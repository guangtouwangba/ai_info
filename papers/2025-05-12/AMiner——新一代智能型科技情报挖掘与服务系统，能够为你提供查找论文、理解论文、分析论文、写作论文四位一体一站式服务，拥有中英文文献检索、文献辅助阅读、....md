...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索（覆盖42个学科3.5亿论文）、AI辅助阅读（自动生成摘要/问答）、文献翻译及科研订阅（按需推送最新成果）。支持PDF上传分析，集成学者画像、会议追踪等功能，可通过网页或微信免费使用，显著提升文献调研与论文写作效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T22:05:01Z
- **目录日期**: 2025-05-12
