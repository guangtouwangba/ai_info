...
研究人员开发了集成计算平台ProME v1.0，用于极端条件下（高温、高压、高应变率）多组分合金材料性能的模拟计算。该平台整合了多种软件工具，涵盖晶体结构搜索、无序构型建模、热力学性质、弹性性质、导电导热性、微观结构演化模拟及相图优化等功能。应用案例显示，ProME成功设计了航天发动机喷嘴用铂-铱-铝-铬四元合金，在保持高温强度的同时显著降低了原材料成本。该平台为材料研发的基础科学研究和工业创新提供了重要支持。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T04:03:05Z
- **目录日期**: 2025-05-12
