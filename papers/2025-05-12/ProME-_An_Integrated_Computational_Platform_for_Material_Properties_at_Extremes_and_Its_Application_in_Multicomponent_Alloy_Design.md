...
研究人员开发了集成计算平台ProME v1.0，用于极端条件下的材料性能预测。该平台整合了多种软件工具，可计算多元合金在超高温（数万开尔文）、超高压（数百万大气压）及超高应变率（每秒百万次）下的晶体结构、热力学性质、弹性、导电性及微观结构演化等特性。应用案例显示，ProME成功设计了航天发动机喷嘴用铂-铱-铝-铬四元合金，在保持高温强度的同时显著降低了材料成本。该平台为材料研发的基础科学研究和工业创新提供了关键支持。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T22:01:01Z
- **目录日期**: 2025-05-12
