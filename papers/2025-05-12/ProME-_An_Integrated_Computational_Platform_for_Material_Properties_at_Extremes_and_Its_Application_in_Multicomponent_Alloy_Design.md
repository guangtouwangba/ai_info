...
ProME v1.0是一个集成计算平台，用于极端条件下（高温、高压、高应变率）的多组分合金材料性能研究。它整合了多种软件工具，涵盖晶体结构搜索（ABC）、无序构型建模（SAE）、多相热力学性质（MFP²）、热弹性性能（HTEM）、电热输运（TREX）、高应变率相场模拟（Hippos）和相图优化（AutoCalphad）。该平台已成功应用于航天发动机喷嘴用Pt-Ir-Al-Cr四元合金设计，在保持高温强度的同时大幅降低成本。ProME为材料研发提供了从基础科学到工业创新的关键支持。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T18:01:26Z
- **目录日期**: 2025-05-12
