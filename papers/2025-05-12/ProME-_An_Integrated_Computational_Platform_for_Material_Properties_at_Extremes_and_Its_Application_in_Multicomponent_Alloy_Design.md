...
ProME v1.0是一个集成计算平台，用于极端条件下（高温、高压、高应变率）的多组分合金材料性能研究。它整合了多种软件工具，涵盖晶体结构搜索（ABC）、无序构型建模（SAE）、热力学性质（MFP²）、弹性（HTEM）、电热输运（TREX）、高应变相场模拟（Hippos）及相图优化（AutoCalphad）等功能。该平台已成功应用于航空航天发动机喷嘴用Pt-Ir-Al-Cr四元合金设计，在保持高温强度的同时大幅降低成本。ProME为材料研发的基础科学和工业创新提供了关键支持。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T07:01:07Z
- **目录日期**: 2025-05-12
