...
该研究探讨了活性物质在储层计算（RC）范式中的信息处理能力，通过模拟外部驱动的混沌信号预测模型，发现了一种此前被忽视的优异动力学机制。该机制在多种物理参数和推断任务中均表现出稳健的最优性能，揭示了物理系统计算与推断的普适性原理。最优计算状态位于临界阻尼阈值之下，表现为多阶段微观动力学弛豫，并能在混沌驱动下通过准稳态与高度非线性状态的快速切换实现自适应。相关性与动力学特征可标识最优性能区间。该模型为理解非平衡多体物理中的学习与非传统计算提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T01:29:54Z
- **目录日期**: 2025-05-12
