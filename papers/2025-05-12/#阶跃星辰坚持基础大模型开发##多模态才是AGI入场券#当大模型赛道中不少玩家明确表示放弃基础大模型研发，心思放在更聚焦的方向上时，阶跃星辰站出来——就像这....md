...
阶跃星辰坚持基础大模型研发，认为行业技术仍处于快速迭代期（如GPT-4即将"过时"），放弃基础模型会错失主流趋势。其CEO姜大昕强调模型决定应用上限，应用反哺模型，因此保持"端云一体Agent平台"的C端产品定位，从"跃问"升级为"阶跃AI"，探索多模态理解作为AGI关键。尽管行业部分公司转向垂直领域，阶跃仍押注基座大模型与多模态技术的协同发展，认为AI助手和内容服务存在巨大市场机会。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T01:31:22Z
- **目录日期**: 2025-05-12
