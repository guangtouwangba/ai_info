...
阶跃星辰坚持基础大模型研发，CEO姜大昕认为AI技术发展迅速，必须紧跟主流趋势。公司相信基础模型决定应用上限，而应用场景反哺模型迭代。其产品从"跃问"升级为"阶跃AI"，转型为端云一体Agent平台，主要服务C端用户。姜大昕强调多模态是AGI的关键，尽管行业部分玩家转向垂直领域，阶跃仍将专注基座大模型研发，同时探索多模态理解能力，认为智能助手和内容领域存在巨大机会。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T02:33:35Z
- **目录日期**: 2025-05-12
