...
阶跃星辰坚持基础大模型研发，创始人姜大昕认为技术发展仍处于快速上升期，放弃基础模型会错失主流趋势。公司相信模型与应用相辅相成，模型决定应用上限，应用提供场景和数据支持。其C端产品从"跃问"升级为"阶跃AI"，转型为端云一体Agent平台，聚焦智能助手和内容服务。姜大昕强调多模态是AGI的关键，公司将持续投入基础模型研发，同时探索多模态理解能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T00:03:42Z
- **目录日期**: 2025-05-12
