...
中国车企的负债情况分析显示，虽然汽车行业整体资产负债率较高（普遍超过60%，部分达80%以上），但与国际水平相当。关键点在于：1）负债结构更健康；2）供应链稳定性持续增强。相比制造业40%-60%的标准，汽车产业因产业链长、金融化程度高，负债率天然偏高。财报数据表明，中国车企负债风险可控，且行业竞争力和抗风险能力正在提升。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T14:03:19Z
- **目录日期**: 2025-05-12
