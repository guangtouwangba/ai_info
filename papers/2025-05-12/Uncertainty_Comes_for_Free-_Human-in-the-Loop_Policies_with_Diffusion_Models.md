...
本文提出了一种基于扩散策略的人机协作（HitL）机器人部署方法，通过不确定性度量自主判断何时需要人工干预，减少对持续人工监控的依赖。该方法利用扩散策略的生成过程计算不确定性指标，仅在必要时请求操作员协助，且训练阶段无需人工交互。此外，该方法还能高效收集数据以微调扩散策略，提升自主性能。仿真和真实环境实验表明，该方法能有效提高多种场景下的策略性能。这一方法解决了大规模机器人部署时人工监控成本高的问题，实现了更高效的半自主部署。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T00:02:43Z
- **目录日期**: 2025-05-12
