...
本文提出了一种以概念为中心的智能体构建范式。该智能体使用神经符号概念词汇（如物体、关系和动作概念），这些概念基于感知输入和动作输出，具有组合性，可通过结构组合创造新概念。概念采用符号程序与神经网络结合的表征方式，支持类型化表示。这种神经符号概念使智能体能高效学习和重组概念，跨领域解决2D图像、视频、3D场景和机器人操作等任务。该框架具有数据高效性、组合泛化能力、持续学习优势和零样本迁移特性，实现了灵活推理与持续学习的统一。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T04:03:15Z
- **目录日期**: 2025-05-12
