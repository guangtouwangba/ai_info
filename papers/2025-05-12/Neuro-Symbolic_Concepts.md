...
本文提出了一种以概念为核心的智能体构建范式。该智能体采用神经符号概念词汇，这些概念（如物体、关系和动作）基于感知输入和行为输出，具有组合性，可通过结构组合创造新概念。概念通过符号程序和神经网络结合表示，支持类型化。利用这种神经符号概念，智能体能高效学习和重组概念，解决2D图像、视频、3D场景和机器人操作等跨领域任务。该框架具有数据高效、组合泛化、持续学习和零样本迁移等优势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T22:01:10Z
- **目录日期**: 2025-05-12
