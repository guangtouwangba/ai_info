...
本研究探讨了有限群体博弈中智能体决策模型（KLD-RL模型）的鲁棒性，重点分析模型参数如何影响噪声和建模误差对决策的影响。通过理论分析和数值模拟，揭示了参数调节对减弱这些干扰因素的作用，为工程应用中群体博弈模型的参数选择提供了实用策略。研究结果验证了理论分析，并展示了参数优化的具体方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T07:00:56Z
- **目录日期**: 2025-05-12
