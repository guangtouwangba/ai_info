...
本研究探讨了有限群体博弈中智能体决策模型（KLD-RL模型）的鲁棒性，重点分析了模型参数如何影响噪声和建模误差对决策的影响。通过理论分析和数值模拟，提出了参数调整策略以减轻这些干扰因素的作用，为群体博弈的工程应用提供了实用指导。研究验证了参数选择的有效性，并展示了实际应用中的优化方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T18:01:16Z
- **目录日期**: 2025-05-12
