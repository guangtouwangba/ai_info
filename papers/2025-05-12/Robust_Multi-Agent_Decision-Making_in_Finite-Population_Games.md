...
本研究探讨了有限群体博弈中智能体决策模型（特别是KLD-RL模型）的鲁棒性，重点分析模型参数如何影响噪声和建模误差对决策的影响。通过理论分析和数值模拟，研究揭示了如何有效调节参数来减轻这些干扰因素的作用，为群体博弈的工程应用提供了实用的参数选择策略。结果表明，合理设置KLD-RL模型的参数能显著提升系统在存在噪声和模型不精确情况下的决策稳定性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T04:02:56Z
- **目录日期**: 2025-05-12
