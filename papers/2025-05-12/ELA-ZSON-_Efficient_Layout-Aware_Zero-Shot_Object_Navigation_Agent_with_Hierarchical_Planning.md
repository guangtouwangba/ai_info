...
ELA-ZSON是一种高效的布局感知零样本物体导航方法，适用于复杂多房间室内环境。它结合全局拓扑地图（含布局信息）和局部场景表征记忆进行分层规划，由LLM驱动的智能体自主管理导航流程，无需人工干预、复杂奖励机制或昂贵训练。在MP3D基准测试中，该方法达到85%的导航成功率（SR）和79%的路径加权成功率（SPL），较现有方法分别提升40%和60%。虚拟代理和真实机器人实验验证了其鲁棒性和实用价值。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T20:01:48Z
- **目录日期**: 2025-05-12
