...
ELA-ZSON是一种高效的零样本目标导航方法，专为复杂多房间室内环境设计。它通过结合全局拓扑布局地图和局部场景记忆进行分层规划，实现了高效导航。该方法由LLM驱动的智能体管理，无需人工干预、复杂奖励机制或昂贵训练。在MP3D基准测试中，其目标导航成功率(SR)达85%，路径加权成功率(SPL)达79%，分别比现有方法提升40%和60%。虚拟代理和真实机器人实验验证了其鲁棒性和实用性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T19:01:38Z
- **目录日期**: 2025-05-12
