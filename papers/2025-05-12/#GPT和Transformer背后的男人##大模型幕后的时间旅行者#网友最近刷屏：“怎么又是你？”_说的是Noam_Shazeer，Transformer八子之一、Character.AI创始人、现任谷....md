...
Noam Shazeer是Transformer架构核心贡献者、Character.AI创始人、现谷歌Gemini技术主管，被誉为大模型领域的"时间旅行者"。作为Transformer论文第八作者（公认贡献最大）、MoE架构关键推进者，他主导了多项突破性技术（Adafactor优化器/Multi Query Attention等）。从IMO数学竞赛满分到谷歌第200号员工，其技术预见性持续被验证——3年前的研究与朱泽园最新论文高度吻合，2017年便预言"语言模型将主导全球算力"。网友评价："我们其实生活在Noam Shazeer时代"。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T00:04:09Z
- **目录日期**: 2025-05-12
