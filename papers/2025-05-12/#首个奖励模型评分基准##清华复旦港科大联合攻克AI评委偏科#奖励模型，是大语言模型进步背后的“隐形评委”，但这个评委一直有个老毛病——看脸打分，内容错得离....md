...
清华大学、复旦大学和香港科技大学联合发布了首个奖励模型评分基准RM-Bench，解决了AI奖励模型"偏科"问题。该基准通过3x3矩阵评估模型在不同风格组合下的判断准确性，覆盖聊天、代码、数学和安全等领域，使用GPT-4o和人工验证数据确保可靠性。RM-Bench不仅能评估奖励模型本身，还能预测其对整个语言模型性能的提升效果。相关论文已被ICLR 2025接收为口头报告，项目代码和评测榜单已开源。这一突破使AI评估更加客观准确，推动大语言模型发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T00:03:51Z
- **目录日期**: 2025-05-12
