...
清华大学、复旦大学和香港科技大学联合发布了首个奖励模型评测基准RM-Bench，解决了现有奖励模型"重形式轻内容"的偏科问题。该基准通过设计内容细微差异+多风格对照测试，采用3x3矩阵评估模型在不同难度下的判断准确性，覆盖聊天、代码等多领域数据，并用GPT-4o和人工验证确保数据质量。RM-Bench不仅能评估奖励模型本身，还能预测其对大语言模型性能的提升效果。该成果已被ICLR 2025接收为口头报告论文，相关代码和数据已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T01:31:31Z
- **目录日期**: 2025-05-12
