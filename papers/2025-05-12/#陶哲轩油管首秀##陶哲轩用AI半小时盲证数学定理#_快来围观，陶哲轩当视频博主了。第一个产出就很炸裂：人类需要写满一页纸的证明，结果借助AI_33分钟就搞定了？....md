...
著名数学家陶哲轩在YouTube首秀中展示AI辅助数学证明：仅用33分钟就完成传统需要一页纸推导的定理证明。视频采用"盲证"方式全程无人工干预，引发数学界关注。该频道上线一天即获900+订阅和2000+观看量，网友称赞其具有历史意义。陶哲轩此次演示展现了AI在数学领域的强大潜力，为学术研究提供了新的可能性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T17:04:10Z
- **目录日期**: 2025-05-12
