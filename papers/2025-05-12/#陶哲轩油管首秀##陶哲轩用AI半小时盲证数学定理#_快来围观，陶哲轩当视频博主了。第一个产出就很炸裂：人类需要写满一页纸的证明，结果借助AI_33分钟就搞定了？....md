...
著名数学家陶哲轩在YouTube首次发布视频，展示用AI工具仅用33分钟就完成了一个通常需要写满一页纸的数学定理证明。该视频引发热议，被网友称为"具有历史意义"的突破。在没有宣传的情况下，其频道首日即获900+订阅和2000+观看量。陶哲轩全程采用"盲证"方式，无需深入思考即可完成证明，展示了AI辅助数学研究的潜力。网友纷纷表示这是"伟大数学频道的诞生"，期待AI为数学领域带来更多革新。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T12:04:24Z
- **目录日期**: 2025-05-12
