...
这篇论文提出了CodeArena基准测试和SynCode-Instruct数据集，用于评估代码生成大模型(CodeLLMs)与人类偏好的对齐程度。CodeArena包含397个高质量编程任务样本，覆盖40类任务和44种语言；SynCode-Instruct则是一个近200亿标记的合成指令数据集。实验发现：1)传统基于执行的测试与人类偏好存在差异；2)开源顶级模型(如Qwen2.5-Coder)与专有模型(如OpenAI o1)性能差距显著。研究强调了在代码生成任务中考虑人类偏好的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T14:06:12Z
- **目录日期**: 2025-05-12
