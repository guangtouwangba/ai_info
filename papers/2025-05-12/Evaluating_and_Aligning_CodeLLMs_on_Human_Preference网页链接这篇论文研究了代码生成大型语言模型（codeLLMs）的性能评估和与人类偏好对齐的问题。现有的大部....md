...
这篇论文针对代码生成大模型(codeLLMs)与人类偏好对齐的问题，提出了CodeArena基准测试和SynCode-Instruct合成指令集。CodeArena包含397个高质量样本，覆盖40类编程任务和44种语言，更贴近实际需求。研究发现现有基于执行的评估与人类偏好存在差距，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著。通过20B标记的合成指令微调实验，验证了大模型对齐人类偏好的重要性。该研究为提升代码生成模型的实用性和用户体验提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T13:15:40Z
- **目录日期**: 2025-05-12
