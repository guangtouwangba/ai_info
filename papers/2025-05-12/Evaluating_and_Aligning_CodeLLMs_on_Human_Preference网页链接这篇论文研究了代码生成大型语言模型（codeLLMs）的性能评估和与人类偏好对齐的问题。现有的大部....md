...
这篇论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，通过397个高质量样本覆盖40类编程任务和44种语言，评估模型与人类偏好的对齐程度。研究发现传统执行基准与人类偏好存在差异，并构建了20B标记的合成指令数据集SynCode-Instruct验证微调效果。实验显示开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)存在显著差距，凸显了人类偏好对齐的重要性。该研究为提升代码LLMs的实际应用价值提供了新评估维度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T21:05:35Z
- **目录日期**: 2025-05-12
