...
这篇28页的综述系统总结了多智能体具身智能的前沿进展。核心指出：具身智能需具备物理身体、环境交互和学习适应性。在多智能体控制方面，EMAPF框架通过动态聚类实现组内集中控制与组间分布式协调。针对开放环境，采用图神经网络和自进化机制提升系统适应性。任务分配方面，SMART-LLM等模型通过任务分解和动态调整优化协作。分布式决策则结合独立模型协作与混合评估机制。研究趋势显示，生成模型正推动多智能体系统向更灵活、自适应的方向发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T11:03:18Z
- **目录日期**: 2025-05-12
