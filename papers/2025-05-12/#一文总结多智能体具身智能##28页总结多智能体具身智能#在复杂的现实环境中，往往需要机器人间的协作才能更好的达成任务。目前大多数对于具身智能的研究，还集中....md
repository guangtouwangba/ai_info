...
这篇28页的综述总结了多智能体具身智能的前沿技术。核心要素包括物理身体、环境互动和经验学习。重点介绍了动态聚类控制（EMAPF框架）、开放环境自进化机制（图神经网络/Transformer处理团队变化）、任务分配（如SMART-LLM分解任务）和分布式决策（独立模型协作+混合评估）。最新趋势包括闭环任务分配、子任务依赖优化和集中式模仿学习。研究强调多智能体协作在复杂环境中的适应性提升，突破了传统单智能体和多智能体强化学习的局限。论文链接：https://arxiv.org/abs/2505.05108

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T13:12:50Z
- **目录日期**: 2025-05-12
