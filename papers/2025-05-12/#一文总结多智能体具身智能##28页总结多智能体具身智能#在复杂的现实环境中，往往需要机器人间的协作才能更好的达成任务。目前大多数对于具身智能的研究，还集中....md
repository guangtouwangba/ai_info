...
这篇28页的综述总结了多智能体具身智能的最新进展。具身智能的核心在于物理身体、环境交互和经验学习。在多智能体控制方面，EMAPF框架通过动态聚类实现组内集中控制和组间分布式协调。开放环境中，采用图神经网络和自进化机制应对动态变化。任务分配方面，SMART-LLM等模型能分解任务并优化分配逻辑。分布式决策则通过独立模型协作或混合评估机制实现。这些技术推动多智能体系统在复杂环境中的协作能力发展。论文链接：https://arxiv.org/abs/2505.05108

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T18:03:34Z
- **目录日期**: 2025-05-12
