...
该研究探讨了在线分数联盟博弈(FHGs)中的联盟形成问题，目标是最大化社会福利。研究发现：在一般在线FHGs中，计算最大匹配可获得最优竞争比，但对无界估值代理而言该比值无界。在允许解散联盟的情况下，基于匹配的算法能实现1/(6+4√2)的最优竞争比。此外，针对随机到达且代理数量未知的在线匹配场景，研究提出了紧确分析，表明存在1/6竞争比的随机算法，而任何算法都无法超过1/3竞争比。这些结果深化了联盟形成与匹配问题的关联理解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T15:01:11Z
- **目录日期**: 2025-05-12
