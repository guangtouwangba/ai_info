...
这篇论文研究了在线分式合作博弈(FHGs)中的联盟形成问题，目标是最大化社会福利。研究发现：在一般在线FHGs中，计算最大匹配能获得最优竞争比，但该比值在无界估值时会无限增大。在两种相关场景中取得了常数竞争比：1)允许解散联盟时，基于匹配的算法能达到最优竞争比1/(6+4√2)；2)随机到达且代理数量未知时，随机算法能达到1/6竞争比，且1/3是理论上界。研究揭示了匹配方法与FHGs之间的深层联系。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T11:01:28Z
- **目录日期**: 2025-05-12
