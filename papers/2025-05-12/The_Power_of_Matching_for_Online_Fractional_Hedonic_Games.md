...
该研究探讨了在线分数联盟博弈(FHGs)中的联盟形成问题，目标是最大化社会福利。研究发现：在一般在线FHGs中，计算最大匹配可获得最优竞争比，但该比率在无界估值下会无限增长。通过两种相关设定实现了常数竞争比：1)若允许解散联盟，基于匹配的算法能达到最优竞争比1/(6+4√2)；2)在随机到达且代理数量未知的在线匹配设定中，严格分析表明存在1/6竞争比的随机算法，而任何算法竞争比不可能优于1/3。研究揭示了联盟形成与匹配问题之间的深层联系。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T07:01:28Z
- **目录日期**: 2025-05-12
