...
该研究探讨了分数联盟博弈(FHGs)中的在线联盟形成问题，目标是最大化社会福利。在一般在线FHGs中，计算最大匹配可获得最优竞争比，但估值无界时竞争比也无界。研究发现两种相关情境下可获得常数竞争比：1)允许解散联盟时，基于匹配的算法能达到最优竞争比1/(6+4√2)；2)随机到达且代理数量未知时，随机化算法可实现1/6竞争比，而任何算法竞争比上限为1/3。研究揭示了联盟形成与匹配问题之间的深层联系。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T12:01:36Z
- **目录日期**: 2025-05-12
