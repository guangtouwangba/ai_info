...
该研究探讨了分数超图博弈(FHGs)中的在线联盟形成问题，目标是最大化社会福利。在一般在线FHGs中，计算最大匹配可获得最优竞争比，但该比率在无界估值下无界。研究在两个相关场景中取得突破：1)若允许解散联盟，基于匹配的算法可实现最优竞争比1/(6+4√2)；2)在随机到达的在线匹配设置中，提出紧确分析，给出1/6竞争比的随机算法，并证明1/3是最优上界。研究揭示了匹配方法与联盟形成问题的深层联系。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T18:01:45Z
- **目录日期**: 2025-05-12
