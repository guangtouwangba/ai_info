...
本文研究了在线分数联盟博弈(FHGs)中的联盟形成问题，目标是最大化社会福利。研究发现：在一般在线FHGs中，计算最大匹配可获得最优竞争比，但估值无界时竞争比也无界。在允许解散联盟的情况下，基于匹配的算法能达到最优竞争比1/(6+4√2)。此外，针对随机到达且代理数量未知的在线匹配场景，研究提出了紧确分析，得出随机1/6竞争比算法，且证明任何算法竞争比不可能优于1/3。这些结果深化了对匹配与FHGs关系的理解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T09:01:37Z
- **目录日期**: 2025-05-12
