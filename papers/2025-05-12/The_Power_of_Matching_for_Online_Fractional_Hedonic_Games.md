...
该研究探讨了在线分数联盟博弈(FHGs)中的联盟形成问题，目标是最大化社会福利。研究发现：在一般在线FHGs中，计算最大匹配可获得最优竞争比，但估值无界时竞争比也无界。在两种相关设定中取得了恒定竞争比：1)允许解散联盟时，基于匹配的算法可实现最优竞争比1/(6+4√2)；2)随机到达且代理数量未知时，随机1/6竞争比算法是紧的，且无算法能优于1/3竞争比。研究揭示了联盟形成与匹配问题之间的深层联系。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T02:30:54Z
- **目录日期**: 2025-05-12
