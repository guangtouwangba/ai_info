...
该研究探讨了在线分数联盟博弈(FHGs)中的联盟形成问题，目标是最大化社会福利。研究发现：在一般在线FHGs中，计算最大匹配可获得最优竞争比，但估值无界时竞争比也无界。在两种相关设置中取得突破：1)若允许解散联盟，基于匹配的算法可实现最优竞争比1/(6+4√2)；2)在随机到达且代理数量未知时，严格分析表明随机算法可达1/6竞争比，而理论上限为1/3。研究揭示了FHGs与匹配问题的新联系，为在线联盟形成提供了算法保证。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T04:03:24Z
- **目录日期**: 2025-05-12
