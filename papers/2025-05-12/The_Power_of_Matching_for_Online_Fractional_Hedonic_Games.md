...
该研究探讨了在线分数联盟博弈(FHGs)中的联盟形成问题，目标是最大化社会福利。在一般在线FHGs中，计算最大匹配可获得最优竞争比，但估值无界时竞争比也无界。研究在两个相关场景中取得突破：1)允许解散联盟时，基于匹配的算法可实现最优竞争比1/(6+4√2)；2)随机到达且代理数量未知时，提出1/6竞争比的随机算法，并证明1/3是理论上限。研究揭示了FHGs与匹配问题的新联系，为在线联盟形成提供了理论保证。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T06:01:24Z
- **目录日期**: 2025-05-12
