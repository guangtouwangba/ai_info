...
该研究探讨了在线分式享乐博弈(FHGs)中的联盟形成问题，目标是最大化社会福利。研究发现：在一般在线FHGs中，计算最大匹配能获得最优竞争比，但估值无界时竞争比也无界。在两种相关场景中取得了常数竞争比：1)允许解散联盟时，基于匹配的算法可实现最优竞争比1/(6+4√2)；2)随机到达且代理数量未知时，随机1/6竞争比算法是紧的，而任何算法不可能优于1/3竞争比。研究揭示了匹配方法在联盟形成中的关键作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T21:01:21Z
- **目录日期**: 2025-05-12
