...
字节与北大联合推出开源AI框架DreamO，能在8-10秒内生成高质量定制图像。该模型仅400M参数，支持多条件组合控制（如风格、主体、服装等），并保持强一致性和图像稳定性。基于Flux模型改进，DreamO实现了低成本高效率的复杂图像生成，适用于多主体构图、虚拟试衣等场景。技术细节详见原文链接。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T17:03:05Z
- **目录日期**: 2025-05-12
