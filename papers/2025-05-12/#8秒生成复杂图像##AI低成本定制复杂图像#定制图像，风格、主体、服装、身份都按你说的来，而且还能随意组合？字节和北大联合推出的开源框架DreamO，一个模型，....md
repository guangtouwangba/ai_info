# #8秒生成复杂图像##AI低成本定制复杂图像#定制图像，风格、主体、服装、身份都按你说的来，而且还能随意组合？字节和北大联合推出的开源框架DreamO，一个模型，...
...
字节与北大联合推出开源框架DreamO，能在8-10秒内高效生成定制化复杂图像。该模型仅需400M参数，支持多条件组合控制（如风格、主体、服装、身份），并能处理多主体构图和虚拟试衣等复杂需求。其技术基于Flux生成模型改进，具有高一致性和稳定的图像质量，能有效保留参考图像信息。特点包括低成本高效率、多条件灵活组合以及强一致性输出，为AI图像生成提供了新的开源解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T21:02:56Z
- **目录日期**: 2025-05-12
