...
字节与北大联合推出开源AI框架DreamO，能8-10秒快速生成定制化复杂图像。该模型仅400M参数，支持多条件组合控制（如风格、主体、服装、身份等），在虚拟试衣、多主体生成等场景表现突出。其技术基于Flux模型改进，具有生成效率高（低成本）、控制维度多、图像一致性强的特点，能精准保留参考图像信息。相关论文细节可通过链接查看。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T19:02:38Z
- **目录日期**: 2025-05-12
