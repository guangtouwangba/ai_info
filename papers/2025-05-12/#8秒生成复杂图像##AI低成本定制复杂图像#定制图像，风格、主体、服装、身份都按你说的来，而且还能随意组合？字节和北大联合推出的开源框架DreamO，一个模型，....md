...
字节与北大联合推出开源AI框架DreamO，能快速生成定制化复杂图像。该模型仅400M参数，8-10秒即可输出图像，支持多条件组合控制（如风格、主体、服装等），并保持高一致性和图像质量。基于Flux模型改进，DreamO特别擅长处理多主体构图和虚拟试衣等复杂场景，在低成本下实现高效精准的图像生成。相关技术细节已通过文章发布。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T13:12:25Z
- **目录日期**: 2025-05-12
