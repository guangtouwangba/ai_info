# #科学家让铅瞬间变成金##科学家上演现实版点石成金#在日内瓦CERN的地下，科学家实现了炼金术士的终极梦想：把铅变成了金。虽然只是短短一微秒，也只有极其微小的...
...
欧洲核子研究中心(CERN)的科学家利用大型强子对撞机(LHC)实现了"铅变金"的突破。他们将铅离子加速至近光速碰撞，通过超外周碰撞产生的高能光子轰击铅原子核，使其失去3个质子(从原子序82变为79)，短暂形成金原子核。虽然每次仅产生约86亿个金原子(总质量2.9×10⁻¹¹克)，持续时间仅1微秒，但这验证了电磁诱导核反应的可行性。该研究主要目的是探索高能物理机制，而非实际炼金，对理解基本粒子相互作用和未来新粒子探索具有重要意义。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T14:04:02Z
- **目录日期**: 2025-05-12
