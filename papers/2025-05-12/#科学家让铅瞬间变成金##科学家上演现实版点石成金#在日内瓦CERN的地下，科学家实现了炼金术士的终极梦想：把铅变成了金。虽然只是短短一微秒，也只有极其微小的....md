...
欧洲核子研究中心(CERN)科学家利用大型强子对撞机(LHC)实现了"铅变金"的突破：通过超外周碰撞使铅离子释放高能光子，将铅原子核(原子序82)转变为金原子核(原子序79)。实验产生了约86亿个金原子核(总质量2.9×10⁻¹¹克)，但仅存在1微秒。这项研究主要价值在于探索电磁诱导核反应机制，而非实际炼金。该成果验证了高能物理可以改变元素性质，为未来粒子研究提供了新思路。实验还观测到铊、汞等同位素的生成。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T16:03:53Z
- **目录日期**: 2025-05-12
