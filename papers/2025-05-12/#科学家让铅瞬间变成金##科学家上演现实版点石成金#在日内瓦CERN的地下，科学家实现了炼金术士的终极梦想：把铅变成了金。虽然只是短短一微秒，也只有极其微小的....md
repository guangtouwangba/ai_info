...
欧洲核子研究中心(CERN)科学家利用大型强子对撞机(LHC)实现了"铅变金"的突破：通过将铅离子加速至近光速并使其发生超外周碰撞，产生的高能光子可击出铅原子核3个质子，使其转变为金原子核(原子序从82变为79)。实验中产生了约86亿个金原子核(总质量仅2.9×10⁻¹¹克)，但仅存在1微秒。该研究主要价值在于探索电磁诱导核反应机制，而非实际生产黄金，为高能物理研究提供了新见解。实验还观测到铊、汞等同位素生成。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T18:04:02Z
- **目录日期**: 2025-05-12
