...
欧洲核子研究中心(CERN)的科学家利用大型强子对撞机(LHC)，通过超外周碰撞使铅离子在接近光速下相互作用。高能光子从铅原子核中击出3个质子，将铅(原子序82)短暂转变为金(原子序79)。虽然仅产生86亿个金原子(总质量约2.9×10⁻¹¹克)且仅持续1微秒，但实现了"点铅成金"的科学突破。该实验主要研究电磁诱导核反应机制，而非实际炼金，为理解高能物理过程和发展粒子对撞技术提供了新见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T22:03:28Z
- **目录日期**: 2025-05-12
