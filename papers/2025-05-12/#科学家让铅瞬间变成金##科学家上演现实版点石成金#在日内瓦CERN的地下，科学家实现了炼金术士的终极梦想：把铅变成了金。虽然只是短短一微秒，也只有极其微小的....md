...
欧洲核子研究中心(CERN)的科学家在大型强子对撞机(LHC)中实现了"铅变金"的突破。通过将铅离子加速至近光速并使其发生超外周碰撞，产生的高能光子可将铅原子核(原子序82)转变为金原子核(原子序79)。虽然每次反应仅产生86亿个金原子(总质量约2.9×10⁻¹¹克)且寿命仅1微秒，但证实了电磁诱导核反应的可行性。该实验主要目的是研究高能物理机制，而非实际炼金，成果有助于提升对撞机精度并为新粒子研究奠定基础。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T09:03:50Z
- **目录日期**: 2025-05-12
