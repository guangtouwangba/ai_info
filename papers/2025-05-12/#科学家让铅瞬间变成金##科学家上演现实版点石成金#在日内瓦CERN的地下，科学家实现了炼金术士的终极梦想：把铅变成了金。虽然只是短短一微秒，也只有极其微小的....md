...
欧洲核子研究中心(CERN)的科学家利用大型强子对撞机(LHC)实现了"点铅成金"的突破。他们将铅离子加速至近光速碰撞，通过"超外周碰撞"产生的高能光子使铅原子核失去3个质子(原子序从82变为79)，短暂形成了金元素。虽然每次仅产生86亿个金原子(总重约2.9×10⁻¹¹克)且仅存在1微秒，但这验证了电磁诱导核反应的可行性。该研究主要目的是探索高能物理机制，而非实际炼金，为未来粒子物理研究提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T19:03:22Z
- **目录日期**: 2025-05-12
