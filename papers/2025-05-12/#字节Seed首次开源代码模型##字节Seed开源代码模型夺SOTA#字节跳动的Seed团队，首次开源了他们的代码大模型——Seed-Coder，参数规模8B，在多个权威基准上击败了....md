...
字节跳动Seed团队首次开源代码大模型Seed-Coder（8B参数），包含Base/Instruct/Reasoning三个版本，在多项基准测试中超越Qwen3等模型达到SOTA。其创新点在于采用"小模型自管数据"范式：1）整合四类代码数据源（文件/仓库级代码、Git提交记录、网络代码内容）；2）通过双重去重、语法检查及LLM评分筛选高质量数据；3）定制化评分机制适应不同来源。Reasoning版本采用强化学习优化推理能力，在IOI 2024表现优异。模型及代码已完全开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T04:05:24Z
- **目录日期**: 2025-05-12
