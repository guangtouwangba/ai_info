...
该研究提出了一个量化监督成功概率的框架，将可扩展监督建模为能力不匹配玩家之间的博弈。研究者通过改良版Nim游戏验证框架后，将其应用于黑手党、辩论、后门代码和战争游戏四种监督场景，发现监督效果与AI系统通用能力呈分段线性关系。在嵌套可扩展监督(NSO)的理论研究中，团队确定了NSO成功的条件，并计算出最优监督层级数。实验显示，当Elo差距为400时，四种监督场景的成功率分别为13.5%、51.7%、10.0%和9.4%，且随着被监督系统变强，成功率进一步下降。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T13:11:28Z
- **目录日期**: 2025-05-12
