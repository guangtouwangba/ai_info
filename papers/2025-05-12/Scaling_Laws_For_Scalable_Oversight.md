...
该研究提出了一个量化监督成功概率的框架，将可扩展监督建模为能力不匹配玩家之间的博弈。监督者和被监督者拥有基于通用智力的分段线性Elo评分，包含任务不熟练和饱和两个阶段。研究通过改良版Nim游戏验证框架，并应用于黑手党、辩论、后门代码和战争游戏四种监督场景，发现各自性能随AI能力变化的缩放规律。进一步理论分析了嵌套可扩展监督(NSO)机制，确定了成功条件并推导出最优监督层级数。实验显示在400 Elo差距下，四种场景的NSO成功率分别为13.5%、51.7%、10.0%和9.4%，且随系统变强而下降。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T02:31:33Z
- **目录日期**: 2025-05-12
