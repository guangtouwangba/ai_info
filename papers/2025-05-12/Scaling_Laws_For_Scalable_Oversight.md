...
本文提出一个量化监督成功概率的框架，将可扩展监督建模为能力不匹配玩家间的博弈。研究者用改良版Nim游戏验证框架后，应用于四种监督博弈（Mafia、辩论、后门代码和战争游戏），发现领域表现与AI通用能力间的标度律。进一步理论研究表明，在嵌套可扩展监督（NSO）中，当被监督系统Elo分差为400时，四种游戏的监督成功率分别为13.5%、51.7%、10.0%和9.4%，且成功率随系统能力增强而下降。研究还推导出最大化监督成功概率的最优监督层级数。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T09:02:22Z
- **目录日期**: 2025-05-12
