...
本文提出了一种基于可解释AI的新方法，用于分析Wasserstein距离的组成因素。Wasserstein距离是衡量数据分布差异的有效工具，但单纯计算距离或分析传输映射无法揭示其高低的具体成因。该方法能高效准确地将Wasserstein距离归因于数据子群、输入特征或可解释子空间等不同组件，并在多种数据集和距离规格下保持高精度。通过两个实际案例验证了其应用价值，为深入理解分布差异提供了新的分析视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T08:01:54Z
- **目录日期**: 2025-05-12
