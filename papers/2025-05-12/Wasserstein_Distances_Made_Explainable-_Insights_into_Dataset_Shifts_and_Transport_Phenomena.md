...
Wasserstein距离是分析数据分布差异的有效工具，但单纯计算距离或传输映射难以解释差异来源。本研究提出一种基于可解释AI的新方法，能够高效、准确地将Wasserstein距离归因于数据子群、输入特征或可解释子空间等不同数据成分。该方法在多种数据集和Wasserstein距离设定下均表现出高精度，并通过两个实际案例验证了其应用价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T21:01:51Z
- **目录日期**: 2025-05-12
