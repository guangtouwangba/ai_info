...
本文提出了一种基于可解释AI的新方法，用于分析Wasserstein距离的成因。Wasserstein距离虽能有效比较数据分布，但传统方法难以解释距离高低的具体原因。该方法能准确将Wasserstein距离归因于数据子群、输入特征或可解释子空间等不同成分，在多种数据集和Wasserstein距离规格下均表现优异，并通过两个实际案例验证了其应用价值。该解决方案为深入理解分布差异提供了新的分析工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T09:02:10Z
- **目录日期**: 2025-05-12
