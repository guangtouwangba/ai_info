...
这项研究提出了一个多维框架来分析政治不文明行为（包括无礼、暴力言论、仇恨言论和对民主制度的威胁），并基于2022年巴西大选期间的500万条推文展开实证分析。研究发现：选举期间无礼言论激增，而其他不文明行为多由暴力事件触发；左翼个人影响者是主要传播者，既直接发布不文明内容，也通过转发政客/媒体内容间接传播，形成混合传播模式。研究揭示了巴西政治不文明的多维特征，其框架也可拓展至其他政治语境。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T06:02:13Z
- **目录日期**: 2025-05-12
