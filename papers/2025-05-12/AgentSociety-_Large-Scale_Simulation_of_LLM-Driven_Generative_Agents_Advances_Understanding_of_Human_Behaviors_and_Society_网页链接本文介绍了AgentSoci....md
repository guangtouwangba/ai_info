...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统模拟了超过1万个AI代理的社会互动（共500万次），用于研究社会现象如信息传播、政策影响和自然灾害应对等。通过四个案例研究，证明其模拟结果与现实数据吻合，验证了该系统在理解人类行为机制方面的有效性。研究表明AgentSociety可作为社会科学研究和政策制定的有力工具，补充传统研究方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T12:05:35Z
- **目录日期**: 2025-05-12
