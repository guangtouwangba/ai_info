...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万个AI代理及其500万次社会互动。研究者用它研究了四个关键社会问题：社会极化、信息传播、基本收入政策效果和自然灾害影响。该系统模拟结果与现实世界数据高度吻合，证明其能有效捕捉人类行为机制。AgentSociety可作为计算社会科学的研究平台，为学者和政策制定者提供新工具，弥补传统方法（如调查、访谈）的局限，帮助理解社会问题的模式和成因。这一创新方法展现了AI在社会研究中的巨大潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T10:05:11Z
- **目录日期**: 2025-05-12
