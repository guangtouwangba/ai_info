...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个代理及其500万次互动。研究者利用该系统研究了社会极化、信息传播、基本收入政策和自然灾害影响四个关键社会问题，结果与现实世界数据吻合。该系统结合了LLM代理、真实社会环境和大规模模拟引擎，能够有效捕捉人类行为机制，为社会科学研究和政策制定提供了新工具。研究表明AgentSociety可以补充传统研究方法，帮助理解社会问题的模式和内在机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T17:05:12Z
- **目录日期**: 2025-05-12
