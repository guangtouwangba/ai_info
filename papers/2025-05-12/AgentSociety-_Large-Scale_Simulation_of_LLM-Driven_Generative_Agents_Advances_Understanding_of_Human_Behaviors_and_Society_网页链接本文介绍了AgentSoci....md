...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟10,000多个AI代理的社会互动（500万次交互）。该系统能研究关键社会问题，如信息极化、政策影响（如基本收入）和自然灾害（如飓风）的社会效应。其模拟结果与现实数据高度吻合，验证了该系统在揭示人类行为机制方面的有效性。AgentSociety可作为计算社会科学的新工具，辅助传统研究方法（调查、实验等），为研究者和政策制定者提供社会动态的深层洞察。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T19:04:33Z
- **目录日期**: 2025-05-12
