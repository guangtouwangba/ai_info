...
研究人员提出了SITE基准数据集，用于全面评估大型视觉语言模型的空间智能(SI)。该数据集采用多选题形式，涵盖多种视觉模态（单图、多图、视频）和SI要素（从图形到环境尺度、空间可视化与定向、静态与动态等）。研究结合了31个现有数据集的调研和认知科学分类体系，设计了关于视角转换和动态场景的新任务。实验表明，领先模型在空间定向等基础SI要素上仍落后于人类专家，且模型的空间推理能力与其在具身AI任务中的表现呈正相关。该研究为评估AI空间智能提供了标准化框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T01:28:47Z
- **目录日期**: 2025-05-12
