# #OpenAI微软修改数十亿美元合同##OpenAI与微软为IPO展开谈判#据《金融时报》最新消息，OpenAI和微软正在就双方价值数十亿美元的合作协议展开重新谈判。谈判的核...
...
OpenAI与微软正重新谈判数十亿美元合作协议，核心目标是推动OpenAI未来IPO并确保微软持续获取前沿AI技术。微软考虑放弃部分股权换取2030年后新技术权限。OpenAI正从非营利机构转型为"公益公司"以满足投资者要求，但面临监管审查和治理结构质疑。若转型失败可能影响融资和估值，在与谷歌等对手竞争中处于劣势。双方关系微妙变化，OpenAI同时拓展独立发展路径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-12T02:32:06Z
- **目录日期**: 2025-05-12
