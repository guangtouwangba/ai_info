...
OpenAI近期动作频频：完成创纪录的400亿美元融资，时隔6年再次开源模型权重（含推理模型且不限制商用），同时ChatGPT用户量1小时内暴涨百万。这一系列举措将AI领域热度推向新高，被外界视为对DeepSeek等竞争对手的直接回应。开源策略的调整尤其引发关注，标志着OpenAI在商业化与开放生态之间寻求新平衡。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T00:03:41Z
- **目录日期**: 2025-04-05
