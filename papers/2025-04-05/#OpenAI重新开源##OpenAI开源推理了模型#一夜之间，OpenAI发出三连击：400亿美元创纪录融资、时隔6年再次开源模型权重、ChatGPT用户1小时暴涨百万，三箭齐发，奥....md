...
OpenAI近期采取三项重大举措：1) 获得创纪录的400亿美元融资；2) 时隔6年重新开源模型权重，推出可商用的推理模型；3) ChatGPT用户数量1小时内暴增百万。这些动作显著提升了AI领域的热度，被视为对DeepSeek等竞争对手的直接回应。开源策略尤其引人注目，因其不限制商业用途，可能重塑行业格局。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T04:03:45Z
- **目录日期**: 2025-04-05
