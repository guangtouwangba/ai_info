...
OpenAI近期连续发布三大重磅消息：完成400亿美元创纪录融资、时隔6年重新开源模型权重（首个开源项目为可商用推理模型）、ChatGPT用户1小时激增百万。这一系列动作将AI领域热度推向新高，其中开源策略被认为直接对标DeepSeek等开源竞争对手。此次开源特别强调不限制商业用途，显示出OpenAI在保持技术领先的同时，正积极调整其开源战略布局。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T01:30:38Z
- **目录日期**: 2025-04-05
