...
OpenAI近期动作频频：获得创纪录的400亿美元融资，时隔6年重新开源模型权重（包括可商用的推理模型），同时ChatGPT用户量1小时内暴增百万。这些举措将AI领域热度推向新高，被外界视为对DeepSeek等竞争对手的直接回应。开源模型不设商用限制成为最大亮点，标志着OpenAI战略的重大调整。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T02:29:18Z
- **目录日期**: 2025-04-05
