...
OpenAI近期动作频频：1) 完成400亿美元创纪录融资；2) 时隔6年再次开源模型权重，且不限制商用；3) ChatGPT用户1小时暴涨百万。这些举措显著提升了AI领域热度，被视为对DeepSeek等竞争对手的直接回应。此次开源重点推出了推理模型，标志着OpenAI战略的重大转变。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T03:13:56Z
- **目录日期**: 2025-04-05
