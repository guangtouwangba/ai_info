...
OpenAI近期动作频频：1)完成创纪录的400亿美元融资；2)时隔6年重新开源模型权重；3)ChatGPT用户数1小时暴增百万。该公司开源了推理模型且不限制商用，此举被视为对标DeepSeek。这一系列举措将AI行业热度推向新高，展现出OpenAI在商业化和开源战略上的重大突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T05:04:04Z
- **目录日期**: 2025-04-05
