...
联想集团在2025/26新财年誓师大会上宣布启动"第五次创业"，全面进军AI领域。CEO杨元庆表示，此次转型不仅是推出AI PC产品，而是从底层基础设施到企业智能体平台的全面AI化，甚至包括品牌定位的重构。这标志着这家科技巨头正式加入AI创业赛道，计划从技术底层到应用层面进行全面革新。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T03:14:14Z
- **目录日期**: 2025-04-05
