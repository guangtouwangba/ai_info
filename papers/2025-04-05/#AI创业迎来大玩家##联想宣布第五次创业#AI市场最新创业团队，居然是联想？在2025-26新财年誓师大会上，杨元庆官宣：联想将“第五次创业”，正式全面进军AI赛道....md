...
联想集团在2025/26新财年誓师大会上宣布启动"第五次创业"，全面进军AI领域。董事长杨元庆表示，此次转型并非仅聚焦AI PC，而是涵盖从底层基础设施到企业智能体平台的全方位AI布局，甚至包括品牌定位的AI化重构。这标志着联想正式加入AI创业赛道，成为该领域的重要参与者。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T02:29:38Z
- **目录日期**: 2025-04-05
