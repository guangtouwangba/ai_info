...
豆包AI的文生图功能升级至3.0版本，重点提升了中文文字生成的准确性。新功能支持海报设计、短视频封面制作及文旅周边创作，用户可免费使用。官方示例展示了其生成的海报效果，网友实测反馈积极。该工具适用于多种场景，如旅游VLOG封面设计等，操作简便且风格多样。目前已在平台开放体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T02:28:55Z
- **目录日期**: 2025-04-05
