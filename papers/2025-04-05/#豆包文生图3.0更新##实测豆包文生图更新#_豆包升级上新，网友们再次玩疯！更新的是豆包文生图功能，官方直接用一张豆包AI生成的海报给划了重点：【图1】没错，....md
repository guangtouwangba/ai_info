...
豆包AI的文生图功能升级至3.0版本，主要提升了中文文字生成的准确性。新功能可免费使用，适用于海报设计、社交媒体封面制作（如抖音、小红书）及文旅周边产品设计。官方通过AI生成的海报展示了其应用效果，用户实测反馈积极。该工具现可即时体验，满足多种创意需求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T06:04:18Z
- **目录日期**: 2025-04-05
