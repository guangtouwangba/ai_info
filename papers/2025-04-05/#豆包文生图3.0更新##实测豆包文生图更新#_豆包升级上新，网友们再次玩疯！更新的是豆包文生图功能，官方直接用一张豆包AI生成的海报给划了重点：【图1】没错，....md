...
豆包文生图3.0功能重磅升级，重点优化了中文文字生成的准确性。新版支持制作海报、短视频封面及文旅周边设计，用户可免费体验。官方海报展示了AI生成的图文融合效果，网友实测反馈生成质量显著提升，适用于社交媒体内容创作。目前该功能已开放使用，提供多样化的视觉设计解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T07:04:07Z
- **目录日期**: 2025-04-05
