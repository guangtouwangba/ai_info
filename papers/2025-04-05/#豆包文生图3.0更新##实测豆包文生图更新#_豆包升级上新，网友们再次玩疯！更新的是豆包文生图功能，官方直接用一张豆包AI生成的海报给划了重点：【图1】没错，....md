...
豆包AI文生图功能升级至3.0版本，重点优化了中文文字生成的准确性。新功能支持海报设计、短视频封面制作及文旅周边创作，提供多种风格模板且完全免费。官方示例显示其能精准呈现中文文案，用户实测反馈生成效果实用性强，适用于社交媒体内容创作。目前该功能已开放使用，引发网友广泛体验热潮。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T04:03:24Z
- **目录日期**: 2025-04-05
