...
该研究评估了大型语言模型（LLM）代理在知识更新中的时间依赖性表现，通过日期控制工具（DCTs）测试其知识变异性。研究发现，作为写作助手时，LLM代理依赖网络搜索完成科学摘要的表现受搜索引擎时效性影响，但可通过选择基础模型和显式推理指令（如思维链提示）缓解。结果表明，代理设计和评估需动态考量外部资源的时效影响，以确保可靠性。研究强调了在知识更新中考虑时间因素的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T22:02:08Z
- **目录日期**: 2025-04-05
