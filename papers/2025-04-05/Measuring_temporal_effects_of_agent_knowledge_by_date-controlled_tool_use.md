...
该研究评估了大型语言模型（LLM）代理在时间知识更新中的表现，通过使用不同日期控制的工具（DCTs）测试其知识变异性。研究发现，作为写作助手时，LLM代理依赖网络搜索完成科学摘要的性能受搜索引擎时间性的影响，但可通过基础模型选择及显式推理指令（如思维链提示）缓解。结果表明，代理设计和评估需采用动态视角，并采取措施减少外部资源的时间性影响，以确保可靠性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T09:02:05Z
- **目录日期**: 2025-04-05
