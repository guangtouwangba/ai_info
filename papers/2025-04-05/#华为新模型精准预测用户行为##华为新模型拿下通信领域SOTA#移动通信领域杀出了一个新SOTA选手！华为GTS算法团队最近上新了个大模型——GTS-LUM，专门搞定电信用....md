...
华为GTS算法团队推出新模型GTS-LUM，在移动通信领域实现SOTA性能。该大模型专注于电信用户行为建模，能精准预测用户换套餐意愿、流失风险及后续操作行为。其预测准确度表现突出，可有效预判用户行为轨迹和意图。该技术突破将提升电信服务精准度和用户体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T10:04:07Z
- **目录日期**: 2025-04-05
