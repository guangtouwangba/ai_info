...
华为GTS算法团队推出新模型GTS-LUM，在移动通信领域实现SOTA表现。该模型专注于电信用户行为建模，能够高精度预测用户行为，包括套餐更换意向、流失风险以及下一步操作的时间和类型。其预测准确性显著优于现有方法，为电信运营商提供更精准的用户行为洞察。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T21:04:05Z
- **目录日期**: 2025-04-05
