...
比尔·盖茨公开了50年前微软起家的Altair Basic源代码（共157页）。他在文章中强调，在Office、Windows 95、Xbox和AI出现之前，Altair Basic就已诞生。网友感叹从BASIC语言到万亿参数AI模型的跨越，并认为用AI将这段代码转化为艺术会很有诗意。盖茨还分享了这段代码背后的故事。源代码地址可通过原文链接查看。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T22:03:28Z
- **目录日期**: 2025-04-05
