...
比尔·盖茨公开了50年前微软起家的Altair Basic源代码（共157页），这是个人计算机发展史上的重要里程碑。他在文章中强调，在Office、Windows 95、Xbox和AI出现前，Altair Basic就已诞生。网友感叹从BASIC语言到万亿参数AI模型的飞速技术演进，并认为用GPT-5将这段革命性代码转化为艺术会很有诗意。盖茨还详细讲述了这段代码背后的历史故事。源代码地址见原文链接。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T14:03:42Z
- **目录日期**: 2025-04-05
