...
比尔·盖茨公开了微软起家的Altair Basic源代码，这段50年前的代码共157页。他在文章中强调，在Office、Windows 95、Xbox和AI出现之前，Altair Basic就已诞生，标志着个人计算机发展的开端。网友感叹从BASIC语言到万亿参数AI模型的跨越，并探讨用GPT-5将这段代码转化为艺术的可能性。盖茨还分享了代码背后的故事细节。源代码地址可通过链接查看。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T20:03:19Z
- **目录日期**: 2025-04-05
