...
比尔·盖茨公开了50年前由他编写的Altair Basic源代码（共157页），这是微软起家的关键程序。盖茨强调，在Office、Windows 95等产品之前，Altair Basic已为个人计算机革命奠定基础。网友感叹从BASIC语言到万亿参数AI的技术跨越，并设想用GPT-5将这段代码转化为艺术。盖茨还分享了该代码背后的历史细节。源代码地址见原文链接。（99字）  

（注：图片内容无法直接摘要，核心信息已提炼为文字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T08:03:25Z
- **目录日期**: 2025-04-05
