...
比尔·盖茨近日公开了50年前由他编写的Altair Basic源代码（共157页），这是微软起家的关键程序。他在文章中强调，在Office、Windows 95等产品问世前，Altair Basic已为个人计算机革命奠定基础。网友感叹从BASIC语言到万亿参数AI的跨越，并设想用GPT-5将这段历史代码转化为艺术。盖茨详细回顾了该代码的开发故事，其开源发布引发对计算机发展史的广泛讨论。（注：图片内容未纳入摘要）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T16:03:31Z
- **目录日期**: 2025-04-05
