# #比尔盖茨公开50年前源代码##比尔盖茨公开Altair Basic源代码# 一段时隔整整50年的源代码，更是让微软这家科技巨头起家的源代码，正式被公开了——Altair Basic...
...
比尔·盖茨公开了50年前由他编写的Altair Basic源代码（共157页），这是微软起家的关键程序。他在文章中强调，在Office、Windows 95、Xbox和AI出现之前，Altair Basic就已诞生，标志着个人计算机革命的起点。网友感叹从BASIC语言到万亿参数AI模型的跨越，并设想用GPT-5将这段代码转化为艺术。盖茨还分享了该代码背后的历史细节。源代码地址可通过文末链接查看。（注：图片内容未在摘要中体现）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T15:03:39Z
- **目录日期**: 2025-04-05
