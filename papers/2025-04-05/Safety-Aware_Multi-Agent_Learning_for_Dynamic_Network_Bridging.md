...
本文研究了在部分可观测的安全关键环境中，多智能体系统执行复杂协作任务的挑战。针对动态网络桥接任务，研究者开发了一种结合控制论安全过滤器的多智能体强化学习方法，通过局部设定点更新确保避碰安全。研究发现，将安全过滤器激活编码为边缘级特征能有效提升协调能力。结果表明，局部安全执行与分散学习可在分布式多智能体任务中有效结合。该方法为安全关键环境下的多智能体协作提供了新思路，同时保障了训练和部署阶段的安全性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T08:02:48Z
- **目录日期**: 2025-04-05
