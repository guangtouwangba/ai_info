...
本文研究了在部分可观测的安全关键环境中，多智能体系统执行复杂协作任务的挑战。针对动态网络桥接任务，研究者提出了结合控制理论安全过滤器的方法，通过局部设定点更新实现避碰。研究开发了基于安全信息传递的多智能体强化学习框架，发现将安全过滤器激活编码为边缘特征能有效提升协作效率。结果表明，局部安全约束与分散式学习可在分布式多智能体任务中实现有效结合，为安全关键环境下的协作控制提供了新思路。该方法在训练和部署阶段均能确保安全性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T21:02:35Z
- **目录日期**: 2025-04-05
