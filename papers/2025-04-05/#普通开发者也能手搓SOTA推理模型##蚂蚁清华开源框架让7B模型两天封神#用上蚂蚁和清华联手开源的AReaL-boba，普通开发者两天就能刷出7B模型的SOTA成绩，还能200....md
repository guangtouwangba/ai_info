# #普通开发者也能手搓SOTA推理模型##蚂蚁清华开源框架让7B模型两天封神#用上蚂蚁和清华联手开源的AReaL-boba，普通开发者两天就能刷出7B模型的SOTA成绩，还能200...
...
蚂蚁集团与清华大学联合开源了AReaL-boba框架，使普通开发者能在2天内训练出7B参数模型的SOTA推理性能，并以200美元低成本复现32B大模型QwQ的效果。该框架具有训练速度快、推理能力强、成本低廉三大优势，被比喻为"奶茶三兄弟"（易获取、高效能、普惠性）。其开源性覆盖数据、代码和模型，显著降低了AI研发门槛，特别在数学推理任务中展现出强化学习的高效优化能力。这一突破将大模型训练平民化，有望推动AI技术更广泛的应用落地。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T02:29:30Z
- **目录日期**: 2025-04-05
