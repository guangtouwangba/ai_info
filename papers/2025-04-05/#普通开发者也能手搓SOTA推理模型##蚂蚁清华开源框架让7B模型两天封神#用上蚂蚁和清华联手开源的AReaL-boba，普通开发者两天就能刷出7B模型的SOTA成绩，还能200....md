...
蚂蚁集团与清华大学联合开源AReaL-boba框架，使普通开发者仅需两天即可训练出7B参数的SOTA推理模型，并能以200美元低成本复现32B规模的QwQ模型。该框架具有训练速度快、推理能力强、成本低廉三大优势，被比喻为"AI界的奶茶三兄弟"——易用、高效且普惠。相关数据、代码和模型已全部开源，显著降低了高性能数学推理模型的开发门槛。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T01:30:46Z
- **目录日期**: 2025-04-05
