...
蚂蚁集团与清华大学联合开源AReaL-boba框架，使普通开发者能在两天内训练出7B参数的SOTA推理模型，仅需200美元即可复现32B大模型QwQ的性能。该框架具备训练快、推理强、低成本三大优势，被比喻为AI界的"奶茶三兄弟"（易获取、高效能、平民化）。其开源内容包括完整数据、代码和模型，显著降低了高性能数学推理模型的开发门槛，有望推动AI技术民主化进程。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T04:03:54Z
- **目录日期**: 2025-04-05
