...
蚂蚁集团与清华大学联合开源AReaL-boba框架，使普通开发者仅需两天即可训练出7B参数模型的SOTA推理性能，并仅用200美元复现32B参数模型QwQ。该框架具有训练快、推理强、成本低的优势，被誉为"AI界的奶茶三兄弟"（易用、高效、普惠）。相关数据、代码和模型已全部开源，显著降低了高性能AI模型的开发门槛。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T00:03:49Z
- **目录日期**: 2025-04-05
