...
马斯克近日展示了Optimus机器人的最新进展，其流畅自然的行走姿态（包括膝盖弯曲和手臂摆动）引发热议。与早期版本对比，网友惊叹其拟人化程度显著提升。同时，特斯拉机器人团队借机发布招聘信息，核心成员集体亮相招揽人才。这段演示凸显了Optimus在运动控制方面的突破性进展。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T01:31:01Z
- **目录日期**: 2025-04-05
