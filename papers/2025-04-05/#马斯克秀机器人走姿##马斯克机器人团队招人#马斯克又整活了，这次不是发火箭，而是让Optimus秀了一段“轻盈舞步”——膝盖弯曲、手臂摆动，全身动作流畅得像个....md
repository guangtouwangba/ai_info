...
马斯克近日展示了Optimus机器人的最新进展，其流畅自然的行走姿态（包括膝盖弯曲和手臂摆动）引发热议。网友对比早期视频后惊叹其拟人化程度。与此同时，特斯拉机器人团队公开招募人才，暗示该项目正在加速推进。这段展示凸显了Optimus在运动控制方面的显著进步。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T04:04:10Z
- **目录日期**: 2025-04-05
