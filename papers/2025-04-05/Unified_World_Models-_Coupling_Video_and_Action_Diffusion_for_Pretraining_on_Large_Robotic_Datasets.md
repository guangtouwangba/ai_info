...
本文提出了统一世界模型（UWM），通过整合动作扩散和视频扩散过程，利用Transformer架构实现多模态学习。UWM能灵活表示策略、动态预测和视频生成，支持大规模机器人多任务数据集预训练，比模仿学习更具泛化性和鲁棒性。此外，UWM通过独立控制扩散时间步，有效利用无动作视频数据提升策略微调性能。实验表明，UWM为利用异构数据实现可扩展机器人学习提供了新思路，并统一了模仿学习与世界建模的范式。代码和视频见项目主页。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T07:01:40Z
- **目录日期**: 2025-04-05
