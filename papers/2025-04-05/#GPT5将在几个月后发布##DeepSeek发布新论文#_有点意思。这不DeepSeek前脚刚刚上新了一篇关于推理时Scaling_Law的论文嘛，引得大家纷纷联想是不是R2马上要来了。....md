...
OpenAI宣布GPT-5将在几个月后发布，效果比预期更好，但因技术整合难度推迟原计划，将先推出o3和o4-mini。与此同时，DeepSeek发布了一篇关于推理时Scaling Law的新论文，引发业界关注。两家公司似乎在技术发布上有所互动，OpenAI的调整被视为对DeepSeek动态的回应。奥特曼解释延迟是因需确保系统能力满足预期需求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T05:02:56Z
- **目录日期**: 2025-04-05
