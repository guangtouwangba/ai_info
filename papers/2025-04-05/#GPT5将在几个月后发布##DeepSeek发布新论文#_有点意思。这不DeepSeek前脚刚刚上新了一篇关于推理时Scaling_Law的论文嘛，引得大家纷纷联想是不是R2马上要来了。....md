...
OpenAI CEO奥特曼宣布GPT-5将推迟至几个月后发布，并表示其效果将超预期，原因是技术整合难度高于预期。同时，OpenAI计划先发布o3和o4-mini模型。这一消息紧随中国AI公司DeepSeek发布关于推理时Scaling Law的新论文后公布，显示出行业竞争的紧密互动。DeepSeek的论文引发了对其新一代模型R2的猜测，而OpenAI的回应似乎意在保持技术领先地位。两家公司的最新动态反映了AI领域快速迭代的竞争态势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T22:03:36Z
- **目录日期**: 2025-04-05
