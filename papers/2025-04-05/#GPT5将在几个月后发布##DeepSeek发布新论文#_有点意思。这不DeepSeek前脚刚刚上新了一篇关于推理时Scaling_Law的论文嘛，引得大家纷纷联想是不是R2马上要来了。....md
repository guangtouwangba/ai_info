# #GPT5将在几个月后发布##DeepSeek发布新论文# 有点意思。这不DeepSeek前脚刚刚上新了一篇关于推理时Scaling Law的论文嘛，引得大家纷纷联想是不是R2马上要来了。...
...
OpenAI CEO奥特曼宣布GPT-5将推迟至几个月后发布，称需更多时间整合技术以满足预期需求，并透露将先推出o3和o4-mini过渡版本。与此同时，中国团队DeepSeek刚发布关于推理Scaling Law的新论文，引发行业对R2模型即将问世的猜测。两大AI研发机构近期动作形成微妙联动，反映出全球AI竞赛的激烈态势。OpenAI此次调整计划表明其对GPT-5性能提升持谨慎态度，而DeepSeek的论文成果则显示中国在AI基础研究领域的快速进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T15:03:50Z
- **目录日期**: 2025-04-05
