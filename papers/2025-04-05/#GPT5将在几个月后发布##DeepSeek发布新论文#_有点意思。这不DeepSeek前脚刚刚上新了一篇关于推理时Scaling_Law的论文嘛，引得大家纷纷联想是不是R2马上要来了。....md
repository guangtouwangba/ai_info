...
OpenAI宣布GPT-5将在几个月后发布，效果将超出预期，但因技术整合难度推迟原计划，期间可能先发布o3和o4-mini版本。与此同时，DeepSeek发布了一篇关于推理时Scaling Law的新论文，引发业界对其新模型R2的猜测。两家公司在AI领域的技术竞争日趋明显，OpenAI此次调整计划被外界视为对DeepSeek动态的回应。双方均聚焦提升模型性能与扩展能力，但OpenAI强调需确保系统足够稳定以支持预期需求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T12:03:57Z
- **目录日期**: 2025-04-05
