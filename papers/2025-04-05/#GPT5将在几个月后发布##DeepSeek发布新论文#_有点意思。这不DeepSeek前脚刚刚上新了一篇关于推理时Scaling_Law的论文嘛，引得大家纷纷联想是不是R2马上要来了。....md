...
OpenAI宣布GPT-5将在几个月后发布，效果可能超出预期，但需更多时间整合资源。同时，DeepSeek发布新论文引发关注，OpenAI随即调整计划，表示将先发布o3和o4-mini模型。两家公司在AI领域的竞争态势明显，OpenAI强调需确保能力满足预期需求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T16:03:39Z
- **目录日期**: 2025-04-05
