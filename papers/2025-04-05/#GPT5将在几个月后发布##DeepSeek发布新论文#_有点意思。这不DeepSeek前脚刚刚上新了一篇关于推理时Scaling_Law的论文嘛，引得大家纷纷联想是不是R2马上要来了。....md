...
OpenAI宣布GPT-5将在几个月后发布，效果比预期更好，但需先推出o3和o4-mini过渡版本。Sam Altman解释因技术整合难度超出预期，需确保系统能力满足需求。与此同时，DeepSeek刚发布关于推理时Scaling Law的新论文，引发行业关注。两家公司动态显示AI领域竞争加剧，技术迭代速度持续加快。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T14:03:52Z
- **目录日期**: 2025-04-05
