...
OpenAI宣布GPT-5将在几个月后发布，效果可能超预期，但需更多时间整合资源以满足需求。此前，DeepSeek刚发布关于推理时Scaling Law的新论文，引发业界关注。OpenAI同时计划先推出o3和o4-mini版本。双方动态显示AI领域竞争激烈，技术迭代加速。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T08:03:35Z
- **目录日期**: 2025-04-05
