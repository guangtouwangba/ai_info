...
OpenAI宣布GPT-5将在几个月后发布，效果可能超出预期，但需更多时间整合资源。此前计划先推出o3和o4-mini模型。与此同时，DeepSeek发布了一篇关于推理时Scaling Law的新论文，引发业界关注。两家公司似乎在技术发布上形成竞争态势。OpenAI解释延迟是因技术整合难度高于预期，需确保系统能力满足需求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T11:03:44Z
- **目录日期**: 2025-04-05
