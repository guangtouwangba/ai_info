...
OpenAI宣布GPT-5将在几个月后发布，效果将超出预期，但需更多时间整合资源以满足需求。此前计划先发布o3和o4-mini模型。与此同时，DeepSeek发布了一篇关于推理时Scaling Law的新论文，引发业界关注。两大AI研究机构近期动作频繁，形成竞争态势。OpenAI的调整显示其对产品部署的谨慎态度，而DeepSeek的论文进展则体现了其在技术前沿的持续探索。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T20:03:28Z
- **目录日期**: 2025-04-05
