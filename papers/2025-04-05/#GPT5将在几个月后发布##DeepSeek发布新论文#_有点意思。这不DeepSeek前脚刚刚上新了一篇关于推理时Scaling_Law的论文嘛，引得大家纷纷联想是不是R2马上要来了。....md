...
OpenAI宣布GPT-5将在几个月后发布，效果可能超出预期，但需更多时间整合资源。同时，DeepSeek发布了一篇关于推理时Scaling Law的新论文，引发业界关注。OpenAI CEO奥特曼表示，计划先推出o3和o4-mini版本，以应对开发GPT-5的挑战。两大AI机构的最新动态显示行业竞争激烈，技术迭代加速。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T09:03:35Z
- **目录日期**: 2025-04-05
