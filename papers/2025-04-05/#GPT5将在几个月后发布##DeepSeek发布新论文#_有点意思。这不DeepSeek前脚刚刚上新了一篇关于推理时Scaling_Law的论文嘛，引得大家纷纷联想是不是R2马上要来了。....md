...
OpenAI宣布GPT-5将在几个月后发布，性能可能超出预期，但需更多时间整合资源。同时，OpenAI计划先推出o3和o4-mini模型。此前，DeepSeek发布了一篇关于推理时Scaling Law的新论文，引发行业关注。OpenAI的举动被视为对DeepSeek进展的回应。两家公司在AI领域的竞争持续升温。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T18:03:37Z
- **目录日期**: 2025-04-05
