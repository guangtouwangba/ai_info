...
OpenAI CEO奥特曼表示GPT-5将推迟至几个月后发布，效果会比预期更好，原因是技术整合难度超出预期。同时OpenAI计划先发布o3和o4-mini模型。这一消息恰逢中国团队DeepSeek发布关于推理扩展律的新论文，引发业内对双方技术竞争的关注。奥特曼强调需确保系统能力足以支撑预期需求，暗示GPT-5将带来重大升级。行业观察显示，当前AI领域呈现中美团队交替推进的技术竞赛态势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T13:07:54Z
- **目录日期**: 2025-04-05
