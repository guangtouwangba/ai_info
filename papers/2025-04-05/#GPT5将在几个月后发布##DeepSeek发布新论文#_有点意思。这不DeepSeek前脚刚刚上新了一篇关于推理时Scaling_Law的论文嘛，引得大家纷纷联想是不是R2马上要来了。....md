...
OpenAI计划调整产品发布节奏，将在几周后先推出o3和o4-mini模型，而备受期待的GPT-5预计推迟至几个月后发布。Sam Altman解释称整合工作比预期更复杂，需要确保系统能力满足需求。与此同时，DeepSeek刚发布了一篇关于推理时Scaling Law的新论文，引发业内对其新模型R2的猜测。两大AI研究机构近期动作频频，显示出行业竞争的激烈态势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T06:03:18Z
- **目录日期**: 2025-04-05
