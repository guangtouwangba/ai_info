...
OpenAI宣布GPT-5将在几个月后发布，效果比预期更好，但需先推出o3和o4-mini过渡版本。Sam Altman解释因技术整合复杂，需确保系统能力满足需求。与此同时，DeepSeek发布关于推理时Scaling Law的新论文，引发行业关注。两大AI机构动态显示技术竞争加剧，OpenAI此次调整被外界视为对DeepSeek进展的回应。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T19:03:10Z
- **目录日期**: 2025-04-05
