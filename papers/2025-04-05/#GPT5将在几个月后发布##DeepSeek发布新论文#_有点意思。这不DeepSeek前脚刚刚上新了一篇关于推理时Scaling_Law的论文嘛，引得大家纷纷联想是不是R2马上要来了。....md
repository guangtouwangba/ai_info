...
OpenAI宣布GPT-5将在几个月后发布，效果可能超出预期，但需更多时间整合资源。同时，OpenAI计划先推出o3和o4-mini模型。这一消息紧随DeepSeek发布关于推理时Scaling Law的新论文后，引发行业关注。DeepSeek的论文可能暗示其新模型R2即将推出。两家公司在AI领域的动态显示竞争加剧，OpenAI此次调整计划可能意在回应行业进展，同时确保GPT-5的发布质量。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T10:03:31Z
- **目录日期**: 2025-04-05
