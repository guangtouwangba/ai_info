...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和科研动态订阅等一站式服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持中英文文献搜索，并能通过AI生成摘要和问答互动帮助用户快速理解内容。此外，用户可定制科研情报推送，跟踪关注的学者或领域。平台还包含学者画像、学术会议等特色功能，基础服务免费开放。访问入口：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T03:16:05Z
- **目录日期**: 2025-04-05
