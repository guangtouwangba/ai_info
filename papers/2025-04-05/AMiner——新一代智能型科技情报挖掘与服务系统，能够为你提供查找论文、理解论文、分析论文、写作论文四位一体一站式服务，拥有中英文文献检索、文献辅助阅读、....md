...
AMiner是一个智能科技情报平台，提供一站式学术服务，包括中英文文献检索、辅助阅读、翻译和科研订阅。其数据库涵盖42个学科3.5亿论文、0.6亿学者和1.5亿专利。用户可通过智能问答快速获取文献摘要，支持PDF上传和AI辅助分析。平台还提供个性化科研动态推送，追踪学者、机构及关键词更新。主要功能包括文献检索、自动摘要生成、学术翻译及学者画像分析，适合研究者高效获取和管理学术资源。免费使用入口：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T07:05:58Z
- **目录日期**: 2025-04-05
