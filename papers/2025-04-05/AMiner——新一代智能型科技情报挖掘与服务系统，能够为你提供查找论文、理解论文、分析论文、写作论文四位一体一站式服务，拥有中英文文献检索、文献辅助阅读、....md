...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、阅读辅助和科研动态订阅等一站式服务。它收录3.5亿论文、0.6亿学者和1.5亿专利，支持中英文文献搜索、AI摘要生成和互动问答。用户可上传PDF获取章节概要和问题建议，或订阅个性化科研情报推送。平台还提供学者画像、学术会议等特色功能，基础服务免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T15:06:21Z
- **目录日期**: 2025-04-05
