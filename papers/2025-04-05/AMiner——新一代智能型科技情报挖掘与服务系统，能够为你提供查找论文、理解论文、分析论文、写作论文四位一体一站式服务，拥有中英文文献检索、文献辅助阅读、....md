...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、科研情报订阅等一站式服务。它拥有3.5亿论文、0.6亿学者等海量学术资源，支持AI生成摘要、辅助阅读和互动问答，帮助用户快速理解文献内容。平台还提供个性化订阅功能，可根据用户偏好推送最新科研动态。此外，AMiner具备学者画像、学术会议追踪等特色功能，浏览器版可免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T17:05:34Z
- **目录日期**: 2025-04-05
