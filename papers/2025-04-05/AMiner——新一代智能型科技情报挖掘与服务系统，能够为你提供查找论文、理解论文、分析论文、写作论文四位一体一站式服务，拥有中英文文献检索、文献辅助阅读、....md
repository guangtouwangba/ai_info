...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索（覆盖3.5亿论文）、AI辅助阅读（自动生成摘要/问答）、文档翻译及科研情报订阅（定制化推送最新成果）。其特色功能包含学者画像、会议追踪和必读论文推荐，支持用户通过关键词/学者/机构订阅动态，并通过微信或邮件接收。平台整合了42学科资源，含1.5亿专利和2600万项目数据，基础功能可免费使用，显著提升文献调研与论文写作效率。访问入口：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T21:05:34Z
- **目录日期**: 2025-04-05
