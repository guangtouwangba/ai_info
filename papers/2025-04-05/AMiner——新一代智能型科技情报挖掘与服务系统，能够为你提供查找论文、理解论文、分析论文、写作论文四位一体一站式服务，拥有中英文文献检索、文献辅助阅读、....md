...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译、科研订阅等一站式服务。它支持中英文文献搜索，能自动生成摘要和问答互动，帮助用户快速理解论文内容。平台拥有3.5亿论文、0.6亿学者等海量数据，并提供个性化科研动态推送。用户可通过网页或微信小程序免费使用其核心功能，包括文献分析、学者画像等，显著提升学术研究效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T08:06:11Z
- **目录日期**: 2025-04-05
