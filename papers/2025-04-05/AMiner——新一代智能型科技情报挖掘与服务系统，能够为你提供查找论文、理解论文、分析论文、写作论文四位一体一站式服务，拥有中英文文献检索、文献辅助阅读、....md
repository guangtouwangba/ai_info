...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务。主要功能包括：1）中英文文献检索，支持互动问答和自动摘要生成；2）英文文献翻译，可上传PDF并获取AI生成的摘要和问答解析；3）科研情报订阅，根据用户偏好推送最新学术动态。平台涵盖3.5亿论文、0.6亿学者等海量数据，并提供学者画像、学术会议等辅助功能。浏览器版可免费使用，旨在提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T20:05:40Z
- **目录日期**: 2025-04-05
