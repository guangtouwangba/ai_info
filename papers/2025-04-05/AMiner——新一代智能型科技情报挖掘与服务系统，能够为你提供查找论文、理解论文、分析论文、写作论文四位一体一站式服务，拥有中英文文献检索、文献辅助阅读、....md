...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读辅助、翻译及写作支持等一站式服务。平台收录3.5亿论文、0.6亿学者及海量专利数据，支持中英文文献检索、AI生成摘要、互动问答和文档翻译功能。用户可订阅个性化科研动态，追踪学者及机构最新成果。其特色包括文献智能解析、学术趋势分析及免费基础服务，适用于高效获取和管理学术资源。访问入口：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T04:05:37Z
- **目录日期**: 2025-04-05
