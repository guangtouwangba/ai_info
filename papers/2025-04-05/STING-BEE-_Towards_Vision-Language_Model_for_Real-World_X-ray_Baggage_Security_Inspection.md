...
该研究介绍了首个多模态X射线行李安检数据集STCray，包含46,642张图像-文本配对的扫描图像，涵盖21种威胁类别。通过专门设计的标注协议生成领域感知的连贯描述，用于训练视觉AI助手STING-BEE。该模型支持多种视觉语言任务，包括场景理解、威胁定位、视觉基础和问答，为X射线安检领域的多模态学习建立了新基准。STING-BEE在跨域设置中表现出优异的泛化能力。相关代码、数据和模型已开源。该研究解决了现有数据集在真实威胁和隐藏手法表征不足的问题，突破了封闭式标签范式的限制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T17:00:55Z
- **目录日期**: 2025-04-05
