...
STCray是首个多模态X射线行李安检数据集，包含46,642张图像-文本配对的扫描图，涵盖21种威胁类别，通过机场安检X光扫描仪生成。该数据集采用专业协议开发，确保领域感知和连贯的文本描述，支持多模态指令跟随数据。基于此，研究人员训练了领域感知视觉AI助手STING-BEE，支持场景理解、威胁定位、视觉定位和视觉问答等任务，为X射线行李安检的多模态学习设定了新基准。STING-BEE在跨域场景中展现出先进的泛化能力。相关代码、数据和模型已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T21:01:04Z
- **目录日期**: 2025-04-05
