...
研究人员开发了首个多模态X射线行李安检数据集STCray，包含46,642张图像-文本配对扫描图，涵盖21类威胁物品。该数据集采用专业协议生成，确保领域相关的连贯描述。基于此，团队训练了视觉AI助手STING-BEE，支持场景理解、威胁定位、视觉问答等多模态任务，在X射线安检领域建立了新基准。STING-BEE在跨域场景中展现出优异的泛化能力。该研究解决了现有数据集在真实威胁表示和封闭集标签方面的局限，推动了计算机辅助安检系统的发展。相关代码、数据和模型已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T04:01:09Z
- **目录日期**: 2025-04-05
