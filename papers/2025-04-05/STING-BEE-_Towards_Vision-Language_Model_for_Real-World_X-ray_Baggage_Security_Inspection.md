...
本文介绍了STCray数据集，这是首个多模态X射线行李安检数据集，包含46,642张图像-文本配对的扫描图像，涵盖21种威胁类别，专为提升安检威胁检测而设计。通过专门协议生成领域感知的连贯文本描述，支持多模态指令跟随数据。基于此，研究者训练了领域感知视觉AI助手STING-BEE，能够执行场景理解、威胁定位、视觉定位和视觉问答等任务，在多模态X射线安检学习中建立了新基准。STING-BEE在跨域设置中表现出优异的泛化能力。相关代码、数据和模型已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T22:01:02Z
- **目录日期**: 2025-04-05
