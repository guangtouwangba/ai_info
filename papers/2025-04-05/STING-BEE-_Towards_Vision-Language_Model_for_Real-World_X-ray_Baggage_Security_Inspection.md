...
该研究介绍了首个多模态X射线行李安检数据集STCray，包含46,642张图像-文本配对的扫描图，涵盖21种威胁类别。通过专业协议生成领域感知的连贯描述，研究团队训练了视觉AI助手STING-BEE，支持场景理解、威胁定位、视觉问答等多模态任务，为X射线安检设定了新基准。STING-BEE在跨域场景中展现出先进的泛化能力。该工作解决了现有数据集在真实威胁表征和封闭集范式上的局限性，推动了计算机辅助安检系统的发展。代码、数据和模型已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T13:04:45Z
- **目录日期**: 2025-04-05
