...
大型视觉语言模型(VLMs)为AI驱动的图像理解提供了新范式，无需特定任务训练即可执行任务。研究表明，在17项外科AI视觉任务(从解剖识别到技能评估)中，11种先进VLM表现出良好的泛化能力，有时甚至优于监督模型。上下文学习可将性能提升三倍，显示其适应性强项。但需要空间或时间推理的任务仍具挑战性。虽然医学领域专家标注数据稀缺，但VLMs在外科等干预性领域的实际效用仍待验证。该研究为VLM在临床和现实复杂动态场景中的应用潜力提供了重要见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T11:01:28Z
- **目录日期**: 2025-04-05
