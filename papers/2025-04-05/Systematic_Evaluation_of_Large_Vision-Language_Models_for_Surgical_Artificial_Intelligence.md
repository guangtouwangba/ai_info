...
大型视觉语言模型(VLMs)为AI驱动的图像理解提供了新范式，无需特定任务训练即可执行多种任务。在医学领域，特别是外科手术这种决策主观、场景多变的干预性领域，VLMs展现出良好潜力。研究评估了11种先进VLM在17个外科AI任务(从解剖识别到技能评估)上的表现，发现其具有出色的泛化能力，有时甚至超越监督模型。上下文学习可将性能提升三倍，但时空推理任务仍具挑战。该研究不仅揭示了VLM在外科应用中的价值，也为其他复杂动态场景的临床应用提供了重要参考。(100字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T02:26:49Z
- **目录日期**: 2025-04-05
