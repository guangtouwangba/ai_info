...
大型视觉语言模型(VLMs)为AI驱动的图像理解提供了新范式，无需特定任务训练即可执行任务。在医学领域，尤其是手术这种决策主观且临床场景多变的干预性领域，VLMs展现出良好泛化能力。研究测试了11种先进VLM在17个外科AI任务(从解剖识别到技能评估)的表现，发现其有时能超越监督模型，上下文学习可将性能提升三倍，表明适应能力是其关键优势。但需要时空推理的任务仍具挑战性。这些发现不仅适用于外科，也为VLM在复杂动态临床场景和现实应用中的潜力提供了见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T01:28:25Z
- **目录日期**: 2025-04-05
