...
大型视觉语言模型（VLM）为AI驱动的图像理解提供了新范式，无需任务特定训练即可执行任务，在医疗等专家标注数据稀缺的领域潜力显著。研究评估了11种先进VLM在17项外科AI视觉任务（从解剖识别到技能评估）的表现，涵盖13个腹腔镜、机器人和开放手术数据集。结果表明，VLM展现出良好的泛化能力，有时在非训练场景下优于监督模型。上下文学习可将性能提升三倍，突显其适应性强项，但空间或时间推理任务仍具挑战。该研究为VLM在临床及动态现实场景的应用提供了重要参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T20:01:22Z
- **目录日期**: 2025-04-05
