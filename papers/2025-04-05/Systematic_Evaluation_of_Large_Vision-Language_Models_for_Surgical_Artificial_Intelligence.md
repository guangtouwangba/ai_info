...
大型视觉语言模型(VLMs)为AI驱动的图像理解提供了新范式，无需任务特定训练即可执行任务。研究表明，在手术AI领域的17项视觉理解任务中，11种先进VLMs展现出良好泛化能力，有时甚至优于监督模型。情境学习使性能提升高达三倍，突显其适应能力优势。然而，需要时空推理的任务仍具挑战性。这些发现不仅对稀缺专家标注数据的医疗领域具有价值，也为VLMs在临床和其他动态复杂场景中的应用潜力提供了重要见解。研究覆盖了腹腔镜、机器人和开放手术等13个数据集。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T23:01:28Z
- **目录日期**: 2025-04-05
