...
大型视觉语言模型(VLMs)为AI驱动的图像理解提供了新范式，无需任务特定训练即可执行任务。研究表明，在手术AI领域的17项视觉理解任务中，11种先进VLMs展现出良好泛化能力，有时甚至优于监督模型。上下文学习可将性能提升三倍，表明适应性是其关键优势。然而，需要空间或时间推理的任务仍具挑战性。这些发现不仅揭示了VLMs在手术领域的潜力，也为临床和其他动态复杂场景的应用提供了重要见解。研究基于13个涵盖腹腔镜、机器人和开放手术的数据集展开。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T04:01:28Z
- **目录日期**: 2025-04-05
