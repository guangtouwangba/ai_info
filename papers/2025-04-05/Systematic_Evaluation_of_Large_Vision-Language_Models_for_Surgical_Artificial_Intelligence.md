...
大型视觉语言模型(VLMs)为AI驱动的图像理解提供了新范式，无需特定任务训练即可执行任务。在医学领域，尤其是手术场景中，VLMs展现出良好的泛化能力，有时甚至优于监督模型。研究表明，上下文学习能使性能提升三倍，突显其适应性的优势。然而，需要时空推理的任务仍具挑战性。研究评估了11种先进VLM在17个外科AI任务(从解剖识别到技能评估)的表现，涵盖13个腹腔镜、机器人和开放手术数据集。这些发现不仅对手术AI有重要意义，也为VLM在复杂临床和现实场景中的应用提供了参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T14:01:26Z
- **目录日期**: 2025-04-05
