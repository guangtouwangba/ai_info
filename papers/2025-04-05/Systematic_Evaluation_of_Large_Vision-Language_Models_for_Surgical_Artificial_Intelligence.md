...
大型视觉语言模型(VLMs)为AI驱动的图像理解提供了新范式，无需特定任务训练即可执行任务。在医学领域，尤其是外科手术这类决策主观且场景多变的干预性领域，VLMs展现出良好泛化能力，有时甚至超越监督模型。研究表明，上下文学习可将性能提升三倍，体现其适应性强项，但空间和时间推理任务仍具挑战。研究通过11个先进VLMs在17个外科AI任务(从解剖识别到技能评估)上的测试，使用13个涵盖腹腔镜、机器人和开放手术的数据集，为VLMs在临床和现实复杂场景中的应用潜力提供了重要见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T05:01:29Z
- **目录日期**: 2025-04-05
