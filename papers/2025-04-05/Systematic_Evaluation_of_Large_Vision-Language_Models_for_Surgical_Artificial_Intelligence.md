...
大型视觉语言模型(VLMs)为AI驱动的图像理解提供了新范式，无需任务特定训练即可执行任务。在医学领域，特别是专家标注数据稀缺的手术场景中，VLMs展现出应用潜力。研究评估了11种先进VLM在17项外科AI任务(从解剖识别到技能评估)的表现，使用13个涵盖多种手术方式的数据集。结果显示，VLMs具有良好的泛化能力，有时在非训练环境中表现优于监督模型。上下文学习可将性能提升三倍，表明适应性是其优势。但需要时空推理的任务仍具挑战性。这些发现为VLM在临床和其他动态场景中的应用提供了见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T03:11:32Z
- **目录日期**: 2025-04-05
