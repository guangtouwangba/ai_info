...
研究表明，当两个AI模型在相同科学任务上训练时，它们可能学习相同或不同的理论，这与科学史上理论随实验数据增加而收敛的现象类似。通过提出的MASS框架（哈密顿-拉格朗日神经网络）分析发现：在简单系统中AI倾向于学习哈密顿理论，而复杂系统则转向拉格朗日理论。训练动态和最终权重表现出强烈的随机种子依赖性，这决定了相关理论的"兴衰"。该神经网络不仅增强了可解释性，还能应用于高维问题。多组训练结果显示，随着数据量增加，AI理论会趋于收敛，但有时仍会形成不同理论群体。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T16:01:05Z
- **目录日期**: 2025-04-05
