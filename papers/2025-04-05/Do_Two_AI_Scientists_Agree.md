...
研究表明，当两个AI模型在相同科学任务上训练时，它们可能学习不同理论，但随着训练数据的增加，其理论会趋于收敛。研究者提出MASS方法（哈密顿-拉格朗日神经网络），通过模拟不同AI科学家的训练过程发现：在简单系统中，AI倾向于学习哈密顿理论；而面对复杂系统时，会转向拉格朗日理论。训练动态和最终权重表现出强烈的随机种子依赖性，这决定了相关理论的兴衰。该方法不仅能增强模型可解释性，还可应用于高维问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T17:01:04Z
- **目录日期**: 2025-04-05
