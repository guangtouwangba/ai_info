...
研究表明，当两个AI模型在同一科学任务上训练时，它们可能学习相同或不同的理论，这与科学史上理论随实验数据增加而收敛的现象类似。研究者通过MASS框架（哈密顿-拉格朗日神经网络）发现，AI科学家在简单系统中倾向于学习哈密顿理论，而在复杂系统中转向拉格朗日理论。训练动态和最终权重表现出强烈的随机种子依赖性，这影响了相关理论的选择。该神经网络不仅增强了可解释性，还能应用于更高维度的问题。实验表明，随着训练数据中系统数量的增加，AI学习的理论会趋于一致，但有时仍会形成不同理论群体。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T08:01:17Z
- **目录日期**: 2025-04-05
