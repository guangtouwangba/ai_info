...
研究表明，当两个AI模型在相同科学任务上训练时，它们可能学习到不同理论，但随着训练数据增加，理论会趋于收敛。研究者提出MASS框架，通过哈密顿-拉格朗日神经网络模拟AI科学家，发现简单系统中AI倾向于学习哈密顿理论，复杂系统则转向拉格朗日理论。训练动态和最终权重表现出强烈的随机种子依赖性，这决定了不同理论的兴衰。该神经网络不仅能增强可解释性，还可应用于高维问题。实验表明，AI科学家的理论选择与人类科学发展类似，都受数据量和系统复杂性的影响。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T10:01:09Z
- **目录日期**: 2025-04-05
