...
研究表明，当两个AI模型在同一科学任务上训练时，它们可能学习相同或不同的理论，这取决于训练数据的丰富程度。随着训练数据中系统数量的增加，AI模型的理论会趋于收敛，但有时仍会形成不同理论的分组。研究者提出MASS框架，通过哈密顿-拉格朗日神经网络模拟AI科学家，发现简单系统下AI倾向于学习哈密顿理论，而复杂系统下转向拉格朗日理论。训练动态和最终权重表现出强烈的随机种子依赖性，影响相关理论的兴衰。该方法不仅能增强可解释性，还可应用于高维问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T12:01:26Z
- **目录日期**: 2025-04-05
