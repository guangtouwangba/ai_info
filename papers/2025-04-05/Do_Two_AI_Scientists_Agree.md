...
研究表明，当两个AI模型在相同科学任务上训练时，它们可能学习不同理论，但随着训练数据增加，理论会趋于收敛。研究者提出MASS框架，利用哈密顿-拉格朗日神经网络模拟AI科学家，发现简单系统下AI倾向于哈密顿理论，复杂系统则转向拉格朗日理论。训练动态和最终权重表现出强种子依赖性，影响理论的兴衰。该方法不仅能解释AI学习机制，还可应用于高维问题。实验表明，AI科学家的理论选择与人类科学发展类似，数据量增加会约束理论空间。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T04:01:19Z
- **目录日期**: 2025-04-05
