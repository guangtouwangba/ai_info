...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟超过1万个代理的互动行为和复杂社会环境。研究者利用该平台研究了社会极化、信息传播、基本收入政策及自然灾害影响等社会问题，其模拟结果与现实世界数据高度吻合。该系统展示了作为计算社会科学工具的强大潜力，能够帮助研究者分析社会现象的内在机制，并为政策制定提供数据支持。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T19:04:41Z
- **目录日期**: 2025-04-05
