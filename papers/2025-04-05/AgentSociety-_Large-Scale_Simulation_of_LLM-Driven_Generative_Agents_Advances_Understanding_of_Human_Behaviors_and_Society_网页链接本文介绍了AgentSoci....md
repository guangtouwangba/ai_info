...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟10,000+智能代理的社会互动（500万次交互）。该平台被用于研究四大社会问题：群体极化、敏感信息传播、基本收入政策影响和自然灾害应对。其模拟结果与现实世界数据高度吻合，验证了模型对人类行为机制和社会动态的捕捉能力。该系统为社会科学研究和政策制定提供了新型计算实验工具，能够辅助传统研究方法（如调查、干预实验），帮助揭示社会问题的深层模式和形成机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T13:09:47Z
- **目录日期**: 2025-04-05
