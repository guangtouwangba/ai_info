...
AgentSociety是一个基于大语言模型的大规模社会模拟器，能模拟1万多个代理的社会互动（500万次）。它用于研究极化现象、信息传播、基本收入政策和外部冲击（如飓风）等社会问题，结果与现实实验吻合。该系统结合LLM代理、真实社会环境和强大模拟引擎，可作为计算社会科学实验平台，帮助理解人类行为机制，并为研究者和政策制定者提供新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T09:05:36Z
- **目录日期**: 2025-04-05
