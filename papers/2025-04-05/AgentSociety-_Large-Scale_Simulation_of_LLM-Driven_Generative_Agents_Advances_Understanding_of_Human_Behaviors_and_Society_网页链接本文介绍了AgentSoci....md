...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟器，能够模拟超过1万个AI代理的社会互动（共500万次）。研究者将其作为计算社会科学实验平台，研究了社会极化、信息传播、基本收入政策及自然灾害影响等四大社会问题。模拟结果与现实世界数据高度吻合，证明了该系统在捕捉人类行为机制方面的有效性。该工具为社会科学研究和政策制定提供了创新方法，能够辅助传统研究手段（如调查和干预）来深入分析社会问题的成因与模式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T22:05:11Z
- **目录日期**: 2025-04-05
