...
AgentSociety是一种基于大语言模型的大规模社会模拟器，可模拟10,000多个代理及其500万次互动。研究者用它分析四个社会问题：极化现象、刺激性信息传播、无条件基本收入政策及飓风等外部冲击的影响。模拟结果与现实实验数据吻合，验证了该系统捕捉人类行为机制的能力。该工具为社会科学研究和政策制定提供了新方法，可辅助传统调查和干预研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T08:05:40Z
- **目录日期**: 2025-04-05
