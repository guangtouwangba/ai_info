...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟1万个代理的社会生活及500万次互动。研究者用它作为计算社会科学实验平台，研究了社会极化、信息传播、基本收入政策及外部冲击（如飓风）等社会问题。其模拟结果与现实世界实验数据吻合，验证了该工具在捕捉人类行为机制方面的能力。该研究展示了AgentSociety作为社会科学研究和政策制定工具的潜力，能够辅助传统研究方法（如调查、访谈）深入分析社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T16:05:21Z
- **目录日期**: 2025-04-05
