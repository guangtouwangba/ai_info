...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟1万多个AI代理的社会互动（500万次）。研究者用它研究了社会极化、信息传播、基本收入政策及自然灾害影响等社会问题，结果与现实数据吻合。该系统展现了作为社会科学研究工具和决策支持平台的潜力，能帮助理解人类行为机制并验证政策效果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T02:30:59Z
- **目录日期**: 2025-04-05
