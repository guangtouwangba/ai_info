...
大型AI模型虽然在标准化测试中表现优异，但在医疗、教育、法律等高风险领域应用时仍存在明显缺陷，如对输入数据微小变化的脆弱性、关键场景下缺乏情境感知的决策，以及自信地产生错误信息等问题。为此，研究提出了一种分层创新框架，通过模块化方法将大模型转化为实用的垂直系统，并强调各层级间的动态协调。该框架能帮助研究者：(1)定位创新方向，(2)发现跨领域共性问题以开发实用基础模型，(3)促进跨学科交流。案例研究表明，该框架可有效弥合AI能力与实际应用需求之间的差距。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T12:01:47Z
- **目录日期**: 2025-04-05
