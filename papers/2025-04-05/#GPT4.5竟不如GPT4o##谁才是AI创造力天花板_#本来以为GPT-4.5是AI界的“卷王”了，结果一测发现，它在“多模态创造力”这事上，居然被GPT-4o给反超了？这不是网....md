...
浙江大学与上海AI Lab合作开发了名为Creation-MMBench的新基准测试，专门评估AI模型的多模态创造力（如基于图像生成故事、设计等）。测试结果显示，GPT-4.5在创意任务上的表现反而不如GPT-4o，后者展现出更强的多模态创造能力。该研究通过量化指标挑战了"版本越高性能越强"的常规认知，为AI创造力评估提供了新标准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T09:04:29Z
- **目录日期**: 2025-04-05
