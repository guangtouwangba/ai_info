# #GPT4.5竟不如GPT4o##谁才是AI创造力天花板 #本来以为GPT-4.5是AI界的“卷王”了，结果一测发现，它在“多模态创造力”这事上，居然被GPT-4o给反超了？这不是网...
...
浙江大学与上海AI Lab联合开发了名为Creation-MMBench的新基准测试，专门评估多模态AI模型的创造力表现。测试发现GPT-4.5在图像理解基础上的创意产出（如故事创作、设计构思等）方面表现不如GPT-4o，后者展现出更强的多模态创造力。该基准聚焦AI作为"创意工作者"的能力上限，通过系统性测试揭示了不同模型在创造性任务中的性能差异。这一发现挑战了此前关于模型迭代必然提升所有能力的假设，为AI创造力评估提供了新标准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T06:04:06Z
- **目录日期**: 2025-04-05
