...
浙江大学与上海AI Lab合作开发了名为Creation-MMBench的新基准测试，专门评估AI在多模态创造力方面的表现（如基于图像生成故事、设计等）。测试结果显示，GPT-4.5在"多模态创造力"上意外落后于GPT-4o，颠覆了此前认为GPT-4.5性能更强的预期。该研究通过量化指标揭示了不同AI模型在创意工作领域的实际能力差异，为评估AI创造力提供了新标准。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T04:03:16Z
- **目录日期**: 2025-04-05
