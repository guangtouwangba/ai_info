...
本文提出了一种在LHC上测量$|V_{cb}|$的新方法，通过先进的"bc签名"喷注重子标记技术，将$W \rightarrow bc$信号与来自顶夸克衰变的$bc$匹配喷注关联，实现了标记器的现场校准。该方法显著抑制背景噪声并降低风味标记效率的不确定性，结合新型AI驱动的Sophon和SophonAK4标记器（性能与ATLAS和CMS最先进标记器相当），在HL-LHC条件下可使$|V_{cb}|$测量精度提高约30%。作为副产品，该方法还将$H^{\pm} \rightarrow bc$的搜索灵敏度比ATLAS Run 2结果提升了2-5倍，为LHC探索新的增强区域提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T04:02:19Z
- **目录日期**: 2025-04-05
