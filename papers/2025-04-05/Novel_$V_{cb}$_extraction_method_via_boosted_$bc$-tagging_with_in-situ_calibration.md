...
本文提出了一种在LHC上测量$|V_{cb}|$的新方法，通过使用先进的"bc签名"增强喷注重子标记器（Sophon和新型SophonAK4），结合来自顶夸克衰变的$bc$匹配喷注，实现了标记器的原位校准。该方法显著抑制背景噪声并降低味道标记效率的不确定性，使$|V_{cb}|$测量精度提高约30%（基于HL-LHC预测）。作为副产品，该方法还将$H^{\pm} \rightarrow bc$搜索灵敏度比ATLAS Run 2结果提高了2-5倍。研究展示了先进标记模型在LHC探索未开发增强区域的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T03:12:26Z
- **目录日期**: 2025-04-05
