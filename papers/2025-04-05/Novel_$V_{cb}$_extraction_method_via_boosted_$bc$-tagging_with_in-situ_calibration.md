...
本文提出了一种利用先进喷注重子标记技术（"bc标记"）在LHC上测量$|V_{cb}|$的新方法。通过将$W \rightarrow bc$信号与顶夸克衰变的$bc$匹配喷注关联，实现了标记器的原位校准。该方法显著抑制背景并降低味道标记效率的不确定性，结合AI开发的大/小半径标记器Sophon和SophonAK4（性能匹配ATLAS/CMS最先进技术），在HL-LHC条件下可使$|V_{cb}|$测量精度提高约30%。作为副产品，该方法还将$H^{\pm} \rightarrow bc$的探测灵敏度较ATLAS Run 2结果提升了2-5倍，为LHC探索未被研究的boosted态开辟了新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T14:02:27Z
- **目录日期**: 2025-04-05
