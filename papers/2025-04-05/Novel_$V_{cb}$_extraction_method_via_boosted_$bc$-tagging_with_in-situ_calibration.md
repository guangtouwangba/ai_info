...
本文提出了一种在LHC上测量$|V_{cb}|$的新方法，利用先进的"bc标记器"识别增强喷流中的$bc$信号。通过将$W \rightarrow bc$信号与顶夸克衰变的$bc$匹配喷流关联，实现了标记器的原位校准。该方法显著抑制背景并降低味道标记效率的不确定性，使$|V_{cb}|$测量精度提高约30%。基于AI开发的大/小半径标记器Sophon和SophonAK4性能达到ATLAS/CMS先进水平。该方法还能将$H^{\pm} \rightarrow bc$搜索灵敏度提升2-5倍，为LHC探索增强区域提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T11:02:32Z
- **目录日期**: 2025-04-05
