...
本文提出了一种在LHC上测量$|V_{cb}|$的新方法，利用先进的"bc标记器"识别增强喷流中的$W\rightarrow bc$信号，并通过与顶夸克衰变的$bc$喷流关联实现标记器原位校准。该方法显著抑制背景并降低风味标记效率的不确定性，结合AI开发的大/小半径标记器(Sophon和SophonAK4)，在高亮度LHC条件下可使$|V_{cb}|$测量精度提高约30%。作为副产品，该方法还将$H^{\pm}\rightarrow bc$搜索灵敏度比ATLAS Run 2结果提升2-5倍，为LHC探索增强区域提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T18:02:19Z
- **目录日期**: 2025-04-05
