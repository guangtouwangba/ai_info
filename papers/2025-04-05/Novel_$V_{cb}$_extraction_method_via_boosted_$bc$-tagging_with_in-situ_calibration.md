...
本文提出了一种在LHC测量$|V_{cb}|$的新方法，通过先进的"bc标记器"识别增强喷流中的$bc$信号。该方法利用顶夸克衰变产生的$bc$匹配喷流对标记器进行原位校准，显著抑制背景并降低风味标记效率的不确定性。结合新型AI标记器Sophon和SophonAK4（性能达到ATLAS/CMS顶级水平），相比传统小半径喷流方法，在高亮度LHC条件下可将$|V_{cb}|$测量精度提高约30%。作为副产品，该方法还能将$H^{\pm} \rightarrow bc$的探测灵敏度比ATLAS Run 2结果提升2-5倍，为LHC探索增强区域提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T07:02:11Z
- **目录日期**: 2025-04-05
