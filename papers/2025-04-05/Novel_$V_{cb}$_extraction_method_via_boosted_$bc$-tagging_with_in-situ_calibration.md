...
本文提出了一种在LHC测量$|V_{cb}|$的新方法，利用先进的增强喷射标记器识别"bc签名"。通过将增强的$W \rightarrow bc$信号与顶夸克衰变产生的$bc$匹配喷射关联，实现了标记器的原位校准。该方法显著抑制背景噪声，降低了味道标记效率的不确定性，使测量精度提高约30%。研究采用了基于AI的大/小半径标记器Sophon和SophonAK4，性能与ATLAS和CMS最先进的标记器相当。该方法还能将$H^{\pm} \rightarrow bc$搜索灵敏度提高2-5倍，为LHC探索增强机制提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T19:01:56Z
- **目录日期**: 2025-04-05
