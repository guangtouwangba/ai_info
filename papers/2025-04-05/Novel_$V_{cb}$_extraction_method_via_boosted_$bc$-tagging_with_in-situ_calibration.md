...
本文提出了一种在LHC测量$|V_{cb}|$的新方法，通过先进的"bc签名"增强喷注重子标记技术。该方法将$W \rightarrow bc$信号与顶夸克衰变的$bc$匹配喷注关联，实现了标记器的原位校准，显著抑制背景并降低味道标记效率的不确定性。研究采用基于AI的大/小半径标记器Sophon和SophonAK4，验证其性能达到ATLAS和CMS最先进水平。该方法比传统小半径喷注方法精度提高约30%，并能使$H^{\pm} \rightarrow bc$的搜索灵敏度比ATLAS Run 2结果提升2-5倍，为LHC探索增强区域提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T20:02:11Z
- **目录日期**: 2025-04-05
