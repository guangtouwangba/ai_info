...
本文提出了一种在LHC上测量$|V_{cb}|$的新方法，利用先进的"bc信号"增强喷注重子标记技术。通过将$W \rightarrow bc$信号与来自顶夸克衰变的$bc$匹配喷注相关联，实现了标记器的原位校准。该方法显著抑制背景噪声，降低风味标记效率的不确定性，使$|V_{cb}|$测量精度提高约30%。研究采用基于AI的大/小半径标记器Sophon和SophonAK4，性能达到ATLAS和CMS最先进水平。作为副产品，该方法使$H^{\pm} \rightarrow bc$搜索灵敏度比ATLAS Run 2结果提高2-5倍，为LHC探索增强机制提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T23:02:16Z
- **目录日期**: 2025-04-05
