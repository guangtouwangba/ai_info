...
本文提出了一种在LHC上测量$|V_{cb}|$的新方法，利用先进的"bc标记"喷注识别技术。通过将$W \rightarrow bc$信号与顶夸克衰变的$bc$喷注关联，实现了标记器的原位校准，显著抑制背景并降低味道标记效率的不确定性。研究开发了基于AI的大/小半径喷注标记器Sophon和SophonAK4，性能达到ATLAS和CMS最先进水平。该方法在HL-LHC下可将$|V_{cb}|$测量精度提高约30%，同时将$H^{\pm} \rightarrow bc$搜索灵敏度提升2-5倍。研究为精确测量$|V_{cb}|$提供了新思路，展现了先进标记技术在LHC高能区探索中的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T17:02:04Z
- **目录日期**: 2025-04-05
