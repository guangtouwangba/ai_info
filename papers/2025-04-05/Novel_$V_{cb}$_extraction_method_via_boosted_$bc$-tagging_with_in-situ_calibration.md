...
该研究提出了一种在LHC测量$|V_{cb}|$的新方法，利用先进的"bc标记器"识别增强喷流中的$W \rightarrow bc$信号，并通过顶夸克衰变进行原位校准。该方法显著抑制背景并降低味道标记效率的不确定性，使$|V_{cb}|$测量精度提高约30%。研究开发了基于AI的大/小半径标记器Sophon和SophonAK4，性能达到ATLAS和CMS顶级水平。作为副产品，该方法还将$H^{\pm} \rightarrow bc$的搜索灵敏度比ATLAS Run 2结果提高了2-5倍，为LHC探索增强区域提供了新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T16:02:19Z
- **目录日期**: 2025-04-05
