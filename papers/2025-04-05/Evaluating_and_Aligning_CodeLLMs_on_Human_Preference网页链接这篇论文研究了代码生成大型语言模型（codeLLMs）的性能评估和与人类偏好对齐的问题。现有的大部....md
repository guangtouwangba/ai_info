...
该研究针对代码生成大模型(codeLLMs)提出CodeArena基准测试，聚焦人类偏好对齐问题。通过397个高质量样本(覆盖40类/44种语言)模拟真实编程场景，并构建20B标记的SynCode-Instruct数据集验证合成指令微调效果。实验发现：1)传统执行基准与人类偏好存在偏差；2)开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究揭示了代码生成模型与人类偏好对齐的重要性，为评估体系提供了新维度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T03:16:18Z
- **目录日期**: 2025-04-05
