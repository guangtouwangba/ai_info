...
这篇论文提出了CodeArena基准和SynCode-Instruct语料库，用于评估代码生成大模型（codeLLMs）与人类偏好的对齐程度。CodeArena包含397个高质量样本，覆盖40类编程任务和44种语言，更贴近实际开发需求。研究发现现有基准与人类偏好存在差距，且开源模型（如Qwen2.5-Coder）与商业模型（如OpenAI o1）性能差异显著。通过20B标记的合成指令微调实验，验证了大规模指令数据对提升模型对齐效果的有效性。研究强调了代码生成模型除正确性外，还需关注人类偏好匹配。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T01:32:34Z
- **目录日期**: 2025-04-05
