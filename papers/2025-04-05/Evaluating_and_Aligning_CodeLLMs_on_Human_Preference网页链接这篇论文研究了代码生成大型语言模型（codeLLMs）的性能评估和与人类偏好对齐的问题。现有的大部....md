...
这篇论文针对代码生成大模型(codeLLMs)提出两个创新：1)构建CodeArena基准测试，包含397个高质量编程任务样本，覆盖40类任务和44种语言，首次关注模型输出与人类偏好的对齐；2)创建20B标记量的SynCode-Instruct合成指令集验证大规模微调效果。研究发现现有执行基准与人类偏好存在差距，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著。研究强调了在代码生成任务中，除正确性外，符合人类偏好的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-05T15:06:32Z
- **目录日期**: 2025-04-05
