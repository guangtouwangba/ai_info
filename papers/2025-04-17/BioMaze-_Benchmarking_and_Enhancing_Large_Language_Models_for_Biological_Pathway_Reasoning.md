...
大型语言模型（LLMs）在复杂生物系统（如通路）中的推理能力仍待探索。本文提出BioMaze数据集，包含5.1K个基于真实研究的通路问题，涵盖自然动态变化、扰动、干预条件和多尺度目标等场景。评估发现LLMs在通路推理（尤其是扰动系统）中表现不佳，因此提出PathSeeker——一种基于交互式子图导航的LLM智能体，能更有效处理生物系统复杂性。数据集和代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T18:02:02Z
- **目录日期**: 2025-04-17
