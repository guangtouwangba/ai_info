...
这篇论文探讨了大语言模型(LLMs)在复杂生物系统(如通路)中的推理能力，并提出了BioMaze数据集，包含5.1K个基于真实研究的通路问题。研究发现LLMs在通路推理，尤其是扰动系统中表现不佳。为此，作者开发了PathSeeker——一种基于交互式子图导航的LLM智能体，能更有效地处理生物系统复杂性。该工作填补了LLMs在生物通路推理方面的研究空白，为预测生物现象、提出假设和设计实验提供了新工具。数据集和代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T06:03:01Z
- **目录日期**: 2025-04-17
