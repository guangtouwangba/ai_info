...
这篇论文探讨了大语言模型(LLMs)在复杂生物系统(如通路)中的推理能力，提出了BioMaze数据集(包含5.1K个真实研究衍生的通路问题)。研究发现LLMs在通路推理，特别是扰动系统中表现不佳。为此，作者开发了PathSeeker——一种基于交互式子图导航的LLM代理，能更有效地处理生物系统复杂性。该研究填补了LLMs在生物通路推理领域的空白，为预测生物现象、形成假设和实验设计提供了新工具。数据集和代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T11:02:56Z
- **目录日期**: 2025-04-17
