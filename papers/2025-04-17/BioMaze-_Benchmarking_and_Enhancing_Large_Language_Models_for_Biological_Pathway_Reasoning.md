...
这篇论文探讨了大语言模型(LLMs)在复杂生物系统(如通路)中的推理能力，提出了BioMaze数据集(含5.1K个真实研究衍生的通路问题)。研究发现LLMs在通路推理，尤其是扰动系统中表现不佳。为此，作者开发了PathSeeker——一种基于交互式子图导航的LLM代理，能更有效地处理生物系统复杂性。该工作填补了LLMs在生物通路推理方面的研究空白，为生物现象预测、假说制定和实验设计提供了新工具。数据集和代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T23:02:01Z
- **目录日期**: 2025-04-17
