...
该研究探索了大语言模型(LLMs)在复杂生物系统(如通路)中的推理能力，并提出了BioMaze数据集，包含5.1K个基于真实研究的通路问题。评估发现LLMs在通路推理，尤其是受干扰系统中表现欠佳。为此，研究者开发了PathSeeker——一种基于交互式子图导航的LLM代理，能更有效地处理生物系统复杂性。该工作填补了LLMs在生物通路推理领域的空白，为预测生物现象、提出假设和实验设计提供了新工具。数据集和代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T14:03:06Z
- **目录日期**: 2025-04-17
