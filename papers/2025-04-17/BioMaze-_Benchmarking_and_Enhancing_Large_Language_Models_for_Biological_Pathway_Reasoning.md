...
大型语言模型(LLMs)在生物路径推理中的应用仍待探索。本研究提出BioMaze数据集，包含5.1K个真实研究衍生的复杂路径问题，涵盖自然动态变化、扰动、干预条件和多尺度目标等场景。评估发现LLMs在路径推理(尤其是扰动系统)中表现不佳。为此，研究者开发了PathSeeker代理，通过基于子图的交互式导航增强推理能力，更有效地处理复杂生物系统。该工作为生物路径推理提供了新工具和基准数据集，相关资源已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T21:02:09Z
- **目录日期**: 2025-04-17
