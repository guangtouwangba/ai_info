...
本文改进了分布式过渡系统的概念，引入原子事务来更简洁地定义草根平台。草根平台（如社交网络、加密货币和民主联盟）通过独立运行的多个实例实现去中心化，并能相互连接形成更大实例。研究提出使用多代理原子事务（如社交网络的加/删好友、加密货币的币交换、联盟的社区管理）来清晰规范平台行为，并证明符合"交互性"原子事务的平台具有草根性。这为草根平台建立了严谨的数学基础，为其实现提供了明确起点。相比原有单代理过渡系统，新方法使规范和证明更简洁直观。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T12:03:25Z
- **目录日期**: 2025-04-17
