...
本文探讨了基层平台（grassroots platforms）作为全球平台的平等替代方案，其特点是允许多个独立实例共存并最终互联整合。研究改进了分布式过渡系统的定义，引入原子事务（atomic transactions）来更简洁地规范基层平台（如社交网络、加密货币和民主联盟）的关键操作，如好友管理、货币交换和联盟参与。通过证明这些原子事务具有交互性，研究确立了一个通用定理，验证了这些平台的基层属性。这为基层平台提供了清晰的数学基础和实现起点，解决了原有单年代理过渡系统表达力不足的问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T15:03:20Z
- **目录日期**: 2025-04-17
