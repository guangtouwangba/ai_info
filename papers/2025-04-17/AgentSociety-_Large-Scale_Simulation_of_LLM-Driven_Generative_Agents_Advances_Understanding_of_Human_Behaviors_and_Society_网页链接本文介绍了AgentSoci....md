...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统模拟了1万多个AI代理的社会生活，记录它们之间及与环境500万次互动，用于研究社会极化、信息传播、基本收入政策、自然灾害影响等社会问题。实验结果显示其模拟结果与现实世界数据高度吻合，证明该系统能有效捕捉人类行为机制，可作为社会科学研究和政策制定的有力工具。该研究展示了AI模拟在理解复杂社会现象方面的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T09:06:02Z
- **目录日期**: 2025-04-17
