...
AgentSociety是一个基于大语言模型(LLM)的大规模社会模拟器，能模拟超过1万个代理的社会互动(500万次)。研究者用它研究了四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害冲击。模拟结果与现实世界数据高度吻合，证明该系统能有效捕捉人类行为机制。该平台可作为传统社会科学研究方法(如调查、访谈)的有力补充，为研究者和政策制定者提供新的分析工具，帮助理解复杂社会现象背后的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T17:04:54Z
- **目录日期**: 2025-04-17
