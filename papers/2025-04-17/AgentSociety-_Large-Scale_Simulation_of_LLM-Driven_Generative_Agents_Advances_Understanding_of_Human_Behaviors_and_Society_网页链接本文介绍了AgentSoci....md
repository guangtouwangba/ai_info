...
这篇论文介绍了AgentSociety，一个基于大语言模型(LLM)的大规模社会模拟系统。该系统模拟了超过1万个AI代理的社会互动(500万次交互)，用于研究社会现象如极化、信息传播、基本收入政策影响和自然灾害应对。研究发现模拟结果与现实世界数据高度吻合，证明该系统能有效捕捉人类行为模式和社会机制。AgentSociety为社会科学研究和政策制定提供了新工具，可辅助传统研究方法(如调查、访谈)，帮助理解复杂社会问题的成因和潜在解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T01:33:04Z
- **目录日期**: 2025-04-17
