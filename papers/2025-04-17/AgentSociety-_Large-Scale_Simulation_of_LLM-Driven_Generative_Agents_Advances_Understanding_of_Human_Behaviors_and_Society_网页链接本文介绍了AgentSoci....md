...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能模拟1万多个AI代理的社会互动（500万次交互）。该系统通过四个社会实验（政治极化、信息传播、基本收入政策、自然灾害影响）验证其有效性，实验结果与现实数据高度吻合。研究表明，该平台能有效辅助传统社会科学研究方法（如调查、访谈），帮助研究者分析社会问题的成因与机制，为政策制定提供新工具。这标志着AI驱动的社会仿真在理解人类行为和社会动态方面具有重要潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T03:19:36Z
- **目录日期**: 2025-04-17
