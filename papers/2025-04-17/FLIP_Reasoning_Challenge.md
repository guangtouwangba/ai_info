...
这篇论文介绍了FLIP数据集，用于评估AI在基于Idena区块链人类验证任务中的推理能力。FLIP要求从两组4张图像的排序中识别逻辑连贯的序列，测试多模态AI的顺序推理、视觉叙事和常识能力。实验显示，当前最优开源和闭源模型的零样本准确率最高仅达75.5%和77.9%，远低于人类的95.3%。为图像添加文本描述可提升模型表现（如Gemini 1.5 Pro从69.6%升至75.2%）。15个模型集成后准确率达85.2%，突显现有推理模型的局限性和FLIP等基准的必要性。代码和数据集已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T10:02:19Z
- **目录日期**: 2025-04-17
