...
这篇论文介绍了FLIP数据集，用于评估AI在基于Idena区块链人类验证任务中的推理能力。FLIP挑战要求从两组4张图片序列中选出逻辑连贯的排序，测试顺序推理、视觉叙事和常识能力。实验评估了前沿的视觉语言模型(VLM)和大型语言模型(LLM)，发现最优开源和闭源模型在零样本设置下的准确率最高仅达75.5%和77.9%，远低于人类的95.3%。使用图像描述模型辅助推理可将准确率从69.6%提升至75.2%，而15个模型的集成学习能达到85.2%。研究揭示了当前推理模型的局限性，凸显了FLIP等强大多模态基准的必要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T09:02:12Z
- **目录日期**: 2025-04-17
