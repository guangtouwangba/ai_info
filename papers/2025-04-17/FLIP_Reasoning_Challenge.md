...
该论文介绍了FLIP数据集，用于评估AI的推理能力，基于Idena区块链上的人类验证任务。FLIP要求用户从两组4张图片排序中识别逻辑连贯的序列，测试顺序推理、视觉叙事和常识。实验显示，当前最优的开源和闭源模型在零样本设置下的准确率最高仅达75.5%和77.9%，远低于人类的95.3%。图像描述模型通过提供文本描述提升了推理效果（Gemini 1.5 Pro从69.6%升至75.2%）。结合15个模型的集成方法将准确率提高到85.2%，突显了现有推理模型的局限性和FLIP等多模态基准的必要性。代码和数据集将开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T22:01:12Z
- **目录日期**: 2025-04-17
