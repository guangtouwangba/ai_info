...
这篇论文介绍了FLIP数据集，这是一个基于Idena区块链人类验证任务的人工智能推理能力评估基准。FLIP要求用户从两组4张图像的排序中识别逻辑连贯的序列，测试顺序推理、视觉叙事和常识理解能力。实验评估了前沿的视觉语言模型和大型语言模型，发现即使在零样本设置下，最优开源和闭源模型准确率最高仅达75.5%和77.9%，远低于人类的95.3%。使用图像描述模型辅助推理可提升性能（Gemini 1.5 Pro从69.6%升至75.2%），15个模型集成后准确率达85.2%。研究凸显了现有推理模型的局限性和FLIP等多模态基准的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T11:02:02Z
- **目录日期**: 2025-04-17
