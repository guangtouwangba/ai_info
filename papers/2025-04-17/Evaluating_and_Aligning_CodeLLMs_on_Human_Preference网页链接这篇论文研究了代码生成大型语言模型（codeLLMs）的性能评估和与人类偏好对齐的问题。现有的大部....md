...
这篇论文针对代码生成大模型(codeLLMs)提出了CodeArena基准测试，通过397个涵盖40类编程任务和44种语言的样本，评估模型与人类偏好的匹配度。研究发现现有基准过于关注代码正确性而忽视用户体验，并构建了20B标记的SynCode-Instruct语料库验证合成指令微调效果。实验显示执行基准与CodeArena存在性能差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI)差距显著，凸显了人类偏好对齐的重要性。该研究为提升代码生成模型的实用价值提供了新评估维度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T01:33:41Z
- **目录日期**: 2025-04-17
