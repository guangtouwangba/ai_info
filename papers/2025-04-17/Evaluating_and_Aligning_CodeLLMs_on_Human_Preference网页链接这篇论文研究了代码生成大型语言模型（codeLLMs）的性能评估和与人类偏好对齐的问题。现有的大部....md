...
这篇论文针对代码生成大模型(codeLLMs)提出了CodeArena基准测试和SynCode-Instruct指令集，以评估模型与人类偏好的对齐程度。研究发现现有基准过于关注代码正确性而忽略用户体验，通过397个涵盖40类编程任务的样本和近200亿标记的合成指令验证，发现执行基准与人类偏好存在差异。实验比较40多个模型显示，开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)存在显著差距，凸显了人类偏好对齐的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T04:05:50Z
- **目录日期**: 2025-04-17
