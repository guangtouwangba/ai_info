...
该论文针对代码生成大模型(codeLLMs)提出新评估框架CodeArena，重点关注与人类偏好的对齐问题。研究者构建了包含397个高质量样本的基准测试，覆盖40类编程任务和44种语言，并开发了20B标记的合成指令数据集SynCode-Instruct。实验显示现有基于执行的评估与人类偏好存在偏差，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究强调了在代码生成任务中考虑人类偏好的重要性，为改进代码LLMs提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T03:20:16Z
- **目录日期**: 2025-04-17
