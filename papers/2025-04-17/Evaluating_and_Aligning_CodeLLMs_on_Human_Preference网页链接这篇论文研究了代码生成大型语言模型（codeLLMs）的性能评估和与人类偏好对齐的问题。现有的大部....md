...
这篇论文关注代码生成大模型(codeLLMs)与人类偏好的对齐问题。研究者创建了CodeArena基准测试(包含397个样本，覆盖40类44种语言)来评估模型在真实编程任务中的表现，发现传统基于执行的测试与人类偏好存在差距。同时开发了20B标记的SynCode-Instruct语料库验证合成指令微调效果。实验显示开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著，突出了对齐人类偏好的重要性。研究强调了现有基准在评估代码LLMs时的局限性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T17:05:32Z
- **目录日期**: 2025-04-17
