...
这篇论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，通过397个高质量样本覆盖40类编程任务和44种语言，评估模型与人类偏好的匹配度。研究发现现有基准过于关注代码正确性而忽视用户体验，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)存在显著差距。同时构建了20B标记的SynCode-Instruct合成指令集验证微调效果，强调代码LLMs需兼顾技术性能和人类偏好对齐。研究揭示了执行基准与人类评价间的差异，为提升代码生成质量提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T11:06:39Z
- **目录日期**: 2025-04-17
