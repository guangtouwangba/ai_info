...
这篇论文针对代码生成大模型(codeLLMs)提出新评估方法CodeArena，关注模型输出与人类偏好的对齐。研究者构建了包含397个高质量样本的基准测试，覆盖40类编程任务和44种语言，并开发了20B标记的合成指令数据集SynCode-Instruct。实验发现现有基于执行的评测与人类偏好存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究强调了大模型在代码生成任务中与人类偏好对齐的重要性，为改进代码LLMs提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T20:05:30Z
- **目录日期**: 2025-04-17
