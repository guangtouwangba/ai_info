...
这篇论文针对代码生成大模型(codeLLMs)的评估问题，提出了CodeArena基准测试和SynCode-Instruct语料库。CodeArena包含397个高质量编程样本，覆盖40类任务和44种语言，更贴近人类实际编程需求。研究发现现有基于执行的评测与人类偏好存在差距，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著。研究通过构建近200亿token的合成指令数据集，验证了大模型对齐人类偏好的重要性。这项工作为代码生成模型的实用化评估提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T06:06:35Z
- **目录日期**: 2025-04-17
