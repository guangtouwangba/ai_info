...
这篇论文针对代码生成大语言模型(codeLLMs)提出新评估方法，指出当前基准测试过于侧重代码正确性而忽视人类偏好。研究者构建了CodeArena基准测试(包含397个样本，覆盖40类44种语言)和SynCode-Instruct语料库(近200亿标记)来评估模型表现。实验发现执行基准与人类偏好存在差距，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著，凸显了模型与人类偏好对齐的重要性。研究为提升代码LLMs的实际应用价值提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T10:06:54Z
- **目录日期**: 2025-04-17
