...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献搜索，拥有3.5亿论文、0.6亿学者等海量数据。平台具备AI辅助阅读功能，可自动生成摘要、翻译文献，并通过问答帮助理解内容。用户还能订阅个性化科研动态，跟踪机构、学者或关键词的最新研究。此外，AMiner提供学者画像、学术会议等扩展功能，基础服务免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T04:05:40Z
- **目录日期**: 2025-04-17
