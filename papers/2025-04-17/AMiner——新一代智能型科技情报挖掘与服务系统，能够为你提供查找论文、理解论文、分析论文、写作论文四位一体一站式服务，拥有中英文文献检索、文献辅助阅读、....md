...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献搜索，拥有3.5亿论文、0.6亿学者等海量数据，并提供AI辅助阅读、自动摘要生成和互动问答功能。用户可上传或搜索论文，获取翻译、章节概要和问题建议。平台还支持科研动态订阅，按用户偏好推送最新学术资讯。此外，AMiner提供学者画像、学术会议和论文排行榜等功能，基础服务免费使用。访问地址：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T02:33:22Z
- **目录日期**: 2025-04-17
