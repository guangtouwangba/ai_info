...
AMiner是一个智能科技情报挖掘系统，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献检索、AI辅助阅读和翻译，拥有3.5亿论文、0.6亿学者等海量数据。主要功能包括：1）精准文献检索与智能问答，可自动生成摘要；2）英文文献翻译与内容解析；3）科研动态订阅，按用户兴趣推送最新成果。平台还提供学者画像、学术会议等特色功能，支持免费使用，帮助用户高效获取学术信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T14:06:32Z
- **目录日期**: 2025-04-17
