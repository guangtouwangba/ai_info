...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译、写作等一站式服务。它拥有3.5亿论文、0.6亿学者等海量学术资源，支持中英文文献检索、AI生成摘要、互动问答等功能。用户可上传PDF或从平台获取论文，利用AI快速理解内容。平台还提供科研动态订阅服务，根据用户兴趣推送最新论文摘要。此外，AMiner包含学者画像、学术会议等特色功能，基础服务免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T20:05:20Z
- **目录日期**: 2025-04-17
