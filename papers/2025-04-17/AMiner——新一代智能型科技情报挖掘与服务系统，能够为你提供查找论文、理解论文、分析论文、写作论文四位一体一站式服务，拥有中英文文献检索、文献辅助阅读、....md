...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析与写作的一站式服务。其核心功能包括：1）中英文文献检索，支持互动问答与自动摘要生成；2）英文文献翻译与AI辅助阅读，可解析PDF并生成章节概要；3）科研情报订阅，根据用户偏好推送最新学术动态。平台覆盖42个学科的3.5亿论文、0.6亿学者数据，并提供学者画像、学术会议等特色功能。基础服务可通过浏览器免费使用，显著提升文献调研与论文撰写效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T12:06:30Z
- **目录日期**: 2025-04-17
