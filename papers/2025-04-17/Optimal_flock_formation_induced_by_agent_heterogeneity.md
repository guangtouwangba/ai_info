...
传统群体行为研究通常假设个体同质，但本研究探讨了异质性对集群动态的影响。研究发现，参数优化分配的异质个体群比同质群体表现更优，在目标追踪、编队形成和避障等任务中收敛速度提升20-40%。在存在通信延迟的系统中，异质性甚至能在同质个体无法稳定的情况下实现收敛。这一发现挑战了多智能体控制的现有范式，表明系统无序性可以作为一种自适应的分布式机制促进集群行为。研究为无人机群等自主系统的协调控制提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T04:01:48Z
- **目录日期**: 2025-04-17
