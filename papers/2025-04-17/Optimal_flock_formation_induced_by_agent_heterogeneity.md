...
研究表明，在群体动力学中引入个体差异性可以显著提升群体行为的稳定性和收敛速度。与传统同质化群体相比，参数经过优化分配的异质化群体在目标追踪、队形保持和障碍规避等任务中表现出20-40%的更快收敛速度。特别值得注意的是，在存在通信延迟的系统中，异质性甚至能使原本不稳定的同质群体实现收敛。这一发现挑战了多智能体控制的传统范式，表明系统无序性可以作为一种适应性分布式机制来促进群体行为的形成。研究为无人机群等自主系统的协调控制提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T11:01:50Z
- **目录日期**: 2025-04-17
