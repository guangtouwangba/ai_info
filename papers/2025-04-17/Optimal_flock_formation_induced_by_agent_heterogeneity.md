...
传统集群行为研究假设个体相同，但本研究突破性地探讨了异质性对集群动态的影响。结果表明：参数优化分配的异质群体比同质群体性能提升20-40%，在目标追踪、编队形成和避障等任务中收敛速度更快。在通信延迟情况下，异质性甚至能实现同质系统无法达成的稳定收敛。这一发现挑战了多智能体控制的传统范式，揭示了系统无序性可作为促进集群行为的自适应分布式机制。研究为无人机群等自主系统的协调控制提供了新思路，证明个体差异能显著增强群体整体性能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T06:01:56Z
- **目录日期**: 2025-04-17
