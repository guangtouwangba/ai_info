...
研究表明，在群体智能系统中引入个体差异性可显著提升集群行为的性能。与传统同质化假设不同，研究者发现当无人机等自主智能体被分配最优化的异质性参数时，其集群动态的稳定性和收敛速度比同质化系统提高20-40%。这种优势体现在目标追踪、编队形成和障碍规避等多种任务中，在存在通信延迟时甚至能实现同质系统无法达成的收敛。该发现挑战了多智能体控制的传统范式，证明系统无序性可作为一种自适应的分布式机制促进集群行为的形成。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T22:01:02Z
- **目录日期**: 2025-04-17
