...
传统群体行为研究假设个体同质化，而本研究突破性地探讨了个体差异对群体动态的影响。研究发现，通过优化分配异质性参数，无人机群的收敛速度比同质化群体快20-40%，在目标追踪、编队形成和障碍规避等任务中表现更优。在通信延迟情况下，异质性甚至能实现同质群体无法达成的稳定收敛。这一发现挑战了多智能体控制的传统范式，证明系统无序性可成为促进群体行为的自适应分布式机制。研究为自主车辆群体控制提供了新思路，揭示了生物群体中个体差异的潜在优势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T21:01:17Z
- **目录日期**: 2025-04-17
