...
传统群体行为研究假设个体同质化，但本研究突破性地探索了异质性个体对集群动态的影响。结果表明：参数优化分配的异质个体群比同质群体收敛速度快20-40%，在目标追踪、编队形成和避障等任务中表现更优。特别在通信延迟场景下，异质性可实现同质群体无法达成的稳定集群。这一发现颠覆了多智能体控制领域的传统认知，证明系统无序性可作为促进集体行为的自适应分布式机制。研究为无人机群等自主系统的协调控制提供了新思路，表明合理设计的个体差异能显著提升群体性能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T20:01:09Z
- **目录日期**: 2025-04-17
