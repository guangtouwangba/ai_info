...
本研究利用弱监督学习方法训练基于Conformer架构的阿拉伯语自动语音识别(ASR)系统。使用15,000小时未经验证的弱标注语音数据(包含现代标准阿拉伯语和方言阿拉伯语)，无需人工转录，即实现了最先进的性能表现，在标准基准测试中超越了以往所有阿拉伯语ASR研究成果。该方法有效解决了阿拉伯语等低资源语言面临的大规模标注数据稀缺问题，证明了弱监督学习可作为传统监督方法的高效低成本替代方案，为低资源环境下的ASR系统开发提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T06:02:18Z
- **目录日期**: 2025-04-17
