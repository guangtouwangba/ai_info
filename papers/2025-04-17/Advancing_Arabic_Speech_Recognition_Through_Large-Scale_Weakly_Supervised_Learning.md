...
本研究采用弱监督学习方法，基于Conformer架构训练阿拉伯语自动语音识别(ASR)模型。使用15,000小时未经人工标注的现代标准阿拉伯语(MSA)和方言阿拉伯语(DA)语音数据进行训练，避免了昂贵的人工转录成本。尽管缺乏人工验证标签，该模型在标准测试集上仍取得了最先进的性能表现，超越了所有先前阿拉伯语ASR研究成果。这项工作证明了弱监督学习作为传统监督方法的可扩展、高性价比替代方案的有效性，为低资源语言的ASR系统开发提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T11:02:10Z
- **目录日期**: 2025-04-17
