...
该研究利用弱监督学习方法训练了一个基于Conformer架构的阿拉伯语自动语音识别(ASR)模型。通过使用15,000小时的弱标注语音数据(包含现代标准阿拉伯语和方言阿拉伯语)，无需昂贵的人工转录，该模型在标准基准测试中取得了最先进的性能表现。这一成果表明，弱监督学习可作为传统监督方法的可扩展且经济高效的替代方案，为资源匮乏语言(如阿拉伯语)的ASR系统开发提供了新思路，解决了此类语言因缺乏大规模标注数据集而面临的挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T23:01:26Z
- **目录日期**: 2025-04-17
