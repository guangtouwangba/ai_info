...
该研究利用弱监督学习方法训练了一个基于Conformer架构的阿拉伯语自动语音识别(ASR)模型。通过使用15,000小时包含现代标准阿拉伯语(MSA)和方言阿拉伯语(DA)的弱标注语音数据，避免了昂贵的人工转录。尽管没有人工验证标签，该方法在标准基准测试中达到了最先进的性能表现，超越了之前所有阿拉伯语ASR研究。这项工作证明了弱监督学习作为传统监督方法的高效、低成本替代方案的有效性，为低资源语言的ASR系统发展提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T13:09:07Z
- **目录日期**: 2025-04-17
