...
OpenAI正洽谈以约30亿美元收购AI编程公司Windsurf（前Codeium），这将成为其最大单笔收购。Windsurf主打自然语言生成代码功能，此前估值12.5亿美元。该收购将增强OpenAI的开发者工具能力，反映AI领域两大趋势：1）巨头通过收购加速技术整合；2）工具型AI初创易被并购。OpenAI此前已收购Rockset和Multi，持续完善AI基础设施布局。交易尚未最终确定，但凸显了AI基础工具领域的激烈竞争态势。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T06:03:48Z
- **目录日期**: 2025-04-17
