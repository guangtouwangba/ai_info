# #OpenAI或收购Windsurf##OpenAI目前最大单笔收购#据路透社报道，OpenAI正在洽谈迄今为止最大的一笔收购——以约30亿美元收购AI编程公司Windsurf（前身为Codeium...
...
OpenAI正洽谈以约30亿美元收购AI编程公司Windsurf（前Codeium），这或成其最大单笔收购。Windsurf主打自然语言生成代码功能，投后估值12.5亿美元，OpenAI介入使其估值翻倍。收购若成功，将强化OpenAI的开发者工具能力，反映AI领域两大趋势：1）巨头通过收购工具型AI公司快速补强基础设施；2）AI独角兽并购潮持续，如OpenAI此前收购Rockset和Multi。此次交易凸显AI基础工具竞争白热化，资本正加速行业整合。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T08:04:22Z
- **目录日期**: 2025-04-17
