...
OpenAI正在测试新版ChatGPT的社交功能，允许用户分享AI生成内容（如图像、段子）并互动点赞，旨在打造类似X平台的AI内容社区。该功能将提供信息流界面，支持AI配图、润色发言、生成头像等，用户自拍可被转换成艺术风格作品并一键分享。这一转型将使ChatGPT从聊天工具升级为实时内容平台，既增强用户粘性，又能收集最新数据训练模型。此举被视为OpenAI与马斯克X平台的正面对抗，标志着AI与社交融合的新趋势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T18:02:54Z
- **目录日期**: 2025-04-17
