...
OpenAI正在测试ChatGPT的社交功能升级版，目标对标马斯克的X平台。新版本允许用户分享AI生成内容（如图像/段子）并互动点赞，界面类似X的信息流。该功能将ChatGPT从工具转变为"AI内容社区"，既能收集实时用户数据训练模型，又能实现AI自动配图/润色/头像生成等社交服务。这标志着AI与社交的深度结合，OpenAI或将直接与X和Meta展开竞争。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T10:03:54Z
- **目录日期**: 2025-04-17
