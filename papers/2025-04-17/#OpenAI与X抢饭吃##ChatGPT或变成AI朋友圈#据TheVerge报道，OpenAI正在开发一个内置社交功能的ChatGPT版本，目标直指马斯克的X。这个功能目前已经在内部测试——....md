...
OpenAI正在测试ChatGPT的社交功能新版本，目标对标马斯克的X平台。用户可将AI生成内容（如图像、段子）分享至平台并互动点赞。该功能将ChatGPT从聊天工具升级为"AI内容社区"，通过用户实时内容训练模型理解最新流行文化。界面类似X信息流，支持AI配图、润色发言、生成头像等创意功能。这一转型意味着AI与社交的深度结合，OpenAI或将直接与X和Meta展开竞争。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T16:03:57Z
- **目录日期**: 2025-04-17
