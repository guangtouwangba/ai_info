# #OpenAI与X抢饭吃##ChatGPT或变成AI朋友圈#据TheVerge报道，OpenAI正在开发一个内置社交功能的ChatGPT版本，目标直指马斯克的X。这个功能目前已经在内部测试——...
...
OpenAI正在测试新版ChatGPT的社交功能，允许用户分享AI生成的内容（如图像、段子）并互动点赞。该功能将把ChatGPT从聊天工具转变为类似X（原Twitter）的内容社区，用户可发布AI润色的图文、制作头像等。此举既能增强用户粘性，又能用实时内容训练AI模型以掌握最新流行文化。这标志着OpenAI正式进军社交领域，与马斯克的X平台形成直接竞争。功能界面可能包含AI生成内容的信息流、自动配图/润色工具等，实现"AI朋友圈"的社交化转型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T22:02:43Z
- **目录日期**: 2025-04-17
