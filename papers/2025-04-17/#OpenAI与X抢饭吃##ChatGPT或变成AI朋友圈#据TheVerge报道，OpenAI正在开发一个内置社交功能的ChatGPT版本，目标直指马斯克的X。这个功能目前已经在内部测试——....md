...
OpenAI正在测试ChatGPT的社交功能版本，目标对标马斯克的X平台。新功能允许用户分享AI生成内容（如图像、段子）并互动点赞，形成类似X的信息流社区。该功能将提供AI配图、头像生成、风格转换（如照片转宫崎骏画风）等服务，使ChatGPT从聊天工具升级为内容创作平台。TheVerge分析指出，这种转型不仅能增强用户粘性，还能通过实时内容训练AI理解最新流行文化。此举意味着OpenAI正式进军社交领域，与X和Meta展开直接竞争。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T20:02:56Z
- **目录日期**: 2025-04-17
