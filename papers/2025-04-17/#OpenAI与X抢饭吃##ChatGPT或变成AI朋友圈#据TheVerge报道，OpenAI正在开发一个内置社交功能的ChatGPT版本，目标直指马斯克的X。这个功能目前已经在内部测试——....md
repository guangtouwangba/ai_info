...
OpenAI正在测试ChatGPT的社交功能版本，目标对标马斯克的X平台。新功能允许用户分享AI生成内容（如图像、段子）并互动点赞，形成AI内容社区。界面类似X信息流，支持AI配图、润色发言、生成头像等。用户自拍可被转换成宫崎骏风格插画并自动分享。该转型将ChatGPT从聊天工具升级为实时内容平台，既能获取用户数据训练模型理解流行文化，也标志着AI与社交融合的新趋势，直接与X和Meta展开竞争。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T13:10:46Z
- **目录日期**: 2025-04-17
