...
这项研究系统评估了基于放射组学和深度学习的AI模型在胸部X光疾病检测中的表现，重点关注COVID-19、肺部混浊和病毒性肺炎。研究对比了决策树、梯度提升、随机森林、SVM和MLP等放射组学方法，与CNN和ViT等深度学习模型的诊断准确性和鲁棒性。结果显示，不同模型在不同样本量下各有优势：深度学习模型擅长从图像直接学习，而放射组学在数据有限时可能更具优势。该研究为临床实践中根据具体需求选择AI模型提供了重要指导，特别是在需要快速可靠诊断的自动化高通量环境中。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T10:02:38Z
- **目录日期**: 2025-04-17
