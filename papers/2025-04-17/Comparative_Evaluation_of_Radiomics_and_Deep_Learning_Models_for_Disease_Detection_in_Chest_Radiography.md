...
本研究系统评估了基于放射组学和深度学习的AI模型在胸部X光疾病检测（COVID-19、肺部混浊和病毒性肺炎）中的表现。深度学习方法（如CNN和ViT）直接从图像学习，而放射组学方法提取定量特征，在数据有限时可能更具优势。研究比较了决策树、梯度提升、随机森林、SVM、MLP等传统方法与前沿计算机视觉模型的诊断准确性和鲁棒性，分析了不同样本量下的性能表现，为临床实践中AI诊断工具的选择提供了指导依据。结果表明不同AI方法各具优势，应根据具体临床需求选择合适模型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T12:02:31Z
- **目录日期**: 2025-04-17
