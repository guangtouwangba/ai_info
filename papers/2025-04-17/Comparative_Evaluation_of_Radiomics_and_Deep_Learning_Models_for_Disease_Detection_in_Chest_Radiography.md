...
本研究系统评估了基于放射组学和深度学习的AI模型在胸部X光疾病检测中的表现，重点关注COVID-19、肺部混浊和病毒性肺炎。研究比较了决策树、梯度提升、随机森林、SVM和MLP等放射组学模型与CNN、ViT等深度学习架构的诊断准确性和鲁棒性。结果显示，在数据有限情况下，放射组学模型可能更具优势，而深度学习模型在充足数据时表现更佳。研究通过不同样本量下的性能指标分析，为临床实践中AI诊断工具的选择提供了依据，特别针对自动化高通量环境中对及时可靠诊断的需求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T13:09:17Z
- **目录日期**: 2025-04-17
