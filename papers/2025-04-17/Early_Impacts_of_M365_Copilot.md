...
一项针对56家公司的6000多名知识型员工的实验研究表明，生成式AI能显著提升工作效率。使用该技术的员工每周处理邮件时间减少半小时，文档完成速度提升12%。尽管技术较新，仍有近40%的员工在6个月研究中持续使用。这些发现揭示了AI在广泛行业和岗位中的实际应用价值，为工作方式变革提供了早期实证依据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T03:16:06Z
- **目录日期**: 2025-04-17
