...
生成式AI（GenAI）虽能提升生产力和认知能力，但用户难以预判其输出，导致需多次交互澄清意图，增加认知负担和时间成本。研究提出，GenAI系统应同时提供"前馈"（feedforward）设计，即在用户提交指令前展示AI可能的生成内容，以降低不确定性。通过对话界面、文档编辑器等四个应用场景的原型设计，探讨了前馈机制的设计空间与准则，旨在帮助用户更高效地利用GenAI潜力。该研究为优化人机协作体验提供了新思路。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T19:02:09Z
- **目录日期**: 2025-04-17
