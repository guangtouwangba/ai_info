...
生成式AI（GenAI）虽能提升生产力和认知能力，但用户难以预判其输出，导致需反复交互以澄清意图，造成认知负担和时间消耗。研究提出，GenAI系统需同时提供"反馈"和"前馈"设计——即在用户提交指令前展示AI可能的生成内容。通过四个应用场景（对话界面、文档编辑、可塑界面、自动化代理）的设计实例，探讨了前馈机制如何优化用户体验，推动形成系统化设计准则，帮助用户更高效地利用GenAI潜力。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-17T08:03:14Z
- **目录日期**: 2025-04-17
