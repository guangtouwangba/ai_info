...
上海交大与上海AI Lab联合团队提出IDEAL方法，通过调整SFT训练数据的配比显著提升LLM的综合性能。研究表明，训练数据数量并非关键，不合理的配比反而会加剧模型"偏科"。该方法使原本不擅长编程的Llama 3.1-8B模型代码能力明显提升，说明科学调整训练集组成能有效缓解大语言模型的能力不均衡问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T22:01:55Z
- **目录日期**: 2025-06-11
