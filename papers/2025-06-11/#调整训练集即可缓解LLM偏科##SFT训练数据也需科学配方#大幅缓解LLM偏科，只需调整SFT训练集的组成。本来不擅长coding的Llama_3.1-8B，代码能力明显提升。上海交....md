...
上海交大与上海AI Lab团队提出IDEAL方法，通过调整SFT训练数据的配比而非数量，显著缓解了LLM（如Llama 3.1-8B）的"偏科"问题，提升其在代码等领域的综合表现。研究发现，训练数据数量并非关键，不合理的配比反而会加剧模型能力失衡。该方法为优化大语言模型的多任务性能提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T19:03:21Z
- **目录日期**: 2025-06-11
