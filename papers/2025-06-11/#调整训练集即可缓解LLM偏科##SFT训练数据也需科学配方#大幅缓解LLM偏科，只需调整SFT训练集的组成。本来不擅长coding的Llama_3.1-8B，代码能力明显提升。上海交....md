...
上海交大与上海AI Lab团队提出IDEAL方法，通过优化SFT训练数据的配比而非数量，显著缓解了LLM的"偏科"问题。研究表明，不合理的训练数据配比会加剧模型能力失衡，而调整后的Llama 3.1-8B模型代码能力明显提升。该方法证明科学配置训练集比单纯增加数据量更能提升大模型在不同领域的综合表现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T23:01:38Z
- **目录日期**: 2025-06-11
