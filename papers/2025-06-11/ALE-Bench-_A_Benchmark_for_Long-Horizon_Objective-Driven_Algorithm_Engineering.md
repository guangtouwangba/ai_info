...
ALE-Bench是一个新的AI基准测试，用于评估AI系统在基于分数的算法编程竞赛中的表现，涵盖快递路线规划、机组排班、工厂生产计划和电网平衡等复杂优化问题。该基准基于AtCoder启发式竞赛的真实任务，聚焦于计算难度高且无精确解的问题，支持长期迭代优化。评估发现，前沿大语言模型（LLM）在特定问题上表现优异，但在问题间的一致性和长期问题解决能力上仍显著落后于人类。ALE-Bench旨在推动AI在算法工程领域的进步。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T14:00:56Z
- **目录日期**: 2025-06-11
