...
Chili3D是一款基于浏览器的开源CAD工具，通过将OpenCascade编译为WebAssembly并与Three.js集成，实现了免安装的在线3D建模功能。该工具支持基础几何体创建、2D草图绘制，以及布尔运算、拉伸旋转等高级操作，并提供倒角、镜像等编辑功能。用户可直接在浏览器中测量尺寸、计算体积，并管理STEP/IGES等工程文件。采用TypeScript开发，具备完整的撤销/重做历史记录，为轻量化三维设计提供了便捷的云端解决方案。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T13:14:56Z
- **目录日期**: 2025-06-11
