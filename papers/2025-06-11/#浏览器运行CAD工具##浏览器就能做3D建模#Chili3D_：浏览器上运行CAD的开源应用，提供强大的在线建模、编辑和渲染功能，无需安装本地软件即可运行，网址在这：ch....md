...
Chili3D是一款基于浏览器的开源CAD工具，通过将OpenCascade编译为WebAssembly并与Three.js集成，实现在线3D建模。它支持基础几何体创建、2D草图绘制、布尔运算、拉伸旋转等高级操作，并提供倒角、镜像等编辑功能。用户可直接测量尺寸、计算体积，并管理STEP/IGES等格式文件。该工具无需安装本地软件，具备完整的撤销/重做功能，适用于轻量化云端建模需求。开发语言为TypeScript，访问地址为chili3d.com。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T21:02:23Z
- **目录日期**: 2025-06-11
