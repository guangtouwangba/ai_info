...
Chili3D是一个基于浏览器的开源CAD工具，通过将OpenCascade编译为WebAssembly并与Three.js集成，实现了在线3D建模功能。它支持基础几何体创建、2D草图绘制、布尔运算等高级操作，以及倒角、移动等编辑工具。用户可直接在浏览器中测量尺寸、管理文档（支持STEP/IGES格式），无需安装本地软件。该系统采用TypeScript开发，提供完整的撤销/重做功能，显著降低了CAD使用门槛。访问chili3d.com即可体验。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T20:03:58Z
- **目录日期**: 2025-06-11
