...
Chili3D是一款基于浏览器的开源CAD工具，通过将OpenCascade编译为WebAssembly并与Three.js集成，实现了无需安装软件的在线3D建模。该工具提供基础几何体创建、2D草图绘制、布尔运算、拉伸旋转等高级建模功能，以及倒角、镜像等编辑工具，支持STEP/IGES/BREP格式导入导出。其TypeScript编写的架构包含完整的撤销/重做栈，可测量几何参数并计算体积总和，使复杂CAD操作能在网页端完成。项目网址：chili3d.com。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T23:02:26Z
- **目录日期**: 2025-06-11
