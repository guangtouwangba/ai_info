...
Chili3D是一款基于浏览器的开源CAD工具，通过将OpenCascade编译为WebAssembly并与Three.js集成，实现了完整的在线3D建模功能。它提供基础几何体创建、2D草图绘制、布尔运算等高级建模工具，以及倒角、移动等编辑功能，支持STEP/IGES/BREP格式导入导出。所有操作无需安装本地软件，直接在浏览器中即可完成建模、渲染和文档管理，具有完整的撤销/重做功能。该项目采用TypeScript开发，访问chili3d.com即可使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T14:04:40Z
- **目录日期**: 2025-06-11
