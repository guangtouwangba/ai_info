...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、辅助阅读、翻译、论文写作支持等。它收录了3.5亿论文、0.6亿学者等海量学术资源，支持AI生成摘要、章节概要和智能问答，帮助用户快速理解文献内容。平台还提供科研情报订阅服务，可根据用户偏好推送最新学术动态。此外，AMiner具备学者画像、学术会议追踪等功能，基础服务免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T23:03:55Z
- **目录日期**: 2025-06-11
