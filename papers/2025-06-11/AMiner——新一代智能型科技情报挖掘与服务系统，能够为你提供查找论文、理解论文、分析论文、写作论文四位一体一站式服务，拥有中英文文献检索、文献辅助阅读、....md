...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和科研订阅等一站式服务。它支持中英文文献搜索，能快速定位相关论文，并生成摘要和问答互动。用户可上传PDF或从平台获取论文，利用AI生成章节概要和问题建议。此外，AMiner提供个性化科研动态订阅，按用户关注的学者、机构或关键词推送最新论文摘要。平台还包含学者画像、学术会议和论文排行榜等功能，基础检索免费使用。访问入口：https://www.aminer.cn/。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T07:06:33Z
- **目录日期**: 2025-06-11
