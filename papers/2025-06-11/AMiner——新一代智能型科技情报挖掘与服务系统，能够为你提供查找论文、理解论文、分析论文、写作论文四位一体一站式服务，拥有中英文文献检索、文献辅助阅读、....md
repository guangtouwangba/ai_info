...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索（覆盖3.5亿论文）、AI辅助阅读（自动生成摘要/问答）、文档翻译及科研情报订阅（个性化推送最新研究）。支持用户上传或检索文献，通过对话交互深入理解内容，并整合学者画像、学术会议等资源。平台基础功能免费，可通过网页或微信小程序使用，显著提升文献调研和论文写作效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T05:06:41Z
- **目录日期**: 2025-06-11
