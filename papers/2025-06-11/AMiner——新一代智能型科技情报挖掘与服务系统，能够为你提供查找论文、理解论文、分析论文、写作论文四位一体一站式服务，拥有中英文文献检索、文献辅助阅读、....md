...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、翻译、辅助阅读、科研情报订阅等。它覆盖42个学科，拥有3.5亿论文、0.6亿学者等海量数据。用户可通过互动问答快速获取文献摘要，支持PDF上传和AI辅助阅读分析。平台还提供个性化科研动态推送，支持按学者、机构或关键词订阅最新成果。此外，AMiner包含学者画像、学术会议和论文排行榜等功能，基础检索服务免费开放。访问入口：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T00:05:38Z
- **目录日期**: 2025-06-11
