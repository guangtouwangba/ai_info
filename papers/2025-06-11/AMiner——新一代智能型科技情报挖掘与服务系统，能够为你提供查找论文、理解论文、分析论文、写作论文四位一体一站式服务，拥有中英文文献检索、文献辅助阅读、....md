...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、翻译、辅助阅读和论文写作支持。它拥有3.5亿论文、0.6亿学者等海量数据，支持AI生成摘要、智能问答和科研动态订阅。用户可通过关键词、学者或机构定制推送最新研究，还能上传PDF进行解析和提问。平台免费开放基础功能，帮助研究者高效获取和分析学术信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T02:36:02Z
- **目录日期**: 2025-06-11
