...
这篇论文探讨了代码生成大模型(codeLLMs)与人类偏好的对齐问题，指出当前基准测试过于侧重代码正确性而忽略实际偏好。研究者创建了CodeArena基准(包含397个跨40类/44种语言的样本)和SynCode-Instruct合成指令集(20B标记)来评估模型。实验发现执行基准与CodeArena存在性能差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)表现差距显著，凸显了人类偏好对齐的重要性。研究为提升代码LLMs的实际适用性提供了新评估框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T14:06:32Z
- **目录日期**: 2025-06-11
