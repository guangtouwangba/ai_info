...
这篇论文针对代码生成大模型(codeLLMs)提出新评估方法，强调与人类偏好对齐的重要性。研究者创建了CodeArena基准测试(包含397个高质量样本，覆盖40类编程任务和44种语言)，发现传统执行测试与人类偏好存在差异。同时构建了20B标记的SynCode-Instruct合成指令集验证微调效果。实验比较40多个模型显示，顶级开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)仍存在显著差距，凸显了人类偏好对齐在代码生成中的关键作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T16:05:26Z
- **目录日期**: 2025-06-11
