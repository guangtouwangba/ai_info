...
美国西北大学Reese Richardson团队发布《开放科学诚信指南合集》(COSIG)，整合27种免费工具帮助识别学术不端行为。该指南提供跨学科造假检测方法，包括图像重复、AI生成文本、论文工厂特征等，并针对生物、化学等特定领域给出专业审查技巧（如细胞系真实性、肿瘤大小合规性等）。此外还包含举报流程指导、PubPeer评论规范等人际处理建议。该项目将持续更新，旨在提升学术研究质量监督效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T19:03:02Z
- **目录日期**: 2025-06-11
