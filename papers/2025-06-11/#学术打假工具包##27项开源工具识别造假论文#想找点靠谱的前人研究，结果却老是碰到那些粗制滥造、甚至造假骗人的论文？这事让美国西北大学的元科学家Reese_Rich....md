...
美国西北大学Reese Richardson团队发布《开放科学诚信指南合集》(COSIG)，整合27种免费工具帮助识别学术造假。该指南提供跨学科检测方法，包括图像重复、AI生成文本、论文工厂特征等，并针对生物、化学等特定领域给出审查技巧（如细胞系真实性、肿瘤尺寸合规性）。同时包含实用建议：如何在PubPeer发表建设性评论、向期刊举报问题、处理人际关系等。团队将持续更新该指南并欢迎反馈。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T13:13:34Z
- **目录日期**: 2025-06-11
