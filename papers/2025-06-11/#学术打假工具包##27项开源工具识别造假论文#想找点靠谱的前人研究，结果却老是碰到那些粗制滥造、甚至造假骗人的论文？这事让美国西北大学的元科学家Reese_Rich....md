...
美国西北大学Reese Richardson团队发布《开放科学诚信指南合集》(COSIG)，整合27种免费工具帮助识别学术造假。该指南涵盖图像重复检测、引用操纵分析、AI生成文本识别等技术，并提供跨学科造假特征识别方法（如伪造细胞系研究、肿瘤实验数据异常等）。除技术手段外，还包含在PubPeer发表评论、向期刊举报等实用建议，涉及生物、化学、统计等多个领域。团队将持续更新指南并开放反馈渠道，旨在提升科研诚信审查效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T23:01:22Z
- **目录日期**: 2025-06-11
