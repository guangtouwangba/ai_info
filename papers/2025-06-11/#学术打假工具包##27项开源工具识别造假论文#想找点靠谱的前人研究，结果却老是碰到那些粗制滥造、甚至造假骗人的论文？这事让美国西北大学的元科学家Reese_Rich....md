...
美国西北大学Reese Richardson团队发布《开放科学诚信指南合集》(COSIG)，整合27种免费工具帮助识别学术造假。该指南涵盖图像重复检测、引用操纵、剽窃识别等功能，并提供跨学科造假特征分析（如AI生成文本、论文工厂标记）。包含特定领域审查技巧（如癌症研究、动物实验等），同时指导科研人员使用PubPeer平台、举报流程及标准化操作方法。团队将持续更新该指南，旨在提升学术诚信审查效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T14:03:23Z
- **目录日期**: 2025-06-11
