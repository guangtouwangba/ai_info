...
美国西北大学的Reese Richardson团队发布《开放科学诚信指南合集》(COSIG)，整合27种免费工具帮助识别学术造假。该指南涵盖图像重复、引用操纵、剽窃、AI生成文本等常见问题，并提供特定学科（如生物、化学）的检测方法，包括细胞系真实性、实验伦理合规性等核查技巧。除技术检测外，还包含举报流程、同行评议规范等实用建议。该开源项目将持续更新，旨在提升科研诚信。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T15:02:59Z
- **目录日期**: 2025-06-11
