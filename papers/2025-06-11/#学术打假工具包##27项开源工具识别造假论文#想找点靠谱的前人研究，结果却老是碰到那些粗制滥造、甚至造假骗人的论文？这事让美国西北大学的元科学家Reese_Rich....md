...
美国西北大学Reese Richardson团队开发的《开放科学诚信指南合集》(COSIG)整合了27种免费工具，提供跨学科论文造假识别方案。该指南涵盖图像重复检测、引用操纵分析、AI生成文本识别等技术，并针对生物、化学等特定领域提供专业审查方法（如细胞系验证、实验伦理审查等）。此外还包含学术举报流程指导、PubPeer平台使用规范等人文建议。团队将持续更新这一开源工具包，旨在帮助科研人员有效鉴别问题论文，维护学术诚信。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T12:03:18Z
- **目录日期**: 2025-06-11
