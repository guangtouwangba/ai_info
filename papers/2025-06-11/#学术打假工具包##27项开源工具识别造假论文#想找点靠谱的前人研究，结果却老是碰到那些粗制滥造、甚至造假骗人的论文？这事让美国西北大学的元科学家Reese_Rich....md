...
美国西北大学Reese Richardson团队发布《开放科学诚信指南合集》(COSIG)，整合27种免费工具帮助识别学术造假。该指南提供跨学科检测方法，包括图像重复、AI生成文本、引用操纵等问题，并针对生物、化学等特定领域给出审查技巧（如问题细胞系检测）。同时包含实用建议：如何在PubPeer留言、举报问题论文及处理人际关系。团队将持续更新这一"学术打假工具包"，目前涵盖从论文工厂识别到图像篡改检测等全流程审查方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T18:01:38Z
- **目录日期**: 2025-06-11
