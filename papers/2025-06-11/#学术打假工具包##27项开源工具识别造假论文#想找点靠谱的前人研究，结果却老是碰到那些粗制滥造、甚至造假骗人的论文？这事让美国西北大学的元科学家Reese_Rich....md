...
美国西北大学Reese Richardson团队发布《开放科学诚信指南合集》(COSIG)，整合27种免费开源工具，提供跨学科论文造假识别方案。该指南涵盖图像重复检测、引文操纵分析、AI生成文本识别等技术，特别针对生物学、化学等领域的常见造假手法（如伪造细胞系、篡改实验数据）提供核查方法。同时包含学术举报流程指导、PubPeer平台使用规范等人际处理建议。团队将持续更新这一"学术打假工具包"，目前已在GitHub开源，旨在提升科研诚信审查效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T10:03:08Z
- **目录日期**: 2025-06-11
