...
为了解决自动驾驶等安全关键AI系统数据收集成本高、难以获取罕见边缘案例的问题，研究团队开发了Cosmos-Drive-Dreams合成数据生成管道。该工具基于NVIDIA Cosmos世界基础模型改进的Cosmos-Drive模型套件，能生成可控、高保真、多视角且时空一致的驾驶场景视频。实验表明，生成的数据能有效缓解长尾分布问题，提升3D车道检测、物体检测和驾驶策略学习等下游任务的泛化能力。团队已通过NVIDIA Cosmos平台开源了相关工具、数据集和模型权重。项目页面：https://research.nvidia.com/labs/toronto-ai/cosmos_drive_dreams

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T08:01:51Z
- **目录日期**: 2025-06-11
