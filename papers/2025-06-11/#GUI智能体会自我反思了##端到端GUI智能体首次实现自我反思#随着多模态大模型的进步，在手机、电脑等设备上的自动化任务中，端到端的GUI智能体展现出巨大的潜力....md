...
南洋理工大学MMLab团队开发了GUI-Reflection框架，首次实现了端到端GUI智能体的自我反思能力。该框架通过"预训练-监督微调-在线训练"三阶段模拟人类"犯错→反思→重试"的认知过程，引入反思数据后显著提升了模型性能。实验显示，即使小模型也能达到接近大模型的反思任务表现，特别是在离线微调和在线训练引导下，任务成功率大幅提升。这一突破解决了现有GUI智能体缺乏自我纠错能力的问题，为自动化任务领域带来了重要进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T16:03:23Z
- **目录日期**: 2025-06-11
