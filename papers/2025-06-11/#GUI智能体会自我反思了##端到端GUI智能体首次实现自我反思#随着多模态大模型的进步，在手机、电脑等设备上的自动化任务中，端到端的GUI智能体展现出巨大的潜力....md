...
南洋理工大学MMLab团队开发了GUI-Reflection框架，首次实现端到端GUI智能体的自我反思能力。该框架通过"犯错→反思→重试"机制模拟人类认知过程，结合预训练、监督微调和在线训练三阶段。实验显示，即使小模型加入反思数据后性能接近大模型，离线微调和在线训练显著提升成功率。这一突破解决了现有GUI智能体缺乏自我修正能力的问题，为自动化任务中的持续学习提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T21:02:07Z
- **目录日期**: 2025-06-11
