...
南洋理工大学MMLab团队开发了GUI-Reflection框架，首次实现端到端GUI智能体的自我反思能力。该框架通过"预训练-微调-在线训练"三阶段模拟人类"犯错→反思→重试"的认知过程，引入反思数据显著提升了模型表现。实验显示，即使小模型在加入反思机制后，任务成功率也能接近大模型水平。这项突破解决了现有GUI智能体缺乏自我纠错能力的问题，为通过在线强化学习持续优化智能体性能开辟了新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T22:02:21Z
- **目录日期**: 2025-06-11
