...
南洋理工大学MMLab团队开发了GUI-Reflection框架，首次实现端到端GUI智能体的自我反思能力。该框架通过"犯错→反思→重试"机制模拟人类认知过程，结合预训练、监督微调和在线训练三阶段。实验显示，引入反思数据后，小模型性能接近大模型水平，特别是在离线微调和在线训练引导下，任务成功率显著提升。这一突破解决了现有GUI智能体缺乏自我修正能力的问题，为自动化任务领域带来重要进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T11:04:07Z
- **目录日期**: 2025-06-11
