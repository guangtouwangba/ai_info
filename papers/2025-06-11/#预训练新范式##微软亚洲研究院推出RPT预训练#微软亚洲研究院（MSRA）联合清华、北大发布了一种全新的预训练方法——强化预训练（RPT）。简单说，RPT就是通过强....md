...
微软亚洲研究院联合清华、北大提出强化预训练（RPT）新范式，通过强化学习改造传统自监督训练。RPT让模型在预测token前进行深度推理（如自我批评/纠正），基于OmniMATH数据集和GRPO算法优化，使14B小模型推理能力媲美32B大模型。实验显示RPT显著提升推理准确性和计算效率，展现幂律缩放效应。该方法突破单纯token预测模式，赋予AI"思考"能力，未来或成为预训练主流方向。论文详见arXiv:2506.08007。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T15:03:30Z
- **目录日期**: 2025-06-11
