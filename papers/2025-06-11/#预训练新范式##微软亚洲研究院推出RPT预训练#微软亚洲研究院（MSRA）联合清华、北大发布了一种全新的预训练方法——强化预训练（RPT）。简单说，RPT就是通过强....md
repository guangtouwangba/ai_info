...
微软亚洲研究院联合清华、北大提出强化预训练（RPT）新范式，通过强化学习改造传统自监督训练。RPT让模型在预测token前进行推理（如自我批评/纠正），基于OmniMATH数据集和GRPO算法优化，使14B参数的模型推理能力媲美32B模型。实验显示RPT显著提升推理准确性，并展现计算资源的幂律缩放效应。该方法突破传统token预测模式，推动大模型向"思考后预测"演进，可能成为预训练新主流。论文详见：https://arxiv.org/abs/2506.08007

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T17:02:12Z
- **目录日期**: 2025-06-11
