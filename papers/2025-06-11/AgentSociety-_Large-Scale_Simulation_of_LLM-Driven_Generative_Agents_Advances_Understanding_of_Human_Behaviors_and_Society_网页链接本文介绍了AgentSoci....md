...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟10,000+个人工智能代理及其500万次互动。该系统通过真实社会环境模拟，研究了四大社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。研究结果显示其模拟结果与现实世界数据高度吻合，验证了系统捕捉人类行为机制的能力。该系统可作为计算社会科学研究平台，为传统研究方法（如调查、干预等）提供补充，帮助研究者探索社会问题的模式和成因，具有重要的学术和政策研究价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T03:26:51Z
- **目录日期**: 2025-06-11
