...
该研究介绍了AgentSociety，这是一个基于大语言模型的大规模社会模拟系统，能够模拟超过1万个智能代理及其500万次互动。研究者利用该系统考察了社会极化、信息传播、基本收入政策及自然灾害影响等社会问题。模拟结果与现实世界数据高度吻合，验证了该系统在揭示人类行为机制方面的有效性。AgentSociety展现了作为社会科学研究工具和政策评估平台的潜力，能够辅助传统研究方法，为理解复杂社会现象提供新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T16:04:44Z
- **目录日期**: 2025-06-11
