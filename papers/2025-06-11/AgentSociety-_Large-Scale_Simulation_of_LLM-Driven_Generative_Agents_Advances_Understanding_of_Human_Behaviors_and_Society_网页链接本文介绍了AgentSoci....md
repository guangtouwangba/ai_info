...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统模拟了超过1万个AI代理的社会生活，记录500万次互动，用于研究社会现象如信息传播、政策影响等。通过四个案例研究（包括社会极化和飓风冲击），结果显示其模拟结果与现实数据高度吻合，验证了该系统在揭示人类行为机制方面的有效性。该平台为社会科学研究和政策制定提供了新工具，能够补充传统研究方法，帮助理解复杂社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T00:05:10Z
- **目录日期**: 2025-06-11
