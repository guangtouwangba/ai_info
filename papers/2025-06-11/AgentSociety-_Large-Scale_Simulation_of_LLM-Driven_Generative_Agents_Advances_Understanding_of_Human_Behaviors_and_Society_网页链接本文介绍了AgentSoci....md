...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理的社会互动（500万次交互）。该系统被用于研究四大社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。研究显示，模拟结果与现实世界数据高度吻合，验证了该系统在揭示人类行为机制方面的有效性。这一工具为社会科学研究和政策制定提供了新方法，能够补充传统调查和实验的不足，有助于深入理解复杂社会现象背后的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T02:35:34Z
- **目录日期**: 2025-06-11
