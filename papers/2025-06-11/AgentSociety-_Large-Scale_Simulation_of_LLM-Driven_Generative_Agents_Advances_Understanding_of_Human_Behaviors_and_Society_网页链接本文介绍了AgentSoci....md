...
AgentSociety是一种基于大语言模型的大规模社会模拟器，可模拟1万个代理的社会互动（500万次互动）。它用于研究极化现象、信息传播、基本收入政策及外部冲击（如飓风）等社会问题，结果与现实实验吻合。该工具可作为计算社会科学的研究平台，辅助传统方法（如调查、访谈），帮助分析社会问题的模式和机制。其仿真能力验证了其在模拟人类行为和社会机制方面的有效性，有望成为社会科学研究和政策制定的重要工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T06:05:08Z
- **目录日期**: 2025-06-11
