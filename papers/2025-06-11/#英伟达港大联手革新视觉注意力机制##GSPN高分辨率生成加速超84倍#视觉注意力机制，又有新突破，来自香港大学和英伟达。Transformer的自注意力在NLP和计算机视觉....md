...
香港大学与英伟达合作提出广义空间传播网络(GSPN)，革新视觉注意力机制。传统Transformer处理高分辨率图像时存在计算复杂度高(O(N²))和破坏空间结构的问题。GSPN通过二维线性传播和"稳定性-上下文条件"机制，将计算复杂度降至√N级别，同时保留图像空间连贯性。该方法在多个视觉任务中实现性能突破，高分辨率图像生成速度提升超过84倍，显著提高了效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T02:34:08Z
- **目录日期**: 2025-06-11
