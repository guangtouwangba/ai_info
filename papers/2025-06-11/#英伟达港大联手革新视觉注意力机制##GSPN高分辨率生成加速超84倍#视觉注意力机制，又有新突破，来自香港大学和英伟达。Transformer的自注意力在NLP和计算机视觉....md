...
香港大学与英伟达合作提出广义空间传播网络(GSPN)，革新视觉注意力机制。传统Transformer处理高分辨率图像时存在计算复杂度高(O(N²))和破坏空间结构的问题。GSPN通过二维线性传播和"稳定性-上下文条件"机制，将计算复杂度降至√N级别，同时保留图像空间连贯性。该方法在保持性能的同时显著提升效率，高分辨率图像生成速度提升超84倍，并在多项视觉任务中创下新纪录。这一突破为处理高分辨率视觉数据提供了更高效的解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T01:30:52Z
- **目录日期**: 2025-06-11
