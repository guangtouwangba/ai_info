...
苹果推出Containerization框架，使开发者能在Apple Silicon Mac上运行Linux容器。该方案基于Virtualization.framework，支持OCI镜像管理、轻量级虚拟机容器化进程，集成vminitd系统进行配置管理，并通过Rosetta 2兼容amd64架构容器。需macOS 15+Xcode 26 beta构建，部分高级功能受限。提供cctl工具测试镜像管理、容器运行等功能，GitHub已开源相关文档。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T11:04:17Z
- **目录日期**: 2025-06-11
