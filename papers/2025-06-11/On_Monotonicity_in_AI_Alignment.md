...
这篇论文研究了基于比较的偏好学习方法（如DPO、GPO和GBT）中出现的反直觉现象，即模型在偏好响应y胜过z时，可能反而降低生成y的概率。作者通过实证观察和理论分析，证明了这类方法仍满足局部成对单调性，并提出了一系列单调性形式化定义及其充分条件，为评估学习模型的单调性违规倾向提供了工具。研究结果揭示了当前方法的局限性，并为开发更可靠的偏好学习算法提供了指导。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T19:02:04Z
- **目录日期**: 2025-06-11
