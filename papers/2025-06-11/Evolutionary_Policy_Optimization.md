...
本文提出了一种结合进化算法（EA）和策略梯度优点的混合算法——进化策略优化（EPO）。EPO通过维护基于潜在变量的智能体种群，共享网络参数以提高效率和一致性，并将多样化经验聚合到主智能体中。相比传统策略梯度算法难以扩展批量大小，以及进化算法样本效率低的问题，EPO兼具EA的可扩展性和探索能力，以及策略梯度的性能和稳定性。实验表明，在灵巧操作、足式运动和经典控制任务中，EPO在样本效率、渐进性能和可扩展性上均优于现有最优方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T08:02:24Z
- **目录日期**: 2025-06-11
