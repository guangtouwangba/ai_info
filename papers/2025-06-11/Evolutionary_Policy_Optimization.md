...
本文提出了一种结合进化算法（EA）和策略梯度优点的混合算法——进化策略优化（EPO）。该算法通过维护基于隐变量的智能体种群，共享网络参数以提高效率，并将多样化经验聚合到主智能体中，解决了传统策略梯度算法在大批量训练时多样性不足的问题，同时保持了进化算法的可扩展性。实验表明，EPO在灵巧操控、腿部运动及经典控制任务中，在样本效率、渐进性能和可扩展性方面均优于现有最优基线方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T15:02:04Z
- **目录日期**: 2025-06-11
