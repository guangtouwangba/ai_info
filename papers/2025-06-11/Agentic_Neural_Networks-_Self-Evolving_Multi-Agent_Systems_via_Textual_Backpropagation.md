...
本文提出了Agentic Neural Network(ANN)框架，将多智能体协作建模为分层神经网络结构。每个智能体作为节点，每层团队专注于特定子任务。ANN采用两阶段优化：前向阶段动态分解任务并构建协作团队；反向阶段通过迭代反馈优化协作，使智能体自我进化。这种神经符号方法使ANN能在训练后创建新团队，显著提升准确性和适应性。在四个基准测试中，ANN在相同配置下优于主流多智能体基线，表现出稳定的性能提升。该框架结合了大语言模型的协作能力与神经网络的高效灵活性，具有可扩展性和数据驱动特性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T04:06:03Z
- **目录日期**: 2025-06-11
