...
本文提出了一种名为Agentic Neural Network(ANN)的新型多智能体协作框架，将多智能体系统类比为分层的神经网络结构。ANN采用两阶段优化策略：前向阶段动态分解任务并构建分层协作团队，后向阶段通过迭代反馈优化全局和局部协作。这种神经符号方法使ANN能够创建新的专业化团队，在四个基准数据集上超越了现有方法，表现出更高的准确性和适应性。ANN结合了大语言模型的协作能力与神经网络的高效灵活性，为多智能体系统提供了可扩展的数据驱动框架。作者计划开源整个框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T11:01:23Z
- **目录日期**: 2025-06-11
