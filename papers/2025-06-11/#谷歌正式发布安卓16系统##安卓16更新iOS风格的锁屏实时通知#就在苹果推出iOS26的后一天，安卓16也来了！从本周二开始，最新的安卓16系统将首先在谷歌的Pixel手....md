# #谷歌正式发布安卓16系统##安卓16更新iOS风格的锁屏实时通知#就在苹果推出iOS26的后一天，安卓16也来了！从本周二开始，最新的安卓16系统将首先在谷歌的Pixel手...
...
谷歌正式发布安卓16系统，主要更新包括：1) iOS风格锁屏实时通知功能；2) 状态栏通知自动归类；3) 助听设备通话支持升级；4) 高级保护2.0安全方案；5) 平板电脑新增桌面模式。同时宣布多项应用更新：Google Messages支持RCS群聊、Google Home新增智能家居快捷方式、Google Wallet支持手表交通卡、Google Photos将推出智能图片编辑工具。Material 3新设计语言将延至2025年发布。系统首批适配Pixel手机。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T04:07:53Z
- **目录日期**: 2025-06-11
