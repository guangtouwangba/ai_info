...
本文提出PALM方法，利用大语言模型(LLM)生成高覆盖率的单元测试。通过程序分析识别函数中的分支条件并构建路径约束，结合上下文信息生成提示词指导LLM。在10个Rust开源项目中的实验表明，PALM仅需2-3小时就能显著提升测试覆盖率，某些项目覆盖率提升超50%，平均达75.77%，接近人工水平(71.30%)。提交的91个测试用例中80个被接受，验证了该方法有效性。PALM将程序分析与AI结合，为自动化软件测试开辟了新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T12:02:03Z
- **目录日期**: 2025-06-11
