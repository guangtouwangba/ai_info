...
斯坦福大学最新研究表明，AI与医生协作能显著提升临床诊断准确率。实验将70名医生分为AI优先组（先看AI诊断）、AI后行组（后看AI建议）和传统工具组。结果显示，两种协作模式的诊断准确率分别达到85%和82%，显著高于传统组的75%。AI单独诊断准确率高达90%，与协作效果相当。研究表明，AI作为协作伙伴能减少误诊，提升决策质量。该研究基于GPT-3.5/4测试，暗示更强模型可能带来更大提升。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T02:34:00Z
- **目录日期**: 2025-06-11
