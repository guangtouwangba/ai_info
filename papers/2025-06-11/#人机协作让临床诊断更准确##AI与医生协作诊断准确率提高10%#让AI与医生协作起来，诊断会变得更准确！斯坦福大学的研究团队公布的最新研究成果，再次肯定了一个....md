...
斯坦福大学研究显示，AI与医生协作可显著提升临床诊断准确率。实验招募70名医生，对比AI协作组（AI-first和AI-second模式）与传统资源组的表现。协作组准确率达82%-85%，高于对照组的75%，AI单独诊断准确率更高达90%。研究表明，AI作为协作伙伴能减少误诊并提升决策质量，两种协作模式效果相当，AI-first略优。该成果基于GPT-3.5/4测试，凸显人机协同在医疗诊断中的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T01:30:43Z
- **目录日期**: 2025-06-11
