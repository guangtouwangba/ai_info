...
斯坦福大学最新研究表明，AI与医生协作可显著提升临床诊断准确率。实验招募70名医生分为AI优先组(AI-first)、医生优先组(AI-second)和传统工具对照组。结果显示：协作组诊断准确率达82%-85%，显著高于对照组的75%；AI单独诊断准确率更高达90%。研究创新性地开发了能整合医患双方意见的GPT系统，通过分析共识与分歧点生成综合报告。两种协作模式效果相当，但AI-first组在临床决策方面略优。这表明将AI作为诊断协作伙伴能有效减少误诊，提升医疗质量。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T04:08:48Z
- **目录日期**: 2025-06-11
