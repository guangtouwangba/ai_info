...
哈佛大学研究发现，在AI预训练阶段加入10%的有毒数据（如4chan内容）反而能提升模型表现。这些数据能帮助AI更清晰识别有毒概念，使后续对齐训练更有效。实验显示，适量接触有毒内容的模型不仅减少了有害输出，还保持了良好语言能力，且对越狱攻击更具抵抗力。研究表明，完全排除有毒数据可能导致模型难以区分有害内容，而适度接触并配合后期训练，能让AI更合规且抗干扰。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T22:01:32Z
- **目录日期**: 2025-06-11
