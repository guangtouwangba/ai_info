...
该论文提出了HeuriGym框架，用于评估大语言模型(LLMs)在组合优化问题中生成启发式算法的能力。该框架允许LLMs提出启发式方法，通过代码执行获得反馈并迭代优化方案。研究测试了9个前沿模型在计算机系统、物流和生物等领域的9个问题上的表现，揭示了它们在工具使用、规划和自适应推理方面的局限。作者提出质量-产出指数(QYI)来量化性能，发现即使顶级模型如GPT-4-mini-high和Gemini-2.5-Pro的QYI得分仅为0.6，远低于专家基准1。该开源基准旨在推动LLMs在科学和工程领域的实际问题解决能力发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-11T01:29:43Z
- **目录日期**: 2025-06-11
