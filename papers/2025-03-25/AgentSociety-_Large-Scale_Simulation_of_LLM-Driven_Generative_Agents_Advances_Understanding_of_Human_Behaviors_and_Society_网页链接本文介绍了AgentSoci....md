...
本文介绍AgentSociety——一个基于大语言模型的大规模社会模拟器，可模拟1万多个AI代理的社会互动（500万次）。该系统作为计算社会科学实验平台，研究了社会极化、信息传播、基本收入政策及自然灾害影响等四大社会问题。其模拟结果与现实世界数据高度吻合，证明该系统能有效捕捉人类行为机制，为社会科学研究和政策制定提供了创新工具。该研究展示了AI模拟在理解复杂社会现象方面的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T17:05:05Z
- **目录日期**: 2025-03-25
