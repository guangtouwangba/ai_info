...
这篇论文介绍了一个名为AgentSociety的大规模社会模拟器，它结合了大型语言模型（LLM）驱动的智能代理、真实社会环境和大规模模拟引擎。研究者模拟了超过1万个代理的社会生活及其500万次互动，并研究了极化现象、信息传播、基本收入政策和外部冲击（如飓风）等社会问题。模拟结果与现实世界实验数据吻合，验证了该工具在捕捉人类行为机制方面的能力，展示了其作为社会科学研究和政策制定辅助工具的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T22:04:49Z
- **目录日期**: 2025-03-25
