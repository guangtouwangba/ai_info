...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟1万多个AI代理及其500万次互动。研究者用它分析了四大社会问题：社会极化、信息传播、基本收入政策及自然灾害影响。结果显示其模拟结果与现实数据高度吻合，验证了该系统在揭示人类行为机制方面的有效性。该平台可作为社会科学研究和政策制定的创新工具，补充传统研究方法（如调查和实验），帮助深入理解复杂社会现象。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T04:04:58Z
- **目录日期**: 2025-03-25
