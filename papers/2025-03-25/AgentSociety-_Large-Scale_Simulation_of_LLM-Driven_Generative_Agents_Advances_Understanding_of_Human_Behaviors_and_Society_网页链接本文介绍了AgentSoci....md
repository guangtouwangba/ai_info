...
AgentSociety是一个基于大型语言模型的大规模社会模拟器，能模拟1万多个代理的社会互动（500万次）。该平台用于研究极化现象、信息传播、基本收入政策及自然灾害影响等社会问题。其模拟结果与现实数据吻合，验证了该工具在分析人类行为机制方面的有效性，展示了作为社会科学研究和政策制定辅助工具的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T00:04:43Z
- **目录日期**: 2025-03-25
