...
AgentSociety是一种基于大语言模型的大规模社会模拟器，可模拟超过1万个代理的社会互动（500万次互动）。研究者用它研究四个社会问题：群体极化、刺激性信息传播、基本收入政策影响和自然灾害（如飓风）效应。模拟结果与现实世界数据吻合，验证了该系统捕捉人类行为机制的能力。该平台可作为计算社会科学工具，辅助传统研究方法（如调查、访谈），帮助学者和政策制定者分析社会问题的成因与模式。研究展示了AI模拟在社会科学研究中的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T12:05:43Z
- **目录日期**: 2025-03-25
