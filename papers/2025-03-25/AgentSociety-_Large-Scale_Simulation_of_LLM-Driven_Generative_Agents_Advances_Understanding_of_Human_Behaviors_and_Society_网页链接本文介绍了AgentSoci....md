...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟1万多个代理的社会互动（500万次交互）。它用于研究社会问题，如极化现象、信息传播、基本收入政策及自然灾害影响。模拟结果与现实数据吻合，验证了其模拟人类行为和社会机制的能力。该系统可作为社会科学研究和政策制定的有效工具，补充传统研究方法（如调查、访谈）。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T23:04:45Z
- **目录日期**: 2025-03-25
