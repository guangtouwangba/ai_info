...
AgentSociety是一种基于大语言模型的大规模社会模拟器，可模拟1万多个代理及其500万次互动。研究者用它研究社会极化、信息传播、基本收入政策及外部冲击等社会问题，结果与现实世界数据吻合。该系统结合了LLM代理、真实社会环境和大规模模拟引擎，为社会科学研究和政策制定提供了新工具，能够揭示社会问题的模式、原因及机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T02:31:43Z
- **目录日期**: 2025-03-25
