...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟1万多个代理及其500万次互动。研究通过该平台探索了社会极化、信息传播、基本收入政策和自然灾害影响四个关键问题。模拟结果与现实数据吻合，验证了其捕捉人类行为机制的能力，展示了作为社会科学研究和政策制定工具的潜力。该技术为传统研究方法（如调查、访谈）提供了补充，有助于深入理解社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T08:05:25Z
- **目录日期**: 2025-03-25
