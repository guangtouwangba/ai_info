...
本文提出了一种面向动态无线网络的资源感知可调工作负载收发器(ROUTE)，用于高效传输AI生成内容(AIGC)。该方案结合语义通信(SemCom)和扩散式生成AI模型，通过优先传输内容语义信息缓解带宽压力，并采用改进的扩散模型动态调整边缘/本地计算负载和语义密度，优化资源利用并减少语义失真。实验表明，相比传统方法，ROUTE在传输延迟和内容质量方面表现更优，有效解决了无线网络中信道不稳定、带宽有限和计算资源分布不均等AIGC服务交付的主要挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T04:01:32Z
- **目录日期**: 2025-03-25
