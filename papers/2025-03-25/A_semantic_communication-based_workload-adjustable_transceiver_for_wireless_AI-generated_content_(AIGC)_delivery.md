...
本文提出了一种面向动态无线网络的资源感知可调工作负载收发器（ROUTE），用于高效传输AI生成内容（AIGC）。针对无线网络信道不稳定、带宽有限和计算资源分布不均等问题，ROUTE结合语义通信（SemCom）和扩散式生成AI模型，优先传输内容语义信息以缓解通信资源瓶颈。同时，通过改进的扩散模型动态调整边缘和本地计算负载及语义密度，提高资源利用率并减少传输中的语义失真。实验表明，与传统AIGC方法相比，ROUTE在延迟和内容质量方面表现更优。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T22:01:34Z
- **目录日期**: 2025-03-25
