...
本文提出了一种基于语义通信的资源感知可调收发器(ROUTE)，用于动态无线网络中AI生成内容(AIGC)的传输。通过语义通信优先处理生成内容的关键语义信息，缓解通信资源瓶颈；采用改进的扩散模型调整计算负载和语义密度，提高边缘和本地计算资源利用率，减少传输中的语义失真。相比传统方法，ROUTE在延迟和内容质量方面表现更优。该方案解决了无线网络中信道不稳定、带宽有限和计算资源分布不均等AIGC服务交付的主要挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T14:01:47Z
- **目录日期**: 2025-03-25
