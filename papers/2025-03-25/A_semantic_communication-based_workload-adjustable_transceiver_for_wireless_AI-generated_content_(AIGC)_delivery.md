...
本文提出了一种基于语义通信的资源感知可调收发器(ROUTE)，用于动态无线网络中AI生成内容(AIGC)的高效传输。该方法结合扩散式生成AI模型，通过语义通信优先传输关键语义信息以缓解带宽压力，并采用改进的扩散模型动态调整计算负载和语义密度，优化边缘与本地计算资源利用。相比传统方法，ROUTE在降低传输延迟和提高内容质量方面表现更优，有效解决了无线网络中信道不稳定、带宽有限和计算资源分布不均等挑战。仿真结果验证了该方案的优越性能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T08:01:41Z
- **目录日期**: 2025-03-25
