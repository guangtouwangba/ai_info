...
本文提出了一种面向动态无线网络的资源感知可调工作量收发器（ROUTE），用于高效传输AI生成内容（AIGC）。该方案结合语义通信（SemCom）和基于扩散的生成AI模型，通过优先传输内容语义信息缓解带宽限制，并调整计算负载与语义密度以优化边缘/本地资源利用。相比传统方法，ROUTE在降低传输延迟和提升内容质量方面表现更优。仿真结果表明，该方法能有效解决无线网络中信道不稳定、带宽有限和计算资源分布不均等问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T07:01:50Z
- **目录日期**: 2025-03-25
