...
本文提出Aether框架，通过联合优化4D动态重建、动作条件视频预测和目标条件视觉规划三项核心能力，实现几何感知的世界模型推理。该框架采用任务交错特征学习，促进重建、预测和规划目标间的知识共享。基于视频生成模型，Aether在训练中未接触真实数据的情况下，展现出卓越的合成到真实泛化能力，并在动作跟随和重建任务中实现零样本泛化。其几何建模能力使重建性能远超领域专用模型，且能通过几何感知动作空间将预测转化为行动，实现自主轨迹规划，为物理合理世界建模开辟新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T17:01:11Z
- **目录日期**: 2025-03-25
