...
本文提出Aether框架，通过联合优化4D动态重建、动作条件视频预测和目标条件视觉规划三大核心能力，实现几何感知的世界建模。该框架采用任务交织特征学习，促进重建、预测与规划之间的知识共享。基于视频生成模型，Aether在未接触真实数据的情况下展现出卓越的合成-现实泛化能力，并在动作执行和重建任务中实现零样本泛化。其几何建模能力使重建性能超越专用模型，并通过几何感知动作空间将预测转化为行动，实现自主轨迹规划。该研究为物理合理的世界建模开辟了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T08:01:05Z
- **目录日期**: 2025-03-25
