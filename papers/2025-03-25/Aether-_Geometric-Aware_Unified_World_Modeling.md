...
这篇论文提出了Aether框架，通过联合优化4D动态重建、动作条件视频预测和目标条件视觉规划三项核心能力，实现了几何感知的世界建模。该框架采用任务交错特征学习，促进了重建、预测和规划之间的知识共享。尽管训练中未使用真实数据，Aether仍展现出卓越的合成到真实泛化能力，并在动作跟随和重建任务中实现零样本泛化。其重建性能远超领域专用模型，并能通过几何感知动作空间将预测转化为有效自主轨迹规划。该研究为物理合理世界建模开辟了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T12:01:02Z
- **目录日期**: 2025-03-25
