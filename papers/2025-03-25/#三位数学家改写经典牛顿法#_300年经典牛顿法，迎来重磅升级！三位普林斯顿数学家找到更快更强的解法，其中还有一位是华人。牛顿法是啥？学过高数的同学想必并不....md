...
普林斯顿三位数学家（含一位华人）对300年历史的牛顿法进行了重大改进。牛顿法通过迭代求导寻找函数零点，广泛应用于计算机视觉、金融等领域，但存在函数适用性限制。新算法显著扩大了适用函数范围，在复杂二元函数中展现出更连贯、覆盖面更广的收敛性。研究者表示，该改进可能取代传统牛顿法在众多优化问题中的应用。这一突破解决了牛顿法长期存在的局限性问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T13:09:49Z
- **目录日期**: 2025-03-25
