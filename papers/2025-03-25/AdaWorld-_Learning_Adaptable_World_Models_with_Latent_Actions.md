...
AdaWorld是一种创新的世界模型学习方法，通过自监督方式从视频中提取潜在动作，捕捉帧间关键变化，并在预训练中融入动作信息。相比依赖大量标注数据和昂贵训练的现有模型，AdaWorld能通过有限交互快速适应新环境中的异构动作，实现高效迁移和学习。实验表明，AdaWorld在模拟质量和视觉规划方面均表现优异，解决了传统模型跨领域适应性不足的问题，为智能代理的发展提供了更高效的解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T07:01:22Z
- **目录日期**: 2025-03-25
