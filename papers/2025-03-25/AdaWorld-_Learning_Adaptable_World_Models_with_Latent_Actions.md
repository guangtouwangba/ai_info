...
AdaWorld是一种创新的世界模型学习方法，通过自监督方式从视频中提取潜在动作信息，并构建基于这些动作的自回归世界模型。该方法在预训练阶段融入动作信息，捕捉帧间关键变化，从而减少对大量标注数据和昂贵训练的依赖。AdaWorld能够高效适应新环境，即使在有限交互和微调的情况下也能快速学习新动作。实验表明，AdaWorld在模拟质量和视觉规划方面均优于现有方法，展现出更强的跨领域适应能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T20:01:07Z
- **目录日期**: 2025-03-25
