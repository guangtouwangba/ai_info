...
AdaWorld是一种创新的世界模型学习方法，通过自监督方式从视频中提取潜在动作信息，捕捉帧间关键变化，从而减少对大量动作标记数据的依赖。该方法在预训练阶段融入动作信息，构建基于潜在动作的自回归世界模型，使其能高效适应新环境，即使交互和微调数据有限。实验表明，AdaWorld在仿真质量和视觉规划方面表现优异，显著提升了跨领域适应能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T13:07:36Z
- **目录日期**: 2025-03-25
