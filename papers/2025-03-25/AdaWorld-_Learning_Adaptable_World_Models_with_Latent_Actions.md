...
AdaWorld是一种创新的世界模型学习方法，通过自监督方式从视频中提取潜在动作信息，捕捉帧间关键变化，从而减少对大量动作标记数据的依赖。该方法在预训练阶段融入动作信息，构建基于潜在动作的自回归世界模型，显著提升了模型在新环境中的适应能力。实验表明，AdaWorld在仿真质量和视觉规划任务上表现优异，仅需有限交互和微调即可高效学习新动作，适用于更广泛的领域。这一突破克服了传统世界模型依赖大量标记数据和训练成本高的限制，为智能体开发提供了更灵活高效的解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T04:01:06Z
- **目录日期**: 2025-03-25
