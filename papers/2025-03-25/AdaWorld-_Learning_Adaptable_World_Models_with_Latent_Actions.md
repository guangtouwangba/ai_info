...
AdaWorld是一种创新的世界模型学习方法，通过自监督方式从视频中提取潜在动作信息，捕捉关键帧间转换，并构建基于这些潜在动作的自回归世界模型。该方法在预训练阶段融入动作信息，显著减少了对大量动作标注数据的依赖和训练成本，从而能够高效适应新环境中的异构动作。实验表明，AdaWorld在模拟质量和视觉规划方面表现优异，支持有限交互下的快速迁移和学习，为智能代理在更广泛领域的应用提供了可能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T17:01:19Z
- **目录日期**: 2025-03-25
