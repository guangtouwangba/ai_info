...
DeepSeek V3近期进行了"小版本升级"，实测能力显著提升。新版本虽非推理模型，但能自主分解问题并在陷入误区时回溯思考。在解决"7米甘蔗通过2米高1米宽的门"的难题时，模型经历典型思考过程：先碰壁，后重新审视题目，最终通过"啊哈时刻"顿悟隐藏条件并给出解决方案（尽管计算仍有误区）。这一表现展示了类似人类解题的认知突破能力，被评价为"堪比V3.5"的实质升级。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T03:14:53Z
- **目录日期**: 2025-03-25
