...
美国得克萨斯州Alpha私立K12学校采用AI辅导模式引发关注。该校学生每天仅用2小时与AI助手学习核心课程（效率达传统教学3倍），其余时间培养软技能。OpenAI总裁转发了其"个性化AI导师提升成绩至全国前2%"的成果。支持者认为该模式能降低教育成本，但质疑者指出：1）年学费高达4万美元；2）缺乏具体测试数据和学生背景信息佐证效果。目前该校有数百名学生，部分学生反馈课业压力显著低于传统学校。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T15:04:25Z
- **目录日期**: 2025-03-25
