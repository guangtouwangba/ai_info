...
美国得克萨斯州Alpha私立学校采用AI辅导模式引发关注。该校学生每天仅用2小时与AI助手学习核心课程，效率达传统教学3倍（2小时=6小时传统教学），其余时间培养软技能。OpenAI总裁转发认可其个性化教学成果，学生成绩进入全国前2%。不过该校年学费高达4万美元，且缺乏具体测试数据和学生背景信息，引发部分质疑。支持者认为该模式能降低教育成本，学生反馈课业压力显著减轻。目前该校有数百名学生，并计划在全美扩张。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T13:10:47Z
- **目录日期**: 2025-03-25
