...
美国得克萨斯州Alpha私立K12学校采用AI辅导教学模式引发关注。学生每天仅用2小时与AI助手学习核心课程，效率达传统教学3倍（2小时=6小时），其余时间培养软技能。OpenAI总裁转发其成果，校方称学生成绩进入全国前2%，学习速度提升1倍。但该校年学费高达4万美元，且未公开具体测试数据和学生背景信息，引发部分网友质疑。支持者认为该模式能降低教育成本，学生反馈课业压力显著减轻，有更多时间投入创新项目。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T07:03:50Z
- **目录日期**: 2025-03-25
