...
美国得克萨斯州Alpha私立学校采用AI辅导系统，学生每天仅用2小时与AI助手学习核心课程，其余时间培养其他技能。校方称该模式使学习效率提升1倍（2小时相当于传统教学6小时），部分学生成绩进入全国前2%。OpenAI总裁转发认可其个性化教学成果，但每年4万美元学费和缺乏具体测试数据引发质疑。支持者认为该模式能降低教育成本，学生反馈课业压力显著减轻，有更多时间投入创新项目。目前该校正全美扩张，但教育成效仍需更多实证支持。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T06:03:30Z
- **目录日期**: 2025-03-25
