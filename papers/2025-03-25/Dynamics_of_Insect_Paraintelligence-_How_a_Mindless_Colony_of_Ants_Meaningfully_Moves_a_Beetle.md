...
本文提出了"随机性矢量耗散"(VDR)的新概念，用于解释多组分复杂系统如何通过随机方向过滤、环境信息积累和智能体自组织，实现从混沌到有序的转变。该模型通过"蚂蚁与甲虫"系统的数值模拟验证：蚂蚁通过随机移动和反馈机制，最终形成甲虫的协调运动矢量。VDR是适用于生物群体、去中心化技术网络、社会过程和人工智能算法的普适机制。研究首次提出了蚂蚁-甲虫系统中VDR处理的归一化涌现函数方程，并引入"准智能"概念，指代无自我意识但功能等效于智能活动的理性功能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T17:02:08Z
- **目录日期**: 2025-03-25
