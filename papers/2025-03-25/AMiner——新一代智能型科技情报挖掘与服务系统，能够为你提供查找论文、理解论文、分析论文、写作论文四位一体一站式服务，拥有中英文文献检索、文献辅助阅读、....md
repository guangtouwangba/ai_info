...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、科研情报订阅等一站式服务。平台收录3.5亿论文、0.6亿学者等海量数据，支持文献辅助阅读、AI生成摘要、智能问答等功能。用户可定制订阅最新科研动态，还能使用学者画像、学术会议等特色功能。AMiner通过AI技术帮助用户高效查找、理解和分析论文，提升科研效率。浏览器版可免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T05:05:26Z
- **目录日期**: 2025-03-25
