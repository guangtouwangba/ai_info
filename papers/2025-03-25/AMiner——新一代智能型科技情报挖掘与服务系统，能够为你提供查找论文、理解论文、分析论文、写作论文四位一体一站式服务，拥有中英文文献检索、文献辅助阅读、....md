...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、科研情报订阅等一站式服务。它能快速定位相关学术文献，通过AI生成摘要和问答互动帮助理解内容。用户可上传或搜索论文，获取章节概要和问题建议。平台还支持个性化订阅，推送最新科研动态。收录3.5亿论文、0.6亿学者等海量数据，覆盖42个学科。主要功能包括文献辅助阅读、学者画像、学术会议追踪等，浏览器即可免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T01:33:25Z
- **目录日期**: 2025-03-25
