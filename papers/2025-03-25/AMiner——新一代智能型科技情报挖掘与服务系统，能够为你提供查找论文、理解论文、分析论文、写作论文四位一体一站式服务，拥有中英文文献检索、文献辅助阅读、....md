...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、科研情报订阅等一站式服务。它能高效定位学术文献，通过互动问答帮助理解内容，并自动生成摘要。用户可上传PDF或从平台3.5亿论文库中选取文献，AI会生成概要并支持内容提问。平台还支持个性化科研动态订阅，按用户偏好推送最新论文摘要。此外提供学者画像、学术会议等辅助功能。AMiner浏览器版免费使用，旨在提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T15:05:54Z
- **目录日期**: 2025-03-25
