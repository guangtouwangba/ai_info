...
AMiner是一个智能科技情报挖掘系统，提供论文检索、翻译、分析和写作一站式服务。它支持中英文文献搜索，能自动生成摘要和回答相关问题，提升研究效率。平台还具备文档翻译、辅助阅读功能，用户可上传PDF获取AI生成的摘要和章节概要。此外，AMiner提供科研动态订阅服务，根据用户偏好推送最新论文和资讯。平台收录3.5亿论文、0.6亿学者等海量数据，并免费开放基础功能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T08:05:55Z
- **目录日期**: 2025-03-25
