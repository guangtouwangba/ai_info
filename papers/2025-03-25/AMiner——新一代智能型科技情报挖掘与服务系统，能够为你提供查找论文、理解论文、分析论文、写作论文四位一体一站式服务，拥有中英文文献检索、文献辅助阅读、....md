...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译及科研分析等一站式服务。它收录了3.5亿篇论文、0.6亿学者及1.5亿专利，支持中英文文献检索、AI摘要生成和互动问答。用户可上传PDF或从平台获取论文，系统自动生成摘要和章节概要，并提供翻译功能。此外，AMiner支持个性化科研情报订阅，按用户偏好推送最新学术动态。平台还提供学者画像、学术会议和论文排行榜等功能，基础服务免费使用。网址：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T19:05:01Z
- **目录日期**: 2025-03-25
