...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析及写作一站式服务。支持中英文文献搜索、AI辅助阅读、自动摘要生成及翻译功能，覆盖42个学科3.5亿论文资源。其特色包括：1）智能问答快速定位核心文献；2）PDF文档解析与章节概要生成；3）定制化科研情报订阅（通过微信/邮件推送）；4）学者画像、学术会议等拓展功能。平台免费开放基础检索服务，用户可通过网页或小程序使用。核心优势在于利用AI技术显著提升文献处理效率，帮助研究者快速获取前沿学术动态。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T03:17:09Z
- **目录日期**: 2025-03-25
