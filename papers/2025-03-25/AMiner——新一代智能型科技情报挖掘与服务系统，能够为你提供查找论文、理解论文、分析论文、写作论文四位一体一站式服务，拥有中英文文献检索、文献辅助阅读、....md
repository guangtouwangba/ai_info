...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析及写作一站式服务。平台支持中英文文献检索，AI可生成摘要并解答文献相关问题；具备文档翻译、章节概要等功能，支持PDF上传解析；还能定制科研情报订阅，推送最新学术动态。覆盖42个学科，包含3.5亿论文、0.6亿学者等数据，免费提供学者画像、会议资讯等附加功能。访问入口：https://www.aminer.cn/ 和 AI交互页：https://www.aminer.cn/chat/g/explain/ 。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T00:05:06Z
- **目录日期**: 2025-03-25
