...
这篇论文针对代码生成大模型（codeLLMs）提出新评估方法，强调人类偏好对齐的重要性。研究者创建了CodeArena基准测试（含397个高质量样本，覆盖40类任务和44种语言）和SynCode-Instruct合成指令集（20B标记），发现传统执行测试与人类偏好存在差异。实验比较40多个模型显示，开源顶级模型（如Qwen2.5-Coder）与商业模型（如OpenAI o1）性能差距显著，证实人类偏好对齐是提升代码生成质量的关键维度。该研究为代码LLM评估提供了更贴近实际开发场景的新标准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T02:32:25Z
- **目录日期**: 2025-03-25
