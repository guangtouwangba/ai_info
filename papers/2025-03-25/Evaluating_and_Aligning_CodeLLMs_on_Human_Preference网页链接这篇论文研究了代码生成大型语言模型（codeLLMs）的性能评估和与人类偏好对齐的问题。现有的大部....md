...
这篇论文针对代码生成大模型(codeLLMs)提出新评估方法，指出当前基准测试过于关注代码正确性而忽视人类偏好。研究者构建了CodeArena基准(397个样本，覆盖40类44种语言)模拟真实编程任务，并开发了20B标记的SynCode-Instruct合成指令集。实验发现执行基准与人类偏好存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究强调了对齐人类偏好的重要性，为改进代码生成模型提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T15:06:05Z
- **目录日期**: 2025-03-25
