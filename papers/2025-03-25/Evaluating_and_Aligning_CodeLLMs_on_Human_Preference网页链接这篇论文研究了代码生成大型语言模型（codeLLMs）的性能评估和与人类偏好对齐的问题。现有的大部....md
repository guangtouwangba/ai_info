...
这篇论文探讨了代码生成大语言模型（CodeLLMs）如何更好地与人类偏好对齐。研究者发现现有基准测试过于关注代码正确性，忽略了人类偏好因素。为此，他们构建了CodeArena基准（含397个样本，覆盖40类44种语言）和SynCode-Instruct合成指令集（近200亿标记）。实验显示，传统执行基准与CodeArena存在性能差异，且开源模型（如Qwen2.5-Coder）与专有模型（如OpenAI o1）差距显著，突显了人类偏好对齐的重要性。研究验证了大规模合成指令微调的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T20:05:13Z
- **目录日期**: 2025-03-25
