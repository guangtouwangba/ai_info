...
GitHub上的legacy-cc项目公开了C语言之父Dennis Ritchie在70年代编写的早期C编译器源码，堪称编程语言"考古发现"。该代码展现了C语言原始形态（如无类型检查、默认int变量等），揭示了编译器底层逻辑（语法树处理、内存分配等）和优化雏形。项目包含prestruct和last1120c两个历史版本，2002年由Caldera公司以宽松开源协议授权。开发者认为这些代码不仅是技术遗产，更如同Ritchie留给后人的"手稿"，对理解现代编译器技术（如LLVM/GCC）的演进具有重要意义。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T05:02:49Z
- **目录日期**: 2025-03-25
