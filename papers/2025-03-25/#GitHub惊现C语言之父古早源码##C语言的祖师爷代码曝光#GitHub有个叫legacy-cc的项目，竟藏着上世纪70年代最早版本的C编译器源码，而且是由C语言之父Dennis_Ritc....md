...
GitHub上出现了一个名为legacy-cc的项目，公开了上世纪70年代由C语言之父Dennis Ritchie编写的早期C编译器源码。这段代码展现了C语言的原始形态，如缺乏类型检查、默认int变量等特性，并揭示了编译器基础逻辑（如语法树处理、内存分配等）的雏形。项目包含prestruct和last1120c两个目录，记录了不同阶段的代码演进。2002年Caldera公司以宽松的开源协议授权了这些代码，允许自由使用和修改。该源码被视为编程语言发展史上的重要文物，展示了C语言从零演化的关键历程。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T21:03:38Z
- **目录日期**: 2025-03-25
