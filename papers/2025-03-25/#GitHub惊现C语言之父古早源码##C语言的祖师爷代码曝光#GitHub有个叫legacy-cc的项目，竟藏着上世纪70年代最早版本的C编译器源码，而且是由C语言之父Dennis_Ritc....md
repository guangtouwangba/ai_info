...
GitHub上出现了一个名为legacy-cc的项目，其中包含了C语言之父Dennis Ritchie在20世纪70年代编写的最早版本的C编译器源码。该项目展示了C语言的原始形态，如缺乏类型检查、变量默认为int等早期特性，并揭示了编译器的基础逻辑（如语法树处理、内存分配等）。代码还包含了现代编译器优化技术的雏形，如表达式折叠。该项目由Caldera International于2002年开源，授权宽松，被视为编程语言发展史上的重要文物，吸引了许多开发者研究讨论。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T12:04:01Z
- **目录日期**: 2025-03-25
