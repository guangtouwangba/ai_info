...
本文提出利用约束动态势博弈（WCPDG）来解决多智能体交互决策中的计算挑战。该方法通过将现实交互场景转化为加权约束势动态博弈，将寻找广义纳什均衡（GNE）简化为求解单个约束最优控制问题。相比现有博弈求解器，该方法显著提高了求解效率。仿真实验验证了其有效性，并在四旋翼协同搬运避障任务中进行了实际验证。研究结果表明，约束动态势博弈能有效处理多智能体交互中的耦合目标问题，为解决复杂动态博弈提供了高效的计算框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T02:28:45Z
- **目录日期**: 2025-03-25
