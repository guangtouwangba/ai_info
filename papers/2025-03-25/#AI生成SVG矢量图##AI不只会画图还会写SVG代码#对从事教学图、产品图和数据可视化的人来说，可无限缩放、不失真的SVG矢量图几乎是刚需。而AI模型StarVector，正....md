...
StarVector是一款能直接生成高质量SVG矢量图代码的AI工具，支持通过图像或文字描述生成标准SVG代码（使用<circle>、<polygon>等原生元素）。其基于包含210万组数据的SVG-Stack数据集训练，独创DinoScore评估指标（基于语义相似度）。提供1B（轻量版）和8B（精准版）两个版本，生成速度仅74秒/图，远超传统方法。特点包括：代码结构简洁、支持文本到SVG转换（如描述"红色圆圈包矩形"可生成对应代码），适用于教学图、数据可视化等场景。论文及代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T02:30:21Z
- **目录日期**: 2025-03-25
