...
MIT数学家通过流体力学模型和真人实验，发现人群行走秩序的关键参数是"角度分布"（个体行走方向与正前方的偏离角）。当平均偏离角超过13度时，人群会陷入混乱；低于该临界值则能自然形成有序通道。研究采用二维码追踪技术验证了这一现象，发现"人道"形成后具有自维持特性。该成果可应用于机场、商场等场所的动线优化，提升人群流动效率与安全性。研究揭示了微小个体行为对集体秩序的显著影响，为人群管理提供了量化依据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T14:03:57Z
- **目录日期**: 2025-03-25
