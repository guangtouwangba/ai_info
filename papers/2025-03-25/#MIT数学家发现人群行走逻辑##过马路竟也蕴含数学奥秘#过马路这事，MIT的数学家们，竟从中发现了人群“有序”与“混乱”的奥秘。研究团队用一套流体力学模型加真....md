...
MIT数学家用流体力学模型和真人实验发现，人群行走秩序的关键在于"角度分布"（即个体行走方向与正前方的偏离角度）。当平均偏离角超过13度临界值时，人群会陷入混乱；低于该值则能自然形成有序通道。研究通过二维码追踪志愿者移动轨迹验证了这一发现。该成果可应用于机场、商场等人流密集场所的通道优化，提升安全性和效率。研究表明，微小的个体方向偏差会显著影响整体秩序。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T06:03:01Z
- **目录日期**: 2025-03-25
