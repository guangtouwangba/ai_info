# #MIT数学家发现人群行走逻辑##过马路竟也蕴含数学奥秘#过马路这事，MIT的数学家们，竟从中发现了人群“有序”与“混乱”的奥秘。研究团队用一套流体力学模型加真...
...
MIT数学家通过流体力学模型和真人实验，发现人群行走有序性的关键参数是"角度分布"（个体行走方向与正前方的偏离角）。研究发现：当平均偏离角超过13度临界值时，人群会出现躲闪交错等混乱行为；低于该值则能自然形成有序"人道"。实验通过二维码帽子追踪志愿者移动轨迹验证了这一理论。该成果可应用于机场、商场等场所的通道优化，提升人群流动效率与安全性。研究揭示了微小角度偏差对整体秩序的重大影响，为人群管理提供了量化依据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T17:03:50Z
- **目录日期**: 2025-03-25
