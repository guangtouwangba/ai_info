...
MIT数学家通过流体力学模型和真人实验，发现人群行走有序性的关键参数是"角度分布"（行走方向偏离正前方的平均角度）。研究表明，当平均偏离角超过13度临界值时，人群会陷入混乱；低于该值则能自然形成有序"人道"。团队采用二维码追踪技术验证了这一发现。该成果可应用于机场、商场等人流密集场所的通道设计优化，提高通行效率并降低踩踏风险。研究揭示了微小个体行为对群体秩序的显著影响。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T22:03:36Z
- **目录日期**: 2025-03-25
