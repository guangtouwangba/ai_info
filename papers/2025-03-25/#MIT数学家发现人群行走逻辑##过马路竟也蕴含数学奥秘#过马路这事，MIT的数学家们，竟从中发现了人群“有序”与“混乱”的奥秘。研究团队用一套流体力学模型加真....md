...
MIT数学家通过流体力学模型和真人实验发现，人群行走秩序的关键在于"角度分布"——即个体行走方向偏离正前方的平均角度。研究发现当平均偏离角超过13度临界值时，人群会陷入混乱；低于该值则能自然形成有序"人道"。研究采用二维码追踪技术验证了这一现象，该成果可应用于机场、商场等人流密集场所的通道优化，提高通行效率并降低安全风险。这项研究揭示了微观个体行为对宏观人群秩序的重要影响。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T21:03:28Z
- **目录日期**: 2025-03-25
