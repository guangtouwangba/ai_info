...
MIT数学家通过流体力学模型和真人实验发现，人群行走秩序的关键在于角度分布（angular spread）。当行人平均行走方向偏离正前方超过13度时，人群会陷入混乱；低于13度则能自然形成有序"人道"。研究通过二维码追踪志愿者移动轨迹验证了这一临界值。该成果可应用于机场、商场等场所的通道优化，提升人流效率与安全性。这项研究揭示了微小角度偏差对整体秩序的重大影响。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T20:03:29Z
- **目录日期**: 2025-03-25
