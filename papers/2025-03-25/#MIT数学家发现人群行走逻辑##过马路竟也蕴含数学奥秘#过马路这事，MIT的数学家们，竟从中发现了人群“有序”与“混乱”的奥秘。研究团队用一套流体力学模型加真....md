...
MIT数学家通过流体力学模型和真人实验发现，人群行走秩序的关键在于"角度分布"（即个体行走方向偏离正前方的角度）。研究表明：当平均偏离角超过13度临界值时，人群会陷入混乱；低于该值则能自然形成有序"人道"。团队通过二维码追踪实验验证了这一发现，该成果可应用于机场、商场等场所的通道优化，提升人流效率与安全性。研究揭示了微小角度偏差对整体秩序的显著影响，为人群动力学提供了量化依据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T05:02:40Z
- **目录日期**: 2025-03-25
