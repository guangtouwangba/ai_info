...
MIT数学家通过流体力学模型和真人实验发现，人群行走秩序的关键在于"角度分布"（偏离正前方角度）。研究表明：当平均偏离角超过13度临界值时，人群会陷入混乱；低于该值则能自发形成有序"人道"。团队用二维码追踪志愿者移动轨迹验证了这一发现。该成果可应用于优化机场、商场等场所的人流管理，预防踩踏风险。研究揭示了微小方向偏差对整体秩序的显著影响，13度成为秩序与混乱的分水岭。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T19:03:27Z
- **目录日期**: 2025-03-25
