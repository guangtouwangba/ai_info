...
MIT数学家通过流体力学模型和真人实验发现，人群行走有序与否的关键在于"角度分布"（偏离正前方的平均角度）。当平均偏离角小于13度时，人群能自然形成有序通道；超过13度则会出现混乱。研究采用二维码追踪技术验证了这一临界值，并观察到"人道"具有自组织特性。该成果可应用于机场、商场等场所的动线优化，提升人群流动效率与安全性。研究表明，个体微小的行走角度偏差可能对整个群体秩序产生重大影响。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T13:10:16Z
- **目录日期**: 2025-03-25
