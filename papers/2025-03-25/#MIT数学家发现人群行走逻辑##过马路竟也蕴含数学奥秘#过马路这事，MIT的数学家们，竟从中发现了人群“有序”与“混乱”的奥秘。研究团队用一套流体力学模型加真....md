...
MIT数学家通过流体力学模型和真人实验发现，人群行走秩序的关键在于"角度分布"（偏离正前方角度）。当平均偏离角≤13度时，会自然形成有序的"人道"；超过13度则引发混乱。研究采用二维码追踪技术验证了这一临界值，并观察到秩序具有自维持特性。该成果可应用于机场、商场等场所的通道优化，提升人流效率与安全性。研究揭示了微小个体行为对群体秩序的显著影响，相关论文发表于MIT官网。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T23:03:34Z
- **目录日期**: 2025-03-25
