...
本文提出LLM+MAP框架，用于解决双手机器人操作中的长期任务规划问题。现有方法多关注单手机器人技能，而双手机器人需要复杂的时空协调和任务分配。虽然大语言模型（LLMs）被用于机器人任务规划，但在长期推理中易出错且缺乏逻辑保证。LLM+MAP结合LLM推理与多智能体规划，通过GPT-4o实现，在模拟实验中优于直接使用LLMs（如GPT-4o、V3等）的方法，在规划时间、成功率等指标上表现更优。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-25T00:01:52Z
- **目录日期**: 2025-03-25
