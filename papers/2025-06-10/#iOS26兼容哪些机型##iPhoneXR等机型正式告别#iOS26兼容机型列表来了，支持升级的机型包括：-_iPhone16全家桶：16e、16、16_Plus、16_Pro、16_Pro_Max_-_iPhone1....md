...
iOS26系统兼容机型公布，支持iPhone16至11系列（含Pro/Max）、SE 2/3代，最低要求A13芯片。iPhone XR/XS/XS Max（A12芯片）被正式淘汰，无法获得新功能支持。这是苹果近年来最大幅度的一次机型淘汰，意味着A12设备将止步于iOS25系统。建议用户在升级前确认App适配情况，老机型用户仍可继续使用iOS25系统。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T03:25:21Z
- **目录日期**: 2025-06-10
