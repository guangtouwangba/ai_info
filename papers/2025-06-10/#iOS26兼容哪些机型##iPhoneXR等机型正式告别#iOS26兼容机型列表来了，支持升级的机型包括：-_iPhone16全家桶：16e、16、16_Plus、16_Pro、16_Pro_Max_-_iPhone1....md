...
iOS26系统兼容机型公布，支持iPhone16全系、15/14/13/12系列(含Pro/Max)、11系列(Pro/Max)及SE2/3代。A12芯片设备(XR/XS/XS Max)被淘汰，系统最低要求提升至A13芯片。这意味着XR等口碑良好的老机型将无法获得新功能支持，正式进入退役阶段。建议用户在升级前确认App适配情况，老机型用户可继续使用iOS25系统。此次系统门槛提升幅度较往年更大，直接影响仍在使用的XR/XS系列用户群体。(98字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T02:34:03Z
- **目录日期**: 2025-06-10
