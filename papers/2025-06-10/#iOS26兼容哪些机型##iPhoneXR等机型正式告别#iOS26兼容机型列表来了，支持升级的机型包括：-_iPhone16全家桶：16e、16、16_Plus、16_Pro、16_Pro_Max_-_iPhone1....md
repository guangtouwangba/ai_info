...
iOS26系统兼容机型公布，支持iPhone16/15/14/13/12全系及11 Pro系列，以及SE 2/3代，最低要求A13芯片。这意味着搭载A12芯片的iPhone XR/XS/XS Max将不再获得系统更新。此次淘汰力度较往年更大，这些曾广受欢迎的老机型将无法体验新功能。官方建议用户升级前确认App适配情况，同时表示iOS25仍可继续使用。系统门槛的提升反映了苹果对硬件性能要求的持续提高。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T00:02:29Z
- **目录日期**: 2025-06-10
