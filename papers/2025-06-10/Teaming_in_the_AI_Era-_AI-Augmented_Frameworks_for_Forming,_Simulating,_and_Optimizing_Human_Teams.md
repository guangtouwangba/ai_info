...
该研究旨在利用AI优化团队效能，提出三阶段解决方案：1）团队组建阶段采用多臂老虎机算法，动态平衡成员偏好与任务目标；2）执行阶段开发AI助手tAIfa，通过大语言模型提供实时个性化反馈以提升凝聚力；3）构建PuppeteerLLM模拟框架，用多智能体建模真实团队动态。研究突破传统静态优化局限，解决算法分配导致的成员满意度低、参与度不足等问题，通过动态适应个性特征、目标演变和偏好变化，全面提升团队满意度、参与度和整体绩效。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T01:29:26Z
- **目录日期**: 2025-06-10
