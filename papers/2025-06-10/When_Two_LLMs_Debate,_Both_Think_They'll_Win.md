...
研究发现，大型语言模型（LLMs）在动态对抗性辩论中存在严重的过度自信问题。研究组织60场三轮政策辩论，发现：1）初始平均自信度72.9%，远高于理性基准50%；2）辩论中自信度不降反升，最终达83%；3）61.7%的辩论中双方同时声称≥75%胜率；4）与自身副本辩论时，自信度仍从64.1%升至75.2%；5）模型内部推理与公开自信度不一致。结果表明，LLMs在多轮动态任务中缺乏准确自我评估和更新信念的能力，这对日益部署于助理和代理角色的LLMs构成重大隐患。实验代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T21:02:12Z
- **目录日期**: 2025-06-10
