...
该研究介绍了视觉图竞技场（VGA）数据集，包含6个基于图的任务，用于评估AI系统在视觉抽象概念化方面的能力。VGA通过不同图形布局测试模型对同一概念的识别与推理能力，独立于视觉形式。实验显示，人类在任务中表现近乎完美，而当前最先进的视觉模型和多模态大语言模型在图同构检测上完全失败，在路径/循环任务中表现有限，表明其仅依靠模式匹配而非真正理解。VGA为提升AI视觉模型的人类级概念化能力提供了评估框架。数据集地址：vga.csail.mit.edu。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T00:01:11Z
- **目录日期**: 2025-06-10
