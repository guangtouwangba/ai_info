...
斯坦福大学研究发现，AI与医生协作能显著提升临床诊断准确率。研究比较了两种协作模式（AI先诊断或医生先诊断）与传统资源组的表现，结果显示协作组准确率达82%-85%，明显优于传统组的75%。AI单独诊断准确率高达90%，与协作效果相当。研究表明AI作为协作伙伴能减少误诊，提升决策质量。该研究基于GPT-3.5/4测试，暗示更先进模型可能带来更大提升。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T15:03:09Z
- **目录日期**: 2025-06-10
