...
斯坦福大学研究表明，AI与医生协作能显著提升临床诊断准确率。实验招募70名医师，分为AI优先组（先看AI诊断）、AI后援组（医生先诊断）和传统工具对照组。结果显示，协作组准确率达82-85%，明显高于对照组的75%。AI单独诊断准确率更高达90%，证明其强大能力。两种协作模式效果相当，但AI优先组在临床决策上略优。研究证实人机协作可减少误诊、提高诊断质量，为医疗AI应用提供了重要依据。该结果基于GPT-3.5/4测试，暗示更先进模型可能带来更大提升。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T19:02:41Z
- **目录日期**: 2025-06-10
