# #人机协作让临床诊断更准确##AI与医生协作诊断准确率提高10%#让AI与医生协作起来，诊断会变得更准确！斯坦福大学的研究团队公布的最新研究成果，再次肯定了一个...
...
斯坦福大学最新研究表明，人机协作能显著提升临床诊断准确率。研究对比了AI协作组（AI-first和AI-second两种模式）与传统资源组的表现，发现协作组平均准确率达82%-85%，明显高于对照组的75%。AI单独诊断准确率高达90%，与协作模式相当。通过定制GPT系统整合医患双方意见并分析共识分歧，有效提升了诊断质量。该研究证实将AI作为协作伙伴（而非单纯工具）能减少误诊，且AI-first模式效果更优。这些成果基于GPT-3.5/4实现，暗示更强模型可能带来更大突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T10:02:56Z
- **目录日期**: 2025-06-10
