...
斯坦福大学最新研究表明，AI与医生协作能显著提升临床诊断准确率。实验招募70名医师分为两组：AI-first组（AI先诊断）准确率达85%，AI-second组（医生先诊断）达82%，均显著高于传统资源组的75%。AI单独诊断准确率高达90%。研究采用定制GPT系统，通过整合医患双方意见生成分析报告，突出共识与分歧点。结果显示人机协作模式能减少误诊，提升决策质量，且两种协作方式效果相当。该成果证实AI作为诊断协作者的价值，未来采用更先进模型可能带来更大突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T18:02:56Z
- **目录日期**: 2025-06-10
