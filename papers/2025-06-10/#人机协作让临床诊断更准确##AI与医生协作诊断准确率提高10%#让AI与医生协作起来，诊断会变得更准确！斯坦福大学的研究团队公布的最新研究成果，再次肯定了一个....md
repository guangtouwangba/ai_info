...
斯坦福大学研究发现，AI与医生协作能显著提升临床诊断准确率。研究将70名医生分为两组：AI-first组（先看AI诊断）准确率达85%，AI-second组（后看AI诊断）达82%，均显著高于传统资源组的75%。AI单独诊断准确率高达90%。定制GPT系统能整合医患双方意见，指出共识与分歧。研究表明人机协作模式优于传统方法，可减少误诊并提升决策质量。该成果基于GPT-3.5/4实现，暗示未来更强模型可能带来更大突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T12:03:08Z
- **目录日期**: 2025-06-10
