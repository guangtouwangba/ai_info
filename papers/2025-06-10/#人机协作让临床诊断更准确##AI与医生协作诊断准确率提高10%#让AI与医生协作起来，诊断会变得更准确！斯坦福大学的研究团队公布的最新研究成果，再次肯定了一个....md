...
斯坦福大学最新研究表明，人机协作可显著提升临床诊断准确率。研究团队开发了定制GPT系统，让AI与医生通过两种模式协作：AI先诊断或医生先诊断。实验显示，协作组诊断准确率达82%-85%，明显高于仅使用传统工具组的75%。AI单独诊断准确率高达90%，与协作效果相当。这表明AI已成为强有力的诊断辅助工具，能有效减少误诊并提升决策质量。该研究基于GPT-3.5/4实现，预示着更先进模型可能带来更大突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T17:02:58Z
- **目录日期**: 2025-06-10
