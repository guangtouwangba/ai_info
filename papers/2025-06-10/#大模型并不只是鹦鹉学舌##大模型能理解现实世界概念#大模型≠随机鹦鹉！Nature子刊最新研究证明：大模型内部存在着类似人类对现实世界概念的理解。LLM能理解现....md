...
中国科学院团队在《Nature Machine Intelligence》发表研究，通过分析470万次行为数据发现：多模态大语言模型(MLLMs)能自发形成与人类高度相似的物体概念表征系统。该研究首次构建AI的"概念地图"，证明大模型并非简单"鹦鹉学舌"，而是真正理解现实世界概念。这一发现反驳了"LLM仅依赖统计相关性生成文本"的观点，表明大模型内部存在类似人类的概念理解机制。研究结合行为实验与神经影像分析，为AI的语义理解能力提供了重要证据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T04:08:58Z
- **目录日期**: 2025-06-10
