...
苹果AI新功能Apple Intelligence全面升级：整合ChatGPT支持图像生成；Siri更智能，新增产品问答和视觉识别；快捷指令增强；支持自然语言图片搜索；通话/邮件自动摘要。通知智能化，可分类提醒和优先标记。新增创意工具如自定义emoji、个性化写作、图像处理及记忆视频生成。开发者可调用底层AI框架，Xcode支持AI代码预测，采用新设计语言Liquid Glass。此次更新深度融合AI至iOS系统，提升用户效率并开放开发者工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T01:30:26Z
- **目录日期**: 2025-06-10
