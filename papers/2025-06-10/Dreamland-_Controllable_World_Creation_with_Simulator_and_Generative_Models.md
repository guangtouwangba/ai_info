...
Dreamland是一个结合物理模拟器精细控制和大规模预训练生成模型逼真输出的混合世界生成框架。它通过分层世界抽象，编码像素级和物体级的语义与几何信息作为中间表示，从而增强可控性并降低适配成本。该方法支持现有及未来预训练生成模型的即插即用，并构建了D3Sim数据集用于训练和评估。实验表明，Dreamland在图像质量上提升50.8%，可控性提高17.9%，并能有效增强具身智能体训练。代码和数据将公开。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T17:01:10Z
- **目录日期**: 2025-06-10
