...
Dreamland是一个结合物理模拟器和生成模型的混合世界生成框架，通过分层抽象编码像素级和物体级的语义与几何信息，提升可控性并降低适配成本。相比现有方案，它在图像质量上提升50.8%，可控性增强17.9%，支持直接使用预训练生成模型，并构建了D3Sim数据集用于评估。该框架能增强具身智能体训练，代码和数据将开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T21:01:20Z
- **目录日期**: 2025-06-10
