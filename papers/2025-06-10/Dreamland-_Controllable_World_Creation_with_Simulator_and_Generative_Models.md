...
Dreamland是一个混合世界生成框架，结合了物理模拟器的精细控制和预训练生成模型的逼真内容输出。它通过分层世界抽象编码像素级和对象级的语义与几何信息，作为连接模拟器和生成模型的中间表示，从而提升可控性并降低适配成本。该框架支持直接使用现有及未来的预训练生成模型。实验表明，Dreamland在图像质量上提升50.8%，可控性增强17.9%，并能有效促进具身智能体训练。相关代码和数据将公开。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T14:01:12Z
- **目录日期**: 2025-06-10
