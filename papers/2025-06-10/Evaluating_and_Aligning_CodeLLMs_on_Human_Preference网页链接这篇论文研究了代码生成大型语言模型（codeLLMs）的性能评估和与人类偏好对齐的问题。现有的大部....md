...
该论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，通过397个涵盖40类编程任务和44种语言的样本，评估模型与人类偏好的对齐程度。研究同时构建20B标记的SynCode-Instruct合成指令数据集验证微调效果。实验发现：1)传统执行测试与人类偏好存在差异；2)开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究强调代码生成模型除正确性外，还需重视人类偏好对齐。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T23:05:29Z
- **目录日期**: 2025-06-10
