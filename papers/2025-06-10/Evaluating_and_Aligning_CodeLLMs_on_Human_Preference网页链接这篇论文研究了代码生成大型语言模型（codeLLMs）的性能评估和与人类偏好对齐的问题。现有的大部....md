...
这篇论文针对代码生成大型语言模型(codeLLMs)提出新评估方法，指出当前基准测试过于关注代码正确性而忽视人类偏好。研究者开发了CodeArena基准(包含397个高质量样本，覆盖40类编程任务和44种语言)和SynCode-Instruct合成指令库(20B标记)，用于评估模型与人类偏好的对齐程度。实验发现执行基准与人类偏好存在差异，并显示开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)存在显著性能差距，强调了人类偏好对齐在代码生成中的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T11:06:26Z
- **目录日期**: 2025-06-10
