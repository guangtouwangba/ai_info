...
这篇论文针对代码生成大模型(codeLLMs)评估中忽视人类偏好的问题，提出了CodeArena基准测试(包含397个高质量样本，覆盖40类44种语言)和SynCode-Instruct合成指令集(近200亿标记)。研究发现：1)传统执行基准与人类偏好存在差异；2)开源顶级模型(Qwen2.5-Coder)与商业模型(OpenAI o1)性能差距显著。研究强调了代码生成模型与人类偏好对齐的重要性，并通过大规模实验验证了合成指令微调的有效性，为提升代码LLMs的实际应用价值提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T09:06:54Z
- **目录日期**: 2025-06-10
