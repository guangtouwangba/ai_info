...
本文提出了GUI-Reflection框架，通过三个阶段（预训练、监督微调、在线反思调优）增强多模态大语言模型在GUI自动化中的自我反思与纠错能力。该框架完全自动化生成反思数据，无需人工标注，包含：1）从成功轨迹自动构建反思数据的新方法；2）移动设备上的多样化在线训练环境；3）迭代式在线反思调优算法。实验表明，该方法显著提升了GUI代理的稳健性和适应性，为智能GUI自动化开辟了新途径。所有数据、模型和环境工具将开源发布。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T07:01:00Z
- **目录日期**: 2025-06-10
