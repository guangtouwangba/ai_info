...
该研究提出GUI-Reflection框架，通过多阶段训练（预训练、监督微调、在线反思调优）为多模态GUI模型赋予自我反思和纠错能力。其创新点包括：1) 自动化构建反思/纠错数据管道，提出专门评估反思能力的任务集；2) 搭建移动端多样化训练环境；3) 开发迭代式在线调优算法。该框架无需人工标注即可实现自主错误恢复，显著提升了GUI自动化的鲁棒性和适应性。所有数据、模型及工具将开源发布。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T08:01:07Z
- **目录日期**: 2025-06-10
