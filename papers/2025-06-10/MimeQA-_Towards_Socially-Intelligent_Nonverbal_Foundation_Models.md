...
当前AI社交推理主要依赖语言处理，导致非语言社交理解能力不足。为突破这一局限，研究者开发了"MimeQA"数据集，包含8小时哑剧视频和806个问答对，专门测试非语言社交推理能力。评估发现，现有视频大语言模型(vLLM)准确率仅20-30%，远低于人类的86%。分析表明，vLLM常无法理解虚拟物体，过度依赖文本提示而忽略细微的非语言互动。该研究旨在推动AI发展真正的社交智能，使其能准确解读人类的非语言互动。数据集来自YouTube哑剧视频，强调通过手势和动作表达的艺术形式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T00:02:05Z
- **目录日期**: 2025-06-10
