...
西湖大学AGILab团队提出创新视频编辑方法FlowDirector，解决了传统AI视频编辑中运动不连贯和意外变化的问题。该方法无需反演过程和额外训练，单卡4090即可实现高质量编辑，具有三大优势：1) 低开销，不存储额外控制信息；2) 支持对象增删改和纹理替换等多种编辑；3) 通过"动力冻结"技术保持非编辑区域100%不变。这项SOTA级技术突破了传统反演-编辑范式的限制，仅需一句话指令就能完成复杂视频编辑任务。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T21:03:07Z
- **目录日期**: 2025-06-10
