# #无需训练一句话编辑视频##西湖大学SOTA级视频编辑新方法#传统的视频编辑工作流，正在被AI彻底重塑。AI的视频编辑方法总是存在一些问题：例如视频运动不连贯、编...
...
西湖大学AGILab提出新型视频编辑方法FlowDirector，突破传统反演-编辑范式的局限。该方法无需训练和反演过程，单卡4090即可实现高效编辑，支持对象增删改、纹理替换等操作，并能100%保持背景不变。其核心优势在于通过"动力冻结"技术确保非编辑区域完全一致，解决了现有AI视频编辑常见的运动不连贯和意外变化问题。相比传统方法，FlowDirector具有更低开销、更广编辑范围和更好的背景保持能力，代表了当前SOTA级的视频编辑技术突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T13:13:51Z
- **目录日期**: 2025-06-10
