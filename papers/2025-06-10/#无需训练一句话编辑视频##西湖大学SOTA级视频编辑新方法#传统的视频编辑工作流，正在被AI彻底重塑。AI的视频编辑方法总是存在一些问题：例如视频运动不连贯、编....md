...
西湖大学AGILab团队开发了名为FlowDirector的新型AI视频编辑方法，解决了传统反演-编辑范式导致的运动不连贯和意外变化问题。该方法无需训练或反演过程，单张4090显卡即可实现高质量编辑，显著降低计算开销。其核心优势包括：支持对象增删/纹理替换等多样化编辑；通过"动力冻结"技术确保非编辑区域100%保持原状。该系统突破了现有视频编辑技术的限制，实现了仅需文字指令即可完成复杂编辑的SOTA级表现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T19:03:00Z
- **目录日期**: 2025-06-10
