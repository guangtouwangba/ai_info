...
西湖大学AGILab团队提出新型视频编辑方法FlowDirector，突破传统反演-编辑范式的局限。该方法无需训练和反演过程，单卡4090即可实现高质量编辑，具有三大优势：1)低开销，不存储额外控制信息；2)支持对象增删改及纹理替换等广泛操作；3)通过"动力冻结"技术保持非编辑区域100%不变。该技术解决了现有AI视频编辑中常见的运动不连贯和意外变化问题，代表当前SOTA水平的重大突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T20:02:49Z
- **目录日期**: 2025-06-10
