...
西湖大学AGILab团队提出了一种名为FlowDirector的新型AI视频编辑方法，突破了传统反演-编辑范式的限制。该方法无需训练和反演过程，仅需单张4090显卡即可实现高质量编辑，显著降低了计算开销。FlowDirector支持对象替换、内容增减和纹理修改等多种编辑操作，并能通过"动力冻结"技术100%保持非编辑区域的原始画面。相比现有方法，该技术解决了视频运动不连贯和意外修改等问题，为视频编辑提供了更高效精准的解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T11:03:19Z
- **目录日期**: 2025-06-10
