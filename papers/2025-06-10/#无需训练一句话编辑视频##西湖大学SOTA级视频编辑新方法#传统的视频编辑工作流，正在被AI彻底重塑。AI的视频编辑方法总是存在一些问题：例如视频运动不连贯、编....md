...
西湖大学AGILab提出新型视频编辑方法FlowDirector，突破传统反演-编辑范式的限制。该方法无需训练和反演过程，单卡4090即可实现高质量编辑，支持对象增删改和纹理替换，同时通过"动力冻结"技术保持背景100%不变。相比现有方法，FlowDirector具有更低开销、更广编辑范围和更好的背景保持能力，代表了SOTA级视频编辑技术的进步。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T15:03:28Z
- **目录日期**: 2025-06-10
