...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理的社会互动（500万次交互）。研究者用它研究四个社会问题：群体极化、信息传播、基本收入政策效果和自然灾害影响。模拟结果与现实数据高度吻合，验证了该系统捕捉人类行为机制的能力。该系统可作为计算社会科学研究平台，为学者和政策制定者提供新工具，补充传统研究方法（如调查和实验）。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T13:16:10Z
- **目录日期**: 2025-06-10
