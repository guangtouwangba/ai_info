...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理的社会互动（500万次）。研究者用它研究社会极化、信息传播、基本收入政策及自然灾害影响等社会问题，结果与现实数据吻合。该系统为社会科学研究提供了新工具，能辅助传统方法（如调查）探索社会现象的内在机制，对政策制定具有潜在价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T09:06:10Z
- **目录日期**: 2025-06-10
