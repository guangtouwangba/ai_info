...
本文介绍了一种名为AgentSociety的大规模社会模拟器，它结合了LLM驱动的代理、真实社会环境和强大的模拟引擎，模拟了超过1万个代理及其500万次互动。研究者利用该平台研究了极化现象、信息传播、基本收入政策和自然灾害影响等社会问题。模拟结果与现实世界实验数据高度吻合，证明了该系统在理解人类行为机制方面的有效性，并展示了其作为社会科学研究和政策制定工具的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T22:05:07Z
- **目录日期**: 2025-06-10
