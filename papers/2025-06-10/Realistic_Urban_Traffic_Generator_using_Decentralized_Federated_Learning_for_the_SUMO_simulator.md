...
本文提出了一种名为DesRUTGe的去中心化城市交通生成框架，通过结合深度强化学习(DRL)与SUMO仿真器，生成24小时高保真交通模式。其创新点在于采用去中心化联邦学习(DFL)，每个交通检测器作为独立节点，仅需少量历史数据进行本地DRL模型训练，并通过与相邻区域交换模型参数实现协同优化，无需中央协调。基于巴塞罗那真实数据的测试表明，DesRUTGe在准确性和隐私保护方面优于传统SUMO工具和集中式学习方法，为大规模城市交通仿真提供了更优解决方案。(99字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T10:01:47Z
- **目录日期**: 2025-06-10
