...
DesRUTGe是一种创新的去中心化城市交通生成框架，结合深度强化学习(DRL)和SUMO模拟器，可生成高保真的24小时交通模式。其核心创新是采用去中心化联邦学习(DFL)，每个交通检测器作为独立节点，仅需少量历史数据训练本地DRL模型，并通过与相邻区域交换模型参数(而非原始数据)进行协作优化，既保护隐私又提高准确性。基于巴塞罗那真实数据的测试表明，DesRUTGe在生成精度上优于传统SUMO工具和集中式学习方法，同时解决了扩展性和隐私问题，为智慧交通系统提供了更优解决方案。(99字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T11:01:45Z
- **目录日期**: 2025-06-10
