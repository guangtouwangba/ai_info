...
上海交大与上海AI Lab联合提出IDEAL方法，通过科学调整SFT训练集的数据配比而非单纯增加数据量，有效提升模型能力。研究发现，数据量过多或配比不当会损害模型性能，甚至导致某些能力退化。IDEAL利用理论建模评估各领域数据对验证集性能的影响，结合K-FAC技术高效计算Hessian逆矩阵，并通过超参数m优化数据配比。实验显示，该方法使原本不擅长代码的Llama 3.1-8B模型代码能力显著提升，实现了更均衡的模型表现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T09:03:39Z
- **目录日期**: 2025-06-10
