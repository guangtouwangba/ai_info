...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和科研订阅等一站式服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持中英文文献搜索，并能通过AI生成摘要和问答互动帮助用户快速理解内容。平台还提供文献翻译、文档解析及个性化科研动态推送功能，用户可订阅关注领域的学术资讯。此外，AMiner包含学者画像、学术会议等特色功能，基础服务免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T14:06:11Z
- **目录日期**: 2025-06-10
