...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译及科研订阅等一站式服务。它覆盖42个学科，包含3.5亿论文、0.6亿学者等海量数据，支持中英文文献搜索、AI摘要生成和互动问答。用户可上传PDF或从平台获取论文，快速生成摘要和章节概要。此外，AMiner提供个性化科研动态订阅，通过微信或邮件推送最新学术资讯。平台还包含学者画像、学术会议等功能，基础检索服务免费开放。网址：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T15:06:17Z
- **目录日期**: 2025-06-10
