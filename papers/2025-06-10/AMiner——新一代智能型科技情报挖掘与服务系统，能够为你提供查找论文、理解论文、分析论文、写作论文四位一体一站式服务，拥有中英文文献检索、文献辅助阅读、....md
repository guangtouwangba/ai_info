...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析及写作一站式服务。它涵盖42个学科的3.5亿论文、0.6亿学者等资源，支持中英文文献检索、AI辅助阅读、自动摘要生成及互动问答。用户可上传PDF或从平台获取论文，并通过订阅功能接收定制化科研动态。此外，AMiner还提供学者画像、学术会议追踪等功能，基础服务免费开放。平台网址：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T01:33:11Z
- **目录日期**: 2025-06-10
