...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析和写作一站式服务。它支持中英文文献搜索，能生成摘要、辅助阅读和问答互动，帮助用户快速理解文献内容。平台还提供科研动态订阅服务，根据用户偏好推送最新学术资讯。此外，AMiner包含学者画像、学术会议和论文排行榜等功能，收录了3.5亿论文、0.6亿学者和1.5亿专利等海量数据。用户可通过浏览器免费使用其核心功能，提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T12:06:12Z
- **目录日期**: 2025-06-10
