...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和科研订阅等一站式服务。它收录了3.5亿论文、0.6亿学者和1.5亿专利，支持中英文文献搜索和AI生成摘要。用户可通过互动问答快速理解文献内容，并上传PDF进行智能分析。平台还提供个性化科研动态推送，跟踪学者、机构和关键词。AMiner免费开放使用，具有学者画像、学术会议和论文排行榜等功能，帮助用户高效获取学术信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T19:05:15Z
- **目录日期**: 2025-06-10
