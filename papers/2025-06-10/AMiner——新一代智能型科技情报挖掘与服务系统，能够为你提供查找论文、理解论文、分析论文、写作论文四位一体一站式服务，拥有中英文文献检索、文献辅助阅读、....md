...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索（覆盖3.5亿论文）、AI辅助阅读（自动生成摘要/问答）、文档翻译及科研订阅（定制化推送最新成果）。支持学者画像、会议追踪等功能，用户可通过网页或微信免费使用其核心功能，显著提升文献调研与论文写作效率。平台整合检索、分析、写作全流程，适用于42个学科领域。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T20:05:02Z
- **目录日期**: 2025-06-10
