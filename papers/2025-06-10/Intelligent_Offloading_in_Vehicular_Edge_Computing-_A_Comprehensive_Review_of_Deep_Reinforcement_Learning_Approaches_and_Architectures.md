...
本文综述了智能交通系统(ITS)中基于深度强化学习(DRL)的计算卸载研究进展。随着ITS复杂度增加，传统卸载策略难以应对动态异构环境，DRL因其自适应决策能力受到关注。文章系统梳理了现有工作，从学习范式(单/多智能体)、系统架构(集中/分布式/分层)和优化目标(延迟/能耗/公平性)等维度进行分类比较，分析了马尔可夫决策过程(MDP)的应用方式，并总结了奖励设计、协调机制和可扩展性等新兴趋势。最后指出了开放挑战和未来研究方向，为下一代ITS智能卸载策略开发提供指导。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T11:02:44Z
- **目录日期**: 2025-06-10
