...
香港大学与英伟达合作提出广义空间传播网络（GSPN），革新视觉注意力机制。传统Transformer处理高分辨率图像时存在O(N²)计算复杂度和空间结构破坏问题。GSPN通过二维线性传播和稳定性-上下文条件，将复杂度降至√N级别，保留空间连贯性，生成速度提升超84倍。该方法在多个视觉任务中实现性能突破，显著提升效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T23:02:46Z
- **目录日期**: 2025-06-10
