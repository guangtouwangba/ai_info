...
香港大学与英伟达合作提出广义空间传播网络（GSPN），革新视觉注意力机制。传统Transformer的自注意力处理高分辨率图像时面临计算复杂度高（O(N²)）和空间结构破坏的问题。GSPN通过二维线性传播和稳定性-上下文条件机制，将计算复杂度降至√N级别，同时保留图像空间连贯性。该方法显著提升效率，在高分辨率生成任务中加速超84倍，并在多个视觉任务中刷新性能纪录。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T15:03:19Z
- **目录日期**: 2025-06-10
