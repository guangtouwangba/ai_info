...
香港大学与英伟达合作提出广义空间传播网络(GSPN)，革新视觉注意力机制。传统Transformer处理高分辨率图像时存在O(N²)计算复杂度和破坏空间结构的问题。GSPN通过二维线性传播和稳定性-上下文条件机制，将复杂度降至√N级别，完整保留图像空间连贯性。该方法在保持性能的同时显著提升效率，高分辨率生成任务加速超84倍，并在多项视觉任务中创下新纪录。这一突破为处理高分辨率图像提供了更高效的解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T14:03:15Z
- **目录日期**: 2025-06-10
