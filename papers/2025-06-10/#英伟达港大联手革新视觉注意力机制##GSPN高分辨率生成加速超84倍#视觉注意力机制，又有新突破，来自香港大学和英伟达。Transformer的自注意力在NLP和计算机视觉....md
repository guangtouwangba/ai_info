...
香港大学与英伟达合作提出广义空间传播网络（GSPN），革新视觉注意力机制。传统Transformer处理高分辨率图像时存在计算复杂度高（O(N²)）和空间结构破坏问题。GSPN通过二维线性传播和稳定性-上下文条件设计，将复杂度降至√N级别，同时保留图像空间连贯性。相比线性注意力等方法，GSPN在效率上实现显著提升（加速超84倍），并在多个视觉任务中刷新性能。该技术解决了高分辨率图像处理的关键瓶颈，为计算机视觉领域带来重要突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T11:03:09Z
- **目录日期**: 2025-06-10
