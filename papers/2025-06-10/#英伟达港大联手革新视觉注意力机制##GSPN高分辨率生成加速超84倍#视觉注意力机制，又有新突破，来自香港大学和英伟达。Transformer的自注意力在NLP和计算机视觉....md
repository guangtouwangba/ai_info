...
香港大学与英伟达合作提出广义空间传播网络(GSPN)，革新视觉注意力机制。传统Transformer处理高分辨率图像时存在O(N²)计算复杂度和空间结构破坏问题。GSPN通过二维线性传播和"稳定性-上下文条件"设计，将复杂度降至√N级别，完整保留图像空间连贯性。该方法在保持精度的同时显著提升效率，高分辨率生成任务加速超84倍，并在多个视觉任务中刷新性能纪录。这一突破为处理大尺度图像提供了更高效的解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T17:03:08Z
- **目录日期**: 2025-06-10
