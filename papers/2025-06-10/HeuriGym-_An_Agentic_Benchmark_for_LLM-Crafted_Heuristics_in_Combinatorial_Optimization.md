...
该研究提出了HeuriGym框架，用于评估大语言模型（LLMs）在组合优化问题中生成启发式算法的能力。通过代码执行反馈和迭代优化，HeuriGym测试了9个前沿模型在计算机、物流和生物等领域的9个问题上的表现，揭示了LLMs在工具使用、规划和自适应推理方面的局限。研究引入了质量-产出指数（QYI）来衡量解决方案的通过率和质量，发现即使顶级模型（如GPT-4-mini-high和Gemini-2.5-Pro）的QYI得分也仅为0.6，远低于专家基线1.0。该开源基准旨在推动LLMs在科学和工程领域的实际应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T12:02:10Z
- **目录日期**: 2025-06-10
