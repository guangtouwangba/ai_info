...
该研究提出了HeuriGym框架，用于评估大语言模型（LLMs）在组合优化问题中的启发式算法生成能力。该框架通过代码执行反馈和迭代优化，测试LLMs在工具使用、规划和自适应推理方面的表现。研究评估了9个前沿模型在计算机系统、物流和生物学等领域的9个问题上的表现，发现即使顶级模型如GPT-4-mini-high和Gemini-2.5-Pro的QYI（质量-产量指数）得分仅为0.6，远低于专家基线1.0。开源基准旨在推动LLMs在科学和工程领域的实际应用能力发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T19:01:49Z
- **目录日期**: 2025-06-10
