...
该研究提出了HeuriGym框架，用于评估大语言模型（LLMs）在组合优化问题中生成启发式算法的能力。该框架通过代码执行提供反馈，支持LLMs迭代改进方案。研究测试了9个前沿模型在多个领域的表现，揭示了它们在工具使用、规划和自适应推理方面的局限。研究提出了质量-产出指数（QYI）作为量化指标，发现顶级模型（如GPT-4和Gemini）的QYI仅为0.6，远低于专家基准1.0。这一开源基准旨在推动LLMs在科学和工程领域更有效的实际应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T05:01:49Z
- **目录日期**: 2025-06-10
