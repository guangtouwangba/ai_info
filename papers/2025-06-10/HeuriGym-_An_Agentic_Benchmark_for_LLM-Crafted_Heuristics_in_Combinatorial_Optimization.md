...
该论文提出了HeuriGym框架，用于评估大语言模型（LLMs）在组合优化问题中生成启发式算法的能力。现有评估方法存在封闭式问题易饱和或主观评价不一致的问题。HeuriGym通过代码执行反馈和迭代优化来测试LLMs的启发式算法性能，覆盖计算机系统、物流和生物学等领域的9个问题。研究发现，即使是GPT-4和Gemini等顶尖模型，在工具使用、规划和自适应推理方面仍有局限，其质量-收益指数（QYI）仅为0.6，远低于专家基准1。该开源基准旨在推动LLMs在科学和工程领域的实际应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-10T04:07:07Z
- **目录日期**: 2025-06-10
