...
现有AR叙事系统常通过简单物体标签和空间坐标定义环境语义，导致叙事僵化且忽略物体间的情境关联（如床头婚戒可能暗示婚姻矛盾）。研究提出融合视觉语言模型(VLM)的解决方案，包含三大创新：1) 物理/功能/隐喻三层物体语义解析；2) 双向JSON接口连接VLM生成内容与AR锚点；3) STAM评估框架。实验显示70%用户反馈该系统能基于环境符号生成故事（而非简单叠加），使日常物品获得叙事意义。该框架通过结合VLM的创造性与AR空间精度，实现了从被动场景到主动叙事空间的转化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T16:01:36Z
- **目录日期**: 2025-04-20
