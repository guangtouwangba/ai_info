...
现有AR叙事系统常通过简单物体标签和空间坐标定义环境语义，导致叙事僵化且忽略物体间深层关联（如床头婚戒可能暗示婚姻危机）。研究提出基于视觉语言模型(VLM)的AR叙事框架，通过三大创新：1) 将物体语义分解为物理/功能/隐喻三层；2) 用双向JSON层连接VLM隐喻与AR锚点；3) 建立STAM评估体系。实验显示70%用户因环境象征性叙事改变了对实景的认知。该框架融合VLM的创造性与AR的空间精确性，将被动空间转化为主动叙事场域，开创了物体驱动的叙事新范式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T11:01:22Z
- **目录日期**: 2025-04-20
