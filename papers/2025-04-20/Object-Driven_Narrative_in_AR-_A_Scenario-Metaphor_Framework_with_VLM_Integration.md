...
当前AR叙事系统通常仅用简单物体标签和空间坐标定义环境语义，导致叙事僵化且缺乏上下文关联。研究者提出整合视觉语言模型(VLM)的创新框架，通过三层革新：1)将物体语义分解为物理、功能和隐喻层面；2)用双向JSON层连接VLM隐喻与AR锚点；3)建立STAM评估体系。实验显示，70%用户反馈该系统能基于环境符号生成故事，改变他们对实景物体的感知。该框架融合VLM的创造性与AR的空间精确性，将被动空间转化为主动叙事场域，开创了物体驱动的叙事新范式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T20:01:26Z
- **目录日期**: 2025-04-20
