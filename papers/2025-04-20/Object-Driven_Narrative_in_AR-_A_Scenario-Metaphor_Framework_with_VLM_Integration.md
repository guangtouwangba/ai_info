...
现有AR叙事系统多基于简单物体标签和空间坐标定义环境语义，导致叙事逻辑僵化。为突破这一局限，研究者提出融合视觉语言模型(VLM)的AR叙事框架，通过三个创新点：1) 将物体语义分解为物理、功能和隐喻三层；2) 用双向JSON层连接VLM隐喻与AR锚点；3) 建立STAM评估体系。实验表明，该系统能从环境中生成故事而非简单叠加，70%用户反馈环境物体因隐喻叙事获得新意义。该框架结合VLM的创造性与AR的空间精确性，开创了"物体驱动叙事"新范式，使被动空间转化为主动叙事场域。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T19:01:25Z
- **目录日期**: 2025-04-20
