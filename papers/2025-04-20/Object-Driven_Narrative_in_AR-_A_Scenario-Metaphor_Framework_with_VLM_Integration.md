...
当前自适应AR叙事系统多基于简单物体标签和空间坐标定义环境语义，导致叙事逻辑僵化。本文提出融合视觉语言模型(VLM)的AR叙事框架，通过三项创新解决关键问题：1) 将物体语义分解为物理、功能和隐喻三层；2) 设计双向JSON接口桥接VLM输出与AR锚点；3) 建立STAM评估体系。实验表明，70%用户反馈该系统能基于环境符号生成故事（而非简单叠加），使日常物品获得叙事意义。该框架开创了"物体驱动叙事"新范式，将被动空间转化为主动叙事场域，实现了生成创意与空间精度的有机结合。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T17:01:38Z
- **目录日期**: 2025-04-20
