...
现有AR叙事系统多依赖简单物体标签和空间坐标，导致叙事逻辑僵化且忽视物体间深层关联。研究提出基于视觉语言模型(VLM)的AR叙事框架，通过三重创新：1) 将物体语义分解为物理/功能/隐喻三层；2) 设计双向JSON接口连接VLM隐喻与AR锚点；3) 建立STAM评估体系。实验表明，70%用户反馈该系统能基于环境符号生成故事（而非简单叠加），使日常物品获得叙事意义。该框架融合VLM的创造性与AR的空间精确性，实现了从"空间被动承载"到"环境主动叙事"的范式转换。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T21:01:28Z
- **目录日期**: 2025-04-20
