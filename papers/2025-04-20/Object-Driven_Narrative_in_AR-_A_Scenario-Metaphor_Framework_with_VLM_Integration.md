...
当前自适应AR叙事系统多基于简单物体标签和空间坐标定义环境语义，导致叙事逻辑僵化。针对此问题，研究提出融合视觉语言模型(VLM)的AR叙事框架，通过三项创新：1) 将物体语义分解为物理、功能和隐喻三层；2) 设计双向JSON接口桥接VLM输出与AR锚点；3) 建立STAM评估体系。实验表明，该系统能基于环境本身生成故事（而非简单叠加），70%用户反馈叙事改变了其对现实物体的认知。该框架通过结合VLM的生成能力与AR空间精度，实现了从被动空间到主动叙事场景的范式转换。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T22:01:22Z
- **目录日期**: 2025-04-20
