...
当前自适应AR叙事系统常将环境语义简化为物体标签和空间坐标，导致叙事逻辑僵化。为解决这一问题，研究探索了视觉语言模型(VLM)与AR的融合，发现三大挑战：简单提示生成的叙事缺乏深度；空间语义利用不足；预生成脚本与AR系统不兼容。为此，研究提出场景驱动的AR叙事框架，通过三层创新：1) 物理/功能/隐喻三层物体语义解析；2) 双向JSON接口关联VLM隐喻与AR锚点；3) STAM评估体系。用户研究显示70%参与者因环境符号化叙事而改变对实物的认知，实现了从"空间置入"到"环境自生"的叙事范式转变。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T03:16:52Z
- **目录日期**: 2025-04-20
