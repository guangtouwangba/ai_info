...
当前AR叙事系统通常仅用简单物体标签和空间坐标定义环境语义，导致叙事僵化且缺乏情境深度。本研究提出基于视觉语言模型(VLM)的场景驱动AR叙事框架，通过三大创新解决关键问题：(1) 将物体语义分解为物理、功能和隐喻三层，增强叙事线索识别；(2) 设计双向JSON接口桥接VLM隐喻与AR锚点；(3) 建立STAM评估体系。实验显示，70%用户反馈该系统能基于环境符号生成故事（而非简单叠加），改变其对现实物体的认知。该框架融合VLM的创造性与AR空间精度，实现了从被动空间到主动叙事景观的范式转换。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T04:01:28Z
- **目录日期**: 2025-04-20
