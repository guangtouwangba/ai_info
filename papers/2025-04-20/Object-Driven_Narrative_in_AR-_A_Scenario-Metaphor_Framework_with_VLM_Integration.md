...
现有AR叙事系统常将环境语义简化为物体标签和空间坐标，导致叙事僵化且缺乏情境关联。本研究提出基于视觉语言模型(VLM)的AR叙事框架，通过三层创新：1) 将物体语义分解为物理/功能/隐喻三层；2) 用双向JSON接口连接VLM隐喻与AR锚点；3) 建立STAM评估体系。实验表明，该系统能基于环境本身生成故事（而非简单叠加），70%用户反馈环境物体因叙事获得新意义。该框架融合VLM的创造性与AR的空间精确性，将被动空间转化为主动叙事场景，开创了物体驱动的叙事新范式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T00:01:34Z
- **目录日期**: 2025-04-20
