...
现有AR叙事系统多依赖简单物体标签和空间坐标，导致叙事逻辑僵化，忽视物体关系的语境意义（如床头婚戒暗示婚姻冲突）。研究提出融合视觉语言模型(VLM)的解决方案，通过三大创新：1) 将物体语义分解为物理/功能/隐喻三层；2) 用双向JSON接口连接VLM隐喻与AR锚点；3) 建立STAM评估框架。实验显示70%用户因环境象征性叙事改变对实景的认知。该框架突破"物体即标签"的局限，使环境成为主动叙事媒介，实现空间精度与生成创造力的结合，开创物体驱动的新型叙事范式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T10:01:40Z
- **目录日期**: 2025-04-20
