...
现有AR叙事系统通常仅用简单物体标签和空间坐标定义环境语义，导致叙事僵化。针对此问题，本研究提出融合视觉语言模型(VLM)的AR叙事框架，通过三重创新：1)将物体语义分解为物理、功能和隐喻三层；2)用双向JSON层桥接VLM隐喻与AR锚点；3)建立STAM评估体系。实验表明，该系统能基于环境本身生成故事（而非简单叠加），70%用户反馈叙事改变了其对现实物体的认知。该框架结合VLM的创造性与AR的空间精度，开创了"物体驱动"的叙事范式，使被动空间转化为主动叙事场域。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T13:06:49Z
- **目录日期**: 2025-04-20
