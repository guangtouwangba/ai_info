...
当前AR叙事系统常将环境语义简化为物体标签和空间坐标，导致叙事逻辑僵化。为突破这一局限，研究者提出融合视觉语言模型(VLM)的AR叙事框架，通过三层创新：1) 将物体语义分解为物理、功能和隐喻层面；2) 用双向JSON层连接VLM隐喻与AR锚点；3) 建立STAM评估体系。实验表明，70%用户反馈该系统能基于环境符号学重构叙事认知，使普通物品承载隐喻意义。该框架突破"环境即容器"的传统范式，通过VLM的生成能力与AR空间精度结合，实现了从"在环境中放置故事"到"从环境生成故事"的范式转变。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T07:01:46Z
- **目录日期**: 2025-04-20
