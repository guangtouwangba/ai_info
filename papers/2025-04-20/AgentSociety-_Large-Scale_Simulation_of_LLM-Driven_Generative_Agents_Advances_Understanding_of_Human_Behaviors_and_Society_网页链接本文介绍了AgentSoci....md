...
这篇论文介绍了一个名为AgentSociety的大规模社会模拟器，它利用大型语言模型驱动的代理、真实社会环境和强大模拟引擎，模拟了1万多个代理的社会生活及500万次互动。研究者将其作为计算社会科学实验平台，研究了社会极化、信息传播、基本收入政策和外部冲击（如飓风）等四个关键社会问题。模拟结果与现实世界实验数据吻合，证明了该工具在捕捉人类行为机制方面的有效性，展示了其作为社会科学研究和政策制定辅助工具的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T17:05:33Z
- **目录日期**: 2025-04-20
