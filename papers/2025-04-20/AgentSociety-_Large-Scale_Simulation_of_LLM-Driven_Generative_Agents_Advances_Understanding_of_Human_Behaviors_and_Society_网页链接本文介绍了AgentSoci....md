...
该研究提出AgentSociety——一个整合LLM驱动智能体、真实社会环境和强大模拟引擎的大规模社会模拟平台。通过模拟10,000+智能体间的500万次互动，研究者针对社会极化、信息传播、基本收入政策、自然灾害影响四个关键问题开展实验。结果显示模拟结果与现实数据高度吻合，验证了平台在捕捉人类行为机制方面的有效性。该平台可作为传统社会科学研究方法的补充工具，帮助研究者分析社会问题的成因和模式，为政策制定提供新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T22:04:55Z
- **目录日期**: 2025-04-20
