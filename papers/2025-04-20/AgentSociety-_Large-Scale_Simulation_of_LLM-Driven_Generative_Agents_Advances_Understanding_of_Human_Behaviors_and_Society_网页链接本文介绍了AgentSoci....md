...
这篇论文介绍了AgentSociety，这是一个基于大语言模型(LLM)驱动的大规模社会模拟系统。该系统模拟了超过1万个代理的社会生活，产生了500万次互动。研究者用它研究了四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据吻合，验证了该系统捕捉人类行为和社会机制的能力。AgentSociety展示了作为社会科学研究工具和决策支持系统的潜力，能够补充传统研究方法如调查和访谈。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T01:34:36Z
- **目录日期**: 2025-04-20
