...
这篇论文介绍了AgentSociety，一个基于大语言模型驱动的大规模社会模拟系统。该系统模拟了1万多个智能代理的社会生活，产生了500万次互动。研究者用它研究了四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害冲击。模拟结果与现实世界数据吻合，验证了该系统捕捉人类行为机制的能力。研究表明AgentSociety可作为计算社会科学的有力工具，为研究者和政策制定者提供新的研究手段，补充传统调查和实验方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T02:36:01Z
- **目录日期**: 2025-04-20
