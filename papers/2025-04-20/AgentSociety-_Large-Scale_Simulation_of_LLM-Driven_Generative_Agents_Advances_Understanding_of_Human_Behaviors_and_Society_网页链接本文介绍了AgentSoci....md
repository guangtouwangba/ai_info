...
AgentSociety是一个基于大型语言模型的大规模社会模拟器，可模拟1万多个代理及其500万次互动。该平台用于研究极化现象、信息传播、基本收入政策及外部冲击等社会问题，结果与现实世界实验一致，验证了其有效性。AgentSociety能辅助传统研究方法，帮助理解社会问题的模式和机制，为社会科学研究者和政策制定者提供有力工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T04:05:20Z
- **目录日期**: 2025-04-20
