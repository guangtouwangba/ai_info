...
评估一个行为的安全性需要结合具体情境。对人类来说，这显而易见（如删除邮件是否恰当取决于邮件内容、目的和邮箱类型），但计算系统通常只能在有限情境中运作，依赖手动设置策略和用户确认。然而，随着多功能智能代理（如自动化个人助手）的兴起，现有安全设计难以应对其多样化的情境和能力。为此，本文提出"情境化代理安全框架"（Conseca），旨在生成即时、情境化且可人工验证的安全策略，以适应通用智能代理的复杂需求。该研究为智能代理领域的情境安全提供了初步解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T06:02:27Z
- **目录日期**: 2025-04-20
