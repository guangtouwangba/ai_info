...
本文探讨了在通用智能代理（如自动化个人助手）时代重新思考安全设计的必要性。传统基于手动策略和用户确认的安全机制（如应用权限控制）在有限场景中尚可运作，但随着代理在多任务环境中的广泛部署，其行动安全性需结合具体情境判断（如邮件删除是否合理取决于内容、目的和邮箱类型）。为此，作者提出Conseca框架，旨在生成即时、情境化且可人工验证的安全策略，以应对智能代理在多场景中的复杂安全需求。该研究为适应新一代系统的多维度能力与场景规模提供了初步解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T09:02:27Z
- **目录日期**: 2025-04-20
