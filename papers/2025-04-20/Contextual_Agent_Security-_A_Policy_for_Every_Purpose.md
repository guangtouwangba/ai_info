...
本文探讨了在通用智能代理(如自动化个人助手)时代重新思考安全设计的必要性。传统基于手动策略和用户确认的安全机制(如手机应用权限)已无法适应多任务代理的复杂情境。作者提出"情境代理安全"(Conseca)框架，能够根据具体情境生成即时、可验证的安全策略。该研究强调，判断行为安全性需考虑具体情境(如删除工作邮件与个人邮件的不同)，而未来通用代理将面临更广泛的情境和功能规模，需要新的安全范式来应对这一挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T00:02:24Z
- **目录日期**: 2025-04-20
