...
本文探讨了在通用智能代理（如自动化个人助手）时代重新思考安全设计的必要性。传统基于手动策略和用户确认的安全机制（如应用权限控制）已无法适应多任务代理的复杂情境需求。作者提出"情境代理安全"（Conseca）框架，能够根据具体情境生成即时、可验证的安全策略。该研究强调，行动安全性评估必须考虑上下文因素（如操作内容、目标和环境类型），这与人类基于情境判断行为安全性的能力形成对比，为未来智能代理的安全设计提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T10:02:35Z
- **目录日期**: 2025-04-20
