...
本文探讨了在通用智能代理（如自动化个人助手）日益普及的背景下，如何重新设计安全机制以适应其多任务场景。传统基于手动策略和用户确认的安全方法（如应用权限控制）已无法满足需求，因为动作安全性高度依赖上下文（如邮件删除是否合理取决于内容、目的和账户类型）。为此，作者提出Conseca框架，能动态生成即时、可验证的上下文相关安全策略。该研究标志着向适应智能代理多场景能力的安全设计迈出了重要一步，强调安全机制需随系统应用场景的扩展而进化。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T22:02:10Z
- **目录日期**: 2025-04-20
