...
这篇论文探讨了在通用智能代理(如自动化个人助手)时代重新思考安全设计的必要性。传统基于手动策略和用户确认的安全机制(如应用权限)已无法适应多任务代理的复杂情境。作者提出"情境代理安全"(Conseca)框架，能够根据具体情境(如邮件内容、操作目的、账户类型等)动态生成即时、可验证的安全策略。与人类能自然理解情境不同，计算系统需要新的安全范式来应对多样化场景。该研究是探索情境化安全的第一步，旨在为通用代理设计更灵活、可扩展的安全解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T03:18:02Z
- **目录日期**: 2025-04-20
