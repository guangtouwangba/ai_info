...
蚂蚁推出"百宝箱"智能体开发平台，支持3分钟快速搭建可调用支付宝、高德地图等30余款MCP服务的AI智能体。该平台整合了DeepSeek、通义千问等主流大模型及50多款插件工具，开发者可发布智能体至支付宝小程序。AI智能体凭借自主性、强执行力和生态连接能力成为行业热点，MCP协议的开放推动了大厂生态融合。蚂蚁的入局降低了开发门槛，为开发者提供从技术接入到商业变现的全链路支持，预示着AI智能体可能成为下一代杀手级应用的重要方向。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T10:04:11Z
- **目录日期**: 2025-04-20
