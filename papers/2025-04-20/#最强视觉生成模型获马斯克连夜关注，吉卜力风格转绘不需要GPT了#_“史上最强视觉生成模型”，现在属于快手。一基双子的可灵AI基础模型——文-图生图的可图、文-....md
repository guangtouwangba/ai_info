...
快手发布最新视觉生成模型可灵AI 2.0系列，包含文/图生图的可图2.0和文/图生视频的可灵2.0。据称，可图2.0性能超越MidJourney 7.0和FLUX，可灵2.0在文生视频方面优于Sora，图生视频胜过谷歌Veo2。新版本提升了语义理解和美学表现，新增图像编辑和风格转绘功能（如吉卜力风格转换），引发马斯克关注。该模型号称"史上最强视觉生成模型"，无需依赖GPT即可实现高质量内容创作。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T21:02:42Z
- **目录日期**: 2025-04-20
