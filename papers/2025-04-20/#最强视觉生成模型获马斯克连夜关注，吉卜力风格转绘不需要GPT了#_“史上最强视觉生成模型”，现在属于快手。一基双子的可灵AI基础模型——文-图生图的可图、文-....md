...
快手推出"可灵AI"2.0版本视觉生成模型，包含文/图生图的"可图2.0"和文/图生视频的"可灵2.0"。据称，可图2.0在图像生成上超越MidJourney 7.0和FLUX，可灵2.0在视频生成上优于Sora和谷歌Veo2。新版本提升了语义理解和美学表现，新增图像编辑和风格转绘（如吉卜力风格）功能，引发马斯克关注。该模型被宣传为"史上最强视觉生成模型"，无需依赖GPT即可实现高质量视觉内容创作。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T17:02:56Z
- **目录日期**: 2025-04-20
