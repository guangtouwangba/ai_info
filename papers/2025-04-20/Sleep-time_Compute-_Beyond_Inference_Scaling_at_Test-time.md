...
本文提出"睡眠时间计算"方法，通过让大语言模型在查询前预先处理上下文并预测可能的用户问题，显著降低实时计算需求。实验表明，该方法在Stateful GSM-Symbolic和Stateful AIME任务中能减少5倍实时计算量，同时提升准确率13%-18%。通过Multi-Query GSM-Symbolic任务验证，相关查询可分摊预计算成本，使单查询成本降低2.5倍。研究发现查询可预测性与方法效果正相关，并在软件工程代理任务中验证了实用性。该方法有效平衡了计算延迟、成本与模型性能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T08:01:04Z
- **目录日期**: 2025-04-20
