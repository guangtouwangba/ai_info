...
当前生成艺术快速发展，但真正具有艺术感染力的作品需要超越视觉吸引力的多维度审美推理能力。研究发现，多模态大语言模型（MLLMs）在进行审美判断时容易产生主观臆断和缺乏依据的艺术解读。通过引入基于证据的客观推理框架ArtCoT，可显著改善这一问题，使MLLMs产生更符合人类审美标准的深度分析。该成果可应用于AI艺术教学和生成艺术奖励模型，推动AI系统真正理解、欣赏并创作符合人类审美标准的艺术作品。研究为提升AI审美能力提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T10:02:45Z
- **目录日期**: 2025-04-20
