...
这篇论文探讨了如何利用多模态大语言模型（MLLMs）进行更深入的美学判断。研究发现，当前MLLMs在美学推理时容易产生主观臆断和缺乏依据的艺术解读。通过采用基于证据的客观推理方法（如提出的ArtCoT基线），MLLMs能生成更全面、深入且符合人类审美标准的美学分析。这一突破可应用于AI艺术辅导和生成艺术的奖励模型，推动AI系统真正理解、欣赏并创作出符合人类审美标准的艺术作品。研究为提升AI的美学感知能力提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T23:02:21Z
- **目录日期**: 2025-04-20
