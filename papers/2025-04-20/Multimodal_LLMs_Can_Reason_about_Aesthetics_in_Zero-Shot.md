...
当前生成艺术快速发展，但AI模型常忽视深层次艺术感染力所需的多维审美推理。研究发现，多模态大语言模型（MLLMs）在审美判断时易产生主观臆断和缺乏依据的艺术解读。通过引入基于证据的客观推理框架ArtCoT，可显著改善这一问题，使MLLMs产生更全面、深入的审美分析，更贴近人类判断标准。该成果可应用于AI艺术教学和生成艺术奖励模型，为开发真正理解人类审美、创作有深度艺术作品的AI系统奠定基础。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T15:02:46Z
- **目录日期**: 2025-04-20
