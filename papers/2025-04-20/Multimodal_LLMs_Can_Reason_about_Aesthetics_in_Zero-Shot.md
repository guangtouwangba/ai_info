...
当前生成艺术快速发展，但真正具有艺术感染力的作品需要超越视觉吸引力的多维度美学判断。研究发现，多模态大语言模型（MLLMs）在进行美学推理时容易产生主观臆断和缺乏依据的艺术解读。通过引入基于证据的客观推理框架ArtCoT，可显著改善这一问题，使MLLMs产生更全面深入、更符合人类判断的美学分析。这一突破为AI艺术教学和生成艺术的奖励模型提供了直接应用价值，推动AI系统向真正理解、欣赏并生成符合人类审美标准的艺术作品迈进。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T03:18:16Z
- **目录日期**: 2025-04-20
