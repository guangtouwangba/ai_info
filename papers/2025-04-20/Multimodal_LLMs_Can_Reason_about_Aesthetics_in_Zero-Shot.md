...
当前生成艺术快速发展，但AI模型常忽视艺术深层共鸣所需的美学判断力。研究发现，多模态大语言模型（MLLMs）在美学推理中易产生主观臆断和缺乏依据的艺术解读。通过提出基于证据的客观推理框架ArtCoT，成功克服了这一局限，使MLLMs能生成更全面、深入且符合人类审美标准的美学分析。该成果可应用于AI艺术教学和生成艺术奖励模型，为开发真正理解、欣赏并创作符合人类审美标准的AI系统奠定了基础。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T06:02:41Z
- **目录日期**: 2025-04-20
