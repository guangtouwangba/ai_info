...
当前生成艺术快速发展，但AI模型常忽视艺术深层审美所需的复杂推理过程。研究发现，多模态大语言模型（MLLMs）在进行美学判断时易产生主观臆断和缺乏依据的"幻觉"。通过引入基于证据的客观推理框架ArtCoT，可显著提升MLLMs的审美分析能力，使其产出更符合人类评判标准的多维度深度美学解读。该成果可应用于AI艺术教学和生成艺术奖励模型，为开发真正理解人类审美、创作高质量艺术作品的AI系统奠定基础。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T01:30:51Z
- **目录日期**: 2025-04-20
