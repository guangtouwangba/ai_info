...
当前生成艺术快速发展，但真正具有艺术感染力的作品需要超越视觉吸引力的多维度审美推理。研究发现，多模态大语言模型（MLLMs）在进行美学判断时容易产生主观臆断和缺乏依据的艺术解读。通过采用基于证据的客观推理方法（如提出的ArtCoT基线），可显著提升MLLMs的审美推理能力，使其产出更符合人类评判标准的深度分析。该成果可应用于AI艺术教学和生成艺术奖励模型，为开发能真正理解、欣赏并创作符合人类审美标准的AI系统奠定基础。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T02:32:08Z
- **目录日期**: 2025-04-20
