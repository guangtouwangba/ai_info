...
当前生成艺术快速发展，但真正具有艺术感染力的作品需要超越视觉吸引力的多维度审美推理，而现有计算模型常忽视这一点。本文探索如何利用多模态大语言模型（MLLMs）进行审美判断，发现其存在主观臆断和缺乏依据的"幻觉"问题。研究提出基于证据的客观推理方法ArtCoT，能显著提升模型审美推理的深度和多样性，使其更符合人类判断标准。该成果可应用于AI艺术教学和生成艺术奖励模型，为开发能真正理解、欣赏并创作符合人类审美标准的AI系统奠定了基础。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T07:02:53Z
- **目录日期**: 2025-04-20
