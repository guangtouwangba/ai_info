...
这篇论文探讨了如何利用多模态大语言模型(MLLMs)进行更深入的美学判断。研究发现当前MLLMs在美学推理时容易产生主观臆断和缺乏依据的艺术解读等"幻觉"问题。作者提出了一种基于证据的客观推理方法ArtCoT，能显著改善MLLMs的美学推理能力，使其产出更全面深入且符合人类审美标准的分析。这项研究在AI艺术教学和生成艺术奖励模型等领域具有直接应用价值，为开发真正理解、欣赏和创作符合人类审美标准的AI系统奠定了基础。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T00:02:33Z
- **目录日期**: 2025-04-20
