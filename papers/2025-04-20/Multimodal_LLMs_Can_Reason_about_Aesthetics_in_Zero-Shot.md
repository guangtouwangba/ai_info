...
该研究探讨了如何利用多模态大语言模型(MLLMs)进行美学判断，发现当前模型在审美推理时容易出现主观臆断和缺乏依据的艺术解读等幻觉问题。研究者提出基于证据的客观推理方法ArtCoT，能显著提升模型的多维度深度审美推理能力，使其更符合人类审美标准。这一突破可应用于AI艺术辅导和生成艺术的奖励模型，为开发真正理解、欣赏并生成符合人类审美标准的AI系统奠定了基础。研究揭示了超越单纯视觉吸引力的复杂审美推理过程，填补了当前计算模型的不足。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T20:02:25Z
- **目录日期**: 2025-04-20
