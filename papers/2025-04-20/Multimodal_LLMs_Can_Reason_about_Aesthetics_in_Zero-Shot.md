...
当前生成艺术快速发展，但AI模型常忽视深层审美所需的复杂推理能力。研究发现，多模态大语言模型(MLLMs)在审美判断时易产生主观臆断和缺乏依据的艺术解读。通过引入基于证据的客观推理框架ArtCoT，可显著改善这一问题，使AI的审美分析更贴近人类标准。该成果可应用于AI艺术教学和生成艺术奖励模型，为开发真正理解人类审美、能创作具有深层艺术价值作品的AI系统奠定基础。研究揭示了克服AI审美幻觉的关键路径，推动艺术生成技术向更高层次发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T11:02:30Z
- **目录日期**: 2025-04-20
