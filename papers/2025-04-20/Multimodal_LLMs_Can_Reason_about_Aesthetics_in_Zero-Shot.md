...
当前生成艺术快速发展，但AI模型常忽视深层艺术审美所需的复杂推理能力。研究发现，多模态大语言模型（MLLMs）在美学判断时易产生主观臆断和缺乏依据的艺术解读。通过引入基于证据的客观推理框架ArtCoT，可显著提升模型的美学分析能力，使其产出更符合人类审美的多维度深度评价。该突破在AI艺术教学和生成艺术奖励模型等领域具有应用价值，为开发真正理解、欣赏并创作符合人类审美标准的AI系统奠定了基础。研究揭示了克服AI艺术评价幻觉的关键路径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T05:02:41Z
- **目录日期**: 2025-04-20
