...
自监督学习（SSL）是当前AI系统的核心技术，其设计空间正快速扩展。根据柏拉图表示假说（PRH），不同SSL方法最终会收敛到相同的理想表示。本文结合可辨识性理论（IT）证明PRH可能在SSL中出现，但现有理论无法完全解释SSL的实际成功。为此，作者提出"奇异可辨识性理论"（SITh）作为更全面的理论框架，涵盖整个SSL流程。SITh有助于理解SSL中的隐含数据假设，推动学习更具可解释性和泛化能力的表示。未来研究应关注：1）SSL训练动态与收敛性；2）有限样本、批量和数据多样性的影响；3）架构、数据增强和优化器中的归纳偏置作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T12:01:48Z
- **目录日期**: 2025-04-20
