...
当前自监督学习（SSL）研究快速发展，但缺乏理论解释。基于可辨识性理论（IT）分析表明，柏拉图表征假说（PRH）可能在SSL中成立，但现有理论无法解释其实际效果。为此，研究者提出"奇异可辨识性理论"（SITh）作为更全面的理论框架，涵盖整个SSL流程，以深入理解数据假设并推动学习更具解释性和泛化性的表征。未来研究应聚焦三个方向：1）SSL训练动态与收敛特性；2）有限样本、批量大小和数据多样性的影响；3）架构、数据增强、初始化方案和优化器中的归纳偏置作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T23:01:33Z
- **目录日期**: 2025-04-20
