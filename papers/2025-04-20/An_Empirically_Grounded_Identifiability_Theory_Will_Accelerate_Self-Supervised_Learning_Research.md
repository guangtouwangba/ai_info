...
当前自监督学习(SSL)研究快速发展，但缺乏理论解释。研究表明，根据可识别性理论(IT)，柏拉图表示假说(PRH)可能在SSL中出现，但现有理论无法解释其实际成功。为此，作者提出扩展IT为"奇异可识别性理论"(SITh)，以全面理解SSL流程。SITh有助于揭示SSL中的隐含数据假设，推动学习更具解释性和泛化性的表示。未来研究应关注三个方向：1)SSL的训练动态和收敛特性；2)有限样本、批次大小和数据多样性的影响；3)架构、增强、初始化和优化器中归纳偏置的作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T00:01:44Z
- **目录日期**: 2025-04-20
