...
当前自监督学习（SSL）研究快速发展，但缺乏理论解释。研究表明，根据可识别性理论（IT），柏拉图表示假说（PRH）可能在SSL中成立，即不同方法最终会收敛到相同的理想表示。然而，现有IT无法完全解释SSL的实际成功。为此，研究者提出扩展IT为"奇异可识别性理论"（SITh），以涵盖整个SSL流程，帮助理解其隐含的数据假设，推动学习更具解释性和泛化性的表示。未来研究应关注：1）SSL训练动态与收敛性；2）有限样本、批次大小和数据多样性的影响；3）架构、增强等归纳偏置的作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T22:01:31Z
- **目录日期**: 2025-04-20
