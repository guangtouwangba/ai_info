...
本文探讨了自监督学习（SSL）中柏拉图表征假说（PRH）的理论基础，指出尽管现有可辨识性理论（IT）能解释PRH现象，但无法完全说明SSL的实际成功。为此，作者提出扩展为"奇异可辨识性理论"（SITh），以更全面涵盖SSL流程，帮助理解其隐含数据假设，推动学习更具可解释性和泛化性的表征。研究强调未来三个关键方向：1）SSL的训练动态与收敛特性；2）有限样本、批量和数据多样性的影响；3）架构、数据增强、初始化和优化器中归纳偏置的作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T11:01:34Z
- **目录日期**: 2025-04-20
