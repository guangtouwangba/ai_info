...
当前自监督学习(SSL)研究快速发展，但缺乏理论解释。研究表明，基于可识别性理论(IT)，SSL可能符合柏拉图表示假说(PRH)，即不同方法最终会收敛到相同理想表示。然而现有IT无法完全解释SSL的成功实践。为此，作者提出扩展IT为"奇异可识别性理论"(SITh)，建立更全面的理论框架。未来研究应关注三个方向：1)SSL训练动态与收敛特性；2)有限样本、批次大小和数据多样性的影响；3)架构、数据增强、初始化和优化器中归纳偏置的作用，以推动学习更具解释性和泛化能力的表示。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T08:01:47Z
- **目录日期**: 2025-04-20
