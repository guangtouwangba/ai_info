...
当前自监督学习（SSL）研究快速发展，但缺乏理论解释。研究表明，基于可识别性理论（IT），柏拉图表示假说（PRH）可能在SSL中成立，即不同方法最终收敛到相同的理想表示。然而，现有IT无法完全解释SSL的实际成功。为此，作者提出扩展的"奇异可识别性理论"（SITh），以更全面分析SSL流程，揭示其隐含的数据假设，推动学习更具可解释性和泛化性的表示。未来研究应关注三个方向：SSL训练动态与收敛性、有限样本与数据多样性的影响，以及架构和优化器中的归纳偏置作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T10:01:52Z
- **目录日期**: 2025-04-20
