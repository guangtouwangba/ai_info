...
自监督学习(SSL)已成为当前AI系统的核心技术。研究基于柏拉图表示假说(PRH)，认为不同方法最终会收敛到相同的理想表示，但缺乏理论解释。通过可识别性理论(IT)分析发现PRH可能在SSL中出现，但现有理论无法完全解释其实际效果。为此，作者提出扩展的奇异可识别性理论(SITh)，旨在建立涵盖整个SSL流程的理论框架，以深入理解数据假设并推动学习更具解释性和泛化性的表示。未来研究应关注：1)SSL训练动态与收敛性；2)有限样本、批次大小和数据多样性的影响；3)架构、增强等归纳偏置的作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T07:01:58Z
- **目录日期**: 2025-04-20
