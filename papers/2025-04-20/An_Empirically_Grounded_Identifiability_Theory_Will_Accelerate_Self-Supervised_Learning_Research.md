...
自监督学习（SSL）是当前AI系统的核心技术。尽管不同方法和工程实现各异，但根据柏拉图表示假说（PRH），所有表示最终会收敛到同一理想形式。现有可辨识性理论（IT）可解释PRH现象，但无法完全说明SSL的实际成功。为此，作者提出扩展为"奇异可辨识性理论"（SITh），以更全面涵盖SSL流程，帮助理解其隐含数据假设，推动学习更具可解释性和泛化能力的表示。未来研究应关注：1）SSL训练动态与收敛性；2）有限样本、批量大小和数据多样性的影响；3）架构、增强、初始化和优化器的归纳偏置作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T01:29:44Z
- **目录日期**: 2025-04-20
