...
自监督学习(SSL)是当前AI系统的核心技术。研究基于柏拉图表示假说(PRH)，认为不同SSL方法最终会收敛到相同的理想表示，但缺乏理论解释。通过可辨识性理论(IT)分析，PRH可能在SSL中出现，但现有IT无法完全解释SSL的成功实践。为此，作者提出"奇异可辨识性理论"(SITh)新框架，旨在统一解释整个SSL流程，帮助理解数据假设，推动学习更具解释性和泛化性的表示。未来研究应关注：1)SSL训练动态与收敛性；2)有限样本、批大小和数据多样性的影响；3)架构、数据增强等归纳偏置的作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T20:01:36Z
- **目录日期**: 2025-04-20
