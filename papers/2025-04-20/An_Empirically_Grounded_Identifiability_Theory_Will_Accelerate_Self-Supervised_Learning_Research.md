...
当前自监督学习（SSL）研究快速发展，但缺乏理论解释。本文结合可识别性理论（IT）证明，SSL可能符合柏拉图表征假说（PRH），即不同方法最终收敛到同一理想表征。然而现有IT无法解释SSL的实际成功。为此，作者提出扩展的"奇异可识别性理论"（SITh），构建覆盖整个SSL流程的理论框架，以更好理解数据假设，推动学习更具解释性和泛化性的表征。未来研究应关注：1）SSL训练动态与收敛性；2）有限样本、批量和数据多样性的影响；3）架构、增强、初始化和优化器的归纳偏置作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T03:17:04Z
- **目录日期**: 2025-04-20
