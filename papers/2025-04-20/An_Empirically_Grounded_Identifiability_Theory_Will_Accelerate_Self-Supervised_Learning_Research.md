...
当前自监督学习(SSL)研究快速发展，但缺乏统一理论解释。研究结合可识别性理论(IT)发现，虽然柏拉图表示假说(PRH)认为不同SSL方法会收敛到相同理想表示，但现有理论无法完全解释SSL的成功实践。为此，作者提出"奇异可识别性理论"(SITh)新框架，旨在系统解释整个SSL流程。未来研究应关注三个方向：1)SSL训练动态与收敛特性；2)有限样本、批次大小和数据多样性的影响；3)架构、数据增强、初始化及优化器中归纳偏置的作用，以推动学习更具解释性和泛化能力的表示。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T19:01:35Z
- **目录日期**: 2025-04-20
