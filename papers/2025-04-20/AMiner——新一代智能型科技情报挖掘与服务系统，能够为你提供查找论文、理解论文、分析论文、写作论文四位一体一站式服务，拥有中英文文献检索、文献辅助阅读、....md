...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索（覆盖42个学科3.5亿论文）、AI辅助阅读（自动生成摘要/章节概要）、文献翻译及互动问答功能。支持用户上传PDF或从数据库筛选论文，通过AI快速解析内容。其特色服务包含个性化科研情报订阅（按学者/关键词推送最新成果至微信/邮箱），以及学者画像、学术会议追踪等工具。平台免费开放基础功能，旨在提升文献查阅、论文写作及学术追踪效率。访问入口：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T01:35:19Z
- **目录日期**: 2025-04-20
