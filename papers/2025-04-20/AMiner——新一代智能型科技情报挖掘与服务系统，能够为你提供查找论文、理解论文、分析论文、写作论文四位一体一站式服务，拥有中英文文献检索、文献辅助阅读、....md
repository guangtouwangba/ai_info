...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索（覆盖3.5亿论文）、AI辅助阅读（自动生成摘要和问答）、文档翻译及科研情报订阅（支持微信/邮件推送）。其特色功能包含学者画像、学术会议追踪和论文排行榜，用户可通过浏览器免费使用。平台整合了42个学科资源，支持PDF上传和交互式提问，显著提升文献查阅与论文写作效率。访问入口：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T08:06:11Z
- **目录日期**: 2025-04-20
