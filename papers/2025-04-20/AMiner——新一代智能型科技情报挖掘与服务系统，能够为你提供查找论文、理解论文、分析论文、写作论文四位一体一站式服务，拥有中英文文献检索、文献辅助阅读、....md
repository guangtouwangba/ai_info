...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和科研订阅等一站式服务。它收录了3.5亿篇论文、0.6亿学者和1.5亿专利，支持中英文文献检索，并能通过AI生成摘要和回答文献相关问题。用户可订阅个性化科研动态，通过微信或邮件获取最新资讯。平台还提供学者画像、学术会议和必读论文专题等功能，基础服务免费使用。网址：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T10:06:10Z
- **目录日期**: 2025-04-20
