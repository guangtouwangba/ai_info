...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献检索、AI辅助阅读、自动摘要生成、文档翻译及智能问答，涵盖42个学科3.5亿论文数据。用户可通过订阅功能获取定制化科研动态推送，并利用学者画像、会议追踪等工具。平台支持PDF上传解析，提供章节概要和问题建议，帮助高效理解文献。免费基础功能可通过浏览器访问，适合科研人员快速获取学术资源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T16:06:03Z
- **目录日期**: 2025-04-20
