...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、科研情报订阅等一站式服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持文献辅助阅读、AI摘要生成和互动问答，帮助用户快速理解论文内容。平台还提供个性化科研动态推送，用户可订阅关注的学者或关键词获取最新资讯。AMiner免费开放使用，具备学者画像、学术会议推荐等功能，显著提升科研效率。访问地址：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T22:05:23Z
- **目录日期**: 2025-04-20
