...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译、科研订阅等一站式服务。它拥有3.5亿篇论文、0.6亿学者等海量数据，支持中英文文献检索、AI生成摘要、互动问答等功能。用户可订阅个性化科研动态，追踪学者及机构最新成果。平台还提供文献翻译、文档解析、学术会议信息等工具，帮助研究者高效获取和分析学术信息。通过网页或微信小程序即可免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T21:05:30Z
- **目录日期**: 2025-04-20
