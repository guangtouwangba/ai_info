...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译及科研订阅等一站式服务。它收录了3.5亿论文、0.6亿学者等海量学术资源，支持中英文文献检索、AI生成摘要、互动问答等功能，帮助用户高效获取和理解文献内容。此外，AMiner还提供个性化科研动态订阅、学者画像等特色功能，可通过网页或微信小程序免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T13:11:22Z
- **目录日期**: 2025-04-20
