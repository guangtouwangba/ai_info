...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译及科研订阅等一站式服务。平台收录3.5亿论文、0.6亿学者等海量学术资源，支持中英文文献检索、AI生成摘要、互动问答和文档翻译功能。用户可定制科研动态推送，跟踪机构/学者/关键词的最新成果。特色功能包括学者画像、学术会议推荐及论文排行榜。基础服务免费，适用于高效文献调研与论文写作。访问入口：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T23:05:21Z
- **目录日期**: 2025-04-20
