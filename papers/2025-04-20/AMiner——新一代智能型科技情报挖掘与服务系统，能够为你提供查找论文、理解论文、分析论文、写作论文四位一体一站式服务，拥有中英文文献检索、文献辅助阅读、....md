...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译、科研情报订阅等一站式服务。它收录了3.5亿论文、0.6亿学者、1.5亿专利和2600万科研项目，覆盖42个学科。主要功能包括：1）中英文文献检索与智能问答；2）英文文献翻译、摘要生成和内容解析；3）个性化科研动态订阅推送。平台还提供学者画像、学术会议等特色功能，支持免费使用，帮助用户高效获取和管理学术信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T12:06:11Z
- **目录日期**: 2025-04-20
