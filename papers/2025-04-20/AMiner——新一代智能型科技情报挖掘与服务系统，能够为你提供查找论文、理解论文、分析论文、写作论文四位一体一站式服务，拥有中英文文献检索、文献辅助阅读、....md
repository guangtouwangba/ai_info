...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译及科研分析等一站式服务。其核心功能包括：1）中英文文献检索，支持互动问答和自动摘要生成；2）英文文献翻译与AI辅助阅读，可上传PDF并获取章节概要和内容解析；3）个性化科研订阅，按用户偏好推送最新论文动态。平台覆盖42个学科，包含3.5亿论文、0.6亿学者等海量数据，并免费开放基础功能。网址：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T02:36:46Z
- **目录日期**: 2025-04-20
