...
该论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，关注模型输出与人类偏好的对齐问题。通过397个高质量样本覆盖40类任务和44种编程语言，并构建20B标记的SynCode-Instruct合成指令集。研究发现现有基于执行的评测与人类偏好存在差距，开源模型(如Qwen2.5-Coder)与商用模型(如OpenAI o1)性能差异显著，凸显对齐人类偏好的重要性。研究为代码生成模型的评估提供了更贴近实际需求的新标准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T01:35:32Z
- **目录日期**: 2025-04-20
