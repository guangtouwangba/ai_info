...
这篇论文探讨了代码生成大型语言模型(codeLLMs)如何与人类偏好对齐的问题。研究指出当前基准测试过于关注代码正确性而忽视人类偏好，为此提出了CodeArena基准(包含397个高质量样本，覆盖40类任务和44种语言)和SynCode-Instruct合成指令数据集(近200亿标记)。实验发现执行基准与CodeArena存在性能差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)差距显著，凸显了人类偏好对齐的重要性。研究为评估和改进代码LLMs提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T12:06:21Z
- **目录日期**: 2025-04-20
