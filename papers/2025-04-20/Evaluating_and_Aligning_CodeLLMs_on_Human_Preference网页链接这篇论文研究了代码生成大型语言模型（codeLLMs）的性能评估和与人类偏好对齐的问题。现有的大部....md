...
这篇论文针对代码生成大模型（codeLLMs）提出新评估方法，关注与人类偏好的对齐问题。研究者创建了CodeArena基准测试（含397个样本，覆盖40类44种语言）和SynCode-Instruct合成指令集（20B标记），发现传统执行基准与人类偏好存在差异。实验比较40多个模型显示，开源顶级模型（如Qwen2.5-Coder）与专有模型（如OpenAI o1）性能差距显著，突显对齐人类偏好的重要性。研究强调需超越代码正确性，关注实际编程场景的复杂需求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T16:06:14Z
- **目录日期**: 2025-04-20
