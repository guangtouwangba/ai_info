...
这篇论文针对代码生成大模型(codeLLMs)评估中忽视人类偏好的问题，提出了CodeArena基准测试，包含397个高质量样本，覆盖40个类别和44种编程语言。研究还构建了20B标记的合成指令数据集SynCode-Instruct。实验发现执行基准与CodeArena存在性能差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)差距显著。研究强调了代码LLMs与人类偏好对齐的重要性，为提升模型实用价值提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T22:05:32Z
- **目录日期**: 2025-04-20
