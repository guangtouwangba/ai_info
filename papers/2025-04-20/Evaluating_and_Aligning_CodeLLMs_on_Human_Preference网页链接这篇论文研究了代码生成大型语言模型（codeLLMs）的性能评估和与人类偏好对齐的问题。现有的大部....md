...
这篇论文研究了代码生成大模型(codeLLMs)与人类偏好的对齐问题。作者创建了CodeArena基准测试(包含397个样本,覆盖40类任务和44种语言)来评估模型在真实编程场景中的表现,并构建了20B标记的SynCode-Instruct合成指令集。研究发现现有基于执行的评估与人类偏好存在差距,且开源模型(Qwen2.5-Coder)与商业模型(OpenAI o1)性能差异显著,凸显了人类偏好对齐的重要性。研究为提升代码LLMs的实际应用价值提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T23:05:30Z
- **目录日期**: 2025-04-20
