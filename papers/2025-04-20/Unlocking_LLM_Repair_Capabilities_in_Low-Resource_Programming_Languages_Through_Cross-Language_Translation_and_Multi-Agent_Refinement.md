...
近期研究表明，大型语言模型（LLM）在自动程序修复（APR）方面表现出色，但主要局限于主流语言（如Java、Python），对新兴语言（如Rust）支持不足。为此，研究者提出跨语言修复方法LANTERN，通过多智能体迭代修复范式，将缺陷代码从LLM修复能力较弱的语言翻译至表现更强的语言，无需额外训练。该方法采用基于LLM的动态决策系统，根据错误特征选择最优目标语言并整合修复反馈。在11种语言的5,068个错误测试中，Rust的修复成功率提升22.09%，首次证明跨语言翻译能显著提升LLM的多语言修复能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T06:02:03Z
- **目录日期**: 2025-04-20
