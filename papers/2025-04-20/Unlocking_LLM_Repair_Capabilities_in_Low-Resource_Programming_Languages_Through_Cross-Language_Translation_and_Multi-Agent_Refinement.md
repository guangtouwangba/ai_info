...
近期研究显示，大型语言模型（LLM）在自动程序修复（APR）方面展现出强大能力，但现有方法主要集中于Java、Python等主流语言，对Rust等新兴语言因训练成本高、数据少和社区支持不足而关注有限。为此，研究者提出跨语言修复方法LANTERN，通过多智能体迭代修复范式，将缺陷代码从LLM修复能力弱的语言翻译至其擅长的语言，无需额外训练。基于xCodeEval基准（11种语言的5,068个错误）测试显示，该方法显著提升修复效果，尤以Rust的Pass@10指标提高22.09%为证，为跨语言自动修复开辟了新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T13:07:23Z
- **目录日期**: 2025-04-20
