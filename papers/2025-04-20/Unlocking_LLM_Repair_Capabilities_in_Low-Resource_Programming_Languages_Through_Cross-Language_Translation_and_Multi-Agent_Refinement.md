...
最新研究提出了一种跨语言程序修复方法LANTERN，利用LLM在不同编程语言中的能力差异，通过多代理迭代修复范式提升修复效果。该方法将缺陷代码从LLM修复能力较弱的语言（如Rust）翻译至LLM表现更强的语言进行修复，无需额外训练。关键创新是基于LLM的动态决策系统，能根据错误特征选择最优目标语言并整合先前修复反馈。在包含11种语言5068个错误的xCodeEval基准测试中，该方法显著提升了修复效果，特别是冷门语言（如Rust的Pass@10指标提升22.09%），为语言无关的自动化程序修复开辟了新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T07:02:21Z
- **目录日期**: 2025-04-20
