...
近期研究表明，大语言模型（LLM）在自动程序修复（APR）中展现出强大能力，但现有方法主要集中于Java、Python等主流语言，对Rust等新兴语言因训练成本高、数据少和社区支持不足而效果有限。为此，研究者提出跨语言修复方法LANTERN，通过多智能体迭代范式，将缺陷代码从LLM修复能力弱的语言翻译至修复能力强的语言，无需额外训练。基于xCodeEval基准（11种语言的5,068个错误）测试显示，Rust的Pass@10指标提升22.09%。该研究首次证明跨语言翻译能显著提升LLM修复能力，缩小不同流行度语言间的性能差距，为语言无关的自动化程序修复开辟新途径。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T18:02:02Z
- **目录日期**: 2025-04-20
