...
当前基于LLM的自动程序修复(APR)主要针对Java、Python等主流语言，对Rust等新兴语言修复能力有限。为此，研究者提出跨语言修复方法LANTERN，通过多智能体迭代修复范式，将缺陷代码从LLM修复能力弱的语言翻译至其擅长的语言进行处理，无需额外训练。该方法采用基于LLM的动态决策系统选择最优目标语言，并整合历史修复反馈。在包含11种语言5068个错误的xCodeEval基准测试中，显著提升了冷门语言的修复效果，其中Rust的Pass@10指标提升22.09%，首次证实跨语言翻译能有效弥合不同流行度语言间的修复差距。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-20T16:02:12Z
- **目录日期**: 2025-04-20
