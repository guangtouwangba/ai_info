...
研究发现，大型语言模型（LLMs）能自发形成凝聚力强的AI群体，其观点动态受"多数影响力系数"调控。该系数决定群体能否达成共识，但随着群体规模增大而减弱，最终导致超过临界规模后协调失效。值得注意的是，模型的临界规模随语言能力呈指数增长，最先进LLMs的临界规模甚至超过人类非正式群体。这一发现揭示了AI社会自组织的内在局限性，对需要协调的协作AI系统设计具有重要启示。研究采用复杂性科学和行为科学方法，为理解多智能体系统的稳定性提供了新视角。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T15:03:22Z
- **目录日期**: 2025-04-16
