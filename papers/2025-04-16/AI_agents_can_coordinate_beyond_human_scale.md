...
研究发现，大型语言模型(LLMs)在组成多智能体协作群体时，能自发形成凝聚力，其观点动态受"多数力系数"调控。该系数随群体规模增大而减弱，导致存在临界规模——超过后协调将无法实现，群体稳定性丧失。值得注意的是，临界规模随模型语言能力呈指数增长，最先进LLMs的临界规模甚至超过典型人类非正式群体规模。这些发现揭示了AI智能体社会自组织的内在局限性，对需要协调的协作AI系统设计具有重要启示，既可能带来机遇也可能构成威胁。研究采用复杂性科学和行为科学方法进行分析。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T06:03:06Z
- **目录日期**: 2025-04-16
