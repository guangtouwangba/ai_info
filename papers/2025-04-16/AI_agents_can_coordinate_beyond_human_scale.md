...
研究发现，大型语言模型（LLMs）在协作任务中可自发形成具有凝聚力的群体，其意见动态受"多数力量系数"调控。该系数决定群体能否达成协调，但随着规模增大会逐渐减弱，导致超过临界规模后协调失效。值得注意的是，临界规模随模型语言能力呈指数增长——最先进LLMs的临界规模甚至超过人类非正式群体。这一发现揭示了AI群体自组织的内在局限性，对需要协调的协作AI系统设计具有重要启示，既可能成为优势也可能带来风险。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T17:03:10Z
- **目录日期**: 2025-04-16
