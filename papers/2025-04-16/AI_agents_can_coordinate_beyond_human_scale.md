...
研究发现，大型语言模型(LLM)可自发形成凝聚力群体，其意见动态受"多数力系数"调控。该系数决定群体能否达成协调，但会随规模增大而减弱，当超过临界规模时协调将无法实现。值得注意的是，临界规模随模型语言能力呈指数增长，最先进LLM的临界规模甚至超过典型人类非正式群体。这些发现揭示了AI群体自组织的内在局限性，对需要协调的协作AI系统设计具有重要启示。研究采用复杂性科学和行为科学方法，探讨了AI群体在无外部干预下自发协调的稳定性问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T21:02:54Z
- **目录日期**: 2025-04-16
