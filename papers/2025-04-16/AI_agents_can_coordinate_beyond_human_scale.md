...
研究发现，大型语言模型（LLM）组成的AI群体能自发形成凝聚力，其观点动态受"多数力系数"调控。该系数决定群体协调能力，但随着规模增大会减弱，导致超过临界规模后协调失效。值得注意的是，临界规模随模型语言能力呈指数增长，最先进LLM的临界规模甚至超过人类非正式群体典型大小。这揭示了AI社会自组织的内在局限，对需要协调的协作AI系统设计具有启示意义，既可能成为优势也可能带来风险。研究结合复杂性科学和行为科学方法，为AI群体稳定性提供了量化见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T09:03:12Z
- **目录日期**: 2025-04-16
