...
研究发现大型语言模型(LLM)能自发形成凝聚力群体，其意见动态受"多数力量系数"支配。该系数决定协调可能性，但随着群体规模增大会减弱，导致超过临界规模后协调难以实现。值得注意的是，临界规模随模型语言能力呈指数增长，最先进LLM的临界规模甚至超过典型人类非正式群体规模。这些发现揭示了AI群体自组织的内在局限性，对需要协调的协作AI系统设计具有重要启示。研究采用复杂性科学和行为科学方法，探讨了AI群体在无外部影响下自主协调决策的能力边界。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T14:03:19Z
- **目录日期**: 2025-04-16
