...
研究发现，大型语言模型（LLM）组成的AI群体能自发形成凝聚力，其意见动态受"多数力量系数"调控。该系数决定群体能否达成协调，但随着规模增大会减弱，导致超过临界规模后协调失效。值得注意的是，临界规模随模型语言能力呈指数增长，最先进LLM的临界规模甚至超过人类非正式群体。这揭示了AI社会自组织的内在局限，对需要协调的协作AI系统设计具有重要启示。研究采用复杂性科学和行为科学方法，表明AI群体虽能模拟人类社会的自组织特征，但稳定性存在根本性差异。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T08:03:19Z
- **目录日期**: 2025-04-16
