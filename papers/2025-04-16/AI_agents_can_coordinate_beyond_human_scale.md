...
研究发现，大型语言模型（LLMs）组成的AI群体能自发形成凝聚力，其意见动态受"多数力系数"支配，决定协调能否达成。随着群体规模扩大，多数力减弱，存在临界规模——超过该规模后协调将无法实现。值得注意的是，临界规模随模型语言能力呈指数增长，最先进LLMs的临界规模甚至超过人类非正式群体典型规模。该研究揭示了AI社会自组织的内在局限性，对需要协调的协作AI系统设计具有重要启示，既可能成为优势也可能带来风险。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T10:03:07Z
- **目录日期**: 2025-04-16
