...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、科研情报订阅等一站式服务。它能高效定位学术文献，通过互动问答和自动摘要帮助用户快速理解内容，支持PDF上传和AI辅助阅读分析。平台还提供个性化科研动态推送，覆盖42个学科的3.5亿论文、0.6亿学者等数据。用户可免费使用其浏览器检索功能，体验学者画像、学术会议等特色服务。网址：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T21:05:37Z
- **目录日期**: 2025-04-16
