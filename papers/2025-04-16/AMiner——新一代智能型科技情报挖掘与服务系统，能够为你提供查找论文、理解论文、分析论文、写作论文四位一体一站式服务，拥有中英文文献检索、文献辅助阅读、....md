...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析和写作一站式服务。支持中英文文献搜索，拥有3.5亿论文、0.6亿学者等海量数据。核心功能包括：1）智能文献检索与摘要生成；2）英文文献翻译与辅助阅读；3）个性化科研情报订阅服务。平台还提供学者画像、学术会议等特色功能，可通过网页免费使用，帮助用户高效获取学术资讯。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T12:06:15Z
- **目录日期**: 2025-04-16
