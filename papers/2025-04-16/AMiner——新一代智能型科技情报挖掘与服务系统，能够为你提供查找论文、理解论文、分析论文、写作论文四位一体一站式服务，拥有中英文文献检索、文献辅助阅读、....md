...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析及写作的一站式服务。它支持中英文文献搜索，能自动生成摘要并回答用户提问，提升研究效率。平台还具备文献翻译、文档识别和辅助阅读功能，用户可上传PDF获取AI生成的概要。此外，AMiner提供科研动态订阅服务，根据用户偏好推送最新论文摘要。涵盖42个学科的3.5亿论文资源，并包含学者画像、学术会议等特色功能。基础服务免费，可通过网页或小程序使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T09:06:21Z
- **目录日期**: 2025-04-16
