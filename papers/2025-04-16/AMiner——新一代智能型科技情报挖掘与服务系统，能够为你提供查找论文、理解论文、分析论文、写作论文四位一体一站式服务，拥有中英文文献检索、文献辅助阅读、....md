...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、翻译、辅助阅读和论文写作支持。平台收录3.5亿论文、0.6亿学者等海量数据，支持AI生成摘要、章节概要和智能问答，帮助用户快速理解文献内容。此外，AMiner提供个性化科研情报订阅服务，通过微信或邮件推送最新学术动态。用户还可利用学者画像、学术会议专题等功能辅助研究。平台基础功能免费开放，网址为https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T07:06:18Z
- **目录日期**: 2025-04-16
