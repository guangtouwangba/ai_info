...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读辅助、翻译及科研情报订阅等一站式服务。平台收录3.5亿论文、0.6亿学者等海量数据，支持中英文文献搜索、AI生成摘要、互动问答及文档翻译功能。用户可定制订阅最新科研动态，通过微信或邮件接收个性化推荐。此外，AMiner还提供学者画像、学术会议追踪等特色功能，基础服务免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T03:26:39Z
- **目录日期**: 2025-04-16
