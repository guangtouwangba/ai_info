...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献搜索，能自动生成摘要和问答互动，提升研究效率。平台还具备文档翻译、辅助阅读功能，用户可上传PDF或从3.5亿论文库中获取资料。特色服务包括科研动态订阅（按用户偏好推送最新成果）、学者画像及学术会议追踪。其浏览器版本免费开放，涵盖42个学科的海量数据（论文、专利、项目等），适合科研人员快速获取学术资讯。网址：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T16:06:32Z
- **目录日期**: 2025-04-16
