...
研究人员推出了DeepMath-103K数据集，包含约10.3万个高难度数学题（难度5-9级），旨在通过强化学习提升AI的复杂数学推理能力。该数据集经过严格筛选，确保答案可验证且未被现有基准污染，每道题配有标准答案和三种AI生成的解法，适用于不同训练方法。实验证明，使用该数据集训练的模型在数学推理任务上表现显著提升。数据集已开源，以推动AI推理能力的发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T06:01:48Z
- **目录日期**: 2025-04-16
