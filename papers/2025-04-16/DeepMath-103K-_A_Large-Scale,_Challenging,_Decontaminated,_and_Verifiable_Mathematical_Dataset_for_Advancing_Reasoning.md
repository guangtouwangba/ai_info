...
研究人员开发了DeepMath-103K数据集，包含约10.3万个高难度数学问题，旨在通过强化学习提升AI的复杂数学推理能力。该数据集经过严格筛选，确保题目难度（主要为5-9级）远超现有资源，并避免与评估基准重复。每个问题配有可验证答案和三种AI生成的解法，适用于监督微调等多种训练范式。实验表明，使用该数据集训练的模型在数学基准测试中表现显著提升。数据集已公开，以促进AI推理系统的发展。论文链接：https://github.com/zwhe99/DeepMath。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T14:01:56Z
- **目录日期**: 2025-04-16
