...
研究人员开发了DeepMath-103K数据集，包含约10.3万个高难度数学题（主要为5-9级），专门用于强化学习训练。该数据集通过严格筛选确保挑战性、答案可验证且与评估基准无重叠，每个问题附带三个AI生成的解法。相比现有资源，DeepMath-103K显著提升了难度范围和训练适用性，支持多种训练范式。实验表明，使用该数据集训练的模型在数学推理任务上表现显著提升。数据集已开源（https://github.com/zwhe99/DeepMath），旨在推动AI复杂推理能力的发展。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T19:01:45Z
- **目录日期**: 2025-04-16
