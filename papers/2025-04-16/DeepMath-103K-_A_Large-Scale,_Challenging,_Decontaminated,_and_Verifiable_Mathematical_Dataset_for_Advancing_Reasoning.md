...
DeepMath-103K是一个专为强化学习设计的大规模数学推理数据集，包含约10.3万道高难度题目（主要为5-9级），旨在解决现有训练数据不足、难度低和基准污染等问题。该数据集经过严格筛选，每道题均包含可验证答案和三种AI生成的解答，适用于监督微调等多种训练范式。实验表明，基于该数据集训练的模型在复杂数学基准测试中表现显著提升。数据集覆盖广泛数学主题，可促进AI的泛化推理能力。研究团队已公开该资源以推动AI推理系统发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T08:01:51Z
- **目录日期**: 2025-04-16
