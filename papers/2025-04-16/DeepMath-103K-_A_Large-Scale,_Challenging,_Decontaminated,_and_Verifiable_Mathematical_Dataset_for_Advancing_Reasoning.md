...
研究人员开发了DeepMath-103K数据集，包含约10.3万个高难度数学题（主要为5-9级），旨在通过强化学习提升AI的复杂数学推理能力。该数据集经过严格筛选，确保题目具有挑战性、答案可验证且与现有评估基准无重叠。每个问题提供三种不同解法，适用于监督微调等多种训练方式。实验表明，使用该数据集训练的模型在数学基准测试中表现显著提升。数据集已公开，以推动AI推理系统的发展。论文链接：https://github.com/zwhe99/DeepMath。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T13:09:18Z
- **目录日期**: 2025-04-16
