...
研究人员开发了DeepMath-103K数据集，包含约10.3万个高难度数学问题，旨在通过强化学习训练高级推理模型。该数据集经过严格筛选，确保问题难度（主要为5-9级）远超现有资源，并避免与评估基准重复。每个问题包含可验证的最终答案和三种不同解决方案，适用于多种训练范式。实验表明，使用该数据集训练的模型在数学推理任务上表现显著提升。数据集已公开，以促进AI推理系统的发展。论文链接：https://github.com/zwhe99/DeepMath。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T21:01:43Z
- **目录日期**: 2025-04-16
