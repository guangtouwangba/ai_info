...
Gallice和Monzon（2019）提出了一种自然情境，使得有限数量的自利主体在一次性社会困境中能实现完全合作。他们证明，在序贯公共品博弈中，当参与者不知道自身顺序位置但能观察到部分前人行为时，完全贡献会成为均衡结果，因为参与者有动机引导后续者效仿。本研究通过多人囚徒困境实验验证该理论，实验对象不知自身顺序且仅获知部分历史合作信息。结构计量分析显示，多数人选择搭便车（约30%符合原理论预测），其次是社会偏好型和无条件利他型参与者。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T00:02:28Z
- **目录日期**: 2025-04-16
