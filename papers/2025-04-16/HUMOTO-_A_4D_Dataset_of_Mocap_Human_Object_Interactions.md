...
HUMOTO是一个高精度的人-物交互数据集，包含736段动作序列（7,875秒30fps视频），涵盖63种精确建模的物体和72个可动部件。该数据集通过创新的场景驱动LLM脚本流程生成完整任务链，并采用动捕-相机混合系统处理遮挡问题，覆盖烹饪、野餐等多样化活动。所有序列经过专业艺术家的物理精度（如减少脚滑和穿模）和逻辑流程验证。相比现有数据集，HUMOTO以全身动作和多物体同步交互为特色，为动画、机器人和具身AI等领域提供了更真实的人-物交互建模基准。项目网址见摘要。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T01:30:09Z
- **目录日期**: 2025-04-16
