...
HUMOTO是一个高质量的人-物交互数据集，包含736段动作序列（7,875秒，30fps），涵盖63种精确建模的物体和72个可动部件。该数据集通过场景驱动的LLM脚本流程生成完整、有目的性的任务，并采用动捕与相机结合的系统有效处理遮挡问题。覆盖烹饪、野餐等多种活动，保持物理精确性和任务逻辑性。专业艺术家对每段序列进行严格清理，减少脚步滑动和物体穿透。HUMOTO提供了全身动作和多物体同步交互数据，解决了关键数据采集难题，为动画、机器人和具身AI等领域的真实交互建模提供了新机会。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T02:30:17Z
- **目录日期**: 2025-04-16
