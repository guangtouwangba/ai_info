...
这篇论文探讨了代码生成大模型(codeLLMs)与人类偏好的对齐问题。研究者创建了CodeArena基准测试(包含397个样本，覆盖40类任务和44种语言)，发现现有基于执行的测试无法充分反映人类偏好。同时构建了20B标记的SynCode-Instruct合成指令集验证微调效果。实验显示开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)存在显著差距，凸显了人类偏好对齐的重要性。研究强调需要超越传统正确性评估，开发更符合实际编程需求的模型评价体系。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T03:26:51Z
- **目录日期**: 2025-04-16
