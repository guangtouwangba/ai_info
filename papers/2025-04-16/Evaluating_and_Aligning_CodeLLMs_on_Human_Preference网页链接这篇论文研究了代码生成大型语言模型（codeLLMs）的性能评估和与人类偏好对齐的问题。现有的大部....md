...
这篇论文针对代码生成大模型(codeLLMs)提出新评估方法，指出当前基准测试过于关注代码正确性而忽视人类偏好。研究者构建了CodeArena基准(含397个高质量样本，覆盖40类44种语言)和SynCode-Instruct语料库(近200亿标记)来评估模型。实验发现执行基准与CodeArena存在性能差异，开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)差距显著，凸显对齐人类偏好的重要性。研究强调需要更全面的评估体系来提升代码生成模型的实际应用价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T02:33:51Z
- **目录日期**: 2025-04-16
