...
这篇论文针对代码生成大模型(codeLLMs)提出新评估方法，重点关注与人类偏好的对齐。研究者创建了CodeArena基准测试(包含397个高质量样本，覆盖40类44种语言)和SynCode-Instruct语料库(近200亿标记)，发现现有基于执行的测试与人类偏好存在差距。实验比较40多个模型显示，开源顶级模型(如Qwen2.5-Coder)与专有模型(如OpenAI o1)性能差异显著，凸显对齐人类偏好的重要性。研究证实大规模合成指令微调的有效性，为代码LLM评估提供了更全面的框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T08:06:59Z
- **目录日期**: 2025-04-16
