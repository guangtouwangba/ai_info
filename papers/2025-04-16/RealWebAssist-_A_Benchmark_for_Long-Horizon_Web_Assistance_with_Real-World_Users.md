...
研究人员提出了RealWebAssist基准，用于评估AI助手在真实场景中长期执行网页任务的能力。该基准包含来自真实用户的连续指令数据集，要求AI理解模糊意图、跟踪用户心理状态、适应个性化习惯并准确操作GUI元素。研究表明，现有先进模型在理解用户指令、保持长期交互方面仍面临重大挑战，难以满足现实世界中动态、模糊且持续演变的用户需求。该工作突出了网页助手需解决的关键问题：长期意图推理、用户状态追踪及GUI精准操作。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T00:02:19Z
- **目录日期**: 2025-04-16
