...
本文综述了非小细胞肺癌（NSCLC）治疗中ALK基因双靶点抑制剂的最新进展。ALK基因是NSCLC的重要致癌驱动靶点，已有7种抑制剂获批用于ALK融合阳性患者，但耐药性问题突出。相比联合用药，双靶点抑制剂能通过单一分子同时作用于两个靶点，减少副作用并增强抗耐药性。文章重点分析了这类抑制剂的合理设计、结构-活性关系及治疗策略，为开发新型ALK靶向药和克服耐药性提供了重要参考。研究对推动NSCLC精准治疗具有重要意义。（99字）  

注：第一段关于OmniEval金融评估基准的内容与后文医学研究无关，可能是误粘贴，故未纳入摘要。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T09:05:36Z
- **目录日期**: 2025-04-16
