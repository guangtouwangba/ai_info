...
Kimi-VL是一款高效的开源视觉语言模型(VLM)，采用混合专家(MoE)架构，仅激活28亿参数即可实现强大性能。它在多轮代理任务、图像/视频理解、OCR、数学推理等领域表现优异，媲美GPT-4o-mini等前沿模型。支持128K长上下文处理，在LongVideoBench和MMLongBench-Doc上分别获得64.5和35.1分。其原生分辨率视觉编码器MoonViT能处理超高清输入，在InfoVQA和ScreenSpot-Pro上达83.2和34.5分。进阶版Kimi-VL-Thinking通过长思维链训练，在MMMU(61.7分)等任务中展现卓越推理能力，同时保持参数高效。代码和模型已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T10:02:58Z
- **目录日期**: 2025-04-16
