...
Kimi-VL是一款高效的开源视觉语言模型(VLM)，采用混合专家(MoE)架构，仅激活2.8B参数。它在多轮代理任务、图像/视频理解、OCR、数学推理等方面表现优异，性能媲美GPT-4o等顶尖模型。支持128K长上下文处理，在LongVideoBench和MMLongBench-Doc上分别获得64.5和35.1分。其原生分辨率视觉编码器MoonViT可处理超高分辨率输入，在InfoVQA和ScreenSpot-Pro上分别达到83.2和34.5分。进阶版Kimi-VL-Thinking通过长链思维微调和强化学习，在MMMU、MathVision等任务上表现突出，同时保持参数高效。代码和模型已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T15:03:13Z
- **目录日期**: 2025-04-16
