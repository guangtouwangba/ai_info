...
一项针对6,000多名知识工作者的实验研究表明，生成式AI显著提升了工作效率。实验发现，使用AI工具的员工每周阅读邮件时间减少半小时，文档处理速度提升12%。尽管技术较新，仍有近40%的员工在6个月研究中持续使用该工具。这些发现表明，AI正在改变知识工作者的工作方式，并在多个行业和岗位中带来实质性的时间节省。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T19:02:12Z
- **目录日期**: 2025-04-16
