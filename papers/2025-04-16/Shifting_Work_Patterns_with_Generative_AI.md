...
一项为期6个月的跨行业随机对照实验研究了生成式AI对6000名知识工作者的影响。研究发现，使用AI工具的员工每周处理邮件时间减少3小时（降幅25%），文档完成速度有所提升，但会议时间未显著改变。这表明AI初期主要影响可独立改变的工作行为，而非需要协调的集体行为。实验组通过现有办公软件集成AI功能，意向治疗效应为每周节省1.4小时。研究揭示了AI工具在办公场景中的差异化影响特征。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T19:02:30Z
- **目录日期**: 2025-04-16
