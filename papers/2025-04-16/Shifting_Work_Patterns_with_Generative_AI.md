...
一项为期6个月的跨行业随机对照实验研究了生成式AI对6000名知识工作者的影响。其中一半人获得了集成到日常工作软件中的AI工具。研究发现，使用AI工具的员工每周处理邮件时间减少3小时（25%），文档完成速度有所提升，但会议时间无明显变化。这表明AI初期主要影响可独立改变的工作行为，而非需要协调的集体行为。意向治疗分析显示邮件时间平均减少1.4小时。研究揭示了AI工具在职场应用初期的行为改变模式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T09:02:37Z
- **目录日期**: 2025-04-16
