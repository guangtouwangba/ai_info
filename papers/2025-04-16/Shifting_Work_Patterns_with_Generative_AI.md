...
一项为期6个月的跨行业随机对照实验研究了生成式AI对6000名知识工作者的影响。研究发现，使用AI工具的员工每周处理邮件时间减少3小时(25%)，文档完成速度有所提升，但会议时间无明显变化。这表明AI初期主要影响可独立改变的工作行为，而非需要协调的行为。实验组中半数员工获得了集成到现有办公软件的AI工具访问权限。研究结果表明，生成式AI在发布第一年主要改变了可自主调整的工作模式，对需要团队协作的工作模式影响较小。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T22:02:28Z
- **目录日期**: 2025-04-16
