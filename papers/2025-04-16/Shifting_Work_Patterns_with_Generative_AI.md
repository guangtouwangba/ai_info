...
一项为期6个月的跨行业随机对照实验研究了生成式AI对6000名知识工作者的影响。研究发现，使用AI工具的员工每周处理邮件的时间减少了3小时（25%），完成文档的速度有所提升，但会议时间没有显著变化。这些行为改变主要集中在可独立调整的工作环节，而非需要协调的集体行为。实验组中有一半人获得了集成在常用办公软件中的AI工具。结果表明，在AI工具发布的第一年，其对工作模式的影响主要体现在可独立优化的任务上。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T07:02:37Z
- **目录日期**: 2025-04-16
