...
一项为期6个月的跨行业随机对照实验研究了生成式AI对6000名知识工作者的影响。研究发现，使用AI工具的员工每周处理邮件的时间减少了3小时（约25%），完成文档的速度有所提升，但会议时间没有显著变化。这表明AI初期主要影响可独立改变的工作行为，而非需要协调的行为。实验组中仅部分人实际使用了AI工具，因此意向治疗估计值为每周减少1.4小时。研究揭示了生成式AI在办公场景中的初步应用效果及其对工作模式的差异化影响。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T12:02:38Z
- **目录日期**: 2025-04-16
