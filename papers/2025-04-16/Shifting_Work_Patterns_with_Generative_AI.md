...
一项为期6个月的跨行业随机对照实验研究了生成式AI对6000名知识工作者的影响。研究发现，使用AI工具的员工每周处理邮件的时间减少了3小时（降幅25%），文档完成速度有所提升，但会议时间无明显变化。这表明AI初期主要影响可独立改变的工作行为，而非需要协调的集体行为。实验组中半数员工获得了集成在现有办公软件中的AI工具。研究揭示了AI在工作模式转型中的局限性——它更易改变个体作业方式，较难改变需要团队协作的工作流程。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T14:02:48Z
- **目录日期**: 2025-04-16
