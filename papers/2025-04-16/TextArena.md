...
TextArena是一个开源的文本游戏集合，旨在训练和评估大语言模型（LLMs）的智能体行为。它包含57+种独特环境（单机、双人和多人模式），支持在线对战系统（人类或模型间对抗）和实时TrueSkill评分，弥补传统基准测试在动态社交能力（如谈判、心理理论和欺骗）评估上的不足。该平台注重研究、社区和可扩展性，便于添加新游戏、调整框架、测试模型、与模型对战及训练模型。详细信息可访问其GitHub页面和官网。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T17:02:29Z
- **目录日期**: 2025-04-16
