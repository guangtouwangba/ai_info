...
TextArena是一个开源的文本游戏集合，用于训练和评估大语言模型（LLMs）的智能行为。它包含57+种独特环境（单人、双人和多人模式），支持在线对战系统（人类或模型间对抗），并实时计算TrueSkill评分。传统基准测试常忽略动态社交能力（如谈判、心理理论和欺骗），而TextArena填补了这一空白。其设计注重研究、社区参与和可扩展性，便于添加新游戏、适配框架、测试模型、人机对战及模型训练。详情见官网与GitHub页面：https://www.textarena.ai/ 和 https://github.com/LeonGuertler/TextArena。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T19:02:22Z
- **目录日期**: 2025-04-16
