...
TextArena是一个开源的文本游戏集合，用于训练和评估大语言模型（LLMs）的智能行为。它包含57+种独特环境（单人、双人和多人模式），支持在线对战系统（人类或提交的模型），并实时计算TrueSkill评分。传统基准测试常忽略动态社交技能（如谈判、心理理论和欺骗），而TextArena填补了这一空白。其设计注重研究、社区和可扩展性，便于添加新游戏、适配框架、测试模型、与模型对战及训练模型。更多环境、游戏、排行榜和示例详见官网与GitHub页面。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T07:02:27Z
- **目录日期**: 2025-04-16
