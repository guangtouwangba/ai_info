...
TextArena是一个开源的文本游戏集合，旨在训练和评估大语言模型（LLMs）的智能行为。它包含57+种独特环境（单人、双人和多人模式），支持通过在线对战系统（人类或模型间对抗）实时评估模型能力，并采用TrueSkill评分。传统基准测试常忽略动态社交技能（如谈判、心理理论和欺骗），而TextArena填补了这一空白。其设计注重研究、社区性和扩展性，支持快速添加新游戏、适配框架、测试模型、人机对战及模型训练。更多详情见官网和GitHub页面。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T18:02:23Z
- **目录日期**: 2025-04-16
