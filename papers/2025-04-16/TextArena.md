...
TextArena是一个开源的文本游戏集合，用于训练和评估大语言模型（LLMs）的智能行为。它包含57+种独特环境（单人、双人和多人模式），支持在线对战（人类或模型），并通过实时TrueSkill评分系统评估模型能力。传统基准测试常忽略动态社交技能（如谈判、心理理论和欺骗），而TextArena填补了这一空白。该平台注重研究、社区和可扩展性，便于添加新游戏、调整框架、测试模型、与模型对战及训练模型。详细文档和示例见GitHub和官网链接。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-16T08:02:35Z
- **目录日期**: 2025-04-16
