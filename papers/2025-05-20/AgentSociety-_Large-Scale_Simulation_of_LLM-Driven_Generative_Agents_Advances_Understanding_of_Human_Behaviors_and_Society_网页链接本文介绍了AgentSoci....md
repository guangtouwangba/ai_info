...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统模拟了超过1万个AI代理的社会互动（共500万次），用于研究极化现象、信息传播、基本收入政策影响和自然灾害应对等社会问题。研究结果显示，模拟结果与现实世界数据高度吻合，证明该系统能有效捕捉人类行为机制。AgentSociety可作为计算社会科学研究的创新工具，为研究者和政策制定者提供新的研究方法，补充传统调查和实验的不足。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T01:33:04Z
- **目录日期**: 2025-05-20
