...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能模拟10,000多个智能代理及其500万次社会互动。该系统通过研究社会极化、信息传播、基本收入政策及自然灾害影响等案例，验证了其模拟结果与现实世界数据的高度一致性。研究表明，AgentSociety能有效捕捉人类行为机制，为社会科学研究和政策制定提供新工具，弥补传统调查和实验方法的不足。这一创新平台展示了AI在理解复杂社会现象方面的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T07:05:17Z
- **目录日期**: 2025-05-20
