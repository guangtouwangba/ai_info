...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统模拟了1万多个AI代理的社会生活，记录了500万次互动，用于研究社会现象。研究者用它分析了四个关键问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据吻合良好，证明该系统能有效捕捉人类行为模式和社会机制。AgentSociety展现了作为社会科学研究工具和政策测试平台的潜力，可辅助传统研究方法，帮助理解复杂社会问题的成因和解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T10:12:47Z
- **目录日期**: 2025-05-20
