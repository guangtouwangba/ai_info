...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统模拟了1万多个AI代理在真实社会环境中的500万次互动，用于研究社会现象。研究者通过四个案例（社会极化、信息传播、基本收入政策、自然灾害影响）验证了其有效性，发现模拟结果与现实数据高度吻合。这证明了AgentSociety能有效捕捉人类行为机制，可作为社会科学研究和政策制定的有力工具。该系统结合了AI代理、真实环境和大规模模拟引擎，为传统研究方法提供了新的补充。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T19:05:23Z
- **目录日期**: 2025-05-20
