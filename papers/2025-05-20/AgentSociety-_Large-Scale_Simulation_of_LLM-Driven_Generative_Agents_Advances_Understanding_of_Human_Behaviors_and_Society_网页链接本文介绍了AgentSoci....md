...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理的社会互动（500万次交互）。该系统被用于研究四大社会问题：社会极化、信息传播、基本收入政策效果和自然灾害影响。研究发现模拟结果与现实世界数据高度吻合，验证了该系统捕捉人类行为机制的能力。这一突破性工具为社会科学研究和政策制定提供了新方法，能够有效补充传统调查和实验手段，帮助深入理解复杂社会现象的内在机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T06:05:18Z
- **目录日期**: 2025-05-20
