...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理及其500万次社会互动。研究者用它研究四大社会问题：群体极化、信息传播、基本收入政策效果和自然灾害影响。该系统能有效捕捉人类行为模式，模拟结果与现实数据高度吻合，为社会科学研究和政策制定提供了新工具。该技术突破展示了AI在理解社会机制方面的潜力，可辅助传统研究方法（如调查和实验），帮助分析社会问题的成因和解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T03:23:14Z
- **目录日期**: 2025-05-20
