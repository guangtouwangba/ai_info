...
卡尔加里大学研究发现，生物体会自发释放超弱光子（UPE），这种微光与生命活性相关。实验显示活体老鼠发光明显，死亡后光强骤降；植物在受伤或受刺激时UPE增强，表明其与细胞应激反应相关。UPE由代谢产生的活性氧（ROS）引发，可作为非侵入式生物指标，用于监测生命状态、植物健康及医学研究。该发现为评估生理活性和压力响应提供了新方法，未来或应用于农业筛选和临床监测。研究首次将UPE与死亡过程关联，揭示了生命活动的光学特征。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T21:03:15Z
- **目录日期**: 2025-05-20
