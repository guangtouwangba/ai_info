...
卡尔加里大学研究发现，生物体会自发产生超弱光子发射(UPE)，这种肉眼不可见的"生物微光"与生命活性密切相关。实验显示活体老鼠发光明显，死亡后光线消失；植物在受伤或受刺激时UPE增强，表明其与细胞应激反应相关。UPE源自代谢产生的活性氧(ROS)，可能反映生物体的"挣扎"状态。该发现具有重要意义：可作为非侵入式生物指标，用于监测细胞活性、植物健康状况，未来或应用于医学无创检测。研究首次将UPE现象与生命状态直接关联，为生命科学研究提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T13:13:03Z
- **目录日期**: 2025-05-20
