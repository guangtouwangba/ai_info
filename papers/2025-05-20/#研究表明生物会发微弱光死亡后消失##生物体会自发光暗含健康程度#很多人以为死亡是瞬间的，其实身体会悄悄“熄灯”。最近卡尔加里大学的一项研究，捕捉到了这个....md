...
卡尔加里大学研究发现生物体存在"超弱光子发射"(UPE)现象：活体组织会自发释放肉眼不可见的微弱光，死亡后逐渐消失。实验显示活鼠发光强度显著高于死亡个体，植物在受伤或受刺激时UPE也会增强。这种光源于细胞代谢产生的活性氧(ROS)，可作为生命活性和生理压力的生物指标，在医学检测、农业监测等领域具有应用潜力。研究首次将UPE与生命状态直接关联，为无创监测生物活性提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T11:03:29Z
- **目录日期**: 2025-05-20
