...
卡尔加里大学研究发现生物体会自发产生超弱光子发射（UPE），这种肉眼不可见的"生物微光"与生命活性直接相关。活体小鼠在成像中呈现彩色发光，死亡后光强骤降；植物在受伤或受刺激时UPE增强，受损部位发光最亮。该现象源于细胞代谢产生的活性氧（ROS），压力越大发光越强。研究证实UPE可作为非侵入式生物指标：监测动植物健康状态、评估细胞活性，未来或用于临床追踪组织损伤。该成果首次将UPE强度与生命存续状态建立关联，为生命科学提供新观测维度。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T16:03:35Z
- **目录日期**: 2025-05-20
