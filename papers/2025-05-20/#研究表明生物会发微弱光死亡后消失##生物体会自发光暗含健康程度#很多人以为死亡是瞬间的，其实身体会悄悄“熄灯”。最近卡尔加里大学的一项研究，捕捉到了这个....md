...
卡尔加里大学研究发现，生物体会自发产生超弱光子发射(UPE)，这种肉眼不可见的微光与生命活性相关。活体动物UPE强度显著高于死亡个体，植物在受伤或受刺激时UPE也会增强。该现象源于细胞代谢产生的活性氧(ROS)，压力越大发光越强。研究证实UPE可作为非侵入式生物指标，用于监测动植物健康状态、细胞活性及应激反应，在医学、农业等领域具有潜在应用价值。这项突破首次将UPE与生命状态直接关联，为生命活动监测提供了新方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T17:03:07Z
- **目录日期**: 2025-05-20
