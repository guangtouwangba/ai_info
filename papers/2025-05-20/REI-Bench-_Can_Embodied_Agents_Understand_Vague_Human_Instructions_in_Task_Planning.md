...
机器人任务规划将人类指令分解为可执行动作序列。现有基于大语言模型(LLM)的规划器假设指令清晰，但现实中非专业用户(如老人儿童)常使用模糊指代表达(RE)，严重影响规划性能。研究提出首个含模糊RE的基准测试REI-Bench，发现RE模糊性可使成功率下降77.9%。主要失败原因是规划器遗漏对象。为解决此问题，提出任务导向的上下文认知方法，能生成清晰指令，性能优于现有提示方法。该研究使人机交互更实用，特别有助于服务非专业用户群体。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T18:01:53Z
- **目录日期**: 2025-05-20
