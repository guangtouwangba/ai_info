...
这篇论文研究了基于大语言模型(LLM)的机器人任务规划在遇到模糊指代表达(RE)时的性能下降问题。作者创建了首个包含模糊RE的机器人任务规划基准测试REI-Bench，发现模糊RE会导致规划成功率下降高达77.9%。为解决这个问题，作者提出了一种简单有效的"任务导向上下文认知"方法，通过生成清晰指令显著提升了规划性能。这项研究特别关注老年人和儿童等非专业用户群体，使机器人任务规划在实际人机交互(HRI)场景中更具实用性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T12:02:14Z
- **目录日期**: 2025-05-20
