...
该研究探讨了基于大语言模型(LLM)的机器人任务规划在面对人类模糊指代表达(REs)时的性能下降问题。研究发现REs的模糊性可导致规划成功率下降高达77.9%。为此，作者创建了首个含模糊REs的机器人任务规划基准测试REI-Bench，并提出任务导向的上下文认知方法，通过生成清晰指令显著提升规划性能。这项工作使机器人任务规划对非专业用户(如老人和儿童)更具实用性，推动了人机交互领域的发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T19:02:00Z
- **目录日期**: 2025-05-20
