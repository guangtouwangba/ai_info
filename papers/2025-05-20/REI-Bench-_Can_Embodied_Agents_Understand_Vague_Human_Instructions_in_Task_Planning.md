...
该研究探讨了基于大型语言模型(LLM)的机器人任务规划在面对人类模糊指代表达(REs)时的挑战。研究发现REs的模糊性会导致任务规划成功率下降高达77.9%。为此，作者创建了首个包含模糊REs的机器人任务规划基准测试REI-Bench，并提出"任务导向情境认知"方法，通过生成清晰指令显著提升规划性能。这项工作特别关注老年人和儿童等非专业用户的需求，使机器人任务规划更具实用性，为人机交互(HRI)研究做出了重要贡献。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T13:11:46Z
- **目录日期**: 2025-05-20
