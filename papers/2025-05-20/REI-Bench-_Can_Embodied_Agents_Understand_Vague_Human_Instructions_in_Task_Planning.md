...
该研究探讨了基于大语言模型（LLM）的机器人任务规划中模糊指代表达（REs）的影响。研究发现，非专家用户（如老人和儿童）的模糊指令会导致任务成功率下降高达77.9%。为此，作者提出了首个含模糊REs的机器人任务规划基准REI-Bench，并发现大多数失败源于规划器遗漏对象。为解决此问题，他们提出了一种简单有效的"任务导向上下文认知"方法，能生成清晰指令，显著提升性能。这项工作使机器人任务规划对非专业用户更具实用性，推动了人机交互领域的发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T04:02:59Z
- **目录日期**: 2025-05-20
