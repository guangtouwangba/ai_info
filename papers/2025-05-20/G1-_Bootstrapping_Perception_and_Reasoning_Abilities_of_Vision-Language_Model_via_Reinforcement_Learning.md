...
本文介绍了VLM-Gym，一个专为视觉语言模型（VLMs）设计的强化学习环境，用于提升其在交互式视觉环境（如游戏）中的决策能力。研究发现，现有VLMs在简单游戏中表现不佳，存在“知行差距”。通过VLM-Gym，研究者训练了G0和G1模型，其中G1模型结合了感知增强和强化学习微调，表现优于Claude-3.7等领先专有模型。分析表明，感知和推理能力在强化学习过程中相互促进。相关代码已开源，以推动VLMs作为交互式智能体的发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T05:00:52Z
- **目录日期**: 2025-05-20
