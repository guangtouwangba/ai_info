...
视觉语言模型（VLMs）在多模态任务中表现优异，但在游戏等交互式视觉环境中的决策能力较弱。为此，研究者开发了VLM-Gym，一个强化学习（RL）环境，包含多样化的视觉游戏，支持并行训练。通过纯RL驱动的自我进化训练G0模型，发现感知和推理能力在训练中相互促进。进一步改进的G1模型结合了感知增强的冷启动和RL微调，性能超越Claude-3.7-Sonnet-Thinking等领先模型。研究揭示了感知与推理能力的协同提升机制。代码已开源以推动VLM作为交互智能体的发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T04:01:57Z
- **目录日期**: 2025-05-20
