...
这项研究系统评估了8个主流大语言模型（包括2个DeepSeek模型）在数学推理任务上的表现。关键发现包括：1）DeepSeek-R1在多数领域表现优异，在MMLU形式逻辑基准上准确率最高；2）蒸馏版本（如DeepSeek-1.5B）性能显著下降；3）Gemini 2.0 Flash响应延迟最低。研究还探讨了模型架构、训练方法和优化策略对推理性能的影响，为开发更符合严格推理需求的未来模型提供了指导。评估基于三个独立基准数据集，揭示了当前大语言模型在数学领域的优势与局限。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T03:20:37Z
- **目录日期**: 2025-05-20
