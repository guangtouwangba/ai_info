...
这篇研究系统评估了8种主流大语言模型(LLMs)在数学推理任务上的表现，包括两个DeepSeek模型。结果显示：(1)DeepSeek-R1在多数领域表现优异，在MMLU形式逻辑基准上准确率最高；(2)蒸馏版本(如DeepSeek-1.5B)性能显著下降；(3)Gemini 2.0 Flash响应延迟最低。研究还探讨了架构选择、训练范式和优化策略对推理性能的影响，为开发更符合严格推理需求的未来模型提供了指导。该评估揭示了当前LLMs在数学领域的能力与局限，填补了跨模型家族全面评估的空白。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T23:02:29Z
- **目录日期**: 2025-05-20
