...
本研究系统评估了8种主流大语言模型（LLMs）在数学推理任务上的表现，包括两个DeepSeek模型。结果显示：(1) DeepSeek-R1在多数领域表现优异，在MMLU形式逻辑基准中准确率最高；(2) 蒸馏版本（如DeepSeek-1.5B）性能显著下降；(3) Gemini 2.0 Flash响应延迟最低。研究还探讨了模型架构、训练方法和优化策略对推理性能的影响。这些发现为理解当前LLMs在数学领域的优势和局限提供了新见解，并为开发更符合严格推理需求的未来模型提供了指导。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T13:12:20Z
- **目录日期**: 2025-05-20
