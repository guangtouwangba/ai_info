...
本文探讨了多臂老虎机（Bandit）算法与大型语言模型（LLM）的协同潜力。老虎机算法通过平衡探索与利用，可优化LLM的微调、提示工程和自适应响应生成；而LLM则能通过增强上下文理解、动态适应和自然语言推理，改进老虎机算法的策略选择。研究综述了现有成果，指出两者互补的优势：老虎机算法提升LLM的大规模学习能力，LLM为老虎机决策提供新思路。这一交叉研究为AI创新应用开辟了新途径，同时面临整合挑战与机遇。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T13:11:24Z
- **目录日期**: 2025-05-20
