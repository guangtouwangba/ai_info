...
本文探讨了多臂老虎机算法（Bandit）与大语言模型（LLM）的协同潜力。老虎机算法通过平衡探索与利用，可优化LLM的微调、提示工程和自适应响应生成；而LLM则能通过自然语言推理增强老虎机算法的上下文理解、动态适应和策略选择。研究综述了现有成果，指出两者互补的优势：老虎机算法提升LLM性能，LLM为决策提供新思路。该跨领域研究为人工智能的创新应用搭建了桥梁，同时揭示了未来挑战与机遇。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T11:01:49Z
- **目录日期**: 2025-05-20
