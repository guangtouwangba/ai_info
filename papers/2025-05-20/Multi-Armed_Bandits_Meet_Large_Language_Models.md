...
本文探讨了多臂老虎机算法（Bandit）与大语言模型（LLM）的协同潜力。老虎机算法通过平衡探索与利用，可优化LLM的微调、提示工程和自适应响应生成；而LLM凭借其自然语言理解能力，能为老虎机算法提供更优的上下文理解、动态适应和策略选择。研究综述了两者互补的应用场景，指出LLM可增强基于老虎机的决策系统，同时老虎机算法能提升LLM的大规模学习效率。该跨领域研究为人工智能的创新应用提供了新方向，并揭示了当前挑战与机遇。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T17:01:43Z
- **目录日期**: 2025-05-20
