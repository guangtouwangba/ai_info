...
本文探讨了多臂老虎机算法（Bandit）与大语言模型（LLM）的协同潜力。老虎机算法通过平衡探索与利用，可优化LLM的微调、提示工程和自适应响应生成；而LLM的自然语言推理能力又能增强老虎机算法的上下文理解、动态适应和策略选择。研究综述了两者互补的优势：老虎机算法提升LLM性能，LLM为老虎机决策提供新思路。通过系统回顾现有研究并指出关键挑战与机遇，该综述旨在搭建两个领域间的桥梁，推动人工智能跨学科创新应用的发展。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T08:02:03Z
- **目录日期**: 2025-05-20
