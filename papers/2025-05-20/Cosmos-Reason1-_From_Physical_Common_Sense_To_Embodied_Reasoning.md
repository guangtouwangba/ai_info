...
这篇论文提出了Cosmos-Reason1模型，旨在通过长链思维推理理解物理世界并生成合适的具身决策。研究定义了物理AI推理的关键能力，包括物理常识和具身推理，并采用分层本体表示物理常识（空间、时间、物理知识）和二维本体泛化具身推理。团队开发了7B和56B参数的多模态大语言模型，通过两阶段训练（监督微调与强化学习）提升性能。评估显示该方法显著提升了物理推理能力。相关代码和预训练模型已开源，以促进物理AI发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T22:02:05Z
- **目录日期**: 2025-05-20
