...
本文介绍了Cosmos-Reason1模型，旨在通过长链思维推理帮助AI系统在物理世界中感知、理解并执行复杂动作。该研究定义了物理常识和具身推理两大核心能力，分别采用分层本体和二维本体进行知识表征。团队开发了7B和56B两种参数规模的多模态大语言模型，通过监督微调（SFT）和强化学习（RL）两阶段训练。基于本体论构建的评估基准显示，这两种训练方法显著提升了模型性能。相关代码和预训练模型已通过NVIDIA开放模型许可在GitHub开源，以促进物理AI领域发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T03:20:16Z
- **目录日期**: 2025-05-20
