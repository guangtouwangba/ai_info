...
研究人员开发了首个全自动多智能体系统Robin，能够自主完成科学研究全流程：文献检索、假设生成、实验设计、数据分析和假设更新。该系统成功发现了一种治疗干性年龄相关性黄斑变性（dAMD）的新疗法，提出增强视网膜色素上皮细胞吞噬作用作为治疗策略，并验证了临床药物瑞帕舒地（ripasudil）的疗效。通过RNA测序实验，Robin进一步揭示了该药物通过上调ABCA1基因发挥作用的机制。所有研究过程均由AI自主完成，标志着人工智能首次在实验室闭环框架中实现从发现到验证的完整科学发现过程，为AI驱动科研建立了新范式。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T20:01:14Z
- **目录日期**: 2025-05-20
