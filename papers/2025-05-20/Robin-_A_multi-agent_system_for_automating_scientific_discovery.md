...
研究人员开发了首个全自动多智能体系统Robin，能够自主完成科学发现的关键步骤：文献检索、假设生成、实验设计和数据分析。该系统成功应用于老年性黄斑变性(dAMD)治疗研究，提出增强视网膜色素上皮细胞吞噬作用的新策略，并发现临床药物瑞帕舒地(ripasudil)具有治疗潜力。后续RNA测序实验揭示其通过上调ABCA1发挥作用。值得注意的是，本研究中所有假设、实验方案、数据分析和图表均由Robin自主完成。这一突破性成果标志着AI首次在实验室闭环框架中自主发现并验证新疗法候选物，为AI驱动的科研建立了新范式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T16:01:29Z
- **目录日期**: 2025-05-20
