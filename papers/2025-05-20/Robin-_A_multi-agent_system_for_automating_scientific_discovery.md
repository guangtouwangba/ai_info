...
研究人员开发了首个全自动科学发现多智能体系统Robin，该系统能自主完成文献检索、假设生成、实验设计、数据分析和假设更新等科研全流程。应用该系统成功发现了治疗干性年龄相关性黄斑变性(dAMD)的新疗法：Robin提出增强视网膜色素上皮细胞吞噬作用的新策略，并鉴定出临床已有药物Ripasudil（一种ROCK抑制剂）作为候选药物。通过后续RNA测序实验，系统还发现了ABCA1这一潜在新靶点。所有研究假设、实验方案和数据分析均由Robin自主完成，开创了AI驱动科学发现的新范式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T13:11:04Z
- **目录日期**: 2025-05-20
