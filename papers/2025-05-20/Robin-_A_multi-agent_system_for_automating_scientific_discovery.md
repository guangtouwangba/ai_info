...
研究人员开发了首个全自动多智能体系统Robin，能自主完成科学发现的关键步骤：文献检索、假设生成、实验设计和数据分析。该系统成功应用于老年性黄斑变性（dAMD）治疗研究，提出增强视网膜色素上皮细胞吞噬作用的新策略，并发现临床药物瑞帕舒地（ripasudil）具有治疗潜力。后续RNA测序实验揭示了该药物通过上调脂质转运蛋白ABCA1发挥作用。所有研究环节（假设生成、实验设计、数据分析和图表制作）均由Robin自主完成，首次实现了"实验室闭环"框架下AI自主发现并验证新疗法的突破，为AI驱动科研建立了新范式。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T17:01:25Z
- **目录日期**: 2025-05-20
