...
研究人员开发了首个能全流程自动化科学发现的多智能体系统Robin。该系统整合文献搜索与数据分析功能，可自主生成假设、设计实验、解读结果并更新假设，实现了半自主的科研闭环。应用该系统，研究者发现治疗干性年龄相关性黄斑变性(dAMD)的新疗法：Robin提出增强视网膜色素上皮细胞吞噬作用，并验证了临床药物Ripasudil(ROCK抑制剂)的疗效。后续RNA测序实验揭示了ABCA1基因的关键作用。所有假设、实验设计和数据分析均由Robin自主完成，开创了AI驱动科研的新范式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T04:02:18Z
- **目录日期**: 2025-05-20
