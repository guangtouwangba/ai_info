...
研究人员开发了首个全自动科学发现多智能体系统Robin，该系统能够自主完成文献检索、假设生成、实验设计和数据分析等完整科研流程。应用该系统，研究人员发现了一种治疗干性年龄相关性黄斑变性(dAMD)的新疗法。Robin提出通过增强视网膜色素上皮细胞的吞噬作用作为治疗策略，并鉴定出临床使用的Rho激酶抑制剂Ripasudil作为潜在治疗药物。后续RNA测序实验揭示了该药物通过上调ABCA1基因发挥作用的机制。所有假设、实验方案和数据分析均由Robin自主完成，这标志着人工智能首次在闭环实验框架中自主发现并验证新疗法，开创了AI驱动科研的新范式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T03:19:19Z
- **目录日期**: 2025-05-20
