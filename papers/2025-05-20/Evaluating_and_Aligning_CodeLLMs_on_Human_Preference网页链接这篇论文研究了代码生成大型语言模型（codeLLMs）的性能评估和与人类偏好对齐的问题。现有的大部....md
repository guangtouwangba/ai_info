...
这篇论文针对代码生成大模型(codeLLMs)提出两个创新：1)构建CodeArena基准，包含397个真实编程任务样本(40类/44种语言)，首次关注代码质量与人类偏好的对齐；2)创建20B标记的SynCode-Instruct合成指令集验证微调效果。实验发现：1)传统执行测试与人类偏好评估存在显著差异；2)开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)在人类偏好对齐方面差距明显。研究强调代码生成模型需超越正确性，更应关注实用性和开发者体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T03:23:54Z
- **目录日期**: 2025-05-20
