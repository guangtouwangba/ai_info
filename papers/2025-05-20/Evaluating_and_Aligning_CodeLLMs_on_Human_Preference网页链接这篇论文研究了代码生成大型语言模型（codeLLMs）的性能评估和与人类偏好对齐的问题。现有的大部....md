...
该论文针对代码生成大模型(codeLLMs)提出创新评估方法，指出当前基准测试过于关注代码正确性而忽视人类偏好。研究者构建了CodeArena基准(包含397个高质量样本，覆盖40类编程任务和44种语言)和SynCode-Instruct语料库(近200亿标记)，通过实验发现执行基准与人类偏好存在差异。在测试40多个模型后发现，开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，凸显了模型与人类偏好对齐的重要性。研究成果为提升代码生成模型的实用价值提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T04:07:02Z
- **目录日期**: 2025-05-20
