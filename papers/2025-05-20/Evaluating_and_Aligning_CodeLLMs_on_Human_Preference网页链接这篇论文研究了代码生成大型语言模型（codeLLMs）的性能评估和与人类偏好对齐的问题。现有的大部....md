...
这篇论文聚焦代码生成大模型(codeLLMs)与人类偏好的对齐问题，指出当前基准测试过度关注代码正确性而忽视用户体验。研究者构建了CodeArena基准(含397个多语言样本)和SynCode-Instruct合成指令集(20B标记)，通过实验发现：1)执行基准与人类偏好存在性能差异；2)开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)差距显著。研究强调代码生成模型需同时兼顾功能正确性和人类偏好，为模型优化提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T11:06:14Z
- **目录日期**: 2025-05-20
