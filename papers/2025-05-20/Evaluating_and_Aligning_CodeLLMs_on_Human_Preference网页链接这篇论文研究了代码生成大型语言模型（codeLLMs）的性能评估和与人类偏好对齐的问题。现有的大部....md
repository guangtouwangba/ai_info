...
该论文针对代码生成大模型(codeLLMs)提出创新评估方法，指出当前基准测试过度关注代码正确性而忽视人类偏好匹配。研究者构建了CodeArena基准测试(含397个高质量样本，覆盖40类任务和44种语言)和SynCode-Instruct合成指令库(20B标记)，发现执行基准与人类偏好评估存在显著差异。实验对比40多个模型显示，开源顶级模型(如Qwen2.5-Coder)与专有模型(如OpenAI o1)性能差距明显，凸显了人类偏好对齐在代码生成领域的关键作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T21:05:48Z
- **目录日期**: 2025-05-20
