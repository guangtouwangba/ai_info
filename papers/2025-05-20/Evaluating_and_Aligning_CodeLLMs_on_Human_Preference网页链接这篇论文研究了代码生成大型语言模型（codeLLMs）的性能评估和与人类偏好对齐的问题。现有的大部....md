...
该论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，通过397个涵盖40类编程任务和44种语言的真实样本评估模型与人类偏好的匹配度。研究发现传统基于执行的测试与人类偏好存在差距，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI)性能差异显著。同时构建了20B标记的合成指令数据集SynCode-Instruct验证微调效果，强调对齐人类偏好的重要性。研究揭示了当前代码生成模型评估体系的局限性，为提升模型实用性提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T17:05:31Z
- **目录日期**: 2025-05-20
