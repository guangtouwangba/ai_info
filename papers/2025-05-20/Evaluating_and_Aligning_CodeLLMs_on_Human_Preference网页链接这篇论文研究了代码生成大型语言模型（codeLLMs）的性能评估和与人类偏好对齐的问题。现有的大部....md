...
这篇论文针对代码生成大模型(codeLLMs)与人类偏好对齐问题，提出了CodeArena基准测试和SynCode-Instruct指令集。CodeArena包含397个高质量编程任务样本，覆盖40类任务和44种语言，更贴近实际开发需求。研究通过40多个模型的对比实验发现：1)传统执行测试与人类偏好存在差异；2)开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。同时验证了大规模合成指令微调的有效性(SynCode-Instruct含20B标记)，强调了对齐人类偏好在代码生成领域的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T23:05:33Z
- **目录日期**: 2025-05-20
