...
研究人员提出了一种名为XOXO的新型攻击方法——跨源上下文投毒攻击，通过语义等效的恶意代码修改来操纵AI编程助手，使其生成包含漏洞或错误的代码。这种攻击利用自动收集的上下文信息，难以被传统程序分析技术检测。研究团队开发了任务无关的黑盒攻击算法GCGS，在包括GPT-4.1和Claude 3.5 Sonnet v2等11个模型中平均攻击成功率达75.72%。现有防御措施如对抗性微调对此类攻击无效，凸显了基于LLM的编程工具需要新的安全防护机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T04:03:24Z
- **目录日期**: 2025-05-20
