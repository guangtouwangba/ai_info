...
AI编程助手在代码生成等任务中广泛应用，但其自动收集上下文（如跨文件、项目或贡献者）的特性引入了新的安全风险。研究者提出名为XOXO的跨源上下文投毒攻击，通过语义等效的恶意代码修改（传统分析难以检测）操纵AI生成错误输出，并将责任转嫁给开发者。新型黑盒攻击算法GCGS利用凯莱图系统搜索变换空间，在GPT-4.1、Claude 3.5等11个模型上平均达到75.72%攻击成功率。现有防御措施（如对抗性微调）对此无效，凸显AI编程工具亟需新的安全防护机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T02:31:46Z
- **目录日期**: 2025-05-20
