...
研究人员提出了一种新型攻击方法XOXO（跨源上下文投毒），能够通过语义等效的恶意代码修改来毒化AI编程助手的上下文输入，从而操纵其输出错误代码。该攻击利用Cayley图系统搜索变换空间（GCGS算法），在包括GPT-4.1和Claude 3.5等11个主流模型上平均成功率高达75.72%。由于修改后的代码语义正确，传统程序分析技术难以检测。研究显示现有防御措施（如对抗性微调）对此攻击无效，凸显了AI编程工具亟需新的安全防护机制。这种攻击可能将责任转嫁给受害开发者，具有严重安全隐患。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T19:02:23Z
- **目录日期**: 2025-05-20
