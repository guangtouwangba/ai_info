...
AI编程助手广泛用于代码生成等任务，但其自动收集的跨文件/项目上下文可能被恶意攻击者利用。研究提出新型攻击方法XOXO，通过语义保留的代码修改（难以被传统分析检测）毒化输入，导致助手生成错误代码（成功率75.72%），还能将责任转嫁给开发者。攻击算法GCGS利用凯莱图系统搜索变换空间，在包括GPT-4.1和Claude 3.5等11个模型中均有效。现有防御措施（如对抗微调）对此攻击无效，凸显了AI编程工具亟需新的安全防护机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T16:02:34Z
- **目录日期**: 2025-05-20
