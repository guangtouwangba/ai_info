...
研究人员提出了一种新型攻击方法XOXO（跨源上下文投毒），通过语义等效的对抗性代码修改来毒化AI编程助手的上下文输入，从而操控其输出。这种攻击难以检测，因为代码语义保持正确。研究团队开发了任务无关的黑盒攻击算法GCGS，利用凯莱图系统搜索变换空间，在包括GPT-4.1和Claude 3.5 Sonnet v2等11个模型上平均攻击成功率达75.72%。传统防御方法如对抗性微调对此攻击无效，凸显了AI编程工具需要新的安全防护措施。该攻击可能导致生成易受攻击的代码或引入关键错误。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T14:02:36Z
- **目录日期**: 2025-05-20
