...
研究人员提出了一种新型攻击方法XOXO（跨源上下文投毒），通过语义保留的代码修改来毒化AI编程助手的上下文输入，从而诱导其生成错误或漏洞代码。该攻击采用基于凯莱图的GCGS黑盒算法，平均攻击成功率高达75.72%，影响包括GPT-4.1和Claude 3.5在内的11个主流模型。由于修改保持代码语义正确，传统程序分析难以检测，且现有防御措施（如对抗性微调）效果有限，凸显了AI编程工具亟需新的安全防护机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T17:02:19Z
- **目录日期**: 2025-05-20
