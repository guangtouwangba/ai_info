...
研究人员提出了一种新型攻击方法XOXO（跨源上下文投毒），通过语义等效的对抗性代码修改来毒化AI编程助手的上下文输入，从而操纵其输出错误代码。该攻击利用Cayley图系统搜索变换空间（GCGS算法），在11个主流模型（包括GPT-4.1和Claude 3.5）上平均成功率高达75.72%。由于修改保持代码语义正确，传统分析方法难以检测，还能将责任转嫁给开发者。现有防御措施（如对抗性微调）对此攻击无效，凸显了AI编程工具亟需新的安全防护机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T13:12:09Z
- **目录日期**: 2025-05-20
