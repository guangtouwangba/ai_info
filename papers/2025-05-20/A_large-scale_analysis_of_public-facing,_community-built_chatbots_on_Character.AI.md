...
这篇论文首次对Character.AI平台上的公共聊天机器人进行了大规模分析。Character.AI是一个快速发展的社交媒体平台，用户可创建并互动AI聊天机器人，通常基于虚构或公众人物。该平台月活用户超2000万，但因青少年参与问题引发关注。研究分析了210万条英文提示数据，来自约100万用户，探讨了平台上不同粉丝圈的流行度、跨圈层的共同主题，以及权力动态与性别的关系。研究揭示了一种新兴的在线准社交互动形式，展现了生成式AI与用户生成内容的独特交叉点。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T23:01:51Z
- **目录日期**: 2025-05-20
