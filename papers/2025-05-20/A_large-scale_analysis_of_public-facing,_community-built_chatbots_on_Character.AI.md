...
这篇论文首次对Character.AI平台上的公共聊天机器人进行了大规模分析。该平台结合生成式AI与用户生成内容，允许用户创建虚拟角色供他人互动，月活用户超2000万。研究基于210万条英文提示数据（来自约100万用户），分析了平台上不同粉丝圈的流行度、跨圈层的常见主题，以及权力动态与性别的关系。研究发现揭示了生成式AI与用户生成内容交汇处的新型在线准社交互动形式，尤其关注该平台对青少年用户的显著影响。研究兼具实质性与概念性价值，为理解AI社交平台的独特生态提供了重要见解。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T21:01:55Z
- **目录日期**: 2025-05-20
