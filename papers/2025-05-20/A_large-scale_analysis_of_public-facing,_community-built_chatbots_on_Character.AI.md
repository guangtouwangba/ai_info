...
这篇论文首次对Character.AI平台上的公共聊天机器人进行了大规模分析。该平台结合生成式AI和用户生成内容，允许用户创建基于虚构或公众人物的聊天机器人，月活跃用户超2000万。研究分析了210万条英文提示数据（来自约100万用户），探讨了平台上不同粉丝圈的流行程度、跨粉丝圈的常见主题，以及权力动态与性别的关系。研究发现揭示了生成式AI与用户生成内容结合催生的新型在线准社交互动形式，凸显了该平台在青少年参与等方面的重要社会影响。研究兼具实质性和概念性意义。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T22:01:48Z
- **目录日期**: 2025-05-20
