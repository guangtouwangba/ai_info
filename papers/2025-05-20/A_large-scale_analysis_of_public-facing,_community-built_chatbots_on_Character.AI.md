...
这篇论文首次对快速增长的社交平台Character.AI上的公共聊天机器人进行了大规模分析。该平台结合生成式AI和用户生成内容，允许用户创建角色机器人（常基于虚构或公众人物）供他人互动。研究基于210万条英文提示（来自约100万用户），分析了平台上不同粉丝圈的流行度、跨粉丝圈的常见主题，以及权力动态与性别的关系。研究发现该平台展现了一种独特的在线准社交互动形式，处于生成式AI与用户生成内容的重要交叉点。平台月活用户超2000万，但近期也暴露出青少年参与的严重问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T05:01:46Z
- **目录日期**: 2025-05-20
