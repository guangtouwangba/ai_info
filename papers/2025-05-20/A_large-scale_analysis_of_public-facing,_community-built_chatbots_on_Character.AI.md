...
这篇论文首次对Character.AI平台上的公共聊天机器人进行了大规模分析。Character.AI是一个结合生成式AI与用户生成内容的社交媒体平台，用户可创建基于虚构或公众人物的聊天机器人供他人互动。该平台拥有超2000万月活用户，但青少年参与问题引发关注。研究基于100万用户创建的210万条英文提示数据，分析了平台上不同粉丝圈的流行度、跨圈层的常见主题，以及权力动态与性别的关联。研究揭示了一种介于生成式AI与用户生成内容之间的新型在线准社交互动模式，具有重要的社会与概念研究价值。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T14:02:02Z
- **目录日期**: 2025-05-20
