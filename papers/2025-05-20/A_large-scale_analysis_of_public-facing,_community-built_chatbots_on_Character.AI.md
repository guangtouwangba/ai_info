...
这篇论文首次对Character.AI平台上的公共聊天机器人进行了大规模分析。Character.AI是一个快速发展的社交媒体平台，用户可创建并互动AI聊天机器人，通常基于虚构或公众人物。该平台月活用户超2000万，尤其吸引年轻群体。研究基于210万条英文提示数据，分析了平台上不同粉丝圈的流行度、跨圈层的共性主题，以及权力动态与性别的关系。研究揭示了生成式AI与用户生成内容相结合的新型在线准社交互动形式，展现了这一新兴平台在社交与AI交叉领域的重要影响。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T11:01:58Z
- **目录日期**: 2025-05-20
