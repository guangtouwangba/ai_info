...
这篇论文首次对快速增长的社交平台Character.AI上的公共聊天机器人进行了大规模分析。该平台结合生成式AI和用户生成内容，允许用户创建角色机器人（常基于虚构或公众人物）供他人互动，月活用户超2000万。研究基于100万用户创建的210万条英文聊天提示，分析了平台上不同粉丝圈的流行度、跨圈层的常见主题，以及权力动态与性别的关联。研究发现揭示了一种新兴的在线（准）社交互动形式，展现了生成式AI与用户生成内容融合的独特价值，尤其在青少年参与方面具有重要社会影响。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T03:19:51Z
- **目录日期**: 2025-05-20
