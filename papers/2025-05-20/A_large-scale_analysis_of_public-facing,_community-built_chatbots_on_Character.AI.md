...
这篇论文首次对Character.AI平台上公开的聊天机器人进行了大规模分析。Character.AI是一个快速增长的社交媒体平台，用户可创建并与AI角色互动。该平台结合生成式AI和用户生成内容，允许用户打造基于虚构或公众形象的聊天机器人。研究基于210万条英文提示数据（来自约100万用户），分析了平台上不同粉丝圈的流行度、跨圈层的共性主题，以及权力动态与性别的关系。研究发现这种新型在线准社交互动形式，展现了生成式AI与用户生成内容融合的独特价值。平台月活用户超2000万，尤其对年轻群体影响显著。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T09:02:10Z
- **目录日期**: 2025-05-20
