...
这篇论文首次对Character.AI平台上的公共聊天机器人进行了大规模分析。Character.AI是一个快速增长的社交媒体平台，用户可创建并互动AI聊天机器人，通常基于虚构或公众人物。该平台结合生成式AI与用户生成内容，月活用户超2000万，但也存在青少年参与问题。研究分析了210万条英文提示（来自约100万用户），探讨了平台上不同粉丝圈的流行度、跨粉丝圈的常见主题，以及权力动态与性别的关联。研究揭示了生成式AI与用户生成内容交叉的新型在线（准）社交互动形式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T13:11:34Z
- **目录日期**: 2025-05-20
