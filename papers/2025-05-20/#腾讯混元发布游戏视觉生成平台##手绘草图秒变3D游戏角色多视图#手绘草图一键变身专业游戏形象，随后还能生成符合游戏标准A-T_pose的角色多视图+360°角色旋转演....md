...
腾讯混元发布游戏视觉生成平台，推出工业级AIGC大模型Hunyuan-Game。该平台可将手绘草图一键转换为专业3D游戏角色，并自动生成多视图和360°旋转演示视频，实现游戏资产生成的一站式AI解决方案。这标志着腾讯将AI技术深度应用于游戏美术设计领域。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T16:04:09Z
- **目录日期**: 2025-05-20
