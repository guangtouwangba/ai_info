...
腾讯混元发布游戏视觉生成平台，推出工业级AIGC游戏资产生成大模型Hunyuan-Game。该平台可将手绘草图一键转换为专业3D游戏角色，并自动生成标准A/T姿势多视图及360°旋转演示视频，实现游戏美术设计的智能化生产。该技术显著提升游戏内容生产效率，是腾讯在AI游戏开发领域的重要布局。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T15:04:06Z
- **目录日期**: 2025-05-20
