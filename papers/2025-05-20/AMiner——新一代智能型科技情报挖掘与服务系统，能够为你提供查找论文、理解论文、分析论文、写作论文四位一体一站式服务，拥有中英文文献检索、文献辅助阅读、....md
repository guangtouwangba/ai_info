...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译、科研订阅等一站式服务。它支持中英文文献搜索，能自动生成摘要和问答互动，帮助用户快速理解论文内容。平台还具备AI辅助阅读功能，可上传PDF或从文献库选取论文进行分析。用户可定制科研情报订阅，跟踪最新学术动态。AMiner覆盖42个学科，包含3.5亿论文、0.6亿学者等丰富数据，并提供学者画像、学术会议等特色功能，免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T12:06:11Z
- **目录日期**: 2025-05-20
