...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译、分析等一站式科研服务。其核心功能包括：1）中英文文献检索，支持互动问答和自动摘要生成；2）英文文献翻译与智能解析，可上传PDF获取章节概要和问题建议；3）个性化科研订阅，按用户偏好推送最新论文动态。平台覆盖42个学科，包含3.5亿论文、0.6亿学者等海量数据，并提供学者画像、学术会议等特色功能。基础服务免费开放，旨在提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T07:05:47Z
- **目录日期**: 2025-05-20
