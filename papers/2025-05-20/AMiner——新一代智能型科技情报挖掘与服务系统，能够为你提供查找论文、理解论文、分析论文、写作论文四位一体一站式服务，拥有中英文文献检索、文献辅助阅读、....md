...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析和写作一站式服务。它支持中英文文献搜索，拥有3.5亿论文、0.6亿学者等海量数据，并能通过AI生成摘要和问答辅助理解。用户可上传PDF或从库中选取文献，获取章节概要和问题建议。平台还提供科研动态订阅服务，按用户偏好推送最新学术资讯。此外，AMiner包含学者画像、学术会议等特色功能，基础服务免费开放。访问入口：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T23:05:24Z
- **目录日期**: 2025-05-20
