...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、翻译、辅助阅读和分析。其核心功能包括：1）高效检索3.5亿论文、1.5亿专利等资源，支持智能问答和自动摘要生成；2）AI辅助阅读，可上传PDF或从库中选择文献，快速生成摘要和章节概要；3）定制化科研情报订阅，通过微信或邮件推送最新学术动态。平台还提供学者画像、学术会议追踪等功能，基础服务免费使用，旨在提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T20:05:24Z
- **目录日期**: 2025-05-20
