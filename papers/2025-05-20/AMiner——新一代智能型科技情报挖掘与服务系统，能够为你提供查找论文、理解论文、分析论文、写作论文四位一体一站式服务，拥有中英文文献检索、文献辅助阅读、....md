...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析与写作的一站式服务。它支持中英文文献搜索、AI辅助阅读、自动摘要生成、翻译及问答功能，涵盖3.5亿论文、0.6亿学者等海量数据。用户可订阅个性化科研动态，通过微信或邮件接收最新成果。平台还提供学者画像、学术会议追踪等功能，基础服务免费开放。核心优势包括高效文献筛选、交互式问答、文档智能解析及跨语言支持，显著提升科研效率。访问链接：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T17:05:23Z
- **目录日期**: 2025-05-20
