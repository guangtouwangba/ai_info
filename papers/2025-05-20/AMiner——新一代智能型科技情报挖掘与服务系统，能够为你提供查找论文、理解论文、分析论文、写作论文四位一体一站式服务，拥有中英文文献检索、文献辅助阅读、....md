...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译、分析及写作等一站式服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持中英文文献搜索、AI生成摘要、互动问答和文档翻译。用户可订阅个性化科研动态，追踪学者、机构及关键词。平台还提供学者画像、学术会议和论文排行榜等功能，大部分服务可免费使用。访问入口：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T18:05:16Z
- **目录日期**: 2025-05-20
