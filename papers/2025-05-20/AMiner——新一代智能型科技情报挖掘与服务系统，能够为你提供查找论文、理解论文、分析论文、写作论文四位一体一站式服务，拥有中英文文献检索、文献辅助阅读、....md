...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、科研情报订阅等一站式服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持文献辅助阅读、AI摘要生成和智能问答功能。用户可通过关键词订阅最新科研动态，还能使用学者画像、学术会议等特色功能。平台提供网页版和AI交互界面，部分功能免费开放。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T13:15:36Z
- **目录日期**: 2025-05-20
