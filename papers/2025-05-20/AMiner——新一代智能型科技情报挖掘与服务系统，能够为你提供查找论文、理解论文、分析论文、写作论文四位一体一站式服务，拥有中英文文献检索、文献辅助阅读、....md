...
AMiner是一款智能科技情报挖掘系统，提供一站式科研服务，包括中英文文献检索、翻译、辅助阅读和写作支持。其数据库涵盖42个学科、3.5亿论文、0.6亿学者和1.5亿专利。核心功能包括：1）智能文献检索与自动摘要生成；2）AI辅助阅读和问答互动；3）个性化科研情报订阅服务。用户可通过微信或邮件获取定制化学术动态。平台还提供学者画像、学术会议追踪等特色功能，基础服务免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T10:13:19Z
- **目录日期**: 2025-05-20
