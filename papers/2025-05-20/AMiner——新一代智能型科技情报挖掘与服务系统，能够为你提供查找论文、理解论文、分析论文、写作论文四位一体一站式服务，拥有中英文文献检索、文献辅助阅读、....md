...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、科研情报订阅等一站式服务。它能高效定位相关文献，通过AI生成摘要和问答辅助理解，支持PDF上传和交互式阅读。平台还允许用户定制订阅最新科研动态，覆盖42个学科、3.5亿论文和1.5亿专利。此外，AMiner提供学者画像、学术会议和论文排行榜等功能，基础服务免费使用。访问入口：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T11:06:02Z
- **目录日期**: 2025-05-20
