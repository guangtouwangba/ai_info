...
Zod是一个流行的TypeScript数据验证库，近日发布了重大更新版本Zod4。新版本修复了Zod3长期存在的多项设计局限，主要改进包括：对象解析速度提升7倍，TypeScript实例化次数减少100倍，新增强类型元数据系统，原生支持JSON Schema转换，以及多语言错误信息API。同时推出了轻量级版本Zod Mini，核心包体积减小6.6倍，适合对包体积敏感的场景。Zod4解决了GitHub上投票最高的10个开放问题中的9个，显著提升了性能和功能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T20:03:29Z
- **目录日期**: 2025-05-20
