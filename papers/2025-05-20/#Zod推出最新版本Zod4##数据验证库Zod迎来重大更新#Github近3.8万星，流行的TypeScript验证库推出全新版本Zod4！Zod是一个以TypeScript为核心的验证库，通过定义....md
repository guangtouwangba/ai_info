...
Zod 4是TypeScript数据验证库的重大更新版本，修复了Zod 3的多个设计局限。主要改进包括：对象解析速度提升7倍，TypeScript实例化次数减少100倍，新增强类型元数据系统，原生支持JSON Schema转换，以及多语言错误信息API。同时推出轻量级Zod Mini版本，核心包体积减少6.6倍，功能相同但采用函数式设计。该库在GitHub已获3.8万星，此次更新解决了投票最高的10个问题中的9个。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T15:03:58Z
- **目录日期**: 2025-05-20
