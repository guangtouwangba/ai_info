...
这项研究在大型本科STEM课程中测试了一个结合AI反馈和教材引用的模拟考试系统。系统要求学生解释答案并评估自信度，使用GPT-4生成个性化反馈并推荐教材章节。通过分析28,313次答题记录及学生反馈发现：强制自信度评估和解释要求对实际考试策略影响最大（82.1%学生表示提升了信心）；40%学生查看了推荐的教材内容（远高于传统阅读率）；反馈形式对成绩无显著差异。调查显示学生满意度较高（平均4.1/5分），73.4%能回忆应用相关概念。研究表明结构化反思要求可能比复杂反馈机制更有效。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T09:01:51Z
- **目录日期**: 2025-05-20
