...
这项研究评估了一个在大型生物学课程中整合AI生成反馈与教材引用的模拟考试系统。系统要求学生解释答案并评估自信度，利用GPT-4o生成个性化反馈并推荐教材章节。通过对三场期中考试共28,313次答题记录、279份问卷和23次访谈的分析发现，各类反馈形式对成绩无显著差异，但强制自信度评估和解释要求对学生实际考试策略产生了积极影响。约40%学生查看了推荐教材（远高于传统阅读率），82.1%表示增强了信心。研究表明，结构化反思要求可能比复杂反馈机制更具教学价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T21:01:34Z
- **目录日期**: 2025-05-20
