...
这项研究评估了一个整合AI反馈与教材引用的在线模考系统在大型生物学课程中的应用。系统要求学生解释答案并评估自信度，利用GPT-4生成个性化反馈并推荐教材章节。分析28,313次答题记录和302份反馈发现：各类反馈形式对成绩无显著差异，但强制自信度评估和解释要求显著影响了考试策略；约40%学生查看了推荐教材（远高于传统阅读率）；82.1%的学生表示增强了信心，73.4%能更好应用概念。研究表明，结构化反思要求比复杂反馈机制更具教学价值，系统获得4.1/5的高满意度评分。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T10:08:47Z
- **目录日期**: 2025-05-20
