...
这项研究在大型本科STEM课程中测试了一个结合AI生成反馈与教材引用的模拟考试系统。系统要求学生解释答案并评估自信度，利用GPT-4o生成个性化反馈并推荐教材章节。通过3次期中考试共1296名学生产生的28,313次互动数据，以及279份问卷和23次访谈发现：强制自信度评估和解释要求对学生实际考试策略影响最大（82.1%学生表示提升了信心），40%学生查看了推荐的教材内容（远高于传统阅读率）。虽然不同反馈类型对成绩无显著影响，但结构化反思要求比复杂反馈机制更具教学价值，系统满意度达4.1/5分。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T03:19:30Z
- **目录日期**: 2025-05-20
