...
这项研究在大型生物学课程中测试了一个结合AI反馈与教材引用的模拟考试系统。系统要求学生解释答案并评估自信度，使用GPT-4生成个性化反馈并推荐教材章节。分析28,313次答题记录和数百份调研发现：不同反馈类型对成绩无显著差异，但强制自信度评估和解释要求对学生实际考试策略最有帮助；约40%学生查看了推荐的教材内容（远高于传统阅读率）。82.1%的学生表示增强了信心，73.4%能更好应用知识点。研究表明，结构化反思要求可能比复杂反馈机制更具教学价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T02:30:55Z
- **目录日期**: 2025-05-20
