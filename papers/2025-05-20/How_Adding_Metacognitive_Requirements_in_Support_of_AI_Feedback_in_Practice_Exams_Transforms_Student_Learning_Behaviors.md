...
这项研究在大学生物课程中测试了一个结合AI反馈和教材引用的模拟考试系统。系统要求学生解释答案并评估自信度，GPT-4o据此生成个性化反馈。分析28,313次答题记录和302份反馈发现：强制自信度评分和解释要求对学生实际考试策略影响最大；约40%学生查看了教材引用（远高于传统阅读率）；82.1%学生表示对练习内容更有信心。研究表明，结构化反思要求可能比复杂反馈机制更有效，尽管不同反馈类型对成绩无显著差异。系统获得较高满意度（平均4.1/5分）。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T06:01:32Z
- **目录日期**: 2025-05-20
