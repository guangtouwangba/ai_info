...
这项研究在大型生物学课程中测试了一个结合AI反馈与教材引用的模拟考试系统。系统要求学生解释答案并评估自信度，GPT-4o据此生成个性化反馈并推荐教材章节。分析28,313次答题记录及数百份问卷发现：不同反馈类型对成绩无显著影响，但强制自信度评估和解释要求显著影响了实际考试策略；40%学生查看了推荐教材（远高于常规阅读率）。82.1%学生表示对练习内容更有信心，73.4%能回忆应用相关概念。研究表明，结构化反思要求可能比复杂反馈机制更具教学价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T19:01:29Z
- **目录日期**: 2025-05-20
