...
这项研究在大型STEM本科课程中测试了一个结合AI反馈与教材引用的模拟考试系统。系统要求学生解释答案并评估自信度，利用GPT-4生成个性化反馈并推荐教材章节。通过分析28,313次互动数据（涉及1,296名学生）及302份反馈发现：强制自信度评估和解释要求对学生实际考试策略影响最大（82.1%学生表示提升了信心）；40%学生主动查阅推荐教材（远高于传统阅读率）；反馈形式差异对成绩无显著影响。研究表明，结构化反思要求可能比复杂反馈机制更具教学价值，系统总体满意度达4.1/5分。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T11:01:39Z
- **目录日期**: 2025-05-20
