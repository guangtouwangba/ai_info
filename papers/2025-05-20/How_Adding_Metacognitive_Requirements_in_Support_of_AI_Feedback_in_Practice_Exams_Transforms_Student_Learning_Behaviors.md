...
这项研究在大型生物学课程中测试了一个结合AI反馈与教材引用的模拟考试系统。系统要求学生解释答案并评估自信度，GPT-4o据此生成个性化反馈并推荐教材章节。分析28,313次答题记录及数百份问卷发现：强制自信度评估和解释要求对实际考试策略影响最大（82.1%学生表示提升了信心）；40%学生参考了教材推荐（远高于传统阅读率）；不同反馈类型对成绩无显著差异。73.4%学生能回忆应用相关概念，满意度达4.1/5分。研究表明，结构化反思比复杂反馈机制更具教学价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T17:01:34Z
- **目录日期**: 2025-05-20
