...
这项研究在大型本科STEM课程中测试了一个结合AI反馈与教材引用的模拟考试系统。系统要求学生解释答案并评估自信度，利用GPT-4生成个性化反馈并推荐教材章节。通过对三场期中考试共1296名学生（28,313次答题）、279份问卷和23次访谈的分析发现：各类反馈形式对成绩无显著差异，但强制性的自信度评估和解释要求对学生实际考试策略产生积极影响；约40%学生查看了推荐的教材内容（远高于传统阅读率）；82.1%学生表示对练习内容更有信心。研究表明，结构化反思要求可能比复杂反馈机制更具影响力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T07:01:32Z
- **目录日期**: 2025-05-20
