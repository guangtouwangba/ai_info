...
这项研究评估了一个结合AI生成反馈与教材引用的在线练习系统在大型生物学课程中的应用。系统要求学生解释答案并评估自信度，利用GPT-4生成个性化反馈并推荐教材章节。通过分析28,313次互动数据及302份反馈发现：强制自信度评估和解释要求对学生实际考试策略影响最大（82.1%学生表示提升了信心）；约40%学生查看了推荐的教材内容，远高于传统阅读率；不同反馈类型对成绩无显著差异。结果表明，结构化反思要求可能比精细的反馈机制更具教学价值，系统总体满意度达4.1/5分。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-20T23:01:32Z
- **目录日期**: 2025-05-20
