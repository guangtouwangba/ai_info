...
360人工智能研究院开源了FG-CLIP模型，突破性解决了传统CLIP模型的"视觉近视"问题。该模型通过"长文本深度理解"和"细粒度视觉比对"技术，能精准识别图像局部细节（如成功定位画面右侧的浅棕色木凳），而其他主流模型则错误聚焦于全局特征。实验显示，FG-CLIP在12项下游任务中表现显著优于现有模型，尤其在细粒度理解和长文本检索方面。模型及数据已全面开源，推动了AI视觉理解技术的进步。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T10:02:37Z
- **目录日期**: 2025-04-29
