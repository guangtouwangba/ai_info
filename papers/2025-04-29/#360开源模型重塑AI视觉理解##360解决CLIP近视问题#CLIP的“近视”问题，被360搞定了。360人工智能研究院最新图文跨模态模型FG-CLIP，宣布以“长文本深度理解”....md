...
360人工智能研究院开源了新型跨模态模型FG-CLIP，通过"长文本深度理解"和"细粒度视觉比对"两大创新，成功解决了传统CLIP模型的"视觉近视"问题。实验表明，FG-CLIP能精准识别图像局部细节（如正确识别隐藏的木凳），在12个下游任务中表现显著优于CLIP等现有模型。该技术突破了全局图像与文本嵌入的局限，实现了细粒度特征对齐，在开放词汇检测、长短文本检索等任务上取得突破。模型及相关数据已全面开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T15:03:16Z
- **目录日期**: 2025-04-29
