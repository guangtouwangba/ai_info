...
360人工智能研究院开源了FG-CLIP跨模态模型，通过"长文本深度理解"和"细粒度视觉比对"技术，解决了传统CLIP模型的"视觉近视"问题。实验表明，FG-CLIP能精准识别图像局部细节（如正确识别画面边缘的木凳），在12个下游任务中表现优于CLIP等现有模型，尤其在长文本理解和细粒度比对方面实现突破。该模型已全面开源，可应用于开放词汇检测、图文检索等多模态任务。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T22:02:56Z
- **目录日期**: 2025-04-29
