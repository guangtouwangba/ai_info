...
360人工智能研究院推出开源跨模态模型FG-CLIP，通过"长文本深度理解"和"细粒度视觉比对"技术，解决了传统CLIP模型的"视觉近视"问题。实验显示，FG-CLIP能精准识别图像局部细节（如正确定位隐藏的木凳），在12项下游任务中表现优于CLIP等现有模型，尤其在长文本理解和细粒度比对方面实现突破。该模型已全面开源，适用于开放词汇检测、图文检索等多模态任务，显著提升了AI的视觉理解能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T13:13:09Z
- **目录日期**: 2025-04-29
