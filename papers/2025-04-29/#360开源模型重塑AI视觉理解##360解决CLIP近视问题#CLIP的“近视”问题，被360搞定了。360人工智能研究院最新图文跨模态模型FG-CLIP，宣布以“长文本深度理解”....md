...
360人工智能研究院发布开源跨模态模型FG-CLIP，突破性解决了传统CLIP模型的"视觉近视"问题。该模型通过"长文本深度理解"和"细粒度视觉比对"技术，实现了对图像局部细节的精准识别。测试显示，FG-CLIP能正确识别图中隐藏的木凳细节，而CLIP等现有模型则错误聚焦全局特征。在12个下游任务中，FG-CLIP在细粒度理解、对象检测等任务表现显著优于现有方法。模型代码及相关数据已全面开源，推动AI视觉理解向更精准方向发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T21:03:18Z
- **目录日期**: 2025-04-29
