...
360人工智能研究院开源了FG-CLIP模型，通过"长文本深度理解"和"细粒度视觉比对"两大突破，解决了传统CLIP模型的"视觉近视"问题。该模型能精准识别图像局部细节，在12个下游任务中表现优于现有模型。实验显示，FG-CLIP在细粒度理解、开放词汇检测等任务上显著领先，特别是在长文本和细粒度比对方面实现大幅提升。相比CLIP等模型错误识别全局特征，FG-CLIP能准确捕捉局部细节。模型及相关数据已全面开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T23:02:42Z
- **目录日期**: 2025-04-29
