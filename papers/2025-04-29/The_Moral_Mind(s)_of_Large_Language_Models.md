...
该研究探讨了大型语言模型（LLM）是否具有一致的道德偏好结构。通过揭示性偏好理论工具测试近40个主流LLM，发现每个主要提供商的至少一个模型表现出稳定的道德偏好，其决策行为符合潜在的效用函数。多数模型倾向于中立道德立场，但不同模型间存在显著差异：部分模型能灵活切换伦理视角，而另一些则坚持更刚性的道德框架。研究揭示了LLMs道德推理的共同核心，同时量化了其伦理多样性，为评估AI系统的道德一致性和伦理对齐提供了新框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T00:03:08Z
- **目录日期**: 2025-04-29
