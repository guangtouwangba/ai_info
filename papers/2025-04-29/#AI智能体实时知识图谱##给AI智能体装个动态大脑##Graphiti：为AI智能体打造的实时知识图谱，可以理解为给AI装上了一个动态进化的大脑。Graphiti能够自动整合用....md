...
Graphiti是由Zep团队开发的实时知识图谱系统，旨在为AI智能体构建动态进化的大脑。它能实时整合对话、企业数据和外部信息，支持秒级同步和精确时间记录，相比RAG具有四大优势：实时增量更新、双时间线追踪、混合检索和灵活扩展关系。该系统可应用于电商客服、金融分析和智能助手等领域，提升个性化推荐、市场追踪和决策准确性。该项目已在GitHub开源，获得7000+星标，拥有活跃社区和完善文档。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T23:03:20Z
- **目录日期**: 2025-04-29
