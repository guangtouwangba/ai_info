...
Graphiti是由Zep团队开发的实时知识图谱系统，为AI智能体提供动态知识管理能力。它能实时整合对话、企业数据和外部信息，支持秒级更新并精确记录时间戳，实现历史回溯。相比传统RAG技术，具有增量更新、双时间线追踪、混合检索和可扩展关系等优势。应用场景包括电商客服、金融分析和智能助手等领域，目前已开源并在GitHub获得7k+星标。该系统通过构建持续演化的关系网络，显著提升了AI处理动态信息的能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T19:03:24Z
- **目录日期**: 2025-04-29
