...
Graphiti是由Zep团队开发的实时知识图谱系统，为AI智能体提供动态知识管理能力。它能秒级整合对话、企业数据和外部信息，支持双时间线追踪（事件发生/接收时间）和混合检索（语义+关键词+图遍历）。相比传统RAG，具有实时增量更新、灵活扩展关系等优势，适用于电商客服、金融分析等场景。该项目已开源，获7k+ GitHub星标，社区活跃。核心突破在于使AI具备持续演化的知识处理能力，避免信息滞后。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T13:13:49Z
- **目录日期**: 2025-04-29
