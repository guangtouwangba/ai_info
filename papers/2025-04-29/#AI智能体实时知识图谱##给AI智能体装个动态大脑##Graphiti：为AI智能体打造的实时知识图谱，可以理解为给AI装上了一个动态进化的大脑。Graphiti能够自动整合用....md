...
Graphiti是由Zep团队开发的实时知识图谱系统，专为AI智能体设计，相当于为其安装动态进化的大脑。它能实时整合对话、企业数据和外部信息，支持秒级更新并精确记录时间戳，实现历史回溯。相比传统RAG技术，Graphiti具备实时增量更新、双时间线追踪、混合检索和灵活扩展关系等优势。该系统已开源，适用于电商客服、金融分析和智能助手等场景，能显著提升推荐精准度和决策效率。目前在GitHub获得7000+星标，拥有活跃社区和完善文档。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T15:03:58Z
- **目录日期**: 2025-04-29
