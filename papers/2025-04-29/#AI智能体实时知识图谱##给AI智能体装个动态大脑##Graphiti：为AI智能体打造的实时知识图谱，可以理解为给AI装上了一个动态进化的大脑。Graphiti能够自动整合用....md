...
Graphiti是一种为AI智能体设计的实时知识图谱系统，可视为动态进化的"AI大脑"。它能自动整合对话、企业数据和外部信息，构建持续演化的关系网络，支持秒级同步和精确时间记录。相比传统RAG技术，Graphiti具备实时增量更新、双时间线追踪、混合检索和灵活扩展关系等优势。该系统适用于电商客服、金融分析和智能助手等场景，能提升推荐效果、市场追踪和决策准确性。由Zep团队开发，已在GitHub开源并获7000+星标，文档完善且社区活跃。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T17:03:39Z
- **目录日期**: 2025-04-29
