# #AI智能体实时知识图谱##给AI智能体装个动态大脑##Graphiti：为AI智能体打造的实时知识图谱，可以理解为给AI装上了一个动态进化的大脑。Graphiti能够自动整合用...
...
Graphiti是由Zep团队开发的实时知识图谱系统，为AI智能体提供动态知识管理能力。它能实时整合对话、企业数据和外部信息，支持秒级更新和双时间线追踪（事件发生时间/接收时间）。相比传统RAG技术，具有增量更新、混合检索（语义+关键词+图遍历）和可扩展关系等优势，适用于电商客服、金融分析、智能助手等场景。该项目已在GitHub开源，获7k+星标，文档完善社区活跃。核心价值在于为AI系统构建持续进化的"动态大脑"，提升信息处理时效性和决策准确性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T10:03:18Z
- **目录日期**: 2025-04-29
