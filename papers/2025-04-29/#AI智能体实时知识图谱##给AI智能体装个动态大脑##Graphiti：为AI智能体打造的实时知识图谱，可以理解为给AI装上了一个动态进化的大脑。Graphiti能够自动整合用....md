...
Graphiti是一个为AI智能体设计的实时知识图谱系统，可动态整合对话、企业数据和外部信息，形成持续演化的关系网络。其核心优势包括秒级同步更新、双时间线追踪（事件发生/接收时间）、混合检索技术（语义+关键词+图遍历）和可扩展节点关系。相比传统RAG，它支持增量更新和精准历史回溯。应用场景涵盖电商客服（个性化推荐）、金融分析（市场追踪）和智能助手（实时决策）。该项目由Zep团队开发，已开源并在GitHub获得7000+星标，文档完善社区活跃。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T11:03:22Z
- **目录日期**: 2025-04-29
