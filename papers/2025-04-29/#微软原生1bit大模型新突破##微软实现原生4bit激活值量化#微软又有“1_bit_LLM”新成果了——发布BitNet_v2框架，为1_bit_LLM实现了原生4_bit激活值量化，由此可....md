...
微软推出BitNet v2框架，在1bit大模型基础上实现原生4bit激活值量化，可充分利用新一代GPU（如GB200）的4bit计算能力。相比此前BitNet b1.58（1.58bit权重+8bit激活），新框架通过H-BitLinear模块的Hadamard变换，将激活分布优化为接近高斯分布，减少异常值，成功实现4bit激活。这显著提升了计算效率并降低内存带宽需求，解决了此前计算环节的瓶颈问题。该技术进一步降低了LLM推理成本，为高效部署大模型提供了新方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T13:14:10Z
- **目录日期**: 2025-04-29
