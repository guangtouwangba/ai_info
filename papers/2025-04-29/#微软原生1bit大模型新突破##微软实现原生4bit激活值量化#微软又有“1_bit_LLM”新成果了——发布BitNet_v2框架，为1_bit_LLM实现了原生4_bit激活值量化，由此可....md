...
微软推出BitNet v2框架，在1bit大模型(BitNet b1.58)基础上实现原生4bit激活值量化。通过引入H-BitLinear模块，采用Hadamard变换将激活分布转化为更接近高斯分布，减少异常值，从而突破性地实现4bit激活。这一进展能充分利用新一代GPU(如GB200)的4bit计算能力，显著提升计算效率并降低内存带宽需求。相比此前8bit激活的BitNet b1.58，新框架解决了计算效率瓶颈问题，使1bit大模型能更好地发挥硬件性能优势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T17:03:59Z
- **目录日期**: 2025-04-29
