...
微软推出BitNet v2框架，实现了原生4bit激活值量化，使1bit大模型能充分利用新一代GPU（如GB200）的4bit计算能力。相比此前BitNet b1.58的8bit激活值，新框架通过H-BitLinear模块引入Hadamard变换，将尖锐的激活分布转化为接近高斯分布，减少异常值，显著提升计算效率并降低内存带宽需求。这一突破解决了此前计算环节的效率瓶颈，进一步优化了推理成本。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T19:03:41Z
- **目录日期**: 2025-04-29
