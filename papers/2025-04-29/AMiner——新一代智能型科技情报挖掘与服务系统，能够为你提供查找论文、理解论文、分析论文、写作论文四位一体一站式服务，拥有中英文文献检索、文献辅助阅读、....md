...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献搜索，拥有3.5亿论文、0.6亿学者等海量数据，并提供AI辅助阅读、自动摘要生成、互动问答和文献翻译功能。用户可订阅个性化科研动态，追踪特定学者或领域的最新研究。平台还包含学者画像、学术会议和论文排行榜等工具，基础功能免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T03:20:32Z
- **目录日期**: 2025-04-29
