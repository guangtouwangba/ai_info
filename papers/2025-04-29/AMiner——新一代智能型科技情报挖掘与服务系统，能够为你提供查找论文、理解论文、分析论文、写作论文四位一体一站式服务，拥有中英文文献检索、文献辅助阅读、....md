...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析及写作一站式服务。支持中英文文献检索、AI辅助阅读、自动摘要生成、文献翻译等功能，涵盖3.5亿论文、0.6亿学者等海量数据。其特色包括互动问答快速理解文献、个性化科研动态订阅（通过微信/邮件推送）、学者画像分析等。用户可上传PDF或直接调用平台文献，获取AI生成的摘要、章节概要和问题建议。基础功能免费开放，适用于高效学术研究。访问入口：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T09:05:47Z
- **目录日期**: 2025-04-29
