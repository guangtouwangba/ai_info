...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、翻译、科研情报订阅等。它收录了3.5亿论文、0.6亿学者和1.5亿专利，支持AI生成摘要、辅助阅读和互动问答。用户可订阅个性化科研动态，并通过微信或邮件接收最新资讯。平台还提供学者画像、学术会议和论文排行榜等功能，免费使用。网址：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T12:05:58Z
- **目录日期**: 2025-04-29
