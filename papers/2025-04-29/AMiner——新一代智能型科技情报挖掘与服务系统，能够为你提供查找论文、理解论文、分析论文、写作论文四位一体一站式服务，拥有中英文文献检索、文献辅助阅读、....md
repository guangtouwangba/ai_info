...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、辅助阅读、翻译、论文写作支持等。其核心功能有：1）高效检索3.5亿论文资源，支持智能问答和自动摘要生成；2）AI驱动的文献解析，可上传PDF获取章节概要和内容问答；3）个性化科研订阅，按用户偏好推送最新成果。平台还涵盖学者画像、学术会议等特色功能，基础服务免费开放，旨在提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T06:23:09Z
- **目录日期**: 2025-04-29
