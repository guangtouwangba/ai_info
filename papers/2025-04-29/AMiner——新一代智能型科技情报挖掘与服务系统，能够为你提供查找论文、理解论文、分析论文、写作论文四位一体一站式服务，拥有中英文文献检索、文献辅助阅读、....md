...
AMiner是一款智能科技情报挖掘系统，提供论文检索、辅助阅读、翻译及科研情报订阅等一站式服务。平台涵盖42个学科的3.5亿论文、0.6亿学者等海量数据，支持中英文文献检索、AI生成摘要、互动问答及文档翻译功能。用户可定制订阅最新科研动态，并通过微信或邮件接收。此外，AMiner还提供学者画像、学术会议等特色功能，基础服务免费开放。访问入口：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T20:06:19Z
- **目录日期**: 2025-04-29
