...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、翻译、辅助阅读和科研情报订阅。它拥有3.5亿论文、0.6亿学者等海量数据，支持AI生成摘要、问答互动和个性化订阅推送最新研究动态。用户可通过网页或微信小程序免费使用其核心功能，提升文献查找、阅读和写作效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T05:05:34Z
- **目录日期**: 2025-04-29
