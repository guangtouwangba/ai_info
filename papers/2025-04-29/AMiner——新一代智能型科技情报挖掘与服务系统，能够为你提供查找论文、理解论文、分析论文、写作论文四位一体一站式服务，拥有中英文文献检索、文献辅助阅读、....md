...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、翻译、辅助阅读和科研订阅。其核心功能包括：1）高效检索3.5亿论文资源，支持智能问答和自动摘要生成；2）AI驱动的文献解析，可上传PDF获取章节概要和内容问答；3）个性化科研动态推送，按用户偏好筛选最新成果。平台还涵盖学者画像、学术会议等特色功能，基础服务免费开放。通过网页或小程序即可使用，旨在提升科研效率。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T00:06:12Z
- **目录日期**: 2025-04-29
