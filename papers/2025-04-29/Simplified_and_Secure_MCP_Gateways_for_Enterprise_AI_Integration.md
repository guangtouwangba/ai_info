...
本文介绍了MCP网关架构，旨在解决企业自托管AI代理集成中的安全问题。该方案通过整合安全原则、认证机制、入侵检测和安全隧道技术，实现了不暴露基础设施的安全自托管。主要贡献包括：参考架构设计、威胁模型映射、简化集成策略及开源实现建议。与现有公共MCP服务器方案不同，该研究专门针对企业级自托管AI集成的独特挑战，为Model Context Protocol（MCP）的广泛应用提供了安全可靠的集成方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T10:01:45Z
- **目录日期**: 2025-04-29
