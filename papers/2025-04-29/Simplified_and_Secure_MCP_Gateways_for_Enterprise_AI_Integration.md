...
本文介绍了MCP网关，旨在为企业自托管MCP服务器集成提供安全解决方案。该架构整合了安全原则、身份验证、入侵检测和安全隧道技术，确保基础设施不暴露。主要贡献包括参考架构、威胁模型映射、简化集成策略及开源实现建议。与现有公共MCP服务器方案不同，本研究专注于企业自托管AI集成的独特挑战。通过MCP网关，企业能够安全地部署AI代理，同时满足安全需求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T15:01:51Z
- **目录日期**: 2025-04-29
