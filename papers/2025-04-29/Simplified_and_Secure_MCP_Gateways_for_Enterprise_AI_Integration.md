...
本文介绍了MCP网关，旨在解决企业自托管AI代理集成中的安全问题。该架构整合了安全原则、身份验证、入侵检测和安全隧道技术，使企业能在不暴露基础设施的情况下安全自托管MCP服务器。关键贡献包括参考架构设计、威胁模型映射、简化集成策略及开源实现建议。与现有公共MCP服务器解决方案不同，本研究专注于企业自托管AI集成的独特挑战，为企业提供了更安全、可控的MCP集成方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T16:01:54Z
- **目录日期**: 2025-04-29
