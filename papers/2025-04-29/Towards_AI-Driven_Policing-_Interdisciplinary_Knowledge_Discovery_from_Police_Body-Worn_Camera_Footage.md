...
这篇论文提出了一种新颖的跨学科分析框架，利用人工智能和机器学习技术分析罗切斯特警察局的执法记录仪(BWC)视频。研究旨在识别警民互动中的行为模式，如尊重、不尊重、冲突升级和降级。通过整合视频、音频和自然语言处理技术进行多模态数据分析，从BWC素材中提取关键信息。论文介绍了研究方法、计算技术和发现，为执法部门提供实用分析方案，同时拓展了从警用记录仪数据中挖掘知识的边界。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T23:01:27Z
- **目录日期**: 2025-04-29
