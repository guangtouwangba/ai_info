...
这篇论文提出了一种新颖的跨学科框架，利用人工智能(AI)和统计机器学习(ML)技术分析罗切斯特警察局(RPD)的执法记录仪(BWC)视频。研究目标是通过检测、分类和分析警民互动模式，识别关键行为动态，如尊重、不尊重、冲突升级和降级。研究采用多模态数据分析方法，整合视频、音频和自然语言处理(NLP)技术，从执法记录仪视频中提取有意义的信息。论文介绍了研究方法、计算技术和发现，为执法部门提供了实用分析方案，同时推动了从警务视频数据中发现新知识的前沿探索。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T10:01:36Z
- **目录日期**: 2025-04-29
