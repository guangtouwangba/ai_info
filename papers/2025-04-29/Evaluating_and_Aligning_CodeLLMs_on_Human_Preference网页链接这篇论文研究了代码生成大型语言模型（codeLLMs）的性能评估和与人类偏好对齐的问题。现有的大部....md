...
该研究针对代码生成大模型(codeLLMs)提出新评估方法，指出现有基准过于侧重代码正确性而忽视人类偏好。研究者构建了CodeArena基准(含397个多语言样本)和SynCode-Instruct语料库(20B标记)，发现执行基准与人类偏好存在差异。实验比较40多个模型显示，开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，凸显对齐人类偏好的重要性。研究通过模拟真实编程任务的复杂性，为代码LLM评估提供了更全面的框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T01:33:18Z
- **目录日期**: 2025-04-29
