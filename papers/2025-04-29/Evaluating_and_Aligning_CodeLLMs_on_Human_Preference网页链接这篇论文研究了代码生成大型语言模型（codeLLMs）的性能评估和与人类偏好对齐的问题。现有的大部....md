...
该论文针对代码生成大模型(codeLLMs)提出CodeArena基准，通过397个涵盖40类编程任务的真实样本评估模型与人类偏好的对齐程度，弥补了传统基准仅关注代码正确性的不足。研究同时构建了20B标记量的SynCode-Instruct合成指令集验证微调效果。实验发现执行基准与人类偏好存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，凸显人类偏好对齐的重要性。研究为提升代码LLMs的实用价值提供了新评估维度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T05:05:44Z
- **目录日期**: 2025-04-29
