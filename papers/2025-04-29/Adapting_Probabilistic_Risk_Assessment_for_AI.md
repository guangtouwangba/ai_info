...
本文提出了一种针对通用人工智能（AI）系统的概率风险评估（PRA）框架，借鉴核能、航天等高可靠性行业的成熟方法。该框架通过三个方面改进风险评估：(1)基于AI系统特性（如能力、领域知识）的面向方面危害分析；(2)采用双向分析和前瞻技术建模风险路径；(3)运用情景分解、参考尺度和追踪协议管理不确定性。框架整合多种评估方法，生成可比较的量化风险估计，并开发了配套工具生成风险报告卡，帮助开发者、评估者和监管者系统识别风险、评估可能性和严重程度，同时明确记录证据和假设。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T03:15:53Z
- **目录日期**: 2025-04-29
