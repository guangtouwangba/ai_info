...
本文提出模块化机器学习（MML）作为新一代大语言模型（LLM）的发展方向。MML将LLM分解为模块化表征、模块化模型和模块化推理三个相互依赖的组件，旨在提升LLM的反事实推理能力、减少幻觉问题，并增强公平性、安全性和可解释性。该范式能阐明LLM内部工作机制、支持灵活的任务自适应设计，并实现逻辑驱动的决策过程。研究通过解耦表征学习、神经架构搜索和神经符号学习等技术实现MML，同时指出神经与符号系统融合、联合优化等关键挑战，为构建鲁棒、可信的AI系统开辟新路径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T06:01:11Z
- **目录日期**: 2025-04-29
