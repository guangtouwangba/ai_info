...
本文提出了一种新型学习范式——模块化机器学习（MML），旨在解决大语言模型（LLM）在推理、事实一致性和可解释性方面的局限性。MML将LLM分解为模块化表示、模块化模型和模块化推理三个相互依赖的组件，通过解耦语义、灵活设计和逻辑驱动决策，提升LLM的反事实推理能力，减少幻觉，并增强公平性、安全性和透明度。MML利用解耦表示学习、神经架构搜索和神经符号学习等技术实现，但仍面临神经与符号过程整合、联合优化和计算可扩展性等挑战。这一范式有望弥合统计学习与形式推理的鸿沟，推动构建更鲁棒、适应性强且可信的AI系统。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T20:01:13Z
- **目录日期**: 2025-04-29
