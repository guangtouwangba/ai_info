...
多邻国CEO宣布公司转向"AI优先"战略，将逐步用AI取代外包工作，并提出五大改革措施：停止外包AI可胜任的工作、将AI能力纳入招聘考核、AI使用效率加入绩效评估、严格控制新增编制、要求部门提交AI改造方案。公司强调此举旨在让核心团队专注创新而非取代员工。该决定引发两极反应：批评者认为现有AI功能不实用，可能加速公司衰落；支持者则认为拥抱AI是未来趋势。作为知名语言学习APP，多邻国此次转型标志着教育科技行业AI应用的重要突破。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T16:02:42Z
- **目录日期**: 2025-04-29
