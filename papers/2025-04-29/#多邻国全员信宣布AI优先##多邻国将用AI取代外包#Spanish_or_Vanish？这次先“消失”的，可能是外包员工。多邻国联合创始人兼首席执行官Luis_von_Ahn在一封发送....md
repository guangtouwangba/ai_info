...
多邻国CEO宣布公司转型为"AI优先"企业，将逐步用AI取代外包人员，并提出五项具体措施：停止外包AI可胜任工作、招聘考核AI能力、绩效评估AI使用效率、严格控制新增编制、要求部门提交AI改造方案。公司强调此举旨在让核心团队专注创新而非取代员工。该决策引发两极反应：批评者认为现有AI功能不实用，担忧盲目追求AI优先；支持者则认为这是面向未来的必要转型。这一战略调整凸显了AI技术对传统工作岗位的冲击和企业数字化转型的迫切性。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T22:02:29Z
- **目录日期**: 2025-04-29
