...
多邻国CEO宣布公司转向"AI优先"战略，将逐步用AI替代外包人员。具体措施包括：停止外包AI可胜任的工作、招聘考核AI能力、绩效评估AI使用效率、严格控制新增编制、要求部门提交AI改造方案。公司强调此举旨在让核心团队专注创新而非重复劳动。舆论反应两极：批评者认为现有AI功能不实用，警告这是错误转向；支持者则认为拥抱AI是未来趋势。该决策凸显了AI对劳动力市场的冲击，也反映了企业数字化转型中的阵痛。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T12:02:54Z
- **目录日期**: 2025-04-29
