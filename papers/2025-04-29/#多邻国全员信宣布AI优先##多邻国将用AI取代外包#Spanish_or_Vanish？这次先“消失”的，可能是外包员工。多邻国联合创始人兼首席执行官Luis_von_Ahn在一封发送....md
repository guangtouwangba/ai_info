...
多邻国CEO宣布公司转向"AI优先"战略，将逐步用AI替代外包工作，并提出五大措施：停止外包AI可胜任的工作、招聘考核AI能力、绩效评估AI使用效率、严格控制新增编制、要求部门提交AI改造方案。公司强调此举旨在让核心团队专注创新而非取代员工。舆论反应两极：批评者认为现有AI功能不实用，警告这是错误决策；支持者则认为这是面向未来的必要转型。该决策引发对AI替代人力的广泛讨论。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T14:02:43Z
- **目录日期**: 2025-04-29
