...
多邻国CEO宣布公司转向"AI优先"战略，将逐步用AI替代外包工作，并提出五大措施：停止外包AI可胜任岗位、将AI能力纳入招聘考核、AI使用效率加入绩效评估、严格控制新增编制、要求部门提交AI改造方案。公司强调此举旨在让核心团队专注创新而非取代员工。该决策引发两极反应：批评者认为现有AI功能不成熟，担忧影响用户体验；支持者则认为这是拥抱未来的必要举措。作为知名语言学习平台，多邻国此举被视为教育科技行业AI转型的重要风向标。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T19:02:21Z
- **目录日期**: 2025-04-29
