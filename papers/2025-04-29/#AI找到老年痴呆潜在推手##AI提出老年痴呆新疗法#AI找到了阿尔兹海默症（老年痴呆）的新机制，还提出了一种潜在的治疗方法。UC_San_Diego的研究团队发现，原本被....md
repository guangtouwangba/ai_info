...
加州大学圣地亚哥分校团队通过AI发现，PHGDH基因不仅是阿尔茨海默病的生物标志物，更是关键致病因子。该基因具有双重功能：除参与丝氨酸合成外，其隐藏的转录调控模块能独立引发淀粉样蛋白堆积和神经炎症。研究人员开发出靶向小分子NCT-503，可特异性抑制PHGDH的致病转录功能而不影响代谢功能。动物实验显示该口服药能显著减少Aβ斑块、改善认知症状。这项突破性研究发表于《Cell》，目前已进入FDA审批流程，为阿尔茨海默病治疗提供了全新干预策略。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T19:03:16Z
- **目录日期**: 2025-04-29
