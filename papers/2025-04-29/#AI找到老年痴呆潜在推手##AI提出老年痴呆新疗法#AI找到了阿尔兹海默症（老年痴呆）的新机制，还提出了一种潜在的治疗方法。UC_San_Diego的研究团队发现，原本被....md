...
加州大学圣地亚哥分校团队通过AI发现，PHGDH基因不仅是阿尔兹海默症的标志物，更是致病元凶。该基因通过新型转录调控功能（独立于其酶活性）驱动淀粉样蛋白堆积和神经炎症。研究人员利用AI设计出靶向小分子NCT-503，可特异性阻断PHGDH的致病功能。动物实验显示该口服药能减少Aβ斑块、改善认知，且成本较低。研究突破传统疗法思路，已启动FDA申报流程，为阿尔兹海默症治疗提供全新干预靶点。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T10:03:08Z
- **目录日期**: 2025-04-29
