...
加州大学圣地亚哥分校团队利用AI发现，PHGDH基因不仅是阿尔兹海默症的生物标志物，更是致病元凶。该基因通过新型转录调控功能（独立于其酶活性）驱动淀粉样蛋白堆积和神经炎症。研究人员通过AI筛选出小分子药物NCT-503，能特异性阻断PHGDH的致病功能。动物实验显示该口服药可减少Aβ斑块、改善认知，且具血脑屏障穿透性。这项突破性研究发表于《Cell》，目前已启动FDA临床前评估，为阿尔兹海默症提供了从源头干预的新治疗策略。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T20:04:19Z
- **目录日期**: 2025-04-29
