...
加州大学圣地亚哥分校团队利用AI发现，PHGDH基因不仅是阿尔兹海默症的标志物，更是致病关键——其隐藏的转录因子结构模块会引发脑部自噬失衡和炎症，独立驱动β淀粉样蛋白堆积。研究人员通过AI筛选出靶向小分子NCT-503，可特异性阻断PHGDH的转录功能而不影响代谢活性。动物实验显示该口服药能减少斑块、改善记忆，且无需依赖遗传背景。该研究突破传统疗法思路，已进入FDA开发流程，为阿尔兹海默症治疗提供全新干预策略。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T23:03:12Z
- **目录日期**: 2025-04-29
