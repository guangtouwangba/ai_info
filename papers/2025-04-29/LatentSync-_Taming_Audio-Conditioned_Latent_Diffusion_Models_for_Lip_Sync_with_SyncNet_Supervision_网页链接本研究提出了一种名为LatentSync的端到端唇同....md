...
本研究提出LatentSync框架，利用音频条件的潜在扩散模型实现端到端唇同步，无需中间运动表示。该方法通过时间表示对齐（TREPA）增强生成帧的时间一致性，并优化SyncNet训练框架以提升准确性。实验表明，该方法在HDTF和VoxCeleb2数据集上超越现有技术。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T19:04:50Z
- **目录日期**: 2025-04-29
