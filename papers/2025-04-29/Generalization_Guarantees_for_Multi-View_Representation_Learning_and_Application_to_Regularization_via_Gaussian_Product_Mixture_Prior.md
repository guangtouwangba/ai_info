...
本文研究了分布式多视角表示学习问题，探讨了在无显式协调下各代理应从视角中提取何种必要且充分的信息以帮助解码器正确估计隐藏标签。通过泛化误差视角，作者建立了基于相对熵的泛化界，并提出了一种正则化方法。研究发现，数据依赖的高斯混合先验能带来良好性能，在单视角下表现优于现有VIB和CDVIB方法，并自然产生加权注意力机制。多视角实验中，选择高斯乘积混合作为联合先验会隐式鼓励代理提取冗余特征，这一发现与直觉相悖。实验验证了所提方法的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T00:02:18Z
- **目录日期**: 2025-04-29
