...
本文研究了分布式多视图表示学习问题，探讨了在无显式协调下各智能体应如何从视图中提取必要且充分的特征以支持解码器正确估计隐藏标签。通过泛化误差视角，作者建立了基于相对熵的泛化界，并提出一种正则化方法。研究发现数据依赖的高斯混合先验能取得良好性能，在单视图场景下超越现有VIB和CDVIB方法，并自然产生加权注意力机制。多视图场景中，选择高斯乘积混合作为联合先验会促使智能体提取冗余特征，这一发现具有反直觉性。实验验证了所提方法的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T03:16:35Z
- **目录日期**: 2025-04-29
