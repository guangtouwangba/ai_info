...
在AI时代，信息过载和复杂性加剧了社会认知负荷，威胁人类福祉和社会韧性。本文指出，减轻认知负荷不仅是改善当前生活的关键，也是应对高级AI潜在风险（包括生存威胁）的前提。AI通过信息泛滥、算法操控、自动化焦虑、监管缺失和意义消解等机制加剧认知过载。研究将AI安全辩论聚焦于认知负荷，强调其连接短期危害与长期风险的桥梁作用。最后探讨了制度适应、研究方向和政策考量，提出从"过载韧性"视角探索人机对齐的路径，而非提供确定方案。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T04:02:01Z
- **目录日期**: 2025-04-29
