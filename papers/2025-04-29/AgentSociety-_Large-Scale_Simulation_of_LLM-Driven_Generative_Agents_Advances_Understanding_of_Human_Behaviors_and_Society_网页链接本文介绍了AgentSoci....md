...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个智能代理及其500万次社会互动。研究者利用该平台研究了社会极化、信息传播、基本收入政策及自然灾害影响等关键社会问题。模拟结果与现实世界数据高度吻合，验证了系统对人类行为和社会机制的捕捉能力。该系统可作为计算社会科学研究工具，辅助传统调查和实验方法，为研究社会问题成因及政策制定提供新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T11:05:18Z
- **目录日期**: 2025-04-29
