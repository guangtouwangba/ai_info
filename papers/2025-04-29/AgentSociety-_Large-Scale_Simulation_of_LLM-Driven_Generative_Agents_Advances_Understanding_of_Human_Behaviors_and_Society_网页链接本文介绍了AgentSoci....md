...
这篇论文介绍了一个名为AgentSociety的大规模社会模拟器，它结合了大型语言模型驱动的代理、真实社会环境和大规模模拟引擎。研究者模拟了1万多个代理的社会生活及500万次互动，并研究了四个关键社会问题：极化现象、刺激性信息传播、无条件基本收入政策影响和外部冲击（如飓风）的影响。模拟结果与现实世界实验数据吻合，证明了该模拟器在捕捉人类行为和社会机制方面的能力，展示了其作为社会科学研究和政策制定工具的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T17:05:00Z
- **目录日期**: 2025-04-29
