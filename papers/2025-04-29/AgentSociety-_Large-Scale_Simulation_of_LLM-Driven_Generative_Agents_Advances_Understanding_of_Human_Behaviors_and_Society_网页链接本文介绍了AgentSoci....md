...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个智能代理及其500万次社会互动。研究者用它研究了社会极化、信息传播、基本收入政策及自然灾害影响四个关键社会问题。模拟结果与现实世界数据高度吻合，验证了该系统捕捉人类行为机制的能力。该平台可作为计算社会科学实验工具，辅助传统研究方法，帮助学者和政策制定者分析社会问题的模式、成因及潜在机制，展现出在社会科学研究中的重要应用潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T16:05:13Z
- **目录日期**: 2025-04-29
