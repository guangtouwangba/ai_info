...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能够模拟超过1万个AI代理的社会互动（500万次交互）。研究者用它研究了四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，验证了该系统对人类行为和社会机制的捕捉能力。该系统可作为计算社会科学的研究平台，辅助传统研究方法（如调查、访谈），为学者和政策制定者提供新的研究工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T22:04:45Z
- **目录日期**: 2025-04-29
