...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟器，能够模拟1万多个代理的社会生活及其500万次互动。研究者利用该平台研究了四个关键社会问题：社会极化、刺激性信息传播、无条件基本收入政策影响和飓风等外部冲击。模拟结果与现实世界实验数据高度吻合，验证了该系统在捕捉人类行为机制方面的能力。该工具可作为社会科学研究和政策制定的有效补充，帮助理解社会问题的模式、成因和潜在机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T02:33:13Z
- **目录日期**: 2025-04-29
