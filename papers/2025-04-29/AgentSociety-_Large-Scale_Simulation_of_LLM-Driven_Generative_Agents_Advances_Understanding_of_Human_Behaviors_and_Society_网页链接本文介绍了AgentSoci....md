...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能模拟1万多个代理及其500万次互动。研究者用它分析了四个社会问题：群体极化、信息传播、基本收入政策效果和自然灾害影响。模拟结果与现实数据吻合，验证了系统对人类行为和社会机制的捕捉能力。该系统可作为计算社会科学研究平台，辅助传统调查方法，帮助理解社会问题成因，为政策制定提供参考，展现了人工智能在社会研究中的应用潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T13:15:14Z
- **目录日期**: 2025-04-29
