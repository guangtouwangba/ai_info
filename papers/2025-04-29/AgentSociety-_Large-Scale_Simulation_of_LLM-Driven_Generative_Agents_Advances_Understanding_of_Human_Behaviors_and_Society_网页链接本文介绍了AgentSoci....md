...
该研究开发了AgentSociety，一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理的社会互动（500万次）。该系统被用于研究四个关键社会问题：群体极化、信息传播、基本收入政策效果和自然灾害影响。模拟结果与现实世界数据高度吻合，验证了该系统捕捉人类行为机制的能力。研究表明，这种AI驱动的社会模拟可以成为社会科学研究和政策制定的有力工具，为理解复杂社会现象提供了新方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T14:05:25Z
- **目录日期**: 2025-04-29
