...
微软推出免费开源课程《Generative AI for Beginners》，包含21节零基础友好课程，涵盖生成式AI原理到应用开发全流程。课程特点包括：分步讲解+代码示例（支持Python/TypeScript）、配套视频/拓展资料、可申请OpenAI免费额度，并提供Discord交流社区。内容从Prompt工程到聊天机器人开发，覆盖文本/图像生成、向量数据库、RAG框架等热点技术，还包含Meta/Mistral等主流模型实践。项目已在GitHub获8万+星标，适合开发者快速入门生成式AI领域。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T00:04:38Z
- **目录日期**: 2025-04-29
