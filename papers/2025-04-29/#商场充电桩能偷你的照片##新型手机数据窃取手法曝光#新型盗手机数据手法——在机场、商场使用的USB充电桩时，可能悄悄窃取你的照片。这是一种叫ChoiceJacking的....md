# #商场充电桩能偷你的照片##新型手机数据窃取手法曝光#新型盗手机数据手法——在机场、商场使用的USB充电桩时，可能悄悄窃取你的照片。这是一种叫ChoiceJacking的...
...
摘要：新型"ChoiceJacking"攻击手法可通过公共场所USB充电桩窃取手机数据。攻击者伪装充电设备，30秒内即可获取照片/文件访问权限。测试显示11款手机中10款受影响（含iOS/Android）。苹果iOS 18.4和安卓15已加强防护，但安卓设备更新滞后仍存风险。安全建议：避免使用公共充电桩、自带充电器、关闭USB调试功能。该漏洞存在多年，近期才被曝光。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T04:02:40Z
- **目录日期**: 2025-04-29
