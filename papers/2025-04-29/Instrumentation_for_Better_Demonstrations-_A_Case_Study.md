...
本研究探讨了通过传感器增强示范数据质量对机器人操作学习的影响。研究在挤压瓶上集成压力传感器，实现了液体分配任务的自动化数据收集（使用PI控制器）。实验表明，基于Transformer的策略在使用自动化示范数据训练时，78%的情况下表现优于人类示范数据。结果表明，传感器集成不仅提高了数据收集效率，还能生成性能更优的策略，这对开发通用机器人代理具有重要意义。该案例突出了仪器化在提升示范质量和实现规模化数据收集方面的双重优势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T03:16:13Z
- **目录日期**: 2025-04-29
