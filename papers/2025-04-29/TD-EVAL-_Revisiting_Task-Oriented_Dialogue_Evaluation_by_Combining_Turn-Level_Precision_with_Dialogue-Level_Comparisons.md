...
本文提出TD-EVAL框架，用于评估任务导向对话(TOD)系统。该框架结合细粒度的轮次级评估（分析对话连贯性、知识一致性和策略合规性）和整体对话级比较（通过TOD Agent Arena进行两两对比）。实验表明，相比传统指标，TD-EVAL能更有效识别对话错误，且与人类判断更吻合。这一可插拔的评估范式为TOD系统提供了兼顾轮次和系统层面的高效评估方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T05:02:06Z
- **目录日期**: 2025-04-29
