...
纳米AI搜索是周鸿祎推出的面向普通用户的MCP（多智能体协作平台）工具，显著降低了使用门槛。该平台整合了100多款自研和第三方MCP工具，支持复杂任务处理（如报告撰写、社交平台爬虫等）。其特点包括：本地部署提升安全性，绕过登录/广告限制；开放生态允许4亿用户调用智能体服务。延续了360的技术风格，目前因访问量过大常出现服务器拥挤现象。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T21:03:38Z
- **目录日期**: 2025-04-29
