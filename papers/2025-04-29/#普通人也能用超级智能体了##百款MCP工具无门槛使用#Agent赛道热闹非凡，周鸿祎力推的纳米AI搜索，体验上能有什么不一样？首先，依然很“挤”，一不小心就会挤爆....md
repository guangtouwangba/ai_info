...
纳米AI搜索是周鸿祎推出的面向普通用户的MCP（多智能体协作平台）工具，大幅降低了使用门槛。该平台整合了100多个自研和第三方MCP工具，支持复杂任务处理（如报告撰写、社交媒体爬虫等）。其特色包括本地部署（非云端）、深度检索能力，并能绕过登录/广告限制，兼顾便利性与安全性。目前已有4亿用户可无门槛使用这些高阶智能体功能，标志着MCP技术从专业领域向大众市场的突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T15:03:35Z
- **目录日期**: 2025-04-29
