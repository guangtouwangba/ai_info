...
AI4SG（人工智能助力社会公益）旨在利用AI技术解决复杂社会问题，如交通网络优化和全球野生动物保护。然而，项目范围界定（problem scoping）因缺乏兼具技术和领域知识的专家而成为关键瓶颈。为此，研究者提出基于大语言模型（LLM）的"问题界定智能体"（PSA），通过整合科学文献和现实知识自动生成全面项目提案。经专家盲审和AI评估，PSA生成的提案质量与人工撰写相当。研究还指出了实际应用中的挑战及未来改进方向。该成果发表于2023年12月。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T16:01:36Z
- **目录日期**: 2025-04-29
