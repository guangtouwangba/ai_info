...
"AI for Social Good (AI4SG) 利用人工智能解决复杂社会问题，但项目规划常因缺乏跨领域专家而受阻。为此，研究者提出基于大语言模型(LLM)的"问题规划代理"(PSA)，能自动生成基于科学文献和实际知识的项目提案。经专家盲审和AI评估，PSA生成的提案质量接近专家水平。研究还指出了实际规划中的挑战和未来改进方向。该框架有望降低AI4SG项目的启动门槛。" (99字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T21:01:34Z
- **目录日期**: 2025-04-29
