...
AI4SG（人工智能助力社会公益）旨在利用AI技术解决复杂社会问题，如交通网络优化和全球野生动物保护。然而，项目规划（problem scoping）常因缺乏兼具技术与领域知识的专家而进展缓慢。为此，研究者提出基于大语言模型（LLM）的"问题规划智能体"（PSA），通过整合科学文献与现实知识自动生成详细项目提案。盲审与AI评估显示，PSA生成的提案质量接近专家水平。研究还指出了实际应用中的挑战，并提出了未来改进方向。该框架为降低AI4SG项目启动门槛提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T12:01:38Z
- **目录日期**: 2025-04-29
