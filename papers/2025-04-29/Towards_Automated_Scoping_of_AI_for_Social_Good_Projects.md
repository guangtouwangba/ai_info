...
AI4SG（人工智能助力社会公益）旨在利用AI技术解决复杂社会问题，如交通网络优化和全球野生动物保护。然而，由于缺乏兼具技术和领域知识的专业人士，问题界定成为关键瓶颈。为此，研究者提出基于大语言模型（LLM）的"问题界定代理"（PSA），通过整合科学文献和现实知识生成全面项目提案。实验表明，PSA生成的提案在盲审和AI评估中与专家提案相当。研究还指出了现实问题界定中的挑战及未来研究方向。该框架为AI4SG项目的高效启动提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T11:01:32Z
- **目录日期**: 2025-04-29
