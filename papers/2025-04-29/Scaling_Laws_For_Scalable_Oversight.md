...
该研究提出了一个量化监督成功概率的框架，将可扩展监督建模为能力不匹配玩家间的博弈。研究者通过修改版Nim游戏和四个监督博弈（"黑手党"、"辩论"、"后门代码"、"战争游戏"）验证框架，发现领域表现与AI通用能力（以Chatbot Arena Elo为代理）存在缩放规律。在嵌套可扩展监督(NSO)的理论研究中，当监督比基线强400Elo的系统时，成功率低于52%，且随系统变强进一步下降。研究还推导了最大化监督成功率的最优监督层级数。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-29T01:28:39Z
- **目录日期**: 2025-04-29
