...
可解释人工智能（XAI）是可信AI的重要支柱，旨在提高复杂模型的透明度。然而，在提供解释信息的同时也引发了隐私风险。本文通过文献综述（2019-2024年57篇研究）探讨了三个核心问题：(1)XAI解释可能泄露敏感数据；(2)现有隐私保护方法（如差分隐私、模型脱敏）；(3)隐私保护解释应具备的特征（如数据最小化、可控披露）。研究归纳了隐私风险类型和保护技术，指出平衡隐私与其他系统需求的挑战，并为实现隐私合规的XAI提出建议。该综述揭示了可信AI中隐私与可解释性这对基本准则的复杂关系。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T03:18:05Z
- **目录日期**: 2025-05-07
