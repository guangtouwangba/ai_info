...
随着大模型加速渗透金融、医疗等核心行业，其安全可控性成为产业落地的关键前提。瑞莱智慧CEO田天博士在第三届AIGC产业峰会上指出，AI发展面临模型自身缺陷和滥用风险双重挑战，需构建防护边界。当前大模型落地需经历问答、辅助、深度协同三阶段，而通过Agent等技术提升系统级可控性是重要方向。他强调，将智能体安全组织起来是形成强生产力的核心，AI检测系统随技术逼真度提升将愈发重要。峰会吸引超千人参会，线上观众达320万。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T12:03:59Z
- **目录日期**: 2025-05-07
