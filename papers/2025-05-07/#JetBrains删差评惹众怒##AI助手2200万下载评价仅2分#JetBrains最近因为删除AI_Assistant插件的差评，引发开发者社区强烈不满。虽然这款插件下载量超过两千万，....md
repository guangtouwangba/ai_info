...
JetBrains因删除AI Assistant插件的差评引发开发者众怒。该插件下载量超2200万但评分仅2.3分，用户反映差评被无故删除。官方称删评因违反社区政策，但开发者质疑是为"洗白"评分。主要问题包括：仅支持自家云服务、运行卡顿、自动重装等。虽然新AI工具"Junie"评价稍好，但免费额度不足。JetBrains在IDE领域口碑良好，但其AI助手因体验差、限制多，难敌VS Code等免费竞品。事件反映用户对产品体验和公司透明度的强烈不满。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T01:31:40Z
- **目录日期**: 2025-05-07
