...
该研究提出了一个全面的足球理解框架，主要贡献包括：(1) 构建首个大规模多模态足球知识库SoccerWiki，整合球员、球队、裁判和场馆等丰富领域知识；(2) 推出最大最全面的足球专用基准SoccerBench，包含约1万标准化多模态(文本/图像/视频)选择题对，覆盖13项理解任务；(3) 开发新型多智能体系统SoccerAgent，通过协同推理分解复杂问题，利用SoccerWiki的领域知识实现稳健性能；(4) 对现有MLLM模型进行全面评估，验证所提系统的优越性。所有数据和代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T16:00:59Z
- **目录日期**: 2025-05-07
