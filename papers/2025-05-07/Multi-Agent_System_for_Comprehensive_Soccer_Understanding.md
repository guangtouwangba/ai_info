...
该研究提出了一个全面的足球理解框架，包含三个主要贡献：(1) 构建首个大规模多模态足球知识库SoccerWiki，整合球员、球队、裁判和场地等领域的知识；(2) 创建最大的足球专用基准测试SoccerBench，包含约1万个标准化多模态选择题，涵盖13项理解任务；(3) 开发多智能体系统SoccerAgent，通过协同推理分解复杂问题，利用SoccerWiki的专业知识实现优异性能。研究还对现有多模态大模型进行了全面评估，证明了所提系统的优越性。所有数据和代码均已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T23:00:58Z
- **目录日期**: 2025-05-07
