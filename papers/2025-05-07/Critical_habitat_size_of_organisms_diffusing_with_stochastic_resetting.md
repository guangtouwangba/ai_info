...
临界斑块大小是种群持续生存所需的最小栖息地面积。传统研究多假设生物仅通过扩散运动，但额外运动模式（如随机重置）会显著改变栖息地需求。本研究分析了间歇性返回固定位置（如归巢、避难或资源导向行为）对临界斑块大小的影响，推导出种群增长动态和临界斑块大小的解析解，并通过基于个体的模拟验证。结果表明：随机重置可能增大或减小临界斑块大小，具体取决于重置频率、重置位置和外部环境严酷程度。这些发现揭示了间歇性迁移如何塑造生态阈值，为破碎化景观（如森林砍伐区）的保护规划提供新见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T11:01:17Z
- **目录日期**: 2025-05-07
