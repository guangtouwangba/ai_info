...
本文介绍了WebGen-Bench，一个评估基于LLM的智能体从零生成多文件网站代码能力的新基准。该基准包含多样化的网站生成指令，涵盖13个子类别的3大类别，并建立了647个测试用例来验证生成网站的功能性。研究使用网页导航代理自动测试，评估了三种高性能代码代理框架的表现，最佳组合的准确率仅为27.8%，突显了该基准的挑战性。此外，研究还构建了包含6,667条指令的训练集WebGen-Instruct，训练后的Qwen2.5-Coder-32B-Instruct模型准确率达到38.2%，超越了最佳专有模型性能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T10:01:12Z
- **目录日期**: 2025-05-07
