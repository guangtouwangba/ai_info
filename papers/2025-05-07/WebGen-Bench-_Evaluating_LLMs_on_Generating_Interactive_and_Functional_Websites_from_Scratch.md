...
本文介绍了WebGen-Bench，一个评估基于LLM的智能体从零生成多文件网站代码库能力的新基准。该基准包含多样化的网站生成指令，涵盖三大类和十三小类，几乎覆盖所有重要类型的Web应用。通过GPT-4o生成647个测试用例，并手动调整以确保准确性。测试采用网页导航代理自动执行，评估结果显示当前最佳组合（Bolt.diy + DeepSeek-R1）仅达到27.8%的准确率，突显了该基准的挑战性。此外，基于6,667条指令构建的训练集WebGen-Instruct，使Qwen2.5-Coder-32B-Instruct模型准确率提升至38.2%，超越最佳专有模型表现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T14:01:16Z
- **目录日期**: 2025-05-07
