...
本文介绍了WebGen-Bench，这是一个评估基于LLM的智能体从零开始创建多文件网站代码库能力的新基准。该基准包含人类标注者和GPT-4o共同创建的多样化网站生成指令，涵盖3大类13小类几乎所有重要类型的Web应用。研究者使用GPT-4o生成647个测试用例，并手动调整以确保准确性。通过网页导航智能体自动测试，评估了Bolt.diy等3种高性能代码智能体框架，表现最佳的DeepSeek-R1+Bolt.diy组合仅达到27.8%准确率。此外，研究者构建了包含6,667条指令的训练集WebGen-Instruct，训练后的Qwen2.5-Coder-32B-Instruct模型达到38.2%准确率，超越最佳专有模型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T16:01:13Z
- **目录日期**: 2025-05-07
