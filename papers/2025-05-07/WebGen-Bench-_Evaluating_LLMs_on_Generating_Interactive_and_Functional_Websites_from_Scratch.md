...
研究人员提出了WebGen-Bench基准测试，用于评估基于LLM的智能体从零开始创建多文件网站代码库的能力。该基准包含多样化的网站生成指令，涵盖13个子类别的3大类别，并配有647个测试用例。测试采用网页导航代理自动执行，验证生成网站的功能准确性。评估显示，性能最佳的Bolt.diy框架结合DeepSeek-R1模型仅达到27.8%的准确率，突显了该任务的挑战性。此外，研究人员构建了包含6,667条指令的训练集WebGen-Instruct，训练后的Qwen2.5-Coder-32B-Instruct模型准确率达到38.2%，超越了最佳专有模型表现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T05:01:09Z
- **目录日期**: 2025-05-07
