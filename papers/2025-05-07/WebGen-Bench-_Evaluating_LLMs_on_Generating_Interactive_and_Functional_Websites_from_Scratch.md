...
本文介绍了WebGen-Bench，一个评估基于LLM的代理从零创建多文件网站代码库能力的新基准。该基准包含人类与GPT-4o共同设计的多样化网站生成指令，涵盖3大类13小类，涉及几乎所有重要类型的Web应用。研究人员使用GPT-4o生成647个测试用例，并通过人工筛选确保准确性。测试采用网页导航代理自动执行，评估了三种高性能代码代理框架，表现最佳的Bolt.diy+DeepSeek-R1组合仅达到27.8%准确率，突显了该基准的挑战性。此外，基于6,667条指令构建的训练集WebGen-Instruct，使Qwen2.5-Coder-32B-Instruct模型达到了38.2%的准确率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T11:01:06Z
- **目录日期**: 2025-05-07
