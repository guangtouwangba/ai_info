...
本文介绍了WebGen-Bench，一个评估基于LLM的智能体从零创建多文件网站代码库能力的新基准。该基准包含人类标注者和GPT-4o共同生成的多样化网站生成指令，涵盖3大类13小类，几乎包含所有重要类型的Web应用。研究人员使用GPT-4o生成647个测试用例，并手动调整以确保准确性。测试采用强大的网页导航代理自动执行。评估显示，性能最佳的组合（Bolt.diy+DeepSeek-R1）仅达到27.8%的准确率。此外，研究人员构建了包含6,667条指令的训练集WebGen-Instruct，训练后的Qwen2.5-Coder-32B-Instruct模型准确率达到38.2%，超越了最佳专有模型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T17:01:16Z
- **目录日期**: 2025-05-07
