...
本文介绍了WebGen-Bench，这是一个评估基于LLM的代理从零开始创建多文件网站代码库能力的新基准。该基准包含多样化的网站生成指令，涵盖三类主要和十三类次要类别，涉及几乎所有重要的Web应用类型。通过GPT-4o生成647个测试用例，并手动调整以确保准确性。使用高性能代码代理框架（如Bolt.diy）测试，最佳组合（DeepSeek-R1）仅达到27.8%准确率，突显了基准的挑战性。此外，构建了包含6,667条指令的训练集WebGen-Instruct，训练后的Qwen2.5-Coder-32B-Instruct达到38.2%准确率，优于最佳专有模型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T18:01:18Z
- **目录日期**: 2025-05-07
