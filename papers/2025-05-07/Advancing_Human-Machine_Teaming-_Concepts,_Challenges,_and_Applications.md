...
人机协作(HMT)通过整合AI决策、信任校准和自适应协作，正在改变国防、医疗和自主系统等领域的合作模式。该研究提出了HMT的综合分类法，分析了强化学习、基于实例学习和相互依赖理论等模型及跨学科方法。相比以往研究，它重点关注团队认知、AI伦理、多模态交互和现实评估框架。关键挑战包括可解释性、角色分配和可扩展的基准测试。未来研究方向包括跨领域适应、信任感知AI和标准化测试平台。该研究通过融合计算与社会科学，为构建稳健、伦理且可扩展的HMT系统奠定了基础。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T23:02:11Z
- **目录日期**: 2025-05-07
