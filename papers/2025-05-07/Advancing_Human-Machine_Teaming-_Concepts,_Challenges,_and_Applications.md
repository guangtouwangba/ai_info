...
人机协作（HMT）通过整合AI决策、信任校准和自适应协作，正在革新国防、医疗和自主系统等领域的合作模式。本文综述提出了HMT的综合分类法，分析了强化学习、实例学习和相互依赖理论等模型及跨学科方法，并探讨了团队认知、伦理AI、多模态交互和现实评估框架等新方向。关键挑战包括可解释性、角色分配和可扩展的基准测试。未来研究应关注跨领域适应、信任感知AI和标准化测试平台。该研究为构建弹性、伦理和可扩展的HMT系统奠定了基础，连接了计算科学和社会科学。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T14:02:35Z
- **目录日期**: 2025-05-07
