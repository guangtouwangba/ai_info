...
豆包AI新功能可通过文字指令生成超真实cos照片，效果逼真到肉眼难辨。用户只需输入描述性提示（如要求"平凡无奇的iPhone自拍照"风格），即可生成Saber、原神可莉等角色cos图，甚至能还原经典动漫角色如明日香与绫波丽的拍立得合照。该技术虽存在细微瑕疵，但整体呈现效果已引发"真假难辨"的惊叹，展示了AI图像生成技术的突破性进展。目前相关话题#AI生成超真实cos照#已在社交媒体引发热议。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T06:03:53Z
- **目录日期**: 2025-05-07
