...
豆包AI新功能可通过文字指令生成超真实cos照，效果逼真难以肉眼辨别。用户只需输入特定描述（如要求"平庸感自拍"），即可生成Saber、原神可莉、EVA明日香等角色的cos照片，甚至能还原拍立得质感的双人合照。该技术展现了AI在图像生成领域的突破，但也引发对真实性的思考。目前生成效果已接近专业cosplay，仅存少量细节瑕疵。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T05:03:49Z
- **目录日期**: 2025-05-07
