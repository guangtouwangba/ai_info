# #AI生成超真实cos照##cos照也能AI生成了#AI可以生成cos照了？可以的，朋友，可以。近日，豆包的一个新玩法悄悄火了起来，只要输入一段AI指令，就能够生成coser照...
...
豆包AI新功能可通过文字指令生成高度逼真的cosplay照片，效果接近真实拍摄。用户只需输入特定要求（如"平凡的iPhone自拍风格"），即可生成Saber、原神可莉、EVA明日香等角色的cos照。生成的图片带有自然的光影瑕疵和模糊效果，部分作品甚至难以用肉眼辨别真伪。该技术展现了AI图像生成的突破性进展，同时也引发了对"真实与虚拟界限"的讨论。目前示例包含单人照和拍立得风格合照，尽管存在小瑕疵，但整体拟真度令人惊叹。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T03:20:32Z
- **目录日期**: 2025-05-07
