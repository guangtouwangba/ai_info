...
AMiner是一款智能科技情报挖掘系统，提供一站式学术服务，包括中英文文献检索、辅助阅读、翻译和科研情报订阅。平台收录3.5亿论文、0.6亿学者和1.5亿专利，支持AI生成摘要、章节概要和互动问答，帮助用户高效理解文献。用户可定制订阅最新科研动态，通过微信或邮件接收。此外，AMiner还提供学者画像、学术会议和论文排行榜等功能。浏览器版本免费使用，适合科研人员和学生快速获取学术资源。访问链接：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T04:05:43Z
- **目录日期**: 2025-05-07
