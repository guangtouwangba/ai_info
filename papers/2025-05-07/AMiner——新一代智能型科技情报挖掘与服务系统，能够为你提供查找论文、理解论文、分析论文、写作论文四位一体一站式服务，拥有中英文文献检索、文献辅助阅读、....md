...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、科研订阅等一站式服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持AI辅助阅读、自动摘要生成和互动问答，帮助用户快速理解文献内容。平台还提供个性化科研动态推送、学者画像分析等功能，可通过网页或微信小程序免费使用，显著提升学术研究效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T15:05:56Z
- **目录日期**: 2025-05-07
