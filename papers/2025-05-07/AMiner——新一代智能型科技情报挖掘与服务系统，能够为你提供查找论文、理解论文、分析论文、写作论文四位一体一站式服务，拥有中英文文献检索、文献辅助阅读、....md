...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和科研订阅等一站式服务。它支持中英文文献搜索，能快速生成摘要和回答文献相关问题，帮助用户高效筛选信息。平台还具备文档识别和交互式问答功能，可上传PDF并获取AI生成的摘要与章节概要。用户能定制科研动态推送，跟踪机构、学者或关键词的最新研究。此外，AMiner提供学者画像、学术会议和论文排行榜等功能，基础服务免费使用。访问入口：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T07:05:45Z
- **目录日期**: 2025-05-07
