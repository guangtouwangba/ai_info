...
ViSafe是一种高速视觉自主防撞系统，旨在为资源受限的飞行器提供安全关键能力，实现高密度空域共享运行。该系统通过基于学习的边缘AI框架与轻量化多摄像头硬件集成，利用感知输入控制屏障函数（CBF）设计安全阈值，为高速飞行提供可证明的运行时安全保障。测试涵盖数字孪生仿真和真实飞行场景，验证了ViSafe在不同代理类型、接近速度（最高144公里/小时）、交互几何和环境条件（如天气和光照）下均能确保自主避碰，树立了纯视觉高速空中防撞的新标杆。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T20:01:51Z
- **目录日期**: 2025-05-07
