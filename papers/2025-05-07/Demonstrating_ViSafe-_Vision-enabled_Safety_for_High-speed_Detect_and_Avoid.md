...
ViSafe是一种高速纯视觉空中防撞系统，专为资源受限的飞行器设计，可在共享空域实现安全自主避障。该系统整合了基于学习的边缘AI框架与轻量化多摄像头硬件，利用感知输入导向的控制屏障函数（CBF）来确保运行时安全阈值。通过数字孪生仿真和真实飞行测试（包括144公里/小时高速接近场景），ViSafe在不同飞行器类型、接近速度、环境条件（如天气/光照）下均能可靠保持安全间隔，创下了纯视觉自主避障的新标杆，为高速空中导航安全设立了新标准。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T08:02:03Z
- **目录日期**: 2025-05-07
