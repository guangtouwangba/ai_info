...
ViSafe是一种高速纯视觉空中防撞系统，专为资源受限的飞行器设计，可在共享空域实现安全自主避障。该系统集成了基于学习的边缘AI框架和轻量化多摄像头硬件，利用感知输入导向的控制屏障函数（CBF）来确保运行时安全阈值。通过数字孪生和真实飞行场景测试，ViSafe在不同飞行器类型、接近速度（最高144公里/小时）、交互几何和环境条件下均能可靠保持安全间隔。该技术为高速空中导航设立了纯视觉自主避障的新标准，首次在真实高速场景中实现了可验证的安全分离能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T14:02:02Z
- **目录日期**: 2025-05-07
