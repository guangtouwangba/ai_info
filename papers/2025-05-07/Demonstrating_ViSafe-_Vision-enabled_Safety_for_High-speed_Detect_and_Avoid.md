...
ViSafe是一种高速视觉自主防撞系统，旨在为资源受限的飞行器提供安全关键能力。该系统通过将基于学习的边缘AI框架与轻量化多摄像头硬件原型紧密结合，解决了探测与规避（DAA）问题。利用感知输入导向的控制屏障函数（CBF），ViSafe能在高速飞行中提供可证明的安全间隔保证。测试涵盖数字孪生仿真和真实飞行场景，验证了其在各种代理类型、接近速度、交互几何和环境条件（如天气和光照）下的可靠性。在最高144公里/小时接近速度的真实测试中，ViSafe创下了纯视觉自主防撞的新标杆。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T04:01:59Z
- **目录日期**: 2025-05-07
