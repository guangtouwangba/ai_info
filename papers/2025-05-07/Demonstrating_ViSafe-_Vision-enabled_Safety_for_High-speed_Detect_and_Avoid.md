...
ViSafe是一种高速视觉自主防撞系统，旨在为资源受限的飞行器提供安全关键能力，实现高密度空域共享运行。该系统通过将基于学习的边缘AI框架与轻量化多摄像头硬件原型紧密结合，利用感知输入控制屏障函数（CBF）设计安全阈值，为高速飞行提供可证明的安全保障。测试涵盖数字孪生仿真和真实飞行场景，验证了ViSafe在不同飞行器类型、接近速度（最高144公里/小时）、交互几何和环境条件下均能确保安全间隔。该技术为纯视觉自主防撞设立了新标准，推动了高速空中导航的安全性发展。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T10:01:54Z
- **目录日期**: 2025-05-07
