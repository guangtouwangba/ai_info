...
ViSafe是一种高速纯视觉空中防撞系统，为资源受限的飞行器提供安全关键能力。该系统将基于学习的边缘AI框架与轻量化多摄像头硬件原型深度集成，利用感知输入控制屏障函数(CBF)确保运行时安全阈值。通过数字孪生仿真和真实飞行测试验证，ViSafe在不同飞行器类型、接近速度(最高144km/h)、交互几何和环境条件(如天气和光照)下均能可靠保持安全间隔。该成果为纯视觉自主防撞设立了新标杆，为高速空中导航安全建立了新标准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T15:01:53Z
- **目录日期**: 2025-05-07
