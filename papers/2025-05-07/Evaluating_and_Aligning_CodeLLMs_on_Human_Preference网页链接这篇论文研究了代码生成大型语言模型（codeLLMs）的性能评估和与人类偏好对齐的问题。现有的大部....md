...
这篇论文针对代码生成大模型(codeLLMs)提出新评估框架CodeArena，强调现有基准测试忽视人类偏好匹配的问题。研究者构建了包含397个高质量样本的基准(覆盖40类44种语言)，并开发20B标记的合成指令数据集SynCode-Instruct。实验发现执行基准与人类偏好评估存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，凸显对齐人类偏好的重要性。研究通过模拟真实编程场景，为代码LLM评估提供了更全面的标准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T03:23:02Z
- **目录日期**: 2025-05-07
