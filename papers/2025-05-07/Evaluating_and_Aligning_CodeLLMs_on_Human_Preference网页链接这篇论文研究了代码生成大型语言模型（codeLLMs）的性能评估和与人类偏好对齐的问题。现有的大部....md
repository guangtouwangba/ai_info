...
这篇论文针对代码生成大模型(codeLLMs)提出创新评估方法，发现现有基准测试过度关注代码正确性而忽视人类偏好。研究者构建了CodeArena基准(包含397个高质量样本，覆盖40类任务和44种语言)和SynCode-Instruct语料库(近20B标记)，通过实验揭示了执行基准与人类偏好间的性能差异。结果显示开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)存在显著差距，强调了代码生成模型与人类偏好对齐的重要性。该研究为提升代码LLMs的实际应用价值提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T02:34:47Z
- **目录日期**: 2025-05-07
