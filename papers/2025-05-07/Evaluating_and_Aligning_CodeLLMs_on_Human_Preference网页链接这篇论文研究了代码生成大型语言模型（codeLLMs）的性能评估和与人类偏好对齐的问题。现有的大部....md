...
这篇论文针对代码生成大模型(codeLLMs)提出了CodeArena评估基准，关注模型输出与人类偏好的对齐问题。研究团队收集了397个高质量编程任务样本，覆盖40个类别和44种语言，并构建了20B标记的合成指令数据集SynCode-Instruct。实验发现传统基于执行的评估与人类偏好存在差距，且开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI)性能差异显著。研究强调了代码LLMs不仅需要正确性，还需符合开发者实际需求，为提升模型实用性提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T05:05:43Z
- **目录日期**: 2025-05-07
