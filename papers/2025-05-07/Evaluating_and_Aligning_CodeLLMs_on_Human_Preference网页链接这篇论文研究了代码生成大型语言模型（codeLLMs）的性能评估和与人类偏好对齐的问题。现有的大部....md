...
这篇论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，关注现有评估忽视的人类偏好问题。研究收集397个高质量编程任务样本，覆盖40类44种语言，并构建20B标记的合成指令数据集SynCode-Instruct。实验发现执行基准与人类偏好评估存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，凸显对齐人类偏好的重要性。研究通过构建新基准和大规模指令集，为提升代码LLMs的实际适用性提供了重要参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T06:05:55Z
- **目录日期**: 2025-05-07
