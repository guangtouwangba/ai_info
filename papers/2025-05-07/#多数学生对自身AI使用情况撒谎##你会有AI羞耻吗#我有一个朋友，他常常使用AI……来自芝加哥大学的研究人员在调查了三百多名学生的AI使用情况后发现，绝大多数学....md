...
芝加哥大学研究发现，约60%学生承认使用AI工具，但90%认为他人使用AI。多数学生低估自身使用频率（自评每周0-1天），却高估同学使用（认为每周4-5天）。这种现象被称为"AI羞耻"，源于对AI生成内容缺乏创意、涉及学术诚信的担忧。即使在STEM专业，学生也倾向认为同学比自己更依赖AI。研究指出，尽管AI技术快速发展，其使用仍常招致负面评价，反映出社会对AI合理应用的争议与探索。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T05:03:19Z
- **目录日期**: 2025-05-07
