...
芝加哥大学研究发现，约60%学生承认使用AI工具，但认为90%的同学都在使用。多数学生低估自身AI使用频率，认为同学使用更频繁。这种现象被称为"AI羞耻"，源于对AI生成内容缺乏创意、涉及学术诚信的担忧。研究显示，即使STEM专业学生也倾向认为他人使用更多。这种现象不仅存在于教育领域，社会对AI应用的负面评价也导致人们不愿公开使用AI。该研究揭示了新技术应用中存在的认知偏差和社会接受度问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T06:03:22Z
- **目录日期**: 2025-05-07
