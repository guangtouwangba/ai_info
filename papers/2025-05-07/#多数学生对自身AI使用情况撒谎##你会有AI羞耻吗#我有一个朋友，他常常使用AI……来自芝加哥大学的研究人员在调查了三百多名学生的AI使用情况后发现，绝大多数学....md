...
芝加哥大学研究发现，60%学生承认使用AI工具，但90%认为他人使用AI。多数学生低估自身AI使用频率，认为同学使用更频繁。这种现象被称为"AI羞耻"，源于对AI生成内容缺乏创意和学术诚信的担忧。STEM专业学生也存在类似倾向。研究表明，尽管AI技术快速发展，但使用者常因负面评价而隐瞒使用情况，反映出社会对AI合理应用的争议仍在持续。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T00:02:52Z
- **目录日期**: 2025-05-07
