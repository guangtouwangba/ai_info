...
芝加哥大学研究发现，60%学生承认使用AI工具，但认为90%的同学都在使用。多数学生低估自身AI使用频率，认为他人使用更频繁。这种现象被称为"AI羞耻"，源于对AI生成内容缺乏创意、涉及学术诚信的担忧。STEM专业学生也存在类似心理。研究表明，新技术应用本应是优势，但现实中AI使用常招致负面评价。随着AI技术发展，如何合理使用AI成为社会持续探讨的问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T02:31:50Z
- **目录日期**: 2025-05-07
