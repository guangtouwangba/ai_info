...
芝加哥大学研究发现，约60%学生承认使用AI工具，但90%认为他人在使用，显示多数人低估自身AI使用频率。学生普遍认为同学使用AI更频繁（每周4-5天），而自评仅为0-1天。这种现象被称为"AI羞耻"，源于对AI内容缺乏创意、学术诚信问题的担忧。研究指出，尽管AI技术快速发展，其合理应用仍存在争议，使用AI常招致负面评价。STEM专业学生也存在类似倾向，虽更愿承认使用AI，但仍认为他人用得更多。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T01:30:30Z
- **目录日期**: 2025-05-07
