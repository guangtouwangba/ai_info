...
康奈尔大学研究发现，AI写作助手正导致全球写作风格"美式化"。实验显示，印度用户更依赖AI建议（53% vs 美国42%），但需更多修改。AI使印度写作在词汇、文化元素（如节日/食物）上趋近美国风格，而美国写作几乎不受影响。更值得警惕的是，AI还潜移默化改变了深层的价值观表达方式，导致文化差异模糊。研究者警告，当前AI模型可能正在推动"数字同化"，呼吁开发更具文化包容性的AI系统。该研究揭示了技术对文化多样性的潜在威胁。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T01:30:52Z
- **目录日期**: 2025-05-07
