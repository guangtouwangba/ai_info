...
康奈尔大学研究发现，AI写作助手正在推动全球写作风格"美国化"。研究比较了118名美国和印度参与者的写作表现，发现印度用户更依赖AI建议（接受率25% vs 19%），但需更多修改。AI提高了写作效率，却使印度用户的表达更接近美式英语，弱化了本土文化元素（如排灯节、宝莱坞）。更值得关注的是，AI不仅改变表层用词，还影响了深层的价值观表达方式，导致文化差异模糊化。研究者警告，若不改进文化包容性，AI可能加速"数字同化"，消解全球文化多样性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T00:03:14Z
- **目录日期**: 2025-05-07
