...
英伟达宣布RTX 5060显卡将于5月19日发售，建议零售价299美元（约2158元）。作为RTX 50系列入门型号，它拥有3840个CUDA核心，相比RTX 4060增加了核心数量，并升级至GDDR7显存提升带宽。该显卡支持DLSS 4技术和光线追踪，但8GB显存可能限制其在1440p/4K游戏中的表现。英伟达表示《机甲战士5：氏族》等游戏将支持DLSS 4。若供货充足且价格稳定，RTX 5060有望成为新一代主流显卡标杆。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T16:04:05Z
- **目录日期**: 2025-05-07
