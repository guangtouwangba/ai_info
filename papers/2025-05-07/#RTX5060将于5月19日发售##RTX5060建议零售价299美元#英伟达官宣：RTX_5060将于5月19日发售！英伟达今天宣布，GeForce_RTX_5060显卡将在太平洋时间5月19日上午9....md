...
英伟达宣布RTX 5060显卡将于5月19日发售，建议零售价299美元（约2158元）。该显卡拥有3840个CUDA核心，相比RTX 4060增加了核心数，并升级至GDDR7显存，带宽显著提升。作为RTX 50系列入门型号，它支持DLSS 4技术和光线追踪，但8GB显存可能限制1440p/4K游戏表现。英伟达透露《机甲战士5：氏族》等游戏将率先支持DLSS 4。尽管性能定位主流，其市场表现仍取决于供货和价格稳定性。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T23:03:44Z
- **目录日期**: 2025-05-07
