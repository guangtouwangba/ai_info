...
这项研究发现，通过即时反馈训练，人们可以有效提升区分人类写作与AI生成文本的能力，并改善自我评估的准确性。研究让255名受试者分辨随机配对的人类和GPT-4o生成文本，其中反馈组在每次判断后获得正确答案。结果显示，反馈组不仅判断准确率显著提高，还纠正了关于AI文本风格僵化、可读性差等错误认知。特别值得注意的是，无反馈组在最自信时错误率最高，而反馈组克服了这一认知偏差。研究表明针对性反馈训练能帮助人们建立对AI文本特征的准确认知，这对教育领域尤为重要。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T08:02:16Z
- **目录日期**: 2025-05-07
