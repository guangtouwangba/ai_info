...
这项研究探讨了人们能否通过即时反馈学会准确区分人类写作和AI生成的文本，并调整自我能力评估。实验让255名捷克母语者判断随机文本对的来源，分为即时反馈组和无反馈组。结果显示，反馈组在准确性和信心校准上显著提升，纠正了关于AI文本风格和可读性的误解。无反馈组在最有信心时错误最多，而反馈组解决了这一问题。研究表明，针对性训练和明确反馈能有效提升区分能力，帮助修正对AI文本特征的错误认知，促进更准确的自我评估。这一发现在教育领域尤为重要。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T20:02:02Z
- **目录日期**: 2025-05-07
