...
这项研究发现，通过即时反馈训练，人们可以有效提升区分人类写作与AI生成文本的能力，并改善自我评估的准确性。研究让255名捷克母语者判断随机文本对的来源，其中反馈组在每次选择后获得正确答案。结果显示，反馈组在识别准确性和信心校准上显著进步，而未反馈组常在最有信心时犯错。参与者最初对AI文本风格和可读性存在误解，但反馈帮助纠正了这些错误认知。该发现对教育领域尤其重要，表明针对性训练能帮助人们更准确地识别AI文本并调整自我判断。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T18:02:06Z
- **目录日期**: 2025-05-07
