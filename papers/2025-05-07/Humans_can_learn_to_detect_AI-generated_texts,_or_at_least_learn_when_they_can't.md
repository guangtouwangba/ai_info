...
这项研究发现，通过即时反馈训练，人们可以显著提高区分人类写作与AI生成文本的能力，并更准确地校准自我评估。研究让255名捷克母语者判断随机文本对的来源，其中反馈组在准确率和信心校准上表现更好。参与者最初对AI文本存在误解（如认为其风格僵化或可读性差），而无反馈组在最自信时错误最多。研究表明，针对性反馈训练能有效纠正对AI文本特征的误解，提升辨别能力，这对教育领域尤为重要。研究还考察了文本风格和可读性等判断标准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T16:02:02Z
- **目录日期**: 2025-05-07
