...
这项研究探讨了人们能否通过即时反馈准确区分人类书写和AI生成的文本，并调整自我认知。实验让255名捷克母语者判断随机文本对的来源，其中一组获得即时反馈，另一组没有。结果显示，获得反馈的组在准确性和信心校准上显著提升。参与者最初对AI文本存在误解（如认为风格僵化或可读性差），无反馈组在最有信心时错误最多，而反馈组纠正了这一问题。研究表明，针对性训练能有效提升辨别能力，修正对AI文本特征的误解，这对教育领域尤为重要。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T06:02:03Z
- **目录日期**: 2025-05-07
