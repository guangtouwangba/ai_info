...
这项研究开发了一个基于代理的模型(ABM)，模拟社区对飓风引发基础设施中断的恢复能力，重点关注电力与交通网络间的相互依赖性。模型包含电网、交通网、风灾/洪水灾害和家庭代理，应用于佛罗里达州迈阿密-戴德县33147邮编区域。研究模拟了三种恢复策略(基于组件、距离和交通信号灯)，验证显示与飓风"艾尔玛"数据一致。结果表明：优先恢复交通信号灯的策略既能有效恢复信号，又不延迟家庭供电；道路畅通和燃料及时运输能加快电力恢复；交通信号中断会显著减缓交通并增加事故风险。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T02:31:20Z
- **目录日期**: 2025-05-07
