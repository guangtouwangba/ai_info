...
研究人员推出了首个综合性、许可宽松的基准测试UI-Vision，用于评估真实桌面环境中的自动化代理性能。该基准包含83款软件的高质量标注数据（如边界框、UI标签和操作轨迹）和三项精细任务（元素定位、布局定位和动作预测），以严格测试代理能力。评估发现，即使先进模型如UI-TARS-72B在专业软件理解、空间推理和拖拽等复杂操作上仍存在明显缺陷。UI-Vision的开源发布旨在推动开发更强大的桌面任务自动化代理，解决现有研究在离线桌面环境中的数据收集和许可限制问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T12:02:20Z
- **目录日期**: 2025-05-07
