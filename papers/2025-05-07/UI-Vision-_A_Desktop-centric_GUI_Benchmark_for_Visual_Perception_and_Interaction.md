...
UI-Vision是首个针对桌面环境的综合性开源基准测试，用于评估GUI自动化代理的离线细粒度性能。它包含83款软件的高质量人工标注数据（边界框、UI标签和操作轨迹）以及三项任务（元素定位、布局定位和动作预测），可全面测试代理能力。评估发现，当前先进模型（如UI-TARS-72B）在专业软件理解、空间推理和拖拽等复杂操作上存在明显缺陷。该基准的发布旨在推动现实场景中桌面任务自动化代理的发展，解决现有研究因数据收集和许可问题对桌面环境关注不足的现状。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T19:02:08Z
- **目录日期**: 2025-05-07
