...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟10,000多个AI代理的社会互动（500万次交互）。该系统通过四个社会问题案例（社会极化、信息传播、基本收入政策、自然灾害影响）验证其有效性，模拟结果与现实世界数据高度吻合。研究表明，AgentSociety能有效捕捉人类行为机制，可作为计算社会科学研究的新工具，辅助传统调查方法，帮助研究者分析社会问题成因并预测政策效果，为社会科学研究和政策制定提供重要支持。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T16:05:23Z
- **目录日期**: 2025-05-07
