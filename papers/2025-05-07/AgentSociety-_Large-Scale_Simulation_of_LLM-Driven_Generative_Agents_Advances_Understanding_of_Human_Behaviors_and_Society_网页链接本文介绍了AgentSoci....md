...
AgentSociety是一个基于大型语言模型(LLM)的大规模社会模拟系统，可模拟10,000多个智能代理及其500万次互动。该系统通过四个社会问题案例研究(社会极化、信息传播、基本收入政策、自然灾害影响)，验证了其模拟结果与现实世界数据的高度一致性。研究表明，AgentSociety能有效捕捉人类行为机制，为社会科学研究和政策制定提供了强大的计算实验平台，可辅助传统研究方法(如调查、访谈)进行社会问题分析和政策效果预测。这一创新工具展现了LLM在社会模拟领域的巨大潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T08:05:45Z
- **目录日期**: 2025-05-07
