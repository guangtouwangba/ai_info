...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟1万多个代理的社会互动（500万次交互）。它被用于研究极化现象、信息传播、基本收入政策和自然灾害影响等社会问题，结果与现实数据吻合。该系统结合了LLM代理、真实社会环境和模拟引擎，能有效分析社会行为机制，为社会科学研究和政策制定提供新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T23:04:44Z
- **目录日期**: 2025-05-07
