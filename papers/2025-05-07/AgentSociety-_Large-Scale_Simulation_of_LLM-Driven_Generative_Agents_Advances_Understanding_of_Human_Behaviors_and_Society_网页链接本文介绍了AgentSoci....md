...
AgentSociety是一种基于大语言模型的大规模社会模拟系统，可模拟超过1万个代理及其500万次互动。研究者利用该系统研究了社会极化、信息传播、基本收入政策和外部冲击等社会问题。模拟结果与现实世界数据高度吻合，验证了该系统在分析人类行为和社会机制方面的有效性。该平台为社会科学研究和政策制定提供了新工具，能补充传统研究方法（如调查和访谈），帮助深入理解社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T12:05:35Z
- **目录日期**: 2025-05-07
