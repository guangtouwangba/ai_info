...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟10,000+个AI代理的社会互动（500万次交互）。该系统作为计算社会科学实验平台，研究了四大社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，验证了该系统在揭示人类行为机制方面的有效性。研究表明，AgentSociety能有效补充传统社会科学研究方法（如调查、访谈），为研究者和政策制定者提供强大的社会问题分析工具，有助于深入理解复杂社会现象的内在机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-07T15:05:30Z
- **目录日期**: 2025-05-07
