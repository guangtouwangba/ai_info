...
这篇论文研究了AI图像生成工具在支持人类创造力时的能耗问题。通过一项24人参与的实验，研究者发现图像生成条件显著影响能耗和每个提示的创造力支持指数，但不会影响整个任务的创造力支持，这主要与每个提示生成的图像数量有关。研究分析了能耗、创造力支持和用户提示行为之间的关系，同时探讨了人们对AI设计及其环境影响的态度。结果表明，可以在不损害创造力支持的情况下降低AI图像生成工具的能耗。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T21:01:44Z
- **目录日期**: 2025-04-12
