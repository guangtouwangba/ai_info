...
这篇论文研究了AI图像生成工具在支持人类创造力时的能耗问题。通过24人用户实验发现，图像生成条件显著影响能耗和每个提示的创造力支持指数，但不影响每个任务的创造力支持，主要归因于每个提示生成的图像数量。研究分析了能耗、创造力支持和用户提示行为之间的关系，同时探讨了用户对AI设计及其环境影响的态度。结果表明，可以在不损害工具创造力支持的情况下降低能耗。研究为平衡AI创造力辅助功能与环保需求提供了实证依据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T07:02:02Z
- **目录日期**: 2025-04-12
