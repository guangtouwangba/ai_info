...
这篇论文研究了AI图像生成工具在支持人类创造力时的能源消耗问题。通过一项24人参与的实验，研究者发现不同图像生成条件对能耗有显著影响，但对每个任务的创造力支持感知影响不大，主要差异来自每个提示生成的图像数量。研究分析了能源使用、创造力支持和用户提示行为之间的关系，同时探讨了参与者对AI设计工具及其环境影响的态度。结果表明，可以在不显著影响创造力支持的情况下降低能耗。研究为平衡AI创造力工具效能与可持续性提供了实证依据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T06:01:54Z
- **目录日期**: 2025-04-12
