...
这篇论文研究了AI图像生成器在支持人类创造力时如何降低能耗。通过24人用户实验发现，图像生成条件显著影响能耗和创造力支持指数（按提示而非任务计算），主要归因于每提示生成的图像数量。研究分析了能耗、创造力支持和用户提示行为之间的关系，同时探讨了用户对AI设计及其环境影响的看法。结果表明，可以在不损害创造力支持的情况下减少能源消耗，为平衡AI工具的创意辅助功能与可持续性提供了新见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T00:01:49Z
- **目录日期**: 2025-04-12
