...
该研究探讨了AI图像生成工具在支持人类创造力时如何减少能耗。通过24人用户实验发现，图像生成条件显著影响能耗和创造力支持指数（按提示而非任务计算），主要归因于每次提示生成的图像数量。研究分析了能耗、创造力支持与用户提示行为之间的关系，同时考察了用户对AI设计工具及其环境影响的态度。结果表明，可以在不损害感知创造力支持的情况下降低AI系统的能源消耗。研究为平衡AI创造力辅助与可持续性提供了实证依据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T04:01:40Z
- **目录日期**: 2025-04-12
