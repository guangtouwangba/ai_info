...
这篇论文探讨了AI图像生成工具在支持人类创造力时的能源消耗问题。通过一项24人参与的用户研究，作者发现图像生成条件显著影响能耗和创造力支持指数（按提示而非任务计算），主要归因于每次提示生成的图像数量。研究分析了能耗、创造力支持和用户提示行为之间的关系，同时考察了用户对AI设计及环境影响的态度。结果表明，可以在不损害工具创造力感知的情况下降低能源消耗。研究为平衡AI创造力支持与可持续性提供了实用见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T08:01:57Z
- **目录日期**: 2025-04-12
