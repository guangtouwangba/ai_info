...
这篇论文探讨了生成式AI（如图像生成器）对人类创造力的辅助作用及其能耗问题。研究通过24人用户实验发现，图像生成条件显著影响能耗和单次提示的创造力支持指数（但非整体任务），主要归因于每次提示生成的图像数量。研究分析了能耗、创造力支持与用户提示行为的关系，同时考察了用户对AI设计工具及其环境影响的态度。结果表明，可以在不损害感知创造力支持的情况下降低能耗。研究为平衡AI创造力工具效能与可持续性提供了实证依据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T03:12:53Z
- **目录日期**: 2025-04-12
