...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统模拟了1万多个AI代理的社会生活，记录了500万次互动，用于研究极化现象、信息传播、基本收入政策及自然灾害影响等社会问题。实验结果显示，模拟结果与现实数据高度吻合，验证了该系统在揭示人类行为机制方面的有效性。该平台可作为社会科学研究和政策制定的有力工具，为传统研究方法提供补充。研究展示了AI模拟在理解复杂社会现象方面的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T15:05:21Z
- **目录日期**: 2025-04-12
