...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟10,000+个AI代理的社会互动（500万次交互）。该系统通过四个社会实验（政治极化、信息传播、基本收入政策、自然灾害影响）验证了其有效性，实验结果与现实世界数据高度吻合。研究表明，这种模拟方法能有效捕捉人类行为机制，可作为传统社会科学研究方法（如调查、实验）的有力补充，为研究者和政策制定者提供新的研究工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T07:05:20Z
- **目录日期**: 2025-04-12
