...
这篇论文介绍了一个名为AgentSociety的大规模社会模拟器，它结合了大型语言模型驱动的代理、真实社会环境和强大的模拟引擎。研究者模拟了1万多个代理的社会生活及500万次互动，并针对四个关键社会问题（如极化现象、信息传播、基本收入政策、飓风冲击）进行了实验。结果显示模拟结果与现实世界数据吻合，验证了该系统捕捉人类行为机制的能力，表明它可作为社会科学研究和政策制定的有力工具。该研究展示了AI模拟在理解复杂社会现象方面的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T22:04:37Z
- **目录日期**: 2025-04-12
