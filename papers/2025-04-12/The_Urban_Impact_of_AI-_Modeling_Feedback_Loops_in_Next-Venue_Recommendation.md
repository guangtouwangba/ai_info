...
该研究提出了一个模拟框架，用于分析基于AI的"下一地点推荐系统"对人类行为与城市动态的系统性影响。研究发现，虽然推荐算法能增加个人访问场所的多样性，但会加剧集体层面的不平等——使访问集中在少数热门地点。这种影响还会扩展到社交共现网络结构，对城市可达性和空间隔离产生深远影响。该框架首次量化了人机反馈循环在位置推荐中的作用，为预测AI辅助出行的社会风险、评估监管措施及设计伦理算法提供了计算工具，弥补了现有研究过于关注预测准确性而忽视系统性影响的不足。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T10:01:03Z
- **目录日期**: 2025-04-12
