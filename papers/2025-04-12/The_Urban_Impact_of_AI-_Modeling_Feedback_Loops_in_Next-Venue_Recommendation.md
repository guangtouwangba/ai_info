...
该研究提出了一个模拟框架，用于分析基于位置的"下一地点推荐系统"对城市动态的系统性影响。研究发现，尽管推荐算法能增加个人访问场所的多样性，但会加剧集体不平等，使访问集中在少数热门地点。这种影响还延伸到社交共处网络结构，可能强化城市空间隔离。该框架通过建模人机反馈循环（用户行为影响算法训练数据，算法又影响用户行为），为评估AI辅助出行的社会影响提供了新工具，有助于预测风险、评估监管措施并指导伦理算法设计。研究基于真实移动数据，对比了不同推荐策略的效果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T09:01:15Z
- **目录日期**: 2025-04-12
