...
基于位置的推荐系统正日益影响城市流动性决策，但其系统性影响尚未充分研究。本研究通过模拟人机反馈循环，分析算法推荐如何改变用户行为并重塑训练数据。基于真实数据的模拟显示：虽然推荐系统能提升个体访问场所的多样性，但会加剧集体不平等，使访问集中于少数热门地点。这种差异还体现在社交共处网络结构中，对城市可达性和空间隔离产生深远影响。该框架为评估AI辅助移动的社会影响提供了新视角，可预测风险、评估监管措施并指导伦理算法设计。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T14:01:03Z
- **目录日期**: 2025-04-12
