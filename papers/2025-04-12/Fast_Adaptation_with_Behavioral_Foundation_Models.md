...
这篇论文提出了针对无监督零样本强化学习（RL）行为基础模型（BFMs）的快速适应策略，以提升其在下游任务中的表现。研究发现，现有BFMs学到的技能比其推理机制识别的策略更优，适合快速适应。作者提出了基于行动者-评论家和纯行动者的低维任务嵌入空间搜索方法，能在数十次环境交互中提升零样本策略性能10-40%，同时避免了预训练模型微调初期常见的性能下降问题。该方法在导航和运动控制任务中验证了有效性，优于现有基线方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T16:01:28Z
- **目录日期**: 2025-04-12
