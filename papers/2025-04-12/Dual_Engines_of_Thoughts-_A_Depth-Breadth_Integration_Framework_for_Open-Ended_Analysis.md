...
本文提出"思维双引擎"(DEoT)框架，专为开放式问题设计，突破传统单答案推理模式。该框架包含三大核心：基础提示器优化用户查询，求解代理协调任务分解与验证，以及由广度引擎(探索多元因素)和深度引擎(深入分析)构成的双引擎系统。实验显示DEoT在复杂多维度问题上表现优异，相比现有推理模型获得77-86%的胜率，证明其在实际应用中的高效性。该框架具有高度可定制性，用户可根据需求调整分析参数和工具配置，实现广度覆盖与深度分析的平衡。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T04:01:50Z
- **目录日期**: 2025-04-12
