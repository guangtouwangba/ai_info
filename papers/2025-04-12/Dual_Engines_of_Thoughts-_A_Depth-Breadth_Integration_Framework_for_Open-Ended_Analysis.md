...
本文提出"思维双引擎"(DEoT)框架，专为解决开放式问题而设计。该框架包含三个核心组件：优化用户查询的基础提示器、协调任务分解/执行/验证的求解代理，以及由广度引擎(探索多元影响因素)和深度引擎(进行深入分析)构成的双引擎系统。相比传统单答案推理框架，DEoT能同时实现广泛覆盖和深度探究，并支持参数自定义。实验表明，DEoT在处理复杂多维问题时表现优异，以77-86%的胜率超越现有推理模型，展现出强大的实际应用价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T16:02:07Z
- **目录日期**: 2025-04-12
