...
研究人员提出了"思维双引擎"(DEoT)框架，专门用于解决开放性问题。该框架包含三个核心组件：基础提示器(优化用户查询)、求解代理(协调任务分解与验证)以及由广度引擎(探索多元因素)和深度引擎(深入分析)构成的双引擎系统。实验表明，DEoT在解决复杂多面问题时表现优异，相比现有推理模型取得77-86%的胜率。其创新性在于平衡广泛覆盖与深度分析，且支持用户根据需求自定义分析参数和工具配置，特别适合需要全面开放式推理的场景。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T11:01:56Z
- **目录日期**: 2025-04-12
