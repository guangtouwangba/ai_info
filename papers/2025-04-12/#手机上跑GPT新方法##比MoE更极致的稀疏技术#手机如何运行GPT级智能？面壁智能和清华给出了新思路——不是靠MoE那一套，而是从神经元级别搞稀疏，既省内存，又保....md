...
清华大学和面壁智能提出CFM（可配置基础模型）技术，通过神经元级稀疏激活实现在手机等终端设备上高效运行GPT级模型。相比MoE（专家混合）技术需要固定激活专家数量，CFM能根据任务难度动态调整激活神经元数量，既节省内存又保持性能。该技术特别适合前馈神经网络层，可实现模块化组合，为手机、笔记本等端侧设备提供灵活的AI解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T12:03:02Z
- **目录日期**: 2025-04-12
