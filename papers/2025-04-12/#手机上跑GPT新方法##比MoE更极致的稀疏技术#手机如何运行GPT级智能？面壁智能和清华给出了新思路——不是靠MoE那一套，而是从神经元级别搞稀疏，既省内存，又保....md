...
面壁智能与清华团队提出CFM技术，通过神经元级稀疏激活实现手机端运行GPT级模型。相比MoE固定激活专家数量，CFM根据任务难度动态调整激活神经元数量，既节省内存又保持性能。该技术尤其适合FFN层，能灵活组合模型模块，适配手机、笔记本等端侧设备。CFM无需MoE的负载平衡机制，允许全参数参与运算，在资源受限场景下更高效实用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T14:03:01Z
- **目录日期**: 2025-04-12
