...
面壁智能与清华团队提出CFM（可配置基础模型）技术，通过神经元级稀疏激活实现在手机等终端设备运行GPT级模型。相比MoE（专家混合）固定激活专家数量的方式，CFM根据任务复杂度动态激活神经元：复杂任务激活更多神经元，简单任务则减少激活以节省资源。该技术特别优化了FFN层，无需负载均衡机制即可实现全参数参与运算，在保持性能的同时显著降低内存消耗。CFM还支持模块化组合，使终端设备（手机/笔记本/智能家居等）能更高效地进行任务导向建模。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T23:02:48Z
- **目录日期**: 2025-04-12
