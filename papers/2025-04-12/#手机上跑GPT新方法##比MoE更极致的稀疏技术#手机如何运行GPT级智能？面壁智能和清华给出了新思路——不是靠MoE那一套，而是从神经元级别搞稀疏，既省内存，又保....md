...
面壁智能与清华团队提出CFM（可配置基础模型）技术，通过神经元级稀疏化实现在手机等终端设备运行GPT级模型。相比MoE（专家混合）固定激活专家数量的方式，CFM根据任务复杂度动态激活神经元：复杂任务激活更多神经元，简单任务则减少激活，既节省内存又保持性能。该技术特别适合前馈神经网络层，能灵活组合模型模块，无需MoE的负载平衡机制，使全量参数参与计算，更适配手机、笔记本等端侧设备的低功耗需求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T17:03:01Z
- **目录日期**: 2025-04-12
