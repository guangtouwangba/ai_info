...
清华大学和面壁智能提出了一种名为CFM（可配置基础模型）的新技术，能够在手机上高效运行GPT级AI模型。与MoE（混合专家）技术不同，CFM采用神经元级别的稀疏激活机制，根据任务复杂度动态调整激活的神经元数量，既节省内存又保持性能。该方法无需像MoE那样限制激活专家数量，允许全量参数参与运算，同时支持模块化组合，特别适合手机、笔记本等终端设备。研究显示，CFM在前馈神经网络层效果显著，为端侧AI提供了更高效的解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T21:02:51Z
- **目录日期**: 2025-04-12
