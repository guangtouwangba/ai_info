...
清华大学与面壁智能提出CFM技术，通过神经元级稀疏化实现在手机等终端设备运行GPT级模型。相比MoE强制限制激活专家数量，CFM利用模型固有稀疏特性动态调节神经元激活：复杂任务激活更多神经元，简单任务则减少计算。该技术尤其优化了FFN层，支持模块化组合，在保持性能的同时显著降低内存消耗，适合手机、笔记本等端侧应用场景。研究团队表示，这种"按需激活"机制比MoE更灵活高效，无需负载平衡即可实现全参数参与运算。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T15:03:06Z
- **目录日期**: 2025-04-12
