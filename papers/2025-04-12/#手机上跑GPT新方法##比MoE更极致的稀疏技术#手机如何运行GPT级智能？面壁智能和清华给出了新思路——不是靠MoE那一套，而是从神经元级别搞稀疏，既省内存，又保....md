...
清华大学和面壁智能提出CFM技术，通过神经元级稀疏激活实现手机端运行GPT级模型。相比MoE固定激活专家数量的方式，CFM根据任务难度动态激活神经元，既节省内存又保持性能。该技术特别适合FFN层，能灵活组合模型模块，适用于手机、笔记本等端侧设备。CFM无需负载平衡设计，允许全参数参与运算，在保证效率的同时降低了计算资源需求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T16:03:13Z
- **目录日期**: 2025-04-12
