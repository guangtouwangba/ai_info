...
清华大学与面壁智能提出CFM（可配置基础模型）技术，通过神经元级稀疏激活实现手机端高效运行GPT级模型。相比MoE（专家混合）需固定激活专家数量，CFM根据任务复杂度动态调节激活神经元数量，既节省内存又保持性能。该技术尤其适合前馈神经网络层，支持模块化组合，可灵活适配手机、笔记本等终端设备。CFM无需负载平衡设计，允许全参数参与运算，在保证效果的同时显著降低计算资源消耗，为端侧AI部署提供新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T13:06:57Z
- **目录日期**: 2025-04-12
