...
面壁智能与清华团队提出CFM（可配置基础模型）技术，通过神经元级稀疏激活实现在手机等终端设备运行GPT级模型。相比MoE（专家混合）的固定专家激活机制，CFM根据任务复杂度动态调整神经元激活数量，既节省内存又保持性能。该技术特别适合前馈网络层，支持模块化组合，在手机、笔记本等端侧设备上具有显著优势。CFM无需负载平衡设计，允许全参数参与运算，比MoE更灵活高效。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T20:02:50Z
- **目录日期**: 2025-04-12
