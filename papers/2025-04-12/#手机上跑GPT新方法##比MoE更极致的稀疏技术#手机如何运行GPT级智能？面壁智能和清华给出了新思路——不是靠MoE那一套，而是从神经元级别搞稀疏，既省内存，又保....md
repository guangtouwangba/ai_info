...
面壁智能与清华提出CFM技术，可在手机等终端设备上高效运行GPT级模型。该技术通过神经元级稀疏激活（而非MoE的专家路由机制），实现动态计算：任务复杂时激活更多神经元，简单任务则减少计算。相比MoE需要限制激活专家数量，CFM允许全参数参与运算，在保持性能的同时显著降低内存消耗。尤其在FFN层效果突出，支持模块化组合，适用于手机、笔记本等端侧场景。这种原生稀疏性既避免负载均衡问题，又能根据任务需求灵活调配计算资源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T11:02:39Z
- **目录日期**: 2025-04-12
