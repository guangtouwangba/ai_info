...
面壁智能与清华团队提出CFM（可配置基础模型）技术，通过神经元级稀疏激活实现在手机等终端设备运行GPT级模型。相比MoE（专家混合）技术需要固定激活专家数量，CFM根据任务难度动态激活神经元：复杂任务激活更多神经元，简单任务则减少激活。该方法在FFN层表现突出，无需负载平衡机制，支持全参数参与运算，既节省内存又保持性能。CFM还支持模块化组合，适用于手机、笔记本、智能家居等端侧场景，为轻量化大模型部署提供新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T18:02:48Z
- **目录日期**: 2025-04-12
