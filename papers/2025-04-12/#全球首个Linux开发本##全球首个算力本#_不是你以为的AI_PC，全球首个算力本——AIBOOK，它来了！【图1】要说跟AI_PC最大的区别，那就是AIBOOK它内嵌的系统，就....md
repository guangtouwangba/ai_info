...
AIBOOK是全球首款基于Linux系统的AI算力本，专为开发者设计。它具备50TOPS本地算力，支持断网开发，可训练和推理AI模型（如运行7B参数大模型，速度达15 tokens/s）。预装Linux系统，支持云桌面切换Windows及Android开发环境。配置包括32GB内存、1TB SSD、14英寸2.8K OLED屏，重量仅1.35kg。已适配DeepSeek、Qwen等主流开源大模型，最高支持32B参数模型。由爱簿智能推出，旨在解决开发者算力不足和工具链短缺问题，成为便携式AI开发工作站。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T08:03:57Z
- **目录日期**: 2025-04-12
