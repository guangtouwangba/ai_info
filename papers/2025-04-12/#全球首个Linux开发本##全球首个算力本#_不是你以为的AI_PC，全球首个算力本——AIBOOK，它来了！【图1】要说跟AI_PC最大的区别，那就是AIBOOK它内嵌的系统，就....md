...
AIBOOK是全球首款Linux开发本和算力本，由爱簿智能推出，专为开发者设计。它搭载50TOPS算力，支持本地训练和推理模型，可运行32B参数的大语言模型（如DeepSeek、Qwen等），最高速度达15 tokens/s。配备32GB内存、1TB SSD和14英寸2.8K OLED屏，支持云桌面切换和安卓开发。主打便携（1.35kg，12.4mm厚）与离线AI开发能力，解决算力不足和工具链短缺问题，面向开发者、学生和AI爱好者。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T07:04:00Z
- **目录日期**: 2025-04-12
