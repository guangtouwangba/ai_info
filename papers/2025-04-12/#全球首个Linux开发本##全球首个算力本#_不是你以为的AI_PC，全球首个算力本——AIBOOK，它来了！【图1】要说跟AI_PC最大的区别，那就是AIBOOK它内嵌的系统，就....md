...
AIBOOK是全球首款基于Linux系统的AI算力本，由国内初创企业爱簿智能推出。该设备主打50TOPS本地算力，支持断网环境下AI模型训练与推理，可运行32B参数大语言模型（如DeepSeek、Qwen等），端侧推理速度达15 tokens/s。配备32GB内存、1TB SSD和14英寸2.8K OLED屏，兼具开发本便携性（1.35kg/12.4mm）与云桌面/安卓开发兼容性，主要面向开发者解决算力不足和工具链短缺痛点，实现"移动AI实训室"概念。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T06:03:53Z
- **目录日期**: 2025-04-12
