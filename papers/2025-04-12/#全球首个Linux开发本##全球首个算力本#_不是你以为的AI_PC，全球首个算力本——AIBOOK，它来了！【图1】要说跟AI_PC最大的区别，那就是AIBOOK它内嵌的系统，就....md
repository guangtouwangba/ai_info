...
AIBOOK是全球首款Linux开发本和算力本，由国内初创企业爱簿智能推出。它配备50TOPS本地算力、32GB内存和1TB SSD，支持离线训练和推理AI模型（如7B参数大模型），并兼容主流开源大模型（DeepSeek/Qwen等）。预装Linux系统，可一键切换云Windows或Android开发环境，14英寸2.8K OLED屏，重1.35kg。面向开发者解决算力不足和工具链缺失痛点，实现"移动AI实训室"概念。演示显示其能本地完成模型训练、加载和图像识别全流程。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T10:03:42Z
- **目录日期**: 2025-04-12
