...
AIBOOK是全球首款Linux开发本和算力本，由爱簿智能推出，专为开发者、AI爱好者和大学生设计。其亮点包括：内置Linux系统（可切换云桌面和Android容器），50TOPS本地算力支持断网开发，支持训练和推理AI模型（如DeepSeek、Qwen等32B参数大模型），端侧运行7B模型速度达15 tokens/s。硬件配置为32GB内存+1TB SSD，14英寸2.8K OLED屏，重1.35kg，厚度12.4mm。解决了AI开发中算力不足和工具链缺失的痛点，成为便携式"AI实训室"。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T04:03:34Z
- **目录日期**: 2025-04-12
