...
AIBOOK是全球首款基于Linux系统的AI算力本，由国内初创企业爱簿智能推出，专为开发者、AI爱好者和大学生设计。该设备搭载50TOPS算力，支持本地断网训练和推理模型，可运行32B参数的大语言模型，并兼容主流开源模型如DeepSeek、Qwen等。配备32GB内存、1TB SSD和14英寸2.8K OLED屏幕，重量仅1.35kg，支持云桌面切换和安卓开发。其便携性和高性能解决了AI开发中算力不足和工具链短缺的痛点，成为移动AI开发的新选择。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T00:03:36Z
- **目录日期**: 2025-04-12
