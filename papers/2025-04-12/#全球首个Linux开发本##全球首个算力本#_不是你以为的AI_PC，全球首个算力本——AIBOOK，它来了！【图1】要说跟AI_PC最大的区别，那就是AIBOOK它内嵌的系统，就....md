...
AIBOOK是全球首款Linux开发本和算力本，由中国初创企业爱簿智能推出。它搭载50TOPS本地算力，支持断网AI训练和推理，可运行32B参数大模型（如DeepSeek、Qwen），端侧推理速度达15 tokens/s。预装Linux系统，支持云桌面切换Windows及安卓开发环境。配备32GB内存、1TB SSD、14英寸2.8K OLED屏，重1.35kg，主打便携AI开发，解决算力不足和工具链缺失痛点，面向开发者、学生群体。通过VSCode可本地完成模型训练（如图像分类）全流程。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T05:03:49Z
- **目录日期**: 2025-04-12
