...
AIBOOK是全球首款Linux开发本和算力本，内置Linux系统，支持50TOPS本地算力，可断网进行AI模型训练和推理。配备32GB内存、1TB SSD和14英寸2.8K OLED屏，支持一键切换云桌面和安卓开发容器。已适配DeepSeek、Qwen等主流开源大模型，最高支持32B参数模型，端侧运行7B模型速度达15 tokens/s。由爱簿智能研发，面向开发者群体，解决AI开发中算力不足和工具链缺失的痛点，将高性能AI开发环境浓缩至1.35kg机身中，实现移动端高效开发。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T11:03:54Z
- **目录日期**: 2025-04-12
