...
Meta的Llama 4大模型因"作弊"被曝光后，重新上线非特供版，排名从第2名暴跌至第32名，引发社区信任危机。此前版本是未公开优化细节的"实验版"，替换为HuggingFace同款模型后性能明显下降。虽然Llama 4在内存充足但带宽受限的设备上表现良好，且在大型RAG任务中速度快于DeepSeek，但准确率和任务处理能力较弱。实测显示，DeepSeek v3在代码、推理、写作等方面表现更优，尤其在解释能力和创意写作上更受好评。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T18:02:39Z
- **目录日期**: 2025-04-12
