...
Meta的Llama 4大模型因被曝在竞技场测试中使用"特供优化版"而引发争议。重新上线标准版后，其排名从第2名暴跌至第32名，导致社区对Meta产生信任危机。开发者指出，Llama 4在带宽受限设备上表现良好，大型RAG任务执行速度优于DeepSeek，但准确率较弱。实测显示，DeepSeek v3在代码、推理、写作等任务上表现更优，尤其在解释能力和创意写作方面更胜一筹。这一事件凸显了大模型评测透明性的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T19:02:37Z
- **目录日期**: 2025-04-12
