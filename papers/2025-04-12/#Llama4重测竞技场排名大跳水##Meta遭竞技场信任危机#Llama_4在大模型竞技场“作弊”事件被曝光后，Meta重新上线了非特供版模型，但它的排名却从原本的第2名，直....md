...
Meta的Llama 4大模型因"作弊"事件引发争议，重新上线标准版后排名从第2暴跌至第32名。此前官方未公开其"实验版"的具体优化方式，导致社区对Meta产生信任危机。实测显示，Llama 4在带宽受限设备上表现良好，大型RAG任务速度快但精度不足；而DeepSeek v3在代码、推理、写作等任务中表现更优，尤其在解释能力和创意写作方面更受好评。这一事件凸显了AI基准测试透明性的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T14:02:51Z
- **目录日期**: 2025-04-12
