...
Meta的Llama 4大模型因被曝"作弊"后重新上线标准版，导致其在竞技场排名从第2名暴跌至第32名。此前版本是未公开优化细节的"实验版"，引发社区对Meta测试诚信的质疑。尽管Llama 4在内存充足但带宽受限的设备上表现良好，且在大型RAG任务中速度优于DeepSeek，但准确率和综合能力仍不足。实测显示DeepSeek v3在代码、推理和文本创作等方面更优。这一事件使Meta面临严重的社区信任危机。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T20:02:42Z
- **目录日期**: 2025-04-12
