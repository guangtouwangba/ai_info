...
Meta的Llama 4大模型因"作弊"被曝光后，重新上线非特供版，排名从第2名暴跌至第32名，引发社区信任危机。此前版本经过未公开的人类偏好优化，而替换后的HuggingFace同款模型表现较差。尽管Llama 4在带宽受限设备（如Mac Studio）和大型RAG任务中速度占优，但准确率、代码题和文本写作等能力仍逊于DeepSeek v3。开发者批评Meta不尊重基准测试，导致用户对其信任度大幅下降。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T12:02:53Z
- **目录日期**: 2025-04-12
