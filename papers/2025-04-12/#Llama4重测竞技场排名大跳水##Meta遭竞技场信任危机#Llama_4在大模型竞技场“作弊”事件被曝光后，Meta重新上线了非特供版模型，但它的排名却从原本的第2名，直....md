...
Meta的Llama 4大模型因被曝在竞技场测试中"作弊"后，重新上线标准版本，但排名从第2名暴跌至第32名。此前Meta使用了一个未公开优化细节的"实验版"模型，引发社区强烈不满，质疑其不尊重基准测试。实际测试显示，Llama 4在带宽受限设备上表现良好，大型RAG任务执行速度优于DeepSeek，但准确率较低。在代码、推理和文本创作等任务中，DeepSeek v3整体表现更优。这一事件导致Meta面临严重的社区信任危机。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T22:02:36Z
- **目录日期**: 2025-04-12
