...
Meta的Llama 4大模型因被曝在竞技场测试中使用"特供优化版"而引发争议。重新上线标准版后，其排名从第2名暴跌至第32名，导致社区对Meta产生信任危机。虽然Llama 4在带宽受限设备上表现良好，执行速度优于DeepSeek，但在准确率、代码能力和文本创作等核心指标上仍落后。实测显示，DeepSeek v3在推理、写作等任务中表现更优。这一事件凸显了AI基准测试的透明度问题，也损害了Meta在开发者社区的声誉。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T23:02:40Z
- **目录日期**: 2025-04-12
