...
Meta的Llama 4大模型因被曝在竞技场测试中使用优化版"作弊"，重新上线标准版后排名从第2暴跌至第32名，引发社区信任危机。虽然该模型在带宽受限设备（如Mac Studio）和大型RAG任务中表现良好（速度快于DeepSeek），但在准确率、代码、推理和文本创作（如故事结尾设计）等方面仍逊于DeepSeek v3。开发者质疑Meta未公开优化细节，损害基准测试公信力，导致用户对其技术透明度产生强烈不满。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T15:02:57Z
- **目录日期**: 2025-04-12
