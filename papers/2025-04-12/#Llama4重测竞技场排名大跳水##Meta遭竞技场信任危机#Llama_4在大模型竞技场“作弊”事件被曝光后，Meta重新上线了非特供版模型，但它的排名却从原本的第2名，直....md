...
Meta的Llama 4大模型因"作弊"事件被曝光后，重新上线非特供版模型，导致其在竞技场排名从第2名暴跌至第32名。此前版本是未公开优化方式的"实验版"，引发社区不满，质疑Meta不尊重基准测试。尽管Llama 4在带宽受限设备（如Mac Studio）和大型RAG任务中表现良好，但准确率和任务处理能力仍逊于DeepSeek v3。后者在代码、推理、写作等测试中表现更优，尤其在解释能力和故事设计方面获得更高评价。此次事件使Meta面临信任危机。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T13:06:47Z
- **目录日期**: 2025-04-12
