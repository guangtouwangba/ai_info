...
本文提出了一种新型多智能体临床决策支持系统架构，采用模块化智能体分别分析实验室结果、生命体征和临床背景，并通过整合结果进行预测和验证。基于eICU数据库的实现表明，该系统通过透明业务逻辑和遵循自主性、公平性、问责制等伦理AI原则，不仅提高了可解释性和准确性，还增强了重症监护环境中对AI辅助决策的信任度。该框架展示了数据驱动医疗时代构建可信赖临床支持系统的有效途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T19:01:56Z
- **目录日期**: 2025-04-12
