...
本文提出了一种新型多智能体临床决策支持系统架构，采用模块化智能体分别分析实验室结果、生命体征和临床背景，并通过整合结果进行预测和验证。基于eICU数据库的实现展示了该系统的透明度，遵循自主性、公平性和问责制等伦理AI原则。结果表明，该框架不仅提高了可解释性和准确性，还增强了重症监护环境中对AI辅助决策的信任度。整个系统采用透明的业务逻辑实现，体现了数据驱动医疗时代对可解释、符合伦理的人工智能的需求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T15:02:11Z
- **目录日期**: 2025-04-12
