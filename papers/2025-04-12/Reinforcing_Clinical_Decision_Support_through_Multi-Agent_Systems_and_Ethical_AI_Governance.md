...
本文提出了一种基于多智能体系统的临床决策支持新架构，采用模块化智能体分别分析实验室结果、生命体征和临床背景，然后整合结果进行预测和验证。研究使用eICU数据库实现了实验室分析、生命体征解读和情境推理等专用智能体，并通过预测模块和验证智能体运行。该架构遵循自主性、公平性和问责制等伦理AI治理原则，采用透明的业务逻辑实现。结果表明，这种基于智能体的框架不仅提高了可解释性和准确性，还增强了重症监护环境下对AI辅助决策的信任度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T02:27:58Z
- **目录日期**: 2025-04-12
