...
生成式AI对传统的人类独特性（尤其是创造力）概念提出了深刻挑战。基于神经网络的基础模型展现出强大的内容生成能力，引发了关于著作权和智能本质的争论。论文指出，生成式AI通过数学模式合成（而非生物理解）展现另类智能与创造力。其学习本质是从人类集体知识中提取统计模式，这使得版权归属复杂化。作者主张人机协同：将AI作为补充工具，结合人类直觉与伦理判断，以释放创新潜力并解决社会问题。同时需确保技术公平获取，避免加剧社会分化，最大化集体利益。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T07:01:13Z
- **目录日期**: 2025-04-12
