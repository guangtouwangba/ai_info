...
南瓜叶病害严重影响农业生产，传统人工检测方法效率低且易出错。本研究基于包含2000张高清图像（分为5类病害和健康叶片）的"南瓜叶病害数据集"，测试了多种深度学习模型。其中ResNet50表现最优，准确率达90.5%，并在精确率、召回率和F1分数上均有良好表现。研究还采用Grad-CAM等可解释AI技术增强模型决策透明度。结果表明，ResNet50结合XAI方法能有效提升南瓜叶病害的自动化诊断能力，为早期精准防治提供可靠方案。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T04:02:16Z
- **目录日期**: 2025-04-12
