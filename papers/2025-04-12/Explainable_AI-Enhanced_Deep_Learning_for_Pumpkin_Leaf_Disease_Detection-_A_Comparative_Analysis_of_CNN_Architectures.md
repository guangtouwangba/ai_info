...
本研究利用包含2000张高清南瓜叶片图像的"南瓜叶病数据集"，对比了多种深度学习模型对5类叶病（霜霉病、白粉病、花叶病、细菌性叶斑病和健康叶片）的识别效果。结果显示ResNet50模型表现最优，准确率达90.5%。研究还采用Grad-CAM等可解释AI技术增强模型决策透明度。该方法能实现南瓜叶病的自动化精准诊断，有助于早期防治，提升农业生产效率。数据集来自多个农田，确保了模型的泛化能力。该成果为农业病害智能检测提供了可靠解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T17:02:30Z
- **目录日期**: 2025-04-12
