...
南瓜叶病害严重影响农业生产，传统人工检测方法效率低且易出错。本研究采用包含2000张高分辨率图像的南瓜叶病害数据集（含5类：霜霉病、白粉病、花叶病、细菌性叶斑病及健康叶片），测试了多种深度学习模型。结果显示ResNet50表现最佳，准确率达90.5%，其他指标（精确率、召回率、F1分数）同样出色。研究还应用可解释AI技术（Grad-CAM等）增强模型决策透明度。该成果表明ResNet50能有效实现南瓜叶病害的自动化精准检测，为早期防治提供可靠支持。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T11:02:25Z
- **目录日期**: 2025-04-12
