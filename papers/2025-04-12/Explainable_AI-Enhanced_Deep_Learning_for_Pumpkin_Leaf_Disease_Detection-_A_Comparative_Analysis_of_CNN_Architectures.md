...
本研究利用包含2000张高清图像的"南瓜叶病害数据集"，对比了多种深度学习模型对5类叶片（霜霉病、白粉病、花叶病、细菌性叶斑病及健康叶片）的识别效果。结果表明，ResNet50模型表现最优，准确率达90.5%，其他评估指标（精确率、召回率、F1分数）同样出色。研究还采用Grad-CAM等可解释AI技术，增强了模型决策过程的可信度。该成果为南瓜叶病害的自动化精准诊断提供了有效方案，有助于实现早期干预，提升农业生产效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T03:13:32Z
- **目录日期**: 2025-04-12
