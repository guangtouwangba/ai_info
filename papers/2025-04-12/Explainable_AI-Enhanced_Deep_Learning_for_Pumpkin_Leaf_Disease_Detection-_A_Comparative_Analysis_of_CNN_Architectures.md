...
南瓜叶病害严重影响农业生产，传统检测方法费时且易出错。本研究使用包含2000张高分辨率图像的南瓜叶病数据集（涵盖霜霉病、白粉病、花叶病、细菌性叶斑病和健康叶片），测试了多种深度学习模型。结果显示ResNet50表现最佳，准确率达90.5%。研究还采用Grad-CAM等可解释AI技术增强模型决策透明度。该成果表明ResNet50能有效实现南瓜叶病的早期精准诊断，为自动化农业病害检测提供了可靠解决方案。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T02:28:16Z
- **目录日期**: 2025-04-12
