...
南瓜叶病害严重影响农业生产，传统人工检测方法效率低且易出错。本研究使用包含2000张高分辨率图像的南瓜叶病害数据集（含霜霉病、白粉病、花叶病、细菌性叶斑病和健康叶片五类），测试了多种深度学习模型。结果表明，ResNet50模型表现最佳，准确率达90.5%，其他指标（精确率、召回率、F1分数）同样出色。研究还采用可解释AI技术（Grad-CAM等）增强模型决策过程的可视化与可信度。该成果为南瓜叶病害的早期精准诊断提供了自动化解决方案，具有重要应用价值。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T00:02:26Z
- **目录日期**: 2025-04-12
