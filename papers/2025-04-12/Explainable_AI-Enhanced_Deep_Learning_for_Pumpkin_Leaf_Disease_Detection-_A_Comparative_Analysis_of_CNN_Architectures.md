...
南瓜叶病害严重威胁农业生产，传统人工检测方法效率低且易出错。本研究利用包含2000张高分辨率图像的南瓜叶病害数据集（涵盖霜霉病、白粉病、花叶病、细菌性叶斑病及健康叶片），测试了多种深度学习模型。结果显示ResNet50表现最优，准确率达90.5%，并具有较高的精确率、召回率和F1分数。研究还采用可解释AI技术（如Grad-CAM等）增强模型决策过程的可视化，提高了自动化诊断的可信度。该成果为南瓜病害早期精准识别提供了有效解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T21:02:20Z
- **目录日期**: 2025-04-12
