...
南瓜叶病害严重影响农业生产，传统人工检测方法效率低且易出错。本研究采用包含2000张高分辨率图像的南瓜叶病害数据集（5类：霜霉病、白粉病、花叶病、细菌性叶斑病和健康叶片），测试了多种深度学习模型。结果显示ResNet50表现最佳，准确率达90.5%，其他指标（精确率、召回率、F1分数）同样优异。研究还应用可解释AI技术（Grad-CAM等）增强模型决策过程的可理解性。该成果表明ResNet50可显著提升南瓜叶病害的自动化检测水平，有助于早期精准防治。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T23:02:18Z
- **目录日期**: 2025-04-12
