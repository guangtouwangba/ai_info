...
南瓜叶病害严重影响农业生产，传统人工检测方法效率低且易出错。本研究使用包含2000张高分辨率图像的南瓜叶病害数据集（含5类病害及健康叶片），测试了多种深度学习模型。结果显示ResNet50表现最佳，准确率达90.5%，其他指标（精确率、召回率、F1分数）同样优异。研究还采用可解释AI技术（Grad-CAM等）增强模型决策透明度。该成果表明ResNet50能有效实现南瓜叶病害的自动化精准检测，有助于早期防治，提升农业管理效率。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T06:02:32Z
- **目录日期**: 2025-04-12
