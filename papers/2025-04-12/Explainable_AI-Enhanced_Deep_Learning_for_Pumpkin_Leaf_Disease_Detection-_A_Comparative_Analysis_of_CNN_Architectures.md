...
南瓜叶病害严重威胁农业生产，传统检测方法耗时且易出错。本研究使用包含2000张高分辨率图像的"南瓜叶病害数据集"，涵盖5类：霜霉病、白粉病、花叶病、细菌性叶斑病和健康叶片。测试多种深度学习模型后发现，ResNet50表现最佳，准确率达90.5%。通过可解释AI技术（Grad-CAM等）解析模型决策过程，提升了自动化诊断的可信度。结果表明ResNet50能有效革新南瓜叶病害检测，实现更早、更精准的病害治理。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T16:02:38Z
- **目录日期**: 2025-04-12
