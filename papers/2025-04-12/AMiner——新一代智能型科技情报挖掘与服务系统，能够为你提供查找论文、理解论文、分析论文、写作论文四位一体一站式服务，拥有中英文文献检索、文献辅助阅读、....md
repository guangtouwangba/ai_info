...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、阅读分析和科研订阅等一站式服务。它收录了3.5亿篇论文、0.6亿学者和1.5亿专利，支持中英文文献检索、AI辅助阅读和自动摘要生成。用户可通过提问快速理解文献内容，上传PDF获取章节概要和问题建议。平台还提供个性化科研动态订阅，根据用户关注的学者、机构或关键词推送最新论文摘要。此外，AMiner具备学者画像、学术会议和论文排行榜等功能，基础服务可免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T00:10:14Z
- **目录日期**: 2025-04-12
