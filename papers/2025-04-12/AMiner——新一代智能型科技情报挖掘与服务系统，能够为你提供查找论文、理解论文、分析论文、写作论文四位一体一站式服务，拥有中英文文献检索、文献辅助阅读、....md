...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、AI辅助阅读、自动摘要生成、翻译及科研情报订阅等功能。它覆盖42个学科的3.5亿论文、0.6亿学者和1.5亿专利，支持用户通过提问快速理解文献内容，并可按需定制最新研究动态推送。平台还提供学者画像、学术会议追踪等工具，基础功能免费开放使用。访问链接：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T12:06:49Z
- **目录日期**: 2025-04-12
