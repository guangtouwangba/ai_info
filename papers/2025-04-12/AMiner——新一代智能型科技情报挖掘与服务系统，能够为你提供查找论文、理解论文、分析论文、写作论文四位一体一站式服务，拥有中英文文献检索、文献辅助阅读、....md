...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、辅助阅读及科研情报订阅等一站式服务。其核心功能包括：1）高效检索3.5亿论文资源，支持互动问答和自动摘要生成；2）AI驱动的文献解析，可上传PDF获取章节概要和智能问答；3）个性化订阅服务，通过微信/邮件推送最新研究动态。平台还涵盖学者画像、学术会议等特色功能，免费开放基础服务。数据库覆盖42个学科，包含1.5亿专利和2600万科研项目，显著提升学术研究效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T18:05:06Z
- **目录日期**: 2025-04-12
