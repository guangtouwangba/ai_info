...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献检索、AI辅助阅读、自动摘要生成和互动问答功能，帮助用户高效获取和理解学术内容。平台还提供科研情报订阅服务，根据用户兴趣推送最新研究动态。此外，AMiner包含学者画像、学术会议和论文排行榜等功能，收录了3.5亿论文、0.6亿学者等海量数据。用户可通过网页免费使用基础功能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T05:05:31Z
- **目录日期**: 2025-04-12
