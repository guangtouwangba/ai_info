...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、AI辅助阅读、自动摘要生成、翻译及科研情报订阅。平台收录42个学科的3.5亿论文、0.6亿学者等海量数据，支持用户通过关键词、学者或机构追踪最新研究动态，并可通过微信或邮件接收定制化摘要。其AI功能还能解析PDF文献，生成章节概要和问答互动，显著提升文献阅读与论文写作效率。基础功能免费开放，访问入口：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T14:05:38Z
- **目录日期**: 2025-04-12
