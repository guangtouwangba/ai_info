...
这篇论文探讨了代码生成大型语言模型（codeLLMs）如何更好地与人类偏好对齐。现有基准主要关注代码正确性，忽视了人类偏好匹配。为此，研究者构建了CodeArena基准（397个高质量样本，覆盖40类44种语言）和SynCode-Instruct语料库（20B标记）。实验发现执行基准与CodeArena存在性能差异，开源顶级模型（如Qwen2.5-Coder）与专有模型（如OpenAI o1）差距显著，凸显了人类偏好对齐的重要性。研究为提升代码LLMs的实际适用性提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T18:05:15Z
- **目录日期**: 2025-04-12
