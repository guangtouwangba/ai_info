...
这篇论文提出了CodeArena基准测试和SynCode-Instruct语料库，以评估代码生成大语言模型(codeLLMs)与人类偏好的对齐程度。CodeArena包含397个高质量样本，覆盖40类编程任务和44种语言，比传统基准更贴近实际需求。研究还构建了近200亿标记的合成指令数据集用于微调验证。实验显示，现有基于执行的评估与人类偏好存在差距，且开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著，突显了模型对齐人类偏好的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T10:05:35Z
- **目录日期**: 2025-04-12
