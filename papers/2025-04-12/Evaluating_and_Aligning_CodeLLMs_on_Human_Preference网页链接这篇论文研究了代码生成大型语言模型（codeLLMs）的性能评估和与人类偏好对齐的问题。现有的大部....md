...
这篇论文提出CodeArena基准测试和SynCode-Instruct语料库，以评估代码生成大模型（codeLLMs）与人类偏好的对齐程度。现有基准主要关注代码正确性，而CodeArena从397个真实编程任务样本出发，覆盖40类任务和44种语言，更贴近实际需求。研究还构建了20B标记的合成指令数据集验证微调效果。实验显示，执行基准与人类偏好评估存在差异，开源模型（如Qwen2.5-Coder）与商业模型（如OpenAI o1）性能差距显著，凸显对齐人类偏好的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T00:10:22Z
- **目录日期**: 2025-04-12
