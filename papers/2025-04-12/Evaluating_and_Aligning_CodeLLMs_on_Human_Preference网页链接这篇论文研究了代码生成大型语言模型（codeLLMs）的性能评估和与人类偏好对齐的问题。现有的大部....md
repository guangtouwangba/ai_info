...
这篇论文针对代码生成大型语言模型(codeLLMs)提出了CodeArena基准测试，关注模型输出与人类偏好的对齐问题。研究者从真实用户查询中收集了397个高质量样本，覆盖40个类别和44种编程语言。同时构建了包含近200亿标记的合成指令数据集SynCode-Instruct用于微调验证。实验发现，传统基于执行的评估与人类偏好存在差异，且开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，凸显了人类偏好对齐的重要性。该研究为提升代码生成模型的实用价值提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T04:05:19Z
- **目录日期**: 2025-04-12
