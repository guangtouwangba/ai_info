...
这篇论文针对代码生成大模型(codeLLMs)与人类偏好对齐的问题，提出了CodeArena基准测试和SynCode-Instruct数据集。CodeArena包含397个高质量编程任务样本，覆盖40个类别和44种语言，模拟真实编程场景；SynCode-Instruct则是一个近200亿标记的合成指令数据集。研究发现现有基于执行的测试与人类偏好存在差距，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著，突显了模型对齐人类偏好的重要性。研究为评估和改进代码生成模型提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T17:05:40Z
- **目录日期**: 2025-04-12
