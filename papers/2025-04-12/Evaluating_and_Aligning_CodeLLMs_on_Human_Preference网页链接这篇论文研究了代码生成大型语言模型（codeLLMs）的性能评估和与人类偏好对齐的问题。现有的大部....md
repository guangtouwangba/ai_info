...
该论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，聚焦模型输出与人类偏好的对齐问题。研究收集397个真实编程任务样本(覆盖40类/44种语言)，并构建20B标记的合成指令集SynCode-Instruct。实验发现：1)传统执行测试与人类偏好存在偏差；2)开源顶级模型(Qwen2.5-Coder)与商业模型(OpenAI o1)性能差距显著。研究强调需超越代码正确性，重视开发者体验优化。基准与数据集已公开，为提升代码LLMs实用性提供新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T21:05:22Z
- **目录日期**: 2025-04-12
