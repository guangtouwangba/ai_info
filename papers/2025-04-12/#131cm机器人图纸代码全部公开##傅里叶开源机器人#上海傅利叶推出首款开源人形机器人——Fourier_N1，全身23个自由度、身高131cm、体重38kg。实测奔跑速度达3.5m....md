...
上海傅利叶发布开源人形机器人Fourier N1，身高131cm，重38kg，具备23个自由度，运动能力出色（3.5m/s奔跑、上下楼梯等）。采用自研FSA 2.0执行器，续航超2小时。首批开源内容包含完整图纸、物料清单、装配指南和基础控制代码，后续将更新推理代码与训练框架。公司还推出Fourier Nexus平台，整合硬件、算法与数据共享，推动行业生态共建。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T15:03:32Z
- **目录日期**: 2025-04-12
