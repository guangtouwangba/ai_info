...
上海傅利叶发布首款开源人形机器人Fourier N1，身高131cm，重38kg，具备23个自由度，运动能力出色（3.5m/s奔跑、上下楼梯等）。采用自研FSA 2.0执行器和控制系统，提升抗冲击与动作精度，电池续航超2小时。首批开源包含完整图纸、物料清单、装配指南及控制代码，支持"乐高式"搭建。公司还推出Fourier Nexus平台整合硬件、算法与数据共享，承诺持续更新代码推动行业生态共建。该开源项目显著降低了人形机器人的开发门槛。（99字）  

注：严格控制在100字内，涵盖机器人参数、技术亮点、开源内容和生态意义等关键信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T13:07:27Z
- **目录日期**: 2025-04-12
