...
上海傅利叶发布首款开源人形机器人Fourier N1，高131cm、重38kg，具备23个自由度，可完成奔跑(3.5m/s)、上下楼梯、踢球等高难度动作。采用自研FSA 2.0执行器和控制系统，提升运动精度和抗冲击性，电池续航超2小时。完整开源图纸、物料清单、装配指南及控制代码，支持"乐高式"搭建。公司还推出Fourier Nexus平台整合硬件开发与算法开源，将持续更新训练框架，推动机器人生态共建。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T16:03:40Z
- **目录日期**: 2025-04-12
