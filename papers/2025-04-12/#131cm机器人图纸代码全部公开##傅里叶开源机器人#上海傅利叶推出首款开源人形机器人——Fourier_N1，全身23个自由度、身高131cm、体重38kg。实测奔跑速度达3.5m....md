...
上海傅利叶发布开源人形机器人Fourier N1，身高131cm，重38kg，具备23个自由度，运动能力出色（3.5m/s奔跑、上下楼梯等）。采用自研FSA 2.0执行器，续航超2小时。首批开源内容包含完整图纸、代码及装配指南，支持"乐高式"搭建。公司还推出Fourier Nexus平台推动行业生态共建，承诺持续更新算法框架。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T14:03:28Z
- **目录日期**: 2025-04-12
