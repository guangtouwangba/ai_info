...
上海傅利叶推出首款开源人形机器人Fourier N1，身高131cm，重38kg，具备23个自由度，奔跑速度达3.5m/s，支持上下楼梯、踢球等复杂动作。采用自研FSA 2.0执行器，续航超2小时。首批开源内容包括完整图纸、物料清单、控制代码等，支持"乐高式"搭建。公司还推出Fourier Nexus平台，整合硬件、算法与数据共享，推动行业生态共建。后续将持续更新代码与训练框架，确保功能可复现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T19:03:09Z
- **目录日期**: 2025-04-12
