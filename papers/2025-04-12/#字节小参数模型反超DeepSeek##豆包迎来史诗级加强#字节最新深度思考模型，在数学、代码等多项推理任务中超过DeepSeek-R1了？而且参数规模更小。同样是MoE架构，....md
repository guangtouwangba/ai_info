...
字节跳动最新发布的Seed-Thinking-v1.5模型在数学、代码等推理任务中表现优于DeepSeek-R1，尽管其参数规模更小。该模型采用MoE架构，总参数200B，激活参数20B，相比DeepSeek-R1的671B总参数和37B激活参数更为轻量。字节团队通过三个方面的优化实现了这一突破。这一进展可能为豆包AI带来显著性能提升。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T07:04:17Z
- **目录日期**: 2025-04-12
