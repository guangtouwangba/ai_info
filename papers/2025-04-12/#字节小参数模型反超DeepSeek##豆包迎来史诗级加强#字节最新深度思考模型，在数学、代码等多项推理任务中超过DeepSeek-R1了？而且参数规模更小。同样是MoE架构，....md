...
字节推出新型推理模型Seed-Thinking-v1.5，采用MoE架构，总参数200B（激活参数20B），在数学、代码等推理任务中表现优于DeepSeek-R1（总参数671B/激活37B）。该模型以更小参数规模实现更强性能，团队通过三方面优化提升AI能力。相关改进或使"豆包"产品获得显著升级。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T03:15:00Z
- **目录日期**: 2025-04-12
