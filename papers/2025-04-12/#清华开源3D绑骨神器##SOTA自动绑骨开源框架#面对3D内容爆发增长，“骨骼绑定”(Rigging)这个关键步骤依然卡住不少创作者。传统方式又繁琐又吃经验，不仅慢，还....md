...
清华大学与VAST联合开源自动骨骼绑定框架UniRig，显著提升3D模型绑骨效率。该框架采用自回归模型逐关节预测骨架结构，创新引入骨骼树Tokenization技术，使处理速度提升30%，支持人形、动物、幻想生物及机械结构。通过1.4万模型数据集Rig-XL训练，UniRig能同步预测蒙皮权重与骨骼物理属性（如刚体/柔体），增强动画真实感。作为当前最先进的自动绑骨方案，其开源将大幅降低3D内容创作门槛。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T21:03:08Z
- **目录日期**: 2025-04-12
