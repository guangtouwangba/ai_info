...
清华大学与VAST团队合作开源了自动3D骨骼绑定框架UniRig，可处理人物、动物、幻想生物及机械结构等多种模型。该框架采用自回归模型逐关节预测骨架，并创新使用骨骼树Tokenization技术，使Transformer处理效率提升30%。UniRig还能预测蒙皮权重和骨骼物理属性，提升动画真实感。其训练基于包含1.4万模型的大型数据集Rig-XL，确保生成骨架的通用性和可靠性，解决了传统绑骨流程复杂、耗时的痛点。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T16:03:30Z
- **目录日期**: 2025-04-12
