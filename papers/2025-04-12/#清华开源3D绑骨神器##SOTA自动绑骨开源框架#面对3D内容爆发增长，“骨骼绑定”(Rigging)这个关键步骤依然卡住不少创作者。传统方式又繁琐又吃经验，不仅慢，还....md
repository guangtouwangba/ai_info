...
清华大学联合VAST团队开源了3D自动骨骼绑定框架UniRig，采用自回归模型逐关节预测骨架结构，创新性引入骨骼树Tokenization技术，使处理效率提升30%。该框架支持人形、动物、幻想生物及机械结构等多种模型，能自动预测蒙皮权重和骨骼物理属性，并通过1.4万模型数据集Rig-XL训练确保通用性。作为当前最先进的自动绑骨方案，UniRig显著降低了3D动画制作门槛，解决了传统手工绑骨效率低、易出错的问题。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T04:02:39Z
- **目录日期**: 2025-04-12
