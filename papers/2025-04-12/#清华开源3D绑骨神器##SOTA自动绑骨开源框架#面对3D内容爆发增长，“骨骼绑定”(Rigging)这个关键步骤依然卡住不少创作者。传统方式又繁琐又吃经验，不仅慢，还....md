...
清华大学与VAST联合发布开源自动骨骼绑定框架UniRig，可处理人、动物、幻想生物及机械结构等多种3D模型。该框架采用自回归模型逐关节预测骨架，创新性引入骨骼树Tokenization技术，使Transformer处理效率提升30%。同时能预测蒙皮权重和骨骼物理属性（如硬度/重力影响），提升动画真实感。基于包含1.4万模型的大型数据集Rig-XL训练，显著简化传统繁琐的手动绑骨流程，为3D内容创作提供高效解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T09:02:56Z
- **目录日期**: 2025-04-12
