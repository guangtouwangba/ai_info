...
清华大学与VAST联合发布开源自动骨骼绑定框架UniRig，突破传统繁琐的3D模型骨骼绑定流程。该框架采用自回归模型逐关节预测骨架结构，创新引入骨骼树Tokenization技术，使处理效率提升30%。支持人形、动物、幻想生物及机械结构，能自动预测蒙皮权重和骨骼物理属性。基于包含1.4万模型的大型数据集Rig-XL训练，确保生成骨架的通用性和准确性，显著降低3D动画制作门槛。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T17:03:17Z
- **目录日期**: 2025-04-12
