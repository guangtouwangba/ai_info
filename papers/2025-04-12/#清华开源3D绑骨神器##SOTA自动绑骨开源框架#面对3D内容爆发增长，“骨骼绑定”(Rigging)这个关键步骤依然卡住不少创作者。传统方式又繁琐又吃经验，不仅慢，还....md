...
清华大学与VAST联合发布开源自动骨骼绑定框架UniRig，可高效处理各类3D模型（包括人、动物、幻想生物及机械结构）。该技术采用自回归模型逐关节预测骨架，并通过创新的骨骼树Tokenization提升30%效率，同时预测蒙皮权重和骨骼物理属性以增强动画真实性。其训练基于包含1.4万模型的Rig-XL数据集，显著降低传统绑骨的技术门槛，为3D创作者提供SOTA级解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T15:03:22Z
- **目录日期**: 2025-04-12
