...
清华大学与VAST联合开源了自动骨骼绑定框架UniRig，能高效处理各类3D模型（包括人、动物、幻想生物和机械结构）。该框架采用自回归模型逐关节预测骨架，创新性地引入骨骼树Tokenization技术，使处理效率提升30%。同时支持蒙皮权重和骨骼属性预测（如刚性和重力影响），提升动画真实感。其训练基于包含1.4万模型的大型数据集Rig-XL，确保生成骨架的通用性和可靠性。该技术解决了传统骨骼绑定流程繁琐、专业门槛高的问题，是3D内容创作的重要突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T08:02:58Z
- **目录日期**: 2025-04-12
