...
清华大学与VAST联合发布开源自动骨骼绑定框架UniRig，显著提升3D模型绑骨效率。该框架采用自回归模型逐关节预测骨架结构，创新性引入骨骼树Tokenization技术，使处理效率提升30%。UniRig支持人形、动物、幻想生物及机械结构等多种模型，并能预测蒙皮权重与骨骼物理属性（如刚体/柔体特性）。其训练基于包含1.4万模型的Rig-XL数据集，确保生成骨架的通用性与准确性，解决了传统绑骨流程繁琐、专业门槛高的问题。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T22:02:59Z
- **目录日期**: 2025-04-12
