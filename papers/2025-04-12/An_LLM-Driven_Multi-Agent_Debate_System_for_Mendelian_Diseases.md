...
研究人员开发了一种新型LLM驱动的多智能体辩论系统MD2GPS，用于提高孟德尔疾病的诊断准确率。该系统通过语言模型将数据驱动和知识驱动代理的结果转化为自然语言，促使两个专业代理进行辩论。在4个独立数据集的1185个样本测试中，TOP1准确率从42.9%提升至66%。在72例疑难病例中，该系统发现了12例患者的潜在致病基因，并将诊断时间缩短90%。该系统的模块化设计使其可适配其他复杂疾病的诊断研究，为精准医疗和胚胎植入前遗传学诊断提供了新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-12T09:01:46Z
- **目录日期**: 2025-04-12
