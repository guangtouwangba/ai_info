...
这篇论文探讨了如何实现"人工科学家"的愿景——能自主开展原创研究并扩展人类知识的AI系统。研究从AlphaGo风格的Othello智能体Olivaw出发，发现其无法解释自身知识，从而提出了"解释性学习"(EL)框架。通过破解科学模拟游戏Zendo，研究发现人工科学家需要自主构建解释语言而非依赖固定解释器。作者进一步分析了多模态模型，提出了一种解耦感知与解释的CLIP类模型构建方法。最后指出ChatGPT等模型在解释Zendo类规则时表现仅随机水平，与人类存在显著差距，并为此设计了新的基准测试任务。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T00:02:09Z
- **目录日期**: 2025-05-05
