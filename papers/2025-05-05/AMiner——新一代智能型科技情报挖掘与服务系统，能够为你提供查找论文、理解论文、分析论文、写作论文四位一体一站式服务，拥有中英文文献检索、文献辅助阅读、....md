...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读辅助、翻译及科研情报订阅等一站式服务。其核心功能包括：1）中英文文献精准检索，支持互动问答和自动摘要生成；2）AI驱动的文献翻译与解析，可上传PDF获取章节概要和智能问答；3）个性化科研动态订阅，按用户偏好推送最新论文。平台覆盖42个学科，包含3.5亿论文、0.6亿学者等海量数据，并免费开放基础功能。特色服务含学者画像、学术会议追踪及论文排行榜，显著提升科研效率。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T21:04:54Z
- **目录日期**: 2025-05-05
