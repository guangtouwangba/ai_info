...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析和写作一站式服务。它支持中英文文献搜索，拥有3.5亿论文和1.5亿专利数据，能自动生成摘要并解答文献相关问题。平台还提供科研动态订阅、学者画像等功能，用户可通过微信或邮件获取定制化学术资讯。AMiner的AI辅助阅读工具可解析PDF文档，帮助用户快速理解论文内容。该平台基础功能免费，适合科研人员高效获取和管理学术信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T13:14:04Z
- **目录日期**: 2025-05-05
