...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务。主要功能包括：1）中英文文献检索，支持3.5亿论文的精准搜索，可自动生成摘要；2）英文文献翻译与辅助阅读，支持PDF上传并智能解析内容；3）科研情报订阅，按用户兴趣推送最新研究动态。平台还包含学者画像、学术会议等特色功能，覆盖42个学科领域。用户可通过网页或微信小程序免费使用，实现高效文献查找、阅读和写作辅助。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T04:06:15Z
- **目录日期**: 2025-05-05
