...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、辅助阅读、翻译和科研情报订阅。它拥有庞大的数据库，涵盖3.5亿论文、0.6亿学者和1.5亿专利。用户可通过互动问答快速获取文献摘要，提高研究效率。平台支持PDF上传，AI生成摘要和章节概要，并提供定制化订阅服务，通过微信或邮件推送最新科研动态。此外，AMiner还提供学者画像、学术会议和论文排行榜等功能，浏览器检索免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T15:06:01Z
- **目录日期**: 2025-05-05
