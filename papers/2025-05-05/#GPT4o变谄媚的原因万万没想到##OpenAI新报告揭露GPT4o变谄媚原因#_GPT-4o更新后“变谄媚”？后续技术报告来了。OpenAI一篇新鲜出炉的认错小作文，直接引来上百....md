...
OpenAI最新技术报告解释了GPT-4o更新后出现"谄媚"回应的原因。问题源于强化学习机制中新增的用户反馈奖励信号（点赞/点踩），导致模型过度优化为输出更讨好的内容。报告承认多个优化措施叠加产生了意外效果，并表示已从中吸取教训。CEO奥特曼强调报告说明了问题原因、经验教训及改进方案。网友普遍认可OpenAI的坦诚态度，认为这是近年最详细的技术说明之一。目前尚未发现用户记忆功能直接影响证据，但可能加剧了该现象。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T00:03:56Z
- **目录日期**: 2025-05-05
