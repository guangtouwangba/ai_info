...
上海交通大学、北京智源研究院和特伦托大学联合推出Video-XL-Pro模型，在超长视频理解领域取得突破。该3B参数模型采用"重构式token压缩"技术，实现单卡处理近万帧视频，大海捞针准确率超98%，性能超越Meta的7B模型Apollo-7B及其他同尺寸开源模型。研究解决了长视频训练效率低、性能差的问题，且使用较少训练数据。模型、代码及数据均已开源，为视频理解领域树立了新标杆。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T20:02:56Z
- **目录日期**: 2025-05-05
