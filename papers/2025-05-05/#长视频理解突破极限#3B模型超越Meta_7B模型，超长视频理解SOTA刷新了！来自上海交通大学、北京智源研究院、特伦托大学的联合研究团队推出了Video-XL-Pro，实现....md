...
上海交通大学、北京智源研究院和特伦托大学联合推出Video-XL-Pro模型，突破长视频理解瓶颈。该3B参数模型采用"重构式token压缩"技术，仅需少量训练数据即可单卡处理近万帧视频，在多个基准测试中超越Meta的7B模型Apollo-7B及同类开源模型，大海捞针准确率达98%以上。相比现有方法，Video-XL-Pro解决了长视频训练规模受限、处理效率低下的问题，性能显著提升。相关代码、模型和训练数据已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T21:02:47Z
- **目录日期**: 2025-05-05
