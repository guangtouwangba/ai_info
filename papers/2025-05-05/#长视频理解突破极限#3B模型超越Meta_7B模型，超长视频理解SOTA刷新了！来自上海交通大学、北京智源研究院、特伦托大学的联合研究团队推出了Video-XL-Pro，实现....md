...
上海交通大学、北京智源研究院和特伦托大学联合推出Video-XL-Pro模型，在长视频理解领域取得突破。该3B参数模型采用"重构式token压缩"技术，实现单卡处理近万帧视频，大海捞针准确率超98%，性能超越Meta的7B模型Apollo-7B及其他同尺寸开源模型。相比现有方法，该方案解决了长视频训练规模小、处理效率低的问题，且使用较少训练数据即达到SOTA水平。项目代码、模型及数据均已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T04:03:42Z
- **目录日期**: 2025-05-05
