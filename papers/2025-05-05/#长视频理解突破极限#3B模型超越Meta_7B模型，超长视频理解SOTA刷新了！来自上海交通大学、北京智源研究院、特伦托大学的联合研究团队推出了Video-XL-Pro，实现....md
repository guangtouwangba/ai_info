...
上海交通大学等机构联合推出Video-XL-Pro模型，通过"重构式token压缩"技术突破长视频处理瓶颈，实现单卡处理近万帧视频（98%准确率）。该3B参数模型在多项基准测试中超越Meta的7B模型Apollo-7B及同类开源模型，使用较少训练数据即达到SOTA性能。研究解决了现有模型在长视频训练中的效率与性能问题，相关代码、模型及数据已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T18:03:03Z
- **目录日期**: 2025-05-05
