# #长视频理解突破极限#3B模型超越Meta 7B模型，超长视频理解SOTA刷新了！来自上海交通大学、北京智源研究院、特伦托大学的联合研究团队推出了Video-XL-Pro，实现...
...
上海交通大学、北京智源研究院和特伦托大学联合推出Video-XL-Pro模型，在长视频理解领域取得突破。该3B参数规模的模型采用创新的"重构式token压缩"技术，实现了单卡处理近万帧视频的能力，在"大海捞针"测试中准确率超过98%。相比Meta的7B模型Apollo-7B及其他同尺寸开源模型表现更优，同时训练数据需求更少。研究团队已开源项目代码、模型和训练数据。这一成果解决了现有模型在长视频训练和应用中面临的性能差、效率低等瓶颈问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T13:11:31Z
- **目录日期**: 2025-05-05
