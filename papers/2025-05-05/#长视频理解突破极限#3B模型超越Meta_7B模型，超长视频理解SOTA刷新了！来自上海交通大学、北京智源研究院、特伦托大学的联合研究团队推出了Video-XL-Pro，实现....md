...
上海交通大学、北京智源研究院和特伦托大学联合推出Video-XL-Pro模型，在超长视频理解领域取得突破。该3B参数模型采用"重构式token压缩"技术，实现单卡处理近1万帧视频的能力，在"大海捞针"测试中准确率超98%。相比Meta的7B模型Apollo-7B及其他同尺寸开源模型表现更优，且训练数据需求更少。研究解决了现有模型在长视频训练和应用中的性能与效率瓶颈，相关代码、模型和数据均已开源。这一成果刷新了长视频理解的SOTA水平。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T15:03:27Z
- **目录日期**: 2025-05-05
