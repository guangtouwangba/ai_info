...
上海交通大学、北京智源研究院和特伦托大学联合推出Video-XL-Pro模型，在长视频理解领域取得突破。该3B参数模型采用"重构式token压缩"技术，实现单卡处理近万帧视频，大海捞针准确率超98%，性能超越Meta的7B模型Apollo-7B及同类开源模型。相比现有方法，Video-XL-Pro解决了长视频训练规模受限、处理效率低下的问题，且训练数据需求更少。模型已在多项基准测试中刷新SOTA，相关代码、模型和数据均已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T16:03:20Z
- **目录日期**: 2025-05-05
