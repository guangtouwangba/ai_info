...
华中大与北邮团队推出首个纯多模态开源大模型Perception-R1（PR1），在COCO2017 val set上以突破30AP的表现超越YOLOv3等经典模型。该模型通过基于规则的强化学习优化视觉感知能力，在物体检测、OCR和计数任务中表现突出，其感知策略优化框架显著提升了多模态大模型在复杂视觉任务中的精度。实验显示PR1在visual grounding等任务中优于专用模型，展现了强大的可扩展性，为AI视觉感知发展提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T07:03:52Z
- **目录日期**: 2025-05-05
