...
华中大与北邮团队联合推出多模态大模型Perception-R1（PR1），首次在纯多模态开源LLM中突破30AP，性能超越YOLOv3和Faster-RCNN等经典模型。PR1采用基于规则的强化学习优化视觉感知能力，在COCO2017数据集上展现出卓越的物体检测、OCR和计数能力。实验显示，PR1在视觉定位、OCR及Pixmo-Count等任务中超越专用模型，具有强可扩展性。该研究为AI视觉感知发展奠定新基础，推动多模态模型理解能力的边界突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T12:03:47Z
- **目录日期**: 2025-05-05
