...
华中大与北邮团队推出多模态大模型PR1，首次突破30AP性能指标，超越YOLOv3、Faster-RCNN等传统视觉模型。该模型通过基于规则的强化学习优化视觉感知能力，在COCO2017验证集上展现出卓越的物体检测、OCR和计数性能。实验显示PR1在visual grounding等任务中优于专用模型，具有优秀的可扩展性。这一突破为AI视觉感知发展奠定基础，推动多模态模型理解能力的边界。研究成果已开源，标志着多模态LLM在复杂视觉任务中的应用取得重要进展。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T17:03:27Z
- **目录日期**: 2025-05-05
