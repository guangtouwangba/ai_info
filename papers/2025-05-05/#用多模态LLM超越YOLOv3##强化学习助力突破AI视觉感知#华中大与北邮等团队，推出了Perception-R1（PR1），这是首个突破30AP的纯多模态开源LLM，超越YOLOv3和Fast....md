...
华中大与北邮团队推出多模态大模型Perception-R1（PR1），首次以纯多模态LLM架构在COCO2017验证集上突破30AP，超越YOLOv3和Faster-RCNN等传统模型。该模型通过基于规则的强化学习优化视觉感知能力，在物体检测、OCR和计数任务中表现优异。实验显示PR1在visual grounding、OCR及Pixmo-Count等任务中优于专用模型，展现出强大的可扩展性。这一突破为AI视觉感知发展奠定新基础，推动多模态模型理解能力的边界。研究成果已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T01:30:44Z
- **目录日期**: 2025-05-05
