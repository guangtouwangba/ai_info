...
华中大与北邮团队联合推出多模态大语言模型Perception-R1（PR1），首次在纯多模态开源模型中突破30AP，性能超越YOLOv3和Faster-RCNN等经典模型。该模型通过基于规则的强化学习优化视觉感知能力，在COCO2017验证集上展现出卓越的物体检测、OCR和计数性能。实验显示PR1在视觉定位、OCR及Pixmo-Count等任务中优于专用模型，具有突出的可扩展性。这一突破为AI视觉感知发展奠定新基础，推动多模态模型理解能力的边界。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T13:12:02Z
- **目录日期**: 2025-05-05
