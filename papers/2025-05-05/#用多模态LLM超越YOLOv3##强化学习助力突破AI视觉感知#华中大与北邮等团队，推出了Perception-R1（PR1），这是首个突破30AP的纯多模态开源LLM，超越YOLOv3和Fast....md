...
华中大与北邮团队推出多模态大模型PR1，首次突破30AP性能，超越YOLOv3和Faster-RCNN等经典模型。PR1采用基于规则的强化学习优化视觉感知能力，在COCO2017数据集上表现优异，尤其在物体检测、OCR和计数任务中显著领先。实验显示，PR1在视觉定位、OCR等任务中超越专用模型，展现出强大的扩展性。该研究为AI视觉感知发展奠定新基础，推动多模态模型理解能力的边界。成果已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T14:03:49Z
- **目录日期**: 2025-05-05
