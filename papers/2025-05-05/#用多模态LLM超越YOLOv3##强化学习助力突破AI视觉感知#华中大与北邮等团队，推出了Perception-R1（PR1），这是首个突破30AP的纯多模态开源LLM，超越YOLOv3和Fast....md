...
华中大与北邮团队联合推出多模态大模型Perception-R1（PR1），首次在纯多模态开源LLM中突破30AP，性能超越YOLOv3和Faster-RCNN等经典模型。PR1采用基于规则的强化学习优化视觉感知，在COCO2017验证集上表现出色，尤其在物体检测、OCR和计数任务中表现突出。实验显示，PR1在visual grounding等任务中超越专用模型，展现出优秀的可扩展性。该研究为AI视觉感知发展奠定基础，推动了多模态模型理解视觉信息的边界。成果已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T09:03:41Z
- **目录日期**: 2025-05-05
