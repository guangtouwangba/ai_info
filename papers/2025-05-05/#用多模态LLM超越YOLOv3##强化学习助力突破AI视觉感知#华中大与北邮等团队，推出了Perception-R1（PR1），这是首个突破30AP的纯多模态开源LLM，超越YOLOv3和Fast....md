...
华中大与北邮团队联合推出多模态大模型Perception-R1（PR1），首次在纯多模态开源LLM中突破30AP性能，超越YOLOv3、Faster-RCNN等传统视觉模型。通过基于规则的强化学习优化视觉感知，PR1在COCO2017验证集上展现出卓越的物体检测、OCR和计数能力。实验显示其性能优于专用模型，尤其在visual grounding、OCR和Pixmo-Count任务中表现突出。该研究突破多模态感知极限，为AI视觉理解奠定新基础，相关成果已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T18:03:32Z
- **目录日期**: 2025-05-05
