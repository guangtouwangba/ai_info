...
华中大与北邮团队联合推出多模态大模型Perception-R1（PR1），首次在纯多模态开源LLM中突破30AP，性能超越YOLOv3和Faster-RCNN等经典视觉模型。PR1创新性地采用基于规则的强化学习优化视觉感知能力，在COCO2017验证集上展现出卓越的物体检测、OCR和计数性能。实验表明，PR1在视觉定位、文字识别等任务中优于专用模型，展现了出色的可扩展性。该研究为突破AI视觉感知极限提供了新思路，推动了多模态模型理解复杂视觉信息的能力发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T05:03:43Z
- **目录日期**: 2025-05-05
