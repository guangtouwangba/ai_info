...
华中大与北邮团队推出多模态大模型Perception-R1（PR1），首次突破30AP性能指标，超越YOLOv3、Faster-RCNN等传统视觉模型。该模型采用基于规则的强化学习优化视觉感知能力，在COCO2017验证集上表现优异，尤其在物体检测、OCR和计数任务中展现出卓越性能。实验显示PR1在视觉定位、文字识别等任务中超越专用模型，具有强可扩展性，为AI视觉感知领域树立了新基准，推动了多模态模型理解视觉信息的边界。研究成果已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T03:21:05Z
- **目录日期**: 2025-05-05
