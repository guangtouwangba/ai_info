...
华中大与北邮团队推出多模态大模型Perception-R1（PR1），首次突破30AP指标，超越YOLOv3、Faster-RCNN等传统视觉模型，在COCO2017验证集表现优异。该模型通过基于规则的强化学习优化视觉感知能力，在物体检测、OCR和计数任务中显著领先。实验显示PR1在视觉定位、文字识别等任务上优于专用模型，展现了强大的可扩展性。这一突破为AI视觉感知发展奠定新基础，推动多模态模型理解能力的边界。研究成果已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T06:03:29Z
- **目录日期**: 2025-05-05
