...
本文研究了多智能体系统的模式形成控制问题，系统由给定的交互拓扑建模，其中n个智能体中的m个被选为领导者，每个领导者添加控制信号。智能体通过图的拉普拉斯动力学进行交互。模式形成控制问题被表述为一个内在的无限时间线性二次最优控制问题，目标函数中不包含误差信息。在温和条件下，证明了最优控制策略的存在性和收敛到期望模式。基于最优策略，提出了一种分布式控制策略以实现给定模式。数值模拟验证了理论结果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T05:02:11Z
- **目录日期**: 2025-05-05
