...
这篇论文研究了多智能体系统的模式形成控制问题。系统由n个智能体组成，其中m个被选为领导者并施加控制信号。智能体通过图上的拉普拉斯动力学相互作用。该问题被表述为一个内在无限时域线性二次最优控制问题，目标函数中不包含误差信息。在温和条件下，研究证明了最优控制策略的存在性和向期望模式收敛的特性。基于此，论文提出了一种分布式控制策略来实现给定模式。数值模拟验证了理论结果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T18:02:07Z
- **目录日期**: 2025-05-05
