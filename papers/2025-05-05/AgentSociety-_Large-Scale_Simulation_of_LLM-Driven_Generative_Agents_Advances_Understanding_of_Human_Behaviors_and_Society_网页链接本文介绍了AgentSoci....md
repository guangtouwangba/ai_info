...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟10,000多个智能代理的社会互动（达500万次）。该系统通过真实社会环境模拟，研究了四大社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。实验结果显示其模拟结果与现实世界数据高度吻合，验证了系统在捕捉人类行为机制方面的有效性。该平台为社会科学研究和政策制定提供了新工具，能够补充传统研究方法（如调查和访谈），帮助深入理解社会问题的成因和潜在机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T00:05:23Z
- **目录日期**: 2025-05-05
