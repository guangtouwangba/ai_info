...
AgentSociety是一个基于大语言模型(LLM)的大规模社会模拟器，能够模拟超过1万个AI代理的社会互动(500万次交互)。研究者利用该平台研究了四个关键社会问题：社会极化、信息传播、基本收入政策效果和自然灾害影响。模拟结果与现实世界数据高度吻合，验证了该系统在捕捉人类行为机制方面的有效性。这项技术为社会科学研究和政策制定提供了新的实验工具，能够补充传统研究方法(如调查和访谈)，帮助深入理解社会问题的成因和潜在机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T01:32:45Z
- **目录日期**: 2025-05-05
