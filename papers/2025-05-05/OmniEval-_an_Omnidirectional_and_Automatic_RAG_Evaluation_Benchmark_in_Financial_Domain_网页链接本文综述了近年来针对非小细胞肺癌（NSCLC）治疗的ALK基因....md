...
本文综述了针对非小细胞肺癌(NSCLC)ALK基因双靶点抑制剂的最新研究进展。ALK基因是NSCLC的重要致癌驱动靶点，尽管已有7种ALK抑制剂获批，但耐药性问题仍待解决。双靶点抑制剂通过单一分子同时作用于两个靶点，相比联合用药能减少副作用和毒性，在克服耐药性方面更具优势。文章总结了基于ALK的双靶点抑制剂在NSCLC治疗中的发展，分析了其合理设计及构效关系，为开发新型ALK抑制剂和创新治疗策略提供了重要参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T17:04:30Z
- **目录日期**: 2025-05-05
