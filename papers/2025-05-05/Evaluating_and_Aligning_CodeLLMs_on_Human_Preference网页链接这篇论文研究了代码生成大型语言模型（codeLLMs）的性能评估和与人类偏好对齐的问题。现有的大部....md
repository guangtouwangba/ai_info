...
这篇论文针对代码生成大模型(codeLLMs)与人类偏好对齐的问题，提出了CodeArena基准测试和SynCode-Instruct指令数据集。CodeArena包含397个高质量编程任务样本，覆盖40个类别和44种语言，更贴近实际开发需求。研究发现在40多个模型中，开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)存在显著差距，凸显了人类偏好对齐的重要性。同时，近200亿标记的SynCode-Instruct验证了合成指令微调的有效性。该工作为评估和改进代码生成模型提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T09:05:56Z
- **目录日期**: 2025-05-05
