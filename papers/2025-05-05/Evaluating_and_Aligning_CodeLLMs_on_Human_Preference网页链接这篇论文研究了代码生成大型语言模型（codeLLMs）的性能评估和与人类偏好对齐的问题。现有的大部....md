...
这篇论文针对代码生成大模型(codeLLMs)与人类偏好对齐的问题，提出了CodeArena基准测试和SynCode-Instruct合成指令集。CodeArena包含397个高质量样本，覆盖40类任务和44种编程语言，更贴近实际开发需求。研究发现传统基于执行的评估与人类偏好存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究还验证了大规模合成指令微调的有效性，强调了对齐人类偏好在代码生成评估中的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T10:06:05Z
- **目录日期**: 2025-05-05
