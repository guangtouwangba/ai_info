...
这篇论文探讨了代码生成大模型(codeLLMs)与人类偏好的对齐问题。研究者创建了CodeArena基准测试，包含397个高质量样本，覆盖40个类别和44种编程语言，更贴近实际编程场景。同时开发了SynCode-Instruct合成指令数据集(近200亿标记)验证大规模微调效果。实验发现：1)传统执行基准与CodeArena存在性能差异；2)开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)差距显著。研究强调了代码LLMs不仅需要正确性，还需符合人类编程习惯和偏好。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T02:34:46Z
- **目录日期**: 2025-05-05
