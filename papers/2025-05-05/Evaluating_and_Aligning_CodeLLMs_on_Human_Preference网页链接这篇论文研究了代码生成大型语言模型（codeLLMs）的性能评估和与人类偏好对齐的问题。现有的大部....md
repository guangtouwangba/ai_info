...
该论文针对代码生成大模型(codeLLMs)提出新的评估方法，指出当前基准测试过于关注代码正确性而忽视人类偏好。研究者构建了CodeArena基准(包含397个高质量样本，覆盖40类任务和44种语言)和SynCode-Instruct语料库(近200亿标记)来评估模型表现。实验发现执行基准与CodeArena存在性能差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)差距显著，凸显了与人类偏好对齐的重要性。研究证实大规模合成指令微调的有效性，为代码LLM评估提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T01:33:19Z
- **目录日期**: 2025-05-05
