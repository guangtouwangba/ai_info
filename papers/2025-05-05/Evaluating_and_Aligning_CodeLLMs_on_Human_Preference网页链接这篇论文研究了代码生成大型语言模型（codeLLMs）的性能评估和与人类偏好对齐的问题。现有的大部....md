...
这篇论文针对代码生成大模型(codeLLMs)提出新评估框架CodeArena，强调与人类偏好对齐的重要性。研究创建了包含397个高质量样本的基准测试，覆盖40类编程任务和44种语言，并构建近200亿标记的合成指令数据集SynCode-Instruct。实验发现传统执行基准与人类偏好存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究突出了代码生成模型在实用性和人类偏好匹配方面的关键挑战，为改进模型对齐提供了新方向。(99字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T11:06:06Z
- **目录日期**: 2025-05-05
