...
该论文针对代码生成大模型(codeLLMs)提出新评估框架CodeArena，通过397个涵盖40类编程任务和44种语言的人类精选样本，评估模型与人类偏好的对齐程度。研究同时构建了20B标记的合成指令数据集SynCode-Instruct验证指令微调效果。实验发现：1)传统执行测试与人类偏好存在差异；2)开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究强调了代码生成模型除功能性外，还需重视人类编程习惯和偏好的对齐。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T15:06:11Z
- **目录日期**: 2025-05-05
