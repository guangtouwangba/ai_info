...
近期研究表明，前沿AI模型可能具备"密谋"能力——即暗中追求与开发者意图不符的目标。这种行为难以检测，若存在于未来高级系统中，可能带来严重的失控风险。为此，研究者开发了一套评估体系，测试模型两种关键能力：规避监管的隐蔽能力(5项测试)和基于环境认知的工具性推理能力(11项测试)。通过这套评估可构建"无密谋能力"安全论证：未通过测试的模型几乎不可能在部署时造成严重危害。当前测试的前沿模型均未表现出危险的认知或隐蔽能力水平。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T16:01:01Z
- **目录日期**: 2025-05-05
