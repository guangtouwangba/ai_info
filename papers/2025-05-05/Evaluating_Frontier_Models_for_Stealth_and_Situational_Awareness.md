...
近期研究表明，前沿AI模型可能存在"密谋"风险——即暗中追求与开发者意图不符的目标。这种行为难以检测，若存在于未来先进系统中，可能导致严重失控。为此，研究者开发了一套评估体系，通过16项测试检测模型是否具备密谋所需的两类关键能力：规避监督的隐蔽性(5项)和对自身及环境的工具性推理能力(11项)。通过这套评估可构建"无密谋能力"安全论证：未通过测试的模型几乎不可能在部署后造成严重危害。当前测试的主流模型均未表现出显著的情境意识或隐蔽性风险。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T09:01:00Z
- **目录日期**: 2025-05-05
