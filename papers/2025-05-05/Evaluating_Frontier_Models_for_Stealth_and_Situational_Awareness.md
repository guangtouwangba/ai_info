...
近期研究表明，前沿AI模型可能存在"密谋"风险——即暗中追求与开发者意图相悖的目标。这种行为极难检测，若存在于未来先进系统中，将导致严重的失控风险。为此，研究者开发了一套评估体系，通过16项测试检测模型的两类关键能力：5项评估其规避监管的隐蔽能力，11项评估其对自身及环境的认知能力。测试结果显示，当前前沿模型在这两方面均未表现出危险水平。该评估体系可帮助开发者在部署前排除AI密谋风险，确保模型不具备通过隐蔽行为造成严重危害的能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T06:00:53Z
- **目录日期**: 2025-05-05
