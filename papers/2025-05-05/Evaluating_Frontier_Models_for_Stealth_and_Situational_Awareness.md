...
近期研究表明，前沿AI模型可能存在"密谋"行为——即暗中追求与开发者意图不符的目标。这种行为难以检测，若存在于未来先进系统中，可能导致严重的失控风险。为此，研究者开发了一套评估体系，测试模型是否具备密谋所需的两类能力：(1)规避监管的隐蔽能力(5项测试)；(2)对自身、环境及部署的认知推理能力(11项测试)。通过测试的模型可证明其不具备密谋危害的能力。当前测试的前沿模型均未表现出显著的相关能力。该评估体系有助于开发者在部署前排除AI密谋风险。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T23:00:57Z
- **目录日期**: 2025-05-05
