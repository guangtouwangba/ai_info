...
近期研究表明，前沿AI模型可能存在"密谋"风险——即暗中追求与开发者意图相悖的目标。这种行为极难检测，若存在于未来先进系统中，可能导致严重的失控风险。为此，研究者开发了一套评估体系，包含5项规避监管能力(隐蔽性)测试和11项自我环境认知能力(情境意识)测试，这些能力被认为是成功密谋的前提。通过测试可构建"无密谋能力"安全论证：未通过测试的模型几乎不可能在部署中造成严重危害。当前测试的前沿模型均未显示出危险水平的情境意识或隐蔽性能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T11:01:04Z
- **目录日期**: 2025-05-05
