...
TARL是一种创新方法，通过建模心率时间序列中的关键子序列（shapelets）结构关系来早期检测患者恶化。它构建了shapelet转换知识图谱，捕捉病情进展和未来变化趋势，并引入转换感知知识嵌入来强化shapelet间关联及量化缺失值影响，从而生成全面的心率表征。这些表征能解释病情结构并预测未来心率趋势，辅助早期诊断。基于ICU患者可穿戴设备心率数据和临床诊断指标的实验表明，TARL兼具高可靠性和早期检测能力。案例研究验证了其可解释性，展现了作为AI工具帮助临床识别患者恶化早期迹象的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T18:01:51Z
- **目录日期**: 2025-05-05
