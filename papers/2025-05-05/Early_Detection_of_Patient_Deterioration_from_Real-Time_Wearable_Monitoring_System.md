...
本文提出了一种名为TARL的创新方法，用于通过可穿戴设备监测心率数据，实现患者病情恶化的早期检测。TARL通过建模心率时间序列中关键子序列（shapelets）的结构关系，构建知识图谱来追踪病情发展，并引入转移感知嵌入技术处理缺失值，形成全面的心率表征。该方法不仅能解释心率变化结构，还能预测未来趋势。通过与医护人员合作收集ICU患者数据验证，TARL展现出高可靠性和早期预警能力。案例研究证实了其可解释性，表明其作为AI辅助工具帮助临床识别早期恶化征兆的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T08:01:58Z
- **目录日期**: 2025-05-05
