...
本文提出了一种名为TARL的创新方法，用于通过可穿戴设备的心率数据早期检测患者病情恶化。TARL通过建模心率时间序列中关键子序列（shapelets）的结构关系，构建知识图谱来追踪病情发展。该方法采用转移感知知识嵌入技术，强化shapelet间关联并量化缺失值影响，从而生成全面的心率表征，预测未来趋势。与医护人员合作收集的ICU患者数据显示，TARL兼具高可靠性和早期检测能力。案例研究验证了其可解释性，表明该AI工具有助于临床医生识别患者早期恶化征兆，降低死亡率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T10:02:01Z
- **目录日期**: 2025-05-05
