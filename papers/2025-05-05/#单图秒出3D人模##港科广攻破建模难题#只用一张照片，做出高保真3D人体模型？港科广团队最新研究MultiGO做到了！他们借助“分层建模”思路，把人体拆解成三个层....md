...
香港科技大学广州团队提出MultiGO方法，仅需单张照片即可生成高保真3D人体模型。该研究采用分层建模策略，将人体分解为骨架、关节和衣物褶皱三个层级，通过骨架增强、关节扰动和皱纹去噪三项关键技术，实现从整体轮廓到细节纹理的精准重建。相比传统模板方法，MultiGO在CustomHuman和THuman3.0测试集中表现优异，精度指标全面领先。该技术可应用于虚拟试衣、角色定制等领域，研究成果已入选CVPR 2025并即将开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T08:02:54Z
- **目录日期**: 2025-05-05
