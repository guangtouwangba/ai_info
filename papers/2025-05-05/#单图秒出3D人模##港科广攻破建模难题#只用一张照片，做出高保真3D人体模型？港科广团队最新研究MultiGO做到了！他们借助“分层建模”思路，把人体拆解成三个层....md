...
香港科技大学广州分校团队提出MultiGO方法，通过分层建模（骨架、关节、衣物褶皱三层次）实现单张照片生成高保真3D人体模型。该技术采用骨架增强、关节扰动训练和皱纹去噪扩散模型三大创新，显著提升细节精度和骨骼准确性，在CustomHuman和THuman3.0测试集表现领先。研究入选CVPR 2025，适用于虚拟试衣、影视特效等领域。代码即将开源，突破传统模板方法的局限性。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T07:02:50Z
- **目录日期**: 2025-05-05
