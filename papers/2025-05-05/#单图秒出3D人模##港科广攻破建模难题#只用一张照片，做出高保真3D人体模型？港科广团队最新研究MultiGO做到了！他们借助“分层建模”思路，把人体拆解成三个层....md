...
香港科技大学广州分校团队提出MultiGO方法，仅需单张照片即可生成高保真3D人体模型。该技术采用分层建模策略，将人体分解为骨架、关节和衣物褶皱三个层级，通过骨架增强、关节扰动和皱纹去噪三大创新方法优化细节处理。相比传统依赖模板的方法，MultiGO在CustomHuman和THuman3.0测试集中精度领先，解决了骨骼不准、细节缺失等难题。该技术可应用于虚拟试衣、影视特效等领域，研究已被CVPR 2025收录并将开源代码。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T15:02:57Z
- **目录日期**: 2025-05-05
