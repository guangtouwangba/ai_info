...
香港科技大学广州分校团队提出MultiGO方法，仅需单张照片即可生成高保真3D人体模型。该技术采用分层建模策略，将人体分解为骨架、关节和衣物褶皱三个层级，通过骨架增强、关节扰动和皱纹去噪三阶段优化，显著提升建模精度。相比传统模板方法，MultiGO在CustomHuman和THuman3.0测试集中表现优异，细节可达亚毫米级。该研究入选CVPR 2025，代码即将开源，可应用于虚拟试衣、影视特效等领域。分层递进的设计使模型从整体轮廓到微观细节都更接近真实人体。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T06:02:30Z
- **目录日期**: 2025-05-05
