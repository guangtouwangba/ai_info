...
港科广团队提出MultiGO方法，仅需单张照片即可生成高保真3D人体模型。该技术采用分层建模思路，将人体分解为骨架、关节和衣物褶皱三个层级逐步细化：通过骨架增强实现精准对齐，关节扰动提升抗误差能力，皱纹去噪优化细节表现。在CustomHuman和THuman3.0测试中精度领先，解决了传统模板方法细节缺失、骨骼不准的问题。该成果入选CVPR 2025，可应用于虚拟试衣、角色定制等领域，代码即将开源。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T21:02:20Z
- **目录日期**: 2025-05-05
