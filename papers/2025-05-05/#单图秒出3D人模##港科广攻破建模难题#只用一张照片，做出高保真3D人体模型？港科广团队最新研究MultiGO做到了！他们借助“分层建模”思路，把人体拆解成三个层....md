...
香港科技大学广州分校团队提出MultiGO方法，仅需单张照片即可生成高保真3D人体模型。该技术采用分层建模策略，将人体分解为骨架、关节和衣物褶皱三个层级，通过骨架增强、关节扰动和皱纹去噪三大创新方法，显著提升建模精度。相比传统基于模板的方法，MultiGO在CustomHuman和THuman3.0测试集中表现优异，细节可达亚毫米级。该技术可应用于虚拟试衣、角色定制等领域，研究已被CVPR 2025收录并将开源代码。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T23:02:30Z
- **目录日期**: 2025-05-05
