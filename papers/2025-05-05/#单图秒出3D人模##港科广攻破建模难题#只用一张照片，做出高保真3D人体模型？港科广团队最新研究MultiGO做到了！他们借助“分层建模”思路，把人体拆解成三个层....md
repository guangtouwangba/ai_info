...
港科广团队提出MultiGO方法，仅需单张照片即可生成高保真3D人体模型。该技术采用分层建模策略，将人体分解为骨架、关节和衣物褶皱三个层级，通过骨架增强、关节扰动和皱纹去噪三大创新模块逐步优化细节。相比依赖预训练模板的传统方法，MultiGO在CustomHuman和THuman3.0测试集中精度全面领先，能实现亚毫米级细节还原。该成果已入选CVPR 2025，可应用于虚拟试衣、角色定制等领域，代码即将开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T19:02:25Z
- **目录日期**: 2025-05-05
