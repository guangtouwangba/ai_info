...
香港科技大学广州团队提出MultiGO方法，通过分层建模实现单张照片生成高保真3D人体模型。该方法将人体分解为骨架、关节和衣物褶皱三个层级，采用骨架增强（3D傅里叶特征投影）、关节扰动（抗误差训练）和皱纹去噪（扩散模型）三项关键技术，显著提升建模精度。在CustomHuman和THuman3.0测试集中表现优异，适用于虚拟试衣、影视特效等领域。该研究入选CVPR 2025，代码即将开源。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T16:02:45Z
- **目录日期**: 2025-05-05
