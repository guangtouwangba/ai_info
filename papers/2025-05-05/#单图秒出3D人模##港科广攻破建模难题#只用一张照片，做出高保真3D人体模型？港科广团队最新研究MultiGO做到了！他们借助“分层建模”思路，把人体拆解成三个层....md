...
香港科技大学广州团队提出MultiGO方法，通过"分层建模"实现单图生成高保真3D人体模型。该方法将人体分解为骨架、关节和衣物褶皱三个层级：1）骨架增强技术利用3D傅里叶特征和SMPL-X模板精准对齐；2）关节扰动训练提升模型抗误差能力；3）扩散模型处理衣物细节。在CustomHuman和THuman3.0测试集上表现优异，精度指标全面领先。该技术可应用于虚拟试衣、角色定制等领域，研究已入选CVPR 2025并将开源代码。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T17:02:30Z
- **目录日期**: 2025-05-05
