...
华中科技大学与北京邮电大学等团队联合推出多模态大模型Perception-R1（PR1），首次在COCO2017验证集上突破30AP，超越YOLOv3和Faster-RCNN等传统视觉模型。该研究通过基于规则的强化学习（RL）增强多模态感知能力，聚焦纯视觉任务（目标检测、计数）和视觉语言任务（OCR、定位）。PR1展现了感知策略的显著潜力，论文与模型已开源，旨在为社区提供强大基线。这一成果标志着多模态LLM在感知层面的突破，为后续研究奠定基础。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T07:04:22Z
- **目录日期**: 2025-05-05
