...
华中科技大学与北京邮电大学等团队联合推出多模态大模型Perception-R1（PR1），首次在COCO2017验证集上突破30AP，超越YOLOv3和Faster-RCNN。PR1结合基于规则的强化学习（RL），显著提升了纯视觉（目标检测、计数）和视觉语言（OCR、grounding）任务的感知能力。该研究为多模态感知领域提供了开源基准模型，展示了强化学习在优化模型感知策略上的潜力。论文与代码已公开，旨在推动后续研究发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T15:04:27Z
- **目录日期**: 2025-05-05
