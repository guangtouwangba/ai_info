...
华中科技大学与北京邮电大学等团队联合推出多模态大语言模型Perception-R1（PR1），首次在COCO2017验证集上以纯多模态方法突破30AP，超越YOLOv3和Faster-RCNN。该研究通过基于规则的强化学习（RL）增强模型感知能力，聚焦视觉推理基础任务（目标检测、计数）及视觉语言任务（OCR、grounding）。实验表明PR1在感知策略上具有显著潜力，相关论文与模型已开源，旨在为多模态研究提供强基线。这一成果标志着强化学习在多模态感知领域的突破性进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T06:03:57Z
- **目录日期**: 2025-05-05
