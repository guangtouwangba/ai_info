...
华中科技大学、北京邮电大学等团队联合推出多模态大模型Perception-R1（PR1），首次在COCO2017验证集上突破30AP，超越YOLOv3和Faster-RCNN。该研究探索基于规则的强化学习（rule-based RL）对模型感知能力的提升，聚焦纯视觉任务（目标检测、计数）和视觉语言任务（OCR、grounding）。PR1展现了在多模态感知策略上的突破性潜力，论文与模型已开源，旨在为社区提供强大基准。这一成果标志着多模态LLM在基础感知层面的重大进展，为后续研究开辟新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T01:31:16Z
- **目录日期**: 2025-05-05
