...
华中科技大学与北京邮电大学等团队联合推出多模态大模型Perception-R1（PR1），首次在COCO2017验证集上突破30AP，超越YOLOv3和Faster-RCNN。该研究聚焦纯视觉（目标检测、计数）和视觉语言（OCR、grounding）任务，通过基于规则的强化学习（RL）优化模型感知模式，显著提升多模态感知性能。论文与模型已开源，旨在为社区提供强基线支持后续研究。实验证明PR1在感知策略上具有巨大潜力，标志着多模态LLM在视觉推理基础层面的重要突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T23:03:45Z
- **目录日期**: 2025-05-05
