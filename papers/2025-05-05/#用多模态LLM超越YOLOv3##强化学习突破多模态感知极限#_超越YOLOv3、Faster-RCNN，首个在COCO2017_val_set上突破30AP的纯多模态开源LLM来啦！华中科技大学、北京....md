...
华中科技大学与北京邮电大学等团队联合推出多模态大模型Perception-R1（PR1），首次在COCO2017验证集上突破30AP，超越YOLOv3和Faster-RCNN。PR1通过基于规则的强化学习增强视觉感知能力，专注于纯视觉（目标检测、计数）和视觉语言（定位、OCR）任务，展现出多模态感知策略的潜力。该研究开源了论文与模型，旨在为社区提供强大的基线支持后续探索。成果标志着多模态LLM在基础感知层面的突破，为强化学习与视觉推理结合提供了新方向。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T03:21:31Z
- **目录日期**: 2025-05-05
