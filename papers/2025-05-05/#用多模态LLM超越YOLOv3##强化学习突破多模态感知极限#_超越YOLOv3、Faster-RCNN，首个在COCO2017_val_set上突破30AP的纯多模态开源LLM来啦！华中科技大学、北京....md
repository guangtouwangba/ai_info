...
华中科技大学与北京邮电大学等团队联合推出多模态大模型Perception-R1（PR1），首次在COCO2017验证集上以纯多模态方法突破30AP，超越YOLOv3和Faster-RCNN。该研究通过基于规则的强化学习（RL）增强模型感知能力，聚焦视觉（目标检测、计数）和视觉语言（定位、OCR）任务，展现了多模态感知策略的潜力。论文与模型已开源，旨在为社区提供强基准支持后续研究。成果标志着多模态LLM在基础感知层面的重大突破，为视觉推理领域开辟新方向。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T16:04:25Z
- **目录日期**: 2025-05-05
