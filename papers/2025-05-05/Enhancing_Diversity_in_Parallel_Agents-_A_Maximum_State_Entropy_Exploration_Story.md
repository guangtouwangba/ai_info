...
并行数据收集通过让N个相同智能体在环境模拟器中同时运行，将数据收集速度提升N倍。本文提出了一种新颖的学习框架，通过最大化并行收集数据的熵，平衡个体智能体的熵与智能体间的多样性，减少冗余。该方法采用集中式策略梯度算法，在实验中优于相同智能体系统，并能与批量强化学习技术协同利用数据多样性。理论分析表明，专业化并行采样分布具有更快的收敛速度，验证了方法的有效性。这一框架为超越N倍加速提供了可能，并可能引发独立研究兴趣。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T15:01:34Z
- **目录日期**: 2025-05-05
