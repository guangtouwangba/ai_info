...
本文研究了非相对论量子力学中的剪切势理论，重点分析了谐振子和对称势阱|x|两种典型情况。研究不仅确定了能谱，还探讨了剪切过程对本征函数的影响，揭示了本征函数变化对能谱特征的理解具有关键作用。此外，文章还讨论了能谱变化与实现这种变化所需外力做功之间的联系。通过本征函数的深入分析，弥补了文献中常被忽视的方面，为剪切势家族的特性提供了更深刻的认识。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T23:01:50Z
- **目录日期**: 2025-05-05
