...
本研究探讨了非相对论量子力学中的剪切势理论，重点分析了两种典型势场（谐振子势和对称|x|势阱）在剪切变换下的能谱变化及对相应本征函数的影响。研究发现，剪切后的本征函数特性为理解能谱特征提供了新视角，弥补了现有文献在此方面的研究空白。此外，研究还讨论了能谱变化与实现这种变化所需外力做功之间的关联关系。通过系统研究剪切势家族，该工作深化了对量子系统在形变势场中行为特征的理解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T21:01:42Z
- **目录日期**: 2025-05-05
