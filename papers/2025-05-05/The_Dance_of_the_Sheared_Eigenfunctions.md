...
本文研究了非相对论量子力学中的剪切势理论，重点分析了谐振子和对称势阱|x|两种典型情况。研究不仅确定了能谱，还探讨了剪切过程对本征函数的影响，揭示了本征函数特征对能谱关键特性的深层解释。此外，文章还讨论了能谱变化与实现这种变化所需外力做功之间的关系。这项研究填补了文献中对剪切本征函数分析的空白，为理解剪切势体系提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T12:02:03Z
- **目录日期**: 2025-05-05
