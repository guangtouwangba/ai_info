...
本文研究了非相对论量子力学中的剪切势理论，重点分析了谐振子和对称势阱|x|两种典型情况。研究不仅确定了能谱，还探讨了剪切过程对本征函数的影响，填补了文献中相关分析的空白。研究发现剪切后的本征函数能更深入揭示能谱特征。最后，作者讨论了能谱变化与实现这种变化所需外力做功之间的关系。这项工作为理解剪切势系统的量子特性提供了新的理论见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T16:02:01Z
- **目录日期**: 2025-05-05
