...
本文研究了非相对论量子力学中的剪切势理论，重点分析了谐振子和对称势阱|x|两种典型情况。研究不仅确定了能谱，还深入探讨了剪切过程对本征函数的影响，这一常被文献忽略的分析揭示了能谱主要特征的深层机制。最后，作者讨论了剪切势族能谱变化与实现这种变化所需外力做功之间的关系。通过本征函数分析，研究为剪切势系统的光谱特性提供了新的理解视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T07:02:04Z
- **目录日期**: 2025-05-05
