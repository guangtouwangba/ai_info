...
家庭能源管理系统（HEMS）是智能家居中的关键工具，旨在提升能效、降低成本并优化用户舒适度。传统方法常以静态权重因子处理用户舒适度，忽略了动态偏好。本文提出一种基于深度强化学习（DRL）的多模式HEMS框架（DRL-HEMS），通过动态学习用户偏好实现优化。该模型采用无模型单智能体DRL算法，结合电价、环境温度等实时数据，在15分钟间隔下验证。结果显示，DRL-HEMS在能耗优化和计算效率上均优于传统混合整数线性规划（MILP）方法，同时保持用户友好性。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T04:02:40Z
- **目录日期**: 2025-05-05
