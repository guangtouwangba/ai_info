...
这篇综述系统性地探讨了AI系统中的记忆机制，特别关注基于大语言模型(LLM)的智能体。研究首先将记忆表征分为参数化、结构化上下文和非结构化上下文三类，然后提出六种核心记忆操作：巩固、更新、索引、遗忘、检索和压缩。通过将这些操作映射到长期记忆、长上下文、参数修改和多源记忆等研究领域，该综述为AI记忆研究提供了结构化视角，同时梳理了相关基准数据集和工具。最后指出了未来研究方向，相关资源已在GitHub开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T00:01:30Z
- **目录日期**: 2025-05-05
