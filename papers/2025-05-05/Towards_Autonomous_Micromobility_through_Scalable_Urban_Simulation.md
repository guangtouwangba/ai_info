...
这篇摘要介绍了一种名为URBAN-SIM的可扩展城市模拟解决方案，用于推进自主微移动技术。URBAN-SIM是一个高性能机器人学习平台，包含三个关键模块：分层城市生成、交互式动态生成和异步场景采样，以提高机器人学习的多样性、真实性和效率。同时，作者提出了URBAN-BENCH基准测试套件，包含基于城市移动、导航和穿越三大核心技能的八项任务，用于评估AI代理在自主微移动中的能力。实验评估了轮式和腿式等不同形态机器人在各种地形和城市结构中的表现，揭示了各自的优势和局限性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T01:28:36Z
- **目录日期**: 2025-05-05
