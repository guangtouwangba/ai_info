...
德里是全球空气污染最严重的城市之一，主要污染源包括交通尾气、工业排放和建筑扬尘。传统静态空气净化装置因位置不佳和适应性差而效果有限。本研究提出一种深度强化学习（DRL）框架，利用近端策略优化（PPO）算法，根据人口密度、交通流量、工业影响和绿地分布等空间环境因素，优化空气净化亭的布局。相比随机和基于AQI的贪婪方法，DRL方法在多维评估指标（如AQI改善、空间覆盖率和空间熵）上表现更优，实现了净化效果与覆盖范围的平衡，为智慧城市和数据驱动的空气质量治理提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T00:01:43Z
- **目录日期**: 2025-05-05
