...
机器学习（ML）系统的快速增长要求更全面地评估其环境影响，特别是碳足迹，包括训练和推理产生的运行碳排放，以及硬件制造和全生命周期产生的隐含碳排放。针对缺乏量化与优化ML系统总碳足迹的工具，研究提出CATransformers框架，通过碳感知架构搜索，将运行和隐含碳排放纳入硬件加速器设计空间探索，实现可持续性驱动的联合优化。该框架应用于多模态CLIP模型，生成CarbonCLIP模型家族，在保持精度和延迟的同时，总碳排放比前沿边缘小CLIP基线降低达17%。该研究强调需采用整体优化方法设计高性能且环保的AI系统。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T07:01:12Z
- **目录日期**: 2025-05-05
