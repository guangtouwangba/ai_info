...
这篇摘要探讨了机制可解释性(MI)的核心问题——"什么是好的解释?"。研究提出了一个基于科学哲学的多元解释美德框架，整合了贝叶斯、库恩、德意志和规范四种视角来系统评估MI中的解释。研究发现"紧凑证明"方法能兼顾多种解释美德，是很有前景的方向。该框架指出了三个关键研究方向：(1)明确定义解释的简洁性，(2)聚焦统一性解释，(3)推导神经网络的通用原理。改进MI方法将提升我们监控、预测和引导AI系统的能力。研究为评估神经网络解释提供了理论基础。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T11:01:23Z
- **目录日期**: 2025-05-05
