...
这篇摘要讨论了机制可解释性(MI)的核心问题——"什么是好的解释"。作者提出了一个基于科学哲学的多元解释美德框架，整合了贝叶斯、库恩、德意志和法则论四种视角，用于系统评估和改进MI中的解释。研究发现，紧凑证明(Compact Proofs)因涵盖多种解释美德而具有潜力。框架还指出三个研究方向：(1)明确定义解释简洁性，(2)关注统一性解释，(3)推导神经网络的通用原则。改进的MI方法将增强我们监控、预测和引导AI系统的能力。该研究为评估神经网络解释提供了理论基础。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T08:01:28Z
- **目录日期**: 2025-05-05
