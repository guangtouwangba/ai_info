...
本文探讨了机制可解释性(MI)的核心问题——"什么是好的解释"，并提出了基于科学哲学的多元解释美德框架（包括贝叶斯、库恩、德意志和法则学视角），用于系统评估和改进MI中的解释。研究发现，紧凑证明(Compact Proofs)能兼顾多种解释美德，是一种有前景的方法。该框架指出了三个关键研究方向：(1)明确定义解释的简洁性，(2)聚焦统一性解释，(3)推导神经网络的通用原则。改进的MI方法将提升我们监控、预测和引导AI系统的能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-05T17:01:16Z
- **目录日期**: 2025-05-05
