...
豆包编程能力升级后，用户可以在3分钟内制作专属小游戏。新功能包括HTML代码实时预览、Python代码运行以及生成完整项目。示例小游戏包括点击匹配中英文泡泡消除单词、随机抽取生日祝福语以及完成测试题生成MBTI人格。此外，豆包新增了运行按钮，支持在内部直接运行Python代码。这些升级显著提升了编程效率和用户体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-20T01:33:12Z
- **目录日期**: 2025-03-20
