...
Meta首席AI科学家Yann LeCun在英伟达GTC大会上表示，AI不会取代人类，而是作为人类的“超级工具”或“超级助手”，最终的决策权仍掌握在人类手中。他强调，AI的可靠性是当前研究的重点，而非其智能水平。LeCun认为，AI的滥用（如生成错误信息或被恶意利用）才是真正的风险。这一观点与Sam Altman和马斯克等人对超级智能潜在威胁的警告形成鲜明对比。LeCun认为，AI的发展将逐步推进，而非突然出现超级智能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-20T12:02:59Z
- **目录日期**: 2025-03-20
