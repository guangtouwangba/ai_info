...
Meta首席AI科学家Yann LeCun在英伟达GTC大会上表示，AI不会取代人类，而是作为人类的“超级工具”或“超级助手”，最终的决策权仍掌握在人类手中。他强调，AI的滥用（如生成错误信息或恶意利用）是当前的主要风险，而非AI变得过于聪明。LeCun的观点与Sam Altman和马斯克等人对超级智能潜在威胁的警告形成对比，他认为超级智能的出现不会一蹴而就，AI的“可靠性”才是研究的重点。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-20T15:03:07Z
- **目录日期**: 2025-03-20
