...
字节跳动与清华AIR联合实验室SIA Lab推出了一种名为DAPO的关键RL算法，该算法在AIME 2024基准测试中表现优异，仅通过RL训练便使Qwen2.5-32B模型获得50分，超越了使用GRPO算法的DeepSeek-R1-Zero-Qwen，且训练步数减少了50%。该算法的通讯作者和开源项目负责人是禹棋赢，一位2001年出生的哈工大本科毕业生，现为清华AIR直博生，并在字节跳动的“Top Seed人才计划”中担任实习生，负责RL方向的研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-20T17:01:29Z
- **目录日期**: 2025-03-20
