...
在英伟达GTC大会上，OpenAI研究负责人Noam Brown表示，某些AI推理方法其实20年前就能实现，只是当时未找到正确方法。他提到，AI需要像人类一样进行复杂思考，而不是单纯依赖算力。Brown曾主导的Pluribus项目展示了AI通过“思考”策略在扑克比赛中战胜人类选手的能力。他还提到，学术界虽面临计算资源不足的挑战，但仍有机会通过优化模型架构和评测基准来与大公司竞争，特别是在改进当前存在问题的AI评测体系方面。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-20T12:03:29Z
- **目录日期**: 2025-03-20
