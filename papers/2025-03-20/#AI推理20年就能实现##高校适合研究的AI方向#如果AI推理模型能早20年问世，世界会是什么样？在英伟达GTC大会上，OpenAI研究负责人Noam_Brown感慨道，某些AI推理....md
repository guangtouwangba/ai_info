...
在英伟达GTC大会上，OpenAI研究负责人Noam Brown指出，某些AI推理方法其实20年前就能实现，但当时缺乏正确的方法。他提到，AI需要像人类一样进行“思考”策略，而非单纯依赖算力。Brown曾主导的Pluribus项目展示了AI在扑克比赛中战胜人类的能力。他还提到，学术界虽面临计算资源不足的挑战，但仍有机会通过探索高效模型架构和优化AI评测基准与大公司竞争。当前的AI评测体系存在问题，学术界可深度参与改进。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-20T07:01:08Z
- **目录日期**: 2025-03-20
