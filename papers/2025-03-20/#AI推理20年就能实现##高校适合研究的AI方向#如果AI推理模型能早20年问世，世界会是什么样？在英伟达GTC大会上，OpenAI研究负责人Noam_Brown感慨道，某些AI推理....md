...
在英伟达GTC大会上，OpenAI研究负责人Noam Brown表示，某些AI推理方法其实20年前就能实现，只是当时方法不当。他提到，AI需要像人类一样进行深度思考，而非仅依赖算力。Brown曾主导的Pluribus项目展示了AI通过“思考”策略在扑克比赛中战胜人类选手的能力。他还参与了“推理式推断”技术的研发，使AI在回答前进行额外计算，提升推理能力。尽管学术界面临计算资源不足的挑战，Brown认为仍有机会通过优化模型架构和评测基准与大公司竞争。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-20T18:02:58Z
- **目录日期**: 2025-03-20
