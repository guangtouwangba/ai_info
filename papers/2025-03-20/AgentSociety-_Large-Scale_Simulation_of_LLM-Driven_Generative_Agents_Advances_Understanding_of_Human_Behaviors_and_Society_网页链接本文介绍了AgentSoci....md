...
本文介绍了AgentSociety，一个结合大型语言模型（LLM）驱动代理、真实社会环境和强大模拟引擎的大规模社会模拟器。通过模拟超过1万个代理及其500万次互动，研究者探讨了极化现象、信息传播、无条件基本收入政策及外部冲击等社会问题。AgentSociety不仅与传统研究方法（如调查、访谈）相辅相成，还能有效捕捉人类行为及其内在机制，结果与现实世界实验高度吻合，展示了其作为社会科学研究和政策制定工具的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-20T20:03:14Z
- **目录日期**: 2025-03-20
