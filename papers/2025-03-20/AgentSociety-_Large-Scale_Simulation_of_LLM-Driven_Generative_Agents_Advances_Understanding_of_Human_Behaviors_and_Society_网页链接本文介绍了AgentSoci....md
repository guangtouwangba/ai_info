...
本文介绍了AgentSociety，一种大规模社会模拟器，结合大型语言模型驱动的代理、真实社会环境和强大的模拟引擎，模拟了超过1万个代理的社会生活及其500万次互动。研究者利用该平台探讨了极化现象、信息传播、无条件基本收入政策及外部冲击（如飓风）等社会问题。AgentSociety的结果与现实世界实验吻合，展示了其在捕捉人类行为和社会机制方面的能力，并证明了其作为社会科学研究和政策制定工具的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-20T15:04:20Z
- **目录日期**: 2025-03-20
