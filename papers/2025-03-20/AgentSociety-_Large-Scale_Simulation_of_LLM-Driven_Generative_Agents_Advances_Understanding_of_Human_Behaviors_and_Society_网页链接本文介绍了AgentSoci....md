...
本文介绍了AgentSociety，一种大规模社会模拟器，结合大型语言模型驱动的代理、真实社会环境和强大的模拟引擎，模拟了超过1万个代理的社会生活及500万次互动。研究聚焦于极化现象、信息传播、无条件基本收入政策和外部冲击等社会问题，评估其与传统研究方法的互补性。AgentSociety的结果与现实世界实验吻合，展示了其在捕捉人类行为和社会机制方面的能力，成为社会科学研究和政策制定的重要工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-20T11:04:18Z
- **目录日期**: 2025-03-20
