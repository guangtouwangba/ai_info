...
有效的人机协作不仅依赖于AI遵循明确指令的能力，还要求其能够处理沟通中的模糊性、不完整性、无效性和无关性。研究提出了一种整合Gricean准则（数量、质量、关联、方式）和认知框架（共同基础、关联理论、心智理论）的规范性框架，应用于基于大语言模型（LLM）的智能体。实验通过GPT-4驱动的Lamoid智能体在网格世界任务中评估了该框架的效果。结果表明，采用Gricean准则的Lamoid在任务准确性和生成清晰、相关且上下文准确的回应方面表现更优，显著提升了人机协作的效率和语境感知能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-20T01:29:00Z
- **目录日期**: 2025-03-20
