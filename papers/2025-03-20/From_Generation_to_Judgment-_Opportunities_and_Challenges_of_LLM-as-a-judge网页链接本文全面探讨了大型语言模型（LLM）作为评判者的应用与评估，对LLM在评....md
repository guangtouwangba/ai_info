...
本文探讨了大型语言模型（LLM）作为评判者在评分、排名和选择等任务中的应用与评估。文章从输入和输出角度定义了LLM评判者的概念，并从评判内容、方式和领域三个维度构建了分类体系。最后，文章总结了评估LLM评判者的基准，并指出了关键挑战和潜在研究方向，旨在为这一新兴领域提供见解并激发未来研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-20T06:06:06Z
- **目录日期**: 2025-03-20
