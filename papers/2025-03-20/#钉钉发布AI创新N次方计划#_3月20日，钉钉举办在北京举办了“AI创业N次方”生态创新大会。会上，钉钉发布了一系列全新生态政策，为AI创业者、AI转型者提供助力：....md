...
钉钉于3月20日在北京举办了“AI创业N次方”生态创新大会，发布了一系列支持AI创业者和转型者的新政策，包括免除佣金、入驻保证金和算力费用，并在销售、品牌、技术和投资等方面提供支持。钉钉副总裁王铭强调，钉钉将继续开放其平台，支持AI生态建设，提供丰富的客户场景和稳定的协作平台。此外，钉钉还发布了《AI创业行动指南》，为AI创业者提供详细指导。目前，已有超过220万家企业在钉钉上使用AI，覆盖多个行业。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-20T17:02:20Z
- **目录日期**: 2025-03-20
