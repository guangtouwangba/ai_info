...
ByteCraft通过微调7B参数的Qwen2.5模型，成功实现了AI直接生成可执行二进制文件的能力。尽管目前生成的文件存在画面简单、动画异常、玩法单一等问题，且上下文长度仅32KB，生成的文件大小最高约140KB，部分程序可能存在闪屏现象，但其潜力巨大。研究人员表示，未来在更多计算资源和更长上下文长度的支持下，ByteCraft有望实现100%输出可用文件，甚至自动编写复杂多样的游戏。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-20T11:02:36Z
- **目录日期**: 2025-03-20
