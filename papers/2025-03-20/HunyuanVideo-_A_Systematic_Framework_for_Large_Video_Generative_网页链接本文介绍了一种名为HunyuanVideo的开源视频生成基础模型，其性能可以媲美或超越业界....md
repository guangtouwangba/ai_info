...
本文介绍了HunyuanVideo，一个开源的大规模视频生成基础模型，其性能可与或超越领先的闭源模型。HunyuanVideo通过数据筛选、高级架构设计、渐进式模型扩展与训练等关键要素，成功训练了一个超过130亿参数的视频生成模型，成为开源模型中规模最大的一个。该模型在视觉质量、运动动态、文本-视频对齐和高级拍摄技术方面表现出色，超越了多个先进模型。研究者公开了基础模型及其应用代码，旨在缩小闭源与开源社区的差距，推动视频生成生态系统的发展。相关代码已在GitHub公开。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-20T01:26:55Z
- **目录日期**: 2025-03-20
