...
本文介绍了Florence-VL，一种新型的多模态大型语言模型（MLLM），通过集成生成性视觉基础模型Florence-2来增强视觉表征。与传统的CLIP风格视觉变换器不同，Florence-2能捕捉多层次视觉特征，适应多种任务。研究团队设计了深度-广度融合（DBFusion）方法，有效融合视觉特征到预训练语言模型Phi 3.5和LLama 3中。Florence-VL在多种多模态和视觉基准测试中表现优异，特别是在视觉语言对齐方面。模型和训练方法已开源，促进未来研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-20T14:05:56Z
- **目录日期**: 2025-03-20
