...
随着AI在医疗、教育、法律等领域的影响力不断扩大，确保AI系统的治理合法性成为关键问题。文章指出，当前的"宪法AI"虽通过编码明确原则提升了透明度和问责，但仍存在决策不透明和缺乏民主合法性的局限。为此，作者提出"公共宪法AI"，倡导让公众参与制定AI发展原则，形成具有民意基础的"AI宪法"。同时建议设立"AI法庭"发展"AI判例法"，通过具体案例落实宪法原则。这种结合民主审议和案例演进的治理模式，旨在使AI系统更符合公共利益，赋予自动化决策真正的民主合法性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T15:02:35Z
- **目录日期**: 2025-05-15
