...
随着AI在医疗、教育、法律等领域的广泛应用，确保其决策合法性成为关键问题。文章提出，现有"宪法AI"虽通过编码原则提升透明度，但仍存在决策不透明和民主合法性不足的缺陷。为此，作者建议"公共宪法AI"模式：通过公众参与制定AI宪法原则，并设立"AI法庭"形成判例法，使AI治理更符合公共价值观。这一民主协商框架旨在赋予AI系统真正的合法性，使其决策与公共利益保持一致。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T21:02:07Z
- **目录日期**: 2025-05-15
