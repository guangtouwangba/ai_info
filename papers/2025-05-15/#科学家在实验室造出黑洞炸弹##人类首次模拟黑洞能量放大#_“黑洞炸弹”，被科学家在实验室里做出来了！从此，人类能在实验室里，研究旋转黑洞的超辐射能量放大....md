...
南安普敦大学团队首次在实验室验证了"黑洞炸弹"理论。他们用旋转金属圆柱体模拟黑洞的超辐射效应，通过电磁波反射实现能量放大，观测到电压信号指数级增长。该实验证实了1970年代Zel'dovich的预言：旋转物体与电磁波相互作用可提取能量。虽然目前能量级别微小（毫焦耳），但为研究黑洞物理开辟了新途径，未来或应用于暗物质探测和清洁能源开发。这项突破性研究将理论物理带入了可实验验证的新阶段。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T22:03:33Z
- **目录日期**: 2025-05-15
