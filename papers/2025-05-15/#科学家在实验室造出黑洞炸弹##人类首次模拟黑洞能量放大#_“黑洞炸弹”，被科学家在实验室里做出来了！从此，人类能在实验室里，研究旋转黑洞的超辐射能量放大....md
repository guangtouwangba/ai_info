...
南安普敦大学团队首次在实验室验证了"黑洞炸弹"理论。他们用旋转金属圆柱体模拟黑洞的超辐射效应，观测到电磁波能量被放大并指数级增长的现象。该实验证实了1970年代Zel'dovich提出的理论：旋转物体与电磁波相互作用可提取能量。虽然当前能量级别微小（毫焦耳），但为研究黑洞物理开辟了新途径。未来或可用于暗物质探测，甚至开发真空能源。这项突破性研究发表在《Scientific American》上，标志着人类首次在实验室成功模拟黑洞能量放大过程。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T21:03:57Z
- **目录日期**: 2025-05-15
