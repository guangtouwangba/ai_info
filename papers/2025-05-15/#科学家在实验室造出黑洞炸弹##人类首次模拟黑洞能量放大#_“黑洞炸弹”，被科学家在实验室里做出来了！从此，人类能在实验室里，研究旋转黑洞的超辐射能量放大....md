...
南安普敦大学团队首次在实验室验证了"黑洞炸弹"理论，利用旋转金属圆柱体观测到超辐射效应（能量放大过程）。该实验证实了1970年代提出的理论：旋转物体可通过特定机制从真空中提取能量。虽然当前能量级别微小（毫焦耳），但为研究黑洞物理开辟了新途径。未来或应用于暗物质探测，甚至开发清洁能源。这一突破性成果发表在《科学美国人》上，标志着基础物理研究的重要进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T20:04:15Z
- **目录日期**: 2025-05-15
