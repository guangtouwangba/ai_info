...
南安普敦大学团队首次在实验室验证了"黑洞炸弹"理论。他们用旋转金属圆柱体模拟黑洞的ergosphere区域，通过电磁场和反射装置观测到超辐射效应——入射波能量被放大并指数级增长，证实了1970年代Zel'dovich的预言。虽然当前能量仅毫焦耳级别，但该突破为研究黑洞物理开辟了新途径，未来或应用于暗物质探测甚至真空能源开发。这项研究实现了数十年来科学家在实验室模拟黑洞能量放大的设想。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T17:03:58Z
- **目录日期**: 2025-05-15
