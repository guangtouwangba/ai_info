...
南安普敦大学团队首次在实验室验证了"黑洞炸弹"理论。他们用旋转金属圆柱体模拟旋转黑洞，通过电磁波与圆柱体相互作用，观测到了能量放大的"超辐射效应"。该实验证实了1970年代物理学家提出的理论：旋转物体可通过特定机制从真空中提取能量。虽然当前实验能量微小(毫焦耳级)，但为研究黑洞物理开辟了新途径。未来或可用于暗物质探测，甚至开发清洁能源。这项突破性研究发表在《Scientific American》上。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T16:04:08Z
- **目录日期**: 2025-05-15
