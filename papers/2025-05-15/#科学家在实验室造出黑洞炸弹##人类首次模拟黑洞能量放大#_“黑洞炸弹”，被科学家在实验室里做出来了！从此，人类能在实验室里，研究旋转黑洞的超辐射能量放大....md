...
南安普敦大学团队首次在实验室验证了"黑洞炸弹"理论。他们用旋转金属圆柱体模拟黑洞的超辐射效应，观测到电压信号指数级增长，证实了1970年代Yakov Zel'dovich的预言。该实验虽能量微小（毫焦耳级），但验证了旋转黑洞能量放大机制，为研究黑洞物理开辟新途径。未来或可用于暗物质探测，甚至开发真空能源。这项突破性研究将复杂天体物理现象带入实验室尺度，为基础物理研究提供了全新实验平台。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T23:03:43Z
- **目录日期**: 2025-05-15
