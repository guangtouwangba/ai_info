...
美国东北大学学生Ella Stapleton因教授使用AI制作课件却未告知，要求退还8000美元学费，引发AI在教育中的使用争议。调查显示，2023年18%的教师常用AI，2024年比例翻倍。教师们认为AI能减轻负担，但使用界限模糊，有人公开使用，有人隐瞒。学校最终驳回退费请求，要求标注AI内容并人工审核。该事件凸显AI在教育中的矛盾：学生质疑支付高额学费是否值得，而教师需平衡效率与透明度。教授承认应更谨慎使用AI并明确告知学生。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T17:03:38Z
- **目录日期**: 2025-05-15
