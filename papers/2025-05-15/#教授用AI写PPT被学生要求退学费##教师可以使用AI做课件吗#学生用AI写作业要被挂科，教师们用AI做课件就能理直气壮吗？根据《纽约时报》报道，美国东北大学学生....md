...
美国东北大学学生Ella Stapleton因教授使用AI制作课件却未告知，要求退还8000美元学费。事件源于她发现课件中保留的ChatGPT指令及AI生成痕迹（如异常配图、拼写错误）。该教授禁止学生用AI，自己却使用，引发争议。调查显示，2024年35%的美国教师常用AI，较2023年翻倍。教师们对AI使用界限意见不一：有人公开使用AI批改作业，有人则隐瞒。该校最终驳回退费请求，但要求标注AI内容并人工审核。该教授承认需更谨慎使用AI并明确告知学生。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T10:03:47Z
- **目录日期**: 2025-05-15
