...
美国东北大学学生Ella Stapleton因教授使用AI制作课件却未告知，要求退还8000美元学费。事件源于她在讲义中发现ChatGPT指令和AI痕迹，而该教授此前禁止学生使用AI。这反映了教育界对AI使用的争议：教师普遍用AI减轻负担（2023年18%→2024年近翻倍），但缺乏使用规范。校方驳回退费请求，新规要求标注AI内容并人工审核。涉事教授承认应更谨慎，需明确告知学生AI使用情况。该事件凸显了AI在教育中透明度与公平性的核心矛盾。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T20:03:56Z
- **目录日期**: 2025-05-15
