...
美国东北大学学生Ella Stapleton因教授使用AI生成课件却未告知，要求退还8000美元学费。她发现课件中包含ChatGPT指令、扭曲文本和错误配图，而该教授此前禁止学生使用AI。事件引发教育界对AI使用的争议：教师普遍用AI减轻教学负担（2024年使用率较2023年翻倍至36%），但对使用边界存在分歧。校方驳回退费但出台新规，要求标注AI内容并人工审核。涉事教授承认应更谨慎透明地使用AI。该事件凸显AI在教育中引发的公平性和透明度问题。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T12:03:55Z
- **目录日期**: 2025-05-15
