...
美国东北大学学生Ella Stapleton因教授使用AI制作课件却未告知，要求退还8000美元学费。事件引发对教育界AI使用的争议：学生质疑教师禁止AI却自行使用，认为高学费不应购买AI生成内容。调查显示2024年教师AI使用率较2023年翻倍至36%，用途包括课件制作、作业批改等，但规范尚未统一。校方驳回退费请求，新规要求标注AI内容并人工审核。涉事教授承认需更谨慎使用AI并明确告知学生。事件反映AI在教育领域引发的公平性与透明度矛盾。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T13:11:08Z
- **目录日期**: 2025-05-15
