...
美国东北大学学生Ella Stapleton因教授使用AI生成课件却未告知，要求退还8000美元学费。她发现课件中留有ChatGPT指令、扭曲文本和错误图片。该事件反映了教育界对AI使用的争议：教师普遍用AI减轻负担（2023年18%→2024年近翻倍），但学生质疑其正当性。校方驳回退费请求，新规要求标注AI内容并人工审核。涉事教授承认应更谨慎使用AI并明确告知学生。该案例凸显AI在教育中引发的公平性和透明度问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T18:03:54Z
- **目录日期**: 2025-05-15
