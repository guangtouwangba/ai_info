...
美国东北大学学生Ella Stapleton因教授使用AI制作课件却未告知，要求退还8000美元学费。她发现课件中留有ChatGPT指令、异常配图和拼写错误。尽管学校驳回请求并出台新规要求标注AI内容，事件折射出教育界对AI使用的争议。调查显示，教师AI使用率从2023年18%升至2024年近翻倍。支持者视AI为减轻教学负担的工具，反对者质疑其透明度与质量。该教授承认需更谨慎使用AI并明确告知学生，凸显AI在教育中需平衡效率与伦理的挑战。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T14:03:03Z
- **目录日期**: 2025-05-15
