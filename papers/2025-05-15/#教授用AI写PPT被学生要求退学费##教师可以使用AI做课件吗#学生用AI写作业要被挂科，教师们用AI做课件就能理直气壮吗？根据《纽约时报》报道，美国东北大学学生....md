...
美国东北大学学生Ella Stapleton因教授使用AI制作课件却未告知，要求退还8000美元学费。她发现课件中保留ChatGPT指令、扭曲文本和错误配图，质疑教授禁止学生用AI却自己使用。调查显示，2024年近36%教师常用AI，引发教育界对AI使用边界的争议。部分教师认为AI可减轻负担，但需透明使用；也有人反对或隐瞒。该校驳回退费请求，新规要求标注AI内容并人工审核。涉事教授承认应更谨慎，并明确告知学生AI使用情况。事件凸显AI在教育中的伦理矛盾。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T15:03:58Z
- **目录日期**: 2025-05-15
