...
Anthropic即将推出新版Claude模型（Sonnet和Opus版本），主打"极限推理"功能。该功能通过动态循环结合推理与工具使用，能像人类一样暂停、反思并调整策略，尤其在代码生成时会自动测试修正。新模型架构更具适应性，减少对人类监督的依赖，支持128k上下文长度。消息源自The Information，另有用户发现代号"Claude Neptune"的测试模型（疑似Claude 3.8）。虽然部分网友质疑炒作，但Anthropic官方已确认正在进行新版本压力测试，预计未来几周发布。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T21:02:59Z
- **目录日期**: 2025-05-15
