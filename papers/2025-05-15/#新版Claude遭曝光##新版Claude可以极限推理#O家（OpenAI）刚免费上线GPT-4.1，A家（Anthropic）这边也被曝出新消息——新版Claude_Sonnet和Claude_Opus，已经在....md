# #新版Claude遭曝光##新版Claude可以极限推理#O家（OpenAI）刚免费上线GPT-4.1，A家（Anthropic）这边也被曝出新消息——新版Claude Sonnet和Claude Opus，已经在...
...
Anthropic即将推出新版Claude Sonnet和Claude Opus模型，主打"极限推理"功能。该功能通过动态循环结合推理与工具使用，能像人类一样暂停、评估并调整解题策略，尤其在代码生成时会自动测试修正。新模型支持128k tokens上下文，采用更接近人类思维的协作式推理架构，减少对人工监督的依赖。尽管部分网友质疑炒作，但The Information的报道和用户实测的Claude Neptune模型（疑似Claude 3.8）佐证了升级真实性。Anthropic官方已启动新版本压力测试，预计数周内发布。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T15:03:26Z
- **目录日期**: 2025-05-15
