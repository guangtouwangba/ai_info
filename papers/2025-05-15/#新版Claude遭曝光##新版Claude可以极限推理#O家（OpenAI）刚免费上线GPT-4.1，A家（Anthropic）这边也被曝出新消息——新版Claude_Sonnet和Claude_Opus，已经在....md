...
Anthropic即将推出新版Claude模型（Sonnet和Opus），主打"极限推理"功能。该功能通过动态循环结合推理与工具使用，能像人类一样暂停思考、重新评估问题并调整策略。新模型具备128k上下文长度，可自动测试和修正代码错误，减少对人类监督的依赖。消息源自The Information，同时有用户发现正在测试的Claude Neptune模型（疑似Claude 3.8）。虽然部分网友质疑炒作，但Anthropic官方已确认正在进行新版本压力测试。预计新版将在未来几周发布。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T14:02:33Z
- **目录日期**: 2025-05-15
