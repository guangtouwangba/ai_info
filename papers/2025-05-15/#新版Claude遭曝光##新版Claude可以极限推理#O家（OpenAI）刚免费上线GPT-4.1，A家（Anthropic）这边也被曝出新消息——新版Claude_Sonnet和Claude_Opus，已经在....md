...
Anthropic即将发布新版Claude模型（Sonnet和Opus），主打"极限推理"功能。该功能通过动态循环结合推理与工具使用，能像人类一样暂停、反思并调整策略，尤其在代码生成时会自动测试修正。新模型架构更智能，减少人工监督依赖，支持128k tokens（疑似Claude 3.8/Neptune）。消息源自The Information，部分用户已发现实测迹象，官方也确认在进行压力测试。尽管存在炒作质疑，但新模型的类人推理能力值得期待，预计未来几周发布。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T18:03:27Z
- **目录日期**: 2025-05-15
