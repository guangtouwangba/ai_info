...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统模拟了1万多个AI代理的社会生活，记录它们之间及与环境间的500万次互动。研究者用它研究了四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，验证了该系统在捕捉人类行为机制方面的有效性。该平台可作为社会科学研究和政策制定的有力工具，为理解复杂社会现象提供新方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T15:05:26Z
- **目录日期**: 2025-05-15
