...
AgentSociety是一种基于大语言模型的大规模社会模拟器，可模拟1万多个代理及其500万次互动。研究者用它分析社会极化、信息传播、基本收入政策及自然灾害影响等问题，结果与现实数据吻合。该系统展现了作为社会科学研究工具的潜力，能辅助传统方法探索社会问题的模式和机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T08:05:36Z
- **目录日期**: 2025-05-15
