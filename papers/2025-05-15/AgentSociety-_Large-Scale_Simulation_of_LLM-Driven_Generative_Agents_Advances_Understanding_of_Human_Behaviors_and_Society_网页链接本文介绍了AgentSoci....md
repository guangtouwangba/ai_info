...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理及其500万次社会互动。研究者用它研究四大社会问题：社会极化、信息传播、基本收入政策效果和自然灾害影响。该系统模拟结果与现实数据高度吻合，证明其能有效捕捉人类行为机制。作为计算社会科学工具，AgentSociety可辅助传统研究方法，帮助学者和政策制定者分析社会问题成因及潜在解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T03:23:19Z
- **目录日期**: 2025-05-15
