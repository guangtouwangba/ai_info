...
自2022年起，ChatGPT等生成式AI通过人类反馈强化学习（RLHF）技术优化输出，使语言模型表现更接近人类。这种技术进步虽提升了交互质量，但也引发了伦理与社会问题，包括透明度、偏见及人际关系等潜在风险。本文采用修辞学分析，聚焦RLHF如何重塑语言规范、信息获取及社交期待，突破传统对AI生成内容说服力的研究，转向其内在机制。通过程序修辞理论，探讨AI技术可能强化语言霸权、固化偏见、脱离语境学习及影响人际关系的风险，为AI伦理研究开辟新方向，对教育者、学者及AI用户具有重要启示。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T20:01:45Z
- **目录日期**: 2025-05-15
