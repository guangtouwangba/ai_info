...
2022年以来，ChatGPT等生成式AI通过"人类反馈强化学习"(RLHF)技术优化输出，使语言模型表现更接近人类。这种进步在提升交互质量的同时，也引发了关于透明度、偏见和社会关系的伦理担忧。本文运用程序修辞理论，从传统的内容分析转向探究RLHF的内在说服机制，揭示了AI技术可能强化语言霸权、延续偏见、脱离学习情境并影响人际关系的风险。该研究为AI伦理开辟了新视角，对教育工作者、学者及广大AI用户具有重要启示意义。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T07:01:36Z
- **目录日期**: 2025-05-15
