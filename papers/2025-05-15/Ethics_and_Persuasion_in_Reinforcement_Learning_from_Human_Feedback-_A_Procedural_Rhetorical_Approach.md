...
2022年以来，ChatGPT等生成式AI聊天机器人采用"人类反馈强化学习"(RLHF)技术，通过人工标注优化输出，使对话更拟人化。这种技术进步带来了透明度、偏见、人际关系等伦理和社会挑战。本文通过修辞学分析，探讨RLHF如何重塑语言规范、信息获取和社交期待，将研究焦点从生成内容转向AI的底层说服机制。理论分析揭示了AI可能强化语言霸权、延续偏见、使学习去情境化并影响人际关系，为AI伦理研究开辟了新方向。该研究对教育工作者、学者及AI用户具有重要参考价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T18:02:06Z
- **目录日期**: 2025-05-15
