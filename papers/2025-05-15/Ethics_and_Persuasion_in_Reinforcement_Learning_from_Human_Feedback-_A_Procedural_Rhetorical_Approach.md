...
自2022年起，ChatGPT等生成式AI通过人类反馈强化学习（RLHF）技术优化输出，使语言模型表现更接近人类。这种进步虽提升了交互体验，但也引发了伦理和社会问题，如透明度、偏见及人际关系影响。本文从修辞学角度分析了RLHF如何重塑语言规范、信息获取和社交期待，不同于以往对AI生成内容说服力的研究，转向探讨RLHF内置的说服机制。理论层面揭示了AI技术可能强化语言霸权、延续偏见、脱离学习情境并影响人际关系的风险，为AI伦理研究提供了新方向，对教育工作者和AI用户具有重要参考价值。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T22:01:30Z
- **目录日期**: 2025-05-15
