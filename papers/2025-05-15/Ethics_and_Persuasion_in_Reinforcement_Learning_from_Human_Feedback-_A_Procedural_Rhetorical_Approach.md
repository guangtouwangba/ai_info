...
自2022年起，ChatGPT等生成式AI通过"人类反馈强化学习"(RLHF)技术优化输出，使语言模型表现更接近人类。这种技术进步虽提升了交互体验，却引发了伦理和社会问题：透明度缺失、偏见固化、人际关系异化等。本文从修辞学角度，运用Ian Bogost的程序修辞理论，分析了RLHF重塑的三大核心程序——语言规范维护、信息检索实践和社会关系预期。不同于以往对AI生成内容说服力的研究，该研究转向探究RLHF底层机制如何强化霸权语言、延续偏见、剥离学习情境并侵蚀人际关系，为AI伦理研究开辟了新方向，对教育工作者和AI使用者具有启示意义。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T23:01:35Z
- **目录日期**: 2025-05-15
