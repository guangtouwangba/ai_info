...
这篇论文针对代码生成大模型(codeLLMs)提出了CodeArena基准测试，聚焦人类偏好对齐问题。研究者从真实用户查询中精选397个样本，覆盖40个类别和44种编程语言，模拟实际编程场景。同时构建了20B标记的合成指令数据集SynCode-Instruct验证微调效果。实验发现执行基准与人类偏好存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，凸显了人类偏好对齐的重要性。该研究为评估和改进代码生成模型提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T19:05:38Z
- **目录日期**: 2025-05-15
