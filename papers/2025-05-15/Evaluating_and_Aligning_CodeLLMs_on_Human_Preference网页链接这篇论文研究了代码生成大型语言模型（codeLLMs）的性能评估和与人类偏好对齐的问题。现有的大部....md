...
该论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，通过397个涵盖40类编程任务和44种语言的人类精选样本，评估模型与人类偏好的对齐程度。研究发现传统基于执行的测试与人类偏好存在差异，并通过40多个模型实验显示开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)存在显著差距。同时构建了20B标记的SynCode-Instruct合成指令集，验证了大规模指令微调的有效性，强调了代码生成模型与人类偏好对齐的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T08:06:21Z
- **目录日期**: 2025-05-15
