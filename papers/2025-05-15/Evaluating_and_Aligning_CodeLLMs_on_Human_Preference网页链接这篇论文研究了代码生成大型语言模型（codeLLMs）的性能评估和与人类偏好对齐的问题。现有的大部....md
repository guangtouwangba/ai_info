...
这篇论文针对代码生成大模型(codeLLMs)提出创新评估方法，指出当前基准测试过于关注代码正确性而忽视人类偏好。研究者构建了包含397个样本的CodeArena基准测试(覆盖40类编程任务和44种语言)，并开发了20B标记量的SynCode-Instruct合成指令数据集。实验发现执行基准与人类偏好评估存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，凸显了模型对齐人类偏好的重要性。研究为提升代码LLMs的实际应用价值提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T18:06:00Z
- **目录日期**: 2025-05-15
