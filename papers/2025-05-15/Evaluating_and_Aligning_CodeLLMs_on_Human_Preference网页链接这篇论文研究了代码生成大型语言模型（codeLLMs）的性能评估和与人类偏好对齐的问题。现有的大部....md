...
这篇论文探讨了代码生成大模型(codeLLMs)与人类偏好的对齐问题，指出当前基准测试过于关注代码正确性而忽视用户体验。研究者创建了CodeArena基准(包含397个样本，覆盖40类任务和44种语言)和SynCode-Instruct合成指令集(约200亿标记)来评估模型。实验发现执行基准与人类偏好存在差距，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著，凸显对齐人类偏好的重要性。研究强调了在代码生成任务中兼顾技术正确性和用户体验的必要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T07:05:53Z
- **目录日期**: 2025-05-15
