...
这篇论文提出了CodeArena基准测试和SynCode-Instruct数据集，用于评估代码生成大模型与人类偏好的对齐程度。研究发现现有基准过于关注代码正确性而忽视用户体验，因此构建了包含397个多语言样本的CodeArena和近200亿标记的合成指令集。实验显示执行基准与人类偏好存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI)性能差距显著，凸显了人类偏好对齐的重要性。研究为提升代码生成模型的实用性和用户体验提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T10:06:15Z
- **目录日期**: 2025-05-15
