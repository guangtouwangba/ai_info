...
荷兰AMOLF团队研发了一种无需算法和硬件的软体机器人，仅通过空气驱动就能运动。该机器人采用3D打印外壳和弯曲软管作为腿，连接气泵后能自动形成类似生物运动的节律性动作。多条腿通过共享气源实现同步协调，最新无线版本能耗降至每条腿0.06瓦，并配备光传感器导航。虽然目前运动控制仍较随机（遇墙转向、遇水后退），但团队计划进一步优化其环境适应性。这种"无脑"机器人未来或可用于人工心脏等特殊场景，依靠流体力学实现自主运作。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T00:04:33Z
- **目录日期**: 2025-05-15
