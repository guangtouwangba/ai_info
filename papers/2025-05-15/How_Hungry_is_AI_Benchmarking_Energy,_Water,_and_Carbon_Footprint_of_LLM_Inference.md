...
该研究提出了一个基础设施感知的基准框架，用于评估30种最先进大语言模型在商业数据中心推理时的环境足迹。研究发现，o3和DeepSeek-R1能耗最高（单次长提示超33Wh），是GPT-4.1 nano的70多倍；Claude-3.7 Sonnet生态效率最佳。虽然单次GPT-4o短查询仅耗电0.43Wh，但日频次达7亿次时，年耗电量相当于3.5万美国家庭，淡水蒸发量满足120万人年饮水需求，碳排放需芝加哥大小的森林才能抵消。研究表明：尽管单次查询高效，但全球规模仍导致不成比例的资源消耗。该框架为AI可持续发展标准提供了量化方法论基础。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T09:01:32Z
- **目录日期**: 2025-05-15
