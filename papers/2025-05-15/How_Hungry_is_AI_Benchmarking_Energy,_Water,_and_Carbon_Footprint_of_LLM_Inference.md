...
该研究提出了一个基础设施感知的基准框架，用于量化30个商用大语言模型（LLM）推理阶段的环境足迹。通过结合API性能数据、区域环境因子和硬件配置推断，研究发现：o3和DeepSeek-R1能耗最高（单次长提示超33Wh，是GPT-4.1 nano的70倍），Claude-3.7 Sonnet生态效率最佳。单个GPT-4o短查询耗电0.43Wh，但日频7亿次查询的年化影响巨大——相当于3.5万美国家庭用电、120万人年饮水量的淡水蒸发，以及需芝加哥面积森林抵消的碳排放。研究表明，尽管单次查询高效，但全球规模仍导致资源消耗失衡，为AI可持续发展标准提供了量化方法论基础。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T04:01:38Z
- **目录日期**: 2025-05-15
