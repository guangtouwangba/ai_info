...
随着大语言模型(LLMs)在各行业的广泛应用，量化其推理阶段的环境影响变得至关重要。本研究提出了首个基础设施感知的基准框架，评估了30个商业数据中心部署的先进LLM模型。结果显示：o3和DeepSeek-R1能耗最高(单次长提示超33Wh)，是GPT-4.1 nano的70倍；Claude-3.7 Sonnet生态效率最佳。单个GPT-4o短查询耗电0.43Wh，但日均7亿次查询的年环境影响惊人：相当于3.5万美国家庭用电、120万人年饮水量的淡水蒸发，以及需要芝加哥面积的森林来抵消的碳排放。研究表明，尽管单次查询高效，但全球规模仍导致巨大资源消耗。该研究为AI可持续发展提供了标准化评估方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T16:01:18Z
- **目录日期**: 2025-05-15
