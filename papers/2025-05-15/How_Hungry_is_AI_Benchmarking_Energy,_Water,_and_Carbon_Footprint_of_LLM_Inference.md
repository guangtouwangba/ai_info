...
本研究提出了一种新型基础设施感知基准框架，用于量化30种最先进大语言模型(LLM)在商业数据中心推理时的环境足迹。研究发现：o3和DeepSeek-R1能耗最高，处理长提示耗电超33Wh，是GPT-4.1 nano的70多倍；Claude-3.7 Sonnet生态效率最佳。单个GPT-4o短查询耗电0.43Wh，但日处理7亿次查询时，年耗电量相当于3.5万美国家庭用电，淡水蒸发量满足120万人年饮用水需求，碳排放需芝加哥大小的森林来抵消。研究表明，尽管单次查询高效，但全球规模下资源消耗惊人。该研究为LLM部署的可持续性评估提供了标准化方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T08:01:23Z
- **目录日期**: 2025-05-15
