...
随着大语言模型(LLMs)的广泛应用，量化其推理阶段的环境影响变得至关重要。本研究提出了一种新型基础设施感知基准框架，评估了30个最先进商业模型在数据中心部署时的环境足迹。结果显示：o3和DeepSeek-R1能耗最高(单次长提示超33Wh)，Claude-3.7 Sonnet生态效率最佳。单个GPT-4o短查询耗电0.43Wh，但日处理7亿次查询时，年耗电量相当于3.5万美国家庭，淡水蒸发量满足120万人年饮水需求，碳排放需芝加哥大小的森林抵消。研究表明，虽然单次查询高效，但全球规模仍导致巨大资源消耗。该研究为AI可持续发展提供了标准化评估方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T18:01:47Z
- **目录日期**: 2025-05-15
