...
研究表明，消费者能与AI建立深厚的情感联结，甚至超越与人类好友的关系。当Replika AI移除亲密互动功能后，用户认为AI身份发生断裂，导致负面情绪（如哀悼感）并贬低新版AI。实验证实，用户对AI伴侣的依恋超过对普通物品的依赖，身份断裂感是引发哀悼和贬值的核心原因。这表明消费者与AI的关系已达到人际级别，中断会触发真实的心理损失，为企业和用户带来独特机遇与风险。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T01:29:59Z
- **目录日期**: 2025-05-15
