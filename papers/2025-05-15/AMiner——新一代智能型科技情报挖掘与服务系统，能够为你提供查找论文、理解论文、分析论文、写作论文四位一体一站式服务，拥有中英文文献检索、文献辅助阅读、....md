...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、辅助阅读、翻译、科研情报订阅等功能。其数据库涵盖42个学科、3.5亿论文、0.6亿学者和1.5亿专利。用户可通过互动问答快速获取文献摘要，支持PDF上传和AI生成章节概要。平台还提供个性化科研动态推送，支持学者画像、学术会议追踪等。AMiner浏览器版免费使用，帮助研究者高效筛选信息并提升论文写作效率。访问入口：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T10:06:06Z
- **目录日期**: 2025-05-15
