...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读辅助、翻译及科研订阅等一站式服务。平台收录3.5亿论文、0.6亿学者等海量学术资源，支持中英文文献检索、AI生成摘要、互动问答及文档翻译功能。用户可通过个性化订阅获取最新科研动态，还能使用学者画像、学术会议等特色工具。其浏览器版本免费开放，旨在提升学术研究效率。访问入口：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T21:05:28Z
- **目录日期**: 2025-05-15
