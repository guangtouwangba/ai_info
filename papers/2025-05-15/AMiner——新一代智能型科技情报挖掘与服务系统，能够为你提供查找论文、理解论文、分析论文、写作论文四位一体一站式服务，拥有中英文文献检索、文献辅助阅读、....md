...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析、写作一站式服务。平台支持中英文文献检索，可自动生成摘要和问答互动，帮助用户快速理解论文。其AI翻译功能支持文档上传和智能摘要生成，并提供科研动态订阅服务，通过微信或邮件推送个性化学术资讯。此外，AMiner还涵盖学者画像、学术会议等特色功能，拥有3.5亿论文和1.5亿专利数据库。基础功能免费开放，用户可通过网页或小程序便捷使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T02:34:52Z
- **目录日期**: 2025-05-15
