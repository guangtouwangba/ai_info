...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、辅助阅读、翻译和科研情报订阅。它拥有3.5亿论文、0.6亿学者等海量数据，支持AI生成摘要、章节概要和智能问答，帮助用户快速理解文献内容。用户可通过订阅功能获取个性化科研动态推送，还能使用学者画像、学术会议等特色功能。平台提供免费基础服务，适合科研人员和学生高效开展学术研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T04:06:00Z
- **目录日期**: 2025-05-15
