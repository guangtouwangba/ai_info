...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译及科研分析等一站式服务。它支持中英文文献搜索，拥有3.5亿论文、0.6亿学者等海量数据，并能通过AI生成摘要、章节概要和智能问答，帮助用户快速理解文献内容。此外，AMiner还提供科研动态订阅服务，用户可定制关注领域，通过微信或邮件获取最新学术资讯。平台还包含学者画像、学术会议和论文排行榜等功能，基础检索服务免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T20:05:55Z
- **目录日期**: 2025-05-15
