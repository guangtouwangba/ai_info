...
AMiner是一款智能科技情报挖掘系统，提供一站式科研服务，包括中英文文献检索、辅助阅读、翻译等功能。平台收录3.5亿论文、0.6亿学者等海量数据，支持互动问答和自动摘要生成，提升文献筛选与写作效率。用户可上传PDF或从文献库选取论文，获取AI生成的摘要、章节概要和问题建议。此外，AMiner提供个性化科研动态订阅服务，通过微信或邮件推送最新学术资讯。平台还包含学者画像、学术会议等特色功能，基础检索服务免费开放。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T13:12:58Z
- **目录日期**: 2025-05-15
