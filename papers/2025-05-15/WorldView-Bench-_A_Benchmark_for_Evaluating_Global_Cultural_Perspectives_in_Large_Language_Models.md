...
当前大语言模型（LLMs）的训练和校准主要基于西方中心视角，导致文化同质化，难以反映全球文明多样性。为此，研究者提出WorldView-Bench基准，通过自由生成式评估（而非传统分类测试）来量化模型的全球文化包容性（GCI）。基于Senturk的"多元世界观"理论，研究采用两种干预策略：（1）上下文驱动的多元LLMs；（2）多智能体系统（MAS）驱动的多元LLMs。实验显示，MAS方案使观点分布熵值从13%提升至94%，积极情感占比达67.7%，显著改善了文化平衡性。该研究为开发更具包容性的AI系统提供了新范式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T10:01:34Z
- **目录日期**: 2025-05-15
