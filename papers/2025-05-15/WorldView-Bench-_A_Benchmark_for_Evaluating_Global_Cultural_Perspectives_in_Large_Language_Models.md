...
当前大语言模型(LLM)的训练和校准主要基于西方中心主义认知体系，导致文化同质化问题。为此，研究者开发了WorldView-Bench基准测试，通过自由生成式评估(而非传统分类测试)来测量LLM的全球文化包容性(GCI)。基于Senturk等人的"多元世界观"理论，研究采用两种干预策略：(1)上下文实现的多元LLM；(2)多智能体系统(MAS)实现的多元LLM。实验显示，MAS方法使视角分布熵值从基线13%提升至94%，积极情绪达67.7%，显著改善了文化平衡性。这为构建更具文化包容性的AI系统提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T18:01:57Z
- **目录日期**: 2025-05-15
