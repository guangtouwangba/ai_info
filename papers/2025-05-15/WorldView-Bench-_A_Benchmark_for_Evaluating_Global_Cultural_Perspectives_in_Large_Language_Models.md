...
当前大语言模型（LLMs）的训练和校准主要基于西方中心主义认知，导致文化同质化，难以体现全球文明多样性。现有评估框架无法有效捕捉这种偏见。为此，研究者提出WorldView-Bench基准，通过自由生成式评估（而非传统分类测试）来量化模型的全球文化包容性（GCI），并基于"多元世界观"理论区分单极（强化文化同质化）与多元（整合不同视角）模型。采用两种干预策略后，多元视角分布熵值从基线13%提升至94%，积极情感占比达67.7%，显著改善了文化平衡性，为构建更具包容性的AI系统提供了新思路。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T14:01:19Z
- **目录日期**: 2025-05-15
