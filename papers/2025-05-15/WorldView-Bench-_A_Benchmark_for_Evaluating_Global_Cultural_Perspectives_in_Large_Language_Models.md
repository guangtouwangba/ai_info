...
当前大型语言模型(LLM)的训练和校准主要基于西方中心主义认知体系，导致文化同质化问题。为解决这一问题，研究者开发了WorldView-Bench基准测试，通过自由生成式评估(而非传统分类测试)来测量全球文化包容性(GCI)。基于Senturk等人提出的"多重世界观"理论，研究采用两种干预策略：1)上下文实现的多重LLM(通过系统提示嵌入多重性原则)；2)多智能体系统实现的多重LLM(不同文化视角的LLM智能体协作生成回答)。实验显示多智能体方法将视角分布熵从13%提升至94%，情感正向率达67.7%，显著提升了文化平衡性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T15:01:40Z
- **目录日期**: 2025-05-15
