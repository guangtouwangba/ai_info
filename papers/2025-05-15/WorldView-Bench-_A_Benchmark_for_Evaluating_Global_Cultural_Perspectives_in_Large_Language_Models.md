...
当前大语言模型(LLMs)的训练和校准主要基于西方中心主义认知体系，导致文化同质化问题。为评估全球文化包容性(GCI)，研究者提出WorldView-Bench基准测试，采用自由生成式评估(而非传统分类基准)来测量文化极化现象。通过两种干预策略：(1)上下文实现的多路复用LLMs；(2)多代理系统(MAS)实现的多路复用LLMs(不同文化视角的代理协作生成回答)，研究显示MAS方法使视角分布熵值从13%提升至94%，积极情感达67.7%，显著提升文化平衡性。这为开发更具文化包容性的AI系统提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T07:01:24Z
- **目录日期**: 2025-05-15
