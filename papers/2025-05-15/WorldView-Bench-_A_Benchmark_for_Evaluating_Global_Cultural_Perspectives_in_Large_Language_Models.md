...
当前大语言模型(LLMs)的训练和校准主要基于西方中心主义认知体系，导致文化同质化问题。为评估全球文化包容性(GCI)，研究者开发了WorldView-Bench基准测试，采用自由生成式评估(而非传统分类测试)来测量文化极化现象。通过两种干预策略：(1)上下文实现的多路复用LLMs；(2)多代理系统实现的多路复用LLMs，研究显示视角分布得分(PDS)熵值从基线13%提升至94%，积极情绪达67.7%，显著改善了文化平衡。这表明多路复用AI评估能有效减少LLMs中的文化偏见，推动更具包容性的AI系统发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T23:01:25Z
- **目录日期**: 2025-05-15
