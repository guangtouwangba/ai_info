...
OpenAI CEO Sam Altman在红杉资本活动上透露，公司的终极目标是打造订阅制AI操作系统，涵盖用户一生的数据，实现高度个性化服务。他认为未来的AI模型将拥有万亿级上下文标记，成为用户的"人生顾问"。目前该计划仍处构想阶段，OpenAI正专注于改进通用模型（占90%精力），同时探索语音交互、AI代理和编码应用。Altman预测2025年AI将更多进入物理世界，机器人创造经济价值，并强调OpenAI将作为核心AI订阅服务商，鼓励竞争。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T04:04:32Z
- **目录日期**: 2025-05-15
