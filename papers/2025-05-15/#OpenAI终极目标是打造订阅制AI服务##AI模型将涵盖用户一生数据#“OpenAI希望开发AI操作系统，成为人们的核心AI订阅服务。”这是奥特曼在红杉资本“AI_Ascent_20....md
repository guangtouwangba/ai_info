...
OpenAI CEO Sam Altman在红杉资本活动上透露，公司的终极目标是打造订阅制AI操作系统，成为用户终身的个性化AI助手。该模型将拥有万亿级上下文记忆，涵盖用户一生数据，实现深度个性化推理。目前计划仍处概念阶段，但已开展相关研究。Altman预测2025年AI代理将主导工作流程，编码成为关键能力，并可能推动重大科学发现。他同时强调OpenAI将专注于核心AI订阅服务，保持开放竞争。当前90%资源仍用于优化通用模型，语音交互等前沿领域尚待突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T00:03:20Z
- **目录日期**: 2025-05-15
