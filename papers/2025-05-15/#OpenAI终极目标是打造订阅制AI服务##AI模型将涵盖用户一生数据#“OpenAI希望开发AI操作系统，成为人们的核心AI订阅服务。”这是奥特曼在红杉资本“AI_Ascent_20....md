...
OpenAI CEO Sam Altman在红杉资本活动上透露，公司的终极目标是打造订阅制AI操作系统，成为用户终身数据管家。他设想未来AI将拥有万亿级上下文标记，存储用户一生数据并提供个性化推理服务。目前该计划尚处概念阶段，公司90%资源仍聚焦通用模型优化。Altman预测2025年AI代理将主导工作流程，编码成为核心能力，并可能推动重大科学发现。他同时强调语音交互和机器人技术的经济潜力，并表示OpenAI将保持策略灵活性，通过API/SDK构建开放生态。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T02:32:15Z
- **目录日期**: 2025-05-15
