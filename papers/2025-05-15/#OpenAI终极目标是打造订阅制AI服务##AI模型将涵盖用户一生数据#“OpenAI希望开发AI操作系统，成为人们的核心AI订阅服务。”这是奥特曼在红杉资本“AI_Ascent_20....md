...
OpenAI CEO Sam Altman在红杉资本活动上透露，公司的终极目标是打造订阅制AI操作系统，成为用户终身的个性化AI助手。该模型将存储用户一生数据，实现深度个性化推理，改变人机交互方式。目前计划仍处构想阶段，但OpenAI已在开展相关研究。Altman预测2025年AI将更多进入物理世界，机器人创造经济价值，编码将成为核心能力。他建议初创公司如能提供更好的AI订阅服务可大胆竞争，OpenAI将专注于优化基础模型和构建AI基础设施。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T03:21:31Z
- **目录日期**: 2025-05-15
