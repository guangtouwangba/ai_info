...
南安普敦大学团队首次在实验室模拟黑洞能量放大效应，通过旋转金属圆柱体观测到"超辐射"现象，验证了1970年代提出的"黑洞炸弹"理论。该实验装置由金属柱、线圈和电容组成，成功实现电磁波能量指数级放大，能量级别约毫焦耳。这一突破为研究黑洞物理提供了新途径，未来或应用于暗物质探测和真空能源开发。研究证实了旋转物体与电磁波相互作用可提取能量的理论预言，为基础物理学开辟了新研究方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T11:04:17Z
- **目录日期**: 2025-05-15
