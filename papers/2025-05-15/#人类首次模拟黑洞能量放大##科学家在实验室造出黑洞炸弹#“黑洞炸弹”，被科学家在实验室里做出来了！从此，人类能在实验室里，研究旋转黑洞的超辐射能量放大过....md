...
南安普敦大学团队首次在实验室通过旋转金属圆柱体观测到"超辐射效应"，验证了黑洞能量放大理论。该实验模拟了旋转黑洞通过负能量粒子窃取动能的机制，当电磁波在装置内反射时能量呈指数增长，形成微型的"黑洞炸弹"。虽然目前能量级别仅毫焦耳量级，但这一突破为研究黑洞物理提供了新途径，未来或应用于暗物质探测和真空能源开发。该成果证实了1970年代彭罗斯和泽尔多维奇的理论预言，是基础物理研究的重要里程碑。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T15:04:21Z
- **目录日期**: 2025-05-15
