...
南安普敦大学团队首次在实验室模拟出"黑洞炸弹"效应。他们通过旋转金属圆柱体装置，成功观测到"超辐射"现象——电磁波能量被旋转物体放大的过程，验证了1970年代的理论预测。该实验虽能量微小（毫焦耳级），但证实了旋转黑洞能量提取的物理机制，为研究黑洞物理开辟了新途径。未来或可用于暗物质探测，甚至开发真空能源。这一突破性成果将基础理论转化为可实验验证的模型，标志着人类首次在实验室重现黑洞能量放大现象。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T12:04:16Z
- **目录日期**: 2025-05-15
