...
这篇论文提出了"ICLR points"概念，用于量化计算机科学不同子领域发表顶会论文的平均工作量。通过分析DBLP(2019-2023)数据和CSRankings教师信息，比较了27个计算机子领域的发表工作量差异。研究发现系统领域会议比AI领域会议需要更多工作量。该指标可用于评估高校、教师和求职者的发表记录，实现跨领域可比性，但也强调需结合全面评估标准，避免单一指标滥用。研究证实了不同领域发表工作量存在显著差异的普遍认知。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T09:02:18Z
- **目录日期**: 2025-05-15
