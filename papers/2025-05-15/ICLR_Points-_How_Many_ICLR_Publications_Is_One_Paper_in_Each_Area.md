...
该研究提出了"ICLR点数"的概念，用于衡量在顶级机器学习会议(如ICLR、ICML、NeurIPS)发表论文所需的平均工作量。通过分析DBLP(2019-2023)的出版物数据和CSRankings的教师信息，研究比较了27个计算机科学子领域的平均发表工作量。结果显示系统领域会议比AI领域会议需要更多工作量。该指标可用于评估高校、教师和候选人的发表记录，实现跨领域比较。但研究也强调需谨慎使用该指标，避免滥用，应结合其他评估标准进行全面考量。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T03:19:54Z
- **目录日期**: 2025-05-15
