...
本文提出了"ICLR点数"概念，用于衡量计算机科学不同子领域发表论文的平均工作量（以顶级机器学习会议ICLR、ICML、NeurIPS为基准）。通过分析DBLP(2019-2023)数据和CSRankings教师信息，研究发现27个计算机子领域间存在显著差异：系统会议论文通常比AI会议需要更多工作量。该指标可用于评估高校、教师和研究人员的发表记录，实现跨领域比较。但作者也指出该指标的局限性，强调学术评估需综合考量，不能仅依赖发表指标。研究证实了不同领域发表工作量差异的普遍认知。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T22:01:47Z
- **目录日期**: 2025-05-15
