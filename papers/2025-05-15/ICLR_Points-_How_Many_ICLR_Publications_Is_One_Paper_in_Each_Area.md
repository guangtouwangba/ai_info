...
该研究提出了"ICLR分数"概念，用于量化计算机科学不同子领域发表顶级会议论文的平均工作量。通过分析DBLP(2019-2023)数据和CSRankings教师信息，比较了27个计算机子领域的发表工作量差异。研究发现系统领域会议比AI领域需要更多工作量。该指标可用于评估高校、教师和候选人的学术产出，实现跨领域比较。但作者强调需谨慎使用该指标，应结合其他评估标准进行综合考量，避免仅依赖发表指标。研究揭示了计算机科学不同子领域间显著的发表工作量差异。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T14:01:44Z
- **目录日期**: 2025-05-15
