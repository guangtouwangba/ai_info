...
这篇论文提出了"ICLR点数"的概念，用于量化计算机科学不同子领域发表顶级会议论文所需的平均工作量。研究基于DBLP(2019-2023)的出版物数据和CSRankings的教师信息，比较了27个计算机科学子领域的发表工作量差异。研究发现系统领域会议比AI领域会议需要更多工作量。该指标可用于评估高校、教师和候选人的学术产出，促进跨领域比较。但作者也指出该指标的局限性，强调学术评估需要综合考量，不能仅依赖发表指标。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T07:01:58Z
- **目录日期**: 2025-05-15
