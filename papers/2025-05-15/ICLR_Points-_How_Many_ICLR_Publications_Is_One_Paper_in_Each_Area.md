...
该研究提出了"ICLR点数"概念，用于量化计算机科学不同子领域发表论文的平均工作量。通过分析DBLP(2019-2023)的出版物数据和CSRankings的教师信息，比较了27个计算机科学子领域的发表工作量差异。研究发现系统领域会议比AI会议需要更多工作量。该指标可用于评估高校、教师和候选人的学术产出，实现跨领域比较，但也需注意其局限性，避免滥用，强调应结合全面评估标准而非仅依赖发表指标。研究验证了不同领域发表工作量存在显著差异的普遍认知。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T15:02:13Z
- **目录日期**: 2025-05-15
