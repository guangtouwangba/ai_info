...
这篇论文提出了"ICLR点数"的概念，用于衡量在计算机科学不同子领域中发表一篇顶级会议论文所需的平均工作量。通过分析DBLP(2019-2023)的出版物数据和CSRankings的教师信息，研究者比较了27个计算机科学子领域的发表工作量差异。研究发现，系统领域会议通常比AI领域会议需要更多工作量。该指标可用于评估大学、教师和研究人员的发表记录，促进跨领域比较。但作者也提醒该指标存在局限性，强调学术评估需要综合考虑多种因素，而非仅依赖发表指标。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T17:02:02Z
- **目录日期**: 2025-05-15
