...
该研究提出"ICLR点数"概念，用于量化计算机科学不同子领域发表顶级论文的平均工作量（以ICLR/ICML/NeurIPS等AI顶会为基准）。通过分析DBLP(2019-2023)数据和CSRankings教师信息，比较了27个子领域后发现：系统领域会议单篇发表所需工作量显著高于AI会议。该指标可用于高校、教师及求职者的跨领域学术评价，但研究者强调需结合全面评估标准，避免单一指标滥用。研究揭示了计算机科学不同子领域间存在的显著发表工作量差异。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T05:02:00Z
- **目录日期**: 2025-05-15
