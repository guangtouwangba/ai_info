...
该研究提出了"ICLR点数"概念，用于量化计算机科学不同子领域发表论文的平均工作量（以顶级机器学习会议ICLR/ICML/NeurIPS为基准）。通过分析DBLP(2019-2023)数据和CSRankings教师信息，比较了27个计算机子领域的发表工作量差异。研究发现系统领域会议比AI领域需要更多工作量。该指标可用于评估高校、教师和研究人员的学术产出，促进跨领域比较，但研究者强调需结合全面评估标准，避免单一指标滥用。研究证实了不同领域发表工作量的显著差异这一普遍认知。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T10:02:06Z
- **目录日期**: 2025-05-15
