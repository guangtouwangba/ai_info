...
字节Seed团队提出AttentionInfluence方法，利用小模型（1.3B参数）的注意力机制筛选高质量数据，无需人工标注即可提升大模型（7B参数）的推理能力。通过屏蔽关键检索头计算损失差异，对数据评分并筛选，实验显示在MMLU、GSM8K等基准任务中性能提升1.4-3.5个百分点。该方法避免了传统数据筛选的领域偏见问题，且能同步提升代码生成能力，被赞为"简单而巧妙"的创新。谷歌DeepMind科学家也转发认可这一成果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T17:04:06Z
- **目录日期**: 2025-05-15
