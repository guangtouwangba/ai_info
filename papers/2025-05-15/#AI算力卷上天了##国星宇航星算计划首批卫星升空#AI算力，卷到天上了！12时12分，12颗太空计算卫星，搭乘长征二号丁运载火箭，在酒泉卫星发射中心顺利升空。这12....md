...
中国商业航天企业国星宇航成功发射12颗太空计算卫星，组成全球首个太空计算星座，标志着"星算计划"正式启动。该计划旨在构建由2800颗卫星组成的太空计算网络，将AI算力部署到太空。这些卫星具备太空计算和互联能力，将开启"太空计算时代"新篇章。此次发射采用长征二号丁运载火箭，在酒泉卫星发射中心完成。未来太空计算网络有望实现地外数据中心建设，改变传统地面算力部署模式。(99字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T00:03:39Z
- **目录日期**: 2025-05-15
