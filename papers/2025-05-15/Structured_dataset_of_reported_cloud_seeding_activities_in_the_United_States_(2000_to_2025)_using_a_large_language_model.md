...
美国自1940年代起使用人工降雨技术（云催化），但缺乏结构化数据记录。为此，研究人员利用OpenAI的o4-mini大语言模型处理了836份NOAA历史报告，构建了2000-2025年全美人工降雨活动的结构化数据集，包含时间、地点、催化剂、实施设备及目的等信息。通过多阶段PDF文本转换和响应解析，该数据集经人工验证准确率达94.72%，已公开于Zenodo平台。该研究不仅填补了人工降雨数据空白，更展示了LLM从历史文献提取结构化环境数据的潜力，为跨学科历史文档数据挖掘提供了可扩展框架。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T01:28:45Z
- **目录日期**: 2025-05-15
