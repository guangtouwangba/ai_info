...
vivo与香港科技大学联合研发的PreSelect数据筛选方法被ICML 2025接收。该技术通过fastText评分器计算数据的"预测强度"(Predictive Strength)，利用模型loss与下游任务表现的排序一致性评估数据价值，筛选出对模型能力提升最有效的数据。相比传统方法，PreSelect将计算需求降低10倍，理论基础更坚实，减少人工规则依赖。其核心基于"压缩即智能"理念，即模型压缩数据能力(BPC指标)与智能水平正相关。该方法使大模型训练数据筛选更高效客观，效率提升10倍。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T17:03:01Z
- **目录日期**: 2025-05-15
