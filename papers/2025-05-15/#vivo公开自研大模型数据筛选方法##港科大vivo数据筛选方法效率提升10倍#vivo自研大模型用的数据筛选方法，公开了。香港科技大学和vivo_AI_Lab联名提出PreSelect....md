...
vivo与香港科技大学联合研发的PreSelect数据筛选方法被ICML 2025接收。该方法通过fastText评分器计算数据的"预测强度"(Predictive Strength)，量化数据对模型能力的贡献效率，使筛选过程减少10倍计算需求。其核心基于"压缩即智能"理论，利用模型在数据上的归一化loss与下游任务表现的强相关性，优先保留能显著提升模型效果的高预测强度数据。相比传统方法，该方案理论基础更坚实，减少人工规则依赖，具有更高泛化性。论文显示该方法可大幅提升大模型训练的数据效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T12:03:11Z
- **目录日期**: 2025-05-15
