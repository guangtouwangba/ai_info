...
这篇综述首次系统性地总结了检测大型AI模型(LAIMs)生成多媒体内容(如文本、图像、视频、音频等)的研究现状。文章提出了新的检测方法分类体系，从纯检测和超越检测两个维度进行分析，并概述了生成机制、数据集、在线工具和评估指标。特别从社交媒体视角探讨了其社会影响，指出了当前检测技术面临的挑战和未来研究方向。该研究填补了学术空白，旨在为AI安全领域做出贡献，维护数字信息完整性。相关资源已开源在GitHub上。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T04:02:52Z
- **目录日期**: 2025-05-15
