...
这篇综述首次系统性地总结了检测大型AI模型(LAIMs)生成多媒体内容的研究现状，涵盖文本、图像、视频、音频等多模态内容。作者提出了新的分类法，将检测方法分为纯粹检测(提升性能)和超越检测(增强通用性、鲁棒性等特性)两类。研究还概述了生成机制、公开数据集、在线检测工具和评估指标，特别从社交媒体视角分析了其社会影响。文章指出了当前检测技术面临的挑战，并提出了未来研究方向，旨在填补学术空白，为全球AI安全做出贡献，确保数字领域信息完整性。项目链接已公开。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T02:31:13Z
- **目录日期**: 2025-05-15
