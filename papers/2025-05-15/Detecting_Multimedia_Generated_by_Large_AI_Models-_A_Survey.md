...
随着大型AI模型（LAIMs）的快速发展，AI生成的多媒体内容日益普及，但也带来了滥用、社会扰乱和伦理风险。本文首次系统综述了针对LAIM生成的多媒体（如文本、图像、视频、音频）的检测方法，提出基于媒体模态的新分类法，涵盖纯检测（提升性能）和扩展检测（增强泛化性、鲁棒性等）。研究还总结了生成机制、数据集、在线工具和评估指标，并从社交媒体视角分析其社会影响。最后指出了当前检测的挑战和未来研究方向，旨在填补学术空白，助力全球AI安全。项目链接见原文。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T06:02:35Z
- **目录日期**: 2025-05-15
