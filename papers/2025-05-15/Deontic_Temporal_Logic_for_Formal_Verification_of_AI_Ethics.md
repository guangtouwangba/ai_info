...
本文提出了一种基于道义逻辑的形式化方法，用于定义和评估AI系统的伦理行为，重点关注公平性和可解释性等伦理要求。该方法引入公理和定理，并整合时序算子来分析AI系统随时间变化的伦理表现。作者通过验证COMPAS和贷款预测两个实际AI系统，使用自动定理证明器检查其是否符合定义的伦理属性。结果显示，这两个系统均未能满足某些关键的公平性和非歧视性伦理要求，证明了该形式化方法在识别现实AI应用中潜在伦理问题上的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T18:02:32Z
- **目录日期**: 2025-05-15
