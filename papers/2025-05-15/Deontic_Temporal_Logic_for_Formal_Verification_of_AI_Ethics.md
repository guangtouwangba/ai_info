...
本文提出了一种基于道义逻辑的形式化方法，用于定义和评估AI系统的伦理行为，重点关注公平性和可解释性。该方法引入公理和定理，并结合时序算子来分析AI系统随时间变化的伦理表现。作者通过评估COMPAS和贷款预测两个实际AI系统来验证该方法的有效性，使用自动定理证明器检查系统是否满足定义的伦理属性。结果表明，这两个系统在某些关键公平性和非歧视性伦理属性上存在不足，证实了该形式化方法在识别现实AI应用伦理问题上的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T15:02:25Z
- **目录日期**: 2025-05-15
