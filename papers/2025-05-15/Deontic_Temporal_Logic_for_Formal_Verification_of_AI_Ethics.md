...
本文提出了一种基于道义逻辑的形式化方法，用于定义和评估AI系统的伦理行为，重点关注公平性和可解释性。通过引入公理和定理，结合时间算子分析AI系统随时间变化的伦理表现。作者以COMPAS和贷款预测系统为例，采用自动定理证明器验证这些系统是否满足定义的伦理属性。形式化验证表明，两个系统均未能满足某些与公平性和非歧视相关的关键伦理要求，证实了该方法在识别实际AI应用伦理问题方面的有效性。该研究为通过形式化方法确保AI伦理行为提供了重要参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T12:02:19Z
- **目录日期**: 2025-05-15
