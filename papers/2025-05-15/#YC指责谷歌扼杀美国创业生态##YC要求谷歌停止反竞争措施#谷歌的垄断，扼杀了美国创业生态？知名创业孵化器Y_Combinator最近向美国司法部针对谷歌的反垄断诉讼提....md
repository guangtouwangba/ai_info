...
知名创业孵化器YC向美国司法部提交意见书，指控谷歌通过垄断搜索和AI市场形成"扼杀区"，阻碍初创企业融资和发展。YC提出五项补救措施：开放搜索数据训练AI模型、禁止付费预装协议、防止AI搜索垄断、禁止预设AI答案、杜绝报复行为。值得注意的是，YC与OpenAI关系密切（OpenAI CEO曾任YC总裁），而OpenAI正与谷歌展开搜索竞争。尽管谷歌云去年曾为YC系初创企业提供支持，YC仍选择在反垄断诉讼中公开反对谷歌的商业行为。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T00:04:23Z
- **目录日期**: 2025-05-15
