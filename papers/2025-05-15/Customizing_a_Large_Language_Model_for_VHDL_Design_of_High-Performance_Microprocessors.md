...
近年来，大型语言模型（LLM）在硬件设计中的应用逐渐兴起，主要用于提升芯片设计效率。虽然Verilog设计中的LLM应用备受关注，但同样广泛使用的VHDL却鲜有研究。本文探讨了针对高性能处理器设计机构的需求，开发专门用于解释VHDL代码的LLM的过程。通过定制测试集和扩展预训练（EPT），专家评估显示代码解释准确率从基础模型的43%提升至69%。研究还开发了LLM-as-a-judge评估方法，指令调优后的EPT模型预期准确率达71%，使用新基础模型可进一步提升至85%以上。最后讨论了利用生成式AI新进展进一步提高硬件设计LLM质量的可能性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T15:01:15Z
- **目录日期**: 2025-05-15
