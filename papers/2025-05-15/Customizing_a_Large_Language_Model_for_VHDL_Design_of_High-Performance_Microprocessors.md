...
近年来，大型语言模型（LLM）在硬件设计中的应用逐渐兴起，主要用于提升芯片设计效率。虽然Verilog设计中的LLM应用备受关注，但VHDL领域的研究较少，尽管其在行业中仍广泛应用。本文探讨了为高性能处理器设计机构开发专用LLM的过程，重点针对VHDL代码解释任务。通过定制测试集和扩展预训练（EPT），模型生成的代码解释专家评分从43%提升至69%。研究还开发了LLM-as-a-judge评估方法，最终指令调优模型的预期专家评分达71%，并指出采用新基模型可进一步提升至85%以上。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T13:08:52Z
- **目录日期**: 2025-05-15
