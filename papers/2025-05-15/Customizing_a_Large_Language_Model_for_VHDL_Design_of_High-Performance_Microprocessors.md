...
近年来，大型语言模型(LLMs)在硬件设计领域的应用日益广泛，主要聚焦于提升芯片设计效率。虽然Verilog设计中的LLM应用已获较多关注，但VHDL语言的应用研究相对不足，尤其在高性能处理器设计领域。本研究开发了专门用于解释VHDL代码的LLM模型，通过扩展预训练(EPT)和专家评估，将代码解释准确率从基础模型的43%提升至69%。研究还开发了LLM-as-a-judge评估方法，经指令微调后模型预期准确率达71%，且使用更新基础模型有望提升至85%以上。最后探讨了利用生成式AI新进展进一步提升硬件设计LLM质量的可能性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T06:01:13Z
- **目录日期**: 2025-05-15
