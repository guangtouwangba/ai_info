...
近年来，大型语言模型(LLMs)在硬件设计中应用广泛，主要提升芯片设计效率。虽然Verilog设计中的LLMs应用备受关注，但VHDL的应用研究较少，尤其在高性能处理器设计领域。本文介绍了开发专用于解释VHDL代码的LLM的过程，针对高性能处理器设计需求创建测试集，并通过扩展预训练(EPT)改进模型。专家评估显示EPT模型的代码解释准确率从基础模型的43%提升至69%。研究还开发了LLM-as-a-judge评估方法，指令调优后的EPT模型预期准确率达71%，使用新基础模型可提升至85%以上。最后探讨了利用生成式AI新进展进一步提升硬件设计LLM质量的可能性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-15T05:01:07Z
- **目录日期**: 2025-05-15
