...
这篇论文提出了"科学层级图谱"(SCIENCE HIERARCHOGRAPHY)，旨在将科学文献组织成多层次的分层结构，帮助追踪跨学科进展。研究者开发了一种结合嵌入聚类和LLM提示的算法，平衡计算效率与语义精度，相比纯LLM方法在质量和速度上取得更好权衡。该框架能多维度分类论文，反映研究的跨学科性。评估显示，基于该结构的LLM代理能更有效地定位目标论文，提升可解释性，支持趋势发现，为文献探索提供传统检索之外的替代途径。相关代码和数据已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T00:01:32Z
- **目录日期**: 2025-04-22
