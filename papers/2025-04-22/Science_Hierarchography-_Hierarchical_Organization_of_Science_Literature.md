...
这篇论文提出了"科学层级图谱"(SCIENCE HIERARCHOGRAPHY)的概念，旨在将科学文献组织成多层次的分层结构，从广泛领域到具体研究实现灵活分类。研究团队开发了一种结合嵌入聚类和LLM提示的算法，在计算效率和语义准确性之间取得平衡。该方法能捕捉论文的多维度分类特征，相比传统搜索方式，这种结构化方法提高了可解释性，支持趋势发现，并为文献探索提供了新途径。实验表明，基于该层级的LLM代理能更有效地定位目标论文。相关代码和数据已在GitHub开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T01:28:32Z
- **目录日期**: 2025-04-22
