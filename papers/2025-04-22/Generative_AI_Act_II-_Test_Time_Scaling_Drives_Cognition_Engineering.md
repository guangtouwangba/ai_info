...
第一代大语言模型（2020-2023）通过大规模参数和数据扩展取得显著成功，但仍存在知识滞后、浅层推理和认知受限等问题。当时提示工程是主要交互方式。当前进入"第二代"（2024起），模型正从潜在空间的知识检索系统转变为通过测试时扩展技术的思维构建引擎，实现了基于语言的思维层面人机交互。本文阐明了认知工程的概念基础，系统分解了相关先进方法，通过教程和优化实现推动该领域普及。相关论文资源见GitHub仓库：https://github.com/GAIR-NLP/cognition-engineering

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T01:28:44Z
- **目录日期**: 2025-04-22
