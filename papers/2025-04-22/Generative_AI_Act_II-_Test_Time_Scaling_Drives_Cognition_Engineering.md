...
第一代大语言模型（2020-2023）通过海量参数和数据扩展取得显著成就，但仍存在知识滞后、浅层推理等局限。这一时期，提示工程成为人机交互的主要方式。当前进入"第二阶段"（2024起），模型正从潜在空间的知识检索系统转变为通过测试时扩展技术构建思维的引擎，实现基于语言思维的深层次交互。本文阐明认知工程的概念基础，分析其发展关键性，并通过教程和优化实现系统解析这些先进方法，推动认知工程民主化。相关论文资源见GitHub仓库：https://github.com/GAIR-NLP/cognition-engineering

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T00:01:43Z
- **目录日期**: 2025-04-22
