...
VAST推出的Tripo Doodle是一款创新工具，可将2D草图和文本提示快速转化为精细3D模型，简化了传统建模流程。该工具已在SIGGRAPH Asia 2024亮相，支持实时修改草图或文本时动态更新3D效果，适用于植物、家具等各类物体建模，并提供"随机化"功能激发创意。其核心组件已开源，使3D建模变得像涂鸦一样简单直观。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T09:02:53Z
- **目录日期**: 2025-04-22
