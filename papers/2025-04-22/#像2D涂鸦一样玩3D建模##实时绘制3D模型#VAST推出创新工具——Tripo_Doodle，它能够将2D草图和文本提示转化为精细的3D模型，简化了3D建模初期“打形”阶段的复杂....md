...
VAST推出的Tripo Doodle工具在SIGGRAPH Asia 2024亮相，可将2D草图或文本提示实时转化为精细3D模型，大幅简化建模初期流程。用户通过简单涂鸦即可生成植物、家具等3D物体，修改草图时模型会动态更新，并支持"随机化"功能探索创意方案。该工具关键组件已开源，使3D建模变得像涂鸦一样直观高效。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T11:02:25Z
- **目录日期**: 2025-04-22
