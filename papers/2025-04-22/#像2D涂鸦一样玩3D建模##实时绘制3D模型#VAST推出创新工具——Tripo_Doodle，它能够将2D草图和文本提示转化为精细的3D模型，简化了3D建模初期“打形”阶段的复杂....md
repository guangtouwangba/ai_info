...
VAST推出的Tripo Doodle是一款创新工具，可将2D草图和文本提示实时转化为精细3D模型，大幅简化3D建模初期流程。该工具已在SIGGRAPH Asia 2024亮相，其开源组件允许用户通过简单涂鸦即时生成3D物体，并支持动态更新。无论是植物、家具还是幻想生物，都能快速建模，还提供"随机化"功能激发创意。这种直观的操作方式让3D建模变得像涂鸦一样简单流畅。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T16:02:37Z
- **目录日期**: 2025-04-22
