...
VAST推出的Tripo Doodle工具革新了3D建模流程，可将2D草图或文本提示实时转化为精细3D模型。该工具简化了传统建模的复杂打形步骤，支持通过涂鸦式绘制生成动态更新的3D效果，并具备随机化功能激发创意。在SIGGRAPH Asia 2024首秀中，它展示了快速生成植物、家具乃至幻想生物的能力，其核心组件已开源。这一技术使3D创作变得如涂鸦般直观高效。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T13:11:22Z
- **目录日期**: 2025-04-22
