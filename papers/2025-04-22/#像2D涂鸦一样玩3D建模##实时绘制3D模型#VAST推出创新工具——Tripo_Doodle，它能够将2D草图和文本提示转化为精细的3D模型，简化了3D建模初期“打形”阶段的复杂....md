...
VAST推出的Tripo Doodle工具通过AI技术实现2D草图/文本到3D模型的实时转换，大幅简化建模流程。该工具在SIGGRAPH Asia 2024亮相，支持手绘涂鸦生成精细3D模型（如植物、家具等），修改草图或文本时3D效果会动态更新，并提供"随机化"功能辅助创意设计。关键组件已开源，使3D建模变得像涂鸦一样直观高效。（注：含配图展示工具界面与生成效果）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T19:03:46Z
- **目录日期**: 2025-04-22
