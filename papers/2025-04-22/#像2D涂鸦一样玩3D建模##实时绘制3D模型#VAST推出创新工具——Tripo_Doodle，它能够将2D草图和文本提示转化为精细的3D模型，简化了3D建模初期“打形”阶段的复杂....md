...
VAST推出的Tripo Doodle是一款创新工具，可将2D草图和文本提示实时转化为精细3D模型，大幅简化3D建模初期流程。该工具已在SIGGRAPH Asia 2024亮相，其开源组件允许用户通过简单涂鸦即时生成并动态调整3D模型，支持从植物到怪兽等多种物体创作。独特的"随机化"功能还能激发创意灵感，使3D建模变得如同涂鸦般直观流畅。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T08:02:55Z
- **目录日期**: 2025-04-22
