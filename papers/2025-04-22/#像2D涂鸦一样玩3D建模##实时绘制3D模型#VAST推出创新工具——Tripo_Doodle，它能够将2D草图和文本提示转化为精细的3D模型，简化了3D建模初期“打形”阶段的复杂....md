...
VAST推出的Tripo Doodle工具革新了3D建模流程，可将2D草图或文本提示实时转化为精细3D模型。该工具简化了传统建模的复杂"打形"步骤，支持动态更新修改，并提供"随机化"功能激发创意。目前已开源核心组件，用户能像涂鸦般轻松生成植物、家具等各类3D物体。该技术于SIGGRAPH Asia 2024首次展示，显著降低了3D创作门槛。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T18:03:55Z
- **目录日期**: 2025-04-22
