...
VAST推出的Tripo Doodle是一款创新工具，能够将2D草图和文本提示实时转化为精细3D模型，简化了传统建模流程。该工具已在SIGGRAPH Asia 2024亮相，支持用户通过简单涂鸦快速生成植物、家具等3D物体，并随草图修改动态更新模型。其开源组件和"随机化"功能为创作者提供了灵活的设计探索方式，使3D建模变得像涂鸦一样直观高效。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T21:04:02Z
- **目录日期**: 2025-04-22
