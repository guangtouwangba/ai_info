...
VAST推出的Tripo Doodle工具可将2D草图和文本提示实时转化为精细3D模型，大幅简化传统建模的复杂流程。该工具已在SIGGRAPH Asia 2024亮相，支持通过简单涂鸦生成植物、家具等各类3D物体，并随草图修改动态更新模型。其开源组件和"随机化"功能为创作者提供直观的创意探索方式，使3D建模变得像涂鸦般简单高效。（注：原文含推广链接及图片信息未纳入摘要）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T20:04:26Z
- **目录日期**: 2025-04-22
