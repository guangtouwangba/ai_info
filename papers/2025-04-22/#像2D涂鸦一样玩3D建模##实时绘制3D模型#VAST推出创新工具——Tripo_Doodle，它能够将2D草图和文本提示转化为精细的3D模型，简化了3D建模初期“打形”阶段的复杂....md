...
VAST推出的Tripo Doodle是一款创新工具，可将2D草图和文本提示实时转化为精细3D模型，显著简化传统建模流程。该工具在SIGGRAPH Asia 2024首次亮相，支持用户通过简单涂鸦生成植物、家具等3D物体，并随草图/文本修改动态更新模型。其开源组件和"随机化"功能为创作者提供高效创意探索，使3D建模如同涂鸦般直观流畅。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T14:04:09Z
- **目录日期**: 2025-04-22
