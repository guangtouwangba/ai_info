...
VAST推出的Tripo Doodle是一款创新工具，能够将2D草图和文本提示实时转化为精细3D模型，大幅简化3D建模初期的复杂流程。该工具已在SIGGRAPH Asia 2024亮相，其核心组件已开源。用户只需简单涂鸦2D形状，即可即时生成并动态调整3D模型，支持从植物到怪兽等多种物体创作。"随机化"功能还能激发创意灵感。这款工具让3D建模变得像涂鸦一样简单直观。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T12:03:59Z
- **目录日期**: 2025-04-22
