...
本文提出了一种新型的LLM智能体记忆系统，能够动态组织记忆。该系统基于Zettelkasten方法，通过动态索引和链接构建互连知识网络。每当新增记忆时，系统会生成包含上下文描述、关键词和标签的结构化笔记，并分析历史记忆建立关联链接。新记忆的加入还能触发对现有记忆的更新，实现知识网络的持续优化。实验表明，该系统在六个基础模型上表现优于现有方法。代码已开源，包括评估代码(https://github.com/WujiangXu/AgenticMemory)和系统实现(https://github.com/agiresearch/A-mem)。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T01:29:50Z
- **目录日期**: 2025-04-22
