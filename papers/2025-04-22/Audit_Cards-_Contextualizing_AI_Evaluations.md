...
当前AI治理框架依赖审计，但评估结果需要结合背景信息才能有效解读。研究发现现有评估报告普遍缺乏关键背景信息，如审计者身份、利益冲突、模型访问权限等，且监管框架缺乏严格的报告规范。为此，研究者提出"审计卡片"方案，通过结构化格式报告六类核心背景特征：审计者身份、评估范围、方法、资源权限、流程完整性和审查机制。分析显示，该方法能提升透明度、促进正确解读并建立报告可信度。研究强调AI评估本质是社会技术过程，需同时关注技术规范与报告实践。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T00:01:21Z
- **目录日期**: 2025-04-22
