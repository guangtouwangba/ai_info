...
多视角理解是MLLMs作为具身智能体的关键能力，但现有模型在几何一致性和跨视角对应上表现不足。研究团队提出All-Angles Bench基准测试，包含90个真实场景的2,100组人工标注多视角QA对，通过6项任务（计数、属性识别、相对距离/方向、物体操控、相机位姿估计）系统评估27个主流MLLMs（包括Gemini-2.0、Claude-3.7和GPT-4o）。实验显示当前模型与人类水平存在显著差距，尤其在部分遮挡视角的跨视角对应和粗略相机位姿估计方面表现欠佳，表明需要开发增强多视角感知的专用模块。该基准为提升MLLMs空间理解能力提供了重要参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T15:01:06Z
- **目录日期**: 2025-04-22
