...
该研究提出了All-Angles Bench基准，用于评估多模态大语言模型（MLLMs）在多视角场景理解中的表现。该基准包含90个真实场景的2100多个标注问答对，涵盖计数、属性识别、相对距离等6项任务，重点测试模型在几何一致性和跨视角信息对齐的能力。实验测试了27个主流MLLMs（包括Gemini-2.0、Claude-3.7和GPT-4o），发现它们与人类水平存在显著差距，尤其在处理部分遮挡视图和相机姿态估计方面表现不佳。研究建议需要开发增强多视角感知的专用模块来提升性能。基准已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T19:01:05Z
- **目录日期**: 2025-04-22
