...
这篇论文提出了All-Angles Bench基准测试，用于评估多模态大语言模型(MLLMs)在多视角场景理解中的表现。该基准包含90个真实场景的2,100多个人工标注问答对，涵盖6项测试几何一致性和跨视角对齐能力的任务。实验测试了27个主流MLLMs(包括Gemini、Claude和GPT-4o)，发现现有模型在遮挡视角的跨视角对应和粗略相机位姿估计方面表现不佳，与人类水平存在显著差距。研究指出需要开发增强多视角感知的专用模块，该基准为提升MLLMs的空间理解能力提供了重要参考。项目已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T13:08:15Z
- **目录日期**: 2025-04-22
