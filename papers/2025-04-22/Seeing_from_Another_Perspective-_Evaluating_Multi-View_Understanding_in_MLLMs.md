...
多模态大语言模型（MLLMs）在多视角理解（如导航、操作和3D场景理解）方面仍面临几何一致性和跨视角对应性的挑战。为此，研究团队提出了All-Angles Bench基准测试，包含90个真实场景的2,100多组人工标注多视角问答对，涵盖计数、属性识别、相对距离等六项任务。测试发现，包括Gemini-2.0-Flash、Claude-3.7-Sonnet和GPT-4o在内的27个MLLMs表现远低于人类水平，尤其在部分遮挡视角的跨视角对应性和粗略相机姿态估计上存在明显不足。该研究为提升MLLMs的多视角理解能力提供了重要参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T06:01:03Z
- **目录日期**: 2025-04-22
