...
这篇论文提出了All-Angles Bench基准测试，用于评估多模态大语言模型(MLLMs)在多视角场景理解中的表现。该基准包含90个真实场景中的2,100个人工标注问答对，涵盖计数、属性识别、相对距离等6项任务。测试27个主流MLLMs(包括Gemini、Claude、GPT-4o)后发现，现有模型在跨视角对应(特别是部分遮挡情况)和相机姿态估计方面显著落后于人类水平。研究表明，MLLMs需要增强多视角感知能力的专门模块。该基准为提升MLLMs的几何一致性理解提供了重要参考。项目已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T12:01:03Z
- **目录日期**: 2025-04-22
