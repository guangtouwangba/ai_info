...
当前多模态大语言模型(MLLMs)在高级推理和规划方面表现出色，但在多视角几何一致性和跨视角对应关系上仍存在明显不足。为此，研究者提出了All-Angles Bench基准测试，包含90个真实场景中的2,100多个标注问答对，通过6项任务评估模型能力。测试27个主流MLLMs(包括Gemini-2.0、Claude-3.7和GPT-4o)后发现，模型在遮挡视角的跨视角对应和粗略相机姿态估计方面表现较差，与人类水平差距显著。该研究为提升MLLMs的多视角理解能力提供了重要参考。项目已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T08:01:02Z
- **目录日期**: 2025-04-22
