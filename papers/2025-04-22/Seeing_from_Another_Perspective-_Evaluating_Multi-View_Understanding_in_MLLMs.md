...
多模态大语言模型（MLLMs）在多视角理解方面仍面临挑战，尤其在几何一致性和跨视角对应关系上表现不足。为此，研究者提出了All-Angles Bench基准测试，包含90个真实场景中2,100个人工标注的多视角问答对，涵盖计数、属性识别、相对距离等六项任务。测试了27个主流MLLMs（如GPT-4o、Gemini-2.0-Flash），发现其性能远低于人类水平，尤其在部分遮挡视角的跨视角对应和粗略相机姿态估计方面表现较差。该研究为提升MLLMs的多视角理解能力提供了重要参考。项目已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T20:01:03Z
- **目录日期**: 2025-04-22
