...
这篇论文提出了All-Angles Bench基准测试，用于评估多模态大语言模型(MLLMs)在多视角场景理解中的表现。该基准包含90个真实场景中的2,100个人工标注问答对，涵盖6项测试几何一致性和跨视角对齐能力的任务。实验测试了27个主流MLLMs(包括Gemini、Claude和GPT-4o)，发现它们与人类表现存在显著差距，尤其在处理部分遮挡视图和粗略相机姿态估计方面表现不佳。研究指出需要开发具有更强多视角感知能力的专用模块，该基准为提升MLLMs的多视角理解能力提供了重要参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T21:00:58Z
- **目录日期**: 2025-04-22
