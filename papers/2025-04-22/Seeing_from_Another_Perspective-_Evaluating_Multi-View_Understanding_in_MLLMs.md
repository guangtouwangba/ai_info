...
多视角理解是MLLMs作为具身智能体的关键挑战。尽管MLLMs在高层次推理和规划方面取得进展，但在几何一致性和跨视角对应上表现不足。研究者提出了All-Angles Bench基准测试，包含90个真实场景的2,100个人工标注问答对，通过6项任务评估模型性能。测试27个主流MLLMs（包括Gemini-2.0-Flash等）发现，模型在遮挡视角对应和相机姿态估计方面显著落后于人类水平。研究表明，MLLMs需要增强多视角感知的专门模块。该基准为提升MLLMs的多视角理解能力提供了重要参考。项目已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T05:01:00Z
- **目录日期**: 2025-04-22
