...
这篇论文提出了一个名为FlowReasoner的查询级元代理系统，用于自动化设计针对每个用户查询的多代理系统。核心思想是通过外部执行反馈激励基于推理的元代理：首先基于DeepSeek R1赋予基础推理能力，再通过强化学习结合多目标奖励（性能、复杂度、效率）进行优化。实验表明，FlowReasoner能针对每个查询生成个性化多代理系统，在工程和竞赛代码基准测试中表现优异，准确率比o1-mini高出10.52%。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T15:01:32Z
- **目录日期**: 2025-04-22
