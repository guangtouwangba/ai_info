...
这项研究通过两阶段实验发现，匿名社交媒体信息能显著影响用户观点。实验让美国参与者先对罗夏墨迹图表达看法，第二阶段随机展示不同信息（包括匿名评论）。结果显示，匿名评论改变了近半数参与者的初始选择，但个体对自身观点的信心会削弱这种影响。基于代理模型分析表明，匿名信息通过简单机制就能改变观点流行度排序。此外，第一阶段信心水平与观点改变频率呈负相关。研究表明，即使匿名信息也能产生实质影响，但接收者的自信程度是关键调节因素。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T07:02:07Z
- **目录日期**: 2025-04-22
