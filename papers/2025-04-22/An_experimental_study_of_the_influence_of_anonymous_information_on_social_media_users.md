...
这项研究通过两阶段实验和基于代理的建模(ABM)发现，匿名社交媒体信息能显著影响用户观点。实验让美国代表性样本参与者先对罗夏墨迹图表达看法，第二阶段随机接受不同信息条件(包括匿名评论)。结果显示匿名评论改变了近半数参与者的初始选择，但影响强度会随参与者对自身选择的信心增强而减弱。ABM证实这种影响可用简单机制解释。研究发现，第一阶段参与者的信心水平与观点改变数量呈负相关。这表明即使匿名信息也能显著改变接收者的观点，进而可能影响观点流行度排名。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T19:02:03Z
- **目录日期**: 2025-04-22
