...
这项研究通过两阶段实验发现，匿名社交媒体信息会显著影响用户观点。实验让美国参与者对罗夏墨迹图发表看法后，随机接收不同信息反馈。结果显示，匿名评论可改变50%参与者的初始选择，但个体对自身观点的信心会削弱这种影响。基于代理模型分析表明，匿名信息通过简单机制就能改变观点流行度排序。此外，第一阶段信心水平与观点改变频率呈负相关。研究表明，即使匿名信息也能显著影响受众决策，但个人确信度越高，受影响的概率越低。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T18:02:00Z
- **目录日期**: 2025-04-22
