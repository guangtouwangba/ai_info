...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译和科研订阅等一站式服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持中英文文献检索、AI摘要生成和互动问答，帮助用户快速理解论文内容。平台还提供个性化科研动态推送，用户可订阅关注领域的最新研究。此外，AMiner具备学者画像、学术会议和论文排行榜等功能，浏览器版可免费使用。其AI工具能解析上传的PDF文献，生成摘要并回答相关问题，提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T19:05:25Z
- **目录日期**: 2025-04-22
