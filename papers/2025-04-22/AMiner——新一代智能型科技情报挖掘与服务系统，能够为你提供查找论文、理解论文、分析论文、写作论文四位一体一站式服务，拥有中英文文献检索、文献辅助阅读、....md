...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、辅助阅读、翻译及学术分析。其核心功能包括：1）精准检索3.5亿论文资源；2）AI生成摘要与互动问答，提升文献理解效率；3）支持PDF上传及多语言翻译；4）定制化科研动态推送。平台覆盖42个学科，整合学者、专利及项目数据，并提供免费基础服务。特色功能含学者画像、会议追踪等，通过网页或微信小程序即可使用。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T07:06:16Z
- **目录日期**: 2025-04-22
