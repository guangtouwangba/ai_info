...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、辅助阅读、翻译和科研情报订阅。它拥有3.5亿论文、0.6亿学者等海量数据，支持AI生成摘要、问答互动和个性化订阅推送。用户可通过关键词、学者或机构定制最新研究动态，并利用文档解析、章节概览等功能高效理解文献。平台还提供学者画像、学术会议等特色服务，浏览器版本可免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T15:06:17Z
- **目录日期**: 2025-04-22
