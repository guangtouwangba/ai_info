...
AMiner是一个智能科技情报挖掘系统，提供论文检索、辅助阅读、翻译、写作等一站式服务。它支持中英文文献搜索，能自动生成摘要和问答互动，帮助用户快速理解内容。平台还提供科研情报订阅功能，根据用户偏好推送最新学术动态。此外，AMiner包含学者画像、学术会议和论文排行榜等工具，收录3.5亿论文、0.6亿学者等海量数据。用户可通过网页免费使用基础功能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T11:04:47Z
- **目录日期**: 2025-04-22
