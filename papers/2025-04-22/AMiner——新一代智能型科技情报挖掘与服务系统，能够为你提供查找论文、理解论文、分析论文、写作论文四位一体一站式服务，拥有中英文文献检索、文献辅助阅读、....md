...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和科研订阅等一站式服务。它收录3.5亿论文、0.6亿学者和1.5亿专利，支持中英文文献搜索、AI生成摘要及互动问答。用户可上传PDF或从平台选论文，获取章节概要和问题建议。订阅功能可按偏好推送最新科研动态。此外，AMiner还提供学者画像、学术会议和论文排行榜等功能，基础服务免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T05:05:59Z
- **目录日期**: 2025-04-22
