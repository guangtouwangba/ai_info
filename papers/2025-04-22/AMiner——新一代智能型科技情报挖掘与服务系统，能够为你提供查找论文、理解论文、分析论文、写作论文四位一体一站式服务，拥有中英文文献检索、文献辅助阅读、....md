...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、辅助阅读、翻译、智能问答等功能。它收录了3.5亿论文、0.6亿学者和1.5亿专利，支持用户快速定位文献、生成摘要和翻译内容。平台还提供科研动态订阅服务，根据用户偏好推送最新学术资讯。此外，AMiner具备学者画像、学术会议推荐等特色功能，浏览器版本可免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T20:06:33Z
- **目录日期**: 2025-04-22
