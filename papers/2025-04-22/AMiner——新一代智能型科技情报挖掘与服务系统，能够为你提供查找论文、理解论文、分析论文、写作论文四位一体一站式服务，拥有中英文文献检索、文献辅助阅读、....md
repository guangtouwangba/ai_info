...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译及科研订阅等一站式服务。它收录3.5亿论文、0.6亿学者和1.5亿专利，支持中英文文献搜索、AI生成摘要和互动问答。用户可上传PDF或从平台获取论文，通过AI快速理解内容。此外，AMiner提供个性化科研动态推送，跟踪机构、学者及关键词，并通过微信或邮件发送最新资讯。平台还包含学者画像、学术会议和论文排行榜等功能，基础服务免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T10:06:05Z
- **目录日期**: 2025-04-22
