...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译、科研订阅等一站式服务。它收录了3.5亿论文、0.6亿学者和1.5亿专利，支持中英文文献搜索、AI生成摘要、互动问答和文档翻译功能。用户可定制科研动态推送，关注特定学者或关键词。平台还提供学者画像、学术会议和论文排行榜等工具，部分功能免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T12:06:22Z
- **目录日期**: 2025-04-22
