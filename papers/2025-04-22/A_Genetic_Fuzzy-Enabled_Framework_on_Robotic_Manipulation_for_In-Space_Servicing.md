...
随着近地轨道卫星数量增加，地月空间机器人系统的自动化维护变得至关重要。为确保卫星维护的安全性，控制系统需兼具高效性和可靠性。本研究将遗传模糊树（Genetic Fuzzy Trees）与广泛使用的LQR控制方案相结合，通过Thales的TrUE AI工具包开发了一种新型控制器，用于双自由度平面机械臂的卫星维护。实验表明，遗传模糊-LQR控制器平均性能比最优LQR提升18.5%，且对不确定性具有极强鲁棒性。该成果为太空机器人提供了可信赖的高效控制方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T13:09:10Z
- **目录日期**: 2025-04-22
