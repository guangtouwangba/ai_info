...
随着近地轨道卫星数量增加，地月空间机器人系统的自动化维护变得至关重要。卫星维护需要极高安全性，因此控制技术必须兼具高效性和可靠性。本研究将遗传模糊树与广泛使用的LQR控制方案相结合，通过Thales公司的TrUE AI工具包，开发了一种用于双自由度平面机械臂的可信高效控制器。实验表明，遗传模糊-LQR控制器平均性能比最优LQR提升18.5%，且对不确定性具有极强鲁棒性。该控制器理论上可用于卫星维护任务，为自动化太空服务提供了新解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T14:01:57Z
- **目录日期**: 2025-04-22
