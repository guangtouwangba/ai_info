...
数势科技联合创始人谭李在AIGC产业峰会上指出，企业级AI应用面临数据洞见获取难的挑战。AI Agent（如SwiftAgent平台）通过让业务人员像与分析师对话一样获取数据，助力决策。三大趋势推动新数据消费范式：数据右移、决策下移、管理后移。基础模型成本下降（如DeepSeek）加速企业AI应用落地，未来成本或进一步降低。核心是让非技术人员快速获取数据支持，而非简单"Excel+Chat"。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T13:10:56Z
- **目录日期**: 2025-04-22
