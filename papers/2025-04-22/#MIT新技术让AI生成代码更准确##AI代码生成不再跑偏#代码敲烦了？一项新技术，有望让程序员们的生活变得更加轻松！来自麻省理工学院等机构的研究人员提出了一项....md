...
MIT研究人员提出新技术，通过序列蒙特卡洛方法并行生成多个代码候选，动态分配计算资源并筛选最优结果，实现AI生成代码的结构规范性和语义准确性双重控制。该方法使小型开源模型在Python代码生成任务中超越体积更大的商业模型。相比传统"完整检查"或"渐进修正"方案，新技术能避免资源浪费和语义偏离问题。未来计划将该技术扩展到更大规模文本生成，并结合学习机制持续优化。研究成果将在ICLR发表，相关代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T19:02:53Z
- **目录日期**: 2025-04-22
