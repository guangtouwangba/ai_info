...
MIT研究人员开发了一项新技术，通过序列蒙特卡洛方法让AI生成更准确的代码。该技术让语言模型并行生成多个候选代码，动态分配计算资源，根据结构和语义准确性筛选最优结果。测试显示，采用该方法的小型开源模型性能甚至超越体积更大的商业模型。相比传统方法（完整输出检查耗资源/渐进检查易偏离），新技术能同时控制代码规范性和语义准确性。该成果将在ICLR发表，未来计划扩展到更大规模文本生成并整合学习机制。论文和代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T17:03:09Z
- **目录日期**: 2025-04-22
