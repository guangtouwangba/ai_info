...
MIT研究人员开发了一种新技术，通过序列蒙特卡洛方法并行生成多个候选代码，动态分配计算资源并评估每个输出的结构和语义准确性。该方法将专家知识编码到大型语言模型(LLM)中，在Python代码生成测试中，小型开源模型表现优于体积更大的商业模型。相比传统方法(完整检查或渐进修正)，新技术能同时控制代码规范性和语义准确性，避免资源浪费或结果偏离。该成果将在ICLR发表，未来计划扩展到更大规模文本生成并整合学习机制。开源代码已发布在GitHub。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T18:02:55Z
- **目录日期**: 2025-04-22
