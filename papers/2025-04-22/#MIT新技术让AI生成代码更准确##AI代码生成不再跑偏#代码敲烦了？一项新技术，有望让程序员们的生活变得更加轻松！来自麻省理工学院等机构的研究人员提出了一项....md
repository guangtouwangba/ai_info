...
MIT研究人员开发了一种新技术，通过序列蒙特卡洛方法并行生成多个候选代码，动态分配计算资源并筛选最优结果，显著提升了AI生成代码的准确性和结构规范性。在测试中，采用该方法的小型开源模型表现优于体积更大的商业模型。该技术通过双重控制代码结构和语义，有效解决了现有方法在计算效率或语义准确性上的不足。研究成果将在ICLR发表，未来计划扩展到更大规模文本生成并与学习机制结合。开源代码已发布在GitHub。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T16:01:36Z
- **目录日期**: 2025-04-22
