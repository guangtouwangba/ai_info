...
MIT研究人员开发了一种新技术，通过序列蒙特卡洛方法并行生成多个候选代码，动态分配计算资源并淘汰低质量结果，确保AI生成的代码同时符合编程规范与用户意图。在测试中，采用该方法的小型开源模型表现优于体积更大的商业模型。该技术解决了现有方法在计算效率或语义准确性上的不足，未来有望扩展至更大规模文本生成。研究成果将在ICLR发表，相关代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T14:03:05Z
- **目录日期**: 2025-04-22
