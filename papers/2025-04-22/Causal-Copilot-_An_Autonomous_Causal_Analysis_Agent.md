...
这篇论文介绍了Causal-Copilot，一个基于大语言模型的自主代理系统，旨在降低因果分析的复杂性，使其更易于领域专家使用。该系统自动化了因果分析的完整流程，包括因果发现、因果推断、算法选择、超参数优化、结果解释和生成可操作见解，支持表格和时间序列数据。通过整合20多种先进的因果分析技术，Causal-Copilot为非专业人士提供了交互式自然语言界面，同时保持方法论的严谨性。实证评估显示，其性能优于现有基线，有效弥合了因果分析的理论复杂性与实际应用之间的差距。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T15:02:29Z
- **目录日期**: 2025-04-22
