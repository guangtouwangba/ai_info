...
这篇论文介绍了Causal-Copilot，一个基于大语言模型的自主代理系统，旨在降低因果分析的复杂性，让领域专家也能轻松使用。它自动化了因果分析的完整流程，包括因果发现、因果推断、算法选择、超参数优化等，支持自然语言交互，集成了20多种先进的因果分析技术。该系统既帮助非专业人士进行严谨的因果分析，又为研究者提供了丰富的实际应用场景。实证评估显示，Causal-Copilot性能优于现有基线，有效弥合了因果分析的理论复杂性与实际应用之间的鸿沟。系统已提供在线演示。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T23:02:04Z
- **目录日期**: 2025-04-22
