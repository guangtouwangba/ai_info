...
这篇论文介绍了Causal-Copilot，一个基于大语言模型的自主代理系统，旨在降低因果分析的复杂性，使领域专家也能轻松使用。该系统自动化了因果分析的完整流程，包括因果发现、因果推断、算法选择、超参数优化等，支持自然语言交互，整合了20多种前沿因果分析方法。Causal-Copilot既为非专业人士提供了易用工具，又通过真实应用场景推动了因果理论的发展。实证评估表明，其性能优于现有基线方法，有效弥合了因果分析的理论复杂性与实际应用之间的鸿沟。系统已提供在线演示。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T19:02:13Z
- **目录日期**: 2025-04-22
