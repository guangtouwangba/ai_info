...
这篇论文介绍了Causal-Copilot，一个基于大语言模型的自主代理系统，旨在简化因果分析流程，使其更易于非专家使用。该系统自动化了因果发现、因果推断、算法选择、超参数优化等全流程，支持通过自然语言交互进行结果解释和生成可操作见解。Causal-Copilot整合了20多种先进的因果分析技术，在实证评估中表现优于现有基线，为领域专家提供了可靠、可扩展的解决方案，弥合了因果分析的理论复杂性与实际应用之间的差距。系统演示可在https://causalcopilot.com/访问。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T10:02:15Z
- **目录日期**: 2025-04-22
