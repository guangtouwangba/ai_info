...
本文介绍了AgentSociety，这是一个基于大语言模型的大规模社会模拟器，包含1万个代理和500万次互动。研究者用它模拟了社会极化、信息传播、基本收入政策和自然灾害影响四个关键问题。结果显示其模拟结果与现实世界数据高度吻合，证明该平台能有效捕捉人类行为机制，为社会科学研究和政策制定提供了新工具。该成果展示了大语言模型在社会模拟中的潜力，可作为传统研究方法的补充。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T23:04:49Z
- **目录日期**: 2025-04-22
