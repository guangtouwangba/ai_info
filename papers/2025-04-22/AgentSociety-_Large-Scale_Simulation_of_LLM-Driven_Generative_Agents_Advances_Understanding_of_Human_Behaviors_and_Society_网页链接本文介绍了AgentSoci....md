...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟10,000+个AI代理及其500万次社会互动。该平台通过四个社会问题案例（社会极化、信息传播、基本收入政策、自然灾害影响）验证其有效性，模拟结果与现实数据高度吻合。研究表明，该系统能有效捕捉人类行为机制，为社会科学研究和政策制定提供新工具，补充传统调查和实验方法的不足。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T17:05:45Z
- **目录日期**: 2025-04-22
