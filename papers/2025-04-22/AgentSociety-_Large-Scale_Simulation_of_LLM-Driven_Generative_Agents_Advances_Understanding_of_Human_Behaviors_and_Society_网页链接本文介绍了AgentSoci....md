...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理的社会互动（500万次交互）。研究者用它分析四大社会问题：社会极化、信息传播、基本收入政策效果和自然灾害影响。模拟结果与现实数据高度吻合，验证了该系统在揭示人类行为机制方面的可靠性。该系统可作为计算社会科学的研究平台，为学者和政策制定者提供传统方法（如调查）之外的补充工具，帮助理解复杂社会现象的成因和机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T01:32:47Z
- **目录日期**: 2025-04-22
