...
研究表明，配备基本编程工具的大语言模型（LLM）编码代理能够自主修改自身代码，从而提升基准任务表现。在SWE Bench Verified随机子集上，性能提升达17%至53%，在LiveCodeBench和合成代理基准测试中也有额外增益。该工作推动了自动化、开放式智能代理系统的设计，并为工具使用和其他代理任务的LLM后训练提供了参考框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T17:01:47Z
- **目录日期**: 2025-04-22
