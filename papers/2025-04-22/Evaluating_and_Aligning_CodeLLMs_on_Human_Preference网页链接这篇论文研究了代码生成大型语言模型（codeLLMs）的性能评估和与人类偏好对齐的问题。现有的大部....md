...
这篇论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，强调现有评估忽视人类偏好匹配的问题。研究者从真实查询中精选397个样本(覆盖40类/44种语言)，并构建20B标记的SynCode-Instruct合成指令集验证微调效果。实验发现执行基准与CodeArena存在性能差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)差距显著，凸显人类偏好对齐的重要性。研究通过模拟真实编程场景的复杂性，为代码LLM评估提供了更全面的视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T02:33:34Z
- **目录日期**: 2025-04-22
