...
这篇论文针对代码生成大模型(codeLLMs)的评估标准提出创新，指出当前基准测试过于侧重代码正确性而忽视人类偏好。研究者构建了CodeArena基准测试(包含397个涵盖40类编程任务的样本)和SynCode-Instruct语料库(近200亿标记)，通过实验发现：1)传统执行测试与人类偏好存在偏差；2)开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究强调了代码生成模型与人类偏好对齐的重要性，为改进评估体系提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T17:06:25Z
- **目录日期**: 2025-04-22
