...
这篇论文针对代码生成大模型(codeLLMs)提出新评估方法，发现现有基准测试过于关注代码正确性而忽视人类偏好。研究者构建了CodeArena基准测试(含397个高质量样本，覆盖40类44种语言)和SynCode-Instruct指令集(近200亿标记)，通过实验揭示了执行基准与人类偏好间的性能差异。结果显示开源顶级模型(如Qwen2.5-Coder)与专有模型(如OpenAI o1)存在显著差距，凸显了模型与人类偏好对齐的重要性。研究为提升代码LLMs的实际应用价值提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T15:06:29Z
- **目录日期**: 2025-04-22
