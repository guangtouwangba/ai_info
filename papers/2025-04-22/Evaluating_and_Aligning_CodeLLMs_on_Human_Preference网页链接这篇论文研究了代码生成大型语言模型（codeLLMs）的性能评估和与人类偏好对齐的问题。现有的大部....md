...
这篇论文探讨了代码生成大模型（CodeLLMs）如何与人类偏好对齐的问题。现有基准主要测试代码正确性，而忽略了人类偏好匹配。为此，研究者构建了CodeArena基准（包含397个高质量样本，覆盖40类任务和44种编程语言）和SynCode-Instruct合成指令集（近200亿标记）。实验发现执行基准与CodeArena存在性能差异，开源顶级模型（如Qwen2.5-Coder）与专有模型（如OpenAI o1）差距显著，凸显了人类偏好对齐的重要性。研究证实大规模合成指令微调的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T01:33:25Z
- **目录日期**: 2025-04-22
