...
这篇论文针对代码生成大型语言模型(codeLLMs)提出新评估方法，重点关注与人类偏好的对齐。研究者创建了CodeArena基准测试(包含397个高质量样本，覆盖40类任务和44种语言)和SynCode-Instruct语料库(近200亿标记)，发现传统执行基准与人类偏好存在差异。实验比较40多个模型显示，顶级开源模型(如Qwen2.5-Coder)与专有模型(如OpenAI o1)性能差距显著，凸显了人类偏好对齐的重要性。研究验证了大规模合成指令微调的有效性，为改进代码LLMs提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T04:05:52Z
- **目录日期**: 2025-04-22
