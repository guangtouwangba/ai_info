...
这篇论文针对代码生成大模型(codeLLMs)与人类偏好对齐的问题，提出了CodeArena基准测试(包含397个高质量样本，覆盖40类任务和44种编程语言)和SynCode-Instruct合成指令数据集(近200亿标记)。研究发现现有基于执行的评测与人类偏好存在偏差，实验显示开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，凸显了人类偏好对齐的重要性。研究通过构建更贴近实际编程场景的评估体系，为提升代码生成模型的实际可用性提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T23:05:24Z
- **目录日期**: 2025-04-22
