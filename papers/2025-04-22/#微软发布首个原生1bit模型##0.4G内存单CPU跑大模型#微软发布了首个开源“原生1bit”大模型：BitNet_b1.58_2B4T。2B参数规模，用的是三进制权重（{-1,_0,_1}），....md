...
微软发布全球首个开源"原生1bit"大模型BitNet b1.58 2B4T，采用三进制权重（-1,0,1），仅需0.4GB内存即可在单CPU上流畅运行。该2B参数模型每秒可生成5-7个token，延迟低至29ms，能耗仅0.028焦耳/次，性能媲美全精度模型，在数学和常识推理任务上超越Llama等主流模型。其超低资源需求使普通笔记本、树莓派等设备都能高效运行，为边缘计算带来突破性进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T00:04:20Z
- **目录日期**: 2025-04-22
