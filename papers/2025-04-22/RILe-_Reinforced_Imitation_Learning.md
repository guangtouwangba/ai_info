...
本文提出RILe框架，通过结合模仿学习(IL)和逆强化学习(IRL)的优势，解决高维环境中复杂行为学习的难题。传统方法存在计算成本高或反馈不足的问题，而RILe采用新型"训练师-学生"机制：训练师学习自适应奖励函数，学生利用该信号模仿专家行为。该框架能动态调整指导策略，在不同学习阶段提供精细化反馈，在高维任务中表现优异。实验证明，RILe在机器人运动控制等复杂任务中显著优于现有方法，几乎达到专家水平，为高维环境下的智能体学习提供了高效解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-22T06:02:39Z
- **目录日期**: 2025-04-22
