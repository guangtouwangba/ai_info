...
大型语言模型（LLM）驱动的数据科学代理（如AutoMind）旨在自动化机器学习流程，但现有框架因僵化的工作流程和编码策略而难以应对复杂任务。AutoMind通过三大创新突破限制：（1）基于专家知识库增强领域认知；（2）采用智能树搜索算法探索解决方案；（3）自适应编码策略动态调整代码生成。实验表明，该框架在自动化数据科学基准测试中性能优于现有方案，兼具高效性与鲁棒性，推动了全自动化数据科学的发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-16T00:01:10Z
- **目录日期**: 2025-06-16
