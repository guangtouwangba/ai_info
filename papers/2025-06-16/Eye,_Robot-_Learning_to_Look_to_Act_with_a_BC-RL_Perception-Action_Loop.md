...
研究人员开发了EyeRobot系统，通过强化学习训练机械眼球实现主动注视行为，以完成现实任务。该系统采用360°摄像头采集数据，并在仿真环境中训练手眼协同策略：手部（行为克隆）从眼球观测中学习动作，而眼球（强化学习）通过手部动作准确性获得奖励，从而自然形成注视任务相关区域的能力。其仿生中央凹架构实现了高分辨率低算力需求，带来更稳定的注视和目标跟踪能力。实验表明，EyeRobot能在单摄像头下有效完成大范围全景操作任务，验证了主动注视对机器人操作的重要性。项目网址：https://www.eyerobot.net/ （99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-16T00:01:19Z
- **目录日期**: 2025-06-16
