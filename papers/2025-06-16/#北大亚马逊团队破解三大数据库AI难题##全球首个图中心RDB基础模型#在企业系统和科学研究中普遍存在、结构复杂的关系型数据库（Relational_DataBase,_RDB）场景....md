...
北京大学张牧涵团队与亚马逊云科技合作开发了全球首个图中心RDB基础模型Griffin。该模型创新性地将关系型数据库(RDB)视为动态异质图进行建模，通过在超1.5亿行表格数据上的预训练和微调，解决了传统大模型在多表交互和异质特征场景下的应用难题。Griffin展现出优异的可迁移性和泛化能力，为复杂数据库环境提供了AI解决方案。这项突破性成果已被国际顶级会议ICML 2025接收，标志着结构化数据AI处理的重要进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-16T03:27:09Z
- **目录日期**: 2025-06-16
