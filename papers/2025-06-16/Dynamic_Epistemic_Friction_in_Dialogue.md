...
这篇论文探讨了在人类与AI协作中，大型语言模型（LLM）与人类偏好对齐时面临的"认知摩擦"问题。认知摩擦指在整合新信息时，因与现有信念冲突而产生的阻力。作者将其定义为"动态认知摩擦"，即智能体当前信念与外部证据支持的新命题之间的错位。基于动态认知逻辑框架，研究分析了协作任务中的对话数据，表明该模型能有效预测信念更新。最后讨论了如何完善这一模型，以更好地适应现实对话场景的复杂性，提升LLM在协作中的实用性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-16T00:01:56Z
- **目录日期**: 2025-06-16
