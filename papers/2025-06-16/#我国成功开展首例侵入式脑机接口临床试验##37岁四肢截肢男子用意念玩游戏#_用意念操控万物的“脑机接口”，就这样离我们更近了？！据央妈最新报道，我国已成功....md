...
我国成功开展首例侵入式脑机接口临床试验，由中科院脑智卓越中心联合华山医院等团队完成。一名37岁四肢截肢男子通过植入全球最小、柔性最强的神经电极（硬币大小，电极丝达头发丝的1/100），实现意念操控五子棋、发短信等功能。该技术超越Neuralink的部分参数，使我国成为全球第二个进入该领域临床试验的国家。短期目标为机械臂抓握，长期或拓展至机器狗等智能设备控制。这一突破标志着脑机接口技术从科幻迈向现实应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-16T02:35:17Z
- **目录日期**: 2025-06-16
