...
这篇论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，通过397个涵盖40类编程任务和44种语言的样本，评估模型与人类偏好的对齐程度。研究发现现有基于执行的测试与人类偏好存在差距，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著。同时构建了包含近200亿标记的SynCode-Instruct合成指令数据集，验证了大规规模指令微调的有效性，强调了代码生成模型除正确性外还需关注人类偏好对齐的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T19:05:37Z
- **目录日期**: 2025-05-24
