...
这篇论文探讨了代码生成大模型（codeLLMs）如何与人类偏好对齐的问题。研究者创建了CodeArena基准测试，包含397个高质量编程任务样本，覆盖40个类别和44种语言，更贴近实际开发场景。同时开发了SynCode-Instruct语料库（近200亿标记）验证合成指令微调效果。实验发现传统执行基准与CodeArena存在性能差异，且开源模型（如Qwen2.5-Coder）与商业模型（如OpenAI o1）差距显著，凸显了模型与人类偏好对齐的重要性。研究为提升代码LLM的实际应用价值提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T13:12:50Z
- **目录日期**: 2025-05-24
