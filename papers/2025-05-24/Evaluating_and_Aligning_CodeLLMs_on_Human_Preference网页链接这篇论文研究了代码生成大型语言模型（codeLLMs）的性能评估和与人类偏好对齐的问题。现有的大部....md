...
这篇论文针对代码生成大模型(codeLLMs)与人类偏好对齐的问题，提出了CodeArena基准测试和SynCode-Instruct指令集。CodeArena包含397个高质量编程任务样本，覆盖40个类别和44种语言，更贴近实际开发需求。研究发现在执行基准和人类偏好评估间存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。通过构建近200亿token的合成指令数据，验证了大模型微调的有效性，强调了代码生成模型需要同时关注正确性和人类偏好对齐。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T23:05:31Z
- **目录日期**: 2025-05-24
