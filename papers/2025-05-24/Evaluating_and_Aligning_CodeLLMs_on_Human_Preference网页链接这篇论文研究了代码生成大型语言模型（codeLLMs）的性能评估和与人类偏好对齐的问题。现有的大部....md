...
这篇论文针对代码生成大模型(codeLLMs)与人类偏好对齐的问题，提出了CodeArena基准测试和SynCode-Instruct合成指令数据集。CodeArena包含397个高质量编程任务样本，覆盖40类任务和44种语言，更贴近实际开发需求。研究发现在40多个模型中，开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)存在显著差距，验证了与人类偏好对齐的重要性。同时，通过近200亿token的合成指令数据证实了大规规模指令微调的有效性，为提升代码生成质量提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T15:06:03Z
- **目录日期**: 2025-05-24
