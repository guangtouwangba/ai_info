...
该论文针对代码生成大语言模型(codeLLMs)提出新评估方法，重点关注与人类偏好的对齐。研究创建了CodeArena基准测试(包含397个高质量样本，覆盖40类任务和44种语言)和SynCode-Instruct语料库(近200亿标记)，发现传统执行测试与人类偏好评估存在差异。实验比较40多个模型显示，顶级开源模型(如Qwen2.5-Coder)与专有模型(如OpenAI o1)性能差距显著，凸显对齐人类偏好的重要性。研究为提升代码LLMs的实际应用价值提供了新评估框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T07:06:06Z
- **目录日期**: 2025-05-24
