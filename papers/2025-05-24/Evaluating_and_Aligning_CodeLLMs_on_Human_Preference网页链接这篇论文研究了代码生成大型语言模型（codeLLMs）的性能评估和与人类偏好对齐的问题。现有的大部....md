...
这篇论文提出了CodeArena基准测试和SynCode-Instruct语料库，用于评估代码生成大语言模型（codeLLMs）与人类偏好的对齐程度。CodeArena包含397个高质量样本，覆盖40个类别和44种编程语言，模拟真实编程任务。研究发现在40多个模型中，开源顶级codeLLM（如Qwen2.5-Coder）与专有模型（如OpenAI o1）存在显著差距，表明现有基于执行的基准测试无法充分反映人类偏好。论文强调需要改进模型对齐方法，并验证了大规模合成指令微调的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T01:32:51Z
- **目录日期**: 2025-05-24
