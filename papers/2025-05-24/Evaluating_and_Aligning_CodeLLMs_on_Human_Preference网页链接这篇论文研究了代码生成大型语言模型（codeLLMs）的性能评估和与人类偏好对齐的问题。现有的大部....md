...
该论文针对代码生成大模型(codeLLMs)提出CodeArena基准，通过397个涵盖40类编程任务和44种语言的样本评估模型与人类偏好的对齐程度，弥补了传统基准仅关注代码正确性的不足。研究同时构建了20B标记的合成指令数据集SynCode-Instruct验证大规模微调效果。实验发现执行基准与人类偏好评估存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，突显对齐人类偏好的重要性。研究强调了代码生成模型在实际应用中的用户体验关键作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T12:06:08Z
- **目录日期**: 2025-05-24
