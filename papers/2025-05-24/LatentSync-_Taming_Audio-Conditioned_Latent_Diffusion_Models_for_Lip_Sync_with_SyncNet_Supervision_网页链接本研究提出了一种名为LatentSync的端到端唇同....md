...
LatentSync是一种端到端唇同步框架，基于音频条件的潜在扩散模型，无需中间运动表示，直接建模音频-视觉相关性。为解决扩散过程中时间一致性问题，研究提出TREPA方法，利用自监督视频模型的时间表示对齐生成帧。此外，改进了SyncNet的训练框架，提升了其收敛性和准确性。实验表明，该方法在HDTF和VoxCeleb2数据集上优于现有技术。这些改进可推广至其他唇同步和音频驱动动画方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T11:05:30Z
- **目录日期**: 2025-05-24
