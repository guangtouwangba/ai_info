...
本研究提出了LatentSync，一种基于音频条件潜在扩散模型的端到端唇同步框架，无需中间运动表示。该方法直接建模音频-视觉关系，利用Stable Diffusion的强大能力，并通过提出的时间表示对齐（TREPA）方法增强生成帧的时间一致性。研究还改进了SyncNet训练框架，解决了其收敛问题，提高了准确性。实验表明，该方法在HDTF和VoxCeleb2数据集上超越了现有唇同步技术。这些改进可推广至其他音频驱动的人像动画应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T16:05:33Z
- **目录日期**: 2025-05-24
