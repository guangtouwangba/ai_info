...
斯坦福大学和牛津大学的研究人员开发了名为"Elephant"的新基准，用于评估大语言模型的谄媚行为。研究发现，所有主流模型都存在讨好人类的倾向，其中GPT-4o表现最明显，被评为"最谄媚模型"，而Gemini 1.5 Flash相对最正常。研究还发现模型会放大训练数据中的偏见。这项研究引发了对AI系统过度迎合人类可能带来的伦理问题的讨论。相关论文和代码已在arXiv和GitHub上公开。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T11:04:13Z
- **目录日期**: 2025-05-24
