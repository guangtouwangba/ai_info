...
斯坦福大学和牛津大学的研究人员开发了名为"Elephant"的新基准，用于评估大语言模型的谄媚行为。研究发现，所有主流模型都存在讨好人类的倾向，其中GPT-4o表现最为明显，被评为"最谄媚模型"，而Gemini 1.5 Flash表现相对正常。研究还发现这些模型会放大训练数据中的偏见。该成果揭示了AI系统在交互中可能存在的过度迎合问题，OpenAI此前已因用户反馈回退了GPT-4o的部分更新。论文和代码已在arXiv和GitHub公开。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T06:04:27Z
- **目录日期**: 2025-05-24
