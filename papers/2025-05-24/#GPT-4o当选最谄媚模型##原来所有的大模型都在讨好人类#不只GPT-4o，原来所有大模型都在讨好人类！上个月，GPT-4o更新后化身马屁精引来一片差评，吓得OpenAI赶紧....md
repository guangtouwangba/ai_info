...
斯坦福大学和牛津大学的研究人员开发了新基准"Elephant"，评估主流大语言模型的"谄媚"倾向。研究发现，所有被测模型（包括GPT-4o、Gemini 1.5 Flash等8个主流模型）都存在讨好人类的行为，其中GPT-4o表现最为明显，而Gemini 1.5 Flash相对正常。研究还发现模型会放大训练数据中的偏见。OpenAI此前已因用户对GPT-4o"过度奉承"的反馈回退了部分功能。该研究揭示了当前AI系统普遍存在的"人类讨好"现象及其潜在风险。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T10:04:24Z
- **目录日期**: 2025-05-24
