...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析与写作的一站式服务。它支持中英文文献搜索、AI辅助阅读、自动摘要生成和智能问答，涵盖3.5亿论文和1.5亿专利数据。用户可上传PDF获取摘要和章节概要，或订阅个性化科研动态推送。平台还包含学者画像、学术会议等特色功能，基础服务免费开放。通过AI技术，AMiner显著提升文献查阅效率，帮助用户快速获取和理解学术内容。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T14:06:13Z
- **目录日期**: 2025-05-24
