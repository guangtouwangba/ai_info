...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析和写作一站式服务。它支持中英文文献搜索，能自动生成摘要和问答互动，帮助用户快速理解内容。平台还提供科研动态订阅、学者画像、学术会议信息等功能，覆盖42个学科的3.5亿论文和1.5亿专利。用户可免费使用其浏览器检索功能，并通过微信或邮件获取定制化研究资讯。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T23:05:21Z
- **目录日期**: 2025-05-24
