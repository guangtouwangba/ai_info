...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、辅助阅读、翻译和科研情报订阅等。其数据库涵盖42个学科的3.5亿论文、0.6亿学者和1.5亿专利。用户可通过互动问答快速获取文献摘要，并利用AI工具生成章节概要和问题建议。平台还支持个性化订阅，通过微信或邮件推送最新科研动态。此外，AMiner提供学者画像、学术会议和论文排行榜等功能，基础检索服务免费开放。访问入口：https://www.aminer.cn/。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T20:05:28Z
- **目录日期**: 2025-05-24
