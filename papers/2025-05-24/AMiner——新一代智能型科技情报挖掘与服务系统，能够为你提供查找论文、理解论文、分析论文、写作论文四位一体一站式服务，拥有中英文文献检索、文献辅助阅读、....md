...
AMiner是一款智能科技情报挖掘系统，提供论文检索、翻译、分析及写作一站式服务。支持中英文文献搜索，可生成摘要和问答互动，帮助快速理解内容。具备文档识别、辅助阅读功能，用户可上传PDF或从平台获取论文。提供科研动态订阅服务，根据用户偏好推送最新学术资讯。平台还包含学者画像、学术会议等特色功能，收录3.5亿论文、0.6亿学者等海量数据。免费使用，可通过网页或微信小程序体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T19:05:25Z
- **目录日期**: 2025-05-24
