...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、辅助阅读、翻译、论文分析等功能。平台收录了3.5亿论文、0.6亿学者等海量数据，支持AI生成摘要、互动问答和文档翻译。用户可订阅个性化科研动态，追踪学者或机构的最新成果。此外，AMiner还提供学者画像、学术会议和论文排行榜等工具，帮助用户高效获取和管理学术信息。其浏览器版本可免费使用，适合科研人员快速查找和理解文献。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T15:05:51Z
- **目录日期**: 2025-05-24
