...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、辅助阅读、翻译、摘要生成等功能。它覆盖42个学科，拥有3.5亿论文、0.6亿学者等海量数据。用户可通过智能问答快速理解文献，订阅个性化科研动态，还能使用学者画像、会议追踪等工具。平台支持PDF上传和AI辅助分析，帮助高效撰写论文。部分功能免费开放，适合科研人员使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T22:05:24Z
- **目录日期**: 2025-05-24
