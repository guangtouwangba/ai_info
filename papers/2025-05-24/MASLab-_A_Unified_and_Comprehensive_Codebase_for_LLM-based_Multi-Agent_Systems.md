...
MASLab是一个基于LLM的多智能体系统(MAS)统一代码库，旨在解决现有研究中代码分散、重复实现和评估标准不统一的问题。它整合了20多种跨领域已验证方法，提供统一环境和多种基准测试确保公平比较，并采用模块化设计降低研究门槛。通过覆盖10+基准和8种模型的实验，MASLab为研究者提供了全面的MAS方法现状概览。该开源项目将持续更新领域最新进展，并欢迎社区贡献。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T22:01:37Z
- **目录日期**: 2025-05-24
