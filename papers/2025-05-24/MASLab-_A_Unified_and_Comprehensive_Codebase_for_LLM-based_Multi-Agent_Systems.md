...
MASLab是一个统一、全面的多智能体系统（MAS）代码库，旨在解决现有研究中代码分散、重复实现和评估标准不统一的问题。它整合了20多种已验证方法，提供统一环境和多样化基准测试，确保公平比较。通过共享的模块化结构，MASLab降低了研究门槛，便于扩展。基于该平台的大规模实验覆盖10多个基准和8种模型，为研究者提供了清晰的领域现状概览。MASLab将持续更新，跟踪最新进展，并欢迎开源社区共同贡献。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T13:08:23Z
- **目录日期**: 2025-05-24
