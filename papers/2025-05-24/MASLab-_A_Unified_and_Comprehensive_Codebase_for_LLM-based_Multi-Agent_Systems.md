...
研究人员开发了MASLab，这是一个统一、全面且便于研究的代码库，用于基于大语言模型（LLM）的多智能体系统（MAS）。MASLab整合了20多种跨领域已验证的方法，提供统一环境和多种基准测试以确保公平比较，并采用共享的简化结构降低理解和扩展门槛。通过覆盖10多个基准和8种模型的实验，MASLab为研究者提供了当前MAS方法的全面视图。该代码库将持续更新，跟踪领域最新进展，并欢迎开源社区贡献，旨在解决现有研究中重复实现、不公平比较和高门槛等问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T12:01:50Z
- **目录日期**: 2025-05-24
