...
MASLab是一个统一、全面的多智能体系统（MAS）代码库，旨在解决现有研究中代码分散、重复实现和评估标准不一致的问题。它整合了20多种跨领域方法，并逐一验证其准确性；提供统一环境与多样化基准，确保公平比较；采用模块化设计降低研究门槛。基于MASLab的实验覆盖10多个基准和8种模型，为研究者提供清晰的领域现状概览。该平台将持续更新并欢迎开源社区贡献，推动LLM-based MAS领域的发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T17:01:43Z
- **目录日期**: 2025-05-24
