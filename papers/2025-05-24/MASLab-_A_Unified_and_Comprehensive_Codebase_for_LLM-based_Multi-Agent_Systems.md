...
MASLab是一个统一、全面的代码库，旨在解决基于大语言模型(LLM)的多智能体系统(MAS)研究中存在的冗余实现、不公平比较和高门槛问题。它整合了20多种跨领域方法，经过严格验证，并提供统一环境与多种基准测试，确保公平比较。MASLab采用共享的简化结构，降低了理解与扩展的难度。通过覆盖10多个基准和8种模型的广泛实验，为研究者提供了清晰的MAS方法现状概览。该代码库将持续更新，跟踪领域最新进展，并欢迎开源社区贡献。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T06:01:51Z
- **目录日期**: 2025-05-24
