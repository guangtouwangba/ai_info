...
MASLab是一个基于大语言模型(LLM)的多智能体系统(MAS)统一代码库，旨在解决该领域缺乏标准化平台导致的重复实现、不公平比较和研究门槛高的问题。它整合了20多种跨领域方法并严格验证，提供统一环境和多种基准测试以确保公平比较，采用共享的简化结构降低理解和扩展难度。通过覆盖10多个基准测试和8种模型的广泛实验，MASLab为研究者提供了当前MAS方法的全面概览。该平台将持续更新，跟踪领域最新进展，并欢迎开源社区贡献。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T10:01:45Z
- **目录日期**: 2025-05-24
