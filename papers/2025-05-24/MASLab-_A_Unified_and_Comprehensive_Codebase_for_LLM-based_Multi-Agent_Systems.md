...
研究人员开发了MASLab，这是一个统一、全面且便于研究的代码库，旨在解决基于大语言模型(LLM)的多智能体系统(MAS)领域缺乏统一平台的问题。MASLab整合了20多种跨领域的成熟方法，经过严格验证，并提供统一环境和多种基准测试以确保公平比较。其共享的简化结构降低了理解和扩展的门槛。基于MASLab，研究团队进行了涵盖10多个基准测试和8种模型的广泛实验，为研究者提供了当前MAS方法的全面概览。该平台将持续更新，跟踪领域最新进展，并欢迎开源社区的贡献。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T18:01:40Z
- **目录日期**: 2025-05-24
