...
MASLab是一个统一、全面的多智能体系统（MAS）代码库，旨在解决现有研究中的冗余实现、不公平比较和高门槛问题。它整合了20多种跨领域方法，并通过逐步验证确保准确性；提供统一环境和多种基准测试，支持公平比较；采用共享的简化结构，降低理解和扩展难度。基于MASLab，研究团队在10多个基准和8种模型上进行了广泛实验，为研究者提供了清晰的MAS方法现状概览。该平台将持续更新，追踪领域最新进展，并欢迎开源社区贡献。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T23:01:42Z
- **目录日期**: 2025-05-24
