...
上海AI Lab发布新一代InternThinker大模型，首次实现围棋AI的透明思维链展示。该模型通过"加速训练营"技术提升专业推理能力，达到职业围棋水平，并能用自然语言解释决策过程，包括应对李世石"神之一手"的推演。这一突破解决了传统围棋AI"黑盒"问题，标志着大模型在专业领域推理能力的重要进展。公测版和开源代码已同步发布。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T06:03:59Z
- **目录日期**: 2025-05-24
