...
上海AI Lab发布新一代InternThinker大模型，首次实现围棋AI透明化推理。该模型通过"加速训练营"等技术突破，既达到专业围棋水平，又能用自然语言解释决策过程，打破了传统AI的"黑盒"思维。测试显示，它甚至能正确应对李世石著名的"神之一手"。这是首个兼具专业棋力和可解释性的大模型，标志着AI在复杂策略游戏中的理解能力取得重要进展。模型已开放公测和开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T12:03:56Z
- **目录日期**: 2025-05-24
