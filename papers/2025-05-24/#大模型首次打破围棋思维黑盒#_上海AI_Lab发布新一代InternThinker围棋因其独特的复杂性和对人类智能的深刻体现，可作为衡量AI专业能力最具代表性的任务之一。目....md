...
上海AI Lab发布新一代InternThinker大模型，首次实现围棋AI的透明思维链推理。该模型通过"加速训练营"等技术突破，在保持专业棋力的同时，能用自然语言解释决策过程，包括应对李世石"神之一手"的推演。这是我国首个兼具围棋专业水平和可解释性的大模型，打破了传统围棋AI的"黑盒"状态，标志着AI推理能力的重要进展。模型已开放公测和开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T16:03:50Z
- **目录日期**: 2025-05-24
