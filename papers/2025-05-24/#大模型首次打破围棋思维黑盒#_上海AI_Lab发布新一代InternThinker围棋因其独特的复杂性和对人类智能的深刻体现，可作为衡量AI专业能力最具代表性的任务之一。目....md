...
上海AI Lab发布新一代InternThinker大模型，首次实现围棋专业水平与透明思维链的双重突破。该模型通过"加速训练营"技术提升推理能力，不仅能应对李世石著名的"神之一手"，还能用自然语言解释决策过程，打破传统围棋AI的"黑盒"状态。作为中国首个具备围棋专业解释能力的大模型，InternThinker标志着AI在复杂策略游戏中的可解释性取得重要进展。项目已开放公测和开源代码。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T05:03:28Z
- **目录日期**: 2025-05-24
