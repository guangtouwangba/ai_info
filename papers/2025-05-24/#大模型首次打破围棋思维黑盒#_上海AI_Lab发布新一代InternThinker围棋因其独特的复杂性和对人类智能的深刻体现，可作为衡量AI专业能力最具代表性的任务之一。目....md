...
上海AI Lab发布新一代InternThinker大模型，首次实现围棋AI的透明思维链。该模型通过"加速训练营"技术提升推理能力，成为中国首个兼具专业棋力（可应对李世石"神之一手"）和可解释性的大模型，打破了传统围棋AI的"黑盒"困境。模型能用人话解释决策过程，标志着AI在复杂策略游戏中的理解能力取得突破。公测版和开源代码已同步发布。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T14:03:51Z
- **目录日期**: 2025-05-24
