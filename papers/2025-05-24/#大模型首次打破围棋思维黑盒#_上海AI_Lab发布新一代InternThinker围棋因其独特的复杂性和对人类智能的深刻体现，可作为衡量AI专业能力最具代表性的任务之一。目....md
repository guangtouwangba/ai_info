...
上海AI Lab发布新一代InternThinker大模型，首次实现围棋AI透明化推理。该模型通过"加速训练营"技术突破，既具备专业围棋水平（能应对李世石"神之一手"等复杂局面），又能用自然语言展示思维链，打破传统围棋AI的"黑盒"状态。作为我国首个兼具专业能力和解释性的大模型，InternThinker已在GitHub开源并提供公测。这一进展标志着AI在复杂策略游戏中的可解释性取得重要突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T08:03:54Z
- **目录日期**: 2025-05-24
