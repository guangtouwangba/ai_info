...
上海AI Lab发布新一代InternThinker大模型，首次实现围棋AI的可解释推理能力。该模型通过"加速训练营"技术突破，兼具专业棋力（可应对李世石"神之一手"）和透明思维链展示能力，打破传统围棋AI的"黑盒"困境。作为我国首个达到围棋专业水平且能解释决策过程的大模型，其开源版本已在GitHub发布。这一进展标志着AI在复杂策略游戏中的推理能力取得重要突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T21:03:59Z
- **目录日期**: 2025-05-24
