...
上海AI Lab发布新一代InternThinker大模型，首次实现围棋AI的透明思维链展示。该模型通过"加速训练营"技术突破，在保持专业棋力的同时，能用自然语言解释推理过程，包括应对李世石"神之一手"的决策分析。这打破了传统围棋AI的"黑盒"模式，标志着AI在复杂策略游戏中可解释性的重要进展。模型已开放公测和开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T20:03:53Z
- **目录日期**: 2025-05-24
