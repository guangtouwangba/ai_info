...
上海AI Lab发布新一代InternThinker大模型，首次实现围棋专业水平与透明思维链的双重突破。该模型通过"加速训练营"(InternBootcamp)技术提升推理能力，不仅能应对李世石著名的"神之一手"，还能用自然语言解释决策过程，打破了传统AI围棋的"黑盒"困境。这标志着大模型在专业领域推理能力的重要进展，为AI可解释性研究提供了新范例。项目已开放公测和开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T19:03:51Z
- **目录日期**: 2025-05-24
