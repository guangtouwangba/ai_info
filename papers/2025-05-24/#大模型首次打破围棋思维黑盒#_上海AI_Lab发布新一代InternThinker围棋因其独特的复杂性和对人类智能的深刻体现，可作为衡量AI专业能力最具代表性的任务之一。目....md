...
上海AI Lab发布新一代InternThinker大模型，首次实现围棋AI的透明思维链。该模型通过"加速训练营"技术提升专业推理能力，不仅达到专业围棋水平，还能用自然语言解释决策过程。其突破性在于破解了传统围棋AI的"黑盒"问题，甚至能应对李世石的"神之一手"等复杂棋局。这标志着AI在专业领域可解释性方面取得重要进展，公测版和开源代码已同步发布。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T13:10:31Z
- **目录日期**: 2025-05-24
