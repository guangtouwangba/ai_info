...
上海AI Lab发布新一代InternThinker大模型，首次实现围棋AI的透明思维链展示。该模型通过创新的"加速训练营"技术显著提升推理能力，成为中国首个兼具专业围棋水平和可解释性的大模型，能应对李世石"神之一手"等复杂局面。这一突破解决了传统围棋AI"黑盒"难题，使AI不仅能下棋，还能用人类语言解释思考过程。公测和开源已同步开放。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T02:30:31Z
- **目录日期**: 2025-05-24
