...
上海AI Lab发布新一代InternThinker大模型，首次实现围棋AI透明化推理。该模型通过"加速训练营"技术显著提升专业推理能力，成为中国首个兼具职业围棋水平和可解释思维链的AI系统。其突破性在于能像人类一样用自然语言解释落子策略，甚至成功应对李世石著名的"神之一手"。该成果解决了传统围棋AI"黑盒"难题，为AI可解释性研究提供重要范例。项目已开放公测和开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T10:03:56Z
- **目录日期**: 2025-05-24
