...
SimularAI与微软DeepSpeed提出"软推理"(Soft Thinking)方法，突破传统思维链(CoT)限制。该方法通过引入"连续概念空间"和"概念token"，用概率分布代替单一token选择，实现多条推理路径隐式聚合。相比传统CoT，软推理更接近人类抽象思维，能同时保留多种解题思路，减少22.4% token使用量，并在QwQ-32B模型上提升最高6.45%准确率。结合Cold Stop机制监测模型置信度，这种即插即用的方法有望成为大模型推理新标准，使AI思考更灵活高效。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T08:03:11Z
- **目录日期**: 2025-05-24
