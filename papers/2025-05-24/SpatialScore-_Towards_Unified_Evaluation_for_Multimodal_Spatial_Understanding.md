...
这篇论文探讨多模态大语言模型(MLLMs)的3D空间感知能力，提出了VGBench基准测试视觉几何感知(如相机姿态和运动估计)，并整合11个现有数据集创建了最全面的多模态空间理解基准SpatialScore(含28K样本和困难子集SpatialScore-Hard)。研究者还开发了配备9种专用工具的多智能体系统SpatialAgent，支持Plan-Execute和ReAct推理模式。实验揭示了MLLMs在空间推理方面的持续挑战，同时验证了SpatialAgent的有效性。该工作为MLLMs的下一代发展提供了严谨的评估基准和重要见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T18:01:15Z
- **目录日期**: 2025-05-24
