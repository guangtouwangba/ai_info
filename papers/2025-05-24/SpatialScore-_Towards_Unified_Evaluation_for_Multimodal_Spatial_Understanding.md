...
本文研究了多模态大语言模型(MLLM)的空间理解能力，提出了VGBench基准测试视觉几何感知任务(如相机位姿估计)，并整合11个现有数据集创建了最全面的多模态空间理解基准SpatialScore(含28K样本)。该基准包含专门设计的挑战性子集SpatialScore-Hard，同时开发了支持Plan-Execute和ReAct推理范式的多智能体系统SpatialAgent(集成9种专用工具)。实验揭示了MLLM在空间推理方面的持续挑战，验证了SpatialAgent的有效性。该研究为MLLM的下一代发展提供了严谨的评估基准和重要见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T12:01:30Z
- **目录日期**: 2025-05-24
