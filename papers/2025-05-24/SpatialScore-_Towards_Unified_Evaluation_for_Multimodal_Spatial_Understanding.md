...
该研究探讨多模态大语言模型(MLLMs)的3D空间感知能力，提出VGBench评估视觉几何感知(如相机位姿估计)，并整合11个现有数据集构建SpatialScore基准(含28K样本)，包含专门挑战性子集SpatialScore-Hard。同时开发了支持9种空间理解工具的多智能体系统SpatialAgent，支持"计划-执行"和"反应式"推理。实验揭示了MLLMs在空间推理中的持续挑战，同时验证了SpatialAgent的有效性。该基准将为MLLMs的下一代发展提供严格评估标准和重要见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T17:01:23Z
- **目录日期**: 2025-05-24
