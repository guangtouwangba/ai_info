...
该研究探讨了多模态大语言模型(MLLMs)的3D空间感知能力，提出了VGBench评估几何感知能力，并整合11个数据集创建了最全面的空间理解基准SpatialScore(含28K样本和困难子集SpatialScore-Hard)。同时开发了支持9种专用工具的多智能体系统SpatialAgent，支持Plan-Execute和ReAct推理模式。评估显示当前MLLMs在空间推理方面仍存在挑战，但SpatialAgent表现优异。该基准将为MLLMs的下一代发展提供重要参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T07:01:18Z
- **目录日期**: 2025-05-24
