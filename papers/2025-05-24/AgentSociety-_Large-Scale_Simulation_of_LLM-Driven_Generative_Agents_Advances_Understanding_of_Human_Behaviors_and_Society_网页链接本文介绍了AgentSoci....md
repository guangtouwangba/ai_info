...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统模拟了1万多个AI代理的社会生活，记录了500万次交互行为。研究者利用该平台研究了四个关键社会问题：社会极化现象、刺激性信息传播、基本收入政策影响和自然灾害（如飓风）的社会影响。模拟结果与现实世界数据高度吻合，验证了该系统在理解人类行为机制方面的有效性。研究表明，AgentSociety可以作为社会科学研究和政策制定的有力工具，为传统研究方法提供补充。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T18:05:12Z
- **目录日期**: 2025-05-24
