...
该研究开发了AgentSociety，一个基于大语言模型的大规模社会模拟系统，可模拟1万多个代理的互动行为。研究者用它研究了四个社会问题：社会极化、信息传播、基本收入政策和自然灾害影响。模拟结果与现实数据吻合，验证了该系统在理解人类行为机制方面的有效性。该系统为社会科学研究和政策制定提供了新工具，能补充传统研究方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T11:05:13Z
- **目录日期**: 2025-05-24
