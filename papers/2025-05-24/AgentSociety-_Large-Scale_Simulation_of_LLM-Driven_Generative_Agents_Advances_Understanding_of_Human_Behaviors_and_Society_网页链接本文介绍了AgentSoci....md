...
该研究介绍了AgentSociety，这是一个基于大语言模型的大规模社会模拟系统，能够模拟1万多个智能代理及其500万次社会互动。该系统被用于研究四大社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，证明了该系统在揭示人类行为机制和社会问题成因方面的有效性。研究表明，AgentSociety可作为社会科学研究和政策制定的有力工具，为传统研究方法提供补充。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T01:32:13Z
- **目录日期**: 2025-05-24
