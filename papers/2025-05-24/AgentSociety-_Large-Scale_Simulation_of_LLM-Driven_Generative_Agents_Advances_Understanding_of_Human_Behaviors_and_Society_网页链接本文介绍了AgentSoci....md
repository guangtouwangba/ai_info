...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理的社会互动（500万次）。该系统通过四个社会问题研究（政治极化、信息传播、基本收入政策、自然灾害影响）验证了其有效性，结果与现实世界数据吻合。研究表明，这种模拟能有效捕捉人类行为机制，可作为社会科学研究和政策制定的新工具，补充传统研究方法（如调查、访谈）。该系统展示了LLM在理解社会复杂性问题方面的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T21:05:02Z
- **目录日期**: 2025-05-24
