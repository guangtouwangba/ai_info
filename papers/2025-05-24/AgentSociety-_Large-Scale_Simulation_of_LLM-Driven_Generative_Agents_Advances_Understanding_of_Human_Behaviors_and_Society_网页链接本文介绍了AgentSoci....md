...
AgentSociety是一个基于大型语言模型的大规模社会模拟系统，能模拟1万多个代理的社会互动（500万次）。研究者用它分析四大社会问题：社会极化、信息传播、基本收入政策、自然灾害影响。模拟结果与现实数据吻合，验证了该系统捕捉人类行为机制的能力。这表明AgentSociety可作为社会科学研究和政策制定的有效工具，补充传统研究方法（如调查、实验）。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T13:12:07Z
- **目录日期**: 2025-05-24
