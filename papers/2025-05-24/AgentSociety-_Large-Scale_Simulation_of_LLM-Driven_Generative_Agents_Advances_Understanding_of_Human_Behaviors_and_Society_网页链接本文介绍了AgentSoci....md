...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能够模拟1万多个AI代理的社会互动（500万次交互）。该系统通过四个关键社会议题（社会极化、信息传播、基本收入政策、自然灾害影响）的模拟实验，验证了其模拟结果与现实世界数据的高度一致性。研究表明，这种LLM驱动的模拟器能有效捕捉人类行为机制，可作为计算社会科学研究的有力工具，为政策制定提供新方法。该成果展示了AI模拟在理解复杂社会现象方面的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T06:05:24Z
- **目录日期**: 2025-05-24
