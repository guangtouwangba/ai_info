...
这篇论文介绍了一个名为AgentSociety的大规模社会模拟器，它结合了大型语言模型驱动的代理、真实社会环境和强大的模拟引擎，模拟了超过1万个代理及其500万次互动。研究利用该平台探索了四个关键社会问题：极化现象、刺激性信息传播、无条件基本收入政策影响和外部冲击（如飓风）的影响。模拟结果与现实世界实验数据吻合，验证了该工具在捕捉人类行为机制方面的能力，展示了其作为社会科学研究和政策制定辅助工具的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T04:05:12Z
- **目录日期**: 2025-05-24
