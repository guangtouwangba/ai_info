...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能够模拟1万多个AI代理的社会互动（500万次交互）。该系统被用于研究四个关键社会问题：群体极化、信息传播、基本收入政策效果和自然灾害影响。研究结果显示，模拟结果与现实世界数据高度吻合，证明该系统能有效捕捉人类行为机制。这表明AgentSociety可作为社会科学研究和政策制定的有力工具，为传统研究方法（如调查和实验）提供补充。该系统展现了AI在理解复杂社会现象方面的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T05:05:40Z
- **目录日期**: 2025-05-24
