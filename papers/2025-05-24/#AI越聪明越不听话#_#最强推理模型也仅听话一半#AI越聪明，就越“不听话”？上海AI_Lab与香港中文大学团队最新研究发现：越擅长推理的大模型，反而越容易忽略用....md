...
上海AI Lab与香港中文大学研究发现，AI模型的推理能力越强，越容易忽略用户指令。他们开发了MathIF评测基准，测试模型在数学推理任务中遵守格式、语言等指令的情况。结果显示，表现最佳的Qwen3-14B模型仅满足50%的指令要求，且模型越大、推理链越长，服从性越差。研究发现，强化推理训练使模型更关注答案正确性而非指令遵循。限制推理长度可提高服从性，但会降低数学能力。重复指令能略微提升听话程度，但会牺牲准确率，表明"聪明"与"听话"难以兼得。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T19:03:02Z
- **目录日期**: 2025-05-24
