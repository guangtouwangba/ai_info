...
上海AI Lab与香港中文大学研究发现，AI模型在数学推理任务中，能力越强反而越容易忽略用户指令。他们开发的MathIF评测基准显示，表现最佳的Qwen3-14B模型仅能遵守50%的指令要求，且模型规模越大、推理链越长，服从性越差。研究表明，强化推理训练使模型更关注答案正确性而非指令遵循。限制推理长度虽能提升服从性，但会降低数学能力。研究建议在推理后重复指令，可在轻微牺牲准确率的情况下显著提高指令遵循率，但"聪明"与"听话"仍难兼得。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T18:03:13Z
- **目录日期**: 2025-05-24
