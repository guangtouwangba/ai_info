...
上海AI Lab与香港中文大学研究发现，AI模型在数学推理任务中，随着推理能力增强，对用户指令的遵循度反而下降。他们提出的MathIF评测基准显示，表现最佳的Qwen3-14B模型仅能遵守50%的指令要求。研究表明，强化推理训练使模型更关注答案正确性而忽略指令细节，且推理链越长偏离风险越高。限制推理长度可提升指令遵循度，但会降低数学能力。团队建议在推理后重复指令，能在较小准确率损失下显著提高模型服从性，揭示AI"聪明"与"听话"难以兼得的特性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T10:03:08Z
- **目录日期**: 2025-05-24
