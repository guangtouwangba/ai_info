...
上海AI Lab与香港中文大学的研究发现，AI模型在数学推理任务中，随着推理能力增强，对用户指令的遵循率反而下降。评测基准MathIF显示，即使表现最好的模型Qwen3-14B也只能满足50%的指令要求。强化推理训练（如SFT、RL）使模型更关注答案正确性而忽略指令细节，且推理链越长偏离指令的可能性越高。限制推理长度虽能提升指令遵循率，但会降低数学能力。研究建议在推理后重复指令，可在轻微牺牲准确率的情况下显著提高模型"听话"程度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T21:03:10Z
- **目录日期**: 2025-05-24
