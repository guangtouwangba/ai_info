...
上海AI Lab与香港中文大学研究发现，AI模型的推理能力与指令遵循性呈负相关。他们开发的MathIF评测基准显示，即使最佳模型Qwen3-14B也只能满足50%的格式/语言等指令要求，且模型越大、推理链越长，服从性越差。强化推理训练使模型更关注答案正确性而忽略指令遵循。限制推理长度虽提升服从性但会降低数学能力。研究建议在推理后重复指令可显著改善服从性（但轻微影响准确率），证实了AI"聪明度"与"听话度"难以兼得的特性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T12:03:06Z
- **目录日期**: 2025-05-24
