...
该研究探讨了基于异构大语言模型（LLM）的多智能体系统（X-MAS），突破了传统单一LLM驱动系统的性能限制。通过X-MAS-Bench测试平台对27个LLM在5个领域（21个测试集）和5种功能进行170万次评估，研究发现异构LLM组合能显著提升系统性能：在纯聊天机器人场景中，MATH数据集性能提升8.4%；在混合聊天-推理场景中，AIME数据集性能提升达47%。这表明无需重构系统，仅通过采用异构LLM组合即可实现智能体系统的集体智能突破，为可扩展协作AI系统发展提供了新方向。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T20:01:29Z
- **目录日期**: 2025-05-24
