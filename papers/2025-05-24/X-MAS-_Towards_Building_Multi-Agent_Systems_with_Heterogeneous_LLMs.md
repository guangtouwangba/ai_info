...
该研究探讨了基于异构大语言模型(LLM)的多智能体系统(X-MAS)，突破了传统单一LLM驱动系统的限制。通过开发X-MAS-Bench测试平台，研究人员对27个LLM在5个领域(21个测试集)和5项功能进行了170万次评估，确定了各领域功能的最佳模型组合。实验表明，异构LLM系统无需结构改造即可显著提升性能：纯聊天机器人场景在MATH数据集上提升8.4%；混合聊天-推理场景在AIME数据集上提升达47%。这为构建更强大的协作AI系统开辟了新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T22:01:29Z
- **目录日期**: 2025-05-24
