...
本文提出异构大语言模型驱动的多智能体系统(X-MAS)，突破了传统同构系统的限制。研究者开发了X-MAS-Bench测试平台，对27个大模型在5个领域21个测试集上进行了170万次评估，发现异构配置能显著提升系统性能：在纯聊天机器人场景中，MATH数据集上性能提升8.4%；在混合聊天-推理场景中，AIME数据集上性能提升高达47%。研究表明，无需重构系统架构，仅通过采用异构模型组合，就能充分发挥不同模型的集体智能优势，为构建可扩展的协作AI系统开辟了新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T19:01:23Z
- **目录日期**: 2025-05-24
