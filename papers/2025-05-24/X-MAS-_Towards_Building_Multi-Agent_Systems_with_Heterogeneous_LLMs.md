...
这篇论文探讨了基于异构大语言模型(LLM)的多智能体系统(X-MAS)，通过让不同LLM驱动不同智能体，突破单一模型限制，发挥集体智能优势。研究团队开发了X-MAS-Bench测试平台，对27个LLM在5个领域(21个测试集)和5种功能进行了170万次评估，确定了最优模型组合。实验表明，从同构转向异构LLM驱动的多智能体系统能显著提升性能：在纯聊天机器人场景下，MATH数据集性能提升8.4%；在混合聊天-推理场景中，AIME数据集性能提升达47%。这为构建可扩展的协作AI系统提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T03:17:16Z
- **目录日期**: 2025-05-24
