...
本文提出了一种基于异构大语言模型（LLM）的多智能体系统（X-MAS），突破了传统单一LLM驱动系统的性能限制。研究团队开发了X-MAS-Bench测试平台，对27个LLM在5个领域21个测试集和5种功能进行了超过170万次评估，确定了各领域-功能组合的最优模型选择。实验表明，异构LLM驱动的MAS能显著提升系统性能：在纯聊天机器人场景下，MATH数据集性能提升8.4%；在混合聊天-推理场景下，AIME数据集性能提升高达47%。该研究为构建可扩展的协作AI系统提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T15:01:27Z
- **目录日期**: 2025-05-24
