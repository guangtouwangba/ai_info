...
该研究探讨了基于异构大语言模型（LLM）的多智能体系统（X-MAS），通过整合不同LLM驱动的智能体来突破单一模型的能力限制。研究者开发了X-MAS-Bench测试平台，评估了27个LLM在5个领域和5种功能上的表现，进行了超过170万次测试。结果表明，异构LLM配置能显著提升系统性能：在纯聊天机器人场景中，MATH数据集上性能提升8.4%；在混合聊天-推理场景中，AIME数据集上性能提升达47%。这一发现为构建更强大的协作式AI系统提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T02:29:07Z
- **目录日期**: 2025-05-24
