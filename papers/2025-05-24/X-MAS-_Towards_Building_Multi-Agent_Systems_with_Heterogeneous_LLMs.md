...
本文提出了一种基于异构大语言模型（LLM）的多智能体系统（X-MAS），通过整合不同LLM驱动的智能体，突破单一模型限制，提升系统集体智能。研究团队开发了X-MAS-Bench测试平台，对27个LLM在5个领域（21个测试集）和5种功能进行170万次评估，确定最优模型组合。实验表明，相比同构系统，异构X-MAS无需结构调整即可显著提升性能：纯聊天机器人场景在MATH数据集上提升8.4%，混合推理场景在AIME数据集上提升47%。该研究为构建可扩展的协作AI系统提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T18:01:31Z
- **目录日期**: 2025-05-24
