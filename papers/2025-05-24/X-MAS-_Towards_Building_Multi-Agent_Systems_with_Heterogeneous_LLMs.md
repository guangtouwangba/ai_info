...
该研究提出了一种基于异构大语言模型(LLM)的多智能体系统(X-MAS)，突破了传统单一LLM驱动系统的限制。通过开发X-MAS-Bench测试平台，研究人员对27个LLM在5个领域(21个测试集)和5种功能上进行了170万次评估，确定了最优模型组合。实验表明，采用异构LLM配置可显著提升系统性能：在纯聊天机器人场景下，MATH数据集性能提升8.4%；在混合聊天-推理场景下，AIME数据集性能提升达47%。这一发现为构建更强大的协作式AI系统提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T09:01:22Z
- **目录日期**: 2025-05-24
