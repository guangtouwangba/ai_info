...
该研究探讨了基于异构大语言模型（LLM）的多智能体系统（X-MAS），突破传统单一LLM驱动的限制。通过X-MAS-Bench测试平台评估27种LLM在5个领域和5种功能中的表现，完成超170万次测试以确定最优模型组合。实验表明，异构LLM系统能显著提升性能：在纯聊天机器人场景中，MATH数据集表现提升8.4%；在混合聊天-推理场景中，AIME数据集性能提升达47%。研究证实异构LLM在多智能体系统中的变革潜力，为可扩展协作AI系统发展提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T16:01:31Z
- **目录日期**: 2025-05-24
