...
这篇论文探讨了基于异构大语言模型（LLM）的多智能体系统（X-MAS），通过让不同LLM驱动不同智能体，突破单一模型限制，显著提升系统性能。研究团队开发了X-MAS-Bench测试平台，对27个LLM在5个领域21个测试集和5种功能上进行了超170万次评估，确定了最优模型组合方案。实验表明，异构系统相比同构系统能带来显著性能提升：在纯聊天机器人场景中MATH数据集表现提升8.4%；在混合型（聊天-推理）场景中AIME数据集表现提升47%。该研究为构建可扩展的协作AI系统提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T11:01:27Z
- **目录日期**: 2025-05-24
