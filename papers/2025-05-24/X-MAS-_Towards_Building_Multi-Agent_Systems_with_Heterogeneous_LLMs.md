...
该研究探索了基于异构大语言模型（LLM）的多智能体系统（X-MAS），突破了传统单一LLM驱动的局限。通过构建X-MAS-Bench测试平台，研究人员对27个LLM在5个领域（含21个测试集）和5种功能进行了超170万次评估，发现异构LLM组合能显著提升系统性能。实验表明：纯聊天机器人场景中，异构配置在MATH数据集上性能提升8.4%；混合聊天-推理场景中，AIME数据集性能提升达47%。这一发现为构建更强大的协作AI系统提供了新方向，无需重构即可实现智能跃升。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T17:01:33Z
- **目录日期**: 2025-05-24
