...
本文提出异构大语言模型驱动的多智能体系统(X-MAS)，突破传统单一模型限制，通过整合不同LLM的专长提升系统性能。研究开发了X-MAS-Bench测试平台，对27个LLM在5个领域21个测试集进行170万次评估，发现异构配置能显著提升表现：在纯聊天机器人场景下，MATH数据集性能提升8.4%；在混合推理场景中，AIME数据集提升达47%。研究表明，无需重构系统，仅通过采用异构LLM组合即可大幅增强多智能体系统的协作智能，为可扩展的协作AI系统发展提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T06:01:40Z
- **目录日期**: 2025-05-24
