...
这篇论文探讨了基于异构大语言模型(LLM)的多智能体系统(X-MAS)，突破了传统同构系统的限制。研究团队开发了X-MAS-Bench测试平台，对27个LLM在5个领域和5种功能上进行了170万次评估，确定了最优模型组合。实验表明，异构系统无需结构改造即可显著提升性能：在纯聊天机器人场景中，MATH数据集上性能提升8.4%；在混合(聊天+推理)场景中，AIME数据集上性能提升达47%。这证明了异构LLM在多智能体系统中的变革潜力，为可扩展协作AI系统的发展提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T00:01:43Z
- **目录日期**: 2025-05-24
