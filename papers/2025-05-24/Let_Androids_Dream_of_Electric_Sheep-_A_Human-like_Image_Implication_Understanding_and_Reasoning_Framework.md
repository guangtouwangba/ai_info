...
AI系统在理解图像隐喻方面仍面临挑战，现有模型难以捕捉视觉内容中的文化、情感和上下文隐含意义。研究者提出Let Androids Dream (LAD)框架，模仿人类认知过程，通过三阶段方法解决这一问题：感知（将视觉信息转为多层级文本）、搜索（整合跨领域知识消除歧义）和推理（生成上下文对齐的隐含意义）。LAD在英文图像隐含理解基准测试中超越15+多模态大模型，中文测试表现显著提升，在选择题上与GPT-4o相当，开放式问题表现优于36.7%。该研究为AI理解图像隐喻提供了新思路。项目已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T05:01:23Z
- **目录日期**: 2025-05-24
