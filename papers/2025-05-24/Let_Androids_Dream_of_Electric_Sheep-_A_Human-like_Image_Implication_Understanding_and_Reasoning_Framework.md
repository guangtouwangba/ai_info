...
AI系统在图像隐喻理解方面面临挑战，现有模型难以捕捉视觉内容中的文化、情感和语境隐含意义。研究团队提出"Let Androids Dream (LAD)"框架，通过三阶段认知过程：感知（将视觉信息转为多层级文本）、搜索（整合跨领域知识消除歧义）和推理（生成语境对齐的隐含意义）。该框架采用轻量级GPT-4o-mini模型，在英文图像隐喻基准测试中超越15+多模态大模型，中文测试表现显著提升，在选择题上与GPT-4o相当，开放式问题性能高出36.7%。研究为AI视觉语言推理提供了新思路。项目已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T09:01:01Z
- **目录日期**: 2025-05-24
