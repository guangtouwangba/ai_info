...
本文提出Let Androids Dream (LAD)框架，解决AI系统理解图像隐喻的难题。现有多模态大模型在视觉问答任务中表现良好，但难以捕捉视觉元素间的抽象含义。LAD通过三阶段框架：感知（将视觉信息转为多层级文本表示）、搜索（整合跨领域知识消除歧义）和推理（生成上下文对齐的图像含义），显著提升图像隐喻理解能力。实验表明，轻量级GPT-4o-mini模型结合LAD在英汉图像隐喻基准测试中达到SOTA性能，在开放式问题上超越GPT-4o达36.7%。该研究为AI视觉-语言推理提供了新思路。项目已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T13:07:50Z
- **目录日期**: 2025-05-24
