...
AI系统在理解图像隐喻方面仍面临挑战，现有模型难以捕捉视觉内容中的文化、情感和上下文隐含意义。为此，研究者提出"Let Androids Dream (LAD)"框架，通过三阶段认知过程提升图像隐含意义理解：(1)感知：将视觉信息转化为多层次文本表示；(2)搜索：整合跨领域知识消除歧义；(3)推理：生成符合上下文的图像含义解释。LAD在英汉图像理解基准测试中表现优异，轻量级GPT-4o-mini版本在开放性问题上的表现超越GPT-4o达36.7%。该研究为提升AI视觉语言推理能力提供了新思路。项目已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T19:01:02Z
- **目录日期**: 2025-05-24
