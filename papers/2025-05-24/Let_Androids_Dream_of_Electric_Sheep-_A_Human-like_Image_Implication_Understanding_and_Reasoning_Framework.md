...
论文提出Let Androids Dream (LAD)框架，用于解决AI系统理解图像隐喻含义的难题。现有多模态大模型在视觉问答任务中表现良好，但难以捕捉视觉元素间的抽象关系。LAD模仿人类认知过程，采用三阶段方法：感知（将视觉信息转为多层次文本表示）、搜索（整合跨领域知识消除歧义）、推理（生成符合上下文的图像含义解释）。实验表明，轻量级GPT-4o-mini模型结合LAD框架在英汉图像隐喻理解基准测试中达到最优性能，在开放式问题上比GPT-4o提升36.7%。该研究为提升AI视觉语言推理能力提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T04:01:08Z
- **目录日期**: 2025-05-24
