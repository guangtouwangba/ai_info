...
AI系统在理解图像隐喻方面仍面临重大挑战，现有模型难以捕捉视觉内容中蕴含的文化、情感和语境信息。针对这一局限，研究者提出"Let Androids Dream (LAD)"三阶段框架：感知（将视觉信息转化为多层次文本表征）、搜索（整合跨领域知识消除歧义）和推理（生成符合语境的图像含义解释）。该框架搭载轻量级GPT-4o-mini模型，在英文图像理解基准测试中超越15+多模态大模型，中文测试表现显著提升，在选择题上与GPT-4o相当，开放式问题表现优于36.7%。该研究为提升AI视觉语言推理能力提供了新思路，项目已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T00:01:19Z
- **目录日期**: 2025-05-24
