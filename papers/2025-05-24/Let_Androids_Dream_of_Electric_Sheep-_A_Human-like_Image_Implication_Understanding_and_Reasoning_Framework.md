...
AI系统在理解图像隐喻方面仍面临挑战，现有模型难以捕捉视觉内容中的文化、情感和上下文隐含意义。为此，研究者提出Let Androids Dream (LAD)框架，模仿人类认知过程，通过三阶段处理：感知（将视觉信息转为多层级文本）、搜索（整合跨领域知识消除歧义）和推理（生成上下文对齐的隐含意义）。LAD在轻量级GPT-4o-mini模型上实现了英语图像隐喻任务的SOTA性能，中文任务显著提升，在选择题上与GPT-4o相当，开放式问题超越36.7%。该研究为AI视觉-语言推理提供了新思路。项目已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T18:01:04Z
- **目录日期**: 2025-05-24
