...
研究人员推出了首个阿拉伯语多模态推理基准测试ARB，旨在评估AI模型在阿拉伯语文本和视觉模态下的逐步推理能力。该基准涵盖11个领域，包含1,356个多模态样本和5,119个人工标注的推理步骤。通过对12个先进模型的测试，发现其在连贯性、忠实度和文化适应性方面仍存在挑战。ARB为评估非主流语言的多模态推理提供了结构化框架，推动了更具包容性、透明度和文化意识的AI系统发展。相关代码和评估工具已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T07:00:56Z
- **目录日期**: 2025-05-24
