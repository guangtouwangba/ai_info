...
本文介绍了首个针对阿拉伯语多模态推理的综合性基准测试ARB，旨在评估模型在文本和视觉模态下的逐步推理能力。ARB涵盖11个领域，包含1,356个多模态样本和5,119个人工标注的推理步骤。研究评估了12个先进的开源和闭源大模型，发现它们在连贯性、忠实性和文化适应性方面仍存在挑战。ARB为评估非主流语言的多模态推理提供了结构化框架，推动了更具包容性、透明性和文化意识的AI系统发展。相关代码、基准和评估工具已开源，以支持未来研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T17:01:01Z
- **目录日期**: 2025-05-24
