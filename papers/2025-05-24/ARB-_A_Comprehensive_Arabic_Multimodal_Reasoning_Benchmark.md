...
研究人员推出了首个针对阿拉伯语多模态推理的综合基准测试ARB，涵盖11个领域，包含1,356个多模态样本和5,119个人工标注的推理步骤。该基准旨在评估大型多模态模型(LMM)在阿拉伯语环境下的逐步推理能力，填补了现有基准主要关注英语的不足。测试12个先进模型后发现，这些模型在连贯性、忠实度和文化适应性方面仍存在挑战。ARB为评估非主流语言的多模态推理提供了结构化框架，推动了更具包容性、透明性和文化意识的AI系统发展。相关代码和评估工具已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T14:00:55Z
- **目录日期**: 2025-05-24
