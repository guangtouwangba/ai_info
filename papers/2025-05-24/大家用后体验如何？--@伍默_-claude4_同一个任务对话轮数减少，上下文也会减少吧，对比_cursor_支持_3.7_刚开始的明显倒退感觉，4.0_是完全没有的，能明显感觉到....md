...
用户对Claude-4的评价呈现两极分化：部分用户（如@伍默_）认为其任务处理效率提升，对话轮数减少但可靠性明显增强；而测试显示其长上下文召回能力较3.7版本显著下降，可能影响复杂工程场景的应用效果。开发者@karminski-牙医指出，该缺陷或导致实际项目修改时表现倒退，引发社区对版本升级实用性的讨论。目前尚未形成统一结论，需更多实际应用案例验证。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T21:03:00Z
- **目录日期**: 2025-05-24
