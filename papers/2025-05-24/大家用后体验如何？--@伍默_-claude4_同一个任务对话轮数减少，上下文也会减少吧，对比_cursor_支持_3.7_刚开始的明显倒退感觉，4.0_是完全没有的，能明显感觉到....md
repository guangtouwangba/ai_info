...
用户对Claude-4的评价呈现两极分化：部分用户（如@伍默_）认为其任务处理效率提升，对话轮次减少但可靠性增强；而@karminski-牙医的测试显示其长上下文召回能力较Claude-3.7明显下降，可能影响复杂工程场景的应用效果。目前实际使用体验存在争议，需结合具体应用场景评估，代码工程等依赖长上下文的场景可能受影响较大。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T11:02:41Z
- **目录日期**: 2025-05-24
