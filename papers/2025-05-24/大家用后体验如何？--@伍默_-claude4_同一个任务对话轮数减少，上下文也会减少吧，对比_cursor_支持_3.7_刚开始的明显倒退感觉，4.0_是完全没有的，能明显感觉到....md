...
用户对Claude-4的评价呈现两极分化：部分用户（如@伍默_）认为其任务处理效率提升，对话轮次减少但可靠性增强，尤其在代码编辑场景表现优于3.7版本；而测试数据显示其长上下文召回能力明显下降，@karminski-牙医指出这可能影响复杂工程项目的实际应用效果。目前尚未形成统一结论，需更多实际使用反馈验证其工程适用性。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T22:02:59Z
- **目录日期**: 2025-05-24
