...
用户对Claude4的体验呈现两极分化：部分用户（如@伍默_）认为4.0版本在任务对话效率和可靠性上明显优于3.7，尤其在代码编辑场景中表现更稳定；而测试数据显示其长上下文召回能力较3.7显著下降，可能影响复杂工程项目的实际应用效果。开发者@karminski-牙医指出，这种性能差异可能导致在真实项目修改时，4.0反而不及旧版实用。目前尚未形成统一结论，需结合具体使用场景评估。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T18:03:03Z
- **目录日期**: 2025-05-24
