...
用户对Claude-4的评价呈现两极分化：部分用户（如@伍默_）认为其任务处理效率提升，对话轮次减少但可靠性增强；而测试显示其长上下文召回能力较3.7版本明显下降，可能影响代码工程等复杂场景的实用性。开发者@karminski-牙医指出，这一缺陷或导致实际项目修改效果反而不如旧版，呼吁已使用者分享体验。整体来看，Claude-4在基础对话优化和复杂任务性能之间存在权衡矛盾。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T10:02:56Z
- **目录日期**: 2025-05-24
