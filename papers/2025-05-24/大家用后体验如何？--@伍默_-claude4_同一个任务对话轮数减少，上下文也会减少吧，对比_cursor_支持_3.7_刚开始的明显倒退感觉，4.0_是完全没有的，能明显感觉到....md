...
用户对Claude-4的评价呈现两极分化：部分用户（如@伍默_）认为其任务处理效率提升，对话轮数减少但可靠性明显增强；而测试显示其长上下文召回能力较3.7版本显著下降，可能影响复杂工程场景的应用效果。开发者@karminski-牙医指出，这对需要持续追踪上下文的代码修改任务尤为不利。目前实际体验反馈不一，需结合具体使用场景评估，建议已大规模使用的用户分享对比体验。#AI技术迭代 #模型优化争议

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T14:02:48Z
- **目录日期**: 2025-05-24
