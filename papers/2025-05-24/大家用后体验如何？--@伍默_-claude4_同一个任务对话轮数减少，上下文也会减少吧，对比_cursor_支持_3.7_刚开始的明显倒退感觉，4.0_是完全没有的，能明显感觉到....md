...
用户对Claude4的体验存在分歧：部分用户（如@伍默_）认为4.0版本在任务对话效率和可靠性上明显优于3.7，尤其在代码编辑场景中表现更稳定；而测试显示其长上下文召回能力较3.7显著下降，可能影响复杂工程应用效果。开发者@karminski-牙医指出这可能导致实际项目修改时性能反而不及旧版。目前尚未形成统一结论，需更多实际应用反馈验证。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T08:02:49Z
- **目录日期**: 2025-05-24
