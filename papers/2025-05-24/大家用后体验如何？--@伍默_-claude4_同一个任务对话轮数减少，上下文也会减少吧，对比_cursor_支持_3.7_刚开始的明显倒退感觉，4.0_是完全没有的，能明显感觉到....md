...
用户对Claude-4的评价呈现两极分化：部分用户（如@伍默_）认为其任务对话效率提升，代码处理能力比3.7版本更可靠；但测试显示其长上下文召回能力明显下降，可能影响复杂工程应用效果。开发者@karminski-牙医指出，这对需要持续追踪上下文的实际项目可能造成负面影响，暗示某些场景下3.7版本反而更优。目前尚未形成统一结论，实际体验可能因使用场景而异。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T16:02:54Z
- **目录日期**: 2025-05-24
