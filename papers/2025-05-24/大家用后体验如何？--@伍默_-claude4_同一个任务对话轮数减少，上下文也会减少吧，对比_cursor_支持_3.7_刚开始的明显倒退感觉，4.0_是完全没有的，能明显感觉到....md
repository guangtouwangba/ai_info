...
用户对Claude-4的体验评价呈现两极分化。部分用户（如@伍默_）认为4.0版本在任务对话效率和可靠性方面有明显提升，优于早期3.7版本；而测试显示其长上下文召回能力较3.7显著下降，可能影响工程应用效果。开发者@karminski-牙医指出，这一缺陷在现实项目修改等需要强上下文支持的场景中尤为明显，质疑4.0实际工程表现可能反而不及3.7。目前尚未形成统一结论，期待更多实际使用反馈。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T07:02:47Z
- **目录日期**: 2025-05-24
