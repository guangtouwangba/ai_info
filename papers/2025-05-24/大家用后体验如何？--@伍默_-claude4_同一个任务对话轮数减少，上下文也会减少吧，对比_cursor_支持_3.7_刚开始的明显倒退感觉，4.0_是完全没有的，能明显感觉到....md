...
用户对Claude-4的评价呈现两极分化：部分用户（如@伍默_）认为其任务处理效率提升，对话轮次减少但可靠性增强，尤其在代码场景中表现优于3.7版本；而测试显示其长上下文召回能力显著下降，可能影响复杂工程应用效果（如代码项目修改）。开发者@karminski-牙医指出这一缺陷可能导致实际工程性能反而不及3.7版本，呼吁实际使用者分享体验。整体来看，Claude-4在基础任务表现优化，但专业场景的深度上下文处理能力存在争议。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T23:03:04Z
- **目录日期**: 2025-05-24
