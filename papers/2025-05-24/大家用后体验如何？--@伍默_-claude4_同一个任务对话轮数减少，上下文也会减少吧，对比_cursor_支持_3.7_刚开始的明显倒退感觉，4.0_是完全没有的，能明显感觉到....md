...
Claude4用户反馈呈现两极分化：部分用户（如@伍默_）认为4.0版本在代码任务中对话轮次减少但可靠性提升，相比3.7版本有明显改进；而@karminski-牙医的测试显示其长上下文召回能力显著下降，可能影响复杂工程项目的实际应用效果。目前尚未形成统一结论，需更多实际使用案例验证。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T09:02:37Z
- **目录日期**: 2025-05-24
