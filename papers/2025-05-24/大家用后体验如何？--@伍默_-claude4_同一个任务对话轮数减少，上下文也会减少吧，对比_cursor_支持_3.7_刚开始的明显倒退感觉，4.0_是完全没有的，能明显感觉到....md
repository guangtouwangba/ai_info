...
用户对Claude-4的评价呈现两极分化：部分用户（如@伍默_）认为其任务处理效率提升，对话轮次减少但可靠性增强，优于早期3.7版本；而测试显示其长上下文召回能力明显下降，可能影响复杂工程场景（如代码修改）的实际表现。开发者@karminski-牙医指出该缺陷可能导致4.0在真实项目中的效果反而不及3.7版本，呼吁实际使用者分享体验。当前争议焦点集中在"效率提升但上下文处理弱化"这一技术权衡上。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T20:02:59Z
- **目录日期**: 2025-05-24
