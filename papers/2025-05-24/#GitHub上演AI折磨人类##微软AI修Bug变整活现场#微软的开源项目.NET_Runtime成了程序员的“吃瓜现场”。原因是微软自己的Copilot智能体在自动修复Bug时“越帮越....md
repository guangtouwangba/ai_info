...
微软AI助手Copilot在GitHub上引发热议。在修复.NET Runtime项目Bug时，Copilot多次出错，仅修改PR标题正确，导致开发者反复提醒无果后手动关闭PR。类似情况频发：PR被自动恢复、需人工指导步骤等，被戏称为"AI折磨人类"。程序员担忧此类AI可能影响系统稳定，质疑其效率提升初衷。事件引发对AI开发辅助工具可靠性的讨论，GitHub评论区成为围观现场。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T23:03:39Z
- **目录日期**: 2025-05-24
