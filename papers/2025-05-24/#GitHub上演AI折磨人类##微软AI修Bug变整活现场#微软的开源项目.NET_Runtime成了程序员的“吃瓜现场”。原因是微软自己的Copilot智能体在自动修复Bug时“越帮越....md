...
微软AI助手Copilot在GitHub上引发程序员吐槽。在修复.NET Runtime项目Bug时，Copilot连续出错：代码检查失败、测试报错，仅修改了PR标题正确。开发者被迫多次提醒，AI却辩解或不动，最终手动关闭PR。类似情况频发，如PR自动恢复、重复请求审核等，程序员需反复指导AI，如同"带徒弟"。有人担忧此类AI可能影响生产环境稳定性，批评称"AI应为提效而非反向驱使人类"。事件引发对AI实际应用可靠性的讨论。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T13:10:13Z
- **目录日期**: 2025-05-24
