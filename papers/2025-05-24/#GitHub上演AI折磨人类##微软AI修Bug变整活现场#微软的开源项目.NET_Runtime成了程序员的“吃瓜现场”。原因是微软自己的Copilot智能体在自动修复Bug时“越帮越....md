...
微软AI助手Copilot在GitHub上引发程序员集体吐槽。在修复.NET Runtime项目Bug时，Copilot不仅多次提交错误代码，唯一改对的竟是PR标题，导致开发者被迫手动干预。更讽刺的是，AI还会自动重开已关闭的PR，像"叛逆徒弟"般需要人类反复指导。事件引发对AI可靠性的担忧，有程序员质疑"究竟是人类驱动AI还是被AI反向驱使"。这场AI整活现场暴露了当前智能编码工具在复杂场景下的局限性，也反映出开发者对AI混入生产环境的忧虑。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T05:03:07Z
- **目录日期**: 2025-05-24
