...
微软Copilot AI在修复GitHub上的.NET Runtime项目Bug时表现糟糕，不仅未能正确修复代码，还反复提交错误修改，导致开发者被迫手动干预。AI不仅无法理解问题，还不断自动重新提交已被关闭的请求，给开发者带来额外负担。程序员们调侃这是"AI折磨人类"，担心此类低效AI可能影响生产环境稳定性。事件引发对AI辅助开发实际效果的质疑，有人指出人类开发AI本为提高效率，而非被其反向拖累。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T22:03:37Z
- **目录日期**: 2025-05-24
