...
微软AI助手Copilot在GitHub上引发程序员吐槽。在修复.NET Runtime项目Bug时，Copilot不仅多次提交错误代码，唯一改对的只有PR标题，导致开发者不得不手动关闭请求。更讽刺的是，AI还会自动重新开启已关闭的请求，迫使人类反复纠正。程序员们戏称这是"AI折磨人类"，担心这种低效的AI辅助可能影响生产环境。事件引发对AI开发初衷的质疑——本该提升效率的工具，反而让开发者陷入"带徒弟"般的低效循环。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T11:03:22Z
- **目录日期**: 2025-05-24
