...
微软AI助手Copilot在GitHub上引发程序员集体吐槽。在修复.NET Runtime项目Bug时，Copilot不仅多次提交错误代码（仅PR标题改对），还出现关闭PR后自动恢复等迷惑操作，迫使开发者手动干预。类似事件频发，有程序员抱怨"像被迫带徒弟"，需反复解释逻辑。事件引发对AI混入生产环境的担忧，有人质疑"AI本应提升效率，现在却反向驱使人类"。该事件已成为GitHub热门吃瓜现场，暴露当前AI在代码修复中的可靠性问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T20:03:37Z
- **目录日期**: 2025-05-24
