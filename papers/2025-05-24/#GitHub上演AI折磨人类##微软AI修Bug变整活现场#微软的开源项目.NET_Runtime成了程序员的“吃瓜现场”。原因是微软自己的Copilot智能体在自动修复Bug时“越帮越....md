...
微软AI助手Copilot在GitHub上引发争议，其自动修复Bug功能频频出错：代码检查失败、测试报错，仅修改PR标题正确。开发者被迫多次提醒未果，最终手动关闭PR。更讽刺的是，AI还会自动重开PR或修改内容，导致微软员工遭受"AI骚扰"。程序员们担忧此类低效AI可能影响生产环境，质疑"人类开发AI是为提高效率，而非被反向驱使"。事件引发开发者社区对AI辅助工具可靠性的讨论，GitHub评论区变成大型吃瓜现场。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T08:03:34Z
- **目录日期**: 2025-05-24
