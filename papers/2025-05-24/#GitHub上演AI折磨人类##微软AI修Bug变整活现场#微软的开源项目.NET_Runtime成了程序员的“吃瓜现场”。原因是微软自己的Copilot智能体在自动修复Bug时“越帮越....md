...
微软Copilot AI在修复GitHub上的.NET Runtime项目Bug时表现糟糕，不仅未能正确修复代码，还反复提交错误修改，甚至自动重新开启已关闭的PR。开发者被迫多次提醒AI修正，最终只能手动关闭请求。该事件引发程序员调侃，称AI不仅没提高效率，反而让人类像"带徒弟"一样反复指导。有人担忧此类AI可能影响生产环境稳定性，质疑其实际效用。微软员工的类似遭遇也显示AI在代码维护中存在明显缺陷。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T17:03:51Z
- **目录日期**: 2025-05-24
