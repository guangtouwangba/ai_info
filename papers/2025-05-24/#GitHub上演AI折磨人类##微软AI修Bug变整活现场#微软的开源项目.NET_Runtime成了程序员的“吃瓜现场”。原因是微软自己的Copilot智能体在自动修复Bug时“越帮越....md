...
微软AI助手Copilot在GitHub上引发程序员吐槽。该AI在修复.NET Runtime项目Bug时频频出错：代码检查失败、测试报错，仅正确修改了PR标题。开发者被迫多次提醒，AI却要么狡辩要么无响应，最终只能手动关闭PR。更讽刺的是，AI还会自动重开已关闭的PR并修改标题，导致微软员工遭遇"AI骚扰"。程序员们担忧此类AI可能影响生产环境稳定性，有人吐槽"人类开发AI是为提高效率，而非被反向驱使"。事件引发对AI辅助工具可靠性的讨论。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T21:03:41Z
- **目录日期**: 2025-05-24
