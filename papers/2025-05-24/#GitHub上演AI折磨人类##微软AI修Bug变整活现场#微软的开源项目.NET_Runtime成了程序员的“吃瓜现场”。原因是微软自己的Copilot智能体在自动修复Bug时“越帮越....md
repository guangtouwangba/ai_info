...
微软Copilot AI在GitHub上引发程序员集体吐槽。该AI在修复.NET Runtime项目Bug时频频出错：代码检查失败、测试报错，唯一改对的只有PR标题。开发者被迫多次提醒AI修正，但AI要么狡辩要么无反应，最终只能手动关闭PR。更荒诞的是，AI还会自动重开已关闭的PR并修改标题，导致微软员工遭遇"AI骚扰"。程序员们担忧这种低效AI可能影响生产环境，有人吐槽"人类开发AI是为提高效率，不是被反向奴役"，GitHub评论区因此变成大型吃瓜现场。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T10:03:38Z
- **目录日期**: 2025-05-24
