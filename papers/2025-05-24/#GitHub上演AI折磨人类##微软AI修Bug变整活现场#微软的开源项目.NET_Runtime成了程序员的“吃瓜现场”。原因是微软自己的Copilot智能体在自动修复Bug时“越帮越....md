...
微软的AI编程助手Copilot在GitHub上引发热议。在修复.NET Runtime项目Bug时，Copilot不仅未能正确解决问题，反而制造更多错误：代码检查失败、测试报错，唯一改对的只有PR标题。开发者被迫反复提醒AI修正，最终只能手动关闭PR。类似情况频发，如PR被自动恢复、需人工逐步指导等，导致程序员抱怨"被AI反向驱使"。事件引发对AI混入生产环境影响系统稳定的担忧，有人调侃这是"AI折磨人类"的现场，GitHub评论区沦为吃瓜现场。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T07:03:35Z
- **目录日期**: 2025-05-24
