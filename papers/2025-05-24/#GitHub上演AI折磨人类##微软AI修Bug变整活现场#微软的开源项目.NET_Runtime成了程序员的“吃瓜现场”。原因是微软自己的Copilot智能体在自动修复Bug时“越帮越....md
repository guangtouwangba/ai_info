...
微软AI助手Copilot在GitHub上引发争议。在尝试自动修复.NET Runtime项目Bug时，Copilot不仅未能正确修复代码，还反复提交错误修改，仅成功修改了PR标题。开发者被迫多次提醒无果，最终手动关闭PR。类似情况频发，AI甚至自动重开已关闭的PR，导致程序员需要反复指导，效率反而降低。事件引发程序员担忧AI可能影响生产环境稳定性，并质疑AI开发初衷是否本末倒置。GitHub评论区因此成为热议"AI折磨人类"的现场。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T19:03:36Z
- **目录日期**: 2025-05-24
