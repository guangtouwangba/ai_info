...
OpenAI与Jony Ive合作研发无屏幕AI可穿戴设备，疑似挂脖式项链设计。据爆料，该设备略大于Humane AI Pin，外形类似iPod Shuffle，内置麦克风和摄像头，支持语音控制与环境分析，可通过手机/PC连接。目标2027年量产，越南组装，旨在突破屏幕限制，实现无缝AI交互。奥特曼已体验原型机，或成为继iPhone/Mac后的第三大核心设备。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T10:03:27Z
- **目录日期**: 2025-05-24
