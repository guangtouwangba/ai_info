...
OpenAI与强纳肾合作研发的AI可穿戴设备被曝光，据分析师郭明錤透露，该设备为无屏幕挂脖式设计，外形类似iPod Shuffle但略大于AI Pin。配备麦克风和摄像头，支持语音控制与环境分析，可连接手机/PC。预计2027年量产，可能越南组装。奥特曼已体验原型机，目标是通过AI集成突破屏幕限制，重新定义人机交互。该设备或将成为继MacBook和iPhone后的第三大核心数码产品。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T14:03:20Z
- **目录日期**: 2025-05-24
