...
OpenAI与Jony Ive合作研发新型AI可穿戴设备，据爆料为无屏幕挂脖式设计，外形类似iPod Shuffle但略大于Humane AI Pin。设备配备麦克风和摄像头，支持语音控制与环境分析，预计2027年量产。目标是通过无缝AI交互减少对屏幕的依赖，可能成为继手机、电脑后的第三大核心设备。原型机已由OpenAI CEO奥特曼体验，最终设计或仍有调整，组装或选址越南。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T06:03:31Z
- **目录日期**: 2025-05-24
