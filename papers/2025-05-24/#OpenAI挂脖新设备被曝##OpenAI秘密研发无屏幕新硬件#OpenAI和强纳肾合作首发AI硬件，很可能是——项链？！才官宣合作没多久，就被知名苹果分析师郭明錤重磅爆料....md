...
OpenAI与强纳肾合作研发的AI可穿戴设备被曝光，据分析师郭明錤透露，该设备为无屏幕挂脖式设计，外形类似iPod Shuffle但略大于AI Pin。配备麦克风和摄像头，支持语音控制与环境分析，可通过手机/PC连接。预计2027年量产，可能由越南代工。奥特曼已体验原型机，团队旨在突破屏幕限制，打造更具交互性的AI硬件，或成为继iPhone、Mac后的第三大核心设备。设计理念强调无缝AI集成，减少用户对屏幕的依赖。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T07:03:25Z
- **目录日期**: 2025-05-24
