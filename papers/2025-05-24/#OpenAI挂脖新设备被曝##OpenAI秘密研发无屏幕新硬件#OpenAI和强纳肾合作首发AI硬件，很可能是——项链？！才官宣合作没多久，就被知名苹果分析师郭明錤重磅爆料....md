...
OpenAI与设计师Jony Ive合作研发无屏幕AI可穿戴设备，据分析师郭明錤爆料，该设备为脖挂式项链设计，尺寸略大于Humane AI Pin，类似iPod Shuffle的紧凑造型。原型机配备麦克风和摄像头，支持语音交互与环境感知，目标2027年量产。产品旨在突破屏幕限制，通过无缝AI集成重新定义人机交互，可能成为继iPhone后的下一代核心设备。组装或选址越南，最终设计仍可能调整。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T22:03:29Z
- **目录日期**: 2025-05-24
