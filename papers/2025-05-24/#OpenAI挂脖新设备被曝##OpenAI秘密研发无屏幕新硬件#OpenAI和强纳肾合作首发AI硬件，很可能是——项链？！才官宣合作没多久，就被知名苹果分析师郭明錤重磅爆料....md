...
OpenAI与设计师Jony Ive合作研发无屏幕AI可穿戴设备，据爆料将采用挂脖式设计，外形类似iPod Shuffle但略大于Humane AI Pin。该设备配备麦克风和摄像头，支持语音交互与环境感知，预计2027年量产。其核心理念是突破屏幕限制，通过AI集成重新定义人机交互，可能成为继iPhone、Mac后的第三大核心设备。原型机已由OpenAI CEO奥特曼体验，最终设计或仍有调整，组装或选址越南。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T16:03:24Z
- **目录日期**: 2025-05-24
