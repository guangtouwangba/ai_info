...
OpenAI与强纳肾合作研发新型AI可穿戴设备，据分析师郭明錤爆料，该设备为挂脖式设计，尺寸略大于Humane AI Pin，外形类似iPod Shuffle。设备无屏幕，配备摄像头和麦克风，支持语音控制和环境分析，预计2027年量产。奥特曼已体验原型机，目标是通过AI集成减少对屏幕的依赖，可能成为继MacBook和iPhone后的第三大核心设备。组装或选址越南，最终设计可能调整。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T17:03:41Z
- **目录日期**: 2025-05-24
