# #OpenAI挂脖新设备被曝##OpenAI秘密研发无屏幕新硬件#OpenAI和强纳肾合作首发AI硬件，很可能是——项链？！才官宣合作没多久，就被知名苹果分析师郭明錤重磅爆料...
...
OpenAI与设计师Jony Ive合作研发无屏幕AI可穿戴设备，据爆料为脖挂式项链形态，尺寸略大于Humane AI Pin，类似iPod Shuffle大小。设备配备麦克风和摄像头，支持语音控制与环境分析，可连接手机/PC，目标2027年量产。该产品旨在突破屏幕限制，通过AI交互重新定义计算方式，可能成为继iPhone/Mac后的第三大核心设备。原型机已由OpenAI CEO Sam Altman体验，最终设计或仍有调整，组装或选址越南。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T09:03:14Z
- **目录日期**: 2025-05-24
