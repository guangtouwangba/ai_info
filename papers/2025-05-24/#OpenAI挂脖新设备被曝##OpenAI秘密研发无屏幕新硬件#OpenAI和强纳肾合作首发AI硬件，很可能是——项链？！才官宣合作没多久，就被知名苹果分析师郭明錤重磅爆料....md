...
OpenAI与Jony Ive合作研发无屏幕AI可穿戴设备，预计为挂脖式项链形态，略大于Humane AI Pin，类似iPod Shuffle大小。设备配备麦克风、摄像头，支持语音控制和环境分析，可连接手机/PC，目标2027年量产。其核心理念是突破屏幕限制，通过AI交互重新定义计算方式，可能成为继iPhone、Mac后的第三大核心设备。原型机已由奥特曼体验，组装或选址越南。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T23:03:30Z
- **目录日期**: 2025-05-24
