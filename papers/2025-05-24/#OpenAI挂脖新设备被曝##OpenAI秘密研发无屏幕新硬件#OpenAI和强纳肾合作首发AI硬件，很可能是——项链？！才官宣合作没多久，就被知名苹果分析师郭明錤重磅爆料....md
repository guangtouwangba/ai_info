...
OpenAI与设计师Jony Ive合作研发无屏幕AI可穿戴设备，据爆料可能是一款挂脖式项链设备。该设备比Humane AI Pin稍大，外形类似iPod Shuffle，配备麦克风和摄像头，支持语音控制和环境分析。预计2027年量产，目标是通过AI集成减少对屏幕的依赖，可能成为继iPhone和MacBook后的第三大核心设备。组装或选在越南，最终设计可能仍有变动。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T13:10:04Z
- **目录日期**: 2025-05-24
