...
OpenAI与设计师Jony Ive合作研发无屏幕AI可穿戴设备，据爆料为脖挂式项链形态，略大于Humane AI Pin，类似iPod Shuffle大小。设备配备麦克风和摄像头，支持语音控制与环境分析，可连接手机/PC，目标2027年量产。奥特曼已体验原型机，产品理念旨在突破屏幕限制，通过AI交互重新定义计算方式，或成为继iPhone/Mac后的第三大核心设备。组装或选址越南，最终设计可能调整。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T11:03:12Z
- **目录日期**: 2025-05-24
