...
OpenAI与强纳肾合作研发新款AI可穿戴设备，据爆料为无屏幕挂脖式硬件，类似iPod Shuffle但略大于AI Pin。设备配备麦克风和摄像头，支持语音控制与环境分析，可连接手机/PC，目标2027年量产。OpenAI CEO奥特曼已体验原型机，该产品旨在突破屏幕限制，通过AI交互重新定义计算体验，或将成为继iPhone、Mac后的第三大核心设备。组装可能选址越南，具体设计仍在调整中。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T12:03:26Z
- **目录日期**: 2025-05-24
