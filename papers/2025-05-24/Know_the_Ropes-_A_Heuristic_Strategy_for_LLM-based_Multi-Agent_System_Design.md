...
Know-The-Ropes (KtR) 提出了一种解决大语言模型（LLM）局限性的多智能体框架，包括有限上下文、角色过载和领域迁移脆弱性。传统多智能体方法存在分解模糊、合约不明确和验证开销等问题。KtR通过将领域先验转化为层次化算法蓝图，递归分解任务为类型化子任务，结合轻量级增强技术（如思维链、微调、自检），显著提升性能。实验显示，在背包问题（3-8项）中，3个GPT-4o-mini智能体将准确率从3%提升至95%；任务分配问题（6-15项）中，6智能体系统在10项以内达100%准确率，13-15项达84%。该方法无需更大模型即可实现可靠协作。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T03:18:02Z
- **目录日期**: 2025-05-24
