...
Know-The-Ropes (KtR) 提出了一种解决单一大模型局限性的多智能体框架。该框架通过领域先验知识构建层级化任务分解算法，将任务递归拆分为类型化、控制器协调的子任务，并采用最简增强策略（如思维链、微调等）解决。基于"没有免费午餐"定理，KtR放弃通用提示，专注结构化分解。实验显示：在背包问题(3-8项)中，3个GPT-4o-mini智能体将准确率从3%提升至95%；在更复杂的任务分配问题(6-15项)中，6智能体系统在10项内达100%准确率。这表明算法感知分解结合定向增强可使小型模型成为可靠协作系统。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T01:29:25Z
- **目录日期**: 2025-05-24
