...
Know-The-Ropes (KtR) 提出了一种多智能体框架，通过将领域先验转化为分层算法蓝图，递归分解任务为类型化子任务，由控制器协调解决。该方法避免了传统多智能体系统的分解模糊和验证开销问题，采用轻量级增强（如思维链、微调）提升性能。实验显示：在背包问题（3-8物品）中，3个GPT-4o-mini智能体将准确率从零样本的3%提升至95%；在任务分配问题（6-15任务）中，6智能体系统在10规模以下达100%准确率，13-15规模达84%（零样本仅11%）。该方法证明算法感知分解结合定向增强可使中小模型高效协作，无需依赖超大单体模型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T16:02:11Z
- **目录日期**: 2025-05-24
