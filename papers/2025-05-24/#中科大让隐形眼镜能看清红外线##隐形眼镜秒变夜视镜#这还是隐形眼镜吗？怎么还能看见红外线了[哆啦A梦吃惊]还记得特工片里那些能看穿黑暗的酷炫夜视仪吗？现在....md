...
中科大团队研发了一种能看清红外线的隐形眼镜，通过内置特殊纳米颗粒将不可见的红外光转换为可见光。相比传统夜视仪更轻便，无需外接电源，闭眼时仍可工作。目前成像较模糊且仅适用于强红外光源，每副成本约200美元。该技术源于2019年小鼠视网膜纳米颗粒实验，现改进为非侵入性方案。测试显示佩戴者能识别红外光方向和防伪标记，在医疗（如手术导航）和视觉疾病治疗方面具潜力。研究尚处原理验证阶段，需进一步优化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T03:19:24Z
- **目录日期**: 2025-05-24
