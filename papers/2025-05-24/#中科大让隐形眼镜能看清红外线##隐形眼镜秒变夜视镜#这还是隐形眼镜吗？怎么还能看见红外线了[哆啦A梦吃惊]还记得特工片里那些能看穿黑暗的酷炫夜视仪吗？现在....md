...
中国科学技术大学研发出一种能感知红外线的隐形眼镜，通过内置特殊纳米颗粒将不可见的红外光转换为可见光。相比传统夜视仪更轻便，无需电源且闭眼仍可使用，但成像较模糊且仅能识别强红外信号。该技术源于2019年小鼠视网膜纳米颗粒实验，现改进为非侵入性方案。测试显示佩戴者能识别红外光源方向，闭眼时效果更佳。潜在应用包括防伪识别、医疗手术导航和视觉疾病治疗。目前仍处原理验证阶段，单副成本约200美元，需进一步优化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T02:31:15Z
- **目录日期**: 2025-05-24
