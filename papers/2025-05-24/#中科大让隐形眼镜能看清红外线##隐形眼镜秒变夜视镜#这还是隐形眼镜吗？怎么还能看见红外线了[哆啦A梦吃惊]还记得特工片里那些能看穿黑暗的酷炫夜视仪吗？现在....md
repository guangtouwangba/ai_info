...
中科大研发出一种新型隐形眼镜，通过内置特殊纳米颗粒将红外光转换为可见光，实现裸眼红外视觉。该技术比传统夜视仪更轻便，无需外接电源，闭眼时仍可工作。目前原型存在图像模糊、仅能识别强红外信号等局限，单副成本约200美元。研究团队在2019年小鼠视网膜实验基础上改进为无创方案，测试显示佩戴者能识别红外光源方向。潜在应用包括防伪识别、医疗手术导航和视觉疾病治疗。该技术尚处原理验证阶段，需进一步优化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-24T00:03:24Z
- **目录日期**: 2025-05-24
