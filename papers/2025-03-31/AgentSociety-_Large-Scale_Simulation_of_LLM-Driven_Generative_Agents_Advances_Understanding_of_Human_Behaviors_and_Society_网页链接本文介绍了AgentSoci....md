...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能模拟1万多个AI代理的社会互动（500万次交互）。研究者用它研究了四大社会问题：社会极化、信息传播、基本收入政策效果和自然灾害影响。模拟结果与现实数据高度吻合，验证了该系统捕捉人类行为机制的能力。这为社会科学研究和政策制定提供了新工具，能辅助传统调查和实验方法，帮助理解社会问题的成因和模式。该系统展示了AI在社会科学研究中的应用潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T03:26:19Z
- **目录日期**: 2025-03-31
