...
AgentSociety是一种基于大语言模型的大规模社会模拟器，可模拟超过1万个代理及其500万次互动。该平台用于研究极化现象、信息传播、基本收入政策及外部冲击等社会问题，结果与现实数据吻合，验证了其模拟人类行为和社会机制的能力。研究表明，AgentSociety可作为计算社会科学的重要工具，辅助传统研究方法，帮助研究者分析社会问题的模式和成因，并为政策制定提供参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T14:05:29Z
- **目录日期**: 2025-03-31
