...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟1万多个代理及其500万次互动。研究者用它分析了四个关键社会问题：社会极化、刺激性信息传播、无条件基本收入政策影响和飓风等外部冲击。模拟结果与现实世界数据吻合，验证了该系统捕捉人类行为和社会机制的能力。该平台可作为传统社会科学研究方法的补充工具，帮助研究者和政策制定者理解社会问题的模式和成因，展现出在社会科学研究中的重要应用潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T21:04:33Z
- **目录日期**: 2025-03-31
