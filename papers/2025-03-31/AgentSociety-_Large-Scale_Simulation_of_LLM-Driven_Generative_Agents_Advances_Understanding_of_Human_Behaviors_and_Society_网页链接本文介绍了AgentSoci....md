...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统通过模拟1万多个AI代理及其500万次互动，研究了四大社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。研究发现模拟结果与现实世界数据高度吻合，验证了该系统在揭示人类行为机制和社会规律方面的有效性。AgentSociety为社会科学研究提供了新工具，能辅助传统调查方法，帮助研究者更深入地理解复杂社会现象，并为政策制定提供参考依据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T00:05:28Z
- **目录日期**: 2025-03-31
