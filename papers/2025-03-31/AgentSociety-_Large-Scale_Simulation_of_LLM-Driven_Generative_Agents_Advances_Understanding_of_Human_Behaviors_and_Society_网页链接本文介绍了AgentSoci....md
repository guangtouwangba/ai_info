...
AgentSociety是一种基于大语言模型的大规模社会模拟器，可模拟1万多个代理及其500万次互动。它通过真实社会环境和强大模拟引擎，研究极化现象、信息传播、基本收入政策及自然灾害影响等社会问题。模拟结果与现实世界数据吻合，验证了其在捕捉人类行为机制方面的能力，展示了作为社会科学研究和政策制定工具的潜力。该平台能补充传统研究方法（如调查和访谈），帮助深入分析社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T15:05:20Z
- **目录日期**: 2025-03-31
