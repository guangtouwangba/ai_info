...
AgentSociety是一个基于大语言模型的大规模社会模拟器，包含1万多个代理和500万次互动。它通过模拟真实社会环境，研究了极化现象、信息传播、基本收入政策及外部冲击等社会问题。模拟结果与现实数据吻合，验证了其捕捉人类行为和社会机制的能力。该系统可作为计算社会科学的研究平台，辅助传统方法（如调查、访谈）分析社会问题的模式和成因，为研究者和政策制定者提供有力工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T06:05:09Z
- **目录日期**: 2025-03-31
