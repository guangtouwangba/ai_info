...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献搜索、AI辅助阅读、自动摘要生成和互动问答，帮助用户高效获取和理解学术内容。平台还提供科研动态订阅功能，可根据用户偏好推送最新论文和资讯。此外，AMiner包含学者画像、学术会议和论文排行榜等特色功能，收录了3.5亿论文和0.6亿学者数据。用户可通过网页免费使用基础功能，适合科研人员和学生提升研究效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T11:07:33Z
- **目录日期**: 2025-03-31
