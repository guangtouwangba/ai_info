...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献搜索，拥有3.5亿论文、0.6亿学者等海量数据，并能通过AI生成摘要和问答互动辅助理解。平台还提供文献翻译、科研动态订阅（通过微信或邮件推送）、学者画像等功能，支持用户上传PDF或直接检索文献库。其浏览器版本可免费使用，帮助研究者高效获取学术信息。访问入口：https://www.aminer.cn/ 。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T06:05:42Z
- **目录日期**: 2025-03-31
