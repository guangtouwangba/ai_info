...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析和写作一站式服务。它支持中英文文献搜索，能生成摘要、辅助阅读，并允许用户通过问答深入理解论文内容。平台还提供科研动态订阅功能，根据用户偏好推送最新学术资讯。收录了3.5亿论文、0.6亿学者等海量数据，涵盖42个学科。主要功能包括文献检索、AI辅助阅读、自动翻译、学者画像等，可通过网页免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T00:05:55Z
- **目录日期**: 2025-03-31
