...
AMiner是一个智能科技情报挖掘系统，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献搜索、AI辅助阅读和翻译，拥有3.5亿论文、0.6亿学者等海量数据。用户可通过互动问答快速理解文献，并生成摘要以提高写作效率。平台还提供科研动态订阅服务，根据用户偏好推送最新学术资讯。此外，AMiner具备学者画像、学术会议等功能，基础服务免费使用。访问地址：https://www.aminer.cn/。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T03:26:45Z
- **目录日期**: 2025-03-31
