...
浙江大学与上海AI Lab等机构的研究人员提出了一种名为"邻近自回归建模"(NAR)的新视觉生成范式。该技术突破了传统"下一个token预测"方法的效率瓶颈，采用"下一个邻域预测"机制，将图像/视频生成视为逐步"外绘"过程。实验表明，这种新方法能显著提升高分辨率图像生成速度，相比传统方法提速近14倍(13.8倍)，为视觉生成领域带来了突破性的效率提升。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T00:03:30Z
- **目录日期**: 2025-03-31
