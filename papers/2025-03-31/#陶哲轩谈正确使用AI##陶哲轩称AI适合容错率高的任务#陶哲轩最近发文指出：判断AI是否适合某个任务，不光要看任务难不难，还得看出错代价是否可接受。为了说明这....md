...
陶哲轩提出判断AI适用性的二维框架：任务复杂度vs容错率。简单且容错率高的任务(如家常烹饪)适合AI；复杂且容错率低的任务(如国宴)需谨慎。他建议"AI初稿+人工修正"的混合模式，例如AI生成学习计划后由教师调整。这种协同方式既能发挥AI效率，又能通过人工把关降低风险，实现优势互补。核心观点是：AI应作为辅助工具而非完全替代，关键决策仍需人类参与。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T08:04:31Z
- **目录日期**: 2025-03-31
