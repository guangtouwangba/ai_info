...
陶哲轩提出判断AI适用性的二维框架：任务复杂度与容错率。简单且容错率高的任务（如家常烹饪）适合AI；复杂且容错率低的任务（如国宴）需谨慎。他建议教育领域采用"AI初稿+人工修正"的混合模式，既保持个性化又控制风险。强调"AI辅助+人类兜底"是最现实的协作方式，能平衡效率与可靠性。该框架为AI应用提供了清晰的决策依据，突出人机协同的优势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T22:03:43Z
- **目录日期**: 2025-03-31
