...
陶哲轩提出判断AI适用性的二维框架：任务复杂度vs容错率。简单且容错率高的任务（如家常菜谱推荐）适合AI；复杂且容错率低的任务（如国宴设计）需谨慎。他建议采用"AI生成初稿+人类修正"的混合模式，例如教育领域可先用AI制定学习计划草案，再由教师调整。这种协同方式既能利用AI效率，又能通过人工把关降低风险，实现优势互补。核心观点是AI应作为辅助工具而非完全替代，尤其在关键领域需保留人类决策权。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T12:04:10Z
- **目录日期**: 2025-03-31
