...
陶哲轩提出了一个AI适用性评估框架，建议根据任务复杂度与容错率来判断是否适合使用AI。简单且容错率高的任务（如家常烹饪）适合AI处理，而复杂且容错率低的关键任务（如国宴筹备）则需谨慎。他提倡"AI辅助+人类监督"的混合模式，例如让AI生成学习计划初稿再由教师调整，既能发挥AI效率优势，又能控制风险。该框架强调AI应作为增强而非替代人类的工具，在可承受错误代价的领域发挥作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T19:03:31Z
- **目录日期**: 2025-03-31
