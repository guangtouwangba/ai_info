...
陶哲轩提出了一个AI任务适用性评估框架，建议根据任务复杂度和容错率两个维度来判断是否适合使用AI。他认为简单且容错率高的任务最适合AI处理，而复杂且容错率低的任务则应谨慎使用。他提倡"AI辅助+人类兜底"的混合模式，例如在教育领域让AI生成学习计划初稿，再由老师调整。这种模式既能发挥AI效率优势，又能降低错误风险，比完全依赖AI更现实可行。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T14:04:02Z
- **目录日期**: 2025-03-31
