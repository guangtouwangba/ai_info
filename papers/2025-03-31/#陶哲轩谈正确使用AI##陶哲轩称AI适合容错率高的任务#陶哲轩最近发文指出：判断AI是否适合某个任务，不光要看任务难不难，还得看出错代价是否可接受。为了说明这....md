# #陶哲轩谈正确使用AI##陶哲轩称AI适合容错率高的任务#陶哲轩最近发文指出：判断AI是否适合某个任务，不光要看任务难不难，还得看出错代价是否可接受。为了说明这...
...
陶哲轩提出AI适用性的评估框架，建议从"任务复杂度"和"容错率"两个维度判断AI的适用场景。他认为简单且容错率高的任务（如日常烹饪）适合AI处理，而复杂且容错率低的任务（如外交宴席）需要人类主导。在教育领域，他推荐"AI初稿+人工调整"的混合模式，既能实现个性化又降低风险。总体主张"AI辅助+人类把关"的协作方式，充分发挥各自优势。该框架为AI应用提供了实用决策工具，强调需根据具体场景权衡自动化程度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T15:03:59Z
- **目录日期**: 2025-03-31
