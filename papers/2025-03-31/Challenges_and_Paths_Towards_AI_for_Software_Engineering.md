...
近期AI在软件工程领域取得显著进展，成为生成式AI的重要成功应用，但实现全面自动化仍需突破诸多挑战。理想状态下，人类可专注于关键决策，而常规开发工作由AI完成。该目标需要产学研界的持续投入。本文通过三方面展开讨论：首先建立软件工程AI任务分类体系，强调除代码生成外的其他任务；其次指出当前方法的主要瓶颈；最后提出解决这些瓶颈的潜在研究方向，以推动这一快速发展领域的未来研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T11:01:37Z
- **目录日期**: 2025-03-31
