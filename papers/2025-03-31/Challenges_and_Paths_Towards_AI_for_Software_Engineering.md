...
AI在软件工程领域取得了显著进展，成为生成式AI的重要成功案例，但要实现完全自动化仍需克服诸多挑战。未来目标是实现高度自动化，让人类专注于关键决策和权衡，而常规开发工作由AI完成。本文从三方面探讨这一目标：首先，提出AI在软件工程中的任务分类，强调除代码生成外还有许多其他任务；其次，指出当前方法的主要瓶颈；最后，列出有前景的研究方向以突破这些瓶颈，推动该领域的未来发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T21:01:14Z
- **目录日期**: 2025-03-31
