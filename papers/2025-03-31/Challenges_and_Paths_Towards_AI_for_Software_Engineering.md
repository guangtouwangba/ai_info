...
这篇论文探讨了AI在软件工程领域的进展与挑战。尽管AI在代码生成和补全等方面已取得显著成功，但要实现高度自动化仍需突破多项瓶颈。作者从三方面展开讨论：首先，提出了AI在软件工程中的任务分类，强调除代码生成外还有许多其他任务；其次，分析了当前方法面临的主要限制；最后，列出有前景的研究方向以解决这些瓶颈。未来需要学术界和工业界的共同努力，才能实现人类专注于关键决策、AI处理常规开发工作的理想状态。该研究旨在为这一快速发展的领域提供启发。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T23:01:22Z
- **目录日期**: 2025-03-31
