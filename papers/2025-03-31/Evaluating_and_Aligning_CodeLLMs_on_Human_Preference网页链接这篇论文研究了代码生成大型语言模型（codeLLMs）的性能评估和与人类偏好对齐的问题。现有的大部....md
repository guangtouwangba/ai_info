...
这篇论文探讨了代码生成大模型(codeLLMs)与人类偏好的对齐问题，指出当前基准测试过于关注代码正确性而忽视用户体验。研究者提出了CodeArena基准测试，包含397个高质量样本覆盖40类任务和44种编程语言，并构建了20B标记的SynCode-Instruct合成指令集。实验发现执行基准与CodeArena存在性能差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)差距显著，凸显了人类偏好对齐的重要性。研究强调了在代码生成评估中纳入用户体验指标的必要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T00:06:25Z
- **目录日期**: 2025-03-31
