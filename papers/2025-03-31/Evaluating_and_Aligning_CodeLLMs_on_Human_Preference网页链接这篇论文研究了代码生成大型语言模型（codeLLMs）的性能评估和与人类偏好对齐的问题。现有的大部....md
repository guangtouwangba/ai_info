...
这篇论文针对代码生成大模型(codeLLMs)提出新评估方法，发现现有基准过于关注代码正确性而忽视人类偏好。研究团队构建了包含397个高质量样本的CodeArena基准(覆盖40类任务和44种语言)，并开发了20B标记量的SynCode-Instruct合成指令集。实验显示，执行基准与人类偏好评估存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI)性能差距显著，突显了对齐人类偏好的重要性。该研究为提升代码LLMs的实际应用价值提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T08:06:52Z
- **目录日期**: 2025-03-31
