...
该论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，通过397个涵盖40类编程任务和44种语言的样本，评估模型与人类偏好的匹配度。研究发现现有基准过度关注代码正确性而忽略实际偏好，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI)存在显著差距。同时构建20B标记的SynCode-Instruct合成指令集验证微调效果，强调代码生成模型需要同时满足功能正确性和人类偏好。研究揭示了当前评估体系的局限性，为提升代码LLMs的实用价值提供新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T16:06:13Z
- **目录日期**: 2025-03-31
