...
这篇论文提出CodeArena基准测试和SynCode-Instruct语料库，研究代码生成大模型(CodeLLMs)与人类偏好的对齐问题。CodeArena包含397个高质量编程任务样本，覆盖40类44种语言，模拟真实编程场景；SynCode-Instruct则包含近200亿标记的合成指令数据。实验发现，传统执行基准与人类偏好评估存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究强调了代码生成模型除正确性外，还需关注与人类开发者偏好的匹配度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T03:26:54Z
- **目录日期**: 2025-03-31
