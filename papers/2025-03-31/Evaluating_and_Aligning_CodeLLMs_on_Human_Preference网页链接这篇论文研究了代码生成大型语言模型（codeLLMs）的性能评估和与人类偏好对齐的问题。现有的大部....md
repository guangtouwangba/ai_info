...
这篇论文探讨了代码生成大模型(codeLLMs)如何与人类偏好对齐的问题。研究者创建了CodeArena基准测试，包含397个高质量样本，覆盖40类任务和44种编程语言，更贴近实际编程需求。同时开发了包含近200亿标记的合成指令数据集SynCode-Instruct。实验发现，传统基于执行的测试与人类偏好评估存在差异，且开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)在人类偏好匹配上表现差距明显，凸显了模型对齐的重要性。研究为提升代码生成模型的实际应用价值提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T19:05:13Z
- **目录日期**: 2025-03-31
