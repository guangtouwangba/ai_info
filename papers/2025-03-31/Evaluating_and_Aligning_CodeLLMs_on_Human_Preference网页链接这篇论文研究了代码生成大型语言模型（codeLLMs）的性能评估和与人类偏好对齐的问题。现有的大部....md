...
该论文针对代码生成大模型(codeLLMs)提出新评估方法，强调人类偏好对齐的重要性。研究者创建了CodeArena基准测试(含397个高质量样本，覆盖40类编程任务和44种语言)，并构建近200亿标记的SynCode-Instruct合成指令集。实验发现：1)传统基于执行的评估与人类偏好存在差异；2)开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究凸显了在代码生成任务中，仅关注功能正确性不足，需加强模型输出与人类编程偏好的对齐。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T02:34:00Z
- **目录日期**: 2025-03-31
