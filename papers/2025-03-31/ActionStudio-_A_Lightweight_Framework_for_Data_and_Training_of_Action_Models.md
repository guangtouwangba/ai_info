...
ActionStudio是一个轻量级、可扩展的数据和训练框架，专为动作模型设计。它通过标准化格式统一异构智能体轨迹，支持LoRA、全微调和分布式训练等多种范式，并集成了强大的预处理和验证工具。该框架在公共和工业基准测试中表现出色，验证了其高效性和可扩展性。研究团队开源了代码和数据（https://github.com/SalesforceAIResearch/xLAM），以促进相关领域的研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T17:01:10Z
- **目录日期**: 2025-03-31
