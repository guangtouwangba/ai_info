...
这篇论文介绍了一个美国大选电视广告的最大数字数据集，包含9,707个广告，提供机器可搜索的转录文本和高质量摘要。研究团队开发了基于AI的自动化分析流程，替代传统人工处理方式，并通过人工评估验证了转录和摘要的质量。该数据集来自Julian P. Kanter政治广告档案馆，支持追踪70年来总统竞选焦点议题的演变。研究还展示了如何利用LLM工具为其他视频数据集生成高质量摘要。这套方法解决了传统小样本研究的局限性，为学术研究提供了全面的大规模分析资源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T19:01:56Z
- **目录日期**: 2025-03-31
