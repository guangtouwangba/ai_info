...
这篇论文介绍了美国最大最全面的总统竞选电视广告数字数据集，包含9,707个广告，配有机器可搜索的转录文本和高质量摘要，便于学术研究。传统方法依赖人工收集和小样本，而作者开发了基于AI的自动化分析流程，能并行处理视频准备、转录和摘要生成。经人工评估，这些转录和摘要质量媲美人工制作。研究还展示了该数据的应用价值，如追踪70年间总统选举核心议题的演变。分析流程和代码库展示了如何利用LLM工具为其他视频数据集生成高质量摘要。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T12:02:09Z
- **目录日期**: 2025-03-31
