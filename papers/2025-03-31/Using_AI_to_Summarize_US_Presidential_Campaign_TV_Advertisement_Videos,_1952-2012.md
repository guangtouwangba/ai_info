...
这篇论文介绍了一个最大最全面的美国总统竞选电视广告数据集，包含数字化格式的广告视频、可机器检索的文本转录和高质量摘要，旨在促进学术研究。传统方法依赖人工收集和小样本，而作者开发了基于AI的自动化分析流程，对Kanter政治广告档案馆的9,707条广告进行转录和摘要。人工评估证实其质量媲美人工处理结果。研究还展示了该数据的应用价值，如追踪70年间竞选焦点议题的演变。该AI分析流程和代码库为其他视频数据集的高质量摘要生成提供了范例。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T22:02:04Z
- **目录日期**: 2025-03-31
