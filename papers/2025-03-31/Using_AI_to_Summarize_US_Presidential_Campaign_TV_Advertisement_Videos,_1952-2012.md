...
这篇论文介绍了美国最大最全面的总统竞选电视广告数字数据集，包含9,707个广告，配有机器可搜索的转录文本和高质量摘要。研究者开发了基于AI的自动化分析流程，大幅降低了人工处理视频的工作量。通过人工评估验证，这些转录和摘要质量与人工制作相当。该数据集支持多种学术研究，比如追踪70年来总统选举核心议题的演变。论文还展示了如何利用大语言模型工具为其他视频数据集生成高质量摘要。数据集来自Julian P. Kanter政治广告档案馆，填补了该领域大规模数字资源的空白。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T10:02:04Z
- **目录日期**: 2025-03-31
