...
这篇论文介绍了美国最大最全面的总统竞选电视广告数字数据集，包含9,707个广告，配有机器可搜索的转录文本和高质量摘要。研究团队开发了基于AI的自动化分析流程，大幅提升了视频准备、转录和摘要的效率。通过人工评估证实，这些转录和摘要的质量与人工制作相当。数据集来自Julian P. Kanter政治广告档案馆，可用于追踪70年来总统选举核心议题的演变。该研究还展示了如何利用LLM工具为其他视频数据集生成高质量摘要，为学术研究提供了重要资源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T21:01:50Z
- **目录日期**: 2025-03-31
