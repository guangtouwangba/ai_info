...
当前，AI素养的定义仍模糊不清，研究者和从业者对如何设计和讨论AI素养教育缺乏共识。该领域涵盖从大学生使用ChatGPT到幼儿与社交机器人互动等广泛场景。一项对2020年后124项研究的综述提出了AI素养的三种概念化方式（功能性、批判性、间接效益）和三种视角（技术细节、工具、社会文化），构建了一个反映实践多样性的框架。该框架指出，AI素养讨论需要更专业的术语，并揭示了某些目标下的研究空白，呼吁更精准的学术界定和实践探索。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T11:02:31Z
- **目录日期**: 2025-03-31
