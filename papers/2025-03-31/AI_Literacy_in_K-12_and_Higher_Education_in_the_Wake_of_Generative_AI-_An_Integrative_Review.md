...
当前AI素养的定义仍不明确，缺乏共识。本文通过综述2020年以来的124项研究，提出了AI素养的三个维度（功能性、批判性、间接受益性）和三种视角（技术细节、工具、社会文化），构建了实践框架。研究发现，AI素养的应用范围广泛，从大学生使用ChatGPT到幼儿与社交机器人互动。该框架揭示了现有术语的不足，并指出某些AI素养目标的研究空白，呼吁更精确的概念界定。这一综述为AI素养的讨论和教学设计提供了系统性参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T22:02:12Z
- **目录日期**: 2025-03-31
