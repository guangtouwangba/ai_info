...
当前，AI素养的定义仍不明确，缺乏共识。研究通过整合2020年以来的124项实证与理论研究，提出了AI素养的三种概念化方式（功能性、批判性、间接受益性）和三种视角（技术细节、工具、社会文化），形成了一个实践框架。该框架揭示了AI素养讨论中需要更专业化的术语，并指出某些AI素养目标的研究空白。研究涵盖从大学生使用ChatGPT到幼儿与社交机器人互动等广泛场景，突显了该领域的多样性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T15:02:15Z
- **目录日期**: 2025-03-31
