...
本文介绍了"不完整偏好提案"(IPP)，旨在确保高级人工智能代理不会抗拒关机。该提案的核心是使用新型"DReST"奖励函数训练代理，使其能有效追求目标（"有用性"）并随机选择不同轨迹长度（"中立性"）。研究提出了评估这两种特性的指标，通过在网格世界中训练简单代理验证了DReST的有效性。结果表明，DReST可训练高级代理同时具备有用性和中立性，理论分析也支持这类代理既实用又可关机。这为开发安全可控的AI系统提供了初步证据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T23:02:18Z
- **目录日期**: 2025-03-31
