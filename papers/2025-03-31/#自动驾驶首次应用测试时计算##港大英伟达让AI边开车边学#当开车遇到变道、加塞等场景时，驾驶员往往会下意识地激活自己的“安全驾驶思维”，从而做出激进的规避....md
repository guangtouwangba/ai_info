...
香港大学、英伟达和图宾根大学联合团队提出Centaur方法，通过测试时计算技术让自动驾驶系统在行驶过程中动态学习优化驾驶策略。该方法利用数据驱动方式替代预设规则，使AI能像人类驾驶员一样在变道、加塞等不确定场景中灵活调整驾驶行为，避免传统自动驾驶系统因过度谨慎导致的急刹或避让问题，显著提升了系统在复杂路况下的适应性和安全性。这项技术实现了自动驾驶AI"边开车边学习"的能力，是自动驾驶领域的重要突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T01:31:24Z
- **目录日期**: 2025-03-31
