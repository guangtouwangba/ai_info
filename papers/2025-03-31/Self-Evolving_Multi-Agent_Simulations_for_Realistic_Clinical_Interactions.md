...
研究人员开发了开源临床模拟环境MedAgentSim，包含医生、患者和检测代理，用于评估大语言模型(LLM)在动态诊断中的表现。该框架要求医生代理通过多轮对话主动与患者互动，向检测代理请求相关检查(如体温、血压、心电图)和影像结果(如MRI、X光)，模拟真实诊断流程。系统整合了多代理讨论、思维链推理和基于经验的知识检索，支持医生代理通过自我改进机制迭代优化诊断策略。研究还提出了评估LLM动态诊断能力的基准测试，支持全自动和人工交互模式。代码和工具已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T10:01:02Z
- **目录日期**: 2025-03-31
