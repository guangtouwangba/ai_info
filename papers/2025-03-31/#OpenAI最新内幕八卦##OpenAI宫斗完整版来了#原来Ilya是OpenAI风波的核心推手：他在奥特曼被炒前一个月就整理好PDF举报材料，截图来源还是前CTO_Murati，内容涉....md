...
OpenAI内部权力斗争的核心人物是首席科学家Ilya Sutskever。他在Sam Altman被解雇前一个月就准备了举报材料，指控Altman在GPT-4 Turbo审批流程上撒谎。董事会解雇Altman时未提前通知微软，后经前CTO Murati提醒。随后员工集体抗议，Ilya反悔签名，Altman在48小时内戏剧性复职。但多数高管已离职创业，仅剩Greg Brockman留下。这场高层动荡揭示了OpenAI内部的严重分歧。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T00:03:05Z
- **目录日期**: 2025-03-31
