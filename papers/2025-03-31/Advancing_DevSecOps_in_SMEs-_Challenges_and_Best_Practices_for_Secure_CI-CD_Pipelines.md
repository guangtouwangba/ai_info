...
该研究评估了中小型企业（SMEs）采用DevSecOps的现状，发现68%的企业已实施该模式，但技术复杂性（41%）、资源限制（35%）和文化阻力（38%）阻碍了全面应用。尽管73%的企业领导重视安全，仅12%能做到每次提交都进行安全扫描。API安全（63%）和软件成分分析（62%）工具应用广泛，但容器安全采用率较低（34%）。未来AI/ML将显著影响DevSecOps发展。研究建议通过自动化流程、领导驱动的安全文化和跨团队协作来加强CI/CD管道安全。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T09:01:37Z
- **目录日期**: 2025-03-31
