...
本研究提出LatentSync框架，通过音频条件潜在扩散模型实现端到端唇同步，无需中间运动表示。该方法创新性地采用时间表示对齐(TREPA)技术解决扩散模型的时间一致性问题，并优化SyncNet训练框架提升准确性。实验表明，该方法在HDTF和VoxCeleb2数据集上超越现有技术，为音频驱动人像动画提供了新思路。研究还系统分析了影响SyncNet性能的关键因素，相关经验可推广至其他唇同步方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-31T18:05:07Z
- **目录日期**: 2025-03-31
