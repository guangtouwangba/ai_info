...
本文提出了一种基于扩散模型的虚拟试衣(VTON)新方法SPM-Diff，通过显式利用视觉对应关系作为先验来改善服装细节保留。该方法将服装细节解释为结构化语义点，通过局部流变形将服装语义点与目标人体匹配，并利用深度/法线图增强为3D感知线索。提出的点聚焦扩散损失充分利用语义点匹配优势，模拟真实穿衣过程。在VITON-HD和DressCode数据集上的实验表明，该方法能有效保持服装形状和细节，达到了最先进的VTON性能。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T07:02:24Z
- **目录日期**: 2025-05-25
