...
这篇论文提出了一种基于扩散模型的虚拟试衣（VTON）新方法SPM-Diff，通过显式利用视觉对应关系来改善服装细节保留。传统方法直接将服装图像输入UNet，而本文创新地将服装细节表示为结构化语义点，通过局部流变形匹配目标人物上的对应点，并融合深度/法线图增强为3D感知线索。该方法模拟真实穿衣过程，设计了点聚焦扩散损失来强化语义点匹配监督。在VITON-HD和DressCode数据集上的实验表明，该方法能有效保持服装形状和细节，达到了最先进的性能表现。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T09:02:27Z
- **目录日期**: 2025-05-25
