...
该研究提出了一种无需人工标注的大规模网络导航智能体训练方法。首先利用大语言模型（LLM）自动标注15万个网站的任务，然后由LLM智能体执行任务并生成轨迹，最后通过LLM过滤成功轨迹。该方法在数据筛选方面表现优异，有害内容识别准确率达97%，轨迹成功率判断准确率达82.6%。基于Qwen 3 1.7B训练的智能体性能优异，成功率56.9%，超越235倍大的Llama 4 Maverick，达到Gemini 2.5 Flash性能的94.7%。研究团队将公开代码、模型和数据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T07:02:34Z
- **目录日期**: 2025-05-25
