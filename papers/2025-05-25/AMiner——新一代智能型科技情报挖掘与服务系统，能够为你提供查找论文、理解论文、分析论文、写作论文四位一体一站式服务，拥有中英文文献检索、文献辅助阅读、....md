...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、辅助阅读、科研订阅等一站式服务。其核心功能包括：1）精准检索42个学科的3.5亿论文资源；2）AI生成文献摘要与互动问答；3）支持PDF文档解析与内容对话；4）定制化科研动态推送。平台还涵盖学者画像、学术会议等特色功能，基础服务免费开放。通过AI技术显著提升文献调研效率，适用于论文写作与科研追踪。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T02:38:35Z
- **目录日期**: 2025-05-25
