...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、辅助阅读、翻译和科研情报订阅。平台拥有3.5亿论文、0.6亿学者等海量数据，支持互动问答、自动摘要生成和文献分析。用户可订阅个性化科研动态，通过微信或邮件获取最新资讯。此外，AMiner还提供学者画像、学术会议和论文排行榜等功能。其AI技术能快速解析文献内容，帮助用户高效理解与写作。平台基础功能免费开放，适合科研人员使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T17:05:50Z
- **目录日期**: 2025-05-25
