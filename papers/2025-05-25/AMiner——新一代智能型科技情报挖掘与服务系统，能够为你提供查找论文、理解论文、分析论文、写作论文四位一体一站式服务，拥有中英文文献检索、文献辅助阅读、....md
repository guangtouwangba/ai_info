...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献检索、AI辅助阅读、自动摘要生成和翻译功能，涵盖3.5亿论文、0.6亿学者等海量数据。用户可通过互动问答快速理解文献，并订阅个性化科研动态推送。平台还支持PDF上传分析、学者画像及学术会议追踪，浏览器版本可免费使用。核心功能包括高效文献定位、智能摘要生成和跨语言文献处理，显著提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T15:06:07Z
- **目录日期**: 2025-05-25
