...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和科研订阅等一站式服务。它拥有3.5亿论文、0.6亿学者等海量学术资源，支持中英文文献检索，并能通过AI生成摘要、章节概要和智能问答。用户可订阅个性化科研动态，追踪特定学者或领域的最新进展。平台还提供学者画像、学术会议和论文排行榜等功能，大部分服务可免费使用。AMiner旨在帮助研究者高效获取和分析学术信息，提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T23:05:20Z
- **目录日期**: 2025-05-25
