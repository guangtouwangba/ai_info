...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析与写作的一站式服务。它支持中英文文献搜索，能自动生成摘要和问答互动，帮助用户快速理解内容。平台还具备文档翻译、科研动态订阅功能，可根据用户偏好推送最新学术资讯。此外，AMiner收录了海量学术资源，包括3.5亿论文、0.6亿学者和1.5亿专利，并提供学者画像、会议信息等辅助工具。用户可通过网页或微信小程序免费使用其核心功能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T14:06:10Z
- **目录日期**: 2025-05-25
