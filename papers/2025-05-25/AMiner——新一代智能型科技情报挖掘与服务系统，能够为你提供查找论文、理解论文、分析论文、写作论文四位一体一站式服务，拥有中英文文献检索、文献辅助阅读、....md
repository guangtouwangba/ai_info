...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、科研情报订阅等一站式服务。它能快速定位相关学术文献，通过AI生成摘要和问答辅助理解，支持PDF上传和交互式阅读。平台还提供个性化订阅服务，推送最新科研动态。收录3.5亿论文、0.6亿学者等海量数据，涵盖42个学科。主要功能包括学者画像、学术会议追踪和论文排行榜，支持免费使用。网址：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T00:05:41Z
- **目录日期**: 2025-05-25
