...
该研究探讨了多模态大语言模型(MLLMs)的3D空间感知能力，提出了VGBench基准测试视觉几何感知(如相机姿态估计)，并整合11个现有数据集创建了迄今最全面的多模态空间理解基准SpatialScore(含28K样本和困难子集SpatialScore-Hard)。同时开发了支持Plan-Execute和ReAct推理范式的多智能体系统SpatialAgent(集成9种专用工具)。实验揭示了MLLMs在空间推理中的持续挑战，同时验证了SpatialAgent的有效性。该基准将为MLLMs的下一代发展提供重要参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T22:01:16Z
- **目录日期**: 2025-05-25
