...
本研究探讨多模态大语言模型(MLLMs)的3D空间感知能力，提出VGBench评估视觉几何感知(如相机位姿估计)，并整合11个现有数据集创建最全面的空间理解基准SpatialScore(含28K样本和挑战性子集SpatialScore-Hard)。同时开发了支持Plan-Execute和ReAct推理范式的多智能体系统SpatialAgent(集成9种专用工具)。实验揭示了MLLMs在空间推理中的持续挑战，验证了SpatialAgent的有效性。该基准将为MLLMs的下一代演进提供严谨评估标准与重要洞见。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T07:01:13Z
- **目录日期**: 2025-05-25
