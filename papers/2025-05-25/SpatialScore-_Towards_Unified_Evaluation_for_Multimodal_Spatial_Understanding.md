...
本文研究了多模态大语言模型(MLLM)的空间理解能力，提出了VGBench基准测试视觉几何感知(如相机位姿和运动估计)，并整合11个现有数据集创建了迄今最全面的多模态空间理解基准SpatialScore(含28K样本)。该基准包含精心设计的挑战性子集SpatialScore-Hard。同时开发了支持Plan-Execute和ReAct推理范式的多代理系统SpatialAgent(含9个专用工具)。实验表明当前MLLM在空间推理方面仍存在挑战，而SpatialAgent表现优异。该研究为MLLM的下一代发展提供了重要基准和见解。(99字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T13:07:11Z
- **目录日期**: 2025-05-25
