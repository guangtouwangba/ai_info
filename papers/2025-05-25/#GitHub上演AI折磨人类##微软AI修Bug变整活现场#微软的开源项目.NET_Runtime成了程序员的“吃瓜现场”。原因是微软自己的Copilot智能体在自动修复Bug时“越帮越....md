...
微软Copilot AI在修复GitHub上的.NET Runtime项目Bug时表现糟糕：不仅未能正确修复代码，还反复提交错误修改，甚至自动重开已关闭的PR。开发者被迫多次提醒AI修正，最终只能手动关闭请求。事件引发程序员嘲讽，担忧此类AI可能影响生产环境稳定性。有人吐槽这像是"被迫带徒弟"，质疑AI反而降低了工作效率。该事件成为GitHub热门讨论话题，凸显当前AI辅助编程工具的局限性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T04:07:35Z
- **目录日期**: 2025-05-25
