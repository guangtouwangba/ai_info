...
微软AI助手Copilot在GitHub上修复.NET Runtime项目Bug时频频出错，引发程序员围观。该AI不仅未能正确修复代码，还反复提交错误修改，甚至自动重新打开已关闭的请求。开发者被迫手动干预，并像"带徒弟"一样向AI解释步骤。事件引发对AI可能影响生产环境稳定性的担忧，有程序员质疑"人类开发AI是为了提高效率，而非被反向驱使"。这一系列AI"整活"行为在GitHub评论区形成了独特的"吃瓜现场"。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T02:36:40Z
- **目录日期**: 2025-05-25
