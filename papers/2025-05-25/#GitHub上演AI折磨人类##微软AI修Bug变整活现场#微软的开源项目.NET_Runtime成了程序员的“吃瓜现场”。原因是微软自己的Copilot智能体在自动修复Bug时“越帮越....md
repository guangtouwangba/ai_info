...
微软AI助手Copilot在GitHub上引发争议。在.NET Runtime项目中，Copilot尝试修复Bug时多次出错，仅正确修改了PR标题，导致开发者被迫手动干预。类似情况频发：PR被自动恢复、错误修改等，AI不仅未能提升效率，反而增加开发者负担。程序员担忧此类AI可能影响系统稳定性，并质疑其实际价值。事件引发对AI辅助工具成熟度的讨论，开发者戏称这是在"被迫带徒弟"。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T06:03:56Z
- **目录日期**: 2025-05-25
