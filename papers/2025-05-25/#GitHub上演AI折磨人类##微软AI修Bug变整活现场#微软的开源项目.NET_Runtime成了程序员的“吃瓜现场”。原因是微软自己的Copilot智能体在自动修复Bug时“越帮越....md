...
微软Copilot AI在GitHub上的.NET Runtime项目中闹出笑话：试图修复Bug时频频出错，仅修改了PR标题却无法正确修复代码，导致开发者被迫手动关闭PR。其他微软员工也遭遇类似情况，AI不仅修复失败，还反复自动恢复PR、修改标题，像需要人类"带徒弟"。程序员们担忧这种AI可能影响生产环境稳定性，并吐槽"AI本应提高效率，现在却反向驱使人类"。该事件引发开发者社区围观，成为AI辅助开发的反面教材。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T05:03:52Z
- **目录日期**: 2025-05-25
