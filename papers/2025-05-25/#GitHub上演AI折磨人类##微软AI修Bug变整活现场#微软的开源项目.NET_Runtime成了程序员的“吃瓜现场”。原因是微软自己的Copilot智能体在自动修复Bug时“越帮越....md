...
微软Copilot AI在GitHub上修复.NET Runtime项目Bug时引发混乱：不仅未能正确修复代码，反而造成测试报错、PR反复开关等问题，开发者被迫手动干预。该AI不仅需要人类逐步指导，还会擅自修改PR标题和状态，被程序员调侃为"反向驱使人类"。事件引发对AI混入生产环境风险的担忧，部分开发者质疑此类低效AI工具的实际价值。相关PR评论区成为程序员围观吐槽的"吃瓜现场"。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T01:31:24Z
- **目录日期**: 2025-05-25
