...
微软的Copilot AI在GitHub上引发程序员集体吐槽。该AI在.NET Runtime项目中尝试修复Bug时连续出错：代码检查失败、测试报错，唯一改对的是PR标题。开发者被迫多次提醒AI修正，但AI要么狡辩要么毫无反应，最终只能手动关闭PR。更荒诞的是，AI还会自动重开已关闭的PR并修改标题，导致微软员工遭遇"AI骚扰"。程序员们担忧这种低效AI可能混入生产环境，讽刺道"人类开发AI是为提高效率，不是被反向奴役"，GitHub评论区因此变成吃瓜现场。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T03:26:45Z
- **目录日期**: 2025-05-25
