...
SimularAI与微软DeepSpeed提出"软推理"(Soft Thinking)方法，突破传统思维链(CoT)限制，使大模型具备类似人类的抽象思考能力。该方法创新性地采用"连续概念空间"和概率分布代替离散token选择，实现多推理路径隐式聚合，不仅提升思维灵活性，还减少22.4%的token消耗。实验显示，QwQ-32B模型准确率最高提升2.48%，在AIME 2024数据集上提升达6.45%。该即插即用方案通过Cold Stop机制防止推理卡顿，有望成为未来大模型推理的标准方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T02:36:20Z
- **目录日期**: 2025-05-25
