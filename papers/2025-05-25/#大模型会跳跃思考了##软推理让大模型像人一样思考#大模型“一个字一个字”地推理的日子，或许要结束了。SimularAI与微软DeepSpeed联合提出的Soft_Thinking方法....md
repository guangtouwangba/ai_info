...
SimularAI与微软DeepSpeed联合提出"软推理"(Soft Thinking)方法，突破传统思维链(CoT)的局限性。该方法创新性地引入"连续概念空间"和"概念token"，用概率分布代替单一token选择，实现多条推理路径的隐式聚合。相比传统方法，软推理更接近人类抽象思维，能同时保留多种解题思路，使模型token使用量减少22.4%，在QwQ-32B模型上准确率最高提升2.48%，AIME 2024数据集上提升6.45%。该技术还包含Cold Stop机制防止模型"卡壳"，未来或将成为大模型推理的标准方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T13:10:14Z
- **目录日期**: 2025-05-25
