...
该研究推出了首个针对阿拉伯语的多模态推理基准测试ARB，涵盖视觉推理、文档理解、OCR等11个领域，包含1,356个多模态样本和5,119个人工标注的推理步骤。评估12个先进大模型后发现，在连贯性、忠实度和文化理解方面仍存在挑战。ARB为评估非主流语言的多模态推理提供了结构化框架，推动更具包容性、透明性和文化意识的AI系统发展。相关代码、基准和评估工具已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T22:00:57Z
- **目录日期**: 2025-05-25
