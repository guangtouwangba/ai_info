...
阿拉伯多模态推理基准（ARB）是首个评估阿拉伯语多模态逐步推理能力的基准，涵盖视觉推理、文档理解、OCR、科学分析和文化解读等11个领域，包含1,356个多模态样本和5,119个人工标注的推理步骤。该研究评估了12个先进的开源和闭源大模型，发现其在连贯性、忠实度和文化适应性方面仍存在挑战。ARB为研究非主流语言的多模态推理提供了结构化框架，推动更具包容性、透明性和文化敏感性的AI系统发展。相关代码、基准和评估工具已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T05:00:53Z
- **目录日期**: 2025-05-25
