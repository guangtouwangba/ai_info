...
阿拉伯多模态推理基准(ARB)是首个针对阿拉伯语多模态逐步推理能力的评估基准，涵盖视觉推理、文档理解、OCR等11个领域，包含1,356个多模态样本和5,119个人工标注的推理步骤。该研究评估了12个先进的开源和闭源大模型，发现这些模型在连贯性、忠实度和文化适应性方面仍存在挑战。ARB为评估非主流语言的多模态推理提供了结构化框架，推动了更具包容性、透明度和文化意识的AI系统发展。相关代码、评估标准及工具已开源，以支持未来研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T08:01:03Z
- **目录日期**: 2025-05-25
