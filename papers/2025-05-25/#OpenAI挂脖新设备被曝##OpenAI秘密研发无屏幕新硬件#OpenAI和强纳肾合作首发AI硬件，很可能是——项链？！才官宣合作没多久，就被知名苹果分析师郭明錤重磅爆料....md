...
OpenAI与设计师Jony Ive合作研发无屏幕AI可穿戴设备，据爆料为脖挂式项链形态，尺寸略大于Humane AI Pin，类似iPod Shuffle。设备配备麦克风和摄像头，支持语音控制与环境分析，预计2027年量产。目标是通过无缝AI交互减少对屏幕的依赖，可能成为继iPhone后的第三大核心设备。原型机已由OpenAI CEO奥特曼体验，最终设计或仍有调整。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T01:31:15Z
- **目录日期**: 2025-05-25
