...
OpenAI与设计师Jony Ive合作研发无屏幕AI可穿戴设备，据分析师郭明錤爆料，该设备为脖挂式设计，外形类似iPod Shuffle但略大于AI Pin，配备麦克风和摄像头，支持语音交互与环境感知。预计2027年量产，目标是通过AI集成减少对屏幕的依赖，可能成为继iPhone、Mac后的第三大核心设备。原型机已由OpenAI CEO奥特曼体验，最终设计或仍有调整。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T03:26:35Z
- **目录日期**: 2025-05-25
