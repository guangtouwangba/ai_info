...
OpenAI与设计师Jony Ive合作研发无屏幕AI可穿戴设备，据分析师郭明錤爆料，该设备为挂脖式设计，尺寸略大于Humane AI Pin，类似iPod Shuffle。配备麦克风和摄像头，支持语音控制与环境分析，预计2027年量产。目标是通过AI集成突破屏幕限制，可能成为继iPhone后的核心交互设备。原型机已由OpenAI CEO奥特曼体验，组装或选址越南。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T02:36:30Z
- **目录日期**: 2025-05-25
