...
OpenAI与强纳肾合作研发新型AI可穿戴设备，据爆料可能是一款无屏幕的挂脖式项链设备。该设备比Humane AI Pin略大，外形类似iPod Shuffle，配备麦克风和摄像头，支持语音控制与环境分析。预计2027年量产，可能由越南工厂组装。OpenAI希望该产品能突破屏幕限制，通过AI集成重新定义计算方式，成为继MacBook和iPhone后的第三大核心设备。原型机已由奥特曼体验，最终设计可能仍有变动。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T06:03:47Z
- **目录日期**: 2025-05-25
