...
OpenAI与强纳肾合作研发无屏幕AI可穿戴设备，据爆料为挂脖式项链设计。该设备比Humane AI Pin稍大，外形类似iPod Shuffle，配备麦克风和摄像头，支持语音控制与环境分析。预计2027年量产，可能在越南组装。OpenAI CEO奥特曼已体验原型机，目标是通过无缝AI交互减少对屏幕的依赖，或将成为继iPhone、MacBook后的第三大核心设备。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T00:03:42Z
- **目录日期**: 2025-05-25
