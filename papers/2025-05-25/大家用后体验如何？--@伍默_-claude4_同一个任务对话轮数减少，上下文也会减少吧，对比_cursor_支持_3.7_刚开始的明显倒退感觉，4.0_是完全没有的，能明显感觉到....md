...
用户对Claude-4的使用体验存在分歧。部分用户（如@伍默_）认为Claude-4在任务对话轮数和上下文处理上比3.7版本更可靠；而@karminski-牙医的测试显示，Claude-4的长上下文召回能力明显下降，可能影响实际工程应用效果。目前尚未有大规模使用的反馈证实其优劣。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T17:03:47Z
- **目录日期**: 2025-05-25
