...
用户对Claude-4的体验评价呈现两极分化：部分用户（如@伍默_）认为4.0版本在任务对话效率和可靠性上明显优于3.7，尤其在代码编辑场景中表现更稳定；而测试数据显示其长上下文召回能力较3.7显著下降，@karminski-牙医指出这可能影响复杂工程项目的实际应用效果。目前尚未形成统一结论，需更多实际使用反馈验证新版本在具体场景中的优劣。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T19:04:01Z
- **目录日期**: 2025-05-25
