...
用户对Claude-4的体验评价呈现两极分化。部分用户（如@伍默_）认为4.0版本在任务对话效率和可靠性方面有明显提升，优于3.7版本；而测试显示其长上下文召回能力显著下降，可能影响实际工程应用效果。开发者@karminski-牙医指出，这一缺陷可能导致在处理复杂项目时代码修改效果反而不及3.7版本。目前尚未形成统一结论，建议使用者根据具体应用场景（对话效率优先或上下文理解优先）选择版本。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T02:35:59Z
- **目录日期**: 2025-05-25
