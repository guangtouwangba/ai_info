...
用户对Claude-4的评价存在分歧：部分用户（如@伍默_）认为4.0版本在任务对话效率和可靠性上明显优于3.7，尤其在代码编写场景中表现更稳定；而测试显示其长上下文召回能力较3.7显著下降，可能影响复杂工程项目的实际应用效果。开发者@karminski-牙医指出，这对需要深度上下文理解的现实项目修改可能造成负面影响。目前尚未形成统一结论，需更多实际使用反馈验证。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T12:04:10Z
- **目录日期**: 2025-05-25
