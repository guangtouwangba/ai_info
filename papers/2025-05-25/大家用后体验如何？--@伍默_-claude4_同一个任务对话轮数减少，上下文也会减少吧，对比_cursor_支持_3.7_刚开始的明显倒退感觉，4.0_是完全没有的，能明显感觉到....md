...
用户对Claude-4的评价呈现两极分化：部分用户（如@伍默_）认为4.0版本在任务对话效率和可靠性上明显优于3.7，特别是在代码编写场景中表现更稳定；而测试数据显示其长上下文召回能力较3.7显著下降，这可能影响复杂工程项目的实际应用效果。目前尚未形成统一结论，建议使用者根据具体场景需求选择版本，工程类项目需谨慎评估长上下文依赖问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T09:04:02Z
- **目录日期**: 2025-05-25
