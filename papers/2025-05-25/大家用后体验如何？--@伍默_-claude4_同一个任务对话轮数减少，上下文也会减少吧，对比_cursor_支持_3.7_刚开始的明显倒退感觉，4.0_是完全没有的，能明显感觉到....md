...
用户对Claude-4的评价呈现两极分化：部分用户（如@伍默_）认为4.0版本在代码任务中对话轮次减少且响应更可靠；但测试显示其长上下文召回能力较3.7版本明显下降，可能影响实际工程应用效果。开发者@karminski-牙医指出，这对需要复杂上下文理解的现实项目修改尤为关键，质疑4.0在工程场景中的实用性。目前尚未形成统一结论，期待更多实际使用反馈。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T06:03:14Z
- **目录日期**: 2025-05-25
