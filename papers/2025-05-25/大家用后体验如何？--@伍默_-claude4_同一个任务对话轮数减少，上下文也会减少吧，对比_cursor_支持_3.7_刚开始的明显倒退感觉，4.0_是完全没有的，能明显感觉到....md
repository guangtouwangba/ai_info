...
用户对Claude-4的评价呈现两极分化：部分用户（如@伍默_）认为其任务处理效率提升，对话轮数减少但可靠性增强；而@karminski-牙医的测试显示其长上下文召回能力较3.7版本明显下降，可能影响复杂工程场景的应用效果。当前争议焦点在于版本迭代是否在特定场景（如代码修改）存在性能倒退，实际体验差异可能取决于具体使用场景。建议用户根据自身需求（效率优先或上下文依赖）选择版本。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T22:04:08Z
- **目录日期**: 2025-05-25
