...
关于Claude-4的用户体验反馈呈现两极分化：部分用户（如@伍默_）认为4.0版本在代码任务中的对话效率和可靠性明显优于3.7，未出现早期版本的性能倒退；而@karminski-牙医的测试显示其长上下文召回能力显著下降，这对需要处理复杂工程项目的开发者可能造成实际影响。当前讨论聚焦于版本迭代是否在提升响应速度的同时牺牲了核心的上下文处理能力，建议使用者根据具体场景需求选择版本。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T05:03:12Z
- **目录日期**: 2025-05-25
