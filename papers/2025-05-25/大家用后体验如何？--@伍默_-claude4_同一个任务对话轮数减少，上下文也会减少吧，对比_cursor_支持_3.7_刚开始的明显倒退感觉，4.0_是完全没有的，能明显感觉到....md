...
用户对Claude-4的使用体验存在分歧。部分用户（如@伍默_）认为Claude-4在任务对话轮数和上下文方面表现更可靠，优于早期版本的Claude-3.7。然而，测试显示Claude-4的长上下文召回能力明显下降，可能影响实际工程应用效果。这引发了关于Claude-4是否真的优于Claude-3.7的讨论，尤其是对于需要处理复杂代码和现实世界项目的用户而言。目前尚未有大规模使用的明确反馈。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T16:04:09Z
- **目录日期**: 2025-05-25
