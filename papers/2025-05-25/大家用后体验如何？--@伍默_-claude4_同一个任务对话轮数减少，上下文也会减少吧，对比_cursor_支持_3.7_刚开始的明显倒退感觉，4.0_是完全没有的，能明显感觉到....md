...
用户对Claude-4的评价呈现两极分化：部分用户（如@伍默_）认为其任务处理效率提升，对话轮数减少但可靠性增强；而测试显示其长上下文召回能力较Claude-3.7明显下降，可能影响代码工程等复杂场景的实用性。开发者@karminski-牙医指出该缺陷或导致实际工程应用效果倒退，呼吁已使用者分享体验。当前版本在基础任务优化与复杂场景性能之间存在权衡。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T00:03:13Z
- **目录日期**: 2025-05-25
