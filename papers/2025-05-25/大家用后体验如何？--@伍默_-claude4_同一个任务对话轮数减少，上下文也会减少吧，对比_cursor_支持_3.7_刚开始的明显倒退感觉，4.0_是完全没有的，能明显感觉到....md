...
关于Claude-4的用户体验存在两种不同反馈：一方面有用户认为其对话效率提升（@伍默_），任务轮数减少且可靠性增强；另一方面测试显示其长上下文召回能力较3.7版本明显下降（@karminski-牙医），可能影响复杂工程应用效果。目前尚未形成统一结论，实际体验可能因使用场景而异。核心矛盾点在于模型在对话效率与长文本处理能力之间的权衡表现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T11:04:01Z
- **目录日期**: 2025-05-25
