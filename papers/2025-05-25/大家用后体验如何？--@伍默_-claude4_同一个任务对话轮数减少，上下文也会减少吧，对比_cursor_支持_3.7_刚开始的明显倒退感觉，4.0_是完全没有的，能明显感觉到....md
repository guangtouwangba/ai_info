...
用户对Claude-4的评价呈现两极分化：部分用户（如@伍默_）认为其任务处理效率提升，对话轮次减少但可靠性增强，尤其在代码编辑场景表现优于3.7版本；而测试数据显示其长上下文召回能力显著下降，@karminski-牙医指出这可能影响复杂工程项目的实际应用效果。整体来看，Claude-4在基础任务响应速度上获得认可，但处理需要深度上下文维持的场景时可能存在性能倒退。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T20:04:07Z
- **目录日期**: 2025-05-25
