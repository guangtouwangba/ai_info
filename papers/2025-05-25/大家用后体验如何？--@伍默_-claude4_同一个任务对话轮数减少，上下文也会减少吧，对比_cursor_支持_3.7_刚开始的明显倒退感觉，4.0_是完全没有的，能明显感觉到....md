# 大家用后体验如何？//@伍默_:claude4 同一个任务对话轮数减少，上下文也会减少吧，对比 cursor 支持 3.7 刚开始的明显倒退感觉，4.0 是完全没有的，能明显感觉到...
...
用户对Claude-4的评价呈现两极分化：部分用户（如@伍默_）认为其任务处理效率提升，对话轮次减少但可靠性增强；而测试显示其长上下文召回能力较Claude-3.7明显下降，可能影响代码工程等复杂场景的应用效果。开发者@karminski-牙医指出，这种性能差异可能导致Claude-4在实际项目中的表现反而不如旧版，引发社区对版本升级实用性的讨论。当前用户反馈显示，新版本在基础任务中更稳定，但在需要深度上下文理解的任务中存在局限。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T10:04:00Z
- **目录日期**: 2025-05-25
