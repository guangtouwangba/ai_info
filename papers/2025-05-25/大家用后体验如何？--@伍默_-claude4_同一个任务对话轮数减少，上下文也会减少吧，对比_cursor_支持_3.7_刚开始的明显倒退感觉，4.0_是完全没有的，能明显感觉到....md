...
用户对Claude-4的评价呈现两极分化：部分用户（如@伍默_）认为其任务处理效率提升，对话轮数减少但可靠性增强，尤其在代码编辑场景表现优于旧版；而测试显示其长上下文召回能力较3.7版本明显下降，可能影响复杂工程应用效果。开发者@karminski-牙医指出这可能导致实际项目修改时性能倒退，呼吁使用者分享实测体验。当前争议焦点集中在版本迭代是否以牺牲上下文理解为代价换取响应速度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T21:04:09Z
- **目录日期**: 2025-05-25
