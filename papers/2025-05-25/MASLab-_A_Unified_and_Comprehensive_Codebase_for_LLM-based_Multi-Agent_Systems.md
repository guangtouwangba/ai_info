...
研究人员开发了MASLab，一个统一、全面的代码库，旨在解决基于LLM的多智能体系统(MAS)领域缺乏标准化工具的问题。MASLab整合了20多种跨领域方法，并经过严格验证；提供统一环境与多种基准测试，确保公平比较；采用共享精简结构，降低理解与扩展门槛。团队基于MASLab进行了广泛实验，覆盖10多个基准和8种模型，为研究者提供清晰全面的MAS方法现状概览。该平台将持续更新，追踪领域最新进展，并欢迎开源社区贡献。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T04:05:34Z
- **目录日期**: 2025-05-25
