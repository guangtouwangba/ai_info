...
研究人员开发了MASLab，这是一个统一、全面且便于研究的代码库，旨在解决基于大语言模型（LLM）的多智能体系统（MAS）领域缺乏统一平台的问题。MASLab整合了20多种跨领域已验证的方法，提供统一环境和多种基准测试以确保公平比较，并通过共享的简化结构降低理解和扩展门槛。该平台还进行了涵盖10多个基准和8种模型的广泛实验，为研究者提供清晰的MAS方法现状概览。MASLab将持续更新，跟踪领域最新进展，并欢迎开源社区贡献。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T10:01:36Z
- **目录日期**: 2025-05-25
