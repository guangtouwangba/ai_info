...
研究人员开发了MASLab，一个统一、全面的代码库，用于基于大语言模型(LLM)的多智能体系统(MAS)研究。MASLab整合了20多种跨领域方法，经严格验证；提供统一环境与多种基准测试，确保公平比较；采用共享精简结构，降低理解与扩展门槛。通过10多个基准测试和8种模型的广泛实验，MASLab为研究者提供了当前MAS方法的清晰概览。该代码库将持续更新，跟踪领域最新进展，并欢迎开源社区贡献。MASLab解决了现有研究中代码分散、重复实现、比较不公和入门门槛高等问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T01:29:26Z
- **目录日期**: 2025-05-25
