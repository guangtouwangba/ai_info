...
研究人员开发了MASLab，一个统一、全面的代码库，用于基于大语言模型(LLM)的多智能体系统(MAS)。MASLab整合了20多种跨领域方法，经过严格验证，并提供统一环境和多种基准测试以确保公平比较。其共享结构降低了理解和扩展门槛。通过10多个基准和8个模型的广泛实验，MASLab为研究者提供了清晰的MAS方法现状概览。该代码库将持续更新，跟踪领域最新进展，并欢迎开源社区贡献。MASLab解决了现有研究中方法分散、重复实现和评估标准不一的问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T16:01:57Z
- **目录日期**: 2025-05-25
