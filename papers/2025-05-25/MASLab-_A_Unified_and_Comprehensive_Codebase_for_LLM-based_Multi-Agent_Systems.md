...
MASLab是一个统一的、全面的、研究友好的代码库，旨在解决基于LLM的多智能体系统（MAS）领域缺乏统一平台的问题。它整合了20多种跨领域已验证的方法，提供统一环境和多样化基准以实现公平比较，并采用共享的简化结构降低理解和扩展门槛。通过覆盖10多个基准和8种模型的广泛实验，MASLab为研究者提供了当前MAS方法的全面概览。该平台将持续更新，跟踪领域最新进展，并欢迎开源社区贡献。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T00:01:51Z
- **目录日期**: 2025-05-25
