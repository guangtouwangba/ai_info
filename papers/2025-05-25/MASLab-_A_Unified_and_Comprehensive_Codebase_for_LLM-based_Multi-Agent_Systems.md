...
MASLab是一个统一、全面的多智能体系统（MAS）代码库，旨在解决现有研究中代码分散、重复实现和评估标准不统一的问题。它整合了20多种成熟方法，经过严格验证，并提供统一的环境与多种基准测试，确保公平比较。MASLab采用模块化设计，降低理解与扩展门槛，并基于10多个基准和8种模型进行了广泛实验，为研究者提供清晰的MAS方法现状概览。该平台将持续更新，跟踪领域最新进展，并欢迎开源社区贡献。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T13:07:32Z
- **目录日期**: 2025-05-25
