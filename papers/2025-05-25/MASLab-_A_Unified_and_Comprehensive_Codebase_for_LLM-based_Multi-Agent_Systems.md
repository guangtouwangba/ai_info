...
研究人员开发了MASLab，这是一个统一、全面且易于研究的代码库，用于基于大语言模型（LLM）的多智能体系统（MAS）。MASLab整合了20多种跨领域已验证的方法，提供了统一的环境和多种基准测试，确保公平比较。其共享的简化结构降低了理解和扩展的门槛。通过覆盖10多个基准测试和8种模型的广泛实验，MASLab为研究者提供了清晰的MAS方法现状概览。该代码库将持续更新，跟踪领域最新进展，并欢迎开源社区的贡献。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T03:24:32Z
- **目录日期**: 2025-05-25
