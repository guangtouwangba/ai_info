...
研究人员推出了MASLab，一个统一、全面且易于研究的代码库，旨在解决基于LLM的多智能体系统（MAS）领域缺乏统一平台的问题。MASLab整合了20多种跨领域方法，并经过严格验证，确保与官方实现一致。它提供统一环境和多种基准测试，支持公平比较，同时采用共享的简化结构，降低理解和扩展门槛。通过涵盖10多个基准和8种模型的广泛实验，MASLab为研究者提供了清晰的MAS方法现状概览。该平台将持续更新，跟踪最新进展，并欢迎开源社区贡献。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T17:01:34Z
- **目录日期**: 2025-05-25
