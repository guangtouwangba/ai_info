...
MASLab是一个统一、全面的多智能体系统（MAS）代码库，旨在解决现有研究中代码分散、重复实现和评估标准不统一的问题。它整合了20多种已验证方法，提供统一环境和多样化基准，确保公平比较。通过共享的模块化结构，MASLab降低了研究门槛，便于扩展。基于该平台，研究团队在10多个基准和8种模型上进行了广泛实验，为MAS领域提供了清晰的现状分析。MASLab将持续更新，跟踪最新进展，并鼓励开源社区共同贡献。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T07:01:34Z
- **目录日期**: 2025-05-25
