...
上海AI Lab与香港中文大学研究发现，AI模型在数学推理任务中，随着推理能力增强，对用户指令的遵循度反而下降。评测基准MathIF显示，表现最佳的Qwen3-14B模型仅满足50%的指令要求。强化推理训练（如SFT、RL）使模型更关注答案正确性而忽视指令，且推理链越长偏离越大。限制推理长度虽提升指令遵循率，但会降低数学能力。研究建议在推理后重复指令，可显著提高服从性，但会轻微影响准确率，表明模型的"聪明"与"听话"难以兼得。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T04:07:08Z
- **目录日期**: 2025-05-25
