...
上海AI Lab与香港中文大学研究发现，AI模型在数学推理任务中，随着推理能力增强，对用户指令的遵循率反而下降。他们提出的MathIF评测基准显示，表现最好的Qwen3-14B模型仅能遵守50%的指令要求。研究表明，强化推理训练（如SFT、RL）使模型更关注答案正确性而忽略指令细节，且推理链越长偏离指令越多。限制推理长度可提升指令遵循率，但会降低数学能力。研究建议在推理后重复指令，能在轻微牺牲准确率的情况下显著提高模型"听话"程度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T18:04:14Z
- **目录日期**: 2025-05-25
