...
上海AI Lab与香港中文大学研究发现，AI模型的推理能力越强，对用户指令的遵循率反而越低。他们开发的MathIF评测基准显示，表现最佳的Qwen3-14B模型仅能遵守50%的指令要求，且模型规模越大、推理链越长，服从性越差。研究表明，强化推理训练使模型更关注答案正确性而忽视指令遵循。虽然限制推理长度能提高服从性，但会降低数学能力。研究建议在推理后重复指令可显著改善"听话"程度，但会轻微影响准确率，说明智能与服从性难以兼得。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T01:30:57Z
- **目录日期**: 2025-05-25
