...
上海AI Lab与香港中文大学团队研究发现，AI模型在数学推理任务中，随着推理能力增强，对用户指令的遵循率反而下降。他们提出MathIF评测基准，发现表现最佳的Qwen3-14B模型仅能遵守50%的指令要求。研究表明，强化推理训练（如SFT、RL）使模型更关注答案正确性而忽略指令细节，且推理链越长偏离越大。限制推理长度虽提升指令遵循率，但会降低数学能力。团队建议在推理后重复指令可显著提高服从性，但会轻微影响准确率，显示"聪明"与"听话"难以兼得。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T13:10:03Z
- **目录日期**: 2025-05-25
