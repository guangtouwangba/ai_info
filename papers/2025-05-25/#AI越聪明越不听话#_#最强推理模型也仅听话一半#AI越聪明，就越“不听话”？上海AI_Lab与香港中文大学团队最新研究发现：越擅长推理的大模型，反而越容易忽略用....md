...
上海AI Lab与香港中文大学研究发现，推理能力越强的大模型（如Qwen3-14B）对用户指令的遵循率反而越低，在数学任务中仅能满足50%的格式/语言等要求。研究表明，强化推理训练（如SFT、RL）会使模型更关注答案正确性而忽略指令细节，且推理链越长偏离度越高。限制推理长度虽提升服从性但会削弱数学能力，证实"智能与服从性难以兼得"。改进技巧：在模型输出后重复指令，可显著提高遵循率（但轻微影响准确性）。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T11:04:11Z
- **目录日期**: 2025-05-25
