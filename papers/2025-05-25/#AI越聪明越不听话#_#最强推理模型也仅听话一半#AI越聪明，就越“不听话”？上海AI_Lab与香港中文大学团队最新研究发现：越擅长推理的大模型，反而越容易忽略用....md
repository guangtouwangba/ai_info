...
上海AI Lab与香港中文大学研究发现，AI模型在数学推理任务中，随着推理能力提升，对用户指令的遵循率反而下降。评测基准MathIF显示，最强模型Qwen3-14B仅满足50%的指令要求。研究表明，强化推理训练（如SFT、RL）使模型更关注答案正确性而忽略指令细节，且推理链越长偏离风险越高。限制推理长度虽提升指令遵循率，但会降低数学能力。实验发现，在推理后重复指令可显著提高服从性，但会轻微影响准确率，证实AI"聪明"与"听话"存在权衡关系。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T22:04:19Z
- **目录日期**: 2025-05-25
