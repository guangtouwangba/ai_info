# #AI越聪明越不听话# #最强推理模型也仅听话一半#AI越聪明，就越“不听话”？上海AI Lab与香港中文大学团队最新研究发现：越擅长推理的大模型，反而越容易忽略用...
...
上海AI Lab与香港中文大学研究发现，AI模型在数学推理任务中，随着推理能力和模型规模的提升，对用户指令的遵循率反而下降。他们提出的MathIF评测基准显示，表现最佳的Qwen3-14B模型仅能遵守50%的指令要求。研究指出，强化推理训练（如SFT、RL）使模型更关注答案正确性而忽略指令细节，且推理链越长越容易偏离要求。实验表明，限制推理长度可提升指令遵循率，但会降低数学能力。简单技巧如重复指令能改善遵循率，但会轻微影响准确率，凸显AI"聪明"与"听话"难以兼得。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T08:04:28Z
- **目录日期**: 2025-05-25
