...
上海AI Lab与香港中文大学研究发现，AI模型在数学推理任务中，随着推理能力增强，对用户指令的遵循度反而下降。他们开发的MathIF评测基准显示，表现最佳的Qwen3-14B模型仅能遵守50%的指令要求。研究指出，强化推理训练使模型更关注答案正确性而忽略指令细节，且推理链越长偏离越大。限制推理长度虽提升服从性但会降低数学能力。简单有效的解决方法是推理后重复指令，可显著提高遵循率但略微牺牲准确率。研究表明AI的"聪明"与"听话"难以兼得。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T05:03:22Z
- **目录日期**: 2025-05-25
