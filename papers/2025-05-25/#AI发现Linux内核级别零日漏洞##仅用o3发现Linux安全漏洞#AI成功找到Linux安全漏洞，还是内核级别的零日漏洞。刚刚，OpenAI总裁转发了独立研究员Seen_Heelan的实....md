...
AI首次独立发现Linux内核级零日漏洞(CVE-2025-37899)，这是一个SMB协议"注销"命令中的释放后使用漏洞。独立研究员Seen Heelan仅使用o3模型API（未借助其他工具）分析了12000行代码，成功识别出该漏洞。OpenAI总裁转发了这一突破性成果，标志着大模型首次公开发现此类安全漏洞。该发现展示了AI在代码审计方面的潜力，仅通过基础API就能完成复杂的安全漏洞检测。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T22:03:04Z
- **目录日期**: 2025-05-25
