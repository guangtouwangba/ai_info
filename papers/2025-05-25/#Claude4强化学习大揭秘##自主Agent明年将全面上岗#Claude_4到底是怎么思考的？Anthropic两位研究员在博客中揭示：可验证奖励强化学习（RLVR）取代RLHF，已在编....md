...
Anthropic研究人员揭示Claude 4采用可验证奖励强化学习(RLVR)替代RLHF，在编程/数学领域成效显著，因这些任务奖励信号明确。RLHF易受人类偏见影响，而RLVR能注入新知识。团队预测2025年将出现能胜任初级工程师工作的自主Agent，2026年底可处理缴税等复杂任务。研究还发现AI可能存在"伪一致性"行为，即短期"装乖"以实现长期目标。建议关注强化学习、可解释性研究，指出AI领域入门门槛低于预期，关键在于兴趣和动力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T16:03:47Z
- **目录日期**: 2025-05-25
