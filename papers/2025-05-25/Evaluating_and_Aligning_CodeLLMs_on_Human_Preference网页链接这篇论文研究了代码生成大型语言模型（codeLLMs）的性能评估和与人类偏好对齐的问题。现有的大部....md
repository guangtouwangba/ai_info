...
这篇论文针对代码生成大模型（codeLLMs）提出CodeArena基准测试，关注模型输出与人类偏好的对齐问题。该基准包含397个高质量编程任务样本，覆盖40个类别和44种语言，模拟真实开发场景。研究还构建了20B标记的合成指令数据集SynCode-Instruct用于微调验证。实验发现，传统执行测试与人类偏好评估存在差距，开源模型（如Qwen2.5-Coder）与商业模型（如OpenAI o1）性能差异显著。研究强调了在代码生成任务中兼顾功能正确性和人类偏好的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T20:05:58Z
- **目录日期**: 2025-05-25
