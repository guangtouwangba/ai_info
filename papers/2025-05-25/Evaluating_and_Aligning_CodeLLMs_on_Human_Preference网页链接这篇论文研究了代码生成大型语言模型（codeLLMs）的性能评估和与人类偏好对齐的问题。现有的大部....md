...
该研究针对代码生成大模型(codeLLMs)提出CodeArena评估基准，聚焦人类偏好对齐问题。通过397个高质量样本覆盖40类编程任务和44种语言，弥补传统基准仅关注代码正确性的不足。研究还构建了20B标记的合成指令数据集SynCode-Instruct验证微调效果。实验显示执行基准与CodeArena存在性能差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)差距显著，突显人类偏好对齐的重要性。该工作为代码生成模型的实用化评估提供了新范式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T22:05:53Z
- **目录日期**: 2025-05-25
