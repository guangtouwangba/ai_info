...
这篇论文探讨了代码生成大型语言模型(codeLLMs)如何与人类偏好对齐的问题。研究者创建了CodeArena基准测试，包含397个高质量样本，覆盖40个类别和44种编程语言，模拟真实编程任务。同时开发了SynCode-Instruct语料库(近20B标记)验证合成指令微调效果。实验发现：1)传统执行基准与CodeArena存在性能差异；2)开源顶级模型(如Qwen2.5-Coder)与专有模型(如OpenAI o1)差距显著。研究强调了代码LLM与人类偏好对齐的重要性，为模型评估提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T10:06:08Z
- **目录日期**: 2025-05-25
