...
这篇论文针对代码生成大模型(codeLLMs)提出两个关键贡献：1) 创建CodeArena基准测试，包含397个涵盖40类编程任务和44种语言的人类偏好样本，弥补现有基准忽视人类偏好的不足；2) 构建20B标记量的SynCode-Instruct合成指令数据集验证微调效果。实验发现执行基准与人类偏好测试存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，凸显对齐人类偏好的重要性。研究强调了在代码生成评估中兼顾功能正确性和用户体验的必要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T03:28:52Z
- **目录日期**: 2025-05-25
