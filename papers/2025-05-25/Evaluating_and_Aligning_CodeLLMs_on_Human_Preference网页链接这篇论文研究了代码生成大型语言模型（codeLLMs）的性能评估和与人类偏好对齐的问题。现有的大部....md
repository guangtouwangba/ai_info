...
这篇论文针对代码生成大模型(codeLLMs)提出新评估方法，发现现有基准过于关注代码正确性而忽视人类偏好。研究者构建了CodeArena基准(包含397个高质量样本，覆盖40类任务和44种语言)和SynCode-Instruct指令集(近200亿标记)，用于评估模型与人类偏好的对齐程度。实验显示，传统基于执行的测试与CodeArena存在差异，且开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，凸显了人类偏好对齐的重要性。研究为代码生成模型的评估提供了新维度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T05:05:47Z
- **目录日期**: 2025-05-25
