...
AI系统在理解图像隐喻方面仍面临挑战，现有模型难以捕捉视觉内容中的文化、情感和上下文隐含意义。为此，研究者提出Let Androids Dream (LAD)框架，模拟人类认知过程，通过三阶段解决上下文缺失问题：感知（将视觉信息转为多层级文本表征）、搜索（整合跨领域知识消除歧义）和推理（生成上下文对齐的隐含意义）。LAD在轻量级GPT-4o-mini模型上实现了SOTA性能，在英文基准测试中超越15+多模态大模型，中文测试显著提升，MCQ任务媲美GPT-4o，OSQ任务领先36.7%。项目已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T10:01:03Z
- **目录日期**: 2025-05-25
