...
AI系统在理解图像隐喻方面仍面临挑战，现有模型难以捕捉视觉内容中的文化、情感和语境隐含意义。为解决这一问题，研究者提出了"Let Androids Dream (LAD)"框架，模仿人类认知过程，通过三阶段处理：感知(将视觉信息转化为多层次文本表示)、搜索(整合跨领域知识消除歧义)和推理(生成语境对齐的隐含意义)。实验表明，LAD在英汉图像隐喻基准测试中表现优异，轻量级GPT-4o-mini版本在多项选择题上与GPT-4o相当，开放式问题表现提升36.7%。该研究为提升AI视觉语言推理能力提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T06:01:06Z
- **目录日期**: 2025-05-25
