...
AI系统在理解图像隐喻方面仍面临挑战，现有模型难以捕捉视觉内容中的文化、情感和语境隐含意义。为此，研究团队提出Let Androids Dream (LAD)框架，通过三阶段认知过程（感知→搜索→推理）解决上下文缺失问题。LAD将视觉信息转化为多层级文本表征，整合跨领域知识进行显式推理。实验表明，轻量级GPT-4o-mini结合LAD在英汉图像隐喻基准测试中超越15+多模态大模型，在开放式问题上性能超过GPT-4o达36.7%。该研究为AI理解图像隐喻提供了新思路，推动了视觉-语言推理领域发展。项目已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T14:01:13Z
- **目录日期**: 2025-05-25
