...
AI系统在理解图像隐喻方面仍面临挑战，现有模型难以捕捉视觉内容中隐含的文化、情感和语境信息。为此，研究者提出了Let Androids Dream (LAD)框架，通过三阶段流程提升图像隐喻理解能力：(1)感知阶段将视觉信息转换为多层次文本表示，(2)搜索阶段整合跨领域知识消除歧义，(3)推理阶段生成符合语境的图像隐喻解释。实验表明，LAD在英汉图像隐喻基准测试中表现优异，轻量级GPT-4o-mini版本在多项选择题上与GPT-4o相当，开放式问题性能提升36.7%。该研究为AI视觉语言推理提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T09:01:13Z
- **目录日期**: 2025-05-25
