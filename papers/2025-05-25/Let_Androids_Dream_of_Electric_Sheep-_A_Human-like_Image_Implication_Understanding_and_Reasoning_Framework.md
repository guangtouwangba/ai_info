...
论文提出了一种名为"Let Androids Dream (LAD)"的新型框架，用于解决AI系统理解图像隐喻含义的挑战。该框架模仿人类认知过程，通过三阶段处理：感知（将视觉信息转化为多层级文本表示）、搜索（整合跨领域知识消除歧义）和推理（生成上下文对齐的图像含义）。实验表明，LAD框架配合轻量级GPT-4o-mini模型在英汉图像隐喻理解基准测试中表现优异，在多项选择题上与GPT-4o相当，在开放式问题上超出36.7%。该研究为提升AI视觉语言推理能力提供了新思路，相关项目已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T18:01:07Z
- **目录日期**: 2025-05-25
