...
AI系统在理解图像隐喻方面仍面临挑战，现有模型难以捕捉视觉内容中的文化、情感和上下文隐含意义。为此，研究团队提出了"Let Androids Dream (LAD)"框架，通过三阶段处理：感知（将视觉信息转换为多级文本表示）、搜索（整合跨领域知识消除歧义）和推理（生成上下文对齐的图像含义）。该框架结合轻量级GPT-4o-mini模型，在英文图像理解基准测试中超越15+多模态大模型，在中文测试中表现显著提升，在开放式问题上性能超过GPT-4o达36.7%。该研究为AI理解图像隐喻提供了新思路，推动了视觉-语言推理领域发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T11:01:12Z
- **目录日期**: 2025-05-25
