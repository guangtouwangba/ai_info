...
论文提出Let Androids Dream (LAD)框架，解决AI系统理解图像隐喻的挑战。现有模型难以捕捉视觉内容中的文化、情感和上下文隐含意义。LAD通过三阶段处理：感知（将视觉信息转为多层级文本表示）、搜索（整合跨领域知识消除歧义）和推理（生成上下文对齐的图像含义），显著提升性能。在英文和中文图像隐喻基准测试中，轻量级GPT-4o-mini模型表现优异，在选择题上与GPT-4o相当，开放式问题上超出36.7%。该研究为AI理解图像隐喻提供了新思路，推动视觉-语言推理和人机交互发展。项目已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T00:01:26Z
- **目录日期**: 2025-05-25
