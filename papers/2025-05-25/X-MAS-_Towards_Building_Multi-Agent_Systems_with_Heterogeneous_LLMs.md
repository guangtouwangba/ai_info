...
本文提出了一种基于异构大语言模型（LLM）的多智能体系统（X-MAS），突破了传统同构LLM系统的性能限制。研究团队开发了X-MAS-Bench测试平台，对27种LLM在5个领域（21个测试集）和5种功能进行了170万次评估，确定了各领域功能的最佳模型组合。实验表明，异构LLM系统无需结构改造即可显著提升性能：在纯聊天机器人场景中，MATH数据集性能提升8.4%；在混合聊天-推理场景中，AIME数据集性能提升高达47%。这为构建更强大的协作AI系统开辟了新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T10:01:26Z
- **目录日期**: 2025-05-25
