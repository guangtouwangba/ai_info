...
本文提出异构大语言模型驱动的多智能体系统(X-MAS)，通过整合不同LLM来突破单一模型限制。研究者开发了X-MAS-Bench测试平台，对27个LLM在5个领域21个测试集和5种功能进行了170万次评估，确定了最优模型组合。实验表明，从同构转向异构LLM驱动的MAS能显著提升系统性能：在纯聊天机器人场景中，MATH数据集上性能提升8.4%；在混合聊天-推理场景中，AIME数据集上性能提升达47%。这为构建可扩展的协作AI系统提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T04:05:25Z
- **目录日期**: 2025-05-25
