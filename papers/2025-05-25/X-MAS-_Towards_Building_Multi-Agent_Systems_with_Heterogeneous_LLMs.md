...
本文提出异构大语言模型驱动的多智能体系统(X-MAS)，通过整合不同LLM来突破单一模型限制。研究开发了X-MAS-Bench测试平台，对27个LLM在5个领域21个测试集和5种功能进行170万次评估，发现异构配置能显著提升系统性能：在纯聊天机器人场景中，MATH数据集上性能提升8.4%；在混合聊天-推理场景中，AIME数据集上性能提升47%。研究表明，无需重构系统架构，仅通过采用异构LLM组合即可大幅提升多智能体系统的集体智能，为可扩展协作AI系统发展提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T00:01:44Z
- **目录日期**: 2025-05-25
