...
该研究探讨了基于异构大语言模型(LLM)的多智能体系统(X-MAS)，突破了传统同构系统的局限。通过构建X-MAS-Bench测试平台，研究人员对27个LLM在5个领域(21个测试集)和5种功能进行了170万次评估，发现异构配置能显著提升系统性能：在纯聊天机器人场景中，MATH数据集性能提升8.4%；在混合聊天-推理场景中，AIME数据集性能提升达47%。研究表明，无需重构系统架构，仅通过采用异构LLM驱动就能充分发挥集体智能优势，为可扩展协作AI系统的发展提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T12:01:42Z
- **目录日期**: 2025-05-25
