...
本文提出异构大语言模型驱动的多智能体系统(X-MAS)，突破传统同构系统的局限。研究开发了X-MAS-Bench测试平台，对27个大模型在5个领域21个测试集和5项功能进行170万次评估，发现异构配置能显著提升系统性能。实验显示：纯聊天机器人场景下，异构系统在MATH数据集上性能提升8.4%；混合聊天-推理场景下，在AIME数据集上性能提升高达47%。研究表明，无需重构系统架构，仅通过采用异构大模型组合，就能有效提升多智能体系统的集体智能，为构建可扩展的协作AI系统开辟了新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T14:01:33Z
- **目录日期**: 2025-05-25
