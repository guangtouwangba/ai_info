...
本文提出了一种基于异构大语言模型（LLM）的多智能体系统（X-MAS），通过整合不同LLM驱动的智能体，突破单一模型限制，实现集体智能提升。研究开发了X-MAS-Bench测试平台，对27个LLM在5个领域21个测试集和5种功能进行超170万次评估，确定了各领域功能的最优模型组合。实验表明，异构系统无需结构调整即可显著提升性能：纯聊天机器人场景在MATH数据集上提升8.4%，混合推理场景在AIME数据集上提升47%。这为构建可扩展的协作AI系统提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T19:01:38Z
- **目录日期**: 2025-05-25
