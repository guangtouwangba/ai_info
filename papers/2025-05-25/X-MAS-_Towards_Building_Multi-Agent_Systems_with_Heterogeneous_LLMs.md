...
本文提出异构大语言模型驱动的多智能体系统(X-MAS)，突破传统同构系统的限制。研究开发了X-MAS-Bench测试平台，对27个大模型在5个领域21个测试集和5种功能进行170万次评估，发现异构配置能显著提升系统性能：在纯聊天机器人场景下，MATH数据集性能提升8.4%；在混合聊天-推理场景下，AIME数据集性能提升达47%。研究表明，无需重构系统架构，仅通过采用异构模型组合即可实现多智能体系统性能的显著提升，为构建更强大的协作AI系统开辟了新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T02:34:29Z
- **目录日期**: 2025-05-25
