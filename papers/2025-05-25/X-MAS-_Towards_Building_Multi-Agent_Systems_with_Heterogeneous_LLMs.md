...
该研究提出了一种基于异构大语言模型（LLM）的多智能体系统（X-MAS），突破了传统同构LLM系统的性能限制。通过构建X-MAS-Bench测试平台，研究人员对27个LLM在5个领域（涵盖21个测试集）和5种功能进行了超过170万次评估，确定了各领域-功能组合的最优模型选择。实验表明：在纯聊天机器人场景中，异构配置使MATH数据集性能提升8.4%；在混合聊天-推理场景中，AIME数据集性能提升达47%。这一发现为构建更强大的可扩展协作AI系统提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T22:01:25Z
- **目录日期**: 2025-05-25
