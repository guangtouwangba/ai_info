...
这篇论文探讨了基于异构大语言模型(LLM)的多智能体系统(X-MAS)，突破了传统单一LLM驱动系统的限制。研究者开发了X-MAS-Bench测试平台，对27个LLM在5个领域和5种功能上进行了170万次评估，发现采用不同LLM组合的异构系统能显著提升性能：在纯聊天机器人场景中，MATH数据集上性能提升8.4%；在混合聊天-推理场景中，AIME数据集上性能提升达47%。研究表明，无需重构系统架构，仅通过合理配置异构LLM组合即可显著增强多智能体系统的集体智能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T09:01:34Z
- **目录日期**: 2025-05-25
