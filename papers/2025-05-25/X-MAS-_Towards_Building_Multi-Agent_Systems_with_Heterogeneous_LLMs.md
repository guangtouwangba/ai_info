...
本文提出异构大语言模型驱动的多智能体系统(X-MAS)，突破传统同构系统的局限，通过整合不同大语言模型的优势提升整体性能。研究团队开发了X-MAS-Bench测试平台，对27个大语言模型在5个领域21个测试集和5种功能上进行了超过170万次评估，确定了各领域-功能组合的最佳模型选择。实验表明，异构系统无需结构改造即可显著提升性能：在纯聊天机器人场景中，MATH数据集上性能提升8.4%；在混合聊天-推理场景中，AIME数据集上性能提升达47%。这为构建更强大的协作AI系统开辟了新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T03:24:22Z
- **目录日期**: 2025-05-25
