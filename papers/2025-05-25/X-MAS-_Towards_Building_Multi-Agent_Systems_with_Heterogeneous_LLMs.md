...
这篇论文探讨了基于异构大语言模型(LLM)的多智能体系统(X-MAS)，突破了传统单一LLM驱动系统的限制。研究者开发了X-MAS-Bench测试平台，对27个LLM在5个领域21个测试集和5种功能上进行了170万次评估，发现异构LLM组合能显著提升系统性能。实验表明：在纯聊天机器人场景下，异构配置使MATH数据集性能提升8.4%；在混合聊天-推理场景中，AIME数据集性能提升达47%。研究证实了异构LLM在多智能体系统中的变革潜力，为发展可扩展的协作AI系统开辟了新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T11:01:33Z
- **目录日期**: 2025-05-25
