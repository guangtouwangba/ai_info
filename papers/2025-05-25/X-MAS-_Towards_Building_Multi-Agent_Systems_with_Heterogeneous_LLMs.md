...
该研究探讨了基于异构大语言模型（LLM）的多智能体系统（X-MAS），突破了传统单一LLM驱动系统的性能限制。通过开发X-MAS-Bench测试平台，研究人员对27个LLM在5个领域和5种功能上进行了170万次评估，发现异构LLM组合能显著提升系统表现。实验显示，在纯聊天机器人场景中异构配置使MATH数据集性能提升8.4%；在混合聊天-推理场景中AIME数据集性能提升达47%。研究表明，无需重构系统架构，仅通过采用异构LLM驱动即可有效提升多智能体系统的集体智能水平。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T01:29:16Z
- **目录日期**: 2025-05-25
