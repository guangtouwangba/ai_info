...
本文提出了一种基于异构大语言模型(LLM)的多智能体系统(X-MAS)，突破了传统单一LLM驱动的限制。研究者开发了X-MAS-Bench测试平台，对27个LLM在5个领域(21个测试集)和5种功能进行了170多万次评估，发现异构LLM组合能显著提升系统性能。实验显示，在纯聊天机器人场景中，异构配置在MATH数据集上性能提升8.4%；在混合聊天-推理场景中，AIME数据集上性能提升高达47%。研究表明，无需重构系统，仅通过采用异构LLM组合就能有效提升多智能体系统的集体智能水平。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T17:01:23Z
- **目录日期**: 2025-05-25
