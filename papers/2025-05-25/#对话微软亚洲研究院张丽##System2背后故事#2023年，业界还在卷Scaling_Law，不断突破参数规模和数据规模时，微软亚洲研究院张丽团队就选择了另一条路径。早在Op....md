# #对话微软亚洲研究院张丽##System2背后故事#2023年，业界还在卷Scaling Law，不断突破参数规模和数据规模时，微软亚洲研究院张丽团队就选择了另一条路径。早在Op...
...
2023年，当业界聚焦于Scaling Law时，微软亚洲研究院张丽团队另辟蹊径，率先探索大模型的深度推理能力。她将认知科学中的"System2"概念引入AI领域，近期通过蒙特卡洛搜索算法使7B模型达到o1级别的数学推理水平（rStar-Math成果）。作为LongRoPE和rStar系列项目负责人，张丽团队的工作为突破大模型智商上限提供了新思路，其基于算法优化的路径与主流的PPO/GRPO强化学习方法形成鲜明对比。这项研究展示了小参数模型实现复杂推理的可能性，为AI发展开辟了替代方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T19:03:08Z
- **目录日期**: 2025-05-25
