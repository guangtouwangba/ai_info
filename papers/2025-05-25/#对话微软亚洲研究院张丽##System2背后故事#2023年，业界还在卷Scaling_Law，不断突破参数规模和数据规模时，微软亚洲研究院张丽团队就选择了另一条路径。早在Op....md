...
微软亚洲研究院张丽团队在2023年选择了一条不同于主流Scaling Law的路径，率先将认知科学中的"System2"概念引入大模型领域，探索深度推理能力。其最新成果rStar-Math通过蒙特卡洛搜索算法，使7B参数模型达到与OpenAI o1相当的数学推理水平，为当前以PPO/GRPO为主的强化学习路线提供了新思路。作为系统研究组首席研究员，张丽还领导了微软LongRoPE等项目，其工作突破了大模型的智商上限，引发学界广泛讨论。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T08:03:12Z
- **目录日期**: 2025-05-25
