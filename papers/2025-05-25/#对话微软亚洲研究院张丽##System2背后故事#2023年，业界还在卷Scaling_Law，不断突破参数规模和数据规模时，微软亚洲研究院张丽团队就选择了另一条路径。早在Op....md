...
微软亚洲研究院张丽团队在2023年选择了一条不同于主流Scaling Law的路径，率先探索大模型的深度推理能力，并将认知科学中的"System2"概念引入AI领域。其最新成果rStar-Math通过蒙特卡洛搜索算法，使7B参数模型达到与OpenAI o1相当的数学推理水平。这一突破性工作为当前以PPO/GRPO为主的强化学习路线提供了新思路，引发学界广泛讨论。作为微软LongRoPE和rStar系列项目负责人，张丽的研究聚焦突破大模型智商上限，推动AI向更高级推理能力发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T14:03:04Z
- **目录日期**: 2025-05-25
