...
微软亚洲研究院张丽团队在2023年突破主流Scaling Law路线，率先探索大模型深度推理能力，将认知科学中的System2概念引入AI领域。其最新成果rStar-Math通过蒙特卡洛搜索算法，使7B小模型达到o1级别的数学推理能力，为当前PPO/GRPO主导的强化学习路线提供了新思路。作为LongRoPE和rStar系列项目负责人，张丽的研究聚焦突破大模型智商上限，相关成果引发学界广泛讨论。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T09:03:01Z
- **目录日期**: 2025-05-25
