...
微软亚洲研究院张丽团队在2023年突破行业对Scaling Law的追逐，率先探索大模型深度推理能力，将认知科学中的"System2"概念引入AI领域。其最新成果rStar-Math通过蒙特卡洛搜索算法，使7B参数模型达到o1级别的数学推理能力，为当前主流的PPO/GRPO强化学习路线提供了新思路。作为LongRoPE和rStar系列项目负责人，张丽的研究开辟了提升大模型智商上限的创新路径，相关成果引发学界广泛讨论。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T22:02:47Z
- **目录日期**: 2025-05-25
