...
微软亚洲研究院张丽团队另辟蹊径，在业界聚焦参数规模时率先探索大模型深度推理能力，将认知科学中的System2概念引入AI领域。其最新成果rStar-Math通过蒙特卡洛搜索算法，使7B小模型达到GPT-4o级别的数学推理水平，突破了当前强化学习主导的技术路线。这项创新为提升大模型"智商上限"提供了新思路，相关研究早于OpenAI的GPT-4o发布。张丽作为系统研究组首席研究员，还领导了LongRoPE等项目，其工作正在重新定义大模型的认知架构可能性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T12:03:15Z
- **目录日期**: 2025-05-25
