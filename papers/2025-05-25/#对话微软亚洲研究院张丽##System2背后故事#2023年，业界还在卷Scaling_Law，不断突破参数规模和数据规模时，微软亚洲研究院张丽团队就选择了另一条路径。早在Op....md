...
微软亚洲研究院张丽团队在2023年选择了一条不同于主流Scaling Law的路径，率先探索大模型的深度推理能力，并将认知科学中的"System2"概念引入该领域。其最新成果rStar-Math通过蒙特卡洛搜索算法，使7B参数模型达到o1级别的数学推理能力，为当前基于PPO/GRPO的强化学习路线提供了新思路。作为LongRoPE和rStar系列项目负责人，张丽的研究突破了大模型的智商上限，相关成果引发广泛讨论。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T15:03:11Z
- **目录日期**: 2025-05-25
