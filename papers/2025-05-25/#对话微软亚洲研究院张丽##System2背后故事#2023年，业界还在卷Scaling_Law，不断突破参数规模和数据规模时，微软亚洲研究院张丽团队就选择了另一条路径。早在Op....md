...
微软亚洲研究院张丽团队另辟蹊径，在业界聚焦参数规模时率先探索大模型深度推理能力。她们将认知科学中的System2概念引入AI领域，并通过蒙特卡洛搜索算法使7B小模型达到GPT-4级别的数学推理水平（rStar-Math）。这一突破性工作为当前主流的强化学习路线提供了新思路。作为LongRoPE和rStar系列项目负责人，张丽团队的研究推动了大模型"智商上限"的突破，其创新方法在学术界引发广泛讨论。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T11:03:03Z
- **目录日期**: 2025-05-25
