...
微软亚洲研究院张丽团队另辟蹊径，在业界聚焦参数规模时率先探索大模型深度推理能力。她们将认知科学中的"System2"概念引入AI领域，近期通过蒙特卡洛搜索算法使7B小模型达到GPT-4级别的数学推理水平（rStar-Math）。这一突破性工作挑战了当前主流的PPO/GRPO强化学习范式，为提升模型智商开辟了新路径。张丽作为系统研究组首席研究员，还领导了LongRoPE等项目，其创新思路正在重塑大模型发展方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T10:03:03Z
- **目录日期**: 2025-05-25
