...
微软亚洲研究院张丽团队在2023年突破主流Scaling Law路径，率先将认知科学中的"System2"概念引入大模型领域，探索深度推理能力。其最新成果rStar-Math通过蒙特卡洛搜索算法，使7B小模型达到o1级别的数学推理水平，为当前PPO/GRPO主导的强化学习路线提供了新思路。作为LongRoPE和rStar系列项目负责人，张丽的研究突破了大模型智商上限，相关技术细节和背后思考可通过量子位专访进一步了解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T21:02:42Z
- **目录日期**: 2025-05-25
