...
微软亚洲研究院张丽团队另辟蹊径，在2023年业界聚焦参数规模扩展时，率先探索大模型深度推理能力，将认知科学中的System2概念引入AI领域。其最新成果rStar-Math通过蒙特卡洛搜索算法，使7B小模型达到OpenAI o1级别的数学推理能力，突破了当前强化学习主导的技术路线。作为LongRoPE和rStar系列项目负责人，张丽的研究为大模型智商上限提升开辟了新方向。这项创新工作引发了学界对模型架构可能性的重新思考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T20:03:16Z
- **目录日期**: 2025-05-25
