...
微软亚洲研究院张丽团队另辟蹊径，在业界聚焦参数规模时率先探索大模型深度推理能力，将认知科学中的"System2"概念引入AI领域。其最新成果rStar-Math通过蒙特卡洛搜索算法，使7B小模型达到GPT-4级别的数学推理水平。这一突破性工作为当前主流的强化学习路线提供了新思路，展示了小模型实现复杂推理的可能性。作为LongRoPE和rStar系列项目负责人，张丽的研究正推动大模型突破智商上限，相关技术细节和背后思考已通过量子位专访公开。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T18:03:04Z
- **目录日期**: 2025-05-25
