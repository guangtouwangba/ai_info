...
这篇论文介绍了AgentSociety，一个基于大型语言模型(LLM)的大规模社会模拟器，能够模拟超过1万个代理及其500万次互动。研究者用它作为计算社会科学实验平台，研究了社会极化、信息传播、基本收入政策影响和自然灾害应对等四个关键社会问题。模拟结果与现实世界数据高度吻合，验证了该系统捕捉人类行为机制的能力。该平台展示了作为社会科学研究和政策制定辅助工具的潜力，能够补充传统研究方法如调查和访谈。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T11:05:27Z
- **目录日期**: 2025-05-25
