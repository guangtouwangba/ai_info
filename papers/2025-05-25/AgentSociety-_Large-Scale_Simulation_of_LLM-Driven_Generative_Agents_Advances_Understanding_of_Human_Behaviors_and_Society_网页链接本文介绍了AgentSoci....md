...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统模拟了超过1万个AI代理的社会互动（500万次），用于研究极化现象、信息传播、基本收入政策和自然灾害影响等社会问题。研究结果表明，模拟结果与现实世界数据高度吻合，验证了该系统在捕捉人类行为机制方面的有效性。AgentSociety为社会科学研究和政策制定提供了新工具，能够辅助传统研究方法，帮助理解社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T21:05:32Z
- **目录日期**: 2025-05-25
