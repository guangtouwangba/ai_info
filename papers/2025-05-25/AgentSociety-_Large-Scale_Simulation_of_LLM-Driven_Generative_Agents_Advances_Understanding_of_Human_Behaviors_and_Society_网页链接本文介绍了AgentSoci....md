...
该研究介绍了AgentSociety，这是一个基于大语言模型的大规模社会模拟系统，能够模拟1万多个代理及其500万次互动。研究者用它分析了四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实数据高度吻合，验证了该系统在捕捉人类行为机制方面的有效性。这一工具为社会科学研究和政策制定提供了新方法，有望成为传统研究手段的重要补充。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T17:05:16Z
- **目录日期**: 2025-05-25
