...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可以模拟1万多个AI代理及其500万次互动。研究者用它研究社会极化、信息传播、基本收入政策及自然灾害影响等社会问题。模拟结果与现实数据吻合，验证了该系统捕捉人类行为机制的能力。该工具有望成为社会科学研究和政策制定的重要工具，为传统研究方法提供补充。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T13:11:11Z
- **目录日期**: 2025-05-25
