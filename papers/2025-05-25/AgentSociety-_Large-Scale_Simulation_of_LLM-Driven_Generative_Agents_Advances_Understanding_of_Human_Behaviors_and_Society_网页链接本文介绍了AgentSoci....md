...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统，能够模拟1万多个智能代理及其500万次社会互动。研究者用它研究了四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，验证了该系统对人类行为和社会机制的捕捉能力。该系统可作为传统社会科学研究方法的补充工具，帮助研究者分析社会问题模式、成因和潜在机制，为政策制定提供新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T02:38:04Z
- **目录日期**: 2025-05-25
