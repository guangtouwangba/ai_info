...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟超过1万个代理的社会互动（500万次交互）。研究者用它研究了社会极化、信息传播、基本收入政策及飓风影响四个关键问题，结果与现实数据吻合。该系统结合LLM代理、真实环境与模拟引擎，能有效捕捉人类行为机制，为社会科学研究和政策制定提供新工具，补充传统调查和实验方法。实验验证了其模拟人类社会的可靠性，展现了在理解社会问题模式与机制方面的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T12:05:45Z
- **目录日期**: 2025-05-25
