...
Know-The-Ropes (KtR) 提出了一种解决单一大模型局限性的多智能体框架，通过将领域先验转化为分层算法蓝图，递归分解任务为类型化子任务，并采用轻量级增强技术（如思维链、微调等）解决。基于"没有免费午餐"定理，KtR放弃通用提示，转向结构化分解。实验显示：在背包问题(3-8项)中，3个GPT-4o-mini智能体将准确率从3%提升至95%；在任务分配问题(6-15项)中，6智能体系统在10项任务达到100%准确率。该方法证明算法感知分解结合定向增强可使小型模型成为可靠协作系统，无需持续扩大模型规模。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T03:25:07Z
- **目录日期**: 2025-05-25
