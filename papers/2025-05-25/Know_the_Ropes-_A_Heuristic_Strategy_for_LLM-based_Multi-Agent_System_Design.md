...
Know-The-Ropes (KtR) 提出了一种多智能体框架，通过将领域先验转化为分层算法蓝图，递归分解任务为类型化的子任务，结合轻量级增强技术（如思维链、微调等），解决单一大模型面临的有限上下文、角色过载和领域迁移脆弱性问题。实验显示，在背包问题（3-8项）中，3个GPT-4o-mini智能体将准确率从零样本的3%提升至95%；在任务分配问题（6-15项）中，6智能体系统在10项规模达到100%准确率。该方法证明算法感知分解结合定向增强可使中小模型实现可靠协作，无需依赖超大单体模型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T02:35:08Z
- **目录日期**: 2025-05-25
