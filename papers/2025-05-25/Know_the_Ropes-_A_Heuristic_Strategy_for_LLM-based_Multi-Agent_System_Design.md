...
Know-The-Ropes (KtR) 提出了一种多智能体框架，通过将领域先验转化为层次化算法蓝图，递归分解任务为类型化的子任务，由控制器协调解决。该方法避免了传统多智能体系统的分解模糊和验证开销问题，结合轻量级增强技术（如思维链、微调等）。实验显示：在背包问题（3-8项）中，3个GPT-4o-mini智能体将准确率从零样本的3%提升至95%；在更复杂的任务分配问题（6-15项）中，6智能体系统对10项任务达到100%准确率，13-15项达84%（零样本仅11%）。该方法证明算法感知分解能有效提升小模型性能，无需依赖超大单体模型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T14:02:18Z
- **目录日期**: 2025-05-25
