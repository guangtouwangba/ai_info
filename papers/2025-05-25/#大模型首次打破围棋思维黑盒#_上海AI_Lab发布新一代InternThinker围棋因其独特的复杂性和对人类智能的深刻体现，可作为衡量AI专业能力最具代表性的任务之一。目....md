...
上海AI Lab发布新一代InternThinker大模型，首次实现围棋AI透明化思维链。该模型通过"加速训练营"技术提升专业推理能力，成为中国首个兼具职业围棋水平和可解释性的大模型。其突破性在于能够用自然语言解释决策过程，包括应对李世石"神之一手"等复杂局面。该成果解决了传统围棋AI"黑盒"问题，为AI推理可解释性研究提供新方向。模型已开放公测和开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T05:04:10Z
- **目录日期**: 2025-05-25
