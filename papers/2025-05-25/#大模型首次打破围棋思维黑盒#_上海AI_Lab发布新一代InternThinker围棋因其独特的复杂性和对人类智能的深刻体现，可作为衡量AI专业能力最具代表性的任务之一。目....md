...
上海AI Lab发布新一代InternThinker大模型，首次实现围棋专业水平与透明思维链的双重突破。该模型通过"加速训练营"(InternBootcamp)技术创新，不仅能达到职业围棋水平，还能用人类语言解释推理过程，破解了传统AI围棋的"黑盒"难题。测试显示，它可正确应对李世石著名的"神之一手"，标志着大模型在复杂策略游戏中的可解释性取得重要进展。项目已开放公测和开源代码。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T03:27:03Z
- **目录日期**: 2025-05-25
