...
上海AI Lab发布新一代InternThinker大模型，首次实现围棋AI的透明思维链展示。该模型通过"加速训练营"技术提升专业推理能力，既达到职业围棋水平，又能用自然语言解释决策过程，包括应对李世石著名的"神之一手"。这打破了传统围棋AI的"黑盒"困境，标志着AI在复杂策略游戏中可解释性的重大突破。模型已开放公测和开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T01:31:39Z
- **目录日期**: 2025-05-25
