...
上海AI Lab发布新一代InternThinker大模型，首次实现围棋专业水平与透明思维链的双重突破。该模型通过"加速训练营"技术显著提升推理能力，不仅能应对李世石著名的"神之一手"，还能用自然语言解释决策过程，打破传统AI围棋的"黑盒"困境。作为中国首个兼具专业棋力和可解释性的大模型，InternThinker标志着AI在复杂策略游戏领域取得重要进展。项目已开放公测和开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T00:04:13Z
- **目录日期**: 2025-05-25
