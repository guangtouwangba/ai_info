...
上海AI Lab发布新一代书生·思客（InternThinker），成为首个兼具围棋专业水平和透明思维链的大模型。通过"加速训练营"（InternBootcamp）等技术创新，该模型不仅能达到围棋专业水准，还能用自然语言解释推理过程，突破传统AI的"黑盒"困境。测试中，InternThinker成功应对了李世石的"神之一手"，展示了其专业推理能力。该模型已开放公测和开源，标志着AI在可解释性方面的重要进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T04:07:52Z
- **目录日期**: 2025-05-25
