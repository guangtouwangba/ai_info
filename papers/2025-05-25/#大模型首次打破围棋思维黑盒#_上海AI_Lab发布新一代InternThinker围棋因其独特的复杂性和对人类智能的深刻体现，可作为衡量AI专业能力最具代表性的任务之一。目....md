...
上海AI Lab发布新一代InternThinker大模型，首次实现围棋专业水平与透明思维链的结合。该模型通过"加速训练营"等技术突破，不仅能达到专业围棋水平，还能用自然语言解释推理过程，包括应对李世石"神之一手"的决策分析。这打破了传统AI围棋"黑盒"模式，是我国首个兼具专业棋力和可解释性的大模型。公测和开源已同步推出。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-25T02:36:55Z
- **目录日期**: 2025-05-25
