...
这篇论文针对代码生成大模型(codeLLMs)与人类偏好对齐的问题，提出了CodeArena基准测试(包含397个样本，覆盖40类任务和44种语言)和SynCode-Instruct合成指令数据集(20B标记)。研究发现：1)传统执行基准与人类偏好存在差异；2)开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究强调了大模型在代码生成任务中与人类偏好对齐的重要性，并通过大规模实验验证了合成指令微调的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T02:32:56Z
- **目录日期**: 2025-05-10
