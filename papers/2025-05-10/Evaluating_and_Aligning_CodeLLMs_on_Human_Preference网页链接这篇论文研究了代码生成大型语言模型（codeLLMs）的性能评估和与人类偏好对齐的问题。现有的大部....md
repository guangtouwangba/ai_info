...
这篇论文针对代码生成大模型(codeLLMs)提出了CodeArena基准测试，聚焦人类偏好对齐问题。研究收集了397个涵盖40类编程任务和44种语言的真实样本，并构建了20B标记的合成指令数据集SynCode-Instruct。实验发现传统执行基准与人类偏好评估存在差距，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著。研究强调了代码生成模型除正确性外，还需重视与开发者实际需求的匹配度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T06:05:53Z
- **目录日期**: 2025-05-10
