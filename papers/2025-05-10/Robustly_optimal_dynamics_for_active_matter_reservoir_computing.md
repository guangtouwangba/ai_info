...
该研究探讨了活性物质在储备池计算（RC）范式中的信息处理能力，通过外部驱动模型预测混沌信号的未来状态。研究发现了一种此前被忽视的优异动力学机制，该机制在不同物理参数和推断任务中均表现出稳健的最优性。最优计算状态位于临界阻尼阈值以下，涉及多阶段的微观动力学弛豫过程，其适应性源于准静态与高度非线性动态之间的快速切换。系统的相干与非相干动力学共同发挥作用，且在不同时空尺度上有所差异。该模型为理解非平衡多体物理中的学习和非常规计算提供了新的理论框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T18:02:00Z
- **目录日期**: 2025-05-10
