...
该研究探讨了活性物质在储层计算（RC）范式中的信息处理能力，通过模拟受外部驱动的模型预测混沌信号。研究发现了一个此前被忽视的优越动力学状态，该状态在不同物理参数和任务中均表现稳健，揭示了物理系统计算与推断的新机制。最优计算状态位于临界阻尼阈值之下，涉及多阶段微观动力学弛豫，并因响应机制的多样性（如准稳态与高度非线性态快速切换）而适应混沌驱动。相关动力学特征可标识最优性能状态。该模型为理解非平衡多体物理中的学习和非常规计算提供了新视角。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T12:02:06Z
- **目录日期**: 2025-05-10
