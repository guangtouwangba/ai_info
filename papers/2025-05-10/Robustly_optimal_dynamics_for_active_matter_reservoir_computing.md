...
该研究探讨了活性物质在储层计算（RC）范式中的信息处理能力，通过外部驱动模型预测混沌信号的未来状态。研究发现了一个此前被忽视的优异动力学机制，该机制在不同物理参数和推断任务中均表现出稳健的最优性。最优计算状态位于临界阻尼阈值之下，涉及多阶段的微观动力学弛豫过程，并展现出准稳态与高度非线性动态间的快速切换。系统的内在弛豫能力决定了其信息处理效能，而相干与非相干动力学的协同作用进一步提升了性能。该模型为理解非平衡多体物理中的学习和非常规计算提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T15:02:18Z
- **目录日期**: 2025-05-10
