...
该研究探讨了活性物质在储层计算（RC）范式中的信息处理能力，通过模拟系统预测混沌信号的未来状态。研究发现了一个此前被忽视的优越动力学机制，该机制在不同物理参数和推断任务中均表现出稳健的最优性。系统信息处理能力主要取决于其内在弛豫特性，在临界阻尼阈值以下的多阶段微观弛豫中达到最佳计算状态。最优系统通过准静态与高度非线性动态间的快速切换适应混沌驱动，相干与非相干动力学共同作用。相关动力学特征可标识最优性能区间，为平衡态多体物理的非传统计算提供新视角。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T16:02:16Z
- **目录日期**: 2025-05-10
