...
该研究探讨了活性物质在储层计算（RC）范式中的信息处理能力，通过模拟外部驱动的混沌信号预测模型，发现了一种此前被忽视的优异动力学机制。该机制在多种物理参数和任务中表现稳健且最优，其核心在于系统固有的多阶段弛豫能力，最佳计算状态出现在临界阻尼阈值以下。系统通过准静态与高度非线性状态的快速切换适应混沌驱动，其运作依赖相干与非相干动力学的协同作用，且不同时空尺度的动力学相关性可标识最优性能区间。这一物理解释性模型为多体非平衡系统的学习与非传统计算提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T23:01:56Z
- **目录日期**: 2025-05-10
