...
该研究探讨了活性物质在储备池计算（RC）范式中的信息处理能力，通过模拟受外部驱动的系统预测混沌信号。研究发现了一个此前被忽视的优越动力学机制，该机制在不同物理参数和推断任务中均表现出鲁棒的最优性。最优计算状态位于临界阻尼阈值以下，涉及多阶段的微观动力学弛豫，其适应性源于准静态与高度非线性动态间的快速切换。系统内在弛豫能力决定了信息处理效能，相关动力学特征可标识最优性能区间。这一物理可解释的模型为多体非平衡系统的非传统计算提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T07:02:07Z
- **目录日期**: 2025-05-10
