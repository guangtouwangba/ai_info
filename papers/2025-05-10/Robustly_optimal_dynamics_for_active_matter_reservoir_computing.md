...
该研究探讨了活性物质在储层计算（RC）范式中的信息处理能力，通过模拟外部驱动的混沌信号预测模型，发现了一个此前被忽视的优越动力学机制。这一机制在多种物理参数和推断任务中均表现稳健，揭示了物理系统计算与推断的核心规律：信息处理效能主要取决于系统的本征弛豫能力。最优计算状态位于临界阻尼阈值之下，表现为多阶段微观弛豫，并能在混沌驱动下通过准静态与高度非线性状态的快速切换实现自适应。相关动力学特征可标识最优性能区间，为理解非平衡多体物理中的新型计算提供了物理解释框架。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T04:02:08Z
- **目录日期**: 2025-05-10
