...
该研究探讨了活性物质在储层计算（RC）范式中的信息处理能力，通过模拟受外部驱动的模型预测混沌信号未来状态。研究发现了一种此前被忽视的优越动力学机制，该机制在不同物理参数和推断任务中均表现出鲁棒的最优性。系统信息处理能力主要由其内在弛豫能力决定，最佳计算状态位于临界阻尼阈值下方，涉及多阶段的微观动力学弛豫。最优系统在混沌外部驱动下具有适应性，表现为准稳态与高度非线性动态间的快速切换。相干与非相干动力学共同作用，且动态相关性可指示最优性能状态。该模型为理解非平衡多体物理中的学习与非传统计算提供了新视角。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T13:07:25Z
- **目录日期**: 2025-05-10
