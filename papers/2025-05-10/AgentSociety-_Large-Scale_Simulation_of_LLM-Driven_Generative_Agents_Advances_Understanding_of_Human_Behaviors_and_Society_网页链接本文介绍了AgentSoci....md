...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能模拟1万多个AI代理及其500万次社会互动。研究者用它作为计算社会科学实验平台，研究了社会极化、信息传播、基本收入政策、自然灾害影响等四个关键社会问题。模拟结果与现实世界数据高度吻合，验证了该系统捕捉人类行为机制的能力。该工具为社会科学研究和政策制定提供了新方法，能有效补充传统调查和实验手段，帮助理解复杂社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T15:05:32Z
- **目录日期**: 2025-05-10
