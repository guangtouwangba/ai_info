...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理及其500万次互动。研究者用它研究了四大社会问题：社会极化、信息传播、基本收入政策和自然灾害影响。该系统能有效捕捉人类行为模式，模拟结果与现实研究高度吻合，展示了作为社会科学研究工具的强大潜力，可辅助传统调查和干预方法，帮助理解社会问题的成因和机制。这项技术为政策制定和社会科学研究提供了创新实验平台。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T19:04:38Z
- **目录日期**: 2025-05-10
