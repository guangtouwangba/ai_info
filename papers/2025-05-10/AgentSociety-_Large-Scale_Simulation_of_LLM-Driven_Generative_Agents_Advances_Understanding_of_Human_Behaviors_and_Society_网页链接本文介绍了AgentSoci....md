...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个智能代理及其500万次互动。研究者用它研究四大社会问题：社会极化、信息传播、基本收入政策效果和自然灾害影响。该系统能准确复现现实世界的人类行为模式，验证了其捕捉社会机制的能力。研究证明AgentSociety可作为计算社会科学的实验平台，为传统研究方法提供补充，帮助理解社会问题的成因和机制，具有重要的学术和政策研究价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T03:19:44Z
- **目录日期**: 2025-05-10
