...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统通过模拟1万多个AI代理及其500万次互动，研究社会现象如信息传播、政策影响等。研究验证了模拟结果与现实数据的吻合性，展示了其在理解人类行为机制和政策评估方面的潜力。该系统可作为计算社会科学的研究工具，辅助传统方法分析社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T23:04:35Z
- **目录日期**: 2025-05-10
