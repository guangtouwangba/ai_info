...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟1万多个生成式智能体及其500万次社会互动。研究者利用该平台研究了四个关键社会问题：社会极化、刺激性信息传播、基本收入政策影响和自然灾害（如飓风）的社会效应。模拟结果与现实世界数据高度吻合，验证了该平台在揭示人类行为机制方面的有效性。这一工具为社会科学研究和政策制定提供了新方法，能够补充传统研究方法（如调查和访谈），帮助深入理解复杂社会现象的内在机理。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T13:10:33Z
- **目录日期**: 2025-05-10
