...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理及其500万次社会互动。研究者用它研究四大社会问题：社会极化、刺激性信息传播、基本收入政策影响和自然灾害冲击。模拟结果与现实数据高度吻合，验证了该系统捕捉人类行为机制的能力。该平台可作为计算社会科学的研究工具，辅助传统调查和实验方法，帮助分析社会问题的成因和机制，为政策制定提供参考依据。研究展示了AI模拟在社会科学研究中的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T17:05:05Z
- **目录日期**: 2025-05-10
