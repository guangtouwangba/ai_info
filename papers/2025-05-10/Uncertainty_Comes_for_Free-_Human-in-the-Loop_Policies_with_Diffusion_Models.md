...
本文提出了一种基于扩散策略的人机协作方法，通过计算不确定性指标让机器人仅在必要时主动寻求人类协助，减少持续人工监控的需求。该方法利用扩散策略的生成过程，在部署时自主决定请求操作员帮助，且无需训练阶段的人工交互。同时，该方法还能高效收集数据以微调扩散策略，提升自主性能。模拟和真实环境实验表明，该方法能有效提高多种场景下的策略性能，平衡自主运行与人工干预，适用于大规模机器人部署。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T13:07:44Z
- **目录日期**: 2025-05-10
