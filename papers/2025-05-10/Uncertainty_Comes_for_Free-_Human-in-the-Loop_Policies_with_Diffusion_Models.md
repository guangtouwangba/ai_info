...
本文提出了一种基于扩散策略的人机协作方法，使机器人仅在必要时主动寻求人工协助，减少对持续人工监控的依赖。该方法利用扩散策略的生成过程计算不确定性指标，让自主代理在部署时决定何时请求操作员帮助，且无需训练阶段的人工交互。此外，该方法还可用于高效收集数据以微调扩散策略，提升自主性能。模拟和真实环境实验表明，该方法能在多种场景下有效提高策略性能。这一方案解决了大规模机器人部署中人工监控劳动强度高的问题，实现了更高效的人机协同部署。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T12:02:26Z
- **目录日期**: 2025-05-10
