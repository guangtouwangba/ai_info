...
本文提出了一种基于扩散策略的人机协作（HitL）机器人部署方法，通过主动寻求必要的人类干预来减少持续监控的需求。该方法利用扩散策略的生成过程计算不确定性指标，使自主代理能在部署时自主决定何时请求操作员协助，而无需训练阶段的人工交互。此外，该方法还可用于高效数据收集以微调扩散策略，提升自主性能。模拟和真实环境实验表明，该方法能有效提高多种场景下的策略表现，平衡自主运行与必要人工干预，适用于大规模机器人部署。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T08:02:29Z
- **目录日期**: 2025-05-10
