...
本文提出了一种改进的人机协作（HitL）机器人部署方法，通过扩散策略主动在必要时寻求人工协助，减少对持续人工监控的依赖。该方法利用扩散策略的生成过程计算基于不确定性的指标，使自主代理能在部署时决定何时请求操作员协助，且无需训练阶段的人工交互。此外，该方法还可用于高效收集数据以微调扩散策略，提升自主性能。模拟和真实环境实验表明，该方法在多种场景下均能有效提升策略性能，同时降低人力成本。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T16:02:35Z
- **目录日期**: 2025-05-10
