...
本文提出了一种改进的人机协作（HitL）机器人部署方法，通过扩散策略主动在必要时寻求人工协助，减少持续人工监控的需求。该方法利用扩散策略的生成过程计算基于不确定性的指标，使自主系统能在部署时决定何时请求操作员协助，且无需训练阶段的人工交互。此外，该方法还能高效收集数据以微调扩散策略，提升自主性能。仿真和真实环境实验表明，该方法能有效提高多种场景下的策略性能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T01:29:35Z
- **目录日期**: 2025-05-10
