...
本文提出了一种基于扩散策略的人机协作（HitL）机器人部署方法，通过主动请求人类协助来减少对持续人工监控的依赖。该方法利用扩散策略的生成过程计算不确定性指标，仅在必要时寻求操作员干预，且无需训练阶段的人工交互。此外，该方法还可用于高效收集数据以微调扩散策略，提升自主性能。模拟和真实环境实验表明，该方法能有效提高多种场景下的策略性能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T04:02:28Z
- **目录日期**: 2025-05-10
