...
本文提出了一种基于扩散策略（diffusion policies）的人机协作方法，通过计算不确定性指标，让机器人仅在必要时主动寻求人类协助，从而减少持续人工监控的需求。该方法无需训练阶段的人类干预，并可用于高效收集数据以优化策略。实验表明，该方法在模拟和真实环境中均能提升多种场景下的策略性能，同时降低大规模机器人部署的人力成本。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T00:02:22Z
- **目录日期**: 2025-05-10
