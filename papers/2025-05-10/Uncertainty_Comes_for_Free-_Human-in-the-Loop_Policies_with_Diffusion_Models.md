...
本文提出了一种基于扩散策略的人机协作方法，通过计算不确定性指标让机器人仅在必要时主动寻求人类协助，从而减少持续人工监控的需求。该方法利用扩散策略的生成过程，在部署时自主决定何时请求操作员干预，无需训练阶段的人工交互。同时，该方法还能用于高效收集数据以微调扩散策略，提升自主性能。仿真和真实环境实验表明，该方法能有效提高多种场景下的策略表现。研究解决了大规模机器人部署时人工监控强度过高的问题，为人机协作系统提供了实用解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T22:02:07Z
- **目录日期**: 2025-05-10
