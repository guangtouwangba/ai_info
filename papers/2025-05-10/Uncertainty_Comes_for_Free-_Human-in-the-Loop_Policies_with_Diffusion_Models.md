...
本文提出一种基于扩散策略的人机协作方法，使机器人仅在必要时主动寻求人工协助，减少持续人工监控的需求。该方法利用扩散策略的生成过程计算不确定性指标，让自主代理在部署时决定何时请求操作员帮助，且无需训练阶段的人工交互。此外，该方法还能高效收集数据以微调扩散策略，提升自主性能。仿真和真实环境实验表明，该方法能有效提升多种场景下的策略性能。研究解决了大规模机器人部署时人工干预劳动强度高的问题，为半自主系统提供了实用解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T23:02:14Z
- **目录日期**: 2025-05-10
