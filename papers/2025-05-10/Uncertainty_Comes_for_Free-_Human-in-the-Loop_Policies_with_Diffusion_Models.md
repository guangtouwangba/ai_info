...
本文提出了一种基于扩散策略的人机协作方法，使机器人仅在必要时主动寻求人工干预，减少持续监控的负担。该方法利用扩散策略的生成过程计算不确定性指标，自主决定何时请求操作员协助，且无需训练阶段的人工交互。同时，该方法还可用于高效收集数据以微调扩散策略，提升自主性能。模拟和真实环境实验表明，该方法能有效提高多种场景下的策略性能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T03:16:57Z
- **目录日期**: 2025-05-10
