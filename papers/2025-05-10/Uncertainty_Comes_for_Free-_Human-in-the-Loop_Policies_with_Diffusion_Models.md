...
本文提出了一种基于扩散策略的人机协作机器人部署方法，旨在减少对持续人工监控的依赖。该方法利用扩散策略的生成过程计算不确定性指标，仅在必要时主动寻求人工干预，而无需训练阶段的人工参与。此外，该方法还可用于高效收集数据以优化扩散策略，提升自主性能。仿真和真实环境实验表明，该方法能有效提高多种场景下的策略性能，平衡自主运行与人工干预的需求，适用于大规模机器人部署场景。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T05:02:16Z
- **目录日期**: 2025-05-10
