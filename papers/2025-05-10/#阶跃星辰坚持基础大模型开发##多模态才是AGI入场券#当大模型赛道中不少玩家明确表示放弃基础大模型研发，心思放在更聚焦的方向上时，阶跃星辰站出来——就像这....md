...
阶跃星辰坚持基础大模型研发，创始人姜大昕认为AI技术仍处于快速发展阶段，基础模型决定应用上限，而应用为模型提供场景和数据。公司产品从"跃问"更名为"阶跃AI"，转型为端云一体Agent平台，主要服务C端用户。姜大昕强调多模态是AGI的关键，尽管行业部分玩家转向垂直领域，阶跃仍将专注基础模型开发，同时探索多模态理解，认为智能助手和内容类应用具有巨大潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T22:02:25Z
- **目录日期**: 2025-05-10
