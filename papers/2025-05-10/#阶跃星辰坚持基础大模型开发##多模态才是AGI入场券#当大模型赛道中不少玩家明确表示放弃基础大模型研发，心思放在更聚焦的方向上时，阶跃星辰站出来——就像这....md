...
阶跃星辰坚持基础大模型研发，CEO姜大昕认为技术发展仍处快速迭代期，放弃基础模型可能错失主流趋势。公司相信模型决定应用上限，应用反哺模型优化，因此保持动态发展策略。其C端产品从"跃问"升级为"阶跃AI"，转向端云一体Agent平台，聚焦智能助手和内容服务，最终目标仍是服务普通用户。姜大昕强调多模态能力是AGI的关键，行业技术革新迅速（如GPT-4即将"过时"），需持续投入基础研究以保持竞争力。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T21:02:39Z
- **目录日期**: 2025-05-10
