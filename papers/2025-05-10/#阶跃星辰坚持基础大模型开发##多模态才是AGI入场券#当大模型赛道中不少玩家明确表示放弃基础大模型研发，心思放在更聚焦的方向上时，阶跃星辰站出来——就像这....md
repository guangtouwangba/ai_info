...
阶跃星辰坚持基础大模型研发，认为行业技术仍处于快速上升期，放弃基础模型可能错失主流趋势。CEO姜大昕指出，模型决定应用上限，应用反哺模型迭代，二者相辅相成。公司产品从"跃问"升级为"阶跃AI"，转向端云一体Agent平台，但仍以C端服务为核心。尽管多模态被视为AGI关键，阶跃仍聚焦基座大模型开发，同时探索多模态理解，认为AI助手和内容领域存在巨大机会。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T23:02:32Z
- **目录日期**: 2025-05-10
