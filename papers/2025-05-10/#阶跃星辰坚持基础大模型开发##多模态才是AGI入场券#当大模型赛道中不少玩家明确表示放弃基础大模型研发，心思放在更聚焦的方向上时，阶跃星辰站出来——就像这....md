...
阶跃星辰坚持基础大模型研发，CEO姜大昕认为行业技术仍处于快速发展阶段，基础模型决定应用上限，而应用为模型提供场景和数据。公司产品从"跃问"更名为"阶跃AI"，转型为端云一体Agent平台，主要服务C端用户。姜大昕强调多模态是AGI的关键，尽管行业部分玩家转向垂直领域，阶跃仍将专注基础模型创新，认为AI助手和内容领域存在巨大机会。公司动态调整产品形态，但保持"模型驱动应用"的核心逻辑。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T20:02:46Z
- **目录日期**: 2025-05-10
