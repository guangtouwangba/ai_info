...
阶跃星辰坚持基础大模型研发，CEO姜大昕认为行业技术发展迅速，放弃基础模型会错失主流趋势。公司相信模型与应用相辅相成，模型决定应用上限，应用提供场景和数据。其C端产品从"跃问"更名为"阶跃AI"，转型为端云一体Agent平台，最终目标是服务C端用户。姜大昕表示，无论是助手类还是内容类应用都有巨大机会。公司持续探索多模态技术，视其为通向AGI的关键。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T15:03:03Z
- **目录日期**: 2025-05-10
