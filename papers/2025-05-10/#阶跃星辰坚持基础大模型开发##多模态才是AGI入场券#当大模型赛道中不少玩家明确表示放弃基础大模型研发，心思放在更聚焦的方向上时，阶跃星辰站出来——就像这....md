...
阶跃星辰CEO姜大昕表示公司将继续坚持基础大模型研发，认为AI技术仍处于快速发展阶段，基础模型决定应用上限。公司产品从"跃问"更名为"阶跃AI"，转型为端云一体Agent平台，主要面向C端用户。姜大昕强调多模态能力是AGI的关键，模型与应用相辅相成，通过实际场景数据推动技术进步。尽管行业部分玩家转向垂直领域，阶跃星辰仍致力于基础模型创新，认为智能助手和内容服务存在巨大市场机会。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T17:02:44Z
- **目录日期**: 2025-05-10
