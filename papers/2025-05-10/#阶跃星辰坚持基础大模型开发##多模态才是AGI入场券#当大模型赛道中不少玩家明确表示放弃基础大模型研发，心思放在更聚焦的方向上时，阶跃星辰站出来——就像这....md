...
阶跃星辰坚持基础大模型研发，创始人姜大昕认为AI技术发展迅速，放弃基础模型会错失主流趋势。同时，模型与应用相辅相成，模型决定应用上限，应用提供场景和数据。公司产品从"跃问"更名为"阶跃AI"，转型为端云一体Agent平台，主要服务C端用户。姜大昕强调多模态是AGI的关键，尽管行业部分玩家转向垂直领域，阶跃仍将专注基础模型和多模态技术探索。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T13:08:05Z
- **目录日期**: 2025-05-10
