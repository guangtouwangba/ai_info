...
阶跃星辰坚持基础大模型研发，CEO姜大昕认为技术发展仍处于快速迭代期（如GPT-4即将"过时"），放弃基础模型会错失主流趋势。公司相信模型决定应用上限，应用反哺模型迭代，因此持续投入基座大模型，同时动态调整产品形态——其C端助手App"跃问"已升级为Agent平台"阶跃AI"，主打端云一体架构。姜大昕强调，尽管与头部企业合作，最终目标仍是服务C端用户，认为AI助手和内容生成领域存在巨大机会。多模态被视为实现AGI的关键路径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T14:02:47Z
- **目录日期**: 2025-05-10
