...
该研究提出了MultiMind框架，首次将多模态信息整合到社交推理游戏(如"狼人杀")的AI智能体中。该框架通过分析面部表情、语音语调等非语言线索，结合心理理论(ToM)建模玩家间的相互怀疑程度，并利用蒙特卡洛树搜索(MCTS)优化沟通策略。实验表明，MultiMind在AI对战和人类对战中均表现出色。这项研究推动了大型语言模型在多模态社交推理领域的发展，使AI更接近人类的社会认知能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T02:29:29Z
- **目录日期**: 2025-05-10
