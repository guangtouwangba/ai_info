...
该研究提出了MultiMind框架，首次将多模态信息整合到社交推理游戏（如"狼人杀"）的LLM智能体中。通过分析面部表情、语音语调等非语言线索，并结合心理理论(ToM)模型追踪玩家间的相互怀疑程度，MultiMind能更准确地模拟人类社交推理。结合蒙特卡洛树搜索(MCTS)，该智能体可制定最小化自身嫌疑的沟通策略。实验表明，MultiMind在智能体对战和人类玩家测试中均表现出色，标志着LLM智能体在多模态社交推理领域的重要进展，使其更接近人类的社交互动能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T20:02:15Z
- **目录日期**: 2025-05-10
