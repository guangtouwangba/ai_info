...
研究人员开发了名为SITE的标准化空间智能(SI)评估基准数据集，采用多选视觉问答形式，用于全面评估大视觉语言模型在不同视觉模态(单图/多图/视频)和SI维度(图形到环境尺度、空间可视化与定向、内在/外在、静态/动态)的表现。该基准综合了31个现有数据集的调研和认知科学分类体系，创新性地设计了视角转换和动态场景两类新任务。实验表明主流模型在空间定向等基础SI能力上显著落后人类专家，且发现模型的空间推理能力与具身AI任务表现呈正相关。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T12:01:07Z
- **目录日期**: 2025-05-10
