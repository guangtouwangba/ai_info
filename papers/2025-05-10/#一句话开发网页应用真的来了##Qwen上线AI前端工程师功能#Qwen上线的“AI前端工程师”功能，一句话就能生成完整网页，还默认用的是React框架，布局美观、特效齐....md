...
Qwen最新推出"AI前端工程师"功能，支持通过自然语言指令快速生成完整网页应用。该功能基于React框架，可一键生成包含HTML/CSS/JavaScript的完整代码，支持个人主页、电商页面等多种场景，并能模仿现有网站界面和实现复杂动画效果。用户上传网页后，AI可自动生成匹配的展示页面。该功能已集成至Qwen Chat网页版，开启"网页开发"模式即可使用，配合"深度思考"模式可获得更高质量输出。目前仅支持React技术栈，采用Tailwind CSS和.jsx单文件结构。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T18:02:55Z
- **目录日期**: 2025-05-10
