...
Noam Shazeer是Transformer架构核心贡献者之一，现为谷歌Gemini技术主管，被誉为大模型领域的"时间旅行者"。作为Transformer论文第八作者但贡献最大，他深度参与了MoE架构演进、Adafactor优化器等关键技术突破。这位数学天才（IMO满分、Putnam竞赛Top10）从谷歌第200号员工成长为AI领军人物，其创立的Character.AI被谷歌27亿美元收购。他准确预言了语言模型将主导全球算力的趋势，被网友称为"我们正生活在Noam Shazeer时代"。其技术预判力和持续创新使其成为大模型发展史上的关键人物。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T18:03:05Z
- **目录日期**: 2025-05-10
