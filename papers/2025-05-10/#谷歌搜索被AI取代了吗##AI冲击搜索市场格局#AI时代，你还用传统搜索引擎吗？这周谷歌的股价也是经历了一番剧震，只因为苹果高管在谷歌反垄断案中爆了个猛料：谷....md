...
AI正在冲击传统搜索引擎市场。谷歌4月Safari搜索量首次下降，部分用户转向ChatGPT等AI工具，广告点击增速降至2%的历史新低。分析师对威胁程度看法不一：郭明錤认为AI终将影响谷歌广告业务，而Jefferies认为谷歌能通过AI功能获利。目前AI搜索量已占传统引擎的15%，市场格局面临重塑。核心矛盾在于：当AI能直接提供精准答案时，用户对广告链接的依赖度可能持续降低。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T21:03:39Z
- **目录日期**: 2025-05-10
