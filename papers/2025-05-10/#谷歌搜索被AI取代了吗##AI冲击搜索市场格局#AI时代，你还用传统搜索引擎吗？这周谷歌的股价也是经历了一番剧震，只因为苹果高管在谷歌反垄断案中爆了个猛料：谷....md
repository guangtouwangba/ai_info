...
谷歌搜索业务正面临AI工具的冲击。苹果高管在反垄断案中透露，4月Safari的谷歌搜索量首次下降，用户转向ChatGPT等AI工具。谷歌回应称总体搜索量仍在增长，但广告点击增速已降至2%的历史新低。分析师对威胁程度看法不一：郭明錤认为AI终将影响广告业务，而Jefferies认为谷歌能通过AI功能盈利。数据显示，AI工具已占搜索市场15%的份额，重塑行业格局。核心矛盾在于：当AI能直接提供答案，用户是否会减少传统搜索？

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T02:29:56Z
- **目录日期**: 2025-05-10
