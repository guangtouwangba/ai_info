...
AI正在冲击传统搜索引擎市场格局。谷歌4月Safari搜索量首次下降，广告点击增速创历史新低（仅2%），分析师认为ChatGPT等AI工具已占搜索市场15%份额。争议焦点在于：一方认为AI直接提供答案将减少广告点击（郭明錤称AI公司尚未开展广告业务是当前谷歌仍增长的主因）；另一方认为谷歌终将通过AI功能获利。核心矛盾在于：当AI能直接解答"吃什么""去哪玩"等问题时，用户对传统搜索广告的依赖度将大幅降低。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T17:03:53Z
- **目录日期**: 2025-05-10
