...
AI正在冲击传统搜索市场格局。谷歌4月通过Safari的搜索量首次下降，广告点击增速降至2%的历史新低，分析师认为这与ChatGPT等AI工具兴起有关。目前AI搜索量已占传统引擎的15%，用户更倾向直接获取AI生成的精准答案而非浏览广告页面。虽然谷歌表示总体搜索量仍在增长，但市场对其控制力产生质疑。分析师观点分化：部分认为AI终将威胁谷歌广告业务，另一些则相信谷歌能通过AI功能实现盈利。搜索市场正因AI技术面临重塑。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T07:03:41Z
- **目录日期**: 2025-05-10
