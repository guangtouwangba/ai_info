...
AI正在冲击传统搜索引擎市场。谷歌4月通过Safari的搜索量首次下降，广告点击增速降至2%的历史新低，分析师认为AI工具（如ChatGPT）分流了用户。目前ChatGPT等AI搜索量已占传统引擎的15%。虽然谷歌表示总体搜索量仍在增长，但市场担忧其主导地位。分析师观点分歧：郭明錤认为AI终将影响谷歌广告，而Jefferies则认为谷歌能通过AI功能获利。核心矛盾在于：当AI能直接给出精准答案，用户可能不再需要传统搜索。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T23:03:30Z
- **目录日期**: 2025-05-10
