...
AI工具如ChatGPT正冲击传统搜索引擎市场。谷歌4月通过Safari的搜索量首次下降，广告点击增速降至2%的历史新低，可能因AI提供更精准答案减少了广告点击。分析师观点分化：部分认为AI终将威胁谷歌广告业务，另一些则相信谷歌能通过AI功能盈利。目前AI搜索量已占传统引擎的15%，用户更倾向直接获取答案而非浏览广告页面。市场格局正在重塑，但谷歌称总体搜索量仍在增长。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T00:02:40Z
- **目录日期**: 2025-05-10
