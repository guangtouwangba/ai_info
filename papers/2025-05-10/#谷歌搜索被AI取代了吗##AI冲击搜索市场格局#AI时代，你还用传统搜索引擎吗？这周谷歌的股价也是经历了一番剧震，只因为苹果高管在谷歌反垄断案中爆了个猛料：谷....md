...
谷歌搜索业务正面临AI工具的冲击。苹果高管在反垄断案中透露，4月Safari的谷歌搜索量首次下降，用户转向ChatGPT等AI工具。谷歌回应称总体搜索量仍在增长，但广告点击增速降至2%的历史新低，分析师认为AI精准答案可能减少了广告转化。部分专家警告AI将威胁谷歌广告业务，而乐观派则认为谷歌能通过AI功能盈利。数据显示，AI工具已占搜索市场15%的份额，重塑行业格局。用户更倾向直接获取AI生成的答案，而非浏览传统搜索结果页。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T12:03:37Z
- **目录日期**: 2025-05-10
