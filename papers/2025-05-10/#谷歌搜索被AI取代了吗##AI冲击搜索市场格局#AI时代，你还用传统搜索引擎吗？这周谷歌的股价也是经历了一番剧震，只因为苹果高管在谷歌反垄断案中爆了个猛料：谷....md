...
AI正在冲击传统搜索引擎市场。谷歌4月Safari搜索量首次下降，部分用户转向ChatGPT等AI工具。谷歌广告点击增速降至2%的历史新低，分析师认为AI精准答案可能减少了广告转化。ChatGPT类工具已占搜索市场15%的份额。分析师对威胁程度看法不一：郭明錤认为AI终将影响谷歌广告，而Jefferies认为谷歌最终能通过AI功能盈利。市场格局正在重塑，AI直接提供答案的能力可能改变用户搜索习惯。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T15:04:16Z
- **目录日期**: 2025-05-10
