...
AI正在冲击传统搜索市场格局。谷歌4月通过Safari的搜索量首次下降，广告点击增速降至2%的历史新低，分析师认为这与ChatGPT等AI工具兴起有关。虽然谷歌表示整体搜索量仍在增长，但数据显示AI搜索已占传统搜索量的15%。分析师对威胁程度看法不一：郭明錤认为AI终将影响谷歌广告业务，而Jefferies则认为谷歌能通过AI功能获利。核心矛盾在于：当AI能直接给出精准答案，用户对传统搜索的依赖度正在降低。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T22:03:23Z
- **目录日期**: 2025-05-10
