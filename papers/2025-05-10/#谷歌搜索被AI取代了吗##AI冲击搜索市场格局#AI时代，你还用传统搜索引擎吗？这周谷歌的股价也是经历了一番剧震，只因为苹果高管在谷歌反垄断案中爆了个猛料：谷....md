...
AI工具正在冲击传统搜索引擎市场。谷歌4月Safari搜索量首次下降，广告点击增速创历史新低（仅2%），分析师认为ChatGPT等AI工具已占15%搜索份额。虽然谷歌称总体搜索量仍在增长，但市场担忧AI直接提供答案会减少广告点击。分析师观点分化：郭明錤认为AI终将影响谷歌广告，而Jefferies相信谷歌能通过AI功能获利。核心矛盾在于：当AI能直接解决问题时，用户是否还需要传统搜索页面。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T09:03:33Z
- **目录日期**: 2025-05-10
