...
AI正在冲击传统搜索引擎市场格局。谷歌4月通过Safari的搜索量首次下降，广告点击增速创历史新低（仅2%），分析师认为这与ChatGPT等AI工具兴起有关（已占15%搜索量）。虽然谷歌称总体搜索量仍在增长，但市场担忧AI直接提供答案会减少广告点击。分析师观点分歧：郭明錤认为AI终将影响广告业务，Jefferies则认为谷歌能通过AI功能获利。这一趋势显示AI正在重塑搜索市场，用户可能更倾向直接获取答案而非浏览广告页面。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T16:04:10Z
- **目录日期**: 2025-05-10
