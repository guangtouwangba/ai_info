...
AI正在冲击传统搜索引擎市场。谷歌4月通过Safari的搜索量首次下降，广告点击增速降至2%的历史新低，分析师认为这与ChatGPT等AI工具兴起有关（已占15%搜索量）。虽然谷歌称总体搜索量仍在增长，但市场担忧AI直接提供答案会减少广告点击。分析师观点分化：郭明錤认为AI终将威胁谷歌广告，Jefferies则认为谷歌能通过AI功能获利。核心矛盾在于：当AI能直接解决问题，用户可能不再需要传统搜索页面。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T13:09:23Z
- **目录日期**: 2025-05-10
