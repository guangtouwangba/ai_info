...
清华大学、复旦大学和香港科技大学联合发布了RM-Bench评测基准，这是首个针对奖励模型的系统性评分标准，解决了传统模型"重形式轻内容"的偏科问题。该基准通过3x3矩阵评估不同风格组合下的判断准确度，覆盖聊天、代码等多元场景，并采用GPT-4o生成对抗性数据。RM-Bench不仅能评估奖励模型质量，还能预测其对大语言模型性能的提升效果。相关成果已被ICLR 2025接收为口头报告，代码和榜单已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T06:02:42Z
- **目录日期**: 2025-05-10
