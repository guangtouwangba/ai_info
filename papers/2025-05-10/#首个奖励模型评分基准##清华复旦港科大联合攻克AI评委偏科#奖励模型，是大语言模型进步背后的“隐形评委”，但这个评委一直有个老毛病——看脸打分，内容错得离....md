...
清华大学、复旦大学和香港科技大学联合发布了首个奖励模型评分基准RM-Bench，解决了AI奖励模型"重形式轻内容"的偏科问题。该基准通过3x3矩阵评估不同难度下模型的内容判断能力，覆盖聊天、代码等多领域，并采用GPT-4o生成验证数据。RM-Bench不仅能准确评估奖励模型，还能预测其对大语言模型性能的提升效果。这项被ICLR 2025接收为口头报告的研究，标志着AI评估向"内容为王"迈出关键一步，相关代码和榜单已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T23:02:40Z
- **目录日期**: 2025-05-10
