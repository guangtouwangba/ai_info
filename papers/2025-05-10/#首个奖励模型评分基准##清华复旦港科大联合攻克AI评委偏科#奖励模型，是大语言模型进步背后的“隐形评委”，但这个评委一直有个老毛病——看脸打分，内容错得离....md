...
清华大学、复旦大学和香港科技大学联合发布了首个奖励模型评分基准RM-Bench，解决了AI奖励模型"重形式轻内容"的偏科问题。该基准通过内容细微差异+多风格对照测试、3x3矩阵评估体系（简单/普通/困难三个等级），全面检验模型在聊天、代码、数学、安全等领域的真实判断能力。RM-Bench采用GPT-4o生成数据并人工验证，其评估结果与策略模型性能高度相关，能有效预测语言模型的整体优化效果。该项目已被ICLR 2025接收为口头报告论文，相关代码和榜单已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T21:02:48Z
- **目录日期**: 2025-05-10
