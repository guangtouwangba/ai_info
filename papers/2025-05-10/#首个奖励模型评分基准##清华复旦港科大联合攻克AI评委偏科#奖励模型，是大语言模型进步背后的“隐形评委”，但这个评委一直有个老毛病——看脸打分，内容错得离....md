...
清华大学、复旦大学和香港科技大学联合发布了首个奖励模型评分基准RM-Bench，旨在解决AI奖励模型"重形式轻内容"的偏科问题。该基准通过设计内容细微差异+多风格对照测试、3x3矩阵评估体系，系统检验模型在不同难度下"内容为王"的判断能力，覆盖聊天、代码等多元场景。研究显示RM-Bench与策略模型性能高度相关，不仅能评估奖励模型质量，还可预测其对大语言模型整体性能的提升效果。该成果已被ICLR 2025接收为口头报告，相关代码和榜单已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T09:02:30Z
- **目录日期**: 2025-05-10
