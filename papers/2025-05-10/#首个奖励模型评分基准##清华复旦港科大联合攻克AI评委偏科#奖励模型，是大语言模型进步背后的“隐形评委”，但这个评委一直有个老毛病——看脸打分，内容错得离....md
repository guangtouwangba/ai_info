...
清华大学、复旦大学和香港科技大学联合发布了首个奖励模型评分基准RM-Bench，解决了AI奖励模型"重形式轻内容"的偏科问题。该基准采用3x3矩阵评估不同难度下模型对内容质量的判断能力，覆盖聊天、代码等多元场景，并通过GPT-4o生成对抗性测试数据。RM-Bench不仅能评估奖励模型本身，还能预测其对大语言模型性能的提升效果。相关论文已被ICLR 2025接收为口头报告，代码和评测榜单已开源。这一突破标志着AI评估体系向"内容为王"迈出关键一步。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T22:02:34Z
- **目录日期**: 2025-05-10
