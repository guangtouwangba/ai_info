...
清华大学、复旦大学和香港科技大学联合发布了首个奖励模型评测基准RM-Bench，解决了AI奖励模型"重形式轻内容"的偏科问题。该基准通过内容细微差异+多风格对照测试、3x3矩阵评估体系和多领域覆盖（聊天/代码/数学/安全），系统性检验模型是否真正"内容为王"。RM-Bench与策略模型性能高度相关，不仅能评估奖励模型质量，还能预测其对大语言模型的优化效果。该成果已被ICLR 2025接收为口头报告，相关代码和榜单已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T20:02:56Z
- **目录日期**: 2025-05-10
