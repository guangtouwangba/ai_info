...
【摘要】本文综述了ALK基因双靶点抑制剂在非小细胞肺癌(NSCLC)治疗中的最新进展。ALK基因是NSCLC的关键致癌驱动靶点，尽管已有7种抑制剂获批，但耐药性问题突出。研究显示，相比联合用药，单一分子同时靶向两个位点的双靶点抑制剂能降低副作用，更有效克服耐药性。文章系统分析了这类抑制剂的结构-活性关系及设计策略，为开发新型ALK靶向药提供了重要参考，对推动肺癌精准治疗具有重要意义。（注：原文前段提及的金融领域RAG评估基准"OmniEval"与后文医学内容无关，可能为排版错误）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T18:04:35Z
- **目录日期**: 2025-05-10
