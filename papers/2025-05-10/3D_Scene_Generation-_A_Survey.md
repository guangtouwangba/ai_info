...
3D场景生成技术旨在创建空间结构化、语义明确且逼真的环境，用于沉浸式媒体、机器人、自动驾驶和具身AI等领域。早期基于程序规则的方法可扩展但多样性有限。近年来，深度生成模型（如GAN、扩散模型）和3D表示技术（如NeRF、3D高斯）通过学习真实场景分布，提升了生成的真实性、多样性和视角一致性。该综述将方法分为四类：程序生成、神经3D生成、基于图像的生成和基于视频的生成，分析其技术基础、优缺点及代表性成果，并探讨了数据集、评估协议和应用。未来方向包括更高保真度、物理感知生成和统一感知-生成模型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T01:28:13Z
- **目录日期**: 2025-05-10
