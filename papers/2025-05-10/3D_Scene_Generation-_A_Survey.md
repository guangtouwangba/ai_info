...
3D场景生成技术旨在创建空间结构化、语义丰富且逼真的虚拟环境，应用于沉浸式媒体、机器人、自动驾驶和具身AI等领域。早期基于规则的方法可扩展但多样性不足，而近期基于深度生成模型（如GAN、扩散模型）和3D表示（如NeRF、3D高斯）的方法显著提升了保真度、多样性和视角一致性。该综述将现有方法分为四类：程序化生成、神经3D生成、图像生成和视频生成，分析其技术基础与优缺点，并总结数据集、评估指标和应用场景。未来方向包括更高保真度、物理感知生成及统一感知-生成模型。项目页面持续更新进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T07:00:54Z
- **目录日期**: 2025-05-10
