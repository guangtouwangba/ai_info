...
3D场景生成技术旨在创建具有空间结构、语义信息和逼真视觉效果的环境，应用于沉浸式媒体、机器人、自动驾驶等领域。早期基于程序规则的方法可扩展但多样性不足。近年来，深度生成模型（如GAN、扩散模型）和3D表示技术（如NeRF、3D高斯）显著提升了生成的真实性、多样性和视角一致性。该领域方法可分为四类：程序生成、神经3D生成、基于图像的生成和基于视频的生成。当前挑战包括生成能力、3D表示、数据标注和评估标准，未来方向包括更高保真度、物理感知交互和感知-生成统一模型。相关资源见项目页面。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T04:00:58Z
- **目录日期**: 2025-05-10
