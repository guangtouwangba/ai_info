...
3D场景生成技术旨在创建空间结构化、语义丰富且逼真的虚拟环境，应用于沉浸式媒体、机器人、自动驾驶等领域。早期基于规则的方法可扩展但多样性有限，而当前深度生成模型（如GAN、扩散模型）和3D表示（如NeRF、3D高斯）显著提升了真实感、多样性和视角一致性。最新研究将扩散模型应用于图像或视频合成，进一步推动3D生成与真实感结合。该领域分为程序化生成、神经3D生成、图像和视频生成四类方法，面临生成能力、3D表示、数据标注等挑战，未来方向包括高保真、物理交互和感知生成一体化。详见GitHub项目页。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T09:00:50Z
- **目录日期**: 2025-05-10
