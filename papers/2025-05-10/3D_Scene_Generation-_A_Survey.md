...
3D场景生成技术旨在创建具有空间结构、语义信息和真实感的环境，应用于沉浸式媒体、机器人、自动驾驶等领域。早期基于规则的方法可扩展但多样性不足。近年来，深度生成模型（如GAN、扩散模型）和3D表示技术（如NeRF、3D高斯）显著提升了生成的真实性、多样性和视角一致性。该综述将现有方法分为四类：程序化生成、神经3D生成、图像生成和视频生成，分析了技术基础、优缺点及代表性成果，并探讨了数据集、评估方法和应用。未来方向包括更高保真度、物理感知生成和统一感知-生成模型。项目页持续更新进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T18:00:55Z
- **目录日期**: 2025-05-10
