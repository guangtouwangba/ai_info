...
3D场景生成技术旨在创建空间结构化、语义丰富且逼真的虚拟环境，应用于沉浸式媒体、机器人、自动驾驶和具身AI等领域。早期基于程序规则的方法可扩展但多样性不足。近年来，基于GAN、扩散模型等深度生成模型和NeRF、3D高斯等3D表示方法，显著提升了场景的真实性、多样性和视角一致性。该综述系统梳理了四类主流方法（程序生成、神经3D生成、图像生成和视频生成），分析了技术基础、优缺点及评估指标，并指出未来方向如更高保真度、物理感知生成和统一感知-生成模型。相关资源见GitHub项目页。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T05:00:47Z
- **目录日期**: 2025-05-10
