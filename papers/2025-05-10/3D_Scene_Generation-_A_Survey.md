...
3D场景生成旨在创建空间结构化、语义明确且逼真的虚拟环境，应用于沉浸式媒体、机器人、自动驾驶和具身AI等领域。早期基于规则的方法可扩展但多样性不足，而深度生成模型（如GAN、扩散模型）和3D表示（如NeRF、3D高斯）提升了真实感、多样性和视角一致性。该综述系统梳理了四大范式：程序化生成、神经3D生成、图像生成和视频生成，分析了技术基础、优缺点及典型成果，并总结了数据集、评估方法和应用。未来方向包括更高保真度、物理感知交互生成及感知-生成统一模型。详见项目页：https://github.com/hzxie/Awesome-3D-Scene-Generation。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T19:00:52Z
- **目录日期**: 2025-05-10
