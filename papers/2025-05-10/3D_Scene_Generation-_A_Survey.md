...
3D场景生成技术旨在创建具有空间结构、语义信息和真实感的环境，应用于沉浸式媒体、机器人、自动驾驶等领域。早期基于规则的方法可扩展但多样性有限。近年来，基于深度生成模型（如GAN、扩散模型）和3D表示（如NeRF、3D高斯）的方法提升了生成的真实性、多样性和视角一致性。该综述系统梳理了四类方法：程序化生成、神经3D生成、图像生成和视频生成，分析了技术基础、优缺点及评估标准。未来挑战包括生成能力、3D表示、数据标注和评估，发展方向包括高保真、物理感知和交互式生成。项目地址：https://github.com/hzxie/Awesome-3D-Scene-Generation。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T16:01:03Z
- **目录日期**: 2025-05-10
