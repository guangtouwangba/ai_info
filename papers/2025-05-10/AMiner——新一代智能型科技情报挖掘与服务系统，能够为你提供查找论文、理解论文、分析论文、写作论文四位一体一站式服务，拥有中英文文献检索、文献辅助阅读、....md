...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献检索，拥有3.5亿论文、0.6亿学者等海量数据，并能通过AI生成摘要、翻译及问答互动。用户可订阅个性化科研动态，追踪学者及机构的最新成果。平台还提供文献辅助阅读、文档识别等功能，帮助高效理解内容。AMiner的浏览器版本可免费使用，适合科研人员快速获取学术资讯。访问入口：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T22:04:50Z
- **目录日期**: 2025-05-10
