...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、翻译、辅助阅读及论文写作支持。其数据库涵盖42个学科的3.5亿论文、0.6亿学者及1.5亿专利。核心功能包括：1）智能文献检索与互动问答，可自动生成摘要；2）AI辅助阅读，支持上传PDF并提取关键信息；3）定制化科研情报订阅，通过微信/邮件推送最新成果。平台还提供学者画像、学术会议等特色服务，基础功能免费开放。网址：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T02:32:47Z
- **目录日期**: 2025-05-10
