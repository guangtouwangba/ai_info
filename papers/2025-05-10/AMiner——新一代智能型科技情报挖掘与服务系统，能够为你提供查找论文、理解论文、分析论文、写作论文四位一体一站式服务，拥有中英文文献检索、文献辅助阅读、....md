...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献检索，拥有3.5亿论文、0.6亿学者等海量数据，并提供AI辅助阅读、自动摘要生成和互动问答功能。此外，AMiner支持英文文献翻译、科研情报订阅（通过微信或邮件推送最新研究动态），以及学者画像、学术会议追踪等特色功能。用户可免费使用其浏览器检索服务，实现高效学术信息获取与研究支持。平台网址：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T16:05:54Z
- **目录日期**: 2025-05-10
