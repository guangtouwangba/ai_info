...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作一站式服务。它支持中英文文献搜索、AI辅助阅读和翻译，拥有3.5亿论文、0.6亿学者等海量数据。用户可通过提问快速获取文献摘要，上传PDF生成章节概要，还能订阅个性化科研动态。平台还包含学者画像、学术会议等特色功能，基础检索免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T14:05:41Z
- **目录日期**: 2025-05-10
