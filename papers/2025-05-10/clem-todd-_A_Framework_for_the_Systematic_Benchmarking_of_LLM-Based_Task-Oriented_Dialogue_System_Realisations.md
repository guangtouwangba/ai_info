...
本文提出了clem todd框架，用于在统一条件下系统评估任务导向对话系统。该框架支持灵活组合不同用户模拟器和对话系统进行基准测试，确保数据集、评估指标和计算约束的一致性。研究通过重新评估现有系统并整合三个新系统，验证了框架的灵活性。结果表明，架构、模型规模和提示策略对对话性能有显著影响，为构建高效对话AI系统提供了实用指导。该框架解决了现有研究中评估标准不统一的问题，能更全面地比较不同系统配置的效果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T23:01:30Z
- **目录日期**: 2025-05-10
