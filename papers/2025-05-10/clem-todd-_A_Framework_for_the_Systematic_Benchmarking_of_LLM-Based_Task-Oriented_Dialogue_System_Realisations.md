...
本文提出了clem todd框架，用于在统一条件下系统评估任务导向对话系统。该框架支持灵活组合不同用户模拟器和对话系统，确保数据集、评估指标和计算约束的一致性。研究通过重新评估现有系统并整合三个新系统，验证了框架的有效性，揭示了架构、规模和提示策略对对话性能的影响，为构建高效对话AI提供了实用指导。该研究弥补了现有评估方法孤立性的局限，提升了跨架构和配置的通用性洞察。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T12:01:37Z
- **目录日期**: 2025-05-10
