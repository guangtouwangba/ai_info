...
Noam Shazeer是Transformer论文八位作者中公认贡献最大者，被誉为"总站在大模型技术C位的传奇男子"。作为谷歌资深研究员，他在多项AI突破性技术中留下深刻印记：从开创性的《Attention is all you need》（引用量超17万次），到将MoE引入LLM、Adafactor算法、多查询注意力机制、门控线性层(GLU)等核心技术。近期Meta研究员发现，他三年前的研究已预见当前3-token因果卷积等前沿方向，被戏称为"时间旅行者"。其奠基性工作塑造了当今主流模型架构，堪称定义了"Noam Shazeer时代"的AI技术发展轨迹。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T13:08:59Z
- **目录日期**: 2025-05-10
