...
Noam Shazeer是Transformer论文八位作者中最具影响力的研究者，被誉为"总站在大模型技术C位的传奇男子"。作为谷歌早期研究员，他在《Attention is all you need》（引用量超17万次）、MoE架构、Adafactor算法、多查询注意力机制等多项突破性技术中做出奠基性贡献。近期Meta研究员发现他三年前的研究已预见了当前3-token因果卷积的进展，引发"他可能是时间旅行者"的调侃。尽管低调，但当今主流大模型架构的发展都建立在他的工作基础上，被业界称为"生活在Noam Shazeer时代"。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T15:03:56Z
- **目录日期**: 2025-05-10
