...
Noam Shazeer（沙哥）是Transformer八位核心作者中公认贡献最大者，其奠基性工作贯穿当今大模型技术发展。作为谷歌资深研究员，他主导了《Attention is All You Need》（引用量17万+）、MoE架构、Adafactor优化器等突破性研究，近期Meta团队发现其3年前的工作已预见了当前因果卷积等前沿方向。虽低调少曝光，但学界公认主流模型架构均建立在其创新基础上，朱泽园等研究者甚至调侃他"可能是时间旅行者"。从Transformer到Character.AI创业再回归谷歌，Shazeer持续引领着AI技术演进。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T07:03:19Z
- **目录日期**: 2025-05-10
