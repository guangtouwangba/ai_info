...
Noam Shazeer（沙哥）是Transformer八位核心作者之一，被誉为对大模型技术贡献最大的研究者。他参与的关键突破包括开创性论文《Attention is all you need》（引用超17万次）、将MoE引入LLM、Adafactor算法、多查询注意力机制等。近期Meta研究员朱泽园团队的新研究再次印证了沙哥三年前的前瞻性工作，网友调侃他"像是时间旅行者"。尽管低调，他奠基的技术深刻影响了当前主流模型架构，被业界称为"生活在Noam Shazeer时代"。其职业生涯横跨谷歌、创业公司Character.AI，持续引领AI核心技术发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T12:03:18Z
- **目录日期**: 2025-05-10
