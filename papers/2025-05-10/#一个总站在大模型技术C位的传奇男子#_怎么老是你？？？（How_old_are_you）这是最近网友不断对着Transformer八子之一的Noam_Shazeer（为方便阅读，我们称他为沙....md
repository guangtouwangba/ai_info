...
Noam Shazeer（沙哥）是Transformer八位核心作者中公认贡献最大的一位，被誉为"总站在大模型技术C位的传奇男子"。作为AI领域的关键奠基人，他在《Attention Is All You Need》、MoE架构、Adafactor算法、多查询注意力机制等重大突破中均发挥核心作用。近期Meta研究员发现其3年前的工作已预见当前因果卷积研究，引发"他可能是时间旅行者"的调侃。从谷歌到创业Character.AI再回归，Shazeer的成果持续引领大模型技术演进，被业界认为当今主流模型架构都建立在其开创性工作基础上。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T10:03:21Z
- **目录日期**: 2025-05-10
