...
Noam Shazeer是Transformer八位核心作者中公认贡献最大者，被誉为"大模型技术C位的传奇男子"。作为AI领域奠基性人物，他在《Attention is All You Need》、MoE架构、Adafactor算法等多项突破性研究中扮演关键角色。其工作贯穿当今主流大模型的核心技术，包括多查询注意力、门控线性层等创新。近期Meta研究员发现他3年前的研究已预见当前技术趋势，引发"他是否时间旅行者"的调侃。虽低调少曝光，但业界认为我们正生活在"Noam Shazeer时代"，当前模型架构多建立在其开创性工作基础上。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T21:03:22Z
- **目录日期**: 2025-05-10
