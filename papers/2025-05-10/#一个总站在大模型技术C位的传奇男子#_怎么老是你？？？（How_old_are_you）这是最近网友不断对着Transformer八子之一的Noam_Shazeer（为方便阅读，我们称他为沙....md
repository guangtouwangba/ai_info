...
Noam Shazeer（沙哥）是Transformer八位核心作者中公认贡献最大者，被誉为大模型技术发展的关键奠基人。他主导或参与了多项突破性研究，包括开创性的《Attention Is All You Need》（引用超17万次）、将MoE引入大模型、Adafactor优化算法、多查询注意力机制等。近期Meta研究员朱泽园团队的工作再次印证其前瞻性——沙哥3年前已研究类似3-token因果卷积技术。网友调侃他"像时间旅行者"，因其成果持续引领AI发展。尽管低调，当今主流模型架构均建立在其工作基础上，堪称"Shazeer时代"的隐形推手。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T09:03:13Z
- **目录日期**: 2025-05-10
