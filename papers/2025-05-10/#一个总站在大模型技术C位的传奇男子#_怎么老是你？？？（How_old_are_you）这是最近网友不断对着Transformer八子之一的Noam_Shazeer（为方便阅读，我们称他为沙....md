...
Noam Shazeer（沙哥）是Transformer八位核心作者之一，被公认为对AI大模型技术贡献最大的人物。作为谷歌研究员，他深度参与了《Attention Is All You Need》、MoE架构、Adafactor优化器等多项奠基性工作，其研究成果持续引领大模型发展方向。近期Meta研究员发现他三年前已探索过当前热门技术（如3-token因果卷积），引发"他是否时间旅行者"的调侃。尽管低调，现代主流模型架构多建立在其开创性工作基础上，被业界称为"生活在Noam Shazeer时代"的AI发展期。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T17:03:30Z
- **目录日期**: 2025-05-10
