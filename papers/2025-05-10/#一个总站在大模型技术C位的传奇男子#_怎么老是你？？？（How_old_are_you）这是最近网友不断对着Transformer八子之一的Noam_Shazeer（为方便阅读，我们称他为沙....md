...
Noam Shazeer（沙哥）是Transformer八位核心作者中公认贡献最大的一位，其研究成果贯穿当今大模型技术发展的关键节点。作为《Attention Is All You Need》的核心作者（论文引用超17万次），他先后推动了MoE架构、Adafactor优化算法、多查询注意力机制、门控线性层（GLU）等突破性技术。近期Meta研究员发现其3-token因果卷积研究比行业早三年，引发网友惊叹"他可能是时间旅行者"。从谷歌到创业Character.AI再回归，Shazeer持续引领LLM架构演进，被业界视为奠定当代大模型技术基石的传奇人物。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T08:03:28Z
- **目录日期**: 2025-05-10
