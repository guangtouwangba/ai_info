...
Noam Shazeer（沙哥）是Transformer八位核心作者中公认贡献最大的一位，其研究贯穿当今大模型关键技术发展。作为《Attention Is All You Need》的核心作者（论文引用超17万次），他提出的多项技术（如MoE架构、Adafactor算法、多查询注意力、门控线性层等）已成为行业基础。近期Meta研究员朱泽园团队的新成果再次印证了他3年前的前瞻性研究，被网友戏称为"时间旅行者"。这位低调的AI先驱虽不常曝光，但其奠基性工作深刻塑造了当代大模型技术演进路径，堪称"站在大模型技术C位的传奇人物"。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T22:03:06Z
- **目录日期**: 2025-05-10
