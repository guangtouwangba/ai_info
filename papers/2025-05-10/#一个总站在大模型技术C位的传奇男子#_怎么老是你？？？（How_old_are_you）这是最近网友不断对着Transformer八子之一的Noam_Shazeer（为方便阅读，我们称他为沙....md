...
Noam Shazeer（昵称"沙哥"）是Transformer论文八位作者中公认贡献最大者，被誉为"总是站在大模型技术C位的传奇人物"。作为谷歌资深研究员，他在多个AI突破性技术中扮演关键角色：提出注意力机制（《Attention is All You Need》引用量超17万）、将MoE引入LLM、开发Adafactor优化算法、多查询注意力机制等。近期Meta研究员朱泽园发现，其团队最新研究的3-token因果卷积技术，沙哥团队三年前已有相关成果。因其持续的前瞻性贡献，业界戏称他可能是"时间旅行者"，并认为当前大模型时代本质是"Noam Shazeer时代"。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T11:03:09Z
- **目录日期**: 2025-05-10
