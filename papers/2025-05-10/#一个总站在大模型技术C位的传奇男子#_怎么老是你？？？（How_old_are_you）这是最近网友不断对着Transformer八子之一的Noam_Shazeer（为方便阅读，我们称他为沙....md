...
Noam Shazeer（沙哥）是Transformer八位核心作者中公认贡献最大的一位，被誉为"总站在大模型技术C位的传奇男子"。作为AI领域的关键奠基者，他在《Attention is all you need》（引用量超17万次）、MoE架构、Adafactor算法、多查询注意力机制等突破性技术中均发挥核心作用。近期Meta研究员发现其3年前的工作已预见当前研究趋势，引发"他可能是时间旅行者"的调侃。从谷歌到创业公司Character.AI再回归谷歌，Shazeer的成果持续引领大模型技术演进，被业界称为生活在"Noam Shazeer时代"。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-10T18:03:22Z
- **目录日期**: 2025-05-10
