...
该研究提出了一种多智能体系统中协作满足长期空间约束的方法。每个智能体都受到空间不等式约束的影响，这些约束可能依赖于其他智能体的位置，且无需直接通信。目标是通过集中式优化框架，最大化约束满足度函数，使智能体在满足自身约束的同时协助其他智能体。当约束不可行时，系统会收敛到最小违规解。研究还开发了基于分布式共识的优化方案，近似集中式解，并设计了单积分器智能体的分布式控制器。仿真验证了该方法的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T22:01:29Z
- **目录日期**: 2025-03-26
