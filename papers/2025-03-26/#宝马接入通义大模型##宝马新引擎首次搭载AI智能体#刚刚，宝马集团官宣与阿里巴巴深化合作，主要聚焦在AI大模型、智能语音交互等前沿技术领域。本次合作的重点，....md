...
宝马集团与阿里巴巴深化合作，将通义大模型接入宝马新世代车型，打造AI智能引擎。该引擎结合通义模型和斑马元神AI，首次搭载AI Agent，实现模糊语义理解和逻辑推演。新车型预计2026年在中国交付，上海车展将提前展示智能座舱。阿里云已服务90%以上汽车品牌，包括国内外主流车企。通义千问大模型也与苹果、传音等手机厂商合作，部分机型已内置该模型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T17:03:52Z
- **目录日期**: 2025-03-26
