...
随着机器学习/人工智能在自动化决策中的广泛应用，对可验证计算的需求日益增长。本研究探讨了自主决策中可验证计算的问题，提出了一个基于采样的协议，相比现有方法更快速、经济且简单。此外，针对非确定性带来的挑战，研究提出了一系列策略来有效管理常见场景。该工作为提升自动化决策系统的可靠性和透明度提供了实用解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T00:01:43Z
- **目录日期**: 2025-03-26
