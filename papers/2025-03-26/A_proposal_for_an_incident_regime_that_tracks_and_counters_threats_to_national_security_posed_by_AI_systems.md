...
近期AI能力的快速发展引发了对国家安全威胁的担忧，如恶意网络攻击或自主AI系统失控。为此，美国立法者提出建立"AI事件管理机制"应对此类风险。本文提出一个法定的事后部署AI事件管理方案，将可能威胁国家安全的领域定义为"安全关键领域"(如核能、航空、生物双用途研究等)，并参照其他关键领域的现有机制设计了三阶段方案：1)部署前沿AI前需提交"国家安全案例"；2)发生事件时向政府报告；3)政府参与修正安全措施。该方案旨在通过制度化管理降低AI系统带来的国家安全风险。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T15:19:18Z
- **目录日期**: 2025-03-26
