...
AdaWorld是一种创新的世界模型学习方法，通过自监督方式从视频中提取潜在动作，捕捉帧间关键变化，并在预训练中融入动作信息。该方法构建了基于潜在动作的自回归世界模型，显著提升了模型在新环境中的适应能力。相比依赖大量标注数据和昂贵训练的现有方法，AdaWorld能在有限交互和微调下高效学习新动作，实现跨领域迁移。多环境实验表明，AdaWorld在仿真质量和视觉规划方面均优于现有方法，为智能代理开发提供了更高效、适应性更强的解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T01:28:25Z
- **目录日期**: 2025-03-26
