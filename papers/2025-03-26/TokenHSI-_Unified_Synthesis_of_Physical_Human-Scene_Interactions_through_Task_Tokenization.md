...
TokenHSI提出了一种基于Transformer的统一策略，用于合成多样且物理合理的人-场景交互（HSI）。传统方法依赖多个独立控制器，难以处理需要多技能整合的复杂任务。TokenHSI将人体本体感知建模为共享令牌，并通过掩码机制与不同任务令牌结合，实现跨技能知识共享和多任务训练。该架构支持可变长度输入，使学习技能能灵活适应新场景。通过额外任务标记器，可修改交互目标的几何形状并协调多技能处理复杂任务。实验表明，TokenHSI显著提升了HSI任务的通用性、适应性和可扩展性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T14:01:33Z
- **目录日期**: 2025-03-26
