...
TokenHSI提出了一种基于Transformer的统一策略模型，用于合成多样且物理合理的人-场景交互(HSI)。传统方法依赖独立控制器，难以处理需要多技能整合的复杂任务。该模型通过将人体本体感知建模为共享token，并结合任务token的掩码机制，实现跨技能知识共享和多任务训练。其架构支持可变长度输入，可灵活适应新场景，并通过任务token修改交互目标几何或协调多技能完成复杂任务。实验表明，该方法显著提升了HSI任务的通用性、适应性和可扩展性。项目网站：https://liangpan99.github.io/TokenHSI/ （100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T17:01:01Z
- **目录日期**: 2025-03-26
