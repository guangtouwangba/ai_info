...
TokenHSI提出了一种基于Transformer的统一策略模型，用于合成多样化且物理合理的人-场景交互(HSI)。该方法通过将人体本体感觉建模为共享令牌，并结合不同任务令牌的掩码机制，实现了多技能的统一和灵活适应。相比现有专注于单一任务的独立控制器，TokenHSI支持可变长度输入，促进跨技能知识共享和多任务训练。通过添加任务标记器，不仅能修改交互目标的几何形状，还能协调多个技能处理复杂任务。实验表明，该方法显著提升了HSI任务的通用性、适应性和可扩展性。项目网站：https://liangpan99.github.io/TokenHSI/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T21:01:02Z
- **目录日期**: 2025-03-26
