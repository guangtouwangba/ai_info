...
TokenHSI提出了一种基于Transformer的统一策略模型，用于合成多样且物理合理的人-场景交互(HSI)。该模型通过将人体本体感知建模为共享令牌，并结合任务特定令牌，实现了多技能统一和灵活适应。其架构支持可变长度输入，便于将学习技能迁移到新场景。通过训练额外任务分词器，不仅能修改交互目标的几何形状，还能协调多种技能处理复杂任务。实验表明，该方法显著提升了HSI任务中的多功能性、适应性和可扩展性。相比现有专注于单一任务的控制器，TokenHSI能更好地整合多种技能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T11:01:03Z
- **目录日期**: 2025-03-26
