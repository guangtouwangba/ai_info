...
TokenHSI提出了一种基于Transformer的统一策略模型，用于合成多样且物理合理的人-场景交互(HSI)。该方法通过将人体本体感知建模为共享令牌，并与不同任务令牌结合，实现了多技能统一和灵活适应。相比现有专注于单一任务的控制器，TokenHSI支持可变长度输入，能协调多种技能处理复杂任务（如持物坐下）。通过训练额外任务标记器，可修改交互目标的几何形状并整合多个技能。实验表明，该方法显著提升了HSI任务的通用性、适应性和可扩展性。项目网站：https://liangpan99.github.io/TokenHSI/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T22:00:53Z
- **目录日期**: 2025-03-26
