...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟10,000+智能代理及其500万次互动。该系统通过真实社会环境和强大模拟引擎，研究了四大社会问题：群体极化、信息传播、基本收入政策及自然灾害影响。其模拟结果与现实世界数据高度吻合，验证了该系统捕捉人类行为机制的能力。研究表明，AgentSociety能有效补充传统社会科学研究方法（如调查、访谈），为研究者和政策制定者提供新型分析工具。该成果发表于AMiner平台，展示了LLM在社会仿真领域的应用潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T11:05:20Z
- **目录日期**: 2025-03-26
