...
AgentSociety是一个基于大语言模型的大规模社会模拟器，能够模拟超过1万个代理及其500万次互动。研究者利用该平台研究了四个关键社会问题：社会极化、刺激性信息传播、无条件基本收入政策影响以及外部冲击（如飓风）效应。模拟结果与现实世界数据高度吻合，验证了该工具在分析人类行为和社会机制方面的有效性。这一突破性成果展示了AgentSociety作为社会科学研究和政策制定辅助工具的潜力，为理解复杂社会现象提供了新方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T22:04:45Z
- **目录日期**: 2025-03-26
