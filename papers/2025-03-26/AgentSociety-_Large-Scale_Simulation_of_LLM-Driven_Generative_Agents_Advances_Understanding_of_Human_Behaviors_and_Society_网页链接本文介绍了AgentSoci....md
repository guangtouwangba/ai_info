...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟器，能够模拟1万多个代理的社会生活及500万次互动。研究者用它研究了四个关键社会问题：社会极化、刺激性信息传播、无条件基本收入政策影响和外部冲击（如飓风）。模拟结果与现实世界实验吻合，验证了该工具在捕捉人类行为机制方面的能力，展示了其作为社会科学研究和政策制定辅助工具的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T23:12:01Z
- **目录日期**: 2025-03-26
