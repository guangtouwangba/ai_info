...
该研究探讨了如何利用速度跳跃模型描述一维空间中单个运动实体的轨迹数据。模型假设实体在有限状态网络中进行马尔可夫转换，每个状态具有特定速度和固定转换率。针对无法直接观测隐藏状态、仅能获取离散噪声观测数据的情况，研究者提出了一系列近似分布方法。通过四种模型结构的仿真对比验证，这些近似在状态转换频率低于成像频率时表现良好。所得近似分布可用于快速预测、实验设计指导，以及作为模型选择和推断的似然函数。研究为处理高分辨率时空追踪数据提供了实用数学工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T20:02:13Z
- **目录日期**: 2025-03-26
