...
本文研究了一维空间中单智能体运动的"速度跳跃"模型，该模型通过有限状态网络描述个体运动状态转换。针对无法直接观测隐藏状态、只能获取离散噪声观测数据的情况，作者提出了一系列近似分布方法来解决精确分布难以求解的问题。通过四个模型实例的仿真验证，证明在状态转换频率足够低于观测频率时，这些近似方法具有良好准确性。这些近似分布可用于快速预测、指导实验设计，并作为模型选择和推断的似然函数。研究为处理高分辨率时空追踪数据提供了有效的数学建模工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T10:02:32Z
- **目录日期**: 2025-03-26
