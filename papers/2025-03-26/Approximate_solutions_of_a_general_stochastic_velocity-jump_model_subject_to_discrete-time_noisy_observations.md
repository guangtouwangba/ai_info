...
这篇论文研究了如何利用速度跳跃模型描述一维空间中单个运动体的轨迹。该模型基于有限状态网络，每个状态具有特定速度和固定切换速率。由于无法直接观测隐藏状态，精确分布难以求解，因此作者提出了一系列近似方法来估计数据分布。通过四种模型结构的仿真对比验证，这些近似方法在状态切换频率低于成像频率时表现良好。所得近似分布可用于快速正向预测、指导实验设计，并作为推断和模型选择的似然函数。研究为处理高分辨率时空追踪数据提供了有效的数学建模工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T19:02:13Z
- **目录日期**: 2025-03-26
