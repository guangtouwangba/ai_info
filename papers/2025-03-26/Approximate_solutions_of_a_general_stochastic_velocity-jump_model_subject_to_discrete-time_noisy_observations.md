...
这篇论文研究了一维空间中单智能体速度跳跃模型的解，该模型通过有限状态网络中的马尔可夫转换描述运动，每个状态具有特定速度和固定切换速率。针对无法直接观测隐藏状态、仅能获取离散时间噪声观测数据的情况，作者提出了一系列近似分布方法来解决精确分布难以求解的问题。通过四种模型结构的仿真实验验证，这些近似分布在状态切换频率足够低于观测频率时表现准确。这些近似分布可用于快速预测、实验设计指导以及作为模型选择和推断的似然函数。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T12:02:48Z
- **目录日期**: 2025-03-26
