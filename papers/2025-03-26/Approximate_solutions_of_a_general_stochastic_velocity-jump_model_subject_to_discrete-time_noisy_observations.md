...
该研究针对高分辨率时空追踪数据，提出了一种基于速度跳跃模型的单代理一维运动建模方法。模型通过有限状态网络描述运动状态转换，每个状态具有特定速度和固定转换率。针对无法直接观测隐藏状态且存在离散噪声观测的问题，研究推导了一系列数据分布的近似解。通过四个模型实例的仿真验证，证实当状态转换频率低于成像频率时，近似解具有良好准确性。这些近似分布可用于快速预测、实验设计指导，以及作为模型选择和推断的似然函数。研究成果为分析个体运动轨迹数据提供了有效工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T08:02:00Z
- **目录日期**: 2025-03-26
