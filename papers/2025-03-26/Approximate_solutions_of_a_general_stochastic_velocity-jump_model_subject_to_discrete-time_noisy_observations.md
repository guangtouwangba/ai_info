...
该研究探讨了如何利用速度跳跃模型分析一维空间中单个运动体的轨迹数据。研究者针对离散时间观测且无法直接获取运动体状态的情况，提出了一系列近似分布方法，以解决精确分布难以计算的问题。通过四种模型结构的仿真实验验证，这些近似方法在状态切换频率低于成像频率时表现良好。所得近似分布可用于快速预测、实验设计指导，以及作为推断和模型选择的似然函数。研究为处理高分辨率时空追踪数据提供了有效的数学建模工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T22:02:07Z
- **目录日期**: 2025-03-26
