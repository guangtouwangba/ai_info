...
这篇论文针对代码生成大模型(codeLLMs)提出新评估方法CodeArena，关注人类偏好对齐问题。研究者从真实用户查询中精选397个样本，覆盖40类任务和44种编程语言，构建更贴近实际编程场景的基准测试。同时开发了包含近200亿标记的合成指令数据集SynCode-Instruct用于模型微调。实验发现传统执行基准与人类偏好评估存在差距，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)表现差异显著，凸显了人类偏好对齐在代码生成任务中的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T23:12:37Z
- **目录日期**: 2025-03-26
