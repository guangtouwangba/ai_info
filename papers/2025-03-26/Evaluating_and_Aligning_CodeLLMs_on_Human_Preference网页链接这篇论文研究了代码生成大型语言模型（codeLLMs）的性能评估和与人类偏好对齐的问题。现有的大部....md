...
这篇论文针对代码生成大模型(codeLLMs)提出新的评估方法，强调与人类偏好对齐的重要性。研究者创建了CodeArena基准测试(包含397个高质量样本，覆盖40类任务和44种语言)，并构建近200亿标记的SynCode-Instruct合成指令集。实验发现：1)传统执行测试与人类偏好存在差异；2)开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究突出了在代码生成任务中考虑人类偏好的必要性，为改进代码LLMs提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T06:05:43Z
- **目录日期**: 2025-03-26
