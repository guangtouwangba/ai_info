...
本文综述了非小细胞肺癌(NSCLC)治疗中ALK基因双靶点抑制剂的最新进展。ALK基因作为NSCLC的关键致癌驱动因子，现有7种靶向药已获批用于ALK融合阳性患者，但耐药性问题突出。研究指出，相比联合用药，单一分子同时抑制双靶点的抑制剂能降低副作用和毒性，更有效应对耐药挑战。文章系统总结了ALK双靶点抑制剂的设计策略、结构-活性关系及临床应用前景，为开发新型靶向疗法提供了重要参考，对改善NSCLC治疗具有积极意义。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T02:35:56Z
- **目录日期**: 2025-03-26
