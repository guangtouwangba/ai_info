...
OpenAI推出GPT-4o图像生成功能，能精准渲染文本并严格遵循指令。该功能支持多轮对话完善细节，如将白板文字、人物动作等复杂要求准确呈现。案例显示，它能保持角色一致性，并理解构图、道具等深度需求。用户可通过逐步调整（如从基础图像添加游戏UI元素）实现精细化创作。该功能将逐步开放给Plus至免费用户，并整合至Sora。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T05:01:33Z
- **目录日期**: 2025-03-26
