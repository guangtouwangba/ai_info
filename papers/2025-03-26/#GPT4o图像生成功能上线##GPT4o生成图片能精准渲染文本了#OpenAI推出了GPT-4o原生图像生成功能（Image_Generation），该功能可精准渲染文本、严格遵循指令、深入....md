# #GPT4o图像生成功能上线##GPT4o生成图片能精准渲染文本了#OpenAI推出了GPT-4o原生图像生成功能（Image Generation），该功能可精准渲染文本、严格遵循指令、深入...
...
OpenAI推出GPT-4o原生图像生成功能，具备精准文本渲染、严格指令执行和多轮细节调整能力。典型案例包括：1）将用户指定的超长文字准确呈现在白板上；2）保持角色一致性并还原隐藏摄影师；3）精确呈现女巫道具和路标内容。该功能支持渐进式创作，如从基础猫咪图像逐步完善为带游戏UI的3A风格画面。该功能将逐步开放给Plus/Pro/Team及免费用户，并整合至Sora系统。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T06:03:37Z
- **目录日期**: 2025-03-26
