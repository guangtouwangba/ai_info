...
谷歌与普林斯顿、纽约大学联合研究发现，Whisper语音模型的内部处理机制与人类大脑语言处理路径高度吻合。该模型未经大脑数据训练，却能精准预测大脑不同区域在语音理解（STG听觉区→IFG语义区）和语言产出（IFG→MC运动皮层→STG听觉反馈）时的神经活动顺序与时间点。研究表明，AI与大脑在语言处理的底层计算逻辑（如上下文预测、表征方式）存在本质相似性，这一发现可能推动脑机接口和认知神经科学发展，使AI成为解码人类思维的"翻译官"。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T16:03:40Z
- **目录日期**: 2025-03-26
