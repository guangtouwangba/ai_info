...
谷歌与普林斯顿、NYU合作研究发现，Whisper语音模型的内部处理机制与人类大脑语言处理路径高度吻合。该模型未经大脑数据训练，却能精准预测大脑不同区域（如STG听觉区、IFG语义区、MC运动皮层）在语音理解、思考和表达各阶段的激活顺序与时间点。研究表明AI与大脑在预测性处理（如下一词预测）、上下文表征等底层计算逻辑存在共性，可能为脑机接口和认知科学研究提供新突破。这种自发对齐现象暗示AI或能成为解码人类思维的"翻译官"。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T15:21:12Z
- **目录日期**: 2025-03-26
