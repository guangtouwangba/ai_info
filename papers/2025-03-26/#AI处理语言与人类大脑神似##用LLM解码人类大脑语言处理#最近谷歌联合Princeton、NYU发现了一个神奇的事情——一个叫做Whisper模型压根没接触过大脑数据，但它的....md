...
谷歌与普林斯顿、纽约大学联合研究发现，Whisper语音模型的内部处理机制与人类大脑语言处理路径高度吻合。该模型未经大脑数据训练，却能精准预测大脑不同区域（如听觉区STG、语义区IFG、运动皮层MC）在语音理解、生成及自我监听时的激活顺序和时间点。研究表明，AI与大脑在语言处理的底层计算逻辑（如预测下一词、上下文表征）存在本质相似性。这一发现为脑机接口和认知神经科学提供了新思路，AI或将成为解码人类思维的"翻译官"。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T19:02:57Z
- **目录日期**: 2025-03-26
