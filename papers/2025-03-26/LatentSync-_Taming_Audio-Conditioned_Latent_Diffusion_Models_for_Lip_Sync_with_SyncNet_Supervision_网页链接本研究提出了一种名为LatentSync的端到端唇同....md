...
本研究提出LatentSync，一种基于音频条件潜在扩散模型的端到端唇同步框架。该框架直接建模音频-视觉关系，无需中间运动表示，克服了传统方法的时间一致性问题。创新点包括：1) 提出TREPA方法增强时间一致性；2) 改进SyncNet训练框架，解决收敛问题；3) 在HDTF和VoxCeleb2数据集上性能超越现有方法。研究还分析了影响SyncNet性能的关键因素，为相关领域提供参考。该方法利用Stable Diffusion的强大能力，实现了高质量的唇同步效果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T09:07:31Z
- **目录日期**: 2025-03-26
