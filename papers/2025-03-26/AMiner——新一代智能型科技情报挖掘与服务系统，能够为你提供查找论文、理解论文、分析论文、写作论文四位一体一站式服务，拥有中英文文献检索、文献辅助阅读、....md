...
AMiner是一个智能科技情报挖掘平台，提供四位一体的学术服务：查找、理解、分析和写作论文。它支持中英文文献检索、辅助阅读、翻译等功能，涵盖42个学科的3.5亿论文、0.6亿学者和1.5亿专利。用户可通过互动问答快速获取文献摘要，提升研究效率。平台还支持PDF上传、AI摘要生成及内容问答，并提供科研动态订阅服务，按用户偏好推送最新成果。此外，AMiner包含学者画像、学术会议等特色功能，基础服务免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T11:05:52Z
- **目录日期**: 2025-03-26
