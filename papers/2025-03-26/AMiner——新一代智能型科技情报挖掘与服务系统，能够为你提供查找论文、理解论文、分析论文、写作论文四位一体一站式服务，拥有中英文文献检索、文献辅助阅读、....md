...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、翻译、科研情报订阅等。它拥有3.5亿论文、0.6亿学者等海量数据，支持文献辅助阅读、自动摘要生成和智能问答，帮助用户高效筛选和理解学术内容。用户可通过订阅功能获取最新科研动态，还能使用学者画像、学术会议专题等特色功能。平台支持免费使用，适合科研人员和学生快速获取学术资源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T08:05:39Z
- **目录日期**: 2025-03-26
