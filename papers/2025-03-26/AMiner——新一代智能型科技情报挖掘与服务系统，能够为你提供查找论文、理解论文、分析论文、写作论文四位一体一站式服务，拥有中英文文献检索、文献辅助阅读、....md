...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献搜索，拥有3.5亿论文、0.6亿学者等海量数据。主要功能包括：1）互动式文献检索与自动摘要生成；2）英文文献翻译与AI辅助阅读；3）个性化科研情报订阅推送。平台还提供学者画像、学术会议等特色功能，可通过浏览器免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T13:12:41Z
- **目录日期**: 2025-03-26
