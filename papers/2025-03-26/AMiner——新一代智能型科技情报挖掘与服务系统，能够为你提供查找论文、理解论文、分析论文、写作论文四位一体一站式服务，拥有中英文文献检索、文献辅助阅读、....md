...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和分析等一站式服务。它收录了3.5亿篇论文、0.6亿学者和1.5亿专利，支持中英文文献检索、AI生成摘要和互动问答功能。用户可上传PDF或从平台获取论文，系统能快速生成摘要和章节概要。此外，AMiner提供科研动态订阅服务，根据用户偏好推送最新学术资讯。平台还包含学者画像、学术会议和论文排行榜等功能，可通过浏览器免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T09:07:40Z
- **目录日期**: 2025-03-26
