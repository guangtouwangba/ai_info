...
AMiner是一个智能科技情报挖掘系统，提供论文检索、阅读、分析和写作的一站式服务。它拥有42个学科的3.5亿论文、0.6亿学者和1.5亿专利数据，支持中英文文献检索、AI辅助阅读、自动摘要生成和翻译功能。用户可通过互动问答快速理解文献内容，还能订阅个性化科研动态推送。平台还提供学者画像、学术会议和必读论文专题等功能，支持免费使用。AMiner通过AI技术简化科研流程，帮助用户高效获取学术信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T21:05:04Z
- **目录日期**: 2025-03-26
