...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作一站式服务。它支持中英文文献搜索、AI辅助阅读、自动摘要生成及翻译功能，覆盖42个学科3.5亿论文。用户可通过互动问答快速理解文献，或订阅个性化科研动态推送。平台还支持PDF上传解析、学者画像分析及学术会议追踪，基础功能免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T14:08:44Z
- **目录日期**: 2025-03-26
