...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译和科研订阅等一站式服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持中英文文献检索、AI生成摘要、互动问答和文档翻译。用户可订阅个性化科研动态，追踪学者和机构最新成果。平台还提供学者画像、学术会议和论文排行榜等功能，支持浏览器免费使用。AMiner通过AI技术帮助用户高效筛选文献、理解内容和撰写论文，显著提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T15:23:42Z
- **目录日期**: 2025-03-26
