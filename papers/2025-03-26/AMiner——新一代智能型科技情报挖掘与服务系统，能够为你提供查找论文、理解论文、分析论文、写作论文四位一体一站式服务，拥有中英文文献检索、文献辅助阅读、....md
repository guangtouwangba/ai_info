...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、辅助阅读、翻译和科研情报订阅。它拥有3.5亿论文、0.6亿学者等海量数据，支持互动问答、自动摘要生成和文献翻译功能。用户可定制订阅最新科研动态，并通过学者画像、会议专题等工具高效获取信息。平台还支持文档上传和AI辅助分析，帮助用户快速理解论文内容。免费使用，适合科研人员提升效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T05:03:44Z
- **目录日期**: 2025-03-26
