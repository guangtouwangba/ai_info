...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、翻译、辅助阅读和分析功能。平台收录3.5亿论文、0.6亿学者和1.5亿专利，支持互动问答、自动摘要生成和科研动态订阅。用户可通过关键词、学者或机构定制推送，并通过微信或邮件获取最新研究。此外，AMiner还提供学者画像、学术会议和论文排行榜等功能，浏览器版本可免费使用。访问入口：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T17:05:23Z
- **目录日期**: 2025-03-26
