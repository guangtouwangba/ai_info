...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译和分析等一站式服务。它拥有庞大的学术数据库（3.5亿论文、0.6亿学者等），支持中英文文献检索、AI生成摘要和互动问答，帮助用户快速理解论文内容。此外，AMiner还提供科研动态订阅、学者画像等功能，可通过微信或邮件推送个性化学术资讯。平台支持文档上传和智能解析，并免费开放基础功能。访问入口：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T18:05:08Z
- **目录日期**: 2025-03-26
