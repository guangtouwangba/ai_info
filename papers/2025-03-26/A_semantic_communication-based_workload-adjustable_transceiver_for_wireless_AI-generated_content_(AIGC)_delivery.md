...
本文提出了一种基于语义通信（SemCom）的资源感知可调工作负载收发器（ROUTE），用于动态无线网络中AI生成内容（AIGC）的高效传输。通过SemCom优先传输生成内容的关键语义信息，缓解通信资源瓶颈；同时采用改进的扩散模型，在边缘和本地协同生成内容时动态调整计算负载和语义密度，提升资源利用率并减少语义失真。实验表明，与传统AIGC方法相比，ROUTE在传输延迟和内容质量方面具有显著优势。该方案有效解决了无线网络信道不稳定、带宽有限和计算资源分布不均等挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T00:02:01Z
- **目录日期**: 2025-03-26
