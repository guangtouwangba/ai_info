...
本文提出了一种面向动态无线网络的资源感知可调工作负载收发器（ROUTE），用于高效传输AI生成内容（AIGC）。针对无线网络中的信道不稳定、带宽有限和计算资源分布不均等问题，该方案结合语义通信（SemCom）和扩散模型：1）通过SemCom优先传输生成内容的关键语义信息以缓解通信资源瓶颈；2）采用改进的扩散模型动态调整边缘/本地计算负载和语义密度，提升计算资源利用率并减少传输中的语义失真。实验表明，相比传统方法，ROUTE在延迟和内容质量方面表现更优。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T04:01:48Z
- **目录日期**: 2025-03-26
