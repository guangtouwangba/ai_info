...
本文提出了一种基于语义通信的资源感知可调收发器（ROUTE），用于动态无线网络中AI生成内容（AIGC）的高效传输。针对无线网络中的信道不稳定、带宽有限和计算资源分布不均等问题，ROUTE利用语义通信优先传输生成内容的关键语义信息，缓解通信资源瓶颈。同时，通过改进的扩散模型动态调整计算负载和语义密度，提升边缘与本地计算资源利用率，减少传输中的语义失真。实验表明，与传统AIGC方法相比，ROUTE在延迟和内容质量方面具有显著优势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T01:28:54Z
- **目录日期**: 2025-03-26
