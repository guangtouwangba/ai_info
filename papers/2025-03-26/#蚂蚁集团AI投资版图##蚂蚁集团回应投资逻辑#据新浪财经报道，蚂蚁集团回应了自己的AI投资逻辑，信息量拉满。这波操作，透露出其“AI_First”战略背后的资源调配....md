...
蚂蚁集团近期披露其AI投资布局，覆盖多个关键领域：智谱AI和月之暗面（大模型研发）、墨芯科技与清微智能（AI芯片与算力）、深度赋智（AI Agent框架）、星海图（具身智能）、秘塔科技等（AI应用工具）。其战略核心是推动AI从概念向产业化过渡，重点关注大模型与具身智能的融合，认为这是未来技术突破的关键方向。投资逻辑强调长期投入，以技术底层（算法、芯片）到应用层（工具、智能体）的全链路布局，巩固"AI First"战略资源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T23:11:05Z
- **目录日期**: 2025-03-26
