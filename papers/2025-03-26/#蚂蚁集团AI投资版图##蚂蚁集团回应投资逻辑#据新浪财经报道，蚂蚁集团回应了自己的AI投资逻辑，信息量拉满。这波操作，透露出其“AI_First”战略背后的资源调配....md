...
蚂蚁集团近期披露了其AI投资布局，展现出"AI First"战略。投资覆盖多个维度：大模型领域投资智谱AI和月之暗面；算力芯片方向布局墨芯科技和清微智能；AI Agent方向支持深度赋智；具身智能领域投资星海图；应用层投资秘塔科技、爱诗科技等。蚂蚁认为AI正从概念期迈向产业化，特别看好大模型与具身智能的融合潜力。这一系列投资反映了其对AI技术长期投入的决心，以及把握下一代技术爆发的战略眼光。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T16:04:36Z
- **目录日期**: 2025-03-26
