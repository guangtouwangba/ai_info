...
蚂蚁集团近期披露了其AI投资布局，展现出"AI First"的战略方向。投资覆盖多个领域：智谱AI和月之暗面专注大模型研发；墨芯科技和清微智能聚焦AI芯片；深度赋智开发AI Agent框架；星海图探索具身智能；秘塔科技等公司开发AI应用工具。蚂蚁认为AI正从概念走向产业化，特别看好大模型与具身智能的融合潜力。这一布局体现了对AI技术长期投入的决心，旨在把握下一代技术发展机遇。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T09:05:52Z
- **目录日期**: 2025-03-26
