...
蚂蚁集团近期披露其"AI First"战略投资布局，涵盖多个AI细分领域：大模型方向投资智谱AI和月之暗面；算力芯片方向布局墨芯科技和清微智能；智能体领域投资深度赋智；具身智能方向支持星海图；应用层投资秘塔科技等企业。该布局反映出蚂蚁对AI产业化趋势的判断，尤其看好大模型与具身智能的融合潜力，强调长期技术投入的重要性。通过系统性投资构建完整AI生态，覆盖从底层芯片到上层应用的全产业链。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T21:03:49Z
- **目录日期**: 2025-03-26
