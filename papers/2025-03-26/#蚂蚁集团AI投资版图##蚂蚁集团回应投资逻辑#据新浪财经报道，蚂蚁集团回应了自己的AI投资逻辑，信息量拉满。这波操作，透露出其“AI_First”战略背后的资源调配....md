...
蚂蚁集团近期公开了其AI投资布局，展现出"AI First"的战略方向。投资覆盖多个领域：大模型（智谱AI、月之暗面）、AI算力芯片（墨芯科技、清微智能）、AI智能体（深度赋智）、具身智能（星海图）以及AI应用工具（秘塔科技等）。蚂蚁认为AI技术正从概念走向产业化，需长期投入，并特别看好大模型与具身智能的融合潜力。这一布局反映了其对AI全产业链的前瞻性投资逻辑，旨在把握下一代技术爆发的关键节点。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T12:04:48Z
- **目录日期**: 2025-03-26
