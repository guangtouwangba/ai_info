...
蚂蚁集团近期披露了其AI投资布局，展现出"AI First"战略。投资涵盖多个领域：大模型方向包括智谱AI和月之暗面；AI算力与芯片方向投资了墨芯科技和清微智能；AI Agent方向布局深度赋智；具身智能方向涉及星海图；AI应用方向投资了秘塔科技、爱诗科技等。蚂蚁认为AI技术正从概念期迈向产业化，需要长期投入，并指出大模型与具身智能的融合将是未来技术爆发的核心。这一布局体现了蚂蚁对AI产业化的系统性思考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T07:01:43Z
- **目录日期**: 2025-03-26
