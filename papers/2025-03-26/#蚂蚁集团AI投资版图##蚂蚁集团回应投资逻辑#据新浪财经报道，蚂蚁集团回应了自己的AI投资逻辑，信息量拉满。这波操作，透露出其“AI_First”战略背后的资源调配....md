...
蚂蚁集团近期披露了其"AI First"战略投资布局，主要覆盖5大方向：1）大模型领域投资智谱AI和月之暗面；2）AI芯片领域布局墨芯科技和清微智能；3）智能体方向投资深度赋智；4）具身智能领域涉足星海图；5）AI应用层投资秘塔科技等企业。该布局显示蚂蚁看好大模型与具身智能的技术融合，认为AI正从概念验证进入产业化阶段，需要长期投入。这些投资旨在构建从底层芯片到上层应用的完整AI生态链。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T20:03:49Z
- **目录日期**: 2025-03-26
