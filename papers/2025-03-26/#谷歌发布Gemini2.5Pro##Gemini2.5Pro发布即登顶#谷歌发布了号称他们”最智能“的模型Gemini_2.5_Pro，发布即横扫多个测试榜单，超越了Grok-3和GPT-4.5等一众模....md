...
谷歌发布新一代AI模型Gemini 2.5 Pro，号称是其"最智能"的推理模型。该模型在多项基准测试中表现优异，登顶LMArena文字、通用和视觉榜单，超越Grok-3、GPT-4.5等竞争对手。在"人类最后的考试"推理测试中获得18.8%的最高分。演示中能快速生成可运行的代码，如根据简单指令创建跑酷游戏。目前已在Google AI Studio和Gemini应用中上线，供高级用户使用，具体定价将在未来几周公布。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T05:01:25Z
- **目录日期**: 2025-03-26
