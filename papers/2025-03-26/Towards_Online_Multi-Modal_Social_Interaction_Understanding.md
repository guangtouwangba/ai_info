...
该研究提出了一种在线多模态社交交互理解框架(Online-MMSI-VLM)，用于解决AI代理在实时交互中无法利用未来上下文的问题。该框架采用两种互补策略：1)通过粗到细的多方对话预测模拟未来可能的对话内容，先预测说话人轮次再生成详细对话；2)利用社交感知视觉提示，通过边界框和人体关键点突出视频中的社交动态。实验表明，该方法在三个任务和两个数据集上均达到最先进水平，显著优于基线模型。代码和预训练模型将公开发布。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T22:01:59Z
- **目录日期**: 2025-03-26
