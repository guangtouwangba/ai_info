...
该研究提出了在线多模态社交交互理解框架Online-MMSI-VLM，用于解决AI系统在实时交互中无法利用未来上下文的问题。该框架采用两种策略：1）通过粗到细的多方对话预测模拟未来可能的对话内容；2）利用社交感知视觉提示（如边界框和人体关键点）突出视频中的社交动态。实验表明，该方法在三个任务和两个数据集上均优于基线模型，实现了最先进的性能。代码和预训练模型将开源。该研究为实时人机交互提供了有效解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T13:08:59Z
- **目录日期**: 2025-03-26
