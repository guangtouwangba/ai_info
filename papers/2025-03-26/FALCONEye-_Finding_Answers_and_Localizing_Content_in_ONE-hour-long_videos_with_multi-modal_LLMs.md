...
FALCONEye是一种新型视频检索系统，结合视觉语言模型(VLM)和大语言模型(LLM)，专门解决长达1小时以上视频中的信息定位难题。其创新点包括：1)针对长视频优化的元架构；2)基于短片段、字幕和置信度的高效搜索算法；3)先进的VLM置信度校准技术。该系统能在标准计算资源上运行，并在新发布的FALCON-Bench长视频基准测试中表现优于现有技术，同时在相关测试中达到相当或更好的性能。该研究还发布了首个专注于超长视频(平均>1小时)开放问题评估的基准测试集。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T17:01:58Z
- **目录日期**: 2025-03-26
