...
BrainNRDS利用先进的视频扩散模型，将静态图像表征与动态运动生成解耦，通过fMRI脑活动数据解码人类对动态视觉刺激的响应。研究发现：1）从观看视频的脑活动中可解码细粒度物体级光流；2）视频编码器在预测视频驱动的脑活动时优于图像模型；3）基于脑解码运动信号可实现仅用首帧视频的真实重动画；4）扩展了从脑活动完整解码视频的能力。该研究揭示了大脑如何处理动态视觉场景的时空信息，展示了脑成像与视频扩散模型结合开发生物启发的鲁棒计算机视觉系统的潜力。详见项目网站：https://brain-nrds.github.io/。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T06:02:32Z
- **目录日期**: 2025-03-26
