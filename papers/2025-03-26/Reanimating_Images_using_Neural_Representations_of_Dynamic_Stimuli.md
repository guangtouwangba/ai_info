...
这篇论文介绍了BrainNRDS方法，通过结合fMRI脑成像数据和视频扩散模型，研究人类对动态视觉刺激的理解。研究发现：(1) 可以从观看视频时的大脑活动中解码出精细的光流运动信息；(2) 视频编码器在预测大脑活动方面优于静态图像模型；(3) 仅用视频首帧和大脑解码的运动信号就能实现视频重生成；(4) 实现了从大脑活动完整解码视频。该方法推进了对大脑时空信息处理机制的理解，展示了脑成像与视频模型结合开发生物启发的计算机视觉系统的潜力。更多示例见项目网站。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T10:02:42Z
- **目录日期**: 2025-03-26
