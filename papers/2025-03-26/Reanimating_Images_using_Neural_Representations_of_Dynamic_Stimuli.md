...
BrainNRDS利用视频扩散模型分离静态图像表征与动态运动生成，通过fMRI脑活动数据深入解析人类对动态视觉刺激的响应。研究发现：1) 从观看视频的脑活动中可解码出细粒度光流运动表征；2) 视频编码器在预测视频诱发的脑活动时优于图像模型；3) 基于脑解码运动信号可实现仅用首帧的视频逼真重动画；4) 实现了从脑活动完整解码视频。该研究揭示了大脑处理动态视觉时空信息的机制，为开发生物启发的鲁棒计算机视觉系统提供了新思路。项目网站展示更多解码案例。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T15:20:20Z
- **目录日期**: 2025-03-26
