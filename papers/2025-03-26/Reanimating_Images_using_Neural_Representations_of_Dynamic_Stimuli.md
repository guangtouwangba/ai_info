...
BrainNRDS利用先进的视频扩散模型，将静态图像表征与动态运动生成分离，通过fMRI脑活动数据深入解析人类对动态视觉刺激的响应。研究发现：1）从观看视频的受试者脑活动中可解码出细粒度光流运动信息；2）视频编码器在预测视频驱动的脑活动时优于图像模型；3）基于脑解码的运动信号可实现仅用视频首帧的真实视频重动画；4）首次实现从脑活动完整解码视频。该研究揭示了大脑处理动态视觉时空信息的机制，为开发生物启发的鲁棒计算机视觉系统提供了新思路。详见项目网站：https://brain-nrds.github.io/。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T17:02:27Z
- **目录日期**: 2025-03-26
