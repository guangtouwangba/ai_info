...
这篇论文介绍了BrainNRDS方法，利用视频扩散模型分离静态图像表征与动态运动生成，通过fMRI脑活动数据研究人类对动态视觉刺激的响应。研究发现：(1) 从观看视频的脑活动中可解码出细粒度光流运动信息；(2) 视频编码器在预测视频驱动的脑活动方面优于图像模型；(3) 仅需视频首帧即可通过脑解码信号实现视频重动画；(4) 实现了从脑活动完整解码视频。该方法结合脑成像与视频扩散模型，推进了对时空信息神经表征的理解，为开发更具生物启发性的计算机视觉系统提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T18:02:28Z
- **目录日期**: 2025-03-26
