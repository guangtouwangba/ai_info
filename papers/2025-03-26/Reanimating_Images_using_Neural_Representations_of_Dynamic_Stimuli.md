...
BrainNRDS利用先进的视频扩散模型，将静态图像表征与动态运动生成解耦，通过fMRI脑活动数据解析人类对动态视觉刺激的响应。研究发现：1）从观看视频的脑活动中可解码出细粒度物体级光流运动信息；2）视频编码器在预测视频驱动的脑活动时优于图像模型；3）基于脑解码的运动信号能仅用视频首帧实现逼真视频重动画；4）实现了从脑活动完整解码视频。该研究揭示了大脑处理动态视觉时空信息的机制，为开发生物启发的鲁棒计算机视觉系统提供了新思路，结合脑成像与视频扩散模型展现出巨大潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T08:02:07Z
- **目录日期**: 2025-03-26
