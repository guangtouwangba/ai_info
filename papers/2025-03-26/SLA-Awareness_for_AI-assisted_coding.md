...
AI辅助编码工具通过代码大语言模型(CodeLLM)显著提升开发效率，自动化代码生成、补全等重复任务。不同任务对延迟要求各异：代码补全需关注首词延迟(TTFT)，代码翻译需关注端到端延迟(E2E)。现有方案难以同时满足多种延迟要求及资源优化。为此，研究者提出CATO系统，可协调多样化编码任务，在满足延迟要求的同时最大化资源利用率。实验表明，CATO使TTFT关键任务的吞吐量和资源利用率分别提升10%和41.1%，代码摘要的P95 E2E延迟降低18%，代码生成的P95 TTFT延迟降低14%，优于现有系统。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T17:01:48Z
- **目录日期**: 2025-03-26
