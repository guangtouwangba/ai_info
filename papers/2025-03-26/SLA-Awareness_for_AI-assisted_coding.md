...
AI辅助编码工具通过代码大语言模型(CodeLLM)显著提升开发效率，自动化代码生成、补全等重复任务。不同任务对延迟要求各异：代码补全需关注首词延迟(TTFT)，代码翻译则需优化端到端延迟(E2E)。现有方案因缺乏端到端延迟感知，难以兼顾并发任务需求与资源利用率。为此，研究者提出CATO系统，可同时满足多样化编码任务的延迟要求并最大化资源利用。实验表明，CATO使TTFT关键任务吞吐量提升10%，资源利用率提高41.1%，代码摘要E2E延迟降低18%，代码生成TTFT延迟减少14%。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T21:01:45Z
- **目录日期**: 2025-03-26
