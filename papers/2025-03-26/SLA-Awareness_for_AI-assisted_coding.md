...
AI辅助编码工具通过代码大语言模型(CodeLLMs)显著提升开发效率，自动化代码生成、补全等重复任务。不同任务对延迟有独特要求：代码补全关注首词延迟(TTFT)，代码翻译则看重端到端延迟(E2E)。现有服务模式难以兼顾并发任务延迟和资源利用率。为此，研究者提出CATO系统，可同时处理多种编码任务并优化延迟表现。实验显示，CATO使TTFT关键任务吞吐量提升10%，资源利用率提高41.1%，代码摘要E2E延迟降低18%，代码生成TTFT延迟减少14%，优于现有方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T12:02:18Z
- **目录日期**: 2025-03-26
