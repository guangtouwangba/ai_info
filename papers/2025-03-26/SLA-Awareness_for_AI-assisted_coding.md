...
AI辅助编码工具通过代码大语言模型(CodeLLM)显著提升开发效率，自动化代码生成、补全等重复任务。但不同任务对延迟要求各异：代码补全关注首词响应时间(TTFT)，代码翻译则需优化端到端延迟(E2E)。现有服务模式难以兼顾并发任务延迟与资源利用率。为此，研究提出CATO编排系统，实验显示其能同时提升吞吐率(10%)和资源利用率(41.1%)，代码摘要E2E延迟降低18%，代码生成TTFT减少14%，优于现有方案。该系统有效平衡了实时交互需求与集群资源优化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T18:01:52Z
- **目录日期**: 2025-03-26
