...
MIT数学家通过流体力学模型和真人实验发现，人群行走秩序的关键在于"角度分布"（即个人行走方向与正前方的偏离角度）。研究表明，当平均偏离角超过13度时，人群会陷入混乱；低于该临界值则能自然形成有序通道。该发现通过二维码追踪实验验证，未来可应用于机场、商场等场所的动线优化。研究揭示了微小个体行为对群体秩序的显著影响，为预防踩踏等风险提供了科学依据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-26T00:04:05Z
- **目录日期**: 2025-03-26
