...
该研究评估了大型语言模型（LLM）智能体在时间变化下的知识表现，通过日期控制工具（DCT）测试其作为写作助手完成科学摘要的能力。结果显示，搜索引擎的时间性会影响智能体表现，但可通过选择基础模型和链式推理提示（如思维链提示）缓解这一问题。研究表明，智能体设计和评估需动态考虑外部资源的时间影响，以确保可靠性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T05:02:07Z
- **目录日期**: 2025-04-04
