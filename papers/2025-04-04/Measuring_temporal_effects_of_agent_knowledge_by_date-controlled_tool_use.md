...
本研究评估了大型语言模型（LLM）代理在知识更新中的时间依赖性，通过日期控制工具（DCTs）测试其作为写作助手完成科学摘要时的表现。结果表明，搜索引擎的时间性会影响代理性能，但可通过选择基础模型和链式思维提示（chain-of-thought）等显式推理指令缓解。研究强调，代理设计和评估需动态考虑外部资源的时效性，以确保可靠性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T23:02:12Z
- **目录日期**: 2025-04-04
