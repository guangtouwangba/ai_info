...
该研究评估了大型语言模型（LLM）代理在知识更新中的时间依赖性表现，通过日期控制工具（DCTs）测试其作为写作助手完成科学摘要的能力。结果显示，搜索引擎的时间性会影响代理性能，但可通过基础模型选择和显式推理指令（如思维链提示）缓解。研究表明，代理设计和评估需动态考虑外部资源的时间影响，以确保可靠性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T03:13:25Z
- **目录日期**: 2025-04-04
