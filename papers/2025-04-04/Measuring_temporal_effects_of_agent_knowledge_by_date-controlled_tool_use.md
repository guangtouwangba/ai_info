...
该研究评估了大型语言模型（LLM）代理在知识更新中的时间动态性，通过日期控制工具（DCTs）测试其作为写作助手时的表现。研究发现，搜索引擎的时间性会影响代理的性能，但可通过选择基础模型和显式推理指令（如思维链提示）缓解这一问题。结果表明，代理设计和评估需考虑外部资源的时效性，并采取动态措施以确保可靠性。研究强调了时间因素对知识积累和代理响应质量的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T12:02:21Z
- **目录日期**: 2025-04-04
