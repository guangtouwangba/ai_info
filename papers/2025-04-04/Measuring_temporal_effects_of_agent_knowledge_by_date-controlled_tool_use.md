...
该研究评估了大型语言模型（LLM）代理在时间知识更新中的表现，通过日期控制工具（DCTs）测试其对科学摘要生成的适应性。结果表明，搜索引擎的时间性会影响代理性能，但可通过模型选择和链式推理提示（如思维链提示）缓解。研究强调代理设计需动态考虑外部资源的时间影响，以确保可靠性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T04:01:56Z
- **目录日期**: 2025-04-04
