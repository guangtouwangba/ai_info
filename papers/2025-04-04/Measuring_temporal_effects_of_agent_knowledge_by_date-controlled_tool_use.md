...
这篇摘要研究了大型语言模型（LLM）代理在知识更新中的时间依赖性，特别是通过日期控制工具（DCTs）评估其知识变异性。研究发现，作为写作助手的LLM代理在完成科学摘要时，其性能受搜索引擎时间性的显著影响，但可以通过选择基础模型和显式推理指令（如思维链提示）缓解这一问题。结果表明，代理设计和评估需采用动态视角，并采取措施减少外部资源的时间影响，以确保可靠性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T08:02:20Z
- **目录日期**: 2025-04-04
