...
蚂蚁集团与清华大学联合开源AReaL-boba框架，使普通开发者能在两天内训练出7B参数的SOTA推理模型，并以200美元低成本复现32B大模型QwQ的性能。该框架具备高效训练、强大推理和低成本三大优势，被比喻为"奶茶三兄弟"——易用、高效且普惠。相关代码、数据和模型已全面开源，显著降低了AI研发门槛，尤其提升了数学推理模型的训练效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T14:04:10Z
- **目录日期**: 2025-04-04
