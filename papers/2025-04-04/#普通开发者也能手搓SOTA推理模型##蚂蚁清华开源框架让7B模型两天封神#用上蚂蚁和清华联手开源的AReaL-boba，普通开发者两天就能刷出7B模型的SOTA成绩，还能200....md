...
蚂蚁集团与清华大学联合开源了AReaL-boba框架，使普通开发者能在两天内训练出7B参数规模的SOTA推理模型，并以200美元低成本复现32B参数的QwQ模型。该框架具有训练速度快、推理性能强、成本低廉三大优势，被比喻为"AI界的奶茶三兄弟"——易用、高效且普惠。相关技术实现了数学推理模型的强化学习突破，所有数据、代码和模型均已开源，大幅降低了AI研发门槛。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T03:14:20Z
- **目录日期**: 2025-04-04
