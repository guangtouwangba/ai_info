...
蚂蚁集团与清华大学联合开源了AReaL-boba框架，使普通开发者能在两天内训练出性能顶尖的7B参数模型（SOTA水平），并以200美元低成本复现32B参数的QwQ模型。该框架具有训练速度快、推理能力强、成本低廉三大优势，被比喻为"奶茶三兄弟"——易用、高效且普惠。相关代码、数据和模型已全部开源，显著降低了高性能AI模型的开发门槛，特别在数学推理任务上展现出强化学习(RL)的突破性效果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T22:03:56Z
- **目录日期**: 2025-04-04
