...
蚂蚁集团与清华大学联合开源了AReaL-boba框架，使普通开发者能在两天内训练出7B参数的SOTA推理模型，并以200美元低成本复现32B规模的QwQ模型。该框架具有高效训练、强大推理和低成本优势，被比喻为AI界的"奶茶三兄弟"（易用、高效、普惠）。相关技术实现了数学推理模型的强化学习突破，并开源了完整数据、代码和模型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T11:04:04Z
- **目录日期**: 2025-04-04
