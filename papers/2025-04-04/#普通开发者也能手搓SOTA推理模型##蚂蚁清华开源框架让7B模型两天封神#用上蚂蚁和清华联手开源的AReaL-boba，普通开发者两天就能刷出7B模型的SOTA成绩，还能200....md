...
蚂蚁集团与清华大学联合开源AReaL-boba框架，使普通开发者能在两天内训练出7B规模的SOTA推理模型，并以200美元低成本复现32B大模型QwQ的性能。该框架具备"训练快、推理强、成本低"三大优势，被比喻为AI界的"奶茶三兄弟"（易获取、高性能、平民化）。其开源性覆盖数据、代码和模型，显著降低了高性能AI模型的开发门槛，特别在数学推理任务中展现出强化学习的高效性。这一突破或将推动AI技术民主化进程。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T00:04:01Z
- **目录日期**: 2025-04-04
