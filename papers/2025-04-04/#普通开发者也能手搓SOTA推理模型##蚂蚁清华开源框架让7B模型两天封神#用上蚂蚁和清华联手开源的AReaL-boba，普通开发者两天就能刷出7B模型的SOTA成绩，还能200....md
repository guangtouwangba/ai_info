...
蚂蚁集团与清华大学联合开源AReaL-boba框架，使普通开发者能在两天内训练出7B规模的SOTA推理模型，并以200美元低成本复现32B模型QwQ。该框架具有训练速度快、推理性能强、成本低廉三大优势，被比喻为"AI界的奶茶三兄弟"——易用、高效且普惠。其开源性（包含数据、代码和模型）显著降低了AI研发门槛，特别在数学推理任务中展现出强化学习的突破性效果，为开发者提供了高效复现前沿成果的实用工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T20:03:49Z
- **目录日期**: 2025-04-04
