...
蚂蚁集团与清华大学联合开源AReaL-boba框架，使普通开发者仅需两天即可训练出7B参数的SOTA推理模型，并以200美元低成本复现32B大模型QwQ的性能。该框架具备训练速度快、推理能力强、成本低廉三大优势，被比喻为"AI界的奶茶三兄弟"（易获取、高性能、平民化）。其开源性（数据/代码/模型全开源）显著降低了AI研发门槛，特别在数学推理任务中展现出强化学习的突破性效果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T15:04:04Z
- **目录日期**: 2025-04-04
