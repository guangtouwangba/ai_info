...
蚂蚁集团和清华大学联合开源了AReaL-boba框架，使普通开发者能在两天内训练出7B规模的SOTA推理模型，仅需200美元即可复现32B模型QwQ的性能。该框架具有训练速度快、推理能力强、成本低的特点，被誉为"AI界的奶茶三兄弟"（好喝、管饱、人人可用）。相关数据、代码和模型已全部开源，显著降低了高性能AI模型的开发门槛。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T06:03:45Z
- **目录日期**: 2025-04-04
