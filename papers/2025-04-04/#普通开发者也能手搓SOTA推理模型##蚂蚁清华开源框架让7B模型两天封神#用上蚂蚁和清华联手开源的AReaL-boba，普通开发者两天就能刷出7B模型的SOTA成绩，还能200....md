...
蚂蚁集团与清华大学联合开源AReaL-boba框架，使普通开发者能在2天内训练出7B参数的SOTA推理模型，并以200美元低成本复现32B大模型QwQ的性能。该框架具备训练快、推理强、成本低三大优势，被比喻为"AI界的奶茶三兄弟"（易用/高效/普惠）。其开源性涵盖数据、代码和模型，特别在数学推理任务中展现出强化学习的突破性表现，大幅降低了AI模型开发门槛。相关成果已通过论文和开源项目全面公开。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T05:03:22Z
- **目录日期**: 2025-04-04
