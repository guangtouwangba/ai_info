...
蚂蚁集团与清华大学联合开源AReaL-boba框架，使普通开发者仅用两天即可训练出7B参数的SOTA推理模型，成本低至200美元即可复现32B规模的QwQ模型成果。该框架以"训练快、推理强、成本低"为特点，被比喻为AI界的"奶茶三兄弟"（易获取、高性能、平民化）。其开源性覆盖数据、代码和模型，显著降低了高性能数学推理模型的门槛，尤其适合资源有限的研究者快速实现强化学习在数学推理任务中的应用突破。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T02:29:13Z
- **目录日期**: 2025-04-04
