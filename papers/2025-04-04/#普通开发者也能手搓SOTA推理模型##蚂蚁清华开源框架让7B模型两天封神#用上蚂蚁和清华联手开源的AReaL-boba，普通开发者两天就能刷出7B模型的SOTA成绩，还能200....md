...
蚂蚁集团与清华大学联合开源了AReaL-boba框架，使普通开发者仅用两天就能训练出7B规模的SOTA推理模型，成本低至200美元即可复现32B大模型QwQ的性能。该框架具有训练快、推理强、低成本三大优势，被比喻为"AI界的奶茶三兄弟"（易用/高效/普惠）。其开箱即用的特性显著降低了AI模型开发门槛，相关数据、代码和模型已全面开源，特别在数学推理任务中展现出强化学习带来的显著性能提升。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T04:02:59Z
- **目录日期**: 2025-04-04
