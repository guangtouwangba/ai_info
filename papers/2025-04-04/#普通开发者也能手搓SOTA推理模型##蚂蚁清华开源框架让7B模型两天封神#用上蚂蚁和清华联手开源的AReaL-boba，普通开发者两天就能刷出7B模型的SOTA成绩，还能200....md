...
蚂蚁集团与清华大学联合开源AReaL-boba框架，使普通开发者能在两天内训练出7B参数的SOTA推理模型，并以200美元低成本复现32B大模型QwQ的性能。该框架具备高效训练、强大推理和极低成本三大优势，被比喻为"AI界的奶茶三兄弟"（易用、高效、普惠）。其开源性覆盖数据、代码和模型，显著降低了数学推理模型的开发门槛，尤其适合资源有限的开发者实现高性能模型训练。相关成果已在论文中公开，为AI社区提供了可复现的强化学习训练方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T23:03:56Z
- **目录日期**: 2025-04-04
