...
蚂蚁集团与清华大学联合开源AReaL-boba框架，使普通开发者能在两天内训练出7B参数的SOTA推理模型（如复现32B模型QwQ仅需200美元）。该框架具有高效训练、强推理能力、低成本三大优势，被比喻为"AI界奶茶三兄弟"——易用、高效且普惠。相关代码、数据和模型已全面开源，显著降低了高性能AI模型的开发门槛，特别在数学推理任务中展现出强化学习的突破性效果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T17:03:52Z
- **目录日期**: 2025-04-04
