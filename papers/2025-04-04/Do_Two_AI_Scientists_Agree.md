...
研究表明，当多个AI模型在相同科学任务上训练时，它们可能学习到不同理论，类似于科学史上多种理论并存的现象。随着训练数据的增加，AI模型的理论会逐渐收敛，但有时仍会形成不同理论群组。研究者提出MASS框架，通过哈密顿-拉格朗日神经网络模拟AI科学家，发现简单系统下AI倾向于学习哈密顿理论，而复杂系统下转向拉格朗日理论。训练过程和最终权重表现出强烈随机依赖性，影响理论的选择。该方法不仅增强可解释性，还能应用于高维问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T21:01:05Z
- **目录日期**: 2025-04-04
