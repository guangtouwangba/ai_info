...
研究表明，当两个AI模型在同一科学任务上训练时，它们可能学习相同或不同的理论，这取决于训练数据的丰富程度。随着训练数据的增加，AI模型的理论会趋于一致，但有时仍会形成不同理论的分组。研究者提出MASS框架，通过哈密顿-拉格朗日神经网络模拟AI科学家，发现简单系统下AI倾向于学习哈密顿理论，而复杂系统下转向拉格朗日理论。训练动态和最终权重高度依赖初始随机种子，这决定了不同理论的兴衰。该神经网络不仅增强可解释性，还能应用于高维问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T14:01:12Z
- **目录日期**: 2025-04-04
