...
研究表明，当两个AI模型在相同科学任务上训练时，它们可能学习不同理论，但随着训练数据增加，理论会趋于收敛。研究者提出MASS方法，通过哈密顿-拉格朗日神经网络模拟AI科学家，发现简单系统下AI倾向于学习哈密顿理论，复杂系统则转向拉格朗日表述。训练动态和最终权重表现出强种子依赖性，影响不同理论的"兴衰"。该方法不仅能增强可解释性，还可应用于高维问题。这反映了科学史上理论随实验数据增加而逐渐收敛的现象在AI领域同样适用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T23:01:15Z
- **目录日期**: 2025-04-04
