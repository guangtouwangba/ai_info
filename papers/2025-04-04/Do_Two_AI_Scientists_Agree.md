...
研究表明，当两个AI模型在相同科学任务上训练时，它们可能学习不同理论，但随着训练数据增加，其理论会逐渐收敛。研究者提出MASS框架（哈密顿-拉格朗日神经网络），通过多组随机种子模拟不同AI科学家的训练过程发现：简单系统下AI倾向于哈密顿理论，复杂系统则转向拉格朗日表述。训练动态和最终权重高度依赖随机种子，这决定了不同理论的"兴衰"。该神经网络不仅提升了可解释性，还能处理高维问题，揭示了AI科学家与人类科学发展相似的"理论选择"规律——数据越多，理论空间越受限。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T08:01:18Z
- **目录日期**: 2025-04-04
