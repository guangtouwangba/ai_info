...
研究表明，当多个AI模型在同一科学任务上训练时，其学习到的理论可能不同，但随着训练数据的增加会趋于收敛。研究者提出MASS框架（Hamiltonian-Lagrangian神经网络），通过大量随机种子训练模拟不同AI科学家的理论形成过程。实验发现：在简单系统中AI倾向于学习哈密顿理论，而复杂系统则转向拉格朗日表述；训练动态和最终权重高度依赖随机种子，这决定了不同理论的"兴衰"。该方法不仅能解释AI学习机制，还可拓展至高维问题，揭示了AI科学家与人类科学发展相似的"理论选择"规律。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T17:01:19Z
- **目录日期**: 2025-04-04
