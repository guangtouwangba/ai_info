...
研究表明，当两个AI模型在相同科学任务上训练时，它们可能学习到不同理论，但随着训练数据中系统数量的增加，AI模型的理论会趋于收敛，有时会形成对应不同理论的分组。研究者提出MASS方法，使用哈密顿-拉格朗日神经网络作为"AI科学家"，在物理标准问题上进行多组训练模拟。结果显示：简单系统下AI倾向于学习哈密顿理论，复杂系统则转向拉格朗日表述；训练动态和最终权重对随机种子有强依赖性，这决定了相关理论的兴衰。该方法不仅增强可解释性，还可应用于高维问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T16:01:07Z
- **目录日期**: 2025-04-04
