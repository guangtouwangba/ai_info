...
本研究探讨了图论博弈（graphon games）的均衡存在性及其与大网络博弈的关系。在效用函数连续且拟凹的条件下，证明了无限维策略空间的图论博弈均衡存在性。此外，研究将图论博弈的纳什均衡刻画为大网络博弈渐近均衡的极限点：当大网络博弈序列收敛于图论博弈时，其渐近均衡序列的极限即为图论博弈的均衡；反之，任意图论博弈均衡均可由某一大网络博弈序列的渐近均衡逼近。结果表明，图论博弈是大网络博弈在玩家数量趋于无穷时的理想化极限模型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T01:28:17Z
- **目录日期**: 2025-04-04
