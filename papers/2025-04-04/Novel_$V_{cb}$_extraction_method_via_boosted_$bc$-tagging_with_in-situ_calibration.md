...
本文提出了一种在LHC测量$|V_{cb}|$的新方法，利用先进的"bc标记器"识别$W \rightarrow bc$信号，并通过顶夸克衰变进行原位校准。该方法显著抑制背景噪声，降低味道标记效率的不确定性，结合AI开发的大/小半径标记器(Sophon和SophonAK4)，在HL-LHC下可使$|V_{cb}|$测量精度提高约30%。作为副产品，该方法还将$H^{\pm} \rightarrow bc$的搜索灵敏度比ATLAS Run 2结果提升了2-5倍。研究展示了先进标记模型在LHC探索未开发能区的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T10:02:31Z
- **目录日期**: 2025-04-04
