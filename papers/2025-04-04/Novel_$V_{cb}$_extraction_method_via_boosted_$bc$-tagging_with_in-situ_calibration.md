...
本文提出了一种在LHC测量$|V_{cb}|$的新方法，通过先进的"bc标记"技术识别增强喷注中的$W \rightarrow bc$信号，并结合顶夸克衰变进行原位校准。该方法显著抑制背景干扰并降低风味标记效率的不确定性，在HL-LHC条件下可将$|V_{cb}|$测量精度提高约30%。研究开发了基于AI的大/小半径喷注标记器Sophon和SophonAK4，性能达到ATLAS和CMS最先进水平。作为副产品，该方法还将$H^{\pm} \rightarrow bc$的搜索灵敏度比ATLAS Run 2结果提高了2-5倍，为LHC探索增强区域提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T09:02:28Z
- **目录日期**: 2025-04-04
