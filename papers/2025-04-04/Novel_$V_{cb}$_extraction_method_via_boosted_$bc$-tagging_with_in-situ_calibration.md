...
本文提出了一种在LHC上测量$|V_{cb}|$的新方法，通过先进的"bc签名"增强喷注重子标记技术，将$W \rightarrow bc$信号与来自顶夸克衰变的$bc$匹配喷注相关联，实现了标记器的原位校准。该方法显著抑制背景噪声并降低味道标记效率的不确定性，在HL-LHC条件下可使$|V_{cb}|$测量精度提高约30%。同时，该方法还能将$H^{\pm} \rightarrow bc$搜索灵敏度比ATLAS Run 2结果提升2-5倍。研究采用了基于AI的大/小半径标记器Sophon和SophonAK4，性能与ATLAS/CMS最先进标记器相当，为LHC探索新的增强区域提供了新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T08:02:33Z
- **目录日期**: 2025-04-04
