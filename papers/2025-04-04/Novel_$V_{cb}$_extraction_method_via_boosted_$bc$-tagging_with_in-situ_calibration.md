...
本文提出了一种利用LHC测量$|V_{cb}|$的新方法，通过先进的"bc签名"增强喷注重子标记技术识别$W \rightarrow bc$信号，并与顶夸克衰变产生的$bc$匹配喷注进行原位校准。该方法显著抑制背景干扰，降低风味标记效率的不确定性，在HL-LHC条件下可将$|V_{cb}|$测量精度提高约30%。研究开发了基于AI的大/小半径标记器Sophon和SophonAK4，性能与ATLAS/CMS最先进标记器相当。作为副产品，该方法还将$H^{\pm} \rightarrow bc$搜索灵敏度比ATLAS Run 2结果提升2-5倍，为LHC探索增强机制开辟了新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T16:02:14Z
- **目录日期**: 2025-04-04
