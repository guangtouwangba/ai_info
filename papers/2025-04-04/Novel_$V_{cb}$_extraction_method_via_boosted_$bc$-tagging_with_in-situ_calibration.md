...
本文提出了一种在LHC测量$|V_{cb}|$的新方法，利用先进的"bc标记器"识别$W \rightarrow bc$信号，并结合顶夸克衰变中的bc匹配喷注进行原位校准。该方法显著抑制背景噪声，降低味道标记效率的不确定性，从而提升测量精度。研究采用了基于AI的大/小半径标记器Sophon和SophonAK4，其性能与ATLAS和CMS最先进的标记器相当。在高亮度LHC条件下，该方法可使$|V_{cb}|$测量精度提高约30%，同时将$H^{\pm} \rightarrow bc$搜索灵敏度提升2-5倍。该工作为精确测量$|V_{cb}|$提供了新视角，展示了先进标记模型在LHC探索新物理的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T14:02:23Z
- **目录日期**: 2025-04-04
