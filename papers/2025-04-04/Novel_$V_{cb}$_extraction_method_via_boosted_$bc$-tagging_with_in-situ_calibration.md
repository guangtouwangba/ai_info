...
本文提出了一种利用LHC测量$|V_{cb}|$的新方法，通过先进的"bc标记器"识别"bc信号"，并结合顶夸克衰变中的bc匹配喷注进行原位校准。该方法显著抑制背景并降低味道标记效率的不确定性，使$|V_{cb}|$测量精度提高约30%（基于HL-LHC预测）。研究采用基于AI的大/小半径标记器Sophon和SophonAK4，性能达到ATLAS和CMS先进水平。该方法不仅补充传统小半径喷注方案，还能将带电希格斯玻色子$H^{\pm} \rightarrow bc$的搜索灵敏度提升2-5倍，为LHC探索新的增强区域提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T23:02:23Z
- **目录日期**: 2025-04-04
