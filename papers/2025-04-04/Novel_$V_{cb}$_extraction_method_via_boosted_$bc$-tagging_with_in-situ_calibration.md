...
本文提出了一种在LHC上测量$|V_{cb}|$的新方法，通过先进的增强喷射标记器识别"bc特征"。该方法将增强的$W \rightarrow bc$信号与来自顶夸克衰变的$bc$匹配喷流关联，实现了标记器的原位校准，显著抑制背景并降低风味标记效率的不确定性。研究开发了基于AI的大/小半径标记器Sophon和SophonAK4，验证其性能匹配ATLAS和CMS的最先进标记器。该方法使$|V_{cb}|$测量精度提高约30%，并提升$H^{\pm} \rightarrow bc$搜索灵敏度2-5倍，为LHC探索增强机制开辟了新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T07:02:17Z
- **目录日期**: 2025-04-04
