...
本文提出了一种在LHC上测量$|V_{cb}|$的新方法，通过使用先进的"bc标记器"识别$W \rightarrow bc$信号，并结合来自顶夸克衰变的$bc$匹配喷注进行原位校准。该方法显著抑制了背景干扰，降低了味道标记效率的不确定性，使$|V_{cb}|$测量精度提高约30%。研究采用了基于AI的大/小半径标记器Sophon和SophonAK4，性能达到ATLAS和CMS最先进水平。该方法还能将$H^{\pm} \rightarrow bc$的搜索灵敏度提升2-5倍，为LHC探索未研究的增强区域提供了新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T17:02:23Z
- **目录日期**: 2025-04-04
