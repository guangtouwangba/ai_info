...
本文提出了一种利用先进喷注重子标记技术（"bc签名"）在LHC上测量$|V_{cb}|$的新方法。通过将增强的$W \rightarrow bc$信号与来自顶夸克衰变的$bc$匹配喷注关联，实现了标记器的原位校准。该方法显著抑制背景噪声，降低味道标记效率的不确定性，从而提高测量精度。研究开发了基于AI的大/小半径标记器Sophon和SophonAK4，性能达到ATLAS和CMS最先进水平。在HL-LHC条件下可使$|V_{cb}|$测量精度提高约30%，同时将$H^{\pm} \rightarrow bc$搜索灵敏度提升2-5倍。该工作为精确测量$|V_{cb}|$提供了新思路，展示了先进标记模型在LHC高能区探索中的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T11:02:32Z
- **目录日期**: 2025-04-04
