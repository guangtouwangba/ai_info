...
本文提出了一种利用LHC测量$|V_{cb}|$的新方法，通过先进的"bc签名"增强喷注重子标记器，将$W \rightarrow bc$信号与顶夸克衰变的$bc$匹配喷注关联，实现标记器的原位校准。该方法显著抑制背景噪声并降低味道标记效率的不确定性，从而提高测量精度。研究采用基于AI的大/小半径标记器Sophon和SophonAK4，验证其性能与ATLAS和CMS最先进标记器相当。在HL-LHC预测下，该方法使$|V_{cb}|$测量精度提高约30%，同时将$H^{\pm} \rightarrow bc$搜索灵敏度提升2-5倍，为LHC探索增强机制提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T18:02:16Z
- **目录日期**: 2025-04-04
