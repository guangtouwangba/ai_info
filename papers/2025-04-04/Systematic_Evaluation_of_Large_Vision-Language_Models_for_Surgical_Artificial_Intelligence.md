...
大型视觉语言模型(VLM)为AI驱动的图像理解提供了新范式，无需任务特定训练即可执行任务。在医学领域，尤其是专家标注数据稀缺的手术场景中，VLM展现出应用潜力。研究评估了11种先进VLM在17项外科AI任务中的表现，涵盖腹腔镜、机器人和开放手术。实验表明VLM具有良好的泛化能力，上下文学习可使性能提升3倍，但时空推理任务仍具挑战性。该研究不仅揭示了VLM在外科领域的潜力，也为其他复杂动态场景的临床应用提供了参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T10:01:31Z
- **目录日期**: 2025-04-04
