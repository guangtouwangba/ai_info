...
大型视觉语言模型(VLMs)为AI驱动的图像理解提供了新范式，无需任务特定训练即可执行任务。研究表明，在17项外科AI视觉任务(从解剖识别到技能评估)中，11种先进VLMs表现出良好的泛化能力，有时甚至超过监督模型。上下文学习可将性能提升三倍，显示其适应性强。但需要时空推理的任务仍具挑战性。虽然医学领域专家标注数据稀缺，但VLMs在外科等干预性领域展现出潜力，为临床和现实世界复杂动态场景的应用提供了新思路。研究基于13个涵盖腹腔镜、机器人和开放手术的数据集。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T04:01:18Z
- **目录日期**: 2025-04-04
