...
大型视觉语言模型(VLM)为AI驱动的图像理解提供了新范式，无需特定任务训练即可执行任务。这种灵活性在医学领域尤其有前景，因为专家标注数据稀缺。研究团队全面评估了11种先进VLM在17个外科AI视觉理解任务(从解剖识别到技能评估)中的表现，使用了13个涵盖腹腔镜、机器人和开放手术的数据集。实验表明VLM展现出良好的泛化能力，有时在非训练场景下优于监督模型。上下文学习可将性能提升三倍，显示其适应性强。但需要时空推理的任务仍具挑战。这些发现为VLM在临床和其他动态场景中的应用提供了见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T14:01:25Z
- **目录日期**: 2025-04-04
