...
大型视觉语言模型(VLM)为AI驱动的图像理解提供了新范式，无需任务特定训练即可执行多种任务。在医学领域，特别是外科手术这种决策主观、场景多变的干预性领域，VLM展现出良好泛化能力，有时甚至超越监督模型。研究表明，上下文学习可使性能提升三倍，突显其适应性强项。然而，需要时空推理的任务仍具挑战。通过对11个先进VLM在17个外科AI任务(从解剖识别到技能评估)的全面分析，该研究不仅验证了VLM在外科的应用潜力，也为复杂动态场景的临床应用提供了重要见解。(100字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T16:01:19Z
- **目录日期**: 2025-04-04
