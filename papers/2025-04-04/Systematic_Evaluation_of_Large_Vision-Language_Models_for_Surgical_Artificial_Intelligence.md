...
大型视觉语言模型(VLMs)为AI驱动的图像理解提供了新范式，无需特定任务训练即可执行任务。在医学领域，特别是专家标注数据稀缺的手术场景中，VLMs展现出应用潜力。研究评估了11种先进VLM在17个外科AI任务(从解剖识别到技能评估)的表现，使用13个涵盖多种手术方式的数据集。实验表明VLMs具有良好的泛化能力，有时甚至优于监督模型。上下文学习可将性能提升三倍，突显其适应能力，但空间和时间推理任务仍具挑战性。该研究为VLM在临床及其他复杂动态场景的应用提供了重要见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T08:01:31Z
- **目录日期**: 2025-04-04
