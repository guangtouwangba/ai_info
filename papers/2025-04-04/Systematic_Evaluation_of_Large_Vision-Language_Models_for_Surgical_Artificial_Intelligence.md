...
大型视觉语言模型(VLMs)为AI驱动的图像理解提供了新范式，无需特定任务训练即可执行任务。研究评估了11种先进VLMs在17个外科AI任务(从解剖识别到技能评估)的表现，使用13个涵盖多种手术类型的数据集。结果显示，VLMs展现出良好的泛化能力，有时在非训练场景下优于监督模型。上下文学习使性能提升达三倍，表明其适应性强。但需要时空推理的任务仍具挑战性。该研究不仅揭示了VLMs在外科领域的潜力，也为复杂动态临床场景的应用提供了见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T17:01:30Z
- **目录日期**: 2025-04-04
