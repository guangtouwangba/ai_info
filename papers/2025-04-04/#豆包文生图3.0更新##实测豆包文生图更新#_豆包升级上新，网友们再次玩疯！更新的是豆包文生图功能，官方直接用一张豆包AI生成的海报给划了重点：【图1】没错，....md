...
豆包AI的文生图功能升级至3.0版本，重点优化了中文文字生成的准确性。新功能支持用户快速生成海报、短视频封面及文旅周边设计，提供多种风格模板且完全免费。官方示例显示，该工具可精准呈现文字内容，适用于社交媒体内容创作。目前已在豆包平台开放使用，引发网友热烈体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T17:03:26Z
- **目录日期**: 2025-04-04
