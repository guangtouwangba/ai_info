...
豆包AI的文生图功能升级至3.0版本，重点提升了中文文字生成的准确性。用户可免费使用该功能制作海报、短视频封面（如抖音/小红书风格）及文旅周边设计，操作便捷且效果直观。官方示例展示了生成的海报和旅游VLOG封面，显示其风格适配能力和实用性。目前该功能已开放体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T09:03:23Z
- **目录日期**: 2025-04-04
