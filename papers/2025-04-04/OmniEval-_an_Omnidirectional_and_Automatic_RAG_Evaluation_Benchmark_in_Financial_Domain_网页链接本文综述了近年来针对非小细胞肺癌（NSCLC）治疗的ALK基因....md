...
这篇论文介绍了OmniEval——一个面向金融领域的全方位自动RAG（检索增强生成）评估基准。同时，文章还综述了非小细胞肺癌(NSCLC)治疗中针对ALK基因的双靶点抑制剂研究进展。尽管已有7种ALK抑制剂获批用于治疗ALK融合阳性NSCLC，但耐药性问题仍然存在。研究表明，能同时靶向两个药物靶点的单一分子双靶点抑制剂比联合用药更能减少副作用和毒性，特别是在克服耐药性方面。文章分析了这类抑制剂的结构-活性关系，为开发新型ALK抑制剂和克服耐药性提供了重要见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T08:05:27Z
- **目录日期**: 2025-04-04
