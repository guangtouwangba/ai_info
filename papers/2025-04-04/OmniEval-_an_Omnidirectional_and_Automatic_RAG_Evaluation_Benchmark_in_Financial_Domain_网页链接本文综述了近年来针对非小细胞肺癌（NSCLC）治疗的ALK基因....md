...
这篇论文介绍了OmniEval，一个针对金融领域的全方位自动RAG（检索增强生成）评估基准。同时，文章还综述了非小细胞肺癌（NSCLC）治疗中ALK基因双靶点抑制剂的最新进展。ALK基因是NSCLC的重要致癌驱动因子，尽管已有7种ALK抑制剂获批，但耐药性问题仍然存在。研究指出，同时针对两个靶点的双靶点抑制剂比联合用药更能减少副作用和毒性，特别是在克服耐药性方面。文章总结了ALK双靶点抑制剂的治疗进展、合理设计及结构-活性关系，为开发新型抑制剂和克服耐药性提供了见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T20:04:49Z
- **目录日期**: 2025-04-04
