...
这篇论文介绍了OmniEval，一个面向金融领域的全方位自动RAG（检索增强生成）评估基准。同时，文章还综述了针对非小细胞肺癌(NSCLC)中ALK基因的双靶点抑制剂研究进展。ALK基因是NSCLC的重要治疗靶点，尽管已有7种ALK抑制剂获批，但耐药性问题仍然存在。研究表明，相比联合用药，能同时作用于两个靶点的单一分子抑制剂能减少副作用和毒性，在克服耐药性方面更具优势。文章总结了ALK双靶点抑制剂的最新进展，分析了其结构-活性关系，为开发新型抗癌药物提供了重要见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T23:04:57Z
- **目录日期**: 2025-04-04
