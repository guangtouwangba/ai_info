...
这篇论文介绍了OmniEval，一个针对金融领域设计的全方位自动RAG（检索增强生成）评估基准。同时，文章还综述了非小细胞肺癌（NSCLC）治疗中ALK基因双靶点抑制剂的最新研究进展。ALK基因作为NSCLC的重要致癌驱动基因，现有7种获批抑制剂仍面临耐药性问题。研究指出，相比联合用药，能同时靶向两个位点的单一分子抑制剂具有减少副作用和毒性的优势。文章总结了ALK双靶点抑制剂的治疗进展，分析了其合理设计和结构-活性关系，为开发新型抑制剂和克服耐药性提供了见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T19:04:51Z
- **目录日期**: 2025-04-04
