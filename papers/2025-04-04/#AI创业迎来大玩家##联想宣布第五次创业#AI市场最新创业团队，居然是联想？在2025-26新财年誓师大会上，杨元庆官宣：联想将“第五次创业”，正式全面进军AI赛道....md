...
联想集团在2025/26新财年誓师大会上宣布启动"第五次创业"，全面进军AI领域。CEO杨元庆表示，联想将进行从底层基础设施到企业智能体平台的AI全栈布局，并重构品牌定位，而不仅限于AI PC产品。这一战略标志着这家科技巨头正式加入AI创业赛道，展开深度转型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T02:29:22Z
- **目录日期**: 2025-04-04
