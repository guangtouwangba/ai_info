...
联想在2025/26新财年誓师大会上宣布启动"第五次创业"，全面进军AI领域。CEO杨元庆表示，联想将不仅限于AI PC，而是从底层基础设施到企业智能体平台进行全面AI化改造，甚至重构品牌定位。这表明联想正从传统硬件厂商向AI技术公司转型，计划在人工智能领域进行深度布局。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T12:04:11Z
- **目录日期**: 2025-04-04
