...
联想集团在2025/26新财年誓师大会上宣布启动"第五次创业"，全面进军AI领域。CEO杨元庆表示，此次转型不仅是推出AI PC产品，而是从底层基础设施到企业智能体平台的全方位AI化重构，包括品牌定位的全面升级。这标志着这家科技巨头正式加入AI创业赛道，将AI技术深度整合至企业各业务层面。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T13:10:30Z
- **目录日期**: 2025-04-04
