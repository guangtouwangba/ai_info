...
联想集团在2025/26新财年誓师大会上宣布启动"第五次创业"，全面进军AI领域。CEO杨元庆表示，联想将不局限于AI PC，而是从底层基础设施到企业智能体平台进行全面AI化转型，甚至重构品牌定位。这表明联想正将人工智能作为核心战略方向，计划深度布局AI全产业链。此次转型被视为联想继PC、移动互联网等业务后的又一次重大战略调整。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T07:03:49Z
- **目录日期**: 2025-04-04
