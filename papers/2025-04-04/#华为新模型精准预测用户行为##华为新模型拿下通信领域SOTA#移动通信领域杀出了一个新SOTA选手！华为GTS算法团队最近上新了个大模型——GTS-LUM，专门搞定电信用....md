...
华为GTS算法团队推出新的大模型GTS-LUM，专门用于电信用户行为建模。该模型能够精准预测用户行为，包括换套餐意愿、流失风险以及下一步操作的时间和内容，准确率极高。这一成果在移动通信领域取得了SOTA（当前最先进水平）表现，展示了华为在通信技术领域的强大研发实力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T20:03:02Z
- **目录日期**: 2025-04-04
