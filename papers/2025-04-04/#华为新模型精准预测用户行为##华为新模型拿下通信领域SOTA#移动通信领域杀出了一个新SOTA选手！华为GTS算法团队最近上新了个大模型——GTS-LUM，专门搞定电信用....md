...
华为GTS算法团队近日推出电信用户行为预测大模型GTS-LUM，在移动通信领域实现SOTA性能。该模型能精准预测用户换套餐意愿、流失风险及后续操作行为，展现出超强预测能力。相关技术细节详见微博文章《移动通信领域有了新SOTA：华为出品，精准预测用户行为》。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T18:03:01Z
- **目录日期**: 2025-04-04
