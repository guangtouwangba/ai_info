...
华为GTS算法团队近日推出电信用户行为建模大模型GTS-LUM，在移动通信领域取得SOTA成果。该模型能精准预测用户行为，包括套餐更换倾向、流失风险及具体操作预判，准确率显著提升。相关技术细节详见微博文章《移动通信领域有了新SOTA：华为出品，精准预测用户行为》。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T22:03:05Z
- **目录日期**: 2025-04-04
