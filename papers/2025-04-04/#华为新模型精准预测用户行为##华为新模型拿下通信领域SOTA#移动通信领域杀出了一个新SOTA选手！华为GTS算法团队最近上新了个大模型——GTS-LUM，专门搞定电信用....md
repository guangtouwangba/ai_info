...
华为GTS算法团队近日推出电信用户行为预测大模型GTS-LUM，在移动通信领域取得SOTA成果。该模型能精准预测用户换套餐、离网倾向等行为，甚至可预判用户下一步操作的时间和内容。相关技术细节显示其预测准确度显著提升，为电信运营商提供更精准的用户行为分析工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T14:03:23Z
- **目录日期**: 2025-04-04
