...
模仿学习是构建通用机器人的重要方法，但依赖高质量专家演示限制了其扩展性。为解决这一问题，研究者提出统一世界模型（UWM），通过整合动作扩散和视频扩散过程，利用Transformer架构灵活实现策略学习、动态预测和视频生成。实验表明，UWM能有效预训练多任务机器人数据集，比传统模仿学习获得更通用、鲁棒的策略；同时支持无动作标注视频数据学习，提升微调策略性能。该框架为利用异构大数据进行可扩展的机器人学习提供了新思路，弥合了模仿学习与世界建模的鸿沟。详情见项目网站。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T05:01:47Z
- **目录日期**: 2025-04-04
