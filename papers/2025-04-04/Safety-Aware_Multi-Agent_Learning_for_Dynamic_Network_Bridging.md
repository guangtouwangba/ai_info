...
这篇论文研究了在部分可观测的安全关键环境中，多智能体系统执行复杂协作任务的挑战。作者以动态网络桥接任务为例，要求智能体在移动目标间维持通信路径。为确保训练和部署安全，他们整合了基于控制理论的安全过滤器，通过局部设定点更新实现碰撞避免。研究提出并评估了安全感知的多智能体强化学习消息传递方法，发现将安全过滤器激活编码为边缘级特征能有效提升协作效率。结果表明，局部安全执行与去中心化学习可在分布式多智能体任务中有效结合。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T17:02:41Z
- **目录日期**: 2025-04-04
