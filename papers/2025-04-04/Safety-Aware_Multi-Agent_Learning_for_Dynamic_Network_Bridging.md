...
本文研究了在部分可观测环境下，多智能体系统执行复杂协作任务的安全性问题。针对动态网络桥接任务，研究者提出了一种结合控制理论安全过滤器的强化学习方法，通过局部设定点更新实现碰撞避免。研究发现，将安全过滤器激活信息编码为边缘级特征可有效提升多智能体间的协调能力。结果表明，局部安全强制与去中心化学习在分布式多智能体任务中能够有效结合，为安全关键环境下的多智能体协作提供了可行方案。该方法在训练和部署阶段均能确保安全性，具有重要应用价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T12:02:58Z
- **目录日期**: 2025-04-04
