...
本文研究了安全关键环境下多智能体系统在部分可观测条件下的复杂协作任务，重点关注动态网络桥接任务。通过集成控制理论的安全过滤器实现碰撞避免，提出了一种安全感知的消息传递强化学习方法。研究表明，将安全过滤器激活编码为边缘级特征可有效提升协作效率。结果表明，局部安全执行与分散式学习可在分布式多智能体任务中实现有效结合。该方法为安全关键场景下的多智能体协作提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T21:02:26Z
- **目录日期**: 2025-04-04
