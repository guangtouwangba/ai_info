...
本文研究了安全关键环境下多智能体系统在部分可观测条件下的复杂协作任务，重点关注动态网络桥接任务。研究提出了一种结合控制理论安全过滤器的方法，通过局部设定点更新实现碰撞避免。实验表明，将安全过滤器激活编码为边缘级特征可提升多智能体强化学习中的协调能力。结果表明，局部安全执行与去中心化学习能有效结合，适用于分布式多智能体任务。该方法在训练和部署阶段均能保障安全性，为安全关键场景下的多智能体协作提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T05:02:41Z
- **目录日期**: 2025-04-04
