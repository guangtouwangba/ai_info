...
本文研究了安全关键环境下多智能体系统在部分可观测条件下的复杂协作任务。针对动态网络桥接任务，研究者提出了一种结合控制论安全过滤器的方案，通过局部设定点更新实现碰撞避免。实验表明，将安全过滤器激活编码为边缘级特征的多智能体强化学习方法能有效提升协调能力。研究证实，局部安全执行与分散式学习可在分布式多智能体任务中有效结合。这种方法既保证了训练和部署阶段的安全性，又提高了系统在动态环境中的协作表现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T20:02:32Z
- **目录日期**: 2025-04-04
