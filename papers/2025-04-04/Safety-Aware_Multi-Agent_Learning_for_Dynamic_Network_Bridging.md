...
本文研究了在部分可观测的安全关键环境中，多智能体系统执行复杂协作任务的挑战。针对动态网络桥接任务，研究者提出了一种结合控制理论安全过滤器的方案，通过本地设定点更新实现碰撞避免。研究发现，将安全过滤器激活编码为边缘级特征的多智能体强化学习方法能有效提升协作效率。结果表明，本地安全机制与分散式学习可在分布式多任务中有效结合，为安全关键环境下的多智能体协作提供了新思路。该方法在训练和部署阶段均能确保安全性，具有实际应用价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T09:02:49Z
- **目录日期**: 2025-04-04
