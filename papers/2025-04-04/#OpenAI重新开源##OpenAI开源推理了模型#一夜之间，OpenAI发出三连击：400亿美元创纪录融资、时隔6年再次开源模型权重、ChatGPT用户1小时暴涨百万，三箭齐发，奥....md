...
OpenAI近期发布三项重大动态：1) 获得创纪录的400亿美元融资；2) 时隔6年重新开源模型权重，首推可商用推理模型；3) ChatGPT用户量1小时激增百万。这些举措显著提升了AI领域热度，被视为对DeepSeek等竞争对手的直接回应。开源模型不设商用限制的特点尤其引发业界关注。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T08:03:48Z
- **目录日期**: 2025-04-04
