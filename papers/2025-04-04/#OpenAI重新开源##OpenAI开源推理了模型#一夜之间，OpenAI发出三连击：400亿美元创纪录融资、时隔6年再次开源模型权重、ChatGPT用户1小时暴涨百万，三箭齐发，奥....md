...
OpenAI近期动作频频：宣布创纪录的400亿美元融资，时隔6年重新开源模型权重（包括可商用的推理模型），同时ChatGPT用户量1小时内暴增百万。这一系列举措将AI领域热度推向新高，被外界视为对DeepSeek等竞争对手的直接回应。开源策略的转变尤其引发关注，标志着OpenAI在商业化与开放生态之间寻求新平衡。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T03:14:11Z
- **目录日期**: 2025-04-04
