...
OpenAI近期动作频频：完成400亿美元创纪录融资，时隔6年重新开源模型权重（含推理模型且无商用限制），ChatGPT用户1小时激增百万。三大举措同步推进，显著提升AI领域热度。此次开源被视为对DeepSeek等开源模型的直接竞争，标志着OpenAI战略调整。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T17:03:44Z
- **目录日期**: 2025-04-04
