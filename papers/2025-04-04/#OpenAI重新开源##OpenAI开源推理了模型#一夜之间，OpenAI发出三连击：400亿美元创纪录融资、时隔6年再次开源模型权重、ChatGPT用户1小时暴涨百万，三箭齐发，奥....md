...
OpenAI近期采取三项重大举措：完成创纪录的400亿美元融资、时隔6年重新开源模型权重（包含推理模型且不限制商用）、ChatGPT用户1小时暴涨百万。这些动作显著提升了AI领域热度，被视为对DeepSeek等竞争对手的直接回应。开源策略的回归标志着OpenAI在商业化与开放生态之间寻求新平衡，可能重塑行业竞争格局。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T05:03:12Z
- **目录日期**: 2025-04-04
