...
OpenAI近期动作频频：完成400亿美元创纪录融资、时隔6年重新开源模型权重（含推理模型且不限制商用）、ChatGPT用户1小时暴涨百万。这三大举措将AI领域热度推向新高，被解读为对标DeepSeek等开源竞争对手的战略布局。开源模型包含完整推理能力，商业使用无限制，显著降低了行业技术门槛。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T11:03:52Z
- **目录日期**: 2025-04-04
