...
OpenAI近期重磅动作频出：完成400亿美元创纪录融资，时隔6年重新开源模型权重，ChatGPT用户1小时激增百万。此次开源包含推理模型且不限制商用，被视为直接对标DeepSeek等开源竞品。三大举措同步推进，CEO奥特曼将AI行业热度推向新高度，引发广泛关注。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T18:03:42Z
- **目录日期**: 2025-04-04
