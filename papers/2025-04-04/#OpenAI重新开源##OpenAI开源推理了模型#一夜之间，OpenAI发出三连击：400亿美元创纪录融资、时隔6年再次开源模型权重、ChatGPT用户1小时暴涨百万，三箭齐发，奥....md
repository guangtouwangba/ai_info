...
OpenAI近期采取了三项重大举措：完成创纪录的400亿美元融资、时隔6年重新开源模型权重，以及ChatGPT用户量1小时内暴涨百万。这些动作显著提升了AI领域的热度。其中开源的推理模型不限制商用，被视为直接对标DeepSeek等竞争对手。这一系列动作标志着OpenAI在商业化与开源战略上的重大调整，可能重塑当前AI行业格局。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T06:03:36Z
- **目录日期**: 2025-04-04
