...
OpenAI近期动作频频：完成400亿美元创纪录融资，时隔6年重新开源模型权重（含推理模型且无商用限制），ChatGPT用户1小时激增百万。这些举措显著提升了AI领域热度，被视为对DeepSeek等竞争对手的直接回应。开源策略的调整标志着OpenAI在商业化与开放生态间寻求新平衡。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T15:03:55Z
- **目录日期**: 2025-04-04
