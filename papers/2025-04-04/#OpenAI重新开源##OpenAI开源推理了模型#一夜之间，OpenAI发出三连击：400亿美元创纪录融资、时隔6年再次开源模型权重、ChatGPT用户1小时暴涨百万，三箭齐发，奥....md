...
OpenAI近期采取三项重大举措：完成400亿美元创纪录融资、时隔6年重新开源模型权重（含商用许可）、ChatGPT用户1小时激增百万。这一系列动作将AI领域热度推向新高，其开源策略被视为直接对标DeepSeek等竞争对手。首波开源的推理模型取消商用限制，展现出OpenAI在行业竞争中的积极姿态。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T23:03:46Z
- **目录日期**: 2025-04-04
