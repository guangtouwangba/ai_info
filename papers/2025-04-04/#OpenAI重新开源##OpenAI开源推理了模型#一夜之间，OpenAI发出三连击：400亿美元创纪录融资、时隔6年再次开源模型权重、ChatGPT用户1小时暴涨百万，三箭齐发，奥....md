...
OpenAI近期动作频频：完成400亿美元创纪录融资，时隔6年重新开源模型权重（含推理模型且无商用限制），ChatGPT用户1小时激增百万。三大举措同步推进，CEO奥特曼将AI行业热度推向新高。此次开源被视为直接对标国产模型DeepSeek，引发行业广泛关注。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T20:03:39Z
- **目录日期**: 2025-04-04
