...
OpenAI近期动作频频：1)完成创纪录的400亿美元融资；2)时隔6年重新开源模型权重，首个开源推理模型不限制商用；3)ChatGPT用户1小时暴增百万。这一系列举措将AI领域热度推向新高，被视为对DeepSeek等竞争对手的直接回应。开源策略的调整标志着OpenAI在商业化与开放生态之间寻求新平衡。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T02:29:03Z
- **目录日期**: 2025-04-04
