...
OpenAI近期动作频频：完成400亿美元创纪录融资，时隔6年再次开源模型权重，并推出可商用推理模型。同时ChatGPT用户数1小时内暴涨百万。这一系列举措将AI领域热度推向新高，被视为直接对标DeepSeek等竞争对手。开源策略的调整显示出OpenAI在商业化与开放生态间寻求平衡，其最新开源的推理模型不限制商业用途，可能对行业格局产生重要影响。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T04:02:50Z
- **目录日期**: 2025-04-04
