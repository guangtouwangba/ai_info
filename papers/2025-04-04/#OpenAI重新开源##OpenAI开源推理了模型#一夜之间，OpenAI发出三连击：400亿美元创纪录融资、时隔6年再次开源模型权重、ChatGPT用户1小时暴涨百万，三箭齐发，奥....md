...
OpenAI近期动作频频：完成400亿美元创纪录融资，时隔6年再次开源模型权重（含推理模型且无商用限制），同时ChatGPT用户1小时激增百万。三大举措将AI领域热度推向新高，被视为与DeepSeek等竞争对手的直接抗衡。此次开源被业界解读为战略调整，可能重塑行业格局。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T22:03:47Z
- **目录日期**: 2025-04-04
