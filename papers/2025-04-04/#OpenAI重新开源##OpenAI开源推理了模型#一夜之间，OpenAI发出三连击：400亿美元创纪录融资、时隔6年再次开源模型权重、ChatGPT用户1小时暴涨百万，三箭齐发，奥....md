...
OpenAI近期动作频频：完成400亿美元创纪录融资，时隔6年再次开源模型权重（包括可商用的推理模型），同时ChatGPT用户1小时暴涨百万。这一系列举措将AI领域热度推向新高，被外界视为对DeepSeek等竞争对手的直接回应。开源策略的调整标志着OpenAI在商业化与开源生态之间寻求新平衡。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T00:03:49Z
- **目录日期**: 2025-04-04
