...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可以模拟超过1万个代理的行为及其500万次互动。研究者用它研究了社会极化、信息传播、基本收入政策及外部冲击等社会问题，结果与现实世界实验吻合。这验证了其模拟人类行为和社会机制的能力，展示了作为社会科学研究和政策制定工具的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T15:05:27Z
- **目录日期**: 2025-04-04
