...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟10,000多个AI代理及其500万次互动。研究者用它分析四个关键社会问题：群体极化、信息传播、基本收入政策影响和自然灾害应对。结果显示，其模拟结果与现实世界数据高度吻合，验证了该系统在揭示人类行为机制和社会动态方面的有效性。该平台为社会科学研究和政策制定提供了新工具，能辅助传统方法（如调查和实验）探索复杂社会现象的成因和解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T12:05:48Z
- **目录日期**: 2025-04-04
