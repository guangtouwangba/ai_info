...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟1万多个代理及其500万次互动。它通过真实社会环境和大规模模拟引擎，研究了社会极化、信息传播、基本收入政策和自然灾害影响等关键问题。结果显示其模拟结果与现实实验高度吻合，验证了该工具在捕捉人类行为机制方面的能力。该平台为社会科学研究和政策制定提供了新方法，能有效补充传统调查和干预研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T23:05:17Z
- **目录日期**: 2025-04-04
