...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个代理及其500万次互动。它通过研究社会极化、信息传播、基本收入政策和自然灾害等案例，验证了其模拟结果与现实世界数据的一致性。该系统为社会科学研究和政策制定提供了新工具，能有效捕捉人类行为模式和社会机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T07:05:25Z
- **目录日期**: 2025-04-04
