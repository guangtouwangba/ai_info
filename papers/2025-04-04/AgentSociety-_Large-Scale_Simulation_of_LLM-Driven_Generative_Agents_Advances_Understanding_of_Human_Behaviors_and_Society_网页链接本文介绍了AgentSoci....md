...
AgentSociety是一个基于大型语言模型的大规模社会模拟系统，可模拟10,000多个代理及其500万次互动。研究者利用该系统研究了社会极化、信息传播、基本收入政策及飓风影响等社会问题，结果与现实世界数据吻合。该系统结合LLM代理、真实社会环境和模拟引擎，能有效捕捉人类行为机制，为社会科学研究和政策制定提供新工具。实验表明AgentSociety可辅助传统研究方法（如调查和干预），揭示社会问题的模式和成因，具有重要应用潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T17:05:09Z
- **目录日期**: 2025-04-04
