...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟超过1万个AI代理及其500万次互动。研究者利用该平台探索了社会极化、信息传播、基本收入政策及自然灾害影响等关键社会问题。模拟结果与现实世界数据高度吻合，验证了其在分析人类行为和社会机制方面的有效性。该工具为社会科学研究和政策制定提供了新方法，能辅助传统调查和干预研究，帮助理解社会问题的成因和潜在解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T11:06:07Z
- **目录日期**: 2025-04-04
