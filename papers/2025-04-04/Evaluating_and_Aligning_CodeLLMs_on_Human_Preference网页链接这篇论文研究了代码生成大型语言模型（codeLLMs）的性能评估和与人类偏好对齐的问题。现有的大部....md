...
这篇论文研究了代码生成大模型（CodeLLMs）与人类偏好的对齐问题，指出现有基准测试过于关注代码正确性而忽略用户体验。研究者开发了CodeArena基准测试，包含397个高质量样本，覆盖40个类别和44种编程语言，模拟真实编程任务。同时构建了20B标记的合成指令数据集SynCode-Instruct验证指令微调效果。实验发现执行基准与人类偏好评估存在差异，开源模型（如Qwen2.5-Coder）与商业模型（如OpenAI o1）性能差距显著，强调了人类偏好对齐的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T11:06:56Z
- **目录日期**: 2025-04-04
