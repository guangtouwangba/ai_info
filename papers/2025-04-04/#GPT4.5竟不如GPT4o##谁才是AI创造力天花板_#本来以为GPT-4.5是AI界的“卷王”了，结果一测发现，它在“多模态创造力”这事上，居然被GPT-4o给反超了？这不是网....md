...
浙江大学与上海AI Lab联合开发了名为Creation-MMBench的新基准测试，专门评估AI在多模态创造力方面的表现。测试发现，GPT-4.5在基于图像的创意任务（如故事创作、设计构思等）上表现不如GPT-4o，后者展现出更强的多模态创造能力。这一结果挑战了此前认为GPT-4.5是AI创造力天花板的观点，为衡量AI作为"创意工作者"的能力提供了新标准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T14:03:32Z
- **目录日期**: 2025-04-04
