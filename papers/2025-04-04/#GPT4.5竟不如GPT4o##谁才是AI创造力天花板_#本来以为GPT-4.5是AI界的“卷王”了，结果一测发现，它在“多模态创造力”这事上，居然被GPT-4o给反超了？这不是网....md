...
浙江大学与上海AI Lab联合开发了名为Creation-MMBench的新基准测试，专门评估AI在多模态创造力方面的表现（如基于图像的讲故事、设计等创意任务）。测试结果显示，GPT-4.5在"多模态创造力"上被GPT-4o反超，后者展现出更强的创意工作能力。该研究通过科学测评揭示了当前AI模型的创造力上限差异，为多模态AI发展提供了重要参考指标。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T13:09:45Z
- **目录日期**: 2025-04-04
