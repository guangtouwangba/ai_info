...
浙江大学与上海AI Lab联合开发了名为Creation-MMBench的新基准测试，专门评估AI模型的多模态创造力（如基于图像生成故事、设计等）。测试结果显示，GPT-4.5在创意任务表现上反被GPT-4o超越，后者展现出更强的"创意工作者"能力。该研究通过量化指标挑战了模型迭代必然提升性能的假设，为AI创造力评估提供了新标准。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T17:03:18Z
- **目录日期**: 2025-04-04
