...
浙江大学与上海AI Lab联合开发了名为Creation-MMBench的新基准测试，专门评估AI的多模态创造力，如基于图像的讲故事、设计和创意工作能力。测试结果显示，GPT-4.5在多模态创造力上表现不如GPT-4o，后者展现出更强的创意能力。这一发现挑战了此前认为GPT-4.5是AI界“卷王”的认知，为衡量AI创造力提供了新的标准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T12:03:23Z
- **目录日期**: 2025-04-04
