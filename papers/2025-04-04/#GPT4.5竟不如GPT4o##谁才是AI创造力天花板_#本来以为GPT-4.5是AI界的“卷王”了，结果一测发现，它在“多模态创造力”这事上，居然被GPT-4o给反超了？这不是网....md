...
浙江大学与上海AI Lab合作开发了名为Creation-MMBench的新基准测试，专门评估AI在多模态创造力方面的表现。测试发现，GPT-4o在基于图像的创意任务（如故事创作、设计构思等）上超越了GPT-4.5，打破了此前认为GPT-4.5更强的预期。这一结果表明GPT-4o可能成为当前AI创造力的新标杆。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T07:02:58Z
- **目录日期**: 2025-04-04
