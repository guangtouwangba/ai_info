...
浙江大学与上海AI Lab联合开发了名为Creation-MMBench的新基准测试，专门评估AI的多模态创造力，包括基于图像的讲故事、设计和创意工作能力。测试结果显示，GPT-4.5在创造力表现上不如GPT-4o，后者在多模态任务中展现出更强的创意能力。这一发现挑战了此前对GPT-4.5作为"AI卷王"的认知，表明不同模型在特定领域的性能可能存在显著差异。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T10:03:19Z
- **目录日期**: 2025-04-04
