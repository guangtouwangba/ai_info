...
浙江大学与上海AI Lab合作开发了名为Creation-MMBench的新基准测试，专门评估AI的多模态创造力（如基于图像的讲故事、设计等创意能力）。测试结果显示，GPT-4.5在创意任务表现上反而不如GPT-4o，颠覆了此前对模型迭代性能的预期。该研究通过量化指标揭示了当前AI在创造性工作领域的实际能力边界。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T16:03:14Z
- **目录日期**: 2025-04-04
