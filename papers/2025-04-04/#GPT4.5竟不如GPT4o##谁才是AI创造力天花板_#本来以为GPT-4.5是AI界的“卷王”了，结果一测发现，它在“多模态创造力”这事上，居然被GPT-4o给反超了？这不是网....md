...
浙江大学与上海AI Lab合作开发了名为Creation-MMBench的新基准测试，专门评估AI在多模态创造力方面的表现。测试结果显示，GPT-4.5在基于图像的创意任务（如讲故事、设计等）上表现不如GPT-4o，后者展现出更强的多模态创造力。该基准旨在探索AI作为"创意工作者"的能力上限。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T19:03:16Z
- **目录日期**: 2025-04-04
