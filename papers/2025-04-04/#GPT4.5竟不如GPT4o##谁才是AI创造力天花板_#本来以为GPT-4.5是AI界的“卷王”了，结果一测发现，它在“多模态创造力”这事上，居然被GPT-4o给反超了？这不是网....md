...
浙江大学与上海AI Lab合作开发了名为Creation-MMBench的新基准测试，专门评估AI的多模态创造力（如基于图像的讲故事、设计等创意能力）。测试结果显示，GPT-4.5在创意表现上意外落后于GPT-4o，颠覆了此前认为GPT-4.5更强的预期。该研究通过量化分析揭示了不同AI模型在创造性任务中的实际表现差异，为评估AI的"创意工作者"潜力提供了新标准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T22:03:16Z
- **目录日期**: 2025-04-04
