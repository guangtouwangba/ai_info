...
浙江大学与上海AI Lab合作开发了名为Creation-MMBench的新基准测试，专门评估AI的多模态创造力（如基于图像的讲故事、设计等）。测试结果显示，GPT-4.5在创造力表现上不如GPT-4o，后者在多模态任务中展现更强能力。该研究旨在探索AI作为"创意工作者"的潜力上限，为模型性能提供更全面的衡量标准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T21:02:57Z
- **目录日期**: 2025-04-04
