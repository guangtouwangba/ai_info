...
浙江大学与上海AI Lab联合开发了名为Creation-MMBench的新基准测试，专门评估AI的多模态创造力（如基于图像的讲故事、设计等）。测试发现，GPT-4.5在创意任务表现上不如GPT-4o，后者展现出更强的多模态创造力。这一结果挑战了此前对GPT-4.5作为"AI卷王"的认知，揭示了不同模型在创意工作领域的性能差异。研究为衡量AI创造力提供了新标准，可能影响未来模型发展方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T18:03:19Z
- **目录日期**: 2025-04-04
