...
浙江大学与上海AI Lab联合开发了名为Creation-MMBench的新基准测试，专门评估AI的多模态创造力（如基于图像的讲故事、设计等）。测试结果显示，GPT-4.5在创意任务上的表现反而不如GPT-4o，打破了此前认为GPT-4.5更强的预期。该研究旨在探索AI作为"创意工作者"的能力上限，为多模态生成模型的性能提供了更细粒度的衡量标准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T06:03:07Z
- **目录日期**: 2025-04-04
