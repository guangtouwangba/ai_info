...
该研究提出了一个由推理模块、解释模块和人机交互模块组成的框架，旨在提升大语言模型(LLMs)在物理研究中的可靠性和可解释性。通过专门设计的解释模块(包含摘要生成、模型构建、界面开发和测试等智能体)，将LLM输出结构化地整合到物理理论框架中，构建更易理解的科学模型。案例研究表明，该方法能增强AI辅助科学推理的透明度，便于验证结果，并深化与既有理论模型的融合。研究特别强调了物理推理所需的逻辑一致性、定量精确性和理论整合性，为AI辅助科研提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T02:27:57Z
- **目录日期**: 2025-04-04
