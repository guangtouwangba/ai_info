...
大型AI模型虽然在标准化测试中表现优异，但在医疗、教育、法律等高风险领域应用时，仍存在明显缺陷，如对输入数据微小变化敏感、关键场景下决策缺乏上下文理解、以及自信地产生错误信息等问题。为此，研究者提出了一种分层创新框架，通过模块化方法将大模型转化为实用的垂直系统，并强调各层间的动态协作。该框架帮助研究者和从业者：（1）定位创新方向，（2）发现跨领域共性机遇，（3）促进跨学科关键挑战的交流。案例研究表明，该框架能有效协调模型能力与实际应用需求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T07:01:32Z
- **目录日期**: 2025-04-04
