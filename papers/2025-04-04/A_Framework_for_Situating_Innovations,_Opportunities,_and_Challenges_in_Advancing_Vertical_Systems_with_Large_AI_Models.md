...
大型AI模型虽然在标准化测试中表现优异，但在医疗、教育等高风险领域应用时，常暴露脆弱性、缺乏情境理解及输出错误等问题。为此，研究者提出分层创新框架，通过模块化方法将大模型转化为实用"垂直系统"，并强调各层间的动态协作。该框架帮助研究者：(1)定位创新方向（如垂直领域洞察推动通用创新）；(2)发现被忽视的机会（如跨领域共性问题导向的基础模型开发）；(3)促进跨学科交流（建立开发者、领域专家与人机交互学者的共同语言）。案例研究表明该框架可有效指导实践。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T13:07:51Z
- **目录日期**: 2025-04-04
