...
本文提出了一种评估合成数据质量的框架，旨在平衡隐私保护与数据实用性。该框架采用保留样本基准测试策略，通过低维/高维分布比较、嵌入相似度测量和最近邻距离指标进行量化评估，支持序列和上下文等多种数据类型。其标准化指标可提供可解释的质量诊断，促进合成数据生成技术的可复现性和方法一致性。相关代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T02:28:07Z
- **目录日期**: 2025-04-04
