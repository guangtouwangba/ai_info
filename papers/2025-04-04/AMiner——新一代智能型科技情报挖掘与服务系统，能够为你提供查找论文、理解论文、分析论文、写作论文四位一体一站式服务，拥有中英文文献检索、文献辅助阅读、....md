...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、辅助阅读、翻译、学术问答等功能。它收录了3.5亿论文、0.6亿学者等海量数据，支持AI生成摘要、章节概要和互动问答，帮助用户高效理解文献内容。平台还提供个性化科研情报订阅服务，通过微信或邮件推送最新学术动态。此外，AMiner具备学者画像、学术会议追踪等特色功能，浏览器版本可免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T23:05:45Z
- **目录日期**: 2025-04-04
