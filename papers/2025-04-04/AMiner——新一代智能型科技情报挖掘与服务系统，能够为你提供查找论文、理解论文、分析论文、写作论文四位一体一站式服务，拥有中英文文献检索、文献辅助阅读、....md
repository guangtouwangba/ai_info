...
AMiner是一个智能科技情报挖掘系统，提供四位一体的学术服务：论文检索、理解、分析和写作支持。它拥有中英文文献检索、辅助阅读、翻译等功能，收录3.5亿论文、0.6亿学者等海量数据。特色功能包括互动问答生成文献摘要、AI辅助阅读（上传PDF生成摘要和章节概要）、科研动态订阅（按偏好推送最新论文）。平台还提供学者画像、学术会议等资源，支持浏览器免费使用，帮助用户高效获取和管理学术信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T01:32:16Z
- **目录日期**: 2025-04-04
