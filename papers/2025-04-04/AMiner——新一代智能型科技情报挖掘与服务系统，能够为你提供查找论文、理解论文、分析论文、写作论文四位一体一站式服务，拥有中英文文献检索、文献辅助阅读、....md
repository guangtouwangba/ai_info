...
AMiner是一个智能科技情报挖掘平台，提供四位一体的学术服务：文献检索、辅助阅读、翻译分析和科研订阅。它收录3.5亿论文、0.6亿学者和1.5亿专利，支持中英文检索、AI生成摘要、互动问答和文献翻译。用户可订阅个性化科研动态，跟踪机构/学者动态。平台还提供学者画像、学术会议等特色功能，基础服务免费使用，助力高效科研。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T06:06:01Z
- **目录日期**: 2025-04-04
