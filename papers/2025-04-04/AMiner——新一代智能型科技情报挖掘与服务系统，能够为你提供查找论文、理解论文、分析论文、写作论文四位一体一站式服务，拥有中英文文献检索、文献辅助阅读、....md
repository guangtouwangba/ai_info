...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译和分析等一站式服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持中英文文献检索，并能通过AI生成摘要和问答互动。平台还提供文献翻译、科研动态订阅、学者画像等功能，用户可定制关注内容并通过微信或邮件接收更新。AMiner的浏览器版本免费开放，旨在提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T02:31:59Z
- **目录日期**: 2025-04-04
