...
该研究介绍了首个多模态X射线行李安检数据集STCray，包含46,642张图像-文本配对扫描图，覆盖21种威胁类别。通过专业协议生成领域感知的连贯文本描述，用于训练视觉AI助手STING-BEE。该助手支持多种视觉语言任务，如场景理解、威胁定位和视觉问答，在跨域设置中表现出优异泛化能力。研究突破了现有封闭集范式的限制，为X射线安检领域的多模态学习建立了新基准。相关代码、数据和模型已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T04:00:57Z
- **目录日期**: 2025-04-04
