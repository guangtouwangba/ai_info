...
传统优化编译器在现代软件系统的复杂性管理中至关重要，而并行编程的需求进一步强化了优化技术的重要性。本研究探讨了大型语言模型（LLMs）能否革新代码优化方法，通过对比三种传统编译器与两种LLMs的性能。研究发现，LLMs虽能超越传统编译器（如CodeLlama-70B最高提速1.75倍，优于CETUS编译器的1.67倍），但在大代码量时易生成错误代码，需自动化验证。提示策略对LLMs性能影响显著，其中详细指令（DIP）和思维链（CoT）策略效果突出。研究还提出了优化模式基准测试和自动评估机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-04T02:28:51Z
- **目录日期**: 2025-04-04
