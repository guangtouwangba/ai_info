...
本文探讨了通过众包方式激发AI在网络安全攻防中的潜力。研究团队在两场CTF比赛中设立公开AI赛道，AI团队表现优异，分别进入前5%和前10%，表明开放市场激发可作为内部评估的有效补充。研究建议采用悬赏机制来及时掌握AI新兴能力。另一优势是能大规模收集人类表现数据，分析显示AI可可靠解决中位人类选手1小时内完成的网络安全挑战。这为AI能力评估和负责任部署提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T17:02:39Z
- **目录日期**: 2025-05-28
