...
本研究通过在两场网络安全夺旗赛（CTF）中设置公开AI赛道，探索众包方式激发AI网络攻防潜力的可行性。结果显示AI团队表现优异，分别进入前5%和前10%并赢得7500美元奖金，表明公开市场激发可作为内部评估的有效补充。研究者建议设立"AI能力激发悬赏"机制，以低成本持续追踪AI技术发展。研究还采用METR方法量化对比，发现AI能可靠解决中位水平人类选手1小时内完成的网络挑战。这为评估AI网络攻防能力提供了新思路，对AI治理和负责任部署具有启示意义。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T19:02:14Z
- **目录日期**: 2025-05-28
