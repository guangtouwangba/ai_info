...
这篇论文探讨了通过众包方式激发AI在网络安全攻防中的潜力。研究团队在两场CTF比赛（400队和8000队规模）中设置公开AI赛道，AI团队表现优异（前5%和前10%），共获7500美元奖金。结果表明，开放市场的AI能力激发可作为内部研发的有效补充，建议采用悬赏机制来持续评估AI能力。研究还发现，AI能可靠解决普通人类选手1小时内完成的网络攻防挑战。这为AI网络攻防能力评估提供了新思路，同时强调了开放众包模式在收集人类基准数据方面的优势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T22:03:11Z
- **目录日期**: 2025-05-28
