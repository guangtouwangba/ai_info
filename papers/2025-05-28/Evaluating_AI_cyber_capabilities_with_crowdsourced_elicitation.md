...
随着AI系统能力不断提升，评估其网络攻击潜力对治理和部署至关重要。本研究通过在两场网络安全竞赛（400队和8000队规模）中设置公开AI赛道，发现AI团队表现优异（分别进入前5%和前10%），获得总计7500美元奖金，证明众包式AI能力激发可作为内部评估的有效补充。研究建议设立"能力激发悬赏"机制，以经济高效地追踪AI前沿能力。同时，公开测试能大规模收集人类表现数据，分析显示AI可稳定解决中位水平人类参赛者1小时内完成的网络挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T03:21:27Z
- **目录日期**: 2025-05-28
