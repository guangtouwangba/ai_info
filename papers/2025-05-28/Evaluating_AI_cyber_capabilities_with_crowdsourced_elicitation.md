...
随着AI系统能力不断提升，评估其网络攻击潜力对治理和部署至关重要。本研究通过两场CTF比赛（AI vs. Humans和Cyber Apocalypse）探索众包式AI能力激发，发现AI团队表现优异（分别进入前5%和前10%），表明开放市场激发可作为内部评估的有效补充。研究建议采用激励奖金机制来及时掌握AI新兴能力。开放评估还能大规模收集人类表现数据，分析显示AI能可靠解决中位人类参与者1小时内完成的网络安全挑战。这为AI能力评估提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T15:03:36Z
- **目录日期**: 2025-05-28
