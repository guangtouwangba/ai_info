...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作一站式服务。它支持中英文文献搜索，拥有3.5亿论文、0.6亿学者等海量数据，并提供AI辅助阅读、自动摘要生成和互动问答功能。用户可上传PDF或从平台获取论文，系统会生成摘要和章节概要。AMiner还提供科研动态订阅服务，根据用户偏好推送最新论文和资讯。此外，平台包含学者画像、学术会议和论文排行榜等功能，基础服务免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T11:05:49Z
- **目录日期**: 2025-05-28
