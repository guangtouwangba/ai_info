...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、翻译、科研情报订阅等。平台拥有3.5亿论文、0.6亿学者等海量数据，支持文献辅助阅读、AI摘要生成和智能问答，帮助用户快速理解论文内容。用户可定制科研动态推送，跟踪特定学者或关键词。此外，AMiner还提供学者画像、学术会议信息等功能，基础服务免费开放。访问链接：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T09:05:57Z
- **目录日期**: 2025-05-28
