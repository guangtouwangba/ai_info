...
随着AI系统在医疗、法律和治理等领域的应用日益增多，理解其如何处理伦理复杂场景变得至关重要。本研究不同于以往仅关注大语言模型(LLM)道德判断的工作，而是大规模分析了LLM提供的道德推理过程。通过600多个电车难题作为测试案例，研究团队开发了一个分类法，依据结果主义和义务论两大伦理理论系统地对推理过程进行分类。研究发现：LLM的思维链倾向于基于道德义务的义务论原则，而事后解释则明显转向强调效用的结果主义理由。这项研究为理解LLM处理伦理问题的方式奠定了基础，对高风险决策环境中安全部署LLM具有重要意义。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T09:02:16Z
- **目录日期**: 2025-05-28
