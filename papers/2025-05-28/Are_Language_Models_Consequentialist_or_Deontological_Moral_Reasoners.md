...
随着AI系统在医疗、法律和治理等领域的应用增多，理解其处理伦理复杂场景的方式变得至关重要。以往研究主要关注大语言模型（LLM）的道德判断，而非其内在道德推理过程。本研究通过600多个电车难题，大规模分析LLM的道德推理痕迹，并提出基于结果论和义务论的分类法。研究发现，LLM的思维链倾向于义务论原则，而事后解释则明显转向强调效用的结果论。该框架为理解LLM如何处理和表达伦理考量奠定了基础，是LLM在高风险决策中安全、可解释部署的重要一步。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T10:02:08Z
- **目录日期**: 2025-05-28
