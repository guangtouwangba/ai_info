...
随着AI系统在高风险领域的应用增加，其概率性和不透明性对传统验证方法提出了挑战。零知识证明（ZKP）作为一种密码学解决方案，能在不泄露敏感信息的情况下验证AI系统的合规性。研究通过系统调查发现，ZKP在机器学习验证中主要关注推理阶段，而数据预处理和训练阶段研究不足。当前趋势显示，研究正朝着构建统一的"零知识机器学习运维"（ZKMLOps）框架发展，该框架利用ZKP提供正确性、完整性和隐私性的密码学保证，从而增强AI系统的可问责性、透明性，并符合可信AI原则。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T01:28:58Z
- **目录日期**: 2025-05-28
