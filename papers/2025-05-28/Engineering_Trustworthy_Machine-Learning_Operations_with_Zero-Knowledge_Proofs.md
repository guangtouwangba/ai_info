...
随着AI系统在高风险领域的广泛应用，其概率性和不透明性对传统验证方法提出了挑战。零知识证明（ZKP）作为一种密码学解决方案，能在不泄露敏感信息的前提下验证AI系统的合规性。研究发现，ZKP在机器学习验证中主要聚焦于推理阶段，而数据预处理和训练阶段研究不足。当前趋势指向构建统一的零知识机器学习运维（ZKMLOps）框架，通过ZKP提供正确性、完整性和隐私性的密码学保证，从而增强AI系统的可问责性、透明性，并符合可信AI原则。该框架有望满足欧盟《人工智能法案》等监管要求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T00:01:39Z
- **目录日期**: 2025-05-28
