...
研究发现，大型语言模型(LLMs)在临床问答中存在"沉默共识"问题，即智能体过早达成诊断结论而缺乏深入分析。为此，研究提出"鲶鱼代理"概念，通过结构化异议来打破共识、激发深度推理。该代理采用两种机制：基于案例难度的复杂性感知干预，以及平衡批评与协作的语气校准干预。在12个医疗问答基准测试中，该方法显著优于单智能体和多智能体LLMs框架，包括GPT-4o和DeepSeek-R1等领先商业模型。这一创新为提升AI医疗诊断的可靠性提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T03:19:49Z
- **目录日期**: 2025-05-28
