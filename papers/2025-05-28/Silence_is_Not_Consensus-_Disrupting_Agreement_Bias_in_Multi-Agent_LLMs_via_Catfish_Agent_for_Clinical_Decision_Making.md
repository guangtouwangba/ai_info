...
大型语言模型(LLMs)在临床问答中展现潜力，但多智能体框架存在"沉默共识"问题，即在复杂案例中过早达成诊断共识。研究提出"鲶鱼代理"概念，通过引入结构化异议来对抗这种现象。该代理采用两种干预机制：(1)基于病例难度的复杂度感知干预；(2)平衡批评与协作的语气校准干预。在9个医疗问答和3个医疗视觉问答基准测试中，该方法超越了单智能体和多智能体LLMs框架，包括GPT-4o和DeepSeek-R1等领先商业模型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T11:01:01Z
- **目录日期**: 2025-05-28
