...
研究发现，大型语言模型(LLMs)在临床问答中存在"沉默共识"问题，即多智能体系统过早达成诊断结论。为此，研究者提出"鲶鱼代理"概念，通过引入结构化异议来激发深度推理。该代理采用两种机制：(1)基于病例复杂度的干预；(2)平衡批评与协作的语调校准。在12个医疗问答基准测试中，该方法超越了单智能体和多智能体框架，包括GPT-4o和DeepSeek-R1等领先商业模型。这一创新借鉴了组织心理学中的"鲶鱼效应"，有效提升了AI医疗诊断的准确性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T02:30:38Z
- **目录日期**: 2025-05-28
