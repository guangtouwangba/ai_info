...
研究发现，大型语言模型(LLMs)在临床问答中存在"沉默共识"问题，即智能体过早达成诊断共识而缺乏深入分析。受组织心理学"鲶鱼效应"启发，研究者提出"鲶鱼代理"概念，通过结构化异议来打破共识并激发深度推理。该代理采用两种干预机制：(1)基于病例难度的复杂性感知干预；(2)平衡批评与协作的语气校准干预。在9个医学问答和3个医学视觉问答基准测试中，该方法表现优于单智能体和多智能体LLMs框架，包括GPT-4o和DeepSeek-R1等领先商业模型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T21:00:57Z
- **目录日期**: 2025-05-28
