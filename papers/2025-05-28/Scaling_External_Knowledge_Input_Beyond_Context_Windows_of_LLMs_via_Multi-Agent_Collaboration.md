...
本文提出多智能体框架ExtAgents，通过分布式处理突破大语言模型（LLM）上下文窗口限制，解决海量外部知识整合的瓶颈问题。相比现有方法，ExtAgents在增强版多跳问答测试集∞Bench+及长文本生成任务中表现优异，无论输入知识是否超出上下文窗口，性能均显著提升。该方法无需长上下文训练，并行性高且效率优异，为需要大规模外部知识的复杂任务提供了新解决方案，对实际应用具有重要价值。研究还指出进一步优化多智能体协同机制将提升知识整合能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T14:02:30Z
- **目录日期**: 2025-05-28
