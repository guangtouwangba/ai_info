...
随着大语言模型(LLMs)推理和信息检索能力的提升，其有限的上下文窗口限制了外部知识的整合规模。针对这一问题，研究者提出了多智能体框架ExtAgents，通过优化知识同步和推理过程，在不扩展上下文窗口的情况下提升知识整合能力。实验表明，在改进的多跳问答测试集∞Bench+等基准上，该方法显著优于现有非训练方法，无论知识量是否超出上下文窗口限制，同时保持高效并行性。该研究为处理海量知识输入提供了新思路，对实际应用具有重要意义。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T04:04:16Z
- **目录日期**: 2025-05-28
