...
这篇论文提出了一种新方法，使视觉语言模型(VLMs)能够生成、理解和编辑复杂的3D场景。通过构建包含场景语义蓝图、标记点云和编码空间关系的超图的三维空间上下文，该方法为VLMs提供了结构化、几何感知的工作记忆。基于此，研究人员开发了一个自主3D场景生成流程，支持高质量资产生成、环境设置和人体工学调整。实验表明，该方法能处理多样化输入，实现前所未有的泛化能力，并支持交互式场景编辑和路径规划等下游任务，在计算机图形学、3D视觉和具身应用中展现出巨大潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T00:01:50Z
- **目录日期**: 2025-05-28
