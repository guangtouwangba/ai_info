...
该研究提出了一个名为MineAnyBuild的综合性基准测试，用于评估开放世界AI代理在《我的世界》游戏中的空间规划能力。该基准包含4,000个精心设计的空间规划任务，要求AI根据多模态人类指令生成可执行的建筑计划。它从空间理解、空间推理、创造力和空间常识四个维度进行评估，并支持利用玩家生成内容进行无限扩展的数据收集。研究发现现有基于多模态大语言模型的AI代理在空间规划能力上存在严重局限但潜力巨大。该基准为空间智能评估开辟了新途径，将推动具备空间规划能力的开放世界AI代理的发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T00:01:17Z
- **目录日期**: 2025-05-28
