...
基于视觉语言模型(VLM)的Web代理在模拟人类与网站交互方面取得了进展，但面临严重安全风险。研究提出AdInject攻击方法，利用互联网广告投放向Web代理环境注入恶意内容，无需了解用户意图或代理模型参数。该方法通过设计误导性广告内容和基于VLM的优化技术，使广告看似与任务相关，攻击成功率超过60%，某些情况下接近100%。研究表明广告投放是Web代理环境注入攻击的有效途径，凸显了开发防御机制的紧迫性。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T13:11:09Z
- **目录日期**: 2025-05-28
