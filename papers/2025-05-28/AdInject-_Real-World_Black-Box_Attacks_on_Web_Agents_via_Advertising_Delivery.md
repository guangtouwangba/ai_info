...
基于视觉语言模型(VLM)的Web代理在自动化网页交互方面取得进展，但面临新型安全威胁。研究者提出AdInject攻击方法，通过互联网广告投放向代理环境注入恶意内容，无需知晓用户意图或代理参数。该方法利用VLM优化广告内容，使其看似与任务相关，成功率最高达100%。实验表明，常见广告渠道可成为针对Web代理的有效攻击媒介，凸显了开发防御机制的紧迫性。该研究揭示了现实环境中Web代理的安全漏洞，代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T11:01:20Z
- **目录日期**: 2025-05-28
