...
本文提出AdInject，一种新型黑盒攻击方法，利用互联网广告投放向基于视觉语言模型(VLM)的网页代理注入恶意内容。相比现有攻击方法依赖不现实的假设（如直接修改HTML或获取模型参数），AdInject在更现实的威胁模型下运作：无需知晓用户意图或代理参数，仅需静态恶意内容。该方法通过设计诱导点击的广告内容，并基于VLM优化广告使其与网页上下文相关，从而提高攻击成功率。实验显示攻击成功率超60%，某些情况下接近100%，揭示了广告投放作为实际攻击媒介的严重安全威胁，亟需防御机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T16:01:24Z
- **目录日期**: 2025-05-28
