...
基于视觉语言模型(VLM)的网页代理在自动化复杂任务方面取得进展，但存在严重安全漏洞。研究提出AdInject攻击方法，利用互联网广告投放向网页代理注入恶意内容，无需获取代理参数或用户意图信息。该方法通过设计误导性广告内容和基于VLM的优化技术，使广告看似与任务相关，攻击成功率超过60%，某些情况下接近100%。研究表明广告投放是现实可行的攻击媒介，凸显网页代理安全漏洞，亟需开发防御机制。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T18:01:23Z
- **目录日期**: 2025-05-28
