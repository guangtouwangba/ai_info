...
基于视觉语言模型（VLM）的Web代理通过模拟人类与网站的交互实现任务自动化，但其在开放网络环境中面临安全风险。本文提出AdInject攻击方法，利用互联网广告投放向Web代理环境注入恶意内容。该方法采用黑盒攻击模式，无需了解用户意图或代理参数，通过优化广告内容误导代理点击。实验显示攻击成功率超60%，部分场景接近100%，证明广告投放是有效的攻击媒介。研究揭示了Web代理因现实环境操控渠道存在的安全漏洞，亟需开发防御机制。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T03:20:10Z
- **目录日期**: 2025-05-28
