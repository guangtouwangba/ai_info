...
该论文提出AdInject，一种针对视觉语言模型(VLM)网页代理的新型黑盒攻击方法，通过互联网广告投放注入恶意内容。相比现有攻击方法依赖不现实的假设，AdInject在更现实的威胁模型下运作：无需代理参数、用户意图知识或直接HTML操作。该方法包含误导代理点击的恶意广告设计策略，以及基于VLM的广告内容优化技术，通过推断网站上下文增强攻击相关性。实验显示攻击成功率超60%，某些场景接近100%，证明广告投放是有效的真实攻击媒介。研究揭示了网页代理面临的实际安全威胁，亟需开发防御机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T12:01:18Z
- **目录日期**: 2025-05-28
