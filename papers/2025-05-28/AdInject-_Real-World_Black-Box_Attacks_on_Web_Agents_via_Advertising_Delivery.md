...
基于视觉语言模型(VLM)的Web代理在模拟人类与网站交互方面取得重要进展，但其在开放网络环境中存在严重安全漏洞。本研究提出AdInject攻击方法，利用互联网广告投放向Web代理环境注入恶意内容。该方法采用黑盒攻击模式，无需了解用户意图或代理参数，通过优化广告内容误导代理点击。实验显示攻击成功率超过60%，某些情况下接近100%，证明广告投放是有效的攻击媒介。该研究揭示了Web代理面临的实际安全威胁，亟需开发防御机制。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T07:01:20Z
- **目录日期**: 2025-05-28
