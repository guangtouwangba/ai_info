...
亚马逊推行AI编程工具后，程序员面临新挑战：管理层因AI"提升效率"缩短项目周期，员工被迫依赖AI生成代码，但需耗费大量时间审核和修复错误代码，工作压力不减反增。虽然公司强调AI旨在增强而非替代人力，但员工抱怨晋升路径模糊，且功劳被归功于AI。部分人认为AI能处理琐碎任务，但整体上程序员正沦为"代码流水线工人"。微软Copilot此前也因自动修Bug失败引发争议，凸显AI编程的可靠性问题。管理层则认为AI显著提升生产力并节省成本，双方矛盾持续。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T01:31:50Z
- **目录日期**: 2025-05-28
