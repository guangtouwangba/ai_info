...
OSSU是一个开源计算机教育项目，整合了哈佛、MIT等名校的免费计算机课程，提供系统化学习路径。课程分为四个阶段：CS入门、核心知识（编程/算法/操作系统等）、进阶选修（系统架构/安全等）和毕业项目。适合零基础到进阶学习者，支持灵活进度（建议每周20小时/两年完成）。项目由全球社区维护，提供学习工具和讨论平台（Discord/GitHub）。GitHub获18.4万星，课程地址：github.com/ossu/computer-science。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T21:03:26Z
- **目录日期**: 2025-05-28
