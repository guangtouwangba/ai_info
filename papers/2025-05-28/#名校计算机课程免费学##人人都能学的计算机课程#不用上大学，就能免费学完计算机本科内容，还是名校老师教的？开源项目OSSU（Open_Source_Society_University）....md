...
OSSU是一个开源计算机教育项目，整合了哈佛、MIT等全球顶尖名校的免费计算机课程，提供从零基础到进阶的系统学习路径。项目包含四个阶段：计算机入门、核心知识（编程/算法/操作系统等）、选修方向（安全/架构等）和毕业项目，完整学习约需2年（每周20小时）。学习者可通过GitHub和Discord社区互动，并利用配套工具制定学习计划。该项目适合自学、转岗或技能提升，目前GitHub星标已超18.4万。课程地址：github.com/ossu/computer-science

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T23:03:23Z
- **目录日期**: 2025-05-28
