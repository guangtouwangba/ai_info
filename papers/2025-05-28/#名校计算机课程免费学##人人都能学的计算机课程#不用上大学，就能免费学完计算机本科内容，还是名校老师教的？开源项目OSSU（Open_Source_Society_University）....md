...
OSSU是一个开源计算机教育项目，整合了哈佛、MIT等全球顶尖名校的免费计算机课程，提供系统化的自学路径。该项目包含四个阶段：CS入门、核心知识（编程/算法/操作系统等）、进阶选修（系统架构/安全等）和毕业项目，适合零基础到进阶学习者。通过GitHub和Discord社区提供学习支持，建议每周20小时约两年完成。所有课程免费，学习者可自主安排进度，并配有进度追踪工具。GitHub星标超18.4万，已成为技术自学热门资源。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T13:13:38Z
- **目录日期**: 2025-05-28
