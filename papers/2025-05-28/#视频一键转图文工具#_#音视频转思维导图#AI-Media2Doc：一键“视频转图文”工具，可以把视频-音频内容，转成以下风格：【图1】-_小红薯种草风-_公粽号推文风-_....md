# #视频一键转图文工具# #音视频转思维导图#AI-Media2Doc：一键“视频转图文”工具，可以把视频/音频内容，转成以下风格：【图1】- 小红薯种草风- 公粽号推文风- ...
...
AI-Media2Doc是一款开源本地部署的视频处理工具，可将音视频一键转换为多种格式：小红书/公众号风格图文、知识笔记、思维导图和字幕文件。其核心技术采用ffmpeg wasm实现前端视频处理，支持浏览器直接运行。特色功能包括AI视频问答（提取核心观点/重点）、字幕导出、Docker部署等。开发者为解决个人视频笔记痛点而开发，强调隐私保护无需上传数据。未来计划加入关键帧提取和本地语音识别优化处理效率。项目地址：github.com/hanshuaikang/AI-Media2Doc（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T20:03:38Z
- **目录日期**: 2025-05-28
