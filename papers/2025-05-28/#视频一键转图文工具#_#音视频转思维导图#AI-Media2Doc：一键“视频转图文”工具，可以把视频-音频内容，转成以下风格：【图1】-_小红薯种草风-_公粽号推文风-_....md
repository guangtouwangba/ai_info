...
AI-Media2Doc是一款开源本地部署的视频/音频转图文工具，支持将内容转换为小红书风格、公众号推文、知识笔记、思维导图及字幕文件。其特色包括：前端通过ffmpeg wasm处理视频，支持AI问答提取核心观点，可导出字幕文件，提供Docker部署方案。开发者旨在解决视频笔记痛点，保障隐私安全，未来计划加入关键帧提取和本地语音识别功能。项目地址：github.com/hanshuaikang/AI-Media2Doc。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T15:05:17Z
- **目录日期**: 2025-05-28
