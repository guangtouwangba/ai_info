...
AI-Media2Doc是一款开源本地部署的视频转图文工具，可将音视频内容转换为小红书/公众号风格图文、知识笔记、思维导图或字幕文件。基于ffmpeg wasm技术，完全在浏览器前端处理视频，支持AI问答提取核心观点、导出字幕文件、Docker一键部署等功能。开发者为解决视频笔记痛点开发，未来计划加入关键帧提取和本地语音识别优化处理效率。项目地址：github.com/hanshuaikang/AI-Media2Doc

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T23:03:31Z
- **目录日期**: 2025-05-28
