...
AI-Media2Doc是一款开源本地部署的视频/音频转图文工具，支持将内容转换为小红书风格、公众号推文、知识笔记、思维导图及字幕文件。该工具基于ffmpeg wasm技术，完全在浏览器前端处理视频，无需上传隐私数据。特色功能包括：AI智能问答（提炼视频核心观点）、字幕导出、Docker一键部署。开发者旨在解决视频学习笔记痛点，未来计划加入关键帧提取和本地语音识别功能以提升效率。项目地址：github.com/hanshuaikang/AI-Media2Doc

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T10:03:46Z
- **目录日期**: 2025-05-28
