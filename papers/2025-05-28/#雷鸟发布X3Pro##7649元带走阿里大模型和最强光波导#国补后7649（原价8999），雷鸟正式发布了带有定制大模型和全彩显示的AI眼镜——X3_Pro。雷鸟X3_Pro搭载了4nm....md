...
雷鸟正式发布X3 Pro AI眼镜，国补后售价7649元（原价8999元）。该眼镜搭载4nm高通骁龙AR1平台，支持光波导全彩显示，重量仅76g。内置与阿里通义合作定制的多模态大模型，可实时交互提问，后续还将上线AI Agent商店扩展应用功能，并支持实景导航。预售于5月27日开启，6月15日发货。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T03:21:45Z
- **目录日期**: 2025-05-28
