...
EPOCH AI组织的数学竞赛中，AI模型o4-mini-medium在4.5小时内解23道题的表现优于MIT学生团队的平均水平，但未超过人类联合得分（解题率约35%）。比赛题目涵盖拓扑学、代数几何等高难度领域。人类因时间限制可能被低估实力，实际解题率推测为30-50%。AI解题更快（5-20分钟/题），而人类需更长时间且具有持续学习潜力。研究预测，若当前趋势持续，AI数学能力可能在年底超越人类。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T11:03:06Z
- **目录日期**: 2025-05-28
