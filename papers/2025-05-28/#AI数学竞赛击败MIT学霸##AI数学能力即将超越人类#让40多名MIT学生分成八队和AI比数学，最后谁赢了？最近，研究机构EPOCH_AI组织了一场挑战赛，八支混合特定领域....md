...
EPOCH AI组织的数学竞赛中，AI模型o4-mini-medium在4.5小时内解答23道高难度数学题的表现优于MIT学生团队的平均水平，但未超过人类联合解题率（约35%）。比赛题目涵盖拓扑学、代数几何等，难度从本科到菲尔兹奖级别。人类因时间限制可能被低估实力，实际解题率推测为30-50%。AI解题速度更快（5-20分钟/题），但人类长期学习潜力更强。研究预测，AI或将在年底前在数学推理上超越人类。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T19:02:52Z
- **目录日期**: 2025-05-28
