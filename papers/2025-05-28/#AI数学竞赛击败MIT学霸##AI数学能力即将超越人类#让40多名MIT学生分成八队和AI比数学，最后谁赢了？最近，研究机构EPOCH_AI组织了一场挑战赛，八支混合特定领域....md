...
EPOCH AI组织的数学竞赛中，AI模型o4-mini-medium在4.5小时内解答23道高难度数学题（含拓扑学、代数几何等），表现优于MIT学生团队的平均水平，但未超过人类联合得分（解题率约35%）。人类因时间限制可能被低估实力，实际解题率估计为30-50%。AI解题更快（5-20分钟/题），但人类通过长期学习潜力更大。研究推测，AI或将在年底前在数学推理上超越人类。竞赛表明AI数学能力已接近顶尖学生，但人类协作仍具优势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T16:03:14Z
- **目录日期**: 2025-05-28
