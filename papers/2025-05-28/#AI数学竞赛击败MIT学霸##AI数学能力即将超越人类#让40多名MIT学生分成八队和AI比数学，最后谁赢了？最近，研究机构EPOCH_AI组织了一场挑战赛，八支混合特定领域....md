...
EPOCH AI组织的数学竞赛中，AI模型o4-mini-medium在4.5小时内解23道数学题的表现优于MIT学生团队的平均水平，但不及人类联合得分（35%解题率）。比赛题目涵盖拓扑学、代数几何等高难度领域，人类因时间限制可能被低估实力——平均需40分钟/题，而AI仅需5-20分钟。研究者推测人类真实解题率约30-50%，并警告AI或将在年底前超越人类数学能力。该结果凸显AI在复杂数学推理上的快速进步，但人类长期学习潜力仍具优势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T12:03:07Z
- **目录日期**: 2025-05-28
