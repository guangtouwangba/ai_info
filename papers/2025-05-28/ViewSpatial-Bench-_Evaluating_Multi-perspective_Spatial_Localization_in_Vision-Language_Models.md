...
当前视觉语言模型（VLM）在自我中心视角的空间推理上表现优异，但在跨视角（如他者视角）的空间理解上存在显著不足。研究团队提出首个多视角空间定位基准测试ViewSpatial-Bench，包含5类任务，并通过自动化3D标注生成精确方向标签。测试发现：VLM在相机视角任务中表现尚可，但人类视角推理准确率明显下降。通过多视角空间数据微调，模型整体性能提升46.24%，证实建模3D空间关系能有效增强VLM的空间理解能力。该研究为具身AI系统的空间智能评估建立了重要基准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T16:01:12Z
- **目录日期**: 2025-05-28
