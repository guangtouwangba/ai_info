...
当前视觉语言模型（VLM）在自我中心视角的空间推理中表现优异，但在跨视角空间理解（如他者视角）上存在显著缺陷。研究团队提出首个多视角空间定位基准ViewSpatial-Bench，包含5类任务，并开发自动3D标注流程生成精准方向标签。测试发现VLM在相机视角任务表现尚可，但人类视角推理准确率明显下降。通过多视角空间数据微调，模型整体性能提升46.24%，证实建模3D空间关系能有效增强VLM的空间理解能力。该研究为具身AI系统的空间智能评估提供了关键基准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T18:01:16Z
- **目录日期**: 2025-05-28
