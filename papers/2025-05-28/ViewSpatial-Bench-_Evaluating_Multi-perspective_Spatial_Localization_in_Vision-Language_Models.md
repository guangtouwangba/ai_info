...
当前视觉语言模型（VLM）在自我中心视角（相机视角）的空间推理中表现优异，但在跨视角（如他人视角）的空间理解上存在显著不足。为此，研究团队提出了首个多视角空间定位基准测试ViewSpatial-Bench，包含5类任务，并开发了自动化3D标注流程生成精确方向标签。测试发现：VLM在相机视角任务中表现尚可，但在人类视角任务中准确率大幅下降。通过多视角数据集微调后，模型整体性能提升46.24%。研究表明，建模3D空间关系能有效增强VLM的空间理解能力，为具身AI系统的空间智能评估提供了重要基准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T22:01:04Z
- **目录日期**: 2025-05-28
