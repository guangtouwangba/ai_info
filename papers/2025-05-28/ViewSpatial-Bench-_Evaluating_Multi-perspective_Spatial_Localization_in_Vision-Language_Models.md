...
当前视觉语言模型（VLM）在自我中心视角的空间推理上表现优异，但在跨视角（如他人视角）的空间理解上存在明显不足。研究团队提出首个多视角空间定位基准测试ViewSpatial-Bench，包含5类任务，并开发了自动3D标注流程。测试发现，VLM在相机视角任务中表现尚可，但在人类视角推理时准确率显著下降。通过多视角空间数据微调，模型性能整体提升46.24%。该研究为具身AI的空间智能建立了关键基准，证明建模3D空间关系能有效增强VLM的空间理解能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T19:01:02Z
- **目录日期**: 2025-05-28
