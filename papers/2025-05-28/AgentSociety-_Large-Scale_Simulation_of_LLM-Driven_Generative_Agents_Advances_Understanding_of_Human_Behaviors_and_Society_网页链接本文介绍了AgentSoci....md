...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统，能够模拟1万多个AI代理及其500万次社会互动。研究者用它作为计算社会科学实验平台，研究了社会极化、信息传播、基本收入政策影响和自然灾害应对等四个关键社会问题。模拟结果与现实世界数据高度吻合，证明该系统能有效捕捉人类行为机制，展现了作为社会科学研究和政策制定工具的潜力。该研究为大语言模型在社会系统建模中的应用提供了重要范例。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T01:33:18Z
- **目录日期**: 2025-05-28
