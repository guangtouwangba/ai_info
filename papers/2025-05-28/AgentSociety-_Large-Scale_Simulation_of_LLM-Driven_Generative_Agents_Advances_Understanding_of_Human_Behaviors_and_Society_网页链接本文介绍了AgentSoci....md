...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万个AI代理及其500万次社会互动。研究者用它研究四大社会问题：社会极化、信息传播、基本收入政策效果和自然灾害影响。模拟结果与现实数据吻合，验证了该系统在揭示人类行为机制方面的有效性。该系统可作为传统社会科学研究方法的补充工具，帮助学者和政策制定者分析社会问题成因及潜在解决方案。研究表明，AI驱动的社会模拟有望成为计算社会科学研究的重要平台。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T16:05:20Z
- **目录日期**: 2025-05-28
