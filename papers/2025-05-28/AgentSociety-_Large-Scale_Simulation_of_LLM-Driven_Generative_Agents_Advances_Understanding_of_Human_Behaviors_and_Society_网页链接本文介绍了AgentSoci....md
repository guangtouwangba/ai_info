...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个智能代理的社会互动（500万次交互）。研究者用它研究了四个关键社会问题：社会极化、信息传播、基本收入政策效果和自然灾害影响。该系统模拟结果与现实世界数据吻合，验证了其捕捉人类行为机制的能力。这表明AgentSociety能作为计算社会科学的有力工具，辅助传统研究方法（如调查和实验），帮助研究者分析社会问题模式并支持政策制定。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T22:05:42Z
- **目录日期**: 2025-05-28
