...
该研究介绍了AgentSociety，一个基于大语言模型的大规模社会模拟器，可模拟1万多个代理及其500万次互动。研究者用它分析了四个社会问题：社会极化、信息传播、基本收入政策影响和自然灾害冲击。模拟结果与现实数据吻合，验证了该工具在揭示人类行为机制方面的有效性，展示了其作为社会科学研究和政策制定辅助工具的潜力。该系统能补充传统研究方法，帮助理解复杂社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T23:04:38Z
- **目录日期**: 2025-05-28
