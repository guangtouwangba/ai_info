...
这篇论文介绍了一个名为AgentSociety的大规模社会模拟器，它结合了大型语言模型驱动的智能代理、真实社会环境和大规模模拟引擎。研究者通过模拟1万多个代理及其500万次互动，研究了社会极化、信息传播、基本收入政策和自然灾害影响等关键社会问题。模拟结果与现实世界数据高度吻合，证明了该系统在理解人类行为和社会机制方面的有效性。AgentSociety展现了作为社会科学研究和政策制定工具的潜力，能够补充传统研究方法（如调查和访谈），为复杂社会问题提供新的研究途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T12:05:28Z
- **目录日期**: 2025-05-28
