...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理的社会互动（500万次交互）。研究者用它研究了四个关键社会问题：社会极化、信息传播、基本收入政策效果和自然灾害影响。该系统能有效捕捉人类行为模式，模拟结果与现实数据高度吻合，展现了作为社会科学研究工具和决策支持系统的潜力，可辅助传统研究方法（如调查和实验）分析社会问题的成因和机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T00:05:31Z
- **目录日期**: 2025-05-28
