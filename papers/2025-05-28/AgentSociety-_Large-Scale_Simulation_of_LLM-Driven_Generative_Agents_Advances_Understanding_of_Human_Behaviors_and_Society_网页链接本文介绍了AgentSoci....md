...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个智能体及其500万次社会互动。研究者利用该平台研究了四个关键社会问题：社会极化、信息传播、基本收入政策效果和自然灾害影响。模拟结果与现实世界数据高度吻合，验证了系统对人类行为和社会机制建模的有效性。该系统可作为计算社会科学研究平台，为传统研究方法提供补充，帮助研究者分析社会问题模式及潜在机制，具有重要的学术和政策应用价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T18:05:08Z
- **目录日期**: 2025-05-28
