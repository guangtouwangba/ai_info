...
这篇论文介绍了AgentSociety，一个利用大型语言模型驱动的大规模社会模拟器。该系统模拟了超过1万个代理及其500万次互动，用于研究社会问题如极化现象、信息传播、基本收入政策影响和自然灾害应对。研究结果与现实世界数据吻合，验证了该模拟器在捕捉人类行为机制方面的能力。AgentSociety可作为社会科学研究和政策制定的有力工具，补充传统研究方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T05:04:41Z
- **目录日期**: 2025-05-28
