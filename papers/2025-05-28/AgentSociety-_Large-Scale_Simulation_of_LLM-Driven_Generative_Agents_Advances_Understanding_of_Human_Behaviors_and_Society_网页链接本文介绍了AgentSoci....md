...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可以模拟1万多个AI代理的社会互动（500万次交互）。研究者用它研究了四个社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实数据吻合，表明该系统能有效捕捉人类行为机制。这展示了AgentSociety作为社会科学研究工具和辅助政策制定的潜力，可补充传统研究方法（如调查和实验）。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T08:05:40Z
- **目录日期**: 2025-05-28
