...
本研究提出了首个学术海报生成基准和评估体系（包括视觉质量、文本连贯性、综合评估及论文内容测试），并开发了PosterAgent多智能体流程：通过解析器提取论文结构，规划器设计平衡版式，绘制-评论循环优化视觉呈现。实验发现GPT-4o生成的海报虽美观但文本质量差，而开源模型Qwen-2.5系列在减少87%计算量的情况下全面优于现有系统，仅需0.005美元即可将22页论文转换为可编辑.pptx海报。研究揭示了视觉语义对读者参与度的关键作用，为自动化海报生成指明了方向。代码和数据集已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T20:01:30Z
- **目录日期**: 2025-05-28
