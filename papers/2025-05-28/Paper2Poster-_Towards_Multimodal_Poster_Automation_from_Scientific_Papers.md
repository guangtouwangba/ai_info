...
本文提出了首个学术海报生成基准测试和评估指标，并介绍了PosterAgent系统。该基准从视觉质量、文本连贯性、整体评估和内容传达能力四个方面评估生成效果。PosterAgent采用自上而下的多智能体流程：解析器提取论文结构，规划器设计布局，画家-评论员循环优化视觉呈现。测试发现，GPT-4o生成的海报虽美观但文本质量差；而基于Qwen-2.5的开源系统在减少87%计算量的情况下表现更优，仅需0.005美元即可将22页论文转化为可编辑.pptx海报。研究为自动化海报生成指明了方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T21:01:27Z
- **目录日期**: 2025-05-28
