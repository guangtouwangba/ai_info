...
本文提出了首个学术海报生成基准和评估指标，包括视觉质量、文本连贯性、整体评估和论文内容传达能力。研究者开发了PosterAgent系统，采用自上而下的多智能体流程：解析器提取论文结构化信息，规划器设计布局，绘制-评论循环优化面板。实验发现，GPT-4o生成的海报虽美观但文本质量差，而开源模型Qwen-2.5系列在多数指标上表现更优且成本更低（0.005美元/海报）。该系统能将22页论文转化为可编辑.pptx海报，为自动化海报生成指明了方向。代码和数据集已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T02:31:11Z
- **目录日期**: 2025-05-28
