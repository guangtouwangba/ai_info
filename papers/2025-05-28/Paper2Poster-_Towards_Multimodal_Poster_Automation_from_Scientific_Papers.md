...
本文提出了首个学术海报生成基准和评估指标（视觉质量、文本连贯性、整体评估和论文问答能力），并开发了PosterAgent多智能体流程。该系统通过解析器、规划器和绘画-评论循环，将论文转化为结构化海报布局。实验发现，GPT-4o生成的海报虽美观但文本质量差，而开源模型Qwen-2.5系列在多数指标上表现更优且成本降低87%（单张海报仅0.005美元）。研究揭示了视觉语义对读者参与度的关键作用，为全自动海报生成模型发展指明了方向。代码和数据集已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T15:02:26Z
- **目录日期**: 2025-05-28
