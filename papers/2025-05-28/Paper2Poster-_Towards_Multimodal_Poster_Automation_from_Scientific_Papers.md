...
本研究提出了首个学术海报生成基准测试和评估体系，包含视觉质量、文本连贯性、整体评估和论文内容测试(PaperQuiz)四个维度。基于此，团队开发了PosterAgent系统，采用自上而下的多智能体流程：解析器提取论文结构，规划器设计布局，画师-评论员循环优化视觉呈现。测试发现，GPT-4生成的海报虽美观但文本质量差且内容传达不佳，而开源模型Qwen-2.5系列在减少87%token使用量的情况下表现更优，仅需0.005美元即可将22页论文转换为可编辑.pptx海报。研究为自动化海报生成指明了方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T17:01:41Z
- **目录日期**: 2025-05-28
