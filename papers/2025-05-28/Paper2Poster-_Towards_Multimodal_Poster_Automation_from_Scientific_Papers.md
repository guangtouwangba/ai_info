...
本文提出了首个学术海报生成基准和评估体系（包括视觉质量、文本连贯性、整体评估和论文内容测试），并开发了PosterAgent多智能体流程。该系统通过解析论文、规划图文布局和循环优化，将22页论文转化为可编辑.pptx海报，成本仅0.005美元。实验表明，开源模型（如Qwen-2.5）在多数指标上优于GPT-4o方案，且节省87%计算量。研究发现人类设计海报更依赖视觉语义传达信息，而现有AI生成内容存在文本噪声和内容传达不足的问题。相关代码和数据集已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T16:01:37Z
- **目录日期**: 2025-05-28
