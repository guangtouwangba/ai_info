...
该研究提出了首个学术海报生成基准和评估体系（包括视觉质量、文本连贯性、综合评估及论文内容传达能力），并开发了PosterAgent多智能体流程：通过解析器提取论文结构化信息，规划器设计布局，画师-评论员循环优化视觉呈现。实验发现GPT-4o生成的海报虽视觉吸引但文本质量差，而开源模型Qwen-2.5系列在多数指标上表现更优且成本降低87%（单次生成仅0.005美元）。该系统可将22页论文转化为可编辑.pptx海报，为自动化海报生成提供了新方向。代码和数据集已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T10:01:25Z
- **目录日期**: 2025-05-28
