...
这篇论文提出了首个学术海报生成基准和评估指标，并介绍了PosterAgent系统。该研究构建了一个包含论文-海报配对的数据集，从视觉质量、文本连贯性、整体评估和内容传达能力四个维度评估生成效果。PosterAgent采用自上而下的多智能体流程：解析论文、规划布局、循环优化设计。实验发现，GPT-4o生成的海报虽美观但文本质量差，而开源模型Qwen-2.5系列在多数指标上表现更好且成本更低（仅0.005美元/海报）。研究为自动化海报生成模型发展指明了方向，相关代码和数据集已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T06:01:29Z
- **目录日期**: 2025-05-28
