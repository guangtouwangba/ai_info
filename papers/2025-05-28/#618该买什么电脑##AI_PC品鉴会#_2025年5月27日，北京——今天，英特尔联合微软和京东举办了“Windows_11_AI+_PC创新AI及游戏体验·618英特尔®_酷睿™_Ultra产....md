...
英特尔联合微软、京东举办"Windows 11 AI+ PC品鉴会"，宣布PC全面进入AI时代。现场展示10家厂商基于第二代酷睿Ultra处理器的AI PC，覆盖工作、创作、游戏等场景。新款处理器性能显著提升：Ultra 200V系列AI算力达120 TOPS，200H系列单核性能提升17%，GPU游戏性能提升22%。微软强调Windows 11 AI+ PC具备五大特性：更强安全性、AI算力、应用生态、能效续航及流畅游戏体验。活动标志着传统PC向高效智能方向转型，618期间这些AI PC将成为消费热点。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T02:33:37Z
- **目录日期**: 2025-05-28
