...
英特尔联合微软、京东举办AI PC品鉴会，宣布Windows 10全面转向Windows 11 AI+PC时代。现场展示10家厂商基于第二代酷睿Ultra处理器的AI PC，覆盖工作、创作、游戏等场景。新一代处理器性能显著提升：Ultra 200V系列AI算力达120 TOPS，200H系列单线程/多线程性能分别提升17%/20%，能效比提高21%。产品具备强AI算力、长续航、游戏优化等特性，支持本地AI模型部署。微软强调Windows 11 AI+PC在生产力、安全性和能效方面的优势。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T00:03:14Z
- **目录日期**: 2025-05-28
