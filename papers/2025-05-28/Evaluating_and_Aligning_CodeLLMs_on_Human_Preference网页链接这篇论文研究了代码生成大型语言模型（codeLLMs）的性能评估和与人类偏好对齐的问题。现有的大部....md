...
这篇论文针对代码生成大模型(codeLLMs)提出了CodeArena基准测试，聚焦模型输出与人类偏好的对齐问题。研究者收集了397个涵盖40类任务和44种编程语言的真实样本，并构建了20B标记的合成指令数据集SynCode-Instruct。实验发现：1)传统执行正确性基准与人类偏好存在差异；2)开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究强调了在代码生成任务中，除功能性外还需重视人类可读性、实用性等偏好因素。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T18:05:45Z
- **目录日期**: 2025-05-28
