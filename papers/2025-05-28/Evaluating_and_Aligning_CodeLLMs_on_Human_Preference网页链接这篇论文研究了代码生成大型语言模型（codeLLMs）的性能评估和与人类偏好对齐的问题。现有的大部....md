...
这篇论文探讨了代码生成大模型（CodeLLMs）与人类偏好对齐的问题。研究发现现有基准测试过于关注代码正确性，忽视了人类偏好匹配。为此，作者构建了CodeArena基准（397个样本，40类，44种语言）和SynCode-Instruct语料库（20B标记）来评估模型。实验显示执行基准与CodeArena存在性能差异，开源模型（如Qwen2.5-Coder）与专有模型（如OpenAI o1）差距显著，凸显了人类偏好对齐的重要性。研究为提升代码生成模型的实际应用价值提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T13:15:59Z
- **目录日期**: 2025-05-28
