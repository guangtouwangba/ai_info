...
这篇论文针对代码生成大模型(codeLLMs)提出创新评估方法，指出当前基准测试过度关注代码正确性而忽视人类偏好。研究者构建了CodeArena基准(包含397个高质量样本，覆盖40类编程任务和44种语言)和SynCode-Instruct合成指令库(近200亿标记)。实验发现执行基准与人类偏好评估存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究强调了代码生成模型与人类偏好对齐的重要性，为改进代码LLMs提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T02:35:57Z
- **目录日期**: 2025-05-28
