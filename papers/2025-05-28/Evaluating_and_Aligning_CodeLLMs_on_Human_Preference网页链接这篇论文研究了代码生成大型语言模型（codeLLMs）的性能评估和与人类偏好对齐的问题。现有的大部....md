...
这篇论文针对代码生成大模型(codeLLMs)提出新评估框架CodeArena，通过397个涵盖40类编程任务和44种语言的真实样本，首次系统评估模型输出与人类偏好的匹配度。研究发现传统基于执行的评估与人类偏好存在显著差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI)在人性化输出方面差距明显。研究同时构建了200亿标记的合成指令数据集SynCode-Instruct，验证了大规模指令微调的有效性，强调了代码生成模型除功能性外还需关注人机交互体验的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T15:07:38Z
- **目录日期**: 2025-05-28
