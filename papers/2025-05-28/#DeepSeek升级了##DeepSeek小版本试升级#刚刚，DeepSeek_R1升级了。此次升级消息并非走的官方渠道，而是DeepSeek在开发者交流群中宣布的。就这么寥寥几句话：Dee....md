...
DeepSeek R1模型已完成小版本升级，官方在开发者交流群中宣布了这一消息，建议用户通过网页、APP或小程序测试新版本，并开启"深度思考"功能。虽然官方称为"小版本试升级"，但用户反馈显示性能提升显著，部分测试者认为其表现已接近Claude 4水平。升级后的API接口和使用方式保持不变，官方鼓励用户自行测试代码生成等功能并在评论区分享结果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T16:02:47Z
- **目录日期**: 2025-05-28
