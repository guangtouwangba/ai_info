...
DeepSeek R1模型已完成小版本升级，官方建议用户通过网页、APP或小程序测试新版本，API接口保持不变。虽然官方称为"小升级"，但用户实测反馈性能提升显著，部分用户认为其表现已接近Claude 4水平。升级消息通过开发者交流群发布，鼓励用户测试代码编写、网页制作等功能并在评论区分享结果。官方特别提示使用时要"打开深度思考"功能。目前尚未公布具体升级细节，用户需自行体验验证实际改进效果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T15:03:50Z
- **目录日期**: 2025-05-28
