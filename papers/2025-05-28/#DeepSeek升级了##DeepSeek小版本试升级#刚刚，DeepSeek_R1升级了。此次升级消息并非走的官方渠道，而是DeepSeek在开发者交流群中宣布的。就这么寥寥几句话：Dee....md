...
DeepSeek R1模型已完成小版本升级，官方在开发者交流群中宣布了这一消息。升级后的模型性能显著提升，用户可通过官网、APP或小程序体验，API接口保持不变。部分用户测试后反馈性能大幅改进，甚至认为可与Claude 4媲美，但具体效果需自行验证。官方建议使用时开启"深度思考"功能。目前升级细节尚未正式公布，用户可尝试编写代码或网页测试新版本性能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T17:02:48Z
- **目录日期**: 2025-05-28
