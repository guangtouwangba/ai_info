# #DeepSeek升级了##DeepSeek小版本试升级#刚刚，DeepSeek R1升级了。此次升级消息并非走的官方渠道，而是DeepSeek在开发者交流群中宣布的。就这么寥寥几句话：Dee...
...
DeepSeek R1 模型近期进行了小版本升级，官方在开发者交流群中低调宣布了这一消息。升级后的模型性能显著提升，用户可通过官方网页、APP或小程序体验，API接口保持不变。部分测试者反馈其表现已接近Claude 4水平，尤其在代码生成和网页制作等任务上进步明显。官方建议使用"深度思考"功能以获得更好效果，但具体案例尚未经第三方验证，鼓励用户自行测试并分享结果。此次升级虽未大范围宣传，但实际改进效果引发开发者社区关注。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T23:02:31Z
- **目录日期**: 2025-05-28
