...
DeepSeek R1模型近日完成小版本升级，官方在开发者交流群中低调宣布。升级后模型性能显著提升，用户可通过官网、APP或小程序体验，API接口保持不变。部分测试者反馈新版本表现优异，甚至可与Claude 4媲美，建议用户自行测试代码生成或网页制作等功能验证效果。官方特别提醒使用时要开启"深度思考"模式。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T18:02:40Z
- **目录日期**: 2025-05-28
