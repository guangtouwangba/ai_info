...
DeepSeek R1模型已完成小版本升级，官方通过开发者交流群低调宣布。升级后模型性能显著提升，用户可通过官网、APP或小程序体验（需开启"深度思考"功能），API接口保持不变。部分用户测试反馈显示性能提升明显，甚至可与Claude 4相媲美，但具体案例真实性尚待验证。官方鼓励用户自行测试代码生成、网页制作等功能，并将结果分享至评论区供参考。此次升级虽称"小版本"，但实际改进幅度似乎超出预期。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T22:03:21Z
- **目录日期**: 2025-05-28
