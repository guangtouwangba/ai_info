...
多癌种早期检测（MCED）技术通过单次血液样本检测多种癌症并定位组织来源，有望改善临床决策和健康结果。然而，由于使用模糊的总体性能指标掩盖了不同癌症类型的检测差异，该技术尚未获得监管批准和广泛应用。本研究提出癌症特异性评估方法，包括类型特异性准确率、组织定位预测值和分类分布估计，并给出置信区间公式。通过模拟研究和实际数据验证，该方法能更精准评估MCED检测效果，支持优化临床试验设计（包括传统、数字、AI驱动和混合筛查平台），为医疗决策者提供科学依据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T11:02:03Z
- **目录日期**: 2025-05-28
