...
多癌早期检测（MCED）技术通过单次血液样本检测多种癌症并定位组织来源，有望改善临床决策和健康结果。然而，由于传统评估使用模糊的综合性能指标，掩盖了癌症类型间的生物学差异和检测行为差异，导致其尚未获得监管批准和广泛应用。本研究提出癌症特异性评估方法，包括类型特异性准确率、组织定位预测值和分类分布估计，并给出置信区间公式。通过模拟实验验证方法有效性，并应用于真实数据集。该框架支持精准临床决策，优化传统/数字/AI分层筛查试验设计，促进多方知情决策。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T12:02:03Z
- **目录日期**: 2025-05-28
