...
多癌早期检测(MCED)技术通过单次血液检测识别多种癌症类型并定位组织来源，有望改善临床决策和健康结果。然而，由于使用模糊的总体性能指标掩盖了癌症类型间的生物学差异，该技术尚未获得监管批准和广泛应用。本研究提出统计方法，可估计癌症特异性检测准确性、组织定位预测值和分类分布，并提供置信区间。通过模拟研究和实际数据应用验证方法有效性。这些方法能精确评估MCED检测性能，支持优化临床试验设计，为临床医生、政策制定者和患者提供更可靠的决策依据，促进该技术在分层诊断平台中的应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T13:11:57Z
- **目录日期**: 2025-05-28
