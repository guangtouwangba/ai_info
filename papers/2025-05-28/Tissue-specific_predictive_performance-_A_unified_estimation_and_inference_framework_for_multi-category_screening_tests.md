...
多癌早期检测(MCED)技术可通过单次血液样本检测多种癌症类型并定位组织来源，但尚未获得监管批准和广泛应用。主要障碍在于传统评估指标过于笼统，掩盖了不同癌症类型的检测性能差异。本研究提出癌症特异性精准度评估方法，包括：癌症特异性内在准确度、组织定位预测值和边际分类分布，并推导相应置信区间公式。通过模拟研究和实际数据应用验证方法有效性。该统计框架支持更精确的临床决策，优化传统/数字/AI驱动的分层诊断试验设计，为医疗决策者提供更可靠的评估依据，推动MCED在癌症早筛中的应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T21:01:56Z
- **目录日期**: 2025-05-28
