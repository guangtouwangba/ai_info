...
多癌早期检测（MCED）技术通过单次血液样本检测多种癌症类型并定位组织来源，有望改善临床决策和健康结果。然而，由于使用模糊的临床指标，当前测试性能评估存在不确定性，导致其尚未获得监管批准或广泛应用。传统方法采用总体性能指标，忽略了癌症类型间的生物学差异，掩盖了真实效果。本文提出癌症特异性准确性评估方法，包括类型特异性内在准确性、组织定位预测值和边际分类分布，并提供置信区间计算。通过模拟研究和实际数据应用验证，该方法支持更精准的临床决策和优化试验设计，促进MCED在早期癌症检测中的应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-28T18:02:02Z
- **目录日期**: 2025-05-28
