...
本文提出了一种完整的心理时序逻辑BPICTL，通过引入心理模态扩展了CTL逻辑。研究给出了BPICTL的可靠且完备的推理系统，证明了其有限模型性质，并提出了一种BPICTL的模型检测算法。该工作将传统时序逻辑与心理模态相结合，为形式化验证具有心理状态的系统提供了理论基础和实用工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T03:14:43Z
- **目录日期**: 2025-04-09
