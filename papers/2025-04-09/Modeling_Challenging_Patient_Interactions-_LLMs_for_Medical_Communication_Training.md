...
本研究利用大语言模型(LLMs)开发了基于Satir模型的"指责型"和"合理化型"虚拟患者(VPs)，以提升医患沟通培训。通过高级提示工程(行为提示、作者注释和固执机制)，VPs能准确呈现不同沟通风格的情感特征。医疗专业人员评估显示，两种VPs的真实性评分良好(指责型3.8±1.0；合理化型3.7±0.8，5分制)，情感分析也证实了预设特征：指责型表现痛苦、愤怒，合理化型则更冷静。情感评分(0-9分)显示指责型更负面(3.1±0.6)，合理化型更中性(4.0±0.4)。该AI驱动方案为医学教育提供了可扩展、经济高效的沟通技能培训工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T17:01:55Z
- **目录日期**: 2025-04-09
