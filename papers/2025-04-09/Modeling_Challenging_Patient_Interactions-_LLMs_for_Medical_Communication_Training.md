...
本研究利用大语言模型（LLM）模拟基于Satir模型的"指责型"和"合理化型"患者角色，通过高级提示工程开发虚拟患者（VP）。医疗专业人员评估显示，两种角色真实性评分分别为3.8±1.0和3.7±0.8（5分量表），并能正确识别其风格。情感分析表明指责型表现出痛苦、愤怒，合理化型则更冷静；情感评分分别为3.1±0.6（负面）和4.0±0.4（中性）。该研究证实LLM能复现复杂沟通模式，为医学教育提供可扩展、经济高效的培训方案，帮助培养同理心和诊断能力，具有变革医疗培训的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T04:02:00Z
- **目录日期**: 2025-04-09
