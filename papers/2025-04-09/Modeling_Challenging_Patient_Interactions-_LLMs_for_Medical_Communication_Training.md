...
本研究利用大语言模型(LLMs)开发了两种基于Satir模型的虚拟患者(VPs)："指责型"和"合理化型"。通过高级提示工程(包括行为提示、作者注释和固执机制)，这些VP能展现细腻的情感和对话特征。医疗专业人员评估显示，两种VP的真实性评分较高(指责型3.8±1.0，合理化型3.7±0.8，5分制)，并能准确识别其风格。情感分析表明指责型表现出痛苦、愤怒(负面情绪3.1±0.6)，而合理化型则更冷静(中性情绪4.0±0.4)。研究证实LLMs能有效模拟复杂医患沟通，为医学教育提供可扩展、经济高效的培训方案，帮助培养同理心和诊断能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T10:02:31Z
- **目录日期**: 2025-04-09
