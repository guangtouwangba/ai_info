...
本研究利用大语言模型（LLMs）模拟基于Satir模型的"指责型"和"合理化型"患者角色，开发了具有多语言适应性的虚拟患者（VPs）。通过高级提示工程（行为提示、作者注释和固执机制），VPs成功呈现了预设的复杂情感特征。医学专业人员评估显示，两类VPs的真实性评分良好（指责型3.8±1.0；合理化型3.7±0.8，5分制），情感分析也验证了其差异性：指责型表现出痛苦/愤怒（情感得分3.1±0.6），而合理化型则呈现沉思/平静（4.0±0.4）。该AI驱动方案为医学教育提供了可扩展、经济高效的沟通训练工具，能有效提升医护人员的共情能力和临床应对技巧。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T13:09:31Z
- **目录日期**: 2025-04-09
