...
本研究利用大语言模型(LLMs)开发了两种基于Satir模型的虚拟患者角色("指责型"和"理性型")，通过高级提示工程模拟真实医患互动。医疗专业人员评估显示，两种角色在5分制真实性评分中分别获得3.8±1.0和3.7±0.8分，并能准确识别其风格特征。情感分析表明，指责型患者表现出痛苦、愤怒(情感得分3.1±0.6)，而理性型则呈现思考、平静状态(得分4.0±0.4)。该研究证实LLMs能有效模拟复杂沟通模式，为医学教育提供可扩展、经济高效的培训方案，帮助医学生提升共情能力和诊断技巧，应对临床挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T11:01:54Z
- **目录日期**: 2025-04-09
