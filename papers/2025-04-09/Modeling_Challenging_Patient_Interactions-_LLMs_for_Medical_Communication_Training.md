...
本研究利用大语言模型（LLM）模拟基于Satir模型的"指责型"和"合理化型"患者角色，通过高级提示工程（行为提示、作者注释和固执机制）开发虚拟患者（VP）。医疗专业人员评估显示，两种VP在5分量表上均获较高真实性评分（指责型3.8±1.0，合理化型3.7±0.8），并能准确识别其风格。情感分析表明指责型表现痛苦、愤怒（情感得分3.1±0.6），合理化型则呈现沉思、冷静（4.0±0.4），符合预设病史特征。该AI驱动方法为医学教育提供了可扩展、经济高效的沟通训练方案，能提升医护人员的共情能力和诊断敏锐度，具有变革医疗培训的潜力。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T18:01:56Z
- **目录日期**: 2025-04-09
