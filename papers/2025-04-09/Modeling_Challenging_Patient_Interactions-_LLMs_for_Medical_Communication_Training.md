...
本研究利用大型语言模型（LLMs）模拟基于Satir模型的"指责型"和"理性化型"患者角色，通过高级提示工程（行为提示、作者注释和固执机制）开发虚拟患者（VPs）。医疗专业人员评估显示，两种VP在5分量表上均获较高真实性评分（指责型3.8±1.0，理性化型3.7±0.8），并能准确识别其风格。情绪分析表明指责型表现出痛苦、愤怒（情感得分3.1±0.6），理性化型则呈现沉思、冷静（4.0±0.4），与预设病史细节一致。研究证实LLMs能复现复杂医患沟通模式，为医学教育提供可扩展、低成本的高仿真培训工具，有助于提升医护人员的共情能力和临床应对技巧。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T21:01:46Z
- **目录日期**: 2025-04-09
