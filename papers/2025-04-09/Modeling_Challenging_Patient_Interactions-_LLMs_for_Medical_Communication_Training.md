...
本研究利用大语言模型（LLM）模拟基于Satir模型的"指责型"和"合理化型"患者角色，通过高级提示工程开发具有细腻情感特征的虚拟患者。医疗专业人员评估显示，两种角色真实性评分良好（指责型3.8±1.0，合理化型3.7±0.8，5分制），情感分析证实其差异：指责型表现痛苦愤怒（情感得分3.1±0.6），合理化型呈现冷静思考（4.0±0.4）。研究表明LLM能有效复现复杂医患沟通模式，为医学教育提供可扩展、经济高效的培训方案，帮助培养医护人员的同理心和诊断能力，具有变革医疗培训的潜力。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T23:01:48Z
- **目录日期**: 2025-04-09
