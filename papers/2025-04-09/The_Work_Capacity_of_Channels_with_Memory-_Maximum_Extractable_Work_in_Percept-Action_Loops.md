...
预测未来观测在机器学习、生物学和经济学等领域至关重要，并与变分自由能原理等组织原则相关。然而，能够与环境交互的复杂自适应系统不仅是预测机器，还能主动改变环境。本研究分析了感知-动作循环中信息处理的热力学，提出“做功能力”概念，即代理从环境中提取功的最大速率。结果表明，在动作可影响环境的情况下，传统高效做功设计原则（如最大化预测能力或遗忘过去动作）不再最优。相反，代理需平衡预测与遗忘，因为记忆过去动作可能减少可用自由能，揭示了主动学习系统中预测与能量效率的潜在冲突。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T16:01:25Z
- **目录日期**: 2025-04-09
