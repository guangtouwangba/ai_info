...
预测未来观测在机器学习、生物学和经济学等领域至关重要，并与变分自由能原理等组织原则相关。然而，交互式自适应系统不仅是预测机器，还能通过行动改变环境。本研究分析了感知-行动循环中信息处理的热力学，提出"工作容量"概念——代理从环境中提取功的最大速率。结果表明，在行动可影响环境的情况下，传统高效代理设计原则（最大化预测能力和遗忘过去行动）不再最优。高效代理需平衡预测与遗忘，因为记忆过去行动可能减少可用自由能，揭示了主动学习系统中预测与能效之间的潜在冲突。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T18:01:27Z
- **目录日期**: 2025-04-09
