...
这篇论文探讨了主动学习系统中预测行为与能量效率的热力学关系。研究发现，在与环境互动的感知-行动循环中，传统的工作效率优化原则（最大化预测能力和遗忘过去行为）在行动会产生可观测后果的环境中不再最优。相反，高效能系统需要在预测和遗忘之间取得平衡，因为记忆过去的行动可能减少可用自由能。这表明主动学习系统的热力学特性与被动观察系统存在根本差异，预测能力与能量效率可能相互制约。研究提出了"工作容量"概念来衡量系统从环境中提取功的最大速率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T17:01:20Z
- **目录日期**: 2025-04-09
