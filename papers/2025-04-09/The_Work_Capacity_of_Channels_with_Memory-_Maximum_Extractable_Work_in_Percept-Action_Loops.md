...
预测未来观测在机器学习、生物学和经济学等领域至关重要，并与变分自由能原理等组织原则相关。然而，主动与环境交互的复杂系统不仅是预测机器，还能通过行动改变环境。本研究分析了感知-动作循环中信息处理的热力学，引入“工作容量”概念，衡量代理从环境中提取功的最大速率。结果表明，在动作影响环境的情况下，单纯最大化预测或遗忘过往动作均非最优策略。高效代理需平衡预测与遗忘，因为记忆动作可能减少自由能。这揭示了主动学习系统中预测与能效之间的潜在冲突。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T11:01:22Z
- **目录日期**: 2025-04-09
