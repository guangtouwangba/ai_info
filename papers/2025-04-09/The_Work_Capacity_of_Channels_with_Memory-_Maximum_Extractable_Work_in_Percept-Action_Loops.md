...
这篇论文探讨了主动学习系统中信息处理的热力学问题。研究发现，在与环境交互的感知-行动循环中，传统的两个高效工作代理设计原则（最大化预测能力和遗忘过去行动）在行动会产生可观察后果的环境中不再最优。相反，高效工作代理需要在预测和遗忘之间取得平衡，因为记住过去行动可能减少可用自由能。这揭示了主动学习系统与被动观察热力学的根本区别，表明在主动系统中预测能力与能量效率可能存在矛盾。研究提出了"工作容量"概念来衡量代理从环境中提取功的最大速率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T14:01:31Z
- **目录日期**: 2025-04-09
