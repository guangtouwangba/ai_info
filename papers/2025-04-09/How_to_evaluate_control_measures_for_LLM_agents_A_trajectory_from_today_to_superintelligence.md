...
随着AI代理能力增强，自主造成危害的风险上升，开发者需通过"控制评估"测试防御措施的有效性。本文提出系统性框架，根据AI能力水平动态调整红队的测试权限，使评估更精准匹配实际风险。作者虚构了5个能力递增的AI模型（M1-M5），对应5级控制标准（ACL），每级配备相应的评估规则和安全措施。研究指出，针对超级智能LLM的安全论证需要突破性研究，最终可能需要替代方案来解决对齐问题。该框架旨在提供实用且经济高效的风险评估方法，避免过度依赖人类已知攻击策略的假设。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T02:28:30Z
- **目录日期**: 2025-04-09
