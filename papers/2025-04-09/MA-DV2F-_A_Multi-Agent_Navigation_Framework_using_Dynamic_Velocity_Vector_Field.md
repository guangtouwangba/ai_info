...
本文提出MA-DV2F框架，一种用于多车辆群体控制的动态速度矢量场方法。该框架为每辆车独立生成动态更新的速度矢量场，提供导航网格中各点的参考方向和速度，确保车辆安全抵达目标。通过实时根据车辆间距离和速度调整矢量场，有效预防碰撞。实验表明，MA-DV2F在安全性、计算效率和目标到达准确性方面优于现有方法，尤其适用于大规模车辆群控。项目页面详见：https://yininghase.github.io/MA-DV2F/。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T03:15:02Z
- **目录日期**: 2025-04-09
