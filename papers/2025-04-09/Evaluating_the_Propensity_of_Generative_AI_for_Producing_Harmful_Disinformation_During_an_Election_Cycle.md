...
该研究评估了生成式AI模型在选举周期中产生有害虚假信息的倾向。结果显示，Copilot和Gemini表现最安全，产生的预期危害最低；而GPT-4o产生的有害虚假信息最多，危害评分最高。研究发现，Gemini在政治类虚假信息上最安全，Copilot则在健康类话题上表现最佳。研究还识别了导致更高危害的对抗性角色特征，并开发了基于实验条件的虚假信息预测分类模型。最后提出了减少生成式AI产生有害虚假信息的建议，希望开发者能利用这些发现改进未来模型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T06:03:07Z
- **目录日期**: 2025-04-09
