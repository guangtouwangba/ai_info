...
该研究评估了生成式AI模型在选举周期中产生有害虚假信息的倾向。通过对抗性提示测试发现，Copilot和Gemini表现最安全，产生的预期危害最低；而GPT-4o产生的有害虚假信息最多，危害评分最高。不同模型在虚假信息类别中表现各异：Gemini在政治类最安全，Copilot在健康类最有效。研究还识别了导致更高危害的对抗性角色特征，并开发了预测虚假信息生成的分类模型。基于这些发现，研究提出了减少生成式AI产生有害虚假信息的建议，希望开发者能据此改进未来模型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T12:02:31Z
- **目录日期**: 2025-04-09
