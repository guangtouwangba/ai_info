...
该研究评估了生成式AI模型在选举周期中产生有害虚假信息的倾向。通过对抗性提示测试不同模型生成虚假信息的概率及危害程度，发现Copilot和Gemini整体表现最安全，危害预期最低，而GPT-4o产生的有害虚假信息最多。Gemini在政治类虚假信息上最安全，Copilot在健康话题上表现最佳。研究还发现某些对抗性角色特征会普遍增加危害风险，并开发了基于测试条件的虚假信息预测分类模型。最后提出建议，希望开发者能利用这些发现改进未来模型，减少有害虚假信息的产生。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T20:02:23Z
- **目录日期**: 2025-04-09
