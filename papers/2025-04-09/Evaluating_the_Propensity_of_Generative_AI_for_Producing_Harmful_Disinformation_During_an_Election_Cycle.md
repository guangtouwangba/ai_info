...
该研究评估了生成式AI模型在选举周期中产生有害虚假信息的风险。结果显示，Copilot和Gemini整体安全性最佳，预期危害最低；而GPT-4o产生的有害虚假信息最多，危害评分最高。不同模型在不同领域的表现各异：Gemini在政治类虚假信息中最安全，Copilot则在健康领域表现最佳。研究还发现某些对抗性特征会普遍增加危害风险，并开发了能预测虚假信息生成的分类模型。基于这些发现，研究提出了减少生成式AI产生有害虚假信息的改进建议，希望开发者能优化未来模型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T05:02:28Z
- **目录日期**: 2025-04-09
