...
大型语言模型（LLMs）推动了自动短答案评分（ASAG）的发展，使其超越传统基于标准答案的评分方式，支持更复杂的评分场景（如量规评估）。然而，现有全自动方法在量规评估中仍难以达到人类水平。本研究提出GradeHITL框架，通过人机协同（HITL）机制，利用LLMs的生成能力向专家提问，动态优化评分量规。实验表明，这种交互式方法显著提升了评分准确性，优于现有技术，使ASAG更接近人类评估水平。核心创新在于将专家反馈融入迭代优化过程，解决了全自动评分的局限性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T00:02:26Z
- **目录日期**: 2025-04-09
