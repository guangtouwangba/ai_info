...
中科大与华为合作开发了新型AI框架CMO，结合图神经网络(GNN)和蒙特卡洛树搜索(MCTS)，优化芯片逻辑设计。该框架通过"教师-学生"模式，GNN学习有效逻辑转换后指导MCTS，生成轻量级评分函数。核心创新GESD方案采用符号学习方法，结合结构-语义特征分离、知识蒸馏等技术，显著提升效率。实验显示，在多个电路数据集上优化时间减少60%，电路深度降低30%。该技术已集成至华为EMU工具，支持国产EDA发展，无需GPU即可实现2.5倍效率提升。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T16:03:47Z
- **目录日期**: 2025-04-09
