...
中科大与华为合作开发了新型AI框架CMO，用于优化芯片设计中的逻辑优化环节。该框架结合图神经网络(GNN)和蒙特卡洛树搜索(MCTS)，通过GESD方案实现精准"剪枝"，减少冗余操作。采用教师-学生模式，将GNN学到的知识转化为轻量级打分函数。实验显示，在多个数据集上CMO使优化效率最高提升2.5倍，如Sixteen电路优化时间缩短60%，Hyp电路深度减少30%。该技术已集成至华为EMU工具，支持国产EDA发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T12:03:41Z
- **目录日期**: 2025-04-09
