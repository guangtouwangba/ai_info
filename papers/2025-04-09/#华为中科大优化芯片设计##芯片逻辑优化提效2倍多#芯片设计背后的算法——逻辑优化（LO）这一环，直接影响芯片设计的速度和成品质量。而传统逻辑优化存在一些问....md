...
中科大与华为合作开发了新型AI框架CMO，结合图神经网络(GNN)和蒙特卡洛树搜索(MCTS)，显著优化芯片逻辑设计流程。该技术通过"教师-学生"知识蒸馏模式，生成轻量级可解释的评分函数，在EPFL/IWLS数据集测试中使优化效率最高提升2.5倍，电路深度减少30%。核心创新GESD方案采用结构-语义特征分离等策略，仅需CPU即可运行，已集成至华为EMU工具，推动EDA国产化。实验显示Sixteen电路优化时间缩短近60%，Hyp电路层数从8259降至5762层。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T11:03:20Z
- **目录日期**: 2025-04-09
