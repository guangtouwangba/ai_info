...
中科大与华为合作开发了新型AI框架CMO，用于优化芯片设计中的逻辑优化(LO)环节。该框架结合图神经网络(GNN)和蒙特卡洛树搜索(MCTS)，通过GESD方案实现精准"剪枝"，减少冗余操作。关键技术包括结构-语义特征分离、知识蒸馏和焦点损失函数等。实验显示，在多个电路数据集上，CMO使优化效率最高提升2.5倍，如Sixteen电路优化时间从78784秒降至32001秒。该技术已集成至华为EMU工具，支持EDA国产化。论文和代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T20:03:49Z
- **目录日期**: 2025-04-09
