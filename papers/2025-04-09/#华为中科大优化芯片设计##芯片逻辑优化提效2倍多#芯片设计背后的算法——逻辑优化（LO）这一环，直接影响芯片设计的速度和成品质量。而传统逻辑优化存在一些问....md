...
中科大与华为联合研发的CMO框架创新性地结合图神经网络(GNN)和蒙特卡洛树搜索(MCTS)，通过GESD方案实现芯片逻辑优化效率提升。该技术采用"教师-学生"知识蒸馏模式，分离结构/语义特征，优化奖励机制，应用焦点损失函数，在三大测试集上验证显著效果：Sixteen电路优化时间缩短60%，Hyp电路深度减少30%。该方案已集成至华为EMU工具，支持国产EDA发展，无需GPU依赖，在CPU环境下即可实现最高2.5倍的效率提升。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T13:11:56Z
- **目录日期**: 2025-04-09
