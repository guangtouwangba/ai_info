...
中科大王杰教授团队与华为诺亚方舟实验室合作开发了新型AI框架CMO，用于优化芯片设计中的逻辑优化环节。CMO结合图神经网络（GNN）和蒙特卡洛树搜索（MCTS），通过"教师-学生"模式，显著减少无效操作，提升效率最高达2.5倍。该技术采用GESD方案，优化搜索流程，并在EPFL、IWLS等数据集上验证有效，如Sixteen电路优化时间缩短60%。目前CMO已集成至华为EMU工具，支持EDA国产化。论文及代码已公开。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T22:03:17Z
- **目录日期**: 2025-04-09
