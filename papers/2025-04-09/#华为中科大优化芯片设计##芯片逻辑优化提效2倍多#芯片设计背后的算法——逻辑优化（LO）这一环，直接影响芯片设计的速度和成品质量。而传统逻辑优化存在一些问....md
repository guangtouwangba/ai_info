...
中科大与华为合作开发了新型AI框架CMO，通过结合图神经网络(GNN)和蒙特卡洛树搜索(MCTS)，优化芯片设计中的逻辑优化环节。该技术采用"教师-学生"模式，利用GESD方案生成高效的打分函数，显著减少无效操作。实验显示，CMO将优化效率最高提升2.5倍，如Sixteen电路优化时间从78784秒缩短至32001秒，Hyp电路深度从8259层降至5762层。该技术已集成到华为EMU工具中，支持国产EDA发展，且仅需CPU环境运行，摆脱GPU依赖。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T19:03:21Z
- **目录日期**: 2025-04-09
