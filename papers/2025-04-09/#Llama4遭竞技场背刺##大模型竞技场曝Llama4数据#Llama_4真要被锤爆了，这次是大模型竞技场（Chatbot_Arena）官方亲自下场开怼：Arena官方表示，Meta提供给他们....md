...
大模型竞技场(Chatbot Arena)指控Meta提供的Llama-4是经过人类偏好优化的特供版本"Llama-4-Maverick-03-26-Experimental"，但未明确标注，影响排名公平性。竞技场公布了2000多轮对战数据，显示该版本在代码生成、中文解析等任务中表现优异且更讨喜，但引发"刷榜"质疑。虽然Llama-4在竞技场排名第一(超过DeepSeek-V3)，但实际使用中频繁翻车。Meta回应称差异源于部署问题而非测试集训练，但难以服众。事件暴露出现有AI评价体系(如人类投票)的局限性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T02:30:36Z
- **目录日期**: 2025-04-09
