...
大模型竞技场（Chatbot Arena）指控Meta提供的Llama 4是经过人类偏好优化的特供版（Llama-4-Maverick-03-26-Experimental），未明确标注，影响排名公平性。官方公布2000多轮对战数据显示，该版本在代码生成、中文解析等任务中表现优于对手，用户偏好明显，但引发“刷榜定制”质疑。尽管Meta否认使用测试集训练，称差异源于部署问题，但模型排名（超越DeepSeek-V3）与实际体验不符，引发对评分机制（如人类投票、ELO算法）的争议。事件暴露透明度与评估标准问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T04:04:44Z
- **目录日期**: 2025-04-09
