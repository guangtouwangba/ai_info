...
研究人员开发了TxGemma系列高效通用大语言模型（LLM），包含2B/9B/27B参数版本，专为药物研发设计。该模型在66项药物开发任务中表现优异：64项超越或持平现有通用模型（45项领先），50项超越专业模型（26项领先）。其特点包括：1）多源数据整合能力；2）小样本微调优势；3）支持自然语言交互和分子机制解释。基于此还开发了Agentic-Tx智能代理系统，在多个化学/生物学基准测试中显著领先，如在Humanity's Last Exam上相对性能提升52.3%。这些工具显著提升了药物开发的预测效率和可解释性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T12:01:37Z
- **目录日期**: 2025-04-09
