...
研究人员开发了TxGemma系列高效通用大语言模型，专门用于药物研发。该模型基于Gemma-2架构，包含2B、9B和27B参数版本，在66项药物开发任务中表现优异：64项优于或持平现有通用模型（45项更优），50项优于专业模型（26项更优）。TxGemma能整合小分子、蛋白质等多元数据，且在小样本场景下表现良好。其对话功能支持自然语言交互和分子机制解释。此外，团队还推出了Agentic-Tx智能代理系统，在多个化学和生物基准测试中显著超越先前最佳模型，最高提升达52.3%。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T10:02:06Z
- **目录日期**: 2025-04-09
