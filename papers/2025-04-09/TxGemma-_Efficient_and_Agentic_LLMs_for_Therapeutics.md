...
TxGemma是一套高效通用的大型语言模型(LLM)套件，专为药物研发设计。该套件包含2B/9B/27B参数模型，在66项药物研发任务中表现优异：64项优于或持平现有通用模型(45项更优)，50项优于专业模型(26项更优)。相比基础LLM，TxGemma在临床试验不良反应预测等下游任务中所需训练数据更少。其对话模型支持自然语言交互，能基于分子结构提供预测机制解释。此外，基于Gemini 2.5的Agentic-Tx智能体系统在多个化学/生物学基准测试中表现突出，在Humanity's Last Exam上相对性能提升达52.3%。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T09:01:38Z
- **目录日期**: 2025-04-09
