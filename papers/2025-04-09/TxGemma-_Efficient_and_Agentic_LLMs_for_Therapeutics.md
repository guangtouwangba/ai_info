...
研究人员开发了TxGemma系列高效通用大语言模型，用于药物开发中的属性预测、交互推理和解释。该系列包含2B、9B和27B参数模型，在66项药物开发任务中表现优异，64项优于或持平现有通用模型，50项优于专业模型。TxGemma所需训练数据更少，适合数据有限场景。此外还开发了对话模型，支持自然语言交互和分子结构推理。基于此，团队进一步推出Agentic-Tx智能代理系统，在多个化学和生物学基准测试中显著超越先前最佳模型，最高提升达52.3%。这些工具为药物研发提供了高效、可解释的AI解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T04:01:40Z
- **目录日期**: 2025-04-09
