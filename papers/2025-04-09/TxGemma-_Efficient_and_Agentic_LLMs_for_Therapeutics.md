...
研究人员开发了TxGemma系列高效通用大语言模型，用于治疗性开发预测和交互推理。该套件包含2B、9B和27B参数模型，在66项治疗开发任务中表现优异，64项优于或持平现有通用模型（45项更优），50项优于专业模型（26项更优）。TxGemma所需训练数据更少，适合数据有限场景。此外还开发了对话式模型和Agentic-Tx智能代理系统，后者在多个基准测试中表现突出，如在Humanity's Last Exam上相对提升52.3%，在GPQA（化学）上提升26.7%。这些工具为药物研发提供了强大的预测和交互能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T05:01:37Z
- **目录日期**: 2025-04-09
