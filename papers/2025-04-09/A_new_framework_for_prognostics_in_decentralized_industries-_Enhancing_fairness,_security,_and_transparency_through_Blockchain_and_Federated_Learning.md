...
本文探讨了在工业5.0背景下，如何通过联邦学习（FL）和区块链（BC）技术提升去中心化制造环境中机器剩余使用寿命（RUL）的预测能力。传统集中式数据方法存在隐私、安全和扩展性问题，而FL支持多站点本地化模型训练，BC则确保网络中的信任、透明度和数据完整性。该框架优化了RUL预测，增强了数据隐私与安全，并促进去中心化协作。实验基于NASA CMAPSS数据集验证了模型的有效性，相关代码已在GitHub开源，以推动工业5.0的创新研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T23:02:07Z
- **目录日期**: 2025-04-09
