...
本文探讨了在工业5.0背景下，如何通过联邦学习(FL)和区块链(BC)技术结合来提升设备剩余使用寿命(RUL)预测能力。传统集中式数据方法存在隐私、安全和扩展性问题，而FL支持多站点本地化模型训练，BC则确保网络中的信任、透明度和数据完整性。该框架优化了RUL预测，增强了数据隐私与安全，促进了分散制造中的协作。研究使用NASA CMAPSS数据集验证了模型有效性，并通过GitHub开源代码推动工业5.0创新。该方案解决了隐私安全、透明度及分散网络参与激励等关键挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T09:02:27Z
- **目录日期**: 2025-04-09
