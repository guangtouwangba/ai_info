...
Jeremy Howard（Kaggle前首席科学家）声称自己创造了第一个大语言模型（LLM），引发AI圈热议。经考证，其2018年提出的ULMFiT模型采用无监督预训练-微调范式，被公认为现代LLM的"共同祖先"。GPT-1作者也承认受其启发。分析显示ULMFiT已具备语言模型、自监督训练等核心LLM特征，虽未使用Transformer架构，但在技术路径上奠定了重要基础。这场"AI考古"揭示了ULMFiT作为NLP领域关键转折点的历史地位。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T01:30:42Z
- **目录日期**: 2025-04-09
