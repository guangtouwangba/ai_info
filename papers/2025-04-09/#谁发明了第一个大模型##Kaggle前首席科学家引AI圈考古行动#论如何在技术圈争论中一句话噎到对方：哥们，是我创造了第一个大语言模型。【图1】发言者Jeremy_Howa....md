...
这篇微博讨论了AI领域关于"谁发明了第一个大语言模型"的争议。Kaggle前首席科学家Jeremy Howard声称自己创造了第一个大语言模型，并提供了证据支持。他的2018年论文ULMFiT采用了非监督预训练-微调范式，被GPT-1作者承认是其灵感来源之一。考据显示ULMFiT具备现代大语言模型的关键特质，被认为是所有现代大模型的"共同祖先"。虽然ULMFiT不是基于Transformer架构，但在概念和技术路径上确实开创了先河，是一个被低估的重要转折点。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T02:30:15Z
- **目录日期**: 2025-04-09
