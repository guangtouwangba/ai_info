...
该研究探讨了AI在特定任务中超越人类表现时，披露其超强能力对用户态度和行为的影响。通过"角色卡片"模拟多样化用户反应，研究发现透明度具有双刃剑效应：披露能力虽能减少怀疑，但会引发新手在合作场景中的挫败感，以及竞争环境下的过度依赖。经验丰富的玩家则可能将披露视为对手不可战胜的证明，转而追求次优目标。研究表明，透明度并非万能解决方案，需根据用户特征、领域规范和公平目标精心设计。研究发布了"角色卡片数据集"以促进可重复的AI对齐研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T02:29:06Z
- **目录日期**: 2025-04-09
