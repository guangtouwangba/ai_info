...
这篇论文提出了CodeArena基准测试和SynCode-Instruct语料库，用于评估代码生成大模型（codeLLMs）与人类偏好的对齐程度。现有基准主要关注代码正确性，而CodeArena通过397个涵盖40类编程任务的样本，更贴近实际开发需求。研究还构建了包含近200亿标记的合成指令数据集用于微调。实验发现，执行基准与人类偏好评估存在差异，且开源模型（如Qwen2.5-Coder）与商业模型（如OpenAI）性能差距显著，凸显了人类偏好对齐的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T08:06:27Z
- **目录日期**: 2025-04-09
