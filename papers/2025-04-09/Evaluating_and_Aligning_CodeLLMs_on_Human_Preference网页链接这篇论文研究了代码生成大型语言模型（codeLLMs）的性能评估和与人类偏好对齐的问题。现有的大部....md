...
这篇论文针对代码生成大模型(codeLLMs)提出新评估方法，指出当前基准测试过于关注代码正确性而忽视人类偏好。研究者构建了CodeArena基准(含397个高质量样本，覆盖40类任务和44种编程语言)和SynCode-Instruct指令集(近200亿标记)，发现执行基准与人类偏好存在差异。实验比较40多个模型显示，开源顶级模型(如Qwen2.5-Coder)与专有模型(如OpenAI o1)性能差距显著，凸显对齐人类偏好的重要性。研究强调需要更全面的评估标准来提升代码生成模型的实际应用价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T10:06:40Z
- **目录日期**: 2025-04-09
