...
近期机器学习的发展显著提升了从基因表达数据中识别疾病相关基因的能力，但该过程通常依赖专业知识和人工操作，限制了可扩展性。为此，研究团队开发了GenoTEX基准数据集，提供遵循计算基因组学标准的全流程分析代码和专家标注结果，用于评估自动化基因-性状关联分析方法。同时提出GenoAgent——基于大语言模型的多智能体协作系统，通过自校正编程流程分析基因数据。实验验证了大语言模型在基因组数据分析中的潜力，也揭示了改进空间。该资源有望推动基因表达数据自动化分析的发展，数据集已开源发布。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T09:02:47Z
- **目录日期**: 2025-04-09
