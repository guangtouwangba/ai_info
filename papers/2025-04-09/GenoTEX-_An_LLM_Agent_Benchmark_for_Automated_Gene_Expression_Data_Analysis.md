...
近期机器学习在基因表达数据疾病相关基因识别方面取得显著进展，但传统方法依赖专家经验且难以扩展。为此，研究者开发了GenoTEX基准数据集，包含符合计算基因组学标准的分析流程、专家标注数据，用于评估自动化分析方法。同时提出GenoAgent系统，采用具备自我修正能力的多智能体协作框架处理基因表达数据。实验表明大语言模型在基因组数据分析中具有潜力，但也存在需改进的挑战。该基准数据集（https://github.com/Liu-Hy/GenoTEX）为自动化基因表达分析方法的评估与发展提供了重要资源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T11:02:35Z
- **目录日期**: 2025-04-09
