...
近期机器学习在基因表达数据疾病相关基因识别方面取得显著进展，但传统方法依赖专家知识且难以扩展。为此，研究者开发了GenoTEX基准数据集，包含符合计算基因组学标准的分析流程和专家标注结果，用于评估自动化分析方法。同时提出GenoAgent——基于大语言模型的多智能体系统，采用自校正编程工作流协作分析基因数据。实验表明大语言模型在基因组数据分析中具有潜力，同时也揭示了改进空间。GenoTEX为基因表达数据自动化分析提供了评估基准，相关资源已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T13:10:34Z
- **目录日期**: 2025-04-09
