...
近期机器学习在基因表达数据分析方面取得显著进展，但传统方法依赖专家经验且难以扩展。为此，研究者开发了GenoTEX基准数据集，包含标准化的基因-性状关联分析流程（数据选择、预处理和统计分析）及专家标注结果。同时提出GenoAgent系统，采用具备自我修正能力的多智能体协作框架来自动化分析流程。实验证明大语言模型在基因组数据分析中具有潜力，但也暴露出需要改进的问题。该研究为基因表达分析的自动化方法提供了评估基准（开源地址：https://github.com/Liu-Hy/GenoTEX），将推动该领域发展。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T19:02:19Z
- **目录日期**: 2025-04-09
