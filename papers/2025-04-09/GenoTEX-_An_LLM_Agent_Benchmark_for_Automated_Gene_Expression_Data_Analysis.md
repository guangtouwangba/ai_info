...
近期机器学习在基因表达数据疾病相关基因识别方面取得显著进展，但传统方法依赖专家经验且难以扩展。为此，研究者开发了GenoTEX基准数据集，包含标准化的基因组学分析流程和专家标注，用于评估自动化分析方法。同时提出GenoAgent系统，采用基于大语言模型的多智能体协作框架，通过自校正编程流程实现基因表达数据分析。实验验证了大语言模型在基因组学分析的潜力，也揭示了改进方向。该资源（https://github.com/Liu-Hy/GenoTEX）为基因表达数据自动化分析提供了基准平台。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T08:02:57Z
- **目录日期**: 2025-04-09
