...
近期机器学习在基因表达数据分析中取得显著进展，但传统方法依赖专家经验且难以扩展。为此，研究者开发了GenoTEX基准数据集，包含符合计算基因组学标准的分析流程和专家标注结果，用于评估自动化分析方法。同时提出GenoAgent系统，采用基于大语言模型的多智能体协作框架，通过自校正编程流程实现基因-性状关联分析。实验验证了大语言模型在基因组数据分析中的潜力，也揭示了改进方向。该资源为基因表达分析的自动化方法提供了评测基准，相关数据已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T07:02:38Z
- **目录日期**: 2025-04-09
