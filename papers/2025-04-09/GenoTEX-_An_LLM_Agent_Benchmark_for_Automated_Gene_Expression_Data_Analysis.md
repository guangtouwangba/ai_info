...
近期机器学习在基因表达数据疾病相关基因识别方面取得显著进展，但传统方法依赖专业知识和人工操作，可扩展性有限。为此，研究者开发了GenoTEX基准数据集，包含符合计算基因组学标准的分析流程、专家标注结果，用于评估自动化分析方法。同时提出GenoAgent——基于大语言模型的多智能体系统，通过多步骤编程和自校正协作分析基因数据。实验验证了大语言模型处理基因组数据的潜力，也揭示了改进方向。该资源（GitHub开源）为基因表达分析的自动化方法提供了标准化评估平台，推动该领域发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T16:02:38Z
- **目录日期**: 2025-04-09
