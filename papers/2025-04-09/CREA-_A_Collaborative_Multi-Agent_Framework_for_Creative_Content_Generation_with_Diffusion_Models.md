...
本文提出CREA框架，通过多智能体协作模拟人类创作过程，解决AI图像创作的创新性难题。不同于传统基于提示的直接修改，CREA采用自主迭代方法，由专业AI智能体协同完成构思、生成、评价和优化。实验表明，CREA在多样性、语义对齐和创意转换方面显著优于现有方法。该框架将创造力构建为动态过程，重新定义了AI与艺术的结合，为自主AI艺术探索、生成设计和人机协同创作开辟了新途径。据我们所知，这是首个针对创意编辑任务提出的系统性解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T03:13:38Z
- **目录日期**: 2025-04-09
