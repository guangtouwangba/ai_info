...
本文综述了针对非小细胞肺癌（NSCLC）ALK基因双靶点抑制剂的最新进展。ALK基因是NSCLC的重要致癌驱动靶点，尽管已有7种ALK抑制剂获批，但耐药性问题仍存在挑战。相比联合用药，双靶点抑制剂能同时作用于两个靶点，减少副作用并增强抗耐药性。文章总结了这类抑制剂的设计原理、结构-活性关系及治疗策略，为开发新型ALK靶向药提供了重要参考。该研究对克服NSCLC治疗中的耐药性问题具有指导意义。（99字）  

注：原文开头提及的"OmniEval"金融领域评估内容与后续肺癌研究无关，可能是微博排版错误，因此未纳入摘要。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T10:05:45Z
- **目录日期**: 2025-04-09
