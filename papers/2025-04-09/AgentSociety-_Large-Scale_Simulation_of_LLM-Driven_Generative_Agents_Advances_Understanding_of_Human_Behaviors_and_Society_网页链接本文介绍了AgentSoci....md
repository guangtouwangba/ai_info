...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统模拟了1万多个AI代理的社会互动（共500万次），用于研究社会现象如信息传播、政策影响和突发事件应对。通过四个案例研究（社会极化、信息传播、基本收入政策、飓风影响），验证了模拟结果与现实数据的吻合性。研究表明，AgentSociety能有效捕捉人类行为机制，为社会科学研究和政策制定提供了新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T00:05:48Z
- **目录日期**: 2025-04-09
