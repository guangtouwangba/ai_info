...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统通过1万多个AI代理在虚拟社会环境中进行500万次交互，模拟了真实人类行为和社会动态。研究者利用该平台研究了四个关键社会问题：群体极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，验证了系统对人类行为机制和社会现象的解释力。该平台可作为计算社会科学研究工具，为政策制定提供新方法，弥补传统调查和实验的局限性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T12:05:18Z
- **目录日期**: 2025-04-09
