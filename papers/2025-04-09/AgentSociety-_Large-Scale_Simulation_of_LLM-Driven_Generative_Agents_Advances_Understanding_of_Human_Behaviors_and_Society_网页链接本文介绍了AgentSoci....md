...
AgentSociety是一个基于大型语言模型的大规模社会模拟器，可模拟1万多个代理及其500万次互动。研究者用它分析四个社会问题：极化现象、刺激性信息传播、无条件基本收入政策影响和外部冲击（如飓风）。模拟结果与现实世界数据吻合，验证了其捕捉人类行为和社会机制的能力。该工具可作为社会科学研究和政策制定的新方法，补充传统调查和实验手段。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T11:05:26Z
- **目录日期**: 2025-04-09
