...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统模拟了超过1万个AI代理的社会互动（共500万次），用于研究社会现象如信息传播、政策影响等。研究测试了极化现象、刺激性信息传播、基本收入政策和飓风冲击四个案例，结果与现实数据吻合，验证了该模拟器捕捉人类行为机制的能力。这表明AgentSociety可作为社会科学研究和政策制定的有效工具，补充传统研究方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T16:05:14Z
- **目录日期**: 2025-04-09
