...
英特尔锐炫™游戏显卡正被用于大模型一体机，提供高性价比方案。测试显示，4张A770显卡比2张N卡耗时略长（50分钟vs30分钟），但成本仅为N卡一半。飞致云公司验证该方案适合30-50人团队，将百万级部署成本降低一个数量级。虽然性能稍逊，但价格优势显著，成为私有化部署大模型的新选择，尤其适合中小规模AI推理需求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T12:03:32Z
- **目录日期**: 2025-04-09
