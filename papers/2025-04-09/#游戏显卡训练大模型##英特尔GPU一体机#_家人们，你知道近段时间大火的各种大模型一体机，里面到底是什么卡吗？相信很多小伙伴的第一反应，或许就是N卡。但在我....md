...
英特尔锐炫™显卡正被用于大模型一体机，提供高性价比方案。测试显示，4张锐炫™A770显卡比2张N卡慢20分钟（50分钟vs30分钟），但成本仅为N卡一半。飞致云公司将其用于MaxKB知识库系统，认为该方案适合30-50人团队，将私有化部署成本从百万元级降至十万级。虽然性能稍逊，但显著降低了AI推理门槛，成为大模型部署的新选择。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T16:03:36Z
- **目录日期**: 2025-04-09
