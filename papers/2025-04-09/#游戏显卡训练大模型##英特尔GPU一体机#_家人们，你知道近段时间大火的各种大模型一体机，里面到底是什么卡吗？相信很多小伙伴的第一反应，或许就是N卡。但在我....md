...
英特尔锐炫™游戏显卡(A770)正被用于大模型一体机，相比N卡虽速度稍慢(50分钟vs半小时完成相同任务)，但4张A770价格仅相当于半张N卡，性价比突出。飞致云测试表明，这种方案适合30-50人团队使用，将私有化部署成本从百万元级降至十万元级，为大模型落地提供了高性价比选择。除一体机外，锐炫显卡在AI推理任务中的应用也日益广泛。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T13:11:45Z
- **目录日期**: 2025-04-09
