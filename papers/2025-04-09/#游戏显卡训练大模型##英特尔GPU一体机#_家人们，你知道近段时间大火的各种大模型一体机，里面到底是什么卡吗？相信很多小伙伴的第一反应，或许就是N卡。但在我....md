...
英特尔锐炫™游戏显卡正被用于大模型一体机方案，提供高性价比选择。飞致云测试显示，4张A770显卡（耗时50分钟）虽慢于N卡（30分钟），但成本仅为后者一半。这种方案适合30-50人团队，将私有化部署成本从百万元级降至十万元级，成为企业部署大模型（如知识库问答系统）的经济型替代方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T18:03:24Z
- **目录日期**: 2025-04-09
