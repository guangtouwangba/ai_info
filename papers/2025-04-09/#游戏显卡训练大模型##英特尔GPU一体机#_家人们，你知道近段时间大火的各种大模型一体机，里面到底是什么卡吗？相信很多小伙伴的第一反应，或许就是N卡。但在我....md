...
英特尔锐炫™显卡(A770)正被用于大模型一体机，提供高性价比方案。测试显示，4张A770完成大模型任务需50分钟，虽慢于N卡的30分钟，但成本仅为后者一半。飞致云公司将其应用于MaxKB知识库系统，认为该方案特别适合30-50人团队，将私有化部署成本从百万元级降至十万元级。游戏显卡的加入为大模型训练提供了更经济的选择，同时在AI推理领域也展现应用潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T14:03:42Z
- **目录日期**: 2025-04-09
