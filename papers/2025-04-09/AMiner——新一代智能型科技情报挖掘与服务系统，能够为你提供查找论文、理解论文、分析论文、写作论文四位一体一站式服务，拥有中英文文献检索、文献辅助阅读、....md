...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、辅助阅读、翻译和科研情报订阅。它拥有海量学术资源（3.5亿论文、0.6亿学者等），支持AI生成摘要、互动问答和文档分析，帮助用户高效理解文献内容。用户可定制订阅最新科研动态，还能使用学者画像、学术会议等扩展功能。平台通过网页和小程序免费开放，旨在提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T23:05:14Z
- **目录日期**: 2025-04-09
