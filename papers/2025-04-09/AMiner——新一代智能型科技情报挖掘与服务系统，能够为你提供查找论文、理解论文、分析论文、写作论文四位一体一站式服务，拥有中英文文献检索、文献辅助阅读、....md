...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译和科研动态订阅等一站式服务。它收录了3.5亿篇论文、0.6亿学者和1.5亿专利，支持中英文文献检索，并能自动生成摘要和章节概要。用户可通过互动问答深入理解文献内容，还能定制科研情报推送服务，通过微信或邮件获取最新学术资讯。此外，AMiner还提供学者画像、学术会议和论文排行榜等功能，免费使用。访问网址：https://www.aminer.cn/。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T08:06:18Z
- **目录日期**: 2025-04-09
