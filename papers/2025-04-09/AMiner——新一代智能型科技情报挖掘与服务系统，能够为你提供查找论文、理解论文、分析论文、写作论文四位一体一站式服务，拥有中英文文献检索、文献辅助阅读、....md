...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译和科研订阅等一站式服务。它收录了3.5亿篇论文、0.6亿学者和1.5亿专利，支持中英文文献检索，并能自动生成摘要和章节概要。用户可通过互动问答深入理解文献内容，还能订阅个性化科研动态。平台还提供学者画像、学术会议和必读论文专题等功能，可通过浏览器免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T15:06:31Z
- **目录日期**: 2025-04-09
