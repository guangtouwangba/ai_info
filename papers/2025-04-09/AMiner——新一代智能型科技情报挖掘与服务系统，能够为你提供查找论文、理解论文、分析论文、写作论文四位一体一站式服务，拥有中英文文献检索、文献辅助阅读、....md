...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析和写作一站式服务。平台支持中英文文献搜索、AI辅助阅读、自动摘要生成、互动问答及文档翻译功能，覆盖42个学科3.5亿论文资源。特色功能包括科研动态订阅（通过微信/邮件推送定制化情报）、学者画像分析及学术会议追踪。用户可免费使用网页版，通过上传PDF或平台文献库快速获取结构化摘要与内容解析，显著提升科研效率。访问入口：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T11:05:55Z
- **目录日期**: 2025-04-09
