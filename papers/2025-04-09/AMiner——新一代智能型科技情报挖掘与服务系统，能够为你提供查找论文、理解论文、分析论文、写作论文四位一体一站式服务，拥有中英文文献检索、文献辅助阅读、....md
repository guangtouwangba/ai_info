...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作一站式服务。它支持中英文文献搜索，拥有3.5亿论文、0.6亿学者等海量数据，并能自动生成摘要和翻译。用户可通过互动问答快速理解文献内容，还能订阅个性化科研动态推送。平台还提供学者画像、学术会议等辅助功能，支持PDF上传和智能摘要生成。AMiner可免费使用，帮助研究者高效获取学术信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T16:05:42Z
- **目录日期**: 2025-04-09
