...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、辅助阅读、翻译和论文写作支持。它收录了3.5亿论文、0.6亿学者等海量数据，支持互动问答和自动摘要生成。用户可上传PDF或搜索文献，获取摘要和章节概要，并通过对话深入理解内容。平台还提供科研动态订阅服务，根据用户偏好推送最新论文摘要。此外，AMiner具备学者画像、学术会议等功能，浏览器即可免费使用。访问入口：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T04:07:08Z
- **目录日期**: 2025-04-09
