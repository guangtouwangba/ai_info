...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、辅助阅读、翻译和论文写作支持。它收录了3.5亿论文、0.6亿学者和1.5亿专利等海量学术资源。主要功能有：1）精准检索文献并生成摘要；2）AI辅助阅读和翻译英文文献；3）个性化科研情报订阅服务，通过微信或邮件推送最新研究动态。平台还提供学者画像、学术会议和论文排行榜等功能，支持免费使用。网址：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-09T12:05:48Z
- **目录日期**: 2025-04-09
