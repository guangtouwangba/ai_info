...
华中科技大学与北京邮电大学等团队联合推出多模态大模型Perception-R1（PR1），首次在COCO2017验证集上突破30AP，超越YOLOv3和Faster-RCNN等传统视觉模型。PR1通过基于规则的强化学习（RL）增强多模态感知能力，专注于纯视觉任务（如目标检测、计数）和视觉语言任务（如OCR、定位）。该研究展示了RL在提升模型感知策略方面的潜力，相关论文与代码已开源，旨在为多模态研究提供高性能基线。成果标志着强化学习在多模态感知领域的突破性进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T07:02:48Z
- **目录日期**: 2025-05-03
