...
华中科技大学与北京邮电大学等团队联合推出多模态大模型Perception-R1（PR1），首次在COCO2017验证集上突破30AP，超越YOLOv3和Faster-RCNN。该研究通过基于规则的强化学习（RL）增强模型感知能力，聚焦纯视觉任务（如目标检测、计数）和视觉语言任务（如OCR、定位）。PR1展现出在多模态感知策略上的显著潜力，相关论文和代码已开源，旨在为社区提供强大的基准模型，推动多模态感知研究的进一步发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T15:03:23Z
- **目录日期**: 2025-05-03
