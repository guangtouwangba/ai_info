...
华中科技大学与北京邮电大学等团队联合推出多模态大模型Perception-R1（PR1），首次在COCO2017验证集上突破30AP，超越YOLOv3和Faster-RCNN。该研究通过基于规则的强化学习（RL）增强模型感知能力，专注于纯视觉任务（如目标检测、计数）和视觉语言任务（如OCR、定位）。PR1展现出在多模态感知策略上的显著潜力，论文与模型已开源，旨在为后续研究提供强基准。这一成果标志着多模态LLM在视觉推理基础感知层面的重要突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T11:03:12Z
- **目录日期**: 2025-05-03
