...
华中科技大学与北京邮电大学等团队联合推出多模态大模型Perception-R1（PR1），首次在COCO2017验证集上突破30AP，超越YOLOv3和Faster-RCNN。该研究探索了基于规则的强化学习（RL）对模型感知能力的提升，聚焦纯视觉任务（目标检测、计数）和视觉语言任务（OCR、grounding）。PR1展现了多模态LLM在感知策略上的潜力，论文与模型已开源，旨在为后续研究提供强大基线。这一成果标志着多模态感知技术的重要突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T16:03:27Z
- **目录日期**: 2025-05-03
