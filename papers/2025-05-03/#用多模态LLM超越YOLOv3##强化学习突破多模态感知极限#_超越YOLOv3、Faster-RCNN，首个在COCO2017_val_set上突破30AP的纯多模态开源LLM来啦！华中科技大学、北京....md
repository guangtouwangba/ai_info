...
华中科技大学与北京邮电大学等团队联合推出多模态大模型Perception-R1（PR1），首次在COCO2017验证集上突破30AP，超越YOLOv3和Faster-RCNN。该研究探索基于规则的强化学习（RL）对多模态感知能力的提升，聚焦纯视觉（目标检测、计数）和视觉语言（OCR、定位）任务。PR1展现出感知策略的显著潜力，论文与模型已开源，旨在为社区提供强基准。研究标志着多模态LLM在基础感知层面的突破，为后续AI视觉推理发展奠定基础。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T19:03:11Z
- **目录日期**: 2025-05-03
