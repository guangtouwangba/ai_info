...
Claude最新更新两大核心功能：1) 网页版接入MCP协议（AI界的Type-C接口），支持GitLab、PayPal等10款应用一键集成，可快速调用Jira等服务完成日程安排、用户反馈分析等任务；2) Research功能升级，新增MCP数据源支持，能30分钟内分析500+资料并生成带引用来源的详细报告。这些功能已向Max/Team/Enterprise用户开放，Pro用户将陆续获得。更新强化了AI与工具集成能力，推动"大模型即服务"发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T16:03:56Z
- **目录日期**: 2025-05-03
