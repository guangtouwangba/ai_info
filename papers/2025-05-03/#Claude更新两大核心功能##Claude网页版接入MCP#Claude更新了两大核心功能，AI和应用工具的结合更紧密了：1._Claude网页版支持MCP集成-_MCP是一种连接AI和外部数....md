...
Claude最新更新两大核心功能：1) 网页版接入MCP协议（AI界的Type-C接口），支持10款应用（如Jira、PayPal等）快速集成，实现AI直接调用外部工具数据；2) Research功能升级，可读取MCP应用数据，30分钟内处理500+资料生成带来源引用的详细报告。这些功能已向Max/Team/Enterprise用户开放，Pro用户将陆续获得。更新强化了AI与工具的深度整合，推动"大模型即服务"发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T17:03:38Z
- **目录日期**: 2025-05-03
