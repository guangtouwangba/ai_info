...
Claude最新更新两大核心功能：1）网页版支持MCP协议集成，可一键连接GitLab、PayPal等10款应用，实现跨工具数据调用（如Jira任务管理）；2）Research功能升级，可整合MCP接入数据源，30分钟内分析500+文档并生成带引用来源的详细报告。这些功能已向Max/Team/Enterprise用户开放，Pro用户将逐步获得，推动AI向"大模型即服务"发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T13:08:56Z
- **目录日期**: 2025-05-03
