...
Claude近期更新两大核心功能：1) 网页版接入MCP协议（AI界的Type-C接口），支持10款应用（如Jira、PayPal）的快速集成，开发者30分钟即可完成配置，实现AI直接调用外部工具；2) Research功能升级，新增MCP数据源支持，能30分钟内分析500+资料并生成带来源引用的详细报告。这些功能已向Max/Team/Enterprise用户开放，Pro用户将逐步获得，标志着AI与工作流融合的进一步深化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T23:03:24Z
- **目录日期**: 2025-05-03
