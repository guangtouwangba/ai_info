...
Claude最新更新两大核心功能：1) 网页版接入MCP协议（AI界的Type-C接口），支持10款应用（如Jira、PayPal）的快速集成，开发者30分钟即可完成配置，实现AI直接调用外部工具数据；2) Research功能升级，可整合MCP接入应用的数据源，30分钟内处理500+资料并生成带引用来源的详细报告。这些功能已向Max/Team/Enterprise用户开放，Pro用户将陆续获得。更新推动AI与工具链深度整合，向"大模型即服务"迈进。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T19:03:38Z
- **目录日期**: 2025-05-03
