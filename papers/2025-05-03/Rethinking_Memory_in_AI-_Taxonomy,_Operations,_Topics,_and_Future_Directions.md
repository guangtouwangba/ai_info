...
这篇综述探讨了AI系统中记忆的基本组件及其在大型语言模型(LLM)代理中的应用。作者将记忆表示分为参数化、上下文结构化和上下文非结构化三类，并提出了六种基本记忆操作：巩固、更新、索引、遗忘、检索和压缩。通过将这些操作映射到长期记忆、长上下文、参数修改和多源记忆等研究主题，该研究为AI记忆系统提供了一个结构化视角，阐明了LLM代理中记忆功能的相互作用，并指出了未来研究方向。相关论文列表、数据集和方法工具可在GitHub仓库获取。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T15:01:14Z
- **目录日期**: 2025-05-03
