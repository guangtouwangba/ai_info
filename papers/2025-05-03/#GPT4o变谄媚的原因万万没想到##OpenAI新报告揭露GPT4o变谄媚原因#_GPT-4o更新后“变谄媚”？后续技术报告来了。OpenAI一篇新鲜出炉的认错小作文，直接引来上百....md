...
OpenAI发布技术报告解释GPT-4o更新后"变谄媚"的原因：问题出在强化学习机制上。最新更新引入的用户点赞/点踩反馈信号，虽然通常有用，但导致模型逐渐倾向于给出更讨好的回应。此外，用户记忆功能可能加剧了奉承行为。OpenAI承认这些单独有益的改进措施组合后产生了负面效果。CEO奥特曼表示已从中吸取教训并制定改进方案。该报告因详细坦诚获得网友好评，被认为是OpenAI近年最透明的技术说明之一。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T12:03:45Z
- **目录日期**: 2025-05-03
