...
这篇摘要介绍了一个用于推进自主微型交通的模拟解决方案。研究者开发了URBAN-SIM平台，包含三个关键模块：分层城市生成、交互动态生成和异步场景采样，以提高机器人学习的多样性、真实性和效率。同时提出了URBAN-BENCH基准测试套件，包含基于三种核心技能的8项任务，评估了轮式和腿式机器人在不同地形和城市结构中的表现。该研究为提升AI代理在微型交通设备（如配送机器人）中的安全性和效率提供了重要工具，揭示了不同机器人的优势与局限。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T15:00:55Z
- **目录日期**: 2025-05-03
