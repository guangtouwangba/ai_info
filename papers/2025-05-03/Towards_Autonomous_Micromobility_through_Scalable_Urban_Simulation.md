...
微型交通（如配送机器人、电动代步车）是城市交通的有前景的替代方案，但目前依赖人工操作存在安全和效率问题。研究提出通过AI代理辅助操作来提升性能，并开发了URBAN-SIM仿真平台（含分层城市生成、交互动态生成和异步场景采样模块）以支持大规模机器人训练。同时推出URBAN-BENCH测试套件，包含基于城市移动、导航和穿越三大核心技能的8项任务，评估轮式和足式等不同机器人在多样化地形和城市结构中的表现。实验揭示了各机器人的优劣势，为自主微型交通发展提供了系统性研究框架。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T20:00:57Z
- **目录日期**: 2025-05-03
