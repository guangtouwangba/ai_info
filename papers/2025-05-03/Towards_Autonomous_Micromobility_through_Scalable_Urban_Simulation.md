...
这篇摘要介绍了URBAN-SIM和URBAN-BENCH，一个用于自主微型交通（如配送机器人、代步车）AI代理训练和评估的城市模拟系统。URBAN-SIM通过分层城市生成、交互动态生成和异步场景采样三个模块，提高了机器人学习的多样性、真实性和效率。URBAN-BENCH则包含基于城市移动、导航和穿越三大核心技能的8项任务，用于评估不同形态机器人（轮式、腿式等）的性能。实验揭示了各机器人在不同地形和城市结构中的优劣势，为提升微型交通的安全性和效率提供了解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T12:01:09Z
- **目录日期**: 2025-05-03
