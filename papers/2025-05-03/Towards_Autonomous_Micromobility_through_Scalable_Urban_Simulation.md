...
这篇论文提出了一个可扩展的城市模拟解决方案URBAN-SIM，用于推进自主微移动技术发展。URBAN-SIM是一个高性能机器人学习平台，包含三个关键模块：分层城市生成管道、交互式动态生成策略和异步场景采样方案，以提高机器人学习的多样性、真实性和效率。同时，论文提出了URBAN-BENCH基准测试套件，包含基于城市运动、导航和穿越三大核心技能的八项任务，用于评估AI代理在实现自主微移动方面的能力。实验评估了轮式和腿式等不同机器人在多样化地形和城市结构中的表现，揭示了各自的优势和局限性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T11:00:50Z
- **目录日期**: 2025-05-03
