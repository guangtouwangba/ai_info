...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、科研情报订阅等一站式服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持AI辅助阅读、自动摘要生成和互动问答，帮助用户高效理解文献内容。平台还提供个性化科研动态推送，用户可订阅关注的关键词、学者或机构，通过微信或邮件获取最新研究资讯。此外，AMiner具备学者画像、学术会议推荐等功能，基础服务免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T12:05:51Z
- **目录日期**: 2025-05-03
