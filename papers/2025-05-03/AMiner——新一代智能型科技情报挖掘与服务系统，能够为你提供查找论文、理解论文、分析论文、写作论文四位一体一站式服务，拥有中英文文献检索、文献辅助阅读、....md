...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译和科研订阅等一站式服务。它收录了3.5亿论文、0.6亿学者和1.5亿专利，支持中英文文献检索，并能通过AI生成摘要和问答互动帮助理解内容。用户可订阅个性化科研动态，追踪学者和机构的最新成果。平台还提供学者画像、学术会议和论文排行榜等功能，基础服务免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T21:05:23Z
- **目录日期**: 2025-05-03
