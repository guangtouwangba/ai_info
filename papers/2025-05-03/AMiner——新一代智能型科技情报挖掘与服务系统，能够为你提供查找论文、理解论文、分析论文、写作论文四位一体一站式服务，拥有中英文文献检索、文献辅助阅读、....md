...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作一站式服务。它支持中英文文献搜索，能自动生成摘要和问答互动，帮助用户高效理解内容。平台还具备文献翻译、文档识别和辅助阅读功能，用户可上传PDF或从数据库获取论文。AMiner提供科研动态订阅服务，根据用户偏好推送最新学术资讯。此外，它还包含学者画像、学术会议和论文排行榜等功能。平台收录3.5亿论文、0.6亿学者等海量数据，基础功能免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T20:05:30Z
- **目录日期**: 2025-05-03
