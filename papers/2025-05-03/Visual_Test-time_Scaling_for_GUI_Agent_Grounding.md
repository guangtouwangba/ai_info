...
研究者提出了RegionFocus，一种视觉测试时缩放方法，用于提升视觉语言模型代理处理网页的能力。该方法通过动态放大相关区域，减少背景干扰，提高定位准确性。结合图像地图机制，可视化关键地标，增强动作选择的透明度。实验显示，该方法在Screenspot-pro和WebVoyager基准测试中，分别将UI-TARS和Qwen2.5-VL模型的性能提升了28%和24%。使用Qwen2.5-VL-72B模型时，RegionFocus在ScreenSpot-Pro基准测试中达到了61.6%的最新定位性能。代码将公开于GitHub。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T02:28:11Z
- **目录日期**: 2025-05-03
