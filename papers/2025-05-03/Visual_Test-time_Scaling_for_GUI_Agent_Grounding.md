...
我们提出了RegionFocus，一种视觉测试时缩放方法，用于提升视觉语言模型代理处理网页的能力。该方法通过动态放大相关区域来减少背景干扰，提高定位准确性。我们采用图像作为地图的机制，可视化关键地标，提供透明的操作记录，帮助代理在候选动作中有效选择。实验表明，该方法在Screenspot-pro和WebVoyager基准测试中分别提升了28%和24%的性能，使Qwen2.5-VL-72B模型在ScreenSpot-Pro上达到61.6%的最新定位准确率。代码将在GitHub公开。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T13:06:12Z
- **目录日期**: 2025-05-03
