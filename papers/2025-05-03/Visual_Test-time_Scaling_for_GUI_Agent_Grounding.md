...
本文介绍了RegionFocus，一种用于视觉语言模型代理的视觉测试时缩放方法。该方法通过动态放大网页相关区域，减少背景干扰，提高定位准确性。同时提出图像映射机制，可视化关键地标，增强动作选择的透明度。实验表明，该方法在Screenspot-pro和WebVoyager基准测试中分别提升28%和24%的性能，结合Qwen2.5-VL-72B模型后，在ScreenSpot-Pro基准上达到61.6%的最新定位准确率。代码将在GitHub公开。该方法显著提升了视觉语言模型代理在复杂网页交互中的表现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T14:01:13Z
- **目录日期**: 2025-05-03
