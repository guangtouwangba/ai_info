...
这篇立场论文主张转向以数据为中心的人工智能对齐方法，强调提高训练数据的质量和代表性。作者指出当前方法过于关注算法而忽视数据的关键作用，分析了人类反馈存在不可靠性、时间漂移和情境依赖等问题，以及AI反馈因模型局限难以捕捉人类价值观的缺陷。为此，论文提出未来研究方向：改进反馈收集方法、开发鲁棒的数据清洗技术、建立严格的反馈验证流程，呼吁加强以数据为中心的对齐实践研究，以解决现有理解与实践中的不足。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T02:29:13Z
- **目录日期**: 2025-05-03
