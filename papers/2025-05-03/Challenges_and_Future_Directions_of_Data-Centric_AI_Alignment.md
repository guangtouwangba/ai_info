...
随着AI系统能力增强，确保其与人类价值观对齐成为研究重点。当前方法多聚焦算法设计，却低估了数据的关键作用。本文主张转向以数据为中心的AI对齐，强调提升数据质量和代表性。研究指出人类反馈存在不可靠性，AI反馈存在时间漂移、情境依赖及模型局限等问题。建议未来研究方向包括：改进反馈收集方法、开发鲁棒的数据清洗技术、建立严格的验证流程。该文呼吁填补数据对齐实践中的认知空白，推动相关研究发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T19:02:12Z
- **目录日期**: 2025-05-03
