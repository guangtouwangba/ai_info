...
本文主张转向以数据为中心的AI对齐方法，强调提高训练数据的质量和代表性。当前方法过于依赖算法设计，而低估了数据的关键作用。研究指出人类反馈存在不可靠性，AI反馈则受限于时间漂移、情境依赖和模型固有缺陷。作者提出未来研究方向：优化反馈收集流程、开发鲁棒的数据清洗方法、建立严格的反馈验证机制，以解决数据对齐中的核心挑战。这一框架旨在填补现有研究空白，推动AI系统更好地与人类价值观保持一致。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T16:02:24Z
- **目录日期**: 2025-05-03
