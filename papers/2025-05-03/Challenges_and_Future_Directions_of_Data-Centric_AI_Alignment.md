...
随着AI系统能力增强，确保其与人类价值观对齐成为研究重点。当前方法过于关注算法设计而忽视数据质量。本文提出以数据为中心的AI对齐新范式，指出人类反馈存在可靠性问题，AI反馈则受限于时间漂移、情境依赖和模型缺陷。研究建议三个改进方向：优化反馈收集流程、开发鲁棒的数据清洗方法、建立严格的反馈验证机制。论文呼吁学界填补数据对齐领域的研究空白，通过提升数据质量和代表性来实现更有效的AI价值校准。该立场性论文为AI安全领域提供了重要的方法论转向思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T17:02:08Z
- **目录日期**: 2025-05-03
