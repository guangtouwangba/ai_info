...
这篇论文探讨了实现"人工科学家"愿景所需的关键概念，从AlphaGo到ChatGPT展开实证研究。研究始于类似AlphaGo Zero的Olivaw智能体，它虽能自主发现知识但无法交流，由此提出了"解释性学习"(EL)框架来模拟科学家解释新现象的过程。通过破解科学模拟游戏Zendo，研究得出关键洞见：人工科学家必须自主构建解释语言的理解机制。论文还提出了一种经济高效的多模态模型构建方法，并指出当前大语言模型(如ChatGPT)在解释能力上的不足，为此设计了Big-Bench符号解释任务作为基准测试。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T19:01:53Z
- **目录日期**: 2025-05-03
