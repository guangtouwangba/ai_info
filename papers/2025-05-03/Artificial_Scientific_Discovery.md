...
这篇论文探讨了实现"人工科学家"（能自主开展原创研究并扩展人类知识的AI系统）所需的基础概念。研究从AlphaGo类智能体Olivaw出发，发现其无法表达知识，进而提出"解释性学习"(EL)框架来模拟科学家解释新现象的过程。通过破解科学模拟游戏Zendo，研究发现人工科学家需要自主构建解释语言而非依赖固定解释器。作者进一步提出解耦感知与解释的CLIP类模型构建方法，并指出ChatGPT等模型在成为人工科学家方面的不足，最后引入Big-Bench符号解释任务作为评估基准，显示大语言模型在该任务上表现仅达随机水平。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T01:29:13Z
- **目录日期**: 2025-05-03
