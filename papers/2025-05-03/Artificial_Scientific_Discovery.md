...
这篇论文探讨了实现"人工科学家"愿景所需的基础概念，从AlphaGo到ChatGPT展开实证研究。研究始于开发类似AlphaGo Zero的Olivaw智能体，发现其无法传达知识后，提出了"解释性学习"(EL)框架来模拟科学家解释新现象的过程。该框架成功应用于Zendo棋盘游戏，揭示人工科学家需自主发展解释语言而非依赖固定解释器。作者进一步研究多模态模型，提出高效构建CLIP类模型的方法。最后指出ChatGPT等模型成为人工科学家的不足，并引入Big-Bench符号解释任务基准测试，显示LLMs表现随机而人类能完全解决。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T12:02:10Z
- **目录日期**: 2025-05-03
