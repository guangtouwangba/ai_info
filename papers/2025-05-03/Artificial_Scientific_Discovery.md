...
这篇论文探讨了实现"人工科学家"愿景的关键概念，从AlphaGo到ChatGPT展开实证研究。研究始于类似AlphaGo Zero的Olivaw智能体，发现其无法传达知识，进而开发了"解释学习"(EL)框架来模拟科学家解释新现象的过程。通过EL成功破解了模拟科研过程的Zendo游戏，得出关键见解：人工科学家必须自主发展解释语言的理解能力。研究还提出构建CLIP类模型的新方法，明确分离解释与感知功能。最后指出当前大语言模型(如ChatGPT)在解释Zendo类任务上表现仅随机水平，与人类存在显著差距。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T22:01:46Z
- **目录日期**: 2025-05-03
