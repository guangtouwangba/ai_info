...
这篇论文探讨了如何实现"人工科学家"的愿景，即机器能自主开展原创研究并扩展人类知识。研究从AlphaGo类智能体Olivaw出发，发现其无法交流知识，进而提出"解释学习"(EL)框架来模拟科学家解释新现象的过程。通过破解科学模拟游戏Zendo，研究发现人工科学家需要自主构建解释语言而非依赖现有解释器。作者还提出一种高效的多模态模型构建方法，将单模态模型解耦结合。最后指出ChatGPT等模型在解释Zendo类任务上表现仅如随机猜测，与人类能力差距显著，尚无法成为真正的人工科学家。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T09:01:54Z
- **目录日期**: 2025-05-03
