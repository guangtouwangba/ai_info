...
这篇论文探讨了实现"人工科学家"愿景所需的核心概念，从AlphaGo到ChatGPT展开实证研究。研究始于类似AlphaGo Zero的Olivaw智能体，它虽能发现新知识但无法表达，由此发展出"解释性学习"(EL)框架来模拟科学家向同行解释新现象的过程。通过EL成功破解模拟科研过程的Zendo游戏，得出关键洞见：人工科学家必须自主构建解释语言系统，而非依赖固定解释器。研究进一步提出解耦感知与解释的CLIP类模型构建方法，并指出当前大语言模型在解释能力上的不足，开发了相关基准测试。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T21:01:53Z
- **目录日期**: 2025-05-03
