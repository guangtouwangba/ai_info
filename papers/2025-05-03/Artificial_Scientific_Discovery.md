...
这篇论文探讨了实现“人工科学家”愿景所需的关键概念，从AlphaGo到ChatGPT展开实证研究。研究始于类似AlphaGo Zero的Olivaw智能体，它能发现奥赛罗棋知识但无法交流，从而引出了“解释性学习”(EL)框架的开发。该框架成功应用于模拟科研过程的Zendo棋盘游戏，揭示人工科学家必须自主构建解释语言而非依赖固定解释器。作者进一步提出构建CLIP类模型的新方法，将解释与感知显式分离。最后指出ChatGPT等模型在成为人工科学家方面的不足，并引入Big-Bench符号解释任务作为基准测试。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T15:01:55Z
- **目录日期**: 2025-05-03
