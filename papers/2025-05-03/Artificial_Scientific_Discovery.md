...
这篇论文探讨了实现"人工科学家"愿景所需的基础概念，从AlphaGo到ChatGPT展开实证研究。作者首先开发了类似AlphaGo Zero的Olivaw智能体，发现其无法传达知识，进而提出"解释性学习"(EL)框架来解决科学解释问题。通过破解科学模拟游戏Zendo，研究发现人工科学家需要自主构建解释语言而非依赖固定解释器。论文还提出了一种经济高效的多模态模型构建方法，将单模态模型解耦结合。最后指出当前大语言模型(如ChatGPT)与人工科学家的差距，并引入Big-Bench符号解释任务作为基准测试，显示人类表现远超随机水平而大模型仅达随机水平。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T07:01:59Z
- **目录日期**: 2025-05-03
