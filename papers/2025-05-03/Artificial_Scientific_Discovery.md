...
这篇论文探讨了实现"人工科学家"愿景所需的关键概念，从AlphaGo到ChatGPT展开实证研究。研究从类似AlphaGo Zero的Olivaw智能体开始，发现其无法有效传递知识，进而开发了"解释性学习"(EL)框架。通过破解科学模拟游戏Zendo，研究揭示人工科学家必须自主发展解释语言的理解能力。作者还提出了一种构建CLIP类模型的新方法，将解释与感知明确分离。最后指出当前大语言模型(如ChatGPT)在解释Zendo类任务上表现仅达随机水平，与人类存在显著差距，仍需突破才能成为真正的人工科学家。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T18:02:08Z
- **目录日期**: 2025-05-03
