...
这篇论文探讨了实现"人工科学家"愿景所需的关键概念，从AlphaGo到ChatGPT展开实证研究。研究始于开发类似AlphaGo Zero的Olivaw智能体，发现其无法有效传达知识后，提出了"解释性学习"(EL)框架来模拟科学解释过程。通过破解科学模拟游戏Zendo，揭示了人工科学家必须自主发展解释语言理解能力。研究进一步探索现代多模态模型，提出将解释与感知明确分离的CLIP类模型构建方法。最后指出ChatGPT等模型在成为人工科学家方面的不足，并引入Big-Bench符号解释任务作为评估基准，显示大语言模型表现仅达随机水平，而人类可完全解决。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T04:01:50Z
- **目录日期**: 2025-05-03
