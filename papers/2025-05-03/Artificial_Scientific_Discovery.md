...
这篇论文探讨了实现"人工科学家"愿景所需的基础概念，从AlphaGo到ChatGPT展开实证研究。研究始于类似AlphaGo Zero的Olivaw智能体，它能发现奥赛罗棋知识但无法表达，由此发展出"解释性学习"(EL)框架，成功破解模拟科研过程的Zendo棋盘游戏。研究发现人工科学家必须自主构建解释语言，而非依赖固定解释器。作者进一步提出构建CLIP类模型的新方法，将解释与感知明确分离。最后指出ChatGPT等模型成为人工科学家仍欠缺的能力，并引入Big-Bench符号解释任务作为基准测试，显示大语言模型表现仅达随机水平。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T08:01:55Z
- **目录日期**: 2025-05-03
