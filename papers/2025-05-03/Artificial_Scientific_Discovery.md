...
这篇论文探讨了实现"人工科学家"愿景所需的基础概念，从AlphaGo到ChatGPT展开实证研究。研究始于类似AlphaGo Zero的Olivaw智能体，虽能自主发现知识但无法表达，由此提出"解释性学习"(EL)框架来模拟科学家解释新现象的过程。通过EL成功破解Zendo棋盘游戏，发现人工科学家需要自主构建解释语言而非依赖固定解释器。研究进一步分析多模态模型，提出将感知与解释显式分离的CLIP类模型构建方法。最后指出当前大语言模型(如ChatGPT)与人工科学家的差距，并引入Big-Bench符号解释任务作为基准测试。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T02:28:54Z
- **目录日期**: 2025-05-03
