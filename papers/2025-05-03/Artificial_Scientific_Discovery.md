...
这篇论文探讨了实现"人工科学家"愿景所需的关键概念，从AlphaGo到ChatGPT展开实证研究。研究首先开发了类似AlphaGo Zero的Olivaw智能体，发现其无法传达知识，进而提出解释学习(EL)框架来模拟科学家解释新现象的过程。通过成功破解Zendo棋盘游戏，研究揭示人工科学家需要自主发展解释语言的理解能力。论文还提出构建解耦感知与解释的CLIP类模型的新方法，并分析了ChatGPT等模型成为人工科学家的不足，通过Big-Bench符号解释任务显示大语言模型在此类任务上表现仅达随机水平。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T03:16:23Z
- **目录日期**: 2025-05-03
