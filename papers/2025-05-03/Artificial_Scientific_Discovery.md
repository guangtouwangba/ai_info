...
这篇论文探讨了实现"人工科学家"愿景所需的关键概念，从AlphaGo到ChatGPT展开实证研究。研究始于类似AlphaGo Zero的Olivaw智能体，它虽能发现知识但无法表达，由此发展出"解释性学习"(EL)框架。该框架成功应用于Zendo棋盘游戏，揭示了人工科学家必须自主构建解释语言而非依赖固定解释器。作者进一步研究现代多模态模型，提出一种经济高效的方法来解耦感知与解释。最后指出ChatGPT等模型与人工科学家的差距，并引入Big-Bench符号解释任务作为基准测试，显示大语言模型表现随机而人类能完全解决。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T13:07:01Z
- **目录日期**: 2025-05-03
