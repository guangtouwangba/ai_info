...
这篇论文探讨了如何实现"人工科学家"的愿景，即让机器能自主开展原创研究并扩展人类知识。研究从AlphaGo类智能体Olivaw出发，发现其无法表达知识，进而开发了"解释学习"(EL)框架来模拟科学家解释新现象的过程。通过破解科学模拟游戏Zendo，研究发现人工科学家需要自主发展解释语言的理解能力，而非依赖固定解释器。作者还提出了一种经济高效的多模态模型构建方法，并分析了ChatGPT等模型与人工科学家的差距，最后引入Big-Bench符号解释任务来评估模型的理解能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T05:02:07Z
- **目录日期**: 2025-05-03
