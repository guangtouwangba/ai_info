...
这篇论文探讨了实现"人工科学家"愿景所需的核心概念，从AlphaGo到ChatGPT展开实证研究。研究始于类似AlphaGo Zero的Olivaw智能体，发现其无法交流知识，进而提出"解释性学习"(EL)框架来模拟科学家解释新现象的过程。通过EL成功破解了模拟科研过程的Zendo游戏，关键发现是人工科学家必须自主发展解释语言的理解能力。研究还提出了一种高效构建CLIP类模型的方法，并指出当前大语言模型(如ChatGPT)在解释Zendo类规则时表现仅达随机水平，远不及人类，距离成为真正的人工科学家仍有差距。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T14:02:01Z
- **目录日期**: 2025-05-03
