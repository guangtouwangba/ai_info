...
这篇论文探讨了实现"人工科学家"（能自主进行原创研究并扩展人类知识的AI系统）所需的基础概念。研究从AlphaGo类智能体Olivaw出发，发现其无法解释自身发现，进而开发了"解释性学习"(EL)框架。通过破解科学模拟游戏Zendo，研究得出关键洞见：人工科学家必须自主发展解释语言的理解能力，而非依赖固定解释器。作者进一步提出构建解耦感知与解释的多模态模型方法，并分析ChatGPT等系统成为人工科学家尚缺的能力，最后引入Big-Bench符号解释任务作为评估基准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T11:01:50Z
- **目录日期**: 2025-05-03
