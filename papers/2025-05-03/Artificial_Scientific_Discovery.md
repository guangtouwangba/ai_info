...
这篇论文探讨了实现"人工科学家"愿景所需的基础概念，从AlphaGo到ChatGPT展开实证研究。作者首先开发了类似AlphaGo Zero的Olivaw智能体，发现其无法交流知识，进而提出"解释性学习"(EL)框架来解决科学解释问题。通过破解Zendo棋盘游戏，研究发现人工科学家必须自主发展解释语言的理解能力。随后研究转向多模态模型，提出解耦感知与解释的CLIP类模型构建方法。最后指出ChatGPT等模型在成为人工科学家方面的不足，并引入Big-Bench符号解释任务基准测试，显示大语言模型表现仅达随机水平，而人类能完全解决。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T20:02:01Z
- **目录日期**: 2025-05-03
