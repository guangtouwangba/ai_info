...
这篇论文探讨了实现"人工科学家"愿景所需的基础概念，从AlphaGo到ChatGPT展开实证研究。研究始于类似AlphaGo Zero的Olivaw智能体，它虽能发现奥赛罗棋知识但无法表达，从而催生了"解释性学习"(EL)框架。通过EL成功破解模拟科研过程的Zendo游戏，发现人工科学家必须自主构建解释语言而非依赖固定解释器。研究还提出一种高效构建CLIP类模型的方法，将解释与感知显式分离。最后指出ChatGPT等模型与人工科学家的差距，并引入Big-Bench符号解释任务基准，显示大语言模型在此类任务中表现仅达随机水平。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T10:02:04Z
- **目录日期**: 2025-05-03
