...
当前大语言模型（LLM）的偏好对齐方法主要关注相对偏好，却忽略了响应质量。现有方法过度追求隐含奖励差距最大化，可能导致过拟合或高质量拒绝响应的遗忘。针对这一问题，本研究提出奖励条件化的LLM策略，通过分析数据集中全部响应质量来推断更优解。方法包括基于质量分数重新标记偏好对，构建奖励增强数据集。实验表明，该方法显著提升DPO性能，有效缓解遗忘问题，最大化偏好数据效用。研究证明其效果不仅源于数据扩展，更来自方法本身的优越性。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T20:02:10Z
- **目录日期**: 2025-05-03
