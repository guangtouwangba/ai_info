...
现有的大型语言模型偏好对齐方法主要关注相对偏好，却忽视了响应的质量特征，导致模型可能过度拟合或错误遗忘高质量被拒回答。本研究提出了一种奖励条件化的LLM策略，通过分析数据集中全部响应质量来学习，并推广至更优区域。方法包括基于质量分数重新标记偏好对以构建奖励增强数据集。实验表明，该方法显著提升了DPO性能，不仅最大化偏好数据的效用，还缓解了遗忘问题，效果超越单纯的数据扩展。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T08:02:05Z
- **目录日期**: 2025-05-03
