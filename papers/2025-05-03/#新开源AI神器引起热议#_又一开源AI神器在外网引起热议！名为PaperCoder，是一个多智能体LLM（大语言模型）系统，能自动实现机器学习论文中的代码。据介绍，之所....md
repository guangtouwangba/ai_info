...
韩国科学技术院研究人员开发了开源AI工具PaperCoder，这是一个多智能体大语言模型系统，能够自动将机器学习论文转换为可运行代码。该工具的推出是为了解决顶会论文中仅21%公开代码、导致复现困难的问题。PaperCoder通过规划、分析和代码生成三阶段的智能体协作，生成的代码质量超越现有基准，并获得77%原论文作者的认可。这一创新工具显著提升了研究成果的复现效率，在学术界引发广泛关注。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T04:03:28Z
- **目录日期**: 2025-05-03
