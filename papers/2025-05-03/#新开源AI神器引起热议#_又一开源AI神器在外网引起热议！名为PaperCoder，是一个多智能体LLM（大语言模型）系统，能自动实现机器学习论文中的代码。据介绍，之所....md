...
韩国科学技术院研究人员开发了一款名为PaperCoder的开源AI工具，旨在自动将机器学习论文转换为可运行代码。该工具采用多智能体系统，分规划、分析和代码生成三个阶段处理任务。据统计，2024年NeurIPS等顶会论文仅21%公开代码，导致复现困难。PaperCoder生成的代码质量超越部分基准，获得77%原论文作者认可，有望加速研究成果复现和应用。这一创新工具近期在外网引发热议。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T03:18:06Z
- **目录日期**: 2025-05-03
