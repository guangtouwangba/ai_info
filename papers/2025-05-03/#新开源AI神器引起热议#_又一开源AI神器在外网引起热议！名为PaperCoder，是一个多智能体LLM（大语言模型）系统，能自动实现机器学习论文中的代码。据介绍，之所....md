# #新开源AI神器引起热议# 又一开源AI神器在外网引起热议！名为PaperCoder，是一个多智能体LLM（大语言模型）系统，能自动实现机器学习论文中的代码。据介绍，之所...
...
韩国科学技术院研究人员开发了一款名为PaperCoder的开源AI工具，能够自动将机器学习论文转换为可运行代码。该工具采用多智能体系统，分为规划、分析和代码生成三个阶段，分别由专门智能体处理不同任务。据统计，2024年顶级AI会议论文中仅21%公开了代码，导致研究复现困难。PaperCoder生成的代码质量优于现有基准，并获得了77%原论文作者的认可。这一创新工具有望加速机器学习研究成果的复现和应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T00:03:40Z
- **目录日期**: 2025-05-03
