...
韩国科学技术院研究人员开发了开源AI工具PaperCoder，能够自动将机器学习论文转换为可运行代码。该系统采用多智能体架构，通过规划、分析和代码生成三个阶段处理任务。开发背景是2024年顶会论文中仅21%公开代码，导致复现困难。测试显示其生成代码质量优于现有基准，并获得了77%原论文作者的认可。该工具旨在加速科研成果的复现和应用，已在国际学术界引发热议。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T02:30:39Z
- **目录日期**: 2025-05-03
