...
微软与OpenAI的合作关系近期出现微妙变化。《华尔街日报》指出双方在算力资源分配、AGI发展理念和内部竞争三方面存在分歧：微软限制计算资源供给并自研AI模型，对AGI进展持保守态度；OpenAI则面临人才流失，坚持AGI研发。此外，微软收购Inflection团队开发竞品，双方高层沟通频率明显下降。尽管公开场合仍展示合作，但各自战略调整表明联盟正在松动。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T10:04:07Z
- **目录日期**: 2025-05-03
