...
微软与OpenAI的合作关系近期出现微妙变化。《华尔街日报》指出三大分歧：1)算力分配与模型授权争议，微软正减少对OpenAI的依赖；2)AGI发展理念差异，OpenAI持续投入而微软转向Copilot等实用产品；3)内部竞争加剧，微软收购Inflection团队自研LLM模型。尽管双方仍保持每周例会，但联系频率从CEO每日多条短信降至例行沟通。这些动向显示两家公司在AI领域的战略协同正在减弱，合作模式面临调整。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T12:04:14Z
- **目录日期**: 2025-05-03
