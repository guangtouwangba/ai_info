...
微软与OpenAI的合作关系近期出现裂痕，主要分歧包括：1）算力资源分配与模型授权问题，微软正减少对OpenAI的依赖并自研AI模型；2）AGI发展路径分歧，OpenAI持续投入而微软转向Copilot等务实产品；3）内部竞争加剧，微软收购Inflection团队独立研发对标GPT-4的模型。尽管双方公开保持合作，但高管互动频率从每日多条短信降至每周例会，反映出战略合作正在弱化。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T05:03:33Z
- **目录日期**: 2025-05-03
