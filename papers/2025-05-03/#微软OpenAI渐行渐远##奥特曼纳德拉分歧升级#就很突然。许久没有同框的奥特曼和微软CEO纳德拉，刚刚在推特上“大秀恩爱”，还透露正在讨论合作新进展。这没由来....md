...
微软与OpenAI的合作关系出现裂痕，主要分歧集中在三方面：1）算力资源分配和模型授权问题，微软称已提供最大支持但OpenAI仍有更高需求；2）AGI发展理念不合，OpenAI持续投入而微软转向Copilot等实际应用；3）微软收购Inflection团队自研大模型，形成内部竞争。双方联系频率从CEO每日短信降至每周例会，尽管公开仍维持合作，但各自独立发展的趋势日益明显。近期奥特曼与纳德拉的"秀恩爱"推文可能意在平息外界对双方关系恶化的猜测。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T08:04:00Z
- **目录日期**: 2025-05-03
