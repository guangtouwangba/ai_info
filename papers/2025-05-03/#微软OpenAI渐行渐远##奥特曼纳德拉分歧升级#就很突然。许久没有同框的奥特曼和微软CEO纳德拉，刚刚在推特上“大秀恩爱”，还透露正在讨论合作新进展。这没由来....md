# #微软OpenAI渐行渐远##奥特曼纳德拉分歧升级#就很突然。许久没有同框的奥特曼和微软CEO纳德拉，刚刚在推特上“大秀恩爱”，还透露正在讨论合作新进展。这没由来...
...
微软与OpenAI的合作关系近期出现微妙变化。据《华尔街日报》报道，双方在算力资源分配、AGI发展路径和模型授权方面存在分歧。微软正加速自研AI模型并收购Inflection团队，减少对OpenAI的依赖；而OpenAI面临人才流失问题。尽管双方仍维持每周例会，但联系频率已从CEO每日多次沟通降至每周一次。奥特曼与纳德拉最新互动被解读为对合作关系的公关回应，实际合作正呈现"渐行渐远"态势。（99字）  

注：摘要聚焦核心矛盾点（算力/方向/竞争），用数据对比（沟通频率变化）体现关系疏离，末句点明公开互动与实质进展的差异，符合信息浓缩要求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T18:04:03Z
- **目录日期**: 2025-05-03
