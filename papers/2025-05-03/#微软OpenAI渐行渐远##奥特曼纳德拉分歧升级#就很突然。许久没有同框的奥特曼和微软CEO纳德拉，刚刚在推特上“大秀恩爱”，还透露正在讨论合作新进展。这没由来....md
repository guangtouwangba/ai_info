...
微软与OpenAI的合作关系近期出现微妙变化。据《华尔街日报》报道，双方在算力资源分配、模型授权和AGI发展方向上存在分歧。微软正减少对OpenAI的依赖，通过自研AI模型和收购Inflection团队加强独立研发能力。尽管双方仍保持每周例会联系，但较此前密切沟通已明显降温。奥特曼与纳德拉最新互动被外界视为对合作关系的公关回应，实际合作已呈现"渐行渐远"态势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T03:17:22Z
- **目录日期**: 2025-05-03
