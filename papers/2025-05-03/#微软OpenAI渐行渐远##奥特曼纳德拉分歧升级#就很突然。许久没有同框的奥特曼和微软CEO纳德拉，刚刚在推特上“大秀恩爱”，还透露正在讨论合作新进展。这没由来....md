...
微软与OpenAI的合作关系近期出现微妙变化，主要分歧集中在三方面：1）算力资源分配与模型授权问题，微软称已提供极限支持但OpenAI要求更多；2）AGI发展理念差异，奥特曼保持乐观而微软态度趋于保守；3）内部竞争加剧，微软收购Inflection团队自研大模型。尽管双方仍维持每周例会，但联系频率较巅峰时期（每日多条短信）明显下降。外媒报道显示，这对曾经的黄金搭档正逐渐走向战略独立。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T09:04:06Z
- **目录日期**: 2025-05-03
