...
微软与OpenAI的合作关系出现微妙变化，主要分歧集中在三方面：1)算力资源分配和模型授权问题；2)对AGI发展方向的判断差异；3)微软自研AI形成内部竞争。据《华尔街日报》报道，双方高层联系频率从每天多条短信降至每周例会，微软正通过收购和自研减少对OpenAI的依赖。尽管公开场合仍展示合作，但各自战略调整表明两家公司正在渐行渐远。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T14:04:12Z
- **目录日期**: 2025-05-03
