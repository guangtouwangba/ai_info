...
微软与OpenAI的合作关系近期出现微妙变化。据《华尔街日报》报道，双方在算力资源分配、模型授权和AGI发展方向上存在分歧。微软正减少对OpenAI的依赖，自研AI模型并收购Inflection团队开发对标GPT-4的产品。尽管双方仍维持合作，但联系频率从CEO每日多条短信降至每周例会。OpenAI面临人才流失，微软则主推Copilot并对AGI进展持保留态度。这些动向显示两家公司正逐渐走向不同的技术发展路径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T23:03:33Z
- **目录日期**: 2025-05-03
