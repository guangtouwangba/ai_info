...
微软与OpenAI的合作关系出现裂痕，主要体现在三方面：1）算力分配与模型授权存在分歧，微软正自研AI减少依赖；2）AGI发展理念不合，OpenAI人事动荡而微软主推Copilot；3）微软收购Inflection团队独立研发LLM，形成内部竞争。据《华尔街日报》透露，双方CEO联系频率从每日多条短信降至每周例会，虽公开维持合作，但渐行渐远态势明显。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T04:02:48Z
- **目录日期**: 2025-05-03
