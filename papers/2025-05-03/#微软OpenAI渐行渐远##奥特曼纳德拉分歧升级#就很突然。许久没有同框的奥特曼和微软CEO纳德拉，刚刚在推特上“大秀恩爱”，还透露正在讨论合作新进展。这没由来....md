...
微软与OpenAI的合作关系出现裂痕，主要体现在三方面：1)算力分配和模型授权存在分歧，微软正自研AI减少依赖；2)对AGI发展态度不同，OpenAI人事动荡而微软主推Copilot；3)微软收购Inflection团队独立研发LLM，部分操作未告知OpenAI。双方联系频率从CEO每日多次短信降至每周例会，虽公开维持合作，但各自动作显示关系正在疏远。近期奥特曼与纳德拉的公开互动被解读为对《华尔街日报》爆料的回应。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T22:03:38Z
- **目录日期**: 2025-05-03
