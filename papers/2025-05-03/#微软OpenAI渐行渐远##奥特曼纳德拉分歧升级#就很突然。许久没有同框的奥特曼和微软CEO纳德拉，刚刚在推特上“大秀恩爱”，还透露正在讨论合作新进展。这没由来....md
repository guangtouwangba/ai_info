...
微软与OpenAI的合作关系近期出现裂痕，主要分歧集中在三方面：1)算力资源分配和模型授权问题，微软称已提供极限资源但OpenAI仍不满；2)AGI发展理念差异，OpenAI持续投入但微软转向Copilot等务实产品；3)内部竞争加剧，微软收购Inflection团队自研LLM模型。双方联系频率从每日多条短信降至每周例会，尽管公开仍维持合作，但各自独立研发的动作表明关系正在疏远。这一变化引发业界对AI领域合作格局的关注。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T19:03:47Z
- **目录日期**: 2025-05-03
