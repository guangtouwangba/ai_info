...
微软与OpenAI的合作关系出现裂痕，主要分歧集中在三个方面：1)算力资源分配和模型授权问题，微软声称已提供极限支持但OpenAI要求更多；2)AGI发展理念差异，OpenAI保持乐观而微软转向务实；3)内部竞争加剧，微软收购Inflection团队自研大模型。尽管双方公开"秀恩爱"，但《华尔街日报》披露高层沟通频率从每日多条降至每周例会，合作紧密度明显下降。微软正通过自研AI减少对OpenAI依赖，暗示科技圈这对"模范搭档"渐行渐远。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T16:04:06Z
- **目录日期**: 2025-05-03
