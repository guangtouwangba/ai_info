...
微软与OpenAI的合作关系近期出现微妙变化，主要体现在三方面：1）算力分配与模型授权存在分歧，微软正自研AI减少依赖；2）对AGI发展态度不同，OpenAI信心十足而微软持保留态度；3）微软收购Inflection团队独立研发LLM，形成内部竞争。双方联系频率从每日多条降至每周例会，尽管公开仍维持合作，但各自行动显示关系正在疏远。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T11:03:50Z
- **目录日期**: 2025-05-03
