...
微软与OpenAI的合作关系近期出现微妙变化。据《华尔街日报》报道，双方在算力资源分配、AGI发展方向和模型授权方面存在分歧。微软正减少对OpenAI的依赖，自研AI模型并收购Inflection团队开发对标GPT-4的产品。OpenAI则面临技术人才流失问题。尽管双方仍维持合作，但微软CEO纳德拉与奥特曼的沟通频率已从每日多条短信降至每周例会。这些迹象表明，这对曾经的科技合作典范正在逐渐疏远。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T07:03:27Z
- **目录日期**: 2025-05-03
