...
微软与OpenAI的合作关系出现裂痕，主要分歧集中在三方面：1) 算力资源分配和模型授权问题，微软称已提供最大支持但OpenAI仍感不足；2) 对AGI发展前景判断不同，OpenAI保持乐观而微软转向务实；3) 微软收购Inflection团队自研大模型，形成内部竞争。双方联系频率从CEO每日多次短信降至每周例会，尽管公开仍展示合作，但各自行动显示关系正在疏远。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T02:29:56Z
- **目录日期**: 2025-05-03
