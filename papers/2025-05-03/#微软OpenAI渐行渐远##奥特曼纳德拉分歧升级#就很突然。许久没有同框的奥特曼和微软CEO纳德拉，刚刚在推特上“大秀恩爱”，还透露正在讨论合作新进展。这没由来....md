...
微软与OpenAI的合作关系近期出现微妙变化。据《华尔街日报》报道，双方在算力资源分配、模型授权权限和AGI发展方向上存在分歧。微软正通过自研AI模型和收购Inflection团队减少对OpenAI的依赖，而OpenAI面临人才流失问题。尽管双方仍维持每周例会，但联系频率已从CEO间每日多条短信降至例行沟通。这些动向表明，这对曾亲密的科技合作伙伴正在逐渐拉开距离，各自探索独立发展路径。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T00:03:01Z
- **目录日期**: 2025-05-03
