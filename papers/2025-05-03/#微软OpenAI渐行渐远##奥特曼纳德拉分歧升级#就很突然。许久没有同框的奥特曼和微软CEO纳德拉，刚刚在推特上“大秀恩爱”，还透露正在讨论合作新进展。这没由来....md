...
微软与OpenAI的合作关系近期出现裂痕，主要分歧集中在三个方面：1) 算力资源分配和模型授权问题，微软声称已提供极限支持但OpenAI仍感不足；2) 对AGI发展前景判断不同，OpenAI信心十足而微软态度保守；3) 内部竞争加剧，微软收购Inflection团队自研LLM模型，部分操作未告知OpenAI。据《华尔街日报》报道，双方高层联系频率从每天多条短信降至每周例会，尽管公开仍维持合作，但各自动作已显露渐行渐远趋势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T06:03:22Z
- **目录日期**: 2025-05-03
