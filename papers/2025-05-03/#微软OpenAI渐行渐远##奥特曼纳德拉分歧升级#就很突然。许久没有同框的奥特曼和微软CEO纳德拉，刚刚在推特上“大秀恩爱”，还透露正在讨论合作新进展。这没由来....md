...
微软与OpenAI的合作关系近期出现微妙变化。据《华尔街日报》报道，双方在算力资源分配、模型授权和AGI发展方向上存在分歧。微软正减少对OpenAI的依赖，自研AI模型并收购Inflection团队；而OpenAI面临人才流失问题。虽然双方仍保持每周例会，但联系频率已从CEO间每日多条短信降至当前水平。尽管公开场合仍展示合作，各自战略调整表明联盟关系正在松动。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T13:09:04Z
- **目录日期**: 2025-05-03
