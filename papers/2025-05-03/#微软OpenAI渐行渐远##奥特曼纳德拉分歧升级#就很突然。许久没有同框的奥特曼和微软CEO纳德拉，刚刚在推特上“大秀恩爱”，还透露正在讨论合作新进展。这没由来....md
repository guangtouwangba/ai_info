...
微软与OpenAI的合作关系近期出现微妙变化。据《华尔街日报》报道，双方在算力资源分配、模型授权和AGI发展方向上存在分歧。微软正减少对OpenAI的依赖，自研AI模型并收购Inflection团队开发对标GPT-4的产品。OpenAI则面临人才流失等问题。尽管双方仍保持每周例会，但联系频率已从CEO间每日多条短信降至最低限度。奥特曼与纳德拉最新互动被解读为对合作关系的公关回应，实际合作深度可能正在减弱。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T01:30:09Z
- **目录日期**: 2025-05-03
