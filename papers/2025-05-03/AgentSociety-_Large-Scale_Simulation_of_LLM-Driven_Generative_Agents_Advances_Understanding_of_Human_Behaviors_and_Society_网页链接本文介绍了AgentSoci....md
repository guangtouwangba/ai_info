...
这篇论文介绍了AgentSociety，这是一个基于大型语言模型的大规模社会模拟器，能够模拟超过1万个代理的社会互动（共500万次）。研究者用它来探索四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据吻合，表明该系统能有效捕捉人类行为机制。该工具为社会科学研究和政策制定提供了新方法，有望成为传统研究方法（如调查和实验）的有力补充。研究展示了AI模拟在理解复杂社会现象方面的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T07:05:05Z
- **目录日期**: 2025-05-03
