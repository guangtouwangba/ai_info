...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟10,000+个AI代理及其500万次社会互动。该系统通过四个社会实验（社会极化、信息传播、基本收入政策、自然灾害影响）验证了其有效性，结果与现实世界数据高度吻合。研究表明，这种LLM驱动的模拟器能有效捕捉人类行为机制，为社会科学研究和政策制定提供了新工具，可辅助传统研究方法（如调查、访谈）来探索社会问题的成因和解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T12:05:23Z
- **目录日期**: 2025-05-03
