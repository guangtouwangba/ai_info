...
AgentSociety是一个基于大型语言模型的大规模社会模拟系统，能够模拟超过1万个智能代理及其500万次社会互动。该系统被用于研究极化现象、信息传播、基本收入政策影响和自然灾害应对等社会问题。研究显示，模拟结果与现实世界数据高度吻合，验证了该系统在捕捉人类行为机制方面的有效性。AgentSociety为社会科学研究和政策制定提供了新型实验平台，能够辅助传统研究方法，帮助理解社会问题的成因和潜在解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T15:05:14Z
- **目录日期**: 2025-05-03
