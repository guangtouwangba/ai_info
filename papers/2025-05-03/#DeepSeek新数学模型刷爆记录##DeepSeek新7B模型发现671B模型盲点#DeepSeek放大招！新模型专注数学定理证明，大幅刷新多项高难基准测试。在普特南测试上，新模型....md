...
DeepSeek发布新数学模型DeepSeek-Prover-V2，在普特南测试中取得49道题的突破性成绩，远超当前最佳模型（10道）。值得注意的是，7B参数的小模型通过强化学习发现了671B大模型未掌握的数学推理技能，成功解决了13个大模型未能处理的问题，尤其在有限基数问题上展现出独特推理模式。该模型基于V1.5-Base微调后通过强化学习训练而成，展现了"小模型发现大模型盲点"的反常现象。论文还揭示了模型通过强化学习自主获得新能力的特点。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T05:03:49Z
- **目录日期**: 2025-05-03
