...
DeepSeek推出的新数学模型DeepSeek-Prover-V2在数学定理证明领域取得突破，刷新多项高难度基准测试记录。在普特南测试中，该模型解决了49道题，远超当前第一名（10道）。值得注意的是，参数量仅7B的版本通过强化学习发现了671B大模型未掌握的技能，成功解决了13道大模型无法处理的问题，尤其在有限基数问题上展现出独特推理模式。这表明小模型通过特定训练可以超越大模型的能力范围。该成果展示了AI在数学推理领域的潜力，并揭示了模型规模并非决定性能的唯一因素。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T00:03:17Z
- **目录日期**: 2025-05-03
