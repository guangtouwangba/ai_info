...
DeepSeek推出新数学模型DeepSeek-Prover-V2，在普特南测试中刷新纪录，解答了49道题，远超此前Kimi-Prover的10道题记录。值得注意的是，7B参数的小模型通过强化学习发现了671B大模型未掌握的解题技能，在有限基数问题上采用了独特推理方法，解决了13个大模型未能攻克的题目。该模型基于DeepSeek-Prover-V1.5-Base微调，并通过强化学习训练，展现了小模型自主发展新能力的特点。这一突破展示了AI在数学推理领域的潜力，为未来模型优化提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T06:03:41Z
- **目录日期**: 2025-05-03
