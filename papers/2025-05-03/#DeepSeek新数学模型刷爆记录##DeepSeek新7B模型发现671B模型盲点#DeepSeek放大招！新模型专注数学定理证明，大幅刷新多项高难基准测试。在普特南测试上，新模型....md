...
DeepSeek发布的新数学模型DeepSeek-Prover-V2在数学定理证明领域取得突破，在普特南测试中以49道题的解答刷新记录，远超此前Kimi-Prover的10道。特别值得注意的是，7B参数的小模型通过强化学习发现了671B大模型未能掌握的解题技能，在有限基数问题上展现出独特推理模式。这一现象表明小模型通过特定训练可以超越大模型的能力范围。该研究展示了强化学习在数学推理中的潜力，为AI数学能力发展提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T04:03:04Z
- **目录日期**: 2025-05-03
