...
DeepSeek发布新数学模型DeepSeek-Prover-V2，在普特南数学测试中表现突出，以49道题刷新纪录，远超当前第一名（10道）。值得注意的是，7B参数的小模型通过强化学习发现了671B大模型的盲点，解决了后者未能处理的13个问题，尤其在有限基数问题上展现出独特推理模式。该模型基于V1.5-Base微调后通过强化学习训练，意外获得大模型不具备的新技能。这一突破展示了小模型在特定领域的潜力，同时为未发布的R2版本带来更高期待。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T01:30:27Z
- **目录日期**: 2025-05-03
