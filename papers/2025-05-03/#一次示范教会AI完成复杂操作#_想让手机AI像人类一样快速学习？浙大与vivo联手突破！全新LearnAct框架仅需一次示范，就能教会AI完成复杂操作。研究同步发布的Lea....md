...
浙江大学与vivo合作开发了LearnAct框架，仅需一次示范即可教会AI完成复杂操作。该研究同时发布了LearnGUI基准，首次构建了移动端示范学习的评估体系，为AI智能体的实用化部署提供关键技术。研究团队来自浙江大学和vivo AI Lab，由硕士生刘广义、赵鹏翔（共同一作）和vivo算法专家刘亮主导，浙大孟文超研究员担任通讯作者。该技术突破使手机AI能像人类一样快速学习复杂任务。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T04:03:20Z
- **目录日期**: 2025-05-03
