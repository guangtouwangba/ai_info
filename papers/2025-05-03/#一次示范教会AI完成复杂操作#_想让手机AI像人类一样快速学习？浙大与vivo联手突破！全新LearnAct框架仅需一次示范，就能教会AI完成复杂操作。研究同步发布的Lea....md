# #一次示范教会AI完成复杂操作# 想让手机AI像人类一样快速学习？浙大与vivo联手突破！全新LearnAct框架仅需一次示范，就能教会AI完成复杂操作。研究同步发布的Lea...
...
浙江大学与vivo AI lab合作研发了LearnAct框架，该技术通过单次示范即可教会AI完成复杂操作，显著提升移动端AI学习效率。研究团队同步发布了LearnGUI基准测试体系，首次构建了面向移动设备示范学习的评估标准。该成果由浙大硕士生刘广义、赵鹏翔（共同一作）与vivo算法专家刘亮主导，浙大孟文超研究员担任通讯作者，为大语言模型驱动的GUI智能体技术提供了实用化部署方案，标志着手机AI"一次学习终身掌握"能力的重要突破。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T06:03:59Z
- **目录日期**: 2025-05-03
