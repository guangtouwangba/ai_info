...
华中大与北邮团队联合推出多模态大模型Perception-R1(PR1)，首次在纯多模态开源LLM中突破30AP性能指标，超越YOLOv3、Faster-RCNN等经典模型。该模型通过基于规则的强化学习优化视觉感知能力，在COCO2017验证集上表现出色，在物体检测、OCR和计数等任务中优于专用模型。实验显示PR1在visual grounding、OCR和Pixmo-Count任务中具有卓越性能，展现了强大的可扩展性。这一突破为AI视觉感知发展奠定基础，推动了多模态模型理解视觉信息的边界。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T18:02:48Z
- **目录日期**: 2025-05-03
