...
华中大与北邮团队推出多模态开源大模型Perception-R1（PR1），首次突破30AP性能指标，在COCO2017验证集上超越YOLOv3和Faster-RCNN等经典模型。该模型采用基于规则的强化学习优化视觉感知能力，在物体检测、OCR和计数任务中表现优异。实验显示，PR1在视觉定位、OCR和Pixmo-Count等任务中超越专用模型，展现出强大的可扩展性。这一突破为AI视觉感知发展奠定基础，推动了多模态模型理解视觉信息的边界。研究成果已开源，助力AI视觉技术进一步发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T22:02:26Z
- **目录日期**: 2025-05-03
