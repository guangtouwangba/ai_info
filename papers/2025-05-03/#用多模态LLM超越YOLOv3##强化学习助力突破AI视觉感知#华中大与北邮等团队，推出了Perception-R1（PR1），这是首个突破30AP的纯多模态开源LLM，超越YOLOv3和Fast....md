...
华中大与北邮团队联合推出多模态大模型Perception-R1（PR1），首次在纯多模态开源LLM中突破30AP性能指标，超越YOLOv3和Faster-RCNN等经典视觉模型。PR1采用基于规则的强化学习优化视觉感知能力，在COCO2017验证集上展现出卓越的物体检测、OCR和计数性能。实验表明，该模型在视觉定位、OCR等任务中优于专用模型，具有出色的可扩展性。这一突破为AI视觉感知领域树立了新基准，推动了多模态模型理解视觉信息的能力边界。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T11:02:34Z
- **目录日期**: 2025-05-03
