...
华中大与北邮团队推出多模态大模型PR1，首个纯多模态开源LLM突破30AP，在COCO2017数据集上超越YOLOv3和Faster-RCNN。通过基于规则的强化学习优化视觉感知，PR1在物体检测、OCR和计数任务中表现优异，超越专用模型。实验显示其在visual grounding、OCR和Pixmo-Count等任务中具有出色扩展性，为AI视觉感知发展奠定基础，推动模型理解视觉信息的极限。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T14:02:46Z
- **目录日期**: 2025-05-03
