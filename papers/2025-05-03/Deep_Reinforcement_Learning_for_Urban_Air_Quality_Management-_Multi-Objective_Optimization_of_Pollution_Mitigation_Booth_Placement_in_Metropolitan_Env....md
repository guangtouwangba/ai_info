...
德里是全球污染最严重的城市之一，主要受交通排放、工业活动和建筑扬尘影响。传统静态空气净化装置因位置不佳和适应性差而效果有限。本研究提出一种深度强化学习（DRL）框架，利用近端策略优化（PPO）算法，基于人口密度、交通模式、工业影响和绿地限制等因素，优化空气净化亭的布局。相比随机和贪婪AQI基准方法，DRL方法在多维评估指标（如AQI改善、空间覆盖和人口/交通影响）上表现更优，实现了净化设施的高效均衡分布，在降低AQI与广泛覆盖间取得最佳平衡，为智慧城市和空气质量管理提供了AI驱动的优化方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T23:01:18Z
- **目录日期**: 2025-05-03
