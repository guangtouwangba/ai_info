...
德里是全球污染最严重的城市之一，主要受交通排放、工业活动和建筑扬尘影响。传统静态空气净化装置因位置不佳和适应性不足效果有限。本研究提出一种深度强化学习（DRL）框架，利用近端策略优化（PPO）算法，基于人口密度、交通模式等动态优化空气净化亭的布局。相比随机和贪婪基线方法，DRL方案在AQI改善、空间覆盖和公平性等指标上表现更优，实现了净化效率与覆盖范围的平衡。结果表明，AI驱动的空间优化可提升智慧城市的空气质量管理能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T16:01:33Z
- **目录日期**: 2025-05-03
