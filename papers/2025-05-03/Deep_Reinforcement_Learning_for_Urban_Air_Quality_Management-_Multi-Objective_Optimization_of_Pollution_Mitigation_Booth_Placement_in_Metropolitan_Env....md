...
德里是全球污染最严重的城市之一，主要受交通排放、工业活动和建筑扬尘影响。传统静态空气净化装置因布局不合理和适应性差而效果有限。本研究提出一种深度强化学习（DRL）框架，采用近端策略优化（PPO）算法，基于人口密度、交通模式等动态因素优化空气净化亭的布局。相比随机和贪婪基准方法，DRL方法在多维评估指标（如AQI改善、空间覆盖率）上表现更优，实现了净化设施的高效均衡分布，在AQI降低与覆盖范围间取得最佳平衡。该研究凸显了人工智能在智慧城市空气质量管理的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T11:01:21Z
- **目录日期**: 2025-05-03
