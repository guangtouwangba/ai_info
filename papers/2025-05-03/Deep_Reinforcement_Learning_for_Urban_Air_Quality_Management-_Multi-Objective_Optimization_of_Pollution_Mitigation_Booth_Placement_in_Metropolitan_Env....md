...
德里是全球空气污染最严重的城市之一，主要污染源包括交通排放、工业活动和建筑扬尘。传统静态空气净化装置因位置欠佳和适应性不足效果有限。本研究提出一种深度强化学习（DRL）框架，利用近端策略优化（PPO）算法，基于人口密度、交通模式等动态因素优化空气净化亭的布局。相比随机或基于AQI的贪婪策略，DRL方法在多维评估指标（如AQI改善、空间覆盖等）上表现更优，实现了净化效率与覆盖范围的平衡，确保城市各区域公平受益。结果表明AI驱动的空间优化能有效提升智慧城市的空气质量管理水平。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T03:15:56Z
- **目录日期**: 2025-05-03
