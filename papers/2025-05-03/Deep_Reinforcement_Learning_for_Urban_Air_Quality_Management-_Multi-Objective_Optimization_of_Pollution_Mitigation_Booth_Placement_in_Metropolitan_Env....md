...
德里是全球空气污染最严重的城市之一，主要受交通排放、工业活动和建筑扬尘影响。传统静态空气净化装置因位置不佳和适应性差而效果有限。本研究提出一种基于深度强化学习（DRL）的新框架，使用近端策略优化（PPO）算法，综合考虑人口密度、交通模式等环境因素，优化空气净化亭的布局。实验表明，该方法在改善空气质量指数（AQI）、空间覆盖率和公平性方面均优于随机和贪婪基线策略，实现了净化效果与覆盖范围的平衡。研究凸显了人工智能在智慧城市和空气质量数据驱动管理中的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T09:01:26Z
- **目录日期**: 2025-05-03
