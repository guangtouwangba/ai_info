...
这篇论文探讨了代码生成大模型(codeLLMs)与人类偏好的对齐问题。研究者创建了CodeArena基准测试(包含397个样本，覆盖40类任务和44种编程语言)和SynCode-Instruct语料库(近200亿标记)，发现传统执行基准与人类偏好评估存在差距。实验比较40多个模型显示，开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著，突显对齐人类偏好的重要性。研究强调需要超越代码正确性，关注实际编程场景中的用户体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-03T09:05:57Z
- **目录日期**: 2025-05-03
