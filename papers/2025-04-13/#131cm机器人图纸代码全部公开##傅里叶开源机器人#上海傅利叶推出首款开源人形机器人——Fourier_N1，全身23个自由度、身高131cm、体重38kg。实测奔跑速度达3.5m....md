...
上海傅利叶发布首款开源人形机器人Fourier N1，身高131cm，重38kg，具备23个自由度，可奔跑(3.5m/s)、上下楼梯、踢球等。采用自研FSA 2.0执行器和控制系统，续航超2小时。完整开源图纸、物料清单、控制代码等，支持"乐高式"搭建。公司还推出Fourier Nexus平台整合硬件、算法和数据共享，将持续更新代码推动行业生态建设。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T03:54:56Z
- **目录日期**: 2025-04-13
