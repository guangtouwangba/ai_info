...
上海傅利叶发布首款开源人形机器人Fourier N1，身高131cm，重38kg，具备23个自由度，可奔跑（3.5m/s）、上下楼梯、踢球等。采用自研FSA 2.0执行器与控制系统，提升运动精度和抗冲击性，电池续航超2小时。开源内容包括完整图纸、物料清单、装配指南及控制代码，支持"乐高式"快速搭建。傅利叶同步推出Fourier Nexus平台，整合硬件、算法与数据共享，推动行业生态共建，并承诺持续更新代码确保功能复现。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T22:03:41Z
- **目录日期**: 2025-04-13
