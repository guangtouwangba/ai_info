...
上海傅利叶推出首款开源人形机器人Fourier N1，身高131cm，重38kg，具备23个自由度，运动能力出色（3.5m/s奔跑、上下楼梯等）。采用自研FSA 2.0执行器和控制系统，提升抗冲击与精度，续航超2小时。完整开源图纸、代码及装配指南，支持"乐高式"搭建。公司同步推出Fourier Nexus平台整合硬件、算法与数据共享，将持续更新代码推动行业生态建设。（99字）  

（注：保留核心参数、技术亮点、开源特点及生态建设信息，严格压缩至100字内）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T03:00:36Z
- **目录日期**: 2025-04-13
