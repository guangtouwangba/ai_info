...
上海傅利叶推出开源人形机器人Fourier N1，高131cm/重38kg，具备23个自由度，运动能力出色（3.5m/s奔跑、上下楼梯等）。采用自研FSA 2.0执行器和控制系统，续航超2小时。首批开源包含完整图纸、代码及装配指南，后续将更新训练框架。通过Fourier Nexus平台推动行业生态共建，实现硬件算法数据共享。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T06:03:55Z
- **目录日期**: 2025-04-13
