...
上海傅利叶发布首款开源人形机器人Fourier N1，身高131cm，重38kg，具备23个自由度，运动能力出色（3.5m/s奔跑、上下楼梯等）。采用自研FSA 2.0执行器和控制系统，提升抗冲击与精度，2小时续航。首批开源包含完整图纸、物料清单、装配指南及控制代码，后续将更新推理代码与训练框架。公司还推出Fourier Nexus平台，整合硬件、算法与数据共享，推动行业生态共建。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T19:03:26Z
- **目录日期**: 2025-04-13
