...
AgentSociety是一个基于大语言模型的大规模社会模拟器，能模拟1万多个AI代理的社会互动（500万次）。研究者用它分析四个关键社会问题：社会极化、刺激性信息传播、基本收入政策影响和自然灾害（如飓风）的社会效应。模拟结果与现实数据吻合，验证了该系统捕捉人类行为机制的能力。这表明AgentSociety可作为计算社会科学的新工具，辅助传统研究方法（如调查、实验），帮助学者和政策制定者理解复杂社会现象的成因与模式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T05:11:16Z
- **目录日期**: 2025-04-13
