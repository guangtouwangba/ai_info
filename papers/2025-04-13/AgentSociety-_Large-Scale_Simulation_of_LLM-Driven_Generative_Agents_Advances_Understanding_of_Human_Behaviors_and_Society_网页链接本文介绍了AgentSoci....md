...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能模拟1万多个智能代理的社会互动（500万次交互）。研究者用它研究了四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，证明该系统能有效捕捉人类行为机制。这一工具为社会科学研究和政策制定提供了新方法，可辅助传统调查和实验方法，帮助理解复杂社会现象背后的模式和原因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T07:05:09Z
- **目录日期**: 2025-04-13
