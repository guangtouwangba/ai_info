...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟10,000+智能代理的社交行为及500万次互动。研究团队利用该平台进行了四项社会实验：群体极化、信息传播、基本收入政策效果和自然灾害影响。结果显示模拟结果与现实数据高度吻合，验证了该系统在揭示人类行为机制和社会问题成因方面的有效性。该系统可作为传统社会科学研究方法的补充工具，为研究者和政策制定者提供新的分析视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T11:05:08Z
- **目录日期**: 2025-04-13
