...
本文介绍AgentSociety，这是一个基于大语言模型的大规模社会模拟器，包含1万多个代理和500万次互动。研究者用它模拟了四个关键社会问题：社会极化、信息传播、基本收入政策和自然灾害影响。结果显示其模拟结果与现实数据吻合，验证了该系统捕捉人类行为机制的能力。该平台可作为计算社会科学实验工具，帮助研究社会问题成因并辅助政策制定，展现了LLM在社会模拟研究中的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T23:04:54Z
- **目录日期**: 2025-04-13
