...
AgentSociety是一个基于大语言模型的大规模社会模拟器，包含1万多个AI代理和500万次互动。它通过模拟真实社会环境，研究了四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害冲击。研究结果与现实世界数据吻合，验证了该平台在揭示人类行为机制方面的有效性。这一工具为社会科学研究和政策制定提供了新方法，能够补充传统调查和实验的不足。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T03:02:16Z
- **目录日期**: 2025-04-13
