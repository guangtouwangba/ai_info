...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理及其500万次社会互动。研究者用它研究了四个社会问题：群体极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实数据吻合，验证了该系统捕捉人类行为机制的能力。这表明AgentSociety能有效辅助传统社会科学研究方法，帮助分析社会问题的模式和成因，为研究者和政策制定者提供重要工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T08:05:05Z
- **目录日期**: 2025-04-13
