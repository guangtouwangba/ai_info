...
清华大学和面壁智能提出CFM（可配置基础模型）技术，通过神经元级稀疏激活实现手机端高效运行GPT级模型。相比MoE（专家混合）需固定激活专家数量，CFM根据任务难度动态激活神经元，既节省内存又保持性能。该技术尤其适合前馈神经网络层，支持灵活组合模型模块，适用于手机、笔记本等端侧设备。CFM利用模型天然稀疏性，无需负载平衡，全参数参与运算，在资源受限场景下展现出显著优势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T05:09:35Z
- **目录日期**: 2025-04-13
