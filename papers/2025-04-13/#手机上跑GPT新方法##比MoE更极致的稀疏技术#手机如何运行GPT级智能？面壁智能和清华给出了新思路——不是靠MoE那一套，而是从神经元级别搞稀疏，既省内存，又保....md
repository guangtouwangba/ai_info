...
清华大学与面壁智能提出CFM（可配置基础模型）技术，通过神经元级稀疏激活实现手机端高效运行GPT级模型。相比MoE（专家混合）固定激活专家数量的方式，CFM根据任务复杂度动态调整激活神经元数量，既节省内存又保持性能。该技术特别适合FFN层，支持模块化组合，在手机、笔记本等端侧设备上具有显著优势，无需负载平衡即可实现全参数参与运算，为移动端AI部署提供新思路。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T19:03:01Z
- **目录日期**: 2025-04-13
