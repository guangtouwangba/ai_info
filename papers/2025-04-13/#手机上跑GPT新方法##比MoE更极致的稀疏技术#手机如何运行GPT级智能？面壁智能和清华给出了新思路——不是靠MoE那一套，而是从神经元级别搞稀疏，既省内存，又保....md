...
面壁智能与清华团队提出CFM技术，通过神经元级稀疏激活实现在手机等终端设备上高效运行GPT级模型。相比MoE固定激活专家数量的方式，CFM根据任务难度动态调整激活神经元数量，既节省内存又保持性能。该技术特别适合FFN层，支持模块化组合，在手机、笔记本等端侧场景具有优势。CFM无需负载平衡机制，允许全参数参与运算，比MoE更灵活高效。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T18:01:56Z
- **目录日期**: 2025-04-13
