...
面壁智能与清华团队提出CFM技术，通过神经元级稀疏激活实现手机端高效运行GPT级模型。相比MoE强制限制激活专家数量，CFM能根据任务难度动态调整激活神经元数量，既节省内存又保持性能。该技术尤其适合FFN层，支持模块化组合，在手机、笔记本等端侧设备上具有应用优势，无需负载平衡即可实现全参数参与运算，比MoE更灵活高效。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T14:03:35Z
- **目录日期**: 2025-04-13
