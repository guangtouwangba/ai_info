...
面壁智能与清华团队提出CFM（可配置基础模型）技术，通过神经元级稀疏激活实现在手机等终端设备运行GPT级模型。相比MoE（专家混合）需固定激活专家数量，CFM根据任务复杂度动态激活神经元，既节省内存又保持性能。该技术特别适用于FFN层，支持模块化组合，在手机、笔记本等端侧场景具有显著优势，无需负载平衡即可实现全参数参与运算，比MoE更高效灵活。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T04:29:43Z
- **目录日期**: 2025-04-13
