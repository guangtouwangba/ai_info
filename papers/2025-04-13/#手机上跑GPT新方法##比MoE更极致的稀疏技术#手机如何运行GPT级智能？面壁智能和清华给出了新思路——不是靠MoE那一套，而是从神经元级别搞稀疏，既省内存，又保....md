...
面壁智能与清华团队提出CFM技术，可在手机等设备上高效运行GPT级模型。该技术通过神经元级稀疏激活实现：根据任务难度动态激活神经元（任务难时多激活，简单时少激活），相比MoE技术更灵活高效。CFM无需限制激活专家数量，允许全参数参与运算，在FFN层效果显著，尤其适合手机、笔记本等端侧设备。该技术还能模块化组合模型，实现任务导向建模，在保证性能的同时大幅节省内存。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T03:00:08Z
- **目录日期**: 2025-04-13
