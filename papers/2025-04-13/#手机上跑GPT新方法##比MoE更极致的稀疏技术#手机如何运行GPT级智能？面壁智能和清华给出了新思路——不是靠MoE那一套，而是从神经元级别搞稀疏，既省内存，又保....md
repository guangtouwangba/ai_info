...
面壁智能与清华大学提出CFM（可配置基础模型）技术，通过神经元级稀疏化实现在手机等终端设备运行GPT级模型。相比MoE技术需要限制激活专家数量，CFM利用模型天然的稀疏特性，根据任务难度动态激活神经元，既节省内存又保持性能。该技术特别适合FFN层，支持模块化组合，为手机、笔记本等端侧设备提供高效AI解决方案，无需复杂负载平衡即可实现全参数参与运算。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T22:03:17Z
- **目录日期**: 2025-04-13
