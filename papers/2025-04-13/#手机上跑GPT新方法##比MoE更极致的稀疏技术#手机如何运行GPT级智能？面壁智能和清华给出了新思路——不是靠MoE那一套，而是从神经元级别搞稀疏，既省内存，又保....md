...
面壁智能与清华团队提出CFM技术（可配置基础模型），通过神经元级稀疏化实现在手机等终端设备运行GPT级模型。该技术利用模型天然的稀疏激活特性，根据任务复杂度动态调整激活神经元数量，相比MoE技术无需限制激活专家数量，保持全参数运算的同时节省内存。CFM支持模块化组合，特别适合FFN层优化，为手机、笔记本等端侧设备提供高效AI解决方案，在保证性能前提下显著降低计算资源消耗。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T09:03:42Z
- **目录日期**: 2025-04-13
