...
面壁智能与清华团队提出CFM技术，通过神经元级稀疏激活实现手机端运行GPT级模型。相比MoE固定激活专家数量的方式，CFM根据任务难度动态调整激活神经元数量，既节省内存又保持性能。该技术特别适合FFN层，在手机、笔记本等终端设备上具有优势。CFM还支持模块化组合，实现更灵活的任务导向建模。这种全参数参与、无需负载平衡的设计，比MoE更高效地解决了大模型在端侧部署的挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T17:03:30Z
- **目录日期**: 2025-04-13
