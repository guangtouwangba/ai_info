...
面壁智能与清华团队提出CFM（可配置基础模型）技术，通过神经元级稀疏激活实现手机端高效运行GPT级模型。相比MoE的固定专家激活机制，CFM根据任务复杂度动态调整激活神经元数量，既节省内存又保持性能。该技术尤其适合FFN层，支持模块化组合，在手机、笔记本等终端设备上具有应用优势，无需MoE的负载平衡约束，实现全参数灵活运算。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T01:49:10Z
- **目录日期**: 2025-04-13
