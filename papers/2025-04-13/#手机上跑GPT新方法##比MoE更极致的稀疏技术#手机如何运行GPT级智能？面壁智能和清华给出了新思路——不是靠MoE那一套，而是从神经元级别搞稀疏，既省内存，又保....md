...
清华大学与面壁智能提出CFM（可配置基础模型）技术，通过神经元级稀疏化实现在手机等终端设备运行GPT级模型。相比MoE（混合专家）固定激活专家数量的方式，CFM根据任务复杂度动态激活神经元，既节省内存又保持性能。该技术特别适合前馈神经网络层，支持模块化组合，在手机、笔记本等端侧设备上具有显著优势，无需MoE的负载平衡机制，实现更高效的资源利用和任务导向建模。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T20:03:13Z
- **目录日期**: 2025-04-13
