...
面壁智能与清华团队提出CFM技术，通过神经元级稀疏激活实现在手机等端侧设备运行GPT级模型。相比MoE固定激活专家数量的方式，CFM根据任务难度动态调整激活神经元数量，既节省内存又保持性能。该技术允许全量参数参与运算，无需负载平衡，且在FFN层效果显著。CFM支持模块化组合，提升任务建模效率，特别适合手机、笔记本等资源受限场景。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T08:03:24Z
- **目录日期**: 2025-04-13
