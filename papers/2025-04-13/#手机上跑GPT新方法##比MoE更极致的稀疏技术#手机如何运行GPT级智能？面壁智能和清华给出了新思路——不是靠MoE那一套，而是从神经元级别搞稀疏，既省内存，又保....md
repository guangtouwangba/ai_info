...
面壁智能与清华团队提出CFM技术，通过神经元级稀疏激活实现在手机上运行GPT级模型。相比MoE固定激活专家数量的方式，CFM根据任务难度动态调整激活神经元数量，既节省内存又保持性能。该技术特别适合移动设备，能灵活组合模型模块，在FFN层效果显著。CFM无需负载平衡，允许全参数参与运算，为手机、笔记本等端侧设备提供高效AI解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T11:03:30Z
- **目录日期**: 2025-04-13
