...
面壁智能与清华团队提出CFM技术，通过神经元级稀疏激活实现手机端运行GPT级模型。相比MoE强制限制激活专家数量，CFM根据任务难度动态调整激活神经元数量，既节省内存又保持性能。该技术允许全量参数参与运算，无需负载平衡，并在FFN层表现突出，适合手机、笔记本等端侧设备。CFM还支持模块化组合，实现任务导向的灵活建模，为轻量化大模型部署提供新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T13:08:21Z
- **目录日期**: 2025-04-13
