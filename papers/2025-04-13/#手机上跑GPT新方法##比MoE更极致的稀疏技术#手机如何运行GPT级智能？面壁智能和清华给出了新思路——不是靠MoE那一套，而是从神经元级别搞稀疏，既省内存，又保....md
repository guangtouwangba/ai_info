...
面壁智能与清华团队提出CFM（可配置基础模型）技术，通过神经元级稀疏激活实现手机端高效运行GPT级模型。相比MoE固定激活专家数量的方式，CFM根据任务难度动态调整激活神经元数量，在保证性能的同时降低计算负载。该技术特别适合FFN层，支持模块化组合，为手机、笔记本等终端设备提供更灵活的AI部署方案，兼具内存效率和计算效能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T23:03:30Z
- **目录日期**: 2025-04-13
