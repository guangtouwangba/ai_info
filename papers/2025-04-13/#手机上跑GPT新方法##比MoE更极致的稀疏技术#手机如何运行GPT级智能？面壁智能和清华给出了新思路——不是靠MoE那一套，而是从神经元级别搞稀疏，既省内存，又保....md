...
面壁智能与清华团队提出CFM（可配置基础模型）技术，通过在神经元级别实现动态稀疏激活，使GPT级模型能在手机等终端设备高效运行。相比MoE（专家混合）固定激活专家数量的限制，CFM根据任务复杂度自适应激活神经元：复杂任务激活更多，简单任务减少计算。该技术尤其优化了FFN层，支持模块化组合，兼顾性能与能效，适合移动端部署。研究显示CFM无需负载平衡机制即可实现全参数参与运算，比MoE更灵活省资源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T16:03:31Z
- **目录日期**: 2025-04-13
