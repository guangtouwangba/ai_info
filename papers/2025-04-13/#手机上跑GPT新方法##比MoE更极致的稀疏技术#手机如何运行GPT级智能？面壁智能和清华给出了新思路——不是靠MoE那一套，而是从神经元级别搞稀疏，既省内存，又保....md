...
面壁智能与清华团队提出CFM技术，可在手机等终端设备上高效运行GPT级模型。该技术通过神经元级稀疏激活（而非MoE的专家路由机制），根据任务复杂度动态调整激活神经元数量，既节省内存又保持性能。CFM允许全量参数参与运算，无需MoE的负载平衡限制，且在FFN层表现突出。其模块化设计支持灵活组合模型组件，特别适合手机、笔记本等端侧场景，实现任务导向的高效建模。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T06:03:31Z
- **目录日期**: 2025-04-13
