...
面壁智能与清华大学提出CFM（可配置基础模型）技术，通过神经元级稀疏激活实现手机端高效运行GPT级模型。相比MoE（专家混合）强制限制激活专家数量，CFM根据任务难度动态激活神经元，既降低内存占用又保持性能。该技术特别适合FFN层，支持模块化组合，在手机、笔记本等终端设备上具有显著优势。其天然稀疏特性避免了MoE的负载平衡问题，实现全参数参与的高效计算。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T03:54:31Z
- **目录日期**: 2025-04-13
