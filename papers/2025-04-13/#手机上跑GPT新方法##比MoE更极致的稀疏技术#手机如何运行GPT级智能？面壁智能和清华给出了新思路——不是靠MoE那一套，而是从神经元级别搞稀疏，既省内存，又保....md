...
清华大学与面壁智能提出CFM（可配置基础模型）技术，通过神经元级稀疏激活实现手机端高效运行GPT级模型。相比MoE固定专家数量的方式，CFM根据任务复杂度动态激活神经元（FFN层效果显著），既节省内存又保持性能。该技术支持模块化组合，适配手机/笔记本等端侧设备，无需负载均衡设计，全参数参与运算。研究显示这种天然稀疏性比MoE更适合资源受限场景。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T00:26:37Z
- **目录日期**: 2025-04-13
