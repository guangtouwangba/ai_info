...
该论文研究代码生成大模型(codeLLMs)与人类偏好的对齐问题，提出了CodeArena基准测试(包含397个高质量样本，覆盖40类编程任务和44种语言)和SynCode-Instruct合成指令数据集(近200亿标记)。研究发现：1)传统基于执行的评估与人类偏好存在差异；2)开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究强调了代码生成模型除正确性外，还需关注人类偏好对齐的重要性。论文通过构建新基准和数据集，为评估代码LLMs提供了更全面的框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T03:02:58Z
- **目录日期**: 2025-04-13
