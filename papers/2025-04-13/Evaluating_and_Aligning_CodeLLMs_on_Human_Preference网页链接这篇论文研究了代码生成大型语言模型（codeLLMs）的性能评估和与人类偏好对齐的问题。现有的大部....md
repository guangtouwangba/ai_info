...
这篇论文探讨了代码生成大模型（codeLLMs）如何与人类偏好对齐的问题。现有基准测试多关注代码正确性，而忽略了人类偏好。为此，研究者构建了CodeArena基准测试，包含397个高质量样本，覆盖40个类别和44种编程语言，模拟真实编程任务。同时，创建了SynCode-Instruct语料库（近20B标记）验证大规模合成指令微调的效果。实验发现，执行基准与CodeArena存在性能差异，且开源顶级模型（如Qwen2.5-Coder）与专有模型（如OpenAI o1）差距显著，凸显了人类偏好对齐的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T08:05:45Z
- **目录日期**: 2025-04-13
