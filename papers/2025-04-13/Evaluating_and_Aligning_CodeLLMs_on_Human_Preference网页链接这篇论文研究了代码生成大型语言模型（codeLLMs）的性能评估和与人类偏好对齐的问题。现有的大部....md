...
该研究针对代码生成大模型(codeLLMs)提出CodeArena基准测试，从397个真实编程任务样本(覆盖40类/44种语言)评估模型与人类偏好的对齐程度，并构建20B标记的SynCode-Instruct合成指令集验证微调效果。实验发现：1)传统执行基准与人类偏好存在差异；2)开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，凸显对齐人类偏好的重要性。研究强调需超越代码正确性，关注实际开发场景中的用户体验需求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T22:05:31Z
- **目录日期**: 2025-04-13
