...
这篇论文针对代码生成大模型(codeLLMs)的评估与人类偏好对齐问题展开研究。作者创建了CodeArena基准测试(包含397个高质量样本，覆盖40类任务和44种编程语言)来评估模型在真实编程场景中的表现，同时构建了20B标记的SynCode-Instruct合成指令数据集。研究发现：1)传统基于执行的测试与人类偏好存在偏差；2)开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究强调了代码LLMs与人类偏好对齐的重要性，为相关研究提供了新评估框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T11:05:45Z
- **目录日期**: 2025-04-13
