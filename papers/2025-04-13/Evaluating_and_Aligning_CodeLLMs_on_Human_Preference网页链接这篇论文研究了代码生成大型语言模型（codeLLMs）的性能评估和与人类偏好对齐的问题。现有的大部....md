...
这篇论文针对代码生成大模型(codeLLMs)提出两个关键贡献：1) 创建CodeArena基准测试，包含397个高质量编程任务(覆盖40类/44种语言)，首次系统评估模型输出与人类偏好的匹配度；2) 构建20B标记量的SynCode-Instruct合成指令集验证微调效果。实验发现：现有执行基准与人类偏好存在显著差异，开源顶级模型Qwen2.5-Coder与商业模型OpenAI o1性能差距明显，凸显对齐人类偏好的重要性。研究强调需超越传统正确性评估，关注代码实用性和开发者体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T18:04:01Z
- **目录日期**: 2025-04-13
