...
清华大学与VAST联合开源了自动骨骼绑定框架UniRig，旨在解决3D模型绑骨难题。该框架采用自回归模型逐关节预测骨架结构，创新引入骨骼树Tokenization技术，使处理效率提升30%，支持人形、动物、幻想生物及机械结构。UniRig还能预测蒙皮权重和骨骼物理属性（如刚性和重力影响），基于1.4万模型数据集Rig-XL训练，确保生成骨架的通用性与真实性，显著降低3D动画制作门槛。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T10:03:53Z
- **目录日期**: 2025-04-13
