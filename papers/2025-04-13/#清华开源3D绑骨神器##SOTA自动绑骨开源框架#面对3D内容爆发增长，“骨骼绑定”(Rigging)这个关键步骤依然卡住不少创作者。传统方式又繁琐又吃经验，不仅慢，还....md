...
清华大学与VAST联合推出开源自动骨骼绑定框架UniRig，可处理人形、动物、幻想生物及机械结构等多种3D模型。该技术采用自回归模型逐关节预测骨架，并通过创新的骨骼树Tokenization提升30%效率，还能预测蒙皮权重和骨骼物理属性。基于1.4万模型的大型数据集Rig-XL训练，显著简化传统繁琐的手动绑骨流程，为3D动画创作提供高效解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T21:03:37Z
- **目录日期**: 2025-04-13
