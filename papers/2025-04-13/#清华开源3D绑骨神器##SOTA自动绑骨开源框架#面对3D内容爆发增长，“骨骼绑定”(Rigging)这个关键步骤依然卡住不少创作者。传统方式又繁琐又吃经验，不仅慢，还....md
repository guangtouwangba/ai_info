...
清华大学与VAST联合开源自动骨骼绑定框架UniRig，突破传统绑骨技术瓶颈。该框架采用自回归模型逐关节预测骨架，创新性引入骨骼树Tokenization技术，处理效率提升30%，支持人形、动物、幻想生物及机械结构等多种3D模型。通过预测蒙皮权重和骨骼物理属性（如刚体/柔体特性），显著提升动画真实感。其训练基于包含1.4万模型的大型数据集Rig-XL，确保生成骨架的通用性与可靠性，为3D内容创作者提供高效自动化解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T01:49:26Z
- **目录日期**: 2025-04-13
