...
清华大学与VAST团队联合开源了3D自动骨骼绑定框架UniRig，能高效处理各类模型（包括人形、动物、幻想生物及机械结构）的骨骼绑定问题。该框架采用自回归模型逐关节预测骨架结构，并创新性地引入骨骼树Tokenization技术，使处理效率提升30%。此外，UniRig还能预测蒙皮权重和骨骼物理属性，增强动画真实感。其训练基于包含1.4万模型的大型数据集Rig-XL，确保生成骨架的通用性和稳定性，显著降低了3D创作中传统绑骨的技术门槛。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T08:03:43Z
- **目录日期**: 2025-04-13
