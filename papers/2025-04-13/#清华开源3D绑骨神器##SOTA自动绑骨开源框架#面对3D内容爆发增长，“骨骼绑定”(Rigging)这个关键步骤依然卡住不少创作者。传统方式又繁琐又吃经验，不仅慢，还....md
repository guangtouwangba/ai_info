...
清华大学与VAST联合开源了3D自动骨骼绑定框架UniRig，可高效处理各类模型（包括人形、动物、幻想生物及机械结构）。该技术采用自回归模型逐关节预测骨架，并通过创新的骨骼树Tokenization提升30%效率，同时预测蒙皮权重和骨骼物理属性。基于1.4万模型数据集Rig-XL训练，显著降低了传统绑骨的专业门槛，为3D动画创作提供SOTA级开源解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T04:30:00Z
- **目录日期**: 2025-04-13
