...
清华大学与VAST联合发布开源自动骨骼绑定框架UniRig，突破传统繁琐的3D模型骨骼绑定流程。该框架采用自回归模型逐关节预测骨架结构，创新性引入骨骼树Tokenization技术，将处理效率提升30%，支持人体、动物、幻想生物及机械结构的自动绑定。UniRig还能预测蒙皮权重和骨骼物理属性，通过1.4万模型数据集Rig-XL训练，确保生成骨架的通用性和真实动画效果。这一SOTA级解决方案显著降低了3D内容创作门槛，是3D版DeepSeek开源系列的重要成果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T11:03:49Z
- **目录日期**: 2025-04-13
