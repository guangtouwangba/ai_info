...
清华大学与VAST联合发布开源自动骨骼绑定框架UniRig，可高效处理各类3D模型（人形、动物、幻想生物、机械等）。该技术采用自回归模型逐关节预测骨架，创新性引入骨骼树Tokenization提升30%效率，并能预测蒙皮权重和骨骼物理属性（如硬度/重力影响）。基于1.4万模型数据集Rig-XL训练，显著简化传统繁琐的手动绑骨流程，为3D动画创作者提供SOTA级开源解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T12:03:47Z
- **目录日期**: 2025-04-13
