...
清华大学联合VAST团队开源了自动骨骼绑定框架UniRig，解决了3D模型绑骨（Rigging）的行业痛点。该框架采用自回归模型逐关节预测骨架结构，创新性地引入骨骼树Tokenization技术，将处理效率提升30%，支持人形、动物、幻想生物及机械等多种模型。UniRig还能预测蒙皮权重和骨骼物理属性（如刚体/柔体），提升动画真实感。其训练基于包含1.4万模型的大型数据集Rig-XL，确保生成骨架的通用性和可靠性。这一SOTA级开源工具显著降低了3D内容创作门槛。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T18:02:12Z
- **目录日期**: 2025-04-13
