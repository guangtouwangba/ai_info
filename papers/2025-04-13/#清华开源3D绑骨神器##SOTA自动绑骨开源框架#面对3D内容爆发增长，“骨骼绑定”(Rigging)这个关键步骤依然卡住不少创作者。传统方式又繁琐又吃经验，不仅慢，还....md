...
清华大学与VAST团队联合发布开源自动骨骼绑定框架UniRig，突破传统繁琐的3D模型骨骼绑定流程。该框架采用自回归模型逐关节预测骨架结构，创新性引入骨骼树Tokenization技术，使处理效率提升30%，支持人体、动物、幻想生物及机械结构等多种模型。系统还能预测蒙皮权重和骨骼物理属性，基于超1.4万模型的Rig-XL数据集训练，确保生成骨架的通用性和动画真实性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T14:03:52Z
- **目录日期**: 2025-04-13
