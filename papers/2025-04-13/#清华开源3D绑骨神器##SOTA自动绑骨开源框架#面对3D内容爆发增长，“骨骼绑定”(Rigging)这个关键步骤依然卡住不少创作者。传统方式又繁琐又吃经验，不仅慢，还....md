...
清华大学与VAST联合发布开源自动骨骼绑定框架UniRig，显著提升3D模型绑骨效率。该框架采用自回归模型逐关节预测骨架结构，并创新引入骨骼树Tokenization技术，使处理效率提升30%。UniRig支持人形、动物、幻想生物及机械结构，能自动预测蒙皮权重和骨骼物理属性。其训练基于包含1.4万模型的Rig-XL数据集，确保生成骨架的通用性和准确性。这一突破性技术解决了传统绑骨流程繁琐、专业门槛高的问题，为3D内容创作提供高效解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T19:03:18Z
- **目录日期**: 2025-04-13
