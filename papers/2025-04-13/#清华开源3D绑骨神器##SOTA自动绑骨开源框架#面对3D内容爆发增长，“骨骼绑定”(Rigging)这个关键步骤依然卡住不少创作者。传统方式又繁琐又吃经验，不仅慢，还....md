...
清华大学与VAST联合开源UniRig自动骨骼绑定框架，突破传统繁琐的3D模型绑骨流程。该框架采用自回归模型逐关节预测骨架结构，创新性引入骨骼树Tokenization技术，处理效率提升30%，支持人形、动物、幻想生物及机械等多种模型。通过Rig-XL大型数据集（含1.4万+模型）训练，可同步预测蒙皮权重与骨骼物理属性，实现更真实的动画效果。作为当前最先进的自动绑骨方案，UniRig显著降低了3D内容创作门槛。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T22:03:32Z
- **目录日期**: 2025-04-13
