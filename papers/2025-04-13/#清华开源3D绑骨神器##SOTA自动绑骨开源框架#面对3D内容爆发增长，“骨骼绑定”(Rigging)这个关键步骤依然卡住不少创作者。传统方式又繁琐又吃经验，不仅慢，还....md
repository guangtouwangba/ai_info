...
清华大学与VAST联合发布开源自动骨骼绑定框架UniRig，显著简化3D模型动画制作流程。该框架采用自回归模型逐关节预测骨架结构，创新性引入骨骼树Tokenization技术，处理效率提升30%，支持人形、动物、幻想生物及机械结构等多种模型。通过Rig-XL大型数据集（含1.4万+模型）训练，UniRig能同步预测蒙皮权重与骨骼物理属性，增强动画真实感。这一SOTA级解决方案突破了传统绑骨技术对专业经验的依赖，为3D内容创作提供高效通用工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T20:03:29Z
- **目录日期**: 2025-04-13
