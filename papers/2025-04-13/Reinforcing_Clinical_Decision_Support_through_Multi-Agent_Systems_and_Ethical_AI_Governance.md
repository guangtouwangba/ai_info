...
这篇论文提出了一种新型多智能体临床决策支持系统架构，通过模块化智能体分别分析实验室结果、生命体征和临床背景，然后整合这些结果进行预测和验证。该系统基于eICU数据库实现，采用透明的业务逻辑实现方式，遵循自主性、公平性和问责制等伦理AI治理原则。研究表明，这种基于智能体的框架不仅提高了可解释性和准确性，还能增强重症监护环境中对AI辅助决策的信任度。该架构为实现可信赖且有效的患者护理提供了数据驱动医疗时代的解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T06:02:05Z
- **目录日期**: 2025-04-13
