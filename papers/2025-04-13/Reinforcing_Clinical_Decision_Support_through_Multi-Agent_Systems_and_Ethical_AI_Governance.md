...
本文提出了一种新型多智能体临床决策支持系统架构，采用模块化智能体分别分析实验室结果、生命体征和临床背景，并整合这些结果进行预测和验证。基于eICU数据库的实现表明，该系统遵循自主性、公平性和问责制等伦理AI原则，通过透明业务逻辑提高了可解释性和准确性。研究证明，该框架不仅能增强重症监护环境中AI辅助决策的可信度，还能有效提升临床决策的可靠性。这一数据驱动的方法为构建可信赖的医疗AI系统提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T20:01:58Z
- **目录日期**: 2025-04-13
