...
本文提出了一种新型多智能体临床决策支持系统架构，通过模块化智能体分别分析实验室结果、生命体征和临床背景，再整合结果进行预测和验证。基于eICU数据库实现，系统包含实验室分析智能体、生命体征解读器和情境推理器，以及预测模块和验证智能体。该透明化业务逻辑实现遵循自主性、公平性和问责制等伦理AI治理原则。结果表明，该框架不仅提高了可解释性和准确性，还增强了重症监护环境下对AI辅助决策的信任度，实现了数据驱动医疗时代可信赖的临床决策支持。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T21:02:07Z
- **目录日期**: 2025-04-13
