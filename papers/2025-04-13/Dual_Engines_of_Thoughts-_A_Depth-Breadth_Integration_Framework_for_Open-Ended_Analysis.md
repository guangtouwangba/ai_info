...
本文提出"思维双引擎"(DEoT)框架，专门针对开放性问题进行综合分析。该框架包含三大核心：基础提示器(优化用户查询)、求解代理(协调任务分解与验证)以及由广度引擎(探索多元因素)和深度引擎(深入分析)构成的双引擎系统。DEoT能平衡广泛覆盖与深度分析，支持参数自定义，实验表明其在处理复杂多维问题时优于现有推理模型，胜率达77-86%。这种集成设计特别适用于需要同时兼顾广度和深度的开放性问题分析场景。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T12:01:54Z
- **目录日期**: 2025-04-13
