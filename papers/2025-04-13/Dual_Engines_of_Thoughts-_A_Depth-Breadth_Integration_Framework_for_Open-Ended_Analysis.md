...
研究者提出了"思维双引擎"(DEoT)框架，专门用于解决开放性问题。该框架包含三个核心组件：优化用户查询的基础提示器、协调任务分解与验证的求解代理，以及由广度引擎(探索多元影响因素)和深度引擎(进行深入分析)组成的双引擎系统。DEoT能同时兼顾广泛覆盖和深度分析，具有高度可定制性。实验表明，在解决复杂多面问题时，DEoT以77-86%的胜率优于现有推理模型，展现了其在现实应用中的高效性。该框架突破了传统单答案推理模式的局限，为开放性问题提供了更全面的分析方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T03:53:25Z
- **目录日期**: 2025-04-13
