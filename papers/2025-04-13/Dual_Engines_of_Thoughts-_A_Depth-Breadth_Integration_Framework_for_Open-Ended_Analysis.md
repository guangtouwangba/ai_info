...
本文提出"思维双引擎"(DEoT)框架，专门解决开放性问题分析。该框架包含三个核心组件：基础提示器优化用户查询、求解代理协调任务分解与验证、以及由广度引擎(探索多元影响因素)和深度引擎(进行深入分析)组成的双引擎系统。DEoT能平衡广泛覆盖与深度分析，具有高度可定制性。实验表明，在解决复杂多维度问题时，DEoT以77-86%的胜率优于现有推理模型，展现了实际应用中的卓越性能。该框架突破了传统单答案推理的局限，为开放性问题提供了更全面的分析方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T20:01:50Z
- **目录日期**: 2025-04-13
