...
本文提出了"思维双引擎"(DEoT)框架，用于解决开放性问题。该框架包含三个核心组件：优化用户查询的基础提示器、协调任务分解与执行的求解代理，以及由广度引擎(探索多元影响因素)和深度引擎(深入分析)构成的双引擎系统。DEoT能平衡广泛覆盖与深度分析，支持参数自定义。实验表明，在解决复杂多面问题时，DEoT以77-86%的胜率优于现有推理模型，展现了出色的实际应用效果。该框架特别适合需要全面开放式推理的场景，突破了传统单答案推理模式的局限。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T01:48:10Z
- **目录日期**: 2025-04-13
