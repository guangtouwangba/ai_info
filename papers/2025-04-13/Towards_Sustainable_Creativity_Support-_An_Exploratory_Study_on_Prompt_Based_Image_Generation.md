...
该研究探讨了生成式AI（如图像生成器）在支持人类创造力方面的作用及其能耗问题。通过一项24人参与的实验，研究发现图像生成条件显著影响能耗和单次提示的创造力支持指数，但整体任务表现不受影响，这可能与每次提示生成的图像数量有关。研究分析了能耗、创造力支持和用户提示行为之间的关系，同时考察了参与者对AI设计工具及其环境影响的看法，旨在探索在不损害创造力支持的前提下降低能耗的可能性。结果表明，通过优化提示策略可能实现能耗与创意辅助的平衡。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T10:01:56Z
- **目录日期**: 2025-04-13
