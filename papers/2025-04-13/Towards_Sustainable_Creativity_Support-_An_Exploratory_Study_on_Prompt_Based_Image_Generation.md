...
这篇论文研究了生成式AI（如图像生成器）在支持人类创造力时的能源消耗问题。通过一项24人参与的实验，研究者发现图像生成条件显著影响能耗和单次提示的创造力支持指数，但不影响整体任务的创造力评价，这可能与每次提示生成的图像数量有关。研究分析了能源使用、创造力支持和用户提示行为之间的关系，同时探讨了用户对AI设计工具及其环境影响的态度。结果表明，可以在不影响创造力支持的情况下降低AI工具的能耗。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T15:01:51Z
- **目录日期**: 2025-04-13
