...
这篇论文研究了AI图像生成工具在支持人类创造力时的能耗问题。通过一项24人参与的用户实验，研究者发现不同图像生成条件对能耗有显著影响，但创意支持指数仅与单次提示相关而非整体任务，主要归因于每次提示生成的图像数量。研究分析了能耗、创意支持和用户提示行为之间的关系，同时探讨了用户对AI设计工具及其环境影响的态度。结果表明，可以在不影响创意支持的情况下降低AI图像生成系统的能耗，为开发更环保的创意辅助工具提供了依据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T23:01:58Z
- **目录日期**: 2025-04-13
