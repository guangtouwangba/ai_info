...
这篇论文探讨了AI图像生成工具在支持人类创造力方面的作用及其能耗问题。研究表明，虽然AI能快速可视化创意，但其高能耗受到批评。通过24人用户实验发现，图像生成条件显著影响能耗和单次提示的创造力支持指数（但非整体任务），主要归因于每次提示生成的图像数量。研究分析了能耗、创造力支持和用户提示行为之间的关系，同时考察了人们对AI设计及其环境影响的态度。结果表明，可以在不影响创造力支持的情况下降低能耗。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T06:01:47Z
- **目录日期**: 2025-04-13
