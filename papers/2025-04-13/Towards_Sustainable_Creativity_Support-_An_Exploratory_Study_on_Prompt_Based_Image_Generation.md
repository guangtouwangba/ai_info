...
该研究探讨了AI图像生成工具在支持人类创造力方面的作用，同时关注其高能耗问题。通过24人参与的实验，研究发现不同图像生成条件对能耗有显著影响，但创意支持指数仅与单次提示相关，而非整体任务，主要归因于每次提示生成的图像数量。研究分析了能耗、创意支持与用户提示行为之间的关系，并探讨了用户对AI设计及其环境影响的态度。结果表明，可以在不影响创意支持的情况下降低能耗，为平衡AI工具的创造性与可持续性提供了见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T00:25:40Z
- **目录日期**: 2025-04-13
