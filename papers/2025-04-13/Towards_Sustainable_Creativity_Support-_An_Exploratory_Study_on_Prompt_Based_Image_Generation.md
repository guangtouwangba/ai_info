...
该研究探讨了AI图像生成工具在支持人类创造力时如何减少能耗。通过对24名用户的实验发现，图像生成条件显著影响能耗和每个提示的创造力支持指数，但不会影响整体任务的创造力支持，这主要与每次提示生成的图像数量有关。研究分析了能耗、创造力支持和用户提示行为之间的关系，同时考察了用户对AI设计及其环境影响的态度。结果表明，可以在不损害创造力支持的情况下降低AI图像生成工具的能源消耗。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T13:06:35Z
- **目录日期**: 2025-04-13
