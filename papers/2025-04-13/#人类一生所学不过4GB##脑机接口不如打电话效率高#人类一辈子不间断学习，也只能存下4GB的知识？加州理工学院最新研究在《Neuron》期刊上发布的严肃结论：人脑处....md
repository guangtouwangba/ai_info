...
加州理工学院《Neuron》期刊研究显示，人脑信息处理速度存在"10bit/s"的生理极限，远低于感官接收数据的速度（双眼3.2Gbps）。通过打字、演讲等行为验证，人类一生积累的知识量约4GB。研究指出大脑进化形成的串行处理机制限制了多任务能力，并对脑机接口的带宽突破提出质疑——即使Neuralink也难以超越这一生理天花板。不过研究者认为，脑机接口的价值在于信息解码而非速率突破。该发现引发对认知极限与技术应用的新思考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T21:02:39Z
- **目录日期**: 2025-04-13
