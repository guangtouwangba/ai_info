...
加州理工学院《Neuron》期刊研究显示，人脑信息处理速度仅约10bit/秒，远低于感官接收的10亿bit/秒数据量。通过打字、演讲等活动验证，人类认知存在"带宽瓶颈"。高级打字员输出速度即达此上限，而双眼视觉输入高达3.2Gbps。进化形成的串行处理机制限制了多任务能力，这也解释了脑机接口难以突破10bit/s的生理极限。研究者指出，脑机接口的价值在于信息解码而非速率提升，调侃其传输效率甚至不如语言交流。按此推算，人类终生学习积累的知识量仅约4GB。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T12:02:38Z
- **目录日期**: 2025-04-13
