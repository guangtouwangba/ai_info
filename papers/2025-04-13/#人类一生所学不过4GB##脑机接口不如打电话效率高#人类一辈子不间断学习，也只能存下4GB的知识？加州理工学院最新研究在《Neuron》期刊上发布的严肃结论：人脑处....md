...
加州理工学院《Neuron》期刊研究显示，人脑信息处理速度存在严重瓶颈：尽管感官每秒接收千兆级数据，但大脑处理能力仅约10bit/s（如打字员每秒输出10bit）。这种进化形成的串行处理模式导致信息处理效率低下，一生所学信息量仅约4GB。研究质疑脑机接口突破带宽限制的可能性，指出其核心价值在于信息解码而非速率提升。该发现揭示了人类认知的物理极限——语言交流速度已接近大脑处理能力的上限。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T17:02:45Z
- **目录日期**: 2025-04-13
