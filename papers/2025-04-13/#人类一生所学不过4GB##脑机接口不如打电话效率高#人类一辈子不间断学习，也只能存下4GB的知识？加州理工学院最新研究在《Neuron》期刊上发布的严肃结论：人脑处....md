...
加州理工学院《Neuron》期刊研究显示，人脑信息处理速度仅约10bit/秒，远低于感官接收的10亿bit/秒数据量，形成"信息堵车"。通过打字、演讲等实验证实该处理速率具有普遍性。研究指出大脑进化形成的串行处理机制限制了多任务能力，并质疑脑机接口突破10bit/s带宽限制的可能性，认为其核心价值在于信息解码而非速率提升。按此计算，人类一生学习积累的知识量仅约4GB。该研究引发对认知极限与技术突破关系的热议。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T20:02:30Z
- **目录日期**: 2025-04-13
