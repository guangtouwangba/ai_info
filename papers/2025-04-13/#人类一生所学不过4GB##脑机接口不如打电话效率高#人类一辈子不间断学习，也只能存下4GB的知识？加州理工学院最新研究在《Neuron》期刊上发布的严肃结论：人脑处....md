...
加州理工学院《Neuron》期刊最新研究表明，人类大脑信息处理速度存在约10bit/s的瓶颈，远低于感官接收数据的速度（双眼达3.2Gbps）。研究通过多种行为测试证实该限制普遍存在，指出这是进化形成的串行处理机制所致。按此推算，人类一生所学信息量仅约4GB。该发现对脑机接口技术提出挑战，认为其难以突破大脑固有带宽限制，但仍有信息解码价值。研究强调人脑更擅长专注单任务，多任务并行能力受生理结构制约。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T23:02:46Z
- **目录日期**: 2025-04-13
