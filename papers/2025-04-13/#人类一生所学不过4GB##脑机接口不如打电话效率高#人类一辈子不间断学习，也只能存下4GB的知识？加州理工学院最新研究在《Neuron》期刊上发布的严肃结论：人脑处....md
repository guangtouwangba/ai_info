...
加州理工学院《Neuron》期刊研究显示，人脑信息处理速度仅约10bit/秒，远低于感官接收的10亿bit/秒数据量。通过打字、演讲等实验证实，人类一生积累的知识量约4GB。大脑进化形成的"串行处理"模式限制了多任务能力，这也解释了脑机接口难以突破带宽瓶颈的原因——即使植入电极，信息传输速率仍受10bit/s限制。研究者认为脑机接口的价值在于信息解码而非速率提升，并调侃其效率可能不如语言交流。该研究揭示了人类认知的生理局限性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T14:02:47Z
- **目录日期**: 2025-04-13
