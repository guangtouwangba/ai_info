...
加州理工学院《Neuron》期刊最新研究表明，人类大脑信息处理速度存在"10bit/s"的生理极限。研究发现，无论是打字、说话还是解魔方，人类认知输出速率均稳定在每秒10比特左右，而感官输入却高达3.2Gbps，形成巨大"信息鸿沟"。这种进化形成的串行处理机制虽保障生存，却限制了多任务能力。研究指出，即便脑机接口技术也难以突破该带宽限制，其核心价值在于信息解码而非速率提升。按此推算，人类一生所学信息量仅约4GB。该发现对认知科学和人机交互研究具有重要启示意义。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T11:02:41Z
- **目录日期**: 2025-04-13
