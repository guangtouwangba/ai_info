...
加州理工学院《Neuron》期刊最新研究表明，人脑信息处理速度存在"10bit/s"的生理极限，一生所学知识仅约4GB。研究发现，尽管感官每秒接收10亿bit数据，但大脑采用"串行处理"模式导致严重信息拥堵。该结论对脑机接口技术提出挑战，指出其无法突破人脑固有带宽限制，语言交流已接近信息传输极限。不过研究者认为，脑机接口的价值在于信息解码而非速率提升。这项研究揭示了人类认知系统的根本性效率瓶颈。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T13:07:36Z
- **目录日期**: 2025-04-13
