...
加州理工学院《Neuron》期刊研究显示，人脑信息处理速度仅约10bit/s，远低于感官接收的10亿bit/s数据量。通过打字、演讲等实验证实这一速率限制，说明大脑采用"串行处理"模式，制约多任务能力。该研究指出人类一生所学信息量约4GB，并对脑机接口突破带宽限制提出质疑，认为其核心价值在于信息解码而非速率提升。研究者调侃称，打电话的语言传输效率已接近人脑处理极限。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T16:02:44Z
- **目录日期**: 2025-04-13
