# #人类一生所学不过4GB##脑机接口不如打电话效率高#人类一辈子不间断学习，也只能存下4GB的知识？加州理工学院最新研究在《Neuron》期刊上发布的严肃结论：人脑处...
...
加州理工学院《Neuron》期刊研究显示，人脑信息处理速度仅约10bit/秒，远低于感官接收的10亿bit/秒数据量，导致大脑长期处于"信息过载"状态。通过打字、演讲等行为验证，人类最高信息输出速率稳定在10bit/s（如打字员每秒2个单词）。研究表明大脑进化形成的串行处理机制严重限制了多任务能力，这也意味着脑机接口难以突破该生理瓶颈——其价值在于信息解码而非带宽提升。按此推算，人类一生所学知识存储量仅约4GB。研究对Neuralink等脑机接口技术的实际效用提出了根本性质疑。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T06:02:40Z
- **目录日期**: 2025-04-13
