...
加州理工学院在《Neuron》发表的研究指出，人脑信息处理速度仅约10bit/s，远低于感官接收数据的Gbps级速率。通过打字、演讲等行为验证，人类认知存在"串行处理"瓶颈，导致一生所学信息量仅约4GB。研究质疑脑机接口突破带宽限制的可能性，认为其核心价值在于信息解码而非速率提升。该发现揭示了人脑进化形成的效率与局限性，引发对认知能力本质的重新思考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T10:02:46Z
- **目录日期**: 2025-04-13
