...
加州理工学院在《Neuron》期刊发表研究指出，人脑信息处理速度存在"10bit/s"的瓶颈，一生所学知识总量不超过4GB。研究发现，尽管感官每秒接收10亿比特数据，但大脑受限于进化形成的串行处理模式，导致信息处理效率低下。这一结论对脑机接口技术提出挑战，认为其难以突破人脑固有的带宽限制。不过研究者强调，脑机接口的价值在于信息解码而非速率提升。研究通过打字、演讲等日常活动验证了这一理论，并指出人类语言速度已接近处理极限。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T18:01:12Z
- **目录日期**: 2025-04-13
