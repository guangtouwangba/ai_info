...
加州理工学院《Neuron》期刊研究显示，人脑信息处理速度仅约10bit/秒，远低于感官接收的10亿bit/秒数据量。通过打字、演讲等实验证实，人类认知存在"信息堵车"。按此推算，一生所学信息量不超过4GB。研究指出大脑进化形成的"串行处理"模式限制了多任务能力，并对脑机接口突破带宽限制提出质疑——其10bit/s的生理瓶颈使信息传输效率甚至低于语言交流。不过研究者认为脑机接口在信息解码方面仍有价值。该研究引发对认知极限与技术突破的重新思考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T08:02:37Z
- **目录日期**: 2025-04-13
