...
加州理工学院《Neuron》期刊最新研究表明，人类大脑信息处理速度存在约10bit/s的瓶颈，远低于感官接收能力（双眼3.2Gbps）。通过打字、演讲等行为验证，发现人类一生积累的知识量仅约4GB。研究指出大脑进化形成的"串行处理"模式限制了多任务能力，并对脑机接口突破带宽限制提出质疑——其核心价值在于信息解码而非速率提升。该成果引发对认知极限与脑机技术实用性的新思考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T15:02:45Z
- **目录日期**: 2025-04-13
