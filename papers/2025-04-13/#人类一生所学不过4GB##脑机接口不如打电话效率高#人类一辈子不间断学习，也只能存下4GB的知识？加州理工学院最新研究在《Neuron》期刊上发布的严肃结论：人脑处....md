...
加州理工学院《Neuron》期刊最新研究揭示：人类大脑信息处理速度存在"10bit/s"的生理极限，相当于一生所学知识仅约4GB。研究发现，尽管感官每秒接收数十亿比特数据，但大脑进化形成的串行处理模式严重限制了信息吞吐量。这一发现对脑机接口技术提出挑战，指出其难以突破人脑固有带宽限制，甚至调侃"打电话的通信效率更高"。不过研究者强调，脑机接口的价值在于信息解码而非速率突破。该研究引发对大脑信息处理机制的新思考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T22:02:30Z
- **目录日期**: 2025-04-13
