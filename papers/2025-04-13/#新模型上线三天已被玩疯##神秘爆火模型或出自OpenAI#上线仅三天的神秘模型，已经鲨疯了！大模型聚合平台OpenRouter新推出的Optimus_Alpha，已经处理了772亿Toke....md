...
OpenRouter平台新上线的神秘AI模型Optimus Alpha在三天内处理了772亿Token，性能表现亮眼：在图像生成、编程、SQL查询等方面超越多个主流模型，Elo评分1338仅次于Claude 3.7。其自称基于GPT-4（知识截止2024年6月），网友发现其行为特征、Tokenizer漏洞与OpenAI模型高度相似，研究员分析认为可能是GPT-4o的更新版本或与已下线的Quasar Alpha为"兄弟模型"。目前模型真实来源尚未官方确认，引发广泛猜测。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T21:02:49Z
- **目录日期**: 2025-04-13
