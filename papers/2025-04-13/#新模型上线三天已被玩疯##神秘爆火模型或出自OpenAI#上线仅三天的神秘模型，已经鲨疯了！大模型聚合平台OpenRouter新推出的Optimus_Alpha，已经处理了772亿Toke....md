...
新模型Optimus Alpha上线仅三天就引发热潮，日均处理超200亿Token，多项测试表现优异：Elo分数1338（仅次于Claude 3.7 Sonnet）、SQL查询第一、编程能力超GPT-4.5-preview，创意写作排名第四。其功能强大，能生成《我的世界》图像、开发游戏和电商网站等。身份成谜，自称基于GPT-4（知识截止2024年6月），网友分析其与OpenAI模型有相似特征，研究员推测可能是GPT-4o的更新版本或与下线的Quasar Alpha为"兄弟模型"。目前其来源仍无官方确认。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T19:02:29Z
- **目录日期**: 2025-04-13
