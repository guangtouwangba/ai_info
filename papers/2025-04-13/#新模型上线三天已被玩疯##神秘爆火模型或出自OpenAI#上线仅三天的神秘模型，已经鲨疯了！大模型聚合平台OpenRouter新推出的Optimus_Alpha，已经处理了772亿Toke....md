...
Optimus Alpha是OpenRouter平台新推出的神秘AI模型，上线三天处理量已达772亿Token，日处理量超340亿。该模型在多领域表现优异：图像生成碾压4o-mini，编程能力超过GPT-4.5-preview，SQL查询排名第一，创意写作位列第四。其身份引发热议，自称基于GPT-4，知识截止2024年6月。研究人员发现其与ChatGPT-4o和已下线的Quasar Alpha高度相似，Tokenizer bug等特征指向可能出自OpenAI。目前用户正积极测试其各项能力，但开发者尚未公开模型来源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T06:02:51Z
- **目录日期**: 2025-04-13
