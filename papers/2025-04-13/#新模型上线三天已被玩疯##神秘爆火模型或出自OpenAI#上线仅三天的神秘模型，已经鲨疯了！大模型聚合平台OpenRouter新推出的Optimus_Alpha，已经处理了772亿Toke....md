...
近日，一款名为Optimus Alpha的神秘AI模型在OpenRouter平台上线三天即引发热潮，日均处理超200亿Token，多项测试表现优异：Elo评分1338（仅次于Claude 3.7）、SQL查询第一、编程能力超越GPT-4.5-preview，还能生成《我的世界》图像和构建电商网站。其自称基于GPT-4（知识截止2024年6月），网友发现其与OpenAI模型存在Tokenizer相同bug，研究员分析认为它极可能是GPT-4o的更新版本。尽管官方未透露来源，其强大性能与OpenAI的高度关联性引发广泛猜测。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T20:02:39Z
- **目录日期**: 2025-04-13
