...
OpenRouter平台新推出的Optimus Alpha模型上线三天即引发热潮，日均处理超200亿Token，多项测试表现优异：Elo评分1338（仅次于Claude 3.7）、SQL查询第一、编程能力超GPT-4.5-preview，并能流畅完成跨文件任务。其身份引发猜测，模型自称基于GPT-4（知识截止2024年6月），技术痕迹与OpenAI高度相似，研究员分析认为可能是GPT-4o的更新版本。目前该模型在Trending榜单排名第一，用户已用它生成游戏图像、开发应用等，实际效果碾压部分知名模型。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T17:02:56Z
- **目录日期**: 2025-04-13
