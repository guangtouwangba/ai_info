...
OpenAI疑似发布神秘新模型Optimus Alpha，上线3天日均处理200亿Token，峰值达340亿。该模型在多领域表现优异：图像生成碾压4o-mini，编程超越GPT-4.5，SQL测试第一，创意写作第四。用户发现其行为与下线的Quasar Alpha高度一致，且出现OpenAI特有Tokenizer漏洞。研究员分析表明，该模型极似GPT-4o升级版，但官方未确认其身份。目前该模型在OpenRouter平台趋势榜排名第一，引发网友对其真实背景的热议。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T07:02:54Z
- **目录日期**: 2025-04-13
