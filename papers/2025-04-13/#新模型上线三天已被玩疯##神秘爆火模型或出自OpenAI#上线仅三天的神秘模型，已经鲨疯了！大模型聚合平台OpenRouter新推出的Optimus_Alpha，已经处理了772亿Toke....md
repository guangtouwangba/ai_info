...
OpenRouter平台新上线的神秘模型Optimus Alpha在三天内处理了772亿Token，日处理量超340亿，表现亮眼。该模型在多领域测试中表现优异，包括图像生成、编程、SQL查询等，Elo分数1338，仅次于Claude 3.7 Sonnet。其身份引发猜测，自称基于GPT-4，知识截止2024年6月，行为与OpenAI模型相似，出现同款Tokenizer bug。研究员分析认为它可能是GPT-4o的更新版本或与Quasar Alpha为"兄弟模型"。网友推测其可能来自OpenAI或马斯克团队。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T13:07:45Z
- **目录日期**: 2025-04-13
