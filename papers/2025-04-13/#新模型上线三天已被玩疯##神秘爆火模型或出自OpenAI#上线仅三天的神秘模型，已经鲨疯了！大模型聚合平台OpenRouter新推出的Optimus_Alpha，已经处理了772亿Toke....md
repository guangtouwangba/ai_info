...
一款名为Optimus Alpha的神秘AI模型在OpenRouter平台上线三天即引发热潮，日均处理超200亿Token，峰值达340亿。其表现优异：在图像生成、编程（超过GPT-4.5）、SQL查询（排名第一）和创意写作（第四名）等任务中表现突出，Elo评分1338仅次于Claude 3.7。虽然官方未透露来源，但模型自称基于GPT-4（知识截止2024年6月），且被发现与OpenAI模型存在相似特征（如Tokenizer bug）。研究员推测可能是GPT-4o的更新版本或与已下线的Quasar Alpha为"兄弟模型"。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T15:02:56Z
- **目录日期**: 2025-04-13
