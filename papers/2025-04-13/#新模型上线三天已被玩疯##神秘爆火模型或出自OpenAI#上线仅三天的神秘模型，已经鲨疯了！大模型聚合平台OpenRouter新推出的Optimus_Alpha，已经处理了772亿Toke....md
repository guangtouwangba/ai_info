...
OpenRouter平台新上线的神秘模型Optimus Alpha在三天内处理了772亿Token，日均超200亿且持续增长。该模型在多项测试中表现优异：Elo分数1338排名第二，SQL查询第一，编程能力超过GPT-4.5-preview，创意写作第四。用户用它成功生成《我的世界》图像、开发游戏和电商网站等。尽管官方未透露来源，但模型自称基于GPT-4，且被发现与OpenAI的Quasar Alpha有相似行为和Tokenizer bug。研究员分析认为它可能是GPT-4o的更新版本，引发网友对其出自OpenAI的猜测。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T18:01:22Z
- **目录日期**: 2025-04-13
