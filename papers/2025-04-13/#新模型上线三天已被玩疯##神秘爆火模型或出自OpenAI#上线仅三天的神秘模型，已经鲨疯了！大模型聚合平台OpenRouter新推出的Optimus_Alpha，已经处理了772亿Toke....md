...
一款名为Optimus Alpha的神秘AI模型在OpenRouter平台上线仅三天就引发热潮，日处理Token量超340亿，多项测试表现优异：Elo评分1338（仅次于Claude 3.7）、SQL查询第一、编程能力超越GPT-4.5。其《我的世界》图像生成、贪吃蛇等应用效果惊艳，但最引人关注的是其身份之谜——模型自称基于GPT-4（知识截止2024年6月），研究者发现其与OpenAI的GPT-4o和已下线的Quasar Alpha高度相似，存在OpenAI特有bug，引发"是否GPT-4.1测试版"的猜测。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T16:02:55Z
- **目录日期**: 2025-04-13
