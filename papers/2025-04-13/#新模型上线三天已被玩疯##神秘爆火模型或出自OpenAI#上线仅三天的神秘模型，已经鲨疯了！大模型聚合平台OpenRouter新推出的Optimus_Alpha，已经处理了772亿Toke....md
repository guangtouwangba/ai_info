# #新模型上线三天已被玩疯##神秘爆火模型或出自OpenAI#上线仅三天的神秘模型，已经鲨疯了！大模型聚合平台OpenRouter新推出的Optimus Alpha，已经处理了772亿Toke...
...
OpenRouter平台新推出的神秘AI模型Optimus Alpha上线三天即引发热潮，日均处理超200亿Token，多项测试表现优异：Elo评分1338（仅次于Claude 3.7）、SQL查询第一、编程能力超越GPT-4.5。其《我的世界》图像生成、跨文件电商功能等展示出强大多模态能力。模型自称基于GPT-4（知识截止2024年6月），研究者发现其与OpenAI的ChatGPT-4o和已下线的Quasar Alpha高度相似，存在特有Tokenizer漏洞。尽管未公开来源，技术痕迹表明很可能出自OpenAI系，被推测为GPT-4.1测试版本。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T11:02:52Z
- **目录日期**: 2025-04-13
