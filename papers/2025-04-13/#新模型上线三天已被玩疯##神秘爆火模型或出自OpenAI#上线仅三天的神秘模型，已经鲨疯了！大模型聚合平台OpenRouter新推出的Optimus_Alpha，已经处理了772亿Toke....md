...
近期OpenRouter平台上线名为Optimus Alpha的神秘AI模型，上线三天即引发热潮，日均处理超200亿Token。该模型在多领域表现优异：图像生成碾压4o-mini，编程能力超越GPT-4.5，SQL测试排名第一，创意写作位列第四。其身份引发猜测，模型自称基于GPT-4（知识截止2024年6月），研究者发现其与OpenAI模型存在Tokenizer相同bug，谱系分析显示其最接近ChatGPT-4o更新版。目前该模型暂未公开开发者信息，但技术特征强烈指向OpenAI系产品。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T10:02:56Z
- **目录日期**: 2025-04-13
