...
Meta的Llama 4大模型因被曝在竞技场测试中"作弊"而引发争议。重新上线标准版后，其排名从第2名暴跌至第32名，引发社区对Meta测试诚信的质疑。虽然Llama 4在特定硬件环境下表现良好，但在多项任务测试中仍逊色于DeepSeek v3，尤其在准确率和任务处理能力方面。此次事件导致用户对Meta的信任度下降，批评其不尊重基准测试标准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T03:00:00Z
- **目录日期**: 2025-04-13
