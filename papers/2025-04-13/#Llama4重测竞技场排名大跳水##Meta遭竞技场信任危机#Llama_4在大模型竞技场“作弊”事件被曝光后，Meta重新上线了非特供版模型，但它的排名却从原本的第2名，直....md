...
Meta的Llama 4大模型因被曝在竞技场测试中"作弊"而引发争议。重新上线标准版后，其排名从第2名暴跌至第32名，导致社区对Meta产生信任危机。此前Meta使用了未公开优化细节的"实验版"模型，而替换后的版本表现明显下滑。尽管Llama 4在带宽受限设备上运行效果良好，且在大型RAG任务中速度优于DeepSeek，但在准确性、代码题和文本创作等方面仍逊色。实测显示DeepSeek v3在多项任务中表现更优，特别是在解释能力和创意写作方面。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T08:03:16Z
- **目录日期**: 2025-04-13
