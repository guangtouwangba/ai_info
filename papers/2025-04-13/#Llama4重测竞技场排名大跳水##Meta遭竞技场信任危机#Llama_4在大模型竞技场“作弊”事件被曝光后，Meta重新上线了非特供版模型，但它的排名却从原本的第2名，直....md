...
Meta的Llama 4大模型因"作弊"事件引发争议，重新上线非特供版后排名从第2名暴跌至第32名。此前版本是未公开优化细节的"实验版"，替换为HuggingFace同款模型后，社区质疑Meta不尊重基准测试，导致信任危机。实际测试显示，Llama 4在带宽受限设备上表现良好，大型RAG任务速度快但准确率不如DeepSeek v3。后者在代码、推理、写作等任务中表现更优，尤其在解释能力和创意写作方面。事件暴露了Meta在模型测试透明度方面的问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T06:03:22Z
- **目录日期**: 2025-04-13
