...
Meta的Llama 4大模型因被曝在竞技场测试中"作弊"引发争议。重新上线标准版后，排名从第2暴跌至第32名。此前Meta使用了未公开优化方式的"实验版"模型，现替换为HuggingFace同款指令微调模型，引发社区对其测试诚信的质疑。尽管Llama 4在带宽受限设备上表现良好，执行速度优于DeepSeek，但在准确性、代码、推理和写作等任务上仍落后于DeepSeek v3。该事件导致Meta面临严重的社区信任危机。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T22:03:10Z
- **目录日期**: 2025-04-13
