...
Meta因Llama 4在竞技场测试中使用"特供优化版"引发争议，重新上线标准版后排名从第2暴跌至第32名，导致社区对其信任危机。尽管Llama 4在带宽受限设备（如Mac Studio）和大型RAG任务速度上表现优异，但在准确率、代码题和文本创作等方面仍逊于DeepSeek v3。开发者批评Meta未公开优化细节，损害基准测试公信力，而实测显示DeepSeek在推理、解释能力和创意写作上更优。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T09:03:31Z
- **目录日期**: 2025-04-13
