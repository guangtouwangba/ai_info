...
Meta的Llama 4大模型因被曝在竞技场测试中使用"特供优化版"而引发争议。重新上线标准版后，其排名从第2名暴跌至第32名，引发社区对Meta测试诚信的质疑。开发者指出，Llama 4在带宽受限设备（如Mac Studio）上表现良好，大型RAG任务执行速度优于DeepSeek，但准确率和综合能力仍不足。实测显示DeepSeek v3在代码、推理、文本创作（特别是解释能力和故事结尾设计）方面更优。此次事件导致Meta面临严重的社区信任危机。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T17:03:22Z
- **目录日期**: 2025-04-13
