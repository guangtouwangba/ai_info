...
Meta因Llama 4在竞技场测试中使用优化版本（未公开细节）引发争议，重新上线标准版后排名从第2暴跌至第32名，导致社区对其信任危机。尽管Llama 4在带宽受限设备（如Mac Studio）和大型RAG任务速度上表现优异，但准确率和综合能力仍落后于竞品（如DeepSeek v3）。后者在代码、推理、文本创作（如故事结尾设计）等实测中更优。开发者批评Meta破坏基准测试公正性，削弱了开源社区对其模型的信任。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T21:03:16Z
- **目录日期**: 2025-04-13
