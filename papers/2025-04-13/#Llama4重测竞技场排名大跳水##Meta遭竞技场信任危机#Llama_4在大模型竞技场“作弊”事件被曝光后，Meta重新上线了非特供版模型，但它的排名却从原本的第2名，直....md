...
Meta的Llama 4大模型因被曝在竞技场测试中"作弊"引发争议。重新上线非特供版后，其排名从第2名暴跌至第32名，导致社区对Meta产生信任危机。虽然Llama 4在特定硬件环境和大型RAG任务中表现良好，但在代码、推理和文本创作等核心能力上仍逊色于DeepSeek v3。开发者指出，Meta未公开优化细节的做法损害了透明度，而DeepSeek在解释能力和任务完成度上更受好评。这一事件凸显了大模型评测中公平性和透明度的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T19:02:54Z
- **目录日期**: 2025-04-13
