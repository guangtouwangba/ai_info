...
Meta因Llama 4在竞技场测试中疑似"作弊"引发争议，重新上线标准版后排名从第2暴跌至第32名。此前被替换的"实验版"未公开优化细节，引发社区对Meta测试透明度的质疑。虽然Llama 4在带宽受限设备（如Mac Studio）表现良好，且在大型RAG任务中速度优于DeepSeek，但准确率和综合能力仍不足。多项测试显示，DeepSeek v3在代码、推理和文本创作（如故事结尾设计）上更优。此次事件导致Meta面临严重的社区信任危机。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T12:03:19Z
- **目录日期**: 2025-04-13
