...
Meta的Llama 4大模型因"作弊"争议被重新测试，排名从第2名暴跌至第32名。此前Meta使用了一个未公开优化细节的"实验版"模型参赛，引发社区对基准测试公正性的质疑。替换为HuggingFace同款模型后，性能明显下滑。尽管Llama 4在特定硬件环境和大型RAG任务中表现尚可，但在代码、推理和文本创作等核心能力上仍逊色于DeepSeek v3。这一事件导致Meta面临严重的社区信任危机。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T04:29:34Z
- **目录日期**: 2025-04-13
