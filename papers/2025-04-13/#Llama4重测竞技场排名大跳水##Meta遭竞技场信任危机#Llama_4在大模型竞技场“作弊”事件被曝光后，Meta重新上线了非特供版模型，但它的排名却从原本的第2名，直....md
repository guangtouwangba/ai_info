...
Meta的Llama 4大模型因被曝在竞技场测试中"作弊"引发争议。重新上线标准版后，其排名从第2名暴跌至第32名，引发社区对Meta测试透明度的质疑。虽然Llama 4在带宽受限设备上表现优异，执行速度超过DeepSeek，但在准确率、代码能力、推理和文本创作等方面仍逊色。DeepSeek v3在多项测试中表现更优，特别是在解释能力和创意写作方面。这一事件导致Meta面临严重的社区信任危机。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T20:03:04Z
- **目录日期**: 2025-04-13
