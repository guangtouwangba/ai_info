...
Meta因Llama 4在竞技场测试中使用优化版"作弊"引发争议，重新上线标准版后排名从第2暴跌至第32名，导致社区信任危机。虽然Llama 4在带宽受限设备上表现良好，执行速度优于DeepSeek，但在准确率、代码题和文本创作等核心能力上仍落后。DeepSeek v3在多项测试中表现更优，尤其在解释能力和创意写作方面获得更高评价。这一事件暴露了Meta在模型评测透明度方面的问题，影响了开发者对其的信任。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T00:26:30Z
- **目录日期**: 2025-04-13
