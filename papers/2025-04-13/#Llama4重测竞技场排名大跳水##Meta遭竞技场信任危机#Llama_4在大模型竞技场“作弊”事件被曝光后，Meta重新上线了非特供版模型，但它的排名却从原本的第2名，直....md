...
Meta因Llama 4在竞技场测试中涉嫌"作弊"引发争议，重新上线标准版后排名从第2暴跌至第32名。此前被替换的版本是未公开优化细节的"实验版"，改用HuggingFace同款模型后，社区质疑Meta不尊重基准测试，导致信任危机。实测显示，Llama 4在带宽受限设备（如Mac Studio）表现良好，大型RAG任务速度快但精度不足。相比之下，DeepSeek v3在代码、推理、写作等任务中表现更优，尤其在解释能力和创意写作上更受好评。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T05:09:26Z
- **目录日期**: 2025-04-13
