...
Meta的Llama 4大模型因被曝在竞技场测试中使用"特供优化版"而引发争议。重新上线标准版后，其排名从第2名暴跌至第32名，导致社区对Meta的测试诚信产生质疑。尽管Llama 4在特定硬件环境（如带宽受限设备）和大型RAG任务中表现良好，速度优于DeepSeek，但在准确率、代码能力、推理和文本创作等核心指标上仍落后。实测显示，DeepSeek v3在多项任务中表现更优，尤其在解释能力和创意写作方面获得更高评价。这一事件使Meta面临严重的信任危机。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T10:03:25Z
- **目录日期**: 2025-04-13
