...
Meta的Llama 4模型因"作弊"（使用专为人类偏好优化的实验版）被曝光后，重新上线标准版本，导致其在大模型竞技场排名从第2暴跌至第32，引发社区信任危机。尽管该模型在内存充足但带宽受限的设备（如Mac Studio）上表现良好，且在大型RAG任务中速度优于DeepSeek，但准确率和任务处理能力仍不足。多项测试显示，DeepSeek v3在代码、推理、文本创作等方面更优。网友批评Meta不尊重基准测试，损害了社区信任。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T18:01:48Z
- **目录日期**: 2025-04-13
