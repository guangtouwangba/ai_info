...
Meta的Llama 4大模型因被曝在竞技场测试中使用"特供优化版"而引发争议。重新上线标准版后，其排名从第2名暴跌至第32名，导致社区对Meta产生信任危机。开发者指出，Llama 4在内存充足但带宽受限的设备上表现良好，但在准确率和任务处理能力上仍逊色于DeepSeek v3。实测显示，DeepSeek v3在代码、推理、文本创作等方面表现更优，尤其在解释能力和故事设计上获得更高评价。这一事件凸显了AI基准测试的透明性问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T01:49:02Z
- **目录日期**: 2025-04-13
