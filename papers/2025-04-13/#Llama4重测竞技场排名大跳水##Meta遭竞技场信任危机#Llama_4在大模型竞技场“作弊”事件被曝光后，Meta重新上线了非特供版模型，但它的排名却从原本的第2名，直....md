...
Meta的Llama 4模型因"作弊"事件引发争议，重新上线非特供版后排名从第2名暴跌至第32名。此前版本专为人类偏好优化但未公开细节，导致社区质疑Meta不尊重基准测试，引发信任危机。开发者指出Llama 4在内存充足但带宽受限的设备上表现良好，大型RAG任务速度快但准确率不如DeepSeek。实测显示DeepSeek v3在代码、推理、写作等方面更优，尤其是解释能力和故事设计。Meta此次事件暴露了模型评测透明度问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T16:03:21Z
- **目录日期**: 2025-04-13
