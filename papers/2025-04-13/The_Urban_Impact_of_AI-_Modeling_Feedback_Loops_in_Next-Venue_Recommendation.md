...
基于位置的推荐系统正日益影响城市个体出行决策，但其对城市动态的系统性影响研究较少。本研究通过模拟人机反馈循环框架，分析算法推荐如何改变用户行为并反哺模型训练。基于真实出行数据的模拟显示：推荐系统虽能提升个体访问场所的多样性，却可能加剧集体不平等——使访问集中于少数热门地点。这种分化还体现在社交共现网络结构中，对城市可达性和空间隔离产生深远影响。该框架为评估AI辅助出行的社会影响提供了新视角，可帮助预测风险、评估监管措施并指导伦理算法设计。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T07:01:08Z
- **目录日期**: 2025-04-13
