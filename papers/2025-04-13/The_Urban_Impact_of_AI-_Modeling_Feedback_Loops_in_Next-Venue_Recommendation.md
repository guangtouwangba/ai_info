...
这篇论文提出了一个模拟框架，研究基于位置的"下一地点推荐系统"对城市动态的系统性影响。研究发现，虽然推荐算法能增加个人访问场所的多样性，但可能加剧集体不平等，使访问集中在少数热门地点。该框架通过真实移动数据模拟人机反馈循环，揭示了AI推荐对城市可达性和空间隔离的潜在影响，为评估算法社会影响、预测风险及设计伦理系统提供了计算工具。研究强调需要平衡个性化推荐与城市整体公平性，为监管干预和算法设计提供新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T19:01:01Z
- **目录日期**: 2025-04-13
