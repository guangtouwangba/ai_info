...
基于位置的推荐系统正日益影响城市个体移动决策，但其系统性影响尚未充分研究。本研究提出一个模拟框架，量化人机反馈循环：算法推荐改变用户行为，进而重塑模型训练数据。基于真实移动数据的模拟显示，推荐系统虽能提升个体访问场所的多样性，却可能加剧集体不平等——使访问集中于少数热门地点。这种分化还体现在社交共现网络结构中，对城市可达性和空间隔离产生深远影响。该框架为评估AI辅助移动的社会影响提供了新工具，可帮助预测风险、评估监管措施并指导伦理算法设计。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T08:01:06Z
- **目录日期**: 2025-04-13
