...
基于位置的推荐系统通过人机反馈循环影响城市动态：虽然能增加个人访问场所的多样性，但会加剧集体不平等——使访问集中在少数热门地点。研究通过真实移动数据模拟发现，这种推荐算法还会改变社交共处网络结构，对城市可达性和空间隔离产生深远影响。该框架为评估AI辅助出行的社会影响提供了新视角，可帮助预测风险、评估监管措施并指导伦理算法设计。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T16:01:10Z
- **目录日期**: 2025-04-13
