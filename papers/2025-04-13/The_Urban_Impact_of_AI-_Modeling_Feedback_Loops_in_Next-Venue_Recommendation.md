...
该研究提出了一个模拟框架，用于分析基于AI的下一个地点推荐系统对人类行为与城市动态的系统性影响。研究发现，虽然推荐算法能增加个人访问场所的多样性，但会加剧集体层面的不平等，使访问集中在少数热门地点。这种影响还延伸到社交共现网络结构，可能加剧城市空间隔离。该框架为评估AI辅助移动性的社会影响提供了新视角，可帮助预测风险、评估监管措施并指导伦理算法设计。研究基于真实移动数据，揭示了人机反馈循环对城市动态的潜在长期影响。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T22:01:08Z
- **目录日期**: 2025-04-13
