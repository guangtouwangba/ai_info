...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译和科研订阅等一站式服务。它支持中英文文献搜索，能快速生成摘要和问答互动，帮助用户高效理解论文内容。平台还具备文档识别、章节概要和个性化科研动态推送功能，覆盖42个学科的3.5亿论文数据。用户可通过浏览器免费使用，实现学者画像追踪、学术会议查询等需求，提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T23:05:20Z
- **目录日期**: 2025-04-13
