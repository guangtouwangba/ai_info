...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作一站式服务。支持中英文文献搜索，拥有3.5亿论文、0.6亿学者等海量数据。特色功能包括：1）智能问答和自动摘要生成，提升文献筛选效率；2）英文文献翻译和辅助阅读工具，支持PDF上传和内容解析；3）个性化科研订阅，通过微信/邮件推送最新学术动态。平台还提供学者画像、学术会议等扩展功能，可免费使用。网址：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T14:05:43Z
- **目录日期**: 2025-04-13
