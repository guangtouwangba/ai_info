...
研究人员开发了一种基于大语言模型的多智能体辩论系统MD2GPS，用于提高孟德尔疾病的诊断准确性。该系统通过数据驱动和知识驱动智能体的自然语言辩论，将TOP1诊断准确率从42.9%提升至66%。在72例疑难病例中，该系统发现了12例潜在致病基因，并将诊断时间缩短90%。MD2GPS具有模块化设计，各组件可替换，使其能适应其他复杂疾病的诊断和研究。该系统已在4个独立数据集的1185个样本中验证，为精准医疗和胚胎植入前遗传学诊断提供了新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T16:01:41Z
- **目录日期**: 2025-04-13
