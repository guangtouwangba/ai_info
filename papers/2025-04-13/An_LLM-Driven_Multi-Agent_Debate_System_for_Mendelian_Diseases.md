...
研究人员开发了一种新型LLM驱动的多智能体辩论系统MD2GPS，用于提高孟德尔疾病的诊断准确性。该系统通过自然语言处理整合数据驱动和知识驱动智能体的结果，促进两者间的辩论，从而提升诊断效果。在4个独立数据集的1,185个样本测试中，TOP1准确率从42.9%提升至66%。在72例疑难病例中，系统识别出12例患者的潜在致病基因，并将诊断时间缩短90%。该系统的模块化设计使其可灵活应用于其他复杂疾病的诊断和研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T12:01:36Z
- **目录日期**: 2025-04-13
