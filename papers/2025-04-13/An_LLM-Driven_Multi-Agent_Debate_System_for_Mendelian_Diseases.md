...
研究人员开发了一种新型LLM驱动的多智能体辩论系统MD2GPS，用于提高孟德尔疾病的诊断准确性。该系统通过数据驱动和知识驱动智能体的自然语言辩论，将TOP1诊断准确率从42.9%提升至66%，并在72例疑难病例中发现了12例潜在致病基因，缩短90%诊断时间。MD2GPS具有模块可替换性，可拓展用于其他复杂疾病的诊断研究。该系统已通过1,185个样本的测试验证，为精准医疗和植入前遗传学诊断提供了更高效可靠的解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T19:01:27Z
- **目录日期**: 2025-04-13
