...
上海AI Lab与西工大联合提出CityGS-X架构，采用并行化混合分层三维表征（PH²-3D），突破传统"分块+合并"方法。该技术仅需4张RTX 4090即可完成5000+图像的大规模城市3D重建，实现训练速度翻倍、显存优化和精度提升。其核心创新包括K层并行体素建模、动态体素分配和高斯属性共享，支持多任务并行渲染。在RGB渲染和几何还原精度上均达到SOTA水平，有效解决了视角过拟合问题，为城市级三维重建提供了高效解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T19:02:45Z
- **目录日期**: 2025-04-13
