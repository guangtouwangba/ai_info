...
上海AI Lab与西工大联合提出的CityGS-X架构，通过并行化混合分层三维表征（PH²-3D）技术，实现了高效的大规模城市3D重建。该方案摒弃传统分块合并方法，采用批处理+多任务并行渲染，显著提升训练速度并降低显存需求。仅需4张RTX 4090显卡即可处理超5000张图像的大场景，在RGB渲染和几何精度上均达到SOTA水平。其核心创新包括K层并行体素建模、动态体素分配和高斯属性共享，通过多任务协同优化有效避免了视角过拟合问题。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T04:29:25Z
- **目录日期**: 2025-04-13
