...
上海AI Lab与西工大联合提出CityGS-X架构，通过并行化混合分层三维表征(PH²-3D)实现高效城市级3D重建。该方案突破传统分块合并方式，采用批处理+多任务并行渲染，仅需4张RTX 4090即可处理5000+图像的大场景。关键优势包括：训练速度提升2倍，RGB渲染与几何精度达SOTA水平，通过K层分层体素建模和动态分配技术显著优化显存使用。模型支持高斯属性迁移和多视图协同优化，有效解决了视角过拟合问题，为大规模三维重建提供了新的高效解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T01:48:53Z
- **目录日期**: 2025-04-13
