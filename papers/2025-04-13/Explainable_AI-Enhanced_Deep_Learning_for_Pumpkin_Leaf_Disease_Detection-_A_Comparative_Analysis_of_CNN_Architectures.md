...
南瓜叶病害严重影响农业生产，传统人工检测方法效率低且易出错。本研究采用包含2000张高分辨率图像的南瓜叶病害数据集（5类病害），测试了多种深度学习模型。结果显示ResNet50表现最佳，准确率达90.5%。研究还应用可解释AI技术（如Grad-CAM等）增强模型决策透明度，提高了自动化诊断的可信度。该成果为南瓜病害早期精准识别提供了有效解决方案，具有重要农业应用价值。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-13T04:29:05Z
- **目录日期**: 2025-04-13
