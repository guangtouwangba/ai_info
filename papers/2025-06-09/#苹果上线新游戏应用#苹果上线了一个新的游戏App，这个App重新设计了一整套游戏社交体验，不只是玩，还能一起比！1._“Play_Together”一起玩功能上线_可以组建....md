...
苹果新上线了一款游戏应用，重点强化社交互动功能。主要亮点包括：1）"一起玩"功能支持实时组队和查看好友游戏动态；2）新增挑战模式，支持单人或多人游戏比拼，基于排行榜机制；3）智能游戏库自动分类游戏，记录游玩历史及成就。该应用降低了游戏社交门槛，为Apple Arcade和手游玩家提供了全新的互动体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T18:02:28Z
- **目录日期**: 2025-06-09
