...
苹果推出全新游戏应用，主打社交与竞技功能。核心亮点包括：1）"一起玩"功能支持实时组队开黑，可查看好友游戏动态；2）挑战模式支持单/多人游戏比拼，基于排行榜机制；3）智能游戏库自动分类记录游玩历史与成就。该应用通过降低组队门槛、强化社交互动，为Apple Arcade和手游用户提供全新游戏体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T23:03:34Z
- **目录日期**: 2025-06-09
