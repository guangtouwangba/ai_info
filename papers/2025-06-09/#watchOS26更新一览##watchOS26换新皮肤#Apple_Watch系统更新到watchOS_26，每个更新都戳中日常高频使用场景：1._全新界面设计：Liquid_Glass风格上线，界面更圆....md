...
watchOS 26 带来多项实用更新：全新 Liquid Glass 界面设计更时尚；新增 AI 健身助手 Workout Buddy，可分析训练负荷、提供周总结和智能提醒；Workout App 优化训练自定义和音乐推荐；Smart Stack 能预测用户需求；信息功能支持实时翻译和多语言显示；新增自动音量调节、手势关闭通知等细节改进。整体聚焦高频使用场景的智能化与便捷性提升。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T19:03:10Z
- **目录日期**: 2025-06-09
