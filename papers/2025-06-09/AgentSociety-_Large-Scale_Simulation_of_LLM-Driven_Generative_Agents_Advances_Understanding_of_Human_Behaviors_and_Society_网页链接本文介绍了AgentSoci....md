...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能够模拟1万多个AI代理及其500万次社会互动。该系统通过真实社会环境模拟，研究了四大社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，验证了该系统在揭示人类行为机制方面的有效性。研究表明，AgentSociety可作为计算社会科学的有力工具，为研究者和政策制定者提供新的研究方法，补充传统调查和实验的不足。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T16:04:40Z
- **目录日期**: 2025-06-09
