...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统通过模拟1万多个AI代理及其500万次互动，研究社会现象如信息传播、政策影响等。实验结果显示其模拟结果与现实数据高度吻合，验证了该系统在社会科学研究和政策制定中的实用价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T06:03:47Z
- **目录日期**: 2025-06-09
