...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理的社会互动（500万次交互）。研究者用它研究四大社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实数据高度吻合，验证了该系统捕捉人类行为机制的能力，展现了其作为社会科学研究和政策制定工具的潜力。该系统结合了LLM智能体、真实社会环境和大规模模拟引擎，能够有效补充传统研究方法（如调查和访谈），帮助深入分析社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T21:05:02Z
- **目录日期**: 2025-06-09
