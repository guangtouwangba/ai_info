...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统模拟了10,000多个AI代理的社会互动（共500万次），用于研究社会现象如信息传播、政策影响和外部冲击。通过四个案例研究（社会极化、信息传播、基本收入政策、飓风影响），证明其模拟结果与现实数据吻合。该平台可作为社会科学研究的补充工具，帮助研究者理解人类行为机制，并为政策制定提供参考。研究展示了AI模拟在社会科学领域的应用潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T20:04:36Z
- **目录日期**: 2025-06-09
