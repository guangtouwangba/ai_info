...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理的社会互动（500万次交互）。研究者用它研究四个关键社会问题：群体极化、信息传播、基本收入政策效果和自然灾害影响。该系统模拟结果与现实世界数据吻合，验证了其捕捉人类行为机制的能力。这表明AgentSociety能有效辅助传统社会科学研究方法，帮助研究者分析社会问题成因，为政策制定提供新工具。该技术展示了大语言模型在社会模拟中的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T09:04:08Z
- **目录日期**: 2025-06-09
