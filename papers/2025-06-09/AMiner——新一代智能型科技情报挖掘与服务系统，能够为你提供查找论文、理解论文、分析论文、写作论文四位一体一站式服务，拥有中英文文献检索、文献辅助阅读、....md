...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、翻译、辅助阅读和分析。其数据库涵盖42个学科，包含3.5亿论文、0.6亿学者等资源。核心功能包括：1）智能文献搜索与摘要生成；2）AI辅助阅读，支持PDF上传和内容问答；3）科研动态订阅，按用户兴趣推送最新成果。平台还提供学者画像、学术会议等特色服务，基础功能可免费使用，旨在提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T16:05:03Z
- **目录日期**: 2025-06-09
