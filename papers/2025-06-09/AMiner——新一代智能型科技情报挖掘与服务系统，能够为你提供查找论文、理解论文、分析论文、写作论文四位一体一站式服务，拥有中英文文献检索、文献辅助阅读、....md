...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献搜索，能快速定位相关论文，并生成摘要以提高效率。平台还具备文献翻译、文档识别和互动问答功能，帮助用户深入理解内容。此外，AMiner提供科研情报订阅服务，根据用户偏好推送最新学术动态，覆盖42个学科的3.5亿论文、0.6亿学者等数据。其浏览器版本免费开放，包含学者画像、学术会议等辅助功能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T19:05:09Z
- **目录日期**: 2025-06-09
