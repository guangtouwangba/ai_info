...
AMiner是一款新一代智能科技情报挖掘与服务系统，提供四位一体的学术服务，包括论文查找、理解、分析和写作。平台支持中英文文献检索、辅助阅读、翻译等功能，涵盖42个学科的3.5亿论文、0.6亿学者和1.5亿专利。其特色功能包括互动式问答、自动摘要生成、文档识别和科研情报订阅服务，用户可通过微信或邮件获取定制化学术动态。此外，AMiner还提供学者画像、学术会议和必读论文专题等工具，浏览器检索免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T20:05:01Z
- **目录日期**: 2025-06-09
