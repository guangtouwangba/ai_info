...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译、科研情报订阅等一站式服务。它收录了3.5亿篇论文、0.6亿学者和1.5亿专利，支持中英文文献检索，并能通过AI生成摘要和问答互动。用户可上传PDF或从平台获取论文，系统会提供摘要、章节概要和问题建议。此外，AMiner支持个性化订阅，通过微信或邮件推送最新科研动态，还包含学者画像、学术会议等特色功能。平台基础功能免费，适合科研人员高效获取学术信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T04:10:47Z
- **目录日期**: 2025-06-09
