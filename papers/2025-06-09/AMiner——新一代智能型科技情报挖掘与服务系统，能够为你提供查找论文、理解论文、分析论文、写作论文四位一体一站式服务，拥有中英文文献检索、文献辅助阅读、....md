...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析和写作一站式服务。它支持中英文文献检索，能快速定位相关论文，并生成摘要和问答互动。平台具备AI辅助阅读功能，可上传PDF文档获取章节概要和问题建议。用户还能订阅个性化科研动态，跟踪机构、学者和关键词的最新成果。此外，AMiner提供学者画像、学术会议和论文排行榜等功能。平台收录3.5亿论文、0.6亿学者等海量数据，基础功能免费使用。网址：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T01:33:37Z
- **目录日期**: 2025-06-09
