...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献检索，拥有3.5亿论文、0.6亿学者等海量数据，并能通过AI生成摘要、翻译和问答互动。用户可上传PDF或从平台获取文献，系统会提供摘要、章节概要和问题建议。此外，AMiner支持科研情报订阅，按用户偏好推送最新学术动态，还能分析学者画像、学术会议等。平台免费开放使用，网址为https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T23:05:08Z
- **目录日期**: 2025-06-09
