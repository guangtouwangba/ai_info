...
苹果发表论文《The Illusion of Thinking》，批评当前大语言模型的推理能力只是"假思考"。研究通过汉诺塔等4种复杂度可调的谜题测试发现：低难度时简单模型更高效；中等难度思维链机制有效；高复杂度下所有模型（包括DeepSeek、Claude等）准确率归零。关键发现是模型在复杂任务中会主动"罢工"，暴露出其缺乏真正的逻辑泛化能力，连基础步骤执行都困难。论文质疑当前AI的"思考"本质是模板匹配，算力无法解决根本缺陷。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T05:03:41Z
- **目录日期**: 2025-06-09
