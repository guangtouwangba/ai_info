...
苹果最新论文《The Illusion of Thinking》指出，当前大语言模型（如DeepSeek、Claude等）的"思考"能力存在严重缺陷。通过汉诺塔等4个复杂度可调的谜题测试发现：低难度时非思考型模型更高效；中等难度思维链机制有效；但高复杂度下所有模型准确率归零。研究揭示模型在遇到困难时会主动"罢工"，缺乏真正的逻辑泛化能力，其推理过程实质是"模板匹配"。论文质疑现有大模型无法实现深度思考，更多算力也无法解决根本问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T04:08:14Z
- **目录日期**: 2025-06-09
