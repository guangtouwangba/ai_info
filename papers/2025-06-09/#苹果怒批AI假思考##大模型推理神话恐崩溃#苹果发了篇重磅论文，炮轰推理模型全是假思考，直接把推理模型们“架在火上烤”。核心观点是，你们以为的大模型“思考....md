...
苹果最新论文《The Illusion of Thinking》指出，当前大语言模型（如DeepSeek、Claude等）的"推理能力"本质是模板匹配而非真正思考。通过汉诺塔等4类可控实验发现：低难度时非思考模型更高效；中等难度思维链有效；高复杂度时所有模型准确率归零。关键发现是模型在复杂任务中会主动"罢工"，暴露出其缺乏泛化逻辑能力，甚至无法可靠执行既定步骤。论文质疑现有推理模型只是"假思考"，算力增长无法解决根本缺陷。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T07:03:17Z
- **目录日期**: 2025-06-09
