...
苹果最新论文《The Illusion of Thinking》指出，当前大语言模型（如DeepSeek、Claude等）的"推理能力"本质是模式匹配而非真正思考。研究通过汉诺塔等4类复杂度可调的谜题测试发现：低难度时简单模型更高效；中等难度思维链机制有效；但高复杂度时所有模型准确率归零。关键发现是模型在遇到困难时会主动"放弃思考"，暴露出其缺乏泛化逻辑能力，无法可靠执行基础推理步骤。论文质疑了大模型宣称的推理神话，认为现有技术尚未实现真正的AI思考能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T02:36:41Z
- **目录日期**: 2025-06-09
