...
苹果最新论文《The Illusion of Thinking》指出当前大语言模型（如DeepSeek、Claude等）的"思考"能力存在严重缺陷。通过汉诺塔等4种复杂度可调的谜题测试发现：低难度时非思考型模型更高效；中等难度思维链机制有效；但高复杂度时所有模型准确率归零。研究揭示模型在遇到困难时会主动停止"思考"，表明其缺乏真正的逻辑泛化能力，仅能进行模式匹配而非深度推理。该研究质疑了大模型的实际推理能力，认为现有技术仍无法实现真正的AI思考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T06:02:06Z
- **目录日期**: 2025-06-09
