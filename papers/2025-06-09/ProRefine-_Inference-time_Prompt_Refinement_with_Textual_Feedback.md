...
ProRefine是一种创新的即时提示优化方法，通过利用大语言模型(LLM)的文本反馈来改进多智能体协作工作流中的提示设计。该方法无需额外训练或真实标签，就能动态优化多步推理任务的提示。在5个数学推理基准测试中，ProRefine比零样本思维链基线性能高出3-37个百分点，显著提升了准确性。该技术不仅提高了AI系统的可靠性，还使较小模型能达到与大模型相当的性能，有助于高效、可扩展的AI部署，促进高性能AI的普及应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T00:01:42Z
- **目录日期**: 2025-06-09
