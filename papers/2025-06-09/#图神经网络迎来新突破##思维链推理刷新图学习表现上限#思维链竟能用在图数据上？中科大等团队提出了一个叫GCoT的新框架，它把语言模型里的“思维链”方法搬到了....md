...
中科大团队提出GCoT框架，首次将语言模型的"思维链"方法应用于无文本的图数据学习。该框架通过三步推理：初步推断→生成中间"思维"表示→创建节点专属提示进行迭代优化。在8个数据集测试中，GCoT仅用1-5个样本就超越现有最优模型，突破了图神经网络在少样本场景下的性能瓶颈。这一创新将思维链推理成功扩展到非文本数据结构，显著提升了图学习的表现上限。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T05:04:09Z
- **目录日期**: 2025-06-09
