...
这篇论文针对代码生成大模型(codeLLMs)提出创新评估方法，指出当前基准测试过度关注代码正确性而忽视人类偏好。研究者构建了CodeArena基准(397个样本/44种语言)模拟真实编程场景，并开发了20B标记的SynCode-Instruct合成指令集。实验发现执行基准与CodeArena存在性能差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)差距显著，凸显了人类偏好对齐的重要性。研究为代码LLM评估提供了更全面的框架，强调需同时考虑技术性能和用户体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T09:04:47Z
- **目录日期**: 2025-06-09
