...
本研究评估了视觉语言模型(VLMs)在腹腔镜手术等内窥镜任务中的表现。研究发现，VLMs能有效完成基本感知任务(如物体计数和定位)，性能与通用领域相当；但在需要医学知识的进阶任务中表现显著下降。值得注意的是，当前专用医疗VLMs在手术任务中表现不如通用模型，表明其尚未优化以适应手术环境的复杂性。该研究揭示了VLMs在手术领域面临的独特挑战，为下一代内窥镜AI系统开发提供了重要见解，并指出了医疗视觉语言模型需要改进的关键方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T20:01:12Z
- **目录日期**: 2025-06-09
