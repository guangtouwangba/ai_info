...
本研究评估了视觉语言模型(VLM)在腹腔镜手术中的表现。研究发现，VLM能有效完成基础感知任务(如物体计数和定位)，表现与通用领域相当；但在需要医学知识的任务上表现显著下降。值得注意的是，专用医疗VLM在基础和高级手术任务中均逊色于通用模型，表明其尚未适应手术环境的复杂性。该研究揭示了VLM在手术领域面临的独特挑战，为下一代内窥镜AI系统开发提供了重要见解，并指出了医疗视觉语言模型需要改进的关键方向。研究基于多组先进模型、手术数据集和专家标注展开。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T13:10:58Z
- **目录日期**: 2025-06-09
