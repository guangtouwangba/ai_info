...
本研究评估了视觉语言模型(VLM)在内窥镜手术任务中的表现。研究发现，现有VLM能较好完成基础感知任务(如物体计数和定位)，性能与通用领域相当；但在需要医学知识的进阶任务中表现显著下降。值得注意的是，专用医疗VLM在各类手术任务中表现均不如通用模型，表明其尚未针对手术环境复杂性进行优化。该研究揭示了VLM在手术领域应用的关键局限，为下一代内窥镜AI系统开发提供了重要参考，指出了医疗视觉语言模型需要重点改进的方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T23:01:21Z
- **目录日期**: 2025-06-09
