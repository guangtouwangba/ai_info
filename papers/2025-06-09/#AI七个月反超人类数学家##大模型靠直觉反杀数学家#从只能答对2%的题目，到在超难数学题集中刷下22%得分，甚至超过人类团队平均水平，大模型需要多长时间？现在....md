...
AI在7个月内大幅提升数学解题能力，在专为挑战AI设计的FrontierMath基准测试中，从最初仅能答对2%的题目进步到22%的正确率，超过人类团队平均水平。研究人员分析发现，AI并非依赖记忆，而是展现出丰富的知识储备和直觉式推理能力，但缺乏数学家的创造力和严谨证明能力。该测试包含300道高难度数学题，难度涵盖本科到菲尔兹奖级别。专家总结当前AI是一个"博学但依赖直觉的推理机"，尚存在理解深度不足和表达冗长等局限性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T16:02:46Z
- **目录日期**: 2025-06-09
