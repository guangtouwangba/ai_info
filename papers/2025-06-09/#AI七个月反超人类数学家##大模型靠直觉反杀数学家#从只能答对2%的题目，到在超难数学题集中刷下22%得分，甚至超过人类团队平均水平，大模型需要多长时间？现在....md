...
AI在7个月内从仅能答对2%的数学难题提升至22%正确率，超越人类平均水平。测试基于包含300道高难度数学题的FrontierMath基准，14位数学家分析发现，AI并非死记硬背，而是依靠直觉和广博知识储备解题，但缺乏创造力与形式化推理能力。研究总结该AI为"博学但依赖直觉的推理机"，虽能处理复杂问题，但推理过程冗长且缺乏数学家般的严谨性。这一突破引发对AI数学能力发展速度的重新思考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T18:03:33Z
- **目录日期**: 2025-06-09
