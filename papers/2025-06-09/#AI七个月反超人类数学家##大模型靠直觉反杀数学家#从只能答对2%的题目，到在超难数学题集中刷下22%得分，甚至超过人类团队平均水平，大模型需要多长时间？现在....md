...
AI在7个月内取得重大突破，在专为挑战AI设计的FrontierMath数学基准测试中，从最初仅能答对2%的题目提升到22%的正确率，超过了人类团队平均水平。研究人员分析发现，AI并非靠死记硬背，而是展现出强大的知识储备和直觉推理能力，但缺乏数学家的创造力和形式化思维。该测试包含300道高难度数学题，难度从本科水平到菲尔兹奖级别。研究指出，当前AI仍存在理解深度不足、表达冗长等局限性，但展现了直觉驱动的推理潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T11:01:44Z
- **目录日期**: 2025-06-09
