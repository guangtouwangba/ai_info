...
AI在7个月内大幅提升数学解题能力，在专为挑战AI设计的FrontierMath基准测试中，从最初仅能答对2%的题目进步到22%的正确率，甚至超过人类团队平均水平。该测试包含300个高难度数学问题。研究人员发现，AI并非依赖记忆，而是凭借广泛知识储备和直觉推理能力解题，但缺乏数学家的创造力和形式化思维。14位数学家分析认为，当前AI更像一个"博学但依赖直觉的推理机"，存在理解深度不足和表达冗长等局限。这一突破引发了对AI数学推理能力发展的新思考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T12:01:49Z
- **目录日期**: 2025-06-09
