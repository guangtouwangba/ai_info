...
本研究提出LatentSync，一种基于音频条件潜在扩散模型的端到端唇同步框架。该方法直接建模音频-视觉关系，无需中间运动表示，克服了传统两阶段方法的局限。针对扩散模型的时间一致性问题，作者开发了TREPA技术，利用自监督视频模型的时间表示来对齐生成帧。同时，通过系统性研究改进了SyncNet训练框架，提升了其收敛性和准确性。在HDTF和VoxCeleb2数据集上的实验表明，该方法在多项指标上优于现有技术。这些改进也可推广到其他音频驱动的人像动画应用中。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T10:06:08Z
- **目录日期**: 2025-06-09
