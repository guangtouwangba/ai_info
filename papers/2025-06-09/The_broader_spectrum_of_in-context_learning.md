...
本文提出了一种新视角，将语言模型的少样本学习能力置于更广泛的元学习框架中。作者认为，任何能通过上下文显著降低后续预测损失的序列分布都可视为一种上下文学习。这一观点有助于统一语言模型展现的各种上下文能力，如根据指令适应任务、角色扮演或时间序列外推等。研究还揭示了上下文学习可能源于语言依赖处理（如共指或平行结构）的低层次机制，并强调了泛化能力的重要性——包括学习新事物、适应不同呈现方式及应用所学知识。最后，作者建议未来研究应关注更广泛的上下文能力类型和泛化维度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T01:30:31Z
- **目录日期**: 2025-06-09
