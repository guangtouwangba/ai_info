...
该论文综述了针对非小细胞肺癌(NSCLC)ALK基因双靶点抑制剂的研究进展。ALK基因是NSCLC的重要致癌驱动靶点，现有7种ALK抑制剂虽获批使用，但面临耐药性问题。相比联合用药，双靶点抑制剂能同时作用于两个靶点，减少副作用并增强抗耐药性。文章系统分析了这类抑制剂的合理设计、结构-活性关系，为开发新型ALK靶向药和克服耐药性提供了重要见解。研究聚焦于通过双靶点策略优化NSCLC治疗，对推动靶向治疗发展具有重要意义。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T13:14:46Z
- **目录日期**: 2025-06-09
