...
本文提出了一种轻量级视频异常检测系统RuleVAD，专为消费电子设备设计。该系统采用解耦双分支架构：隐式分支通过视觉特征快速进行粗粒度分类，过滤正常活动；显式分支则利用YOLO-World检测物体并生成可解释的文本关联规则，实现细粒度分类，降低误报率。在XD-Violence和UCF-Crime基准测试中，RuleVAD在准确性和速度上均优于现有方法。该系统优化了低功耗运行，可完全部署在NVIDIA Jetson Nano等边缘设备上，为智能家居摄像头等消费电子产品提供实时安全监控解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T13:12:23Z
- **目录日期**: 2025-06-09
