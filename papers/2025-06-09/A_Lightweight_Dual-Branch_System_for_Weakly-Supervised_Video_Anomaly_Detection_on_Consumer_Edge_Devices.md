...
本文提出了一种轻量级视频异常检测系统RuleVAD，专为消费电子设备设计。该系统采用创新的双分支架构：隐式分支通过视觉特征快速过滤正常活动；显式分支则结合YOLO-World物体检测和数据挖掘生成可解释的文本关联规则，实现细粒度分类。实验表明，RuleVAD在XD-Violence和UCF-Crime数据集上性能优于现有方法，同时优化了计算效率，可在NVIDIA Jetson Nano等低功耗设备上实时运行，有效降低了误报率，为智能家居等场景提供了实用的实时安全监控解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T23:02:23Z
- **目录日期**: 2025-06-09
