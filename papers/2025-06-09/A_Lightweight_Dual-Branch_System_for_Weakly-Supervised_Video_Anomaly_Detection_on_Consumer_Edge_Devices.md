...
本文提出了一种轻量级视频异常检测系统RuleVAD，专为消费电子设备设计。该系统采用解耦双分支架构：隐式分支通过视觉特征快速二分类过滤正常活动；显式分支利用YOLO-World检测物体并生成可解释的文本关联规则，实现细粒度分类，降低误报率。在XD-Violence和UCF-Crime数据集上的实验表明，RuleVAD在精度和速度上均优于现有方法，且可部署在NVIDIA Jetson Nano等低功耗设备上，为智能家居等场景提供实时高效的安全监控方案。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T22:02:45Z
- **目录日期**: 2025-06-09
