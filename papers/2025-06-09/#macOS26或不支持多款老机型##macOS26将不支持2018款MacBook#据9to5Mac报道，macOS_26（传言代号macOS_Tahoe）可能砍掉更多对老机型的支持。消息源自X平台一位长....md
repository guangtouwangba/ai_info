...
据爆料，macOS 26可能停止支持多款Intel老机型，包括2020款13寸MacBook Pro（双雷电口）、2018款MacBook Pro全系、2018款Mac mini等。这些机型多采用Intel第8代处理器，属于苹果向自研芯片过渡期的产品。新系统预计仅支持M1及后续芯片机型，以及2019年后部分Intel机型。若属实，苹果正加速淘汰"外观新但芯片旧"的过渡产品。最终兼容名单需待WWDC 2025官方确认。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T04:07:55Z
- **目录日期**: 2025-06-09
