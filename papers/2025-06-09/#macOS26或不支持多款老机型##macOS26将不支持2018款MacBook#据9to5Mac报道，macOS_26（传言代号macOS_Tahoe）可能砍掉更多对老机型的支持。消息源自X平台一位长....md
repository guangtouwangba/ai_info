# #macOS26或不支持多款老机型##macOS26将不支持2018款MacBook#据9to5Mac报道，macOS 26（传言代号macOS Tahoe）可能砍掉更多对老机型的支持。消息源自X平台一位长...
...
据爆料，macOS 26（代号Tahoe）可能停止支持多款Intel老机型，包括2020款双雷电口MacBook Pro（搭载第8代Intel芯片）、2018款MacBook Pro全系、2018款Mac mini等。支持列表预计仅保留2019年后机型及所有Apple Silicon设备。这显示苹果正逐步淘汰"外观新但芯片旧"的过渡产品，尤其是2020年前后的Intel末代机型。最终兼容名单需待WWDC 2025确认。（98字）  

关键点：  
1. 受影响机型集中在2017-2020年Intel芯片产品  
2. 2020款双雷电MacBook Pro因沿用2018款架构面临淘汰  
3. Apple Silicon设备全系兼容  
4. 反映苹果加速清理Intel过渡机型
