...
该研究提出了视觉图竞技场(VGA)数据集，包含6项基于图的任务，用于评估AI系统的视觉抽象能力。研究发现人类在各项任务中表现近乎完美，而当前最先进的视觉模型和多模态大语言模型在图同构检测上完全失败，在路径/循环任务中表现有限。结果表明当前AI模型存在伪智能模式匹配而非真正理解的根本局限。VGA通过隔离表示不变推理的挑战，为推进AI视觉模型实现类人概念化提供了框架。数据集地址：vga.csail.mit.edu。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T17:01:24Z
- **目录日期**: 2025-06-09
