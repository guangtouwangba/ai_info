...
该研究介绍了视觉图竞技场（VGA）数据集，包含6个基于图的任务，用于评估AI系统在视觉抽象概念化方面的能力。VGA通过不同图布局（如Kamada-Kawai与平面图）测试模型独立于视觉形式的推理能力。实验发现人类在任务中表现近乎完美，而最先进的视觉模型和多模态大语言模型在检测同构性上完全失败，在路径/循环任务中表现有限，表明其仅具备伪智能模式匹配而非真正理解。该研究揭示了当前AI视觉理解的根本局限，为开发类人概念化AI提供了框架。VGA数据集已公开。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T22:01:18Z
- **目录日期**: 2025-06-09
