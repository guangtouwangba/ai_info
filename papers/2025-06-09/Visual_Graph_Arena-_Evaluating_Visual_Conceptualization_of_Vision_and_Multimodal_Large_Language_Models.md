...
该研究提出了视觉图竞技场（VGA）数据集，包含6个基于图的任务，用于评估AI系统在视觉抽象概念化方面的能力。研究发现，人类在这些任务中表现近乎完美，而现有最先进的视觉模型和多模态大语言模型在图形同构检测上完全失败，在路径/循环任务中表现有限，表明它们依赖伪智能模式匹配而非真正理解。VGA通过使用不同图形布局来测试与视觉形式无关的推理能力，揭示了当前AI在视觉理解上的根本局限，为开发更接近人类概念化能力的AI视觉模型提供了框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T20:01:04Z
- **目录日期**: 2025-06-09
