...
该研究提出了视觉图竞技场（VGA）数据集，包含6个基于图的任务，用于评估AI系统在视觉抽象概念化方面的能力。VGA通过不同图形布局（如Kamada-Kawai与平面图）测试模型独立于视觉形式的推理能力。实验发现人类在任务中近乎完美，而最先进的视觉模型和多模态大语言模型在图同构检测中完全失败，在路径/循环任务中表现有限。研究揭示了当前AI模型存在伪智能模式匹配而非真正理解的根本局限。VGA为推进AI视觉模型实现类人概念化提供了评估框架。数据集地址：vga.csail.mit.edu

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T02:34:41Z
- **目录日期**: 2025-06-09
