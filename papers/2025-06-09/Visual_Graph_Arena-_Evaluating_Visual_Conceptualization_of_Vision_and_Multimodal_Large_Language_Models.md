...
该研究提出了视觉图竞技场（VGA）数据集，包含6个基于图的任务，用于评估AI系统在视觉抽象和概念化方面的能力。实验发现，人类在各项任务中表现近乎完美，而当前最先进的视觉模型和多模态大语言模型在图同构检测上完全失败，在路径/循环任务中表现有限。结果表明，AI系统可能依赖伪智能模式匹配而非真正的理解。VGA通过隔离表征不变推理的挑战，为提升AI视觉模型的人类级概念化能力提供了框架。数据集已公开：vga.csail.mit.edu。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T19:01:08Z
- **目录日期**: 2025-06-09
