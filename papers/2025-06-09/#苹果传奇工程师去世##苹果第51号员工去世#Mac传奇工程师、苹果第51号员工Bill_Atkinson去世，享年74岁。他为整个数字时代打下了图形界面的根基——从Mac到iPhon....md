# #苹果传奇工程师去世##苹果第51号员工去世#Mac传奇工程师、苹果第51号员工Bill Atkinson去世，享年74岁。他为整个数字时代打下了图形界面的根基——从Mac到iPhon...
...
苹果传奇工程师Bill Atkinson去世，享年74岁。作为苹果第51号员工，他开发了奠定现代图形界面基础的QuickDraw引擎，创造了MacPaint（首款图形编辑器）和HyperCard（超链接雏形）。他参与设计的交互方式（如下拉菜单、双击操作）至今仍是数字界面核心。其创办的General Magic项目预言了智能手机形态。Atkinson与乔布斯共同塑造了"苹果风格"美学（如圆角窗口）。值得注意的是，Mac团队三大核心人物（Jobs、Raskin、Atkinson）均因胰腺癌离世。他的创新彻底改变了人机交互方式，让电脑从专业工具变为大众化设备。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T05:03:33Z
- **目录日期**: 2025-06-09
