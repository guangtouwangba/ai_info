...
苹果传奇工程师Bill Atkinson去世，享年74岁。作为苹果第51号员工，他开创了现代图形界面的基础，开发了QuickDraw引擎和MacPaint图形编辑器，定义了点击、拖拽等基础交互方式。他参与设计的HyperCard孕育了超链接概念，其创办的General Magic更是智能手机理念的先驱。Atkinson与乔布斯密切合作，将圆角设计等美学元素融入Mac系统。作为数字时代图形界面的奠基人，他让电脑从专业工具变为大众化产品，深刻影响了从Mac到iPhone的交互体验。他与乔布斯等Mac核心成员均因胰腺癌去世，令人唏嘘。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T06:01:56Z
- **目录日期**: 2025-06-09
