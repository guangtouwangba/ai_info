...
最新神经研究表明，大脑在思考时仅比休息状态多消耗5%的能量，但思考仍会让人感到疲惫。这是因为大脑在空闲时已消耗95%的能量用于维持基本生理功能。虽然集中注意力只增加少量能耗，但进化使大脑对能量使用极为敏感，会主动触发疲劳机制以防止过度消耗。大脑仅占体重2%却消耗全身20%的能量，这种高效节能的设计是为了在资源稀缺的环境中生存。因此，思考时的疲惫感并非真正能量不足，而是大脑的自我保护机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T18:03:17Z
- **目录日期**: 2025-06-09
