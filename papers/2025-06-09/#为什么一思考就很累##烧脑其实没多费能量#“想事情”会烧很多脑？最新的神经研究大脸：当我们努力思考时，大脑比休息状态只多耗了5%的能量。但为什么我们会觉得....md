...
最新神经研究表明，大脑在思考时仅比休息状态多消耗5%的能量，但人类仍会感到"脑力枯竭"。这是因为：1）大脑95%能量用于维持基础生命活动；2）进化使大脑对额外能耗极其敏感，5%的增幅在原始环境中可能影响生存；3）大脑仅占体重2%却消耗20%能量，采用高效节能模式；4）疲劳感是大脑的自我保护机制，防止过度消耗。这种"限电"机制源于进化压力，说明大脑始终在为生存进行能量预算，即使休息时也处于高负荷状态。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T12:01:24Z
- **目录日期**: 2025-06-09
