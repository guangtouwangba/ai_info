...
2024年智源大会（AI春晚）亮点纷呈：1）机器人展演：宇树G1人形机器人展示拳击能力，天工机器人2.0版演示家政技能；银河通用机器人实现语音指令完成取货全流程。2）学术前沿：四位图灵奖得主（Bengio、Sutton、姚期智、Sifakis）同台分享AI洞见。活动呈现科研与应用的深度融合，彰显AI技术快速落地趋势。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T00:03:56Z
- **目录日期**: 2025-06-09
