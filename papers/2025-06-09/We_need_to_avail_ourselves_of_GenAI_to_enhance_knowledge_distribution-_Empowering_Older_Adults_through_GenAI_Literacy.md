...
随着生成式AI（GenAI）普及，提升用户（尤其是老年人等弱势群体）对AI利弊的认知至关重要。本研究通过聊天机器人Litti探索面向老年人的AI素养教育策略，采用混合方法评估其对AI知识、安全及伦理认知的影响。定量数据显示AI素养有提升趋势（未达显著水平），定性访谈则揭示参与者对GenAI的认知差异及强烈学习意愿。尽管Litti提供了积极学习体验，但未能显著增强参与者对GenAI的信任或安全感。该案例研究凸显了为老年群体设计AI教育的挑战与机遇。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T20:01:22Z
- **目录日期**: 2025-06-09
