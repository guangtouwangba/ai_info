...
随着生成式AI（GenAI）的普及，帮助老年人（65岁及以上）等弱势群体理解其益处和风险至关重要。本研究通过聊天机器人Litti探索了向老年人提供GenAI教育的策略，评估其对AI素养（知识、安全与伦理）的影响。定量数据显示AI素养有提升趋势，但不显著；定性访谈则表明参与者对GenAI熟悉度差异较大，但学习意愿强烈。研究发现，尽管Litti提供了积极的学习体验，但并未显著提升参与者对GenAI的信任或安全感。这项探索性案例研究揭示了为老年人设计AI教育的挑战与机遇。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T02:35:03Z
- **目录日期**: 2025-06-09
