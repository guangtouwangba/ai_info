...
本研究探讨了通过聊天机器人Litti向老年人（65岁及以上）普及生成式AI（GenAI）知识的策略。采用混合方法评估发现，虽然定量数据显示AI素养（知识、安全和伦理使用）有改善趋势，但结果未达显著水平。定性访谈则揭示老年人对GenAI的熟悉程度差异较大，但学习意愿强烈。研究显示，Litti虽提供了积极的学习体验，但未能显著提升参与者对GenAI的信任或安全感。这项探索性案例研究凸显了为快速增长老年群体设计AI教育的挑战与机遇。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T23:01:29Z
- **目录日期**: 2025-06-09
