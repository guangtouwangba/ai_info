...
本研究探讨了通过聊天机器人Litti向老年人（65岁及以上）普及生成式AI（GenAI）知识的策略。研究发现，尽管定量数据显示AI素养（知识、安全和伦理使用）有提升趋势，但效果不显著。定性访谈显示老年人对GenAI的熟悉程度不一，但学习意愿强烈。Litti提供了积极的学习体验，但未显著提升参与者对GenAI的信任或安全感。这项探索性案例研究揭示了为快速增长老年人口设计AI素养教育的挑战与机遇，强调需针对其需求优化教育方式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T03:26:32Z
- **目录日期**: 2025-06-09
