...
本研究探讨了通过聊天机器人Litti向老年人(65岁及以上)提供生成式AI(GAI)教育的策略。采用混合方法研究发现，虽然定量数据显示参与者AI素养(知识、安全、伦理)有提升趋势但不显著，但定性访谈揭示了老年人对GAI的不同熟悉程度和强烈学习意愿。研究显示Litti提供了积极学习体验，但未能显著提升参与者对GAI的信任感或安全感。这项探索性案例研究凸显了为快速增长老年群体设计AI素养教育面临的挑战与机遇，强调需要针对这一特殊群体开发更有效的技术教育方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T05:01:57Z
- **目录日期**: 2025-06-09
