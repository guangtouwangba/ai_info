# #苹果VisionPro升级盘点##visionOS26空间体验卷出新高度#Apple刚刚更新了Vision Pro的系统——visionOS 26，带来一堆新功能，特别是空间体验这块，升级相当明显...
...
苹果Vision Pro最新visionOS 26系统带来显著空间体验升级：AI可将2D照片转为3D立体图像；虚拟形象Persona更逼真且本地生成；新增空间浏览模式，网页元素可拖拽至3D空间；支持多设备共享体验；企业设备池和个人设置迁移功能；空间小组件自由定制；新增木星表面沉浸环境和180°视频支持；兼容Logitech 3D绘图笔和PS VR2手柄等外设；优化眼动追踪、90Hz刷新率及3D模型交互。该系统强化了混合现实办公与生活场景，推动空间计算体验进入新阶段。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T19:02:53Z
- **目录日期**: 2025-06-09
