...
苹果Vision Pro最新visionOS 26系统带来多项空间体验升级：AI可将2D照片转为立体3D图像；虚拟形象Persona更逼真；Safari新增空间浏览模式；支持多设备共享体验；企业可共享设备池；新增空间小组件和木星沉浸环境；支持Logitech 3D绘图笔和PS VR2手柄等外设；新增眼神滚动、90Hz刷新率等功能。系统强化了混合现实操作体验，向空间办公和生活场景迈进。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T21:03:15Z
- **目录日期**: 2025-06-09
