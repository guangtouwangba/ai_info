# #macOS换上新皮肤##macOS桌面可个性化到毛孔#macOS 26正式命名为macOS Tahoe，这次主打一个词：通透感。除了整体设计上的“焕然一新”，不少细节也做了精致升级...
...
macOS 26正式命名为macOS Tahoe，主打"通透感"设计升级。新系统采用Liquid Glass效果使图标、Dock和小组件呈现半透明镜面光泽，菜单栏全透明处理增强视觉空间感。个性化功能大幅提升，支持文件夹换色、添加自定义表情，图标和小组件可自由调整。快捷指令(Shortcuts)新增定时/行为触发功能，并深度集成Apple Intelligence，支持调用ChatGPT。整体而言，macOS Tahoe通过美学设计革新和智能化功能升级，为用户带来更直观、个性化的桌面体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T22:03:32Z
- **目录日期**: 2025-06-09
