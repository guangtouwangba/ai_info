# #一图盘点苹果AI新功能##AppleIntelligence都有哪些更新#Apple Intelligence到底上了哪些新功能？【图1】咱们来一网打尽：- 系统原生功能升级： - 支持ChatGPT整...
...
苹果AI新功能Apple Intelligence全面升级：整合ChatGPT支持图像生成；Siri更智能，具备视觉识别和知识问答；新增智能摘要、自然语言图片搜索等功能。通知系统智能化，支持自动分类和优先提醒。创意工具新增Genmoji混搭emoji、个性化写作和影像生成。开发者可使用Foundation Models框架调用底层AI能力，Xcode加入AI代码预测。新设计语言Liquid Glass和增强的App Intents接口助力开发。苹果将AI深度融入iOS系统，提升用户体验和开发效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T21:02:58Z
- **目录日期**: 2025-06-09
