...
这篇论文开发了一种异步LLM智能体，不仅能决定说什么，还能决定何时发言。研究者收集了在线Mafia游戏数据集进行评估，发现该智能体的游戏表现和融入人类玩家的能力与真人相当。分析表明，智能体的发言时机选择与人类相似，但消息内容存在差异。该研究为LLM融入真实人类群体场景（如团队讨论、教育环境等）铺平了道路，并公开了所有数据和代码以促进更真实的异步通信研究。这项工作突破了当前LLM主要应用于同步对话的局限，使其能适应无固定轮次的复杂社交动态场景。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T01:29:26Z
- **目录日期**: 2025-06-09
