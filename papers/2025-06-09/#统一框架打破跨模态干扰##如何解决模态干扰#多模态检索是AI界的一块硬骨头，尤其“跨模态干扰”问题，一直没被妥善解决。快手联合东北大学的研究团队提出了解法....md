...
快手与东北大学团队提出UNITE统一嵌入框架，通过模态感知对比学习解决多模态检索中的跨模态干扰问题。该框架采用两阶段训练：检索适应建立基础能力，指令微调增强复杂任务处理。UNITE在图文/视频检索任务中表现优异，7B模型超越多个更大规模模型，并发现视频-文本数据具有统一模态潜力。研究显示细粒度文本-视频样本对训练效果最佳。论文及代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T05:04:01Z
- **目录日期**: 2025-06-09
