...
iOS26系统兼容机型公布，支持iPhone16全系、15/14/13/12/11系列（含Pro/Max机型）及SE2/3代，最低要求A13芯片。这意味着搭载A12芯片的iPhone XR/XS/XS Max将不再获得系统更新，正式退出支持名单。此次系统门槛提升幅度较大，导致仍在广泛使用的XR/XS系列无法升级。虽然这些机型仍可继续使用iOS25系统，但将无法体验新功能。建议用户在升级前确认App适配情况，老机型用户无需急于更换设备。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T20:02:28Z
- **目录日期**: 2025-06-09
