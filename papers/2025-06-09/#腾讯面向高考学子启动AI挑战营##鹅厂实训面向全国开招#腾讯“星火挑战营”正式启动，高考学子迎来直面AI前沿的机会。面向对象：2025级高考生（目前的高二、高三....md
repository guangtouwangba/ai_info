...
腾讯推出"星火挑战营"，面向2025级高考生（高二、高三）招募60-70人，6月13日截止报名。活动将于2025年8月8-14日在深圳举行，聚焦AI前沿技术：1）超长文本理解（微信读书AI团队指导）；2）长思维链技术（OpenAI o1/DeepSeek式推理）；3）具身智能+机器人（腾讯Robotics X实验室）；4）多模态感知（优图实验室）。优先录取数学/物理/信息学奥赛获奖者、重点高校预录生及科技赛事优胜者。活动旨在让高中生直接参与大模型、机器人等尖端AI研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T02:36:53Z
- **目录日期**: 2025-06-09
