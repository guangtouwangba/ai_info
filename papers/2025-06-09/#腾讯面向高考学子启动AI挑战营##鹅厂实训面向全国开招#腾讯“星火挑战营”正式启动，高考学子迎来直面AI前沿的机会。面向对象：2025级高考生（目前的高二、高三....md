...
腾讯推出"星火挑战营"，面向2025级高考生（高二、高三）招募60-70人，报名截止6月13日。活动将于2025年8月8-14日在深圳举行，聚焦四大AI前沿领域：1）微信读书团队指导的超长文本理解；2）模仿OpenAI的长思维链技术；3）腾讯Robotics X实验室的具身智能与机器人；4）优图实验室的多模态感知理解。优先录取有奥赛成绩、重点高校预录取资格或科技赛事成果的学生。活动旨在让高中生接触AI尖端技术，涵盖大模型、机器人等热门研究方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T00:02:48Z
- **目录日期**: 2025-06-09
