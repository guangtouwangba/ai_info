...
腾讯启动"星火挑战营"，面向2025级高考生（现高二、高三）招募60-70人，6月13日截止报名。营期定于2025年8月8-14日在深圳举行，聚焦AI四大前沿方向：1）微信读书团队指导的超长文本理解；2）OpenAI式长思维链技术；3）Robotics X实验室的具身智能与机器人；4）优图实验室的多模态感知理解。优先录取数学/物理/信息学特长生，尤其是有奥赛成绩、高校预录资格或科技赛事成果者。活动提供高中生接触大模型、具身智能等尖端技术的研究机会。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T03:28:46Z
- **目录日期**: 2025-06-09
