...
腾讯启动"星火挑战营"，面向2025级高考生（高二、高三）招募60-70人，优先录取数学/物理/信息学特长生（含奥赛获奖者）。营期定于2025年8月8-14日在深圳举办，报名截止6月13日。项目聚焦四大AI前沿领域：1）微信读书团队指导的超长文本理解；2）OpenAI/DeepSeek式的长思维链技术；3）腾讯Robotics X实验室的具身智能机器人；4）优图实验室的多模态情绪识别。入选者将直接参与大模型、机器人等尖端技术实践。（注：含3张宣传图片未在摘要中体现）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T06:02:16Z
- **目录日期**: 2025-06-09
