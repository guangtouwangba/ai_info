...
腾讯面向2025级高考生（现高二、高三）启动"星火挑战营"，聚焦AI前沿技术，招募60-70人（8月8-14日，深圳）。活动涵盖四大方向：1）微信读书团队指导的超长文本理解；2）OpenAI/DeepSeek式的长思维链技术；3）腾讯Robotics X实验室的具身智能+机器人；4）优图实验室的多模态感知理解。优先录取有奥赛成绩、重点高校预录资格或科技赛事成果者，报名截止6月13日。该项目旨在让高中生直接参与大模型、机器人等尖端AI研究。（注：图片内容未纳入摘要）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T05:03:53Z
- **目录日期**: 2025-06-09
