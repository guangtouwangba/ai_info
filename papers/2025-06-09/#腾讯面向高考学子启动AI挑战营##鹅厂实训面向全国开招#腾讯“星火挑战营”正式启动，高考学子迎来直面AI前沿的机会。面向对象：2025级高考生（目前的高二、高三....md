...
腾讯推出"星火挑战营"，面向2025级高考生（高二、高三）招募60-70人，6月13日截止报名。活动将于2025年8月8-14日在深圳举行，聚焦四大AI前沿方向：1）微信读书团队指导的超长文本理解；2）OpenAI风格的复杂推理拆解技术；3）腾讯Robotics X实验室的具身智能与机器人交互；4）优图实验室的多模态情绪识别。优先考虑数学/物理/信息学竞赛获奖者、重点高校预录取学生及科技赛事优胜者。该项目为高中生提供接触顶尖AI研究的实践机会。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T04:08:26Z
- **目录日期**: 2025-06-09
