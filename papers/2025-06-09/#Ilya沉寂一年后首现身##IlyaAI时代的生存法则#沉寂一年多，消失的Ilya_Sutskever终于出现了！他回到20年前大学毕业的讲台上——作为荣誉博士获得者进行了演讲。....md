...
OpenAI前首席科学家Ilya Sutskever沉寂一年后首次公开亮相，在其母校多伦多大学获颁荣誉理学博士学位并发表演讲。他未提及创业进展或AGI时间表，而是分享了AI时代的生存法则：接受AI终将具备人类全部能力的现实，不沉溺过去，专注当下改善。此次演讲是他离开OpenAI后的首次公开活动，多伦多大学表彰了他在AI领域的奠基性贡献及对负责任AI发展的倡导。尽管演讲仅10分钟，但引发广泛关注，网友对其复出表示振奋。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T14:03:04Z
- **目录日期**: 2025-06-09
