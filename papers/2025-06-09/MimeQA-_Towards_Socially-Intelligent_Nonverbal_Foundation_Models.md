...
随着AI日益融入日常生活，开发具备社交智能的AI系统变得至关重要。当前AI社交推理主要依赖语言数据，导致系统虽擅长语言交流，却难以理解非语言社交信号。为此，研究者创新性地利用哑剧视频（无语言仅靠肢体动作表达）构建了MimeQA数据集：包含8小时YouTube视频和806个精心标注的QA对，专门测试非语言社交推理能力。评估显示，当前视频大语言模型(vLLM)准确率仅20-30%，远低于人类的86%。分析发现vLLM常无法理解虚拟物体，过度依赖文本提示而忽略细微非语言互动。该研究为开发真正理解非语言交互的社交智能AI开辟了新方向。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T13:12:11Z
- **目录日期**: 2025-06-09
