...
随着AI日益融入日常生活，开发具备社交智能、能理解非语言互动的AI变得至关重要。当前AI社交推理主要依赖语言模型，导致系统擅长语言交流却难以理解非语言社交信号。为此，研究者利用哑剧视频（完全依赖肢体动作表达）构建了MimeQA数据集，包含8小时视频和806个标注问答对，专门测试非语言社交推理能力。实验发现，当前视频大语言模型(vLLM)准确率仅20-30%（人类达86%），主要问题在于难以想象虚拟物体、过度依赖文本提示而忽略细微非语言互动。该研究为开发真正理解非语言交互的社交智能AI指明了方向。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T20:02:08Z
- **目录日期**: 2025-06-09
