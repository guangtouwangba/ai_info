...
当前AI社交推理主要依赖语言方式，导致非语言社交理解能力不足。为解决这一问题，研究团队利用哑剧视频（无语言表达）创建了MimeQA数据集，包含8小时YouTube视频和806个标注问答对，专门测试非语言社交推理能力。评估发现，主流视频大语言模型(vLLMs)准确率仅20-30%，远低于人类的86%。分析表明，vLLMs难以理解想象物体，过度依赖文本提示而忽略细微非语言互动。该研究旨在推动AI发展真正的社交智能，提升非语言交互理解能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T22:02:35Z
- **目录日期**: 2025-06-09
