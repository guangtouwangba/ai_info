...
随着AI日益融入日常生活，开发具备社交智能的AI系统变得至关重要。当前AI社交推理主要依赖语言处理，导致系统在非语言社交理解方面存在不足。为此，研究者利用哑剧视频这一富含非语言互动的数据源，创建了MimeQA数据集（含8小时视频和806个问答对），用于评估非语言社交推理能力。测试发现，现有视频大语言模型(vLLM)准确率仅20-30%（人类为86%），主要问题在于难以理解想象物体和过度依赖文本提示。该研究旨在推动能真正理解非语言互动的AI系统发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T16:02:09Z
- **目录日期**: 2025-06-09
