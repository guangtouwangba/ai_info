...
该博士论文研究AI增强的团队优化框架，旨在提升团队满意度、参与度和绩效。首先提出基于多臂老虎机算法的团队组建框架，通过迭代优化成员偏好与团队目标的匹配。其次开发AI反馈助手tAIfa，利用大语言模型为团队和个人提供实时个性化反馈以增强凝聚力。最后构建PuppeteerLLM模拟框架，通过多智能体建模真实环境中的复杂团队动态。研究解决了现有方法依赖静态数据、忽略成员个性动态变化等问题，为团队组建和持续协作提供智能化解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T19:01:40Z
- **目录日期**: 2025-06-09
