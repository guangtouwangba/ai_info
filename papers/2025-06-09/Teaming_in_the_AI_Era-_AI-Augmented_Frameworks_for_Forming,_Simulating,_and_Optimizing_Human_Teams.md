...
该研究旨在开发AI增强的团队优化框架，解决团队组建和协作中的关键问题。首先提出基于多臂老虎机算法的团队组建框架，通过迭代优化成员偏好与任务目标的匹配来提升满意度；其次开发AI助手tAIfa，利用大语言模型为团队和个人提供实时个性化反馈以增强凝聚力；最后构建PuppeteerLLM模拟框架，通过多智能体建模来研究复杂团队动态。这些方法突破了传统静态优化工具的局限，能够适应成员个性、目标演变和偏好变化的动态交互，从而系统性提升团队满意度、参与度和整体绩效。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T18:01:34Z
- **目录日期**: 2025-06-09
