...
该研究旨在开发AI增强的团队优化框架，以提升团队满意度、参与度和整体表现。针对团队组建阶段，提出基于多臂老虎机算法的动态优化框架，平衡成员偏好与任务目标；在团队执行阶段，开发了AI反馈助手tAIfa，利用大语言模型提供个性化实时反馈以增强凝聚力；最后构建PuppeteerLLM模拟框架，通过多智能体建模来研究复杂团队动态。研究解决了传统方法依赖静态数据、忽视成员个性动态变化等问题，通过迭代优化和即时干预，有效改善算法分配导致的成员承诺不足和参与度低下问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T02:35:26Z
- **目录日期**: 2025-06-09
