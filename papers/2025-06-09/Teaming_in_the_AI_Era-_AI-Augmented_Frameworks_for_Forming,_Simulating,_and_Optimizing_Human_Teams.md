...
该研究旨在开发AI增强的团队优化框架，以提升团队满意度、参与度和绩效。首先提出基于多臂老虎机算法的团队组建框架，通过迭代优化成员偏好与团队目标的匹配；其次开发AI反馈助手tAIfa，利用大语言模型提供个性化实时反馈；最后构建PuppeteerLLM模拟框架，通过多智能体建模模拟真实环境中的复杂团队动态。研究解决了现有方法依赖静态数据、目标单一、缺乏动态适应性等问题，可有效改善传统算法分配导致的成员满意度低、参与度不足等问题，为团队全生命周期提供智能化支持。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-09T10:01:48Z
- **目录日期**: 2025-06-09
