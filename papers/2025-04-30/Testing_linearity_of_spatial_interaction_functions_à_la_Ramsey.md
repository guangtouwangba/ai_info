...
本文提出了一种计算简便的空间交互函数线性检验方法。该方法基于拉格朗日乘数原理，采用非参数方式构建条件异方差稳健检验，类似于Ramsey RESET方法，仅需在原假设下估计线性空间自回归模型。蒙特卡洛模拟显示该方法具有良好的尺寸控制和检验功效。通过芬兰数据的实证研究，该方法成功揭示了相邻城市间是否存在税收竞争，验证了其实际应用价值。这种检验方法适用于从业者设定的规范或代理优化行为产生的空间交互函数，为相关研究提供了有效的分析工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T20:02:15Z
- **目录日期**: 2025-04-30
