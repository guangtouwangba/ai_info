...
本文提出了一种计算简便的空间交互函数线性检验方法。该检验基于拉格朗日乘数原理，采用非参数方法且对条件异方差具有稳健性，类似于Ramsey RESET检验思路。其优势在于只需在原假设下估计线性空间自回归模型，简化了计算过程。蒙特卡洛模拟显示该方法具有良好的尺寸控制和检验功效。通过对芬兰数据的实证研究，该方法有效验证了相邻城市间是否存在税收竞争，展示了其实际应用价值。该检验适用于分析空间交互关系的线性特征，为相关决策和研究提供了可靠工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T16:02:34Z
- **目录日期**: 2025-04-30
