...
本文提出了一种计算简便的空间交互函数线性检验方法。该检验基于拉格朗日乘数原理，采用非参数方法且具有条件异方差稳健性，类似于Ramsey RESET检验思路，仅需在原假设下估计线性空间自回归模型。蒙特卡洛模拟显示该方法具有良好的尺寸控制和检验功效。通过芬兰数据的实证研究，该方法有效验证了相邻城市间是否存在税收竞争，展示了其实际应用价值。该方法适用于分析由实践者设定或代理人优化行为产生的空间交互函数，为相关研究提供了简便可靠的线性检验工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T13:09:44Z
- **目录日期**: 2025-04-30
