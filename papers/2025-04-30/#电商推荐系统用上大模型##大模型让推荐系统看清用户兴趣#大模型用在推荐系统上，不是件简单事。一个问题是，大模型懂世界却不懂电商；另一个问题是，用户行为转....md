...
阿里妈妈推出URM"世界知识大模型"，解决大模型在电商推荐中的两大难题：缺乏领域知识和用户行为数据冗长。该模型融合大语言模型的通用能力与电商专业知识，能深度理解用户兴趣并进行推理。例如，能结合"儿童新年衣服"的搜索语境，识别用户宝妈身份，优先推荐节日童装而非其常浏览的女装。系统可实时生成情境化推荐，实现更精准的个性化服务。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T15:04:20Z
- **目录日期**: 2025-04-30
