...
阿里妈妈推出URM世界知识大模型，解决电商推荐系统两大难题：大模型缺乏电商领域知识，以及用户行为数据冗长难处理。URM结合大模型的通用能力和电商专业知识，能深度理解用户兴趣并实时生成精准推荐。例如，当用户搜索"儿童新年衣服"时，系统能识别用户身份（宝妈）和场景需求（新年），优先推荐相关商品而非近期浏览记录。该技术实现了对用户行为的"推理级"理解，显著提升推荐准确性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T18:04:00Z
- **目录日期**: 2025-04-30
