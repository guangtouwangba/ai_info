...
阿里妈妈推出世界知识大模型URM，解决大模型在电商推荐中的两大难题：缺乏领域知识和用户行为文本冗长。URM结合大模型的通用知识与电商场景，能对用户兴趣进行"推理级"理解。例如，搜索"儿童新年衣服"时，系统能识别用户是宝妈，并优先推荐新年款而非近期浏览的女装。该模型通过理解用户历史和实时语境，生成精准推荐，提升电商个性化体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T23:04:00Z
- **目录日期**: 2025-04-30
