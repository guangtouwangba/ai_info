...
阿里妈妈推出URM（世界知识大模型），解决大模型在电商推荐中的两大难题：缺乏领域知识和用户行为数据冗长。URM结合通用大模型能力与电商专业知识，实现"推理级"用户兴趣理解。它能分析用户历史行为并结合实时语境生成精准推荐，例如识别"儿童新年衣服"搜索背后的宝妈身份，优先推荐节日款而非近期浏览的牛仔裤。这一技术提升了电商推荐的个性化和场景适配能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T10:03:56Z
- **目录日期**: 2025-04-30
