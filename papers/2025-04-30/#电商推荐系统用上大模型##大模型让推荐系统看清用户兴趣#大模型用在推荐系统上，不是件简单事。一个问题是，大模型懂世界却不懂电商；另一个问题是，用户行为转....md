...
阿里妈妈推出URM世界知识大模型，解决大模型在电商推荐中的两大难题：缺乏领域知识和用户行为数据冗长。URM结合大模型的通用能力和电商专业知识，能深度理解用户兴趣并实时生成精准推荐。例如，识别"儿童新年衣服"搜索背后的宝妈身份，结合节日语境优先推荐相关商品，而非用户近期浏览记录。该技术实现了对用户需求的推理级解析，提升推荐系统的场景化适配能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T16:04:14Z
- **目录日期**: 2025-04-30
