...
该研究提出XPG-RL强化学习框架，用于解决杂乱环境中的机械搜索难题。该框架结合任务驱动的动作优先级机制与情境感知切换策略，动态选择抓取、移障或视角调整等基础动作。其策略模块能自适应输出动作选择阈值，感知模块融合RGB-D数据与语义几何特征生成结构化场景表征。实验表明，XPG-RL在任务成功率和运动效率上显著优于基线方法，长时任务效率提升达4.5倍，验证了融合领域知识与可学习决策策略对机器人操作的优越性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T05:01:32Z
- **目录日期**: 2025-04-30
