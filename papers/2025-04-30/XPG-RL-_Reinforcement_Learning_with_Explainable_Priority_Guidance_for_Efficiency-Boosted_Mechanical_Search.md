...
本文提出XPG-RL强化学习框架，用于解决杂乱环境中的机械搜索问题。该框架结合任务驱动的动作优先级机制和上下文感知切换策略，动态选择抓取、遮挡移除或视角调整等基础动作。其感知模块融合RGB-D数据与语义几何特征，生成结构化场景表征。实验表明，XPG-RL在任务成功率和运动效率上显著优于基线方法，长时任务效率提升高达4.5倍，验证了融合领域知识与可学习决策策略的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T14:01:41Z
- **目录日期**: 2025-04-30
