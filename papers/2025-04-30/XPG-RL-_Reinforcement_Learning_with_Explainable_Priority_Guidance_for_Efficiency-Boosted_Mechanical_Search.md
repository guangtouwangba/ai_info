...
本文提出XPG-RL强化学习框架，用于解决机械臂在杂乱环境中的长时程搜索任务。该框架结合任务驱动的动作优先级机制与情境感知切换策略，动态选择抓取、移障或调整视角等基础动作。通过优化策略输出自适应阈值控制动作选择，并融合RGB-D输入与语义几何特征生成结构化场景表征。实验表明，XPG-RL在任务成功率和运动效率上显著优于基线方法，长时程任务效率最高提升4.5倍，验证了融合领域知识与可学习决策策略对提升机器人操作鲁棒性和效率的有效性。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T03:16:29Z
- **目录日期**: 2025-04-30
