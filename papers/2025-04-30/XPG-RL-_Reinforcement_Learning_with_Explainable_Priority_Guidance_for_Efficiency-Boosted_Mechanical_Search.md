...
该研究提出了一种名为XPG-RL的强化学习框架，用于解决杂乱环境中的机械搜索问题。该框架通过可解释的优先级决策机制，结合原始感官输入，动态选择抓取目标、移除遮挡物和调整视角等动作基元。XPG-RL融合RGB-D输入与语义几何特征生成结构化场景表征，并优化策略以自适应阈值选择动作。实验表明，XPG-RL在任务成功率和运动效率上显著优于基线方法，长时任务效率提升高达4.5倍，验证了结合领域知识与可学习决策策略对机器人操作的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T06:01:46Z
- **目录日期**: 2025-04-30
