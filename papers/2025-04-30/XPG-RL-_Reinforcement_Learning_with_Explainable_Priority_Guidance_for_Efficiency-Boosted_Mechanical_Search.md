...
本文提出XPG-RL强化学习框架，用于解决杂乱环境中的机械搜索问题。该框架结合任务驱动的动作优先级机制和情境感知切换策略，动态选择目标抓取、遮挡移除和视角调整等基本动作。通过优化策略输出自适应阈值来控制动作选择，并融合RGB-D输入与语义几何特征生成结构化场景表示。实验表明，XPG-RL在任务成功率和运动效率上均优于基线方法，在长时程任务中效率提升高达4.5倍，验证了结合领域知识与可学习决策策略对提升机器人操作鲁棒性和效率的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T15:01:49Z
- **目录日期**: 2025-04-30
