...
本文提出XPG-RL强化学习框架，用于解决机械臂在杂乱环境中的搜索任务挑战。该框架通过可解释的优先级决策机制，融合RGB-D感知数据与语义几何特征，动态选择抓取、遮挡清除或视角调整等动作基元。实验表明，XPG-RL在任务成功率和运动效率上显著优于基线方法，长时任务效率提升达4.5倍。研究验证了将领域知识与可学习决策策略相结合的优势，能实现更鲁棒高效的机器人操作。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T18:01:44Z
- **目录日期**: 2025-04-30
