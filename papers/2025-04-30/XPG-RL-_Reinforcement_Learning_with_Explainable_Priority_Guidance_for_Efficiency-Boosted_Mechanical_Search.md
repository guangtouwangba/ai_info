...
本文提出XPG-RL强化学习框架，用于解决杂乱环境中的机械搜索问题。该框架结合可解释的优先级决策机制，通过原始感官输入动态选择抓取、移除遮挡和视角调整等动作基元。其感知模块融合RGB-D数据与语义几何特征生成结构化场景表征，策略模块输出自适应阈值控制动作选择。实验表明，XPG-RL在任务成功率和运动效率上显著优于基线方法，长时程任务效率最高提升4.5倍，验证了融合领域知识与可学习决策策略对机器人操作的优越性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T09:01:46Z
- **目录日期**: 2025-04-30
