...
本文提出XPG-RL强化学习框架，用于解决杂乱环境中的机械搜索难题。该框架结合可解释的优先级决策机制与情境感知切换策略，通过RGB-D输入和语义几何特征融合生成场景表征，动态选择抓取、移障或视角调整等动作基元。实验表明，XPG-RL在任务成功率和运动效率上显著优于基线方法，长时任务效率提升最高达4.5倍，验证了融合领域知识与可学习策略对提升机器人操作鲁棒性和效率的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T19:01:25Z
- **目录日期**: 2025-04-30
