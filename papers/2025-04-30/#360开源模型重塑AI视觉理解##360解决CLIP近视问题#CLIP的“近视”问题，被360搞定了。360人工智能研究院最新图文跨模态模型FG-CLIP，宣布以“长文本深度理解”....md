...
360人工智能研究院开源了FG-CLIP跨模态模型，通过"长文本深度理解"和"细粒度视觉比对"两大突破，解决了传统CLIP模型的"视觉近视"问题。该模型能精准识别图像局部细节，在12个下游任务测试中表现优于CLIP等现有模型。实验显示，FG-CLIP能正确识别被其他模型忽略的细节（如隐藏在画面中的木凳），在细粒度理解、对象检测等任务上实现显著提升。模型及相关数据已全面开源，标志着AI视觉理解能力的重要突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T04:03:21Z
- **目录日期**: 2025-04-30
