...
360人工智能研究院开源了FG-CLIP模型，通过"长文本深度理解"和"细粒度视觉比对"技术突破，成功解决了传统CLIP模型的"视觉近视"问题。该模型能精准识别图像局部细节，在12个下游任务测试中表现优于CLIP、EVACLIP等现有模型，尤其在长文本理解和细粒度比对方面实现显著提升。实验显示FG-CLIP能正确识别隐藏物体（如示例中的木凳），而其他模型则错误聚焦于显眼物体（如蓝色狗狗）。该模型已全面开源，相关数据可在GitHub获取。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T05:03:44Z
- **目录日期**: 2025-04-30
