...
360人工智能研究院开源了FG-CLIP跨模态模型，通过"长文本深度理解"和"细粒度视觉比对"技术，解决了传统CLIP模型的"视觉近视"问题。该模型能精准识别图像局部细节，在12个下游任务测试中表现优于CLIP等现有模型，尤其在长文本理解和细粒度比对方面实现突破。实验显示FG-CLIP能正确识别被其他模型忽略的画面细节（如隐藏在狗身后的木凳），而其他模型则错误匹配了全局特征。该模型已全面开源相关代码和数据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T06:04:13Z
- **目录日期**: 2025-04-30
