...
360人工智能研究院推出开源跨模态模型FG-CLIP，突破性解决了传统CLIP模型的"视觉近视"问题。该模型通过"长文本深度理解"和"细粒度视觉比对"技术，能精准识别图像局部细节（如正确识别画面中隐藏的木凳），而其他主流模型则因全局特征偏好产生误判。实验显示，FG-CLIP在12项下游任务中表现显著优于现有模型，尤其在细粒度理解和长文本检索方面。模型代码及数据已全面开源，推动AI视觉理解向更精准的细粒度对齐发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T02:31:11Z
- **目录日期**: 2025-04-30
