...
360人工智能研究院开源了FG-CLIP跨模态模型，解决了传统CLIP模型的"视觉近视"问题。该模型通过"长文本深度理解"和"细粒度视觉比对"两大突破，能够精准识别图像局部细节。测试显示，FG-CLIP在12个下游任务中表现优异，尤其在细粒度理解和长文本检索方面显著优于CLIP等现有模型。相比其他模型错误识别全局特征，FG-CLIP能准确捕捉隐藏细节（如识别图中被遮挡的木凳）。该技术已全面开源，为AI视觉理解领域带来重要突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T01:30:41Z
- **目录日期**: 2025-04-30
