...
Ladybird是一款完全独立的开源浏览器，从零开始自主研发，不使用Chromium、Firefox或WebKit代码。其目标是构建符合现代Web标准、跨平台的独立浏览器，由非营利组织运营，依靠赞助和捐款维持。目前已有7名全职工程师，支持者包括GitHub联合创始人等。尽管尚未完全成熟，但其JS引擎合规性排名第二，代码量达50万行，贡献者超1000人。官网：ladybird.org，GitHub：github.com/LadybirdBrowser/ladybird。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T13:10:22Z
- **目录日期**: 2025-04-30
