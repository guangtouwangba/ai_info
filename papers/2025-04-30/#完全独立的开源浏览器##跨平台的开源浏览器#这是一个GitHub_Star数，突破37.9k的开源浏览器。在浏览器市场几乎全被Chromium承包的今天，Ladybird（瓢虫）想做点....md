...
Ladybird是一款完全独立开发的开源浏览器，不依赖Chromium、Firefox或WebKit，从底层引擎到JS引擎均自主构建。该项目由非营利组织运营，拒绝商业化，仅靠赞助维持。目前已有7名全职工程师，支持者包括GitHub联合创始人等。尽管尚未完全成熟，但已通过多项Web标准测试，JS引擎合规性排名第二，代码量达50万行。其目标是打造跨平台、符合现代标准的纯净浏览器，专注核心功能而非商业扩张。官网：ladybird.org，GitHub星标超37.9k。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T22:02:54Z
- **目录日期**: 2025-04-30
