...
Ladybird是一款完全独立开发的开源浏览器，不依赖Chromium、Firefox或WebKit，所有引擎均从零开始用C++编写。其目标是打造符合现代Web标准、跨平台且真正独立的浏览器，由非营利组织运营，仅靠赞助和捐款维持。目前已有7名全职工程师，支持者包括GitHub联合创始人等。尽管尚未完全成熟，但已在JS引擎合规性测试中排名第二，代码量近50万行，贡献者超1000人。Ladybird坚持不商业化，专注于浏览器本身，致力于提供无广告、无盈利的纯净体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T18:03:04Z
- **目录日期**: 2025-04-30
