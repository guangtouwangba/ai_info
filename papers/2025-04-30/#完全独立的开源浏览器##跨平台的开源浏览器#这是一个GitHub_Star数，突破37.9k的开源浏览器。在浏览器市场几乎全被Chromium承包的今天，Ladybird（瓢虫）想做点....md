...
Ladybird是一款完全独立开发的开源浏览器，不依赖Chromium、Firefox或WebKit，所有底层引擎和JS引擎均从零开始用C++编写。该项目由非营利组织Ladybird Browser Initiative运营，完全依靠赞助和捐款维持，承诺永不商业化。目前已有7名全职工程师和1000多名贡献者，代码量达50万行，JS引擎合规性排名第二。虽然尚未完全成熟，但已能处理GitHub issues等日常任务，目标是打造符合现代Web标准的跨平台浏览器。官网：ladybird.org，GitHub获37.9k星。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T16:03:16Z
- **目录日期**: 2025-04-30
