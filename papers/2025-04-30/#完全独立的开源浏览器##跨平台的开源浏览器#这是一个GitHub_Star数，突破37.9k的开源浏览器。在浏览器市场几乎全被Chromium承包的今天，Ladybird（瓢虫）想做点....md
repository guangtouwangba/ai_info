...
Ladybird是一款完全独立开发的开源浏览器，不依赖Chromium、Firefox或WebKit，所有底层引擎和JS引擎均自主开发。其目标是打造符合现代Web标准、跨平台的独立浏览器，由非营利组织运营，依靠赞助和捐款维持，拒绝商业化。目前已有7名全职工程师，支持者包括GitHub联合创始人等。尽管尚未完全成熟，但其JS引擎合规性已排名第二（仅次于Firefox），代码量近50万行，贡献者超1000人。官网：ladybird.org，GitHub：github.com/LadybirdBrowser/ladybird。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T23:03:04Z
- **目录日期**: 2025-04-30
