...
Ladybird是一款完全独立的开源浏览器，从底层引擎到JS引擎全部自主开发，不使用Chromium、Firefox或WebKit代码。该项目由非营利组织运营，依靠赞助和捐款维持，承诺永不商业化。目前已有7名全职工程师，支持者包括GitHub联合创始人等。浏览器已能处理日常任务，在Web Platform Tests中JS引擎合规性排名第二。代码量近50万行，贡献者超1000人。目标是打造符合现代标准的跨平台浏览器，专注于浏览器本身而非商业扩张。官网：ladybird.org，GitHub仓库获37.9k星。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T14:03:12Z
- **目录日期**: 2025-04-30
