...
70岁NASA宇航员Don Pettit完成第四次太空任务（累计590天）后返回地球。他在国际空间站度过220天期间，失重环境缓解了颈椎病和肩周炎症状，但返回时经历了4.4G过载和呕吐。Pettit指出太空生活会导致小肌肉群退化，需逐步恢复训练。作为NASA在轨时间最长纪录保持者，他主张延长国际空间站使用寿命，并表态愿继续执行任务。该宇航员认为人类探索太空的使命不应停止，展现了高龄航天工作者对事业的持续热情。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T22:03:30Z
- **目录日期**: 2025-04-30
