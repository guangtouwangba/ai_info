...
AegisLLM是一种基于多智能体协作的防御系统，用于对抗对抗性攻击和信息泄露。该系统由协调器、偏转器、响应器和评估器等自主智能体组成，通过结构化工作流程确保大语言模型输出的安全性和合规性，并通过即时优化实现自我改进。实验表明，AegisLLM在无需重新训练模型的情况下，能有效应对遗忘和越狱等威胁场景。在WMDP遗忘基准测试中仅需20个训练样本和不到300次调用；在StrongReject越狱测试中性能提升51%，误拒率仅为7.9%。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T21:01:39Z
- **目录日期**: 2025-04-30
