...
AgentSociety是一个基于大型语言模型的大规模社会模拟器，能够模拟1万多个代理的社会生活及500万次互动。该系统通过研究极化现象、信息传播、基本收入政策及自然灾害影响等社会问题，验证了其模拟结果与现实实验数据的一致性。研究表明，AgentSociety能有效捕捉人类行为机制，为社会科学研究和政策制定提供了新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T18:04:49Z
- **目录日期**: 2025-04-30
