...
这篇论文介绍了一个名为AgentSociety的大规模社会模拟器，它结合了大型语言模型驱动的智能代理、真实社会环境和大规模模拟引擎。研究者通过模拟1万多个代理及其500万次互动，研究了四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害冲击。结果显示，模拟结果与现实世界实验数据高度吻合，验证了该系统捕捉人类行为机制的能力。该平台为社会科学研究和政策制定提供了新工具，能够辅助传统研究方法，帮助理解社会问题的模式和潜在机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T09:05:18Z
- **目录日期**: 2025-04-30
