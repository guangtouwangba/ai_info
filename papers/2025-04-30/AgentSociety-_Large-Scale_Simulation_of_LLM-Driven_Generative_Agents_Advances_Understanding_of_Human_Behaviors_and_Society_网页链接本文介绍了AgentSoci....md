...
该研究介绍了AgentSociety，这是一个基于大语言模型的大规模社会模拟系统，能够模拟1万多个代理及其500万次社会互动。该系统被用于研究四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，验证了该平台在揭示人类行为机制方面的有效性。研究表明，AgentSociety可作为社会科学研究和政策制定的有力工具，为理解复杂社会现象提供新方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T23:04:51Z
- **目录日期**: 2025-04-30
