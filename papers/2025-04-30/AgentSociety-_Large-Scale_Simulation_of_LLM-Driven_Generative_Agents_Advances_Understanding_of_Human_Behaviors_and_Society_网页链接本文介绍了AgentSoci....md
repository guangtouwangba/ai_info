...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可以模拟10,000多个AI代理的社会生活及500万次互动。该系统被用于研究社会极化、信息传播、基本收入政策影响和自然灾害应对等社会问题，模拟结果与现实世界数据高度吻合。研究表明，AgentSociety能有效捕捉人类行为机制，为社会科学研究和政策制定提供了新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T13:12:19Z
- **目录日期**: 2025-04-30
