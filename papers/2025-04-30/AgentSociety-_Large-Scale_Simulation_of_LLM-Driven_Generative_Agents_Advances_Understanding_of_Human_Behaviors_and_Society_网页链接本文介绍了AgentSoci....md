...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理的社会互动（500万次交互）。该系统被用于研究四大社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。研究显示其模拟结果与现实世界数据高度吻合，验证了系统对人类行为机制建模的有效性。该平台为社会科学研究提供了新工具，能辅助传统研究方法（如调查、实验），帮助研究者分析社会问题的成因和潜在机制，对政策制定具有重要参考价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T12:05:09Z
- **目录日期**: 2025-04-30
