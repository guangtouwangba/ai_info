...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟1万多个代理及其500万次互动。研究者用它研究社会极化、信息传播、基本收入政策和飓风影响等社会问题，结果与现实世界数据吻合。该系统结合LLM代理、真实环境和大规模模拟引擎，能有效捕捉人类行为机制，为社会科学研究和政策制定提供新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T14:05:12Z
- **目录日期**: 2025-04-30
