...
Graphiti是由Zep团队开发的开源实时知识图谱系统，为AI智能体提供动态知识管理能力。其核心创新在于支持秒级数据同步、双时间线追踪（事件发生/接收时间）和混合检索技术（语义+关键词+图遍历），相比传统RAG实现了实时增量更新和灵活的关系扩展。该系统可应用于电商客服、金融分析和智能助手等场景，通过整合多源数据构建动态知识网络。项目已在GitHub开源并获得7000+星标，具有完善的文档和活跃社区支持。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T03:18:59Z
- **目录日期**: 2025-04-30
