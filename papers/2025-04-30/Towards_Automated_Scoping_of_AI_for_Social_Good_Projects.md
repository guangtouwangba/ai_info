...
AI4SG（人工智能助力社会公益）旨在利用AI技术解决复杂社会问题，如交通网络优化和全球野生动物保护。然而，项目规划（问题界定）因缺乏兼具技术与领域知识的专家而成为瓶颈。为此，研究团队提出基于大语言模型（LLM）的"问题界定智能体"（PSA），通过整合科学文献与现实知识生成全面项目提案。盲审和AI评估显示，PSA生成的提案质量接近专家水平。研究同时指出了实际应用中的挑战，并提出了未来改进方向。该成果为AI社会公益项目的高效规划提供了新思路。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T00:01:39Z
- **目录日期**: 2025-04-30
