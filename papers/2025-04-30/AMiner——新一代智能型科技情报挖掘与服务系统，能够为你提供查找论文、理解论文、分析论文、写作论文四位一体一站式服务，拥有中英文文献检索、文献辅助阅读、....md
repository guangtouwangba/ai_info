...
AMiner是一个智能科技情报挖掘平台，提供文献检索、翻译、科研订阅等一站式服务。它涵盖42个学科的3.5亿论文、0.6亿学者等海量数据，支持中英文文献搜索、AI辅助阅读、自动摘要生成及互动问答。用户可订阅个性化科研动态，追踪机构、学者及关键词，并通过微信或邮件接收最新资讯。平台还提供学者画像、学术会议等特色功能，基础服务免费开放。访问入口：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T03:20:43Z
- **目录日期**: 2025-04-30
