...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作一站式服务。它支持中英文文献搜索，能自动生成摘要和问答互动，帮助用户快速理解内容。平台还具备文献翻译、文档识别和辅助阅读功能，用户可上传PDF或从3.5亿论文库中查找资料。此外，AMiner提供科研动态订阅服务，根据用户偏好推送最新学术资讯，覆盖42个学科领域。平台免费开放基础功能，包含学者画像、学术会议等特色工具，致力于提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T14:05:44Z
- **目录日期**: 2025-04-30
