...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、翻译、辅助阅读和科研情报订阅。平台覆盖42个学科，拥有3.5亿论文、0.6亿学者等海量数据。用户可通过互动问答快速获取文献摘要，支持PDF上传和AI辅助阅读，还能定制订阅最新科研动态。此外，AMiner提供学者画像、学术会议和论文排行榜等功能，基础检索免费使用。访问入口：[AMiner网站](https://www.aminer.cn) | [AI服务页](https://www.aminer.cn/chat/g/explain/)。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T18:05:16Z
- **目录日期**: 2025-04-30
