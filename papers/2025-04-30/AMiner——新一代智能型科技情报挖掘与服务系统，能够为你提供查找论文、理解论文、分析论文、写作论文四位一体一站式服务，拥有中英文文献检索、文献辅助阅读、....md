...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、辅助阅读、翻译和科研情报订阅。它覆盖42个学科，拥有3.5亿论文、0.6亿学者等海量数据。用户可通过互动问答快速获取文献摘要，支持PDF上传和AI辅助阅读分析。此外，AMiner还能根据用户偏好推送最新科研动态，并提供学者画像、学术会议等特色功能。平台基础服务免费，适合科研人员高效获取学术资源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T07:05:39Z
- **目录日期**: 2025-04-30
