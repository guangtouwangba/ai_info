...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析及写作一站式服务。它支持中英文文献搜索，能快速生成摘要和回答文献相关问题，提升研究效率。平台还具备文档识别、辅助阅读功能，用户可上传PDF或从库中选取论文进行AI解析。此外，AMiner提供科研动态订阅服务，根据用户偏好推送最新学术资讯。涵盖42个学科的3.5亿论文资源，并免费开放基础功能。网址：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T19:04:48Z
- **目录日期**: 2025-04-30
