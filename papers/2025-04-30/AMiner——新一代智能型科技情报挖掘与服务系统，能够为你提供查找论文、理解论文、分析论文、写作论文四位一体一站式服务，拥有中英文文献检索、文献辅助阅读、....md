...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、辅助阅读和科研订阅等一站式服务。它收录了3.5亿论文、0.6亿学者等海量学术资源，支持AI生成摘要、智能问答和文档解析功能。用户可通过关键词、学者或机构订阅最新科研动态，还能免费使用学者画像、会议资讯等工具，显著提升文献查找与论文写作效率。平台支持网页和小程序访问，适合科研人员快速获取学术信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T01:33:14Z
- **目录日期**: 2025-04-30
