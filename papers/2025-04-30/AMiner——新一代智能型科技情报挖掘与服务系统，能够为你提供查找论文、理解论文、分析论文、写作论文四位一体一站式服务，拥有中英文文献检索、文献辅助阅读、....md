...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、科研订阅等一站式服务。其核心功能包括：1）高效检索3.5亿论文资源，支持智能问答和自动摘要生成；2）AI辅助阅读，可解析PDF文档并生成章节概要；3）定制化科研动态推送，通过关键词追踪最新成果。平台还包含学者画像、学术会议等特色功能，支持浏览器免费使用。通过AI技术显著提升文献查阅、理解和写作效率，适用于科研人员快速获取学术资讯。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T12:05:36Z
- **目录日期**: 2025-04-30
