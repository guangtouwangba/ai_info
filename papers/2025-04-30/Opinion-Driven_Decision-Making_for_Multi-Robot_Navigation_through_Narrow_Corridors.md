...
本文提出了一种基于意见驱动的多机器人窄通道导航框架，采用非线性意见动力学（NOD）模型解决多机器人通道通行问题。该框架将NOD模型与路径规划算法结合，有效降低了通道通行中的死锁概率。为提升系统可扩展性，研究者引入了博弈简化技术以支持大规模机器人群体协调。通过大量仿真实验验证了该方法的有效性，表明该方案能实现多机器人在狭窄通道中的高效协同通行。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T15:02:10Z
- **目录日期**: 2025-04-30
