...
本文提出了一种基于意见驱动的多机器人狭窄走廊通行框架。该框架采用非线性意见动力学(NOD)模型进行多智能体决策，将走廊通行问题建模为多机器人导航博弈。通过将NOD模型与路径规划算法结合，有效降低了通行过程中的死锁概率。为提升系统可扩展性，引入博弈简化技术以支持大规模机器人群体协调。仿真实验验证了该方法的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T07:01:55Z
- **目录日期**: 2025-04-30
