...
本文提出了一种基于意见驱动的多机器人狭窄走廊通行框架。该方案采用非线性意见动力学(NOD)多智能体决策模型，将走廊通行问题建模为多机器人导航博弈。通过将NOD模型与路径规划算法结合，该框架能有效降低通行过程中的死锁概率。为提高系统可扩展性，作者引入了博弈简化技术以支持大规模机器人群体协调。仿真实验验证了该方法的有效性，表明其能实现多机器人在狭窄通道中的高效协同通行。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T13:09:12Z
- **目录日期**: 2025-04-30
