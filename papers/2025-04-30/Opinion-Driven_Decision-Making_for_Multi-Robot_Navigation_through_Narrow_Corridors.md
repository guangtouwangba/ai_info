...
本文提出了一种基于观点的多机器人窄走廊通行框架，采用非线性意见动力学（NOD）模型进行决策。该框架将NOD与路径规划算法结合，有效降低了走廊通行中的死锁概率。为提升系统可扩展性，引入了博弈简化技术以支持大规模机器人协调。仿真实验验证了该方法的有效性。该研究为解决多机器人窄通道协同通行问题提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T08:02:10Z
- **目录日期**: 2025-04-30
