...
多邻国CEO宣布公司战略转向"AI优先"，将逐步用AI替代外包人员，并提出五大措施：停止外包AI可胜任的工作、招聘考核AI能力、绩效评估AI使用效率、严格控制新增编制、要求部门提交AI改造方案。公司强调此举旨在让核心团队专注创新而非取代员工。该决策引发两极反应：批评者认为现有AI功能不实用，担忧盲目转型；支持者则认为这是面向未来的必要举措。作为语言学习领域的头部企业，多邻国的AI转型战略或将对行业产生示范效应。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T07:04:11Z
- **目录日期**: 2025-04-30
