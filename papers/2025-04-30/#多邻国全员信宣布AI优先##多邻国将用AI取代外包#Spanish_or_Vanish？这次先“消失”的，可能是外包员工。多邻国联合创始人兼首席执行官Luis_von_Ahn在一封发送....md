...
多邻国CEO宣布公司战略转向"AI优先"，将逐步用AI替代外包人员，并提出五大改革措施：停止外包AI可胜任工作、招聘考核AI能力、绩效评估AI使用效率、严格审批新增编制、要求部门提交AI改造方案。公司强调此举旨在让核心团队专注创新而非取代员工。舆论反应两极：批评者认为现有AI功能难用且不实用，警告这是公司衰落的开始；支持者则认为拥抱AI是赢得未来的关键举措。该决策引发对AI替代人力和企业转型的热议。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T00:02:41Z
- **目录日期**: 2025-04-30
