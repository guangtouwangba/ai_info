...
多邻国CEO宣布公司战略转向"AI优先"，将逐步用AI替代外包人员，并提出五大改革措施：停止外包AI可胜任工作、招聘考核AI能力、绩效评估AI使用效率、严格审批新增编制、要求部门提交AI改造方案。公司强调此举旨在让核心团队专注创新而非取代员工。该决策引发两极反应：批评者认为现有AI功能不实用，警告可能加速公司衰落；支持者则认为这是拥抱未来的必要举措。作为知名语言学习平台，多邻国的AI转型标志着教育科技行业的重要变革趋势。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T01:30:08Z
- **目录日期**: 2025-04-30
