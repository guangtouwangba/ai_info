...
在儿童中心设计中，直接与儿童互动至关重要，但现有研究常以成人视角为主。AI虚拟人(VHs)为解决儿童访谈中的信任和环境敏感问题提供了新思路。本研究制定了基于大语言模型(LLM)的虚拟儿童访谈设计准则，规范了色彩、语音、表情等多模态要素，开发了三种人机协作模式(LLM-Auto、LLM-Interview和LLM-Analyze)。对15名6-12岁儿童的测试显示，LLM-Analyze模式表现最优，能获得更长的回答、更高的用户体验评分和更有效的儿童参与度。该研究为儿童友好型AI交互提供了实用指导。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T02:29:07Z
- **目录日期**: 2025-04-30
