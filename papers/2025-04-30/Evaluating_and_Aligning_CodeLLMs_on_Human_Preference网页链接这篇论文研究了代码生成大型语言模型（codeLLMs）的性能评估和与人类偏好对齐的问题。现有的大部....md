...
这篇论文针对代码生成大模型(codeLLMs)与人类偏好对齐的问题，提出了CodeArena基准测试和SynCode-Instruct指令集。CodeArena包含397个涵盖40类编程任务的高质量样本，模拟真实编程场景；SynCode-Instruct则构建了近200亿标记的合成指令数据。研究发现传统执行基准与人类偏好存在差距，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著。研究强调了代码生成模型除正确性外，还需重视与开发者实际需求的匹配度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T01:33:24Z
- **目录日期**: 2025-04-30
