...
这篇论文针对代码生成大模型(codeLLMs)的评估标准进行了创新研究，指出当前基准测试过于侧重代码正确性而忽视人类偏好。研究者提出了CodeArena基准测试，包含397个涵盖40类编程任务和44种语言的高质量样本，更贴近实际开发场景。同时开发了包含近200亿标记的SynCode-Instruct合成指令数据集用于模型微调。实验发现执行基准与CodeArena存在性能差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)差距显著，凸显了模型与人类偏好对齐的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T06:05:49Z
- **目录日期**: 2025-04-30
