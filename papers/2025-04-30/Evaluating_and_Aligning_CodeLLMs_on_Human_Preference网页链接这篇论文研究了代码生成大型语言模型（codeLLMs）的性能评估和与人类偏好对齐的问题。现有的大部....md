...
这篇论文针对代码生成大语言模型(codeLLMs)提出了新评估方法，指出当前基准测试过于关注代码正确性而忽视人类偏好。研究者构建了CodeArena基准测试(包含397个高质量样本，覆盖40类编程任务和44种语言)和SynCode-Instruct合成指令库(近200亿标记)，发现执行基准与人类偏好评估存在差异。实验比较40多个模型显示，顶级开源模型(如Qwen2.5-Coder)与专有模型(如OpenAI o1)性能差距显著，凸显了模型与人类偏好对齐的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T07:05:50Z
- **目录日期**: 2025-04-30
