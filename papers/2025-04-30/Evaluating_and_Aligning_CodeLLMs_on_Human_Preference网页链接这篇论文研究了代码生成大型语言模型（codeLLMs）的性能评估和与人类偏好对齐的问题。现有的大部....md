...
这篇论文探讨了代码生成大模型(codeLLMs)如何更好匹配人类偏好。研究者创建了CodeArena基准测试(含397个样本，覆盖40类任务和44种语言)，发现传统基于执行的评估与人类偏好存在差异。通过实验40多个模型发现，开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)存在明显差距。同时构建了20B标记的SynCode-Instruct语料库，验证了大规模合成指令微调的有效性。研究强调了代码LLMs与人类偏好对齐的重要性，为提升模型实用性提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T08:06:06Z
- **目录日期**: 2025-04-30
