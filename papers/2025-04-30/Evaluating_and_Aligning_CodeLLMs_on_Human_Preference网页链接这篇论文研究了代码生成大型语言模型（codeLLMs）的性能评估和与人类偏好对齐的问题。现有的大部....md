...
该论文研究代码生成大模型(codeLLMs)与人类偏好的对齐问题，提出CodeArena基准测试(包含397个高质量样本，覆盖40类任务和44种编程语言)来评估模型在真实编程场景中的表现。同时构建近200亿标记的合成指令数据集SynCode-Instruct验证大规模微调效果。实验发现传统执行基准与CodeArena存在评估差异，且开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，凸显了人类偏好对齐的重要性。研究强调需超越代码正确性，关注实际开发需求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T09:05:57Z
- **目录日期**: 2025-04-30
