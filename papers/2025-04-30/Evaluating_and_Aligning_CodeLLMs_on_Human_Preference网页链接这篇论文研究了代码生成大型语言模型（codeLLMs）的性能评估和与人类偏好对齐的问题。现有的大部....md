...
这篇论文提出了CodeArena基准测试和SynCode-Instruct语料库，以解决现有代码生成模型评估中忽视人类偏好的问题。CodeArena包含397个高质量样本，覆盖40个类别和44种编程语言，模拟真实编程任务。研究还构建了近20B标记的合成指令数据集用于微调验证。实验显示，执行基准与人类偏好评估存在差异，且开源模型(如Qwen2.5-Coder)与专有模型(如OpenAI o1)性能差距显著，强调了与人类偏好对齐的重要性。该研究为代码生成模型的评估和改进提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T20:05:22Z
- **目录日期**: 2025-04-30
