...
这篇论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，关注模型输出与人类偏好的对齐问题。研究构建了包含397个样本(覆盖40类任务和44种语言)的人工标注数据集，并开发了20B标记量的合成指令集SynCode-Instruct。实验发现：1)传统执行测试与人类偏好存在差异；2)开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究强调了代码生成模型除功能性外，还需重视与开发者实际需求的匹配度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T05:05:38Z
- **目录日期**: 2025-04-30
