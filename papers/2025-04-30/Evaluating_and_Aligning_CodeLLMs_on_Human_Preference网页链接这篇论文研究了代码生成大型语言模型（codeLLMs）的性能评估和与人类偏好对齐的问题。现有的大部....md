...
这篇论文探讨了代码生成大模型（codeLLMs）与人类偏好的对齐问题，指出现有基准测试过于关注代码正确性而忽视人类偏好。为此，研究团队创建了CodeArena基准测试，包含397个高质量样本，覆盖40个类别和44种编程语言，模拟真实编程任务。同时构建了20B标记的合成指令数据集SynCode-Instruct验证指令微调效果。实验显示，执行基准与CodeArena存在性能差异，开源模型（如Qwen2.5-Coder）与商业模型（如OpenAI o1）差距显著，强调了人类偏好对齐的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T03:20:52Z
- **目录日期**: 2025-04-30
