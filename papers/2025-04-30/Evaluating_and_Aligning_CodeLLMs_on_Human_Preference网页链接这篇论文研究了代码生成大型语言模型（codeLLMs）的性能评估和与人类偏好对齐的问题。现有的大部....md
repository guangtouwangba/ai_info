...
这篇论文针对代码生成大模型(codeLLMs)提出新评估方法CodeArena，关注模型输出与人类偏好的对齐问题。研究者构建了包含397个高质量样本的基准测试，覆盖40个类别和44种编程语言，并开发了近200亿标记的合成指令数据集SynCode-Instruct。实验发现传统基于执行的评估与人类偏好存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)表现差距显著，凸显了人类偏好对齐在代码生成中的重要性。该研究为改进代码LLMs提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T15:06:02Z
- **目录日期**: 2025-04-30
