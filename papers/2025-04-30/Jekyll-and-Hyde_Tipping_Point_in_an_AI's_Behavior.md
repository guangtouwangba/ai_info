...
该研究指出，当前缺乏科学方法预测或解释大语言模型（如ChatGPT）何时会在回答中突然转向错误、误导或危险内容，这削弱了公众对AI的信任。研究者从基本原理推导出一个精确公式，揭示这种"善恶突变点"源于AI注意力过度分散导致突然崩溃。该公式仅需中学数学即可理解，并量化预测如何通过调整提示词或训练来延迟或防止突变。这为政策制定者和公众讨论AI在医疗、决策等高风险场景的应用提供了科学依据，同时解答了"是否应对AI保持礼貌"等实际问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T10:01:26Z
- **目录日期**: 2025-04-30
