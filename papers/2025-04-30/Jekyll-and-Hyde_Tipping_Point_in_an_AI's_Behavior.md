...
这篇论文探讨了AI信任危机的一个核心问题：目前缺乏科学方法预测或解释大型语言模型（如ChatGPT）何时会突然产生错误、误导或危险的回答。作者从基本原理出发，推导出一个精确公式来预测这种"杰基尔与海德"式突变点，发现其根源在于AI注意力过度分散导致的突然崩溃。该公式仅需中学数学即可理解，能定量预测如何通过调整提示词和训练来延缓或防止这种突变。研究为政策制定者和公众提供了讨论AI风险的科学基础，包括医疗建议、决策支持等应用场景，也解答了"是否该对AI保持礼貌"等实际问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T19:01:08Z
- **目录日期**: 2025-04-30
