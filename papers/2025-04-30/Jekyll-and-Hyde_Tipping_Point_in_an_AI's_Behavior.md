...
该研究针对公众对AI（如ChatGPT）输出突然变得错误、误导或危险的不信任问题，提出了一个基于基本原理的精确公式，用于预测LLM（大语言模型）的“杰基尔与海德”临界点。该公式仅需中学数学知识，揭示了临界点源于AI注意力过度分散导致的突然崩溃，并量化了如何通过调整提示词和训练来延迟或防止这一现象。这一发现为政策制定者和公众提供了讨论AI广泛应用的可靠基础，例如作为个人顾问或医疗建议者，并解答了“是否应对LLM保持礼貌”等透明问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T11:01:15Z
- **目录日期**: 2025-04-30
