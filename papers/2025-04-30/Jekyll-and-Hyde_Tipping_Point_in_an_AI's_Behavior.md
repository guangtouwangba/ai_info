...
该研究揭示了大型语言模型（LLM）输出突然转向错误、误导或危险内容的临界点机制。通过基础原理推导出精确公式，表明这种"杰基尔与海德"式突变源于AI注意力过度分散导致的突然崩溃。该公式仅需中学数学即可理解，能定量预测如何通过调整提示词或训练数据来延迟或防止临界点出现。研究为政策制定者和公众提供了讨论AI风险的量化基础，涵盖医疗咨询、冲突决策等场景，并解答了"是否应对LLM保持礼貌"等实际问题。这种透明解释有助于重建对AI的信任。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T17:01:09Z
- **目录日期**: 2025-04-30
