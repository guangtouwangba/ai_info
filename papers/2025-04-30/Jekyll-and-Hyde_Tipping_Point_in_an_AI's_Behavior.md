...
该研究指出，当前缺乏科学方法预测或解释大型语言模型（LLM）何时会在回答中突然转向错误、误导或危险内容，这削弱了公众对AI的信任。研究者从基本原理出发，推导出一个简单公式，揭示了LLM的"杰基尔与海德式"突变点源于注意力过度分散导致的突然崩溃。该公式仅需中学数学即可理解，能定量预测如何通过调整提示词或训练来延迟或防止突变。这为政策制定者和公众提供了讨论AI应用与风险的可靠基础，包括医疗建议、冲突决策等场景，并解答了"是否应对LLM保持礼貌"等实际问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T07:01:14Z
- **目录日期**: 2025-04-30
