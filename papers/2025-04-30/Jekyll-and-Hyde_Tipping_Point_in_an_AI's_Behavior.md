...
该研究从基本原理推导出LLMs（如ChatGPT）输出突然转向错误、误导或不相关内容的临界点公式，揭示了这是由于AI注意力过度分散导致的突变。该公式仅需中学数学即可理解，能预测如何通过调整提示词或训练来延迟或防止临界点出现。它为政策制定者和公众提供了量化讨论AI风险的基础，适用于医疗咨询、决策支持等广泛场景，并解答了"是否应对LLM保持礼貌"等实际问题。当前缺乏预测AI错误输出的科学解释，已导致用户因担忧而采取非理性应对方式，这一研究填补了关键空白。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T04:01:20Z
- **目录日期**: 2025-04-30
