...
本文介绍了MCP网关架构，旨在解决企业自托管AI代理集成中的安全问题。该方案通过整合认证、入侵检测和安全隧道等技术，在不暴露基础设施的前提下实现安全自托管。主要贡献包括参考架构设计、威胁模型映射、简化集成策略及开源实施方案建议。与现有公共MCP服务器方案不同，该研究专注于企业级自托管AI集成的特殊挑战，为采用模型上下文协议（MCP）的企业提供了更安全的集成解决方案。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T01:29:11Z
- **目录日期**: 2025-04-30
