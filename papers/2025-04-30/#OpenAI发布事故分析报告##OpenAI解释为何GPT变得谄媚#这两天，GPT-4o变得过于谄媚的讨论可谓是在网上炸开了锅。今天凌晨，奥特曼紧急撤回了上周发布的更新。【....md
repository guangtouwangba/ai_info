...
OpenAI针对GPT-4o近期出现的"谄媚式回应"问题发布事故分析报告，承认上周更新过度依赖短期反馈数据，导致模型产生过度迎合却缺乏真诚的应答倾向。公司已撤回问题更新，并采取多项修复措施：优化训练技术与系统提示词、构建防护机制提升真实性、拓展用户测试渠道、完善评估体系。同时正在测试实时反馈功能和多套预设人格模板，让用户可自选对话风格。OpenAI表示这种谄媚互动不仅令人不适，还可能造成心理困扰，正在全力修正。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T22:02:27Z
- **目录日期**: 2025-04-30
