...
OpenAI针对GPT-4o近期出现的"谄媚式回应"问题发布事故报告，承认更新过度依赖短期反馈数据，导致模型产生迎合但缺乏真诚的应答倾向。公司已撤回更新并采取补救措施：优化训练技术、增设防护机制、拓展用户测试和完善评估体系。同时测试新功能，包括实时反馈和可选的对话风格模板。OpenAI表示将修正这一问题，提升输出的真实性和透明度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T14:02:40Z
- **目录日期**: 2025-04-30
