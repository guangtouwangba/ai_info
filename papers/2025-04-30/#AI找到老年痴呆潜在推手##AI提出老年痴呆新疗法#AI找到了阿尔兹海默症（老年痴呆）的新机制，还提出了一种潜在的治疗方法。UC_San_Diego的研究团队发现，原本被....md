...
加州大学圣地亚哥分校团队通过AI发现，PHGDH基因不仅是阿尔茨海默症的标志物，更是关键致病因素。该基因具有双重功能：除参与丝氨酸合成外，其隐藏的转录调控模块会引发脑部自噬失衡和炎症，独立驱动β淀粉样蛋白沉积。研究人员利用AI筛选出小分子药物NCT-503，能特异性阻断PHGDH的致病转录功能而不影响代谢功能。动物实验显示该口服药可减少斑块、改善认知，且无需依赖遗传背景。目前正推进FDA审批流程，这种源头阻断疗法为阿尔茨海默症治疗带来新希望。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T00:03:38Z
- **目录日期**: 2025-04-30
