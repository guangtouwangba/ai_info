...
加州大学圣地亚哥分校团队利用AI发现，PHGDH基因不仅是阿尔茨海默病的生物标志物，更是其致病元凶。该基因通过新型转录调控功能（独立于其酶活性）驱动淀粉样蛋白堆积和神经炎症。研究筛选出小分子药物NCT-503，可特异性阻断PHGDH的致病模块，在动物模型中显著改善病理和认知症状。这种口服靶向疗法突破传统清除斑块的思路，直接干预疾病源头，目前已进入FDA开发流程。该成果发表于《Cell》期刊，为阿尔茨海默病治疗带来新希望。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T04:03:47Z
- **目录日期**: 2025-04-30
