...
微软最新发布BitNet v2框架，实现了1bit大模型原生4bit激活值量化，可充分利用新一代GPU（如GB200）的4bit计算能力。相比此前BitNet b1.58（权重量化至1.58bit但激活仍为8bit），新框架通过引入H-BitLinear模块，在量化前应用Hadamard变换将激活分布调整为近似高斯分布，有效减少异常值，从而真正实现4bit激活。这一突破显著提升了计算效率，降低了内存带宽需求，使大模型推理更加高效。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-30T01:31:45Z
- **目录日期**: 2025-04-30
