...
西湖大学等机构提出ReasonMap评测基准，测试多模态大模型对高分辨率地铁图的空间理解和路径规划能力。结果显示，开源模型普遍表现不佳，存在混淆线路或遗漏站点等问题；闭源模型如GPT-3表现较好，但仍与人类水平有明显差距。测试涵盖15个主流模型，北京、杭州等复杂地铁图的识别难度较高。研究表明，当前AI大模型在复杂图像理解和逻辑推理方面仍有提升空间。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T16:03:09Z
- **目录日期**: 2025-06-07
