...
西湖大学等机构提出ReasonMap评测基准，测试多模态大模型对高分辨率地铁图(平均5839×5449像素)的空间理解和路径规划能力。测试覆盖15个主流模型，结果显示开源模型普遍表现不佳，存在混淆线路或遗漏站点等问题。闭源模型如GPT-3表现较好但仍与人类水平存在明显差距。北京、杭州等复杂地铁图的测试难度较高，多数模型准确率不理想。该研究强调了对贴近人类使用地图方式的评估需求，揭示了当前AI在复杂视觉推理任务上的局限性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T14:01:40Z
- **目录日期**: 2025-06-07
