...
西湖大学等机构提出ReasonMap评测基准，测试多模态大模型对高分辨率地铁图（平均5839×5449像素）的空间理解和路径规划能力。测试覆盖15个主流模型，结果显示开源模型普遍表现不佳，存在混淆线路或遗漏站点的问题；闭源模型如GPT-4表现较好，但仍显著低于人类水平。北京、杭州等复杂地铁图的识别难度较高。该研究强调模型需提升对密集细节和复杂结构的理解能力，以更贴近人类使用地图的方式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T13:09:33Z
- **目录日期**: 2025-06-07
