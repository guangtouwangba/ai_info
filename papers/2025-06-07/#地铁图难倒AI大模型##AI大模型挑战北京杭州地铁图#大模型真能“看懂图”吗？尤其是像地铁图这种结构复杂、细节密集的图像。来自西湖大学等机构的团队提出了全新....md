...
西湖大学等机构提出ReasonMap评测基准，测试多模态大模型对高分辨率地铁图的空间理解和路径规划能力。结果显示，开源模型普遍表现不佳，在复杂线路（如北京、杭州地铁图）上容易混淆线路或遗漏站点。闭源模型如GPT-3表现较好，但仍与人类水平存在明显差距。该研究测试了15个主流模型，发现当前AI处理复杂图像和逻辑推理的能力仍有提升空间。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T23:03:19Z
- **目录日期**: 2025-06-07
