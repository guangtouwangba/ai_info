...
西湖大学等机构提出ReasonMap评测基准，测试多模态大模型对高分辨率地铁图（平均5839×5449像素）的空间理解和路径规划能力。结果显示，开源模型普遍表现不佳，存在混淆线路或遗漏站点等问题；闭源模型如GPT-4表现较好，但仍显著落后于人类水平。测试涵盖15个主流模型，涉及多个城市地铁图，其中北京、杭州等复杂地图难度较高。研究表明，当前AI在复杂图像理解和逻辑推理方面仍有明显局限，尤其面对密集结构化信息时与人类存在差距。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T12:01:10Z
- **目录日期**: 2025-06-07
