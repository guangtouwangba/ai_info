...
行为克隆(BC)方法在模仿学习中的根本局限是只能模仿专家在特定状态下的行为，当智能体偏离专家示范状态时无法自主恢复。本研究提出"学习搜索"(L2S)方法，通过从专家示范中学习世界模型和奖励模型，使智能体在测试时能自主规划恢复路径。所开发的SAILOR算法在12项视觉操作任务中表现优于基于相同数据的扩散策略，即使BC使用5-10倍示范数据仍存在性能差距。SAILOR能识别细微错误并避免奖励欺骗，实现了无需人工干预的稳定高效学习。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T16:02:00Z
- **目录日期**: 2025-06-07
