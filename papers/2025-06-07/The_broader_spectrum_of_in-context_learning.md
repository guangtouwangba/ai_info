...
这篇摘要提出了一种更广泛的元学习视角，将语言模型的上下文学习能力置于更宏观的谱系中。作者认为，任何能通过上下文显著降低后续预测损失的序列分布都可被视为某种形式的上下文学习。这一观点有助于统一语言模型展现的各种上下文能力，如根据指令适应任务、角色扮演或时间序列外推等，并揭示了其可能源于语言依赖关系（如共指或平行结构）的低层次处理。研究强调了泛化能力的重要性，包括学习新事物、适应不同呈现方式及应用所学内容等维度，并建议未来研究应考虑更广泛的上下文能力类型和泛化形式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T01:29:54Z
- **目录日期**: 2025-06-07
