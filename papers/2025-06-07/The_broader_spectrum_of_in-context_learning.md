...
这篇论文提出了一种新视角，将语言模型的少量样本学习能力置于更广泛的元学习框架下。作者认为，任何能通过上下文显著降低后续预测损失的序列分布，都可视为一种上下文学习。这一观点有助于统一语言模型展现的各种上下文能力，如根据指令适应任务、角色扮演或时间序列外推。研究还揭示了上下文学习可能与语言依赖处理（如共指或平行结构）的低层次处理相关，并强调了泛化能力的重要性——包括学习新事物、从不同呈现方式中学习以及应用所学知识。最后，作者建议未来研究应考虑更广泛的上下文学习能力和泛化类型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T10:02:39Z
- **目录日期**: 2025-06-07
