...
这篇论文提出了一个更广泛的视角来看待语言模型的上下文学习能力。作者认为，任何能够通过上下文显著降低后续预测损失的序列分布都可以被视为某种形式的上下文学习。这一观点有助于统一语言模型展现的各种上下文能力，如根据指令或角色扮演适应任务、外推时间序列等。研究还揭示了上下文学习可能源于语言依赖关系的低层次处理（如共指或平行结构），并强调了泛化能力的重要性，包括学习新事物的能力、从不同呈现方式中学习的灵活性以及应用所学知识的能力。作者建议未来的上下文学习研究应考虑更广泛的能力和泛化类型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T22:02:20Z
- **目录日期**: 2025-06-07
