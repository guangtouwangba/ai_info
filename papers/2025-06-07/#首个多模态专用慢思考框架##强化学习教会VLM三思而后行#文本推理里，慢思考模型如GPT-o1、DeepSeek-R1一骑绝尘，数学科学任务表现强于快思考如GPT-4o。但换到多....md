...
港科大等团队针对视觉语言模型(VLM)在多模态推理中"慢思考"失效问题，提出VL-Rethinker框架。该方案包含两大创新：1）优势样本回放机制，重点学习关键样本；2）强制反思机制，通过提示语引导模型自主判断反思时机。基于39K高质量多模态数据训练，该框架在MathVista等基准测试中超越GPT-o1，接近OpenAI-o1水平，不同规模模型均显著提升。研究证明"慢思考"策略经适配后同样适用于多模态领域，使VLM具备自我验证和纠错能力，甚至能识别题目本身的错误。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T15:02:16Z
- **目录日期**: 2025-06-07
