...
港科大等团队针对视觉语言模型(VLM)在多模态推理中的"慢思考"短板，提出了VL-Rethinker框架。该框架通过两项创新机制：1)优势样本回放(SSR)优先训练关键样本，2)强制反思机制引导模型自主验证纠错。基于39K高质量多模态数据(ViRL39K)的实验显示，该框架在MathVista等数据集上超越GPT-o1，接近OpenAI-o1水平，不同规模模型均获显著提升。研究首次验证了慢思考在多模态领域的有效性，使VLM具备"三思而后行"的反思能力，甚至能识别题目本身的错误。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T12:01:29Z
- **目录日期**: 2025-06-07
