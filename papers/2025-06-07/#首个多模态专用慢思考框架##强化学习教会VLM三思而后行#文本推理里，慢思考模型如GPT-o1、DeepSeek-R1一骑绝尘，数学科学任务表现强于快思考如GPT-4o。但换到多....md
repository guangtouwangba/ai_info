...
港科大团队针对视觉语言模型(VLM)在多模态推理中的"慢思考"短板，提出创新框架VL-Rethinker。通过构建39K高质量数据集(ViRL39K)并设计两项机制：1)优势样本回放(SSR)聚焦关键训练样本；2)强制反思提示引导自我验证。该框架使模型能自主判断反思时机，甚至识别题目错误，在MathVista等基准测试中超越GPT-o1，接近OpenAI-o1水平，不同规模模型均显著提升。研究证明"慢思考"策略可有效提升VLM的推理能力，为多模态AI发展提供新思路。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T17:02:09Z
- **目录日期**: 2025-06-07
