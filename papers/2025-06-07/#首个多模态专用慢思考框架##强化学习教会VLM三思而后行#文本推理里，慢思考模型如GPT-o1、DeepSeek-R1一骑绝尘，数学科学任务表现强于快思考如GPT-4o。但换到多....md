...
港科大等团队针对视觉语言模型(VLM)在多模态推理中存在的"优势消失"和"反思惰性"问题，提出首个多模态专用慢思考框架VL-Rethinker。该框架通过"优势样本回放"(优先训练高价值样本)和"强制反思机制"(引导模型自我验证)两项关键技术，显著提升模型性能。实验显示，该框架在MathVista等数据集上超越GPT-o1，接近OpenAI-o1水平，不同规模模型均获大幅提升，验证了慢思考在多模态领域的有效性。相关成果包含39K高质量多模态推理数据集ViRL39K。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T10:03:11Z
- **目录日期**: 2025-06-07
