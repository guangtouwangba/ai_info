...
港科大等团队针对视觉语言模型(VLM)在多模态推理中"慢思考"失效的问题，提出VL-Rethinker框架。该框架通过两项创新机制：1)优势样本回放(SSR)策略，优先学习关键样本；2)强制反思机制，引导模型自主判断反思时机。基于39K条多模态数据(ViRL39K)的实验显示，该框架在MathVista等基准测试中超越GPT-o1，接近OpenAI-o1水平，不同规模模型均显著提升。研究证实了慢思考在多模态领域的可行性，使VLM具备自我验证、纠错甚至识别题目错误的能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T11:01:27Z
- **目录日期**: 2025-06-07
