...
当前大语言模型(LLMs)主要应用于同步对话场景，而现实世界中的群聊、在线会议和社交游戏等场景本质上是异步的。本研究开发了一种自适应异步LLM智能体，不仅能决定说什么，还能决定何时发言。通过在"狼人杀"游戏中与人类玩家共同测试，该智能体在游戏表现和融入度上都与人类相当。分析显示，智能体的发言时机选择与人类相似，但发言内容存在差异。研究发布了完整数据集和代码，为LLMs融入真实人类群体场景(如团队讨论辅助、教育及专业环境)铺平了道路，推动更真实的异步通信研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T13:07:49Z
- **目录日期**: 2025-06-07
