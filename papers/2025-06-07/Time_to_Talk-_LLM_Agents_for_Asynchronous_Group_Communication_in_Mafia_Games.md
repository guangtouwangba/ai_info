...
该研究开发了一种异步LLM智能体，不仅能决定说什么，还能决定何时发言，以模拟现实中的非轮流对话场景（如群聊、在线会议等）。通过在"狼人杀"游戏中测试，该智能体表现与人类相当，既能融入人群，发言时机也与人类相似，但内容存在差异。研究发布了完整数据和代码，为LLM在团队协作、教育等需要复杂社交互动的场景中的应用铺平道路，推动LLM向更自然的异步人机交互发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T00:01:49Z
- **目录日期**: 2025-06-07
