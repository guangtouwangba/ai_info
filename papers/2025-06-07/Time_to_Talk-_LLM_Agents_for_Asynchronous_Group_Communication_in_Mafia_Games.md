...
当前大语言模型(LLM)主要用于同步交流，而现实场景多为异步沟通(如群聊、在线会议等)。本研究开发了一种自适应异步LLM智能体，不仅能决定"说什么"，还能判断"何时说"。通过在"狼人杀"游戏中测试，该智能体表现与人类相当，既能融入群体，发言时机也与人类相似(但内容存在差异)。研究发布了完整数据集和代码，为LLM在团队协作、教育等需要复杂社交互动的场景中的应用铺平道路，推动LLM在真实人类群体环境中的整合。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T04:02:45Z
- **目录日期**: 2025-06-07
