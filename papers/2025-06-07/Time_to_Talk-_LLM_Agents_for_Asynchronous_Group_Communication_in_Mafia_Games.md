...
当前大语言模型(LLMs)主要用于同步对话，而现实场景如群聊、在线会议等多为异步交流。本研究开发了一种自适应异步LLM智能体，能自主决定发言内容和时机。通过在"狼人杀"游戏中测试，该智能体表现与人类相当，能自然融入群体。分析显示其发言时机选择与人类相似，但内容存在差异。研究发布了完整数据集和代码，为LLM在团队协作、教育等复杂社交场景的应用铺路，推动人机异步交互的发展。这项工作为LLM融入真实群体环境提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T10:01:37Z
- **目录日期**: 2025-06-07
