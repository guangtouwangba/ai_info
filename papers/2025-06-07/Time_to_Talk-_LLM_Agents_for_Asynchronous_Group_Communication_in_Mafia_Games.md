...
当前大语言模型(LLMs)主要用于同步对话，而现实场景如群聊、在线会议等往往是异步的。本研究开发了一种异步LLM智能体，能自主决定发言内容和时机。通过在"狼人杀"游戏中测试，该智能体表现与人类相当，能自然地融入群体。分析显示其发言时机选择与人类相似，但内容存在差异。研究发布了完整数据集和代码，为LLMs在团队协作、教育等需要复杂社交互动的场景中的应用铺平道路。这项工作推动了LLMs向更真实的异步群体交流环境发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T07:01:20Z
- **目录日期**: 2025-06-07
