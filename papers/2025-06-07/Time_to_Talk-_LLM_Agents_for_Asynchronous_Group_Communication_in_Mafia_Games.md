...
当前大语言模型(LLMs)主要用于同步对话场景，而现实中的群聊、在线会议等往往是异步交流。本研究开发了一种自适应异步LLM智能体，不仅能决定"说什么"，还能判断"何时说"。通过在"狼人杀"游戏中测试，该智能体表现与人类相当，能自然地融入群体。分析显示其发言时机选择与人类相似，但内容存在差异。研究发布了完整数据集和代码，为LLM在团队协作、教育等复杂社交场景的应用铺平道路。这项工作推动了LLM在真实异步交流环境中的发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T08:01:30Z
- **目录日期**: 2025-06-07
