...
当前大语言模型(LLMs)主要应用于同步对话场景，而现实中的群聊、在线会议等往往是异步的。本研究开发了一个异步LLM智能体，不仅能决定说什么，还能决定何时发言。通过在"狼人杀"游戏中测试，该智能体表现与人类相当，发言时机选择与人类相似，但内容存在差异。研究发布了数据集和代码，为LLM融入真实人类群体互动(如团队讨论、教育等场景)奠定了基础，推动了更自然的异步人机交互发展。这项工作有助于LLM在需要处理复杂社交动态的环境中的应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T18:01:22Z
- **目录日期**: 2025-06-07
