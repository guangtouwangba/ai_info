...
当前大语言模型（LLMs）主要用于同步对话（轮流发言），而现实场景（如群聊、在线会议或社交游戏）多为异步交流。本研究开发了一种异步LLM智能体，不仅能决定发言内容，还能自主选择发言时机。通过在"狼人杀"游戏中与人类玩家对比测试，该智能体在游戏表现和融入度上与人类相当，其发言时机决策也接近人类模式，但内容存在差异。研究公开了数据和代码，为LLMs融入真实人类群体场景（如团队协作、教育等需要处理复杂社交动态的环境）奠定了基础。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T19:01:16Z
- **目录日期**: 2025-06-07
