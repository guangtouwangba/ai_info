...
当前大语言模型(LLM)主要用于同步对话，而现实交流多为异步(如群聊、在线会议等)。研究者开发了一种异步LLM智能体，能自主决定发言时机和内容。通过在"狼人杀"游戏中测试，该智能体表现与人类相当，能自然融入群体。分析显示其发言时机选择与人类相似，但内容存在差异。研究团队公开了数据集和代码，推动LLM在异步交流中的发展。该成果为LLM融入真实群体场景(如团队协作、教育等)奠定了基础，有助于处理复杂社交动态。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T22:01:23Z
- **目录日期**: 2025-06-07
