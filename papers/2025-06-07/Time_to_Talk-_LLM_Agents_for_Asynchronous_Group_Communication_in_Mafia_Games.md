...
当前大语言模型（LLMs）主要用于同步对话（轮流发言），但现实场景（如群聊、在线会议或社交游戏）多为异步交流，发言时机是关键决策。本研究开发了一种异步LLM智能体，不仅能决定发言内容，还能选择发言时机。通过在在线"狼人杀"游戏中测试，该智能体表现与人类相当，并能自然融入玩家群体。分析显示，其发言时机决策与人类相似，但内容存在差异。研究公开了数据和代码，推动LLMs在更真实的异步交流中的应用，为团队协作、教育等复杂社交场景的整合铺平道路。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T06:01:34Z
- **目录日期**: 2025-06-07
