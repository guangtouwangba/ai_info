...
复旦大学与香港中文大学联合推出MME-Reasoning基准，首次系统评估多模态大模型的逻辑推理能力。该基准包含1188道题，涵盖演绎、归纳和溯因三类推理，测试五种能力（模式分析、规划探索等）。30多款模型参与测评，包括GPT-4o、Gemini 2.5 Pro等，最高得分仅60%左右。研究发现模型常出现重复推理、假设验证等问题。该基准通过严格设计避免知识偏见，成为当前最具挑战性的多模态推理评估工具之一。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T23:03:50Z
- **目录日期**: 2025-06-07
