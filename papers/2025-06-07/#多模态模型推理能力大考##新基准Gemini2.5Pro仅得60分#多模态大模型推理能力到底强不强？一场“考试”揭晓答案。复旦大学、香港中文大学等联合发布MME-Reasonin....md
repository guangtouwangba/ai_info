...
复旦大学与香港中文大学联合推出MME-Reasoning基准，首次系统评估多模态大模型的逻辑推理能力。该基准包含1188道题，涵盖演绎、归纳和溯因三类推理，按难度和题型（选择、问答、规则验证）划分，测试模式分析、规划等五种能力。评估30多款模型（包括GPT-4o、Gemini 2.5 Pro等），最优得分仅约60%，显示当前模型在多模态推理上仍有局限。研究发现模型常出现重复推理、冗长回答等问题。该基准成为目前最具挑战性的多模态推理评估标准之一。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T16:03:36Z
- **目录日期**: 2025-06-07
