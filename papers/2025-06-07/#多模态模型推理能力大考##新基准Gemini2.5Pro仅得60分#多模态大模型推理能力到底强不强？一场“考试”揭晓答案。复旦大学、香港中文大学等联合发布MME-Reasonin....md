...
复旦大学和香港中文大学联合发布MME-Reasoning基准，首次系统评估多模态大模型的逻辑推理能力。该基准包含1188道题，涵盖演绎、归纳和溯因三类推理，分选择题、自由作答和规则验证三种题型，测试模式分析、规划探索等五种能力。评估了GPT-4o、Gemini 2.5 Pro等30多款模型，最优得分仅60%左右。研究发现模型常出现重复推理、过度生成等问题。该基准避免了知识偏见，专注于逻辑本身，成为当前最具挑战性的多模态推理评估标准之一。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T15:02:26Z
- **目录日期**: 2025-06-07
