...
复旦大学和香港中文大学联合发布MME-Reasoning基准，首次系统评估多模态大模型的逻辑推理能力。该基准包含1188道题，涵盖演绎、归纳和溯因三类推理，按难度分档并避免知识偏见。测试了GPT-4o、Gemini 2.5 Pro等30多款模型，最优得分仅60%左右。研究发现模型常出现重复推理、冗长回答等问题。该基准被认为是当前最具挑战性的多模态推理评估工具，显示现有模型在复杂逻辑推理上仍有明显不足。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T11:01:35Z
- **目录日期**: 2025-06-07
