...
复旦大学与香港中文大学联合发布MME-Reasoning基准，首次系统评估多模态大模型的逻辑推理能力。该基准包含1188道题，涵盖演绎、归纳、溯因三类推理，测试五种核心能力。30多款主流模型（如GPT-4o、Gemini 2.5 Pro）参与测评，最高得分仅约60%，显示当前多模态模型在复杂推理任务上仍有明显局限。研究发现模型常出现冗余推理、假设验证困难等问题。该基准通过严格设计规避知识偏见，成为当前最具挑战性的多模态推理评估标准之一。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T13:10:06Z
- **目录日期**: 2025-06-07
