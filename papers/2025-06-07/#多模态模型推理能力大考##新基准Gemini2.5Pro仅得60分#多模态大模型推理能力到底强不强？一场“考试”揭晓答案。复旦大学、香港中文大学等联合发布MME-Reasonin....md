...
复旦大学与香港中文大学联合推出MME-Reasoning基准，首次系统评估多模态大模型的逻辑推理能力。该基准包含1188道题，涵盖演绎、归纳、溯因三类推理，分选择题、自由作答等题型，测试模式分析、时空推理等五项能力。评测30余款模型（包括GPT-4o、Gemini 2.5 Pro等），最高得分仅约60%，显示当前模型在多模态推理上仍有明显不足。研究发现模型常出现重复推理、无效假设等问题。该基准因严格区分推理类型、规避知识偏见，成为最具挑战性的多模态评估标准之一。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T12:01:42Z
- **目录日期**: 2025-06-07
