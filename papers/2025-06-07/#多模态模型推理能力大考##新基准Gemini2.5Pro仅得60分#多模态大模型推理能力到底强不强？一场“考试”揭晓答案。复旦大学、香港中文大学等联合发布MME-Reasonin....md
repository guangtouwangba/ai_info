...
复旦大学与香港中文大学联合推出MME-Reasoning基准，首次系统评估多模态大模型的逻辑推理能力。该基准包含1188道题，涵盖演绎、归纳、溯因三类推理，分选择题、自由作答等题型，测试模式分析、时空推理等五项能力。评估30余款模型（包括GPT-4o、Gemini 2.5 Pro等），最高得分仅约60%。研究发现模型常出现重复推理、过度生成等问题。该基准通过严格设计规避知识偏见，成为当前最具挑战性的多模态推理评估标准，显示现有模型逻辑推理能力仍有显著提升空间。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T22:03:27Z
- **目录日期**: 2025-06-07
