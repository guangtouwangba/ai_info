...
复旦大学和香港中文大学联合推出MME-Reasoning基准，首次系统评估多模态大模型的逻辑推理能力。该基准包含1188道题目，涵盖演绎、归纳和溯因三类推理，分选择题、自由作答和规则验证三种题型，测试模式分析、规划探索等五种能力。评估30多款模型（包括GPT-4o、Gemini 2.5 Pro等）发现，最优模型得分仅约60%，显示当前多模态模型在复杂推理任务上仍有显著不足。该基准通过严格设计避免知识偏见，成为最具挑战性的多模态推理评估标准之一。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T19:03:15Z
- **目录日期**: 2025-06-07
