...
本文提出了"控制税"(Control Tax)的概念，用于衡量将安全控制措施整合到AI系统中的操作和财务成本。研究建立了量化控制税的理论框架，将分类器性能与安全保障相关联；在对抗环境下评估了先进语言模型，测试攻击者植入后门与监控模型检测漏洞的能力；并提供了控制协议的实际成本估算，开发了平衡安全性与成本效益的优化监控策略。该框架通过系统连接安全保证与其成本，帮助从业者做出明智决策，推动AI控制领域在不同部署场景中的经济可行性评估。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T00:02:08Z
- **目录日期**: 2025-06-07
