...
本文提出“控制税”概念，即AI控制措施带来的运营和财务成本，为AI控制领域做出三点贡献：1) 建立量化控制税的理论框架，将分类器性能映射到安全保证；2) 在对抗环境下评估先进语言模型，研究攻击模型植入代码后门与监控模型检测的对抗；3) 提供控制协议的实际成本估算，并开发平衡安全性与成本效益的优化监控策略，同时考虑审计预算等现实约束。该框架通过系统关联安全保证与成本，帮助从业者做出明智决策，推动AI控制在经济可行性评估方面的发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T06:01:53Z
- **目录日期**: 2025-06-07
