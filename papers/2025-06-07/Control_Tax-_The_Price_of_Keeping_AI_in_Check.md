...
本文提出"控制税"(Control Tax)概念，用于衡量AI系统中整合安全控制措施所需的操作和财务成本。研究建立了量化控制税的理论框架，将分类器性能映射到安全保障；评估了对抗环境下先进语言模型的漏洞检测能力；并提供了控制协议的实际成本估算，开发了平衡安全性与成本效益的优化监控策略。该框架通过系统连接安全保证与其成本，帮助从业者在不同部署场景下基于经济可行性做出明智决策，推动AI控制(AIC)领域的实际应用发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T19:01:32Z
- **目录日期**: 2025-06-07
