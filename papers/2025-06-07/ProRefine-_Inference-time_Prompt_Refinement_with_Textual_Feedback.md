...
ProRefine是一种创新的即时提示优化方法，通过利用大语言模型的文本反馈来改进多智能体协作工作流中的提示设计。该方法无需额外训练或真实标签，就能动态优化多步推理任务的提示。在五个数学推理基准测试中，ProRefine比零样本思维链基线提高了3-37个百分点。该技术不仅能提升准确性，还能使较小模型达到与大模型相当的性能，有助于高效、可扩展的AI部署，并促进高性能AI的普及应用。研究解决了当前智能体工作流中因提示设计不佳导致的错误传播和性能欠佳问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T05:01:51Z
- **目录日期**: 2025-06-07
