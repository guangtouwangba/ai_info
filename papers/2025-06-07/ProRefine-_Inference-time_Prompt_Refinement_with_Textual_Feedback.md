...
多智能体协作工作流（Agentic workflows）常因提示词设计不佳导致错误传播和性能下降。研究者提出ProRefine方法，通过大语言模型的文本反馈动态优化多步推理任务的提示词，无需额外训练或标注数据。在5个数学推理基准测试中，ProRefine比零样本思维链基线提升3-37个百分点，使小模型达到大模型性能。该方法提高了AI系统的准确性和可扩展性，为高效部署高性能AI提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T04:02:53Z
- **目录日期**: 2025-06-07
