...
本文介绍了ProRefine，一种创新的推理时提示优化方法，用于解决多AI代理协作工作流中的错误传播和性能不佳问题。该方法利用大语言模型（LLM）的文本反馈动态优化多步推理任务的提示，无需额外训练或真实标签。在五个数学推理基准测试中，ProRefine显著优于零样本思维链基线3到37个百分点。该技术不仅能提高准确性，还能使较小模型达到与大模型相当的性能，展现了高效、可扩展AI部署的潜力，有助于高性能AI的普及应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T19:01:24Z
- **目录日期**: 2025-06-07
