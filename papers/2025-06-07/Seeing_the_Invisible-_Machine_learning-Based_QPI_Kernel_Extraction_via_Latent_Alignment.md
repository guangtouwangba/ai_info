...
本文提出了一种基于AI的准粒子干涉(QPI)核提取新方法，解决了多散射源图像中单散射核提取这一不适定逆问题。该方法采用两步学习策略：首先通过变分自编码器学习散射核的紧凑潜在表示；随后利用专用编码器将QPI观测数据与预学习核的潜在表示对齐。这种设计使模型能在复杂纠缠散射条件下稳健推断核函数。研究构建了包含100种独特核的多样化QPI数据集，实验表明该方法较传统一步法基线具有更高提取精度，且对未见核具有更好泛化能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T02:30:38Z
- **目录日期**: 2025-06-07
