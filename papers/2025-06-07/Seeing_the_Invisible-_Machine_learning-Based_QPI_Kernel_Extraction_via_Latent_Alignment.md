...
本研究提出了首个基于人工智能的准粒子干涉(QPI)核提取框架，用于解决多散射源图像中单散射核提取这一病态逆问题。该框架采用两步学习策略：首先训练变分自编码器学习散射核的紧凑潜在空间表示；然后通过专用编码器将QPI观测数据与预学习核的潜在表示对齐。这种设计使模型能在复杂纠缠散射条件下稳健推断散射核。研究构建了包含100种独特核的多样化QPI数据集，实验表明该方法相比直接一步法基线具有显著更高的提取精度，并对未见核具有更好的泛化能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T10:01:27Z
- **目录日期**: 2025-06-07
