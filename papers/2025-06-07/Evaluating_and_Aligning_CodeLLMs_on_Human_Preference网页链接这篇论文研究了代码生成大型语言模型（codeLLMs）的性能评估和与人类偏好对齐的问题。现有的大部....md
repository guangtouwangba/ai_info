...
这篇论文针对代码生成大模型(codeLLMs)提出了CodeArena基准测试，聚焦模型输出与人类偏好的对齐问题。研究收集了397个涵盖40类任务、44种编程语言的真实样本，并构建了20B标记量的合成指令数据集SynCode-Instruct。实验发现传统执行测试与人类偏好评估存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI)性能差距显著，凸显了人类偏好对齐的重要性。该研究为评估代码生成模型提供了更全面的框架，强调除功能性外还需考虑实际开发者的使用偏好。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T23:05:50Z
- **目录日期**: 2025-06-07
