...
这篇论文提出了CodeArena基准测试和SynCode-Instruct语料库，用于评估代码生成大模型(CodeLLMs)与人类偏好的对齐程度。CodeArena包含397个高质量编程任务样本，覆盖40个类别和44种语言，模拟真实编程场景。研究发现在执行基准和人类偏好评估间存在性能差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI)差距显著。同时验证了大规模合成指令微调的有效性，强调了对齐人类偏好的重要性。该研究为提升代码生成模型的实际适用性提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T20:03:56Z
- **目录日期**: 2025-06-07
