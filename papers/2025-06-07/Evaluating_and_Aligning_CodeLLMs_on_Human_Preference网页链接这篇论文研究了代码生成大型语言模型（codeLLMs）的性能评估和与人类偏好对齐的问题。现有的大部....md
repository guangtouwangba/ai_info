...
这篇论文针对代码生成大模型(codeLLMs)与人类偏好对齐的问题，提出了CodeArena基准测试(包含397个高质量样本，覆盖40类任务和44种编程语言)和SynCode-Instruct合成指令语料库(近200亿标记)。研究发现现有基于执行的评估与人类偏好存在差距，实验显示开源模型(如Qwen2.5-Coder)与专有模型(如OpenAI o1)性能差异显著。该研究强调了代码生成模型除正确性外，还需重视与人类开发者偏好的对齐。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T10:05:47Z
- **目录日期**: 2025-06-07
