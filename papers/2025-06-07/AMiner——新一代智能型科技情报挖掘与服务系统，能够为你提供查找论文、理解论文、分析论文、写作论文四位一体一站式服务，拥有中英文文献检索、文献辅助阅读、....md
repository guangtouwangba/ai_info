...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、辅助阅读、翻译和科研情报订阅。它拥有3.5亿论文、0.6亿学者等海量数据，支持AI生成摘要、互动问答和文档解析。用户可定制订阅最新科研动态，并免费使用学者画像、学术会议等功能。平台通过网页和小程序提供便捷访问，帮助用户高效获取和理解学术信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T21:04:02Z
- **目录日期**: 2025-06-07
