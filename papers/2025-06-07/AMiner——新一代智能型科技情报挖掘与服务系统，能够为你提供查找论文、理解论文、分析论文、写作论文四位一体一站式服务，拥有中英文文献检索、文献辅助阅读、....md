...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译及科研分析等一站式服务。它收录3.5亿论文、0.6亿学者和1.5亿专利，支持中英文文献检索，能自动生成摘要并回答用户问题。此外，AMiner还提供文献翻译、科研动态订阅、学者画像等功能，帮助用户高效获取学术资讯。平台可通过网页免费使用，适合科研人员快速查找和理解文献内容。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T22:05:09Z
- **目录日期**: 2025-06-07
