...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和科研订阅等服务。它涵盖42个学科，拥有3.5亿论文、0.6亿学者等海量数据。主要功能包括：1）中英文文献检索，支持互动问答和自动摘要生成；2）英文文献翻译与辅助阅读，可上传PDF并获取AI生成的摘要和问答；3）科研情报订阅，按用户偏好推送最新学术动态。此外还提供学者画像、学术会议等工具。平台部分功能免费开放，旨在提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T04:06:40Z
- **目录日期**: 2025-06-07
