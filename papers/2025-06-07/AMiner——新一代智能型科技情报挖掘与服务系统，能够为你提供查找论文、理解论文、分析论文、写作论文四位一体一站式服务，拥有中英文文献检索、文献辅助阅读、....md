...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、科研情报订阅等一站式服务。其核心功能包括：1）高效检索3.5亿论文资源，支持AI生成摘要和互动问答；2）文献翻译和辅助阅读工具，可解析PDF并提取关键信息；3）个性化订阅服务，按用户偏好推送最新研究动态。平台还涵盖学者画像、学术会议等特色功能，支持浏览器免费使用。通过AI技术显著提升文献查阅、理解和写作效率，适用于科研工作者快速获取学术资讯。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T19:04:58Z
- **目录日期**: 2025-06-07
