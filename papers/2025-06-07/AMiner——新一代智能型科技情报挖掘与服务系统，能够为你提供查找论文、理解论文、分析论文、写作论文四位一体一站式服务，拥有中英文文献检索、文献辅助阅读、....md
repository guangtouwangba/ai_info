...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、科研情报订阅等一站式服务。它能快速定位相关学术文献，支持互动问答和自动摘要生成，帮助用户高效理解内容。用户可上传PDF或从平台获取论文，AI会生成摘要、章节概要和问题建议。此外，AMiner支持定制化科研动态推送，通过微信或邮件发送最新学术资讯。平台还包含学者画像、学术会议和论文排行榜等功能，基础服务免费使用。访问入口：https://www.aminer.cn/。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T07:05:18Z
- **目录日期**: 2025-06-07
