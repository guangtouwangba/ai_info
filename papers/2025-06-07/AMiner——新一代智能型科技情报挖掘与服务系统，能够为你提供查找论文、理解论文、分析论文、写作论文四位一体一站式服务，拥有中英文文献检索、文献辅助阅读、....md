...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、翻译、辅助阅读和科研情报订阅。它拥有3.5亿论文、0.6亿学者等海量数据，支持AI生成摘要、互动问答和文献分析。用户可订阅个性化科研动态，追踪学者及机构最新成果。平台还提供学者画像、学术会议推荐等功能，基础服务免费开放。网址：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T08:05:36Z
- **目录日期**: 2025-06-07
