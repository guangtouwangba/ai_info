...
AMiner是一个智能科技情报挖掘平台，提供文献检索、辅助阅读、翻译和科研订阅等一站式服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持中英文检索、AI生成摘要和互动问答。用户可上传PDF或从库中选文，获取章节概要和问题建议。平台还提供个性化科研动态推送，通过微信或邮件发送最新论文摘要。此外，AMiner具备学者画像、学术会议和论文排行榜等功能，基础服务免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T05:06:10Z
- **目录日期**: 2025-06-07
