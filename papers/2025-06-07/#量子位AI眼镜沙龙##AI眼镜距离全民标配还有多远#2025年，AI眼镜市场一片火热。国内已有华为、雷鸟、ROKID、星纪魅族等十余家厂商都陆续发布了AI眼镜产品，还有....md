...
2025年AI眼镜市场竞争激烈，华为、雷鸟等十余家厂商已推出产品，"百镜大战"开启。量子位拟于6月下旬在北京举办AI眼镜沙龙，探讨行业现状与未来，包括第一代产品市场反馈、爆款挑战、杀手级应用及全民标配路径。活动将邀请厂商、产业链企业和投资机构参与。AI眼镜作为最贴近人体的AI硬件形态，正成为创新落地场景，但距离全民普及仍需解决技术、应用等多方面问题。活动详情可通过量子位公众号获取。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T03:23:02Z
- **目录日期**: 2025-06-07
