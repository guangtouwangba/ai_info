...
2025年AI眼镜市场蓬勃发展，华为、雷鸟等十余家厂商已推出产品，行业进入"百镜大战"阶段。量子位计划6月下旬在北京举办AI眼镜专题沙龙，探讨产品市场反馈、爆款打造难点、杀手级应用及全民普及路径。活动将邀请眼镜厂商、芯片/大模型供应商及投资机构参与，通过主题分享和圆桌对话形式展开。该沙龙旨在推动行业交流，加速AI眼镜从创新产品向全民标配的演进。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T04:05:12Z
- **目录日期**: 2025-06-07
