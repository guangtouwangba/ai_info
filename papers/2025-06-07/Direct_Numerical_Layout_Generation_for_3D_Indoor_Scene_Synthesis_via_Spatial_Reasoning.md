...
这篇论文提出了DirectLayout框架，利用大语言模型的空间推理能力直接从文本描述生成3D室内场景布局。该方法通过三阶段流程：首先生成俯视图布局，然后提升到3D空间，最后优化物体摆放。研究采用基于3D-Front数据集的思想链激活技术来增强空间推理能力，并设计了生成式布局奖励机制提高泛化性。推理阶段通过上下文学习迭代调整资产与布局的匹配。实验表明，DirectLayout在语义一致性、泛化能力和物理合理性方面表现优异，解决了现有方法在开放词汇和细粒度控制上的不足。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T13:07:15Z
- **目录日期**: 2025-06-07
