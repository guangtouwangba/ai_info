...
AgentSociety是一个基于大语言模型的大规模社会模拟平台，可模拟1万个AI代理的社会互动（500万次）。研究者用它研究四大社会问题：社会极化、信息传播、基本收入政策效果和自然灾害影响。模拟结果与现实数据吻合，验证了该平台捕捉人类行为机制的能力，展示了其作为社会科学研究和政策制定工具的潜力。该平台结合了AI代理、真实社会环境和大规模模拟引擎，为传统研究方法提供了有效补充。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T23:05:13Z
- **目录日期**: 2025-06-07
