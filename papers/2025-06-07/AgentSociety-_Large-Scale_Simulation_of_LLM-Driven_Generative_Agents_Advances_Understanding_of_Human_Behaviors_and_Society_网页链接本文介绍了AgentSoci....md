...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统通过1万多个智能代理和500万次互动，模拟真实社会环境，用于研究社会问题。研究者测试了四个关键场景：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实数据吻合，验证了系统捕捉人类行为机制的能力。该平台可作为社会科学研究和政策制定的有力工具，弥补传统方法的局限性。研究表明，这种AI驱动的模拟方法能有效探索社会问题的成因和潜在解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T21:03:38Z
- **目录日期**: 2025-06-07
