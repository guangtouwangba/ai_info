...
这篇论文介绍了AgentSociety，这是一个利用大语言模型驱动的大规模社会模拟系统，能够模拟超过1万个代理及其500万次互动。研究者用它作为计算社会科学实验平台，研究了社会极化、信息传播、基本收入政策及自然灾害影响等四个关键问题。模拟结果与现实世界数据吻合，验证了该系统捕捉人类行为机制的能力，展示了其作为社会科学研究和政策制定工具的潜力。该技术为理解复杂社会现象提供了新方法，可辅助传统研究手段。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T18:04:42Z
- **目录日期**: 2025-06-07
