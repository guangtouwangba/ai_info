...
复旦大学与腾讯优图实验室合作开发了基于扩散模型的少样本异常图像生成新算法DualAnoDiff，解决了工业异常检测中真实异常数据稀缺的问题。该算法能生成接近真实异常情形的图像，并显著提升了检测模型的性能（检测、定位、分类等任务）。实验表明，DualAnoDiff在MVTec数据集上超越了现有方法，达到新的SOTA水平。相关论文已被CVPR 2025接收。这一突破为工业质检领域提供了更高效的异常检测解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T07:03:24Z
- **目录日期**: 2025-06-07
