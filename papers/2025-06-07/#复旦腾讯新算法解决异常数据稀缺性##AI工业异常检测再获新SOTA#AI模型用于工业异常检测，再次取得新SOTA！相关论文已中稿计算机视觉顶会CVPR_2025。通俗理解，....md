...
复旦大学与腾讯优图实验室合作开发了新型算法DualAnoDiff，基于扩散模型解决工业异常检测中数据稀缺问题。该算法通过生成逼真的异常图像来训练检测模型，在MVTec数据集上表现优异，实现了检测、定位和分类任务的SOTA性能。相关论文已被CVPR 2025接收。相比传统方法，DualAnoDiff生成的异常图像更接近真实情况，显著提升了下游任务的检测效果。这一突破为工业质检领域提供了更高效的AI解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T08:03:39Z
- **目录日期**: 2025-06-07
