...
复旦大学与腾讯优图实验室联合研发的DualAnoDiff模型，解决了工业异常检测中真实异常数据稀缺的问题。该基于扩散模型的算法能生成高质量的异常样本图像，在MVTec数据集上实现了最接近真实异常的表现，并在检测、定位和分类等下游任务中取得新的SOTA效果。相比传统方法，DualAnoDiff仅需少量样本即可生成逼真异常图像，显著提升了模型训练效果。这项成果已被计算机视觉顶会CVPR 2025接收，为工业质检领域提供了更高效的数据增强方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T02:32:46Z
- **目录日期**: 2025-06-07
