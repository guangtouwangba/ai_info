...
2024年智源大会（"AI春晚"）呈现两大亮点：1）机器人展演方面，宇树G1人形机器人展示拳击能力，天工机器人2.0版演示家政技能，银河通用机器人实现语音指令完成取货全流程；2）学术前沿部分，四位图灵奖得主（Bengio、Sutton、姚期智、Sifakis）发表主题演讲。活动通过"科研+应用"双线并行的形式，集中展示了AI领域的最新突破与产业化成果。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T23:03:30Z
- **目录日期**: 2025-06-07
