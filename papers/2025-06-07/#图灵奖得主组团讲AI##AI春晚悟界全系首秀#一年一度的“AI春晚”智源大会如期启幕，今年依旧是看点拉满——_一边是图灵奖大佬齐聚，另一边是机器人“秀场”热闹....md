...
2024年智源大会（"AI春晚"）亮点纷呈：1）人形机器人同台竞技，宇树G1展示拳击能力，天工2.0演示家政技能；银河通用机器人实现语音指令全流程操作。2）四位图灵奖得主（Bengio、Sutton、姚期智、Sifakis）发表前沿演讲。活动呈现AI领域"科研+应用"双轨进展，机器人实操演示与顶尖学术观点碰撞，展现人工智能技术快速发展的现状。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T21:01:52Z
- **目录日期**: 2025-06-07
