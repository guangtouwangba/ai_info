...
2024年智源大会（"AI春晚"）亮点纷呈：四位图灵奖得主（Bengio/Sutton/姚期智/Sifakis）发表前沿演讲；人形机器人展示惊艳技能——宇树G1演示拳击、天工2.0展示家政服务，银河通用机器人实现语音指令全流程取货。活动呈现科研与应用的深度融合，彰显AI技术快速发展的现状。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T17:01:58Z
- **目录日期**: 2025-06-07
