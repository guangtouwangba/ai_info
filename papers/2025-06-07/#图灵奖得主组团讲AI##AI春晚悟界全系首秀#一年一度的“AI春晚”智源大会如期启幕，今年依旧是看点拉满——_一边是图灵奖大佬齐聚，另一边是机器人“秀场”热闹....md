...
2024年智源"AI春晚"亮点纷呈：四位图灵奖得主（Bengio、Sutton、姚期智、Sifakis）同台演讲；人形机器人成为焦点——宇树G1展示拳击技能，升级版天工机器人演示家政服务；银河通用机器人实现语音指令完成取货全流程。活动呈现科研与应用的深度融合，展现AI技术前沿发展动态。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T16:03:17Z
- **目录日期**: 2025-06-07
