...
2024年智源大会（"AI春晚"）亮点纷呈：1）机器人方面，宇树G1人形机器人展示拳击能力，天工机器人2.0版演示家政技能，银河通用机器人实现语音指令完成取货全流程；2）学术方面，四位图灵奖得主（Bengio、Sutton、姚期智、Sifakis）同台分享AI前沿见解。活动呈现科研与应用的深度融合，展现AI技术快速发展的现状。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-07T19:02:58Z
- **目录日期**: 2025-06-07
