...
生成式AI能帮助小企业主自动化任务、提高效率和改善盈利，但技术门槛仍是主要障碍。研究指出，除提示工程外，用户还需掌握快捷键、编辑技能等辅助技能才能有效使用AI。基于设计研讨会和15家小企业访谈，研究者开发了BizChat——一个基于大语言模型的网页应用，帮助不同数字技能水平的用户撰写商业计划书。该应用采用三项设计原则：兼顾新手与高级用户的可扩展性("低门槛高上限")、提供即时微学习("适时学习")、围绕商业场景设计交互("情境化技术引入")。未来计划将进一步部署该应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T01:29:34Z
- **目录日期**: 2025-05-17
