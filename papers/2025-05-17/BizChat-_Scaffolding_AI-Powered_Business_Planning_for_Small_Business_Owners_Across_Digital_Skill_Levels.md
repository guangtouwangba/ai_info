...
生成式AI能帮助小企业主自动化任务、提高效率并改善盈利。然而，尽管ChatGPT等系统设计直观，技术能力较弱的用户仍面临障碍。研究发现，用户需掌握键盘快捷键、编辑技能、文件转换和浏览器操作等辅助技能才能有效使用AI。为此，研究者开发了BizChat——一个基于大语言模型的网页应用，帮助不同数字技能水平的企业主撰写商业计划书。该应用采用三个设计原则：低门槛高上限的易用性、实时微学习的创业教育支持，以及围绕商业场景的交互设计。未来计划进一步部署该应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T14:02:21Z
- **目录日期**: 2025-05-17
