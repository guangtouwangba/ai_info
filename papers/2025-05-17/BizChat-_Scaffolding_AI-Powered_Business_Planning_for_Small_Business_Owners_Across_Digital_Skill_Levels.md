...
生成式AI能帮助小企业主自动化任务、提高效率并改善盈利，但对技术不熟练者仍存在使用障碍。研究表明，除提示工程外，用户还需掌握快捷键、编辑技能等辅助技能才能有效应用AI。基于设计研讨会和15家小企业访谈，研究者开发了BizChat——一个LLM驱动的网页应用，帮助不同数字技能水平的用户撰写商业计划书。该应用采用三项设计原则：低门槛高上限的易用性设计、即时微学习的教育支持，以及围绕商业场景的交互框架。未来计划将进一步部署该应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T20:02:15Z
- **目录日期**: 2025-05-17
