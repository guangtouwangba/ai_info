...
生成式AI能帮助小企业主自动化任务、提高效率并改善盈利。然而，尽管ChatGPT等系统看似直观，技术不熟练者仍面临使用障碍。研究发现，除提示工程外，用户还需掌握键盘快捷键、编辑技能、文件转换和浏览器操作等辅助技能。基于设计研讨会和15家小企业访谈，研究团队开发了BizChat——一个基于大语言模型的网页应用，帮助不同数字技能水平的用户撰写商业计划书。该应用采用三大设计原则：低门槛高上限、即时微学习、业务场景化交互。未来计划进一步部署该工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T11:02:20Z
- **目录日期**: 2025-05-17
