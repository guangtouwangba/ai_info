...
生成式AI可以帮助小企业主自动化任务、提高效率和利润，但对技术不熟悉的用户仍面临使用障碍。研究发现，除了提示工程外，用户还需掌握快捷键、编辑技能、文件转换等辅助技能。为此，研究者基于设计研讨会和15次访谈，开发了BizChat——一个基于大语言模型的网页应用，帮助不同数字技能水平的用户撰写商业计划书。BizChat采用三项设计原则：低门槛高上限、即时微学习和情境化技术引入，既满足新手需求，也支持高级用户。未来计划进一步部署该应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T17:02:07Z
- **目录日期**: 2025-05-17
