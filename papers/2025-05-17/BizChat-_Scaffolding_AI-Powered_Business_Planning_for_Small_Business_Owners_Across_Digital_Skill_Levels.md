...
生成式AI能帮助小企业主自动化任务、提高效率并改善盈利。然而，尽管ChatGPT等系统看似直观，技术不熟练的用户仍面临障碍。研究发现，除提示工程外，用户还需掌握快捷键、编辑技能、文件转换和浏览器操作等辅助技能。为此，研究者基于设计研讨会和15家小企业访谈，开发了BizChat——一个基于大语言模型的网页应用，帮助不同数字技能水平的企业主撰写商业计划书。BizChat采用三大设计原则：低门槛高上限、即时微学习和业务场景化交互。未来计划进一步部署该应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T08:02:11Z
- **目录日期**: 2025-05-17
