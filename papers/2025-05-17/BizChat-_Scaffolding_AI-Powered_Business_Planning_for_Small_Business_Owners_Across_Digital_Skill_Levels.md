...
生成式AI能帮助小企业主自动化任务、提高效率和利润，但技术门槛仍是主要障碍。研究表明，用户需掌握键盘快捷键、编辑技能等辅助技能才能有效使用AI工具。基于设计研讨会和15家小企业访谈，研究者开发了LLM驱动的BizChat网页应用，帮助不同数字技能水平的用户撰写商业计划书。该应用采用三个设计原则：兼顾新手和高级用户的"低门槛高上限"设计、支持即时学习的微教学模块、以及围绕商业场景的交互框架。研究团队计划未来进一步部署BizChat系统。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T00:02:27Z
- **目录日期**: 2025-05-17
