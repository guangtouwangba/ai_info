...
生成式AI能帮助小企业主自动化任务、提高效率和利润，但对技术不熟悉者仍存在使用障碍。研究发现，除提示工程外，用户还需掌握键盘快捷键、编辑技能等辅助技能。基于设计研讨会和15家小企业访谈，研究者开发了LLM驱动的BizChat网页应用，帮助不同数字技能水平的用户撰写商业计划书。该应用采用三大设计原则：兼顾新手和高级用户的易用性（低门槛高上限）、提供即时微学习支持（适时学习）、围绕商业活动设计交互（情境化技术引入）。未来计划进一步部署该应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T13:07:34Z
- **目录日期**: 2025-05-17
