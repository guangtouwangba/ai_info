...
该研究探讨了如何通过小数据集建模人类在战略网络游戏（Junior High Game）中的行为，以理解社会网络对财富、健康不平等等的影响。研究发现，**hCAB方法**（假设社区意识行为并建模行为分布）表现最佳，能准确模拟小群体（6-11人）的动态，且人类参与者无法区分hCAB代理与真人行为。这表明hCAB能有效捕捉个体和群体层面的真实人类行为，为研究社会网络机制提供了新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T00:02:37Z
- **目录日期**: 2025-05-17
