...
该研究比较了多种从小数据集中学习人类在战略网络游戏（Junior High Game）中行为模型的方法。最佳方法是hCAB，它通过建模行为分布（而非均值）并假设人类具有社区意识行为（而非简单行为匹配），能准确反映6-11人小群体动态。用户研究显示，人类参与者无法区分hCAB智能体与真人行为，验证了该模型能生成可信的个体行为。这些发现为理解人类网络及其对社会不平等等结果的影响提供了新见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T06:02:28Z
- **目录日期**: 2025-05-17
