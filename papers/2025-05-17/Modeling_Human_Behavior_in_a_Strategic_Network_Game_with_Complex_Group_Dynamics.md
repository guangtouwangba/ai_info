...
该研究探讨了如何通过小数据集建模人类在战略网络游戏（Junior High Game）中的行为，以理解社会网络对财富、健康不平等等问题的影响。研究发现，hCAB方法表现最佳，它通过建模行为分布（而非均值）并假设人类具有社区感知行为（而非单纯行为匹配），能更准确地反映小群体（6-11人）的动态。用户研究还表明，人类参与者无法区分hCAB智能体与真实人类行为，验证了该模型在个体层面行为的合理性。这一成果为理解人类网络行为提供了新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T19:02:14Z
- **目录日期**: 2025-05-17
