...
人类网络对社会不平等、贫困和霸凌等关键问题影响深远。为更好理解网络行为，研究对比了多种从小数据集中建模人类行为的方法，重点关注策略性网络游戏“初中游戏”（JHG）。结果表明，表现最佳的hCAB方法通过建模行为分布（而非均值）并假设人类具有社区意识行为（而非简单行为匹配），能更准确反映小群体（6-11人）的动态特征。用户研究还发现，人类参与者无法区分hCAB智能体与真实人类行为，验证了该模型在个体层面的拟真性。这一发现为研究社会网络行为提供了新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T21:02:09Z
- **目录日期**: 2025-05-17
