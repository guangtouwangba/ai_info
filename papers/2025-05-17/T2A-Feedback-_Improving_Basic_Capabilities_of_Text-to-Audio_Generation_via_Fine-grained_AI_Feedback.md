...
本文提出了一种基于AI反馈学习的文本到音频(T2A)生成改进方法。研究者开发了三个细粒度音频评分管道：事件出现评分、事件序列评分和音频质量评分，这些评分与人类偏好显著相关。基于此，构建了包含4.1万提示和24.9万音频的T2A-FeedBack数据集，并创建了专注于长文本、多事件和叙事场景的T2A-EpicBench基准测试。实验表明，通过简单的偏好调整，音频生成模型在简单和复杂场景下均获得显著提升。该方法有效解决了当前T2A模型在复杂多事件音频生成中难以满足人类偏好的问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T01:28:28Z
- **目录日期**: 2025-05-17
