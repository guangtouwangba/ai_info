...
该研究提出通过AI反馈学习提升文本到音频(T2A)生成模型性能的方法。研究者开发了三个细粒度评分系统：事件出现评分、事件序列评分和声学质量评分，这些评分与人类偏好显著相关。基于此构建了包含4.1万提示和24.9万音频的T2A-FeedBack数据集，并创建了针对长文本、多事件场景的T2A-EpicBench基准测试。实验表明，通过简单偏好调优，现有音频生成模型在简单和复杂场景下均获得显著提升。这些自动评分系统可作为有效的反馈信号和评估指标。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T11:01:01Z
- **目录日期**: 2025-05-17
