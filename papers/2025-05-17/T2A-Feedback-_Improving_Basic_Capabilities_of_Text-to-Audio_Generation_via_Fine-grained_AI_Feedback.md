...
本文提出了一种基于AI反馈学习的文本到音频(T2A)生成改进方法。研究团队开发了细粒度的AI音频评分系统，从事件完整性、序列准确性和音质三个维度评估生成音频，这些指标与人类偏好高度相关。基于此构建了包含4.1万提示和24.9万音频的T2A-FeedBack数据集，并建立了针对长文本、多事件场景的T2A-EpicBench基准测试。实验表明，通过简单的偏好调优，该方法能显著提升现有音频生成模型在简单和复杂场景下的表现，特别是在遵循提示和音质方面取得明显进步。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T18:00:52Z
- **目录日期**: 2025-05-17
