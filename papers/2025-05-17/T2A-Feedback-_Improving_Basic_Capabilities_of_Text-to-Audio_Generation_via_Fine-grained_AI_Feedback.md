...
该研究提出了一种基于AI反馈学习的文本转音频(T2A)生成优化方法。针对现有模型在复杂多事件音频生成中存在的提示跟随和音质问题，研究者开发了细粒度AI评分系统，包括事件发生评分、事件序列评分和音质评分。这些评分与人类偏好显著相关，优于现有评估指标。基于此构建了包含4.1万提示和24.9万音频的T2A-FeedBack数据集，并推出专注于长文本、多事件场景的T2A-EpicBench基准测试。实验表明，通过简单偏好调优，模型在简单和复杂场景下的生成质量均获得显著提升。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T07:00:51Z
- **目录日期**: 2025-05-17
