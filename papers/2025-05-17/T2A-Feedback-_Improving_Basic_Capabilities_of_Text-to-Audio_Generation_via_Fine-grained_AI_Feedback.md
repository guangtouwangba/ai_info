...
本文提出通过AI反馈学习提升文本转音频(T2A)模型性能的方法。研究者开发了细粒度的音频评分系统，评估事件完整性、序列准确性和音质，这些指标与人类偏好高度相关。基于此构建了包含4.1万提示和24.9万音频的T2A-FeedBack数据集，并建立了针对长文本、多事件场景的T2A-EpicBench基准测试。实验表明，简单的偏好调优就能显著提升现有模型在简单和复杂场景下的表现，改善了提示跟随能力和音质。该研究为高级T2A应用提供了有效的评估和优化框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T03:17:02Z
- **目录日期**: 2025-05-17
