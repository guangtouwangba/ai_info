...
这篇论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，关注模型输出与人类偏好的对齐问题。研究构建了包含397个样本的多样化测试集(覆盖40类任务和44种语言)，并开发了20B标记的合成指令数据集SynCode-Instruct。实验发现传统执行基准与人类偏好存在差距，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)表现差异显著，凸显了人类偏好对齐在代码生成中的重要性。研究为评估代码LLMs提供了更贴近实际需求的新标准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T05:05:58Z
- **目录日期**: 2025-05-17
