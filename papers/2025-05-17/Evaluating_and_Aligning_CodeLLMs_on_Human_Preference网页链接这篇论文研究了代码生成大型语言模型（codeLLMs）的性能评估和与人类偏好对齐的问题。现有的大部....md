...
该论文针对代码生成大模型(codeLLMs)与人类偏好对齐问题，提出CodeArena基准测试和SynCode-Instruct语料库。CodeArena包含397个涵盖40类编程任务的真实样本，涉及44种语言；SynCode-Instruct则包含近200亿标记的合成指令数据。研究发现：1)传统执行测试与人类偏好存在差距；2)开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著。研究强调了代码生成模型除正确性外，还需重视与开发者实际需求的匹配度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T21:05:22Z
- **目录日期**: 2025-05-17
