...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个代理的社会互动（500万次）。该系统通过四个社会问题案例（极化现象、信息传播、基本收入政策、自然灾害影响）验证其有效性，结果与现实数据吻合。研究表明，该系统能有效捕捉人类行为机制，可作为社会科学研究和政策制定的创新工具，补充传统研究方法（如调查、访谈）。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T22:04:36Z
- **目录日期**: 2025-05-17
