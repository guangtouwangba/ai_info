...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可以模拟超过1万个AI代理的社会互动（达500万次）。研究者利用该系统研究了四个关键社会问题：社会极化、信息传播、基本收入政策效果和自然灾害影响。模拟结果与现实世界数据高度吻合，验证了该系统捕捉人类行为机制的能力。该平台为社会科学研究和政策制定提供了新工具，能有效补充传统研究方法（如调查和访谈），帮助深入理解社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T05:05:14Z
- **目录日期**: 2025-05-17
