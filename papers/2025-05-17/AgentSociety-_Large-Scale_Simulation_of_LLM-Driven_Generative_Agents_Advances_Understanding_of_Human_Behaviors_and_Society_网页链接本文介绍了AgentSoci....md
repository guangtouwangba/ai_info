...
该研究介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统，可模拟1万多个代理及其500万次互动。该系统被用于研究四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，验证了该系统捕捉人类行为机制的能力。研究表明AgentSociety可作为计算社会科学的有效工具，为研究者和政策制定者提供新的研究方法，补充传统调查和实验手段。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T01:32:25Z
- **目录日期**: 2025-05-17
