...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理的社会行为及500万次互动。研究者利用该系统研究了四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，验证了该系统在揭示人类行为机制方面的准确性。该系统可作为计算社会科学研究的创新平台，为研究者和政策制定者提供新的分析工具，弥补传统调查和实验方法的不足。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T11:05:36Z
- **目录日期**: 2025-05-17
