...
通义实验室提出"ZeroSearch"方法，让大模型自主模拟搜索引擎进行训练。该方法通过轻量微调生成有用/噪声文档，采用课程式抗噪训练逐步提升难度，并利用强化学习形成闭环。实验显示，3B/7B小模型在单跳/多跳问答任务中表现优异，效果媲美谷歌搜索，且无需真实API调用，显著降低成本。该方案解决了传统方法存在的文档质量差、成本高和扩展难等问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T19:02:44Z
- **目录日期**: 2025-05-17
