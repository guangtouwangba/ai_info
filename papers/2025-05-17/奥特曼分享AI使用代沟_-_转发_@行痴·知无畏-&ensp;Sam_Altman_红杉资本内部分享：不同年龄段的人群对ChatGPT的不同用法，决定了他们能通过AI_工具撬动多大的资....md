...
Sam Altman在红杉资本内部分享中指出，不同年龄段用户对ChatGPT的使用方式存在显著代沟，这直接影响他们通过AI工具获取资源的能力。年轻人更倾向于将AI用于创造性工作和效率提升，而年长用户多停留在基础功能使用层面。这种认知差异导致AI工具对不同人群的价值产出存在巨大差距，值得深入思考如何缩小代沟以释放AI的全民潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T11:04:00Z
- **目录日期**: 2025-05-17
