...
Sam Altman在红杉资本内部分享中指出，不同年龄段用户对ChatGPT的使用方式存在明显代际差异，这直接影响他们通过AI工具获取资源的能力。年轻人倾向于将AI用于创造性工作和效率提升，而年长用户多用于基础信息查询。这种使用差异导致AI工具对个人生产力的提升效果呈现显著分层，值得深入思考如何缩小数字代沟。分享以#AI生活指南#和#AI创造营#为主题，强调AI应用能力将成未来关键竞争力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T07:03:37Z
- **目录日期**: 2025-05-17
