...
Sam Altman在红杉资本内部分享中指出，不同年龄段用户使用ChatGPT的方式存在显著差异，这种"AI使用代沟"直接影响他们利用AI工具撬动资源的能力。年轻人倾向于探索创新应用，而年长用户多用于基础功能，这种认知差异导致AI工具的价值挖掘程度不同。分享引发对AI应用代际差异的思考，强调需要针对不同群体优化AI使用方式以释放更大潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T15:03:47Z
- **目录日期**: 2025-05-17
