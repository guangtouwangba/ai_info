...
Sam Altman在红杉资本内部分享中指出，不同年龄段用户对ChatGPT的使用方式存在显著代际差异，这种差异直接影响他们通过AI工具获取资源的能力。年轻用户更倾向于探索创新应用场景，而年长用户多用于传统任务处理。这种认知差距导致AI工具的价值挖掘程度不同，值得深入思考如何缩小代沟以释放AI的更大潜力。分享内容引发关于#AI生活指南#和#AI创造营#的讨论，强调需要针对不同群体开展AI素养教育。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T16:04:08Z
- **目录日期**: 2025-05-17
