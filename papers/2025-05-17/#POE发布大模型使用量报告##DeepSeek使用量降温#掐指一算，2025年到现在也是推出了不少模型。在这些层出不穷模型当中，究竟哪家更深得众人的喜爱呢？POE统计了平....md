...
POE平台发布的AI模型使用趋势报告显示：GPT-4.1和Gemini 2.5 Pro迅速崛起，分别占据10%和5%的消息份额，而Claude系列下降10%；DeepSeek R1热度减退，份额从7%降至3%。推理模型活跃度提升至10%，Gemini 2.5 Pro占30%份额。图像生成领域竞争激烈，GPT-Image-1和Imagen3份额显著增长。可灵2.0在视频生成中占21%，Veo 2稳定在20%。音频生成方面，ElevenLabs保持80%的领先份额，新兴平台开始竞争。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T12:04:25Z
- **目录日期**: 2025-05-17
