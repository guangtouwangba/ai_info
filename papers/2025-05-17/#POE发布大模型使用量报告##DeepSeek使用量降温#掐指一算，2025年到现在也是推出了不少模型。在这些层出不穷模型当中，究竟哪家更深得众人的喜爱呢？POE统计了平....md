...
POE平台发布的AI模型使用趋势报告显示：GPT-4.1和Gemini 2.5 Pro迅速崛起，分别占据10%和5%的消息份额，而Claude系列下降10%；DeepSeek R1热度减退，从7%降至3%。图像生成领域，GPT-Image-1和Imagen3表现亮眼，分别占17%和30%。视频生成中，Kling-2.0-Master三周内占21%，Veo 2稳定在20%。音频生成仍由ElevenLabs主导，处理80%的TTS请求。推理模型活跃度提升至10%，Gemini 2.5 Pro占30%份额。整体竞争加剧，新兴平台通过差异化展开角逐。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T03:20:06Z
- **目录日期**: 2025-05-17
