...
POE平台发布的AI模型使用趋势报告显示：GPT-4.1和Gemini 2.5 Pro迅速崛起，分别占据10%和5%的文本请求份额，而Claude系列下降10%，DeepSeek R1从7%降至3%。推理模型中，Gemini 2.5 Pro在订阅用户中占30%份额。图像生成领域，GPT-Image-1和Imagen3分别占17%和30%，FLUX保持35%。视频生成方面，Kling-2.0-Master三周内占21%，Veo 2稳定在20%。音频生成中，ElevenLabs处理80%的TTS请求，新兴平台开始竞争。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T02:32:00Z
- **目录日期**: 2025-05-17
