...
POE平台发布的AI模型使用趋势报告显示：GPT-4.1和Gemini 2.5 Pro快速崛起，分别占据10%和5%的消息份额，而Claude下降10%，DeepSeek R1从7%降至3%。推理模型活跃度提升至10%，Gemini 2.5 Pro占其30%份额。图像生成领域，GPT-Image-1和Imagen3分别占17%和30%，FLUX保持35%。视频生成中，Kling-2.0-Master占21%，Veo 2稳定在20%。音频生成由ElevenLabs主导，处理80%的TTS请求，新兴平台开始竞争。整体竞争加剧，新模型快速抢占市场份额。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T11:04:33Z
- **目录日期**: 2025-05-17
