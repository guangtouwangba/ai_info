...
POE平台发布的AI模型使用趋势报告显示：GPT-4.1和Gemini 2.5 Pro快速崛起，分别占据10%和5%的消息份额，而Claude系列下降10%。DeepSeek R1热度减退，份额从7%降至3%。图像生成领域，GPT-Image-1和Imagen3表现强劲，分别占17%和30%份额。视频生成中，Kling-2.0-Master和Veo 2各占21%和20%。音频生成方面，ElevenLabs保持80%的TTS请求主导地位，新兴平台开始竞争。推理模型使用占比从2%升至10%，Gemini 2.5 Pro占30%份额。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T07:04:08Z
- **目录日期**: 2025-05-17
