...
OpenAI推出新一代AI编程工具Codex，基于codex-1模型优化，能生成符合人类风格的代码，支持编写功能、修复Bug、分析代码库等任务。该工具已集成到ChatGPT中，目前面向Pro、Enterprise和Team用户开放。Codex采用强化学习训练，可并行处理多项任务，同时推出精简版codex-mini-latest，API定价为输入每百万token 1.5美元，输出6美元。OpenAI表示这将极大提升个人开发效率，标志着AI编程的新时代。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T18:03:27Z
- **目录日期**: 2025-05-17
