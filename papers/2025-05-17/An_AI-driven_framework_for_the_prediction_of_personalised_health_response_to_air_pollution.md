...
空气污染严重威胁公共健康，加剧呼吸系统和心血管疾病。气候变化引发的极端天气（如野火、热浪）进一步加重污染危害。本研究提出创新方案，通过整合可穿戴设备的生理数据与实时环境暴露信息，构建基于云端的人工智能预测模型（对抗自编码神经网络）。该模型能准确重建健康信号的时间依赖性变化，捕捉污染的非线性健康影响，并利用智能手表数据进行迁移学习以提升泛化能力。研究展示了如何安全合规地利用个人传感数据和AI时序预测技术，实现个性化的污染健康反应监测与预警。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T23:00:47Z
- **目录日期**: 2025-05-17
