...
空气污染严重威胁公共健康，加剧呼吸和心血管疾病。气候变化引发的极端天气（如野火和热浪）进一步加重污染危害。本研究提出一种创新方法，通过整合可穿戴设备的生理数据和实时环境暴露信息，利用AI时间序列预测技术（对抗自编码神经网络）来监测和预测个体健康反应。该云框架模型能准确重建健康信号并捕捉污染的非线性影响，结合智能手表数据的迁移学习增强了模型泛化能力。研究展示了AI如何利用多源数据实现个性化健康预测，为应对污染健康风险提供新方案。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T02:29:21Z
- **目录日期**: 2025-05-17
