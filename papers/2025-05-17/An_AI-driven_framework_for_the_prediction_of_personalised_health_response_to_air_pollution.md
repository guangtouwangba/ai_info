...
空气污染严重威胁公众健康，加剧呼吸系统和心血管疾病。气候变化引发的极端天气（如野火、热浪）进一步加重污染影响。本研究提出创新方案：通过可穿戴设备采集生理数据，结合实时环境暴露信息，利用对抗自编码器神经网络构建AI模型，预测个体对污染的健康反应。模型能准确重建时序健康信号并捕捉非线性响应，通过智能手表数据进行迁移学习增强了泛化能力。该云框架采用安全合规的数据采集方式，展示了AI在个性化健康监测中的应用潜力，为应对污染健康风险提供新工具。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T12:01:12Z
- **目录日期**: 2025-05-17
