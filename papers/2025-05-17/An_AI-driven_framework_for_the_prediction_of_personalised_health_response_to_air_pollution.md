...
空气污染严重威胁公众健康，加剧呼吸系统和心血管疾病。气候变化引发的极端天气（如野火、热浪）会进一步加重污染。本研究提出一种创新方法，通过整合可穿戴设备的生理数据和实时环境暴露信息，利用对抗自编码器神经网络预测个体健康反应。该AI模型能准确重建时间相关的健康信号，捕捉污染的非线性影响，并采用智能手表数据进行迁移学习以提升泛化能力。整个系统基于云端模块化框架，在确保数据安全与伦理的前提下，实现了对个性化健康风险的实时监测和预测。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T18:01:09Z
- **目录日期**: 2025-05-17
