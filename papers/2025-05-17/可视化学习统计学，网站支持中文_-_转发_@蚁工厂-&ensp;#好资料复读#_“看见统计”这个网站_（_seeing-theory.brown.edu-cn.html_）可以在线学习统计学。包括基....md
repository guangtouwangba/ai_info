...
"看见统计"（seeing-theory.brown.edu/cn.html）是一个由布朗大学学生Daniel Kunin开发的中英双语可视化统计学习网站。该平台通过交互式数据图表直观讲解统计学核心内容，涵盖基础/进阶概率论、概率分布、频率学派与贝叶斯学派的统计推断，以及回归分析等模块。其特色是将抽象统计概念转化为动态可视化模型，帮助学习者更易理解。网站最初为本科教学项目，现已成为开放教育资源，适合各层次统计学学习者使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T01:30:17Z
- **目录日期**: 2025-05-17
