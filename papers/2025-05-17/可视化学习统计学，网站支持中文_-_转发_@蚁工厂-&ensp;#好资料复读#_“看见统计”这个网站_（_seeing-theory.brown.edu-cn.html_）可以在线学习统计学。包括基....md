...
"看见统计"（seeing-theory.brown.edu/cn.html）是一个可视化学习统计学的双语网站，由布朗大学本科生Daniel Kunin开发。该平台通过动态数据可视化直观呈现六大核心模块：基础/进阶概率论、概率分布、频率学派与贝叶斯学派的统计推断，以及回归分析。其特色是将抽象的统计概念转化为交互式图形，大幅降低学习门槛。网站支持中英文切换，尤其适合中文用户理解统计学原理。曾入选微博#好资料复读#推荐，配有四张展示不同统计场景可视化效果的示例图片。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T18:03:36Z
- **目录日期**: 2025-05-17
