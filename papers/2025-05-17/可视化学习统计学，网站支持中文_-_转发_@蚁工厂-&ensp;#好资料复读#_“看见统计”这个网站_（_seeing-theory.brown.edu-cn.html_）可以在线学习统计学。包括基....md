...
"看见统计"（seeing-theory.brown.edu/cn.html）是一个可视化学习统计学的双语网站，由布朗大学本科生Daniel Kunin创建。该平台通过动态数据可视化直观呈现统计学核心概念，涵盖基础/进阶概率论、概率分布、频率学派与贝叶斯学派的统计推断，以及回归分析等内容。网站支持中英文切换，旨在通过交互式图表降低学习门槛，帮助用户更轻松地理解抽象统计理论。其特色是将数学公式转化为可视化的动态演示，使统计学习过程更加生动易懂。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T08:03:33Z
- **目录日期**: 2025-05-17
