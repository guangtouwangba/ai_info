...
"看见统计"是由布朗大学本科生Daniel Kunin创建的可视化统计学习网站(seeing-theory.brown.edu/cn.html)，提供中英双语支持。该网站通过交互式数据可视化，系统讲解统计学六大核心模块：基础/进阶概率论、概率分布、频率学派与贝叶斯学派的统计推断、回归分析。其特色是将抽象的统计概念转化为直观的视觉呈现，显著降低了学习门槛。该项目最初是本科期间的创新尝试，现已成为帮助全球学习者理解统计学原理的优质开源教育资源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T10:04:23Z
- **目录日期**: 2025-05-17
