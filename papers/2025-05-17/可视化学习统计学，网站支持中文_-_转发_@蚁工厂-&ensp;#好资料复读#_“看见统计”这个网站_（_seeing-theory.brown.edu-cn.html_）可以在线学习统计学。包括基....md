...
“看见统计”是由布朗大学本科生Daniel Kunin开发的中英双语可视化统计学习网站（seeing-theory.brown.edu/cn.html）。该平台通过动态数据可视化直观呈现六大核心模块：基础/进阶概率论、概率分布、频率学派与贝叶斯学派的统计推断，以及回归分析。其特色在于将抽象统计概念转化为可交互图形，显著降低学习门槛。网站最初作为本科项目开发，现已成为帮助全球学习者理解统计学原理的优质资源，尤其适合偏好视觉化学习方式的中文用户。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T09:03:50Z
- **目录日期**: 2025-05-17
