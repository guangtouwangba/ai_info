...
"看见统计"（seeing-theory.brown.edu/cn.html）是一个由布朗大学学生Daniel Kunin创建的中英双语可视化统计学习网站。该平台通过动态数据可视化直观展示统计学核心概念，涵盖基础/进阶概率论、概率分布、频率学派与贝叶斯学派的统计推断，以及回归分析等内容。其特色是将抽象统计理论转化为交互式图形演示，帮助学习者更易理解复杂概念。网站最初为本科教学项目，现已成为开放学习资源，适合各层次统计学习者使用。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T19:03:24Z
- **目录日期**: 2025-05-17
