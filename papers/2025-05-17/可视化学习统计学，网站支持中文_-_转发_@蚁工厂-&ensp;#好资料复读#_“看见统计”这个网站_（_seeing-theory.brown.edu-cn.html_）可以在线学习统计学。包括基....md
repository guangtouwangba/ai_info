...
"看见统计"（seeing-theory.brown.edu/cn.html）是一个由布朗大学本科生Daniel Kunin开发的中英双语可视化统计学习网站。该平台通过交互式数据可视化，直观呈现基础/进阶概率论、概率分布、频率学派与贝叶斯学派的统计推断、回归分析等核心统计概念。其特色在于将抽象的数理统计知识转化为动态图形演示，有效降低学习门槛。网站同时支持中文界面，为中文使用者提供便捷的统计学入门途径。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T00:02:57Z
- **目录日期**: 2025-05-17
