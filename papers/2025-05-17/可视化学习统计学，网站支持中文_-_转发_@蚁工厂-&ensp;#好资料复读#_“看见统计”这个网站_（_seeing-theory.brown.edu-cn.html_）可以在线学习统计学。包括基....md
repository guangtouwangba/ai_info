...
"看见统计"（seeing-theory.brown.edu/cn.html）是一个由布朗大学本科生Daniel Kunin开发的中英双语可视化统计学习网站。该平台通过交互式数据可视化，直观呈现基础/进阶概率论、概率分布、频率学派与贝叶斯学派的统计推断，以及回归分析等核心统计学概念。其特色在于将抽象的数理统计知识转化为动态图形演示，显著降低了学习门槛。网站最初作为本科课程项目开发，现已成为帮助全球学习者理解统计学原理的优质开源教育资源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T23:03:08Z
- **目录日期**: 2025-05-17
