...
"看见统计"(seeing-theory.brown.edu/cn.html)是由布朗大学本科生Daniel Kunin开发的可视化统计学学习网站，提供中英双语支持。该网站通过交互式数据可视化，直观展示六大核心统计概念：基础/进阶概率论、概率分布、频率学派与贝叶斯学派的统计推断，以及回归分析。其特色是将抽象统计理论转化为动态图形演示，显著降低学习门槛。作为开源项目，该平台已成为统计学初学者的优质入门工具，尤其适合偏好视觉学习方式的学生。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T22:03:14Z
- **目录日期**: 2025-05-17
