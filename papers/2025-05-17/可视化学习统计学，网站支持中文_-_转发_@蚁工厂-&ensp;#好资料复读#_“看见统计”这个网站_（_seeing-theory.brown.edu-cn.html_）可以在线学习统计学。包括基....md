...
"看见统计"是由布朗大学本科生Daniel Kunin开发的中英双语可视化统计学习网站(seeing-theory.brown.edu/cn.html)。该平台通过交互式数据可视化，直观展示基础/进阶概率论、概率分布、频率学派与贝叶斯学派的统计推断、回归分析等核心统计概念，有效降低学习门槛。网站最初为本科课程项目，现已发展为成熟的统计教育工具，其特色是将抽象理论转化为动态图形演示，帮助用户建立直观理解。中文界面的支持使其更便于中文学习者使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T02:31:19Z
- **目录日期**: 2025-05-17
