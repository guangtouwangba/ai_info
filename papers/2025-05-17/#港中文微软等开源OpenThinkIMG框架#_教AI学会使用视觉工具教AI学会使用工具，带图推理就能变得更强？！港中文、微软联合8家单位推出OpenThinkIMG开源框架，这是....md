...
港中文大学与微软等8家机构联合推出开源框架OpenThinkIMG，旨在提升AI的视觉工具使用和推理能力。该框架解决了三大挑战：1) 整合不同视觉工具（如分割、检测、OCR）的接口难题；2) 缺乏训练AI使用工具的示范数据；3) 传统AI模型缺乏灵活应变能力。核心技术创新是自适应工具训练技术V-ToolRL，使AI能自主学习何时及如何使用视觉工具。实验表明，该框架在带图推理任务中表现优于同类开源模型，推动AI向更接近人类"动手操作"的智能推理迈进。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T09:03:08Z
- **目录日期**: 2025-05-17
