...
港中文大学与微软等机构联合推出开源框架OpenThinkIMG，旨在提升AI使用视觉工具进行推理的能力。该框架解决了三大挑战：1) 整合不同视觉工具的技术难题；2) 缺乏训练数据的问题；3) 传统AI模型适应性差的问题。团队还公开了核心技术V-ToolRL，通过自适应训练使AI能智能选择和使用视觉工具（如分割、OCR等），显著提升了带图推理能力。这一突破让AI能像人类一样借助视觉工具增强认知，在复杂场景中表现优于现有开源模型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T05:02:43Z
- **目录日期**: 2025-05-17
