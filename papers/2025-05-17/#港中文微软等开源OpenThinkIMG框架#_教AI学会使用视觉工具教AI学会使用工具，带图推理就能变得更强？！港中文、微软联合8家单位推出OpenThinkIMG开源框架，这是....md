# #港中文微软等开源OpenThinkIMG框架# 教AI学会使用视觉工具教AI学会使用工具，带图推理就能变得更强？！港中文、微软联合8家单位推出OpenThinkIMG开源框架，这是...
...
港中文与微软等机构联合推出开源框架OpenThinkIMG，旨在提升AI使用视觉工具进行推理的能力。该框架解决了三大挑战：1）整合多样化视觉工具的困难；2）缺乏训练AI使用工具的高质量示范数据；3）传统AI模型缺乏灵活应变能力。通过核心的V-ToolRL自适应训练技术，OpenThinkIMG使AI能智能选择并运用视觉工具（如分割、OCR等），显著增强带图推理表现。这一创新让AI模拟人类"动手操作"的认知方式，在视觉任务中展现更强的自主学习和适应能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T12:03:03Z
- **目录日期**: 2025-05-17
