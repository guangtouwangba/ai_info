...
港中文与微软等机构联合推出开源框架OpenThinkIMG，旨在提升AI使用视觉工具进行推理的能力。该框架解决了工具集成难、训练数据缺乏和模型适应性差三大挑战，通过自适应工具使用训练技术V-ToolRL，帮助AI智能选择和使用视觉工具（如分割、检测、OCR等），从而增强其推理和应变能力。OpenThinkIMG为AI提供了类似人类使用辅助工具的灵活性，显著提升了带图推理任务的性能，成为一站式解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T08:02:54Z
- **目录日期**: 2025-05-17
