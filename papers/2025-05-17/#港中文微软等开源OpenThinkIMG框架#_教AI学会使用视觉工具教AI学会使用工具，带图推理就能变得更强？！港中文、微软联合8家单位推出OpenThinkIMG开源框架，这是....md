...
港中文大学与微软等机构联合推出开源框架OpenThinkIMG，旨在提升AI使用视觉工具进行推理的能力。该框架解决了三大挑战：1) 不同视觉工具(如分割、OCR)的集成难题；2) 缺乏训练AI使用工具的高质量示范数据；3) 传统AI模型缺乏灵活应变能力。核心创新是V-ToolRL自适应训练技术，使AI能智能选择和使用工具，显著提升带图推理性能。该框架模拟人类使用辅助工具(如画辅助线)的认知方式，有望推动AI视觉推理能力的发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T21:02:48Z
- **目录日期**: 2025-05-17
