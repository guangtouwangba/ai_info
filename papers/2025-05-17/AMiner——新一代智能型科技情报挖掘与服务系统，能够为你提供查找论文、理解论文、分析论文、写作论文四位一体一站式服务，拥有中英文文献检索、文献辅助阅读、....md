...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献搜索，能快速定位相关论文，并通过AI生成摘要和问答互动功能提升研究效率。平台还具备文献翻译、文档识别和辅助阅读功能，用户可上传PDF或从库中选取论文获取章节概要及问题建议。此外，AMiner提供科研动态订阅服务，根据用户偏好推送最新学术资讯。其数据库涵盖42个学科的3.5亿论文、0.6亿学者等资源，基础功能免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T03:22:31Z
- **目录日期**: 2025-05-17
