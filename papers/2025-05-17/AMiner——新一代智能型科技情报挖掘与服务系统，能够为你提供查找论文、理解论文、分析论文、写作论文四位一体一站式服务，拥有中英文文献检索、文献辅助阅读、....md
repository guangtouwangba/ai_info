...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、辅助阅读、翻译和论文写作支持。其数据库涵盖42个学科，包含3.5亿论文、0.6亿学者和1.5亿专利。核心功能包括：1）智能文献检索与自动摘要生成；2）PDF文档解析与互动问答；3）个性化科研动态订阅服务；4）学者画像与学术会议追踪。平台通过AI技术帮助用户快速定位和理解文献内容，提升科研效率。基础功能免费开放，支持网页端使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T20:05:50Z
- **目录日期**: 2025-05-17
