...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、翻译、辅助阅读和科研情报订阅。它拥有3.5亿论文、0.6亿学者和1.5亿专利数据，支持AI生成摘要、互动问答和个性化订阅最新研究动态。用户可通过网页或微信小程序免费使用，高效提升文献查找、阅读和论文写作效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T22:05:04Z
- **目录日期**: 2025-05-17
