...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析与写作的一站式服务。它支持中英文文献搜索，拥有3.5亿论文、0.6亿学者等海量数据，并提供AI辅助阅读、自动摘要生成、文献翻译及互动问答功能。用户可订阅个性化科研动态，追踪机构、学者或关键词的最新研究。平台还包含学者画像、学术会议等特色功能，基础服务免费开放。网址：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T23:04:51Z
- **目录日期**: 2025-05-17
