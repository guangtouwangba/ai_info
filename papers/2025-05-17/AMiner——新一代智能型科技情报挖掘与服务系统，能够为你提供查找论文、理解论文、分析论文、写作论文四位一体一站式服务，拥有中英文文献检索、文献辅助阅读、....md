...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译及科研订阅等一站式服务。它支持中英文文献搜索，能自动生成摘要和问答互动，帮助用户快速理解论文内容。平台还提供文献翻译、文档识别和个性化科研动态推送功能。AMiner收录了3.5亿论文、0.6亿学者和1.5亿专利等海量资源，用户可通过浏览器免费使用。网址：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T12:05:58Z
- **目录日期**: 2025-05-17
