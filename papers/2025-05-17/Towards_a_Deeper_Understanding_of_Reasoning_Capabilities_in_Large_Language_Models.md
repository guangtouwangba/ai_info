...
该研究评估了大语言模型在动态环境中的自适应能力，发现大模型普遍优于小模型，但策略性提示可缩小差距。过长的提示会损害小模型在基础任务中的表现，而大模型更稳健。高级提示技术主要提升小模型在复杂任务中的表现，但对高性能大模型帮助有限。推理方法虽能提升表现，但也带来不稳定性，甚至导致性能骤降。相比人类，大模型在规划、推理和空间协调等关键领域仍存在局限，表明当前模型无法仅通过自我反思提示克服根本缺陷，需超越静态基准以全面评估推理能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T22:01:10Z
- **目录日期**: 2025-05-17
