...
该研究评估了大型语言模型(LLMs)在动态环境中的自适应能力，测试了自我反思、启发式突变和规划等提示技术。结果显示，大模型普遍优于小模型，但策略性提示可缩小差距；过长提示会损害小模型的基础反应能力，而大模型表现更稳健；复杂任务中高级提示主要帮助小模型，对大模型提升有限。研究发现，高级推理方法虽能提升表现，但也带来不稳定性，可能导致性能骤降。与人类相比，LLMs在规划、推理和空间协调等关键领域仍存在根本性缺陷，表明当前模型无法仅通过自我反思提示克服这些限制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T20:01:24Z
- **目录日期**: 2025-05-17
