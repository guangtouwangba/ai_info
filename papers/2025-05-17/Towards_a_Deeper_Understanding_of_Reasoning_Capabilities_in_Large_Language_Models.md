...
该研究评估了大语言模型在动态环境中的自适应能力，测试了自我反思、启发式突变和规划等提示技术的作用。实验发现，大模型通常优于小模型，但策略性提示可缩小差距；过长提示会损害小模型在基础任务中的表现，而大模型更稳健；复杂任务中高级提示主要帮助小模型，但对高性能大模型提升有限。尽管推理方法能提升表现，但也带来不稳定性。相比人类，大模型在规划、推理和空间协调等关键领域仍存在根本缺陷，表明仅靠自我反思提示无法完全克服。研究强调需超越静态基准，以捕捉推理的复杂性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T06:01:21Z
- **目录日期**: 2025-05-17
