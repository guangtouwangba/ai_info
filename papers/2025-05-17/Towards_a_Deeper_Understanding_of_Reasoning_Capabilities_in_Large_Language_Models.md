...
该研究评估了大语言模型在动态环境中的自适应能力，发现更大模型通常表现更好，但策略性提示可缩小性能差距。较长提示会损害小模型的基础反应任务表现，而大模型更稳定。高级提示技术对小模型在复杂任务中帮助更大，但对高性能大模型提升有限。尽管推理方法可能显著提升表现，但也带来不稳定性。相比人类表现，大语言模型在规划、推理和空间协调等关键领域仍存在根本性缺陷，表明当前模型无法仅通过自我反思提示完全克服。研究强调需超越静态基准以捕捉推理的复杂性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T21:01:11Z
- **目录日期**: 2025-05-17
