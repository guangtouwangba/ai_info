...
该研究评估了大语言模型在动态环境中的自适应能力，发现更大模型通常表现更好，但策略性提示可缩小性能差距。较长的提示会损害小模型在基础任务上的表现，而大模型更稳健。高级提示技术对小模型在复杂任务中帮助更大，但对高性能大模型提升有限。尽管推理方法可能显著提升表现，但也带来不稳定性和性能下降。研究表明，当前大语言模型在规划、推理和空间协调等关键领域仍存在根本性局限，仅靠自我反思提示难以完全克服，需超越静态基准以全面评估推理能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T17:01:17Z
- **目录日期**: 2025-05-17
