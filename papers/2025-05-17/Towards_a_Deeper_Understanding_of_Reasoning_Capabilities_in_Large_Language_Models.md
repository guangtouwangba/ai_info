...
该研究评估了大型语言模型(LLM)在动态环境中的自适应能力，发现大模型通常优于小模型，但策略性提示可缩小差距。长提示会降低小模型在基础任务中的表现，而大模型更稳健。高级提示技术对小模型在复杂任务中帮助更大，但对高性能大模型提升有限。推理方法虽能提升表现，但也带来不稳定性和性能下降。与人类相比，LLM在规划、推理和空间协调等关键领域仍存在根本性缺陷，表明当前LLM的真实推理能力有限，需超越静态基准测试以全面评估其推理复杂性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T19:01:19Z
- **目录日期**: 2025-05-17
