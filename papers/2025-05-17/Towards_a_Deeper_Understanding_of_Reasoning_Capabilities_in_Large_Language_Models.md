...
这项研究评估了大型语言模型在动态环境中的自适应能力，发现大模型普遍优于小模型，但策略性提示能缩小差距。过长的提示会损害小模型在基础任务上的表现，而大模型表现更稳定。高级提示技术对小模型在复杂任务中帮助更大，但对高性能大模型提升有限。尽管推理方法可能显著提升表现，但也可能引发不稳定性和性能下降。研究发现当前大模型在规划、推理和空间协调等关键领域仍存在根本性局限，提示技术无法完全克服，表明需要超越静态基准来评估推理能力的复杂性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T01:28:46Z
- **目录日期**: 2025-05-17
