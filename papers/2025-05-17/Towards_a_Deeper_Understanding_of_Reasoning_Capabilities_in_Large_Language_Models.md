...
这项研究评估了大语言模型在动态环境中的自适应能力，发现更大的模型通常表现更好，但策略性提示可以缩小性能差距。较长的提示对小模型的基本反应任务有负面影响，而大模型表现更稳健。高级提示技术主要帮助小模型处理复杂任务，但对高性能大模型提升有限。高级推理方法虽能提升表现，但也带来不稳定性。研究发现，当前大语言模型在规划、推理和空间协调等关键领域仍存在根本性局限，仅靠自我反思提示无法完全克服。动态基准测试凸显了通用推理能力的不足，需超越静态基准以全面评估推理复杂性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T00:01:39Z
- **目录日期**: 2025-05-17
