...
该研究评估了大语言模型在动态环境中的自适应能力，发现大模型普遍优于小模型，但策略性提示能缩小差距。长提示对小模型的基础反应任务有负面影响，而大模型表现更稳定。高级提示技术对小模型的复杂任务更有效，但对高性能大模型提升有限。推理方法虽能提升表现，但也会导致不稳定和性能骤降。研究发现，当前大语言模型在规划、推理和空间协调等关键领域仍有根本性缺陷，仅靠自我反思提示难以完全克服。动态基准测试凸显了通用推理能力的不足，需超越静态基准以全面评估推理复杂性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T15:01:17Z
- **目录日期**: 2025-05-17
