...
该研究探讨了超临界Sobolev映射、拟共形及拟对称同胚下中间维度的畸变问题。作者将Gehring-Väisälä定理（关于拟共形映射维度畸变的依赖关系）和Kovalev定理（关于0到1之间不存在严格共形维度的度量空间）推广到中间维度场景。应用方面包括对欧几里得集拟共形分类的新贡献，以及共形盒计数维度消失的新充分条件。研究结论具体体现在Bedford-McMullen地毯、Mandelbrot渗流样本和含多项式收敛序列因子的乘积集等案例中。成果为中间维度的几何分析提供了新的理论工具。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T22:01:30Z
- **目录日期**: 2025-05-17
