...
该研究探讨了超临界Sobolev映射以及拟共形/拟对称同胚下中间维度的畸变问题。主要贡献包括：将Gehring-Väisälä定理（关于拟共形映射维度畸变的依赖关系）和Kovalev定理（关于0到1之间不存在严格共形维度的度量空间）扩展到中间维度场景。研究结果应用于欧几里得集合的拟共形分类，并提出了共形盒计数维度消失的新充分条件。具体案例展示了结论对Bedford-McMullen地毯、Mandelbrot渗流样本以及含多项式收敛序列因子的乘积集的影响。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-17T13:06:59Z
- **目录日期**: 2025-05-17
