...
该研究提出"睡眠时间计算"方法，让大语言模型在用户查询前离线预计算可能的问题和有用信息，从而显著降低实时计算需求。实验表明，该方法在Stateful GSM-Symbolic和Stateful AIME任务中可将实时计算量减少约5倍，同时提升准确率13-18%。通过Multi-Query GSM-Symbolic任务分摊预计算成本，单次查询平均成本降低2.5倍。研究发现查询可预测性与方法效果正相关，并在实际软件工程任务中验证了该方法的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T17:01:01Z
- **目录日期**: 2025-04-19
