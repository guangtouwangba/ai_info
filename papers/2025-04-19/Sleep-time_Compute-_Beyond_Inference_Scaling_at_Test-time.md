...
该研究提出"睡眠时间计算"方法，通过让大语言模型在查询前预先处理上下文并预测可能的用户问题，显著降低推理时的计算需求。实验显示，该方法在Stateful GSM-Symbolic和Stateful AIME任务中可将推理计算量减少约5倍，同时提升准确率13-18%。通过Multi-Query GSM-Symbolic任务分摊计算成本，单次查询平均成本降低2.5倍。研究发现查询可预测性与方法效果正相关，并在软件工程代理任务中验证了实用性。该方法有效平衡了计算效率与模型性能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T21:00:52Z
- **目录日期**: 2025-04-19
