...
本文提出"睡眠时间计算"方法，通过让大语言模型在查询前预先计算可能的问题和有用信息，显著降低推理时的计算需求和延迟。实验表明，该方法在Stateful GSM-Symbolic和Stateful AIME任务中可将推理计算量减少约5倍，同时提升准确率13%-18%。通过Multi-Query GSM-Symbolic任务分摊计算成本，单查询平均成本降低2.5倍。研究发现查询可预测性与方法效果正相关。最后通过代理软件工程任务的案例研究验证了该方法的实用性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T05:01:07Z
- **目录日期**: 2025-04-19
