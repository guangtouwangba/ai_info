...
本文提出"睡眠时间计算"方法，通过让大语言模型在查询前预先处理上下文并预测可能的用户问题，显著降低测试时的计算需求。实验显示，该方法在Stateful GSM-Symbolic和Stateful AIME任务上能减少5倍测试计算量，同时提升准确率13%和18%。通过Multi-Query GSM-Symbolic任务分摊计算成本，单查询成本降低2.5倍。研究发现查询可预测性与方法效果正相关，并通过实际软件开发任务验证了其有效性。该方法有效平衡了计算成本与模型性能，为优化大模型推理提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T23:01:01Z
- **目录日期**: 2025-04-19
