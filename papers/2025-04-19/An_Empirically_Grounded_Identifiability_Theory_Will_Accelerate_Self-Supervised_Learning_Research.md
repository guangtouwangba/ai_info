...
自监督学习（SSL）是当前AI系统的核心技术。研究基于柏拉图表示假说（PRH），认为不同方法最终会收敛到相同的理想表示，但缺乏理论解释。通过可识别性理论（IT）分析，PRH可能在SSL中出现，但现有IT无法完全解释SSL的实际成功。为此，研究者提出扩展的**奇异可识别性理论（SITh）**，以涵盖整个SSL流程，从而更深入理解数据假设，推动学习更具可解释性和泛化性的表示。未来研究方向包括：1）SSL训练动态与收敛性；2）有限样本、批大小和数据多样性的影响；3）架构、增强、初始化和优化器的归纳偏置作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T22:01:40Z
- **目录日期**: 2025-04-19
