...
当前自监督学习（SSL）研究快速发展，但缺乏理论解释。基于可识别性理论（IT）分析表明，柏拉图表示假说（PRH）可能在SSL中成立，但现有IT无法解释SSL的实际成功。为此，研究者提出"奇异可识别性理论"（SITh）这一新框架，旨在全面解释SSL流程，促进学习更具可解释性和泛化能力的表征。未来研究应关注三个方向：1）SSL训练动态与收敛特性；2）有限样本、批量和数据多样性的影响；3）架构、数据增强、初始化和优化器中归纳偏置的作用。该理论框架有望弥合理论与实践的鸿沟。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T19:01:34Z
- **目录日期**: 2025-04-19
