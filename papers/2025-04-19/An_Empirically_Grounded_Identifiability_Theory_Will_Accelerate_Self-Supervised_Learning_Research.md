...
当前自监督学习（SSL）研究快速发展，但缺乏理论解释。本文结合可识别性理论（IT）证明，尽管方法各异，SSL表征可能趋近于柏拉图式理想（PRH假说）。然而现有IT无法完全解释SSL的实际成功。为此，作者提出"奇异可识别性理论"（SITh）新框架，旨在统一解释整个SSL流程。该理论将帮助理解SSL隐含的数据假设，推动学习更具解释性和泛化性的表征。未来研究需关注三个方向：1）SSL训练动态与收敛性；2）有限样本、批大小和数据多样性的影响；3）架构、数据增强等归纳偏置的作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T17:01:46Z
- **目录日期**: 2025-04-19
