...
自监督学习（SSL）是当前AI系统的核心技术。基于柏拉图表示假说（PRH），不同SSL方法最终会收敛到相同的理想表示，但缺乏理论解释。研究发现可识别性理论（IT）能解释PRH现象，但无法完全说明SSL的实际成功。为此，研究者提出扩展的奇异可识别性理论（SITh），以更全面分析SSL流程，揭示其隐含的数据假设，推动学习更具可解释性和泛化性的表示。未来研究重点包括：1）SSL训练动态与收敛性；2）有限样本、批量大小和数据多样性的影响；3）架构、数据增强、初始化和优化器的归纳偏置作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T06:01:50Z
- **目录日期**: 2025-04-19
