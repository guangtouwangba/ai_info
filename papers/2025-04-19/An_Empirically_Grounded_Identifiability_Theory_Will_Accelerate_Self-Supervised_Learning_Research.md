...
当前自监督学习(SSL)研究快速发展，但缺乏理论解释。研究表明，根据可识别性理论(IT)，柏拉图表示假说(PRH)可能在SSL中成立，但现有理论无法完全解释SSL的成功实践。为此，研究者提出扩展为"奇异可识别性理论"(SITh)，以建立涵盖整个SSL流程的理论框架，帮助理解数据假设并提升表征的可解释性和泛化性。未来研究应关注三个方向：1)SSL训练动态与收敛特性；2)有限样本、批量大小和数据多样性的影响；3)架构、数据增强、初始化和优化器中的归纳偏置作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T15:01:46Z
- **目录日期**: 2025-04-19
