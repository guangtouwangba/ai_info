...
当前自监督学习（SSL）研究快速发展，但缺乏理论解释。本文结合可辨识性理论（IT）表明，尽管方法各异，SSL表征可能收敛于柏拉图式理想状态（PRH假说）。然而现有IT无法完全解释SSL的实际成功，因此提出扩展为"奇异可辨识性理论"（SITh），建立覆盖完整SSL流程的理论框架。SITh将帮助理解SSL隐含的数据假设，推动学习更具可解释性和泛化能力的表征。未来研究需关注三个方向：1）SSL训练动态与收敛性；2）有限样本、批大小和数据多样性的影响；3）架构、数据增强、初始化和优化器中归纳偏置的作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T13:05:40Z
- **目录日期**: 2025-04-19
