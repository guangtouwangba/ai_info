...
当前自监督学习(SSL)研究快速发展，但柏拉图表示假说(PRH)缺乏理论解释。通过可辨识性理论(IT)分析发现，PRH可能存在于SSL中，但现有理论无法解释SSL的实际成功。为此，研究者提出"奇异可辨识性理论"(SITh)作为更广泛的理论框架，以深入理解SSL隐含的数据假设，推动学习更具解释性和泛化性的表示。未来研究需关注三个方向：1)SSL训练动态与收敛特性；2)有限样本、批次大小和数据多样性的影响；3)架构、数据增强、初始化方案和优化器的归纳偏置作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T11:01:53Z
- **目录日期**: 2025-04-19
