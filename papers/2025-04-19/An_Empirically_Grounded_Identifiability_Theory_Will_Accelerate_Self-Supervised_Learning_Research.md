...
当前自监督学习（SSL）研究快速发展，但缺乏理论解释。研究发现，基于可辨识性理论（IT），柏拉图表示假说（PRH）可能在SSL中成立，但现有IT无法完全解释SSL的实际成功。为此，研究者提出扩展IT为"奇异可辨识性理论"（SITh），以更全面分析SSL流程。SITh有助于理解SSL中的隐含数据假设，推动学习更具解释性和泛化性的表示。未来研究应关注：1）SSL训练动态与收敛性；2）有限样本、批量和数据多样性的影响；3）架构、数据增强、初始化和优化器中归纳偏置的作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T09:01:38Z
- **目录日期**: 2025-04-19
