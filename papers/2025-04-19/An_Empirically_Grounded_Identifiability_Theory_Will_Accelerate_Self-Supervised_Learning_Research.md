...
当前自监督学习（SSL）研究快速发展，但其理论基础尚不完善。研究基于可识别性理论（IT）发现，尽管不同SSL方法可能收敛到相同的"柏拉图式理想表示"（PRH假设），但现有理论无法解释SSL的实际成功。为此，作者提出"奇异可识别性理论"（SITh），旨在建立覆盖整个SSL流程的理论框架，以更好地理解数据假设并推动学习更具可解释性和泛化能力的表示。未来研究应重点关注三个方向：SSL训练动态与收敛特性、有限样本/批量/数据多样性的影响，以及架构/数据增强/初始化/优化器中的归纳偏置作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T14:01:52Z
- **目录日期**: 2025-04-19
