...
这篇摘要探讨了自监督学习(SSL)中的柏拉图表示假说(PRH)，即不同方法最终会收敛到相同的理想表示。作者通过可辨识性理论(IT)证明PRH可能在SSL中出现，但现有理论无法完全解释SSL的成功实践。为此，作者提出扩展为"奇异可辨识性理论"(SITh)的新框架，以更全面理解SSL流程。研究指出三个关键方向：1)SSL训练动态与收敛特性；2)有限样本、批次大小和数据多样性的影响；3)架构、数据增强、初始化方案和优化器中归纳偏置的作用，旨在推动学习更具解释性和泛化能力的表示。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T20:01:46Z
- **目录日期**: 2025-04-19
