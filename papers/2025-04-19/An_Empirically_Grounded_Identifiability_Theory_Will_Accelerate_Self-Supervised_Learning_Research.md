...
当前自监督学习（SSL）研究快速发展，但缺乏理论解释。基于可识别性理论（IT）分析表明，柏拉图表示假说（PRH）可能在SSL中成立，但现有理论无法完全解释其实际效果。为此，研究者提出扩展的奇异可识别性理论（SITh），以更全面理解SSL流程中的数据假设，推动学习更具解释性和泛化性的表示。未来研究应关注三个方向：1）SSL训练动态与收敛性；2）有限样本、批大小和数据多样性的影响；3）架构、数据增强、初始化和优化器的归纳偏置作用。该框架有望弥合理论与实践的差距。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T05:01:49Z
- **目录日期**: 2025-04-19
