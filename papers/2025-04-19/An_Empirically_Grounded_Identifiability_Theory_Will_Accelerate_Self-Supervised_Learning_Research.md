...
自监督学习（SSL）是当前AI系统的核心技术，但其理论解释仍不完善。研究结合可辨识性理论（IT）表明，尽管方法多样，SSL表征可能收敛于柏拉图式理想（PRH）。然而，现有IT无法完全解释SSL的实际成功。为此，研究者提出扩展为"奇异可辨识性理论"（SITh），以更全面涵盖SSL流程，促进对数据隐含假设的理解，推动学习更具可解释性和泛化性的表征。未来研究应聚焦三个方向：1）SSL训练动态与收敛性；2）有限样本、批次大小和数据多样性的影响；3）架构、数据增强、初始化和优化器的归纳偏置作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T01:28:49Z
- **目录日期**: 2025-04-19
