...
这篇论文探讨了如何利用多模态大语言模型(MLLMs)进行美学判断，以弥补当前生成艺术在深层艺术感染力方面的不足。研究发现MLLMs在美学推理时容易出现主观臆断和缺乏依据的艺术解读等"幻觉"问题。作者提出的ArtCoT基线方法通过基于证据的客观推理过程，显著改善了这一问题，使MLLMs产生的美学分析更全面深入且更符合人类判断标准。这一成果可应用于AI艺术辅导和生成艺术的奖励模型，为开发能真正理解、欣赏并创作符合人类审美标准的AI系统奠定了基础。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T21:02:25Z
- **目录日期**: 2025-04-19
