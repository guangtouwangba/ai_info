...
这篇论文探讨了如何利用多模态大语言模型(MLLMs)进行艺术审美判断。研究发现，当前MLLMs在美学推理中存在幻觉倾向，容易产生主观意见和未经证实的艺术解读。作者提出基于证据的客观推理方法ArtCoT，能显著改善MLLMs的美学推理能力，使其产出更全面深入的分析，并与人类审美标准更吻合。这一突破可应用于AI艺术辅导和生成艺术的奖励模型，为开发能真正理解、欣赏并创作符合人类审美标准的AI系统奠定了基础。研究揭示了克服当前计算模型在复杂美学判断方面局限性的有效途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T10:02:38Z
- **目录日期**: 2025-04-19
