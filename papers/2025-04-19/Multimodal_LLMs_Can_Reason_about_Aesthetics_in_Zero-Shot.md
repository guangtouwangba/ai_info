...
该研究探讨了如何利用多模态大语言模型(MLLMs)进行更深入的美学判断。研究发现当前MLLMs在美学推理时容易出现主观臆断和缺乏依据的艺术解读等问题。通过引入基于证据的客观推理方法(ArtCoT)，可显著提升模型的美学判断能力，使其产出更全面深入的美学分析，并与人类审美标准更吻合。这一成果可应用于AI艺术教学和生成艺术的奖励模型，为开发能真正理解、欣赏和创作符合人类审美标准的AI系统奠定了基础。研究揭示了计算美学中客观推理的重要性，突破了当前模型仅关注视觉吸引力的局限。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T12:02:39Z
- **目录日期**: 2025-04-19
