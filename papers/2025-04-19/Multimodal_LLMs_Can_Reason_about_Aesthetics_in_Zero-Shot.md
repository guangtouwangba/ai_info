...
这篇论文探讨了如何利用多模态大语言模型(MLLMs)进行更深入的美学判断。研究发现，当前MLLMs在美学推理时容易产生主观臆断和缺乏依据的艺术解读。作者提出基于证据的客观推理方法ArtCoT，能显著改善这一问题，使MLLMs产生更全面、深入且符合人类审美标准的美学分析。这一成果可应用于AI艺术教学和生成艺术的评价模型，为开发真正理解、欣赏和创作符合人类审美标准的AI系统奠定了基础。研究揭示了克服现有模型在美学判断方面局限性的有效途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T13:06:36Z
- **目录日期**: 2025-04-19
