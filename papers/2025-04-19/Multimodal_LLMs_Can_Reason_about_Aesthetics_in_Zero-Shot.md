...
当前生成艺术快速发展，但AI模型常忽视艺术深层审美所需的复杂推理能力。研究发现，多模态大语言模型（MLLMs）在进行美学判断时易产生主观臆断的"幻觉"。通过提出基于证据的客观推理框架ArtCoT，成功引导MLLMs产出更符合人类审美的多维度深度分析。该突破可应用于AI艺术教学和生成艺术奖励模型，为开发真正理解人类美学标准、能创作引发深层共鸣作品的AI系统奠定基础。研究揭示了克服AI艺术评价主观性的关键路径，推动生成艺术向更具人文价值的方向发展。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T16:02:39Z
- **目录日期**: 2025-04-19
