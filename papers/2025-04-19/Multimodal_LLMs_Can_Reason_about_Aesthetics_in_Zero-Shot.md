...
当前生成艺术快速发展，但真正能引发深层共鸣的艺术创作需要超越视觉吸引力的复杂审美推理。研究发现，多模态大语言模型（MLLMs）在审美判断时容易产生主观臆断和缺乏依据的艺术解读。通过引入基于证据的客观推理框架ArtCoT，可显著提升模型的审美分析能力，使其输出更符合人类判断的多维度深度解析。该成果可应用于AI艺术教学和生成艺术奖励模型，为开发能真正理解、欣赏并创作符合人类审美标准的AI系统奠定基础。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T20:02:38Z
- **目录日期**: 2025-04-19
