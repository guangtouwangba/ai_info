...
当前生成艺术快速发展，但真正能引发深层共鸣的艺术创作需要超越视觉吸引力的复杂审美推理。研究发现，多模态大语言模型（MLLMs）在审美判断时容易出现主观臆断和缺乏依据的"幻觉"。通过采用基于证据的客观推理框架ArtCoT，可显著提升MLLMs的审美分析能力，使其产出更符合人类标准的多维度深度评价。这一突破为AI艺术教育、生成艺术奖励模型等应用奠定了基础，推动AI系统向真正理解、欣赏并创作符合人类审美标准的艺术作品迈进。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T17:02:37Z
- **目录日期**: 2025-04-19
