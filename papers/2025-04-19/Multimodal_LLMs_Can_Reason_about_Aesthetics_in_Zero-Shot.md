...
该研究探讨了如何利用多模态大语言模型(MLLMs)进行更深入的美学判断。当前生成艺术虽能创造视觉愉悦的图像，但缺乏真正打动观众的艺术感染力。研究发现MLLMs在美学推理时容易出现主观臆断和未经证实的艺术解读等"幻觉"问题。通过引入基于证据的客观推理框架ArtCoT，显著提升了MLLMs的美学分析能力，使其产出更全面深入且符合人类审美标准的评价。这一突破可应用于AI艺术辅导和生成艺术奖励模型，为开发真正理解并创造符合人类审美标准的AI系统奠定了基础。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T01:29:31Z
- **目录日期**: 2025-04-19
