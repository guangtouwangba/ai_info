...
这篇论文探讨了如何利用多模态大语言模型（MLLMs）进行艺术审美判断。研究发现，当前MLLMs在审美推理时容易产生主观臆断和未经证实的艺术解读。通过提出基于证据的客观推理方法ArtCoT，研究证明可以显著改善这一问题，使MLLMs的审美判断更接近人类标准。这一发现可应用于AI艺术教学和生成艺术的奖励模型，为开发能真正理解、欣赏并创作符合人类审美标准的AI系统奠定了基础。研究强调了超越单纯视觉吸引力的多维度审美推理的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T09:02:33Z
- **目录日期**: 2025-04-19
