...
Fellou是一款革命性的智能浏览器，将传统浏览、智能体(Agent)和工作流自动化三合一。它能理解用户意图，自动规划并执行任务，在准确性、表达深度和执行效率(3.7分钟完成49个任务)上超越主流AI工具。其核心技术包括：1)自研Eko框架，延迟降低65%；2)混合经验学习系统，通过记录失败经验持续优化；3)支持任务前后自定义干预。目前开放Mac内测，代表未来生产力工具向"能听会做"的智能浏览器方向发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T22:04:03Z
- **目录日期**: 2025-04-19
