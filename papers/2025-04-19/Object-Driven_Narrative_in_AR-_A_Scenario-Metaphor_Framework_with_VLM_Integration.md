...
当前AR叙事系统大多依赖简单的物体标签和空间坐标，导致叙事逻辑僵化。为解决这一问题，研究者提出整合视觉语言模型(VLM)的AR框架，通过三层创新：1)将物体语义分解为物理、功能和隐喻层面；2)用双向JSON层连接VLM输出与AR锚点；3)建立STAM评估体系。实验显示，70%用户反馈该系统能基于环境符号学重构叙事认知，使普通物品展现深层隐喻（如床头婚戒暗示婚姻危机）。该框架突破传统"物体即标签"的局限，将静态空间转化为具有叙事能动性的故事场景，实现了环境自生型叙事。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T03:11:19Z
- **目录日期**: 2025-04-19
