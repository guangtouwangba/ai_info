...
当前自适应AR叙事系统主要依赖简单物体标签和空间坐标，限制了叙事的深度和灵活性。为解决这一问题，研究者探索将视觉语言模型(VLMs)融入AR流程，但面临叙事深度不足、空间语义利用不充分等问题。提出的新框架包含三项创新：1)分层物体语义理解(物理/功能/隐喻层)；2)双向JSON叙事接口；3)STAM评估体系。实验显示，70%用户反馈该系统能基于环境符号生成故事，改变他们对现实物体的认知。该框架通过结合VLM的创造力和AR的空间精度，实现了从被动空间到主动叙事场景的转变。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T16:01:33Z
- **目录日期**: 2025-04-19
