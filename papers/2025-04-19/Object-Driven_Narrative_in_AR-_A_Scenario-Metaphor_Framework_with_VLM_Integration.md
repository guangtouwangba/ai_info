...
当前自适应AR叙事系统大多依赖简单物体标签和空间坐标，导致叙事逻辑僵化，忽略了物体关系的语境意义（如床头婚戒可能暗示婚姻冲突）。研究提出融合视觉语言模型(VLM)的AR叙事框架，通过三大创新：1) 将物体语义分解为物理/功能/隐喻三层；2) 用双向JSON层桥接VLM隐喻与AR锚点；3) 建立STAM评估体系。实验显示，70%用户因环境象征性叙事改变了现实物体认知。该框架将VLM的生成创造力与AR空间精度结合，实现了从"在环境中放置故事"到"从环境生成故事"的范式转变，使被动空间转化为主动叙事场域。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T14:01:41Z
- **目录日期**: 2025-04-19
