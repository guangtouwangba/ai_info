...
当前AR叙事系统过度简化环境语义，仅用物体标签和坐标限制了故事逻辑。为解决这一问题，研究者提出结合视觉语言模型(VLM)的AR叙事框架，包含三大创新：1) 将物体语义分解为物理、功能和隐喻三层；2) 通过双向JSON层连接VLM生成内容与AR锚点；3) 建立STAM评估体系。实验表明，该系统能基于环境本身生成故事，70%用户反馈叙事改变了他们对实物的认知。该框架融合VLM的创造力和AR的空间精确性，实现了从"被动空间"到"主动叙事景观"的转变，开创了物体驱动的新型叙事范式。(99字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T20:01:36Z
- **目录日期**: 2025-04-19
