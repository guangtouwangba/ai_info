...
当前自适应AR叙事系统多依赖简单的物体标签和空间坐标，导致叙事逻辑僵化，忽略了物体关系的语境意义（如床头婚戒可能暗示婚姻矛盾）。研究提出整合视觉语言模型(VLM)的解决方案，通过三重创新：1) 将物体语义分解为物理/功能/隐喻三层；2) 用双向JSON层连接VLM隐喻与AR锚点；3) 建立STAM评估框架。实验显示，70%用户因环境象征性叙事改变了现实物体认知。该框架融合VLM的生成创造力与AR空间精度，实现了从"在环境中放置故事"到"由环境生成故事"的范式转变，使被动空间转化为主动叙事场域。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T09:01:28Z
- **目录日期**: 2025-04-19
