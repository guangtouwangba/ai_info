...
现有AR叙事系统常依赖简单物体标签和空间坐标，导致叙事僵化且缺乏上下文关联。为解决这一问题，研究者提出融合视觉语言模型(VLM)的三项创新：1) 将物体语义分解为物理、功能和隐喻三层；2) 通过双向JSON层连接VLM隐喻与AR锚点；3) 建立STAM评估框架。实验表明，该系统能基于环境生成故事（而非简单叠加），70%用户反馈能重新理解现实物体的象征意义。该框架结合VLM的创造性与AR的空间精确性，实现了"物体驱动"的叙事范式，使被动空间转化为主动叙事载体。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T15:01:34Z
- **目录日期**: 2025-04-19
