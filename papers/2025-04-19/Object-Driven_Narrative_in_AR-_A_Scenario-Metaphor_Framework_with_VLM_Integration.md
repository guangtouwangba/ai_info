...
当前自适应AR叙事系统通常仅用简单物体标签和空间坐标定义环境语义，导致叙事僵化且缺乏上下文关联。为解决这一问题，研究者提出整合视觉语言模型(VLM)的AR叙事框架，包含三项创新：1) 将物体语义分解为物理、功能和隐喻三层；2) 通过双向JSON层桥接VLM隐喻与AR锚点；3) 建立STAM评估体系。实验表明，该系统能从环境中生成故事而非简单叠加，70%用户反馈环境物体因隐喻叙事获得新意义。该框架融合VLM的创造性与AR的空间精确性，实现了"物体驱动"的主动叙事范式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T17:01:35Z
- **目录日期**: 2025-04-19
