...
当前自适应AR叙事系统多基于简单物体标签和空间坐标，导致叙事逻辑僵化。针对这一问题，研究者提出融合视觉语言模型(VLM)的AR叙事框架，通过三层创新：1) 将物体语义分解为物理、功能和隐喻层面；2) 设计双向JSON接口连接VLM隐喻与AR锚点；3) 建立STAM评估体系。实验表明，该系统能从环境中生成故事而不仅是叠加故事，70%用户反馈环境物体被赋予了新含义。该框架结合VLM的创造性与AR的空间精确性，实现了"物体驱动"的叙事范式，使被动空间转化为主动叙事载体。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T05:01:38Z
- **目录日期**: 2025-04-19
