...
当前自适应AR叙事系统多采用简单物体标签和空间坐标来定义环境语义，导致叙事逻辑僵化。为解决这一问题，研究者探索将视觉语言模型(VLM)整合到AR流程中，但面临叙事深度不足、空间语义利用不充分等问题。论文提出场景驱动的AR叙事框架，包含三大创新：1)状态感知的物体语义分层(物理/功能/隐喻)；2)双向JSON叙事接口；3)STAM评估体系。实验显示，70%用户反馈该系统能基于环境符号学改变其对现实物体的认知。该框架融合VLM的创造性与AR的空间精确性，实现了从"在环境中放置故事"到"让环境生成故事"的范式转变。(100字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T18:01:27Z
- **目录日期**: 2025-04-19
