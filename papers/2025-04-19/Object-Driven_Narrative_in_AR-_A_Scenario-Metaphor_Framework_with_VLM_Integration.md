...
当前AR叙事系统常将环境语义简化为物体标签和空间坐标，导致叙事僵化。研究提出整合视觉语言模型(VLM)的新框架，通过三层创新：1) 将物体语义分解为物理、功能和隐喻层面；2) 用双向JSON层连接VLM输出与AR锚点；3) 建立STAM评估体系。实验显示，70%用户反馈该系统能基于环境符号生成故事（而非简单叠加），改变了对现实物体的认知。该框架融合VLM的创造性与AR的空间精确性，实现了从"被动空间"到"主动叙事景观"的转变，开创了物体驱动的叙事新范式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T00:01:40Z
- **目录日期**: 2025-04-19
