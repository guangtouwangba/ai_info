...
当前自适应AR叙事系统通常仅用简单物体标签和空间坐标定义环境语义，导致叙事僵化。针对这一问题，研究者提出整合视觉语言模型(VLM)的解决方案，但面临叙事深度不足、空间语义利用不充分等问题。该研究提出场景驱动的AR叙事框架，通过三个创新：1) 分层的物体语义理解(物理/功能/隐喻)；2) 双向JSON接口连接VLM与AR锚点；3) STAM评估体系。实验显示，70%用户反馈该系统能基于环境符号生成故事，改变对现实物体的认知。该框架将VLM的创造力与AR空间精度结合，开创了主动环境叙事新范式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T12:01:33Z
- **目录日期**: 2025-04-19
