...
现有AR叙事系统通常仅用简单物体标签和空间坐标定义环境语义，导致叙事僵化且缺乏上下文关联。针对这一问题，研究者提出融合视觉语言模型(VLM)的创新框架，通过三层创新：1)将物体语义分解为物理、功能和隐喻层面；2)设计双向JSON接口连接VLM输出与AR锚点；3)建立STAM评估体系。实验表明，该系统能基于环境本身生成故事（而非简单叠加），70%用户反馈叙事改变了其对现实物体的认知。该框架开创了"物体驱动叙事"新范式，将被动空间转化为主动叙事场域，实现了生成创意与空间精度的有机融合。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T10:01:30Z
- **目录日期**: 2025-04-19
