...
当前自适应AR叙事系统多依赖简单物体标签和空间坐标，导致叙事逻辑僵化。为解决这一问题，研究者提出融合视觉语言模型(VLM)的AR叙事框架，通过三重创新：1) 将物体语义分解为物理、功能和隐喻三层；2) 设计双向JSON接口连接VLM隐喻与AR锚点；3) 建立STAM评估体系。实验表明，该系统能基于环境生成故事（而非简单叠加），70%用户反馈环境物体因隐喻叙事获得新意义。该框架结合VLM的创造性与AR的空间精确性，实现了从被动空间到主动叙事场景的范式转变。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T04:01:23Z
- **目录日期**: 2025-04-19
