...
现有AR叙事系统通常仅用简单物体标签和空间坐标定义环境语义，导致叙事僵化且忽视物体间的深层关联。为解决这一问题，研究者提出融合视觉语言模型(VLM)的AR叙事框架，包含三大创新：1) 将物体语义分解为物理、功能和隐喻三层；2) 通过双向JSON层连接VLM隐喻与AR锚点；3) 建立STAM评估体系。实验表明，该系统能基于环境本身生成故事，70%用户反馈叙事改变了他们对实景物体的认知。该框架结合VLM的创造性与AR的空间精确性，实现了从"被动空间"到"主动叙事景观"的转变。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T06:01:39Z
- **目录日期**: 2025-04-19
