...
蚂蚁集团推出"百宝箱"智能体开发平台，支持3分钟快速搭建可调用支付宝、高德地图等30余款服务的AI智能体。该平台整合了DeepSeek、通义千问等主流大模型及50多款插件工具，开发者可发布智能体至支付宝小程序。基于MCP协议，智能体具备高自主性和强执行力，连接丰富生态并拓展商业变现机会。随着大厂纷纷布局MCP，AI智能体正成为行业新趋势，但开发门槛、生态打通等挑战仍需突破。蚂蚁的入局为开发者提供了接入国民级应用生态的新机遇。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T15:04:00Z
- **目录日期**: 2025-04-19
