...
蚂蚁集团推出"百宝箱"智能体开发平台，支持3分钟快速搭建可调用支付宝、高德地图等30余款MCP服务的AI智能体。该平台整合了DeepSeek、通义千问等主流大模型及50多款插件工具，开发者可发布智能体至支付宝小程序。MCP协议推动的AI智能体浪潮具有高自主性、强执行力和丰富商业变现机会，正成为AI时代的杀手级应用方向。随着大厂纷纷布局，智能体开发门槛降低但生态整合与商业模式仍存挑战，蚂蚁的入局为开发者提供了连接国民级应用生态的新机遇。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T04:03:03Z
- **目录日期**: 2025-04-19
