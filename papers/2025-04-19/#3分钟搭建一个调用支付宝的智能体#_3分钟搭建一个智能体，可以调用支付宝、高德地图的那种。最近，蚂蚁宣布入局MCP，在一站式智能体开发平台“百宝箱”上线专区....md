...
蚂蚁集团近期推出"百宝箱"智能体开发平台，支持快速搭建可调用支付宝、高德地图等30余款服务的AI智能体。该平台整合了DeepSeek、通义千问等主流大模型及50多款插件工具，开发者可在3分钟内完成部署，并发布为支付宝小程序。基于MCP协议的开源生态，AI智能体展现出比传统大模型应用更强的自主性和商业潜力，被视为AI时代的杀手级应用方向。随着大厂纷纷布局，智能体开发门槛降低但生态整合与商业模式仍存挑战，该领域正成为开发者新机遇。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T22:03:32Z
- **目录日期**: 2025-04-19
