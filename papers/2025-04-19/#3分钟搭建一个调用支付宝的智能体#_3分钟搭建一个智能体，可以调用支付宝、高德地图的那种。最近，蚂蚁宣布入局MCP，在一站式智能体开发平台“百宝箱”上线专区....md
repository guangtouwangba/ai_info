...
蚂蚁集团推出"百宝箱"智能体开发平台，支持3分钟快速搭建可调用支付宝、高德地图等30余款MCP服务的AI智能体。该平台整合了DeepSeek、通义千问等主流大模型及50多款插件工具，开发者可发布智能体至支付宝小程序。AI智能体因MCP协议兴起，具有高自主性、强执行力和丰富生态连接优势，被视为AI时代的杀手级应用机遇。随着大厂纷纷布局MCP，智能体开发门槛降低，商业变现潜力显现，但生态打通与模式创新仍存挑战。蚂蚁的入局加速了该趋势发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T03:12:56Z
- **目录日期**: 2025-04-19
