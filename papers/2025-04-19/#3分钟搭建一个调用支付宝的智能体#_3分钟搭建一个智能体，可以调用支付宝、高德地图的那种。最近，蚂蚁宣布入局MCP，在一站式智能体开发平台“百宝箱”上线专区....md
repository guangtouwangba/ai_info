...
蚂蚁集团推出"百宝箱"智能体开发平台，支持3分钟快速搭建可调用支付宝、高德地图等30余款服务的AI智能体。该平台整合了DeepSeek、通义千问等主流大模型及50多款插件工具，开发者可发布智能体至支付宝小程序。基于MCP协议，该方案降低了开发门槛，提供生态连接能力，展现AI智能体在自主性、执行力和商业变现方面的优势。随着大厂纷纷布局MCP，AI智能体正成为行业新趋势，可能催生下一代杀手级应用。蚂蚁的入局进一步推动了这一技术浪潮的发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T13:08:15Z
- **目录日期**: 2025-04-19
