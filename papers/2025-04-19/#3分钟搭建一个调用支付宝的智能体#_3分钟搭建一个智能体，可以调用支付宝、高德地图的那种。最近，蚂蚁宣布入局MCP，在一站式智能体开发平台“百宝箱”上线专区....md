...
蚂蚁集团推出"百宝箱"智能体开发平台，支持3分钟快速搭建可调用支付宝、高德地图等30余款MCP服务的AI智能体。该平台整合了DeepSeek、通义千问等主流大模型及50多款插件工具，开发者可将成果发布为支付宝小程序。MCP协议推动的AI智能体浪潮具有高自主性和强执行力特点，为开发者提供更丰富的商业变现机会。随着大厂纷纷布局，AI智能体正成为行业新趋势，但开发门槛和商业模式仍存挑战。蚂蚁此次入局有望加速智能体生态发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T20:03:47Z
- **目录日期**: 2025-04-19
