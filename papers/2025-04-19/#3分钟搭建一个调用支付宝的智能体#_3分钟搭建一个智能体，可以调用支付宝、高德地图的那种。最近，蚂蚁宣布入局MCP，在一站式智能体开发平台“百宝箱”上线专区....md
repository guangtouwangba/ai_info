...
蚂蚁集团推出"百宝箱"智能体开发平台，支持3分钟快速搭建可调用支付宝、高德地图等30余款服务的AI智能体。该平台整合DeepSeek、通义千问等主流大模型及50多款插件工具，开发者可发布智能体至支付宝小程序。MCP协议推动的AI智能体浪潮具有高自主性、强执行力和丰富商业潜力，正吸引互联网大厂布局。蚂蚁此次入局降低了开发门槛，为开发者提供连接国民级应用生态的机会，或将催生AI时代的杀手级应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T01:30:00Z
- **目录日期**: 2025-04-19
