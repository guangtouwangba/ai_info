...
这篇论文探讨了在通用智能代理(如自动化个人助手)时代需要重新思考安全设计的问题。传统基于手动策略和用户确认的安全机制(如应用权限)已无法适应多任务代理的复杂情境。作者提出"情境代理安全"(Conseca)框架，能够根据具体情境(如邮件内容、操作目的、账户类型等)动态生成即时、可验证的安全策略。该研究强调，与人类不同，计算系统需要新的安全机制来应对多样化情境中的行为安全性判断，这是适应通用代理规模化部署的重要一步。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T00:02:25Z
- **目录日期**: 2025-04-19
