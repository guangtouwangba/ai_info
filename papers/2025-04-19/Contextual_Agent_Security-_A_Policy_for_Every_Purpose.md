...
评估一个行为的安全性需要考虑其发生的具体情境。对人类而言，这显而易见（如删除邮件是否恰当取决于邮件内容、目的和邮箱类型）。但计算系统通常只在有限情境中运作，依赖手动制定的策略和用户确认（如应用权限）来防范风险。随着多功能智能代理（如自动个人助手）的出现，其广泛的适用情境和能力要求我们重新思考安全设计。本文提出"情境化智能代理安全"（Conseca）框架，旨在生成即时、情境化且可人工验证的安全策略，作为适应新型智能代理安全需求的第一步。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T17:02:27Z
- **目录日期**: 2025-04-19
