...
评估一个行为的安全性需要结合具体情境。对人类而言，这显而易见（如删除邮件是否恰当取决于内容、目的和邮箱类型）。传统计算系统因功能有限，依靠手动策略和用户确认（如应用权限）即可防范风险。但随着多功能智能代理（如自动助手）的出现，其广泛的应用场景要求重新设计安全机制。为此，本文提出"情境化代理安全框架"（Conseca），旨在生成即时、情境化且可人工验证的安全策略，以适应新一代智能系统的复杂需求。研究聚焦智能代理领域，为情境化安全设计迈出第一步。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T08:02:29Z
- **目录日期**: 2025-04-19
