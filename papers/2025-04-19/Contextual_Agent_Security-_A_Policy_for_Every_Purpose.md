...
判断一个行为是否安全需要结合具体情境。对人类而言，这显而易见（如删除邮件是否恰当取决于邮件内容、目的和邮箱类型），但计算系统通常只能在有限情境中运作，依靠手动设置策略和用户确认来防范风险。然而，随着多功能智能代理（如自动化个人助手）的出现，其广泛的任务处理能力要求安全设计必须适应更复杂的情境。为此，本文提出"情境化代理安全框架"（Conseca），旨在生成即时、情境化且可人工验证的安全策略，以应对新型智能代理带来的安全挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T13:06:24Z
- **目录日期**: 2025-04-19
