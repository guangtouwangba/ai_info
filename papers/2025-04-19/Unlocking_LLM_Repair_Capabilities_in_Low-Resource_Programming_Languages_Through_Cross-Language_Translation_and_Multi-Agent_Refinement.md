...
近期研究表明，大型语言模型（LLM）在自动程序修复（APR）中展现出强大能力，但现有方法主要针对Java、Python等主流语言，对Rust等新兴语言修复效果有限。为此，研究者提出跨语言修复框架LANTERN，通过多智能体迭代修复策略，将缺陷代码从LLM修复能力弱的语言翻译至修复能力强的语言，无需额外训练。基于xCodeEval基准（11种语言5,068个缺陷）的测试显示，该方法显著提升修复效果，其中Rust的Pass@10指标提升22.09%，首次证明跨语言翻译能有效缩小不同流行度语言间的修复性能差距。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T17:02:07Z
- **目录日期**: 2025-04-19
