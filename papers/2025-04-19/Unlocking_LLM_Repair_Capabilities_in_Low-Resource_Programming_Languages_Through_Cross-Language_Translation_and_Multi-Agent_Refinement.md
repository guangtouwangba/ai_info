...
近期研究表明，LLMs在自动程序修复（APR）中展现出强大能力，但现有方法主要针对Java、Python等主流语言，对Rust等新兴语言因训练成本高、数据少和社区支持不足而关注较少。为此，研究者提出跨语言修复方法LANTERN，通过多智能体迭代修复范式，将缺陷代码从LLMs修复能力弱的语言翻译至修复能力强的语言，无需额外训练。基于LLM的动态决策系统根据错误特征选择最优目标语言，并整合修复反馈。在11种语言的5,068个错误测试中，Rust的修复成功率提升22.09%，首次证明跨语言翻译能显著提升LLMs的多语言修复能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T02:26:57Z
- **目录日期**: 2025-04-19
