...
最新研究提出跨语言程序修复方法LANTERN，利用大语言模型(LLM)在不同编程语言间的修复能力差异，通过多智能体迭代修复范式提升修复效果。该方法将缺陷代码从LLM修复能力较弱的语言翻译至表现更好的语言，无需额外训练。基于LLM的决策系统能动态选择最优目标语言并整合修复反馈。在包含11种语言5068个错误的xCodeEval基准测试中，该方法显著提升修复效果，特别是冷门语言如Rust的Pass@10指标提升22.09%，首次证明跨语言翻译能有效弥合不同流行度语言间的修复性能差距。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T20:02:08Z
- **目录日期**: 2025-04-19
