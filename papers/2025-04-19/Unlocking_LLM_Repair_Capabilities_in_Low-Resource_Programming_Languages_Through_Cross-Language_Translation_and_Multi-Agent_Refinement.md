...
最近研究显示，大语言模型（LLM）在自动程序修复（APR）中展现出强大能力，但主要集中于Java、Python等主流语言，对Rust等新兴语言因资源限制缺乏支持。为此，研究者提出跨语言修复方法LANTERN，通过多智能体迭代范式，将缺陷代码从LLM修复能力弱的语言翻译至修复能力强的语言，无需额外训练。该方法基于LLM动态选择目标语言并整合修复反馈，在11种语言的5068个错误测试中显著提升修复效果，尤其冷门语言（如Rust的Pass@10指标提升22.09%），首次实证跨语言翻译能弥合不同流行度语言间的修复差距。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T13:06:03Z
- **目录日期**: 2025-04-19
