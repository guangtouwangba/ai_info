...
近期研究表明，大型语言模型（LLM）在自动程序修复（APR）中展现出强大能力，但现有方法主要针对主流语言（如Java、Python），对Rust等新兴语言支持不足。为此，研究者提出跨语言修复方法LANTERN，通过多智能体迭代修复范式，将缺陷代码从LLM修复能力弱的语言翻译至表现更强的语言，无需额外训练。基于xCodeEval基准（11种语言5068个错误）的测试显示，该方法显著提升修复效果，其中Rust的Pass@10指标提高22.09%，首次证明跨语言翻译能有效弥合不同流行度语言间的修复差距。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T05:02:13Z
- **目录日期**: 2025-04-19
