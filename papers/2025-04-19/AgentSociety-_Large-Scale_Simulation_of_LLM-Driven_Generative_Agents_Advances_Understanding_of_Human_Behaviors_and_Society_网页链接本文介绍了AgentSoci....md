...
AgentSociety是一个基于大语言模型的大规模社会模拟器，包含1万多个AI代理，模拟了500万次社会互动。研究者用它分析了四个关键社会问题：社会极化、信息传播、基本收入政策及自然灾害影响。模拟结果与现实实验数据高度吻合，验证了该平台在揭示人类行为机制和社会问题成因方面的有效性。该系统可作为传统社会科学研究方法（如调查、访谈）的有力补充，为研究者和政策制定者提供新的分析工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T17:05:22Z
- **目录日期**: 2025-04-19
