...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟器，能够模拟1万多个代理及其500万次互动。研究者用它研究了社会极化、信息传播、基本收入政策和自然灾害影响等四个社会问题。模拟结果与现实数据吻合，验证了该系统在理解人类行为和社会机制方面的有效性，展示了其作为社会科学研究和政策制定工具的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T13:09:42Z
- **目录日期**: 2025-04-19
