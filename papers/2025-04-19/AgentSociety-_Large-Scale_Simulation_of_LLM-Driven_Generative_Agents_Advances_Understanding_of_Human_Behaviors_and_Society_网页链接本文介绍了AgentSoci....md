...
《AgentSociety》是一项利用大语言模型驱动的大规模社会模拟系统，通过1万个代理和500万次互动，模拟真实社会环境。研究聚焦四个关键社会问题：社会极化、刺激性信息传播、无条件基本收入政策及飓风等外部冲击的影响。结果显示，模拟结果与现实世界实验高度吻合，验证了该系统在捕捉人类行为机制方面的能力。该工具为社会科学研究和政策制定提供了新方法，可辅助传统研究手段（如调查和干预），深入探索社会问题的成因与潜在机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T12:05:34Z
- **目录日期**: 2025-04-19
