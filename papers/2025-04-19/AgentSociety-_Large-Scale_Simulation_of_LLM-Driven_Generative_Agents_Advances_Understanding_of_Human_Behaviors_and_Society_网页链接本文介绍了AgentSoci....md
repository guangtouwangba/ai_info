...
AgentSociety是一个基于大型语言模型的大规模社会模拟系统，可模拟10,000+智能代理及500万次社会互动。该系统通过四个关键社会议题（社会极化、信息传播、基本收入政策、自然灾害影响）验证其有效性，实验结果与现实数据高度吻合。研究表明，该平台能有效捕捉人类行为机制，为社会科学研究和政策制定提供新工具，补充传统调查和实验方法的不足。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T01:31:51Z
- **目录日期**: 2025-04-19
