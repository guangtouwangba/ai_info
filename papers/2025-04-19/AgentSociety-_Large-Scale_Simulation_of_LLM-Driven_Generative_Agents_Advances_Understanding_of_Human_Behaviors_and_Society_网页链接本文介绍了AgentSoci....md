...
AgentSociety是一个基于大型语言模型的大规模社会模拟系统，能够模拟超过1万个代理的社会生活及500万次互动。研究者利用该平台研究了社会极化、信息传播、基本收入政策及自然灾害影响等关键问题。模拟结果与现实世界数据吻合，验证了系统捕捉人类行为机制的能力，展示了其作为社会科学研究和政策制定工具的潜力。该系统通过结合LLM代理、真实社会环境和大规模模拟引擎，为理解复杂社会现象提供了新方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T00:04:54Z
- **目录日期**: 2025-04-19
