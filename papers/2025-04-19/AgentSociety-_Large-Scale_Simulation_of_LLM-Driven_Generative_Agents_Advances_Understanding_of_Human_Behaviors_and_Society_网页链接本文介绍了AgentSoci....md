...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统模拟了超过1万个AI代理的社会生活，产生了500万次互动，用于研究社会现象如信息传播、政策影响等。研究验证了模拟结果与现实数据的吻合性，展示了该系统在理解人类行为机制方面的能力，为社会科学研究和政策制定提供了新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T02:30:10Z
- **目录日期**: 2025-04-19
