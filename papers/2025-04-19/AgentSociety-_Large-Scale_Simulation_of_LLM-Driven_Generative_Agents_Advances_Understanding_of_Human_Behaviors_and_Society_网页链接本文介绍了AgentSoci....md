...
这篇论文介绍了AgentSociety，一个基于大型语言模型的大规模社会模拟系统，能够模拟1万多个AI代理的社会互动（500万次）。研究者用它研究了四个社会问题：社会极化、信息传播、基本收入政策效果和自然灾害影响。模拟结果与现实世界数据吻合，验证了该系统在分析人类行为和社会机制方面的有效性。该平台为社会科学研究和政策制定提供了新工具，能补充传统研究方法（如调查和访谈）的不足。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T07:05:23Z
- **目录日期**: 2025-04-19
