...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，包含1万多个AI代理和500万次互动。研究者用它模拟了社会极化、信息传播、基本收入政策及自然灾害影响四个关键问题。结果显示其模拟结果与现实世界数据高度吻合，验证了系统对人类行为和社会机制的捕捉能力。该系统可作为计算社会科学的新工具，为研究者和政策制定者提供传统方法（如调查、实验）之外的补充研究手段，有助于深入理解复杂社会问题的成因和机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T18:05:08Z
- **目录日期**: 2025-04-19
