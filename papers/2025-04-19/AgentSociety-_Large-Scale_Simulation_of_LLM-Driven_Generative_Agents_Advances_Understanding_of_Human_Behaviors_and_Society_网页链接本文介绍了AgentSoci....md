...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟10,000多个AI代理及其500万次社会互动。研究者用它研究了四大社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，验证了该系统捕捉人类行为机制的能力。该平台可作为计算社会科学研究工具，为学者和政策制定者提供新的实验手段，补充传统调查和访谈方法的不足，帮助深入理解复杂社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T04:05:03Z
- **目录日期**: 2025-04-19
