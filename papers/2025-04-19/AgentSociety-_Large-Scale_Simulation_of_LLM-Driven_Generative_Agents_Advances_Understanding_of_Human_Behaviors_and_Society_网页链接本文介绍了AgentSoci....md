...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统通过1万个AI代理模拟真实社会环境，记录了500万次交互，用于研究社会现象。研究者测试了四个关键问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实数据高度吻合，证明了该系统能有效捕捉人类行为机制。AgentSociety为社会科学研究和政策制定提供了新工具，可辅助传统研究方法，帮助理解复杂社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T14:05:51Z
- **目录日期**: 2025-04-19
