...
AgentSociety是一个基于大型语言模型的大规模社会模拟器，能模拟超过1万个代理及其500万次互动。研究者用它分析极化现象、信息传播、基本收入政策及飓风影响等社会问题，结果与现实数据吻合。该系统可作为计算社会科学工具，辅助传统研究方法，帮助理解社会行为机制，并为政策制定提供参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T11:05:47Z
- **目录日期**: 2025-04-19
