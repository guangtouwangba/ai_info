...
这篇论文针对代码生成大模型（codeLLMs）与人类偏好对齐的问题，提出了新基准CodeArena和合成指令数据集SynCode-Instruct。CodeArena包含397个高质量样本，覆盖40类编程任务和44种语言，更贴近实际开发需求。研究发现在执行基准和人类偏好评估间存在差异，开源模型（如Qwen2.5-Coder）与商业模型（如OpenAI o1）表现差距显著。通过20B标记的指令微调实验，验证了合成数据对提升模型对齐效果的有效性，强调了代码生成模型除正确性外还需关注人类偏好匹配的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T20:05:59Z
- **目录日期**: 2025-04-19
