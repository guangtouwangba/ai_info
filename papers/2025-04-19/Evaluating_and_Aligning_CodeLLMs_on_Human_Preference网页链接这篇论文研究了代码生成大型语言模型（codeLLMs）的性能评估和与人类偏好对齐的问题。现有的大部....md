...
这篇论文针对代码生成大模型(codeLLMs)与人类偏好对齐的问题，提出了CodeArena基准测试和SynCode-Instruct指令数据集。CodeArena包含397个高质量编程任务样本，覆盖40个类别和44种语言，更贴近实际开发场景。研究发现现有基于执行的评测与人类偏好存在差距，且开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著。通过构建近200亿token的合成指令数据验证了大模型微调的有效性，强调了代码生成模型除正确性外还需关注人类偏好对齐的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T04:05:40Z
- **目录日期**: 2025-04-19
