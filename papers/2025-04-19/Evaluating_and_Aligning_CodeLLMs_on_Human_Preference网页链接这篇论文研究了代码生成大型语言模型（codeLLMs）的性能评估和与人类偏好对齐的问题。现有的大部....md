...
这篇论文探讨了代码生成大模型（codeLLMs）如何更好地与人类偏好对齐。研究者发现现有基准测试过于关注代码正确性，忽视了人类偏好，因此提出了CodeArena基准测试，包含397个高质量样本，覆盖40个类别和44种编程语言。此外，论文还构建了20B标记的合成指令数据集SynCode-Instruct。实验显示，开源模型（如Qwen2.5-Coder）与专有模型（如OpenAI o1）存在显著差距，突显了与人类偏好对齐的重要性。研究强调了在代码生成任务中考虑人类偏好的必要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T23:05:38Z
- **目录日期**: 2025-04-19
