...
该研究针对代码生成大模型(codeLLMs)提出CodeArena基准测试，包含397个高质量样本，覆盖40类编程任务和44种语言，以评估模型与人类偏好的匹配度。同时构建了20B标记的SynCode-Instruct合成指令数据集验证微调效果。实验发现执行基准与人类偏好存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，凸显对齐人类偏好的重要性。研究强调现有评估过于侧重代码正确性而忽视实际开发需求，为代码LLM的优化提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T13:10:21Z
- **目录日期**: 2025-04-19
