...
这篇论文针对代码生成大型语言模型(codeLLMs)提出新评估方法，重点关注与人类偏好的对齐问题。研究者开发了CodeArena基准测试，包含397个高质量样本，覆盖40个类别和44种编程语言，模拟真实编程任务。同时构建了SynCode-Instruct语料库(近20B标记)验证合成指令微调效果。实验发现执行基准与CodeArena存在性能差异，开源顶级模型(如Qwen2.5-Coder)与专有模型(如OpenAI o1)间仍有显著差距，凸显了人类偏好对齐的重要性。研究为代码LLM评估提供了更全面的视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T19:05:27Z
- **目录日期**: 2025-04-19
