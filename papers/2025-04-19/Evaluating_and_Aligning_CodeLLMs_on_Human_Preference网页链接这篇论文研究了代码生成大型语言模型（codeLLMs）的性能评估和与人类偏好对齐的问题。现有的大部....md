...
这篇论文探讨了代码生成大模型（codeLLMs）与人类偏好的对齐问题。研究发现现有基准测试过于关注代码正确性而忽视人类偏好，因此提出了CodeArena基准（含397个样本，覆盖40类编程任务和44种语言）和合成指令数据集SynCode-Instruct（约200亿标记）。实验显示执行基准与人类偏好评估存在差异，开源模型（如Qwen2.5-Coder）与商业模型（如OpenAI o1）性能差距显著，凸显了人类偏好对齐的重要性。研究为提升代码生成模型的实用性和用户体验提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T17:06:03Z
- **目录日期**: 2025-04-19
