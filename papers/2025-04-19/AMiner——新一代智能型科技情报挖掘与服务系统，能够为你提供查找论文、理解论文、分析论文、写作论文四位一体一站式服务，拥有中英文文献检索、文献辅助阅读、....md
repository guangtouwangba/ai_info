...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译和科研订阅等一站式服务。它覆盖42个学科，包含3.5亿论文、0.6亿学者等数据。主要功能包括：1）中英文文献检索与智能问答；2）英文文献翻译及AI辅助阅读（自动生成摘要、章节概要等）；3）个性化科研情报订阅（通过微信/邮件推送最新研究动态）。平台还支持学者画像、学术会议追踪等功能，可免费使用。网址：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T00:05:18Z
- **目录日期**: 2025-04-19
