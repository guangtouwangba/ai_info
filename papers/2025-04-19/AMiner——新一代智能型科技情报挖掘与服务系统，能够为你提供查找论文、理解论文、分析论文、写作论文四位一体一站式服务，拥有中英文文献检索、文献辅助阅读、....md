...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译和科研订阅等一站式服务。它收录了3.5亿论文、0.6亿学者和1.5亿专利等海量数据，支持中英文文献检索、AI生成摘要、互动问答等功能。用户可上传或搜索论文，获取摘要和章节概要，并通过对话深入理解内容。平台还提供个性化科研动态订阅，根据用户关注的学者、机构或关键词推送最新论文。此外，AMiner具备学者画像、学术会议和论文排行榜等特色功能，浏览器版可免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T17:05:52Z
- **目录日期**: 2025-04-19
