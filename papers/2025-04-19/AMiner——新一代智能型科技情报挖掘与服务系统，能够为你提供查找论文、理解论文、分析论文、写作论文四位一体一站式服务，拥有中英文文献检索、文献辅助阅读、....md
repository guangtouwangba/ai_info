...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和科研订阅等一站式服务。它支持中英文文献搜索，能自动生成摘要并回答用户提问，提升研究效率。平台还具备文档识别、章节概要和互动问答功能，帮助用户深入理解文献。用户可订阅个性化科研动态，跟踪机构、学者或关键词的最新成果。AMiner收录了3.5亿论文、0.6亿学者和1.5亿专利等海量数据，并提供免费使用入口。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T06:06:03Z
- **目录日期**: 2025-04-19
