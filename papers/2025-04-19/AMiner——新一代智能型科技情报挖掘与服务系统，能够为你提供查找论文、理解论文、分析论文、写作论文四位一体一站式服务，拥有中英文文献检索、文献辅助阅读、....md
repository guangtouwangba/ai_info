...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和科研订阅等一站式服务。平台收录3.5亿论文、0.6亿学者等海量学术资源，支持中英文文献检索和AI生成摘要。用户可通过互动问答快速理解文献内容，还能上传PDF获取智能解析。特色功能包括个性化科研动态推送、学者画像分析及学术会议追踪。AMiner提供网页版免费使用，帮助研究者高效获取和管理学术信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T19:05:17Z
- **目录日期**: 2025-04-19
