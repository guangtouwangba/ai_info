...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务。主要功能包括：1）中英文文献检索，支持3.5亿论文的精准搜索，可自动生成摘要；2）文献辅助阅读，支持PDF上传、章节概要生成和AI问答；3）科研情报订阅，根据用户兴趣推送最新研究动态；4）附加学者画像、会议追踪等工具。平台覆盖42个学科，整合论文、专利和科研项目数据，通过网页或微信小程序提供免费服务，显著提升文献调研和论文写作效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T14:06:24Z
- **目录日期**: 2025-04-19
