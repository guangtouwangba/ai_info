...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和科研订阅等一站式服务。它收录了3.5亿论文、0.6亿学者和1.5亿专利，支持中英文文献检索、AI摘要生成和互动问答。用户可上传PDF或从平台获取论文，利用AI快速理解内容。平台还提供个性化科研动态推送，通过微信或邮件发送最新学术资讯。此外，AMiner包含学者画像、学术会议等特色功能，基础服务免费使用。访问地址：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T02:30:35Z
- **目录日期**: 2025-04-19
