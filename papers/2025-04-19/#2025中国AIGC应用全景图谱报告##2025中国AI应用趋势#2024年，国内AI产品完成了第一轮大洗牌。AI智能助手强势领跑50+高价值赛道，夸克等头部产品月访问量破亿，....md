...
2024年中国AI行业完成首轮洗牌，头部产品如夸克、豆包月访问量破亿。量子位智库发布《2025中国AIGC应用全景图谱报告》，从C端、B端和开发工具三大维度分析400+企业，覆盖AI助手、办公、创作、文娱和生活五大场景。报告显示AI已渗透搜索、电商等全流程，并指出技术突破和生态扩张正推动行业进入新拐点。完整报告可通过链接获取。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-19T16:03:19Z
- **目录日期**: 2025-04-19
