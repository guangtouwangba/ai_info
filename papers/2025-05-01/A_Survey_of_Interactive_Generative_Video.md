...
交互式生成视频（IGV）是一种结合生成能力和交互功能的技术，可生成高质量视频内容并支持用户通过控制信号和反馈进行互动。该技术主要应用于三大领域：1）游戏，支持无限虚拟世界探索；2）具身AI，作为物理感知环境合成器，训练智能体与动态场景交互；3）自动驾驶，提供闭环仿真测试。研究提出理想IGV系统的五大模块：生成、控制、记忆、动态和智能，并分析了技术挑战，如实时生成、开放域控制、长期一致性、物理模拟和因果推理。这一框架旨在推动IGV技术向更成熟、实用的方向发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T08:00:59Z
- **目录日期**: 2025-05-01
