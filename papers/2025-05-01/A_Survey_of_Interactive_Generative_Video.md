...
交互式生成视频（IGV）是一种结合生成能力和交互功能的技术，可创建高质量视频内容并支持用户通过控制信号和实时反馈进行互动。本文探讨了IGV在三大领域的应用：1）游戏，支持无限虚拟世界探索；2）具身AI，作为物理感知环境合成器，训练智能体与动态场景交互；3）自动驾驶，提供闭环仿真以进行安全测试。作者提出理想IGV系统的五大模块：生成、控制、记忆、动态和智能，并分析了技术挑战，如实时生成、开放域控制、长期一致性、物理模拟和因果推理。该研究旨在推动IGV技术的进一步发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T21:00:59Z
- **目录日期**: 2025-05-01
