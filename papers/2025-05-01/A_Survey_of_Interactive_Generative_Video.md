...
交互式生成视频(IGV)是一种结合生成能力和交互功能的新兴技术，可生成高质量视频内容并支持用户通过控制信号进行互动。该技术主要应用于三大领域：1)游戏领域实现虚拟世界无限探索；2)具身AI作为物理感知环境合成器；3)自动驾驶提供闭环仿真测试。研究提出理想IGV系统应包含生成、控制、记忆、动态和智能五大模块，并分析了实时生成、开放域控制、长期一致性、精确物理模拟和因果推理等关键技术挑战。这一系统分析将推动IGV技术向更成熟实用的方向发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T03:21:03Z
- **目录日期**: 2025-05-01
