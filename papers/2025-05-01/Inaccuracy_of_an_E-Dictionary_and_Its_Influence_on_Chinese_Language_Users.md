...
电子词典已成为二语学习者扩充词汇的主要工具，但其准确性和语料构建方式却鲜受质疑。本研究通过实验、用户调查和词典评析，考察了中国主流电子词典"有道"的定义缺陷。实验发现，不完整或错误的词典定义会导致严重误解，且用户存在不良查询习惯。研究进一步揭示了问题根源：数据处理缺陷及AI/机器学习技术在词典构建中的应用不足。结果表明，用户需加强词典使用素养培训，电子词典的底层AI模型也亟待改进。该研究填补了电子词典局限性领域的实证空白。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T02:32:59Z
- **目录日期**: 2025-05-01
