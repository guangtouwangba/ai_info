...
这篇论文针对代码生成大模型(codeLLMs)提出新评估方法，指出当前基准测试过于关注代码正确性而忽视人类偏好。研究者构建了CodeArena基准测试(包含397个样本/40类/44种语言)模拟真实编程任务，并创建20B标记的SynCode-Instruct合成指令集进行验证。实验发现执行基准与CodeArena存在性能差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)表现差距显著，凸显了与人类偏好对齐的重要性。研究为提升代码LLMs的实际应用价值提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T16:06:04Z
- **目录日期**: 2025-05-01
