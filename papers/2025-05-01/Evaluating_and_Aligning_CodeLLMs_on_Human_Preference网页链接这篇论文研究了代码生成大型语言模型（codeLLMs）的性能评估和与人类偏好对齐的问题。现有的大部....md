...
该研究针对代码生成大模型(codeLLMs)提出CodeArena基准测试，关注模型输出与人类偏好的对齐问题。通过收集397个涵盖40类编程任务和44种语言的真实样本，以及构建近200亿标记的合成指令数据集SynCode-Instruct，研究发现传统执行测试与人类偏好存在差距。在测试40多个模型后发现，开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著，凸显了人类偏好对齐在代码生成中的重要性。研究为评估和改进代码LLMs提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T17:05:21Z
- **目录日期**: 2025-05-01
