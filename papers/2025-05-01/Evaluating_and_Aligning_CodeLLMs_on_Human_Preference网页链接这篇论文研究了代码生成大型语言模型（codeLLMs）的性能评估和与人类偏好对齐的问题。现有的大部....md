...
这篇论文针对代码生成大模型(codeLLMs)的评估标准提出创新，指出当前基准测试过度关注代码正确性而忽视人类偏好。研究者构建了CodeArena基准测试(包含397个样本/40类/44种语言)模拟真实编程场景，并开发了20B标记量的SynCode-Instruct合成指令数据集。实验发现执行基准与人类偏好评估存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，凸显了模型对齐人类偏好的重要性。研究为提升代码LLMs的实际应用价值提供了新评估维度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T10:05:43Z
- **目录日期**: 2025-05-01
