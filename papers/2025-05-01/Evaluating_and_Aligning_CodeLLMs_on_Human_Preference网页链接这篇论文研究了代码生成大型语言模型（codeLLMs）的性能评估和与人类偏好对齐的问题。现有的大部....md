...
该论文针对代码生成大模型(codeLLMs)提出新评估框架CodeArena，通过397个涵盖40类编程任务和44种语言的真实样本评估模型与人类偏好的对齐程度。研究发现传统基于执行的测试与人类偏好存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。同时构建近200亿标记的合成指令数据集SynCode-Instruct验证大规模指令微调效果。研究强调代码生成模型除正确性外，还需关注开发者实际使用偏好，为代码LLM的优化提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T14:05:42Z
- **目录日期**: 2025-05-01
