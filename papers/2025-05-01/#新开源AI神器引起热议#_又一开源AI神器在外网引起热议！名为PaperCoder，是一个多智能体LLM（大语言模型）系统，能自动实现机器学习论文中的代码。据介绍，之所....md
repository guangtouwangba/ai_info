...
韩国科学技术院研究人员开发了一款名为PaperCoder的开源AI工具，能够将机器学习论文自动转换为可运行代码。该工具采用多智能体系统，分规划、分析和代码生成三个阶段处理任务。据统计，2024年NeurIPS等顶会论文仅21%公开代码，导致复现困难。PaperCoder生成的代码质量超越部分基准测试，并获得了77%原论文作者的认可。这一创新有望加速机器学习研究成果的复现和应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T12:03:03Z
- **目录日期**: 2025-05-01
