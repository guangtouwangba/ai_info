...
韩国科学技术院团队开发了开源AI工具PaperCoder，这是一个多智能体大语言模型系统，能够自动将机器学习论文转化为可运行代码。该工具针对顶会论文仅21%公开代码的问题，通过规划、分析和代码生成三个阶段的智能体协作，显著提升了研究复现效率。测试显示其生成的代码质量优于现有基准，并获得了77%原论文作者的认可。这一创新有望加速机器学习领域的代码共享和研究复现进程。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T07:02:56Z
- **目录日期**: 2025-05-01
