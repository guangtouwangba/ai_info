...
韩国科学技术院研究人员开发了一款名为PaperCoder的开源AI工具，能够将机器学习论文自动转换为可运行代码。该工具采用多智能体系统，在规划、分析和代码生成三个阶段分别由专门模块处理，最终生成的代码质量超过现有基准，并获得了77%原论文作者的认可。开发动机源于2024年顶会论文仅21%公开代码的现实问题，旨在解决研究成果复现缓慢的痛点。这一创新工具近期在国际学界引发热议。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T15:03:00Z
- **目录日期**: 2025-05-01
