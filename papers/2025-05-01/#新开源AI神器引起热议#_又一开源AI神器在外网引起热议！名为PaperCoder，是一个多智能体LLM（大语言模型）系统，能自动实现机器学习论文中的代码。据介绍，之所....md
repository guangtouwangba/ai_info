...
韩国科学技术院研究人员开发了一款名为PaperCoder的开源AI工具，旨在自动将机器学习论文转换为可运行代码。该系统采用多智能体架构，通过规划、分析和代码生成三个阶段协同工作，专门解决顶会论文代码开源率低（2024年仅21%）导致的复现难题。测试表明，其生成代码质量超越部分现有基准，并获得了77%原论文作者的认可。该工具有望加速科研成果的复现和应用落地。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T17:02:58Z
- **目录日期**: 2025-05-01
