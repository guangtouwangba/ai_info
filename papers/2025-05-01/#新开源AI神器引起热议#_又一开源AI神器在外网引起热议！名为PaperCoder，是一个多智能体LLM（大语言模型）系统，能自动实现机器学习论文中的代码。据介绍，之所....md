...
韩国科学技术院团队开发的开源AI工具PaperCoder引发热议。该系统采用多智能体架构，能自动将机器学习论文转化为可运行代码，解决顶会论文仅21%公开代码导致的复现难题。其通过规划、分析、代码生成三阶段协作，生成质量超越现有基准，获77%原论文作者认可。该工具显著提升科研代码复现效率，推动AI研究可复现性发展。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T10:03:04Z
- **目录日期**: 2025-05-01
