...
韩国科学技术院团队开发的开源AI工具PaperCoder引发热议。该系统通过多智能体协作（规划、分析、代码生成三阶段），能将机器学习论文自动转化为可运行代码。研究显示2024年顶会论文仅21%公开代码，严重影响复现效率。测试表明其生成代码质量超越部分基准，并获得77%原论文作者认可。该工具旨在解决学术代码共享不足导致的科研效率低下问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T05:02:45Z
- **目录日期**: 2025-05-01
