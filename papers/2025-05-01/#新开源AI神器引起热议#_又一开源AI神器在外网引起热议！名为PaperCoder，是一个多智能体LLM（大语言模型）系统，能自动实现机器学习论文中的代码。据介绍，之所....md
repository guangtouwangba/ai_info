...
韩国科学技术院团队开发的开源AI工具PaperCoder引发热议。该系统采用多智能体架构，能自动将机器学习论文转化为可运行代码，解决了顶会论文仅21%公开代码导致的复现难题。其三大智能体分别处理规划、分析和代码生成任务，生成的代码质量超越现有基准，获得77%原论文作者认可。该工具显著提升了研究成果的复现效率，推动AI领域研究发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T18:03:05Z
- **目录日期**: 2025-05-01
