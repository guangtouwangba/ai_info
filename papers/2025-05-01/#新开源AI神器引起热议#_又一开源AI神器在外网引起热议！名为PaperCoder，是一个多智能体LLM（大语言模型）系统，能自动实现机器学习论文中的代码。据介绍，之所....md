...
韩国科学技术院团队开发的开源AI工具PaperCoder引发关注。该系统采用多智能体架构，能自动将机器学习论文转化为可运行代码，解决了当前仅21%顶会论文公开代码导致的复现难题。其工作流程分为规划、分析和代码生成三阶段，由专用智能体处理不同任务。测试显示，生成代码质量超越部分现有基准，并获得77%原论文作者的认可。该工具显著提升了研究成果的复现效率，推动AI领域研究进程。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T09:03:04Z
- **目录日期**: 2025-05-01
