...
韩国科学技术院研究人员开发了一款名为PaperCoder的开源AI工具，旨在自动将机器学习论文转化为可运行代码。该工具采用多智能体系统，分为规划、分析和代码生成三个阶段，由专门智能体处理不同任务。统计显示2024年顶会论文仅21%公开代码，导致复现困难。PaperCoder生成的代码质量超越部分现有基准，并获得77%原论文作者认可。这一创新有望加速机器学习研究的复现和应用进程。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T13:09:53Z
- **目录日期**: 2025-05-01
