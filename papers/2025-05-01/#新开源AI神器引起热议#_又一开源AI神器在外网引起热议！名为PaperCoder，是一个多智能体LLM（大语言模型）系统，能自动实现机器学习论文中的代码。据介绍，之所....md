...
韩国科学技术院研究人员开发了一款名为PaperCoder的开源AI工具，能够将机器学习论文自动转化为可运行代码。该工具采用多智能体系统，通过规划、分析和代码生成三个阶段处理任务，旨在解决顶会论文仅21%公开代码导致的复现困难问题。测试显示，其生成代码质量超越部分现有基准，并获得了77%原论文作者的认可。这一创新工具显著提升了研究成果的复现效率，在学术圈引发广泛关注。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T14:02:59Z
- **目录日期**: 2025-05-01
