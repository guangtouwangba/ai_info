...
韩国科学技术院研究人员开发了一款名为PaperCoder的开源AI工具，旨在自动将机器学习论文转换为可运行代码。该系统采用多智能体架构，分规划、分析和代码生成三个阶段处理任务。统计显示，2024年NeurIPS等顶会论文仅21%公开代码，导致复现困难。PaperCoder生成的代码质量超过部分现有基准，并获得了77%原论文作者的认可。该工具可显著加速研究成果的复现和应用开发。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T22:02:54Z
- **目录日期**: 2025-05-01
