...
韩国科学技术院团队开发的开源AI工具PaperCoder引发关注，该系统能自动将机器学习论文转化为可运行代码。针对顶会论文仅21%公开代码的问题，该工具通过规划、分析、代码生成三阶段的多智能体协作，显著提升研究复现效率。测试显示其生成代码质量超越部分基准，并获77%原论文作者认可。该工具旨在解决学术代码共享不足导致的复现困难问题，推动AI研究发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T23:02:45Z
- **目录日期**: 2025-05-01
