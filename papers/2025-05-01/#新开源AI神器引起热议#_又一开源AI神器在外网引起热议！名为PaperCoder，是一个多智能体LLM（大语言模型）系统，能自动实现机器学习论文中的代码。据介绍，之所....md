...
韩国科学技术院团队开发的开源AI工具PaperCoder引发关注。这个多智能体系统能将机器学习论文自动转换为可运行代码，解决了顶会论文仅21%公开代码导致的复现难题。系统通过规划、分析、代码生成三阶段智能体协作，生成质量超过现有基准，获得77%原论文作者认可。该工具显著提升了研究成果的复现效率，推动AI领域研究发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T06:02:51Z
- **目录日期**: 2025-05-01
