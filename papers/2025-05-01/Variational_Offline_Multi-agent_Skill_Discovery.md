...
该研究提出两种新型自动编码方案VO-MASD-3D和VO-MASD-Hier，首次实现多智能体场景中自动提取子群协调模式与时间抽象的技能学习。核心创新是动态分组功能，可基于任务交互自动识别潜在子群。方法支持离线多任务数据应用，发现的子群技能可跨任务迁移而无需重新训练。在《星际争霸》任务中的实验表明，其显著优于现有分层多智能体强化学习方法，并能有效缓解延迟稀疏奖励场景的学习困难。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T04:05:06Z
- **目录日期**: 2025-05-01
