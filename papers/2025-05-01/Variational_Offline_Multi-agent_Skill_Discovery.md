...
该研究提出两种新型自编码器方案VO-MASD-3D和VO-MASD-Hier，首次实现多智能体场景中自动提取子群协调模式与时间抽象技能。核心创新是动态分组函数，能基于任务交互自动识别潜在子群。方法适用于离线多任务数据，发现的子群技能可跨任务迁移无需重训练。在《星际争霸》任务中的实验表明，该方法显著优于现有分层多智能体强化学习技术，并能有效缓解延迟稀疏奖励场景的学习困难。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T20:02:10Z
- **目录日期**: 2025-05-01
