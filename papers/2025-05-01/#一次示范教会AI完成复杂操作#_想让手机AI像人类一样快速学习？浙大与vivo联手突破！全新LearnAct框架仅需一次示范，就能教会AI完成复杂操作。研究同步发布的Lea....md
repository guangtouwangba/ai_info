...
浙江大学与vivo合作研发了LearnAct框架，仅需一次示范就能教会AI完成复杂操作。该研究同时发布了LearnGUI基准，首次构建了面向移动端示范学习的评估体系，为AI智能体的实用化部署提供关键技术支撑。研究团队来自浙江大学和vivo AI Lab，共同第一作者为刘广义和赵鹏翔，研究方向为大语言模型驱动的GUI智能体技术。项目由vivo算法专家刘亮领导，通信作者为浙江大学孟文超研究员。这一突破使手机AI能像人类一样快速学习复杂任务。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T06:02:43Z
- **目录日期**: 2025-05-01
