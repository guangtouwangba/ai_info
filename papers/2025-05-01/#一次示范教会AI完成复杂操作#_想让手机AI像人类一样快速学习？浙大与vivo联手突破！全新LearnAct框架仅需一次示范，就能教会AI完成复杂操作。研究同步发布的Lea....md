...
浙江大学与vivo合作开发了LearnAct框架，仅需一次示范就能教会AI完成复杂操作。该研究同步发布了LearnGUI基准，首次构建了移动端示范学习的评估体系，为AI智能体的实用化部署提供关键技术。研究团队来自浙江大学和vivo AI lab，由硕士生刘广义、赵鹏翔主导，vivo专家刘亮和浙大研究员孟文超指导。这一突破使手机AI能像人类一样快速学习，有望大幅提升移动设备的智能化水平。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T21:02:49Z
- **目录日期**: 2025-05-01
