...
浙江大学与vivo合作研发的LearnAct框架实现重大突破，仅需一次示范即可教会AI完成复杂操作。该研究同步发布LearnGUI基准，首次建立移动端示范学习的评估体系，为AI智能体实用化提供关键技术支撑。项目由浙大硕士生刘广义、赵鹏翔（共同一作）和vivo算法专家刘亮主导，通信作者为浙大孟文超研究员。该技术让手机AI通过单次示范就能终身掌握复杂任务操作，推动大语言模型驱动的GUI智能体技术发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T12:02:54Z
- **目录日期**: 2025-05-01
