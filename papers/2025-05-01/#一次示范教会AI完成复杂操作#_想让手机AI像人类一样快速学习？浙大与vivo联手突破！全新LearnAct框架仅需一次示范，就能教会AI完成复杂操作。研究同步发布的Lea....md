...
浙江大学与vivo AI lab合作开发了LearnAct框架，仅需一次示范即可教会AI完成复杂手机操作。该研究同步发布了LearnGUI基准测试，首次构建了移动端示范学习的评估体系，为AI智能体的实际应用提供了关键技术支持。项目由浙大硕士生刘广义、赵鹏翔（共同一作）和vivo算法专家刘亮主导，浙大孟文超研究员担任通讯作者。这项突破使手机AI能像人类一样快速学习复杂任务操作。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T09:02:56Z
- **目录日期**: 2025-05-01
