...
浙江大学与vivo合作开发了LearnAct框架，仅需一次示范即可教会AI完成复杂操作。该研究同时发布了LearnGUI基准，首次构建了移动端示范学习的评估体系，为AI智能体的实际应用提供了关键技术。研究团队来自浙江大学和vivo AI Lab，共同第一作者为刘广义和赵鹏翔，项目负责人为刘亮，通信作者为孟文超研究员。这一突破使手机AI能快速学习并执行复杂任务，推动了大语言模型驱动的GUI智能体技术的发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T18:02:57Z
- **目录日期**: 2025-05-01
