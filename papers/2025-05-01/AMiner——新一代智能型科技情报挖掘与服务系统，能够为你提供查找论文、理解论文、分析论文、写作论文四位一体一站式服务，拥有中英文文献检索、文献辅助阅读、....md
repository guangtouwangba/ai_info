...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析和写作一站式服务。它支持中英文文献搜索，拥有3.5亿论文、0.6亿学者等海量数据，并能通过AI生成摘要、辅助阅读和智能问答。用户可订阅个性化科研动态，追踪机构、学者和关键词，通过微信或邮件接收最新资讯。此外，AMiner还提供学者画像、学术会议和论文排行榜等功能，浏览器版可免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T21:05:15Z
- **目录日期**: 2025-05-01
