...
AMiner是一个智能科技情报挖掘系统，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献搜索，拥有3.5亿论文、0.6亿学者等海量数据，并能通过AI生成摘要和问答辅助理解。平台还提供文献翻译、科研动态订阅（按用户偏好推送最新研究）、学者画像等功能，支持PDF上传和交互式提问。用户可通过网页或微信小程序免费使用其核心功能，帮助高效获取和管理学术信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T11:05:36Z
- **目录日期**: 2025-05-01
