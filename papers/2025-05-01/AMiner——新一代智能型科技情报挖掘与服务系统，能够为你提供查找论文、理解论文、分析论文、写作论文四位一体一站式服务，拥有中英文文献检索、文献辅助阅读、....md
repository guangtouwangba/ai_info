...
AMiner是一个智能科技情报挖掘系统，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献搜索、AI辅助阅读、自动摘要生成和翻译功能，涵盖3.5亿论文和1.5亿专利等海量学术资源。用户可通过互动问答快速理解文献内容，还能订阅个性化科研动态推送。平台还提供学者画像、学术会议等特色功能，基础服务免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T20:05:09Z
- **目录日期**: 2025-05-01
