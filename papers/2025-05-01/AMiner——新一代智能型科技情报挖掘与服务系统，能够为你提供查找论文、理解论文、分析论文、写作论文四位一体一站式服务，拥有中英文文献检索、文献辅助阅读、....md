...
AMiner是一个智能科技情报平台，提供论文检索、阅读辅助、翻译和科研订阅等一站式服务。它包含3.5亿论文、0.6亿学者和1.5亿专利数据，支持中英文文献搜索、AI生成摘要、互动问答及文档翻译。用户可订阅个性化科研动态，跟踪机构、学者或关键词的最新研究。平台还提供学者画像、学术会议和论文排行榜等功能，基础服务免费开放。访问入口：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T15:05:33Z
- **目录日期**: 2025-05-01
