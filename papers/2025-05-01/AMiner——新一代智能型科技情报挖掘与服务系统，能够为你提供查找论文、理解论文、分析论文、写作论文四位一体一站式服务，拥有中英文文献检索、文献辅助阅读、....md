...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索（覆盖42个学科3.5亿论文）、AI辅助阅读（自动生成摘要、章节概要和问答）、文档翻译及科研情报订阅（按需推送最新研究）。用户可通过关键词、学者或机构定制内容，并通过微信或邮件接收。平台还支持学者画像、学术会议追踪和论文排行榜功能，基础服务免费开放。网址：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T01:32:51Z
- **目录日期**: 2025-05-01
