...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、科研情报订阅等一站式服务。它能帮助用户快速定位相关论文，生成摘要和章节概要，并通过智能问答辅助理解文献内容。平台还支持个性化订阅，根据用户关注的学者、机构或关键词推送最新科研动态。此外，AMiner还提供学者画像、学术会议和必读论文专题等功能。该平台收录了3.5亿论文、0.6亿学者和1.5亿专利等海量数据，可通过浏览器免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T12:05:27Z
- **目录日期**: 2025-05-01
