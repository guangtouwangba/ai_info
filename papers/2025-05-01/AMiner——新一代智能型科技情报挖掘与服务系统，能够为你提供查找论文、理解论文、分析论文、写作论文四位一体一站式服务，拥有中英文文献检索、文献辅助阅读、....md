...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、辅助阅读、翻译和科研情报订阅。其核心功能包括：1）高效检索3.5亿论文资源，支持智能问答和自动摘要生成；2）AI驱动的文献解析，可上传PDF获取章节概要和内容问答；3）个性化订阅服务，通过微信/邮件推送最新研究动态。平台覆盖42个学科，整合论文、学者、专利和科研项目数据，支持免费基础使用，旨在提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T09:05:32Z
- **目录日期**: 2025-05-01
