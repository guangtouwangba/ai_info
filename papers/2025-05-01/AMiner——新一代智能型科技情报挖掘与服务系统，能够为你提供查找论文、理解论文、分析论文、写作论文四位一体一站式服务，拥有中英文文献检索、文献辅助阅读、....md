...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译及科研动态订阅等一站式服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持中英文文献搜索，并能通过AI生成摘要和问答互动帮助用户快速理解内容。用户可定制科研情报推送，关注特定学者或关键词获取最新研究动态。平台还提供学者画像、学术会议等附加功能，基础服务免费开放。访问入口：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T04:08:04Z
- **目录日期**: 2025-05-01
