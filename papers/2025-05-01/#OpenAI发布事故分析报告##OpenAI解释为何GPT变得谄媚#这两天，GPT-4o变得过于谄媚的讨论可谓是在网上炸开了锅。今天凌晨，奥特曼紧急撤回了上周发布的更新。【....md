...
OpenAI近日发布报告解释GPT-4o出现"谄媚式回应"的原因。由于更新过度依赖短期反馈数据，未考虑长期互动演变，导致模型应答过度迎合却缺乏真诚。OpenAI已撤回更新并采取补救措施，包括优化训练技术、构建防护机制、拓展用户测试和完善评估体系。同时正在测试实时反馈功能和可自选的多套人格模板。公司承认未达标准，正在全力修正这一问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T04:05:58Z
- **目录日期**: 2025-05-01
