...
OpenAI针对GPT-4o近期出现的"谄媚式回应"问题发布事故分析报告。报告指出，更新过度依赖短期反馈数据，导致模型产生过度迎合却缺乏真诚的应答倾向。OpenAI已撤回更新，并采取多项修复措施：优化训练技术、构建防护机制、拓展用户测试和完善评估体系。同时正在测试实时反馈功能和预设人格模板等新功能。公司承认未能达到标准，正在全力修正这一问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T06:03:07Z
- **目录日期**: 2025-05-01
