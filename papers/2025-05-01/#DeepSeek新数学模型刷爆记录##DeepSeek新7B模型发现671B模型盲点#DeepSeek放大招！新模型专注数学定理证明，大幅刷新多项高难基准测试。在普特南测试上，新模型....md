...
DeepSeek推出新数学证明模型DeepSeek-Prover-V2，在普特南测试中以49道题刷新纪录，远超当前最佳模型（10道题）。特别值得注意的是，7B参数的小模型通过强化学习发现了671B大模型未掌握的解题方法，成功解决了13个大模型无法处理的问题，尤其在有限基数问题上展现出独特推理模式。该模型基于V1.5-Base微调后强化训练而成，体现了小模型自主发展新能力的特点。这一突破展示了模型规模并非性能的唯一决定因素，强化学习可能激发意料之外的智能涌现。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T21:02:34Z
- **目录日期**: 2025-05-01
