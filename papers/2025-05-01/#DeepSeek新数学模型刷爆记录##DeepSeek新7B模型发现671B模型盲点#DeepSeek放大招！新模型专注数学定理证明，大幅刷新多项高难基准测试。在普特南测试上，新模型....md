...
DeepSeek发布新数学证明模型DeepSeek-Prover-V2，在普特南测试中取得49道题的新纪录，远超当前最佳模型（10道）。特别值得注意的是，7B参数的小模型通过强化学习发现了671B大模型未掌握的解题技能，成功解决了13个大模型未能处理的问题。研究发现7B模型在处理有限基数问题时采用了独特方法，而大模型输出中未见类似策略。该模型基于DeepSeek-Prover-V1.5-Base微调后经强化学习训练获得，展示了小模型通过特定训练可超越大模型特定能力的现象。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T13:09:23Z
- **目录日期**: 2025-05-01
