...
DeepSeek推出的新数学模型DeepSeek-Prover-V2在数学定理证明领域取得突破，在普特南测试中以49道题的解答刷新纪录，远超此前Kimi-Prover的10道题表现。值得注意的是，7B参数的小模型通过强化学习发现了671B大模型未掌握的解题技能，在有限基数问题上展现出独特推理模式。该模型基于V1.5-Base改进，先使用大模型数据进行微调，再通过强化学习获得新能力。研究表明小模型可以自主发展出超越大模型的新技能，为AI发展提供了新思路。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T10:02:37Z
- **目录日期**: 2025-05-01
