...
DeepSeek发布新数学模型DeepSeek-Prover-V2，在普特南数学测试中取得49道题的突破性成绩，远超当前冠军模型（10道）。特别值得注意的是，7B参数的小模型通过强化学习发现了671B大模型未掌握的解题方法，成功解决了13个大模型未能攻克的题目。研究发现，小模型在处理有限基数问题时采用了独特的数学工具（Cardinal.toNat等），而大模型输出中完全缺失这种模式。该成果展示了小模型通过特定训练可能获得超越大模型的新能力。论文还揭示了强化学习带来的"新技能涌现"现象。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T19:02:26Z
- **目录日期**: 2025-05-01
