...
DeepSeek发布新数学模型DeepSeek-Prover-V2，在普特南测试中创下49道题的新纪录，远超当前第一名（10道）。值得注意的是，7B参数的小模型通过强化学习发现了671B大模型的盲点，解决了13个大模型未能解决的问题，展现出独特的有限基数处理能力。该模型基于DeepSeek-Prover-V1.5-Base微调，并利用671B模型的强化学习数据训练，最终自主掌握了更大模型不具备的新技能。这一突破展示了小模型在特定领域的潜力，为AI推理能力发展提供了新思路。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T17:02:35Z
- **目录日期**: 2025-05-01
