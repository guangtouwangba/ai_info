...
DeepSeek发布的新数学模型DeepSeek-Prover-V2在数学定理证明领域取得突破，以49道题的优异表现刷新普特南测试记录，远超此前Kimi-Prover的10道题成绩。值得注意的是，7B参数的小模型通过强化学习发现了671B大模型未掌握的解题技能，在有限基数问题上展现出独特推理模式。该模型基于V1.5-Base微调后，利用671B模型数据进行强化学习训练，最终实现了参数更小但性能更强的突破，为AI数学推理领域带来新进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T12:02:38Z
- **目录日期**: 2025-05-01
