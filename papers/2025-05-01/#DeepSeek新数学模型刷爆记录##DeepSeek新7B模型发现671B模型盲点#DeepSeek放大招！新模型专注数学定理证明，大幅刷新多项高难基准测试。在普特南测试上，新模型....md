...
DeepSeek发布新数学模型DeepSeek-Prover-V2，在普特南测试中刷新记录，解答49道题，远超当前最佳模型（10道）。特别值得注意的是，7B参数的小模型通过强化学习发现了671B大模型未掌握的技能，解决了13个大模型无法处理的问题，尤其在有限基数问题上表现出独特推理模式。该模型基于V1.5-Base微调并强化学习训练，展现了"小模型超越大模型"的新现象。团队称这一突破为"啊哈时刻"，突显了AI在数学定理证明中的潜力。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T15:02:32Z
- **目录日期**: 2025-05-01
