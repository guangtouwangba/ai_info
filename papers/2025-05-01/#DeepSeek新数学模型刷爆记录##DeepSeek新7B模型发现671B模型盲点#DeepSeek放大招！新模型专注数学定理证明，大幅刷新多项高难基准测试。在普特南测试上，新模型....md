...
DeepSeek发布新数学模型DeepSeek-Prover-V2，在普特南测试中取得49道题的好成绩，远超当前第一名（10道题）。值得注意的是，7B参数的小模型通过强化学习发现了671B大模型未掌握的数学推理技能，成功解决了13个大模型无法处理的问题，尤其在有限基数问题上表现出独特方法。该模型基于DeepSeek-Prover-V1.5-Base微调并强化训练，展现了"小模型发现新能力"的突破。这一成果刷新多项数学基准测试记录，并揭示了模型规模并非决定性能的唯一因素。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T05:02:23Z
- **目录日期**: 2025-05-01
