...
DeepSeek发布新数学推理模型DeepSeek-Prover-V2，在普特南测试中以49道解题数刷新记录（原纪录10道）。研究发现，7B参数的小模型通过强化学习掌握了671B大模型不具备的新技能——在有限基数问题中采用独特推理方法（如Cardinal.toNat），成功解决13个大模型未攻克的题目。该模型基于V1.5-Base微调后，利用大模型训练数据进行强化学习，最终实现"小模型发现大模型盲点"的突破。团队称这一现象为"通过强化学习发现新技能"，展示了模型自主能力的发展潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T07:02:32Z
- **目录日期**: 2025-05-01
