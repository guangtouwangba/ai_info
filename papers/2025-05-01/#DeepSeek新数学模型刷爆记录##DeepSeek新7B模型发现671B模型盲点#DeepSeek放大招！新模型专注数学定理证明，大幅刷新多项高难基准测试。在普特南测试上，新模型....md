...
DeepSeek发布新数学模型DeepSeek-Prover-V2，在普特南测试中取得49道题的好成绩，远超当前第一名（10道）。值得注意的是，7B小模型通过强化学习发现了671B大模型未掌握的数学推理技能，成功解决了13个大模型无法处理的问题，尤其在有限基数问题上表现出独特推理模式。该模型基于V1.5-Base微调并强化学习训练而成，展现了"小模型超越大模型"的突破性能力。团队称其推理方法带来意外惊喜，未发布的R2版本更受期待。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T14:02:31Z
- **目录日期**: 2025-05-01
