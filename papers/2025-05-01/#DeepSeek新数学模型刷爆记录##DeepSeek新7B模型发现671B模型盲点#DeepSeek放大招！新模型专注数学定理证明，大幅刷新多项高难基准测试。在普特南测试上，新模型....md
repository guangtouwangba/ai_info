...
DeepSeek推出新数学模型DeepSeek-Prover-V2，在普特南测试中取得49道题的好成绩，远超当前第一名的10道题。令人惊讶的是，7B参数的小模型通过强化学习发现了671B大模型的盲点，解决了13个大模型未能解决的问题，尤其在有限基数问题上表现出独特推理模式。该模型基于DeepSeek-Prover-V1.5-Base微调并强化学习而成，展现了自主发现新技能的能力。这一突破为未发布的R2模型带来更多期待。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T22:02:29Z
- **目录日期**: 2025-05-01
