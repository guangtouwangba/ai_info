...
DeepSeek推出的新数学模型DeepSeek-Prover-V2在数学定理证明领域表现突出，刷新多项基准测试记录。在普特南测试中，该模型解答了49道题，远超当前第一名的10道。值得注意的是，参数量仅7B的模型通过强化学习发现了671B大模型未掌握的技能，解决了13个大模型未能处理的问题，尤其在有限基数问题上展现出独特推理模式。该模型基于强化学习微调，展示了小模型自主发展新能力的特点，为AI数学推理开辟了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T20:02:28Z
- **目录日期**: 2025-05-01
