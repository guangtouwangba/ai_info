...
DeepSeek发布新数学模型DeepSeek-Prover-V2，在普特南测试中创下49道题的新纪录，远超当前第一名Kimi-Prover的10道题表现。值得注意的是，7B小模型通过强化学习发现了671B大模型未掌握的数学推理技能，解决了13个大模型无法处理的问题。研究发现7B模型在处理有限基数问题时采用了独特的推理方法，而这一能力是在基于大模型数据微调后自主涌现的。该突破展示了小模型通过特定训练可能超越大模型的新可能性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T06:02:27Z
- **目录日期**: 2025-05-01
