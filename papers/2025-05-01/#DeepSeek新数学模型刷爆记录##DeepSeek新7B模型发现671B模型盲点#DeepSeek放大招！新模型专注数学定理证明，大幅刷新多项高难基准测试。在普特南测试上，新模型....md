...
DeepSeek推出的新数学模型DeepSeek-Prover-V2在数学定理证明领域取得突破，刷新多项高难度基准测试记录。在普特南测试中，该模型解决了49道题，远超当前第一名（10道题）。值得注意的是，参数量仅7B的版本通过强化学习发现了671B大模型未能掌握的解题方法，在有限基数问题上展现出独特推理模式。这表明小模型也能通过训练获得超越大模型的新能力。该成果展示了强化学习在数学推理中的潜力，同时为未来模型优化提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T11:02:35Z
- **目录日期**: 2025-05-01
