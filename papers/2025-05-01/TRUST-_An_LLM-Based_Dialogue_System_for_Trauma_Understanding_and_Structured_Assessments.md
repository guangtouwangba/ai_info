...
本研究开发了名为TRUST的LLM对话系统框架，用于标准化创伤后应激障碍(PTSD)诊断访谈。该系统采用协作式LLM模块和专门设计的对话行为模式来模拟临床医生行为，并通过基于真实访谈记录的模拟患者方法进行测试。评估表明，TRUST在专业评审中表现与真实临床访谈相当，达到普通临床医生水平，但在沟通方式和应答适当性方面仍有改进空间。该框架展现了提升心理健康服务可及性的潜力。研究填补了LLM在标准化诊断访谈领域的应用空白，为未来优化奠定了基础。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T20:01:00Z
- **目录日期**: 2025-05-01
