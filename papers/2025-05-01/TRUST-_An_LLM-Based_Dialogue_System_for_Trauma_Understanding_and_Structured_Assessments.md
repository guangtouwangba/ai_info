...
本研究开发了TRUST框架，利用大语言模型（LLM）构建对话系统，用于创伤后应激障碍（PTSD）的标准诊断访谈和评估。该系统通过特定设计的对话行为模式生成临床响应，并基于真实访谈记录开发患者模拟方法以减少人工测试成本。专家评估表明，TRUST在临床访谈中的表现与真实医生相当，尽管在沟通风格和响应适当性方面仍有改进空间。该框架展现了提升心理健康服务可及性的潜力，为未来优化奠定了基础。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T03:21:11Z
- **目录日期**: 2025-05-01
