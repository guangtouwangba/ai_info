...
本研究开发了TRUST框架，这是一种基于大型语言模型（LLM）的对话系统，用于创伤后应激障碍（PTSD）的标准诊断访谈和评估。该框架包含协作式LLM模块，采用专门设计的对话行为模式生成临床响应，并通过基于真实访谈记录的模拟患者方法进行测试。专家评估表明，TRUST的表现与真实临床访谈相当，达到普通临床医生水平，但在沟通方式和响应适当性方面仍有改进空间。该研究为提升心理健康服务的可及性提供了新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T07:01:05Z
- **目录日期**: 2025-05-01
