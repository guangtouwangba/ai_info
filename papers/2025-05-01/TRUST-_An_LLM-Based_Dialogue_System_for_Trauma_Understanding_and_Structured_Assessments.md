...
本研究开发了TRUST框架，一种基于大语言模型（LLM）的对话系统，用于创伤后应激障碍（PTSD）的标准诊断访谈和评估。该框架包含协作式LLM模块，采用专门设计的临床访谈对话行为模式生成适当回应，并通过真实访谈记录构建患者模拟来替代人工测试。专家评估表明，TRUST在临床访谈中的表现与真实医生相当，达到平均水平，但在沟通方式和回应适当性方面仍有改进空间。该研究为提升心理健康服务的可及性提供了新途径，展示了LLM在标准化诊断访谈中的应用潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T16:01:22Z
- **目录日期**: 2025-05-01
