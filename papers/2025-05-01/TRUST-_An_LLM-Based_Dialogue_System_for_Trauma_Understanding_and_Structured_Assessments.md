...
本研究开发了TRUST框架，一种基于大语言模型（LLM）的对话系统，用于创伤后应激障碍（PTSD）的标准诊断访谈和评估。该框架包含协作式LLM模块，采用专门设计的临床对话行为模式生成适当响应，并通过基于真实访谈记录的病人模拟方法进行测试。专家评估表明，TRUST的表现与真实临床访谈相当，达到普通临床医生水平，未来可在沟通风格和响应适切性方面继续优化。该研究为提升心理健康服务可及性提供了新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T21:01:07Z
- **目录日期**: 2025-05-01
