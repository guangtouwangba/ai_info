...
本研究开发了TRUST框架，一种基于大语言模型（LLM）的对话系统，用于创伤后应激障碍（PTSD）的标准诊断访谈和评估。该系统通过专门设计的临床访谈对话行为模式生成适当响应，并采用基于真实访谈记录的病人模拟方法进行测试。专家评估表明，TRUST在临床访谈中的表现与真实医生相当，达到了普通医生水平，但在沟通风格和响应适当性方面仍有改进空间。该框架展现了提升心理健康服务可及性的潜力，为未来优化奠定了基础。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T22:01:07Z
- **目录日期**: 2025-05-01
