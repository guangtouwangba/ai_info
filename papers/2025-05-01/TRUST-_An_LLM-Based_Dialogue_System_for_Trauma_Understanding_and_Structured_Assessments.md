...
本研究开发了TRUST框架，一种基于大语言模型（LLM）的对话系统，用于创伤后应激障碍（PTSD）的标准诊断访谈和评估。该框架通过协作式LLM模块模拟临床医生行为，并设计了专门的对话行为模式指导临床反应生成。采用基于真实访谈记录的病人模拟方法替代人工测试。专家评估表明，TRUST系统表现接近真实临床访谈水平，虽在沟通风格和反应适当性方面仍有改进空间，但展现了提升心理健康服务可及性的潜力。研究为LLM在标准化临床访谈中的应用提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T08:01:08Z
- **目录日期**: 2025-05-01
