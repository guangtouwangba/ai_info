...
该研究开发了名为TRUST的LLM对话系统框架，用于创伤后应激障碍(PTSD)的标准诊断访谈和评估。该系统包含协作式LLM模块，采用专门设计的临床访谈对话行为模式生成适当回应，并通过基于真实访谈记录的病人模拟方法进行测试。专家评估表明，TRUST的表现与真实临床访谈相当，达到普通临床医生水平，但在沟通方式和回应适当性方面仍有改进空间。该框架展现了提升心理健康服务可及性的潜力，为填补该领域的技术空白提供了解决方案。(100字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T11:01:03Z
- **目录日期**: 2025-05-01
