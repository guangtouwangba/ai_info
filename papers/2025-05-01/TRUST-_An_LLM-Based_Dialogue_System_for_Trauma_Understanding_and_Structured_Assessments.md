...
本研究开发了TRUST框架，一种基于大语言模型（LLM）的对话系统，用于创伤后应激障碍（PTSD）的标准诊断访谈和评估。该框架包含协作式LLM模块，采用专为临床访谈设计的对话行为模式生成适当响应，并通过基于真实访谈记录的模拟患者方法进行测试。专家评估表明，TRUST在临床访谈中的表现与真实医生相当，达到了普通医生水平，但在沟通风格和响应适当性方面仍有改进空间。该研究为提升心理健康服务的可及性提供了新途径，展示了LLM在标准化诊断中的应用潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T13:07:44Z
- **目录日期**: 2025-05-01
