...
本研究开发了TRUST框架，一种基于大型语言模型（LLM）的对话系统，用于创伤后应激障碍（PTSD）的标准诊断访谈和评估。该框架通过协作式LLM模块模拟临床医生行为，并采用专为临床访谈设计的对话行为模式生成适当回应。研究采用基于真实访谈记录的病人模拟方法进行评估，专家评审表明TRUST的表现与真实临床访谈相当。系统达到普通临床医生水平，未来可在沟通方式和回应适当性方面改进。TRUST框架展现了提升心理健康服务可及性的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T18:01:15Z
- **目录日期**: 2025-05-01
