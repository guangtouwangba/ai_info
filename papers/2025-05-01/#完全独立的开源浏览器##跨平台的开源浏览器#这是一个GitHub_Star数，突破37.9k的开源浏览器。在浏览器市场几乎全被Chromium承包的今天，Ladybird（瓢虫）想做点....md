...
Ladybird是一款完全独立开发的开源浏览器，采用C++从零编写引擎，不依赖Chromium、Firefox或WebKit。其目标是打造符合现代标准的跨平台浏览器，坚持非营利模式，靠赞助运营，拒绝广告和商业变现。目前拥有7名全职工程师，GitHub star超37.9k，代码量近50万行，JS引擎合规性排名第二。虽未完全成熟，但已能处理GitHub issues等基础任务，体现了对浏览器市场多元化的探索。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T02:33:49Z
- **目录日期**: 2025-05-01
