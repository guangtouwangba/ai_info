...
Ladybird是一款完全独立开发的开源浏览器，不依赖Chromium、Firefox或WebKit，引擎和JS引擎均从零开始用C++编写。其目标为打造符合现代Web标准、跨平台的独立浏览器，由非营利组织运营，仅靠赞助和捐款维持。目前已有7名全职工程师，支持者包括GitHub联合创始人等。浏览器功能持续完善，已能处理日常任务，JS引擎合规性排名第二。代码量近50万行，贡献者超1000人。官网：ladybird.org，GitHub：github.com/LadybirdBrowser/ladybird。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T11:03:58Z
- **目录日期**: 2025-05-01
