...
Ladybird是一款完全独立开发的开源浏览器，从底层引擎到JS引擎均采用C++自主编写，不依赖Chromium、Firefox或WebKit。该项目由非营利组织运营，完全依靠赞助和捐款维持，承诺永不商业化。目前已有7名全职工程师，支持者包括GitHub联合创始人等。尽管尚未完全成熟，但已在JS引擎合规性测试中排名第二（仅次于Firefox），代码量达50万行，贡献者超1000人。其目标是打造符合现代标准的跨平台浏览器，专注核心功能而非商业扩张。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T22:03:38Z
- **目录日期**: 2025-05-01
