...
Ladybird是一款完全独立开发的开源浏览器，不依赖Chromium、Firefox或WebKit，从底层引擎到JS引擎均自主用C++编写。其目标为打造符合现代Web标准、跨平台的浏览器，由非营利组织运营，仅靠赞助维持，承诺永不商业化。目前拥有7名全职工程师，GitHub星标37.9k，代码量近50万行，JS引擎合规性排名第二。尽管尚未完全成熟，但已能处理基础网络任务，体现了对浏览器市场多元化的探索。官网：ladybird.org，GitHub开源可参与。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T06:03:36Z
- **目录日期**: 2025-05-01
