...
Ladybird是一款完全独立开发的开源浏览器，不依赖Chromium、Firefox或WebKit，所有引擎均从零开始用C++编写。其目标是为现代网络标准提供跨平台的独立浏览器解决方案，由非营利组织Ladybird Browser Initiative运营，完全依靠赞助和捐款维持。目前已有7名全职工程师，支持者包括GitHub联合创始人等。尽管尚未完全成熟，但其JS引擎合规性已排名第二（仅次于Firefox），代码量近50万行，贡献者超1000人。该项目承诺永不商业化，专注于浏览器本身的发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T04:06:28Z
- **目录日期**: 2025-05-01
