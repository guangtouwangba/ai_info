...
Ladybird是一款完全独立的开源浏览器项目，采用C++从零编写，不依赖Chromium、Firefox或WebKit。该项目由非营利组织Ladybird Browser Initiative运营，完全依靠赞助和捐款，承诺永不商业化。目前已有7名全职工程师，支持者包括GitHub联合创始人等。虽然尚未完全成熟，但已能处理日常任务，在JS引擎合规性测试中排名第二，代码量达50万行，贡献者超1000人。目标是打造符合现代Web标准、跨平台的独立浏览器，官网和GitHub均已开放。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T13:10:44Z
- **目录日期**: 2025-05-01
