...
Ladybird是一款完全独立开发的开源浏览器，不依赖Chromium、Firefox或WebKit，而是从零开始用C++编写自己的底层引擎和JS引擎。该项目由非营利组织Ladybird Browser Initiative运营，完全依靠赞助和捐款，承诺永不商业化。目前已有7名全职工程师，支持者包括GitHub联合创始人等。虽然仍在开发中，但已展现出潜力，JS引擎合规性排名第二（仅次于Firefox），代码量达50万行。目标是打造符合现代Web标准、跨平台且真正独立的浏览器。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T00:03:06Z
- **目录日期**: 2025-05-01
