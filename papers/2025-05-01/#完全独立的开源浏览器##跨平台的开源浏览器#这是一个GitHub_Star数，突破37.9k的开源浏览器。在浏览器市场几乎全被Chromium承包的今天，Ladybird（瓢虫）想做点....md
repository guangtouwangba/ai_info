...
Ladybird是一款完全独立开发的开源浏览器，不依赖Chromium、Firefox或WebKit，所有底层引擎和JS引擎均自主开发。该项目由非营利组织Ladybird Browser Initiative运营，依靠赞助和捐款维持，承诺永不商业化。目前已有7名全职工程师，支持者包括GitHub联合创始人等。尽管尚未完全成熟，但已能处理日常任务，并在JS引擎合规性测试中排名第二。代码量近50万行，贡献者超1000人。目标是打造符合现代Web标准、跨平台的独立浏览器。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T16:04:10Z
- **目录日期**: 2025-05-01
