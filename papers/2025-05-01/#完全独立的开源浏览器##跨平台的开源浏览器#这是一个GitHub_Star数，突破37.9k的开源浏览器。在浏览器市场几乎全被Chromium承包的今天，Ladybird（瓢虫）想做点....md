...
Ladybird是一款完全独立开发的开源浏览器，不依赖Chromium、Firefox或WebKit，所有底层引擎和JS引擎均从零开始用C++编写。该项目由非营利组织Ladybird Browser Initiative运营，完全依靠赞助和捐款维持，承诺永不商业化。目前已有7名全职工程师，支持者包括GitHub联合创始人等。浏览器已能处理日常任务，在Web Platform Tests中JS引擎合规性排名第二，代码量达50万行。目标是打造符合现代标准的跨平台浏览器，强调独立性、专注性和非营利性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T12:03:50Z
- **目录日期**: 2025-05-01
