...
这篇论文提出了一个AI智能体的四维评估框架：自主性、效能、目标复杂性和通用性。每个维度设有不同等级，这些特性差异会影响AI系统的设计、运作和治理。基于此框架，研究者构建了不同AI智能体的"代理特征图谱"，从单一任务助手到高度自主的通用系统，揭示了各类AI带来的跨领域技术与非技术治理挑战。该框架通过明确关键变量，为开发者、政策制定者和公众提供了评估工具，有助于制定更符合社会集体目标的治理方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T23:01:15Z
- **目录日期**: 2025-05-01
