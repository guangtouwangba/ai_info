...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能够模拟超过1万个AI代理的社会互动（500万次交互）。研究者用它研究了四个关键社会问题：社会极化、信息传播、基本收入政策效果和自然灾害影响。该系统模拟结果与现实世界数据吻合，证明其能有效捕捉人类行为机制，可作为社会科学研究和政策制定的创新工具。该平台结合了LLM智能体、真实社会环境和大规模模拟引擎，为传统研究方法（如调查、实验）提供了有力补充。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T10:05:05Z
- **目录日期**: 2025-05-01
