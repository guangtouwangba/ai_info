...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个智能代理及其500万次社会互动。该系统通过真实社会环境研究四大社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。研究显示其模拟结果与现实数据吻合，验证了该系统在揭示人类行为机制方面的有效性。作为计算社会科学工具，AgentSociety能辅助传统研究方法，为社会科学研究和政策制定提供新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T09:05:04Z
- **目录日期**: 2025-05-01
