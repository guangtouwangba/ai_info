...
本文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统，能够模拟1万多个智能代理及其500万次社会互动。该系统作为计算社会科学实验平台，研究了社会极化、信息传播、基本收入政策及自然灾害影响等关键问题。模拟结果与现实数据高度吻合，验证了该系统在揭示人类行为机制方面的有效性，展现了其作为社会科学研究和政策制定工具的潜力。该研究为大语言模型在社会系统建模中的应用提供了重要范例。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T04:07:36Z
- **目录日期**: 2025-05-01
