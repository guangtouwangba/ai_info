...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理及其500万次互动。研究者用它研究四大社会问题：社会极化、信息传播、基本收入政策效果和自然灾害影响。该系统模拟结果与现实数据高度吻合，验证了其捕捉人类行为机制的能力，展示了作为社会科学研究和政策制定工具的潜力。该平台能补充传统研究方法（如调查和访谈），帮助深入理解社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T19:04:34Z
- **目录日期**: 2025-05-01
