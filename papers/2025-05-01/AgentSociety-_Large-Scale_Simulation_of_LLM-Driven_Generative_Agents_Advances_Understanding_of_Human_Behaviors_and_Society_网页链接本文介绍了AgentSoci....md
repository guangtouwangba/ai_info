...
该研究介绍了AgentSociety，这是一个基于大型语言模型的大规模社会模拟器，能够模拟超过1万个代理的社会互动（500万次）。该系统通过四个关键社会问题（如极化现象、信息传播、政策影响和外部冲击）的案例研究，验证了其模拟结果与现实世界实验的一致性。研究表明，AgentSociety不仅能有效捕捉人类行为机制，还可作为社会科学研究和政策制定的有力工具，为理解社会问题提供新的计算实验方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T13:12:02Z
- **目录日期**: 2025-05-01
