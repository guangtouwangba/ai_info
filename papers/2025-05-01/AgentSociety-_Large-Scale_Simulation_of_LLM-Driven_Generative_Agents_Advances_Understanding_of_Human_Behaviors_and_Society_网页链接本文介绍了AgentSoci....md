...
该研究介绍了AgentSociety，一个基于大型语言模型的大规模社会模拟器，能够模拟超过1万个代理的社交互动（500万次）。研究者利用该平台研究了四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，验证了该系统在捕捉人类行为机制方面的有效性。这一工具为社会科学研究和政策制定提供了新方法，能够补充传统研究手段（如调查和访谈），帮助深入理解复杂社会问题的成因和解决途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T16:05:25Z
- **目录日期**: 2025-05-01
