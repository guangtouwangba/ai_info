...
该研究提出了首个针对基于大语言模型(LLMs)的具身AI决策系统的后门攻击框架(BALD)，系统性地探索了攻击面和触发机制。研究者设计了三种攻击方式：词注入、场景操纵和知识注入，针对LLM决策流程的不同环节。实验在自动驾驶和家庭机器人任务中(GPT-3.5/LLaMA2/PaLM2)验证了攻击效果，如使车辆加速撞向障碍物或机器人将刀具放在床上。词和知识注入攻击成功率近100%，场景操纵攻击成功率65%-90%。这些攻击仅需有限系统访问且能抵抗防御措施，揭示了具身LLM系统的严重安全隐患。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T20:02:01Z
- **目录日期**: 2025-05-01
