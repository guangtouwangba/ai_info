...
该研究提出了首个针对基于大语言模型(LLM)的具身AI决策系统的后门攻击框架(BALD)，系统探索了攻击面和触发机制。研究者设计了三种攻击方式：词语注入、场景操纵和知识注入，针对LLM决策流程的不同环节。实验在自动驾驶和家庭机器人任务中测试了GPT-3.5等主流模型，攻击成功率最高可达100%，如使车辆加速撞向障碍物或机器人将刀具放在床上。这些攻击仅需有限系统访问权限，且能抵抗现有防御措施。研究揭示了具身LLM系统的重大安全隐患，亟需加强安全防护。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T11:02:03Z
- **目录日期**: 2025-05-01
