...
大型语言模型（LLMs）在具身AI决策任务中展现了潜力，但微调过程也引入了安全风险。本研究首次提出针对LLM决策系统的后门攻击框架（BALD），探索了三种攻击方式：词注入、场景操纵和知识注入，针对LLM决策流程的不同环节。实验在自动驾驶和家庭机器人任务中测试了GPT-3.5、LLaMA2和PaLM2等模型，攻击成功率高达100%（词/知识注入）和65-90%（场景操纵），且无需系统入侵。这些攻击对现有防御措施表现出强韧性，凸显了具身LLM系统的安全漏洞及防护的紧迫性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T16:02:22Z
- **目录日期**: 2025-05-01
