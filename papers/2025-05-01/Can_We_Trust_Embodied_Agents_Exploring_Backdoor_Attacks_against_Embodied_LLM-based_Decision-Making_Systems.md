...
本文提出了首个针对基于大语言模型(LLM)的具身AI决策系统的后门攻击框架BALD，系统研究了攻击面和触发机制。通过词注入、场景操控和知识注入三种攻击方式，在自动驾驶和家庭机器人任务中对GPT-3.5、LLaMA2和PaLM2等主流模型进行测试，攻击成功率最高可达100%。这些攻击仅需有限系统访问权限，且能绕过防御机制，导致车辆加速撞向障碍物或机器人将刀具放在床上等危险行为。研究揭示了具身LLM系统的重大安全隐患，亟需加强安全防护以降低潜在风险。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T08:02:09Z
- **目录日期**: 2025-05-01
