...
本文提出了首个针对基于大语言模型（LLM）的具身AI决策系统的后门攻击框架BALD，系统研究了攻击面和触发机制。通过词注入、场景操纵和知识注入三种攻击方式，针对LLM决策流程的不同环节进行攻击。实验在自动驾驶和家庭机器人任务中验证了攻击的有效性和隐蔽性，如车辆加速撞向障碍物、机器人将刀具放在床上等。词和知识注入攻击成功率接近100%，仅需有限系统访问权限；场景操纵攻击成功率超65%，最高达90%，且无需运行时入侵。研究揭示了具身LLM系统的严重安全漏洞，亟需防护措施。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T21:02:07Z
- **目录日期**: 2025-05-01
