...
视频游戏是决策算法研究的重要测试平台，但现代游戏的研究成本过高。本研究系统评估了基于预训练视觉编码器（如DINOv2）和端到端训练在《我的世界》《CS:GO》等游戏中的模仿学习效果。结果表明，端到端训练在低分辨率图像和少量演示下仍有效，但预训练编码器能显著提升性能，具体效果因游戏而异。预训练编码器不仅能提高决策能力，还可大幅降低研究成本，使视频游戏决策研究更易普及。该发现为视觉表征选择提供了实用指导。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T06:02:19Z
- **目录日期**: 2025-05-01
