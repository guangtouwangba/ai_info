...
该研究探讨了在视频游戏中使用预训练视觉编码器进行模仿学习的可行性。相比传统的端到端训练方法，研究者系统评估了公开预训练编码器（如DINOv2）在《我的世界》《CS:GO》等游戏中的表现。结果显示，端到端训练虽能在低分辨率图像和少量演示下有效工作，但预训练编码器能显著提升决策性能，且大幅降低训练成本，使更多研究者能开展现代游戏决策研究。不同游戏对编码器的需求存在差异，预训练方法为游戏AI研究提供了更经济高效的解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T17:02:22Z
- **目录日期**: 2025-05-01
