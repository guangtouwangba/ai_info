...
视频游戏是决策智能研究的重要测试平台，但现代游戏的开发成本过高限制了研究进展。本研究系统比较了使用预训练视觉编码器（如DINOv2）与端到端训练方法在《我的世界》《CS:GO》等游戏中的模仿学习效果。结果表明，端到端训练在低分辨率图像和少量演示下仍有效，但预训练编码器能显著提升性能。预训练编码器不仅能提高决策效果，还能大幅降低训练成本，使视频游戏决策研究更易普及。不同游戏的最佳编码器选择存在差异，需根据具体场景权衡。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T23:02:12Z
- **目录日期**: 2025-05-01
