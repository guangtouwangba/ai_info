...
视频游戏是决策AI研究的重要测试平台，但现代游戏的高成本限制了研究进展。本研究系统评估了基于预训练视觉编码器（如DINOv2）和端到端训练在《我的世界》《CS:GO》等游戏中的模仿学习表现。结果表明，端到端训练虽能通过低分辨率图像和少量演示有效学习，但预训练编码器能显著提升性能并降低训练成本。这为游戏决策研究提供了更经济高效的解决方案，使更多研究者能突破传统Atari游戏的局限，推动现代游戏环境下的AI决策研究发展。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T22:02:21Z
- **目录日期**: 2025-05-01
