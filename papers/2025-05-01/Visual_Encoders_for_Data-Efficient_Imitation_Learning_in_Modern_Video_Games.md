...
视频游戏是决策AI研究的重要测试平台，但现代游戏研究常受限于高昂成本。本研究对比了两种视觉编码方法：传统端到端训练与预训练编码器（如DINOv2）在《我的世界》《CS:GO》等游戏中的模仿学习表现。结果显示，端到端训练虽能通过低分辨率图像和少量演示有效学习，但预训练编码器能显著提升性能。后者可大幅降低训练成本，使视频游戏决策研究更易普及。不同游戏的最佳编码方案存在差异，预训练模型为资源有限的研究者提供了可行替代方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-01T04:05:15Z
- **目录日期**: 2025-05-01
