...
ZeroGUI是一个零人工成本的在线学习框架，旨在提升纯视觉GUI代理的自动化训练能力。它通过视觉语言模型（VLM）自动生成多样化任务目标，并利用VLM评估任务完成情况，无需人工标注或定制评估函数。结合两阶段在线强化学习，ZeroGUI能持续从GUI环境中交互学习。实验表明，该框架显著提升了UI-TARS和Aguvis等GUI代理在OSWorld和AndroidLab环境中的性能。ZeroGUI解决了现有离线学习方法依赖人工标注和动态适应性不足的问题，实现了高效、可扩展的自动化训练。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T16:01:12Z
- **目录日期**: 2025-06-01
