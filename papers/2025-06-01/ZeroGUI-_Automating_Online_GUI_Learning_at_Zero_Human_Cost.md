...
ZeroGUI提出了一种零人工成本的在线学习框架，用于训练纯视觉GUI代理。该框架通过视觉语言模型(VLM)自动生成多样化任务目标，并利用VLM进行无人工干预的任务成功评估，结合两阶段在线强化学习持续与环境交互。相比现有离线学习方法，ZeroGUI解决了对人工标注的依赖和动态环境适应性问题。实验表明，在UI-TARS和Aguvis等GUI代理上，ZeroGUI在OSWorld和AndroidLab环境中显著提升了性能。该框架具有可扩展性，代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T13:07:48Z
- **目录日期**: 2025-06-01
