...
ZeroGUI是一个可扩展的在线学习框架，旨在零人工成本下自动化GUI智能体训练。它通过视觉语言模型（VLM）自动生成多样化任务目标，并评估任务成功率，无需人工标注或定制评估函数。该框架采用两阶段在线强化学习，持续与GUI环境交互学习。实验表明，ZeroGUI显著提升了UI-TARS和Aguvis等GUI智能体在OSWorld和AndroidLab环境中的性能，克服了传统离线学习对人工标注的依赖和动态环境适应性不足的问题。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T11:01:06Z
- **目录日期**: 2025-06-01
