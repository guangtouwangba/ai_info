...
ZeroGUI提出了一种零人工成本的在线学习框架，用于训练纯视觉GUI代理。它通过VLM自动生成多样化的任务目标，并利用VLM评估任务完成情况，无需人工标注或定制评估函数。结合两阶段在线强化学习，该框架能持续与环境交互并自主学习。实验表明，ZeroGUI显著提升了UI-TARS和Aguvis等GUI代理在OSWorld和AndroidLab环境中的性能。这一方法解决了现有离线学习框架对人工标注的依赖和动态环境适应性问题，实现了高效、可扩展的GUI代理训练。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T01:29:19Z
- **目录日期**: 2025-06-01
