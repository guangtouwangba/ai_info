...
ZeroGUI是一个创新的在线学习框架，旨在零人工成本下自动化训练视觉语言模型（VLM）驱动的GUI智能体。它通过VLM自动生成多样任务目标，无需人工标注；利用VLM评估任务完成度，避免人工设计评估函数；并采用两阶段在线强化学习持续与环境交互。实验表明，ZeroGUI显著提升了UI-TARS和Aguvis等GUI智能体在OSWorld和AndroidLab环境中的表现，解决了传统离线学习方法依赖人工标注和适应动态环境能力不足的问题。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T04:12:36Z
- **目录日期**: 2025-06-01
