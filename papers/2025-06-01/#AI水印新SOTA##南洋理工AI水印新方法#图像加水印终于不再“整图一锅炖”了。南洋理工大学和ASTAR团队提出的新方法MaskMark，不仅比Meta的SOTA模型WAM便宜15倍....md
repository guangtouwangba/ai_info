...
南洋理工大学与A*STAR团队开发了新型AI水印技术MaskMark，采用"掩码机制"精准定位水印区域，分为全图嵌入(MaskMark-D)和局部嵌入(MaskMark-ED)两种版本。该技术训练成本仅为Meta WAM模型的1/15（单A6000显卡20小时），在高保真度下保持近100%提取准确率，尤其在小区域水印任务上表现突出。它能同时嵌入多个水印，水印定位精度(IoU)优于现有方案，并支持快速微调以适应新型攻击。该技术特别适合人脸、LOGO等局部保护场景。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T14:04:22Z
- **目录日期**: 2025-06-01
