...
南洋理工大学与A*STAR团队提出新型AI水印方法MaskMark，通过掩码机制精准定位水印区域，支持全图或局部嵌入（分D/ED两版本）。相比Meta的WAM模型，训练成本降低15倍（单卡20小时），在高保真度下保持近100%提取准确率，尤其在小区域水印任务中表现突出。意外支持多水印嵌入（如5个），水印定位精度（IoU）超越现有技术。具备快速微调能力，可灵活适应不同比特长度及新型攻击。该成果为图像/人脸/LOGO保护提供了高效解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T05:03:26Z
- **目录日期**: 2025-06-01
