...
南洋理工大学与A*STAR团队提出AI水印新方法MaskMark，采用"掩码机制"精准定位水印区域，分为全图嵌入(MaskMark-D)和局部嵌入(MaskMark-ED)两种版本。该方法在保持高保真度的同时实现接近100%的提取准确率，尤其在小区域水印任务上表现突出，且意外支持多水印嵌入。训练成本仅为Meta WAM模型的1/15（单A6000显卡20小时），效率提升15倍，并具备快速微调能力以应对新型攻击。该技术特别适用于人脸、LOGO等局部保护场景，性能全面超越现有SOTA模型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T11:03:42Z
- **目录日期**: 2025-06-01
