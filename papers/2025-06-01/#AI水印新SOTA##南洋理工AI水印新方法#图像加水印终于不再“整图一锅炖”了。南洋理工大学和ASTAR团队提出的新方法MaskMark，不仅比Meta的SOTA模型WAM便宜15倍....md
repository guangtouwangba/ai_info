...
南洋理工大学与A*STAR团队提出新型AI水印方法MaskMark，采用"掩码机制"精准定位水印区域，分为全图嵌入(MaskMark-D)和区域嵌入(MaskMark-ED)两种版本。该方法在保持高保真度的同时实现近100%提取准确率，尤其在小区域水印任务上显著优于Meta的WAM等现有模型。其训练成本仅为WAM的1/15（单卡A6000训练20小时），支持多水印嵌入和快速对抗适应。性能指标（如IoU）全面超越SOTA，且未针对多水印设计却能同时处理5个水印，为人脸/LOGO保护等场景提供高效解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T18:04:41Z
- **目录日期**: 2025-06-01
