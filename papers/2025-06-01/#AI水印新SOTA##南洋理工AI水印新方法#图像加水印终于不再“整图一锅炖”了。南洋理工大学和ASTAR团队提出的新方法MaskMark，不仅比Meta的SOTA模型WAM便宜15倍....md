...
南洋理工大学与A*STAR团队提出新型AI水印方法MaskMark，通过"掩码机制"实现精准水印嵌入与提取。该方法分两种版本：MaskMark-D支持全图嵌入局部提取，MaskMark-ED专用于指定区域保护（如人脸/LOGO）。相比Meta的WAM模型，训练成本降低15倍（单A6000显卡20小时），在高保真度下仍保持近100%提取准确率，尤其在小区域水印任务中表现突出。意外发现可同时嵌入5个水印无误，水印定位精度(IoU)也优于现有技术，且支持快速微调以适应新型攻击。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T02:44:23Z
- **目录日期**: 2025-06-01
