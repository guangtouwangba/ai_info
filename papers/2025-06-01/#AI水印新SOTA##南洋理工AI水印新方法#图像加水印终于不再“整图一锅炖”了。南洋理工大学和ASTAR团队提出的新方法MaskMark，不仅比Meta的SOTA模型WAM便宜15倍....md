...
南洋理工大学与A*STAR团队提出新型AI水印方法MaskMark，采用"掩码机制"精准定位水印区域，分为全图嵌入(MaskMark-D)和区域嵌入(MaskMark-ED)两种版本。该方法在保持100%提取准确率的同时，训练成本仅为Meta WAM模型的1/15（单卡A6000训练20小时），且支持多水印嵌入。性能表现全面超越现有SOTA，尤其在局部小区域水印任务中优势显著，水印定位精度(IoU)优于WAM和EditGuard，并具备快速适应新攻击的能力。特别适用于人脸、LOGO等敏感内容保护场景。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T09:03:44Z
- **目录日期**: 2025-06-01
