...
南洋理工大学与A*STAR团队提出新型AI水印方法MaskMark，采用"掩码机制"实现精准水印定位，性能全面超越Meta的WAM模型。该方法分两种版本：MaskMark-D支持全图嵌入局部提取，MaskMark-ED专用于指定区域保护。实验显示其在高保真度下提取准确率近100%，水印定位能力显著优于现有技术，意外展现出多水印处理能力。训练成本仅为WAM的1/15，单张A6000显卡20小时即可完成，支持快速微调以适应新型攻击。该成果为图像版权保护提供了更高效精准的解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T12:03:40Z
- **目录日期**: 2025-06-01
