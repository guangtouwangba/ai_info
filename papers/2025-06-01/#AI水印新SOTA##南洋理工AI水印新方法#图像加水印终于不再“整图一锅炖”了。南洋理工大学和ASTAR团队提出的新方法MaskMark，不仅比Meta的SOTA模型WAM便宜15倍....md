...
南洋理工大学与A*STAR团队提出新型AI水印方法MaskMark，通过"掩码机制"实现精准水印定位，性能超越Meta的WAM模型。该方法分两种版本：MaskMark-D支持全图嵌入局部提取，MaskMark-ED专用于指定区域保护（如人脸/LOGO）。实验显示其在高保真度下保持近100%提取准确率，尤其在小区域任务表现突出，单卡训练成本仅为WAM的1/15（20小时完成），且意外支持多水印嵌入（最多5个）。该技术具备快速微调能力，能有效应对新型攻击，成为当前AI水印领域的新SOTA方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T06:02:49Z
- **目录日期**: 2025-06-01
