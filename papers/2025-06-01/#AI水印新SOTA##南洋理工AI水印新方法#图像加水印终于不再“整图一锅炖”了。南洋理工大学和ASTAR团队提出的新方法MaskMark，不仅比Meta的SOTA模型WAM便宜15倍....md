...
南洋理工大学与A*STAR团队提出新型AI水印方法MaskMark，通过"掩码机制"精准控制水印嵌入/提取区域，性能全面超越Meta的WAM模型。该技术分两种版本：全图嵌入局部提取（MaskMark-D）和指定区域嵌入（MaskMark-ED），后者特别适合人脸/LOGO保护。实验显示其在高保真度下保持近100%提取准确率，水印定位能力（IoU指标）显著优于现有方案，意外支持同时嵌入5个水印。训练效率突出：单卡20小时完成，计算成本仅为WAM的1/15，且支持快速微调应对新型攻击。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T21:03:29Z
- **目录日期**: 2025-06-01
