...
南洋理工大学与A*STAR团队提出新型AI水印方法MaskMark，通过"掩码机制"精准定位水印区域，分为全图嵌入(MaskMark-D)和局部嵌入(MaskMark-ED)两种版本。该方法在性能上全面超越Meta的WAM模型，提取准确率接近100%，尤其在小区域水印任务中表现突出，且意外支持多水印嵌入。训练效率显著提升，单张A6000显卡20小时完成，成本仅为WAM的1/15。该方法支持快速微调，能有效应对新型攻击，适用于人脸、LOGO等敏感内容保护。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T23:03:40Z
- **目录日期**: 2025-06-01
