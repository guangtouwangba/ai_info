...
南洋理工大学与A*STAR团队提出新型AI水印方法MaskMark，采用掩码机制实现精准水印定位，性能全面超越Meta的WAM模型。该方法分两种版本：MaskMark-D支持全图嵌入局部提取，MaskMark-ED专用于指定区域保护。实验显示其在高保真度下提取准确率近100%，尤其在微小区域嵌入任务中表现突出，且意外支持多水印同步嵌入。训练效率显著提升，单卡20小时即可完成，计算成本仅为WAM的1/15，并具备快速适应新型攻击的能力。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T10:03:31Z
- **目录日期**: 2025-06-01
