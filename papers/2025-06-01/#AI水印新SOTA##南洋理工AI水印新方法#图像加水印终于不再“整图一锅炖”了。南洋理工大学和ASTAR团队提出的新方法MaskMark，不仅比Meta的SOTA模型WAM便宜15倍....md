...
南洋理工大学与A*STAR团队提出新型AI水印方法MaskMark，通过"掩码机制"实现精准水印定位，性能全面超越Meta的WAM模型。该方法分全图嵌入（MaskMark-D）和区域嵌入（MaskMark-ED）两种版本，在高保真度下保持近100%提取准确率，尤其擅长小区域水印任务。其训练成本仅为WAM的1/15（单卡20小时完成），支持多水印嵌入和快速对抗适应。该技术在人脸/LOGO保护等场景表现突出，定位精度（IoU指标）显著优于现有方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T08:03:31Z
- **目录日期**: 2025-06-01
