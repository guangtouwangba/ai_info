...
Tri Dao团队（Mamba核心作者）最新发布两种高效注意力机制GTA和GLA，专为推理场景优化。实验显示：GTA在中大型模型质量优于GQA，GLA与MLA精度相当但效率更高，在32K/64K长文本处理时吞吐量显著提升，并发能力更强。新技术实现2倍推理加速并降低内存消耗，尤其适合长上下文任务，同时保持生成质量。测试涵盖4种模型规模，评估指标包括困惑度、7项下游任务及解码延迟等效率参数。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T14:03:41Z
- **目录日期**: 2025-06-01
