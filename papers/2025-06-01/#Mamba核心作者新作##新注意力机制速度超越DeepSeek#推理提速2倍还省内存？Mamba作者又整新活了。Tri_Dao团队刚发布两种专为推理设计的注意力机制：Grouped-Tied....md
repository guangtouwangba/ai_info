...
Mamba核心作者Tri Dao团队发布两种新型注意力机制GTA和GLA，专为提升推理效率设计。实验显示，GTA在中大型模型中质量优于GQA，GLA与MLA精度相当但效率更高。新机制在32K/64K长文本处理时吞吐量显著提升，解码速度提高2倍且节省内存，同时增强并发处理能力，特别适合长上下文场景。研究测试了四种模型规模，涵盖困惑度、下游任务表现及延迟/吞吐量等指标，证实新方法在保持生成质量的同时优化了推理性能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T12:02:48Z
- **目录日期**: 2025-06-01
