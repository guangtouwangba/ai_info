...
Tri Dao团队推出两种新型注意力机制GTA和GLA，专为提升推理效率设计。GTA在中大型模型中质量优于GQA，GLA与MLA精度相当但效率更高。测试显示，这两种机制在32K/64K长文本处理时吞吐量显著领先，解码速度提升2倍且节省内存，同时增强并发处理能力，尤其适合长上下文场景。新方法在保持生成质量的同时，显著优化了推理速度和内存利用率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T09:03:01Z
- **目录日期**: 2025-06-01
