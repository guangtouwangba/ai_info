...
Mamba核心作者Tri Dao团队推出两种新型注意力机制GTA和GLA，专为提升推理效率设计。实验显示：GTA在中大型模型中质量优于GQA，GLA在保持精度的同时显著提高效率，尤其擅长处理长文本（32K/64K时吞吐量领先）。新机制使解码速度提升2倍，内存利用率更优，且具备更强并发处理能力，适用于不均衡负载场景。这些改进未牺牲模型生成质量，在困惑度和7个下游任务测试中表现优异。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T21:02:50Z
- **目录日期**: 2025-06-01
