...
Mamba核心作者Tri Dao团队最新发布两种高效注意力机制：GTA和GLA，专为优化推理性能设计。实验显示，GTA在中大型模型中质量优于GQA，GLA则保持MLA精度但效率更高。新方法在32K/64K长文本处理时吞吐量显著提升，解码速度提高2倍且节省内存，尤其擅长处理并发请求和不均衡负载。这些改进在不损失生成质量前提下，为长上下文场景提供了更优解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T15:02:50Z
- **目录日期**: 2025-06-01
