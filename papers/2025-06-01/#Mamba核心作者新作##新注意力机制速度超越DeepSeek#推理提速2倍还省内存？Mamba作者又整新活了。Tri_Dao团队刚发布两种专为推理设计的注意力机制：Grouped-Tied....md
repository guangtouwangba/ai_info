...
Mamba核心作者Tri Dao团队推出两种新型注意力机制GTA和GLA，专为提升推理效率设计。实验显示：GTA在中大型模型质量优于GQA，GLA保持精度的同时显著提升效率，在32K/64K长文本处理中吞吐量领先，并发能力更强。这些改进使解码速度提升2倍并优化内存使用，特别适合长上下文场景，为注意力机制带来突破性进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T20:03:07Z
- **目录日期**: 2025-06-01
