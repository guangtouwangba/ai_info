...
本文提出了一种基于强化学习的自主机器学习(ML)代理框架ML-Agent。该框架包含三个关键创新：(1)探索增强微调，提升代理行动多样性；(2)分步强化学习，加速经验收集；(3)统一的奖励模块，整合不同ML反馈信号。实验表明，仅用7B参数的Qwen-2.5模型在9个ML任务上训练后，性能即超越671B参数的DeepSeek-R1代理，并展现出持续的自我改进能力和出色的跨任务泛化性能。这一成果为学习型ML代理的发展提供了新范式，显著提升了自主机器学习的适应性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T07:01:53Z
- **目录日期**: 2025-06-01
