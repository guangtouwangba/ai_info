...
这篇论文提出了一种基于强化学习(RL)的自主机器学习(ML)代理框架，通过三个创新组件实现：1)增强探索的微调技术促进多样化动作生成；2)分步RL训练提高效率；3)统一的奖励模块整合ML反馈信号。研究使用7B参数的Qwen-2.5模型训练出ML-Agent，仅通过9个ML任务的训练就超越了671B参数的DeepSeek-R1代理，展现出持续性能提升和出色的跨任务泛化能力。该工作首次实现了基于学习的ML代理范式，突破了传统依赖人工提示工程的局限，为自主ML工程开辟了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T16:01:54Z
- **目录日期**: 2025-06-01
