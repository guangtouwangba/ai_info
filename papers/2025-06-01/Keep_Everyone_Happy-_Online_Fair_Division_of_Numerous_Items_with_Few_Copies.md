...
这篇论文研究了一种新型在线公平分配问题，其中学习者需顺序观察不可分割物品并将其分配给多个代理，同时满足公平性和效率约束。现有算法假设物品数量少且有足够副本，但现实中常遇到物品多而副本少的情况（如在线平台的用户多但使用次数少），导致难以准确估计效用。为此，作者提出将效用建模为物品-代理特征的未知函数，并将问题转化为上下文赌博机问题，设计了具有次线性遗憾保证的算法。实验验证了算法的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T03:30:22Z
- **目录日期**: 2025-06-01
