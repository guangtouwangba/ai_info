...
这篇论文针对代码生成大语言模型(codeLLMs)提出创新评估框架，重点解决现有基准忽视人类偏好的问题。研究者构建了CodeArena基准(包含397个高质量样本，覆盖40类编程任务和44种语言)和SynCode-Instruct合成指令集(近200亿标记)，通过实验发现：1)传统执行基准与人类偏好评估存在显著差异；2)开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距明显。研究强调了代码生成模型与人类偏好对齐的重要性，为提升实际编程辅助效果提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T15:05:43Z
- **目录日期**: 2025-06-01
