...
该论文针对代码生成大模型(codeLLMs)提出创新评估框架，指出当前基准测试过于侧重代码正确性而忽视人类偏好。研究者构建了包含397个高质量样本的CodeArena基准测试，覆盖40类编程任务和44种语言，并开发了20B标记量的SynCode-Instruct合成指令数据集。实验发现执行基准与人类偏好评估存在显著差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距明显，凸显了模型与人类编程习惯对齐的重要性。研究为提升代码LLMs的实际适用性提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T22:05:42Z
- **目录日期**: 2025-06-01
