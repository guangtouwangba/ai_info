...
这篇论文针对代码生成大模型(codeLLMs)提出了CodeArena基准测试，通过397个涵盖40类编程任务和44种语言的真实样本，评估模型与人类偏好的对齐程度。研究发现传统执行基准与人类偏好存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。同时构建了20B标记的SynCode-Instruct合成指令集验证微调效果，强调了对齐人类偏好在代码生成中的重要性。研究为提升代码LLMs的实际应用价值提供了新评估维度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T09:05:52Z
- **目录日期**: 2025-06-01
