...
这篇论文探讨了代码生成大模型(codeLLMs)如何更好地与人类偏好对齐。研究者创建了CodeArena基准测试，包含397个高质量编程任务样本，覆盖40个类别和44种语言，更贴近实际开发场景。同时构建了SynCode-Instruct合成指令数据集(近200亿标记)来验证指令微调效果。实验发现传统执行基准与CodeArena存在差异，且开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI)在人类偏好匹配度上有显著差距，凸显了模型对齐的重要性。研究为提升代码生成质量提供了新评估方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T01:33:16Z
- **目录日期**: 2025-06-01
