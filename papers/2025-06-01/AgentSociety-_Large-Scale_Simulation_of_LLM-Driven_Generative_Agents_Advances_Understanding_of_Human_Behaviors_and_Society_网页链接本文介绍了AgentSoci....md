...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟器，能够模拟超过1万个代理的社会生活及500万次互动。研究者用它研究了四个关键社会问题：极化现象、刺激性信息传播、无条件基本收入政策影响和飓风等外部冲击。模拟结果与现实世界实验吻合，验证了该系统捕捉人类行为机制的能力，展示了其作为社会科学研究和政策制定工具的潜力。该平台可辅助传统研究方法，帮助理解社会问题的模式、原因和潜在机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T22:04:59Z
- **目录日期**: 2025-06-01
