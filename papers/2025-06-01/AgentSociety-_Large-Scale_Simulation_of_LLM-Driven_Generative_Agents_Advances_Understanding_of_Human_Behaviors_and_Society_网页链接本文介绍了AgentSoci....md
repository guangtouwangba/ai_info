...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能模拟1万多个AI代理的社会互动（500万次交互）。研究者用它研究四大社会问题：群体极化、信息传播、基本收入政策效果和自然灾害影响。该系统模拟结果与现实数据高度吻合，验证了其捕捉人类行为机制的能力。该平台可作为计算社会科学研究工具，辅助传统调查方法，帮助学者和政策制定者分析社会问题的成因与解决方案。研究展示了AI模拟在社会科学研究中的巨大潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T18:06:09Z
- **目录日期**: 2025-06-01
