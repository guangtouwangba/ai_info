...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理在真实社会环境中的500万次互动。研究者利用该系统研究了四个关键社会问题：社会极化、刺激性信息传播、基本收入政策影响和自然灾害（如飓风）的社会效应。模拟结果与现实世界数据高度吻合，证明该系统能有效捕捉人类行为机制。AgentSociety展示了作为社会科学研究新工具的潜力，可辅助传统研究方法（如调查和干预实验），帮助理解复杂社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T05:05:16Z
- **目录日期**: 2025-06-01
