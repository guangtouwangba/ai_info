...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟超过1万个代理及其500万次互动。研究者用它分析社会极化、信息传播、基本收入政策及外部冲击（如飓风）的影响，结果与现实实验吻合。该系统结合真实社会环境与模拟引擎，能有效捕捉人类行为机制，为社会科学研究和政策制定提供新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T11:05:09Z
- **目录日期**: 2025-06-01
