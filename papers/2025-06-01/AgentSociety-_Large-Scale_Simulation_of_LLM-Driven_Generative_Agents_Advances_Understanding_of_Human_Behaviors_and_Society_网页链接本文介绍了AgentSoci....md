...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统，能够模拟超过1万个代理及其500万次互动。研究者利用该平台研究了社会极化、信息传播、基本收入政策及自然灾害影响等社会问题，结果与现实世界数据吻合。该系统展示了作为社会科学研究工具的强大潜力，可帮助理解人类行为机制并辅助政策制定。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T06:04:42Z
- **目录日期**: 2025-06-01
