...
AgentSociety是一个基于大型语言模型的大规模社会模拟器，可模拟1万多个代理的社会生活及其500万次互动。研究者用它研究了四个社会问题：极化现象、刺激性信息传播、无条件基本收入政策影响和飓风等外部冲击。模拟结果与现实世界实验吻合，验证了该系统捕捉人类行为和社会机制的能力。AgentSociety可作为计算社会科学实验平台，辅助传统研究方法，帮助理解社会问题的模式、原因和机制，为社会科学研究和政策制定提供有力工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T00:04:55Z
- **目录日期**: 2025-06-01
