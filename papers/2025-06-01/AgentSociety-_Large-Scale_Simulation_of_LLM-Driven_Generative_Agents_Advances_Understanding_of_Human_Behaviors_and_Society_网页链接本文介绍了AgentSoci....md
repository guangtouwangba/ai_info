...
本文介绍AgentSociety，一个基于大语言模型的大规模社会模拟器，可模拟1万多个代理及其500万次互动。研究者用它分析四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害冲击。模拟结果与现实数据吻合，验证了该工具捕捉人类行为机制的能力。AgentSociety可作为计算社会科学实验平台，辅助传统研究方法，帮助研究者探索社会问题的模式和成因，为政策制定提供新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T23:04:55Z
- **目录日期**: 2025-06-01
