...
DeepMind开源了一个面向AI的数学猜想题库，采用Lean语言进行形式化处理，使计算机能够理解和验证。该题库旨在为AI提供训练数据，帮助数学家协作验证猜想，并为AI辅助数学研究奠定基础。陶哲轩支持这一项目，认为这是AI协助解决数学难题的重要一步。DeepMind计划结合其AI证明系统AlphaProof，实现AI自主探索和证明数学定理。项目鼓励社区贡献新猜想，推动数学研究的开源协作。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T06:03:05Z
- **目录日期**: 2025-06-01
