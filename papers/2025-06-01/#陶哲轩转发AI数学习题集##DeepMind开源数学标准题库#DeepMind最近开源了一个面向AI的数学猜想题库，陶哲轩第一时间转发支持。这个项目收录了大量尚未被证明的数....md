...
DeepMind开源了一个用Lean语言形式化的数学猜想题库，获陶哲轩转发支持。该题库包含大量未证明的数学猜想，旨在：1）为AI提供标准训练数据；2）构建数学家协作平台；3）建立AI辅助数学研究的基础设施。形式化处理使猜想可编程验证，陶哲轩曾用此方法完成PFR猜想验证。项目鼓励社区贡献新猜想，未来将结合AlphaProof系统实现AI"自主解题"。这标志着AI辅助数学研究的重要进展，项目地址：github.com/google-deepmind/formal-conjectures。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T12:04:02Z
- **目录日期**: 2025-06-01
