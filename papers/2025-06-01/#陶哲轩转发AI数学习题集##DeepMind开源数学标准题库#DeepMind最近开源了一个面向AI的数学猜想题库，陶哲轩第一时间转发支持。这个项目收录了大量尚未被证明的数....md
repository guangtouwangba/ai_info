...
DeepMind开源了一个用Lean语言形式化的数学猜想题库，旨在为AI提供训练数据、为数学家搭建协作平台。该题库收录了未证明的数学猜想，经形式化处理后可供计算机验证。陶哲轩转发支持，认为这是AI辅助数学研究的重要基础设施。项目鼓励社区贡献新猜想，未来将结合AlphaProof系统实现AI自主解题。这一举措可能推动AI参与数学定理发现，为数学研究提供新范式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T14:04:40Z
- **目录日期**: 2025-06-01
