...
DeepMind开源了一个用Lean语言形式化的数学猜想题库，旨在为AI提供训练数据、为数学家搭建协作平台。该题库收录了未证明的数学猜想，经过形式化处理后可供计算机理解验证。陶哲轩转发支持该项目，认为这是AI辅助数学研究的重要一步。DeepMind计划结合其AI证明系统AlphaProof，实现"AI自主解题"的目标。项目鼓励社区贡献新猜想，未来可能推动AI参与数学定理发现。项目地址：github.com/google-deepmind/formal-conjectures。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T17:05:26Z
- **目录日期**: 2025-06-01
