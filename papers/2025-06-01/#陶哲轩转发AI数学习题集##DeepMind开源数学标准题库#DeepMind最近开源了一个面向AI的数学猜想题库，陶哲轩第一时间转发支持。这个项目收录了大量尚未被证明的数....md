...
DeepMind开源了一个用Lean语言形式化的数学猜想题库，旨在为AI训练提供标准数学问题集，同时作为数学家协作和自动定理证明的实验平台。陶哲轩支持该项目，认为这是AI辅助数学研究的重要一步。该题库允许社区贡献新猜想和修正现有内容，未来将与AlphaProof等AI系统结合，推动AI自主解题和发现新定理。项目地址：github.com/google-deepmind/formal-conjectures。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T08:03:53Z
- **目录日期**: 2025-06-01
