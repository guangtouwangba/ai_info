...
DeepMind开源了一个用Lean语言形式化的数学猜想题库，旨在推动AI辅助数学研究。该项目为AI提供标准训练题库，帮助模型理解数学猜想；同时为数学家提供协作平台，支持猜想验证和自动定理证明。陶哲轩转发支持，指出这是AI协助解决数学难题的重要一步。DeepMind计划结合其AI证明系统AlphaProof，实现"找题+解题"的闭环。项目鼓励社区贡献新猜想，未来或能推动AI辅助发现数学新定理。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T07:03:18Z
- **目录日期**: 2025-06-01
