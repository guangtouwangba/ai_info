...
DeepMind开源了一个用Lean语言形式化的数学猜想题库，获得数学家陶哲轩转发支持。该项目为AI提供标准训练题库，帮助理解数学猜想；为数学家搭建协作平台，支持猜想验证与定理证明实验；同时构建AI辅助数学研究的基础设施。陶哲轩曾用类似方法验证PFR猜想，认为这是AI协助解决数学难题的重要一步。DeepMind计划结合其AI证明系统AlphaProof，实现"自动出题+解题"的闭环。项目鼓励社区贡献新猜想，未来可能推动AI辅助发现数学新定理。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T10:03:52Z
- **目录日期**: 2025-06-01
