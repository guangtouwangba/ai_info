...
DeepMind开源了一个AI数学猜想题库，用Lean语言将未证明的数学猜想形式化处理。该题库可训练AI理解数学猜想，为数学家提供合作平台，并构建AI辅助数学研究的基础设施。陶哲轩支持该项目，认为这是AI协助解决数学难题的重要一步。DeepMind鼓励社区贡献新猜想，未来计划结合其AI证明系统AlphaProof，实现AI自主"找题+解题"。项目地址：github.com/google-deepmind/formal-conjectures。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T22:03:56Z
- **目录日期**: 2025-06-01
