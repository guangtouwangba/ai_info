...
DeepMind开源了一个用Lean语言形式化的数学猜想题库，旨在为AI提供训练数据、为数学家搭建协作平台。该题库收录了大量未证明的猜想，经过形式化处理后可供计算机验证。陶哲轩转发支持该项目，认为这是AI辅助数学研究的重要基础设施。DeepMind计划结合其AI证明系统AlphaProof，实现"自动找题+解题"的闭环。项目鼓励社区贡献新猜想，未来可能推动AI辅助发现数学定理。GitHub已开放协作，标志着AI与数学研究融合的新阶段。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T11:04:01Z
- **目录日期**: 2025-06-01
