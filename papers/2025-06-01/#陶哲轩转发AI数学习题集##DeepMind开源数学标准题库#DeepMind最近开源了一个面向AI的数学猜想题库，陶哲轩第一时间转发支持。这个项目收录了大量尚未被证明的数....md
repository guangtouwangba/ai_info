...
DeepMind开源了一个用Lean语言形式化的数学猜想题库，旨在训练AI理解数学问题，并为数学家提供协作平台。该题库包含未证明的猜想，支持社区贡献和修正。陶哲轩转发支持，认为这是AI辅助数学研究的重要基础设施。项目未来计划结合AlphaProof系统，实现AI自主解题。流程开放，鼓励通过GitHub提交新猜想。这一举措可能推动AI参与数学定理发现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T13:10:49Z
- **目录日期**: 2025-06-01
