...
DeepMind开源了一个用Lean语言形式化的数学猜想题库，旨在为AI训练提供标准数学问题集，同时作为数学家协作和自动定理证明的实验平台。陶哲轩转发支持该项目，指出这是AI辅助数学研究的重要基础设施。该题库允许社区贡献新猜想或修正现有内容，未来将与AlphaProof等AI证明系统结合，推动AI自主发现和验证数学定理。项目地址：github.com/google-deepmind/formal-conjectures。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T04:14:33Z
- **目录日期**: 2025-06-01
