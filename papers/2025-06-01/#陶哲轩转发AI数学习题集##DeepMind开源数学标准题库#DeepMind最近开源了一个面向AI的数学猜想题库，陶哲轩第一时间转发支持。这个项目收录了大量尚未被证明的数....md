...
DeepMind开源了一个用Lean语言形式化的数学猜想题库，旨在为AI提供训练数据、为数学家搭建协作平台。该题库收录未证明的数学猜想，支持社区贡献和验证。陶哲轩参与推广并指出这是AI辅助数学研究的重要基础设施。项目未来计划结合AlphaProof系统，实现AI自主解题。流程开放，鼓励通过GitHub提交新猜想。这一举措可能推动AI在数学定理发现中的应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T18:04:58Z
- **目录日期**: 2025-06-01
