...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作一站式服务。它支持中英文文献检索，能通过AI生成摘要和问答互动，帮助用户快速理解论文内容。平台还提供文献翻译、文档识别和科研动态订阅功能，用户可定制关注领域，通过微信或邮件接收最新学术资讯。此外，AMiner包含学者画像、学术会议和论文排行榜等工具，收录3.5亿论文和0.6亿学者数据，基础功能免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T03:33:10Z
- **目录日期**: 2025-06-01
