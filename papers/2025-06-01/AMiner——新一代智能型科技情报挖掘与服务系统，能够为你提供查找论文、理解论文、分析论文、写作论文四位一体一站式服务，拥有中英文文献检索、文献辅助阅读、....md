...
AMiner是一个智能科技情报挖掘系统，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献检索，拥有3.5亿论文、0.6亿学者等海量数据，并提供AI辅助阅读、自动摘要生成和互动问答功能。用户可上传PDF或搜索文献，快速获取摘要和章节概要。平台还支持科研情报订阅，按用户偏好推送最新学术动态。此外，AMiner提供学者画像、学术会议和论文排行榜等功能。基础服务免费，可通过网页或微信小程序使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T22:05:33Z
- **目录日期**: 2025-06-01
