...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析及写作的一站式服务。它支持中英文文献搜索、AI辅助阅读、自动摘要生成和翻译功能，覆盖42个学科的3.5亿论文资源。用户可通过互动问答快速理解文献内容，或订阅个性化科研动态推送。平台还支持PDF上传、章节概要和学者画像分析，帮助高效获取学术信息。免费基础功能可通过浏览器使用，适合科研人员及学生提升文献调研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T19:05:44Z
- **目录日期**: 2025-06-01
