...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析及写作的一站式服务。平台支持中英文文献检索、AI辅助阅读、自动摘要生成和翻译功能，涵盖42个学科的3.5亿论文、0.6亿学者等海量数据。其特色包括交互式问答理解文献、定制化科研情报订阅（通过微信/邮件推送），以及学者画像、学术会议等拓展功能。用户可免费使用浏览器检索，还能上传PDF获得AI生成的摘要和章节概要，显著提升科研效率。访问入口：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T08:05:30Z
- **目录日期**: 2025-06-01
