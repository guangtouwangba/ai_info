...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、辅助阅读、翻译和科研情报订阅。它收录了3.5亿论文、0.6亿学者等海量数据，支持互动问答、自动摘要生成和文档识别功能。用户可定制订阅最新科研动态，还能使用学者画像、学术会议等特色功能。平台通过AI技术提升文献理解与写作效率，支持免费使用，适合科研人员快速获取和管理学术信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T13:12:33Z
- **目录日期**: 2025-06-01
