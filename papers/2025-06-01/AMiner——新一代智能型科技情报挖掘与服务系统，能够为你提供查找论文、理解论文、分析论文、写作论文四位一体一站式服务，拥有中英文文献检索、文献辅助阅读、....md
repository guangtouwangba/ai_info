...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、辅助阅读、AI翻译、论文摘要生成等功能。平台收录3.5亿论文、0.6亿学者等海量学术资源，支持用户通过提问快速理解文献内容，并能定制科研动态订阅服务（通过微信/邮件推送）。其特色功能包含学者画像、学术会议追踪及文献排行榜，浏览器版可免费使用。核心优势在于通过AI技术提升文献检索效率，简化科研信息获取流程。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T07:05:47Z
- **目录日期**: 2025-06-01
