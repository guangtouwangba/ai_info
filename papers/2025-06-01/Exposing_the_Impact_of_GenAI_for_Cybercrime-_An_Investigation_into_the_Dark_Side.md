...
这篇论文通过心理学框架和技术放大理论，实证研究了生成式AI与恶意网络活动及网络犯罪的关联。采用准实验设计和中断时间序列分析，作者分析了两组数据集（一组通用，一组聚焦加密货币），评估了生成式AI在网络犯罪中的作用。研究结果有助于平衡AI治理中的控制与创新，强调需要制定策略指导政策制定者、AI开发者和网络安全专家，并教育公众，以最大化AI的益处同时降低风险。该研究为生成式AI的安全、伦理和双重用途问题提供了实证依据，推动了相关讨论。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T16:01:40Z
- **目录日期**: 2025-06-01
