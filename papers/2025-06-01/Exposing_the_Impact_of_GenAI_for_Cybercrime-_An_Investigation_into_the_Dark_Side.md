...
这篇论文通过心理学框架和技术放大理论，实证研究了生成式AI与恶意网络活动及网络犯罪的关联。研究者采用准实验设计和中断时间序列分析，分析了两组数据集（通用和加密货币相关），评估生成式AI在网络犯罪中的作用。研究结果为AI治理的讨论提供了实证依据，强调需平衡监管与创新，为政策制定者、AI开发者、网络安全专家和公众提供指导，以最大化AI效益并降低风险。研究呼吁制定策略，在促进技术发展的同时有效管控AI的安全与伦理风险。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T20:01:34Z
- **目录日期**: 2025-06-01
