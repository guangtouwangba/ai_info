...
近年来，生成式AI的快速发展和普及引发了对其安全性和伦理风险的广泛讨论，尤其在网络安全领域存在"双刃剑"效应。本研究通过心理学中的技术放大理论和可供性理论框架，首次提供了生成式AI与网络犯罪关联的实证证据。研究者采用准实验设计和间断时间序列分析，通过两个数据集(普通网络和加密货币相关)验证了生成式AI对网络犯罪的影响。研究结果为AI治理提供了新见解，强调需要在管控与创新间取得平衡，为政策制定者、AI开发者、网络安全专家和公众提供指导，以最大化AI效益同时降低风险。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T12:01:34Z
- **目录日期**: 2025-06-01
