...
这项研究系统综述了AI记忆机制，指出大语言模型(LLMs)需要更完整的记忆系统来支持长期交互。记忆分为两类：参数化记忆(内部知识，响应快但难更新)和上下文记忆(显式信息，更灵活)。研究定义了6种核心记忆操作：巩固、更新、索引、遗忘、检索、压缩，这些构成了AI的"记忆肌肉"。该框架为大模型实现人类式记忆能力提供了理论基础，标志着AI从临时工具向具有记忆能力的智能体转变的重要进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T08:03:19Z
- **目录日期**: 2025-06-01
