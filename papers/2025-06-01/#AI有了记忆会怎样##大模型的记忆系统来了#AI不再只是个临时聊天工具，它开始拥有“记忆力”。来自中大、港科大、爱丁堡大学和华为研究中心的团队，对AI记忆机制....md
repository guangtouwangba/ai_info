...
这篇综述研究探讨了大语言模型(LLMs)的记忆系统发展。研究者提出了记忆的两个核心维度：参数化记忆(模型内部知识)和上下文记忆(显式信息)。围绕这些记忆类型，定义了6种关键操作：巩固、更新、索引、遗忘、检索和压缩。这些机制使AI能够处理跨轮对话、多模态输入和个性化偏好，推动LLMs向长期交互的智能体发展。该研究为理解AI记忆系统提供了统一框架，标志着大模型向更接近人类记忆能力的方向迈进。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T12:03:29Z
- **目录日期**: 2025-06-01
