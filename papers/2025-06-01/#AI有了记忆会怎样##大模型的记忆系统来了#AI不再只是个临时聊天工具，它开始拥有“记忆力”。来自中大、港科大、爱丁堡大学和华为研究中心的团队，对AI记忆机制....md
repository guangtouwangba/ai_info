...
中大、港科大等团队发表研究，系统梳理了AI记忆机制。研究指出大语言模型需要更完善的记忆系统来支持长期交互，包括跨轮对话、多模态输入等功能。记忆分为参数化记忆（内部知识）和上下文记忆（显式信息）两类，并定义了6种核心操作：巩固、更新、索引、遗忘、检索和压缩。这些机制使AI能像人类一样管理记忆，为大模型赋予了更接近人类的记忆能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T02:44:12Z
- **目录日期**: 2025-06-01
