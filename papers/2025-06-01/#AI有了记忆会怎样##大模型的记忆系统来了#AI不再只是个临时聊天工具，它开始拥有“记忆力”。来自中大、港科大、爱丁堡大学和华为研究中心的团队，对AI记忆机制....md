...
这篇研究综述探讨了大语言模型(LLMs)记忆系统的关键进展。研究团队提出了记忆系统的两个核心维度：记忆表示(分为参数化记忆和上下文记忆)和记忆操作(包括巩固、更新等6种核心操作)。参数化记忆指模型内部知识，响应快但难更新；上下文记忆则更灵活，支持多模态内容。该研究为AI构建类人记忆能力提供了系统框架，使大模型能更好地处理长期交互、个性化偏好等复杂需求，标志着AI从临时聊天工具向具有记忆能力的智能体转变。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T13:10:18Z
- **目录日期**: 2025-06-01
