...
该研究由中大、港科大、爱丁堡大学和华为团队合作，系统综述了AI记忆机制。研究指出大语言模型(LLMs)需要更完整的记忆系统来支持长期交互，包括跨轮对话、多模态输入和个性化偏好。记忆系统分为参数化记忆(模型内部知识)和上下文记忆(显式信息)，并定义了6种核心操作：巩固、更新、索引、遗忘、检索和压缩。这些机制使AI能够更灵活地处理信息，为构建具有人类记忆能力的智能体提供了统一框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T23:03:30Z
- **目录日期**: 2025-06-01
