...
中大、港科大等团队最新研究系统梳理了AI记忆机制，指出大语言模型需要更完善的记忆系统来支持长期交互。研究从记忆表示（参数化/上下文记忆）和记忆操作（巩固、更新等6种核心功能）两个维度构建框架，使AI能像人类一样处理跨轮对话、多模态输入等复杂需求。参数化记忆存储内部知识但难更新，上下文记忆则更灵活可调。该研究为开发具有持续学习能力的智能体提供了理论基础。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T01:30:32Z
- **目录日期**: 2025-06-01
