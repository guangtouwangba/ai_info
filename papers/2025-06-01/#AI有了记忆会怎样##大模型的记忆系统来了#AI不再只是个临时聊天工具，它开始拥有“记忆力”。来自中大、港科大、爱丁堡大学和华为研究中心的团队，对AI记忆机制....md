...
中大、港科大、爱丁堡大学和华为团队发表研究，系统综述了AI记忆机制。研究指出大语言模型(LLMs)需要更完整的记忆系统来支持长期交互，包括跨轮对话、多模态输入和个性化偏好。记忆系统分为参数化记忆(内部知识)和上下文记忆(显式信息)，并定义了6种核心操作：巩固、更新、索引、遗忘、检索和压缩。这为理解AI智能提供了新视角，使大模型能更接近人类记忆能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T06:02:39Z
- **目录日期**: 2025-06-01
