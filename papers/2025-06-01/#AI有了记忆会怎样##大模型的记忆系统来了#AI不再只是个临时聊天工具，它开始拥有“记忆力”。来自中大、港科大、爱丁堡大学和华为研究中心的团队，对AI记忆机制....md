...
这篇研究综述探讨了AI记忆系统的发展，指出大语言模型(LLMs)正向长期交互的智能体演进，需要更复杂的记忆功能支持跨轮对话、多模态输入和个性化偏好。研究从记忆表示(参数化记忆和上下文记忆)和记忆操作两个维度分析，提出了6种核心"原子操作"：巩固、更新、索引、遗忘、检索和压缩，为AI构建类似人类的记忆能力提供了系统框架。这项由多所高校和华为团队完成的研究，为理解AI智能开辟了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T16:03:40Z
- **目录日期**: 2025-06-01
