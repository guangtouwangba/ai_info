...
这篇研究综述探讨了大语言模型(LLMs)如何发展记忆系统以实现长期交互智能。研究团队来自中大、港科大等机构，提出了记忆的两个核心维度：参数化记忆(模型内部知识)和上下文记忆(显式信息)。研究定义了6种关键记忆操作：巩固、更新、索引、遗忘、检索和压缩，这些机制使AI能像人类一样处理跨轮对话、多模态输入和个性化偏好。该框架为构建更智能的AI系统提供了理论基础，使大模型从临时聊天工具向具有持续记忆能力的智能体转变。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T18:04:29Z
- **目录日期**: 2025-06-01
