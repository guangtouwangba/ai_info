...
这篇研究综述探讨了大语言模型(LLMs)如何发展记忆系统以实现长期交互智能。研究团队来自中大、港科大等机构，提出记忆系统包含参数化记忆(内部知识)和上下文记忆(显式信息)两种表示方式，以及6种核心操作：巩固、更新、索引、遗忘、检索和压缩。参数化记忆响应快但难更新，上下文记忆更灵活且支持多模态内容。该框架为AI实现类似人类的记忆能力提供了系统化方案，使大模型能处理跨轮对话、个性化偏好等复杂需求，标志着AI从临时聊天工具向具有记忆功能的智能体演进。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T11:03:30Z
- **目录日期**: 2025-06-01
