...
这篇研究综述探讨了大语言模型(LLMs)的记忆系统发展。研究团队提出了记忆的两个核心维度：参数化记忆(模型内部知识)和上下文记忆(显式信息)，并定义了6种关键记忆操作：巩固、更新、索引、遗忘、检索和压缩。这些机制使AI能够更好地处理跨轮对话、多模态输入和个性化需求，推动LLMs向长期交互智能体发展。记忆系统的完善将显著提升AI的交互能力和实用性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T05:03:17Z
- **目录日期**: 2025-06-01
