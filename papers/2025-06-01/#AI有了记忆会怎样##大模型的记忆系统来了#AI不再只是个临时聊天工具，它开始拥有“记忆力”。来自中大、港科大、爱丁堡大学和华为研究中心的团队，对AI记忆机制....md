...
这篇综述研究探讨了大语言模型(LLMs)记忆系统的关键发展。研究团队提出AI记忆可分为参数化记忆(模型内部知识)和上下文记忆(显式信息)，并定义了6种核心记忆操作：巩固、更新、索引、遗忘、检索和压缩。这些机制使AI能够处理跨轮对话、多模态输入和个性化偏好，推动AI从临时聊天工具向具有长期记忆能力的智能体转变。该框架为构建更复杂的AI记忆系统提供了理论基础，使大模型能更接近人类的记忆能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T15:03:17Z
- **目录日期**: 2025-06-01
