...
这篇研究综述探讨了大语言模型(LLMs)的记忆系统发展。研究团队来自中大、港科大等机构，提出了AI记忆的两个核心维度：参数化记忆(内部知识)和上下文记忆(显式信息)。研究定义了6种关键记忆操作：巩固、更新、索引、遗忘、检索和压缩，这些机制使AI能够处理跨轮对话、多模态输入和个性化偏好。参数化记忆响应快但难更新，上下文记忆更灵活可更新。该框架为构建具有长期交互能力的智能体提供了理论基础，标志着AI向更接近人类记忆能力的方向发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T17:04:47Z
- **目录日期**: 2025-06-01
