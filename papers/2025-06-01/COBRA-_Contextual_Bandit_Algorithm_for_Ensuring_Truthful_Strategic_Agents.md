...
这篇论文研究了一个涉及多个智能体的上下文赌博机问题，其中学习者需要观察上下文和智能体报告的选项，然后选择最大化系统整体奖励的选项。现有研究假设智能体会如实报告选项，但现实中（如电商平台卖家可能虚报产品质量）这并不成立。为此，作者提出了COBRA算法，在不使用金钱激励的情况下，通过设计激励机制抑制智能体的策略性行为，同时保证激励相容性和次线性遗憾。实验验证了该算法的各项性能表现。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T05:02:29Z
- **目录日期**: 2025-06-01
