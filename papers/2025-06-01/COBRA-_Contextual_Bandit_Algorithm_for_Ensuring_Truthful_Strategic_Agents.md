...
这篇论文研究了多智能体情境下的上下文赌博机问题，提出了一种名为COBRA的算法来解决智能体可能虚报信息的问题。传统方法假设智能体会如实报告，但现实中（如电商平台卖家可能夸大产品质量）存在策略性欺骗行为。COBRA算法无需经济激励即可抑制这种策略行为，同时保证激励相容性和次线性遗憾界。实验验证了该算法的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T07:02:02Z
- **目录日期**: 2025-06-01
