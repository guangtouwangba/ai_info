...
这篇论文研究了一种涉及多个智能体的上下文赌博机问题，其中学习者需在智能体可能虚报信息的情况下选择最优策略。现有研究假设智能体会如实报告信息，但现实中（如电商平台卖家可能夸大产品质量以获得推荐）这并不成立。为此，作者提出COBRA算法，无需经济激励即可抑制智能体的策略性虚报行为，同时保证激励兼容性和次线性遗憾。实验验证了算法的有效性。该研究为存在策略性欺骗的场景提供了新的解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T00:02:25Z
- **目录日期**: 2025-06-01
