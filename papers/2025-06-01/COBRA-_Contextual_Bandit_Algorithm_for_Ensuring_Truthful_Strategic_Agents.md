...
这篇论文研究了一个涉及多个智能体的上下文赌博机问题，其中学习者需要处理智能体可能虚报信息的情况。不同于现有假设智能体诚实报告的研究，作者提出了一种名为COBRA的算法，能够在无需金钱激励的情况下抑制智能体的策略性虚报行为，同时保证激励相容性和次线性遗憾。该算法适用于现实场景（如电商平台中卖家虚报产品质量的问题），实验验证了其有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T09:02:01Z
- **目录日期**: 2025-06-01
