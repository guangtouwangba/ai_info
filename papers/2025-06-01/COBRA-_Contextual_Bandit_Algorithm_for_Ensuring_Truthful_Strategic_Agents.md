...
这篇论文研究了一个涉及多个智能体的情境赌博问题，其中学习者需要根据智能体报告的选项和情境选择最大化系统总奖励的选项。现有研究假设智能体会如实报告，但现实中（如在线平台卖家可能虚报产品质量）常存在策略性欺骗行为。为此，作者提出了COBRA算法，无需货币激励即可抑制智能体的策略性行为，同时保证激励相容性和次线性遗憾界。实验验证了该算法的各项性能表现。该研究为存在策略性欺骗的情境赌博问题提供了实用解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T21:01:45Z
- **目录日期**: 2025-06-01
