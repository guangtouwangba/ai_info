...
这篇论文研究了一个涉及多个智能体的上下文赌博机问题，提出了一种名为COBRA的算法来处理智能体的策略性行为。传统方法假设智能体会如实报告其选择，但现实中（如电商平台的卖家）可能存在虚报行为。COBRA算法无需货币激励即可抑制策略性行为，同时保证激励相容性和次线性遗憾界。实验验证了该算法的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T23:01:53Z
- **目录日期**: 2025-06-01
