...
这篇论文研究了一个涉及多个智能体的上下文赌博问题，其中学习者需在智能体可能虚报信息的情况下选择最大化系统总奖励的选项。现有研究假设智能体会如实报告，但现实中（如电商平台卖家可能夸大产品质量）常存在策略性虚报。为此，作者提出COBRA算法，无需金钱激励即可抑制策略性行为，同时保证激励相容性和次线性遗憾界。实验验证了算法的有效性。该研究突破了传统假设，为存在策略性操纵的场景提供了解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T10:01:55Z
- **目录日期**: 2025-06-01
