...
这篇论文研究了一个涉及多个智能体的上下文赌博机问题，其中学习者需在智能体可能虚报选择的情况下最大化系统总奖励。现有研究假设智能体会如实报告选择，但现实中（如电商平台卖家可能虚报产品质量）常不成立。为此，作者提出COBRA算法，无需金钱激励即可抑制智能体的策略性虚报行为，同时保证激励相容性和次线性遗憾。实验验证了算法的有效性。该研究为存在策略性操纵的场景提供了新的解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T03:29:54Z
- **目录日期**: 2025-06-01
