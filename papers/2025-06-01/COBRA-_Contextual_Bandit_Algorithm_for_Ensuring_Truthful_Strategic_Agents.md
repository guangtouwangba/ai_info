...
本文提出了一种针对多智能体情境赌博问题的算法COBRA，解决了现有研究中假设智能体诚实上报行为的局限性。在现实场景（如电商平台）中，智能体可能通过虚报信息获取优势。COBRA算法无需货币激励，即可抑制智能体的策略性行为，同时保证激励相容性和次线性遗憾界。实验验证了该算法的各项性能表现。该研究为存在策略性智能体的情境赌博问题提供了实用解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T14:02:32Z
- **目录日期**: 2025-06-01
