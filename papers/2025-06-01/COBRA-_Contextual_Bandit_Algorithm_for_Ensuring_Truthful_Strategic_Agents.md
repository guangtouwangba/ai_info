...
这篇论文研究了涉及多个智能体的上下文赌博问题，提出了一种名为COBRA的算法来解决智能体可能虚报信息的问题。传统方法假设智能体会如实报告，但在实际应用中（如电商平台卖家可能虚报产品质量），这并不现实。COBRA算法无需货币激励就能抑制智能体的策略性行为，同时保证激励相容性和次线性遗憾。实验验证了该算法的性能优势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T04:13:22Z
- **目录日期**: 2025-06-01
