...
这篇论文研究了一个涉及多个智能体的上下文赌博问题，其中学习者需要观察智能体报告的选项并选择最大化系统整体奖励的选项。现有研究假设智能体会如实报告，但在实际应用中（如在线平台卖家可能虚报产品质量），这一假设不成立。为此，作者提出了COBRA算法，在不使用金钱激励的情况下，通过激励兼容机制抑制智能体的策略性行为，同时保证次线性遗憾。实验验证了该算法的各项性能表现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T01:29:59Z
- **目录日期**: 2025-06-01
