...
这篇论文研究了涉及多个智能体的上下文赌博机问题，提出了一种名为COBRA的算法来解决智能体可能虚报信息的问题。传统方法假设智能体会如实报告，但现实中（如电商平台卖家可能夸大产品质量）并非如此。COBRA无需货币激励就能抑制策略性虚报行为，同时保证激励相容性和次线性遗憾。实验验证了该算法的各项性能优势。该研究为存在策略性智能体的推荐系统等场景提供了新解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T19:02:04Z
- **目录日期**: 2025-06-01
