...
这篇论文研究了多智能体情境下的上下文赌博机问题，提出了一种名为COBRA的新算法。传统方法假设智能体会如实报告其选项，但现实中（如电商平台卖家可能虚报产品质量）常存在策略性欺骗行为。COBRA算法无需货币激励即可抑制这种策略性行为，同时保证激励相容性和次线性遗憾界。实验验证了该算法在多方面的性能优势。该研究对存在策略性代理的实际应用场景（如在线推荐系统）具有重要价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T12:01:52Z
- **目录日期**: 2025-06-01
