...
斯坦福研究团队意外发现AI生成的CUDA内核性能超越人类专家优化版本，在多项深度学习操作中表现亮眼：矩阵乘法达PyTorch的101.3%，二维卷积达179.9%，层归一化更是提升至484.4%。该突破源于训练内核生成模型时，测试阶段的合成数据意外产生高性能内核。方法创新在于迭代间加入语言推理步骤，通过"思考式"搜索实现方案多样化。这一发现预示AI可能重塑底层代码优化领域，相关成果由华人团队主导，性能最高可提升近400%。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T11:04:13Z
- **目录日期**: 2025-06-01
