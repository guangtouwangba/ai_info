...
斯坦福研究团队意外发现AI生成的CUDA内核性能超越人类专家优化版本，在深度学习操作中表现亮眼：矩阵乘法达PyTorch的101.3%，二维卷积179.9%，层归一化甚至提升484.4%。该突破源于训练内核生成模型时，测试阶段的合成数据意外产生了高性能内核。方法创新在于迭代间加入语言推理步骤，通过多样化"思考"寻找更优解。这一发现可能颠覆传统内核优化领域，展现了AI在底层计算优化中的巨大潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T08:04:01Z
- **目录日期**: 2025-06-01
