...
斯坦福研究团队意外发现，AI生成的CUDA内核性能远超人类专家优化版本。在深度学习常见操作中，AI优化内核比原生PyTorch性能提升101%-484%，其中层归一化(LayerNorm)提升近5倍。该方法通过语言推理步骤增加搜索多样性，而非传统逐步优化。研究初衷是生成合成数据训练模型，却意外发现测试阶段生成的数据本身就能产生高性能内核。这一突破可能改变传统内核优化方式，引发对AI取代内核工程师的讨论。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T01:31:09Z
- **目录日期**: 2025-06-01
