...
斯坦福研究团队意外发现AI生成的CUDA内核性能远超人类专家优化版本。测试显示，在矩阵乘法、卷积、Softmax等深度学习操作上，AI内核比PyTorch原生实现提升101%-484%。该方法创新性地在优化过程中加入"语言推理"步骤，通过多样化搜索产生更优解决方案。研究原目标仅为生成训练数据，却意外获得高性能内核，引发对AI取代内核工程师的讨论。这一突破性成果展现了AI在底层计算优化中的巨大潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T15:03:56Z
- **目录日期**: 2025-06-01
