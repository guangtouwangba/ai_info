...
斯坦福研究发现AI意外生成的CUDA内核性能超越人类专家优化版本，在深度学习操作中表现亮眼：矩阵乘法达PyTorch的101.3%，二维卷积179.9%，层归一化提升484.4%。研究团队原计划生成合成数据训练模型，却在测试阶段意外获得高性能内核。方法创新在于迭代间加入语言推理步骤，通过"思考"式搜索实现多样化优化。这一突破显示AI在内核工程领域的潜力，性能最高提升近400%，引发对AI取代专业工程师的讨论。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T06:03:13Z
- **目录日期**: 2025-06-01
