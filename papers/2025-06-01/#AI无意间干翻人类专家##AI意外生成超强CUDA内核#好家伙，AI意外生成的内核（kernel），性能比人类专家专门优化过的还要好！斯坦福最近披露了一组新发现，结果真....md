...
斯坦福大学研究团队意外发现，AI生成的CUDA内核性能超越人类专家优化版本。在深度学习常见操作中，AI优化内核比原生PyTorch性能提升最高达484%（层归一化），矩阵乘法提升101%，二维卷积提升180%。该突破源于测试阶段生成的合成数据意外具备优秀性能。研究方法创新性地在优化过程中加入语言推理步骤，通过"思考"式搜索实现多样化解决方案。这一发现可能颠覆传统内核优化方式，引发AI取代内核工程师的讨论。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T09:04:13Z
- **目录日期**: 2025-06-01
