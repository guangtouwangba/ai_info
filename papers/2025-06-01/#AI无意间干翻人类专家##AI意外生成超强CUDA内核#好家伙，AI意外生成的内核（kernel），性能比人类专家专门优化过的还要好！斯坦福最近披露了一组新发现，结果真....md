...
斯坦福研究团队意外发现，AI生成的CUDA内核性能超越人类专家优化版本。测试显示，AI内核在矩阵乘法、卷积等深度学习操作上表现突出，其中层归一化性能达PyTorch的484.4%。该方法通过语言推理步骤增强搜索多样性，而非传统逐步优化。这一突破可能重塑内核工程领域，展现AI在代码优化方面的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T00:03:28Z
- **目录日期**: 2025-06-01
