...
斯坦福研究团队意外发现，AI生成的CUDA内核性能超越人类专家优化版本。在深度学习操作中，AI优化内核比原生PyTorch性能提升显著：矩阵乘法达101.3%，二维卷积179.9%，层归一化高达484.4%。研究原目标是生成合成数据训练模型，但测试阶段数据直接产生了高性能内核。方法独特之处在于，每次迭代加入语言推理步骤，通过"思考"式搜索实现多样化优化。这一突破可能重塑内核工程领域，展现AI在底层性能优化中的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T12:04:11Z
- **目录日期**: 2025-06-01
