...
斯坦福研究团队意外发现AI生成的CUDA内核性能超越人类专家优化版本，在深度学习操作中表现亮眼：矩阵乘法达PyTorch的101.3%，二维卷积达179.9%，层归一化更提升至484.4%。该突破源于测试阶段合成数据意外生成的高效内核，其方法创新性地结合语言推理步骤，通过"思考式"迭代增强搜索多样性。这一发现不仅展示AI在底层优化领域的潜力，也暗示内核工程师可能面临被替代的风险。研究原目标仅为生成训练数据，却意外获得性能突破，最高提升近400%。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T02:44:50Z
- **目录日期**: 2025-06-01
