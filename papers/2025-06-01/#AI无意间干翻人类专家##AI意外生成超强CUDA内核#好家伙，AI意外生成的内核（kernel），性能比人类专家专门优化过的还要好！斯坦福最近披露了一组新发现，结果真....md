...
斯坦福大学研究团队意外发现，AI生成的CUDA内核性能超越人类专家优化版本，在深度学习操作中表现亮眼：矩阵乘法达PyTorch的101.3%，二维卷积达179.9%，层归一化性能提升高达484.4%。该方法通过语言推理步骤增强搜索多样性，而非传统逐步优化。研究原目标为生成训练数据，却意外发现测试阶段合成数据可直接产生高性能内核。这一突破可能重塑内核优化领域，展现AI在底层计算优化中的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T05:03:51Z
- **目录日期**: 2025-06-01
