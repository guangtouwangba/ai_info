...
阿里通义实验室开源了MaskSearch预训练框架，通过检索增强型掩码预测(RAMP)技术，使小模型能媲美大模型性能。该框架创新性地结合监督微调(SFT)和强化学习(RL)，采用多智能体生成思维链和混合奖励系统优化推理路径，并引入课程学习策略提升泛化能力。实验显示，在跨领域问答任务中，采用MaskSearch的小模型表现优异。研究还揭示了掩码策略和奖励函数对模型性能的重要影响。这一技术突破为提升小模型推理能力提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T03:30:51Z
- **目录日期**: 2025-06-01
