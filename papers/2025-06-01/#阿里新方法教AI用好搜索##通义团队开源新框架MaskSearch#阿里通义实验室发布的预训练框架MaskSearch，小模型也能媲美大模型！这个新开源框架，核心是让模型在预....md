...
阿里通义实验室开源了新型预训练框架MaskSearch，其核心创新是将检索增强机制融入预训练过程。该框架基于BERT的掩码预测思路，但强制模型通过搜索获取外部知识来补全信息（RAMP任务）。通过多智能体协同生成思维链和混合奖励系统，兼容监督学习和强化学习训练。实验显示，采用课程学习策略的MaskSearch能显著提升小模型性能，在跨领域任务中达到媲美大模型的效果。研究还揭示了掩码策略和奖励函数对模型学习能力的关键影响。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T18:04:50Z
- **目录日期**: 2025-06-01
