...
Ubiquant研究团队提出"熵最小化"(EM)方法,仅需1条高质量样本和10步训练即可提升大模型性能。该方法通过降低模型输出分布的熵值,迫使模型选择最自信的答案,无需标注数据或奖励函数。实验显示,在数学推理任务上,EM表现媲美甚至超越需要大量数据的强化学习方法。关键创新在于选择模型回答不稳定的问题作为训练样本,如仅用1道物理题就显著提升了Qwen2.5-Math-7B的数学能力。这种无监督方法大大降低了训练成本和复杂度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-01T14:03:19Z
- **目录日期**: 2025-06-01
