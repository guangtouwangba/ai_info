...
该论文提出了一种新型的智能记忆系统，用于增强大语言模型(LLM)代理的记忆能力。受Zettelkasten方法启发，该系统能动态组织记忆，通过索引和链接构建知识网络。新记忆会生成包含上下文描述、关键词和标签的结构化笔记，并与历史记忆建立关联。系统还能更新现有记忆的表示和属性，实现持续优化。结合Zettelkasten的结构化原则与代理驱动的灵活性，该系统展现出更强的适应性和情境感知能力。在六个基础模型上的实验表明，其性能优于现有最优基线。相关代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T17:02:27Z
- **目录日期**: 2025-04-21
