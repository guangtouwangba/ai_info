...
本文提出了一种新型的LLM智能体记忆系统，能动态组织记忆并建立知识网络。该系统基于Zettelkasten方法，为每个新记忆生成包含上下文描述、关键词和标签的结构化笔记，并分析历史记忆建立关联链接。新记忆的加入会触发现有记忆的上下文更新，实现记忆网络的持续优化。该方法结合了Zettelkasten的结构化组织原则与智能体驱动的决策灵活性，实现了更自适应、情境感知的记忆管理。在六个基础模型上的实验表明，其性能优于现有SOTA基线。相关代码已在GitHub开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T14:02:42Z
- **目录日期**: 2025-04-21
