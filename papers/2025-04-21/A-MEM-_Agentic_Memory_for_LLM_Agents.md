...
本文提出了一种新型的LLM智能体记忆系统，能够动态地以自主方式组织记忆。该系统借鉴Zettelkasten方法，通过动态索引和链接构建互联知识网络：每新增记忆时生成包含上下文描述、关键词等结构化属性的完整笔记，并分析历史记忆建立关联链接。新记忆的整合还能触发现有记忆的上下文表征更新，实现知识网络的持续进化。该系统结合了Zettelkasten的结构化组织原则与智能体驱动的决策灵活性，在6个基础模型上的实验显示其性能显著优于现有SOTA基线。相关代码已在GitHub开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T21:02:33Z
- **目录日期**: 2025-04-21
