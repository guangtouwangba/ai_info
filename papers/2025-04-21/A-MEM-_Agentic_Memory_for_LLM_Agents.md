...
这篇论文提出了一种新型的智能记忆系统，用于增强大语言模型(LLM)代理的记忆能力。该系统借鉴了Zettelkasten方法，通过动态索引和链接构建互联的知识网络。每当新增记忆时，系统会生成包含上下文描述、关键词和标签的结构化笔记，并分析历史记忆建立关联。新记忆的加入还能触发对已有记忆的更新，实现记忆网络的持续优化。实验表明，该系统在六个基础模型上的表现优于现有方法。源代码已在GitHub开源，包含性能评估工具和记忆系统实现。这种结合结构化组织和智能决策的方法，显著提升了记忆管理的适应性和情境感知能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T12:02:37Z
- **目录日期**: 2025-04-21
