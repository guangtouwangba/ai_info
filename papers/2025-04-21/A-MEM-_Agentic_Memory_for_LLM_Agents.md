...
本文提出了一种新型的LLM智能体记忆系统，采用类似Zettelkasten方法的原理动态组织记忆。系统通过生成包含上下文描述、关键词和标签的结构化笔记，建立知识网络连接。新记忆的加入会触发对历史记忆的相关性分析，建立有意义关联，并能动态更新现有记忆的表征和属性，实现记忆网络的持续优化。该方法结合了Zettelkasten的结构化组织原则和智能体驱动的决策灵活性，在6个基础模型上的实验表明其性能优于现有最优基线。相关代码已在GitHub开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T16:02:28Z
- **目录日期**: 2025-04-21
