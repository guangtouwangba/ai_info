...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟10,000+个AI代理在真实社会环境中的500万次交互。研究者通过该平台研究了四大社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实数据高度吻合，验证了该系统捕捉人类行为机制的能力。该平台可作为传统社会科学研究方法（如调查、访谈）的有力补充，为研究社会问题成因和政策制定提供新工具。研究表明AgentSociety在计算社会科学领域具有重要应用潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T18:05:08Z
- **目录日期**: 2025-04-21
