...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟器，能模拟1万多个代理的社会互动（500万次）。研究者用它分析四个社会问题：群体极化、信息传播、基本收入政策效果和自然灾害影响。模拟结果与现实数据吻合，验证了该工具在揭示人类行为机制和社会问题成因方面的有效性。该系统可作为计算社会科学的新平台，辅助传统研究方法，为研究者和政策制定者提供有力支持。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T09:05:47Z
- **目录日期**: 2025-04-21
