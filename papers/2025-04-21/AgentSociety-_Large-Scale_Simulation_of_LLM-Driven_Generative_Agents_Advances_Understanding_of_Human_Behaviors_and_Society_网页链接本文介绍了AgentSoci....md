...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统通过1万多个AI代理在虚拟社会中的500万次互动，模拟了真实社会环境。研究团队利用该平台进行了四项社会实验：社会极化现象、刺激性信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，证明了该系统在揭示人类行为机制和社会问题成因方面的有效性。AgentSociety为社会科学研究和政策制定提供了新的实验工具，能够补充传统研究方法，帮助理解复杂社会现象。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T07:04:42Z
- **目录日期**: 2025-04-21
