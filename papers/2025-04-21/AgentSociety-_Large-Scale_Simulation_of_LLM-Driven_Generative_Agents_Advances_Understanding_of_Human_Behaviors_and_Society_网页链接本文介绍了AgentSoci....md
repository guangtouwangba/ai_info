...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟1万多个AI代理的社会互动（500万次）。研究者用它作为计算社会科学实验平台，研究了四大社会问题：社会极化、刺激性信息传播、无条件基本收入政策影响及飓风等外部冲击。模拟结果与现实世界数据吻合，验证了该系统捕捉人类行为机制的能力。该工具为社会科学研究和政策制定提供了新方法，能有效补充传统调查和干预研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T13:11:48Z
- **目录日期**: 2025-04-21
