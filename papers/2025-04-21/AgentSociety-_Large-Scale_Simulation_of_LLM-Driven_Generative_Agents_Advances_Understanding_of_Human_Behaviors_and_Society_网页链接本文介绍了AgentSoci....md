...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个代理的社会互动（500万次交互）。该系统作为计算社会科学实验平台，研究了社会极化、信息传播、基本收入政策及自然灾害影响四个关键问题。模拟结果与现实数据吻合，验证了其在捕捉人类行为机制方面的有效性，展示了作为社会科学研究和政策制定工具的潜力。研究证明AgentSociety能有效辅助传统研究方法（如调查和干预），为理解社会问题提供新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T10:03:45Z
- **目录日期**: 2025-04-21
