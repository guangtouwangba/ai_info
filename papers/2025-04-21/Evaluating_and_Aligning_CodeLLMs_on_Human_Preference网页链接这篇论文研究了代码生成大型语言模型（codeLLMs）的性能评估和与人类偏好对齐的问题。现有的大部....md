...
这篇论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，强调现有评估忽视人类偏好匹配的问题。研究收集397个高质量编程任务样本，覆盖40类44种语言，并构建20B标记的SynCode-Instruct合成指令集。实验发现执行基准与人类偏好存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，揭示了模型对齐人类偏好的重要性。研究通过真实场景模拟验证了合成指令微调的有效性，为代码生成模型的评估体系提供了新维度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T12:06:24Z
- **目录日期**: 2025-04-21
