...
近期研究表明，LLMs在自动程序修复（APR）中展现出强大能力，但现有方法主要集中于主流语言（如Java、Python），而忽略了新兴语言（如Rust）。为此，研究者提出LANTERN方法，通过多智能体迭代修复范式，将缺陷代码从LLMs修复能力弱的语言翻译至修复能力强的语言，无需额外训练。该方法采用基于LLM的决策系统动态选择目标语言，并结合修复反馈。在xCodeEval基准测试（11种语言5068个错误）中，Rust的Pass@10指标提升22.09%，首次证明跨语言翻译能显著提升LLMs的修复能力，弥合不同流行度语言间的性能差距。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T01:29:40Z
- **目录日期**: 2025-04-21
