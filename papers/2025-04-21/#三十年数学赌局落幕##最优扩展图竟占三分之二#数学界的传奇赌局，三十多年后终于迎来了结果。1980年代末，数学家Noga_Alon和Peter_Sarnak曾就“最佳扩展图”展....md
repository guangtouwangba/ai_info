...
数学界持续30年的著名赌局近日揭晓：关于最优扩展图（Expander Graph）的稀有性之争，Noga Alon和Peter Sarnak两位数学家的预测均被推翻。最新研究表明，具有完美连接特性的Ramanujan图实际占比约69%，既非极其稀有也非普遍存在。扩展图因其高效连通性被广泛应用于网络设计、密码学和神经网络领域。这一突破性发现由三位数学家借助物理现象证明，不仅解决了长期争议，更为随机图和矩阵研究开辟了新方向，展现了数学中"随机性蕴含规律"的深层奥秘。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T06:02:44Z
- **目录日期**: 2025-04-21
