# #三十年数学赌局落幕##最优扩展图竟占三分之二#数学界的传奇赌局，三十多年后终于迎来了结果。1980年代末，数学家Noga Alon和Peter Sarnak曾就“最佳扩展图”展...
...
1980年代末，数学家Noga Alon和Peter Sarnak就"最优扩展图"（Expander Graph）的稀有性展开赌局。扩展图具有高度连通性，广泛应用于网络设计、密码学和神经网络。Sarnak认为最优扩展图（Ramanujan图）极其稀有，而Alon认为随机图大概率是完美扩展图。30多年后，三位数学家通过物理学方法证明：最优扩展图占比约69%，既非极稀有也非普遍。这一结果颠覆了原有认知，为扩展图研究开辟了新方向，展现了数学探索中"随机性蕴含规律"的深刻本质。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T13:10:46Z
- **目录日期**: 2025-04-21
