...
这场持续30多年的数学赌局终于落幕。1980年代，数学家Alon和Sarnak就"最优扩展图"（具有高度连通性的特殊图形）的稀有性打赌：Alon认为随机图大概率是完美扩展图，Sarnak则认为极为罕见。最新研究证明两人都错了——最优扩展图（Ramanujan图）实际上占约69%，既非极其稀有也不普遍。这一发现颠覆了原有认知，为网络科学、密码学等领域带来新见解。扩展图因其强大连通性被广泛应用于互联网设计、纠错编码和神经网络建模。该研究揭示了随机图中隐藏的深层规律。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T09:04:22Z
- **目录日期**: 2025-04-21
