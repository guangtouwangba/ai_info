...
这场持续30多年的数学赌局终于揭晓：1980年代数学家Alon和Sarnak就"最优扩展图"稀有性打赌，Alon认为随机图大概率是完美扩展图，Sarnak则认为极难构造。最新研究证明两人都错了——最优扩展图（Ramanujan图）实际占比约69%，既非稀有也不普遍。扩展图因其高度连通性在互联网、密码学和神经网络中有重要应用。这一发现颠覆了原有认知，为图论研究开辟了新方向，展现了数学探索中"随机性蕴含规律"的奇妙特性。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T04:03:20Z
- **目录日期**: 2025-04-21
