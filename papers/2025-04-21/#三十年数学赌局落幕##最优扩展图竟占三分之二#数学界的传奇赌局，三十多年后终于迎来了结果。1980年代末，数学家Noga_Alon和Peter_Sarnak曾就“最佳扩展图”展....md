...
这篇微博讲述了一个持续30多年的数学赌局结果。1980年代，数学家Noga Alon和Peter Sarnak就"最优扩展图"(Expander Graph)的普遍性打赌：Sarnak认为最优扩展图(Ramanujan图)极为稀有，而Alon认为随机图大概率是完美扩展图。最新研究显示两人都错了——最优扩展图约占69%，既非稀有也非普遍。扩展图具有强连接性，广泛应用于网络设计、密码学和神经网络建模。这一发现为图论研究开辟了新思路，展现了数学探索的趣味性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T07:03:22Z
- **目录日期**: 2025-04-21
