...
这场持续30多年的数学赌局终于揭晓：1980年代数学家Alon和Sarnak对"最优扩展图"（Ramanujan图）的普遍性各执一词，Alon认为随机图大概率是最优扩展图，Sarnak则认为极其稀有。最新研究证明两者皆错——最优扩展图约占69%，既非罕见也非普遍。扩展图因其强大连通性在互联网、密码学和神经网络等领域有重要应用。这一发现不仅解决了长期争议，更为图论研究开辟了新方向，展现了数学探索中"随机中的规律"这一永恒主题。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T11:04:24Z
- **目录日期**: 2025-04-21
