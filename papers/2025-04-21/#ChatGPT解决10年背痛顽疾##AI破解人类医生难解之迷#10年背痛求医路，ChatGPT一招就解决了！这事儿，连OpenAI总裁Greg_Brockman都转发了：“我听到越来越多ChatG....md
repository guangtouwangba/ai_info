...
一名网友因10年背痛求医无果，将症状和诊疗经历输入ChatGPT后获得突破性进展。AI整合医学知识，分析出"低背能力"理论的核心问题，提供个性化锻炼方案和执行计划。经过数周调整，患者背痛缓解60-70%。相比传统医生单一视角的诊断，ChatGPT展现出综合医疗信息、定制解决方案的优势。OpenAI总裁转发该案例，指出AI虽不完美，但已开始改善人类健康难题。该案例花费不足20美元，凸显AI医疗辅助的性价比潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T04:03:11Z
- **目录日期**: 2025-04-21
