...
一名网友因10年背痛求医无果，将症状和治疗史输入ChatGPT后获得突破性进展。AI整合医学知识，提供个性化解释和锻炼计划，使其疼痛减少60-70%。与传统医生单一视角不同，ChatGPT能综合分析并持续调整方案。OpenAI总裁转发该案例，称AI虽不完美但已开始改善人类健康。该案例展示了AI在医疗辅助方面的潜力，以20美元成本实现远超传统诊疗的效果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T05:02:54Z
- **目录日期**: 2025-04-21
