...
第一代大语言模型（2020-2023）通过大规模参数和数据扩展取得显著成就，但存在知识滞后、浅层推理和认知受限等问题。这一时期主要通过提示工程实现人机对话交互。当前进入"第二阶段"（2024起），模型正从潜在空间的知识检索系统转变为基于测试时扩展技术的思维构建引擎，通过语言思维建立更深层的人机连接。本文阐明认知工程的概念基础，通过教程和优化实现系统解析这些先进方法，使更多实践者能参与AI发展的第二阶段。相关论文合集持续更新于GitHub仓库。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T18:01:25Z
- **目录日期**: 2025-04-21
