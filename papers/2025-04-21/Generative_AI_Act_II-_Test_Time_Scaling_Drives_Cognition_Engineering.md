...
这篇摘要讨论了大语言模型（LLM）的发展阶段。第一代生成式AI（2020-2023）通过大规模参数和数据扩展取得显著成功，但存在知识滞后、推理浅层等局限，主要依赖提示工程进行交互。当前进入"第二幕"（2024起），模型正从知识检索系统转变为通过测试时扩展技术构建思维引擎，实现基于语言思维的深层次认知连接。作者阐述了认知工程的概念基础和发展时机，通过教程和优化实现系统化解析这些先进方法，使更多实践者能参与AI发展的第二阶段。相关论文资源已在GitHub开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T05:01:24Z
- **目录日期**: 2025-04-21
