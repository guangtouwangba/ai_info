...
第一代大语言模型（2020-2023）通过大规模参数和数据扩展取得显著成就，但仍存在知识滞后、浅层推理和认知受限等问题。这一时期主要通过提示工程实现人机对话交互。当前进入"第二阶段"（2024起），模型正从潜在空间的知识检索系统转变为基于测试时扩展技术的思维构建引擎，实现语言层面的思维连接。本文阐明认知工程的概念基础及其发展关键性，通过系统教程和优化实现普及认知工程技术，使更多实践者参与AI新阶段。相关论文资源见GitHub仓库：https://github.com/GAIR-NLP/cognition-engineering（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T06:01:14Z
- **目录日期**: 2025-04-21
