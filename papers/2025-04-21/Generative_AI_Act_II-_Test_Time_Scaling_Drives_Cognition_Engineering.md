...
第一代大语言模型（2020-2023）通过大规模参数和数据扩展取得显著成功，但仍存在知识滞后、浅层推理和认知受限等问题，主要依赖提示工程实现人机对话。当前进入"第二代"（2024起），模型正从潜在空间的知识检索系统转变为通过测试时扩展技术构建思维的引擎，实现基于语言思维的深层次人机交互。本文阐明认知工程的概念基础，系统分解相关技术方法，提供优化实现方案，旨在普及认知工程技术，使更多研究者能参与AI发展的新阶段。相关论文资源持续更新于GitHub仓库。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T08:01:31Z
- **目录日期**: 2025-04-21
