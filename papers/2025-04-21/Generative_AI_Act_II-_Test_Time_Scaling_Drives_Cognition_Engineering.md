...
第一代大语言模型（2020-2023）通过海量参数和数据扩展取得显著成就，但仍存在知识滞后、推理浅层等局限，主要依赖提示工程实现人机对话。当前进入"第二代"（2024起），模型正从潜在空间的知识检索系统转变为通过测试时扩展技术构建的思维引擎，实现基于语言思维的深层次认知连接。本文阐明认知工程的概念基础，系统分解先进方法并提供优化实现方案，通过开源项目（GitHub链接）推动该领域发展，使更多研究者能参与AI发展的新阶段。研究团队将持续更新相关论文资源库。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T23:01:17Z
- **目录日期**: 2025-04-21
