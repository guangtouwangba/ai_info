...
第一代大语言模型（2020-2023）通过大规模参数和数据扩展取得显著成就，但仍存在知识滞后、推理浅层等局限，主要依赖提示工程实现对话交互。当前进入"第二阶段"（2024起），模型正从潜在空间的知识检索系统转变为通过测试时扩展技术构建的思维引擎，建立基于语言思维的深层次AI交互。本文阐明认知工程的概念基础，系统分解相关技术方法，提供教程和优化实现，促进该领域普及发展。相关论文资源持续更新于GitHub仓库：https://github.com/GAIR-NLP/cognition-engineering

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T16:01:25Z
- **目录日期**: 2025-04-21
