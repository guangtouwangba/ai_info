...
第一代大语言模型（2020-2023）通过海量参数和数据扩展取得显著成功，但仍存在知识滞后、浅层推理等局限，主要依赖提示工程实现对话交互。当前进入"第二阶段"（2024至今），模型正从潜在空间的知识检索系统转变为通过测试时扩展技术构建的思维引擎，实现基于语言思维的深层次人机交互。本文阐述认知工程的概念基础与发展契机，通过系统教程和优化实现推动该技术普及，使更多开发者能参与AI新阶段。相关测试时扩展论文合集持续更新于GitHub仓库。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T13:07:34Z
- **目录日期**: 2025-04-21
