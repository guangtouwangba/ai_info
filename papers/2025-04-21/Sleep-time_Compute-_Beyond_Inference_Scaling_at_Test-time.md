...
本文提出"睡眠时间计算"(sleep-time compute)方法，通过让大语言模型在查询前预先计算可能的问题和有用信息，显著降低测试时的计算需求。实验显示，该方法在Stateful GSM-Symbolic和Stateful AIME任务上能减少5倍测试计算量，同时提升13%-18%准确率。通过Multi-Query GSM-Symbolic分摊计算成本，单查询平均成本降低2.5倍。研究发现查询可预测性与方法效果正相关。最后通过软件工程代理任务验证了该方法的实用性，证明其能有效平衡延迟、成本和性能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T01:28:32Z
- **目录日期**: 2025-04-21
