...
自监督学习（SSL）是当前AI系统的核心技术，其设计空间不断扩展。根据柏拉图表示假说（PRH），不同方法最终会收敛到相同的理想表示，但缺乏理论解释。研究表明，可辨识性理论（IT）可解释PRH现象，但无法完全说明SSL的实际成功。为此，提出扩展的奇异可辨识性理论（SITh），以更全面分析SSL流程，促进可解释和泛化性表示的学习。未来研究方向包括：1）SSL训练动态与收敛性；2）有限样本、批次大小和数据多样性的影响；3）架构、增强、初始化和优化器的归纳偏置作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T02:30:27Z
- **目录日期**: 2025-04-21
