# #中国研制出全球最快闪存器##史上最快闪存技术#目前人类最快电荷存储器——超高速闪存器件，被复旦大学研制成功！复旦大学周鹏、刘春森团队近期在Nature上，发表...
...
复旦大学周鹏、刘春森团队在《Nature》发表突破性成果，成功研制全球最快闪存器件"破晓(PoX)"。该器件写入速度达400皮秒（比最快SRAM快两个数量级），兼具非易失性存储特性，解决了传统存储技术"速度与非易失性不可兼得"的难题。其核心创新在于采用二维狄拉克石墨烯通道实现电子弹道输运，结合"二维超注入"机制和AI优化工艺。这项技术特别适用于AI训练/推理、边缘计算等场景，有望取代现有SRAM+Flash架构，为下一代AI硬件提供高性能存储解决方案。团队正推进产业化应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T06:02:28Z
- **目录日期**: 2025-04-21
