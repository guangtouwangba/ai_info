...
复旦大学周鹏、刘春森团队在《Nature》发表"破晓(PoX)"皮秒闪存器件研究成果，创下400皮秒(0.4纳秒)的全球最快闪存速度记录。该技术突破性地结合了SRAM的高速特性和闪存的非易失性，采用二维狄拉克石墨烯通道实现电子弹道输运，配合"二维超注入"机制和AI优化工艺，兼具低功耗、高集成度优势。这项技术有望替代现有SRAM+Flash双模块结构，特别适用于AI训练/推理、边缘计算等场景，为下一代AI硬件发展奠定关键基础，目前团队正推进产业化落地。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T11:04:03Z
- **目录日期**: 2025-04-21
