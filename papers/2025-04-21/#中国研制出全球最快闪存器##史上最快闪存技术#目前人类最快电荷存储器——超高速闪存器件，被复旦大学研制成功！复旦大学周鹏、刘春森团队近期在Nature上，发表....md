...
复旦大学周鹏、刘春森团队在《Nature》发表研究成果，成功研制全球最快闪存器件"破晓(PoX)"。该器件突破存储技术瓶颈，实现400皮秒(亚1纳秒)的擦写速度，比现有最快SRAM快两个数量级，同时具备非易失性存储特性。其创新在于采用二维狄拉克石墨烯通道实现电子弹道输运，引入"二维超注入"机制提升电荷注入效率，并运用AI算法优化制造工艺。这一技术有望替代传统SRAM与Flash双模块结构，为AI训练/推理、边缘计算等场景提供更高效节能的存储解决方案，目前正推进量产进程。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T16:04:19Z
- **目录日期**: 2025-04-21
