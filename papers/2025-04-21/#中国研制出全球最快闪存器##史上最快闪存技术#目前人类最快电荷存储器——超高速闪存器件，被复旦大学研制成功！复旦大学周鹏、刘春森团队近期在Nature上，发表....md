...
复旦大学周鹏、刘春森团队在《Nature》发表突破性成果，研发出全球最快闪存技术"破晓(PoX)"。该器件写入速度达400皮秒，比现有SRAM快两个数量级，同时具备非易失性存储特性，解决了传统存储技术"速度与非易失性不可兼得"的难题。其创新在于采用二维狄拉克石墨烯通道实现电子弹道输运，引入"二维超注入"机制提升电荷注入效率，并应用AI优化制造工艺。这项技术有望替代现有SRAM与Flash双模块结构，为AI训练/推理、边缘计算等场景提供更高效节能的存储解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T15:04:22Z
- **目录日期**: 2025-04-21
