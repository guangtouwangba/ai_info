...
复旦大学周鹏、刘春森团队在《自然》期刊发表"破晓(PoX)"皮秒闪存器件研究成果，创下400皮秒(0.4纳秒)的全球最快闪存速度纪录。该技术突破性地结合了SRAM的高速特性和闪存的非易失性：采用二维狄拉克石墨烯通道实现电子弹道输运，引入"二维超注入"机制提升电荷效率，并应用AI优化制造工艺。其超高速、低功耗特性特别适合AI训练/推理、边缘计算等场景，有望替代现有SRAM+Flash双模块架构。团队正推进阵列设计和系统集成验证，这项突破可能重塑未来AI硬件存储架构。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T14:04:32Z
- **目录日期**: 2025-04-21
