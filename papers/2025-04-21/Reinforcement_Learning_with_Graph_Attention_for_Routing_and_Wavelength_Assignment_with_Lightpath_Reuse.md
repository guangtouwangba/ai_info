...
本文研究了固定栅格网络中带灵活速率转发器的路由与波长分配问题（RWA-LR），提出了一种基于图注意力网络的强化学习（RL）方法。研究发现，按跳数排序候选路径的启发式算法比按总长度排序的吞吐量高6%。通过优化RL策略，新方法比现有最优RL方法提升2.5%（17.4Tbps），比最佳启发式算法提升1.2%（8.5Tbps）。尽管边际收益较小，但凸显了在长周期资源分配任务中学习有效RL策略的挑战。研究开源了全部代码以促进复现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T08:02:27Z
- **目录日期**: 2025-04-21
