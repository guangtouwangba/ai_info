...
本文研究了固定网格网络中结合灵活速率收发器的路由与波长分配问题（RWA-LR），提出了一种基于图注意力网络的强化学习（RL）方法。相比传统启发式算法（按跳数排序路径可提升6%吞吐量），该方法将最优RL方案的吞吐量提高了2.5%（17.4Tbps），较最佳启发式算法提升1.2%（8.5Tbps）。研究开源了全部代码，并指出在长周期资源分配任务中学习有效RL策略的挑战性。成果凸显了图结构数据处理在光网络优化中的潜力，但边际收益也反映了该问题的复杂性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T06:01:57Z
- **目录日期**: 2025-04-21
