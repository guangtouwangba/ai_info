...
当前AI治理框架依赖审计，但评估结果需要结合背景信息才能有效解读。研究发现现有评估报告普遍缺乏关键背景信息（如审计者身份、利益冲突、模型访问权限等），且监管框架缺乏明确的报告规范。为此，研究者提出"审计卡片"方案，要求系统披露六类核心背景特征：审计者身份、评估范围、方法、资源权限、流程完整性和审查机制。通过分析现有报告发现，多数未充分披露这些信息。审计卡片通过结构化呈现关键主张及其依据，可提升透明度、促进准确解读并建立报告可信度，弥补当前评估实践的不足。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T03:17:18Z
- **目录日期**: 2025-04-21
