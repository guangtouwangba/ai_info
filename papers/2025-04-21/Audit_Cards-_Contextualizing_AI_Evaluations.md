...
当前AI治理框架依赖审计，但评估结果需要结合背景信息才能有效解读。现有研究多关注技术规范，却忽视了审计作为社会技术过程的本质，缺乏对报告流程和背景的指导。为此，研究者提出"审计卡片"框架，要求明确六类关键背景信息：审计者身份、评估范围、方法、资源权限、流程完整性和复核机制。分析显示，现有审计报告普遍缺失审计者背景、利益冲突等核心信息，且监管框架缺乏报告规范要求。审计卡片通过结构化呈现关键主张及其依据，可提升透明度、促进准确解读并增强报告可信度。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T11:01:00Z
- **目录日期**: 2025-04-21
