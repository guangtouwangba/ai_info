...
当前AI治理框架依赖审计，但评估结果需要结合背景信息才能有效解读。现有研究主要关注技术标准，却忽视了审计报告的社会技术属性，缺乏对报告程序和背景的指导。为此，研究者提出"审计卡片"方案，通过文献综述和利益相关方访谈，提炼出六类关键背景信息：审计者身份、评估范围、方法、资源权限、流程完整性和审查机制。分析显示，现有审计报告普遍缺失重要背景（如审计者资质、利益冲突、模型访问权限），且监管框架缺乏报告规范。审计卡片通过结构化呈现核心主张及其依据，可提升透明度并建立信任。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T04:01:20Z
- **目录日期**: 2025-04-21
