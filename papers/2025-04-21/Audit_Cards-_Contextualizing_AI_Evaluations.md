...
当前AI治理框架依赖审计，但评估结果需要结合背景信息才能有效解读。研究发现，现有评估报告常遗漏关键背景信息（如审计者身份、利益冲突、模型访问权限等），且缺乏统一的报告标准。为此，研究者提出"审计卡片"框架，要求明确报告六类核心背景特征：审计者身份、评估范围、方法、资源权限、流程完整性和审查机制。通过分析现有报告发现，多数评估未充分披露这些信息，现有法规也缺乏相关规范。审计卡片通过结构化呈现关键主张及其依据，可提升透明度、促进准确解读并建立报告可信度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T23:00:58Z
- **目录日期**: 2025-04-21
