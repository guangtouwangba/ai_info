...
当前AI治理框架依赖审计，但评估结果需要结合背景信息才能有效解读。现有文献主要关注技术标准，但评估本质上是社会技术过程，缺乏对报告流程和背景的指导。研究提出"审计卡片"概念，明确六类关键背景信息：审计者身份、评估范围、方法、资源访问、流程完整性和审查机制。分析发现现有评估报告普遍缺失重要背景（如审计者背景、利益冲突、模型访问权限），且多数法规缺乏严格报告指引。审计卡片能以结构化方式呈现关键声明及依据，提升透明度、促进正确解读并建立报告可信度。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T09:00:56Z
- **目录日期**: 2025-04-21
