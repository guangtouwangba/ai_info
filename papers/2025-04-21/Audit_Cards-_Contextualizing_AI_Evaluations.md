...
当前AI治理框架依赖审计，但评估结果需要结合背景信息才能有效解读。现有研究主要关注技术标准，却忽视了审计报告的社会技术属性，导致关键背景信息（如审计者身份、利益冲突、模型访问权限等）常被遗漏。通过文献分析、利益相关者访谈和框架研究，研究者提出"审计卡片"方案，要求明确报告六类关键背景信息：审计者身份、评估范围、方法、资源权限、流程完整性和审查机制。分析显示，现有审计报告普遍缺乏透明度，监管框架也缺少规范。审计卡片可结构化呈现核心主张及其依据，提升透明度并建立信任。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T22:00:58Z
- **目录日期**: 2025-04-21
