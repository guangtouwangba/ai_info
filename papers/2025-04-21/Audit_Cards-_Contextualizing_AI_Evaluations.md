...
当前AI治理框架依赖审计，但评估结果需要结合背景信息才能有效解读。即使技术严谨的评估，若报告不透明或选择性呈现，也难提供有用洞见。现有研究多关注技术标准，却忽视评估本质是社会技术过程，缺乏对报告流程和背景的指导。为此，研究者提出"审计卡片"方案，通过文献分析、利益相关者访谈和框架研究，明确了需报告的六类关键背景信息：审计者身份、评估范围、方法、资源权限、流程完整性和审查机制。分析显示现有报告普遍缺失重要背景（如审计者资质、利益冲突等），且监管框架缺乏报告规范。审计卡片通过结构化呈现核心主张及其依据，可提升透明度、促进正确解读并建立信任。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T18:01:06Z
- **目录日期**: 2025-04-21
