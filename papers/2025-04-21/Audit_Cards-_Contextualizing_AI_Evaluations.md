...
当前AI治理框架依赖审计，但评估结果需要结合背景信息才能有效解读。现有研究多关注技术标准，忽视了审计报告的社会技术属性，导致关键背景信息（如审计者身份、利益冲突、模型访问权限等）常被遗漏。通过文献综述和利益相关者访谈，研究者提出"审计卡片"方案，要求明确报告六类关键背景：审计者身份、评估范围、方法、资源权限、流程完整性和审查机制。分析显示，现有审计报告普遍缺乏这些信息，且监管框架也缺少相关规范。审计卡片能结构化呈现关键主张及其依据，提升透明度并建立信任。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T14:01:15Z
- **目录日期**: 2025-04-21
