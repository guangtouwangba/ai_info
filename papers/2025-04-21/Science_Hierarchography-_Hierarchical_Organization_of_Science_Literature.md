...
该研究提出"科学层级图"(SCIENCE HIERARCHOGRAPHY)，旨在将科学文献组织成多层次分类体系，从广泛领域到具体研究。研究者开发了结合嵌入聚类与LLM提示的算法，平衡计算效率与语义精度。相比纯LLM方法，该方案在质量与速度间取得更好权衡。层级结构能反映论文的多维度分类，帮助识别研究热点与空白领域。评估显示，基于该结构的LLM代理能更有效定位目标论文，提升可解释性并支持趋势发现，为文献探索提供传统搜索外的替代方案。相关代码和数据已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T20:01:45Z
- **目录日期**: 2025-04-21
