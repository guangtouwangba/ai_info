...
该研究提出"科学层级图谱"(SCIENCE HIERARCHOGRAPHY)，旨在将科学文献组织成多层次分类体系，从宏观领域到具体研究。研究团队开发了结合嵌入聚类与LLM提示的算法，平衡计算效率与语义精度。该方法优于纯LLM方案，能捕捉论文的多维度分类特征。评估显示，基于该层级的LLM代理能更有效地定位目标论文，提升可解释性并支持趋势发现，为文献探索提供了传统检索之外的新途径。相关代码和数据已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T08:01:20Z
- **目录日期**: 2025-04-21
