...
该研究提出"科学层级图谱"(SCIENCE HIERARCHOGRAPHY)，旨在将科学文献组织成多层次分类体系，以追踪跨学科进展。研究者开发了一种结合嵌入聚类与LLM提示的算法，在计算效率与语义精度间取得平衡。该方法能多维度分类论文，比单纯依赖LLM的方法更高效。实验表明，基于该层级的LLM代理能更有效定位目标论文，提升可解释性并支持趋势发现，为文献探索提供了传统检索之外的新途径。相关代码和数据已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T14:01:25Z
- **目录日期**: 2025-04-21
