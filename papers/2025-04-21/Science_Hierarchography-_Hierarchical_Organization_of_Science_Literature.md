...
这篇论文提出了"科学层级分类法"(SCIENCE HIERARCHOGRAPHY)，旨在将科学文献组织成多层次的分层结构，从广泛领域到具体研究进行系统分类。研究者开发了一种结合快速嵌入聚类和LLM提示的算法，在计算效率和语义准确性间取得平衡。该方法能多维度分类论文，反映研究的跨学科特性。实验表明，基于该结构的LLM代理能更有效地定位目标论文，提升文献探索的可解释性，支持趋势发现，为传统搜索方法提供了替代方案。相关代码和数据已在GitHub开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T17:01:10Z
- **目录日期**: 2025-04-21
