...
该研究提出了"科学层级图谱"(SCIENCE HIERARCHOGRAPHY)，旨在将科学文献组织成多层次分类体系，从广泛领域到具体研究。研究者开发了结合快速嵌入聚类与LLM提示的算法，在计算效率与语义精度间取得平衡。该方法超越了传统主题标签，能捕捉论文的多维度分类特征。评估显示，基于LLM的代理能有效利用该层级结构定位目标论文，提升可解释性并支持趋势发现，为文献探索提供了传统检索之外的替代方案。相关代码、数据及演示见GitHub链接。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T07:01:00Z
- **目录日期**: 2025-04-21
