...
这篇论文提出了"科学层级图"(SCIENCE HIERARCHOGRAPHY)的概念，旨在将快速增长的科研文献组织成多层次分类体系。研究者开发了一种结合嵌入聚类和LLM提示的算法，平衡计算效率与语义准确性。相比单纯依赖LLM的方法，该方案在质量和速度间取得更好平衡，并能捕捉论文的多维度特征。评估显示，基于该层级结构的LLM代理能更有效地定位目标文献，提升可解释性，支持趋势发现，为文献探索提供了传统检索之外的新途径。相关代码和数据已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T11:01:10Z
- **目录日期**: 2025-04-21
