...
这篇论文提出了"科学层级图谱"(SCIENCE HIERARCHOGRAPHY)，旨在将科学文献组织成高质量层次结构，以展示从广泛领域到具体研究的多级抽象分类。研究团队开发了结合快速嵌入聚类与LLM提示的算法，在计算效率与语义精度间取得平衡。该方法超越了传统主题标签，能捕捉研究的多维度分类特征。评估显示，基于LLM的智能体能有效利用该层次结构定位目标论文，增强可解释性并支持趋势发现，为文献探索提供了超越传统搜索的新途径。相关代码和数据已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T05:01:14Z
- **目录日期**: 2025-04-21
