...
这篇论文提出了"科学层级图谱"(SCIENCE HIERARCHOGRAPHY)的概念，旨在将科学文献组织成多层次的分层结构，从广泛领域到具体研究进行分类。研究者开发了一种结合快速嵌入聚类与LLM提示的算法，在计算效率和语义准确性之间取得平衡。该方法能反映研究论文的多维度分类，相比传统搜索方法，这种结构化方式提高了可解释性，支持趋势发现，并为文献探索提供了新途径。研究评估表明，基于LLM的智能体能更有效地利用该层级结构定位目标论文。相关代码和数据已在GitHub开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T06:01:05Z
- **目录日期**: 2025-04-21
