...
该研究提出了"科学层级图谱"(SCIENCE HIERARCHOGRAPHY)，旨在将科学文献组织成多层次分类体系，以揭示不同领域的探索密度。研究团队开发了结合嵌入聚类和LLM提示的算法，在计算效率与语义精度间取得平衡。该方法支持跨学科多维分类，相比纯LLM方法更具优势。评估显示，基于该层级的LLM代理能更有效地定位目标论文，提升可解释性并支持趋势发现，为文献探索提供了传统检索之外的替代方案。相关代码、数据及演示已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T18:01:16Z
- **目录日期**: 2025-04-21
