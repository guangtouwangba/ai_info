...
这篇论文提出了"科学层级图谱"(SCIENCE HIERARCHOGRAPHY)，旨在将科学文献组织成多层次的分层结构，从广泛领域到具体研究实现灵活分类。研究者开发了结合快速嵌入聚类与LLM提示的算法，在计算效率与语义精度间取得平衡。该方法比单纯依赖LLM的方法更高效，并能捕捉论文的多维度分类特征。评估显示，基于该结构的LLM代理能更有效地定位目标论文，提升可解释性并支持趋势发现，为科学文献探索提供了超越传统检索的新途径。相关代码和数据已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T12:01:18Z
- **目录日期**: 2025-04-21
