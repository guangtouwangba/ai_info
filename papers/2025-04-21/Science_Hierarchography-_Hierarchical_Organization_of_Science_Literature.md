...
这篇论文提出了"科学层级图谱"(SCIENCE HIERARCHOGRAPHY)，旨在将科学文献组织成多层次的分层结构，从广泛领域到具体研究进行分类。研究者开发了结合嵌入聚类和LLM提示的算法，在计算效率和语义准确性间取得平衡。该方法能多维度分类论文，反映研究的跨学科特性。评估显示，基于LLM的代理能有效利用该层次结构定位目标论文，提升可解释性并支持趋势发现，为文献探索提供了传统搜索之外的新途径。相关代码和数据已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T13:07:23Z
- **目录日期**: 2025-04-21
