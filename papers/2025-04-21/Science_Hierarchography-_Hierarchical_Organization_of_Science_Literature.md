...
这篇论文提出了"科学层级图"(SCIENCE HIERARCHOGRAPHY)的概念，旨在将科学文献组织成多层次的分层结构，从广泛领域到具体研究进行系统分类。研究团队开发了一种结合嵌入聚类和LLM提示的算法，在计算效率和语义准确性之间取得平衡。该方法能捕捉研究论文的多维度分类特征，相比传统方法提高了可解释性，有助于发现研究趋势和空白领域。评估显示，基于LLM的智能体能更有效地利用该层级结构定位目标论文，为科学文献探索提供了超越传统搜索的新途径。相关代码和数据已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T19:01:13Z
- **目录日期**: 2025-04-21
