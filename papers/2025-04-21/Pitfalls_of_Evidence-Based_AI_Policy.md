...
各国正努力制定AI治理政策，但技术上仍存在不确定性和分歧。近期关于"基于证据的AI政策"的讨论强调高标准证据要求，但过度强调证据可能导致系统性风险忽视。历史经验（如1965年烟草、1985年化石燃料争议）表明，"循证政策"常被用作拖延监管、保护行业利益的策略。研究指出，真正的证据导向政策应优先促进AI风险的识别、研究和审议，并提出了15项监管目标。分析显示巴西、加拿大、中国、欧盟、韩国、英国和美国都需加强证据收集政策的实施。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T07:02:14Z
- **目录日期**: 2025-04-21
