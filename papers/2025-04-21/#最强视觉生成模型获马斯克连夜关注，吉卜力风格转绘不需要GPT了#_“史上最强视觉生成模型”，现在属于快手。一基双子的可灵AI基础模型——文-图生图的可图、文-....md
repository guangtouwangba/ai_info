...
快手推出的可灵AI基础模型2.0版本在视觉生成领域取得突破。其中，可图2.0（文/图生图）在对比测试中表现优于MidJourney 7.0和FLUX；可灵2.0（文/图生视频）也显著超越Sora和谷歌Veo2。新版本增强了语义理解和美学能力，新增图像编辑、风格转绘（如吉卜力风格）等功能。该模型因出色表现被称为"史上最强视觉生成模型"，并受到马斯克关注。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T00:03:00Z
- **目录日期**: 2025-04-21
