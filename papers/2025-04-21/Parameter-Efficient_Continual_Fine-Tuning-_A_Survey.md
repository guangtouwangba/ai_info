...
这篇摘要探讨了大规模预训练网络在AI领域的革命性影响及其核心局限——对i.i.d.假设的依赖阻碍了动态学习适应性。作者指出，AI的下一个突破在于实现持续学习(CL)，使模型能适应不断变化的环境。虽然参数高效微调(PEFT)能有效调整大模型，但仍面临灾难性遗忘问题。文章综述了CL算法、PEFT方法及参数高效持续微调(PECFT)的最新进展，分析了不同方法、评估指标及未来研究方向，旨在促进CL与PEFT的协同研究，为新型持续学习模型开辟道路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T04:01:50Z
- **目录日期**: 2025-04-21
