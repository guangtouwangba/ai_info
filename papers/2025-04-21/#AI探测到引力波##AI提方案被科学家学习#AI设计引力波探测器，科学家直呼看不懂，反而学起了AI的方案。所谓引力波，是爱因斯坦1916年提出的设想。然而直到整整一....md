...
德国马克斯·普朗克光科学研究所团队开发了名为Urania的AI系统，成功设计出颠覆传统物理直觉的引力波探测器方案。该AI通过自由探索设计空间，生成大量创新结构，其中部分方案灵敏度比现有设计提升10倍。研究人员筛选出50个最优模型建立公开数据库"Detector Zoo"。这一突破表明AI不仅能优化参数，更能实现结构性创新，甚至提出人类难以理解的解决方案，标志着AI从工具升级为科研合作者，或将开启"机器提出-人类解读"的新科研范式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T14:03:39Z
- **目录日期**: 2025-04-21
