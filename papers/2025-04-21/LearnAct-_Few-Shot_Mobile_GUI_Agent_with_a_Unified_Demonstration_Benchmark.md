...
该研究提出通过人类示范提升移动GUI代理能力的创新方法，而非依赖海量数据集。团队开发了首个专注于示范学习的LearnGUI数据集（含2,252离线任务和101在线任务），并构建了多代理框架LearnAct，包含DemoParser（知识提取）、KnowSeeker（知识检索）和ActExecutor（任务执行）三个模块。实验显示：单次示范使Gemini-1.5-Pro准确率从19.3%提升至51.7%；在线测试中UI-TARS-7B-SFT任务成功率从18.1%提高到32.8%。该框架为移动GUI代理提供了更适应、个性化且可部署的新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T20:02:22Z
- **目录日期**: 2025-04-21
