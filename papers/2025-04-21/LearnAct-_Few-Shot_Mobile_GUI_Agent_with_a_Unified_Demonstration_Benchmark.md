...
该研究提出通过人类示范增强移动GUI代理能力，而非依赖大规模数据集。团队开发了首个示范学习专用数据集LearnGUI（含2,252离线任务和101在线任务），并设计多智能体框架LearnAct，包含演示解析器、知识检索器和执行器三个模块。实验显示：单次示范使Gemini-1.5-Pro准确率从19.3%提升至51.7%；在线测试中UI-TARS-7B-SFT任务成功率从18.1%提高到32.8%。该成果为构建更具适应性、个性化的移动GUI代理提供了新方向，突破了传统预训练方法在多样化场景中的泛化瓶颈。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T16:01:46Z
- **目录日期**: 2025-04-21
