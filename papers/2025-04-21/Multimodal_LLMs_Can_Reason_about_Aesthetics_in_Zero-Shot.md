...
这篇论文探讨了如何利用多模态大语言模型(MLLMs)进行艺术审美判断。研究发现，当前MLLMs在审美推理中存在"幻觉"问题，容易产生主观意见和缺乏依据的艺术解读。作者提出了一种基于证据的客观推理方法ArtCoT，能显著提升MLLMs的审美推理能力，使其产出更全面深入且符合人类审美的判断。这项研究在AI艺术教学和生成艺术的奖励模型等领域具有应用价值，为开发真正理解人类审美标准、能欣赏和创作艺术作品的AI系统奠定了基础。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T02:31:09Z
- **目录日期**: 2025-04-21
