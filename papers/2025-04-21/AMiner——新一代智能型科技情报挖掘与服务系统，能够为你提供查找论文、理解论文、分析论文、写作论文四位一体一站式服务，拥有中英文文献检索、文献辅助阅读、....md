...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译、科研情报订阅等一站式服务。它收录3.5亿论文、0.6亿学者等海量数据，支持中英文文献检索，并能自动生成摘要和问答互动。用户可上传PDF或从平台获取论文，利用AI快速理解内容。此外，AMiner提供个性化科研动态订阅，通过微信或邮件推送最新学术资讯。平台还包含学者画像、学术会议等特色功能，基础服务免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T12:06:11Z
- **目录日期**: 2025-04-21
