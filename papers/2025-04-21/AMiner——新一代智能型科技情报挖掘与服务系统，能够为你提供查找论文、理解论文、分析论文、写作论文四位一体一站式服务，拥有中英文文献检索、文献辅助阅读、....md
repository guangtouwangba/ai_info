...
AMiner是一个智能科技情报挖掘系统，提供论文检索、阅读、分析和写作一站式服务。它支持中英文文献搜索、AI辅助阅读、自动摘要生成和翻译功能，涵盖42个学科的3.5亿论文、0.6亿学者等数据。用户可通过互动问答快速理解文献，订阅个性化科研动态，还能使用学者画像、学术会议等特色功能。平台提供免费浏览器检索，网址为https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T17:05:47Z
- **目录日期**: 2025-04-21
