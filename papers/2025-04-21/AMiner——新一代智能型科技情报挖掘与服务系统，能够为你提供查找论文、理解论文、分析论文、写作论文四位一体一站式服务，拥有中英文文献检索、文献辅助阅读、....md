...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析及写作一站式服务。支持中英文文献搜索、AI辅助阅读、自动摘要生成和翻译功能，覆盖42个学科3.5亿论文资源。特色功能包括互动问答获取文献核心内容、PDF文档智能解析、科研动态订阅推送（通过微信/邮件），以及学者画像等分析工具。平台免费开放基础检索服务，帮助用户高效获取学术信息，显著提升科研效率。访问入口：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T11:06:04Z
- **目录日期**: 2025-04-21
