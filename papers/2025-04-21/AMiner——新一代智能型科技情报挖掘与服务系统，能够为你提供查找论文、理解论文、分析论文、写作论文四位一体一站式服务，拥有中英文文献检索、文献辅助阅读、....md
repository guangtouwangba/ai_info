...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译和科研订阅等一站式服务。它收录了3.5亿篇论文、0.6亿学者和1.5亿专利，支持中英文文献检索和AI生成摘要。用户可通过互动问答快速理解文献内容，并上传PDF进行智能分析。平台还提供个性化科研动态订阅，跟踪最新学术资讯。此外，AMiner包含学者画像、学术会议和论文排行榜等功能，基础服务可免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T20:06:41Z
- **目录日期**: 2025-04-21
