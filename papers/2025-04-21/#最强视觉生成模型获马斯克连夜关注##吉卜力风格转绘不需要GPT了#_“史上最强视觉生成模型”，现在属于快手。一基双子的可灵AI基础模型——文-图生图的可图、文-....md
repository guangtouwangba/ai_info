...
快手推出升级版"可灵AI"视觉生成模型，包含可图2.0（文/图生图）和可灵2.0（文/图生视频）。据称，可图2.0在图像生成上超越MidJourney 7.0和FLUX，可灵2.0在视频生成上优于Sora和谷歌Veo2。新版本提升了语义理解和美学表现，新增图像编辑、风格转绘（如吉卜力风格）等功能，引发马斯克关注。该技术号称"史上最强视觉生成模型"，无需依赖GPT即可实现高质量内容创作。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T02:31:36Z
- **目录日期**: 2025-04-21
