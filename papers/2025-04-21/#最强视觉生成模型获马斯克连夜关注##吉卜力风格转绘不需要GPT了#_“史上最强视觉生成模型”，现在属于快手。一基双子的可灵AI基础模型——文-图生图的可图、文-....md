...
快手发布"可灵AI"2.0版本，包含可图（文/图生图）和可灵（文/图生视频）两大模型。官方宣称其性能显著超越主流竞品：可图2.0对比MidJourney 7.0的胜负比超300%，可灵2.0文生视频对比Sora超360%。新版本提升了语义理解和美学表现，新增图像编辑、风格转绘（如吉卜力风格）等功能，引发马斯克关注。该模型被快手称为"史上最强视觉生成模型"。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-21T04:03:47Z
- **目录日期**: 2025-04-21
