...
本文介绍了Cosmos世界基础模型平台，旨在帮助开发者为其物理AI系统构建定制化的世界模型。该平台包括视频处理管道、预训练的世界基础模型、模型微调示例和视频标记器。世界基础模型作为通用模型，可通过微调适应下游应用需求。为促进物理AI解决社会关键问题，Cosmos平台及其模型以开源和开放权重形式发布，许可宽松，可通过GitHub获取。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-19T20:02:23Z
- **目录日期**: 2025-03-19
