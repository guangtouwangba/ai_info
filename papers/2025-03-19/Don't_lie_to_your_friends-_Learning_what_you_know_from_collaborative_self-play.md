...
本文提出了一种名为“协作自玩”的新方法，用于教导AI代理了解自身能力和限制。通过构建多代理协作环境，团队因共同得出正确答案而获得奖励，从而促使代理学会何时使用参数知识、何时依赖工具输出、何时避免或保留判断。这种方法通过群体奖励机制，激励代理在异构工具环境中协作，以最大化成功并最小化努力。实验表明，这种群体奖励机制能够提升代理在单独部署时的工具使用和选择性预测能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-19T11:13:21Z
- **目录日期**: 2025-03-19
