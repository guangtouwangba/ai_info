...
港科大Harry Yang团队与Everlyn AI等机构合作开发了名为LightGen的图像生成模型，该模型通过知识蒸馏和直接偏好优化策略，显著降低了训练所需的计算资源和数据规模。仅需8张GPU和88个GPU days，LightGen就能实现与当前最先进模型相媲美的高质量图像生成效果。该模型在参数量和预训练数据规模上更为精简，但在基准评测中甚至超越了部分SOTA模型。LightGen的开源特性进一步推动了其在图像生成领域的应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-19T13:12:47Z
- **目录日期**: 2025-03-19
