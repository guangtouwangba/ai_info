...
港科大Harry Yang团队与Everlyn AI等机构合作开发了名为LightGen的图像生成模型，该模型通过知识蒸馏和直接偏好优化策略，显著降低了训练所需的计算资源和数据规模。仅需8张GPU和88个GPU days，LightGen就能实现与当前最先进（SOTA）模型相媲美的高质量图像生成效果，甚至在部分基准评测中超越SOTA模型。LightGen的开源特性使其成为低成本、高效率的图像生成预训练方案，为高质量图像生成任务提供了新的可能性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-19T14:06:19Z
- **目录日期**: 2025-03-19
