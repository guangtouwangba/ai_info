...
豆包编程能力升级后，用户可以在3分钟内制作专属小游戏。新功能包括HTML代码实时预览、Python运行及生成完整项目。示例游戏包括点击匹配中英文泡泡消除单词、点击贺卡随机抽取生日祝福语，以及完成测试题生成MBTI人格。此外，豆包新增运行按钮，可直接在平台内运行Python代码。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-19T22:02:39Z
- **目录日期**: 2025-03-19
