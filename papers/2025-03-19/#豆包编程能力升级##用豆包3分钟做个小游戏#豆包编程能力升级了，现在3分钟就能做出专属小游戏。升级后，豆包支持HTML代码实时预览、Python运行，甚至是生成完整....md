...
豆包编程能力升级，支持HTML代码实时预览、Python运行及生成完整项目。用户可在3分钟内制作专属小游戏，如点击匹配中英文泡泡消除单词、随机抽取生日祝福语及生成MBTI人格测试。升级后，豆包新增运行按钮，可直接在内部运行Python代码，提升编程效率和用户体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-19T18:04:39Z
- **目录日期**: 2025-03-19
