...
VisEscape是一个包含20个虚拟密室逃脱的基准测试，旨在评估AI模型在探索驱动规划中的表现，要求模型通过不断更新知识和连接线索来适应动态变化的环境。研究发现，即使最先进的多模态模型也难以成功逃脱，表现差异显著。为此，研究者提出了VisEscaper模型，整合了记忆、反馈和ReAct模块，使其平均效率提升5倍，效果提升3.7倍，显著改善了模型在复杂环境中的表现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-19T21:02:05Z
- **目录日期**: 2025-03-19
