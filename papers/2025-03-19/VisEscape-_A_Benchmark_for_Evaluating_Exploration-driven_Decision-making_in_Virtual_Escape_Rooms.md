...
VisEscape是一个包含20个虚拟密室逃脱的基准测试，旨在评估AI模型在探索驱动规划中的表现，要求模型通过不断更新知识和连接线索来应对动态变化的环境。研究发现，即使最先进的多模态模型也难以成功逃脱，表现差异显著。为此，提出了VisEscaper模型，通过整合记忆、反馈和ReAct模块，显著提升了性能，平均效果提高了3.7倍，效率提高了5.0倍。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-19T14:02:48Z
- **目录日期**: 2025-03-19
