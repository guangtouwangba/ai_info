...
本研究探讨了人工智能领域中大型语言模型（LLMs）所涉及的伦理问题，包括与其他AI系统共有的隐私和公平性挑战，以及LLMs特有的问题，如幻觉、可验证的责任性和解码审查复杂性。研究强调需要解决这些复杂性以确保责任性、减少偏见并增强LLMs在信息传播中的透明度。提出了缓解策略和未来方向，倡导跨学科合作，推荐针对特定领域的伦理框架和适应多样环境的动态审计系统，旨在指导LLMs的负责任开发和集成，推动以伦理考量为导向的AI进步。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-19T14:03:29Z
- **目录日期**: 2025-03-19
