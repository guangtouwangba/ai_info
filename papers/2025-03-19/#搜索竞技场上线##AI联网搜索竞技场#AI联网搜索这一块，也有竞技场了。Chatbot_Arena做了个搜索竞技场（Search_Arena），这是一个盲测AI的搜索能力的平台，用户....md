...
Chatbot Arena推出了“搜索竞技场”（Search Arena），这是一个盲测AI搜索能力的平台，用户可以通过投票比较不同模型的搜索表现。例如，用户提问“下次月全食是什么时候？”，Search Arena会提供两个模型的回答，并揭示答案来源：模型A为GPT-4o的生成结果，模型B为GPT-4o-mini-search的联网搜索结果。平台还支持图片对话、文生图（如DALL-E 3、Flux、Ideogram）及与GitHub代码仓库对话等功能，方便开发者查询代码。用户可自行判断哪个模型表现更佳。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-19T13:10:32Z
- **目录日期**: 2025-03-19
