...
Chatbot Arena推出了“搜索竞技场”（Search Arena），这是一个盲测AI搜索能力的平台。用户可以通过投票比较不同AI模型的搜索结果，例如询问“下次月全食是什么时候”，系统会展示两个模型的回答并揭示其来源。平台还支持图片对话、文生图（如DALL-E 3、Flux、Ideogram）以及与GitHub代码仓库对话的功能。通过对比案例，用户可以自行判断哪个模型表现更好。感兴趣的用户可以访问相关链接体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-19T14:04:01Z
- **目录日期**: 2025-03-19
