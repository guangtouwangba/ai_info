...
尽管AI在基准测试上进展迅速，但其实际意义仍不明确。为量化AI系统相对于人类的能力，研究者提出新指标“50%任务完成时间跨度”，即人类完成AI模型50%成功率任务所需时间。研究发现，当前前沿AI模型（如Claude 3.7 Sonnet）的50%时间跨度约为50分钟，且自2019年以来每7个月翻倍，2024年可能加速。AI时间跨度的提升主要源于更高的可靠性、错误适应能力、逻辑推理和工具使用能力。若趋势持续，5年内AI或能自动化目前人类需一个月完成的软件任务。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-19T21:01:03Z
- **目录日期**: 2025-03-19
