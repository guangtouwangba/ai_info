...
本文提出了一种新指标“50%-任务完成时间范围”，用于量化AI系统在人类能力方面的表现。该指标指人类完成AI模型能以50%成功率完成的任务所需时间。研究表明，当前前沿AI模型（如Claude 3.7 Sonnet）的50%时间范围约为50分钟，且自2019年以来每7个月翻倍，2024年可能加速。AI时间范围的增加主要归因于更高的可靠性、错误适应能力、逻辑推理和工具使用能力。若该趋势持续，预计5年内AI将能自动化许多目前人类需一个月完成的软件任务。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-19T14:01:14Z
- **目录日期**: 2025-03-19
