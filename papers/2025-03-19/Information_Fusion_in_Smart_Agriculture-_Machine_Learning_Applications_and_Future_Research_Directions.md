...
本文综述了机器学习（ML）在农业中的应用，旨在提升可持续性和效率。研究围绕五个目标展开：分析ML在农业各阶段的应用、探讨ML与农业数据及数据融合的结合、进行文献计量与统计分析、调查AI驱动的农业公司案例、以及整理公开数据集。重点在于ML与多源数据融合（如遥感、物联网和气候分析）如何提升精准农业的预测精度和决策能力。通过案例和统计洞察，展示了AI驱动智能农业的发展趋势，并讨论了异构数据集融合的挑战，为研究者、行业专家和政策制定者提供了信息融合与ML应用的路线图。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-19T17:03:28Z
- **目录日期**: 2025-03-19
