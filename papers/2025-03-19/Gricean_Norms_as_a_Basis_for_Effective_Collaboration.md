...
有效的人机协作不仅依赖于AI遵循明确指令的能力，还取决于其处理沟通中的模糊性、不完整性、无效性和无关性的能力。研究提出了一种结合Gricean准则（数量、质量、关联、方式）和认知框架（共同基础、关联理论、心智理论）的规范性框架，应用于基于大语言模型（LLM）的智能体。实验通过GPT-4驱动的Lamoid智能体在网格世界任务中评估该框架，结果显示，遵循Gricean准则的Lamoid在任务准确性和生成清晰、准确、上下文相关的响应方面表现更优，表明该框架提升了智能体的语用推理能力，促进了人机协作的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-19T19:01:33Z
- **目录日期**: 2025-03-19
