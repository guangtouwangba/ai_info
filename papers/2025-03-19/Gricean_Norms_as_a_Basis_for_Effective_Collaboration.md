...
本文提出了一种整合Gricean准则和认知框架的规范性框架，旨在提升基于大型语言模型（LLM）的智能体在人类-AI协作中的表现。该框架通过Gricean准则（数量、质量、关联、方式）和推理能力，帮助智能体处理模糊、不完整、无效或不相关的指令。实验中使用GPT-4驱动的Lamoid智能体在网格世界任务中与人类协作，结果显示，具备Gricean准则的Lamoid在任务准确性和响应清晰度、准确性及上下文相关性上表现更优，表明该框架能增强智能体的语用推理能力，促进有效的人机协作。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-19T17:01:59Z
- **目录日期**: 2025-03-19
