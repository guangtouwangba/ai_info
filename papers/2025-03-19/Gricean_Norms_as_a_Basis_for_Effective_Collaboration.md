...
有效的人机协作不仅依赖于AI遵循明确指令的能力，还取决于其处理沟通中的模糊性、不完整性、无效性和无关性的能力。研究提出了一种结合Gricean准则（数量、质量、关联、方式）和认知框架（共同基础、关联理论、心智理论）的规范框架，应用于基于大语言模型（LLM）的智能体。通过实验，使用GPT-4驱动的Lamoid智能体在网格世界任务中与人类协作，结果表明，遵循Gricean准则的Lamoid在任务准确性和生成清晰、准确、上下文相关的响应方面表现更优，提升了人机协作的实用推理和情境感知能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-19T14:01:44Z
- **目录日期**: 2025-03-19
