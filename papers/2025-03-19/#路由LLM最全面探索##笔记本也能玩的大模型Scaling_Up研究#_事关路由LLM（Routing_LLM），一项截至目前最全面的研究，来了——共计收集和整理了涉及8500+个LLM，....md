...
路由LLM（Routing LLM）是一项全面研究，涉及8500多个大型语言模型（LLM）在12个基准测试上的2亿条性能记录。该研究通过将ChatGPT、Qwen、DeepSeek等LLM视为“专家”，利用路由器（Router）将输入分配给合适的LLM处理，从而实现高性能、低计算消耗和低幻觉的目标。中山大学和普渡大学的研究人员发现，随着LLM候选数量的增加，路由LLM的性能显著提升，称为“Model-level Scaling Up”。他们还开发了RouterEval评测工具，使其他研究人员能在低计算资源（如笔记本、单卡GPU）下参与研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-19T22:02:50Z
- **目录日期**: 2025-03-19
