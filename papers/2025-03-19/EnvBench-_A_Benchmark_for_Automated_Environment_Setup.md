...
近期，大型语言模型（LLMs）的进展使得研究者能够专注于软件工程领域的实际仓库级任务。本文提出了一种自动化软件仓库环境设置的任务，并引入了全面的环境设置基准EnvBench，涵盖329个Python和665个基于JVM的仓库。EnvBench专注于具有真实配置挑战的仓库，排除了可通过简单确定性脚本完全配置的项目。我们实现了两种自动评估指标，并评估了三种环境设置方法，结果表明EnvBench对当前方法仍具有挑战性。基准套件和实验数据已公开。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-19T13:08:35Z
- **目录日期**: 2025-03-19
