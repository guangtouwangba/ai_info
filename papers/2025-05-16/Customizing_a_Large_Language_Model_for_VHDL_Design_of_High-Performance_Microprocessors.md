...
近年来，大型语言模型（LLM）在硬件设计中的应用逐渐兴起，主要用于提升芯片设计效率。虽然Verilog设计中的LLM应用备受关注，但VHDL的应用研究较少，尽管其在行业中仍广泛使用。本文探讨了针对高性能处理器设计机构的需求，开发专门用于解释VHDL代码的LLM的过程。通过定制测试集和扩展预训练（EPT），专家对代码解释的评分从基础模型的43%提升至69%。此外，开发了LLM-as-a-judge评估方法，进一步优化模型性能，预计专家评分可达71%，未来使用更先进的基模型可能提升至85%以上。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T01:28:44Z
- **目录日期**: 2025-05-16
