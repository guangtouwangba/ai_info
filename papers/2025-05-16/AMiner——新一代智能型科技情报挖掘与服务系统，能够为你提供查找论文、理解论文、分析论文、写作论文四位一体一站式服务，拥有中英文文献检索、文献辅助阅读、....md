...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读辅助、翻译及科研分析等一站式服务。平台拥有3.5亿论文、0.6亿学者等海量学术资源，支持中英文文献检索、AI生成摘要、互动问答及文档翻译功能。用户可订阅个性化科研动态，跟踪机构、学者或关键词的最新成果。此外，AMiner还提供学者画像、学术会议推荐等工具，基础功能免费开放。访问入口：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T12:06:12Z
- **目录日期**: 2025-05-16
