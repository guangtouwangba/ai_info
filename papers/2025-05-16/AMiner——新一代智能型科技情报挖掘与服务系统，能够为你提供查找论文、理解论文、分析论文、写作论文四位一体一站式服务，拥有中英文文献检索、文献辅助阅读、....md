...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析和写作的一站式服务。平台支持中英文文献检索、AI辅助阅读、自动摘要生成和翻译功能，覆盖42个学科3.5亿论文资源。特色功能包括互动问答获取文献要点、文档上传解析、科研动态订阅（通过微信/邮件推送），以及学者画像等工具。用户可免费使用浏览器检索，通过设定关键词或关注对象获取定制化学术资讯，显著提升文献调研效率。平台还提供学术会议追踪和必读论文推荐服务。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T03:24:16Z
- **目录日期**: 2025-05-16
