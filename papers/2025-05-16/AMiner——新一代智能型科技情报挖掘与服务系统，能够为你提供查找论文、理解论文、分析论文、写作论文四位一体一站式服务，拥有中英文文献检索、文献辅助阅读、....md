...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析及写作一站式服务。支持中英文文献搜索、AI辅助阅读、自动摘要生成和翻译功能，覆盖42个学科3.5亿论文资源。特色功能包括：1）智能问答快速解析文献；2）PDF上传自动生成摘要与章节概要；3）定制化科研情报订阅推送；4）学者画像与学术会议追踪。平台免费开放基础检索服务，用户可通过网页或微信小程序访问，实现高效学术信息获取与研究效率提升。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T02:35:14Z
- **目录日期**: 2025-05-16
