...
AMiner是一个智能科技情报挖掘平台，提供一站式论文查找、理解、分析和写作服务。它支持中英文文献检索、AI辅助阅读、自动摘要生成及翻译功能，覆盖42个学科的3.5亿论文、0.6亿学者等数据。用户可通过互动问答快速获取文献核心内容，上传PDF或检索论文后，系统能生成摘要、章节概要和问题建议。平台还支持个性化科研情报订阅，按用户偏好推送最新学术动态。此外，AMiner提供学者画像、学术会议等特色功能，基础服务免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T15:05:53Z
- **目录日期**: 2025-05-16
