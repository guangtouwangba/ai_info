...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和科研情报订阅等一站式服务。它收录了3.5亿论文、0.6亿学者和1.5亿专利，支持中英文文献搜索，并能通过AI生成摘要和回答用户问题。用户可订阅最新科研动态，关注特定学者或关键词。平台还提供学者画像、学术会议和论文排行榜等功能，大部分服务可免费使用。访问地址：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T23:05:09Z
- **目录日期**: 2025-05-16
