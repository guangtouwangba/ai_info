...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、辅助阅读、翻译及科研情报订阅。它覆盖42个学科，拥有3.5亿论文、0.6亿学者等海量数据。用户可通过互动问答快速获取文献摘要，支持PDF上传和AI辅助分析。平台还能定制推送最新科研动态，并具备学者画像、会议追踪等功能。基础检索免费，适合高效学术研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T10:05:52Z
- **目录日期**: 2025-05-16
