...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索（覆盖3.5亿论文）、AI辅助阅读（自动生成摘要/章节概要）、文档翻译及智能问答功能。支持用户上传或检索文献后通过对话深入解析内容。其特色服务包含个性化科研情报订阅（按学者/关键词推送最新成果）、学者画像分析及学术会议追踪。平台整合了42个学科的海量数据（含1.5亿专利和2600万项目），基础功能免费开放，旨在提升文献调研和论文写作效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T06:06:19Z
- **目录日期**: 2025-05-16
