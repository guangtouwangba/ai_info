...
随着大语言模型（LLM）广泛应用，量化其推理阶段的环境影响变得至关重要。本研究提出了一种新型基础设施感知基准框架，评估了30个主流商业模型在数据中心部署时的环境足迹。结果显示，不同模型能耗差异显著：o3和DeepSeek-R1能耗最高（单次长提示超33Wh），是GPT-4.1 nano的70倍；Claude-3.7 Sonnet生态效率最优。单次GPT-4o短查询耗电0.43Wh，但日频7亿次查询将导致年耗电量相当于3.5万美国家庭，淡水消耗满足120万人年饮水需求，碳排放需芝加哥大小的森林抵消。研究揭示了高效个体查询与大规模部署间的资源矛盾，为AI可持续发展提供了标准化评估方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T01:28:55Z
- **目录日期**: 2025-05-16
