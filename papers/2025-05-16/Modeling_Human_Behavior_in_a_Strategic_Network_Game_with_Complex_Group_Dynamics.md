...
该研究比较了多种从小数据集中学习人类在策略网络游戏“初中游戏”(JHG)中行为模型的方法。最佳方法hCAB通过建模行为分布(而非均值)并假设人类具有社区意识行为(而非简单行为匹配)，能准确反映6-11人小群体动态。用户研究显示，人类参与者无法区分hCAB智能体与真人，表明该模型能产生可信的个体行为。这些发现为理解影响社会不平等等人际网络机制提供了新见解，说明社区意识和行为分布建模对准确预测人类网络行为至关重要。(100字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T09:02:23Z
- **目录日期**: 2025-05-16
