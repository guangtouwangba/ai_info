...
该研究比较了不同方法对人类战略网络游戏行为建模的效果，发现hCAB模型表现最佳。hCAB通过建模行为分布而非均值，并假设人类具有社区意识行为而非简单行为匹配，能准确反映小规模群体(6-11人)的动态特征。用户研究显示，参与者无法区分hCAB智能体与真人行为，证实该模型能产生可信的个体行为。这项研究为理解人类网络行为提供了新方法，对解决财富/健康不平等、贫困和霸凌等社会问题具有重要意义。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T05:02:25Z
- **目录日期**: 2025-05-16
