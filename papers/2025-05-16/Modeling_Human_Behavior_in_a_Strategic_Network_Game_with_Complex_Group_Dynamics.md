...
该研究探讨了人类网络对社会不平等、贫困和欺凌等结果的影响，并提出了一种名为hCAB的建模方法，用于模拟人类在战略网络游戏（Junior High Game）中的行为。hCAB通过建模行为的分布而非均值，并假设人类具有社区意识行为而非简单行为匹配，在小规模群体（6-11人）中能准确反映人类群体动态。实验表明，人类参与者无法区分hCAB代理和真实人类行为，验证了该模型在个体行为模拟上的有效性。这一方法为理解人类网络行为提供了新工具，有助于优化社会决策。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T14:02:48Z
- **目录日期**: 2025-05-16
