...
该研究比较了多种从小数据集中学习人类在策略性网络游戏“初中游戏”(JHG)中行为模型的方法。最佳方法是hCAB模型，它通过建模行为分布而非均值，并假设人类具有社区意识行为而非简单行为匹配。在小型社会(6-11人)中，hCAB模型能准确反映群体动态。用户研究还表明，人类参与者无法区分hCAB智能体与真实人类行为，证实该模型能产生可信的个体行为。这些发现有助于理解人类网络对社会不平等等重大议题的影响，为促进有利社会结果提供了新见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T18:02:46Z
- **目录日期**: 2025-05-16
