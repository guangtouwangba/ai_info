...
Anthropic即将推出新版Claude Sonnet和Claude Opus模型，主打"极限推理"功能。该功能通过动态循环结合推理与工具使用，能像人类一样暂停、反思并调整策略，尤其在代码生成时会自动测试修正。新模型架构更智能，减少对人类监督的依赖，支持128k tokens上下文。虽然部分网友质疑炒作，但The Information的报道和用户实测的Claude Neptune模型（疑似Claude 3.8）增加了可信度。Anthropic官方也确认正在进行新版本压力测试，预计几周内发布。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T00:03:08Z
- **目录日期**: 2025-05-16
