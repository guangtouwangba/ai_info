...
Anthropic即将推出新版Claude Sonnet和Claude Opus模型，主打"极限推理"功能。该功能通过动态循环结合推理与工具使用，能像人类一样暂停、重新评估并调整解题策略，尤其在代码生成时会自动测试修正。新模型架构减少对人类监督的依赖，支持128k tokens上下文。虽然部分网友质疑消息真实性，但The Information的报道和用户实测的Claude Neptune模型（疑似Claude 3.8）佐证了升级计划。Anthropic官方也确认正在进行新版本压力测试。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T02:33:15Z
- **目录日期**: 2025-05-16
