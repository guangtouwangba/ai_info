...
当前大语言模型(LLMs)的训练和校准主要基于西方中心主义认知体系，导致文化同质化问题。为评估全球文化包容性(GCI)，研究者提出WorldView-Bench基准测试，基于"多重世界观"理论区分同质化(Uniplex)与多元化(Multiplex)模型。该测试通过自由生成式评估(而非传统分类基准)测量文化极化现象，并采用两种干预策略：上下文提示嵌入多元原则，以及多智能体系统(MAS)整合不同文化视角。实验显示MAS方法使视角分布熵从13%提升至94%，积极情绪达67.7%，显著改善了文化平衡性，为构建更具包容性的AI系统提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T00:01:34Z
- **目录日期**: 2025-05-16
