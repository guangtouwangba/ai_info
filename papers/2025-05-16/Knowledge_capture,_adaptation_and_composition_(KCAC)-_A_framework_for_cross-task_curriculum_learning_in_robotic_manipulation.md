...
本文提出了一种知识捕获、适应与组合（KCAC）框架，通过跨任务课程学习将知识迁移系统化融入强化学习（RL），以解决机器人操作中样本效率低和可解释性差的问题。在CausalWorld基准测试中，KCAC重构了两块堆叠任务的奖励函数，放宽约束以提升灵活性，并设计子任务与结构化课程。实验表明，KCAC相比传统RL方法缩短40%训练时间，成功率提高10%，同时揭示了子任务选择、过渡时机和学习率等课程设计关键参数。该研究为基于课程的RL框架提供了效率优化与概念指导。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T10:01:49Z
- **目录日期**: 2025-05-16
