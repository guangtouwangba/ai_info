...
该研究提出了一种知识捕获、适应与组合（KCAC）框架，通过跨任务课程学习将知识迁移系统化地融入强化学习（RL），以解决机器人操作中样本效率低和可解释性差的问题。研究在CausalWorld基准测试中重构了两块堆叠任务的奖励函数，移除刚性约束以提升灵活性，并设计了两个子任务及结构化课程。实验表明，KCAC相比传统RL方法缩短40%训练时间且成功率提高10%，同时揭示了子任务选择、过渡时机和学习率等关键课程设计参数。该成果为基于课程的RL框架提供了效率优化与概念指导。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T14:02:06Z
- **目录日期**: 2025-05-16
