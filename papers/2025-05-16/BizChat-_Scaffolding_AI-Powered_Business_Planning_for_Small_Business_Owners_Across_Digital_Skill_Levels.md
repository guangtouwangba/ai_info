...
生成式AI虽能帮助小企业主自动化任务、提升效率，但技术门槛仍是主要障碍。研究发现，用户需掌握快捷键、文件转换等辅助技能才能有效使用AI工具。为此，研究者开发了BizChat——基于大语言模型的网页应用，通过"低门槛高上限"设计、即时微学习和业务场景化交互，帮助不同数字技能水平的用户撰写商业计划书。该工具融合了学习科学理念，未来计划进一步部署应用。研究基于设计研讨会和15家小企业访谈，强调在推广AI时需兼顾技术易用性与教育支持。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T14:02:29Z
- **目录日期**: 2025-05-16
