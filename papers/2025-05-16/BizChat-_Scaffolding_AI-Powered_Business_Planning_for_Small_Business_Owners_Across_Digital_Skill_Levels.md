...
生成式AI能帮助小企业主自动化任务、提高效率和改善盈利，但对技术不熟练者仍存在使用障碍。研究表明，除提示工程外，用户还需掌握快捷键、编辑技能等辅助技能。基于设计研讨会和15次访谈，研究者开发了BizChat——一个帮助不同数字技能水平的创业者撰写商业计划的LLM网页应用。其设计融合了三个原则：兼顾低门槛与高扩展性（低地板高天花板）、提供即时微学习支持（适时学习）、围绕商业活动设计交互（情境化技术引入）。未来计划将进一步部署该应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T08:02:23Z
- **目录日期**: 2025-05-16
