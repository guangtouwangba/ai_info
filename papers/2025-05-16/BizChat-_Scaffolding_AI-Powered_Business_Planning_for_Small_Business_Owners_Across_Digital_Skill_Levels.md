...
生成式AI能帮助小企业主自动化任务、提高效率并改善盈利，但对技术不熟悉者仍面临使用障碍。研究表明，除提示工程外，用户还需掌握快捷键、编辑技能等辅助技能。基于设计研讨会和15家小企业访谈，研究者开发了BizChat——一个LLM驱动的网页应用，帮助不同数字技能水平的企业主撰写商业计划书。该应用采用三项设计原则：兼顾新手和高级用户的"低门槛高上限"设计；支持即时学习的微教学；围绕商业场景的交互框架。未来计划进一步部署该应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T04:03:47Z
- **目录日期**: 2025-05-16
