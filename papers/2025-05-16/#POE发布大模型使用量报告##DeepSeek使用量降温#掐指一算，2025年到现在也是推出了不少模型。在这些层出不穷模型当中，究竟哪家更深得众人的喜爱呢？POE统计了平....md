...
POE平台发布的大模型使用量报告显示：GPT-4.1和Gemini 2.5 Pro迅速崛起，分别占据10%和5%的消息份额，而Claude系列下跌10%，DeepSeek R1从7%降至3%。推理模型活跃度提升至10%峰值，Gemini 2.5 Pro占30%份额。图像生成领域，GPT-Image-1和Imagen3竞争激烈，分别占17%和30%。视频生成中，可灵2.0三周内占21%，Veo 2稳定在20%。音频生成由ElevenLabs主导，处理80%的TTS请求，新兴平台如Cartesia等开始竞争。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T17:03:18Z
- **目录日期**: 2025-05-16
