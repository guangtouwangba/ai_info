...
POE平台发布的AI模型使用趋势报告显示：GPT-4.1和Gemini 2.5 Pro迅速崛起，分别占据约10%和5%的消息份额，而Claude系列下降10%；DeepSeek R1热度减退，份额从7%降至3%。推理模型活跃度上升，Gemini 2.5 Pro在订阅用户中占比达30%。图像生成领域竞争激烈，GPT-Image-1和Imagen3份额显著增长。视频生成方面，可灵2.0三周内占据21%份额，Veo 2稳定在20%。音频生成中，ElevenLabs保持80%的TTS请求领先地位。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T19:03:21Z
- **目录日期**: 2025-05-16
