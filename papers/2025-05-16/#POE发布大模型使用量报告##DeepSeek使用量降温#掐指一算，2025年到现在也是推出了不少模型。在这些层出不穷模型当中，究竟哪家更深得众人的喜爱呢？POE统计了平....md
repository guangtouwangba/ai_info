...
POE平台发布的AI模型使用趋势报告显示：GPT-4.1和Gemini 2.5 Pro快速崛起，分别占据约10%和5%的消息份额，而Claude系列下降约10%。DeepSeek R1热度减退，份额从7%降至3%。推理模型活跃度上升，Gemini 2.5 Pro占30%份额。图像生成领域，GPT-Image-1和Imagen3表现突出。视频生成中，Kling-2.0-Master和Veo 2各占约20%份额。音频生成方面，ElevenLabs保持80%的领先地位，新兴平台开始竞争。整体来看，AI模型竞争激烈，各领域均有显著变化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T14:03:28Z
- **目录日期**: 2025-05-16
