...
该研究评估了大语言模型在动态环境中的自适应能力，发现大模型通常优于小模型，但策略性提示可缩小差距。过长的提示对小模型的基础反应任务有负面影响，而大模型表现更稳定。高级提示技术对小模型的复杂任务更有效，但对高性能大模型提升有限。高级推理方法虽能提升表现，但也带来不稳定性。相比人类表现，大语言模型在规划、推理和空间协调等关键领域仍有局限，静态基准无法全面反映推理复杂性，表明当前大模型存在根本性缺陷，仅靠自我反思提示难以完全克服。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T11:01:21Z
- **目录日期**: 2025-05-16
