...
本研究评估了大语言模型在动态环境中的自适应能力，发现更大模型通常表现更好，但策略性提示能缩小性能差距。过长提示会损害小模型在基础任务中的表现，而大模型更稳健。高级提示技术对小模型在复杂任务中帮助更大，但对高性能大模型提升有限。推理方法虽能提升表现，但也会导致不稳定和性能骤降。与人类相比，大语言模型在规划、推理和空间协调等关键领域仍有局限，表明当前模型存在根本性缺陷，无法仅通过自我反思提示完全克服。研究强调需超越静态基准以全面评估推理能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T05:01:15Z
- **目录日期**: 2025-05-16
