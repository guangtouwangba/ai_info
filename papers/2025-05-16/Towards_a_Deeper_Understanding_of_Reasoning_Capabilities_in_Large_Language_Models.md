...
该研究评估了大型语言模型在动态环境中的自适应能力，发现大模型普遍优于小模型，但策略性提示可缩小差距。过长的提示会损害小模型在基础任务上的表现，而大模型表现更稳定。高级提示技术对小模型在复杂任务中更有效，但对高性能大模型提升有限。高级推理方法虽可能显著提升表现，但也带来不稳定性和性能波动。相比人类，大模型在规划、推理和空间协调等关键领域仍存在根本性缺陷，表明仅靠自我反思提示无法完全克服。研究强调需超越静态基准，以全面评估推理能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T08:01:27Z
- **目录日期**: 2025-05-16
