...
该研究评估了大型语言模型在动态环境中的自适应能力，发现大模型通常优于小模型，但策略性提示能缩小性能差距。过长的提示对小模型有负面影响，而大模型表现更稳定。高级提示技术主要提升小模型在复杂任务中的表现，但对高性能大模型帮助有限。推理方法虽能提升决策一致性，但也带来不稳定性。与人类表现相比，大模型在规划、推理和空间协调等关键领域仍存在根本性缺陷，表明仅靠自反思提示无法完全克服。研究强调需超越静态基准，以更全面评估推理能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T21:01:11Z
- **目录日期**: 2025-05-16
