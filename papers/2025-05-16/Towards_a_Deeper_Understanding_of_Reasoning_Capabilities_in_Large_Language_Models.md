...
本研究评估了大型语言模型在动态环境中的自适应能力，发现大模型表现优于小模型，但策略性提示可缩小差距。过长的提示会损害小模型在基础任务上的表现，而大模型更稳健。复杂游戏中，高级提示技术对小模型帮助更大，但对高性能大模型提升有限。推理方法虽能提升表现，但也会导致不稳定和性能骤降。与人类相比，大模型在规划、推理和空间协调等关键领域仍有明显局限，表明当前模型存在根本性缺陷，仅靠自我反思提示无法完全克服。静态基准不足以全面评估推理能力，需转向动态环境测试。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T16:01:17Z
- **目录日期**: 2025-05-16
