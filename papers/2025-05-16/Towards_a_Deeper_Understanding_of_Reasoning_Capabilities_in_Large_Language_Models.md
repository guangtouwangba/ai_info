...
该研究评估了大语言模型在动态环境中的自适应能力，发现更大的模型通常表现更好，但策略性提示可以缩小与小模型的差距。较长的提示对小模型的基本反应任务有负面影响，而大模型表现更稳定。高级提示技术对小模型在复杂任务中帮助更大，但对高性能大模型提升有限。高级推理方法虽能提升表现，但也带来不稳定性。与人类相比，大语言模型在规划、推理和空间协调等关键领域仍存在明显局限，表明当前模型无法仅通过自我反思提示完全克服这些缺陷，需超越静态基准以评估推理复杂性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T03:19:34Z
- **目录日期**: 2025-05-16
