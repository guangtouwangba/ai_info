...
空气污染严重威胁公共健康，加剧呼吸系统和心血管疾病。气候变化引发的极端天气（如野火、热浪）进一步加重污染危害。本研究提出一种创新方法，通过整合可穿戴设备的生理数据与实时环境暴露信息，利用对抗自编码器神经网络构建AI模型，预测个体对污染的健康反应。模型能准确重构时间相关的健康信号，捕捉非线性污染响应，并通过智能手表数据进行迁移学习，提升泛化能力。该云基模块化框架以安全合规的方式整合多源数据，展示了AI在个性化健康监测中的应用潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T13:09:25Z
- **目录日期**: 2025-05-16
