...
空气污染严重威胁公共健康，加剧呼吸和心血管疾病，而气候变化引发的极端天气（如野火、热浪）进一步加重污染影响。本研究提出一种创新方法，通过整合可穿戴设备的生理数据与实时环境暴露信息，利用AI时间序列预测技术（基于对抗自编码器神经网络）来监测和预测个体健康反应。该模型能准确重建健康信号并捕捉污染的非线性影响，结合智能手表数据的迁移学习增强了泛化能力。整个流程采用云端模块化框架，确保数据安全合规，展现了AI在个性化健康监测中的应用潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T18:01:08Z
- **目录日期**: 2025-05-16
