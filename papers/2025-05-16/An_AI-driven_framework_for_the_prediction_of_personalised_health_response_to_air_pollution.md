...
空气污染严重威胁公众健康，加剧呼吸和心血管疾病。气候变化引发的极端天气（如野火、热浪）进一步加重污染危害。本研究提出一种创新方法，通过整合可穿戴设备的生理数据与实时环境暴露信息，利用对抗自编码器神经网络预测个体健康反应。该模型能准确重建时间依赖性健康信号，捕捉污染的非线性影响，并采用迁移学习提升泛化能力。基于云计算的模块化框架确保数据收集安全合规，智能手表数据验证了该方案对真实场景的适应性。研究表明AI模型能有效预测个体化污染健康风险。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T02:30:26Z
- **目录日期**: 2025-05-16
