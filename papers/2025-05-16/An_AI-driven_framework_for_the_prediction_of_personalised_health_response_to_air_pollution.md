...
空气污染严重威胁公共健康，加剧呼吸系统和心血管疾病。气候变化导致野火、热浪等极端天气增多，进一步加重污染危害。本研究提出一种创新方法，通过整合可穿戴设备的生理数据与实时环境暴露信息，利用对抗自编码器神经网络预测个体健康反应。该模型能准确重建时间相关的健康信号，捕捉污染的非线性影响，并通过智能手表数据进行迁移学习，提升模型泛化能力。整个系统采用云端模块化框架，在保证数据安全与伦理的前提下，实现了对个性化健康风险的动态监测与预测。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T07:01:15Z
- **目录日期**: 2025-05-16
