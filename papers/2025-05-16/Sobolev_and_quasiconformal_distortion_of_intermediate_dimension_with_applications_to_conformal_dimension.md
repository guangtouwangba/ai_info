...
该研究探讨了超临界Sobolev映射、拟共形及拟对称同胚下中间维度的畸变问题，扩展了Gehring-Väisälä定理（拟共形映射依赖膨胀的维度畸变）和Kovalev定理（不存在共形维度严格介于0和1之间的度量空间）到中间维度场景。应用包括对欧几里得集拟共形分类的新贡献，以及共形盒维数消失的新充分条件。研究结论具体应用于Bedford-McMullen地毯、Mandelbrot渗流样本及含多项式收敛序列因子的乘积集，为相关领域提供了新的理论支持。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T23:01:30Z
- **目录日期**: 2025-05-16
