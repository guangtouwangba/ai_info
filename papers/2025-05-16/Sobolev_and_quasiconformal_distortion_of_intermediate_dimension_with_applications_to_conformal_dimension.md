...
该研究探讨了超临界Sobolev映射、拟共形及拟对称同胚下中间维度的畸变问题。主要成果包括：将Gehring-Väisälä定理（拟共形映射依赖膨胀的维度畸变）和Kovalev定理（不存在共形维度严格介于0和1之间的度量空间）推广到中间维度场景。应用方面提出了欧几里得集拟共形分类的新结论，以及共形盒维数消失的新判据。研究结果对Bedford-McMullen地毯、Mandelbrot渗流样本和含多项式收敛序列因子的积集等具体案例具有直接推论，深化了对分形结构在非线性变换下维度演化的理解。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T11:01:46Z
- **目录日期**: 2025-05-16
