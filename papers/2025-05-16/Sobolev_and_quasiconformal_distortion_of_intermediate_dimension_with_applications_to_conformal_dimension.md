...
该研究探讨了超临界Sobolev映射、拟共形及拟对称同胚对中间维数的影响，扩展了Gehring-Väisälä定理（拟共形映射的维数畸变）和Kovalev定理（度量空间共形维数不存在0到1之间的严格值）到中间维数领域。应用包括对欧几里得集拟共形分类的新贡献，以及共形盒维数消失的新充分条件。研究结论具体应用于Bedford-McMullen地毯、Mandelbrot渗流样本及含多项式收敛序列因子的乘积集，为相关分形结构的维数分析提供了新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T10:01:39Z
- **目录日期**: 2025-05-16
