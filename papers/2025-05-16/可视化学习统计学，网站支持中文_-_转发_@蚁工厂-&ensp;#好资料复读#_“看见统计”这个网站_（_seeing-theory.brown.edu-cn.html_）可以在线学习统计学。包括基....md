...
"看见统计"是一个由布朗大学本科生Daniel Kunin创建的可视化学习网站(seeing-theory.brown.edu/cn.html)，通过交互式数据可视化帮助理解统计学概念。网站包含基础/进阶概率论、概率分布、频率学派与贝叶斯学派的统计推断、回归分析等核心内容，支持中英双语。其特色是将抽象的统计理论转化为直观的图形演示，如通过动态图表展示概率分布和统计推断过程。该项目曾获IEEE VIS数据故事竞赛奖，适合统计学初学者通过视觉化方式建立直观认知。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T23:02:28Z
- **目录日期**: 2025-05-16
