...
“看见统计”是一个由布朗大学本科生Daniel Kunin创建的可视化统计学学习网站（seeing-theory.brown.edu/cn.html），提供中英双语支持。该网站通过动态数据可视化直观展示六大核心模块：基础/进阶概率论、概率分布、频率学派与贝叶斯学派的统计推断，以及回归分析。其特色在于将抽象的统计概念转化为交互式图形，帮助学习者更轻松理解统计学原理。项目最初源于本科课程作业，现已发展为系统的可视化教学工具，适用于统计学入门和复习。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T22:02:28Z
- **目录日期**: 2025-05-16
