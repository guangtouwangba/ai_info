...
"看见统计"（seeing-theory.brown.edu/cn.html）是一个可视化学习统计学的双语网站，由布朗大学本科生Daniel Kunin创建。该平台通过动态数据可视化讲解六大核心模块：基础/进阶概率论、概率分布、频率学派与贝叶斯学派的统计推断，以及回归分析。其特色在于将抽象统计概念转化为直观的交互图表，大幅降低学习门槛。网站支持中英文切换，尤其适合中文用户理解统计学原理。作为开源教育项目，曾获IEEE VIS数据故事竞赛奖项，现已成为全球流行的统计学习辅助工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T16:02:51Z
- **目录日期**: 2025-05-16
