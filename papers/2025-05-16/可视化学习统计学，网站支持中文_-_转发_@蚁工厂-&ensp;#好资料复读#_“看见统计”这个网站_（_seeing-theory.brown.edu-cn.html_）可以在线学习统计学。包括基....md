...
“看见统计”是一个由布朗大学学生Daniel Kunin创建的可视化统计学学习网站（seeing-theory.brown.edu/cn.html），提供中英双语支持。该网站通过数据可视化直观展示统计概念，涵盖基础/进阶概率论、概率分布、频率学派与贝叶斯学派的统计推断，以及回归分析六大核心模块。其特色是将抽象理论转化为交互式图表，帮助学习者更易理解统计学原理。网站最初是本科期间的学术项目，现已成为突破语言障碍的优质统计学习资源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T21:02:32Z
- **目录日期**: 2025-05-16
