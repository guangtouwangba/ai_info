...
“看见统计”是由布朗大学本科生Daniel Kunin创建的可视化统计学学习网站（seeing-theory.brown.edu/cn.html），提供中英双语支持。该网站通过交互式数据可视化讲解六大核心模块：基础/进阶概率论、概率分布、频率学派与贝叶斯学派的统计推断，以及回归分析。其特色是将抽象统计概念转化为直观的动态图表，大幅降低学习门槛，尤其适合视觉型学习者。项目最初作为本科教学创新成果，现已成为国际通用的统计教育工具，曾入选#AI创造营#推荐资源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T19:02:44Z
- **目录日期**: 2025-05-16
