...
"看见统计"是由布朗大学本科生Daniel Kunin创建的可视化统计学学习网站(seeing-theory.brown.edu/cn.html)，提供中英双语支持。该网站通过交互式数据可视化，帮助用户更直观地理解六大核心统计概念：基础/进阶概率论、概率分布、频率学派与贝叶斯学派的统计推断，以及回归分析。其特色是将抽象的统计理论转化为动态图形演示，大幅降低学习门槛。项目最初是本科期间的创作，现已成为广受欢迎的教育资源，尤其适合视觉学习者和统计初学者快速建立直观认知。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T20:02:41Z
- **目录日期**: 2025-05-16
