...
Sam Altman在红杉资本内部分享中指出，不同年龄段用户对ChatGPT的使用方式存在显著代际差异，这直接影响他们通过AI工具获取资源的能力。年轻人更倾向于将AI用于创造性工作和效率提升，而年长用户多用于基础信息查询。这种使用方式的差异导致AI工具产生的价值存在明显分层，反映出数字原住民与数字移民在技术应用深度上的鸿沟。该现象引发对AI时代技能代际传递的思考，强调需要针对性培训来缩小数字代沟。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T20:02:51Z
- **目录日期**: 2025-05-16
