# 奥特曼分享AI使用代沟 - 转发 @行痴·知无畏:&ensp;Sam Altman 红杉资本内部分享：不同年龄段的人群对ChatGPT的不同用法，决定了他们能通过AI 工具撬动多大的资...
...
Sam Altman在红杉资本内部分享中指出，不同年龄段用户使用ChatGPT的方式存在显著代际差异，这直接影响他们通过AI工具撬动资源的能力。年轻人更擅长将AI用于创造性工作和效率提升，而年长用户多停留在基础功能使用。这种认知差异导致AI工具的价值挖掘程度不同，形成"数字鸿沟"。分享强调需要针对不同群体开展AI教育，缩小使用代沟，最大化人工智能的社会价值。该观点引发对AI普及策略的思考，相关话题#ai生活指南#、#ai创造营#受到关注。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T19:02:53Z
- **目录日期**: 2025-05-16
