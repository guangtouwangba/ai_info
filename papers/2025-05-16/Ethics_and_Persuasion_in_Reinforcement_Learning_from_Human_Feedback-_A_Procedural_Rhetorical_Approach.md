...
2022年以来，ChatGPT等生成式AI通过人类反馈强化学习(RLHF)技术优化输出，使语言模型表现更接近人类。这种技术进步在提升交互质量的同时，也引发了关于透明度、偏见和社会关系的伦理担忧。本文从修辞学角度分析RLHF如何重塑语言规范、信息获取和社交期待，突破传统对AI生成内容说服力的研究框架，转向探究其底层说服机制。理论层面揭示了AI技术可能强化语言霸权、延续偏见、脱离语境学习并影响人际关系，为AI伦理研究开辟新方向，对教育工作者、学者及AI使用者具有重要启示意义。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T01:29:16Z
- **目录日期**: 2025-05-16
