# #Cursor官方指南教你选模型##如何在Cursor中选择正确的模型#还不知道如何在Cursor里选择最适合你的模型？官方教程都来啦！Cursor官网发布了一份指南，直接把应该...
...
Cursor官方发布模型选择指南，提出三个关键维度：自信度（如Gemini-2.5-pro快速决策）、思考深度（如o3深入规划）、上下文容量（大任务需高容量模型）。模型分为思考型（自主决策，如Claude-3.7-sonnet）和非思考型（需明确指令，如GPT-4.1）。任务适配建议：小改动用Claude-3.5-sonnet，大规模重构用Claude-3.7-Sonnet，复杂bug修复用o3。指南包含选择流程图，帮助用户快速匹配需求。原文链接：https://docs.cursor.com/guides/selecting-models

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T01:30:28Z
- **目录日期**: 2025-05-16
