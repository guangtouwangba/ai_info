...
vivo与香港科技大学联合研发的PreSelect数据筛选方法被ICML 2025收录，该方法通过fastText评分器实现高效数据选择，计算需求降低10倍。其核心是"预测强度"(Predictive Strength)指标，通过分析模型loss与下游任务表现的排序一致性来评估数据价值，优先保留对模型能力提升显著的高质量数据。该方法基于"压缩即智能"理论，相比传统方法更具理论基础和泛化性，减少了人工规则依赖，使数据筛选更客观高效。相关技术细节已在微信文章公开。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T02:33:06Z
- **目录日期**: 2025-05-16
