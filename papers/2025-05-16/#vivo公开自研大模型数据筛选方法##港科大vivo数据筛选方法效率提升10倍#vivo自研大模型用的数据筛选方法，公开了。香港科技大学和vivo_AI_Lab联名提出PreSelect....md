...
vivo与香港科技大学联合研发的PreSelect数据筛选方法被ICML 2025接收。该技术通过fastText评分器计算数据的"预测强度"(Predictive Strength)，利用模型loss与下游任务表现的排序一致性筛选高质量数据，使计算需求降低10倍。该方法基于"压缩即智能"理论，认为模型压缩数据能力(BPC)与智能水平正相关，通过客观指标替代人工规则，提升筛选效率和泛化性。相比现有方案，PreSelect具有更强理论支撑，能更有效识别对模型能力提升显著的数据样本。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T00:02:58Z
- **目录日期**: 2025-05-16
