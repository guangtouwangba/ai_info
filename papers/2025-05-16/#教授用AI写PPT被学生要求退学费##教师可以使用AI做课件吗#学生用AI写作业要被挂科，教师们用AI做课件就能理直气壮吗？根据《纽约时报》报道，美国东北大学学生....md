...
美国东北大学学生Ella Stapleton因教授使用AI制作课件却未告知，要求退还8000美元学费。事件引发教育界对AI使用的争议：学生质疑教师禁止他们用AI却自己依赖AI工具，认为高价学费不应只获得AI生成内容。调查显示2024年教师使用AI比例较2023年翻倍至36%，但使用规范尚未统一。校方驳回退费请求但出台新规，要求标注AI内容并人工审核。涉事教授承认需更谨慎使用AI并明确告知学生。事件凸显AI在教育中引发的公平性与透明度问题。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T01:31:21Z
- **目录日期**: 2025-05-16
