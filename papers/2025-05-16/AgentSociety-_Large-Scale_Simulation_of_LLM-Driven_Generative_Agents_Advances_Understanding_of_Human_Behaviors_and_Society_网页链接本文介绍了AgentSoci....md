...
该研究开发了AgentSociety，一个基于大语言模型的大规模社会模拟系统，能够模拟1万多个代理及其500万次互动。该系统被用于研究四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，验证了该系统捕捉人类行为机制的能力。研究表明，这种AI驱动的模拟器可作为传统社会科学研究方法的补充工具，帮助研究者更深入地理解社会现象，并为政策制定提供新的研究途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T08:05:49Z
- **目录日期**: 2025-05-16
