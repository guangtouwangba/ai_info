...
本文介绍了一个名为AgentSociety的大规模社会模拟器，它结合了LLM驱动的智能代理、真实社会环境和大规模模拟引擎。研究者通过模拟1万多个代理及其500万次互动，研究了社会极化、信息传播、基本收入政策以及自然灾害影响等关键问题。模拟结果与现实世界数据吻合，验证了该平台在捕捉人类行为机制方面的能力，展示了其作为社会科学研究和政策制定工具的潜力。这一创新方法为理解复杂社会现象提供了新的计算实验手段。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T23:04:42Z
- **目录日期**: 2025-05-16
