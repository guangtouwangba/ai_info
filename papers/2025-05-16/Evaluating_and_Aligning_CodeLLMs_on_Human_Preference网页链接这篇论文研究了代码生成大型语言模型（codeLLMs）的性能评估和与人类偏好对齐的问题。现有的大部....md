...
这篇论文研究了代码生成大模型(codeLLMs)与人类偏好的对齐问题。作者创建了CodeArena基准测试(包含397个样本,覆盖40类任务和44种编程语言)来评估模型在真实编程场景中的表现,同时构建了20B标记的SynCode-Instruct合成指令数据集。研究发现:1)传统基于执行的测试与人类偏好存在差异;2)开源顶级模型(Qwen2.5-Coder)与商业模型(OpenAI o1)性能差距显著。研究凸显了代码LLMs与人类偏好对齐的重要性,为改进代码生成模型提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T11:06:19Z
- **目录日期**: 2025-05-16
