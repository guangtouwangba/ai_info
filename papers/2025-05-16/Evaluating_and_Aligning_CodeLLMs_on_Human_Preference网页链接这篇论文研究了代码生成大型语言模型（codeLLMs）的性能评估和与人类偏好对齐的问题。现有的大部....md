...
这篇论文研究了代码生成大模型(codeLLMs)与人类偏好的对齐问题，提出了CodeArena基准测试(包含397个样本，覆盖40类任务和44种语言)来评估模型在真实编程场景中的表现。研究还构建了20B标记的SynCode-Instruct合成指令集验证微调效果。实验发现执行基准与人类偏好存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，凸显了人类偏好对齐的重要性。研究为提升代码LLMs的实际应用价值提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T03:24:26Z
- **目录日期**: 2025-05-16
