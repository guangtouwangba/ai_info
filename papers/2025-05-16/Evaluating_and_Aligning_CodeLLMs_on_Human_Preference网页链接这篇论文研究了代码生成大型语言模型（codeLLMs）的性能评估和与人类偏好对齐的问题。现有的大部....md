...
这篇论文研究了代码生成大模型(codeLLMs)与人类偏好的对齐问题。作者创建了CodeArena基准测试，包含397个高质量样本，覆盖40个类别和44种编程语言，更贴近实际编程场景。同时构建了SynCode-Instruct语料库(近20B标记)验证合成指令微调效果。实验显示，传统基于执行的测试与CodeArena存在差异，开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，突出了对齐人类偏好的重要性。研究为评估和改进代码生成模型提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T23:05:19Z
- **目录日期**: 2025-05-16
