...
这篇论文针对代码生成大型语言模型(codeLLMs)提出新评估方法，关注人类偏好对齐问题。研究者创建了CodeArena基准测试(包含397个高质量样本，覆盖40类任务和44种编程语言)和SynCode-Instruct合成指令语料库(近200亿标记)。实验发现现有基于执行的评估与人类偏好存在差距，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著。研究强调代码LLMs不仅需要正确性，还需符合人类编程偏好，为模型优化提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T10:06:03Z
- **目录日期**: 2025-05-16
