...
本文提出了一种通过AI反馈学习提升文本到音频(T2A)生成模型性能的方法。针对现有模型在复杂多事件音频生成中难以满足人类偏好的问题，研究者开发了细粒度音频评分系统，包括事件匹配度、事件序列准确性和音质评估三项指标。这些自动评分与人类偏好高度相关。基于此构建了包含4.1万提示和24.9万音频的T2A-FeedBack数据集，并推出专注长文本、多事件场景的T2A-EpicBench基准测试。实验表明，简单的偏好调优就能显著提升模型在简单和复杂场景下的生成质量。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-16T11:00:59Z
- **目录日期**: 2025-05-16
