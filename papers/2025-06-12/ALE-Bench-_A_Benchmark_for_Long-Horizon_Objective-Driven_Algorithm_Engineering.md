...
ALE-Bench是一个新的AI基准测试，用于评估AI系统在基于分数的算法编程竞赛中的表现。该测试借鉴了AtCoder Heuristic竞赛的真实任务，涉及计算复杂度高的优化问题（如物流路线、排班调度等），且无已知精确解。与短时、二元评判的编程测试不同，ALE-Bench支持长期迭代优化，并提供测试反馈和可视化工具。评估显示，前沿大语言模型（LLMs）在特定问题上表现优异，但在跨问题一致性和长期问题解决能力上仍显著落后于人类。该基准旨在推动AI在复杂算法工程领域的进步。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T01:28:40Z
- **目录日期**: 2025-06-12
