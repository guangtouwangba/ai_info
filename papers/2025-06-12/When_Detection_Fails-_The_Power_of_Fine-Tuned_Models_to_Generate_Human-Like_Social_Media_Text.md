...
检测社交媒体上的AI生成文本极具挑战性，主要由于文本简短且语言非正式。研究者模拟威胁攻击者，创建了包含505,159条AI生成帖子的数据集，涵盖11个争议话题。研究发现，在已知生成模型的理想条件下可有效检测，但若攻击者不公开其微调模型，检测效果大幅下降。人类实验证实了这一结论。消融实验显示，现有检测算法对微调模型存在明显漏洞。这一发现对所有检测领域均有影响，因为微调是LLM的常见应用场景。研究突显了社交媒体作为舆论操纵渠道的风险。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T11:01:46Z
- **目录日期**: 2025-06-12
