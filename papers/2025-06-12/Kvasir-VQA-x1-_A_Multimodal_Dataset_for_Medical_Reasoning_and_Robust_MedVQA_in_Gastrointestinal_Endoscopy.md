...
研究人员推出了Kvasir-VQA-x1数据集，这是一个针对胃肠道内窥镜的大规模医学视觉问答数据集。该数据集在原有基础上新增了159,549个问题-答案对，旨在测试更深入的临床推理能力。通过使用大语言模型系统生成分层复杂度的临床问题，并引入模拟常见成像伪影的视觉增强技术，该数据集支持标准VQA性能和模型鲁棒性两个评估方向。Kvasir-VQA-x1遵循FAIR数据原则，为开发更可靠的临床多模态AI系统提供了具有挑战性的基准测试。数据集已开源，可通过GitHub和HuggingFace获取。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T21:01:56Z
- **目录日期**: 2025-06-12
