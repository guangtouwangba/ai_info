...
微软亚洲研究院联合清华、北大提出强化预训练（RPT）新范式，通过强化学习改造传统自监督训练。RPT让模型在预测前进行推理思考（如自我批评/纠正），基于OmniMATH数据集和GRPO算法优化，使14B小模型达到32B大模型的推理水平。实验显示RPT-14B在数学竞赛等任务中推理能力显著提升，并展现计算资源的幂律缩放效应。该方法突破单纯token预测模式，通过奖励机制增强深度推理，有望成为AI预训练新方向。论文见：https://arxiv.org/abs/2506.08007

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T00:03:28Z
- **目录日期**: 2025-06-12
