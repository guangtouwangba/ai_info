...
上海交通大学、斯坦福大学等机构联合开发了Video-Bench视频评估框架，利用多模态大模型（MLLM）模拟人类认知过程，实现对AI生成视频质量的自动化评估。该框架能精准检测物体一致性（相关性0.735）、动作合理性等问题，并解决传统美学质量评估难题，性能显著优于现有方法。这一技术将推动电影、广告、VR等领域的视频生成模型优化，使AI视频更符合人类审美需求。研究成果已入选CVPR2025。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T14:03:48Z
- **目录日期**: 2025-06-12
