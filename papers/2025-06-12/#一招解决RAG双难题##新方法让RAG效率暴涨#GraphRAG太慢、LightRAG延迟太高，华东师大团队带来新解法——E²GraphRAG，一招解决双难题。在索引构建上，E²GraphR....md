...
华东师范大学团队提出E²GraphRAG新方法，有效解决GraphRAG速度慢和LightRAG延迟高的问题。该方法在索引构建上比GraphRAG快10倍，查询速度是LightRAG的100倍。E²GraphRAG采用两步策略：先用大模型生成文档树提取多粒度信息，再用SpaCy抽取实体关系构建轻量图。这种结合信息层级和实体关系的方法，在保持细粒度处理的同时大幅提升效率，为RAG系统提供了更优解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T09:01:52Z
- **目录日期**: 2025-06-12
