...
华东师大团队提出E²GraphRAG新方法，有效解决GraphRAG速度慢和LightRAG延迟高的双重问题。该方法在索引构建上比GraphRAG快10倍，查询速度是LightRAG的100倍。E²GraphRAG采用两步策略：先用大模型构建文档总结树提取多粒度信息，再用SpaCy抽取实体关系图。这种结合总结树和实体图的方法，既保留了信息处理的细粒度，又显著提升了检索效率和准确性，实现了轻量但信息丰富的检索系统。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T13:12:39Z
- **目录日期**: 2025-06-12
