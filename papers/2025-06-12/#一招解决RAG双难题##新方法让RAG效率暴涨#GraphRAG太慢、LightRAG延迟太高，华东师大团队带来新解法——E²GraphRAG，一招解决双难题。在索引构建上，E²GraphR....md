...
华东师大团队提出E²GraphRAG新方法，有效解决GraphRAG速度慢和LightRAG延迟高的问题。该方法在索引构建上比GraphRAG快10倍，查询速度是LightRAG的100倍，同时保持信息处理的精度。E²GraphRAG采用两步策略：先用大模型生成文档树提取多粒度信息，再用SpaCy抽取实体关系构建轻量图。这种结合层级总结和实体关系的方法，既提升了检索效率，又增强了信息处理的细粒度和准确性，实现了高效且精准的检索系统。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T12:03:05Z
- **目录日期**: 2025-06-12
