...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献搜索，拥有3.5亿论文、0.6亿学者等海量数据，并能通过AI生成摘要、翻译和问答互动。用户可订阅个性化科研动态，追踪学者或领域进展。平台还提供文献辅助阅读、文档识别等功能，帮助高效理解内容。免费使用，适合科研人员快速获取学术资源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T15:04:04Z
- **目录日期**: 2025-06-12
