...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索（覆盖3.5亿论文）、AI辅助阅读（自动生成摘要/问答）、文档翻译及科研动态订阅（支持微信/邮件推送）。其特色功能包含学者画像、学术会议追踪及必读论文推荐，支持用户上传PDF或直接检索文献库进行交互式分析。平台免费开放基础服务，可通过网页或小程序使用，显著提升文献调研与论文写作效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T06:04:23Z
- **目录日期**: 2025-06-12
