...
本文提出了Agentic Neural Network（ANN）框架，将多智能体协作建模为分层神经网络结构。每个智能体作为节点，每层形成专注于子任务的协作团队。ANN采用两阶段优化：前向阶段动态分解任务并逐层构建智能体团队；反向阶段通过迭代反馈优化协作，使智能体自我进化角色和协调方式。这种神经符号方法使ANN能创建新专业团队，显著提升准确性和适应性。在四个基准测试中，ANN在相同配置下优于现有多智能体基线，展现了可扩展的数据驱动框架优势，结合了LLM协作能力与神经网络效率。框架将开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T00:01:36Z
- **目录日期**: 2025-06-12
