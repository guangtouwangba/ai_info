...
朴茨茅斯大学Enrique Gaztanaga教授提出新理论，认为宇宙大爆炸可能不是起点，而是超大质量黑洞坍缩后量子反弹的结果。该理论结合广义相对论和量子力学，指出费米子的不相容原理能阻止无限坍缩，导致物质反弹形成新宇宙。这种机制自然解释宇宙加速膨胀（暴胀和暗能量），无需引入额外维度等假设。理论预测宇宙存在微小正曲率，未来观测或可验证。该模型还暗示我们宇宙可能位于更大"母宇宙"的黑洞内部，呈现宇宙循环的新图景。（99字）  

核心突破：用量子效应改写奇点定理，将大爆炸重构为黑洞坍缩-反弹过程。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T17:03:39Z
- **目录日期**: 2025-06-12
