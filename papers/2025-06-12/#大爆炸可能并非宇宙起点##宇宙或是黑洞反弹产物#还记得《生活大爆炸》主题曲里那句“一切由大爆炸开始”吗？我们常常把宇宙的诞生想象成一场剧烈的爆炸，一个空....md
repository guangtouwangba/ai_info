...
朴茨茅斯大学Enrique Gaztanaga教授提出颠覆性理论，认为宇宙大爆炸可能源自黑洞引力坍缩后的量子反弹。该理论指出，当物质被压缩至极高密度时，量子不相容原理会阻止奇点形成，迫使坍缩物质反弹，形成新宇宙。这一过程自然解释了宇宙加速膨胀现象（暴胀和暗能量），且完全兼容现有物理理论。模型预测宇宙应存在微小正曲率，未来可通过观测验证。该理论暗示我们的宇宙可能位于某个"母宇宙"的黑洞内部，将大爆炸重新诠释为宇宙循环中的一环而非绝对起点。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T22:02:42Z
- **目录日期**: 2025-06-12
