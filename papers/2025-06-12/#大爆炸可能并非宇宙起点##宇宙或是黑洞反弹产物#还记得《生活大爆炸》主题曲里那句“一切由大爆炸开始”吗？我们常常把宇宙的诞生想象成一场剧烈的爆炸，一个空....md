...
朴茨茅斯大学Enrique Gaztanaga教授提出颠覆性理论，认为宇宙大爆炸可能源于超大质量黑洞的引力坍缩反弹，而非传统认知的奇点起源。该理论结合量子力学与广义相对论，指出量子不相容原理能阻止无限坍缩，导致物质反弹形成新宇宙。模型预测宇宙存在微小正曲率，并自然解释暴胀和暗能量现象。若观测证实空间曲率，将支持这一"黑洞宇宙"假说。该理论暗示我们的宇宙可能位于某个母宇宙的黑洞内部，呈现宇宙循环的新图景。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T11:03:14Z
- **目录日期**: 2025-06-12
