...
上海交大与上海AI Lab联合团队提出IDEAL方法，通过优化SFT训练集的数据配比，显著提升大语言模型(LLM)的综合性能。研究表明，训练数据量并非关键，不当的数据配比反而会加剧模型"偏科"现象。该方法使原本不擅长编程的Llama 3.1-8B模型代码能力明显提升，证明科学调整训练集组成能有效缓解LLM的领域能力不平衡问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T02:31:50Z
- **目录日期**: 2025-06-12
