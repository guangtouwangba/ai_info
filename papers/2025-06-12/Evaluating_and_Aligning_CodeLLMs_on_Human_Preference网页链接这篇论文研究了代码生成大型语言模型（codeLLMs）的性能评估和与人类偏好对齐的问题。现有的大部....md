...
这篇论文针对代码生成大模型（codeLLMs）提出新评估方法，关注现有基准忽视的人类偏好问题。研究者构建了CodeArena基准（397个高质量样本，覆盖40类编程任务和44种语言）和20B标记的合成指令数据集SynCode-Instruct。实验发现执行基准与人类偏好评估存在差异，开源模型（如Qwen2.5-Coder）与商业模型（如OpenAI o1）性能差距显著。研究凸显了代码生成模型与人类偏好对齐的重要性，为改进模型提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T01:33:26Z
- **目录日期**: 2025-06-12
