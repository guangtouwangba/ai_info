...
这篇论文针对代码生成大模型(codeLLMs)提出新评估框架CodeArena，通过397个涵盖40类编程任务和44种语言的人类精选样本，评估模型输出与人类偏好的对齐程度。研究发现传统基于执行的测试与人类偏好存在显著差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI)性能差距明显。同时构建了20B标记量的合成指令数据集SynCode-Instruct验证微调效果，强调代码生成模型除正确性外还需关注人类编程习惯和需求，为提升模型实用性提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T23:05:29Z
- **目录日期**: 2025-06-12
