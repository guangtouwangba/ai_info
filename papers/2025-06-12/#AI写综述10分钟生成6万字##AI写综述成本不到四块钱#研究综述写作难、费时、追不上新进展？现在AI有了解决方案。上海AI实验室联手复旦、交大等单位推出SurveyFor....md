...
上海AI实验室联合复旦、交大等机构推出SurveyForge框架，能自动生成高质量学术综述。该系统10分钟可产6万字，成本仅0.5美元，通过两阶段流程实现：首先生成结构化大纲（基于60万篇论文和2万篇综述数据），再通过"学者导航代理"SANA模块智能检索文献，确保内容相关性。采用并行生成+协调机制解决长文本一致性问题，既涵盖经典文献又追踪最新研究。该成果已被ACL 2025收录，显著提升综述写作效率并降低成本。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T21:02:52Z
- **目录日期**: 2025-06-12
