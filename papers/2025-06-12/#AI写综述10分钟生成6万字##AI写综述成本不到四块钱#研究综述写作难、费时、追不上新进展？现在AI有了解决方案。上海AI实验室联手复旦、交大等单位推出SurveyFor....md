...
上海AI实验室联合复旦、交大等机构开发了SurveyForge框架，可自动生成高质量学术综述。该系统通过两阶段流程：先融合60万篇论文和2万篇大纲生成结构化框架，再通过SANA模块智能检索文献，平衡经典与前沿研究。其并行协调机制确保6万字长文内容一致性，10分钟即可完成，成本不足0.5美元（约3.6元）。该成果已被ACL 2025接收，解决了传统综述写作耗时、追新难的问题。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T11:03:01Z
- **目录日期**: 2025-06-12
