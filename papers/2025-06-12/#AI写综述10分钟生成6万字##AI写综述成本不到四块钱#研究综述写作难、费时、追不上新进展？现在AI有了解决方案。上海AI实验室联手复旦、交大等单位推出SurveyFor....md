...
上海AI实验室联合复旦、交大等机构推出SurveyForge框架，可自动生成高质量学术综述，被ACL 2025接收。该系统10分钟可生成6万字综述，成本不足0.5美元（约4元人民币）。其采用两阶段流程：先通过融合arXiv论文和综述大纲数据库生成结构化大纲，再通过"学者导航代理"SANA模块提升文献相关性，解决检索遗忘问题。采用并行协调机制确保长文一致性，兼顾经典与新兴研究。该系统显著提升综述写作效率，降低时间和经济成本。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T15:01:30Z
- **目录日期**: 2025-06-12
