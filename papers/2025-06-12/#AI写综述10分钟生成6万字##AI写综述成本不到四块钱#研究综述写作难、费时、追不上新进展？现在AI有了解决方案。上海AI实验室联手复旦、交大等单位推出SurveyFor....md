...
上海AI实验室联合复旦、交大等机构推出SurveyForge框架，可自动生成高质量学术综述，被ACL 2025接收。该系统通过两阶段流程：先融合60万篇论文和2万篇大纲生成结构化框架，再通过"学者导航代理"模块提升文献相关性。其并行协调机制确保长文一致性，10分钟可生成6万字综述，成本不足0.5美元（约3.6元人民币）。特点包括结构清晰、内容质量高，并能兼顾经典文献与前沿研究，解决了传统综述写作耗时长、成本高的问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T22:02:34Z
- **目录日期**: 2025-06-12
