...
上海AI实验室联合复旦、交大等机构研发的SurveyForge框架，可自动生成高质量学术综述。该系统通过两阶段流程：先融合60万篇论文和2万篇大纲生成结构化框架，再通过"学者导航代理"模块提升文献相关性。其特点包括10分钟生成6万字、成本仅0.5美元，采用并行协调机制确保内容一致性。该技术解决了传统综述写作耗时长、成本高的问题，已被ACL 2025接收。系统能兼顾经典文献与新兴研究，显著提升学术写作效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T16:02:55Z
- **目录日期**: 2025-06-12
