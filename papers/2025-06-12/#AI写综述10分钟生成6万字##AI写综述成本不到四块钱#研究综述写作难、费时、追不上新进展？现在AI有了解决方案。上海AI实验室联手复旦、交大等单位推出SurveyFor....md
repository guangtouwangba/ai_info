...
上海AI实验室联合复旦、交大等机构推出SurveyForge框架，可自动生成高质量学术综述，被ACL 2025接收。该系统通过两阶段流程实现：首先生成结构化大纲，再填充内容。其核心创新"SANA模块"通过子查询记忆、检索记忆和时间感知重排序技术，提升文献相关性。该系统能在10分钟内生成6万字综述，成本仅0.5美元（约4元人民币），采用并行协调机制确保内容一致性。该方案解决了传统综述写作耗时长、成本高、难跟新进展的问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T14:03:18Z
- **目录日期**: 2025-06-12
