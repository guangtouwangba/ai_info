...
中兴通讯团队针对AI代码补全工具在工业场景中的不足，提出两个新评测指标和仓库级代码处理框架，以缩小AI建议与开发者需求间的差距。当前工具如GitHub Copilot常因"局部视野"和评价标准偏差导致补全质量不佳，尤其在跨文件复杂场景中表现受限。该研究旨在提升专业场景（如中兴自研ZTE-Code-Copilot）的实用性，通过更全面的代码库分析和开发者真实需求评估，使AI补全更精准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T13:12:19Z
- **目录日期**: 2025-06-12
