...
中兴通讯团队针对AI代码补全工具在工业场景中的不足，提出两个新评测指标和一套仓库级代码处理框架，旨在缩小AI建议与开发者实际需求间的差距。当前工具如GitHub Copilot虽提升效率，但存在建议质量不足、缺乏全局代码库理解等问题。新方法通过优化模型对跨文件、模块的深层语义依赖的把握，提升补全准确性和实用性，特别适用于中兴自研的ZTE-Code-Copilot等专业场景，为代码大模型在复杂工业环境中的应用开辟新路径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T14:03:59Z
- **目录日期**: 2025-06-12
