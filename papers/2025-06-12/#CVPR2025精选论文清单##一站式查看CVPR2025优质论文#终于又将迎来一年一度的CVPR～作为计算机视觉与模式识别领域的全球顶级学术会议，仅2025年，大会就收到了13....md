...
CVPR2025作为计算机视觉领域顶级会议，共收到13,008篇投稿，录用2,878篇。为帮助研究者快速定位优质论文，网友整理了一份精选清单，涵盖视觉语言模型、视觉智能体、目标跟踪、开放世界检测等热门方向，同时包含深度估计和3D视觉等领域成果。清单提供论文链接、代码、演示视频和海报等配套资源，并开放补充建议。精选论文可通过GitHub获取，完整录用列表详见CVPR官网。该资源为研究者提供了高效的一站式论文检索方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T12:01:32Z
- **目录日期**: 2025-06-12
