...
CVPR2025作为计算机视觉顶级会议，收到13,008篇投稿，录用2,878篇。为帮助研究者快速定位优质论文，网友整理了一份精选清单，涵盖视觉语言模型(VLMs)、视觉智能体、目标跟踪、开放世界检测等热门方向，同时包含深度估计和3D视觉等领域。清单提供论文链接、代码、演示视频和海报等资源，并支持用户补充推荐优秀论文。精选清单和完整录用论文可通过GitHub和CVPR官网查看。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T14:03:08Z
- **目录日期**: 2025-06-12
