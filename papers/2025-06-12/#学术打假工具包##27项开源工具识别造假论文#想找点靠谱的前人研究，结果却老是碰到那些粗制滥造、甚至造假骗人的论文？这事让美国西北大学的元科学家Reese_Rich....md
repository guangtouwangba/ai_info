...
美国西北大学Reese Richardson团队发布《开放科学诚信指南合集》(COSIG)，整合27种免费开源工具，提供跨学科论文造假识别方案。该指南涵盖图像重复检测、引用操纵、AI生成文本、论文工厂特征等常见问题，并针对生物学、化学等特定领域提供专业审查技巧（如细胞系真实性验证、实验伦理合规性等）。同时包含实用建议：如何在PubPeer发表建设性评论、向期刊举报问题、处理学术人际关系等。该动态更新项目将持续收集反馈，旨在提升科研诚信审查效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T00:03:00Z
- **目录日期**: 2025-06-12
