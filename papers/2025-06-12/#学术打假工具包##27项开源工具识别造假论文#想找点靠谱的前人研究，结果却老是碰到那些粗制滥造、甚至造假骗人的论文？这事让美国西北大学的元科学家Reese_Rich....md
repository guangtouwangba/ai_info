...
美国西北大学Reese Richardson团队开发了《开放科学诚信指南合集》(COSIG)，整合27种免费工具和实用技巧，帮助识别学术造假。该指南涵盖图像重复、剽窃、AI生成文本等跨学科问题，并提供特定领域(如生物、化学)的审查方法，包括检测问题细胞系、异常实验数据等。此外还包含举报流程指导、PubPeer平台使用建议等人际处理技巧。该开源项目将持续更新，旨在提升学术研究的可信度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T02:31:30Z
- **目录日期**: 2025-06-12
