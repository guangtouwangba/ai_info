...
美国西北大学Reese Richardson团队发布《开放科学诚信指南合集》(COSIG)，整合27种免费工具帮助识别学术造假。该指南提供跨学科检测方法，包括图像重复、AI生成文本、论文工厂特征等，并针对生物、化学等特定领域给出审查技巧（如细胞系真实性、实验伦理合规性）。同时包含实用建议：如何在PubPeer发表建设性评论、举报问题论文及处理相关人际关系。该开源工具包将持续更新，旨在提升学术研究可信度。配图展示了指南界面及部分检测工具示例。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T03:22:47Z
- **目录日期**: 2025-06-12
