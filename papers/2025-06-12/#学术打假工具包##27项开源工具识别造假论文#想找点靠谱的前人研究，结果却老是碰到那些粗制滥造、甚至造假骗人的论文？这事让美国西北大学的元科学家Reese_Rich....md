...
美国西北大学Reese Richardson团队发布《开放科学诚信指南合集》(COSIG)，整合27种免费工具用于识别学术造假。该指南提供跨学科检测方法，包括图像重复、AI生成文本、引用操纵等问题，并针对生物学、化学等特定领域给出审查技巧（如细胞系真实性、实验伦理合规性等）。同时提供实用建议：如何在PubPeer发表建设性评论、向期刊举报问题以及处理人际关系。该开源项目将持续更新，旨在帮助科研人员辨别问题论文，维护学术诚信。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T01:30:32Z
- **目录日期**: 2025-06-12
