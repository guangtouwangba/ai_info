...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能够模拟1万多个智能代理的社会互动（达500万次）。研究者利用该平台研究了四大社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，验证了系统对人类行为和社会机制的捕捉能力。该系统可作为计算社会科学研究的创新工具，为政策制定提供数据支持，弥补传统研究方法（如问卷调查）的局限性，帮助深入理解复杂社会现象的内在机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T23:04:53Z
- **目录日期**: 2025-06-12
