...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能够模拟1万多个智能代理的社会互动（500万次交互）。该系统通过四个关键社会问题的研究（社会极化、信息传播、基本收入政策、自然灾害影响），验证了其模拟结果与现实世界数据的一致性。研究表明，这种LLM驱动的模拟器能有效捕捉人类行为机制，可作为计算社会科学研究的创新工具，为政策制定提供新视角。该系统结合了生成式AI、真实社会环境和大规模模拟引擎，展现了人工智能在社会科学研究中的应用潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T04:07:51Z
- **目录日期**: 2025-06-12
