...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理及其500万次社会互动。该系统通过真实社会环境和大规模模拟引擎，研究了社会极化、信息传播、基本收入政策及自然灾害影响等四大社会问题。模拟结果与现实世界数据高度吻合，验证了该系统捕捉人类行为机制的能力。研究表明AgentSociety可作为计算社会科学的有力工具，为研究社会问题模式和制定政策提供新方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T00:04:56Z
- **目录日期**: 2025-06-12
