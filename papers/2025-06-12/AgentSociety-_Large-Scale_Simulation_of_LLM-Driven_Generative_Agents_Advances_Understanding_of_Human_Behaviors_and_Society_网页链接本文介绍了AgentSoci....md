...
AgentSociety是一个基于大型语言模型的大规模社会模拟器，可模拟超过1万个代理及其500万次互动。研究者用它探索了社会极化、信息传播、基本收入政策及飓风影响四个关键问题。模拟结果与现实世界数据吻合，验证了该工具捕捉人类行为机制的能力。这一系统为社会科学研究和政策制定提供了新方法，能辅助传统调查和干预手段，帮助理解社会问题的模式和成因。研究表明，LLM驱动的模拟器具有成为社会科学重要工具的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T09:04:47Z
- **目录日期**: 2025-06-12
