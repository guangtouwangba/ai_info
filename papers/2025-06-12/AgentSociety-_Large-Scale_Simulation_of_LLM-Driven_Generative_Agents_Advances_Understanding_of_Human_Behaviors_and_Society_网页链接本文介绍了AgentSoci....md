...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理的社会互动（500万次交互）。该系统通过研究四大社会问题（社会极化、信息传播、基本收入政策、自然灾害影响），验证了其模拟结果与现实数据的吻合度，展示了在社会科学研究和政策制定中的应用潜力。该平台能有效补充传统研究方法（如调查、访谈），帮助揭示社会问题的模式和内在机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T07:04:34Z
- **目录日期**: 2025-06-12
