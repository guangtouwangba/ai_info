...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟平台。该系统模拟了1万多个AI代理的社会生活，记录了500万次互动，用于研究社会现象如信息传播、政策影响等。通过四个案例研究，证明其模拟结果与现实数据吻合，展现了作为社会科学研究工具的潜力。该平台能帮助研究者探索社会问题的模式和机制，为政策制定提供新方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-12T17:05:37Z
- **目录日期**: 2025-06-12
