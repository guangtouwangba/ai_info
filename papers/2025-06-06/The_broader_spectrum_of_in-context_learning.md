...
这篇论文提出了一种新视角，将语言模型的少样本学习能力置于更广泛的"元学习上下文学习"框架中。作者认为，任何能通过上下文显著降低后续预测损失的序列分布，都可以视为引发某种上下文学习。这一观点有助于统一语言模型展现的各种上下文能力，如根据指令适应任务、角色扮演或时间序列外推等。研究还揭示了上下文学习可能与语言依赖的低层次处理（如共指或平行结构）有关，并强调了泛化能力的重要性。作者建议未来研究应考虑更广泛的上下文能力类型和泛化维度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T11:02:30Z
- **目录日期**: 2025-06-06
