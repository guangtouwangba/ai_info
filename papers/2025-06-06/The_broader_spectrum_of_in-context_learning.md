...
这篇论文提出了一种新视角，将语言模型的少量样本上下文学习能力置于更广泛的元学习谱系中。作者认为任何能通过上下文显著降低后续预测损失的序列分布都可视为一种上下文学习。这一观点有助于统一语言模型展现的各种上下文能力，如根据指令适应任务、角色扮演或时间序列外推等。研究还揭示了上下文学习可能源于语言依赖关系(如共指或平行结构)的低层次处理。作者强调泛化能力研究应从多维度展开，包括学习新颖内容、不同呈现方式的灵活性以及应用所学知识的能力。最后呼吁未来研究应关注更广泛的上下文能力类型和泛化形式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T23:02:33Z
- **目录日期**: 2025-06-06
