...
这篇论文提出了一种新视角，将语言模型的少量示例学习能力置于更广泛的元学习上下文学习框架中。作者认为，任何能通过上下文显著降低后续预测损失的序列分布，都可视为引发某种上下文学习。这一观点有助于统一语言模型展现的各种上下文能力，如根据指令或角色扮演适应任务、预测时间序列等。研究还揭示了上下文学习可能与语言依赖处理（如共指或平行结构）的低层次处理有关，并强调了泛化能力研究的重要性，包括学习新颖内容、适应不同呈现方式及应用所学知识等方面。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T20:02:23Z
- **目录日期**: 2025-06-06
