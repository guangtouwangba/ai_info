...
CVPR 2025将举办《从视频生成到世界模型》教程，探讨视频生成技术如何从简单的动态内容发展为具备时空一致性、因果推理能力的高质量输出，并可能成为构建世界模型的关键。教程将聚焦视频生成在感知、交互、物理推理等方面的潜力，以及其如何支撑具身智能发展。来自学界和产业界的研究者将分享生成建模、3D理解、强化学习等前沿进展，解析视频生成向交互式世界模型演进的路径。活动将于2025年6月11日在美国纳什维尔举行，官网和资料库已开放。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T01:30:57Z
- **目录日期**: 2025-06-06
