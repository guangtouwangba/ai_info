...
CVPR 2025教程《从视频生成到世界模型》将探讨视频生成技术的最新进展及其向世界模型的演进方向。当前视频生成已从基础动态内容发展为具备叙事、动作控制和长时推理能力的高质量输出。以可灵、Sora等为代表的新一代模型正突破边界，研究者关注视频生成能否成为构建可交互、可推理世界模型的基础，并支撑具身智能发展。教程汇聚学界与产业界专家，围绕生成建模、3D理解、强化学习等方向，探索如何将视频生成转化为感知-决策一体化的智能基座。活动将于2025年6月11日在美国纳什维尔举行。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T03:24:35Z
- **目录日期**: 2025-06-06
