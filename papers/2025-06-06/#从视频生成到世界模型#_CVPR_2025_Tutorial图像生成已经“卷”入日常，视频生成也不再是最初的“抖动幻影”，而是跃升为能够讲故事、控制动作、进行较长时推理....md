...
CVPR 2025将举办主题为"从视频生成到世界模型"的教程，探讨视频生成技术如何发展为可交互、可推理的世界模型。随着可灵、Sora等模型的突破，视频生成已从简单动态内容提升到具备时空一致性和因果推理能力。该教程将汇集学术界和产业界专家，讨论如何将生成能力转化为感知、预测和决策的智能基座，赋能具身智能发展。重点关注视频生成作为视觉先验，如何理解物体交互、人类行为及物理语义因果，最终构建交互式世界模型。活动将于2025年6月11日在美国纳什维尔举行。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T02:33:26Z
- **目录日期**: 2025-06-06
