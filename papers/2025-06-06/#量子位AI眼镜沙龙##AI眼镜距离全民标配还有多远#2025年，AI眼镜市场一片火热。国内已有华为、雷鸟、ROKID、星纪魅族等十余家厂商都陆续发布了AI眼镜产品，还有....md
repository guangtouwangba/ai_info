...
2025年AI眼镜市场竞争激烈，华为、雷鸟等十余家厂商已推出产品，"百镜大战"开启。量子位计划6月下旬在北京举办AI眼镜沙龙，探讨行业现状与未来，包括产品挑战、杀手级应用及全民标配路径。活动面向产业链企业、投资机构等，线上线下同步进行。核心议题聚焦市场反馈、爆款要素及发展阶段。报名可通过量子位公众号。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T17:02:31Z
- **目录日期**: 2025-06-06
