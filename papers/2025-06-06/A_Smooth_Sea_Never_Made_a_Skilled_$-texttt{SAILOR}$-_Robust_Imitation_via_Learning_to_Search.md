...
行为克隆（BC）方法在模仿学习中的根本局限在于，它仅能教会智能体在专家访问过的状态下模仿行为，而一旦偏离演示轨迹，智能体无法自主恢复。本文提出“学习搜索”（L2S）框架，通过从专家演示中学习世界模型和奖励模型，使智能体能在测试时规划恢复策略，无需额外人工修正。在12项视觉操作任务中，新方法SAILOR显著优于基于BC的扩散策略，即使BC数据量扩大5-10倍仍存在性能差距。SAILOR能识别细微错误并避免奖励作弊，代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T12:02:06Z
- **目录日期**: 2025-06-06
