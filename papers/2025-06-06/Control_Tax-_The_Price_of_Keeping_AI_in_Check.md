...
本文提出"控制税"(Control Tax)概念，用于衡量AI控制机制在运营和财务上的成本。研究贡献包括：(1)建立量化控制税的理论框架，将分类器性能与安全保证关联；(2)在对抗环境下评估先进语言模型，研究攻击模型植入代码后门与监控模型检测的对抗；(3)提供控制协议的实际成本估算，开发平衡安全性与成本效益的优化监控策略。该框架通过系统连接安全保证与其成本，帮助从业者做出明智决策，推动AI控制领域发展。研究强调在AI部署中需兼顾安全保证与经济可行性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T08:02:09Z
- **目录日期**: 2025-06-06
