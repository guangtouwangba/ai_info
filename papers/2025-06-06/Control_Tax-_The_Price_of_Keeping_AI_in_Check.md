...
本文提出"控制税"(Control Tax)概念，量化AI控制机制的操作和财务成本，为AI控制领域做出三项贡献：(1)建立理论框架，将分类器性能映射到安全保证；(2)在对抗环境下评估先进语言模型，研究攻击模型植入后门与监控模型检测漏洞的对抗；(3)提供控制协议的实际成本估算，开发平衡安全性与成本效益的优化监控策略。该框架通过系统连接安全保证与其成本，帮助从业者做出明智决策，推动AI控制在各种部署场景中的经济可行性评估。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T09:01:55Z
- **目录日期**: 2025-06-06
