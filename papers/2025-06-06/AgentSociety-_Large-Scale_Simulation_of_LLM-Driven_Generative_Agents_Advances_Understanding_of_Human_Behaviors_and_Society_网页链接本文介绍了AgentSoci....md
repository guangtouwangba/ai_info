...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个智能代理及其500万次社会互动。该系统被用于研究四大社会问题：社会极化、信息传播、基本收入政策效果和自然灾害影响。模拟结果与现实世界数据高度吻合，验证了该系统对人类行为和社会机制建模的有效性。研究表明，AgentSociety能作为计算社会科学研究的创新平台，为学者和政策制定者提供传统调查方法外的补充研究工具，有助于深入理解复杂社会现象背后的模式和机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T05:05:16Z
- **目录日期**: 2025-06-06
