...
这篇论文介绍了AgentSociety，这是一个利用大型语言模型(LLM)驱动的大规模社会模拟系统。该系统模拟了1万多个AI代理的社会生活，产生了500万次互动，用于研究社会现象如政治极化、信息传播、基本收入政策影响和自然灾害应对。研究结果显示，模拟结果与现实世界数据高度吻合，验证了该系统在理解人类行为和社会机制方面的有效性。AgentSociety为社会科学研究和政策制定提供了新的实验平台，能够补充传统研究方法，帮助探索复杂社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T06:03:54Z
- **目录日期**: 2025-06-06
