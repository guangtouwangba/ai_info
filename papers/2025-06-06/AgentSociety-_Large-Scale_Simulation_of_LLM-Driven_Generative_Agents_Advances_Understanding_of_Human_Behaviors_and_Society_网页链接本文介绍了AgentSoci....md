...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟超过1万个代理及其500万次社会互动。研究者用它研究了四个关键社会问题：社会极化、信息传播、基本收入政策效果和外部冲击（如飓风）影响。模拟结果与现实世界数据吻合，验证了该系统捕捉人类行为机制的能力。该平台可作为传统社会科学研究方法（如调查、访谈）的补充工具，帮助研究者分析社会问题的模式和成因，为政策制定提供新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T02:34:48Z
- **目录日期**: 2025-06-06
