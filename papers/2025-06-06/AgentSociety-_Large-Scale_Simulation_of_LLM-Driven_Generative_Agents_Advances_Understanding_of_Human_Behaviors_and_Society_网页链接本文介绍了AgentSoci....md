...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个代理及其500万次互动。研究者用它研究了四个社会问题：社会极化、信息传播、基本收入政策影响和自然灾害冲击。模拟结果与现实数据吻合，验证了该系统在捕捉人类行为机制方面的有效性。该系统可作为计算社会科学研究平台，辅助传统方法（如调查和干预）分析社会问题的模式和成因，为研究者和政策制定者提供新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T03:25:54Z
- **目录日期**: 2025-06-06
