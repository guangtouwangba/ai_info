...
当前大语言模型（LLMs）主要用于同步对话（轮流发言），但现实场景（如群聊、在线会议或社交游戏）多为异步交流。本研究开发了一种异步LLM智能体，能自主决定发言内容和时机。通过在"狼人杀"游戏中与人类玩家互动测试，该智能体表现与人类相当，既能融入群体，发言时机也与人类相似（但内容存在差异）。研究发布了数据集和代码，推动LLMs在更真实的异步场景（如团队协作、教育等）中的应用。这项工作为LLMs融入复杂社交环境奠定了基础。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T19:01:28Z
- **目录日期**: 2025-06-06
