...
当前大语言模型(LLMs)主要应用于同步对话场景，而现实中的群聊、在线会议等往往是异步交流。本研究开发了一种异步LLM智能体，能自主决定发言内容和时机。通过在"狼人杀"游戏中与人类玩家互动测试，该智能体在游戏表现和社交融入度上都达到人类水平。分析显示其发言时机选择与人类相似，但内容存在差异。研究团队公开了所有数据和代码，为LLM在团队协作、教育等复杂社交场景的应用铺平道路。这项工作推动了LLM向更自然的异步群体交互方向发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T10:01:42Z
- **目录日期**: 2025-06-06
