...
当前大语言模型(LLMs)主要用于同步对话，而现实场景如群聊、在线会议等多为异步交流。本研究开发了一种异步LLM智能体，不仅能决定"说什么"，还能判断"何时说"。通过在"狼人杀"游戏中测试，该智能体表现与人类相当，能自然融入群体。分析显示其发言时机选择与人类相似，但内容存在差异。研究公开了数据集和代码，为LLM在团队协作、教育等复杂社交场景的应用铺平道路，推动更真实的异步人机交互研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T16:01:40Z
- **目录日期**: 2025-06-06
