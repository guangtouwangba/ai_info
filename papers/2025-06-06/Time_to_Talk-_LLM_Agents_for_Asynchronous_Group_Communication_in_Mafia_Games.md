...
当前大语言模型(LLMs)主要用于同步对话，而现实场景如群聊、在线会议或社交游戏往往是异步的。本研究开发了一种自适应异步LLM智能体，不仅能决定说什么，还能决定何时发言。通过在"狼人杀"游戏中与人类玩家互动测试，该智能体在游戏表现和融入度上都与人类相当。分析显示其发言时机选择与人类相似，但内容存在差异。研究公开了所有数据和代码，为LLM在团队讨论、教育等复杂社交场景的应用铺平道路，推动更真实的异步人机交互研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T20:01:31Z
- **目录日期**: 2025-06-06
