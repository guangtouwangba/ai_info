...
当前大语言模型(LLMs)主要用于同步对话，而现实场景多为异步交流(如群聊、在线会议等)。本研究开发了一种异步LLM智能体，能自主决定发言时机和内容。通过在"狼人杀"游戏中与人类玩家互动测试，该智能体在游戏表现和社交融入度上均达到人类水平，发言时机选择与人类相似，但发言内容存在差异。研究发布了完整数据集和代码，为LLMs融入真实人类群体场景(如团队协作、教育等)奠定了基础，推动LLMs在复杂社交动态环境中的应用发展。(99字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T07:01:44Z
- **目录日期**: 2025-06-06
