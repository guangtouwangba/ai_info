...
多智能体协作工作流常因提示设计不佳导致错误传播和性能下降。研究者提出ProRefine方法，利用大语言模型的文本反馈动态优化推理任务的提示，无需额外训练或标注数据。在5个数学推理基准测试中，该方法比零样本思维链基线提升3-37个百分点，使小模型能媲美大模型性能，提升了AI系统的准确性、可扩展性和普及性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T08:01:56Z
- **目录日期**: 2025-06-06
