...
本文介绍了ProRefine，一种创新的推理时提示优化方法，旨在解决多智能体协作工作流中的错误传播和性能不佳问题。该方法利用大语言模型的文本反馈动态优化多步推理任务的提示，无需额外训练或真实标签。在五个数学推理基准测试中，ProRefine显著优于零样本思维链基线3-37个百分点。该方法不仅能提高准确性，还能使小型模型达到与大型模型相当的性能，展示了其在高效、可扩展AI部署方面的潜力，有助于普及高性能AI技术的应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T11:01:40Z
- **目录日期**: 2025-06-06
