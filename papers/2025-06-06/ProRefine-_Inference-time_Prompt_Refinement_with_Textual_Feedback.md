...
ProRefine是一种创新的即时提示优化方法，通过利用大语言模型(LLM)的文本反馈来提升多智能体工作流的性能。该方法无需额外训练或真实标签，就能动态优化多步推理任务的提示。在五个数学推理基准测试中，ProRefine比零样本思维链基线提高了3-37个百分点。它不仅提高了准确性，还能使小型模型达到大型模型的性能，有助于高效、可扩展的AI部署，并促进高性能AI的普及。该技术有效解决了智能体工作流中因提示设计不佳导致的错误传播和性能欠佳问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T12:01:47Z
- **目录日期**: 2025-06-06
