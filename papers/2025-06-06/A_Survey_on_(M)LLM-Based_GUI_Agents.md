...
这篇综述系统梳理了基于大语言模型（LLM）的图形用户界面（GUI）代理的最新进展，分析了其四大核心组件：结合文本解析和多模态理解的感知系统、基于知识库构建的探索机制、采用高级推理的任务规划框架，以及具备安全控制的交互系统。研究揭示了LLM和多模态学习如何革新跨平台GUI自动化，同时指出现有评估框架的局限性，提出了标准化方向。文章还探讨了元素定位、知识检索、长程规划和执行安全等关键技术挑战，为智能界面自动化的未来发展提供了研究思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T03:23:10Z
- **目录日期**: 2025-06-06
