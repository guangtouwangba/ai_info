...
PNAS最新研究发现，大脑衰老存在关键转折点：40岁后（43岁左右）脑网络开始不稳定，60岁后加速衰退，主因是神经元出现胰岛素抵抗导致葡萄糖利用障碍。研究通过2万份脑影像数据发现，酮体（D-βHB）可作为替代能源显著改善40-59岁人群的脑功能（60岁以上效果减弱），而葡萄糖无效。机制表明酮体可绕过胰岛素通路直接供能。7T fMRI扫描证实，早期补充酮体可能延缓认知衰退，但干预需在60岁前进行。该研究为预防老年痴呆提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T02:33:37Z
- **目录日期**: 2025-06-06
