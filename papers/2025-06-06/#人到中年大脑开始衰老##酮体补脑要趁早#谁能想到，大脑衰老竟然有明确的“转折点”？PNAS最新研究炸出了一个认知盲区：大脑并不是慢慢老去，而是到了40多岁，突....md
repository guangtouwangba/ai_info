...
PNAS最新研究发现，大脑衰老存在关键转折点：40岁后脑网络开始失稳（43岁左右），60岁后加速衰退。研究分析近2万人脑影像数据，揭示神经元胰岛素抵抗是主因——脑细胞无法有效利用葡萄糖供能。实验显示，补充酮体（D-βHB）可显著改善40-59岁人群脑功能（60岁以上效果减弱），因其能绕过胰岛素通路直接供能。7T-fMRI证实酮体可稳定神经网络，提示中年期是干预认知衰退的"窗口期"。该研究为阿尔茨海默病预防提供了新思路：及早调整脑能量供给方式比后期药物干预更关键。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T01:31:11Z
- **目录日期**: 2025-06-06
