...
复旦大学与腾讯优图实验室合作开发了新型AI算法DualAnoDiff，用于解决工业异常检测中异常数据稀缺的问题。该基于扩散模型的少样本生成方法能高效合成逼真异常图像，在MVTec数据集上取得SOTA性能，显著提升了检测、定位和分类等下游任务表现。研究成果已被CVPR 2025接收，为工业质检提供了更高效的数据增强方案。相比传统方法，DualAnoDiff生成的异常样本更贴近真实场景分布，有效缓解了工业场景中正负样本不均衡的难题。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T12:03:35Z
- **目录日期**: 2025-06-06
