# #复旦腾讯新算法解决异常数据稀缺性##AI工业异常检测再获新SOTA#AI模型用于工业异常检测，再次取得新SOTA！相关论文已中稿计算机视觉顶会CVPR 2025。通俗理解，...
...
复旦大学与腾讯优图实验室合作开发的新算法DualAnoDiff，解决了工业异常检测中真实异常数据稀缺的问题。该算法基于扩散模型，能够生成高质量的异常图像样本用于训练检测模型。实验表明，DualAnoDiff在MVTec数据集上表现优异，生成的异常图像最接近真实情况，并在检测、定位和分类等下游任务中取得了新的SOTA（state-of-the-art）性能。相关论文已被计算机视觉顶会CVPR 2025接收。这一突破为工业质检提供了更高效的AI解决方案，减少了依赖大量真实异常数据的需求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T10:03:28Z
- **目录日期**: 2025-06-06
