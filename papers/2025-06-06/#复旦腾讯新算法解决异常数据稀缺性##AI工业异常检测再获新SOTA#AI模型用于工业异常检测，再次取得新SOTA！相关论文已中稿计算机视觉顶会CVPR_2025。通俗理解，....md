...
复旦大学与腾讯优图实验室联合研发的新算法DualAnoDiff，解决了工业异常检测中真实异常数据稀缺的问题。该算法基于扩散模型，能生成高质量的异常图像用于训练检测模型，在MVTec数据集上取得了SOTA性能，显著提升了检测、定位和分类等下游任务的效果。相关论文已被CVPR 2025接收。相比传统方法，DualAnoDiff生成的异常图像更接近真实情况，为工业质检提供了更有效的解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T23:03:30Z
- **目录日期**: 2025-06-06
