...
复旦大学与腾讯优图实验室合作开发的新算法DualAnoDiff解决了工业异常检测中真实异常数据稀缺的问题。该基于扩散模型的算法能生成高质量的异常图像用于训练检测模型，在MVTec数据集上取得SOTA性能，显著提升了异常检测、定位和分类效果。研究成果已被CVPR 2025接收，为工业质检提供了更高效的解决方案。相比传统方法，DualAnoDiff生成的异常图像更接近真实情况，有效缓解了数据不足的挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T18:03:17Z
- **目录日期**: 2025-06-06
