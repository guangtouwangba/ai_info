...
复旦大学与腾讯优图实验室合作开发了基于扩散模型的新算法DualAnoDiff，用于解决工业异常检测中真实异常数据稀缺的问题。该算法通过生成高质量的异常图像来训练检测模型，在MVTec数据集上取得了SOTA性能，显著提升了异常检测、定位和分类的准确性。研究成果已被计算机视觉顶会CVPR 2025接收。相比传统方法，DualAnoDiff生成的异常图像更接近真实情况，有效缓解了工业场景中异常样本不足的挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T19:03:10Z
- **目录日期**: 2025-06-06
