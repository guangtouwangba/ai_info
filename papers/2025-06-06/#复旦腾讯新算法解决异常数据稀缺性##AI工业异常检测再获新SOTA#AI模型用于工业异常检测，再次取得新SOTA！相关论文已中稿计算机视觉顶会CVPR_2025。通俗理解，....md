...
复旦大学与腾讯优图实验室合作开发的新算法DualAnoDiff解决了工业异常检测中数据稀缺的难题。该基于扩散模型的少样本异常图像生成方法，能高效合成接近真实场景的缺陷样本，在MVTec数据集上实现了检测、定位和分类任务的SOTA性能。相比传统生成方法，DualAnoDiff生成的异常图像质量更高，显著提升了下游模型的训练效果。这项入选CVPR 2025的研究为工业质检提供了更优的少样本学习方案，通过合成逼真缺陷数据有效缓解了实际生产中正负样本不均衡的问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T11:03:11Z
- **目录日期**: 2025-06-06
