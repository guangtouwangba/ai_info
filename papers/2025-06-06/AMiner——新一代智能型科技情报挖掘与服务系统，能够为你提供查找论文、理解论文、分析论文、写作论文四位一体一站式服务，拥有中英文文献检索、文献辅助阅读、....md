...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、翻译、辅助阅读和科研情报订阅。它拥有庞大的学术资源库，涵盖42个学科的3.5亿论文、0.6亿学者和1.5亿专利。用户可通过互动问答快速理解文献内容，AI还能自动生成摘要和章节概要，提升研究效率。此外，AMiner支持个性化订阅，推送最新科研动态，并提供学者画像、学术会议等辅助功能。平台免费开放使用，适合科研人员和学生高效获取学术信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T09:06:04Z
- **目录日期**: 2025-06-06
