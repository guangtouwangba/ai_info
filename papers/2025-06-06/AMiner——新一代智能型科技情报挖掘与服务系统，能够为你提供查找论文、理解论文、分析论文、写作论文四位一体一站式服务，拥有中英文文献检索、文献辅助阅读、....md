...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和科研情报订阅等一站式服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持中英文文献搜索、AI生成摘要、互动问答和文档翻译功能。用户可定制订阅最新科研动态，还能使用学者画像、学术会议等特色功能。平台通过网页和小程序免费开放，帮助研究者高效获取和分析学术信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T16:05:19Z
- **目录日期**: 2025-06-06
