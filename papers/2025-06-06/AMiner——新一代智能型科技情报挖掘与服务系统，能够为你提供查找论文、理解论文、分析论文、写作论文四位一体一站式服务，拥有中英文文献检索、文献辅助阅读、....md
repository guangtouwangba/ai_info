...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和科研订阅等一站式服务。它支持中英文文献搜索，能自动生成摘要并解答用户提问，帮助快速理解论文内容。平台还具备文档识别和翻译功能，用户可上传PDF获取AI生成的摘要和章节概要。此外，AMiner提供个性化科研动态订阅，根据用户关注的学者、机构或关键词推送最新论文。平台收录了3.5亿论文、0.6亿学者等海量学术资源，部分功能可免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T17:04:13Z
- **目录日期**: 2025-06-06
