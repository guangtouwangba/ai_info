...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、AI辅助阅读、翻译、科研情报订阅等功能。平台收录3.5亿论文、0.6亿学者等海量数据，支持文献摘要生成、互动问答和个性化订阅推送。用户可通过网页或微信小程序免费使用，高效获取和管理学术资源，提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T10:05:57Z
- **目录日期**: 2025-06-06
