...
AMiner是一个智能科技情报挖掘平台，提供四位一体的学术服务：文献检索（支持中英文）、辅助阅读、翻译和科研分析。平台收录3.5亿论文、0.6亿学者等海量数据，通过AI技术实现文献摘要生成、互动问答和章节概要提取。特色功能包括个性化科研情报订阅（微信/邮件推送）、学者画像分析及学术会议追踪。用户可免费使用浏览器检索，并上传PDF进行智能解析。其一站式服务显著提升文献筛选、论文理解和写作效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T18:05:14Z
- **目录日期**: 2025-06-06
