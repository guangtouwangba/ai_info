...
本文提出了一种基于AI的准粒子干涉(QPI)核提取新方法，解决了多散射条件下QPI图像反演的病态逆问题。该框架采用两步学习策略：首先通过变分自编码器学习散射核的紧凑潜在空间表示；随后使用专用编码器将QPI观测数据与预学习核的潜在表示对齐。这种设计使模型能在复杂散射条件下稳健推断核函数。研究构建了包含100种独特核的物理真实QPI数据集，实验表明该方法较传统一步法基线显著提高了提取精度，并对未见核具有更好的泛化能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T22:01:19Z
- **目录日期**: 2025-06-06
