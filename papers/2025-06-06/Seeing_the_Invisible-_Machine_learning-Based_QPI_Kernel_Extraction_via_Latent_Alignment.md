...
本文提出了一种基于人工智能的准粒子干涉(QPI)核提取新方法。针对多散射体图像中单散射体QPI模式提取这一病态逆问题，研究团队设计了一个两步学习框架：首先通过变分自编码器学习散射核的紧凑潜在空间表示，随后利用专用编码器将QPI观测数据与预学习核的潜在表示对齐。该方法在包含100种独特核的物理真实QPI数据集上测试表明，相比直接一步法基线模型，该框架显著提高了核提取精度，并展现出对未见核的更好泛化能力，能有效处理复杂纠缠散射条件。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T11:01:21Z
- **目录日期**: 2025-06-06
