...
研究表明，生成式AI能提升开发者效率，但也引发对职业替代和技能退化的担忧。一项针对21名前沿AI开发者的研究总结了12个工作目标、75项相关任务及所需技能，揭示了开发者使用AI的实践模式。研究发现，成功的AI开发者需掌握四大领域技能：高效使用生成式AI、核心软件工程、相关工程及非工程技能，并将其融入六步任务流程。为应对AI时代，职业培训和计算机科学教育需兼顾技术能力与软技能，覆盖四大领域，以帮助开发者提升技能、避免退化，适应未来需求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T00:02:08Z
- **目录日期**: 2025-06-06
