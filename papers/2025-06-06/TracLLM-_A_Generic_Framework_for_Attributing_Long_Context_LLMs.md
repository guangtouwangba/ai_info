...
这篇论文提出了TracLLM框架，用于追踪长上下文大语言模型(LLM)生成结果的关键来源文本。针对现有特征归因方法(如Shapley)在长上下文场景下效率低、效果差的问题，TracLLM通过基于信息的搜索算法提升效率，并采用贡献分数集成/降噪技术提高准确性。该技术可应用于LLM系统调试、攻击溯源分析(如提示注入攻击)和增强用户信任等场景。实验表明，TracLLM能有效识别长上下文中影响LLM输出的关键文本段落。代码和数据已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T00:01:34Z
- **目录日期**: 2025-06-06
