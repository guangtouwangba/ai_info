...
2024年ACM博士论文奖授予华盛顿大学Ashish Sharma的《人机协作支持心理健康与福祉》，研究AI如何提升心理健康服务。其成果包括：1)开发强化学习系统提升在线陪伴者的同理心表达；2)通过大规模试验证明AI辅助能有效改善消极思维；3)建立评估框架，发现当前AI治疗师表现更接近低质量人类治疗（如过度建议）。另两名荣誉提名获奖者分别研究受限计算模型的伪随机分布（Zander Kelley）和LLM数据应用范式重构（Sewon Min）。该奖项每年评选计算机领域最佳博士论文，主奖奖金2万美元。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T01:31:56Z
- **目录日期**: 2025-06-06
