...
研究人员提出了一种名为MACS（多智能体晶体结构优化）的新方法，利用多智能体强化学习优化周期性晶体结构。该方法将原子视为智能体，通过协作调整位置来寻找稳定构型。MACS在多种已知晶体材料上进行训练，其策略不仅能优化训练过的结构，还能处理更大尺寸和未见过的成分，展现出优异的可扩展性和零样本迁移能力。与现有优化方法相比，MACS能以更少的能量计算、更快的速度和最低的失败率完成晶体结构优化。这一成果为计算化学和材料设计领域提供了高效的结构优化解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T02:31:03Z
- **目录日期**: 2025-06-06
