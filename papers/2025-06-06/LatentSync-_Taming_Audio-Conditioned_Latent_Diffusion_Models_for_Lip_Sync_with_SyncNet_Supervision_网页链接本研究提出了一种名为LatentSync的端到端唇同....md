...
本研究提出LatentSync，一种端到端唇同步框架，基于音频条件的潜在扩散模型，无需中间运动表示。为解决时间一致性问题，提出TREPA方法，利用自监督视频模型对齐生成帧与真实帧。研究还优化了SyncNet训练框架，提升其准确性。实验表明，该方法在HDTF和VoxCeleb2数据集上超越现有技术。创新点包括直接建模音频-视觉关系、增强时间一致性及改进SyncNet训练，为唇同步和音频驱动动画提供新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T03:26:15Z
- **目录日期**: 2025-06-06
