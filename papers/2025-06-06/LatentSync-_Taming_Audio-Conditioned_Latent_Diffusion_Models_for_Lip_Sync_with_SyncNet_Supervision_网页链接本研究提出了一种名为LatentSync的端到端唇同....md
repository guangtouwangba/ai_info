...
本研究提出LatentSync框架，一种基于音频条件潜在扩散模型的端到端唇同步方法，无需中间运动表示。通过引入时间表示对齐(TREPA)技术解决扩散模型的时间一致性问题，并优化SyncNet训练框架提升准确性。该方法在HDTF和VoxCeleb2数据集上超越现有技术，为音频驱动人像动画提供了新方案。创新点包括直接建模音视频关联、增强时序一致性以及改进SyncNet收敛性，这些经验可推广至其他相关应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T23:05:23Z
- **目录日期**: 2025-06-06
