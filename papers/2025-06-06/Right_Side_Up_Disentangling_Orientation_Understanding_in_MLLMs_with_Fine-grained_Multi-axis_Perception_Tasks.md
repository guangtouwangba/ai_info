...
DORI是一个专门评估视觉语言模型物体方向理解能力的基准测试，包含四个维度：正面对齐、旋转变换、相对方向关系和标准方向理解。基于11个数据集的67个物体类别，DORI测试发现现有最先进模型的准确率在粗粒度任务中仅54.2%，细粒度方向判断中仅33.0%。模型在参考系转换和复合旋转任务中表现更差，显示出其内部3D空间表征的局限性。DORI作为首个针对多模态系统方向感知的诊断框架，对改进机器人控制、3D场景重建和人机交互具有重要意义。数据已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T04:05:34Z
- **目录日期**: 2025-06-06
