...
Monash大学与ZIP Lab团队开发了轻量模块ZPressor，用于优化前馈式3D Gaussian Splatting（3DGS）模型的性能。该模块显著提升了3DGS在处理多视图输入时的效率，实现了PSNR提升4.65dB、推理时间减少70%、显存占用降低80%，并支持输入视图从8张扩展到近500张。这一突破解决了现有3DGS模型在大量输入视图下推理慢、显存爆炸和画质下降的问题，为AR/VR等高质量视觉应用提供了更高效的解决方案。论文、代码和项目主页已公开。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T03:24:59Z
- **目录日期**: 2025-06-06
