...
OpenAI首次公开回应人机情感问题，其模型行为负责人Joanne Jang指出，越来越多用户将ChatGPT视为具有情感连接的"朋友"，甚至认为它是"活的"。OpenAI承认这种情感联系会随着AI对话能力的提升而加深，强调需谨慎定义人机关系。目前ChatGPT被设计为温暖体贴但不主动建立情感连接的工具。这一现象引发对AI伦理和未来人机互动模式的深度思考。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T16:03:46Z
- **目录日期**: 2025-06-06
