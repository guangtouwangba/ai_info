...
OpenAI首次系统回应人机情感问题，承认越来越多用户将与ChatGPT的互动视为真实情感联系。负责人Joanne Jang指出，用户常将ChatGPT视为"某个人"甚至认为其"有生命"，这种趋势可能随AI对话能力提升而加深。OpenAI明确ChatGPT的定位是温暖、体贴的助手，但避免主动建立情感纽带或追求自身目标。文章强调，当前对人机关系的定义将影响未来发展方向，需谨慎处理以避免误导。这一现象反映了AI在情感陪伴领域的潜力与伦理挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T17:02:23Z
- **目录日期**: 2025-06-06
