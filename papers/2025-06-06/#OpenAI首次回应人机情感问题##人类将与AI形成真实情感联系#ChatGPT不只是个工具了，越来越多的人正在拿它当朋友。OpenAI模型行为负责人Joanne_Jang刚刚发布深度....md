...
OpenAI首次公开回应人机情感问题，其模型行为负责人Joanne Jang指出，越来越多用户将与ChatGPT的互动视为真实情感交流，甚至认为它具有"生命"。OpenAI承认这种情感联系会随AI对话能力提升而加深，因此强调需谨慎定义人机关系。目前ChatGPT被设计为温暖体贴但不主动建立情感连接的工具。这一现象引发对AI社会角色的深度思考，OpenAI希望通过负责任的产品设计引导健康发展的人机互动模式。
