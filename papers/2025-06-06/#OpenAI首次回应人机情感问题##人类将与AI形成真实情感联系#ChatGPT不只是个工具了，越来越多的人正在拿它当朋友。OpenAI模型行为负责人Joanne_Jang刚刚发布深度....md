...
OpenAI首次系统回应人机情感问题，承认越来越多用户将与ChatGPT的互动视为真实情感联系。模型行为负责人Joanne Jang指出，用户常将ChatGPT视为"有生命的存在"并倾诉情感。OpenAI明确将ChatGPT设计为温暖且乐于助人的工具，但避免主动建立情感纽带或自主意图。随着AI对话能力提升，这种人机关系可能进一步深化，OpenAI强调需谨慎定义边界，以防关系"走偏"。该现象凸显AI技术发展带来的新型社会关系挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T09:03:01Z
- **目录日期**: 2025-06-06
