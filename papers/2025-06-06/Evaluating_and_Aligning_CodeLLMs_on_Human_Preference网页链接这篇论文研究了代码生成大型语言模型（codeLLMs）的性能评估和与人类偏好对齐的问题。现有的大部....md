...
这篇论文针对代码生成大模型(codeLLMs)提出新评估框架CodeArena，强调现有基准测试过度关注代码正确性而忽视人类偏好。研究者构建了包含397个高质量样本的基准数据集(覆盖40类任务和44种语言)，并开发20B标记的合成指令集SynCode-Instruct用于模型微调。实验发现执行基准与人类偏好评估存在显著差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI)在人类偏好对齐方面差距明显。研究突出了代码生成模型与开发者实际需求对齐的重要性，为改进代码LLMs提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T13:14:36Z
- **目录日期**: 2025-06-06
