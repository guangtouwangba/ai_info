...
这篇论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，强调评估模型输出与人类偏好的对齐性。研究收集了397个涵盖40类编程任务的样本，涉及44种语言，并构建20B标记的合成指令数据集SynCode-Instruct。实验发现：1)传统执行测试与人类偏好评估存在差异；2)开源顶尖模型(如Qwen2.5-Coder)与商业模型(如OpenAI)性能差距显著。研究凸显了代码生成模型除正确性外，还需关注实际开发场景中的人类偏好对齐问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T16:05:30Z
- **目录日期**: 2025-06-06
