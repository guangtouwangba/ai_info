...
这篇论文提出CodeArena基准测试和SynCode-Instruct语料库，研究代码生成大模型(CodeLLMs)与人类偏好的对齐问题。CodeArena包含397个高质量编程任务样本，覆盖40类44种语言，比传统基准更关注实际开发需求。实验发现执行基准与人类偏好评估存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究通过20B标记的合成指令验证了大规模微调效果，强调了对齐人类偏好在代码生成中的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T21:05:42Z
- **目录日期**: 2025-06-06
