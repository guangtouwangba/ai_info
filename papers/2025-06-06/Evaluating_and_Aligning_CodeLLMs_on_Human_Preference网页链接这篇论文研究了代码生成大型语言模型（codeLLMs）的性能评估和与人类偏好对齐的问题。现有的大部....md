...
该论文针对代码生成大模型(codeLLMs)提出了CodeArena基准测试，聚焦人类偏好对齐问题。研究者从真实编程场景收集397个高质量样本，覆盖40类任务和44种语言，并构建20B标记的合成指令数据集SynCode-Instruct。实验发现传统执行基准与人类偏好存在差距，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著。研究强调代码生成模型不仅需要正确性，还需符合开发者实际偏好，为模型评估提供了新维度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-06T18:05:22Z
- **目录日期**: 2025-06-06
