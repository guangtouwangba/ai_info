...
LabUtopia是一个专为实验室环境设计的仿真与基准测试平台，旨在推动具身智能的发展。它包含三个核心组件：高保真多物理化学模拟器LabSim、可扩展的场景生成器LabScene，以及涵盖5种复杂度任务的层次化基准测试LabBench。该平台支持30种任务、200多个场景与仪器资产，适用于大规模训练与系统性评估。LabUtopia通过模拟实验室特有的物理化学变化和长时程规划需求，为开发具有感知、规划和控制的科学智能体提供了理想测试环境，同时为探索具身智能的泛化能力与极限奠定了研究基础。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T08:01:55Z
- **目录日期**: 2025-05-29
