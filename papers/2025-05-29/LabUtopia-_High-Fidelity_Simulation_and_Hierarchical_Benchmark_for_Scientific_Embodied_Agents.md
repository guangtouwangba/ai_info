...
LabUtopia是一个专为实验室环境设计的仿真与基准测试平台，旨在推动具身智能在科研场景中的发展。该平台包含三个核心组件：高保真多物理化学交互模拟器LabSim、可扩展的科学场景生成器LabScene，以及涵盖从原子操作到长程移动操作的五级复杂度基准测试LabBench。支持30种任务和200多个场景资产，支持大规模训练和系统评估。LabUtopia为科学智能体提供了感知、规划和控制的集成研究平台，同时为探索具身智能的实践能力和泛化极限建立了严格测试标准，填补了该领域长期缺乏合适工具的空白。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T10:02:04Z
- **目录日期**: 2025-05-29
