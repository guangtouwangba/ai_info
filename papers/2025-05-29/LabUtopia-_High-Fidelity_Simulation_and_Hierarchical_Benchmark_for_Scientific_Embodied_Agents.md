...
LabUtopia是一个专为实验室环境设计的仿真与基准测试套件，旨在推动具身智能在科学实验中的发展。它包含三个核心组件：高保真多物理化学模拟器LabSim、可扩展的场景生成器LabScene，以及涵盖从原子操作到长程移动操作五个复杂度层级的基准测试LabBench。该平台支持30种任务和200多个场景与仪器资产，支持大规模训练和系统评估。LabUtopia为科学实验中的感知、规划和控制的整合提供了强大平台，并为未来研究探索具身智能的实际能力和泛化极限奠定了严格测试基础。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T22:01:46Z
- **目录日期**: 2025-05-29
