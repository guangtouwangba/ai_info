...
LabUtopia是一个专为实验室环境设计的仿真与基准测试套件，旨在推动具身智能在科学实验中的发展。它包含三个核心组件：高保真多物理化学交互模拟器LabSim、可扩展的科学场景生成器LabScene，以及涵盖从原子操作到长程移动操作的五级复杂性基准LabBench。该平台支持30种任务和200多个场景与仪器资产，支持大规模训练与系统评估。LabUtopia为科学智能体提供了感知、规划与控制一体化的研究平台，同时为探索具身智能的实践能力与泛化极限建立了严格测试标准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T13:10:25Z
- **目录日期**: 2025-05-29
