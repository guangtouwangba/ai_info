...
LabUtopia是一个专为实验室环境设计的仿真与基准测试平台，旨在推动具身智能在科研场景中的发展。该平台包含三部分：1）高保真多物理化学模拟器LabSim；2）可扩展的科学场景生成器LabScene；3）涵盖5个复杂度层级（从原子操作到长程移动操控）的层次化基准测试LabBench。支持30种任务和200多个场景/仪器资源，支持大规模训练与系统评估。研究表明，LabUtopia为科学智能体整合感知、规划与控制提供了强大平台，并为探索具身智能的实践能力与泛化极限建立了严格测试标准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T09:01:59Z
- **目录日期**: 2025-05-29
