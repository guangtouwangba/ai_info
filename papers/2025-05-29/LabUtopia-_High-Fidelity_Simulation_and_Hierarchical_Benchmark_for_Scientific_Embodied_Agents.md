...
LabUtopia是一个专为实验室环境设计的仿真与基准测试平台，旨在推动具身智能在科研场景中的发展。该平台包含三个核心组件：高保真多物理化学模拟器LabSim、可扩展的场景生成器LabScene，以及涵盖5种复杂度层级（从原子操作到长程移动操控）的基准测试LabBench。它支持30种任务、200多个场景与仪器资产，支持大规模训练与系统评估。研究表明，LabUtopia为整合感知、规划与控制提供了强大平台，同时为探索具身智能的实际能力与泛化极限建立了严谨的测试环境。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T23:01:38Z
- **目录日期**: 2025-05-29
