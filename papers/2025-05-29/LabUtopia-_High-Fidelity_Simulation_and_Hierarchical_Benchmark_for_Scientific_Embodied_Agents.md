...
LabUtopia是一个专为实验室环境设计的仿真与基准测试套件，旨在推动具身智能体的发展。它包含三个核心组件：高保真多物理化学模拟器LabSim、可扩展的场景生成器LabScene，以及涵盖5个复杂度层级的基准测试LabBench（含30项任务和200多个场景/仪器资源）。该系统解决了实验室智能体开发长期缺乏合适仿真工具和评估标准的问题，支持从基础操作到长时程移动操控的多层次训练与评估。LabUtopia为科学用途智能体的感知-规划-控制集成提供了高效平台，并为探索具身智能的泛化极限建立了严谨测试框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T14:01:56Z
- **目录日期**: 2025-05-29
