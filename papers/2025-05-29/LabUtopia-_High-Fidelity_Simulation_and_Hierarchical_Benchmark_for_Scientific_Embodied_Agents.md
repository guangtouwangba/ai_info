...
LabUtopia是一个专为实验室环境设计的仿真与基准测试套件，旨在推动具身智能在科研场景中的发展。它包含三个核心组件：高保真多物理化学模拟器LabSim、可扩展的场景生成器LabScene以及分层基准测试LabBench（涵盖5种复杂度任务）。该平台支持30种任务、200多个场景与仪器资产，适用于大规模训练与系统性评估。LabUtopia解决了实验室智能体开发长期缺乏合适工具的问题，为感知-规划-控制一体化研究提供了理想测试平台，同时能有效探索具身智能的泛化极限与实际应用潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T19:01:48Z
- **目录日期**: 2025-05-29
