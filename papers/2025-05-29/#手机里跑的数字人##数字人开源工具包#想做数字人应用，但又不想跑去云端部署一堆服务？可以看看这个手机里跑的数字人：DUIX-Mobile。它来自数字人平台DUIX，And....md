...
DUIX-Mobile是一款可在手机本地运行的数字人开源工具包，支持Android/iOS平台。该工具包具有低延迟(<1.5秒)、自然交互(模拟表情语气)、轻量化部署等特点，适用于移动AI助手、数字人客服、虚拟导游等场景。其亮点包括：模块化架构可对接ASR/TTS/LLM等组件；提供医生、律师等预设角色模型；支持离线运行满足金融政务需求。开源SDK允许开发者自定义功能，GitHub已提供多个可直接运行的预设数字人模型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T09:03:00Z
- **目录日期**: 2025-05-29
