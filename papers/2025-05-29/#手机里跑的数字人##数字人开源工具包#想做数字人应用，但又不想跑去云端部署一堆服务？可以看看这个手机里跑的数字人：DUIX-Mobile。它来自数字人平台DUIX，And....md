...
DUIX-Mobile是一款支持Android和iOS的本地化部署数字人开源工具包，适用于移动AI助手、客服、虚拟导游等场景。其亮点包括：1）自然的表情/语音交互（延迟<1.5秒）；2）轻量化可脱网运行，适配金融/政务场景；3）模块化架构支持自定义ASR/TTS/LLM组件接入；4）提供医生、律师等预设角色模型。开发者可通过GitHub获取SDK快速搭建数字人应用，实现终端设备的智能化交互界面。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T11:03:50Z
- **目录日期**: 2025-05-29
