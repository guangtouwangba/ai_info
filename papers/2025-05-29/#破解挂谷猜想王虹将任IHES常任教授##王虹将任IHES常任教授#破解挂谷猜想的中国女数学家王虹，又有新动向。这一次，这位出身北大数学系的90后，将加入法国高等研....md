...
中国数学家王虹因破解百年难题"挂谷猜想"获国际认可，将于2025年出任法国高等研究所（IHES）常任教授，成为该所第8位数学教授。IHES现有7位常任教授中包括多位菲尔兹奖得主。29岁的王虹是北大数学系校友，其突破性成果被认为有望冲击菲尔兹奖。她将与纽约大学联合任职，延续IHES在数学分析领域的卓越传统。此前她与合作者解决了三维Kakeya猜想，该问题涉及调和分析与数论等多个数学分支，成果引发学界轰动。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T00:03:14Z
- **目录日期**: 2025-05-29
