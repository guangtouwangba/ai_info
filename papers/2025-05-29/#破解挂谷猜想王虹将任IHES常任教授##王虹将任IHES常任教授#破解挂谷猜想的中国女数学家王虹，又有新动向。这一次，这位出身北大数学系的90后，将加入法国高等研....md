...
中国数学家王虹因破解百年数学难题"挂谷猜想"获得国际认可，将于2025年9月出任法国高等研究所(IHES)常任教授，同时兼任纽约大学教授。IHES现有7位常任教授中包括多位菲尔兹奖得主。29岁的王虹是北大数学系校友，2023年与Joshua Zahl合作解决了三维Kakeya猜想，该成果被认为可能助其获得菲尔兹奖。她将成为IHES第8位数学常任教授，延续该机构在数学分析领域的卓越传统。此前Jean Bourgain等著名数学家都曾在此任职。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T01:31:13Z
- **目录日期**: 2025-05-29
