...
DeepSeek 正式发布新版 R1-0528 模型，性能接近 o3 和 Gemini 2.5 Pro。该模型在数学、编程和逻辑推理等任务上表现优异，尤其在 AIME 等高难度测试中进步显著。新增 JSON 输出和函数调用功能，便于实际应用集成。幻觉率降低，文本生成更自然流畅。此外，官方通过“思维链”蒸馏技术提升了中小型模型（如 Qwen3-8B）的性能，接近更大模型的水平。模型权重已在 Hugging Face 开源，适用于代码生成、Web 开发等场景。体验入口：chat.deepseek.com。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T21:02:39Z
- **目录日期**: 2025-05-29
