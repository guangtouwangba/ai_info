...
DeepSeek 发布了新版 R1-0528 模型，性能接近 o3 和 Gemini 2.5 Pro，在数学、编程、逻辑推理等基准测试中表现优异。主要升级包括：推理能力增强，支持 JSON 输出和函数调用，幻觉率降低，文本生成更自然，并优化了中小模型的性能（如 Qwen3-8B）。此外，代码生成和前端开发体验提升。模型已在 Hugging Face 开源，支持 API 接入。用户可前往 chat.deepseek.com 体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T23:02:30Z
- **目录日期**: 2025-05-29
