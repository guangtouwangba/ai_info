...
DeepSeek 官方发布了新版模型 DeepSeek-R1-0528，性能接近 o3 和 Gemini 2.5 Pro。该模型在数学、编程、逻辑推理等任务上表现优异，AIME 等高难度推理测试分数显著提升。新增 JSON 输出和函数调用支持，便于实际应用集成。幻觉率降低，文本生成更自然流畅。此外，官方将 R1 的思维链蒸馏至 Qwen3-8B，使其性能逼近 Qwen3-235B。模型权重已在 Hugging Face 开源，适用于轻量部署。体验入口：chat.deepseek.com。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T17:02:38Z
- **目录日期**: 2025-05-29
