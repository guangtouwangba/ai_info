...
该论文提出了一种基于个性化因果图推理的智能框架，以增强大语言模型(LLMs)在个性化推理方面的能力。针对LLMs在处理多因素个人数据时的局限性，该框架通过整合个人因果图来指导推理过程。研究以营养导向的饮食建议为案例，采用反事实评估方法验证LLM推荐食物对血糖管理的效果。结果表明，该方法能有效提供个性化饮食建议，在三个时间窗口内降低平均血糖iAUC，优于传统方法。LLM作为评判者的评估也证实，该方法显著提升了推理过程的个性化程度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T15:02:37Z
- **目录日期**: 2025-05-29
