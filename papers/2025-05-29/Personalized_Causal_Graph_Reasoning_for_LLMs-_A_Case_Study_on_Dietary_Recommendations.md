...
该论文提出了一种基于个性化因果图推理的智能框架，旨在解决大语言模型(LLMs)在处理多因素个人数据时的局限性。通过构建个人因果图来指导LLM的推理过程，该方法在营养导向的饮食推荐案例中表现出色。反事实评估表明，该方法能有效推荐有助于血糖管理的个性化饮食方案，在三个时间窗口内显著降低平均葡萄糖iAUC，优于传统方法。LLM作为评判者的评估结果也证实，该框架显著提升了推理过程的个性化水平，为需要个性化决策的领域提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T13:10:58Z
- **目录日期**: 2025-05-29
