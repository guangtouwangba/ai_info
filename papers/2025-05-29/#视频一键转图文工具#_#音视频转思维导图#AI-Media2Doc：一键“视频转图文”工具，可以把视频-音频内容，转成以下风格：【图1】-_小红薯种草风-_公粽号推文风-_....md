...
AI-Media2Doc是一款开源本地部署的视频处理工具，可将音视频一键转换为多种格式：小红书/公众号风格图文、知识笔记、思维导图和字幕文件。其核心技术是ffmpeg wasm前端处理，支持浏览器直接运行。特色功能包括AI内容问答（总结重点/核心观点）、字幕导出、Docker快速部署，未来还将添加关键帧提取和本地语音识别功能。开发者为解决个人视频笔记需求而创建，注重隐私保护无需上传数据。项目地址：github.com/hanshuaikang/AI-Media2Doc。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T00:03:40Z
- **目录日期**: 2025-05-29
