...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、翻译、辅助阅读和论文写作支持。其数据库涵盖42个学科，包含3.5亿论文、0.6亿学者等资源。核心功能包括：1）智能文献检索与自动摘要生成；2）英文文献翻译与互动问答；3）个性化科研情报订阅服务。平台还提供学者画像、学术会议追踪等功能，支持网页端免费使用，帮助用户高效获取和管理学术信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T07:05:56Z
- **目录日期**: 2025-05-29
