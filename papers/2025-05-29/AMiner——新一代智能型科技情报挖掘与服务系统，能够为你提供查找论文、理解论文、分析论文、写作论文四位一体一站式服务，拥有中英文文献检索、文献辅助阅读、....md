...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献搜索，能自动生成摘要和问答互动，帮助用户快速理解论文内容。平台还具备文献翻译、文档识别和科研情报订阅功能，可根据用户兴趣推送最新学术动态。AMiner拥有庞大的数据库，涵盖3.5亿论文、0.6亿学者和1.5亿专利，并提供学者画像、学术会议等特色功能。用户可通过网页或微信小程序免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T20:05:16Z
- **目录日期**: 2025-05-29
