...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索（覆盖42个学科3.5亿论文）、AI辅助阅读（自动生成摘要、章节概要和问答）、文档翻译及科研订阅（按需推送最新成果）。用户可通过关键词、学者或机构定制情报，并通过微信/邮件接收。平台还支持学者画像、会议追踪及论文排行榜功能，基础服务免费开放。核心亮点在于高效检索、AI摘要生成和个性化科研动态推送，显著提升文献调研效率。访问入口：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T23:05:41Z
- **目录日期**: 2025-05-29
