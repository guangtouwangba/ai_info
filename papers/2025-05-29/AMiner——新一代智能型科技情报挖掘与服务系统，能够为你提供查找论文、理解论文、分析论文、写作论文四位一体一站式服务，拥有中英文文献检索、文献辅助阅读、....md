...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、科研情报订阅等一站式服务。其核心功能包括：1）高效检索3.5亿论文资源，支持智能问答和自动摘要生成；2）AI辅助阅读，可解析上传的PDF文献并生成章节概要；3）个性化订阅服务，定期推送最新科研动态。平台还包含学者画像、学术会议等特色功能，支持浏览器免费使用。通过整合文献查找、理解、分析和写作全流程，AMiner显著提升了科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T04:08:04Z
- **目录日期**: 2025-05-29
