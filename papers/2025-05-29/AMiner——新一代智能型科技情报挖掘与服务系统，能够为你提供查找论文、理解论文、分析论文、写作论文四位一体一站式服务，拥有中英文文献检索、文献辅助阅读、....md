...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作一站式服务。它支持中英文文献搜索，能自动生成摘要，并具备互动问答功能。平台还提供文献翻译、文档识别和辅助阅读工具，用户可上传PDF或从库中选取论文获取AI生成的摘要与章节概要。AMiner提供科研动态订阅服务，根据用户偏好推送最新学术资讯。此外，平台包含学者画像、学术会议和论文排行榜等功能，免费开放使用。网址：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T17:05:38Z
- **目录日期**: 2025-05-29
