...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、辅助阅读和科研订阅服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持AI生成摘要、智能问答和文档解析。用户可定制学术动态推送，追踪机构、学者及关键词，并通过微信或邮件接收最新研究。平台还提供学者画像、会议信息等免费功能，帮助高效获取和分析学术资源。访问入口：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T13:14:24Z
- **目录日期**: 2025-05-29
