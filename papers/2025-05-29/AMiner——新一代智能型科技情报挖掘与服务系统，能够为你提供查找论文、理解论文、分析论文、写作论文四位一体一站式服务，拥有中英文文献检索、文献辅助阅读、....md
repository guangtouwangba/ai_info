...
AMiner是一个集论文检索、阅读、分析和写作于一体的智能科研平台，提供中英文文献搜索、AI辅助阅读、自动摘要生成、翻译及问答功能。其数据库涵盖42个学科3.5亿论文、0.6亿学者及1.5亿专利，支持用户上传PDF或直接检索文献，通过AI生成摘要和章节概要。平台还提供个性化科研情报订阅服务，可按用户设定的关键词推送最新研究成果。此外，AMiner包含学者画像、学术会议追踪等特色功能，基础服务免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T09:06:13Z
- **目录日期**: 2025-05-29
