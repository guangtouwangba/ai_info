...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析和写作一站式服务。支持中英文文献搜索、AI辅助阅读、自动摘要生成及翻译功能，涵盖42个学科3.5亿论文资源。其特色包括互动问答获取文献核心内容、PDF文档智能解析，以及个性化科研动态订阅（通过微信/邮件推送）。平台还整合学者画像、学术会议等工具，基础功能可免费使用。网址：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T10:06:22Z
- **目录日期**: 2025-05-29
