...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析及写作一站式服务。平台支持中英文文献搜索、AI辅助阅读、自动摘要生成及翻译功能，覆盖42个学科3.5亿论文资源。特色功能包括：1）智能问答快速定位文献核心内容；2）PDF上传解析与章节概要生成；3）个性化科研动态订阅（学者/机构/关键词追踪）。此外提供学者画像、学术会议等拓展服务，基础功能可免费使用。网址：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T05:05:45Z
- **目录日期**: 2025-05-29
