...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译和分析等一站式服务。它收录了3.5亿论文、0.6亿学者等海量学术资源，支持中英文文献检索、AI生成摘要、互动问答等功能，帮助用户快速理解文献内容。平台还提供科研情报订阅服务，根据用户偏好推送最新学术动态。此外，AMiner具备学者画像、学术会议推荐等特色功能，浏览器版本可免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T12:06:14Z
- **目录日期**: 2025-05-29
