...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、辅助阅读、翻译和科研情报订阅等功能。它收录了3.5亿论文、0.6亿学者和1.5亿专利，支持AI生成摘要、章节概要和智能问答，帮助用户高效筛选和理解文献。用户可定制订阅最新科研动态，并通过微信或邮件接收。平台还提供学者画像、学术会议和论文排行榜等特色功能，浏览器检索免费使用。访问入口：https://www.aminer.cn/。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T19:05:15Z
- **目录日期**: 2025-05-29
