...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万个智能代理及其500万次社会互动。研究者利用该平台研究了四大社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，验证了系统对人类行为和社会机制的捕捉能力。该系统可作为计算社会科学研究平台，为传统研究方法（如调查、干预）提供补充，帮助研究者分析社会问题的模式、成因和机制，展现了在社会科学研究和政策制定中的应用潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T13:13:53Z
- **目录日期**: 2025-05-29
