...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理的社会互动（500万次交互）。该系统被用于研究四大社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。研究发现模拟结果与现实社会实验高度吻合，证明该系统能有效捕捉人类行为机制。这一工具为社会科学研究和政策制定提供了新的实验平台，可辅助传统研究方法（如调查、访谈）探索社会问题的成因和解决方案。研究展示了LLM在复杂社会系统建模中的应用潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T03:24:20Z
- **目录日期**: 2025-05-29
