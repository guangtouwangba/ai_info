...
这篇论文介绍了一个名为AgentSociety的大规模社会模拟器，它结合了大型语言模型驱动的代理、真实社会环境和强大的模拟引擎。研究者模拟了1万多个代理的社会生活及500万次互动，并针对极化现象、信息传播、基本收入政策和飓风影响等四个社会问题进行了实验。结果表明，AgentSociety能有效捕捉人类行为机制，其模拟结果与现实世界实验吻合，展示了它作为社会科学研究和政策制定工具的潜力。该系统为理解社会问题提供了新的计算实验方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T01:32:39Z
- **目录日期**: 2025-05-29
