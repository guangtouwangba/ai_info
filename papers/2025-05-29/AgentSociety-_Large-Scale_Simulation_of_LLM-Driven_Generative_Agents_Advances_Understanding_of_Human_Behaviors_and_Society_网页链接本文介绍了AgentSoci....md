...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理及其500万次社会互动。研究者利用该系统研究了社会极化、信息传播、基本收入政策及自然灾害影响等关键社会问题，其模拟结果与现实世界数据高度吻合。该系统展示了作为计算社会科学实验平台的潜力，能够辅助传统研究方法，帮助理解人类行为模式和社会机制，为社会科学研究和政策制定提供新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T06:05:24Z
- **目录日期**: 2025-05-29
