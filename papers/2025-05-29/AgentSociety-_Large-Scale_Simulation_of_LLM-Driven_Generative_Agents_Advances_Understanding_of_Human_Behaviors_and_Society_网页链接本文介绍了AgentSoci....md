...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理的社会互动。研究者用它研究了社会极化、信息传播、基本收入政策及自然灾害影响等社会问题。模拟结果与现实数据高度吻合，验证了该系统在揭示人类行为机制方面的有效性。该平台可作为传统社会科学研究方法的补充工具，帮助学者和政策制定者更好地理解复杂社会现象。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T07:05:24Z
- **目录日期**: 2025-05-29
