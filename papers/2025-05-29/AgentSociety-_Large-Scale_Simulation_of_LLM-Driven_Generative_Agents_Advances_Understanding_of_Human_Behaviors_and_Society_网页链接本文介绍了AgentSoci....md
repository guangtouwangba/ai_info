...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个智能代理的社会互动（达500万次）。该系统被用于研究四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，验证了该系统在分析人类行为机制方面的有效性。研究表明，AgentSociety能够作为计算社会科学的重要工具，辅助传统研究方法，帮助研究者和社会决策者深入理解复杂社会现象。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T12:05:44Z
- **目录日期**: 2025-05-29
