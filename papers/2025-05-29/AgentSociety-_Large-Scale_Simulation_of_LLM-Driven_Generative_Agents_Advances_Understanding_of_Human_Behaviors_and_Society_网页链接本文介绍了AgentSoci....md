...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统模拟了超过1万个AI代理的社会生活，记录下500万次互动，用于研究极化现象、信息传播、基本收入政策影响和自然灾害应对等社会问题。研究结果显示，模拟结果与现实世界数据高度吻合，证明该系统能有效捕捉人类行为模式和社会机制。AgentSociety为社会科学研究和政策制定提供了强大的实验平台，可作为传统研究方法的补充工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T21:04:51Z
- **目录日期**: 2025-05-29
