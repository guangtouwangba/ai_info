...
大型语言模型(LLMs)在临床问答中展现出潜力，但多智能体框架存在"沉默共识"问题，即在复杂病例中过早达成诊断结论。研究者提出"鲶鱼代理"概念，通过结构化异议来激发深入分析。该代理采用两种干预机制：(1)基于病例难度的复杂性感知干预；(2)平衡批评与协作的语气校准干预。在12个医学问答基准测试中，该方法优于单智能体和多智能体框架，包括GPT-4o和DeepSeek-R1等领先商业模型。这一创新借鉴组织心理学中的"鲶鱼效应"，有效提升了诊断准确性。(99字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T01:28:30Z
- **目录日期**: 2025-05-29
