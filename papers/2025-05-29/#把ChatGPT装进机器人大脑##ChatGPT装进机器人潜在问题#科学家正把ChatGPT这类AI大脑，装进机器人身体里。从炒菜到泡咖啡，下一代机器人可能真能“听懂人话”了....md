...
科学家正在将ChatGPT等大语言模型(LLM)整合到机器人系统中，使机器人能理解模糊指令并自主完成任务。目前主要有三种实现方式：通过生成代码控制机械臂、组合基础动作完成任务、以及迁移学习操作新工具。虽然这项技术让机器人具备了类似"常识"的理解能力，但也面临LLM产生错误指令和数据偏见等风险。研究者建议用传统AI系统审查LLM生成的指令来降低风险。这项突破可能让机器人真正实现"听懂人话"并完成复杂任务，但同时也引发了关于AI安全性和伦理问题的新思考。(99字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T22:03:41Z
- **目录日期**: 2025-05-29
