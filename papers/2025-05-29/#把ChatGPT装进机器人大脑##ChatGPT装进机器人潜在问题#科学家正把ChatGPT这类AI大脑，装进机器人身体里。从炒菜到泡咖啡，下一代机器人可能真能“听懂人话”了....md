...
科学家正在将ChatGPT等大语言模型(LLM)整合到机器人中，使其具备理解自然语言指令的能力。目前已有多种实现方式：南加州大学让ChatGPT生成控制代码，谷歌通过组合基础动作完成任务，普林斯顿团队则发现AI能通过描述学习使用新工具。这种突破使机器人能执行"做个土豆煎饼"等模糊指令，而非仅重复预设动作。但该技术仍面临LLM"幻觉"生成错误指令、训练数据偏见等问题。研究者建议用传统AI系统审查LLM指令以确保安全。这一进展标志着机器人向通用化迈出重要一步，但也引发对AI伦理的新思考。(99字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T23:03:57Z
- **目录日期**: 2025-05-29
