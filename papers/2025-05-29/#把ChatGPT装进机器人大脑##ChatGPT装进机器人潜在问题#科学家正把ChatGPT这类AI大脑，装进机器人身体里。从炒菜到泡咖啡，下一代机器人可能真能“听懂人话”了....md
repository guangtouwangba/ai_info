...
科学家正在将ChatGPT等大型语言模型(LLM)整合到机器人系统中，使机器人能理解模糊的人类指令并自主完成任务。目前主要采用三种方法：生成控制代码、组合基础动作、迁移学习操作新工具。虽然这项技术让机器人具备了"常识性"理解能力，但也面临LLM可能产生错误指令、数据偏见等风险。研究人员建议采用传统AI系统进行指令审查来降低风险。这项突破使机器人从重复性劳动迈向更复杂的日常任务，但也引发了对AI伦理问题的思考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T18:04:24Z
- **目录日期**: 2025-05-29
