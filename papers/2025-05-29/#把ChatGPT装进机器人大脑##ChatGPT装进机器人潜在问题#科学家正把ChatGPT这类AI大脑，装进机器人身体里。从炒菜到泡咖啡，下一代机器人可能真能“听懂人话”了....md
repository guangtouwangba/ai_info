...
科学家正在将ChatGPT等大型语言模型(LLM)整合到机器人系统中，使机器人能理解模糊的人类指令并自主完成任务。目前主要有三种实现方式：通过生成代码控制机械臂、组合基础动作完成任务、利用迁移学习操作新工具。虽然这项技术让机器人具备了"常识性"理解能力，但仍面临LLM产生错误指令和数据偏见等问题。研究者建议用传统AI系统审查LLM生成的指令来降低风险。这项突破使机器人从重复性劳动迈向更复杂的日常任务，但也引发了关于AI安全性和伦理问题的新思考。(99字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T12:03:56Z
- **目录日期**: 2025-05-29
