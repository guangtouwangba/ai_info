...
科学家正在将ChatGPT等大语言模型(LLM)整合到机器人中，使其具备语言理解和常识推理能力。通过生成代码或组合基础动作，机器人可以执行"做个potato hash"等模糊指令。主要方法包括南加州大学的ProgPrompt、谷歌的SayCan等。但LLM存在"幻觉"和偏见问题，当前解决方案是让传统AI系统审查LLM生成的指令。这项技术突破让机器人从重复性工作转向复杂任务，但也引发了对AI安全性和偏见的担忧。研究人员正在探索如何平衡创新与风险控制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T20:03:42Z
- **目录日期**: 2025-05-29
