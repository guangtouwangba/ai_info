...
OSSU是一个开源计算机科学自学项目，整合了哈佛、MIT等全球顶尖名校的免费课程资源，提供完整的计算机本科学习路径。该项目分为四个阶段：CS入门、核心知识、进阶选修和毕业项目，涵盖编程、算法、系统等关键领域。学习者可自由安排进度（建议每周20小时/2年完成），并通过Discord社区互动。项目已在GitHub获18.4万星，特别适合零基础入门或技术人员系统提升。课程完全免费，配套有学习进度追踪工具。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T00:03:31Z
- **目录日期**: 2025-05-29
