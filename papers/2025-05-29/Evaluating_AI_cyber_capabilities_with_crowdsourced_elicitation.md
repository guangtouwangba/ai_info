...
本文探讨了通过众包方式激发AI在网络安全领域的潜力。研究团队在两场CTF竞赛中设立公开AI赛道，AI团队表现优异（分别进入前5%和前10%），表明开放市场激发可作为内部研发的有效补充。研究建议设立"AI能力激发奖金"机制，以经济高效的方式跟踪AI新兴能力。研究还发现，AI能可靠解决中等水平人类选手1小时内完成的网络安全挑战。这些发现为AI能力评估和治理提供了新思路，突显了众包模式在AI安全研究中的价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T01:30:05Z
- **目录日期**: 2025-05-29
