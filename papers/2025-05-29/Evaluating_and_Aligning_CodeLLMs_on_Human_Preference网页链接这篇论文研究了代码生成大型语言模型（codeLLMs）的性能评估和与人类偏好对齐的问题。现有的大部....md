...
这篇论文针对代码生成大模型(codeLLMs)提出新评估框架CodeArena，通过397个涵盖40类编程任务和44种语言的人类精选样本，评估模型与人类偏好的对齐程度。研究发现传统基于执行的测试与人类偏好存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。论文还构建了20B标记的合成指令数据集SynCode-Instruct验证大规模微调效果，强调代码LLMs需同时兼顾正确性和人类偏好。研究为提升代码生成模型的实际应用价值提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T10:06:35Z
- **目录日期**: 2025-05-29
