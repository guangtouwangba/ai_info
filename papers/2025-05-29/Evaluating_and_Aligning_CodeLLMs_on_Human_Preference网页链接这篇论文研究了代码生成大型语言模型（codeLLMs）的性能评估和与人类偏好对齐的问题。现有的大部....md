...
这篇论文提出了CodeArena基准测试，用于评估代码生成大模型(CodeLLMs)与人类偏好的对齐程度。研究指出当前基准过于关注代码正确性而忽视用户体验，因此构建了包含397个样本、覆盖40类任务和44种编程语言的测试集。同时开发了20B标记的合成指令数据集SynCode-Instruct用于模型微调。实验发现执行基准与人类偏好存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI)性能差距显著，凸显了人类偏好对齐的重要性。研究为提升代码生成模型的实用价值提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T11:05:50Z
- **目录日期**: 2025-05-29
