...
这篇论文研究了代码生成大模型(codeLLMs)与人类偏好的对齐问题。作者提出了CodeArena基准测试，包含397个高质量样本，覆盖40个类别和44种编程语言，更贴近实际编程需求。同时构建了SynCode-Instruct合成指令语料库(近200亿标记)验证大规模微调效果。实验发现现有基于执行的测试与CodeArena存在性能差异，且开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI)在人类偏好对齐方面仍有显著差距。研究强调了代码LLMs不仅需要正确性，还需符合人类编程习惯的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T16:05:54Z
- **目录日期**: 2025-05-29
