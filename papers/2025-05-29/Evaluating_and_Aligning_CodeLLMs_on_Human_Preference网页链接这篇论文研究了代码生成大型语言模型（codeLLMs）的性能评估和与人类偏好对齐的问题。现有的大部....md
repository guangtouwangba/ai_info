...
这篇论文提出了CodeArena基准测试和SynCode-Instruct语料库，以评估代码生成大模型（codeLLMs）与人类偏好的对齐程度。研究发现现有基准过于关注代码正确性而忽视人类偏好，而CodeArena包含397个涵盖40类编程任务的真实样本。实验显示，基于执行的测试与人类偏好评估存在差距，开源模型（如Qwen2.5-Coder）与商业模型（如OpenAI o1）性能差异显著。研究强调了对齐人类偏好的重要性，并通过20B标记的合成指令验证了大规模微调的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T13:14:35Z
- **目录日期**: 2025-05-29
