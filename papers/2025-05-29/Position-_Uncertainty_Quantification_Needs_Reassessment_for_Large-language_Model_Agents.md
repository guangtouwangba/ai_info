...
这篇立场论文指出，传统将不确定性分为认知性和偶然性的二分法在LLM智能体与用户交互的开放场景中存在局限。作者发现现有定义在交互环境下互相矛盾且失去意义，因此提出三个新研究方向：1) 任务描述不完整时的"未明确不确定性"；2)通过交互学习追问以降低情境不确定性；3)利用丰富语言表达(而非简单数值)来传递"输出不确定性"。这些新方法有望使LLM交互更透明、可信且直观。研究强调需要针对人机交互特点重新思考不确定性量化框架。(99字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T09:01:13Z
- **目录日期**: 2025-05-29
