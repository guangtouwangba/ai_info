...
华为提出S-GRPO新方法，优化大模型推理效率。该方法通过"串行分组+衰减奖励"机制，允许模型在推理过程中提前终止：完整思考后训练模型在不同深度答题，答对越早奖励越高。相比传统GRPO方法，S-GRPO节省60%计算量，在数学和科学推理任务中表现更优——推理路径更短、准确率更高，尤其适合长度受限场景，用一半资源即可达到更好效果。该方法有效解决了AI"过度思考"问题，实现高效精准的推理输出。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T18:04:13Z
- **目录日期**: 2025-05-29
