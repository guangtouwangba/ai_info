...
华为提出S-GRPO新方法，优化大模型推理效率。该方法通过"串行分组+衰减奖励"机制，允许AI在推理过程中提前终止：完整推理后训练模型在任意中间步骤作答，答对越早奖励越高。实验显示，S-GRPO使计算量减少60%，在数学和科学推理任务中，不仅路径更短且准确率更高，尤其适合长度受限场景，仅需一半资源即可达到更好效果。相比传统GRPO的"拖到底"模式，新方法实现了效率与精度的双重提升。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T14:03:42Z
- **目录日期**: 2025-05-29
