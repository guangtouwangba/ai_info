...
华为提出新型S-GRPO方法优化大模型推理效率，通过"提前终止"机制显著提升性能。该方法采用三步策略：完整推理路径→允许中途打断→按提前答对给予衰减奖励。相比传统GRPO强制完整推理，S-GRPO训练出的模型能在确保准确率前提下，平均节省60%计算量。在数学/科学推理五大任务测试中，该方法不仅缩短推理路径，准确率也更高，尤其适合计算资源受限场景，用一半预算即可达到更优效果。该技术有效解决了AI"过度思考"导致的效率低下问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T15:03:47Z
- **目录日期**: 2025-05-29
