...
华为提出S-GRPO新方法，解决大模型推理"想太多"问题。该方法通过"串行分组+衰减奖励"机制，允许AI在推理过程中提前终止：完整推理后训练模型在任意中间步骤作答，并给予"越早答对奖励越高"的激励。实验显示，S-GRPO在数学/科学推理任务中节省60%计算量，同时提升准确率，尤其在长度受限时优势显著，仅需一半计算资源即可达到更优效果。该方法实现了推理效率与精度的双重突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T20:03:33Z
- **目录日期**: 2025-05-29
