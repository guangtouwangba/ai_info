...
DeepSeek R1模型近期完成小版本升级，官方在开发者交流群中低调宣布了这一消息。升级后的模型性能显著提升，用户可通过官网、APP或小程序体验，API接口保持不变。部分用户测试后反馈性能大幅改进，甚至认为可与Claude 4媲美。官方建议使用"深度思考"功能以获得更好效果，并鼓励用户自行测试代码生成等能力，在评论区分享结果。此次升级虽未正式公告，但已引发开发者社区关注。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T02:33:03Z
- **目录日期**: 2025-05-29
