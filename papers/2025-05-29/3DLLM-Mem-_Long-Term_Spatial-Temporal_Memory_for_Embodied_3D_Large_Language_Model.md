...
该研究针对大语言模型(LLMs)在动态3D环境中空间-时间记忆建模的不足，提出了3DMem-Bench基准测试(含26,000+轨迹和2,892项任务)和3DLLM-Mem记忆管理模型。该模型通过工作记忆标记查询并融合情景记忆中的关键空间-时间特征，使智能体能在复杂环境中高效聚焦任务相关信息。实验显示，3DLLM-Mem在最具挑战性的野外任务中成功率比最优基线高16.5%，实现了最先进的性能表现。研究解决了LLMs在3D环境中的长期记忆推理难题，推动了具身智能的发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T14:01:02Z
- **目录日期**: 2025-05-29
