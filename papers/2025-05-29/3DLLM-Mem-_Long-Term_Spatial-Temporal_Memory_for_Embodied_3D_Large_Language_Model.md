...
本文提出3DLLM-Mem模型，通过动态记忆管理解决大语言模型(LLM)在3D环境中的空间-时间推理问题。研究首先构建了包含2,892项任务的3DMem-Bench基准测试，含26,000多条轨迹。该模型采用工作记忆令牌查询情景记忆，选择性融合关键时空特征，使智能体能在复杂环境中高效聚焦任务相关信息。实验表明，3DLLM-Mem在最具挑战性的野外任务中成功率比最强基线高16.5%，实现了最先进的性能表现。该研究为LLM在动态3D环境中的规划与行动提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T08:00:59Z
- **目录日期**: 2025-05-29
