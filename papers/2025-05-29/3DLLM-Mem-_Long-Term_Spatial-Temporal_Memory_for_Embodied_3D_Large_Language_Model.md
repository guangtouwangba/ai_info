...
本文提出3DMem-Bench基准测试和3DLLM-Mem模型，解决大语言模型在3D环境中空间-时间记忆推理的不足。3DMem-Bench包含26,000+轨迹和2,892项任务，用于评估3D环境中的长期记忆能力。3DLLM-Mem采用工作记忆标记查询并融合情景记忆中的关键时空特征，实现高效记忆管理。实验显示，该模型在最具挑战性的任务上以16.5%的优势超越现有基线，显著提升了动态3D环境中的规划与行动能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T18:01:44Z
- **目录日期**: 2025-05-29
