...
本文提出了一种端到端自主信息检索智能体构建范式，包含四个关键阶段：(1)浏览数据构建、(2)轨迹采样、(3)监督微调实现有效冷启动、(4)强化学习提升泛化能力。基于ReAct框架实现的WebDancer网络代理，在GAIA和WebWalkerQA等复杂信息检索基准测试中表现优异。该训练范式展现了开发更强大代理模型的系统路径，相关代码和演示将在GitHub发布。研究结果表明，这种数据驱动、分阶段训练的方法能有效提升多步骤自主研究能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T20:01:20Z
- **目录日期**: 2025-05-29
