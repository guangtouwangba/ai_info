...
本文提出了一种端到端自主信息检索智能体的构建范式，包含四个关键阶段：(1)浏览数据构建、(2)轨迹采样、(3)监督微调实现有效冷启动、(4)强化学习提升泛化能力。基于ReAct框架实现的WebDancer网络智能体在GAIA和WebWalkerQA等复杂信息检索基准测试中表现优异。该方法从数据中心和训练阶段视角出发，为开发更强大的智能体模型提供了系统化路径和实用见解。相关代码和演示将在GitHub发布。研究展示了自主多步研究智能体在解决复杂现实问题方面的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T21:01:19Z
- **目录日期**: 2025-05-29
