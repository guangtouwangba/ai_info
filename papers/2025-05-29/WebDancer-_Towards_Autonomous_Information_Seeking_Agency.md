...
本文提出了一种端到端自主信息检索智能体构建框架WebDancer，基于ReAct架构，包含四个关键阶段：(1)浏览数据构建、(2)轨迹采样、(3)监督微调冷启动、(4)强化学习增强泛化能力。该框架在GAIA和WebWalkerQA基准测试中表现优异，验证了训练范式的有效性。研究还分析了智能体训练过程，为开发更强大的自主模型提供了系统化路径。代码和演示将发布于Alibaba-NLP的GitHub仓库。该工作展示了从数据中心和训练阶段视角构建多步骤研究智能体的可行性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T23:01:13Z
- **目录日期**: 2025-05-29
