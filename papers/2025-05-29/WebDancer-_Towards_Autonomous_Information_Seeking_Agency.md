...
本文提出了一种端到端自主信息检索智能体的构建范式，包含四个关键阶段：(1)浏览数据构建、(2)轨迹采样、(3)监督微调实现有效冷启动、(4)强化学习提升泛化能力。基于ReAct框架实现的WebDancer网络代理在GAIA和WebWalkerQA等复杂信息检索基准测试中表现优异，验证了该训练范式的有效性。研究还分析了智能体训练过程，为开发更强大的代理模型提供了系统化路径。相关代码和演示将在https://github.com/Alibaba-NLP/WebAgent发布。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T15:01:31Z
- **目录日期**: 2025-05-29
