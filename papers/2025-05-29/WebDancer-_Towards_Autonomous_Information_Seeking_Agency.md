...
本文提出了一种端到端自主信息检索智能体构建框架WebDancer，基于ReAct架构，包含四个关键阶段：浏览数据构建、轨迹采样、监督微调冷启动和强化学习泛化增强。该框架在GAIA和WebWalkerQA等复杂信息检索基准测试中表现优异，验证了训练范式的有效性。研究不仅展示了智能体在多步推理任务中的潜力，还为开发更强大的自主研究系统提供了系统化路径。相关代码和演示将在Alibaba-NLP的GitHub仓库开源。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T13:09:51Z
- **目录日期**: 2025-05-29
