...
本文提出了一种端到端自主信息检索智能体构建框架WebDancer，基于ReAct架构，包含四个关键阶段：(1)构建浏览数据，(2)轨迹采样，(3)监督微调实现冷启动，(4)强化学习提升泛化能力。该框架在GAIA和WebWalkerQA等复杂信息检索基准测试中表现优异，验证了训练范式的有效性。研究还分析了智能体训练过程，为开发更强大的自主模型提供了系统化路径。相关代码和演示将在Alibaba-NLP的GitHub仓库开源。该工作为构建多步骤自主研究系统提供了数据驱动的新范式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T22:01:18Z
- **目录日期**: 2025-05-29
