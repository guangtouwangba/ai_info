...
本文提出了一种构建端到端自主信息搜索智能体的数据驱动训练框架WebDancer，基于ReAct架构。该框架包含四个关键阶段：(1)构建浏览数据，(2)轨迹采样，(3)监督微调实现冷启动，(4)强化学习提升泛化能力。在GAIA和WebWalkerQA基准测试中表现优异，验证了训练范式的有效性。研究为开发更强大的智能体模型提供了系统化路径和实用见解。代码和演示将发布于https://github.com/Alibaba-NLP/WebAgent。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T06:01:29Z
- **目录日期**: 2025-05-29
