...
本文提出了一种端到端自主信息搜索智能体的构建范式，包含四个关键阶段：(1) 浏览数据构建，(2) 轨迹采样，(3) 监督微调实现有效冷启动，(4) 强化学习提升泛化能力。基于ReAct框架实现的WebDancer网络代理在GAIA和WebWalkerQA基准测试中表现优异。该训练范式不仅验证了有效性，还为开发更强大的自主模型提供了系统化路径。代码和演示将在GitHub发布。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T17:01:19Z
- **目录日期**: 2025-05-29
