...
本文提出了一种构建端到端自主信息搜索智能体的数据驱动训练范式WebDancer，基于ReAct框架。该方法包含四个关键阶段：构建浏览数据、轨迹采样、监督微调实现冷启动，以及强化学习提升泛化能力。在GAIA和WebWalkerQA等复杂信息检索基准测试中，WebDancer表现出色，验证了该训练范式的有效性。研究还分析了智能体训练过程，为开发更强大的自主模型提供了系统化路径。相关代码和演示将发布于Alibaba-NLP的GitHub仓库。该工作展示了从数据和训练角度构建多步骤研究智能体的可行性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T07:01:14Z
- **目录日期**: 2025-05-29
