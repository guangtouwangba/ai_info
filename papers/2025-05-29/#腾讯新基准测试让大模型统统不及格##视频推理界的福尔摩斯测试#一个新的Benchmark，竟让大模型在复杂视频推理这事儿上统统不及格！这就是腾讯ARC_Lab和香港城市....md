...
腾讯ARC Lab和香港城市大学联合推出Video-Holmes基准测试，专门评估多模态大模型的复杂视频推理能力。该测试通过"推理凶手""解析作案意图"等高难度任务，突破现有基准视频简单、难以区分推理能力的局限。结果显示，所有参与测试的大模型均未及格，暴露出当前技术在复杂视频推理领域的不足。测试代码已开源至GitHub和HuggingFace，供研究者挑战。这一"视频版福尔摩斯测试"为AI视频推理能力设立了新标准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T12:03:34Z
- **目录日期**: 2025-05-29
