...
腾讯ARC Lab与香港城市大学联合推出Video-Holmes基准测试，专门评估多模态大模型在复杂视频推理任务（如凶案推理、作案意图分析）中的表现。该测试通过高难度场景弥补了现有基准视频简单、无法区分推理能力的缺陷。结果显示，所有参与测试的大模型均未达标，暴露出当前技术在复杂推理任务上的局限性。测试工具已开源至GitHub和HuggingFace，供研究者挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T21:03:19Z
- **目录日期**: 2025-05-29
