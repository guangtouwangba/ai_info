...
腾讯ARC Lab和香港城市大学联合推出名为Video-Holmes的新基准测试，专门评估多模态大模型在复杂视频推理任务（如推理凶手、作案意图等）上的表现。该测试解决了现有基准视频源和问题过于简单的问题，能更好区分推理与非推理模型。结果显示，所有测试的大模型均未及格，表现不佳。测试工具包已开源至GitHub和HuggingFace，供研究者挑战。这一"福尔摩斯式"测试突显了大模型在复杂视频推理上的能力局限。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-29T22:03:19Z
- **目录日期**: 2025-05-29
