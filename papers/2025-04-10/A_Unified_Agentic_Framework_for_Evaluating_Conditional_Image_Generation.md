...
本文提出CIGEval框架，利用多模态大模型（LMMs）作为核心，结合多功能工具箱和细粒度评估体系，为条件图像生成任务提供统一、可靠的自动化评估方案。实验表明，基于GPT-4o的CIGEval与人类评估的相关性达0.4625（接近人工评估者间0.47的相关性）。仅用2.3K训练轨迹微调的7B开源LMMs版本即超越此前最佳方法。案例研究证实其能识别主题一致性和控制引导遵循等细微问题，展现了接近人类水平的自动化评估潜力。该框架为图像生成任务提供了可解释、任务无关的评估新范式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T08:01:33Z
- **目录日期**: 2025-04-10
