...
本文提出了CIGEval框架，利用多模态大模型（LMMs）作为核心，结合多功能工具箱和细粒度评估体系，为条件图像生成任务提供统一、可靠的自动化评估方案。实验表明，GPT-4o版本的CIGEval与人类评估的相关性达0.4625，接近评估者间相关性0.47。仅用2.3K训练轨迹的7B开源LMMs实现时，其性能超越此前基于GPT-4o的最佳方法。案例研究证实CIGEval能识别主题一致性和控制引导遵循等细微问题，展现了接近人类水平的自动化评估潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T09:01:40Z
- **目录日期**: 2025-04-10
