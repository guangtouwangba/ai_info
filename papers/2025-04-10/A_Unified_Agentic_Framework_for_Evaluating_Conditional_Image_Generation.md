...
本文提出了CIGEval框架，用于条件图像生成的自动化评估。该框架以大型多模态模型（LMMs）为核心，结合多功能工具箱和细粒度评估体系，能自主选择工具并进行分析。实验表明，GPT-4o版本的CIGEval与人工评估的相关系数达0.4625，接近人工评估者间0.47的相关性。使用7B开源LMMs和仅2.3K训练轨迹时，其性能超越基于GPT-4o的现有最优方法。案例研究显示，CIGEval能识别主题一致性和控制引导等细微问题，展现了接近人类水平的可靠自动化评估潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T13:08:43Z
- **目录日期**: 2025-04-10
