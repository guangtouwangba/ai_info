...
本文提出CIGEval框架，利用多模态大模型（LMMs）作为核心，构建了条件图像生成的统一评估系统。该框架整合多功能工具箱和细粒度评估标准，并通过合成训练轨迹使小型LMMs能自主选择工具进行细致分析。实验表明，GPT-4o版本的CIGEval与人工评估相关性达0.4625（接近人工评估者间相关性0.47）。仅用2.3K训练轨迹的7B开源LMMs实现时，其性能超越此前基于GPT-4o的最佳方法。案例研究证实CIGEval能识别主体一致性和控制引导等细微问题，展现了接近人类水平的自动化评估潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T06:02:05Z
- **目录日期**: 2025-04-10
