...
本文提出CIGEval框架，利用多模态大模型（LMMs）作为核心，通过多功能工具箱和细粒度评估体系，实现条件图像生成任务的自动化评估。CIGEval（GPT-4o版）在七项任务实验中与人工评估的相关系数达0.4625，接近评估者间0.47的相关性。仅用2.3K训练轨迹微调后，7B开源LMMs版本甚至超越此前基于GPT-4o的最佳方法。案例研究表明，CIGEval能识别主题一致性和控制引导遵循等细微问题，展现出接近人类可靠性的自动化评估潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T07:01:32Z
- **目录日期**: 2025-04-10
