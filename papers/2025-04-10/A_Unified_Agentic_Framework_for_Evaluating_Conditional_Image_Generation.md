...
本文提出了CIGEval框架，用于条件图像生成任务的自动化评估。该框架以大型多模态模型（LMMs）为核心，整合多功能工具包并建立细粒度评估体系。实验表明，GPT-4o版本的CIGEval与人工评估的相关系数达0.4625（接近人工评估者间0.47的相关性）。仅用2.3K训练轨迹的7B开源LMMs版本即超越此前基于GPT-4o的最佳方法。案例研究显示，CIGEval能识别图像生成中主体一致性和控制引导遵循等细微问题，展现了实现人类级别可靠自动化评估的潜力。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T16:01:37Z
- **目录日期**: 2025-04-10
