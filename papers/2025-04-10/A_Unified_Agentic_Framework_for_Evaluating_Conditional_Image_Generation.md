...
本文提出了CIGEval框架，用于条件图像生成的自动化评估。该框架以大型多模态模型（LMMs）为核心，整合多功能工具箱，建立细粒度评估体系。实验表明，GPT-4o版本的CIGEval与人工评估的相关性达0.4625，接近人工评估者间的相关性（0.47）。仅用2.3K训练轨迹的7B开源LMMs实现时，CIGEval性能超越之前基于GPT-4o的最佳方法。案例研究显示，该框架能识别主题一致性和控制引导遵循等细微问题，展现了接近人类水平的自动化评估潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T14:01:40Z
- **目录日期**: 2025-04-10
