...
本文提出CIGEval框架，利用多模态大模型（LMMs）作为核心，结合多功能工具箱和细粒度评估体系，实现条件图像生成任务的自动化评估。通过合成微调轨迹，CIGEval使小型LMMs能自主选择工具并分析结果。实验表明，GPT-4o版本的CIGEval与人工评估的相关系数达0.4625，接近评估者间0.47的相关性；使用7B开源LMMs和2.3K训练轨迹时，其性能超越此前基于GPT-4o的最佳方法。案例研究显示，CIGEval能识别图像生成中的细微问题（如主体一致性和控制引导遵循度），展现了接近人类水平的可靠评估潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T04:01:36Z
- **目录日期**: 2025-04-10
