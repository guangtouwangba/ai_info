...
根据微博信息，网友在ChatGPT网页端前端代码中发现"o4-mini"、"o4-mini-high"和"o3"等模型名称的引用。这些代码由互联网档案馆Wayback Machine在2025年4月10日无意中保存。虽然目前无法确认"o4"模型的具体信息，但代码泄露表明OpenAI可能在开发新一代模型。该发现通过JavaScript文件曝光，需要使用iframe工具才能完整显示相关代码内容。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T10:03:21Z
- **目录日期**: 2025-04-10
