...
根据微博信息，有网友发现ChatGPT网页端前端代码中出现了"o4-mini"、"o4-mini-high"和"o3"等模型名称的引用。这些代码是通过互联网档案馆Wayback Machine意外保存的2025年4月10日的JavaScript文件。虽然目前OpenAI尚未正式发布o4模型，但代码中的这些引用引发了关于新一代模型可能即将发布的猜测。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T16:03:52Z
- **目录日期**: 2025-04-10
