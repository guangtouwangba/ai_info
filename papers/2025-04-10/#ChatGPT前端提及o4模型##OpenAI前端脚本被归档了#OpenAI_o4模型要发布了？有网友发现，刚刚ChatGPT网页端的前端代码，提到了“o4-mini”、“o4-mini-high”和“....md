...
根据网友发现，ChatGPT网页端前端代码中意外出现了"o4-mini"、"o4-mini-high"和"o3"等模型名称的引用。这些信息是通过互联网档案馆Wayback Machine保存的2025年4月10日的JavaScript文件泄露的。代码截图显示OpenAI可能正在开发代号为o4的新模型系列，但目前官方尚未确认该消息的真实性。这一发现引发了关于OpenAI即将发布新一代AI模型的猜测。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T23:03:54Z
- **目录日期**: 2025-04-10
