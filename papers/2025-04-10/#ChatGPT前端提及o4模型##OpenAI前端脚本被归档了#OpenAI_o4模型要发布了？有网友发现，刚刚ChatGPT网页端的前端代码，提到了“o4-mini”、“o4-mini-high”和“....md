...
网友发现ChatGPT网页端前端代码中出现了"o4-mini"、"o4-mini-high"和"o3"等字样，疑似暗示OpenAI即将发布o4模型。这些代码是通过互联网档案馆Wayback Machine意外保存的2025年4月10日的JavaScript文件。虽然目前官方尚未确认，但这一发现引发了关于OpenAI新一代模型可能即将发布的猜测。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T12:03:42Z
- **目录日期**: 2025-04-10
