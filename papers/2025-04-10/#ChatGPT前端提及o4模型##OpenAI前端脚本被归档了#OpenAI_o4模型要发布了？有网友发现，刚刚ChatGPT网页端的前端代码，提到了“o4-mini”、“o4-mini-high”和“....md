...
微博网友发现ChatGPT网页端前端代码中出现了"o4-mini"、"o4-mini-high"和"o3"等字样，这些代码被互联网档案馆Wayback Machine意外保存。代码保存时间为2025年4月10日，格式为JavaScript文件。这一发现引发猜测OpenAI可能即将发布新的o4模型。代码链接显示为加密内容，但通过iframe工具可解析出相关模型名称。目前尚不清楚这是测试代码还是即将发布的新版本。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T22:03:28Z
- **目录日期**: 2025-04-10
