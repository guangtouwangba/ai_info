...
OpenAI疑似即将发布o4模型。网友在ChatGPT网页端前端代码中发现"o4-mini"、"o4-mini-high"和"o3"等字样，这些信息由互联网档案馆Wayback Machine在2025年4月10日无意保存的JavaScript文件中泄露。代码链接显示为加密内容，但通过iframe工具可解析出相关模型名称。这一发现引发了对OpenAI新一代模型发布的猜测。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T09:03:09Z
- **目录日期**: 2025-04-10
