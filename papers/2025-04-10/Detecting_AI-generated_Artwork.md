...
人工智能(AI)生成艺术的高效性和高质量对人类艺术家提出了新挑战。本研究探索了不同机器学习方法在区分AI生成与人类创作艺术品方面的效用，特别针对巴洛克、立体主义和表现主义三种复杂艺术风格。测试了逻辑回归、支持向量机、多层感知器和卷积神经网络等模型。实验结果显示，六分类任务最高准确率达0.8208，而区分AI与人类艺术的二分类准确率高达0.9758。这表明机器学习模型能有效识别不同艺术风格的创作来源差异。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T18:01:25Z
- **目录日期**: 2025-04-10
