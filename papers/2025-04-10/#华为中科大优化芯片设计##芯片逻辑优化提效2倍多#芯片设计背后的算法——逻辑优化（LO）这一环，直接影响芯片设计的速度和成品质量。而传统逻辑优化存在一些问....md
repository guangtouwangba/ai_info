...
中科大与华为合作开发了新型AI框架CMO，结合图神经网络(GNN)和蒙特卡洛树搜索(MCTS)，优化芯片设计中的逻辑优化环节。该框架通过"教师-学生"模式，将GNN学到的知识转化为轻量级打分函数，显著减少无效操作。实验显示，CMO使优化效率提升最高2.5倍，电路深度减少30%，时间缩短60%。该技术已集成至华为EMU工具，支持国产EDA发展。核心创新GESD方案采用结构-语义特征分离、知识蒸馏等策略，在CPU环境下实现高效优化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T00:05:07Z
- **目录日期**: 2025-04-10
