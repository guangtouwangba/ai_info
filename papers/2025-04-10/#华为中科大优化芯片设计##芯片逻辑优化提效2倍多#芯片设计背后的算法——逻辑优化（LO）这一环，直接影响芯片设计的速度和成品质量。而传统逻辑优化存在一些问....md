...
中科大与华为联合研发的CMO框架通过结合图神经网络(GNN)和蒙特卡洛树搜索(MCTS)，显著提升了芯片逻辑优化效率。该技术采用"教师-学生"模式，GNN学习有效逻辑转换后，通过符号学习将知识传递给MCTS，最终生成轻量级评分函数。实验显示，在多个电路数据集上，CMO使优化时间最多减少60%，电路深度降低30%，效率提升达2.5倍。该方案已集成至华为EMU工具，支持国产EDA发展，且仅需CPU即可运行，摆脱GPU依赖。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T03:17:18Z
- **目录日期**: 2025-04-10
