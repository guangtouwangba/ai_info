...
近期大视觉语言模型(LVLMs)在多个领域展现出强大能力，但医学等专业领域的表现尚未充分评估。研究团队提出RadVUQA基准测试，从五个维度评估LVLMs：1)解剖学理解；2)多模态理解；3)定量与空间推理；4)生理知识；5)抗干扰能力。结果显示，通用和医疗专用LVLMs在跨模态理解和定量推理方面存在明显不足，与临床医生水平差距显著。该研究强调需要开发更强大、智能的LVLMs。相关代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T09:02:47Z
- **目录日期**: 2025-04-10
