...
该研究提出了RadVUQA基准测试，用于全面评估大型视觉语言模型(LVLMs)在医学影像领域的表现。测试涵盖五个维度：解剖学理解、多模态理解、定量与空间推理、生理学知识以及抗干扰能力。结果显示，无论是通用LVLMs还是医学专用LVLMs，在多模态理解和定量推理方面都存在明显不足。研究发现现有模型与临床医生水平存在巨大差距，亟需开发更强大、智能的LVLMs。该研究为医学AI发展提供了重要评估工具，相关代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T08:02:35Z
- **目录日期**: 2025-04-10
