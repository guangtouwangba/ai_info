...
近期大视觉语言模型(LVLMs)在多个领域展现出卓越能力，但医学等专业领域的性能评估仍不足。研究团队提出RadVUQA基准，从五个维度全面评估LVLMs：1)解剖结构识别能力；2)多模态理解能力；3)定量与空间推理能力；4)生理知识掌握；5)对非协调和合成数据的鲁棒性。结果显示，通用和医学专用LVLMs在多模态理解和定量推理方面存在严重不足，与临床医生水平差距显著。该研究强调需要开发更强大、智能的LVLMs。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T06:03:40Z
- **目录日期**: 2025-04-10
