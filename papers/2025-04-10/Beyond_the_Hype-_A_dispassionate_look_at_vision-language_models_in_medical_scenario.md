...
该研究提出了RadVUQA基准测试，用于全面评估大型视觉语言模型(LVLMs)在医学放射学领域的表现。该测试从五个维度(解剖学理解、多模态理解、定量空间推理、生理学知识和鲁棒性)对现有模型进行评估。结果显示，无论是通用LVLMs还是医学专用LVLMs都存在关键缺陷，特别是在多模态理解和定量推理能力方面较弱。研究发现现有LVLMs与临床医生水平存在巨大差距，亟需开发更强大、更智能的模型。相关代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T13:09:49Z
- **目录日期**: 2025-04-10
