...
该研究提出了RadVUQA基准，从五个维度全面评估大型视觉语言模型(LVLMs)在医学领域的表现：解剖理解、多模态理解、定量空间推理、生理知识掌握和鲁棒性。结果表明，无论是通用LVLMs还是医学专用LVLMs都存在关键缺陷，特别是在多模态理解和定量推理能力方面表现薄弱。研究发现现有LVLMs与临床医生水平存在巨大差距，亟需开发更强大、更智能的模型。该基准测试为改进医学领域的视觉语言模型提供了重要参考。代码已开源在https://github.com/Nandayang/RadVUQA。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T11:02:20Z
- **目录日期**: 2025-04-10
