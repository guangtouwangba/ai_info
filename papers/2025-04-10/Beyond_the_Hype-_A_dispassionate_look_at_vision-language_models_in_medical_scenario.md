...
该研究提出了RadVUQA基准，用于全面评估大型视觉语言模型(LVLMs)在放射学领域的表现。该基准从五个维度测试模型能力：解剖学理解、多模态理解、定量与空间推理、生理学知识及鲁棒性。研究发现，无论是通用LVLMs还是医学专用LVLMs都存在显著缺陷，特别是在多模态理解和定量推理方面表现薄弱。结果表明现有模型与临床医生水平存在巨大差距，亟需开发更强大、智能的LVLMs。研究代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T05:02:34Z
- **目录日期**: 2025-04-10
