...
近期大视觉语言模型(LVLMs)在多个领域展现出卓越能力，但在医学等专业领域的表现仍缺乏充分评估。研究者提出RadVUQA基准测试，从五个维度全面评估LVLMs：1)解剖学理解；2)多模态理解；3)定量与空间推理；4)生理学知识；5)对抗非协调和合成数据的鲁棒性。结果显示，无论是通用LVLMs还是医学专用LVLMs，在多模态理解和定量推理方面都存在明显不足，与临床医生水平差距显著。该研究强调了开发更强大智能LVLMs的迫切需求。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T20:02:24Z
- **目录日期**: 2025-04-10
