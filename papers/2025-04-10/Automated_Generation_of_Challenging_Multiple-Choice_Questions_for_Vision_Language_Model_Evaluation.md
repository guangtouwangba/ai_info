...
本文介绍了AutoConverter框架，用于将开放式视觉问答(VQA)自动转换为多选题格式，以解决现有评测基准因回答多样性导致评估困难的问题。实验表明，该方法能生成准确且具挑战性的多选题，且视觉语言模型(VLMs)在其上的表现与人工制作题目相当或更低。基于此构建的VMCBench整合了20个VQA数据集共9,018道多选题，并对33个前沿VLMs进行全面评估，为可扩展、一致且可复现的VLM评测设立了新标准。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T21:02:18Z
- **目录日期**: 2025-04-10
