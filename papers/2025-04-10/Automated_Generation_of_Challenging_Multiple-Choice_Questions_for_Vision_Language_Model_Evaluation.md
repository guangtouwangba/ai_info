...
针对视觉语言模型(VLM)评估的挑战，研究者提出了AutoConverter框架，能够自动将开放式视觉问答(VQA)转换为多选题格式，实现更客观的评估。实验表明，该框架能生成准确且具挑战性的多选题，且VLM在这些题目上的表现与人工创建题目相当或更低。基于此，研究者构建了VMCBench基准，将20个现有VQA数据集统一转换为多选题格式，共包含9,018道题目。该研究对33个最先进的VLM进行了全面评估，为可扩展、一致且可复现的VLM评估设立了新标准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T11:02:10Z
- **目录日期**: 2025-04-10
