...
当前视觉语言模型(VLM)评估面临开放性问题导致评判标准不统一的挑战。研究者提出AutoConverter框架，可自动将开放式视觉问答转换为标准化多选题，显著降低人工标注成本。实验表明，该框架生成的多选题具有正确性和挑战性，且VLM在其上的表现与人工编写题目相当或更低。基于此构建的VMCBench基准整合了20个VQA数据集共9,018道多选题，并对33个前沿VLM进行全面评估，为可扩展、一致且可复现的VLM评估设立了新标准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T13:09:37Z
- **目录日期**: 2025-04-10
