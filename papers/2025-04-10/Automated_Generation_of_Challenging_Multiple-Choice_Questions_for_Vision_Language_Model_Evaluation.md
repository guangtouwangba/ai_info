...
针对视觉语言模型(VLM)评估的挑战，研究者提出了AutoConverter框架，可将开放式视觉问答(VQA)自动转换为多选题格式，实现更客观的评估。实验表明，该方法生成的题目正确且具挑战性，VLM在其上的准确率与人工题目相当或更低。基于此构建的VMCBench基准整合了20个VQA数据集共9,018道多选题，并对33个前沿VLM进行了全面评估，为可扩展、一致且可复现的VLM评估设立了新标准。该研究解决了开放式问题评估的主观性问题，显著降低了多选题制作成本。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T08:02:25Z
- **目录日期**: 2025-04-10
