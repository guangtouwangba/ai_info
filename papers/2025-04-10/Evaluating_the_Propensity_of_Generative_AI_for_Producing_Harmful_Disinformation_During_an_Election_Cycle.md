...
该研究评估了不同生成式AI模型在选举周期中产生有害虚假信息的倾向及其危害。结果显示，Copilot和Gemini表现最安全，产生的预期危害最低，而GPT-4o产生的有害虚假信息最多，危害最高。Gemini在政治类虚假信息中最安全，Copilot在健康类最安全。研究还发现某些对抗性角色特征会增加危害，并开发了预测虚假信息生成的分类模型。基于这些发现，研究提出了减少生成式AI产生有害虚假信息的建议，希望开发者能改进未来模型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T02:28:55Z
- **目录日期**: 2025-04-10
