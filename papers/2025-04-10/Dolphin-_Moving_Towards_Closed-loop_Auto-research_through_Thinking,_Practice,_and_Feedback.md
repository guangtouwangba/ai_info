...
人工智能（AI）正在推动科研范式的变革。本文提出Dolphin框架，一个基于大语言模型（LLM）的闭环系统，旨在提升科研自动化水平。Dolphin通过分析实验反馈和相关文献生成新想法，利用调试优化的代码模板实现这些想法，并自动分析结果以指导下一轮研究。实验表明，Dolphin能持续提升研究主题的性能，在某些任务（如3D点分类）中提出的方法甚至媲美最先进技术。该框架展现了AI在自动科研方面的潜力，通过闭环迭代优化研究流程，显著提高科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T21:02:10Z
- **目录日期**: 2025-04-10
