...
人工智能正在推动科研范式的变革。本文提出的"Dolphin"是一个闭环的LLM驱动框架，旨在提升科研自动化水平。它通过分析先前实验反馈和相关论文生成新想法，利用代码模板实现并调试方案，然后自动分析结果并反馈给下一轮迭代。实验表明，Dolphin能在循环中持续提升输入主题的性能，在某些任务(如3D点分类)中提出的方法甚至媲美最先进水平。该框架展示了AI在自动化科研方面的潜力，通过改进数据分析、加速计算和促进创新想法生成，显著提高了研究效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T20:02:05Z
- **目录日期**: 2025-04-10
