...
本文提出建立AI事故应对机制以防范AI系统对国家安全构成的威胁。作者将"安全关键"领域（如核能、航空、生物双用途研究等）的概念扩展到前沿AI开发，建议实施法律强制的部署后监管制度。该制度分为三阶段：1) AI提供商需在部署前沿系统前提交"国家安全案例"；2) 发生事故时需向政府机构报告；3) 政府参与修订安全规程以应对未来威胁。制度设计参考了美国其他安全关键领域的监管模式，并通过假设性网络攻击案例说明其运作机制。该提案旨在平衡AI创新与国家安全风险管控。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T12:02:11Z
- **目录日期**: 2025-04-10
