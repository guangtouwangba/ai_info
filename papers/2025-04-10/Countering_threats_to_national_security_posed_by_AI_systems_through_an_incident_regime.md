...
近期AI能力的快速发展引发国家安全担忧,如恶意网络攻击关键基础设施或失控自主AI系统。为此,美国立法者提出"AI事件管理机制"应对威胁。本文提出法定AI部署后事件管理方案,将"安全关键"概念扩展到民用核电、航空、生命科学双用途研究和前沿AI开发。方案分三阶段:1)AI供应商部署前沿系统前需提交"国家安全案例";2)发生事件时向政府机构报告;3)政府参与修订安全程序以防范未来威胁。方案借鉴其他安全关键行业经验,并通过模拟AI网络事件场景验证可行性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T04:02:10Z
- **目录日期**: 2025-04-10
