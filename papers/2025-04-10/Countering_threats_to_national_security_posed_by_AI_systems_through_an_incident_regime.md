...
本文提出建立"AI事件监管制度"以应对AI系统对国家安全的潜在威胁。研究者首先定义了"安全关键"领域（如核能、航空、生物双用途研究等），并将前沿AI发展纳入其中。提案包含三个阶段：1) AI提供商部署前沿系统前需提交"国家安全案例"；2) 发生事件时需向政府机构报告；3) 政府参与修订安全程序以防范未来威胁。该制度借鉴了美国其他安全关键领域的监管经验，并通过假设性网络事件场景说明其运作机制，旨在通过法律强制手段确保AI系统的部署后监管。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T22:02:00Z
- **目录日期**: 2025-04-10
