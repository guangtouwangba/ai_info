...
人类通过环境探索、经验抽象和技能协作构建了自我提升机制，但现有自主网络代理仍缺乏关键能力。为此，研究者提出了SkillWeaver框架，使代理能自主合成可重用API技能：在新网站上发现技能、通过实践优化并提炼为稳健API，持续扩展轻量级API库。实验显示，该框架在WebArena和真实网站上分别将成功率提升31.8%和39.8%。强代理合成的API还能通过技能迁移显著提升弱代理性能（WebArena上最高提升54.3%），验证了将网站交互提炼为可共享API的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T08:01:12Z
- **目录日期**: 2025-04-10
