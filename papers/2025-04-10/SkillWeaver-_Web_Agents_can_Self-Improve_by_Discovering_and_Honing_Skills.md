...
人类通过环境探索、经验分层抽象和协作构建技能库实现自我提升。当前自主网络代理缺乏自我改进能力，难以抽象程序性知识、优化技能和组合技能。为此，研究者提出SkillWeaver框架，使代理能自主合成可重用API技能：在新网站发现技能→实践执行→将经验提炼为稳健API。通过迭代探索构建轻量级即插即用API库，实验显示在WebArena和真实网站上的成功率分别提升31.8%和39.8%。强代理合成的API可使弱代理性能提升达54.3%，证明API技能可有效共享并增强不同网络代理的能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T09:01:13Z
- **目录日期**: 2025-04-10
