...
人类通过环境探索、经验分层抽象和协作构建技能库实现自我提升。为赋予自主网络代理类似能力，研究者提出SkillWeaver框架，使代理能自动合成可重用API技能。该框架让代理在新网站自主发现技能、实践执行，并将经验提炼为稳健API。通过迭代探索构建轻量级即插即用API库，显著增强代理能力。实验显示，在WebArena和真实网站上成功率分别提升31.8%和39.8%。强代理合成的API还能提升弱代理性能（WebArena上达54.3%），证明技能共享的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T21:01:16Z
- **目录日期**: 2025-04-10
