...
人类通过环境探索、经验分层抽象和协作构建技能库实现自我提升。现有自主网络代理缺乏这些能力，难以抽象程序性知识、优化技能和组合技能。为此，研究者提出SkillWeaver框架，使代理能自主合成可重用API技能：在新网站发现技能→实践执行→将经验提炼为稳健API。通过迭代探索构建轻量级即插即用API库，显著增强代理能力。在WebArena和真实网站的实验中，成功率分别提升31.8%和39.8%。强代理合成的API还能提升弱代理性能（WebArena上达54.3%），证明API技能可有效共享。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T18:01:18Z
- **目录日期**: 2025-04-10
