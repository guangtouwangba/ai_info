...
人类通过环境探索、经验分层抽象和协作构建技能库实现自我提升。现有自主网络代理缺乏关键的自改进能力，难以抽象程序性知识、优化技能和组合技能。为此，研究者提出SkillWeaver框架，使代理能自主合成可重用的API技能。代理在新网站中自动发现技能、练习执行并将经验提炼为稳健API，通过迭代探索构建轻量级即插即用API库。实验表明，SkillWeaver在WebArena和真实网站上的成功率分别提升31.8%和39.8%，且强代理合成的API可使弱代理性能提升高达54.3%，验证了技能共享的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T17:01:14Z
- **目录日期**: 2025-04-10
