...
本研究利用大语言模型(LLMs)开发了基于Satir模型的"指责型"和"合理化型"虚拟患者(VPs)，用于医疗沟通培训。通过精细的提示工程，这些VP能呈现特定的情感和对话特征。医疗专业人员评估显示，两种VP的真实性评分较高(指责型3.8±1.0，合理化型3.7±0.8，5分制)，且能准确识别其风格。情感分析表明，指责型表现出痛苦、愤怒，合理化型则更冷静。情感评分也证实了沟通风格的差异(指责型3.1±0.6，合理化型4.0±0.4，9分制)。该研究证明了LLMs在模拟复杂医患沟通方面的潜力，为培养医护人员的沟通技巧提供了可扩展的解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T01:29:15Z
- **目录日期**: 2025-04-10
