...
AgentSociety是一个基于大型语言模型的大规模社会模拟器，能模拟1万多个代理及其500万次互动。研究者用它分析了四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害冲击。模拟结果与现实世界数据高度吻合，验证了该系统捕捉人类行为机制的能力。该平台可作为计算社会科学研究的创新工具，为学者和政策制定者提供传统方法（如调查、实验）之外的补充研究手段，有助于深入理解复杂社会现象的内在机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T06:07:41Z
- **目录日期**: 2025-04-10
