...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能模拟10,000+智能代理的社会互动（500万次交互）。该系统通过研究四大社会问题（社会极化、信息传播、基本收入政策、自然灾害影响），验证了其模拟结果与现实数据的吻合度，证明其能有效捕捉人类行为机制。研究展示了AgentSociety作为计算社会科学工具的价值，为政策制定和社会研究提供了新方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T10:05:14Z
- **目录日期**: 2025-04-10
