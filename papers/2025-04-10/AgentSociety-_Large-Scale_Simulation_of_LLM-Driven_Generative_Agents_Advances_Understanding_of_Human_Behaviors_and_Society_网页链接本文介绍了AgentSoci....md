...
该研究介绍了AgentSociety，一个基于大语言模型的大规模社会模拟器，能够模拟1万多个代理及其500万次互动。研究者用它分析了四个关键社会问题：社会极化、信息传播、基本收入政策影响和外部冲击（如飓风）。模拟结果与现实世界数据吻合，验证了该工具在理解人类行为和社会机制方面的有效性。AgentSociety可作为传统社会科学研究方法的补充，帮助研究者和政策制定者探索社会问题的模式和成因，展现了在社会科学领域的应用潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T08:05:20Z
- **目录日期**: 2025-04-10
