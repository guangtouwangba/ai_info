...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能够模拟10,000多个AI代理的社会互动（共500万次交互）。该系统被用于研究四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。研究发现模拟结果与现实世界数据高度吻合，验证了该系统在捕捉人类行为机制方面的有效性。这一工具为社会科学研究和政策制定提供了新的实验平台，能够辅助传统研究方法（如调查和访谈），帮助研究者深入理解社会问题的成因和潜在解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T15:05:41Z
- **目录日期**: 2025-04-10
