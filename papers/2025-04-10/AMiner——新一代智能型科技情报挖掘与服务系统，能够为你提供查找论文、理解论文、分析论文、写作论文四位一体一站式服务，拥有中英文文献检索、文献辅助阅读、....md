...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析和写作的一站式服务，涵盖中英文文献搜索、翻译、辅助阅读等功能。平台收录3.5亿论文、0.6亿学者等海量数据，支持互动问答和自动摘要生成，提升科研效率。用户可上传或搜索论文，获取AI生成的摘要和章节概要，并通过对话深入理解内容。此外，AMiner提供个性化科研动态订阅服务，按用户偏好推送最新学术资讯。平台还包含学者画像、学术会议等特色功能，基础服务免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T03:18:51Z
- **目录日期**: 2025-04-10
