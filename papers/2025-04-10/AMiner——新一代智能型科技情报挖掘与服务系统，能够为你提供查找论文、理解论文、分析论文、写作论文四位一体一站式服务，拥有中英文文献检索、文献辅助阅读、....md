...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、辅助阅读、翻译和科研情报订阅。平台收录3.5亿论文、0.6亿学者等海量数据，支持互动问答、自动摘要生成及文献内容深度解析。用户可通过关键词、学者或机构订阅最新科研动态，并通过微信或邮件接收。此外，AMiner还提供学者画像、学术会议追踪等功能，基础服务免费开放。访问链接：[AMiner官网](https://www.aminer.cn) | [AI功能页](https://www.aminer.cn/chat/g/explain/)。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T06:08:28Z
- **目录日期**: 2025-04-10
