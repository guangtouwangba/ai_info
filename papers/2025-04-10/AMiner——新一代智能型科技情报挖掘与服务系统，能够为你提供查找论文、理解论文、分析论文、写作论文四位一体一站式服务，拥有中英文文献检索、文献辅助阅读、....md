...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献检索，能自动生成摘要并回答用户提问，提升研究效率。平台还具备文献翻译、文档识别和辅助阅读功能，用户可上传PDF或从数据库获取论文，通过AI快速理解内容。此外，AMiner提供科研情报订阅服务，根据用户偏好推送最新学术动态。平台涵盖42个学科，包含3.5亿论文、0.6亿学者等数据，并免费开放基础功能，帮助研究者高效获取学术资源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T22:05:18Z
- **目录日期**: 2025-04-10
