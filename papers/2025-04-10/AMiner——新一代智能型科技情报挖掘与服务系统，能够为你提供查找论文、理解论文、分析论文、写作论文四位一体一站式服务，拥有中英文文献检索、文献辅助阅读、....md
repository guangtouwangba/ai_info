...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和科研订阅等一站式服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持中英文文献检索，并能通过AI生成摘要和解答问题。用户可上传PDF或从平台获取论文，系统会提供摘要、章节概要和问题建议。此外，AMiner提供个性化科研动态订阅，按用户设定的关键词、学者或机构推送最新论文摘要。平台还包含学者画像、学术会议等功能，基础服务免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T12:06:05Z
- **目录日期**: 2025-04-10
