...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、AI辅助阅读、自动摘要生成、翻译及科研情报订阅。平台收录3.5亿论文、0.6亿学者数据，支持用户通过关键词、学者或机构追踪最新研究动态，并能上传PDF进行智能解析和问答互动。特色功能包括个性化文献推荐、学术趋势分析及多终端同步推送（微信/邮件）。基础服务免费开放，致力于提升科研效率。访问入口：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T20:05:28Z
- **目录日期**: 2025-04-10
