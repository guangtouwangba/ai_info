...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作一站式服务。它支持中英文文献搜索、自动摘要生成、AI辅助翻译及互动问答，帮助用户快速理解文献内容。平台还提供科研情报订阅功能，可根据用户偏好推送最新学术动态。此外，AMiner涵盖42个学科的3.5亿论文、0.6亿学者等海量数据，并支持学者画像、学术会议等扩展功能。用户可通过网页免费使用基础服务，提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T19:05:03Z
- **目录日期**: 2025-04-10
