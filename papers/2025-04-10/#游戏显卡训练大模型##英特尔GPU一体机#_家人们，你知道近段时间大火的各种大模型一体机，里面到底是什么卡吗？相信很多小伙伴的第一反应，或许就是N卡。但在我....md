...
英特尔锐炫™显卡正被用于大模型一体机，提供高性价比方案。测试显示，4张A770显卡耗时50分钟完成N卡半小时的任务，但成本仅为半张N卡价格。飞致云公司表示，这种配置适合30-50人团队，将私有化部署成本降低一个数量级。虽然性能略逊于N卡，但锐炫显卡在AI推理任务中展现了突出的性价比优势，为大模型应用提供了更经济的选择。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T01:31:04Z
- **目录日期**: 2025-04-10
