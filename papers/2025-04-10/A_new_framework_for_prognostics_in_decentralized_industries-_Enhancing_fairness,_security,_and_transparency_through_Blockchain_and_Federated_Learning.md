...
本文探讨了在工业5.0背景下，如何通过联邦学习（FL）和区块链（BC）技术提升预测性维护（PM）中设备剩余使用寿命（RUL）的预测能力。传统集中式数据方法存在隐私、安全和扩展性问题，而FL支持多站点本地化模型训练，BC确保网络中的信任、透明度和数据完整性。该框架优化了RUL预测，增强了数据隐私与安全，促进了去中心化制造的协作。实验基于NASA CMAPSS数据集验证了模型有效性，并开源代码以推动工业5.0的创新。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T01:29:36Z
- **目录日期**: 2025-04-10
