...
这篇论文探讨了代码生成大模型(codeLLMs)与人类偏好的对齐问题。研究者创建了CodeArena基准测试(包含397个样本，覆盖40类编程任务和44种语言)，发现现有基准过于关注代码正确性而忽视人类偏好。同时构建了20B标记的SynCode-Instruct合成指令集验证微调效果。实验显示执行基准与CodeArena存在性能差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)差距显著，凸显对齐人类偏好的重要性。研究强调了在评估代码LLMs时需兼顾功能正确性和用户体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T05:05:43Z
- **目录日期**: 2025-04-10
