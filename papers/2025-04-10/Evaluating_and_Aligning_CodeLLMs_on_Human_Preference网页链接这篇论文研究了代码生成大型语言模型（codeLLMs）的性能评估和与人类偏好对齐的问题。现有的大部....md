...
该研究针对代码生成大模型(codeLLMs)提出新评估方法，发现现有基准过度关注代码正确性而忽视人类偏好。研究者构建了CodeArena基准(含397个多样化编程任务)和SynCode-Instruct语料库(20B标记)，实验显示执行基准与人类偏好存在差距，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著。研究强调了代码生成模型与人类偏好对齐的重要性，为改进代码LLMs提供了新方向。(98字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T22:05:27Z
- **目录日期**: 2025-04-10
