...
这篇论文探讨了代码生成大模型(codeLLMs)与人类偏好对齐的问题。研究者创建了CodeArena基准测试(包含397个高质量样本，覆盖40类44种语言)来评估模型在真实编程任务中的表现，发现传统基于执行的测试与人类偏好存在差异。同时开发了20B标记的SynCode-Instruct合成指令集验证微调效果。实验显示开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)存在显著差距，凸显了模型对齐人类偏好的重要性。研究强调了现有评估体系在衡量代码实用性方面的不足。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T23:05:53Z
- **目录日期**: 2025-04-10
