...
这篇论文针对代码生成大模型(codeLLMs)与人类偏好对齐的问题，提出了CodeArena基准测试和SynCode-Instruct数据集。CodeArena包含397个高质量编程任务样本，覆盖40个类别和44种语言，更贴近实际开发场景。研究发现在40多个模型中，开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)存在显著差距，表明单纯代码正确性评估不足以反映人类偏好需求。同时验证了大规模合成指令微调的有效性，突显了代码LLMs与人类偏好对齐的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T17:05:58Z
- **目录日期**: 2025-04-10
