...
这项研究评估了ChatGPT、Google Vertex AI和ORNL检索增强生成（RAG）优化的LLaMA 2/LLaMA在危险材料运输法规检索中的表现。基于约40份美国联邦和州法规文件，研究人员构建了100个与路线规划和许可要求相关的查询。结果显示，RAG增强的LLaMA模型在准确性、细节和相关性方面显著优于其他模型，尽管偶有不一致。该研究首次将RAG技术应用于运输安全领域，强调在高风险场景中，领域特定的模型优化和严格评估对确保可靠性至关重要。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T08:01:43Z
- **目录日期**: 2025-04-10
