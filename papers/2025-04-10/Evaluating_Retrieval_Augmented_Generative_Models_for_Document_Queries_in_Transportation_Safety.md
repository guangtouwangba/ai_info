...
本研究评估了ChatGPT、Google Vertex AI和ORNL检索增强生成（RAG）优化的LLaMA 2/LLaMA在危险品运输法规检索中的表现。通过100个真实查询测试发现，RAG增强的LLaMA模型在准确性、细节和相关性上显著优于其他模型，尽管偶有不一致。研究首次将RAG技术应用于运输安全领域，强调专业领域微调和严格评估对确保高风险场景可靠性的重要性。实验基于40份美国联邦/州法规文件，证实生成式AI在专业领域需针对性优化才能保证信息准确性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T07:01:42Z
- **目录日期**: 2025-04-10
