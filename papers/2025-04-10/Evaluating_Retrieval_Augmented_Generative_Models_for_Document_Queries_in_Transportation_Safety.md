...
该研究评估了ChatGPT、Google Vertex AI和ORNL检索增强生成（RAG）优化的LLaMA 2/LLaMA三种生成式大语言模型在美国危险品运输法规检索中的表现。基于约40份联邦/州法规文件和100个实际查询，RAG优化的LLaMA模型在准确性、细节和相关性方面显著优于其他模型，尽管偶有不一致。这是首次将RAG技术应用于运输安全领域，研究表明高风险专业领域需要针对性的模型优化和严格评估，以确保可靠性并减少错误风险。研究为专业领域大模型应用提供了重要参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T09:01:51Z
- **目录日期**: 2025-04-10
