...
本研究评估了ChatGPT、谷歌Vertex AI和ORNL检索增强生成(LLaMA 2/LLaMA)三种大语言模型在美国危险品运输法规信息检索中的表现。通过100个真实查询测试发现，检索增强的LLaMA模型在准确性、细节和相关性方面显著优于其他模型，尽管偶有不一致。研究首次将检索增强生成技术应用于运输安全领域，强调在专业高风险领域需要对模型进行针对性优化和严格评估，以确保可靠性并降低错误风险。实验基于约40份联邦和州法规文件，采用定性和定量相结合的评价方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T15:01:56Z
- **目录日期**: 2025-04-10
