...
本研究评估了ChatGPT、Google Vertex AI和ORNL检索增强生成（RAG）优化的LLaMA 2/LLaMA在危险材料运输法规检索中的表现。通过分析约40份美国联邦/州法规文件并设计100个实际查询，研究发现RAG增强的LLaMA模型在准确性、细节和相关性上显著优于其他模型，尽管偶有不一致。该研究首次将RAG应用于运输安全领域，强调在专业高风险场景中，需进行领域优化和严格评估以确保可靠性，减少错误风险。结果表明生成式AI在专业领域应用时需针对性改进。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T12:01:49Z
- **目录日期**: 2025-04-10
