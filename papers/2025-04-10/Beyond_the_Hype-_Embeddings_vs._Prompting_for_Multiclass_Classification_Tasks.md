...
该研究表明，在家庭服务项目分类任务中，基于嵌入的softmax模型在准确性、校准性、延迟和成本方面全面优于基于LLM提示的方法。嵌入模型的准确率比提示方法高49.5%，且在纯文本、纯图像和图文混合场景下表现一致更优，同时能生成校准良好的概率输出。此外，嵌入方法处理速度比提示方法快14-81倍，成本可降低10倍。通过A/B测试验证了实际部署效果。这说明对于可利用专有数据的多分类问题，传统嵌入方法仍具优势，不应盲目追求LLM技术。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-10T18:01:52Z
- **目录日期**: 2025-04-10
