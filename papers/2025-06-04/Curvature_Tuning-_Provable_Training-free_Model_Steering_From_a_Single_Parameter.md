...
这篇论文提出了一种新颖的微调方法——曲率调谐(Curvature Tuning, CT)，通过调节激活函数的曲率来调整模型决策边界。与传统基于权重调整的微调方法不同，CT将可解释的超参数注入激活函数，不仅能证明性地改变决策边界曲率，还能将模型投影到平滑函数空间。实验表明，CT具有显著优势：在12个数据集上，ResNet-50/152的下游准确率比线性探测提高7.14%/8.46%，比LoRA提高4.64%/1.70%；在RobustBench的ℓ∞基准测试中，鲁棒准确率提升高达1032.64%/1494.46%。该方法参数高效，同时提升了模型的泛化性和鲁棒性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T19:02:29Z
- **目录日期**: 2025-06-04
