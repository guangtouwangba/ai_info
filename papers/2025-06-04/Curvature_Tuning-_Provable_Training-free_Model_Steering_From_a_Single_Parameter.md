...
这篇论文提出了一种新的微调方法——曲率调节（CT），通过调整激活函数的曲率而非权重来优化预训练模型。CT将激活函数视为样条算子，仅需注入一个超参数即可调节模型决策边界，具有高可解释性。理论证明CT能平滑调整决策边界曲率，与现有侧重特征适应的微调方法形成互补。实验表明，CT显著提升模型性能：在12个数据集上，ResNet-50/152的下游准确率分别比线性探测提高7.14%/8.46%，比LoRA方法提高4.64%/1.70%；在RobustBench对抗攻击基准上，鲁棒准确率提升超过10倍。该方法参数效率高且开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T21:02:28Z
- **目录日期**: 2025-06-04
