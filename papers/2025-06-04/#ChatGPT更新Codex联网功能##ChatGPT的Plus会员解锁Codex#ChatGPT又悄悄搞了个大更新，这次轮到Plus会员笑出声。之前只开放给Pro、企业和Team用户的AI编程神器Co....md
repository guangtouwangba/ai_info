# #ChatGPT更新Codex联网功能##ChatGPT的Plus会员解锁Codex#ChatGPT又悄悄搞了个大更新，这次轮到Plus会员笑出声。之前只开放给Pro、企业和Team用户的AI编程神器Co...
...
ChatGPT向Plus会员开放了Codex编程功能，主要更新包括：1) 支持联网操作（需手动开启，可设置70多个白名单站点）；2) 新增语音输入功能；3) 支持更新PR以适应团队协作。同时，免费用户获得轻量版"记忆功能"，仅能参考最近对话。此次更新降低了AI编程工具的使用门槛，联网能力尤其受到开发者好评。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T01:28:55Z
- **目录日期**: 2025-06-04
