...
这篇论文针对代码生成大模型(codeLLMs)提出了CodeArena基准测试，关注模型输出与人类偏好的对齐问题。研究收集了397个高质量编程任务样本，覆盖40个类别和44种语言，发现传统基于执行的测试与人类偏好存在差异。通过40多个模型的对比实验显示，开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。同时构建了20B标记的SynCode-Instruct合成指令集，验证了大规规模指令微调的有效性，强调了人类偏好对齐在代码生成中的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T06:04:42Z
- **目录日期**: 2025-06-04
