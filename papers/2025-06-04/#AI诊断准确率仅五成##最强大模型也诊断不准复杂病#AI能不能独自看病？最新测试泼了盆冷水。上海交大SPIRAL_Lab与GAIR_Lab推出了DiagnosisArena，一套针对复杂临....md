# #AI诊断准确率仅五成##最强大模型也诊断不准复杂病#AI能不能独自看病？最新测试泼了盆冷水。上海交大SPIRAL Lab与GAIR Lab推出了DiagnosisArena，一套针对复杂临...
...
上海交大团队推出DiagnosisArena评测集，测试AI在复杂临床诊断中的表现。该评测基于权威医学期刊的1113道高难度病例题，涵盖28个科室，并排除了模型可能记忆的题目。测试结果显示，即使最强的GPT-4o模型准确率也仅为51.12%，其他模型表现更差。开放问答模式下，部分模型表现明显下滑，表明当前AI尚不具备"像医生一样思考"的能力。这项研究揭示了AI在独立医疗诊断中的局限性，尤其对复杂病例的判断仍有较大提升空间。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T18:03:28Z
- **目录日期**: 2025-06-04
