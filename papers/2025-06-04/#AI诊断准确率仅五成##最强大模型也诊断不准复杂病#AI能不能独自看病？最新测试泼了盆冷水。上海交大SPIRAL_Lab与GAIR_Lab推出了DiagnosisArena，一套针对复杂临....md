...
上海交大团队推出DiagnosisArena评测集，测试AI在复杂临床诊断中的表现。该评测集基于权威医学期刊的1113道高难度题目，涵盖28个科室。测试结果显示，最强模型GPT-4o准确率仅51.12%，其他模型表现更差。开放问答模式下，部分模型表现明显下滑，表明AI尚未掌握"医生式思考"。研究证实当前AI独立诊断能力有限，尤其在复杂病例处理上存在明显不足。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T17:03:22Z
- **目录日期**: 2025-06-04
