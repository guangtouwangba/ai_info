...
上海交大团队推出DiagnosisArena评测集，测试AI在复杂临床诊断中的表现。该评测集基于权威医学期刊的1113道高难度题目，涵盖28个科室，确保模型无法依赖记忆作答。测试结果显示，最强模型GPT-4o准确率仅51.12%，其他模型表现更差，开放问答模式下缺陷尤为明显。研究表明当前AI尚不具备"像医生一样思考"的能力，无法独立完成复杂疾病的准确诊断。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T21:03:17Z
- **目录日期**: 2025-06-04
