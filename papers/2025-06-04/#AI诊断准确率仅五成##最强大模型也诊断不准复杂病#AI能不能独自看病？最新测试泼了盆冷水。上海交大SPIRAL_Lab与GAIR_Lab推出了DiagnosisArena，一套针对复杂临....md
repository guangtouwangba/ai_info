...
上海交大团队发布DiagnosisArena评测集，测试AI对复杂病例的诊断能力。该评测集包含1113道来自权威期刊的医学题目，涵盖28个科室，并排除了模型可能记住答案的题目。测试结果显示，即使最强的GPT-4o模型准确率也仅为51.12%，其他模型表现更差。开放问答模式下，部分模型表现明显下降，表明AI尚不具备医生般的临床推理能力。研究证实当前AI在独立诊断复杂疾病方面仍有局限。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T10:01:34Z
- **目录日期**: 2025-06-04
