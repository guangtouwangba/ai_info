...
上海交大团队推出DiagnosisArena评测集，测试AI在复杂临床诊断中的表现。该评测基于权威医学期刊的1113道高难度题目，涵盖28个科室，并排除模型可能记忆的题目。测试结果显示，最强模型GPT-4o准确率仅51.12%，其他模型表现更差。开放问答模式下，模型缺陷更明显，表明当前AI尚不具备医生般的临床推理能力。研究证实AI还无法独立完成精准诊疗，尤其在复杂病例诊断方面存在显著局限。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T12:03:51Z
- **目录日期**: 2025-06-04
