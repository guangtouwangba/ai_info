...
上海交大研究团队推出DiagnosisArena评测集，测试AI在复杂临床诊断中的表现。该评测集包含1113道来自顶级医学期刊的病例题，覆盖28个科室，并排除模型可能记忆的题目。测试结果显示，最强模型GPT-4o准确率仅为51.12%，其他模型表现更差。开放问答模式下，部分模型表现明显下滑，表明AI尚未掌握医生式的临床推理能力。研究证实当前AI无法独立完成准确诊断，尤其在复杂病例中表现欠佳。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T20:03:11Z
- **目录日期**: 2025-06-04
