...
研究人员提出了一种新型"Chain-of-Jailbreak"(CoJ)攻击方法，通过分步编辑过程突破Stable Diffusion等文本生成图像模型的安全防护。该方法将恶意查询分解为多个子查询，引导模型迭代生成和编辑图像。在包含9种安全场景的CoJ-Bench数据集测试中，CoJ对GPT-4V等4种主流模型的攻击成功率超过60%，显著高于其他方法(14%)。为应对此威胁，研究团队还开发了"Think Twice Prompting"防御策略，可成功阻止95%以上的CoJ攻击。相关数据和代码已公开以促进AI安全研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T19:02:39Z
- **目录日期**: 2025-06-04
