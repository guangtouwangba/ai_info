...
OpenAI CEO奥特曼在访谈中展望下一代AI模型：理想的AGI应具备超人推理能力、万亿级上下文处理能力，并能调用各种工具，核心是强大的问题解决能力而非知识存储。他认为AGI应能自主发现新科学，或将人类科研效率提升数倍。对于千倍算力假设，他提出极具前瞻性的应用构想。这一观点引发热议，支持者认同其科研愿景，也有担忧者认为过度依赖AI可能带来风险。访谈体现了奥特曼对AI推动科学革命的持续期待。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T20:04:03Z
- **目录日期**: 2025-06-04
