...
OpenAI CEO奥特曼在访谈中展望下一代AI模型：理想的AGI应具备超人推理能力、万亿级上下文处理能力，并能调用各类工具。他强调AGI不需要预先存储知识，而应专注于思考、搜索和问题解决能力，目标是自主发现新科学或将全球科研效率提升数倍。对于算力提升的假设，奥特曼提出概念性方案。这番言论引发两极反应：支持者认同其科研愿景，反对者则担忧人类过度依赖AI决策权。访谈还透露了奥特曼对千倍算力应用的构想。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T09:02:01Z
- **目录日期**: 2025-06-04
