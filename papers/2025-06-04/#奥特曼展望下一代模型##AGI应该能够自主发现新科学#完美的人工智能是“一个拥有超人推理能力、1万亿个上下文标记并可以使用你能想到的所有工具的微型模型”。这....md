...
OpenAI CEO奥特曼在访谈中展望下一代AI模型：理想的AGI应具备超人推理能力、万亿级上下文处理能力，并能调用各类工具。他强调AGI的核心不是存储知识，而是拥有思考、搜索、模拟和解决问题的能力，最终目标是能自主发现新科学，或将人类科研效率提升数倍。部分网友赞同其愿景，也有人担忧过度依赖AI的风险。对于算力提升的假设，奥特曼认为这将极大加速AI发展，但具体方案仍需探索。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T14:05:06Z
- **目录日期**: 2025-06-04
