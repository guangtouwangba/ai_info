...
OpenAI CEO奥特曼在访谈中展望下一代AI模型：理想的AGI应具备超人推理能力、万亿级上下文处理能力，并能调用各种工具。他强调AGI不需要内置知识，而应专注于思考、搜索和问题解决，目标是自主发现新科学或将人类科研效率提升数倍。对于算力提升的假设，他提出概念性方案。这一愿景引发讨论，支持者认同其科研潜力，反对者则担忧人类主导权问题。访谈展现了奥特曼对AGI发展方向的持续思考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T15:13:16Z
- **目录日期**: 2025-06-04
