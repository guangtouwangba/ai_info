...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、科研订阅等一站式服务。它能快速定位相关论文，通过AI生成摘要和问答辅助理解，支持PDF上传分析。平台覆盖42个学科的3.5亿论文、0.6亿学者等数据，用户可定制订阅最新科研动态。此外，还提供学者画像、学术会议等特色功能，基础检索免费使用。网址：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T09:04:44Z
- **目录日期**: 2025-06-04
