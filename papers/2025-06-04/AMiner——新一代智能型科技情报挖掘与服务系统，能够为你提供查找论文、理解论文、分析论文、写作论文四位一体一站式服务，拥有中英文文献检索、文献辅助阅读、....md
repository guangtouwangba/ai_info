...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、翻译、辅助阅读和分析功能。它拥有3.5亿论文、0.6亿学者和1.5亿专利的庞大数据库，支持AI生成摘要、章节概要和互动问答，帮助用户高效理解文献。此外，AMiner提供个性化科研情报订阅，通过微信或邮件推送最新学术动态。平台还涵盖学者画像、学术会议和论文排行榜等功能，基础服务免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T05:06:03Z
- **目录日期**: 2025-06-04
