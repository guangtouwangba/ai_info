...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索（覆盖42个学科3.5亿论文）、AI辅助阅读（自动生成摘要、章节概要和问答互动）、文档翻译及科研情报订阅（按用户偏好推送最新动态）。平台还支持学者画像、学术会议追踪和论文排行榜功能，用户可通过网页或微信小程序免费使用，显著提升文献筛选、阅读和论文写作效率。核心亮点：多语言检索、智能摘要生成、个性化订阅和交互式文献解析。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T01:32:18Z
- **目录日期**: 2025-06-04
