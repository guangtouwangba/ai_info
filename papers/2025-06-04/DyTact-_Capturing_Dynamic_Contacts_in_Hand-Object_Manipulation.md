...
这篇论文提出了DyTact，一种无标记的动态手-物体接触捕捉方法。该方法使用基于2D高斯面元的动态关节表示来建模复杂的手部操作，并将其绑定到MANO网格上，利用模板模型的归纳偏置来稳定和加速优化。DyTact包含一个细化模块处理高频变形，以及接触引导的自适应采样策略，在接触区域选择性增加面元密度以应对严重遮挡。实验表明，DyTact在动态接触估计精度和新视角合成质量上均达到先进水平，同时优化速度快且内存效率高。项目页面：https://oliver-cong02.github.io/DyTact.github.io/。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T08:02:01Z
- **目录日期**: 2025-06-04
