...
该论文提出名为NSA的稀疏注意力机制，通过算法与硬件协同优化解决传统注意力机制处理长文本时的高计算成本问题。其核心创新是动态分层稀疏策略：先粗粒度压缩令牌，再细粒度选择关键令牌，在保持全局上下文感知的同时确保局部精度。NSA具有硬件对齐特性，能高效建模长文本上下文，且保持原生可训练性。这一方法为降低大模型计算开销提供了有效解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T20:05:09Z
- **目录日期**: 2025-06-04
