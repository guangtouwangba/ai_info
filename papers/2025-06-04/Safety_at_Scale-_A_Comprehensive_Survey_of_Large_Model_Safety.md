...
大型模型（如视觉基础模型、大语言模型、扩散模型等）凭借其强大的学习和泛化能力，重塑了AI领域，广泛应用于对话、推荐、自动驾驶、医疗等领域。然而，其广泛部署也带来了安全性风险，包括对抗攻击、数据投毒、越狱攻击、能耗攻击等威胁。本文系统梳理了各类攻击及防御策略，总结了常用数据集与基准，并指出当前挑战：需建立全面的安全评估体系、可扩展的防御机制及可持续数据实践。研究强调，需学术界与国际社会协同合作，推动AI模型安全防护体系的持续发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T02:32:20Z
- **目录日期**: 2025-06-04
