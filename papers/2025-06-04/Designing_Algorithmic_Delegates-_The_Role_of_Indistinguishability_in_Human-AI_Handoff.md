...
随着AI技术的进步，人们更愿意将任务委托给AI代理。然而，人类决策者通常基于可观察特征对问题实例进行分类，而非全面考虑所有因素。本文研究了在分类存在时设计最优算法代理的问题，发现最优代理可能显著优于独立算法。该问题具有组合复杂性，且最优设计与任务特性密切相关。尽管一般情况下寻找最优代理是计算困难的，但在某些广泛场景（如最优动作可分解为人类和算法观察特征的函数时）存在高效解法。实验表明，通过迭代更新的代理虽非全局最优，但通常表现良好。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T16:03:11Z
- **目录日期**: 2025-06-04
