...
随着AI技术的进步，人们更愿意将任务委托给AI代理。人类决策者通常基于可观察特征对问题实例进行分类，并决定是否委托AI处理。研究发现，在分类情境下设计最优AI代理具有挑战性：该问题本质上是组合性的，且最优方案与任务特性关系复杂，通常计算难度很高。不过，研究提出了在某些场景（如最优行动可分解为人类和算法各自观察特征的函数时）的高效求解方法。实验表明，虽然迭代优化的代理未必达到理论最优，但实际表现良好。这为设计人机协作算法提供了重要洞见。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T19:01:54Z
- **目录日期**: 2025-06-04
