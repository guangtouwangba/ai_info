...
随着AI技术进步，人们更倾向于将任务委托给AI代理。人类决策者通常基于可观察特征对问题进行分类，并决定是否委托AI处理。研究发现，在分类情境下设计最优AI代理具有挑战性：该问题本质上是组合性的，且最优代理可能显著优于独立算法。虽然寻找全局最优解是计算困难的，但在某些情况下（如最优行动可分解为人类和算法各自观察特征的函数时）存在高效解法。实验表明，通过迭代更新设计的代理虽非全局最优，但实际表现良好。这为AI与人类协作系统的设计提供了重要洞见。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T17:01:58Z
- **目录日期**: 2025-06-04
