...
随着AI技术发展，人们更倾向于将任务委托给AI代理。人类决策者通常基于可观察特征对问题实例进行分类，决定是否委托AI处理。研究发现，在分类情境下设计最优算法代理具有关键意义——这种委托代理可能比独立算法表现更优。该问题本质上是组合性的，即使在简单场景下，最优设计与任务特性间的关系也很复杂，且通常属于计算难题。不过研究提出了若干高效求解方案，包括当最优行动可分解为人类与算法各自观察特征的函数时。模拟实验表明，通过迭代更新设计的代理虽非全局最优，但实际表现良好。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T22:01:47Z
- **目录日期**: 2025-06-04
