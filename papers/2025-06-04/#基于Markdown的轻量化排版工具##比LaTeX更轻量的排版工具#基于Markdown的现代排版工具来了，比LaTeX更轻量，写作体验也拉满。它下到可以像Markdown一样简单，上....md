...
Quarkdown是一款基于Markdown的轻量化排版工具，兼具LaTeX的灵活性和Markdown的简洁性。它支持函数化书写、多格式导出（HTML/PDF/幻灯片等），并内置可扩展标准库（数学/布局等组件）。相比LaTeX，其语法更清爽、生成速度更快，且支持实时预览。适用于论文、电子书、技术文档等场景，全流程仅需Markdown语法即可完成复杂排版。项目开源地址：github.com/iamgio/quarkdown。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T10:01:43Z
- **目录日期**: 2025-06-04
