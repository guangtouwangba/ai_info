...
Quarkdown是一款基于Markdown的轻量化排版工具，兼具简洁与灵活性。它支持函数化书写、变量和自定义指令，可导出HTML/PDF/幻灯片等多种格式，比LaTeX更轻量快速且支持实时预览。提供开箱即用的标准库（数学、布局等），同时允许用户扩展自定义库。适用于论文、技术文档、电子书等场景，全程使用Markdown语法完成排版。项目地址：github.com/iamgio/quarkdown。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T21:03:25Z
- **目录日期**: 2025-06-04
