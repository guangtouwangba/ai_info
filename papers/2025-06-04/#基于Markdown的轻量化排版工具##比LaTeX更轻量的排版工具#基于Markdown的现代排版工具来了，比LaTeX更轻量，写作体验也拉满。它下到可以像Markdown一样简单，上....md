...
Quarkdown是一款基于Markdown的轻量化排版工具，兼具简洁与灵活性。它支持函数化书写、变量、判断和循环，可导出HTML/PDF/幻灯片等多种格式，比LaTeX更轻量快速且支持实时预览。提供开箱即用的标准库（数学、布局等），并能扩展自定义库，适用于论文、电子书、技术文档等全流程Markdown排版。项目地址：github.com/iamgio/quarkdown。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T19:03:28Z
- **目录日期**: 2025-06-04
