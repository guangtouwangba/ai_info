...
Quarkdown是一款基于Markdown的轻量化排版工具，兼具简洁与灵活性。它支持函数化书写（含变量、判断、循环）、多格式导出（HTML/PDF/幻灯片等），并内置可扩展标准库（数学/布局等组件）。相比LaTeX，其语法更清爽、生成更快且支持实时预览，适用于论文、电子书、技术文档等场景。通过纯Markdown语法即可完成从写作到复杂排版的全流程。项目开源地址：github.com/iamgio/quarkdown。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T13:12:23Z
- **目录日期**: 2025-06-04
