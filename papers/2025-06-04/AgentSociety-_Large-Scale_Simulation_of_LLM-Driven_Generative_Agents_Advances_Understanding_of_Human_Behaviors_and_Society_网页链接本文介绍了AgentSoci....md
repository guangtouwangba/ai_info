...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统，能够模拟超过1万个AI代理的社会互动（500万次）。研究者用它研究了四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据吻合良好，证明该系统能有效捕捉人类行为机制。AgentSociety为社会科学研究和政策制定提供了创新工具，可补充传统研究方法（如调查和实验），帮助理解复杂社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T17:05:29Z
- **目录日期**: 2025-06-04
