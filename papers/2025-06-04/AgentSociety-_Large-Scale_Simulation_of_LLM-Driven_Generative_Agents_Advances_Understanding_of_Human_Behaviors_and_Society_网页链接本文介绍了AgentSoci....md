...
这项研究介绍了AgentSociety——一个结合大型语言模型(LLM)代理、真实社会环境和大规模模拟引擎的社会模拟平台。研究者通过模拟1万多个代理的500万次社会互动，研究了四个关键社会问题：社会极化、信息传播、基本收入政策和自然灾害影响。模拟结果与现实世界数据高度吻合，证明了该平台在捕捉人类行为机制方面的有效性。AgentSociety为社会科学研究和政策制定提供了新工具，能够补充传统研究方法，帮助理解复杂社会现象的模式、成因和潜在机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T22:05:00Z
- **目录日期**: 2025-06-04
