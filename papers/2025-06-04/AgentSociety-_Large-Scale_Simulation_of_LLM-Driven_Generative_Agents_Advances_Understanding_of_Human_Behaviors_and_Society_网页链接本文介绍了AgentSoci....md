...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟超过1万个代理及其500万次互动。研究者用它研究了社会极化、信息传播、基本收入政策及飓风影响等社会问题，结果与现实数据吻合。该系统结合了LLM代理、真实社会环境和强大模拟引擎，可作为计算社会科学实验平台，帮助理解人类行为机制，为研究者和政策制定者提供新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T16:06:33Z
- **目录日期**: 2025-06-04
