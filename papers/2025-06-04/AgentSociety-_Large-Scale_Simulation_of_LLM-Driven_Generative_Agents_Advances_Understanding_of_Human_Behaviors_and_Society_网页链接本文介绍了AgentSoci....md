...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟超过1万个AI代理及其500万次社会互动。研究者利用该平台研究了四大社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实数据高度吻合，验证了系统对人类行为机制建模的有效性。该系统可作为计算社会科学研究的新工具，为政策制定提供仿真实验环境，弥补传统调查和干预研究的局限性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T12:05:54Z
- **目录日期**: 2025-06-04
