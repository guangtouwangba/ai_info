...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟平台。该系统模拟了超过1万个AI代理的社会互动（共500万次），用于研究极化现象、信息传播、基本收入政策及自然灾害影响等社会问题。研究结果表明，该模拟器能有效捕捉人类行为模式，其输出与现实世界数据高度吻合，展现了作为社会科学研究工具的重要潜力，可辅助传统研究方法并为政策制定提供参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T09:04:08Z
- **目录日期**: 2025-06-04
