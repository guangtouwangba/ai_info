...
该研究介绍了AgentSociety，一个基于大语言模型的大规模社会模拟器，可模拟1万多个代理及其500万次互动。研究者用它分析了四个关键社会问题：极化现象、刺激性信息传播、无条件基本收入政策影响和飓风等外部冲击。模拟结果与现实世界实验数据吻合，验证了该系统捕捉人类行为机制的能力。AgentSociety可作为计算社会科学实验平台，辅助传统研究方法，帮助研究者理解社会问题的模式和机制，为政策制定提供新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T04:07:46Z
- **目录日期**: 2025-06-04
