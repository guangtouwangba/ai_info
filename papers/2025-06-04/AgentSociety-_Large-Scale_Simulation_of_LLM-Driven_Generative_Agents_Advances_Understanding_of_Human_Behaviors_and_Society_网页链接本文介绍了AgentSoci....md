...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个智能代理及其500万次互动。研究者利用该系统研究了社会极化、信息传播、基本收入政策及自然灾害影响等社会问题。模拟结果与现实世界数据高度吻合，验证了该系统在揭示人类行为机制方面的有效性。该平台为社会科学研究和政策制定提供了新工具，能补充传统研究方法（如调查和访谈），帮助深入理解社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T14:06:22Z
- **目录日期**: 2025-06-04
