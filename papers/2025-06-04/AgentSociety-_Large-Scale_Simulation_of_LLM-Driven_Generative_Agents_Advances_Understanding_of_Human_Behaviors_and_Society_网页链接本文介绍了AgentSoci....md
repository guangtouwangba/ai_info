...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟1万多个代理及其500万次互动。研究者用它研究四个社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实数据吻合，验证了其捕捉人类行为机制的能力。该系统可作为社会科学研究和政策制定的有力工具，补充传统研究方法如调查和访谈。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T06:04:01Z
- **目录日期**: 2025-06-04
