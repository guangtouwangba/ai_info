...
研究人员提出了一种名为CURE的新型强化学习框架，通过协同进化编码和单元测试生成能力，无需真实代码作为监督。该框架基于交互结果设计专用奖励机制，使单元测试器能直接从编码错误中学习。优化后的ReasonFlux-Coder-7B和14B模型在Qwen2.5-Instruct上实现了5.3%的代码生成准确率提升和9.0%的Best-of-N准确率提升，性能超越同类模型。该模型还能扩展到测试时扩展和智能编码等下游任务，性能提升8.1%。其中ReasonFlux-Coder-4B在长链思维任务中持续优于Qwen3-4B，同时保持64.8%的推理效率。研究还发现该模型可作为基础模型强化学习的有效奖励模型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T17:01:14Z
- **目录日期**: 2025-06-04
