...
研究人员提出了CURE框架，一种新型强化学习方法，通过协同进化代码生成和单元测试能力，无需真实代码作为监督。该方法基于交互结果设计专用奖励机制，使测试器能从编码错误中学习。在Qwen2.5-Instruct模型上优化的ReasonFlux-Coder-7B/14B模型，代码生成准确率提升5.3%，Best-of-N准确率提高9%，优于同类模型。其4B版本在长链推理中超越Qwen3-4B，单元测试生成效率达64.8%。该模型还可作为基础模型的强化学习奖励模型。项目已开源：https://github.com/Gen-Verse/CURE

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T03:21:52Z
- **目录日期**: 2025-06-04
