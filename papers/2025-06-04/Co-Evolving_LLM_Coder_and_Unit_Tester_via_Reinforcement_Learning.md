...
研究人员提出了一种名为CURE的新型强化学习框架，通过协同进化代码生成和单元测试能力，无需真实代码作为监督。该框架基于交互结果设计专用奖励机制，使单元测试器能直接从编码错误中学习。优化后的ReasonFlux-Coder-7B和14B模型在Qwen2.5-Instruct上实现了5.3%的代码生成准确率提升和9.0%的Best-of-N准确率提升，性能超越同类模型。4B版本在长链推理任务中表现优于Qwen3-4B，单元测试生成效率达64.8%。该模型还可作为基础模型的强化学习奖励模型。项目已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T05:01:28Z
- **目录日期**: 2025-06-04
