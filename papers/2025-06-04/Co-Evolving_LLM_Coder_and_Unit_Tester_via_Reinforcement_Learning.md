...
研究人员提出了一种名为CURE的新型强化学习框架，通过协同进化代码生成和单元测试能力，无需真实代码作为监督。该方法基于交互结果设计专用奖励机制，使单元测试器能直接从编码错误中学习。优化后的ReasonFlux-Coder-7B和14B模型在Qwen2.5-Instruct上实现了5.3%的代码生成准确率提升和9.0%的Best-of-N准确率提升，优于同类模型。该框架还支持测试时扩展和自主编码等下游任务，性能提升8.1%。其中ReasonFlux-Coder-4B在长链推理任务中表现优于Qwen3-4B，同时保持64.8%的单元测试生成效率。项目已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-04T19:01:09Z
- **目录日期**: 2025-06-04
