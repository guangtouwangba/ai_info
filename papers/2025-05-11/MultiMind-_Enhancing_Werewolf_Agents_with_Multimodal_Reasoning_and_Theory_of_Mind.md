...
该研究提出了MultiMind框架，首次将多模态信息整合到社交推理游戏（如"一夜终极狼人杀"）的AI代理中。该框架通过分析面部表情、语音语调等非语言线索，结合心理理论模型追踪玩家间的相互怀疑程度，并利用蒙特卡洛树搜索优化沟通策略。实验表明，MultiMind在AI对战和人类对战中均表现出色，推动了具备多模态社交推理能力的大语言模型发展。研究突破了传统纯文本分析的局限，使AI更接近人类的多模态社交互动方式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T09:02:25Z
- **目录日期**: 2025-05-11
