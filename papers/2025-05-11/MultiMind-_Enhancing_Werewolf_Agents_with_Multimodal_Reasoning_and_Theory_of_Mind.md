...
该研究提出了MultiMind框架，首次将多模态信息整合到社交推理游戏（如《一夜终极狼人杀》）的LLM智能体中。该框架通过分析面部表情、语音语调及文本内容，结合心理理论（ToM）模型追踪玩家间的相互怀疑度，并利用蒙特卡洛树搜索（MCTS）优化沟通策略以降低自身嫌疑。实验表明，MultiMind在人机对抗和人类玩家测试中均表现优异，推动了LLM智能体在多模态社交推理领域向类人化方向的重要进展。研究突破了现有纯文本方法的局限，更贴近人类自然社交中的多模态交互特性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T10:02:16Z
- **目录日期**: 2025-05-11
