...
该研究提出MultiMind框架，首次将多模态信息整合到社交推理游戏（如"一夜终极狼人杀"）的LLM智能体中。该框架通过分析面部表情、语音语调等非语言线索，并结合心智理论(ToM)模型追踪玩家间的相互怀疑程度，再使用蒙特卡洛树搜索(MCTS)优化沟通策略。实验表明，MultiMind在智能体间对抗和人类玩家测试中均表现出色，实现了跨模态的人类级社交推理能力，突破了现有纯文本智能体的局限。这项研究为开发具备多模态社交推理能力的LLM智能体提供了重要进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T18:02:07Z
- **目录日期**: 2025-05-11
