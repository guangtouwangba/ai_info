...
该研究提出了首个整合多模态信息的社交推理游戏代理MultiMind，用于解决现有基于文本的AI代理在"一夜终极狼人杀"游戏中无法利用面部表情和语音语调等关键社交线索的局限。该框架通过心理理论模型追踪玩家间的相互怀疑程度，并结合蒙特卡洛树搜索来制定最小化自身嫌疑的沟通策略。实验表明，MultiMind在AI对战和人类玩家测试中均表现出色，标志着大语言模型在多模态社交推理能力上的重要突破，使AI更接近人类的多模态社交推理水平。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T06:02:17Z
- **目录日期**: 2025-05-11
