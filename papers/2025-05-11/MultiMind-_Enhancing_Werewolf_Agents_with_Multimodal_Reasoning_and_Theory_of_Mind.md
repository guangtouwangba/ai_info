...
本研究提出了首个整合多模态信息的社交推理游戏AI框架MultiMind，用于"一夜终极狼人杀"游戏。该框架突破现有纯文本方法的局限，通过分析面部表情、语音语调等多模态信息，结合心理理论(ToM)模型追踪玩家间的相互怀疑程度，并利用蒙特卡洛树搜索(MCTS)优化沟通策略以降低自身嫌疑。实验表明，MultiMind在AI对抗和人类对战中均表现优异，推动了LLM智能体在多模态社交推理方面向类人水平发展。这一创新为理解复杂社交互动中的多维度信息处理提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T03:21:08Z
- **目录日期**: 2025-05-11
