...
本文提出了clem todd框架，用于在统一条件下系统评估任务导向对话系统。该框架支持灵活集成不同用户模拟器和对话系统（包括现有或新开发的模型），确保使用一致的数据集、评估指标和计算限制。研究通过重新评估现有系统并整合三个新系统，展示了clem todd的灵活性。结果表明，架构、模型规模和提示策略对对话性能有显著影响，为构建高效对话AI系统提供了实用指导。该框架解决了现有研究中评估孤立、结论泛化性不足的问题，推动了对话系统开发的标准化比较。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T02:31:34Z
- **目录日期**: 2025-05-11
