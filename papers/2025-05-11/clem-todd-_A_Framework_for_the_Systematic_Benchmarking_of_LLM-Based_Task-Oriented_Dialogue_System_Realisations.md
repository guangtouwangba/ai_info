...
本文提出了clem todd框架，用于在统一条件下系统评估任务导向对话系统。该框架支持灵活组合不同用户模拟器和对话系统，提供一致的评估标准（数据集、指标和计算限制）。研究重新评估了现有系统，并整合了三个新系统，分析了架构、规模和提示策略对对话性能的影响，为构建高效对话AI系统提供了实用指导。该框架解决了现有研究中评估分散、难以横向比较的问题，提升了对话系统研究的可推广性和可比性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T20:01:36Z
- **目录日期**: 2025-05-11
