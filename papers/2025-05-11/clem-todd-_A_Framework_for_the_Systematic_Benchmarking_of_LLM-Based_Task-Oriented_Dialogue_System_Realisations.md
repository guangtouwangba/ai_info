...
本文介绍了clem todd框架，旨在通过统一标准评估任务导向对话系统。该框架支持灵活集成不同用户模拟器和对话系统，确保一致的评估条件（数据集、指标和计算资源）。研究重新评估了现有系统，并整合了三个新系统，分析了架构、规模和提示策略对性能的影响，为构建高效对话AI提供了实用指导。该框架解决了现有研究中评估孤立、结论泛化性不足的问题，推动了对话系统开发的系统化比较。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T00:01:38Z
- **目录日期**: 2025-05-11
