...
本文提出了clem todd框架，用于在统一条件下系统评估任务导向对话系统。该框架支持灵活组合不同用户模拟器和对话系统，提供标准化数据集、评估指标和计算约束。通过重新评估现有系统并集成三个新系统，研究揭示了架构、模型规模和提示策略对对话性能的影响，为构建高效对话AI提供了实用指导。该框架解决了现有研究中评估孤立、结论泛化性不足的问题，支持即插即用式集成，实现了跨系统配置的基准测试。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T05:01:41Z
- **目录日期**: 2025-05-11
