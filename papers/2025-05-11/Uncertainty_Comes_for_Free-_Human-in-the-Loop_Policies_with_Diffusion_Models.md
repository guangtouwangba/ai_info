...
该研究提出了一种基于扩散策略的人机协同机器人部署方法，通过计算不确定性指标让机器人仅在必要时主动寻求人类协助，减少持续人工监控的需求。该方法利用扩散策略的生成过程，在部署时自主决定何时请求操作员干预，且训练阶段无需人工参与。研究还表明该方法可用于高效收集数据以微调扩散策略，提升自主性能。模拟和真实环境实验证明，该方法能有效提高多种场景下的策略性能，平衡自主操作与必要人工干预，适用于大规模机器人部署。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T04:03:48Z
- **目录日期**: 2025-05-11
