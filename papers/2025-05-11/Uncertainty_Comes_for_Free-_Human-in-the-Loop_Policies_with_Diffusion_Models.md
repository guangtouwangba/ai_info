...
本文提出了一种基于扩散策略的人机协作方法，使机器人仅在必要时请求人工干预，减少持续监控的负担。该方法利用扩散策略的生成过程计算不确定性指标，自主决定何时需要人工协助，且无需训练阶段的人工交互。同时，该方法还能高效收集数据以优化扩散策略。实验表明，该方法在多种模拟和真实场景中有效提升了策略性能，平衡了自主性与人工干预的需求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T02:32:21Z
- **目录日期**: 2025-05-11
