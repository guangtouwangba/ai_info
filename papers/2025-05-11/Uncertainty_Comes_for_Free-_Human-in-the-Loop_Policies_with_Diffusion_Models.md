...
本文提出了一种基于扩散策略的人机协作方法，通过计算不确定性指标让机器人仅在必要时请求人工干预，减少持续监控的负担。该方法利用扩散策略的生成过程，在部署时自主决定何时寻求帮助，无需训练阶段的人工交互。同时，该方法还能高效收集数据以优化扩散策略，提升自主性能。仿真和真实环境实验表明，该方法在多种场景下均能有效提高策略性能，平衡自主性与人工干预的需求，适用于大规模机器人部署。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T18:02:15Z
- **目录日期**: 2025-05-11
