...
本文提出了一种改进人机协作（HitL）机器人部署的方法，通过扩散策略主动在必要时寻求人类协助，减少持续人工监控的需求。该方法利用扩散策略的生成过程计算基于不确定性的指标，使自主代理能在部署时决定何时请求操作员帮助，且无需训练阶段的人工交互。此外，该方法还可用于高效收集数据以微调扩散策略，提升自主性能。模拟和真实环境实验表明，该方法在多种场景下均能有效提升策略性能，平衡自主操作与必要人工干预，适用于大规模机器人部署。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T09:02:42Z
- **目录日期**: 2025-05-11
