...
本文提出了一种基于扩散策略的人机协作方法，通过计算不确定性指标让机器人仅在必要时主动寻求人类协助，减少对持续人工监控的依赖。该方法利用扩散策略的生成过程，在部署时自主决定是否需要操作员干预，且无需训练阶段的人工交互。此外，该方法还能高效收集数据以微调扩散策略，提升自主性能。仿真和真实环境实验表明，该方法在多种场景下都能有效提高策略的部署性能，同时降低人力成本。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T05:02:27Z
- **目录日期**: 2025-05-11
