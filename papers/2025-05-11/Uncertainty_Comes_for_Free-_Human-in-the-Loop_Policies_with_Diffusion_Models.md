...
本文提出了一种基于扩散策略的人机协作方法，旨在减少机器人部署中对人工持续监控的依赖。该方法通过扩散策略生成过程计算不确定性指标，仅在必要时请求人工协助，而无需训练阶段的人工干预。同时，该方法还能用于高效收集数据以优化扩散策略，提升自主性能。仿真和真实环境实验表明，该方法能有效提高多种场景下的策略性能，实现更高效的半自主机器人部署。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T07:02:23Z
- **目录日期**: 2025-05-11
