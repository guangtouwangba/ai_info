...
该研究探讨了活性物质在储层计算（RC）范式中的信息处理能力，通过模拟外部驱动的混沌信号预测模型，发现了一个此前被忽视的优异动力学机制。这一机制在多种物理参数和任务中表现稳健且最优，揭示了物理系统计算与推断的核心特征：其信息处理效能主要取决于系统的本征弛豫能力。最优计算状态位于临界阻尼阈值之下，呈现多阶段微观弛豫动力学，并能通过准静态与高度非线性状态的快速切换适应混沌驱动。相关性与动力学特征可标识最优性能区间，为多体非平衡系统的非传统计算提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T00:02:04Z
- **目录日期**: 2025-05-11
