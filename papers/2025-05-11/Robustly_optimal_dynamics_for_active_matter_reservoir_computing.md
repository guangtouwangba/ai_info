...
该研究探讨了活性物质在储层计算（RC）范式中的信息处理能力，通过模拟受外部驱动的模型预测混沌信号。研究发现了一个此前被忽视的优越动力学机制，该机制在不同物理参数和任务中均表现出鲁棒的最优性。系统信息处理能力主要取决于其固有弛豫特性，最佳计算状态位于临界阻尼阈值以下，呈现多阶段微观弛豫。在混沌驱动下，系统通过准静态与高度非线性状态的快速切换实现适应。相关动力学特征可标识最优性能区间。该物理可解释模型为非平衡多体系统中的非传统计算提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T04:03:29Z
- **目录日期**: 2025-05-11
