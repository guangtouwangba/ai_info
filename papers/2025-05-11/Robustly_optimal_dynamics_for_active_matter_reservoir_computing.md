...
该研究探讨了活性物质在储层计算（RC）范式中的信息处理能力，通过模拟受外部驱动的模型预测混沌信号未来状态。研究发现了一种此前被忽视的独特动力学机制，该机制在多种物理参数和推断任务中表现出稳健的最优性。最优计算状态位于临界阻尼阈值下方，涉及多阶段的微观动力学弛豫过程，并展现出准静态与高度非线性动态间的快速切换。系统的信息处理能力主要由其本征弛豫特性决定，且相干与非相干动力学共同发挥作用。该模型为理解非平衡多体物理中的学习和非常规计算提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T14:02:13Z
- **目录日期**: 2025-05-11
