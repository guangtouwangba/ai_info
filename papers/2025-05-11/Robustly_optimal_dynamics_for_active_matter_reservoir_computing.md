...
这项研究探讨了活性物质在储层计算（RC）范式中的信息处理能力，通过模拟受外部驱动的系统预测混沌信号。研究发现了一种此前被忽视的优越动力学状态，该状态在不同物理参数和任务中均表现出稳健的最优性。系统信息处理能力主要由其内在弛豫能力决定，最优计算状态位于临界阻尼阈值以下，呈现多阶段微观弛豫。在混沌驱动下，系统通过准静态与高度非线性状态的快速切换实现适应，相干与非相干动力学共同作用。相关动力学特征可标识最优性能状态，为理解非平衡多体物理计算提供了新视角。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T22:01:53Z
- **目录日期**: 2025-05-11
