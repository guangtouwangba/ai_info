...
该研究探讨了活性物质在储层计算（RC）范式中的信息处理能力，通过模拟受外部驱动的模型预测混沌信号未来状态。研究发现了一个此前被忽视的优异动力学机制，该机制在不同物理参数和推断任务中均表现出稳健的最优性，揭示了物理系统计算与推断的普适性原理。最优计算状态位于临界阻尼阈值之下，表现为多阶段微观动力学弛豫，其适应性源于准静态与高度非线性动态间的快速切换。相关性与动力学响应揭示了系统与驱动间的紧密关联，为平衡态外多体物理的非传统计算提供了新视角。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T23:01:53Z
- **目录日期**: 2025-05-11
