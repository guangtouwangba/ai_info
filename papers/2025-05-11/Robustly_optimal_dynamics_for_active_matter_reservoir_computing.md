...
该研究探讨了活性物质在储备池计算（RC）范式中的信息处理能力，通过模拟受外部驱动的模型预测混沌信号未来状态。研究发现了一个此前被忽视的优越动力学机制，该机制在不同物理参数和推断任务中均表现出鲁棒的最优性。最优计算状态位于临界阻尼阈值之下，涉及多阶段的微观动力学弛豫过程，其适应性源于准稳态与高度非线性状态间的快速切换。相关性与非相干动力学共同作用，且粒子动态相关性可标识最优性能区间。该模型为理解非平衡多体物理中的信息处理提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T05:02:09Z
- **目录日期**: 2025-05-11
