...
该研究探索了活性物质在储层计算（RC）范式中的信息处理能力，通过模拟外部驱动的混沌信号预测模型，发现了一个此前被忽视的优越动力学机制。这一机制在多种物理参数和推断任务中均表现出稳健的最优性，揭示了物理系统计算与推断的内在规律。研究发现，信息处理效能主要取决于系统的本征弛豫能力，其最优计算状态位于临界阻尼阈值之下，表现为多阶段的微观动力学弛豫。该系统通过准静态与高度非线性状态的快速切换适应混沌驱动，其运作同时依赖相干与非相干动力学，为平衡态多体物理的非传统计算提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T12:02:07Z
- **目录日期**: 2025-05-11
