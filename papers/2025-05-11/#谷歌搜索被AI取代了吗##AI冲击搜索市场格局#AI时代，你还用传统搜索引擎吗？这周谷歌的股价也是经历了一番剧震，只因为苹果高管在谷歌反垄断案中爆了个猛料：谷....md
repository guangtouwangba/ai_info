...
AI正在冲击传统搜索市场格局。谷歌4月通过Safari的搜索量首次下降，广告点击增速降至2%的历史新低，分析师认为ChatGPT等AI工具分流了约15%的搜索量。虽然谷歌表示总体搜索量仍在增长，但市场担忧AI直接提供答案会降低用户点击广告的需求。分析师观点分化：郭明錤警告AI终将影响广告业务，而Jefferies认为谷歌能通过AI功能获利。随着AI提供更精准的答案，搜索市场正面临重塑，用户可能越来越少依赖传统搜索引擎。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T03:22:55Z
- **目录日期**: 2025-05-11
