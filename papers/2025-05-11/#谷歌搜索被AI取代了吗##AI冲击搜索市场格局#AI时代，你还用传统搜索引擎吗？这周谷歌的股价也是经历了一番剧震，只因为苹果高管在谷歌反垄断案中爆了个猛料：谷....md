...
AI正在冲击传统搜索引擎市场格局。谷歌4月通过Safari的搜索量首次下降，广告点击增速降至2%的历史新低，分析师认为ChatGPT等AI工具分流了约15%搜索量。虽然谷歌表示总搜索量仍在增长，但市场担忧其主导地位正在动摇。分析师观点分化：郭明錤警告AI将威胁谷歌广告业务，而Jefferies则认为谷歌最终能通过AI功能获利。核心争议在于：当AI能直接提供精准答案时，用户是否会减少使用传统搜索引擎。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T13:09:21Z
- **目录日期**: 2025-05-11
