...
谷歌搜索业务正面临AI工具的冲击。苹果高管在反垄断案中透露，4月Safari的谷歌搜索量首次下降，用户转向ChatGPT等AI工具。谷歌回应称总体搜索量仍在增长，但广告点击增速降至2%的历史新低，引发市场担忧。分析师观点分化：部分认为AI将长期威胁谷歌广告业务，另一些则相信谷歌能通过AI功能盈利。数据显示，AI工具已占搜索市场15%的份额，重塑行业格局。核心矛盾在于：当AI能直接提供精准答案，用户是否还需要传统搜索引擎？

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T08:04:16Z
- **目录日期**: 2025-05-11
