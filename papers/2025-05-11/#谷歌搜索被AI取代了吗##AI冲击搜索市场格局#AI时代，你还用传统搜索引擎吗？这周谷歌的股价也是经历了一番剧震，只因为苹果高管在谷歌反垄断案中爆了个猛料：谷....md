...
谷歌搜索业务正面临AI工具的冲击。苹果高管在反垄断案中透露，4月Safari的谷歌搜索量首次下降，用户转向ChatGPT等AI工具。谷歌回应称总体搜索量仍在增长，但广告点击增速已降至2%的历史新低。分析师对威胁程度意见不一：郭明錤认为AI终将影响广告业务，而Jefferies相信谷歌能通过AI功能获利。数据显示，AI工具已占搜索市场的15%，直接提供答案的模式可能改变用户习惯。搜索市场格局正在AI冲击下重塑。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T05:04:09Z
- **目录日期**: 2025-05-11
