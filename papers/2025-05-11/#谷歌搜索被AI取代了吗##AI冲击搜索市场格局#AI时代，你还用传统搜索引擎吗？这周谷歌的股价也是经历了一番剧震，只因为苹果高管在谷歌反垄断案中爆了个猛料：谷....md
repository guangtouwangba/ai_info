...
AI正在冲击传统搜索引擎市场。谷歌4月Safari搜索量首次下降，广告点击增速创历史新低（仅2%），分析师认为ChatGPT等AI工具已占搜索市场15%份额。虽然谷歌声称总搜索量仍在增长，但苹果高管证词显示用户正转向AI。观点分歧：郭明錤认为AI终将威胁谷歌广告业务，而Jefferies分析师相信谷歌能通过AI功能盈利。核心矛盾在于：当AI能直接提供精准答案时，用户对传统搜索的依赖度正在降低。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T02:33:48Z
- **目录日期**: 2025-05-11
