...
AI正在冲击传统搜索市场格局。谷歌4月通过Safari的搜索量首次下降，广告点击增速降至2%的历史新低，分析师认为ChatGPT等AI工具已占15%搜索量。虽然谷歌表示总体搜索量仍在增长，但市场担忧AI直接提供答案会减少广告点击。分析师观点分歧：郭明錤警告AI将威胁谷歌广告，Jefferies则认为谷歌能通过AI功能获利。随着AI重新定义搜索方式，传统搜索引擎面临重大挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T12:04:15Z
- **目录日期**: 2025-05-11
