...
AI正在冲击传统搜索引擎市场。谷歌4月通过Safari的搜索量首次下降，广告点击增速降至2%的历史新低，分析师认为这与ChatGPT等AI工具兴起有关。虽然谷歌称总体搜索量仍在增长，但数据显示AI搜索已占传统搜索量的15%。专家对影响程度意见不一：郭明錤认为AI终将威胁谷歌广告业务，而Jefferies分析师则认为谷歌能通过AI功能获利。随着AI直接提供精准答案，用户可能减少使用传统搜索，市场格局正在重塑。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T01:31:27Z
- **目录日期**: 2025-05-11
