...
AI工具如ChatGPT对谷歌搜索业务构成挑战。数据显示，4月Safari的谷歌搜索量首次下降，广告点击增速创历史新低（仅2%）。分析师认为，AI提供更精准答案可能减少广告点击，而ChatGPT等工具已占搜索市场15%份额。尽管谷歌称整体搜索量仍在增长，但市场格局正被AI重塑。部分专家警告谷歌广告业务将受冲击，另一些则认为谷歌最终能通过AI功能盈利。核心矛盾在于：当AI能直接解答问题，用户可能减少使用传统搜索引擎。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T06:04:09Z
- **目录日期**: 2025-05-11
