...
谷歌搜索业务正面临AI工具的冲击。苹果高管在反垄断案中透露，4月Safari的谷歌搜索量首次下降，用户转向ChatGPT等AI工具。谷歌回应称总体搜索量仍在增长，但广告点击增速已降至2%的历史低点。分析师对威胁程度看法不一：郭明錤认为AI终将影响谷歌广告，而Jefferies相信谷歌能通过AI功能获利。目前AI搜索量约占传统引擎的15%，市场格局正在重塑。核心问题在于：当AI能直接提供精准答案，用户是否会减少使用传统搜索引擎？

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T10:04:04Z
- **目录日期**: 2025-05-11
