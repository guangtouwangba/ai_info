...
清华大学、复旦大学和香港科技大学联合发布RM-Bench评测基准，首次为奖励模型建立系统评估标准，解决其"重形式轻内容"的偏科问题。该基准通过3x3矩阵测试不同风格组合下的判断准确度，覆盖聊天、代码、数学等多领域，使用GPT-4o生成对抗性数据。RM-Bench不仅能评估奖励模型本身，还能预测其对大语言模型性能的提升效果。相关成果已被ICLR 2025接收为Oral论文，代码和评测榜单已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T14:03:17Z
- **目录日期**: 2025-05-11
