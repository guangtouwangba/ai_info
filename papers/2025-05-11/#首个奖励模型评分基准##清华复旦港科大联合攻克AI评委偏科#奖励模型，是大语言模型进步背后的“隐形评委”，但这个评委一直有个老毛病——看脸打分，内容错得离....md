...
清华大学、复旦大学和香港科技大学联合发布了首个奖励模型评测基准RM-Bench，解决了AI奖励模型"偏科"问题。该基准通过3x3矩阵评估模型在不同风格组合下的准确度，覆盖聊天、代码、数学和安全等领域，使用GPT-4o等强模型生成对抗性测试数据。RM-Bench不仅能评估奖励模型本身，还能预测其对大语言模型性能的影响。这一成果已被ICLR 2025接收为Oral论文，相关代码和评测榜单已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T11:02:58Z
- **目录日期**: 2025-05-11
