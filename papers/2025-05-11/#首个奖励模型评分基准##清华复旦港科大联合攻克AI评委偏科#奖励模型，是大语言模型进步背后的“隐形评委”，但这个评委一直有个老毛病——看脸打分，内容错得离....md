...
清华大学、复旦大学和香港科技大学联合发布了首个奖励模型评分基准RM-Bench，解决了AI奖励模型"重形式轻内容"的偏科问题。该基准通过3x3矩阵评估模型在不同难度和风格组合下的判断准确性，覆盖聊天、代码等多元场景，并采用GPT-4o生成对抗性测试数据。RM-Bench不仅能评估奖励模型性能，还能预测其对大语言模型优化的实际效果。这项被ICLR 2025接收为口头报告的研究已开源代码并建立评测榜单，标志着AI评估体系向"内容为王"迈出关键一步。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T01:30:32Z
- **目录日期**: 2025-05-11
