...
清华、复旦和港科大联合发布了首个奖励模型评测基准RM-Bench，解决了AI评委"偏科"问题。该基准通过设计内容细微差异+多风格对照测试，避免模型被排版技巧误导；采用3x3矩阵评估不同难度下的判断准确度；覆盖聊天、代码等多元场景，并用GPT-4o+人工验证数据。RM-Bench不仅能评估奖励模型质量，还能预测其对大语言模型性能的提升效果。该研究已被ICLR 2025接收为口头报告，相关代码和榜单已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T07:03:04Z
- **目录日期**: 2025-05-11
