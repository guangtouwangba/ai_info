...
清华大学、复旦大学和香港科技大学联合开发了首个奖励模型评分基准RM-Bench，解决了AI评委"偏科"问题。该基准通过3x3矩阵系统评估模型在不同难度和风格组合下的判断准确性，覆盖聊天、代码、数学和安全领域，并采用GPT-4o生成对抗性测试数据。RM-Bench不仅能更客观地评估奖励模型，还能预测其对大语言模型性能的提升效果。这项研究已被ICLR 2025接收为Oral论文，相关代码和评测榜单已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T16:03:38Z
- **目录日期**: 2025-05-11
