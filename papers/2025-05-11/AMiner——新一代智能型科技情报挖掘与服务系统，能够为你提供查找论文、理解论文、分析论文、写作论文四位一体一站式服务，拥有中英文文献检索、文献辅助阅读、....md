...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、AI辅助阅读、自动摘要生成、论文翻译及科研动态订阅。平台覆盖42个学科，拥有3.5亿论文和1.5亿专利数据，支持用户通过关键词、学者或机构追踪最新研究，并通过微信或邮件推送定制化情报。其AI功能可解析上传的PDF文献，生成摘要、章节概要和问答交互，显著提升文献阅读与论文写作效率。基础功能免费开放，适用于学者、学生等科研人群。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T15:05:30Z
- **目录日期**: 2025-05-11
