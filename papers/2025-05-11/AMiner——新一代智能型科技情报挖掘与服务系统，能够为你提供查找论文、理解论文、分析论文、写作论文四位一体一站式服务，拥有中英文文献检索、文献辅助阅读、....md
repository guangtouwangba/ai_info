...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、翻译、辅助阅读和科研情报订阅。平台收录3.5亿论文、0.6亿学者和1.5亿专利，支持互动问答、自动摘要生成和文档分析。用户可定制订阅最新科研动态，并通过微信或邮件接收。此外，AMiner还提供学者画像、学术会议和论文排行榜等功能，部分服务可免费使用。访问链接：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T05:05:42Z
- **目录日期**: 2025-05-11
