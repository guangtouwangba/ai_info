...
AMiner是一个智能科技情报挖掘平台，提供文献检索、翻译、科研订阅等一站式服务。它收录了3.5亿论文、0.6亿学者等海量数据，支持中英文文献检索、AI辅助阅读和自动摘要生成。用户可通过互动问答快速理解文献内容，还能订阅个性化科研动态。平台还具备学者画像、学术会议追踪等功能，大部分服务可免费使用。AMiner通过AI技术显著提升文献查阅和论文写作效率，是科研工作者的高效工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T13:10:54Z
- **目录日期**: 2025-05-11
