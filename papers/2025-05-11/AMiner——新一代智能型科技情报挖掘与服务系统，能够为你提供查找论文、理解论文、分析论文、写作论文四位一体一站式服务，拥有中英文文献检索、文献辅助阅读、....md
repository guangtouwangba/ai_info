...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译及科研订阅等一站式服务。它支持中英文文献搜索，能自动生成摘要和问答互动，帮助用户快速理解论文内容。平台还具备文档识别、章节概要和个性化科研动态推送功能，覆盖3.5亿论文和0.6亿学者数据。用户可通过网页或微信小程序免费使用其核心功能，包括学者画像、学术会议追踪等，显著提升科研效率。访问入口：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T17:05:22Z
- **目录日期**: 2025-05-11
