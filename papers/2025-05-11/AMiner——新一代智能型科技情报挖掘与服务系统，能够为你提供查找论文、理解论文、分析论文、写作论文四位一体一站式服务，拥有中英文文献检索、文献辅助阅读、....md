...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析和写作一站式服务。它支持中英文文献搜索，能快速定位相关论文，并生成摘要和问答互动，提升研究效率。平台还具备文献翻译、辅助阅读及文档识别功能，用户可上传PDF或从库中选取论文，获取AI生成的摘要和章节概要。此外，AMiner提供科研情报订阅服务，根据用户偏好推送最新学术动态。其他功能包括学者画像、学术会议和论文排行榜等。该平台免费使用，网址为https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T23:05:02Z
- **目录日期**: 2025-05-11
