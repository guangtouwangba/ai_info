...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、辅助阅读、翻译和科研情报订阅。它拥有庞大的数据库，涵盖3.5亿论文、0.6亿学者等资源。用户可通过互动问答快速获取文献摘要，支持PDF上传和AI生成概要，还能定制订阅最新科研动态。平台还提供学者画像、学术会议等功能，浏览器版本可免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T01:32:59Z
- **目录日期**: 2025-05-11
