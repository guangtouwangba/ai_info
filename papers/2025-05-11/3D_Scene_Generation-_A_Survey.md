...
3D场景生成技术旨在创建具有空间结构、语义信息和真实感的环境，应用于沉浸式媒体、机器人、自动驾驶等领域。早期基于规则的方法可扩展但多样性有限，而深度生成模型（如GAN、扩散模型）和3D表示（如NeRF、3D高斯）提升了真实感、多样性和视角一致性。本文系统梳理了四大范式：程序化生成、神经3D生成、图像生成和视频生成，分析其技术基础、优缺点及典型成果，并总结了数据集、评估方法和应用。未来方向包括更高保真度、物理感知交互生成和感知-生成统一模型。项目页面持续更新进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T11:00:50Z
- **目录日期**: 2025-05-11
