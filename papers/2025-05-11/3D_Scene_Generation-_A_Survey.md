...
3D场景生成技术旨在创建空间结构化、语义丰富且逼真的虚拟环境，应用于沉浸式媒体、机器人、自动驾驶等领域。早期方法依赖程序化规则，扩展性强但多样性不足。近年来，基于深度生成模型（如GAN、扩散模型）和3D表示（如NeRF、3D高斯）的技术显著提升了场景的真实感、多样性和视角一致性。本文系统梳理了四大生成范式：程序化生成、神经3D生成、图像生成和视频生成，分析其技术基础、优缺点及典型成果，并探讨数据集、评估方法和应用。未来方向包括更高保真度、物理感知交互生成及感知-生成统一模型。项目动态详见GitHub页面。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T03:19:41Z
- **目录日期**: 2025-05-11
