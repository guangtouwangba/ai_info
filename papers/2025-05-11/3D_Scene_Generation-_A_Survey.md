...
3D场景生成旨在创建空间结构化、语义丰富且逼真的环境，应用于沉浸式媒体、机器人、自动驾驶和具身AI等领域。早期基于规则的方法可扩展但多样性有限。近年来，基于深度生成模型（如GAN、扩散模型）和3D表示（如NeRF、3D高斯）的技术显著提升了生成的真实性、多样性和视角一致性。该综述系统梳理了四大方法：程序化生成、神经3D生成、图像生成和视频生成，分析其技术基础、优缺点及典型结果，并探讨了数据集、评估方法和应用。未来方向包括更高保真度、物理感知生成及统一感知-生成模型。项目地址见GitHub。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T19:00:50Z
- **目录日期**: 2025-05-11
