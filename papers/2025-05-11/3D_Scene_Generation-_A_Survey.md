...
3D场景生成技术旨在创建结构化、语义丰富且逼真的虚拟环境，应用于沉浸式媒体、机器人、自动驾驶等领域。早期基于规则的方法可扩展但多样性不足，而当前深度生成模型（如GAN、扩散模型）和3D表示（如NeRF、3D高斯）显著提升了真实感、多样性和视角一致性。该综述系统梳理了四大技术范式：程序化生成、神经3D生成、图像/视频驱动生成，分析其技术基础、优缺点及典型成果，并总结了数据集、评估方法和应用场景。未来方向包括更高真实感、物理交互生成及感知-生成统一模型。相关资源持续更新于GitHub项目页。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T15:00:59Z
- **目录日期**: 2025-05-11
