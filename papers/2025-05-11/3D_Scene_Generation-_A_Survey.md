...
3D场景生成技术旨在创建具有空间结构、语义信息和照片级真实感的环境，应用于沉浸式媒体、机器人、自动驾驶和具身AI等领域。早期基于程序规则的方法可扩展但多样性不足。近年来，基于深度生成模型（如GAN、扩散模型）和3D表示（如NeRF、3D高斯）的技术显著提升了真实感、多样性和视角一致性。该综述系统梳理了四大生成范式：程序化生成、神经3D生成、图像生成和视频生成，分析了技术基础、优缺点及评估方法，并探讨了未来方向如更高真实感、物理感知生成和统一感知-生成模型。相关资源见GitHub项目页。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T12:00:53Z
- **目录日期**: 2025-05-11
