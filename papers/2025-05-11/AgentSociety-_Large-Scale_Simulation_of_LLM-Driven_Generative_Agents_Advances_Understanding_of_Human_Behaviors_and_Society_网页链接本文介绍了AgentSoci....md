...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个智能体及其500万次社会互动。该系统被用于研究四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。研究显示，模拟结果与现实世界数据高度吻合，验证了该系统在揭示人类行为机制方面的有效性。该平台可作为计算社会科学的研究工具，为学者和政策制定者提供新的实验手段，补充传统研究方法如问卷调查和实地干预。这一突破展示了AI模拟在社会科学研究中的巨大潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T13:10:25Z
- **目录日期**: 2025-05-11
