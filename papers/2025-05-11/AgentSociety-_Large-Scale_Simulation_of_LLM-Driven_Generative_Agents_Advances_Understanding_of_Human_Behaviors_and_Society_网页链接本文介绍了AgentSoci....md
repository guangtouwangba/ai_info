...
该研究开发了AgentSociety大规模社会模拟器，通过大型语言模型驱动1万多个代理，模拟500万次社会互动。该系统研究了四大社会问题：社会极化、信息传播、基本收入政策效果和自然灾害影响。模拟结果与现实数据高度吻合，验证了该系统捕捉人类行为机制的能力。研究表明，这种AI驱动的社会模拟器可作为社会科学研究和政策制定的有效工具，为理解复杂社会现象提供新方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T14:05:19Z
- **目录日期**: 2025-05-11
