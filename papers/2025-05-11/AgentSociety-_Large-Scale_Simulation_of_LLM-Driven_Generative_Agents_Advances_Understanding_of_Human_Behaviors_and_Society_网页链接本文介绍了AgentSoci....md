...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理在真实社会环境中的500万次互动。研究者利用该平台研究了四个关键社会问题：群体极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，证明该系统能有效捕捉人类行为机制。AgentSociety可作为计算社会科学的研究工具，为学者和政策制定者提供传统方法（如调查、实验）之外的补充研究手段，帮助理解复杂社会现象的内在规律。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T02:35:02Z
- **目录日期**: 2025-05-11
