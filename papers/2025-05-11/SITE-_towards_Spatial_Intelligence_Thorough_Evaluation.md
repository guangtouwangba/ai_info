...
研究人员开发了名为SITE的标准化空间智能(SI)评估基准数据集，采用多选视觉问答形式，用于全面评估大视觉语言模型的空间智能能力。该数据集涵盖多种视觉模态(单图/多图/视频)和SI维度(图形到环境尺度、空间可视化与定向、静态与动态等)，结合了31个现有数据集的调研和认知科学分类体系，并创新性地设计了视角转换和动态场景两类新任务。实验表明，主流模型在空间定向等基础SI能力上显著落后人类专家，且模型的空间推理能力与其在具身AI任务中的表现呈正相关。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T02:31:05Z
- **目录日期**: 2025-05-11
