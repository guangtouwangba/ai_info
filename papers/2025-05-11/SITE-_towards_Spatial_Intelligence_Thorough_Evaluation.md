...
这篇论文介绍了SITE基准数据集，旨在全面评估大型视觉语言模型的空间智能(SI)。该数据集采用多选视觉问答形式，覆盖多种视觉模态（单图/多图/视频）和SI维度（图形到环境尺度、空间可视化与定向、静态与动态等）。研究结合自下而上的31个现有数据集调研和自上而下的认知科学分类方法，创新设计了视角转换和动态场景两类新任务。实验表明，主流模型在空间定向等基础SI维度上显著落后人类专家，且发现模型的空间推理能力与其在具身AI任务中的表现呈正相关。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T20:01:06Z
- **目录日期**: 2025-05-11
