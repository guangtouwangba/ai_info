...
SITE是一个用于全面评估空间智能（SI）的基准数据集，采用多选视觉问答的标准化形式，涵盖多种视觉模态（单图、多图、视频）和SI维度（图形到环境尺度、空间可视化与定向、静态与动态等）。该数据集通过整合31个现有数据集和认知科学分类系统，设计了新颖的视角转换和动态场景任务。实验表明，主流模型在空间定向等基础SI能力上显著落后于人类专家，且空间推理能力与具身AI任务表现呈正相关。SITE为评估视觉-语言模型的SI能力提供了系统化工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T12:01:02Z
- **目录日期**: 2025-05-11
