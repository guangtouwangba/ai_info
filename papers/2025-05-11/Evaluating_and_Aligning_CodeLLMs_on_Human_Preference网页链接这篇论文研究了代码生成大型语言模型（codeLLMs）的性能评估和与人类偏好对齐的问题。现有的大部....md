...
这篇论文针对代码生成大模型(codeLLMs)的评估问题，指出当前基准测试过于关注代码正确性而忽视人类偏好。研究者提出了CodeArena基准(包含397个高质量样本，覆盖40类任务和44种语言)和SynCode-Instruct合成指令集(近200亿标记)，通过实验发现执行基准与人类偏好存在差异，并揭示开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)的性能差距，强调了代码LLM与人类偏好对齐的重要性。研究为提升代码生成模型的实用价值提供了新评估框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T07:05:42Z
- **目录日期**: 2025-05-11
