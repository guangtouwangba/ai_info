...
这篇论文针对代码生成大模型(codeLLMs)的评估与人类偏好对齐问题，提出新基准CodeArena(含397个高质量样本，覆盖40类44种语言)和合成指令数据集SynCode-Instruct(20B标记)。研究发现：1)传统执行基准与人类偏好存在差距；2)开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著。通过构建更贴近实际编程场景的评估体系，论文揭示了代码生成质量与人类偏好对齐的重要性，为改进代码LLMs提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T22:05:11Z
- **目录日期**: 2025-05-11
