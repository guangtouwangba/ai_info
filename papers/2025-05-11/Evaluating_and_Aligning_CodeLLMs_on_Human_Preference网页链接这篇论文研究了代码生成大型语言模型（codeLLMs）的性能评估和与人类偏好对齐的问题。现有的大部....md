...
这篇论文针对代码生成大型语言模型(codeLLMs)提出新评估方法，重点关注与人类偏好的对齐问题。研究者开发了CodeArena基准测试，包含397个高质量样本，覆盖40个类别和44种编程语言，模拟真实编程任务。同时构建了20B标记的合成指令数据集SynCode-Instruct验证微调效果。实验发现现有执行基准与人类偏好存在差距，开源模型(如Qwen2.5-Coder)与专有模型(如OpenAI o1)性能差异显著。研究强调了代码LLMs与人类偏好对齐的重要性，为改进模型提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T09:06:04Z
- **目录日期**: 2025-05-11
