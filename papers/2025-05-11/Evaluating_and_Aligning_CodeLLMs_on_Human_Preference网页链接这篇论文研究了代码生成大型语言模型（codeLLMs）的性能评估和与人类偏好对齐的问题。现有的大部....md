...
这篇论文针对代码生成大模型(codeLLMs)提出新评估框架CodeArena，关注模型输出与人类偏好的对齐问题。研究者构建了包含397个高质量样本的基准测试，覆盖40类任务和44种编程语言，并开发了20B标记的合成指令数据集SynCode-Instruct。实验发现传统基于执行的评估与人类偏好存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究强调了在代码生成任务中考虑人类偏好的重要性，为改进代码LLMs提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T15:05:41Z
- **目录日期**: 2025-05-11
