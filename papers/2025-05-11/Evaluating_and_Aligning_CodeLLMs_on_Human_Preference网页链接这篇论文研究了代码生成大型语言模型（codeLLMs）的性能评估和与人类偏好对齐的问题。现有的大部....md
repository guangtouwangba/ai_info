...
这篇论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，关注模型输出与人类偏好的对齐问题。研究构建了包含397个样本(覆盖40类任务和44种语言)的人工标注数据集，并开发了20B标记的合成指令集SynCode-Instruct。实验发现：1)传统执行基准与人类偏好存在差异；2)开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究强调了大模型在代码生成任务中符合人类偏好的重要性，为评估体系提供了新维度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T19:05:12Z
- **目录日期**: 2025-05-11
