...
Noam Shazeer是Transformer论文核心作者、谷歌Gemini技术主管，被誉为大模型领域的"时间旅行者"。这位数学天才从IMO满分到谷歌第200号员工，全程参与AI关键突破：Transformer架构、MoE技术演进（Sparsely-Gated/GShard/Switch）、Adafactor优化器等重要创新。他创立的Character.AI被谷歌27亿美元收购，其"语言模型将主导全球算力"的预言正在应验。技术社区评价他如同"常驻NPC"，始终站在AI发展的最前沿，网友感叹"我们其实生活在Noam Shazeer时代"。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T00:03:11Z
- **目录日期**: 2025-05-11
