...
Noam Shazeer是Transformer架构的核心贡献者之一，现为谷歌Gemini技术主管，被誉为大模型领域的"时间旅行者"。作为Transformer论文第八作者，他在MoE架构、Adafactor优化器等关键技术中均有开创性贡献。从IMO数学竞赛满分到谷歌第200号员工，再到创立Character.AI后被谷歌以27亿美元收购，他始终处于AI技术前沿。其2017年关于"语言模型将主导全球算力"的预言正在应验，被业界称为"生活在Noam Shazeer时代"的技术先知。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T12:03:31Z
- **目录日期**: 2025-05-11
