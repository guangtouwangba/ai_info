...
Noam Shazeer是Transformer架构核心贡献者、谷歌Gemini技术主管，被誉为大模型领域的"时间旅行者"。作为Transformer论文第八作者，他在MoE架构、Adafactor优化器等关键技术突破中持续领先。从IMO满分到谷歌第200号员工，再到创立Character.AI后被谷歌27亿美元收购，他始终处于AI发展前沿。其2017年"语言模型将主导全球算力"的预言已成现实，被网友称为"我们生活在Noam Shazeer时代"。其超前技术预判源于深厚数学功底（Putnam竞赛Top10）和工程实践（参与谷歌广告/搜索/AI系统开发）。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T13:08:42Z
- **目录日期**: 2025-05-11
