...
Noam Shazeer（昵称"沙哥"）是Transformer八位核心作者中公认贡献最大的研究者，被誉为"总站在大模型技术C位的传奇人物"。作为AI领域的关键奠基者，他在注意力机制、MoE架构、Adafactor算法等多项突破性技术中发挥核心作用。近期Meta研究员发现，他三年前的研究已预见了当前前沿的3-token因果卷积技术，引发"他可能是时间旅行者"的调侃。从《Attention Is All You Need》（引用量17万+）到Character.AI创业，其开创性工作持续引领大模型发展，被业界称为"生活在Noam Shazeer时代"。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T11:03:35Z
- **目录日期**: 2025-05-11
