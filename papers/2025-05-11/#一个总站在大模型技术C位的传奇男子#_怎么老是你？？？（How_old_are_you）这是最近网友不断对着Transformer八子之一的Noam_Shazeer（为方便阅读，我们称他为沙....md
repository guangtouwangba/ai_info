...
Noam Shazeer是Transformer八位核心作者中公认贡献最大的一位，被称为"总站在大模型技术C位的传奇男子"。作为AI领域的关键人物，他在《Attention is all you need》、MoE架构、Adafactor算法、多查询注意力机制等多项重大突破中都有奠基性贡献。近期Meta研究员发现他3年前的研究就已预见了当前3-token因果卷积的进展，引发"他可能是时间旅行者"的调侃。从谷歌到创业Character.AI再回归，Shazeer的技术创新持续引领着主流模型架构的发展，被业界称为"生活在Noam Shazeer时代"。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T06:03:46Z
- **目录日期**: 2025-05-11
