...
Noam Shazeer是Transformer八位核心作者中公认贡献最大的一位，被誉为"总站在大模型技术C位的传奇男子"。作为AI领域的奠基性人物，他在《Attention is all you need》、MoE架构、Adafactor算法、多查询注意力机制等多项突破性技术中发挥关键作用。近期Meta研究员发现其3年前的工作已预见当前研究趋势，引发"他是否时间旅行者"的调侃。从谷歌到创业公司Character.AI再回归，Shazeer的贡献贯穿当今主流大模型架构发展，被业界称为生活在"Noam Shazeer时代"的技术先驱。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T13:09:01Z
- **目录日期**: 2025-05-11
