...
Noam Shazeer是Transformer论文八位作者中公认贡献最大者，被称为"总站在大模型技术C位的传奇男子"。作为谷歌资深研究员，他在多项AI突破性技术中扮演关键角色，包括开创性论文《Attention is all you need》(引用量超17万次)、将MoE引入LLM、Adafactor算法、多查询注意力机制等。近期Meta研究员发现他3年前的工作已预见了当前研究的关键点，引发"他可能是时间旅行者"的调侃。尽管低调，当今主流大模型架构的发展都建立在他的奠基性工作基础上，堪称定义了"Shazeer时代"。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T14:03:57Z
- **目录日期**: 2025-05-11
