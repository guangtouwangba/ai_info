...
Noam Shazeer是Transformer八位核心作者中公认贡献最大者，被誉为"总站在大模型技术C位的传奇人物"。作为AI领域奠基性人物，他在《Attention is All You Need》（引用量17万+）、MoE架构、Adafactor算法、多查询注意力机制等突破性研究中都有关键贡献。近期Meta研究员发现其3年前的工作已预见当前研究趋势，引发"他可能是时间旅行者"的调侃。虽低调不似明星科学家，但当今主流模型架构多建立在其开创性工作基础上，被业界称为"生活在Noam Shazeer时代"。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T08:03:56Z
- **目录日期**: 2025-05-11
