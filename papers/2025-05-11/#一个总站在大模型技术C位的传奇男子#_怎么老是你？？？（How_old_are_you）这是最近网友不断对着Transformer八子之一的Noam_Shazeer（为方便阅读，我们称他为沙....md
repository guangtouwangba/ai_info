...
Noam Shazeer是Transformer论文八位作者中公认贡献最大的一位，被称为"沙哥"。作为AI领域的传奇人物，他在大模型关键技术（如注意力机制、MoE架构、Adafactor算法等）中屡屡超前布局，被网友调侃"总是他"。近期Meta研究员朱泽园发现其3年前的工作已预见了当前研究，更引发"时间旅行者"的玩笑。从《Attention Is All You Need》（引用17万+）到创业Character.AI再回归谷歌，Shazeer的奠基性成果深刻塑造了当今LLM技术演进，堪称"站在大模型技术C位"的关键人物。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T04:05:11Z
- **目录日期**: 2025-05-11
