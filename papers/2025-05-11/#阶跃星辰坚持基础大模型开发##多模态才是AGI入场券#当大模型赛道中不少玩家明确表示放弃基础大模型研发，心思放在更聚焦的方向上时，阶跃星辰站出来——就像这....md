...
阶跃星辰坚持基础大模型研发，认为行业技术仍处于快速迭代期（如GPT-4即将"过时"），放弃基座模型会错失主流趋势。CEO姜大昕强调模型决定应用上限，应用反哺模型迭代，二者需协同发展。其C端产品"跃问"已升级为Agent平台"阶跃AI"，主打端云一体服务，最终目标仍是C端市场。公司认为多模态是AGI的关键方向，但持续投入基座模型研发才能支撑长期竞争力。（99字）  
