...
阶跃星辰坚持基础大模型研发，创始人姜大昕认为技术发展仍处于快速迭代阶段，基础模型决定应用上限。公司产品从"跃问"升级为"阶跃AI"，转型为端云一体Agent平台，主攻C端服务。姜大昕强调多模态是AGI的关键，模型与应用相辅相成，未来将在智能助手和内容领域持续探索。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T01:30:22Z
- **目录日期**: 2025-05-11
