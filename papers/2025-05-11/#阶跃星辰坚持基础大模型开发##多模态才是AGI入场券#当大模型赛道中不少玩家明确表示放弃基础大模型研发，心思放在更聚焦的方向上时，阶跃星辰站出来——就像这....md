...
阶跃星辰坚持基础大模型研发，认为行业技术仍处快速发展期（如GPT-4即将"过时"），放弃基础模型可能错失主流趋势。CEO姜大昕指出，模型决定应用上限，应用反哺模型迭代，二者相辅相成。其C端产品"跃问"已升级为Agent平台"阶跃AI"，侧重端云一体架构，最终目标仍是服务普通用户。公司认为多模态是AGI的关键方向，同时持续投入基座大模型开发以保持技术竞争力。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T21:03:29Z
- **目录日期**: 2025-05-11
