...
阶跃星辰坚持基础大模型研发，创始人姜大昕认为行业技术发展仍处于快速上升期，放弃基础模型可能错失主流趋势。公司相信模型与应用相辅相成，模型决定应用上限，应用提供场景和数据。其产品从"跃问"更名为"阶跃AI"，转型为端云一体Agent平台，主要服务C端用户。姜大昕强调多模态是AGI的关键，尽管行业部分玩家转向细分领域，阶跃仍将专注基础模型研发，同时探索多模态理解，认为智能助手和内容类应用存在巨大机会。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T10:02:57Z
- **目录日期**: 2025-05-11
