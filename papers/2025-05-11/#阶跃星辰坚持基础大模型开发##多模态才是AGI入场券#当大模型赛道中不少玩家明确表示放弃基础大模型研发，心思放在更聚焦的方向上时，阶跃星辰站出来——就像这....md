...
阶跃星辰坚持基础大模型研发，CEO姜大昕认为技术发展仍处快速迭代期，放弃基础模型可能错失主流趋势。公司相信模型决定应用上限，应用反哺模型优化，因此保持动态发展策略。其C端产品从"跃问"升级为"阶跃AI"，转向端云一体Agent平台，聚焦智能助手和内容服务。姜大昕强调多模态是AGI的关键方向，但基础模型研发仍是核心。公司产品形态虽持续调整，但始终围绕"模型-应用"协同逻辑推进。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T05:03:01Z
- **目录日期**: 2025-05-11
