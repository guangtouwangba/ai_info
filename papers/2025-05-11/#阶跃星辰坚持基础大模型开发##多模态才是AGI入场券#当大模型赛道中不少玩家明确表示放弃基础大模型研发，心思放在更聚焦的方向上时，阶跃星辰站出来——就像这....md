...
阶跃星辰坚持基础大模型研发，认为行业技术仍处快速发展期，基础模型决定应用上限。CEO姜大昕表示，尽管部分企业转向垂直领域，阶跃仍将专注基座模型，保持与应用的协同发展。其C端产品"跃问"已升级为"阶跃AI"，从ChatGPT类工具转向端云一体Agent平台，目标服务普通用户。公司认为多模态是AGI的关键方向，同时强调基座模型与场景落地的双向促进。面对技术快速迭代，阶跃选择持续投入核心模型研发以把握主流趋势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T06:03:00Z
- **目录日期**: 2025-05-11
