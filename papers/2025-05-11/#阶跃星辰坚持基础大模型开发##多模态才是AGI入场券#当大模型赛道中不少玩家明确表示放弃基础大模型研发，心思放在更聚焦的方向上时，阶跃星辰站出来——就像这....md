...
阶跃星辰坚持基础大模型研发，创始人姜大昕认为AI技术发展迅猛，放弃基础模型会错失主流趋势。他强调模型决定应用上限，应用为模型提供场景和数据，两者相辅相成。公司产品从"跃问"更名为"阶跃AI"，转型为端云一体Agent平台，主要服务C端用户。姜大昕表示，尽管与头部企业合作，但最终目标是通过助手或内容类产品服务大众。他认为多模态是AGI的关键，将继续探索多模态理解技术。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T15:03:25Z
- **目录日期**: 2025-05-11
