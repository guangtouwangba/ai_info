...
阶跃星辰坚持基础大模型研发，认为行业技术仍处于快速发展阶段，基础模型决定应用上限。CEO姜大昕表示，尽管部分企业转向垂直领域，但阶跃将持续投入基础模型，保持技术前沿性。同时，公司从ChatGPT类产品转向多模态Agent平台，主推C端服务，与头部企业合作开发智能终端助手。姜大昕强调，模型与应用相辅相成，多模态是AGI发展的关键方向。公司产品形态虽动态调整，但核心逻辑不变，未来将探索更多C端应用场景。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T14:03:09Z
- **目录日期**: 2025-05-11
