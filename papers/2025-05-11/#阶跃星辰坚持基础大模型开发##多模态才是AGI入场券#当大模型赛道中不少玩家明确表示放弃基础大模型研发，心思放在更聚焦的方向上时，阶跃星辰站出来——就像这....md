...
阶跃星辰坚持基础大模型研发，认为行业技术仍处于快速迭代期（如GPT-4即将"过时"），放弃基础模型会错失主流趋势。其CEO姜大昕指出，模型决定应用上限，应用反哺模型迭代，二者相辅相成。公司产品从"跃问"升级为"阶跃AI"，转型为端云一体Agent平台，主打C端服务，涵盖智能助手和内容场景。同时强调多模态是AGI的关键路径，将继续探索多模态理解能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T17:03:20Z
- **目录日期**: 2025-05-11
