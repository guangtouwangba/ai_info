...
阶跃星辰坚持基础大模型研发，认为行业技术仍处于快速发展阶段，基础模型决定应用上限。CEO姜大昕表示，尽管部分企业转向垂直领域，阶跃仍将专注基座大模型，同时探索多模态技术作为AGI的关键路径。其C端产品"阶跃AI"已从ChatGPT类工具升级为端云一体Agent平台，目标是通过智能终端服务普通用户。公司认为模型与应用相辅相成，未来在助手和内容领域存在巨大机会。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T22:03:04Z
- **目录日期**: 2025-05-11
