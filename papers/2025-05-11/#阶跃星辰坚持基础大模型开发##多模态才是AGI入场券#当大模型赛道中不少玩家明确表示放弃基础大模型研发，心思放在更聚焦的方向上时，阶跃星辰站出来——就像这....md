...
阶跃星辰坚持基础大模型研发，CEO姜大昕认为AI技术仍处快速发展期，基础模型决定应用上限。公司产品从"跃问"升级为"阶跃AI"，转型为端云一体Agent平台，聚焦C端服务。尽管行业部分玩家转向垂直领域，阶跃仍相信多模态是AGI的关键，坚持基础模型与应用场景协同发展。姜大昕指出，模型技术迭代迅速（如GPT-4即将"过时"），公司需紧跟主流趋势，同时通过合作拓展智能终端Agent应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T02:32:41Z
- **目录日期**: 2025-05-11
