...
阶跃星辰坚持基础大模型研发，CEO姜大昕认为技术发展仍处快速迭代期，基础模型决定应用上限，而应用场景反哺模型优化。公司产品从"跃问"升级为"阶跃AI"，转型为端云一体Agent平台，聚焦C端服务，涵盖智能助手和内容生成。姜大昕强调多模态是AGI的关键路径，尽管行业部分玩家转向垂直领域，阶跃仍将持续投入基础模型研发，保持技术前沿性。公司通过与头部企业合作布局智能终端Agent，同时探索多模态理解能力，认为AI助手和内容创作存在巨大市场机会。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T07:02:54Z
- **目录日期**: 2025-05-11
