...
阶跃星辰坚持基础大模型研发，认为行业技术仍处于快速迭代期（如GPT-4即将"过时"），需紧跟主流趋势。CEO姜大昕强调基础模型决定应用上限，而应用反哺模型迭代，二者相辅相成。其C端产品"跃问"已升级为Agent平台"阶跃AI"，通过与头部企业合作聚焦智能终端服务，但最终目标仍是C端助手与内容场景。公司认为多模态是AGI的关键发展方向，将持续探索多模态理解能力。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T09:03:16Z
- **目录日期**: 2025-05-11
