...
阶跃星辰坚持基础大模型研发，CEO姜大昕认为行业技术发展仍处快速迭代期，基础模型决定应用上限。公司产品从"跃问"升级为"阶跃AI"，转型为端云一体Agent平台，聚焦C端服务。尽管部分企业转向垂直领域，阶跃仍坚持模型与应用协同发展，通过多模态技术探索AGI路径。姜大昕指出，当前技术很快会被超越，但基础模型研发是把握行业趋势的关键。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T16:03:26Z
- **目录日期**: 2025-05-11
