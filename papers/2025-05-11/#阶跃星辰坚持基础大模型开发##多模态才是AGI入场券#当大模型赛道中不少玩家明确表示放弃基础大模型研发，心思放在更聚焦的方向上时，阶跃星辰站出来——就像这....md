...
阶跃星辰坚持基础大模型研发，CEO姜大昕认为AI技术发展迅速，放弃基础模型会错失主流趋势。公司相信模型决定应用上限，应用反哺模型迭代。其C端产品从"跃问"升级为"阶跃AI"，转型为端云一体Agent平台，聚焦智能助手和内容服务。姜大昕强调多模态能力是AGI的关键，公司将持续投入基础模型研发，同时探索多模态理解技术，以保持竞争力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T19:03:11Z
- **目录日期**: 2025-05-11
