...
阶跃星辰坚持基础大模型研发，CEO姜大昕认为技术发展仍处快速上升期，放弃基础模型会错失主流趋势。公司认为模型决定应用上限，应用则为模型提供场景和数据，二者相辅相成。其C端产品从"跃问"更名为"阶跃AI"，转型为端云一体Agent平台，最终目标仍是服务普通用户。姜大昕强调多模态是AGI的关键，尽管行业部分玩家转向垂直领域，阶跃仍将持续投入基础大模型和多模态技术研发。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T11:02:49Z
- **目录日期**: 2025-05-11
