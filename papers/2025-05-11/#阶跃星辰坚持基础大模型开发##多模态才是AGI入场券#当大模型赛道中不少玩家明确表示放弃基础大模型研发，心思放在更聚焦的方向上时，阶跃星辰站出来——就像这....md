...
阶跃星辰坚持基础大模型研发，认为行业技术仍处快速发展期，基础模型决定应用上限。CEO姜大昕指出，AI技术迭代迅速（如GPT-4即将"过时"），公司需紧跟主流趋势。其产品从"跃问"升级为"阶跃AI"，转型为端云一体Agent平台，主攻C端服务，涵盖智能助手和内容领域。同时强调多模态是AGI的关键路径，模型与应用相辅相成——模型定义潜力，应用提供场景和数据反馈。公司动态调整产品形态，但保持"基础研发+场景落地"的核心逻辑。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T23:03:06Z
- **目录日期**: 2025-05-11
