...
阶跃星辰坚持基础大模型研发，认为行业技术仍处于快速迭代期（如GPT-4即将"过时"），需紧跟主流趋势。CEO姜大昕强调基础模型决定应用上限，而应用反哺模型迭代，二者相辅相成。其C端产品"跃问"已升级为Agent平台"阶跃AI"，主打端云一体智能助手，通过与头部企业合作最终服务消费者。公司认为多模态是AGI的关键路径，同时看好AI助手和内容类应用的商业潜力。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-11T13:08:08Z
- **目录日期**: 2025-05-11
