...
OpenAI正在测试ChatGPT的社交功能版本，目标对标马斯克的X平台。新功能允许用户分享AI生成内容（如图像、段子）并互动点赞，形成类似社交媒体的信息流。该功能不仅能自动润色发言、制作AI头像，还能将照片转为艺术风格插图并一键分享。TheVerge分析指出，这种"AI内容社区"模式可为ChatGPT提供实时训练数据，帮助其掌握最新流行文化。这意味着ChatGPT可能从聊天工具转型为社交平台，直接与X和Meta竞争。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T05:03:52Z
- **目录日期**: 2025-04-18
