...
OpenAI正在测试ChatGPT的社交功能升级，计划将其打造成类似X（原Twitter）的AI内容社区。新版本允许用户分享AI生成的内容（如图像、段子），并支持点赞、评论等互动。该功能不仅能展示创作成果，还能通过用户实时内容训练ChatGPT理解最新流行文化。界面或类似信息流，支持AI配图、润色文本甚至生成头像。此举标志着ChatGPT从工具转向社交平台，可能引发与马斯克X的直接竞争，推动AI与社交融合的新趋势。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T01:29:58Z
- **目录日期**: 2025-04-18
