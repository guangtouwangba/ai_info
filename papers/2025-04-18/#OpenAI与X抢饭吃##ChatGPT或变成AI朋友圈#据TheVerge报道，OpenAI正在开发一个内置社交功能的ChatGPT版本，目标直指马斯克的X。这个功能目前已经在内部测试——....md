...
OpenAI正测试ChatGPT社交功能版本，旨在打造AI内容社区。用户可分享AI生成内容（如图像、段子）并互动点赞，平台将呈现类似X的信息流界面。该功能支持AI配图、风格转换（如自拍变宫崎骏插画）及内容自动优化，通过用户实时数据训练模型以捕捉最新流行文化。此举标志着ChatGPT从工具转向社交平台，或将与X等社交媒体直接竞争。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T06:03:43Z
- **目录日期**: 2025-04-18
