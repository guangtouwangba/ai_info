...
OpenAI正在测试新版ChatGPT的社交功能，用户可分享AI生成内容（如图像）并互动。该平台类似X（原推特），但内容由AI生成，支持配图、段子创作等。此举旨在打造AI内容社区，通过用户实时内容训练模型以理解流行文化。ChatGPT或从聊天工具转型为社交平台，与X直接竞争。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T03:15:52Z
- **目录日期**: 2025-04-18
