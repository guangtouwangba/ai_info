...
本文改进了分布式过渡系统的概念，引入原子事务来重新定义基层平台。基层平台（如社交网络、加密货币和民主联盟）通过独立运行的多个实例互联形成更大网络，提供去中心化替代方案。研究提出基于原子事务的清晰规范，包括社交网络的加/删好友、加密货币的币交换、民主联盟的社区管理操作，并证明符合"交互式"原子事务的平台即为基层平台。这为基层平台建立了严谨的数学基础，为其实现提供了明确起点。相比原单代理过渡系统，新方法能更简洁地表达多代理原子操作。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T04:02:07Z
- **目录日期**: 2025-04-18
