...
近期研究表明，LLMs在自动程序修复（APR）中展现出强大能力，但现有方法主要集中于主流语言（如Java、Python），而忽视了Rust等新兴语言。为此，研究者提出跨语言修复方法LANTERN，通过多智能体迭代修复范式，将缺陷代码从LLMs修复能力较弱的语言翻译至表现更强的语言，无需额外训练。该方法采用基于LLM的动态决策系统，根据错误特征选择最优目标语言，并整合修复反馈。在包含11种语言5068个错误的xCodeEval基准测试中，Rust的Pass@10指标提升22.09%，首次证明跨语言翻译能有效弥合不同流行度语言间的修复差距。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T22:02:07Z
- **目录日期**: 2025-04-18
