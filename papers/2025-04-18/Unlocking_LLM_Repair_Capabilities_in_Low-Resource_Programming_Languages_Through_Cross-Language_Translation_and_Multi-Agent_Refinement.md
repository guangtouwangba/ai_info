...
最近研究表明，大型语言模型（LLM）在自动程序修复（APR）方面展现出强大能力，但现有方法主要针对主流语言（如Java、Python），而忽视了Rust等新兴语言。为此，研究者提出跨语言修复方法LANTERN，通过多智能体迭代修复范式，将缺陷代码从LLM修复能力较弱的语言翻译至修复能力较强的语言，无需额外训练。该方法采用基于LLM的动态决策系统，根据错误特征选择最优目标语言，并整合修复反馈。在xCodeEval基准测试中，Rust的修复成功率提升22.09%，首次证明跨语言翻译能显著提升LLM的多语言修复能力，为语言无关的自动程序修复开辟了新途径。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T09:02:03Z
- **目录日期**: 2025-04-18
