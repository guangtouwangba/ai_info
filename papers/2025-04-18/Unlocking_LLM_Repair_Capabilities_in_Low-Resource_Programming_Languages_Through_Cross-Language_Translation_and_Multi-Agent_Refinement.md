...
近期研究表明，大型语言模型(LLMs)在自动程序修复(APR)方面展现出强大能力，但现有方法主要集中于Java、Python等主流语言，对Rust等新兴语言因训练成本高、数据集不足而缺乏支持。为此，研究者提出跨语言修复方法LANTERN，通过多智能体迭代修复范式，将缺陷代码从LLMs修复能力弱的语言翻译至其擅长的语言，无需额外训练。基于xCodeEval基准测试（11种语言5068个错误），该方法显著提升修复效果，特别是冷门语言如Rust的Pass@10指标提升22.09%，首次证明跨语言翻译能有效弥合不同流行度语言间的修复差距。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T21:02:00Z
- **目录日期**: 2025-04-18
