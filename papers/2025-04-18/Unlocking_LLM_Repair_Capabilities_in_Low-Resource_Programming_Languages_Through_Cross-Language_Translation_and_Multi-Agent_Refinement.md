...
近期研究表明，LLMs在自动程序修复（APR）方面展现出强大能力，但现有方法主要集中于主流语言（如Java、Python），而忽视了新兴语言（如Rust）。为此，研究者提出跨语言修复方法LANTERN，通过多智能体迭代修复范式，将缺陷代码从LLMs修复能力较弱的语言翻译至修复能力较强的语言，无需额外训练。该方法采用基于LLMs的决策系统动态选择目标语言，并整合修复反馈。在xCodeEval基准测试中，Rust的修复成功率提升22.09%，首次证明跨语言翻译能显著扩展LLMs的修复能力，弥合不同流行度语言间的性能差距。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T08:02:02Z
- **目录日期**: 2025-04-18
