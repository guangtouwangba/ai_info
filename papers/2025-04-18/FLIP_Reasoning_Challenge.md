...
这篇论文介绍了FLIP数据集，这是一个基于Idena区块链人类验证任务的人工智能推理能力评估基准。FLIP要求用户从两组4张图片序列中识别逻辑连贯的排序，测试多模态AI系统的顺序推理、视觉叙事和常识能力。实验显示，当前最优的开源和闭源模型在零样本设置下的准确率仅为75.5%和77.9%，远低于人类的95.3%。使用图像描述模型辅助推理可提升性能（Gemini 1.5 Pro从69.6%升至75.2%），15个模型集成后准确率达85.2%。研究揭示了现有推理模型的局限性，凸显了FLIP等强大多模态基准的必要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T00:01:38Z
- **目录日期**: 2025-04-18
