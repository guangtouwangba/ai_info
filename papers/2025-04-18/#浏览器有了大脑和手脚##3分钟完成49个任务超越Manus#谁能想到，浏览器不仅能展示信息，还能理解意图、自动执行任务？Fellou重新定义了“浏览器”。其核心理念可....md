...
Fellou是一款革命性的智能浏览器，集信息浏览、AI智能体和自动化工作流于一体。它通过"大脑"(理解意图)和"手脚"(执行任务)实现全流程自动化，在测试中表现优于主流AI工具：3.7分钟完成49个任务(Manus需18.6分钟)，延迟降低65%。其独特功能包括：1)混合经验学习系统，从失败中积累经验；2)Eko框架支持自定义逻辑插入。目前已开放Mac内测，未来可能重塑生产力工具形态，实现"一句话自动完成任务"的智能体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T23:03:15Z
- **目录日期**: 2025-04-18
