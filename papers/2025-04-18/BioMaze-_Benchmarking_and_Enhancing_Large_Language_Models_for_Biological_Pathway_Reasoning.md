...
这篇论文探讨了大语言模型（LLM）在复杂生物通路推理中的潜力。作者提出了BioMaze数据集，包含5.1K个基于真实研究的生物通路问题，涵盖自然动态变化、扰动、干预条件和多尺度目标等场景。评估发现LLM在通路推理（尤其是扰动系统）中表现不佳。为此，作者开发了PathSeeker智能体，通过基于子图的交互式导航增强推理能力，更有效地处理复杂生物系统。该研究为LLM在生物通路分析中的应用提供了新思路，相关数据和代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T04:01:51Z
- **目录日期**: 2025-04-18
