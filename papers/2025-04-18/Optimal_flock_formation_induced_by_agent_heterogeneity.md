...
传统群体行为研究多假设个体同质化，本研究突破性地探讨了异质性对集群动态的影响。结果表明：参数优化分配的异质智能体群比同质群体性能显著提升，在目标追踪、队形保持和避障等任务中收敛速度加快20-40%。特别在通信延迟场景下，异质性可实现同质系统无法达成的稳定集群。这一发现颠覆了多智能体控制的传统范式，揭示系统无序性可作为促进集体行为的自适应分布式机制。研究为无人机群等自主系统的协调控制提供了新思路，证明个体差异能增强群体整体性能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T03:13:32Z
- **目录日期**: 2025-04-18
