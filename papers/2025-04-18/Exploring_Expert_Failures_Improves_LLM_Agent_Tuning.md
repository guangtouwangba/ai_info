...
该研究提出了一种名为"探索专家失败"(EEF)的新方法，用于改进大型语言模型(LLMs)作为智能体的性能。传统方法RFT仅利用专家成功轨迹进行微调，而EEF创新性地从专家失败轨迹中提取有价值的指导信息(如关键行动和计划)，同时排除有害动作以避免干扰。实验表明，EEF能解决一些之前无法完成的复杂子任务，在WebShop测试中达到62%的胜率，显著优于RFT(53.6%)和GPT-4(35.6%)，并在WebShop和SciWorld基准测试中创下新纪录。该方法通过利用专家失败经验有效提升了智能体的探索效率和关键技能获取。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T16:01:23Z
- **目录日期**: 2025-04-18
