...
本文提出"睡眠时间计算"方法，通过离线预计算用户可能提出的查询相关量，显著降低大语言模型(LLM)在测试时的计算需求。实验表明，该方法在Stateful GSM-Symbolic和Stateful AIME推理任务中，能将达到相同准确率所需的测试计算量减少约5倍，同时通过增加睡眠计算可提升准确率13-18%。在多查询任务Multi-Query GSM-Symbolic中，通过分摊预计算成本使单查询平均成本降低2.5倍。研究发现查询可预测性与方法效果正相关，并在实际软件工程任务中验证了其有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T20:00:52Z
- **目录日期**: 2025-04-18
