...
本文提出“睡眠时间计算”方法，通过让大语言模型在查询前预先处理上下文并预测可能的问题，显著降低推理时的计算需求和延迟。实验表明，该方法在Stateful GSM-Symbolic和Stateful AIME任务上能减少约5倍计算量，同时提升准确率13%和18%。此外，Multi-Query GSM-Symbolic通过分摊相关查询的计算成本，使单次查询成本降低2.5倍。研究发现，用户查询的可预测性与该方法的有效性高度相关。最后，案例研究验证了该方法在软件工程任务中的实际应用效果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T16:01:01Z
- **目录日期**: 2025-04-18
