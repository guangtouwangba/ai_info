...
本文探讨了自监督学习（SSL）中柏拉图表征假说（PRH）的理论基础，指出尽管现有可辨识性理论（IT）可以解释PRH现象，但无法完全说明SSL的实际成功。为此，作者提出扩展为"奇异可辨识性理论"（SITh），以涵盖整个SSL流程，从而更深入理解其隐含的数据假设，推动学习更具可解释性和泛化性的表征。未来研究应关注三个方向：1）SSL的训练动态与收敛特性；2）有限样本、批次大小和数据多样性的影响；3）架构、数据增强、初始化及优化器中归纳偏置的作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T13:07:17Z
- **目录日期**: 2025-04-18
