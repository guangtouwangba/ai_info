...
当前自监督学习(SSL)研究快速发展，但缺乏理论解释。研究发现，基于可辨识性理论(IT)，柏拉图表征假说(PRH)可能在SSL中成立，但现有IT无法完全解释SSL的成功实践。为此，研究者提出扩展的"奇异可辨识性理论"(SITh)，旨在建立涵盖整个SSL流程的理论框架。该理论将帮助理解SSL中的隐含数据假设，推动学习更具解释性和泛化能力的表征。未来研究应重点关注三个方向：SSL训练动态与收敛特性、有限样本/批量/数据多样性的影响，以及架构/增强/初始化/优化器中归纳偏置的作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T07:01:44Z
- **目录日期**: 2025-04-18
