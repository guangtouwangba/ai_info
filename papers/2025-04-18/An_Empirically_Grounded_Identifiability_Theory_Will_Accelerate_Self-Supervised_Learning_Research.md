...
该研究探讨了自监督学习(SSL)中"柏拉图表示假说"(PRH)的理论基础，即不同方法最终会收敛到相同的理想表示。通过可识别性理论(IT)分析发现，PRH可以在SSL中实现，但现有理论无法解释SSL的实际成功。为此，作者提出"奇异可识别性理论"(SITh)这一更广泛的理论框架，以涵盖整个SSL流程。SITh有助于理解SSL中的隐含数据假设，推动学习更具可解释性和泛化能力的表示。未来研究应关注：1)SSL训练动态与收敛性；2)有限样本、批次大小和数据多样性的影响；3)架构、增强、初始化和优化器中的归纳偏置作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T20:01:32Z
- **目录日期**: 2025-04-18
