...
当前自监督学习(SSL)研究快速发展，但缺乏统一理论解释。研究发现，基于可识别性理论(IT)，柏拉图表征假说(PRH)能在SSL中实现，但现有IT无法解释SSL的实际成功。为此，研究者提出"奇异可识别性理论"(SITh)，作为涵盖整个SSL流程的扩展理论框架。SITh能深入分析SSL中的隐含数据假设，推动学习更具解释性和泛化能力的表征。未来研究应关注三个方向：1)SSL训练动态与收敛特性；2)有限样本、批次大小和数据多样性的影响；3)架构、数据增强、初始化和优化器中的归纳偏置作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T08:01:40Z
- **目录日期**: 2025-04-18
