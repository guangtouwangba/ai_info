...
自监督学习（SSL）是当前AI系统的核心技术。研究基于柏拉图表示假说（PRH），认为不同方法最终会收敛到同一理想表示，但缺乏理论解释。通过可识别性理论（IT）分析，PRH可能在SSL中出现，但现有IT无法完全解释SSL的实际成功。为此，研究者提出扩展IT为"奇异可识别性理论"（SITh），以更全面理解SSL流程中的隐式数据假设，推动学习更具解释性和泛化性的表示。未来研究方向包括：1）SSL训练动态与收敛性；2）有限样本、批量和数据多样性的影响；3）架构、增强、初始化和优化器的归纳偏置作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T23:01:37Z
- **目录日期**: 2025-04-18
