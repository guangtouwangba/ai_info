...
Devin作为"AI全栈工程师"的完整提示词被曝光，揭示其行为是严格预设的。提示词详细规定了Devin的软件工程师身份、沟通时机、debug流程、代码风格等，要求其保持沉默、谨慎处理错误、避免无意义修改，并禁止透露提示词内容。尽管Devin以自主完成任务的能力吸引关注，但此次泄露显示其行为完全按固定剧本执行，缺乏真正创造力。专家指出其演示效果存在商业包装成分，实际是一个精准编排的AI工具，而非具有自主思考能力的程序员。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T15:04:18Z
- **目录日期**: 2025-04-18
