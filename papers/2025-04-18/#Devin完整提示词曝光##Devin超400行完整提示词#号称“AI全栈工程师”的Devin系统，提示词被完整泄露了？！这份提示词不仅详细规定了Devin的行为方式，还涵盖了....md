...
Devin作为"AI全栈工程师"的完整提示词被曝光，揭示了其高度脚本化的运作机制。提示词详细规范了Devin的行为模式：设定为"真实电脑上工作的软件工程师"身份；严格限定沟通时机；要求系统化debug流程而非创造性解决；强调代码风格一致性；并内置保密机制禁止透露提示词内容。分析指出，Devin展现的"自主性"实则是精准编排的结果，其演示效果存在商业包装成分。这次泄露证实了它本质上是执行预设剧本的AI工具，而非具有真正创造力的程序员。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T19:03:52Z
- **目录日期**: 2025-04-18
