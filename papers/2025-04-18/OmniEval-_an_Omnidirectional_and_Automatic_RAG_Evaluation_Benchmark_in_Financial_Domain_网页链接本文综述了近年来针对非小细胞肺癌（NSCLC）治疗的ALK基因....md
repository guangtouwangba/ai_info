...
该论文综述了针对非小细胞肺癌(NSCLC)ALK基因双靶点抑制剂的最新进展。ALK基因是NSCLC的关键致癌驱动因素，现有7种ALK抑制剂虽获批使用，但面临耐药性问题。相比联合用药，双靶点抑制剂能同时作用于两个靶点，减少副作用并提高耐药性应对能力。研究总结了这类抑制剂在NSCLC治疗中的发展，分析了其合理设计和结构-活性关系，为开发新型ALK抑制剂和创新疗法提供重要参考，有助于解决当前靶向治疗中的耐药性挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T20:04:48Z
- **目录日期**: 2025-04-18
