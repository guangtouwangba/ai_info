...
哈工大深圳博士生李俊劼团队开发了GiVE模型，解决了AI视觉模型的"选择性失明"问题。该模型通过AG-Adapter模块让AI能根据文本指令关注图像细节，并设计了三种训练目标提升细节感知能力。团队构建了包含8万图像、24万标注的MOInst数据集进行训练。GiVE可作为插件集成到现有系统，显著提升了图文检索和图像分类准确率。这项突破为AI从粗略看图发展到按需识图奠定了基础，在医疗、安防等领域具有应用潜力。相关代码和数据集已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T18:03:42Z
- **目录日期**: 2025-04-18
