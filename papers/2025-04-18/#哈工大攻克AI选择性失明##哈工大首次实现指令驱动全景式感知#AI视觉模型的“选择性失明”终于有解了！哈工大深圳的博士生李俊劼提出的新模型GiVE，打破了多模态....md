...
哈工大深圳博士生李俊劼团队提出GiVE模型，解决了AI视觉模型的"选择性失明"问题。该模型通过AG-Adapter模块实现指令驱动的全景感知，能根据文本指令聚焦图像细节。创新点包括三个细节感知训练目标，并构建了包含8万图像的多目标指令数据集MOInst。GiVE可作为插件集成现有系统，显著提升图文检索和图像分类准确率。这项技术有望应用于医疗、安防等领域，推动AI从"粗略看图"向"按需识图"发展。相关代码和数据集已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T20:03:37Z
- **目录日期**: 2025-04-18
