...
英伟达发布RTX 5060系列显卡，主打1080p/1440p游戏，支持DLSS 4技术提升帧率并降低延迟。5060 Ti分8GB（2765元）和16GB（3130元）版本，基础款5060（2182元）5月上市。性能较4060提升20-25%，在《黑神话》等游戏中帧率翻倍。但8GB显存配置引发争议，英伟达称其适合主流场景。新卡还支持PCIe 5.0和AI创作加速，适用于Blender等创意软件。核心采用Ada Lovelace Refresh架构，兼顾游戏与生产力需求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T03:16:14Z
- **目录日期**: 2025-04-18
