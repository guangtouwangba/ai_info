...
判断一个行为是否安全需要结合具体情境。对人类而言，这显而易见，比如删除邮件是否合适取决于邮件内容、目的和邮箱类型。传统计算系统功能有限，依靠手动设置策略和用户确认（如应用权限）即可防范风险。但随着多功能智能代理（如自动个人助手）的出现，其广泛的应用场景要求重新设计安全机制。为此，本文提出"情境化代理安全框架"（Conseca），旨在生成即时、情境化且可人工验证的安全策略，以适应这类系统的多样化需求。该研究为智能代理领域的情境安全探索迈出了第一步。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T21:02:18Z
- **目录日期**: 2025-04-18
