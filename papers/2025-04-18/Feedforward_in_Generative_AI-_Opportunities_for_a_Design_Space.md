...
生成式AI（GenAI）虽能提升生产力，但用户难以预判其输出，导致频繁交互以澄清意图，增加认知负担和时间成本。研究提出，GenAI系统需同时提供"前馈"（feedforward）设计——在用户提交指令前展示预期生成内容，以降低不确定性。通过对话界面、文档编辑器等四个应用场景的原型设计，探讨了前馈机制如何优化用户体验，为GenAI系统设计提供新方向。该研究旨在推动前馈设计的系统性探索，建立通用准则，帮助用户更高效地利用GenAI潜力。（99字）  

注：摘要核心聚焦于"前馈"设计的重要性及实践案例，通过场景化原型论证其价值，最终指向设计规范的系统性研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T04:02:00Z
- **目录日期**: 2025-04-18
