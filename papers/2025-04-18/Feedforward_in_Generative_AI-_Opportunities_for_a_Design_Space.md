...
生成式AI（GenAI）虽能提升生产力与认知能力，但用户难以预判其输出内容，导致需多次交互调整意图，增加认知负荷与时间成本。研究提出，GenAI系统需同时提供"前馈"（feedforward）设计——在用户提交指令前展示AI可能的生成内容，以降低不确定性。通过对话界面、文档编辑等四个应用场景的原型设计，探讨了前馈机制如何优化人机协作，为GenAI系统设计提供新方向与准则。该研究旨在推动通过前瞻性交互设计释放GenAI的完整潜力。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T01:29:21Z
- **目录日期**: 2025-04-18
