...
该研究探讨了如何利用多模态大语言模型(MLLMs)进行更深入的美学判断。当前生成艺术虽能创造视觉愉悦的图像，但缺乏真正打动观众的艺术感染力。研究发现MLLMs在美学推理时存在幻觉倾向，常产生主观且缺乏依据的艺术解读。通过引入基于证据的客观推理方法(ArtCoT)，可显著提升模型的美学判断能力，使其产出更全面深入、更符合人类审美标准的分析。这一突破为AI艺术辅导和生成艺术奖励模型等应用奠定了基础，推动AI系统真正理解、欣赏并创作符合人类审美标准的艺术作品。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T14:02:34Z
- **目录日期**: 2025-04-18
