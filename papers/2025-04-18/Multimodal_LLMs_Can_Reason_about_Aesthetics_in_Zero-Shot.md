...
这篇论文探讨了如何利用多模态大语言模型（MLLMs）进行更深入的美学判断。研究发现，当前MLLMs在美学推理时容易产生主观臆断和缺乏依据的艺术解读。通过引入基于证据的客观推理方法（如提出的ArtCoT基线），能显著提升模型的美学分析能力，使其更符合人类审美标准。这项研究为AI艺术辅导和生成艺术奖励模型提供了直接应用价值，推动了AI系统在真正理解、欣赏和生成符合人类审美标准的艺术作品方面的发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T08:02:32Z
- **目录日期**: 2025-04-18
