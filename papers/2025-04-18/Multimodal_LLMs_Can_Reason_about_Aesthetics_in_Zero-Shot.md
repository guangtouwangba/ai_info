...
当前生成艺术快速发展，但真正具有艺术感染力的作品需要超越视觉吸引力的深层审美推理。研究发现，多模态大语言模型（MLLMs）在进行美学判断时容易产生主观臆断和缺乏依据的艺术解读。通过采用基于证据的客观推理方法（如提出的ArtCoT基线），MLLMs能生成更全面深入、更符合人类评判标准的美学分析。这一突破可应用于AI艺术辅导和生成艺术奖励模型，为开发真正理解人类审美标准、能欣赏和创作艺术作品的AI系统奠定了基础。研究揭示了克服AI审美幻觉的关键路径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T13:08:09Z
- **目录日期**: 2025-04-18
