...
这篇论文探讨了如何利用多模态大语言模型(MLLMs)进行艺术审美判断。研究发现，当前MLLMs在审美推理时容易产生主观臆断和缺乏依据的艺术解读。作者提出基于证据的客观推理方法ArtCoT，能显著改善这一问题，使MLLMs产生更全面深入的审美分析，更符合人类判断标准。这一成果可应用于AI艺术辅导和生成艺术的奖励模型，为开发真正理解人类审美、能创作符合人类审美标准的AI系统奠定了基础。研究揭示了当前生成艺术在实现深层艺术感染力方面的局限性，并提出了解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T10:02:32Z
- **目录日期**: 2025-04-18
