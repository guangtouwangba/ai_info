...
当前生成艺术快速发展，但AI模型常忽略深层次的艺术感染力。本研究探索如何利用多模态大语言模型（MLLM）进行美学判断，发现其存在主观臆断和缺乏依据的"幻觉"问题。作者提出基于证据的客观推理方法ArtCoT，能显著提升模型的美学分析能力，使其产出更符合人类审美的多维度深度评价。该成果可应用于AI艺术教学和生成艺术奖励模型，为开发真正理解、欣赏并创作符合人类审美标准的AI系统奠定了基础。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T06:02:24Z
- **目录日期**: 2025-04-18
