...
该研究探讨了如何利用多模态大语言模型(MLLMs)进行更深入的艺术审美判断。研究发现当前MLLMs在审美推理中存在主观臆断和缺乏依据的问题。通过提出基于证据的客观推理方法ArtCoT，显著改善了模型的审美判断能力，使其更符合人类审美标准。这一进展可应用于AI艺术辅导和生成艺术的奖励模型，为开发能真正理解和创作符合人类审美标准的AI系统奠定了基础。研究强调了超越视觉吸引力的多维度审美推理在生成艺术中的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T20:02:24Z
- **目录日期**: 2025-04-18
