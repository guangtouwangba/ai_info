...
当前生成艺术快速发展，但AI模型常忽略深层次的艺术审美，仅关注视觉吸引力。本文提出利用多模态大模型（MLLMs）进行美学推理，发现其存在主观臆断和缺乏依据的"幻觉"问题。通过引入基于证据的客观推理框架ArtCoT，显著提升了MLLMs的审美判断能力，使其输出更符合人类标准。该成果可应用于AI艺术教学和生成艺术奖励模型，为开发真正理解人类审美的AI系统奠定基础。研究揭示了客观推理在克服AI美学评价局限性中的关键作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T15:02:33Z
- **目录日期**: 2025-04-18
