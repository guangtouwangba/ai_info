...
当前生成艺术快速发展，但AI模型常忽视艺术深层感染力所需的多维审美推理。研究发现，多模态大语言模型（MLLMs）在审美判断时易产生主观臆断和缺乏依据的艺术解读。通过采用基于证据的客观推理框架ArtCoT，可显著改善这一问题，使AI的审美分析更接近人类标准。该成果可应用于AI艺术教学和生成艺术奖励模型，为开发真正理解人类审美、能创作引发深层共鸣的艺术AI系统奠定基础。研究揭示了克服AI审美幻觉的关键路径，推动AI向具有高级艺术感知力的方向发展。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T11:02:38Z
- **目录日期**: 2025-04-18
