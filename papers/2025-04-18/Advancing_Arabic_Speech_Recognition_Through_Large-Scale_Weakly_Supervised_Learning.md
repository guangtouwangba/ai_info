...
本研究利用弱监督学习方法训练了一个基于Conformer架构的阿拉伯语自动语音识别(ASR)模型。该模型完全使用15,000小时的弱标注语音数据(包含现代标准阿拉伯语和方言阿拉伯语)进行训练，无需昂贵的人工转录。尽管缺乏人工验证标签，该方法在标准基准测试中实现了最先进的性能表现，超越了此前所有阿拉伯语ASR研究成果。这项工作证明了弱监督学习作为传统监督学习方法的一种可扩展、高成本效益的替代方案，为低资源语言环境下的ASR系统改进开辟了新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T02:27:37Z
- **目录日期**: 2025-04-18
