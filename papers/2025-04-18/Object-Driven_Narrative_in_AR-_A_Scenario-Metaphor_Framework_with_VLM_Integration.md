...
当前自适应AR叙事系统通常仅用简单物体标签和空间坐标定义环境语义，导致叙事僵化且忽视上下文关联（如床头婚戒可能暗示婚姻危机却被简化为"两个物体"）。研究提出基于视觉语言模型(VLM)的AR叙事框架，通过三重创新：1) 将物体语义分解为物理/功能/隐喻三层；2) 设计双向JSON接口连接VLM隐喻与AR锚点；3) 建立STAM评估体系。实验显示70%用户因环境符号化叙事改变了对实景的认知。该框架融合VLM生成创造力与AR空间精度，实现了从"空间布景"到"环境自生"的叙事范式转变。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T22:01:38Z
- **目录日期**: 2025-04-18
