...
当前自适应AR叙事系统大多使用简单物体标签和空间坐标定义环境语义，导致叙事僵化且缺乏上下文关联。为此，研究者提出整合视觉语言模型(VLM)的AR叙事框架，通过三大创新解决关键问题：1) 三层物体语义分解（物理/功能/隐喻层）识别细微叙事线索；2) 双向JSON接口桥接VLM隐喻与AR锚点；3) STAM评估框架验证叙事质量。实验显示，70%用户因环境符号化叙事改变了对现实物体的认知。该框架将VLM的生成创造力与AR空间精度结合，实现了从"空间放置故事"到"环境自主生成故事"的范式转变。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T10:01:30Z
- **目录日期**: 2025-04-18
