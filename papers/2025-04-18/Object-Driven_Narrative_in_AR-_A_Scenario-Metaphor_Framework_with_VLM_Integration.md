...
当前自适应AR叙事系统通常使用简单的物体标签和空间坐标来定义环境语义，导致叙事逻辑僵化且缺乏上下文关联（如床头柜上的婚戒可能暗示婚姻冲突，但系统仅视为"两个物体"）。研究提出基于视觉语言模型(VLM)的AR叙事框架，通过三层创新：1) 将物体语义分解为物理/功能/隐喻层次；2) 建立双向JSON接口连接VLM生成内容与AR锚点；3) 开发STAM评估体系。用户研究显示70%参与者因环境象征性叙事而改变对实物的认知。该框架将VLM的生成能力与AR空间精度结合，实现了从"空间置入故事"到"环境生成故事"的范式转变。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T18:01:39Z
- **目录日期**: 2025-04-18
