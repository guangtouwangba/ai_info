...
当前自适应AR叙事系统通常使用简单对象标签和空间坐标定义环境语义，导致叙事僵化且缺乏深度。针对这一问题，研究者提出整合视觉语言模型(VLM)的AR叙事框架，通过三个创新点：1) 将对象语义分解为物理、功能和隐喻三层；2) 设计双向JSON层连接VLM生成内容与AR锚点；3) 建立STAM评估框架。实验显示，70%用户反馈该系统能基于环境符号学改变他们对现实物体的认知，实现了从"在环境中放置故事"到"从环境生成故事"的转变，使被动空间转化为主动叙事媒介。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T06:01:28Z
- **目录日期**: 2025-04-18
