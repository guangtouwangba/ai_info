...
当前自适应AR叙事系统大多使用简单的物体标签和空间坐标来定义环境语义，导致叙事逻辑僵化且缺乏上下文关联。针对这一问题，研究者提出整合视觉语言模型(VLM)的AR叙事框架，通过三个创新点：1) 将物体语义分解为物理、功能和隐喻三层；2) 设计双向JSON接口连接VLM隐喻与AR锚点；3) 建立STAM评估体系。实验表明，70%用户反馈该系统能基于环境符号学改变其对现实物体的认知。该框架将VLM的生成创造力与AR空间精度结合，实现了从"在环境中放置故事"到"从环境生成故事"的范式转变。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T16:01:34Z
- **目录日期**: 2025-04-18
