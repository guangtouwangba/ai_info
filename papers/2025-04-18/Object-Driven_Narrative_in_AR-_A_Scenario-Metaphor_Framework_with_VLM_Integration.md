...
现有AR叙事系统常简单使用物体标签和空间坐标定义环境语义，导致叙事僵化且缺乏上下文关联。研究者提出整合视觉语言模型(VLM)的新框架，通过三方面创新：1) 将物体语义分解为物理、功能和隐喻三层；2) 设计双向JSON接口连接VLM输出与AR锚点；3) 建立STAM评估体系。实验表明，该系统能基于环境本身生成故事（而非简单叠加），70%用户反馈能通过环境象征重新理解现实物体。该框架融合VLM的创造性与AR的空间精度，实现了"物体驱动"的叙事范式，使被动空间转化为主动叙事场景。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T15:01:34Z
- **目录日期**: 2025-04-18
