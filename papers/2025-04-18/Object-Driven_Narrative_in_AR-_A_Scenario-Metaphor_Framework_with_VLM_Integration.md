...
现有自适应AR叙事系统多采用简单的物体标签和空间坐标定义环境语义，导致叙事僵化且忽视物体间的语境意义（如床头婚戒可能暗示婚姻冲突）。研究提出整合视觉语言模型（VLM）的解决方案，通过三项创新：1）分物理/功能/隐喻三层解析物体语义；2）用双向JSON层关联VLM输出与AR锚点；3）建立STAM评估框架。实验显示70%用户因环境符号化叙事改变了对实景的认知。该框架将VLM的生成能力与AR空间精度结合，实现了从"在环境中放置故事"到"由环境生成故事"的范式转变，使被动空间转化为主动叙事场域。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T17:01:41Z
- **目录日期**: 2025-04-18
