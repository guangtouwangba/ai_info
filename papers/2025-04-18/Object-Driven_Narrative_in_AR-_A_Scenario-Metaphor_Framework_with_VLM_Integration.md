...
现有自适应AR叙事系统多采用简单物体标签和空间坐标定义环境语义，导致叙事逻辑僵化。针对该问题，研究者提出融合视觉语言模型(VLM)的创新框架：1) 通过物理/功能/隐喻三层语义解析，使VLM能识别相似物体的叙事差异；2) 设计双向JSON接口桥接VLM隐喻与AR锚点；3) 建立STAM评估体系验证叙事质量。实验显示70%用户因环境符号化叙事改变了对实景的认知。该框架突破性地将VLM的生成能力与AR空间精度结合，使被动空间转化为主动叙事载体，开创了物体驱动的叙事新范式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T14:01:30Z
- **目录日期**: 2025-04-18
