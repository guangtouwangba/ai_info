...
现有的AR叙事系统通常用简单对象标签和空间坐标定义环境语义，导致叙事缺乏深度。研究者提出整合视觉语言模型(VLM)的解决方案，通过三层创新：1)将对象语义分解为物理、功能和隐喻层面；2)用双向JSON层连接VLM隐喻与AR锚点；3)建立STAM评估框架。实验表明，70%用户反馈该系统能让他们重新理解现实物品的象征意义。该框架将VLM的创造性与AR空间精度结合，实现了从"在环境中放置故事"到"从环境生成故事"的转变，使被动空间成为主动叙事载体。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T20:01:21Z
- **目录日期**: 2025-04-18
