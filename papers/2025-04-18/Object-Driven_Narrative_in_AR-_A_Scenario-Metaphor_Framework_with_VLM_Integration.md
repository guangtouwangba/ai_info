...
现有AR叙事系统多采用简单物体标签和空间坐标来定义环境语义，导致叙事逻辑僵化，忽略了物体间关系的深层含义（如床头柜上的婚戒可能暗示婚姻冲突）。研究提出融合视觉语言模型(VLM)的AR叙事框架，通过三大创新：1) 将物体语义分解为物理、功能和隐喻三层；2) 用双向JSON层连接VLM隐喻与AR锚点；3) 建立STAM评估体系。用户研究显示，70%参与者因环境符号化叙事而改变对现实物体的认知。该框架将VLM的生成创造力与AR空间精度结合，实现了从"在环境中放置故事"到"让环境生成故事"的范式转变。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T11:01:35Z
- **目录日期**: 2025-04-18
