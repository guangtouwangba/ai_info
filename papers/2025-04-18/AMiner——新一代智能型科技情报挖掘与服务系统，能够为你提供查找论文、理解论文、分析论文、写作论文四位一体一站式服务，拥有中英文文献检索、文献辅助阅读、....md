...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索（覆盖42个学科3.5亿论文）、AI辅助阅读（自动生成摘要、章节概要和问答）、文档翻译及科研情报订阅（按用户偏好推送最新动态）。支持PDF上传分析，集成学者画像、学术会议等工具，可通过网页或微信小程序免费使用，显著提升文献查阅与论文写作效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T23:05:03Z
- **目录日期**: 2025-04-18
