...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析与写作的一站式服务。平台收录42个学科的3.5亿论文、0.6亿学者及1.5亿专利，支持中英文文献检索、AI辅助阅读、自动摘要生成和互动问答功能。用户可上传PDF或从文献库选择论文，获取摘要、章节概要和问题建议。此外，AMiner提供科研动态订阅服务，按用户偏好推送最新论文摘要，支持微信或邮件接收。平台还包含学者画像、学术会议等特色功能，基础服务免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T10:05:30Z
- **目录日期**: 2025-04-18
