...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和科研动态订阅等一站式服务。它收录了3.5亿篇论文、0.6亿学者和1.5亿专利，支持中英文文献检索，并能自动生成摘要和问答互动。用户可上传PDF或从平台获取论文，利用AI技术快速理解内容。此外，AMiner提供个性化科研情报订阅，通过微信或邮件推送最新学术资讯。平台还包含学者画像、学术会议和论文排行榜等功能，浏览器检索免费使用。网址：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T22:05:14Z
- **目录日期**: 2025-04-18
