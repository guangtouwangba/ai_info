...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译、写作等一站式服务。它收录3.5亿论文、0.6亿学者等海量数据，支持中英文文献检索，能自动生成摘要和问答互动。平台还具备文档翻译、科研动态订阅功能，可按用户偏好推送最新学术资讯。此外，AMiner提供学者画像、学术会议等特色服务，基础功能可免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T06:05:16Z
- **目录日期**: 2025-04-18
