...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献搜索，拥有3.5亿论文、0.6亿学者等海量数据，并提供AI辅助阅读、自动摘要生成、互动问答等功能。用户可订阅个性化科研动态，通过微信或邮件获取最新学术资讯。平台还支持PDF上传、文档翻译、学者画像分析等，帮助用户高效获取和理解学术内容。AMiner可免费使用，适合科研人员快速查找和消化文献信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T15:05:49Z
- **目录日期**: 2025-04-18
