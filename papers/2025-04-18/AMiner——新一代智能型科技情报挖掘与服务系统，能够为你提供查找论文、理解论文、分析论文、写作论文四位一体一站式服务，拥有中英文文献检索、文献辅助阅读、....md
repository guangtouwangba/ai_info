...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、辅助阅读、翻译和论文写作支持。平台收录3.5亿论文、0.6亿学者等海量数据，支持互动问答和自动摘要生成，帮助用户高效筛选和理解文献。其特色功能包括科研情报订阅（按用户偏好推送最新研究）、文档智能解析（上传PDF可生成摘要和章节概要），以及学者画像等工具。用户可通过网页免费使用基础功能，实现快速文献检索和深度内容分析。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T12:05:42Z
- **目录日期**: 2025-04-18
