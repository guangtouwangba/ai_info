...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作的一站式服务。其核心功能包括：1）中英文文献检索，支持互动问答和自动摘要生成；2）英文文献翻译与辅助阅读，可上传PDF并获取AI生成的摘要和问答解析；3）科研情报订阅，按用户偏好推送最新学术动态。平台覆盖42个学科的3.5亿论文、0.6亿学者等资源，并提供学者画像、会议追踪等附加功能。用户可通过网页免费使用基础服务，实现高效学术研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T05:05:24Z
- **目录日期**: 2025-04-18
