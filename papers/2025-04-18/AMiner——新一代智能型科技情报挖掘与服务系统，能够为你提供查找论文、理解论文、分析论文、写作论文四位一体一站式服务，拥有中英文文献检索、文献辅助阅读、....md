...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索（覆盖42个学科3.5亿论文）、AI辅助阅读（自动生成摘要、章节概要和问答）、文档翻译及科研情报订阅（按需推送最新成果）。支持用户上传或检索文献后，通过对话交互深入理解内容，并集成学者画像、学术会议等特色功能。平台基础服务免费，可通过网页或微信小程序使用，显著提升文献调研与论文写作效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T16:05:45Z
- **目录日期**: 2025-04-18
