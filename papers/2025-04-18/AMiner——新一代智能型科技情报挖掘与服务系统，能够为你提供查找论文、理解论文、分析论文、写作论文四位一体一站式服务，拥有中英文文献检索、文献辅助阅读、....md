...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、科研订阅等一站式服务。它能帮助用户快速查找、理解和分析论文，支持42个学科的3.5亿论文资源，并提供AI生成的摘要和问答功能。用户可定制科研动态推送，通过微信或邮件获取最新学术资讯。平台还包含学者画像、学术会议等辅助功能，免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T21:05:16Z
- **目录日期**: 2025-04-18
