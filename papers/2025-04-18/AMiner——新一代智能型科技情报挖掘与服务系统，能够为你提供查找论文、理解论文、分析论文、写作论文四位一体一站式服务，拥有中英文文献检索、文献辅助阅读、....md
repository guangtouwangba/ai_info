...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析和写作的一站式服务。其核心功能包括：1）中英文文献检索，支持互动问答和自动摘要生成；2）英文文献翻译与辅助阅读，可上传PDF获取AI生成的摘要和章节概要；3）科研情报订阅，按用户偏好推送最新学术动态。平台涵盖42个学科的3.5亿论文、0.6亿学者等海量数据，并提供学者画像、学术会议等特色功能。基础服务免费，可通过网页或微信小程序使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T17:05:49Z
- **目录日期**: 2025-04-18
