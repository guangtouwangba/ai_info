...
AgentSociety是一个基于大型语言模型的大规模社会模拟器，通过模拟1万多个代理和500万次互动来研究人类行为和社会现象。该平台作为计算社会科学实验工具，研究了社会极化、信息传播、基本收入政策及自然灾害影响等关键问题。其模拟结果与现实世界数据高度吻合，验证了该模型捕捉人类行为机制的能力。研究表明AgentSociety能有效补充传统社会科学研究方法，为研究者和政策制定者提供重要分析工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T04:04:08Z
- **目录日期**: 2025-04-18
