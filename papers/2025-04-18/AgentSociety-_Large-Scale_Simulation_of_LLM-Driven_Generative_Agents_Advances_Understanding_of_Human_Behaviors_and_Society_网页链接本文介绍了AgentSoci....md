...
这篇论文介绍了一个名为AgentSociety的大规模社会模拟器，它结合了LLM驱动的智能代理、真实社会环境和大规模模拟引擎。研究者模拟了1万多个代理的社会生活及500万次互动，并针对极化现象、信息传播、基本收入政策和飓风影响四个社会问题进行了实验。结果表明，模拟结果与现实世界数据吻合，验证了该系统捕捉人类行为机制的能力，展现了其作为社会科学研究和政策制定工具的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T07:05:00Z
- **目录日期**: 2025-04-18
