...
AgentSociety是一个基于大语言模型的大规模社会模拟器，通过模拟10,000多个AI代理及其500万次互动，研究人类行为和社会现象。该系统作为计算社会科学实验平台，分析了社会极化、信息传播、基本收入政策及自然灾害影响等关键问题。其模拟结果与现实数据高度吻合，验证了该工具在揭示社会机制方面的有效性，为社会科学研究和政策制定提供了新方法。研究展示了AI模拟在理解复杂社会动态中的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T12:05:15Z
- **目录日期**: 2025-04-18
