...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，包含1万多个AI代理和500万次互动。研究者用它模拟了四个关键社会问题：社会极化、信息传播、基本收入政策效果和自然灾害影响。模拟结果与现实世界数据高度吻合，验证了该系统捕捉人类行为机制的能力。该平台可作为计算社会科学研究工具，帮助学者和政策制定者分析社会问题的成因和潜在解决方案，补充传统研究方法（如调查和访谈）的不足。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T16:05:18Z
- **目录日期**: 2025-04-18
