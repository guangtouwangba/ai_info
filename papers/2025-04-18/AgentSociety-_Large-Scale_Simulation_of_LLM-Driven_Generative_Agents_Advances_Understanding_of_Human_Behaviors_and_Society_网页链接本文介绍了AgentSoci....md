...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，通过1万个AI代理和500万次交互模拟人类社会行为。该系统研究了四大社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，验证了其捕捉人类行为机制的能力。该平台可作为计算社会科学的研究工具，辅助传统调查方法，帮助学者和政策制定者分析社会问题的成因和解决方案。研究表明，AI驱动的社会模拟在理解复杂社会现象方面具有重要潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T22:04:47Z
- **目录日期**: 2025-04-18
