...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个代理及其500万次互动。研究者用它研究社会极化、信息传播、基本收入政策及自然灾害影响等问题。模拟结果与现实数据吻合，验证了该系统捕捉人类行为和社会机制的能力，展现了作为社会科学研究和政策制定工具的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T14:05:13Z
- **目录日期**: 2025-04-18
