...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万个AI代理及其500万次社会互动。研究者用它研究了四大社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，验证了该系统捕捉人类行为机制的能力。该系统可作为计算社会科学的新工具，辅助传统研究方法，帮助学者和政策制定者分析社会问题的模式和成因。研究展示了AI模拟在社会科学研究中的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T01:31:34Z
- **目录日期**: 2025-04-18
