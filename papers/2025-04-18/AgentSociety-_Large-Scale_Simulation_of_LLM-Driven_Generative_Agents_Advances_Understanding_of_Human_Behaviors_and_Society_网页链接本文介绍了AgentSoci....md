...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统模拟了超过1万个AI代理的社会互动（500万次），用于研究社会现象如信息传播、政策影响等。通过四个案例（社会极化、信息传播、基本收入政策、自然灾害影响），验证了模拟结果与现实数据的吻合性。研究表明，该系统能有效捕捉人类行为机制，可作为社会科学研究和政策制定的有力工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T20:05:05Z
- **目录日期**: 2025-04-18
