...
这篇论文针对代码生成大模型（CodeLLMs）提出新评估框架CodeArena，关注人类偏好对齐而非仅代码正确性。研究收集397个高质量编程任务样本（覆盖40类/44种语言），并构建20B标记的合成指令数据集SynCode-Instruct。实验发现传统执行基准与人类偏好评估存在差异，开源模型（如Qwen2.5-Coder）与商业模型（如OpenAI o1）性能差距显著。研究强调代码生成模型需兼顾功能正确性和人类编程习惯，为模型优化提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T10:05:39Z
- **目录日期**: 2025-04-18
