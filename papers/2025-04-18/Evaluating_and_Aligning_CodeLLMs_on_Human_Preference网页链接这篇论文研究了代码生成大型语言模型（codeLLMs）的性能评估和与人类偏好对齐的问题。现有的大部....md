...
这篇论文针对代码生成大模型(codeLLMs)提出CodeArena基准，关注模型输出与人类偏好的对齐问题。研究者从真实用户查询中收集397个高质量样本，覆盖40个类别和44种编程语言，并构建近200亿token的合成指令数据集SynCode-Instruct。实验发现传统基于执行的评估与人类偏好存在差距，开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著。研究强调了对齐人类偏好的重要性，为代码生成模型的评估提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-18T19:05:18Z
- **目录日期**: 2025-04-18
