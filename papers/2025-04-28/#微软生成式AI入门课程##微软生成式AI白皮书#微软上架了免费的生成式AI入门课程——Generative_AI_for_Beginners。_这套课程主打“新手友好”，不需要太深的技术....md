...
微软推出了免费开源的新手友好课程《Generative AI for Beginners》，包含21节独立课程，涵盖生成式AI基础原理到应用开发全流程。课程特点包括：零门槛学习、Python/TypeScript代码示例、配套视频与拓展资料、可申请OpenAI免费额度及Azure资源、提供Discord交流社区。内容涉及提示词工程、文本/图像生成应用开发、向量数据库、AI Agents等热门技术，并包含主流大模型对比和伦理指南。该项目已在GitHub获得8万+星标，适合初学者系统学习生成式AI技术。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T22:04:03Z
- **目录日期**: 2025-04-28
