...
微软推出免费开源课程《Generative AI for Beginners》，包含21节新手友好课程，涵盖生成式AI基础原理到实战应用（如文本/图像生成、聊天机器人开发等）。课程特点：提供Python/TypeScript代码示例、配套视频、Discord社群支持，结课后可申请OpenAI免费额度。内容包含提示词工程、向量数据库、RAG框架、模型微调等热门技术，已获8万+ GitHub星标。适合零基础学习者系统性入门生成式AI开发。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T16:04:12Z
- **目录日期**: 2025-04-28
