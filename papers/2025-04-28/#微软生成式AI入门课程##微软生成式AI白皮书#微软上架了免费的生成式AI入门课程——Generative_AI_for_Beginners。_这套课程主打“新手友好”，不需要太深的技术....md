...
微软推出免费开源课程《Generative AI for Beginners》，包含21节零基础友好课程，涵盖生成式AI原理到应用开发全流程。课程特点包括：分步教学（含Python/TypeScript示例）、主流模型对比、提示词工程、聊天机器人开发等实战项目，配套视频和Discord社群支持。学习者还可申请微软OpenAI免费额度及Azure资源。目前GitHub获8万+星标，内容包含RAG框架、AI Agents等前沿技术。适合想系统学习生成式AI的入门者。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T21:03:44Z
- **目录日期**: 2025-04-28
