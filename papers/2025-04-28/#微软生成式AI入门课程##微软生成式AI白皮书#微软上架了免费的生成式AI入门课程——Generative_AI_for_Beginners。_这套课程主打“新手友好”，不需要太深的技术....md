...
微软推出免费开源课程《Generative AI for Beginners》，包含21节零基础入门课，涵盖生成式AI原理到应用开发全流程。课程特点：无需技术背景、支持Python/TypeScript代码示例、配套视频和拓展资料，完成学习可申请OpenAI免费额度及Azure资源。内容包含Prompt工程、文本/图像生成应用开发、向量数据库、AI Agents等热门技术，并提供Discord交流社群。该项目已在GitHub获得8万+星标，适合初学者系统学习生成式AI技术。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T11:21:16Z
- **目录日期**: 2025-04-28
