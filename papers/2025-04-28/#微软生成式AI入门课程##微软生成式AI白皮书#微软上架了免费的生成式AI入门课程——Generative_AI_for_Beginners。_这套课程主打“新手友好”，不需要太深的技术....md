# #微软生成式AI入门课程##微软生成式AI白皮书#微软上架了免费的生成式AI入门课程——Generative AI for Beginners。 这套课程主打“新手友好”，不需要太深的技术...
...
微软推出免费开源课程《Generative AI for Beginners》，包含21节新手友好课程，涵盖生成式AI基础原理到应用开发全流程。课程特点包括：无需技术背景、提供Python/TypeScript代码示例、配套视频和拓展资料、可申请OpenAI免费额度及Azure资源、设有Discord交流社群。内容涉及Prompt工程、文本/图像生成应用开发、向量数据库、AI Agents等热门技术。该项目已在GitHub获得8万+星标，适合初学者系统学习生成式AI技术。课程官网和GitHub仓库链接已附。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T14:04:15Z
- **目录日期**: 2025-04-28
