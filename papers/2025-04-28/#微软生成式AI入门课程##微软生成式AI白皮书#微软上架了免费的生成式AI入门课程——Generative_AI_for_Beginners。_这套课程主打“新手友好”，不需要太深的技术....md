...
微软推出了免费开源的生成式AI入门课程《Generative AI for Beginners》，包含21节新手友好课程，涵盖从基础原理到实战开发全流程。课程特点包括：无需技术背景、提供Python/TypeScript代码示例、配套视频和拓展资料、可申请OpenAI免费额度，并有Discord交流社群。内容涉及Prompt工程、文本/图像生成应用开发、向量数据库、AI Agents等热门技术。该项目已在GitHub获得8万+星标，适合零基础学习者系统掌握生成式AI应用开发。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T13:18:27Z
- **目录日期**: 2025-04-28
