...
该研究提出了一个量化"可扩展监督"成功概率的框架，将监督建模为能力不匹配玩家间的博弈。研究者用修改版Nim游戏验证框架后，分析了四种监督博弈场景，发现领域表现与AI通用能力（以Chatbot Arena Elo为指标）存在缩放规律。进一步理论研究表明，在嵌套可扩展监督(NSO)中，当监督比基线强400 Elo的系统时成功率不足52%，且随系统变强继续下降。研究还推导了最大化监督成功率的最优监督层级数。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T19:00:56Z
- **目录日期**: 2025-04-28
