...
本文通过理论模型分析了拍卖中预筛选策略的经济合理性。研究发现，基于噪声预测器的预筛选相当于标准拍卖中竞标者估值的相关性，但不符合传统关联性假设。研究比较了全支付、第一价格和第二价格拍卖中的均衡策略条件，结果表明：全支付拍卖中预筛选能显著提高收入（完美预测时仅需2名竞标者即可实现最优），而第一价格和第二价格拍卖中允许所有竞标者参与仍是收入最大化的选择。该研究为拍卖设计者利用AI技术优化竞标者筛选提供了理论依据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T00:02:35Z
- **目录日期**: 2025-04-28
