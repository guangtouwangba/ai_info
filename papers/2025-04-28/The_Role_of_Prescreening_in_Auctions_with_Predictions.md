...
本文探讨了拍卖行通过预筛选（prescreening）策略选择高价值竞标者的经济合理性。研究发现，预筛选拍卖等同于标准拍卖中竞标者估值相关的情况，但传统关联性假设不成立。研究分析了全支付、第一价格和第二价格拍卖的均衡策略条件，结果显示：在全支付拍卖中，预筛选能显著提高收入（完美预测时仅需两名竞标者即可实现最优）；而在第一价格和第二价格拍卖中，允许所有竞标者参与仍是收入最大化的选择。这表明预筛选策略的效果高度依赖于拍卖机制类型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T01:29:54Z
- **目录日期**: 2025-04-28
