...
本文通过理论模型分析了拍卖方利用机器学习预筛选竞拍者的经济合理性。研究表明，基于噪声预测器的预筛选相当于标准拍卖中竞拍者估值的相关性变化，但不符合传统关联性假设。研究比较了全支付、第一价格和第二价格三种拍卖形式，发现预筛选能显著提升全支付拍卖的收益（完美预测时仅需两名竞拍者即可实现最优收益），但在第一价格和第二价格拍卖中，允许所有竞拍者参与仍是收益最大化的选择。这为拍卖设计中的选择性准入策略提供了理论依据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T02:31:22Z
- **目录日期**: 2025-04-28
