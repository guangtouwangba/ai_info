...
印度食品配送平台（如Swiggy和Zomato）为边缘群体提供重要收入，但也使劳动者陷入隐形劳动循环。通过对14名配送员的半结构化访谈，研究发现等待时间和重复性UI交互是造成"数字不适"的主要负担。尽管劳动者会采取策略应对算法管理，但仍受平台"游戏化"和系统不透明的限制。研究建议通过以劳动者为中心的GUI自动化来减少摩擦并保留自主权。最后，这篇立场论文主张在全球化南部的HCI设计中，应优先考虑劳动者自主性而非效率驱动的优化设计。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T02:30:43Z
- **目录日期**: 2025-04-28
