...
本研究探讨了通过传感器增强演示数据质量对机器人操作学习的影响。研究通过在挤压瓶上集成压力传感器，实现了液体分配任务的自动化数据收集。基于Transformer的策略在78%的情况下表现优于使用人类演示数据训练的策略。结果表明，仪器化不仅能实现可扩展的数据收集，还能提升策略性能，为开发通用机器人代理提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T04:01:24Z
- **目录日期**: 2025-04-28
