...
本研究探讨了传感器辅助如何提升机器人模仿学习的效果。通过在挤压瓶上安装压力传感器，实现了液体分装任务的自动化数据采集。实验表明，基于Transformer策略、使用自动采集数据训练的模型，在78%情况下优于人类演示数据训练的模型。研究证明，仪器化不仅能实现可扩展的数据收集，还能生成性能更优的策略，为开发通用机器人代理提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T22:01:21Z
- **目录日期**: 2025-04-28
