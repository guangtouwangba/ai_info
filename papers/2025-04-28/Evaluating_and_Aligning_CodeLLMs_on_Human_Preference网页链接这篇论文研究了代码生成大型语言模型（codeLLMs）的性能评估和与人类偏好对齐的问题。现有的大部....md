...
这篇论文探讨了代码生成大模型(codeLLMs)如何与人类偏好对齐的问题。研究者创建了CodeArena基准测试，包含397个高质量编程任务样本，覆盖40个类别和44种语言，更贴近实际开发场景。同时构建了SynCode-Instruct合成指令数据集(近200亿标记)来验证指令微调效果。实验发现，传统执行基准与CodeArena存在性能差异，且开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI)在人类偏好匹配上仍有显著差距，凸显了模型对齐的重要性。研究为提升代码LLMs的实际应用价值提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T20:05:57Z
- **目录日期**: 2025-04-28
