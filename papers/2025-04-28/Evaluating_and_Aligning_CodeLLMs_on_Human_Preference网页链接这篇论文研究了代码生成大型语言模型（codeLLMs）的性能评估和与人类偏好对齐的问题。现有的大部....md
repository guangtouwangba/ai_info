...
这篇论文提出了CodeArena基准测试和SynCode-Instruct数据集，用于评估代码生成大模型（codeLLMs）与人类偏好的对齐程度。研究发现现有基准过于侧重代码正确性而忽视实际偏好，通过收集397个涵盖40类编程任务的样本和构建20B标记的合成指令集，揭示了执行基准与人类评估间的差异。实验对比40多个模型显示，开源顶级模型（如Qwen2.5-Coder）与商业模型（如OpenAI o1）存在显著差距，强调了偏好对齐在代码生成中的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T14:06:09Z
- **目录日期**: 2025-04-28
