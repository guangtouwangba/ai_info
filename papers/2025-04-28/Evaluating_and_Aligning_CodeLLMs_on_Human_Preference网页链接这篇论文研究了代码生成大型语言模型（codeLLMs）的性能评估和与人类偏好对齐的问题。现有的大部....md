...
这篇论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，聚焦人类偏好对齐问题。研究者构建了包含397个高质量样本的评估集(覆盖40类任务和44种语言)，并开发了20B标记的合成指令数据集SynCode-Instruct。实验发现：1)传统执行基准与人类偏好存在差距；2)开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著。研究强调了对齐人类偏好在代码生成中的重要性，为提升LLMs的实际编程辅助能力提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T06:07:58Z
- **目录日期**: 2025-04-28
