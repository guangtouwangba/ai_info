...
这篇论文针对代码生成大模型(codeLLMs)与人类偏好对齐的问题，提出了CodeArena基准测试和SynCode-Instruct语料库。CodeArena包含397个高质量编程任务样本，覆盖40个类别和44种语言，更贴近实际开发需求；SynCode-Instruct则包含近200亿标记的合成指令数据。研究发现现有基于执行的评估与人类偏好存在差距，实验显示开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著，强调了模型对齐人类偏好的重要性。该研究为提升代码生成模型的实用性和用户体验提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T01:33:24Z
- **目录日期**: 2025-04-28
