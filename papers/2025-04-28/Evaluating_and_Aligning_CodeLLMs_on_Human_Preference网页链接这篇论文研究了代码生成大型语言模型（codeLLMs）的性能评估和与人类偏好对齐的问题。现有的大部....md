...
这篇论文针对代码生成大型语言模型(codeLLMs)与人类偏好对齐的问题，提出了CodeArena基准测试(包含397个高质量样本，覆盖40个类别和44种语言)和SynCode-Instruct语料库(近20B标记)。研究发现现有基于执行的测试与人类偏好存在差异，开源顶级模型(如Qwen2.5-Coder)与专有模型(如OpenAI o1)性能差距显著。研究强调了代码LLMs与人类偏好对齐的重要性，为评估和改进代码生成模型提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T16:06:03Z
- **目录日期**: 2025-04-28
