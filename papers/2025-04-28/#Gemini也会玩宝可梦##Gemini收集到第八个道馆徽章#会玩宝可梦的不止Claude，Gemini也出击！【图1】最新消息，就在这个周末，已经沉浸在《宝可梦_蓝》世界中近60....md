...
谷歌AI模型Gemini 2.5 Pro成功在《宝可梦蓝》游戏中收集到第八个道馆徽章，已游玩近600小时。工程师通过建立游戏接口连接模拟器，让AI能获取游戏画面和状态数据，经网格处理后发送给Gemini分析决策，形成"截图-分析-操作"的循环系统，并每100次动作进行记忆摘要优化。该项目灵感来自此前Claude玩宝可梦的实验，现可通过Twitch直播观看AI挑战四天王。这标志着AI在复杂游戏环境中展现出惊人的学习和适应能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T04:03:44Z
- **目录日期**: 2025-04-28
