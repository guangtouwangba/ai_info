...
Gemini 2.5 Pro成功在《宝可梦 蓝》中收集到第八个道馆徽章，耗时近600小时。一名软件工程师通过mGBA模拟器建立游戏接口，让Gemini能截取屏幕、发送指令并获取游戏数据。AI通过网格叠加处理截图和状态信息进行决策，每100次动作后摘要消息以减少token消耗。该项目灵感来自Claude玩宝可梦的挑战，现可通过Twitch直播围观AI挑战四天王。网友称赞这是AI领域的重大成就。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T03:20:35Z
- **目录日期**: 2025-04-28
