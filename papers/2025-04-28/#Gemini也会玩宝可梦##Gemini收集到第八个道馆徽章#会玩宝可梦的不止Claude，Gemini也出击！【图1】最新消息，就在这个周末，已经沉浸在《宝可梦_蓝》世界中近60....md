...
Gemini 2.5 Pro成功在《宝可梦 蓝》中收集到第八个道馆徽章，耗时近600小时。一名软件工程师通过mGBA模拟器建立游戏接口，让AI能获取游戏截图、状态数据并发送按键指令。系统循环执行：截图处理、AI决策、按键操作，并每100次动作摘要消息以节省资源。该项目灵感来自Claude玩宝可梦的尝试，现可通过Twitch直播观看AI挑战冠军之路。网友称赞这是AI领域的重大成就。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T07:15:03Z
- **目录日期**: 2025-04-28
