...
Gemini AI成功在《宝可梦 蓝》中收集到第八个道馆徽章，游戏时间近600小时。一名工程师通过mGBA模拟器建立游戏接口，让Gemini 2.5 Pro能截取屏幕、发送指令并分析游戏状态。系统循环执行截图、网格处理、AI决策和按键操作，每100次动作进行摘要以节省资源。该项目灵感来自Claude玩宝可梦的尝试，现可通过Twitch直播观看AI挑战四天王。网友称赞这是"AI迄今最大成就"。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T01:30:24Z
- **目录日期**: 2025-04-28
