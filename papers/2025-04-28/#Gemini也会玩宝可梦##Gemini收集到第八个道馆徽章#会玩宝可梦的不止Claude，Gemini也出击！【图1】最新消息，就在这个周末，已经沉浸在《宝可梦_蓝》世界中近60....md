...
谷歌AI模型Gemini 2.5 Pro成功在《宝可梦蓝》游戏中收集到第八个道馆徽章，累计游戏时长近600小时。该项目由工程师通过mGBA模拟器实现，系统会截取游戏画面并叠加网格辅助分析，由Gemini根据图像和内存数据做出决策，每100次动作进行摘要以节省算力。该实验灵感来自此前Claude玩宝可梦的项目，现可通过Twitch直播观看AI挑战四天王。网友戏称这是"AI领域最大成就"，展现了AI在复杂游戏中的决策能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T06:06:16Z
- **目录日期**: 2025-04-28
