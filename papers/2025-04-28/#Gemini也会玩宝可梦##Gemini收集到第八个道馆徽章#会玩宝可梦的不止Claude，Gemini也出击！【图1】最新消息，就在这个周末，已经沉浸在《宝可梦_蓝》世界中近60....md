...
谷歌AI模型Gemini 2.5 Pro成功在《宝可梦蓝》游戏中取得突破，经过近600小时游戏时长后收集到第八个道馆徽章。该实验由一位软件工程师设计，通过建立游戏模拟器接口让AI获取屏幕截图和游戏数据，经网格处理辅助决策，循环执行"截图-分析-操作"流程，并采用内存摘要技术优化token消耗。这一成果被视为AI在游戏领域的重大进展，目前Gemini正在挑战冠军之路，相关直播在Twitch平台持续进行。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T05:04:55Z
- **目录日期**: 2025-04-28
