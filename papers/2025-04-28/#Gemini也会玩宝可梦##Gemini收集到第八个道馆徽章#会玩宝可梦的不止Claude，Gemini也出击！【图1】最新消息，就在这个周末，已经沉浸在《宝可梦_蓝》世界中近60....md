...
谷歌AI模型Gemini 2.5 Pro成功在《宝可梦蓝》游戏中收集到第八个道馆徽章，已游玩近600小时。该系统通过mGBA模拟器接口实现游戏交互：截取画面、发送指令、获取数据，并利用网格叠加辅助AI决策。工程师设计了循环流程：截图分析→AI决策→执行操作→状态更新，每100次动作进行消息摘要以节省资源。该项目灵感来自Claude玩宝可梦的案例，现可通过Twitch直播观看AI挑战四天王。该实验展示了AI在复杂游戏环境中的学习与适应能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T00:03:06Z
- **目录日期**: 2025-04-28
