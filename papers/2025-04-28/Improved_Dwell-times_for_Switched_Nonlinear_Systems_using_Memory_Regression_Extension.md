...
本文提出了一种基于切换系统的方法，通过利用记忆回归扩展(MRE)技术来延长自主智能体在GPS失效环境中的持续运行时间。该方法通过周期性获取GPS信号来修正累积状态估计误差，从而在未知动态和环境干扰下保持精确轨迹跟踪。相比现有切换系统方法，MRE技术能在GPS可用时优化系统参数估计，实现更长的GPS失效运行时间且不损害闭环系统稳定性。李雅普诺夫稳定性分析证实了该方法的有效性，仿真结果验证了理论发现，显示出持续运行时间的延长和轨迹跟踪性能的提升。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T22:01:29Z
- **目录日期**: 2025-04-28
