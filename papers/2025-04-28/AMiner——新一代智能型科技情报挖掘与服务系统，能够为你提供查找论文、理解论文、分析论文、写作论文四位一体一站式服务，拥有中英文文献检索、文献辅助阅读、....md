...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、AI辅助阅读、自动摘要生成、翻译及科研情报订阅。平台覆盖42个学科，拥有3.5亿论文、0.6亿学者等海量数据，支持用户通过关键词或上传PDF快速获取文献核心内容，并定制个性化学术动态推送。其互动问答功能可深度解析论文，显著提升研究效率。基础功能免费开放，适用于学者、学生等科研人群。访问入口：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T17:05:13Z
- **目录日期**: 2025-04-28
