...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析和写作的一站式服务。它收录了3.5亿篇论文和1.5亿项专利，支持中英文文献检索、AI辅助阅读和自动摘要生成。用户可通过互动问答快速理解文献内容，或上传PDF获取章节概要和问题建议。平台还提供科研动态订阅服务，根据用户偏好推送最新学术资讯。此外，AMiner具备学者画像、学术会议和论文排行榜等功能，基础服务可免费使用。访问入口：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T00:06:05Z
- **目录日期**: 2025-04-28
