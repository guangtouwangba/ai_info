...
AMiner是一个智能科技情报挖掘平台，提供四位一体的学术服务：1）支持中英文文献检索，可快速定位相关论文并生成摘要；2）具备文献翻译功能，支持PDF上传和AI辅助阅读；3）提供科研情报订阅服务，按用户兴趣推送最新研究动态；4）额外功能包括学者画像、学术会议追踪等。平台收录3.5亿论文、0.6亿学者等海量数据，通过AI技术实现智能问答、文档解析等功能，帮助用户高效获取和理解学术信息。基础功能可免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T09:37:02Z
- **目录日期**: 2025-04-28
