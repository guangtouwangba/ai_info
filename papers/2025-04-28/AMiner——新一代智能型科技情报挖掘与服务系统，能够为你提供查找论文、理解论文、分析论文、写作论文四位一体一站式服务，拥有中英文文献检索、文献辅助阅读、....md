...
AMiner是一个智能科技情报挖掘平台，提供四位一体的学术服务：1）支持中英文文献检索，通过AI问答和自动摘要提升效率；2）具备文献翻译、文档解析和互动问答功能，辅助深度阅读；3）支持个性化科研情报订阅，自动推送最新研究成果；4）集成学者画像、学术会议等特色功能。平台覆盖42个学科的3.5亿论文、1.5亿专利等海量数据，提供浏览器免费访问（aminer.cn），帮助用户高效完成文献查找、理解、分析和写作全流程。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T22:05:30Z
- **目录日期**: 2025-04-28
