...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作的一站式服务。它拥有3.5亿论文、0.6亿学者等海量学术资源，支持中英文文献检索、AI辅助阅读、自动摘要生成和互动问答功能。用户可上传PDF或从平台获取文献，AI会快速生成摘要和章节概要。平台还提供科研动态订阅服务，根据用户偏好推送最新论文。其他功能包括学者画像、学术会议和论文排行榜等。AMiner浏览器版可免费使用，旨在提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T10:39:18Z
- **目录日期**: 2025-04-28
