# #格灵深瞳发布新亿级数据集##格林深瞳助力CLIP刷新SOTA#新的亿级大规模图文对数据集来了，CLIP达成新SOTA！格灵深瞳最新发布的高质量数据集RealSyn，不仅规模大...
...
格灵深瞳发布全新亿级图文数据集RealSyn，包含1亿组高质量图文对，每张图片关联多个真实/合成文本。该数据集经过严格过滤和语义平衡采样，提供15M/30M/100M三种规模版本。基于RealSyn训练的CLIP模型在多任务中刷新SOTA性能，展现出卓越的视觉语言表征能力。目前数据集已在Hugging Face平台开源，相关技术细节可通过微信文章获取。这一大规模优质数据集的发布将显著推动多模态学习领域发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T01:30:13Z
- **目录日期**: 2025-04-28
