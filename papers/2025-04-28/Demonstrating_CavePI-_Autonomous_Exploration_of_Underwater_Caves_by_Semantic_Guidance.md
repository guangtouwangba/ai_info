...
本文介绍了CavePI自主水下机器人（AUV）的系统设计与算法集成，用于水下洞穴的语义引导探索。该系统采用轻量级深度视觉感知模块实现环境语义理解，并结合鲁棒控制机制在复杂洞穴结构中导航。研究通过实地水下洞穴测试和ROS数字孪生仿真验证了其性能，证明该系统能在无GPS、特征稀缺及低能见度条件下实现可靠导航。该技术对水资源管理、水文地质学、考古学及海洋机器人领域具有重要意义。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T00:02:44Z
- **目录日期**: 2025-04-28
