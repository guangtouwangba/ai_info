...
本文介绍了CavePI自主水下机器人系统，用于水下洞穴探索。该系统结合视觉伺服框架与边缘AI技术，通过轻量级深度视觉感知模块实现环境语义理解，并采用鲁棒控制机制导航复杂洞穴结构。研究通过真实水下洞穴、泉眼实地测试及ROS数字孪生仿真验证了系统性能。结果表明，该系统能在缺乏特征、无GPS信号及低能见度条件下实现可靠导航，为水资源管理、水文地质学、考古学等领域提供了创新解决方案。硬件设计与算法集成的协同优化是确保系统在挑战性环境中稳定运行的关键。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T02:31:31Z
- **目录日期**: 2025-04-28
