...
本文介绍了CavePI水下自主机器人系统，该系统采用视觉伺服框架进行语义引导的水下洞穴探索。通过轻量级深度视觉感知模块实现环境语义理解，并结合鲁棒控制机制完成复杂洞穴导航。系统硬件和边缘AI设计针对水下GPS失效、特征匮乏和低能见度等挑战进行了优化。研究通过真实水下洞穴和泉眼现场测试，并在ROS仿真环境中验证了数字孪生模型。结果表明，该集成系统能在恶劣条件下实现可靠导航，对水资源管理、水文地质学和考古学等领域具有重要应用价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T03:19:10Z
- **目录日期**: 2025-04-28
