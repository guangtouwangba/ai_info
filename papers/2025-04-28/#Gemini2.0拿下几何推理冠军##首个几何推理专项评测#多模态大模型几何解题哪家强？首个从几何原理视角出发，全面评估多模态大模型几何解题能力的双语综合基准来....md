...
GeoSense首个几何推理专项评测显示，Gemini-2.0-Pro-Flash在148个几何原理的测评中表现最佳，Qwen-VL系列领跑开源模型。该评测覆盖1789道中英双语题目，从原理识别(GPI)、应用(GPA)到答案正确率(ACC)多维度评估。研究发现：模型规模越大推理能力越强，但平面几何（如相似三角形识别）仍是普遍短板；原理识别错误会显著降低解题准确率。评测指出，提升原理理解能力是优化多模态AI几何推理的关键。数据与评测代码已开源，由淘天集团未来生活实验室团队开发。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T20:03:35Z
- **目录日期**: 2025-04-28
