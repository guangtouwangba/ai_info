...
GeoSense是首个针对多模态大模型几何推理能力的双语评测基准，由淘天集团团队开发。该基准基于五层知识架构，涵盖148个几何原理和1789道题目，从几何原理识别(GPI)、应用(GPA)和答案正确率(ACC)三个维度评估。评测显示，Gemini-2.0-Pro-Flash表现最佳，开源模型中Qwen-VL系列表现突出。研究发现模型规模越大推理能力越强，但平面几何仍是共同短板，特别是在相似/全等三角形等原理识别上存在困难。团队指出提升原理识别能力是优化几何推理的关键方向。评测数据和代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T14:03:35Z
- **目录日期**: 2025-04-28
