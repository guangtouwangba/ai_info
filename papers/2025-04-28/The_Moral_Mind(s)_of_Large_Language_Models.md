...
该研究探讨了大语言模型（LLM）是否具有稳定的"道德思维"。通过对近40个主流LLM进行道德困境测试，发现每个主要供应商至少有一个模型表现出近似稳定的道德偏好，其行为似乎受潜在效用函数引导。大多数模型倾向于中性道德立场，但也存在显著差异：部分模型能灵活调整道德推理视角，而另一些则坚持更刚性的伦理立场。研究揭示了LLM道德推理的共同核心，同时提供了评估AI系统伦理一致性的新框架。这些发现为AI伦理对齐的基准测试提供了方法论支持。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T04:02:32Z
- **目录日期**: 2025-04-28
