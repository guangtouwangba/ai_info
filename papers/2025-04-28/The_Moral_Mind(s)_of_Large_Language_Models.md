...
该研究探讨了大语言模型（LLM）是否具有一致的道德偏好结构。通过揭示偏好理论工具测试近40个主流LLM模型，发现每个主要提供商的至少一个模型表现出近似稳定的道德偏好行为，似乎受潜在效用函数引导。多数模型呈现中性道德立场，但存在显著差异：部分模型能灵活切换道德视角，而另一些则坚持更固定的伦理框架。研究构建了基于偏好模式的相似性网络，揭示了LLM道德推理的共同核心与差异性，为评估AI系统的道德一致性和伦理对齐提供了新框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T13:16:48Z
- **目录日期**: 2025-04-28
