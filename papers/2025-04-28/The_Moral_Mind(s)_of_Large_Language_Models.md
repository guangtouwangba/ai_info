...
该研究探讨了大型语言模型（LLM）是否具有稳定的道德偏好结构。通过揭示性偏好理论工具对近40个主流LLM进行测试，发现每个主要提供商的至少一个模型表现出近似稳定的道德偏好，其决策行为符合效用函数引导。大多数模型的道德立场趋于中性，但存在显著差异：部分模型能灵活调整道德推理，而另一些则遵循更固定的伦理模式。研究揭示了LLM道德推理的共同核心，同时提供了评估模型道德一致性的新框架，为AI系统的伦理对齐基准建立了方法论基础。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T07:11:54Z
- **目录日期**: 2025-04-28
