...
该研究探讨了大语言模型（LLM）是否具有一致的道德偏好结构。通过揭示性偏好理论工具测试近40个主流LLM，发现至少每个主要提供商的模型都表现出近似稳定的道德偏好，其决策行为符合效用函数。多数模型倾向于中立道德立场，但存在差异：部分模型能灵活推理，而另一些则遵循更严格的伦理框架。研究构建了基于偏好模式的相似性网络，揭示了LLM道德推理的共同核心与显著差异，为评估AI系统的道德一致性和伦理对齐提供了新框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T15:02:23Z
- **目录日期**: 2025-04-28
