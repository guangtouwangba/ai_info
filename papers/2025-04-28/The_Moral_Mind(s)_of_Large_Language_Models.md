...
该研究探讨了大语言模型（LLM）是否具有一致的道德偏好结构。通过揭示偏好理论工具对近40个主流LLM进行测试，发现每个主要提供商的至少一个模型表现出近似稳定的道德偏好，其行为似乎受潜在效用函数引导。大多数模型的道德立场趋于中立，但也存在显著差异：部分模型能灵活切换伦理视角，而另一些则坚持更固定的道德框架。研究揭示了LLMs道德推理的共同核心，同时提供了评估AI系统伦理一致性的新框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T22:02:31Z
- **目录日期**: 2025-04-28
