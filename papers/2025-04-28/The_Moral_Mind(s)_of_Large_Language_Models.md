...
该研究探讨了大语言模型（LLM）是否具有一致的道德偏好结构。通过揭示偏好理论工具对近40个主流LLM进行测试，发现至少每个主要提供商的模型都表现出近似稳定的道德偏好，其决策行为符合潜在的效用函数。大多数模型倾向于中立道德立场，但存在显著差异：部分模型能灵活切换道德视角，而另一些则遵循更固定的伦理模式。研究揭示了LLM道德推理的共同核心，同时提供了评估AI系统伦理一致性的新框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T18:02:21Z
- **目录日期**: 2025-04-28
