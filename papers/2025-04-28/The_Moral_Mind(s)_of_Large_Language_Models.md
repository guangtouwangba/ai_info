...
该研究探讨了大型语言模型（LLM）是否具有一致的道德偏好结构。通过揭示偏好理论工具对近40个主流LLM进行测试，发现每个主要厂商至少有一个模型表现出稳定的道德偏好，类似于基于效用函数的决策。多数模型倾向于中立道德立场，但存在差异性：部分模型展现灵活推理能力，而另一些则遵循更僵化的伦理模式。研究揭示了LLM道德推理的共同核心，同时呈现显著差异，为评估AI系统的道德一致性和伦理对齐提供了新框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T10:36:06Z
- **目录日期**: 2025-04-28
