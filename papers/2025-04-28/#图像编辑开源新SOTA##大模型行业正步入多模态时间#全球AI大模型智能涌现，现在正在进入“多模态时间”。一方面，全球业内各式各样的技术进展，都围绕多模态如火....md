...
AI行业正加速进入多模态时代，阶跃星辰作为代表性企业，过去一个月密集发布三款多模态模型：Step1X-Edit（开源图像编辑）、Step-R1-V-Mini（多模态推理）和Step-Video-TI2V（开源图生视频），覆盖当前核心需求。其70%已发布模型为多模态，凸显向智能终端Agent落地的战略转向。这些开源工具既体现技术突破，也符合行业对多模态能力的迫切需求，推动AI从单一模态向视听融合的智能交互演进。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T13:18:37Z
- **目录日期**: 2025-04-28
