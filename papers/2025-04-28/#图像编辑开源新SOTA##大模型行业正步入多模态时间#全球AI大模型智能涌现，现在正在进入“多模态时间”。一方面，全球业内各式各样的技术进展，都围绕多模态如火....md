...
AI行业正加速进入多模态时代，技术发展和应用落地都聚焦多模态能力。阶跃星辰作为多模态领域的领先者，近期发布了三款开源模型：Step1X-Edit（图像编辑）、Step-R1-V-Mini（多模态推理）和Step-Video-TI2V（图生视频），覆盖核心需求方向。其中两款已开源，体现其技术实力和落地导向。目前阶跃70%的模型为多模态，并重点布局智能终端Agent，推动实际应用。这些进展反映了行业向多模态转型的趋势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T23:03:49Z
- **目录日期**: 2025-04-28
