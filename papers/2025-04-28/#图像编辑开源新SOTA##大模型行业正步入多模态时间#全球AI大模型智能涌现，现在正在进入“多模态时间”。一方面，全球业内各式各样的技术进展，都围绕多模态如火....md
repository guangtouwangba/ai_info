...
AI行业正加速进入多模态时代，技术发展和应用落地均聚焦多模态能力。阶跃星辰作为多模态领域代表，近期密集发布三款开源模型：Step1X-Edit（图像编辑）、Step-R1-V-Mini（多模态推理）和Step-Video-TI2V（图生视频），覆盖核心应用场景。其70%已发布模型为多模态，凸显向智能终端Agent落地的战略转型。这些开源工具既体现技术突破，也符合行业对多模态刚需的追逐趋势。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T09:32:21Z
- **目录日期**: 2025-04-28
