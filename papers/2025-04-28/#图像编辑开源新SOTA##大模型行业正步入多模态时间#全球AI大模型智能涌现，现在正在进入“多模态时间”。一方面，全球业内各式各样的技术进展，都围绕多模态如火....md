# #图像编辑开源新SOTA##大模型行业正步入多模态时间#全球AI大模型智能涌现，现在正在进入“多模态时间”。一方面，全球业内各式各样的技术进展，都围绕多模态如火...
...
AI行业正加速进入多模态时代，技术发展和应用落地都聚焦多模态能力。阶跃星辰作为多模态领域的领先者，近期密集发布了三款开源模型：Step1X-Edit（图像编辑）、Step-R1-V-Mini（多模态推理）和Step-Video-TI2V（图生视频），覆盖当前核心需求。其中两款已开源，展现其技术实力和落地导向。该公司70%的模型为多模态，并重点布局智能终端Agent，凸显其"应用型玩家"定位。这些进展反映了行业向多模态转型的大趋势，也展示了阶跃星辰在多模态竞赛中的领先地位。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T22:04:14Z
- **目录日期**: 2025-04-28
