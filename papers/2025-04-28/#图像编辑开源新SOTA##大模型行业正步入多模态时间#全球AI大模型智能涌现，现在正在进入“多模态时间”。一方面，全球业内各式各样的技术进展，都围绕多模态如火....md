...
全球AI大模型正加速进入多模态时代，技术发展和应用落地均聚焦多模态能力。阶跃星辰作为行业代表，近一个月密集发布3款多模态模型：开源的Step1X-Edit图像编辑模型和Step-Video-TI2V图生视频模型，以及Step-R1-V-Mini多模态推理模型，覆盖核心需求方向。其70%已发布模型为多模态，凸显向智能终端Agent落地的战略布局。这些进展既体现技术趋势，也反映了多模态已成为AI应用落地的关键支撑。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T15:04:08Z
- **目录日期**: 2025-04-28
