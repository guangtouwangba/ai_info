...
AI行业正加速进入多模态时代，技术发展和应用落地都聚焦多模态能力。阶跃星辰作为代表性企业，过去一个月密集发布三款多模态模型：Step1X-Edit（开源图像编辑）、Step-R1-V-Mini（多模态推理）和Step-Video-TI2V（开源图生视频），覆盖当前核心需求。其70%已发布模型为多模态，凸显向智能终端Agent落地的战略转向。这些开源且性能优异的模型，既体现了技术趋势，也强化了阶跃在多模态领域的领先地位。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T16:04:22Z
- **目录日期**: 2025-04-28
