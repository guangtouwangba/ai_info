...
本文研究了分布式多视图表示学习问题，探讨了在无显式协调下各代理应提取哪些必要且充分的特征以帮助解码器正确估计隐藏标签。作者从泛化误差角度出发，建立了基于相对熵的泛化界限，并提出了一种正则化方法。研究发现，数据依赖的高斯混合先验能带来良好性能，在单视图场景下优于现有VIB和CDVIB方法，并自然产生了加权注意力机制。对于多视图场景，采用高斯乘积混合作为联合先验会隐式鼓励代理提取冗余特征，这一发现具有反直觉性。实验验证了所提方法的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T10:35:17Z
- **目录日期**: 2025-04-28
