...
该研究探讨了分布式多视角表示学习问题，其中多个代理从各自视角独立提取特征，解码器通过整合所有特征估计隐藏标签。研究从泛化误差角度出发，提出了基于最小描述长度（MDL）的泛化界限，并设计了一种正则化方法。实验表明，数据依赖的高斯混合先验优于现有变分信息瓶颈（VIB）方法。单视角下，该方法自然衍生出加权注意力机制；多视角下，高斯乘积混合先验促使代理提取冗余特征，这一反直觉发现为多视角学习提供了新见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T19:01:21Z
- **目录日期**: 2025-04-28
