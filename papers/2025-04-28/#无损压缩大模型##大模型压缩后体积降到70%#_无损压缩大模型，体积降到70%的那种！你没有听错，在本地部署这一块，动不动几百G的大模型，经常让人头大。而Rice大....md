...
Rice大学和xMAD.ai团队开发的DFloat11框架实现了大模型的无损压缩，可将体积缩减至原模型的70%。以Llama-3.1-405B为例，模型从811.7GB压缩到551.22GB，仅需8张80GB GPU即可运行。该技术通过动态长度编码和优化GPU推理效率，在保持精度的同时提升推理速度最高达38.8倍。其核心是利用BFloat16的数据稀疏性，采用查找表和并行解压等技术实现高效压缩和解压。相比传统压缩方法，DFloat11专为部署设计，代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T02:33:01Z
- **目录日期**: 2025-04-28
