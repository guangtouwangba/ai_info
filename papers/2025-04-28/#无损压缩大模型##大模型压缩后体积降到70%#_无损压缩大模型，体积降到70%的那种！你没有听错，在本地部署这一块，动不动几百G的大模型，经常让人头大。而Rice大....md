...
Rice大学和xMAD.ai团队开发了DFloat11无损压缩框架，可将大模型体积压缩至70%且保持精度无损。以Llama-3.1-405B为例，模型从811.7GB缩减到551.22GB，8张80GB GPU即可运行。该技术通过优化BFloat16格式的动态编码（平均仅用2.6位）、GPU专用解压设计（查找表+并行解压），使推理速度提升最高38.8倍。相比传统压缩方法，DFloat11专为高效推理部署优化，代码已开源。论文和GitHub链接已提供。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T00:03:29Z
- **目录日期**: 2025-04-28
