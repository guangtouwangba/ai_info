...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个智能代理的社会互动（500万次交互）。该系统被用于研究四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，验证了该系统在捕捉人类行为机制方面的有效性。研究表明，AgentSociety能作为计算社会科学研究的创新平台，为传统研究方法（如调查和干预）提供补充，帮助学者和政策制定者深入理解社会问题成因并探索解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T04:05:19Z
- **目录日期**: 2025-04-28
