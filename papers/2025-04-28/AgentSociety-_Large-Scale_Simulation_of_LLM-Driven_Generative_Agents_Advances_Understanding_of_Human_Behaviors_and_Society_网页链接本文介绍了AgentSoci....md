...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟10,000多个智能代理及其500万次互动。该系统通过真实社会环境和强大模拟引擎，研究了四大社会问题：群体极化、信息传播、基本收入政策影响和自然灾害冲击。模拟结果与现实世界数据高度吻合，证明其能有效捕捉人类行为机制。这一工具为社会科学研究和政策制定提供了创新方法，可辅助传统研究方法（如调查和干预）深入分析社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T09:36:09Z
- **目录日期**: 2025-04-28
