...
本文提出了一种针对通用人工智能（AI）系统的概率风险评估（PRA）框架，借鉴核能、航天等高可靠性行业的成熟方法。该框架通过三个创新点系统评估AI风险：(1)基于AI系统特性（如能力、领域知识等）的面向方面危害分析；(2)采用双向分析和前瞻性技术的风险路径建模；(3)通过情景分解、参考尺度和追踪协议管理不确定性。该框架整合多种评估方法，生成可量化的绝对风险估计，并开发了配套工具包，帮助AI开发者、评估者和监管者生成风险报告卡。这一系统方法旨在应对AI快速发展带来的风险管理挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T17:00:58Z
- **目录日期**: 2025-04-28
