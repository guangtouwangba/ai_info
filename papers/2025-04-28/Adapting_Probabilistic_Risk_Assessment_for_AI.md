...
本文提出了一种针对通用人工智能(AI)系统的概率风险评估(PRA)框架，借鉴核能、航天等高可靠性行业的成熟方法，以应对AI快速发展带来的风险管理挑战。该框架通过三个关键创新：(1)基于AI系统特性(如能力、领域知识等)的面向方面危害分析；(2)采用双向分析和前瞻性技术的风险路径建模；(3)运用情景分解和参考尺度等方法管理不确定性。框架整合多种评估方法，生成可量化的绝对风险估计，并最终形成风险报告卡。研究者已将其实现为工作手册工具，供AI开发者、评估者和监管者使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T16:01:06Z
- **目录日期**: 2025-04-28
