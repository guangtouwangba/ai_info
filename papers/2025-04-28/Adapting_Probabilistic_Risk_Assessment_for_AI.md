...
本文提出了一种针对通用人工智能(AI)系统的概率风险评估(PRA)框架，以应对AI快速发展带来的潜在灾难性风险。该框架借鉴了核能、航天等高可靠性行业的评估技术，通过三个关键创新实现系统化风险评估：(1)基于AI系统特性(如能力、领域知识等)的面向方面危害分析；(2)采用双向分析和前瞻性技术的风险路径建模；(3)运用情景分解、参考尺度和明确追踪协议的不确定性管理。该框架整合多种评估方法，生成可量化的绝对风险估计，并开发了配套工具帮助AI开发者、评估者和监管者生成风险报告卡。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T11:18:08Z
- **目录日期**: 2025-04-28
