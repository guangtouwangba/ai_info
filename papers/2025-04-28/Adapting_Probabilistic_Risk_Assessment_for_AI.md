...
本文提出了一种针对通用人工智能(AI)系统的概率风险评估(PRA)框架，旨在解决当前AI风险评估方法的不足。该框架借鉴高可靠性行业(如核电、航天)的成熟技术，通过三个关键创新：(1)基于AI系统特性(能力、领域知识等)的面向方面危害分析；(2)采用双向分析和前瞻性技术的风险路径建模；(3)运用情景分解、参考尺度和明确追踪协议的不确定性管理方法。该框架整合多种评估方法，生成可比较的量化风险估计，并开发了配套工具，为AI开发者、评估者和监管者提供系统化的风险评估解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T08:10:44Z
- **目录日期**: 2025-04-28
