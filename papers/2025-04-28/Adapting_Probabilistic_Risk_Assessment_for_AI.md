...
本文提出了一种针对通用人工智能(AI)系统的概率风险评估(PRA)框架，旨在解决当前AI风险评估方法的不足。该框架借鉴了核能、航空航天等高可靠性行业的成熟技术，通过三个方面进行创新：(1)基于AI系统特性(如能力、领域知识等)的面向方面危害分析；(2)采用双向分析和前瞻性技术的风险路径建模；(3)运用情景分解、参考尺度和明确追踪协议的不确定性管理。该框架整合了多种评估方法，将证据转化为可比较的量化绝对风险估计，并开发了工作手册工具供开发者、评估者和监管者使用，以实现更系统化的AI风险评估。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T13:15:14Z
- **目录日期**: 2025-04-28
