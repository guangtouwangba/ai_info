...
本文提出了一种针对通用人工智能(AI)系统的概率风险评估(PRA)框架，借鉴核能、航天等高可靠性行业的成熟方法。该框架通过三个创新点系统评估AI风险：(1)基于AI系统特性(如能力、领域知识等)的面向方面危害分析；(2)采用双向分析和前瞻技术的风险路径建模；(3)运用情景分解、参考尺度和明确追踪协议的不确定性管理。框架整合多种评估方法，将证据转化为可量化的绝对风险估计，并生成风险报告卡。已开发为工作手册工具，供AI开发者、评估者和监管者使用，项目网站可获取。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T06:03:08Z
- **目录日期**: 2025-04-28
