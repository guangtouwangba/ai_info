...
本研究提出了一种新型集成贝叶斯推理(EBI)方法，通过贝叶斯估计整合多个小型语言模型(SLM)的判断，使其性能超越单个模型。实验表明，EBI在多种任务(包括日英双语能力评估和消费者画像分析)中表现优异，甚至整合负提升值模型也能提高整体性能。该方法为有限计算资源下构建高性能AI系统提供了新思路，并能有效利用性能较低的个体模型。研究基于现有的大模型评估、集成方法和开源模型利用等成果，探讨了该方法的创新性和重要意义。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-28T02:30:52Z
- **目录日期**: 2025-04-28
