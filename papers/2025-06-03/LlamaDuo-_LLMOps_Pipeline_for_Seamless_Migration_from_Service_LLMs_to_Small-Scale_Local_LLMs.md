...
这篇论文提出了"LlamaDuo"流程，旨在将云端大型语言模型(LLMs)的知识和能力迁移到本地可管理的小型模型上。该流程通过使用服务型LLM生成的合成数据对小模型进行微调，若性能不足则自动追加相似数据进行多轮优化，最终使小模型能在特定任务上达到或超越原LLM的表现。LlamaDuo解决了云LLM的运营依赖、隐私问题和联网需求等挑战，为受限环境下的AI部署提供了实用、可扩展的解决方案。实验证明其在多种下游任务中具有高效性、适应性和经济性。项目代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T00:02:37Z
- **目录日期**: 2025-06-03
