...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译和科研订阅服务。它覆盖42个学科，包含3.5亿论文、0.6亿学者等数据。主要功能包括：1）中英文文献检索，支持智能问答和自动摘要生成；2）英文文献翻译与辅助阅读，可上传PDF并获取AI生成的摘要和问题建议；3）定制化科研情报订阅，通过微信或邮件推送最新学术动态。此外还提供学者画像、学术会议等特色功能。平台免费开放使用，旨在提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T11:05:52Z
- **目录日期**: 2025-06-03
