...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析和写作一站式服务。它支持中英文文献搜索，能自动生成摘要并解答用户提问，提升研究效率。平台还具备文档翻译、辅助阅读功能，用户可上传PDF获取AI生成的概要。此外，AMiner提供科研动态订阅服务，按用户偏好推送最新论文摘要。收录3.5亿论文、0.6亿学者等海量数据，支持免费使用，网址：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T19:05:18Z
- **目录日期**: 2025-06-03
