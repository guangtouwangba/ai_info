...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、翻译、辅助阅读和写作支持。平台收录3.5亿论文、0.6亿学者和1.5亿专利，支持AI生成摘要、章节概要和智能问答。用户可订阅个性化科研动态，追踪机构、学者及关键词，通过微信或邮件接收最新资讯。此外，AMiner还提供学者画像、学术会议和论文排行榜等功能，基础检索服务免费开放。访问链接：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T01:33:29Z
- **目录日期**: 2025-06-03
