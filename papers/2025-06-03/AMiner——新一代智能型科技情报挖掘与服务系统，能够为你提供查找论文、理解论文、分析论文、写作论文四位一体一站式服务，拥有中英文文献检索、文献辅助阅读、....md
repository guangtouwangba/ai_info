...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索（3.5亿论文）、AI辅助阅读、自动摘要生成和翻译功能。其特色包含互动问答理解文献、科研动态订阅（通过微信/邮件推送）、学者画像分析及学术会议追踪。平台支持PDF上传智能解析，并能根据用户偏好（机构/学者/关键词）个性化推荐最新研究成果。基础功能免费开放，覆盖42个学科领域，整合论文、专利（1.5亿）和科研项目（2600万）数据，显著提升文献调研与论文写作效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T10:06:11Z
- **目录日期**: 2025-06-03
