...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献搜索，拥有3.5亿论文、0.6亿学者等海量数据，并能通过AI生成摘要和问答互动辅助理解。平台还提供文献翻译、科研动态订阅（按用户偏好推送最新成果）、学者画像等功能，支持PDF上传和交互式阅读。用户可通过网页或微信小程序免费使用，实现高效学术研究。核心优势包括智能摘要、个性化推荐和多语言支持，显著提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T18:05:49Z
- **目录日期**: 2025-06-03
