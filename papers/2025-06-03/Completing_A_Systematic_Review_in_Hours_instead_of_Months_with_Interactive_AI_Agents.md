...
系统综述（SRs）在医疗等高要求领域至关重要，但传统方法耗时且依赖专业知识。InsightAgent是一种基于大语言模型的交互式AI代理，通过语义分割文献库和多代理设计提升综述质量。它提供直观的可视化界面，让用户实时监控并反馈。用户研究表明，该工具将综述质量提升27.2%，达到人工写作的79.7%，用户满意度提高34.4%。使用InsightAgent后，医生仅需1.5小时即可完成高质量系统综述，大幅缩短传统数月的耗时。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T17:01:41Z
- **目录日期**: 2025-06-03
