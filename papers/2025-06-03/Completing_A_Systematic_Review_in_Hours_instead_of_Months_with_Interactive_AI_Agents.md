...
InsightAgent是一种基于大语言模型的人机交互AI系统，旨在优化耗时的系统性文献综述流程。它通过语义分割文献库，采用多智能体设计进行精准处理，显著提升综述质量。系统提供可视化界面，让用户（如医疗专家）实时监控并反馈，使综述质量提升27.2%，达到人工撰写质量的79.7%，用户满意度提高34.4%。使用该工具后，医生仅需1.5小时即可完成高质量综述，而传统方法需数月。研究经9位医学专家验证，证实其有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T18:01:43Z
- **目录日期**: 2025-06-03
