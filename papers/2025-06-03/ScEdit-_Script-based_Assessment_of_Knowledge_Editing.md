...
当前知识编辑（KE）研究虽受关注，但任务设计较为简单，现有评估框架下许多方法得分接近完美，却缺乏实际应用验证（如LLM智能体场景）。为此，本文提出新型脚本基准ScEdit，涵盖反事实和时序编辑，结合词级与文本级评估，将传统事实型（"What"类问题）评测扩展到行动型（"How"类问题）。实验表明，所有KE方法在现有指标上均表现下降，文本级评估面临挑战，揭示了该任务的复杂性。基准已开源：https://github.com/asdfo123/ScEdit。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T08:00:57Z
- **目录日期**: 2025-06-03
