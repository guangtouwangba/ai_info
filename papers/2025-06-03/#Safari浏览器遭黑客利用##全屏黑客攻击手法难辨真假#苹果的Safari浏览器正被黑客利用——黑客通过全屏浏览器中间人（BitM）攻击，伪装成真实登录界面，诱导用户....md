...
Safari浏览器正遭受新型全屏中间人攻击(BitM)。黑客通过伪造登录页面，利用Fullscreen API隐藏地址栏，诱导用户输入账号密码。相比Chrome/Firefox的明确全屏提示，Safari仅以易忽略的滑动动画作为警示，导致攻击成功率更高。该攻击已通过社交媒体广告等渠道传播，但苹果以"动画已足够提示"为由拒绝修复。安全团队建议用户登录时务必核对网址，勿轻信全屏界面。目前攻击主要针对Safari，但其他浏览器也存在类似风险。(98字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T09:03:57Z
- **目录日期**: 2025-06-03
