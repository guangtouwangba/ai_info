...
浙江大学、天津大学和微软亚洲研究院团队提出新框架Self-Braking Tuning(SBT)，解决大模型"过度思考"问题。该框架通过刹车信号机制、多任务微调等方法，让模型学会在适当时候停止推理。实验显示，SBT使模型输出减少62.8%，同时保持94.1%的准确率。团队还设计了推理效率比和过度推理标记比两个评估指标。项目已开源，可访问ZJU-REAL.github.io/SBT。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T14:04:30Z
- **目录日期**: 2025-06-03
