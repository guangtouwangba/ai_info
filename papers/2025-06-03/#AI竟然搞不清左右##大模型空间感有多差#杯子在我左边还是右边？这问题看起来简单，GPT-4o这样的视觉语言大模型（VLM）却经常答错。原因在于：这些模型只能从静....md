...
浙江大学、电子科技大学和香港中文大学联合开发了ViewSpatial-Bench基准测试，评估视觉语言大模型（VLM）的空间定位能力。研究发现，GPT-4o等主流模型在判断左右、视角转换等空间任务上表现不佳，准确率最低仅25%。模型更擅长处理第三人称信息，但难以从相机视角进行空间映射。该测试包含5700多个问答对，覆盖5种任务，揭示了VLM因依赖静态数据而导致的空间推理缺陷。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T03:24:08Z
- **目录日期**: 2025-06-03
