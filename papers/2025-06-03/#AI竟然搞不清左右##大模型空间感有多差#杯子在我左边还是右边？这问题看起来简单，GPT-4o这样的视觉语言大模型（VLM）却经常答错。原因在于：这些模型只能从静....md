...
浙江大学等机构研究发现，当前视觉语言大模型（如GPT-4o）的空间感知能力存在明显缺陷，难以准确判断"左右"等基础空间关系。研究团队推出ViewSpatial-Bench评测基准，通过5700多个问答对测试发现：模型在人物注视方向任务中准确率仅25%，GPT-4o最高仅36%；且模型更擅长第三人称视角而非相机视角的空间映射。这表明大模型仅通过静态图文学习难以建立真正的空间认知能力，多角度推理仍是技术瓶颈。该研究为提升AI空间智能提供了重要评估工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T00:02:49Z
- **目录日期**: 2025-06-03
