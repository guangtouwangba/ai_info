...
浙江大学等机构研究发现，当前视觉语言大模型（如GPT-4o）的空间感知能力存在显著缺陷。通过新开发的ViewSpatial-Bench基准测试（含5700多组问答），发现模型在判断物体左右位置、人物注视方向等任务中准确率极低（最低25%）。主要原因是模型仅通过静态图文学习空间关系，缺乏多视角推理能力，尤其不擅长从相机视角进行空间映射。测试显示，模型处理第三人称信息优于第一人称视角，暴露了空间智能的局限性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T04:07:52Z
- **目录日期**: 2025-06-03
