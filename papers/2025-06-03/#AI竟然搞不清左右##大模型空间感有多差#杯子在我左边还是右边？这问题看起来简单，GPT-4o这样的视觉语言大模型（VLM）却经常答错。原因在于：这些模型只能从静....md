...
浙江大学等机构研究发现，当前视觉语言大模型（如GPT-4o）的空间定位能力存在明显缺陷。通过新推出的ViewSpatial-Bench基准测试（含5700+问答对）发现，模型在判断左右位置、人物注视方向等任务中表现不佳，平均准确率仅25-36%。主要问题源于模型仅通过静态图文学习空间信息，导致多角度空间推理能力薄弱，且对相机视角的适应能力显著弱于第三人称视角。这表明AI的空间感知能力仍需突破性改进。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T01:30:30Z
- **目录日期**: 2025-06-03
