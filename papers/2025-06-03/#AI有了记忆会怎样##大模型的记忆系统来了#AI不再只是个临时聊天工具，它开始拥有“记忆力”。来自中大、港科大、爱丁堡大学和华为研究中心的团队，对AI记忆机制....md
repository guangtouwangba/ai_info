...
中大、港科大等团队最新研究系统梳理了AI记忆机制，指出大语言模型需要更完善的记忆系统来支持长期交互。研究从记忆表示（参数化记忆和上下文记忆）和操作（巩固、更新等6种核心功能）两个维度构建框架，使AI具备类似人类的记忆能力。参数化记忆存储内部知识但难更新，上下文记忆则更灵活可扩展。该研究为AI实现复杂记忆功能提供了理论基础，标志着大模型向更智能的方向发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T01:31:56Z
- **目录日期**: 2025-06-03
