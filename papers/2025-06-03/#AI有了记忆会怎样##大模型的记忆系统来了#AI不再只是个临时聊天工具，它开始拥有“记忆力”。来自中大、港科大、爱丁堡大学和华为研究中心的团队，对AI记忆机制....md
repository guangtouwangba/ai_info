...
这篇研究综述探讨了AI记忆系统的发展，指出大语言模型(LLMs)正朝着长期交互智能体演进，需要更复杂的记忆机制。研究团队从记忆表示(参数化记忆和上下文记忆)和记忆操作两个维度分析，定义了6种核心操作：巩固、更新、索引、遗忘、检索和压缩。参数化记忆存储内部知识但难更新，上下文记忆则更灵活，支持多模态内容。该研究为AI构建类人记忆能力提供了系统框架，使AI不再局限于临时对话，而能实现个性化、持续性的智能交互。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T02:34:02Z
- **目录日期**: 2025-06-03
