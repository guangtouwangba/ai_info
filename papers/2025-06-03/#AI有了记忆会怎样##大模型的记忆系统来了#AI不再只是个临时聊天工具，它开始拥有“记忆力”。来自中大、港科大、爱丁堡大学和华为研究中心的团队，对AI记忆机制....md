...
这篇研究综述探讨了大语言模型(LLMs)记忆系统的关键发展。研究团队提出了记忆的两个核心维度：参数化记忆(模型内部知识)和上下文记忆(显式信息)。围绕这些记忆类型，定义了6种基本操作：巩固、更新、索引、遗忘、检索和压缩。这些机制使AI能够处理跨轮对话、多模态输入和个性化偏好，推动LLMs向长期交互的智能体发展。该框架为理解AI记忆系统提供了统一视角，有助于开发更具适应性和解释性的AI记忆能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T00:04:35Z
- **目录日期**: 2025-06-03
