...
本文提出了一种受大脑皮层扩展启发的神经可塑性扩展方法（NE），以解决强化学习中的可塑性丧失问题。NE通过动态扩展网络规模（从初始小网络到完整维度），结合三个关键组件：基于潜在梯度的弹性拓扑生成、休眠神经元剪枝优化网络表达能力，以及通过经验回顾实现神经元整合，平衡可塑性与稳定性。实验表明，NE能有效缓解可塑性损失，在MuJoCo和DeepMind Control Suite任务中优于现有方法，使智能体在动态环境中更具适应性，推动深度学习从静态训练向持续适应模型的转变。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T21:03:02Z
- **目录日期**: 2025-06-03
