...
这篇论文介绍了VideoCAD，首个面向专业工程工具的大规模合成数据集，包含41K+标注的CAD操作视频，用于复杂UI交互学习。相比现有数据集，VideoCAD具有20倍更长的时间跨度和更高复杂度。研究展示了两个关键应用：1) 从专业3D CAD工具学习UI交互，提出了SOTA模型VideoCADFormer；2) 构建了评估多模态大语言模型空间推理能力的VQA基准。研究揭示了当前视频UI理解的关键挑战，包括精确动作定位、多模态空间推理和长时依赖等问题。该工作填补了专业工程领域AI交互学习的空白。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T00:01:52Z
- **目录日期**: 2025-06-03
