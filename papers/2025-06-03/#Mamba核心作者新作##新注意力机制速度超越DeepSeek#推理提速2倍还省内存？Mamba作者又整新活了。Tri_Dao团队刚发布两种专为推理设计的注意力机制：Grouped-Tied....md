...
Mamba核心作者Tri Dao团队发布两种新型注意力机制GTA和GLA，专为提升推理效率设计。实验显示：GTA在中大型模型中质量优于GQA；GLA与MLA精度相当但效率更高，在32K/64K长文本处理时吞吐量显著领先。新机制在保持生成质量的同时，实现2倍推理加速并降低内存消耗，尤其擅长处理长上下文和并发请求。测试涵盖4种模型规模，验证了其在困惑度、下游任务表现及KV缓存等方面的优势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T00:04:05Z
- **目录日期**: 2025-06-03
