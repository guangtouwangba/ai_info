...
Mamba核心作者Tri Dao团队发布两种新型注意力机制GTA和GLA，专为提升推理效率设计。实验显示，GTA在中大型模型质量优于GQA，GLA与MLA精度相当但效率更高。两种机制显著提升解码速度（最高提速2倍）和内存利用率，尤其在长上下文场景表现突出：GLA在32K/64K长文本吞吐量领先，并发处理能力更强。该技术适用于不均衡负载场景，在保持生成质量的同时优化了延迟、吞吐量和KV缓存量。研究成果有望替代现有注意力机制如DeepSeek采用的方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T02:33:34Z
- **目录日期**: 2025-06-03
