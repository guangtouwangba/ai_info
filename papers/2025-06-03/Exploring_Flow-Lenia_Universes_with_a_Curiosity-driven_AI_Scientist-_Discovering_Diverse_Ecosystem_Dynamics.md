...
本文提出了一种基于好奇心驱动AI科学家的自动化方法，用于发现Flow-Lenia（一种具有质量守恒和参数局部化的连续元胞自动机）中的系统级动力学。该方法通过多样性搜索算法和模拟范围指标（如进化活性、基于压缩的复杂性和多尺度熵）来探索大规模环境中相互作用的模式，相比随机搜索能发现更丰富的动力学行为。实验展示了生态系统模拟如何自组织出复杂集体行为，超越了以往个体模式搜索的范畴。该方法还结合了交互式探索工具，形成人机协作的科学工作流程，其框架可推广至其他参数化复杂系统的涌现特性研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T11:01:19Z
- **目录日期**: 2025-06-03
