...
大型语言模型(LLMs)依赖静态训练数据，易产生幻觉和知识过时问题。检索增强生成(RAG)通过整合外部动态信息改善事实准确性。随着多模态学习的发展，多模态RAG进一步融合文本、图像、音频和视频等多种模态以提升生成质量，但跨模态对齐和推理带来了新挑战。本文系统综述了多模态RAG的数据集、基准、评估指标、方法创新(检索/融合/增强/生成)、训练策略、鲁棒性增强、损失函数和基于代理的方法，并探讨了不同应用场景。最后指出开放挑战和未来方向，为开发更可靠的多模态AI系统奠定基础。相关资源已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T14:02:04Z
- **目录日期**: 2025-06-03
