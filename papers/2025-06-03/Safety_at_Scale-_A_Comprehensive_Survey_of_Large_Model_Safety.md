...
大型模型（如视觉基础模型、大语言模型、扩散模型等）凭借其强大的预训练学习与泛化能力，重塑了AI领域，广泛应用于对话、推荐、医疗等场景。然而，其部署也面临对抗攻击、数据投毒、越狱注入等安全威胁。本文系统梳理了当前模型安全研究：（1）分类总结了各类攻击方式；（2）归纳了防御策略与常用数据集；（3）指出开放性挑战，包括需建立全面评估体系、可扩展防御机制及可持续数据实践，并强调研究界与国际协作的重要性。该综述为开发综合防护系统提供了重要参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T10:02:13Z
- **目录日期**: 2025-06-03
