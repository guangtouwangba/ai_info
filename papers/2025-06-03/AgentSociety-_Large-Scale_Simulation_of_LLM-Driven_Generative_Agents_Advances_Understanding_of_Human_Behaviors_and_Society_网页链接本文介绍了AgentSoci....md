...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统模拟了1万多个AI代理在真实社会环境中的互动（500万次交互），用于研究社会现象如极化、信息传播、基本收入政策和自然灾害影响等。研究显示，模拟结果与现实世界数据高度吻合，验证了该系统捕捉人类行为机制的能力。AgentSociety可作为计算社会科学研究平台，为学者和政策制定者提供新的研究工具，补充传统方法如调查和实验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T09:05:59Z
- **目录日期**: 2025-06-03
