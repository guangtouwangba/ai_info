...
这篇论文介绍了AgentSociety，一个基于大型语言模型的大规模社会模拟器，能够模拟超过1万个代理的社会生活及500万次互动。研究者利用该平台研究了极化现象、信息传播、基本收入政策及外部冲击等四个社会问题。结果显示，模拟结果与现实世界实验吻合，验证了其在捕捉人类行为和社会机制方面的能力。AgentSociety展现了作为社会科学研究和政策制定工具的潜力，能够辅助传统研究方法，帮助理解社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T16:06:05Z
- **目录日期**: 2025-06-03
