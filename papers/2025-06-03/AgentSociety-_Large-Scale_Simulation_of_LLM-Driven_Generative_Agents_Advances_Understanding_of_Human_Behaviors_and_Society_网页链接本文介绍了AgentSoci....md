...
AgentSociety是一种基于大语言模型的大规模社会模拟器，可模拟1万多个代理的社会互动（500万次交互）。它通过真实社会环境和大规模模拟引擎，研究了四大社会问题：社会极化、刺激性信息传播、无条件基本收入政策影响及飓风等外部冲击。模拟结果与现实世界数据高度吻合，验证了其捕捉人类行为机制的能力。该系统可作为计算社会科学研究的补充工具，帮助分析社会问题的成因和模式，为研究者和政策制定者提供新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T00:05:42Z
- **目录日期**: 2025-06-03
