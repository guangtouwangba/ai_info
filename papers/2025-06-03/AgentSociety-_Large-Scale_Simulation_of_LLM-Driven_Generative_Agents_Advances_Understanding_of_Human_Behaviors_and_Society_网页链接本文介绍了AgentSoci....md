...
AgentSociety是一个基于大语言模型的大规模社会模拟器，能够模拟超过1万个代理及其500万次互动。研究者利用该平台研究了社会极化、信息传播、基本收入政策及自然灾害影响等社会问题。模拟结果与现实世界数据高度吻合，验证了其在捕捉人类行为机制方面的有效性。该工具为社会科学研究和政策制定提供了新的实验平台，有望辅助传统研究方法，深入分析社会问题的成因和潜在机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T15:05:36Z
- **目录日期**: 2025-06-03
