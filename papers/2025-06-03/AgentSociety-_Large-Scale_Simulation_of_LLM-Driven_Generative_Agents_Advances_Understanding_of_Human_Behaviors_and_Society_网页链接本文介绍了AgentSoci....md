...
AgentSociety是一个基于大型语言模型(LLM)的大规模社会模拟系统，可模拟1万多个智能代理及其500万次社会互动。该系统通过四个社会实验(社会极化、信息传播、基本收入政策、自然灾害影响)验证了其有效性，结果显示模拟结果与现实世界数据高度吻合。研究表明，AgentSociety能有效捕捉人类行为模式和社会机制，为社会科学研究和政策制定提供了强大的计算实验平台，可辅助传统研究方法(如调查、访谈)进行社会问题分析。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T07:05:47Z
- **目录日期**: 2025-06-03
