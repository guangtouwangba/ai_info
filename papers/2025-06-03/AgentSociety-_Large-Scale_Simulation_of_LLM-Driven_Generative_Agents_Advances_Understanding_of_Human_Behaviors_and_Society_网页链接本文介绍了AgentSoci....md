...
该论文介绍了AgentSociety，一个基于大型语言模型的大规模社会模拟器，可模拟1万多个代理及其500万次互动。研究者利用该平台研究了社会极化、信息传播、基本收入政策和自然灾害影响等社会问题。模拟结果与现实世界数据吻合，验证了该系统捕捉人类行为机制的能力，展示了其作为社会科学研究和政策制定工具的潜力。该系统结合了LLM驱动的代理、真实社会环境和大规模模拟引擎，为传统研究方法提供了补充。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T23:03:29Z
- **目录日期**: 2025-06-03
