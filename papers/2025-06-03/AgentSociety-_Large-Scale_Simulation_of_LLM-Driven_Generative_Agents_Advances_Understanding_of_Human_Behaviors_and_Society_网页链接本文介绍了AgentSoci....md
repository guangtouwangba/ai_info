...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理的社会互动（500万次交互）。该系统通过四个社会问题案例（社会极化、信息传播、基本收入政策、自然灾害影响）验证其有效性，模拟结果与现实数据高度吻合。研究表明，这种LLM驱动的模拟器能有效捕捉人类行为机制，可作为计算社会科学研究和政策制定的创新工具，补充传统调查和实验方法的不足。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T17:05:47Z
- **目录日期**: 2025-06-03
