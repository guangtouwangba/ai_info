...
本文提出了一种提高光热疗法（PT）和光声成像（PA）效率的方法，即开发近红外（NIR）多光子吸收光热分子或对比剂。这些新型材料可在生物组织透明性更好的NIR波段激发，实现高空间精度的局部控制。研究采用飞秒激光双光子激发模型有机金属化合物，并利用时域布里渊散射技术测定其非线性吸收系数，该系数直接关联PT/PA效应。该方法为探索和优化非线性PT/PA吸收剂及对比剂提供了实用途径，有助于推动多光子激发下光热与光声效应的表征技术发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T04:05:55Z
- **目录日期**: 2025-06-03
