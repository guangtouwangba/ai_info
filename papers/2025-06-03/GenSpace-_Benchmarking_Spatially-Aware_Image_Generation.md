...
GenSpace是一个评估AI图像生成模型3D空间感知能力的新基准和流程。研究发现，尽管现有模型能生成视觉吸引人的图像并遵循一般指令，但在3D空间细节（如物体位置、关系和尺寸）上仍有不足。研究提出了专用评估流程和指标，通过多视觉基础模型重建3D场景几何，提供更准确的空间保真度度量。研究总结了当前最先进图像生成模型在空间感知上的三个核心局限：1)物体视角理解，2)自我中心-他中心视角转换，3)度量尺寸遵循，为改进空间智能指明了方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T00:01:33Z
- **目录日期**: 2025-06-03
