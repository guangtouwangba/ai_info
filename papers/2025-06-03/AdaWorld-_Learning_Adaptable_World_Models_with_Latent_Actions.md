...
AdaWorld是一种创新的世界模型学习方法，通过自监督方式从视频中提取潜在动作信息，捕捉帧间关键变化，并构建基于这些潜在动作的自回归世界模型。该方法减少了传统模型对大量动作标注数据和昂贵训练的依赖，使其能通过有限交互快速适应新环境中的异构动作。实验表明，AdaWorld在模拟质量和视觉规划方面表现优异，支持高效迁移和新动作学习，提升了跨领域适用性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T12:01:49Z
- **目录日期**: 2025-06-03
