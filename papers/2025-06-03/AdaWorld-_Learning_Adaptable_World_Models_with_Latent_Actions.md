...
AdaWorld是一种创新的世界模型学习方法，通过自监督方式从视频中提取潜在动作，捕捉帧间关键变化，并构建基于这些潜在动作的自回归世界模型。相比依赖大量动作标记数据的传统方法，AdaWorld能在有限交互和微调下高效适应新环境中的异构动作。实验表明，AdaWorld在模拟质量和视觉规划方面表现优异，实现了更好的跨领域适应性和迁移学习能力。该方法解决了现有世界模型对新环境适应成本高的问题，为智能体开发提供了更高效的解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T13:11:58Z
- **目录日期**: 2025-06-03
