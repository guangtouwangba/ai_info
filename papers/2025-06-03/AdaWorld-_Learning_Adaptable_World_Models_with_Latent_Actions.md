...
AdaWorld是一种创新的世界模型学习方法，通过自监督方式从视频中提取潜在动作信息，捕捉关键帧间转换，并构建基于这些潜在动作的自回归世界模型。该方法减少了传统模型对大量动作标记数据和昂贵训练的依赖，使其能在有限交互和微调下快速适应新环境中的异构动作。实验表明，AdaWorld在模拟质量和视觉规划方面表现优异，显著提升了跨领域适应能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T18:01:59Z
- **目录日期**: 2025-06-03
