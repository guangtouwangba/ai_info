...
3MDBench是一个开源框架，用于评估大型视觉语言模型(LVLMs)在远程医疗咨询中的表现。它通过4种性格类型的患者代理和评估代理，模拟3013个真实病例(涵盖34种诊断)，结合文本和图像数据测试模型的诊断准确性和对话质量。实验比较了GPT-4o-mini等主流LVLMs，发现多模态对话结合内部推理可使F1分数提升6.5%，而融入卷积网络的诊断预测更能显著提升20%的F1值。该研究强调了情境感知和信息寻求式提问在医疗对话中的重要性。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T06:01:24Z
- **目录日期**: 2025-06-03
