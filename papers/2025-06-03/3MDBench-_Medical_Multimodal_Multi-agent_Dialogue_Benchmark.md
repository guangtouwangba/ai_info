...
3MDBench是一个开源框架，用于评估大型视觉语言模型(LVLM)在远程医疗咨询中的表现。该框架通过4种性格类型的患者代理和评估代理，模拟真实场景中的3013个病例(覆盖34种诊断)，结合文本和图像数据。实验比较了GPT-4o-mini等主流LVLM的诊断策略，发现多模态对话结合内部推理可使F1分数提升6.5%，而将卷积网络的预测结果融入LVLM上下文更能使F1分数提升达20%。研究表明，情境感知的信息寻求式提问能显著提升诊断准确性。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T02:31:11Z
- **目录日期**: 2025-06-03
