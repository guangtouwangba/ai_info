...
研究者提出了Agent-X，一个用于评估视觉中心智能体多步深度推理能力的大规模基准测试。该基准包含828个真实视觉场景任务，涵盖图像、视频、多图对比和文本指令，涉及6大领域：通用视觉推理、网页浏览、安防监控、自动驾驶、体育和数学推理。Agent-X要求智能体在多样化场景中结合工具使用进行逐步决策，并提供了细粒度的分步评估框架。测试显示，包括GPT、Gemini和Qwen在内的顶尖模型在多步视觉任务中表现不佳，完整任务成功率不足50%，揭示了当前模型在推理和工具使用能力上的瓶颈。数据和代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T00:01:23Z
- **目录日期**: 2025-06-03
