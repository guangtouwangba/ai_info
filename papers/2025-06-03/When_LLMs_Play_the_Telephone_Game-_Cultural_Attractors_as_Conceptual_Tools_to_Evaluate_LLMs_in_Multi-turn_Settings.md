...
该研究探讨了大型语言模型（LLM）在迭代交互中的信息演变问题。通过类似"传话游戏"的实验设计，研究者发现：单个LLM输出中微小的偏差会在多次传递中被放大，导致文本内容向特定"吸引状态"演化。实验追踪了文本毒性、积极性、难度和长度等属性的变化，发现开放性指令会强化吸引效应，不同属性对吸引效应的敏感度也不同（如毒性比长度更易受影响）。研究揭示了多步传递动态的重要性，为理解LLM的文化演化机制提供了初步见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T05:02:34Z
- **目录日期**: 2025-06-03
