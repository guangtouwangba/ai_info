...
Diff-VLA是一种新型的端到端自动驾驶方法，通过结合稀疏-稠密扩散策略和视觉语言模型(VLM)来解决现有方法的局限性。该方法利用稀疏扩散表示实现高效的多模态驾驶行为，并通过VLM与地图实例、智能体的深度交互优化轨迹生成。相比传统方法，Diff-VLA避免了昂贵的鸟瞰图计算，提升了复杂场景下的决策能力。在2025年自动驾驶挑战赛中，该方法在真实和合成反应场景中表现出色，达到了45.0 PDMS的优异性能，展示了端到端范式在整合感知、预测和规划任务方面的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T09:01:31Z
- **目录日期**: 2025-06-03
