...
AI领域正探索"反向计算"（Uncomputation）这一节能新路径。该技术源于1961年IBM物理学家Landauer的理论：删除数据会发热耗能。其同事Bennett提出通过反向运行计算过程来保留数据并减少能耗，但因耗时双倍长期未被重视。随着芯片技术逼近极限，剑桥大学研究显示低速可逆计算可显著降低发热，尤其适合并行结构的AI计算。初创公司Vaire Computing正推进该技术商业化，有望解决AI高能耗问题。这一沉寂数十年的理论或将迎来实际应用突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T09:03:21Z
- **目录日期**: 2025-06-03
