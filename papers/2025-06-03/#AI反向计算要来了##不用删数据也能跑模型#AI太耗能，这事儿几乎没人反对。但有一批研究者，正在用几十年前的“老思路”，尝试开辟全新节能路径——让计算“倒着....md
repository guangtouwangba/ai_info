...
AI节能新突破：可逆计算技术有望解决AI高能耗问题。传统计算因删除数据产生热量，而IBM物理学家Landauer提出的理论指出这是物理定律。后来Bennett提出"反向计算"（Uncomputation）方案，通过恢复中间数据来节能，但效率较低。随着芯片技术接近极限，剑桥大学研究显示可逆计算在慢速运行时能显著降低能耗，尤其适合并行计算的AI领域。初创公司Vaire Computing正推动该技术商业化，可能实现高密度低发热的AI芯片布局。这一沉寂数十年的理论即将迎来实际应用突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T21:03:53Z
- **目录日期**: 2025-06-03
