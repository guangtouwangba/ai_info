...
AI领域正探索"可逆计算"这一节能新路径。传统计算因删除数据产生热量，而可逆计算通过反向运行保留原始数据，减少能耗。虽然该方法耗时翻倍且长期未被重视，但随着芯片技术接近极限，其优势显现：特别适合AI并行计算，能降低发热、节省空间和散热成本。剑桥大学研究者已证明慢速可逆计算可大幅节能，相关初创公司正在推进商业化。这一源自1960年代的理论，如今有望在AI时代实现突破性应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T20:03:20Z
- **目录日期**: 2025-06-03
