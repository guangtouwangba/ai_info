...
研究人员正探索"可逆计算"来降低AI能耗。传统计算删除数据会产生热量，而可逆计算通过反向运行保留原始数据，减少能量损耗。虽然该方法速度较慢，但适合AI并行计算，能显著降低发热和能耗。随着芯片技术接近极限，剑桥大学团队已成立公司推进商业化。这可能是解决AI高能耗问题的突破性方案，有望实现密集低热芯片布局。几十年的理论即将落地，被专家称为该领域最令人期待的进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T12:03:24Z
- **目录日期**: 2025-06-03
