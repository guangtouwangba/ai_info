...
AI节能新突破：可逆计算技术有望降低能耗。传统计算因删除数据产生热量，而可逆计算（Uncomputation）通过反向运行保留数据，减少能量损耗。尽管早期因速度慢难以落地，但随着芯片技术接近极限，该技术重新受到关注。剑桥大学研究显示，慢速可逆计算可大幅降低发热，尤其适合AI领域：并行计算不依赖速度，多芯片慢速运行更节能，且低发热允许密集布置。初创公司Vaire Computing正推动商业化，可能成为AI能效问题的关键解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T16:03:59Z
- **目录日期**: 2025-06-03
