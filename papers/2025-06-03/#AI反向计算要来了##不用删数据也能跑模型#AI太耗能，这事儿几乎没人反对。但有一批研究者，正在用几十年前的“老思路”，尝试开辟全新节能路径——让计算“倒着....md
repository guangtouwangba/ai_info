...
AI能耗问题催生了"可逆计算"新思路：通过反向运行计算过程保留原始数据，避免信息删除导致的能量损耗（Landauer原理）。该理论由IBM学者提出，MIT曾尝试硬件实现但被搁置。随着芯片逼近物理极限，剑桥团队发现慢速可逆计算可显著降低AI能耗，其并行特性尤其适合多芯片部署，能节省散热成本。初创公司Vaire Computing正推动该技术商业化，或将成为AI节能的重要突破。这项酝酿60年的理论有望迎来实际应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T17:03:49Z
- **目录日期**: 2025-06-03
