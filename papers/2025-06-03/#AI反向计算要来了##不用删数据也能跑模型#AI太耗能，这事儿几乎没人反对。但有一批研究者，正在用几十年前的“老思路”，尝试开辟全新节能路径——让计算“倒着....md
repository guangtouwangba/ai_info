...
研究人员正在探索"可逆计算"这一节能新路径。传统计算会因删除数据产生热量，而可逆计算通过反向运行保留中间数据实现节能。虽然该方法需要双倍时间，但在AI领域具有优势：并行计算对速度要求不高，多芯片慢速运行反而更节能，且低发热允许密集布置。随着传统芯片接近极限，剑桥大学团队已成立公司推进商业化。这项始于1960年代的理论，如今有望在AI时代实现突破，被专家称为"最令人兴奋的进展"。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T23:01:33Z
- **目录日期**: 2025-06-03
