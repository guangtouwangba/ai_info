...
这篇论文提出了CodeArena基准测试和SynCode-Instruct数据集，用于评估代码生成大语言模型(codeLLMs)与人类偏好的对齐程度。研究发现现有基准过于关注代码正确性而忽视人类偏好，因此构建了包含397个多样化编程任务的CodeArena，并创建了近200亿标记的合成指令数据集。实验显示，基于执行的测试与人类偏好评估存在差异，且开源模型(如Qwen2.5-Coder)与专有模型(如OpenAI o1)性能差距显著，凸显了人类偏好对齐的重要性。该研究为改进代码LLMs提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T00:06:29Z
- **目录日期**: 2025-06-03
