...
这篇论文针对代码生成大模型(codeLLMs)提出两个创新：1)构建CodeArena基准测试(397个样本/44种语言)，首次评估模型输出与人类偏好的匹配度；2)开发20B标记的SynCode-Instruct合成指令集验证微调效果。研究发现传统执行测试与人类偏好存在显著差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)在人类对齐方面差距明显。研究强调代码生成质量需兼顾功能正确性和开发者体验，为模型优化提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-03T18:05:58Z
- **目录日期**: 2025-06-03
