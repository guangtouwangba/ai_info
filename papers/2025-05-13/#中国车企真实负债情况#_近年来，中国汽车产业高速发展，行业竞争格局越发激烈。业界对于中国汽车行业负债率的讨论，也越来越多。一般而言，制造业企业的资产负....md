...
中国车企的负债情况分析显示，虽然资产负债率普遍高于制造业平均水平（60%以上，部分超过80%），但与国际车企水平相当。行业特性（产业链长、金融化程度高）导致负债率天然较高。关键点在于：1）中国车企负债结构更健康；2）供应链稳定性持续增强。财报数据表明，当前负债率属于合理范围，反映的是行业扩张需求而非财务风险。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T05:03:45Z
- **目录日期**: 2025-05-13
