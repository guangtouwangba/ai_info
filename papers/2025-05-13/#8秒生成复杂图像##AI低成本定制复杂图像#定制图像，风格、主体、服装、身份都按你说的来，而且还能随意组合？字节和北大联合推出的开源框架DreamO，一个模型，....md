...
字节跳动与北京大学联合推出开源框架DreamO，可在8-10秒内生成高质量定制图像。该模型仅需400M参数，支持多条件组合控制（如风格、主体、服装等），并保持良好的一致性和图像质量。基于Flux模型改进，DreamO能高效处理复杂需求如多主体构图和虚拟试衣，实现低成本AI图像定制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T01:30:42Z
- **目录日期**: 2025-05-13
