...
字节与北大联合推出开源AI框架DreamO，能低成本高效生成复杂定制图像。该模型仅400M参数，8-10秒即可输出图像，支持多条件组合控制（如风格、主体、服装等），保持良好一致性和图像质量。基于Flux模型改进，DreamO特别擅长处理多主体、虚拟试衣等复杂场景，同时有效保留参考图像信息。其高效率、强可控性为AI图像生成提供了新解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T00:03:16Z
- **目录日期**: 2025-05-13
