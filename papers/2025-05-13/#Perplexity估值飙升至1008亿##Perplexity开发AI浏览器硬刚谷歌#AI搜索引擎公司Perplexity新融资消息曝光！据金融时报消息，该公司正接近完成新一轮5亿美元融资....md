...
AI搜索引擎公司Perplexity估值飙升至140亿美元（约1008亿人民币），正完成5亿美元融资用于开发AI浏览器Comet，直接挑战谷歌Chrome。其估值半年翻3倍，年收入达1.2亿美元。该公司以"替代传统搜索引擎"为口号，宣称Comet将提供更精准的搜索体验。但面临谷歌、苹果等巨头的反扑，以及OpenAI、Anthropic等AI公司的竞争压力。本轮融资将用于技术研发和市场扩展，巩固其AI领域优势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T15:04:28Z
- **目录日期**: 2025-05-13
