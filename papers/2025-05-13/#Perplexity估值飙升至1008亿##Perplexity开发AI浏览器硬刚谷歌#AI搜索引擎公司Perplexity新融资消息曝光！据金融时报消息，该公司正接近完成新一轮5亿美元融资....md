...
AI搜索引擎公司Perplexity估值飙升至140亿美元（约1008亿人民币），正进行5亿美元新一轮融资，资金将用于开发AI浏览器Comet挑战谷歌Chrome。其估值半年内从30亿涨至90亿，现又增长超50%。年度收入达1.2亿美元。Perplexity以"替代传统搜索引擎"为口号，但面临谷歌、OpenAI等激烈竞争。谷歌已新增AI搜索功能，OpenAI和Anthropic也推出AI搜索产品。Perplexity计划通过技术研发巩固竞争优势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T20:04:00Z
- **目录日期**: 2025-05-13
