...
AI搜索引擎公司Perplexity估值飙升至140亿美元（约1008亿人民币），正进行5亿美元新一轮融资，资金将用于开发AI浏览器Comet挑战谷歌Chrome。其估值半年内从30亿增至90亿，现又涨超50%。年度收入达1.2亿美元。Perplexity以"替代传统搜索引擎"为口号，直面谷歌、苹果竞争，同时面临OpenAI、Anthropic等AI公司的搜索产品挑战。该融资将助力技术研发与市场扩张，巩固其AI领域优势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T16:04:18Z
- **目录日期**: 2025-05-13
