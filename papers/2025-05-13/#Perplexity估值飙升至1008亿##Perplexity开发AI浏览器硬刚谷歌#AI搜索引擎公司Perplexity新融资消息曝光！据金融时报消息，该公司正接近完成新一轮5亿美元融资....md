...
AI搜索引擎公司Perplexity估值飙升至140亿美元（约1008亿人民币），正进行5亿美元融资，资金将用于开发AI浏览器Comet挑战谷歌Chrome。其估值半年内从30亿涨至140亿，年收入达1.2亿美元。Perplexity以"替代传统搜索引擎"为口号，直面谷歌、苹果竞争，同时面临OpenAI、Anthropic等AI公司的搜索产品挑战。本轮融资由Accel领投，将用于技术研发和市场扩展。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T10:03:11Z
- **目录日期**: 2025-05-13
