...
本文提出了一种加权广义符合测试鞅(WCTM)方法，用于高风险AI/ML系统的持续部署后监控。该方法突破了现有非参数变点检测技术的局限，能够在线监控数据分布中的任何异常变化并控制误报率。具体算法可在线适应轻度协变量偏移，同时快速检测和诊断更严重的概念偏移或极端协变量偏移。相比现有最优方法，该方案在真实数据集上表现出更优性能，为AI系统可靠性监控提供了理论基础和实用工具，支持根因分析，有助于确保高风险场景下AI系统的安全运行。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T03:20:40Z
- **目录日期**: 2025-05-13
