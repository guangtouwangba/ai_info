...
本文提出了一种加权泛化的共形测试鞅(WCTM)方法，用于高风险AI/ML系统的持续部署后监控。该方法突破了现有非参数变点检测技术的限制，能在线监控数据分布中的任何异常变化并控制误报。WCTM不仅支持在线适应轻度协变量偏移，还能快速检测和诊断更严重的概念偏移或极端协变量偏移。相比现有方法，WCTM扩展了监控范围，允许在线自适应调整，并支持性能下降的根因分析。实验表明，该方法在真实数据集上的表现优于当前最先进的基线方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T12:02:42Z
- **目录日期**: 2025-05-13
