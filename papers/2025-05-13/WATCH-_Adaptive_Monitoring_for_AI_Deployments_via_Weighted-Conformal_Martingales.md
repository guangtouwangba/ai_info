...
本文提出了一种加权广义共形测试鞅（WCTM）方法，用于高风险AI/ML系统的持续部署后监控。该方法扩展了传统非参数变点检测的范围，能在线适应轻度协变量偏移，同时快速检测更严重的概念偏移或极端协变量偏移，并控制误报率。相比现有方法，WCTM支持更广泛的假设类别监控，允许在线自适应调整，并能进行性能退化的根因分析。实验表明，该方法在真实数据集上优于现有最优基线，为AI系统可靠性监控提供了更强大的理论框架和实用工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T23:02:20Z
- **目录日期**: 2025-05-13
