...
本文提出了一种加权广义符合性测试鞅(WCTM)方法，用于高风险AI/ML系统的持续部署后监控。该方法扩展了现有非参数变点检测技术的应用范围，能在线监控数据分布中的任何异常变化并控制误报率。针对实际应用，研究设计了特定WCTM算法，可在线适应轻度协变量偏移，同时快速检测更严重的概念偏移或极端协变量偏移。相比现有方法，WCTM不仅能监控更广泛的假设类别，还支持在线自适应和根本原因分析。在真实数据集上的实验表明，该方法优于当前最先进的基线方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T16:02:44Z
- **目录日期**: 2025-05-13
