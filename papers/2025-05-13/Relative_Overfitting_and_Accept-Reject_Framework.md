...
当前大语言模型(LLM)的扩展法则面临瓶颈，研究发现信号噪声比变化导致的噪声效应是主因。论文提出"相对过拟合"概念，并开发了接受-拒绝(AR)框架，利用小语言模型(SLM)对LLM决策产生普遍正向影响。实验表明，相比增加LLM参数，该框架能以更低成本在多场景中获得稳定有效的性能提升。研究还探讨了该方法在计算机视觉和科学AI等领域的潜力，有望帮助扩展法则突破现有瓶颈。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T04:02:15Z
- **目录日期**: 2025-05-13
