...
当前大语言模型(LLM)的扩展规律面临瓶颈，本文认为边际收益递减下信噪比变化导致的噪声效应是主因。研究者提出"相对过拟合"概念，并基于此开发了接受-拒绝(AR)框架，利用小语言模型(SLM)对LLM决策产生普遍正向影响。实验表明，相比增加LLM参数，该框架能以更低成本获得更优性能，且改进具有普适性和稳定性。该方法在CV和AI科研等领域也展现出潜力，有望帮助扩展规律突破现有瓶颈。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T15:01:30Z
- **目录日期**: 2025-05-13
