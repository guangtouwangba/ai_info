...
当前大语言模型(LLM)的扩展规律面临瓶颈。研究发现，边际收益递减下信噪比变化导致的噪声效应是主因。为此提出"相对过拟合"概念和接受-拒绝(AR)框架，利用小语言模型(SLM)对LLM决策产生普遍正向影响。实验表明，相比增加LLM参数，该框架能以更低成本实现更优性能，且改进具有普适性和稳定性。研究还探讨了该方法在计算机视觉和科学AI等领域的潜力，有望帮助扩展规律突破现有瓶颈。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T17:01:23Z
- **目录日期**: 2025-05-13
