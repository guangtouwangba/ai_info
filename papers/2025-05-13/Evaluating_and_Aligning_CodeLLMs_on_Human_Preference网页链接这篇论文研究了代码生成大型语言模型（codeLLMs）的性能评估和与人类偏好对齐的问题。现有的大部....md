...
该研究针对代码生成大模型(codeLLMs)提出CodeArena基准测试，聚焦人类偏好对齐问题。通过收集397个高质量编程任务样本(覆盖40类/44种语言)，构建SynCode-Instruct合成指令库(20B标记)，评估发现：1)传统执行基准与人类偏好存在差异；2)开源模型(Qwen2.5-Coder)与商业模型(OpenAI o1)性能差距显著。研究强调代码生成模型需兼顾功能正确性和人类偏好，为模型优化提供新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T00:06:10Z
- **目录日期**: 2025-05-13
