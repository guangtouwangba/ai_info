...
这篇论文针对代码生成大模型(codeLLMs)提出新的评估方法，强调与人类偏好的对齐。研究者构建了CodeArena基准测试(包含397个高质量样本，覆盖40类任务和44种语言)来模拟真实编程场景，并开发了20B标记的SynCode-Instruct合成指令数据集。实验发现传统执行基准与人类偏好评估存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，凸显了人类偏好对齐的重要性。研究为提升代码生成模型的实用性和用户体验提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T17:05:49Z
- **目录日期**: 2025-05-13
