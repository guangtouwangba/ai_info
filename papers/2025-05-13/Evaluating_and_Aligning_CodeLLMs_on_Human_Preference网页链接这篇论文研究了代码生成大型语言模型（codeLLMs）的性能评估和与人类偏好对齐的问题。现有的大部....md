...
这篇论文提出了CodeArena基准测试和SynCode-Instruct语料库，以评估代码生成大模型（codeLLMs）与人类偏好的对齐程度。CodeArena包含397个高质量编程任务样本，覆盖40类任务和44种语言，更贴近实际开发需求。研究发现在执行基准和人类偏好评估间存在性能差异，开源模型（如Qwen2.5-Coder）与商业模型（如OpenAI o1）表现差距显著。通过20B标记的合成指令微调实验，验证了大规模指令数据对提升模型对齐效果的有效性，凸显了代码生成模型优化中考虑人类偏好的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T21:05:31Z
- **目录日期**: 2025-05-13
