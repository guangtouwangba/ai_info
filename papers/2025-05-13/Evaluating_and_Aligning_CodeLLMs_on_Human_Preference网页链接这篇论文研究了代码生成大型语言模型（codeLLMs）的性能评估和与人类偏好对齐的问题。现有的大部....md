...
这篇论文探讨了代码生成大模型(codeLLMs)与人类偏好的对齐问题，指出当前基准测试过于侧重代码正确性而忽视用户体验。研究者创建了CodeArena基准(包含397个样本，覆盖40类任务和44种语言)来模拟真实编程场景，并构建了20B标记的SynCode-Instruct合成指令集进行验证。实验发现执行基准与人类偏好评估存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，凸显了人类偏好对齐的重要性。研究成果为提升代码LLMs的实用性提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T23:05:21Z
- **目录日期**: 2025-05-13
