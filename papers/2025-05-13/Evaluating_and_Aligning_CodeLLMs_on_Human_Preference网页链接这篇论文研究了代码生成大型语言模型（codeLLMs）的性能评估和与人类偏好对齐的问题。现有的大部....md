...
这篇论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，聚焦人类偏好对齐问题。研究者构建了包含397个高质量样本的数据集，覆盖40个类别和44种编程语言，并开发了20B标记的合成指令集SynCode-Instruct。实验发现传统执行基准与人类偏好评估存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI)性能差距显著，凸显了人类偏好对齐在代码生成中的重要性。研究为评估代码LLMs提供了更全面的框架，强调需同时考虑功能正确性和用户体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T10:04:43Z
- **目录日期**: 2025-05-13
