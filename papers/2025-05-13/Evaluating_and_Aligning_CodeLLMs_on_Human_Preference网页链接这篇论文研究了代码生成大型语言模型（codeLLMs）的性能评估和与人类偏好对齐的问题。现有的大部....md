...
这篇论文针对代码生成大型语言模型（codeLLMs）提出新评估方法，指出当前基准测试过于关注代码正确性而忽略人类偏好。研究者构建了CodeArena基准（含397个多样本、40类、44种语言）和SynCode-Instruct合成指令集（近20B标记）。实验发现执行基准与人类偏好存在差异，开源模型（如Qwen2.5-Coder）与商业模型（如OpenAI o1）性能差距显著，强调对齐人类偏好的重要性。研究为提升代码LLMs的实际适用性提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T19:05:23Z
- **目录日期**: 2025-05-13
