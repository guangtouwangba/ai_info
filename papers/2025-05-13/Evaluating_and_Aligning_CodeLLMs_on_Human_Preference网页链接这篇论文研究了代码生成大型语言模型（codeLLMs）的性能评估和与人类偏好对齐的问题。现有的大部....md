...
这篇论文针对代码生成大模型(codeLLMs)提出了CodeArena基准测试，聚焦人类偏好对齐问题。研究发现现有基准过于关注代码正确性而忽视用户体验，因此构建了包含397个样本(覆盖40类任务和44种语言)的人类策划测试集，并开发了20B标记的SynCode-Instruct合成指令集。实验显示执行基准与人类偏好存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，凸显了人类偏好对齐在代码生成中的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T11:06:03Z
- **目录日期**: 2025-05-13
