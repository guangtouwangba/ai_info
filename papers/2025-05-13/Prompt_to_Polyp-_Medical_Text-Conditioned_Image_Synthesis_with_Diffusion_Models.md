...
本文研究了医疗领域的文本到图像生成技术，比较了两种方法：(1)微调预训练大模型和(2)训练小型专用模型。研究者提出了一种基于Stable Diffusion优化的新型模型MSDM，整合了临床文本编码器、变分自编码器和交叉注意力机制，以更好地对齐医疗文本提示与生成图像。通过在结肠镜(MedVQA-GI)和放射学(ROCOv2)数据集上的评估发现，大模型虽能获得更高保真度，但优化的MSDM能以更低计算成本实现相近质量。定量指标和医学专家评估揭示了每种方法的优缺点，为解决医疗AI数据稀缺问题提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T21:02:02Z
- **目录日期**: 2025-05-13
