...
本文综述了计算说服力的三个关键视角：AI作为说服者（生成有说服力的内容及应用）、AI作为被说服者（易受操纵和攻击）以及AI作为说服评判者（评估策略和伦理）。研究指出，AI驱动的说服技术既带来机遇（如有益应用），也存在风险（如操纵和偏见强化）。由于说服效果具有主观性和情境依赖性，当前对其有效性的理解仍有限。文章提出了计算说服研究的分类框架，并探讨了关键挑战（如评估说服力、减少操纵性说服）和未来方向（开发负责任的说服系统），以提升AI说服的安全性、公平性和有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T11:01:51Z
- **目录日期**: 2025-05-13
