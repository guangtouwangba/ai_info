...
这篇摘要探讨了人工智能在说服过程中的三重角色：说服者、被说服者和评判者。AI作为说服者能生成有影响力的内容，但也可能被用于操控；作为被说服者时易受攻击和偏见影响；作为评判者则需评估策略并确保伦理。研究提出了计算说服的分类框架，指出关键挑战包括评估说服效果、防止操控性说服及开发负责任的AI系统。随着语言模型能力提升，未来需关注AI说服的安全性、公平性和有效性，平衡其应用价值与潜在风险。该领域研究仍受制于说服行为的主观性和情境依赖性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T18:01:54Z
- **目录日期**: 2025-05-13
