...
这篇摘要探讨了人工智能在说服领域的三重角色：作为说服者（生成有说服力的内容）、被说服者（易受操纵和偏见影响）以及评判者（评估说服策略的伦理性和有效性）。随着对话式AI的兴起，AI驱动的说服既带来应用机遇，也伴随操纵风险。研究指出当前面临的关键挑战包括：评估说服效果、防止恶意操纵，以及开发负责任的AI说服系统。文章提出了计算说服研究的分类框架，并呼吁未来研究应关注提升AI说服的安全性、公平性和有效性，特别是针对日益强大的语言模型带来的风险。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T05:01:54Z
- **目录日期**: 2025-05-13
