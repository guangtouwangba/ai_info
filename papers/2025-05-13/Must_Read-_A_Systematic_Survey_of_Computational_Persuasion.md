...
这篇摘要探讨了人工智能在说服力方面的三重角色：作为说服者、被说服者和评判者。AI作为说服者可以生成有说服力的内容，但也存在操纵风险；作为被说服者易受攻击和偏见影响；作为评判者则需评估说服策略并确保伦理。研究提出了计算说服力的分类框架，并指出关键挑战：评估说服效果、防止操纵性说服和发展负责任的AI说服系统。随着语言模型能力的提升，未来研究需要关注如何确保AI说服的安全性、公平性和有效性，同时应对相关风险。该领域仍受限于说服效果的主观性和情境依赖性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T08:01:52Z
- **目录日期**: 2025-05-13
