...
本文综述了人工智能在说服领域的三大角色：说服者（AI生成说服性内容及应用）、被说服者（AI易受操纵和偏见影响）以及评判者（评估说服策略并确保伦理）。研究指出，AI驱动的说服技术既带来机遇（如有益应用）也伴随风险（如操纵行为），且当前对说服效果的理解仍受限于其主观性和情境依赖性。作者提出计算说服研究的分类框架，并探讨关键挑战：评估说服力、减少操纵性说服、开发负责任的AI说服系统。最后展望未来研究方向，强调需提升AI说服的安全性、公平性和有效性，以应对强大语言模型带来的风险。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T23:01:43Z
- **目录日期**: 2025-05-13
