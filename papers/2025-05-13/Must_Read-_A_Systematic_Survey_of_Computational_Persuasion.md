...
这篇摘要探讨了人工智能在说服领域的三重角色：说服者、被说服者和评判者。AI作为说服者可生成有说服力的内容，但也存在操纵风险；作为被说服者易受攻击和偏见影响；作为评判者能评估说服策略并检测操纵行为。研究提出了计算说服的分类框架，指出关键挑战包括评估说服效果、减少操纵性说服以及开发负责任的AI说服系统。未来研究需要解决语言模型能力提升带来的风险，同时提高AI说服的安全性、公平性和有效性。该领域仍受限于说服效果的主观性和情境依赖性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T19:01:47Z
- **目录日期**: 2025-05-13
