...
这篇摘要探讨了人工智能在说服领域的三重角色：作为说服者、被说服者和评判者。AI作为说服者可以生成有影响力的内容，但也存在操纵风险；作为被说服者容易受到对抗攻击和偏见影响；作为评判者则需评估策略伦理性和检测操纵行为。研究提出了计算说服的分类框架，并指出关键挑战：评估说服效果、防止操纵性说服以及开发负责任的AI说服系统。随着语言模型能力提升，未来研究需关注如何确保AI说服的安全性、公平性和有效性，同时应对其潜在风险。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T06:01:58Z
- **目录日期**: 2025-05-13
