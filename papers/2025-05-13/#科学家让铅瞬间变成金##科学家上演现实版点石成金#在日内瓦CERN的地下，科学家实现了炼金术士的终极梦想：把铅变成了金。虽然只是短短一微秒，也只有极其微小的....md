...
欧洲核子研究中心（CERN）的科学家利用大型强子对撞机（LHC），通过超外周碰撞（UPC）使铅离子在接近光速下相互作用。高能光子从铅原子核中击出3个质子，将铅（原子序82）短暂转化为金（原子序79），持续约1微秒，生成约86亿个金原子核（总质量2.9×10⁻¹¹克）。该实验主要研究电磁诱导核反应机制，而非实用炼金，旨在探索高能物理过程，提升对撞精度并为新粒子研究奠定基础。同时观测到铊、汞等同位素，验证了反应的核转化能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T01:31:29Z
- **目录日期**: 2025-05-13
