...
欧洲核子研究中心(CERN)的科学家利用大型强子对撞机(LHC)实现了"铅变金"的突破。通过将铅离子加速至近光速并使其发生"超外周碰撞"，产生的高能光子可剥离铅原子核的3个质子(原子序从82降至79)，短暂形成金原子核。虽然每次反应仅产生86亿个金原子(总重约2.9×10⁻¹¹克)且仅维持1微秒，但这验证了电磁诱导核反应的可行性。该实验主要目的是研究高能物理机制，而非实际炼金，成果有助于提升对撞机精度并为新粒子探索奠定基础。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T04:04:54Z
- **目录日期**: 2025-05-13
