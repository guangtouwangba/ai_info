...
任天堂更新Switch用户协议，声明拥有远程封锁破解主机的技术，违规操作（如破解、运行自制软件等）可能导致设备永久失效。新协议禁止修改软件、使用未授权硬件/软件绕过保护措施，违者将面临账号或设备封禁。欧洲法律限制此类措施，仅允许封锁盗版内容访问权。这引发设备所有权争议，用户购买硬件但软件仅为授权使用。网友批评此举过度限制用户权利，可能影响Switch 2发布前的品牌形象。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T20:03:06Z
- **目录日期**: 2025-05-13
