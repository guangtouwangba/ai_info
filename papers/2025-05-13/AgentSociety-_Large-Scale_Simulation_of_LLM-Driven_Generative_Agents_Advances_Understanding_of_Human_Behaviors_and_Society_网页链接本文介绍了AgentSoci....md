...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，通过模拟1万多个代理和500万次互动来研究人类行为和社会现象。该系统作为计算社会科学实验平台，研究了社会极化、信息传播、基本收入政策及自然灾害影响等关键问题。模拟结果与现实数据吻合，验证了其捕捉人类行为机制的能力，展现了作为社会科学研究和政策制定工具的潜力。该研究为理解复杂社会问题提供了新方法，并可能辅助传统研究方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T07:05:45Z
- **目录日期**: 2025-05-13
