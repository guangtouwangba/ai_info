...
AgentSociety是一个基于大语言模型的大规模社会模拟平台，可模拟超过1万个智能代理及其500万次互动。研究者利用该平台研究了社会极化、信息传播、基本收入政策及自然灾害影响等社会问题，结果与现实世界数据高度吻合。该系统展现了作为社会科学研究工具的强大潜力，能够有效捕捉人类行为模式和社会机制，为研究者和政策制定者提供新的研究方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T05:05:18Z
- **目录日期**: 2025-05-13
