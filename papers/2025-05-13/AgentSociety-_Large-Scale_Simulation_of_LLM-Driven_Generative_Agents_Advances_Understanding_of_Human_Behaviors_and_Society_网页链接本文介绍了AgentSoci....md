...
这篇论文介绍了一个名为AgentSociety的大规模社会模拟系统，它利用大型语言模型驱动的智能代理、真实社会环境和大规模模拟引擎，模拟了超过1万个代理的社会生活及500万次互动。研究者通过该系统研究了四个关键社会问题：社会极化、刺激性信息传播、无条件基本收入政策影响以及飓风等外部冲击。模拟结果与现实世界实验数据高度吻合，验证了该系统捕捉人类行为和社会机制的能力，展示了其作为社会科学研究和政策制定工具的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T18:05:02Z
- **目录日期**: 2025-05-13
