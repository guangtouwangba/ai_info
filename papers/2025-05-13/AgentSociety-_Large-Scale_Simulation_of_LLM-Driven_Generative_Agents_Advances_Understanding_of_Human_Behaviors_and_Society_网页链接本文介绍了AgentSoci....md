...
该研究开发了AgentSociety大规模社会模拟器，通过整合LLM驱动的智能代理、真实社会环境和强大模拟引擎，成功模拟了1万多个代理的社交活动及500万次互动。研究团队利用该平台针对社会极化、信息传播、基本收入政策和飓风影响四个关键问题进行实验，结果与现实世界数据高度吻合。这一突破性成果不仅验证了模拟器捕捉人类行为机制的能力，更展现了其作为社会科学研究和政策制定重要工具的潜力，为理解复杂社会现象提供了新方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T06:05:31Z
- **目录日期**: 2025-05-13
