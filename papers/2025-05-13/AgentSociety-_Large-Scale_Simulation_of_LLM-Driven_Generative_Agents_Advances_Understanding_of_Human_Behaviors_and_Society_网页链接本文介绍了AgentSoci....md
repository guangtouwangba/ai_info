...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个智能代理及其500万次社会互动。该系统作为计算社会科学实验平台，研究了社会极化、信息传播、基本收入政策和自然灾害影响等社会问题。其模拟结果与现实世界数据高度吻合，验证了系统对人类行为和社会机制建模的有效性。研究表明，AgentSociety能够辅助传统社会科学研究方法，为研究者和政策制定者提供有价值的分析工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T20:05:10Z
- **目录日期**: 2025-05-13
