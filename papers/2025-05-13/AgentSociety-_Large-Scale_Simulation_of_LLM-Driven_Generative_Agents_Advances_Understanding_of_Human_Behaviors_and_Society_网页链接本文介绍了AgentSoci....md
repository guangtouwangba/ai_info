...
AgentSociety是一个基于大型语言模型的大规模社会模拟系统，可模拟1万多个代理及其500万次互动。研究者利用该平台研究了社会极化、信息传播、基本收入政策和自然灾害影响四个关键问题。模拟结果与现实世界数据高度吻合，验证了系统对人类行为和社会机制建模的有效性。这一工具为社会科学研究和政策制定提供了新方法，能够补充传统调查和实验的不足，帮助深入理解复杂社会问题的成因和机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T16:05:28Z
- **目录日期**: 2025-05-13
