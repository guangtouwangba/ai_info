...
荷兰科学家团队在《宇宙学与天体粒子物理学杂志》发表研究，发现宇宙衰亡速度远超预期。通过扩展霍金辐射理论，他们证明所有引力天体（包括黑洞和中子星）都会蒸发，且衰变时间仅取决于密度。令人意外的是，中子星与恒星级黑洞蒸发时间相同（约10⁶⁷年），因黑洞会重吸收部分辐射。仅考虑该效应时，宇宙终结时间从原先预测的10¹¹⁰⁰年大幅缩短至10⁷⁸年，月球蒸发则需10⁹⁰年。该研究颠覆了天体物理学的传统认知。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T22:03:54Z
- **目录日期**: 2025-05-13
