...
荷兰科学家Falcke等人研究发现，宇宙衰亡速度比预期快得多。他们证实霍金辐射不仅适用于黑洞，也作用于中子星等天体，且蒸发时长仅取决于密度。令人意外的是，中子星与恒星级黑洞的衰亡时间相同（约10⁶⁷年），因黑洞会重新吸收部分辐射而延缓衰变。研究推算仅靠此类辐射，宇宙终结时间将从原认为的10¹¹⁰⁰年大幅提前至约10⁷⁸年。该成果发表于《宇宙学与天体粒子物理学杂志》，刷新了对宇宙终极命运的认知。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T10:03:05Z
- **目录日期**: 2025-05-13
