...
荷兰科学家团队在《宇宙学与天体粒子物理学杂志》发表研究指出，宇宙衰亡速度远超预期。他们发现霍金辐射效应不仅作用于黑洞，也适用于中子星等天体，且蒸发时间仅与密度相关（约10⁶⁷年）。据此推算，宇宙终结时间从原先预测的10¹¹⁰⁰年大幅缩短至10⁷⁸年。研究还揭示黑洞因无实体表面会吸收部分自身辐射，反而延缓衰变。月球和人类的理论蒸发时间需10⁹⁰年，但实际会通过其他方式更早消亡。该发现对传统天体物理理论提出了新挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T17:03:52Z
- **目录日期**: 2025-05-13
