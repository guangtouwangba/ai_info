...
荷兰科学家团队在《宇宙学与天体粒子物理学杂志》发表研究指出，宇宙衰亡速度远超预期。他们发现霍金辐射不仅作用于黑洞，也适用于中子星等天体，且蒸发时长仅取决于密度（约10⁶⁷年）。令人意外的是，中子星与恒星级黑洞衰亡时间相同，因黑洞会吸收部分自身辐射延缓衰变。研究推算仅靠此类辐射，宇宙终结时间将从原先预测的10¹¹⁰⁰年大幅提前至10⁷⁸年。不过对人类而言，月球完全蒸发仍需10⁹⁰年，远早于其他毁灭方式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T23:03:32Z
- **目录日期**: 2025-05-13
