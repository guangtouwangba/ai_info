...
IVE是一个基于视觉语言模型(VLM)的机器人探索框架，通过模拟人类好奇心驱动探索。它将RGB-D观测转换为语义场景图，想象新场景并预测其物理可行性，再生成可执行动作序列。相比强化学习基线，IVE实现了4.1-7.8倍的状态访问熵增长，表明其探索更具多样性和意义性。收集的经验还能有效支持下游任务学习，其训练出的策略性能接近或超过基于人类示范数据训练的模型。该框架在模拟和真实桌面环境中均得到验证，成功弥合了想象与执行间的鸿沟。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T13:10:30Z
- **目录日期**: 2025-05-13
