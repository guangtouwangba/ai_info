...
IVE是一个受人类好奇心启发的机器人探索框架，通过视觉语言模型（VLM）将RGB-D观测转化为语义场景图，想象新场景并验证其物理可行性，再生成可执行动作序列。该框架在模拟和真实桌面环境中测试，相比强化学习基线，IVE实现了4.1至7.8倍的探索状态熵增，表明其探索更具多样性和意义性。收集的经验还能有效支持下游任务学习，其策略性能接近或超过基于人类示范训练的结果。IVE填补了想象与执行间的鸿沟，为开放环境中稀疏奖励的任务提供了通用解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T05:01:03Z
- **目录日期**: 2025-05-13
