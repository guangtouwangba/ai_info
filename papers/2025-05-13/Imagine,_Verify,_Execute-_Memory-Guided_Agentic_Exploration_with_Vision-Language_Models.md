...
IVE是一个受人类好奇心启发的机器人探索框架，通过视觉语言模型(VLMs)将RGB-D观测转化为语义场景图，想象新场景并预测其物理可行性，再通过动作工具生成可执行技能序列。该框架在模拟和真实桌面环境中验证，相比强化学习基线，IVE实现了4.1-7.8倍的探索状态熵增，展现出更丰富、更有意义的探索能力。收集的经验还支持下游学习，训练出的策略性能接近或超过基于人类演示数据训练的模型。IVE有效弥合了想象与执行间的鸿沟，为开放环境中机器人学习提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T14:00:53Z
- **目录日期**: 2025-05-13
