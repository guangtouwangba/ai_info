...
该研究提出了一个多维框架分析政治不文明行为，包含无礼、暴力言论、仇恨言论和对民主制度的威胁。通过分析2022年巴西大选期间2307名政治影响者的500万条推文，研究发现：选举期间无礼言论激增，其他维度则多由暴力事件触发；左翼个人影响者是主要传播者，既传播直接不文明内容，也通过讨论他人言论间接传播；传播模式混合了直接传播和两步传播理论。研究揭示了巴西政治不文明的多维特性，其框架可拓展至其他政治背景。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T00:02:35Z
- **目录日期**: 2025-05-13
