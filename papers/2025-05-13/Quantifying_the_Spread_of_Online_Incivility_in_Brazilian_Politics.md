...
该研究提出了一个多维框架来分析政治不文明行为，包括无礼、暴力言论、仇恨言论和对民主制度的威胁。通过分析2022年巴西大选期间的500万条推文，研究发现：竞选期间无礼行为激增，而其他不文明行为多由暴力事件触发；左翼个人影响者是主要传播者，既直接传播也通过讨论他人言论间接传播；传播模式混合了直接和两步流动理论。研究揭示了巴西政治不文明的多维特性，其框架可扩展至其他政治背景。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T01:29:52Z
- **目录日期**: 2025-05-13
