...
研究团队开发了集成计算平台ProME v1.0，用于极端条件下材料性能的多尺度模拟。该平台整合了8个功能模块，可计算万开尔文高温、百万大气压高压及百万/秒高应变率下的多元合金特性。应用案例显示，ProME成功设计了航天发动机喷嘴用Pt-Ir-Al-Cr四元合金，在保持高温强度的同时显著降低了成本。该平台为材料研发提供了从基础研究到工业创新的全链条计算支持，覆盖晶体结构搜索、无序构型建模、热力学性质、弹塑性、输运特性到相图优化等完整材料设计流程。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T01:28:40Z
- **目录日期**: 2025-05-13
