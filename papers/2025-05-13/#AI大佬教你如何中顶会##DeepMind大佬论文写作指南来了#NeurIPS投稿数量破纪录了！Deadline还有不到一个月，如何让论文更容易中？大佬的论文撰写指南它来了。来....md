...
DeepMind研究员Neel Nanda发布机器学习论文写作指南，强调论文应围绕1-3个新颖核心主张构建技术叙事，通过严谨实验证据支持，并阐明研究价值。关键要素包括：提炼独特成果形成连贯主题、把握写作时机、突出创新性、提供多样化的可靠实验证据。论文结构建议：摘要激发兴趣，引言说明贡献，正文详述方法结果，讨论局限性与影响，相关工作需体现差异。指南指出，优秀论文是"基于证据的技术故事"，需平衡科学性（How）与影响力（So what）。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T23:02:44Z
- **目录日期**: 2025-05-13
