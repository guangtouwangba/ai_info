...
这篇指南总结了Google DeepMind研究员Neel Nanda的论文写作建议。核心观点是：优秀论文需要讲述一个严谨的技术故事，包含1-3个新颖主张，并通过实验证据支持。关键要素包括构建清晰叙事、突出研究新颖性、提供严谨实验证据。论文结构上，摘要要吸引读者，引言说明贡献，正文详述方法结果，讨论局限性和影响。特别强调研究需拓展知识边界，明确与前人工作的差异，实验设计要可靠且有统计意义。写作时机应在完成关键实验后，聚焦研究亮点和难点。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T11:03:04Z
- **目录日期**: 2025-05-13
