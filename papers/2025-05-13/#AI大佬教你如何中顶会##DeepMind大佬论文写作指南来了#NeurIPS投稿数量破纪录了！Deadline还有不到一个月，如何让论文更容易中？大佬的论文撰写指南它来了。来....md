...
这篇指南总结了Google DeepMind研究员Neel Nanda的机器学习论文写作经验。核心观点是：优秀论文应讲述一个基于证据的连贯技术故事，包含1-3个新颖主张，并通过严谨实验验证。关键要素包括：构建清晰叙事、突出研究新颖性、提供可靠证据。论文结构建议：摘要激发兴趣，引言说明贡献，正文详述方法结果，讨论局限性和影响，相关工作区分前人研究。写作时机应在完成关键实验后，重点阐明研究价值和创新点。指南强调论文要让读者理解、相信并关注研究成果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T17:03:01Z
- **目录日期**: 2025-05-13
