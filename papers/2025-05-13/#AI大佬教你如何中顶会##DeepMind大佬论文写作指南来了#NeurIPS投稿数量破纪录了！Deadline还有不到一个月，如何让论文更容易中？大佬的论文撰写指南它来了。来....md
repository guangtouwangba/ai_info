...
这篇指南总结了Google DeepMind研究员Neel Nanda的论文写作建议，核心观点是：优秀论文应讲述一个基于证据的连贯技术故事，包含1-3个新颖主张，并用严谨实验验证。关键要素包括：构建清晰叙事、突出研究新颖性、提供可靠证据。论文结构上，摘要需激发兴趣，引言阐明贡献，正文详述方法结果，讨论局限性与影响。特别强调研究需解决"为什么重要"的问题，并通过实验设计、基线对比等展现可信度。指南还附有摘要范例解析，强调论文应让读者理解并相信研究的价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T16:03:16Z
- **目录日期**: 2025-05-13
