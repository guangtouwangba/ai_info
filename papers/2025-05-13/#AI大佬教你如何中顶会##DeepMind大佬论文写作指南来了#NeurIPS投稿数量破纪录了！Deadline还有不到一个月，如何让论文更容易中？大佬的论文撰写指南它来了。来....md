...
DeepMind研究员Neel Nanda发布机器学习论文写作指南，强调优秀论文应讲述基于证据的技术故事。关键要素包括：提炼1-3个新颖主张构建连贯叙事；通过严谨实验提供可靠证据；突出研究创新性和实际价值。论文结构建议：摘要激发兴趣，引言明确贡献，正文详述方法结果，讨论局限与影响，相关工作说明差异化。特别指出写作前需验证关键实验，使用LLMs了解前人工作，实验设计需具区分力且统计严谨。指南以具体论文摘要为例进行逐行解析。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T13:12:38Z
- **目录日期**: 2025-05-13
