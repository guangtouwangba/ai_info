...
这篇指南总结了Google DeepMind研究员Neel Nanda的论文写作建议。核心观点是：优秀论文应讲述一个严谨的技术故事，包含1-3个新颖主张，并通过实验证据支持。关键要素包括构建清晰叙事、突出研究新颖性、提供严谨证据。论文结构上，摘要要激发兴趣，引言阐明贡献，正文详述方法结果，讨论局限性和影响，相关工作说明差异性。写作时机应在完成关键实验后，重点展示研究价值和知识边界突破。指南强调论文要让读者理解、相信并关注研究成果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T18:03:00Z
- **目录日期**: 2025-05-13
