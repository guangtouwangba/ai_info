...
DeepMind研究员Neel Nanda发布机器学习论文写作指南，强调优秀论文需构建清晰叙事，包含1-3个新颖主张、严谨证据和研究价值。关键要素包括：提炼核心主张、把握写作时机、突出创新性、提供可靠实验数据。论文结构建议：摘要激发兴趣，引言说明贡献，正文详述方法结果，讨论局限性与影响，相关工作需差异化。指南以具体论文为例解析摘要写法，指出附录可补充次要信息。该指南基于作者指导20多篇论文的经验，旨在帮助研究者提升论文质量。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T19:02:53Z
- **目录日期**: 2025-05-13
