...
这篇指南总结了Google DeepMind研究员Neel Nanda的机器学习论文写作经验。核心观点认为优秀论文应讲述一个技术故事，包含1-3个新颖主张，并通过严谨实验证据支持。关键要素包括：构建连贯叙事、突出研究新颖性、提供多样化实验证据。论文结构上，摘要要激发兴趣，引言明确贡献，正文详述方法结果，讨论局限性和影响，相关工作需说明差异性。写作时机应在完成关键实验后，重点提炼研究的核心价值和创新点。指南特别强调论文要让读者理解研究的动机、方法和意义。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T15:03:18Z
- **目录日期**: 2025-05-13
