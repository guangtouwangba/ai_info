...
这篇论文探讨了人工智能（AI）开发中忽视分歧的伦理与认知风险，提出了“视角同质化”的概念，即AI系统开发过程中不合理压制多元观点的问题。作者认为，这种同质化会损害边缘群体的利益，并提出了一个规范性框架，强调分歧在AI生命周期中的价值。该框架建议：明确分歧的认知意义、纳入多元视角、优化任务设计并记录分歧。研究挑战了AI实践中的常见假设，为参与式和多元化方法提供了理论基础，并为未来AI设计与治理提出了可操作的改进方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T18:02:15Z
- **目录日期**: 2025-05-13
