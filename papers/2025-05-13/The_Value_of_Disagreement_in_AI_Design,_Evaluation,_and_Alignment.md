...
这篇论文探讨了人工智能（AI）开发中忽视或压制不同观点的风险，提出了“视角同质化”的概念，即AI系统开发过程中不合理地压制多样性和分歧，可能导致认知和伦理上的危害，尤其对边缘化群体。作者提出了一个规范性框架，强调分歧的认知价值，并指导如何在AI生命周期的各个阶段（如设计、评估、沟通）纳入多元视角。该框架挑战了AI实践中的常见假设，为参与式和多元化方法提供了理论基础，并为未来AI设计与治理提出了可操作的改进方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T19:02:03Z
- **目录日期**: 2025-05-13
