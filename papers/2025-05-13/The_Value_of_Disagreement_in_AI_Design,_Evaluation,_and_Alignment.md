...
这篇论文探讨了人工智能（AI）开发中因压制分歧而导致的“视角同质化”风险，认为这种同质化可能对边缘群体造成伦理和认知上的危害。作者提出了一个规范性框架，强调分歧在AI生命周期中的认知价值，并建议通过包容多元视角、优化任务设计及记录分歧来应对风险。该框架挑战了AI实践中的常见假设，支持参与式和多元化方法，为未来AI设计与治理提供了可操作的路径。研究呼吁在开发流程中针对性干预，以平衡分歧与决策效率的权衡。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T09:02:15Z
- **目录日期**: 2025-05-13
