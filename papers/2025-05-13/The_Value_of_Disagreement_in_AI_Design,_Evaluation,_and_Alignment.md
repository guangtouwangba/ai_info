...
这篇论文探讨了人工智能（AI）开发中普遍存在的意见分歧被压制的问题，提出了“视角同质化”的概念，即AI系统开发过程中不合理地压制分歧和多样性视角，可能对边缘群体造成伦理和认知上的危害。作者提出了一个规范性框架，强调分歧的认知价值，并指导如何在AI生命周期的不同阶段（如设计、评估、沟通等）纳入多元视角。该框架挑战了AI实践中的常见假设，为参与式和多元化方法提供了理论基础，并为未来AI设计和治理提供了可操作的改进方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T05:02:14Z
- **目录日期**: 2025-05-13
