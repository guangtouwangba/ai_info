...
这篇论文提出了一个基于状态特征影响力的理论框架，用于解释强化学习模型的决策过程。针对智能体与环境交互中的三个核心要素（行为、性能和价值估计），研究者将状态特征视为合作参与者，并运用合作博弈论中的Shapley值方法来量化每个特征的影响力。该方法提供了一组具有明确语义和理论保证的数学解释，能产生符合人类直觉的见解，同时揭示了新的发现。该框架统一并扩展了现有工作，明确了各种解释方法背后的假设，为构建更可解释、更可信的强化学习系统奠定了理论基础。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T15:01:19Z
- **目录日期**: 2025-05-13
