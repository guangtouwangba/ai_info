...
该研究提出了一个量化监督成功概率的框架，将可扩展监督建模为能力不匹配玩家之间的博弈。监督者和被监督者拥有基于通用智力的分段线性Elo评分，包含"任务无能"和"任务饱和"两个平台期。研究通过改良Nim游戏验证框架，并应用于黑手党、辩论、后门代码和战争游戏四种监督场景，发现领域表现与AI系统能力的缩放规律。在嵌套可扩展监督(NSO)的理论研究中，确定了NSO成功的条件及最优监督层级数。实验显示，当Elo差距为400时，四种游戏的NSO成功率分别为13.5%、51.7%、10.0%和9.4%，且随系统变强而下降。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T01:29:43Z
- **目录日期**: 2025-05-13
