...
Manus智能体平台正式开放注册，推出免费试用模式：新用户获1000积分，每日再赠300积分（示例任务消耗267积分）。同时提供三档付费会员（19-199美元/月），对应1900-19900积分/月。实测显示高级任务消耗较大（如每日新闻需704积分），用户反馈价格偏高。平台表示这是团队两个月的成果，希望用户享受服务。目前该平台已引发行业关注。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T07:04:35Z
- **目录日期**: 2025-05-13
