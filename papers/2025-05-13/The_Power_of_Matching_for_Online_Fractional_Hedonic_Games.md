...
这篇论文研究了分数联盟博弈(FHGs)中的在线联盟形成问题，目标是最大化社会福利。在一般在线FHGs中，计算最大匹配能达到最优竞争比，但该比率会随估值范围扩大而无界。研究在两个相关场景中取得了常数竞争比：1)允许解散联盟时，基于匹配的算法能达到最优竞争比1/(6+4√2)；2)随机到达且代理数量未知时，提出了紧致的1/6竞争比随机算法，并证明任何算法竞争比不可能优于1/3。研究揭示了FHGs与匹配问题之间的深层联系。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T00:01:46Z
- **目录日期**: 2025-05-13
