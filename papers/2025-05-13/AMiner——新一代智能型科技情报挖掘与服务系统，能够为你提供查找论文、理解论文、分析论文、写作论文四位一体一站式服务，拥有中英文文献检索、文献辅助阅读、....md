...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、翻译、辅助阅读和科研订阅。其数据库涵盖42个学科3.5亿论文、0.6亿学者和1.5亿专利。核心功能包括：1）智能文献检索与摘要生成；2）PDF文档解析与交互式问答；3）个性化科研动态推送。平台还支持学者画像分析、学术会议追踪等功能，基础服务免费开放。通过AI技术显著提升文献查阅和论文写作效率，适合研究人员快速获取前沿学术信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T09:06:04Z
- **目录日期**: 2025-05-13
