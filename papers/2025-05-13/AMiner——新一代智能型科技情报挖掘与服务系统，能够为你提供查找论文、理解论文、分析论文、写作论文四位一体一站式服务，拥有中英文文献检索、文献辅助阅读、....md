...
AMiner是一款智能科技情报挖掘系统，提供论文检索、翻译、阅读分析和科研订阅等一站式服务。它支持中英文文献搜索，拥有3.5亿论文、0.6亿学者等海量数据，并能通过AI生成摘要和问答辅助理解。用户可订阅个性化科研动态，追踪学者或领域进展。平台还提供文献翻译、文档解析及学术会议等资源，基础功能免费使用。访问入口：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T17:05:39Z
- **目录日期**: 2025-05-13
