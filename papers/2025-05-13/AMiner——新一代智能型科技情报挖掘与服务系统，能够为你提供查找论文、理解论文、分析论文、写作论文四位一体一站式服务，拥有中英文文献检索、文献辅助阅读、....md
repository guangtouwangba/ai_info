...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析及写作一站式服务。它支持中英文文献搜索，能自动生成摘要并解答用户提问，提高研究效率。平台还具备文档识别和辅助阅读功能，用户可上传PDF或从数据库选取论文，获取章节概要和问题建议。此外，AMiner提供科研动态订阅服务，按用户偏好推送最新学术资讯。其数据库涵盖3.5亿论文、0.6亿学者及1.5亿专利，支持免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T07:06:16Z
- **目录日期**: 2025-05-13
