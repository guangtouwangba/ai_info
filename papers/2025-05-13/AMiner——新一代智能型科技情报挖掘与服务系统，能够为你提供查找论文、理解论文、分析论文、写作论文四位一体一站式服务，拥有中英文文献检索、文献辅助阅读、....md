...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译、科研情报订阅等一站式服务。它收录了3.5亿论文、0.6亿学者等海量学术资源，支持中英文文献检索，并能通过AI生成摘要、章节概要和智能问答。用户可订阅个性化科研动态，追踪特定学者或关键词的最新研究。平台还提供学者画像、学术会议信息等特色功能，基础检索服务免费开放。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-13T04:06:31Z
- **目录日期**: 2025-05-13
