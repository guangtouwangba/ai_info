...
本文首次全面综述了基于大语言模型（LLM）的智能体评估方法，涵盖四个关键维度：基础能力（如规划、工具使用、自我反思和记忆）、应用特定基准（如网络、软件工程、科学和对话代理）、通用代理基准以及评估框架。分析揭示了评估趋势，如向更现实、更具挑战性的持续更新基准转变，同时指出了未来研究需解决的关键问题，包括成本效率、安全性和鲁棒性评估，以及开发细粒度和可扩展的评估方法。本文为智能体评估领域的快速发展提供了方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-23T11:01:20Z
- **目录日期**: 2025-03-23
