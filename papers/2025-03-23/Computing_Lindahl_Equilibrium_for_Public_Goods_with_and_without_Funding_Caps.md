...
林达尔均衡是一种用于在多个可分公共物品之间分配固定预算的解决方案概念，始终位于核心，满足稳定性和比例公平性。本文研究了具有可分线性效用函数的代理模型，提出了新的凸规划公式，证明其与纳什社会福利最大化相关，并通过镜像下降法等价于比例响应动态，提供了收敛保证。在无上限设置中，林达尔均衡等同于最大化纳什社会福利；在有上限设置中，证明了新凸规划公式仍适用，其最优解为林达尔均衡，从而解决了长期存在的算法效率问题，并表明可分分段线性凹效用类的近似核心稳定分配可高效计算。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-23T08:01:29Z
- **目录日期**: 2025-03-23
