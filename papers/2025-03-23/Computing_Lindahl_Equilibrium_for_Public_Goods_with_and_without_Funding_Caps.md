...
林达尔均衡是一种用于在多个可分公共物品之间分配固定预算的解决方案概念，始终位于核心，满足稳定性和比例公平性。研究考虑了一个模型，其中代理对公共物品具有可分离的线性效用函数，输出为每个物品分配支出，总和不超过可用预算。在无上限设置中，公共物品可吸收任意资金，林达尔均衡等同于最大化纳什社会福利，可通过比例响应动态计算。研究提出了新的凸规划公式，证明其与纳什福利最大化相关，并通过镜像下降证明其收敛性。在上限设置中，证明了新凸规划仍有效，林达尔均衡可高效计算，且近似核心稳定分配也可高效计算。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-23T17:01:36Z
- **目录日期**: 2025-03-23
