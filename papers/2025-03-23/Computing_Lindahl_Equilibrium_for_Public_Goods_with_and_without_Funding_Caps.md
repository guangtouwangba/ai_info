...
Lindahl均衡是一种用于在多个可分公共物品之间分配固定预算的解决方案，具有稳定性和比例公平性。研究提出了一种新的凸规划公式，用于计算无上限设置下的Lindahl均衡，该均衡等同于最大化纳什社会福利，并可通过比例响应动态计算。新公式与Fisher市场均衡的Shmyrev凸程序相似，并通过对偶和重构与纳什福利最大化相关。在有上限设置下，证明了该凸规划公式仍适用，其最优解为Lindahl均衡，从而解决了长期存在的算法计算问题，并表明可有效计算近似核心稳定分配。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-23T21:01:15Z
- **目录日期**: 2025-03-23
