...
林达尔均衡是一种用于在多个可分公共物品之间分配固定预算的解决方案概念，始终位于核心，满足稳定性和比例公平性。本文研究了具有可分线性效用函数的代理模型，提出了新的凸规划公式来计算林达尔均衡，并证明其通过对偶和重构与纳什社会福利最大化相关。在无上限设置中，均衡可通过比例响应动态计算；在有上限设置中，证明了新凸规划仍适用，从而解决了长期存在的算法效率问题。结果表明，林达尔均衡在有上限设置中可高效计算，且近似核心稳定分配也可高效计算。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-23T00:01:40Z
- **目录日期**: 2025-03-23
