...
林达尔均衡是一种用于在多个可分割公共物品之间分配固定预算的解决方案概念，始终位于核心内，满足稳定性和比例公平性。本文研究了代理人对公共物品具有可分离线性效用函数的模型，并引入新的凸规划公式来计算该均衡，证明其与纳什社会福利最大化相关。通过镜像下降法，我们提供了比例响应动态收敛的新证明。在有限制条件下，我们证明了该凸规划仍有效，其最优解为林达尔均衡，从而解决了长期存在的算法效率问题，并表明可有效计算近似核心稳定分配。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-23T14:01:24Z
- **目录日期**: 2025-03-23
