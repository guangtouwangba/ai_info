...
元戎启行CEO周光在英伟达GTC 2025上提出了RoadAGI概念，这是一种通过自动驾驶实现垂直领域AGI（通用人工智能）的新路径。与传统的Robotaxi不同，RoadAGI旨在通过一个平台赋能智能车、机器人等移动体，无需依赖高精地图，实现大规模商用自动驾驶。元戎启行的AI Spark平台将支持这一愿景，推动一切可动设备具备自主移动能力。这一创新路径为自动驾驶和AI公司开辟了新的可能性，展示了通过自动驾驶实现AGI的另一种途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-23T13:08:04Z
- **目录日期**: 2025-03-23
