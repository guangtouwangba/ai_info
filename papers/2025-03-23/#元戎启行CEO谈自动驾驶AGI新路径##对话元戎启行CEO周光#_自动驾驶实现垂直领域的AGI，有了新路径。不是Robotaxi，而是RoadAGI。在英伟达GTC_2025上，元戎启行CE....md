...
元戎启行CEO周光在英伟达GTC 2025上提出了一种新的自动驾驶AGI实现路径——RoadAGI。与传统的Robotaxi不同，RoadAGI旨在通过不依赖高精地图的AI Spark平台，赋能智能车、机器人等多种移动体，实现垂直道路场景下的通用人工智能（AGI）。这一创新路径有望加速自动驾驶的大规模商用，并为AI公司和自动驾驶公司开辟新的可能性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-23T04:03:41Z
- **目录日期**: 2025-03-23
