...
元戎启行CEO周光在英伟达GTC 2025上提出了RoadAGI概念，这是一种通过自动驾驶实现垂直领域AGI（通用人工智能）的新路径。RoadAGI不依赖高精地图，通过AI Spark平台赋能智能车、机器人等移动体，使其具备自主移动能力。这一创新旨在加速自动驾驶的大规模商用，特别是在垂直道路场景下。周光及其公司元戎启行代表了一种新的可能性，即通过自动驾驶技术实现AGI，为未来智能交通和移动设备提供了新的发展方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-23T22:03:48Z
- **目录日期**: 2025-03-23
