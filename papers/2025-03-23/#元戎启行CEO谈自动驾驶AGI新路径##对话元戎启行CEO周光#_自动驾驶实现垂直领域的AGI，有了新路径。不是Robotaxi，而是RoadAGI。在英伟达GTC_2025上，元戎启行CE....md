...
元戎启行CEO周光在英伟达GTC 2025上提出了一种新的自动驾驶AGI实现路径——RoadAGI。与传统的Robotaxi不同，RoadAGI旨在通过一个平台赋能各种移动体，包括智能车、机器人等，实现垂直道路场景下的AGI。该平台不依赖高精地图，能够更快地推动自动驾驶的大规模商用。元戎启行通过这一创新路径，展示了自动驾驶技术在实现AGI方面的第二种可能性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-23T12:04:53Z
- **目录日期**: 2025-03-23
