...
元戎启行CEO周光在英伟达GTC 2025上提出了RoadAGI概念，这是一种通过自动驾驶实现垂直领域AGI（人工通用智能）的新路径。与传统的Robotaxi不同，RoadAGI旨在通过元戎启行的AI Spark平台，不依赖高精地图，赋能智能车、机器人等多种移动体，使其具备自主移动能力。这一创新路径有望加速自动驾驶的大规模商用，并推动垂直道路场景下的AGI发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-23T19:04:01Z
- **目录日期**: 2025-03-23
