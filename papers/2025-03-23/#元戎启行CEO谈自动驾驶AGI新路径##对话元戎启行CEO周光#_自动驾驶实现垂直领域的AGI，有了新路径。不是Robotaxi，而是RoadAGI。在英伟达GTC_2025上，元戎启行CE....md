...
元戎启行CEO周光在英伟达GTC 2025上提出了RoadAGI概念，这是一种通过自动驾驶实现垂直领域AGI（人工通用智能）的新路径。与传统的Robotaxi不同，RoadAGI旨在通过一个平台赋能各种移动体，包括智能车、机器人等，使其具备自主移动能力，且不依赖高精地图。这一创新路径有望加速自动驾驶的大规模商用，并为AI和自动驾驶公司开辟新的可能性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-23T00:03:39Z
- **目录日期**: 2025-03-23
