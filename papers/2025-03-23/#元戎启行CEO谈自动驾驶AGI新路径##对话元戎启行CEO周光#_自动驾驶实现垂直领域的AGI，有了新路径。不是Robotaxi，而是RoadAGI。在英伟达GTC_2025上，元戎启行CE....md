...
元戎启行CEO周光在英伟达GTC 2025上提出了通过RoadAGI实现自动驾驶垂直领域AGI的新路径。RoadAGI不依赖高精地图，通过AI Spark平台赋能智能车、机器人等移动体，使其具备自主移动能力。这一创新路径旨在加速自动驾驶的大规模商用，特别是在垂直道路场景中的应用。元戎启行和周光代表AI与自动驾驶公司，探索了实现AGI的第二种可能性，展示了自动驾驶技术的广阔前景。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-23T14:04:30Z
- **目录日期**: 2025-03-23
