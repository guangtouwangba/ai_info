...
元戎启行CEO周光在英伟达GTC 2025上提出了一种新的自动驾驶技术路径——RoadAGI，旨在通过不依赖高精地图的方式，实现垂直道路场景下的AGI（人工通用智能）。这一技术通过AI Spark平台赋能各种移动体，包括智能车、机器人等，使它们具备自主移动的能力。RoadAGI被视为一种更快实现大规模商用自动驾驶的新途径，代表了自动驾驶领域的第二种可能性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-23T17:04:19Z
- **目录日期**: 2025-03-23
