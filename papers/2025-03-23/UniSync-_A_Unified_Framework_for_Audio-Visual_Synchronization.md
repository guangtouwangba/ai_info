...
UniSync是一种新颖的音频-视频同步评估方法，通过嵌入相似性来处理不同音频和视觉表示（如Mel频谱、HuBERT、RGB图像、面部解析图等）。该方法采用对比学习框架，结合基于边际的损失和跨说话者不同步对，提升了判别能力。UniSync在标准数据集上表现优异，兼容多种音频-视觉表示，并在自然和AI生成内容中显著提高了同步质量。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-23T05:02:11Z
- **目录日期**: 2025-03-23
