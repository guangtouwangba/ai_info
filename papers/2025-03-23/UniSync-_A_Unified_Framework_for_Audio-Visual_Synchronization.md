...
UniSync是一种新颖的音频-视频同步评估方法，通过嵌入相似性来处理多种音频和视觉表示（如梅尔频谱、HuBERT、RGB图像、面部解析图等）。该方法采用对比学习框架，结合基于边界的损失组件和跨说话者不同步对，提升了判别能力。UniSync在标准数据集上表现优异，适用于多种音频-视频表示，并能集成到说话人脸生成框架中，显著提升自然和AI生成内容的同步质量。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-23T22:02:08Z
- **目录日期**: 2025-03-23
