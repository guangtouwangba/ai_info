...
UniSync是一种新颖的音频-视频同步评估方法，通过嵌入相似性来处理多种音频和视觉表示（如Mel频谱、HuBERT、RGB图像、面部解析图等）。它采用对比学习框架，结合基于边界的损失和跨说话者不同步对，提高了判别能力。UniSync在标准数据集上优于现有方法，并在多种音频-视频表示中表现出广泛的适用性。其集成到说话人脸生成框架中，显著提升了自然和AI生成内容的同步质量。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-23T07:02:20Z
- **目录日期**: 2025-03-23
