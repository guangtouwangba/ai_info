...
苹果因AI功能跳票在美国加州面临集体诉讼。苹果在发布iPhone 16时大力宣传Apple Intelligence，承诺为Siri带来革命性AI功能，吸引大量用户购买。然而，这些功能一再推迟上线，导致用户未能体验到预期功能。用户指控苹果广告存在虚假宣传，误导消费者对产品功能的认知，并已向法院提起诉讼。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-23T00:04:16Z
- **目录日期**: 2025-03-23
