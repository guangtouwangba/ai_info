...
这篇论文探讨了代码生成大型语言模型（codeLLMs）的性能评估及其与人类偏好的对齐问题。研究提出了一个名为CodeArena的基准测试，包含397个高质量样本，覆盖40个类别和44种编程语言，以模拟现实编程任务的复杂性。此外，研究构建了一个包含近20B标记的合成指令语料库SynCode-Instruct，用于验证大规模合成指令微调的有效性。实验结果显示，开源顶级代码LLM与专有LLM之间存在显著性能差距，强调了与人类偏好对齐的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-23T23:05:28Z
- **目录日期**: 2025-03-23
