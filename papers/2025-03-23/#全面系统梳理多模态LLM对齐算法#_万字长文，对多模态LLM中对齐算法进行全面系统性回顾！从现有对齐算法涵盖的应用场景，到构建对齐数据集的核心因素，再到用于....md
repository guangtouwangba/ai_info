...
本文全面回顾了多模态大语言模型（MLLMs）中的对齐算法，涵盖了应用场景、数据集构建、评估方法和未来发展方向。文章指出，尽管MLLMs在处理视觉、听觉和文本等多模态数据方面取得进展，但在真实性、安全性和推理能力等方面仍面临挑战。对齐算法通过减少幻觉、确保安全性和改善推理能力，成为解决这些问题的关键。文章还提出了未来研究方向，包括视觉信息整合和LLM对齐方法的经验启示。该研究由多个知名机构的研究人员共同完成。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-23T16:03:32Z
- **目录日期**: 2025-03-23
