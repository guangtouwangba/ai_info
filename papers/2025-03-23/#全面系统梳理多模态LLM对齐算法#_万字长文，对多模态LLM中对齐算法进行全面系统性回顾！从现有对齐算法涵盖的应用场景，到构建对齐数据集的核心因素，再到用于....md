...
本文全面回顾了多模态大语言模型（MLLMs）中的对齐算法，涵盖了应用场景、数据集构建、评估方法和未来发展方向。文章分类了现有算法，分析了数据集构建的核心因素，并总结了评估基准。未来发展方向包括视觉信息整合和LLM对齐方法的经验启示。研究由多个知名机构的研究人员共同完成，旨在解决MLLMs在真实性、安全性和推理能力等方面的挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-23T05:02:45Z
- **目录日期**: 2025-03-23
