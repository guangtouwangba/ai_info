...
本文全面回顾了多模态大语言模型（MLLMs）中的对齐算法，涵盖了应用场景、数据集构建、评估方法和未来发展方向。由于多模态数据的复杂性，MLLMs在真实性、安全性和推理能力方面面临挑战。对齐算法通过分类现有方法、分析数据集构建的核心因素、整理评估基准，并提出了未来发展方向，如视觉信息整合和LLM对齐方法的经验启示。该研究由多个知名机构的研究人员共同完成，为MLLMs的进一步发展提供了系统性的参考框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-23T17:03:16Z
- **目录日期**: 2025-03-23
