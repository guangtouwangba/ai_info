...
本文探讨了大型语言模型（LLM）作为评判者的应用与评估，详细定义了LLM评判者的概念，并从评判内容、方式和领域三个维度构建了分类体系。文章深入研究了LLM在评分、排名和选择等任务中的应用，汇总了评估LLM评判者的基准，并指出了关键挑战和潜在研究方向。研究旨在为这一新兴领域提供见解，并激发未来的研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-23T05:06:02Z
- **目录日期**: 2025-03-23
