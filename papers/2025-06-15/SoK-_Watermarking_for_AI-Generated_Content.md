...
随着生成式AI（GenAI）输出的质量提升，区分AI与人类生成内容变得愈发困难。水印技术通过嵌入隐藏信号来可靠检测AI生成内容，成为解决该问题的有效方法。虽然水印不能完全消除GenAI的所有风险，但能通过打击错误信息和欺骗行为，提升AI的安全性和可信度。本文全面综述了GenAI水印技术，包括其历史与监管需求、定义、特性、目标及威胁模型，并探讨了评估策略以开发抗攻击的鲁棒水印方案。此外，文章总结了代表性研究、开放挑战及未来方向，旨在指导研究并支持政策制定者应对GenAI的广泛影响。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T11:02:09Z
- **目录日期**: 2025-06-15
