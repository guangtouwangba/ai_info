...
随着生成式AI（GenAI）输出质量提升，区分其与人类创作内容愈发困难。数字水印技术通过嵌入隐藏信号实现可靠检测，成为解决该问题的有效手段。虽然水印不能完全消除GenAI风险，但能通过打击虚假信息增强AI安全性和可信度。本文系统梳理了GenAI水印技术，从历史与监管需求出发，形式化定义水印方案特性，分析核心目标与威胁模型，探讨抗攻击的鲁棒水印评估策略。通过综述代表性研究、现存挑战及未来方向，为研究者提供方法指导，并辅助政策制定者应对GenAI的广泛影响。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T16:02:31Z
- **目录日期**: 2025-06-15
