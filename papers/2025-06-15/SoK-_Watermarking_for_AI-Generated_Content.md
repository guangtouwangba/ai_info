...
随着生成式AI（GenAI）输出质量的提升，区分AI与人类生成内容愈发困难。数字水印技术通过嵌入隐藏信号实现可靠检测，成为解决该问题的有效方法。尽管水印不能完全消除GenAI的所有风险，但能通过打击虚假信息增强AI安全性和可信度。本文系统综述了GenAI水印技术，从历史与监管需求出发，形式化定义了水印方案的特性和目标，分析了现有方法的威胁模型与评估策略，并探讨了抗攻击鲁棒水印的开发。最后总结了代表性研究、开放挑战及未来方向，为研究者和政策制定者提供指导。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T13:09:09Z
- **目录日期**: 2025-06-15
