...
随着生成式AI（GenAI）输出的质量提升，区分AI与人类生成内容变得愈发困难。数字水印技术通过嵌入隐藏信号实现可靠检测，成为解决这一问题的有效方法。尽管水印技术无法完全应对GenAI的所有风险，但它在增强AI安全性和可信度、打击虚假信息方面具有关键作用。本文全面综述了GenAI水印技术，包括其历史与监管需求、定义、理想特性、核心目标及威胁模型，并探讨了实用评估策略以开发抗攻击的鲁棒水印方案。此外，文章总结了最新研究、开放挑战及未来方向，旨在为研究者和政策制定者提供指导。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T08:02:03Z
- **目录日期**: 2025-06-15
