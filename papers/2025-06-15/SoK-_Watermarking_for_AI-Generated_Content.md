...
随着生成式AI（GenAI）输出的质量提升，区分AI与人类生成内容变得愈发困难。数字水印技术通过嵌入隐藏信号来可靠识别AI生成内容，成为解决这一问题的有效方法。虽然水印并非应对GenAI所有风险的万能方案，但它在打击错误信息和欺骗行为、提升AI安全性与可信度方面至关重要。本文系统梳理了GenAI水印技术，从历史与监管角度阐述其必要性，定义水印方案的核心特性与目标，分析威胁模型及抗攻击评估策略，并总结代表性研究、现存挑战与未来方向，为研究者和政策制定者提供指导。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T01:30:04Z
- **目录日期**: 2025-06-15
