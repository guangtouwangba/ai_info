...
AgentSociety是一个基于大型语言模型的大规模社会模拟器，可模拟1万多个代理的社会生活及500万次互动。研究者用它研究极化现象、信息传播、基本收入政策及飓风影响等社会问题，结果与现实实验吻合，验证了其模拟人类行为和社会机制的能力。该系统可作为社会科学研究和政策制定的有力工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T05:03:51Z
- **目录日期**: 2025-06-15
