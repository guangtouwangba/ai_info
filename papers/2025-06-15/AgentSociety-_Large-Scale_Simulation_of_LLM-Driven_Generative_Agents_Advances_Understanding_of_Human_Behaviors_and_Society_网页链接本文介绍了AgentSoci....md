...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个代理及其500万次社会互动。研究者利用该系统研究了社会极化、信息传播、基本收入政策及自然灾害影响等社会问题，结果与现实数据吻合。该系统展示了作为计算社会科学研究工具的潜力，能帮助理解人类行为机制并辅助政策制定。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T03:29:49Z
- **目录日期**: 2025-06-15
