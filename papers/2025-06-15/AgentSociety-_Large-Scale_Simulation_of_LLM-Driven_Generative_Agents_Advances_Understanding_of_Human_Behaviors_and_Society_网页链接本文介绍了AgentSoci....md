...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟1万多个代理的社会互动（500万次）。它被用于研究社会极化、信息传播、基本收入政策及自然灾害影响等问题，结果与现实世界数据吻合。该系统展示了作为社会科学研究工具和政策测试平台的潜力，能有效捕捉人类行为机制，辅助传统研究方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T09:04:27Z
- **目录日期**: 2025-06-15
