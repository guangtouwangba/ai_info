...
AgentSociety是一个基于大型语言模型的大规模社会模拟器，可模拟10,000多个代理及其500万次互动。该平台用于研究社会极化、信息传播、基本收入政策及自然灾害影响等关键问题。其模拟结果与现实数据吻合，验证了模型捕捉人类行为和社会机制的能力，展示了作为社会科学研究和政策制定工具的潜力。通过整合LLM代理、真实环境和大规模模拟引擎，AgentSociety为传统研究方法提供了补充，有助于深入理解社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T12:04:20Z
- **目录日期**: 2025-06-15
