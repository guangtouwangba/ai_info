...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟10,000+个智能代理及其500万次社会互动。该系统通过四个社会实验（政治极化、信息传播、基本收入政策、飓风影响）验证了其有效性，模拟结果与现实数据高度吻合。研究证明该系统能有效捕捉人类行为机制，为社会科学研究和政策制定提供了新型计算实验平台，可辅助传统研究方法（如调查、访谈）深入分析社会问题的成因和规律。该成果展示了LLM在社会仿真领域的应用潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T01:32:01Z
- **目录日期**: 2025-06-15
