...
AgentSociety是一种基于大语言模型的大规模社会模拟器，可模拟超过1万个代理及其500万次互动。研究者利用该平台研究了社会极化、信息传播、基本收入政策和自然灾害影响等社会问题。模拟结果与现实世界数据高度吻合，验证了该系统捕捉人类行为机制的能力。这一工具为社会科学研究和政策制定提供了新方法，能够补充传统调查和实验的不足，有助于深入理解社会问题的成因和潜在解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T13:12:15Z
- **目录日期**: 2025-06-15
