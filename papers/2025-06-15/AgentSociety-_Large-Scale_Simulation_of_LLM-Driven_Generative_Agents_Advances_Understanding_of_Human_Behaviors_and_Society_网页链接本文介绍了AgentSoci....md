...
AgentSociety是一种基于大语言模型的大规模社会模拟系统，可模拟1万多个智能代理及其500万次互动。该系统通过研究社会极化、信息传播、基本收入政策及自然灾害影响等案例，验证了其模拟结果与现实世界数据的一致性。研究表明，AgentSociety能有效捕捉人类行为机制，为社会科学研究和政策制定提供新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T14:03:52Z
- **目录日期**: 2025-06-15
