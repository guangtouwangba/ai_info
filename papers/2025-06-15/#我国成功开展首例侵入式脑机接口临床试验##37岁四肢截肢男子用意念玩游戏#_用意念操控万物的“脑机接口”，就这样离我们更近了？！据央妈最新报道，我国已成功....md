...
我国成功开展首例侵入式脑机接口临床试验，由中科院脑智卓越中心联合华山医院等机构完成。一位四肢截肢的37岁男子通过植入全球最小、柔性最强的神经电极（硬币大小，电极丝为头发丝的1/100），实现了意念操控五子棋游戏和发短信等功能。该技术短期目标是让患者控制机械臂完成抓握等动作，长期或拓展至机器狗等智能设备操控。我国成为全球第二个进入该领域临床试验的国家，其植入体尺寸和柔性均优于马斯克的Neuralink。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T22:02:28Z
- **目录日期**: 2025-06-15
