...
中国成功完成首例侵入式脑机接口临床试验，由中科院与华山医院团队合作实现。一名37岁四肢截肢患者通过植入全球最小（硬币大小）、最柔性（发丝1/100）的神经电极，实现意念操控五子棋、发短信等功能。该技术使我国成为继马斯克Neuralink后全球第二个进入该领域临床阶段的国家。短期目标将测试机械臂抓握功能，长期或拓展至控制智能机器人。该突破在植入体尺寸（Neuralink的1/2）和电极柔性（超Neuralink百倍）上具有显著优势，标志着脑机接口技术迈向实用化重要一步。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T13:10:10Z
- **目录日期**: 2025-06-15
