...
我国成功开展首例侵入式脑机接口临床试验，由中科院脑智卓越中心联合华山医院等机构完成。一位37岁四肢截肢男子通过植入全球最小、柔性最强的神经电极（硬币大小，电极丝为头发丝的1/100），实现意念操控五子棋游戏和发短信等功能。该技术超越马斯克Neuralink的部分指标，使我国成为全球第二个进入侵入式脑机接口临床试验的国家。下一步计划短期实现机械臂抓握，长期探索控制智能设备。这一突破标志着脑机接口技术迈向实际应用的重要进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T07:02:21Z
- **目录日期**: 2025-06-15
