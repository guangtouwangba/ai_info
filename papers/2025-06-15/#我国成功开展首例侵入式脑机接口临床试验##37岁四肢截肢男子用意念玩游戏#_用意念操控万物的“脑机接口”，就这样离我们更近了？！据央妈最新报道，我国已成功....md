...
我国成功开展首例侵入式脑机接口临床试验，由中科院与华山医院等合作完成。一位37岁四肢截肢男子通过植入全球最小、柔性最强的神经电极（硬币大小，电极丝为头发1/100），实现意念操控五子棋、发短信等功能。该技术使我国成为继马斯克Neuralink后全球第二个进入侵入式脑机临床阶段的国家。短期目标为机械臂抓握，长期或拓展至机器狗等智能设备控制。该突破标志着我国在脑机接口硬件（尺寸/柔性超越Neuralink）和临床应用迈出关键一步。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T18:04:01Z
- **目录日期**: 2025-06-15
