...
随着AI视频生成技术的快速发展，其带来的信息可信度危机催生了检测技术的需求。针对现有高质量真实场景数据集的缺乏，研究者提出了GenWorld数据集，具有三大特点：(1)真实场景模拟；(2)采用多SOTA模型生成高质量伪造视频；(3)涵盖多生成器和多提示模态的跨提示多样性。研究发现现有方法难以检测世界模型(如Cosmos)生成的视频，因此提出了基于多视角一致性的SpannDetector模型。实验证明该方法效果显著，为基于物理合理性的可解释AI视频检测指明方向。GenWorld有望推动该领域发展。项目页：https://chen-wl20.github.io/GenWorld

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T06:00:50Z
- **目录日期**: 2025-06-15
