...
随着视频生成技术的快速发展，AI生成视频检测的需求日益迫切。本文提出GenWorld数据集，具有三大特点：(1) 真实场景模拟，关注高影响力的现实世界视频；(2) 采用多种先进视频生成模型，确保高质量伪造视频；(3) 包含多生成器和多提示模态，增强泛化性。研究发现现有方法难以检测世界模型(如Cosmos)生成的高质量视频，因此提出SpannDetector模型，利用多视角一致性作为检测标准。实验表明该方法效果显著，为基于物理合理性的可解释AI视频检测提供了新方向。GenWorld有望推动该领域发展。项目页面见链接。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T01:29:02Z
- **目录日期**: 2025-06-15
