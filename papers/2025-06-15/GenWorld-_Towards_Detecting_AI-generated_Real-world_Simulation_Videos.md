...
随着AI视频生成技术的快速发展，检测伪造视频的需求日益迫切。本文提出GenWorld数据集，包含高质量、多样化的真实场景模拟视频，涵盖多种生成模型和提示方式（文本、图像、视频）。研究发现现有方法难以检测世界模型（如Cosmos）生成的高质量视频，为此提出SpannDetector模型，利用多视角一致性作为检测标准。实验表明该方法效果显著，为基于物理合理性的可解释AI视频检测提供了新方向。GenWorld有望推动该领域发展。项目页面：https://chen-wl20.github.io/GenWorld

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T12:00:53Z
- **目录日期**: 2025-06-15
