...
视频生成技术的快速发展威胁了真实信息的可信度，加剧了对AI生成视频检测的需求。现有方法因缺乏高质量真实场景数据集而受限。为此，研究团队提出**GenWorld**——一个大规模、高质量、模拟真实世界的AI生成视频检测数据集，其特点包括：(1)真实场景模拟；(2)采用先进模型生成高伪造质量视频；(3)涵盖多生成器及多模态提示（文本/图像/视频）。研究同时发现现有方法难以检测世界模型（如Cosmos）生成的视频，并提出**SpannDetector**模型，通过多视角一致性实现高效检测。实验表明该方法性能优越，为基于物理合理性的可解释检测提供了新方向。数据集将推动该领域发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T03:26:52Z
- **目录日期**: 2025-06-15
