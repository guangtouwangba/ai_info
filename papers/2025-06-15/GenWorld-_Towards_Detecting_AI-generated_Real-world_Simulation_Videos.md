...
随着视频生成技术的快速发展，AI生成视频的检测需求日益迫切。本文提出GenWorld——一个高质量、大规模、模拟真实场景的AI生成视频检测数据集，其特点包括：1) 聚焦真实世界场景模拟；2) 采用多种先进视频生成模型确保高质量伪造视频；3) 包含多生成器和多模态提示的跨提示多样性。研究发现现有方法难以检测世界模型(如Cosmos)生成的高质量视频，因此提出SpannDetector模型，利用多视角一致性作为检测标准。实验表明该方法效果显著，为基于物理合理性的可解释AI视频检测指明了新方向。项目页面见文末链接。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T05:00:48Z
- **目录日期**: 2025-06-15
