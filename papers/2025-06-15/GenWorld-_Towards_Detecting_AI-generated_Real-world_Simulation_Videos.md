...
随着AI视频生成技术的快速发展，真实信息的可信度受到威胁，对AI生成视频检测的需求日益增长。然而，高质量真实世界数据集的缺乏阻碍了可靠检测器的发展。为此，研究者提出了GenWorld数据集，具有三大特点：(1)真实世界模拟场景；(2)采用先进模型生成高质量伪造视频；(3)包含多样生成器和多模态提示。研究发现现有方法难以检测世界模型(如Cosmos)生成的视频，因此提出SpannDetector模型，利用多视角一致性作为检测标准。实验表明该方法效果显著，为基于物理合理性的可解释AI视频检测提供了新方向。GenWorld有望推动该领域发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T16:01:05Z
- **目录日期**: 2025-06-15
