...
Dia浏览器是Arc团队推出的首个AI原生浏览器，目前开启内测。其核心功能包括：1) 无需调用ChatGPT即可直接与任意网页对话（如官网咨询产品）；2) 智能比较不同网页内容（如手机参数对比）；3) 视频内容解析（自动总结/定位时间点）。该浏览器能自动识别标签页上下文，支持YouTube/谷歌日历等多平台交互。早期测试显示用户体验显著优于传统浏览器，尤其网页对话功能最受欢迎。目前仅限Arc会员体验，被部分用户视为可能替代Chrome的下一代工具。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T21:02:41Z
- **目录日期**: 2025-06-15
