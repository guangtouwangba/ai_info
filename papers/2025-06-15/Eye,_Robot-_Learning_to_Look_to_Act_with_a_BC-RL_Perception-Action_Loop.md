...
研究人员开发了EyeRobot系统，通过强化学习训练机械眼球主动注视以辅助机器人完成任务。该系统采用360°摄像头收集演示数据，并在仿真环境中训练眼球注视策略。通过"行为克隆-强化学习"循环联合训练手部（BC）和眼球（RL）动作：眼球获得奖励当手部能基于其观察做出正确动作。这种协调机制使眼球自然聚焦于对任务完成关键的视野区域。系统采用类似人类中央凹的架构，在有限算力下实现高分辨率观察，表现出更稳定的注视和抗干扰能力。实验表明，单摄像头即可有效支持大范围工作空间的操作任务。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T09:01:23Z
- **目录日期**: 2025-06-15
