...
研究人员开发了EyeRobot系统，通过强化学习训练机械眼球自主注视策略，实现手眼协同操作。该系统采用360度摄像头收集演示数据，在仿真环境中训练眼球注视策略，并通过BC-RL联合训练方法使眼球自动关注对手部操作有利的区域。机械眼球采用类似人眼中央凹的高分辨率架构，在低计算成本下实现稳定注视和物体追踪能力。实验表明，EyeRobot能在单摄像头支持下有效完成环绕机械臂的大范围操作任务。该系统展示了基于任务需求的自然注视行为如何提升机器人操作性能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T05:01:02Z
- **目录日期**: 2025-06-15
