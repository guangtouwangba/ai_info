...
研究人员开发了EyeRobot系统，通过强化学习训练机械眼球自主注视策略，实现手眼协同完成任务。该系统采用360°摄像头采集演示数据，在仿真环境中训练眼球注视策略，并通过BC-RL联合训练框架：手部(BC)基于眼球观测学习动作，眼球(RL)则因手部动作预测准确而获得奖励。这种设计使眼球自然注视对手部任务有用的区域，同时采用类中央凹的视觉架构，在低计算成本下实现高分辨率观测，表现出稳定的注视能力和抗干扰性。实验表明，该系统能在单摄像头下有效完成大范围操作任务。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T19:01:39Z
- **目录日期**: 2025-06-15
