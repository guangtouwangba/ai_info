...
研究人员开发了EyeRobot系统，通过强化学习训练机械眼球自主转动观察环境，实现手眼协同完成任务。该系统采用360°摄像头采集演示数据，在仿真环境中训练基于BC-RL联合学习框架：手部(BC)根据眼球观测执行动作，眼球(RL)通过手部动作准确性获得奖励。采用仿中央凹视觉的架构，以低计算成本实现高分辨率观测，表现出稳定注视、目标追踪和抗干扰能力。在5个环绕机械臂的全景操作任务测试中，单摄像头即可有效支持大范围工作空间的操作。项目详情见：https://www.eyerobot.net/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T21:01:16Z
- **目录日期**: 2025-06-15
