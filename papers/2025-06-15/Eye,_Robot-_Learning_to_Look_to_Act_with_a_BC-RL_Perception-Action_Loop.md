...
研究人员开发了EyeRobot系统，通过强化学习训练机械眼球自主注视策略，实现手眼协同完成任务。该系统采用360°摄像头采集演示数据，在仿真环境中训练眼球注视策略，并通过BC-RL联合训练方法：手部(BC)根据眼球观察学习动作，眼球(RL)则通过手部动作准确性获得奖励。实验表明，该系统能在全景工作空间完成五项操作任务，其仿生注视架构实现了高分辨率观察、稳定注视和目标跟踪能力。EyeRobot证明了单一摄像头即可支持大范围工作空间的操作任务。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T18:01:21Z
- **目录日期**: 2025-06-15
