...
研究人员开发了EyeRobot系统，通过机械眼球和强化学习实现仿人眼动的任务导向型注视行为。该系统采用360°摄像头收集演示数据，在仿真环境中训练手-眼协同策略：手部（行为克隆）基于眼球观测执行动作，而眼球（强化学习）通过优化手部动作准确性获得奖励。其仿视网膜中央凹的架构实现了高分辨率低算力需求，并表现出稳定注视、目标跟踪和抗干扰能力。在5种环绕式操作任务测试中，EyeRobot单摄像头即可有效支持大范围工作空间的操作，验证了任务驱动的主动视觉机制优势。（项目网站：https://www.eyerobot.net/）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T12:01:08Z
- **目录日期**: 2025-06-15
