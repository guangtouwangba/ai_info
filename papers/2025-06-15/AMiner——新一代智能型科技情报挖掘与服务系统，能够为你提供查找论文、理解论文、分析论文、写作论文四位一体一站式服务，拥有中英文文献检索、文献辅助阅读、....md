...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析与写作一站式服务。平台支持中英文文献搜索、AI辅助阅读、自动摘要生成及翻译功能，涵盖3.5亿论文和1.5亿专利数据。其特色包括：1）智能问答快速理解文献；2）PDF上传解析与章节概要生成；3）定制化科研动态推送（通过微信/邮件）；4）学者画像等拓展功能。用户可免费使用浏览器版，实现高效学术信息获取与研究效率提升。访问入口：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T06:04:18Z
- **目录日期**: 2025-06-15
