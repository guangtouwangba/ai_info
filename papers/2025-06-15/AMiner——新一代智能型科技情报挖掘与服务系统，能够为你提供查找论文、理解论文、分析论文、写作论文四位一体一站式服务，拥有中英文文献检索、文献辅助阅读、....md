...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作一站式服务。它支持中英文文献搜索、AI辅助阅读、自动摘要生成和翻译功能，涵盖42个学科的3.5亿论文资源。用户可通过互动问答快速理解文献内容，并订阅个性化科研动态推送。平台还支持PDF文档解析、学者画像分析及学术会议追踪，帮助研究者高效获取前沿信息。基础功能免费开放，访问入口：https://www.aminer.cn/。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T14:04:19Z
- **目录日期**: 2025-06-15
