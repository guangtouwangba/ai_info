...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、辅助阅读、翻译和科研情报订阅。它拥有海量学术资源（3.5亿论文、0.6亿学者等），支持互动问答、自动摘要生成和文献分析。用户可上传PDF或搜索论文，获取AI生成的摘要和章节概要，并通过对话深入理解内容。平台还提供个性化科研动态推送，支持学者画像、学术会议追踪等功能。基础服务免费，适合科研人员高效获取和管理学术信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T20:09:28Z
- **目录日期**: 2025-06-15
