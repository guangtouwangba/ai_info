...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、辅助阅读、翻译和科研动态订阅。它覆盖42个学科，拥有3.5亿论文、0.6亿学者等海量数据。用户可通过互动问答快速获取文献摘要，上传PDF生成章节概要，还能定制关键词推送最新研究。平台还支持学者画像、学术会议追踪等功能，基础服务免费开放，助力高效科研。访问官网或AI交互页即可体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T18:08:22Z
- **目录日期**: 2025-06-15
