...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作一站式服务。它支持中英文文献搜索、AI辅助阅读、自动摘要生成和翻译功能，涵盖3.5亿论文、0.6亿学者等海量数据。用户可通过互动问答快速理解文献，或上传PDF获取AI生成的摘要与章节概要。平台还提供科研动态订阅服务，按用户偏好推送最新论文。其他功能包括学者画像、学术会议追踪和论文排行榜。AMiner支持浏览器免费使用，旨在提升科研效率。  

网址：[AMiner官网](https://www.aminer.cn/) | [AI功能页](https://www.aminer.cn/chat/g/explain/)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T23:04:41Z
- **目录日期**: 2025-06-15
