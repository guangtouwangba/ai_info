...
AMiner是一个智能科技情报挖掘平台，提供四位一体的学术服务：论文检索、理解、分析和写作支持。它涵盖42个学科，收录3.5亿论文、0.6亿学者和1.5亿专利。主要功能包括：1）中英文文献检索，支持智能问答和自动摘要生成；2）英文文献翻译与辅助阅读，可上传PDF并获取AI生成的摘要和章节概要；3）科研情报订阅，按用户偏好推送最新研究动态。此外，还提供学者画像、学术会议和论文排行榜等功能。平台支持免费使用，旨在提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T00:04:56Z
- **目录日期**: 2025-06-15
