...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、科研订阅等一站式服务。其核心功能包括：1）精准检索3.5亿论文资源，支持AI生成摘要和互动问答；2）支持PDF文档解析，提供章节概要和内容问答；3）定制化科研动态推送，跟踪学者/机构最新成果。平台覆盖42个学科，整合论文、专利、学者等数据，免费提供文献辅助阅读、学术画像等服务，显著提升科研效率。访问入口：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T03:30:09Z
- **目录日期**: 2025-06-15
