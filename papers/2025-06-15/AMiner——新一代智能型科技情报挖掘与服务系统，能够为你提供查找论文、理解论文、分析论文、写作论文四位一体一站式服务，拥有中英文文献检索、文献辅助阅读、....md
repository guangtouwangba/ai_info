...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、辅助阅读、翻译、论文写作支持等。其核心功能包括：1）高效检索3.5亿论文资源；2）AI生成摘要与互动问答；3）文献翻译与内容解析；4）定制化科研动态推送。平台覆盖42个学科，整合学者、专利及项目数据，支持PDF上传智能分析。用户可通过网页或微信小程序免费使用基础功能，实现高效文献管理与学术追踪。特色服务包含学者画像、会议追踪及学术排行榜等，显著提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T10:04:35Z
- **目录日期**: 2025-06-15
