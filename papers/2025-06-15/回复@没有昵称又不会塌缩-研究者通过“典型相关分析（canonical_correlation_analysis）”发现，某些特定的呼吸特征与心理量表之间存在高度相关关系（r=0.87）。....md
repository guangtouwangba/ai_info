...
以色列魏茨曼科学研究所最新研究发现，人类具有独特的"呼吸指纹"，个体识别准确率达96.8%。通过可穿戴设备监测100名志愿者日常活动数据，发现呼吸模式能反映心理状态：焦虑者吸气时间短，抑郁者呼气停顿长，自闭特质者睡眠时呼吸不规律。研究提出逆向视角，认为呼吸可能影响情绪而非相反，暗示通过调整呼吸模式或可改善心理健康。该研究为呼吸模式与心理健康的关联提供了新证据，未来或可开发基于呼吸调节的身心健康干预方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T08:03:18Z
- **目录日期**: 2025-06-15
