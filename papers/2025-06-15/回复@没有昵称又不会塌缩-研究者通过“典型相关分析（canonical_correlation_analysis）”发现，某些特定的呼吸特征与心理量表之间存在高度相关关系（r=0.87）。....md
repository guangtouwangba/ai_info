...
以色列魏茨曼科学研究所最新研究发现，人类呼吸模式具有独特性，可作为"呼吸指纹"识别个体，准确率达96.8%。研究还发现特定呼吸特征与心理状态相关：焦虑者吸气时间短、夜间呼吸变化大；抑郁者呼气停顿长、吸气峰值高；自闭特质者睡眠时吸气暂停久、呼吸不规律。研究者提出逆向视角，认为呼吸可能影响情绪而非相反，计划通过引导健康呼吸模式来改善心理健康。该研究使用可穿戴设备监测100名志愿者日常活动中的呼吸数据，发现呼吸特征具有长期稳定性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T07:03:14Z
- **目录日期**: 2025-06-15
