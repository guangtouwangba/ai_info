# 回复@没有昵称又不会塌缩:研究者通过“典型相关分析（canonical correlation analysis）”发现，某些特定的呼吸特征与心理量表之间存在高度相关关系（r=0.87）。...
...
以色列魏茨曼科学研究所最新研究发现，人类具有独特的"呼吸指纹"，个体识别准确率达96.8%。研究通过可穿戴设备监测100名志愿者日常活动时的呼吸数据，发现呼吸模式不仅能准确识别个体，还与心理状态相关：焦虑者吸气时间短、夜间呼吸变化大；抑郁者呼气停顿长、吸气峰值高；自闭特质者睡眠时吸气暂停久、呼吸不规律。研究者提出"呼吸影响情绪"的逆向视角，认为引导健康呼吸模式可能改善心理健康。该研究为呼吸模式与心理健康的关联提供了新证据，未来或可用于心理干预。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T06:03:03Z
- **目录日期**: 2025-06-15
