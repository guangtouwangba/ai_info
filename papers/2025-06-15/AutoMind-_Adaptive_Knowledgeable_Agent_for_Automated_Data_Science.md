...
大型语言模型（LLM）代理在解决现实数据科学问题上潜力巨大，但现有框架依赖固定流程和编码策略，仅能处理简单任务，难以应对复杂创新问题。为此，研究团队提出AutoMind框架，通过三大创新提升性能：(1) 构建专家知识库增强领域专业性，(2) 采用智能树搜索算法优化解决方案探索，(3) 开发自适应编码策略动态调整代码生成。在两项自动化数据科学基准测试中，AutoMind表现优于现有最佳方案，验证了其在效率、质量和鲁棒性上的优势，推动了全自动化数据科学的发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T01:29:10Z
- **目录日期**: 2025-06-15
