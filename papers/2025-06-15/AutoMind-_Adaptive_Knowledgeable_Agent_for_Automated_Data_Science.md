...
大型语言模型(LLM)代理在解决现实数据科学问题方面潜力巨大，但现有框架依赖固定流程和编码策略，仅能处理简单问题。AutoMind提出三点创新：(1)构建专家知识库增强领域认知；(2)采用知识树搜索算法策略性探索解决方案；(3)自适应性编码策略动态调整代码生成。实验表明，AutoMind在自动化数据科学基准测试中优于现有方法，展现出高效性、鲁棒性和优质解决方案质量，推动数据科学全自动化进程。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T22:00:54Z
- **目录日期**: 2025-06-15
