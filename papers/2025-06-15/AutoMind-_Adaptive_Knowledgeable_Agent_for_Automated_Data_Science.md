...
大型语言模型（LLM）代理在解决现实数据科学问题方面潜力巨大，但现有框架依赖僵化流程，难以应对复杂任务。为此，研究者提出AutoMind框架，通过三大创新提升性能：(1) 整合专家知识库增强领域认知，(2) 采用智能树搜索算法探索解决方案，(3) 自适应代码生成策略动态调整任务复杂度。实验表明，该框架在自动化数据科学基准测试中显著优于现有方法，在效率、质量和鲁棒性方面表现优异，推动了全自动化数据科学的发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T03:26:59Z
- **目录日期**: 2025-06-15
