...
大型语言模型（LLM）代理在解决现实世界数据科学问题方面潜力巨大，但现有框架依赖僵化的工作流程和编码策略，仅适用于简单任务。为此，研究者提出AutoMind框架，通过三个关键创新克服局限：（1）基于领域专家知识的精选知识库；（2）智能树搜索算法探索解决方案；（3）自适应编码策略动态调整代码生成。实验表明，AutoMind在自动化数据科学基准测试中优于现有方法，展现出高效性、鲁棒性和优质解决方案，推动了全自动数据科学的发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T06:00:57Z
- **目录日期**: 2025-06-15
