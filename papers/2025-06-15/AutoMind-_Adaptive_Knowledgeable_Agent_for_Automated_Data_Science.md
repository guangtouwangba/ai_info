...
大型语言模型(LLM)代理在解决现实数据科学问题方面潜力巨大，但现有框架依赖固定工作流程和编码策略，难以处理复杂任务。为此，研究者提出AutoMind框架，通过三个关键创新：(1)构建专家知识库提供领域知识支持；(2)采用知识树搜索算法策略性探索解决方案；(3)实施自适应编码策略动态调整代码生成。实验表明，AutoMind在自动化数据科学基准测试中表现优于现有方法，在效率、效果和解决方案质量方面均有优势，为实现全自动化数据科学迈出重要一步。(99字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T20:01:27Z
- **目录日期**: 2025-06-15
