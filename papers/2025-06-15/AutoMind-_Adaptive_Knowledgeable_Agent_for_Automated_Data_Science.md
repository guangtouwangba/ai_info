...
大型语言模型（LLM）代理在解决现实数据科学问题上潜力巨大，但现有框架依赖固定流程和编码策略，仅适用于简单任务，难以应对复杂创新需求。本文提出AutoMind框架，通过三大创新突破局限：（1）构建专家知识库以增强领域专业性；（2）采用智能树搜索算法策略性探索解决方案；（3）开发自适应编码策略动态调整代码生成。在两项自动化数据科学基准测试中，AutoMind表现优于现有最优方法，验证了其在效率、质量和鲁棒性方面的优势，推动了全自动化数据科学的发展进程。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T08:00:59Z
- **目录日期**: 2025-06-15
