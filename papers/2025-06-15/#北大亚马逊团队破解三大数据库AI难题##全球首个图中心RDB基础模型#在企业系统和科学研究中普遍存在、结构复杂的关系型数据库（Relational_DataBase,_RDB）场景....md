...
北京大学张牧涵团队与亚马逊云科技合作开发了全球首个图中心RDB基础模型Griffin，解决了关系型数据库(RDB)在AI应用中的三大难题。该模型创新性地将RDB视为动态异质图进行建模，通过超过1.5亿行表格数据的预训练和监督微调，实现了优异的迁移性和泛化能力。Griffin突破了传统大模型在多表交互和异质特征处理上的局限，为结构化数据场景提供了新的AI解决方案。这项成果已被国际顶级会议ICML 2025接收。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T17:04:17Z
- **目录日期**: 2025-06-15
