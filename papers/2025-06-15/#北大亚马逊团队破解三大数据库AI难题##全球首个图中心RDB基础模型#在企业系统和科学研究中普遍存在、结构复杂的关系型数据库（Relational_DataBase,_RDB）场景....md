# #北大亚马逊团队破解三大数据库AI难题##全球首个图中心RDB基础模型#在企业系统和科学研究中普遍存在、结构复杂的关系型数据库（Relational DataBase, RDB）场景...
...
北京大学张牧涵团队联合亚马逊云科技提出Griffin模型，这是全球首个以图为中心的关系型数据库(RDB)基础模型。该模型将RDB视为动态异质图进行建模，通过在超1.5亿行表格数据上的预训练和监督微调，解决了传统大模型在多表交互和异质特征场景下的应用难题。Griffin具备良好的可迁移性和泛化能力，其研究成果已被ICML 2025接收。这一突破性进展填补了RDB场景下基础模型研究的空白，为复杂结构化数据的AI处理提供了新范式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T16:02:48Z
- **目录日期**: 2025-06-15
