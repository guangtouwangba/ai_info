...
北京大学张牧涵团队与亚马逊云科技合作开发了全球首个图中心RDB基础模型Griffin。该模型创新性地将关系型数据库(RDB)视为动态异质图进行建模，解决了传统大模型在多表交互和异质特征场景下的应用难题。通过在超1.5亿行表格数据上进行预训练和监督微调，Griffin展现出优异的迁移能力和泛化性能。这一突破性成果已获国际顶级会议ICML 2025接收，标志着结构化数据AI处理的重要进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T21:02:25Z
- **目录日期**: 2025-06-15
