...
这篇立场论文提出，当前基于大语言模型（LLM）的网页代理面临核心挑战：人类界面设计与AI能力不匹配。现有方法在处理DOM树、增强截图或API交互时存在局限。作者主张范式转变，建议开发专为AI优化的"代理式网页界面"（AWI），并提出六大设计原则：安全性、效率和标准化等，以平衡各方利益。这种新交互范式旨在突破现有界面限制，推动更高效、可靠、透明的网页代理发展，需要机器学习社区的广泛协作。该方案为自动化复杂网页任务提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T20:02:12Z
- **目录日期**: 2025-06-15
