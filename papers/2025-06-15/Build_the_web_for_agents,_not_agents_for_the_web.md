...
这篇立场论文提出，当前基于大语言模型（LLM）的网页代理面临核心挑战：人类设计的界面与AI能力不匹配。现有方法在处理复杂网页输入时存在局限，无论是解析DOM树、依赖增强截图还是通过API交互。作者主张范式转变，建议开发专为AI优化的"代理式网页界面"（AWI），并提出六大设计原则：安全性、效率和标准化等，以平衡各方利益。这一新范式旨在克服现有界面的根本限制，推动更高效、可靠和透明的网页代理设计，需要机器学习社区的广泛协作。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T05:01:16Z
- **目录日期**: 2025-06-15
