...
这篇立场论文主张改变网页代理的研究范式，提出应开发专为AI代理优化的新型交互界面（AWI），而非强迫代理适应人类设计的界面。当前方法因网页输入复杂性（如DOM树庞大、依赖截图或API交互）面临挑战。AWI基于六大设计原则，注重安全性、效率和标准化，以平衡各方利益。这一转变旨在克服现有界面的根本局限，推动更高效、可靠、透明的网页代理发展，需要机器学习社区的广泛协作。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T06:01:19Z
- **目录日期**: 2025-06-15
