...
这篇立场论文主张改变当前网页代理的研究范式，提出应开发专为AI代理优化的新型交互界面（AWI），而非迫使其适应人类设计的界面。现有方法因网页输入复杂性和人机界面不匹配而面临挑战。AWI基于六大设计原则（安全性、效率性、标准化等），旨在克服传统界面的根本局限，为所有利益相关方服务。这种重构有望实现更高效、可靠、透明的网页代理设计，需要机器学习社区的广泛协作。该研究为自动化复杂网页交互提供了新方向，推动网络环境中的自主任务完成能力发展。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T02:37:45Z
- **目录日期**: 2025-06-15
