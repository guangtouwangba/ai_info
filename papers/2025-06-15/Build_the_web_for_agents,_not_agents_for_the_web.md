...
这篇立场论文提出，当前基于大语言模型（LLM）的网络代理面临人机界面不匹配的核心挑战。作者主张转变研究范式，建议开发专为AI代理优化的"代理式网络界面"（AWI），而非让代理适应人类界面。AWI设计遵循安全性、效率和标准化等六项原则，旨在克服现有界面的根本局限。这种新范式将促进更高效、可靠且透明的网络代理发展，需要机器学习社区的广泛协作。该方案试图解决现有方法在处理DOM树、屏幕截图或API交互时面临的网页输入复杂性难题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T16:01:44Z
- **目录日期**: 2025-06-15
