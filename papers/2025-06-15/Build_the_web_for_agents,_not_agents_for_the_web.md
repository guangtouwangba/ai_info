...
当前大语言模型（LLM）和多模态技术的发展推动了网页智能代理（Web Agent）的研究，旨在实现自主完成网页任务。然而，现有方法因人类界面与LLM能力不匹配而面临挑战，如处理复杂DOM树、依赖增强截图或绕过界面直接调用API。为此，本文提出转向“面向代理的网页界面”（AWI），专为AI代理设计而非人类。AWI遵循安全性、高效性和标准化等六大原则，平衡多方利益。这一新范式有望突破现有界面限制，推动更高效、可靠、透明的网页代理发展，需机器学习社区共同协作实现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T12:01:25Z
- **目录日期**: 2025-06-15
