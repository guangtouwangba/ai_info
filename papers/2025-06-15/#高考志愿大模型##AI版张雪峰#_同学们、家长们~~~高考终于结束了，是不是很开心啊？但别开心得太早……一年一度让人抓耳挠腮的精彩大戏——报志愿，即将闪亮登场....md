...
夸克发布了国内首个免费高考志愿大模型，5分钟即可生成完整志愿报告。该AI基于数百位专家经验，将院校分为冲击层（19所）、稳妥层（38所）和保底层（39所），提供近100个志愿明细及核心策略分析。传统志愿咨询服务价格昂贵（数千至上万元），且仅2%考生能获取。该技术旨在解决信息不对称问题，其准确性仍需验证，但标志着AI对传统高考咨询行业的革新尝试。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T01:31:00Z
- **目录日期**: 2025-06-15
