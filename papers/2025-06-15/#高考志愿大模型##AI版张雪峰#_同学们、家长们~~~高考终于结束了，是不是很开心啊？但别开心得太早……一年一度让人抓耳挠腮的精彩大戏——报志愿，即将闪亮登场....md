...
夸克推出了国内首个免费高考志愿填报AI大模型，5分钟即可生成完整志愿报告。该AI基于数百位专家经验，将院校分为"冲击/稳妥/保底"三层，提供近百个志愿明细，并分析考生情况与填报策略。相比动辄数千元的人工咨询服务（仅2%考生使用），该工具旨在解决传统志愿填报存在的信息差和高收费问题。目前测试显示其生成结果直观专业，但实际可靠性仍需验证。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T05:03:05Z
- **目录日期**: 2025-06-15
