...
这篇论文探讨了在人类与AI协作中"认知摩擦"的重要性，即当新信息与现有信念冲突时产生的阻力。作者提出了"动态认知摩擦"的概念，将其定义为智能体当前信念状态与外部证据支持的新命题之间的不匹配。研究基于动态认知逻辑框架，分析了协作任务中的对话数据，表明该模型能有效预测对话中的信念更新。最后讨论了如何完善这一模型，以更好地适应现实对话场景的复杂性。研究强调了在大型语言模型对齐人类偏好时考虑认知摩擦的关键作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T03:27:40Z
- **目录日期**: 2025-06-15
