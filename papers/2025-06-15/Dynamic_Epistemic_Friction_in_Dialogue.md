...
该研究探讨了大型语言模型(LLMs)与人类偏好对齐中的"认知摩擦"问题，即当新信息与现有信念冲突时产生的整合阻力。作者提出"动态认知摩擦"概念，将其定义为代理当前信念状态与外部证据支持的新命题之间的错位，并基于动态认知逻辑框架进行建模。研究表明，这种认知摩擦模型能有效预测对话中的信念更新过程。最后，作者讨论了如何通过测量认知阻力或摩擦来完善信念对齐模型，以更好地适应现实对话场景的复杂性。研究强调了在人类-AI协作中考虑认知摩擦的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T18:02:47Z
- **目录日期**: 2025-06-15
