...
该研究探讨了大型语言模型(LLMs)与人类协作中的"认知摩擦"问题，即当新信息与现有信念冲突时产生的整合阻力。作者提出"动态认知摩擦"概念，将其定义为智能体当前信念状态与外部证据支持的新命题之间的错位。研究基于动态认知逻辑框架，将摩擦视为交互过程中非平凡的信念修正。通过协作任务分析表明，该模型能有效预测对话中的信念更新。最后讨论了如何完善这一模型，使其能更好地适应现实对话场景的复杂性，从而提升LLMs在人类-AI协作中的效用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-15T01:29:51Z
- **目录日期**: 2025-06-15
