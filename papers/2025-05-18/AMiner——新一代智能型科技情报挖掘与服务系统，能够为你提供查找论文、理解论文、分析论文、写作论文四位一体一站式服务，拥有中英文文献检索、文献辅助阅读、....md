...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、科研订阅等一站式服务。它能帮助用户快速定位相关论文，自动生成摘要，并通过智能问答辅助理解文献内容。平台还支持个性化科研动态订阅，跟踪最新学术资讯。AMiner拥有3.5亿论文、0.6亿学者等海量数据，并提供学者画像、学术会议等附加功能。用户可通过网页免费使用，提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T00:05:44Z
- **目录日期**: 2025-05-18
