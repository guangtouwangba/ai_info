...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、科研订阅等一站式服务。其核心功能包括：1）高效检索3.5亿论文资源，支持互动问答和自动摘要生成；2）AI辅助阅读，可解析上传或平台内的PDF文献，生成章节概要和智能问答；3）定制化科研情报推送，通过微信/邮件定期发送用户关注的学术动态。平台还涵盖学者画像、学术会议等特色功能，支持免费使用，旨在提升科研效率。访问入口：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T17:06:02Z
- **目录日期**: 2025-05-18
