...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、翻译、辅助阅读和科研情报订阅等功能。它拥有3.5亿论文、0.6亿学者和1.5亿专利的数据库，支持AI生成摘要、章节概要和智能问答，帮助用户高效理解文献内容。用户可通过定制订阅获取最新科研动态，并利用学者画像、学术会议专题等工具。平台支持免费使用，适合科研人员和学生提升研究效率。访问链接：[AMiner官网](https://www.aminer.cn)。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T18:05:36Z
- **目录日期**: 2025-05-18
