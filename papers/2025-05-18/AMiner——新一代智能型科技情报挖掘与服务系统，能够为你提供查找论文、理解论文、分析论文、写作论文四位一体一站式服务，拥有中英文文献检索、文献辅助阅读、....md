...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、科研情报订阅等一站式服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持文献辅助阅读、AI摘要生成和智能问答功能。用户可订阅个性化科研动态，追踪学者及机构最新成果。平台还提供学者画像、学术会议等特色功能，浏览器版免费使用，帮助研究者高效获取和分析学术信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T06:05:55Z
- **目录日期**: 2025-05-18
