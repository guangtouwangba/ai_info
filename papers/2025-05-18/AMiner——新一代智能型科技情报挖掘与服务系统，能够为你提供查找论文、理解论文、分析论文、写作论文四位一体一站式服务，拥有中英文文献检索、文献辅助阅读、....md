...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献检索、自动摘要生成、互动问答和文档翻译，涵盖42个学科的3.5亿论文、0.6亿学者等数据。用户可订阅个性化科研动态，通过微信或邮件获取最新资讯。平台还提供学者画像、学术会议和论文排行榜等功能，基础服务免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T01:33:26Z
- **目录日期**: 2025-05-18
