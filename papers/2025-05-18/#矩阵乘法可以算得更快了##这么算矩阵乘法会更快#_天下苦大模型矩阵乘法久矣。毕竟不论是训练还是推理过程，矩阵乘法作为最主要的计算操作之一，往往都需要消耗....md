...
香港中文大学最新研究提出了一种改进的矩阵乘法算法，可节省5%-10%的能源和5%的计算时间。该10页论文指出，这一突破对数据分析、芯片设计、无线通信和大语言模型(LLM)训练都有重要影响。矩阵乘法是AI模型训练和推理中最耗能的操作之一，这项优化有望显著提升计算效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T17:02:57Z
- **目录日期**: 2025-05-18
