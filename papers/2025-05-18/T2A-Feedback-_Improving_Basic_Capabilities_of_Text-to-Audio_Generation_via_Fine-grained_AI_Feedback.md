...
本文提出通过AI反馈学习提升文本到音频(T2A)生成模型在复杂多事件音频中的表现。研究者开发了细粒度评分系统，评估事件完整性、序列准确性和音质，这些指标与人类偏好显著相关。基于此构建了包含4.1万提示和24.9万音频的T2A-FeedBack数据集，并推出针对长文本和多事件场景的T2A-EpicBench基准测试。实验表明，通过简单的偏好调优，模型在简单和复杂场景下的生成质量均有显著提升。该方法为提升T2A模型的高级能力提供了有效解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T20:01:07Z
- **目录日期**: 2025-05-18
