...
本文提出了一种基于AI反馈学习的文本到音频（T2A）生成改进方法。研究者开发了细粒度的音频评分系统，从事件完整性、事件顺序和音质三方面评估生成效果，这些指标与人类偏好高度相关。基于此，构建了包含4.1万提示和24.9万音频的T2A-FeedBack数据集，并设计了针对长文本、多事件场景的T2A-EpicBench基准测试。实验表明，通过简单的偏好调优，该方法能显著提升现有音频生成模型在简单和复杂场景下的表现。该研究为提升T2A模型的高级能力提供了有效解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T10:01:03Z
- **目录日期**: 2025-05-18
