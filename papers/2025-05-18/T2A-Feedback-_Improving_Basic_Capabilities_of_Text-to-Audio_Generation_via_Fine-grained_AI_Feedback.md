...
该研究提出了一种基于AI反馈学习的文本到音频(T2A)生成改进方法。通过开发三个细粒度评分管道（事件出现得分、事件顺序得分、声学和谐波质量得分）来评估生成音频的质量，这些评分与人类偏好显著相关。研究者构建了包含4.1万提示和24.9万音频的大规模偏好数据集T2A-FeedBack，并创建了针对长文本、多事件场景的评估基准T2A-EpicBench。实验表明，通过简单的偏好调优，现有音频生成模型在简单和复杂场景下的表现均得到显著提升。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T18:00:57Z
- **目录日期**: 2025-05-18
