...
本文提出了一种通过AI反馈学习提升文本到音频(T2A)生成模型性能的方法。研究者开发了细粒度的AI音频评分系统，包括事件出现评分、事件顺序评分和音质评分，这些评分与人类偏好显著相关。基于此，构建了包含41k提示和249k音频的大规模偏好数据集T2A-FeedBack，并创建了专注于长文本、多事件和叙事场景的评测基准T2A-EpicBench。实验表明，通过简单的偏好调优，该方法能显著提升现有音频生成模型在简单和复杂场景下的表现，改善了提示跟随能力和音质。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T22:00:55Z
- **目录日期**: 2025-05-18
