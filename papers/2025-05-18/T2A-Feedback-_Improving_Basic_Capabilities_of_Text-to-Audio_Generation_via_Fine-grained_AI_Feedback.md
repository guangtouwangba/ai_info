...
该研究提出通过AI反馈学习提升文本转音频(T2A)模型性能。研究者开发了细粒度评分系统，评估事件完整性、顺序准确性和音质，这些指标与人类偏好显著相关。基于此构建了包含4.1万提示和24.9万音频的T2A-FeedBack数据集，并创建了针对长文本、多事件场景的T2A-EpicBench基准测试。实验表明，通过简单的偏好调优，模型在简单和复杂场景下的音频生成质量均获得显著提升。该方法为优化T2A模型提供了有效的反馈机制和评估框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T12:00:58Z
- **目录日期**: 2025-05-18
