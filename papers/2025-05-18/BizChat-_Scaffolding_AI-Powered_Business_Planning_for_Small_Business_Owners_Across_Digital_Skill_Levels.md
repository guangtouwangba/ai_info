...
生成式AI能帮助小企业主自动化任务、提高效率和利润。然而，尽管像ChatGPT这样的系统看似直观，但对技术不熟练的用户仍存在障碍。研究发现，除了提示工程外，用户还需掌握键盘快捷键、编辑技能、文件转换和浏览器使用等辅助技能。基于设计研讨会和15次小企业访谈，研究者开发了BizChat——一个基于大语言模型的网页应用，帮助不同数字技能水平的企业主撰写商业计划书。BizChat采用三个设计原则：低门槛高上限、即时微学习和情境化技术引入。未来计划进一步部署该应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T18:02:05Z
- **目录日期**: 2025-05-18
