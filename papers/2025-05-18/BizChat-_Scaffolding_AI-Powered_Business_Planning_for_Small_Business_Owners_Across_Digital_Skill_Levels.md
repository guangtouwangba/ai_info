...
生成式AI虽能帮助小企业主自动化任务、提升效率，但技术门槛仍是主要障碍。研究指出，用户需掌握快捷键、文件转换等辅助技能才能有效使用AI工具。基于设计研讨会和15家小企业访谈，研究者开发了LLM驱动的网页应用BizChat，通过低门槛高扩展性界面（低地板高天花板）、实时微学习（即时学习）和业务场景化交互（情境化技术引入）三大设计原则，帮助不同数字技能水平的用户撰写商业计划书。未来计划进一步部署该工具。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T00:02:21Z
- **目录日期**: 2025-05-18
