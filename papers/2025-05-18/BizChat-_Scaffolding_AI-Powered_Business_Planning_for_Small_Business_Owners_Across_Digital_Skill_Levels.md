...
生成式AI能帮助小企业主自动化任务、提高效率和利润，但技术门槛仍是障碍。研究表明，除提示工程外，用户还需掌握快捷键、编辑技能等辅助技能才能有效使用AI。为此，研究者开发了BizChat——一个基于大语言模型的网页应用，帮助不同数字技能水平的用户撰写商业计划书。BizChat采用三项设计原则：兼顾新手与高级用户的"低门槛高上限"设计、支持即时学习的微教学模块，以及围绕商业场景的交互框架。该研究基于设计研讨会和15家小企业访谈，未来计划进一步部署BizChat。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T14:02:21Z
- **目录日期**: 2025-05-18
