...
生成式AI能帮助小企业主自动化任务、提高效率并改善收益，但对技术不熟练者仍存在使用障碍。研究发现，除提示工程外，用户还需掌握快捷键、编辑技能等辅助技能。为此，研究团队基于设计研讨会和15家小企业访谈，开发了LLM驱动的BizChat网页应用，帮助不同数字技能水平的用户撰写商业计划书。该应用采用三项设计原则：兼顾新手和高级用户的"低门槛高上限"设计、支持创业教育的"即时学习"功能，以及围绕商业活动的情境化技术引导。研究团队计划未来进一步部署该应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T04:05:56Z
- **目录日期**: 2025-05-18
