...
生成式AI能帮助小企业主自动化任务、提高效率和改善盈利，但技术门槛仍是主要障碍。研究指出，除提示工程外，用户还需掌握快捷键、编辑技能等辅助技能。基于工作坊和15次访谈，研究者开发了BizChat——一个LLM驱动的网页应用，帮助不同数字技能水平的用户撰写商业计划书。该应用融合了三大设计理念：兼顾低门槛与高扩展性（低地板高天花板）、提供即时微学习支持（适时学习）、围绕商业活动设计交互（情境化技术引入）。研究团队计划未来进一步部署该应用。
