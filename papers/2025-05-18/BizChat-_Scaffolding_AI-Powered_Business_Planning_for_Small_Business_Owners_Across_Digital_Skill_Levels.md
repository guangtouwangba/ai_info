...
生成式AI（如ChatGPT）虽能帮助小企业主自动化任务、提升效率，但技术门槛仍是关键障碍。研究表明，用户需掌握快捷键、文件转换等辅助技能才能有效使用AI工具。为此，研究团队基于工作坊和15家小企业访谈，开发了LLM驱动的网页应用BizChat，通过低门槛高扩展性设计（低地板高天花板）、实时微学习（适时学习）和业务场景化交互（情境化技术引入），帮助不同数字技能水平的用户撰写商业计划书。该工具融合学习科学理念，未来计划进一步部署应用。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T11:01:54Z
- **目录日期**: 2025-05-18
