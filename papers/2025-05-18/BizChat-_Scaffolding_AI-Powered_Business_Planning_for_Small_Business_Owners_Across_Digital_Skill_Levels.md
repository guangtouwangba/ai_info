...
生成式AI能帮助小企业主自动化任务、提高效率并增加收益，但技术门槛仍是主要障碍。研究发现，除提示词工程外，用户还需掌握键盘快捷键、编辑技巧等辅助技能。基于工作坊和15家小企业访谈，研究者开发了BizChat——一个LLM驱动的网页应用，帮助不同数字技能水平的用户撰写商业计划书。该应用采用三项设计原则：兼顾新手与高级用户的"低门槛高上限"设计；支持即时学习的微教学；围绕商业场景的交互框架。研究团队计划进一步部署该应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T06:02:19Z
- **目录日期**: 2025-05-18
