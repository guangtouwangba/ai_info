...
DeepMind的通用科学AI系统AlphaEvolve在数学领域取得突破，将4×4复数矩阵乘法的运算量从49次降至48次，打破了1969年Strassen算法保持56年的记录。该系统通过完全自主探索（无人工预设）、异步分布式架构并行演化算法，并利用自动化评估优化方案，首次在纯数学领域实现"超越人类"的发现。其解法不仅适用于复数领域，还意外适用于实数领域。目前团队正尝试更大规模矩阵（5×5、6×6）的优化，认为性能与底层模型能力正相关，未来仍有提升空间。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T21:04:51Z
- **目录日期**: 2025-05-18
