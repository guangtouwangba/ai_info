...
DeepMind的通用科学AI系统AlphaEvolve取得突破性进展，在纯数学领域打破了56年的矩阵乘法计算记录。该系统通过完全自主探索，将4×4复数矩阵乘法的运算量从49次降至48次，超越了1969年Strassen算法的上限。其核心技术包括：无预设结构的自由探索、并行演化候选算法、自动化评估迭代。这一成果标志着AI首次在基础数学研究中实现"超越人类"的实质性突破，并展现出在更大规模矩阵中的优化潜力。研究人员认为其性能将随底层模型能力持续提升，为科学发现提供了新范式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T05:03:12Z
- **目录日期**: 2025-05-18
