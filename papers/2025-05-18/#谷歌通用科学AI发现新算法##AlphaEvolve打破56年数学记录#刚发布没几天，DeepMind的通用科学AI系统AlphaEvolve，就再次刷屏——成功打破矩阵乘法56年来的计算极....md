# #谷歌通用科学AI发现新算法##AlphaEvolve打破56年数学记录#刚发布没几天，DeepMind的通用科学AI系统AlphaEvolve，就再次刷屏——成功打破矩阵乘法56年来的计算极...
...
DeepMind的通用科学AI系统AlphaEvolve取得重大突破，在纯数学领域发现4×4复数矩阵乘法的新算法，将运算量从49次乘法降至48次，打破了1969年Strassen算法保持56年的记录。该系统通过完全自主探索（无人类经验干预）、异步分布式架构并行演化候选方案，并利用自动化评估实现算法迭代优化，首次在基础数学研究中实现"超越人类"的原创性发现。研究团队表示，其性能与底层大模型能力正相关，未来有望在更大规模矩阵（5×5、6×6）中取得进展。这一成果标志着AI从工程应用迈向基础科学创新。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T14:03:42Z
- **目录日期**: 2025-05-18
