...
DeepMind的通用科学AI系统AlphaEvolve取得重大突破，在纯数学领域首次超越人类：它将4×4复数矩阵乘法的运算量从49次降至48次，打破了1969年Strassen算法保持56年的记录。该系统通过完全自主探索（无人工预设）、异步分布式架构并行演化算法，并利用自动化评估逐步优化，最终跳出人类思维定式，在复数领域发现更优解（意外适用于实数领域）。尽管5×5以上矩阵尚未突破人类最优，但团队表示其潜力与底层模型能力正相关，未来可能带来更多数学发现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T04:06:40Z
- **目录日期**: 2025-05-18
