...
DeepMind的通用科学AI系统AlphaEvolve取得重大突破，在纯数学领域发现4×4复数矩阵乘法的新算法，将运算量从49次乘法降至48次，打破了1969年Strassen算法保持56年的记录。该系统通过完全自主探索（无人工预设）、异步分布式架构并行演化候选方案，并利用自动化评估实现算法迭代，首次在基础数学中实现"超越人类"的实质性突破。目前正尝试更大规模矩阵（5×5、6×6）的优化，未来性能有望随底层模型提升而增强。这一成果标志着AI从工程应用迈向基础科学创新的重要里程碑。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T22:03:27Z
- **目录日期**: 2025-05-18
