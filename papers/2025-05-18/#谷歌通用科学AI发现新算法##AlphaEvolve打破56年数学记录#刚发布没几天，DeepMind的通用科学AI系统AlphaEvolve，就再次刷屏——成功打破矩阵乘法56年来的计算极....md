...
DeepMind的通用科学AI系统AlphaEvolve在数学领域取得突破，将4×4复数矩阵乘法的运算量从49次减少到48次，打破了1969年Strassen算法保持56年的记录。该系统通过完全自主探索，在无人类经验干预的情况下发现了更优解法，并意外适用于实数领域。其技术核心包括异步分布式架构并行演化算法、自动化评估系统驱动进化。这是AI首次在纯数学基础研究中超越人类最优解，展现了自主发现新规律的能力。团队表示其性能与底层模型能力正相关，未来有望在更大规模矩阵计算中取得进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T10:03:35Z
- **目录日期**: 2025-05-18
