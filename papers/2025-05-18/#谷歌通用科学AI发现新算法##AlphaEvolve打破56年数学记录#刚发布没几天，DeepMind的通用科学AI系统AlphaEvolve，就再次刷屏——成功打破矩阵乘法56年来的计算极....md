...
DeepMind的通用科学AI系统AlphaEvolve在数学领域取得突破，将4×4复数矩阵乘法的运算量从49次减少到48次，打破了1969年Strassen算法保持56年的记录。该AI通过完全自主探索，在无人类经验干预下发现了更优解法，并意外适用于实数领域。其核心技术包括：自由探索搜索空间、分布式并行演化和自动化评估系统。这是AI首次在纯数学基础研究中超越人类，展现了从工程应用到前沿科学的跨越。团队表示其潜力与底层模型能力正相关，未来可能攻克更大规模矩阵优化问题。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T19:03:20Z
- **目录日期**: 2025-05-18
