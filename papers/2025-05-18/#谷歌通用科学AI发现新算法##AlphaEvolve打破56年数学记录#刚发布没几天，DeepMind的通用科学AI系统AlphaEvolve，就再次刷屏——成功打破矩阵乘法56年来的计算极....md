...
DeepMind的通用科学AI系统AlphaEvolve取得数学突破，将4×4复数矩阵乘法的运算量从49次降至48次，打破了Strassen算法保持了56年的记录。该系统通过完全自主探索，在无人类经验干预下发现了更优解法，并意外适用于实数领域。其核心技术包括异步分布式架构并行演化算法、自动化评估系统驱动进化。这是AI首次在纯数学基础研究中超越人类最优解，展现了自主发现新规律的能力。团队表示其性能与底层模型规模正相关，未来有望在更大矩阵运算中取得进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T12:03:35Z
- **目录日期**: 2025-05-18
