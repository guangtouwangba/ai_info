...
DeepMind的通用科学AI系统AlphaEvolve取得重大突破，在纯数学领域首次超越人类——它将4×4复数矩阵乘法的运算次数从49次降至48次，打破了1969年Strassen算法保持56年的记录。该系统通过完全自主探索，摆脱人类预设的对称性限制，在复数域发现更优解法并意外适用于实数域。其核心技术包括：无人工干预的自由搜索、并行演化候选算法、自动化评估进化。目前正挑战更大规模矩阵，未来性能有望随底层模型提升。这一成果标志着AI不仅能辅助科研，还能独立发现数学新规律。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T06:03:34Z
- **目录日期**: 2025-05-18
