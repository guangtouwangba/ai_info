...
DeepMind的通用科学AI系统AlphaEvolve在数学领域取得突破，将4×4复数矩阵乘法的运算量从49次减少到48次，打破了56年来由Strassen算法保持的纪录。该系统通过完全自主探索，跳脱人类算法的对称性限制，在复数领域发现更优解法，并意外适用于实数领域。其技术核心包括：无预设结构的自由探索、并行演化的分布式架构，以及自动化评估系统。这是AI首次在纯数学基础研究中实现"超越人类"的实质性突破，未来有望挑战更大规模矩阵运算。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T23:03:11Z
- **目录日期**: 2025-05-18
