...
DeepMind的通用科学AI系统AlphaEvolve在数学领域取得突破，将4×4复数矩阵乘法的运算量从49次减少到48次，打破了1969年Strassen算法保持56年的记录。该系统通过完全自主探索，跳脱人类算法框架，在复数领域发现更优解法并意外适用于实数领域。其核心技术包括无预设结构的自由探索、并行演化和自动化评估。这是AI首次在纯数学基础研究中实现"超越人类"的实质性突破，展现了在科学发现中的潜力。团队表示其性能与底层模型能力正相关，未来可能实现更大突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T11:03:12Z
- **目录日期**: 2025-05-18
