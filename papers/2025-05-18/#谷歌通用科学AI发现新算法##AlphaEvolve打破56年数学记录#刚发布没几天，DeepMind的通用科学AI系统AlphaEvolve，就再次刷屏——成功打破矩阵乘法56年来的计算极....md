...
DeepMind的通用科学AI系统AlphaEvolve在数学领域取得突破性进展，将4×4复数矩阵乘法的运算量从49次减少到48次，打破了1969年Strassen算法保持56年的记录。该系统通过完全自主探索，在无人类经验干预下发现了超越传统对称性限制的新算法，且该解法在实数领域同样适用。其核心技术包括异步分布式架构并行演化候选算法，以及自动化评估系统驱动迭代优化。这是AI首次在纯数学基础研究中实现"比人强"的实质性突破，展现了在科学发现领域的潜力，未来有望通过模型升级挑战更大规模矩阵问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T17:03:40Z
- **目录日期**: 2025-05-18
