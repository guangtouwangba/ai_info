...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能够模拟10,000多个AI代理的社会互动（500万次交互）。该系统被用于研究四个关键社会问题：社会极化、刺激性信息传播、基本收入政策影响和自然灾害（如飓风）的社会效应。模拟结果与现实世界数据高度吻合，验证了该系统捕捉人类行为机制的能力。研究表明AgentSociety可作为计算社会科学的创新工具，为研究者和政策制定者提供传统方法（如调查、访谈）之外的新研究范式，有助于深入理解社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T11:05:25Z
- **目录日期**: 2025-05-18
