...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统能模拟1万多个AI代理的社会生活，记录500万次互动，用于研究社会现象。研究者用它分析了四个关键问题：社会极化、信息传播、基本收入政策效果和自然灾害影响。模拟结果与现实数据高度吻合，验证了该系统的有效性。AgentSociety为社会科学研究提供了新工具，能帮助理解人类行为机制，辅助政策制定，弥补传统研究方法的不足。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T04:09:01Z
- **目录日期**: 2025-05-18
