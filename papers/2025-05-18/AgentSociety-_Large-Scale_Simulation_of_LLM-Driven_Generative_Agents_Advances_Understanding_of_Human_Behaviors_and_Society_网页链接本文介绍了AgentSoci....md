...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能模拟1万个AI代理及其500万次社会互动。研究者用它研究四个关键社会问题：群体极化、信息传播、基本收入政策效果和自然灾害影响。该系统模拟结果与现实世界数据高度吻合，验证了其捕捉人类行为机制的能力。研究表明AgentSociety可作为计算社会科学的重要工具，为研究者提供传统方法（如调查、实验）之外的补充研究手段，帮助理解社会问题成因并辅助政策制定。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T14:05:27Z
- **目录日期**: 2025-05-18
