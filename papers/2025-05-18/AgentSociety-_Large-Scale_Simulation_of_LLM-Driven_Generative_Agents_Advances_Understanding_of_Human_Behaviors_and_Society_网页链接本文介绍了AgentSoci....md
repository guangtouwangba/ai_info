...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟1万多个代理及其500万次互动。研究者利用该平台探索了社会极化、信息传播、基本收入政策及飓风影响等社会问题，结果与现实世界数据高度吻合。该系统能有效捕捉人类行为模式和社会机制，为社会科学研究和政策制定提供了新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T06:05:23Z
- **目录日期**: 2025-05-18
