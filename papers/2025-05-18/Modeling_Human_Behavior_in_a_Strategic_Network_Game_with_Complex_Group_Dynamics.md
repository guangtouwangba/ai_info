...
该研究探讨了人类网络对社会不平等、贫困和欺凌等结果的影响，并通过“初中生游戏”（JHG）对比了不同行为建模方法。研究发现，表现最佳的hCAB模型通过模拟人类行为的分布（而非均值）并假设社区意识行为（而非行为匹配），能更准确地反映小型群体（6-11人）的动态。用户研究还表明，人类参与者无法区分hCAB代理和真实人类行为，验证了该模型在个体层面的合理性。这一成果为理解人类网络行为提供了新方法，有助于优化社会干预策略。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T17:02:25Z
- **目录日期**: 2025-05-18
