...
该研究比较了多种从小数据集中学习人类在战略网络游戏“初中游戏”(JHG)中行为模型的方法。最佳方法是hCAB，它模拟人类行为的分布而非均值，并假设人类采用社区感知行为而非简单行为匹配。在小型社会(6-11人)中，hCAB模型能准确反映人类群体动态。用户研究还显示，人类参与者无法区分hCAB智能体与真实人类，表明该模型能产生可信的个体行为。这些发现有助于理解人类网络行为，对解决财富健康不平等、贫困和霸凌等社会问题具有重要意义。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T03:23:23Z
- **目录日期**: 2025-05-18
