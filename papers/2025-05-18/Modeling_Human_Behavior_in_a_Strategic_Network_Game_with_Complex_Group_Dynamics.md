...
该研究比较了多种从小数据集中学习人类在策略性网络游戏（Junior High Game）中行为模型的方法。最佳方法hCAB通过建模人类行为的分布（而非均值）并假设人类具有社区意识行为（而非简单行为匹配），能准确反映6-11人小群体动态。用户研究显示，人类参与者无法区分hCAB智能体与真人行为，验证了该模型能生成可信的个体行为。这些发现为理解影响财富、健康等社会结果的人类网络机制提供了新见解，表明社区感知和行为分布建模对模拟真实社会互动至关重要。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T06:02:30Z
- **目录日期**: 2025-05-18
