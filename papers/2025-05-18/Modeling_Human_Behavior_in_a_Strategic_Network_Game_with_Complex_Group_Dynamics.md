...
人类网络对社会不平等、贫困和霸凌等关键问题有重要影响。为更好理解人类网络行为，研究比较了多种建模方法在战略网络游戏“初中游戏”（JHG）中的表现。结果表明，最佳模型hCAB通过模拟人类行为的分布（而非均值）并采用社区感知行为假设，能准确反映小群体（6-11人）的动态特征。用户研究进一步显示，人类参与者无法区分hCAB智能体与真实人类行为，验证了该模型在个体层面行为的合理性。这一发现为研究社会网络行为提供了新方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T21:03:02Z
- **目录日期**: 2025-05-18
