...
该研究比较了多种从小数据集中学习人类在战略网络游戏"初中游戏"(JHG)中行为模型的方法。最佳方法是hCAB模型，它通过建模行为分布(而非均值)并假设人类具有社区意识(而非简单行为匹配)。在小型社会(6-11人)中，hCAB能准确反映群体动态。用户研究还表明，人类参与者无法区分hCAB智能体与真人，证明该模型能产生可信的个体行为。这些发现为理解人类网络行为提供了新见解，有助于改善财富分配、健康不平等等社会问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T20:02:36Z
- **目录日期**: 2025-05-18
