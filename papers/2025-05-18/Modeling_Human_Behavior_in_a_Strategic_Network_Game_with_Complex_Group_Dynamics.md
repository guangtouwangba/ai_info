...
该研究比较了多种从小数据集中学习人类在战略网络游戏"初中游戏"(JHG)中行为模型的方法。最佳模型hCAB采用社区感知行为假设并建模行为分布(而非均值)，能准确反映小型社会(6-11人)的群体动态。用户研究显示，人类参与者无法区分hCAB智能体与真人，表明该模型能生成可信的个体行为。这些发现为理解影响财富、健康不平等等重要社会结果的人类网络提供了新见解，有助于促进有利的社会结果。研究方法特别关注行为参数化假设(行为匹配vs社区感知)和建模维度(均值vs分布)的差异。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T08:02:25Z
- **目录日期**: 2025-05-18
