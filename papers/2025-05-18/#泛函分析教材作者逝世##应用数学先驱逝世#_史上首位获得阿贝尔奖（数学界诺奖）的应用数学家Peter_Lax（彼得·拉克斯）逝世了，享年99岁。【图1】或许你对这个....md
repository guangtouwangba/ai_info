...
应用数学先驱、阿贝尔奖首位应用数学得主Peter Lax（彼得·拉克斯）于99岁高龄逝世。他以经典教材《泛函分析》闻名，其著作《微积分及其应用》《线性代数及其应用》也广受推崇。拉克斯是理论数学与应用数学交叉领域的巨匠，开创了计算机技术在数学分析中的应用，其理论至今深刻影响科研与工程实践。阿贝尔奖评价他"弥合了纯数学与应用数学的鸿沟"，《纽约时报》称其"重新定义了计算机时代的数学角色"。他于2024年5月刚度过99岁生日，后因心脏淀粉样变性离世。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T23:02:56Z
- **目录日期**: 2025-05-18
