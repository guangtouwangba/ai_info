...
著名应用数学家、《泛函分析》教材作者Peter Lax（彼得·拉克斯）于99岁高龄逝世。他是首位获得数学界最高荣誉阿贝尔奖的应用数学家，在理论数学与应用数学交叉领域贡献卓著，并率先将计算机技术引入数学分析。其编写的《微积分及其应用》《线性代数及其应用》等教材以清晰易懂著称。阿贝尔奖官方评价他"弥合了纯数学与应用数学的鸿沟"，《纽约时报》称其"重新定义了计算机时代的数学角色"。拉克斯于2023年5月刚度过99岁生日，后因心脏淀粉样变性在纽约去世。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T18:03:06Z
- **目录日期**: 2025-05-18
