...
著名应用数学家、《泛函分析》教材作者Peter Lax（彼得·拉克斯）于纽约逝世，享年99岁。他是首位获得数学界最高荣誉阿贝尔奖的应用数学家，其著作《泛函分析》《微积分及其应用》等成为经典教材。拉克斯在理论数学与应用数学交叉领域贡献卓著，推动了计算机技术与数学分析的结合，被评价为"重新定义了数学在计算机时代的角色"。阿贝尔奖官方称赞他"弥合了纯粹与应用数学之间的鸿沟"。他于2024年5月刚度过99岁生日，最终因心脏淀粉样变性离世。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T10:03:15Z
- **目录日期**: 2025-05-18
