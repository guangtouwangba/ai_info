...
著名应用数学家Peter Lax（彼得·拉克斯）逝世，享年99岁。他是首位获得阿贝尔奖的应用数学家，其经典教材《泛函分析》广为人知。拉克斯在理论数学与应用数学交叉领域贡献卓著，并率先将计算机技术引入数学分析。他编写的多部教材（如《微积分及其应用》）以通俗易懂著称。阿贝尔奖评价他"弥合了纯粹与应用数学的鸿沟"，《纽约时报》称其"重新定义了计算机时代的数学角色"。拉克斯因心脏淀粉样变性于纽约家中去世，其学术遗产持续影响科学与工程领域。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T11:02:51Z
- **目录日期**: 2025-05-18
