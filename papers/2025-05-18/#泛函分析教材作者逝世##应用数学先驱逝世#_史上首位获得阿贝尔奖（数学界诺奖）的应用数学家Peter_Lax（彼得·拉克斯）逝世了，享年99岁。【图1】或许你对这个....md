...
著名应用数学家、《泛函分析》教材作者Peter Lax（彼得·拉克斯）逝世，享年99岁。他是首位获得数学界"诺奖"阿贝尔奖的应用数学家，其著作《泛函分析》《微积分及其应用》等成为经典教材。拉克斯在理论数学与应用数学交叉领域贡献卓著，是最早将计算机技术引入数学分析的先驱之一。阿贝尔奖官方评价他"弥合了纯粹与应用数学的鸿沟"。5月刚过完99岁生日的他因心脏淀粉样变性在纽约去世，《纽约时报》称其"重新定义了计算机时代的数学角色"。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T14:03:23Z
- **目录日期**: 2025-05-18
