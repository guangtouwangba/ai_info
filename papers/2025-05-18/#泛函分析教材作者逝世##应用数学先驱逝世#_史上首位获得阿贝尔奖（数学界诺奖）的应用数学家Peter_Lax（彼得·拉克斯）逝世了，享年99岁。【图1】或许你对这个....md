...
著名应用数学家、《泛函分析》教材作者Peter Lax（彼得·拉克斯）于纽约逝世，享年99岁。他是首位获得数学界最高荣誉阿贝尔奖的应用数学家，被誉为"弥合纯粹与应用数学鸿沟"的巨匠。其经典教材《泛函分析》《微积分及其应用》等以通俗易懂著称。作为计算机数学分析先驱，他重新定义了数学在计算机时代的角色。阿贝尔奖官方评价其研究影响深远，著作卓越，并长期致力于数学教育。拉克斯于2023年5月刚过完99岁生日，后因心脏淀粉样变性离世。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T19:03:04Z
- **目录日期**: 2025-05-18
