...
著名应用数学家、《泛函分析》教材作者彼得·拉克斯（Peter Lax）于纽约逝世，享年99岁。作为首位获得数学界最高荣誉阿贝尔奖的应用数学家，拉克斯在理论数学与应用数学交叉领域贡献卓著，其研究成果广泛应用于科学与工程实践。他编写的《微积分及其应用》《线性代数及其应用》等教材以通俗易懂著称。阿贝尔奖官方评价其"弥合了纯粹与应用数学的鸿沟"，《纽约时报》称其"重新定义了计算机时代的数学角色"。拉克斯于2023年5月刚度过99岁生日，后因心脏淀粉样变性离世。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T17:03:20Z
- **目录日期**: 2025-05-18
