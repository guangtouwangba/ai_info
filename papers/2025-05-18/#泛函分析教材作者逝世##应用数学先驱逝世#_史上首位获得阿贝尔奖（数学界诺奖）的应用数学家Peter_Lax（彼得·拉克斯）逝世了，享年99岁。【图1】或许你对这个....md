...
著名应用数学家、《泛函分析》教材作者Peter Lax（彼得·拉克斯）于纽约逝世，享年99岁。他是首位获得数学界最高荣誉阿贝尔奖的应用数学家，其著作《泛函分析》《微积分及其应用》等成为经典教材，以深入浅出的风格广受推崇。拉克斯在纯数学与应用数学交叉领域贡献卓著，开创了计算机技术在数学分析中的应用，被评价为"重新定义了计算机时代的数学角色"。阿贝尔奖官方曾称赞他"弥合了纯粹与应用数学的鸿沟"。他因心脏淀粉样变性离世，其学术遗产持续影响科学与工程领域。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T20:03:29Z
- **目录日期**: 2025-05-18
