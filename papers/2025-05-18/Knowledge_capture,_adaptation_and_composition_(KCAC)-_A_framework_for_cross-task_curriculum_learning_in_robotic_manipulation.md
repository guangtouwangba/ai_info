...
本文提出了一种知识捕获、适应与组合（KCAC）框架，通过跨任务课程学习将知识迁移系统性地融入强化学习（RL），以解决机器人操作中样本效率低和可解释性差的问题。在CausalWorld基准测试中，KCAC通过重新设计奖励函数和设计子任务课程，使双块堆叠任务的训练时间减少40%，成功率提升10%。研究还揭示了课程设计中的关键参数（子任务选择、过渡时机和学习率）对学习效率的影响，为基于课程的RL框架提供了实践指导。该成果为RL和机器人学习的课程设计提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T21:02:01Z
- **目录日期**: 2025-05-18
