...
这篇论文研究了代码生成大模型(codeLLMs)与人类偏好的对齐问题。研究者创建了CodeArena基准测试(包含397个样本，覆盖40类任务和44种编程语言)来评估模型在真实编程场景中的表现，发现传统基于执行的测试与人类偏好存在差异。同时构建了20B标记的SynCode-Instruct合成指令集验证微调效果。实验比较40多个模型显示，开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI)仍存在显著差距，凸显了人类偏好对齐在代码生成中的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T16:05:55Z
- **目录日期**: 2025-05-18
