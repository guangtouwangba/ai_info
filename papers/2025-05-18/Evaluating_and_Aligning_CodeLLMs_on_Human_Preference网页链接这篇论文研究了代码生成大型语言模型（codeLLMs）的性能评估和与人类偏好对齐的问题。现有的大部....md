...
这篇论文探讨了代码生成大语言模型(codeLLMs)与人类偏好的对齐问题。研究者创建了CodeArena基准测试(包含397个样本，覆盖40类任务和44种语言)，发现传统基于执行的评估与人类偏好存在差距。同时构建了20B标记的SynCode-Instruct合成指令数据集用于微调验证。实验比较40多个模型显示，顶级开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，突出了对齐人类偏好的重要性。研究强调需要超越代码正确性，关注实际编程场景中的用户体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T08:05:58Z
- **目录日期**: 2025-05-18
