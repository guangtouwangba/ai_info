...
这篇论文提出了CodeArena基准测试和SynCode-Instruct语料库，用于评估代码生成大语言模型（codeLLMs）与人类偏好的对齐程度。研究发现现有基准过于关注代码正确性而忽视人类偏好，而CodeArena通过397个多样化编程任务弥补了这一缺陷。实验显示，基于执行的测试与人类偏好评估存在差距，且开源模型（如Qwen2.5-Coder）与专有模型（如OpenAI o1）性能差异显著。研究强调了人类偏好对齐在代码生成中的重要性，并验证了大规模合成指令微调的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T18:05:46Z
- **目录日期**: 2025-05-18
