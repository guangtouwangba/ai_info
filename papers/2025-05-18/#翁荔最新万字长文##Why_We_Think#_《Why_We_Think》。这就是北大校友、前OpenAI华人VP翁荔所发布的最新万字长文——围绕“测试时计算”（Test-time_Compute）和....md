...
北大校友、前OpenAI华人副总裁翁荔发表万字长文《Why We Think》，探讨通过"测试时计算"和"思维链"技术提升AI模型性能。文章指出，让模型在输出前进行更长时间的思考（如智能解码、思维链推理等方法），能显著突破当前能力瓶颈。该观点引发广泛讨论，被认为开拓了AI理解的新维度。文章详细分析了这些技术如何提升模型智能水平。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T16:03:04Z
- **目录日期**: 2025-05-18
