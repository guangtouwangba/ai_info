...
前OpenAI华人副总裁翁荔发表万字长文《Why We Think》，探讨通过"测试时计算"和"思维链"(CoT)技术提升AI模型性能。文章指出，让模型在输出前进行更深入思考（如智能解码、推理链等方法），能显著突破当前能力瓶颈。这一观点被网友评价为"打开了AI理解的新维度"，认为这些技术为提升模型智能水平提供了重要方向。文章重点分析了如何通过延长思考过程来优化模型表现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T19:02:53Z
- **目录日期**: 2025-05-18
