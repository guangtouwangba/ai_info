...
北大校友、前OpenAI华人副总裁翁荔发表万字长文《Why We Think》，探讨通过"测试时计算"和"思维链"技术提升AI模型性能。文章指出，让模型在输出前进行更多思考（如智能解码、思维链推理等）能显著突破当前能力瓶颈。该观点引发广泛关注，被认为开辟了理解AI的新维度。文章详细分析了这些技术如何提升模型智能水平，网友评价其内容"精彩"。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T20:03:19Z
- **目录日期**: 2025-05-18
