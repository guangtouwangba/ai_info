...
前OpenAI华人副总裁翁荔发表万字长文《Why We Think》，探讨通过"测试时计算"和"思维链"(CoT)技术提升AI模型性能。核心观点是：让模型在输出前进行更多思考（如智能解码、思维链推理等），能显著突破当前能力瓶颈。文章认为这种"多思考一会儿"的方法为AI理解开辟了新维度，引发广泛关注。网友评价该研究"精彩"，认为其提供了提升AI智能水平的新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T21:04:19Z
- **目录日期**: 2025-05-18
