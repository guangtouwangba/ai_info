...
翁荔（前OpenAI华人副总裁）发表万字长文《Why We Think》，探讨如何通过"测试时计算"和"思维链推理"提升AI模型性能。文章指出，让模型在输出答案前进行更多思考（如智能解码、潜在思考等方法），能显著突破当前能力瓶颈。这一观点引发广泛关注，被认为开辟了理解AI的新维度。文章详细分析了这些技术如何通过延长推理过程来增强模型表现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T11:02:38Z
- **目录日期**: 2025-05-18
