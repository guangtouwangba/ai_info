...
翁荔（前OpenAI华人副总裁）发表万字长文《Why We Think》，探讨如何通过"测试时计算"和"思维链推理"（Chain-of-Thought）提升AI模型性能。核心观点是：让模型在输出答案前进行更长时间的思考（如智能解码、潜在思考等方法），能显著突破当前能力瓶颈。文章引发广泛关注，被认为开辟了理解AI智能的新维度。该方法通过延长推理过程，使模型表现更接近人类深思熟虑的思维模式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T08:02:52Z
- **目录日期**: 2025-05-18
