...
港中文与微软等机构联合推出开源框架OpenThinkIMG，旨在提升AI使用视觉工具进行推理的能力。该框架解决了工具集成难、训练数据缺乏和模型适应性差三大挑战，并采用自适应工具训练技术V-ToolRL。通过赋予AI类似人类的"动手操作"能力（如标注、分割等），显著增强了其在视觉任务中的推理表现。该技术有望推动AI在复杂视觉场景中的灵活应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T04:07:11Z
- **目录日期**: 2025-05-18
