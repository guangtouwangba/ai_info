...
港中文与微软等机构联合开源OpenThinkIMG框架，旨在提升AI的视觉工具使用和推理能力。该框架解决了工具集成难、训练数据缺乏和模型适应性差三大挑战，通过自适应工具使用训练技术V-ToolRL，帮助AI智能选择和使用视觉工具（如分割、检测、OCR等），从而增强其灵活推理能力。OpenThinkIMG为AI提供了类似人类的"动手操作"能力，显著提升了带图推理性能，成为一站式解决方案。相关技术细节和成果已在公开报告中展示。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T21:05:21Z
- **目录日期**: 2025-05-18
