...
港中文与微软等机构联合推出开源框架OpenThinkIMG，旨在提升AI使用视觉工具进行推理的能力。该框架解决了工具整合困难、训练数据缺乏和模型适应性差三大挑战，通过自适应工具使用训练技术V-ToolRL，让AI智能选择并灵活运用视觉工具（如分割、检测、OCR等）。研究表明，赋予AI类似人类的"动手操作"能力可显著增强其认知与推理表现，在带图推理任务中超越现有开源模型。这一技术突破为AI的多模态理解和复杂问题解决提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T14:04:13Z
- **目录日期**: 2025-05-18
