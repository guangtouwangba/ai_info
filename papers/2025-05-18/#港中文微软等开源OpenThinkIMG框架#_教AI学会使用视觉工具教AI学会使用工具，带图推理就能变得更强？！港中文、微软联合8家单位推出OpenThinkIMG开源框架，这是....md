...
港中文与微软等机构联合推出开源框架OpenThinkIMG，旨在提升AI使用视觉工具进行推理的能力。该框架解决了工具整合困难、训练数据缺乏和模型适应性差三大挑战，并公开了核心技术V-ToolRL。通过赋予AI类似人类使用视觉工具（如标记、分割）的能力，显著增强了其认知和推理表现，在带图推理任务中超越同类开源模型。这一创新为AI灵活运用视觉工具提供了系统化解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T20:04:48Z
- **目录日期**: 2025-05-18
