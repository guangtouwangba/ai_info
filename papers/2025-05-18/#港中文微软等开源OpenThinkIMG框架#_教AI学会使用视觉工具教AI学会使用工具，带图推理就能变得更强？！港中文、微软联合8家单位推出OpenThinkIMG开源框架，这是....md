...
港中文与微软等机构联合推出开源框架OpenThinkIMG，旨在提升AI使用视觉工具进行推理的能力。该框架解决了工具集成困难、训练数据缺乏和模型适应性差三大挑战，通过自适应工具使用训练技术V-ToolRL，使AI能灵活调用分割、检测、OCR等视觉工具，增强其自主学习和推理性能。这一创新让AI像人类一样借助工具辅助分析，显著提升了带图推理任务的准确性和适应性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T17:04:09Z
- **目录日期**: 2025-05-18
