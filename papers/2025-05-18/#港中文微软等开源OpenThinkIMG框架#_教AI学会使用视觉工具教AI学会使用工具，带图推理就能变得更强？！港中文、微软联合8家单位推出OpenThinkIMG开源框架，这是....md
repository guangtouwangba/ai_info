...
港中文与微软等机构联合推出开源框架OpenThinkIMG，旨在提升AI使用视觉工具进行推理的能力。该框架解决了三大挑战：工具集成困难、训练数据缺乏和模型适应性差。通过自适应工具使用训练技术V-ToolRL，OpenThinkIMG帮助AI智能选择并灵活运用视觉工具（如分割、检测、OCR等），从而增强其推理和自主学习能力。这一创新使AI在带图推理任务中表现优于同类开源模型，为AI视觉工具应用提供了高效的一站式解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T13:10:00Z
- **目录日期**: 2025-05-18
