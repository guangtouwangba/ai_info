...
港中文与微软等机构联合推出开源框架OpenThinkIMG，旨在提升AI使用视觉工具进行推理的能力。该框架解决了三大挑战：1) 不同视觉工具(如分割、OCR)的集成难题；2) 缺乏训练AI使用工具的高质量示范数据；3) 传统AI模型在新场景下缺乏灵活应变能力。核心创新是V-ToolRL自适应训练技术，使AI能智能选择并组合工具，在带图推理任务中表现优于同类模型。该研究模仿人类借助视觉工具(如画辅助线)增强认知的思路，有望显著提升AI的视觉推理能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T06:04:05Z
- **目录日期**: 2025-05-18
