...
港中文与微软等机构联合推出开源框架OpenThinkIMG，旨在提升AI使用视觉工具进行推理的能力。该框架解决了工具整合困难、训练数据缺乏和模型适应性差三大挑战，通过自适应工具使用训练技术V-ToolRL，帮助AI智能选择并灵活应用视觉工具（如分割、检测、OCR等），从而增强其推理性能。这一创新使AI能够像人类一样借助工具辅助分析，显著提升了处理复杂视觉任务的能力。相关技术细节和成果已公开发布。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T01:30:52Z
- **目录日期**: 2025-05-18
