...
该研究评估了大语言模型在动态环境中的自适应能力，发现更大的模型通常表现更好，但策略性提示可以缩小性能差距。过长的提示会损害小模型在基础任务上的表现，而大模型更稳健。高级提示技术对小模型在复杂任务中更有益，但对高性能大模型提升有限。推理方法虽然可能显著提升表现，但也带来不稳定性。与人类相比，大语言模型在规划、推理和空间协调等关键领域仍存在根本性缺陷，表明仅靠自我反思提示无法完全克服。研究强调需超越静态基准，以捕捉推理的复杂性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T15:01:29Z
- **目录日期**: 2025-05-18
