...
该研究评估了大型语言模型(LLM)在动态环境中的自适应能力，测试了自我反思、启发式变异和规划等提示技术。实验发现：1)大模型表现优于小模型，但策略性提示可缩小差距；2)过长提示会损害小模型的基本反应能力，大模型则更稳健；3)高级提示技术对小模型在复杂任务中帮助更大，但对高性能大模型提升有限。研究揭示当前LLM在规划、推理和空间协调等关键领域仍存在根本性缺陷，其推理能力具有高度不稳定性。结果表明，仅靠自我反思提示无法完全克服这些限制，需要超越静态基准来评估真实推理能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T13:07:05Z
- **目录日期**: 2025-05-18
