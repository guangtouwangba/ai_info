...
这项研究评估了大型语言模型(LLM)在动态环境中的自适应能力，测试了自我反思、启发式突变和规划等提示技术的作用。实验发现，大模型通常优于小模型，但策略性提示能缩小差距；过长提示会损害小模型在基础任务的表现，而大模型更稳健；复杂任务中高级提示对小模型帮助更大。然而，高级推理方法虽能提升表现，但也带来不稳定性，可能导致性能骤降。与人类相比，LLM在规划、推理和空间协调等关键领域仍存在根本性缺陷，表明仅靠自我反思提示无法完全克服当前LLM的局限性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T21:01:23Z
- **目录日期**: 2025-05-18
