...
该研究评估了大语言模型在动态环境中的自适应能力，发现大模型通常优于小模型，但策略性提示可缩小差距。长提示对小模型的基础任务有负面影响，而大模型表现更稳健。复杂任务中，高级提示技术对小模型帮助更大，但对高性能大模型提升有限。高级推理方法虽能提升表现，但也带来不稳定性。相比人类，大模型在规划、推理和空间协调等关键领域仍有局限，表明当前模型存在根本性缺陷，仅靠自我反思提示难以完全克服。研究强调需超越静态基准，以全面评估推理能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T19:01:17Z
- **目录日期**: 2025-05-18
