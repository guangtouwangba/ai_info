...
该研究评估了大语言模型在动态环境中的自适应能力，发现大模型普遍优于小模型，但策略性提示能缩小差距。小模型在基础反应任务上易受长提示干扰，而大模型表现更稳定。高级提示技术对小模型在复杂任务中帮助更大，但对高性能大模型提升有限。虽然推理方法可能显著提升表现，但也带来不稳定性。相比人类，大语言模型在规划、推理和空间协调等关键领域仍有局限，表明当前模型存在根本性缺陷，仅靠自我反思提示无法完全克服。研究强调需超越静态基准以全面评估推理能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T02:32:28Z
- **目录日期**: 2025-05-18
