...
该研究评估了大语言模型在动态环境中的自适应能力，测试了自我反思、启发式突变和规划等提示技术的作用。实验发现，大模型普遍优于小模型，但策略性提示能缩小差距；过长提示对小模型处理基础任务有负面影响，而大模型表现更稳健；复杂任务中高级提示对小模型提升更明显，但对高性能大模型帮助有限。高级推理方法虽能提升表现，但也带来不稳定性和性能波动。研究表明，当前大语言模型在规划、推理和空间协调等关键领域仍有局限，仅靠自我反思提示无法完全克服，需超越静态基准以全面评估推理能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T11:00:59Z
- **目录日期**: 2025-05-18
