...
该研究评估了大语言模型在动态环境中的自适应能力，发现大模型表现优于小模型，但策略性提示可缩小差距。长提示会损害小模型的基础反应任务表现，而大模型更稳健。高级提示技术对小模型在复杂任务中更有效，但对高性能大模型提升有限。高级推理方法虽能提升表现，但也带来不稳定性和性能波动。研究发现大模型在规划、推理和空间协调等关键领域仍有局限，现有推理方法（如思维链）虽能改进多步数学推理，但动态基准测试揭示了通用推理能力的不足，需超越静态基准以全面评估。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T12:01:19Z
- **目录日期**: 2025-05-18
