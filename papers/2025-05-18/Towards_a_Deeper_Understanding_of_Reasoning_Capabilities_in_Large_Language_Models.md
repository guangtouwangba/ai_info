...
这项研究评估了大型语言模型在动态环境中的自适应能力，发现大模型普遍优于小模型，但策略性提示可以缩小差距。过长的提示会损害小模型在基础任务上的表现，而大模型更稳健。高级提示技术主要提升小模型在复杂任务中的表现，但对大模型改善有限。尽管推理方法能提升某些任务表现，但也可能引发不稳定性和性能下降。与人类相比，当前大模型在规划、推理和空间协调等关键领域仍存在根本性缺陷，表明仅靠自我反思提示无法完全克服。研究强调需要超越静态基准来全面评估推理能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T17:01:17Z
- **目录日期**: 2025-05-18
