...
该开发者基于RISC-V架构，在自研操作系统Starina上实现了Hypervisor虚拟化支持，成功运行Linux。过程包括：进入Guest模式、处理Guest指令、输出测试信息、加载Linux内核并解决设备树问题、支持时间读取和中断注入、模拟MMIO设备，最终通过virtio-fs实现文件共享。整个开发在QEMU中完成，利用其RISC-V H-extension模拟和GDB调试功能，实现了从零搭建轻量虚拟机环境的目标。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T17:03:49Z
- **目录日期**: 2025-05-18
