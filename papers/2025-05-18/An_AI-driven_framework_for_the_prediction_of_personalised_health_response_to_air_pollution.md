...
空气污染严重威胁公共健康，会引发或加剧呼吸系统和心血管疾病。气候变化导致野火、热浪等极端天气增多，进一步加重污染危害。本研究提出一种创新方法，通过整合可穿戴设备的生理数据与实时环境暴露信息，利用对抗自编码器神经网络构建AI模型，预测个体对污染的健康反应。模型能准确重构时间相关的健康信号，捕捉非线性污染响应。结合智能手表数据的迁移学习增强了模型的泛化能力，展示了该方案对现实用户数据的适应性。整个系统采用云端模块化框架，确保数据收集安全合规。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T09:01:02Z
- **目录日期**: 2025-05-18
