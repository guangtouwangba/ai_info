...
空气污染严重威胁公众健康，加剧呼吸系统和心血管疾病。气候变化导致的极端天气（如野火和热浪）进一步加重污染影响。本研究提出一种创新方法，通过整合可穿戴设备的生理数据和实时环境暴露信息，利用AI时间序列预测技术监测个体健康反应。采用基于云计算的模块化框架，以对抗自编码器神经网络为核心模型，能准确重建健康信号并捕捉污染的非线性影响。结合智能手表数据的迁移学习增强了模型泛化能力，验证了该方案对现实用户数据的适应性。研究为个性化污染健康预警提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T16:01:07Z
- **目录日期**: 2025-05-18
