...
空气污染严重威胁公众健康，加剧呼吸系统和心血管疾病。气候变化引发的极端天气（如野火、热浪）进一步加重污染影响。本研究提出创新方案，通过整合可穿戴设备的生理数据与实时环境暴露信息，利用AI时间序列预测技术（对抗自编码器神经网络）构建个性化健康响应模型。该云框架能准确重构健康信号，捕捉污染的非线性影响，并通过智能手表数据的迁移学习提升模型泛化能力。研究展示了AI在结合个人健康数据与环境因素进行精准健康预测方面的潜力，为个性化医疗监测提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T23:01:03Z
- **目录日期**: 2025-05-18
