...
空气污染严重威胁公共健康，加剧呼吸系统和心血管疾病。气候变化引发的极端天气（如野火、热浪）会进一步加重污染危害。本研究提出创新方案，通过整合可穿戴设备的生理数据与实时环境暴露信息，利用对抗自编码器神经网络构建AI模型，精准预测个体健康对污染的非线性反应。模型采用云端模块化框架，结合迁移学习技术（基于智能手表数据），显著提升泛化能力。结果表明，该方法能有效重构健康信号时序特征，为个性化健康监测提供新途径。数据收集严格遵循安全与伦理规范。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T18:01:06Z
- **目录日期**: 2025-05-18
