...
空气污染严重威胁公众健康，会引发或加剧呼吸系统和心血管疾病。气候变化导致的极端天气（如野火和热浪）进一步加剧了污染及其健康影响。本研究提出一种创新方法，通过整合可穿戴设备的生理数据和实时环境暴露信息，利用对抗自编码器神经网络预测个体对污染的健康反应。该模型能准确重建时间相关的健康信号，并捕捉污染的非线性影响。结合智能手表数据的迁移学习增强了模型的泛化能力，展示了该框架对真实用户数据的适应性。整个系统基于云端模块化架构，确保数据收集的安全性和伦理性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T21:01:13Z
- **目录日期**: 2025-05-18
