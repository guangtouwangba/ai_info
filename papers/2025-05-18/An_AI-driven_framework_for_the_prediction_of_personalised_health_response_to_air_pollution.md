...
空气污染严重威胁公共健康，加剧呼吸系统和心血管疾病。气候变化引发的极端天气（如野火、热浪）进一步加剧污染危害。本研究提出创新方法，通过整合可穿戴设备的生理数据与实时环境暴露信息，利用AI时间序列预测技术（对抗自编码神经网络）构建个性化健康响应模型。该云框架能准确重构健康信号，捕捉污染的非线性影响，并通过智能手表数据迁移学习提升泛化能力。研究验证了该方案能基于用户数据有效预测个体对污染的健康反应，为精准健康监测提供新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T22:01:04Z
- **目录日期**: 2025-05-18
