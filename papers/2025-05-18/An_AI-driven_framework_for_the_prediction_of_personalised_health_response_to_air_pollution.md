...
空气污染严重威胁公共健康，加剧呼吸系统和心血管疾病。气候变化导致的极端天气（如野火和热浪）会进一步加重污染影响。本研究提出一种创新方法，通过整合可穿戴设备的生理数据和实时环境暴露信息，利用AI时间序列预测技术（对抗自编码神经网络）来监测和预测个体健康反应。模型能准确重建健康信号并捕捉污染的非线性影响，通过智能手表数据的迁移学习增强了泛化能力。该云框架在确保数据安全和伦理的前提下，展示了基于用户数据的个性化健康预测潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T08:01:06Z
- **目录日期**: 2025-05-18
