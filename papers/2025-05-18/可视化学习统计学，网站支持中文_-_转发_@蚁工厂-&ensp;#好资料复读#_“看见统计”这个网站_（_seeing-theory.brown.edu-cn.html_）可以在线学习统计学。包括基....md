...
"看见统计"是由布朗大学本科生Daniel Kunin开发的中英双语可视化统计学习网站(seeing-theory.brown.edu/cn.html)，通过交互式数据可视化帮助理解统计学概念。网站涵盖基础/进阶概率论、概率分布、频率学派与贝叶斯学派的统计推断、回归分析等核心内容，将抽象统计理论转化为直观的可视化演示。该项目曾获IEEE信息可视化会议最佳海报奖，适合统计学初学者通过图形化方式建立直观认知。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T03:24:45Z
- **目录日期**: 2025-05-18
