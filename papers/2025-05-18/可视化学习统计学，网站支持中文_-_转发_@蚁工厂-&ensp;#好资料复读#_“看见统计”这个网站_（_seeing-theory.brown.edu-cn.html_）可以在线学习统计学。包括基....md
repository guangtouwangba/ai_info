# 可视化学习统计学，网站支持中文 - 转发 @蚁工厂:&ensp;#好资料复读# “看见统计”这个网站 （ seeing-theory.brown.edu/cn.html ）可以在线学习统计学。包括基...
...
"看见统计"（seeing-theory.brown.edu/cn.html）是由布朗大学本科生Daniel Kunin开发的中英双语统计学学习网站，通过数据可视化帮助用户理解统计概念。网站涵盖基础/进阶概率论、概率分布、频率学派与贝叶斯学派的统计推断，以及回归分析等内容。其特色在于用交互式图表直观展示抽象统计理论，适合不同基础的学习者。该项目曾获IEEE VIS数据故事竞赛奖项，现托管于布朗大学服务器持续维护更新。中文界面降低了国内用户的学习门槛，是统计学入门的优质可视化学习资源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T00:03:49Z
- **目录日期**: 2025-05-18
