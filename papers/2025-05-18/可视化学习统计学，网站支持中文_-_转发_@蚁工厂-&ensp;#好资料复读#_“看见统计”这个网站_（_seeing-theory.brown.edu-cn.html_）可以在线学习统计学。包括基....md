...
"看见统计"（seeing-theory.brown.edu/cn.html）是一个可视化学习统计学的双语网站，由布朗大学本科生Daniel Kunin创建。该平台通过动态数据可视化直观展示六大核心模块：基础/进阶概率论、概率分布、频率学派与贝叶斯学派的统计推断，以及回归分析。其特色在于将抽象统计概念转化为交互式图形，支持中英文切换，特别适合初学者理解统计学原理。网站曾获IEEE VIS数据故事竞赛奖项，现已成为开源项目持续更新维护。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T01:31:25Z
- **目录日期**: 2025-05-18
