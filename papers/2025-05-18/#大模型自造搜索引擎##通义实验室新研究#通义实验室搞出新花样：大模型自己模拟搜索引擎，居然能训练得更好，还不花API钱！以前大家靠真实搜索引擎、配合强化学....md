...
通义实验室提出"ZeroSearch"方法，让大模型自主模拟搜索引擎进行训练。该方法通过轻量微调生成含噪声的文档数据，采用课程式抗噪训练逐步提升难度，并利用强化学习形成闭环。实验显示，仅用3B/7B小模型在单跳/多跳问答任务上就超越传统基于真实搜索引擎的方法，且无需API调用成本。该创新解决了文档质量差、训练成本高和模型扩展难等问题，为高效训练检索增强型大模型提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-18T09:03:46Z
- **目录日期**: 2025-05-18
