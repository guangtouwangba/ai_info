...
多模态大语言模型（MLLM）正快速发展，从最初的多模态理解扩展到多模态生成，能力从粗粒度迈向细粒度，并支持更多模态。然而，现有评估方法无法全面衡量其通用性。为此，研究团队提出"General-Level"评估框架，定义了MLLM的5级性能标准，引入"协同性"概念来评估模型在多模态理解与生成中的一致性。配套的General-Bench包含700多项任务和32.5万实例，评估了100多个先进MLLM，揭示了当前模型与真正通用人工智能的差距。该项目为下一代多模态基础模型研究奠定了基础，加速AGI实现。项目页面：https://generalist.top/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T18:01:11Z
- **目录日期**: 2025-05-08
