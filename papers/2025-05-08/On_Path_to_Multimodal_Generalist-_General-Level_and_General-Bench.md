...
多模态大语言模型（MLLM）正快速发展，从最初的多模态理解扩展到多模态生成，能力范围也从粗粒度到细粒度、从有限模态到任意模态。然而，现有评估方法难以衡量MLLM是否接近人类水平AI。为此，研究团队提出"General-Level"评估框架，定义了5级性能标准，并引入"协同性"概念来评估模型在多模态理解与生成中的一致性。配套的General-Bench包含700多项任务和32.5万实例，测试了100多个先进MLLM，揭示了当前模型的局限性。该项目旨在为下一代多模态基础模型研究提供基础设施，加速通用人工智能（AGI）的实现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T21:01:07Z
- **目录日期**: 2025-05-08
