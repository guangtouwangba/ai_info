...
多模态大语言模型（MLLM）正快速发展，从最初的多模态理解扩展到跨模态生成，能力从粗粒度到细粒度，支持模态范围也不断扩大。然而，现有评估指标无法全面衡量MLLM是否接近人类水平AI。为此，研究团队提出"General-Level"评估框架，定义了5级MLLM性能标准，引入"协同性"概念衡量模型在理解、生成及跨模态的一致性表现。配套的General-Bench基准包含700多项任务和32.58万实例，评估了100多个先进MLLM，揭示了当前模型与真正AI的差距，为下一代多模态基础模型研究提供基础设施，加速AGI实现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T20:01:07Z
- **目录日期**: 2025-05-08
