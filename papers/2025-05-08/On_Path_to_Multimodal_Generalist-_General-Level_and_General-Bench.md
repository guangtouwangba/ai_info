...
多模态大语言模型（MLLM）正快速发展，从最初仅理解多模态内容，逐步演变为能跨模态生成内容的通用型模型。然而，现有评测标准难以全面衡量其能力。为此，研究团队提出"General-Level"评估框架，定义了5级性能标准，并引入"Synergy"概念，评估模型在理解与生成、跨模态任务中的一致性。配套的General-Bench测试集涵盖700多项任务和32.58万实例，评测了100多个先进MLLM。结果显示当前模型距离真正通用人工智能仍有差距。该项目旨在为下一代多模态基础模型研究提供基础设施，加速AGI实现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T05:01:01Z
- **目录日期**: 2025-05-08
