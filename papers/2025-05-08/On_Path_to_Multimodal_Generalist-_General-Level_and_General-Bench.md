...
多模态大语言模型(MLLM)正在快速发展，从最初仅能理解多模态内容，进化到能跨模态理解和生成。现有评估方法难以全面衡量MLLM的真实能力。为此，研究团队提出"General-Level"评估框架，定义了5级性能标准，并引入"协同性"概念来衡量模型在理解与生成、跨模态方面的能力一致性。配套的General-Bench评估集包含700多项任务和32.5万实例，对100多个先进MLLM的测试揭示了当前模型与人类水平AI的差距。该项目旨在为下一代多模态基础模型研究提供基础设施，加速通用人工智能(AGI)的实现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T14:01:12Z
- **目录日期**: 2025-05-08
