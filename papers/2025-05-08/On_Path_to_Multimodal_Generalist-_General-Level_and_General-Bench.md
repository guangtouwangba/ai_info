...
多模态大语言模型(MLLM)正快速发展，从最初仅能理解多模态内容，演进为能跨模态理解和生成的通用系统。研究者提出"General-Level"评估框架，定义5级性能标准，引入"协同性"概念衡量模型在理解、生成和多模态间的一致性表现。配套的General-Bench包含700多项任务和32.5万实例，评估了100多个先进MLLM，揭示了当前模型与人类智能的差距。该研究旨在为下一代多模态基础模型提供评估基础设施，加速通用人工智能(AGI)的发展。项目页面：https://generalist.top/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T23:01:09Z
- **目录日期**: 2025-05-08
