...
多模态大语言模型(MLLM)正快速发展，从最初仅能理解多模态内容，到如今能跨模态理解和生成内容。研究提出"General-Level"评估框架，将MLLM能力划分为5个等级，引入"协同性"概念来衡量模型在理解与生成、跨模态间的一致性表现。配套的General-Bench基准包含700多项任务和32.5万个实例，评估了100多个先进MLLM，揭示了当前模型与真正通用人工智能的差距。该项目旨在为下一代多模态基础模型研究提供基础设施，加速实现AGI。项目页面：https://generalist.top/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T08:01:05Z
- **目录日期**: 2025-05-08
