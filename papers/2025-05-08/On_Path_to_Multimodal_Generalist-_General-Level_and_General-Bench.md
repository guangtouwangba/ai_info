...
多模态大语言模型（MLLM）正快速发展，从最初的多模态理解扩展到跨模态生成，能力从粗粒度到细粒度，支持模态范围也不断扩大。然而，现有评估方法难以衡量模型是否真正接近人类水平AI。为此，研究团队提出"General-Level"评估框架，定义了MLLM的5级性能标准，并引入"协同性"概念来衡量模型在理解和生成任务中的一致性。配套的General-Bench包含700多项任务和32.5万实例，评估了100多个先进MLLM，揭示了当前模型与真正AI的差距，为下一代多模态基础模型研究提供了基础设施。项目页面：https://generalist.top/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T19:01:10Z
- **目录日期**: 2025-05-08
