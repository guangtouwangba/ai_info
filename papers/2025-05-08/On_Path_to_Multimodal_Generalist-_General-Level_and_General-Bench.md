...
多模态大语言模型(MLLM)正在快速发展，从最初仅能理解多模态内容，进化到能跨模态理解和生成。现有评估方法难以全面衡量MLLM的真实能力。为此，研究团队提出"General-Level"评估框架，定义了5级性能标准，并引入"协同性"概念来衡量模型在理解与生成、跨模态方面的表现。配套的General-Bench基准包含700多项任务和32.58万个实例，评估了100多个先进MLLM。结果显示当前模型距离真正通用人工智能仍有差距。该研究为下一代多模态基础模型的发展提供了重要基础设施，将加速AGI的实现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T06:01:17Z
- **目录日期**: 2025-05-08
