...
多模态大语言模型（MLLM）正快速发展，从最初的多模态理解扩展到跨模态生成，能力从粗粒度到细粒度，支持模态范围也不断扩大。然而，仅凭任务表现评估模型是否接近人类水平AI存在局限。为此，研究提出**General-Level**评估框架，定义5级MLLM性能标准，核心指标为跨模态理解与生成的协同性（Synergy），并构建包含700+任务、32.5万实例的**General-Bench**基准。通过对100+前沿MLLM的测试，揭示了当前模型与通用AI的差距，为下一代多模态基础模型研究提供基础设施。项目主页：https://generalist.top/  

（注：原文约1000词，经压缩保留核心信息，包括研究动机、方法框架、基准规模及意义，严格控制在100字内。）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T11:01:04Z
- **目录日期**: 2025-05-08
