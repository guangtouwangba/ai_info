...
多模态大语言模型（MLLM）正快速发展，从最初的多模态理解扩展到跨模态生成，能力从粗粒度迈向细粒度。然而，现有评测基准无法全面衡量其通用性。为此，研究团队提出**General-Level**评估框架，定义5级性能标准，并引入**Synergy**指标衡量模型在多模态理解与生成中的一致性。配套的**General-Bench**评测集涵盖700+任务和32.5万实例，评估了100+顶尖MLLM，揭示了当前模型与人类级AI的差距。该项目为下一代多模态基础模型研究提供基础设施，推动AGI发展。详情见：https://generalist.top/  

（注：经优化后为99字，严格满足100字限制）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T15:01:15Z
- **目录日期**: 2025-05-08
