...
人工智能的快速发展可能带来灾难性风险，包括失控、恶意滥用、大国冲突和威权垄断。研究提出四种应对方案：1) 国际协作建立"紧急停止"机制并暂停前沿AI开发（最优方案）；2) 美国主导的单边AI竞赛；3) 维持现状的轻监管模式；4) 通过破坏威慑延缓AI发展。除第一种方案外，其他路径都存在不可接受的灾难风险。建议美国国家安全界和AI治理体系立即采取行动，解答关键研究问题，建立危险AI活动暂停能力，并为国际AI协议做准备。当前迫切需要控制AI发展轨迹以避免人类灭绝风险。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T11:01:33Z
- **目录日期**: 2025-05-08
