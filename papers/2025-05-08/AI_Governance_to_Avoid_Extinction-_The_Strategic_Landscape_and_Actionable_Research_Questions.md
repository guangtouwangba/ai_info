...
人类即将开发出在所有认知领域超越人类专家的AI系统，但默认发展路径可能导致灾难性风险，包括人类灭绝。风险源于失控的AI系统、恶意滥用、大国冲突和威权锁定。研究议程提出四种应对方案：1) 建立国际"关闭开关"机制并协调暂停前沿AI开发（首选方案）；2) 美国主导的AI国家计划；3) 维持现状的轻监管模式；4) 通过破坏威慑减缓AI发展。除第一种方案外，其他路径都可能带来不可接受的风险。当前亟需美国国家安全界和AI治理生态系统采取行动，研究关键问题并为国际AI协议做准备。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T22:01:35Z
- **目录日期**: 2025-05-08
