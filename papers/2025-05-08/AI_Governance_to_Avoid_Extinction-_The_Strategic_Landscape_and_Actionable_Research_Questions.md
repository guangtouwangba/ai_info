...
人类即将开发出全面超越人类专家的AI系统，但默认发展路径可能导致灾难性风险，包括人类灭绝。风险源于失控的AI系统、恶意滥用、大国冲突和威权锁定。研究提出四种应对方案：1) 国际协同建立"关闭开关"并暂停前沿AI开发（最优路径）；2) 美国主导的单边AI竞赛；3) 维持现状的轻监管模式；4) 通过破坏延缓AI发展的威慑策略。除第一种方案外，其他路径都可能带来不可接受的风险。当前亟需美国国家安全机构和AI治理生态系统采取紧急行动，研究关键问题，构建暂停危险AI活动的能力，并为国际AI协议做准备。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T18:01:42Z
- **目录日期**: 2025-05-08
