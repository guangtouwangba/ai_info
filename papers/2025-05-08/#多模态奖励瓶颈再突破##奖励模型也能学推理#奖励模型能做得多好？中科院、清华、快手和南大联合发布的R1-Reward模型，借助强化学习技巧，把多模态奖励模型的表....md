...
中科院、清华、快手和南大联合研发的R1-Reward模型在多模态奖励模型领域取得突破。该模型采用强化学习技术，通过StableReinforce算法（包含预裁剪、优势过滤器和一致性奖励机制）显著提升性能5%-15%。训练过程先利用GPT-4o生成20万样本进行预训练，再针对高难度样本强化学习。模型在多个基准测试中超越现有技术，推理时多次采样可进一步提高准确率，在Any Correct评估下接近100%准确。此外，模型还展现出反思纠错能力，使推理过程更高效简洁。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T22:02:53Z
- **目录日期**: 2025-05-08
