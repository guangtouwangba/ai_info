...
中科院、清华、快手和南大联合研发的R1-Reward模型在多模态奖励领域取得突破。该模型采用强化学习框架，通过预裁剪、优势过滤器和一致性奖励三大技术创新，将性能提升5%-15%。训练时先用GPT-4o生成20万样本进行预训练，再重点攻克高难度样本。实验显示，该模型在多个基准测试中超越现有技术，推理过程更高效，并具备自我反思能力。特别在"Any Correct"评估中准确率接近100%，展现了强大的多模态推理能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T23:02:55Z
- **目录日期**: 2025-05-08
