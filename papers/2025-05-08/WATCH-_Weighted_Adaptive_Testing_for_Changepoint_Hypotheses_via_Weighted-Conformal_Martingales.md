...
本文提出了一种加权广义符合性测试鞅(WCTMs)方法，用于在高风险AI/ML系统中持续监测数据分布的任何意外变化，同时控制误报。该方法扩展了现有非参数变化点检测技术的适用范围，支持在线适应轻度协变量偏移，同时能检测更严重的变化(如概念偏移或极端协变量偏移)。相比现有方法，WCTMs提供了更灵活的理论框架，允许监测更广泛的假设类别。在真实数据集上的实验表明，该方法优于当前最先进的基线方法，为AI系统部署后的安全监控提供了更强大的工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T16:01:33Z
- **目录日期**: 2025-05-08
