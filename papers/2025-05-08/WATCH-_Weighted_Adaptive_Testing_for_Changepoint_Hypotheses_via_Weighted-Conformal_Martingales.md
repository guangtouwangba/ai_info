...
本文提出了一种加权广义共形测试鞅（WCTMs）方法，用于高风险AI/ML系统的持续监控。该方法扩展了现有非参数变点检测技术的适用范围，能够在线监测数据分布中的异常变化（如概念漂移或极端协变量漂移）并控制误报率。相比现有方法，WCTMs支持在线自适应调整以应对轻度协变量漂移，同时对无法适应的严重变化发出警报。实验表明，该方法在真实数据集上优于当前最先进的基线方法，为AI系统部署后的安全监控提供了更强大的理论框架和实践工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T14:01:24Z
- **目录日期**: 2025-05-08
