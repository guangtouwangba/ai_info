...
本文提出了一种加权广义共形测试鞅(WCTM)方法，用于高风险AI/ML系统的持续部署后监控。该方法突破了现有非参数变点检测技术的限制，能够在线监测数据分布中的任何异常变化，同时控制误报率。研究还开发了实用算法，可适应轻度协变量偏移，并对严重概念偏移或极端协变量偏移发出警报。相比现有最优方法，该方案在真实数据集上表现出更优性能，为AI系统安全部署提供了更全面的监控手段，特别适用于需要持续保障可靠性的高风险应用场景。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T18:01:20Z
- **目录日期**: 2025-05-08
