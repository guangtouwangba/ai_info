...
本文提出了一种加权广义共形测试鞅(WCTMs)方法，用于高风险AI/ML系统的持续监控。该方法扩展了现有非参数变点检测技术的应用范围，能够在线监控数据分布中的异常变化并控制误报。研究者开发了特定算法，可适应轻度协变量偏移，同时对严重概念偏移或极端协变量偏移发出警报。相比现有方法，WCTMs突破了假设类限制，支持在线自适应调整。实验表明，该方法在真实数据集上优于当前最优基线模型，为AI系统部署后的安全监控提供了新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T15:01:24Z
- **目录日期**: 2025-05-08
