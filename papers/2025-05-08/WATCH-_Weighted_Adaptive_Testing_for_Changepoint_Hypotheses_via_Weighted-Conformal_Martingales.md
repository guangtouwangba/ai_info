...
本文提出了一种加权广义符合性测试马氏链(WCTMs)方法，用于人工智能系统部署后的持续监控。该方法扩展了现有非参数变点检测技术的应用范围，能在线监测数据分布中的异常变化并控制误报率。研究者设计了实用算法，可适应轻度协变量偏移，同时对严重概念偏移或极端协变量偏移发出警报。实验表明，该方法在真实数据集上优于现有基线方法，为高风险AI系统提供了更可靠的监控方案。该研究为AI系统部署后的安全监测提供了新的理论框架和实用工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T12:01:38Z
- **目录日期**: 2025-05-08
