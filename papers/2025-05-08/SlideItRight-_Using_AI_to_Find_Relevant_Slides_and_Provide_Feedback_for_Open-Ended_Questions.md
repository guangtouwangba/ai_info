...
研究表明，多模态AI反馈能提升学习效果。通过结合大语言模型生成的文本反馈和相关课程幻灯片，研究采用2x2实验设计（人工/AI反馈×有无幻灯片）对91名参与者测试。结果显示，所有组别均取得显著学习进步，但组间差异不显著。学生认为幻灯片辅助有帮助但理解存在困难，AI反馈虽具个性化和相关性，但信任度低于人工反馈。该研究验证了多媒体学习原则，表明多模态反馈潜力巨大，但需优化AI反馈的可理解性和可信度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T03:19:36Z
- **目录日期**: 2025-05-08
