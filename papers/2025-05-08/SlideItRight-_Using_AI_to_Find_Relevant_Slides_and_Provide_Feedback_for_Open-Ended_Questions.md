...
研究表明，利用AI生成多模态反馈（如结合文本和幻灯片）能提升学习效果，但与传统人工反馈相比，学习增益差异不显著。91名参与者的实验显示，尽管学生认为AI反馈个性化且相关，但对AI的信任度低于人工反馈。幻灯片辅助虽被认为有益，但理解存在困难。所有条件均带来显著学习提升，但不同反馈方式（AI/人工、有无幻灯片）的效果差异无统计学意义。研究突显了AI多模态反馈的潜力，但也揭示了学生对AI信任度和多模态内容理解度的挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T05:01:45Z
- **目录日期**: 2025-05-08
