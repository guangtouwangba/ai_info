...
研究表明，人工智能（AI）生成的多模态反馈（结合文本与相关课件幻灯片）能有效支持学生学习。通过91人的在线实验，发现所有反馈形式均带来显著学习提升，但不同条件间无显著差异。学生认为幻灯片辅助有助于学习，但理解存在困难；AI生成的文本反馈被认为具有个性化和相关性，但信任度低于人工反馈。该研究验证了多媒体学习原则，即多模态反馈能降低认知负荷，但需优化AI反馈的可理解性和可信度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T10:01:49Z
- **目录日期**: 2025-05-08
