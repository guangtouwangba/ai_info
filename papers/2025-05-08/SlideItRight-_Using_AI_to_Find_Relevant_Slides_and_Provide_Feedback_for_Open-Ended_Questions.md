...
该研究探讨了AI生成多模态反馈对学习效果的影响，结合LLMs文本反馈和相关课程幻灯片辅助。通过91人的在线实验（2x2设计：人工/AI反馈×有无幻灯片），结果显示所有条件下学习均有显著提升，但组间差异不显著。学生认为幻灯片反馈有助学习但理解存在困难，AI文本反馈虽具个性化和相关性，但信任度低于人工反馈。研究表明多模态反馈具有潜力，但需优化AI可信度和幻灯片呈现方式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T12:02:38Z
- **目录日期**: 2025-05-08
