...
该研究探讨了AI生成多模态反馈对学习的影响。通过结合大语言模型生成的文本反馈和相关课程幻灯片，研究者采用2×2实验设计（人工/AI反馈×有无幻灯片）对91名参与者进行了测试。结果显示所有条件下学习效果均有显著提升，但组间差异不显著。学生认为幻灯片辅助有助于学习，但理解存在困难；AI生成的反馈被认为个性化和相关，但信任度低于人工反馈。研究表明多模态反馈具有潜力，但在可理解性和可信度方面仍需改进。研究支持了多媒体学习原则，展示了AI在教育反馈中的应用前景。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T23:01:47Z
- **目录日期**: 2025-05-08
