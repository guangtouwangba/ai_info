...
该研究探讨了多模态AI反馈对学生学习的影响，利用大语言模型生成文本反馈并辅以相关幻灯片。通过91人的在线实验（2x2设计：人工/AI反馈×有无幻灯片），发现所有条件下学习效果均有显著提升，但组间差异不显著。学生认为幻灯片反馈有助学习但理解困难，AI文本反馈虽具个性化和相关性，但信任度低于人工反馈。研究表明多模态反馈具有潜力，但在清晰度和可信度方面仍需改进。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T19:01:50Z
- **目录日期**: 2025-05-08
