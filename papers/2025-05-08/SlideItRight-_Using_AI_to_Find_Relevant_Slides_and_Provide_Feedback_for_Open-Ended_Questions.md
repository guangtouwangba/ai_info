...
该研究探讨了人工智能在多模态反馈中的作用，利用大语言模型（LLM）生成文本反馈，并辅以相关课程幻灯片作为补充。通过一项91人的在线实验（2x2设计），比较了人工反馈与AI反馈、有无幻灯片辅助的效果。结果显示，所有条件下学习效果均有显著提升，但组间差异不显著。学生认为幻灯片反馈对学习有帮助，但理解存在困难；AI生成的开放式反馈被认为个性化且相关，但信任度低于人工反馈。研究表明，多模态反馈具有潜力，但需优化AI可信度和辅助材料的清晰度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T18:01:51Z
- **目录日期**: 2025-05-08
