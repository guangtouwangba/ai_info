...
该论文介绍了WebGen-Bench，一个用于评估基于LLM的代理从零创建多文件网站代码库能力的新基准。该基准包含多样化的网站生成指令，涵盖三大类和十三个子类，涉及几乎所有重要类型的Web应用。通过GPT-4o生成647个测试用例并人工调整，确保准确性。测试采用网页导航代理自动执行，评估结果显示最佳组合（Bolt.diy + DeepSeek-R1）仅达到27.8%准确率，突显了基准的挑战性。此外，构建了包含6,667条指令的训练集WebGen-Instruct，训练后的Qwen2.5-Coder-32B-Instruct模型准确率达38.2%，超越了最佳专有模型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T00:01:26Z
- **目录日期**: 2025-05-08
