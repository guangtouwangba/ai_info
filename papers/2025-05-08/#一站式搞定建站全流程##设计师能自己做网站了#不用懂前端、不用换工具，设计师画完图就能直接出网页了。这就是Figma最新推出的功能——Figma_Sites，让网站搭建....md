...
Figma推出全新功能Figma Sites，让设计师无需前端知识即可独立完成网站建设。该工具可将设计稿直接转换为响应式网页，提供预设模块和自动布局功能简化搭建流程。用户能轻松添加悬停效果、滚动字幕等交互元素，完全无需编码。未来还将支持AI生成和优化代码。平台提供多种模板，适用于活动页、作品集等场景，实现从设计到上线的全流程一站式解决，大幅降低建站门槛。官网已开放体验链接。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T22:03:46Z
- **目录日期**: 2025-05-08
