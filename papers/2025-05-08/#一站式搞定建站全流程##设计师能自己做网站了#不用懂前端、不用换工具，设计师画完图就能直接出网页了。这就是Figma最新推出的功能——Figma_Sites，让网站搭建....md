# #一站式搞定建站全流程##设计师能自己做网站了#不用懂前端、不用换工具，设计师画完图就能直接出网页了。这就是Figma最新推出的功能——Figma Sites，让网站搭建...
...
Figma推出全新功能Figma Sites，使设计师无需前端知识即可快速搭建网站。该工具支持将设计稿直接转换为响应式网页，提供预设模块和自动布局功能，简化页面搭建流程。用户可轻松添加交互动效（如悬停效果、滚动字幕等），无需编写代码。未来还将支持AI生成和优化代码。该平台提供多种模板，适用于活动页、作品集等场景，实现从设计到上线的全流程一站式解决，显著降低独立建站门槛。官网已开放体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T20:04:01Z
- **目录日期**: 2025-05-08
