...
Figma推出新功能Figma Sites，让设计师无需前端知识即可一站式完成网站搭建。该工具支持将设计稿直接转为响应式网页，提供预设模块和自动布局功能，可快速生成完整页面。用户能轻松添加悬停、滚动等交互效果，无需编写代码。未来还将支持AI生成和优化代码。该功能大幅降低建站门槛，设计师可独立完成从设计到上线的全流程。官网提供多种模板，适用于活动页、作品集等场景，帮助用户快速上线网站。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T10:04:00Z
- **目录日期**: 2025-05-08
