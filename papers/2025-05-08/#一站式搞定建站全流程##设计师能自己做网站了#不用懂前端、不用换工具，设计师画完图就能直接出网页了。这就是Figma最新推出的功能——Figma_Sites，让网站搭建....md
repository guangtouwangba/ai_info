...
Figma推出全新功能Figma Sites，让设计师无需前端知识即可独立建站。该工具支持将设计稿直接转为响应式网页，提供预设模块和自动布局功能，简化页面搭建流程。用户可轻松添加悬停、滚动等交互效果，未来还将支持AI代码优化。从活动页到作品集，Figma Sites提供多种模板，实现从设计到上线的全流程一站式解决，显著降低建站门槛。官网已开放体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T09:03:37Z
- **目录日期**: 2025-05-08
