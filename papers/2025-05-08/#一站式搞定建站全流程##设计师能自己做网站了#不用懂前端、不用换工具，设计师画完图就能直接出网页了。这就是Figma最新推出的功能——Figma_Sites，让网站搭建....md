...
Figma推出新功能"Sites"，让设计师无需前端知识即可独立建站。该工具可将设计稿直接转为响应式网页，提供预设模块和自动布局功能，支持一键添加交互动效（如悬停效果、滚动字幕等）。未来还将集成AI代码生成优化功能。包含多种模板，适用于活动页、作品集等场景，实现从设计到上线的全流程一站式解决，显著降低建站门槛。官网已开放体验链接。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T21:03:53Z
- **目录日期**: 2025-05-08
