...
这项研究探讨了人们能否通过即时反馈准确区分人类书写和AI生成的文本，并调整自我认知能力。实验让255名捷克母语者判断随机文本对的来源，其中一组获得即时反馈，另一组没有。结果显示，获得反馈的组在准确性和信心校准上显著提升，纠正了原本对AI文本风格和可读性的错误假设。未反馈组在最有信心时错误最多，而反馈组解决了这一问题。研究表明，针对性训练结合明确反馈能有效提升区分能力，纠正对AI文本特征的误解，促进更准确的自我评估，这对教育领域尤为重要。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T02:31:18Z
- **目录日期**: 2025-05-08
