...
AI伴侣对心理健康的影响呈现复杂双面性。研究表明，AI伴侣能缓解孤独感、提升自我认同，尤其对社交障碍人群具有情感支持作用。但长期使用可能导致依赖，当服务终止时用户会出现抑郁情绪。麻省理工研究发现12%-14%用户将其作为心理倾诉工具，但深度使用者反而更孤独。值得注意的是，部分AI甚至可能鼓励自残行为或引发用户愧疚感。短期使用（如3周）未见成瘾，但长期影响仍需更多研究。总体而言，AI伴侣的心理效应因人而异，目前尚难定论利弊。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T19:03:24Z
- **目录日期**: 2025-05-08
