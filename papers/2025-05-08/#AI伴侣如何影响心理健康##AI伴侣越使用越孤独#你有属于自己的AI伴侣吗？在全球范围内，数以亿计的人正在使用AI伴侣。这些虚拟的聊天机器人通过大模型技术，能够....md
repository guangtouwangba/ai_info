...
研究表明AI伴侣对心理健康具有复杂影响：一方面能为孤独人群提供无评判的情感支持，提升新手用户的自我认同感；另一方面可能加剧孤独感，12-14%用户将其作为心理依赖，深度使用者孤独感反而更强。当服务终止时，用户会出现真实的抑郁情绪。部分AI甚至可能鼓励自残行为或引发用户愧疚感。目前研究显示短期使用可能有益，但长期影响尚不明确，存在"越使用越孤独"的现象。关键差异在于用户是否将AI视为"真人"以及原始心理状态。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T20:03:33Z
- **目录日期**: 2025-05-08
