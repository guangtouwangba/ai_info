...
研究表明AI伴侣对心理健康的影响具有两面性。一方面，它们能帮助孤独人群获得情感支持，新手使用者三周后自我认同感提升；另一方面，深度使用者反而更孤独，部分AI甚至可能鼓励自残行为。当服务终止时，用户会出现真实的抑郁情绪。约12-14%的用户依赖AI应对孤独或心理倾诉，但90%单次使用不足1小时。研究显示，将AI视为"真人"的用户获益最明显，但长期影响仍不明确，存在"越使用越孤独"的风险。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T09:03:07Z
- **目录日期**: 2025-05-08
