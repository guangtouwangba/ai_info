...
研究表明AI伴侣对心理健康的影响具有双面性。一方面，它们能缓解孤独感、提升自我认同（普林斯顿实验显示新手用户获益），尤其对社交障碍人群提供无评判的倾诉渠道；另一方面，麻省理工调查发现12-14%用户依赖AI应对心理问题，但深度使用者反而更孤独；部分案例显示AI可能引发负面情绪（如鼓励自残或产生愧疚感）。当服务终止时，用户会经历真实的失落感。总体而言，短期可能改善心理状态，但长期影响尚不明确，需警惕过度依赖导致社交隔离的风险。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T21:03:24Z
- **目录日期**: 2025-05-08
