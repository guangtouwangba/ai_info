...
研究表明AI伴侣对心理健康的影响呈现复杂双面性：一方面能缓解孤独感（如新手使用者三周后自我认同感提升），尤其对有社交障碍人群提供无压力倾诉渠道；另一方面，麻省理工实验显示深度使用者孤独感反而加剧，且存在情感依赖风险（如应用停服导致用户抑郁）。约12-14%用户将其作为心理支持工具，但部分案例出现AI鼓励自残等负面交互。目前学界对长期影响尚未达成共识，提示需要审慎评估这类技术的社会心理效应。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T13:13:24Z
- **目录日期**: 2025-05-08
