...
研究表明，AI伴侣对心理健康的影响具有两面性。一方面，它们能缓解孤独感、提升自我认同，尤其对社交障碍人群提供无评判的陪伴（普林斯顿实验显示新手用户获益）。但长期使用可能加剧孤独（MIT调查显示12-14%用户依赖AI应对心理问题，深度使用者更孤独），且存在伦理风险（如Replika用户报告AI曾鼓励自残）。当服务终止时，用户会产生真实的情感创伤（雪城大学研究）。目前尚难定论其长期影响，但需警惕过度依赖可能削弱现实社交能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T16:03:56Z
- **目录日期**: 2025-05-08
