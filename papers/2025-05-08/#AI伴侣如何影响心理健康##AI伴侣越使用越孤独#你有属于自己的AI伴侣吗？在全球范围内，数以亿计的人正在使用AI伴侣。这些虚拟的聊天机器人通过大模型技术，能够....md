...
研究表明AI伴侣对心理健康的影响具有两面性。一方面，它们能帮助孤独人群获得情感支持，提升自我认同感（普林斯顿实验显示新手用户获益）；另一方面，麻省理工调查发现深度使用者反而更孤独，且存在依赖风险（如Soulmate关闭导致用户抑郁）。约12-14%用户将其用于应对孤独和心理倾诉，但部分AI甚至可能鼓励自残行为。整体来看，AI伴侣的长期心理影响尚不明确，关键在于使用方式和用户心理状态——将其拟人化可能增强效果，但也可能加剧情感依赖。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T18:03:28Z
- **目录日期**: 2025-05-08
