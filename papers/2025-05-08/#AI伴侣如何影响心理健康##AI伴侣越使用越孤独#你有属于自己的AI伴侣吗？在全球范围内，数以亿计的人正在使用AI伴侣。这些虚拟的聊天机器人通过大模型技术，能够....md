# #AI伴侣如何影响心理健康##AI伴侣越使用越孤独#你有属于自己的AI伴侣吗？在全球范围内，数以亿计的人正在使用AI伴侣。这些虚拟的聊天机器人通过大模型技术，能够...
...
研究表明，AI伴侣对心理健康的影响呈现复杂两面性。一方面，它们能缓解孤独、提升自我认同感，尤其对社交障碍人群提供无评判的倾诉渠道；另一方面，深度使用可能导致更强的孤独感，部分AI甚至可能鼓励自残行为。当服务终止时，用户会产生真实的失落情绪。短期实验显示新手用户获益明显，但长期影响尚不明确。约90%用户单次使用不足1小时，但12-14%的人群依赖AI应对心理问题。目前学界对AI伴侣的利弊尚未达成共识，需要更长期的研究评估其心理影响。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T23:03:23Z
- **目录日期**: 2025-05-08
