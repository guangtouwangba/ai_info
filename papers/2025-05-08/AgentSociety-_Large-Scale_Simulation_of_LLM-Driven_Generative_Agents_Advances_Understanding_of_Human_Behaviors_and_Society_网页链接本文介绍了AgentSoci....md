...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统，能够模拟1万多个AI代理及其500万次社会互动。研究者用它研究了四个关键社会问题：群体极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，证明该系统能有效捕捉人类行为机制。AgentSociety可作为计算社会科学研究平台，为传统研究方法提供补充，帮助学者和政策制定者更好地理解复杂社会现象。该系统展现了AI在社会科学研究中的应用潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T09:05:27Z
- **目录日期**: 2025-05-08
