...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟1万多个代理的社会互动（500万次交互）。它被用于研究极化现象、信息传播、基本收入政策及自然灾害影响等社会问题，结果与现实数据吻合。该系统结合了生成式AI、真实社会环境和大规模模拟引擎，为社会科学研究提供了新工具，能辅助传统方法（如调查和干预）分析社会问题的模式和机制。研究表明AgentSociety能有效捕捉人类行为特征，具有支持社会科学研究和政策制定的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T01:33:00Z
- **目录日期**: 2025-05-08
