...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能模拟10,000多个AI代理的社会互动（500万次交互）。研究者用它研究四个社会问题：群体极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实数据吻合，验证了该系统捕捉人类行为机制的能力。该系统可作为社会科学研究和政策制定的新工具，补充传统研究方法（如调查和实验）。研究展示了AI模拟在理解复杂社会现象方面的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T11:05:11Z
- **目录日期**: 2025-05-08
