...
该研究介绍了AgentSociety——一个基于大语言模型的大规模社会模拟系统，可模拟10,000+智能代理及其500万次社会互动。该系统被用于研究四大社会问题：群体极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，证明其能有效捕捉人类行为机制。该平台为社会科学研究提供了新工具，可辅助传统研究方法，帮助学者和政策制定者深入理解社会问题的成因与模式。研究展示了AI模拟在社会科学领域的应用潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T00:05:34Z
- **目录日期**: 2025-05-08
