...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个智能代理及其500万次社会互动。该系统被用于研究四大社会问题：社会极化、信息传播、基本收入政策效果和自然灾害影响。研究结果显示，模拟结果与现实世界数据高度吻合，验证了该系统在揭示人类行为机制方面的有效性。这一创新工具为社会科学研究和政策制定提供了新的实验平台，能够辅助传统研究方法（如调查和访谈），帮助深入理解复杂社会问题的成因和模式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T23:04:39Z
- **目录日期**: 2025-05-08
