...
这篇论文介绍了AgentSociety，一个基于大型语言模型的大规模社会模拟器，能够模拟1万多个代理及其500万次互动。研究者用它研究了四个关键社会问题：社会极化、信息传播、基本收入政策影响和外部冲击（如飓风）。模拟结果与现实世界数据吻合，验证了该工具捕捉人类行为和社会机制的能力。AgentSociety可作为计算社会科学的新平台，辅助传统研究方法，帮助学者和政策制定者更好地理解社会问题的模式和成因，展现了在社会科学研究中的重要潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T16:05:28Z
- **目录日期**: 2025-05-08
