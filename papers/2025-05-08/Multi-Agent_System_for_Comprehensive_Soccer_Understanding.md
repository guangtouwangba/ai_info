...
该研究提出了一个全面的足球理解框架，主要贡献包括：(1) 构建首个大规模多模态足球知识库SoccerWiki，整合球员、球队、裁判和场馆等领域的知识；(2) 推出最大的足球专用基准SoccerBench，包含约1万组标准化多模态选择题，覆盖13项理解任务；(3) 开发新型多智能体系统SoccerAgent，通过协同推理分解复杂问题，并利用SoccerWiki的领域知识；(4) 在SoccerBench上评估现有模型，验证了该智能体系统的优越性。所有数据和代码已开源。该框架填补了现有研究在综合性足球理解方面的空白。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T00:01:15Z
- **目录日期**: 2025-05-08
