...
AI作弊已成为大学生普遍现象，近90%学生使用ChatGPT等工具完成作业、论文甚至编程任务。教师采取蓝皮书考试、AI检测工具等应对措施，但效果有限。这种现象不仅破坏学术诚信，更暴露教育体系弊端：功利化倾向削弱学生基础能力，传统作业形式与当代需求脱节。专家指出，单纯惩罚难以解决问题，教育系统需全面改革以适应AI时代，重新平衡技术工具与核心能力培养的关系。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T16:03:02Z
- **目录日期**: 2025-05-08
