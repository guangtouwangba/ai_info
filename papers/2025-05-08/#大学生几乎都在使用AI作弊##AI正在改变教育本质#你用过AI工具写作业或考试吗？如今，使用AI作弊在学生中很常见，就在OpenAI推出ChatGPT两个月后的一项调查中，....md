...
当前大学生使用AI作弊现象普遍，约90%学生用ChatGPT等工具完成作业、论文甚至编程任务，严重冲击学术诚信。教师采取蓝皮书考试、AI检测工具等应对措施，但效果有限。这一现象暴露出教育体系问题：高成本导致学习功利化，传统作业失去意义。专家指出，单纯禁止AI治标不治本，亟需系统性教育改革，平衡技术使用与能力培养。AI作弊的长期影响尚待观察，但已引发对批判性思维弱化和教育本质异化的深刻担忧。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T13:12:32Z
- **目录日期**: 2025-05-08
