...
当前大学生普遍使用AI工具（如ChatGPT）完成作业、论文和编程任务，近90%的学生承认使用AI辅助学习。教师采取多种措施应对，包括改变考试形式、使用检测工具等，但效果有限。AI作弊不仅影响学术诚信，还削弱学生的基本能力，反映出教育系统的高成本和功利化问题。专家指出，仅惩罚作弊无法解决问题，需全面改革教育体系以适应AI时代。这一现象凸显了传统教育面临的挑战，亟需重新思考学习方式和评估标准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T11:02:36Z
- **目录日期**: 2025-05-08
