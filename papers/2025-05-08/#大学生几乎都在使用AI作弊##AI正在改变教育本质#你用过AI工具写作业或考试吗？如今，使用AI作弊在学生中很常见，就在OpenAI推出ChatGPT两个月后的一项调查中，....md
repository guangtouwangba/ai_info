...
当前AI工具（如ChatGPT）被广泛用于大学生作业和考试作弊，包括生成论文、编程代码和课堂讨论内容。教师们采取应对措施如调整考试形式、使用检测工具等，但效果有限。AI作弊不仅破坏学术诚信，还可能削弱学生的基本学习能力，反映出教育系统的高成本和功利化问题。专家指出，仅惩罚作弊无法解决问题，需全面改革教育体系，重新思考学习方式和评估标准。这一现象凸显了AI时代教育本质面临的深层挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T23:02:36Z
- **目录日期**: 2025-05-08
