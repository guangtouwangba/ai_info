...
当前大学生普遍使用AI工具（如ChatGPT）完成作业、论文和编程任务，近90%的学生承认使用AI辅助学习。教师采取蓝皮书考试、AI检测工具等应对措施，但效果有限。AI作弊不仅破坏学术诚信，还可能削弱学生的写作和批判性思维能力，反映出教育系统的高成本和功利化问题。专家指出，仅惩罚作弊无法解决问题，需全面改革教育体系，调整评估方式以适应AI时代。这一现象凸显了传统教育与技术发展间的根本性矛盾。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T19:02:40Z
- **目录日期**: 2025-05-08
