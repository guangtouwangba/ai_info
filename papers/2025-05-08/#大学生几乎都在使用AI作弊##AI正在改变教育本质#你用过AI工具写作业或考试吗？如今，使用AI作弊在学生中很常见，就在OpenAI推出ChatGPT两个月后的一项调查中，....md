...
当前大学生使用AI作弊现象普遍，近90%学生用ChatGPT完成作业。主要方式包括：AI生成论文/代码、参与在线讨论等。教师采取蓝皮书考试、AI检测工具等应对措施，但效果有限。AI作弊不仅破坏学术诚信，更暴露教育体系问题——功利化学习导致知识探索缺失。教育工作者指出，单纯惩罚治标不治本，需系统性改革以适应AI时代的学习需求。这一现象正迫使教育本质发生深刻变革。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T10:02:40Z
- **目录日期**: 2025-05-08
