...
该微博讨论AI工具（如ChatGPT）在大学生中的普遍使用及其对教育的影响。调查显示近90%学生用AI完成作业，包括写作、编程和课堂讨论。教师采取多种措施应对，如更改考试形式、使用检测工具等，但效果有限。AI作弊不仅破坏学术诚信，还可能削弱学生的基础能力，同时反映教育系统的高成本和功利化问题。专家指出，仅惩罚作弊不够，需全面改革教育体系以适应AI时代。完整文章见链接。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T12:03:26Z
- **目录日期**: 2025-05-08
