...
AI作弊正在深刻改变教育生态。调查显示近90%大学生使用ChatGPT等工具完成作业，包括论文写作、编程作业和在线讨论。教师采取蓝皮书考试、AI检测工具等应对措施，但效果有限。这种现象不仅威胁学术诚信，更反映出教育体系的结构性问题——功利化倾向导致学习沦为交易。教育工作者指出，单纯惩罚难以治本，亟需系统性改革以适应AI时代的学习需求。这场变革将重新定义教育的本质，需要平衡技术应用与核心能力培养。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T17:02:59Z
- **目录日期**: 2025-05-08
