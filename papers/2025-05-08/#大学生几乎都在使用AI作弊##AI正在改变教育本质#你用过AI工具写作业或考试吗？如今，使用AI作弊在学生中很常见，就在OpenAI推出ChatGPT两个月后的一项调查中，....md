...
当前大学生使用AI作弊现象普遍，约90%学生用ChatGPT等工具完成作业、论文和编程任务，甚至生成课堂讨论内容。教师采取蓝皮书考试、AI检测工具等应对措施，但效果有限。AI作弊不仅破坏学术诚信，还可能削弱学生的写作和批判性思维能力，反映出教育系统的高成本和功利化问题。专家指出，仅惩罚作弊无法解决问题，需全面改革教育体系以适应AI时代的学习需求。这一现象正在从根本上挑战传统教育模式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T22:02:35Z
- **目录日期**: 2025-05-08
