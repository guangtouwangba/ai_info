...
当前大学生使用AI作弊现象普遍，约90%学生用ChatGPT等工具完成作业、论文甚至编程任务。教师采取蓝皮书考试、AI检测工具等应对措施，但效果有限。AI作弊不仅破坏学术诚信，更暴露教育体系问题：功利化倾向削弱学生基础能力，传统作业模式受到质疑。教育工作者指出，单纯惩罚难以治本，需进行系统性改革以适应AI时代的学习需求。这一现象反映出高等教育正面临本质性挑战，亟需重新平衡技术应用与能力培养的关系。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T15:03:03Z
- **目录日期**: 2025-05-08
