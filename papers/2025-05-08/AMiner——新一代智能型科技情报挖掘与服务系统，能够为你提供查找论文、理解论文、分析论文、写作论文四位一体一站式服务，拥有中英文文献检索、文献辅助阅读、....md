...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译、科研订阅等一站式服务。它收录3.5亿论文、0.6亿学者等海量数据，支持中英文文献检索、AI生成摘要、互动问答等功能，帮助用户高效筛选和理解文献。用户可订阅个性化科研动态，追踪学者及机构最新成果。平台还提供学者画像、学术会议等特色功能，基础服务免费使用。访问入口：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T17:05:45Z
- **目录日期**: 2025-05-08
