...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析及写作的一站式服务。它支持中英文文献检索，拥有3.5亿论文、0.6亿学者等海量数据，并具备AI辅助阅读、自动摘要生成、互动问答等功能。用户可上传PDF或直接搜索文献，快速获取摘要和章节概要。平台还提供科研动态订阅服务，根据用户偏好推送最新学术资讯。此外，AMiner包含学者画像、学术会议等特色功能，基础服务免费开放。访问入口：https://www.aminer.cn/。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T18:05:16Z
- **目录日期**: 2025-05-08
