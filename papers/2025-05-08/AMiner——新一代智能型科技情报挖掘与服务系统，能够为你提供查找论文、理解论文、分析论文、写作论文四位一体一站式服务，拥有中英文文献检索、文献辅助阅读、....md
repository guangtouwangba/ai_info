...
AMiner是一款智能科技情报挖掘系统，提供一站式科研服务，包括中英文文献检索、翻译、辅助阅读和论文写作支持。平台收录3.5亿论文、0.6亿学者等海量数据，支持互动问答、自动摘要生成和文档解析功能。用户可定制科研情报订阅，通过微信或邮件获取最新学术动态。此外，AMiner还提供学者画像、学术会议追踪等特色功能，基础服务免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T19:05:09Z
- **目录日期**: 2025-05-08
