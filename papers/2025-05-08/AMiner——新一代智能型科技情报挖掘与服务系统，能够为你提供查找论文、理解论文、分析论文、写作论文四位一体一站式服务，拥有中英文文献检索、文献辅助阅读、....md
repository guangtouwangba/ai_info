...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、AI辅助阅读、自动摘要生成、翻译及科研情报订阅。它覆盖42个学科的3.5亿论文、0.6亿学者等数据，支持用户通过提问快速理解文献内容，并能定制推送最新研究动态。平台还具备学者画像、学术会议追踪等功能，基础服务免费开放。网址：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T15:05:57Z
- **目录日期**: 2025-05-08
