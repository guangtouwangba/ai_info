...
开源文本生成图像(TTI)技术因个性化适配器的发展而普及，但也助长了非自愿深度伪造和性别歧视内容等滥用行为。本研究分析了最大开源TTI平台CivitAI的4000万用户生成图像和23万模型数据，发现NSFW内容激增及大量模仿真实人物的模型。研究指出网络亚文化深刻影响着模型个性化实践，并从女权主义和建构主义视角探讨了剥削性视觉内容的成因。基于分析，建议采取改进内容审核、优化工具设计、明确平台政策等干预措施，以减少潜在危害并增强责任意识。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T11:01:23Z
- **目录日期**: 2025-05-08
