...
开源文本生成图像(TTI)技术快速发展，使个性化模型成为可能，但也带来滥用风险。研究分析了最大开源TTI平台CivitAI的4000万用户生成图片和23万模型，发现NSFW内容激增，大量模型用于模仿真实人物，网络亚文化深刻影响模型个性化实践。从女权主义和建构主义视角，研究揭示了平台设计选择和社区动态如何塑造剥削性视觉内容。为此，研究者建议采取改进内容审核、重新设计工具、制定更清晰平台政策等措施，以增强责任意识和用户同意机制，减轻潜在危害。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T21:01:26Z
- **目录日期**: 2025-05-08
