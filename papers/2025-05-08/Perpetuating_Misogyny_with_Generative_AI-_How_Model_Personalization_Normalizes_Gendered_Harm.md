...
开源文本生成图像(TTI)技术快速发展，使个性化模型成为可能，但也带来滥用风险。本研究分析最大开源TTI平台CivitAI的4000万用户生成图片和23万模型数据，发现两大问题：一是NSFW内容激增，二是大量模仿真实人物的模型涌现。同时，网络亚文化深刻影响着模型定制和视觉内容。研究从女性主义和建构主义视角指出平台设计和社区动态对内容的影响，建议采取改进内容审核、优化工具设计、明确平台政策等措施，以增强责任意识和用户同意机制，减少潜在危害。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T07:01:36Z
- **目录日期**: 2025-05-08
