...
开源文本生成图像（TTI）技术快速发展，用户可通过适配器定制模型，但也催生了非自愿深度伪造和性别歧视等有害内容。本研究分析了主流开源TTI平台CivitAI，基于4000万用户图片和23万模型数据，发现平台存在大量不适宜工作场所（NSFW）内容和模仿真实人物的模型，且互联网亚文化显著影响模型定制实践。研究从女权主义和建构主义视角探讨剥削性视觉内容的成因，指出平台设计和社区动态的影响。最后建议通过改进内容审核、工具设计和平台政策来减少危害，促进责任与知情同意。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T12:02:00Z
- **目录日期**: 2025-05-08
