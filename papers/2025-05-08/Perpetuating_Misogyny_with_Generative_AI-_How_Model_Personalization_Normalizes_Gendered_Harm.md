...
这项研究分析了开源文本生成图像（TTI）平台CivitAI的社会技术影响。通过对4000万用户生成图片和23万模型的分析，研究发现平台上非安全内容（NSFW）激增，且大量模型用于模仿真实人物。互联网亚文化显著影响了模型个性化工具和实践。研究从女权主义和建构主义视角探讨了剥削性视觉内容的产生机制，指出平台设计选择和社区动态塑造了不良后果。为此，研究者建议采取改进内容审核、重新设计工具、制定更清晰平台政策等干预措施，以减少潜在危害并增强责任意识。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T18:01:32Z
- **目录日期**: 2025-05-08
