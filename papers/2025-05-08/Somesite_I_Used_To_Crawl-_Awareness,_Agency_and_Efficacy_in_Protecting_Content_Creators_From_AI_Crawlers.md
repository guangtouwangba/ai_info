...
这篇研究探讨了当前网络工具（如robots.txt、NoAI标签和反向代理）在保护内容创作者免受AI爬取方面的效果。通过对203名专业艺术家的调查和大规模测量，研究发现艺术家们强烈需要这类工具，但面临技术认知不足、部署能力有限以及工具对不响应爬虫效果不佳等障碍。反向代理提供的网络级拦截虽能更有效阻挡AI爬虫，但目前部署较少且存在局限性。研究表明，现有工具在应对AI数据抓取时存在显著不足，需更有效的解决方案来平衡创作者权益与AI发展需求。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T11:02:25Z
- **目录日期**: 2025-05-08
