...
生成式AI的成功依赖大量网络爬取的数据训练，但这一做法引发了版权、隐私和伦理争议。现有工具如robots.txt、NoAI元标签和反向代理可限制爬虫，但效果有限。研究调查了网络工具保护内容创作者的能力，特别针对艺术家群体。通过大规模测量和203名专业艺术家的调查发现，虽然对robots.txt等工具有强烈需求，但受限于技术认知、部署能力和对不响应爬虫的无效性。反向代理提供的网络级拦截虽更有效，但部署不足且存在局限性。整体上，现有工具难以全面保护创作者免受AI爬取。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T23:02:22Z
- **目录日期**: 2025-05-08
