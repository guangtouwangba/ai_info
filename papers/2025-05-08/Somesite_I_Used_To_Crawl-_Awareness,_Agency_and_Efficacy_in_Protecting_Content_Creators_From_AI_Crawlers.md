...
这篇研究探讨了当前网络工具（如robots.txt、NoAI标签和反向代理）在保护内容创作者免受AI爬取方面的效果。通过大规模测量和对203名专业艺术家的调查，研究发现虽然艺术家们强烈需要这类工具，但受限于技术认知不足、部署权限问题以及工具对不响应爬虫的有限效果。反向代理提供的网络级拦截虽能提供更强保护，但目前部署较少且存在自身局限。研究表明，现有工具在应对AI爬取时仍面临技术意识和有效性方面的重大障碍。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T04:03:27Z
- **目录日期**: 2025-05-08
