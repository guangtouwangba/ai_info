...
这篇研究探讨了当前网络工具（如robots.txt、NoAI元标签和反向代理）在保护内容创作者免受AI爬虫抓取方面的效果。通过大规模测量和对203名专业艺术家的调查，研究发现虽然艺术家们强烈需求这类工具，但受限于技术认知不足、部署能力有限，以及工具对不遵守规则的爬虫效果不佳。反向代理提供的网络级拦截虽更有效，但目前部署较少且存在局限性。研究表明，现有工具在应对AI爬虫时仍面临技术意识、执行力和有效性等多重挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T09:02:46Z
- **目录日期**: 2025-05-08
