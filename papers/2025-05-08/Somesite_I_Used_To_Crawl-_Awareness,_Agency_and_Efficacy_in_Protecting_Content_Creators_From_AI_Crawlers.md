...
这篇研究探讨了当前网络工具（如robots.txt、NoAI标签和反向代理）在保护内容创作者免受AI爬虫抓取方面的效果。通过大规模测量和对203名专业艺术家的调查，研究发现虽然艺术家强烈需求这类工具，但受限于技术认知不足、部署能力有限以及工具对不响应爬虫的防护效果不佳。反向代理提供的网络级爬虫拦截虽能提供更强保护，但目前部署较少且存在自身局限性。研究表明现有工具难以有效应对资源充足的AI爬虫，凸显了版权保护与AI发展之间的矛盾。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T03:20:16Z
- **目录日期**: 2025-05-08
