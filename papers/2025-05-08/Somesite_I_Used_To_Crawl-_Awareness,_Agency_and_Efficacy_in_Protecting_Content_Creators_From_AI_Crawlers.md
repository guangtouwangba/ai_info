...
生成式AI的成功依赖于从互联网抓取的大量训练数据，但这一做法引发了版权、隐私和伦理争议。现有工具如robots.txt、NoAI元标签和反向代理拦截虽能影响爬虫，但对资源充足的对手效果有限。本研究调查了网络工具保护创作者免受AI爬虫的能力，特别针对艺术家群体。通过大规模测量和203名专业艺术家的调研发现，尽管对robots.txt等工具有强烈需求，但受限于技术认知、部署能力和对无响应爬虫的有限效果。反向代理提供的网络级拦截虽防护更强，但普及度低且存在局限性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T21:02:24Z
- **目录日期**: 2025-05-08
