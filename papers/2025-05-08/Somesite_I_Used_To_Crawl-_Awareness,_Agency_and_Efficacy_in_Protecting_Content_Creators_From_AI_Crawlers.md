...
这篇研究探讨了当前网络工具（如robots.txt、NoAI元标签和反向代理）在保护内容创作者免受AI爬取方面的效果。通过大规模测量和对203名专业艺术家的调查，研究发现艺术家们强烈需求这类工具，但受限于技术认知不足、部署能力有限，且工具对不响应爬虫的效果不佳。研究还测试了反向代理提供的网络级爬虫拦截工具，发现虽然目前部署较少且能提供更强保护，但仍存在局限性。总体而言，现有工具在应对AI相关爬取时存在显著不足，需要更有效的解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T22:02:19Z
- **目录日期**: 2025-05-08
