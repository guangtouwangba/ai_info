...
生成式AI的成功依赖于从互联网爬取的大量数据训练，但这一做法引发了版权、隐私和伦理问题。现有工具如robots.txt、NoAI元标签和反向代理可阻止爬取，但效果有限。本研究探讨了网络工具保护内容创作者免受AI爬取的能力和效果。针对艺术家群体的调查（203名专业人士）显示，虽然对robots.txt等工具有强烈需求，但受限于技术认知、部署能力和对不响应爬虫的无效性。反向代理提供的网络级拦截工具效果更强，但部署较少且存在局限性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T10:02:28Z
- **目录日期**: 2025-05-08
