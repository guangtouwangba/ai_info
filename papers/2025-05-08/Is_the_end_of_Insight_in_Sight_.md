...
研究表明，在基于物理信息神经网络（PINN）求解玻尔兹曼方程的稀薄气体动力学问题中，神经网络的权重矩阵与物理问题的数学结构没有明显关联，反而接近高斯随机分布。虽然还需更多研究验证，但结果表明深度学习与玻尔兹曼方程的数值解法可能是获得相同物理知识的两种独立路径。这一发现暗示可解释AI（XAI）可能是不切实际甚至不适定的目标。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T23:00:59Z
- **目录日期**: 2025-05-08
