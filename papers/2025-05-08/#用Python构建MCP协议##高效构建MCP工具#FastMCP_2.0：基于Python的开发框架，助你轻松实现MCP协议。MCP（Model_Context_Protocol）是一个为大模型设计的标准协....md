...
FastMCP 2.0是一个基于Python的MCP（Model Context Protocol）开发框架，旨在简化大模型与外部数据/功能的交互协议实现。2.0版本新增客户端开发能力，支持远程访问和本地调试；增强服务代理功能，可构建复合服务或插件系统；提供OpenAPI/FastAPI自动转换接口，兼容现有项目。采用Python装饰器简化开发（如@mcp.tool()声明工具函数），降低协议底层复杂度，适合快速原型开发和正式部署。项目提供完整文档和示例，GitHub开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-08T20:03:42Z
- **目录日期**: 2025-05-08
