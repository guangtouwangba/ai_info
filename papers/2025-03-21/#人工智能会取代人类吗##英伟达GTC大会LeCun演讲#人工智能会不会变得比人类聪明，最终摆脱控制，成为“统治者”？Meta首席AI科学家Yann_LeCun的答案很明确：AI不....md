...
Meta首席AI科学家Yann LeCun在英伟达GTC大会上表示，AI不会取代人类，而是作为人类的“超级工具”或“超级助手”，最终的决策权仍掌握在人类手中。他强调，AI的“可靠性”是当前研究的重点，而非其智能水平。LeCun认为，AI的滥用（如生成错误信息或被恶意利用）才是真正需要关注的问题。与Sam Altman和马斯克等对超级智能风险的警告不同，LeCun认为超级智能的出现不会一蹴而就，且AI更像是一种工具，其使用方式由人类决定。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T06:05:13Z
- **目录日期**: 2025-03-21
