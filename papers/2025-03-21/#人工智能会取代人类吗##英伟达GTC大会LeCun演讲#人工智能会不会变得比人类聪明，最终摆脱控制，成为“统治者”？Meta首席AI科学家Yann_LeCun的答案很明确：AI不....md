...
Meta首席AI科学家Yann LeCun在英伟达GTC大会上表示，AI不会取代人类，而是作为人类的“超级工具”被管理。他认为未来的超级智能将成为“超级助手”，但决策权仍在人类手中。LeCun强调，AI的滥用（如生成错误信息或被恶意利用）是当前的主要担忧，而非AI变得过于聪明。与Sam Altman和马斯克等对超级智能风险的警告不同，LeCun认为超级智能的出现不会一蹴而就，AI更像是一种工具，其使用方式由人类决定。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T00:02:24Z
- **目录日期**: 2025-03-21
