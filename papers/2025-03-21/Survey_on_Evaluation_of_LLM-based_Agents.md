...
本文首次全面综述了基于大型语言模型（LLM）的智能体评估方法。研究从四个关键维度系统分析了评估基准和框架：（1）基础能力，如规划、工具使用、自我反思和记忆；（2）应用特定基准，涵盖网络、软件工程、科学和对话代理；（3）通用代理基准；（4）评估框架。分析揭示了向更现实、更具挑战性评估的转变趋势，并指出了未来研究需解决的关键问题，如成本效率、安全性和鲁棒性评估，以及开发细粒度、可扩展的评估方法。本文为智能体评估领域的快速发展和未来研究方向提供了重要参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T17:01:22Z
- **目录日期**: 2025-03-21
