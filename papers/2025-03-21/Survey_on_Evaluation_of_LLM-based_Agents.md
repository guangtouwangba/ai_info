...
本文首次全面调查了基于大型语言模型（LLM）的智能体评估方法，系统分析了四个关键维度的评估基准和框架：基础能力（规划、工具使用、自我反思、记忆）、应用特定基准（网络、软件工程、科学、对话）、通用智能体基准以及评估框架。研究发现，评估趋势正转向更现实、更具挑战性的持续更新基准。同时，指出了未来研究需解决的关键问题，如成本效率、安全性、鲁棒性评估，以及开发细粒度、可扩展的评估方法。本文为智能体评估领域提供了快速发展的路线图，并提出了未来研究方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T20:01:13Z
- **目录日期**: 2025-03-21
