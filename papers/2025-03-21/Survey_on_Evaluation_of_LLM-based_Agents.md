...
本文首次全面调查了基于LLM（大型语言模型）的智能体评估方法，分析了四个关键维度的评估基准和框架：基础能力（如规划、工具使用、自省和记忆）、特定应用（如网络、软件工程、科学和对话代理）、通用代理以及评估框架。研究发现，评估趋势正转向更现实和具挑战性的持续更新基准。同时，指出了未来研究需解决的关键问题，包括成本效率、安全性和鲁棒性评估，以及开发细粒度和可扩展的评估方法。本文为智能体评估的快速演变提供了方向和建议。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T10:01:22Z
- **目录日期**: 2025-03-21
