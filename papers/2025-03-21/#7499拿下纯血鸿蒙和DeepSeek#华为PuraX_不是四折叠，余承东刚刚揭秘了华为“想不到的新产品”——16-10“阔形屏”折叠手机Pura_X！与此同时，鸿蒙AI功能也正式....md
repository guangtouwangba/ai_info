...
华为发布了新款折叠手机Pura X，搭载了纯血鸿蒙系统和自研盘古大模型与DeepSeek双模型架构的AI功能，流畅度提升了40%。Pura X的发布标志着华为终端全面进入鸿蒙时代。该手机12+256GB版本售价7499元，12+512GB版本售价7999元，还有更为精致的典藏版。发布会前，相关话题已冲上热搜，现场反响热烈。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T06:04:21Z
- **目录日期**: 2025-03-21
