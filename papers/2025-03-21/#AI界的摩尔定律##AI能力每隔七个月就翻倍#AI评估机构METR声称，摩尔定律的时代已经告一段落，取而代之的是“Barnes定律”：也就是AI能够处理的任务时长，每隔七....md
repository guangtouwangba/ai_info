...
AI评估机构METR提出“Barnes定律”，认为AI处理任务的能力每隔七个月翻倍，取代了传统的摩尔定律。从2020年到2025年，AI模型如GPT系列在任务复杂度和处理时长上迅速提升，从几秒到几十分钟不等。图表展示了这一趋势，粉色圆点标记了不同GPT版本的能力进展。若“Barnes定律”成立，AI未来的发展速度将远超预期，处理更大规模和更复杂任务的能力将显著增强。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T02:27:30Z
- **目录日期**: 2025-03-21
