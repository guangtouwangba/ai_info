# #AI界的摩尔定律##AI能力每隔七个月就翻倍#AI评估机构METR声称，摩尔定律的时代已经告一段落，取而代之的是“Barnes定律”：也就是AI能够处理的任务时长，每隔七...
...
AI评估机构METR提出，摩尔定律的时代已结束，取而代之的是“Barnes定律”，即AI处理任务的能力每隔七个月翻倍。从GPT-3到o1等模型的发展显示，AI能处理的任务复杂度和时长迅速提升。横轴表示模型发布时间（2020-2025年），纵轴表示任务长度（从几秒到几十分钟）。粉色圆点标记了不同GPT版本的能力，显示AI任务复杂度不断增加。若“Barnes定律”成立，AI在未来处理任务的时间和规模将每七个月翻倍，发展速度可能远超预期。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T01:28:52Z
- **目录日期**: 2025-03-21
