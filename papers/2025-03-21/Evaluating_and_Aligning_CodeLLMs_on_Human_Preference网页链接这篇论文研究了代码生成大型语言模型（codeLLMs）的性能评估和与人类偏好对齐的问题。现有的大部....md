...
这篇论文探讨了代码生成大型语言模型（codeLLMs）在性能评估和与人类偏好对齐方面的问题。现有基准测试主要关注代码的正确性，而忽略了与人类偏好的匹配。为此，研究提出了CodeArena基准，模拟现实编程任务的复杂性，并选取了397个高质量样本，涵盖40个类别和44种编程语言。此外，研究构建了SynCode-Instruct语料库（近20B标记），验证了大规模合成指令微调的有效性。实验显示，开源和专有代码LLM之间存在显著性能差距，强调了与人类偏好对齐的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T01:31:57Z
- **目录日期**: 2025-03-21
