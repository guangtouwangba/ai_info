...
在最近的访谈中，Sam Altman反思了OpenAI的策略，指出中国团队DeepSeek的成功在于其开放策略，如免费提供最强模型和展示思维链，这促使OpenAI考虑更开放地分享技术。Altman透露，GPT-5将增加新功能，如思维链和联网搜索。他还分享了OpenAI从实验室到消费科技公司的转变，以及ChatGPT意外爆红后的快速成长。Altman强调，AI正成为普通人日常生活的一部分，而年轻用户对ChatGPT的接受度尤其高。OpenAI正努力抓住这一波AI普及的机遇。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T12:05:16Z
- **目录日期**: 2025-03-21
