...
在最近的一次访谈中，OpenAI的CEO Sam Altman反思了DeepSeek的成功带来的教训，认为OpenAI过于保守，错失了展示其技术优势的机会。他提到，DeepSeek通过免费提供最强模型和公开模型的推理过程迅速获得关注。Altman透露，未来的GPT-5将增加更多功能，如思维链和联网搜索。他还分享了OpenAI从实验室向消费科技公司转变的过程，以及ChatGPT意外爆红后的快速成长。Altman强调，AI正成为普通人日常生活的一部分，而年轻用户对ChatGPT的接受度尤其高。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T05:03:01Z
- **目录日期**: 2025-03-21
