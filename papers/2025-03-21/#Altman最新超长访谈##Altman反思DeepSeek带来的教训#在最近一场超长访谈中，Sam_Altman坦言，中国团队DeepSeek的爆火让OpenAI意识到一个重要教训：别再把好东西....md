...
在最近的一次访谈中，Sam Altman反思了OpenAI的策略，特别是对中国团队DeepSeek的成功。他指出，DeepSeek通过提供免费的最强模型和公开模型的推理过程迅速获得关注，这促使OpenAI重新考虑其保守策略。Altman透露，未来的GPT-5将包含更多开放功能，如思维链和联网搜索。他还分享了OpenAI从实验室到消费科技巨头的转变，以及ChatGPT意外爆红的故事。Altman强调，AI正成为普通人日常生活的一部分，而不仅仅是研究工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T22:03:38Z
- **目录日期**: 2025-03-21
