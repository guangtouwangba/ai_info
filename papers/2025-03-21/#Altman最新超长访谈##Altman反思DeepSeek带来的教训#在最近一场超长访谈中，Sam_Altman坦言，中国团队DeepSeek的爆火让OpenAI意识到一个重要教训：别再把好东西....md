...
在最近的访谈中，Sam Altman反思了OpenAI的策略，指出中国团队DeepSeek的成功让OpenAI意识到开放和透明的重要性。DeepSeek通过免费提供最强模型和展示思维链迅速获得关注，而OpenAI因过于保守错失机会。Altman透露，GPT-5将加入更多功能，如思维链和联网搜索。他还分享了OpenAI从实验室到消费科技公司的转变，强调AI正成为普通人日常生活的一部分。年轻人对ChatGPT的接受度高，而公司内部也在适应这一变化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T17:04:12Z
- **目录日期**: 2025-03-21
