...
在最近的访谈中，OpenAI的CEO Sam Altman反思了中国团队DeepSeek的成功给OpenAI带来的教训，即不应过于保守地隐藏先进技术。DeepSeek通过免费提供最强模型和公开模型的推理过程迅速获得关注。Altman承认OpenAI虽有类似能力，但过去因谨慎未公开，导致错失机会。他透露GPT-5将增加更多功能，如思维链和联网搜索。Altman还分享了他从技术宅到管理十亿用户平台的转变，以及ChatGPT意外爆红后的快速成长，强调AI正成为普通人日常生活的一部分。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T09:04:09Z
- **目录日期**: 2025-03-21
