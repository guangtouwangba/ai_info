...
在最近的访谈中，Sam Altman反思了OpenAI因DeepSeek的成功而学到的教训：不再隐藏优秀技术。DeepSeek通过免费提供最强模型和公开思维链迅速走红，而OpenAI因过于保守错失机会。Altman透露，GPT-5将加入更多功能，如思维链和联网搜索。他还分享了OpenAI从实验室到消费科技公司的转变，以及ChatGPT意外爆红后的快速成长。他强调，AI正成为普通人日常生活的一部分，年轻用户对ChatGPT的接受度远超老一辈。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T11:05:24Z
- **目录日期**: 2025-03-21
