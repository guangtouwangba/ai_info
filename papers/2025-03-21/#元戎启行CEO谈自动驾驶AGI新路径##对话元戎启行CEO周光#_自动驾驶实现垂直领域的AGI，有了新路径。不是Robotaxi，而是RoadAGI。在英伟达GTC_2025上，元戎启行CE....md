...
元戎启行CEO周光在英伟达GTC 2025上提出了RoadAGI概念，这是一种新的自动驾驶实现AGI（通用人工智能）的路径。不同于传统的Robotaxi，RoadAGI旨在通过一个平台赋能各种移动体，如智能车、机器人等，使其具备自主移动能力，而无需依赖高精地图。这一创新思路有望加速自动驾驶的大规模商用，特别是在垂直道路场景下。元戎启行通过AI Spark平台，展示了自动驾驶技术的新可能性，为AI和自动驾驶领域开辟了新的发展方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T22:02:43Z
- **目录日期**: 2025-03-21
