...
元戎启行CEO周光在英伟达GTC 2025上提出了RoadAGI概念，这是一种通过自动驾驶实现垂直领域通用人工智能（AGI）的新路径。RoadAGI不依赖高精地图，通过AI Spark平台赋能各种移动体，如智能车、机器人等，使其具备自主移动能力。这一创新路径旨在加速自动驾驶的大规模商用，特别是在特定道路场景下的应用。周光及其公司元戎启行代表了AI和自动驾驶领域的第二种可能性，展示了通过自动驾驶实现AGI的新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T23:02:45Z
- **目录日期**: 2025-03-21
