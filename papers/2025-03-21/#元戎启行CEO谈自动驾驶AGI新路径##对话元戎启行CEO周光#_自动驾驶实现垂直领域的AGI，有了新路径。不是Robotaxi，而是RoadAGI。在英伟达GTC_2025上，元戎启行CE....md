...
元戎启行CEO周光在英伟达GTC 2025上提出了一种新的自动驾驶AGI实现路径——RoadAGI。与传统的Robotaxi不同，RoadAGI旨在通过一个平台赋能智能车、机器人等移动体，实现垂直道路场景下的AGI。该平台名为AI Spark，不依赖高精地图，能够为各种移动设备提供自主移动能力。这一创新路径为自动驾驶的大规模商用提供了新的可能性，展示了元戎启行在自动驾驶领域的领先地位。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T12:03:44Z
- **目录日期**: 2025-03-21
