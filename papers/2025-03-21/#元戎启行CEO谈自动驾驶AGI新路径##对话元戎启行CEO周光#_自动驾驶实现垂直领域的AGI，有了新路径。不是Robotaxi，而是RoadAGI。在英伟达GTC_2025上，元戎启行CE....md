...
元戎启行CEO周光在英伟达GTC 2025上提出了一种新的自动驾驶技术路径——RoadAGI，旨在通过不依赖高精地图的方式，实现垂直道路场景下的通用人工智能（AGI）。这一技术通过元戎启行的AI Spark平台，赋能各种移动体，包括智能车、机器人等，使其具备自主移动能力。RoadAGI被视为一种能够加速自动驾驶大规模商用的新途径，展示了自动驾驶技术在实现AGI方面的第二种可能性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T16:03:42Z
- **目录日期**: 2025-03-21
