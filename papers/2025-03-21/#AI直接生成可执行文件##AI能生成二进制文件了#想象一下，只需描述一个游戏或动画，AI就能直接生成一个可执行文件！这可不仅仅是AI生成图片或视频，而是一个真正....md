...
ByteCraft是一项突破性技术，能够在仅4个GPU的条件下，通过微调7B参数的Qwen2.5模型，直接根据文本描述生成可执行的二进制文件。尽管目前生成的文件存在画面简单、动画异常、玩法单一等问题，且上下文长度限制为32KB，文件大小最高约140KB，但其潜力巨大。研究人员表示，未来在更多计算资源和更长上下文长度的支持下，ByteCraft有望实现100%生成可用文件，甚至自动编写复杂多样的游戏。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T00:02:33Z
- **目录日期**: 2025-03-21
