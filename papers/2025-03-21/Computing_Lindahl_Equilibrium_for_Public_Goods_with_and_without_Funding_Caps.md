...
Lindahl均衡是一种用于在多个可分公共物品之间分配固定预算的解决方案概念，具有稳定性和比例公平性。本文提出了一种新的凸规划方法，用于在无上限和上限设置下计算Lindahl均衡。在无上限情况下，Lindahl均衡等同于最大化Nash社会福利，并可通过比例响应动态计算。本文证明了比例响应动态等价于在新凸规划上运行镜像下降，从而提供了收敛保证的新证明。在上限设置下，本文证明了新凸规划仍有效，其最优解即为Lindahl均衡，解决了长期存在的算法效率问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T08:01:31Z
- **目录日期**: 2025-03-21
