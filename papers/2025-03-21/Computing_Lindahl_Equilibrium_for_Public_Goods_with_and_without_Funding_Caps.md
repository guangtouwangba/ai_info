...
林达尔均衡是一种用于在多个可分割公共物品之间分配固定预算的解决方案概念，始终位于核心，满足稳定性和比例公平性。本文提出了一种新的凸规划公式，用于计算无上限设置下的林达尔均衡，证明其与纳什社会福利最大化相关，并通过镜像下降法提供收敛保证。在有上限设置下，本文首次证明该凸规划公式仍适用，且最优解为林达尔均衡，从而解决了长期存在的算法效率问题。这一结果还表明，对于可分分段线性凹效用函数，近似核心稳定分配可以高效计算。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T10:01:34Z
- **目录日期**: 2025-03-21
