...
Lindahl均衡是一种用于在多个可分公共物品之间分配固定预算的解决方案，具有稳定性和比例公平性。研究考虑了代理人对公共物品具有可分离线性效用函数的模型，并引入了一种新的凸规划公式来计算该均衡，证明了其与Nash社会福利最大化的对偶关系。此外，比例响应动态等价于在新公式上运行镜像下降，提供了收敛保证的新证明。在有限预算上限的情况下，证明了该凸规划公式仍适用，且其最优解为Lindahl均衡，从而解决了长期存在的算法效率问题，并表明可高效计算近似核心稳定分配。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T20:01:23Z
- **目录日期**: 2025-03-21
