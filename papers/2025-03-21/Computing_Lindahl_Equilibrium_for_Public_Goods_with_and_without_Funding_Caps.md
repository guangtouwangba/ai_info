...
Lindahl均衡是一种用于在多个可分公共物品之间分配固定预算的解决方案，具有核心稳定性和比例公平性。本文研究了代理人对公共物品具有可分离线性效用函数的模型，并提出了新的凸规划公式来计算Lindahl均衡。在无上限设置中，该均衡等价于最大化Nash社会福利，并通过比例响应动态实现。本文还证明了比例响应动态等价于在新公式上运行镜像下降法，从而提供了新的收敛性证明。在有上限设置中，本文证明了新凸规划公式仍适用，并首次提供了高效计算Lindahl均衡的算法，适用于可分离分段线性凹效用函数。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T06:01:39Z
- **目录日期**: 2025-03-21
