...
林达尔均衡是一种用于在多个可分公共物品之间分配固定预算的解决方案概念，始终位于核心，满足稳定性和比例公平性。本文研究了代理人对公共物品具有可分离线性效用函数的模型，并引入了一种新的凸规划公式来计算该均衡，证明了其与纳什社会福利最大化的对偶关系。通过镜像下降法，提供了比例响应动态收敛的新证明。在有限预算约束下，证明了该凸规划仍有效，其最优解为林达尔均衡，解决了长期存在的算法效率问题，并表明可有效计算近似核心稳定分配。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T09:01:34Z
- **目录日期**: 2025-03-21
