...
Lindahl均衡是一种用于在多个可分公共物品之间分配固定预算的解决方案，具有稳定性和比例公平性。本文提出了一个新的凸规划公式，用于计算无上限设置下的Lindahl均衡，并证明其与Nash社会福利最大化相关。通过镜像下降法，我们提供了比例响应动态收敛的新证明。在有上限设置下，每个公共物品有资金上限，Lindahl均衡的存在性通过固定点论证已知，但高效算法一直未解决。我们证明新凸规划在有上限设置下仍有效，其最优解为Lindahl均衡，从而实现了高效计算。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T16:01:37Z
- **目录日期**: 2025-03-21
