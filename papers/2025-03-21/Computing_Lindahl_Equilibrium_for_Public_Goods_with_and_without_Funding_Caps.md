...
Lindahl均衡是一种用于在多个可分公共物品之间分配固定预算的解决方案，具有稳定性和比例公平性。本文研究了代理人对公共物品具有可分离线性效用函数的情况，提出了新的凸规划公式来计算Lindahl均衡，并证明其与Nash社会福利最大化相关。通过镜像下降法，证明了比例响应动态的收敛性。在有限预算上限的情况下，本文首次证明了Lindahl均衡的存在性，并提出了高效算法来计算该均衡，解决了长期存在的开放性问题。这一结果还表明，对于可分分段线性凹效用函数，近似核心稳定分配可以高效计算。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T04:16:45Z
- **目录日期**: 2025-03-21
