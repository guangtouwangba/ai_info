...
Lindahl均衡是一种用于在多个可分公共物品间分配固定预算的解决方案，具有核心稳定性和比例公平性。本文提出了一种新的凸规划方法，用于计算无上限设置下的Lindahl均衡，该方法与Nash社会福利最大化相关，并通过镜像下降法证明了比例响应动态的收敛性。在有上限设置下，每个公共物品有资金上限，Lindahl均衡的存在性通过固定点论证已知，但高效算法一直未解决。本文证明新凸规划方法在有上限设置下仍适用，其最优解即为Lindahl均衡，从而实现了高效计算，并适用于可分离分段线性凹效用函数的近似核心稳定分配。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T21:01:18Z
- **目录日期**: 2025-03-21
