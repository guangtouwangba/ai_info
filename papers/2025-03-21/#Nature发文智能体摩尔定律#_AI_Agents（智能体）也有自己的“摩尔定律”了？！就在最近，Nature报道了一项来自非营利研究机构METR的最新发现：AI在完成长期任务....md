...
Nature最近报道了非营利研究机构METR的一项发现，指出AI在完成长期任务方面的进步速度惊人，其能力大约每七个月翻一番。研究人员提出了“50%-任务完成时间跨度”这一指标来衡量AI自动完成任务的能力变化。根据预测，大约五年后，AI将能够自动完成许多人类现在需要一个月才能完成的任务。这一发现让人们对AI的快速进步有了更直观的感受。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T19:04:26Z
- **目录日期**: 2025-03-21
