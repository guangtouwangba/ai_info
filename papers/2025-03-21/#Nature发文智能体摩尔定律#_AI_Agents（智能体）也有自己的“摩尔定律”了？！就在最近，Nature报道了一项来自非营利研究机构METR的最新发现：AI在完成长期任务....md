...
《自然》杂志报道了非营利研究机构METR的最新发现，指出AI在完成长期任务方面的进步速度惊人，其能力大约每七个月翻一番。研究人员提出了“50%-任务完成时间跨度”指标来衡量AI的进步，发现AI完成任务的时间跨度在2019年为10分钟，七个月后变为20分钟。2024年，这一增长速度加快至每三个月翻一番。预计五年后，AI将能自动完成许多人类目前需要一个月才能完成的任务。这一发现让人们对AI的快速进步有了更直观的感受。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T22:04:05Z
- **目录日期**: 2025-03-21
