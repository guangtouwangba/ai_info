...
微软放弃了与CoreWeave签署的价值120亿美元的数据中心扩容订单，随后OpenAI接手了这笔交易。OpenAI是微软的主要投资者，因此这笔资金间接来自微软。CoreWeave是一家专注于AI基础设施的公司，正在筹备首次公开募股（IPO），目标融资27亿美元。OpenAI的Sam Altman支持CoreWeave的上市，并强调其算力对OpenAI未来模型的重要性。这一事件反映了AI行业内主要玩家之间的紧密合作和相互依赖，同时也突显了AI经济目前仍处于少数核心企业主导的封闭循环状态。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T14:05:03Z
- **目录日期**: 2025-03-21
