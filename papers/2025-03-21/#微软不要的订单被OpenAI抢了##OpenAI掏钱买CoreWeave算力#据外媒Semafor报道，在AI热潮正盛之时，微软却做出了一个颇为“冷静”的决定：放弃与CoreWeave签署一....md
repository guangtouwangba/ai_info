...
微软放弃了与CoreWeave签署的价值近120亿美元的数据中心扩容订单，OpenAI迅速接手了这一订单。尽管微软是OpenAI的主要投资者，这一交易仍显示出AI行业内部的紧密联系和相互依赖。CoreWeave，一家专注于AI基础设施的公司，正在筹备首次公开募股（IPO），目标是融资27亿美元。OpenAI的Sam Altman支持CoreWeave的上市，强调其算力对OpenAI未来模型的重要性。这一事件反映了AI行业核心玩家之间的深度绑定和行业内的封闭循环经济。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T13:10:18Z
- **目录日期**: 2025-03-21
