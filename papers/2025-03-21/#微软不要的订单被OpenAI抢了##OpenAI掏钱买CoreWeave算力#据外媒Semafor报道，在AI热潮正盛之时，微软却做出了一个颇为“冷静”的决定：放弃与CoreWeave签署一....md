...
在AI热潮中，微软决定放弃与CoreWeave签署的价值120亿美元的数据中心扩容订单。CoreWeave随即与OpenAI签约，尽管微软是OpenAI的主要投资者。这一事件反映了AI行业的封闭循环，主要玩家如英伟达、微软和OpenAI相互依赖。CoreWeave，一家专注于AI基础设施的公司，正筹备IPO，融资目标27亿美元，这是自2022年ChatGPT引发的AIGC浪潮以来，AI公司的首次大规模公开募股。OpenAI的Sam Altman支持CoreWeave的上市，强调其算力对OpenAI未来模型的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T18:04:19Z
- **目录日期**: 2025-03-21
