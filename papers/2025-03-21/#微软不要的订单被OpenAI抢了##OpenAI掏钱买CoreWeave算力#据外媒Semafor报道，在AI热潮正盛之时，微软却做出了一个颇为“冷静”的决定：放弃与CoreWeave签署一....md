...
在AI热潮中，微软决定放弃与CoreWeave签署的价值120亿美元的数据中心扩容订单。CoreWeave随即与OpenAI签约，而OpenAI的最大投资者正是微软。这一交易反映了AI行业的封闭循环，主要玩家如英伟达、微软和OpenAI相互依赖。CoreWeave，一家专注于AI基础设施的公司，正筹备IPO，目标融资27亿美元。OpenAI的Sam Altman支持CoreWeave，强调其算力对OpenAI未来模型的重要性。这一合作展示了行业内深度绑定，预示着AI竞赛的激烈未来。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T12:05:41Z
- **目录日期**: 2025-03-21
