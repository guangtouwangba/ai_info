...
微软放弃了与CoreWeave签署的价值120亿美元的数据中心扩容订单，而OpenAI迅速接手了这一订单。有趣的是，OpenAI的主要投资者正是微软。这一事件反映了AI行业的封闭循环，核心玩家如英伟达、微软和OpenAI之间相互交织。CoreWeave是一家专注于AI基础设施的公司，正在筹备首次公开募股（IPO），融资目标高达27亿美元。OpenAI的Sam Altman在CoreWeave的路演视频中表示，OpenAI的后续模型离不开CoreWeave的算力支持，显示了行业内玩家之间的深度绑定。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T16:05:57Z
- **目录日期**: 2025-03-21
