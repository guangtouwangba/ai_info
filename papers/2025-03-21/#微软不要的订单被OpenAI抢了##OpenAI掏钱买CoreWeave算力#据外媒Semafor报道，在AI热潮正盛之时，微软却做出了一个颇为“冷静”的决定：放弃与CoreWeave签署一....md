...
微软在AI热潮中决定放弃与CoreWeave签署的价值120亿美元的数据中心扩容订单，随后OpenAI接手了这笔订单。OpenAI是微软的主要投资者，因此这笔资金实际上仍来自微软。CoreWeave是一家专注于AI基础设施的公司，正准备进行首次公开募股（IPO），融资目标为27亿美元。OpenAI的Sam Altman在CoreWeave的路演视频中表示，OpenAI的后续模型开发依赖于CoreWeave的算力支持。这一事件反映了AI行业内主要玩家之间的深度绑定和相互依赖。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T21:04:05Z
- **目录日期**: 2025-03-21
