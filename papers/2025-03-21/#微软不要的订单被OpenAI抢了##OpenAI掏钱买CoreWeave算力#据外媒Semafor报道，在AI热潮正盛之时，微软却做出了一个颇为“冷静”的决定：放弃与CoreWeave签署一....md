...
微软决定放弃与CoreWeave签署的价值120亿美元的数据中心扩容订单，OpenAI随即接手。OpenAI是微软的主要投资者，因此这笔交易实际上仍由微软出资。CoreWeave是一家专注于AI基础设施的公司，背靠英伟达，并计划进行首次公开募股（IPO），融资目标高达27亿美元。OpenAI的Sam Altman在路演中表示，CoreWeave的算力对其后续模型的开发至关重要。这一交易反映了AI行业内部的紧密合作和相互依赖，也突显了AI经济目前仍处于少数核心玩家主导的封闭循环中。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T04:19:35Z
- **目录日期**: 2025-03-21
