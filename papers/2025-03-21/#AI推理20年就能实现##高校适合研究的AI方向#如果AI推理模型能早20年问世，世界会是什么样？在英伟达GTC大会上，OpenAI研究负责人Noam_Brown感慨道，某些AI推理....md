...
在英伟达GTC大会上，OpenAI研究负责人Noam Brown指出，某些AI推理方法其实20年前就能实现，只是当时未找到正确方法。他提到，AI需要像人类一样进行深度思考，而非仅依赖算力。Brown曾主导的Pluribus项目展示了AI通过“思考”策略在扑克比赛中战胜人类选手的能力。他还提到，学术界虽面临计算资源不足的挑战，但仍可通过优化模型架构和评测基准与大公司竞争。当前的AI评测体系存在问题，学术界有机会在此领域发挥重要作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T03:12:42Z
- **目录日期**: 2025-03-21
