...
在英伟达GTC大会上，OpenAI研究负责人Noam Brown表示，某些AI推理方法其实20年前就可能实现，只是当时未找到正确方法。他提到，AI需要像人类一样进行深度思考，而非仅依赖算力。Brown曾主导Pluribus项目，开发出能在扑克比赛中战胜人类顶尖选手的AI，该AI具备“思考”策略。他还参与研发“推理式推断”技术，使AI在回答前进行额外计算，提升推理能力。尽管学术研究面临计算资源不足的挑战，但Brown认为学界仍可通过优化模型架构和评测基准与大公司竞争。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T00:02:45Z
- **目录日期**: 2025-03-21
