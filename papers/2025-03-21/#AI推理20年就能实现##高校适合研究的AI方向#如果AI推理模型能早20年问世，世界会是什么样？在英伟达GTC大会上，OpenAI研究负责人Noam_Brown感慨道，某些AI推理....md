...
在英伟达GTC大会上，OpenAI研究负责人Noam Brown表示，某些AI推理方法其实20年前就能实现，只是当时方法不当。他提到，AI需要像人类一样进行复杂思考，而非单纯依赖算力。Brown曾主导的Pluribus项目展示了AI通过“思考”策略战胜人类扑克选手的能力。他还参与了“推理式推断”技术的研发，使AI具备更接近人类的推理能力。尽管学术界面临计算资源不足的挑战，但Brown认为，高校仍可通过优化模型架构和评测基准在AI研究中发挥重要作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-21T01:30:05Z
- **目录日期**: 2025-03-21
