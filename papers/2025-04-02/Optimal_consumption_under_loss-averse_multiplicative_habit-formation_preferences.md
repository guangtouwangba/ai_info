...
本文研究了具有损失厌恶特性的乘性习惯形成偏好模型及其无限时间范围内的最优投资消费策略。作者采用S型效用函数描述消费习惯比，通过构建凹包络和双值函数，分析相关非线性自由边界问题，完整解决了HJB方程。基于自由边界问题的解，获得了反馈形式的最优策略，并开发了新的验证方法以适应效用函数的广泛性。研究证明了原始问题与凹化问题的等价性，并通过数值算例讨论了最优策略的量化特性及其金融意义。全文在技术处理上具有创新性，为行为金融偏好建模提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T09:02:58Z
- **目录日期**: 2025-04-02
