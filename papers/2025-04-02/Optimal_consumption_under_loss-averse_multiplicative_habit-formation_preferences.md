...
这篇论文研究了具有损失厌恶特性的乘性习惯形成偏好及其在无限时间范围内的最优投资与消费策略。作者采用S型效用函数描述消费习惯比，通过构建S型效用的凹包络和对偶价值函数，深入分析了相关HJB方程及非线性自由边界问题。基于自由边界解的属性，提出了反馈形式的最优策略，并发展了新的验证方法以应对效用函数的广泛性。研究证明了原始问题与凹化问题的等价性，并通过数值算例讨论了最优策略的量化特性及其金融意义。全文在技术处理上具有创新性，为行为金融偏好建模提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T06:02:43Z
- **目录日期**: 2025-04-02
