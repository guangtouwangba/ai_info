...
本文研究了具有损失厌恶特性的乘性习惯形成偏好及其在无限时间范围内的最优投资与消费策略。作者采用S型效用函数描述消费习惯比，通过构建凹包络和双对偶价值函数，分析了HJB方程的非线性自由边界问题。基于自由边界解的解析性质，获得了反馈形式的最优策略，并提出了新的验证方法以处理广义效用函数。研究证明了原问题与凹化问题的等价性，并通过数值算例讨论了最优策略的量化特性及其金融意义。该工作为行为金融中的非标准偏好建模提供了新的理论框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T15:02:26Z
- **目录日期**: 2025-04-02
