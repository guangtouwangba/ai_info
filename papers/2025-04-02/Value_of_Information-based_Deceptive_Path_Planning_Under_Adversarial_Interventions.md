...
本文提出了一种基于马尔可夫决策过程(MDP)的对抗性干预下的欺骗路径规划(DPP)新模型。针对被动观察者无法应对主动对抗干预的问题，研究者设计了信息价值(VoI)目标函数，引导规划器选择信息价值低的轨迹来欺骗对手采取次优干预。通过结合MDP线性规划理论，开发了计算高效的策略合成方法。实验表明，该方法在网格世界问题中能有效实现对抗环境下的欺骗性，性能优于现有DPP方法和保守路径规划方法。该研究为主动对抗环境下的路径规划提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T02:29:10Z
- **目录日期**: 2025-04-02
