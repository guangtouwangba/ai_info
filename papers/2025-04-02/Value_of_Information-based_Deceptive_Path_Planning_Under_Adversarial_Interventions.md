...
本文提出了一种新的马尔可夫决策过程(MDP)模型，用于解决对抗性干预下的欺骗路径规划(DPP)问题。传统DPP方法无法应对具有主动干预能力的观察者，而本研究通过设计新的信息价值(VoI)目标，指导路径规划策略的生成。该方法使规划者能选择信息价值低的轨迹，诱使对手采取次优干预。基于MDP线性规划理论，研究者开发了计算高效的求解方法。实验表明，该方法在对抗性环境下能有效实现欺骗效果，且在网格世界测试中优于现有DPP方法和保守路径规划方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T01:29:41Z
- **目录日期**: 2025-04-02
