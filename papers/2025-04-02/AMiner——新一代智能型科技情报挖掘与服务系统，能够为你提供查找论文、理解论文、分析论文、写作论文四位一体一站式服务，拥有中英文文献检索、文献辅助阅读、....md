...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译及科研订阅等一站式服务。它收录了3.5亿论文、0.6亿学者等海量学术资源，支持中英文文献检索，并能通过AI生成摘要和回答用户提问。此外，AMiner还提供文献翻译、科研动态订阅（通过微信或邮件推送）、学者画像等功能，帮助用户高效获取和理解学术信息。平台可免费使用，适合科研人员和学生提升研究效率。访问链接：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T15:06:09Z
- **目录日期**: 2025-04-02
