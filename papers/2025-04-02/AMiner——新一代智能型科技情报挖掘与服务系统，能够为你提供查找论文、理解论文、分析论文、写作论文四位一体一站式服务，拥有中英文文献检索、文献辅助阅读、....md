...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译和科研订阅等一站式服务。它收录了3.5亿篇论文、0.6亿学者和1.5亿专利，支持中英文文献搜索，并能通过AI生成摘要和问答互动。用户可上传PDF或从平台获取论文，系统会提供摘要、章节概要和问题建议。此外，AMiner还能根据用户偏好推送最新科研动态，支持学者画像、学术会议等功能。平台免费使用，网址为https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T20:05:26Z
- **目录日期**: 2025-04-02
