...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、辅助阅读及科研动态订阅等服务。其核心功能包括：1）高效检索3.5亿论文资源，支持互动问答和自动摘要生成；2）AI驱动的文献翻译与解析，可上传PDF获取章节概要和智能问答；3）个性化科研情报推送，通过微信/邮件跟踪最新成果。平台还涵盖学者画像、学术会议等模块，支持免费基础使用，致力于提升科研效率。访问入口：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T21:05:10Z
- **目录日期**: 2025-04-02
