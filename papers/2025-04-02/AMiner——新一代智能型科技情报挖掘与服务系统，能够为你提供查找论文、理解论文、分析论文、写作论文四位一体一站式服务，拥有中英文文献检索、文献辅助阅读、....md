...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献搜索、AI辅助阅读、自动摘要生成和翻译功能，涵盖3.5亿论文、0.6亿学者等海量数据。用户可通过互动问答快速理解文献，还能订阅个性化科研动态。平台还包含学者画像、学术会议等特色功能，基础服务免费开放。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T04:08:02Z
- **目录日期**: 2025-04-02
