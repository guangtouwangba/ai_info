...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析及写作一站式服务。支持中英文文献搜索、AI辅助阅读、自动摘要生成及翻译功能，涵盖42个学科3.5亿论文资源。其特色包括：1）互动问答快速理解文献；2）支持PDF上传并生成章节概要；3）定制化科研动态订阅（通过微信/邮件推送）。平台还提供学者画像、学术会议追踪等免费功能。用户可通过网页或小程序访问，显著提升文献调研与论文撰写效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T23:05:25Z
- **目录日期**: 2025-04-02
