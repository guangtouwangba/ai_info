...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析与写作一站式服务。平台支持中英文文献检索，可自动生成摘要并支持互动问答；具备英文文献翻译、文档识别及辅助阅读功能；还提供科研情报订阅服务，按用户偏好推送最新学术动态。收录3.5亿论文、0.6亿学者等海量数据，覆盖42个学科，支持免费使用。核心功能包括学者画像、学术会议追踪及论文排行榜等，帮助用户高效获取和管理科研信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T16:05:53Z
- **目录日期**: 2025-04-02
