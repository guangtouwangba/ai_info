...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作一站式服务。它支持中英文文献搜索、AI辅助阅读、自动摘要生成、互动问答和文档翻译功能，覆盖3.5亿论文和1.5亿专利数据。用户可订阅个性化科研动态，跟踪学者及机构最新成果。平台还包含学者画像、学术会议等特色功能，基础服务免费开放。网址：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T11:05:56Z
- **目录日期**: 2025-04-02
