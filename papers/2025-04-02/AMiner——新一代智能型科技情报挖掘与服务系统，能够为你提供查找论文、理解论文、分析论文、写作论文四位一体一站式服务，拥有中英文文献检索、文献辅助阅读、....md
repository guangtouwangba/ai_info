...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作一站式服务。它支持中英文文献搜索，能自动生成摘要并回答用户提问，帮助快速理解论文内容。平台还具备文档翻译、辅助阅读和科研情报订阅功能，可根据用户兴趣推送最新学术动态。收录了3.5亿论文、0.6亿学者等海量数据，覆盖42个学科。用户可通过网页或微信小程序免费使用其核心功能，包括学者画像、学术会议和论文专题等资源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T03:18:03Z
- **目录日期**: 2025-04-02
