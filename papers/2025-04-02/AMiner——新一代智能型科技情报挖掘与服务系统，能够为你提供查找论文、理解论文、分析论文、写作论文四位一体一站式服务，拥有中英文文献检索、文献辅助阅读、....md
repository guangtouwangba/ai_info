...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、科研订阅等一站式服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持文献搜索、AI摘要生成、互动问答等功能，帮助用户快速理解论文内容。平台还提供个性化科研动态推送，用户可订阅关注的关键词、学者或机构，通过微信或邮件获取最新研究。此外，AMiner具备学者画像、学术会议推荐等特色功能，浏览器版可免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T01:33:14Z
- **目录日期**: 2025-04-02
