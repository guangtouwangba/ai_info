...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析和写作一站式服务。它支持中英文文献搜索，能自动生成摘要和问答互动，帮助用户快速理解内容。平台还具备文档识别、辅助阅读功能，用户可上传PDF或从文献库选取论文进行AI解析。此外，AMiner提供科研动态订阅服务，根据用户偏好推送最新学术资讯。其数据库涵盖42个学科的3.5亿论文、0.6亿学者及大量专利和项目，支持免费使用。网址：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T10:06:13Z
- **目录日期**: 2025-04-02
