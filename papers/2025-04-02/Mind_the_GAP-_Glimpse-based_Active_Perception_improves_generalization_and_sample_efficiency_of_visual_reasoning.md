...
人类在理解视觉关系方面远优于AI系统，尤其是在处理新物体时。受主动视觉理论启发，研究者开发了基于凝视的主动感知系统（GAP），通过依次聚焦图像的关键区域并处理高分辨率信息，结合眼动位置和视觉内容来表征图像各部分的关系。实验表明，GAP能提取超越直接视觉内容的关系，在多项视觉推理任务中达到最优性能，且样本效率更高，对分布外输入的泛化能力更强。该系统验证了动作信息对视觉关系学习的重要性，为缩小AI与人类视觉能力差距提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T12:02:05Z
- **目录日期**: 2025-04-02
