...
人类在理解视觉关系方面远超AI系统，尤其是在处理新物体时。受主动视觉理论启发，研究者开发了基于"Glimpse-based Active Perception (GAP)"的系统，通过模拟人眼注视机制，依次聚焦图像中最显著区域并高分辨率处理。该系统利用注视位置和周围视觉内容来表征图像各部分间的关系。实验表明，GAP能提取超越直接视觉内容的关系，在多项视觉推理任务中达到最先进性能，比现有模型更具样本效率，对分布外输入具有更好的泛化能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T19:01:44Z
- **目录日期**: 2025-04-02
