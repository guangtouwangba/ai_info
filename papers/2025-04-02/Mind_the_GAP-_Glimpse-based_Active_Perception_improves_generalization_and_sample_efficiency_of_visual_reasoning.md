...
人类在理解视觉关系方面远优于AI系统，尤其是在处理新物体时。受主动视觉理论启发，研究者开发了基于"Glimpse"的主动感知系统(GAP)，该系统通过依次注视图像中最显著区域并高分辨率处理，结合眼动位置和视觉内容来表征图像各部分关系。实验表明，GAP能提取超越直接视觉内容的关系，在多项视觉推理任务中达到最先进性能，比现有模型更高效且对分布外输入具有更好泛化能力。该系统模拟人类主动注视机制，显著提升了AI的视觉关系理解能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T10:02:03Z
- **目录日期**: 2025-04-02
