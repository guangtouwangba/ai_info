...
人类在理解视觉关系方面远超AI系统，尤其是在处理新物体时。受主动视觉理论启发，研究者开发了基于凝视的主动感知系统（GAP），通过模拟人眼注视机制，依次聚焦图像中最显著区域进行高分辨率处理。该系统利用注视位置及周围视觉内容来表示图像各部分间的关系。实验表明，GAP能提取超越直接视觉内容的关系，在多项视觉推理任务中达到最先进水平，且样本效率更高，对分布外数据具有更好的泛化能力。这验证了动作信息对视觉关系学习的关键作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T15:02:05Z
- **目录日期**: 2025-04-02
