...
谷歌联合创始人Sergey Brin指出，当前AI发展的核心应是可靠性而非拟人化智能。他认为用户更需要AI稳定完成80%基础任务（如订机票），而非不可预测地处理90%复杂操作。典型案例显示，全自动AI工具（如Devin、Cursor）常因黑箱操作导致数据丢失或效率低下，反增用户负担。Sergey强调优秀AI产品应具备透明性和防御机制，聚焦可控的小任务执行，而非追求"万能助手"。现阶段AI应作为可靠工具而非决策者，稳定性远胜于偶尔的惊艳表现。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T02:31:13Z
- **目录日期**: 2025-04-02
