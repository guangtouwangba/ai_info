...
这篇研究介绍了一个名为GNN 101的教育可视化工具，旨在帮助非AI专家理解图神经网络(GNNs)的复杂结构和工作原理。该工具通过动画可视化将数学公式与抽象层次（包括模型概览、层操作和详细计算）无缝结合，提供节点链接视图和矩阵视图两种互补视角。GNN 101由四位GNN专家合作开发，并在三门相关课程中应用。用户研究表明其可用性和有效性良好。该工具开源且无需安装，可直接在浏览器中使用，便于广泛教育推广。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T23:01:30Z
- **目录日期**: 2025-04-02
