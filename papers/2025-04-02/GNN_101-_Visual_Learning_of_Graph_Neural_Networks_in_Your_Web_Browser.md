...
该研究开发了名为GNN 101的可视化教育工具，旨在帮助非AI专家理解图神经网络(GNNs)。该工具通过动画可视化将数学公式与多级抽象(包括模型概览、层操作和详细计算)无缝结合，提供节点链接视图和矩阵视图两种互补视角。GNN 101是与4位GNN专家合作开发，并在3门相关课程中部署验证。用户研究表明其对教学助理和学生均具实用性和有效性。该工具开源且无需安装，可直接在浏览器中使用，便于广泛教育推广。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T10:01:42Z
- **目录日期**: 2025-04-02
