...
该研究开发了GNN 101，一款用于交互式学习图神经网络(GNN)的教育可视化工具。该工具通过动画可视化将数学公式与多级抽象视图(包括模型概览、层操作和详细计算)无缝集成，提供节点链接视图和矩阵视图两种互补视角。GNN 101是与4位GNN专家合作开发，并在3门GNN相关课程中部署。用户研究表明其可用性和有效性。该工具开源且无需安装，可直接在浏览器中使用，旨在帮助非AI专家理解GNN的复杂结构和内部工作原理。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T11:01:29Z
- **目录日期**: 2025-04-02
