...
该研究开发了GNN 101，一个用于交互式学习图神经网络(GNN)的教育可视化工具。它通过动画可视化将数学公式与抽象层次(如模型概览、层操作和详细计算)无缝结合，提供节点链接视图和矩阵视图两种互补视角。该工具由四位GNN专家合作设计，并在三个GNN相关课程中部署。用户研究表明其对助教和学生均具有可用性和有效性。GNN 101是开源的，无需安装即可在浏览器中使用，旨在帮助非AI专家理解GNN的复杂结构和内部工作原理。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T12:01:43Z
- **目录日期**: 2025-04-02
