...
英特尔新任CEO陈立武在Vision 2025大会上首次公开演讲，提出"重启英特尔"战略。他宣布四大核心方向：1）强化创新文化，聚焦PC/数据中心芯片，推进18A工艺与Panther Lake处理器；2）巩固核心业务，优化Xeon性能与成本；3）精简非核心业务，推出Jaguar Shores对抗英伟达；4）重建客户信任，强调"少承诺多交付"。作为技术背景的实干派，陈立武曾成功带领Cadence转型，此次明确将复制"技术+收购"策略，同时突出英特尔"设计+制造"一体化的供应链优势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T05:06:11Z
- **目录日期**: 2025-04-02
