...
英特尔新任CEO陈立武在Vision 2025大会上宣布四大核心战略：1）强化创新文化，聚焦PC/数据中心芯片，推进18A工艺量产；2）巩固核心业务，优化Xeon芯片效能；3）精简非核心业务，转向AI驱动的新平台战略；4）重建客户信任，采用"少承诺多交付"的务实作风。他强调英特尔作为美国唯一具备全产业链能力的芯片商，需承担技术主权责任。曾带领Cadence转型成功的陈立武表示将复制"技术+收购"策略改造英特尔，并以长期承诺表明改革决心。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T07:04:35Z
- **目录日期**: 2025-04-02
