...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟1万多个代理及其500万次互动。它通过真实社会环境和大规模模拟引擎，研究社会极化、信息传播、基本收入政策及外部冲击（如飓风）等关键问题。模拟结果与现实世界实验吻合，验证了其捕捉人类行为和社会机制的能力。该工具为社会科学研究和政策制定提供了新方法，能辅助传统研究手段（如调查和干预），帮助深入理解社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T12:05:54Z
- **目录日期**: 2025-04-02
