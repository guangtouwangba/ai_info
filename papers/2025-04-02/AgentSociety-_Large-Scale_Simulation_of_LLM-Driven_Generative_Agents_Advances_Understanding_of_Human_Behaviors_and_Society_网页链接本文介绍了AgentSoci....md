...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能够模拟超过1万个AI代理的社会互动（500万次交互）。该系统通过研究社会极化、信息传播、基本收入政策和自然灾害影响四个关键场景，验证了其模拟结果与现实世界数据的高度一致性。研究表明，这种LLM驱动的模拟器能有效捕捉人类行为机制，为社会科学研究和政策制定提供了新工具，可辅助传统研究方法（如调查和干预实验）来探索社会问题的成因和模式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T04:07:19Z
- **目录日期**: 2025-04-02
