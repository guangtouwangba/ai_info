...
这篇论文介绍了一个名为AgentSociety的大规模社会模拟器，它结合了大型语言模型驱动的代理、真实社会环境和大规模模拟引擎。研究者利用该平台模拟了1万多个代理的社会生活及500万次互动，并针对极化现象、信息传播、基本收入政策和外部冲击等四个社会问题进行了研究。模拟结果与现实世界实验数据吻合，验证了该工具在捕捉人类行为机制方面的能力，展示了其作为社会科学研究和政策制定辅助工具的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T03:17:31Z
- **目录日期**: 2025-04-02
