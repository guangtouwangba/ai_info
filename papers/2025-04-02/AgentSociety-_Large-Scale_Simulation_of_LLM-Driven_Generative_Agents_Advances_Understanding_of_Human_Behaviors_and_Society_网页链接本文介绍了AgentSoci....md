...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟1万多个代理及其500万次互动。研究者用它分析四大社会问题：社会极化、信息传播、基本收入政策及自然灾害影响。模拟结果与现实数据吻合，验证了该工具在揭示人类行为机制和社会动态方面的有效性。该系统可作为计算社会科学和政策研究的创新平台，辅助传统研究方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T07:05:38Z
- **目录日期**: 2025-04-02
