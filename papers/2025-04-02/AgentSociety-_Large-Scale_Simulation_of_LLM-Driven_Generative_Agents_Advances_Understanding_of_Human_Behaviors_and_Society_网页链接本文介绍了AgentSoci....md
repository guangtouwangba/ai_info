...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟超过1万个AI代理及其500万次社会互动。该系统通过研究社会极化、信息传播、基本收入政策和自然灾害影响四个案例，验证了其模拟结果与现实世界数据的高度一致性。研究表明，AgentSociety能有效捕捉人类行为机制，为社会科学研究和政策制定提供了新的计算实验平台，弥补了传统调查和干预方法的局限性。这一突破性工具展现了AI在理解复杂社会现象方面的巨大潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T15:05:38Z
- **目录日期**: 2025-04-02
