...
AgentSociety是一个基于大语言模型的智能体社会模拟器，可模拟超过1万个代理及其500万次互动。研究者用它研究了四大社会问题：社会极化、信息传播、基本收入政策及自然灾害影响。结果显示其模拟结果与现实世界数据高度吻合，证明该系统能有效捕捉人类行为机制。该平台为社会科学研究和政策制定提供了创新工具，可辅助传统研究方法（如调查、访谈），帮助深入分析社会问题的成因和模式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T02:32:17Z
- **目录日期**: 2025-04-02
