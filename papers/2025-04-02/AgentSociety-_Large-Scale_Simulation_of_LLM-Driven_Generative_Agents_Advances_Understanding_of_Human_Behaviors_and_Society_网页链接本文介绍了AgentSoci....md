...
AgentSociety是一个基于大型语言模型的大规模社会模拟器，能够模拟超过1万个代理的社会生活及其500万次互动。该平台用于研究极化现象、刺激性信息传播、无条件基本收入政策及外部冲击（如飓风）等社会问题。其模拟结果与现实世界实验一致，验证了其在捕捉人类行为和社会机制方面的能力。AgentSociety可作为社会科学研究和政策制定的有力工具，补充传统研究方法（如调查和访谈），帮助深入理解社会问题的模式、原因和潜在机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T16:05:23Z
- **目录日期**: 2025-04-02
