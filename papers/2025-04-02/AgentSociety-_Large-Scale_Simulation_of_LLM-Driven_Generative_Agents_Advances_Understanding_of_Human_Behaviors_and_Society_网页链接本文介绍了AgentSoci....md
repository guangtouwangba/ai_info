...
AgentSociety是一个基于大语言模型的大规模社会模拟器，能模拟1万多个代理的社会互动（500万次）。它通过研究社会极化、信息传播、基本收入政策及外部冲击（如飓风）等问题，验证了其模拟结果与现实世界数据的一致性。该系统可作为计算社会科学实验平台，辅助传统研究方法（如调查、访谈），帮助分析社会问题的模式和机制。研究表明，AgentSociety能有效捕捉人类行为规律，为社会科学研究和政策制定提供新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T09:07:02Z
- **目录日期**: 2025-04-02
