...
WeirdFlows是一种新型反金融犯罪检测系统，采用自上而下的网络分析方法，无需预先定义欺诈模式或训练数据集。该系统能识别随时间变化的复杂交易模式，并提供可解释的异常检测结果，辅助分析师工作。在意大利联合圣保罗银行8000万笔跨国交易的实际测试中，WeirdFlows成功检测出可疑交易和违规主体，特别是在2022年2月后欧盟经济制裁背景下表现突出。该系统具有处理海量数据、发现复杂模式以及保持结果可解释性的优势，为正式金融犯罪调查提供了有效工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T19:00:59Z
- **目录日期**: 2025-04-02
