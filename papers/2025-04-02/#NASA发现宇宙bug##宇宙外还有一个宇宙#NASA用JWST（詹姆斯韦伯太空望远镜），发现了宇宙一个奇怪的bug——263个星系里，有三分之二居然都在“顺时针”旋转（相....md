...
NASA通过詹姆斯韦伯望远镜发现263个星系中约三分之二呈现顺时针旋转，这与宇宙"各向同性"理论相矛盾。科学家提出两种解释：1) "黑洞宇宙论"认为宇宙可能起源于旋转黑洞，继承了初始旋转方向；2) 观测偏差，银河系自身旋转导致反方向星系更易被观测。前者将颠覆宇宙认知，暗示宇宙嵌套结构；后者则质疑现有宇宙测量数据的准确性。该发现发表于《皇家天文学会月刊》，无论哪种解释都将对天文学产生重大影响。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T01:30:56Z
- **目录日期**: 2025-04-02
