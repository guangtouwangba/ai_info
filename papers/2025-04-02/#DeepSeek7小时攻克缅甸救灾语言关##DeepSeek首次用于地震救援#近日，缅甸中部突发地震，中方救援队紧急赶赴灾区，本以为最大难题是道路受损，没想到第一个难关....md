...
DeepSeek模型在7小时内快速开发出中缅英三语互译平台，用于缅甸地震救援。该系统由应急语言服务团和北京语言大学紧急搭建，提供简洁实用的短语翻译，覆盖指挥撤离、医疗沟通等关键场景，并包含50句高频应急用语。操作简单，无需培训，已帮助700多名当地用户与中方救援队高效沟通。AI技术首次在地震救援中发挥关键作用，成为跨越语言障碍的"救命桥梁"。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T09:04:18Z
- **目录日期**: 2025-04-02
