...
DeepSeek AI模型在7小时内开发出中缅英三语互译平台，首次用于缅甸地震救援。该平台由应急语言服务团和北京语言大学紧急搭建，提供分类清晰的应急短语，包括50句高频用语，覆盖撤离、医疗等关键场景，操作简单无需培训。已有700多名缅甸用户使用，显著提升救援沟通效率。AI在此次救援中成为跨越语言障碍的"救命桥梁"。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T12:04:09Z
- **目录日期**: 2025-04-02
