...
DeepSeek模型在7小时内开发出中缅英三语互译平台，助力缅甸地震救援。该系统由应急语言服务团和北京语言大学紧急开发，提供简洁实用的短语翻译，覆盖医疗、撤离等关键场景。平台包含50句高频应急用语，操作简单，无需培训，大幅提升救援沟通效率。已有700多名缅甸用户使用，成为救援中的重要语言桥梁。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T22:03:37Z
- **目录日期**: 2025-04-02
