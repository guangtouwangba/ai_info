...
近日缅甸发生地震，中方救援队面临语言障碍。国家应急语言服务团与北京语言大学紧急开发基于DeepSeek模型的中缅英三语互译平台，仅用7小时上线。该系统包含预置应急短语和50句高频用语，操作简单，无需培训即可使用，极大提升救援沟通效率。已有700多名缅甸用户使用该平台，AI技术成为救灾中的关键桥梁。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T18:03:49Z
- **目录日期**: 2025-04-02
