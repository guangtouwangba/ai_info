...
DeepSeek模型在7小时内快速开发出中缅英三语互译平台，首次用于缅甸地震救援。该平台由应急语言服务团和北京语言大学紧急搭建，包含预置高频应急用语，操作简单，无需培训即可使用。系统覆盖撤离指挥、伤员搜寻、医疗沟通等关键场景，显著提升救援队与当地民众的沟通效率。已有700多名缅甸用户使用该平台，AI技术成为救灾中的"语言桥梁"。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T07:03:02Z
- **目录日期**: 2025-04-02
