...
本文提出TNTRules算法，用于解决信息物理系统中贝叶斯优化（BO）的可解释性问题。该算法通过方差剪枝和层次聚类技术生成全局和局部解释，提供可操作规则和可视化图表，识别最优解范围和替代方案。与现有可解释AI方法不同，TNTRules专为BO设计，采用多目标优化提高解释质量。实验表明，在5个多目标测试函数和2个超参数调优问题上，TNTRules在正确性、完整性和紧凑性方面显著优于三种基线方法，能生成高保真、简洁且完整的解释，增强人类与BO的协作调优能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T13:09:29Z
- **目录日期**: 2025-04-02
