...
本文提出TNTRules算法，用于解决信息物理系统中贝叶斯优化(BO)的可解释性问题。该算法通过方差剪枝和层次聚类处理不确定性，生成全局和局部解释，提供最优解范围及替代方案的可视化规则。相比现有可解释AI方法，TNTRules专为BO设计，采用多目标优化最大化解释质量。在5个测试函数和2个超参数调优问题上评估显示，其正确性、完整性和简洁性显著优于三种基线方法。研究成果实现了BO推荐的可操作解释，促进人机协同的系统调优。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T14:02:27Z
- **目录日期**: 2025-04-02
