...
本文提出TNTRules算法，用于解决信息物理系统中贝叶斯优化(BO)的可解释性问题。该算法通过方差剪枝技术和层次聚类编码不确定性，生成全局和局部解释，提供可操作规则和可视化图表，识别最优解边界及替代方案。相比现有可解释AI方法，TNTRules专为BO设计，采用多目标优化最大化解释质量。实验使用正确性、完整性和紧凑性指标评估，在5个多目标测试函数和2个超参数调优问题上，TNTRules显著优于三种基线方法，能生成高保真、紧凑且完整的解释。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T11:02:22Z
- **目录日期**: 2025-04-02
