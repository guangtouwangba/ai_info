...
该论文介绍了OmniEval——一个面向金融领域的全方位自动RAG（检索增强生成）评估基准。重点针对非小细胞肺癌(NSCLC)治疗中ALK基因双靶点抑制剂的最新研究进展进行了综述。作为NSCLC常见致癌驱动基因，ALK已成为重要治疗靶点。尽管已有7种ALK抑制剂获批，但耐药性问题仍然存在。研究表明，相比联合用药，能同时作用于两个靶点的单一分子抑制剂可减少副作用，在克服耐药性方面更具优势。文章系统分析了这类双靶点抑制剂的设计策略、结构-活性关系，为开发新型ALK靶向药提供了重要见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T19:04:29Z
- **目录日期**: 2025-04-02
