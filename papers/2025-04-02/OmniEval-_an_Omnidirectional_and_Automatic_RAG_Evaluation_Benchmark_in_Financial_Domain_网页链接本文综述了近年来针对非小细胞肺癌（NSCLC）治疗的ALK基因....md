...
这篇论文介绍了OmniEval，一个面向金融领域的全自动RAG（检索增强生成）评估基准。该基准旨在提供全方位的评估能力，以测试和优化金融领域的信息检索和生成系统。同时，论文还综述了针对非小细胞肺癌（NSCLC）ALK基因的双靶点抑制剂研究进展，探讨了如何通过设计新型抑制剂来克服现有疗法的耐药性问题。双靶点抑制剂通过同时作用于两个靶点，有望减少副作用并提高疗效，为NSCLC治疗提供了新的策略。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T04:06:46Z
- **目录日期**: 2025-04-02
