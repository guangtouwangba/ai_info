...
这篇论文介绍了OmniEval，一个面向金融领域的全方位自动RAG（检索增强生成）评估基准。同时，文章还综述了针对非小细胞肺癌(NSCLC)中ALK基因的双靶点抑制剂研究进展。ALK基因是NSCLC的重要致癌驱动因素，尽管已有7种ALK抑制剂获批，但耐药性问题仍然存在。相比联合用药，双靶点抑制剂能同时作用于两个靶点，减少副作用和毒性，在克服耐药性方面具有优势。文章总结了ALK双靶点抑制剂的最新进展，分析了其结构-活性关系，为开发新型抑制剂和克服耐药性提供了见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T21:04:29Z
- **目录日期**: 2025-04-02
