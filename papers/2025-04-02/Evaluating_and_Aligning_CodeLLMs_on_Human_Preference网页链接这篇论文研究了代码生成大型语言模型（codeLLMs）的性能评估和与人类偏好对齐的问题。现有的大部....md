...
这篇论文提出了CodeArena基准测试和SynCode-Instruct语料库，以评估代码生成大模型（codeLLMs）与人类偏好的对齐程度。CodeArena包含397个高质量样本，覆盖40类编程任务和44种语言，模拟真实编程场景。研究还构建了20B标记的合成指令数据集用于微调验证。实验发现，传统执行基准与人类偏好评估存在差距，且开源模型（如Qwen2.5-Coder）与商业模型（如OpenAI o1）性能差异显著，凸显了人类偏好对齐在代码生成中的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T17:05:45Z
- **目录日期**: 2025-04-02
