...
这篇论文针对代码生成大模型(codeLLMs)提出了CodeArena基准测试，弥补了现有评估忽视人类偏好的缺陷。该基准包含397个高质量样本，覆盖40类编程任务和44种语言。研究还构建了20B标记的合成指令数据集SynCode-Instruct，验证了大模型微调效果。实验发现，传统执行基准与CodeArena存在性能差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)差距显著，凸显了模型与人类偏好对齐的重要性。研究为代码生成模型的评估提供了更全面的视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T02:32:58Z
- **目录日期**: 2025-04-02
