...
这篇论文针对代码生成大模型（CodeLLMs）与人类偏好对齐的问题，提出了CodeArena基准测试和SynCode-Instruct语料库。CodeArena包含397个高质量样本，覆盖40类编程任务和44种语言，模拟真实场景；SynCode-Instruct则包含近200亿标记的合成指令数据。研究发现现有基准（如执行正确率）与人类偏好存在差异，且开源模型（如Qwen2.5-Coder）与专有模型（如OpenAI o1）性能差距显著。研究强调了代码生成模型在功能正确性之外，还需优化与开发者实际需求的匹配度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T23:05:35Z
- **目录日期**: 2025-04-02
