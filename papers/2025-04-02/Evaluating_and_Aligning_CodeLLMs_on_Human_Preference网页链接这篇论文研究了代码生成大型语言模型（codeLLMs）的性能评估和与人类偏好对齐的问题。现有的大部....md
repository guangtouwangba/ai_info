...
这篇论文研究了代码生成大模型(codeLLMs)如何更好地匹配人类偏好。研究者创建了CodeArena基准测试，包含397个高质量编程任务样本，覆盖40个类别和44种语言，更贴近实际开发需求。同时开发了SynCode-Instruct合成指令数据集(近200亿标记)来验证大规模指令微调效果。实验发现，传统执行基准与人类偏好评估存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距明显，凸显了对齐人类偏好的重要性。研究为提升代码生成模型的实际应用价值提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T18:05:46Z
- **目录日期**: 2025-04-02
