...
这篇论文探讨了如何结合仿真和真实世界数据来提升机器人视觉操控任务的性能。研究发现，仅靠真实数据训练成本高昂且耗时，而纯仿真训练又存在现实差距。通过系统实验，作者提出了一种简单有效的"仿真-现实协同训练"方法，在机械臂和人形机器人两种平台上验证了该策略的有效性。结果表明，即使仿真与真实数据存在显著差异，协同训练仍能平均提升38%的任务表现。这项工作为利用仿真数据增强真实机器人学习提供了实用方案，相关视频和结果可在项目网站查看。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-02T00:01:44Z
- **目录日期**: 2025-04-02
