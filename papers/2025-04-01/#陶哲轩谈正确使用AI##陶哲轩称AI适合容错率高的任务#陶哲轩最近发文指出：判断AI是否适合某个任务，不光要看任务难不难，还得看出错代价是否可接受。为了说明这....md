...
陶哲轩提出评估AI适用性的二维框架：任务复杂度与容错率。简单且容错率高的任务（如家常菜谱推荐）适合AI；复杂且容错率低的任务（如外交国宴）需谨慎。他建议采用"AI初稿+人工修正"的混合模式，例如教育领域由AI生成学习计划初稿，再由教师调整。这种模式既能利用AI效率，又能通过人工把关控制风险，实现优势互补。核心观点是AI应作为辅助工具而非完全替代，关键决策仍需人类介入。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T00:04:02Z
- **目录日期**: 2025-04-01
