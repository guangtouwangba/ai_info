...
该研究调查了多模态大语言模型(MLLMs)作为视障人士辅助技术的效果。用户调查发现，尽管采用率高，但仍存在情境理解、文化敏感性和复杂场景理解等问题。研究提出了5项以用户为中心的图像/视频任务，包括创新的光学盲文识别。对12个MLLMs的系统评估显示，这些模型在文化背景、多语言支持、盲文阅读、辅助物体识别和幻觉等方面仍需改进。研究为多模态AI在无障碍领域的发展方向提供了重要见解，强调需要更具包容性、鲁棒性和可信赖的视觉辅助技术。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T01:29:31Z
- **目录日期**: 2025-04-01
