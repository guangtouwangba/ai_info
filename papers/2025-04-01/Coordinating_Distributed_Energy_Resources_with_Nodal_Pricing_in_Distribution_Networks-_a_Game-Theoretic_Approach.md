...
本文提出了一种用于配电网实时节点定价的机制，旨在实现分布式能源自主运行下的成本最小化和电压控制，并通过随机博弈理论分析市场行为。与现有方法不同，该定价方案无需基于设备的集中协调或产消者间通信。通过建立随机博弈成为马尔可夫势博弈的新充分条件，证明计算均衡解等价于求解单智能体马尔可夫决策过程。这些条件具有普适性，可应用于其他领域。基于IEEE测试系统的实证研究表明，该定价策略具有显著有效性。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T06:01:30Z
- **目录日期**: 2025-04-01
