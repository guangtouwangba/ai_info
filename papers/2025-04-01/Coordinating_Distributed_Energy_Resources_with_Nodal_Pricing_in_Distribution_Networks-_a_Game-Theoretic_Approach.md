...
本文提出了一种用于配电网中分布式能源实时节点定价机制，旨在实现成本最小化和电压控制，并利用随机博弈理论分析市场行为。与传统方法不同，该机制无需设备感知的集中协调或产消者间通信。通过建立随机博弈成为马尔可夫势博弈的新充分条件，证明计算均衡解等价于求解单智能体马尔可夫决策过程。这些条件具有普适性，可应用于其他领域。基于IEEE测试系统的实证研究表明，该定价策略具有显著有效性。研究为分布式能源管理提供了去中心化解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T05:01:33Z
- **目录日期**: 2025-04-01
