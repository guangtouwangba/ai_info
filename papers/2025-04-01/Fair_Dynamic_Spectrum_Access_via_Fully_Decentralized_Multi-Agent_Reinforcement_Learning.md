...
该研究提出了一种基于强化学习的去中心化无线网络公平共享方案(FSRL)，使多个源节点在无需协调的情况下自适应选择频段。FSRL结合了状态增强、风险控制架构和公平导向的奖励机制，在50多种网络场景中测试表明：与基线算法相比，在严苛条件下(多源节点单频段)公平性提升达89%(Jain指数)，平均提升48.1%。该方法仅需观测自身传输结果，无需了解网络规模或其他节点策略，即可实现高公平性的吞吐量优化，并能抵抗干扰和适应ad-hoc环境。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T07:02:12Z
- **目录日期**: 2025-04-01
