...
本文提出了一种基于强化学习(RL)的去中心化无线网络公平共享方案FSRL。在多个源-目的节点对共享有限正交频带的场景下，FSRL使各节点能自主调整频带选择策略，仅通过观察自身传输结果(成功/冲突)进行学习，无需节点间协调或网络先验信息。FSRL结合了状态增强、风险控制架构和公平性驱动的奖励机制，在50多种网络设置下的仿真表明：相比基线RL算法，FSRL在严苛条件下(多源节点单频带)公平性提升达89%(Jain指数)，平均提升48.1%，实现了网络范围内的公平性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T20:02:02Z
- **目录日期**: 2025-04-01
