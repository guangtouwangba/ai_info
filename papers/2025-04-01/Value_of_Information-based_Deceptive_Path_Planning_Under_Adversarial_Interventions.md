...
本文提出了一种新的马尔可夫决策过程（MDP）模型，用于解决对抗性干预下的欺骗性路径规划（DPP）问题。通过设计新的信息价值（VoI）目标，该方法引导智能体选择信息价值低的轨迹，诱使对抗性观察者采取次优干预。基于MDP线性规划理论，研究开发了高效的计算方法合成对抗干预下的DPP策略。实验表明，该方法在网格世界问题中优于现有DPP方法和保守路径规划方法，能有效实现对抗干预下的欺骗性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T03:20:10Z
- **目录日期**: 2025-04-01
