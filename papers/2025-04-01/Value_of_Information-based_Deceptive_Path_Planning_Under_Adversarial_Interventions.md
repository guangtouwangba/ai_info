...
本文提出了一种新的马尔可夫决策过程(MDP)模型，用于解决对抗性干预下的欺骗路径规划(DPP)问题。传统DPP方法无法应对具有对抗干预能力的观察者，而新方法通过设计信息价值(VoI)目标，使路径规划者能选择低信息价值的轨迹，诱导观察者采取次优干预。基于MDP线性规划理论，研究者开发了计算高效的策略合成方法。实验表明，该方法在网格世界问题中能有效实现对抗干预下的欺骗性，性能优于现有DPP方法和保守路径规划方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T10:02:14Z
- **目录日期**: 2025-04-01
