...
本文提出了一种新的基于马尔可夫决策过程(MDP)的欺骗性路径规划(DPP)模型，用于解决对抗性干预环境下的路径规划问题。研究者设计了新的信息价值(VoI)目标来指导DPP策略，使规划者能通过选择低信息价值的轨迹欺骗对手采取次优干预措施。利用MDP线性规划理论，开发了计算高效的求解方法。实验表明，该方法在对抗性干预下能有效实现欺骗性，且在网格世界问题上表现优于现有DPP方法和保守路径规划方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T22:02:07Z
- **目录日期**: 2025-04-01
