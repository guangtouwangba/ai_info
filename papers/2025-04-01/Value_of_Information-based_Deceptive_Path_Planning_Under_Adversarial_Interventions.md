...
本文提出了一种新的马尔可夫决策过程(MDP)模型，用于解决对抗性干预下的欺骗路径规划(DPP)问题。研究者开发了基于信息价值(VoI)的目标函数，指导设计欺骗性路径策略，使规划者能通过选择低信息价值的轨迹来诱导对手采取次优干预。通过结合MDP线性规划理论，该方法能高效计算对抗干预下的欺骗策略。实验表明，该方法在网格世界问题中优于现有DPP方法和保守路径规划方法，能有效实现对抗环境下的欺骗性路径规划。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T06:02:14Z
- **目录日期**: 2025-04-01
