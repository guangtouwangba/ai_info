...
本文提出了一种基于马尔可夫决策过程(MDP)的对抗性干预下的欺骗路径规划(DPP)新模型。针对被动观察者设计的传统DPP方法无法应对对抗性干预，本研究通过设计新的信息价值(VoI)目标，引导规划者选择信息价值低的轨迹，诱使对手采取次优干预措施。结合MDP线性规划理论，开发了计算高效的策略合成方法。实验表明，该方法在网格世界问题中能有效实现欺骗性，性能优于现有DPP方法和保守路径规划方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T05:02:10Z
- **目录日期**: 2025-04-01
