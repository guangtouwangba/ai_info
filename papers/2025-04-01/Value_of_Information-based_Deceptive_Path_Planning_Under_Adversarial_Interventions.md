...
本文提出了一种新的马尔可夫决策过程（MDP）模型，用于解决对抗性干预下的欺骗路径规划（DPP）问题。传统DPP方法无法应对具有对抗干预能力的观察者，而本研究通过设计新的信息价值（VoI）目标，指导路径规划策略，使规划者能通过选择低信息价值的轨迹欺骗观察者采取次优干预。基于MDP线性规划理论，作者开发了计算高效的求解方法。实验表明，该方法在对抗干预下能有效实现欺骗性，并在网格世界问题中优于现有DPP方法和保守路径规划方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T07:02:22Z
- **目录日期**: 2025-04-01
