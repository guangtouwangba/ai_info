...
本文提出了一种新的马尔可夫决策过程（MDP）模型，用于解决对抗性干预下的欺骗路径规划（DPP）问题。通过设计新的信息价值（VoI）目标，该方法使路径规划代理能够通过选择低信息价值的轨迹，诱导对手采取次优干预措施。基于MDP的线性规划理论，研究开发了计算高效的策略合成方法。实验表明，该方法在对抗性干预下能有效实现欺骗效果，并在网格世界问题中优于现有DPP方法和保守路径规划方法。该研究为动态对抗环境中的路径规划提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T13:09:49Z
- **目录日期**: 2025-04-01
