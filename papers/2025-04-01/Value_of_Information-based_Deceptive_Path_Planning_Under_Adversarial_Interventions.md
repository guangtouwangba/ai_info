...
本文提出了一种新的马尔可夫决策过程(MDP)模型，用于解决对抗性干预下的欺骗路径规划(DPP)问题。研究者设计了新的信息价值(VoI)目标函数，指导路径规划策略的制定，使智能体能通过选择低信息价值的轨迹来欺骗对手采取次优干预措施。该方法利用MDP线性规划理论，开发了计算高效的策略合成方法。实验表明，该方法在对抗性干预下能有效实现欺骗效果，在网格世界测试中表现优于现有DPP方法和保守路径规划方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T19:02:05Z
- **目录日期**: 2025-04-01
