...
NASA通过詹姆斯韦伯望远镜发现263个星系中约2/3呈现顺时针旋转，与宇宙"各向同性"理论相矛盾。科学家提出两种解释：1) "黑洞宇宙论"认为宇宙可能起源于旋转黑洞，继承了初始旋转方向；2) 观测偏差，因银河系自身旋转导致反方向星系更易被观测。无论哪种解释都将颠覆现有认知——要么宇宙存在于更高维度的黑洞中，要么现有宇宙测量数据存在系统性误差。该发现发表于《皇家天文学会月刊》，可能改变人类对宇宙结构的理解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T17:04:09Z
- **目录日期**: 2025-04-01
