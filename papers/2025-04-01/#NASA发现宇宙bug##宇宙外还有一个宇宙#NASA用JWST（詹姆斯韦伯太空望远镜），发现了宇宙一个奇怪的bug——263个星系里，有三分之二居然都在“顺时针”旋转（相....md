...
NASA通过詹姆斯韦伯望远镜发现263个星系中三分之二呈现顺时针旋转，与宇宙"各向同性"理论相悖。科学家提出两种解释：1) "黑洞宇宙论"认为宇宙可能源自旋转黑洞，继承了初始旋转方向；2) 观测偏差，银河系自身旋转导致反方向星系更易被观测。无论哪种解释都挑战现有认知：前者暗示宇宙存在更高维度的方向性，后者则质疑现有宇宙测量数据的准确性。这一发现可能颠覆对宇宙结构的基本理解，相关研究发表于《皇家天文学会月刊》。(99字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T15:03:51Z
- **目录日期**: 2025-04-01
