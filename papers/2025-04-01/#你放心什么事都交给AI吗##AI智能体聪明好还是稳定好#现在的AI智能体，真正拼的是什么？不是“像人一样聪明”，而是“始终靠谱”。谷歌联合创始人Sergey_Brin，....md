...
谷歌联合创始人Sergey Brin指出，当前AI发展的核心应是稳定性而非拟人化智能。用户更需要AI可靠完成80%基础任务，而非不可预测地处理90%复杂操作。典型案例显示，全自动AI工具（如Devin、Cursor）常因不可控性导致效率低下甚至数据丢失。他强调优秀产品应建立防御机制，聚焦可验证的小任务执行，而非追求"万能助手"。现阶段AI应作为稳定工具而非决策者，透明度和可控性比"聪明"表现更重要。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T16:04:42Z
- **目录日期**: 2025-04-01
