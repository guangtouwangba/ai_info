...
谷歌联合创始人Sergey Brin指出，当前AI发展的核心应是可靠性而非单纯追求拟人化智能。他认为用户更需要AI稳定完成80%基础任务，而非不可预测地处理90%复杂操作。典型案例显示，全自动AI工具（如Devin、Cursor）常因不可控性导致效率低下甚至数据丢失。Sergey强调，优秀AI产品应建立防御机制确保基础任务无误，而非盲目追求"万能助手"概念。现阶段AI应聚焦可解释、可中断的辅助功能，避免因过度自动化增加用户风险。可靠性始终应优先于炫技式智能表现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T14:04:00Z
- **目录日期**: 2025-04-01
