...
谷歌联合创始人Sergey Brin指出，当前AI发展的核心应是可靠性而非拟人化智能。他认为用户更需要AI稳定完成80%基础任务（如订机票），而非不可预测地处理90%复杂操作。许多全自动AI项目（如Devin、Cursor）因"黑箱操作"和不可控性导致效率低下甚至数据丢失。Sergey强调优秀AI产品应建立防御机制，聚焦可验证的小任务执行，而非追求"万能助手"。现阶段AI应作为可靠工具而非决策者，稳定性远胜于偶尔的惊艳表现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T08:03:21Z
- **目录日期**: 2025-04-01
