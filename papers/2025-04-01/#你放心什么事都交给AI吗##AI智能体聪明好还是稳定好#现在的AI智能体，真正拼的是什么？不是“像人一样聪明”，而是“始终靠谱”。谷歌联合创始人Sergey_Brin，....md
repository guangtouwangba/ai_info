...
谷歌联合创始人Sergey Brin指出，当前AI发展的核心应是可靠性而非拟人化智能。他认为用户更需要AI稳定完成80%基础任务，而非不可预测地处理90%复杂操作。典型案例显示，全自动AI工具（如Cursor代码工具、Devin工程师项目）常因不可控性导致数据丢失或效率低下。理想AI应作为透明可控的工具，而非"黑箱"决策者。现阶段应聚焦精准执行小任务，而非追求全能自动化。可靠性和用户可控性比"聪明但不稳定"的表现更重要。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T12:04:01Z
- **目录日期**: 2025-04-01
