...
谷歌联合创始人Sergey Brin指出，当前AI发展的核心应是可靠性而非拟人化智能。用户更需要AI稳定完成80%基础任务，而非不可预测地处理90%复杂操作。典型案例显示，全自动AI工具（如Devin、Cursor）常因不可控性导致数据丢失或效率低下，反增用户负担。他强调优秀AI产品应聚焦可解释性和防御机制设计，避免"黑箱操作"。现阶段应优先确保简单任务执行无误，而非追求"万能助手"的噱头。稳定性与可控性远比偶尔的惊艳表现更重要。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T23:03:33Z
- **目录日期**: 2025-04-01
