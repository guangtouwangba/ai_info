...
谷歌联合创始人Sergey Brin指出，当前AI发展的核心矛盾在于"可靠性优先于能力"。他认为AI智能体不应追求拟人化或全自动化，而应确保基础任务的稳定执行。现有AI产品存在两大问题：一是过度黑箱化导致用户失控（如Cursor误删数据、Devin操作混乱）；二是错误地将"偶尔惊艳"等同于实用价值。真正的进步在于构建可预测、可中断的系统，让AI专注完成80%确定性任务，而非冒险处理90%复杂事务。现阶段AI应定位为"可靠工具"，而非"自主决策者"。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T09:03:46Z
- **目录日期**: 2025-04-01
