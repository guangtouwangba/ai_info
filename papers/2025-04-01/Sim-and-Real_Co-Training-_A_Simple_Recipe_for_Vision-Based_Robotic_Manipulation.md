...
这篇论文探讨了如何结合仿真和真实世界数据来训练机器人策略。研究表明，仅靠仿真数据训练的策略存在现实差距，而单纯依赖真实数据又成本高昂。通过实验验证，作者提出了一种简单有效的"仿真-现实协同训练"方法，证明在视觉操控任务中，即使仿真与真实数据存在显著差异，混合训练仍能平均提升38%的任务表现。该方法在机械臂和人形机器人等多种任务中均取得良好效果，为利用仿真数据增强真实机器人学习提供了实用方案。更多结果详见项目网站。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T19:01:10Z
- **目录日期**: 2025-04-01
