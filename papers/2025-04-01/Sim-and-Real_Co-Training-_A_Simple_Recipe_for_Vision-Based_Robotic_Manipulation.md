...
该研究探讨了如何结合仿真和真实世界数据来训练机器人策略。虽然大规模真实数据收集成本高，但仿真数据可以补充训练，尤其是借助生成式AI和自动化工具。研究发现，混合训练策略能显著提升策略性能，在真实任务中平均提高38%的表现，即使仿真与现实数据存在差异。研究通过机器人手臂和人形机器人等多种任务验证了这一方法，并提出了有效的训练方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T14:01:21Z
- **目录日期**: 2025-04-01
