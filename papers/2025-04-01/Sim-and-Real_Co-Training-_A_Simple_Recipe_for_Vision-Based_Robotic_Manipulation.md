...
这篇论文探讨了如何结合仿真和真实世界数据来提升机器人策略训练效果。研究表明，仅靠真实世界数据收集耗时耗力，而单纯仿真训练又存在现实差距。通过实验发现，在机器人手臂和人形机器人等多种任务中，混合使用仿真和真实数据共同训练策略，即使两者数据存在显著差异，也能使真实任务表现平均提升38%。研究提出了一个简单有效的视觉机器人操作任务解决方案，验证了仿真数据对提升真实世界学习效果的重要价值。该方法为利用仿真数据增强机器人学习提供了实用指导。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T05:01:15Z
- **目录日期**: 2025-04-01
