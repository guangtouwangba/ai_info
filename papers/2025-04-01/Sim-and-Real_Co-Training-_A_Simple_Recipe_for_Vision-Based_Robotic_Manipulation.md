...
这篇论文探讨了如何结合仿真和真实世界数据来训练机器人策略。虽然真实世界数据收集成本高，但仿真数据可以大规模生成。研究发现，混合使用仿真和真实数据共同训练策略，能显著提升机器人视觉操控任务的性能，平均提高38%。即使仿真与真实数据存在差异，这种协同训练方法仍然有效。研究通过机器人手臂和人形机器人等多种任务验证了这一策略，为利用仿真数据增强真实世界机器人学习提供了实用方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T12:01:16Z
- **目录日期**: 2025-04-01
