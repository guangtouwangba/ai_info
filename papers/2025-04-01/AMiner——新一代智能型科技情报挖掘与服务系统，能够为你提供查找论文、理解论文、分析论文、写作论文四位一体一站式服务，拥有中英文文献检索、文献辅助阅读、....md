...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献检索、AI辅助阅读、自动摘要生成及翻译功能，涵盖42个学科的3.5亿论文、0.6亿学者和1.5亿专利。用户可通过互动问答快速理解文献，并订阅个性化科研动态推送。平台还提供学者画像、学术会议和论文排行榜等功能，基础服务免费开放。访问入口：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T09:05:57Z
- **目录日期**: 2025-04-01
