...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、辅助阅读、翻译和论文写作支持。它收录了3.5亿论文、0.6亿学者等海量数据，支持互动问答、自动摘要生成和文献翻译功能。用户可订阅个性化科研动态，追踪学者和机构最新成果。平台还提供学者画像、学术会议和论文专题等工具，浏览器版可免费使用。通过AI技术，AMiner帮助用户高效筛选文献、理解内容和提升研究效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T02:35:38Z
- **目录日期**: 2025-04-01
