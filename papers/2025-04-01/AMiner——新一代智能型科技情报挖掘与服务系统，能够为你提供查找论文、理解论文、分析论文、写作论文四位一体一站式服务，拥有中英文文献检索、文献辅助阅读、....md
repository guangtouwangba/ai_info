...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、辅助阅读、翻译、论文写作支持等。其核心功能包括：1）高效检索3.5亿论文资源，支持互动问答和自动摘要生成；2）AI驱动的文献翻译与解析，可上传PDF获取章节概要和智能问答；3）个性化科研订阅服务，按需推送最新学术动态。平台还涵盖学者画像、学术会议等特色功能，支持免费使用，旨在提升科研效率。访问入口：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T21:05:16Z
- **目录日期**: 2025-04-01
