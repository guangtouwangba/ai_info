...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作一站式服务。它支持中英文文献搜索，能自动生成摘要和章节概要，并允许用户通过问答深入理解内容。平台还提供文献翻译、科研动态订阅（按用户偏好推送最新论文）、学者画像等功能，覆盖42个学科3.5亿论文资源。用户可免费使用浏览器检索，通过网页或微信小程序获取服务。核心优势包括高效筛选文献、AI辅助阅读及个性化情报推送，显著提升科研效率。访问入口：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T05:05:20Z
- **目录日期**: 2025-04-01
