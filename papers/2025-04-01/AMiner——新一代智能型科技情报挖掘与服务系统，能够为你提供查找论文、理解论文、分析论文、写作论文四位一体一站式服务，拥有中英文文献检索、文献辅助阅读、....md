...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、辅助阅读、翻译和科研情报订阅。它拥有42个学科的3.5亿论文、0.6亿学者和1.5亿专利数据。用户可通过互动问答快速理解文献，AI还能自动生成摘要和章节概要。平台支持定制化订阅，推送最新科研动态，并提供学者画像、学术会议等附加功能。AMiner可免费使用，帮助用户高效筛选文献、提升研究效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T12:06:06Z
- **目录日期**: 2025-04-01
