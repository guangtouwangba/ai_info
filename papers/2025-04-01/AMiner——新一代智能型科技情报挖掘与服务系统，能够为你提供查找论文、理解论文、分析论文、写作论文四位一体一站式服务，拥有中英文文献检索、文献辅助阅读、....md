...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、AI辅助阅读、翻译、摘要生成等功能。平台收录3.5亿论文、0.6亿学者等海量数据，支持用户通过提问快速理解文献内容，并能定制科研动态推送。此外，AMiner还提供学者画像、学术会议等特色功能，基础服务可免费使用。其AI工具能自动解析论文结构、生成摘要，显著提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T13:13:31Z
- **目录日期**: 2025-04-01
