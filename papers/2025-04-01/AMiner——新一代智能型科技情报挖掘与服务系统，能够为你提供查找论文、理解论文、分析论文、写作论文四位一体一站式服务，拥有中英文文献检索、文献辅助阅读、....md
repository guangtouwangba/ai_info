...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、辅助阅读和科研订阅等一站式服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持AI生成摘要、智能问答和文档解析，帮助用户快速理解文献内容。平台还能根据用户偏好推送最新科研动态，并提供学者画像、学术会议等特色功能。AMiner可免费使用，适合科研人员高效获取和管理学术信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T03:28:38Z
- **目录日期**: 2025-04-01
