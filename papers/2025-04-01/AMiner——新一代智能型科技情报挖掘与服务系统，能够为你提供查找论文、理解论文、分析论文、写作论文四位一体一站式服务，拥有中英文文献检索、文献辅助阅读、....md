...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、科研情报订阅等一站式服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持文献辅助阅读、智能问答和自动摘要生成。用户可通过关键词、机构或学者订阅最新科研动态，并通过微信或邮件接收。平台还提供学者画像、学术会议和必读论文专题等功能，帮助用户高效获取和理解学术信息。AMiner浏览器版可免费使用，网址为https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T07:05:56Z
- **目录日期**: 2025-04-01
