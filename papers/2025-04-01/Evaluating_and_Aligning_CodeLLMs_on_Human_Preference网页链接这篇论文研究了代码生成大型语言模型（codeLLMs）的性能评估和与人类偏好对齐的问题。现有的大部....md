...
这篇论文探讨了代码生成大模型(codeLLMs)与人类偏好的对齐问题。研究者创建了CodeArena基准测试，包含397个高质量样本，覆盖40个类别和44种编程语言，更贴近实际编程场景。同时开发了包含近200亿标记的SynCode-Instruct合成指令数据集。实验发现，传统基于执行的评估与CodeArena存在差异，且开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，凸显了人类偏好对齐的重要性。研究强调了代码生成模型评估需兼顾正确性和人类偏好。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T23:05:37Z
- **目录日期**: 2025-04-01
