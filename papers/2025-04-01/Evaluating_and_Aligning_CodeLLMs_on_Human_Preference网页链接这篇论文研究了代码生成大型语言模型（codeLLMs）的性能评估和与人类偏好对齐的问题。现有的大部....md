...
这篇论文提出了CodeArena基准测试，用于评估代码生成大模型(codeLLMs)与人类偏好的对齐程度。研究指出当前基准过于关注代码正确性而忽视用户体验，因此构建了包含397个样本、覆盖40类任务和44种编程语言的评估体系。同时开发了20B标记的合成指令数据集SynCode-Instruct验证微调效果。实验发现执行基准与CodeArena存在性能差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI)差距显著，凸显了人类偏好对齐的重要性。研究为提升代码生成模型的实用价值提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T15:06:23Z
- **目录日期**: 2025-04-01
