...
PathOrchestra是一个基于自监督学习的大规模病理基础模型，在30万张多中心病理切片上训练而成。该模型在112项临床任务（含61个私有和51个公共数据集）中表现优异，涵盖癌症分类、病变识别、生物标志物评估等。测试显示，其在27,755张全切片图像和941万区域中，47项任务准确率超0.950，尤其在跨器官泛癌分类、淋巴瘤亚型诊断等方面表现突出。该模型首次实现了高发结直肠癌和复杂淋巴瘤的结构化报告生成，显著降低数据标注需求，展现了临床应用的巨大潜力，为高效精准医疗服务提供了新路径。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T17:02:09Z
- **目录日期**: 2025-04-01
