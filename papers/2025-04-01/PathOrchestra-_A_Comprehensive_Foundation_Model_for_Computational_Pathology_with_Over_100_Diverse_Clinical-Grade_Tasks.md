...
PathOrchestra是一个基于自监督学习的大规模病理学基础模型，利用来自20种组织和器官类型的30万张病理切片进行训练。该模型在112项临床任务中进行了严格评估，涵盖癌症分类、病变识别、生物标志物评估、基因表达预测及结构化报告生成等。结果显示，PathOrchestra在27,755张全切片图像和941万多个感兴趣区域中表现优异，47项任务准确率超过0.950，包括泛癌分类和淋巴瘤亚型诊断。该模型首次实现了高发结直肠癌和复杂淋巴瘤的结构化报告生成，展现了其临床潜力，并通过减少对数据标注的依赖，为高效、高质量的医疗服务提供了可能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T21:01:18Z
- **目录日期**: 2025-04-01
