...
PathOrchestra是一个基于自监督学习的大规模病理学基础模型，使用来自多个中心的30万张病理切片训练，涵盖20种组织和器官类型。该模型在112项临床任务中进行了严格评估，包括癌症分类、病变识别、生物标志物评估和结构化报告生成等。在27,755张全切片图像和940万区域上的测试显示，PathOrchestra在47项任务中准确率超过0.950，尤其在跨器官癌症分类和淋巴瘤亚型诊断中表现突出。该模型首次实现了结直肠癌和淋巴瘤的结构化报告生成，显著减少了对大量标注数据的依赖，展现了在临床整合中的高效潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T16:02:20Z
- **目录日期**: 2025-04-01
