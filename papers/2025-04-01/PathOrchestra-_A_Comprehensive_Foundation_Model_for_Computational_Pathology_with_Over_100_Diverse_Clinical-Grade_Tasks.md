...
PathOrchestra是一个基于自监督学习的大规模病理基础模型，利用来自多个中心的30万张病理切片训练而成。该模型在112项临床任务中进行了严格评估，涵盖癌症分类、病变识别、生物标志物评估等，在27,755张全切片图像和941万多个感兴趣区域上表现出色，47项任务准确率超过0.950。特别值得注意的是，它首次实现了高发结直肠癌和复杂淋巴瘤的结构化报告生成。PathOrchestra展示了大规模病理基础模型的可行性和有效性，其高准确率和低标注依赖的特点使其具有显著的临床整合潜力，为提升医疗服务效率和质量提供了新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T03:19:15Z
- **目录日期**: 2025-04-01
