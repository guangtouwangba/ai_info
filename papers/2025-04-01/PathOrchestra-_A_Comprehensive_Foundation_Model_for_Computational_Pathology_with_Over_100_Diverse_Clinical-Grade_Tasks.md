...
PathOrchestra是一种基于自监督学习的大规模病理基础模型，训练数据包含来自多个中心的30万张病理切片，涵盖20种组织和器官类型。该模型在112项临床任务上进行了严格评估，包括癌症分类、病变识别、生物标志物评估和结构化报告生成等。测试覆盖27,755张全切片图像和941万多个感兴趣区域，在47项任务中准确率超过0.950，尤其在结直肠癌和淋巴瘤结构化报告生成方面表现突出。研究表明，PathOrchestra具有高准确性和低标注依赖的特点，展现了大规模病理基础模型在临床整合中的可行性和有效性，为提升医疗服务效率和质量提供了新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T11:01:25Z
- **目录日期**: 2025-04-01
