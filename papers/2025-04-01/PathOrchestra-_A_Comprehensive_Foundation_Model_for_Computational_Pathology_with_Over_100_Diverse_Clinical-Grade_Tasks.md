...
PathOrchestra是一种基于自监督学习的大规模病理基础模型，在30万张多中心病理切片上训练，涵盖20种组织器官。该模型在112项临床任务（61个私有和51个公共数据集）上进行了严格验证，包括癌症分类、病变识别、生物标志物评估等。在27,755张全切片图像和940万区域上表现出色，47项任务准确率超0.950，如泛癌分类和淋巴瘤亚型诊断。它首次实现了高发结直肠癌和复杂淋巴瘤的结构化报告生成，临床潜力显著。该模型展示了大规模病理基础模型的可行性，减少了对数据标注的依赖，有望提升临床效率和服务质量。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T06:01:20Z
- **目录日期**: 2025-04-01
