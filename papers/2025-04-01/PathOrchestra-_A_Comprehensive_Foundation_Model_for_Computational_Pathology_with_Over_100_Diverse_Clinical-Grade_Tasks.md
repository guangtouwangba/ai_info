...
PathOrchestra是一种基于自监督学习的大规模病理学基础模型，在30万张多中心病理切片上训练，涵盖20种组织和器官类型。该模型在112项临床任务（包括癌症分类、病变识别、生物标志物评估等）中表现优异，在27,755张全切片图像和9,415,729个ROI上验证，47项任务准确率超过0.950。它首次实现了高发结直肠癌和复杂淋巴瘤的结构化报告生成，显著降低了数据标注需求。研究表明PathOrchestra具有出色的临床适用性和泛化能力，为高质量医疗服务提供了可行路径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T10:01:26Z
- **目录日期**: 2025-04-01
