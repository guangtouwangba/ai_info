...
PathOrchestra是一个基于自监督学习的大规模病理学基础模型，在包含30万张来自20种组织和器官的病理切片数据集上训练而成。该模型在112项临床任务中进行了严格评估，涵盖癌症分类、病变识别、生物标志物评估和结构化报告生成等。结果显示，PathOrchestra在27,755张全切片图像和940万多个感兴趣区域上表现出色，47项任务准确率超过0.950，尤其在结直肠癌和淋巴瘤结构化报告生成方面开创先例。其高准确率和低标注依赖的特点突显了临床应用的潜力，为高效、高质量的医疗服务提供了新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T07:01:27Z
- **目录日期**: 2025-04-01
