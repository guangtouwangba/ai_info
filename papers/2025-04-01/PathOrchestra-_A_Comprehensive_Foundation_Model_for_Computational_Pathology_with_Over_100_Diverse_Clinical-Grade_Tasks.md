...
PathOrchestra是一个基于自监督学习的大规模病理学基础模型，使用来自多中心的30万张病理切片进行训练，涵盖20种组织和器官类型。该模型在112项临床任务（包括61个私有和51个公共数据集）上进行了严格评估，涉及癌症分类、病变识别、生物标志物评估等。在27,755张全切片图像和941万个感兴趣区域中表现优异，47项任务准确率超过0.950。该模型首次实现了高发结直肠癌和复杂淋巴瘤的结构化报告生成，展示了临床应用的巨大潜力。其高准确性和低标注依赖性为临床整合提供了高效解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T22:01:19Z
- **目录日期**: 2025-04-01
