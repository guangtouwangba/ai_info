...
英特尔新任CEO陈立武在Vision 2025大会上提出"重启英特尔"四大战略：1）强化PC/数据中心芯片核心业务，推进18A工艺量产；2）培养创新文化，重招技术人才；3）砍掉非核心业务，发展AI驱动的新平台；4）建立客户信任，直面问题。他强调英特尔作为美国唯一"设计+制造"一体化芯片商的技术主权责任，并计划复制其成功改造Cadence的经验。陈立武以"不画饼只干活"的务实风格著称，表示将长期领导英特尔转型。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T10:02:46Z
- **目录日期**: 2025-04-01
