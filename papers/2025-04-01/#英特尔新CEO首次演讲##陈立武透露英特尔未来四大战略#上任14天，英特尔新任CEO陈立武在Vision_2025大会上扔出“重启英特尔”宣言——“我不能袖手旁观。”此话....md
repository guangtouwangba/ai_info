...
英特尔新任CEO陈立武在Vision 2025大会上提出"重启英特尔"计划，强调四大战略：1）培养创新文化，聚焦PC/数据中心芯片，推进18A工艺量产；2）强化核心业务，召回技术人才；3）砍掉非核心业务（如Falcon Shores），加速AI/软件定义硬件布局；4）重建客户信任，直面问题。他特别指出英特尔作为美国唯一"设计+制造"一体化芯片公司的战略价值，并借鉴其成功改造Cadence的经验。陈立武以"不画饼，只干活"的务实风格，承诺将长期领导英特尔转型。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T12:02:59Z
- **目录日期**: 2025-04-01
