...
英特尔新任CEO陈立武在Vision 2025大会上宣布四大战略：1）强化创新文化，聚焦PC/数据中心芯片，推进18A工艺量产；2）巩固核心业务，优化Xeon芯片效能；3）砍掉非核心项目（如Falcon Shores），转向AI驱动的新平台；4）重建客户信任，直面问题。他强调英特尔作为美国唯一"设计+制造"一体化芯片商的技术主权责任，并计划复制其成功改造Cadence的经验。陈立武以"少承诺多交付"为准则，表态将长期领导英特尔转型。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T19:02:34Z
- **目录日期**: 2025-04-01
