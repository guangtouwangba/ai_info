...
本研究提出了BEATS框架，用于评估大语言模型（LLMs）的偏见、伦理、公平性和真实性。该框架包含29项指标，涵盖人口统计、认知、社会偏见及伦理推理、群体公平和事实性风险等方面，量化评估LLM输出可能加剧社会偏见的风险。实验数据显示，37.65%的主流模型输出存在某种偏见，凸显其在关键决策系统中的潜在风险。BEATS提供了一种可扩展且统计严谨的方法，用于基准测试、偏见诊断和缓解策略开发，旨在推动更具社会责任感和伦理对齐的AI模型发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T05:01:51Z
- **目录日期**: 2025-04-01
