...
本研究提出了BEATS框架，用于评估大语言模型(LLM)的偏见、伦理、公平性和事实性。该框架包含29项指标，涵盖人口统计、认知、社会偏见以及伦理推理、群体公平和事实性风险等方面，可量化评估LLM输出中可能存在的系统性偏见。实验数据显示，行业领先模型37.65%的输出存在某种偏见，揭示了其在关键决策系统中的潜在风险。BEATS提供了可扩展且严谨的评估方法，帮助诊断偏见成因并制定缓解策略，旨在推动开发更具社会责任感和伦理对齐的AI模型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T08:02:01Z
- **目录日期**: 2025-04-01
