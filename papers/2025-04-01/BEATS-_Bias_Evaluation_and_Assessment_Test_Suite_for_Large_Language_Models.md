...
本研究提出了BEATS框架，用于评估大语言模型(LLMs)的偏见、伦理、公平性和事实性。该框架包含29项指标，涵盖人口统计、认知、社会偏见等多个维度，可量化评估LLM输出中可能存在的系统性偏见。实验数据显示，领先商业模型37.65%的输出存在某种偏见，凸显了在关键决策系统中使用这些模型的风险。BEATS提供了可扩展的统计方法，既能评估LLMs，又能诊断偏见成因并制定缓解策略。该框架旨在推动开发更具社会责任感和伦理对齐的AI模型，为负责任的AI评估设立了严格标准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T18:02:41Z
- **目录日期**: 2025-04-01
