...
本研究提出了BEATS框架，用于评估大语言模型(LLMs)的偏见、伦理、公平性和事实性。该框架包含29项指标，涵盖人口统计、认知、社会偏见等多个维度，能定量分析LLM输出中可能存在的系统性偏见。实验数据显示，37.65%的主流商业模型输出存在某种偏见，凸显了其在关键决策系统中的潜在风险。BEATS提供了可扩展的统计方法，不仅能评估LLM表现，还能诊断偏见成因并制定缓解策略。该框架旨在推动开发更具社会责任感和伦理对齐的AI模型，为负责任的AI发展建立严格标准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T16:02:50Z
- **目录日期**: 2025-04-01
