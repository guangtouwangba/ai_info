...
本研究提出了BEATS框架，用于评估大语言模型(LLMs)的偏见、伦理、公平性和事实性。该框架包含29项指标，涵盖人口统计、认知、社会偏见及伦理推理、群体公平、事实性等方面，量化评估LLM输出中可能存在的系统性偏见。实验数据显示，行业领先模型37.65%的输出存在某种偏见，凸显其在关键决策系统中的潜在风险。BEATS提供了一种可扩展且统计严谨的方法，用于基准测试、诊断偏见成因并制定缓解策略，旨在推动开发更具社会责任感和伦理对齐的AI模型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T12:02:00Z
- **目录日期**: 2025-04-01
