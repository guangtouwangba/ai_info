...
AgentSociety是一种基于大语言模型的大规模社会模拟器，可模拟10,000多个AI代理的社会互动（500万次互动）。研究者用它研究四大社会问题：社会极化、信息传播、基本收入政策效果和自然灾害影响。模拟结果与现实数据高度吻合，验证了该工具在揭示人类行为机制方面的有效性。该系统为社会科学研究和政策制定提供了新方法，能补充传统调查和实验的不足。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T13:13:02Z
- **目录日期**: 2025-04-01
