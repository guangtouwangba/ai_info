...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理及其500万次社会互动。研究者利用该平台研究了四大社会问题：社会极化、刺激性信息传播、基本收入政策影响和自然灾害（如飓风）的社会效应。模拟结果与现实世界数据吻合，验证了该系统在揭示人类行为机制方面的有效性。该技术为社会科学研究和政策制定提供了新工具，能辅助传统研究方法（如调查和访谈），帮助理解社会问题的成因和潜在解决路径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T08:05:36Z
- **目录日期**: 2025-04-01
