...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟器。它通过1万个AI代理和500万次互动，模拟真实社会环境，研究四大社会问题：社会极化、信息传播、基本收入政策影响和外部冲击（如飓风）。模拟结果与现实世界数据吻合，验证了该工具在捕捉人类行为机制方面的有效性。研究表明，AgentSociety可作为计算社会科学的有力工具，帮助研究者和政策制定者理解社会问题成因，补充传统研究方法（如调查和访谈）的不足，具有重要的学术和实用价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T23:05:02Z
- **目录日期**: 2025-04-01
