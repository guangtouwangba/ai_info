...
AgentSociety是一种基于大语言模型的大规模社会模拟器，可模拟1万个代理的社会互动（500万次）。研究者用它分析四个关键社会问题：社会极化、信息传播、基本收入政策及飓风等外部冲击的影响。模拟结果与现实数据吻合，验证了其捕捉人类行为机制的能力。该系统可作为计算社会科学研究平台，辅助传统方法（如调查、访谈），帮助学者和决策者理解社会问题的成因与模式。该技术展现了LLM在社会仿真和政策评估中的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T00:05:24Z
- **目录日期**: 2025-04-01
