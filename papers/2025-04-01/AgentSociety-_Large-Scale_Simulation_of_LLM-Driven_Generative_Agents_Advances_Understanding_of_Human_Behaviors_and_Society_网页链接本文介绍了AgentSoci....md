...
这篇论文介绍了AgentSociety，一个利用大语言模型驱动的大规模社会模拟器，可以模拟超过1万个代理的社会互动。研究者用它研究了极化现象、信息传播、基本收入政策和飓风影响等社会问题，结果与现实世界实验吻合。该模拟器展示了作为社会科学研究工具的强大潜力，能帮助理解人类行为和社会机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T20:04:52Z
- **目录日期**: 2025-04-01
