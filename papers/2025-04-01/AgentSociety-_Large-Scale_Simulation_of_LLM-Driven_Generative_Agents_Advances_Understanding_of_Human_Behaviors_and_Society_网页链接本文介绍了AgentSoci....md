...
这篇论文介绍了AgentSociety，这是一个利用大型语言模型驱动的大规模社会模拟器，可以模拟超过1万个代理的社会行为和500万次互动。研究者用它作为计算社会科学实验平台，研究了极化现象、刺激性信息传播、无条件基本收入政策以及飓风等外部冲击对社会的影响。模拟结果与现实世界数据吻合，验证了该工具在捕捉人类行为机制方面的有效性，并展示了其作为社会科学研究和政策制定辅助工具的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T03:28:07Z
- **目录日期**: 2025-04-01
