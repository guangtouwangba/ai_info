...
AgentSociety是一种基于大语言模型的大规模社会模拟器，可模拟1万多个代理及其500万次互动。该平台被用于研究社会极化、信息传播、基本收入政策及自然灾害影响等关键问题，其模拟结果与现实数据高度吻合。研究证明AgentSociety能有效捕捉人类行为机制，为社会科学研究和政策制定提供新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T01:33:00Z
- **目录日期**: 2025-04-01
