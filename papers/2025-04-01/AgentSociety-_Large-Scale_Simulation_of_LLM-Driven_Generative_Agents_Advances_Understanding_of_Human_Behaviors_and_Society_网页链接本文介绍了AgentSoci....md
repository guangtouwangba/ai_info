...
本文介绍了AgentSociety，这是一个利用大型语言模型（LLM）驱动的大规模社会模拟器，包含超过1万个代理和500万次互动。该模拟器用于研究极化现象、信息传播、基本收入政策及外部冲击等社会问题。其模拟结果与现实世界实验数据吻合，验证了其在捕捉人类行为和社会机制方面的有效性。AgentSociety展示了作为社会科学研究和政策制定工具的潜力，能够辅助传统研究方法，帮助理解社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T10:05:04Z
- **目录日期**: 2025-04-01
