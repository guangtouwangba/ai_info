...
当前基于大语言模型(LLM)的信贷对话机器人虽能有效互动，但动态情感表达能力有限。本文提出EQ-negotiator系统，结合预训练语言模型(PLM)的情感识别与基于博弈论和隐马尔可夫模型的情感推理，通过分析客户当前及历史情绪来应对负面情绪。该方法在公共情感数据集上微调PLM，并在信贷对话数据集验证，使LLM代理能实时捕捉客户情绪变化，根据情感决策策略动态调整回应语气。这种情感智能谈判系统有助于信贷机构建立积极客户关系，提升信贷服务满意度，模仿人类谈判者细腻的决策过程。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T20:02:29Z
- **目录日期**: 2025-04-01
