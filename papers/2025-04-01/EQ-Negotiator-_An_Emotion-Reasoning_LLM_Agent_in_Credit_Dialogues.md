...
当前基于大语言模型(LLM)的信贷对话系统在动态情感表达上仍有局限。本文提出EQ-negotiator系统，结合预训练语言模型(PLM)的情感感知与基于博弈论和隐马尔可夫模型的情感推理。该系统能分析客户当前及历史情绪，实时调整回应语气，如在客户持续消极时适当表达愤怒以引导对话。通过在公共情感数据集上微调PLM并在信贷对话数据上验证，该系统能有效捕捉客户情绪变化并做出动态响应。这种情境感知的情感调节机制可模仿人类谈判者的决策，帮助信贷机构改善客户关系，提升服务满意度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T22:02:26Z
- **目录日期**: 2025-04-01
