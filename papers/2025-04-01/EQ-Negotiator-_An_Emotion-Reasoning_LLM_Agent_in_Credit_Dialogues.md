...
当前基于大语言模型（LLM）的信贷对话机器人虽能有效互动，但动态情感表达能力有限。本文提出EQ-negotiator，结合预训练语言模型（PLM）的情感感知与博弈论/隐马尔可夫模型的情感推理，通过历史与实时情绪分析管理客户负面情绪。方法在公开情感数据集微调PLM，并在信贷对话数据验证，使LLM能实时捕捉情绪变化，基于情感决策策略动态调整回应语气。这种情境感知的情绪调节可模仿人类谈判者的细腻决策，帮助信贷机构改善客户关系，提升服务满意度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T10:02:33Z
- **目录日期**: 2025-04-01
