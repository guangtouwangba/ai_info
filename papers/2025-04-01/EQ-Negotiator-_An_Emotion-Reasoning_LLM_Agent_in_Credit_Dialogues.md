...
当前基于大语言模型（LLM）的信贷对话机器人缺乏动态情感表达能力，主要依赖被动共情而非情感推理。本文提出一种结合预训练语言模型（PLM）情感识别与博弈论/隐马尔可夫模型情感推理的EQ谈判系统，通过分析客户实时及历史情绪，动态调整回应策略（如适时表达克制愤怒以引导对话）。该方法在公开情感数据集上微调PLM，并在信贷对话数据验证，使LLM能敏锐捕捉情绪变化，基于情感决策策略实时调整语气。该技术有助于信贷机构改善客户关系，提升服务满意度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T14:02:46Z
- **目录日期**: 2025-04-01
