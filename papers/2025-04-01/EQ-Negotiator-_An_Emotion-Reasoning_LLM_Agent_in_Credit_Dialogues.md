...
当前基于大语言模型（LLM）的信贷对话机器人虽能有效互动，但动态情感表达能力有限。现有代理主要依赖被动共情，缺乏情感推理能力。本文提出EQ-negotiator，结合预训练语言模型（PLM）的情感感知与博弈论/隐马尔可夫模型的情感推理，通过分析客户实时和历史情绪来应对负面情绪。该方法在公开情感数据集上微调PLM，并在信贷对话数据验证，使LLM代理能捕捉情绪变化，根据情感决策策略动态调整回应语气。该技术可提升金融机构客户关系管理，优化信贷服务满意度。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T15:02:47Z
- **目录日期**: 2025-04-01
