...
当前基于大语言模型（LLM）的信贷对话机器人虽能有效互动，但动态情感表达能力有限。现有代理主要依赖被动共情，缺乏情感推理能力。本文提出EQ-negotiator，结合预训练语言模型（PLM）的情感感知与基于博弈论和隐马尔可夫模型的情感推理，通过分析客户当前及历史情绪来管理负面情绪。该方法在公共情感数据集上微调PLM，并在信贷对话数据上验证，使LLM代理能实时捕捉客户情绪变化，动态调整回应语气。EQ-negotiator有助于信贷机构改善客户关系，提升服务满意度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T19:02:21Z
- **目录日期**: 2025-04-01
