...
当前基于大语言模型(LLM)的信贷对话机器人虽能有效互动，但动态情感表达能力有限。本文提出EQ-negotiator系统，结合预训练语言模型(PLM)的情感识别与基于博弈论和隐马尔可夫模型的情感推理，通过分析客户当前和历史情绪来管理负面情绪。该方法在公共情感数据集上微调PLM，并在信贷对话数据上验证，使LLM能实时捕捉客户情绪变化并动态调整回应语气。这种情境感知的情感调节能模仿人类谈判者的决策，帮助信贷机构改善客户关系，提升服务满意度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T11:02:39Z
- **目录日期**: 2025-04-01
