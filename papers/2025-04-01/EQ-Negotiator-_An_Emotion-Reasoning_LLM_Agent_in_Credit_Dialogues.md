...
当前基于大语言模型(LLM)的信贷对话系统在动态情感表达方面存在局限。本文提出EQ-negotiator系统，结合预训练语言模型(PLM)的情感识别与基于博弈论和隐马尔可夫模型的情感推理，通过分析客户当前和历史情绪来应对负面情绪。该方法在公共情感数据集上微调PLM，并在信贷对话数据上验证，使LLM代理能实时捕捉客户情绪变化，根据情感决策策略动态调整回应语气。该系统模仿人类谈判者的细腻决策，通过策略性情感适应(如适度表达愤怒)引导对话，有助于信贷机构改善客户关系，提升服务满意度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T13:10:10Z
- **目录日期**: 2025-04-01
