...
当前基于大语言模型（LLM）的信贷对话机器人缺乏动态情感表达能力，主要依赖被动共情。本文提出一种结合预训练语言模型（PLM）情感识别与博弈论/隐马尔可夫模型情感推理的EQ谈判系统。该系统通过分析客户当前及历史情绪，实时调整响应策略（如适时展现克制愤怒以引导消极客户），模拟人类谈判者的细腻决策。方法在公开情感数据集微调PLM，并在信贷对话数据验证，使LLM能敏锐捕捉情绪变化，基于情感决策策略动态调整语气。该技术可提升金融机构客户关系管理质量，优化信贷服务满意度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T21:02:20Z
- **目录日期**: 2025-04-01
