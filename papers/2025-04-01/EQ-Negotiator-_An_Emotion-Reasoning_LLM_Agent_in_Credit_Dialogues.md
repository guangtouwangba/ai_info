...
当前基于大语言模型（LLM）的信贷对话机器人缺乏动态情感表达能力，主要依赖被动共情。本文提出EQ-negotiator，结合预训练语言模型（PLM）的情感识别与基于博弈论和隐马尔可夫模型的情感推理，通过分析客户当前及历史情绪来优化负面情绪应对。该方法在公开情感数据集上微调PLM，并在信贷对话数据验证，使LLM能实时捕捉情绪变化并动态调整回应策略。例如面对持续消极的客户时，可策略性表达适度愤怒以引导对话。该技术有助于信贷机构改善客户关系，提升服务满意度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-01T16:03:31Z
- **目录日期**: 2025-04-01
