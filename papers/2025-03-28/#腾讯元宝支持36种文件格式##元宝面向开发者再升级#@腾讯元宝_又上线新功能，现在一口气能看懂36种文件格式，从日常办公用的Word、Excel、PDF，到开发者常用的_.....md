...
腾讯元宝AI助手最新升级，支持36种文件格式处理，包括办公文档(Word/Excel/PDF)和开发者文件(.py/.java/.cpp等)。新增代码智能识别功能，可进行代码解读、逻辑审查、bug检测及优化建议，支持Python/Java/C++等语言互译与语法简化。该平台采用混元与DeepSeek双模型驱动，自2月上线以来已迭代30余次，最新集成DeepSeek V3-0324模型并新增HTML实时预览功能。所有功能目前免费开放，面向开发者持续优化AI辅助编程体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T09:03:07Z
- **目录日期**: 2025-03-28
