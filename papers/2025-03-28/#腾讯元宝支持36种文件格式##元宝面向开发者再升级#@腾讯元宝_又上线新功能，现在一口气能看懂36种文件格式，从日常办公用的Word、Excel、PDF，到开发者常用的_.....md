...
腾讯元宝AI助手最新升级，支持36种文件格式处理，包括办公文档(Word/Excel/PDF)和开发文件(.py/.java/.cpp等)。新增代码智能识别功能，可进行代码解读、逻辑审查、bug检测及优化建议，支持Python/C++/Java等语言互译和语法简化。该平台采用混元与DeepSeek双模型驱动，自2月上线以来已更新超30次，最新集成了DeepSeek V3-0324模型并新增HTML实时预览功能。所有功能目前免费开放，持续为开发者提供AI支持。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T12:05:23Z
- **目录日期**: 2025-03-28
