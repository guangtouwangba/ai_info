...
腾讯元宝AI助手最新升级，支持36种文件格式处理，包括办公文档(Word/Excel/PDF)和开发文件(.py/.java/.cpp等)。新增代码智能识别功能，可进行代码解读、逻辑审查、bug检测、优化建议及跨语言翻译(如Python转JavaScript)。所有功能免费无限使用，自2月上线以来已迭代30余次，近期集成DeepSeek V3-0324模型并新增HTML实时预览功能。腾讯表示将持续采用混元+DeepSeek双模型驱动策略，为开发者提供高效AI工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T19:03:10Z
- **目录日期**: 2025-03-28
