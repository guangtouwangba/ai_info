...
腾讯元宝AI助手新增支持36种文件格式处理能力，包括办公文档(Word/Excel/PDF)和开发文件(.py/.java/.cpp等)。其特色功能包括：自动识别编程语言，提供代码审查、逻辑分析、bug检测及优化建议，支持Python/JavaScript等跨语言转换。该服务目前免费开放，自2月上线以来已迭代30余次，近期集成了DeepSeek V3-0324模型并新增HTML实时预览功能。腾讯强调将持续采用混元+DeepSeek双模型架构，为开发者提供高效AI工具支持。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T17:03:26Z
- **目录日期**: 2025-03-28
