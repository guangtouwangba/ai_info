...
腾讯元宝AI助手最新升级，支持36种文件格式处理，包括办公文档(Word/Excel/PDF)和开发文件(.py/.java/.cpp等)。具备代码语言自动识别功能，可进行代码解读、逻辑审查、bug检测及优化建议，支持Python/JavaScript等跨语言转换。目前所有功能免费无限使用，自2月上线以来已迭代超30次，近期集成了DeepSeek V3-0324模型并新增HTML实时预览功能。腾讯表示将持续采用混元+DeepSeek双模型驱动策略，为开发者提供高效AI工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T23:03:17Z
- **目录日期**: 2025-03-28
