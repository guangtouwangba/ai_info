...
视频生成技术已从早期的不真实输出发展到能生成视觉逼真且时序连贯的视频。现有评测基准（如VBench）主要评估表观真实性，包括单帧美感、时序一致性和基本提示跟随，但忽略了深层的现实世界原则。为实现真正的“世界模型”，视频生成需进一步满足物理规律、常识推理、解剖正确性和结构完整性等内在真实性要求。为此，研究团队推出VBench-2.0基准，从人类逼真度、可控性、创造性、物理性和常识性五个维度进行自动化评估，结合通用视觉语言模型和专用异常检测方法，推动视频生成向本质真实性的新标准迈进。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T15:01:53Z
- **目录日期**: 2025-03-28
