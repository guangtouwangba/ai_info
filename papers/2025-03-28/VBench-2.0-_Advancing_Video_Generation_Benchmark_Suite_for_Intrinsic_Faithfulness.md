...
视频生成技术已从早期不真实的输出发展到能生成视觉逼真且时序连贯的视频。现有评估基准（如VBench）主要关注表层真实性，如帧美学、时序一致性和基本提示遵循，但忽略了是否符合现实世界原则。为实现真正的"世界模型"，下一代视频生成需确保内在真实性，即遵守物理规律、常识推理、解剖正确性和结构完整性。为此，研究团队推出VBench-2.0基准，从人类逼真度、可控性、创造性、物理性和常识性五个维度自动评估视频生成模型的内在真实性，整合先进视觉语言模型和异常检测方法，推动视频生成向更高标准发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T14:04:20Z
- **目录日期**: 2025-03-28
