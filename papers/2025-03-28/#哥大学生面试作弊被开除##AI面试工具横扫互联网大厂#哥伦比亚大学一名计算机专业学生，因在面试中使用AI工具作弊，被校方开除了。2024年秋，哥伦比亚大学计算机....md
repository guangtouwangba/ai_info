...
哥伦比亚大学计算机系学生Roy Lee因在科技公司面试中使用自研AI作弊工具"InterviewCoder"被开除。他与合伙人Neel为创业造势，录制使用该工具通过Meta、Amazon等公司技术面试的全过程并公开炫耀，引发亚马逊面试官投诉。校方经调查认定其行为不当，最终作出开除决定。Roy表示虽付出沉重代价，但仍感谢在哥大的经历。该事件凸显了AI技术对招聘诚信体系的冲击，也反映了高校在新技术伦理监管上的滞后性。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T05:02:47Z
- **目录日期**: 2025-03-28
