...
哥伦比亚大学计算机系学生Roy Lee因在科技公司面试中使用自研AI作弊工具"InterviewCoder"被开除。他与合伙人开发该工具实时辅助编程面试，并通过录屏挑战Meta、Amazon等公司面试获取offer，在社交媒体炫耀以制造话题。Amazon面试官发现后投诉校方，导致哥大启动调查。校方最终以"传播机密文件"等罪名将其开除。Roy表示虽付出高昂代价，但感谢在哥大的经历。该事件引发对AI面试作弊工具及学术诚信的讨论，其LinkedIn账号也因无法验证offer真实性被封禁。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T13:12:20Z
- **目录日期**: 2025-03-28
