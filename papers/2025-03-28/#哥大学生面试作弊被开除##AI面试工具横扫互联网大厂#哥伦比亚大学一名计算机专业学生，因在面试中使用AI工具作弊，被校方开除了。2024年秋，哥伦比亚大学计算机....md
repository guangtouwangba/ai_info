...
哥伦比亚大学计算机系学生Roy Lee与合伙人开发了一款名为"InterviewCoder"的AI作弊工具，用于编程面试实时辅助。为制造话题，他们录制了使用该工具通过Meta、Amazon等大厂面试的全过程并公开炫耀。此举引发Amazon面试官投诉，导致哥大展开调查。尽管最初校规未明确禁止此类工具，Roy最终仍因"传播机密文件"等指控被开除。他在社交媒体上表示这次"创业"是代价高昂的教训，但仍感谢母校经历。事件凸显了AI技术应用与学术诚信之间的边界问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T11:03:49Z
- **目录日期**: 2025-03-28
