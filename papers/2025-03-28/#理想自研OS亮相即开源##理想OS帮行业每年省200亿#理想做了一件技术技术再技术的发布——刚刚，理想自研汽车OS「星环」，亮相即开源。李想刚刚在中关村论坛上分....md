...
理想汽车在中关村论坛发布自研汽车操作系统「星环OS」并宣布开源。该系统源于2020年芯片短缺危机，历时3年研发，投入10亿元和200名工程师，具有实时性强、稳定性高（比AUTOSAR响应快1倍、稳定性高5倍）、支持多芯片架构（适配周期仅4周）等特点，能缩短AEB刹停距离7米，每年为理想节省数十亿成本。开源后预计全行业可减少100-200亿元重复研发投入，主机厂每年节省数千万授权费。这是全球首个开源汽车OS，4月底将登陆开源社区。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T00:03:21Z
- **目录日期**: 2025-03-28
