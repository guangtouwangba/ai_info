...
理想汽车在中关村论坛发布自研汽车操作系统「星环OS」并宣布开源。该系统源于2020年芯片短缺时期的研发，投入200人团队和10亿元资金，具有实时性强、稳定性高（比AUTOSAR响应快1倍）、硬件资源整合（降低BOM成本几十亿/年）及快速芯片适配（仅需4周）等特点。开源后预计每年为行业节省100-200亿元研发投入，主机厂可减少OS授权费用。功能上提升AEB性能（120km/h刹停距离缩短7米），支持多芯片架构。理想成为全球首个开源汽车OS的车企，旨在推动行业协同创新。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T03:15:44Z
- **目录日期**: 2025-03-28
