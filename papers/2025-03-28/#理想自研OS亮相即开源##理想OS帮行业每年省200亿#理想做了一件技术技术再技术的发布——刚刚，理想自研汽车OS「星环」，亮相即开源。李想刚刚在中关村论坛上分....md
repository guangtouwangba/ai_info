...
理想汽车在中关村论坛发布了自研汽车操作系统"星环OS"，并宣布开源。该系统源于2020年芯片短缺时期的研发，投入200名人员、耗资10亿，具有三大优势：1)响应速度比AUTOSAR快1倍，AEB刹停距离缩短7米；2)实现算力共享，降低硬件成本，每年节省几十亿BOM费用；3)芯片适配周期从6个月缩短至4周。开源后预计每年可为行业节省100-200亿元重复研发费用。李想表示，这是AI时代的汽车OS，将通过开源推动行业创新，替代国外系统。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T05:03:48Z
- **目录日期**: 2025-03-28
