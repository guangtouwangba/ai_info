...
理想汽车在中关村论坛发布自研汽车操作系统"星环OS"并宣布开源。该系统源于2020年芯片荒时期的研发，具有三大优势：1)响应速度比AUTOSAR快1倍，稳定性高5倍，AEB刹停距离缩短7米；2)通过虚拟化技术降低硬件成本，每年可节省几十亿BOM成本；3)芯片适配周期从6个月缩短至4周。理想表示开源后可为行业每年节省100-200亿元重复研发费用。该OS已投入200人团队和10亿元研发资金，将于4月底在开源社区发布。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T01:30:10Z
- **目录日期**: 2025-03-28
