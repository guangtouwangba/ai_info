...
GPT-4o生成的吉卜力风格图像引发版权争议。专家指出，AI模仿艺术风格本身不违法，但若训练数据使用了未经授权的吉卜力影片素材则构成侵权。目前争议焦点在于AI模型的训练数据来源及授权情况，类似纠纷已出现在多起AI诉讼案中。OpenAI回应称其工具不会模仿在世艺术家的个人风格，但允许复制"工作室风格"，而吉卜力案例显示这种区分存在模糊地带。随着谷歌等公司推出类似功能，AI艺术模仿的版权问题日益凸显，现有法律尚未跟上技术发展步伐。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T20:03:44Z
- **目录日期**: 2025-03-28
