...
GPT-4o生成的吉卜力风格图像引发版权争议。律师指出，模仿风格本身不违法，但若训练数据未经授权使用吉卜力作品则构成侵权。目前争议焦点在于AI训练素材来源是否合法，类似纠纷已出现在OpenAI和Midjourney的诉讼中。OpenAI回应称不会模仿在世艺术家个人风格，但允许复制"工作室风格"，而宫崎骏与吉卜力风格的界限模糊。随着谷歌等公司推出类似功能，AI绘图技术发展远超版权法规完善速度，商业使用可能加剧法律风险。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T18:03:39Z
- **目录日期**: 2025-03-28
