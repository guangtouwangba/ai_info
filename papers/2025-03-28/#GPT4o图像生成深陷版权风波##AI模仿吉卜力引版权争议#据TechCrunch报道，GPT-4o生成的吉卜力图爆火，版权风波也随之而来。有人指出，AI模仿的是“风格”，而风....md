...
GPT-4o生成的吉卜力风格图像引发版权争议。专家指出，AI模仿艺术风格本身不违法，但若训练数据使用了未经授权的吉卜力作品素材则构成侵权。目前争议焦点在于训练数据的来源及授权情况，类似问题也出现在其他AI诉讼案中。OpenAI回应称不会模仿在世艺术家个人风格，但允许复制工作室风格，然而吉卜力创始人宫崎骏的个人风格与工作室风格界限模糊。随着谷歌、xAI等公司推出类似功能，AI绘图技术发展迅速，但相关版权法规尚未完善，潜在法律风险加剧。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T11:03:31Z
- **目录日期**: 2025-03-28
