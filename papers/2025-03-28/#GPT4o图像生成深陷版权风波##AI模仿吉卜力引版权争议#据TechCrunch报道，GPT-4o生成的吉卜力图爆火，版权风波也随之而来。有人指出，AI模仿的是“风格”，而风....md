...
GPT-4o生成的吉卜力风格图像引发版权争议。律师指出，AI模仿画风本身不违法，但若训练数据未经授权使用吉卜力作品则构成侵权。OpenAI回应称不模仿在世艺术家个人风格，但允许复制"工作室风格"，而宫崎骏个人风格与吉卜力工作室风格界限模糊。随着谷歌、xAI等推出类似功能，AI模仿画风已成趋势，但版权法规尚未完善。用户商业用途可能加剧法律风险，目前多起AI诉讼案（如《纽约时报》诉OpenAI）都聚焦训练数据授权问题。技术发展速度远超法律规范。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T21:03:37Z
- **目录日期**: 2025-03-28
