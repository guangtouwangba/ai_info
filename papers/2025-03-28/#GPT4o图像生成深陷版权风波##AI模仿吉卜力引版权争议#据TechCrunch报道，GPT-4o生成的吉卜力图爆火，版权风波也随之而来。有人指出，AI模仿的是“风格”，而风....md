# #GPT4o图像生成深陷版权风波##AI模仿吉卜力引版权争议#据TechCrunch报道，GPT-4o生成的吉卜力图爆火，版权风波也随之而来。有人指出，AI模仿的是“风格”，而风...
...
GPT-4o生成的吉卜力风格图像引发版权争议。律师指出，单纯模仿风格不违法，但若训练数据未经授权使用吉卜力作品则构成侵权。OpenAI回应称避免模仿在世艺术家个人风格，但工作室风格可复制，而宫崎骏与吉卜力风格的界限模糊。用户可能将生成图像用于商业用途，加剧法律风险。随着谷歌、xAI等推出类似功能，AI绘图版权问题凸显，现行法规尚未跟上技术发展步伐。多起AI版权诉讼（如《纽约时报》诉OpenAI）均聚焦训练数据来源合法性。技术发展与版权保护间存在明显断层。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T23:03:34Z
- **目录日期**: 2025-03-28
