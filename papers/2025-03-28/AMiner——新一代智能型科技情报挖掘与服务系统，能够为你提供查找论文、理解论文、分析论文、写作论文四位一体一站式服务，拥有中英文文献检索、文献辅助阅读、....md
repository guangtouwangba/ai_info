...
AMiner是一个智能科技情报平台，提供中英文文献检索、翻译、科研动态订阅等一站式服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持文献搜索、AI摘要生成、互动问答和辅助阅读。用户可定制订阅最新科研资讯，并通过微信或邮件接收。平台还提供学者画像、学术会议和论文排行榜等功能，基础服务免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T07:05:37Z
- **目录日期**: 2025-03-28
