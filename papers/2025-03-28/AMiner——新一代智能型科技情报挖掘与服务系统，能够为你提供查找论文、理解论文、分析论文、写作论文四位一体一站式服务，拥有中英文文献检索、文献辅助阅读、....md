...
AMiner是一个智能科技情报挖掘系统，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献检索，能自动生成摘要和回答用户问题，提高研究效率。平台还提供英文文献翻译、文档识别和辅助阅读功能，用户可上传PDF或从库中选取论文，获取摘要和章节概要。此外，AMiner提供科研情报订阅服务，根据用户偏好推送最新学术动态。其他功能包括学者画像、学术会议和论文排行榜。平台免费使用，拥有庞大的学术资源库。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T01:32:48Z
- **目录日期**: 2025-03-28
