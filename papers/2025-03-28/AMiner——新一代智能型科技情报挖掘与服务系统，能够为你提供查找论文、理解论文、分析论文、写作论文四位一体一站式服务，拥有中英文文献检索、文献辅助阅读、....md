...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务。主要功能包括：1）中英文文献检索，支持3.5亿论文检索和智能问答；2）AI辅助阅读，可自动生成摘要、翻译及内容解析；3）个性化科研订阅，按用户兴趣推送最新成果；4）额外提供学者画像、学术会议等工具。平台覆盖42个学科，整合论文、专利和科研项目数据，支持网页端免费使用，显著提升文献调研和论文写作效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T14:20:52Z
- **目录日期**: 2025-03-28
