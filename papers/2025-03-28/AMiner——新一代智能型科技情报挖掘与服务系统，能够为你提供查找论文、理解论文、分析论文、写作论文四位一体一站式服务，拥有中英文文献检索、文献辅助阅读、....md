...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、翻译、辅助阅读和论文写作支持。它拥有庞大的学术数据库（3.5亿论文、0.6亿学者等），支持AI生成摘要、智能问答和科研动态订阅。用户可通过关键词、学者或机构定制最新研究推送，还能使用文档解析和交互式阅读功能。平台免费开放基础服务，旨在提升学术研究效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T17:05:17Z
- **目录日期**: 2025-03-28
