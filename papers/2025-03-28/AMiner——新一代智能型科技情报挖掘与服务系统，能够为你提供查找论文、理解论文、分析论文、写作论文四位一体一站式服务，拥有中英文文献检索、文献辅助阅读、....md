...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、AI辅助阅读、翻译、摘要生成和学术问答功能。它涵盖42个学科的3.5亿论文、0.6亿学者和1.5亿专利数据，支持用户上传或搜索文献后快速获取摘要、章节概要和问题建议。平台还提供个性化科研动态订阅服务，通过微信或邮件推送最新研究进展。其浏览器版本可免费使用，集成学者画像、学术会议和论文排行榜等工具，显著提升文献调研和论文写作效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T05:05:25Z
- **目录日期**: 2025-03-28
