...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析和写作一站式服务。它支持中英文文献搜索，能自动生成摘要并回答用户提问，帮助快速理解论文内容。平台还提供科研动态订阅、学者画像、学术会议信息等功能，覆盖42个学科的3.5亿论文和1.5亿专利。用户可通过网页或微信小程序免费使用，实现高效学术研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T18:05:00Z
- **目录日期**: 2025-03-28
