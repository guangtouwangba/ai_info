...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析和写作一站式服务。它支持中英文文献搜索，拥有3.5亿论文、0.6亿学者等海量数据，并能通过AI生成摘要和回答文献相关问题。平台还提供科研动态订阅、学者画像等功能，用户可免费使用其浏览器检索服务。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T19:04:48Z
- **目录日期**: 2025-03-28
