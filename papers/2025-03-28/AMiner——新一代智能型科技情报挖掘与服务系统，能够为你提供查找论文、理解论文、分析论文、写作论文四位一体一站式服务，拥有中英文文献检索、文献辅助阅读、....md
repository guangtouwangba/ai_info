...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和科研订阅等一站式服务。它拥有3.5亿论文、0.6亿学者等海量学术资源，支持中英文文献检索、AI生成摘要、互动问答和文档翻译功能。用户可定制科研动态推送，关注特定学者或关键词获取最新研究。平台还提供学者画像、学术会议等特色功能，基础服务免费使用。AMiner通过AI技术帮助用户高效定位文献、理解内容并提升论文写作效率，适用于科研人员和学生。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T10:05:16Z
- **目录日期**: 2025-03-28
