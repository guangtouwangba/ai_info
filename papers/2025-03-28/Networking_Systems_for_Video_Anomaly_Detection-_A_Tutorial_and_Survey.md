...
随着智能城市监控摄像头和在线视频应用的普及，视频异常检测(VAD)成为AI领域的重要研究方向。深度学习与边缘计算的发展推动了VAD技术的进步，使其从算法研究扩展到可部署的网络系统(NSVAD)，成为AI、物联网视频和计算技术的交叉热点。本文系统梳理了基于深度学习的VAD方法的基本假设、学习框架和应用场景，为初学者提供教程；回顾了最新进展和典型解决方案，并汇总了相关资源。最后展望了未来趋势，探讨AI与计算技术如何解决现有挑战并创造新机遇，为研究者和工程师提供指导。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T01:29:41Z
- **目录日期**: 2025-03-28
