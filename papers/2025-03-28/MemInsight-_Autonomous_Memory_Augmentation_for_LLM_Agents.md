...
本文提出了一种名为MemInsight的自主记忆增强方法，旨在优化大语言模型（LLM）的语义数据表示和检索机制。该方法通过整合历史交互信息，帮助LLM代理生成更准确、更具情境化的响应。研究在对话推荐、问答和事件摘要三个任务场景中验证了其有效性。实验结果显示，在LLM-REDIAL数据集上，MemInsight将推荐说服力提升高达14%，并在LoCoMo检索任务中以34%的召回率优势超越RAG基线。这些结果表明，MemInsight能显著提升LLM代理在多任务中的上下文表现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T23:00:57Z
- **目录日期**: 2025-03-28
