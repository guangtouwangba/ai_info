...
这篇论文探讨了多智能体社会技术系统中社会成本函数(SCF)的选择问题。研究表明，SCF的选择取决于两个关键因素：个体成本在智能体间的可比性程度(从序数级到完全基数可比性)以及需要满足的公理条件。基于社会选择理论，作者提出了一个指导框架，说明不同假设和公理如何决定合适的SCF形式(如经典功利总和、纳什SCF或极大极小原则)。该框架可应用于水资源分配和交通管理等实际控制问题，为资源分配提供理论依据。研究强调了SCF选择需要严格论证，以避免不良后果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T01:28:29Z
- **目录日期**: 2025-03-28
