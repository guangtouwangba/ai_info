...
该研究探讨了多智能体社会技术系统中社会成本函数(SCF)的选择问题。SCF用于协调能源、水资源分配和交通管理等领域中的资源分配，但不当选择可能导致不良后果。研究表明，SCF的选择取决于个体成本的可比程度(从序数到完全基数可比性)以及需要满足的公理。基于社会选择理论，研究提供了控制应用中的指导框架，说明不同假设如何决定应使用功利总和、纳什SCF或最大化最小值等特定SCF。最后，研究展示了该框架在水资源和交通分配中的实际应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T00:01:36Z
- **目录日期**: 2025-03-28
