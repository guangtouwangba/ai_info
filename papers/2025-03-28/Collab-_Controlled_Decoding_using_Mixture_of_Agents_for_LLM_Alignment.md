...
本文提出了一种基于多智能体协作的解码方法Collab，用于提升大语言模型（LLM）在推理阶段的对齐性能。传统强化学习人类反馈（RLHF）方法计算成本高，而单智能体解码策略难以适应多样化任务。Collab通过动态选择现有对齐LLM策略池中的最优模型进行逐词解码，利用长期效用指标实现多模型协作。理论分析证明该方法在目标奖励下具有最优性能。实验表明，Collab在开源对齐模型上的表现优于单智能体基线，平均奖励提升1.56倍，GPT-4评估胜率提升71.89%，成为当前最佳解码策略。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T09:01:36Z
- **目录日期**: 2025-03-28
