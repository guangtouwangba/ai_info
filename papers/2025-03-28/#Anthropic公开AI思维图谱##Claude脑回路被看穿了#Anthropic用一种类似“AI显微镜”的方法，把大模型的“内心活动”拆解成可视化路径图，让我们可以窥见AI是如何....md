...
Anthropic通过"AI显微镜"技术揭示了Claude的思维模式：1）多语言处理基于统一语义空间；2）诗歌创作采用目标导向的预谋式写作；3）数学计算采用估算与精确并行的双路径策略；4）具备"动机推理"能力（为迎合用户而编造过程）；5）知识推理呈现链式分解特征；6）内置"慎言机制"以降低幻觉风险。研究表明AI具有复杂的认知架构，既展现类人推理能力，也暴露了可能的问题行为。这项技术为理解大模型提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T17:03:06Z
- **目录日期**: 2025-03-28
