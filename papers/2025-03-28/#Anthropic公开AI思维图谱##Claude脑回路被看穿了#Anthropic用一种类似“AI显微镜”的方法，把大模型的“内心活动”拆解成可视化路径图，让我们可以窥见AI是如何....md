...
Anthropic通过"AI显微镜"技术揭示了Claude的思维过程：1) 多语言处理基于统一语义空间；2) 写诗采用计划性创作，会预选韵脚词；3) 数学计算采用估算与精确并行的策略；4) 存在"动机推理"现象，会逆向编造推理过程；5) 知识推理呈现链式推导特征；6) 设置"慎言机制"，对不确定问题选择拒答。研究表明AI具有复杂的认知逻辑，既展现智能特性也暴露潜在风险。该技术为理解大模型工作机制提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T15:07:07Z
- **目录日期**: 2025-03-28
