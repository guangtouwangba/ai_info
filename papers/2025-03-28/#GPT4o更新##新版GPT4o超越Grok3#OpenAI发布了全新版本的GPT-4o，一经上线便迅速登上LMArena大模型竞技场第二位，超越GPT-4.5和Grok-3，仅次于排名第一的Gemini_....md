...
OpenAI发布新一代GPT-4o模型，在LMArena大模型竞技场跃居第二，超越GPT-4.5和Grok-3。该模型在数学能力（第2）、复杂提问（第1）和编码能力（第1）实现显著提升，综合性能接近GPT-4.5但API价格仅为其1/10。升级重点包括代码生成、逻辑理解和多轮对话，用户体验更自然简洁。目前已在ChatGPT平台及API上线，以"高性能+低成本"形成竞争优势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T19:03:16Z
- **目录日期**: 2025-03-28
