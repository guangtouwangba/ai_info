...
OpenAI发布新一代GPT-4o模型，在LMArena榜单跃居第二（仅次于Gemini 2.5 Pro），数学能力从14位升至第2，复杂提问和编码能力均登顶。其性能接近GPT-4.5但API价格仅为1/10，实现"更强更省"双重突破。升级重点包括代码生成、逻辑理解和多轮对话，用户反馈其响应更智能简洁。该模型已正式上线ChatGPT平台，以超高性价比提供接近人类的自然交互体验。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T14:08:31Z
- **目录日期**: 2025-03-28
