...
OpenAI发布GPT-4o，性能大幅提升：LMArena排名第二，超越GPT-4.5和Grok-3，数学能力升至第二，复杂提问和编码能力均跃居第一。其性能接近GPT-4.5，但API价格仅为十分之一。升级包括代码生成、逻辑理解和多轮对话，回答更简洁自然。用户反馈更聪明、有创意，协作表现更佳。目前已上线ChatGPT平台及API，性价比突出。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T08:13:30Z
- **目录日期**: 2025-03-28
