...
OpenAI发布全新GPT-4o模型，在LMArena大模型竞技场排名第二，超越GPT-4.5和Grok-3。该模型在数学能力（第2）、复杂提问（第1）和编码能力（第1）等方面显著提升，综合性能接近GPT-4.5但API价格仅为十分之一。GPT-4o在代码生成、逻辑理解和多轮对话等场景表现更稳定自然，用户反馈其回答更简洁有创意。目前已上线ChatGPT平台及API，实现性能与成本的双重优化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T17:03:34Z
- **目录日期**: 2025-03-28
