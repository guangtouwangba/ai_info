...
OpenAI发布新一代GPT-4o模型，在LMArena榜单跃居第二，超越GPT-4.5和Grok-3。其数学能力从第14升至第2，复杂提问和编码能力均登顶。性能接近GPT-4.5但API价格仅1/10，实现"更强更省"。升级重点包括代码生成、逻辑理解和多轮对话，回答更简洁自然。目前已上线ChatGPT平台，以高性价比提供更智能、稳定的交互体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T23:03:25Z
- **目录日期**: 2025-03-28
