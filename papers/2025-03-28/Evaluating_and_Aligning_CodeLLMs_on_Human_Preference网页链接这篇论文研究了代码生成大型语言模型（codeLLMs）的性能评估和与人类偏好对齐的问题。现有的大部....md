...
这篇论文提出了CodeArena基准测试和SynCode-Instruct语料库，用于评估代码生成大语言模型(codeLLMs)与人类偏好的对齐程度。研究指出当前基准过于关注代码正确性而忽视人类偏好，因此构建了包含397个样本、覆盖40类任务和44种语言的CodeArena。实验发现执行基准与CodeArena存在性能差异，开源模型(如Qwen2.5-Coder)与专有模型(如OpenAI o1)差距显著，凸显对齐人类偏好的重要性。SynCode-Instruct(近200亿标记)验证了大规模合成指令微调的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T02:32:35Z
- **目录日期**: 2025-03-28
