...
该论文针对代码生成大模型(codeLLMs)提出新评估方法，发现现有基准过于关注代码正确性而忽略人类偏好。研究者构建了CodeArena基准(含397个多语言样本)和SynCode-Instruct语料库(近200亿标记)，通过实验揭示了执行基准与人类偏好间的评估差异。结果显示开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI)存在显著性能差距，强调了模型与人类偏好对齐的重要性。研究为提升代码LLMs的实际应用价值提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T05:05:34Z
- **目录日期**: 2025-03-28
