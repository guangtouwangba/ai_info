...
这篇论文针对代码生成大模型(codeLLMs)提出了两个重要贡献：1)创建了CodeArena基准测试，包含397个高质量编程任务样本，覆盖40个类别和44种语言，首次关注代码生成与人类偏好的匹配；2)构建了SynCode-Instruct语料库(近200亿标记)，验证了合成指令微调的有效性。研究发现现有基于执行的测试与人类偏好存在差距，且开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著，强调了模型对齐人类偏好的重要性。研究为代码生成模型的评估和优化提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T00:06:17Z
- **目录日期**: 2025-03-28
