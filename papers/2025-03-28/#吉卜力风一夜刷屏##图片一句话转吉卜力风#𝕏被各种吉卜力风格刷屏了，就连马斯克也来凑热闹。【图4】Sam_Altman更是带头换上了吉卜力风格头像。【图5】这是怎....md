...
近日，GPT-4o的图像生成功能引发热潮，用户只需上传图片并输入提示词"帮我转成吉卜力风格"，即可一键生成吉卜力动画风格的图像。这一功能迅速风靡社交平台，连马斯克、Sam Altman等名人也参与其中。但该技术也引发版权争议，OpenAI回应称不会模仿在世艺术家的个人风格，但允许复制"工作室风格"。目前法律上尚未明确界定此类AI风格模仿是否侵权，最终结论需等待司法裁定。网友已生成包括雷军在内的各种吉卜力风格形象，展示出强大的风格迁移能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T00:04:36Z
- **目录日期**: 2025-03-28
