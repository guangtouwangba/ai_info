...
OVO-Bench是一个专注于评估视频大语言模型（Video-LLMs）时间感知能力的新型基准测试。它强调在线视频理解的关键特性——根据问题提出的时间戳动态推理，涵盖回溯过去事件、实时理解和延迟响应三种场景。该基准包含12项任务、644个独特视频和约2800个人工标注的精细时间戳元数据。通过自动生成和人工筛选结合的方式，OVO-Bench构建了系统性评估流程。对9个视频大模型的测试表明，尽管在传统基准上有进步，现有模型在在线视频理解方面仍显著落后于人类水平。该基准旨在推动视频大模型在动态时间推理方面的发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T19:01:53Z
- **目录日期**: 2025-03-28
