...
研究人员提出了OVO-Bench基准测试，专门评估视频大语言模型（LLMs）的时序感知能力——即根据提问时间戳动态推理的能力。该基准包含12项任务、644个视频和2800条精细标注，测试模型在三种场景下的表现：回溯过去事件、实时理解当前画面、延迟响应以获取未来信息。评估发现，尽管现有模型在传统基准上有进步，但在在线视频理解方面仍显著落后于人类。OVO-Bench通过结合自动生成与人工标注，为在线视频推理研究提供了系统性评估工具，旨在推动视频LLMs的发展。项目代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T10:01:53Z
- **目录日期**: 2025-03-28
