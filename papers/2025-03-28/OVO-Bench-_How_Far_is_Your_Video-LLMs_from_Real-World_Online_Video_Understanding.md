...
OVO-Bench是一个新型在线视频基准测试，旨在评估视频大语言模型（LLMs）的时间感知能力——即根据提问时间戳动态推理的能力。该基准包含12项任务，覆盖644个独特视频和约2800个人工标注的精细元注释，重点测试模型在三种场景下的表现：回溯过去事件、实时理解当前事件、以及延迟响应以获取未来信息。研究发现，尽管现有视频LLMs在传统基准上表现良好，但在在线视频理解方面仍显著落后于人类水平。该基准希望推动视频LLMs在动态时间推理方面的进步。项目代码和数据集已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T14:06:46Z
- **目录日期**: 2025-03-28
