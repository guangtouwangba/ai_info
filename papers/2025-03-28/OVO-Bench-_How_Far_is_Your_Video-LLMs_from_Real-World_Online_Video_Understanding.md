...
OVO-Bench是一个专注于评估视频大语言模型（Video-LLMs）时间感知能力的新型基准测试。它强调在线模型需根据问题提出的时间戳动态推理，涵盖三种场景：回溯过去事件、实时理解当前事件以及延迟响应以获取未来信息。该基准包含12项任务、644个独特视频和约2800个人工标注的精细元数据。通过自动化生成与人工审核结合，系统评估了9种Video-LLMs，发现现有模型在在线视频理解方面与人类表现存在显著差距。OVO-Bench旨在推动视频LLMs发展，促进在线视频推理研究。代码与基准已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T03:14:13Z
- **目录日期**: 2025-03-28
