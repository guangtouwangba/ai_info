...
OVO-Bench是一个专注于评估视频大语言模型（Video-LLMs）时间感知能力的新基准测试。它强调在线模型根据问题时间戳动态推理的能力，包括回溯过去事件、实时理解当前事件和延迟响应以获取未来信息三种场景。该基准包含12项任务、644个独特视频和约2800个人工标注的精细时间戳元数据。通过结合自动化生成和人工标注，OVO-Bench系统评估了9个Video-LLMs，发现现有模型在在线视频理解方面仍显著落后于人类。该基准旨在推动视频LLMs的发展，促进在线视频推理研究的进步。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T22:01:53Z
- **目录日期**: 2025-03-28
