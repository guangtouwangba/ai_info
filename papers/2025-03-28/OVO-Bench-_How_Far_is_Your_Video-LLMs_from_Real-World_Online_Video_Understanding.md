...
OVO-Bench是一个专注于评估视频大语言模型（Video-LLMs）时间感知能力的新型基准测试。它强调在线模型根据提问时间戳动态推理的能力，涵盖三种场景：回溯过去事件、实时理解当前事件以及延迟响应以获取未来信息。该基准包含12项任务、644个独特视频和约2800条精细标注。通过自动化生成和人工标注结合，系统评估了9个Video-LLMs，发现现有模型在在线视频理解方面表现不佳，与人类存在显著差距。OVO-Bench旨在推动视频LLMs发展，促进在线视频推理研究。代码和基准已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T12:03:04Z
- **目录日期**: 2025-03-28
