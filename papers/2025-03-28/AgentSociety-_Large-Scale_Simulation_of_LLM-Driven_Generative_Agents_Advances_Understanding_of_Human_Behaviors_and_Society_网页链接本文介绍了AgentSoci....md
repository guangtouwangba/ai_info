...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟1万多个代理的社会互动（500万次互动）。它被用于研究四个关键社会问题：社会极化、刺激性信息传播、基本收入政策影响和外部冲击（如飓风）。模拟结果与现实世界数据吻合，验证了其捕捉人类行为机制的能力。该系统可作为社会科学研究和政策制定的新工具，补充传统方法（如调查和访谈），帮助理解社会问题的模式和成因。研究表明AgentSociety在推动计算社会科学发展方面具有重要潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T12:08:38Z
- **目录日期**: 2025-03-28
