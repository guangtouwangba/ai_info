...
AgentSociety是一个基于大语言模型的大规模社会模拟器，包含1万多个AI代理和500万次互动，用于研究人类行为和社会现象。它模拟了极化现象、信息传播、基本收入政策和自然灾害影响等社会问题，结果与现实研究吻合。该系统结合了AI代理、真实社会环境和强大模拟引擎，可作为计算社会科学的实验平台，帮助研究者分析社会问题的模式和机制，并为政策制定提供参考。研究表明AgentSociety能有效捕捉人类行为特征，具有成为社会科学研究重要工具的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T03:17:41Z
- **目录日期**: 2025-03-28
