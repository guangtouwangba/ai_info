...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟器，能够模拟超过1万个代理及其500万次互动。研究者用它研究了极化现象、信息传播、基本收入政策和自然灾害影响等社会问题。结果显示其模拟结果与现实数据吻合，验证了该工具在捕捉人类行为机制方面的能力，表明它可作为社会科学研究和政策制定的有效工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T06:05:16Z
- **目录日期**: 2025-03-28
