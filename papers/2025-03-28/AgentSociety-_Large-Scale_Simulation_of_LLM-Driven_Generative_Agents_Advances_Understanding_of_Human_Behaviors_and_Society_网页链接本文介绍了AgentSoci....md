...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟器，可模拟1万多个代理及其500万次互动。研究者用它作为计算社会科学实验平台，研究了社会极化、信息传播、基本收入政策影响和外部冲击（如飓风）四个关键问题。模拟结果与现实世界数据吻合，验证了该工具在理解人类行为和社会机制方面的有效性。AgentSociety展示了作为社会科学研究和政策制定辅助工具的潜力，能够补充传统研究方法（如调查和访谈）。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T19:04:23Z
- **目录日期**: 2025-03-28
