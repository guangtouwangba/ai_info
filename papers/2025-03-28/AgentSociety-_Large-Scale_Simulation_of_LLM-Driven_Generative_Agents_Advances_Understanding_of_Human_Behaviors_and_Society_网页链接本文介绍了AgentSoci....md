...
AgentSociety是一种基于大语言模型的大规模社会模拟器，可模拟超过1万个代理及其500万次互动。研究者用它研究了社会极化、信息传播、基本收入政策及自然灾害影响等社会问题。模拟结果与现实世界数据吻合，验证了其在分析人类行为和社会机制方面的有效性。该系统可作为社会科学研究和政策制定的有力工具，补充传统研究方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T09:05:36Z
- **目录日期**: 2025-03-28
