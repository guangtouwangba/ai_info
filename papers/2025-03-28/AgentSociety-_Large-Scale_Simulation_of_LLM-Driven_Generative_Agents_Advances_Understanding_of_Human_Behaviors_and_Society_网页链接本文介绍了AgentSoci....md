...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟超过1万个智能代理的社会互动（500万次交互）。该系统通过研究社会极化、信息传播、基本收入政策及自然灾害影响等四大社会问题，验证了其模拟结果与现实世界数据的高度吻合。研究表明，AgentSociety能有效捕捉人类行为机制，为社会科学研究和政策制定提供了创新工具，可辅助传统调查和实验方法。这一突破性技术展现了AI在理解复杂社会现象方面的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T05:05:01Z
- **目录日期**: 2025-03-28
