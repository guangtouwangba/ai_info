...
GenoTEX是一个用于基因表达数据自动化分析的基准数据集，包含标准化流程（数据选择、预处理和统计分析）的注释代码和结果，并经过生物信息学专家审核以确保准确性。研究者还开发了GenoAgent——基于大语言模型（LLM）的多智能体系统，通过多步骤编程和自校正功能协作分析基因数据。实验表明LLM方法在基因组数据分析中具有潜力，同时错误分析揭示了改进方向。该基准为评估和开发自动化基因分析方法提供了资源，项目地址：https://github.com/Liu-Hy/GenoTex。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T23:02:13Z
- **目录日期**: 2025-03-28
