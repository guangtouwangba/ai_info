...
GenoTEX是一个用于自动化基因表达数据分析的基准数据集，包含注释代码和结果，覆盖基因识别全流程（数据选择、预处理和统计分析）。该数据集遵循计算基因组学标准，并由生物信息学专家验证准确性。研究团队还开发了GenoAgent，一个基于大语言模型（LLM）的多智能体系统，采用多步骤编程和自校正机制协作分析基因数据。实验表明LLM方法在基因组数据分析中具有潜力，但也揭示了改进空间。GenoTEX为评估和提升自动化基因分析提供了资源，数据集已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T17:02:20Z
- **目录日期**: 2025-03-28
