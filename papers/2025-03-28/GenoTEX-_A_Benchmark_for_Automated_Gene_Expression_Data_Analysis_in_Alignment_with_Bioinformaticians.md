...
GenoTEX是一个用于自动化基因表达数据分析的基准数据集，包含基因识别任务中的代码注释和专家验证结果，涵盖数据选择、预处理和统计分析流程。研究者还开发了GenoAgent——基于大语言模型的多智能体系统，采用自校正编程工作流协作分析基因数据。实验表明该方法在基因组数据分析中具有潜力，同时揭示了改进空间。该基准为评估和开发自动化基因分析方法提供了可靠资源，可访问https://github.com/Liu-Hy/GenoTex。研究展示了LLM在降低生物信息学分析门槛方面的应用前景。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T09:02:37Z
- **目录日期**: 2025-03-28
