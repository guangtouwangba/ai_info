...
GenoTEX是一个用于自动化基因表达数据分析的基准数据集，包含注释代码和结果，覆盖数据集选择、预处理和统计分析等流程，符合计算基因组学标准。该数据集由生物信息学专家标注，确保准确性和可靠性。研究团队还开发了GenoAgent，一个基于大语言模型（LLM）的多智能体系统，采用多步骤编程和自校正机制协作分析基因表达数据。实验表明LLM方法在基因组数据分析中具有潜力，同时也揭示了未来改进的挑战。GenoTEX可作为评估和提升基因表达数据自动化分析方法的资源，相关数据已在GitHub开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T03:14:35Z
- **目录日期**: 2025-03-28
