...
GenoTEX是一个用于自动化分析基因表达数据的基准数据集，包含注释代码和解决基因识别问题的标准化流程（数据集选择、预处理和统计分析）。该数据集由生物信息学家精心标注，确保准确性和可靠性。同时，研究团队提出GenoAgent——基于大语言模型（LLM）的多智能体系统，采用多步骤编程和自校正机制协同分析基因数据。实验表明LLM方法在基因组数据分析中具有潜力，但也揭示了当前挑战。GenoTEX为评估和开发自动化基因分析方法提供了重要资源，其基准数据已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T20:02:24Z
- **目录日期**: 2025-03-28
