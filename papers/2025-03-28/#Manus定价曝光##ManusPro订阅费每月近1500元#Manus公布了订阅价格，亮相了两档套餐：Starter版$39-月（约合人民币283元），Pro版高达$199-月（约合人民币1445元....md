...
Manus公布了两档AI订阅套餐：Starter版39美元/月（约283元），支持2个任务；Pro版199美元/月（约1445元），支持5个任务并提供更长上下文、高投入模式等高级功能。Pro版用户还享有更高稳定性和优先资源使用权。该产品定位"通用AI助手"，目前处于测试阶段，已与阿里Qwen团队合作。其定价显著高于ChatGPT Plus（20美元/月），试图通过差异化服务在国内AI市场竞争。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T11:02:36Z
- **目录日期**: 2025-03-28
