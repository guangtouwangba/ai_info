...
Manus公布了两档AI订阅套餐价格：Starter版39美元/月（约283元），支持2个任务；Pro版199美元/月（约1445元），支持5个任务并提供更长上下文、高投入模式等高级功能。定位"通用AI助手"的Manus价格显著高于ChatGPT Plus，主打差异化智能体服务。目前该平台仍处测试阶段，已与阿里Qwen团队达成合作。高定价策略显示出其瞄准专业市场的定位，反映了国内AI服务竞争的加剧趋势。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T13:10:59Z
- **目录日期**: 2025-03-28
