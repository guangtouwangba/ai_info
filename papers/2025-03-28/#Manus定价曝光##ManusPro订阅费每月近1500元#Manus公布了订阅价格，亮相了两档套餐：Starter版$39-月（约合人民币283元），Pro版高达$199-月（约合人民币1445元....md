...
Manus公布了两档AI订阅套餐定价：Starter版39美元/月（约283元），支持2个并发任务；Pro版199美元/月（约1445元），支持5个任务并提供更长上下文、高投入模式等高级功能。其定位为"通用AI助手"，价格显著高于ChatGPT Plus（20美元/月）。目前仍处测试阶段，已与阿里通义千问团队合作。该定价策略显示出Manus试图通过差异化服务在国内AI市场竞争，提供类"AI实习生"的高端智能服务。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-28T22:02:35Z
- **目录日期**: 2025-03-28
