...
OpenAI CEO奥特曼在访谈中展望下一代AI模型，认为理想的AGI应具备超人推理能力、万亿级上下文处理能力，并能调用各种工具。他强调AGI不需要内置知识，而应专注于思考、搜索和问题解决能力，目标是能自主发现新科学或大幅加速人类科研进程。这一观点引发讨论，支持者认同其愿景，也有人担忧过度依赖AI的风险。奥特曼还探讨了千倍算力下的AI发展可能性，展现了OpenAI对通用人工智能的长期构想。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T01:31:41Z
- **目录日期**: 2025-06-05
