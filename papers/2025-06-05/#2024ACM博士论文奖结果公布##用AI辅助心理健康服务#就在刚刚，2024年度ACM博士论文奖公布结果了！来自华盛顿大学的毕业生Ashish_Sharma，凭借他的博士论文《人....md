...
2024年ACM博士论文奖由华盛顿大学的Ashish Sharma获得，其论文《人机协作支持心理健康与福祉》研究了AI如何提升心理健康服务。他开发了基于强化学习的AI系统帮助在线互助志愿者提高同理心表达，并通过大规模实验证明AI辅助能有效改善消极思维。此外，他建立了评估AI心理干预效果的框架，发现当前大语言模型更接近低质量人类治疗师行为。荣誉提名授予Alexander Kelley（受限计算模型研究）和Sewon Min（大语言模型数据应用）。该奖项每年表彰计算机领域最佳博士论文，奖金2万美元。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T19:03:31Z
- **目录日期**: 2025-06-05
