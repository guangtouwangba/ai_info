...
2024年ACM博士论文奖授予华盛顿大学的Ashish Sharma，其研究聚焦AI辅助心理健康服务。他开发了基于强化学习的AI系统，提升在线互助志愿者的同理心表达；通过大规模试验证明AI-人类协作能有效帮助用户克服消极思维；并创建评估框架，发现当前AI治疗师行为更接近低质量人类治疗（如过度建议）。荣誉提名奖授予Zander Kelley（受限计算模型的伪随机分布研究）和Sewon Min（大语言模型数据应用重构）。该奖项每年评选计算机领域最佳博士论文，奖金2万美元。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T11:04:08Z
- **目录日期**: 2025-06-05
