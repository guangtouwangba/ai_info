...
2024年ACM博士论文奖授予华盛顿大学Ashish Sharma，其研究聚焦AI辅助心理健康服务。他开发了基于强化学习的AI系统提升在线陪伴者的同理心表达（实验显示效果显著），并通过大规模试验证明AI-人类协作能有效帮助认知重构。同时，他建立了评估AI心理干预效果的框架，发现当前LLM治疗师表现更接近低质量人类治疗（如过度建议而非情感支持）。另两位荣誉提名者分别研究受限计算模型的伪随机分布（Kelley）和LLM数据应用范式重构（Min）。该奖项年度奖金总额3万美元。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T20:03:45Z
- **目录日期**: 2025-06-05
