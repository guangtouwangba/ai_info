...
2024年ACM博士论文奖授予华盛顿大学Ashish Sharma，其研究聚焦AI辅助心理健康服务。论文提出三方面创新：1)开发强化学习系统提升在线互助志愿者的共情能力；2)通过大规模实验证明AI-人类协作能有效帮助认知重构；3)建立评估框架，发现当前AI治疗师表现更接近低质量人类治疗师（如过度建议）。另两位荣誉提名者分别研究受限计算模型的伪随机分布（Zander Kelley）和LLM数据应用范式重构（Sewon Min）。该奖项每年评选计算机领域顶尖博士论文，奖金2万美元。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T17:04:18Z
- **目录日期**: 2025-06-05
