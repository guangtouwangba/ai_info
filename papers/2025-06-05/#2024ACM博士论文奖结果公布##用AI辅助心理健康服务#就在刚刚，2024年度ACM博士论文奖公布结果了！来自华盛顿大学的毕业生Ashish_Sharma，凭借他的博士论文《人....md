...
2024年ACM博士论文奖由华盛顿大学的Ashish Sharma获得，其论文《人机协作支持心理健康与福祉》探索了AI如何提升心理健康服务。研究包括：1）开发强化学习系统提升志愿者同理心表达；2）通过AI辅助帮助用户克服消极思维；3）评估AI干预效果，发现当前AI治疗师行为更接近低质量人类治疗师。荣誉提名授予Alexander Kelley（伪随机分布研究）和Sewon Min（大语言模型数据应用）。该奖项每年表彰计算机领域顶尖博士论文，获奖者奖金2万美元，提名者共享1万美元。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T09:04:06Z
- **目录日期**: 2025-06-05
