...
这篇论文提出了一种新型多模态智能体架构OWMM-VLM，用于解决开放世界移动操作任务(OWMM)的挑战。该架构通过维护多视角场景帧和智能体状态进行决策，并采用函数调用控制机器人。针对领域偏移导致的幻觉问题，作者开发了数据合成流程对视觉语言模型(VLM)进行指令微调，使其具备全局场景理解、机器人状态跟踪和多模态动作生成能力。实验表明，该模型性能优于GPT-4o等基础模型，在真实场景中展现出强大的零样本泛化能力。项目页面已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T04:05:15Z
- **目录日期**: 2025-06-05
