...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟10,000+智能代理及其500万次社会互动。该系统通过四个社会实验（社会极化、信息传播、基本收入政策、自然灾害影响）验证了其有效性，模拟结果与现实研究数据高度吻合。研究表明，AgentSociety能够有效捕捉人类行为模式和社会机制，可作为计算社会科学研究的新工具，为社会科学研究和政策制定提供支持。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T13:14:56Z
- **目录日期**: 2025-06-05
