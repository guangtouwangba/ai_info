...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统，能够模拟1万多个代理及其500万次互动。研究者用它来研究社会极化、信息传播、基本收入政策和自然灾害影响等社会问题。实验结果与现实数据吻合，验证了该系统捕捉人类行为和社会机制的能力，展示了其作为社会科学研究和政策制定工具的潜力。该系统结合了语言模型、真实社会环境和大规模模拟引擎，为传统研究方法提供了补充。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T00:05:38Z
- **目录日期**: 2025-06-05
