...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万个AI代理及其500万次社会互动。研究者用它研究社会极化、信息传播、基本收入政策及自然灾害影响等社会问题，结果与现实数据吻合。该系统结合了生成式AI、真实社会环境和大规模模拟技术，为社会科学研究和政策制定提供了新工具，能有效补充传统研究方法（如调查、访谈），帮助理解人类行为模式和社会机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T14:05:52Z
- **目录日期**: 2025-06-05
