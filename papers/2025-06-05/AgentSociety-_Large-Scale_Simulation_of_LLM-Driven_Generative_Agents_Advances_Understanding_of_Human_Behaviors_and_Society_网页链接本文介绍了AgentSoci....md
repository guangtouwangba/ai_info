...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个智能代理及其500万次社会互动。该系统通过四个关键社会问题（社会极化、信息传播、基本收入政策、自然灾害影响）的实验，验证了其模拟结果与现实世界数据的高度吻合。研究表明，这种LLM驱动的模拟器能有效捕捉人类行为模式和社会机制，可作为计算社会科学研究和政策制定的创新工具，为传统研究方法（如调查、访谈）提供有力补充。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T17:05:40Z
- **目录日期**: 2025-06-05
