...
AgentSociety是一个基于大型语言模型的大规模社会模拟系统，能够模拟1万多个智能代理的社会生活及500万次互动。研究者利用该平台研究了四个关键社会问题：社会极化、刺激性信息传播、无条件基本收入政策影响和自然灾害（如飓风）冲击。模拟结果与现实世界数据高度吻合，验证了系统捕捉人类行为机制的能力。该系统可作为计算社会科学研究的新工具，为政策制定提供支持，补充传统研究方法（如调查和访谈）的不足，帮助深入理解社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T23:05:06Z
- **目录日期**: 2025-06-05
