...
这篇论文针对代码生成大模型(codeLLMs)提出新评估框架CodeArena，聚焦人类偏好对齐问题。研究收集397个涵盖40类任务和44种编程语言的真实样本，并构建20B标记的合成指令数据集SynCode-Instruct。实验发现传统执行基准与人类偏好评估存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究强调代码生成质量需兼顾功能正确性和人类可接受性，为改进代码LLMs提供了重要方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T03:26:54Z
- **目录日期**: 2025-06-05
