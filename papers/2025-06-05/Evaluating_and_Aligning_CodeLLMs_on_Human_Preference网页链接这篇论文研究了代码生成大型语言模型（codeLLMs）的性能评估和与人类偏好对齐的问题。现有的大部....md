...
这篇论文针对代码生成大模型(codeLLMs)与人类偏好对齐的问题，提出了CodeArena基准测试和SynCode-Instruct指令集。CodeArena包含397个涵盖40类任务和44种编程语言的真实样本，弥补了现有基准忽视人类偏好的缺陷。研究还构建了近200亿标记的合成指令数据集验证微调效果。实验显示执行基准与CodeArena存在性能差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)差距显著，凸显了人类偏好对齐的重要性。该研究为评估代码LLMs提供了更全面的框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T08:06:57Z
- **目录日期**: 2025-06-05
