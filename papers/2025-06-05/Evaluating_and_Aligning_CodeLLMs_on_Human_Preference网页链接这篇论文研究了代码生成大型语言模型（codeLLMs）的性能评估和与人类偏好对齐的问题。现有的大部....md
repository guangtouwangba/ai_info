...
这篇论文聚焦代码生成大模型(codeLLMs)与人类偏好的对齐问题，提出CodeArena基准测试(包含397个跨40类/44种编程语言的高质量样本)和SynCode-Instruct合成指令集(20B标记)。研究发现现有基于执行的评估与人类偏好存在偏差，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。通过构建更贴近实际编程场景的评估体系，论文揭示了代码生成模型在实用性和人类偏好匹配方面的关键挑战，强调需要超越传统正确性指标的综合评估方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T22:05:22Z
- **目录日期**: 2025-06-05
