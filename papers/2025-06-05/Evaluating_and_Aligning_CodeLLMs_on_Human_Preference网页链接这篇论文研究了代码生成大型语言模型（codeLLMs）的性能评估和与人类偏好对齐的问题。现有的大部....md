...
这篇论文针对代码生成大模型(codeLLMs)提出创新评估框架CodeArena，包含397个涵盖40类编程任务和44种语言的人类标注样本，弥补了现有基准忽视人类偏好的缺陷。研究同时构建20B标记的合成指令数据集SynCode-Instruct验证微调效果。实验发现执行基准与人类偏好评估存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，揭示了代码生成模型与人类偏好对齐的重要性。该研究为提升代码LLMs的实用价值提供了新评估维度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T01:33:30Z
- **目录日期**: 2025-06-05
