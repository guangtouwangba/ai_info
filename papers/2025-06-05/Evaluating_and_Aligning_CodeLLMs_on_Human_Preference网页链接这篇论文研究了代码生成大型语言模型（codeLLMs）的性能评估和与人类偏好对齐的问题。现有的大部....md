...
这篇论文针对代码生成大模型(codeLLMs)提出两个关键贡献：1) 创建CodeArena基准测试，包含397个涵盖40类编程任务和44种语言的人类偏好样本，弥补现有基准忽视人机对齐的不足；2) 构建20B标记的SynCode-Instruct合成指令集验证大规模微调效果。实验发现执行基准与人类偏好存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，凸显对齐人类偏好的重要性。研究强调需超越代码正确性，关注开发者实际需求来评估代码LLMs。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T02:35:50Z
- **目录日期**: 2025-06-05
