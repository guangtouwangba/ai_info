...
该论文综述了针对非小细胞肺癌(NSCLC)ALK基因双靶点抑制剂的最新研究进展。ALK基因是NSCLC的重要致癌驱动靶点，尽管已有7种ALK抑制剂获批，但耐药性问题仍然存在。相比联合用药，能同时作用于两个靶点的双靶点抑制剂具有减少副作用和毒性的优势。文章重点分析了这类抑制剂在NSCLC治疗中的发展现状，探讨了其合理设计及构效关系，为开发新型ALK抑制剂和克服耐药性提供了重要参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T23:04:50Z
- **目录日期**: 2025-06-05
