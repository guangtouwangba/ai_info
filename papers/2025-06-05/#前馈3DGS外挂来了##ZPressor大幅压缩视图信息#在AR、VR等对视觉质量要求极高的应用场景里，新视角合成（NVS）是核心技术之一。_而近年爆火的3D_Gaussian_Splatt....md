...
Monash大学与ZIP Lab团队开发了轻量模块ZPressor，用于优化前馈式3D Gaussian Splatting（3DGS）模型。该模块显著提升了3DGS在大量输入视图下的性能：PSNR提升4.65dB（36视图），推理时间减少70%，显存占用降低80%，并支持视图数量从8张扩展到近500张。ZPressor解决了现有3DGS模型在信息过载时出现的推理慢、显存爆炸和画质下降问题，适用于AR/VR等高质量视觉场景。论文、代码和项目已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T11:03:41Z
- **目录日期**: 2025-06-05
