...
Monash大学与ZIP Lab团队开发了轻量模块ZPressor，用于优化前馈式3D Gaussian Splatting（3DGS）模型。该技术解决了3DGS在多视图输入时出现的推理慢、显存爆炸和画质下降问题。ZPressor集成后显著提升了性能：在36张输入视图下PSNR提升4.65dB，推理时间减少70%，显存占用降低80%，并支持从8张扩展到近500张视图输入。这一突破使3DGS在AR/VR等高质量视觉应用中更高效实用。相关论文、代码和项目已公开。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T12:03:52Z
- **目录日期**: 2025-06-05
