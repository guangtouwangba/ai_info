...
这篇综述系统分析了基于大语言模型（LLM）的图形用户界面（GUI）智能代理的最新进展。研究梳理了现代GUI代理的四大核心组件：1）结合文本解析与多模态理解的感知系统；2）通过内部建模和历史经验构建的知识探索机制；3）采用高级推理的任务规划框架；4）具备安全控制的交互系统。文章揭示了LLM和多模态学习如何革新跨平台GUI自动化，同时指出当前评估方法的局限性，并提出了标准化方向。研究还探讨了元素定位、知识检索、长期规划和执行安全等关键技术挑战，为未来智能界面自动化发展提供了方向指引。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T13:11:55Z
- **目录日期**: 2025-06-05
