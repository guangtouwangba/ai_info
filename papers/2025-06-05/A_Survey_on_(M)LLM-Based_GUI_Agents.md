...
本文综述了基于大语言模型（LLM）的图形用户界面（GUI）代理的最新进展。GUI代理已从基于规则的脚本发展为能理解并执行复杂界面操作的AI系统。研究系统分析了其四大核心组件：1)结合文本解析和多模态理解的感知系统；2)通过内部建模和历史经验构建知识库的探索机制；3)利用高级推理的任务规划框架；4)具有安全控制的交互系统。文章探讨了LLM和多模态学习如何革新桌面、移动和网页平台的GUI自动化，同时指出当前评估框架的局限性，并提出了元素定位、知识检索、长期规划和执行安全等关键挑战及未来研究方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T22:02:15Z
- **目录日期**: 2025-06-05
