...
本文综述了基于大语言模型（LLM）的图形用户界面（GUI）智能体的最新进展，系统分析了其四大核心组件：1）结合文本解析和多模态理解的感知系统；2）通过内部建模和历史经验构建的知识探索机制；3）利用高级推理的任务规划框架；4）具备安全控制的交互系统。研究揭示了LLM和多模态学习如何革新桌面、移动和网页平台的自动化操作，同时指出了当前评估框架的局限性。文章还探讨了元素定位、知识检索、长期规划和执行安全等关键技术挑战，为智能界面自动化的未来发展提供了方向性建议。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T11:02:44Z
- **目录日期**: 2025-06-05
