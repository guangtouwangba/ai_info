...
本文综述了基于大语言模型（LLM）的图形用户界面（GUI）智能体研究进展。这类智能体通过四大核心组件实现复杂界面操作：1）结合文本解析与多模态理解的感知系统；2）通过内部建模和历史经验构建的知识库；3）运用高级推理的任务规划框架；4）具备安全控制的交互系统。研究揭示了LLM和多模态学习如何革新桌面/移动/网页平台的自动化操作，同时指出当前评估体系的局限性。关键挑战包括元素精确定位、知识检索、长程规划和执行安全控制，为未来智能界面自动化发展指明了方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T05:02:55Z
- **目录日期**: 2025-06-05
