...
这篇论文提出了TracLLM框架，旨在解决长上下文大语言模型(LLM)的"上下文回溯"问题，即识别生成输出所依赖的具体文本片段。该框架通过改进现有特征归因方法(如Shapley)，结合启发式搜索算法和贡献分数集成/去噪技术，提高了回溯的效率和准确性。TracLLM在调试LLM系统、攻击取证分析和增强用户信任等方面具有应用价值。实验表明，它能有效识别长上下文中影响LLM输出的关键文本。代码和数据已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T11:01:29Z
- **目录日期**: 2025-06-05
