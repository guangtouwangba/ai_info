...
这篇论文提出了TracLLM框架，旨在解决长上下文大语言模型(LLM)的"上下文回溯"问题，即识别影响模型输出的关键文本片段。该框架通过改进现有特征归因方法(如Shapley)，开发了基于启发式搜索的算法提高效率，并采用贡献分数集成/去噪技术提升准确性。TracLLM在调试LLM系统、攻击取证分析和增强用户信任等方面具有应用价值。实验表明，它能有效识别长上下文中导致LLM输出的关键文本。代码和数据已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T15:01:28Z
- **目录日期**: 2025-06-05
