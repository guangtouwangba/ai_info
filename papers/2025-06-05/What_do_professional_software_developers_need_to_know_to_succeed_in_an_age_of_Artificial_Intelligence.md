...
研究表明，生成式AI能提升开发者效率，但也引发对职业替代和技能退化的担忧。一项针对21名前沿AI开发者研究总结了12个工作目标、75项任务及所需技能，揭示了AI在工作中的实际应用。研究发现，成功运用AI的开发者需掌握四大领域技能：高效使用生成式AI、核心软件工程、相关工程及非工程技能，并应用于六步任务流程中。为应对AI时代挑战，职业培训和计算机科学教育需兼顾软技能与四大领域技术能力，以提升开发者竞争力并防止技能退化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T19:01:54Z
- **目录日期**: 2025-06-05
