...
这篇论文探讨了利用大语言模型(LLMs)设计宣传检测工具的方法。研究承认AI模型存在固有偏见(尤其在政治领域)，但提出这些偏见可被用来增强新闻阅读中的批判性思维。与传统观点不同，该研究将AI偏见视为可利用因素，结合确认偏误和认知失调等心理学概念，提出了基于用户政治立场的个性化选择策略。通过定性用户研究，论文为宣传检测AI工具提出了三项设计建议：偏见意识、个性化选择、以及逐步引入多元观点。研究为处理AI偏见提供了创新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T14:02:39Z
- **目录日期**: 2025-06-05
