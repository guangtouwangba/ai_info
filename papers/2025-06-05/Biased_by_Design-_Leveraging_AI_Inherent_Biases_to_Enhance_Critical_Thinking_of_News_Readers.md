...
这篇论文探讨了利用大语言模型(LLMs)设计宣传检测工具的方法。研究承认AI模型(特别是政治语境中)存在固有偏见，但探索了如何利用这些偏见来增强新闻阅读中的批判性思维。不同于通常认为AI偏见有害的观点，该研究提出了基于用户政治立场的个性化选择策略，应用了确认偏误和认知失调等心理学概念。通过定性用户研究，论文为宣传检测AI工具提出了设计建议：提高偏见意识、提供个性化选择、逐步引入多元观点。研究展示了如何将AI偏见转化为促进批判性思维的工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T10:02:09Z
- **目录日期**: 2025-06-05
