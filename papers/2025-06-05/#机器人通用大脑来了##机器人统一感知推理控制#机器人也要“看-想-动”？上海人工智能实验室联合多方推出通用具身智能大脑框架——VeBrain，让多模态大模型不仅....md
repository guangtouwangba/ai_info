...
上海人工智能实验室推出通用具身智能框架VeBrain，将机器人控制转化为语言建模问题，通过"关键点检测+技能识别"双任务机制统一感知、推理与控制。其核心是60万条指令级数据集VeBrain-600k，支持多模态理解、空间推理和精准操作。测试显示，VeBrain在多模态理解媲美Qwen2.5-VL，空间推理超越GPT-4o，机器人控制显著优于同类模型，在四足机器人和机械臂上均展现强泛化能力。该技术突破为实现"像人一样思考和行动"的具身智能迈出关键一步。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T21:04:09Z
- **目录日期**: 2025-06-05
