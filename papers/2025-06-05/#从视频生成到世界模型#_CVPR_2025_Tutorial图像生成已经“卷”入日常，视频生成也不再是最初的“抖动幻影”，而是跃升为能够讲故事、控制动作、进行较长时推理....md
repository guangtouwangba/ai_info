# #从视频生成到世界模型# CVPR 2025 Tutorial图像生成已经“卷”入日常，视频生成也不再是最初的“抖动幻影”，而是跃升为能够讲故事、控制动作、进行较长时推理...
...
CVPR 2025教程《从视频生成到世界模型》将探讨视频生成技术的最新进展及其向世界模型演化的潜力。当前视频生成已从简单动态内容发展为具备叙事能力、动作控制和长时推理的高质量输出（如Sora、Genie等模型）。教程聚焦三个核心问题：视频生成能否成为世界模型的桥梁？能否发展为可交互的智能中枢？如何支撑具身智能？来自学界和业界的专家将分享生成建模、3D理解、强化学习等领域成果，探索如何通过视频生成实现感知-建模-推理-决策一体化的智能系统。会议将于2025年6月11日在美国纳什维尔举行。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T23:03:06Z
- **目录日期**: 2025-06-05
