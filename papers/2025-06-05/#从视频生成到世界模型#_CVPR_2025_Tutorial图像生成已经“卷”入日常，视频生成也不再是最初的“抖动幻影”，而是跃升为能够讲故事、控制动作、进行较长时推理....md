...
CVPR 2025将举办主题为"从视频生成到世界模型"的教程，探讨视频生成技术如何发展为具备交互和推理能力的智能世界模型。随着可灵、Sora等模型的突破，视频生成已从简单动态内容提升到能控制动作、进行长时推理的阶段。该教程将聚集学术界和产业界专家，讨论如何利用视频生成作为视觉先验，赋能AI感知世界、理解交互和物理推理，最终构建支持具身智能的世界模型。活动将于2025年6月11日在美国纳什维尔举行，涵盖生成建模、3D理解、强化学习等方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T10:02:53Z
- **目录日期**: 2025-06-05
