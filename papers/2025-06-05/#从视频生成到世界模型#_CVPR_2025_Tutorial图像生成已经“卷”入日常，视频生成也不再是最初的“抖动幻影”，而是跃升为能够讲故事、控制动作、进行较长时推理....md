...
CVPR 2025将举办《从视频生成到世界模型》教程，探讨视频生成技术如何从简单的动态内容升级为具备时空一致性、物理因果推理能力的世界模型构建工具。教程聚焦视频生成模型（如Sora、Genie等）在具身智能、交互决策等领域的潜力，研究其能否成为理解世界、预测物理交互的智能基座。来自学界和业界的专家将分享生成建模、3D理解、强化学习等前沿进展，探索视频生成向可交互世界模型的转化路径。活动将于2025年6月11日在美国纳什维尔举行，官网和开源资料已公开。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T11:03:20Z
- **目录日期**: 2025-06-05
