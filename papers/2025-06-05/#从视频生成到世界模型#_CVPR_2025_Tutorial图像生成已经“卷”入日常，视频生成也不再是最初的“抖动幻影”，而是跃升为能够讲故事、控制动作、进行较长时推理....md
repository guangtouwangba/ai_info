...
CVPR 2025将举办"从视频生成到世界模型"专题教程，探讨视频生成技术如何发展为可交互、可推理的世界模型。随着可灵、Sora等模型的突破，视频生成已从简单动态内容升级为具备时空一致性、物理因果推理能力的高质量输出。该教程汇聚学界和业界专家，重点讨论：1）视频生成作为视觉先验如何赋能AI感知与推理；2）从生成模型到交互式世界模型的转化路径；3）在具身智能中的应用潜力。活动将于2025年6月11日在美国纳什维尔举行，涵盖生成建模、3D理解、强化学习等前沿方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T20:02:54Z
- **目录日期**: 2025-06-05
