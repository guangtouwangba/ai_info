...
CVPR 2025教程《从视频生成到世界模型》将探讨视频生成技术如何发展为具备时空一致性、物理推理和交互能力的智能系统。随着可灵、Sora等模型的突破，研究者关注视频生成能否成为构建可交互、可推理的世界模型的关键路径，并支撑具身智能发展。教程汇聚学术界和产业界专家，从生成建模、3D理解、强化学习等角度，探讨如何将视频生成转化为感知-决策一体化的智能基座。会议将于2025年6月11日在美国纳什维尔举行，官网和GitHub已开放相关资料。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T13:12:33Z
- **目录日期**: 2025-06-05
