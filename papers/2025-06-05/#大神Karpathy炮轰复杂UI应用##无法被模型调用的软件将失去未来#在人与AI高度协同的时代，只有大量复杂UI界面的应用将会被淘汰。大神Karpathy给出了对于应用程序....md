...
AI专家Karpathy提出，在AI协同时代，仅依赖复杂UI界面的软件（如Adobe、CAD）将面临淘汰风险，因其缺乏文本交互能力，难以实现"氛围式编程"。他根据UI/文本比例将应用划分为四个风险等级，引发热议。支持者认为封闭UI阻碍AI整合，反对者则强调专业软件的特殊性。核心争议在于：UI是否应基于文本交互构建，以及AI应适应人类还是反之。双方共识是需建立更规范的软件框架以实现人机协作。这场辩论揭示了AI时代软件设计的转型压力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T23:03:47Z
- **目录日期**: 2025-06-05
