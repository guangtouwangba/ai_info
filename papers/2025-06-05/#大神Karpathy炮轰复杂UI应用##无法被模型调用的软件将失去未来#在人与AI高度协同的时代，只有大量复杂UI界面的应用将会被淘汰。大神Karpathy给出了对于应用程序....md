...
AI专家Karpathy提出，在AI协同时代，仅依赖复杂UI界面而缺乏文本交互能力的软件（如Adobe、CAD）将面临淘汰风险。他认为软件需要支持"氛围式编程"，通过文本接口实现人机协作，并划分了不同软件的风险等级。支持者认为封闭UI会阻碍AI整合，反对者则强调专业软件的特殊性。争议焦点在于：是让AI适应人类操作方式，还是软件需要适配AI交互。双方共识是需建立更规范的交互框架。该观点引发对UI未来价值的广泛讨论。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T16:03:47Z
- **目录日期**: 2025-06-05
