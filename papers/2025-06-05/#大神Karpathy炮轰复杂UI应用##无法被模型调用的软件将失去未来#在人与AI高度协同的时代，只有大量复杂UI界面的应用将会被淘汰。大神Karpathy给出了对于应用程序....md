...
AI专家Karpathy提出，在AI协同时代，仅依赖复杂UI界面的软件（如Adobe、CAD）将面临淘汰风险，因其缺乏文本交互能力难以实现人机高效协作。他将应用按UI/文本比例分为四个风险等级，认为应建立UI与文本的转换机制。支持者赞同软件需开放API以适应AI浪潮，反对者则指出专业软件（如Photoshop）的特殊性，认为AI应适应人类操作方式。争议焦点在于如何平衡可视化交互与AI兼容性，但共识是需要更规范的软件框架来实现人机协作。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T19:03:23Z
- **目录日期**: 2025-06-05
