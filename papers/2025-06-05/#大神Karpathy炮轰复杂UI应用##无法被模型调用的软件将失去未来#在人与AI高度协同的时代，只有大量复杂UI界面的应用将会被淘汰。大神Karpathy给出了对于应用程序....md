...
AI专家Karpathy提出，在AI协同时代，仅依赖复杂UI界面而缺乏文本交互能力的软件（如Adobe、CAD）将面临淘汰风险。他认为软件需要支持"氛围式编程"，使AI能通过文本指令调用功能。Karpathy将常见软件按UI/文本比例划分为四个风险等级，引发热议。支持者认为封闭UI会阻碍AI整合，反对者则强调专业软件的特殊性。讨论核心在于：未来软件需在可视化操作与文本接口间建立转换机制，同时需要标准化框架来实现人机高效协作。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T09:03:55Z
- **目录日期**: 2025-06-05
