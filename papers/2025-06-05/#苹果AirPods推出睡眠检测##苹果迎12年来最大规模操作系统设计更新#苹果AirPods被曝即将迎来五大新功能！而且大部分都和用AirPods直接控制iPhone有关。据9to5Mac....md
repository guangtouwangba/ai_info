...
苹果AirPods将在WWDC25大会上推出五大新功能，包括：通过耳机控制iPhone相机、睡眠自动暂停、头部动作控制、录音室级麦克风模式，以及教室场景下快速连接iPad。同时，苹果操作系统将迎来iOS7以来最大规模的设计更新。这些升级引发广泛期待，WWDC25大会将于北京时间6月10日凌晨1点举行。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T13:13:07Z
- **目录日期**: 2025-06-05
