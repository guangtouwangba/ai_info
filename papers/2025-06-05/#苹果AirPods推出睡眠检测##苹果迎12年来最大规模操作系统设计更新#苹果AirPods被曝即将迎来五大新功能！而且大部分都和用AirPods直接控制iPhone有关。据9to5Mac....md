...
苹果AirPods将在WWDC25大会上推出五大新功能：1）用耳机控制iPhone相机；2）睡眠自动暂停检测；3）头部动作控制；4）"录音室品质"麦克风模式；5）教室场景快速连接iPad。同时，iOS系统将迎来12年来最大设计更新。这些升级引发广泛期待，WWDC25大会将于6月10日凌晨1点举行。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T12:04:01Z
- **目录日期**: 2025-06-05
