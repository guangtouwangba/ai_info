# #苹果AirPods推出睡眠检测##苹果迎12年来最大规模操作系统设计更新#苹果AirPods被曝即将迎来五大新功能！而且大部分都和用AirPods直接控制iPhone有关。据9to5Mac...
...
苹果将在WWDC25大会上为AirPods推出五大新功能：1）通过耳机控制iPhone相机；2）睡眠自动暂停检测；3）头部动作控制；4）"录音室品质"麦克风模式；5）教室场景快速连接iPad。同时，iOS系统将迎来12年来最大设计更新，这是自iOS 7后首次全面改版。这些升级显著提升了用户对AirPods的期待值，发布会将于北京时间6月10日凌晨1点举行。（98字）  

注：摘要聚焦核心更新内容（5项硬件功能+1项系统设计），省略图片描述和次要信息，严格控制在100字内。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T23:03:37Z
- **目录日期**: 2025-06-05
