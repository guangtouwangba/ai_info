...
研究人员提出了一种名为"链式越狱"(CoJ)的新型攻击方法，可逐步绕过Stable Diffusion、DALL-E 3等文本生成图像模型的安全防护。该方法将恶意查询分解为多个子查询，通过迭代编辑图像实现越狱。实验表明，CoJ对GPT-4V、Gemini等主流模型的攻击成功率超过60%，远超传统方法(14%)。为应对此威胁，研究团队还开发了"三思提示"防御技术，可成功拦截95%以上的CoJ攻击。相关数据集CoJ-Bench涵盖9种安全场景和3类编辑操作，已开源以促进AI安全研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T00:02:50Z
- **目录日期**: 2025-06-05
