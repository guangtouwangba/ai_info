...
Quarkdown是一款基于Markdown的轻量化排版工具，兼具简洁与灵活性。它支持函数化书写、变量定义及逻辑控制，可导出HTML/PDF/幻灯片等多种格式。相比LaTeX，其语法更清爽、生成更快且支持实时预览，同时提供可扩展的标准库（含数学/布局等模块）。适用于论文、电子书、技术文档等场景，全程使用Markdown语法实现复杂排版。项目地址：github.com/iamgio/quarkdown。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T02:33:28Z
- **目录日期**: 2025-06-05
