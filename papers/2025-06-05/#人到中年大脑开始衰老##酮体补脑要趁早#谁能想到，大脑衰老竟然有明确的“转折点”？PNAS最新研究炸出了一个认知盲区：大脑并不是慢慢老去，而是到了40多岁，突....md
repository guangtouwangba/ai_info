...
PNAS最新研究发现，人类大脑在43岁左右开始出现衰老转折点，60岁后加速退化，主要原因是神经元出现胰岛素抵抗，无法有效利用葡萄糖供能。研究通过分析2万人的脑影像数据发现，酮体（D-βHB）可作为替代能源，在40-59岁人群中能显著改善脑功能，但对60岁以上效果有限。机制研究表明，酮体可绕过胰岛素通路直接为脑细胞供能。该发现提示中年是干预大脑衰老的关键窗口期，通过调整能量供给方式可能延缓认知衰退。研究采用7T fMRI技术验证了这一结论。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T19:02:59Z
- **目录日期**: 2025-06-05
