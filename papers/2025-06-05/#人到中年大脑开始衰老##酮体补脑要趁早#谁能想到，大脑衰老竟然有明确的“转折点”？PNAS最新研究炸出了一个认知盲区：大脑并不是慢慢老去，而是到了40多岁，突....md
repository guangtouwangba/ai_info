...
PNAS最新研究揭示，大脑衰老存在关键转折点：40多岁（约43岁）开始出现脑网络不稳定，60岁后加速衰退，主要原因是神经元胰岛素抵抗导致葡萄糖利用障碍。研究发现酮体（D-βHB）可作为替代能源，在40-59岁人群中显著改善脑功能，但对60岁以上效果有限。机制表明酮体能绕过胰岛素通路直接供能。研究提示中年是干预窗口期，通过调整能量供给方式或可延缓认知衰退。该研究基于近2万人的脑影像数据和7T fMRI技术验证。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T20:03:05Z
- **目录日期**: 2025-06-05
