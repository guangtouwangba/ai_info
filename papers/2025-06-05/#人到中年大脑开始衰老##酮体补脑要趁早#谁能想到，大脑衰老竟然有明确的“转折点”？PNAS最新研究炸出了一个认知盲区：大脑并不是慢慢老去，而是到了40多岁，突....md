...
PNAS最新研究发现大脑衰老存在关键转折点：40多岁开始衰退，60岁加速恶化。研究分析近2万人脑影像数据，发现神经元胰岛素抵抗导致脑细胞无法有效利用葡萄糖是主因。实验显示，补充酮体(D-βHB)能显著改善40-59岁人群脑功能，但对60岁以上效果有限。机制研究表明酮体可绕过胰岛素通路为脑细胞供能。7T fMRI扫描证实这一发现，提示中年期是干预大脑衰老的关键窗口期。该研究为预防认知衰退提供了新思路，强调早期调整能量供给方式的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T14:03:32Z
- **目录日期**: 2025-06-05
