...
PNAS最新研究发现大脑衰老存在关键转折点：40多岁（43岁左右）脑网络开始不稳定，60岁后加速衰退，主要原因是神经元出现胰岛素抵抗，无法有效利用葡萄糖。研究通过分析近2万人脑影像数据发现，酮体（D-βHB）可作为替代能源，在40-59岁人群中显著改善脑功能，但对60岁以上效果有限。机制研究表明，酮体可绕过胰岛素通路直接供能。该发现提示中年是干预脑衰老的关键窗口期，通过调整能量供给方式（如补充酮体）可能延缓认知衰退。研究采用7T fMRI技术验证。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T13:12:43Z
- **目录日期**: 2025-06-05
