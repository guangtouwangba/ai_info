...
PNAS最新研究发现，大脑衰老存在关键转折点：40岁后脑网络开始不稳定，60岁加速衰退，主要原因是神经元胰岛素抵抗导致葡萄糖利用障碍。研究通过分析2万人脑影像数据发现，酮体（D-βHB）可替代葡萄糖为脑细胞供能，在40-59岁人群中显著改善脑功能，但对60岁以上效果有限。机制研究表明，酮体能绕过胰岛素通路直接供能。该发现提示中年是干预大脑衰老的关键窗口期，及早调整能量供给方式可能延缓认知衰退。研究采用7T fMRI技术验证了脑网络稳定性与能量代谢的关系。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T11:03:30Z
- **目录日期**: 2025-06-05
