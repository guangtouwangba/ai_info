...
PNAS最新研究表明，大脑衰老存在关键转折点：43岁左右脑网络开始不稳定，60岁后加速衰退，主要因神经元出现胰岛素抵抗，无法有效利用葡萄糖供能。研究发现酮体（D-βHB）可作为替代能源，对40-59岁人群显著改善脑功能，但60岁以上效果减弱。机制显示酮体能绕过胰岛素通路直接供能，7T fMRI扫描证实其稳定神经网络的作用。该研究提示中年是干预脑衰老的关键窗口期，及早调整能量供给方式可能延缓认知衰退。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T12:03:42Z
- **目录日期**: 2025-06-05
