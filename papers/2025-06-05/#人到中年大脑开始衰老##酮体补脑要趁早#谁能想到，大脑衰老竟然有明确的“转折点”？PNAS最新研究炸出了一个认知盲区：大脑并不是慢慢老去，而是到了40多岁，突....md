...
PNAS最新研究分析了近2万人的脑影像数据，发现大脑衰老存在关键转折点：43岁左右脑网络开始不稳定，60岁后加速衰退。主要原因是神经元出现胰岛素抵抗，无法有效利用葡萄糖供能。研究发现酮体（D-βHB）可作为替代能源，在40-59岁人群中显著改善脑功能，但对60岁以上效果有限。机制研究表明，酮体可绕过胰岛素通路直接为神经元供能。该发现提示中年时期可能是干预大脑衰老的关键窗口期，通过调整能量供给方式或可延缓认知衰退。研究采用7T fMRI技术验证了这一结论。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T22:02:57Z
- **目录日期**: 2025-06-05
