...
PNAS最新研究揭示，大脑衰老存在关键转折点：43岁左右脑网络开始不稳定，60岁加速衰退，主因是神经元胰岛素抵抗导致葡萄糖利用障碍。研究发现酮体（D-βHB）可作为替代能源，对40-59岁人群显著改善脑功能，但对60岁以上效果有限。机制表明酮体可绕过胰岛素通路直接供能，7T fMRI扫描证实其稳定神经网络的作用。该研究提示中年是干预认知衰退的关键窗口期，需及早调整脑能量供给方式。论文链接：www.pnas.org/doi/10.1073/pnas.2416433122（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T21:03:06Z
- **目录日期**: 2025-06-05
