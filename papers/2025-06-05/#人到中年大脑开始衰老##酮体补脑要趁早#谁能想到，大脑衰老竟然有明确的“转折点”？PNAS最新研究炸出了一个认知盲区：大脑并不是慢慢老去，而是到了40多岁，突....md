...
PNAS最新研究发现，大脑衰老存在关键转折点：40多岁开始明显衰退，60岁后加速恶化。研究分析近2万人的脑影像数据，发现神经元胰岛素抵抗导致葡萄糖代谢障碍是主因。实验显示，补充酮体（D-βHB）能显著改善40-59岁人群的脑功能，但对60岁以上效果有限。机制研究表明，酮体可绕过胰岛素通路为脑细胞供能。该发现提示，中年阶段是干预大脑衰老的关键窗口期，及早调整能量供给方式可能延缓认知衰退。研究采用7T fMRI技术验证了脑网络稳定性变化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T17:03:35Z
- **目录日期**: 2025-06-05
