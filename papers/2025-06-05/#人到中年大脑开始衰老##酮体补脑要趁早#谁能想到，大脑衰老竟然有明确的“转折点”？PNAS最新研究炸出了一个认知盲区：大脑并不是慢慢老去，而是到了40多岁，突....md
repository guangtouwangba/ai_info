...
根据PNAS最新研究，大脑衰老存在明确转折点：40多岁开始衰退，60岁加速恶化。研究发现神经元胰岛素抵抗导致脑细胞无法有效利用葡萄糖，而酮体（D-βHB）可作为替代能源。实验显示，40-59岁人群补充酮体后脑功能显著改善，但60岁以上效果减弱。关键机制在于酮体绕过胰岛素通路直接供能。研究提示中年是干预窗口期，通过调整能量供给方式可能延缓认知衰退。该发现挑战了"老年痴呆不可逆"的传统认知，强调早期干预的重要性。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T10:03:03Z
- **目录日期**: 2025-06-05
