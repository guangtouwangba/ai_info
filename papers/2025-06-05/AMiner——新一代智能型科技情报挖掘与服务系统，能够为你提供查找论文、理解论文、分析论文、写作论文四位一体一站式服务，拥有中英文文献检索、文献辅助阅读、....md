...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、辅助阅读、翻译等功能。它收录了3.5亿论文、0.6亿学者等海量数据，支持互动问答和自动摘要生成，帮助用户高效筛选和理解文献。此外，AMiner还提供科研情报订阅服务，根据用户偏好推送最新学术动态，并具备学者画像、会议追踪等特色功能。平台可免费使用，旨在提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T04:09:41Z
- **目录日期**: 2025-06-05
