...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、科研订阅等一站式服务。其核心功能包括：1）精准检索3.5亿论文资源，支持智能问答和自动摘要生成；2）AI辅助阅读，可解析上传的PDF文献并生成章节概要；3）个性化科研动态推送，通过微信/邮件定期发送最新成果。平台还包含学者画像、学术会议等特色功能，基础服务免费开放。网址：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T12:06:24Z
- **目录日期**: 2025-06-05
