...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、辅助阅读、自动摘要生成、翻译和问答功能。它覆盖42个学科的3.5亿论文、0.6亿学者和1.5亿专利，支持用户上传PDF或直接检索文献，通过AI生成摘要和章节概要。平台还提供个性化科研动态订阅服务，根据用户关注的学者、机构或关键词推送最新论文。此外，AMiner包含学者画像、学术会议和论文排行榜等功能，基础服务免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T00:06:15Z
- **目录日期**: 2025-06-05
