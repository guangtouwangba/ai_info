...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索（覆盖42个学科3.5亿论文）、AI辅助阅读（自动生成摘要/章节概要）、文档翻译及智能问答功能。支持用户上传PDF或从数据库筛选文献，通过对话深入解析内容。特色功能包括个性化科研情报订阅（按学者/关键词推送最新成果）、学者画像分析及学术会议追踪。平台免费开放基础检索服务，可通过网页或微信小程序使用，显著提升文献调研和论文写作效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T01:33:15Z
- **目录日期**: 2025-06-05
