...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、科研订阅等一站式服务。其核心功能包括：1）高效检索3.5亿论文资源，支持互动问答和自动摘要生成；2）AI辅助阅读，可解析PDF并生成章节概要和问题建议；3）个性化科研动态推送，通过微信/邮件定期发送定制化情报。平台还涵盖学者画像、学术会议等特色功能，基础服务免费开放。收录42个学科的海量学术数据（论文/专利/项目），显著提升文献调研和论文写作效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T08:06:46Z
- **目录日期**: 2025-06-05
