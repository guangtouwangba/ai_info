...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、辅助阅读和科研订阅等服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持AI生成摘要、章节概要和互动问答，帮助用户快速理解文献。用户可定制科研动态推送，跟踪机构、学者或关键词的最新研究。平台还提供学者画像、学术会议等特色功能，基础服务免费使用，旨在提升学术研究效率。访问链接：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T16:05:38Z
- **目录日期**: 2025-06-05
