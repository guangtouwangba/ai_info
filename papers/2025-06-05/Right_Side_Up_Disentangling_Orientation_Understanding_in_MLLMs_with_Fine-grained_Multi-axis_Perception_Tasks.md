...
DORI是一个专门评估视觉语言模型物体方向感知能力的基准测试，包含四个维度：正面对齐、旋转变换、相对方向关系和标准方向理解。基于11个数据集的67类物体测试发现，现有最优模型在粗粒度任务中准确率仅54.2%，细粒度判断降至33.0%，且在处理参考系转换和复合旋转时表现更差。研究表明当前模型缺乏精确角度估计、视角变化追踪和复合旋转理解能力，揭示了其内部3D空间表征的局限性。DORI为改进机器人控制、3D场景重建和人机交互提供了诊断工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T19:02:03Z
- **目录日期**: 2025-06-05
