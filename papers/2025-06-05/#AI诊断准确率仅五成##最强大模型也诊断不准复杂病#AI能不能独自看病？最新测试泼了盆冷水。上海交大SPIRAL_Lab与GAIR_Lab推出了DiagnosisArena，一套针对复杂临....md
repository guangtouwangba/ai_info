...
上海交大团队推出DiagnosisArena评测集，测试AI在复杂临床诊断中的表现。该评测基于权威医学期刊的1113道高难度题目，涵盖28个科室。结果显示，最强模型GPT-4o准确率仅51.12%，其他模型表现更差。开放问答模式下，部分模型暴露了缺乏真正医学推理能力的缺陷，表明当前AI尚无法像医生一样思考。这项研究揭示了AI在独立诊疗方面的局限性，尤其在复杂病例诊断中仍有较大提升空间。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T01:30:53Z
- **目录日期**: 2025-06-05
