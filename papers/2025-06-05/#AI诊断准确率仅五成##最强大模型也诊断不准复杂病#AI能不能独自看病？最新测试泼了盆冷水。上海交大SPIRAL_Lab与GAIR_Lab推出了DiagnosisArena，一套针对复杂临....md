...
上海交大研究团队推出DiagnosisArena评测集，测试AI在复杂临床诊断中的表现。该评测集基于权威医学期刊的1113道高难度病例题，涵盖28个科室，并排除了模型可能记忆的题目。测试结果显示，即使最强的GPT-4o模型准确率也仅为51.12%，其他模型表现更差。开放问答模式下，模型表现进一步下降，表明当前AI尚不具备"像医生一样思考"的能力，无法独立完成复杂疾病的准确诊断。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-05T03:25:05Z
- **目录日期**: 2025-06-05
