...
斯坦福研究团队意外发现AI生成的CUDA内核性能超越人类专家优化版本，在深度学习操作中表现亮眼：矩阵乘法达PyTorch的101.3%，二维卷积179.9%，层归一化提升484.4%。该方法通过语言推理步骤增强搜索多样性，而非传统逐步优化。原本旨在生成训练数据的测试阶段，意外产出了高性能内核。这一突破可能重塑内核优化领域，展现AI在底层计算优化中的潜力。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T22:02:38Z
- **目录日期**: 2025-05-31
