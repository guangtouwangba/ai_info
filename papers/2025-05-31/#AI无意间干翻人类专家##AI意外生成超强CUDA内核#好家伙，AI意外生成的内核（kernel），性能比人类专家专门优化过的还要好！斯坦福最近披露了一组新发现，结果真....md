...
斯坦福研究团队意外发现AI生成的CUDA内核性能超越人类专家优化版本。在深度学习常见操作中，AI优化内核比PyTorch原生实现提升101%-484%，其中层归一化(LayerNorm)性能提升近5倍。该方法在测试阶段通过合成数据自动生成高效内核，并引入"语言推理"步骤增强搜索多样性。这一突破性进展表明AI可能重塑底层代码优化领域，意外展现出替代传统内核工程师的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T12:02:51Z
- **目录日期**: 2025-05-31
