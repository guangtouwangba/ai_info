...
斯坦福研究团队意外发现AI生成的CUDA内核性能超越人类专家优化结果。测试显示，AI优化的内核在矩阵乘法、卷积等深度学习操作上表现突出，性能最高提升近400%（如层归一化达PyTorch的484.4%）。该突破源于训练内核生成模型时，测试阶段的合成数据意外产生高性能内核。方法创新在于迭代间加入语言推理步骤，通过"思考"式搜索提升多样性。这一发现可能颠覆传统内核优化模式，引发对AI替代专业工程师的讨论。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T10:02:36Z
- **目录日期**: 2025-05-31
