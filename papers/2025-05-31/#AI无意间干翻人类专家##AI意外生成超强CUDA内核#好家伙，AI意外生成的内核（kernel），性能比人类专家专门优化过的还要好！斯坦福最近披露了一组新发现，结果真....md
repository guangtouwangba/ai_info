...
斯坦福大学研究团队意外发现，AI自动生成的CUDA内核性能远超人类专家优化版本，在常见深度学习操作上实现显著提升。其中层归一化性能达PyTorch的484.4%，卷积组合操作提升290.1%。该突破源于测试阶段生成的合成数据意外产生高性能内核。研究方法创新性地在优化过程中加入"语言推理"步骤，通过多样化搜索获得更优解。这一发现展示了AI在代码优化领域的潜力，可能改变传统内核开发模式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T21:02:49Z
- **目录日期**: 2025-05-31
