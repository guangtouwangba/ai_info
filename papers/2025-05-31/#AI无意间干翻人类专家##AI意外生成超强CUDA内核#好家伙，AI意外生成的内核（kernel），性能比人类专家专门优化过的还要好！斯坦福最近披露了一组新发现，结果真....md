...
斯坦福研究团队意外发现AI生成的CUDA内核性能超越人类专家优化版本，在多项深度学习操作中表现亮眼：矩阵乘法达PyTorch的101.3%，二维卷积达179.9%，层归一化性能提升近5倍。该方法通过语言推理步骤增强搜索多样性，使AI在测试阶段生成的合成数据直接产出优质内核。这一突破性进展显示AI可能重塑高性能计算优化领域，相关技术细节已由华人主创团队公开。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T20:02:56Z
- **目录日期**: 2025-05-31
