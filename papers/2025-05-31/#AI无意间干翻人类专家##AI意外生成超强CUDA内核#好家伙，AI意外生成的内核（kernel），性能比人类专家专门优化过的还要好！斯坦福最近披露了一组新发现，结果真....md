...
斯坦福研究团队意外发现，AI生成的CUDA内核性能远超人类专家优化版本。在深度学习常见操作中，AI内核比原生PyTorch性能提升101%-484%，其中层归一化(LayerNorm)提升近5倍。该突破源于训练内核生成模型时，测试阶段产生的合成数据意外生成了高性能内核。方法创新在于迭代间加入语言推理步骤，通过"思考"式搜索获得更优解。这一发现可能颠覆传统内核优化方式，引发对AI取代内核工程师的讨论。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T14:03:07Z
- **目录日期**: 2025-05-31
