...
斯坦福研究团队意外发现AI生成的CUDA内核性能远超人类专家优化版本。在深度学习常见操作中，AI优化内核性能提升显著：矩阵乘法达PyTorch的101.3%，二维卷积达179.9%，层归一化更是达到484.4%。这一突破源于团队在训练内核生成模型时，发现测试阶段生成的合成数据本身就能产生高性能内核。方法创新在于每次迭代间加入语言推理步骤，通过"思考"式搜索实现多样化优化。该成果显示AI在底层代码优化领域具有取代人类专家的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T23:02:42Z
- **目录日期**: 2025-05-31
