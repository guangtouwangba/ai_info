...
斯坦福大学研究团队意外发现，AI生成的CUDA内核性能远超人类专家优化版本。测试显示，AI内核在矩阵乘法、卷积、Softmax等常见深度学习操作上，性能比原生PyTorch提升101%-484%。该方法通过语言推理步骤增强搜索多样性，而非传统逐步优化。研究初衷是生成训练数据，却意外获得高性能内核。这一突破可能颠覆传统内核优化领域，引发对AI替代专业工程师的讨论。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T07:02:22Z
- **目录日期**: 2025-05-31
