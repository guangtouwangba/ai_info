...
斯坦福研究团队意外发现AI生成的CUDA内核性能超越人类专家优化版本。在深度学习操作中，AI优化内核性能提升显著：矩阵乘法达PyTorch的101.3%，二维卷积达179.9%，层归一化最高达484.4%。该突破源于测试阶段生成的合成数据意外产生高性能内核。方法创新在于迭代间加入语言推理步骤，通过"思考式"搜索实现多样化优化。这一发现可能颠覆传统内核优化方式，展现AI在底层计算优化中的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T19:03:04Z
- **目录日期**: 2025-05-31
