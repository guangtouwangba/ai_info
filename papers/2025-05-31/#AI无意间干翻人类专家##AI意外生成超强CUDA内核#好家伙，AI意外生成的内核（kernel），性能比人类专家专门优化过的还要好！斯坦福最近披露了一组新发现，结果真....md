...
斯坦福研究团队意外发现AI生成的CUDA内核性能超越人类专家优化版本。在多项深度学习操作中，AI优化内核表现亮眼：矩阵乘法达PyTorch的101.3%，二维卷积达179.9%，层归一化更达484.4%。该突破源于训练内核生成模型时，测试阶段合成的数据意外产生了高性能内核。方法创新在于迭代间加入语言推理步骤，通过"思考式"搜索实现多样化优化。这一发现可能颠覆传统内核优化方式，展现了AI在底层计算优化中的巨大潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T17:02:08Z
- **目录日期**: 2025-05-31
