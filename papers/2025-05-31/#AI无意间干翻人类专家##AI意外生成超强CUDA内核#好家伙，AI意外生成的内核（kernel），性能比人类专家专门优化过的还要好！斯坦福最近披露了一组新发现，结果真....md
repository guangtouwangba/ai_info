...
斯坦福研究团队意外发现AI生成的CUDA内核性能超越人类专家优化版本。在深度学习操作中，AI优化内核比原生PyTorch性能提升高达484%（如LayerNorm），矩阵乘法提升101%，二维卷积提升180%。该方法通过语言推理步骤增强搜索多样性，而非传统逐步优化。研究初衷是生成合成数据训练模型，却意外发现测试阶段数据直接产生高性能内核。这一突破可能颠覆传统内核优化领域，展现AI在底层计算优化中的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T08:03:07Z
- **目录日期**: 2025-05-31
