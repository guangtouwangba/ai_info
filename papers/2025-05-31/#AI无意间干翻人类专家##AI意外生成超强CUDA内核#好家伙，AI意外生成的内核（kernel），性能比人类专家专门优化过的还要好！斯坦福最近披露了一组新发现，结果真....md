...
斯坦福研究团队意外发现，AI生成的CUDA内核性能超越人类专家优化版本，在深度学习操作中表现亮眼：矩阵乘法达PyTorch的101.3%，二维卷积达179.9%，层归一化更提升至484.4%。该突破源于合成数据训练时，测试阶段生成的内核意外表现出色。方法创新在于迭代间加入语言推理步骤，通过"思考式"搜索提升多样性。这一发现可能重塑内核优化领域，展现AI在底层性能优化中的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T13:09:24Z
- **目录日期**: 2025-05-31
