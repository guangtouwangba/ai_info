...
这篇论文通过心理学框架和技术放大理论，实证研究了生成式AI与网络恶意活动及网络犯罪的关系。研究采用准实验设计和中断时间序列分析，分析了两组数据集（一组通用，一组聚焦加密货币），评估了生成式AI在网络犯罪中的作用。结果表明，生成式AI既可能放大网络风险，也可能提供防御机会。研究为AI治理提供了平衡管控与创新的依据，强调需要制定策略指导政策制定者、AI开发者和网络安全专家，并加强公众教育，以最大化AI效益同时降低风险。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T09:01:39Z
- **目录日期**: 2025-05-31
