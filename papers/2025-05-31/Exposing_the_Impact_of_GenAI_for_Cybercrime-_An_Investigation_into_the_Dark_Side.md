...
这篇论文通过心理学框架和技术放大理论，实证研究了生成式AI与恶意网络活动及网络犯罪的关系。采用准实验设计和中断时间序列分析，研究者分析了两组数据集（普通和加密货币相关），评估了生成式AI在网络犯罪中的作用。研究结果揭示了AI治理中控制与创新的平衡问题，强调需要制定策略指导政策制定者、AI开发者和网络安全专家，并教育公众，以最大化AI的益处同时降低风险。该研究为AI安全、伦理风险和双重用途问题的讨论提供了实证依据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T23:01:24Z
- **目录日期**: 2025-05-31
