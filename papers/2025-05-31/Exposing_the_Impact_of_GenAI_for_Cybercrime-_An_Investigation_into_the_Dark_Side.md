...
这篇论文通过心理学框架和技术放大理论，实证研究了生成式AI与恶意网络活动及网络犯罪的关联。采用准实验设计和中断时间序列分析，研究者分析了两组数据集（通用和加密货币相关），评估了生成式AI在网络犯罪中的作用。研究结果为AI治理的讨论提供了依据，强调需在控制与创新间取得平衡，并提出策略建议：指导政策制定者、启发AI开发者与网络安全专家，并教育公众，以最大化AI效益同时降低风险。研究呼吁关注AI安全、伦理及双重用途问题，特别是在网络安全领域的潜在影响。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T03:19:10Z
- **目录日期**: 2025-05-31
