...
Nature报道了一种新型超薄电子纹身传感器，可实时监测大脑负荷状态。该设备结合脑电图(EEG)和眼动图(EOG)技术，仅需200美元基础设备和20美元一次性纹身贴片，相比传统脑电帽更便捷经济。通过监测θ/δ波增强(用脑)和α/β波减弱(疲劳)等脑电信号变化，配合机器学习模型，能准确预测"最优脑负荷"状态和即将出现的脑力透支。研究团队正开发适用于有发区域的版本，目标是让脑疲劳监测像测心率一样普及。该技术已在6人实验中验证有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T07:03:17Z
- **目录日期**: 2025-05-31
