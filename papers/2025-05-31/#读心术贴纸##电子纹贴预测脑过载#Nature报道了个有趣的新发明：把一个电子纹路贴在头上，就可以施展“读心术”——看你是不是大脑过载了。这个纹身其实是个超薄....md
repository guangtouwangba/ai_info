...
Nature报道了一款新型超薄电子纹身贴纸传感器，可实时监测大脑状态。该设备结合EEG/EOG技术，通过分析θ/δ波（用脑强度）和α/β波（疲劳程度）的变化，能预测脑力过载风险并发出预警。相比传统脑电帽，其成本仅220美元（含20美元一次性贴片），且便于佩戴。实验显示，该装置可帮助找到"最优脑负荷"状态——大脑效率峰值区间。团队正研发适用于有发区域的版本，未来或使脑疲劳监测像测心率一样普及。（注：原文含配图未在摘要中体现）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T12:03:47Z
- **目录日期**: 2025-05-31
