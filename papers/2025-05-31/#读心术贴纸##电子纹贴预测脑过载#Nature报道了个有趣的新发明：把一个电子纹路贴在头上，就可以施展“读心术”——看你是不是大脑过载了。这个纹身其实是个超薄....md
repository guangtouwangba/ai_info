...
Nature报道了一种新型超薄电子纹身贴纸，可实时监测大脑状态。该设备结合脑电图(EEG)和眼动图(EOG)技术，成本约220美元（含20美元一次性感应器）。通过分析θ/δ波增强（用脑）和α/β波减弱（疲劳）等脑电信号，能预测"最优脑负荷"状态并提前预警脑力过载。研究人员训练机器学习模型准确预测脑负荷变化，未来计划扩展至有发区域监测，目标是实现日常脑疲劳监测如测心率般便捷。实验显示其对6名志愿者记忆任务时的脑状态监测有效。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T14:04:04Z
- **目录日期**: 2025-05-31
