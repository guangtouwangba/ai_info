...
Nature报道了一种新型超薄电子纹身传感器，可贴在头部监测脑负荷状态。该设备结合脑电图(EEG)和眼动图(EOG)技术，通过分析θ/δ波(用脑努力)和α/β波(疲劳)变化，能预测"最优脑负荷"并提前预警脑力透支。相比传统脑电帽更轻便经济(总价约220美元)。研究团队正开发适用于有头发区域的版本，目标是实现日常化的脑疲劳监测。机器学习模型能准确预测脑力变化趋势，未来或可像测心率一样简单监测大脑状态。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T03:20:47Z
- **目录日期**: 2025-05-31
