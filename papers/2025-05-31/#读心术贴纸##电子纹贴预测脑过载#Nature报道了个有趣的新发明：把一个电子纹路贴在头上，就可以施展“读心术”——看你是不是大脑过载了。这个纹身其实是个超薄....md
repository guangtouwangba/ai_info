...
Nature报道了一种新型超薄电子纹身贴纸，可实时监测大脑状态。该设备结合EEG和EOG技术，通过分析θ/δ波（用脑强度）和α/β波（疲劳程度）来评估脑负荷，并利用机器学习预测脑力临界点。相比传统脑电帽，这套仅220美元的系统更轻便经济。目前已在6人实验中验证有效性，未来计划扩展至有发区域监测，目标是让脑疲劳监测像测心率一样普及。研究旨在帮助人们找到"最优脑负荷"状态——既不过度轻松也不过度疲劳的高效工作区间。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T10:03:29Z
- **目录日期**: 2025-05-31
