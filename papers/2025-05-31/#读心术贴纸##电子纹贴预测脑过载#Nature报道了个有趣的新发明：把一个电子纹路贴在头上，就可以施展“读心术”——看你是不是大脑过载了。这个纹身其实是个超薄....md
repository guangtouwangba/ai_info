...
Nature报道了一种新型超薄电子纹身贴纸（约20美元），结合200美元的便携设备，可通过EEG/EOG技术监测脑负荷状态。它能检测θ/δ波（用脑强度）和α/β波（疲劳程度），利用机器学习预测脑力过载趋势，帮助找到"最优脑负荷"状态。相比传统脑电帽更轻便经济，未来计划实现头皮监测，目标是像测心率一样日常化监测脑疲劳。实验显示该设备能有效追踪6名志愿者完成记忆任务时的脑电变化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T16:03:51Z
- **目录日期**: 2025-05-31
