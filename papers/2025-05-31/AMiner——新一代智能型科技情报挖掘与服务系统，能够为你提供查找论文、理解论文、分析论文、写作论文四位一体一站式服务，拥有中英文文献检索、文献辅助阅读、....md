...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译、科研订阅等一站式服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持中英文文献搜索、AI生成摘要、互动问答等功能，帮助用户快速理解论文内容。平台还支持科研动态订阅，可按用户偏好推送最新学术资讯。此外，AMiner提供学者画像、学术会议等特色功能，基础服务可免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T05:05:11Z
- **目录日期**: 2025-05-31
