...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译和科研订阅等一站式服务。它支持中英文文献搜索，能自动生成摘要和问答互动，帮助用户快速理解论文内容。平台还具备文档识别、章节概要和个性化科研动态推送功能，覆盖42个学科的3.5亿论文资源。用户可通过浏览器免费使用，并定制关注学者、机构及关键词的最新研究资讯。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T01:32:35Z
- **目录日期**: 2025-05-31
