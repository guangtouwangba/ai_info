...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和科研情报订阅等一站式服务。它支持中英文文献搜索，能自动生成摘要并回答用户提问，帮助快速理解论文内容。平台还支持PDF上传和AI辅助阅读，可定制科研动态推送。收录了3.5亿论文、0.6亿学者等海量学术资源，并提供学者画像、学术会议等扩展功能。用户可通过网页免费使用基础功能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T02:33:43Z
- **目录日期**: 2025-05-31
