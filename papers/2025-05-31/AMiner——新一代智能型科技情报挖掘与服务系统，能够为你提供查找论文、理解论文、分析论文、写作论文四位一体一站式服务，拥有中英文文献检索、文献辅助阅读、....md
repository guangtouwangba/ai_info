...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、辅助阅读、翻译、学术问答等功能。它收录了3.5亿论文、0.6亿学者等海量数据，支持用户快速定位相关文献并生成摘要。平台还提供文献翻译、文档识别、科研动态订阅服务，用户可定制关注领域，通过微信或邮件接收最新研究进展。此外，AMiner具备学者画像、学术会议推荐等功能，基础服务免费开放。访问入口：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T17:04:33Z
- **目录日期**: 2025-05-31
