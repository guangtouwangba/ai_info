...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译及科研订阅等一站式服务。它支持中英文文献搜索，能快速定位相关论文并生成摘要，提升研究效率。平台还具备AI辅助阅读功能，可解析PDF文档，提供章节概要和智能问答。用户可定制科研动态订阅，跟踪特定学者或关键词的最新成果。AMiner覆盖42个学科，包含3.5亿论文、0.6亿学者等海量数据，并免费开放基础功能。访问入口：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T22:04:31Z
- **目录日期**: 2025-05-31
