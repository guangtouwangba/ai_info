...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索（覆盖3.5亿论文）、AI辅助阅读、自动摘要生成、翻译及问答功能。用户可上传或搜索文献，快速获取摘要和章节概要，并通过对话深入理解内容。平台支持个性化科研情报订阅，按用户设定的关键词推送最新研究动态。此外，还提供学者画像、学术会议追踪等特色功能，基础服务免费开放。访问入口：https://www.aminer.cn/。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T07:05:00Z
- **目录日期**: 2025-05-31
