...
中国科大等团队研究发现，大语言模型（LLM）的"灾难性遗忘"本质是功能向量偏移而非能力丢失——新任务激活了错误功能方向，导致原有能力被遮蔽。研究提出"函数向量"分析法，将任务功能抽象为可追踪的向量，并开发FVG训练法限制功能偏移。实验显示：生成任务比分类任务更易遗忘，早期性能下降可能是假性现象。该方法不仅能缓解遗忘，还提升了上下文学习能力。成果获ICLR 2025口头报告，代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T02:32:19Z
- **目录日期**: 2025-05-31
