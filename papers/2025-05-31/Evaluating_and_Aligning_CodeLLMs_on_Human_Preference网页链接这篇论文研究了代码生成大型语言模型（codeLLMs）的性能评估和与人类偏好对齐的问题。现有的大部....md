...
该论文针对代码生成大模型(codeLLMs)提出新评估框架CodeArena，通过397个涵盖40类编程任务和44种语言的人类精选样本，评估模型与人类偏好的对齐程度。研究发现传统基于执行的基准测试与人类偏好存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI)性能差距显著。同时构建20B标记的合成指令数据集SynCode-Instruct验证大规模指令微调效果，强调代码LLMs需同时关注功能正确性和人类编程习惯。研究为提升代码生成模型实用性提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T05:05:20Z
- **目录日期**: 2025-05-31
