...
这篇论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，通过397个涵盖40类编程任务和44种语言的高质量样本，评估模型与人类偏好的匹配程度。研究发现传统基于执行的测试与人类偏好存在差距，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著。研究还构建了20B标记的SynCode-Instruct合成指令数据集，验证了大规模仿真指令微调的有效性，强调了代码LLMs与人类偏好对齐的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T13:11:53Z
- **目录日期**: 2025-05-31
