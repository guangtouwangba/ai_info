...
这篇论文针对代码生成大模型(codeLLMs)提出创新评估框架CodeArena，通过397个涵盖40类编程任务和44种语言的真实样本，首次系统评估模型输出与人类偏好的对齐程度。研究发现传统基于执行的评测与人类偏好存在显著差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI)性能差距明显。同时提出的SynCode-Instruct合成指令集(20B标记)验证了大规模指令微调的有效性。研究揭示了当前代码LLMs在实用性方面的不足，强调了人类偏好对齐在代码生成领域的关键作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T02:33:54Z
- **目录日期**: 2025-05-31
