...
这篇研究综述探讨了大语言模型(LLMs)记忆系统的关键发展。研究者从记忆表示(参数化记忆和上下文记忆)和记忆操作两个维度，提出了包含6种核心操作的统一框架：巩固、更新、索引、遗忘、检索和压缩。参数化记忆指模型内部知识，响应快但难更新；上下文记忆则更灵活，支持多模态输入和个性化交互。该研究为构建具备长期记忆能力的AI系统提供了理论基础，使大模型能更好地支持跨轮对话、知识更新等复杂任务，向更智能的交互形态迈进。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T22:02:07Z
- **目录日期**: 2025-05-31
