...
这篇研究综述探讨了AI记忆系统的关键发展。来自多所高校和华为的团队提出，大语言模型(LLMs)需要更完善的记忆系统来支持长期交互，包括跨轮对话、多模态输入和个性化偏好。研究从两个维度分析：记忆表示(参数化记忆和上下文记忆)和记忆操作(6种核心操作：巩固、更新、索引、遗忘、检索和压缩)。参数化记忆存储内部知识但难以更新，而上下文记忆(包括非结构化和结构化数据)更灵活。这些机制使AI能像人类一样有效管理和运用记忆。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T20:02:22Z
- **目录日期**: 2025-05-31
