...
这项研究系统综述了AI记忆机制，指出大语言模型(LLMs)需要更完整的记忆系统来支持长期交互。研究从记忆表示(参数化记忆和上下文记忆)和记忆操作两个维度展开，定义了6种核心操作：巩固、更新、索引、遗忘、检索和压缩。参数化记忆是模型内部知识但更新困难，上下文记忆则更灵活可更新。该框架为AI实现类似人类的记忆能力提供了理论基础，使AI从临时聊天工具向具有持续记忆的智能体发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T19:02:30Z
- **目录日期**: 2025-05-31
