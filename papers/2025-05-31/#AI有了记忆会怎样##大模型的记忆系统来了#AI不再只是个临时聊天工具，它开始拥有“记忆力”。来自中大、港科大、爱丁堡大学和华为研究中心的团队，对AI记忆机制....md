...
中大、港科大、爱丁堡大学和华为团队发表研究，系统综述了AI记忆机制。研究指出大语言模型(LLMs)需要更完整的记忆系统来支持长期交互，包括跨轮对话、多模态输入和个性化偏好。记忆分为参数化记忆(模型内部知识)和上下文记忆(显式信息)，并定义了6种核心操作：巩固、更新、索引、遗忘、检索和压缩。这些机制使AI能更灵活地处理信息，为构建更智能的系统提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T23:02:10Z
- **目录日期**: 2025-05-31
