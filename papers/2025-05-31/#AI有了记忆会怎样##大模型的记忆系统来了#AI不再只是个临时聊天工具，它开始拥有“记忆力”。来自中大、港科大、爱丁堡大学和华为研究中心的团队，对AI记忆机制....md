...
中大、港科大等团队发表研究，系统综述了AI记忆机制。研究指出大语言模型需要更完整的记忆系统来支持长期交互，包括跨轮对话和多模态输入。记忆分为参数化记忆（内部知识，响应快但难更新）和上下文记忆（显式信息，更灵活）。研究定义了6种核心记忆操作：巩固、更新、索引、遗忘、检索和压缩，为AI构建"记忆肌肉"。该框架为理解智能提供了新视角，使AI从临时工具向有记忆的智能体发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T21:02:17Z
- **目录日期**: 2025-05-31
