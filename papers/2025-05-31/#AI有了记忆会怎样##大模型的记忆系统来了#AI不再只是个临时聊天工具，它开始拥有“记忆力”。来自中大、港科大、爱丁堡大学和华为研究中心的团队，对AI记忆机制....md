...
中大、港科大等团队发表研究，系统综述了AI记忆机制，提出大语言模型(LLMs)需要更完整的记忆系统来支持长期交互。研究从记忆表示(参数化记忆和上下文记忆)和记忆操作两个维度分析，定义了6种核心操作：巩固、更新、索引、遗忘、检索和压缩。参数化记忆存储内部知识但难以更新，上下文记忆则更灵活可更新。该研究为AI实现类似人类的记忆能力提供了统一框架，推动AI从临时聊天工具向具有记忆功能的智能体发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T18:02:25Z
- **目录日期**: 2025-05-31
