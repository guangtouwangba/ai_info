...
本文提出了一种基于强化学习的自主机器学习框架ML-Agent，通过三个创新组件实现高效训练：(1) 探索增强微调提升动作多样性；(2) 分步强化学习加速经验收集；(3) 专用奖励模块统一反馈信号。实验表明，仅用7B参数的Qwen-2.5模型在9个任务上训练后，其性能即超越671B参数的DeepSeek-R1代理，并展现出持续改进能力和优异的跨任务泛化性能。该研究首次实现了基于学习的智能体机器学习范式，突破了传统依赖人工提示工程的局限。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T12:01:39Z
- **目录日期**: 2025-05-31
