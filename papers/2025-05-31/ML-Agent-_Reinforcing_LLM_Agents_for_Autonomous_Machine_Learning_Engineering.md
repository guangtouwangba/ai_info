...
本文提出了一种基于强化学习(RL)的自主机器学习(ML)代理框架ML-Agent。该框架包含三个关键创新：(1)探索增强微调，提升代理的多样化动作生成能力；(2)分步RL训练，加速经验收集；(3)统一的ML任务奖励模块。实验表明，仅用7B参数的Qwen-2.5模型在9个ML任务上训练后，性能即超越671B参数的DeepSeek-R1代理，并展现出持续的改进能力和优秀的跨任务泛化性能。这一研究首次实现了基于学习的自主ML代理范式，突破了传统依赖人工提示工程的局限。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T21:01:36Z
- **目录日期**: 2025-05-31
