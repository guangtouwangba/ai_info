...
本文提出了一种基于强化学习的自主机器学习代理框架ML-Agent，通过三个创新点实现高效训练：(1) 探索增强微调提升动作多样性；(2) 单步强化学习加速经验收集；(3) 统一奖励模块整合多源反馈。实验表明，仅用7B参数的Qwen-2.5模型在9个任务上训练后，性能即超越671B参数的DeepSeek-R1代理，并展现出持续改进能力和优异的跨任务泛化性。该研究首次实现了通过在线强化学习让大语言模型代理从机器学习任务交互中自主学习的范式，为自适应机器学习工程开辟了新方向。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T11:01:38Z
- **目录日期**: 2025-05-31
