...
ZeroGUI提出了一种零人工成本的在线学习框架，用于训练纯视觉GUI代理。现有方法依赖人工标注且适应性有限，而ZeroGUI通过VLM自动生成任务目标、评估奖励，并结合两阶段在线强化学习，实现动态环境下的持续学习。实验表明，该框架显著提升了UI-TARS和Aguvis等代理在OSWorld和AndroidLab环境中的性能。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T23:01:02Z
- **目录日期**: 2025-05-31
