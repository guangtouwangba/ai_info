...
ZeroGUI提出了一种零人工成本的在线学习框架，用于训练纯视觉GUI代理。该框架通过VLM自动生成多样化任务目标，并利用VLM进行无人工干预的任务成功评估，结合两阶段在线强化学习持续与环境交互学习。相比依赖人工标注的离线方法，ZeroGUI解决了动态环境适应性问题，在UI-TARS和Aguvis等代理上显著提升了OSWorld和AndroidLab环境的表现。这一创新方法实现了完全自动化的GUI代理训练，代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T09:01:08Z
- **目录日期**: 2025-05-31
