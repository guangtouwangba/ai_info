...
ZeroGUI提出了一种零人工成本的在线学习框架，用于训练纯视觉GUI代理。现有离线方法依赖人工标注且适应性有限，而ZeroGUI通过三个创新点解决这些问题：(1) 基于VLM的自动任务生成，从当前环境状态产生多样化训练目标；(2) VLM自动奖励评估，无需人工设计评价函数；(3) 两阶段在线强化学习，持续与环境交互学习。实验表明，ZeroGUI显著提升了UI-TARS和Aguvis代理在OSWorld和AndroidLab环境中的表现。该框架实现了完全自动化的GUI代理训练，代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T19:01:08Z
- **目录日期**: 2025-05-31
