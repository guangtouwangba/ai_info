...
南洋理工大学与A*STAR团队提出新型AI水印方法MaskMark，采用"掩码机制"实现精准水印定位，支持全图或局部嵌入（如人脸/LOGO）。相比Meta的WAM模型，其训练成本降低15倍（单卡A6000仅需20小时），在高保真度下仍保持近100%提取准确率，尤其擅长小区域水印任务。性能全面超越现有技术，意外支持单图嵌入5个水印，且能快速适应新型攻击。该成果为图像版权保护提供了高效解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T14:02:37Z
- **目录日期**: 2025-05-31
