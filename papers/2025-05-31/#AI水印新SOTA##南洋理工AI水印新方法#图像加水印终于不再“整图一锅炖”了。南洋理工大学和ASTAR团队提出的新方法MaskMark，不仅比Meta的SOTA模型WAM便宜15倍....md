...
南洋理工大学与A*STAR团队提出新型AI水印方法MaskMark，通过"掩码机制"精准定位水印区域，分为全图嵌入(MaskMark-D)和局部嵌入(MaskMark-ED)两种版本。该方法在保持高保真度的同时实现接近100%的提取准确率，尤其在小区域水印任务上表现突出，支持单次嵌入多个水印。训练成本仅为Meta的WAM模型的1/15（单张A6000显卡20小时完成），计算效率提升15倍，且具备快速适应新攻击的能力。该技术特别适用于人脸、LOGO等局部保护场景。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T15:03:24Z
- **目录日期**: 2025-05-31
