...
南洋理工大学与A*STAR团队提出新型AI水印方法MaskMark，采用"掩码机制"精准定位水印区域，分为全图嵌入(MaskMark-D)和局部嵌入(MaskMark-ED)两种版本。该方法在保持高保真度的同时实现近100%提取准确率，尤其在小区域水印任务上显著优于Meta的WAM等现有模型，且意外支持多水印嵌入。训练效率突出：单卡20小时完成，成本仅为WAM的1/15，并具备快速适应新攻击的能力。该技术特别适用于人脸、LOGO等局部保护场景。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T16:02:30Z
- **目录日期**: 2025-05-31
