...
南洋理工大学与A*STAR团队提出新型AI水印方法MaskMark，采用"掩码机制"精准定位水印区域，分为全图嵌入(MaskMark-D)和局部嵌入(MaskMark-ED)两种版本。该方法以仅1/15的训练成本超越Meta的WAM模型，在保真度和提取准确率(近100%)上表现优异，尤其擅长小区域水印处理，并能同时嵌入多个水印。仅需单张A6000显卡20小时即可完成训练，支持快速微调以适应新型攻击。该技术特别适用于人脸、LOGO等局部保护场景，实现了AI水印领域的新突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T12:02:26Z
- **目录日期**: 2025-05-31
