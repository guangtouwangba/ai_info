...
南洋理工大学与A*STAR团队提出新型AI水印方法MaskMark，通过掩码机制实现精准水印定位，性能全面超越Meta的WAM模型。该方法分两种版本：MaskMark-D支持全图嵌入局部提取，MaskMark-ED专用于指定区域保护（如人脸/LOGO）。实验显示其在高保真度下提取准确率近100%，小区域水印表现尤其突出，单卡训练仅需20小时，效率达WAM的15倍。意外发现可同时嵌入5个水印且无错误，支持快速微调以适应新型攻击。该研究以1/15成本刷新AI水印SOTA。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T18:02:35Z
- **目录日期**: 2025-05-31
