...
南洋理工大学与A*STAR团队提出新型AI水印方法MaskMark，通过掩码机制精准定位水印区域，支持全图或局部嵌入（如人脸/LOGO）。相比Meta的WAM模型，其训练成本降低15倍（单卡A6000仅需20小时），在高保真度下仍保持近100%提取准确率，尤其擅长小区域水印任务。该方法未经专门训练即可同时嵌入5个水印，水印定位精度（IoU指标）超越WAM和EditGuard，并支持快速微调以适应新型攻击。性能与效率的双突破使其成为当前AI水印领域的新SOTA。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T21:02:27Z
- **目录日期**: 2025-05-31
