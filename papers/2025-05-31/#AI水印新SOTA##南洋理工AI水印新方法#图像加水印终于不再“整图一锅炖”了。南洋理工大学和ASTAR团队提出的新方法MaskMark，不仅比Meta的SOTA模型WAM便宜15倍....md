...
南洋理工大学与A*STAR团队提出新型AI水印方法MaskMark，通过掩码机制实现精准水印嵌入/提取，性能超越Meta的WAM模型。其特点包括：1）分全图版(MaskMark-D)和区域版(MaskMark-ED)，后者特别适合人脸/LOGO保护；2）高保真下提取准确率近100%，小区域表现尤佳；3）单卡训练仅需20小时，成本仅为WAM的1/15；4）意外支持多水印嵌入（最多5个）。该方法在定位精度(IoU)和抗攻击适应性上均达SOTA水平。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T08:02:40Z
- **目录日期**: 2025-05-31
