...
南洋理工大学与A*STAR团队提出新型AI水印方法MaskMark，通过"掩码机制"实现精准水印定位，支持全图或局部嵌入（如人脸/LOGO保护）。相比Meta的WAM模型，其训练成本降低15倍（单卡20小时），在高保真度下仍保持近100%提取准确率，尤其在小区域任务中表现突出。该方法意外支持多水印嵌入（最多5个），水印定位精度（IoU指标）超越现有技术，并具备快速微调能力以应对新型攻击。相关成果已展示出显著的效率与性能优势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T09:02:36Z
- **目录日期**: 2025-05-31
