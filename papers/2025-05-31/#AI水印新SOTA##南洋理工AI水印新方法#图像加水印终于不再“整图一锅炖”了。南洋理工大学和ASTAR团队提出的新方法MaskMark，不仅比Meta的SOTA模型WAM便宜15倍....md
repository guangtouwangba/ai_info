...
南洋理工大学与A*STAR团队提出新型AI水印方法MaskMark，通过掩码机制实现精准水印嵌入/提取，性能全面超越Meta的WAM模型。该方法分两种版本：MaskMark-D支持全图嵌入局部提取，MaskMark-ED针对特定区域保护。实验显示其在高保真度下保持近100%提取准确率，小区域水印表现尤其突出，单卡训练效率达WAM的15倍。意外支持多水印嵌入（最多5个），且能快速适配新攻击。相关成果以1/15训练成本刷新SOTA，为人脸/LOGO保护等场景提供高效解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T11:02:31Z
- **目录日期**: 2025-05-31
