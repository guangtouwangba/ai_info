...
南洋理工大学与A*STAR团队提出新型AI水印方法MaskMark，采用"掩码机制"实现精准水印定位，支持全图或局部嵌入（MaskMark-D/ED）。相比Meta的WAM模型，训练成本降低15倍（单卡A6000仅需20小时），在高保真度下仍保持近100%提取准确率，尤其擅长小区域水印任务。其水印定位能力（IoU指标）超越现有方案，意外支持同时嵌入5个水印。具备快速微调能力，可灵活应对不同比特长度及新型攻击，为人脸/LOGO保护等场景提供高效解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T23:02:18Z
- **目录日期**: 2025-05-31
