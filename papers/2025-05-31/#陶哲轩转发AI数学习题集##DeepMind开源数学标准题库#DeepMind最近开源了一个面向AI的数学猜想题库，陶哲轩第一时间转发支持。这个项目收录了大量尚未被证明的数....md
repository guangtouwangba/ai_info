...
DeepMind开源了一个用Lean语言形式化的数学猜想题库，获陶哲轩转发支持。该题库包含大量未证明的数学猜想，旨在为AI提供训练数据、为数学家搭建协作平台，并构建AI辅助数学研究的基础设施。形式化处理使猜想可编程验证，陶哲轩曾用此方法验证PFR猜想。项目鼓励社区贡献新猜想，未来将结合AlphaProof系统实现AI自主解题。这标志着AI辅助数学研究的重要进展。项目地址：github.com/google-deepmind/formal-conjectures。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T11:02:49Z
- **目录日期**: 2025-05-31
