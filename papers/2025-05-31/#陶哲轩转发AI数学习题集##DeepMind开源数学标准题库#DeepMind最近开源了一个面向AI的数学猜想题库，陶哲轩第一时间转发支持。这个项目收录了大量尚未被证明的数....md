...
DeepMind开源了一个用Lean语言形式化的数学猜想题库，旨在为AI提供训练数据，帮助数学家协作验证猜想，并构建AI辅助数学研究的基础设施。陶哲轩支持该项目，指出这是AI协助解决数学难题的重要一步。该题库允许社区贡献新猜想和修正错误，未来将与AlphaProof等AI证明系统结合，推动AI自主发现数学定理。项目地址：github.com/google-deepmind/formal-conjectures。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T21:02:41Z
- **目录日期**: 2025-05-31
