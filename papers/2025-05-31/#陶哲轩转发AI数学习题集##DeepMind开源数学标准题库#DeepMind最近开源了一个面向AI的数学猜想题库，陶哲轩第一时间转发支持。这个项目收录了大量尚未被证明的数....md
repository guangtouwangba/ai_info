...
DeepMind开源了一个面向AI的数学猜想题库，采用Lean语言进行形式化处理，使计算机能理解未证明的数学猜想。著名数学家陶哲轩转发支持，指出这是AI辅助数学研究的重要一步。该题库可作为AI训练数据集、数学家合作平台及未来AI数学研究的基建。DeepMind计划结合其AI证明系统AlphaProof，实现AI自主"找题+解题"。项目鼓励社区贡献新猜想，流程通过GitHub完成。这一举措可能推动AI参与数学定理发现，项目地址已公开。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T16:02:46Z
- **目录日期**: 2025-05-31
