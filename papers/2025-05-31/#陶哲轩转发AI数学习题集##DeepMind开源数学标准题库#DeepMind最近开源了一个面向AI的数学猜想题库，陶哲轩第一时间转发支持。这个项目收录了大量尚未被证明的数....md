...
DeepMind开源了一个用Lean语言形式化的数学猜想题库，获得数学家陶哲轩转发支持。该项目为AI提供训练数据集，为数学家搭建协作平台，并构建未来AI辅助数学研究的基础设施。形式化处理使数学猜想可编程验证，陶哲轩曾用此方法完成PFR猜想验证。DeepMind计划结合其AlphaProof系统，实现AI自主"找题+解题"，推动数学定理的AI辅助发现。项目鼓励社区贡献新猜想，GitHub提交流程友好。这标志着AI与数学研究协同迈出重要一步。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T18:02:55Z
- **目录日期**: 2025-05-31
