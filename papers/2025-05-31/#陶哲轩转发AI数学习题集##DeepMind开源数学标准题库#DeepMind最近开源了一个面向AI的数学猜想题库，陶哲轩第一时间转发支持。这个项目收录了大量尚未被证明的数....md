...
DeepMind开源了一个用Lean语言形式化的数学猜想题库，旨在为AI提供训练数据、为数学家搭建协作平台。该题库收录了未证明的数学猜想，经过形式化处理后可供计算机验证。陶哲轩转发支持并指出这是AI辅助数学研究的重要一步。项目鼓励社区贡献新猜想，未来将与AlphaProof系统结合，实现AI自动解题。这一基础设施有望推动AI参与数学发现，项目地址为github.com/google-deepmind/formal-conjectures。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T20:02:48Z
- **目录日期**: 2025-05-31
