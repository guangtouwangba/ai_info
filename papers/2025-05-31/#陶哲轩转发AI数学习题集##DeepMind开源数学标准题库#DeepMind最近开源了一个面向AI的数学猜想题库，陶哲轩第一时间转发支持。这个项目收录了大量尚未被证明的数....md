...
DeepMind开源了一个用Lean语言形式化的数学猜想题库，旨在训练AI理解数学问题，并为数学家提供协作平台。陶哲轩转发支持，认为这是AI辅助数学研究的重要基础设施。该项目鼓励社区贡献新猜想，未来将结合AlphaProof系统实现AI自主解题。这一举措可能推动AI参与数学定理发现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T12:02:43Z
- **目录日期**: 2025-05-31
