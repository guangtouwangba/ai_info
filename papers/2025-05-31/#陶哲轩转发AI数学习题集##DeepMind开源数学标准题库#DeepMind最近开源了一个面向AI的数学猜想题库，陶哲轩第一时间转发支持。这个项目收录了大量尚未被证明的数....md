...
DeepMind开源了一个AI数学猜想题库，采用Lean语言形式化处理未证明的数学猜想，获陶哲轩转发支持。该项目为AI提供训练数据，帮助数学家协作验证猜想，并构建未来AI数学研究的基础设施。形式化使问题可编程验证，陶哲轩曾借此完成PFR猜想验证。DeepMind鼓励社区贡献新猜想，未来将结合AlphaProof系统实现AI自主解题。这一举措或推动AI辅助数学定理发现。项目地址：github.com/google-deepmind/formal-conjectures。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T15:03:42Z
- **目录日期**: 2025-05-31
