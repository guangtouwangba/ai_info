...
DeepMind开源了一个面向AI的数学猜想题库，采用Lean语言形式化处理未证明的猜想。该题库为AI提供训练数据，帮助数学家协作验证猜想，并构建AI辅助数学研究的基础设施。陶哲轩曾用类似方法验证PFR猜想，认为这是AI协助解决数学难题的重要一步。项目鼓励社区贡献新猜想，未来将与AlphaProof系统结合，实现AI自主解题。开源地址：github.com/google-deepmind/formal-conjectures。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T19:02:56Z
- **目录日期**: 2025-05-31
