...
DeepMind开源了一个用Lean语言形式化的数学猜想题库，旨在为AI提供训练数据、为数学家搭建协作平台。该项目收录了大量未证明的数学猜想，通过形式化处理使计算机能够理解和验证。陶哲轩积极支持该项目，认为这是AI辅助数学研究的重要一步。DeepMind计划结合其AI证明系统AlphaProof，实现"自动找题+解题"的闭环。项目鼓励社区贡献新猜想，未来可能推动AI辅助发现数学定理。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T10:02:29Z
- **目录日期**: 2025-05-31
