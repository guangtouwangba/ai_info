# #陶哲轩转发AI数学习题集##DeepMind开源数学标准题库#DeepMind最近开源了一个面向AI的数学猜想题库，陶哲轩第一时间转发支持。这个项目收录了大量尚未被证明的数...
...
DeepMind开源了一个用Lean语言形式化的数学猜想题库，旨在为AI提供训练数据、为数学家搭建协作平台。该项目收录了大量未证明的数学猜想，将其转化为计算机可处理的形式，使问题可验证可编程。著名数学家陶哲轩转发支持，并指出这是AI辅助数学研究的重要一步。DeepMind计划结合其AI证明系统AlphaProof，实现"AI自主解题+发现新定理"的目标。该开源项目鼓励社区贡献新猜想，未来可能成为AI数学研究的核心基础设施。项目地址：github.com/google-deepmind/formal-conjectures

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T22:02:32Z
- **目录日期**: 2025-05-31
