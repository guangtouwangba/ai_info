...
DeepMind开源了一个面向AI的数学猜想题库，采用Lean语言进行形式化处理，使计算机能理解未证明的数学猜想。该题库可作为AI训练数据集、数学家协作平台及未来AI数学研究的基础设施。陶哲轩转发支持，并指出这是AI辅助解决数学难题的重要一步。DeepMind鼓励社区贡献新猜想，未来计划结合其AI证明系统AlphaProof，实现AI自主"找题+解题"。项目地址：github.com/google-deepmind/formal-conjectures。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T14:02:58Z
- **目录日期**: 2025-05-31
