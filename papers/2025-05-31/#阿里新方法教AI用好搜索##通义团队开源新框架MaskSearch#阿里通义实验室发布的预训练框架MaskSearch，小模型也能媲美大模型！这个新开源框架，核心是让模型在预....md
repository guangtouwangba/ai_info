...
阿里通义实验室开源了MaskSearch预训练框架，通过"检索增强型掩码预测"(RAMP)技术，让AI模型在训练时学会结合搜索引擎获取外部知识来补全信息。该框架创新性地兼容监督微调和强化学习两种训练方式，采用多智能体+教师模型生成思维链，并通过混合奖励系统优化推理路径。实验显示，采用该框架的小模型在问答任务中表现优异，甚至能媲美大模型，尤其在跨领域任务上展现出强大泛化能力。研究还发现掩码策略和奖励函数对模型性能有显著影响。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T10:02:21Z
- **目录日期**: 2025-05-31
