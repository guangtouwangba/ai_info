...
阿里通义实验室开源预训练框架MaskSearch，通过检索增强型掩码预测(RAMP)技术，让AI在预训练时学习结合搜索引擎进行推理。该框架创新性地兼容监督微调(SFT)和强化学习(RL)，采用多智能体生成思维链和混合奖励机制优化推理路径，并引入课程学习提升泛化能力。实验显示，该方法使小模型在问答任务中达到媲美大模型的性能，尤其在跨领域任务表现突出。研究还揭示了掩码策略和奖励函数对模型学习效果的关键影响。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T18:02:46Z
- **目录日期**: 2025-05-31
