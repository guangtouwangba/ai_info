...
阿里通义实验室开源了新型预训练框架MaskSearch，通过检索增强型掩码预测(RAMP)技术，让AI模型在预训练时学会结合搜索引擎进行推理。该框架创新性地兼容监督微调和强化学习训练，采用多智能体生成思维链和混合奖励机制优化推理路径，并引入课程学习策略提升泛化能力。实验显示，采用MaskSearch的小模型在问答任务中表现优异，部分场景下甚至能媲美大模型性能。研究还揭示了掩码策略和奖励函数对模型学习效果的重要影响。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T23:02:26Z
- **目录日期**: 2025-05-31
