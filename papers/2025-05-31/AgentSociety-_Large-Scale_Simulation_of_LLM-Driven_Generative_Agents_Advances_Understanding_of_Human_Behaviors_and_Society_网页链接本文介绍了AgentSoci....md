...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个代理及其500万次社会互动。研究者利用该系统研究了社会极化、信息传播、基本收入政策及自然灾害影响等社会问题。模拟结果与现实数据高度吻合，验证了该系统在捕捉人类行为机制方面的有效性。该平台可作为计算社会科学研究工具，为学者和政策制定者提供新的研究方法，弥补传统调查和实验的局限性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T12:04:41Z
- **目录日期**: 2025-05-31
