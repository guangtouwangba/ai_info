...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理的社会互动（500万次）。该系统作为计算社会科学实验平台，研究了四大社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，证明其能有效捕捉人类行为机制。该系统有望成为社会科学研究和政策制定的创新工具，为传统研究方法（如调查、访谈）提供补充。研究展示了LLM驱动代理在理解复杂社会现象方面的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T23:04:09Z
- **目录日期**: 2025-05-31
