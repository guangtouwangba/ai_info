...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟1万多个代理的社会生活及其500万次互动。研究者用它研究了社会极化、信息传播、基本收入政策及自然灾害影响等问题，结果与现实世界数据吻合。该系统展示了作为社会科学研究工具和辅助政策制定的潜力，能有效捕捉人类行为模式及其内在机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T07:04:35Z
- **目录日期**: 2025-05-31
