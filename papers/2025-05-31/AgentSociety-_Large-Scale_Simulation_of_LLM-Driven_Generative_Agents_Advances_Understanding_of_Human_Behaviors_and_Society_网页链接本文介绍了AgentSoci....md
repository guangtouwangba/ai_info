...
AgentSociety是一个基于大语言模型的大规模社会模拟器，能模拟1万多个代理及其500万次互动。研究者用它分析四个社会问题：群体极化、刺激性信息传播、基本收入政策影响和飓风等外部冲击。模拟结果与现实数据吻合，验证了该系统捕捉人类行为机制的能力。该平台可作为传统社会科学研究方法（如调查、实验）的补充工具，帮助研究者探索社会问题的成因和模式，并为政策制定提供参考依据，展现了LLM在社会模拟中的实用价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T21:04:10Z
- **目录日期**: 2025-05-31
