...
MME-VideoOCR是一个专门评估多模态模型视频OCR能力的基准测试，包含1,464个视频片段和2,000条问答对，覆盖多样场景并加入干扰项。测试从10类任务、25个子任务评估模型对视频文字的识别、理解和推理能力。结果显示，即使是表现最好的Gemini-2.5 Pro模型准确率也仅为73.7%，开源模型普遍低于60%，主要困难在于时序理解和文字推理。该测试突显了当前AI模型在视频文字处理上的局限性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T04:04:47Z
- **目录日期**: 2025-05-31
