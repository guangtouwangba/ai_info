...
MME-VideoOCR是一个评估多模态模型视频OCR能力的新基准，包含1,464个视频片段和2,000条问答对，覆盖多样场景并加入干扰项。它从10类任务、25个子任务全面测试模型对视频文字的"看清""理解""推理"能力。评估结果显示，即使是表现最佳的Gemini-2.5 Pro模型准确率也仅73.7%，开源模型更低于60%，主要困难在于时序理解和文字推理。该研究揭示了当前AI在视频文字识别任务上的局限性，为未来改进提供了方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T01:30:47Z
- **目录日期**: 2025-05-31
