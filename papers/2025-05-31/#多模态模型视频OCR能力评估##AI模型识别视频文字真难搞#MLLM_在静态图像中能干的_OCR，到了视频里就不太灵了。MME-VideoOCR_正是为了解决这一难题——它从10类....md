...
MME-VideoOCR是一个专门评估多模态大模型(MLLM)视频OCR能力的新基准，包含1,464个视频片段和2,000条问答对，覆盖10类任务25个子任务。测试显示，即使是表现最好的Gemini-2.5 Pro模型准确率也仅73.7%，开源模型普遍低于60%。主要挑战在于时序理解和文字推理能力不足。该基准通过字符串匹配、多选题和GPT评分三种方式，全面考察模型对视频中文字的识别、时空定位、追踪和推理能力，特别设置了模糊、遮挡等干扰项以提升评估难度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T02:31:50Z
- **目录日期**: 2025-05-31
