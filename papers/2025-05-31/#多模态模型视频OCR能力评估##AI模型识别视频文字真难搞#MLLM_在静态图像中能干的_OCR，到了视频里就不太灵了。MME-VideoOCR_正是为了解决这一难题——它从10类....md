...
MME-VideoOCR是一个专门评估多模态模型视频OCR能力的新基准，包含1,464个视频片段和2,000条问答对，覆盖多样场景并加入干扰项。该基准从10类任务、25个子任务全面测试模型对视频文字的"看清"、"理解"和"推理"能力。结果显示，即使最强模型Gemini-2.5 Pro准确率仅73.7%，开源模型更低于60%，主要难点在于时序理解和文字推理。评估采用字符串匹配、多选题和GPT辅助评分三种方式，凸显了视频OCR任务的高挑战性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T03:21:08Z
- **目录日期**: 2025-05-31
