...
MME-VideoOCR是一个专门评估多模态模型视频OCR能力的基准测试，包含1,464个视频片段和2,000条问答对，覆盖多样化场景并添加干扰项。测试从10类任务、25个子任务全面评估模型对视频文字的识别、理解和推理能力。结果显示，即使是表现最好的Gemini-2.5 Pro模型准确率也仅为73.7%，开源模型表现更差，尤其在时序理解和文字推理方面存在明显不足。该测试采用字符串匹配、多选题和GPT辅助评分三种评估方式，突显了当前AI模型处理视频文字的挑战性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T05:03:30Z
- **目录日期**: 2025-05-31
