...
上海人工智能实验室与高校合作开发的Avengers框架，通过四个关键步骤（Embedding、Clustering、Scoring、Routing & Voting）将多个7B小模型并联组合，无需额外训练即展现卓越性能。在15个公开数据集测试中，该框架在9个任务上超越GPT-4.1，数学和代码任务分别领先18.21%和7.46%。相比需要训练的混合方法，Avengers具有结构轻量、泛化性强等优势，在OOD任务表现更稳定，平均性能超出主流混合策略17.16%，验证了小模型集体作战的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T03:21:17Z
- **目录日期**: 2025-05-31
