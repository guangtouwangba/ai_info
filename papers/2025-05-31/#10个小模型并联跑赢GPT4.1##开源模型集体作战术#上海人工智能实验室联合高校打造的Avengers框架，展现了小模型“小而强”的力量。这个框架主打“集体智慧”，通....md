...
上海人工智能实验室开发的Avengers框架通过"集体智慧"策略，将多个7B小模型并联组合，无需额外训练即超越GPT-4.1性能。该框架采用四步流程：问题理解、聚类、模型评分、动态路由投票，在15个测试数据集中9项表现更优，数学和代码任务分别领先18.21%和7.46%。相比传统混合模型方法，这种轻量化结构在分布外任务中稳定性提升17.16%，展示了开源小模型协同作战的显著优势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T05:03:38Z
- **目录日期**: 2025-05-31
