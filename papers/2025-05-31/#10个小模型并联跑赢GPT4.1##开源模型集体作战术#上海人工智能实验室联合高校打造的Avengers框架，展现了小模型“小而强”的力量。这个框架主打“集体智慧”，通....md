...
上海人工智能实验室推出的Avengers框架创新性地通过并联多个7B小模型（无需额外训练）实现超越GPT-4.1的性能。该框架采用四步策略：问题理解、聚类、模型能力评估及动态路由投票，在15个测试数据集中，9项表现优于GPT-4.1，数学和代码任务分别领先18.21%和7.46%。相比传统混合模型方法，其轻量化结构在分布外任务中稳定性更优，平均性能高出主流方案17.16%，展现了开源模型协同作战的高效潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T01:30:58Z
- **目录日期**: 2025-05-31
