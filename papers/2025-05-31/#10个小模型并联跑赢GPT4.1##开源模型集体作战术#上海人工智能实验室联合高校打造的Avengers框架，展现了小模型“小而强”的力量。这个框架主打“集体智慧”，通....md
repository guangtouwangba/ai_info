...
上海人工智能实验室联合高校开发的Avengers框架，通过四个关键步骤（问题理解、聚类、模型评分、动态路由投票），将多个7B小模型并联组合，无需额外训练即展现出超越GPT-4.1的性能。在15个公开数据集测试中，该框架在9个任务上领先，数学和代码任务分别提升18.21%和7.46%。相比传统路由方法和主流混合模型策略，Avengers具有结构轻量、泛化能力强等优势，在分布外任务中表现更稳定，平均性能高出17.16%，展示了小模型集体作战的显著潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T07:03:44Z
- **目录日期**: 2025-05-31
