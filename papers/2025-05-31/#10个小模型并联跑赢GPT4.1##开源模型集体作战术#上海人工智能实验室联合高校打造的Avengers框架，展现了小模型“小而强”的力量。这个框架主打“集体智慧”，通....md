...
上海人工智能实验室推出的Avengers框架通过"集体智慧"策略，将多个7B小模型并联组合，无需额外训练即超越GPT-4.1性能。该框架采用四步流程：问题理解、聚类、模型能力评估及动态路由投票，在15个测试数据集中，9项表现优于GPT-4.1，数学任务领先18.21%，代码任务领先7.46%。相比需要训练的混合方法，Avengers具有结构轻量、泛化性强优势，在分布外任务中稳定性更佳，平均性能超出主流混合策略17.16%，展现了小模型协同作战的显著效能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T00:03:56Z
- **目录日期**: 2025-05-31
