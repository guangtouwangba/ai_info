...
上海人工智能实验室推出的Avengers框架通过"集体智慧"策略，将多个7B小模型并联组合，无需额外训练即可超越GPT-4.1。该框架采用四步流程：问题理解、聚类、模型评分、动态路由投票，在15个测试数据集中9项表现更优，数学任务领先18.21%，代码任务领先7.46%。相比传统混合模型方法，Avengers结构更轻量，在OOD任务中泛化能力更强，平均性能高出17.16%，展现了开源小模型协同作战的显著优势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T06:03:44Z
- **目录日期**: 2025-05-31
