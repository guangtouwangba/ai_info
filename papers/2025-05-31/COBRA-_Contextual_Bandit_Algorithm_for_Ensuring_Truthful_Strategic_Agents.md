...
这篇论文研究了一个涉及多个智能体的上下文赌博机问题，其中学习者需要处理智能体可能虚报选择的行为（如卖家夸大产品质量）。现有研究假设智能体会如实报告，但现实中可能存在策略性欺骗。为此，作者提出了COBRA算法，该算法无需货币激励即可抑制智能体的策略性行为，同时保证激励相容性和次线性遗憾界。实验验证了算法的有效性。研究解决了实际应用中智能体不诚实报告的挑战，适用于如电商平台卖家竞争等场景。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T05:01:54Z
- **目录日期**: 2025-05-31
