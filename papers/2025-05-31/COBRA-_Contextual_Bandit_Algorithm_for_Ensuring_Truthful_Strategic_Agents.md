...
这篇论文研究了一个涉及多个智能体的上下文赌博机问题，其中学习者需在智能体可能虚报选择的情况下最大化系统总奖励。现有研究假设智能体会如实报告选择，但现实中（如电商平台卖家可能虚报产品质量）常存在策略性欺骗行为。为此，作者提出COBRA算法，在不使用金钱激励的情况下，通过机制设计抑制智能体的策略性行为，同时保证激励相容性和次线性遗憾界。实验验证了该算法在多方面的性能表现。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T23:01:40Z
- **目录日期**: 2025-05-31
