...
这篇论文研究了一个涉及多个智能体的上下文赌博机问题，其中学习者需在智能体可能虚报信息的情况下选择最优策略。现有研究假设智能体会如实报告，但现实中（如电商平台卖家可能夸大产品质量）常存在策略性欺骗行为。为此，作者提出了COBRA算法，无需金钱激励即可抑制智能体的策略性行为，同时保证激励相容性和次线性遗憾界。实验验证了该算法的各项性能优势。该研究为存在信息操纵的场景提供了实用的决策框架。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T19:01:54Z
- **目录日期**: 2025-05-31
