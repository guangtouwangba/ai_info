...
这篇论文提出了一种针对多智能体情境赌博问题的算法COBRA，解决了现有研究中假设智能体诚实上报行为的局限性。在现实场景（如电商平台）中，卖家可能虚报产品质量以获得推荐优势。COBRA无需货币激励，通过机制设计抑制策略性操纵行为，同时保证激励相容性和次线性遗憾界。实验验证了算法的有效性。该研究为存在策略性智能体的推荐系统等应用提供了新解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T12:01:46Z
- **目录日期**: 2025-05-31
