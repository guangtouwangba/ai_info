...
这篇论文研究了涉及多个智能体的上下文赌博问题，其中学习者需在智能体可能虚报信息的情况下选择最优策略。现有研究假设智能体会如实报告，但这与现实不符（如电商平台中卖家可能夸大产品质量）。为此，作者提出COBRA算法，无需金钱激励即可抑制智能体的策略性虚报行为，同时保证激励相容性和次线性遗憾。实验验证了该算法的有效性。该研究对存在信息操纵场景的推荐系统等应用具有重要价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T11:01:46Z
- **目录日期**: 2025-05-31
