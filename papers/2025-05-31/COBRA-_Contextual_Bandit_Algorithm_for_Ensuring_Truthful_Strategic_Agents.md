...
这篇论文研究了一个涉及多个智能体的上下文赌博机问题，其中学习者需要观察上下文和智能体报告的选项，然后选择最大化系统整体奖励的选项。现有研究假设智能体会如实报告选项，但这在现实中往往不成立（例如电商平台中卖家可能虚报产品质量）。为此，作者提出了COBRA算法，该算法无需货币激励就能抑制智能体的策略性行为，同时保证激励相容性和次线性遗憾界。实验结果验证了该算法的各项性能表现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T18:01:46Z
- **目录日期**: 2025-05-31
