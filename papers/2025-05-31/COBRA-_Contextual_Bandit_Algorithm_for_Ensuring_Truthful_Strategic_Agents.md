...
这篇论文研究了一个涉及多个智能体的上下文赌博机问题，其中学习者需要观察上下文和智能体报告的选项，并选择最大化系统整体奖励的选项。现有研究假设智能体会如实报告选项，但在实际应用中（如在线平台卖家可能虚报产品质量），这一假设不成立。为此，作者提出了一种名为COBRA的算法，无需货币激励即可抑制智能体的策略性行为，同时保证激励兼容性和次线性遗憾。实验验证了该算法的性能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T15:02:00Z
- **目录日期**: 2025-05-31
