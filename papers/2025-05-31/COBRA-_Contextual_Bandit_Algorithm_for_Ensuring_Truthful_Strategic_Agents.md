...
这篇论文研究了一个涉及多个智能体的上下文赌博机问题，其中学习者需在智能体可能虚报选择的情况下，选取使系统总奖励最大化的选项。针对现有研究假设智能体会如实报告的不现实性（如电商平台中卖家虚报产品质量），作者提出了COBRA算法。该算法无需货币激励即可抑制智能体的策略性行为，同时保证激励兼容性和次线性遗憾界。实验结果验证了算法的各项性能表现。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T22:01:36Z
- **目录日期**: 2025-05-31
