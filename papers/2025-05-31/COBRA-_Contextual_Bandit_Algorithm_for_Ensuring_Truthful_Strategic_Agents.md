...
这篇论文研究了一个涉及多个智能体的上下文赌博机问题。传统方法假设智能体会如实报告其选择，但现实中（如电商平台卖家可能虚报产品质量）存在策略性欺骗行为。为此，作者提出了COBRA算法，无需货币激励即可抑制智能体的策略性行为，同时保证激励兼容性和次线性遗憾界。实验验证了该算法的各项性能优势。该研究为存在策略性欺骗的场景提供了新的解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-31T21:01:45Z
- **目录日期**: 2025-05-31
