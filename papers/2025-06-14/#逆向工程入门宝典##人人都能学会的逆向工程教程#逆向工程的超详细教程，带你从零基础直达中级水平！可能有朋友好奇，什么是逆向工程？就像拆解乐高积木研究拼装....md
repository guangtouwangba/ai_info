...
这是一套面向零基础学习者的逆向工程入门教程，通过类比拆解乐高积木的方式，讲解如何通过现有系统反推设计原理。教程涵盖x86/x64架构和ARM处理器体系，从恶意软件分析基础到汇编语言解析循序渐进。提供PDF/MOBI电子书格式，支持内容持续更新。适用于网络安全领域初学者，可通过侧边栏快速检索知识点。附有详细图文教程链接，帮助用户从入门提升至中级水平。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T08:02:58Z
- **目录日期**: 2025-06-14
