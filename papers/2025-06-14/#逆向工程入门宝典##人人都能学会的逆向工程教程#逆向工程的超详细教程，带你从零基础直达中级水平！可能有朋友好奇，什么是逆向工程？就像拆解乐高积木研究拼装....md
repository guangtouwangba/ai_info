...
这是一套面向零基础学习者的逆向工程入门教程，通过类比拆解乐高积木的方式，讲解如何分析现有系统/产品的设计原理。教程涵盖x86/x64架构和32/64位ARM处理器，从恶意软件分析基础到汇编语言解析循序渐进。提供PDF/MOBI电子书格式，内容持续更新。特色包括章节快速导航、适合复习和系统学习，是网络安全领域的实用基础教程。附带示例图片展示课程内容结构。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T04:03:50Z
- **目录日期**: 2025-06-14
