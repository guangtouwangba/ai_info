...
这是一套面向零基础学习者的逆向工程教程，通过拆解分析现有系统来推导设计原理，类比乐高积木的拆解研究。教程涵盖x86/x64架构和ARM处理器体系，从恶意软件分析基础到汇编语言解析循序渐进。提供PDF/MOBI电子书格式，支持章节跳转阅读并持续更新内容。该资源旨在用易懂方式教授网络安全领域这项核心技能，适合从入门到中级水平的学习需求。附带网页链接提供完整教程获取途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T06:02:58Z
- **目录日期**: 2025-06-14
