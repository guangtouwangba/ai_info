...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和科研订阅等一站式服务。它支持中英文文献检索，能通过AI生成摘要和问答互动，帮助用户快速理解论文内容。平台还提供文献翻译、文档识别和个性化科研动态订阅功能，覆盖42个学科3.5亿论文数据。用户可免费使用浏览器检索，并通过微信或邮件获取定制学术资讯。此外，AMiner还包含学者画像、学术会议和论文排行榜等特色功能，助力科研效率提升。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T09:04:34Z
- **目录日期**: 2025-06-14
