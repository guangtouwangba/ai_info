...
AMiner是一款智能科技情报挖掘系统，提供论文检索、辅助阅读、翻译及科研订阅等一站式服务。它涵盖42个学科的3.5亿论文、0.6亿学者等海量数据，支持中英文文献检索，并能通过AI生成摘要、章节概要和问答互动，帮助用户快速理解内容。此外，用户可定制科研动态推送，关注特定学者或关键词，通过微信或邮件获取最新资讯。平台还提供学者画像、会议信息等附加功能，基础服务免费开放使用。访问链接：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T14:05:43Z
- **目录日期**: 2025-06-14
