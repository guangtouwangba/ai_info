...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析和写作一站式服务。它支持中英文文献搜索，拥有3.5亿论文、0.6亿学者等海量数据，并能通过AI生成摘要和解答问题。平台还具备文献翻译、科研动态订阅（通过微信或邮件推送）、学者画像等功能。用户可免费使用其浏览器检索服务，实现高效学术研究。访问入口：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T05:04:19Z
- **目录日期**: 2025-06-14
