...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、辅助阅读、翻译和科研情报订阅。它拥有庞大的数据库，涵盖3.5亿论文、0.6亿学者和1.5亿专利。用户可通过互动问答快速理解文献内容，并自动生成摘要以提高写作效率。平台还支持文档上传，利用AI技术生成章节概要和问题建议。此外，用户可定制订阅最新科研动态，通过微信或邮件接收。AMiner还提供学者画像、学术会议和论文排行榜等功能，基础功能免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T12:04:33Z
- **目录日期**: 2025-06-14
