...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和科研订阅等一站式服务。它收录了3.5亿篇论文、0.6亿学者和1.5亿专利，支持中英文文献检索，并能通过AI生成摘要和问答互动帮助用户快速理解内容。此外，AMiner提供个性化科研动态订阅，用户可设置关注领域，通过微信或邮件获取最新学术资讯。平台还包含学者画像、学术会议和论文排行榜等功能，基础服务免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T03:22:41Z
- **目录日期**: 2025-06-14
