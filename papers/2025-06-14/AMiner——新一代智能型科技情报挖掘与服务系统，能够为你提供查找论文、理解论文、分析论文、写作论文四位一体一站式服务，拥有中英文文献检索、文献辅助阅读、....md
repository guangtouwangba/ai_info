...
AMiner是一个智能科技情报挖掘平台，提供文献检索、辅助阅读、翻译、科研订阅等一站式服务。其核心功能包括：1）中英文文献检索，支持互动问答和自动摘要生成；2）英文文献翻译与AI辅助阅读，可解析PDF并生成章节概要；3）个性化科研情报订阅，按用户偏好推送最新论文。平台覆盖42个学科，包含3.5亿论文、0.6亿学者等海量数据，并提供学者画像、学术会议等特色功能。基础服务免费开放，旨在提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T10:04:09Z
- **目录日期**: 2025-06-14
