...
随着生成式AI（GenAI）输出的质量提升，区分AI与人类生成内容变得愈发困难。数字水印技术是一种潜在解决方案，通过在AI生成内容中嵌入隐藏信号以实现可靠检测。尽管水印并非解决GenAI所有风险的万能方案，但它能通过打击错误信息和欺骗行为，显著提升AI的安全性和可信度。本文系统梳理了GenAI水印技术，从历史与监管需求出发，形式化定义了水印方案的特性和目标，分析了威胁模型与评估策略，并综述了代表性研究。同时指出开放挑战与未来方向，为研究者和政策制定者提供技术发展与治理参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T04:03:11Z
- **目录日期**: 2025-06-14
