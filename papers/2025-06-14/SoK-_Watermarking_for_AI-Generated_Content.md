...
随着生成式AI（GenAI）输出的质量提升，区分AI与人类生成内容变得愈发困难。数字水印技术是一种潜在解决方案，通过在AI生成内容中嵌入隐藏信号以实现可靠检测。尽管水印并非解决GenAI所有风险的万能方案，但它在增强AI安全性和可信度、对抗错误信息方面至关重要。本文全面综述了GenAI水印技术，从历史和监管角度阐述了水印的必要性，明确了水印的定义和理想特性，分析了现有方法的核心目标和威胁模型，并探讨了实用评估策略。此外，文章总结了代表性研究、现存挑战及未来方向，为研究者和政策制定者提供参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T23:02:07Z
- **目录日期**: 2025-06-14
