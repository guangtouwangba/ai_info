...
随着生成式AI（GenAI）输出的质量提升，区分AI与人类生成内容变得愈发困难。水印技术通过嵌入隐藏信号实现可靠检测，成为解决这一问题的有效方法。虽然水印并非应对GenAI所有风险的万能方案，但它能通过打击错误信息和欺骗行为，提升AI的安全性和可信度。本文全面综述了GenAI水印技术，从历史和监管角度探讨其必要性，明确了水印的定义与理想特性，分析了现有方法的核心目标和威胁模型，并研究了实用评估策略以开发抗攻击的鲁棒水印。此外，文章总结了代表性研究、开放挑战及未来方向，为研究者和政策制定者提供指导。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T19:03:01Z
- **目录日期**: 2025-06-14
