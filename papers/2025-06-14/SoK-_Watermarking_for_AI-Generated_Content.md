...
随着生成式AI（GenAI）输出的质量提升，区分AI与人类生成内容变得愈发困难。数字水印技术通过嵌入隐藏信号来可靠识别AI生成内容，成为解决该问题的有效方法。尽管水印并非应对GenAI所有风险的万能方案，但它能通过打击虚假信息增强AI的安全性和可信度。本文系统综述了GenAI水印技术，从历史与监管需求出发，定义了水印方案的核心属性和目标，分析了威胁模型及抗攻击评估策略，并总结了最新研究、现存挑战与未来方向，旨在为研究者和政策制定者提供技术参考与决策支持。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T20:02:28Z
- **目录日期**: 2025-06-14
