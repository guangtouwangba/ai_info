...
随着生成式AI（GenAI）输出的质量提升，区分AI与人类生成内容愈发困难。数字水印技术是一种有前景的解决方案，通过在AI生成内容中嵌入隐藏信号实现可靠检测。尽管水印不能完全解决GenAI的所有风险，但能通过打击错误信息和欺骗行为，提升AI的安全性和可信度。本文系统综述了GenAI水印技术，包括其历史与监管需求、定义、理想特性、核心目标及威胁模型，并探讨了实用评估策略以开发抗攻击的鲁棒水印方案。同时总结了代表性研究、开放挑战及未来方向，为研究者和政策制定者提供指导。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T08:02:12Z
- **目录日期**: 2025-06-14
