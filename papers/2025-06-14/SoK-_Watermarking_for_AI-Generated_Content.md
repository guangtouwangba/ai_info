...
随着生成式AI（GenAI）输出的质量提升，区分AI与人类生成内容变得愈发困难。数字水印技术成为解决该问题的有效方法，通过在AI生成内容中嵌入隐藏信号以实现可靠检测。尽管水印并非应对GenAI所有风险的万能方案，但它在打击错误信息和欺骗行为、增强AI安全性与可信度方面至关重要。本文系统梳理了GenAI水印技术，从历史与监管需求出发，形式化定义了水印方案及其理想特性，分析了现有方法的核心目标与威胁模型，并探讨了抗攻击鲁棒水印的评估策略。最后总结了代表性研究、开放挑战与未来方向，为研究者和政策制定者提供参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T01:29:35Z
- **目录日期**: 2025-06-14
