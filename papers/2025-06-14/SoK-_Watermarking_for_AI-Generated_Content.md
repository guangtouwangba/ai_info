...
随着生成式AI（GenAI）输出的质量提升，区分其与人类创作内容愈发困难。数字水印技术通过嵌入隐藏信号来识别AI生成内容，成为解决该问题的有效方法。尽管水印并非应对GenAI所有风险的万能方案，但它在打击虚假信息、增强AI安全性和可信度方面至关重要。本文系统梳理了GenAI水印技术，从历史与监管需求出发，定义了水印方案的标准与特性，分析了核心目标与威胁模型，并探讨了抗攻击的实用评估策略。同时综述了前沿研究，指出开放挑战与未来方向，为研究者和政策制定者提供参考框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T13:09:12Z
- **目录日期**: 2025-06-14
