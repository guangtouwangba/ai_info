...
随着生成式AI（GenAI）输出质量提升，区分AI与人类生成内容变得困难。水印技术通过嵌入隐藏信号实现可靠检测，成为解决该问题的有效方法。尽管水印不能完全消除GenAI的风险，但能通过打击虚假信息增强AI安全性和可信度。本文系统综述了GenAI水印技术，从历史与监管角度阐述其必要性，定义水印方案的核心属性和目标，分析威胁模型及抗攻击的评估策略。同时总结了代表性研究，指出开放挑战与未来方向，旨在推动水印技术发展，并为政策制定者应对GenAI的广泛影响提供参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T10:01:56Z
- **目录日期**: 2025-06-14
