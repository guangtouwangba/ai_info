...
随着生成式AI（GenAI）输出质量提升，区分其与人类创作内容愈发困难。数字水印技术成为解决这一问题的有效方法，通过在AI生成内容中嵌入隐藏信号实现可靠检测。尽管水印并非应对GenAI所有风险的万能方案，但它在打击错误信息和欺骗行为、增强AI安全性与可信度方面至关重要。本文系统综述了GenAI水印技术，包括历史与监管需求、水印定义与特性、核心目标与威胁模型，并探讨了抗攻击的鲁棒水印开发策略。同时分析了当前研究进展、开放挑战及未来方向，为研究者和政策制定者提供指导。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T21:02:23Z
- **目录日期**: 2025-06-14
