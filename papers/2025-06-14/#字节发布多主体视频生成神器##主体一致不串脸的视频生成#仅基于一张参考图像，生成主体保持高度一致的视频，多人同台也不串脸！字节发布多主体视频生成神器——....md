...
字节跳动发布多主体视频生成工具MAGREF，仅需单张参考图像即可生成主体高度一致的视频，支持多人同框且保持各自特征不"串脸"。该系统通过掩码引导和通道拼接技术，能处理不同风格、时代的输入素材，根据文本指令生成多样化动作、环境和光影效果。MAGREF在保持模型简洁的同时，实现了对人物、物体及背景的协调控制，确保视频序列中身份稳定、结构合理。该技术突破传统单主体生成的限制，为多角色互动场景提供高质量视频生成解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T03:21:37Z
- **目录日期**: 2025-06-14
