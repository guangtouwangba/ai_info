...
随着AI视频生成技术的快速发展，其真实性威胁到现实世界信息的可信度，催生了对AI生成视频检测器的需求。然而，高质量真实世界数据集的缺乏阻碍了可靠检测器的发展。为此，研究团队提出GenWorld——一个大规模、高质量、模拟真实场景的AI生成视频检测数据集，其特点包括：真实场景模拟、多先进模型生成的高质量伪造视频，以及跨提示多样性。研究发现现有方法难以检测世界模型生成的高质量视频，因此提出SpannDetector模型，利用多视角一致性作为检测标准，实验显示该方法效果显著。GenWorld有望推动AI生成视频检测领域发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T14:00:50Z
- **目录日期**: 2025-06-14
