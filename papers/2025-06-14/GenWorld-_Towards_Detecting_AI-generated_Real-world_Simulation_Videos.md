...
本文提出GenWorld，一个用于AI生成视频检测的大规模、高质量真实世界模拟数据集。该数据集具有三大特点：(1)真实场景模拟，关注具有现实影响力的视频；(2)采用多款先进视频生成模型，确保伪造视频的高质量；(3)包含多样生成器和多模态提示（文本/图像/视频），增强检测泛化性。研究发现现有方法难以检测世界模型生成的高质量视频，因此提出SpannDetector模型，利用多视角一致性作为检测标准。实验表明该方法效果显著，为基于物理合理性的可解释AI视频检测指明了新方向。项目页面已公开。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T02:29:54Z
- **目录日期**: 2025-06-14
