...
随着视频生成技术的快速发展，AI生成视频的检测需求日益迫切。本文提出GenWorld，一个高质量、大规模、模拟真实场景的AI生成视频检测数据集，涵盖多模态生成器（文本、图像、视频输入）的伪造视频。研究发现现有方法难以检测世界模型（如Cosmos）生成的高质量视频，因此提出SpannDetector模型，利用多视角一致性作为检测标准。实验表明该方法效果显著，为基于物理合理性的可解释检测提供了新方向。GenWorld将推动AI生成视频检测领域发展。项目页：https://chen-wl20.github.io/GenWorld

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T22:01:03Z
- **目录日期**: 2025-06-14
