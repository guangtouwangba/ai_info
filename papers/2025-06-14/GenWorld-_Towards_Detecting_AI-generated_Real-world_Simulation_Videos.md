...
随着视频生成技术的快速发展，AI生成视频的检测需求日益迫切。针对现有高质量真实世界数据集的不足，本文提出了GenWorld——一个大规模、高质量、模拟真实场景的AI生成视频检测数据集。GenWorld采用多种先进视频生成模型，涵盖多模态提示（文本/图像/视频），确保数据多样性和真实性。研究发现现有方法难以检测世界模型（如Cosmos）生成的高质量视频，因此提出了基于多视角一致性的SpannDetector模型。实验表明该方法效果显著，为基于物理合理性的可解释AI视频检测提供了新方向。项目页面：https://chen-wl20.github.io/GenWorld

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T16:00:54Z
- **目录日期**: 2025-06-14
