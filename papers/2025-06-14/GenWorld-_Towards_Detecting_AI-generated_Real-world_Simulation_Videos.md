...
视频生成技术的快速发展威胁了真实信息的可信度，加剧了对AI生成视频检测的需求。然而，高质量真实场景数据集的缺乏阻碍了可靠检测器的发展。为此，研究者提出了**GenWorld**——一个大规模、高质量、模拟真实场景的AI生成视频检测数据集，其特点包括：真实场景模拟、多模态生成（文本/图像/视频输入）以及跨模型多样性。研究发现现有方法难以检测世界模型（如Cosmos）生成的高质量视频，因此提出**SpannDetector**模型，通过多视角一致性检测提升效果。实验表明该方法在物理合理性解释方向具有潜力。数据集地址：https://chen-wl20.github.io/GenWorld

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T12:01:02Z
- **目录日期**: 2025-06-14
