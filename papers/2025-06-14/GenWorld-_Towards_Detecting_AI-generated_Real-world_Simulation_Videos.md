...
本文提出GenWorld，一个高质量、大规模的真实世界模拟数据集，用于AI生成视频检测。GenWorld具有三大特点：(1)真实场景模拟，聚焦具有现实影响力的视频；(2)采用多种先进视频生成模型，确保伪造视频的高质量；(3)包含多样化的生成器和提示模态（文本、图像、视频），增强检测模型的泛化能力。研究发现现有方法难以检测世界模型（如Cosmos）生成的高质量视频，为此提出SpannDetector模型，利用多视角一致性作为检测标准。实验表明该方法效果显著，为基于物理合理性的可解释AI视频检测提供了新方向。项目页面：https://chen-wl20.github.io/GenWorld

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T09:00:53Z
- **目录日期**: 2025-06-14
