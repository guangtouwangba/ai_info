...
随着视频生成技术的快速发展，AI生成视频的检测需求日益迫切。针对现有高质量真实场景数据集的缺乏，本文提出GenWorld——一个大规模、高质量、模拟真实场景的AI生成视频检测数据集。该数据集具有真实场景模拟、高质量生成和跨提示多样性三大特点，涵盖多种生成模型和输入模态。研究发现现有方法难以检测世界模型（如Cosmos）生成的高质量视频，因此提出SpannDetector模型，利用多视角一致性作为检测标准。实验表明该方法效果显著，为基于物理合理性的可解释AI视频检测提供了新方向。项目页面：https://chen-wl20.github.io/GenWorld

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T13:07:10Z
- **目录日期**: 2025-06-14
