...
本文提出GenWorld数据集，用于提升AI生成视频的检测能力。该数据集具有三大特点：1) 模拟真实场景的高质量伪造视频；2) 采用多种先进视频生成模型；3) 包含跨提示模态的多样性样本。研究发现现有方法难以检测世界模型(如Cosmos)生成的高质量视频，为此提出SpannDetector模型，利用多视角一致性作为检测标准。实验表明该方法效果显著，为基于物理合理性的可解释检测提供了新方向。GenWorld有望推动AI生成视频检测领域发展。项目页面：https://chen-wl20.github.io/GenWorld

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T00:01:06Z
- **目录日期**: 2025-06-14
