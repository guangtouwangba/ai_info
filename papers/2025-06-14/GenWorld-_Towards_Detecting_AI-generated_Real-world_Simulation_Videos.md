...
随着视频生成技术的快速发展，AI生成视频的真实性威胁到现实世界信息的可信度，亟需开发可靠的检测工具。针对现有高质量真实场景数据集的不足，研究者提出了GenWorld数据集，其特点包括：(1) 模拟真实场景视频；(2) 采用多类先进模型生成高质量伪造视频；(3) 包含多种生成方式和提示模态。研究发现现有方法难以检测世界模型(如Cosmos)生成的高质量视频，因此提出了SpannDetector模型，利用多视角一致性作为检测标准。实验表明该方法效果显著，为基于物理合理性的可解释AI视频检测提供了新方向。GenWorld将推动该领域发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T03:19:21Z
- **目录日期**: 2025-06-14
