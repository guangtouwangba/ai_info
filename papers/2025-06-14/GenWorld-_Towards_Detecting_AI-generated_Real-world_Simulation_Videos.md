...
本文提出了GenWorld，一个高质量、大规模的真实世界模拟数据集，用于检测AI生成的视频。GenWorld包含多种先进视频生成模型产生的逼真伪造视频，涵盖不同生成器和提示模态（如文本、图像、视频），以提高检测模型的泛化能力。研究发现现有方法难以检测世界模型（如Cosmos）生成的高质量视频，因此提出SpannDetector模型，利用多视角一致性作为检测标准。实验表明该方法效果显著，为基于物理合理性的可解释AI视频检测提供了新方向。GenWorld有望推动AI生成视频检测领域的发展。项目页面：https://chen-wl20.github.io/GenWorld

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T05:00:56Z
- **目录日期**: 2025-06-14
