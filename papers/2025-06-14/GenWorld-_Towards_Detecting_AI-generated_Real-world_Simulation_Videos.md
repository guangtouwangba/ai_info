...
随着视频生成技术的快速发展，AI生成视频的检测需求日益迫切。然而，高质量真实世界数据集的缺乏阻碍了可靠检测器的发展。为此，研究者提出了GenWorld数据集，具有三大特点：(1) 模拟真实场景；(2) 采用先进生成模型制作高质量伪造视频；(3) 包含多种生成器和提示方式以增强泛化性。分析发现现有方法难以检测世界模型生成的视频，因此提出了SpannDetector模型，利用多视角一致性作为检测标准。实验表明该方法效果显著，为基于物理合理性的可解释检测提供了新方向。GenWorld有望推动AI生成视频检测领域的发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T10:00:49Z
- **目录日期**: 2025-06-14
