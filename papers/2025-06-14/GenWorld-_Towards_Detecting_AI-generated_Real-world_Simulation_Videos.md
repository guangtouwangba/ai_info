...
本文提出了GenWorld，一个用于AI生成视频检测的大规模、高质量、真实场景模拟数据集。该数据集具有三大特点：真实场景模拟、高质量伪造视频（使用多种先进生成模型）、跨提示多样性（涵盖多种生成器和提示模态）。研究发现现有方法难以检测世界模型生成的高质量视频，因此提出了SpannDetector模型，利用多视角一致性作为检测标准。实验表明该方法效果显著，为基于物理合理性的可解释AI视频检测提供了新方向。GenWorld有望推动AI生成视频检测领域发展。项目页面：https://chen-wl20.github.io/GenWorld

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T07:00:55Z
- **目录日期**: 2025-06-14
