...
以色列魏茨曼科学研究所最新研究发现，人类呼吸模式具有类似指纹的独特性，个体识别准确率达96.8%。通过可穿戴设备监测发现，不同心理状态对应特定呼吸特征：焦虑者吸气时间短、夜间呼吸变化大；抑郁者呼气停顿长、吸气峰值高；自闭特质者睡眠时吸气暂停久且不规律。研究提出"呼吸影响情绪"的新视角，认为引导健康呼吸模式或能改善心理健康。目前正计划通过实验验证模仿健康呼吸节奏是否能降低焦虑抑郁评分（典型相关分析显示呼吸特征与心理量表相关性达r=0.87）。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T21:03:10Z
- **目录日期**: 2025-06-14
