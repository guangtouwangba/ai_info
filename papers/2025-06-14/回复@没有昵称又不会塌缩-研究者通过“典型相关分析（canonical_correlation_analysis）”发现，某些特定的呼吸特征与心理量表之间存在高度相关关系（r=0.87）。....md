...
以色列魏茨曼科学研究所最新研究发现，人类具有独特的"呼吸指纹"，个体识别准确率达96.8%。研究通过可穿戴设备监测发现，呼吸模式能反映心理状态：焦虑者吸气时间短、夜间呼吸变化大；抑郁者呼气停顿长、吸气峰值高；自闭特质者睡眠时吸气暂停久且不规律。研究者提出"呼吸影响情绪"的逆向视角，认为引导健康呼吸模式可能改善身心健康。该研究暗示呼吸特征与心理状态存在高度相关(r=0.87)，后续将验证通过调节呼吸改善情绪的效果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T18:04:53Z
- **目录日期**: 2025-06-14
