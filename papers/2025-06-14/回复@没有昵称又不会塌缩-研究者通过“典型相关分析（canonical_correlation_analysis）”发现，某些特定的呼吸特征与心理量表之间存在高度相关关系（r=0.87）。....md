...
以色列魏茨曼科学研究所最新研究发现，人类具有独特的"呼吸指纹"，个体识别准确率达96.8%。通过分析100名志愿者的呼吸数据，研究发现呼吸模式与心理状态存在显著关联：焦虑者吸气时间短、夜间呼吸变化大；抑郁者呼气停顿长、吸气峰值高；自闭特质者睡眠时吸气暂停更久。研究提出"呼吸影响情绪"的逆向视角，认为引导健康呼吸模式可能改善心理健康。该成果为通过呼吸监测心理状态提供了新思路，相关论文已发表在Medical Xpress平台。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T23:02:51Z
- **目录日期**: 2025-06-14
