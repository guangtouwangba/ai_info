...
以色列魏茨曼科学研究所最新研究发现，人类呼吸具有类似指纹的独特性，个体识别准确率达96.8%。研究还揭示呼吸模式与心理状态的关联：焦虑者吸气时间短，抑郁者呼气停顿长，自闭特质者睡眠时呼吸不规律。研究者提出"呼吸影响情绪"的逆向视角，认为通过调整呼吸模式可能改善心理健康。该研究使用可穿戴设备监测100名志愿者日常活动中的呼吸数据，发现这些特征具有长期稳定性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T15:02:57Z
- **目录日期**: 2025-06-14
