...
夸克推出了国内首个免费高考志愿填报大模型AI，可在5分钟内生成包含近百个志愿的完整报告。该AI将院校分为冲击层、稳妥层和保底层三个层级，并基于考生情况提供详细分析，号称浓缩了数百位专家的智慧。相比动辄数千元的人工咨询服务（仅2%考生使用），这一免费AI工具旨在解决大多数考生依赖自行搜集信息的痛点。不过其推荐准确性和可靠性仍需实际验证，但已展现出替代传统高价志愿咨询服务的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T11:03:07Z
- **目录日期**: 2025-06-14
