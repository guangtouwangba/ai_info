...
夸克发布了国内首个免费高考志愿大模型，5分钟内可生成完整志愿报告。该AI基于数百位专家经验，将院校分为冲击层（19所）、稳妥层（38所）和保底层（39所），提供近100个志愿明细。相比动辄数千元的人工咨询服务（仅2%考生使用），该技术旨在解决传统志愿填报信息差问题，以AI替代高价咨询。目前需验证其可靠性，但已展现通过技术降低教育信息门槛的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T14:03:46Z
- **目录日期**: 2025-06-14
