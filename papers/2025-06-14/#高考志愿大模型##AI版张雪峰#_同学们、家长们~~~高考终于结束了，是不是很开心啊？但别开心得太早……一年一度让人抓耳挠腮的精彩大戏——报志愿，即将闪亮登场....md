...
夸克发布了国内首个免费高考志愿大模型，5分钟生成完整志愿报告，包含考生分析、核心策略及近100个志愿明细表，并按"冲击/稳妥/保底"三层次分类推荐院校。该AI模型整合数百位专家经验，旨在解决传统志愿咨询价格高（数千至上万元）、覆盖率低（仅2%考生使用）的问题，提供更普惠的智能填报方案。目前需验证其推荐准确性，但已展现替代高价人工咨询的潜力，被网友称为"AI版张雪峰"。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T22:03:09Z
- **目录日期**: 2025-06-14
