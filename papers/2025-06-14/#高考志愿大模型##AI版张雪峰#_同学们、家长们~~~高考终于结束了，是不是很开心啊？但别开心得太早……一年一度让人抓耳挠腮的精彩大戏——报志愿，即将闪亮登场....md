...
夸克发布了国内首个免费高考志愿大模型AI，可在5分钟内生成完整志愿报告。该AI基于数百位专家经验，将院校分为冲击层、稳妥层和保底层，提供近百个志愿明细，并给出核心填报策略。相比动辄数千元的人工咨询服务（仅2%考生使用），该AI解决方案旨在降低门槛，帮助更多考生科学填报志愿。目前其准确性和可靠性仍需进一步验证，但已展现出替代传统高价咨询服务的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T12:03:03Z
- **目录日期**: 2025-06-14
