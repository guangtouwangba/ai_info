...
夸克推出了国内首个免费高考志愿大模型，5分钟即可生成完整志愿报告，包含考生分析、核心策略及近100个志愿推荐，分为冲击层、稳妥层和保底层三个梯度。该AI系统整合了数百位专家经验，旨在解决传统高价志愿咨询（收费数千至上万元）覆盖率不足2%的问题，为考生提供高效、免费的智能填报方案。目前需验证其推荐准确性和技术可靠性，但已展现替代人工咨询的潜力，被网友称为"AI版张雪峰"。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T10:02:03Z
- **目录日期**: 2025-06-14
