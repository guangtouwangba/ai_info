...
大型语言模型(LLM)代理在解决数据科学问题方面潜力巨大，但现有框架依赖固定流程和编码策略，难以处理复杂任务。为此，研究人员提出AutoMind框架，通过三个关键创新：(1)专家知识库提供领域知识支持；(2)知识树搜索算法探索解决方案；(3)自适应编码策略动态调整代码生成。实验表明，AutoMind在自动化数据科学基准测试中优于现有方法，展现出高效、稳健的性能，为实现完全自动化的数据科学迈出重要一步。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T08:01:01Z
- **目录日期**: 2025-06-14
