...
大型语言模型(LLM)代理在解决现实数据科学问题方面潜力巨大，但现有框架依赖固定流程和编码策略，仅能处理简单问题。为此，研究者提出了AutoMind框架，通过三个关键创新：(1)专家知识库提供领域知识支持，(2)基于知识的树搜索算法探索解决方案，(3)自适应编码策略动态调整代码生成。实验表明，AutoMind在自动化数据科学基准测试中优于现有方法，展现出高效、稳健的性能，为实现完全自动化的数据科学迈出了重要一步。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T12:01:09Z
- **目录日期**: 2025-06-14
