...
大型语言模型(LLM)代理在解决现实数据科学问题方面潜力巨大，但现有框架依赖固定流程，仅能处理简单问题。本文提出的AutoMind框架通过三个关键创新克服了这些局限：(1)构建专家知识库增强领域专业性；(2)采用知识树搜索算法战略性地探索解决方案；(3)开发自适应编码策略动态调整代码生成。在两个自动化数据科学基准测试中，AutoMind表现优于现有最优方法，验证了其在效率、质量和鲁棒性方面的优势，为实现完全自动化的数据科学迈出了重要一步。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T04:02:14Z
- **目录日期**: 2025-06-14
