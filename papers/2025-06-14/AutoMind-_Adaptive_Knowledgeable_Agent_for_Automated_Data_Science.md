...
大型语言模型(LLM)代理在解决现实数据科学问题方面潜力巨大，但现有框架依赖刚性工作流程和固定编码策略，仅适用于简单问题。为此，研究者提出了AutoMind框架，通过三个关键创新克服了这些局限：(1)构建专家知识库以提供领域专业知识；(2)采用知识引导的树搜索算法进行策略性解决方案探索；(3)使用自适应编码策略根据任务复杂度动态调整代码生成。在自动化数据科学基准测试中，AutoMind表现优于现有最优方法，在有效性、效率和解决方案质量方面均展现出优势，推动了数据科学全自动化的发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T06:01:12Z
- **目录日期**: 2025-06-14
