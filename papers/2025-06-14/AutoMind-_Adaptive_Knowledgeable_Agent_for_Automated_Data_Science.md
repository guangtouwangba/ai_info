...
大型语言模型(LLM)代理在解决现实数据科学问题方面潜力巨大，但现有框架依赖固定流程和编码策略，仅适用于简单问题。为此，研究团队提出AutoMind框架，通过三大创新突破局限：(1)构建专家知识库提供领域专业知识；(2)采用知识树搜索算法策略性探索解决方案；(3)开发自适应编码策略动态调整代码生成。在两项自动化数据科学基准测试中，AutoMind表现优于现有最优方法，展现出卓越的效率、鲁棒性和解决方案质量，为完全自动化数据科学迈出重要一步。(98字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T18:01:23Z
- **目录日期**: 2025-06-14
