...
该研究探讨了大型语言模型(LLMs)与人类偏好对齐中的"认知摩擦"问题，即当新信息与现有信念冲突时产生的整合阻力。作者提出"动态认知摩擦"概念，将其定义为代理当前信念状态与外部证据支持的新命题之间的错位，并基于动态认知逻辑框架进行分析。研究表明，该模型能有效预测对话中的信念更新，并指出将信念对齐作为认知阻力测量指标的方法可进一步优化，以适应现实对话场景的复杂性。这为提升人机协作中LLMs的认知整合能力提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T08:01:46Z
- **目录日期**: 2025-06-14
