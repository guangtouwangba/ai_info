...
该研究探讨了大型语言模型（LLM）与人类协作中的"认知摩擦"问题，即模型在面对新信息时更新信念的阻力。作者提出"动态认知摩擦"概念，定义为智能体现有信念与外部证据支持的新命题之间的错位，并将其置于动态认知逻辑框架下分析。研究表明，这种认知摩擦模型能有效预测对话中的信念更新，并指出通过衡量认知阻力或摩擦，可以使信念对齐模型更复杂化，从而适应现实对话场景的复杂性。这一发现对改进人机协作中LLM的适应性具有重要意义。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T19:02:25Z
- **目录日期**: 2025-06-14
