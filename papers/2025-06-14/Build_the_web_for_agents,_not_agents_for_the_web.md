...
这篇立场论文主张改变当前网页代理的研究范式，提出应开发专为AI代理优化的新型交互界面——"代理式网页界面"（AWI），而非让人工智能适应人类设计的界面。现有方法在处理复杂网页输入时存在根本性局限，无论是解析DOM树、依赖增强截图还是通过API交互。AWI基于六大设计原则，强调安全性、效率和标准化，旨在克服现有界面的根本缺陷，为更高效、可靠、透明的网页代理设计铺路。这需要机器学习社区的广泛协作，推动网页任务自动化的发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T09:01:22Z
- **目录日期**: 2025-06-14
