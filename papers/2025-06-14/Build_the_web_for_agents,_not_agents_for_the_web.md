...
这篇立场论文提出，当前基于大语言模型（LLM）的网页代理面临核心挑战：人类界面设计与AI能力不匹配。为解决这一问题，作者主张开发专为AI优化的新型交互范式——"代理式网页界面"（AWI），而非让AI适应人类界面。AWI设计遵循六大原则，强调安全性、效率和标准化，平衡各方利益相关者需求。这一转变旨在克服现有界面的根本局限，推动更高效、可靠和透明的网页代理设计，需要机器学习社区的广泛协作。该范式将改变网页代理研究方向，从被动适应转为主动设计AI友好界面。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T06:01:35Z
- **目录日期**: 2025-06-14
