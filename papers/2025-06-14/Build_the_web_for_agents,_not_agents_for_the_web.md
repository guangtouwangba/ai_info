...
这篇立场论文提出，当前基于大语言模型（LLM）的网页代理面临核心挑战：人类界面与AI能力不匹配。为解决这一问题，作者主张开发专为AI优化的"代理式网页界面"（AWI），而非让AI适应人类界面。AWI基于六大设计原则（安全性、效率、标准化等），旨在平衡各方利益，克服现有界面的根本局限。这种新范式将推动更高效、可靠、透明的网页代理发展，需要机器学习社区的广泛协作。该转变将改变网页代理研究范式，从被动适应转为主动设计AI友好型交互界面。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T15:01:25Z
- **目录日期**: 2025-06-14
