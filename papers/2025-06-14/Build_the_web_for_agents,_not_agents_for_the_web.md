...
这篇立场论文主张改变网页代理的研究范式，提出应开发专为AI代理优化的新型交互界面——Agentic Web Interface (AWI)，而非迫使代理适应人类设计的界面。当前方法面临网页输入复杂性的挑战，如处理庞大的DOM树或依赖增强截图。AWI基于六大设计原则，强调安全性、效率和标准化，旨在克服现有界面的根本限制，为更高效、可靠和透明的网页代理设计铺路。这一转变需要机器学习社区的广泛协作，以平衡各方利益，推动网页任务自动化的发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T18:02:00Z
- **目录日期**: 2025-06-14
