...
这篇立场论文主张改变网页代理的研究范式，提出应开发专为AI代理优化的新型交互界面——Agentic Web Interface (AWI)，而非让人工智能适应人类设计的界面。当前基于大语言模型(LLMs)的网页代理面临网页输入复杂性的挑战，如处理庞大DOM树或依赖增强截图等方法。AWI基于六大设计原则，注重安全性、效率和标准化，旨在克服现有界面的根本限制，为更高效、可靠和透明的网页代理设计铺平道路。这一转变需要机器学习社区的广泛协作，以实现自动化复杂网页交互的巨大潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T07:01:32Z
- **目录日期**: 2025-06-14
