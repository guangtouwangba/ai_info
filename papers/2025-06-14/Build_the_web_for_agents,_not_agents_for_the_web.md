...
这篇立场论文主张改变网页代理的研究范式，提出开发专为AI代理优化的新型交互界面——Agentic Web Interface (AWI)。当前基于大型语言模型(LLM)的网页代理面临核心挑战：人类设计的界面与AI能力不匹配。现有方法在处理复杂DOM树、依赖增强截图或通过API绕过界面时效果有限。AWI遵循六大设计原则，强调安全性、效率和标准化，平衡各方利益。这一转变旨在突破现有界面的根本限制，推动更高效、可靠、透明的网页代理发展，需要机器学习社区的广泛协作。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T22:01:32Z
- **目录日期**: 2025-06-14
