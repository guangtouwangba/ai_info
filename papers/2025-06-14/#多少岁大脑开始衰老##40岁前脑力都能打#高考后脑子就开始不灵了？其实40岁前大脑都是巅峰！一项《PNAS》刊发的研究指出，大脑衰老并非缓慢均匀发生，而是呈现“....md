...
《PNAS》研究显示，大脑衰老呈"S型"非线性变化：43.7岁前衰退缓慢，之后加速，66.7岁达最不稳定点。神经元胰岛素抵抗是主因，影响葡萄糖供能。研究发现酮体可作为替代能量，40-59岁人群服用后脑稳定性提升最显著（比20岁组高85%），60岁以上效果减弱。中年（40岁左右）是大脑衰老转折点，也是干预黄金窗口期。研究基于近2万人的fMRI数据，提示中年阶段是预防认知衰退的关键时期。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T21:02:41Z
- **目录日期**: 2025-06-14
