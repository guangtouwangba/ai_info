...
以色列魏茨曼科学研究所最新研究发现，人类呼吸模式具有独特性，可作为"呼吸指纹"识别个体，准确率达96.8%。研究通过可穿戴设备监测100名志愿者日常活动数据，发现呼吸模式能稳定保持一年以上。研究还揭示呼吸特征与心理状态的关联：焦虑者吸气时间短、夜间呼吸变化大；抑郁倾向者呼气停顿长；自闭特质者睡眠时呼吸不规律。研究者提出呼吸可能影响情绪的新观点，认为调节呼吸模式或能改善身心健康。该发现为健康监测和心理评估提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T10:02:28Z
- **目录日期**: 2025-06-14
