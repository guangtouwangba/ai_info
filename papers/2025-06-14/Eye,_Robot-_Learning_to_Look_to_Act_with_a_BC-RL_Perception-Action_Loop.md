...
研究人员开发了EyeRobot系统，通过强化学习训练机械眼球自主注视策略，实现手眼协同操作。该系统采用360°摄像头收集演示数据，在仿真环境中训练眼球注视策略，并引入BC-RL联合训练框架：手部(BC)根据眼球观察生成动作，眼球(RL)则在手部预测正确时获得奖励。这种机制使眼球自然聚焦于任务相关区域，采用类似人类中央凹的高分辨率视觉架构，在低计算成本下实现稳定注视和抗干扰能力。实验表明，EyeRobot能在单摄像头支持下有效完成大范围全景操作任务。项目网站：https://www.eyerobot.net/ (100字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T01:28:47Z
- **目录日期**: 2025-06-14
