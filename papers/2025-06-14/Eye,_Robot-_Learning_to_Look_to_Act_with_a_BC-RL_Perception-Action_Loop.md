...
研究人员开发了EyeRobot系统，通过强化学习训练机械眼球自主注视策略，实现手眼协同完成任务。该系统采用360°摄像头采集演示数据，在仿真环境中训练手部（行为克隆）和眼部（强化学习）策略：手部基于眼球观测执行动作，眼部通过手部动作准确性获得奖励。眼球采用类似人类中央凹的高分辨率策略架构，能稳定注视并追踪目标。在5个环绕机械臂的全景操作任务测试中，EyeRobot展示了高效的大范围手眼协调能力，仅用单摄像头即可完成操作。项目详情见：https://www.eyerobot.net/ （98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T22:01:18Z
- **目录日期**: 2025-06-14
