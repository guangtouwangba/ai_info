...
这篇论文介绍了EyeRobot系统，它模仿人类主动观察行为，通过强化学习训练机械眼球完成现实任务。研究团队开发了可自由旋转的机械眼球，并收集了360度摄像头与遥控操作的演示数据。在模拟环境中，他们采用BC-RL联合训练方法：手部(BC)从眼球视角学习动作，而眼球(RL)通过手部动作准确性获得奖励，从而自然形成手眼协调。该系统采用类似中央凹的高分辨率策略架构，能稳定注视并追踪目标。在5个全景工作空间操作任务测试中，EyeRobot仅用单个摄像头就实现了大范围的有效操作。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T18:01:32Z
- **目录日期**: 2025-06-14
