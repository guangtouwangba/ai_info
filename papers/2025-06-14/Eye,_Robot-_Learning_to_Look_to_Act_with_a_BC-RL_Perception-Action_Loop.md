...
研究人员开发了EyeRobot系统，通过机械眼球和强化学习实现任务驱动的主动注视行为。该系统采用360°摄像头采集数据，在仿真环境中训练手-眼协调策略：手部（模仿学习）根据眼球观测执行动作，眼球（强化学习）通过优化手部动作准确性获得奖励。其仿人眼中央凹的架构能以低计算成本实现高分辨率观测，并表现出稳定注视、目标追踪和抗干扰能力。在5种环绕式操作任务测试中，EyeRobot单摄像头系统能有效支持大范围工作空间的操作。项目详情见：https://www.eyerobot.net/（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T14:01:09Z
- **目录日期**: 2025-06-14
