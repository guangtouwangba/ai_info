...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可以模拟10,000多个智能代理的社会互动（500万次交互）。该系统被用于研究四大社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。研究结果显示，模拟结果与现实世界数据高度吻合，验证了该系统在揭示人类行为机制方面的有效性。这表明AgentSociety能作为计算社会科学的有力工具，为研究者和政策制定者提供新的研究方法，补充传统调查和实验的不足。该系统展现了LLM在社会模拟中的巨大潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T11:04:14Z
- **目录日期**: 2025-06-14
