...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个智能代理的社会互动（500万次交互）。该系统通过四个社会问题案例（社会极化、信息传播、基本收入政策、自然灾害影响）验证其有效性，模拟结果与现实研究数据高度吻合。研究表明，AgentSociety能有效捕捉人类行为机制，为社会科学研究和政策制定提供新工具，可作为传统研究方法（如调查、实验）的有力补充。该系统展示了LLM驱动代理在理解复杂社会现象方面的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T16:06:01Z
- **目录日期**: 2025-06-14
