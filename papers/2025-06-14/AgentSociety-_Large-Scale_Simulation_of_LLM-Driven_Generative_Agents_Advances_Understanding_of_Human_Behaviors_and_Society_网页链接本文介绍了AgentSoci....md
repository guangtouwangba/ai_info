...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理的社会互动（达500万次）。研究者用它作为计算社会科学实验平台，研究了四大社会问题：群体极化、敏感信息传播、基本收入政策效果和自然灾害影响。模拟结果与现实世界数据高度吻合，验证了该系统在捕捉人类行为机制方面的准确性。该平台能有效辅助传统研究方法（如调查和干预实验），为社会科学研究和政策制定提供了创新工具。研究展示了AI模拟在理解复杂社会现象方面的巨大潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T19:08:03Z
- **目录日期**: 2025-06-14
