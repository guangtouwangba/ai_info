...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟10,000多个智能代理及其500万次互动。该系统通过四个社会问题研究（社会极化、信息传播、基本收入政策、自然灾害影响），验证了其模拟结果与现实世界数据的一致性。研究表明，AgentSociety能有效捕捉人类行为机制，可作为社会科学研究和政策制定的创新工具，补充传统研究方法如调查和实验。该系统展示了LLM驱动模拟在理解复杂社会现象方面的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T15:04:21Z
- **目录日期**: 2025-06-14
