...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟1万多个代理的社会互动（500万次交互）。它通过研究社会极化、信息传播、基本收入政策及自然灾害影响等案例，验证了其模拟结果与现实世界数据的一致性。该系统能有效捕捉人类行为机制，为社会科学研究和政策制定提供新工具，补充传统调查和实验方法。研究表明，这种LLM驱动的模拟技术有助于深入理解复杂社会现象及其潜在规律。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T01:31:27Z
- **目录日期**: 2025-06-14
