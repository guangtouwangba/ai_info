...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟10,000多个智能代理及其500万次互动。该系统通过真实社会环境模拟，研究了社会极化、信息传播、基本收入政策及自然灾害影响等社会问题。结果显示其模拟结果与现实实验数据高度吻合，验证了系统捕捉人类行为机制的能力。该平台为社会科学研究和政策制定提供了新工具，能有效补充传统研究方法（如调查和访谈），帮助深入理解社会问题的成因和潜在机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T02:33:08Z
- **目录日期**: 2025-06-14
