...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟超过1万个AI代理及其500万次社会互动。研究者通过该系统研究了四个关键社会问题：群体极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，验证了该系统在分析人类行为机制和社会问题方面的有效性。该平台可作为传统社会科学研究方法的补充工具，帮助学者和政策制定者理解复杂社会现象的内在机制。研究成果展示了AI模拟在社会科学领域的应用潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T14:05:13Z
- **目录日期**: 2025-06-14
