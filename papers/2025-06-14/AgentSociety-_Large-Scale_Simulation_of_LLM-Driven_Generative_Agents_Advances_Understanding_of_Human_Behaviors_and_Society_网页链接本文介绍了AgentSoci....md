...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟1万多个代理及其500万次互动。研究者用它分析社会极化、信息传播、基本收入政策及飓风影响等社会问题，结果与现实数据吻合。该系统展示了作为社会科学和政策研究工具的潜力，能有效捕捉人类行为机制，辅助传统研究方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-14T03:22:22Z
- **目录日期**: 2025-06-14
