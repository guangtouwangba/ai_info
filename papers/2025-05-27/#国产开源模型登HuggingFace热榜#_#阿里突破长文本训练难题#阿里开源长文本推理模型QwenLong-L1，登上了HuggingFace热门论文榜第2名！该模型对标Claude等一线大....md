...
阿里开源长文本推理模型QwenLong-L1登上HuggingFace热榜第二名。该模型通过两阶段训练（预训练+强化学习）和分阶段扩展上下文（最大支持128K token），解决了长文本干扰多、易跑偏的难题。其混合奖励机制结合规则校验和语义评估，并针对难题反复训练，使32B版本以70.7分超越部分主流模型，14B版本性能提升4.1分。研究表明，强化学习能赋予模型"设子目标""回溯验证"等类人推理能力，显著优于仅用监督学习的效果。模型特别适用于金融文档等复杂长文本场景。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T10:03:29Z
- **目录日期**: 2025-05-27
