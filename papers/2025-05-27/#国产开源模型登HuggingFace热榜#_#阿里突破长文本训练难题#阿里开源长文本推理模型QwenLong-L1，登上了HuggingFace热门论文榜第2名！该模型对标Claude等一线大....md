...
阿里开源的长文本推理模型QwenLong-L1登上HuggingFace热门论文榜第二名。该模型通过两阶段训练（预训练+强化学习）和分阶段扩展上下文（最大128K token），解决了传统模型在长文本中易受干扰的问题。其混合奖励机制结合规则和语义评估，并针对难题反复训练，显著提升推理稳定性。32B版本性能达70.7分，超越部分主流模型，14B版本也比基础模型平均提升4.1分。研究表明强化学习能赋予模型类人的"子目标设定"和"信息验证"能力，突破长文本训练瓶颈。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T13:13:24Z
- **目录日期**: 2025-05-27
