...
阿里开源的长文本推理模型QwenLong-L1登上HuggingFace热榜第二名，突破长文本训练难题。该模型通过两阶段训练（预训练+强化学习）和分阶段扩展上下文（最高支持128K token），结合混合奖励机制和难题强化训练，显著提升长文本理解能力。其32B版本性能达70.7分，超越部分主流模型，14B版本也比基础模型提升4.1分。研究显示强化学习能有效帮助模型学会"子目标规划"和"信息验证"，解决传统方法在金融等复杂场景中易受干扰的问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T23:03:48Z
- **目录日期**: 2025-05-27
