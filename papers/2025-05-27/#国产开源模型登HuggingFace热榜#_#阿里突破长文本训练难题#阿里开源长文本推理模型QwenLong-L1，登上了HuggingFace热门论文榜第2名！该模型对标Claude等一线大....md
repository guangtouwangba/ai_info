...
阿里开源的长文本推理模型QwenLong-L1登上HuggingFace热榜第二。该模型通过两阶段训练（预训练+强化学习）和分阶段扩展上下文（最高128K token），解决了长文本干扰多、易跑偏的问题。其混合奖励机制结合规则验证和语义评估，并针对难题反复训练，显著提升推理稳定性。32B版本性能达70.7分，超越部分主流模型，14B版本也比基础模型提升4.1分。研究显示强化学习能有效培养模型"反思验证"能力，突破传统监督学习的表面套路局限。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T22:03:44Z
- **目录日期**: 2025-05-27
