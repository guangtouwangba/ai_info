...
阿里开源的长文本推理模型QwenLong-L1登上HuggingFace热榜第二，主打128K上下文处理能力。其通过两阶段训练（预训练+强化学习）和分阶段扩展上下文长度，结合混合奖励机制和难题重点训练，显著提升长文本理解与推理性能。32B版本以70.7分超越部分主流模型，14B版本较基础模型提升4.1分。研究显示强化学习能赋予模型"子目标规划""信息验证"等类人推理能力，有效解决传统模型在金融等长文本场景中易受干扰的问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T14:04:17Z
- **目录日期**: 2025-05-27
