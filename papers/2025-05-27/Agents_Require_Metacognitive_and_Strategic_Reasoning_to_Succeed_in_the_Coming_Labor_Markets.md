...
当前劳动力市场深受信息不完全导致的经济力量影响，包括逆向选择、道德风险和声誉问题。即便引入AI代理后，这些因素仍将发挥作用，因此代理需具备元认知和战略推理能力。元认知是**内部推理**，包括自我评估、任务理解和策略评估；战略推理是**外部推理**，涉及对其他市场参与者（如竞争者、同事）的认知、战略决策及长期学习。代理需结合这两种推理，在职场内外采取行动。研究已探索相关方向，但仍需进一步开发。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T16:01:55Z
- **目录日期**: 2025-05-27
