...
当前劳动力市场深受逆向选择、道德风险和声誉等不完全信息经济力量的影响。即便引入AI代理后，这些因素仍将持续发挥作用，因此代理需具备元认知和战略推理能力。元认知是包含自我评估、任务理解和策略评价的内部推理；战略推理则是关于竞争对手等市场参与者的外部推理，包括制定策略和持续学习。两类推理对代理在职场内外的决策都至关重要。研究正在探索这些能力，但仍需进一步发展相关领域。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T04:05:15Z
- **目录日期**: 2025-05-27
