...
当前劳动力市场深受信息不对称引发的逆向选择、道德风险和声誉问题影响。即便引入AI代理后，这些经济力量仍将持续作用，因此代理需要具备元认知和战略推理能力。元认知是涉及自我评估、任务理解和策略评价的内部推理；战略推理则是关于理解市场参与者（如竞争者、同事）、制定策略和持续学习的外部推理。AI代理在职场内外决策时需综合运用这两种推理能力。现有研究已开始探索这些方向，但仍需进一步发展相关技术。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T21:01:53Z
- **目录日期**: 2025-05-27
