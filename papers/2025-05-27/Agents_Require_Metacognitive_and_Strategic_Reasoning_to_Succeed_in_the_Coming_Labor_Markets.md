...
当前劳动力市场深受信息不对称带来的逆向选择、道德风险和声誉问题影响。即便引入AI代理后，这些经济力量仍将持续发挥作用，因此代理必须具备元认知和战略推理能力。元认知作为内部推理，包括自我评估、任务理解和策略评价；战略推理作为外部推理，涉及对其他市场参与者的认知、战略决策和持续学习。AI代理在劳动力市场中采取行动时，需要同时运用这两种推理方式。研究正在探索这些能力，但仍需进一步发展相关技术。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T02:30:46Z
- **目录日期**: 2025-05-27
