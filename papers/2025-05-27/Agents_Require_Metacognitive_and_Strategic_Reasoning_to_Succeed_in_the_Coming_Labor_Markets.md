...
当前劳动力市场深受信息不完全带来的逆向选择、道德风险和声誉问题影响。即便引入AI代理后，这些经济力量仍将发挥作用，因此代理需具备元认知和战略推理能力。元认知是自我评估、任务理解和策略评价的内部推理；战略推理则是关于市场参与者（如竞争者、同事）的外部推理，包括形成信念、战略决策和持续学习。AI代理在劳动力市场中需要结合这两种推理来决定工作内外的各种行动。研究正在探索这些能力，但仍需进一步发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T19:02:05Z
- **目录日期**: 2025-05-27
