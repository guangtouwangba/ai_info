...
本文提出了一种新方法，使视觉语言模型(VLM)能够生成、理解和编辑复杂3D场景。该方法通过构建动态演化的空间上下文(包括语义蓝图、带标签的点云和编码空间关系的场景超图)，将VLM的多模态推理能力与结构化3D理解相结合。基于此，开发了自主3D场景生成流程，支持高质量资产生成、环境设置和人体工学调整。实验表明，该方法能处理多样化输入，实现前所未有的泛化能力，并支持交互式场景编辑和路径规划等下游任务，在计算机图形学、3D视觉和具身应用中具有广阔前景。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T05:01:26Z
- **目录日期**: 2025-05-27
