...
MA-RAG是一个多智能体检索增强生成框架，通过分解复杂任务来解决查询模糊性、证据稀疏性和多源信息整合等挑战。它采用四个专用智能体（规划器、步骤定义器、提取器和QA智能体）协同工作，基于思维链提示逐步处理RAG流程的每个阶段。该系统无需微调即可实现细粒度信息控制，按需调用智能体以提高效率。实验表明，MA-RAG在复杂问答任务中优于无训练的基线系统，并与微调系统性能相当，验证了多智能体协作推理在RAG中的有效性。该架构具有模块化、可解释和动态工作流的特点。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T02:31:06Z
- **目录日期**: 2025-05-27
