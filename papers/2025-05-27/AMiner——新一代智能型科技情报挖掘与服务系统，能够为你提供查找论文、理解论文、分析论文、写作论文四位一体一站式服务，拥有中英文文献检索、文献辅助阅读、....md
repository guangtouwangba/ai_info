...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析和写作的一站式服务。支持中英文文献搜索、AI辅助阅读、自动摘要生成及翻译功能，覆盖42个学科3.5亿论文。用户可通过互动问答快速理解文献，上传PDF获取章节概要和问题建议。平台还提供科研动态订阅服务，按用户偏好推送最新成果。附加学者画像、学术会议等特色功能，基础服务免费使用。官网：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T15:06:13Z
- **目录日期**: 2025-05-27
