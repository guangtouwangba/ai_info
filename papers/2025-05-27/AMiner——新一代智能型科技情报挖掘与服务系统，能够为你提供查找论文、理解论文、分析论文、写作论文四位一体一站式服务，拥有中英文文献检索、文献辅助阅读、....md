...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、辅助阅读、翻译和科研情报订阅等。它拥有庞大的数据库，涵盖42个学科3.5亿论文、0.6亿学者和1.5亿专利。用户可通过互动问答快速获取文献摘要，并利用AI工具生成章节概要和问题建议。平台还支持个性化订阅，推送最新科研动态。此外，AMiner提供学者画像、学术会议和必读论文专题等功能，免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T10:05:53Z
- **目录日期**: 2025-05-27
