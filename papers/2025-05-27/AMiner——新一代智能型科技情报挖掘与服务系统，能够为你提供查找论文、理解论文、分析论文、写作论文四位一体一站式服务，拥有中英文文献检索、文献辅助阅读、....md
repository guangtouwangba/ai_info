...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译和科研订阅等一站式服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持中英文文献搜索，并能通过AI生成摘要和问答互动。用户可上传PDF或从平台获取论文，系统会提供摘要、章节概要和问题建议。此外，AMiner还提供个性化科研动态推送，跟踪学者、机构或关键词，通过微信或邮件发送最新资讯。平台免费开放，包含学者画像、学术会议等特色功能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T14:06:19Z
- **目录日期**: 2025-05-27
