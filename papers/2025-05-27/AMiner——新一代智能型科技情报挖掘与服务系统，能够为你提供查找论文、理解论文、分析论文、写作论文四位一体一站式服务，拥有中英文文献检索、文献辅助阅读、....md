...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、辅助阅读、翻译、科研情报订阅等功能。它拥有庞大的学术资源库，涵盖42个学科3.5亿论文、0.6亿学者等。用户可通过互动问答快速理解文献，AI还能自动生成摘要和章节概要。此外，AMiner支持个性化订阅，推送最新科研动态，并提供学者画像、学术会议等辅助功能。平台免费开放使用，帮助研究者高效获取和分析学术信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T02:34:43Z
- **目录日期**: 2025-05-27
