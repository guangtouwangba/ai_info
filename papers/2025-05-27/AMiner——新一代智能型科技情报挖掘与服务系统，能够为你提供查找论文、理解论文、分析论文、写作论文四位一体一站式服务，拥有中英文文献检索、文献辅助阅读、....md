...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、辅助阅读、科研订阅等一站式服务。其核心功能包括：1）精准检索3.5亿论文资源，支持智能问答和自动摘要生成；2）AI驱动的文献解析，可上传PDF获取章节概要和问答互动；3）个性化科研动态推送，按用户关注的学者/关键词定制内容。平台还包含学者画像、学术会议等特色功能，基础服务免费开放，旨在提升科研效率。访问入口：https://www.aminer.cn/（20字简介：集成检索、翻译、分析的智能学术平台，助力高效科研）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T22:05:36Z
- **目录日期**: 2025-05-27
