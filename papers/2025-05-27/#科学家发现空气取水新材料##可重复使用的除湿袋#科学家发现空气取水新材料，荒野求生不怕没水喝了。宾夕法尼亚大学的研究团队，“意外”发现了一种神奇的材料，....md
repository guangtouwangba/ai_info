...
宾夕法尼亚大学团队开发出一种新型纳米材料，可从空气中高效收集水分。该材料通过亲水/疏水纳米孔结构，无需外部能源即可主动凝结并释放水滴，且可重复使用。相比传统除湿袋，它具有三大优势：1）永久性使用；2）自动排出水分；3）无需干燥处理即可循环工作。材料由常见塑料和纳米颗粒制成，成本低且易量产。这一突破有望解决干旱地区饮水问题，相关论文已发表。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T13:13:53Z
- **目录日期**: 2025-05-27
