...
本文概述了基于马尔可夫随机动力学的蒙特卡洛算法在非平衡态多粒子相互作用与反应系统研究中的应用。这类基于主体的计算机模拟是本科生和研究生接触前沿研究的有效工具，无需过多先验知识。通过直接可视化模拟数据，学生可快速理解复杂系统的宏观特征，并应用更高级的数据分析方法定量表征其动态特性。文章以反应扩散系统、种群动力学和流行病传播等经典模型为例，展示了"边做边学"的跨学科计算研究教育方法，同时提供了算法实现、代码示例、数据分析工具及常见错误规避建议等实用指导。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T00:01:12Z
- **目录日期**: 2025-05-27
