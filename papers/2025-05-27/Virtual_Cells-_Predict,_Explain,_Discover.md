...
药物发现本质上是一个推断治疗对患者影响的过程，计算模型若能可靠模拟患者反应将极大推动该领域发展。虚拟细胞模型可预测细胞对各种干预的功能响应，有助于发现安全有效的临床疗法。尽管细胞生物学的复杂性使这一目标长期难以实现，但AI、计算能力、实验室自动化和高通量细胞分析等技术的进步带来了新机遇。本文提出开发治疗相关虚拟细胞的关键原则，包括准确预测细胞功能响应并解释其分子机制，采用"实验室闭环"方法生成新见解，并建立基于生物学的评估标准。这种虚拟细胞框架还可扩展至更高组织层级（如虚拟患者），有望优化药物发现效果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T06:02:29Z
- **目录日期**: 2025-05-27
