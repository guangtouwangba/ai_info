...
研究人员提出了一种名为TrojanStego的新型威胁模型，通过微调大语言模型(LLM)将敏感信息隐藏在看似自然的输出中。该方法采用基于词汇分区的编码方案，实验显示被操控的模型能以87%的准确率传输32位机密信息，经三次生成后准确率可达97%以上。这种攻击具有被动性、隐蔽性和实用性，能保持文本连贯性且不易被人类察觉，突显了LLM数据泄露的新风险。研究还提出了评估LLM风险因素的分类框架，警示这种隐蔽的数据外泄攻击可能带来的严重安全威胁。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T19:02:17Z
- **目录日期**: 2025-05-27
