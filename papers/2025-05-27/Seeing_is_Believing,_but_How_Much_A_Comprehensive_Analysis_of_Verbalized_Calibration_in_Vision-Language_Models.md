...
当前研究评估了视觉语言模型（VLMs）中语言化不确定性表达的效果，发现现有VLMs在不同任务和场景中存在显著校准不足。视觉推理模型表现较好，表明模态特定推理对可靠的不确定性估计至关重要。为解决校准问题，研究提出了视觉置信感知提示（Visual Confidence-Aware Prompting）的两阶段提示策略，以提升多模态环境下的置信对齐。研究强调了跨模态VLMs的内在校准不足，并指出模态对齐和模型忠实性对发展可靠多模态系统的根本重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T06:01:12Z
- **目录日期**: 2025-05-27
