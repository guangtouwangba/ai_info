...
本文提出了一种评估神经网络功能相似性的新方法——功能潜在对齐(FuLA)，该方法受知识蒸馏启发，通过最优仿射变换对齐不同模型来解决任务。相比传统模型缝合方法，FuLA能更可靠地衡量独立训练网络的功能相似性。研究在对抗训练、捷径训练和跨层缝合三个测试场景中验证了FuLA的优势：既能避免任务线索相关的伪影，又能捕捉到缝合水平匹配遗漏的重要对齐关系。实验表明，FuLA在功能相似性评估方面具有更高的可靠性，为AI模型比较提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T02:29:59Z
- **目录日期**: 2025-05-27
