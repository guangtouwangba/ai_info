...
北京航空航天大学刘偲教授团队开发出语言引导的无人机控制框架"Flying-on-a-Word(Flow)"，通过自然语言指令实现无人机精细轨迹控制。该框架整合语言指令、六自由度状态和第一视角视觉三种输入模态，采用模仿学习方法学习人类飞行员操作策略。团队构建了覆盖5.02平方公里的大规模真实数据集和仿真测试平台，并开发了地面站-无人机协作策略解决机载计算限制问题。实验表明，系统能通过自然语言实时控制无人机执行指令任务，实现了语言与飞行控制的高效对齐。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T00:03:28Z
- **目录日期**: 2025-05-27
