...
北京航空航天大学刘偲教授团队开发出"Flying-on-a-Word"(Flow)框架，实现通过自然语言指令控制无人机飞行。该框架整合语言指令、六自由度状态和第一视角视觉三种输入，采用模仿学习方法训练无人机响应人类指令。团队构建了覆盖5.02平方公里的大规模真实数据集和仿真测试环境，并开发了Pi-0-UAV模型，成功实现真机部署。针对机载计算限制，提出地面站-无人机协作策略和前瞻轨迹算法，解决了通信延迟问题。这是首个通过自然语言实时控制无人机的视觉语言动作系统。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T01:31:35Z
- **目录日期**: 2025-05-27
