...
该研究探讨了通过增强儿童数据集微调x-vector和ECAPA-TDNN模型，以提升课堂环境下的说话人验证系统性能。结果表明，该方法能有效降低两种模型在课堂数据集和儿童语音数据集上的等错误率(EER)。特别是，ECAPA-TDNN模型在MPT数据集课堂环境中的EER平均降低50%(提升5%)，而x-vector模型在NCTE数据集课堂环境中平均提升8%。该方法显著增强了系统对课堂噪声(如嘈杂声)的鲁棒性，为教育场景AI工具的开发提供了重要支持。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T06:01:22Z
- **目录日期**: 2025-05-27
