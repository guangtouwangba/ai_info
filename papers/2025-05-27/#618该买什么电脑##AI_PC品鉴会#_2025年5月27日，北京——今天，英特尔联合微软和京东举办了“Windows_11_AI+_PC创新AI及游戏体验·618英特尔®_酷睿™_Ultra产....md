...
英特尔联合微软和京东举办AI PC品鉴会，宣布Windows 10全面转向Windows 11 AI+PC时代。活动展示了10家厂商基于第二代酷睿Ultra处理器的AI PC，覆盖工作、创作和游戏场景。新一代处理器性能显著提升：Ultra 200V系列AI算力达120 TOPS，200H系列单核性能提升17%，能效比提高21%，GPU游戏性能提升22%。微软强调Windows 11 AI+PC具有更强安全性、AI算力和续航能力。该系列产品被定位为高效智能的"六边形战士"，尤其适合3A游戏和电竞场景。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T14:03:15Z
- **目录日期**: 2025-05-27
