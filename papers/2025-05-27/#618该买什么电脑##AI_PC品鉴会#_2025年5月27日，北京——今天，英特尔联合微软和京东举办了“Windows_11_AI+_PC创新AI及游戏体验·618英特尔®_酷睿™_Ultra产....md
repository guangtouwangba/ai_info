...
英特尔联合微软和京东举办AI PC品鉴会，宣布Windows 10全面转向Windows 11 AI+PC时代。活动展示了10家厂商基于第二代酷睿Ultra处理器的AI PC，覆盖工作、创作和游戏场景。新款处理器性能显著提升：Ultra 200V系列AI算力达120 TOPS，200H系列单线程性能提升17%，能效比提高21%。产品具备强大AI功能、长续航和游戏优化，支持本地AI模型部署。微软强调Windows 11 AI+PC在生产力、安全性和游戏体验上的优势。该系列PC标志着传统PC向高效智能设备的转型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T23:02:45Z
- **目录日期**: 2025-05-27
