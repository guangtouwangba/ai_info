...
英特尔联合微软和京东举办"Windows 11 AI+ PC品鉴会"，宣布PC进入AI时代。现场展示10家厂商基于第二代酷睿Ultra处理器的AI PC，覆盖工作、创作、游戏等场景。新款处理器性能显著提升：Ultra 200V系列AI算力达120 TOPS，200H系列单核性能提升17%，GPU游戏性能提升22%。AI PC具备高效智能、长续航、强安全性和流畅游戏体验等特点，支持本地AI模型部署。微软强调Windows 11 AI+ PC在生产力、创造力和安全性方面的优势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T22:02:46Z
- **目录日期**: 2025-05-27
