...
英特尔联合微软、京东举办"Windows 11 AI+PC品鉴会"，宣布PC全面进入AI时代。现场展示10家厂商基于第二代酷睿Ultra处理器的AI PC，覆盖工作、创作、游戏等五大场景。新一代处理器性能显著提升：Ultra 200V系列AI算力达120 TOPS，200H系列单核性能提升17%，能效比提升21%，GPU游戏性能提升22%。200HX系列在游戏性能、AI辅助等方面表现突出，成为"六边形战士"。微软强调Windows 11 AI+PC具有更强安全性、AI算力和续航能力，将重塑PC体验。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T16:02:54Z
- **目录日期**: 2025-05-27
