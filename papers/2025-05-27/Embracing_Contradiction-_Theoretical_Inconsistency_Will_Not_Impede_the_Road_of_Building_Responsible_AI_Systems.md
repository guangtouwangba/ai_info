...
这篇立场论文主张，负责任人工智能（RAI）指标间的理论不一致性（如公平性定义的差异或准确性与隐私的权衡）应被视为有益特征而非缺陷。作者提出，通过将指标视为不同目标来协调这些矛盾可带来三大优势：(1) 保持多元道德立场（规范性多元主义）；(2) 更全面捕捉复杂伦理概念（认识论完整性）；(3) 避免单一指标过拟合，提升模型泛化能力（隐式正则化）。相反，强行统一指标会削弱价值多样性。论文呼吁RAI实践应转向界定可接受的不一致阈值，而非消除矛盾。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T00:01:22Z
- **目录日期**: 2025-05-27
