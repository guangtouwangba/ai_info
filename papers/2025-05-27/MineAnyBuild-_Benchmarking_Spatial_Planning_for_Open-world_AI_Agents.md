...
该研究提出了名为MineAnyBuild的综合性基准测试，用于评估开放世界AI代理在《我的世界》游戏中的空间规划能力。该基准包含4,000个精心设计的空间规划任务，要求AI根据多模态人类指令生成可执行的建筑计划。它从空间理解、推理、创造力和空间常识四个维度进行评估，并支持通过玩家生成内容无限扩展数据。研究对现有基于多模态大语言模型(MLLM)的代理进行了全面评估，揭示了它们在空间规划能力上的严重局限与巨大潜力。该基准为空间智能评估开辟了新途径，将推动开放世界AI代理的发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T21:00:56Z
- **目录日期**: 2025-05-27
