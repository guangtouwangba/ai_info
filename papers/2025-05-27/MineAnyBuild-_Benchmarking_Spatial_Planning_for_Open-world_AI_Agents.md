...
该研究提出了一个名为MineAnyBuild的综合性基准测试，用于评估开放世界AI代理在《Minecraft》游戏中的空间规划能力。该基准包含4,000个精心设计的空间规划任务，要求AI根据多模态人类指令生成可执行的建筑计划，并支持通过玩家生成内容无限扩展数据。MineAnyBuild从空间理解、空间推理、创造力和空间常识四个核心维度评估空间规划能力。研究发现，现有基于多模态大语言模型的AI代理在空间规划方面存在明显局限，但也展现出巨大潜力。该基准为空间智能评估开辟了新途径，将推动具备空间规划能力的开放世界AI代理的发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T03:18:55Z
- **目录日期**: 2025-05-27
