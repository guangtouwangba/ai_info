...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个代理的社会互动（500万次交互）。研究者用它研究了四大社会问题：社会极化、信息传播、基本收入政策影响和自然灾害（如飓风）冲击。模拟结果与现实数据高度吻合，验证了该系统在揭示人类行为机制方面的可靠性。该系统可作为计算社会科学的研究平台，辅助传统调查和实验方法，帮助学者和政策制定者分析社会问题的成因与解决方案。研究展示了LLM驱动模拟器在社会研究中的巨大潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T01:33:06Z
- **目录日期**: 2025-05-27
