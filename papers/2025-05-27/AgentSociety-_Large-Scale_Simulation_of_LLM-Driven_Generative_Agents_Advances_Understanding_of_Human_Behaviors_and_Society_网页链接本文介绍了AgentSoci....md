...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能模拟1万多个AI代理的社会互动（500万次交互）。研究者用它探索了四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，验证了该系统在揭示人类行为机制方面的有效性。该系统可作为计算社会科学研究平台，为学者和政策制定者提供新工具，补充传统研究方法（如调查和实验）。研究表明AgentSociety具有推动社会科学研究和政策评估的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T23:05:01Z
- **目录日期**: 2025-05-27
