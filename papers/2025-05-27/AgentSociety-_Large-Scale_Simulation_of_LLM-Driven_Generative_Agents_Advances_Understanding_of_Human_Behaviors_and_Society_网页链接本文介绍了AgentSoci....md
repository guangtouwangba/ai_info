...
这篇论文介绍了一个名为AgentSociety的大规模社会模拟系统，它结合了LLM驱动的智能代理、真实社会环境和大规模模拟引擎。该系统模拟了1万多个代理的社会生活及500万次互动，并用于研究四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害冲击。实验结果与现实世界数据吻合，验证了该系统捕捉人类行为机制的能力，展示了其作为社会科学研究和政策制定工具的潜力。该研究为理解复杂社会现象提供了新的计算实验方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T15:05:45Z
- **目录日期**: 2025-05-27
