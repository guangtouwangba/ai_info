...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟超过1万个代理的社会互动（500万次）。它通过研究社会极化、信息传播、基本收入政策及自然灾害影响等案例，验证了其模拟结果与现实实验的一致性。该系统能有效捕捉人类行为机制，为社会科学研究和政策制定提供新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T06:05:19Z
- **目录日期**: 2025-05-27
