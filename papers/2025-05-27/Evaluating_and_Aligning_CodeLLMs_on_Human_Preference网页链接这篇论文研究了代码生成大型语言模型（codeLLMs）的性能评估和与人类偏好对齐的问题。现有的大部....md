...
该研究针对代码生成大模型(codeLLMs)提出新评估框架CodeArena，通过397个涵盖40类编程任务和44种语言的真实样本，首次系统评估模型输出与人类偏好的对齐程度。研究发现传统执行测试与人类偏好存在显著差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI)性能差距明显。同时验证了20B标记规模的合成指令数据集SynCode-Instruct对模型优化的有效性，强调代码生成模型需兼顾功能正确性和人类编程习惯。研究为提升AI编程助手实用性提供了重要方法论。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T14:06:31Z
- **目录日期**: 2025-05-27
