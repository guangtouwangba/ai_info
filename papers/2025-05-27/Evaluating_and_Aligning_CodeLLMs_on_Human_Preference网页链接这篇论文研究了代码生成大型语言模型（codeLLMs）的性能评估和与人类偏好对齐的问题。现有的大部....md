...
这篇论文研究了代码生成大模型（codeLLMs）与人类偏好的对齐问题，指出现有基准测试过于关注代码正确性而忽视人类偏好。为此，研究者构建了CodeArena基准测试（包含397个高质量样本，覆盖40类任务和44种编程语言）和SynCode-Instruct合成指令集（近200亿标记）。实验发现执行基准与CodeArena存在性能差异，开源模型（如Qwen2.5-Coder）与专有模型（如OpenAI o1）差距显著，凸显了人类偏好对齐的重要性。研究强调需要更全面的评估标准来提升代码LLMs的实际应用价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T03:23:58Z
- **目录日期**: 2025-05-27
