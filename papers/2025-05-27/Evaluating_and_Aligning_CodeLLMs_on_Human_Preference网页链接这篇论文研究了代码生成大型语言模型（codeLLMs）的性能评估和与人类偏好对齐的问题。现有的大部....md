...
该研究针对代码生成大模型(codeLLMs)与人类偏好对齐问题，提出了CodeArena基准测试和SynCode-Instruct指令数据集。CodeArena包含397个高质量编程任务样本，覆盖40类44种语言；SynCode-Instruct包含近200亿标记的合成指令数据。实验发现：1)传统执行基准与人类偏好存在差异；2)开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究凸显了代码生成模型除正确性外，与人类编程习惯和偏好对齐的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T22:05:46Z
- **目录日期**: 2025-05-27
