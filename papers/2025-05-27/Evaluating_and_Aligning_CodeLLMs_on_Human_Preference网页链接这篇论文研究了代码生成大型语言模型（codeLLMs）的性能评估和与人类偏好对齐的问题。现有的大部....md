...
该研究针对代码生成大模型(codeLLMs)提出CodeArena基准测试，包含397个高质量编程任务样本，覆盖40个类别和44种语言，以评估模型与人类偏好的匹配程度。同时构建了20B标记的合成指令数据集SynCode-Instruct用于微调验证。实验发现传统执行基准与人类偏好存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，凸显了代码生成模型与人类偏好对齐的重要性。研究强调了在评估代码生成能力时需兼顾功能正确性和人类编程习惯。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T11:05:57Z
- **目录日期**: 2025-05-27
