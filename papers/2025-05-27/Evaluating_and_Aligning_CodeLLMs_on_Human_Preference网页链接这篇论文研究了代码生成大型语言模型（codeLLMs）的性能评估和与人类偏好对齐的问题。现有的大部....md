...
这篇论文提出了CodeArena基准测试和SynCode-Instruct语料库，用于评估代码生成大模型(CodeLLMs)与人类偏好的对齐程度。CodeArena包含397个高质量编程任务样本，覆盖40个类别和44种语言；SynCode-Instruct则包含近200亿标记的合成指令数据。研究发现现有基于执行的基准测试与人类偏好存在差距，开源模型(如Qwen2.5-Coder)与专有模型(如OpenAI o1)性能差异显著，凸显了人类偏好对齐的重要性。该研究为提升代码生成模型的实际适用性提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T00:05:29Z
- **目录日期**: 2025-05-27
