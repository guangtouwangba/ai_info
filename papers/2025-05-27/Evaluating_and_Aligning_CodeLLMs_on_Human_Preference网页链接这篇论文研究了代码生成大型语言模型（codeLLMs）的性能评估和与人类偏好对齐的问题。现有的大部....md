...
该论文研究代码生成大模型(codeLLMs)与人类偏好的对齐问题。针对现有基准仅关注代码正确性而忽视人类偏好的局限，研究者构建了CodeArena基准(含397个样本，覆盖40类44种语言)模拟真实编程任务，并创建20B标记的SynCode-Instruct合成指令集。实验发现执行基准与CodeArena存在性能差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)差距显著，凸显人类偏好对齐的重要性。研究证实大规模合成指令微调的有效性，为提升代码LLMs实用性提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T15:06:27Z
- **目录日期**: 2025-05-27
