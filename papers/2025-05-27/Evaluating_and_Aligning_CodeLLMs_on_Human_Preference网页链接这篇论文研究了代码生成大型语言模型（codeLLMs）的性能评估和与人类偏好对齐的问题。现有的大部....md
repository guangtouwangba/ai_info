...
这篇论文针对代码生成大模型（codeLLMs）提出新评估方法，指出当前基准测试过于关注代码正确性而忽视人类偏好。研究者开发了CodeArena基准（含397个多语言样本）和SynCode-Instruct合成指令集（20B标记），发现执行基准与人类偏好存在显著差异。实验对比40多个模型显示，顶级开源模型（如Qwen2.5-Coder）与商业模型（如OpenAI o1）性能差距明显，验证了人类偏好对齐的重要性。研究强调了在代码生成任务中兼顾技术指标与用户体验的关键需求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T21:05:53Z
- **目录日期**: 2025-05-27
