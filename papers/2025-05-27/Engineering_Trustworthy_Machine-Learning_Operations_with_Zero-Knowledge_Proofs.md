...
随着AI系统在高风险领域的应用增加，其概率性和不透明性对传统验证方法提出了挑战。零知识证明（ZKP）提供了一种加密解决方案，能在不泄露敏感信息的情况下验证AI系统合规性。研究发现，当前ZKP增强的机器学习研究主要集中在推理验证阶段，而数据预处理和训练阶段仍待探索。研究领域正趋向于开发统一的零知识机器学习运维（ZKMLOps）框架，该框架利用ZKP提供正确性、完整性和隐私性的加密保证，从而提升AI系统的可问责性、透明性，并符合可信AI原则。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T05:01:15Z
- **目录日期**: 2025-05-27
