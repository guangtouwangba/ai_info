...
亚马逊强制推行AI编程工具引发程序员不满。管理层以"提高生产力"为由，缩短项目周期并裁员，迫使程序员依赖Copilot等AI工具快速生成代码。但AI代码错误率高，程序员反而沦为"代码审核员"，需花费大量时间修复bug。工作压力增大但晋升机会减少，员工抱怨被AI工具异化。虽然公司声称AI旨在增强而非取代人力，但实际效果与承诺不符。部分支持者认为AI能解放程序员处理低级任务，但多数人面临工作量增加、职业前景模糊的困境。AI工具的效率提升与管理方式引发职场矛盾。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T14:04:07Z
- **目录日期**: 2025-05-27
