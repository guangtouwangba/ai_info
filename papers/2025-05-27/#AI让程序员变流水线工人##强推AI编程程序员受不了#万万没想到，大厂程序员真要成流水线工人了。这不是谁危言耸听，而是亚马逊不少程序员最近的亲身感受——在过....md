...
亚马逊强制推广AI编程工具（如Copilot）引发程序员不满。管理层以"提升效率"为由缩短项目周期，迫使程序员依赖AI生成代码，但AI代码错误率高，导致程序员反而需花更多时间审核和修复。虽然公司声称AI能解放生产力，但员工反映工作压力增大，晋升前景不明。CEO Andy Jassy则强调AI可节省成本和提高效率。争议焦点在于：AI究竟是提升效率的工具，还是变相加剧工作强度的推手？部分程序员认为AI确实能处理繁琐任务，但更多人面临工作降级为"代码审核员"的困境。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T13:13:13Z
- **目录日期**: 2025-05-27
