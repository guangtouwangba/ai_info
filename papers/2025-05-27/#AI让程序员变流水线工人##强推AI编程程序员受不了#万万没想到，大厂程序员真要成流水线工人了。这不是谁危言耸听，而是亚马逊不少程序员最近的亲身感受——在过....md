...
亚马逊强制推行AI编程工具引发程序员不满。管理层以"提高生产力"为由，缩短项目周期并裁员，迫使程序员依赖Copilot等AI工具快速生成代码。但AI代码错误率高，程序员反而沦为"代码审核员"，需耗费大量时间修复bug。工作压力增加的同时，晋升路径也变得模糊。虽然公司声称AI旨在增强而非取代人工，但员工反馈两极分化：部分人认为AI能解放生产力，更多人则面临工作降级和绩效压力。微软此前也因AI修bug翻车遭群嘲，凸显当前AI编程的局限性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T23:03:36Z
- **目录日期**: 2025-05-27
