...
亚马逊程序员面临AI工具带来的工作变革：管理层强制使用Copilot等AI编程助手，缩短项目周期，导致员工被迫依赖AI生成代码。虽然公司声称AI能提升25%生产力并节省成本，但实际效果堪忧——AI代码错误频出，程序员反而沦为"代码审核员"，工作压力倍增。员工抱怨晋升机制模糊化，功劳归属AI，而公司坚称AI只是辅助工具。争议焦点在于：AI究竟解放了生产力，还是将程序员异化为"流水线工人"？目前正反观点并存，有人认可AI处理基础代码的价值，也有人质疑其实际效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T21:03:38Z
- **目录日期**: 2025-05-27
