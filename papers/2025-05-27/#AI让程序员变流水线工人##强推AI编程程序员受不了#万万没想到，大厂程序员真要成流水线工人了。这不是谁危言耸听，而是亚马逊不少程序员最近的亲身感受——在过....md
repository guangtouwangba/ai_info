...
亚马逊程序员因公司强制推广AI编程工具（如Copilot）而面临工作压力剧增。管理层缩短项目周期，要求更高代码产出，迫使员工依赖AI生成代码。然而AI代码错误率高，程序员反而需花费大量时间审查修改，工作更繁重。虽然公司声称AI能提升25%生产力并节省成本，但员工抱怨晋升机会减少，沦为"代码审核员"。部分人认为AI确实能处理低级任务，但整体上程序员的工作体验和职业发展受到冲击。公司回应称AI旨在增强而非取代员工，会继续优化AI整合流程。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T18:04:12Z
- **目录日期**: 2025-05-27
