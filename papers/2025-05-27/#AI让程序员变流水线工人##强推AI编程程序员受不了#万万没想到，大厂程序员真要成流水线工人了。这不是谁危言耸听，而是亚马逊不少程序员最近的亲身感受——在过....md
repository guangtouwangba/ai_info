...
亚马逊程序员反映，公司强制使用AI编程工具（如Copilot）后，虽然提高了代码产出速度，但导致工作压力剧增：人员缩减但任务量不变，项目截止日期提前，程序员被迫依赖AI生成代码并花费大量时间修复错误。管理层认为AI提升了25%的生产力并节省成本，但员工抱怨工作更繁杂且晋升前景不明。部分人认为AI能解放繁琐任务，但更多人担忧沦为"代码审核员"。亚马逊官方回应称AI旨在增强而非取代员工，会继续优化AI整合。争议焦点在于AI是否真正提升工作效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T11:03:20Z
- **目录日期**: 2025-05-27
