...
亚马逊推行AI编程工具后，程序员面临新挑战：管理层缩短项目周期，强制使用AI生成代码，导致工作量激增且需频繁修复AI的错误代码。员工沦为"代码审核员"，职业发展受阻。虽然公司声称AI旨在提升效率而非取代人力，但实际效果引发争议——部分人认为AI能简化基础工作，但更多人抱怨工作压力增大且绩效评价失衡。微软Copilot等工具的翻车案例（如.NET Runtime事件）也加剧了对AI可靠性的质疑。管理层仍坚持AI节省成本、提升速度的优势，但基层程序员对转型阵痛感到焦虑。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T19:03:51Z
- **目录日期**: 2025-05-27
