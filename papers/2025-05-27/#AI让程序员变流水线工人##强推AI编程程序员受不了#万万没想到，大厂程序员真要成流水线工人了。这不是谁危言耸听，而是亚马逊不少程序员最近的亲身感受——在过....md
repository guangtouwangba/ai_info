...
亚马逊强制推广AI编程工具引发程序员不满。管理层以"提高生产力"为由，缩短项目周期并裁员，迫使程序员依赖AI生成代码。但AI代码错误率高，程序员反而沦为"代码审核员"，工作量不减反增。亚马逊CEO认为AI能提升25%效率并节省成本，但员工抱怨职业发展受阻。官方回应称AI旨在增强而非取代人力，晋升机制仍基于个人表现。争议焦点在于：AI究竟是解放了生产力，还是将程序员异化为流水线工人？目前业界对此看法两极分化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T17:04:06Z
- **目录日期**: 2025-05-27
