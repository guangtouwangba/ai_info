...
亚马逊强制推广AI编程工具引发程序员不满。管理层以"提高生产力"为由，缩短项目周期并裁员，迫使程序员依赖AI生成代码，但AI代码错误率高，导致程序员反而要花更多时间审核和修复。虽然公司声称AI能提升25%效率并节省成本，但员工抱怨工作更繁重且晋升机会受影响。部分人认为AI能帮助处理基础代码，但整体上程序员正沦为"代码审核员"。亚马逊官方回应称AI旨在增强而非取代人力，但员工反馈与官方表态存在明显矛盾。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T16:03:45Z
- **目录日期**: 2025-05-27
