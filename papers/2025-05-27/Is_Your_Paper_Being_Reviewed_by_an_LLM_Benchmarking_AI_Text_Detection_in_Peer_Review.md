...
这篇论文指出，随着大语言模型(LLM)的发展，存在审稿人可能依赖AI撰写耗时审稿报告的风险。研究团队构建了一个包含788,984条AI与人类审稿对比的数据集，涵盖ICLR和NeurIPS两大AI会议8年的投稿论文。通过评估18种现有AI文本检测算法，发现现有方法难以可靠识别AI生成的审稿内容。论文还提出了一种基于稿件内容的"Anchor"检测方法，并分析了模型对人类修改AI文本的敏感性。研究凸显了开发新工具检测AI生成审稿的紧迫性，相关数据集已公开。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-27T00:02:16Z
- **目录日期**: 2025-05-27
