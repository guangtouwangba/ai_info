...
行为克隆（BC）方法在模仿学习中的根本局限性在于，它仅能教会智能体在专家访问过的状态下模仿专家行为。一旦智能体犯错并偏离演示数据范围，它往往无法恢复。为解决这一问题，研究者提出从专家演示中学习搜索（L2S）的方法，即学习世界模型和奖励模型，使智能体能在测试时通过规划恢复专家行为，而无需额外人工纠正。实验表明，新方法SAILOR在多个视觉操作任务中显著优于基于BC的扩散策略，即使BC使用5-10倍演示数据仍存在性能差距。SAILOR能识别细微错误并避免奖励作弊。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T03:27:56Z
- **目录日期**: 2025-06-08
