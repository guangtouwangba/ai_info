...
行为克隆（BC）模仿学习的核心局限在于它仅能教会智能体在专家访问过的状态下模仿行为，一旦偏离演示状态，智能体难以自主恢复。为此，研究者提出基于专家演示的"学习搜索"（L2S）方法SAILOR，通过联合学习世界模型和奖励模型，使智能体能在测试时规划恢复路径，无需额外人工修正。在12项视觉操作任务测试中，SAILOR显著优于基于相同数据的扩散策略BC方法，即使BC演示数据量增加5-10倍仍存在性能差距。该方法能识别细微错误并避免奖励作弊，代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T11:02:02Z
- **目录日期**: 2025-06-08
