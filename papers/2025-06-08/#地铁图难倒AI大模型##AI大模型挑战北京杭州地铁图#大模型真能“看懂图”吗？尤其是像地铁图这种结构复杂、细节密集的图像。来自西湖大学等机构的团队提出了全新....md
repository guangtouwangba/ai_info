...
西湖大学等机构提出ReasonMap评测基准，测试多模态大模型对高分辨率地铁图(平均5839×5449像素)的空间理解和路径规划能力。测试覆盖15个主流模型，结果显示开源模型普遍表现不佳，常出现线路混淆或站点遗漏。闭源模型如GPT-3表现较好但仍显著落后于人类水平。北京、杭州等复杂地铁图对AI挑战最大。研究表明当前AI在理解复杂视觉信息和进行空间推理方面仍存在明显局限，距离人类的地图使用能力尚有差距。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T03:29:09Z
- **目录日期**: 2025-06-08
