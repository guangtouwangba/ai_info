...
西湖大学等机构提出ReasonMap评测基准，测试多模态大模型对高分辨率地铁图的空间理解和路径规划能力。研究发现，开源模型普遍表现不佳，存在混淆线路或遗漏站点的问题。闭源模型如GPT-3表现较好，但仍与人类水平有明显差距。测试涵盖15个主流模型，结果显示北京、杭州等复杂地铁图对AI挑战较大，多数模型准确率较低。该研究突显了AI在复杂图像理解和推理任务上的局限性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T08:04:37Z
- **目录日期**: 2025-06-08
