...
西湖大学等机构提出ReasonMap评测基准，测试多模态大模型对高分辨率地铁图的空间理解和路径规划能力。研究发现，开源模型普遍表现不佳，在复杂线路（如北京、杭州地铁图）中易混淆站点或遗漏路径。闭源模型如GPT-4表现较好，但仍显著低于人类水平。该研究评估了15个主流模型，显示当前AI处理密集视觉信息与逻辑推理的能力存在局限。评测强调贴近真实使用场景，凸显多模态模型在复杂图像理解方面的挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T12:04:15Z
- **目录日期**: 2025-06-08
