...
西湖大学等机构提出ReasonMap评测基准，测试多模态大模型对高分辨率地铁图(平均5839×5449像素)的空间理解和路径规划能力。测试覆盖15个主流模型，结果显示开源模型普遍表现不佳，常混淆线路或遗漏站点。闭源模型如GPT-3表现较好，但仍显著低于人类水平。北京、杭州等复杂地铁图对AI挑战最大。该研究揭示了当前AI在复杂图像理解和逻辑推理方面的局限性，强调需要更接近人类认知方式的多模态模型改进。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T09:04:01Z
- **目录日期**: 2025-06-08
