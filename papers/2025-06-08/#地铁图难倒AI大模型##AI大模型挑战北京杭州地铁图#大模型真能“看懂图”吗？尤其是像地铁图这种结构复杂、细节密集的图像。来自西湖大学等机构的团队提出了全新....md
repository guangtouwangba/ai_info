...
西湖大学等机构提出ReasonMap评测基准，测试多模态大模型对高分辨率地铁图（平均5839×5449像素）的空间理解和路径规划能力。研究发现，开源模型普遍表现不佳，存在混淆线路或遗漏站点等问题；闭源模型如GPT-4表现较好但仍显著落后人类水平。测试涵盖15个主流模型，结果显示北京、杭州等复杂地铁图的识别难度较高。该研究强调当前AI在复杂图像理解和逻辑推理方面与人类存在明显差距。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T01:31:03Z
- **目录日期**: 2025-06-08
