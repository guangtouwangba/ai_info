...
西湖大学等机构提出ReasonMap评测基准，测试多模态大模型对高分辨率地铁图(平均5839×5449像素)的空间理解和路径规划能力。研究发现，开源模型普遍表现不佳，常混淆线路或遗漏站点；闭源模型如GPT-3表现较好但仍显著低于人类水平。测试覆盖15个主流模型，显示北京、杭州等复杂地铁图的识别难度较高。该研究揭示了当前AI在复杂图像理解和逻辑推理方面的局限性，特别是处理结构密集、细节丰富的地图信息时与人类能力存在明显差距。(98字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T02:37:09Z
- **目录日期**: 2025-06-08
