# #地铁图难倒AI大模型##AI大模型挑战北京杭州地铁图#大模型真能“看懂图”吗？尤其是像地铁图这种结构复杂、细节密集的图像。来自西湖大学等机构的团队提出了全新...
...
西湖大学等机构提出ReasonMap评测基准，测试15个主流多模态AI模型对高分辨率地铁图（平均5839×5449像素）的空间理解和路径规划能力。结果显示开源模型普遍表现不佳，在复杂线路（如北京、杭州地铁）中易混淆线路或遗漏站点。闭源模型如GPT-4表现较好但仍显著低于人类水平。该研究强调当前AI在复杂图像理解和逻辑推理方面存在局限，尤其面对结构密集、需多步推理的真实场景时挑战明显。评测覆盖多国城市地铁图，证实高难度地图对AI构成显著挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T05:01:56Z
- **目录日期**: 2025-06-08
