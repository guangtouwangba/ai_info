...
复旦大学和香港中文大学联合推出MME-Reasoning基准，首次系统评估多模态大模型的逻辑推理能力。该基准包含1188道题，涵盖演绎、归纳和溯因三类推理，测试五种核心能力。30多款主流模型参与测评，最优成绩仅60%左右，Gemini 2.5 Pro表现不佳。研究发现模型常出现重复推理、无效假设等问题。该基准通过严格题型设计和难度分级，规避知识偏见，成为当前最具挑战性的多模态推理评估标准，揭示了现有模型在逻辑推理方面的显著不足。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T06:03:53Z
- **目录日期**: 2025-06-08
