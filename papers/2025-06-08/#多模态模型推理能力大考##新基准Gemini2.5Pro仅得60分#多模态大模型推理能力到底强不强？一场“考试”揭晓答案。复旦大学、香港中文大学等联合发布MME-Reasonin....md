...
复旦大学与香港中文大学联合推出MME-Reasoning基准，首次系统评估多模态大模型的逻辑推理能力。该基准包含1188道题，涵盖演绎、归纳等三类推理，测试五种核心能力。30多款主流模型参评（包括GPT-4o、Gemini 2.5 Pro），最高得分仅约60%，显示当前多模态模型在复杂推理任务上仍有显著局限。研究发现模型常出现重复推理、无效假设等典型问题。该基准通过严格题型设计和难度分级，成为目前最具挑战性的多模态推理评估标准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T07:03:19Z
- **目录日期**: 2025-06-08
