...
复旦大学与香港中文大学联合发布MME-Reasoning基准，首次系统评估多模态大模型的逻辑推理能力。该基准包含1188道题，涵盖演绎、归纳和溯因三类推理，分为选择题、自由作答和规则验证三种题型，难度分三档，聚焦五种核心能力。测试显示，包括GPT-4o、Gemini 2.5 Pro在内的30多款模型中，最优得分仅约60%，暴露出模型存在重复推理、假设验证效率低等问题。该基准成为当前最具挑战性的多模态推理评估标准，凸显现有模型在复杂逻辑推理上的局限性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T00:03:35Z
- **目录日期**: 2025-06-08
