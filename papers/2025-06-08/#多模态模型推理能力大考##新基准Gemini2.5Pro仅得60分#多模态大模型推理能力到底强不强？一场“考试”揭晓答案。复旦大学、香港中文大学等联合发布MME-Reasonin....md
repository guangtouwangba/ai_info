...
复旦大学和香港中文大学联合推出MME-Reasoning基准，首次系统评估多模态大模型的逻辑推理能力。该基准包含1188道题，涵盖演绎、归纳和溯因三类推理，分选择题、自由作答和规则验证三种题型，并设置不同难度。测试结果显示，包括GPT-4o、Gemini 2.5 Pro在内的30多款模型中，最优得分仅约60%。研究发现模型常出现重复推理、过度生成等问题。该基准聚焦纯逻辑能力，避免知识偏见，成为当前最具挑战性的多模态推理评估标准之一。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T05:02:29Z
- **目录日期**: 2025-06-08
