...
复旦大学和香港中文大学联合发布MME-Reasoning基准，首次系统评估多模态大模型的逻辑推理能力。该基准包含1188道题，涵盖演绎、归纳和溯因三类推理，测试五种能力。30多款模型参与测评，包括GPT-4o和Gemini 2.5 Pro，最优模型得分仅60%左右。研究发现模型常出现重复推理、超长回答等问题。该基准严格区分推理类型和难度，避免知识偏见，成为当前最具挑战的多模态推理评估标准之一。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T02:37:38Z
- **目录日期**: 2025-06-08
