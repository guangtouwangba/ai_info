...
复旦大学和香港中文大学联合推出MME-Reasoning基准，首次系统评估多模态大模型的逻辑推理能力。该基准包含1188道题目，涵盖演绎、归纳和溯因三类推理，测试五种能力（模式分析、规划探索等）。30多款模型（包括GPT-4o、Gemini 2.5 Pro等）参与测试，最高得分仅60%左右，显示当前多模态模型在复杂推理任务上仍有明显不足。该基准通过严格设计避免知识偏见，专注于逻辑能力评估，成为当前最具挑战性的多模态推理测试标准之一。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T03:29:39Z
- **目录日期**: 2025-06-08
