...
快手与东北大学团队提出UNITE统一嵌入框架，通过"模态感知对比学习"解决多模态检索中的跨模态干扰问题。该框架采用两阶段训练：检索适应建立基础能力，指令微调增强复杂任务处理。实验显示，UNITE在图文/视频检索等任务中超越多个SOTA模型，7B版本甚至优于更大模型。研究发现视频-文本数据具有统一模态潜力，细粒度样本对训练效果最佳。论文及代码已开源，为多模态学习提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T15:03:26Z
- **目录日期**: 2025-06-08
