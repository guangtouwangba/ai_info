...
快手与东北大学团队提出UNITE统一嵌入框架，解决多模态检索中的跨模态干扰问题。该框架采用模态感知对比学习(MAMCL)机制，通过两阶段训练（检索适应+指令微调）实现文本/图像/视频的统一嵌入。实验显示，UNITE在图文检索、视频检索等任务中超越多个SOTA模型，7B版本甚至优于更大参数量模型。研究发现视频-文本数据具有统一模态潜力，细粒度样本对训练效果提升显著。论文及代码已开源，为多模态学习提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T22:02:58Z
- **目录日期**: 2025-06-08
