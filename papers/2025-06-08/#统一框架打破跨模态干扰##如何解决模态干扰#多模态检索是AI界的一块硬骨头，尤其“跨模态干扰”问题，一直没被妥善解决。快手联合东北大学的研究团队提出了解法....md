...
快手与东北大学团队提出UNITE统一嵌入框架，通过模态感知对比学习解决跨模态干扰问题。该框架使用单一嵌入器处理文本、图像、视频及其组合，采用两阶段训练：检索适应建立基础能力，指令微调增强复杂任务处理。实验显示，UNITE在图文/视频检索、指令理解等任务中超越现有模型，7B版本性能优于更大规模模型。研究发现视频-文本数据具有统一模态潜力，细粒度样本对训练效果显著。论文及代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T13:09:33Z
- **目录日期**: 2025-06-08
