...
快手与东北大学团队提出UNITE统一嵌入框架，通过模态感知对比学习(MAMCL)解决跨模态干扰问题。该框架采用两阶段训练：检索适应建立多模态基础能力，指令微调增强复杂任务处理。实验显示，UNITE在图文/视频检索、指令理解等任务中超越E5-V等模型，7B版本甚至优于更大模型。研究发现：1)视频-文本数据具有统一模态潜力；2)指令任务依赖文本-图像数据；3)细粒度视频-文本样本对初期训练最有效。论文和代码已开源，在Flickr30K等基准测试中表现优异。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T21:02:47Z
- **目录日期**: 2025-06-08
