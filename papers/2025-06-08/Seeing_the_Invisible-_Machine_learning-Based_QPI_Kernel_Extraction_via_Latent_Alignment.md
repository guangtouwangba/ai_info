...
本文提出了一种基于人工智能的准粒子干涉(QPI)核提取新方法，解决了传统多散射源图像分析中的不适定反问题。该框架采用两步学习策略：首先通过变分自编码器学习散射核的紧凑潜在空间表示，再使用专用编码器将QPI观测数据与预学习核的潜在表示对齐。这种设计使模型能在复杂纠缠散射条件下稳健推断核函数。研究构建了包含100种独特核的多样化QPI数据集，实验表明该方法相比直接一步法基线具有更高的提取精度，并对未见核展现出更好的泛化能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T11:01:22Z
- **目录日期**: 2025-06-08
