...
本文提出首个基于AI的准粒子干涉(QPI)核提取框架，通过两步学习策略解决多散射源图像中单散射核提取这一病态逆问题。第一步训练变分自编码器学习散射核的紧凑潜在空间；第二步通过专用编码器将QPI观测数据与预学习核的潜在表示对齐。该方法在复杂纠缠散射条件下仍能稳健推断散射核。研究构建了包含100个独特核的多样化物理真实QPI数据集，实验表明该方法的提取精度显著优于直接单步基线，对未见核具有更好泛化能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T01:29:23Z
- **目录日期**: 2025-06-08
