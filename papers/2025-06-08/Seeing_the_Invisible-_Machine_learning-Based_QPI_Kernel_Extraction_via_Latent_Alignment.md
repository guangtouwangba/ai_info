...
本文提出首个基于AI的准粒子干涉(QPI)核提取框架，解决多散射源图像中单散射QPI模式提取这一病态逆问题。研究采用两步学习策略：首先训练变分自编码器学习散射核的紧凑潜在空间表示；然后通过专用编码器将QPI观测的潜在表示与预学习核对齐。这种设计使模型能在复杂纠缠散射条件下稳健推断核函数。研究者构建了包含100个独特核的多样化QPI数据集，实验表明该方法相比直接一步法基线具有更高提取精度，对未见核的泛化能力也显著提升。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T08:01:26Z
- **目录日期**: 2025-06-08
