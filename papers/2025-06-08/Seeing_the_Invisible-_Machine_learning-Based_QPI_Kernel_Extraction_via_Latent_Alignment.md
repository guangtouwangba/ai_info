...
本文提出首个基于AI的准粒子干涉(QPI)核提取框架，通过两步学习策略解决多散射源图像反演难题。第一步采用变分自编码器学习散射核的紧凑潜在空间表示；第二步通过专用编码器对齐QPI观测数据与预学习核的潜在表征。这种设计使模型能在复杂纠缠散射条件下稳健推断核函数。研究构建了包含100种独特核的多样化QPI数据集，实验表明该方法较传统一步法基线显著提高了提取精度，并对未见核具有更好泛化能力，为量子材料电子结构研究提供了新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T20:01:18Z
- **目录日期**: 2025-06-08
