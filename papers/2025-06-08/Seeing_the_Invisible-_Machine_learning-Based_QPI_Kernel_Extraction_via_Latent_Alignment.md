...
本文提出了一种基于AI的准粒子干涉(QPI)核提取新方法。研究者开发了一个两步学习框架：第一步使用变分自编码器学习散射核的紧凑潜在空间表示；第二步通过专用编码器将QPI观测数据与预学习核的潜在表示对齐。该方法能有效解决多散射源图像中单散射核提取这一病态逆问题，在复杂纠缠散射条件下仍保持鲁棒性。实验基于包含100种独特核的多样化QPI数据集，结果显示该方法相比直接一步法基线具有更高的提取精度，并对未见核展现出更好的泛化能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T06:01:21Z
- **目录日期**: 2025-06-08
