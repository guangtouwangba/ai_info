...
本研究提出首个基于AI的准粒子干涉（QPI）核提取框架，通过两步学习策略解决多散射源图像中单散射核的反演难题。首先使用变分自编码器学习散射核的紧凑潜在空间表示，再通过专用编码器将QPI观测数据与预学习核的潜在表示对齐。这种设计使模型能在复杂散射条件下稳健推断散射核。基于100种独特核构建的物理真实数据集验证表明，该方法较直接单步基线方案具有更高提取精度，对未见核的泛化能力更强，为量子材料电子结构研究提供了新工具。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T14:01:38Z
- **目录日期**: 2025-06-08
