...
苹果最新论文《The Illusion of Thinking》指出，当前大语言模型（如DeepSeek、Claude等）的"推理能力"本质是模式匹配而非真实思考。研究通过汉诺塔等4种复杂度可调的谜题测试发现：低难度时基础模型更高效；中等难度思维链有效；但高复杂度下所有模型准确率归零，且会主动"放弃思考"。论文揭示大模型缺乏泛化逻辑能力，无法真正执行分步推理，所谓"AI思考"只是高级模板匹配。这一结论对当前大模型推理神话提出了根本性质疑。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T13:09:11Z
- **目录日期**: 2025-06-08
