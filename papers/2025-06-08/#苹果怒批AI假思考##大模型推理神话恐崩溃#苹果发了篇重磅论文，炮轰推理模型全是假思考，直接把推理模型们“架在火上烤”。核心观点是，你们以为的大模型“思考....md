...
苹果最新论文《The Illusion of Thinking》指出，当前大语言模型的"推理能力"存在根本缺陷。研究通过汉诺塔等4类可控谜题测试发现：低复杂度任务中，简单模型表现更优；中等难度时思维链技术有效；但面对高复杂度问题，包括DeepSeek、Claude在内的所有模型准确率归零。关键发现是模型在遇到困难时会主动"放弃思考"，暴露出其缺乏真正的逻辑泛化能力，所谓推理仅是高级模式匹配。论文质疑大模型是否具备真正的思考能力，认为现有技术路线存在根本局限。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T19:02:24Z
- **目录日期**: 2025-06-08
