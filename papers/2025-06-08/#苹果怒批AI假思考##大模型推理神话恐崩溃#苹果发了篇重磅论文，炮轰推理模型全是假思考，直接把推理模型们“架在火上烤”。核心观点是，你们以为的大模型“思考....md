...
苹果最新论文《The Illusion of Thinking》指出，当前大语言模型（如DeepSeek、Claude等）的“推理”能力存在严重缺陷。通过汉诺塔等4类可控谜题测试发现：低复杂度任务中，无思维链模型表现更优；中等难度时思维链机制开始有效；但面对高复杂度问题，所有模型准确率均崩溃至0%。研究揭示大模型缺乏真正的逻辑泛化能力，在遇到困难时会主动停止“思考”，其推理本质是模式匹配而非真实认知。这一发现质疑了当前AI系统的“思考”神话。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T15:02:55Z
- **目录日期**: 2025-06-08
