...
本文提出了一种新视角，将语言模型的少样本学习能力置于更广泛的元学习框架中。作者认为，任何能通过上下文降低后续预测损失的序列分布都可视为某种上下文学习。这一观点有助于统一语言模型展现的各种上下文能力，如任务适应、角色扮演和时间序列预测等，并揭示了其可能源于语言依赖处理（如指代或平行结构）。研究强调泛化的重要性，包括学习新颖内容、适应不同呈现方式及应用所学知识的能力。最后，作者建议未来研究应关注更广泛的上下文能力类型和泛化维度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T14:02:53Z
- **目录日期**: 2025-06-08
