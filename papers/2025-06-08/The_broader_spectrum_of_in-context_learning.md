...
这篇论文提出了一种新视角，将语言模型的少量样本学习能力置于更广泛的元学习框架中。作者认为，任何能通过上下文降低后续预测损失的序列分布都可以被视为某种形式的上下文学习。这一观点有助于统一语言模型展现的各种上下文能力，如根据指令适应任务或外推时间序列，并揭示了其可能源于语言依赖的低层次处理（如共指或平行结构）。研究强调了泛化的重要性，包括学习新事物的能力、从不同呈现方式中学习的灵活性以及应用所学知识的能力。最后，作者建议未来研究应考虑更广泛的上下文学习能力和泛化类型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T21:02:14Z
- **目录日期**: 2025-06-08
