...
这篇论文针对代码生成大模型(codeLLMs)提出新评估方法，强调与人类偏好对齐的重要性。研究者创建了CodeArena基准测试(包含397个样本，覆盖40类编程任务和44种语言)来模拟真实编程场景，并构建了20B标记的合成指令数据集SynCode-Instruct。实验发现传统执行基准与人类偏好存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究突出了代码生成模型除正确性外，还需关注实际开发需求匹配度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T22:05:42Z
- **目录日期**: 2025-06-08
