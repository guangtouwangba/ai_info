...
这篇论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，关注模型输出与人类偏好的对齐问题。研究者收集了397个涵盖40类编程任务的真实样本(44种语言)，并构建20B标记的合成指令集SynCode-Instruct。实验发现：1)传统执行测试与人类偏好存在偏差；2)开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI)性能差距显著。研究强调代码生成质量需同时考虑功能正确性和人类可读性/实用性，为评估体系提供了新维度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T06:05:44Z
- **目录日期**: 2025-06-08
