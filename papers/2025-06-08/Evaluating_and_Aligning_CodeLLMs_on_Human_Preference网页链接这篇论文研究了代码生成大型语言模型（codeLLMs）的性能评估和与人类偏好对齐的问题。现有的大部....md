...
该论文针对代码生成大模型(codeLLMs)提出创新评估框架CodeArena，通过397个涵盖40类编程任务的真实样本评估模型与人类偏好的对齐程度。研究同时构建近200亿标记的合成指令数据集SynCode-Instruct验证微调效果。实验发现：1)传统执行基准与人类偏好存在差异；2)开源顶级模型(Qwen2.5-Coder)与商业模型(OpenAI o1)性能差距显著。研究强调代码LLMs需兼顾功能正确性和人类编程习惯，为模型优化提供新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T05:04:38Z
- **目录日期**: 2025-06-08
