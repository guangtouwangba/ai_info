...
这篇论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，关注模型输出与人类偏好的对齐问题。研究收集了397个涵盖40类编程任务和44种语言的真实样本，并构建近200亿标记的合成指令数据集SynCode-Instruct。实验发现传统执行测试与人类偏好存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，凸显了人类偏好对齐的重要性。研究为评估代码LLMs提供了更全面的框架，强调需同时考虑功能正确性和用户偏好。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T16:04:32Z
- **目录日期**: 2025-06-08
