...
这篇论文针对代码生成大模型(codeLLMs)提出了CodeArena评估基准，重点关注模型输出与人类偏好的对齐问题。研究团队收集了397个涵盖40类编程任务和44种语言的高质量样本，并构建了20B标记的合成指令数据集SynCode-Instruct。实验发现，传统基于执行的评估与人类偏好存在差异，且开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究强调了代码生成模型不仅需要正确性，还需符合人类编程习惯和偏好。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T01:33:17Z
- **目录日期**: 2025-06-08
