...
该论文针对代码生成大模型(codeLLMs)与人类偏好对齐问题，提出了CodeArena基准测试(包含397个高质量样本，覆盖40类编程任务和44种语言)和SynCode-Instruct合成指令库(近200亿标记)。研究发现传统执行基准与人类偏好存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，凸显了人类偏好对齐的重要性。研究通过构建多样化评估体系，验证了大规模合成指令微调的有效性，为提升代码LLMs的实际应用价值提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T02:39:45Z
- **目录日期**: 2025-06-08
