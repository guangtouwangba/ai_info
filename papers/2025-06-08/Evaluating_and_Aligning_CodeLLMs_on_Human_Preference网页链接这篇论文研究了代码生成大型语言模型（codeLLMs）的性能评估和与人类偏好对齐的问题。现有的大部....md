...
这篇论文提出了CodeArena基准测试和SynCode-Instruct语料库，以解决现有代码生成大模型评估中忽视人类偏好的问题。CodeArena包含397个高质量样本，覆盖40类编程任务和44种语言；SynCode-Instruct则包含近200亿标记的合成指令数据。实验发现执行基准与人类偏好评估存在差异，开源模型（如Qwen2.5-Coder）与商业模型（如OpenAI o1）性能差距显著，凸显了模型对齐人类偏好的重要性。研究强调了在代码生成评估中综合考虑功能正确性和用户体验的必要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T09:05:47Z
- **目录日期**: 2025-06-08
