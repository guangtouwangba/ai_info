...
当前大语言模型(LLMs)主要应用于同步对话场景，而现实中的群聊、在线会议等往往是异步的。本研究开发了一种异步LLM智能体，不仅能决定说什么，还能判断何时发言。通过在"狼人杀"游戏中收集人类与AI混合参与的数据集，发现该智能体在游戏表现和融入度上与人类相当，其发言时机选择与人类相似，但内容存在差异。研究发布了完整数据和代码，为LLMs融入真实人类群体互动(如团队讨论、教育等需要处理复杂社交动态的场景)奠定了基础。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T19:01:26Z
- **目录日期**: 2025-06-08
