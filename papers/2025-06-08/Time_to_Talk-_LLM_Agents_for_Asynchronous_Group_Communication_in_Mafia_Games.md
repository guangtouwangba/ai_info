...
当前大语言模型(LLMs)主要用于同步对话，而现实场景如群聊、在线会议等多为异步交流。本研究开发了一种自适应异步LLM智能体，不仅能决定说什么，还能判断何时发言。通过在"狼人杀"游戏中与人类玩家互动测试，该智能体在游戏表现和社交融入度上都与人类相当。分析显示，其发言时机选择与人类相似，但内容存在差异。研究发布了完整数据集和代码，为LLM融入真实人类群体互动(如团队协作、教育等需处理复杂社交动态的场景)奠定了基础。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T01:29:31Z
- **目录日期**: 2025-06-08
