...
当前大语言模型(LLMs)主要用于同步对话，而现实场景多为异步交流(如群聊、在线会议)。本研究开发了一种异步LLM智能体，能自主决定发言内容和时机。通过在"狼人杀"游戏中与人类玩家对比测试，该智能体在游戏表现和社交融入度上都达到人类水平。分析显示其发言时机选择与人类相似，但内容存在差异。研究发布了完整数据集和代码，为LLMs融入真实群体场景(如团队协作、教育环境)奠定了基础，推动了智能体在复杂社交动态中的实际应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T20:01:28Z
- **目录日期**: 2025-06-08
