...
当前大语言模型(LLM)主要用于同步对话，而现实场景多为异步交流(如群聊、在线会议等)。本研究开发了一种自适应异步LLM智能体，不仅能决定说什么，还能决定何时发言。通过在"狼人杀"游戏中与人类玩家共同测试，该智能体在游戏表现和社交融入度上都达到人类水平。分析表明，其发言时机选择与人类相似，但内容存在差异。研究发布了完整数据和代码，为LLM融入真实人类群体场景(如团队协作、教育等)奠定了基础，推动了需要处理复杂社交动态的异步通信研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T12:01:39Z
- **目录日期**: 2025-06-08
