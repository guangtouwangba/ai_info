...
当前大语言模型(LLMs)主要用于同步对话，而现实场景多为异步交流(如群聊、在线会议等)。本研究开发了一种异步LLM智能体，不仅能决定"说什么"，还能判断"何时说"。通过在"狼人杀"游戏中测试，该智能体表现与人类相当，能自然地融入群体。分析显示其发言时机选择与人类相似，但内容存在差异。研究公开了全部数据和代码，为LLM融入真实群体场景(如团队协作、教育等)奠定了基础，推动了更自然的异步人机交互研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T09:01:29Z
- **目录日期**: 2025-06-08
