...
当前大语言模型（LLM）主要用于同步对话（轮流发言），但现实场景（如群聊、在线会议、社交游戏）多为异步交流。本研究开发了一种异步LLM智能体，不仅能决定发言内容，还能自主选择发言时机。通过在"狼人杀"游戏中与人类玩家同台测试，该智能体表现与人类相当，且能自然融入群体。分析显示，其发言时机选择与人类高度相似，但内容存在差异。研究公开了数据和代码，推动LLM在异步交流中的发展，为团队协作、教育等需要复杂社交互动的场景应用奠定了基础。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T04:08:42Z
- **目录日期**: 2025-06-08
