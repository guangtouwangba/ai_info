...
当前大语言模型(LLM)主要应用于同步对话场景，而现实中的群聊、在线会议等多采用异步交流模式。本研究开发了一种自适应异步LLM智能体，不仅能决定发言内容，还能自主选择发言时机。通过在"狼人杀"游戏中与人类玩家互动测试，该智能体在游戏表现和社交融入度方面都达到人类水平。分析显示，其发言时机决策与人类行为高度相似，但发言内容存在差异。研究团队公开了所有数据和代码，为LLM在团队协作、教育等需要复杂社交互动的真实场景中的应用铺平了道路。(99字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T18:01:25Z
- **目录日期**: 2025-06-08
