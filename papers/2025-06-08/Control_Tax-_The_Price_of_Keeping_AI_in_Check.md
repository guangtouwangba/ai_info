...
本文提出了"控制税"(Control Tax)的概念，即AI系统中实施控制措施所需的运营和财务成本。研究建立了量化控制税的理论框架，将分类器性能与安全保障相关联；评估了先进语言模型在对抗性攻击下的表现，其中攻击模型植入隐蔽后门而监控模型尝试检测漏洞；并提供了控制协议的实际成本估算，开发了平衡安全性与成本效益的优化监控策略。该框架通过系统连接安全保证与成本，帮助从业者在不同部署场景下做出基于经济可行性的明智决策，推动AI控制领域的实际应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T00:01:55Z
- **目录日期**: 2025-06-08
