...
本文提出"控制税"(Control Tax)概念，用于衡量AI控制措施在运营和财务上的成本。研究建立了量化控制税的理论框架，将分类器性能与安全保障相关联；评估了先进语言模型在对抗性场景中的表现，攻击模型植入隐蔽后门而监控模型试图检测漏洞；并实证估算控制协议的成本，开发了平衡安全性和成本效益的优化监控策略。该框架通过系统连接安全保障与其成本，帮助从业者在不同部署场景中做出基于经济可行性的决策，推动AI控制领域的实际应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T03:27:47Z
- **目录日期**: 2025-06-08
