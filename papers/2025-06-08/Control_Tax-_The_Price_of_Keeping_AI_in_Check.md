...
本文提出"控制税"(Control Tax)概念，用于量化AI系统中集成安全控制措施的操作与财务成本。研究建立了理论框架，将分类器性能映射到安全保障，评估了先进语言模型在对抗性攻击下的表现，并估算不同控制协议的实际成本。通过开发优化的监控策略，研究在审计预算等现实约束下平衡安全性与成本效益。该框架首次系统性地连接安全保证与其实现成本，为AI控制领域提供了基于经济可行性的决策依据，有助于推动高风险AI应用的实际部署。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T04:08:58Z
- **目录日期**: 2025-06-08
