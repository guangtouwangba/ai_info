...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析和写作一站式服务。它支持中英文文献搜索，拥有3.5亿论文、0.6亿学者等海量数据，并可通过AI生成摘要和问答辅助理解。用户可上传PDF或从库中选取文献，获取章节概要和问题建议。平台还提供科研动态订阅，按用户偏好推送最新成果。此外，AMiner具备学者画像、学术会议追踪等功能，基础服务免费使用。网址：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T21:05:19Z
- **目录日期**: 2025-06-08
