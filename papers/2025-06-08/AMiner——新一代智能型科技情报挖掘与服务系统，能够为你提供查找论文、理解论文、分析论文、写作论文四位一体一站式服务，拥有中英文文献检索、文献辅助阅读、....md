...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、AI辅助阅读、自动摘要生成、翻译及科研情报订阅等功能。平台收录3.5亿论文、0.6亿学者等海量数据，支持用户通过提问快速理解文献内容，并定制推送最新学术动态。其特色功能涵盖学者画像、学术会议追踪及论文排行榜，基础服务可免费使用。访问入口：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T03:31:26Z
- **目录日期**: 2025-06-08
