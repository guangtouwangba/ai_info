...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、翻译、辅助阅读和科研情报订阅。它拥有庞大的数据库，涵盖3.5亿论文、0.6亿学者和1.5亿专利。用户可通过互动问答快速获取文献摘要，并利用AI工具生成章节概要和问题建议。平台还支持个性化订阅，推送最新科研动态。AMiner免费开放使用，旨在提升学术研究效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T00:05:22Z
- **目录日期**: 2025-06-08
