...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译及科研分析等一站式服务。其核心功能包括：1）中英文文献检索，支持互动问答和自动摘要生成；2）英文文献翻译与AI辅助阅读，可上传PDF并获取章节概要和问题解答；3）个性化科研订阅，通过微信或邮件推送最新学术动态。平台覆盖42个学科，包含3.5亿论文、0.6亿学者等数据，并提供学者画像、会议追踪等附加功能。用户可通过网页免费使用基础服务，旨在提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T08:06:15Z
- **目录日期**: 2025-06-08
