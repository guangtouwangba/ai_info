...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、翻译、辅助阅读和论文写作支持。它拥有海量学术资源（3.5亿论文、0.6亿学者等），支持AI生成摘要、智能问答和科研动态订阅。用户可通过关键词、学者或机构定制推送最新研究，还能上传PDF进行智能解析。平台免费提供学者画像、学术会议等特色功能，帮助高效获取和管理科研信息。访问aminer.cn即可体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T16:04:21Z
- **目录日期**: 2025-06-08
