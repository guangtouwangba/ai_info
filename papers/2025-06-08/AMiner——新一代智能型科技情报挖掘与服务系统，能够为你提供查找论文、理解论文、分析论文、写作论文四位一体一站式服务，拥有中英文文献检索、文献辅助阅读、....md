...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索（覆盖3.5亿论文）、AI辅助阅读（自动生成摘要、章节概要）、文献翻译及互动问答功能。支持用户上传PDF或从数据库选文，通过AI快速解析内容。平台还提供个性化科研情报订阅服务，按用户设定的学者、机构或关键词推送最新研究动态。此外，包含学者画像、学术会议追踪等特色功能，基础检索服务免费开放。网址：https://www.aminer.cn/ （100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T09:05:37Z
- **目录日期**: 2025-06-08
