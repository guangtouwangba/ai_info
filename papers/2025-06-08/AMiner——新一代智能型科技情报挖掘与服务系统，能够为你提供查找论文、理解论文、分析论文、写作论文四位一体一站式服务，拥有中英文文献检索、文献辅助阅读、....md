...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和科研订阅等一站式服务。它覆盖42个学科，包含3.5亿论文、0.6亿学者等海量数据。主要功能包括：1）中英文文献检索，支持智能问答和自动摘要生成；2）英文文献翻译与辅助阅读，可上传PDF并获取AI解析；3）个性化科研订阅，按用户偏好推送最新研究动态。此外还提供学者画像、学术会议等特色功能，基础服务可免费使用。平台网址：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T05:04:28Z
- **目录日期**: 2025-06-08
