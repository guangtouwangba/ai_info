...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析和写作一站式服务。它支持中英文文献搜索，能自动生成摘要和问答互动，帮助用户快速理解论文内容。平台还包含文档识别、辅助阅读和科研情报订阅功能，可根据用户偏好推送最新学术动态。此外，AMiner提供学者画像、学术会议和必读论文专题等功能，收录了3.5亿论文、0.6亿学者等海量数据。用户可通过浏览器免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T23:04:04Z
- **目录日期**: 2025-06-08
