...
2024年智源大会（"AI春晚"）汇聚四位图灵奖得主（Bengio、Sutton、姚期智、Sifakis）分享前沿洞见，同时展示多款尖端机器人：宇树G1人形机器人展现拳击能力，天工机器人2.0演示家政技能，银河通用机器人实现语音指令全流程操作。活动呈现"科研+应用"双轨并进态势，被誉"未来已至"的AI盛会。（注：原文含4张动态图展示机器人实况）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T04:10:39Z
- **目录日期**: 2025-06-08
