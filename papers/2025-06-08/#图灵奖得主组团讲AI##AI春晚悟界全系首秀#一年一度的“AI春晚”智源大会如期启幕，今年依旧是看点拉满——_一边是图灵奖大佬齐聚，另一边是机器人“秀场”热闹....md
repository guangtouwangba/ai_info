...
2024年智源大会（"AI春晚"）呈现两大亮点：1）机器人展演中，宇树G1人形机器人展示拳击技能，天工机器人2.0版本演示家政服务，银河通用机器人实现语音指令完成取货全流程；2）四位图灵奖得主（Bengio、Sutton、姚期智、Sifakis）同台分享AI前沿洞见。活动通过"科研+应用"双线展示，凸显AI技术快速落地的发展趋势。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T16:02:51Z
- **目录日期**: 2025-06-08
