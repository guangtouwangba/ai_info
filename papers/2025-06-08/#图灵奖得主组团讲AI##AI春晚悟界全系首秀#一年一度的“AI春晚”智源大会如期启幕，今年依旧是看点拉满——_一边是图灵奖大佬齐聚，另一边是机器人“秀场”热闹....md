...
2024年智源大会（AI春晚）亮点纷呈：四位图灵奖得主（Bengio、Sutton、姚期智、Sifakis）发表前沿演讲；人形机器人成为焦点，宇树G1展示拳击能力，天工机器人2.0演示家政技能，银河通用机器人实现语音指令取货全流程。活动呈现科研与应用的深度融合，彰显AI技术快速发展的"未来感"。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T21:03:52Z
- **目录日期**: 2025-06-08
