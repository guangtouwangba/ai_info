# #图灵奖得主组团讲AI##AI春晚悟界全系首秀#一年一度的“AI春晚”智源大会如期启幕，今年依旧是看点拉满—— 一边是图灵奖大佬齐聚，另一边是机器人“秀场”热闹...
...
2024年智源大会（AI春晚）汇聚四大亮点：1）人形机器人同台竞技，宇树G1展示拳击能力，天工2.0演示家政技能；2）银河通用机器人实现语音指令全流程操作；3）四位图灵奖得主（Bengio、Sutton、姚期智、Sifakis）发表前沿演讲；4）现场呈现科研与应用的"未来已至"场景，包括机器人动态演示（拳击/长跑/甜点制作）和AI技术布道。活动通过机器人实操与顶尖学术分享，展现AI领域最新突破。（99字）  

注：保留核心事件（机器人展示+图灵奖演讲）、关键人物及技术亮点，压缩冗余描述，符合字数限制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T05:02:07Z
- **目录日期**: 2025-06-08
