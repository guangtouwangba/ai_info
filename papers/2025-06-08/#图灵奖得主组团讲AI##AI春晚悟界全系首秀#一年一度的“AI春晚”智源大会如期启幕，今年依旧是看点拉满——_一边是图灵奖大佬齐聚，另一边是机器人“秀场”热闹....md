...
2024年智源大会（AI春晚）亮点纷呈：1）机器人展演：宇树G1人形机器人展示拳击技能，天工2.0版本演示家政服务；银河通用机器人实现语音指令完成取货全流程。2）学术前沿：四位图灵奖得主（Bengio、Sutton、姚期智、Sifakis）同台分享AI洞见。活动呈现"科研+应用"双轨并进态势，彰显AI技术落地成果与未来发展趋势。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T19:03:39Z
- **目录日期**: 2025-06-08
