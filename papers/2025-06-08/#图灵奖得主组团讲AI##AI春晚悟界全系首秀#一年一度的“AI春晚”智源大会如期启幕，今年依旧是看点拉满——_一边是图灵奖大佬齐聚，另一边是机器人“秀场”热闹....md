...
2024年智源大会（"AI春晚"）亮点纷呈：1）机器人展演：宇树G1人形机器人展示拳击能力，天工机器人2.0版演示家政技能；银河通用机器人实现语音指令完成取货全流程。2）学术前沿：四位图灵奖得主（Bengio、Sutton、姚期智、Sifakis）发表主题演讲。活动呈现AI领域"科研+应用"的双轨发展，人机协作场景的突破性进展尤为瞩目。（98字） 

注：根据微博内容提炼核心信息，保留最具代表性的机器人演示和顶尖学者参与两个维度，符合摘要的简洁性要求。需要更详细的技术细节或演讲内容可进一步扩展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T12:04:28Z
- **目录日期**: 2025-06-08
