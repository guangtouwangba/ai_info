...
2024年"AI春晚"智源大会亮点纷呈：四位图灵奖得主（Bengio、Sutton、姚期智、Sifakis）同台演讲；人形机器人上演精彩对决——宇树G1展示拳击技能，天工2.0版本演示家政服务；银河通用机器人实现语音指令完成取货全流程。活动呈现科研与应用的深度融合，展现AI技术前沿进展。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T02:37:17Z
- **目录日期**: 2025-06-08
