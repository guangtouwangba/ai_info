...
2024年智源"AI春晚"亮点纷呈：四位图灵奖得主（Bengio、Sutton、姚期智、Sifakis）同台演讲；人形机器人展示惊艳技能——宇树G1表演拳击，天工2.0展示家政能力；银河通用机器人实现语音指令完成取货全流程。活动呈现AI领域"科研+应用"双轨并进的发展态势，被誉"未来已至"的科技盛会。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T22:04:03Z
- **目录日期**: 2025-06-08
