...
2024年智源大会（AI春晚）亮点纷呈：1）机器人展演：宇树G1人形机器人展示拳击能力，天工机器人2.0演示家政技能，银河通用机器人实现语音指令取货全流程；2）学术前沿：四位图灵奖得主（Bengio、Sutton、姚期智、Sifakis）同台分享AI洞见。活动呈现"科研+应用"双轨并进态势，被誉"未来已至"的AI技术盛会。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T23:02:42Z
- **目录日期**: 2025-06-08
