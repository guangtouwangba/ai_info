...
2024年"AI春晚"智源大会亮点纷呈：四位图灵奖得主（Bengio、Sutton、姚期智、Sifakis）同台演讲，分享AI前沿洞见。现场机器人展示尤为吸睛，宇树G1人形机器人展现拳击能力，天工2.0版演示家政技能；银河通用机器人实现语音指令完成取货全流程。活动呈现"科研+应用"双轨并行，既有顶尖学术探讨，又有实用场景落地，充分展现AI技术发展现状与未来潜力。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T03:29:21Z
- **目录日期**: 2025-06-08
