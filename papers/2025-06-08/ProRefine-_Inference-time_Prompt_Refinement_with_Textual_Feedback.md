...
本文介绍ProRefine，一种创新的即时提示优化方法，用于解决多智能体协作工作流中的错误传播和性能不佳问题。该方法利用大语言模型的文本反馈动态优化多步推理任务的提示，无需额外训练或真实标签。在五个数学推理基准测试中，ProRefine显著超越零样本思维链基线3-37个百分点。该技术不仅能提高准确性，还能让小模型达到大模型的性能，有助于高效、可扩展的AI部署，推动高性能AI的普及应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T11:01:41Z
- **目录日期**: 2025-06-08
