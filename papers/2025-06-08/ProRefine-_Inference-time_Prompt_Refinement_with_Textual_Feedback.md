...
ProRefine是一种创新的提示优化方法，通过利用大语言模型(LLM)的文本反馈来动态优化多智能体协作工作流中的提示。该方法无需额外训练或真实标签，就能显著提升多步推理任务的性能。在五个数学推理基准测试中，ProRefine比零样本思维链基线高出3-37个百分点。研究显示，该方法不仅能提高准确性，还能让较小模型达到与大模型相当的性能，有助于实现更高效、可扩展的AI部署，促进高性能AI的普及应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T18:01:34Z
- **目录日期**: 2025-06-08
