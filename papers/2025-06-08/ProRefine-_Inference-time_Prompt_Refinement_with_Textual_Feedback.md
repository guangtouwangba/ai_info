...
多智能体协作工作流常因提示设计不佳导致错误传播和性能下降。研究者提出ProRefine方法，利用大语言模型的文本反馈动态优化多步推理任务的提示，无需额外训练或标注数据。在五个数学推理基准测试中，ProRefine比零样本思维链基线提升3-37个百分点，使小模型能达到大模型性能，提升了AI系统的准确性、可扩展性和部署效率。该方法为高性能AI的普及应用提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T19:01:33Z
- **目录日期**: 2025-06-08
