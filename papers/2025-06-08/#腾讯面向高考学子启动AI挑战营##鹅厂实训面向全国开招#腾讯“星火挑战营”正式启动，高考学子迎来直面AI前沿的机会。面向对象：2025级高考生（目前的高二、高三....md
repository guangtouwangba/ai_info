...
腾讯推出"星火挑战营"，面向2025级高考生（现高二、高三）招募60-70人，报名截止6月13日。营期定于2025年8月8-14日在深圳举行，优先录取数学/物理/信息学等领域的优秀学生（含奥赛获奖者）。项目聚焦四大AI前沿方向：1）微信读书团队的百万字文本理解技术；2）OpenAI式长思维链推理；3）腾讯Robotics X实验室的具身智能机器人；4）优图实验室的多模态情绪识别技术。入选者将直接参与腾讯AI核心项目研发。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T18:02:40Z
- **目录日期**: 2025-06-08
