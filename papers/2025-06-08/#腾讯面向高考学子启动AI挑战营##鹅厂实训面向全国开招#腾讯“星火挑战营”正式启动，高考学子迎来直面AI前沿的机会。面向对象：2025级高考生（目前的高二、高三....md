...
腾讯启动面向2025级高考生的"星火挑战营"，聚焦AI前沿技术。活动将于2025年8月8-14日在深圳举行，招募60-70名数学、物理或信息学表现突出的学生（奥赛获奖者优先）。项目涵盖四大方向：1）微信读书团队指导的超长文本理解；2）OpenAI式长思维链技术；3）腾讯Robotics X实验室的具身智能与机器人；4）优图实验室的多模态感知理解。报名截止6月13日，旨在让高中生接触大模型、具身智能等尖端AI研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T09:02:48Z
- **目录日期**: 2025-06-08
