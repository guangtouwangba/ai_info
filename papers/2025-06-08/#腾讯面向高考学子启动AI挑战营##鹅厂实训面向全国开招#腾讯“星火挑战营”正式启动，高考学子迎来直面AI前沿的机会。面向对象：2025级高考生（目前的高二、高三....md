...
腾讯启动面向2025级高考生的“星火挑战营”，聚焦AI前沿技术，招募60-70名数学、物理或信息学表现突出的学生（奥赛获奖者优先）。活动将于2025年8月8-14日在深圳举行，涵盖四大方向：超长文本理解（微信读书AI团队指导）、长思维链技术（模仿OpenAI/DeepSeek推理）、具身智能机器人（腾讯Robotics X实验室实操）及多模态感知（优图实验室情绪识别研究）。报名截止6月13日，旨在为高中生提供顶尖AI实践机会。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T12:03:02Z
- **目录日期**: 2025-06-08
