...
腾讯面向2025级高考生（高二、高三）启动"星火挑战营"AI实训项目，聚焦四大前沿技术方向：1）超长文本理解（微信读书AI团队指导）；2）长思维链技术（学习OpenAI/DeepSeek的复杂推理方法）；3）具身智能+机器人（腾讯Robotics X实验室实践）；4）多模态感知理解（优图实验室研究情绪识别）。活动将于2025年8月8-14日在深圳举行，招募60-70人，6月13日截止报名。优先考虑数学/物理/信息学竞赛获奖、重点高校预录取或有科技项目成果的学生。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T15:03:06Z
- **目录日期**: 2025-06-08
