...
腾讯推出"星火挑战营"，面向2025级高考生（现高二、高三）招募60-70人，6月13日截止报名。营期定于2025年8月8-14日在深圳举行，聚焦AI前沿四大方向：1）微信读书团队指导的超长文本理解；2）OpenAI风格的复杂推理拆解技术；3）腾讯Robotics X实验室的具身智能机器人实践；4）优图实验室的多模态情绪识别。优先录取数理信息学科优等生，含奥赛获奖、科技赛事成绩者。活动提供高中生接触大模型、具身智能等尖端技术的研究机会。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T22:02:50Z
- **目录日期**: 2025-06-08
