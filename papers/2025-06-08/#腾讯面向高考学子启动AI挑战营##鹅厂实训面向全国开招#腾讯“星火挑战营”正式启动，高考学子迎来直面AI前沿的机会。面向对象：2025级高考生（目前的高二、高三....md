...
腾讯启动"星火挑战营"AI项目，面向2025级高考生（高二/高三）招募60-70人，特别欢迎数学、物理、信息学等领域有特长的学生（奥赛获奖者优先）。活动将于2025年8月8-14日在深圳举行，报名截止6月13日。项目聚焦四大前沿AI方向：1）微信读书团队指导的超长文本理解；2）模仿OpenAI的长思维链技术；3）腾讯Robotics X实验室的具身智能与机器人；4）优图实验室的多模态感知理解。入选者将直接参与腾讯顶级AI团队的前沿研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T20:02:46Z
- **目录日期**: 2025-06-08
