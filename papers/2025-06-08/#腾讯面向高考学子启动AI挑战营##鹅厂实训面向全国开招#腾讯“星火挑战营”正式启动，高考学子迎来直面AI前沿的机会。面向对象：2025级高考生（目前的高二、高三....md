...
腾讯启动"星火挑战营"AI项目，面向2025级高考生（高二/高三），特别欢迎数学、物理、信息学等领域表现优异者（奥赛获奖、重点高校预录取等优先）。活动将于2025年8月8-14日在深圳举行，限60-70人，报名截止6月13日。项目聚焦四大前沿AI技术：1）微信读书团队的百万字文本理解与创作；2）OpenAI式长思维链拆解技术；3）腾讯Robotics X实验室的具身智能机器人应用；4）优图实验室的多模态情绪识别技术。活动旨在让高中生直接参与尖端AI研发。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T14:03:19Z
- **目录日期**: 2025-06-08
