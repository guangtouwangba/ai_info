...
腾讯推出"星火挑战营"，面向2025级高考生（高二/高三）招募60-70人，6月13日截止报名。活动将于2025年8月8-14日在深圳举行，聚焦四大AI前沿方向：1）超长文本理解（微信读书AI团队指导）；2）长思维链技术（OpenAI/DeepSeek式推理）；3）具身智能+机器人（腾讯Robotics X实验室实践）；4）多模态感知（优图实验室情绪识别技术）。优先录取数理信息学科优异者，含奥赛获奖、高校预录取或科技赛事成果学生。活动提供接触顶尖AI研究的实践机会。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T23:01:20Z
- **目录日期**: 2025-06-08
