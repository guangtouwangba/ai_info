...
腾讯启动"星火挑战营"，面向2025级高考生（高二/高三），招募60-70名在数学、物理、信息学等领域表现突出的学生。活动将于2025年8月8-14日在深圳举行，报名截止6月13日。挑战营聚焦四大前沿AI技术：超长文本理解（微信读书AI团队指导）、长思维链技术（模仿OpenAI/DeepSeek推理）、具身智能+机器人（腾讯Robotics X实验室）、多模态感知理解（腾讯优图实验室）。优先考虑有奥赛成绩、重点高校预录取资格或科技赛事成绩者。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T16:01:32Z
- **目录日期**: 2025-06-08
