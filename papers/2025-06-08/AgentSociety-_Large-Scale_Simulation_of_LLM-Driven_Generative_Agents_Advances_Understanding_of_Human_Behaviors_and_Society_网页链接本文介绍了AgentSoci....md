...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能够模拟1万多个智能代理及其500万次社会互动。该系统通过真实社会环境和强大模拟引擎，研究了四个关键社会问题：社会极化、刺激性信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，验证了该系统在揭示人类行为机制和社会问题成因方面的有效性。研究表明AgentSociety可作为计算社会科学的重要工具，为研究者和政策制定者提供新的研究方法，补充传统调查和干预手段的不足。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T17:05:22Z
- **目录日期**: 2025-06-08
