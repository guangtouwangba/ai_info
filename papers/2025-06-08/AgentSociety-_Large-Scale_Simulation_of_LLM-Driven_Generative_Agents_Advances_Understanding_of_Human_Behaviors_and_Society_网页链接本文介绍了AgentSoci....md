...
AgentSociety是一种基于大语言模型的大规模社会模拟器，可模拟10,000多个代理和500万次互动。研究者用它分析四个社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实数据吻合，验证了该系统捕捉人类行为机制的能力。该工具可作为社会科学研究和政策制定的新方法，补充传统调查和实验手段。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T09:05:06Z
- **目录日期**: 2025-06-08
