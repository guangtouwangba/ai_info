...
中科大团队提出GCoT框架，首次将语言模型的"思维链"方法应用于无文本的图数据。该框架通过三步推理：初步推断→生成中间"思维"表示→创建节点专属提示进行迭代优化。实验表明，在8个数据集上仅用1-5个样本，GCoT就超越现有最优模型，突破了传统图学习方法在少样本场景下的性能瓶颈。这项研究为处理复杂图结构数据提供了新思路，显著提升了图神经网络的推理能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T21:02:57Z
- **目录日期**: 2025-06-08
