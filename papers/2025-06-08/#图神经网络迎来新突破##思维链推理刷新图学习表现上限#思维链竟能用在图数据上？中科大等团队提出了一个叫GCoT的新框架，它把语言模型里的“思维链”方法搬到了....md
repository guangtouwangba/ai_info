...
中科大团队提出GCoT框架，首次将语言模型的思维链推理应用于无文本的图数据。该方法通过分步处理：先由预训练模型初步推断，再融合多层隐藏表示生成中间"思维"，最后生成节点专属提示进行下一步推理。在8个数据集测试中，GCoT在1-5个样本的少样本情况下表现优于现有SOTA模型，突破了传统图学习方法在复杂图数据上的局限性。这一创新将思维链推理成功扩展到图学习领域，显著提升了模型性能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T13:09:43Z
- **目录日期**: 2025-06-08
