...
港科大等团队研究发现视觉语言模型（VLM）在多模态推理中存在"优势消失"和"反思惰性"问题。为此，他们构建了39K高质量多模态数据集ViRL39K，并提出VL-Rethinker框架，通过两项创新机制：1）优势样本回放（SSR）优先学习高价值样本；2）强制反思机制引导模型自主判断何时需要反思。该框架在MathVista等基准测试中超越GPT-o1，接近OpenAI-o1水平，不同规模模型均显著提升，证明"慢思考"在多模态领域的有效性。研究成果为提升VLM的深度推理能力提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T05:02:17Z
- **目录日期**: 2025-06-08
