...
港科大等团队针对视觉语言模型(VLM)在多模态推理中"慢思考"失效的问题，提出创新解决方案。研究发现传统慢思考框架存在"优势消失"和"反思惰性"两大瓶颈。为此，团队构建了39K高质量多模态数据集ViRL39K，并开发VL-Rethinker框架，通过"优势样本回放"(优先学习关键样本)和"强制反思机制"(智能触发自我验证)显著提升性能。该框架在多个基准测试中超越GPT-o1，接近OpenAI-o1水平，不同规模模型均获显著提升，证明了慢思考在多模态领域的应用潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T01:31:20Z
- **目录日期**: 2025-06-08
