...
港科大等团队针对视觉语言模型(VLM)在多模态推理中"慢思考"失效的问题，提出VL-Rethinker框架。该方案包含两大创新：1)优势样本回放机制(SSR)，通过智能筛选高价值训练样本提升效率；2)强制反思机制，引导模型自主判断反思时机。实验表明，该框架使不同规模模型在MathVista等基准上显著超越GPT-o1，接近OpenAI-o1水平，首次验证了慢思考在多模态领域的可行性。研究还构建了39K高质量多模态推理数据集ViRL39K，为后续研究提供资源支持。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-08T00:03:26Z
- **目录日期**: 2025-06-08
