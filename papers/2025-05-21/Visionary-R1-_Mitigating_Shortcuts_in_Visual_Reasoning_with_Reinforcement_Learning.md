...
这篇论文研究了如何通过强化学习训练视觉语言模型(VLMs)进行图像推理，而无需思维链监督。研究发现，直接应用强化学习会导致模型走捷径，影响泛化能力。作者提出"描述-推理-回答"的输出格式，要求模型先生成详细图像描述再进行推理。在27.3万无思维链的视觉问答对上训练的Visionary-R1模型，仅使用强化学习就在多个视觉推理基准上超越了GPT-4o、Claude3.5-Sonnet和Gemini-1.5-Pro等强大模型。该方法有效缓解了捷径学习问题，提升了模型的推理能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T17:01:10Z
- **目录日期**: 2025-05-21
