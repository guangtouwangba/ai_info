...
本研究提出了一种基于解码器-仅Transformer网络的新方法，用于后处理AI天气预报（如盘古天气模型），以提高1-8天中期恶劣天气预测能力。与传统密集神经网络的后处理方法不同，该方法将预报时间视为序列"标记"，使Transformer能够学习大气状态演变中的复杂时序关系。实验表明，基于Transformer的后处理显著提升了预报技能，且AI驱动的盘古天气模型（即使不含对流参数）在中期预报中表现优于传统全球预报系统（GFS）。该方法提高了准确性、可靠性，并通过特征归因分析增强可解释性，推动了中期恶劣天气预测的发展。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T14:02:42Z
- **目录日期**: 2025-05-21
