...
本研究提出了一种基于解码器-仅Transformer网络的新方法，用于对AI天气预报模型（如盘古天气）进行后处理，以提高1-8天中程强天气预测能力。与传统使用密集神经网络处理离散预报样本的方法不同，该方法将预报时间视为序列"标记"，使Transformer能学习大气状态演变中的复杂时间关系。实验表明，基于Transformer的后处理显著优于密集神经网络，且AI驱动的预报（尤其是高分辨率初始化的盘古天气）即使不含对流参数，在中程预测中也优于全球预报系统（GFS）。该方法提升了准确性、可靠性，并通过特征归因分析增强了可解释性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T07:02:40Z
- **目录日期**: 2025-05-21
