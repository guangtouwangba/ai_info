...
本研究提出了一种基于解码器-仅Transformer网络的新方法，用于后处理AI天气预报（如盘古天气模型），以提升1-8天中尺度恶劣天气预测能力。该方法将预报时间序列视为"标记"，使Transformer能学习大气状态演变的复杂时序关系。相比传统密集神经网络后处理，Transformer显著提高了预测技能。实验表明，即使不含对流参数，基于高分辨率分析的盘古天气AI预报在中尺度表现优于全球预报系统（GFS）。该方法通过特征归因分析提供可解释性，在准确性、可靠性上均有提升，推动了中尺度恶劣天气预测的发展。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T23:02:20Z
- **目录日期**: 2025-05-21
