...
本研究提出了一种基于解码器Transformer网络的新方法，用于后处理AI天气预报（如盘古天气模型），以提升1-8天中程强天气预测能力。该方法将预报时间序列视为"标记"，通过Transformer捕捉大气状态的时序关系，相比传统密集神经网络后处理方法表现更优。实验表明，基于Transformer的后处理显著提高了预报技巧，且盘古天气模型即使不含对流参数，其高分辨率分析初始化的预报仍优于全球预报系统（GFS）。该方法提升了准确性、可靠性，并通过特征归因分析增强可解释性，推动了中程强天气预报的发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T13:11:48Z
- **目录日期**: 2025-05-21
