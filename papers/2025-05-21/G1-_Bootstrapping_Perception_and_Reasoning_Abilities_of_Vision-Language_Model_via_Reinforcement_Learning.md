...
视觉语言模型（VLMs）在多模态任务中表现优异，但在游戏等交互式视觉环境中的决策能力较弱。为解决这一“知而不行”的差距，研究者开发了VLM-Gym——一个强化学习（RL）环境，包含多样化的视觉游戏，支持并行训练。通过纯RL驱动的自我进化训练出的G0模型展现出感知与推理能力。进一步优化的G1模型在RL微调前增强了感知能力，表现超越Claude-3.7等主流模型。研究发现，RL训练中感知与推理能力相互促进。相关代码已开源以推动VLMs作为交互代理的研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T02:30:11Z
- **目录日期**: 2025-05-21
