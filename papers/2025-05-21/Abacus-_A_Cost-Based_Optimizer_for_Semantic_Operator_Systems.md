...
这篇论文介绍了Abacus，一种可扩展的基于成本的优化器，用于优化由语义操作符组成的LLM数据处理系统。Abacus通过少量验证示例和先验性能评估，全局优化系统实现方式，在质量、成本和延迟之间权衡。在生物医学(BioDEX)、法律(CUAD)文档处理和多模态问答(MMQA)测试中，Abacus优化的系统比次优方案质量提高18.7%-39.2%，成本降低高达23.6倍，延迟减少4.2倍，解决了现有优化器无法多维度约束优化的问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T22:01:42Z
- **目录日期**: 2025-05-21
