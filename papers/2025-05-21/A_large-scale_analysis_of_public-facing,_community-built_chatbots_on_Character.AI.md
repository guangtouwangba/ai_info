...
这篇论文对快速增长的社交平台Character.AI进行了首次大规模分析。该平台结合生成式AI和用户生成内容，允许用户创建并互动以虚构或公众人物为原型的聊天机器人。研究基于210万条英文提示数据（来自约100万用户），分析了平台上不同粉丝圈的流行度、跨粉丝圈的常见主题，以及权力动态与性别的关系。研究发现该平台代表了生成式AI与用户生成内容结合的新型在线准社交互动形式，尤其对青少年有显著影响。每月活跃用户超2000万，凸显其社会影响力与研究价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T01:29:36Z
- **目录日期**: 2025-05-21
