...
该研究提出了Cosmos-Reason1模型，旨在通过长链思维推理帮助AI系统理解和应对物理世界。研究定义了物理常识和具身推理两大核心能力，采用分层本体表示物理常识（空间、时间、物理规律），二维本体实现跨具身泛化。团队开发了70亿和560亿参数的Cosmos-Reason1多模态大模型，通过物理AI监督微调（SFT）和强化学习（RL）两阶段训练。基于本体构建的评估基准显示，该方法显著提升了物理推理能力。相关代码和预训练模型已开源（NVIDIA开放许可），以促进物理AI发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T00:02:07Z
- **目录日期**: 2025-05-21
