...
OpenAI计划将ChatGPT从问答助手升级为"行动助手"，通过整合网络搜索、编程工具等能力解决复杂问题。其CPO表示AI Agent将能穿插使用各类工具（如搜索数据+编写代码），实现跨服务操作。模型智能提升通过两种方式：大规模预训练（成本高）或延长思考时间。目前GPT-4成本已比早期降低500倍，未来将继续降低API价格。算法改进和硬件升级将提升效率，而工具调用和网络验证有助于减少幻觉问题。预计1年内AI将具备架构师级能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T12:03:42Z
- **目录日期**: 2025-05-21
