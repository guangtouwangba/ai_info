...
OpenAI CPO Kevin Weil透露ChatGPT将转型为"行动助手"，AI Agent能力将快速升级：6个月达高级工程师水平，1年成为架构师。核心突破在于模型能穿插使用多种工具（搜索/编程/文档处理等），通过深度思考整合信息解决复杂问题。训练成本方面，GPT-4较早期版本成本已降500倍，未来将通过硬件升级和算法优化继续降低成本。安全性通过多工具交叉验证减少幻觉，智能提升与成本下降将形成良性循环。OpenAI计划持续降低API价格以推动行业普及。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T23:03:22Z
- **目录日期**: 2025-05-21
