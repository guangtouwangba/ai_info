...
OpenAI计划将ChatGPT从问答工具升级为能执行复杂任务的AI助手。CPO Kevin Weil表示，未来AI将具备工程师级能力，能整合网络搜索、编程等工具解决实际问题。关键技术突破在于模型能交叉使用各类工具（如搜索数据后用Python绘图），并通过延长思考时间提升智能。OpenAI正大幅降低API成本（GPT-4成本已降500倍），通过硬件优化和算法改进提高效率与安全性，减少"幻觉"错误。该转型将使AI具备跨平台操作和深度推理能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T20:03:25Z
- **目录日期**: 2025-05-21
