...
OpenAI CPO Kevin Weil透露ChatGPT将转型为"行动助手"，AI Agent能力将快速升级：6个月达高级工程师水平，1年后具备架构师能力。其核心突破在于模型能穿插使用多种工具（搜索/编程/文档处理等），通过深度思考整合跨平台信息解决问题。成本方面，GPT-4较早期版本已降本500倍，未来将通过硬件优化和算法改进继续降低成本。安全性通过多维度答案校验和工具辅助来减少幻觉。OpenAI计划持续降低API价格推动AI普及。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T19:03:18Z
- **目录日期**: 2025-05-21
