...
OpenAI计划将ChatGPT从问答工具升级为"行动助手"，通过整合网络搜索、编程等工具解决复杂问题。CPO Kevin Weil表示，AI Agent将具备跨平台操作能力，能自主调用工具完成数据分析、编程等任务。模型智能提升通过预训练和延长思考时间两种方式实现，当前GPT-4成本已比早期降低500倍。OpenAI将持续降低API价格，并通过硬件升级和算法改进提升效率。使用工具辅助推理还能减少AI幻觉，提高回答准确性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T11:03:21Z
- **目录日期**: 2025-05-21
