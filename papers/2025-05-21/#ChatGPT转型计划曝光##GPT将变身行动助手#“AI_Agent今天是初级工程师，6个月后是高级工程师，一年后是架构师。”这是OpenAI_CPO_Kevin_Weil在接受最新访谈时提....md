...
OpenAI首席产品官Kevin Weil透露ChatGPT将向"行动助手"转型，AI Agent未来将具备执行复杂任务的能力，包括整合多工具操作（如搜索、编程、数据分析）、跨平台协作和深度推理。关键技术突破在于模型能智能穿插使用各类工具，并通过延长思考时间提升性能。OpenAI正通过硬件优化和算法改进降低500倍成本，同时利用多工具验证减少AI幻觉问题，使模型更智能安全。公司计划持续降低API价格以推动行业参与。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T17:03:51Z
- **目录日期**: 2025-05-21
