...
OpenAI计划将ChatGPT从问答助手升级为"行动助手"，使其具备深度思考、工具调用和多任务整合能力。CPO Kevin Weil透露，AI Agent将能连接网络和内部系统，通过穿插使用搜索、编程等工具解决复杂问题。模型智能提升通过两种途径：扩大预训练规模或延长思考时间，目前GPT-4成本已较初期降低500倍。OpenAI将持续优化算法和硬件以降低成本，同时通过工具调用和网络验证减少AI幻觉问题，提高答案准确性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T22:03:24Z
- **目录日期**: 2025-05-21
