...
本研究提出LatentSync框架，一种基于音频条件潜在扩散模型的端到端唇同步方法，无需中间运动表示。该方法创新性地引入时间表示对齐（TREPA）技术解决扩散过程中的时间一致性问题，并优化SyncNet训练框架提升准确性。实验表明，该方法在HDTF和VoxCeleb2数据集上超越现有技术，为音频驱动人像动画提供了新思路。研究发现的SyncNet优化经验也可推广至其他相关领域。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T01:33:26Z
- **目录日期**: 2025-05-21
