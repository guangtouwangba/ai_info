...
这篇论文提出了CodeArena基准测试和SynCode-Instruct语料库，用于评估代码生成大语言模型(codeLLMs)与人类偏好的对齐程度。CodeArena包含397个高质量样本，覆盖40类任务和44种编程语言，模拟真实编程场景；SynCode-Instruct则包含近200亿标记的合成指令数据。研究发现传统基于执行的评估与人类偏好存在差异，且开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究强调了代码LLMs与人类偏好对齐的重要性，为改进模型提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T11:06:10Z
- **目录日期**: 2025-05-21
