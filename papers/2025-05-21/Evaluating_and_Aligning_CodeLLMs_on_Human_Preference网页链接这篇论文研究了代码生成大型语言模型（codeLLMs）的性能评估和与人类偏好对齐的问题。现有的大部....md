...
这篇论文提出了CodeArena基准和SynCode-Instruct语料库，以评估代码生成大模型(CodeLLMs)与人类偏好的对齐程度。CodeArena包含397个涵盖40类任务和44种编程语言的高质量样本，模拟真实编程场景。研究发现现有基于执行的基准与人类偏好存在差异，且开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。通过构建近200亿token的合成指令数据集，验证了大规模指令微调的有效性，强调了代码生成模型与人类偏好对齐的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T02:35:21Z
- **目录日期**: 2025-05-21
