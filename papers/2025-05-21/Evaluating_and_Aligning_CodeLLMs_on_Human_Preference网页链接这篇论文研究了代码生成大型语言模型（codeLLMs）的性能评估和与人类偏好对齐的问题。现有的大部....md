...
这篇论文针对代码生成大模型（codeLLMs）提出新评估方法，指出当前基准测试过于关注代码正确性而忽视人类偏好。研究者创建了CodeArena基准（含397个多语言样本）和SynCode-Instruct语料库（20B标记），发现执行基准与人类偏好存在差异。实验比较40多个模型显示，顶级开源模型（如Qwen2.5-Coder）与商业模型（如OpenAI o1）性能差距显著，强调了对齐人类偏好的必要性。研究突出了现实场景中代码质量评估的多维性，为改进代码生成模型提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T05:06:03Z
- **目录日期**: 2025-05-21
