...
这篇论文提出了CodeArena基准测试和SynCode-Instruct语料库，用于评估代码生成大模型（CodeLLMs）与人类偏好的对齐程度。研究发现现有基准过于侧重代码正确性而忽视人类偏好，CodeArena通过397个涵盖40类编程任务的样本弥补这一缺陷。实验显示基于执行的测试与人类偏好评估存在差异，开源模型（如Qwen2.5-Coder）与商业模型（如OpenAI o1）性能差距显著。研究证实大规模合成指令微调有效，并强调对齐人类偏好在代码生成领域的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T07:06:05Z
- **目录日期**: 2025-05-21
