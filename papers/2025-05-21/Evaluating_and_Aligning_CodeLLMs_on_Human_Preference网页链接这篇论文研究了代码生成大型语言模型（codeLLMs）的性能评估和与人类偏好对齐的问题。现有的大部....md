...
这篇论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，关注模型输出与人类偏好的对齐问题。通过397个涵盖40类编程任务和44种语言的样本，研究发现传统执行测试与人类偏好存在差距。同时构建了20B标记的SynCode-Instruct合成指令集验证微调效果。实验显示开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI)在人类偏好匹配上存在显著差异，强调了优化人类偏好对齐的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T22:05:19Z
- **目录日期**: 2025-05-21
