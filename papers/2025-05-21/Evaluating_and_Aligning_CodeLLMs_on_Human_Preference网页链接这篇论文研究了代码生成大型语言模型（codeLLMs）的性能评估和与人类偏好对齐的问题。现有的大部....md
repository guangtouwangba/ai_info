...
这篇论文提出了CodeArena基准测试和SynCode-Instruct语料库，以评估代码生成大模型(CodeLLMs)与人类偏好的对齐程度。CodeArena包含397个高质量编程任务样本，覆盖40类任务和44种语言；SynCode-Instruct则是一个近200亿标记的合成指令数据集。研究发现现有基于执行的基准测试与人类偏好存在差距，且开源模型(如Qwen2.5-Coder)与专有模型(如OpenAI o1)性能差异显著。研究强调了代码生成模型除正确性外，还需关注与开发者实际需求的匹配度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T14:06:11Z
- **目录日期**: 2025-05-21
