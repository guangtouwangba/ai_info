...
这篇论文提出了CodeArena基准测试和SynCode-Instruct语料库，用于评估代码生成大语言模型(codeLLMs)与人类偏好的对齐程度。CodeArena包含397个高质量编程任务样本，覆盖40个类别和44种语言，模拟真实编程场景。研究发现现有基于执行的基准测试与人类偏好存在差异，开源模型(如Qwen2.5-Coder)与专有模型(如OpenAI o1)性能差距显著。研究还验证了大规模合成指令微调的有效性，强调了对齐人类偏好在代码生成中的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T19:05:27Z
- **目录日期**: 2025-05-21
