...
SAFEPATH是一种轻量级对齐方法，用于提升大型推理模型(LRMs)的安全性。它通过在有害提示下生成8个token的"安全引导词"来减少有害输出，同时保持无监督的后续推理能力。实验表明，SAFEPATH在DeepSeek-R1-Distill-Llama-8B模型上能减少90%有害响应，阻挡83.3%越狱攻击，且计算量比现有方法低295-314倍。研究还提出了无需微调的零样本变体，并分析了现有LLM安全方法在推理模型上的适用性差距，为更安全的AI提供了新方向。该方法在保持推理性能的同时显著提升了安全性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T16:01:41Z
- **目录日期**: 2025-05-21
