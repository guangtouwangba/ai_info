...
该研究在大型生物学课程中开发了一个结合AI反馈与教材引用的模拟考试系统，要求学生解释答案并评估信心。系统使用GPT-4生成个性化反馈并引导阅读教材。通过分析28,313次答题记录、279份问卷和23次访谈发现，不同反馈类型对成绩无显著差异，但强制信心评估和解释能有效提升考试策略应用。约40%学生主动查阅教材（远高于传统阅读率），82.1%反馈增强了信心，73.4%能更好应用知识点。研究表明，结构化反思要求比复杂反馈机制更能促进学习效果，系统总体满意度达4.1/5分。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T01:29:15Z
- **目录日期**: 2025-05-21
