...
这篇论文提出了ContextAgent，首个结合多维度感知情境的主动式LLM智能体。它通过可穿戴设备获取视频、音频等感知数据理解用户意图，结合历史行为特征预测主动服务需求，并自动调用工具提供无干扰服务。研究者构建了包含9类日常场景、20种工具的ContextAgentBench基准测试（1000个样本）。实验表明，该模型在主动预测和工具调用准确率上分别比基线提升8.5%和6.0%。这项研究为开发更先进、以人为中心的主动式AI助手提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T07:01:33Z
- **目录日期**: 2025-05-21
