...
本文提出ContextAgent，首个结合多维度感知数据的上下文感知主动AI助手。该系统通过可穿戴设备获取视频、音频等多模态感知数据，结合用户历史行为特征，预测用户意图并判断是否需要主动服务。当需要时，系统会自动调用工具进行无干扰辅助。研究团队构建了包含9个日常场景、20种工具的1000样本基准测试ContextAgentBench。实验表明，ContextAgent在主动预测和工具调用准确率上分别比基线方法提升8.5%和6.0%。该研究为开发更先进、以人为中心的主动AI助手提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T10:01:28Z
- **目录日期**: 2025-05-21
