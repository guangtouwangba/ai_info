...
本文提出ContextAgent，首个结合多维度感知数据的情境感知主动AI助手。该系统通过可穿戴设备获取视频、音频等感知数据理解用户意图，并结合历史行为特征预测主动服务需求，自动调用工具提供无干扰协助。研究构建了首个情境感知主动代理基准测试ContextAgentBench，涵盖9类日常场景和20种工具的1000个样本。实验表明，ContextAgent在主动预测和工具调用准确率上分别比基线高8.5%和6.0%。该研究为开发更先进、以人为中心的主动AI助手提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T04:02:40Z
- **目录日期**: 2025-05-21
