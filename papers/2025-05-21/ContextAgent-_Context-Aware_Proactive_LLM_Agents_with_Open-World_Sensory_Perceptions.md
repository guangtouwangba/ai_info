...
本文提出ContextAgent，首个结合多维度感知情境的主动式LLM智能体。该系统通过可穿戴设备获取视听等多模态感知数据理解用户意图，结合历史数据构建用户画像，预测主动服务需求并自动调用工具。研究者构建了包含9类日常场景、20种工具的ContextAgentBench基准测试（1000个样本）。实验显示，ContextAgent在主动预测和工具调用准确率上分别比基线高8.5%和6.0%。该研究为开发更先进、以人为中心的主动式AI助手提供了新思路，突破了传统基于封闭环境观察或规则通知的局限性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T13:10:40Z
- **目录日期**: 2025-05-21
