...
这篇论文介绍了ContextAgent，首个结合多维度感知情境（如穿戴设备的视频、音频数据）来增强大语言模型（LLM）主动服务能力的智能体。它通过分析实时感知数据和历史个人化情境，预测用户需求并自动调用工具提供无干扰服务。研究者构建了首个情境感知主动服务评测基准ContextAgentBench（含9类日常场景的1000个样本），实验显示ContextAgent在主动预测和工具调用准确率上分别比基线高8.5%和6.0%。该研究为开发更先进、以人为中心的主动式AI助手提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T17:01:30Z
- **目录日期**: 2025-05-21
