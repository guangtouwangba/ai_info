...
这篇论文介绍了ContextAgent，首个结合多维度感知情境的主动式LLM智能体。它通过可穿戴设备获取视频、音频等感知数据来理解用户意图，并结合历史人物画像预测何时需要主动服务。当需要时，ContextAgent会自动调用工具提供无干扰协助。研究者构建了首个情境感知主动代理基准ContextAgentBench，包含9个日常场景的1000个样本和20种工具。实验表明，ContextAgent在主动预测和工具调用上的准确率分别比基线高出8.5%和6.0%。这项研究为开发更先进、以人为本的主动AI助手提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T11:01:33Z
- **目录日期**: 2025-05-21
