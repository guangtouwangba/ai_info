...
《柳叶刀-呼吸医学》最新研究显示，肺功能从20岁左右（女性20岁/男性23岁）达峰后即开始不可逆下降，无平台期。关键发现包括：哮喘患者峰值更低、成年后肺功能更差；吸烟者30岁后肺功能加速衰退。研究强调早期干预的重要性，建议通过有氧运动（每周150分钟）、戒烟、控制哮喘、避免憋气、多喝水和职业防护等措施维护肺健康。该研究基于8国超3万人的数据分析，是目前最完整的肺功能轨迹研究。（99字）  
