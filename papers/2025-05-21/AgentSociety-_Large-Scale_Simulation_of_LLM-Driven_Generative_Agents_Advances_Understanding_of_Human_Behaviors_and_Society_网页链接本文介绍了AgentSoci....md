...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统模拟了1万多个AI代理的社会生活，记录它们之间及与环境间的500万次互动。研究者用它研究了四个社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，证明该系统能有效捕捉人类行为机制。AgentSociety展示了作为社会科学研究工具和政策测试平台的潜力，可辅助传统研究方法，帮助理解社会问题的成因和解决路径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T20:04:42Z
- **目录日期**: 2025-05-21
