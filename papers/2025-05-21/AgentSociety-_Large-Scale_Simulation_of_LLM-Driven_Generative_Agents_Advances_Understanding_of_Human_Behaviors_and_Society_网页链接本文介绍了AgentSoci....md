...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万个AI代理及其500万次互动。研究者用它研究四个社会问题：群体极化、信息传播、基本收入政策效果和自然灾害影响。该系统能准确复现现实社会现象，验证了其模拟人类行为和社会机制的能力，可作为社会科学研究和政策制定的有效工具。实验结果与现实数据吻合，展示了AI模拟在补充传统研究方法（如调查、实验）方面的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T21:04:56Z
- **目录日期**: 2025-05-21
