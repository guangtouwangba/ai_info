...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能模拟1万多个智能代理及其500万次社会互动。研究者利用该系统研究了社会极化、信息传播、基本收入政策及自然灾害影响等社会问题，模拟结果与现实数据高度吻合。该系统可作为计算社会科学的研究平台，帮助理解人类行为机制，为政策制定提供新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T12:05:40Z
- **目录日期**: 2025-05-21
