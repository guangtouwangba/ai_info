...
该研究开发了AgentSociety大规模社会模拟器，通过整合LLM驱动的代理、真实社会环境和模拟引擎，模拟了1万多个代理间的500万次互动。研究聚焦四个社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对，结果与现实世界数据吻合。该系统展现了作为社会科学研究工具的强大潜力，能够有效捕捉人类行为模式和社会机制，为研究者和政策制定者提供新方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T15:05:51Z
- **目录日期**: 2025-05-21
