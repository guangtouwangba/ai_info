...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟1万多个代理及其500万次互动。研究者利用该平台研究了社会极化、信息传播、基本收入政策及飓风影响等社会问题，结果与现实世界数据吻合。该系统结合了LLM代理、真实社会环境和模拟引擎，能有效捕捉人类行为机制，为社会科学研究和政策制定提供了新工具。实验验证了其模拟能力，展示了作为传统研究方法补充的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T16:05:17Z
- **目录日期**: 2025-05-21
