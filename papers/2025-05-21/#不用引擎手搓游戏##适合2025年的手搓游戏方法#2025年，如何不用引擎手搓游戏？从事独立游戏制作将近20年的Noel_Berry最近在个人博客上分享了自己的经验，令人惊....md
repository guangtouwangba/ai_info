...
2025年独立开发者Noel Berry提出无需游戏引擎的手搓游戏方案：1) 使用C#语言，其热重载和反射功能提升开发效率；2) 通过SDL3等开源库处理跨平台视窗/输入/渲染，FMOD管理音频；3) 直接文件加载式资源管理；4) 结合LDtk/Tiled等现成工具做关卡设计，用ImGui快速开发UI工具链；5) 利用C#的Native-AOT编译和SDL3跨平台支持实现多主机移植。该方法强调轻量化开发，适合小团队通过开源框架组合替代重型引擎，保持对项目的完全掌控。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T15:04:44Z
- **目录日期**: 2025-05-21
