...
2025年独立游戏开发者Noel Berry提出"不用游戏引擎手搓游戏"的方法，主要基于C#和开源工具链。关键点包括：1) 使用C#配合.NET热重载功能实现快速迭代；2) 采用SDL3处理跨平台视窗/输入/渲染，FMOD处理音频；3) 直接管理资源加载/释放；4) 利用LDtk/Tiled等现成编辑器配合ImGui开发工具；5) 通过C#的Native-AOT编译实现全平台移植。该方法强调利用现代化语言特性和开源库简化开发流程，适合小型团队避免商业引擎的复杂性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T11:03:56Z
- **目录日期**: 2025-05-21
