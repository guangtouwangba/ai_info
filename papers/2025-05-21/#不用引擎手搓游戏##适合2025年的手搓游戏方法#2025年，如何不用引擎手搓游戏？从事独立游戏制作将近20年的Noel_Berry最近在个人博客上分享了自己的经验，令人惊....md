...
2025年独立开发者Noel Berry提出"不用游戏引擎"的开发方法，推荐使用C#配合开源工具链：SDL3处理跨平台视窗/输入/渲染，FMOD管理音频，LDtk/Tiled构建关卡，ImGui开发UI工具。C#的热重载和反射特性简化调试，Native-AOT编译实现全平台部署。该方法强调轻量化开发，通过组合专业库替代重型引擎，特别适合小型团队。资源管理采用按需加载策略，复杂功能可调用Trenchbroom等专业软件。实践证明该方案能提升开发自由度并降低技术风险。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T17:04:28Z
- **目录日期**: 2025-05-21
