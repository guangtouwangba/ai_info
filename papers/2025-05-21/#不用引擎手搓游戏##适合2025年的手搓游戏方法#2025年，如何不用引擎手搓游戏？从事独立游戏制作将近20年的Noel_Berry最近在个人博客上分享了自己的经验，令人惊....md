...
2025年独立开发者Noel Berry提出"不用游戏引擎"的开发方法，推荐使用C#（支持热重载和实时调试）配合开源框架：SDL3处理跨平台视窗/输入/渲染（支持DirectX/Vulkan/Metal），FMOD管理音频，LDtk/Tiled做关卡设计，ImGui创建UI。资源管理采用按需加载+预处理脚本，利用C#的Native-AOT实现全平台移植。该方法通过组合轻量级工具链，避免商业引擎的复杂性，特别适合小型团队开发2D/像素风游戏，SDL3已覆盖主流主机平台支持。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T16:04:16Z
- **目录日期**: 2025-05-21
