...
《自然》杂志报道了AI在生物医学领域的突破性应用：1）西湖大学团队开发的Pinal蛋白质语言模型，通过17亿条蛋白质数据训练，能用自然语言指令设计功能性蛋白质（如酒精脱氢酶）；2）310.ai公司开发的MP4模型正尝试设计类似GLP-1的减肥药物蛋白；3）维也纳医科大学和耶鲁大学团队分别开发CellWhisperer和Cell2Sentence系统，通过大语言模型解析单细胞测序数据，实现与细胞的"对话"，甚至预测抗癌药物反应。这些进展显示AI正重塑蛋白质设计和细胞研究范式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T20:03:14Z
- **目录日期**: 2025-05-21
