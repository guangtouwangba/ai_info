...
西湖大学团队开发出Pinal模型，能通过自然语言指令设计功能性蛋白质（如酶和荧光蛋白），其生成的酒精脱氢酶设计已获实验验证。310.ai等公司也在开发类似文本转蛋白质的AI工具。同时，单细胞RNA测序领域出现CellWhisperer等工具，可生成细胞特性报告并预测药物影响。这些进展显示AI正推动蛋白质设计和细胞研究的突破性发展，但文本指令精确度仍需优化。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T10:02:51Z
- **目录日期**: 2025-05-21
