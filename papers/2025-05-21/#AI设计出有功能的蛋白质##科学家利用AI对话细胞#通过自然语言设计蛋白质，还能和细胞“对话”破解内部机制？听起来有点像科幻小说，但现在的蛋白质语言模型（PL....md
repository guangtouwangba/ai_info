...
《自然》杂志报道了AI在生物医学领域的突破性进展：1）西湖大学团队开发的Pinal模型能用自然语言指令设计功能性蛋白质，如成功生成具有催化活性的酒精脱氢酶；2）310.ai等公司正用类似技术开发GLP-1类似物等药物；3）维也纳医科大学和耶鲁大学团队分别开发出CellWhisperer和Cell2Sentence系统，通过AI解读单细胞测序数据，实现与细胞的"对话"，甚至预测药物反应。这些进展显示AI正推动蛋白质设计和细胞研究进入新阶段，但文本指令的精确控制仍是当前挑战。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T18:03:38Z
- **目录日期**: 2025-05-21
