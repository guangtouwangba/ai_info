...
《Nature》最新研究显示，AI在生物医学领域取得突破性进展：西湖大学团队开发的Pinal模型通过自然语言指令成功设计出功能性蛋白质（如酒精脱氢酶），其生成的8种设计中有2种具备催化活性。初创公司310.ai的MP4模型正尝试设计类似GLP-1的减肥药物蛋白。此外，维也纳医科大学和耶鲁大学团队分别开发CellWhisperer和Cell2Sentence系统，利用AI解析单细胞测序数据，实现与细胞的"对话"，甚至能预测抗癌药物对基因表达的影响。这些技术将加速蛋白质工程和精准医疗发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T16:03:34Z
- **目录日期**: 2025-05-21
