...
西湖大学团队开发出Pinal蛋白质语言模型，可通过自然语言指令设计功能性蛋白质（如酶和荧光蛋白），实验验证其设计的酒精脱氢酶具有催化活性。310.ai公司MP4模型也在探索类似GLP-1的蛋白质设计，但存在序列重复等技术挑战。此外，AI已延伸至药物分子设计（如Gitter团队的类药抑制剂）和细胞分析领域——维也纳医科大学CellWhisperer能生成细胞报告，耶鲁团队Cell2Sentence可描述细胞特性并预测药物影响。这些进展显示AI正推动生命科学研究的范式变革。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T19:03:09Z
- **目录日期**: 2025-05-21
