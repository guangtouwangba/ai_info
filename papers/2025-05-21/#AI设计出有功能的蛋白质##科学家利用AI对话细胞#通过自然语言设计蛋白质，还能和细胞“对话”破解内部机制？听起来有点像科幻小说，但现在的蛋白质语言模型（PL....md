# #AI设计出有功能的蛋白质##科学家利用AI对话细胞#通过自然语言设计蛋白质，还能和细胞“对话”破解内部机制？听起来有点像科幻小说，但现在的蛋白质语言模型（PL...
...
《自然》杂志报道了AI在生物医学领域的突破性进展：1）西湖大学团队开发的Pinal模型通过自然语言指令成功设计出功能性蛋白质（如酒精脱氢酶），其基于17亿条蛋白质文本数据训练；2）310.ai等公司正用类似技术开发GLP-1类减肥药物；3）维也纳医科大学和耶鲁大学团队分别开发出CellWhisperer和Cell2Sentence系统，能通过对话形式解析单细胞RNA数据，预测药物反应。这些进展显示AI正推动蛋白质设计和细胞研究进入"自然语言交互"新阶段，但文本指令精确性仍是当前挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T23:03:13Z
- **目录日期**: 2025-05-21
