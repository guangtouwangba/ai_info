...
《Nature》最新研究显示，AI在生物医学领域取得突破性进展：1）西湖大学团队开发蛋白质语言模型Pinal，通过自然语言指令成功设计出功能性酶和荧光蛋白（如酒精脱氢酶）；2）310.ai等公司利用类似技术开发减肥药类似物；3）维也纳医科大学和耶鲁大学团队分别推出CellWhisperer和Cell2Sentence系统，实现用自然语言分析单细胞数据并预测药物反应。这些进展显示AI正推动蛋白质设计和细胞研究进入"自然语言交互"新阶段，但文本指令精准度仍需优化。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T14:03:44Z
- **目录日期**: 2025-05-21
