...
《Nature》最新研究显示，AI在生物医学领域取得突破性进展：1）西湖大学团队开发出能通过自然语言指令设计功能性蛋白质的Pinal模型，成功生成具有催化活性的酶和荧光蛋白；2）310.ai等公司利用类似技术开发减肥药类似物；3）维也纳医科大学和耶鲁大学团队分别推出CellWhisperer和Cell2Sentence系统，实现用自然语言与细胞"对话"，分析单细胞测序数据并预测药物反应。这些进展显示AI正推动蛋白质设计和细胞研究进入智能化新阶段，但仍存在指令优化等技术挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T13:12:57Z
- **目录日期**: 2025-05-21
