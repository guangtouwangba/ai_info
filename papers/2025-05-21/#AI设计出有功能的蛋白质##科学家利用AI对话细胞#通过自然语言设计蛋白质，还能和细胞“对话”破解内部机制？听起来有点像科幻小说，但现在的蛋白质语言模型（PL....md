...
《Nature》最新研究显示，AI在生物医学领域取得突破性进展：1）西湖大学团队开发的Pinal模型通过自然语言指令成功设计出功能性蛋白质（如酒精脱氢酶），其基于17亿条蛋白质文本数据训练；2）310.ai等公司正用类似技术开发GLP-1类减肥药物；3）单细胞分析方面，CellWhisperer和Cell2Sentence等工具能通过对话形式解析细胞特性并预测药物反应。尽管存在序列重复等技术挑战，这些进展标志着AI正推动蛋白质设计和细胞研究进入新阶段。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T12:03:31Z
- **目录日期**: 2025-05-21
