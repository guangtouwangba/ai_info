...
《Nature》最新研究显示，AI在生物医学领域取得突破性进展：1）西湖大学团队开发文本转蛋白质模型Pinal，通过自然语言指令成功设计出功能性酶和荧光蛋白；2）310.ai等公司利用类似技术开发减肥药类似物；3）单细胞分析方面，CellWhisperer和Cell2Sentence等工具能"对话"细胞，解析基因表达并预测药物反应。这些进展显示AI正重塑蛋白质设计和细胞研究范式，尽管存在指令优化等技术挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T22:03:15Z
- **目录日期**: 2025-05-21
