...
研究人员开发了首个能全流程自动化科学发现的多智能体系统Robin，该系统整合文献检索与数据分析功能，可自主完成假设生成、实验设计、结果解读和假设更新。应用该系统成功发现了治疗干性年龄相关性黄斑变性(dAMD)的新疗法：Robin提出增强视网膜色素上皮细胞吞噬作用的新策略，并鉴定出临床已有药物瑞帕舒地(ROCK抑制剂)具有治疗潜力。通过后续RNA测序实验，系统还发现该药物通过上调脂质转运蛋白ABCA1发挥作用。这项研究首次实现了AI在实验室闭环框架下自主发现并验证新疗法，为AI驱动的科研建立了新范式。(100字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T00:01:24Z
- **目录日期**: 2025-05-21
