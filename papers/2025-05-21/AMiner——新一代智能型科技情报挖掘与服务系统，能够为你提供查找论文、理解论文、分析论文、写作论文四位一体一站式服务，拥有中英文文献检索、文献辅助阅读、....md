...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、翻译、辅助阅读和科研情报订阅。它拥有42个学科的3.5亿论文、0.6亿学者和1.5亿专利数据。用户可通过互动问答快速获取文献摘要，上传PDF生成概要，并订阅个性化科研动态。平台还支持学者画像、学术会议追踪等功能，基础服务免费开放。网址：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T04:06:40Z
- **目录日期**: 2025-05-21
