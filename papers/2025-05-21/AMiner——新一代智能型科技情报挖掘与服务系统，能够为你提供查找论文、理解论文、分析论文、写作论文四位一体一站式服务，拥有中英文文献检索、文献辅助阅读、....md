...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析、写作一站式服务，涵盖42个学科的3.5亿论文、0.6亿学者等数据。主要功能包括：1）中英文文献检索，支持互动问答和自动摘要生成；2）英文文献翻译与辅助阅读，可上传PDF并获取AI生成的摘要和问答；3）科研情报订阅，按用户偏好推送最新学术动态。此外，还提供学者画像、学术会议等工具，支持免费使用。平台网址：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-21T11:05:59Z
- **目录日期**: 2025-05-21
