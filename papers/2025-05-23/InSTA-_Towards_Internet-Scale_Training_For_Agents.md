...
该研究提出了一种无需人工标注的大规模网络导航智能体训练方法。首先使用大语言模型(LLM)为15万个网站生成任务，然后由LLM代理执行任务并产生轨迹，最后通过LLM过滤成功轨迹。实验表明，语言模型能有效筛选内容(准确率97%)和判断轨迹成功率(82.6%)。基于Qwen 3 1.7B训练的智能体性能优异，成功率56.9%，超越了235倍大的Llama 4 Maverick，达到Gemini 2.5 Flash性能的94.7%。该方法显著降低了人工标注需求，相关代码、模型和数据已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T22:02:28Z
- **目录日期**: 2025-05-23
