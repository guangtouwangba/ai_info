...
上海AI Lab发布新一代InternThinker大模型，首次实现围棋专业水平与透明思维链的双重突破。该模型通过"加速训练营"等技术提升推理能力，不仅能应对李世石著名的"神之一手"，还能用自然语言解释决策过程，打破了传统AI围棋系统的"黑盒"困境。这标志着大模型在复杂策略游戏中的可解释性取得重要进展，公测版和开源代码已同步发布。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T18:02:42Z
- **目录日期**: 2025-05-23
