...
上海AI Lab发布新一代InternThinker大模型，首次实现围棋AI透明化推理。该模型通过"加速训练营"技术突破，既保持专业棋力（可应对李世石"神之一手"），又能用自然语言解释决策过程，打破传统围棋AI的"黑盒"思维模式。作为中国首个兼具专业水平和思维链展示能力的大模型，其开源代码和公测平台已同步开放。这一进展标志着AI在复杂策略游戏中的可解释性取得重要突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T20:02:55Z
- **目录日期**: 2025-05-23
