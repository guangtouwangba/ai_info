...
上海AI Lab发布新一代InternThinker大模型，首次实现围棋专业水平与透明思维链的双重突破。该模型通过"加速训练营"技术显著提升推理能力，不仅能应对李世石著名的"神之一手"，还能用自然语言解释决策过程，打破了传统AI围棋系统的"黑盒"难题。这一成果标志着大模型在专业领域推理可解释性方面取得重要进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T23:02:37Z
- **目录日期**: 2025-05-23
