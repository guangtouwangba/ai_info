...
上海AI Lab发布新一代InternThinker大模型，首次实现围棋AI的透明思维链展示。该模型通过"加速训练营"技术提升专业推理能力，既达到围棋专业水平，又能用自然语言解释决策过程，包括应对李世石"神之一手"的战术分析。这一突破解决了传统围棋AI"黑盒"难题，标志着大模型在复杂策略游戏中的可解释性取得重要进展。模型已开放公测和开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T22:02:37Z
- **目录日期**: 2025-05-23
