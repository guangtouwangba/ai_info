...
本文研究了多模态大语言模型(MLLM)的3D空间感知能力，提出了VGBench基准测试视觉几何感知(如相机位姿估计)，并整合11个现有数据集构建了迄今最全面的多模态空间理解基准SpatialScore(含28K样本)。同时开发了SpatialAgent多智能体系统，集成9种专用工具支持两种推理范式。实验揭示了MLLM在空间推理方面的持续挑战，同时验证了SpatialAgent的有效性。该研究为MLLM的下一代发展提供了重要基准和见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T18:01:15Z
- **目录日期**: 2025-05-23
