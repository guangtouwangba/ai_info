...
该研究探讨了多模态大语言模型(MLLMs)的3D空间感知能力，提出了VGBench评估视觉几何感知(如相机位姿和运动估计)，并整合11个现有数据集构建了最全面的多模态空间理解基准SpatialScore(含28K样本和挑战性子集SpatialScore-Hard)。同时开发了支持Plan-Execute和ReAct推理范式的多智能体系统SpatialAgent(含9种专用工具)。实验揭示了MLLMs在空间推理中的持续挑战，同时验证了SpatialAgent的有效性。该基准将为MLLMs的下一代演进提供严谨评估标准和宝贵洞见。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T07:01:22Z
- **目录日期**: 2025-05-23
