...
本文研究了多模态大语言模型(MLLMs)的3D空间感知能力，提出了VGBench基准测试视觉几何感知(如相机位姿估计)，并整合11个现有数据集创建了最全面的空间理解基准SpatialScore(含28K样本)。同时开发了支持多种推理范式的多代理系统SpatialAgent，包含9个专用工具。评估表明当前MLLMs在空间推理方面仍存在挑战，而SpatialAgent表现优异。该研究为MLLMs的下一代发展提供了重要基准和见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T05:01:17Z
- **目录日期**: 2025-05-23
