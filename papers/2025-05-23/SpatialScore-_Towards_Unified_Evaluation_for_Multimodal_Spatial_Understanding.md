...
本文研究了多模态大语言模型(MLLMs)的空间理解能力，提出了VGBench基准测试视觉几何感知能力，并整合11个现有数据集构建了包含28K样本的SpatialScore综合基准(含高难度子集SpatialScore-Hard)。同时开发了配备9种专用工具的SpatialAgent多智能体系统，支持计划和反应式推理。实验表明当前MLLMs在空间推理方面仍存在挑战，而SpatialAgent表现优异。该研究为MLLMs的空间能力评估提供了全面基准，将推动下一代模型的发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T20:01:32Z
- **目录日期**: 2025-05-23
