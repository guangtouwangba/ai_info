...
该研究探讨了多模态大语言模型(MLLMs)在3D空间感知和理解能力方面的表现。作者提出了VGBench基准测试来评估视觉几何感知能力，并整合11个现有数据集创建了目前最全面的多模态空间理解基准SpatialScore(含28K样本)。同时开发了支持多种推理范式的多智能体系统SpatialAgent(包含9个专用工具)。实验揭示了MLLMs在空间推理方面的持续挑战，同时验证了SpatialAgent的有效性。该基准将为下一代MLLMs的发展提供重要参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T10:01:26Z
- **目录日期**: 2025-05-23
