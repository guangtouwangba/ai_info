...
中科大团队研发了一种能看清红外线的隐形眼镜，通过内置特殊纳米颗粒将红外光转换为可见光。相比传统夜视仪更轻便，无需电源，闭眼也能工作，但成像较模糊且仅适用于强红外光源。成本约200美元/副。该技术源于2019年小鼠视网膜纳米颗粒实验，现改进为非侵入性方案。测试显示佩戴者能识别红外光方向，闭眼效果更佳。潜在应用包括防伪识别、医疗手术导航及视觉疾病治疗。目前仍处原理验证阶段，需进一步优化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T17:03:39Z
- **目录日期**: 2025-05-23
