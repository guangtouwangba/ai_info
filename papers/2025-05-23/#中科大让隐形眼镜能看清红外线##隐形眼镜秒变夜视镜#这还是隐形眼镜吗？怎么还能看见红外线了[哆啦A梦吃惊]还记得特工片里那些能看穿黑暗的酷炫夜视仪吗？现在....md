...
中国科学技术大学研发了一种新型隐形眼镜，通过内置特殊纳米颗粒将不可见的红外光转换为可见光，实现裸眼红外视觉。该技术相比传统夜视仪更轻便，无需外接电源，闭眼时仍可工作。目前原型存在图像模糊、仅能识别强红外信号等局限，单副成本约200美元。研究团队在小鼠和人体实验中验证了可行性，潜在应用包括防伪识别、医疗手术导航和视觉疾病治疗等。该成果基于2019年视网膜纳米颗粒研究改进而来，采用非侵入性设计，但仍需进一步优化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T15:03:26Z
- **目录日期**: 2025-05-23
