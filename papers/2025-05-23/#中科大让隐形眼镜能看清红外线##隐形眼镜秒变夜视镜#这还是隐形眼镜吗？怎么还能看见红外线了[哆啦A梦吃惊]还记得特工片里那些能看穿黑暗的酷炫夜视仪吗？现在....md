...
中科大研发的新型隐形眼镜通过内置特殊纳米颗粒，可将红外光转换为可见光，实现裸眼红外视觉。该技术比传统夜视仪更轻便，无需外接电源，闭眼时仍能工作。实验显示佩戴者能识别红外光源方向，穿透眼睑效果更佳。目前存在成像模糊、仅适用强红外信号等局限，单副成本约200美元。潜在应用包括防伪识别、医疗手术导航和视觉疾病治疗。该研究基于2019年小鼠视网膜纳米颗粒实验改进，采用非侵入性方案，但仍需进一步优化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T14:03:29Z
- **目录日期**: 2025-05-23
