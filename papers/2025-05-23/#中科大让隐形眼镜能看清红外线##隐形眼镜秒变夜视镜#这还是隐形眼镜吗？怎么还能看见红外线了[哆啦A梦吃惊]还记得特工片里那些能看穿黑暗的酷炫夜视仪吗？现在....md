...
中国科学技术大学研发了一款创新型隐形眼镜，通过内置特殊纳米颗粒可将红外光转换为可见光，实现裸眼红外视觉。该技术无需笨重设备或外接电源，闭眼时因减少可见光干扰效果更佳。目前原型存在成像模糊、仅能识别强红外信号等局限，单副成本约200美元。团队在小鼠和人体实验中验证了可行性，潜在应用包括防伪识别、医疗手术导航及视觉疾病治疗。这项研究是2019年视网膜纳米技术研究的非侵入式升级，但仍处于原理验证阶段，需进一步优化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T22:03:19Z
- **目录日期**: 2025-05-23
