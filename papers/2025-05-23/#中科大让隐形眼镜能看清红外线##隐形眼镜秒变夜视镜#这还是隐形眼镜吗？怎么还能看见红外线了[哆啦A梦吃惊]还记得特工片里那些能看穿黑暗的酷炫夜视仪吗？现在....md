...
中科大研发的新型隐形眼镜通过内置纳米颗粒将红外光转换为可见光，实现裸眼红外视觉。相比传统夜视仪更轻便，闭眼仍可使用，但成像较模糊且仅能识别强红外信号（如LED）。2019年团队曾通过小鼠视网膜注射实现该技术，现改进为非侵入性隐形眼镜方案。实验显示佩戴者能识别红外光源方向，穿透眼睑时效果更佳。潜在应用包括防伪识别、医疗手术导航及视觉疾病治疗。目前仍处原理验证阶段，单副成本约200美元，需进一步优化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T11:03:35Z
- **目录日期**: 2025-05-23
