...
中科大研发的新型隐形眼镜通过内置纳米颗粒将红外光转换为可见光，实现裸眼红外视觉。相比传统夜视仪更轻便，无需外接电源，闭眼仍可工作。目前成像较模糊，仅能识别强红外光源（如LED），单副成本约200美元。该技术源自2019年小鼠视网膜纳米颗粒研究，现改进为非侵入性方案。实验显示佩戴者能识别红外光方向，闭眼时效果更佳。潜在应用包括防伪识别、医疗手术导航及视觉疾病治疗。研究尚处原理验证阶段，需进一步优化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T12:03:49Z
- **目录日期**: 2025-05-23
