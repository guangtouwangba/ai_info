...
中科大团队研发出一款能看清红外线的隐形眼镜，通过内置特殊纳米颗粒将不可见的红外光转换为可见光。相比传统夜视仪，这种隐形眼镜更轻便且无需电源，闭眼时仍可工作。但成像较模糊且仅能识别强红外信号，每副成本约200美元。该技术源于2019年小鼠视网膜纳米颗粒实验，现改进为非侵入性方案。测试显示佩戴者能识别红外光方向，闭眼效果更佳。潜在应用包括防伪识别、医疗手术辅助及视觉疾病治疗。目前仍处于原理验证阶段，需进一步优化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T19:03:12Z
- **目录日期**: 2025-05-23
