...
本文提出异构大语言模型驱动的多智能体系统(X-MAS)，突破了传统同构系统的局限。研究者开发了X-MAS-Bench测试平台，对27个大模型在5个领域21个测试集和5种功能上进行了170万次评估，发现异构配置能显著提升系统性能。实验表明：在纯聊天机器人场景中，异构系统在MATH数据集上性能提升8.4%；在混合型场景中，AIME数据集上性能提升高达47%。这些发现证明，无需重构系统架构，仅通过采用异构模型组合即可大幅提升多智能体系统的集体智能水平，为构建可扩展的协作AI系统开辟了新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T20:01:42Z
- **目录日期**: 2025-05-23
