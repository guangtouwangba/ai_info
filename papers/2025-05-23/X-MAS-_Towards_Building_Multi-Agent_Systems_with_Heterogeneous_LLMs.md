...
本文提出了一种基于异构大语言模型（LLM）的多智能体系统（X-MAS），通过整合不同LLM的优势来提升系统性能。研究者开发了X-MAS-Bench测试平台，评估了27个LLM在5个领域和5种功能上的表现，进行了超过170万次测试。结果表明，相比同构系统，异构LLM驱动的多智能体系统无需结构改造即可显著提升性能：在纯聊天机器人场景下，MATH数据集上性能提升8.4%；在混合聊天-推理场景下，AIME数据集上性能提升达47%。这为构建更强大的协作AI系统提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T05:01:27Z
- **目录日期**: 2025-05-23
