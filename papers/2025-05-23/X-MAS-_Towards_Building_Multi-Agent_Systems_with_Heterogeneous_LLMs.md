...
该研究探索了基于异构大语言模型（LLM）的多智能体系统（X-MAS），通过让不同LLM驱动各具特长的智能体，突破单一模型的能力限制。团队开发了X-MAS-Bench测试平台，对27个LLM在5大领域（21个测试集）和5种功能进行了超170万次评估，发现异构配置能显著提升系统性能：在纯聊天机器人场景中，MATH数据集表现提升8.4%；在混合聊天-推理场景中，AIME数据集表现提升达47%。研究表明，无需重构系统架构，仅通过采用异构LLM组合即可有效提升多智能体系统的集体智能水平。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T16:01:33Z
- **目录日期**: 2025-05-23
