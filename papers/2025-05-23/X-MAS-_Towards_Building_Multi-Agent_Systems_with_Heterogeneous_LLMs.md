...
本文提出了一种基于异构大语言模型（LLM）的多智能体系统（X-MAS），突破了传统单模型驱动系统的性能限制。研究团队开发了X-MAS-Bench测试平台，对27个LLM在5个领域（21个测试集）和5项功能进行了超过170万次评估，确定了各领域功能组合的最优模型选择。实验表明，异构LLM驱动的MAS系统性能显著优于同构系统：在纯聊天机器人场景中，MATH数据集上性能提升8.4%；在混合聊天-推理场景中，AIME数据集上性能提升高达47%。这为构建可扩展的协作AI系统提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T07:01:33Z
- **目录日期**: 2025-05-23
