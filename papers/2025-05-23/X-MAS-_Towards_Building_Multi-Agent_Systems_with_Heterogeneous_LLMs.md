...
本文提出了一种基于异构大语言模型（LLM）驱动的多智能体系统（X-MAS），通过整合不同LLM的优势来提升系统性能。研究团队开发了X-MAS-Bench测试平台，对27种LLM在5个领域和5种功能上进行了170万次评估，确定了最优模型组合方案。实验表明，相比同构系统，异构配置能显著提升性能：在纯聊天机器人场景下，MATH数据集上性能提升8.4%；在混合（聊天+推理）场景下，AIME数据集上性能提升高达47%。该研究为构建更强大的协作AI系统提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T10:01:36Z
- **目录日期**: 2025-05-23
