...
这篇论文探讨了基于异构大语言模型(LLM)的多智能体系统(X-MAS)，突破了传统同构系统的局限。研究者开发了X-MAS-Bench测试平台，对27个LLM在5个领域21个测试集和5种功能上进行了170万次评估，确定了各领域-功能组合的最佳模型选择。实验表明，从同构转向异构LLM驱动的多智能体系统能显著提升性能：在纯聊天机器人场景下，MATH数据集性能提升8.4%；在混合聊天-推理场景中，AIME数据集性能提升高达47%。这为构建更强大的协作AI系统提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T17:01:38Z
- **目录日期**: 2025-05-23
