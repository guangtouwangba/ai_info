...
阿拉伯语多模态推理基准(ARB)是首个针对阿拉伯语多模态逐步推理的评估基准，涵盖11个领域(视觉推理、文档理解、OCR等)，包含1,356个样本和5,119个人工标注的推理步骤。研究评估了12个先进的大模型，发现其在连贯性、忠实度和文化基础方面仍存在挑战。ARB为评估非主流语言的多模态推理提供了结构化框架，推动了包容性、透明性和文化感知AI系统的发展。该研究公开了基准数据集、评估标准和代码库(https://github.com/mbzuai-oryx/ARB)，以支持未来研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T20:01:13Z
- **目录日期**: 2025-05-23
