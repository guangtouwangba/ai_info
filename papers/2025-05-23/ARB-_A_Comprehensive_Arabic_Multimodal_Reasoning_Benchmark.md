...
研究人员推出了首个针对阿拉伯语的多模态推理基准测试ARB，旨在评估大型多模态模型(LMMs)在阿拉伯语文本和视觉模态中的逐步推理能力。该基准涵盖11个领域，包含1,356个多模态样本和5,119个人工标注的推理步骤。测试12个先进LMMs后发现，这些模型在连贯性、忠实度和文化基础方面仍存在挑战。ARB为评估非主流语言的多模态推理提供了结构化框架，推动了更具包容性、透明性和文化意识的AI系统发展。相关代码、评估标准和数据集已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T15:01:11Z
- **目录日期**: 2025-05-23
