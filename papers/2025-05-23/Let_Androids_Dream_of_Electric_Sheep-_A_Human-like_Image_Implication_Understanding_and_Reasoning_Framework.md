...
研究人员提出了"Let Androids Dream (LAD)"框架，用于解决AI系统在图像隐喻理解上的挑战。该框架模仿人类认知过程，通过三阶段处理：感知（将视觉信息转为多层级文本）、搜索（整合跨领域知识消除歧义）和推理（生成上下文对齐的隐喻解释）。实验表明，LAD在英文图像隐喻基准测试中超越15+多模态大模型，在中文测试中表现显著提升，其轻量级GPT-4o-mini版本在选择题上与GPT-4o相当，在开放式问题上性能高出36.7%。该研究为提升AI视觉语言推理能力提供了新思路。项目已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T17:01:16Z
- **目录日期**: 2025-05-23
