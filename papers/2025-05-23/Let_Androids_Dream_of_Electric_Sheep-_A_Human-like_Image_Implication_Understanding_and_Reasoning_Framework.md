...
AI系统在理解图像隐喻方面仍面临挑战，现有模型难以捕捉视觉内容中隐含的文化、情感和上下文含义。针对这一问题，研究者提出了"Let Androids Dream (LAD)"框架，通过三阶段处理：感知（将视觉信息转换为多层级文本表示）、搜索（整合跨领域知识消除歧义）和推理（生成上下文对齐的图像含义）。该框架使用轻量级GPT-4o-mini模型，在英文图像理解基准测试中超越15+多模态大模型，中文测试表现显著提升，在选择题上与GPT-4o相当，开放式问题表现提升36.7%。该研究为AI图像理解提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T13:09:11Z
- **目录日期**: 2025-05-23
