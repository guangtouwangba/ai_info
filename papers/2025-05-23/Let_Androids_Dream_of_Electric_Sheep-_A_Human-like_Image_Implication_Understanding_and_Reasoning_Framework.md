...
AI系统在理解图像隐喻方面仍面临挑战，现有模型难以捕捉视觉内容中的文化、情感和语境隐含意义。针对这一问题，研究者提出"Let Androids Dream (LAD)"框架，通过三阶段处理：感知（将视觉信息转化为多层级文本表征）、搜索（整合跨领域知识消除歧义）和推理（生成符合语境的图像含义）。实验表明，该框架在英文图像隐喻基准测试中超越15+多模态大模型，在中文测试中表现显著提升，在选择题上与GPT-4o相当，开放式问题表现优于36.7%。该研究为提升AI视觉语言推理能力提供了新思路。项目已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T20:01:23Z
- **目录日期**: 2025-05-23
