...
论文提出Let Androids Dream (LAD)框架，解决AI系统理解图像隐喻的难题。现有多模态大模型在视觉问答任务中表现良好，但难以捕捉视觉元素间的抽象关系和文化情感内涵。LAD受人类认知启发，采用三阶段流程：感知（将视觉信息转为多层级文本）、搜索（整合跨领域知识消歧）、推理（生成上下文对齐的隐喻解读）。实验表明，轻量级GPT-4o-mini搭载LAD框架在英汉图像隐喻基准测试中超越15+模型，多选题表现媲美GPT-4o，开放式问答提升36.7%。该研究为AI视觉语言推理提供了新思路。项目已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T06:01:10Z
- **目录日期**: 2025-05-23
