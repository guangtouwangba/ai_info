...
论文提出Let Androids Dream (LAD)框架，用于解决AI系统在图像隐喻理解上的挑战。LAD通过三阶段处理：感知（将视觉信息转为多层次文本表示）、搜索（整合跨领域知识消除歧义）、推理（生成上下文对齐的隐含意义）。相比15+多模态大模型，LAD在英文图像隐喻基准上达到SOTA，中文基准显著提升，在选择题上与GPT-4o相当，开放题优于36.7%。该框架为AI理解图像隐含意义提供了新思路，推动了视觉语言推理和人机交互发展。项目已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T05:01:08Z
- **目录日期**: 2025-05-23
