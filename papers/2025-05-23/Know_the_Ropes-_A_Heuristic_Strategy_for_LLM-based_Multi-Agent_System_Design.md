...
Know-The-Ropes (KtR) 提出了一种多智能体框架，通过将领域先验转化为分层算法蓝图，解决单一大模型在上下文限制、角色过载和领域迁移上的瓶颈。KtR递归分解任务为类型化子任务，结合轻量级增强技术（如思维链、微调），避免传统多智能体方法的分解模糊和验证开销。实验显示：在背包问题（3-8项）中，3个GPT-4o-mini智能体将准确率从3%提升至95%；任务分配问题（6-15项）中，6智能体在10项任务达到100%准确率，13-15项达84%（零样本仅11%）。该方法证明算法感知分解能高效利用轻量模型，无需持续扩大模型规模。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T14:02:22Z
- **目录日期**: 2025-05-23
