...
Discord公开了名为"Discord Unveiled"的大规模数据集，包含2015-2024年间10%公共服务器的20.5亿条消息，涉及470万用户。数据特点包括：17%消息来自机器人；多语言内容（英语为主，含西班牙语等）；主题以游戏为核心，涵盖社交、心理健康等；所有用户信息已匿名处理。该数据集为AI训练（如LLM）、NLP研究及社会学分析提供了宝贵资源，完整记录了平台十年发展历程。数据已开放获取，相关论文同步发布。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T01:31:06Z
- **目录日期**: 2025-05-23
