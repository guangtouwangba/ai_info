...
Discord公开了名为"Discord Unveiled"的大规模数据集，包含2015-2024年间470万用户在公共服务器发送的20.5亿条消息。数据经过匿名化处理，覆盖多种语言（以英语为主）和主题（游戏最热门，其次是社交、动漫等），其中17%消息来自机器人账号。该数据集结构完整，可用于训练大语言模型及NLP、社群治理等研究，同时符合数据保护要求。下载地址：zenodo.org/records/15170676；论文：arxiv.org/abs/2502.00627。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T03:21:58Z
- **目录日期**: 2025-05-23
