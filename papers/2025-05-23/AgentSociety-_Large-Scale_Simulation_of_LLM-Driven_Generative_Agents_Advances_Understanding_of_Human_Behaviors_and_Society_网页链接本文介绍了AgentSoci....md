...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟超过1万个AI代理及其500万次互动。研究者利用该平台研究了社会极化、信息传播、基本收入政策及自然灾害影响等社会问题，其模拟结果与现实数据高度吻合。该系统展示了作为计算社会科学研究工具的潜力，能够辅助传统研究方法，帮助理解人类行为机制和社会现象成因，为政策制定提供参考依据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T23:04:54Z
- **目录日期**: 2025-05-23
