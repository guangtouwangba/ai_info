...
AgentSociety是一种基于大语言模型的大规模社会模拟器，可模拟1万多个代理的社会互动（500万次互动）。它用于研究社会问题，如极化现象、信息传播、基本收入政策及自然灾害影响。模拟结果与现实数据吻合，验证了其捕捉人类行为机制的能力，可作为社会科学研究和政策制定的工具。该平台结合了LLM代理、真实社会环境和大规模模拟引擎，为传统研究方法（如调查、访谈）提供了补充。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T17:05:44Z
- **目录日期**: 2025-05-23
