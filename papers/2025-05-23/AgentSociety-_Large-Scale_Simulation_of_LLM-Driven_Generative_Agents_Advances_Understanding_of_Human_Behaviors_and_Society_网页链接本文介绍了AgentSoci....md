...
本文介绍了AgentSociety，这是一个基于大语言模型的大规模社会模拟器，可模拟1万个代理及其500万次互动。研究者用它研究了四个社会问题：社会极化、信息传播、基本收入政策和自然灾害影响。模拟结果与现实世界数据吻合，验证了该工具在揭示人类行为机制方面的有效性。AgentSociety可作为计算社会科学的新平台，辅助传统研究方法，帮助学者和决策者分析社会问题的模式和成因，展现了人工智能在社会研究中的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T03:23:00Z
- **目录日期**: 2025-05-23
