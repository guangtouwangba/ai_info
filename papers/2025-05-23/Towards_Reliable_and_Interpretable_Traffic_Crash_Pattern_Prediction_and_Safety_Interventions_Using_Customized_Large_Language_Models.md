...
这篇论文提出了TrafficSafe框架，利用大语言模型（LLMs）将交通事故预测和特征归因转化为基于文本的推理任务。该研究构建了一个包含58,903份真实事故报告的多模态数据集，整合了基础设施、环境、驾驶员和车辆信息。经微调的TrafficSafe模型在F1分数上比基线方法提高了42%。研究还开发了TrafficSafe Attribution特征归因框架，发现酒驾是严重事故的首要因素，其贡献度是其他驾驶行为的两倍。该框架能识别关键风险因素，指导数据收集策略改进，为将AI技术转化为可操作的交通安全解决方案提供了新范式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T00:02:24Z
- **目录日期**: 2025-05-23
