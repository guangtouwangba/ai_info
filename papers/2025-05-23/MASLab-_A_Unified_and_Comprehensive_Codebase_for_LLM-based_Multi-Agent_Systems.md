...
研究人员推出了MASLab，一个统一、全面且易于研究的代码库，用于基于大语言模型（LLM）的多智能体系统（MAS）。MASLab整合了20多种跨领域已验证方法，提供统一环境和多种基准测试以确保公平比较，并采用共享简化结构降低理解和扩展门槛。通过10多个基准和8种模型的广泛实验，MASLab为研究者提供了当前MAS方法的全面概览。该代码库将持续更新，追踪领域最新进展，并欢迎开源社区贡献。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T11:01:39Z
- **目录日期**: 2025-05-23
