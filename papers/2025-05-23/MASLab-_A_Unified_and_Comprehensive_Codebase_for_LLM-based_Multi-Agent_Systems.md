...
研究人员开发了MASLab，这是一个统一、全面的代码库，旨在解决基于大语言模型(LLM)的多智能体系统(MAS)研究中存在的重复实现、不公平比较和入门门槛高等问题。MASLab整合了20多种跨领域已验证方法，提供统一测试环境与多种基准，确保公平比较；采用共享简化结构，降低理解与扩展难度。通过10多个基准和8种模型的广泛实验，MASLab为研究者提供了当前MAS方法的全面概览。该平台将持续更新，跟踪领域最新进展，并欢迎开源社区贡献。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T05:01:36Z
- **目录日期**: 2025-05-23
