...
研究人员开发了MASLab，一个统一、全面且易于研究的代码库，用于基于大语言模型（LLM）的多智能体系统（MAS）。MASLab整合了20多种跨领域的成熟方法，并经过严格验证，确保与官方实现一致。它提供统一的环境和多种基准，支持公平比较，并采用共享的简化结构，降低理解和扩展门槛。通过覆盖10多个基准和8种模型的广泛实验，MASLab为研究者提供了当前MAS方法的全面视图。该平台将持续更新，跟踪领域最新进展，并欢迎开源社区贡献。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T23:01:41Z
- **目录日期**: 2025-05-23
