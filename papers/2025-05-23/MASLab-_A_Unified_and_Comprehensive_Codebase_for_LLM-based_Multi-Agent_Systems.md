...
本文介绍了MASLab，一个基于大语言模型（LLM）的多智能体系统（MAS）统一代码库，旨在解决现有研究中方法分散、重复实现和评估标准不一的问题。MASLab整合了20多种跨领域方法，经过严格验证，提供统一环境和多种基准测试以确保公平比较。其模块化设计降低了理解和扩展门槛。通过覆盖10多个基准和8种模型的广泛实验，MASLab为研究者提供了当前MAS方法的全面概览。未来将持续更新，跟踪领域最新进展，并欢迎开源社区贡献。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T22:01:41Z
- **目录日期**: 2025-05-23
