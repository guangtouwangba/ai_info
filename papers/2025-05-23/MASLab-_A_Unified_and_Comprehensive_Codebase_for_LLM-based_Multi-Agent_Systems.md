...
MASLab是一个统一、全面的多智能体系统（MAS）代码库，旨在解决现有研究中重复实现、不公平比较和高门槛的问题。它整合了20多种跨领域方法，经过严格验证，并提供统一环境和多种基准测试以确保公平比较。MASLab采用共享的简化结构，降低理解和扩展的难度。基于该平台，研究者进行了大量实验，涵盖10多个基准和8种模型，为MAS方法现状提供了清晰全面的视角。MASLab将持续更新，跟踪领域最新进展，并欢迎开源社区贡献。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T02:31:01Z
- **目录日期**: 2025-05-23
