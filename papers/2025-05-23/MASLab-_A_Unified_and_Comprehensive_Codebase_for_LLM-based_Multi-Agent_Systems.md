...
研究人员开发了名为MASLab的统一代码库，旨在解决基于大语言模型(LLM)的多智能体系统(MAS)研究中的重复实现、不公平比较和高门槛问题。MASLab整合了20多种跨领域已验证方法，提供统一环境和多种基准测试确保公平比较，并通过共享精简结构降低理解和扩展门槛。该平台已进行涵盖10+基准测试和8种模型的广泛实验，为研究者提供全面视角。MASLab将持续更新，跟踪领域最新进展，并欢迎开源社区贡献。该代码库有助于促进LLM-based MAS研究的标准化和发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T16:01:42Z
- **目录日期**: 2025-05-23
