...
研究人员开发了名为MASLab的统一代码库，旨在解决基于大语言模型(LLM)的多智能体系统(MAS)研究中的重复实现、不公平比较和高门槛问题。MASLab整合了20多种跨领域已验证方法，提供统一环境和多种基准测试以确保公平比较，并采用共享精简结构降低理解与扩展难度。通过10多个基准和8个模型的广泛实验，该平台为研究者提供了MAS方法的全面概览。MASLab将持续更新追踪领域最新进展，并欢迎开源社区贡献。该工具显著提升了MAS研究的效率与公平性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T04:02:29Z
- **目录日期**: 2025-05-23
