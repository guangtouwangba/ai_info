...
研究人员推出了MASLab，一个统一、全面且易于研究的代码库，旨在解决基于大语言模型（LLM）的多智能体系统（MAS）领域缺乏统一平台的问题。MASLab整合了20多种跨领域已验证方法，提供统一环境与多种基准测试，确保公平比较。其共享的简化结构降低了理解与扩展门槛。通过覆盖10多个基准和8种模型的实验，MASLab为研究者提供了当前MAS方法的全面概览。该平台将持续更新，跟踪领域最新进展，并欢迎开源社区贡献。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T17:01:51Z
- **目录日期**: 2025-05-23
