...
研究人员开发了MASLab，一个统一、全面的代码库，旨在解决基于大型语言模型(LLM)的多智能体系统(MAS)研究中的冗余实现、不公平比较和高门槛问题。MASLab整合了20多种跨领域方法，并经过严格验证；提供统一环境和多种基准测试以公平评估方法；采用共享精简结构降低理解和扩展难度。通过10多个基准测试和8种模型的广泛实验，MASLab为研究者提供了当前MAS方法的全面概览。该代码库将持续更新，跟踪领域最新进展，并欢迎开源社区贡献。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T14:01:47Z
- **目录日期**: 2025-05-23
