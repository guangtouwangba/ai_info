...
麻省理工学院Ryan Williams教授在计算复杂性领域取得重要突破，提出了一种将算法转化为空间占用更小形式的新方法。研究通过"可压缩卵石"模拟技术，证明空间资源比时间更强大——少量空间可大幅减少运行时间。该成果改进了1975年Hopcroft等人的空间压缩技术，将所需空间降至原时间预算的平方根级别。虽然尚未完全解决"P对PSPACE"这一世纪难题，但为证明PSPACE类问题空间优势提供了新路径。研究源于对树评估问题的创新解法，揭示了数据压缩叠放的可能性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T04:05:06Z
- **目录日期**: 2025-05-23
