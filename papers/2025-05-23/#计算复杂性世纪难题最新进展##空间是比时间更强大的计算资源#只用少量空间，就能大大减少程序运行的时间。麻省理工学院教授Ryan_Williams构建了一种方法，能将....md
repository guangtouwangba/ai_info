...
麻省理工Ryan Williams教授在计算复杂性理论取得突破，提出空间压缩新方法。研究表明空间资源比时间更强大：通过"可压缩卵石"模拟技术，能将算法空间需求降至时间预算的平方根级别，证明少量空间可大幅减少运行时间。这支持了"PSPACE类可能大于P类"的猜想，但完全证明仍需扩大时空差距数量级。该研究源自对树评估问题的创新解法，将数据压缩叠放，最终构建出通用空间压缩工具。成果发表于《量子杂志》，为计算复杂性世纪难题带来新视角。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T02:33:06Z
- **目录日期**: 2025-05-23
