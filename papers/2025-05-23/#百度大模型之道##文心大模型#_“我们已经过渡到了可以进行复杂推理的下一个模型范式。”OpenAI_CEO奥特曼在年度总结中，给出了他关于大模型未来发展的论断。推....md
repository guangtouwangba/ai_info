...
中国信通院最新评估显示，百度"文心X1 Turbo"大模型在推理能力测评中表现优异，成为国内首个且唯一获评最高等级"4+"的模型（24项评估中16项满分）。百度AI Day活动披露，该模型在复杂推理任务上展现领先优势，标志着大模型技术已进入"推理能力竞争"新阶段。OpenAI CEO此前也指出，推理能力正成为行业新焦点。百度副总裁吴甜从模型架构、数据训练等维度解析了文心的技术突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T04:04:57Z
- **目录日期**: 2025-05-23
