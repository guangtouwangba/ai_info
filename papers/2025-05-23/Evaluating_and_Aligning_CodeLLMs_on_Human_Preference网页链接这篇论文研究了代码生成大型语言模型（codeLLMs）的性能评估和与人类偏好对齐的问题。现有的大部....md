...
该研究针对代码生成大模型(codeLLMs)提出新评估框架CodeArena，关注模型输出与人类偏好的对齐问题。通过构建包含397个高质量样本(覆盖40类/44种语言)的人类标注基准，以及近200亿标记的合成指令数据集SynCode-Instruct，研究发现：1)传统执行基准与人类偏好存在显著差异；2)开源顶尖模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距明显。研究强调代码生成质量评估需超越正确性，应更重视人类编程习惯和偏好匹配。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T12:06:36Z
- **目录日期**: 2025-05-23
