...
这篇论文针对代码生成大型语言模型(codeLLMs)提出新评估方法，重点关注与人类偏好的对齐。研究者创建了CodeArena基准测试(包含397个高质量样本，覆盖40类任务和44种语言)和SynCode-Instruct合成指令数据集(近200亿标记)。实验发现传统执行基准与人类偏好评估存在差异，并显示开源模型(如Qwen2.5-Coder)与专有模型(如OpenAI o1)间存在显著性能差距。研究强调了在代码生成任务中考虑人类偏好的重要性，为提升LLMs的实际应用价值提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T01:33:16Z
- **目录日期**: 2025-05-23
