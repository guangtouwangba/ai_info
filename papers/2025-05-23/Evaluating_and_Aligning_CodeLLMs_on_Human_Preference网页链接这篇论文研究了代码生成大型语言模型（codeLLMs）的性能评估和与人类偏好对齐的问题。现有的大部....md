...
这篇论文针对代码生成大模型(codeLLMs)提出了两个关键贡献：1)构建了CodeArena基准测试，包含397个高质量编程任务样本，覆盖40个类别和44种语言，首次关注代码生成与人类偏好的对齐；2)开发了20B标记的SynCode-Instruct合成指令数据集，验证了大规模指令微调的有效性。实验发现现有执行基准与人类偏好存在差距，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著，强调了人类偏好对齐在代码生成中的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T23:05:30Z
- **目录日期**: 2025-05-23
