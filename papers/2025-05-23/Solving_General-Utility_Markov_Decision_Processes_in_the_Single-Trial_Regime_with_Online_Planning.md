...
本文首次提出了解决无限时域折扣通用效用马尔可夫决策过程(GUMDP)单次试验优化问题的方法。研究首先分析了单次试验场景下的策略优化基础问题，包括最优策略类别、问题转化为等效MDP的方法以及计算复杂度。其次，提出利用蒙特卡洛树搜索等在线规划技术解决该问题。实验结果表明，该方法性能显著优于基线模型。该工作为单次轨迹评估场景下的决策优化提供了理论框架和实用算法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T00:02:05Z
- **目录日期**: 2025-05-23
