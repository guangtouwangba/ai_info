...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译及科研分析等一站式服务。其核心功能包括：1）中英文文献检索，支持互动问答和自动摘要生成；2）英文文献翻译与AI辅助阅读，可上传PDF并获取章节概要；3）个性化科研情报订阅，通过微信或邮件推送最新学术动态。平台覆盖42个学科，包含3.5亿论文和1.5亿专利数据，同时提供学者画像、会议追踪等工具，支持免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T07:05:59Z
- **目录日期**: 2025-05-23
