...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析和写作一站式服务。它支持中英文文献搜索，能自动生成摘要并回答用户问题，帮助快速理解论文内容。平台还提供科研动态订阅功能，根据用户偏好推送最新学术资讯。此外，AMiner包含学者画像、学术会议和论文专题等功能，收录大量论文、学者和专利数据。用户可通过网页免费使用其核心功能，提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T04:06:31Z
- **目录日期**: 2025-05-23
