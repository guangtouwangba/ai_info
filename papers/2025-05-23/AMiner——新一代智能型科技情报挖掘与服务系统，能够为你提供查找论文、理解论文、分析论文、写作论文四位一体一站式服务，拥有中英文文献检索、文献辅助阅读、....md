...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析和写作一站式服务。它支持中英文文献搜索，拥有3.5亿论文、0.6亿学者等海量数据，并能通过AI生成摘要和辅助阅读。用户可上传PDF或从库中选取文献，获取概要、章节总结和智能问答。平台还提供科研动态订阅服务，按用户偏好推送最新学术资讯。此外，AMiner具备学者画像、学术会议和论文排行榜等功能，基础服务免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T19:05:24Z
- **目录日期**: 2025-05-23
