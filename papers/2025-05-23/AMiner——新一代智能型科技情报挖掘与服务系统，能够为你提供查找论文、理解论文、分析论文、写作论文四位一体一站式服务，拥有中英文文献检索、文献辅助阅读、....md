...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析及写作辅助的一站式服务。它支持中英文文献搜索，拥有3.5亿论文、0.6亿学者等海量数据，并能通过AI生成摘要和解答问题。用户可上传PDF或直接检索文献，获取章节概要和智能问答。平台还提供科研动态订阅功能，按用户偏好推送最新论文。此外，AMiner包含学者画像、学术会议等特色功能，基础服务免费开放。访问入口：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T23:05:22Z
- **目录日期**: 2025-05-23
