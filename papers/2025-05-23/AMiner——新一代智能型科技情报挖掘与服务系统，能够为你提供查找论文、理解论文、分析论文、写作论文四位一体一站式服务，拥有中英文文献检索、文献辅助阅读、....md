...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和科研订阅等一站式服务。它支持中英文文献搜索，能生成摘要和问答互动，帮助用户快速理解论文内容。平台还提供AI驱动的文献翻译、文档解析和个性化科研动态推送，覆盖42个学科3.5亿论文数据。用户可通过网页或微信小程序免费使用核心功能，实现高效学术研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T13:14:05Z
- **目录日期**: 2025-05-23
