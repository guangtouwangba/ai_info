...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译及科研分析等一站式服务。它收录了3.5亿论文、0.6亿学者等海量学术资源，支持中英文文献搜索，并能通过AI生成摘要、章节概要和智能问答。用户可订阅个性化科研动态，跟踪机构、学者或关键词的最新研究。平台还提供学者画像、学术会议推荐等功能，基础服务免费开放。网址：https://www.aminer.cn/。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T17:06:13Z
- **目录日期**: 2025-05-23
