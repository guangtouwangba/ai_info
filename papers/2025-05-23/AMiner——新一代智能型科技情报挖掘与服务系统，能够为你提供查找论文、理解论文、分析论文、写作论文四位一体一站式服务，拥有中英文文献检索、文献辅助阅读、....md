...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译和科研订阅等一站式服务。它收录了3.5亿篇论文、6000万学者和1.5亿专利，支持中英文文献搜索、AI生成摘要、章节概要和互动问答。用户可上传PDF或从平台获取论文，并通过定制订阅接收最新科研动态。此外，AMiner还提供学者画像、学术会议和必读论文专题等功能。平台免费使用，网址为https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T11:06:11Z
- **目录日期**: 2025-05-23
