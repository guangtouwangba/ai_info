...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析和写作一站式服务。它支持中英文文献搜索，能自动生成摘要和章节概要，并允许用户通过问答深入理解论文内容。平台还提供科研情报订阅，根据用户偏好推送最新学术动态。AMiner收录了3.5亿论文、0.6亿学者和1.5亿专利，覆盖42个学科，并免费开放基础功能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T02:35:07Z
- **目录日期**: 2025-05-23
