...
微软研究院推出的AI天气预报系统Aurora在多领域预测中超越传统数值模型：5天全球空气污染预报74%指标更优，10天海浪预报86%指标领先，热带气旋路径预报100%胜出，10天全球天气预报92%指标占优且极端天气预测更强。其核心采用3D Swin Transformer U-Net架构，通过百万小时地球数据预训练，能以极低成本微调适配新任务。该系统兼具高分辨率预测优势（最高达0.1°）和超低计算成本（比传统方法低数个数量级），未来可扩展至海洋环流、植被监测等领域。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-23T01:31:25Z
- **目录日期**: 2025-05-23
