...
百度推出的"秒哒"是国内首个对话式应用开发平台，用户无需编写代码即可快速开发完整网站和轻应用。该平台通过AI自动完成架构设计、技术选型、编码实现和测试等全流程，3分钟内可生成包含前端页面、后台管理和移动端适配的完整网站，并提供域名发布服务。用户只需输入需求，AI会协同多个智能体完成开发，并支持二次编辑。该产品由李彦宏在2022年11月发布，主打"零代码"和"分钟级"应用开发能力，适用于H5、网站等多种场景。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T11:03:56Z
- **目录日期**: 2025-03-24
