...
百度推出的"秒哒"是国内首个对话式应用开发平台，用户无需编写代码，只需提出需求，AI即可在3分钟内自动完成网站开发。该平台能处理架构设计、技术选型、编码实现、测试等全流程，生成包含前端页面、后台管理及移动端适配的完整网站，并提供域名和二次编辑功能。李彦宏去年11月发布的这一工具，支持H5、网站和轻应用开发，通过自然语言交互实现分钟级应用构建，大幅降低开发门槛。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T09:31:44Z
- **目录日期**: 2025-03-24
