...
百度推出的"秒哒"是国内首个对话式应用开发平台，用户无需编写代码，只需提出需求，AI即可在3分钟内自动完成完整网站开发。该平台能自动处理架构设计、技术选型、编码实现、测试等全流程，生成包含前端页面、后台管理及移动端适配的完整应用，并提供域名和二次编辑功能。李彦宏去年11月发布的这一产品，支持H5、网站和轻应用开发，实现"会说需求就能开发"的智能化体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T18:03:40Z
- **目录日期**: 2025-03-24
