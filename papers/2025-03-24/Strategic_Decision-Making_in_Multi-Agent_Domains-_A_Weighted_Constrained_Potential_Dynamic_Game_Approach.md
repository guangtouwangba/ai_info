...
本文提出利用约束动态势博弈（WCPDG）来解决多智能体交互决策中的计算挑战。通过将现实多智能体场景转化为加权约束动态势博弈，可将寻找广义纳什均衡（GNE）简化为求解单个约束最优控制问题。研究表明，该方法能显著提升求解效率，在多个仿真实验中展现出优于现有博弈求解器的计算速度优势，并在双四旋翼无人机协同搬运避障实验中验证了有效性。这一框架为复杂交互场景提供了一种高效解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T20:02:13Z
- **目录日期**: 2025-03-24
