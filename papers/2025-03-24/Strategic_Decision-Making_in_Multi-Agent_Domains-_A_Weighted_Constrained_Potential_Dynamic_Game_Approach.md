...
本文提出了一种利用约束动态势博弈（WCPDG）结构来解决多智能体交互决策问题的方法。通过将现实中的多智能体交互场景转化为WCPDG，广义纳什均衡（GNE）可以通过求解单个约束最优控制问题获得。相比现有方法，该方法显著减少了求解时间，并通过模拟实验和四旋翼无人机导航实验验证了其有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T05:02:40Z
- **目录日期**: 2025-03-24
