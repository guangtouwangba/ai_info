...
该研究提出利用约束动态势博弈（WCPDG）来解决多智能体交互决策中的计算挑战。通过识别现实场景中可转化为WCPDG的结构，将寻找广义纳什均衡（GNE）简化为求解单个约束最优控制问题。相比现有博弈求解器，该方法显著提高了求解速度。仿真实验验证了其有效性，并在双四旋翼无人机协同搬运物体并避让行人的导航场景中得到实验验证。该方法利用势博弈特性，有效降低了耦合优化问题的复杂度，为多目标交互决策提供了高效解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T14:02:31Z
- **目录日期**: 2025-03-24
