...
在交互式多智能体环境中，决策和规划因智能体目标相互关联而复杂。动态博弈论为此提供了分析框架，但求解约束动态博弈和广义纳什均衡（GNE）面临计算挑战。本文提出利用现实多智能体交互的特殊结构，特别是约束动态势博弈，通过最小化势函数解决单一约束最优控制问题来找到GNE。研究表明，加权约束势动态博弈（WCPDG）的GNE可通过单一约束最优控制问题求解，显著提升求解效率。仿真和实验验证了该方法在双四旋翼无人机避障导航中的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T04:02:42Z
- **目录日期**: 2025-03-24
