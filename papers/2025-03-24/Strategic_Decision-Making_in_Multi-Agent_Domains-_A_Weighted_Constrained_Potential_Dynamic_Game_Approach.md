...
这篇论文提出利用约束动态势博弈（WCPDG）来解决多智能体交互决策中的计算难题。通过分析现实场景中的特殊结构，作者证明可将复杂交互转化为加权约束势动态博弈，从而通过求解单个最优控制问题获得广义纳什均衡（GNE），显著提升求解效率。仿真实验显示该方法比现有博弈求解器快得多，并在双四旋翼无人机协同搬运避障实验中验证了有效性。该框架为多目标耦合的交互决策提供了高效解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T09:30:28Z
- **目录日期**: 2025-03-24
