...
本文提出利用约束动态势博弈（WCPDG）来解决多智能体交互决策中的计算挑战。通过识别现实场景中的特定结构，将问题转化为WCPDG形式，其广义纳什均衡（GNE）可通过求解单个约束最优控制问题获得。相比现有博弈求解器，该方法显著缩短求解时间。仿真实验和双四旋翼无人机协同搬运避障的实物验证表明，该方法能有效处理多目标耦合的复杂交互场景。核心创新在于利用势函数特性，将复杂的多智能体耦合优化问题简化为单目标优化问题求解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T16:02:34Z
- **目录日期**: 2025-03-24
