...
本文提出利用约束动态势博弈（WCPDG）解决多智能体交互决策问题。通过分析现实场景中的特殊结构，将复杂交互转化为加权约束动态势博弈，使广义纳什均衡（GNE）的求解简化为单个约束最优控制问题。相比现有博弈求解器，该方法显著提升计算效率。仿真实验验证了其有效性，并在双四旋翼无人机协同搬运物体、避让行人的导航任务中进行了实际验证。研究表明，约束动态势博弈能有效简化多智能体交互决策，为复杂动态博弈提供高效解决方案。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T22:02:09Z
- **目录日期**: 2025-03-24
