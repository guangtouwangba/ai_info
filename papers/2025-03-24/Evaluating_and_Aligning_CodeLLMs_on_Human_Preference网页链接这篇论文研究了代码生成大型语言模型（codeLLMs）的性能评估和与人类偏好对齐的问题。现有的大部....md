...
这篇论文针对代码生成大模型(codeLLMs)与人类偏好对齐的问题，提出了CodeArena基准测试和SynCode-Instruct合成指令数据集。CodeArena包含397个高质量样本，覆盖40类任务和44种编程语言，更贴近实际开发场景。研究发现现有基于执行的评估与人类偏好存在差距，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著。通过构建近200亿token的合成指令数据验证了大模型微调效果，强调了代码生成模型与人类编程习惯对齐的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T20:05:11Z
- **目录日期**: 2025-03-24
