...
Lindahl均衡是一种用于在多个可分公共物品间分配固定预算的解决方案，具有稳定性和比例公平性。本文研究了在无上限和上限约束下，Lindahl均衡的计算方法。在无上限情况下，Lindahl均衡等价于最大化Nash社会福利，并可通过比例响应动态计算。本文提出了一种新的凸规划公式，证明其与Nash福利最大化相关，并通过镜像下降法提供了收敛性证明。在上限约束下，本文证明了该凸规划仍适用，且其最优解为Lindahl均衡，从而解决了长期存在的计算问题，并表明可高效计算近似核心稳定分配。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T02:28:46Z
- **目录日期**: 2025-03-24
