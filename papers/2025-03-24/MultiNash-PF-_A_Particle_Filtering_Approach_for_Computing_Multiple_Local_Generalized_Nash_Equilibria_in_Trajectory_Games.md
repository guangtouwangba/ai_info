...
现代机器人系统常涉及复杂的多智能体交互，这些交互通常具有多模态性，可能导致多种不同结果。为有效交互，机器人需识别可能的交互模式并适应其他智能体的偏好。本文提出一种高效算法，利用博弈论规划器将交互结果建模为均衡点，每个均衡点对应一种交互模式。通过约束潜在轨迹博弈（CPTG）和局部广义纳什均衡（GNE）建模交互结果，结合隐式粒子滤波进行非凸轨迹优化，显著减少计算时间达50%，并在实际人机交互场景中成功处理多模态交互和实时冲突。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T07:02:34Z
- **目录日期**: 2025-03-24
