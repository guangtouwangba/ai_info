...
本文提出了一种高效算法MultiNash-PF，用于处理多智能体交互中的多模态问题。该方法基于博弈论规划器，将交互结果建模为约束势轨迹游戏(CPTG)的广义纳什均衡(GNE)，每个均衡对应一种交互模式。通过结合势博弈方法与隐式粒子滤波技术，算法能高效识别潜在函数的多个局部极小值点，再经优化求解器精修得到不同GNE。实验表明，该算法比基线方法减少50%计算时间，并在真实人机交互场景中有效处理多模态交互，实时解决潜在冲突。研究成果为机器人适应复杂多智能体交互提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T12:02:33Z
- **目录日期**: 2025-03-24
