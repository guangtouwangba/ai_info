...
现代机器人系统常涉及复杂的多智能体交互，这些交互通常具有多模态性，可能导致多种不同结果。为有效交互，机器人需识别可能的交互模式并适应其他智能体的偏好。本研究提出一种高效算法，利用博弈论规划器将交互结果建模为均衡点，每个均衡点对应一种交互模式。通过将交互规划建模为约束势能轨迹游戏（CPTG），并结合隐式粒子滤波进行非凸轨迹优化，算法能高效识别多个局部广义纳什均衡（GNE）。实验表明，该算法计算时间减少50%，并在人机交互中有效处理多模态交互和实时冲突。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T08:02:41Z
- **目录日期**: 2025-03-24
