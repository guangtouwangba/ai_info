...
Browser Use是一款由苏黎世联邦理工两名研究生开发的AI网页操作工具，仅用5周开发便获得1700万美元种子轮融资。该工具通过将网页内容转化为结构化文字，显著提升AI识别按钮、表单等元素的准确率和效率，解决了传统图像识别或DOM爬虫的局限性。其创新性吸引了Y Combinator孵化营及多家企业关注，甚至引发网站如何适配AI的咨询。创始人指出，随着AI对网页交互需求增长，该工具提供了更稳定的解决方案。融资反映了市场对AI"操作世界"能力的看好。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T11:04:33Z
- **目录日期**: 2025-03-24
