# #Manus带火的AI网页操作工具##AI网页操作工具开发5周融资1700万美元#Manus带火了AI网页操作工具Browser Use，该工具仅开发5周，就拿到了千万美元融资。据TechCru...
...
Manus推出的AI网页操作工具Browser Use在开发仅5周后便获得1700万美元种子轮融资，由Felicis领投，YC创始人和Nexus Venture Partners跟投。该工具通过将网页内容转化为结构化文字，显著提升AI对网页按钮、表单等元素的识别准确率和效率。由苏黎世联邦理工的两名研究生开发，Browser Use已被Y Combinator孵化营中的20多家公司采用，并受到大型企业关注。其成功反映了AI在网页交互中的日益重要性，以及对AI操作能力的广泛期待。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T06:03:40Z
- **目录日期**: 2025-03-24
