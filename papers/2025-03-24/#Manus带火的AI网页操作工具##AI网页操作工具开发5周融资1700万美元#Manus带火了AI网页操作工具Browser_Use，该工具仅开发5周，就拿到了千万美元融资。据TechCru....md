...
Manus推出的AI网页操作工具Browser Use在开发仅5周后便获得了1700万美元的种子轮融资，由Felicis领投，YC创始人Paul Graham等跟投。该工具通过将网页内容转化为结构化文字，显著提升了AI对网页按钮、表单等元素的识别准确率和操作效率。Browser Use由苏黎世联邦理工的两名研究生开发，已在Y Combinator冬季孵化营中被20多家公司采用，并受到大型企业的关注。其成功反映了AI在网页交互领域日益增长的需求和潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T05:03:23Z
- **目录日期**: 2025-03-24
