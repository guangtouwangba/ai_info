...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟1万多个代理的社会互动（500万次）。它用于研究极化现象、信息传播、基本收入政策及外部冲击（如飓风）等社会问题，结果与现实数据吻合。该系统结合LLM代理、真实社会环境和大规模模拟引擎，为社会科学研究和政策制定提供了新工具，能补充传统方法（如调查、访谈），揭示社会问题的模式和机制。其仿真能力验证了其在理解人类行为和社会动态方面的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T18:04:57Z
- **目录日期**: 2025-03-24
