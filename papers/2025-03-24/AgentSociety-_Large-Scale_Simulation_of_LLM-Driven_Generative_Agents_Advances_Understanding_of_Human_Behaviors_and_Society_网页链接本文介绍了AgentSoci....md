...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统通过模拟1万多个AI代理在真实社会环境中的500万次交互，研究了四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。研究结果显示，模拟结果与现实世界数据高度吻合，证明该系统能有效捕捉人类行为模式和社会机制。AgentSociety为社会科学研究和政策制定提供了新工具，可辅助传统研究方法，帮助理解复杂社会问题的成因和潜在解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T11:05:32Z
- **目录日期**: 2025-03-24
