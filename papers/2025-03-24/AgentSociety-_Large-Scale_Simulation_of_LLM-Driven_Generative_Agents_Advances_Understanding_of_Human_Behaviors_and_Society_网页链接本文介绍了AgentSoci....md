...
本文介绍了AgentSociety，一种基于大型语言模型（LLM）驱动的大规模社会模拟器，能够模拟超过1万个代理的社会生活及其500万次互动。通过该平台，研究者探讨了极化现象、信息传播、无条件基本收入政策及外部冲击（如飓风）等社会问题。AgentSociety的结果与现实世界实验高度吻合，展示了其在捕捉人类行为和社会机制方面的能力，并证明了其作为社会科学研究和政策制定工具的潜力。该平台为传统研究方法提供了有力支持，推动了社会问题的深入理解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T06:06:16Z
- **目录日期**: 2025-03-24
