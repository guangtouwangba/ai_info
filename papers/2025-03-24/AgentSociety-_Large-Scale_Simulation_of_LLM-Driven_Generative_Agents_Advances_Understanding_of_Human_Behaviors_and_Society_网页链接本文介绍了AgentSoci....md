...
这篇论文介绍了一个名为AgentSociety的大规模社会模拟器，它利用大型语言模型（LLM）驱动的智能代理、真实社会环境和强大的模拟引擎，模拟了超过1万个代理的社会生活及500万次互动。研究者通过该平台研究了四个关键社会问题：社会极化、刺激性信息传播、无条件基本收入政策影响以及飓风等外部冲击的影响。实验结果表明，AgentSociety的模拟结果与现实世界数据高度吻合，证明其能有效捕捉人类行为和社会机制，为社会科学研究和政策制定提供了有力工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T22:04:27Z
- **目录日期**: 2025-03-24
