...
这篇论文介绍了AgentSociety，这是一个利用大型语言模型驱动的大规模社会模拟器，能够模拟超过1万个代理的社会生活及500万次互动。研究者通过该平台研究了极化现象、刺激性信息传播、无条件基本收入政策及飓风等外部冲击对社会的影响。模拟结果与现实世界实验高度吻合，验证了其捕捉人类行为和社会机制的能力。AgentSociety展现了作为社会科学研究和政策制定工具的潜力，能够辅助传统研究方法，深入探索社会问题的模式、原因和潜在机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T19:04:37Z
- **目录日期**: 2025-03-24
