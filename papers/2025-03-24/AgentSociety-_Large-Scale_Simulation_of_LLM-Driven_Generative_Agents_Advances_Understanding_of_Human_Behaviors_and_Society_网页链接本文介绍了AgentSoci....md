...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理的社会互动（500万次交互）。研究者用它研究四大社会问题：群体极化、信息传播、基本收入政策效果和自然灾害影响。该系统模拟结果与现实数据吻合，验证了其在分析人类行为机制和社会问题方面的有效性，为社会科学研究和政策制定提供了新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T17:05:03Z
- **目录日期**: 2025-03-24
