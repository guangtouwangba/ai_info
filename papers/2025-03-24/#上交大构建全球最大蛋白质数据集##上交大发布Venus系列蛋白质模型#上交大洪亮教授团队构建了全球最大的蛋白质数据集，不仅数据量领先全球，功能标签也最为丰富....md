...
上海交通大学洪亮教授团队构建了全球最大蛋白质数据集，包含近90亿条序列，覆盖陆地、深海及病毒样本，并标注丰富功能标签。团队开发Venus系列AI模型，跳过结构预测直接优化蛋白质功能，实现"AI定向进化"和高效酶挖掘。配套自动化检测设备可日测上百个蛋白质。成果已落地应用：如提升抗体耐碱性4倍（年省千万成本）、诊断酶活性提高3倍（助力阿尔兹海默检测）。该技术将加速生物制药等领域发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T17:03:54Z
- **目录日期**: 2025-03-24
