...
上海交通大学洪亮教授团队构建了全球最大蛋白质数据集，包含近90亿条序列，覆盖陆地、深海及病毒样本，并标注丰富功能标签。团队开发Venus系列AI模型，跳过结构预测直接优化蛋白质功能，实现"AI定向进化"和高效酶挖掘。配套自动化检测设备可日测上百个蛋白质。成果已应用于生物医药领域，如提升抗体耐碱性4倍、关键酶活性3倍，显著降低生产成本。该技术将加速蛋白质设计，推动生物制药等领域的突破性发展。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T10:03:26Z
- **目录日期**: 2025-03-24
