...
大模型正在革新兴趣推荐系统，突破传统基于标签/ID匹配的局限。YouTube使用"语义ID"解决冷启动问题；快手的M3CSR融合多模态数据捕捉用户兴趣；Meta通过知识蒸馏提升小模型性能；LinkedIn训练1500亿参数统一模型处理多任务；Netflix的UniCoRn结合搜索与推荐；华为FLIP实现文本与表格数据互通；Spotify用LLM生成探索性建议。这些系统采用知识蒸馏、LoRA等技术优化效率，使推荐更精准高效，能理解内容本质和用户深层需求，显著提升推荐质量和多样性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T14:03:30Z
- **目录日期**: 2025-03-24
