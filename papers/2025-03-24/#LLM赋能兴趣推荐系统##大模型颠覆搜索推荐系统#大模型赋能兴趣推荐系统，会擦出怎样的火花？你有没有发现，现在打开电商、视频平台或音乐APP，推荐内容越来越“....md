...
大模型正在革新兴趣推荐系统，突破传统基于标签匹配的局限。YouTube采用"语义ID"解决冷启动问题；快手的M3CSR多模态模型融合音视频理解用户偏好；Meta通过知识蒸馏提升小模型性能；LinkedIn训练1500亿参数统一处理多任务；Netflix的UniCoRn系统结合搜索与推荐场景；华为FLIP模型实现文本与结构化数据互通；Spotify利用LLM生成探索性搜索建议。这些技术配合模型压缩和优化方法，使推荐系统更智能高效，能精准捕捉用户潜在需求，实现跨场景的个性化推荐。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T17:03:18Z
- **目录日期**: 2025-03-24
