...
大语言模型(LLM)正在革新推荐系统。相比传统基于标签/关键词的推荐方式，LLM能深度理解内容语义和用户意图。YouTube采用"语义ID"解决冷启动问题；快手的M3CSR融合多模态信息；Meta通过知识蒸馏提升小模型性能；LinkedIn训练1500亿参数的统一推荐模型；Netflix的UniCoRn整合搜索与推荐；华为FLIP实现文本与结构化数据互通；Spotify结合用户行为生成探索性推荐。这些系统通过知识蒸馏、LoRA等技术优化效率，使推荐更精准、个性化且高效，显著提升用户体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T12:03:38Z
- **目录日期**: 2025-03-24
