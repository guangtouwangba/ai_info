...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、辅助阅读和科研订阅服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持AI生成摘要、智能问答和文档解析，帮助用户快速理解文献内容。平台还提供个性化科研动态推送，可按关键词、学者或机构订阅最新成果。此外，AMiner具备学者画像、学术会议追踪等功能，基础服务免费开放。访问地址：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T14:06:11Z
- **目录日期**: 2025-03-24
