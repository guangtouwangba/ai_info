...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、科研情报订阅等一站式服务。平台收录42个学科的3.5亿论文、0.6亿学者等海量数据，支持文献辅助阅读、AI摘要生成和智能问答功能。用户可通过关键词订阅最新科研动态，获取定制化学术资讯推送。AMiner还提供学者画像、学术会议追踪等特色功能，浏览器版可免费使用，旨在提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T18:05:22Z
- **目录日期**: 2025-03-24
