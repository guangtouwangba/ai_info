...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、科研情报订阅等一站式服务。它收录42个学科的3.5亿论文、0.6亿学者和1.5亿专利，支持文献辅助阅读、AI摘要生成和互动问答。用户可定制订阅最新科研动态，并通过微信或邮件接收。平台还提供学者画像、学术会议和必读论文专题等功能，浏览器检索免费使用。访问入口：https://www.aminer.cn/。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T16:06:15Z
- **目录日期**: 2025-03-24
