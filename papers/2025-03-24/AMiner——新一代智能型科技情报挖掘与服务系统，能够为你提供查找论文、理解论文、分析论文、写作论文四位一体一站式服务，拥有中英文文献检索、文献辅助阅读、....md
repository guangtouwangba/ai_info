...
AMiner是一个智能科技情报挖掘与服务系统，提供查找、理解、分析和写作论文的一站式服务。它支持中英文文献检索、翻译、辅助阅读等功能，涵盖42个学科的3.5亿论文、0.6亿学者、1.5亿专利和2600万科研项目。AMiner通过AI技术生成文献摘要、章节概要和问题建议，帮助用户快速理解文献内容。此外，它还提供科研情报订阅服务，根据用户偏好推送最新学术动态。AMiner还具备学者画像、学术会议和必读论文专题等功能，用户可通过浏览器免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T04:06:17Z
- **目录日期**: 2025-03-24
