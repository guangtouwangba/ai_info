...
本文全面回顾了多模态大语言模型（MLLMs）中的对齐算法，涵盖了应用场景、数据集构建、评估方法和未来发展方向。文章分类了现有对齐算法，分析了数据集构建的核心因素，总结了公开数据集的优缺点，并提出了评估框架。未来发展方向包括视觉信息整合、LLM对齐方法的经验启示以及MLLM作为智能体的挑战与机遇。该研究由多所知名机构的研究人员共同完成，旨在解决MLLMs在真实性、安全性和推理能力等方面的挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T08:05:02Z
- **目录日期**: 2025-03-24
