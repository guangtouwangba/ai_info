...
为了理解和预测高度自主AI系统的社会影响，需要建立具有实际基础的基准，即直接将AI性能与现实世界效果相连接的指标。本文介绍了HCAST（人类校准的自主软件任务），包含189个机器学习、网络安全、软件工程和一般推理任务的基准。通过收集563个熟练领域人员的人类基线数据（总计超过1500小时），在相同条件下与AI代理进行比较，估计HCAST任务人类完成时间从1分钟到8小时以上不等。评估前沿基础模型构建的AI代理的成功率，发现当前代理在人类完成时间少于1小时的任务上成功率70-80%，而在超过4小时的任务上成功率低于20%。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T04:01:19Z
- **目录日期**: 2025-03-24
