...
这项研究探讨了面部模仿（自动无意识模仿他人表情）在不同情绪间的差异。研究发现，"恐惧"比"快乐"引发更强的模仿反应，而"愤怒"的模仿程度低于"恐惧"。人格特质（如外向性和宜人性）与模仿程度存在显著关联。这些发现表明，特定情绪会引发更强的模仿反应，而人格特质在情绪同步中起次要作用。研究结果对情感计算应用（如远程人际互动和人机交互场景）具有启示意义，例如设计能自适应模仿用户表情的数字代理，可增强系统共情能力，提升用户体验和参与度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T11:02:04Z
- **目录日期**: 2025-03-24
