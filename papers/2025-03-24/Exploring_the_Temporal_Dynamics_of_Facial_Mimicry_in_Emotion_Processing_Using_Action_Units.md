...
该研究探讨了面部模仿（自动无意识模仿他人表情）在不同情绪间的差异。通过面部动作单元和动态时间规整分析，发现"恐惧"比"快乐"引发更强模仿，而"愤怒"模仿较弱。人格特质（外向性、宜人性）与模仿程度显著相关。结果表明特定情绪会触发不同程度的模仿反应，而人格特质起次要作用。这些发现不仅适用于人际交流，还可应用于情感计算领域，如设计能自适应模仿用户表情的数字代理，从而增强系统共情能力，提升人机交互中的情感共鸣和用户参与度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T15:01:55Z
- **目录日期**: 2025-03-24
