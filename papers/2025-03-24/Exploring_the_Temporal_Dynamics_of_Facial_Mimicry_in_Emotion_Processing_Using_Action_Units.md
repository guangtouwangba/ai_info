...
这项研究探讨了面部表情模仿在不同情绪间的差异。通过分析视频中的面部动作单元和参与者反应，发现"恐惧"比"快乐"引发更强的模仿，而"愤怒"的模仿程度低于"恐惧"。研究还显示，外向性和宜人性等人格特质与模仿程度存在显著关联。这些发现表明，特定情绪会引发不同程度的模仿反应，而人格特质则起次要作用。研究结果对情感计算应用具有启示意义，如设计能自适应模仿用户表情的数字代理，可增强系统共情能力，提升远程人际互动和人机交互中的情感共鸣与用户参与度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T21:01:40Z
- **目录日期**: 2025-03-24
