...
这项研究探讨了面部模仿（自动无意识模仿他人表情）在不同情绪间的差异。通过面部动作单元分析和动态时间规整，发现"恐惧"比"快乐"引发更强的模仿，而"愤怒"的模仿较弱。人格特质（外向性、宜人性）与模仿程度显著相关。研究揭示了特定情绪会诱发不同程度的模仿反应，而人格特质起次要调节作用。这些发现不仅对人际沟通有启示，还可应用于情感计算领域，如设计能自适应模仿用户表情的数字代理，从而增强系统共情能力和用户参与度，改善人机交互体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T10:01:45Z
- **目录日期**: 2025-03-24
