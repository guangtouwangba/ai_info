...
元戎启行CEO周光在英伟达GTC 2025上提出了一种新的自动驾驶技术路径——RoadAGI，旨在通过不依赖高精地图的AI Spark平台，赋能智能车、机器人等移动体，实现垂直道路场景下的AGI（人工通用智能）。这一创新方法有望加速自动驾驶的大规模商用，并为AI和自动驾驶领域开辟新的可能性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T01:31:57Z
- **目录日期**: 2025-03-24
