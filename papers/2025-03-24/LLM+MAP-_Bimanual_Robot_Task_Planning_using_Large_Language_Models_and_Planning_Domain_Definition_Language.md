...
本文提出LLM+MAP框架，用于解决双手机器人操作中的任务规划问题。现有方法多关注单手机器人技能，而双手机器人需要复杂的时空协调和任务分配。虽然大语言模型(LLMs)被用于机器人任务规划，但在长时程推理中仍存在错误和幻觉问题。LLM+MAP结合LLM推理与多智能体规划，通过GPT-4o实现，相比直接使用LLMs(包括GPT-4o、V3等)能生成更优的双手机器人任务计划。实验表明，该方法在规划时间、成功率等指标上表现优异，为机器人推理提供了新思路。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T18:01:47Z
- **目录日期**: 2025-03-24
