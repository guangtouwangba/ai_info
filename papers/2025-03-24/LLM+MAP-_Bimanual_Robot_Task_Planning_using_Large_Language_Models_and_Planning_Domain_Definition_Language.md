...
这篇论文提出了LLM+MAP框架，用于解决双手机器人操作中的长期任务规划问题。现有方法主要关注单手机器人技能，而双手机器人需要同时处理任务分解和分配。虽然大语言模型(LLM)具有零样本生成能力，但在复杂任务中仍存在推理错误。LLM+MAP将LLM推理与多智能体规划相结合，通过GPT-4o实现，在模拟实验中表现出色。相比直接使用LLM(GPT-4o/V3/o1/R1)，该方法在规划时间、成功率、任务步骤缩减等方面均有优势，为机器人推理提供了新思路。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T15:01:44Z
- **目录日期**: 2025-03-24
