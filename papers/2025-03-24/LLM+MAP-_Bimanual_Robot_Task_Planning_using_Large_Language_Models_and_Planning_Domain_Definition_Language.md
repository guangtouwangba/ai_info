...
这篇论文提出了LLM+MAP框架，用于解决双手机器人操作中的长时程任务规划问题。传统方法主要关注单手机器人技能，而大型语言模型(LLMs)在复杂任务中存在推理错误和幻觉问题。LLM+MAP结合了LLM推理和多智能体规划，能自动生成高效的双手机器人任务分配方案。实验使用GPT-4o作为后端，在多种复杂操作任务中与直接由LLM生成的方案(GPT-4o/V3/o1/R1)对比。结果显示LLM+MAP在规划时间、成功率、任务分组和步骤精简方面表现更优，为机器人推理提供了新思路。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T17:01:47Z
- **目录日期**: 2025-03-24
