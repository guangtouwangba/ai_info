...
本文提出LLM+MAP框架，用于解决双手机器人操作中的长期任务规划难题。该框架结合大语言模型(LLM)的推理能力和多智能体规划，克服了LLM在复杂任务中的幻觉和长期推理错误问题。相比直接使用GPT-4o等LLM生成计划，LLM+MAP在规划时间、成功率、任务步骤优化等方面表现更优。实验验证了该方法在不同复杂度长期操作任务中的有效性，为机器人推理提供了新思路。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T13:08:21Z
- **目录日期**: 2025-03-24
