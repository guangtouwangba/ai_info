...
本文提出LLM+MAP框架，用于解决双手机器人操作中的长期任务规划难题。该框架结合大型语言模型(LLM)的推理能力和多智能体规划，克服了LLM在复杂任务中的长时推理错误和幻觉问题。相比直接使用GPT-4o等LLM生成计划，LLM+MAP通过模拟实验在规划时间、成功率等指标上表现更优。研究验证了该方法在各类复杂操作任务中的有效性，为机器人推理提供了新思路。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T22:01:37Z
- **目录日期**: 2025-03-24
