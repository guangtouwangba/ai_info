...
本文介绍了LLM+MAP，一种结合大型语言模型（LLM）推理和多智能体规划的双手机器人任务规划框架，旨在解决双手机器人在长时间尺度任务规划中的挑战。通过模拟实验，LLM+MAP在规划时间、成功率、组扣分和规划步骤减少率等指标上表现出色，优于直接由LLM生成的规划。该框架使用GPT-4o作为后端，展示了其在复杂任务中的高效性和有效性，为机器人推理提供了新的见解。代码可在https://github.com/Kchu/LLM-MAP获取。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T05:01:56Z
- **目录日期**: 2025-03-24
