...
为了解决复杂现实世界任务，本文提出了面向具身多智能体系统的组合约束概念，以应对多智能体协作中的挑战。通过设计针对不同类型约束的接口，实现了与物理世界的无缝交互，并开发了自动数据收集框架。在此基础上，首次引入了具身多智能体操作基准RoboFactory，并基于该基准评估了模仿学习方法在不同难度任务中的表现。此外，研究了多智能体模仿学习的架构和训练策略，旨在构建安全高效的具身多智能体系统。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T01:29:03Z
- **目录日期**: 2025-03-24
