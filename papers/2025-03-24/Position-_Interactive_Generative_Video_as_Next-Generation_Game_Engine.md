...
传统游戏引擎面临创意受限和成本高昂的问题。视频生成模型的突破为游戏开发带来革命性可能。本文提出将交互式生成视频(IGV)作为生成式游戏引擎(GGE)的基础，通过其高质量内容生成、物理感知、用户交互、长期记忆和因果推理等优势，实现无限内容创作。研究构建了GGE的核心框架，并制定了从L0到L4的成熟度路线图，为AI时代的游戏开发指明方向，预示生成式系统将彻底改变游戏创作和体验方式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T23:00:58Z
- **目录日期**: 2025-03-24
