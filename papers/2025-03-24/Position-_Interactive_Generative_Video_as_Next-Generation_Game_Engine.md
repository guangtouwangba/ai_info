...
传统游戏引擎因预设内容限制了创意并推高成本。本文提出将交互式生成视频(IGV)作为生成式游戏引擎(GGE)的基础，利用其在高质量内容生成、物理感知建模、用户交互、长期记忆和因果推理方面的优势，实现无限新颖的游戏内容创作。研究者构建了GGE的核心框架，并制定了从L0到L4的渐进发展路线图，为AI时代的游戏开发指明新方向。这项技术有望彻底改变游戏的创作和体验方式，通过AI生成系统推动游戏产业革新。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T17:01:11Z
- **目录日期**: 2025-03-24
