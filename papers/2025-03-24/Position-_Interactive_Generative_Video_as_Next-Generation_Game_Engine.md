...
现代游戏开发面临创意和成本挑战，传统游戏引擎的内容预定性限制了创新。视频生成模型的突破为游戏创作带来新机遇。本文提出交互生成视频（IGV）作为生成游戏引擎（GGE）的基础，推动下一代游戏无限内容生成。GGE利用IGV在高质量内容合成、物理感知世界建模、用户控制交互、长期记忆和因果推理方面的优势。我们提出GGE的核心模块框架和分层成熟路线图（L0-L4），为AI时代的游戏开发指明方向，展望AI生成系统彻底改变游戏创作与体验的未来。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T03:14:30Z
- **目录日期**: 2025-03-24
