...
传统游戏引擎因预设内容面临创意与成本挑战。视频生成模型的突破为游戏开发带来革新机遇。本文提出将交互式生成视频(IGV)作为生成式游戏引擎(GGE)的基础，实现无限内容生成。GGE具备高质量内容合成、物理感知、用户交互、长期记忆和因果推理等优势。研究制定了包含核心模块的完整框架和五级成熟度路线图(L0-L4)，为AI时代的游戏开发指明方向，展望由AI生成系统重塑游戏创作与体验的未来。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T21:01:00Z
- **目录日期**: 2025-03-24
