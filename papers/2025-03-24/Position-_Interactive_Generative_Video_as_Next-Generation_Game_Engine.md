...
传统游戏引擎因预设内容面临创意和成本挑战。基于视频生成模型的最新突破，本文提出交互式生成视频(IGV)作为生成式游戏引擎(GGE)的基础，通过无限高质量内容生成、物理感知建模、用户交互控制、长期记忆和因果推理等能力革新游戏开发。研究构建了GGE的核心框架，并制定了从L0到L4的成熟度路线图，为AI时代的游戏开发指明新方向，展望由生成式系统重塑游戏创作与体验的未来。该技术有望突破传统内容限制，实现动态生成的全新游戏范式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T14:01:06Z
- **目录日期**: 2025-03-24
