...
传统游戏引擎因预设内容面临创意与成本挑战。视频生成模型的最新突破为游戏开发带来革新机遇。本文提出将交互式生成视频(IGV)作为生成式游戏引擎(GGE)的基础，通过其五大优势(高质量内容生成、物理感知建模、用户交互控制、长期记忆和因果推理)实现无限内容创作。研究构建了GGE的核心框架，并制定了从L0到L4的成熟度路线图，为AI时代的游戏开发指明方向，预示生成式系统将彻底改变游戏的创作与体验方式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T18:01:12Z
- **目录日期**: 2025-03-24
