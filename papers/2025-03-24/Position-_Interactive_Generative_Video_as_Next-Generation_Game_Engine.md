...
传统游戏引擎因预设内容限制面临创意和成本挑战。本文提出将交互式生成视频（IGV）作为生成式游戏引擎（GGE）的基础，利用其在高质量内容合成、物理感知建模、用户交互控制、长期记忆和因果推理方面的优势，实现无限内容生成。研究构建了GGE的核心框架，并制定了从L0到L4的成熟度路线图，为AI时代的游戏开发指明新方向，展望由AI生成系统彻底改变游戏创作与体验的未来。这一创新方案有望突破传统游戏开发的局限性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-24T12:01:19Z
- **目录日期**: 2025-03-24
