...
本文研究了自动驾驶系统（ADS）中基于深度学习的感知模型对抗攻击的脆弱性，以Comma.ai的OpenPilot和YOLO模型为例，系统评估了对抗扰动的影响及防御方法（如对抗训练、图像处理、对比学习和扩散模型）。实验揭示了这些方法在抵御复杂攻击时的优势与局限，旨在深入理解ADS感知系统的漏洞，并为开发更鲁棒的防御策略提供指导。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T23:02:05Z
- **目录日期**: 2025-05-26
