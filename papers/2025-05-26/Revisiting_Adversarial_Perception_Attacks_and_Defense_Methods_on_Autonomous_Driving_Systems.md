...
本文研究了自动驾驶系统（ADS）中基于深度学习的感知模型面临的对抗攻击问题，以OpenPilot和YOLO模型为例，系统评估了对抗扰动对路标识别和前方物体检测的影响。研究测试了对抗训练、图像处理、对比学习和扩散模型等防御方法的有效性，揭示了这些技术在应对复杂攻击时的优势与局限。通过针对性评估模型鲁棒性，研究旨在深入理解ADS感知系统的脆弱性，并为开发更稳健的防御策略提供指导。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T18:02:05Z
- **目录日期**: 2025-05-26
