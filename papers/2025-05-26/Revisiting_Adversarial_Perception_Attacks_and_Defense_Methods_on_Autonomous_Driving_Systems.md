...
本文研究了自动驾驶系统（ADS）中基于深度学习的感知模型对抗攻击的脆弱性及其防御方法。以Comma.ai的OpenPilot（L2级ADS）和YOLO模型为例，作者系统评估了对抗扰动对路标识别和前方物体检测/预测的影响，并测试了对抗训练、图像处理、对比学习和扩散模型等防御技术的效果。实验揭示了这些方法在抵御复杂攻击时的优势与局限，旨在深入分析ADS感知系统的安全漏洞，并为开发更鲁棒的防御策略提供指导。研究聚焦于提升自动驾驶系统在对抗环境下的可靠性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T05:02:23Z
- **目录日期**: 2025-05-26
