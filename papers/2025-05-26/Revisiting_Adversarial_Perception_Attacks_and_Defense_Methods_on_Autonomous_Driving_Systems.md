...
本文研究了自动驾驶系统（ADS）中基于深度学习的感知模型面临的对抗攻击问题，重点分析了路标识别和前方物体检测（如相对距离）的脆弱性。通过使用Comma.ai的OpenPilot（L2级量产ADS）和YOLO模型，系统评估了对抗扰动的影响，并测试了对抗训练、图像处理、对比学习和扩散模型等防御方法的有效性。实验揭示了这些方法在应对复杂攻击时的优势与局限。研究旨在深入理解ADS感知系统的安全弱点，并为开发更鲁棒的防御策略提供指导。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T08:03:37Z
- **目录日期**: 2025-05-26
