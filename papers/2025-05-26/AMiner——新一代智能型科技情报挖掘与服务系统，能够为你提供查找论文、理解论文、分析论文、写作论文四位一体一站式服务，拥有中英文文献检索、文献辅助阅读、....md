...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献搜索、AI辅助阅读、自动摘要生成和翻译功能，涵盖3.5亿论文、0.6亿学者等海量数据。用户可通过互动问答快速理解文献，或订阅个性化科研动态推送。平台还支持PDF上传、章节概要提取及学术对话功能，帮助高效获取研究信息。基础功能免费开放，适合学者、学生等科研人群使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T02:35:39Z
- **目录日期**: 2025-05-26
