...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读辅助、翻译和科研订阅等一站式服务。它支持中英文文献搜索，能自动生成摘要并解答文献相关问题，帮助用户高效筛选和理解学术内容。平台还具备文档识别、章节概要和个性化科研动态推送功能，覆盖42个学科的3.5亿论文和1.5亿专利。用户可通过浏览器免费使用，并定制关注学者或关键词的最新研究进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T17:06:05Z
- **目录日期**: 2025-05-26
