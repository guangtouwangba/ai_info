...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献检索，能快速定位相关论文，并通过AI生成摘要和问答互动帮助理解内容。平台还具备文献翻译、文档识别和辅助阅读功能，用户可上传PDF或从数据库获取论文。此外，AMiner提供科研情报订阅服务，根据用户偏好推送最新学术动态。其数据库涵盖42个学科，包含3.5亿论文、0.6亿学者和1.5亿专利等资源，支持免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T05:06:03Z
- **目录日期**: 2025-05-26
