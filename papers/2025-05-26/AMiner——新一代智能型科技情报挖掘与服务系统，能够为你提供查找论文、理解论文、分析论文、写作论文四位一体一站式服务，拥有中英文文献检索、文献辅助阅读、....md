...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、辅助阅读、翻译和科研情报订阅。它拥有42个学科的3.5亿论文、0.6亿学者和1.5亿专利数据，支持互动式问答、自动摘要生成和文档识别。用户可订阅个性化科研动态，追踪机构、学者和关键词的最新研究。此外，AMiner还提供学者画像、学术会议专题和论文排行榜等功能。平台免费使用，可通过网页或微信小程序访问，帮助用户高效获取和理解学术信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T12:06:03Z
- **目录日期**: 2025-05-26
