...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和科研订阅等一站式服务。它收录了3.5亿论文、0.6亿学者和1.5亿专利，支持中英文文献检索，并能自动生成摘要和问答互动。用户可上传PDF文档获取AI辅助阅读，还能定制科研动态推送。平台还包含学者画像、学术会议和论文排行榜等功能，大部分服务可免费使用。网址：https://www.aminer.cn/。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T00:05:29Z
- **目录日期**: 2025-05-26
