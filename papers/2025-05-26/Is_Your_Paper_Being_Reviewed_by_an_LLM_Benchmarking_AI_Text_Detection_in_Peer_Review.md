...
这篇论文探讨了同行评审过程中使用大语言模型(LLM)生成评审内容的风险。研究团队构建了一个包含788,984条AI生成和人工撰写评审意见的数据集，涵盖ICLR和NeurIPS两个顶级AI会议8年的投稿论文。通过评估18种现有AI文本检测算法，发现很难准确识别单个评审是否由AI生成。研究还提出了一种基于稿件内容的检测方法Anchor，并分析了检测模型对LLM修改人工文本的敏感性。结果表明当前迫切需要开发新工具来检测这种不道德使用生成式AI的行为。数据集已公开供研究使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T03:22:55Z
- **目录日期**: 2025-05-26
