...
这篇论文探讨了AI生成文本对学术同行评审的潜在威胁。研究者构建了一个包含788,984条AI撰写评审意见的数据集，覆盖ICLR和NeurIPS两大AI会议8年来的投稿论文。通过评估18种现有AI文本检测算法，研究发现目前方法难以可靠识别AI生成的评审意见。论文还提出了一种基于稿件内容的检测方法Anchor，并分析了模型对人类修改AI文本的敏感性。研究揭示了在单个评审层面检测AI文本的困难，强调需要开发新工具来应对生成式AI在学术评审中的不当使用。相关数据集已公开。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T14:02:31Z
- **目录日期**: 2025-05-26
