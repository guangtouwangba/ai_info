...
这篇论文研究了AI生成文本对同行评审过程的潜在威胁。研究者创建了一个包含788,984条AI撰写与人工撰写评审意见对比的数据集，涵盖ICLR和NeurIPS两大AI会议8年来的投稿论文。通过评估18种现有AI文本检测算法，发现很难准确识别AI生成的评审意见。研究还探索了一种基于稿件内容的检测方法Anchor，并分析了检测模型对AI修改人工文本的敏感性。结果表明，在单个评审层面识别AI生成文本具有挑战性，亟需开发新工具来检测这种不道德使用生成式AI的行为。数据集已公开。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T05:02:33Z
- **目录日期**: 2025-05-26
