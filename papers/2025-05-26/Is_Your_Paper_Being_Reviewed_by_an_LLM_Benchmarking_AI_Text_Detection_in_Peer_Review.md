...
同行评审是确保科研诚信的关键环节，但随着大语言模型（LLMs）的发展，存在评审人可能依赖AI撰写耗时评审的新风险。为解决缺乏AI生成评审文本检测基准的问题，研究者构建了包含788,984条AI与人类评审对比的数据集，涵盖ICLR和NeurIPS会议8年的论文。通过评估18种现有AI文本检测算法，发现现有方法难以可靠识别单个AI生成的评审，尤其当人类文本经LLM修改后。研究强调亟需开发新工具来检测这种不道德行为，相关数据集已公开。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T20:02:24Z
- **目录日期**: 2025-05-26
