...
这篇论文指出，随着大型语言模型(LLMs)的发展，存在审稿人可能依赖AI撰写耗时评审的风险。研究团队创建了一个包含788,984条AI撰写与人工评审对比的数据集，涵盖ICLR和NeurIPS会议8年的论文。他们评估了18种AI文本检测算法，并开发了基于论文内容的Anchor检测方法。结果显示，在单个评审层面识别AI生成文本具有挑战性，亟需新工具来检测这种不道德行为。数据集已公开，以促进相关研究发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T04:05:29Z
- **目录日期**: 2025-05-26
