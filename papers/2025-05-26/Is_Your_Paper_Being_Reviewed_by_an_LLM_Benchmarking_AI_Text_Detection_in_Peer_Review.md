...
这篇论文探讨了人工智能生成文本对同行评审过程的潜在威胁。研究者创建了一个包含788,984条AI撰写和人类撰写的同行评审的数据集，涵盖ICLR和NeurIPS两大AI会议8年的投稿论文。通过评估18种现有AI文本检测算法，研究发现目前方法难以可靠识别AI生成的评审内容。论文还提出了一种基于稿件内容的"Anchor"检测方法，并分析了模型对AI修改人类文本的敏感性。研究揭示了在单个评审层面检测AI文本的困难，强调需要开发新工具来应对生成式AI的不当使用。数据集已公开。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T21:02:08Z
- **目录日期**: 2025-05-26
