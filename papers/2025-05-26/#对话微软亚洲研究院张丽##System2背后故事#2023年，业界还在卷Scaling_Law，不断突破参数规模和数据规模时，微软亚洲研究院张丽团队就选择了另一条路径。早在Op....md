...
微软亚洲研究院张丽团队在2023年选择了一条不同于主流Scaling Law的路径，率先将认知科学中的"System2"概念引入大模型领域，探索深度推理能力。她们通过蒙特卡洛搜索算法，使7B参数模型达到了OpenAI o1级别的数学推理水平，其研究成果rStar-Math引发广泛讨论。这一工作在强化学习主导的背景下，为突破大模型智商上限提供了新思路。张丽作为首席研究员，还领导了微软LongRoPE等项目，其创新方法正在推动大模型推理能力的发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T00:02:57Z
- **目录日期**: 2025-05-26
