...
微软亚洲研究院张丽团队在2023年选择了一条不同于主流Scaling Law的路径，率先将认知科学中的"System2"概念引入大模型领域，探索深度推理能力。她们通过蒙特卡洛搜索算法让7B参数模型达到了类似OpenAI o1的数学推理水平，其研究成果rStar-Math引发了广泛讨论。这一工作突破了当前基于PPO/GRPO强化学习的主流路线，为大模型智商上限的提升提供了新思路。作为微软LongRoPE和rStar系列项目负责人，张丽的研究开辟了大模型发展的新可能性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T04:06:32Z
- **目录日期**: 2025-05-26
