...
这篇立场论文主张，负责任人工智能（RAI）指标间的理论不一致性（如公平性定义的差异或准确性与隐私的权衡）应被视为优势而非缺陷。作者提出，将这些指标作为不同目标处理能带来三大益处：(1) 保持多元道德立场（规范性多元主义）；(2) 通过冲突指标更全面捕捉伦理概念（认识论完整性）；(3) 联合优化冲突目标可防止过拟合，增强模型泛化能力（隐式正则化）。相反，强行统一指标会削弱价值多样性。论文呼吁RAI实践应转向界定可接受的不一致性阈值，而非追求理论一致性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T03:21:50Z
- **目录日期**: 2025-05-26
