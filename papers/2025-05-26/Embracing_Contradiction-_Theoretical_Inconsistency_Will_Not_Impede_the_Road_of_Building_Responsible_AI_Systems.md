...
这篇立场论文认为，负责任人工智能（RAI）指标间的理论不一致性（如公平性定义的差异或准确性与隐私的权衡）应被视为优势而非缺陷。作者提出，通过将指标视为多元目标，这种不一致性可带来三大益处：(1) 保持道德立场和利益相关者价值的多样性；(2) 更全面地捕捉多维度伦理概念；(3) 通过多目标优化避免过拟合，增强模型泛化能力。相反，强行统一指标会削弱价值多样性、简化伦理深度并降低模型性能。因此，研究呼吁RAI领域应转向界定可接受的不一致性阈值，而非追求理论一致性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T04:04:23Z
- **目录日期**: 2025-05-26
