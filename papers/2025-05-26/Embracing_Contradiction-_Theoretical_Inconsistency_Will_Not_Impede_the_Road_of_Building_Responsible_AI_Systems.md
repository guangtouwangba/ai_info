...
这篇立场论文主张，负责任人工智能（RAI）指标间的理论不一致性（如公平性定义的差异或准确性与隐私的权衡）应被视为优势而非缺陷。作者提出，通过将指标视为多元目标来处理这些矛盾能带来三大益处：(1) **规范多元性**：保留相互矛盾的指标可体现RAI中多样的道德立场和利益相关者价值；(2) **认知完整性**：冲突指标能更全面地捕捉复杂伦理概念；(3) **隐性正则化**：优化冲突目标可防止过拟合，提升模型泛化能力。相反，强行统一指标会削弱价值多样性、简化伦理深度并损害模型性能。作者呼吁RAI实践应聚焦界定可接受的不一致性阈值，而非消除矛盾。  
