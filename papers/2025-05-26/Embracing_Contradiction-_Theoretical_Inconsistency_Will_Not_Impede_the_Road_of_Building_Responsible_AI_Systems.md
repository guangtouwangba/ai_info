...
这篇立场论文主张，负责任人工智能（RAI）指标间的理论不一致性（如公平性定义的差异或准确性与隐私的权衡）应被视为优势而非缺陷。作者提出，通过将指标视为多元目标来处理这些矛盾，可带来三大益处：(1) 保持道德立场和利益相关者价值的多样性；(2) 通过多维度指标更完整地捕捉复杂伦理概念；(3) 联合优化冲突目标可避免过拟合，提升模型泛化能力。相反，强行统一指标会削弱价值多样性、简化伦理深度并损害模型性能。论文呼吁RAI实践应转向界定可接受的不一致性阈值，而非追求理论一致性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T17:01:17Z
- **目录日期**: 2025-05-26
