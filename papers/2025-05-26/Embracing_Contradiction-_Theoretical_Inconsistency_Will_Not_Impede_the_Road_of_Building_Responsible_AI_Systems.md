...
这篇立场论文主张，负责任人工智能（RAI）指标间的理论不一致性（如公平性定义的差异或准确性与隐私的权衡）应被视为优势而非缺陷。作者提出，通过将指标视为不同目标来协调这些矛盾可带来三大益处：(1) 保持多元价值立场；(2) 更完整捕捉复杂的伦理概念；(3) 防止模型对单一指标的过拟合，提升泛化能力。相反，强行统一指标会削弱价值多样性、简化伦理深度并损害模型性能。因此建议RAI领域应转向界定可接受的不一致阈值，而非追求理论一致性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T06:01:21Z
- **目录日期**: 2025-05-26
