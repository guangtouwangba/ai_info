...
这篇立场论文主张，负责任人工智能（RAI）指标间的理论不一致性（如公平性定义的差异或准确性与隐私的权衡）应被视为优势而非缺陷。作者提出，将这些指标视为多元目标可带来三大益处：(1) **规范多元性**：保留矛盾指标能体现RAI中多样的道德立场与利益相关者价值；(2) **认知完整性**：冲突指标能更全面捕捉复杂伦理概念，避免单一简化定义的局限；(3) **隐式正则化**：优化冲突目标可防止过拟合，提升模型泛化性与鲁棒性。论文呼吁RAI实践应接纳不一致性，界定可接受阈值，而非强行统一。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T23:01:17Z
- **目录日期**: 2025-05-26
