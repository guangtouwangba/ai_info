...
这篇立场论文认为，负责任人工智能（RAI）指标间的理论不一致性（如公平性定义的差异或准确性与隐私的权衡）应被视为优势而非缺陷。作者提出，通过将指标视为多元目标，这种不一致性可带来三大益处：(1) **规范多元性**：保留矛盾的指标能体现RAI中多样的道德立场和利益相关者价值；(2) **认识完整性**：冲突指标能更全面捕捉复杂的伦理概念；(3) **隐式正则化**：优化冲突目标可防止过拟合，提升模型泛化能力。相反，强行统一指标会削弱价值多样性、简化伦理深度并损害模型性能。建议RAI实践应聚焦界定可接受的不一致性阈值，而非追求理论一致性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T07:01:20Z
- **目录日期**: 2025-05-26
