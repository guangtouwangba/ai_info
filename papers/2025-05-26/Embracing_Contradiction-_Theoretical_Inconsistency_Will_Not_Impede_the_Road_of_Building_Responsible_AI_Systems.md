...
这篇立场论文认为，负责任人工智能（RAI）指标间的理论不一致性（如公平性定义差异或准确性与隐私的权衡）应被视为优势而非缺陷。作者提出，将这些矛盾指标视为多元目标可带来三大益处：(1) 规范多元性：保留相互矛盾的指标能体现RAI涉及的多元道德立场；(2) 认知完整性：冲突指标能更全面捕捉复杂伦理概念；(3) 隐式正则化：多目标优化可防止模型过拟合，增强泛化能力。相反，强行统一指标会削弱价值多样性。论文主张RAI实践应转向界定可接受的不一致阈值，而非消除矛盾。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T12:01:26Z
- **目录日期**: 2025-05-26
