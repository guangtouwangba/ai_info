...
这篇指南为LLM新手提供了系统化的入门框架，主要涵盖：1）智能体的三大核心组件（模型、指令/编排、工具集）；2）大/小语言模型的特点；3）指令编排的三层架构（指令设定、记忆机制、推理规划）；4）工具调用与RAG技术；5）三种性能增强方法（上下文学习、检索学习、微调学习）；6）LangChain框架的三大功能模块。全文通过结构化知识体系帮助初学者快速建立LLM基础概念认知，并附示意图辅助理解关键流程。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T12:03:44Z
- **目录日期**: 2025-05-26
