...
研究人员提出"Frankentexts"——一种由大语言模型（LLM）在90%内容必须直接复制人类文本的极端约束下生成的新型长文本。该方法要求模型在整合不同文本片段的同时保持叙述连贯性。实验显示，Gemini-2.5-Pro生成的文本81%保持连贯，100%符合提示要求，其中59%被检测器误判为人类创作。人类可通过语气突变和语法不一致识别这类文本。该研究不仅提出了新的生成挑战，还为构建AI-人类混合创作检测器提供了训练数据，并为人机协作写作研究搭建了实验平台，揭示了当前AI检测器的局限性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T13:09:42Z
- **目录日期**: 2025-05-26
