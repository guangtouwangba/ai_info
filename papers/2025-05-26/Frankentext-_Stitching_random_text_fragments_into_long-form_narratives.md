...
研究人员提出"Frankentexts"——一种由大语言模型生成的长篇叙事文本，其90%内容需直接复制人类文本。该任务要求模型在严格限制下保持文本连贯性。实验显示，Gemini-2.5-Pro表现优异：81%的生成文本连贯且100%符合提示要求，59%被检测器误判为人类创作。人类可通过语气突变和语法不一致识别这类文本。该研究不仅提出了新的生成挑战，还为AI-人类混合创作检测提供了训练数据，并探讨了如何检测这种新型"灰色地带"文本，为研究人机协作写作提供了实验平台。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T18:01:43Z
- **目录日期**: 2025-05-26
