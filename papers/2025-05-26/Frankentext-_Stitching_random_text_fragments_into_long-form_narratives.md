...
研究人员提出"Frankentexts"——一种由大语言模型生成的长篇叙事文本，其90%内容需直接复制人类文本。该任务要求模型在严格限制下保持文本连贯性，并通过迭代修订满足复制比例要求。评估显示，Gemini-2.5-Pro生成的文本81%保持连贯，100%符合提示要求，其中59%被检测器误判为人类创作。人类可通过语气突变和语法不一致识别这类文本。该研究不仅提出了新的生成挑战，还为混合创作检测提供了训练数据，并为人机协作写作研究搭建了实验平台，同时揭示了现有AI检测器的局限性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T07:01:58Z
- **目录日期**: 2025-05-26
