...
研究人员提出"Frankentexts"——一种由大语言模型在90%内容必须直接复制人类文本的极端限制下生成长篇叙事的新方法。该方法要求模型整合不同文本片段并保持连贯性，首先生成草稿再迭代修改。评估显示，Gemini-2.5-Pro表现优异：81%的文本连贯且100%符合提示要求，59%的输出被误判为人类创作。人类可通过语气突变和语法不一致识别这类文本。Frankentexts不仅挑战可控生成能力，还为研究人机协作写作、开发新型文本检测器提供了测试平台，揭示了当前AI检测工具的局限性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T11:01:53Z
- **目录日期**: 2025-05-26
