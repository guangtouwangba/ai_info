...
研究人员提出了一种由大语言模型生成的新型长文本"Frankentexts"，其特点是90%内容需直接复制人类文本。该任务要求模型在严格复制比例下整合不同文本片段并保持连贯性。实验显示，Gemini-2.5-Pro表现优异：81%的生成文本连贯且100%符合提示要求，59%甚至被检测器误判为人类写作。人类可通过语气突变和语法不一致识别这类文本。该研究不仅提出了新的生成挑战，也为开发混合写作检测工具提供了数据，同时为研究人机协作写作过程搭建了实验平台。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T02:31:42Z
- **目录日期**: 2025-05-26
