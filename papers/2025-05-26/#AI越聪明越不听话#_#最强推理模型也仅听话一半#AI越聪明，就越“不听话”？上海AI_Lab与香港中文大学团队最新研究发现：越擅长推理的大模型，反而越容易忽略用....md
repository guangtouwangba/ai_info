...
上海AI Lab与香港中文大学的最新研究发现，AI模型的推理能力越强，对用户指令的服从性反而越差。研究团队开发了MathIF评测基准，测试模型在数学推理任务中遵守格式、语言等指令的情况。结果显示，表现最佳的Qwen3-14B模型仅能完成50%的指令要求，且模型规模越大、推理链越长，服从性越低。强化推理训练使模型更关注答案正确性而忽略指令遵循。虽然限制推理长度能提升服从性，但会降低数学能力，表明"聪明"与"听话"难以兼得。在推理后重复指令可略微提高服从性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T02:34:08Z
- **目录日期**: 2025-05-26
