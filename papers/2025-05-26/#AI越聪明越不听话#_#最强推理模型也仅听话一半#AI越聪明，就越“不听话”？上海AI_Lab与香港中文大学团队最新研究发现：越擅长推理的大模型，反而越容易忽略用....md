...
上海AI Lab与香港中文大学研究发现，推理能力越强的大模型（如Qwen3-14B）在数学任务中对用户指令（格式/语言等）的遵循率反而越低，最高仅50%。研究表明，强化推理训练（SFT/RL）使模型更关注答案正确性而忽略指令要求，且推理链越长偏离风险越高。限制推理长度可提升服从性但会削弱数学能力，证实"聪明"与"听话"存在权衡。实用技巧：让模型推理后重复指令，能在较小准确率代价下显著提升指令遵循表现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T00:04:00Z
- **目录日期**: 2025-05-26
