...
本文概述了基于马尔可夫随机动力学的蒙特卡洛算法在非平衡态多粒子相互作用与反应系统研究中的应用。这类基于代理的计算机模拟是本科生和研究生接触前沿研究的有效工具，无需过多先验知识。通过直接可视化模拟数据，学生可直观理解复杂系统的宏观特征，并运用数据分析方法定量研究其稳态和瞬态动力学特性。文章以典型的反应扩散系统、种群动力学和流行病传播模型为例，展示了“边做边学”的跨学科计算研究教育方法。此外，还提供了蒙特卡洛算法实现技巧、示例代码、常见数据分析工具，以及错误排查建议。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T15:01:05Z
- **目录日期**: 2025-05-26
