...
本文概述了基于马尔可夫随机动力学的蒙特卡洛算法在非平衡态多粒子相互作用与反应系统研究中的应用。这类基于代理的计算机模拟是一种有效工具，适合本科生和研究生通过"做中学"接触前沿研究，无需过多先验知识。通过可视化模拟数据，学生可直观理解复杂系统的宏观特征，并应用数据分析定量表征其动态特性（稳态和瞬态）。研究以反应扩散系统、种群动力学和流行病传播等经典模型为例，展示了跨学科计算研究的教学价值。文中还提供了算法实现建议、示例代码、典型分析工具及常见错误的规避技巧。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T20:01:14Z
- **目录日期**: 2025-05-26
