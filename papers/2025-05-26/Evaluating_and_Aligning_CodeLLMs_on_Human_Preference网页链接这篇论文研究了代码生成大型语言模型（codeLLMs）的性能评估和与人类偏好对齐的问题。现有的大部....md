...
这篇论文针对代码生成大模型(codeLLMs)提出新评估框架CodeArena，通过397个涵盖40类编程任务的人类精选样本，评估模型输出与人类偏好的匹配度。研究发现传统基于执行的测试与人类偏好存在显著差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI)性能差距明显。同时构建了20B标记的合成指令数据集SynCode-Instruct验证微调效果。研究强调了在代码生成任务中，除正确性外，与人类偏好对齐的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T21:05:32Z
- **目录日期**: 2025-05-26
