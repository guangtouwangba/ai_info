...
这篇论文提出了CodeArena基准测试和SynCode-Instruct语料库，用于评估代码生成大模型(CodeLLMs)与人类偏好的对齐程度。研究发现现有基准过于关注代码正确性而忽视实际偏好，通过涵盖40类编程任务和44种语言的397个样本，揭示了执行基准与人类评估的差异。实验对比40多个模型显示，开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI)存在显著差距，验证了大规模合成指令微调的有效性，突显了模型对齐人类偏好的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T18:05:46Z
- **目录日期**: 2025-05-26
