...
这篇论文针对代码生成大模型(codeLLMs)提出新评估框架，重点解决现有基准忽略人类偏好的问题。研究团队构建了CodeArena基准(包含397个高质量样本，覆盖40类任务和44种语言)和SynCode-Instruct语料库(近200亿标记)，通过实验发现：1)传统执行基准与人类偏好评估存在差异；2)开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI)性能差距显著。研究强调了代码生成模型与人类偏好对齐的重要性，为提升模型实用价值提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T03:26:35Z
- **目录日期**: 2025-05-26
