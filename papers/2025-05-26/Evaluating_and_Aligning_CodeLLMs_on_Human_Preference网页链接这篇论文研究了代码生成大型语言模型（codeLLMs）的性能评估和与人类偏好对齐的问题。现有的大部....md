...
这篇论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，弥补现有评估忽视人类偏好的不足。该基准包含397个高质量样本，覆盖40类编程任务和44种语言。研究还构建了20B标记的合成指令数据集SynCode-Instruct验证微调效果。实验发现执行基准与人类偏好评估存在差距，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著，凸显对齐人类偏好的重要性。研究为提升代码LLMs的实际应用价值提供了新评估框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T08:07:45Z
- **目录日期**: 2025-05-26
