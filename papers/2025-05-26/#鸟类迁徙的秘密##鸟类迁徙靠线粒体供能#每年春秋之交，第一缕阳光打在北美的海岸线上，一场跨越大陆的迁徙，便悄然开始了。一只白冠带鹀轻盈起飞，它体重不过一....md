...
研究发现鸟类迁徙的超强耐力源于线粒体的季节性改造：在光照刺激下，其飞行肌肉中的线粒体会发生三大变化——数量激增、相互融合成高效网络、氧气利用率显著提升。同时，鸟类通过摄入高抗氧化食物（如富含维生素E的果实）来抵御线粒体产能时产生的自由基损伤。科学家通过实验室模拟和野外追踪（"MitoMobile"移动实验室）验证了这一机制，并探讨其对人类健康（如抗衰老、运动表现）的潜在启示。该研究揭示了能量代谢调控对生命极限活动的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T19:02:43Z
- **目录日期**: 2025-05-26
