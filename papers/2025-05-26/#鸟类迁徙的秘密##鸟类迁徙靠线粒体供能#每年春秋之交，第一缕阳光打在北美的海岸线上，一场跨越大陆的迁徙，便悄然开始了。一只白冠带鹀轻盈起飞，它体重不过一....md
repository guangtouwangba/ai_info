...
研究发现鸟类长途迁徙的关键在于线粒体的适应性改造。迁徙季节前，鸟类飞行肌肉中的线粒体会发生显著变化：数量增加、相互融合形成高效网络、氧气利用率提升，为持续飞行提供充足能量。同时，鸟类会主动摄入高抗氧化食物（如富含维生素E的果实）来抵御线粒体产能时产生的有害自由基。科学家通过人工光照实验和野外数据验证了这一机制，并认为该发现对人类健康研究具有潜在启示意义，可能为改善代谢、延缓衰老提供新思路。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T14:03:10Z
- **目录日期**: 2025-05-26
