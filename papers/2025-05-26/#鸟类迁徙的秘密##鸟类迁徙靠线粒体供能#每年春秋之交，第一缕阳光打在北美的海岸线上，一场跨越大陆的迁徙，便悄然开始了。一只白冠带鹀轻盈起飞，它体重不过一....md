...
研究发现鸟类迁徙的超强耐力源于线粒体的特殊适应性变化：在迁徙季节，鸟类飞行肌肉中的线粒体数量激增、相互融合形成高效网络，氧气利用率显著提升。同时，它们通过摄入高抗氧化食物形成保护机制，抵御能量代谢产生的自由基损伤。科学家通过实验室光照模拟和野外追踪（"MitoMobile"移动实验室）验证了这一机制，并探讨了其在人类健康领域的潜在应用价值。这项研究揭示了细胞能量工厂如何支撑鸟类完成数千公里的极限迁徙。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T11:02:59Z
- **目录日期**: 2025-05-26
