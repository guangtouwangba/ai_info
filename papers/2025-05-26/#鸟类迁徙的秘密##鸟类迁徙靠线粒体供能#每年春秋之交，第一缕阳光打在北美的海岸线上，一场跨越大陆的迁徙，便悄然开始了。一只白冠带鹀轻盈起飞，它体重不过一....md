...
研究发现鸟类迁徙的惊人耐力源于线粒体的适应性改造。在迁徙季节，鸟类飞行肌肉中的线粒体会发生三大变化：数量激增、相互融合成高效网络、氧气利用率显著提升。这些改造由光照变化触发，使鸟类无需训练就能获得超强供能能力。同时，鸟类通过摄入高抗氧化食物来抵御线粒体产生活性氧的副作用。该机制对人类健康研究具有启示意义，可能为改善代谢、延缓衰老提供新思路。线粒体的这种可塑性展现了生命适应极端环境的惊人潜能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T10:06:59Z
- **目录日期**: 2025-05-26
