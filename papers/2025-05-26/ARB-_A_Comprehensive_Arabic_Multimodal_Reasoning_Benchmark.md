...
阿拉伯语多模态推理基准(ARB)是首个针对阿拉伯语多模态逐步推理能力的评估标准，涵盖视觉推理、文档理解、OCR等11个领域，包含1,356个样本和5,119个人工标注的推理步骤。研究团队评估了12个前沿大模型，发现其在连贯性、忠实度和文化适应性方面仍存在挑战。ARB为评估非主流语言的多模态推理提供了结构化框架，推动了更具包容性、透明性和文化敏感性的AI系统发展。该基准及其评估工具已开源，旨在支持相关研究的可重复性。论文代码发布于GitHub平台。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T01:28:42Z
- **目录日期**: 2025-05-26
