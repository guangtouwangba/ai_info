...
北航刘偲教授团队开发出语言控制无人机的新框架"Flying-on-a-Word(Flow)"，通过自然语言指令直接操控无人机飞行。该技术整合语言指令、六自由度状态和第一视角视觉三种输入，采用模仿学习方法学习人类飞行员操作策略。团队构建了覆盖5.02平方公里的大规模真实数据集和仿真测试环境，并开发了地面站-无人机协作策略解决机载计算限制问题。研究成果已实现真机部署，首次通过自然语言实时控制无人机完成任务，标志着人机交互方式的重大突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T14:03:59Z
- **目录日期**: 2025-05-26
