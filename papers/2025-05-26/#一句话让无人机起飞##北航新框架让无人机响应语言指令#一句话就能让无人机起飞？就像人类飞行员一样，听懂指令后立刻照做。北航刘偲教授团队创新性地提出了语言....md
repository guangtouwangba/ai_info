...
北航刘偲教授团队提出"Flying-on-a-Word"(Flow)创新框架，实现无人机通过自然语言指令执行精细飞行控制。该框架整合语言指令、六自由度状态和第一视角视觉，采用模仿学习方法训练无人机模仿人类操作。团队构建了覆盖5.02平方公里的真实数据集和仿真测试环境，并开发了地面站-无人机协作策略解决机载计算限制。基于Pi-0-UAV模型的真机测试成功实现语言实时控制，标志着无人机交互方式的重大突破。研究成果为智能无人系统的人机交互提供了新范式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T23:03:24Z
- **目录日期**: 2025-05-26
