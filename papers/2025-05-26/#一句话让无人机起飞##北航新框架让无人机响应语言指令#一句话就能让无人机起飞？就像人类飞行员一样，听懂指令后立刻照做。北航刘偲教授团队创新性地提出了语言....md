...
北航刘偲教授团队提出"Flying-on-a-Word"(Flow)创新框架，实现无人机通过自然语言指令执行精细飞行控制。该框架整合语言指令、六自由度状态和第一视角视觉，采用模仿学习方法学习人类飞行员操作策略。团队构建了覆盖5.02平方公里的大规模真实数据集，并开发UAV-Flow-Sim仿真平台进行评估。针对机载计算限制，提出地面站-无人机协作策略和前瞻轨迹对齐算法。最终部署的Pi-0-UAV系统成功实现语言实时控制无人机，标志着人机交互的新突破。相关成果已通过真机测试验证。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T22:03:31Z
- **目录日期**: 2025-05-26
