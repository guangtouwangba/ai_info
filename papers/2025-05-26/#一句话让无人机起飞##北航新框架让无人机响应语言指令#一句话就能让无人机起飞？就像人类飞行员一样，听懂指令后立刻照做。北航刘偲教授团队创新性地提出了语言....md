...
北京航空航天大学刘偲教授团队开发出"Flying-on-a-Word"（Flow）框架，实现通过自然语言指令控制无人机飞行。该系统整合语言指令、六自由度状态和第一视角视觉三种输入，采用模仿学习方法学习人类飞行员操作策略。团队构建了覆盖5.02平方公里的大规模真实数据集和仿真测试环境，并针对机载计算限制提出地面站-无人机协作方案。研究成果已实现真机部署，能通过自然语言对话实时控制无人机执行任务。该系统代表了无人机人机交互的重要进展，使无人机能像人类飞行员一样理解并执行口头指令。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T13:11:37Z
- **目录日期**: 2025-05-26
