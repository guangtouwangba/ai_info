...
北航刘偲教授团队提出"Flying-on-a-Word"（Flow）创新框架，实现无人机通过自然语言指令精准控制飞行。该技术整合语言指令、六自由度状态和第一视角视觉数据，采用模仿学习方法训练无人机模仿人类操作。团队构建了覆盖5.02平方公里的真实数据集和UAV-Flow-Sim仿真基准，开发了Pi-0-UAV模型，并成功实现真机部署。针对机载计算限制，提出地面站-无人机协作策略和前瞻轨迹算法，解决了控制延迟问题。这项突破使无人机能像人类飞行员一样实时响应语言指令执行任务。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T19:03:34Z
- **目录日期**: 2025-05-26
