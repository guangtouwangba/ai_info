...
北京航空航天大学刘偲教授团队提出创新框架"Flying-on-a-Word"(Flow)，实现无人机通过自然语言指令执行精细飞行控制。该框架整合语言指令、六自由度状态和第一视角视觉三种输入，采用模仿学习方法训练无人机模仿人类飞行员操作。团队构建了5.02平方公里的真实数据集和仿真测试平台，开发了Pi-0-UAV模型，成功实现真机通过语音实时控制。针对机载计算限制，提出地面站-无人机协作策略和前瞻轨迹对齐算法，解决了延迟问题。研究成果标志着无人机交互控制的重要突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T20:03:45Z
- **目录日期**: 2025-05-26
