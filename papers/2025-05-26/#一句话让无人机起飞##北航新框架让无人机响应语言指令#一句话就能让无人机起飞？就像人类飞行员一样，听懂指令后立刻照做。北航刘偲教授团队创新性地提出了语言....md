...
北京航空航天大学刘偲教授团队开发出"Flying-on-a-Word"(Flow)框架，实现无人机通过自然语言指令控制飞行。该系统整合语言指令、六自由度状态和第一视角视觉三种输入，采用模仿学习方法学习人类飞行员操作策略。团队构建了覆盖5.02平方公里的大规模真实数据集和仿真测试平台，并针对机载计算限制提出地面站-无人机协作方案。真机测试中，Pi-0-UAV模型成功实现语言实时控制，标志着无人机交互方式的重大突破。研究成果已部署于北航开放场景，相关论文和演示视频已公开。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T11:03:50Z
- **目录日期**: 2025-05-26
