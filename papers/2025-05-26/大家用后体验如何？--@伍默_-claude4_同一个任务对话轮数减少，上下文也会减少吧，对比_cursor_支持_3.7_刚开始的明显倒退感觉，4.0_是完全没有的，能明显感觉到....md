...
关于Claude4的用户体验存在不同反馈：一方面有用户指出其对话轮数和上下文支持确实减少，长上下文召回能力较3.7版本明显下降，这对需要处理复杂代码的工程应用可能造成影响；另一方面也有用户认为4.0版本在任务完成质量和可靠性上有所提升，未出现早期3.7版本明显的性能倒退现象。目前实际工程应用效果尚存争议，需要更多使用案例验证。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T02:33:56Z
- **目录日期**: 2025-05-26
