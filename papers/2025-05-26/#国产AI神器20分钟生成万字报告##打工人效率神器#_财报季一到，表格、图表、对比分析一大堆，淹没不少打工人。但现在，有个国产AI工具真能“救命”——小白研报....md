...
国产AI工具"小白研报"能快速生成专业报告，20分钟内可产出万字图文并茂的行业分析。基于元石自研大模型，它能像真人一样思考、搜集资料、构建逻辑，支持PDF/DOCX导出。功能包括：市场调研、品牌对比、学术搜索（可访问arXiv等数据库），提供三种搜索模式，并具备隐私保护功能。典型应用场景包括财报分析、产品选购、论文写作等，如用户输入"万元内女用单反"就能自动生成详细评测报告。该工具还具备智能提问引导功能，帮助用户精准获取信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T18:04:10Z
- **目录日期**: 2025-05-26
