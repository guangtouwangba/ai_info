...
AI首次独立发现Linux内核级零日漏洞(CVE-2025-37899)。研究员Seen Heelan仅使用o3模型API，无需复杂工具，成功识别出SMB协议"注销"命令处理程序中的use-after-free漏洞。这是首个公开报道的由大语言模型发现的系统级漏洞，OpenAI总裁也转发了该成果。该实验仅通过分析12000行代码实现漏洞检测，展示了AI在安全领域的突破性应用潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T02:33:17Z
- **目录日期**: 2025-05-26
