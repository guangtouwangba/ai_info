...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理及其500万次社会互动。研究者利用该系统研究了社会极化、信息传播、基本收入政策和自然灾害影响等社会问题。模拟结果与现实世界数据高度吻合，验证了该系统捕捉人类行为机制的能力。该平台可作为计算社会科学研究的创新工具，为学者和政策制定者提供新的研究范式，弥补传统调查和实验方法的不足。研究表明AgentSociety在理解社会问题成因和预测政策效果方面具有重要潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T03:25:52Z
- **目录日期**: 2025-05-26
