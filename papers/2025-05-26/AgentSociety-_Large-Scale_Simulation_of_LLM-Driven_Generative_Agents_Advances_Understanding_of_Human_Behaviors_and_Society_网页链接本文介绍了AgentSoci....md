...
该研究提出AgentSociety，一个基于大语言模型的大规模社会模拟系统，可模拟1万多个智能代理及其500万次社会互动。该系统作为计算社会科学实验平台，研究了社会极化、信息传播、基本收入政策及自然灾害影响等社会问题。模拟结果与现实世界数据高度吻合，验证了该系统捕捉人类行为机制的能力，展示了其作为社会科学研究和政策制定工具的潜力。该系统能有效补充传统研究方法（如调查和访谈），为理解复杂社会现象提供新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T10:09:39Z
- **目录日期**: 2025-05-26
