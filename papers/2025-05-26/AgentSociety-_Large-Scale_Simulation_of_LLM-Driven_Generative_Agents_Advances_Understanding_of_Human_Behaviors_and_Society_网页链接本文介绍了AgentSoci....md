...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个智能体及其500万次社会互动。研究者利用该系统研究了社会极化、信息传播、基本收入政策及自然灾害影响等社会问题。模拟结果与现实数据吻合，验证了该系统在捕捉人类行为机制方面的有效性。该平台可作为计算社会科学研究工具，辅助传统调查方法，帮助分析社会问题的成因和模式，为政策制定提供参考依据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-26T16:05:02Z
- **目录日期**: 2025-05-26
