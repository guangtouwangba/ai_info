...
这篇论文针对代码生成大模型（codeLLMs）提出新评估方法，指出当前基准测试过于关注代码正确性而忽略人类偏好。研究者构建了CodeArena基准（含397个样本/44种语言）和SynCode-Instruct指令集（20B标记），发现执行基准与人类偏好存在差异。实验显示开源模型（如Qwen2.5-Coder）与商业模型（如OpenAI o1）性能差距显著，强调了对齐人类偏好的必要性。成果发表于#语言模型#领域，为提升AI编程助手实用性提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T07:06:12Z
- **目录日期**: 2025-04-15
