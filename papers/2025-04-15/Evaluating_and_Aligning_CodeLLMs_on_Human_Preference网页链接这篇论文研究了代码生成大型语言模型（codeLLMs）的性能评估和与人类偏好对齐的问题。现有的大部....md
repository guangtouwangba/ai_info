...
这篇论文针对代码生成大模型(codeLLMs)的评估标准提出创新，指出当前基准测试过于关注代码正确性而忽视人类偏好。研究者构建了CodeArena基准(含397个高质量样本，覆盖40类44种语言)和SynCode-Instruct语料库(20B标记)进行验证。实验发现执行基准与人类偏好存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究强调了代码生成模型与人类需求对齐的重要性，为提升AI编程助手实用性提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T18:05:56Z
- **目录日期**: 2025-04-15
