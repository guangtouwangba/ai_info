...
这篇论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，强调现有评估忽视人类偏好匹配的问题。研究者从真实编程查询中精选397个样本(覆盖40类/44种语言)，并构建20B标记的合成指令集SynCode-Instruct。实验显示：执行基准与人类偏好评估存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)表现差距显著，证实对齐人类偏好的重要性。研究揭示了当前代码生成评估的局限性，为提升模型实用性提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T05:04:15Z
- **目录日期**: 2025-04-15
