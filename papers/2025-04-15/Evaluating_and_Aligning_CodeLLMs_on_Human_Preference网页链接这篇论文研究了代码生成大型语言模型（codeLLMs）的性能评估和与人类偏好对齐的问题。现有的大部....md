...
这篇论文探讨了代码生成大模型（codeLLMs）与人类偏好的对齐问题。研究者创建了CodeArena基准测试（含397个样本，覆盖40类任务和44种语言）来评估模型在真实编程场景中的表现，并构建了20B标记的SynCode-Instruct合成指令集。实验发现现有执行基准与人类偏好存在差异，开源模型（如Qwen2.5-Coder）与商业模型（如OpenAI o1）性能差距显著，凸显了对齐人类偏好的重要性。研究强调需要超越代码正确性，关注开发者实际需求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T06:06:13Z
- **目录日期**: 2025-04-15
