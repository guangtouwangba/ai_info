...
这篇论文研究了代码生成大模型(codeLLMs)如何更好地与人类偏好对齐。作者创建了CodeArena基准测试(包含397个高质量样本，覆盖40类任务和44种语言)来评估模型在真实编程场景中的表现，并构建了20B标记的SynCode-Instruct合成指令数据集。研究发现现有基于执行的测试与人类偏好存在差距，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著。研究强调了代码生成模型不仅需要正确性，还需注重与开发者实际需求的匹配。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T10:04:27Z
- **目录日期**: 2025-04-15
