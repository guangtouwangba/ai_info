...
这篇论文针对代码生成大模型(codeLLMs)提出了CodeArena基准测试，关注模型输出与人类偏好的匹配度。研究团队从真实用户查询中精选397个样本，覆盖40个类别和44种编程语言，并构建了20B标记的合成指令集SynCode-Instruct。实验发现执行基准与人类偏好存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)表现差距显著，凸显了对齐人类偏好的重要性。该研究为评估代码LLMs提供了更全面的视角，强调除正确性外还需考虑实际编程需求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T08:06:10Z
- **目录日期**: 2025-04-15
