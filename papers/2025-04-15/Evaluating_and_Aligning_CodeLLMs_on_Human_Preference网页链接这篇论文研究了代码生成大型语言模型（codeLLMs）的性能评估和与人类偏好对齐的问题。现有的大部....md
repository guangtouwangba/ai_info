...
这篇论文针对代码生成大模型(codeLLMs)提出了CodeArena新基准，聚焦模型输出与人类偏好的对齐问题。研究收集了397个涵盖40类编程任务和44种语言的真实样本，并构建了20B标记的合成指令数据集SynCode-Instruct。实验发现：1)传统执行测试与人类偏好评估存在差距；2)开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著。研究强调，仅关注代码正确性不足，需重视人类偏好对齐，这对提升代码生成模型的实用价值至关重要。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T23:06:26Z
- **目录日期**: 2025-04-15
