...
信息技术深刻改变了人类获取信息的方式，但海量在线内容也增加了获取相关信息的难度。近二十年来，推荐系统和搜索引擎等检索系统不断发展以应对这一挑战。近期大语言模型(LLM)展现出超越人类的多项语言处理能力，并具备理解、推理和决策等通用智能。本文首次系统探讨了LLM智能体如何革新推荐与搜索系统，建立了分类框架梳理现有研究，指出其在解决当前检索挑战方面的巨大潜力，为未来研究提供方向。论文还整理了相关文献资源，为这一新兴领域的研究提供参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T03:16:43Z
- **目录日期**: 2025-04-15
