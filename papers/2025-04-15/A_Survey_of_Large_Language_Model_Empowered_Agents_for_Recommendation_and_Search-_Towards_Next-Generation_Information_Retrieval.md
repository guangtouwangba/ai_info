...
信息技术深刻改变了人类获取信息的方式，但海量在线内容也带来了信息过载问题。过去20年，推荐系统和搜索引擎作为信息检索系统发展迅速。近期大语言模型(LLMs)在语言任务中展现出超越人类的能力，并具备理解、推理和决策等通用智能。本文系统探讨了LLM智能体在增强推荐和搜索系统方面的潜力，建立了分类框架梳理现有研究，指出其解决当前挑战的巨大前景，为未来研究提供方向。这是首个系统综述LLM智能体在该领域应用的研究，相关论文列表见文末GitHub链接。(99字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T04:02:20Z
- **目录日期**: 2025-04-15
