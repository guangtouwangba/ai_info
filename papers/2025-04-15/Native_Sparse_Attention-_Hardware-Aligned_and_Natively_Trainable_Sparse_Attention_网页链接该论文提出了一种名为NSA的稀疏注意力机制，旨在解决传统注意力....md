...
该论文提出了Native Sparse Attention (NSA)，一种创新的稀疏注意力机制，旨在降低传统注意力机制处理长文本时的高计算成本。NSA结合算法与硬件优化，采用动态分层稀疏策略，通过粗粒度令牌压缩和细粒度令牌选择，平衡全局上下文感知与局部精度。其关键创新包括硬件对齐设计和原生可训练性，显著提升长文本建模效率。这一方法为大模型处理长序列任务提供了更高效的解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T09:05:17Z
- **目录日期**: 2025-04-15
