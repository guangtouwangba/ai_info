...
Gallice和Monzon（2019）提出了一种在有限自利主体的一次性社会困境中维持完全合作的自然环境模型。该模型表明，在序贯公共物品博弈中，当参与者不知道自身顺序位置但能观察到部分前序行为时，完全合作会成为均衡结果，因为参与者有激励促使后续者效仿。本研究通过多人囚徒困境实验验证该理论，发现多数人选择搭便车，约30%符合Gallice和Monzon的预测类型，其余为有条件合作者、社会偏好考虑者或无条件利他主义者。结构计量分析显示该模型对实际行为的解释力有限。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T18:02:19Z
- **目录日期**: 2025-04-15
