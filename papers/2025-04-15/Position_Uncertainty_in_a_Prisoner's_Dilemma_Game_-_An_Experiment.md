...
Gallice和Monzon(2019)提出了一种在有限自利主体的一次性社会困境中维持完全合作的自然环境模型。该模型预测，在序贯公共品博弈中，当主体不知道自身顺序位置但能观察到部分前人行为时，完全贡献会成为均衡结果。本研究通过多人囚徒困境实验检验该理论，被试不知顺序位置且仅获知部分历史合作信息。实验结果显示：多数人选择搭便车(约30%符合原模型预测)，其次是考虑社会偏好的被试和无条件利他主义者。结构计量分析比较了该模型与条件合作等其他行为策略的解释力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T15:01:43Z
- **目录日期**: 2025-04-15
