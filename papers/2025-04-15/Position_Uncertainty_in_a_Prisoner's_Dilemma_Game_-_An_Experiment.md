...
Gallice和Monzon（2019）提出了一种自然情境，能让有限数量自利的智能体在一次性社会困境中实现完全合作。他们证明，在顺序公共品博弈中，若参与者不知自身顺序位置但能观察部分前序行动，完全合作会成为均衡策略，因为参与者有动机引导后续者效仿。该研究通过多人囚徒困境实验验证该理论，被试不知顺序位置且仅获知部分历史合作信息。实验发现多数人选择搭便车，约30%符合Gallice和Monzon预测类型，其余为条件合作者、社会偏好者或无条件的利他主义者。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T21:02:21Z
- **目录日期**: 2025-04-15
