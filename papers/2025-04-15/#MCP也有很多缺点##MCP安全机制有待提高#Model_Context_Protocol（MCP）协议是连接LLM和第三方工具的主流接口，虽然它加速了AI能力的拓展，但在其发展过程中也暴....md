...
MCP协议作为连接大语言模型和第三方工具的主流接口，虽然扩展了AI能力，但存在多个安全隐患：1) 安全机制薄弱，缺乏统一认证，易被恶意利用；2) 执行环境过于开放，第三方代码风险高；3) 人机边界模糊，误操作风险大；4) 数据传输效率低，延迟明显；5) 多工具环境下性能下降，错误率升高；6) 敏感数据泄露风险高。作者认为MCP协议本身有价值，但需以安全为前提，明确权限边界，并让用户充分了解模型能力范围，否则可能成为不可控的风险源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T23:04:20Z
- **目录日期**: 2025-04-15
