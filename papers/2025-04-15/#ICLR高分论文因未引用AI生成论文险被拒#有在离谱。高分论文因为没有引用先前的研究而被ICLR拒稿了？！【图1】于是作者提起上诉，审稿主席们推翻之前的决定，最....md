...
ICLR高分论文因未引用某篇研究险遭拒稿，后经上诉被接收为Spotlight。作者举报该"先前研究"存在实验结果矛盾、抄袭嫌疑，并指控其使用Claude生成论文内容，但该争议论文仍被COLM 2024接收。双方作者公开争论细节，揭露学术不端争议，引发对AI生成论文和学术规范的讨论。事件凸显当前学术界在AI辅助写作和引用规范方面面临的挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T02:32:09Z
- **目录日期**: 2025-04-15
