...
ICLR一篇高分论文因未引用某篇"先前研究"险遭拒稿，经上诉后被接收为Spotlight论文。作者举报该被引论文存在实验结果矛盾、抄袭嫌疑，且疑似用Claude生成内容（已获COLM 2024接收），因此拒绝引用。事件引发双方公开争论，揭露涉事论文可能使用大模型生成并存在学术不端。这一争议反映了AI生成内容对学术规范的冲击，以及论文审查机制面临的挑战。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T01:31:19Z
- **目录日期**: 2025-04-15
