...
ICLR高分论文因未引用一篇涉嫌AI生成和抄袭的论文险些被拒，作者上诉后最终被接收为Spotlight。争议论文被指实验数据矛盾，并涉嫌用Claude生成内容，却仍被COLM 2024接收。原论文作者拒绝引用该研究，双方后续公开更多争论细节，引发学术诚信讨论。事件暴露了AI生成论文的审查漏洞及学术引用规范的争议。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T03:18:28Z
- **目录日期**: 2025-04-15
