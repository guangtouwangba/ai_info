...
ICLR高分论文因未引用某篇"先前研究"险遭拒稿，上诉后最终被接收。作者举报该被引论文存在实验结果矛盾、抄袭嫌疑，且是使用Claude生成的AI论文，但该问题论文却被COLM 2024接收。争议焦点在于作者拒绝引用这篇涉嫌学术不端的论文，事件引发学界对AI生成论文审查机制的讨论。双方作者已就此事公开交锋，暴露出当前学术评审中AI生成内容带来的新挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T00:03:49Z
- **目录日期**: 2025-04-15
