...
本文介绍了AgentSociety，这是一个基于大语言模型的大规模社会模拟器，能够模拟超过1万个代理的社会生活及500万次互动。研究者利用该平台研究了四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害冲击。模拟结果与现实世界数据高度吻合，验证了该工具在揭示人类行为机制方面的有效性。AgentSociety可作为传统社会科学研究方法的补充工具，帮助研究者分析社会问题的模式、成因和潜在机制，为政策制定提供新的研究途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T15:05:11Z
- **目录日期**: 2025-04-15
