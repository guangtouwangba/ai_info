...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统，能够模拟超过1万个AI代理的社会互动（共500万次）。研究者用它研究了四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，证明该系统能有效捕捉人类行为机制，为社会科学研究和政策制定提供了新工具。该系统结合了LLM智能体、真实社会环境和大规模模拟引擎，可作为传统研究方法（如调查、实验）的有力补充。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T19:05:08Z
- **目录日期**: 2025-04-15
