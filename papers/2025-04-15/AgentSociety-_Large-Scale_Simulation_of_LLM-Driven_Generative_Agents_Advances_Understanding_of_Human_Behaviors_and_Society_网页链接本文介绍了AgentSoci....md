...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟超过1万个智能代理及其500万次互动。研究者利用该平台研究了社会极化、信息传播、基本收入政策及自然灾害影响等社会问题，模拟结果与现实数据高度吻合。该系统能有效捕捉人类行为机制，为社会科学研究和政策制定提供了创新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T03:19:26Z
- **目录日期**: 2025-04-15
