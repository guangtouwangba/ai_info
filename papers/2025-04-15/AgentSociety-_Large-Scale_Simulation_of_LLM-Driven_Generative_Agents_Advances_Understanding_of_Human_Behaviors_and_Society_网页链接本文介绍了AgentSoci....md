...
AgentSociety是一个基于大语言模型的大规模社会模拟器，能模拟超过1万个代理及其500万次互动。研究者用它研究极化现象、信息传播、基本收入政策和飓风影响等社会问题，结果与现实世界数据吻合。这验证了该模拟器捕捉人类行为机制的能力，展示了其作为社会科学研究和政策制定工具的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T09:05:24Z
- **目录日期**: 2025-04-15
