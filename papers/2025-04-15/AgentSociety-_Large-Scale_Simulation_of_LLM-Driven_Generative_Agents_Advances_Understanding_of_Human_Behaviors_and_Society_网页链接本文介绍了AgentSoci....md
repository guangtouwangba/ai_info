...
该论文介绍了AgentSociety——一个基于大语言模型的大规模社会模拟系统，可模拟10,000+智能代理及其500万次社会互动。该系统作为计算社会科学实验平台，研究了社会极化、信息传播、基本收入政策、自然灾害影响等关键问题。模拟结果与现实世界数据高度吻合，证明其能有效捕捉人类行为机制，为社会科学研究和政策制定提供了创新工具。研究展示了AI模拟在理解复杂社会现象方面的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T20:05:32Z
- **目录日期**: 2025-04-15
