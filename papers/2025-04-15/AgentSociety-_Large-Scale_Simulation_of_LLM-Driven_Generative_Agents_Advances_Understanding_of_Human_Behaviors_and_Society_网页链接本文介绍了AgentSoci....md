...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能模拟1万多个AI代理在真实社会环境中的500万次互动。研究者用它研究了四大社会问题：社会极化、刺激性信息传播、基本收入政策影响和自然灾害（如飓风）冲击。模拟结果与现实世界数据高度吻合，验证了该系统捕捉人类行为机制的能力。这表明AgentSociety可作为计算社会科学的创新工具，帮助学者和决策者通过模拟实验分析社会问题成因，补充传统研究方法如问卷调查和实地干预。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T23:05:55Z
- **目录日期**: 2025-04-15
