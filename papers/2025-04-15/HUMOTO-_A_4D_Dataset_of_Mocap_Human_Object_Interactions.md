...
HUMOTO是一个高精度的人-物交互数据集，包含736段序列（7,875秒/30fps），涵盖63种精确建模物体和72个可动部件。该数据集通过场景驱动的LLM脚本生成完整任务流程，并采用动作捕捉与多相机系统有效处理遮挡问题，覆盖烹饪、野餐等多样化活动。所有序列经过专业清理，确保物理准确性和任务逻辑性，显著减少了足部滑动和物体穿透问题。HUMOTO提供了全身动作与多物体同步交互数据，解决了关键数据采集挑战，为动画、机器人和具身AI等领域的真实人-物交互建模研究提供了新机遇。项目网址见摘要。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T11:02:00Z
- **目录日期**: 2025-04-15
