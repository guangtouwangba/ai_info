...
智谱AI近日开源了6款GLM系列模型，包含三大类型：沉思模型GLM-Z1-Rumination、推理模型GLM-Z1-Air和基座模型GLM-4-Air-0414，按参数量分为9B和32B版本。其中，32B推理模型GLM-Z1-0414以200 tokens/秒的推理速度成为目前国内最快商用模型，性能媲美DeepSeek-R1，但成本仅为1/30。所有模型均采用MIT协议，支持免费商用和自由分发，覆盖对话、推理等场景，序列长度最高达128K。此次开源显著提升了AI开发者的技术可及性和商业应用效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T06:03:11Z
- **目录日期**: 2025-04-15
