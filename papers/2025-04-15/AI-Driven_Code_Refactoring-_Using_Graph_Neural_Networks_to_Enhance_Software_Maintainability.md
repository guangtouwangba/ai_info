...
该研究探索了图神经网络(GNN)在代码重构中的应用，利用抽象语法树(AST)提升软件可维护性。通过分析CodeSearchNet的200万代码片段和7.5万份GitHub Python文件，比较GNN与基于规则的SonarQube和决策树方法。结果显示，GNN在准确率达92%，将代码复杂度降低35%，耦合度减少33%，优于SonarQube(78%,16%)和决策树(85%,25%)。预处理修复了60%的语法错误。研究通过柱状图、表格和AST可视化展示结果，为软件工程提供了可扩展的AI驱动代码优化方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T07:02:20Z
- **目录日期**: 2025-04-15
