...
本研究探讨了图神经网络(GNN)在代码重构中的应用，利用抽象语法树(AST)提升软件可维护性。通过分析CodeSearchNet的200万代码片段和7.5万份GitHub Python文件，对比GNN、基于规则的SonarQube和决策树方法。结果显示，GNN以92%的准确率领先(SonarQube 78%，决策树85%)，将代码复杂度降低35%，耦合度降低33%，显著优于其他方法。预处理修复了60%的语法错误。研究证明GNN为代码优化提供了可扩展的AI解决方案，对软件工程具有重要意义。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T14:02:30Z
- **目录日期**: 2025-04-15
