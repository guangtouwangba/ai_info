...
当前大型语言模型(LLMs)生成的文本已接近人类水平，使AI生成文本(AIGT)检测成为关键挑战。该研究综述了AIGT检测的最新方法，包括数字水印、统计与风格分析及机器学习分类，并整理了相关数据集。研究分析了不同场景下AIGT文本的可检测性关键因素，旨在为应对这一重要技术与社会挑战提供实用建议。该领域在识别欺诈、学术不端及打击虚假信息等方面具有重要应用价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T18:03:01Z
- **目录日期**: 2025-04-15
