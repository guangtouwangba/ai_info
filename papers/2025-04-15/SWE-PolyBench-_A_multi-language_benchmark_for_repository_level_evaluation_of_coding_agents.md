...
研究人员推出了SWE-PolyBench，这是一个多语言基准测试，用于评估基于大语言模型的编码代理在真实场景中的表现。该基准包含2110个任务实例，涵盖Java、JavaScript、TypeScript和Python四种语言，涉及错误修复、功能添加和代码重构等任务。研究还开发了一套基于语法树分析的新评估指标，并测试了主流开源编码代理的表现，发现它们在复杂任务和不同语言间表现不均。SWE-PolyBench旨在推动开发更强大、通用的AI编程助手。相关数据和代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T01:28:42Z
- **目录日期**: 2025-04-15
