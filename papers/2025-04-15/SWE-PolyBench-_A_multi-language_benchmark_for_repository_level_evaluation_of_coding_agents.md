...
研究人员开发了名为SWE-PolyBench的多语言基准测试平台，包含2110个来自21个代码库的任务实例，涵盖Java、JavaScript、TypeScript和Python四种语言，涉及错误修复、功能添加和代码重构等任务。该平台提供自动化评估工具和基于语法树分析的新指标，用于全面评估AI编程助手的性能。测试发现当前主流开源编码代理在不同语言和任务复杂度上表现不均，处理复杂问题时存在困难。SWE-PolyBench旨在推动开发更强大、通用的AI编程助手，相关数据和代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T00:01:34Z
- **目录日期**: 2025-04-15
