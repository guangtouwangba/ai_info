...
复旦大学与腾讯优图联合提出新型图像生成框架PixelPonder，突破多条件视觉控制难题。相比现有ControlNet等方案在多提示（如姿态与场景）同时控制时易产生冲突，PixelPonder通过"Patch Adaption"模块动态选择图像局部区域的最优控制信号，实现多模态精准协同。该方法显著提升了复杂条件下（如同时控制主体形态与环境氛围）的生成质量，标志着文生图技术在多条件控制领域的重要进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T14:03:15Z
- **目录日期**: 2025-04-15
