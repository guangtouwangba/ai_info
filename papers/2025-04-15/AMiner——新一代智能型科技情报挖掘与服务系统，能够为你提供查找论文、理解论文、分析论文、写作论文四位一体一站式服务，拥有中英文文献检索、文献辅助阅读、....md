...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析和写作一站式服务。它收录3.5亿论文、0.6亿学者等海量数据，支持中英文文献检索、AI辅助阅读和自动摘要生成。用户可通过智能问答快速理解文献，还能上传PDF进行内容解析。平台提供科研动态订阅服务，按用户偏好推送最新成果。此外，AMiner具备学者画像、学术会议追踪等功能，基础服务免费开放。网址：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T19:05:33Z
- **目录日期**: 2025-04-15
