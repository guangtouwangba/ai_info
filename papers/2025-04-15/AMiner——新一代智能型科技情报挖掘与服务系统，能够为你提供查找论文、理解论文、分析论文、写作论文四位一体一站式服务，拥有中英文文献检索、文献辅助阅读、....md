...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译及科研分析等一站式服务。它覆盖42个学科，包含3.5亿论文、0.6亿学者等海量数据。核心功能包括：1）中英文文献精准检索与智能问答；2）AI辅助生成摘要、翻译及内容解析；3）定制化科研情报订阅，推送最新动态。平台还支持学者画像、学术会议追踪等特色服务，用户可通过网页或微信小程序免费使用。AMiner通过AI技术显著提升文献查阅与科研效率，适合学者、学生及研究人员。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T00:05:49Z
- **目录日期**: 2025-04-15
