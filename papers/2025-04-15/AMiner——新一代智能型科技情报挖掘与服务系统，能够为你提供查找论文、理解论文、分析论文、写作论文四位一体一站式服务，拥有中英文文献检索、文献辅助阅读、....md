...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析和写作一站式服务。它收录3.5亿论文、0.6亿学者等海量学术资源，支持中英文文献检索、AI辅助阅读、自动摘要生成及互动问答功能。用户可订阅个性化科研动态，追踪机构、学者及关键词的最新研究。平台还提供学者画像、学术会议等特色功能，基础服务免费开放。网址：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T17:06:08Z
- **目录日期**: 2025-04-15
