...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译和科研订阅等一站式服务。它收录了3.5亿篇论文、0.6亿学者和1.5亿专利，支持中英文文献搜索，并能自动生成摘要和回答用户提问。此外，AMiner还提供个性化科研动态推送、学者画像等功能，帮助用户高效获取学术信息。平台可通过网页或微信小程序免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T22:05:39Z
- **目录日期**: 2025-04-15
