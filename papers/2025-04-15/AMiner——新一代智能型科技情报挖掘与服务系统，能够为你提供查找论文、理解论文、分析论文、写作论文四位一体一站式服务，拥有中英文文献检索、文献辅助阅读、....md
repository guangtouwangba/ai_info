...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、翻译、辅助阅读和论文写作支持。平台收录3.5亿论文、0.6亿学者等海量数据，支持互动问答、自动摘要生成和文献分析。用户可订阅个性化科研动态，通过微信或邮件获取最新学术资讯。此外，AMiner还提供学者画像、学术会议和必读论文推荐等功能，浏览器检索免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T18:05:47Z
- **目录日期**: 2025-04-15
