...
北京海新智能推出的AI零代码开发平台"响指"实现了用自然语言指令快速生成完整应用。用户只需描述需求（如"开发时尚电商网站"），AI会自动生成功能选项（响应式设计、购物车等），并在10分钟内完成包含5个页面的网站开发。该平台采用主流开源大模型，支持代码二次编辑、应用分享及免费使用，使非技术人员也能轻松实现APP开发、模拟平台搭建等需求。作为国企开发的AI工具，其透明化编程过程和零代码特性重新定义了"开发者"门槛。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T10:01:58Z
- **目录日期**: 2025-04-15
