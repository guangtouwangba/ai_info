# #新AI一句话就能搞开发##国企出手搞AI开发#什么？！ 现在随便一个完全不懂编程的人，都可以开发完整网站了？？？你没看错，现在搞开发啊，真的就是一句话的事儿...
...
北京海新智能推出的AI零代码开发平台"响指"引发关注。该平台允许用户仅通过自然语言描述需求（如"开发时尚电商网站"），AI即可自动生成完整功能网站（含响应式设计、购物车等），全程代码透明可见，10分钟生成5个页面。作为国企开发的工具，它整合主流开源大模型，支持代码二次编辑、应用共享及免费使用，覆盖从教育APP到科研模拟等场景。其特点是彻底降低开发门槛，使非技术人员也能快速实现创意，标志AI时代"全民开发者"趋势的到来。（当前体验地址：haisnap.com）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T22:04:26Z
- **目录日期**: 2025-04-15
