...
研究人员提出了RealWebAssist基准，用于评估AI助手在真实场景中长期网页交互中的表现。该基准针对现实用户指令的模糊性、需求变化和心理状态演变等挑战，要求AI理解用户真实意图、跟踪其心理状态、掌握个人习惯，并准确操作网页元素。实验表明，当前先进模型在理解用户指令和界面操作方面仍存在显著困难，突显了长期网页辅助任务的关键挑战。该基准包含真实用户的多网站连续任务指令集，为开发更智能的网络助手提供了重要测试平台。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T17:02:14Z
- **目录日期**: 2025-04-15
