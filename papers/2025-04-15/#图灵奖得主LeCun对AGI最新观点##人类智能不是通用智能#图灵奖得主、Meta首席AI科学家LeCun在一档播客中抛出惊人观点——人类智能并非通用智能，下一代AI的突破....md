...
图灵奖得主LeCun在播客中提出：1）人类智能并非通用智能，仅擅长生存相关领域；2）当前生成式AI（如大模型）缺乏物理世界理解和推理能力；3）未来突破可能在非生成式AI（如Meta的JEPA架构），需建立"世界模型"实现规划、记忆等能力；4）AGI短期难实现，但10年内或有重大进展；5）Meta坚持开源策略推动生态发展；6）智能眼镜是AI落地的关键场景。他强调AI下一步应像动物一样理解世界，而非仅优化对话能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T01:31:10Z
- **目录日期**: 2025-04-15
