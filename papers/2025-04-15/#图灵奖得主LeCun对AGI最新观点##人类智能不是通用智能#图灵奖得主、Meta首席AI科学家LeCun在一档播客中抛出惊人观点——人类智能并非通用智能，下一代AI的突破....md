...
图灵奖得主LeCun在播客中提出：1）人类智能本质是"专用智能"，仅擅长生存相关任务；2）当前生成式AI（如大模型）缺乏物理世界理解和推理能力，不如猫的认知水平；3）下一代AI突破方向应是构建"世界模型"，实现物理理解、规划与长期记忆，Meta的JEPA架构即非生成式尝试；4）AGI短期内难以实现，但十年内或有重大进展；5）Meta坚持开源策略推动生态发展，并看好智能眼镜作为AI落地场景。他强调AI未来需像动物一样理解世界并行动，而非仅优化对话能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T04:04:05Z
- **目录日期**: 2025-04-15
