...
图灵奖得主LeCun在播客中提出：1）人类智能并非真正的通用智能（AGI），而是高度特化的生存问题解决能力；2）当前生成式AI（如大模型）缺乏物理世界理解和推理能力，不如猫的认知水平；3）下一代AI突破方向可能是非生成式架构（如Meta的JEPA），需建立"世界模型"实现推理与规划；4）AGI短期内难以实现，但10年内或有重大进展；5）Meta坚持开源策略推动生态，并看好智能眼镜作为AI落地场景。他强调AI未来发展应聚焦物理世界理解与行动能力，而非语言生成。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-15T02:32:00Z
- **目录日期**: 2025-04-15
