...
上海傅利叶推出开源人形机器人Fourier N1，高131cm，重38kg，具备23个自由度，运动能力出色（3.5m/s奔跑、上下楼梯等）。采用自研FSA 2.0执行器和控制系统，提升抗冲击与精度，续航超2小时。首批开源包含完整图纸、代码及装配指南，支持"乐高式"搭建，并承诺持续更新。公司还推出Fourier Nexus平台，整合硬件、算法与数据共享，推动行业生态共建。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T16:02:54Z
- **目录日期**: 2025-04-11
