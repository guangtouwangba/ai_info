...
人类通过环境探索、经验分层抽象和协作构建技能库实现自我提升。然而，当前自主网络代理仍缺乏关键的自改进能力。为此，研究团队提出SkillWeaver框架，使代理能自主合成可重用API技能：在新网站上发现技能、实践执行并将经验提炼为稳健API。迭代探索不断扩展轻量级即插即用API库，显著增强代理能力。实验显示，在WebArena和真实网站上成功率分别提升31.8%和39.8%。强代理合成的API还能通过技能迁移使弱代理性能提升达54.3%，验证了该框架在跨代理技能共享方面的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T02:27:56Z
- **目录日期**: 2025-04-11
