...
这篇论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，强调现有评估忽视人类偏好问题。研究者从真实用户查询中精选397个样本，覆盖40类任务和44种语言，构建更贴近实际编程场景的评估体系。同时开发了20B标记量的合成指令数据集SynCode-Instruct验证微调效果。实验发现传统执行测试与CodeArena存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，凸显对齐人类偏好的重要性。研究为代码生成模型的实用化评估提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T06:05:47Z
- **目录日期**: 2025-04-11
