...
这篇论文针对代码生成大模型(codeLLMs)与人类偏好对齐的问题，提出了CodeArena基准测试和SynCode-Instruct语料库。CodeArena包含397个高质量样本，覆盖40类编程任务和44种语言，更贴近实际开发需求。研究发现在40多个模型中，开源顶级模型(如Qwen2.5-Coder)与专有模型(如OpenAI o1)存在显著差距，凸显了人类偏好对齐的重要性。同时构建的20B标记合成指令集验证了大规模指令微调的有效性。结果表明传统基于执行的评估与人类偏好评估存在差异，为代码LLM的优化提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T07:05:50Z
- **目录日期**: 2025-04-11
