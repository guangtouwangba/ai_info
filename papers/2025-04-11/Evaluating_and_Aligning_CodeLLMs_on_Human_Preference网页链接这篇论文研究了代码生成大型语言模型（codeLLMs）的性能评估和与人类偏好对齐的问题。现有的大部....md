...
该论文研究了代码生成大模型(codeLLMs)与人类偏好的对齐问题。作者构建了CodeArena基准测试(397个样本，40类/44种语言)来评估模型在真实编程任务中的表现，并创建了SynCode-Instruct语料库(20B标记)验证合成指令微调效果。实验发现：1)传统执行基准与人类偏好存在差异；2)开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究强调了代码生成模型对齐人类偏好的重要性，为改进模型提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T12:05:56Z
- **目录日期**: 2025-04-11
