...
这篇论文针对代码生成大模型(codeLLMs)与人类偏好对齐的问题，提出了CodeArena基准测试和SynCode-Instruct数据集。CodeArena包含397个高质量样本，覆盖40类任务和44种编程语言，更贴近实际编程场景。研究还构建了近200亿标记的合成指令数据集用于模型微调。实验发现：1)传统基于执行的评估与人类偏好存在差异；2)开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究强调了代码LLMs与人类偏好对齐的重要性，为相关研究提供了新评估框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T18:05:24Z
- **目录日期**: 2025-04-11
