...
这篇论文探讨了代码生成大模型（CodeLLMs）如何更好地与人类偏好对齐。研究者发现现有基准测试过于关注代码正确性，忽略了人类偏好，因此提出了CodeArena基准，包含397个高质量样本，覆盖40个类别和44种编程语言。此外，他们还构建了20B标记的合成指令数据集SynCode-Instruct。实验显示，执行基准与CodeArena存在性能差异，且开源模型（如Qwen2.5-Coder）与专有模型（如OpenAI o1）差距显著，凸显了人类偏好对齐的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T20:05:31Z
- **目录日期**: 2025-04-11
