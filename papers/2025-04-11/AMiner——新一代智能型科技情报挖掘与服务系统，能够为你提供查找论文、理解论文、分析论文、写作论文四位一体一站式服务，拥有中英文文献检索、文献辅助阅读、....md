...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析与写作的一站式服务。其核心功能包括：1）中英文文献检索，支持互动问答与自动摘要生成；2）英文文献翻译与AI辅助阅读，可上传PDF获取章节概要与智能问答；3）科研情报订阅，按用户偏好推送最新论文摘要。平台涵盖3.5亿论文、0.6亿学者数据，支持学者画像、学术会议等特色功能，基础检索服务免费开放。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T03:18:36Z
- **目录日期**: 2025-04-11
