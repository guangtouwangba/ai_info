...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作一站式服务。它支持中英文文献搜索，拥有3.5亿论文、0.6亿学者等海量数据，并提供AI辅助功能，如自动摘要生成、互动问答和文献翻译。用户可订阅个性化科研动态，追踪机构、学者和关键词的最新研究。平台还具备学者画像、学术会议推荐等功能，支持PDF上传和智能解析，帮助用户高效获取和理解学术信息。AMiner可免费使用，适用于科研人员和学生。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T17:05:30Z
- **目录日期**: 2025-04-11
