...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和科研订阅等一站式服务。它拥有3.5亿论文、0.6亿学者等海量学术资源，支持中英文文献检索、AI生成摘要、互动问答和文档翻译功能。用户可定制科研动态推送，关注特定学者或领域的最新研究。平台还提供学者画像、学术会议和论文排行等工具，帮助用户高效获取和分析学术信息。AMiner的浏览器版本可免费使用，适合科研人员和学生提升文献查阅与论文写作效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T08:05:33Z
- **目录日期**: 2025-04-11
