...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读辅助、翻译、写作等一站式服务。平台收录3.5亿论文、0.6亿学者等海量学术资源，支持中英文文献检索，能自动生成摘要并通过问答帮助理解内容。特色功能包括AI辅助阅读（上传PDF获取摘要/章节概要）、科研动态订阅（按偏好推送最新论文）、学者画像分析等。用户可通过网页免费使用基础功能，实现高效文献调研与学术写作。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T04:07:44Z
- **目录日期**: 2025-04-11
