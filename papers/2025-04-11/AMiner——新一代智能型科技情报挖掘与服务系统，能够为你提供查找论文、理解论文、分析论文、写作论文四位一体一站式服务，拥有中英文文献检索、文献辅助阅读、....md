...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、AI辅助阅读、自动摘要生成、科研情报订阅等功能。平台收录3.5亿论文、0.6亿学者等海量数据，支持用户通过提问快速理解文献内容，并能定制推送最新研究动态。其特色功能包含文献翻译、学者画像分析、学术会议追踪等，所有基础服务均可免费使用。通过网页或微信小程序即可体验该系统的智能文献处理能力，显著提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T21:05:06Z
- **目录日期**: 2025-04-11
