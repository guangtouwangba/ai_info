...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、阅读辅助和科研订阅等一站式服务。它涵盖42个学科的3.5亿论文、0.6亿学者和1.5亿专利，支持中英文文献检索，并能通过AI生成摘要和问答互动。用户可上传PDF或从平台获取论文，利用AI工具快速理解内容。此外，AMiner提供定制化科研动态推送，跟踪机构、学者或关键词，通过微信或邮件发送最新资讯。平台还包括学者画像、学术会议和论文排行榜等功能，可免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T14:05:39Z
- **目录日期**: 2025-04-11
