...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译、科研订阅等一站式服务。它收录3.5亿论文、0.6亿学者等海量学术资源，支持中英文文献检索、AI摘要生成和互动问答，帮助用户快速理解内容。平台还支持PDF上传分析、科研动态订阅推送（通过微信/邮件），以及学者画像、学术会议等特色功能。用户可免费使用浏览器检索，通过网页或小程序便捷获取学术资讯。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T05:05:42Z
- **目录日期**: 2025-04-11
