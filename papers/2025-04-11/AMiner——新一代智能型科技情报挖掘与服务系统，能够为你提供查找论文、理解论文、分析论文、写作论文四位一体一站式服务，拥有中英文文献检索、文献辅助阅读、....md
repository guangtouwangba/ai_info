...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、科研情报订阅等一站式服务。它拥有42个学科的3.5亿论文、0.6亿学者等海量数据，支持文献辅助阅读、自动摘要生成和智能问答功能。用户可通过订阅获取最新科研动态，还能使用学者画像、学术会议等特色功能。平台支持PDF上传和交互式分析，帮助用户高效理解文献内容。AMiner提供免费基础服务，可通过网页或微信小程序使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T13:12:34Z
- **目录日期**: 2025-04-11
