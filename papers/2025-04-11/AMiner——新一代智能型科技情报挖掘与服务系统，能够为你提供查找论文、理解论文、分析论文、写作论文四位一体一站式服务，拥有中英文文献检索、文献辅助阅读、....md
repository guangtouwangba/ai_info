...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、科研订阅等一站式服务。其核心功能包括：1）高效检索3.5亿论文资源，支持AI生成摘要和互动问答；2）文献翻译与辅助阅读，可解析PDF并提炼核心内容；3）个性化订阅服务，自动推送最新研究动态。平台覆盖42个学科，整合学者、专利和项目数据，支持免费使用，帮助用户快速获取、理解和分析学术信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T12:05:45Z
- **目录日期**: 2025-04-11
