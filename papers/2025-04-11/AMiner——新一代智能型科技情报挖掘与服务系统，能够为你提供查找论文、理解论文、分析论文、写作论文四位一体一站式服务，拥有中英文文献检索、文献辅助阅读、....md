...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、翻译、辅助阅读和论文写作支持。其数据库涵盖42个学科，包含3.5亿论文、0.6亿学者和1.5亿专利。核心功能包括：1）智能文献搜索与自动摘要生成；2）AI辅助阅读和互动问答；3）个性化科研动态订阅服务；4）学者画像和学术会议追踪。平台支持文档上传和AI解析，帮助用户快速理解文献内容。基础功能免费开放，可通过网页或微信小程序使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T07:05:39Z
- **目录日期**: 2025-04-11
