...
本文提出了一种快速适应策略，用于提升无监督零样本强化学习（RL）中行为基础模型（BFMs）的性能。研究发现，现有BFMs学习的技能集包含比其推理过程更优的策略，因此适合快速适应。作者提出了基于演员-评论家和纯演员的低维任务嵌入空间搜索策略，能在少量环境交互中提升零样本策略的下游任务表现，同时避免预训练模型的性能下降。实验表明，该方法在导航和运动任务中仅需数十次交互即可实现10-40%的性能提升，优于现有基线方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T19:01:24Z
- **目录日期**: 2025-04-11
