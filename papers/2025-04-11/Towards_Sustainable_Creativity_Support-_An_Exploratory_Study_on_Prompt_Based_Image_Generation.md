...
这篇论文探讨了生成式AI（如图像生成器）在支持人类创造力方面的作用及其能耗问题。研究通过用户实验（N=24）发现，图像生成条件显著影响能耗和单次提示的创造力支持指数，但任务整体创造力支持不受影响，主要归因于每次提示生成的图像数量。研究分析了能耗、创造力支持和用户提示行为之间的关系，并探讨了用户对AI设计及其环境影响的态度。结果表明，可以在不显著降低创造力支持的前提下减少AI系统的能耗。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T08:01:51Z
- **目录日期**: 2025-04-11
