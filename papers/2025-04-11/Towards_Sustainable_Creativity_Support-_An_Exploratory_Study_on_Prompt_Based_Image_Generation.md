...
这篇论文研究了AI图像生成工具在支持人类创造力时的能耗问题。通过一项24人参与的实验，研究者发现图像生成条件显著影响能耗和创造力支持指数（按提示而非任务计算），主要与每提示生成的图像数量有关。研究分析了能耗、创造力支持和用户提示行为之间的关系，同时探讨了用户对AI设计及其环境影响的态度。结果表明，有可能在不显著降低工具创造力支持的情况下减少能源消耗。这为开发更环保的AI创意工具提供了参考依据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T12:01:56Z
- **目录日期**: 2025-04-11
