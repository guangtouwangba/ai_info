...
该研究探讨了AI图像生成工具在支持人类创造力时如何降低能耗。通过24人用户实验发现，图像生成条件显著影响能耗和单次提示的创造力支持指数，但整体任务创造力不受影响，主要归因于每次提示生成的图像数量。研究分析了能耗、创造力支持与用户提示行为的关系，并调查了用户对AI设计工具及环境影响的看法，表明在不损害创造力支持的前提下，通过优化提示策略可减少能源消耗。研究为平衡AI创意工具效能与可持续性提供了实证依据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T11:01:46Z
- **目录日期**: 2025-04-11
