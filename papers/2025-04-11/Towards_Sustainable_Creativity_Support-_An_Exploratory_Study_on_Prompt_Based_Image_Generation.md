...
这篇论文研究了AI图像生成工具在支持人类创造力时的能耗问题。通过24人用户实验发现，不同图像生成条件对能耗有显著影响，但创意支持指数仅与单次提示相关而非整体任务，主要归因于每次提示生成的图像数量。研究分析了能耗、创意支持和用户提示行为之间的关系，同时探讨了用户对AI设计及其环境影响的态度。结果表明，可以在不影响创意支持的情况下降低能耗，为开发更环保的AI创意工具提供了依据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T13:08:46Z
- **目录日期**: 2025-04-11
