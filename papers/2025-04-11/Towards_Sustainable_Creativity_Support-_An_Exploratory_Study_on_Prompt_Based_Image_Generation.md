...
这篇论文研究了生成式AI（如图像生成）在支持人类创造力方面的作用，同时探讨了其高能耗问题。通过一项24人参与的实验，研究发现不同图像生成条件对能耗有显著影响，而创造力支持指数与单次提示相关，但与整体任务无关，这主要归因于每次提示生成的图像数量。研究分析了能耗、创造力支持和用户提示行为之间的关系，并探讨了用户对AI设计及其环境影响的态度。结果表明，可以在不显著影响创造力支持的情况下降低AI系统的能耗。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T09:01:59Z
- **目录日期**: 2025-04-11
