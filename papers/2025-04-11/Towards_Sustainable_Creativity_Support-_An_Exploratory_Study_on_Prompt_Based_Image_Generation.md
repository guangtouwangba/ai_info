...
该研究探讨了生成式AI（如图像生成器）在支持人类创造力方面的潜力及其能耗问题。通过24人用户实验发现，不同图像生成条件显著影响能耗和单次提示的创造力支持指数（但整体任务不受影响），主要归因于每次提示生成的图像数量。研究分析了能耗、创造力支持与用户提示行为之间的关系，同时考察了用户对AI设计工具及其环境影响的态度。结果表明，可以在不显著降低创造力支持的情况下减少AI系统的能源消耗。研究为平衡AI辅助创意工具的效率与可持续性提供了实证依据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T16:01:50Z
- **目录日期**: 2025-04-11
