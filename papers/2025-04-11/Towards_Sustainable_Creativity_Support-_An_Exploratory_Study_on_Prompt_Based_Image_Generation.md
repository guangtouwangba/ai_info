...
这项研究探讨了AI图像生成工具在支持人类创造力的同时如何降低能耗。通过对24名用户的实验发现，图像生成条件显著影响能耗和每个提示的创造力支持指数，但不影响每个任务的创造力支持，主要归因于每次提示生成的图像数量。研究分析了能耗、创造力支持和用户提示行为之间的关系，并考察了用户对AI设计及其环境影响的看法。结果表明，可以在不损害工具创造力支持的情况下减少能源消耗，为平衡AI创意辅助与可持续性提供了实用见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T18:01:53Z
- **目录日期**: 2025-04-11
