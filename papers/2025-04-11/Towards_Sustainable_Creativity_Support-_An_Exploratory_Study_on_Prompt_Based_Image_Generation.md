...
这篇论文研究了AI图像生成工具在支持人类创造力时如何降低能耗。通过24人用户实验发现，图像生成条件显著影响能耗和单次提示的创造力支持指数（但整体任务不受影响），主要与每次提示生成的图像数量有关。研究分析了能耗、创造力支持和用户提示行为之间的关系，同时探讨了用户对AI设计工具及其环境影响的态度。结果表明，可以在不影响创造力支持的情况下减少AI图像生成系统的能源消耗。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T22:01:41Z
- **目录日期**: 2025-04-11
