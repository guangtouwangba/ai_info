...
这篇论文研究了AI图像生成工具在支持人类创造力时的能源消耗问题。通过一项24人参与的实验，研究者发现不同图像生成条件对能耗有显著影响，但创意支持指数仅与单次提示相关而非整体任务，主要归因于每次提示生成的图像数量。研究分析了能耗、创意支持与用户提示行为之间的关系，同时探讨了用户对AI设计工具及其环境影响的态度。结果表明，在不影响创意支持的前提下，有可能通过优化提示策略来降低AI图像生成系统的能源消耗。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T19:01:49Z
- **目录日期**: 2025-04-11
