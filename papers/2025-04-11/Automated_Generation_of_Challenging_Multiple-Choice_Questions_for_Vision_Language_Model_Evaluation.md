...
本文介绍了AutoConverter框架，它能将开放式视觉问答(VQA)自动转换为多选题形式，以解决现有评测基准因答案多样性导致评估困难的问题。实验表明，该框架能生成准确且具挑战性的多选题，且视觉语言模型(VLMs)在其上的表现与人工编写题目相当或更差。基于此，作者构建了VMCBench评测基准，将20个VQA数据集统一转换为9,018道多选题，并对33个前沿VLMs进行全面评估，为可扩展、一致且可复现的VLM评估设立了新标准。(99字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T01:29:39Z
- **目录日期**: 2025-04-11
