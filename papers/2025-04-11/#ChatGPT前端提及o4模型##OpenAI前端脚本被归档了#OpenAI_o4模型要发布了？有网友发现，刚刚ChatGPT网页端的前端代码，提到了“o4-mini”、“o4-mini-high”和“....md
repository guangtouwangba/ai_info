...
根据微博爆料，ChatGPT网页端前端代码中意外出现了"o4-mini"、"o4-mini-high"和"o3"等模型名称，这些信息被互联网档案馆Wayback Machine在2025年4月10日的快照中保存。代码显示OpenAI可能正在开发新一代o4模型，但目前官方尚未确认。该发现源于一个被归档的JavaScript文件，用户通过技术手段还原出了相关代码片段。这引发了关于OpenAI即将发布新模型的猜测，但具体细节仍待官方公布。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T06:04:05Z
- **目录日期**: 2025-04-11
