...
近日有网友发现ChatGPT网页端前端代码中出现了"o4-mini"、"o4-mini-high"和"o3"等字样，疑似暗示OpenAI即将发布新一代o4模型。这些信息是通过互联网档案馆Wayback Machine意外保存的2025年4月10日的JavaScript文件泄露的。代码截图显示模型版本信息，但目前OpenAI尚未官方确认o4模型的存在或发布时间。这一发现引发了AI社区对新模型可能带来性能提升的猜测。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T00:04:17Z
- **目录日期**: 2025-04-11
