...
OpenAI疑似将发布新模型"o4"。网友在ChatGPT网页端前端代码中发现"o4-mini"、"o4-mini-high"和"o3"等字样。这些代码由互联网档案馆Wayback Machine在2025年4月10日无意保存，格式为JavaScript文件。代码截图显示模型名称出现在前端脚本中，但OpenAI尚未正式宣布相关消息。该发现引发了对OpenAI即将推出新一代模型的猜测。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T03:16:57Z
- **目录日期**: 2025-04-11
