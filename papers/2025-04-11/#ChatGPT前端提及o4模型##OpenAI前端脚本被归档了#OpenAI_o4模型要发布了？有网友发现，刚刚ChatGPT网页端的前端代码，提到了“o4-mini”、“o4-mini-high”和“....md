...
根据微博信息，网友发现ChatGPT网页端前端代码中出现了"o4-mini"、"o4-mini-high"和"o3"等模型名称的引用。这些代码片段是通过互联网档案馆Wayback Machine意外保存的2025年4月10日的JavaScript文件。虽然代码本身是加密的，但通过iframe工具可以解析出模型名称的显示。这一发现引发了对OpenAI可能即将发布o4模型的猜测，但目前官方尚未确认任何相关信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T02:31:04Z
- **目录日期**: 2025-04-11
