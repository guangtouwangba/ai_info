...
OpenAI疑似即将发布新一代o4模型。有网友发现ChatGPT网页端前端代码中出现了"o4-mini"、"o4-mini-high"和"o3"等字样，这些信息是通过互联网档案馆Wayback Machine无意保存的2025年4月10日的JavaScript文件泄露的。代码截图显示这些模型名称被直接标注在前端脚本中，暗示OpenAI可能正在测试或准备发布新一代模型。这一发现引发了关于o4模型即将问世的猜测。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T04:05:53Z
- **目录日期**: 2025-04-11
