...
本文提出了"双思维引擎"(DEoT)框架，专门用于解决开放性问题。该框架包含三个核心组件：优化用户查询的基础提示器(BP)、协调任务分解与验证的求解代理(SA)，以及由广度引擎(探索多元因素)和深度引擎(深入分析)构成的双引擎系统。实验表明，DEoT在应对复杂多面问题时表现优异，相比现有推理模型获得77-86%的总胜率。其可定制化设计允许调整分析参数和工具配置，既能实现广泛覆盖又能进行深度探究，在现实应用中展现出显著优势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T04:02:41Z
- **目录日期**: 2025-04-11
