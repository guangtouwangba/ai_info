...
研究人员提出了"思维双引擎"(DEoT)框架，专门用于解决开放式问题。该框架包含三个核心组件：基础提示器优化用户查询，求解代理协调任务分解与验证，以及由广度引擎(探索多元因素)和深度引擎(进行深入分析)组成的双引擎系统。实验表明，DEoT在解决复杂多面性问题时表现优异，相比现有推理模型获得77-86%的胜率。这种可定制化设计能平衡广泛覆盖与深度分析，适用于实际应用场景。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T21:01:52Z
- **目录日期**: 2025-04-11
