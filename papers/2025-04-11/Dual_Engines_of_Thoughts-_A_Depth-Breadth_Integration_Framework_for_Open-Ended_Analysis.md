...
本文提出了"思维双引擎"(DEoT)框架，专门用于解决开放性问题。该框架包含三个核心组件：用于优化查询的"基础提示器"、负责任务分解与执行的"求解代理"，以及由"广度引擎"(探索多元影响因素)和"深度引擎"(进行深入分析)组成的双引擎系统。DEoT能同时兼顾广泛覆盖和深度分析，具有高度可定制性。实验表明，在处理复杂多维度问题时，DEoT相比现有推理模型的胜率达到77-86%，显著提升了开放性问题分析的广度和深度，在实际应用中表现出色。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T17:02:00Z
- **目录日期**: 2025-04-11
