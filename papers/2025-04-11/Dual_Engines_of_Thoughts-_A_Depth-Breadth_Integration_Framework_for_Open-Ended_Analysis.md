...
本文提出"思维双引擎"(DEoT)框架，专门解决开放性问题分析。该框架包含三个核心组件：基础提示器优化用户查询，求解代理协调任务分解与验证，以及由广度引擎(探索多元因素)和深度引擎(深入分析)构成的双引擎系统。DEoT能平衡广泛覆盖与深度分析，支持参数自定义。实验表明，在解决复杂多维度问题时，DEoT以77-86%的胜率超越现有推理模型，展现了实际应用优势。该框架突破了传统单答案推理的局限，为开放性问题提供了更全面的分析方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T03:14:51Z
- **目录日期**: 2025-04-11
