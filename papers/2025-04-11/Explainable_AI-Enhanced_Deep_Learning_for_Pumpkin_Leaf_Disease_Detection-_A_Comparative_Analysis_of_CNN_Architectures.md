...
南瓜叶病害严重影响农业生产，传统检测方法费时且易出错。本研究使用包含2000张高分辨率图像的"南瓜叶病害数据集"，涵盖5类病害（霜霉病、白粉病、花叶病、细菌性叶斑病）和健康叶片。通过测试多种深度学习模型，发现ResNet50表现最优，准确率达90.5%。研究还采用可解释AI技术（Grad-CAM等）增强模型决策透明度。结果表明，ResNet50能有效实现南瓜叶病害的自动化精准检测，有助于早期防治。该成果为农业病害诊断提供了可靠的技术支持。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T10:02:26Z
- **目录日期**: 2025-04-11
