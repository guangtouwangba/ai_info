...
本研究利用包含2000张高清南瓜叶片图像的"南瓜叶病数据集"，探索了多种深度学习模型对五种叶病（霜霉病、白粉病、花叶病、细菌性叶斑病及健康叶片）的自动诊断效果。结果表明，ResNet50模型表现最优，准确率达90.5%。研究还采用可解释AI技术（Grad-CAM等）解析模型决策过程，增强了自动诊断的可信度。该成果为南瓜叶病的早期精准识别提供了有效解决方案，有助于提升农业病害管理效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T12:02:38Z
- **目录日期**: 2025-04-11
