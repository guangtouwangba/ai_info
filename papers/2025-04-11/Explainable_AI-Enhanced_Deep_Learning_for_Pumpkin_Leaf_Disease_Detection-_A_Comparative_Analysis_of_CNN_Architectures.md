...
本研究利用包含2000张高清图像的南瓜叶病数据集，测试了多种深度学习模型对五种叶病（霜霉病、白粉病、花叶病、细菌性叶斑病及健康叶片）的分类性能。结果显示ResNet50模型表现最优，准确率达90.5%。研究同时采用Grad-CAM等可解释AI技术增强模型决策透明度，证实了该模型在实现自动化叶病早期精准诊断方面的潜力，为农业病害管理提供了可靠解决方案。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T14:02:33Z
- **目录日期**: 2025-04-11
