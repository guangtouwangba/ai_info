...
本研究利用包含2000张高分辨率图像的"南瓜叶病害数据集"，探索了多种深度学习模型对五种南瓜叶病害（霜霉病、白粉病、花叶病、细菌性叶斑病和健康叶片）的自动识别。实验发现ResNet50模型表现最佳，准确率达90.5%。研究还采用可解释AI技术（Grad-CAM等）增强模型决策过程的可理解性。结果表明，ResNet50能有效提升南瓜叶病害的早期精准诊断，为农业病害管理提供可靠自动化解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T22:02:15Z
- **目录日期**: 2025-04-11
