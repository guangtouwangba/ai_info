...
arXiv推出AI音频摘要功能，用户可在几分钟内听完论文核心内容。该功能适用于通勤、跨学科学习等场景，无需登录即可使用。基于ScienceCast算法，AI会分析TeX源文件生成自然语言摘要并转为音频。目前该功能在"高能天体物理"分类试点，未来将扩展至更多领域。ScienceCast公司此前已与bioRxiv等平台合作，提供多媒体科研服务。这项创新帮助研究者快速筛选论文，提升文献阅读效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T08:02:58Z
- **目录日期**: 2025-04-11
