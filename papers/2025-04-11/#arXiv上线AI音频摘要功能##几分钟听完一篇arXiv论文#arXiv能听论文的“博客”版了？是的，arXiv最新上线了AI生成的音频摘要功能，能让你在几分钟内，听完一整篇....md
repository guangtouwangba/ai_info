...
arXiv近日推出AI音频摘要功能，用户可通过点击论文页面的"Audio Summaries"按钮，快速收听AI生成的论文核心内容摘要。该功能基于ScienceCast算法，能自动解析TeX源文件并转化为简明音频，帮助研究者在通勤、跨学科学习等场景高效筛选论文。目前该服务仅在高能天体物理分类试点，未来将扩展至更多领域。ScienceCast公司此前已与bioRxiv等平台合作，致力于科研内容的多媒体化呈现。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T12:03:35Z
- **目录日期**: 2025-04-11
