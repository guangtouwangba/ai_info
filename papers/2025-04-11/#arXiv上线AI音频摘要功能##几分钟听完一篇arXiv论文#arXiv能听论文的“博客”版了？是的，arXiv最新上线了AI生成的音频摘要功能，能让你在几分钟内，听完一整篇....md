# #arXiv上线AI音频摘要功能##几分钟听完一篇arXiv论文#arXiv能听论文的“博客”版了？是的，arXiv最新上线了AI生成的音频摘要功能，能让你在几分钟内，听完一整篇...
...
arXiv推出AI音频摘要功能，用户可通过点击论文页面的"Audio Summaries"按钮，在几分钟内听完论文核心内容。该功能基于ScienceCast算法，能自动解析TeX源文件生成自然语言摘要并转为语音，适合通勤、跨学科学习等场景。目前仅在astro-ph.HE分类试点，未来将扩展至更多领域。ScienceCast公司此前已与bioRxiv、arXivLabs合作，提供生物领域音频摘要和多媒体增强服务。该功能无需登录即可使用，帮助研究者快速筛选论文。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T13:10:43Z
- **目录日期**: 2025-04-11
