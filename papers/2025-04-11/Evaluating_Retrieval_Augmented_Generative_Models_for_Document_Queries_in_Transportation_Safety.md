...
本研究评估了ChatGPT、Google Vertex AI和ORNL检索增强生成（RAG）优化的LLaMA 2/LLaMA三种生成式大语言模型在美国危险品运输法规信息检索中的表现。通过100个真实查询测试发现，RAG增强的LLaMA模型在准确性、细节和相关性上显著优于其他模型，尽管偶有不一致。研究首次将RAG技术应用于运输安全领域，强调在专业高风险场景中需进行领域优化和严格评估，以确保可靠性并减少错误风险。结果表明，专用优化能有效提升关键领域信息检索质量。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T02:28:27Z
- **目录日期**: 2025-04-11
