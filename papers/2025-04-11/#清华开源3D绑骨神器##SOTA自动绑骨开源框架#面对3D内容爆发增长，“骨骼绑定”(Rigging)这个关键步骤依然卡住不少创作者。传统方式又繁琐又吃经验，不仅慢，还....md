...
清华大学与VAST联合开源了3D自动骨骼绑定框架UniRig，可高效处理人形、动物、幻想生物及机械结构等多种模型。该框架采用自回归模型逐关节预测骨架，创新引入骨骼树Tokenization技术，使Transformer处理效率提升30%。同时支持蒙皮权重和骨骼属性预测，增强动画真实感。其训练基于包含1.4万模型的大型数据集Rig-XL，确保生成骨架的通用性和可靠性，显著降低传统绑骨的技术门槛。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T22:02:26Z
- **目录日期**: 2025-04-11
