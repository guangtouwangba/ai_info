...
清华大学与VAST团队联合发布开源自动骨骼绑定框架UniRig，突破传统繁琐的3D模型骨骼绑定流程。该框架采用自回归模型逐关节预测骨架结构，创新性引入骨骼树Tokenization技术，使处理效率提升30%，支持人形、动物、幻想生物及机械结构的自动绑定。系统还能预测蒙皮权重和骨骼物理属性，增强动画真实感。基于包含1.4万模型的Rig-XL数据集训练，UniRig成为当前最先进的通用自动绑骨解决方案，显著降低3D创作门槛。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T19:02:34Z
- **目录日期**: 2025-04-11
