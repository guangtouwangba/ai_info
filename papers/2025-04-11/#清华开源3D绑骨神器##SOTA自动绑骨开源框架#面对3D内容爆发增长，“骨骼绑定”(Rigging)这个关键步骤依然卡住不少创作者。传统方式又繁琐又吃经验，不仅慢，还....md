...
清华大学团队开源了自动骨骼绑定框架UniRig，可自动为各类3D模型（包括人形、动物、幻想生物和机械结构）生成骨架。该框架采用自回归模型逐关节预测骨架，并创新使用骨骼树Tokenization技术提升30%效率，还能预测蒙皮权重和骨骼物理属性。基于包含1.4万模型的大型数据集Rig-XL训练，显著简化了传统繁琐的手动绑骨流程，为3D动画创作提供高效解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T16:02:45Z
- **目录日期**: 2025-04-11
