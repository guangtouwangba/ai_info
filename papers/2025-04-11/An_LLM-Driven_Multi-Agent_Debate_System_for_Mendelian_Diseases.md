...
研究人员开发了一种名为MD2GPS的创新多智能体辩论系统，用于提高孟德尔疾病的诊断准确性。该系统结合数据驱动和知识驱动智能体，通过语言模型将结果转化为自然语言并进行辩论，从而提升诊断效果。在四个独立数据集的1,185个样本测试中，TOP1准确率从42.9%平均提高到66%。在72例疑难病例中，该系统发现了12例患者的潜在致病基因，并将诊断时间缩短90%。该系统的模块化设计使其可替换方法，便于适应其他复杂疾病的诊断和研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T05:01:42Z
- **目录日期**: 2025-04-11
