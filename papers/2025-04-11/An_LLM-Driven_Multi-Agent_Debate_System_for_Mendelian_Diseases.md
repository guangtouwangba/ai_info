...
本文提出了一种创新性的LLM驱动多智能体辩论系统(MD2GPS)，用于孟德尔疾病的精准诊断。该系统通过语言模型将数据驱动和知识驱动代理的结果转化为自然语言，并促进两者间的辩论。在4个独立数据集(1,185样本)的测试中，TOP1准确率从42.9%提升至66%。在72例疑难病例中，MD2GPS为12名患者识别出潜在致病基因，诊断时间减少90%。该系统各模块方法可替换，便于扩展应用于其他复杂疾病的诊断研究。该成果为精准治疗和胚胎植入前遗传学诊断提供了有效工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T16:01:40Z
- **目录日期**: 2025-04-11
