...
研究人员开发了一个名为MD2GPS的创新多智能体辩论系统，用于提高孟德尔遗传病的诊断准确性。该系统结合数据驱动和知识驱动智能体，通过语言模型将结果转化为自然语言并促进两者辩论。在1,185个样本测试中，TOP1准确率从42.9%提升至66%；在72例疑难病例中，成功识别12例致病基因，诊断时间减少90%。该系统各模块方法可替换，有望拓展应用于其他复杂疾病的诊断研究。该系统解决了现有方法准确性不足或依赖大数据集的问题，为精准医疗和胚胎植入前遗传学诊断提供了新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T11:01:37Z
- **目录日期**: 2025-04-11
