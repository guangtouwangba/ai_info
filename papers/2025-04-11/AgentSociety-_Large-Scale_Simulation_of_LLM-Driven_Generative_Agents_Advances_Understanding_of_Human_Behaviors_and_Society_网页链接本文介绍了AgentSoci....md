...
这篇论文介绍了AgentSociety，一个利用大语言模型驱动的大规模社会模拟器，能够模拟超过1万个代理及其500万次互动。研究者用它研究了四个关键社会问题：社会极化、信息传播、基本收入政策和外部冲击影响。模拟结果与现实世界数据吻合，证明了该系统在捕捉人类行为机制方面的有效性。AgentSociety展现了作为社会科学研究和政策制定工具的潜力，能够辅助传统研究方法，帮助理解社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T19:04:44Z
- **目录日期**: 2025-04-11
