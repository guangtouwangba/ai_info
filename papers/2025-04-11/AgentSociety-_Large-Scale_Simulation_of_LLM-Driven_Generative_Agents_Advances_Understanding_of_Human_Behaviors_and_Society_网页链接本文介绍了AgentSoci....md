...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟超过1万个代理及其500万次互动。研究者用它分析四个关键社会问题：社会极化、信息传播、基本收入政策效果和外部冲击（如飓风）的影响。模拟结果与现实世界数据吻合，验证了该工具在揭示人类行为机制方面的有效性。该平台可作为计算社会科学的新研究方法，辅助传统调查和干预手段，为研究者和政策制定者提供重要参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T22:04:36Z
- **目录日期**: 2025-04-11
