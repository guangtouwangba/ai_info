...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟1万多个代理的社会互动（500万次交互）。研究者用它分析四个关键社会问题：群体极化、信息传播、基本收入政策效果和自然灾害影响。结果显示其模拟结果与现实数据高度吻合，验证了该工具在揭示人类行为机制和社会问题成因方面的有效性。该系统可作为传统社会科学研究方法（如调查、实验）的有力补充，为研究者和政策制定者提供新的分析平台。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T14:05:10Z
- **目录日期**: 2025-04-11
