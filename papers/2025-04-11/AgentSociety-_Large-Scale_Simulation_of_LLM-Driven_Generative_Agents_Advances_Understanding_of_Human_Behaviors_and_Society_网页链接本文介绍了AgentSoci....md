...
AgentSociety是一种基于大语言模型的大规模社会模拟器，可模拟1万多个代理及其500万次互动。该平台用于研究极化现象、信息传播、基本收入政策和外部冲击等社会问题，结果与现实世界数据吻合。研究表明，AgentSociety能有效捕捉人类行为机制，为社会科学研究和政策制定提供新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T05:05:11Z
- **目录日期**: 2025-04-11
