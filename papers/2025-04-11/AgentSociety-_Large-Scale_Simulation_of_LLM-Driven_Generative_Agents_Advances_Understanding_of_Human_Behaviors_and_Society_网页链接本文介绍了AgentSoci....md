...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能够模拟10,000多个AI代理及其500万次社会互动。该系统被用于研究四个关键社会问题：群体极化、信息传播、基本收入政策效果和自然灾害影响。研究结果显示，模拟结果与现实世界数据高度吻合，验证了该系统在捕捉人类行为机制方面的有效性。这一工具为社会科学研究和政策制定提供了新的实验平台，能够辅助传统研究方法，帮助理解复杂社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T08:05:02Z
- **目录日期**: 2025-04-11
