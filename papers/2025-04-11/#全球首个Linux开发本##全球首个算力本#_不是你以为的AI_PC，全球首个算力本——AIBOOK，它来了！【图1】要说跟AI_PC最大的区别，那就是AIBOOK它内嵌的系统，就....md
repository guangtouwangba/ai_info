...
AIBOOK是全球首款Linux开发本和算力本，由国内初创企业爱簿智能推出。它搭载Linux系统，支持50TOPS本地算力，可离线训练和推理AI模型，最高支持32B参数的大语言模型。配备32GB内存、1TB SSD和14英寸2.8K OLED屏，重量仅1.35kg。支持一键切换云桌面和安卓开发环境，已适配DeepSeek、Qwen等主流开源模型，端侧运行速度达15 tokens/s。主要面向开发者、AI爱好者和学生，解决算力不足和工具链短缺问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T18:03:33Z
- **目录日期**: 2025-04-11
