...
AIBOOK是全球首款Linux开发本和算力本，由国内初创企业爱簿智能推出。该设备搭载Linux系统，支持50TOPS本地算力，可离线训练和推理AI模型，最高支持32B参数的大语言模型（如DeepSeek、Qwen等）。配备32GB内存、1TB SSD和14英寸2.8K OLED屏，重1.35kg，兼具便携性与高性能。特色功能包括一键切换云桌面、Android容器支持，以及端侧运行7B模型（15 tokens/s）。主要面向开发者群体，解决AI开发中算力不足和工具链缺失的痛点。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T16:03:41Z
- **目录日期**: 2025-04-11
