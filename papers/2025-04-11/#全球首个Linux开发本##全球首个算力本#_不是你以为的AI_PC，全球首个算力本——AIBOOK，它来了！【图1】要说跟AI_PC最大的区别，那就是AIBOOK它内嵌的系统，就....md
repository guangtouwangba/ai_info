...
AIBOOK是全球首款Linux开发本和算力本，由中国初创企业爱簿智能推出。它搭载Linux系统，支持50TOPS本地算力，可离线训练和推理AI模型，最高支持32B参数的大语言模型（如DeepSeek、Qwen）。配备32GB内存、1TB SSD和14英寸2.8K OLED屏，重量仅1.35kg。支持一键切换云桌面及Android开发，解决了开发者面临的算力不足和工具链短缺问题。其便携性与高性能结合，成为AI学习和开发的理想工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T21:03:21Z
- **目录日期**: 2025-04-11
