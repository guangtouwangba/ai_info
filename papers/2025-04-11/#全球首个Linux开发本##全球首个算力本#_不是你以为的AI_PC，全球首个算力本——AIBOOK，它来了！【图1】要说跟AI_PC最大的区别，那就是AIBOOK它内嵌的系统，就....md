...
AIBOOK是全球首款Linux开发本和算力本，由国内初创企业爱簿智能推出。它搭载50TOPS算力，支持本地断网训练和推理AI模型，可运行32B参数大语言模型（如DeepSeek、Qwen等），端侧推理速度达15 tokens/s。配备32GB内存、1TB SSD和14英寸2.8K OLED屏，支持Linux原生开发、Windows云桌面及安卓容器。主要面向开发者，解决AI开发中算力不足和工具链缺失问题，实现"移动AI实训室"概念，厚度12.4mm，重1.35kg。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T23:03:17Z
- **目录日期**: 2025-04-11
