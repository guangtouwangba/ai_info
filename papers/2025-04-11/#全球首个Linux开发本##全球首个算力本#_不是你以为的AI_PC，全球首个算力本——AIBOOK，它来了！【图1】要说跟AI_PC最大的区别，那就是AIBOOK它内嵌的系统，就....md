...
AIBOOK是全球首款基于Linux系统的AI算力本，专为开发者设计。它具备50TOPS本地算力，支持断网训练和推理模型，可运行32B参数的大语言模型。配备32GB内存、1TB SSD和14英寸2.8K OLED屏幕，重量仅1.35kg。支持Linux原生开发，可切换云桌面进行Windows/安卓开发。已适配DeepSeek、Qwen等主流开源模型，端侧运行7B模型速度达15 tokens/s。由爱簿智能研发，主要面向开发者群体，解决了AI开发中算力不足和工具链缺失的痛点。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T20:03:31Z
- **目录日期**: 2025-04-11
