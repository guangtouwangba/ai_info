...
AIBOOK是全球首款基于Linux系统的AI算力本，专为开发者设计。其核心亮点包括：50TOPS本地算力支持离线AI训练/推理；预装Linux系统，可一键切换云Windows；支持运行32B参数大模型（如DeepSeek/Qwen），端侧推理速度达15 tokens/s；配备32GB内存+1TB SSD，14英寸2.8K OLED屏，重量仅1.35kg。由爱簿智能研发，主要解决开发者面临的算力不足和工具链缺失问题，支持VSCode直接本地训练模型，实现"移动AI开发工作站"概念。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T22:03:19Z
- **目录日期**: 2025-04-11
