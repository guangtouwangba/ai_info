...
AIBOOK是全球首款Linux开发本和算力本，由国内初创企业爱簿智能推出。它搭载Linux系统，支持50TOPS本地算力，可离线训练和推理AI模型（如7B参数大模型），并兼容Windows云桌面和Android开发。配备32GB内存、1TB SSD、14英寸2.8K OLED屏，重量仅1.35kg，支持主流开源大模型（DeepSeek/Qwen等）。主要面向开发者解决算力不足和工具链短缺问题，实现移动端高效AI开发。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T13:09:50Z
- **目录日期**: 2025-04-11
