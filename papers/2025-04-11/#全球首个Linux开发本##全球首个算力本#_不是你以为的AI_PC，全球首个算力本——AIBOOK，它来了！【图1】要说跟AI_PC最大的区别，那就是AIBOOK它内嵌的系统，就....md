# #全球首个Linux开发本##全球首个算力本# 不是你以为的AI PC，全球首个算力本——AIBOOK，它来了！【图1】要说跟AI PC最大的区别，那就是AIBOOK它内嵌的系统，就...
...
AIBOOK是全球首款基于Linux系统的AI算力本，由国内初创企业爱簿智能推出，主打开发者市场。其核心亮点包括：50TOPS本地算力支持断网AI训练/推理；预装Linux系统并支持Windows云桌面切换；可本地运行32B参数大模型（如DeepSeek、Qwen等），7B模型推理速度达15 tokens/s；配备32GB内存+1TB SSD，14英寸2.8K OLED屏，重量仅1.35kg。产品定位为移动AI开发平台，解决开发者面临的算力不足和工具链缺失问题，支持VSCode等开发环境一键模型训练与部署。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T19:03:25Z
- **目录日期**: 2025-04-11
