...
字节跳动最新推出的Seed-Thinking-v1.5模型在数学、代码等推理任务中表现超越DeepSeek-R1，尽管其参数规模更小。该模型采用MoE架构，总参数200B，激活参数20B，而DeepSeek-R1总参数为671B，激活参数37B。Seed团队通过三方面优化实现了更高效的AI性能。这一突破可能为字节旗下产品"豆包"带来显著能力提升。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T17:03:58Z
- **目录日期**: 2025-04-11
