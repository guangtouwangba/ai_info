...
字节推出新推理模型Seed-Thinking-v1.5，采用MoE架构，总参数200B，激活参数20B，在数学、代码等推理任务中表现优于DeepSeek-R1（总参数671B，激活参数37B）。该模型参数规模更小但性能更强，实现轻量级高效推理。字节Seed团队从三方面优化训练方法，使AI更智能。此次升级被称为豆包的"史诗级加强"。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T14:03:15Z
- **目录日期**: 2025-04-11
