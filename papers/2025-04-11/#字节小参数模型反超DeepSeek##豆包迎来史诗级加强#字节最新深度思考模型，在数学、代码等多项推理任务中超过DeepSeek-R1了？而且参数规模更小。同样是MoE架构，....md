...
字节跳动最新推出的Seed-Thinking-v1.5模型在数学、代码等推理任务中表现超越DeepSeek-R1，尽管其参数规模更小。该MoE架构模型总参数200B（激活参数20B），远低于DeepSeek-R1的671B总参数（激活37B）。团队通过三方面优化实现了更高效率。这一突破使豆包AI能力获得显著提升，展示了小参数模型的强大潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T09:02:51Z
- **目录日期**: 2025-04-11
