...
字节跳动最新推出的Seed-Thinking-v1.5模型在数学、代码等推理任务中表现优于DeepSeek-R1，尽管其参数规模更小。该MoE架构模型总参数为200B，激活参数20B，远低于DeepSeek-R1的671B总参数和37B激活参数。Seed团队通过三方面优化实现了更高效的AI性能提升。这一突破可能为豆包AI带来显著能力增强。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T21:03:37Z
- **目录日期**: 2025-04-11
