...
本文提出了CIGEval框架，用于条件图像生成任务的评估。该框架以大型多模态模型（LMMs）为核心，结合多功能工具箱和细粒度评估体系，能自主选择工具并进行分析。实验表明，GPT-4o版本的CIGEval与人工评估的相关性达0.4625，接近人工评估者间的相关性（0.47）。使用7B开源LMMs和仅2.3K训练轨迹时，其性能超越基于GPT-4o的现有最佳方法。案例研究显示，CIGEval能识别主题一致性和控制引导遵循等细微问题，展现了接近人类水平的自动化评估潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T01:28:49Z
- **目录日期**: 2025-04-11
