...
该研究提出了一个模拟框架，分析基于位置的"下一地点推荐系统"对城市动态的系统性影响。研究发现，虽然推荐算法能增加个人访问场所的多样性，但会加剧集体不平等——使访问集中在少数热门地点。这种影响还扩展到社交共现网络结构，可能影响城市可达性和空间隔离。该框架通过真实移动数据模拟人机反馈循环，揭示了AI辅助移动系统的社会影响，为预测风险、评估监管措施和设计伦理算法提供了工具。研究强调需平衡个体推荐效果与城市整体公平性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T16:01:09Z
- **目录日期**: 2025-04-11
