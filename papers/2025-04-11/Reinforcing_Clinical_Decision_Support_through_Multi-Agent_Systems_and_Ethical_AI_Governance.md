...
本文提出了一种基于多智能体系统的临床决策支持架构，通过模块化智能体分别分析实验室结果、生命体征和临床背景，并整合结果进行预测和验证。研究采用eICU数据库实现，包含实验室分析智能体、生命体征解读器和情境推理器，最终通过预测模块和验证智能体输出结果。该系统遵循伦理AI治理原则（自主性、公平性、问责制），采用透明业务逻辑实现。结果表明，该框架不仅提高了可解释性和准确性，还增强了重症监护场景中对AI辅助决策的信任度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T04:02:54Z
- **目录日期**: 2025-04-11
