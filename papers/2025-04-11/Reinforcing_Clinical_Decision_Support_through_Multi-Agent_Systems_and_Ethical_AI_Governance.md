...
本文提出了一种新型多智能体临床决策支持系统架构，采用模块化智能体分别分析实验室结果、生命体征和临床背景，并整合结果进行预测和验证。基于eICU数据库的实现表明，该系统遵循自主性、公平性和问责制等伦理AI治理原则，采用透明的业务逻辑。结果显示，该框架不仅提高了可解释性和准确性，还增强了重症监护环境下对AI辅助决策的信任度。这一数据驱动的方法为实现可信赖且有效的患者护理提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T19:02:05Z
- **目录日期**: 2025-04-11
