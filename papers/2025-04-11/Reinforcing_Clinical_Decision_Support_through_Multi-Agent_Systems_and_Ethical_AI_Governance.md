...
本文提出了一种新型多智能体临床决策支持系统架构，通过模块化智能体分析实验室结果、生命体征和临床背景，并整合这些数据驱动预测和验证结果。系统基于eICU数据库实现，包含实验室分析、生命体征解读和情境推理等专用智能体，以及预测模块和验证智能体。该透明化业务逻辑实现遵循自主性、公平性和问责制等伦理AI治理原则。结果表明，这种基于智能体的框架不仅提高了可解释性和准确性，还增强了重症监护环境中对AI辅助决策的信任度。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T18:02:12Z
- **目录日期**: 2025-04-11
