...
本文提出了一种新型多智能体临床决策支持系统架构，采用模块化智能体分别分析实验室结果、生命体征和临床背景，并通过整合结果驱动预测和验证。基于eICU数据库的实现表明，该系统遵循自主性、公平性和问责制等伦理AI原则，采用透明业务逻辑，不仅提高了可解释性和准确性，还增强了重症监护环境下对AI辅助决策的信任。该研究强调了在数据驱动医疗时代，将可解释且符合伦理的人工智能纳入临床决策支持系统的重要性，以实现可信赖且有效的患者护理。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T09:02:18Z
- **目录日期**: 2025-04-11
