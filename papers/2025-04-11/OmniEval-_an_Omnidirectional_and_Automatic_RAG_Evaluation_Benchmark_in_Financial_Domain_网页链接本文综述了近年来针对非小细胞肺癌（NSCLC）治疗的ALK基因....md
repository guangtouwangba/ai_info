...
本文综述了非小细胞肺癌（NSCLC）治疗中ALK基因双靶点抑制剂的最新进展。ALK基因是NSCLC的重要致癌驱动靶点，已有7种ALK抑制剂获批用于ALK融合阳性NSCLC，但耐药性问题突出。相比联合用药，双靶点抑制剂能同时作用于两个靶点，减少副作用和毒性，对抗耐药性更具优势。文章总结了基于ALK的双靶点抑制剂在NSCLC治疗中的研究进展，分析了其合理设计及构效关系，为开发新型ALK抑制剂和克服耐药性策略提供了重要见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-11T09:05:05Z
- **目录日期**: 2025-04-11
