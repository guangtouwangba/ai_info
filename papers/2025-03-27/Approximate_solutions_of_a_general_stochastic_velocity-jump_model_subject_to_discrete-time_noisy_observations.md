...
这篇论文研究了如何利用速度跳跃模型描述一维空间中单个运动体的轨迹。该模型假设运动体在有限状态网络中随机切换，每个状态对应特定速度和固定切换速率。由于无法直接观测隐藏状态，精确求解分布通常不可行。作者提出了一系列近似方法来计算数据分布，并通过四种模型结构的模拟验证了这些近似在状态切换频率足够低时的准确性。这些近似分布可用于快速预测、指导实验设计，并作为推断和模型选择的似然函数。研究为处理高分辨率时空跟踪数据提供了实用的数学工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T02:28:36Z
- **目录日期**: 2025-03-27
