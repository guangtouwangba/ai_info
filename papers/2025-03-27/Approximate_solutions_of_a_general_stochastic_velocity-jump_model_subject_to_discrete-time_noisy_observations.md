...
这篇论文研究了速度跳跃模型在一维空间中对单个运动个体的建模方法。该模型通过有限状态网络描述个体运动，每个状态具有特定速度和固定转换率。由于无法直接观测隐藏状态，精确分布计算通常难以实现。作者提出了一系列近似数据分布的方法，并通过四种模型结构的仿真验证了其准确性。结果表明，当状态转换频率足够低于成像频率时，这些近似是准确的。这些近似分布可用于快速预测、指导实验设计，并作为模型选择和推断的似然函数。研究为处理离散时间噪声观测数据提供了实用解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T01:29:32Z
- **目录日期**: 2025-03-27
