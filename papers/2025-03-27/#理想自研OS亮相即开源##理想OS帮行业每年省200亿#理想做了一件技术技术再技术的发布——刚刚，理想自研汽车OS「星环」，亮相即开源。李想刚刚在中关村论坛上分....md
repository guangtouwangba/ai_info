...
理想汽车在中关村论坛发布自研汽车操作系统「星环OS」并宣布开源。该系统源于2020年芯片短缺时期的研发，投入200人团队和10亿元资金，具备实时性强（响应速度比AUTOSAR快1倍）、稳定性高（提升5倍）等特点，能缩短AEB刹停距离7米，并实现软硬件解耦（芯片适配周期从6个月缩短至4周）。开源后预计每年为行业节省100-200亿元重复研发成本，主机厂可减少OS授权费用。李想表示，此举旨在推动行业创新，将节省资源用于提升产品安全与用户体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T16:03:06Z
- **目录日期**: 2025-03-27
