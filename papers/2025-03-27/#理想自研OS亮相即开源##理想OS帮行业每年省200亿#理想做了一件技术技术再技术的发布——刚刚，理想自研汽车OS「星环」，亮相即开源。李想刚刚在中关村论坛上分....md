...
理想汽车在中关村论坛发布了自研汽车操作系统「星环OS」，并宣布开源。该系统源于2020年芯片短缺时期的研发，耗时3年投入10亿元，具有实时性强、稳定性高（响应比AUTOSAR快1倍，稳定性高5倍）、支持多芯片适配（仅需4周）等特点，能优化AEB等功能的性能（120km/h刹停距离缩短7米），同时降低BOM成本（每年节省几十亿元）。开源后预计每年为行业节省100-200亿元重复研发费用，主机厂可减少OS授权支出。理想希望通过开源推动行业创新，提升整体竞争力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T13:09:33Z
- **目录日期**: 2025-03-27
