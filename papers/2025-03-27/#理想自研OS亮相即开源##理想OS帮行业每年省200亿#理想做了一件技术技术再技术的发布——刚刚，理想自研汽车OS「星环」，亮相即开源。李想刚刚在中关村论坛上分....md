...
理想汽车在中关村论坛发布了自研汽车操作系统「星环OS」并宣布开源。该系统源于2020年芯片短缺时期的研发，投入200人团队和10亿元资金，具有实时性强、稳定性高（响应速度比AUTOSAR快1倍，稳定性高5倍）、支持多芯片快速适配（仅需4周）等特点，能优化AEB性能（120km/h刹停距离缩短7米）并降低BOM成本（每年节省几十亿元）。开源后预计每年为行业减少100-200亿元重复研发投入，主机厂可节省数千万OS授权费。理想希望以此推动行业创新，提升用户体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T23:03:00Z
- **目录日期**: 2025-03-27
