...
理想汽车在中关村论坛发布自研汽车操作系统「星环OS」并宣布开源。该系统源于2020年芯片短缺时期的研发，具有实时性强、稳定性高（响应速度比AUTOSAR快1倍，稳定性高5倍）、硬件资源整合高效（降低BOM成本几十亿/年）及快速芯片适配（仅需4周）等特点。开源后预计每年为行业节省100-200亿元重复研发费用，主机厂可减少OS授权支出。李想表示此举旨在推动行业创新，将节省成本用于提升用户体验。系统4月底将在开源社区发布。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T14:03:13Z
- **目录日期**: 2025-03-27
