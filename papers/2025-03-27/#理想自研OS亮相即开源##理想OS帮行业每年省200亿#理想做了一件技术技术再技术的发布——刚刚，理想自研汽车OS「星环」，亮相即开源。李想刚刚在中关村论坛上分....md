...
理想汽车在中关村论坛发布了自研汽车操作系统「星环OS」，并宣布开源。该系统源于2020年芯片短缺时期的研发，投入200人团队和10亿元资金，具有实时性强、稳定性高（比AUTOSAR响应快1倍、稳定性高5倍）、支持多芯片快速适配（仅需4周）等特点，能缩短AEB刹停距离7米，并为车企每年节省数十亿元成本。开源后，行业预计每年可减少100-200亿元的重复研发投入，主机厂和供应商可节省大量授权费用。理想希望通过开源推动行业创新，提升整体技术效率和用户体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T22:02:52Z
- **目录日期**: 2025-03-27
