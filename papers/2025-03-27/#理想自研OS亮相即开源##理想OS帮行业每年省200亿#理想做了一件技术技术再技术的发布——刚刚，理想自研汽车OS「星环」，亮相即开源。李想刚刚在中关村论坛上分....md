...
理想汽车在中关村论坛发布了自研汽车操作系统「星环OS」并宣布开源。该系统源于2020年芯片短缺时期的研发，投入200人团队和10亿元资金，具有实时性强、稳定性高（响应速度比AUTOSAR快1倍，稳定性高5倍）、硬件资源整合高效（算力共享、传感器全车共用）以及芯片适配快速（仅需4周）等特点。开源后预计每年为行业节省100-200亿元重复研发成本，主机厂可减少OS授权费用。李想表示，此举旨在推动行业技术进步，将节省的资源用于提升产品安全和用户体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T09:02:54Z
- **目录日期**: 2025-03-27
