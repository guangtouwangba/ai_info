...
理想汽车在中关村论坛发布自研汽车操作系统「星环OS」并宣布开源。该系统源于2020年芯片荒时期的研发，投入200人团队和10亿元资金，具有实时性强、稳定性高（响应速度比AUTOSAR快1倍，稳定性高5倍）、硬件资源整合高效（降低BOM成本数十亿元）及芯片适配快（仅需4周）等特点。开源后预计每年为行业节省100-200亿元重复研发费用，主机厂可减少OS授权支出。李想表示，此举旨在推动行业创新，提升用户体验，4月底将在开源社区发布代码。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T19:02:44Z
- **目录日期**: 2025-03-27
