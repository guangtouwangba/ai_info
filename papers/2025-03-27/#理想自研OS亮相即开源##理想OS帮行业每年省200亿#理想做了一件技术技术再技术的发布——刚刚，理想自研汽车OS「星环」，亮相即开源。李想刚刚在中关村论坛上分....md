...
理想汽车在中关村论坛发布自研汽车操作系统「星环OS」并宣布开源。该系统源于2020年芯片荒时期的研发，具有实时性强、稳定性高（响应速度比AUTOSAR快1倍，稳定性高5倍）、硬件资源整合（算力共享、传感器复用）和快速芯片适配（仅需4周）等特点，能为车企节省数十亿成本。开源后，行业每年可减少100-200亿元的重复研发投入。李想表示，此举旨在推动行业创新，提升产品体验，4月底将在开源社区发布。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T20:02:44Z
- **目录日期**: 2025-03-27
