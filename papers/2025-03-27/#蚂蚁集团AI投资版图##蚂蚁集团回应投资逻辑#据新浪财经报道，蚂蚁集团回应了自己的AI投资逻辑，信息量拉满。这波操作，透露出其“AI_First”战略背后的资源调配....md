...
蚂蚁集团近期披露其AI投资布局，覆盖多个技术方向：大模型（智谱AI、月之暗面）、AI芯片（墨芯科技、清微智能）、智能体（深度赋智）、具身智能（星海图）及AI应用工具（秘塔科技等）。其战略核心是推动AI从概念到产业化，重点关注大模型与具身智能的融合，认为这将是未来技术突破的关键。蚂蚁强调长期投入的必要性，通过资源整合加速AI技术落地。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T00:04:15Z
- **目录日期**: 2025-03-27
