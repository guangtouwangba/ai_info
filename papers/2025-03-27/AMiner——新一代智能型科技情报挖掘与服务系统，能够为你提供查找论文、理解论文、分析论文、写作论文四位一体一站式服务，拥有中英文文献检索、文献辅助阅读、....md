...
AMiner是一个智能科技情报挖掘平台，提供四位一体的学术服务，包括论文检索、理解、分析和写作辅助。它支持中英文文献检索、AI辅助阅读、自动摘要生成和翻译功能，覆盖42个学科的3.5亿论文、0.6亿学者等数据。用户可通过互动问答快速获取文献核心内容，并订阅个性化的科研动态推送。平台还提供学者画像、学术会议追踪等特色功能，基础服务免费开放。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T16:05:41Z
- **目录日期**: 2025-03-27
