...
AMiner是一个集论文检索、阅读、分析和写作功能于一体的智能学术平台。它提供中英文文献搜索、AI辅助阅读、自动摘要生成和翻译功能，覆盖42个学科3.5亿论文资源。特色功能包括：1）智能问答快速理解文献；2）PDF文档解析与内容提炼；3）个性化科研情报订阅服务；4）学者画像和学术会议追踪。平台支持网页端免费使用，通过AI技术显著提升科研效率，帮助用户高效获取和管理学术信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T21:05:13Z
- **目录日期**: 2025-03-27
