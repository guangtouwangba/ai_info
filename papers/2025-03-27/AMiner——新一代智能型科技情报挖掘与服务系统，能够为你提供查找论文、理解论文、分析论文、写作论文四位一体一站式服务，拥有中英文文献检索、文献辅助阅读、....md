...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、科研情报订阅等一站式服务。其核心功能包括：1）高效检索3.5亿论文资源，支持智能问答和自动摘要生成；2）AI辅助阅读，可解析PDF文档并生成章节概要；3）个性化订阅服务，定期推送最新研究动态。平台还包含学者画像、学术会议等特色功能，覆盖42个学科领域。通过浏览器即可免费使用，旨在提升科研人员文献查阅和分析效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T09:05:57Z
- **目录日期**: 2025-03-27
