...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和科研订阅等一站式服务。它支持中英文文献检索，能自动生成摘要和问答互动，帮助用户高效筛选和理解论文。平台还具备文档识别、章节概要和深度问答功能，支持上传PDF或从文献库选取论文。用户可定制科研情报订阅，通过微信或邮件获取最新学术动态。此外，AMiner提供学者画像、学术会议和论文排行榜等功能，免费开放使用。访问官网或AI页面即可体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T10:06:08Z
- **目录日期**: 2025-03-27
