...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和科研订阅等一站式服务。它支持中英文文献搜索，能自动生成摘要和回答用户问题，帮助快速理解论文内容。平台还提供文献翻译、文档识别和个性化科研动态推送功能。AMiner收录了3.5亿论文、0.6亿学者等海量学术资源，可通过网页免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T22:05:22Z
- **目录日期**: 2025-03-27
