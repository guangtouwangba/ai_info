...
AMiner是一款智能科技情报挖掘系统，提供论文检索、翻译、分析及写作一站式服务。平台支持中英文文献搜索，拥有3.5亿论文、0.6亿学者等海量数据，并能通过AI生成摘要、辅助阅读和智能问答。用户可订阅个性化科研动态，追踪学者及机构最新成果。此外，AMiner还具备文献翻译、文档识别及学术会议推荐等功能，免费开放使用。访问入口：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T07:12:47Z
- **目录日期**: 2025-03-27
