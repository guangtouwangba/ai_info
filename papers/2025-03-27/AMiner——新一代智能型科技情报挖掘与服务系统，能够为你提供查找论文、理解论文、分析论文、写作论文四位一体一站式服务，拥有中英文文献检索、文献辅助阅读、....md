...
AMiner是一个智能科技情报挖掘系统，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献搜索，能自动生成摘要，并具备互动问答功能。此外，AMiner提供文献翻译、文档识别和辅助阅读工具，用户可上传PDF或从平台获取论文，AI技术可快速生成摘要和章节概要。平台还提供科研情报订阅服务，根据用户偏好推送最新学术动态。AMiner收录大量学术资源，包括3.5亿论文、0.6亿学者和1.5亿专利，并免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T11:05:59Z
- **目录日期**: 2025-03-27
