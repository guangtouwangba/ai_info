...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、辅助阅读和科研情报订阅等一站式服务。它拥有3.5亿论文、0.6亿学者、1.5亿专利和2600万科研项目数据。用户可通过互动问答快速理解文献内容，系统还能自动生成摘要。平台支持上传PDF文档进行AI辅助阅读，并提供定制化的科研动态推送服务。此外，AMiner还具备学者画像、学术会议和论文排行榜等功能，浏览器检索免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T14:05:54Z
- **目录日期**: 2025-03-27
