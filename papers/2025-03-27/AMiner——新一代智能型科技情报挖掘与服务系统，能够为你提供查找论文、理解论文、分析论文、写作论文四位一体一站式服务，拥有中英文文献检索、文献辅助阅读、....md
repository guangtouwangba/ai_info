...
AMiner是一个智能科技情报挖掘与服务平台，提供论文检索、阅读、分析和写作的一站式服务。其核心功能包括：1）中英文文献检索，帮助用户快速定位相关论文，并提供互动问答和自动摘要生成；2）英文文献翻译与辅助阅读，支持PDF上传并生成摘要、章节概要和智能问答；3）科研情报订阅，根据用户偏好推送最新学术动态。平台还包含学者画像、学术会议和论文专题等功能，覆盖42个学科的3.5亿论文资源。AMiner可免费使用，旨在提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T13:12:26Z
- **目录日期**: 2025-03-27
