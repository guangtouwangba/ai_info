...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作的一站式服务。它拥有42个学科的3.5亿论文、0.6亿学者和1.5亿专利数据，支持中英文文献检索、AI辅助阅读、自动摘要生成、翻译及互动问答功能。用户可订阅个性化科研动态，追踪机构、学者或关键词的最新研究。平台还提供学者画像、学术会议和论文排行榜等工具，浏览器版本免费使用。AMiner通过AI技术提升文献处理效率，帮助用户快速获取和理解学术信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T08:05:53Z
- **目录日期**: 2025-03-27
