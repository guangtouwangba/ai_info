...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析与写作的一站式服务。支持中英文文献搜索、AI辅助阅读、自动摘要生成及翻译功能，覆盖42个学科3.5亿论文资源。其特色包括互动问答理解文献、科研动态订阅推送（通过微信/邮件），以及学者画像等工具。用户可上传PDF或直接检索平台文献，获取章节概要、问题建议及深度内容解析。基础功能免费使用，适用于高效学术研究。平台网址：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T00:05:50Z
- **目录日期**: 2025-03-27
