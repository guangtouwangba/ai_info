...
这篇论文提出CodeArena基准测试和SynCode-Instruct语料库，以评估代码生成大模型（codeLLMs）与人类偏好的对齐程度。现有基准主要测试代码正确性，而CodeArena包含397个真实编程任务样本，覆盖40个类别和44种语言，更贴近实际需求。研究还构建了近200亿标记的合成指令数据集验证微调效果。实验显示，执行基准与人类偏好测试存在差异，开源模型（如Qwen2.5-Coder）与商业模型（如OpenAI o1）性能差距显著，凸显对齐人类偏好的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T16:05:51Z
- **目录日期**: 2025-03-27
