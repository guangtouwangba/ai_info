...
这篇论文提出了CodeArena基准和SynCode-Instruct语料库，用于评估代码生成大语言模型(codeLLMs)与人类偏好的对齐程度。CodeArena包含397个高质量样本，覆盖40类编程任务和44种语言；SynCode-Instruct则包含近200亿标记的合成指令数据。研究发现现有基准测试与人类偏好存在差距，开源模型(如Qwen2.5-Coder)与专有模型(如OpenAI o1)性能差异显著，强调了代码LLMs与人类偏好对齐的重要性。研究为提升代码生成模型的实际应用价值提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T03:35:54Z
- **目录日期**: 2025-03-27
