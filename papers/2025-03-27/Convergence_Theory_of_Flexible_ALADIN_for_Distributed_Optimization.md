...
本文提出了Flexible ALADIN算法，这是ALADIN分布式优化算法的一种随机轮询变体，旨在解决实际应用中因信息传输不可靠导致的数据包丢失问题。该研究对Flexible ALADIN进行了严格的收敛性分析，证明了其在凸问题上的全局收敛性和非凸问题上的局部收敛性，为网络优化和联邦学习等场景提供了更鲁棒的解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T19:01:48Z
- **目录日期**: 2025-03-27
