...
MagicDec研究发现，在大批量长文本推理场景下，投机解码(SD)技术仍能显著提升性能。通过分析瓶颈转移规律，该系统采用稀疏KV缓存的草稿模型缓解KV瓶颈，并提出理论模型优化草稿策略。实验显示，Llama3.1-8B模型在处理中长文本时，批量32-256范围内最高可获得2.51倍加速，且不损失准确性。该技术突破了传统认为SD仅适用于小批量的认知，证明其在保持高吞吐量的同时能有效降低延迟，为聊天机器人、文档分析等长文本应用提供了高效推理方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T22:02:12Z
- **目录日期**: 2025-03-27
