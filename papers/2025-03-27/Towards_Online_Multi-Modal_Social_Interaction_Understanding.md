...
该研究提出了一种在线多模态社交交互理解框架（Online-MMSI-VLM），用于解决人机交互中实时反馈的挑战。传统模型依赖未来上下文，而新框架仅利用历史信息（如对话和视频流），通过两种策略弥补未来信息缺失：1）多轮对话预测，以粗到细的方式模拟未来发言；2）社交感知视觉提示，利用边界框和人体关键点突出视频中的社交动态。在三个任务和两个数据集上的实验表明，该方法性能优于基线模型，达到了最先进水平。代码和预训练模型将开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T01:29:22Z
- **目录日期**: 2025-03-27
