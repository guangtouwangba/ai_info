...
AgentSociety是一个基于大语言模型的大规模社会模拟器，能模拟10,000多个代理及其500万次互动。它通过研究社会极化、信息传播、基本收入政策和自然灾害等案例，验证了其模拟结果与现实世界数据的一致性。该系统可作为计算社会科学实验平台，帮助研究者分析社会问题的模式和机制，为政策制定提供支持。研究表明，AgentSociety能有效捕捉人类行为特征，有望成为社会科学研究和政策评估的重要工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T17:05:03Z
- **目录日期**: 2025-03-27
