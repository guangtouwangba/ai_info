...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟1万多个代理及其500万次互动。该平台作为计算社会科学实验工具，研究了社会极化、信息传播、基本收入政策及飓风等外部冲击的影响。其模拟结果与现实数据吻合，验证了系统对人类行为和社会机制的捕捉能力，展现了在社会科学研究和政策制定中的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T16:05:15Z
- **目录日期**: 2025-03-27
