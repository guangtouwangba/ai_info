...
本文介绍了一种名为AgentSociety的大规模社会模拟器，它结合了大型语言模型驱动的代理、真实社会环境和强大的模拟引擎。研究者模拟了超过1万个代理及其500万次互动，并针对极化现象、信息传播、基本收入政策和外部冲击等四个社会问题进行了实验。结果显示，模拟结果与现实世界实验吻合，验证了该工具在捕捉人类行为和社会机制方面的能力。AgentSociety展现了作为社会科学研究和政策制定辅助工具的潜力，能够帮助理解社会问题的模式、原因和潜在机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T20:04:44Z
- **目录日期**: 2025-03-27
