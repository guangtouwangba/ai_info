...
本文研究了量子热力学中电子器件（transmon-微波腔系统）的功统计测量问题。微波腔作为功载体与transmon交换功，作者提出通过光子数检测测量功矩〈W^n〉的方案，并确定了捕捉功统计中量子相干性的条件。研究发现，通过测量高阶矩可验证包含量子干涉项的Jarzynski等式〈e^(-W/T)〉=1。该工作为复杂量子系统中的功统计测量提供了新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T20:01:39Z
- **目录日期**: 2025-03-27
