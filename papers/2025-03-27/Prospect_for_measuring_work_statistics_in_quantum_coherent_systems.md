...
这篇论文探讨了在量子热力学中测量电子器件功统计的方法，特别是通过研究transmon-微腔系统。微波腔作为功源与transmon交换功，作者提出了一种通过光子数检测测量功矩〈Wⁿ〉的方案。研究发现，通过测量高阶矩可以验证包含量子干涉效应的Jarzynski等式〈e⁻ᵂ∕ᵀ〉=1，并确定了捕捉功统计中量子相干性的条件。该工作为在复杂量子系统中测量功统计开辟了新途径，解决了传统随机热力学中测量这些统计量的困难。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T17:01:50Z
- **目录日期**: 2025-03-27
