...
量子热力学研究量子相干系统与热库或功源之间的热功交换。传统方法难以测量一般系统的功统计特性。本文提出一种通过光子数检测来测量电子器件(transmon-微腔系统)功统计矩〈W^n〉的方案，其中微波腔作为功源与transmon交换功。研究发现该方法能捕捉功统计中的量子相干性，并通过测量高阶矩验证包含量子干涉项的Jarzynski等式〈e^(-W/T)〉=1。该工作为测量复杂量子系统的功统计特性开辟了新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T09:01:58Z
- **目录日期**: 2025-03-27
