...
FALCONEye是一种新型视频检索系统，结合视觉语言模型(VLM)和大语言模型(LLM)，专门解决长视频(>1小时)信息定位难题。其创新点包括：1)针对长视频优化的元架构；2)基于短片段、字幕和置信度的高效探索算法；3)先进的VLM置信度校准技术。该系统能在标准计算资源上运行，并在新发布的FALCON-Bench(平均>1小时的视频问答基准)上表现优于现有技术，在相关基准测试中也达到相当或更好的性能。研究团队同时发布了FALCON-Bench，强调开放式问题评估的重要性。(99字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T01:29:13Z
- **目录日期**: 2025-03-27
