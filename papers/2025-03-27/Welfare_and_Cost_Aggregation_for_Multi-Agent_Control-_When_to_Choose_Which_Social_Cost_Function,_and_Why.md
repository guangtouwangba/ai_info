...
本文探讨了多智能体社会技术系统中社会成本函数(SCF)的选择问题。研究表明，SCF的选取应基于个体成本的可比性程度(从序数到完全基数可比性)以及所需满足的公理。通过借鉴社会选择理论，作者为控制应用提供了选择SCF的指导框架，指出不同假设和公理要求会导向不同的SCF形式，如经典功利总和、纳什SCF或最大最小化原则。最后，研究展示了该框架在水资源和交通分配中的实际应用价值，强调了SCF选择需要严格论证以避免不良后果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T03:17:34Z
- **目录日期**: 2025-03-27
