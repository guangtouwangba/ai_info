...
本文探讨了多智能体社会技术系统中社会成本函数(SCF)的选择问题。研究表明，SCF的选择取决于个体成本的可比性程度以及需要满足的公理条件。基于社会选择理论，作者提出了一个框架，通过分析效用可比性假设(从序数到完全基数可比性)和公理选择，来指导SCF的合理选择，如经典功利总和、纳什SCF或最大最小化方法。该框架可应用于水资源分配和交通资源管理等实际控制场景，确保资源分配的合理性。研究强调了SCF选择需要严格论证，以避免不良后果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T22:01:17Z
- **目录日期**: 2025-03-27
