...
该研究探讨了多智能体社会技术系统中社会成本函数(SCF)的选择问题。研究表明，SCF的选择取决于个体成本的可比性程度(从序数到完全基数可比性)以及所需满足的公理条件。基于社会选择理论，研究为控制系统应用提供了指导框架，说明不同假设条件下应选用何种SCF(如经典功利主义总和、纳什SCF或最大最小化原则)。最后，研究展示了该框架在水资源分配和交通资源管理中的实际应用价值。该成果为资源分配决策提供了理论基础，有助于避免因SCF选择不当导致的不良后果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T21:01:18Z
- **目录日期**: 2025-03-27
