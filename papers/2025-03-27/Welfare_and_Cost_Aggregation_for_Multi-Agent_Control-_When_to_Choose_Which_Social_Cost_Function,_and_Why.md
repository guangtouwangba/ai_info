...
该研究探讨了多智能体社会技术系统中社会成本函数（SCF）的选择问题。研究表明，SCF的选择取决于个体成本的可比性程度（从序数到完全基数可比性）以及所需满足的公理条件。基于社会选择理论，研究提出了如何根据效用可比性假设和公理要求（如功利总和、纳什SCF或最大化最小值）来合理选择SCF，以避免不良结果。研究还通过水资源分配和交通管理的实际案例，展示了该框架在资源分配中的实际应用价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T20:01:13Z
- **目录日期**: 2025-03-27
