...
本文探讨了多智能体社会技术系统中社会成本函数(SCF)的选择问题。研究表明，SCF的选取取决于个体成本的可比程度以及需要满足的公理条件。基于社会选择理论，作者提出了一个指导框架，指出不同的人际效用可比性假设(从序数到完全基数可比性)与公理选择共同决定了合适的SCF形式，如经典功利总和、纳什SCF或最大最小化原则。最后，该框架被成功应用于水资源和交通资源分配的实际案例，为这些领域的资源分配提供了理论依据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T19:01:16Z
- **目录日期**: 2025-03-27
