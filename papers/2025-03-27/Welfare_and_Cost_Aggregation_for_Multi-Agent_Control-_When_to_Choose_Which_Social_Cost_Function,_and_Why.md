...
这篇论文探讨了多智能体社会技术系统中社会成本函数(SCF)的选择问题。研究表明，SCF的合理选择取决于个体成本在智能体间的可比程度以及需要满足的公理条件。基于社会选择理论，作者提出了一个指导框架，指出不同效用可比性假设(从序数级到完全基数可比性)与公理选择的组合决定了合适的SCF形式，如经典功利主义总和、纳什SCF或最大化最小值方法。该框架可应用于水资源分配和交通管理等实际控制问题，为资源分配提供理论依据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T12:01:35Z
- **目录日期**: 2025-03-27
