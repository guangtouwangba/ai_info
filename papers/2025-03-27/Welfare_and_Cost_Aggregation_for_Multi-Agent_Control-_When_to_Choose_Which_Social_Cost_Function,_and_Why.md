...
该研究探讨了在多智能体社会技术系统中，如何通过社会成本函数(SCF)协调资源分配。研究表明，SCF的选择取决于个体成本的可比性程度和所需满足的公理条件。基于社会选择理论，研究揭示了不同效用可比性假设(从序数到完全基数可比性)与公理选择如何共同决定合适的SCF形式，如经典功利总和、纳什SCF或最大化最小值。研究框架可应用于水资源分配和交通管理等实际场景，为资源分配提供了理论依据。研究强调了SCF选择需要严格论证，以避免不良后果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T17:01:24Z
- **目录日期**: 2025-03-27
