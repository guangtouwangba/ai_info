# #英伟达收购贾扬清AI创业公司#AI Infra的洗牌也开始了。国内AI Infra项目竞速白热化之际，硅谷也有跑得快的项目曝出新动态。据科技媒体The Information报道，英...
...
英伟达即将收购AI基础设施创业公司Lepton AI，该公司由前阿里副总裁贾扬清于2023年创立。Lepton AI专注于帮助客户创建和部署AI大模型，主要产品包括经济高效的云GPU解决方案FastGPU和轻量级AI搜索引擎Lepton Search。此次收购被视为英伟达强化AI基础设施布局的战略举措，以应对云服务商的竞争。贾扬清作为深度学习框架Caffe的开发者，其技术背景也是收购的重要因素。这反映了AI基础设施领域正在加速整合。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T01:29:56Z
- **目录日期**: 2025-03-27
