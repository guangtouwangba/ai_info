...
本文综述了心脏消融技术（射频消融、冷冻消融和脉冲场消融）及其计算模型应用，重点探讨计算建模如何提升治疗精度、安全性和有效性。通过分析能量传递、热分布和组织反应，研究发现计算方法可预测消融结果并优化参数，但需充分验证。未来需进一步收集可靠的体内数据以验证模型，促进其临床转化，改善患者预后。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T07:08:05Z
- **目录日期**: 2025-03-27
