...
本文综述了心脏消融技术（射频消融、冷冻消融和脉冲场消融）及其计算模型的应用。重点探讨了计算建模在优化消融精度、安全性和有效性方面的作用，特别是热管理方面。研究表明，数值方法和人工智能模型可预测消融效果、优化参数并提高安全性，但需充分验证。未来需进一步收集可靠体内数据以验证模型，促进其临床应用，改善患者预后。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T18:01:31Z
- **目录日期**: 2025-03-27
