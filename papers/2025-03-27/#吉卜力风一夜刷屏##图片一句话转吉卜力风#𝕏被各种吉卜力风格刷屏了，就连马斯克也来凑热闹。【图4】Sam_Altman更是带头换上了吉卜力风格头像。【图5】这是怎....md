...
近日，GPT-4o的图像生成功能引发社交媒体刷屏热潮，用户只需上传图片并输入"转成吉卜力风格"指令，即可将照片转换为宫崎骏动画风格。包括马斯克、Sam Altman等名人也参与其中，换上吉卜力风格头像。但这一功能引发版权争议，OpenAI回应称其政策允许模仿"工作室风格"而非在世艺术家个人风格，但法律合规性尚待法院裁定。该技术展示出AI强大的风格迁移能力，同时也凸显了生成式AI在艺术版权领域的模糊地带。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T15:04:26Z
- **目录日期**: 2025-03-27
