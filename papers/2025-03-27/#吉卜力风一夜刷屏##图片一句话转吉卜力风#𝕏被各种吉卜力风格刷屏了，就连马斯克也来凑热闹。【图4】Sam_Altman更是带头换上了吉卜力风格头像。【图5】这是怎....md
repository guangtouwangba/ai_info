...
近日，GPT-4o的图像生成功能引发热潮，用户只需上传图片并输入"转成吉卜力风格"指令，即可一键生成宫崎骏动画风格的图像。包括马斯克、Sam Altman在内的名人都参与了这场风格转换狂欢，小米创始人雷军的吉卜力版肖像也在网络流传。不过，这种AI复制工作室艺术风格的行为引发了版权争议。OpenAI表示其政策允许模仿"工作室风格"，但回避在世艺术家的个人风格。目前法律尚未对此类AI创作作出明确界定，相关版权问题仍需等待司法裁决。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T22:04:01Z
- **目录日期**: 2025-03-27
