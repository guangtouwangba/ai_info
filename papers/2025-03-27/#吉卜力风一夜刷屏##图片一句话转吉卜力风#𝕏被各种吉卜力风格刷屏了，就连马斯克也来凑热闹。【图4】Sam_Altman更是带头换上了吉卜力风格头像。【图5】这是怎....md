...
近日，GPT-4o的图像生成功能引发热潮，用户只需上传图片并输入"转成吉卜力风格"的指令，即可将照片转换为日本吉卜力工作室的经典动画风格。这一功能迅速风靡社交网络，连马斯克、Sam Altman等名人也参与其中。不过，这种AI模仿行为引发了版权争议——OpenAI声称仅复制"工作室风格"而非在世艺术家个人风格，但法律界定尚不明确，最终需由法院裁定。该事件既展示了AI技术的创造力，也凸显了数字时代艺术风格版权的新挑战。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T18:03:52Z
- **目录日期**: 2025-03-27
