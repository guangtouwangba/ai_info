...
GPT-4o最新图像生成功能引发网络热潮，用户只需上传图片并输入"转成吉卜力风格"的指令，即可将照片转换为吉卜力工作室的经典动画风格，连马斯克、Sam Altman等名人也参与其中。但该功能引发版权争议，OpenAI回应称其政策允许模仿"工作室风格"而非在世艺术家个人风格，但法律合规性尚待法院裁定。目前社交平台涌现大量AI生成的吉卜力风格头像和名人图像，包括雷军的卡通形象，相关话题#图片一句话转吉卜力风#成为热门讨论焦点。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T10:04:28Z
- **目录日期**: 2025-03-27
