# #吉卜力风一夜刷屏##图片一句话转吉卜力风#𝕏被各种吉卜力风格刷屏了，就连马斯克也来凑热闹。【图4】Sam Altman更是带头换上了吉卜力风格头像。【图5】这是怎...
...
近日，GPT-4o的图像生成功能引发热潮，用户只需上传图片并输入"转成吉卜力风格"的指令，即可将照片转换为吉卜力工作室的经典动画风格。包括马斯克、Sam Altman在内的多位名人纷纷参与，相关话题在社交媒体刷屏。不过，这种AI模仿知名工作室艺术风格的行为也引发版权争议。OpenAI回应称其政策允许复制"工作室风格"，但回避"在世艺术家个人风格"。目前法律尚未对此类AI创作作出明确界定，最终合规性需等待司法裁定。（99字）  

注：原文包含的图片示例（图4-6）及具体操作步骤因字数限制未纳入摘要，核心保留了技术现象、社会反响和版权争议三大要素。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T19:03:47Z
- **目录日期**: 2025-03-27
