...
近日，GPT-4o的图像生成功能引发热潮，用户只需上传图片并输入"转成吉卜力风格"的指令，即可将普通照片转换为宫崎骏动画风格。马斯克、Sam Altman等名人纷纷换上吉卜力风格头像，相关话题在社交媒体刷屏。但该功能也引发版权争议，OpenAI回应称其政策允许模仿"工作室风格"而非在世艺术家个人风格，但法律合规性尚待法院裁定。网友创作的吉卜力版雷军等作品在网络上广泛传播，展现了AI图像生成的强大能力与潜在版权风险。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T12:04:26Z
- **目录日期**: 2025-03-27
