...
近日GPT-4o的图像生成功能引发热潮，用户只需上传图片并输入"转成吉卜力风格"的指令，就能一键生成宫崎骏动画风格的图像，包括马斯克、Sam Altman等名人也参与其中。但该功能引发版权争议，OpenAI回应称其政策允许模仿"工作室风格"而非在世艺术家个人风格，但法律合规性尚待法院裁定。网友创作的"吉卜力版雷军"等作品在社交媒体广泛传播，展现了AI强大的风格迁移能力，同时也凸显了生成式AI在艺术风格版权方面的灰色地带。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T06:03:19Z
- **目录日期**: 2025-03-27
