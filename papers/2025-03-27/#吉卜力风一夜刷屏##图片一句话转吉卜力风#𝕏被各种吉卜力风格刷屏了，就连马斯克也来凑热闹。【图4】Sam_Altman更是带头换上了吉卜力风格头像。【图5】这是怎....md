...
近日，GPT-4o的图像生成功能引发热潮，用户只需上传图片并输入"转成吉卜力风格"的指令，即可将照片转换为吉卜力工作室的经典动画风格。这一功能迅速风靡社交平台，连马斯克、Sam Altman等名人也参与其中。但该技术也引发版权争议，OpenAI回应称其政策允许模仿"工作室风格"而非在世艺术家个人风格，但法律合规性仍需法院裁定。目前网友已创作出吉卜力版雷军等趣味图像，相关话题#图片一句话转吉卜力风#登上热搜。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T20:03:49Z
- **目录日期**: 2025-03-27
