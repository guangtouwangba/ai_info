...
近日，GPT-4o的图像生成功能引发热潮，用户只需上传图片并输入"转成吉卜力风格"的指令，即可一键生成宫崎骏动画风格的图像。包括马斯克、Sam Altman在内的名人都参与了这场创意互动，雷军等公众人物的吉卜力风格形象也在网络疯传。不过，这种AI模仿知名工作室美术风格的行为引发版权争议，OpenAI回应称其政策允许复制"工作室风格"但避免模仿在世艺术家个人风格。目前法律尚未对此类AI创作作出明确界定，相关争议可能需要通过司法程序逐步解决。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T08:03:50Z
- **目录日期**: 2025-03-27
