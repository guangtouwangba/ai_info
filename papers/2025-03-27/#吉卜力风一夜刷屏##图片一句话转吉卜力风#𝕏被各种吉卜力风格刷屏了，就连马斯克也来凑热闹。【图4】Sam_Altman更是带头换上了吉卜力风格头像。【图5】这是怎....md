...
GPT-4o最新图像生成功能引发吉卜力风格热潮，用户只需上传图片并输入提示词即可一键转换，马斯克、Sam Altman等名人纷纷参与。该功能支持将照片转为吉卜力工作室经典画风，但引发版权争议。OpenAI回应称不模仿在世艺术家个人风格，但允许复制"工作室风格"，法律界定尚不明确，需等待法院裁决。网友尝试生成的吉卜力版雷军等形象引发广泛讨论。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T17:04:06Z
- **目录日期**: 2025-03-27
