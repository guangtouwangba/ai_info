...
近日，GPT-4o的图像生成功能引发热潮，用户只需上传图片并输入提示词"转成吉卜力风格"，即可一键生成宫崎骏动画风格的图像。包括马斯克、Sam Altman在内的名人都参与了这一趋势，相关话题在社交媒体刷屏。但该功能也引发版权争议，OpenAI回应称其政策允许模仿"工作室风格"而非在世艺术家个人风格，但法律合规性仍需法院裁定。目前网友已创作出吉卜力风格的小米创始人雷军等趣味图像，展现了AI强大的风格迁移能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T09:04:09Z
- **目录日期**: 2025-03-27
