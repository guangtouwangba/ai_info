...
近日GPT-4o的图像生成功能引发热潮，用户只需上传图片并输入"转成吉卜力风格"的指令，即可将普通照片转换为宫崎骏动画风格。马斯克、Sam Altman等名人纷纷换上吉卜力风格头像，相关话题在社交媒体刷屏。但该功能也引发版权争议，OpenAI回应称其政策允许模仿"工作室风格"而非在世艺术家个人风格，法律界定尚不明确。网友尝试生成包括雷军在内的各种人物吉卜力风格画像，效果引发讨论，但相关版权问题需等待司法裁定。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T16:04:16Z
- **目录日期**: 2025-03-27
