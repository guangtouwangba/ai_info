...
近日，GPT-4o的图像生成功能引发热潮，用户只需上传图片并输入"转成吉卜力风格"的指令，即可将照片转换为宫崎骏动画风格。包括马斯克、Sam Altman在内的名人也参与其中，相关话题在社交媒体刷屏。但这一技术引发版权争议——OpenAI声称仅复制"工作室风格"而非在世艺术家个人风格，但法律界定尚不明确，需等待司法裁决。网友创作的"吉卜力版雷军"等作品展示了该功能的强大效果，同时也凸显了AI艺术创作面临的版权灰色地带。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T11:04:16Z
- **目录日期**: 2025-03-27
