...
近日，GPT-4o的图像生成功能引发社交媒体热潮，用户通过简单指令即可将照片转为吉卜力动画风格，连马斯克、Sam Altman等名人也参与其中。该功能只需上传图片并输入"转成吉卜力风格"的提示词即可实现。但这一技术也引发版权争议，OpenAI回应称其政策允许模仿"工作室风格"而非在世艺术家个人风格，但法律合规性尚待法院裁定。网友创作的吉卜力风格名人头像（如雷军）在网络上广泛传播，凸显了AI艺术生成与版权保护的模糊边界。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T05:02:56Z
- **目录日期**: 2025-03-27
