...
随着智能城市监控摄像头和在线视频应用的普及，公共安全和隐私保护问题日益突出，推动了视频异常检测(VAD)成为人工智能领域的重要研究方向。深度学习与边缘计算的进步使VAD从算法研究扩展到可部署的网络系统(NSVAD)，成为AI、物联网和计算技术的交叉热点。本文系统梳理了深度学习VAD的基础假设、学习框架和应用场景，为初学者提供教程；通过综述最新进展和典型方案阐明核心概念，并汇总研究资源。最后展望了AI与计算技术融合解决现存挑战、开拓新机遇的发展趋势，为研究者提供前瞻指导。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T14:02:38Z
- **目录日期**: 2025-03-27
