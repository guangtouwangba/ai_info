...
随着智能城市监控摄像头和在线视频应用的普及，公共安全和隐私保护问题日益突出，推动了视频异常检测(VAD)成为人工智能领域的基础研究任务。深度学习与边缘计算的进步使VAD从算法工程扩展到可部署的网络系统(NSVAD)，成为AI、物联网视频和计算领域的交叉热点。本文系统梳理了深度学习VAD的基础假设、学习框架和应用场景，为初学者提供详细教程；通过综述最新进展和典型方案阐明核心概念，并汇总研究资源。最后展望未来趋势，探讨AI与计算技术如何解决现有挑战并创造新机遇，为研究者提供指导。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T15:02:43Z
- **目录日期**: 2025-03-27
