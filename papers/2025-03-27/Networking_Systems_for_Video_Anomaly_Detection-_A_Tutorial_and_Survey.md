...
随着智能城市监控摄像头和在线视频应用的普及，公共安全和隐私保护问题日益突出，推动了视频异常检测(VAD)成为人工智能领域的基础研究任务。深度学习与边缘计算的进步使VAD技术取得显著发展，其应用已从算法工程扩展到可部署的网络系统(NSVAD)，成为AI、物联网视频和计算领域的交叉研究热点。本文系统梳理了深度学习驱动VAD的基本假设、学习框架和应用场景，汇总了最新进展和典型解决方案，并展望了AI与计算技术融合解决现存挑战的未来趋势，为研究者提供全面指导。相关资源见GitHub链接。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T12:02:46Z
- **目录日期**: 2025-03-27
