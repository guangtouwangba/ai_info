...
AI辅助编码工具通过代码大语言模型(CodeLLM)显著提升开发效率，自动化代码生成、补全等重复任务。不同任务对延迟要求各异：代码补全需关注首令牌时间(TTFT)，代码翻译需端到端延迟(E2E)。现有方案难以兼顾并发任务延迟与资源利用率。为此提出的CATO系统能同时处理多样化编码任务，实验显示：在并发场景下，TTFT关键任务吞吐量提升10%，资源利用率提高41.1%；代码摘要E2E延迟降低18%，代码生成TTFT减少14%，优于现有方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-27T01:29:03Z
- **目录日期**: 2025-03-27
