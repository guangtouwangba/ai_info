...
本文通过理论模型研究了拍卖中预筛选策略的经济合理性。研究发现，基于噪声预测的预筛选相当于使竞标者估值产生相关性，但不符合传统关联性假设。研究分析了全支付、第一价格和第二价格拍卖中的均衡策略条件，结果显示：全支付拍卖中预筛选能显著提高收益（完美预测时仅需2名竞标者），而第一和第二价格拍卖中允许所有竞标者参与仍是最优策略。这为拍卖者利用AI技术选择性筛选高价值竞标者提供了理论依据，尤其适用于全支付拍卖场景。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T14:02:07Z
- **目录日期**: 2025-04-26
