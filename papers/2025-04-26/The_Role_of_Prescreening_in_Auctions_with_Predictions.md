...
本文通过理论模型分析了拍卖中"预筛选"策略的经济合理性。研究发现，基于噪声预测器的预筛选拍卖等价于竞标者估值相关的标准拍卖，但不符合传统关联性假设。研究比较了全支付、第一价格和第二价格三种拍卖形式，发现：在全支付拍卖中，预筛选能显著提高收益（完美预测时仅需2名竞标者即可达到最优）；而在第一价格和第二价格拍卖中，允许所有竞标者参与仍是收益最大化的选择。这表明拍卖形式不同，预筛选策略的效果存在显著差异。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T15:02:08Z
- **目录日期**: 2025-04-26
