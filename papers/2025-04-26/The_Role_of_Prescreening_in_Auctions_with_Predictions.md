...
本文通过理论模型分析了拍卖行利用机器学习筛选竞拍者的经济合理性。研究表明，基于噪声预测的预筛选相当于标准拍卖中竞拍者估值的相关性，但不符合传统关联性假设。在三种经典拍卖形式中：全支付拍卖中预筛选能显著提高收入（完美预测时仅需2名竞拍者即可最优）；而一级价格和二级价格拍卖中，允许所有竞拍者参与仍是收益最大化的选择。研究揭示了不同拍卖机制下预筛选策略的差异化效果，为拍卖设计提供了理论依据。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T19:02:02Z
- **目录日期**: 2025-04-26
