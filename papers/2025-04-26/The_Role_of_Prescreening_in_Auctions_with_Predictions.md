...
本文通过理论模型研究了拍卖中预筛选竞标者的经济合理性。研究发现，基于噪声预测器的预筛选相当于标准拍卖中竞标者估值的相关性，但不符合传统的关联性假设。研究分析了全支付、第一价格和第二价格拍卖中的均衡策略条件，结果显示：在全支付拍卖中，预筛选能显著提高收入，完美预测时仅允许两名竞标者最优；而在第一和第二价格拍卖中，允许所有竞标者参与仍能实现收入最大化。这表明拍卖形式不同，预筛选策略的经济效果存在显著差异。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T11:02:18Z
- **目录日期**: 2025-04-26
