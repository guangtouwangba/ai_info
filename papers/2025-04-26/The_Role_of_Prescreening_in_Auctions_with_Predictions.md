...
本文研究了拍卖中通过预筛选（prescreening）策略选择竞标者的经济合理性。模型假设竞标者具有独立同分布的私人估值，拍卖设计者通过噪声预测器筛选参与者。研究发现，预筛选拍卖等同于标准拍卖中估值相关的情形，但传统关联性假设不成立。研究揭示了全支付拍卖、第一价格和第二价格拍卖中对称严格单调均衡策略的存在条件。结果显示，全支付拍卖中预筛选能显著提高收益（完美预测时仅需2名竞标者），而第一和第二价格拍卖中允许所有竞标者参与仍是收益最大化的最优策略。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T04:02:14Z
- **目录日期**: 2025-04-26
