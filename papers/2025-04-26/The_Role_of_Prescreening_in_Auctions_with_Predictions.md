...
本文通过理论模型分析了拍卖中预筛选竞标者的经济合理性。研究发现，基于噪声预测器的预筛选相当于标准拍卖中竞标者估值存在相关性，但不符合传统关联性假设。研究比较了全支付、第一价格和第二价格拍卖，发现预筛选能显著提高全支付拍卖的收益（完美预测时仅需两名竞标者即可实现最优），但对第一价格和第二价格拍卖而言，允许所有竞标者参与仍是收益最大化的选择。该研究为拍卖设计者利用AI技术优化竞标者筛选策略提供了理论依据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T23:02:08Z
- **目录日期**: 2025-04-26
