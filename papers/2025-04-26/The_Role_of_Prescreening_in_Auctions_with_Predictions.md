...
本文通过理论模型研究了拍卖行利用机器学习预筛选竞标者的经济合理性。研究发现，基于噪声预测器的预筛选机制相当于标准拍卖中竞标者估值的相关性，但不符合传统关联性假设。研究分析了全支付、第一价格和第二价格三种拍卖形式，证明预筛选能显著提升全支付拍卖的收益（完美预测时仅需2名竞标者即可实现最优收益），但在第一价格和第二价格拍卖中，允许所有竞标者参与仍是收益最大化的选择。该研究为人工智能时代拍卖策略提供了理论依据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T02:28:17Z
- **目录日期**: 2025-04-26
