...
本文通过理论模型分析了拍卖中预筛选（prescreening）策略的经济合理性。研究假设竞拍者拥有独立同分布的私人估值，拍卖设计者通过噪声预测器筛选竞标者数量。研究表明，预筛选拍卖等同于标准拍卖中估值相关的情形，但传统关联性假设不成立。在三种经典拍卖形式中：全支付拍卖中，预筛选能显著提升收益，完美预测时仅需两名竞标者即可实现最优；而在一价和二价拍卖中，允许所有竞标者参与仍是收益最大化的选择。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T21:02:10Z
- **目录日期**: 2025-04-26
