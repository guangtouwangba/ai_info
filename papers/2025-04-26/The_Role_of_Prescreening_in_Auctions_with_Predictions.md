...
本文通过理论模型分析了拍卖中预筛选策略的经济合理性。研究发现，基于噪声预测器筛选竞拍者相当于标准拍卖中竞拍者估价存在相关性，但这种相关性通常不满足传统关联性假设。研究比较了全支付、第一价格和第二价格三种拍卖形式，发现预筛选能显著提升全支付拍卖的收益（完美预测时仅需两名竞拍者即可实现最优收益），但在第一价格和第二价格拍卖中，允许所有竞拍者参与仍是收益最大化的选择。这表明拍卖形式不同，预筛选策略的效果存在显著差异。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T10:02:12Z
- **目录日期**: 2025-04-26
