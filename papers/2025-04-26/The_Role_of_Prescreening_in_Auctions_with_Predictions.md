...
本文研究了拍卖中通过预筛选（prescreening）选择性限制竞标者数量以提升稀缺性和声望的经济合理性。作者建立理论模型，分析竞标者具有独立同分布私有估值时，拍卖设计者基于估值噪声预测器筛选竞标者数量的效果。研究表明：预筛选拍卖等价于估值相关的标准拍卖，但不符合传统关联性假设。在三种经典拍卖形式中，全支付拍卖（all-pay）通过预筛选能显著提高收益（完美预测时仅需2名竞标者），而一级价格和二级价格拍卖仍以允许所有竞标者参与为最优策略。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T00:02:21Z
- **目录日期**: 2025-04-26
