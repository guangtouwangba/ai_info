...
本文通过理论模型分析了拍卖中预筛选策略的经济合理性。研究表明，基于噪声预测器的预筛选相当于标准拍卖中竞标者估值的相关性，但不符合传统关联性假设。在三种经典拍卖形式中：全支付拍卖中，预筛选能显著提升收益，完美预测器下仅允许两名竞标者最优；而在一价和二价拍卖中，允许所有竞标者仍是最佳策略。模型假设竞标者具有独立同分布私有估值，拍卖设计者通过噪声预测器筛选参与者，揭示了预筛选策略在不同拍卖机制中的差异化收益效果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T20:02:17Z
- **目录日期**: 2025-04-26
