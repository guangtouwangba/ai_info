...
本文通过理论模型研究了拍卖中预筛选竞标者的经济合理性。在竞标者估值独立同分布且拍卖方拥有估值噪声预测器的设定下，分析显示：预筛选拍卖等价于估值相关的标准拍卖，但传统关联性假设不成立。研究确定了全支付、第一价格和第二价格拍卖中对称严格单调均衡策略的存在条件。关键发现：全支付拍卖中，预筛选能显著提升收益（完美预测时仅需2名竞标者）；而第一价格和第二价格拍卖中，允许所有竞标者参与仍是收益最大化的最优策略。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T13:06:47Z
- **目录日期**: 2025-04-26
