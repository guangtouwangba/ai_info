...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟器，能够模拟超过1万个代理及其500万次互动。研究者用它研究了四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害冲击。模拟结果与现实实验数据吻合，验证了该工具捕捉人类行为机制的能力。AgentSociety可作为计算社会科学的新平台，为研究者和政策制定者提供传统方法之外的补充研究手段，有助于深入理解社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T14:04:56Z
- **目录日期**: 2025-04-26
