...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能模拟1万多个AI代理的社会互动（500万次）。研究者用它分析四大社会问题：群体极化、信息传播、基本收入政策影响和自然灾害应对。结果显示其模拟结果与现实数据高度吻合，验证了系统对人类行为机制的捕捉能力。该系统可作为社会科学研究和政策制定的创新工具，为传统研究方法（如调查、实验）提供补充。研究突显了LLM在社会仿真中的潜力，为理解复杂社会现象提供了新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T23:04:40Z
- **目录日期**: 2025-04-26
