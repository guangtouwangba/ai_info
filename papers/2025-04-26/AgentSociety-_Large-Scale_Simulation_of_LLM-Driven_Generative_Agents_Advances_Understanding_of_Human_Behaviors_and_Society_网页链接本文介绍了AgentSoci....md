...
AgentSociety是一个基于大型语言模型的大规模社会模拟器，可模拟10,000多个代理及其500万次互动。研究者利用它探索了社会极化、信息传播、基本收入政策及自然灾害影响等社会问题。模拟结果与现实实验数据吻合，验证了其捕捉人类行为机制的能力。该系统可作为计算社会科学研究的创新工具，为政策制定提供新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T02:31:16Z
- **目录日期**: 2025-04-26
