...
这篇论文介绍了AgentSociety——一个基于大语言模型的大规模社会模拟系统，可以模拟10,000多个智能体之间的500万次互动。该系统被用于研究四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。研究结果显示模拟结果与现实世界数据高度吻合，证明该系统能有效捕捉人类行为机制。AgentSociety为社会科学研究和政策制定提供了强大的新型工具，能够补充传统研究方法（如调查和访谈），帮助深入理解复杂社会现象的内在规律。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T12:05:14Z
- **目录日期**: 2025-04-26
