...
AgentSociety是一个基于大语言模型的大规模社会模拟器，通过模拟1万多个代理及其500万次互动，研究人类行为和社会现象。该系统被用于分析极化现象、信息传播、基本收入政策及自然灾害影响等社会问题，结果与现实数据吻合，验证了其有效性。研究表明，AgentSociety能辅助传统社会科学方法，揭示社会问题的模式和机制，为研究者和政策制定者提供有力工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T01:32:05Z
- **目录日期**: 2025-04-26
