...
本文提出EgoCHARM算法，通过单个头戴式惯性测量单元(IMU)实现高效的人体活动识别。该分层算法采用半监督学习策略，主要使用高级活动标签训练，可学习通用低级运动嵌入特征。在9种高级和3种低级活动识别中分别获得0.826和0.855的F1分数，模型参数仅63k(高级)和22k(低级)，可直接部署在当前IMU芯片上。研究还分析了基于头戴IMU的活动识别技术的敏感性和局限性，为智能眼镜在健康监测和情境感知AI等应用提供了资源高效的解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T22:01:02Z
- **目录日期**: 2025-04-26
