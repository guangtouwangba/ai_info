...
中国《石氏星表》可能是世界最古老星图，引发学界争议。国家天文台何勃亮团队通过霍夫变换算法分析，发现部分恒星坐标可追溯至公元前355年（石申时期），部分为公元125年更新。但中科大杨伯顺等学者认为数据可能源于公元前103年后汉代学者的整理，由存在1°偏差的仪器测量所致。争议焦点在于观测年代判定和仪器误差影响。无论具体年代如何，《石氏星表》作为中国天文学珍贵遗产，展现了早期球面坐标应用，对世界天文史具有重要意义。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T00:03:09Z
- **目录日期**: 2025-04-26
