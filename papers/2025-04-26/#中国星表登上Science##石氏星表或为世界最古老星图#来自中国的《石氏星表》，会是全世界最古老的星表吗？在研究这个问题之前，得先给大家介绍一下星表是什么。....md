...
中国《石氏星表》可能是世界最古老的星表，其年代存在争议。国家天文台团队通过霍夫变换算法分析，发现部分数据可追溯至公元前355年（石申时期），部分为公元125年更新。但中科大等学者认为数据可能源于公元前103年后，由汉代学者整理，并受当时浑天仪1°偏差影响。尽管具体年代尚无定论，《石氏星表》作为中国天文学瑰宝，展现了早期球面坐标系的应用，对世界天文史贡献重大。相关研究发表于《Science》。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T04:03:10Z
- **目录日期**: 2025-04-26
