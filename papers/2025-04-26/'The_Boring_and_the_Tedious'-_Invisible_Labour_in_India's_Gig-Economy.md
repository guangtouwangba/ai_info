...
印度食品配送平台（如Swiggy和Zomato）为边缘群体提供重要收入，但也通过隐形劳动加剧工人困境。基于14次半结构化访谈，研究发现等待时间和重复性UI交互是导致"数字不适"的主要负担。工人虽采取策略应对算法管理，但仍受平台"游戏化"和系统不透明性的限制。研究提出以工人为中心的GUI自动化作为干预方案，在减少摩擦的同时保留自主权。该立场论文主张，全球南方的HCI设计应优先考虑工人自主性，而非效率驱动的优化。  
