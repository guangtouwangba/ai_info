...
印度外卖平台（如Swiggy和Zomato）为边缘群体提供重要收入，但也通过隐形劳动加剧工人困境。基于14次访谈，研究发现等待时间和重复性UI交互是导致"数字不适"的主要负担。工人虽采取策略应对算法管理，但仍受平台"游戏化"和系统不透明的限制。研究建议通过以工人为中心的GUI自动化减少摩擦，同时保留自主权。最后，论文主张在全球化南部的HCI设计中，应优先考虑工人自主性而非效率驱动的优化。  
