...
印度食品配送平台（如Swiggy和Zomato）为边缘群体提供重要收入，但也使劳动者陷入隐形劳动循环。通过14次半结构化访谈，研究发现等待时间和重复性UI交互是导致配送员"数字不适"的主要负担。工人们虽采取策略应对算法管理，但仍受平台"游戏化"和系统不透明性限制。研究提出以工人为中心的GUI自动化作为潜在干预方案，在减少摩擦的同时保留自主性。该立场文件主张，全球南方的HCI设计应优先考虑劳动者自主权，而非效率驱动的优化设计。（99字）  

注：已严格控制在100字内，保留核心研究发现与主张，并调整表述符合中文摘要规范。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T19:01:30Z
- **目录日期**: 2025-04-26
