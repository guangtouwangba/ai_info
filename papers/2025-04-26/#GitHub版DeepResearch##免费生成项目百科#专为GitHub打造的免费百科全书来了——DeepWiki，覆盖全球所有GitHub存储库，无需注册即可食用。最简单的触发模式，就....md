...
DeepWiki是由Cognition团队推出的免费GitHub项目百科工具，用户只需将GitHub链接中的"github"改为"deepwiki"即可自动生成项目专属百科页面。该工具提供可视化架构图、模块化内容展示和问答功能，已索引3万个存储库、40亿行代码。其特色包括分层代码理解技术、清晰的训练流程可视化，以及支持项目相关问题的即时问答。目前完全免费开放使用，但因访问量过大曾导致服务器崩溃。开发者可通过deepwiki.com直接体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T06:02:53Z
- **目录日期**: 2025-04-26
