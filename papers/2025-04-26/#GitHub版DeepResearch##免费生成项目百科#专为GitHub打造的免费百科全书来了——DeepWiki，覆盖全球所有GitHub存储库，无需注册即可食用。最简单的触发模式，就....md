...
DeepWiki是由Cognition推出的免费GitHub项目百科工具，用户只需将GitHub链接中的"github"改为"deepwiki"即可自动生成项目专属百科页面。该工具提供可视化架构图、清晰的项目概述和交互式对话框，支持深度提问。已索引3万个存储库，处理40多亿行代码，采用分层结构技术提升代码理解效率。目前完全免费开放使用，但因访问量过大导致服务器过载，团队正在扩容优化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T12:03:07Z
- **目录日期**: 2025-04-26
