...
DeepWiki是由Cognition团队推出的免费GitHub项目百科全书，用户只需将GitHub链接中的"github"改为"deepwiki"即可自动生成项目百科页面。该工具提供可视化架构图、模块化内容展示和问答功能，已索引3万个仓库、40亿行代码。其特色包括分层代码理解技术、清晰的训练流程展示和即时对话咨询，极大提升了开发者查阅效率。目前完全免费开放使用，但因访问量过大曾导致服务器崩溃。该功能源自Devin 2.0的Wiki模块，开发成本超30万美元。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T22:02:39Z
- **目录日期**: 2025-04-26
