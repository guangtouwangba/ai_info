...
DeepWiki是由Cognition推出的免费GitHub项目百科工具，用户只需将GitHub链接中的"github"改为"deepwiki"即可自动生成项目专属百科页面。该工具提供可视化架构图、分层代码解析和问答功能，已索引3万个存储库、40亿行代码。其特色包括：
1. 无需注册直接使用
2. 支持项目架构可视化展示
3. 内置AI问答对话框
4. 提供两种访问方式（链接修改/专用搜索）
目前免费开放，但因访问量过大曾导致服务器崩溃。开发者称索引成本已超30万美元。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T11:03:02Z
- **目录日期**: 2025-04-26
