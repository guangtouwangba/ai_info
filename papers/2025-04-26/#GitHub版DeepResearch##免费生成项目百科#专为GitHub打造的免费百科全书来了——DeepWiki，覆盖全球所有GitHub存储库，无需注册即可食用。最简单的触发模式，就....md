...
DeepWiki是由Cognition推出的免费GitHub项目百科工具，用户只需将GitHub链接中的"github"改为"deepwiki"即可自动生成项目百科页面。该工具覆盖全球所有GitHub存储库，提供可视化架构图、项目概述和问答功能，索引了3万个存储库和40亿行代码。采用分层结构理解代码库，显著提升开发者查阅效率。目前完全免费开放使用，但因访问量过大曾导致服务器崩溃。开发者可通过搜索或修改URL两种方式使用该服务。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T17:02:42Z
- **目录日期**: 2025-04-26
