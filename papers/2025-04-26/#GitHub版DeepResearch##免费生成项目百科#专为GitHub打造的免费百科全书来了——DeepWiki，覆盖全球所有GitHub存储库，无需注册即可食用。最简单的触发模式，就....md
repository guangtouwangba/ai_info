...
DeepWiki是由Cognition推出的免费GitHub项目百科工具，用户只需将GitHub链接中的"github"改为"deepwiki"即可自动生成项目专属百科页面。该工具提供可视化架构图、项目概述、技术细节解析，并支持AI对话查询功能。目前已索引3万个存储库，处理40多亿行代码，采用分层结构理解代码库，显著提升开发者查阅效率。虽然因访问量过大曾导致服务器崩溃，但目前仍免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T07:02:43Z
- **目录日期**: 2025-04-26
