...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析、写作等一站式服务。它收录了3.5亿论文、0.6亿学者等海量学术资源，支持中英文文献检索和互动问答，能自动生成摘要和章节概要。用户可上传PDF文档获取AI辅助阅读，还能定制科研情报订阅服务，通过微信或邮件接收最新学术动态。平台还包含学者画像、学术会议等特色功能，基础检索服务免费开放。访问入口：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T22:04:44Z
- **目录日期**: 2025-04-26
