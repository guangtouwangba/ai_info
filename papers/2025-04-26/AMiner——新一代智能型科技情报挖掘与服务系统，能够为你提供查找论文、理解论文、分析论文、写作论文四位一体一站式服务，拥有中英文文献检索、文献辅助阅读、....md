...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和科研订阅等一站式服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持中英文文献搜索，并能通过AI生成摘要和问答互动帮助用户快速理解内容。平台还提供文献翻译、个性化科研动态推送，以及学者画像等特色功能。用户可通过网页或小程序免费使用，实现高效学术研究和论文写作。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T01:32:30Z
- **目录日期**: 2025-04-26
