...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译和分析等一站式服务。它收录了42个学科的3.5亿论文、0.6亿学者和1.5亿专利，支持中英文文献检索、AI生成摘要、互动问答和文档翻译。用户可订阅个性化科研动态，追踪机构、学者或关键词的最新研究。平台还提供学者画像、学术会议和论文排行榜等功能，基础服务免费使用。网址：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T08:05:21Z
- **目录日期**: 2025-04-26
