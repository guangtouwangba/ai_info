...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、翻译、辅助阅读和论文写作支持。它拥有3.5亿论文、0.6亿学者等海量数据，支持AI生成摘要、互动问答和内容翻译。用户可订阅个性化科研动态，追踪机构、学者及关键词，并通过微信或邮件接收更新。平台还提供学者画像、学术会议等特色功能，基础服务免费开放。访问入口：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T19:04:49Z
- **目录日期**: 2025-04-26
