...
本研究提出了一种名为"集成贝叶斯推理(EBI)"的新方法，通过贝叶斯估计整合多个小型语言模型(SLM)的判断，使其性能超越单个模型。实验表明，即使在日语和英语的多种任务中，EBI都能有效提升表现，甚至整合性能较差的模型也能改善整体效果。该方法为在有限计算资源下构建高性能AI系统提供了新思路，同时展示了如何有效利用单个性能较低的模型。研究建立在现有的大模型评估、集成方法和开源模型应用基础上，具有重要的创新意义。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T16:01:48Z
- **目录日期**: 2025-04-26
