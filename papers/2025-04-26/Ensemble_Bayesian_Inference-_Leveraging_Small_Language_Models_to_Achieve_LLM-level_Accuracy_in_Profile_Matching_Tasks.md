...
本研究提出了一种名为"集成贝叶斯推理(EBI)"的新方法，通过贝叶斯估计整合多个小型语言模型(SLM)的判断，使其性能超越单个模型。实验证明，EBI在多种任务(包括日语和英语的资质评估与消费者画像分析)中表现优异，甚至能有效利用性能较差的模型提升整体表现。该方法为在有限计算资源下构建高性能AI系统开辟了新途径，并展示了如何有效利用性能较低的模型。研究建立在现有大型语言模型评估、集成方法和开源模型应用的基础上，具有重要的创新意义。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T05:01:42Z
- **目录日期**: 2025-04-26
