...
本研究提出了一种名为"集成贝叶斯推理(EBI)"的新方法，通过贝叶斯估计整合多个小型语言模型(SLM)的判断，使其性能超越单个模型的限制。实验表明，即使在包含负提升值的模型中，EBI也能提高整体表现，且在多语言任务(如日语和英语的资质评估与用户画像分析)中均有效。这一发现为在有限计算资源下构建高性能AI系统提供了新思路，同时展示了如何有效利用性能较低的个体模型。该方法基于现有的大模型评估、集成方法和开源模型应用研究，具有重要的创新意义。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T04:01:44Z
- **目录日期**: 2025-04-26
