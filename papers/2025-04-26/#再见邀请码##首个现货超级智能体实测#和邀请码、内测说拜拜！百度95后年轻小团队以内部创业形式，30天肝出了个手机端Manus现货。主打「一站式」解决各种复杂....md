...
百度推出名为"心响App"的现货超级智能体，由年轻团队30天开发完成。该应用突破传统AI助手一问一答模式，提供一站式解决方案，覆盖200多种任务类型，包括健康管理（如定制减脂计划并每日提醒）、工作学习、AI社交（含虚拟伴侣）等场景。已上线安卓平台，无需邀请码即可使用，在百度Create大会正式发布。其特点是能根据简短指令生成详细方案并持续跟进，实现从问题识别到执行的完整服务闭环。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T15:03:06Z
- **目录日期**: 2025-04-26
