...
百度推出全新"心响App"，这是一款无需邀请码的现货超级智能体应用。该产品由年轻团队30天快速开发完成，突破传统AI助手一问一答模式，能一站式解决200多种复杂任务。实测显示，它能根据简单指令生成完整方案（如定制减脂计划），并支持设置例行提醒。功能覆盖工作、学习、生活多场景，甚至包含AI社交功能。目前已上线安卓平台，在百度Create大会正式发布。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T10:03:11Z
- **目录日期**: 2025-04-26
