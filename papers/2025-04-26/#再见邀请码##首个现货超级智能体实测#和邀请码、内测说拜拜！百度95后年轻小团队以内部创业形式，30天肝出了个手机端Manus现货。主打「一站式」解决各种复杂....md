...
百度推出名为"心响App"的现货超级智能体，由95后团队30天开发完成，已上线安卓应用商店。该应用突破传统AI助手一问一答模式，能一站式解决复杂问题，覆盖200多种任务类型，包括健康管理（如定制减脂计划并每日提醒）、工作学习、AI社交（提供虚拟伴侣）等场景。用户通过简短指令即可获得详细定制方案，并可将任务设为日常提醒。产品在百度Create大会亮相，主打通用型智能服务，无需邀请码即可使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T12:03:26Z
- **目录日期**: 2025-04-26
