...
百度推出全新AI应用"心响App"，由95后团队30天开发完成，主打一站式解决复杂问题。该应用突破传统问答模式，支持200多种任务类型，覆盖工作、学习、生活等领域。用户只需简单指令即可获得定制化方案，如减脂计划包含饮食、运动等模块，并能设置每日提醒。特色功能包括AI相亲等情感交互。作为现货产品，心响App已在安卓平台上线，在百度Create大会正式亮相，提供即时可用的超级智能体服务。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T11:03:21Z
- **目录日期**: 2025-04-26
