...
百度推出的"心响App"是一款现货超级智能体应用，由95后团队30天开发完成。该应用突破传统AI助手一问一答模式，提供一站式解决方案，支持200多种任务类型，涵盖工作、学习、生活等领域。特色功能包括：根据简短提示生成完整减脂计划（含饮食、运动、行为干预建议），并能设为每日打卡任务；还提供AI相亲等情感服务。应用已上线安卓商店，在百度Create大会正式发布，主打免邀请码、免内测的现货体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T13:07:45Z
- **目录日期**: 2025-04-26
