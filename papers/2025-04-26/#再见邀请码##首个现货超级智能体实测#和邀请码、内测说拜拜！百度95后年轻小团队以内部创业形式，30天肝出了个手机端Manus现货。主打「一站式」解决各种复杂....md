# #再见邀请码##首个现货超级智能体实测#和邀请码、内测说拜拜！百度95后年轻小团队以内部创业形式，30天肝出了个"手机端Manus"现货。主打「一站式」解决各种复杂...
...
百度推出的"心响App"是一款现货超级智能体应用，由95后团队30天快速开发完成。该应用突破传统AI助手一问一答模式，提供一站式解决方案，支持200多种任务类型，覆盖工作、学习、生活等领域。特色功能包括：根据简短指令生成完整方案（如减脂计划）、设置例行任务提醒、甚至提供AI相亲等情感服务。目前已上线安卓平台，无需邀请码即可使用，在百度Create大会正式亮相。演示显示其能快速响应复杂需求，如制定包含饮食、运动、行为干预的个性化健康计划。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T20:03:21Z
- **目录日期**: 2025-04-26
