...
百度推出名为"心响App"的现货超级智能体，由年轻团队30天开发完成。这款手机端AI助手突破传统问答模式，可一站式解决200多种复杂任务，覆盖工作、学习、生活等领域。特色功能包括：1）根据简短指令生成完整方案（如定制减脂计划）；2）支持设置例行任务（如每日健身打卡）；3）提供AI社交（虚拟伴侣）。该应用已在安卓商店上线，无需邀请码即可使用，展示了从健康管理到情感陪伴的多场景服务能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T22:02:55Z
- **目录日期**: 2025-04-26
