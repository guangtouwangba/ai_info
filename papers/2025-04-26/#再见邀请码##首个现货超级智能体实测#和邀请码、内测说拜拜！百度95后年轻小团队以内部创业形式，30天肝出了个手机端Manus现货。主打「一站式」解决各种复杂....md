...
百度推出全新"心响App"——首个现货超级智能体，无需邀请码即可使用。这款由95后团队30天开发的手机端AI助手，突破传统一问一答模式，能一站式解决200多种生活场景需求。实测显示，输入简单指令即可生成完整方案（如定制减脂计划并设置每日打卡），覆盖健康、教育、法律甚至AI相亲等功能。目前安卓版已上线，在百度Create大会正式亮相，主打"通用超级智能体"定位，实现从任务规划到持续跟进的智能服务闭环。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T14:03:04Z
- **目录日期**: 2025-04-26
