...
研究人员提出了AmbResVLM方法，用于解决机器人语言条件策略中任务描述模糊导致执行失败的问题。该方法通过将语言目标与场景关联并显式推理任务模糊性，显著提升了任务检测和解决能力。实验表明，在模拟和真实环境中，其性能优于现有最优方法，并将下游机器人策略的成功率从69.6%提升至97.1%。相关数据、代码和模型已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T06:01:05Z
- **目录日期**: 2025-04-26
