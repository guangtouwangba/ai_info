...
本文提出AmbResVLM方法，用于解决语言条件策略中的任务描述模糊性问题。该方法通过将语言目标与场景结合并进行显式模糊性推理，显著提升了机器人对模糊任务的理解能力。实验证明，该方法在模拟和真实环境中都优于现有技术，能有效检测和解决任务模糊性。实际机器人测试显示，下游策略的成功率从69.6%提升至97.1%。相关数据、代码和模型已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T04:01:08Z
- **目录日期**: 2025-04-26
