...
网易有道在AIGC峰会上指出，大模型正推动教育领域变革，目前已进入个性化辅导（第二阶段）和主动辅导学习（第三阶段），未来将实现虚拟老师（第四阶段）。AI教育主要覆盖学校、家庭和自学三大场景，通过C端产品（如学习硬件）和订阅服务反哺大模型发展，2024年AI订阅销售额超2亿，同比增长130%。硬件被视为教育大模型落地的关键载体。该模式强调以用户需求驱动技术迭代，加速教育智能化规模化应用。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T23:03:01Z
- **目录日期**: 2025-04-26
