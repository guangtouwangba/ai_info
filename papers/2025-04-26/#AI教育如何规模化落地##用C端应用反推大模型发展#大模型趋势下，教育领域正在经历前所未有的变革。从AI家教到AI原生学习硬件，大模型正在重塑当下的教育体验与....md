...
网易有道在AIGC峰会上指出，AI教育已进入个性化辅导阶段，正向虚拟老师演进。其通过C端产品反推大模型发展，2024年AI订阅销售额超2亿，同比增长130%。三大落地场景为学校、家庭和自学，智能硬件是关键载体。目前行业处于第二（个性化辅导）、第三阶段（主动辅导），第四阶段虚拟老师即将实现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T20:03:12Z
- **目录日期**: 2025-04-26
