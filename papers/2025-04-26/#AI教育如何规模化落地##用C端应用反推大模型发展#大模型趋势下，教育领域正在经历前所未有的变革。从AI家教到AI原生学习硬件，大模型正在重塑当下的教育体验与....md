...
网易有道在AIGC产业峰会上指出，大模型正推动教育领域变革，目前已进入个性化辅导（第二阶段）和主动辅导学习（第三阶段），虚拟老师（第四阶段）即将实现。其通过C端产品（如AI家教、学习硬件）和会员服务反向推动教育大模型发展，2024年AI订阅销售额超2亿，同比增长130%。核心场景覆盖学校、家庭和自学，硬件成为重要载体。当前策略以用户需求驱动技术迭代，加速AI教育规模化落地。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T14:02:53Z
- **目录日期**: 2025-04-26
