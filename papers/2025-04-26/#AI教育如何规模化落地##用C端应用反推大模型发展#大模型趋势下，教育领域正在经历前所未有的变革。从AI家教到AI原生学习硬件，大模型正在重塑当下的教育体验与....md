...
网易有道在第三届AIGC产业峰会上指出，AI教育已进入个性化辅导和主动辅导学习阶段，正向虚拟老师发展。通过C端产品和会员服务推动教育大模型发展，2024年AI订阅销售额超2亿，同比增长130%。教育大模型主要应用于学校、家庭和自学三大场景，硬件是其落地重要载体。当前重点是通过用户需求反推技术演进，实现规模化应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T07:02:52Z
- **目录日期**: 2025-04-26
