...
网易有道在第三届AIGC峰会上指出，AI教育已进入个性化辅导阶段（第二阶段），正向主动辅导学习（第三阶段）和虚拟老师（第四阶段）发展。当前通过C端产品和会员服务（2024年AI订阅销售额超2亿）反推教育大模型落地，硬件是关键载体。三大应用场景覆盖学校、家庭和自学，形成“产品驱动技术”的发展路径。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T09:03:01Z
- **目录日期**: 2025-04-26
