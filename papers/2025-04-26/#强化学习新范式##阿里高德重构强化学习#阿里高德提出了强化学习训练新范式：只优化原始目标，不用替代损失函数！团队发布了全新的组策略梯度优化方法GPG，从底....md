...
阿里高德提出强化学习新范式GPG，直接优化原始目标而无需替代损失函数。该方法突破传统框架，消除评论模型和KL散度约束，采用组内平均奖励归一化降低方差，并引入动态梯度校正机制解决样本偏差问题。GPG在单/多模态任务中表现优异，尤其在数学推理和视觉理解等复杂任务中展现出卓越的通用性和鲁棒性，显著提升训练效率和策略稳定性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T16:03:43Z
- **目录日期**: 2025-04-26
