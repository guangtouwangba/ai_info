...
阿里高德提出强化学习新范式GPG，突破传统方法：1）直接优化原始目标，摒弃替代损失函数；2）简化架构，去除评论模型和KL约束；3）首创精准梯度估计(AGE)技术，解决奖励偏差问题。该方法通过组内奖励归一化和动态梯度校正，显著提升训练效率和稳定性。在数学推理、视觉理解等任务中表现优异，展现出强大的通用性和鲁棒性。GPG为强化学习训练提供了更简洁高效的框架，相关技术细节已在开源文章中公布。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T14:03:34Z
- **目录日期**: 2025-04-26
