...
阿里高德提出强化学习新范式GPG，直接优化原始目标而无需替代损失函数。该方法突破传统框架，消除了评论模型和KL散度约束，引入精准梯度估计(AGE)技术降低奖励偏差。通过组内平均奖励归一化和动态梯度校正机制，显著提升训练效率和稳定性。在数学推理、视觉理解等复杂任务中展现出优异性能，单/多模态任务表现均超越现有方法。这一革新性训练架构为强化学习领域提供了更简洁高效的解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T07:03:32Z
- **目录日期**: 2025-04-26
