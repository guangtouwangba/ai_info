...
阿里高德提出强化学习新范式GPG，直接优化原始目标而无需替代损失函数。该方法创新性地简化了训练架构，去除评论模型和KL散度约束，并引入精准梯度估计(AGE)来降低奖励偏差。GPG通过组内平均奖励归一化和动态梯度校正机制，显著提升了训练稳定性和效率。在数学推理、视觉理解等复杂任务中表现出优越性能，超越了现有方法。这一突破性框架为强化学习领域提供了更高效、稳定的训练新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T13:08:15Z
- **目录日期**: 2025-04-26
