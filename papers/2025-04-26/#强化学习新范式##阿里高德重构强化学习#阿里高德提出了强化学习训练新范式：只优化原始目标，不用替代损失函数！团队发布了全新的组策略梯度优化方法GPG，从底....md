...
阿里高德提出强化学习新范式GPG，直接优化原始目标而无需替代损失函数。该方法突破传统框架，消除评论模型和KL散度约束，首创精准梯度估计(AGE)技术解决奖励偏差问题。通过组内平均奖励归一化和动态梯度校正机制，显著提升训练效率和稳定性。实验显示，GPG在数学推理、视觉理解等复杂任务中表现优异，超越现有方法，展现出强大的通用性和鲁棒性。该研究为强化学习训练流程带来根本性革新。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T05:03:08Z
- **目录日期**: 2025-04-26
