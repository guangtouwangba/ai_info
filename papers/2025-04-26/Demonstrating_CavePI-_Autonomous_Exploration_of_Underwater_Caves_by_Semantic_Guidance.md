...
本文介绍了专为水下洞穴探索设计的自主水下航行器CavePI及其视觉伺服框架。该系统采用轻量级深度视觉感知模块进行环境语义理解，并通过鲁棒控制机制实现复杂洞穴结构的导航。研究通过实地水下洞穴测试和ROS数字孪生仿真验证了该系统在无GPS、低能见度等恶劣环境下的可靠导航性能，为水资源管理、考古学等领域提供了创新解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T23:02:16Z
- **目录日期**: 2025-04-26
