...
本文介绍了用于水下洞穴自主探索的视觉伺服系统CavePI，集成了轻量级深度视觉感知模块和鲁棒控制机制，可在GPS失效、特征匮乏的低能见度环境中实现语义引导导航。该系统通过硬件与边缘AI设计优化，支持复杂洞穴结构的语义识别与路径跟踪。研究通过真实水下洞穴和泉水的实地测试，以及基于ROS的数字孪生仿真验证了其可靠性。成果对水资源管理、水文地质、考古及海洋机器人领域具有重要意义，展现了在极端环境下自主导航的技术突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T20:02:26Z
- **目录日期**: 2025-04-26
