...
本文介绍了CavePI水下自主机器人系统的设计与算法集成，用于在GPS缺失、特征匮乏的低能见度水下洞穴环境中进行语义引导的自主探索。该系统采用轻量级深度视觉感知模块实现环境语义理解，并通过鲁棒控制机制跟踪语义标记完成复杂洞穴导航。研究通过真实水下洞穴实地测试和ROS数字孪生仿真验证了系统性能，展示了其在资源管理、水文地质等领域的应用潜力。集成设计使机器人能够在恶劣条件下可靠导航，为水下自主探测提供了新方案。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T00:02:30Z
- **目录日期**: 2025-04-26
