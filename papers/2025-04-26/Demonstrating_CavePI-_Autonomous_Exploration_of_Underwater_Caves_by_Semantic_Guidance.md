...
本文介绍了CavePI自主水下机器人（AUV）的视觉伺服系统，用于水下洞穴探索。该系统结合轻量化深度视觉感知模块和鲁棒控制机制，可在GPS失效、特征缺失的低能见度环境中实现语义引导导航。研究团队通过实地水下洞穴测试和ROS数字孪生仿真验证了系统性能。该技术对水资源管理、水文地质、考古等领域具有重要意义，展示了在复杂洞穴结构中可靠导航的能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T19:02:09Z
- **目录日期**: 2025-04-26
