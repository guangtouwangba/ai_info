...
本文介绍了用于自主水下洞穴探索的视觉伺服系统CavePI，通过轻量级深度学习模块实现环境语义理解，并采用鲁棒控制机制导航复杂洞穴结构。该系统在自然水下洞穴和泉水中进行了实地测试，并通过ROS数字孪生仿真验证。研究展示了该系统在缺乏特征、无GPS和低能见度条件下的可靠导航能力，对水资源管理、水文地质学、考古学和海洋机器人学具有重要意义。集成设计实现了水下洞穴的安全高效探索与测绘。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T08:02:21Z
- **目录日期**: 2025-04-26
