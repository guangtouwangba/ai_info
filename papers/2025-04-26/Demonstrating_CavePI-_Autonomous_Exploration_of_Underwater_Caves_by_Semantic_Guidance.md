...
本文介绍了用于水下洞穴自主探索的视觉伺服系统CavePI，集成了轻量级深度视觉感知模块和鲁棒控制机制，能在GPS失效、特征匮乏的低能见度环境中实现语义引导导航。该系统通过硬件与边缘AI设计优化，支持复杂洞穴结构的语义识别与路径跟踪。研究通过真实水下洞穴实地测试和ROS数字孪生仿真验证了其可靠性，在水利资源管理、考古等领域的自主探测任务中展现出应用潜力。成果突出了集成设计在极端环境下的导航优势，为水下机器人技术提供了新解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T04:02:24Z
- **目录日期**: 2025-04-26
