...
本文介绍了用于水下洞穴自主探索的视觉伺服系统CavePI，该系统集成了轻量级深度视觉感知模块和鲁棒控制机制，可在GPS失效、特征匮乏及低能见度环境下实现语义引导导航。研究展示了该系统的硬件与边缘AI设计，并通过实地水下洞穴测试及ROS数字孪生仿真验证了其可靠性。成果对水资源管理、考古及海洋机器人等领域具有重要应用价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T21:02:18Z
- **目录日期**: 2025-04-26
