...
本文介绍了CavePI自主水下机器人（AUV）的系统设计与算法集成，用于水下洞穴的语义引导自主探索。该系统采用轻量级深度视觉感知模块实现环境语义理解，结合鲁棒控制机制追踪语义标记导航。通过真实水下洞穴实验和ROS数字孪生仿真验证，该系统能在无GPS、特征缺失和低能见度条件下可靠运行，适用于水资源管理、考古等领域。硬件与边缘AI的协同设计使CavePI具备复杂洞穴结构的自主探索能力，为水下机器人技术提供了新解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T17:02:07Z
- **目录日期**: 2025-04-26
