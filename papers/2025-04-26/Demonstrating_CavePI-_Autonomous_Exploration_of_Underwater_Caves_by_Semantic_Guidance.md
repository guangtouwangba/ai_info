...
本文介绍了CavePI自主水下机器人（AUV）的视觉伺服系统，用于水下洞穴探索。该系统整合轻量级深度视觉感知模块，提供环境语义理解，并通过鲁棒控制机制实现复杂洞穴导航。研究通过实地水下洞穴测试和ROS数字孪生仿真验证了该系统在无GPS、低能见度等恶劣条件下的可靠性。该技术对水资源管理、考古及海洋机器人领域具有重要意义。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T14:02:15Z
- **目录日期**: 2025-04-26
