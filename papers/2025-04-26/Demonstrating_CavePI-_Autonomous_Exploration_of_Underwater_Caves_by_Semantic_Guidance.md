...
本文介绍了用于水下洞穴自主探索的视觉伺服系统CavePI AUV的设计与算法集成。该系统采用轻量级深度视觉感知模块实现环境语义理解，并通过鲁棒控制机制引导导航。研究通过真实水下洞穴、泉水环境的实地测试及ROS数字孪生仿真验证了系统性能。结果表明，该集成设计方案能在缺乏特征、无GPS信号及低能见度条件下实现可靠导航，对水资源管理、水文地质学、考古学及海洋机器人学具有重要意义。硬件与边缘AI的协同设计有效支持了复杂洞穴结构中的语义引导自主探索。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T22:02:05Z
- **目录日期**: 2025-04-26
