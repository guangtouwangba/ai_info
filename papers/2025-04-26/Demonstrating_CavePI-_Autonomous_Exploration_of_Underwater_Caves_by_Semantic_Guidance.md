...
本文介绍了一种用于水下洞穴自主探索的视觉伺服系统CavePI，集成了轻量级深度视觉感知模块和鲁棒控制机制，可在GPS失效、特征匮乏和低能见度条件下实现语义引导导航。该系统通过硬件设计和边缘AI优化部署于新型自主水下机器人，并在真实水下洞穴和模拟环境中验证了性能。实验表明，该系统能有效理解环境语义特征并完成复杂洞穴结构的自主探索，为水资源管理、考古学和海洋机器人等应用提供了可靠解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T15:02:16Z
- **目录日期**: 2025-04-26
