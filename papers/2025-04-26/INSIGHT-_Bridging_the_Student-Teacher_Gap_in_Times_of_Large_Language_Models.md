...
人工智能（LLM）在教育领域既带来机遇也带来挑战，如个性化教学和师生互动减少等问题。本文提出INSIGHT概念验证系统，通过模块化设计整合多种AI工具，辅助师生解答习题。系统分析学生提问关键词，动态生成FAQ并为教师提供个性化面授建议。未来可基于收集的数据实现自适应学习，根据学生进度和风格调整内容，打造更具互动性和包容性的学习体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T04:01:53Z
- **目录日期**: 2025-04-26
