...
大型语言模型等AI技术为教育领域带来机遇与挑战。AI可帮助教师实现个性化教学，但也可能影响师生互动和隐私保护。本文提出INSIGHT概念验证系统，通过模块化设计整合多种AI工具辅助教学。系统分析学生提问的关键词，动态构建FAQ知识库，并为教师提供个性化面授支持建议。未来可基于收集的数据实现自适应学习，根据学生进度和风格调整内容，打造更具互动性和包容性的学习体验。该系统适用于高等教育多课程场景，展示了AI辅助教学的可行方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T23:01:50Z
- **目录日期**: 2025-04-26
