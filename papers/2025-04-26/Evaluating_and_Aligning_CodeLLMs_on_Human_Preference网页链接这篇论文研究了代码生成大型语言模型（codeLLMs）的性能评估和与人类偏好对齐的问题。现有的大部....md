...
这篇论文针对代码生成大型语言模型（CodeLLMs）与人类偏好对齐的问题，提出了CodeArena基准测试（包含397个高质量样本，覆盖40个类别和44种语言）和SynCode-Instruct合成指令数据集（近200亿标记）。研究发现现有基于执行的评估与人类偏好存在差距，开源模型（如Qwen2.5-Coder）与专有模型（如OpenAI o1）性能差异显著，凸显了人类偏好对齐的重要性。该研究为提升代码生成模型的实用性和用户体验提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T21:05:10Z
- **目录日期**: 2025-04-26
