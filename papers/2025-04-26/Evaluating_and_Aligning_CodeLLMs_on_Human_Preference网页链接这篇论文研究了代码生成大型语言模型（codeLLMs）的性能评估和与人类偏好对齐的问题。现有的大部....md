...
这篇论文针对代码生成大型语言模型(codeLLMs)提出了新评估方法，重点关注与人类偏好的对齐。研究者开发了CodeArena基准测试，包含397个高质量样本，覆盖40个类别和44种编程语言，更贴近实际编程场景。同时构建了20B标记的SynCode-Instruct合成指令数据集验证微调效果。实验发现现有基于执行的评估与人类偏好存在差距，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著，凸显了人类偏好对齐的重要性。该研究为改进代码LLMs提供了新的评估维度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T14:05:41Z
- **目录日期**: 2025-04-26
