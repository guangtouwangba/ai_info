...
这篇论文针对代码生成大模型(codeLLMs)提出新评估框架CodeArena，通过397个涵盖40类编程任务和44种语言的高质量样本，评估模型与人类偏好的对齐程度。研究发现传统基于执行的测试与人类偏好存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI)性能差距显著。论文还构建了20B标记的合成指令数据集SynCode-Instruct验证微调效果，强调代码生成模型除正确性外，还需关注实际开发场景中的可用性和人类偏好匹配。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-26T04:05:41Z
- **目录日期**: 2025-04-26
