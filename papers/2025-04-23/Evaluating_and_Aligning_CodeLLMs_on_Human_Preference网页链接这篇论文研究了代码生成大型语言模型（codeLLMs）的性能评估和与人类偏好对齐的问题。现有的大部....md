...
这篇论文针对代码生成大模型(codeLLMs)提出了CodeArena基准测试，强调评估模型输出与人类偏好的对齐性。研究者从真实用户查询中精选397个样本，覆盖40个类别和44种编程语言，比传统仅关注代码正确性的测试更全面。同时构建了20B标记的SynCode-Instruct合成指令数据集验证微调效果。实验发现执行基准与人类偏好评估存在差异，开源模型(如Qwen2.5-Coder)与专有模型(如OpenAI o1)性能差距显著，凸显了人类偏好对齐在代码生成中的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T18:05:49Z
- **目录日期**: 2025-04-23
