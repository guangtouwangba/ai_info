...
这篇论文针对代码生成大模型(codeLLMs)与人类偏好对齐的问题，提出了CodeArena基准测试和SynCode-Instruct数据集。CodeArena包含397个高质量编程任务样本，覆盖40个类别和44种语言，更贴近实际开发场景。研究发现在40多个模型中，开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)存在显著差距，验证了合成指令微调的有效性。结果表明传统基于执行的评估与人类偏好存在差异，强调了代码生成模型需要更好地与开发者需求对齐。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T06:04:38Z
- **目录日期**: 2025-04-23
