...
这篇论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，从397个真实用户查询中评估模型与人类偏好的对齐程度，覆盖40类任务和44种语言。同时构建20B标记的SynCode-Instruct合成指令集验证微调效果。研究发现现有执行基准与人类偏好存在差距，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著，凸显对齐人类偏好的重要性。研究通过多样化测试场景，揭示了当前代码生成模型在实际应用中的局限性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T03:20:35Z
- **目录日期**: 2025-04-23
