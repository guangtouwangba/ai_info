...
这篇论文针对代码生成大型语言模型(codeLLMs)的评估问题，提出了CodeArena基准测试和SynCode-Instruct语料库。CodeArena包含397个高质量样本，覆盖40个类别和44种编程语言，更关注人类偏好而非仅代码正确性。研究还构建了近200亿标记的合成指令数据集验证微调效果。实验发现执行基准与CodeArena存在性能差异，开源顶级模型(如Qwen2.5-Coder)与专有模型(如OpenAI o1)差距显著，凸显了人类偏好对齐的重要性。该研究为代码LLMs评估提供了更全面的框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T09:06:38Z
- **目录日期**: 2025-04-23
