...
这篇论文针对代码生成大模型(codeLLMs)提出了CodeArena基准测试，弥补了现有基准仅关注代码正确性而忽视人类偏好的不足。该基准包含397个高质量样本，覆盖40个类别和44种编程语言。研究还构建了20B标记的合成指令数据集SynCode-Instruct用于微调验证。实验发现执行基准与CodeArena存在性能差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)之间存在显著差距，凸显了模型与人类偏好对齐的重要性。研究为评估代码LLMs提供了更全面的框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T12:06:39Z
- **目录日期**: 2025-04-23
