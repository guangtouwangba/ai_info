...
该研究指出，基于文本提示的生成式AI交互方式对新手用户（如小企业主）存在障碍，包括难以表达品牌直觉、缺乏细粒度调整机会及生成内容缺乏品牌特色。为此，研究者开发了多模态AI工具ACAI，通过结构化输入面板（品牌、受众与目标、灵感板）替代传统提示界面，帮助用户传递品牌相关背景和视觉偏好。研究表明，结构化界面能突出用户定义的情境，改善内容对齐，并增强新手创作流程中的协同控制。这项研究为生成式系统的HCI研究提供了新见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T11:02:13Z
- **目录日期**: 2025-04-23
