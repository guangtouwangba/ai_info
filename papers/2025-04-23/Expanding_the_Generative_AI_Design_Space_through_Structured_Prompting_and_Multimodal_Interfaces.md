...
该研究针对小企业主等新手用户在使用文本提示生成AI时面临的三大挑战：难以通过提示表达品牌直觉、缺乏细粒度调整机会、生成内容缺乏品牌特色。为此，研究者开发了多模态AI工具ACAI，采用结构化输入界面取代传统提示方式，包含品牌、受众与目标、灵感板三个面板，帮助用户传达品牌相关背景和视觉偏好。研究表明，这种结构化界面能突显用户定义的情境，提高内容匹配度，增强新手创作流程中的协同控制能力，为生成式系统的HCI研究提供了新见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T17:02:26Z
- **目录日期**: 2025-04-23
