...
该研究针对小企业主（SBOs）使用文本提示与生成式AI互动时的困难，开发了多模态工具ACAI。通过英国6名SBO的初步研究发现三大挑战：难以通过提示表达品牌直觉、缺乏细粒度调整机会、生成内容过于通用。ACAI采用结构化三面板输入系统（品牌、受众与目标、灵感板），帮助用户传递品牌相关背景和视觉偏好，突破传统提示界面限制。研究表明，结构化界面能突出用户定义背景、提升内容匹配度，并增强新手创意流程中的协同控制力，为生成式系统的HCI研究提供了新思路。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T21:02:06Z
- **目录日期**: 2025-04-23
