...
在TRIUMF离线激光离子源测试台上，研究人员对铬(Cr)进行了逐步共振激光电离光谱研究，以寻找适合钛宝石(Ti:Sa)激光系统的有效电离方案。通过357.971nm、359.451nm和360.636nm三种不同激发跃迁，使用倍频光栅调谐Ti:Sa激光器进行自动连续激光频率扫描，观测到里德堡系列和自电离态。测得Cr的电离势为54575.49(2)stat(2)sys cm-1，精度比NIST数据库记录值提高一个数量级。基于357.971nm和373.935nm两步电离方案，成功实现了放射性Cr同位素束流的在线传输，并测量了50-59Cr在TRIUMF-ISAC的产额。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T18:01:34Z
- **目录日期**: 2025-04-23
