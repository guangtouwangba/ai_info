...
在TRIUMF离线的激光离子源测试平台上，研究人员对铬(Cr)进行了逐步共振激光电离光谱研究，以寻找适合钛蓝宝石(Ti:Sa)激光系统的有效电离方案。通过使用357.971 nm、359.451 nm和360.636 nm三种不同的一阶激发跃迁，采用频率倍增、光栅调谐的Ti:Sa激光器进行了自动连续激光频率扫描。实验观测到了里德堡系列和自电离态(AI)，并由此将Cr的电离电位(IP)精确测定为54575.49(2)stat(2)sys cm-1，精度比NIST数据库中的先前结果提高了一个数量级。随后利用观测到的AI共振（第一阶357.971 nm，第二阶373.935 nm）实现了放射性Cr同位素束的在线传输，用于TRIUMF-ISAC的50-59Cr精确质量测量。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T13:09:17Z
- **目录日期**: 2025-04-23
