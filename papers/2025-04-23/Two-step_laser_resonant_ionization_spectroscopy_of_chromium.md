...
在TRIUMF的离线激光离子源测试台上，研究人员对铬(Cr)进行了逐步共振激光电离光谱研究，以寻找适合钛蓝宝石(Ti:Sa)激光系统的有效电离方案。通过357.971 nm、359.451 nm和360.636 nm三种不同的一级激发跃迁，使用倍频光栅调谐Ti:Sa激光器进行了自动连续激光频率扫描，观测到里德堡系列和自电离态(AI)。测得铬的电离势(IP)为54575.49(2)_stat(2)_sys cm^-1，精度比NIST数据库记录值(54575.6(3) cm^-1)提高了一个数量级。随后采用357.971 nm(一级)和373.935 nm(二级)的电离方案，成功在线产生了放射性Cr同位素束流用于精确质量测量，并测量了^50-59Cr的在线产额。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T19:01:34Z
- **目录日期**: 2025-04-23
