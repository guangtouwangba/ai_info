...
量子位发布的《2025中国AIGC应用全景图谱2.0》将AI应用划分为六大领域：1）B端行业应用（教育/医疗/金融等）；2）AI智能助手（豆包、Kimi等平台）；3）AI办公工具（写作/翻译/PPT等效率工具）；4）开发者工具（MaaS平台/低代码工具）；5）AI创作工具（绘图/视频/音乐生成）；6）文娱生活应用（陪伴/健康/育儿等场景）。图谱通过6张分领域图示，系统展示了AI从企业服务到消费级产品的全场景落地趋势，为从业者提供产业布局参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T17:04:15Z
- **目录日期**: 2025-04-23
