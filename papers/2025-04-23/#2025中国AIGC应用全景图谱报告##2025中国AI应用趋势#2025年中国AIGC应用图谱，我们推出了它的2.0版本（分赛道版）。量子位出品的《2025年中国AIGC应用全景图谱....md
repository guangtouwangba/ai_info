...
量子位发布的《2025中国AIGC应用全景图谱2.0》将AI应用分为六大领域：1）B端行业应用（教育/医疗/金融等）；2）AI智能助手（Kimi、豆包等C端产品及开发框架）；3）AI办公工具（写作/翻译/PPT等效率工具）；4）开发者工具（MaaS平台/低代码工具）；5）AI创作类（绘图/视频/音乐生成）；6）文娱生活类（陪伴/健康/育儿等场景）。图谱系统梳理了AI从企业级到消费级的落地现状，覆盖技术开发、商业应用和日常生活全场景，为从业者和普通用户提供全面的AIGC应用参考指南。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T12:04:01Z
- **目录日期**: 2025-04-23
