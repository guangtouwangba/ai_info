...
量子位发布的《2025中国AIGC应用全景图谱2.0》将AI应用划分为六大领域：1）B端行业解决方案（教育/医疗/金融等）；2）AI智能助手（如豆包、Kimi等C端产品及开发框架）；3）AI办公工具（写作/翻译/PPT等效率应用）；4）开发者工具（MaaS平台/低代码工具等）；5）AI创作工具（绘图/视频/音乐生成）；6）文娱生活应用（陪伴/健康/育儿等）。图谱系统梳理了AI从企业服务到消费级场景的落地现状，为从业者提供全面的行业参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T16:04:15Z
- **目录日期**: 2025-04-23
