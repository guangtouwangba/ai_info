...
量子位发布的《2025中国AIGC应用全景图谱2.0》将AI应用划分为六大领域：1）B端行业应用（教育/医疗/金融等）；2）AI智能助手（豆包、Kimi等平台）；3）AI办公工具（写作/翻译/PPT等效率工具）；4）开发者工具（MaaS平台/低代码工具）；5）AI创作（绘图/视频/音乐生成）；6）文娱生活场景（陪伴/健康/育儿等）。该图谱通过细分赛道展示AI技术在各领域的商业化落地情况，涵盖企业服务、开发者资源和消费级应用，为行业决策者和普通用户提供全景式参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T18:03:42Z
- **目录日期**: 2025-04-23
