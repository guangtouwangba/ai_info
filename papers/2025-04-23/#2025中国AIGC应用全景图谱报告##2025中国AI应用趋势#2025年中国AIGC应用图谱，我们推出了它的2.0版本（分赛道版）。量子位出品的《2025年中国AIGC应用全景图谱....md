...
量子位发布的《2025中国AIGC应用全景图谱2.0》将AI应用划分为6大领域：1）B端行业应用（教育/医疗/金融等）；2）AI智能助手（豆包、Kimi等C端产品及开发框架）；3）AI办公工具（写作/翻译/PPT等效率工具）；4）开发者工具（MaaS平台/低代码工具）；5）AI创作（绘图/视频/音乐生成）；6）文娱生活（陪伴/健康/育儿场景）。图谱系统梳理了AI在B端和C端的落地现状，覆盖企业决策、开发者工具和消费级应用，展现中国AIGC技术的全面渗透趋势。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T13:11:54Z
- **目录日期**: 2025-04-23
