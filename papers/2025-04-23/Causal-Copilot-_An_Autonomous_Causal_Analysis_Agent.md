...
Causal-Copilot是一个基于大语言模型的自主代理系统，旨在降低因果分析的复杂度，让领域专家无需专业知识也能使用。它自动化了因果分析全流程，包括因果发现、推断、算法选择、超参数优化等，支持表格和时间序列数据。系统整合了20多种前沿因果分析技术，通过自然语言交互简化操作，同时保持方法严谨性。实证评估显示其性能优于现有基线，弥合了理论复杂性与实际应用间的鸿沟。该系统既扩展了因果方法的可及性，又通过真实场景反馈推动因果理论发展。提供在线演示：https://causalcopilot.com/。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T01:29:50Z
- **目录日期**: 2025-04-23
