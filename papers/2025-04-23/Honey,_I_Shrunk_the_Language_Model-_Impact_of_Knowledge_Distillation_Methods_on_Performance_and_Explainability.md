...
本文探讨了大型语言模型(LLMs)在资源受限环境中的部署挑战，提出通过知识蒸馏训练小型学生模型的方法。研究扩展了现有方法，包括应用批判性修正提示进行数据生成和综合现有训练方法。基于常识问答(CQA)数据集，系统比较了这些方法在模型性能和可解释性方面的影响。研究贡献了新的蒸馏方法，并通过准确性评估和人类基础研究来衡量性能与可解释性。这些进展有助于推动小型语言模型的蒸馏技术，促进LLM技术的更广泛应用和快速传播。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T17:02:16Z
- **目录日期**: 2025-04-23
