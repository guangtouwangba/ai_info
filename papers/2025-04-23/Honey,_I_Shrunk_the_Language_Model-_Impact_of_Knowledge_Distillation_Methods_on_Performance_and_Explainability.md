...
这篇论文探讨了大型语言模型(LLMs)在资源受限环境中的部署挑战，提出通过知识蒸馏训练小型学生模型。研究扩展了现有蒸馏方法，包括应用批判性修正提示进行数据生成和综合现有训练方法。基于常识问答(CQA)数据集，系统比较了这些方法在模型性能和可解释性方面的表现，其中性能通过准确性衡量，可解释性通过人工评估。研究贡献了新的蒸馏方法及其比较，旨在促进小型语言模型的蒸馏技术，从而扩大LLM技术的适用性和推广速度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T23:01:54Z
- **目录日期**: 2025-04-23
