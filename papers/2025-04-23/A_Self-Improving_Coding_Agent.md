...
研究表明，配备基础编程工具的大语言模型（LLM）编码代理能够自主修改自身代码，显著提升基准任务性能。在SWE Bench Verified随机子集上，性能提升达17%-53%，在LiveCodeBench和合成代理基准测试中也表现更优。该研究推动了自动化、开放式智能代理系统的设计，为工具使用和代理任务的后训练提供了参考框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T01:29:10Z
- **目录日期**: 2025-04-23
