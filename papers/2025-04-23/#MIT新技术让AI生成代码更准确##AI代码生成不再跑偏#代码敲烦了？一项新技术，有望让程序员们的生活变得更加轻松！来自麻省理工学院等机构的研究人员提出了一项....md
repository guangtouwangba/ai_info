...
MIT研究人员开发了一项新技术，通过序列蒙特卡洛方法让AI并行生成多个代码候选方案，并根据结构和语义准确性动态分配计算资源。这种方法结合专家知识引导，使小型开源模型在Python代码生成测试中表现优于体积更大的商业模型。相比传统方法（完整输出检查耗资源/渐进修正易偏离），新技术能同时控制代码规范性和用户意图准确性。该成果将在ICLR发表，未来计划扩展至更大规模文本生成并与学习机制结合。论文和代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T00:03:18Z
- **目录日期**: 2025-04-23
