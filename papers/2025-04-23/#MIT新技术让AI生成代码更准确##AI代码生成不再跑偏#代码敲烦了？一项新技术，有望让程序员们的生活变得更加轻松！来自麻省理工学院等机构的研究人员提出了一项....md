...
MIT研究人员开发了一项新技术，通过序列蒙特卡洛方法让AI并行生成多个代码候选，动态筛选最优解，确保代码结构规范且语义准确。该方法在Python代码生成测试中，使小型开源模型表现优于体积更大的商业模型。传统方法存在资源消耗大或语义偏离问题，新技术通过专家知识引导和权重分配，实现双重控制。未来计划扩展到更大规模文本生成并引入学习机制。该研究将在ICLR发表，由MIT等机构合作完成。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T04:02:05Z
- **目录日期**: 2025-04-23
