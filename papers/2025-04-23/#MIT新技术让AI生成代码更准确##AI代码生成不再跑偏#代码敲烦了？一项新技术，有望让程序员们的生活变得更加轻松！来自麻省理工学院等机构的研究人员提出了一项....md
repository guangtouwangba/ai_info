...
MIT研究人员开发了一种新技术，通过序列蒙特卡洛方法让AI生成更准确的代码。该技术让语言模型并行生成多个候选代码，根据结构和语义质量动态分配计算资源，淘汰低质量选项。在测试中，一个小型开源模型的表现超过了体积更大的商业模型。相比传统方法（完整检查耗资源或渐进检查易偏离），新技术能同时控制代码结构和语义准确性。未来计划将该方法扩展到更大规模文本生成，并与学习机制结合持续提升精度。论文将在ICLR发表，代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T01:30:52Z
- **目录日期**: 2025-04-23
