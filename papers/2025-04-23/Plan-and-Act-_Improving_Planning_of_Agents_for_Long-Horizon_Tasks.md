...
本文提出"Plan-and-Act"框架，通过将高层次规划与低层次执行分离来提升大语言模型处理复杂多步任务的能力。该框架包含生成结构化高层计划的Planner模型和将计划转化为具体动作的Executor模型。为优化Planner的训练，研究者开发了合成数据生成方法，通过标注真实轨迹数据并扩展多样化示例来增强泛化性。在网页导航任务测试中，该框架在WebArena-Lite基准上达到57.58%的成功率，在纯文本环境的WebVoyager上取得81.36%的领先成绩，展现了处理长程规划任务的优越性能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T15:02:32Z
- **目录日期**: 2025-04-23
