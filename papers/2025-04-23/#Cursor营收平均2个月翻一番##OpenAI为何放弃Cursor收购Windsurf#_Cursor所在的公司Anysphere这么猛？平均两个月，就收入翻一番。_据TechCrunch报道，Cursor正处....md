# #Cursor营收平均2个月翻一番##OpenAI为何放弃Cursor收购Windsurf# Cursor所在的公司Anysphere这么猛？平均两个月，就收入翻一番。 据TechCrunch报道，Cursor正处...
...
Cursor母公司Anysphere发展迅猛，营收每两月翻倍，年收达3亿美元，因此拒绝了OpenAI收购。OpenAI转而计划以30亿美元收购另一家AI编程公司Windsurf（前Codeium），后者年收1亿美元，开发者社区热度高且兼容企业系统。此次收购若成功，将成为OpenAI最大单笔收购，旨在快速增强其AI开发工具能力，避免从零研发。这反映了AI巨头通过收购成熟产品加速布局的趋势，此前OpenAI已收购Rockset和Multi等公司，逐步完善技术生态。AI基础工具领域的竞争正日益激烈。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T07:01:42Z
- **目录日期**: 2025-04-23
