...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译及科研分析等一站式服务。它支持中英文文献搜索，能自动生成摘要并回答用户提问，提升研究效率。平台还具备文档翻译、学术订阅功能，可按用户兴趣推送最新科研动态。收录3.5亿论文、0.6亿学者等海量数据，覆盖42个学科。用户可通过网页或微信小程序免费使用其核心功能，包括学者画像、会议资讯等。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T01:33:54Z
- **目录日期**: 2025-04-23
