...
AMiner是一个智能科技情报挖掘平台，提供四位一体的学术服务：论文检索、辅助阅读、智能分析和写作支持。平台收录3.5亿论文、0.6亿学者和1.5亿专利，支持中英文文献检索、AI摘要生成、互动问答及文档翻译功能。用户可订阅个性化科研动态，通过微信或邮件获取最新学术资讯。此外，AMiner还提供学者画像、学术会议追踪和论文排行榜等特色功能，浏览器版可免费使用。网址：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T13:14:07Z
- **目录日期**: 2025-04-23
