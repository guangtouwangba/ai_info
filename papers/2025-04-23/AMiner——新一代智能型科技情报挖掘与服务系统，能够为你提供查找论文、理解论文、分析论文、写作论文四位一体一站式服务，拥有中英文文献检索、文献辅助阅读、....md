...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析及科研订阅等一站式服务。它支持中英文文献搜索，能自动生成摘要并解答用户提问，帮助快速理解论文内容。平台拥有3.5亿论文、0.6亿学者等海量数据，支持PDF上传和AI辅助阅读。用户可定制科研情报推送，跟踪最新学术动态。此外，AMiner还提供学者画像、学术会议等特色功能，基础服务免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T14:06:21Z
- **目录日期**: 2025-04-23
