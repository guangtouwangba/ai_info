...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、辅助阅读、AI翻译、摘要生成及问答交互功能。平台收录3.5亿论文、0.6亿学者及海量专利数据，支持用户通过关键词、学者或机构订阅最新科研动态，并通过微信/邮件推送。其特色功能包含文献智能解析（自动生成摘要、章节概要）、互动式内容问答，以及学者画像分析等。所有基础功能均可免费使用，显著提升文献调研与论文写作效率。访问入口：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T17:06:40Z
- **目录日期**: 2025-04-23
