...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统通过模拟1万多个AI代理及其500万次互动，研究人类社会的复杂行为。研究者用它分析了四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，验证了该系统的有效性。AgentSociety为社会科学研究提供了新工具，能帮助学者和政策制定者更好地理解社会现象背后的机制，并测试不同政策干预的效果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T10:05:51Z
- **目录日期**: 2025-04-23
