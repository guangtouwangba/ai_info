...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟超过1万个代理的社会互动（500万次）。它通过真实社会环境和大规模模拟引擎，研究社会极化、信息传播、基本收入政策及自然灾害影响等问题。实验结果与现实数据吻合，验证了其捕捉人类行为机制的能力，为社会科学研究和政策制定提供了新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T21:05:58Z
- **目录日期**: 2025-04-23
