...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个代理的社会互动（500万次）。该系统通过四个社会问题案例（社会极化、信息传播、基本收入政策、自然灾害影响）验证其有效性，结果与现实世界数据吻合。研究表明，AgentSociety能有效捕捉人类行为机制，为社会科学研究和政策制定提供新工具，可辅助传统研究方法（如调查、访谈）。这一创新平台展示了LLM在理解社会复杂性问题方面的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T05:03:53Z
- **目录日期**: 2025-04-23
