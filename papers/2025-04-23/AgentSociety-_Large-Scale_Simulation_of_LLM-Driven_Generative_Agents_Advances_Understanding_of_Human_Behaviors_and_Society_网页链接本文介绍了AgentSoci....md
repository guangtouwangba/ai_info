...
该研究开发了AgentSociety，一个基于大语言模型的大规模社会模拟系统，可模拟1万多个代理及其500万次互动。研究者通过该系统研究了社会极化、信息传播、基本收入政策和自然灾害影响四个关键社会问题。模拟结果与现实世界数据吻合，验证了系统捕捉人类行为机制的能力。该工具为社会科学研究和政策制定提供了新方法，能有效补充传统研究方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T14:05:50Z
- **目录日期**: 2025-04-23
