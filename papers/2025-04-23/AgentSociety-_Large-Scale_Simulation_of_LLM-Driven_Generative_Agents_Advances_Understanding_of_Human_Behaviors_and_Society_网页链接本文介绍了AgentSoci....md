...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个智能代理及其500万次互动。研究者用它研究了社会极化、信息传播、基本收入政策及自然灾害影响四个社会问题，结果与现实数据吻合。该系统展现了作为社会科学研究工具和辅助政策制定的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T15:05:36Z
- **目录日期**: 2025-04-23
