...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能模拟1万多个AI代理的社会互动（500万次）。研究者用它分析四大社会问题：群体极化、信息传播、基本收入政策效果和自然灾害影响。模拟结果与现实数据高度吻合，证明该系统能有效捕捉人类行为机制。该平台为社会科学研究和政策制定提供了新工具，可辅助传统研究方法（如调查、实验），帮助理解社会问题的成因和规律。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T20:05:50Z
- **目录日期**: 2025-04-23
