...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统模拟了1万多个AI代理的社会生活，记录了500万次代理间及代理与环境间的互动。研究团队利用该平台进行了四项社会实验：社会极化现象、刺激性信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，验证了该系统在揭示人类行为机制方面的可靠性。研究表明，AgentSociety能有效辅助传统社会科学研究方法，为研究者和政策制定者提供有价值的分析工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T11:05:59Z
- **目录日期**: 2025-04-23
