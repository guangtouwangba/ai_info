...
本文提出ForesightNav，一种受人类想象和推理启发的新型探索策略，旨在提升机器人在未知环境中的自主导航能力。该方法赋予机器人预测未探索区域（如占用率和语义细节）的能力，从而有效选择长期导航目标。在Structured3D数据集上的验证表明，该方法能准确预测占用率并预判未知场景几何结构，显著提升探索效率。实验结果显示，在PointNav任务中达到100%完成率，ObjectNav任务中SPL达67%。该研究证明了基于想象的推理能增强自主系统的泛化能力和探索效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T13:09:27Z
- **目录日期**: 2025-04-23
