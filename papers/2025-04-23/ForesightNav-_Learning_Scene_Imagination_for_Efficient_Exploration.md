...
本文提出ForesightNav，一种受人类想象和推理启发的新型探索策略，旨在提升机器人在未知环境中的自主导航能力。该方法赋予机器人预测未探索区域（如占用率和语义信息）的能力，从而选择更有意义的长距离导航目标。在Structured3D数据集上的验证表明，该想象力模块能准确预测场景几何结构，显著提升探索效率：在PointNav任务中达到100%完成率，ObjectNav任务中SPL达67%。研究证明了想象力驱动推理对提升自主系统通用性和探索效率的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T23:01:45Z
- **目录日期**: 2025-04-23
