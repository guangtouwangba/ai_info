...
本文提出了一种受人类想象力启发的新型探索策略ForesightNav，旨在提升机器人在未知环境中的自主导航能力。该方法通过预测未探索区域的占用率和语义信息，帮助机器人选择长期导航目标，显著提高了探索效率。在Structured3D数据集上的实验验证了该方法的有效性：在占用预测方面表现准确，在PointNav任务中达到100%完成率，在ObjectNav任务中SPL达到67%。研究证明了基于想象的推理能有效增强自主系统的泛化探索能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T09:01:58Z
- **目录日期**: 2025-04-23
