...
VAST推出的Tripo Doodle工具在SIGGRAPH Asia 2024亮相，可将2D草图或文本提示实时转化为精细3D模型，大幅简化建模初期的打形流程。其开源组件支持用户通过涂鸦式绘制生成动态更新的3D效果，并能随机化生成创意方案，适用于植物、家具乃至幻想生物等多种对象。该工具实现了"像涂鸦一样简单"的3D建模体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-23T03:18:36Z
- **目录日期**: 2025-04-23
