...
这篇论文针对代码生成大型语言模型(codeLLMs)提出两个关键贡献：1) 创建人类偏好基准CodeArena，包含397个高质量样本，覆盖40类编程任务和44种语言，弥补现有基准忽视人类偏好的不足；2) 构建近200亿标记的合成指令数据集SynCode-Instruct验证大规模微调效果。实验发现执行基准与人类偏好存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，凸显对齐人类偏好的重要性。研究强调需超越代码正确性，关注实际开发场景中的用户体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T11:05:57Z
- **目录日期**: 2025-05-22
