...
这篇论文探讨了代码生成大模型(codeLLMs)与人类偏好的对齐问题。研究者创建了CodeArena基准测试(包含397个样本,覆盖40类44种语言)和SynCode-Instruct语料库(近20B标记),发现现有基准过分关注代码正确性而忽视人类偏好。实验显示:1)执行基准与CodeArena存在性能差异;2)开源顶级模型(如Qwen2.5-Coder)与专有模型(如OpenAI o1)差距显著。研究强调了代码LLMs与人类偏好对齐的重要性,为评估模型提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T13:15:07Z
- **目录日期**: 2025-05-22
