...
这篇论文针对代码生成大模型(codeLLMs)与人类偏好对齐的问题，提出了CodeArena基准测试(包含397个高质量样本，覆盖40类44种语言)和SynCode-Instruct合成指令语料库(近200亿标记)。研究发现现有基准过于侧重代码正确性而忽视人类偏好，实验显示执行基准与CodeArena存在性能差异。在测试40多个模型后发现，顶级开源模型(如Qwen2.5-Coder)与专有模型(如OpenAI o1)仍存在显著差距，凸显了人类偏好对齐的重要性。研究验证了大规模合成指令微调的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T04:07:22Z
- **目录日期**: 2025-05-22
