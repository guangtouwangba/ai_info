...
这篇论文针对代码生成大模型(codeLLMs)提出了CodeArena基准测试，关注模型输出与人类偏好的对齐问题。研究收集了397个涵盖40类编程任务和44种语言的样本，并构建了20B标记的合成指令数据集SynCode-Instruct。实验发现传统执行基准与人类偏好评估存在差距，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI)性能差异显著，凸显了人类偏好对齐在代码生成中的重要性。研究为评估和改进代码LLMs提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T21:05:33Z
- **目录日期**: 2025-05-22
