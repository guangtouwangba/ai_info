...
Memos是一款开源轻量笔记工具，自2022年发布以来GitHub星标数快速增长至40.7k。该工具界面类似flomo，支持灵感记录、待办事项和内容引用联动。主要特点包括：简单Docker部署、纯文本/Markdown编辑、高度自定义界面、本地数据存储保障隐私、完全免费无订阅模式。凭借轻量化设计和持续开发，Memos正成为Obsidian的热门替代选择，尤其适合需要跨平台、隐私优先的用户群体。项目地址：github.com/usememos/memos（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T10:03:16Z
- **目录日期**: 2025-05-22
