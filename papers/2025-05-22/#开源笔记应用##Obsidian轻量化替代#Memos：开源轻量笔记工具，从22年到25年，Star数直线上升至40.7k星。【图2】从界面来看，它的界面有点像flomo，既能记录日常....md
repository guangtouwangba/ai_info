...
Memos是一款开源轻量笔记工具，2022-2025年GitHub星标数飙升至40.7k。界面类似flomo，支持灵感记录、待办事项和内容引用联动。特点包括：Docker简单部署、纯文本/Markdown支持、高度自定义（图标/主题）、本地存储保障隐私、完全免费无订阅。作为活跃开发项目，它正成为Obsidian的轻量化替代选择，适合追求简洁高效的用户。项目地址：github.com/usememos/memos。（注：配图显示界面设计和增长趋势图）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T22:03:14Z
- **目录日期**: 2025-05-22
