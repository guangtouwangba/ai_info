...
Memos是一款开源的轻量级笔记工具，自2022年发布以来GitHub星标数迅速增长至40.7k。其界面类似flomo，支持灵感记录、待办事项和内容引用联动。主要特点包括：简单部署（几行Docker命令）、纯文本/Markdown支持、高度自定义（图标/主题等）、本地数据存储保障隐私、完全免费无订阅。作为Obsidian的轻量化替代方案，Memos凭借开源、跨平台和持续开发的优势受到用户青睐。项目地址：github.com/usememos/memos。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T17:03:13Z
- **目录日期**: 2025-05-22
