...
Memos是一款开源轻量笔记工具，2022-2025年间GitHub星标数飙升至40.7k。其界面类似flomo，支持灵感记录、待办管理和内容引用联动。主要特点包括：简单Docker部署、纯文本/Markdown编辑、高度自定义界面、本地数据存储保障隐私、完全免费无订阅。作为Obsidian的轻量化替代方案，该项目持续活跃开发，凭借简洁易用和隐私安全特性受到用户青睐。项目地址：github.com/usememos/memos（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T15:03:25Z
- **目录日期**: 2025-05-22
