...
Memos是一款开源轻量笔记工具，自2022年推出以来GitHub星标数迅速增长至40.7k。其界面类似flomo，支持灵感记录、待办事项和内容引用联动。主要特点包括：简单Docker部署、纯文本/Markdown编辑、高度自定义界面、本地数据存储保障隐私、完全免费无订阅模式。作为Obsidian的轻量化替代方案，Memos凭借简洁性和隐私性获得用户青睐，目前仍在持续开发中。项目地址：github.com/usememos/memos（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T20:03:28Z
- **目录日期**: 2025-05-22
