...
Memos是一款开源的轻量级笔记工具，自2022年推出以来在GitHub上迅速走红，目前已获得40.7k星标。它结合了flomo的简洁界面和Obsidian的引用功能，支持日常灵感记录和任务管理。特点包括：简单Docker部署、纯文本/Markdown支持、高度自定义、本地数据存储确保隐私、完全免费无订阅。凭借轻量化设计和活跃开发，Memos被视为Obsidian的替代选择，适合追求效率与隐私的用户。项目地址：github.com/usememos/memos。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T18:03:28Z
- **目录日期**: 2025-05-22
