...
本文提出ContextAgent，首个结合多维度感知数据的上下文感知主动AI助手。该系统通过可穿戴设备获取视频、音频等感知数据理解用户意图，并结合历史人物画像预测主动服务需求，自动调用工具提供无干扰协助。研究构建了首个上下文感知主动代理基准ContextAgentBench，包含9个日常场景的1000个样本和20种工具。实验表明，ContextAgent在主动预测和工具调用准确率上分别比基线高8.5%和6.0%。该研究为开发更先进、以人为中心的主动AI助手提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T00:01:36Z
- **目录日期**: 2025-05-22
