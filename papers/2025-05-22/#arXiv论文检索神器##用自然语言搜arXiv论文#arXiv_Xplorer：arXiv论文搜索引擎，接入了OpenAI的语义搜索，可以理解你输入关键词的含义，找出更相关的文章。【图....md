...
arXiv Xplorer是一款基于OpenAI语义搜索技术的arXiv论文搜索引擎，能更精准理解用户查询意图，提供相关性更强的结果。相比arXiv原生搜索功能，它能返回更多高质量论文且避免重复，例如搜索「合成数据集+图像分割+神经网络训练」时结果更丰富。该工具还支持相似论文推荐，帮助扩展研究范围。访问地址：arxivxplorer.com。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T12:04:10Z
- **目录日期**: 2025-05-22
