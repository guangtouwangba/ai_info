...
arXiv Xplorer是一个基于OpenAI语义搜索技术的arXiv论文搜索引擎，能更精准理解用户查询意图，提供比arXiv原生搜索更相关、更全面的结果。例如搜索「合成数据集+图像分割+神经网络训练」时，arXiv仅返回2篇论文，而arXiv Xplorer能提供更多非重复优质文献，并支持相似论文推荐功能。其优势在于通过自然语言处理提升搜索质量，帮助研究者高效获取目标论文。访问地址：arxivxplorer.com

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T08:02:51Z
- **目录日期**: 2025-05-22
