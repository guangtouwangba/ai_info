...
知识蒸馏是一种让小型AI模型(学生模型)向大型AI模型(教师模型)学习的技术，主要分为三种方法：(1)软标签蒸馏：学生模型学习教师模型输出的概率分布；(2)硬标签蒸馏：学生模型直接学习教师模型的最终预测类别；(3)协同蒸馏：多个模型互为师生，相互学习对方的概率分布。这些技术能帮助小模型获得接近大模型的性能，同时保持较小的计算开销。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T15:03:43Z
- **目录日期**: 2025-05-22
