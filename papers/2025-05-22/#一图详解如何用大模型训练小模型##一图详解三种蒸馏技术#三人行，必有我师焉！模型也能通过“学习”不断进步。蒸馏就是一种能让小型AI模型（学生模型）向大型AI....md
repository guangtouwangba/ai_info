...
知识蒸馏是一种让小型AI模型(学生模型)向大型AI模型(教师模型)学习的技术，主要包括三种方法：(1)软标签蒸馏：学生模型学习教师模型的概率输出分布；(2)硬标签蒸馏：学生模型直接学习教师模型的最终预测类别；(3)协同蒸馏：多个模型互相学习对方的概率分布，共同提升。这些方法通过不同方式传递知识，使小模型能获得接近大模型的性能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T10:03:34Z
- **目录日期**: 2025-05-22
