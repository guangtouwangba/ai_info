...
知识蒸馏技术使小型AI模型(学生模型)能向大型模型(教师模型)高效学习，主要有三种方法：(1)软标签蒸馏：学生模型学习教师模型的概率输出分布；(2)硬标签蒸馏：学生直接模仿教师的最终类别预测；(3)协同蒸馏：多个模型互为师生，相互学习软标签分布并可能结合真实标签监督。这些技术通过不同方式传递大模型知识，帮助小模型获得接近大模型的性能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T23:03:24Z
- **目录日期**: 2025-05-22
