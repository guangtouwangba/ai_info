...
该研究提出了一种新型LLM-Hinted RL范式，通过将大型语言模型（LLM）与强化学习（RL）结合来提升自动驾驶性能。针对当前LLM主导方法易产生幻觉（非幻觉率仅57.95%）的问题，该方案保持LLM与RL的相对独立性：LLM生成语义提示辅助决策，RL则通过策略学习纠正潜在错误。基于此开发的HCRMP架构包含状态增强、知识库稳定性锚和语义缓存三大模块，实现了低频LLM指导与高频RL控制的融合。CARLA仿真显示，HCRMP在多样化场景中任务成功率高达80.3%，关键安全场景碰撞率降低11.4%。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T09:01:41Z
- **目录日期**: 2025-05-22
