...
该研究提出了一种新型LLM-Hinted RL范式，通过将大型语言模型（LLM）与强化学习（RL）结合来提升自动驾驶性能。针对当前LLM主导方法存在57.95%幻觉率的问题，该方案保持LLM与RL的相对独立性：LLM生成语义提示辅助运动规划，RL则通过策略学习纠正潜在错误。提出的HCRMP架构包含状态增强、上下文稳定锚和语义缓存三大模块，在CARLA实验中取得显著成效：任务成功率最高达80.3%，关键安全场景下碰撞率降低11.4%，有效提升了复杂场景的驾驶表现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T03:19:42Z
- **目录日期**: 2025-05-22
