...
该研究提出了一种新型LLM-Hinted RL范式，通过将大型语言模型（LLM）与强化学习（RL）相结合来提升自动驾驶性能。针对当前LLM主导方法存在57.95%幻觉率的问题，该方案保持LLM与RL的相对独立性：LLM生成语义提示辅助运动规划，RL则通过策略学习纠正潜在错误。提出的HCRMP架构包含状态增强、上下文稳定锚和语义缓存三大模块，在CARLA测试中表现优异：综合任务成功率80.3%，安全关键场景碰撞率降低11.4%，有效提升了复杂场景下的驾驶性能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T12:01:51Z
- **目录日期**: 2025-05-22
