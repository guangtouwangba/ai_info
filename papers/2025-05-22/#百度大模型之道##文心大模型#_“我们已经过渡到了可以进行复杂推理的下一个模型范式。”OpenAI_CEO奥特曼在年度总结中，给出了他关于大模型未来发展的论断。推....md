...
中国信通院最新大模型推理能力评估显示，百度文心X1 Turbo在24项测试中16项满分，综合评级获国内首个"4+级"最高认证。百度集团副总裁吴甜在AI Day活动详解了该模型的技术突破，指出大模型发展已进入"复杂推理"新阶段。文心凭借模型架构、数据质量和应用落地的综合优势，成为当前国内唯一通过该测评的大模型，标志着国产大模型在推理能力上达到新高度。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T14:02:52Z
- **目录日期**: 2025-05-22
