...
中国信通院最新评估显示，百度"文心X1 Turbo"大模型在推理能力测评中表现优异，成为国内首款且唯一获评最高等级"4+"的模型（16项5分/24项）。该成果在百度AI Day活动中获得技术解读，副总裁吴甜指出大模型发展已进入"复杂推理"新阶段。OpenAI CEO奥特曼此前也强调推理模型正成为行业竞争焦点。文心模型凭借算法、数据等综合优势，在推理能力上取得领先突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T23:02:40Z
- **目录日期**: 2025-05-22
