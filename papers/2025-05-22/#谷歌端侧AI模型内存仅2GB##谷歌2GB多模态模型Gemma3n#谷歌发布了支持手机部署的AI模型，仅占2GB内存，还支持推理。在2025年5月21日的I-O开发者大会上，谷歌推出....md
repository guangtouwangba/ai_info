# #谷歌端侧AI模型内存仅2GB##谷歌2GB多模态模型Gemma3n#谷歌发布了支持手机部署的AI模型，仅占2GB内存，还支持推理。在2025年5月21日的I/O开发者大会上，谷歌推出...
...
谷歌在2025年I/O大会上推出轻量级多模态AI模型Gemma 3n，内存占用仅2GB，支持手机/平板等终端本地部署。该模型采用DeepMind的PLE技术和MatFormer框架，具备5B/8B参数但内存效率相当于2B/4B模型，支持性能/质量模式切换。在Chatbot Arena测试中超越GPT-4.1-nano和Llama-4-17B，可离线处理语音、图像、文字及视频任务。开发者可通过Google AI Edge部署至Android设备，普通用户可通过浏览器使用，适用于隐私敏感场景。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T06:03:57Z
- **目录日期**: 2025-05-22
