...
OpenAI CPO Kevin Weil透露ChatGPT将转型为"行动助手"，AI Agent功能将大幅升级：1) 具备跨平台工具整合能力，可调用搜索/编程等工具完成复杂任务；2) 通过延长思考时间和算法优化提升性能，训练成本已降低500倍；3) 结合网络搜索和多轮验证减少幻觉。目标是一年内使AI具备架构师级能力，从回答问题进阶为执行任务。OpenAI将持续降低API成本推动行业普及。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T01:31:26Z
- **目录日期**: 2025-05-22
