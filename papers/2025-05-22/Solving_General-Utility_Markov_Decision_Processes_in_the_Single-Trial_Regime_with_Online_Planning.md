...
本研究首次提出了解决无限时域折扣通用效用马尔可夫决策过程(GUMDP)在单次试验场景下的方法。作者首先分析了单次试验条件下的策略优化基础问题，包括最优策略类别选择、等效MDP转换以及计算复杂度研究；其次提出利用蒙特卡洛树搜索等在线规划技术解决该问题；最后实验证明该方法优于现有基线方案。该工作为单次评估场景下的GUMDP求解提供了理论框架和实用算法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T19:01:50Z
- **目录日期**: 2025-05-22
