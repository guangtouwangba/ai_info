...
本研究首次提出了解决无限时域折扣通用效用马尔可夫决策过程（GUMDP）在单次试验场景下的方法。作者首先分析了单次试验条件下的策略优化基础问题，包括最优策略类别、问题转化为等价MDP形式以及计算复杂度。其次，研究展示了如何利用在线规划技术（特别是蒙特卡洛树搜索算法）来解决单次试验GUMDP问题。最后，实验结果表明，该方法在性能上显著优于相关基线方法。该工作为单次试验场景下的决策优化提供了新的理论框架和实用算法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T13:11:13Z
- **目录日期**: 2025-05-22
