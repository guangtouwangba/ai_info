...
本研究首次提出了在单次试验场景下解决无限时域折扣通用效用马尔可夫决策过程(GUMDP)的方法。首先分析了单次试验场景下的策略优化基础问题，包括最优策略类别、问题转化等效MDP以及计算复杂度。其次提出利用在线规划技术(特别是蒙特卡洛树搜索算法)求解该问题。实验结果表明，该方法在单次试验场景下性能显著优于基线方法。研究为通用效用MDP在单次评估场景下的求解提供了理论框架和实用算法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T05:02:00Z
- **目录日期**: 2025-05-22
