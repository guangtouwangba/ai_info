...
本文提出了首个解决无限时域折扣通用效用马尔可夫决策过程(GUMDP)单次试验优化问题的方法。研究首先分析了单次试验场景下的策略优化基础问题，包括最优策略类别、问题转化等效MDP以及计算复杂度；其次提出利用蒙特卡洛树搜索等在线规划技术求解该问题；最后实验表明该方法性能显著优于基线模型。该工作填补了GUMDP在单次评估场景下的研究空白，为实际应用提供了理论框架和有效算法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T08:02:07Z
- **目录日期**: 2025-05-22
