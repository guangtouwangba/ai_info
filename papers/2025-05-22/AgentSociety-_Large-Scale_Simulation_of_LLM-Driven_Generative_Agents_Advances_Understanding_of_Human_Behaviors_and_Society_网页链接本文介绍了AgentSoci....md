...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理的社会互动（500万次交互）。该系统被用于研究四大社会问题：社会极化、信息传播、基本收入政策效果和自然灾害影响。模拟结果与现实数据高度吻合，证明其能有效捕捉人类行为机制。该系统为社会科学研究和政策制定提供了新工具，可辅助传统研究方法（如调查和干预实验），帮助理解社会问题的成因和潜在模式。研究展示了AI模拟在社会研究中的巨大潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T08:05:37Z
- **目录日期**: 2025-05-22
