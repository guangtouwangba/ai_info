...
AgentSociety是一个基于大语言模型的大规模社会模拟器，能模拟超过1万个代理的社会互动（500万次）。研究者用它研究四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害冲击。模拟结果与现实数据吻合，验证了该系统捕捉人类行为机制的能力。该工具可作为社会科学研究和政策制定的创新平台，补充传统研究方法（如调查和访谈），帮助理解社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T07:05:39Z
- **目录日期**: 2025-05-22
