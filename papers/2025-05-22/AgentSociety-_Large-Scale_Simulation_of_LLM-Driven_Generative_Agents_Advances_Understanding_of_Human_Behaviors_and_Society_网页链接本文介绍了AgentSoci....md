...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理及其500万次社会互动。研究者利用该平台研究了四大社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，验证了该系统在揭示人类行为机制方面的有效性。这一创新工具为社会科学研究和政策制定提供了新的实验平台，能够补充传统研究方法，帮助深入理解复杂社会现象的成因和机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T20:05:02Z
- **目录日期**: 2025-05-22
