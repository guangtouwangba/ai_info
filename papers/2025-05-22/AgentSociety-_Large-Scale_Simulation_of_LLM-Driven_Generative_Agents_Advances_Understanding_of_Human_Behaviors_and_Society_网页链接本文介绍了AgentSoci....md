...
AgentSociety是一个基于大型语言模型(LLM)的大规模社会模拟系统，可模拟1万多个AI代理的社会互动(500万次交互)。该系统通过四个关键社会问题研究(社会极化、信息传播、基本收入政策、自然灾害影响)，验证了其模拟结果与现实世界数据的一致性。研究表明，AgentSociety能有效捕捉人类行为机制，可作为计算社会科学研究的创新工具，为政策制定提供新方法。该系统结合了LLM代理、真实社会环境和大规模模拟引擎，为传统社会科学研究方法(如调查、访谈)提供了有力补充。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T21:05:00Z
- **目录日期**: 2025-05-22
