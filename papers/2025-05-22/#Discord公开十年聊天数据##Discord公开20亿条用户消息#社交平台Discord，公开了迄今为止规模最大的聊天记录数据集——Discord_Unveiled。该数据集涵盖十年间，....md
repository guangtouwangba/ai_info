...
Discord公开了名为"Discord Unveiled"的大规模数据集，包含2015-2024年间20.5亿条消息，涉及470万用户。数据来自10%的公共服务器，17%为机器人消息，涵盖多语言内容，以游戏讨论为主，同时包含社交、动漫等话题。所有用户信息已匿名处理。该数据集结构完整，可用于大语言模型训练、NLP研究及社会学分析，具有重要学术价值。数据集和论文已公开在Zenodo和arXiv平台。这是目前最全面的社交平台数据之一，为研究真实社交互动提供了宝贵资源。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T20:03:38Z
- **目录日期**: 2025-05-22
