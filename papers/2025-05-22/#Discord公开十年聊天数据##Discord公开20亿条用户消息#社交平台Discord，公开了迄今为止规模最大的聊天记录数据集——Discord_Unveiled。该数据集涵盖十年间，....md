...
Discord公开了名为"Discord Unveiled"的大规模数据集，包含2015-2024年间20.5亿条用户消息，涉及470万用户。数据来自10%的公共服务器，17%为机器人消息，涵盖多种语言，主题以游戏为主，也包括社交、动漫和心理健康等。所有用户信息已匿名处理。该数据集结构完整，可用于训练语言模型及NLP、社群治理等研究，具有重要学术价值。下载地址：zenodo.org/records/15170676，论文见arxiv.org/abs/2502.00627。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T21:03:34Z
- **目录日期**: 2025-05-22
