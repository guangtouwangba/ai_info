...
Discord公开了名为"Discord Unveiled"的大规模数据集，包含2015-2024年间20.5亿条用户消息，涉及470万用户。数据来自10%的公共服务器，17%为机器人消息，涵盖多语言内容，游戏是核心主题。所有用户信息已匿名处理。该数据集结构完整，可用于LLM训练、NLP研究及社会学分析，具有重要学术价值。下载和论文链接已提供。这是目前最丰富的公开社交平台数据之一，记录了Discord十年发展历程。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T14:03:31Z
- **目录日期**: 2025-05-22
