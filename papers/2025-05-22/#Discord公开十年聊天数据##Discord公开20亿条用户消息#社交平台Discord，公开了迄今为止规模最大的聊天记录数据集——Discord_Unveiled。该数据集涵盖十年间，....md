# #Discord公开十年聊天数据##Discord公开20亿条用户消息#社交平台Discord，公开了迄今为止规模最大的聊天记录数据集——Discord Unveiled。该数据集涵盖十年间，...
...
Discord公开了名为"Discord Unveiled"的大规模数据集，包含2015-2024年间20.5亿条用户消息，涉及470万用户。数据来自10%的公共服务器，17%为机器人消息，涵盖多种语言（英语为主）和主题（游戏最热门）。所有用户信息已匿名处理。该数据集结构完整，可用于LLM训练、NLP研究及社会学分析，尤其对社群治理和心理健康研究具有重要价值。下载地址：zenodo.org/records/15170676；论文：arxiv.org/abs/2502.00627。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T19:03:21Z
- **目录日期**: 2025-05-22
