...
Discord公开了名为"Discord Unveiled"的大规模数据集，包含2015-2024年间470万用户发送的20.5亿条消息，覆盖10%的公共服务器。数据特点包括：17%消息来自机器人；多语言内容（英语为主，含西班牙语、法语等）；主要讨论游戏，也涉及社交、动漫、心理健康等话题；所有用户信息已匿名处理。该数据集是当前最完整的社交平台数据之一，可用于大语言模型训练、NLP研究及社会学分析，同时符合数据保护法规。下载和论文链接已提供。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T17:03:24Z
- **目录日期**: 2025-05-22
