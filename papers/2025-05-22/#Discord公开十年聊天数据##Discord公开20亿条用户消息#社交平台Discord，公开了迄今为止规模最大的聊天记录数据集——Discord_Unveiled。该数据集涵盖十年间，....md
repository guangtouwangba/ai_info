...
Discord公开了名为"Discord Unveiled"的大规模数据集，包含2015-2024年间470万用户发送的20.5亿条消息。数据来自10%的公共服务器，涵盖多语言内容（以英语为主），其中17%为机器人消息。主要讨论游戏、社交、动漫等话题，已进行匿名化处理。该数据集结构完整，可用于LLM训练、NLP研究及社会学分析，具有重要学术价值。数据下载和论文链接已公开。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T11:03:25Z
- **目录日期**: 2025-05-22
