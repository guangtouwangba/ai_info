...
Discord公开了名为"Discord Unveiled"的大规模数据集，包含2015-2024年间20.5亿条用户消息，涉及470万用户。数据来自10%的公共服务器，17%由机器人账号发布，涵盖多种语言（以英语为主），主题包括游戏、社交、心理健康等。所有用户信息已匿名处理。该数据集为NLP研究、社群治理和AI训练提供了宝贵资源，尤其对理解在线社交行为具有重要意义。数据集和论文可通过zenodo.org和arxiv.org获取。这是目前最完整的公开社交平台数据之一。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T16:03:31Z
- **目录日期**: 2025-05-22
