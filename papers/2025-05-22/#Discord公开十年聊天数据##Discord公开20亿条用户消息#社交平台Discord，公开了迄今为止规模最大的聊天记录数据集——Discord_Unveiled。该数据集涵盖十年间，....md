...
Discord公开了名为"Discord Unveiled"的大规模数据集，包含2015-2024年间470万用户发送的20.5亿条消息。数据来自10%的公共服务器，17%为机器人消息，涵盖多语言内容，以游戏讨论为主，同时包含社交、动漫和心理健康等话题。所有用户信息已匿名化处理。该数据集结构完整，可用于大语言模型训练、自然语言处理、社群治理等研究，具有重要学术价值。下载地址：zenodo.org/records/15170676，论文见arxiv.org/abs/2502.00627。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T23:03:17Z
- **目录日期**: 2025-05-22
