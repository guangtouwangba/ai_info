...
Discord公开了名为"Discord Unveiled"的大规模数据集，包含2015-2024年间470万用户发送的20.5亿条消息。数据来自10%的公共服务器，17%为机器人消息，涵盖多语言内容（以英语为主），主题涉及游戏、社交、心理健康等。所有用户信息已匿名处理。该数据集具有重要研究价值，可用于训练语言模型、自然语言处理、社群治理等研究，是目前最完整的社交平台公开数据集之一。数据下载和论文链接已公开。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T12:03:26Z
- **目录日期**: 2025-05-22
