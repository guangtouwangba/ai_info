# #谷歌加大AI搜索广告力度##谷歌在AI模式中引入广告#谷歌扩大了AI概览广告的投放范围，还计划在AI模式里也来点广告！先带不熟悉的朋友回顾一下这个AI模式（AI Mod...
...
谷歌近期扩大AI搜索广告投放范围，在AI模式（AI Mode）中引入广告。该功能可为用户提供搜索内容概要和相关链接，广告将出现在响应下方或整合进回答中（如建网站建议附带赞助商工具推荐）。同时，去年推出的AI概览广告从移动端扩展至桌面端，目前仅限美国用户。例如搜索"携带小型犬乘机"时，AI概览下方会显示赞助商犬笼购买链接。广告形式仍在测试中，可能成为搜索新趋势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T08:04:31Z
- **目录日期**: 2025-05-22
