...
本文提出"软思考"(Soft Thinking)方法，突破传统基于离散语言标记的推理限制。该方法通过生成连续概念空间中的抽象概念标记，实现类似人类的"软"推理。这些概念标记由标记嵌入的概率加权混合构成，能平滑过渡并超越离散边界，每个标记隐含探索多种推理路径。实验表明，在数学和编程基准测试中，该方法将pass@1准确率最高提升2.48%，同时减少22.4%的标记使用。定性分析显示其输出仍保持高可读性，有望突破基于离散语言的推理瓶颈。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T23:02:01Z
- **目录日期**: 2025-05-22
