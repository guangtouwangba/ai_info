...
这篇论文提出了“软思考”(Soft Thinking)方法，突破传统基于离散语言标记的推理限制。该方法通过生成连续概念空间中的抽象概念标记，融合多个相关标记的语义，实现更接近人类思维的流畅推理。相比标准思维链(CoT)方法，软思考能同时探索多种推理路径，在数学和编程基准测试中提升准确率最高达2.48%，同时减少22.4%的标记使用量。定性分析表明其输出仍保持高度可解释性。这一方法有望突破基于离散语言的推理瓶颈，相关代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T18:02:15Z
- **目录日期**: 2025-05-22
