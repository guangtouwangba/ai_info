...
本文提出"软思考"(Soft Thinking)方法，突破传统离散语言推理的限制。该方法通过生成连续概念空间中的抽象概念标记，实现类似人类的"软"推理。这些概念标记由多个语义相近的离散标记加权混合而成，能同时探索多种推理路径。实验表明，在数学和编程基准测试中，该方法将pass@1准确率最高提升2.48个百分点，同时减少22.4%的标记使用量。定性分析显示其输出仍保持高度可解释性。该方法突破了基于离散语言的推理瓶颈，展现了连续概念空间在增强模型推理能力方面的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T13:11:24Z
- **目录日期**: 2025-05-22
