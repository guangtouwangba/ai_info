...
麻省理工Ryan Williams教授在计算复杂性理论取得重要突破，提出空间压缩新方法：通过"可压缩卵石"模拟技术，能将算法空间需求降至时间预算的平方根级别。该研究验证了"空间比时间更强大"的理论直觉——有限空间可解决需更多时间的问题，反之则存在时间不足的硬性限制。这为证明PSPACE类严格大于P类提供了新路径，但最终证明仍需进一步扩大时空差距。研究源于树评估问题的空间压缩算法启发，是自1975年Hopcroft等人后该领域的重要进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T18:03:11Z
- **目录日期**: 2025-05-22
