...
麻省理工学院Ryan Williams教授在计算复杂性领域取得突破，提出一种能将算法空间占用大幅缩减的新方法。该研究通过"可压缩卵石"模拟技术，证明空间资源比时间更强大——少量空间可显著减少运行时间。虽然Williams证明了某些问题需要比空间更多的时间资源，但要完全解决"P对PSPACE"这一世纪难题（证明PSPACE类大于P类），仍需进一步扩大时空效率差距。这项研究源于对树评估问题的创新解法，揭示了数据可压缩叠放的新特性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T23:02:51Z
- **目录日期**: 2025-05-22
