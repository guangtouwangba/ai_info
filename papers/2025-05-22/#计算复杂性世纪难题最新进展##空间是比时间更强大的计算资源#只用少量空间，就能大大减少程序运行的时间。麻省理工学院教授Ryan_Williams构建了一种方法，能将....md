...
麻省理工教授Ryan Williams在计算复杂性理论取得突破，提出空间压缩新方法：通过"可压缩卵石"模拟技术，将算法空间需求降至时间预算的平方根级别。这证实了"空间比时间更强大"的直觉——有限空间能解决需要更多时间的问题。研究源于树评估问题的空间优化方案，Williams将其发展为通用模拟工具。虽然该成果向证明PSPACE>P迈出关键一步，但要完全解决这一世纪难题仍需进一步扩大时空计算能力的差距。该研究为计算资源优化提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T12:02:55Z
- **目录日期**: 2025-05-22
