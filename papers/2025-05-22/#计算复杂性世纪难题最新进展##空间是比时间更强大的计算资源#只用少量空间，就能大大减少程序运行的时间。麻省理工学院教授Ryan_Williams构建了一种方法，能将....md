...
麻省理工学院Ryan Williams教授在计算复杂性理论取得突破，提出空间压缩新方法。该研究通过"可压缩卵石"模拟技术，证明少量空间可大幅减少算法运行时间，将所需空间降至原时间预算的平方根级别。这支持了"空间比时间更强大"的理论直觉，即PSPACE类可能严格大于P类。虽然成果显著，但完全证明两类不等仍需进一步扩大时空差距。研究源于对树评估问题的创新解法，展示了数据压缩叠放的可能性，为计算复杂性世纪难题提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T20:03:12Z
- **目录日期**: 2025-05-22
