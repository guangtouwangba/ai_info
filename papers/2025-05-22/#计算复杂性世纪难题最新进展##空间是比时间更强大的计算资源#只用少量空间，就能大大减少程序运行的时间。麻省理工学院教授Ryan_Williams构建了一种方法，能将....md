...
麻省理工学院Ryan Williams教授在计算复杂性理论取得重要突破，提出了一种将算法空间需求大幅压缩的新方法。该研究基于1975年Hopcroft等人的"模拟"技术，结合2023年Cook-Mertz解决树评估问题的压缩算法，开发出新型通用模拟工具，使空间需求降至原时间预算的平方根级别。研究证实空间是比时间更强大的计算资源，但仍需进一步扩大差距才能完全证明PSPACE类严格大于P类。这一进展为计算复杂性世纪难题提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T22:02:58Z
- **目录日期**: 2025-05-22
