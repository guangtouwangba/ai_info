...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析及写作的一站式服务。其核心功能包括：1）中英文文献检索，支持互动问答和自动摘要生成；2）英文文献翻译与辅助阅读，可上传PDF并获取AI生成的摘要和章节概要；3）科研情报订阅，按用户偏好推送最新学术动态。平台覆盖42个学科，包含3.5亿论文、0.6亿学者等海量数据，并免费开放基础功能。特色服务还包括学者画像、学术会议追踪及论文排行榜等，旨在提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T22:05:21Z
- **目录日期**: 2025-05-22
