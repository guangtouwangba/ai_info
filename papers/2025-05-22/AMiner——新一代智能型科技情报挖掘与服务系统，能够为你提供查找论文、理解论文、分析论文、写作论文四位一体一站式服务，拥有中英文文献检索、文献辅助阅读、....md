...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、阅读辅助和科研订阅等一站式服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持中英文文献搜索、AI生成摘要、互动问答和文档翻译功能。用户可定制科研动态推送，追踪机构、学者或关键词的最新研究。平台还提供学者画像、学术会议和论文排行榜等工具，帮助高效获取和分析学术信息。AMiner的浏览器版本可免费使用，适合科研人员快速查找和理解文献。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T13:14:57Z
- **目录日期**: 2025-05-22
