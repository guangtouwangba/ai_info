...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析及写作一站式服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持中英文文献搜索、AI辅助阅读、自动摘要生成和互动问答功能。用户可订阅个性化科研动态，追踪学者或领域最新进展。平台还提供学者画像、学术会议等特色功能，基础服务免费开放。通过网页或微信小程序即可使用，帮助研究者高效获取和管理学术信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T03:24:01Z
- **目录日期**: 2025-05-22
