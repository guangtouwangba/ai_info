...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和科研订阅等一站式服务。它拥有3.5亿篇论文、0.6亿学者和1.5亿专利数据，支持中英文文献搜索、AI摘要生成和互动问答。用户可上传PDF或从平台获取论文，系统自动生成摘要和章节概要。此外，AMiner提供个性化科研动态订阅，通过微信或邮件推送最新学术资讯。平台还包含学者画像、学术会议和论文排行榜等功能，基础服务免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T09:05:55Z
- **目录日期**: 2025-05-22
