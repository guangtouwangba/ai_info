...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、AI辅助阅读、翻译、科研情报订阅等功能。它收录了3.5亿论文、0.6亿学者和1.5亿专利，支持用户通过提问快速获取文献摘要和关键信息，并能上传PDF进行智能解析。平台还提供个性化订阅服务，定期推送最新科研动态。此外，AMiner具备学者画像、学术会议追踪等特色功能，基础服务可免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T10:05:55Z
- **目录日期**: 2025-05-22
