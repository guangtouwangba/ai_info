...
随着医疗系统越来越多地采用先进无线网络和互联设备，医疗应用的安全防护变得至关重要。物联网医疗设备（如手术机器人、重症监护系统和可穿戴监测器）的整合提升了医疗质量，但也带来了严重的安全风险。针对这些设备的网络攻击可能导致危及生命的后果，包括手术失误、设备故障和数据泄露。虽然国际电联的IMT 2030愿景强调了6G通过AI和云集成对医疗的变革作用，但也引发了新的安全问题。本文探讨了SHAP、LIME和DiCE等可解释AI技术如何发现漏洞、加强防御，并提升6G医疗系统的透明度和可信度，实验分析验证了该方法的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T00:02:03Z
- **目录日期**: 2025-05-22
