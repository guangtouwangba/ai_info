...
该研究提出了一种新方法，通过模型融合而非微调来提升深度网络在小规模数据上的泛化能力。研究发现，只需对现有学习策略稍加调整，即可获得非平凡的泛化保证。该方法使泛化差距显著缩小且独立于基础网络规模，从而便于认证。实验首次证明，仅需100个样本即可在ViT-B和mistral-7B等大型模型上获得有效的泛化保证。这一发现对医疗、安全等高风险领域AI系统的可信认证具有直接意义，并为实践与理论的交叉研究开辟了新方向。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T04:03:08Z
- **目录日期**: 2025-05-22
