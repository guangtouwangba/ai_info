...
本文提出了一种新方法，通过模型融合而非微调来提升深度网络在小规模高价值数据上的泛化能力。研究发现，只需对现有学习策略稍作调整，即可获得非平凡的泛化保证。该方法使泛化差距显著缩小且与基础网络规模无关，首次实现了在仅100个样本下对VIT-B和mistral-7B等大型模型的非平凡泛化认证。这一发现对医疗、安全等关键领域AI系统的可信认证具有直接意义，为理论与实践的结合开辟了新方向。研究突破了深度网络在少样本场景下泛化认证的瓶颈。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T20:01:35Z
- **目录日期**: 2025-05-22
