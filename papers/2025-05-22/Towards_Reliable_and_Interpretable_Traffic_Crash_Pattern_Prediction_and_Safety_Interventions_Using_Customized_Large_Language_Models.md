...
这篇论文提出TrafficSafe框架，利用大语言模型(LLMs)改进交通事故预测和特征归因。该框架将多模态事故数据(58,903份真实报告及关联的环境、驾驶员等信息)转化为文本数据集，通过微调LLMs使预测F1分数比基线提升42%。研究还开发了TrafficSafe Attribution特征归因方法，发现酒驾是严重事故的主因，其风险贡献是其他驾驶行为的两倍。该框架能识别关键风险因素，指导数据收集策略，为交通安全研究提供了AI赋能的创新方案，有望实现可行动的、挽救生命的实际应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T10:02:30Z
- **目录日期**: 2025-05-22
