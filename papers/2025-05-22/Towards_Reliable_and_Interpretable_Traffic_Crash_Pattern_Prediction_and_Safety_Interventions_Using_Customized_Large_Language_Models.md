...
本文提出TrafficSafe框架，利用大语言模型（LLMs）将交通事故预测重构为基于文本的推理任务。该框架整合多模态数据（5.8万份真实事故报告及环境、驾驶员等信息），通过微调LLMs使预测F1分数提升42%。创新性地开发了TrafficSafe Attribution特征归因方法，揭示酒驾是严重事故首要因素，其风险贡献是其他驾驶行为的两倍。该框架不仅能识别关键风险因素，还可指导数据收集策略优化，为将AI技术转化为可操作的交通安全解决方案提供了范式，在事故预防领域实现突破性进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T05:02:21Z
- **目录日期**: 2025-05-22
