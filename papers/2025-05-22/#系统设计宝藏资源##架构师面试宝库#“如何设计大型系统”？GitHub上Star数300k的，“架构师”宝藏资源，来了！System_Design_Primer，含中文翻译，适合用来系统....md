...
GitHub上Star数30万的System Design Primer项目是系统设计和架构师面试的宝藏资源，提供中文翻译版本。该教程涵盖系统设计核心概念（可扩展性、可用性、缓存等）、常见面试题（AWS百万用户系统设计等）、分析框架和实战指导，并附带Anki记忆卡和编程练习。它集入门教程、面试题库和实战手册于一体，被视作大厂系统设计面试的"半官方教材"。项目地址：github.com/donnemartin/system-design-primer/blob/master/README-zh-Hans.md

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T21:04:01Z
- **目录日期**: 2025-05-22
