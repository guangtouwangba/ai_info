...
GitHub上Star数300k的"System Design Primer"是一个系统设计与架构学习的宝藏资源，包含中文翻译。该教程涵盖系统设计核心概念（可扩展性、可用性、一致性等）、常见面试题（如AWS百万用户系统设计）、实战思路框架和架构图绘制方法。配套提供Anki记忆卡和编程练习题，堪称集入门指南、面试题库和实战手册于一体的综合性资源，尤其适合准备大厂系统设计面试。项目地址：github.com/donnemartin/system-design-primer。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T15:04:02Z
- **目录日期**: 2025-05-22
