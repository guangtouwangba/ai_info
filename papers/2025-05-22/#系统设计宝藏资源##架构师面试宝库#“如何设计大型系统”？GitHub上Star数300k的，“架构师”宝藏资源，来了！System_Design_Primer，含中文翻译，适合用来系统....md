...
GitHub上Star数30万的System Design Primer是系统设计与架构师面试的宝藏资源，含中文翻译。教程涵盖可扩展性、可用性、缓存、消息队列等核心概念，提供AWS百万用户系统等实战案例及代码图示。包含分析框架、架构图绘制方法、性能瓶颈预估技巧，并配套Anki记忆卡和编程练习题。该资源整合了系统设计入门指南、面试题库和实战手册，被视作大厂面试"半官方教材"。适合系统学习架构知识和面试准备。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T12:03:59Z
- **目录日期**: 2025-05-22
