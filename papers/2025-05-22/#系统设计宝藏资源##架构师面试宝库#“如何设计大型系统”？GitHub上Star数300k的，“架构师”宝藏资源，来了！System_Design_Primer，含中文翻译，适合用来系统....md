...
GitHub上Star数300k的"System Design Primer"教程是系统设计和架构师面试的宝藏资源，包含中文翻译版本。该教程涵盖系统设计核心概念（可扩展性、可用性、一致性等）、常见面试题（AWS百万用户系统、社交网络设计等）、分析框架和实战指导，并配有Anki记忆卡和编程练习题。作为大厂系统设计面试的半官方教材，它集入门指南、面试题库和实战手册于一体，是学习架构知识和准备技术面试的优质资源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T13:13:08Z
- **目录日期**: 2025-05-22
