...
微软研究院开发的AI天气预报系统Aurora在多领域预测中超越传统数值模型：5天全球空气污染预报(74%指标更优)、10天海浪预报(86%更优)、热带气旋路径预报(100%更优)和10天全球天气预报(92%更优)。该系统采用3D Swin Transformer架构，通过预训练(百万小时地球数据)和微调两阶段学习，能以极低成本适配多种预测任务。关键优势在于高分辨率预测能力和比传统方法低数个数量级的计算成本，未来可扩展至海洋环流、极端天气预警等领域。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T22:03:43Z
- **目录日期**: 2025-05-22
