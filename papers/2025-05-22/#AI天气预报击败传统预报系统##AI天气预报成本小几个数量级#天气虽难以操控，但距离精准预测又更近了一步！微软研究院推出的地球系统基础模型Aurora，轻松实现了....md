...
微软研究院开发的AI天气预报系统Aurora在多领域预测中超越传统数值模型：5天全球空气污染预报（74%指标更优）、10天海浪预报（86%更优）、热带气旋路径预报（100%更优）和10天全球天气预报（92%更优）。其核心采用3D Swin Transformer U-Net架构，通过百万小时地球数据预训练和低成本微调实现高效预测，计算成本比传统方法低数个数量级。该系统具备处理多种地球系统任务的能力，包括极端天气预警等，展现了AI在气象领域的突破性进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T10:03:46Z
- **目录日期**: 2025-05-22
