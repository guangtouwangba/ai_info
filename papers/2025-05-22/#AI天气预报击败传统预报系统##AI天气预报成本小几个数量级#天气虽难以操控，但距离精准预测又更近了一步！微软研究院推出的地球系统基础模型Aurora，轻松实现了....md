...
微软研究院开发的AI天气预报系统Aurora在多个关键领域超越传统数值模型：5天全球空气污染预报(74%指标更优)、10天海浪预报(86%更优)、热带气旋路径预报(100%领先)及10天全球天气预报(92%指标更好)。该系统采用3D Swin Transformer U-Net架构，通过百万小时地球系统数据预训练，能以极低成本适配新任务。相比传统方法，Aurora不仅精度更高，计算成本还低数个数量级，在极端天气预警等领域具有应用潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T15:03:52Z
- **目录日期**: 2025-05-22
