...
微软研究院开发的AI天气预测模型Aurora在多领域超越传统数值预报系统：5天全球空气污染预报(74%指标领先)、10天海浪预报(86%领先)、热带气旋路径预报(100%领先)及10天全球天气预报(92%指标占优)，且计算成本降低数个数量级。该模型采用三维Transformer架构，通过百万小时地球系统数据预训练，能低成本适配多种预测任务。其核心优势在于高分辨率预测和极端天气预警能力，未来可扩展至海洋环流、植被监测等领域。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T19:03:40Z
- **目录日期**: 2025-05-22
