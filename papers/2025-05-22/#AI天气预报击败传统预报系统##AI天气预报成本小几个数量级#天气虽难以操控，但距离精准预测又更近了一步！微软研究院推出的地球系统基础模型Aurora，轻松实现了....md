...
微软研究院开发的AI天气预报系统Aurora在多领域超越传统数值模型：5天全球空气污染预报（74%指标更优）、10天海浪预报（86%更优）、热带气旋路径预报（100%领先）及10天全球天气预报（92%指标领先）。其核心采用3D Swin Transformer U-Net架构，通过百万小时地球数据预训练，能以极低成本微调适配新任务。关键优势包括超高分辨率（最高0.1°）、极端天气预测提升及计算成本降低数个数量级，可扩展至海洋、生态等领域的监测预警。论文见：arxiv.org/abs/2405.13063

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-22T17:03:42Z
- **目录日期**: 2025-05-22
