...
传统优化编译器在现代软件系统的复杂性管理中扮演重要角色，而高效并行编程的需求推动了优化技术的发展。本研究探讨了大型语言模型（LLMs）是否能够革新代码优化方法，通过对比三种经典优化编译器与两种LLMs的性能。研究发现，LLMs虽能超越传统编译器（如CodeLlama-70B最高提速1.75倍），但在大代码量时易生成错误代码，需自动化验证。将编译器策略融入提示词可显著提升LLMs表现。三种提示策略（简单指令、详细指令、思维链）效果差异显著，其中CETUS编译器最佳提速达1.67倍。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T15:02:35Z
- **目录日期**: 2025-04-03
