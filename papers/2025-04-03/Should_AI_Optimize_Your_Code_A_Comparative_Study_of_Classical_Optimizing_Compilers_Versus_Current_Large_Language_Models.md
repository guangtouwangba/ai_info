...
传统优化编译器在现代软件系统复杂性增长中发挥了重要作用，而当前架构对高效并行编程的需求要求更强的优化技术。本研究探讨了大型语言模型（LLMs）是否能革新代码优化方法，通过对比三种经典优化编译器和两种LLMs的性能。研究发现，LLMs虽能超越传统编译器（如CodeLlama-70B最高提速1.75倍），但在大代码量时易生成错误代码，需自动化验证。将编译器策略融入提示词可显著提升LLMs性能。三种提示策略（简单指令、详细指令和思维链）效果差异显著，而传统编译器CETUS最高提速1.67倍。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T19:02:27Z
- **目录日期**: 2025-04-03
