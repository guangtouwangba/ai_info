...
传统优化编译器在现代软件系统的复杂性管理中至关重要。本研究探讨了大型语言模型（LLMs）能否革新代码优化方法，通过对比三种传统编译器与两种LLMs的性能。结果显示，LLMs（如CodeLlama-70B）在部分情况下表现优于传统编译器（如CETUS），最高提速达1.75倍，但大代码量时易生成错误代码，需自动化验证。提示策略（如详细指令和思维链）显著影响LLMs表现。研究提出了优化模式测试套件和自动评估机制，为AI驱动的代码优化提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T07:02:50Z
- **目录日期**: 2025-04-03
