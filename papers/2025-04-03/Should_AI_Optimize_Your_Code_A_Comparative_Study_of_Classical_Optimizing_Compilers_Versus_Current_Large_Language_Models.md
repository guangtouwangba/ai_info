...
传统优化编译器在现代软件系统发展中至关重要。本研究探讨了大型语言模型（LLMs）能否革新代码优化方法，通过对比三种经典编译器与两种LLM的性能。结果显示，LLM（如CodeLlama-70B）在优化潜力上可超越传统编译器（如CETUS），最高提速达1.75倍，但大代码量时易出错，需自动化验证。三种提示策略（简单指令、详细指令和思维链）中，将编译器策略融入提示能显著提升LLM表现。研究还提出了优化模式测试集和自动评估机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T17:02:35Z
- **目录日期**: 2025-04-03
