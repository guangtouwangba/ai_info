...
人类在理解视觉关系方面远优于AI系统，尤其是对未见过的物体。受主动视觉理论启发，研究者开发了基于Glimpse的主动感知系统（GAP），通过依次注视图像中最显著区域并高分辨率处理，结合注视位置和周围视觉内容来表征图像各部分关系。实验表明，GAP能提取超越直接视觉内容的关系，在多个视觉推理任务中达到最先进性能，比现有模型更高效且对分布外输入具有更好泛化能力。该系统模拟人类眼动机制，验证了低维空间信息对视觉关系表征的关键作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T02:28:26Z
- **目录日期**: 2025-04-03
