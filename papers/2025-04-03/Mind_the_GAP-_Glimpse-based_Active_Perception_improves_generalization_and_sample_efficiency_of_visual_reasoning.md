...
人类在理解视觉关系方面远优于AI系统，尤其是对新物体。受主动视觉理论启发，研究者开发了基于Glimpse的主动感知系统(GAP)，通过模拟人眼注视机制，依次聚焦图像关键区域并高分辨率处理。该系统利用注视位置及周边视觉内容表征图像各部分关系。实验表明，GAP能提取超越直接视觉内容的关系，在多项视觉推理任务中达到最先进性能，比现有模型更高效且对分布外输入泛化能力更强。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T01:29:03Z
- **目录日期**: 2025-04-03
