...
这篇论文探讨了代码生成大模型(codeLLMs)与人类偏好的对齐问题。研究者创建了CodeArena基准测试，包含397个高质量样本，覆盖40个类别和44种编程语言，更贴近实际编程任务。同时开发了SynCode-Instruct语料库(约200亿标记)验证合成指令微调效果。实验发现传统基于执行的测试与CodeArena存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距明显，凸显了人类偏好对齐的重要性。研究强调了代码生成模型不仅需要正确性，还需符合人类编程习惯和偏好。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T14:06:07Z
- **目录日期**: 2025-04-03
