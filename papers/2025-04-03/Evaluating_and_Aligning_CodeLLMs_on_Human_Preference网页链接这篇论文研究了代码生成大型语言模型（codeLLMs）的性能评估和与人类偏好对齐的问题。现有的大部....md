...
这篇论文提出了CodeArena基准测试和SynCode-Instruct数据集，用于评估代码生成大模型(codeLLMs)与人类偏好的对齐程度。研究发现现有基准过度关注代码正确性而忽视人类偏好，为此构建了包含397个样本、覆盖40类44种编程语言的测试集。实验显示执行基准与人类偏好评估存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI)性能差距显著。研究还验证了大规模合成指令微调的有效性，突显了代码生成模型与人类偏好对齐的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T11:06:22Z
- **目录日期**: 2025-04-03
