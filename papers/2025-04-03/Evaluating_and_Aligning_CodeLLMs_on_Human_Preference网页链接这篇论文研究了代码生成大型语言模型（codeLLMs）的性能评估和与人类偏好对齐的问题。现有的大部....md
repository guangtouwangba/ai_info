...
这篇论文探讨了代码生成大模型(codeLLMs)与人类偏好的对齐问题。研究者创建了CodeArena基准测试，包含397个高质量编程样本，覆盖40个类别和44种语言，更贴近实际开发场景。同时构建了SynCode-Instruct语料库(近200亿标记)验证合成指令微调效果。实验发现传统基准与CodeArena存在性能差异，且开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)差距显著，凸显了人类偏好对齐的重要性。研究为代码生成模型的评估提供了更全面的视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T16:05:55Z
- **目录日期**: 2025-04-03
