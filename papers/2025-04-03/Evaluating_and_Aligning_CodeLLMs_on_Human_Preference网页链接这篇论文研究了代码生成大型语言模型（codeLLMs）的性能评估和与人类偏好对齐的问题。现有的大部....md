...
这篇论文探讨了代码生成大模型（codeLLMs）如何与人类偏好对齐的问题。研究指出，现有基准测试过于关注代码正确性，忽视了人类偏好。为此，作者构建了CodeArena基准测试（含397个样本，覆盖40类任务和44种语言）和SynCode-Instruct合成指令数据集（20B标记）。实验发现执行基准与人类偏好测试存在差异，且开源模型（如Qwen2.5-Coder）与商业模型（如OpenAI o1）性能差距显著，凸显了人类偏好对齐的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T09:06:24Z
- **目录日期**: 2025-04-03
