...
这篇论文探讨了LLMs中的"反转诅咒"现象，即模型难以学习可逆的事实关联，认为这与认知科学中的"绑定问题"有关。研究发现，问题源于Transformer在概念绑定上的两个局限：概念表征的不一致性和纠缠性。作者提出基于JEPA架构的新模型设计，首次无需数据增强或非因果掩码就解决了反转诅咒，并通过引入特殊记忆层进一步提升了泛化能力。实验表明，这种反转能力使模型能通过参数化前向链解决大规模算术推理问题，性能超越了依赖非参数化记忆的前沿LLMs。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T06:01:24Z
- **目录日期**: 2025-04-03
