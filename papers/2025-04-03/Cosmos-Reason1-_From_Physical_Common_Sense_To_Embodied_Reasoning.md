...
本文介绍了Cosmos-Reason1模型，旨在通过长链思维推理理解物理世界并生成自然语言决策。研究定义了物理常识和具身推理等关键能力，采用分层本体表示物理常识，二维本体泛化具身推理。开发了8B和56B参数的多模态大模型，通过视觉预训练、监督微调、物理AI微调和强化学习四阶段训练。基于本体的评估显示，物理AI微调和强化学习显著提升了性能。代码和预训练模型将在NVIDIA开放模型许可下发布，以促进物理AI发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T12:02:19Z
- **目录日期**: 2025-04-03
