...
本文介绍了Cosmos-Reason1模型，旨在通过长链思维推理理解物理世界并生成具身决策。模型基于物理常识（空间、时间、物理知识的分层本体）和具身推理（二维本体）构建，开发了8B和56B参数的多模态大语言模型。训练分四个阶段：视觉预训练、通用监督微调、物理AI微调及强化学习后训练。评估显示后两阶段显著提升性能。研究建立了物理常识与具身推理的基准测试，代码和预训练模型将通过NVIDIA开放模型许可发布，推动物理AI发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T13:08:54Z
- **目录日期**: 2025-04-03
