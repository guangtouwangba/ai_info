...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟1万多个智能代理及其500万次社会互动。研究者利用该平台研究了社会极化、信息传播、基本收入政策及自然灾害影响四个关键问题，其模拟结果与现实数据高度吻合。该系统展现了作为社会科学研究工具的强大潜力，能有效辅助传统研究方法，帮助理解人类行为机制和社会问题成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T05:04:43Z
- **目录日期**: 2025-04-03
