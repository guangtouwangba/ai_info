...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟超过1万个智能代理及其500万次社会互动。研究者利用该平台开展计算社会科学实验，研究了社会极化、信息传播、基本收入政策及自然灾害影响等关键问题。模拟结果与现实世界数据高度吻合，验证了该系统对人类行为和社会机制的捕捉能力。这项技术为社会科学研究和政策制定提供了创新工具，能有效补充传统调查和实验方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T08:05:44Z
- **目录日期**: 2025-04-03
