...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟1万多个代理的社会互动（500万次）。它通过四个案例（社会极化、信息传播、基本收入政策、飓风影响）验证其有效性，结果与现实研究一致。该系统能辅助传统社会科学方法（如调查），揭示社会问题的模式和机制，为研究者和政策制定者提供新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T12:05:34Z
- **目录日期**: 2025-04-03
