...
AgentSociety是一个基于大语言模型的大规模社会模拟器，能模拟1万多个代理的社会互动（500万次）。研究者用它分析四大社会问题：社会极化、信息传播、基本收入政策影响和自然灾害冲击。模拟结果与现实数据高度吻合，验证了该系统在揭示人类行为机制方面的有效性。该平台可作为传统社会科学研究方法（如调查、实验）的补充工具，帮助研究者和政策制定者更深入地理解社会动态。研究展示了AI模拟在社会科学领域的应用潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T17:05:07Z
- **目录日期**: 2025-04-03
