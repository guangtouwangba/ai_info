...
联想集团在2025/26新财年誓师大会上宣布启动"第五次创业"，全面进军AI领域。CEO杨元庆表示，联想将进行全方位的AI转型，不仅限于AI PC产品，而是从底层基础设施到企业智能体平台进行全面布局，甚至重构品牌定位。这标志着这家科技巨头正式加入AI创业赛道，计划打造完整的AI生态系统。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T23:03:05Z
- **目录日期**: 2025-04-03
