...
本文提出了一种评估合成数据质量的框架，通过分布比较、嵌入相似度和近邻距离等量化指标，衡量合成数据在保护隐私的同时还原原始数据分布的能力。该框架采用保留集基准测试策略，支持多种数据类型（包括序列和上下文信息），并提供标准化指标以实现可解释的质量诊断，旨在提升合成数据生成技术的可复现性与方法一致性。相关代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T22:01:50Z
- **目录日期**: 2025-04-03
