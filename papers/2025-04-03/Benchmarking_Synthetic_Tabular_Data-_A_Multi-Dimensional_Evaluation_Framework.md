...
本文提出了一种评估合成数据质量的框架，旨在平衡隐私保护与数据实用性。该框架采用保留集基准测试策略，通过低维/高维分布对比、嵌入相似度测量和最近邻距离指标进行量化评估。它支持多种数据类型（包括序列和上下文信息），并提供标准化指标以实现可解释的质量诊断。该方案致力于提升合成数据生成技术的可复现性和方法一致性，相关代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T09:01:58Z
- **目录日期**: 2025-04-03
