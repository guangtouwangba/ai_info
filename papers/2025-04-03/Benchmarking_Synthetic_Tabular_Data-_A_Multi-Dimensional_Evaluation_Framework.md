...
该研究提出了一种评估合成数据质量的框架，通过量化合成数据对原始数据分布特性的还原程度来平衡隐私性与实用性。该框架采用基于保留集的基准测试策略，结合低维/高维分布比较、嵌入相似度测量和最近邻距离度量进行定量评估，支持多种数据类型（包括序列和上下文信息），并提供标准化指标以实现可解释的质量诊断。该方案旨在提升合成数据生成技术的可复现性与方法一致性，相关代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T18:01:58Z
- **目录日期**: 2025-04-03
