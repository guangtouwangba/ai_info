...
本研究探讨了图博弈（graphon games）的均衡存在性及其与大网络博弈的关系。首先，在效用函数连续且拟凹的条件下，证明了无限维策略空间的图博弈均衡存在性。其次，研究表明图博弈的纳什均衡是大网络博弈渐进均衡的极限点：当大网络博弈序列收敛至图博弈时，其渐进均衡序列的极限即为图博弈的均衡；反之，任意图博弈均衡均可由某一大网络博弈序列的渐进均衡逼近。这些结论表明，图博弈是玩家数量趋近无限时大网络博弈的理想化极限模型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T15:00:59Z
- **目录日期**: 2025-04-03
