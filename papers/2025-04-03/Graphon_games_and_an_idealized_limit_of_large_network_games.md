...
本研究探讨了图论博弈（graphon games）的均衡存在性及其与大型网络博弈的关系。首先，在效用函数连续且拟凹的条件下，证明了无限维策略空间的图论博弈均衡存在性。其次，研究表明图论博弈的纳什均衡可作为大型网络博弈渐近均衡的极限点：当网络博弈序列收敛至图论博弈时，其渐近均衡序列也收敛于图论博弈的均衡；反之，任意图论博弈均衡都可作为某收敛网络博弈序列的渐近均衡极限。这些结论表明，图论博弈是玩家数量趋近无限时大型网络博弈的理想化极限模型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T09:01:07Z
- **目录日期**: 2025-04-03
