...
本文研究了图子博弈（graphon games）的均衡存在性及其与大网络博弈的关系。首先证明了在效用函数连续且拟凹的条件下，无限维策略空间的图子博弈存在均衡。其次，刻画了图子博弈的纳什均衡是大网络博弈渐近纳什均衡的极限点：当大网络博弈序列收敛于图子博弈时，其渐近纳什均衡的收敛点即为图子博弈的均衡；反之，任意图子博弈均衡都可被某一大网络博弈序列的渐近纳什均衡序列逼近。这表明图子博弈是玩家数量趋近无穷时大网络博弈的理想极限模型。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T07:01:16Z
- **目录日期**: 2025-04-03
