...
本研究探讨了图博弈（graphon games）中的均衡存在性及其与大型网络博弈的关系。首先，证明了在效用函数连续且拟凹的条件下，无限维策略空间的图博弈存在均衡。其次，研究表明图博弈的纳什均衡是大型网络博弈渐近均衡的极限点：当网络博弈序列收敛至图博弈时，其渐近均衡序列也收敛至图博弈均衡；反之，任意图博弈均衡均可由某网络博弈序列的渐近均衡逼近。这些结论表明，图博弈是玩家数量趋近无限时大型网络博弈的理想化极限模型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T23:01:00Z
- **目录日期**: 2025-04-03
