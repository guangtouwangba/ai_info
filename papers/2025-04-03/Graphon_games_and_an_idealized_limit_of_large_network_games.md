...
该研究探讨了图子博弈（graphon games）的均衡存在性及其与大网络博弈的关系。首先，在效用函数连续且拟凹的条件下，证明了无限维策略空间的图子博弈均衡存在性。其次，研究表明图子博弈的纳什均衡可作为大网络博弈渐近均衡的极限点：当大网络博弈序列收敛至图子博弈时，其渐近均衡的收敛点必为图子博弈的均衡；反之，任意图子博弈均衡均可由某大网络博弈序列的渐近均衡逼近。这些结论表明，图子博弈是玩家数量趋近无限时大网络博弈的理想极限模型。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T10:01:06Z
- **目录日期**: 2025-04-03
