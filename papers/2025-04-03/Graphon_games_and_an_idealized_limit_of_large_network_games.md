...
本研究探讨了图论博弈（graphon games）的均衡存在性及其与大型网络博弈的极限关系。首先证明了在效用函数连续且拟凹条件下，无限维策略空间的图论博弈存在均衡。其次，研究表明图论博弈的纳什均衡可作为大型网络博弈渐近均衡的极限点：当网络博弈序列收敛于图论博弈时，其渐近均衡序列必收敛于图论博弈的均衡；反之，任意图论博弈均衡都可找到对应收敛的有限网络博弈序列。这证实了图论博弈是玩家数量趋近无限时大型网络博弈的理想化极限模型。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T19:01:00Z
- **目录日期**: 2025-04-03
