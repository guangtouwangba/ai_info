...
本研究证明了图子博弈（graphon games）在效用函数连续且拟凹的条件下存在纳什均衡，其策略空间为无限维。此外，研究还表明图子博弈的纳什均衡可作为大型网络博弈中渐近纳什均衡的极限点：当网络博弈序列收敛于图子博弈时，其渐近均衡序列也收敛于图子博弈的均衡；反之，任意图子博弈均衡都存在收敛于它的网络博弈序列及其渐近均衡。这些结果说明图子博弈是玩家数量趋近无限时大型网络博弈的理想化极限模型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T08:01:04Z
- **目录日期**: 2025-04-03
