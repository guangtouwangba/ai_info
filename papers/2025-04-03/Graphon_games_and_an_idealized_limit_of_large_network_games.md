...
该研究探讨了图博弈（graphon games）的均衡存在性及其与大网络博弈的关系。首先，在效用函数连续且拟凹的条件下，证明了无限维策略空间的图博弈均衡存在性。其次，研究表明图博弈的纳什均衡是大网络博弈中渐进纳什均衡的极限点：当大网络博弈序列收敛于图博弈时，其渐进纳什均衡序列也收敛于图博弈的均衡；反之，任意图博弈均衡均可通过某收敛的大网络博弈序列的渐进均衡逼近。这些结论表明，图博弈是玩家数量趋于无穷时大网络博弈的理想化极限模型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T03:13:05Z
- **目录日期**: 2025-04-03
