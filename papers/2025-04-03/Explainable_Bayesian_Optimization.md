...
本文提出TNTRules算法，用于解决信息物理系统中贝叶斯优化(BO)的可解释性问题。该算法通过方差剪枝和层次聚类技术，生成全局和局部解释规则及可视化图表，能识别最优解范围和替代方案。相比现有可解释AI方法，TNTRules专门针对BO设计，采用多目标优化最大化解释质量。实验表明，在5个多目标测试函数和2个超参数调优问题上，TNTRules在正确性、完整性和紧凑性方面显著优于三种基线方法，能提供高保真、简洁且完整的解释，有效提升人机协作调优的可信度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T00:02:53Z
- **目录日期**: 2025-04-03
