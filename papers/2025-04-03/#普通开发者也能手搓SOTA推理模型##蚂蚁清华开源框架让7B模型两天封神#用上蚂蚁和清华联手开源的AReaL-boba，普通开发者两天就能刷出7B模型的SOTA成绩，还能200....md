...
蚂蚁和清华联合开源了AReaL-boba框架，使普通开发者能在两天内训练出7B规模的SOTA推理模型，仅需200美元即可复现32B模型QwQ的性能。该框架具有训练快、推理强、成本低三大优势，被比喻为"AI界的奶茶三兄弟"。相关技术方案（含数据/代码/模型）已全面开源，显著降低了高性能AI模型的开发门槛。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T14:03:04Z
- **目录日期**: 2025-04-03
