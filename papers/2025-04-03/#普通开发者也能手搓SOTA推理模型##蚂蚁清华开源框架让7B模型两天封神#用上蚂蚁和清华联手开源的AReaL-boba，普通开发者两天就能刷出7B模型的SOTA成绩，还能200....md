...
蚂蚁集团与清华大学联合开源AReaL-boba框架，使普通开发者能在两天内训练出7B参数的SOTA推理模型（如QwQ），成本仅需200美元。该框架显著降低训练门槛，具备高效（快速训练）、高性能（达到顶尖水平）和低成本三大优势，被比喻为"AI界的奶茶三兄弟"。相关数据、代码和模型已全面开源，大幅提升了中小开发者复现前沿模型的能力，尤其在数学推理任务中展现出强化学习的突破性效果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T16:03:00Z
- **目录日期**: 2025-04-03
