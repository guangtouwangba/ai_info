...
蚂蚁集团与清华大学联合开源AReaL-boba框架，使普通开发者能在两天内训练出7B参数的SOTA推理模型，并以200美元低成本复现32B规模的QwQ模型。该框架具备高效训练、强大推理和低成本优势，被比喻为AI界的"奶茶三兄弟"——易用、高效且普惠。相关技术方案（含数据/代码/模型）已全面开源，显著降低了高性能数学推理模型的开发门槛。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T21:02:53Z
- **目录日期**: 2025-04-03
