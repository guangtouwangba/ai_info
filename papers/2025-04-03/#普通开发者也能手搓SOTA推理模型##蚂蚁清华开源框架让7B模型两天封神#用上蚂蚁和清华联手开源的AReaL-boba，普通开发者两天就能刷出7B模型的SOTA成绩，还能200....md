...
蚂蚁集团与清华大学联合开源AReaL-boba框架，使普通开发者能在两天内训练出7B参数模型的SOTA推理性能，成本仅200美元即可复现32B模型QwQ的效果。该框架具备训练快、推理强、成本低三大优势，被比喻为"AI界的奶茶三兄弟"（易获取、高性能、平民化）。其开源性覆盖数据、代码和模型，显著降低了高性能AI模型的开发门槛，特别在数学推理任务中展现出强化学习的突破性效果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T12:03:13Z
- **目录日期**: 2025-04-03
