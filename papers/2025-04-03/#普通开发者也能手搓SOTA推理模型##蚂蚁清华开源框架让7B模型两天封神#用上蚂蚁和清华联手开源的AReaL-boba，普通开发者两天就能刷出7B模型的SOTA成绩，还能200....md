...
蚂蚁集团与清华大学联合开源了AReaL-boba框架，使普通开发者能在2天内训练出7B参数的SOTA推理模型，并以200美元低成本复现32B大模型QwQ。该框架具有训练快、推理强、成本低三大优势，被比喻为"AI界的奶茶三兄弟"（好喝、管饱、人人可及）。相关数据、代码和模型已全部开源，显著降低了高性能AI模型的开发门槛，特别在数学推理任务上展现出强化学习的突破性效果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T15:03:00Z
- **目录日期**: 2025-04-03
