...
蚂蚁集团与清华大学联合开源了AReaL-boba框架，使普通开发者能在两天内训练出性能顶尖的7B参数模型，并以200美元低成本复现32B参数模型QwQ。该框架具有训练速度快、推理能力强、成本低三大优势，被比喻为AI界的"奶茶三兄弟"——易获取、高性能且平民化。该成果包含完整开源的数据、代码和模型，显著降低了高性能AI模型开发门槛，特别在数学推理任务上展现出强化学习带来的显著性能提升。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T19:02:48Z
- **目录日期**: 2025-04-03
