...
蚂蚁集团与清华大学联合开源AReaL-boba框架，使普通开发者能在2天内训练出7B参数规模的SOTA推理模型，仅需200美元即可复现32B参数的QwQ模型。该框架以"训练快、推理强、成本低"为特点，显著降低大模型训练门槛，相关数据、代码和模型已全面开源。其高效性被类比为"奶茶三兄弟"（好喝、管饱、易获取），特别在数学推理任务上展现出强化学习的突破性表现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T23:02:55Z
- **目录日期**: 2025-04-03
