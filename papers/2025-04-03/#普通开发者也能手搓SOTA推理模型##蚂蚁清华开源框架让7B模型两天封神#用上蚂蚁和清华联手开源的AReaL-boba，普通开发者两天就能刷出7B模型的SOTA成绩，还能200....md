...
蚂蚁集团与清华大学联合开源了AReaL-boba框架，使普通开发者能在两天内训练出7B参数的SOTA推理模型，并以200美元低成本复现32B规模的QwQ模型。该框架具有训练速度快、推理能力强、成本低廉三大优势，被比喻为"奶茶三兄弟"——易获取、高性能且平民化。相关数据、代码和模型已全部开源，显著降低了AI模型开发门槛，特别在数学推理任务上展现出强化学习的突破性表现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T17:02:58Z
- **目录日期**: 2025-04-03
