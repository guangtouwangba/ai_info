...
蚂蚁集团与清华大学联合开源了AReaL-boba框架，使普通开发者能在两天内训练出7B参数规模的SOTA推理模型，仅需200美元即可复现32B参数的QwQ模型表现。该框架具有训练速度快、推理能力强、成本低的特点，被比喻为AI界的"奶茶三兄弟"——易获取、高性能且普惠。相关数据、代码和模型已全面开源，显著降低了高性能数学推理模型的门槛。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T20:02:48Z
- **目录日期**: 2025-04-03
