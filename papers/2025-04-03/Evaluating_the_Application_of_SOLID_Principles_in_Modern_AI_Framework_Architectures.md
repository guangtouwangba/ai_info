...
本研究评估了TensorFlow和scikit-learn两大AI框架对SOLID设计原则的遵循程度。分析发现，TensorFlow为追求性能和可扩展性，在单一职责和接口隔离等原则上有所妥协；而scikit-learn更贴近SOLID原则，但也会为性能优化做出调整。研究表明，AI框架需要在软件工程最佳实践与领域特定需求（如性能、可扩展性和开发灵活性）之间权衡，这导致它们必须策略性地偏离传统设计原则。该研究揭示了领域约束如何影响AI框架的架构决策，以及它们如何平衡这些相互矛盾的需求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T22:02:09Z
- **目录日期**: 2025-04-03
