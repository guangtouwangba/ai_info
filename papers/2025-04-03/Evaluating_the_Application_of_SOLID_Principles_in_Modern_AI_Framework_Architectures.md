...
本研究评估了TensorFlow和scikit-learn两大AI框架对SOLID设计原则的遵循程度。分析发现，两者在性能、可扩展性和AI开发特性之间进行了权衡：TensorFlow为性能牺牲了部分单一职责和接口隔离原则；scikit-learn更贴近SOLID原则，但仍有性能优化导致的偏离。研究表明，AI框架需根据具体场景在软件工程原则与领域需求间取得平衡，传统设计原则的适用性取决于性能、扩展性等特定约束。该研究揭示了AI框架如何通过战略性设计选择来协调这些矛盾需求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T12:02:29Z
- **目录日期**: 2025-04-03
