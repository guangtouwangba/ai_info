...
本研究评估了TensorFlow和scikit-learn两大AI框架对SOLID设计原则的遵循程度。分析发现，TensorFlow为追求性能和可扩展性，在单一职责和接口隔离等原则上有意妥协；而scikit-learn更贴近SOLID原则，但也会为性能优化做出调整。研究表明，AI框架需要在软件工程最佳实践与特定领域需求（如性能、可扩展性和开发灵活性）之间权衡，这导致它们策略性地偏离传统设计原则。该研究揭示了领域特性如何影响AI框架的架构决策，以及这些框架如何平衡相互矛盾的设计需求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T20:02:07Z
- **目录日期**: 2025-04-03
