...
本研究评估了TensorFlow和scikit-learn两大AI框架对SOLID设计原则的遵循程度。通过分析架构文档和源码发现，两个框架均部分采纳SOLID原则，但会为性能、可扩展性和AI开发特性做出权衡。TensorFlow更侧重性能与扩展性，在单一职责和接口隔离原则上有所妥协；scikit-learn则更贴近SOLID原则，但也会为性能优化适当偏离。研究表明，AI框架需根据具体场景在软件工程原则与领域需求间取得平衡，性能、扩展性等考量往往需要突破传统设计规范。这揭示了领域特性如何影响AI框架的架构决策。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T14:02:21Z
- **目录日期**: 2025-04-03
