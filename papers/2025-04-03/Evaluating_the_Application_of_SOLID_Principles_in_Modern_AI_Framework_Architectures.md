...
本研究评估了TensorFlow和scikit-learn两大AI框架对SOLID设计原则的遵循程度。分析发现，TensorFlow为追求性能和可扩展性，在单一职责和接口隔离等原则上有意妥协；而scikit-learn更贴近SOLID原则，但仍存在为性能优化而偏离的情况。研究表明，AI框架需根据性能、可扩展性和灵活性等特定需求，在软件工程最佳实践与领域需求间权衡取舍。该研究揭示了领域限制如何影响AI框架架构决策，以及这些框架如何策略性地调整设计来平衡相互矛盾的需求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T06:02:14Z
- **目录日期**: 2025-04-03
