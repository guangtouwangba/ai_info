...
本研究评估了TensorFlow和scikit-learn两大AI框架对SOLID设计原则的遵循程度。分析发现，两者在性能、可扩展性和AI开发特性之间做出了权衡：TensorFlow为性能牺牲了单一职责和接口隔离原则；scikit-learn更贴近SOLID原则，但仍有优化性能的例外。研究表明，AI框架需根据具体场景灵活应用软件工程原则，性能需求常导致对传统原则的偏离。该研究揭示了领域特定需求如何影响AI框架的架构决策，以及这些框架如何战略性地平衡相互矛盾的设计要求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T15:02:14Z
- **目录日期**: 2025-04-03
