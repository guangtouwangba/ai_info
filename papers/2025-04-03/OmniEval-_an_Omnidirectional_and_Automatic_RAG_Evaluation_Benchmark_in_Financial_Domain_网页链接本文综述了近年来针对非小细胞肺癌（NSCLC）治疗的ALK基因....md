...
这篇论文介绍了OmniEval，一个针对金融领域的全方位自动RAG（检索增强生成）评估基准。同时，文章还综述了非小细胞肺癌（NSCLC）治疗中ALK基因双靶点抑制剂的最新研究进展。ALK基因是NSCLC的重要致癌驱动因素，尽管已有7种ALK抑制剂获批，但耐药性问题仍然存在。研究指出，相比联合用药，能同时靶向两个位点的单一分子抑制剂在减少副作用和克服耐药性方面更具优势。文章总结了这类双靶点抑制剂的设计策略和结构-活性关系，为开发新型抗癌药物提供了重要见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T08:05:26Z
- **目录日期**: 2025-04-03
