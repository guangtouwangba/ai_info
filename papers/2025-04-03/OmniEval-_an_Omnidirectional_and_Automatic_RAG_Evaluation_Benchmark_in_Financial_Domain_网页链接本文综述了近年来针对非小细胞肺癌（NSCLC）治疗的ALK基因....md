...
这篇论文介绍了OmniEval，一个面向金融领域的全方位自动RAG（检索增强生成）评估基准。同时，文章综述了非小细胞肺癌（NSCLC）治疗中针对ALK基因的双靶点抑制剂研究进展。ALK基因是NSCLC的重要致癌驱动因子，尽管已有7种ALK抑制剂获批，但耐药性问题仍然存在。研究显示，相比联合用药，单一分子同时靶向两个位点的双靶点抑制剂能减少副作用和毒性，在克服耐药性方面更具优势。文章总结了这类抑制剂的设计策略和结构-活性关系，为开发新型ALK靶向药提供了重要见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T15:05:20Z
- **目录日期**: 2025-04-03
