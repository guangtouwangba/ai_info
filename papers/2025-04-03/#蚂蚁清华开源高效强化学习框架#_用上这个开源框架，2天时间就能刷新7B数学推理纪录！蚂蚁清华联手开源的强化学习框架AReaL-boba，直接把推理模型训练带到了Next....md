# #蚂蚁清华开源高效强化学习框架# 用上这个开源框架，2天时间就能刷新7B数学推理纪录！蚂蚁清华联手开源的强化学习框架AReaL-boba，直接把推理模型训练带到了Next...
...
蚂蚁集团与清华大学联合开源强化学习框架AReaL-boba，显著提升模型训练效率：仅用2天刷新7B模型数学推理记录，32B模型仅需200美元和200条数据即可复现媲美DeepSeek-R1的QwQ-32B。该框架全面开源训练代码、数据、模型参数及技术文档，大幅降低训练成本（效率提升+成本下降），使普通开发者也能高效构建高性能推理模型。技术亮点包括详细教程支持和小样本高精度训练能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T08:04:08Z
- **目录日期**: 2025-04-03
