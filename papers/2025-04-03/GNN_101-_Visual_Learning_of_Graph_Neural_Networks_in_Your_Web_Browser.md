...
这篇论文介绍了一个名为GNN 101的教育可视化工具，旨在帮助非AI专家理解图神经网络(GNNs)的复杂结构和运作原理。该工具通过动画可视化将数学公式与多级抽象（包括模型概览、层操作和详细计算）无缝结合，提供两种互补视图：直观展示图数据的节点-链接视图和高效展示特征及层间转换的矩阵视图。GNN 101是与四位GNN专家合作开发，并在三门GNN课程中部署验证。用户研究表明该工具对助教和学生都有效。作为开源工具，GNN 101可直接在浏览器中使用，无需安装。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T02:28:05Z
- **目录日期**: 2025-04-03
