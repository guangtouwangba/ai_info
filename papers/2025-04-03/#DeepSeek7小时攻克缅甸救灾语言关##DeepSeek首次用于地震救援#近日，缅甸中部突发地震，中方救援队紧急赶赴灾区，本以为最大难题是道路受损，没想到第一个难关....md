...
近日缅甸发生地震，中方救援队面临语言障碍。国家应急语言服务团与北京语言大学紧急开发基于DeepSeek模型的中缅英三语互译平台，仅用7小时上线。该平台提供分类清晰的应急短语，包括50句高频救援用语，操作简单无需培训，支持一键复制翻译。已帮助700多名缅甸用户与救援队高效沟通，成为救灾中的"语言桥梁"。这是AI首次应用于地震救援，展现了技术在紧急情况下的实用价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T00:04:34Z
- **目录日期**: 2025-04-03
