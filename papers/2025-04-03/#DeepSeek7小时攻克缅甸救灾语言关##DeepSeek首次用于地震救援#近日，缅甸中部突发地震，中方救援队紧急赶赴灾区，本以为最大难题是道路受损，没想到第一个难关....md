...
DeepSeek AI模型在7小时内开发出中缅英三语互译平台，助力缅甸地震救援。该平台由国家应急语言服务团和北京语言大学紧急开发，提供关键应急短语翻译，覆盖指挥撤离、医疗沟通等场景，操作简单高效。系统预置高频用语，支持一键复制翻译，大幅提升救援沟通效率。已有700多名缅甸用户使用该平台，成为救援中的重要桥梁。这是AI首次应用于地震救援，展现了技术在紧急情况下的实用价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T01:31:00Z
- **目录日期**: 2025-04-03
