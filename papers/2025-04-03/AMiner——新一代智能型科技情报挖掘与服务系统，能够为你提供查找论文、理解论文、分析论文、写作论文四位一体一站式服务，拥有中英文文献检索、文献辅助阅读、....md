...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译、写作等一站式服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持中英文文献检索、AI生成摘要、互动问答和文档翻译功能。用户可订阅个性化科研动态，追踪机构、学者及关键词的最新研究。平台还提供学者画像、学术会议和论文排行榜等工具，浏览器版可免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T18:05:41Z
- **目录日期**: 2025-04-03
