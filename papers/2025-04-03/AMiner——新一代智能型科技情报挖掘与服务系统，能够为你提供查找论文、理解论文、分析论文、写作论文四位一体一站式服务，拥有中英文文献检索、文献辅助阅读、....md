...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析及写作一站式服务。它支持中英文文献搜索，能自动生成摘要并回答用户提问，提升研究效率。平台还具备文献翻译、文档识别和辅助阅读功能，用户可上传PDF或从数据库获取论文，通过AI快速理解内容。此外，AMiner提供个性化科研情报订阅，按用户偏好推送最新学术动态。涵盖42个学科、3.5亿论文和0.6亿学者数据，支持免费使用，助力学术研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T12:06:03Z
- **目录日期**: 2025-04-03
