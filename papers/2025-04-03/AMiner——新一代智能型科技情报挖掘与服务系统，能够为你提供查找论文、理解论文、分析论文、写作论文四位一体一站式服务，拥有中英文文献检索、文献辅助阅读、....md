...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译和科研分析等一站式服务。它收录了3.5亿篇论文、0.6亿学者和1.5亿专利，支持中英文文献检索、AI生成摘要、互动问答和文档翻译功能。用户可订阅个性化科研动态，跟踪特定学者或关键词的最新研究。平台还提供学者画像、学术会议和论文排行榜等工具，帮助用户高效获取和分析学术信息。AMiner的浏览器版本可免费使用，旨在提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T07:06:21Z
- **目录日期**: 2025-04-03
