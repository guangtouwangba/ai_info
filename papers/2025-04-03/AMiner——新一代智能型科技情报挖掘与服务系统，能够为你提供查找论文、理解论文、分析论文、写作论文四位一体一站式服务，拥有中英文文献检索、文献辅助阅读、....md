...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译、科研订阅等一站式服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持中英文文献检索、AI生成摘要、互动问答等功能，帮助用户快速理解文献内容。平台还提供个性化科研动态订阅，通过微信或邮件推送最新学术资讯。此外，AMiner具备学者画像、学术会议追踪等特色功能，基础服务可免费使用。访问地址：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T10:05:59Z
- **目录日期**: 2025-04-03
