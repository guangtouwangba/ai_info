...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作一站式服务。它支持中英文文献搜索，能自动生成摘要并回答用户问题，提升研究效率。平台还具备文档翻译、辅助阅读功能，用户可上传PDF获取AI生成的章节概要和问题建议。此外，AMiner提供科研动态订阅服务，根据用户偏好推送最新论文和摘要。其数据库涵盖3.5亿论文、0.6亿学者和1.5亿专利，并免费开放基础功能。网址：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T03:18:04Z
- **目录日期**: 2025-04-03
