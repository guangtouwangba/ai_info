...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献搜索，拥有3.5亿论文、0.6亿学者等海量数据，并能通过AI生成摘要、翻译及互动问答。用户可上传PDF或从平台获取文献，利用AI辅助理解内容。此外，AMiner提供科研情报订阅功能，按用户偏好推送最新学术动态。平台还包含学者画像、学术会议等特色功能，基础服务免费开放。访问链接：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T21:05:27Z
- **目录日期**: 2025-04-03
