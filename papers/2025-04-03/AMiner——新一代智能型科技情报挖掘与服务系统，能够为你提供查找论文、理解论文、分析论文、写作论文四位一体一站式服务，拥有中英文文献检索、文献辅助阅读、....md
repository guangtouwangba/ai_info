...
AMiner是一个智能科技情报平台，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献搜索，拥有3.5亿论文、0.6亿学者等海量数据，并能通过AI生成摘要和问答互动辅助理解。平台还提供文献翻译、文档识别和科研动态订阅功能，用户可定制关注领域，通过微信或邮件接收最新研究。此外，AMiner包含学者画像、学术会议等特色功能，基础服务免费使用。访问入口：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T05:05:08Z
- **目录日期**: 2025-04-03
