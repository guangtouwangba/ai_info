...
AMiner是一个智能科技情报平台，提供论文检索、翻译、分析及科研订阅服务。它收录3.5亿论文和1.5亿专利，支持中英文搜索、AI辅助阅读（自动生成摘要、章节概要和问答互动）及文献翻译。用户可定制科研动态推送，跟踪学者或机构的最新成果。平台还包含学者画像、学术会议等特色功能，基础服务免费开放。网址：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T11:06:12Z
- **目录日期**: 2025-04-03
