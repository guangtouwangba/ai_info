...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、辅助阅读和科研情报订阅等一站式服务。其核心功能包括：1）高效检索3.5亿论文资源，支持智能问答和自动摘要生成；2）AI驱动的文献翻译与解析，可上传PDF获取章节概要和深度问答；3）个性化订阅服务，按用户设定的关键词推送最新科研动态。平台还包含学者画像、学术会议等特色功能，支持浏览器免费使用，旨在提升学术研究效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T06:05:48Z
- **目录日期**: 2025-04-03
