...
OpenAI近期动作频频：1）完成400亿美元创纪录融资；2）时隔6年重新开源模型权重，首推推理模型且不限制商用；3）ChatGPT用户1小时暴涨百万。三大举措将AI热度推向新高，被外界视为对DeepSeek等竞争对手的直接回应。此次开源标志着OpenAI战略调整，可能重塑行业竞争格局。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T15:02:49Z
- **目录日期**: 2025-04-03
