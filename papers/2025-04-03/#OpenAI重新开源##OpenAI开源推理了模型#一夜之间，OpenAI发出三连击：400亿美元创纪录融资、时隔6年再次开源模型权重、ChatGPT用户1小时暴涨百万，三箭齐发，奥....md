...
OpenAI近期动作频频：1)完成创纪录的400亿美元融资；2)时隔6年重新开源模型权重；3)ChatGPT用户1小时激增百万。其中开源项目特别引人注目，新发布的推理模型不仅完全开源，还不限制商业用途，被视为直接对标DeepSeek等开源AI项目。这一系列举措将AI领域热度推向新高，展现OpenAI在商业化与开源生态之间的战略平衡。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T21:02:45Z
- **目录日期**: 2025-04-03
