...
OpenAI近期动作频频：1)完成创纪录的400亿美元融资；2)时隔6年重新开源模型权重；3)ChatGPT用户1小时内暴增百万。该公司最新开源了推理模型，且不限制商业用途，这一举措被认为是对DeepSeek等竞争对手的直接回应。三管齐下的战略将AI领域热度推向新高，展现OpenAI在行业内的持续影响力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T22:02:41Z
- **目录日期**: 2025-04-03
