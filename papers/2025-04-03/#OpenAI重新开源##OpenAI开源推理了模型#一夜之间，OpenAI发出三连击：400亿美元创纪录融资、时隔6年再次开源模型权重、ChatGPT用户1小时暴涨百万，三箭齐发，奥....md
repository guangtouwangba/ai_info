...
OpenAI近期发布三大重磅消息：完成400亿美元创纪录融资、时隔6年再次开源模型权重（包括可商用的推理模型）、ChatGPT用户1小时激增百万。这一系列动作将AI领域热度推向新高，被视为对DeepSeek等竞争对手的直接回应。开源策略的调整（从闭源到重新开放）尤其引发行业关注，标志着其战略方向的重大转变。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T13:09:45Z
- **目录日期**: 2025-04-03
