...
OpenAI近期动作频频：1)完成400亿美元创纪录融资；2)时隔6年重新开源模型权重；3)ChatGPT用户1小时暴涨百万。其中新开源项目为推理模型，且不限制商用，被视为对标DeepSeek的竞争举措。这些举措将AI领域热度推向新高，展现OpenAI持续引领行业发展的战略布局。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T23:02:46Z
- **目录日期**: 2025-04-03
