...
OpenAI近期动作频频：1)完成创纪录的400亿美元融资；2)时隔6年重新开源模型权重；3)ChatGPT用户1小时暴增百万。其中开源项目特别引人注目，首推推理模型且不限制商用，被视为直接对标DeepSeek等开源AI平台。这一系列举措将AI领域热度推向新高，展现OpenAI在商业化与开源战略上的重大调整。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T16:02:51Z
- **目录日期**: 2025-04-03
