...
OpenAI近期发布三项重大动态：1) 完成创纪录的400亿美元融资；2) 时隔6年再次开源模型权重，新开源的推理模型允许商用；3) ChatGPT用户数1小时内暴涨百万。这些举措显著提升了AI领域的热度，被视为对DeepSeek等竞争对手的直接回应。OpenAI联合创始人奥特曼通过这一系列动作，进一步巩固了公司在人工智能行业的领先地位。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T12:03:02Z
- **目录日期**: 2025-04-03
