...
大型语言模型(LLMs)在物理研究中日益重要，但确保其输出的可靠性和可解释性仍是挑战。该研究提出由推理模块、解释模块和人机交互模块组成的协作框架，特别强调了解释模块的创新作用。该模块包含多个专业代理(如总结器、模型构建器等)，通过构建可解释的科学模型，将LLM输出结构化。案例研究表明，这种方法提高了透明度，便于验证，并增强了科学研究中AI辅助推理的能力。研究首次系统探讨了如何通过解释模块来改善AI生成结果的理解，弥补了现有文献的空白。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T23:01:42Z
- **目录日期**: 2025-04-03
