...
大语言模型(LLMs)在物理研究中通过增强推理、符号运算和数值计算发挥重要作用，但其输出的可靠性和可解释性仍是挑战。本研究提出一个包含推理模块、解释模块和人机交互模块的协作框架，特别创新性地引入了解释模块来提升AI输出的可理解性。该模块由摘要生成器、模型构建器、界面设计器和测试器等专业代理组成，能协作构建基于物理原理的可解释科学模型。案例研究表明，该方法提高了透明度，便于验证，并强化了AI辅助的科学推理能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-03T13:08:31Z
- **目录日期**: 2025-04-03
