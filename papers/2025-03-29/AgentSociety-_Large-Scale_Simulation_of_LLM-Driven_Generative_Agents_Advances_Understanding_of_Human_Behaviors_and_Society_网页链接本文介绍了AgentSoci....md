...
AgentSociety是一个基于大型语言模型（LLM）的大规模社会模拟器，通过模拟超过1万个代理及其500万次互动，研究人类行为和社会现象。该系统作为计算社会科学实验平台，分析了极化现象、刺激性信息传播、无条件基本收入政策及飓风等外部冲击的影响。其模拟结果与现实世界数据吻合，验证了该工具在揭示社会问题机制方面的有效性，并展示了其作为社会科学研究和政策制定辅助工具的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T11:04:46Z
- **目录日期**: 2025-03-29
