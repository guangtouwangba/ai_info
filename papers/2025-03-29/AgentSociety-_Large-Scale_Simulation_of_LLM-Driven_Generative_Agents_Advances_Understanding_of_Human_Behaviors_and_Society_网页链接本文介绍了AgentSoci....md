...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统模拟了超过1万个AI代理的社会互动（共500万次），用于研究社会现象如极化、信息传播、基本收入政策及自然灾害影响。研究结果表明，模拟结果与现实数据高度吻合，验证了该系统在揭示人类行为机制方面的有效性。AgentSociety为社会科学研究和政策制定提供了新的计算实验平台，能够辅助传统研究方法，帮助理解复杂社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T20:04:39Z
- **目录日期**: 2025-03-29
