...
这篇论文介绍了AgentSociety，一个利用大语言模型驱动的大规模社会模拟器，包含1万多个代理和500万次互动。研究者用它模拟了极化现象、信息传播、基本收入政策及飓风影响等社会问题，结果与现实数据吻合。该系统展示了作为社会科学研究工具和辅助政策制定的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T15:05:32Z
- **目录日期**: 2025-03-29
