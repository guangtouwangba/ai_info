...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟1万多个代理及其500万次互动。研究者用它研究了社会极化、信息传播、基本收入政策和外部冲击等社会问题，结果与现实世界实验一致，验证了其模拟人类行为和社会机制的能力。该工具为社会科学研究和政策制定提供了新方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T12:05:30Z
- **目录日期**: 2025-03-29
