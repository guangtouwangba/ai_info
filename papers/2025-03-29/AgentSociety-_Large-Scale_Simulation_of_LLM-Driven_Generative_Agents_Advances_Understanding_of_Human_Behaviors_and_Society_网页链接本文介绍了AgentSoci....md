...
本文介绍了AgentSociety，一种基于大语言模型的大规模社会模拟器，能够模拟超过1万个代理及其500万次互动。研究者利用该平台研究了社会极化、信息传播、基本收入政策和自然灾害影响等四个关键问题。模拟结果与现实世界数据高度吻合，验证了该系统对人类行为和社会机制的捕捉能力。该工具为社会科学研究和政策制定提供了新方法，有望成为传统研究手段的重要补充。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T19:04:46Z
- **目录日期**: 2025-03-29
