...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统，能够模拟1万多个AI代理的社会互动（共500万次）。该系统被用于研究四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。研究结果显示，模拟结果与现实世界数据高度吻合，证明该系统能有效捕捉人类行为机制。AgentSociety展现了作为社会科学研究工具和政策测试平台的潜力，可辅助传统研究方法（如调查和实验）来深入分析社会问题的成因和解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T16:05:04Z
- **目录日期**: 2025-03-29
