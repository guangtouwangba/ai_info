...
腾讯元宝AI助手最新升级，支持36种文件格式处理，涵盖办公文档（Word/Excel/PDF）和开发代码（.py/.java/.cpp等）。新增代码智能识别功能，可进行代码解读、逻辑审查、Bug检测及跨语言翻译（如Python转JavaScript），并提供优化建议。所有功能目前免费无限使用。自2月上线以来已迭代30余次，近期集成DeepSeek V3-0324模型并新增HTML实时预览功能，持续强化开发者工具属性。腾讯强调元宝采用混元+DeepSeek双模型驱动策略。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T06:03:59Z
- **目录日期**: 2025-03-29
