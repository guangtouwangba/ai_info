...
腾讯元宝AI助手最新升级，支持36种文件格式处理，包括办公文档(Word/Excel/PDF)和开发文件(.py/.java/.cpp等)。新增代码智能识别功能，可进行代码解读、逻辑审查、bug检测及优化建议，支持Python/Java/C++等语言互译与语法简化。该服务目前免费开放，自2月上线以来已迭代30余次，近期集成DeepSeek V3模型并新增HTML实时预览功能。腾讯表示将继续采用混元+DeepSeek双模型驱动策略，持续优化开发者工具生态。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T04:03:31Z
- **目录日期**: 2025-03-29
