...
腾讯元宝AI助手升级，支持36种文件格式解析，包括办公文档(Word/Excel/PDF)和开发文件(.py/.java/.cpp等)。新增代码智能识别功能，可进行代码解读、逻辑审查、Bug检测及优化建议，支持Python/C++/Java等语言互译与语法简化。该服务目前免费开放，自2月上线以来已迭代超30次，近期集成DeepSeek V3-0324模型并新增HTML实时预览功能。腾讯表示将持续采用混元+DeepSeek双模型驱动策略。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T10:03:58Z
- **目录日期**: 2025-03-29
