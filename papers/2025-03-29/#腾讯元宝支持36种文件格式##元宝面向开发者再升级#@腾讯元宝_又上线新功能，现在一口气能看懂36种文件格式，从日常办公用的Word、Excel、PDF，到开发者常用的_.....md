...
腾讯元宝AI助手最新升级，支持36种文件格式处理，包括办公文档(Word/Excel/PDF)和开发文件(.py/.java/.cpp等)。其新增代码智能功能可自动识别编程语言，提供代码解读、逻辑审查、bug检测及优化建议，并支持Python/JavaScript等跨语言转换。该平台采用混元与DeepSeek双模型驱动，自2月上线以来已迭代30余次，最新集成了DeepSeek V3-0324模型并新增HTML实时预览功能。所有功能目前免费开放，面向开发者持续优化AI辅助编程体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T03:12:51Z
- **目录日期**: 2025-03-29
