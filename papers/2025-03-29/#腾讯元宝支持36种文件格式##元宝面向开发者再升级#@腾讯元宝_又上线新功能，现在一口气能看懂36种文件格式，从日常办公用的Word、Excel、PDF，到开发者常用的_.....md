# #腾讯元宝支持36种文件格式##元宝面向开发者再升级#@腾讯元宝 又上线新功能，现在一口气能看懂36种文件格式，从日常办公用的Word、Excel、PDF，到开发者常用的 ....
...
腾讯元宝AI助手最新升级，现已支持36种文件格式处理，包括办公文档(Word/Excel/PDF)和开发文件(.py/.java/.cpp等)。新增代码智能识别功能，可自动识别Python/C++/Java等语言，提供代码解读、逻辑审查、bug检测及优化建议，支持跨语言翻译(如Python转JavaScript)和代码简化。该平台集成DeepSeek V3-0324模型，近期还上线了HTML实时预览功能。自2月上线以来已完成30余次更新，目前所有功能免费开放。腾讯表示将继续采用混元与DeepSeek双模型驱动策略。(98字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T01:30:25Z
- **目录日期**: 2025-03-29
