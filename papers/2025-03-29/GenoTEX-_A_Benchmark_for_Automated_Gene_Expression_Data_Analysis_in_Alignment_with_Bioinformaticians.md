...
GenoTEX是一个用于自动化基因表达数据分析的基准数据集，包含标准化流程（数据选择、预处理、统计分析）的注释代码和结果，遵循计算基因组学标准。该数据集由生物信息学家标注以确保准确性。研究团队还开发了GenoAgent——基于大语言模型（LLM）的多智能体系统，采用可自我修正的多步骤编程工作流协作分析基因数据。实验表明LLM方法在基因组数据分析中具有潜力，同时揭示了改进方向。GenoTEX为评估和提升基因表达分析自动化方法提供了资源，其基准数据可在GitHub获取。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T08:03:43Z
- **目录日期**: 2025-03-29
