...
近期机器学习在基因表达数据疾病相关基因识别方面取得显著进展，但传统方法依赖专家经验且难以扩展。为此，研究者开发了GenoTEX基准数据集，包含符合计算基因组学标准的全流程注释代码和专家验证结果，用于评估自动化分析方法。同时提出GenoAgent——基于大语言模型的多智能体系统，采用可自我修正的编程工作流协作分析基因数据。实验验证了大语言模型在基因组学分析中的潜力，也揭示了改进方向。该数据集（GitHub开源）为基因表达分析的自动化方法提供了基准测试资源，推动该领域发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T19:02:30Z
- **目录日期**: 2025-03-29
