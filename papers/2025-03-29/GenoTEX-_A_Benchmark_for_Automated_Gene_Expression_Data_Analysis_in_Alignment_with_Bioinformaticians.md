...
近期机器学习在基因表达数据识别疾病相关基因方面取得显著进展，但传统方法依赖专家经验且难以扩展。为此，研究者开发了GenoTEX基准数据集，包含符合计算基因组学标准的全流程标注数据（数据选择、预处理和统计分析），并引入基于大语言模型的多智能体系统GenoAgent作为基线方法。实验证明该方法具有自动化分析基因组数据的潜力，同时也揭示了改进空间。GenoTEX通过提供专家标注的标准化评估资源，有望推动基因表达分析自动化技术的发展。数据集已开源在GitHub平台。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T10:02:25Z
- **目录日期**: 2025-03-29
