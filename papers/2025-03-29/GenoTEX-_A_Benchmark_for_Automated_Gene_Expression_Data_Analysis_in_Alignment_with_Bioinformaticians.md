...
GenoTEX是一个用于自动化基因表达数据分析的基准数据集，包含注释代码和结果，覆盖基因识别流程（数据选择、预处理和统计分析）。该数据集遵循计算基因组学标准，并由生物信息学专家标注以确保准确性。研究团队还开发了GenoAgent——基于大语言模型（LLM）的多智能体系统，采用可自我修正的多步编程工作流协作分析基因数据。实验表明LLM方法在基因组数据分析中具有潜力，同时误差分析揭示了改进方向。GenoTEX为评估和提升自动化基因分析提供了资源，项目地址：https://github.com/Liu-Hy/GenoTex。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T06:02:27Z
- **目录日期**: 2025-03-29
