...
GenoTEX是一个用于自动化基因表达数据分析的基准数据集，包含注释代码和结果，覆盖数据集选择、预处理和统计分析等流程，遵循计算基因组学标准。该数据集由生物信息学专家标注，确保准确性和可靠性。研究者还提出了GenoAgent，一个基于大语言模型（LLM）的多智能体系统，采用多步编程和自校正流程协作分析基因表达数据。实验显示LLM方法在基因组数据分析中具有潜力，但也面临挑战。GenoTEX可作为评估和改进基因表达数据自动化分析方法的资源，相关数据已在GitHub开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T13:06:36Z
- **目录日期**: 2025-03-29
