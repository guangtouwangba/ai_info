...
近期机器学习在基因表达数据分析中取得进展，但传统方法依赖专家经验且难以扩展。为此，研究团队开发了GenoTEX基准数据集，包含标准化的基因识别流程（数据选择、预处理、统计分析）及专家标注结果。同时提出GenoAgent系统，采用具备自我修正能力的多智能体框架来自动化分析流程。实验表明大语言模型在该领域具有潜力，但也存在改进空间。该基准数据集为基因表达分析的自动化方法提供了评估标准，相关资源已开源。研究为基因组学与AI的结合提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T14:02:38Z
- **目录日期**: 2025-03-29
