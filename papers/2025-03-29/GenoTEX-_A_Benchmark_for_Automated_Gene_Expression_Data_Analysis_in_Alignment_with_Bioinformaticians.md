...
近期机器学习在基因表达数据识别疾病相关基因方面取得显著进展，但传统方法依赖专家经验且难以扩展。为此，研究者开发了GenoTEX基准数据集，包含符合计算基因组学标准的全流程标注数据（数据选择、预处理、统计分析），并配有生物信息学专家验证。同时提出基于大语言模型的多智能体系统GenoAgent，通过多步骤编程和自校正机制实现基因表达数据的自动化分析。实验验证了大语言模型在基因组数据分析中的潜力，也揭示了改进方向。该基准数据集（GitHub开源）为自动化基因表达分析提供了评估标准和开发资源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T07:02:20Z
- **目录日期**: 2025-03-29
