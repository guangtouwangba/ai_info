...
近期机器学习在基因表达数据疾病相关基因识别方面取得显著进展，但传统方法依赖专业知识和人工操作，可扩展性有限。为此，研究者开发了GenoTEX基准数据集，包含符合计算基因组学标准的完整分析流程（数据选择、预处理和统计分析）及专家标注结果，用于评估自动化分析方法。同时提出GenoAgent——采用多步骤编程工作流和自校正机制的LLM智能体系统，为基因表达数据分析提供基线方案。实验验证了LLM在基因组数据分析中的潜力，也揭示了改进方向。该数据集已开源，可作为自动化基因表达分析方法的评估与开发资源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T03:11:48Z
- **目录日期**: 2025-03-29
