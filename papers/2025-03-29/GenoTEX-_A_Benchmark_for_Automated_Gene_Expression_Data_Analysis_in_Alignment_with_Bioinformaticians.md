...
近期机器学习在基因表达数据疾病相关基因识别方面取得显著进展，但传统方法依赖专家经验且难以扩展。为此，研究者开发了GenoTEX基准数据集，包含符合计算基因组学标准的完整分析流程（数据选择、预处理、统计分析）及专家标注结果。同时提出GenoAgent多智能体系统，采用自校正编程工作流实现基因表达数据的协同分析。实验验证了大语言模型在基因组数据分析中的潜力，也揭示了改进方向。该资源（https://github.com/Liu-Hy/GenoTex）为自动化基因表达分析方法提供了标准化评估基准，推动该领域发展。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T23:02:30Z
- **目录日期**: 2025-03-29
