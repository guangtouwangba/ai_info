...
近期机器学习在基因表达数据疾病相关基因识别方面取得显著进展，但该过程通常需要大量专业知识和人工操作。为此，研究者开发了GenoTEX基准数据集，包含符合计算基因组学标准的完整分析流程（数据选择、预处理和统计分析）及专家标注结果。同时提出基于大语言模型(LLM)的多智能体系统GenoAgent，采用可自我修正的多步编程工作流进行协作分析。实验验证了LLM在基因组数据分析中的潜力，也揭示了改进方向。该基准数据集（GitHub开源）为自动化基因表达分析方法的评估与发展提供了重要资源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T04:02:28Z
- **目录日期**: 2025-03-29
