# #GPT4o更新##新版GPT4o超越Grok3#OpenAI发布了全新版本的GPT-4o，一经上线便迅速登上LMArena大模型竞技场第二位，超越GPT-4.5和Grok-3，仅次于排名第一的Gemini ...
...
OpenAI发布新一代GPT-4o模型，性能大幅提升且价格显著降低。该模型在LMArena大模型竞技场排名第二，超越GPT-4.5和Grok-3。其数学能力跃升至第2，复杂提问和编码能力均位列第一。GPT-4o在逻辑理解、多轮指令处理等方面全面升级，表现更稳定自然。API价格仅为GPT-4.5的十分之一，实现性能与成本的双重突破。用户反馈其回答更简洁智能，协作场景表现更优。目前已上线ChatGPT平台及API，提供高性价比服务。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T03:13:00Z
- **目录日期**: 2025-03-29
