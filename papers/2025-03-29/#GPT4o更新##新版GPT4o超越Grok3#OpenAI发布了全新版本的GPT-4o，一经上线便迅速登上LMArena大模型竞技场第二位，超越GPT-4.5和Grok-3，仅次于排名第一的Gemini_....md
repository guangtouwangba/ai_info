...
OpenAI发布新一代GPT-4o模型，在LMArena大模型竞技场排名第二，超越GPT-4.5和Grok-3。该模型在数学、复杂提问和编码能力上显著提升，综合性能接近GPT-4.5但API价格仅为其十分之一。GPT-4o在代码生成、逻辑理解和多轮对话等方面全面升级，回答更简洁自然。用户反馈其更聪明、有创意，协作表现更佳。目前已上线ChatGPT平台及API，实现性能与成本的双重优化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T00:03:38Z
- **目录日期**: 2025-03-29
