...
OpenAI发布新一代GPT-4o模型，在LMArena大模型竞技场排名第二，超越GPT-4.5和Grok-3。其数学能力跃升至第2，复杂提问和编码能力均位列第一，综合性能接近GPT-4.5但API价格仅为十分之一。该模型在代码生成、逻辑理解和多轮对话等方面全面升级，回答更简洁自然。目前已上线ChatGPT平台及API，实现性能与成本的双重突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T05:03:46Z
- **目录日期**: 2025-03-29
