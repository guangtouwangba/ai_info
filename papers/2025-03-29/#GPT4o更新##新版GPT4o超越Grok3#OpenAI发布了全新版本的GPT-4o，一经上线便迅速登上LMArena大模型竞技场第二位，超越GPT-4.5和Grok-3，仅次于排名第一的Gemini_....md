...
OpenAI发布新一代GPT-4o模型，在LMArena大模型竞技场排名第二，超越GPT-4.5和Grok-3。其数学能力跃升至第2，复杂提问和编码能力均达榜首，综合表现全能。性能接近GPT-4.5但API价格仅为其1/10，实现"更强更省"。升级包括代码生成、逻辑理解和意图识别等，回答更简洁自然。目前已上线ChatGPT平台，提供更高性价比服务。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T04:03:38Z
- **目录日期**: 2025-03-29
