...
OpenAI发布新一代GPT-4o模型，在LMArena大模型竞技场跃居第二，超越GPT-4.5和Grok-3。该模型在数学能力（第2）、复杂提问（第1）和编码能力（第1）等关键指标实现显著提升，综合性能接近GPT-4.5但API价格仅为十分之一。升级后的GPT-4o在代码生成、逻辑理解和多轮对话等场景表现更稳定自然，用户反馈其回答更简洁智能。目前模型已上线ChatGPT平台，以"高性能+低成本"优势引发关注。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T07:03:59Z
- **目录日期**: 2025-03-29
