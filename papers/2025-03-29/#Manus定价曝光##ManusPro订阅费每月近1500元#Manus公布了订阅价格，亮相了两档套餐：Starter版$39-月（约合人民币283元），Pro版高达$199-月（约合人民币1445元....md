...
Manus公布了两档AI订阅套餐：Starter版39美元/月（约283元），支持2个任务；Pro版199美元/月（约1445元），支持5个任务并提供高级功能。Pro版包含更长上下文支持、高投入模式和测试功能，并享有更高稳定性。定位为"通用AI助手"，Manus旨在提供多样化智能服务，相当于雇佣AI实习生。目前处于测试阶段，已与阿里Qwen团队合作。其高价策略在国内AI市场竞争中寻求差异化发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T15:04:23Z
- **目录日期**: 2025-03-29
