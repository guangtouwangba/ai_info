...
Manus公布了两档AI订阅套餐价格：Starter版39美元/月（约283元），Pro版199美元/月（约1445元）。Starter版每月3900积分，支持2个并发任务；Pro版19900积分，支持5个任务，提供更长上下文、高投入模式和测试功能，并享有更高稳定性与优先资源。定位"通用AI助手"，旨在提供智能体服务，相当于AI实习生。目前处于测试阶段，已与阿里Qwen团队合作。其高价策略在国内AI市场竞争中寻求差异化发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T00:02:54Z
- **目录日期**: 2025-03-29
