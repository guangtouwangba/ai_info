...
Manus公布了两档AI订阅套餐：Starter版39美元/月（约283元），支持2个任务；Pro版199美元/月（约1445元），支持5个任务并提供更优性能。Pro版包含高投入模式、测试功能及优先资源使用权，定位为"通用AI助手"。目前仍处测试阶段，已与阿里Qwen团队合作。其高价策略在国内AI市场竞争中寻求差异化发展，相当于提供AI实习生服务。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T23:03:51Z
- **目录日期**: 2025-03-29
