...
Manus公布了两档订阅套餐：Starter版39美元/月（约283元），支持2个任务；Pro版199美元/月（约1445元），支持5个任务并提供更长上下文、高投入模式等高级功能。Pro版用户还享有更高稳定性和优先资源使用权。定位为"通用AI助手"，Manus旨在提供智能体服务，价格显著高于ChatGPT Plus。目前处于测试阶段，已与阿里Qwen团队合作。随着国内AI竞争加剧，Manus试图走差异化路线。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T06:03:17Z
- **目录日期**: 2025-03-29
