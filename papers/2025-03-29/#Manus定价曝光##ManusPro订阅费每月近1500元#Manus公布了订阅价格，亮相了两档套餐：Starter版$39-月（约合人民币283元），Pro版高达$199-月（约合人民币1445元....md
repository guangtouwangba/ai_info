...
Manus公布了两档AI订阅套餐价格：Starter版39美元/月（约283元），提供3900积分和2个并行任务；Pro版199美元/月（约1445元），提供19900积分、5个并行任务、长上下文支持及优先资源使用权。定位"通用AI助手"的Manus价格显著高于ChatGPT Plus，主打智能体服务功能。目前处于测试阶段，已与阿里Qwen团队合作，试图在国内AI市场走差异化路线。Pro版月费接近1500元人民币引发关注。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T05:03:01Z
- **目录日期**: 2025-03-29
