...
Manus公布了两档AI订阅套餐价格：Starter版39美元/月（约283元），支持2个任务；Pro版199美元/月（约1445元），支持5个任务并提供高级功能。Pro版包含更长上下文支持、高投入模式和优先资源使用权，定位为"通用AI助手"。目前仍处测试阶段，已与阿里Qwen团队合作。相比ChatGPT Plus的20美元/月，Manus定价显著更高，试图通过差异化服务在竞争激烈的AI市场中突围。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T20:03:40Z
- **目录日期**: 2025-03-29
