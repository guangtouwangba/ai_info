...
香港大学、英伟达与德国图宾根大学联合团队提出Centaur方法，解决自动驾驶在变道、加塞等场景中过度保守的问题。传统自动驾驶依赖预设规则，导致无故急刹或避让，反而增加风险。Centaur通过实时数据驱动的测试时计算（test-time training），动态优化驾驶策略，使AI能边行驶边学习，提升在不确定场景下的适应性和安全性。该方法突破了固定规则限制，让自动驾驶更像人类"安全驾驶思维"，减少机械反应带来的隐患。相关成果标志着自动驾驶首次实现实时学习优化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T21:02:33Z
- **目录日期**: 2025-03-29
