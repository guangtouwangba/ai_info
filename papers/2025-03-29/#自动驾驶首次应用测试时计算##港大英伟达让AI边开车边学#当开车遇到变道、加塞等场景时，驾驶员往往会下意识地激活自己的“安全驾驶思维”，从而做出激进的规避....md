...
香港大学、英伟达与图宾根大学联合团队提出Centaur方法，通过测试时计算技术让自动驾驶系统实现"边开边学"。该方法利用集群熵和不确定性评估，动态优化驾驶策略，解决了传统自动驾驶在变道、加塞等场景中因依赖预设规则导致的过度保守问题（如无故急刹）。通过在线数据驱动学习，系统能像人类驾驶员一样灵活应对不确定性，显著提升了自动驾驶的适应性和安全性。这项突破使AI驾驶行为更接近人类"安全驾驶思维"，而非刻板遵循固定规则。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T15:03:13Z
- **目录日期**: 2025-03-29
