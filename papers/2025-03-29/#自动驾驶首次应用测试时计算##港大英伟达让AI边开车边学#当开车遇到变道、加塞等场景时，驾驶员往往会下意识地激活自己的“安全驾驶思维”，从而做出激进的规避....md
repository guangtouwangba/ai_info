...
香港大学、英伟达与图宾根大学联合团队提出Centaur方法，通过测试时计算技术让自动驾驶系统实现"边开边学"。该方法利用集群熵和不确定性评估，动态优化驾驶策略，突破传统基于预设规则的局限性。在变道、加塞等复杂场景中，系统能像人类驾驶员一样灵活调整策略，避免过度保守导致的急刹或避让行为，显著提升自动驾驶在不确定环境中的适应性和安全性。这项技术首次实现了自动驾驶系统在真实测试中的在线学习能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T14:03:02Z
- **目录日期**: 2025-03-29
