...
香港大学、英伟达和图宾根大学联合团队提出Centaur方法，通过测试时计算（test-time training）让自动驾驶AI在行驶过程中动态优化驾驶策略。该方法利用不确定性评估和集群熵，使AI能像人类驾驶员一样在变道、加塞等复杂场景中实时学习调整，减少过度保守行为（如无故急刹），同时提升安全性。这项突破性技术摆脱了对预设规则的依赖，显著提高了自动驾驶系统在不确定环境中的适应能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T17:02:51Z
- **目录日期**: 2025-03-29
