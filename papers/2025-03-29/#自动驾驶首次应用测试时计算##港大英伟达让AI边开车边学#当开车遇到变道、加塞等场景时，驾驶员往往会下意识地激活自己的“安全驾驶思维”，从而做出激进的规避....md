...
香港大学、英伟达与图宾根大学联合团队提出Centaur方法，通过在线数据驱动优化自动驾驶决策。该方法突破传统依赖预设规则的局限，使AI能在实际驾驶中动态学习，显著提升在变道、加塞等不确定性场景中的适应能力。相比保守的固定策略可能引发的无故急刹问题，新技术让自动驾驶像人类驾驶员一样灵活调整驾驶风格，兼顾安全性与流畅性。这项测试时计算技术标志着自动驾驶系统首次实现"边开边学"的突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T19:02:51Z
- **目录日期**: 2025-03-29
