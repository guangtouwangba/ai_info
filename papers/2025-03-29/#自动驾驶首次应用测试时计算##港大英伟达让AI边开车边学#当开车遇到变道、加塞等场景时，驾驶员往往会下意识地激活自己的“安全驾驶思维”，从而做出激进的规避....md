...
香港大学、英伟达与图宾根大学联合团队提出Centaur方法，通过测试时计算技术让自动驾驶系统实现"边开边学"。该方法利用不确定性评估和在线数据驱动，动态优化驾驶策略，解决了传统自动驾驶在变道、加塞等场景中因依赖预设规则而表现过于保守的问题。Centaur能显著提升系统在不确定环境中的适应性和安全性，减少无故急刹和过度避让行为，使自动驾驶车辆的表现更接近人类驾驶员的安全驾驶思维。这项技术标志着自动驾驶首次实现了测试时自主优化能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T22:02:44Z
- **目录日期**: 2025-03-29
