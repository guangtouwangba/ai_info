...
香港大学、英伟达与图宾根大学联合团队提出Centaur方法，通过测试时计算（test-time training）技术让自动驾驶系统在行驶过程中动态优化决策。该方法利用不确定性评估和集群熵，使AI能实时学习并适应变道、加塞等复杂场景，摆脱传统预设规则的局限。相比保守的固定策略可能引发的无故急刹问题，Centaur通过在线数据驱动提升了系统在不确定环境中的适应性和安全性，实现更接近人类"安全驾驶思维"的灵活反应。这项突破标志着自动驾驶首次实现"边开边学"的实时优化能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T13:07:06Z
- **目录日期**: 2025-03-29
