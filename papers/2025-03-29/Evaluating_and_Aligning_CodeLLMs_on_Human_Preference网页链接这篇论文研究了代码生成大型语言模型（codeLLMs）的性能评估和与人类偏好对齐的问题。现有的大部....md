...
这篇论文探讨了代码生成大模型(codeLLMs)与人类偏好对齐的问题。研究者创建了CodeArena基准测试(含397个样本，覆盖40类44种语言)和SynCode-Instruct语料库(近200亿标记)，发现现有基准过于侧重代码正确性而忽略人类偏好。实验显示执行基准与CodeArena存在性能差异，开源顶级模型(如Qwen2.5-Coder)与专有模型(如OpenAI o1)差距显著，凸显对齐人类偏好的重要性。研究为评估和改进代码LLMs提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T04:05:23Z
- **目录日期**: 2025-03-29
