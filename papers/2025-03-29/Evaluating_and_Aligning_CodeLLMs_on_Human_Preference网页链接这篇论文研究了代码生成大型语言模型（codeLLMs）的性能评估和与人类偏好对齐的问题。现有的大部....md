...
这篇论文提出了CodeArena基准测试，用于评估代码生成大型语言模型(codeLLMs)与人类偏好的对齐程度。研究指出现有基准过于关注代码正确性而忽视人类偏好，因此构建了包含397个高质量样本、覆盖40类任务和44种编程语言的测试集。同时开发了20B标记的合成指令数据集SynCode-Instruct验证微调效果。实验发现执行基准与人类偏好测试存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，凸显了人类偏好对齐的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T06:05:43Z
- **目录日期**: 2025-03-29
