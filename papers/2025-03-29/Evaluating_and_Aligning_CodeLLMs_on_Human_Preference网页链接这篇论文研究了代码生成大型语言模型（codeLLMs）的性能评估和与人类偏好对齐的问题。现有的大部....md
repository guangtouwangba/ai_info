...
该论文研究了代码生成大语言模型(codeLLMs)与人类偏好的对齐问题。作者创建了CodeArena基准测试(包含397个样本，覆盖40类44种语言)来评估模型在真实编程任务中的表现，并构建了20B标记量的SynCode-Instruct合成指令集。研究发现现有基于执行的评估与人类偏好存在差距，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著。研究强调了代码LLMs不仅需要生成正确代码，还需符合人类编程偏好，这对提升开发者体验至关重要。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T15:06:12Z
- **目录日期**: 2025-03-29
