...
当前视频生成技术已能产生视觉逼真且时序连贯的视频，但现有评估标准（如VBench）主要关注表层真实性（如帧美学、时序一致性），而忽略了内在真实性（如物理规律、常识推理）。为此，研究团队推出VBench-2.0基准，通过自动评估模型在人类逼真度、可控性、创造性、物理合理性和常识性五个维度的表现，推动视频生成向内在真实性发展。该框架结合通用视觉语言模型和专用异常检测方法，并通过人工标注验证，旨在为下一代视频生成模型建立更全面的评估标准，助力AI电影制作和虚拟世界建模等应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T01:28:14Z
- **目录日期**: 2025-03-29
