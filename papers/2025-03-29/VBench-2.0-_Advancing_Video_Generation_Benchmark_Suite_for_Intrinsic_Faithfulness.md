...
视频生成技术已从早期不真实的输出发展到能生成视觉逼真、时序连贯的视频。现有评测基准（如VBench）主要评估表面真实性，包括单帧美学、时序一致性和基础提示遵循度，但忽略了内在真实性（如物理规律、常识推理等）。为此，研究者提出VBench-2.0，新一代评测基准，自动评估视频生成模型的内在真实性，涵盖人类逼真度、可控性、创造性、物理合理性和常识性五个维度，结合通用视觉语言模型和专用异常检测方法，并通过人工标注确保与人类判断一致，旨在为追求内在真实性的下一代视频生成模型设立新标准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T06:01:12Z
- **目录日期**: 2025-03-29
