...
视频生成技术已从早期不真实输出发展到能生成视觉逼真且时序连贯的视频。现有评估基准（如VBench）主要关注表层真实性（如帧美学、时序一致性），但忽略了是否符合现实世界原理。新一代模型虽在表层指标上表现良好，但在物理规律、常识推理等内在真实性上仍有不足。为此，研究者推出VBench-2.0基准，从人类逼真度、可控性、创造性、物理合理性和常识性五个维度评估视频生成模型的内在真实性。该框架结合通用视觉语言模型和专业异常检测方法，通过人工标注确保评估与人类判断一致，旨在为下一代视频生成模型设定新标准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T19:01:20Z
- **目录日期**: 2025-03-29
