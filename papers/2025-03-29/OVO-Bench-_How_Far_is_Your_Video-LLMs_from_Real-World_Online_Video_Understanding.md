...
该论文提出了OVO-Bench，一个专注于评估视频大语言模型（Video-LLMs）时间感知能力的新基准。时间感知是指模型能根据问题提出的时间戳动态推理的能力，这是在线与离线视频模型的关键区别。OVO-Bench包含12项任务、644个视频和约2800条人工标注，测试模型在三种场景下的表现：回溯过去事件、实时理解和延迟响应未来信息。评估显示，现有模型在在线视频理解上仍显著落后于人类。该基准旨在推动视频LLMs的发展，促进在线视频推理研究。数据和代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T18:01:55Z
- **目录日期**: 2025-03-29
