...
OVO-Bench是一个新型在线视频基准测试，旨在评估视频大语言模型(LLMs)的时间感知能力——即根据提问时间戳动态推理的能力。该基准包含12项任务、644个视频和2800条带精确时间戳的人工标注，测试模型在三种场景下的表现：回溯过去事件、实时理解当前事件以及延迟响应以获取未来信息。研究发现，尽管现有视频LLMs在传统基准上有进步，但在在线视频理解方面仍显著落后于人类。该基准旨在推动视频LLMs的发展，促进在线视频推理研究。数据和代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T06:02:09Z
- **目录日期**: 2025-03-29
