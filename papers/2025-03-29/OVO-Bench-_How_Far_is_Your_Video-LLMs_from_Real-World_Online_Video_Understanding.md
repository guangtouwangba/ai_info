...
OVO-Bench是一个新型在线视频基准测试，旨在评估视频大语言模型(LLMs)的时间感知能力——即根据提问时间戳动态推理的能力。该基准包含12项任务、644个视频和约2800条带精确时间戳的人工标注数据，测试模型在三种场景下的表现：(1)回溯过去事件；(2)实时理解当前事件；(3)延迟响应以获取未来信息。评估显示，尽管现有模型在传统基准上有进步，但在在线视频理解方面仍显著落后于人类。该研究希望推动视频LLMs的发展，促进在线视频推理的研究。基准数据和代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T02:27:52Z
- **目录日期**: 2025-03-29
