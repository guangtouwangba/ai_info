...
OVO-Bench是一个新型视频基准测试，专注于评估视频大语言模型(LLM)的"时间感知"能力——即根据问题提出时间动态推理的能力。该基准测试包含12项任务、644个视频和2800条带精确时间戳的人工标注，评估模型在三种场景下的表现：(1)回溯过去事件；(2)实时理解当前事件；(3)延迟响应以获取未来信息。研究测试了9个视频LLM，发现尽管在传统基准上有进步，现有模型在在线视频理解方面仍远逊于人类。该基准旨在推动视频LLM发展，促进在线视频推理研究。项目代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T09:02:10Z
- **目录日期**: 2025-03-29
