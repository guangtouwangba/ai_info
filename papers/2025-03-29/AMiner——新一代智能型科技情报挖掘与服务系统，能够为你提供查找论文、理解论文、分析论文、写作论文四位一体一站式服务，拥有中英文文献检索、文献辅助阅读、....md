...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析和写作一站式服务。它支持中英文文献搜索，拥有3.5亿论文和1.5亿专利数据，并能自动生成摘要和问答互动。用户可上传PDF或从库中选取文献，AI会快速解析内容并提供章节概要和问题建议。平台还支持科研动态订阅，按用户偏好推送最新论文摘要。此外，AMiner提供学者画像、学术会议和论文排行榜等功能，基础服务免费使用。网址：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T05:05:05Z
- **目录日期**: 2025-03-29
