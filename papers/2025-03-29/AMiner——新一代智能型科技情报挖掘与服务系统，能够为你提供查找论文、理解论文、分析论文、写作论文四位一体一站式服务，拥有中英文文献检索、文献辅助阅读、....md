...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译、科研订阅等一站式服务。它整合了3.5亿论文、0.6亿学者等海量数据，支持中英文文献检索、AI生成摘要、互动问答等功能，帮助用户高效筛选和理解文献。平台还提供科研动态订阅服务，可根据用户偏好推送最新学术资讯。此外，AMiner具备学者画像、会议追踪等特色功能，基础服务免费开放。访问地址：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T17:05:19Z
- **目录日期**: 2025-03-29
