...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析及写作一站式服务。它支持中英文文献搜索，能自动生成摘要并回答用户提问，提升研究效率。平台还具备文档识别、辅助阅读功能，用户可上传PDF或从库中选取论文，获取章节概要和问题建议。此外，AMiner提供科研动态订阅服务，按用户偏好推送最新学术资讯。涵盖42个学科的3.5亿论文、0.6亿学者等数据，支持免费使用。网址：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T09:05:32Z
- **目录日期**: 2025-03-29
