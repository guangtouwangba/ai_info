...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译及科研情报订阅等一站式服务。其核心功能包括：1）中英文文献检索，支持互动问答和自动摘要生成；2）英文文献翻译与AI辅助阅读，可上传PDF或从平台获取论文，生成摘要和章节概要；3）个性化科研动态订阅，通过微信或邮件推送最新学术资讯。平台覆盖42个学科，包含3.5亿论文、0.6亿学者等数据，并提供学者画像、学术会议等附加功能。用户可免费使用基础检索服务。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T11:05:13Z
- **目录日期**: 2025-03-29
