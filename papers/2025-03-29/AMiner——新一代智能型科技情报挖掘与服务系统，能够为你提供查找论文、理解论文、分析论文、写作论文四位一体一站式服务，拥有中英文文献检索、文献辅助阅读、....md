...
AMiner是一个智能科技情报挖掘系统，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献检索，能自动生成摘要和回答问题，帮助用户快速理解论文。平台还提供英文文献翻译、文档识别和互动问答功能。用户可订阅科研情报，获取最新学术动态。AMiner拥有3.5亿论文、0.6亿学者等海量数据，并免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T22:05:07Z
- **目录日期**: 2025-03-29
