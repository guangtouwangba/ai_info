...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译和分析等一站式服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持中英文文献检索、AI生成摘要和互动问答，帮助用户快速理解论文内容。此外，AMiner还提供科研动态订阅、学者画像、学术会议追踪等功能，用户可通过微信或邮件获取定制化资讯。平台支持上传PDF文档并自动生成章节概要，提升研究效率。AMiner浏览器版可免费使用，旨在优化学术信息获取体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T03:14:36Z
- **目录日期**: 2025-03-29
