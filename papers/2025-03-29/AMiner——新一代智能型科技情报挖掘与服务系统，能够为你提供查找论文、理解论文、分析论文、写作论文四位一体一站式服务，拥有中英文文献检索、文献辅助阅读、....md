...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析和写作的一站式服务。平台支持中英文文献搜索、AI辅助阅读、自动摘要生成及翻译功能，涵盖3.5亿论文和1.5亿专利数据。其特色包括互动问答理解文献、科研动态订阅推送（通过微信/邮件），以及学者画像等工具。用户可上传PDF或使用内置数据库，快速获取摘要、章节概要和内容答疑。基础功能免费开放，网址：https://www.aminer.cn/ 。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T00:05:13Z
- **目录日期**: 2025-03-29
