...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、翻译、辅助阅读和分析。它收录了3.5亿论文、0.6亿学者等海量数据，支持互动问答和自动摘要生成，提升研究效率。用户可上传PDF或从库中选取文献，获取AI生成的摘要和章节概要，并通过对话深入理解内容。平台还提供科研动态订阅服务，按用户偏好推送最新论文摘要。此外，AMiner具备学者画像、学术会议等功能，浏览器检索免费使用。访问官网或AI页面即可体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T20:05:05Z
- **目录日期**: 2025-03-29
