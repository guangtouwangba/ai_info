...
本文提出了一种基于多智能体协作的解码方法Collab，用于提升大语言模型（LLM）在推理时的对齐性能。传统强化学习人类反馈（RLHF）方法计算成本高，而单智能体解码策略难以适应多样化任务。Collab通过动态选择最优LLM策略进行令牌级决策，利用长期效用指标从模型池中选择最适合当前任务的模型。理论分析证明了该方法在目标奖励下的最优性，实验表明其性能显著优于单智能体基线，平均奖励提升1.56倍，GPT-4胜率提升71.89%，成为当前最先进的解码策略。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T15:01:44Z
- **目录日期**: 2025-03-29
