...
本文提出了一种名为MemInsight的自主记忆增强方法，旨在提升大语言模型（LLM）代理的语义数据表示和检索能力。通过自主增强历史交互数据，该方法使LLM代理能生成更准确且符合上下文的响应。实验在对话推荐、问答和事件摘要三个任务场景中验证了其有效性。在LLM-REDIAL数据集上，MemInsight将推荐说服力提升达14%，并在LoCoMo检索任务中以34%的召回率优势超越RAG基线。结果表明，MemInsight能显著增强LLM代理在多任务中的上下文表现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T15:01:11Z
- **目录日期**: 2025-03-29
