...
GPT-4o生成的吉卜力风格图像引发版权争议。律师指出，单纯模仿风格不违法，但若训练数据使用了未经授权的吉卜力影片素材则构成侵权。目前争议焦点在于AI训练数据的来源和授权情况，类似案件正成为多起诉讼的核心（如《纽约时报》诉OpenAI）。OpenAI回应称不会模仿在世艺术家个人风格，但工作室风格可复制，而吉卜力创始人宫崎骏的风格界定模糊。随着谷歌等公司推出类似功能，AI绘图技术发展迅速，但相关版权法规尚未完善，商业应用可能加剧法律风险。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T03:13:09Z
- **目录日期**: 2025-03-29
