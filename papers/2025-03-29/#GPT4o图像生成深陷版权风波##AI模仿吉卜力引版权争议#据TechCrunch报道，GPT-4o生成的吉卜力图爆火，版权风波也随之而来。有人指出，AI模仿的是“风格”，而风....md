...
GPT-4o生成吉卜力风格图像引发版权争议。律师指出，AI模仿画风本身不违法，但若训练数据未经授权使用吉卜力作品则构成侵权。OpenAI回应称不会模仿在世艺术家个人风格，但允许复制"工作室风格"，而宫崎骏个人与工作室风格界限模糊。用户将生成图像用于商业用途更增加法律风险。目前版权法规尚未跟上AI技术发展速度，类似诉讼频发（如《纽约时报》诉OpenAI）。谷歌等公司也推出类似功能，凸显技术发展与法律监管间的脱节。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T02:29:34Z
- **目录日期**: 2025-03-29
