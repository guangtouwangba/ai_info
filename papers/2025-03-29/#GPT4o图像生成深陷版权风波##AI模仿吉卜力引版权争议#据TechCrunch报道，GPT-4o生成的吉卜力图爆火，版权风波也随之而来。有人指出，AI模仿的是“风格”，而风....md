...
GPT-4o生成的吉卜力风格图像引发版权争议。专家指出，单纯模仿风格不违法，但若训练数据使用了未经授权的吉卜力素材则构成侵权。目前争议焦点在于AI模型的训练数据来源是否合法，这也是近期多起AI诉讼案的核心问题。OpenAI回应称不会模仿在世艺术家个人风格，但工作室风格可以复制，而吉卜力创始人宫崎骏的风格与工作室高度重合，界限模糊。随着谷歌、xAI等公司推出类似功能，AI模仿画风技术快速发展，但相关版权法规尚未完善，导致法律风险加剧。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T00:03:46Z
- **目录日期**: 2025-03-29
