...
GPT-4o生成的吉卜力风格图像引发版权争议。律师指出，AI模仿风格本身不违法，但若训练数据未经授权使用吉卜力作品则构成侵权。目前争议焦点在于训练素材是否合法获取，类似纠纷已出现在OpenAI和Midjourney的诉讼中。OpenAI回应称不模仿在世艺术家个人风格，但工作室风格可复制，而宫崎骏与吉卜力风格的界限模糊。随着谷歌等公司推出类似功能，AI绘图技术发展迅速，但版权法规尚未完善，商业使用可能加剧法律风险。技术跑在规则前面，AI绘图正面临版权迷雾。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-29T01:30:43Z
- **目录日期**: 2025-03-29
