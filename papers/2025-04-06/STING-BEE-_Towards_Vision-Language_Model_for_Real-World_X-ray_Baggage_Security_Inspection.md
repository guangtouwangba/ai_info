...
研究人员开发了首个多模态X光行李安检数据集STCray，包含46,642张图像-文本配对的扫描图，涵盖21种威胁类别。该数据集采用专业协议生成，确保领域相关的连贯描述，用于训练视觉AI助手STING-BEE。STING-BEE支持多种视觉语言任务，包括场景理解、威胁定位和视觉问答，在跨域场景中表现出色。这一成果为X光行李安检的多模态学习设立了新基准。相关代码、数据和模型已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T08:00:57Z
- **目录日期**: 2025-04-06
