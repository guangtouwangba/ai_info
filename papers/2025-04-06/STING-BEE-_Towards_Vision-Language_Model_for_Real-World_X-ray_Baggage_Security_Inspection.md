...
该研究介绍了首个多模态X射线行李安检数据集STCray，包含46,642张图像-文本配对的扫描图像，覆盖21种威胁类别。通过专业协议生成领域感知的连贯描述，构建了多模态指令跟随数据。基于此，研究者训练了领域感知视觉AI助手STING-BEE，支持场景理解、威胁定位、视觉定位和视觉问答等任务，为X射线行李安检的多模态学习设立了新基准。STING-BEE在跨域设置中展现出最先进的泛化能力。相关代码、数据和模型已开源。该工作解决了现有数据集在真实威胁和隐藏策略表征不足的问题，突破了封闭集范式的限制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T14:01:04Z
- **目录日期**: 2025-04-06
