...
为提高X射线行李安检中的威胁检测能力，研究者开发了首个多模态X射线安检数据集STCray，包含46,642张图像-文本配对的扫描图像，覆盖21种威胁类别。该数据集采用专业协议生成，确保领域感知的连贯描述。基于此训练出的视觉AI助手STING-BEE，支持场景理解、威胁定位、视觉问答等多模态任务，在跨域泛化中表现优异。该研究为X射线安检领域的多模态学习设立了新基准。相关代码、数据和模型已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T04:01:13Z
- **目录日期**: 2025-04-06
