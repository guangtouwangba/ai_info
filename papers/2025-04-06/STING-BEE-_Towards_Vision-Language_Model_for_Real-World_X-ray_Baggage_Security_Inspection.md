...
该研究提出了首个多模态X光行李安检数据集STCray，包含46,642张图像-文本配对扫描图，涵盖21类威胁物品，采用专业协议生成领域感知的描述文本。基于此，团队开发了视觉AI助手STING-BEE，支持场景理解、威胁定位、视觉问答等多模态任务，在X光安检领域建立了新基准。相比现有封闭式系统，该方案展现出优异的跨领域泛化能力。数据集和模型代码已开源，为改进安检威胁检测提供了重要资源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T11:00:56Z
- **目录日期**: 2025-04-06
