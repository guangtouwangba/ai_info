...
研究人员开发了首个多模态X射线行李安检数据集STCray，包含46,642张图像-文本配对扫描图，涵盖21种威胁类别。该数据集采用专业协议生成，确保领域感知和连贯描述，为X射线安检提供多模态指令数据。基于此，团队训练出领域感知视觉AI助手STING-BEE，支持场景理解、威胁定位、视觉问答等视觉-语言任务，在跨域场景中表现出最优泛化能力，为X射线安检多模态学习设立了新基准。相关代码、数据和模型已开源。该研究克服了现有封闭式标签系统的局限，提升了复杂威胁检测能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T15:00:58Z
- **目录日期**: 2025-04-06
