...
该研究提出了STCray，首个多模态X射线行李安检数据集，包含46,642张图像-文本配对的扫描图像，涵盖21种威胁类别。通过专门设计的协议生成高质量的多模态指令数据，研究团队训练了名为STING-BEE的领域感知视觉AI助手，支持场景理解、威胁定位、视觉定位和视觉问答等任务，为X射线安检领域的多模态学习设立了新基准。STING-BEE在跨域场景中展现出先进的泛化能力。相关代码、数据和模型已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T22:00:59Z
- **目录日期**: 2025-04-06
