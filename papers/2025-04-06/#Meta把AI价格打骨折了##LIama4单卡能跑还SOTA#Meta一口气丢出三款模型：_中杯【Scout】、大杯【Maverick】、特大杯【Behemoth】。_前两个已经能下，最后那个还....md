...
Meta最新发布了三款AI模型：Scout（中杯）、Maverick（大杯）和Behemoth（特大杯）。其中Behemoth仍在训练中，但参数规模高达2万亿，引发广泛关注。已发布的Llama 4模型以更少参数实现与DeepSeek相当的代码能力，且支持单卡（如H100）运行，性能达到SOTA水平。这一系列突破性发布显著降低了AI使用门槛，被网友称为"价格打骨折"的技术革新。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T20:03:27Z
- **目录日期**: 2025-04-06
