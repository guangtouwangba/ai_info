...
Meta最新发布三款AI模型：Scout（中杯）、Maverick（大杯）和Behemoth（特大杯）。其中Behemoth拥有惊人的2万亿参数，目前仍在训练中。已发布的两款模型表现亮眼，尤其是LIama 4在开源领域重夺第一，其代码能力与DeepSeek相当但参数减少一半，且仅需单张H100显卡即可运行（SOTA级别性能）。这一系列突破性发布显著降低了AI运行成本，被网友称为"价格打骨折"的技术革新。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T07:03:36Z
- **目录日期**: 2025-04-06
