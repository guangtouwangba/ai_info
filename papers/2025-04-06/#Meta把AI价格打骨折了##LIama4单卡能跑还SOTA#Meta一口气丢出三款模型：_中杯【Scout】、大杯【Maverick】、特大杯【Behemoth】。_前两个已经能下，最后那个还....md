...
Meta近日发布了三款AI模型：Scout（中杯）、Maverick（大杯）和Behemoth（特大杯）。其中前两款已开放下载，Behemoth仍在训练中，但凭借2万亿参数的规模引发关注。重点发布的LIama 4在性能上达到SOTA（当前最优水平），代码能力与DeepSeek相当，但参数量减半，且支持单张H100显卡运行，大幅降低了AI使用成本。这一系列模型展示了Meta在高效AI训练和开源领域的突破，尤其是LIama 4以更小体积实现高性能，显著提升了技术性价比。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T14:03:42Z
- **目录日期**: 2025-04-06
