...
Meta最新发布了三款AI模型：Scout（中杯）、Maverick（大杯）和Behemoth（特大杯）。其中Behemoth仍在训练中，但参数规模高达2万亿，引发关注。已发布的两款模型表现亮眼，尤其是LIama 4在性能上达到SOTA（最先进水平），代码能力与DeepSeek相当但参数减半，且仅需单张H100显卡即可运行，大幅降低了AI使用门槛和成本。新模型展现了Meta在高效AI训练技术上的突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T16:03:58Z
- **目录日期**: 2025-04-06
