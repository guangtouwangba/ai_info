...
Meta最新发布三款AI模型：Scout（中杯）、Maverick（大杯）和Behemoth（特大杯）。其中Behemoth仍在训练中，但已引发关注——其参数高达2万亿，技术细节先进。已发布的两款模型表现突出，尤其是LIama 4，在开源领域重回领先地位，代码能力与DeepSeek相当，但参数减少一半，且支持单卡（如H100）运行，达到SOTA（当前最优）性能。Meta此次大幅降低AI成本，推动技术普及。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T05:03:23Z
- **目录日期**: 2025-04-06
