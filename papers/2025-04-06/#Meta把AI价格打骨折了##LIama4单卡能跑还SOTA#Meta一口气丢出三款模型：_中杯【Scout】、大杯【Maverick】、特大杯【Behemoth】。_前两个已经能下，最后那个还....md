...
Meta近日发布三款AI模型：Scout（中杯）、Maverick（大杯）和Behemoth（特大杯，2万亿参数）。前两款已开放下载，Behemoth仍在训练但参数规模惊人。其中LIama 4表现突出，以更少参数实现与DeepSeek相当的代码能力，支持单卡（如H100）运行并达到SOTA性能。新模型在参数效率和技术细节上展现突破，被比作"AI价格打骨折"，显著降低大模型使用门槛。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T11:03:33Z
- **目录日期**: 2025-04-06
