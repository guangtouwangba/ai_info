...
Meta最新发布了三款AI模型：Scout（中杯）、Maverick（大杯）和Behemoth（特大杯）。其中Behemoth仍在训练中，但凭借2万亿参数的庞大规模和前沿训练技术引发关注。已发布的Scout和Maverick表现亮眼，特别是LIama 4模型在参数减少一半的情况下仍达到与DeepSeek相当的代码能力，且支持单卡（如H100）运行并保持SOTA性能，显著降低了AI使用门槛。这一系列发布标志着Meta在开源AI领域重新夺回领先地位。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T17:03:28Z
- **目录日期**: 2025-04-06
