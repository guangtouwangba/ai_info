...
Meta最新发布三款AI模型：Scout（中杯）、Maverick（大杯）和Behemoth（特大杯）。其中Behemoth以2万亿参数的惊人规模引发关注，目前仍在训练中。已发布的Llama 4模型表现突出，在保持与DeepSeek相当代码能力的同时，参数量减少一半，实现单卡H100即可运行的SOTA性能。这一系列创新显著降低了AI使用门槛，被网友称为"价格打骨折"的技术突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T22:03:19Z
- **目录日期**: 2025-04-06
