...
本文研究了在部分可观测的安全关键环境中，多智能体系统完成复杂协作任务的挑战。针对动态网络桥接任务，研究者提出了一种结合控制论安全过滤器的方案，通过局部设定点更新实现避碰。实验表明，将安全过滤器激活编码为边缘级特征能有效提升多智能体强化学习中的信息传递和协调能力。结果表明，局部安全约束与去中心化学习可在分布式多智能体任务中有效结合。该研究为安全关键环境下的多智能体协作提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T06:02:40Z
- **目录日期**: 2025-04-06
