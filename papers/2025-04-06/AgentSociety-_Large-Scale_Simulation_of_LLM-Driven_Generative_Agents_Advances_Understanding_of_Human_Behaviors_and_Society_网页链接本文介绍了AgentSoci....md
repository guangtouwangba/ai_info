...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟1万多个代理及其500万次互动。它结合真实社会环境与模拟引擎，用于研究社会问题如极化现象、信息传播、基本收入政策及外部冲击（如飓风）的影响。模拟结果与现实实验数据吻合，验证了其捕捉人类行为机制的能力。该系统可作为计算社会科学工具，辅助传统研究方法（如调查、访谈），帮助研究者和政策制定者分析社会问题的模式、成因及潜在解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T01:47:26Z
- **目录日期**: 2025-04-06
