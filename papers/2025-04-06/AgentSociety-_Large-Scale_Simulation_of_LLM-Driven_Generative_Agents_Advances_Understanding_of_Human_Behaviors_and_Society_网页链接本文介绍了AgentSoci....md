...
AgentSociety是一个基于大型语言模型的大规模社会模拟系统，可模拟10,000多个AI代理的社会互动（500万次交互）。该系统作为计算社会科学实验平台，研究了社会极化、信息传播、基本收入政策及自然灾害（如飓风）的影响。模拟结果与现实世界数据高度吻合，验证了其捕捉人类行为机制的能力。该工具为社会科学研究和政策制定提供了新方法，能有效辅助传统调查和干预研究，揭示社会问题的成因与模式。研究突显了LLM驱动模拟在社会系统分析中的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T17:05:26Z
- **目录日期**: 2025-04-06
