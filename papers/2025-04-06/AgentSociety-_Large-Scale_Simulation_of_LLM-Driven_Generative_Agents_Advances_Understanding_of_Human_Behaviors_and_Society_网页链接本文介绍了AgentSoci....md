...
这篇论文介绍了一个名为AgentSociety的大规模社会模拟器，它利用大型语言模型驱动的代理、真实社会环境和强大的模拟引擎，模拟了超过1万个代理的社会生活及500万次互动。研究通过四个关键社会问题（如极化现象、信息传播、基本收入政策影响和飓风冲击）验证了该系统的有效性。结果表明，AgentSociety能准确捕捉人类行为模式，与现实实验结果高度吻合，展现了其作为社会科学研究和政策制定工具的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T18:05:00Z
- **目录日期**: 2025-04-06
