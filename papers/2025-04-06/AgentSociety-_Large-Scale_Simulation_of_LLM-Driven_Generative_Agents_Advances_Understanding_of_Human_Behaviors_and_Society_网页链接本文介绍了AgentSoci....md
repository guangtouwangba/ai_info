...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统通过模拟1万多个AI代理及其500万次互动，研究社会现象如政治极化、信息传播、基本收入政策影响和自然灾害应对。研究结果显示，模拟结果与现实世界数据高度吻合，验证了该系统在揭示人类行为机制方面的有效性。AgentSociety为社会科学研究和政策制定提供了新工具，能够补充传统研究方法，帮助理解复杂社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T05:05:23Z
- **目录日期**: 2025-04-06
