...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，通过1万个AI代理模拟了500万次社会互动。该系统被用于研究社会极化、信息传播、基本收入政策及自然灾害影响等四大社会问题，其模拟结果与现实世界数据高度吻合。研究表明，AgentSociety能有效捕捉人类行为机制，为社会科学研究和政策制定提供了新型实验平台，可辅助传统调查和干预方法。这一突破展示了AI模拟在理解复杂社会现象方面的巨大潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T20:05:14Z
- **目录日期**: 2025-04-06
