...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能够模拟10,000+个AI代理的社会互动（500万次交互）。该系统被用于研究四大社会问题：社会极化、信息传播、基本收入政策效果和自然灾害影响。研究发现模拟结果与现实世界数据高度吻合，验证了该系统在揭示人类行为机制方面的有效性。这种模拟方法为社会科学研究和政策制定提供了新工具，能够补充传统研究方法（如调查和实验），帮助理解复杂社会现象的成因和潜在解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T22:04:58Z
- **目录日期**: 2025-04-06
