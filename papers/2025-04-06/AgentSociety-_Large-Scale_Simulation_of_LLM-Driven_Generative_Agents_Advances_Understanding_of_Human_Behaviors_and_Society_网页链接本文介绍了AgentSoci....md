...
AgentSociety是一种基于大语言模型的大规模社会模拟器，通过1万多个AI代理和500万次互动，模拟真实社会环境。研究者用它分析了四个关键社会问题：群体极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，验证了该系统捕捉人类行为机制的能力。该平台可作为计算社会科学研究的创新工具，为政策制定提供新方法，弥补传统调查和实验的局限性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T08:05:56Z
- **目录日期**: 2025-04-06
