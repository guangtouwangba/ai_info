...
研究表明，当多个AI模型基于相同科学任务训练时，它们可能学习到不同理论，类似于科学史上多种理论并存的现象。随着训练数据中系统数量的增加，AI模型的理论会趋于收敛，但有时仍会形成不同理论群组。研究者提出MASS框架（哈密顿-拉格朗日神经网络），通过大量随机种子模拟不同AI科学家的训练过程发现：简单系统下AI倾向于学习哈密顿理论，复杂系统则转向拉格朗日表述。训练动态和最终权重表现出强种子依赖性，决定相关理论的兴衰。该方法不仅能增强可解释性，还可应用于高维问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T14:01:16Z
- **目录日期**: 2025-04-06
