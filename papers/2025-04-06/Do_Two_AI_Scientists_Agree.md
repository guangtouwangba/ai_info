...
研究表明，当两个AI模型基于相同科学任务训练时，它们可能学习不同理论，这与科学史上多种理论并存的现象类似。随着训练数据中系统数量的增加，AI模型倾向于收敛到相同理论，但有时仍会形成不同理论组。研究者提出MASS框架（哈密顿-拉格朗日神经网络），通过多组随机种子模拟不同AI科学家的训练过程。结果显示：简单系统下AI倾向于哈密顿理论，复杂系统则转向拉格朗日表述；训练动态和最终权重高度依赖随机种子，这决定了不同理论的"兴衰"。该方法还可扩展到高维问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T16:01:12Z
- **目录日期**: 2025-04-06
