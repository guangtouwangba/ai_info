...
研究表明，当两个AI模型在相同科学任务上训练时，它们可能学习不同理论，但随着训练数据中系统数量的增加，其理论会趋于收敛。研究者提出MASS框架（哈密顿-拉格朗日神经网络），通过多组随机种子模拟不同AI科学家的训练过程。结果显示：简单系统下AI倾向于学习哈密顿理论，复杂系统则转向拉格朗日表述；训练动态和最终权重高度依赖随机种子，这决定了不同理论的兴衰。该方法不仅能增强可解释性，还可应用于高维问题，揭示了AI科学家的理论选择与传统科学类似的验证机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T11:01:07Z
- **目录日期**: 2025-04-06
