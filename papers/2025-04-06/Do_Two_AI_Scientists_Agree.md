...
研究表明，当两个AI模型在相同科学任务上训练时，它们可能学习相同或不同的理论，类似科学史上理论的兴衰。随着训练数据中系统数量的增加，AI模型的理论趋向收敛，但有时仍会形成不同理论群组。研究者提出MASS框架，通过哈密顿-拉格朗日神经网络模拟AI科学家，发现简单系统下AI倾向于学习哈密顿理论，而复杂系统下转向拉格朗日理论。训练动态和最终权重表现出强烈的随机种子依赖性，影响理论的演化。该方法不仅能增强可解释性，还可应用于高维问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T06:01:12Z
- **目录日期**: 2025-04-06
