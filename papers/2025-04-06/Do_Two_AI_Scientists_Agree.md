...
研究表明，当两个AI模型在相同科学任务上训练时，它们可能学习不同理论，但随着训练数据增加，其理论会趋于收敛。研究者提出MASS框架（哈密顿-拉格朗日神经网络作为AI科学家），通过多轮训练模拟发现：在简单系统中AI倾向于学习哈密顿理论，而复杂系统则转向拉格朗日表述。训练动态和最终权重表现出强烈随机依赖性，影响理论的选择。该神经网络不仅增强可解释性，还能应用于高维问题，揭示了AI科学家的理论形成与实验科学发展规律的相似性——数据越充分，理论空间越受限。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T07:01:11Z
- **目录日期**: 2025-04-06
