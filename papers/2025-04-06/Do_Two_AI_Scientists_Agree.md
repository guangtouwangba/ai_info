...
研究表明，当多个AI模型在同一科学任务上训练时，它们可能学习到不同理论，但随着训练数据的增加，理论会趋于收敛。研究者提出MASS框架（哈密顿-拉格朗日神经网络）来量化AI科学家的理论一致性，发现简单系统下AI倾向于学习哈密顿理论，复杂系统则转向拉格朗日表述。训练初始条件（随机种子）会显著影响最终习得的理论，这与科学史上理论随实验数据演化的现象类似。该神经网络不仅提升了可解释性，还能应用于高维问题，揭示了AI科学家的理论形成机制与人类科学发展规律的相似性。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T21:01:17Z
- **目录日期**: 2025-04-06
