...
当两个AI模型在相同科学任务上训练时，它们可能学习相同或不同的理论，类似于科学史上理论随实验数据增加而收敛的现象。研究表明，随着训练数据中系统数量的增加，AI科学家（如哈密顿-拉格朗日神经网络MASS）倾向于收敛到相同理论，但有时会形成不同理论群体。在简单设置中AI学习哈密顿理论，而复杂系统会转向拉格朗日表述。训练动态和最终权重表现出强烈的随机种子依赖性，影响相关理论的兴衰。该方法不仅增强可解释性，还能应用于高维问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T02:29:14Z
- **目录日期**: 2025-04-06
