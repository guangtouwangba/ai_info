...
研究表明，当两个AI模型在相同科学任务上训练时，它们可能学习不同理论，类似于科学史上多种理论并存的现象。随着训练数据增加，AI模型的理论会趋于收敛，但有时仍会形成不同理论群组。研究者提出MASS框架（哈密顿-拉格朗日神经网络）来量化AI科学家的理论一致性，发现简单系统下AI倾向于哈密顿理论，复杂系统则转向拉格朗日理论。训练动态和最终权重表现出强随机种子依赖性，影响理论的兴衰。该神经网络不仅增强可解释性，还可应用于高维问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T17:01:16Z
- **目录日期**: 2025-04-06
