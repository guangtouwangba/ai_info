...
研究表明，当两个AI模型在同一科学任务上训练时，它们可能学习相同或不同的理论，这与科学史上理论随实验数据增加而收敛的现象类似。通过MASS（哈密顿-拉格朗日神经网络）框架对物理标准问题的多组训练分析发现：AI科学家在简单系统中倾向于学习哈密顿理论，而复杂系统会转向拉格朗日表述。训练动态和最终权重表现出强烈的随机种子依赖性，这决定了相关理论的兴衰。该神经网络不仅增强可解释性，还能应用于高维问题，揭示了AI理论学习与数据复杂度的动态关联。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T23:01:01Z
- **目录日期**: 2025-04-06
