...
研究表明，当两个AI模型在同一科学任务上训练时，它们可能学习相同或不同的理论，这与科学史上理论随实验数据增加而收敛的现象类似。通过提出的MASS框架（哈密顿-拉格朗日神经网络）分析，发现AI科学家在简单系统中倾向于学习哈密顿理论，而在复杂系统中转向拉格朗日理论。训练动态和最终权重表现出强烈的随机种子依赖性，影响理论的选择。该神经网络不仅增强了可解释性，还能应用于高维问题，揭示了AI理论学习与数据复杂度及初始条件的关系。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T00:01:19Z
- **目录日期**: 2025-04-06
