...
中科大与华为合作发布生成式推荐大模型，首次在国产昇腾NPU上实现全链自研部署。该研究复现了Meta的HSTU模型，并提出"相对注意力偏移"(RAB)和残差连接技术，赋予经典SASRec模型可扩展能力。该模型支持多域推荐、冷启动处理，排序性能媲美传统DIN模型。这一突破标志着大模型技术在推荐系统领域的成功应用，展现了国产AI芯片的部署能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T16:03:35Z
- **目录日期**: 2025-04-06
