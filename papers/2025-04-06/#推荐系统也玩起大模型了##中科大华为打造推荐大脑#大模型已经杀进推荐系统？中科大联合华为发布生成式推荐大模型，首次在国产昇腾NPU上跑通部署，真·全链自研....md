...
中科大与华为合作推出生成式推荐大模型，首次在国产昇腾NPU上实现全链自研部署。该模型复现了Meta的HSTU架构，创新提出"相对注意力偏移"(RAB)和残差连接技术，赋予传统SASRec模型扩展能力。其支持多域推荐、冷启动处理，排序性能媲美经典DIN模型，标志着推荐系统正式进入大模型时代。研究还揭示了模型扩展定律的技术原理，展现了国产AI基础设施的应用潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T18:03:00Z
- **目录日期**: 2025-04-06
