...
中科大与华为合作推出生成式推荐大模型，首次在国产昇腾NPU上实现全链自研部署。该研究复现了Meta的HSTU模型，并提出"相对注意力偏移（RAB）"和残差连接技术，赋予传统SASRec模型可扩展能力。该模型支持多域推荐、冷启动处理，排序性能媲美经典DIN模型，展现了推荐系统与大模型结合的技术突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T20:03:08Z
- **目录日期**: 2025-04-06
