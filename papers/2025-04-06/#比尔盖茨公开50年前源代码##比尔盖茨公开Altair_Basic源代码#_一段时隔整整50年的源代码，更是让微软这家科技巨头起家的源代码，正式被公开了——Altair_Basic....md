...
比尔·盖茨公开了50年前微软起家的Altair Basic源代码（157页），这是个人计算机发展的重要里程碑。他在文章中强调，在Office、Windows 95等产品之前，Altair Basic就已诞生。网友感叹从BASIC语言到万亿参数AI模型的飞速技术跨越，并认为用AI将这段代码转化为艺术会很有诗意。盖茨还分享了这段代码背后的历史细节。源代码地址可通过链接查看。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T06:04:23Z
- **目录日期**: 2025-04-06
