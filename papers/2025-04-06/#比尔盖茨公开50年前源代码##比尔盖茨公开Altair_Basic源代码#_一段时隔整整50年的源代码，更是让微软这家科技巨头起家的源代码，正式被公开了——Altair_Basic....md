...
比尔·盖茨公开了50年前由他编写的Altair Basic源代码（共157页），这是微软起家的关键程序。他在文章中强调，在Office、Windows 95等产品之前，Altair Basic就已诞生，标志着个人计算机革命的起点。网友感叹从BASIC语言到万亿参数AI的飞速技术跨越，并提议用GPT-5将这段历史代码转化为艺术。盖茨还分享了该代码背后的开发故事。源代码地址可通过原文链接查看。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T03:17:00Z
- **目录日期**: 2025-04-06
