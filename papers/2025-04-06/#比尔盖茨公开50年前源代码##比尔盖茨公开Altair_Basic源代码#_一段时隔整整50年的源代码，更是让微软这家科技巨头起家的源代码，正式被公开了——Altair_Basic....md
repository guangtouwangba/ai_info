...
比尔·盖茨公开了50年前由他编写的Altair Basic源代码（共157页），这段代码是微软公司的起点。盖茨强调，在Office、Windows 95、Xbox和AI出现之前，Altair Basic就已诞生。网友感叹从BASIC语言到万亿参数AI模型的飞速发展，并认为用GPT-5将这段代码转化为艺术会很有诗意。盖茨还分享了这段代码背后的故事。源代码地址见原文链接。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T02:31:38Z
- **目录日期**: 2025-04-06
