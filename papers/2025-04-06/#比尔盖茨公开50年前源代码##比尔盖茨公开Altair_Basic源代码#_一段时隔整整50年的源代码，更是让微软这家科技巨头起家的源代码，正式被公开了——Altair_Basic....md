...
比尔·盖茨公开了50年前微软起家的Altair Basic源代码（共157页），并撰文回顾这段历史。这段代码诞生于Office、Windows 95等产品之前，标志着个人计算机革命的起点。网友感叹从BASIC语言到万亿参数AI的跨越，认为用AI将这段代码转化为艺术会很有诗意。盖茨详细讲述了代码背后的故事，源代码地址可通过链接查看。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T08:04:49Z
- **目录日期**: 2025-04-06
