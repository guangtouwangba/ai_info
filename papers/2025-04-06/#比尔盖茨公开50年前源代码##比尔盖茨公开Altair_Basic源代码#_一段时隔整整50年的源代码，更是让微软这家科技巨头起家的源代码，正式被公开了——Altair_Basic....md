...
比尔·盖茨公开了50年前由他编写的Altair Basic源代码（共157页），这是微软起家的关键代码。他在文章中强调，在Office、Windows 95等产品之前，Altair Basic就已诞生，标志着个人计算机时代的开端。网友感叹从BASIC语言到万亿参数AI的飞速发展，并讨论用AI将这段历史代码转化为艺术的可能性。盖茨还分享了代码背后的故事。源代码地址可通过链接查看。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T00:03:40Z
- **目录日期**: 2025-04-06
