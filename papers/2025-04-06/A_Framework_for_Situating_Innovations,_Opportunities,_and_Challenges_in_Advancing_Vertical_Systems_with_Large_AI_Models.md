...
大型AI模型虽然在标准化测试中表现优异，但在医疗、教育、法律等高风险领域应用时暴露出明显缺陷，如数据敏感性、决策缺乏情境认知以及错误信息传播等问题。为此，研究提出了一种分层创新框架，通过模块化方法将大模型转化为实用的垂直系统，并强调各层间的动态协作。该框架帮助研究者和从业者定位创新方向（如垂直领域洞察与通用创新的结合）、发现被忽视的机遇（如开发实用基础模型而非追逐基准测试），并促进跨学科交流（如建立AI开发者、领域专家与人机交互学者的共同语言）。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T05:01:31Z
- **目录日期**: 2025-04-06
