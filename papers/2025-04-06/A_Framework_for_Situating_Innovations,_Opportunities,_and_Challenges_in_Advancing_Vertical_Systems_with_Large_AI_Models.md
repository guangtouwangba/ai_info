...
大型AI模型在标准化测试中表现优异，但在医疗、教育等高风险领域应用时暴露出明显缺陷，如对输入数据微小变化的脆弱性、关键场景下缺乏情境感知的决策，以及自信地生成错误信息等问题。为此，研究者提出分层创新框架，通过模块化方法将大模型转化为实用垂直系统，并强调各层级的动态协作。该框架帮助研究者定位创新方向（如开发垂直通用型解决方案）、发现被忽视的机遇（如跨领域共性问题的模型优化），并促进跨学科交流（建立开发者、领域专家与人机交互学者的共同语言）。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T16:01:37Z
- **目录日期**: 2025-04-06
