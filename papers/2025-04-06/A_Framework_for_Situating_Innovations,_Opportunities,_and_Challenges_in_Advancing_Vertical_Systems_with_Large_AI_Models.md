...
大型AI模型虽然在标准化测试中表现优异，但在医疗、教育、法律等高风险领域应用时，仍存在明显缺陷，如对输入数据微小变化的脆弱性、关键场景下缺乏上下文判断，以及自信地生成错误信息等问题。为此，研究提出了一种分层创新框架，通过模块化方法将大模型转化为实用的"垂直系统"，并强调各层间的动态协作。该框架能帮助研究者：(1)定位创新方向，(2)发现跨领域共性机遇，(3)促进跨学科交流。案例研究表明，该方案可有效协调模型能力与实际应用需求之间的差距。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T15:01:32Z
- **目录日期**: 2025-04-06
