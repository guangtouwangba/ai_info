...
大型AI模型在标准化测试中表现优异，但在医疗、教育等高风险领域的实际应用中暴露出明显缺陷，如对输入数据细微变化敏感、决策缺乏情境认知以及错误输出等问题。为此，研究提出一个分层创新框架，通过模块化方法将大模型转化为实用的垂直系统，并强调各层间的动态协作。该框架帮助研究者：(1)定位创新方向，(2)发现跨领域共性需求以开发实用基础模型，(3)促进跨学科沟通。案例研究表明，该框架能有效协调模型能力与实际应用需求，推动AI在关键领域的可靠部署。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T10:01:34Z
- **目录日期**: 2025-04-06
