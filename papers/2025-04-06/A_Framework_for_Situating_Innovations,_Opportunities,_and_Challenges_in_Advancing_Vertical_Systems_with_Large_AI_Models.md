...
当前大型AI模型虽然在标准化测试中表现优异，但在医疗、教育、法律等高风险领域应用时仍存在明显缺陷，如对输入数据细微变化敏感、关键场景决策缺乏上下文理解、过度自信导致错误输出等。为弥合模型能力与实际需求间的差距，研究者提出分层创新框架，通过模块化方法将大模型转化为垂直领域系统，并强调各层间的动态交互。该框架能帮助研究者：(1)定位创新方向，(2)发现跨领域共性需求，(3)促进AI开发者、领域专家与人机交互学者间的跨学科协作，推动构建真正实用的垂直AI系统。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T09:01:36Z
- **目录日期**: 2025-04-06
