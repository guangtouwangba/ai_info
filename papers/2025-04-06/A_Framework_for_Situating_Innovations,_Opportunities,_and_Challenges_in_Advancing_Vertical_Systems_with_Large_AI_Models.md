...
大型AI模型虽然在标准化测试中表现优异，但在医疗、教育、法律等高风险领域应用时，常暴露局限性，如输入数据敏感性、缺乏情境判断和错误自信输出等问题。为此，研究者提出分层创新框架，通过模块化方法将大模型转化为实用垂直系统，满足实际需求。该框架帮助研究者定位创新方向（如垂直领域与通用技术的结合）、发现被忽视的机会（如跨领域共性问题），并促进跨学科协作（如AI开发者、领域专家间的沟通）。案例研究表明，该方案能有效提升大模型在真实场景中的适用性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T02:29:34Z
- **目录日期**: 2025-04-06
