...
调研显示，超90%的年轻人依赖AI进行工作学习，80%通过AI建立真实社交关系。约70%愿与AI交友，60%拥有"AI室友"，同时40%存在"AI焦虑"。近20%的年轻人已通过AI获利，更多人选择边用边学。AI不仅是工具，更成为00后的"情感伙伴"和"创收助手"。数据显示，年轻人平均拥有1.8个AI朋友，反映AI已深度融入年轻群体的日常生活与情感需求。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T17:03:18Z
- **目录日期**: 2025-04-06
