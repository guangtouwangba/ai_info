...
调研显示，AI已成为00后工作学习的重要伙伴：超90%年轻人依赖AI，80%通过AI建立真实关系，70%愿与AI交友，60%拥有"AI室友"。同时，40%存在"AI焦虑"，近20%已通过AI获利。AI不仅作为工具，更成为情感陪伴和创收助手，体现年轻一代对AI的高度接纳与融合。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T20:03:18Z
- **目录日期**: 2025-04-06
