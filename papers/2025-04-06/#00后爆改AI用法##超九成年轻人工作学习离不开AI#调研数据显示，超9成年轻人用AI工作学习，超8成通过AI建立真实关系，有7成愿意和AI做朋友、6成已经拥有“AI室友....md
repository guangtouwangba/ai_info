...
调研显示，AI已成为00后生活的重要部分：超90%年轻人用AI工作学习，80%通过AI建立真实关系，70%愿与AI交友，60%拥有"AI室友"。同时，40%存在"AI焦虑"，20%已通过AI盈利。AI不仅是工具，更成为年轻人的"情绪搭子"和"赚钱助手"，人均拥有1.8个AI朋友。数据反映Z世代对AI的高度依赖与多元化应用趋势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T09:03:17Z
- **目录日期**: 2025-04-06
