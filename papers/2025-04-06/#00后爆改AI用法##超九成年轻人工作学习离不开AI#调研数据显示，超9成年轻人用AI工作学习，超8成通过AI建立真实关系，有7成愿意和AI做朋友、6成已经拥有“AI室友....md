# #00后爆改AI用法##超九成年轻人工作学习离不开AI#调研数据显示，超9成年轻人用AI工作学习，超8成通过AI建立真实关系，有7成愿意和AI做朋友、6成已经拥有“AI室友...
...
调研显示，超90%的00后年轻人依赖AI辅助工作学习，80%通过AI建立真实人际关系，70%愿与AI交友，60%已有"AI室友"。AI不仅作为工具，更成为情感陪伴和创收助手（20%通过AI赚钱）。尽管40%存在"AI焦虑"，但多数选择边用边学，体现Z世代对AI的高度融合与创新应用。人均拥有1.8个AI朋友的数据，凸显AI已深度渗透年轻群体的社交与生活场景。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T05:03:13Z
- **目录日期**: 2025-04-06
