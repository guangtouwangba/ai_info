...
调研显示，AI已成为00后工作学习的核心工具：超90%年轻人依赖AI，80%通过AI建立真实社交关系，70%愿与AI交友，60%拥有"AI室友"。同时，AI也带来新角色——40%存在"AI焦虑"，20%已实现AI创收，更多人选择边用边学。AI从工具演变为"情绪搭子"和"赚钱助手"，Z世代平均拥有1.8个AI朋友，体现技术深度融入生活的趋势。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T12:03:17Z
- **目录日期**: 2025-04-06
