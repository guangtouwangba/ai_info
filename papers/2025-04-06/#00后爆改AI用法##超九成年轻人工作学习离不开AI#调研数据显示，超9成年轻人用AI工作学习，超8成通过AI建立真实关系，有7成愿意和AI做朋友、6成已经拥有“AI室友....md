...
调研显示，AI已成为00后工作学习的重要伙伴：超90%年轻人依赖AI，80%通过AI建立真实人际关系，70%愿与AI交友，60%拥有"AI室友"。同时，40%存在"AI焦虑"，近20%已通过AI获利。AI不仅是工具，更扮演"情绪搭子"和"创收助手"的双重角色，人均拥有1.8个AI朋友。数据反映出年轻一代正积极探索人机共生的新型关系模式。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T18:03:09Z
- **目录日期**: 2025-04-06
