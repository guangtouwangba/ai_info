...
调研显示，AI已成为年轻人生活的重要部分：超90%用于工作学习，80%通过AI建立真实关系，70%愿与AI交友，60%拥有"AI室友"。同时，40%存在"AI焦虑"，20%已通过AI盈利。AI不仅是工具，更成为00后的"情感伙伴"和"创收助手"，人均拥有1.8个AI朋友，展现深度融入日常的趋势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T16:03:48Z
- **目录日期**: 2025-04-06
