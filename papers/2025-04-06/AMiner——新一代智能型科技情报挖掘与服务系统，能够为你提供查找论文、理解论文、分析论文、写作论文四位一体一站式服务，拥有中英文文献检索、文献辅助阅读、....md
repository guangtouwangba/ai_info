...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译和科研订阅等一站式服务。其核心功能包括：1）中英文文献检索，支持互动问答和自动摘要生成；2）英文文献翻译与解析，可上传PDF获取AI生成的摘要和章节概要；3）个性化科研情报订阅，通过微信/邮件推送最新学术动态。平台覆盖42个学科，包含3.5亿论文、0.6亿学者等海量数据，并免费开放基础检索功能。特色服务还包括学者画像、学术会议追踪和论文排行榜等，致力于提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T22:05:27Z
- **目录日期**: 2025-04-06
