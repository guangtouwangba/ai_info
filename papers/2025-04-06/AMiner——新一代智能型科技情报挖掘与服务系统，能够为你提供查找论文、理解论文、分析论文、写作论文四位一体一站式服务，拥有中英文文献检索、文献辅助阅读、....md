...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析与写作的一站式服务。平台涵盖42个学科的3.5亿论文、0.6亿学者等海量数据，支持中英文文献检索、AI辅助阅读、自动摘要生成及互动问答功能。用户可上传或搜索文献，获取章节概要和翻译，还能定制科研动态订阅（通过微信/邮件推送）。此外，AMiner提供学者画像、学术会议追踪等特色功能，基础服务免费开放，旨在提升科研效率。访问入口：https://www.aminer.cn/。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T20:05:43Z
- **目录日期**: 2025-04-06
