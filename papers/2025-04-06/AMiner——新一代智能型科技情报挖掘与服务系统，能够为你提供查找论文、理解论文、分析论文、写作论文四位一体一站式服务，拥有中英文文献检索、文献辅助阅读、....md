...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译及科研分析等一站式服务。它收录42个学科的3.5亿论文、0.6亿学者及1.5亿专利，支持中英文文献检索、AI生成摘要、互动问答和文档翻译功能。用户可订阅个性化科研动态，通过微信或邮件获取最新学术资讯。平台还提供学者画像、会议追踪及论文排行榜等工具，基础功能免费使用，旨在提升科研效率。访问链接：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T16:06:32Z
- **目录日期**: 2025-04-06
