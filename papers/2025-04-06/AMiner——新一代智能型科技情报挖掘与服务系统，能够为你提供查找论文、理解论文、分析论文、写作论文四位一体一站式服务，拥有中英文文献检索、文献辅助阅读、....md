...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、阅读辅助和科研订阅等一站式服务。其核心功能包括：1）中英文文献检索，支持互动问答和自动摘要生成；2）英文文献翻译与AI辅助阅读，可上传PDF并获取章节概要和问题建议；3）个性化科研情报订阅，通过微信/邮件推送最新论文。平台覆盖42个学科的3.5亿论文、0.6亿学者数据，并提供学者画像、学术会议等特色功能。基础检索服务免费开放，网址：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T09:06:02Z
- **目录日期**: 2025-04-06
