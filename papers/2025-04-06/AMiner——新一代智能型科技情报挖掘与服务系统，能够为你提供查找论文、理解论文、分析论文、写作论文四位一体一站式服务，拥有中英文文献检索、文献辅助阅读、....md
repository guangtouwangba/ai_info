...
AMiner是一个智能科技情报挖掘平台，提供四位一体的学术服务：查找、理解、分析和写作论文。它支持中英文文献检索，拥有3.5亿论文、0.6亿学者等海量数据。主要功能包括：1）互动式文献搜索与自动摘要生成；2）英文文献翻译、辅助阅读和AI问答；3）个性化科研情报订阅，通过微信或邮件推送最新动态。平台还提供学者画像、学术会议等特色功能，基础检索服务免费开放。网址：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T08:06:29Z
- **目录日期**: 2025-04-06
