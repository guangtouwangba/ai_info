...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、辅助阅读、翻译和论文写作支持。它拥有庞大的学术数据库，涵盖3.5亿论文、0.6亿学者和1.5亿专利。核心功能包括：1）智能文献检索与摘要生成；2）英文文献翻译与交互式问答；3）个性化科研情报订阅服务。用户可通过关键词、学者或机构定制最新研究动态推送。平台还提供学者画像、学术会议等特色功能，支持免费使用，帮助研究者高效获取和分析学术信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T06:06:26Z
- **目录日期**: 2025-04-06
