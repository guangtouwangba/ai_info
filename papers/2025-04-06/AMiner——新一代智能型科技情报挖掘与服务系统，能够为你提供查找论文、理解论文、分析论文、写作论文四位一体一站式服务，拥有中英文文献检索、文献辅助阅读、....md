...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、辅助阅读、翻译和论文写作支持。平台收录3.5亿论文、0.6亿学者等海量数据，支持互动问答和自动摘要生成，提升研究效率。用户可上传或检索文献，获取AI生成的摘要和章节概要，并通过对话深入理解内容。此外，AMiner提供个性化科研动态订阅，按用户偏好推送最新论文摘要。平台还包含学者画像、学术会议等特色功能，基础服务免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T15:06:04Z
- **目录日期**: 2025-04-06
