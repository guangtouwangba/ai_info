...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读辅助、翻译及科研分析等一站式服务。平台收录3.5亿论文、0.6亿学者等海量数据，支持中英文文献智能检索、互动问答及自动摘要生成，显著提升研究效率。其特色功能包括AI驱动的文献翻译与解析、个性化科研动态订阅（通过微信/邮件推送），以及学者画像、学术会议等拓展服务。用户可免费使用浏览器检索基础功能，通过网页或小程序便捷访问。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T00:06:00Z
- **目录日期**: 2025-04-06
