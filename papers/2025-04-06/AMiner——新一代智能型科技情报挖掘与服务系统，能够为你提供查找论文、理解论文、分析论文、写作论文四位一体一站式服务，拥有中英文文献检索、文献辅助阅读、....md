...
AMiner是一个智能科技情报挖掘平台，提供四位一体的学术服务，包括论文检索、理解、分析和写作。它拥有中英文文献检索、辅助阅读、翻译等功能，覆盖42个学科3.5亿论文、0.6亿学者等海量数据。核心功能包括：1）高效文献检索与互动问答；2）英文文献翻译与AI摘要生成；3）个性化科研情报订阅。此外，还提供学者画像、学术会议等特色服务。平台支持浏览器免费使用，旨在帮助用户快速获取和理解学术信息，提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T21:05:42Z
- **目录日期**: 2025-04-06
