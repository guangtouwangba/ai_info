...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、辅助阅读、翻译和科研情报订阅。平台收录3.5亿论文、0.6亿学者等海量数据，支持互动问答、自动摘要生成和文献内容解析。用户可定制订阅最新科研动态，并通过微信或邮件接收。此外，AMiner还提供学者画像、学术会议和论文排行榜等功能，大部分服务可免费使用。访问入口：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T13:10:10Z
- **目录日期**: 2025-04-06
