...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献检索、AI辅助阅读、自动摘要生成和翻译功能，涵盖42个学科3.5亿论文。用户可通过问答机制快速理解文献内容，上传PDF获取摘要和章节概要。平台还提供科研动态订阅服务，根据用户偏好推送最新学术资讯。此外，AMiner包含学者画像、学术会议和论文排行榜等功能，基础检索服务免费开放。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T01:47:57Z
- **目录日期**: 2025-04-06
