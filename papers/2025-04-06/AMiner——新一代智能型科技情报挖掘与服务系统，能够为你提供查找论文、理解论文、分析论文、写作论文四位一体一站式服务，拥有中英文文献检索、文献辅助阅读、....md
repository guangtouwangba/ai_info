...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译、写作等一站式服务。它收录了3.5亿论文、0.6亿学者等海量学术资源，支持中英文文献检索，并能通过AI生成摘要和问答互动。平台还提供文献翻译、科研动态订阅（按用户偏好推送最新成果）、学者画像等功能。用户可免费使用浏览器检索，通过网页或微信小程序便捷获取学术资讯，提升研究效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T18:05:29Z
- **目录日期**: 2025-04-06
