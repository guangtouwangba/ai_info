...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、翻译、辅助阅读和科研情报订阅。其数据库涵盖42个学科3.5亿论文、0.6亿学者和1.5亿专利。用户可通过互动问答快速理解文献内容，AI还能自动生成摘要和章节概要。平台支持个性化订阅，通过微信或邮件推送最新科研动态，并提供学者画像、学术会议等附加功能。AMiner浏览器版可免费使用，帮助用户高效筛选文献并提升研究效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T23:05:05Z
- **目录日期**: 2025-04-06
