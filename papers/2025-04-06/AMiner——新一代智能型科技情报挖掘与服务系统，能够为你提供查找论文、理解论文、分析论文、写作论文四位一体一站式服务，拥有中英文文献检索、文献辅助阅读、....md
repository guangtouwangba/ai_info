...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译及科研订阅等一站式服务。它支持中英文文献搜索，拥有3.5亿论文、0.6亿学者等海量数据，并能通过AI生成摘要和问答互动帮助用户快速理解文献。平台还支持PDF上传、章节概要生成及个性化科研动态推送（通过微信或邮件）。此外，AMiner提供学者画像、学术会议追踪等功能，基础服务免费开放。访问入口：官网（https://www.aminer.cn）和AI交互页（https://www.aminer.cn/chat/g/explain/）。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T19:05:25Z
- **目录日期**: 2025-04-06
