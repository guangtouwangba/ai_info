...
本研究评估了大型语言模型（LLM）代理在不同时间控制工具（DCTs）下的知识可变性，重点考察其作为写作助手时依赖网络搜索完成科学摘要的表现。结果显示，搜索引擎的时间性会影响代理性能，但通过选择基础模型和采用显式推理指令（如思维链提示）可缓解这一问题。研究强调，代理设计和评估需动态考虑外部资源的时间影响，以确保可靠性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T16:02:09Z
- **目录日期**: 2025-04-06
