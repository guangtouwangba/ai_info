...
该研究评估了大型语言模型（LLM）代理在知识更新中的时间动态性，通过日期控制工具（DCT）测试其作为写作助手时依赖网络搜索的性能差异。结果表明，搜索引擎的时间性导致代理表现依赖工具选择，但可通过基础模型优化和显式推理指令（如思维链提示）缓解。研究强调代理设计需动态视角，并采取措施减少外部资源时间性影响以确保可靠性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T18:01:57Z
- **目录日期**: 2025-04-06
