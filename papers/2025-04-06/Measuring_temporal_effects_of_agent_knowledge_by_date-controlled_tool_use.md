...
该研究探讨了时间因素对基于网络搜索的大型语言模型（LLM）智能体知识更新的影响。通过使用不同日期控制的工具（DCTs）测试LLM智能体作为写作助手完成科学摘要的表现，发现搜索引擎的时间性会导致工具依赖的性能差异。研究指出，基础模型的选择和显式推理指令（如思维链提示）能缓解这一问题。结果表明，智能体设计和评估需动态考量外部资源的时间影响，并采取措施确保可靠性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T07:02:09Z
- **目录日期**: 2025-04-06
