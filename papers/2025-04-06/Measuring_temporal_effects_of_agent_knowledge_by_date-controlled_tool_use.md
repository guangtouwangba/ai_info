...
这篇摘要研究了大型语言模型(LLM)代理在知识更新中的时间动态性。通过使用日期控制工具(DCTs)测试LLM代理作为写作助手完成科学摘要的表现，发现搜索引擎的时间性会导致工具依赖的性能差异。研究表明，基础模型的选择和显式推理指令(如思维链提示)可以缓解这种时间影响。作者建议代理设计和评估应采用动态视角，并采取措施应对外部资源的时间影响，以确保可靠性。研究突出了时间进程对知识积累和更新的重要性，以及不当配置对代理响应质量的影响。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T01:34:21Z
- **目录日期**: 2025-04-06
