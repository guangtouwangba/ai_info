...
这篇摘要研究了大型语言模型(LLM)代理在知识更新中的时间动态性。通过使用日期控制工具(DCTs)测试发现，基于网络搜索的LLM代理性能会随时间变化，这种工具依赖性可通过基础模型选择和显式推理指令(如思维链提示)来缓解。研究以科学摘要写作为例，展示了搜索引擎的时间性如何影响代理表现。结果表明，代理设计和评估应考虑外部资源的时效性影响，采取动态视角和相应措施来确保可靠性。这为提升LLM代理的知识更新能力提供了重要见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T23:01:47Z
- **目录日期**: 2025-04-06
