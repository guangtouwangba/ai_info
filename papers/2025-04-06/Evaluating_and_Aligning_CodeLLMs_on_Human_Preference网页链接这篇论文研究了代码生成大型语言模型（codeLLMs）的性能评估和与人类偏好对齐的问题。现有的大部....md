...
这篇论文针对代码生成大模型（CodeLLMs）与人类偏好对齐的问题，提出了新基准CodeArena（包含397个高质量样本，覆盖40类任务和44种语言）和大规模合成指令数据集SynCode-Instruct（近200亿标记）。研究发现现有基准过于关注代码正确性而忽视人类偏好，实验显示开源模型（如Qwen2.5-Coder）与商业模型（如OpenAI o1）存在显著差距，验证了合成指令微调的有效性，强调了代码生成模型与人类需求对齐的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T21:05:51Z
- **目录日期**: 2025-04-06
