...
这篇论文研究了代码生成大模型(codeLLMs)与人类偏好的对齐问题。作者创建了CodeArena基准测试，包含397个高质量样本，覆盖40个类别和44种编程语言，以评估模型在实际编程任务中的表现。同时构建了SynCode-Instruct合成指令语料库(近200亿标记)验证指令微调效果。实验发现现有基于执行的基准与CodeArena存在性能差异，开源顶级模型(如Qwen2.5-Coder)与专有模型(如OpenAI o1)之间仍有显著差距，凸显了与人类偏好对齐的重要性。研究强调了代码生成模型不仅需要正确性，还需符合人类编程习惯。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T03:19:40Z
- **目录日期**: 2025-04-06
