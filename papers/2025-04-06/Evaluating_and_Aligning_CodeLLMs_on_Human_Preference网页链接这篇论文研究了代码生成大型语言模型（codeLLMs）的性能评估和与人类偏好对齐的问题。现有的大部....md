...
这篇论文提出了CodeArena基准测试，用于评估代码生成大模型(CodeLLMs)与人类偏好的对齐程度。研究者从真实用户查询中精选397个样本，覆盖40类任务和44种编程语言，弥补了现有基准仅关注代码正确性的不足。同时构建了20B标记的合成指令数据集SynCode-Instruct验证微调效果。实验发现执行基准与人类偏好存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，凸显了人类偏好对齐的重要性。研究为提升代码模型的实用价值提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T01:48:07Z
- **目录日期**: 2025-04-06
