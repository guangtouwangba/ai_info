...
该论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，包含397个高质量样本，覆盖40类编程任务和44种语言，更关注人类偏好而非仅代码正确性。研究还构建了20B标记的合成指令数据集SynCode-Instruct验证微调效果。实验发现执行基准与CodeArena存在性能差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)差距显著，凸显对齐人类偏好的重要性。研究强调需超越传统代码正确性评估，关注实际开发场景中的用户体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T23:05:16Z
- **目录日期**: 2025-04-06
