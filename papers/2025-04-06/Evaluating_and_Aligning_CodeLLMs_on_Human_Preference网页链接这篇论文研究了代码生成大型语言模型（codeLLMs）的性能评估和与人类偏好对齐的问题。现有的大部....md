...
这篇论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，聚焦模型输出与人类偏好的对齐问题。研究收集了397个涵盖40类编程任务和44种语言的真实样本，并构建20B标记的合成指令数据集SynCode-Instruct。实验发现，传统基于执行的评估与人类偏好存在差异，且开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究强调代码生成模型不仅需要正确性，还需符合开发者实际需求，为模型优化提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T15:06:16Z
- **目录日期**: 2025-04-06
