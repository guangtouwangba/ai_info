...
本文提出了一种在LHC上测量$|V_{cb}|$的新方法，通过使用先进的"bc签名"增强喷射标记器。该方法将$W \rightarrow bc$信号与顶夸克衰变的$bc$匹配喷流关联，实现了标记器的原位校准，显著抑制背景并降低风味标记效率的不确定性。研究开发了基于AI的大/小半径标记器Sophon和SophonAK4，性能达到ATLAS和CMS最先进水平。在高亮度LHC条件下，该方法可使$|V_{cb}|$测量精度提高约30%，同时将$H^{\pm} \rightarrow bc$搜索灵敏度提升2-5倍。该工作为精确测量$|V_{cb}|$提供了新思路，展现了先进标记模型在LHC探索增强区域的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T21:02:17Z
- **目录日期**: 2025-04-06
