...
本文提出了一种在LHC测量$|V_{cb}|$的新方法，利用先进的"bc标记器"识别$W \rightarrow bc$信号，并结合顶夸克衰变产生的$bc$喷注进行原位校准。该方法显著抑制背景干扰，降低风味标记效率的不确定性，使$|V_{cb}|$测量精度提高约30%。研究开发了基于AI的大/小半径标记器Sophon和SophonAK4，性能达到ATLAS和CMS最先进水平。作为副产品，该方法将$H^{\pm} \rightarrow bc$搜索灵敏度比ATLAS Run 2结果提升2-5倍，为LHC探索高能区提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T12:02:22Z
- **目录日期**: 2025-04-06
