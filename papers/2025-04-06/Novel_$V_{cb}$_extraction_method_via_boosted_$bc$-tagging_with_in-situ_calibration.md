...
本文提出了一种在LHC测量$|V_{cb}|$的新方法，通过先进的"bc标记器"识别增强喷流中的$bc$信号。该方法将$W \rightarrow bc$信号与顶夸克衰变的$bc$匹配喷流关联，实现了标记器的原位校准，显著抑制背景并降低味道标记效率的不确定性。基于AI开发的大/小半径标记器Sophon和SophonAK4已验证与ATLAS和CMS最先进标记器相当。在HL-LHC预期下，该方法可使$|V_{cb}|$测量精度提高约30%，同时将$H^{\pm} \rightarrow bc$搜索灵敏度提升2-5倍。这为精确测量$|V_{cb}|$提供了新视角，并展示了先进标记模型在LHC探索增强机制的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T16:02:24Z
- **目录日期**: 2025-04-06
