...
本文提出了一种在LHC上测量$|V_{cb}|$的新方法，利用先进的"bc标记器"识别增强喷注中的$bc$信号。通过将$W \rightarrow bc$信号与顶夸克衰变产生的$bc$匹配喷注关联，实现了标记器的原位校准。该方法显著抑制了背景干扰，降低了味道标记效率的不确定性，使$|V_{cb}|$测量精度提高约30%。基于AI开发的大/小半径标记器Sophon和SophonAK4已验证与ATLAS和CMS最先进标记器相当。作为副产品，该方法还将$H^{\pm} \rightarrow bc$搜索灵敏度提高了2-5倍，为LHC探索增强区域提供了新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T17:02:16Z
- **目录日期**: 2025-04-06
