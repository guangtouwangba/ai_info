...
本文提出了一种在LHC测量$|V_{cb}|$的新方法，通过先进的"bc标记器"识别$W \rightarrow bc$信号，并结合来自顶夸克衰变的$bc$匹配喷注进行原位校准。该方法显著抑制背景噪声，降低味道标记效率的不确定性，使$|V_{cb}|$测量精度提高约30%（基于HL-LHC预测）。研究开发了基于AI的大/小半径标记器Sophon和SophonAK4，性能达到ATLAS和CMS最先进水平。作为副产品，该方法还将$H^{\pm} \rightarrow bc$的搜索灵敏度比ATLAS Run 2结果提高了2-5倍，为LHC探索高能区提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T01:34:31Z
- **目录日期**: 2025-04-06
