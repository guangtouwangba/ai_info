...
本文提出了一种在LHC测量$|V_{cb}|$的新方法，利用先进的"bc签名"增强喷射标记器，通过将$W \rightarrow bc$信号与顶夸克衰变的$bc$匹配喷射关联，实现了标记器的原位校准。该方法显著抑制背景噪声并降低风味标记效率的不确定性，结合基于AI的大/小半径标记器Sophon和SophonAK4，在HL-LHC预测下使$|V_{cb}|$测量精度提高约30%。作为副产品，该方法将$H^{\pm} \rightarrow bc$的搜索灵敏度比ATLAS Run 2结果提升了2-5倍，为LHC探索增强机制提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T00:02:29Z
- **目录日期**: 2025-04-06
