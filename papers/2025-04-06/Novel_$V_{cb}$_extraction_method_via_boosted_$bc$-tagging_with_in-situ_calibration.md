...
本文提出了一种在LHC测量$|V_{cb}|$的新方法，利用先进的"bc标记器"识别boosted喷注中的$W \rightarrow bc$信号，并结合顶夸克衰变中的$bc$喷注进行原位校准。该方法显著抑制背景并降低风味标记效率的不确定性，使$|V_{cb}|$测量精度提高约30%（基于HL-LHC预测）。同时，该方法将$H^{\pm} \rightarrow bc$搜索灵敏度比ATLAS Run 2结果提升2-5倍。研究采用了基于AI的大/小半径喷注标记器Sophon和SophonAK4，性能与ATLAS和CMS最先进标记器相当。该工作为精确测量$|V_{cb}|$提供了新思路，并展示了先进标记模型在LHC探索新物理的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T19:02:05Z
- **目录日期**: 2025-04-06
