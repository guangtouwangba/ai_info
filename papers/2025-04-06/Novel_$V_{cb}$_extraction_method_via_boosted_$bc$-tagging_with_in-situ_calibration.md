...
本文提出了一种在LHC测量$|V_{cb}|$的新方法，利用先进的"bc签名"增强喷射标记技术。通过将$W \rightarrow bc$信号与顶夸克衰变的$bc$匹配喷射关联，实现了标记器的原位校准。该方法显著抑制背景噪声并降低风味标记效率的不确定性，使$|V_{cb}|$测量精度提高约30%。研究基于新型AI标记器Sophon和SophonAK4，性能达到ATLAS和CMS最先进水平。作为副产品，该方法将$H^{\pm} \rightarrow bc$搜索灵敏度提高了2-5倍。这项工作为精确测量$|V_{cb}|$提供了新视角，展现了先进标记模型在LHC探索增强机制中的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T14:02:24Z
- **目录日期**: 2025-04-06
