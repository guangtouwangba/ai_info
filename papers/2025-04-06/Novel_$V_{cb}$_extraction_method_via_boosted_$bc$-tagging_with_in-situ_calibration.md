...
本文提出了一种利用LHC测量$|V_{cb}|$的新方法，通过先进的"bc签名"增强喷注重子标记技术，结合来自顶夸克衰变的$bc$匹配喷注进行原位校准。该方法显著抑制背景干扰，降低风味标记效率的不确定性，在HL-LHC预测下可将$|V_{cb}|$测量精度提高约30%。研究开发了基于AI的大/小半径喷注重子标记器Sophon和SophonAK4，性能匹配ATLAS和CMS最先进技术。作为副产品，该方法使$H^{\pm} \rightarrow bc$搜索灵敏度比ATLAS Run 2结果提高2-5倍，为LHC探索增强区域提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T03:15:44Z
- **目录日期**: 2025-04-06
