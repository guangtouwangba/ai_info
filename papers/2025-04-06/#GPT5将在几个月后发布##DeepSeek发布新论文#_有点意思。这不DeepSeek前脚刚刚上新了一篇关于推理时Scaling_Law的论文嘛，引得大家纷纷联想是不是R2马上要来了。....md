...
OpenAI宣布GPT-5将在几个月后发布，效果可能超预期，但需更多时间整合资源。此前计划先推出o3和o4-mini模型。与此同时，DeepSeek发布新论文探讨推理时Scaling Law，引发行业关注。两家公司动态显示AI领域竞争激烈，技术迭代加速。OpenAI解释延迟是因需确保系统能力满足预期需求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T04:03:58Z
- **目录日期**: 2025-04-06
