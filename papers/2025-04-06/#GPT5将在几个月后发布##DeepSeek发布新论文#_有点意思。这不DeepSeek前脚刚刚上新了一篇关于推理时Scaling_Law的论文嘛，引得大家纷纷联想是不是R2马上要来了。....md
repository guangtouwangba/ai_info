...
OpenAI宣布GPT-5将在几个月后发布，效果可能超出预期，但需更多时间整合资源。此前计划先发布o3和o4-mini。与此同时，DeepSeek发布了一篇关于推理时Scaling Law的新论文，引发行业关注。OpenAI的调整似乎是对DeepSeek进展的回应，显示两大AI机构的技术竞争日趋激烈。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T00:03:48Z
- **目录日期**: 2025-04-06
