...
OpenAI宣布GPT-5将在几个月后发布，效果将超预期，但需更多时间整合资源。此前计划先推出o3和o4-mini。与此同时，DeepSeek发布关于推理时Scaling Law的新论文，引发行业关注。两家公司动态显示AI领域竞争加剧，OpenAI似乎对DeepSeek的进展作出回应。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T03:17:09Z
- **目录日期**: 2025-04-06
