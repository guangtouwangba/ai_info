...
大型视觉语言模型（VLMs）为AI驱动的图像理解提供了新范式，无需任务特定训练即可执行任务，在医学数据稀缺领域尤其具有潜力。研究评估了11种先进VLMs在17个外科AI任务（从解剖识别到技能评估）的表现，涵盖13个腹腔镜、机器人和开放手术数据集。结果表明，VLMs展现出良好的泛化能力，有时在非训练场景下表现优于监督模型。上下文学习可将性能提升三倍，突显其适应能力，但空间和时间推理任务仍具挑战性。该研究为VLMs在临床及其他动态复杂场景的应用提供了重要参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T19:01:15Z
- **目录日期**: 2025-04-06
