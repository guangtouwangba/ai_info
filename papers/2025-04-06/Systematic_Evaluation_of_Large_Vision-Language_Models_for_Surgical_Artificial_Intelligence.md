...
大型视觉语言模型(VLMs)为AI驱动的图像理解提供了新范式，无需任务特定训练即可执行多种任务。在医学领域，尤其是外科手术这种决策主观且临床场景多变的干预性领域，VLMs展现出良好潜力。研究评估了11种先进VLM在17项外科AI任务(从解剖识别到技能评估)的表现，使用13个涵盖多种手术类型的数据集。结果表明，VLM具有良好的泛化能力，有时甚至优于监督模型；上下文学习可使性能提升三倍，但时空推理任务仍具挑战性。这些发现为VLM在临床及其他复杂动态场景的应用提供了重要见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T11:01:20Z
- **目录日期**: 2025-04-06
