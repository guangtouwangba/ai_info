...
大型视觉语言模型(VLMs)为AI驱动的图像理解提供了新范式，无需任务特定训练即可执行任务。在医学领域，尤其是外科手术这种决策主观且临床场景多变的干预性领域，VLMs展现出良好泛化能力，有时甚至超越监督模型。研究表明，上下文学习能使性能提升三倍，突显其适应能力优势。然而，需要时空推理的任务仍具挑战性。通过分析11个先进VLMs在17个外科AI任务(从解剖识别到技能评估)的表现，该研究不仅评估了VLMs在外科的应用潜力，也为临床及其他复杂动态场景的应用提供了重要见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T07:01:22Z
- **目录日期**: 2025-04-06
