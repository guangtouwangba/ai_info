...
大型视觉语言模型(VLM)为AI驱动的图像理解提供了新范式，无需针对特定任务进行训练即可执行任务。研究评估了11种先进VLM在17项外科AI视觉任务(从解剖识别到技能评估)中的表现，使用13个涵盖腹腔镜、机器人和开放手术的数据集。实验显示VLM展现出良好的泛化能力，有时在非训练环境下表现优于监督模型。上下文学习可将性能提升三倍，表明其适应能力突出。但需要空间或时间推理的任务仍具挑战性。该研究不仅对外科领域，更为VLM在复杂动态临床及现实场景中的应用提供了重要见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T04:01:36Z
- **目录日期**: 2025-04-06
