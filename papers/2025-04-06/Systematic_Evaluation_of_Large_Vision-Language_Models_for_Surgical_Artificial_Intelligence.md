...
大型视觉语言模型(VLMs)为AI驱动的图像理解提供了新范式，无需特定任务训练即可执行多种任务。在医学领域，尤其是专家标注数据稀缺的手术场景中，这类模型展现出应用潜力。研究评估了11种先进VLM在17项外科AI任务(从解剖识别到技能评估)的表现，使用13个涵盖多种手术方式的数据集。结果显示VLM具有良好的泛化能力，有时甚至优于监督模型。上下文学习能使性能提升三倍，但时空推理任务仍具挑战。该研究不仅揭示了VLM在手术领域的潜力，也为其他复杂动态场景的应用提供了参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T06:01:24Z
- **目录日期**: 2025-04-06
