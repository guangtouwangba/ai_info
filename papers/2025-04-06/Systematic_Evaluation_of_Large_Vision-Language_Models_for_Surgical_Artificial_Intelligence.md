...
大型视觉语言模型(VLMs)为AI驱动的图像理解提供了新范式，无需任务特定训练即可执行多种任务。在医学领域，尤其是专家标注数据稀缺的手术场景中，VLMs展现出应用潜力。研究评估了11种先进VLMs在17项外科AI任务(从解剖识别到技能评估)的表现，使用13个涵盖多种手术方式的数据集。结果显示VLMs具有良好的泛化能力，有时甚至优于监督模型。上下文学习可将性能提升三倍，但空间和时间推理任务仍具挑战性。该研究为VLMs在临床及其他动态复杂场景的应用提供了重要见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-06T17:01:26Z
- **目录日期**: 2025-04-06
