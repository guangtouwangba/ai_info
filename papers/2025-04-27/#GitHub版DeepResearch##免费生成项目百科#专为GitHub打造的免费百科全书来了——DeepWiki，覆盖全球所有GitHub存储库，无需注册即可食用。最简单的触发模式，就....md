...
DeepWiki是由Cognition推出的免费GitHub项目百科工具，用户只需将GitHub链接中的"github"改为"deepwiki"即可自动生成项目专属百科页面。该工具提供可视化架构图、模块化内容展示和问答功能，已索引3万个存储库、40亿行代码。其特色是通过分层结构理解代码库，显著提升开发者查阅效率。目前支持链接修改和搜索两种使用方式，所有功能免费开放，但因访问量过大曾导致服务器崩溃。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T01:30:25Z
- **目录日期**: 2025-04-27
