...
DeepWiki是一个专为GitHub项目打造的免费AI百科工具，由开发Devin的Cognition团队推出。用户只需将GitHub链接中的"github"改为"deepwiki"即可自动生成项目百科页面，包含可视化架构图、训练流程等模块化内容，并支持AI问答功能。该系统已索引3万个存储库，处理40多亿行代码，采用分层结构理解代码库，显著提升开发者的项目理解效率。目前提供链接修改和搜索两种使用方式，完全免费开放。由于访问量过大，团队正在扩容服务器。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T04:04:37Z
- **目录日期**: 2025-04-27
