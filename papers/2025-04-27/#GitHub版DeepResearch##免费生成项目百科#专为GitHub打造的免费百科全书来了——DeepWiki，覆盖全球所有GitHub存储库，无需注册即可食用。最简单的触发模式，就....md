...
DeepWiki是由Cognition推出的免费GitHub项目百科全书，用户只需将GitHub链接中的"github"改为"deepwiki"即可自动生成项目百科页面。该系统已索引3万个存储库，处理40亿行代码，提供可视化架构图、结构化项目解析和AI问答功能。采用分层代码理解技术，显著提升开发者查阅效率。目前完全免费开放，但因访问量过大曾导致服务器崩溃。该功能源自Devin 2.0的Wiki模块，现作为独立服务推出，支持链接转换和专用搜索两种使用方式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T00:03:02Z
- **目录日期**: 2025-04-27
