...
上海AI实验室推出开源框架GraphGen，通过"知识图谱引导+双模型协同"机制解决垂直领域大模型训练中高质量问答数据稀缺的痛点。该工具允许用户上传专业文本(如海事知识)，自动生成适配LLaMA-Factory等框架的训练数据，无需人工标注即可用于SFT训练。目前已上线OpenXLab平台，提供Web应用和GitHub开源代码，支持快速配置试用，显著提升垂域模型的专业理解能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T00:02:53Z
- **目录日期**: 2025-04-27
