...
PaperCoder是一款多智能体系统，可将机器学习论文自动转换为可执行代码库。它通过三阶段流程实现：1) Planning阶段制定开发路线图并生成系统架构；2) Analyzing阶段深入分析各模块功能与依赖关系；3) Coding阶段按规划生成代码。在基准测试中，其代码改动率仅0.48%，77%的原作者更偏好其生成结果。该工具显著提升研究复现效率，目前专注机器学习领域，未来计划扩展至物理、生物等学科。测试显示它是当前最接近"一键复现"的解决方案。项目已在GitHub开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T21:04:01Z
- **目录日期**: 2025-04-27
