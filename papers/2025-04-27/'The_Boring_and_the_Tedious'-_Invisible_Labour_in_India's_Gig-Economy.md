...
印度食品配送平台（如Swiggy和Zomato）为边缘群体提供重要收入，但也使劳动者陷入隐形劳动循环。通过14次半结构化访谈，研究发现等待时间和重复性UI交互是造成劳动者"数字不适"的主要负担。尽管劳动者会采取创造性策略应对算法管理，但仍受平台"游戏化"设计和系统不透明性限制。研究建议采用以劳动者为中心的GUI自动化来减少摩擦并保持自主权。该立场文件主张在"全球南方"的HCI研究中，应优先考虑劳动者自主权而非效率驱动的设计优化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T16:01:41Z
- **目录日期**: 2025-04-27
