...
本研究提出了一种新型集成贝叶斯推理方法(EBI)，通过贝叶斯估计整合多个小型语言模型(SLM)的预测结果，使其性能超越单个模型限制。实验表明，即使在加入负提升值模型的情况下，EBI方法在日英双语的能力评估和用户画像分析等任务中仍能提升整体表现。这一发现为在有限计算资源下构建高性能AI系统提供了新思路，同时为有效利用性能较弱的单个模型开辟了途径。该研究基于现有的大模型评估、集成方法和开源模型应用研究，提出了具有创新意义的解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T06:01:42Z
- **目录日期**: 2025-04-27
