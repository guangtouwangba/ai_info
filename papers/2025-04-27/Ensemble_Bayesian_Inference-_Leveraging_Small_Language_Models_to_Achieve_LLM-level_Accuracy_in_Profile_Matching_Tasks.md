...
本研究提出了一种新型集成贝叶斯推理方法（EBI），通过贝叶斯估计整合多个小型语言模型（SLM）的预测结果，使其性能超越单个模型限制。实验证明，EBI在多种任务（包括日英双语能力评估和消费者画像分析）中表现优异，甚至整合某些负提升值模型也能提高整体性能。该方法为在有限计算资源下构建高性能AI系统提供了新思路，同时展示了如何有效利用性能较弱的独立模型。研究基于现有的大模型评估、集成方法和开源模型应用成果，拓展了资源受限环境下的高效AI解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T11:01:53Z
- **目录日期**: 2025-04-27
