...
本研究提出了一种名为"集成贝叶斯推理(EBI)"的新方法，通过贝叶斯估计整合多个小型语言模型(SLM)的判断，使其性能超越单个模型。实验表明，即使在包含负提升值模型的情况下，EBI仍能提升整体表现，且在多语言任务(如日英双语的能力评估和消费者分析)中均有效。这一发现为在有限计算资源下构建高性能AI系统提供了新思路，同时表明可以更有效地利用性能较低的单体模型。该方法建立在现有LLM评估、集成方法和开源模型研究基础上，具有重要的创新意义。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T10:01:37Z
- **目录日期**: 2025-04-27
