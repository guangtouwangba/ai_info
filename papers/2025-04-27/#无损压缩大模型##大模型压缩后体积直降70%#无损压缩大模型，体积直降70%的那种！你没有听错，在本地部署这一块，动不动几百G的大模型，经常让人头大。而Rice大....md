...
Rice大学和xMAD.ai团队开发了DFloat11无损压缩框架，可将大模型体积减少70%且保持精度无损。以Llama-3.1-405B为例，模型从811.7GB压缩至551.22GB，仅需8张80GB GPU即可运行。该技术通过挖掘BFloat16的压缩潜力、动态长度编码和GPU优化设计，使推理速度提升最高38.8倍。相比传统压缩方法，DFloat11专为高效推理设计，支持快速解压和高吞吐量。代码已开源，适用于本地大模型部署场景。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T15:03:08Z
- **目录日期**: 2025-04-27
