...
Rice大学和xMAD.ai团队开发了DFloat11无损压缩框架，可将大模型体积减少70%且保持精度无损。以Llama-3.1-405B为例，模型从811.7GB压缩至551.22GB，仅需8张80GB GPU即可运行，推理速度提升最高38.8倍。其核心技术包括：利用BFloat16的稀疏特性、动态长度编码优化，以及专为GPU设计的并行解压方案。相比传统压缩方法，DFloat11在保持高压缩率的同时实现了高效的推理部署。代码已开源（GitHub/arXiv），显著降低了大模型本地部署的门槛。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T10:02:56Z
- **目录日期**: 2025-04-27
