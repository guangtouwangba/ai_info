...
Rice大学和xMAD.ai团队开发的DFloat11框架实现了大模型无损压缩，可将模型体积减少70%。以Llama-3.1-405B为例，模型从811.7GB压缩至551.22GB，仅需8张80GB GPU即可运行。该技术通过挖掘BFloat16的压缩潜力、动态长度编码和GPU优化设计，在保持精度不变的同时，推理速度提升最高达38.8倍。相比传统压缩方法，DFloat11专为高效推理设计，支持快速解压和部署。相关代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T14:02:57Z
- **目录日期**: 2025-04-27
