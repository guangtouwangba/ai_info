...
莱斯大学和xMAD.ai团队开发的DFloat11框架实现了大模型无损压缩，可将模型体积减少70%且保持精度不变。例如，Llama-3.1-405B模型从811.7GB压缩到551.22GB，仅需8张80GB GPU即可运行。该技术通过挖掘BFloat16数据稀疏性、动态长度编码和GPU优化设计，使推理速度提升最高38.8倍。相比传统压缩方法，DFloat11专为高效推理设计，采用查找表、并行解压等技术，实现部署友好。代码已开源，为本地部署大模型提供了高效解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T13:08:22Z
- **目录日期**: 2025-04-27
