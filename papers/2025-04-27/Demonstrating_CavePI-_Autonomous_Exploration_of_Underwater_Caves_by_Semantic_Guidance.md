...
本文介绍了用于水下洞穴自主探索的视觉伺服系统CavePI，该系统通过轻量级深度视觉感知模块实现环境语义理解，并结合鲁棒控制机制在复杂洞穴结构中导航。研究展示了硬件与边缘AI设计，并在真实水下洞穴和模拟环境中验证了性能。该系统在缺乏GPS、特征稀少及低能见度的条件下仍能可靠导航，适用于水资源管理、考古和海洋机器人等领域。实验证明，集成设计有效支持了自主水下机器人在挑战性环境中的探索与测绘能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T11:02:28Z
- **目录日期**: 2025-04-27
