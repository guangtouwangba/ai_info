...
本文介绍了CavePI自主水下机器人系统，用于水下洞穴探索。该系统整合了视觉伺服框架与轻量级深度视觉感知模块，能在特征匮乏、无GPS且低能见度的环境中实现语义引导导航。通过硬件与边缘AI设计，CavePI可识别环境语义特征并执行稳健控制，在复杂洞穴结构中自主移动。研究通过实地水下洞穴测试和ROS数字孪生仿真验证了系统性能。该技术对水资源管理、水文地质学和考古学等领域具有重要意义，展示了在极端条件下实现可靠自主导航的集成设计方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T09:02:19Z
- **目录日期**: 2025-04-27
