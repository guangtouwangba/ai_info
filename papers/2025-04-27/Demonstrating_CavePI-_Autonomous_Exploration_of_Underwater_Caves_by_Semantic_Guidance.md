...
本文介绍了用于水下洞穴自主探索的视觉伺服系统CavePI，集成了轻量级深度视觉感知模块和鲁棒控制机制，可在GPS失效、特征匮乏的低能见度环境中实现语义引导导航。该系统通过硬件设计和边缘AI优化，支持复杂洞穴结构的语义识别与路径跟踪。研究通过真实水下洞穴实地测试及ROS数字孪生仿真验证了其可靠性，为水资源管理、考古等领域的自主水下探测提供了新方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T00:02:30Z
- **目录日期**: 2025-04-27
