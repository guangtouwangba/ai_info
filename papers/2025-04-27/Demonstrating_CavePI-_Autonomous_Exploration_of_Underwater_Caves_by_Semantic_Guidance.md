...
本文介绍了CavePI自主水下机器人（AUV）的系统设计与算法集成，用于水下洞穴的语义引导探索。该系统采用轻量化但鲁棒的深度视觉感知模块，实现对环境的语义理解，并通过控制机制在复杂洞穴结构中导航。研究通过自然水下洞穴和泉水的实地实验，以及基于ROS的数字孪生仿真验证了系统性能。结果表明，该集成设计能在缺乏特征、无GPS信号和低能见度条件下实现可靠导航，对水资源管理、水文地质学、考古学和海洋机器人学具有重要意义。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T21:02:16Z
- **目录日期**: 2025-04-27
