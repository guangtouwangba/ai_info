...
本文介绍了CavePI自主水下机器人的系统设计与算法集成，用于水下洞穴的语义引导探索。该系统采用轻量级深度视觉感知模块，在特征匮乏、GPS缺失及低能见度条件下实现环境语义理解，并通过鲁棒控制机制完成复杂洞穴导航。研究通过真实水下洞穴实验和ROS数字孪生仿真验证了系统有效性。该技术在水资源管理、水文地质学、考古学等领域具有重要应用价值，解决了水下自主导航的关键挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T08:02:14Z
- **目录日期**: 2025-04-27
