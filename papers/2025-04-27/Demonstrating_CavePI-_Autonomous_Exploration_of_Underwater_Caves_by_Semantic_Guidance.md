...
本研究提出了一种基于视觉伺服框架的自主水下洞穴探索系统，集成于新型AUV CavePI中。该系统采用轻量级深度视觉感知模块实现环境语义理解，并通过鲁棒控制机制引导AUV在复杂洞穴结构中导航。研究通过真实水下洞穴和泉水的现场实验，以及基于ROS的数字孪生仿真验证了系统性能。结果表明，该集成设计方案能在缺乏特征、无GPS信号和低能见度的条件下实现可靠导航，对水资源管理、水文地质学、考古学和海洋机器人学具有重要意义。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T06:02:43Z
- **目录日期**: 2025-04-27
