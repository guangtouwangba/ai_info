...
本文介绍了用于水下洞穴自主探索的视觉伺服系统CavePI，集成了轻量级深度视觉感知模块和鲁棒控制机制，可在GPS失效、特征匮乏的低能见度环境中实现语义引导导航。该系统通过硬件和边缘AI设计，支持复杂洞穴结构的自主探索与建图，在水资源管理、考古等领域具有重要应用价值。研究通过真实水下洞穴和泉水的实地测试，并结合ROS数字孪生仿真验证，证明了该集成设计方案在恶劣环境下的可靠导航能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T12:02:28Z
- **目录日期**: 2025-04-27
