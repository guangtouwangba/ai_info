...
本文介绍了CavePI水下自主机器人系统的设计与算法集成，用于水下洞穴的语义引导探索。该系统采用轻量级深度视觉感知模块实现环境语义理解，并结合鲁棒控制机制在复杂洞穴结构中导航。研究通过实地水下洞穴测试和ROS数字孪生仿真验证了系统性能。结果表明，该集成设计能在特征缺失、GPS拒止及低能见度条件下实现可靠导航，对水资源管理、水文地质学、考古学等领域具有重要意义。硬件与边缘AI的协同设计使CavePI成为首个实现语义引导水下洞穴探索的自主潜航器。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T07:02:19Z
- **目录日期**: 2025-04-27
