...
Rice大学与xMAD.ai团队推出DFloat11无损压缩框架，可将大模型体积压缩至原70%且精度无损。以Llama-3.1-405B为例，模型从811.7GB降至551.22GB，仅需8张80GB GPU即可运行。该技术通过挖掘BFloat16数据稀疏性（仅用2.6位指数信息）、动态长度编码及GPU优化设计（查找表/并行解压），使推理速度最高提升38.8倍。相比传统压缩，DFloat11专为推理部署优化，实现高效实时解压。代码已开源，适用于本地大模型部署场景。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T20:03:22Z
- **目录日期**: 2025-04-27
