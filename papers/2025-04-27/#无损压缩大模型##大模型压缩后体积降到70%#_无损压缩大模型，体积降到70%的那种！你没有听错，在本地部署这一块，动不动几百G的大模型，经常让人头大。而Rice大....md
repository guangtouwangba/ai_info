...
Rice大学和xMAD.ai团队开发了DFloat11无损压缩框架，可将大模型体积压缩至70%且保持精度无损。以Llama-3.1-405B为例，模型从811.7GB缩减到551.22GB，8张80GB GPU即可运行，推理速度提升最高38.8倍。核心技术包括：利用BFloat16指数稀疏特性（仅用2.6位）、动态长度编码优化存储，以及专为GPU设计的查找表、并行解压等部署优化。相比传统压缩，DFloat11实现了推理时高效解压，代码已开源。论文和GitHub链接见原文。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T23:03:04Z
- **目录日期**: 2025-04-27
