...
Rice大学和xMAD.ai团队开发了DFloat11无损压缩框架，可将大模型体积缩减至70%且保持精度无损。例如，Llama-3.1-405B模型从811.7GB压缩至551.22GB，仅需8张80GB GPU即可运行。该技术通过挖掘BFloat16的数据稀疏性（仅用2.6位指数信息）、动态长度编码和GPU优化设计（查找表、并行解压等），使推理速度提升最高38.8倍。相比传统压缩，DFloat11专为高效推理设计，显著降低CPU-GPU数据传输开销。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T16:03:09Z
- **目录日期**: 2025-04-27
