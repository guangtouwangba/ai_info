...
本文提出EgoCHARM算法，用于智能眼镜上基于单惯性测量单元(IMU)的高效人类活动识别。该分层算法采用半监督学习策略，主要利用高级活动标签训练，学习可推广的低级运动嵌入特征。实验在9种高级和3种低级活动上分别获得0.826和0.855的F1分数，模型参数仅63k(高级)和22k(低级)，可直接部署于现有IMU芯片。研究还分析了基于第一视角IMU的活动识别的优势与局限，为资源(内存、计算、功耗、样本)受限场景提供了高效解决方案，适用于健康监测和情境感知AI助手等应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T04:01:28Z
- **目录日期**: 2025-04-27
