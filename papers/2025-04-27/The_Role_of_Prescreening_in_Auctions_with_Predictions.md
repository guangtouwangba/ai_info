...
本文探讨了拍卖中通过预筛选（prescreening）策略选择高价值竞标者的经济合理性。研究表明，基于噪声预测器的预筛选相当于标准拍卖中竞标者估值存在相关性，但传统关联性假设不成立。作者分析了全支付、第一价格和第二价格拍卖的均衡策略条件，发现：在全支付拍卖中，预筛选能显著提高收入（完美预测时仅需两名竞标者即可实现最优）；而在第一价格和第二价格拍卖中，允许所有竞标者参与仍是收益最大化的选择。这为拍卖设计者提供了基于AI预测工具的策略优化依据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T17:02:14Z
- **目录日期**: 2025-04-27
