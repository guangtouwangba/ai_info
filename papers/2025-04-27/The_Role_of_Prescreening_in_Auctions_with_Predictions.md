...
本文构建了一个理论模型，研究拍卖方利用机器学习预筛选竞拍者的经济合理性。模型假设竞拍者具有独立同分布的私人估值，拍卖方通过有噪声的估值预测器筛选竞拍者数量。研究发现：预筛选拍卖等价于估值相关的标准拍卖，但不符合传统的关联性假设。研究证明了三种经典拍卖形式（全支付、第一价格、第二价格）中存在对称严格单调均衡策略的条件。关键结论显示：全支付拍卖中预筛选能显著提升收益（完美预测时仅需2名竞拍者），而第一/第二价格拍卖仍需允许所有竞拍者参与才能实现收益最大化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T13:07:34Z
- **目录日期**: 2025-04-27
