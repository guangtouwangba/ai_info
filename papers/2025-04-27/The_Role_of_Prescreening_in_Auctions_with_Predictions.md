...
拍卖行常采用封闭拍卖制造稀缺性和提升声望，以激发高价值竞标者间的竞争。本研究通过理论模型分析，在竞标者估值独立同分布且拍卖方拥有噪声预测信号的设定下，探讨预筛选竞标者数量的经济合理性。研究发现：预筛选拍卖等价于估值相关的标准拍卖，但不符合传统关联性假设。研究推导了全支付、第一价格和第二价格拍卖中对称严格单调均衡策略的存在条件。关键结论显示，预筛选能显著提升全支付拍卖收益（完美预测时仅需两名竞标者），但对第一/第二价格拍卖而言，允许所有竞标者参与仍是最优策略。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T16:02:20Z
- **目录日期**: 2025-04-27
