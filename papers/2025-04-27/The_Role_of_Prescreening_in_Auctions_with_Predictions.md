...
本文通过理论模型分析了拍卖行利用机器学习筛选竞拍者（预筛选）的经济合理性。研究发现，预筛选拍卖等价于竞拍者估值相关的标准拍卖，但传统关联性假设不成立。研究比较了全支付、第一价格和第二价格拍卖的均衡条件，发现：在全支付拍卖中，预筛选能显著提升收益（完美预测时仅需2名竞拍者即可实现最优）；而在第一价格和第二价格拍卖中，允许所有竞拍者参与仍是收益最大化的选择。这表明拍卖形式对预筛选策略的有效性具有决定性影响。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T05:02:15Z
- **目录日期**: 2025-04-27
