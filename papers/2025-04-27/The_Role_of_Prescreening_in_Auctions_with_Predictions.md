...
本文通过理论模型分析了拍卖中"预筛选"策略的经济合理性。研究发现，基于AI预测的竞拍者筛选机制等同于标准拍卖中的估值关联模型，但不符合传统关联性假设。研究比较了全支付、第一价格和第二价格三种拍卖形式，发现：在全支付拍卖中，预筛选能显著提高收益（完美预测时仅需2名竞拍者即可实现最优）；而在第一价格和第二价格拍卖中，允许所有竞拍者参与仍是收益最大化的选择。该研究为拍卖设计中的选择性准入策略提供了理论依据，揭示了不同拍卖形式下预筛选策略的差异化效果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T03:17:55Z
- **目录日期**: 2025-04-27
