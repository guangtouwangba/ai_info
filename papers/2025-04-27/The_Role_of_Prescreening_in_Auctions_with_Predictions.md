...
本文通过理论模型分析了拍卖行利用机器学习/AI筛选竞拍者（预筛选）的经济合理性。研究发现：1) 预筛选拍卖等同于标准拍卖中竞标者估值存在相关性，但这种相关性不符合传统关联性假设；2) 在全支付拍卖中，预筛选能显著提升收益（完美预测时仅需2名竞标者即可实现最优收益）；3) 在一价和二价拍卖中，允许所有竞标者参与仍是收益最大化的最优策略。研究揭示了不同拍卖形式下预筛选策略的差异化效果，为拍卖设计提供了理论依据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T19:02:05Z
- **目录日期**: 2025-04-27
