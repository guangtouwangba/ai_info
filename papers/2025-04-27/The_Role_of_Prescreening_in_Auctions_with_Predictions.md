...
本文通过理论模型分析了拍卖行利用机器学习筛选竞拍者（预筛选）的经济合理性。研究发现：1）预筛选拍卖相当于标准拍卖中竞拍者估值存在相关性，但不符合传统关联性假设；2）在全支付拍卖中，预筛选能显著提高收益，完美预测时仅允许2人竞拍最优；3）在一价和二价拍卖中，允许所有竞拍者仍是最佳策略。研究揭示了不同拍卖形式下预筛选策略的差异化效果，为拍卖设计提供了理论依据。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T15:02:18Z
- **目录日期**: 2025-04-27
