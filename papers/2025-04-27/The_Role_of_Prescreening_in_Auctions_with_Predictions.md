...
本文通过理论模型研究了拍卖中预筛选策略的经济合理性。研究发现，基于噪声预测器的预筛选拍卖等同于标准拍卖中竞标者估值相关的情况，但传统关联性假设在此不成立。研究分析了全支付、第一价格和第二价格拍卖的均衡策略条件，结果表明：在全支付拍卖中，预筛选能显著提高收益，完美预测器下仅允许两名竞标者最优；而在第一价格和第二价格拍卖中，允许所有竞标者仍能实现收益最大化。这为拍卖设计者利用AI技术优化竞标者筛选提供了理论依据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T12:02:18Z
- **目录日期**: 2025-04-27
