...
本文通过理论模型研究了拍卖中预筛选策略的经济合理性。研究发现，基于噪声预测器的预筛选拍卖等同于标准拍卖中竞标者估值相关的情况，但传统关联性假设不成立。研究比较了全支付、第一价格和第二价格拍卖的均衡策略条件，发现：全支付拍卖中预筛选能显著提高收益（完美预测时仅需2名竞标者即可最优），而第一和第二价格拍卖中允许所有竞标者参与仍是收益最大化的选择。这表明AI驱动的预筛选策略在不同拍卖形式中具有差异化效果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T09:02:09Z
- **目录日期**: 2025-04-27
