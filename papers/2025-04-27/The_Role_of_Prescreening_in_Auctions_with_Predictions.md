...
本文通过理论模型分析了拍卖中预筛选策略的经济合理性。研究发现，基于噪声预测器的预筛选拍卖等同于标准拍卖中竞标者估值相关的情形，但传统关联性假设在此不成立。研究比较了全支付、第一价格和第二价格拍卖的均衡策略条件，发现预筛选能显著提高全支付拍卖的收益（完美预测时仅需2名竞标者即可实现最优收益），但对第一价格和第二价格拍卖而言，允许所有竞标者参与仍是收益最大化的选择。这表明拍卖形式对预筛选策略的效果具有决定性影响。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T11:02:20Z
- **目录日期**: 2025-04-27
