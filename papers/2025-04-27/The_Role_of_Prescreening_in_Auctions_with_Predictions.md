...
本文探讨了拍卖行利用封闭拍卖（筛选竞拍者）来制造稀缺性和提升声望的经济合理性。研究建立了一个理论模型，分析竞拍者具有独立同分布私人估值时，拍卖设计者如何基于估值噪声预测器筛选竞拍者（预筛选）。结果表明：预筛选拍卖等价于估值相关的标准拍卖，但传统关联性假设不成立。研究证明了全支付、第一价格和第二价格拍卖中存在对称严格单调均衡策略的条件。关键发现：全支付拍卖中预筛选能显著提高收益（完美预测时仅需2名竞拍者），而第一/第二价格拍卖仍需全员参与才能收益最大化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T06:02:20Z
- **目录日期**: 2025-04-27
