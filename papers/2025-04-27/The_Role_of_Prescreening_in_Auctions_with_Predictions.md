...
本文通过理论模型分析了拍卖中预筛选策略的经济合理性。研究发现，基于估值噪声预测的预筛选机制相当于使竞标者估值产生相关性，但不符合传统关联性假设。研究比较了全支付、第一价格和第二价格拍卖中的均衡策略条件，发现预筛选能显著提升全支付拍卖收益（完美预测时仅需两名竞标者即可实现最优），但在第一/第二价格拍卖中，接纳所有竞标者仍是收益最大化的选择。这表明AI驱动的精准预筛选能有效创造稀缺性，但其收益效果高度依赖于拍卖机制类型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T10:02:07Z
- **目录日期**: 2025-04-27
