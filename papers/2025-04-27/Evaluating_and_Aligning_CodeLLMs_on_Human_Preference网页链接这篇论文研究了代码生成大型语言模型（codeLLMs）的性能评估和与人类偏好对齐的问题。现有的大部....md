...
这篇论文针对代码生成大型语言模型(codeLLMs)与人类偏好对齐的问题，提出了CodeArena基准测试和SynCode-Instruct合成指令数据集。CodeArena包含397个高质量样本，覆盖40个类别和44种编程语言，更贴近实际编程需求。研究发现在执行基准和人类偏好评估间存在性能差异，开源模型(如Qwen2.5-Coder)与专有模型(如OpenAI o1)差距明显。通过近200亿标记的合成指令微调实验，验证了大规模指令数据对提升模型性能的有效性，强调了代码LLMs与人类偏好对齐的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T08:05:33Z
- **目录日期**: 2025-04-27
