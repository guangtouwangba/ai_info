...
这篇论文针对代码生成大模型(codeLLMs)与人类偏好对齐的问题，提出了CodeArena基准测试和SynCode-Instruct合成指令数据集。CodeArena包含397个高质量编程任务样本，覆盖40类任务和44种语言，更贴近实际开发需求。研究显示传统基于执行的评估与人类偏好存在差距，并发现开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著。通过构建近200亿标记的SynCode-Instruct数据集，验证了大规模合成指令微调的有效性，强调了代码生成模型与人类偏好对齐的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T22:05:53Z
- **目录日期**: 2025-04-27
