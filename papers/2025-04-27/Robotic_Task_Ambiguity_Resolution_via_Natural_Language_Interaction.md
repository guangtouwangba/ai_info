...
本文提出AmbResVLM方法，用于解决机器人语言条件策略中的任务描述模糊性问题。该方法通过将语言目标与场景关联并显式推理任务歧义，显著提升了任务模糊性的检测与解决能力。实验表明，相比现有最优方法，AmbResVLM在仿真和真实场景中均表现优异，成功将下游机器人策略的平均成功率从69.6%提升至97.1%。相关数据、代码和训练模型已开源。该研究为提升语言条件策略的可靠性提供了有效解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T03:16:33Z
- **目录日期**: 2025-04-27
