...
AmbResVLM是一种新型方法，用于解决语言条件策略中的任务描述模糊性问题。它通过将语言目标与场景结合并显式推理任务歧义，显著提升了机器人对模糊指令的检测和解决能力。实验表明，该方法在模拟和真实环境中均优于现有技术，将下游机器人策略的成功率从69.6%提升至97.1%。相关数据、代码和训练模型已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T08:01:00Z
- **目录日期**: 2025-04-27
