...
AmbResVLM是一种新型方法，旨在解决语言条件策略中任务描述模糊导致的机器人执行失败问题。该方法通过将语言目标与场景关联并显式推理任务歧义，显著提升了任务模糊性的检测与解决能力。实验表明，在模拟和真实环境中，AmbResVLM均优于现有最优基线，并将下游机器人策略的平均成功率从69.6%提升至97.1%。相关数据、代码和训练模型已公开。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T05:01:14Z
- **目录日期**: 2025-04-27
