...
AmbResVLM是一种新型方法，用于解决语言条件策略中的任务描述模糊性问题。该方法通过将语言目标与观察场景关联，并显式推理任务歧义，显著提升了机器人对模糊指令的处理能力。在仿真和真实场景中的测试表明，AmbResVLM在任务歧义检测和解决方面优于现有最优基线。真实机器人实验显示，该方法将下游策略的平均成功率从69.6%提升至97.1%。相关数据、代码和训练模型已开源。该研究为提升语言条件策略的可靠性提供了有效解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T04:01:13Z
- **目录日期**: 2025-04-27
