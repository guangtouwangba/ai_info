...
AmbResVLM是一种新型方法，用于解决机器人语言条件策略中的任务描述模糊性问题。该方法通过将语言目标与场景关联并显式推理任务歧义，显著提升了模糊任务的检测与解决能力。实验表明，在仿真和真实环境中，AmbResVLM的性能均优于现有最优基线，并将下游机器人策略的成功率从69.6%提升至97.1%。相关数据、代码和训练模型已开源。该研究为语言条件策略的可靠性提供了重要改进。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T10:00:57Z
- **目录日期**: 2025-04-27
