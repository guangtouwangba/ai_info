...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献搜索，能自动生成摘要和问答互动，帮助用户快速理解内容。平台还具备文献翻译、文档识别和辅助阅读功能，用户可上传PDF或从库中选取论文进行AI解析。AMiner提供科研情报订阅服务，根据用户偏好推送最新学术动态。此外，它还包含学者画像、学术会议和论文排行榜等功能。平台收录了3.5亿论文、0.6亿学者等海量数据，基础功能可免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T22:05:43Z
- **目录日期**: 2025-04-27
