...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索（覆盖42个学科3.5亿论文）、AI辅助阅读（自动生成摘要、章节概要和问答互动）、英文文献翻译及科研情报订阅（定制化推送最新研究动态）。用户可通过关键词、学者或机构订阅内容，并通过微信或邮件接收。平台还支持学者画像、学术会议追踪和论文排行榜功能，基础检索服务免费开放。其AI工具能显著提升文献筛选、理解和写作效率。访问入口：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T06:06:11Z
- **目录日期**: 2025-04-27
