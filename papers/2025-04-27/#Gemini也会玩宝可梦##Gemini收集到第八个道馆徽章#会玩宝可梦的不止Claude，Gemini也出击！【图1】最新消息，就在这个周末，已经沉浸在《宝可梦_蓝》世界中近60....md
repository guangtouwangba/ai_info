...
Gemini AI成功挑战《宝可梦蓝》游戏，在600小时的游戏时间内收集到第八个道馆徽章，即将挑战四天王。该项目由一位工程师开发，通过mGBA模拟器建立游戏接口，让Gemini能获取游戏截图和状态数据，经网格处理后做出决策并执行按键操作。系统每100次动作会摘要消息以减少token消耗。该实验灵感来自此前Claude玩宝可梦的项目，现可通过Twitch直播观看AI对战过程。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T19:02:28Z
- **目录日期**: 2025-04-27
