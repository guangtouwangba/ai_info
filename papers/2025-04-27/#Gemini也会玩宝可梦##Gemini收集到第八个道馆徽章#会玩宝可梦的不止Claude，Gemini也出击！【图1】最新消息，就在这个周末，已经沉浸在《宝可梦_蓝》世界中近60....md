...
Gemini AI成功在《宝可梦蓝》中收集到第八个道馆徽章，游戏时长近600小时。一名工程师通过mGBA模拟器建立游戏接口，让Gemini 2.5 Pro能截取画面、发送指令并分析游戏状态，形成决策循环系统。该系统每100次动作会摘要信息以减少token消耗。该项目灵感来自Claude玩宝可梦的尝试，现正直播挑战四天王。网友称赞这是AI的重大成就，展现了AI在复杂游戏中的学习能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T11:02:47Z
- **目录日期**: 2025-04-27
