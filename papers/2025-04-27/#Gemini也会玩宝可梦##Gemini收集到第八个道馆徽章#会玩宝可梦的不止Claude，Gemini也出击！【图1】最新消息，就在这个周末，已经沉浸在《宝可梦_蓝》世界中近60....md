...
谷歌AI Gemini 2.5 Pro成功在《宝可梦 蓝》中收集到第八个道馆徽章，已游戏近600小时。该实验由工程师通过mGBA模拟器实现，系统会截取游戏画面并叠加网格辅助AI决策，每100次动作进行记忆摘要以节省资源。此前Claude AI也有类似挑战，现可通过Twitch直播观看Gemini挑战四天王。该项目展示了AI通过视觉和状态数据玩经典游戏的能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T18:02:27Z
- **目录日期**: 2025-04-27
