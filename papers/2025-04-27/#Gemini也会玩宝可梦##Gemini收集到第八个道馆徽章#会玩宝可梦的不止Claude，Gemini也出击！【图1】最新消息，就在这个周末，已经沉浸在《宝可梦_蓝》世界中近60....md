...
谷歌AI模型Gemini 2.5 Pro成功在《宝可梦蓝》游戏中收集到第八个道馆徽章，耗时近600小时。该项目由工程师通过mGBA模拟器实现，系统会截取游戏画面并叠加网格辅助分析，将数据发送给AI决策，再执行按键操作。为节省资源，每100次动作后会进行消息摘要处理。该实验灵感来自此前Claude玩宝可梦的项目，现可通过Twitch直播观看AI挑战四天王。网友戏称这是"AI迄今最大成就"，展现了AI在复杂游戏中的学习能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T20:03:00Z
- **目录日期**: 2025-04-27
