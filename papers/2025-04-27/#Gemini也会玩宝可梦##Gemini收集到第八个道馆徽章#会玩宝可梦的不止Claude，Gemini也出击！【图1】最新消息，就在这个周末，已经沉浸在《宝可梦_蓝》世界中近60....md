...
Gemini 2.5 Pro AI成功在《宝可梦蓝》中收集到第八个道馆徽章，耗时近600小时。工程师通过mGBA模拟器建立游戏接口，让AI能获取游戏截图和状态数据，经网格处理后做出决策，循环执行按键操作。系统每100次动作会摘要消息以减少token消耗。该项目灵感来自Claude玩宝可梦的尝试，现可通过Twitch直播观看AI挑战四天王。网友称赞这是AI的重大成就。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T23:02:44Z
- **目录日期**: 2025-04-27
