...
Gemini AI成功挑战《宝可梦蓝》游戏，在600小时游戏时长后收集到第八个道馆徽章，即将挑战四天王。该实验由一位软件工程师设计，通过mGBA模拟器建立游戏接口，让Gemini 2.5 Pro能获取游戏截图和状态数据，经网格处理后由AI决策操作。系统采用循环流程：截图→分析→执行→更新，并每100次动作进行内存摘要优化。该项目灵感来自此前Claude玩宝可梦的尝试，现可通过Twitch直播观看AI训练家的冒险。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T16:02:49Z
- **目录日期**: 2025-04-27
