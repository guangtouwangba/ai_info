...
百度推出全新"心响App"，这是一款现货超级智能体应用，由95后团队30天快速开发完成。该应用突破传统AI助手一问一答模式，提供一站式解决方案，支持200多种任务类型，涵盖工作、学习、生活等多个场景。特色功能包括：根据简短提示生成完整减脂计划（含饮食、运动、行为建议），支持设置例行任务每日提醒；还提供AI相亲等情感服务。目前已上线安卓应用商店，无需邀请码即可使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T02:32:56Z
- **目录日期**: 2025-04-27
