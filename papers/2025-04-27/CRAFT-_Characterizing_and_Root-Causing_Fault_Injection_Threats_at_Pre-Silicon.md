...
本文提出了一种在芯片设计前阶段进行可控故障注入攻击的综合方法，重点分析了RISC-V指令集和流水线阶段的故障影响。研究以AI/ML应用中的时钟毛刺攻击为案例，揭示了两种新漏洞：一是通过指令跳过阻止关键内存值加载，破坏程序连续性；二是将合法指令转为非法指令以劫持控制流。该工作强调了从电路层到软件层的故障传播机制，凸显了先发制人的安全分析对保护网络基础设施的重要性。研究成果为理解多抽象层故障注入攻击提供了系统性方法，有助于发现嵌入式系统潜在安全威胁。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T10:01:56Z
- **目录日期**: 2025-04-27
