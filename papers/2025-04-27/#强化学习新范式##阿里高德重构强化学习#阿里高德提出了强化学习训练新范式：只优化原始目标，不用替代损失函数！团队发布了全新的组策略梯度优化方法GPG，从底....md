...
阿里高德提出强化学习新范式GPG，直接优化原始目标而无需替代损失函数。该方法创新性地移除了评论模型和参考模型，通过组内平均奖励归一化降低方差，并引入动态梯度校正机制解决样本偏差问题。GPG在数学推理和视觉理解等复杂任务中展现出优异性能，训练架构更简洁高效，突破了传统强化学习的效率瓶颈。该框架在单模态和多模态任务中均表现突出，具有高通用性和鲁棒性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T01:31:06Z
- **目录日期**: 2025-04-27
