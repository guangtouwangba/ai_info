...
阿里高德提出强化学习新范式GPG，直接优化原始目标而无需替代损失函数。该方法突破传统框架，消除评论模型和KL约束，首创精准梯度估计(AGE)技术降低奖励偏差。通过组内奖励归一化和动态梯度校正，显著提升训练效率和稳定性。在数学推理、视觉理解等复杂任务中表现优异，展现出强大的通用性和鲁棒性。这一创新为强化学习训练流程带来根本性变革。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T00:03:43Z
- **目录日期**: 2025-04-27
