...
深度学习专家Hugo Larochelle宣布从谷歌DeepMind离职。他作为蒙特利尔团队首席科学家，曾建立当地首个大型AI实验室，并专注于自然语言处理、计算机视觉等领域的研究，包括自编码器、零样本学习等方向。Larochelle学术影响力显著，论文被引超9.3万次，还制作过知名开源深度学习课程。此前他联合创办的Whetlab被Twitter收购。未来他计划激活本地AI人才生态，但未透露具体去向。该消息引发业界广泛关注与祝福。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T10:03:28Z
- **目录日期**: 2025-04-27
