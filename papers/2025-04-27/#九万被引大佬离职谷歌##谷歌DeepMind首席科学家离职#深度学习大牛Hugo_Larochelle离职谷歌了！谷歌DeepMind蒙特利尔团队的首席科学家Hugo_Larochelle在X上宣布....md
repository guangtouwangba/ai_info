...
深度学习专家Hugo Larochelle宣布从谷歌DeepMind离职。他作为蒙特利尔团队首席科学家，八年间建立了该地区首个大型AI实验室，此前曾创立机器学习公司Whetlab（后被Twitter收购）。其研究涵盖自编码器预训练、零样本学习等领域，学术引用超9.3万次，并制作过知名开源深度学习课程。离职后计划激活本地AI人才生态，但未透露具体去向。该消息引发业界广泛祝福。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T16:03:37Z
- **目录日期**: 2025-04-27
