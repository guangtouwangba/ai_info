...
深度学习专家Hugo Larochelle宣布从谷歌DeepMind离职。他作为蒙特利尔团队首席科学家，曾建立该地区首个大型AI实验室，并专注于自然语言处理、计算机视觉等领域的深度学习应用，包括自编码器预训练、零样本学习等方向。Larochelle学术影响力显著，论文被引超9.3万次，其开源深度学习课程广受欢迎。此前他联合创立机器学习公司Whetlab（后被Twitter收购）。离职后计划激活本地AI人才生态，但未透露具体去向。业界对其贡献表示感谢与祝福。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T22:03:38Z
- **目录日期**: 2025-04-27
