...
深度学习专家Hugo Larochelle宣布从谷歌DeepMind离职。作为蒙特利尔团队首席科学家，他八年前加入谷歌并建立了该地区首个大型AI实验室，研究领域涵盖自然语言处理、计算机视觉等方向，学术引用超9.3万次。此前他联合创立机器学习公司Whetlab（后被Twitter收购）。Larochelle以开源深度学习课程闻名，专注自编码器、零样本学习等前沿技术。离职后计划激活本地AI人才生态，但未透露具体去向。业界对其贡献给予高度评价。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T17:03:27Z
- **目录日期**: 2025-04-27
