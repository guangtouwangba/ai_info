...
格灵深瞳发布全新亿级图文数据集RealSyn，包含1亿组高质量图文对，每张图片关联多个真实和合成文本。该数据集经过严格过滤和语义平衡采样，提供15M、30M和100M三种规模版本。RealSyn显著提升了CLIP模型的性能，在多任务视觉语言表征学习中达到新SOTA。目前该数据集已在Hugging Face平台开源，为AI研究提供重要资源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T16:02:37Z
- **目录日期**: 2025-04-27
