...
格灵深瞳发布全新亿级图文数据集RealSyn，包含1亿组高质量图文对，每张图片关联多个真实和合成文本。该数据集经过严格过滤确保质量，并提供15M、30M、100M三种规模版本。RealSyn展现出优异扩展性，助力CLIP模型在多任务中刷新SOTA性能。目前数据集已开源，可通过Hugging Face平台获取。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T12:02:39Z
- **目录日期**: 2025-04-27
