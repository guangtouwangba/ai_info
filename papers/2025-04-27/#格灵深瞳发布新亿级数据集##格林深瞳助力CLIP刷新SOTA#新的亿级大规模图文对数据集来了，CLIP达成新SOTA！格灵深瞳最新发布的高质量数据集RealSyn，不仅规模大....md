...
格灵深瞳发布全新亿级图文数据集RealSyn，包含1亿组高质量图文对，每张图片关联多个真实和合成文本。该数据集经过严格过滤，采用语义平衡采样策略，提供15M、30M和100M三种规模版本。RealSyn展现出优异的扩展性，助力CLIP模型在多任务中刷新SOTA性能。目前数据集已在Hugging Face平台开源，为视觉语言表征学习提供强大支持。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T15:02:35Z
- **目录日期**: 2025-04-27
