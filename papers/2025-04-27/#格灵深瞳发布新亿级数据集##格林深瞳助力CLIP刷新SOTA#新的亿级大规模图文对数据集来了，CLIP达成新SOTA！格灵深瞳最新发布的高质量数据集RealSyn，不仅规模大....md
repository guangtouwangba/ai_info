...
格灵深瞳发布亿级高质量图文数据集RealSyn，包含1亿组图文对，每张图片关联多个真实和合成文本。该数据集经过严格过滤确保质量，并提供15M、30M、100M三种规模版本。RealSyn助力CLIP模型在多任务中取得新SOTA性能，展现出色的扩展性和视觉语言表征学习能力。目前数据集已开源，可通过指定链接获取。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T13:07:53Z
- **目录日期**: 2025-04-27
