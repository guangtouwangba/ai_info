...
格灵深瞳发布全新亿级图文数据集RealSyn，包含1亿组高质量图文对，每张图片关联多个真实/合成文本。该数据集经过严格过滤，采用语义平衡采样策略，提供15M/30M/100M三种规模版本。基于RealSyn训练的CLIP模型在多任务中刷新SOTA，展现出卓越的视觉语言表征学习能力。目前数据集已开源，可通过Hugging Face等平台获取。该资源将显著推动多模态学习领域发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T22:02:40Z
- **目录日期**: 2025-04-27
