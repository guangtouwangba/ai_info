...
格灵深瞳发布名为RealSyn的亿级高质量图文数据集(1亿组)，每张图片关联多个真实/合成文本。该数据集经过严格过滤确保质量，并提供15M/30M/100M三种规模版本。基于该数据集训练的CLIP模型在多任务中刷新SOTA性能，展现出优秀的视觉语言表征学习能力。数据集已开源，可通过Hugging Face等平台获取。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T17:02:31Z
- **目录日期**: 2025-04-27
