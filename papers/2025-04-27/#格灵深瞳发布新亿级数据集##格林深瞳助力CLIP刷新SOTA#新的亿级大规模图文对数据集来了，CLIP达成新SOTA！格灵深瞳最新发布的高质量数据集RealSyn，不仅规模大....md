...
格灵深瞳发布全新亿级图文数据集RealSyn，包含1亿组高质量图文对，每张图片关联多个真实和合成文本。该数据集经过严格过滤，采用语义平衡采样策略，提供15M/30M/100M三种规模。RealSyn显著提升了CLIP模型的性能，在多任务中达到SOTA水平。数据集已开源，可用于视觉语言表征学习等研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T21:02:26Z
- **目录日期**: 2025-04-27
