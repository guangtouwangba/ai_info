...
这篇论文介绍了一个名为AgentSociety的大规模社会模拟器，它结合了LLM驱动的智能代理、真实社会环境和大规模模拟引擎。研究者模拟了1万多个代理的社会生活及500万次互动，并针对四个关键社会问题（如极化现象、政策影响等）进行实验。结果显示模拟结果与现实世界数据吻合，验证了该系统捕捉人类行为机制的能力，表明其可作为社会科学研究和政策制定的有力工具。该系统有望补充传统研究方法，帮助深入理解社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T22:05:16Z
- **目录日期**: 2025-04-27
