...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理及其500万次社会互动。该系统作为计算社会科学实验平台，研究了社会极化、信息传播、基本收入政策及自然灾害影响等社会问题。模拟结果与现实世界数据高度吻合，验证了该系统在捕捉人类行为机制方面的有效性。研究表明AgentSociety能有效补充传统社会研究方法，为社会科学研究和政策制定提供了新工具，展现出大语言模型在社会模拟领域的应用潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T19:04:35Z
- **目录日期**: 2025-04-27
