...
这篇论文介绍了AgentSociety，一个基于大型语言模型的大规模社会模拟系统。该系统通过模拟1万多个AI代理及其500万次互动，研究人类行为和社会现象。研究者用它分析了四个关键社会问题：群体极化、信息传播、基本收入政策效果和自然灾害影响。模拟结果与现实世界数据高度吻合，验证了该系统捕捉人类行为机制的能力。AgentSociety可作为计算社会科学的新工具，为研究者和政策制定者提供社会问题分析的新方法，补充传统研究方法如调查和访谈的不足。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T09:04:56Z
- **目录日期**: 2025-04-27
