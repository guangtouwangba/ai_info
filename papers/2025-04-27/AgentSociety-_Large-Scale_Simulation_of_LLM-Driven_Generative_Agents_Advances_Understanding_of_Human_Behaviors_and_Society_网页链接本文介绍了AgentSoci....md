...
这篇论文介绍了AgentSociety，这是一个利用大型语言模型驱动的大规模社会模拟器。该系统模拟了1万多个代理在真实社会环境中的500万次互动，用于研究极化现象、信息传播、基本收入政策及自然灾害影响等社会问题。研究结果表明，模拟结果与现实世界数据高度吻合，验证了其在捕捉人类行为机制方面的能力。AgentSociety可作为计算社会科学研究的创新工具，为学者和政策制定者提供新的研究途径，弥补传统方法的不足。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-27T02:34:06Z
- **目录日期**: 2025-04-27
