...
DeepSeek发布新数学模型DeepSeek-Prover-V2，在普特南测试中取得49道题的突破性成绩，远超当前第一名（10道）。特别值得注意的是，7B参数的小模型通过强化学习发现了671B大模型未掌握的数学推理技能，成功解决了13个大模型无法处理的问题。研究发现，小模型在处理有限基数问题时采用了独特的方法，而大模型未使用这些技巧。该模型基于前代优化，通过大模型数据微调后获得新能力，展现了"小模型超越大模型"的罕见现象。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T01:31:39Z
- **目录日期**: 2025-05-04
