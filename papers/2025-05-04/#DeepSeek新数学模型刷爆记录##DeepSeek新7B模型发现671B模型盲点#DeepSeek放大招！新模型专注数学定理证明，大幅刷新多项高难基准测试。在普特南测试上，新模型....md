...
DeepSeek发布新数学模型DeepSeek-Prover-V2，在普特南测试中创下49道题的新纪录，远超当前最佳模型（10道）。特别值得注意的是，7B参数的小模型通过强化学习发现了671B大模型未掌握的数学推理技能，解决了13个大模型无法处理的问题。研究发现，小模型在处理有限基数问题时采用了独特方法（如Cardinal.toNat等），而大模型输出中未见这些策略。该模型基于DeepSeek-Prover-V1.5-Base微调，并通过强化学习获得新能力，展现了小模型突破性学习潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T03:24:18Z
- **目录日期**: 2025-05-04
