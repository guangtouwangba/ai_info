...
这篇论文探讨了实现"人工科学家"愿景的关键概念，从AlphaGo到ChatGPT展开实证研究。研究始于类似AlphaGo Zero的Olivaw智能体，它能发现奥赛罗棋知识但无法交流，从而催生了"解释性学习"(EL)框架。通过EL成功破解模拟科研过程的Zendo棋盘游戏，得出关键洞见：人工科学家必须自主发展解释语言的理解能力，而非依赖固定解释器。研究进一步提出构建解耦感知与解释的CLIP类模型的新方法。最后指出ChatGPT等模型与人工科学家的差距，并引入Big-Bench符号解释任务作为基准测试。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T01:29:37Z
- **目录日期**: 2025-05-04
