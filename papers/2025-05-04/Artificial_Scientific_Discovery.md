...
这篇论文探讨了实现"人工科学家"愿景的关键要素，即机器能自主开展原创研究并扩展人类知识。研究从AlphaGo式代理Olivaw出发，发现其无法有效交流知识，从而提出"解释性学习"(EL)框架来模拟科学家解释新现象的过程。通过破解科学模拟游戏Zendo，研究发现人工科学家需要自主构建解释语言而非依赖固定解释器。论文进一步提出构建解耦感知与解释的多模态模型方法，并指出ChatGPT等模型在成为人工科学家方面的不足，同时引入Big-Bench符号解释任务作为评估基准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T14:02:03Z
- **目录日期**: 2025-05-04
