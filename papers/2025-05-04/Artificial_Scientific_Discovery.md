...
这篇论文探讨了实现"人工科学家"愿景所需的基础概念，从AlphaGo到ChatGPT展开实证研究。研究始于开发类似AlphaGo Zero的智能体Olivaw，它虽能发现新知识但无法表达，由此提出"解释性学习"(EL)框架来模拟科学家向同行解释新现象的过程。通过EL成功破解科学模拟游戏Zendo，发现人工科学家必须自主构建解释语言而非依赖现有解释器。研究进一步提出解耦感知与解释的CLIP类模型构建方法，并指出当前大语言模型(如ChatGPT)在解释Zendo类规则时表现仅达随机水平，与人类存在显著差距。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T21:02:01Z
- **目录日期**: 2025-05-04
