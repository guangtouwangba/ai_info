...
这篇论文探讨了实现"人工科学家"愿景所需的核心概念，从AlphaGo到ChatGPT展开实证研究。研究始于类似AlphaGo Zero的Othello智能体Olivaw，它无法表达所学知识，从而催生了"解释性学习"(EL)框架。该框架成功应用于科学模拟游戏Zendo，揭示人工科学家必须自主构建解释语言而非依赖固定解释器。作者进一步研究多模态模型，提出将感知与解释显式分离的CLIP类模型构建方法。最后指出当前大语言模型(如ChatGPT)与人工科学家的差距，并引入Big-Bench符号解释任务基准，显示LLMs表现仅随机水平而人类能完全解决。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T12:02:12Z
- **目录日期**: 2025-05-04
