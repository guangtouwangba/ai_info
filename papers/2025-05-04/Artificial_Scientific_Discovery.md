...
这篇论文探讨了实现"人工科学家"愿景所需的核心概念，从AlphaGo到ChatGPT展开实证研究。研究从类似AlphaGo Zero的Olivaw智能体开始，发现其无法传达知识，进而开发了"解释性学习"(EL)框架来模拟科学家解释新现象的过程。通过EL成功破解了模拟科研过程的Zendo棋盘游戏，得出关键洞见：人工科学家必须自主发展解释语言的能力。研究还提出构建解耦感知与解释的CLIP类模型的新方法，并指出当前大型语言模型(如ChatGPT)在解释Zendo类规则时表现仅达随机水平，与人类存在显著差距。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T07:02:00Z
- **目录日期**: 2025-05-04
