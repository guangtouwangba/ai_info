...
这篇论文探讨了实现"人工科学家"愿景所需的核心概念，从AlphaGo到ChatGPT展开实证研究。研究始于类似AlphaGo Zero的智能体Olivaw，它能自主发现知识但无法表达，从而催生了"解释性学习"(EL)框架。通过破解模拟科研过程的Zendo游戏，研究发现人工科学家需要自主构建解释语言而非依赖固定解释器。作者进一步提出构建CLIP类模型的新方法，将解释与感知显式分离。最后指出ChatGPT等模型在成为人工科学家方面的不足，并引入Big-Bench符号解释任务作为基准测试，显示大语言模型表现仅达随机水平。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T00:02:06Z
- **目录日期**: 2025-05-04
