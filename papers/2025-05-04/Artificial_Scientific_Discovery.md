...
这篇论文探讨了实现"人工科学家"愿景所需的核心概念，从AlphaGo到ChatGPT展开实证研究。研究始于类似AlphaGo Zero的智能体Olivaw，它能发现知识但无法表达，进而提出"解释性学习"(EL)框架来模拟科学家解释新现象的过程。通过EL成功破解科学模拟游戏Zendo，发现人工科学家需要自主构建解释语言而非依赖固定解释器。研究还提出了一种经济高效的多模态模型构建方法，将单模态模型解耦结合。最后指出当前大语言模型(如ChatGPT)与人工科学家的差距，并引入Big-Bench符号解释任务作为基准测试。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T10:02:03Z
- **目录日期**: 2025-05-04
