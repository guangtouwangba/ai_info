...
这篇论文探讨了实现"人工科学家"愿景所需的基础概念，从AlphaGo到ChatGPT展开实证研究。研究始于类似AlphaGo Zero的Olivaw智能体，它虽能发现奥赛罗棋知识但无法表达，由此发展出"解释性学习"(EL)框架来解决科学解释问题。成功破解Zendo棋类游戏后获得关键洞见：人工科学家必须自主构建解释语言而非依赖固定解释器。作者进一步研究多模态模型，提出解耦感知与解释的CLIP类模型构建方法。最后指出ChatGPT等模型与人工科学家的差距，并引入Big-Bench符号解释任务作为基准测试。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T18:01:51Z
- **目录日期**: 2025-05-04
