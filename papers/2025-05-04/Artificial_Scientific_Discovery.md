...
这篇论文探讨了实现"人工科学家"愿景所需的基础概念，从AlphaGo到ChatGPT展开实证研究。研究首先开发了类似AlphaGo Zero的Olivaw代理，发现其无法传递知识，进而提出"解释性学习"(EL)框架来解决科学解释问题。通过破解Zendo棋盘游戏，研究发现人工科学家必须自主构建解释语言而非依赖固定解释器。随后研究转向多模态模型，提出将解释与感知明确分离的CLIP类模型构建方法。最后指出ChatGPT等模型成为人工科学家仍欠缺的能力，并引入Big-Bench符号解释任务作为基准测试。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T19:01:56Z
- **目录日期**: 2025-05-04
