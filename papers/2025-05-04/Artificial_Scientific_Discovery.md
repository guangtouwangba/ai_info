...
这篇论文探讨了如何实现"人工科学家"的愿景，即让机器能自主开展原创研究并扩展人类知识。研究从AlphaGo类智能体Olivaw出发，发现其无法有效交流知识，进而提出"解释学习"(EL)框架来模拟科学家解释新现象的过程。通过破解科学模拟游戏Zendo，研究得出关键洞见：人工科学家需要自主构建解释语言，而非依赖固定解释器。作者还提出构建解耦感知与解释的多模态模型方法，并分析ChatGPT等模型成为人工科学家的不足，同时引入Big-Bench符号解释任务作为评估基准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T20:02:00Z
- **目录日期**: 2025-05-04
