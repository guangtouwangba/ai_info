...
这篇论文探讨了实现"人工科学家"愿景所需的基本概念，从AlphaGo到ChatGPT展开实证研究。研究始于类似AlphaGo Zero的Olivaw智能体，它能从零发现奥赛罗知识但无法表达，从而催生了"解释学习"(EL)框架，用于模拟科学家向同行解释新现象的过程。通过EL成功破解科学模拟游戏Zendo，得出关键洞见：人工科学家必须自主发展解释语言的理解能力。研究还提出构建解耦感知与解释的多模态模型的新方法，并指出当前大语言模型(如ChatGPT)在解释Zendo类规则时表现仅达随机水平，远逊于人类。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T02:33:11Z
- **目录日期**: 2025-05-04
