...
这篇论文探讨了如何实现"人工科学家"的愿景，即机器能自主开展原创研究并扩展人类知识。研究从AlphaGo类智能体Olivaw出发，发现其无法解释知识，进而提出"解释性学习"(EL)框架，成功破解模拟科研的Zendo游戏。关键发现是：人工科学家必须自主构建解释语言，而非依赖固定解释器。作者随后研究多模态模型，提出一种经济高效的解耦感知与解释的方法。最后指出ChatGPT等模型与人工科学家的差距，并引入Big-Bench符号解释任务基准测试，显示大语言模型表现随机而人类能完全解决。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T05:02:09Z
- **目录日期**: 2025-05-04
