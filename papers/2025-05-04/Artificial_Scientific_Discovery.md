...
这篇论文探讨了实现"人工科学家"愿景所需的基本概念，从AlphaGo到ChatGPT展开实证研究。研究始于类似AlphaGo Zero的Olivaw智能体，它能自主发现奥赛罗棋知识但无法表达，从而提出了"解释性学习"(EL)框架来模拟科学家解释新现象的过程。通过EL成功破解了模拟科研过程的Zendo棋盘游戏，发现人工科学家必须自主构建解释语言而非依赖固定解释器。研究还提出了一种高效构建CLIP类模型的方法，并指出ChatGPT等模型在成为人工科学家方面的不足，同时引入了评估符号解释能力的基准测试。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T15:02:12Z
- **目录日期**: 2025-05-04
