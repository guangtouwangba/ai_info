...
这篇论文探讨了实现"人工科学家"愿景所需的关键概念，从AlphaGo到ChatGPT展开实证研究。研究始于开发类似AlphaGo Zero的Olivaw智能体，发现其无法交流知识，进而提出"解释性学习"(EL)框架来解决科学解释问题。通过破解Zendo棋盘游戏，研究发现人工科学家需要自主构建解释语言而非依赖固定解释器。作者还提出一种经济高效的多模态模型构建方法，将单模态模型解耦组合。最后指出当前大语言模型(如ChatGPT)在解释能力上的不足，并引入Big-Bench符号解释任务作为基准测试。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T06:02:06Z
- **目录日期**: 2025-05-04
