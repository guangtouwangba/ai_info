...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能模拟1万多个智能代理的社会互动（500万次交互）。研究者用它研究四大社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。结果显示其模拟结果与现实数据高度吻合，验证了系统捕捉人类行为机制的能力。该系统可作为计算社会科学的新工具，辅助传统研究方法（如调查、实验），帮助学者和政策制定者分析社会问题的成因与解决方案。研究突显了大语言模型在社会模拟中的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T05:05:26Z
- **目录日期**: 2025-05-04
