...
这篇论文介绍了AgentSociety，一个基于大型语言模型(LLM)的大规模社会模拟平台。该系统模拟了超过1万个AI代理的社会互动(500万次交互)，用于研究社会现象如信息传播、政策影响等。研究通过四个案例(社会极化、信息传播、基本收入政策、自然灾害影响)验证了模拟结果与现实数据的吻合度，证明了该平台在理解人类行为机制方面的有效性。AgentSociety展现了作为社会科学研究和政策制定工具的潜力，能够补充传统研究方法如调查和实验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T04:06:55Z
- **目录日期**: 2025-05-04
