...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万个智能代理及其500万次社会互动。研究者利用该平台研究了四大社会问题：社会极化、信息传播、基本收入政策效果和自然灾害影响。模拟结果与现实世界数据高度吻合，验证了该系统在揭示人类行为机制方面的可靠性。该系统可作为计算社会科学研究的新工具，为学者和政策制定者提供传统方法（如调查、实验）之外的补充研究手段，有助于深入理解复杂社会现象的内在规律。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T07:05:11Z
- **目录日期**: 2025-05-04
