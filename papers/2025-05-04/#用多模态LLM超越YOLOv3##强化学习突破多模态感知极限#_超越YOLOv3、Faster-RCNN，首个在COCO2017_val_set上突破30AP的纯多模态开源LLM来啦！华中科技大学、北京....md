...
华中科技大学与北京邮电大学等团队联合推出多模态大模型Perception-R1（PR1），首次在COCO2017验证集上以纯多模态方法突破30AP，超越YOLOv3和Faster-RCNN。PR1结合基于规则的强化学习（RL），显著提升了视觉感知能力，涵盖纯视觉任务（目标检测、计数）和视觉语言任务（定位、OCR）。该研究为多模态感知提供了新基线，模型与代码已开源。成果展示了强化学习在多模态模型感知策略中的潜力，为后续研究奠定基础。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T21:03:42Z
- **目录日期**: 2025-05-04
