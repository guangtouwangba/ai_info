...
华中科技大学与北京邮电大学等团队联合推出多模态大模型Perception-R1（PR1），首次在COCO2017验证集上突破30AP，超越YOLOv3和Faster-RCNN。该研究通过基于规则的强化学习（RL）增强模型感知能力，聚焦纯视觉（目标检测、计数）和视觉语言（OCR、grounding）任务，展现了多模态感知策略的潜力。PR1作为开源模型，旨在为社区提供强大的基线支持后续研究。论文与代码已公开，标志着多模态LLM在视觉推理基础感知层面的重要突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T20:03:39Z
- **目录日期**: 2025-05-04
