...
华中科技大学与北京邮电大学等团队联合推出多模态大模型Perception-R1（PR1），首次在COCO2017验证集上突破30AP，超越YOLOv3和Faster-RCNN。该研究通过基于规则的强化学习（RL）增强模型感知能力，聚焦纯视觉（目标检测、计数）和视觉语言（OCR、grounding）任务，展现了多模态感知策略的潜力。论文与模型已开源，旨在为社区提供强大的多模态研究基线。这一成果标志着强化学习在多模态感知领域的突破性进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T11:03:18Z
- **目录日期**: 2025-05-04
