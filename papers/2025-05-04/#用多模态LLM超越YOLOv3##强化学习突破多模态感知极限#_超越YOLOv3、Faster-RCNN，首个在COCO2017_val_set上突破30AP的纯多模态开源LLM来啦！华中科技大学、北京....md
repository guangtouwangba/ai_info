...
华中科技大学与北京邮电大学等团队联合推出多模态大模型Perception-R1（PR1），首次在COCO2017验证集上突破30AP，超越YOLOv3和Faster-RCNN等传统视觉模型。该研究通过基于规则的强化学习（RL）增强多模态感知能力，聚焦纯视觉（目标检测、计数）和视觉语言（定位、OCR）任务，展现了感知策略的显著潜力。PR1作为首个开源纯多模态LLM基准模型，为后续研究提供了强大支持。论文与代码已开源，推动多模态感知技术的进一步发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T16:03:36Z
- **目录日期**: 2025-05-04
