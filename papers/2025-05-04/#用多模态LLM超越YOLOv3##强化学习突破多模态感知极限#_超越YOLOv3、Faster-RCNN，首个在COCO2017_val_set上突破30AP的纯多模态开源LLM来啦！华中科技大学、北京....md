...
华中科技大学、北京邮电大学等团队联合推出多模态大模型Perception-R1（PR1），首次在COCO2017验证集上突破30AP，超越YOLOv3和Faster-RCNN。PR1通过基于规则的强化学习增强模型感知能力，专注于纯视觉（目标检测、计数）和视觉语言（OCR、grounding）任务，展现了多模态感知策略的潜力。该研究为社区提供了强大的开源基线模型，论文与代码已公开，旨在推动多模态感知技术的后续发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T19:03:26Z
- **目录日期**: 2025-05-04
