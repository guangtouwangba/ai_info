...
本文介绍了RegionFocus，一种用于视觉语言模型代理的视觉测试时缩放方法。针对网页理解中GUI图像复杂、界面元素众多导致动作选择困难的问题，该方法通过动态放大相关区域来减少背景干扰，提高定位准确率。研究还提出图像映射机制，可视化关键地标以提供透明动作记录，帮助代理有效选择候选动作。实验表明，该方法在UI-TARS和Qwen2.5-VL等先进模型上，使Screenspot-pro和WebVoyager基准测试性能分别提升28%和24%。最终在Qwen2.5-VL-72B模型上实现了61.6%的ScreenSpot-Pro新SOTA性能。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T17:01:06Z
- **目录日期**: 2025-05-04
