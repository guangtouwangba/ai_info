...
研究者提出了RegionFocus，一种视觉测试时缩放方法，用于提升视觉语言模型代理在网页理解任务中的表现。该方法通过动态放大相关区域来减少背景干扰，提高动作选择的准确性。同时引入"图像即地图"机制，可视化关键地标，增强决策透明度。实验表明，该方法在UI-TARS和Qwen2.5-VL等先进模型基础上，使Screenspot-pro和WebVoyager基准测试性能分别提升28%和24%。特别是将RegionFocus应用于Qwen2.5-VL-72B模型时，在ScreenSpot-Pro基准上达到了61.6%的最新最优性能。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T10:01:14Z
- **目录日期**: 2025-05-04
