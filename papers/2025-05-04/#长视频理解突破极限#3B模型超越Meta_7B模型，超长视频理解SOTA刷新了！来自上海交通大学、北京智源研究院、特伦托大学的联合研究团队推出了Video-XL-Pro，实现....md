...
上海交通大学等机构联合推出Video-XL-Pro模型，在长视频理解领域取得突破。该3B参数模型采用"重构式token压缩"技术，实现单卡处理近万帧视频，准确率达98%以上，性能超越Meta的7B模型Apollo-7B及其他同尺寸开源模型。研究解决了长视频训练规模受限、处理效率低下的难题，使用较少训练数据即达到SOTA水平。模型、代码及数据已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T19:02:32Z
- **目录日期**: 2025-05-04
