...
上海交通大学、北京智源研究院和特伦托大学联合推出Video-XL-Pro模型，在长视频理解领域取得突破。该3B参数模型采用"重构式token压缩"技术，实现单卡处理近万帧视频，在"大海捞针"测试中准确率超98%，性能超越Meta的7B模型Apollo-7B及其他同尺寸开源模型。研究解决了现有模型在长视频训练和应用中的效率与性能瓶颈，使用较少训练数据即实现SOTA表现。项目代码、模型及训练数据已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T23:02:41Z
- **目录日期**: 2025-05-04
