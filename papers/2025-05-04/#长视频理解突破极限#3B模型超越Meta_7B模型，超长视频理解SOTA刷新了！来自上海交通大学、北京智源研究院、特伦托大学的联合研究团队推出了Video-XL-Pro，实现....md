...
上海交通大学、北京智源研究院和特伦托大学联合推出Video-XL-Pro模型，突破长视频理解瓶颈。该3B参数模型采用"重构式token压缩"技术，实现单卡处理近万帧视频，在"大海捞针"测试中准确率超98%，性能超越Meta的7B模型Apollo-7B及同类开源模型。相比现有方法，该方案训练数据更少，解决了长视频处理效率低、性能差的问题。模型代码、训练数据已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T22:02:47Z
- **目录日期**: 2025-05-04
