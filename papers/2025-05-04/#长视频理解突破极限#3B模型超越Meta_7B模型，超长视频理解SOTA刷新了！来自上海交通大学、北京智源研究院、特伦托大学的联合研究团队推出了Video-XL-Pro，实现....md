...
上海交通大学、北京智源研究院和特伦托大学联合推出Video-XL-Pro模型，突破长视频理解瓶颈。该3B参数模型采用"重构式token压缩"技术，实现单卡处理近万帧视频，在"大海捞针"测试中准确率超98%，性能超越Meta的7B模型Apollo-7B及同类开源模型。相比现有方法，该方案训练数据需求更少，解决了长视频处理中性能差、效率低的问题，相关代码、模型和数据均已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T16:02:34Z
- **目录日期**: 2025-05-04
