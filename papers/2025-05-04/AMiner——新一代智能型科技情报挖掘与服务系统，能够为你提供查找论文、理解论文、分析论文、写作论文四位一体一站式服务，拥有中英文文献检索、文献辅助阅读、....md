...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译及科研订阅等一站式服务。它支持中英文文献搜索，能自动生成摘要和问答互动，帮助用户快速理解内容。平台还具备文档识别、学者画像、学术会议追踪等功能，并支持个性化科研动态订阅。收录了3.5亿论文、0.6亿学者等海量数据，可免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T05:05:53Z
- **目录日期**: 2025-05-04
