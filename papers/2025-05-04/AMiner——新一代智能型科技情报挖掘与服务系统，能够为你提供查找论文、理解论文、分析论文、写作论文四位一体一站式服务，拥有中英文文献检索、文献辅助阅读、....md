...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析和写作一站式服务。它支持中英文文献搜索，能自动生成摘要和问答互动，帮助用户快速理解内容。平台还具备文档识别、辅助阅读和科研情报订阅功能，可根据用户偏好推送最新学术动态。AMiner收录了3.5亿论文、0.6亿学者等海量数据，并提供学者画像、学术会议等附加功能。其浏览器版本可免费使用，旨在提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T13:11:13Z
- **目录日期**: 2025-05-04
