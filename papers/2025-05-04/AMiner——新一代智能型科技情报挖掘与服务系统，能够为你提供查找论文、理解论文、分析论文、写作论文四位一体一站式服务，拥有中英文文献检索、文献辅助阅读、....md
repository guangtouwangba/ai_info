...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译及科研情报订阅等一站式服务。它收录了3.5亿论文、0.6亿学者等海量学术资源，支持中英文文献搜索，并能通过AI生成摘要和章节概要。用户可上传PDF或直接搜索论文，通过智能问答深入理解内容。平台还提供个性化科研动态推送，根据用户关注的学者、机构等定制最新研究资讯。AMiner还包含学者画像、学术会议等功能，基础服务免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T10:05:54Z
- **目录日期**: 2025-05-04
