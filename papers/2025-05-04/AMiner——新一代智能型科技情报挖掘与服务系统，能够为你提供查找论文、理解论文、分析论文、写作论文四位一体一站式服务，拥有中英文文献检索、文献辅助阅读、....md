...
AMiner是一款智能科技情报挖掘系统，提供一站式学术服务，包括中英文文献检索、翻译、辅助阅读和分析。其数据库涵盖42个学科，拥有3.5亿论文、0.6亿学者等资源。核心功能包括：1）智能文献检索与摘要生成；2）英文文献翻译与互动问答；3）个性化科研情报订阅服务。此外，还支持学者画像、学术会议追踪等功能。平台可通过浏览器免费使用，旨在提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T03:25:44Z
- **目录日期**: 2025-05-04
