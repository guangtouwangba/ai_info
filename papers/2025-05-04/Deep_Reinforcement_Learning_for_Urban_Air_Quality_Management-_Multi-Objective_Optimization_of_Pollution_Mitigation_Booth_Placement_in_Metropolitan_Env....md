...
德里是全球空气污染最严重的城市之一，主要受交通排放、工业活动和建筑扬尘影响。传统静态空气净化装置因位置不佳和适应性差，效果有限。本研究提出一种深度强化学习（DRL）框架，利用近端策略优化（PPO）算法，基于人口密度、交通模式等动态因素优化净化亭的布局。与随机和贪婪基线方法相比，DRL方法在空气质量指数（AQI）改善、空间覆盖率和公平性方面表现更优，实现了净化设施的高效均衡分布。结果表明，AI驱动的空间优化可提升智慧城市空气质量管理的效果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T06:01:37Z
- **目录日期**: 2025-05-04
