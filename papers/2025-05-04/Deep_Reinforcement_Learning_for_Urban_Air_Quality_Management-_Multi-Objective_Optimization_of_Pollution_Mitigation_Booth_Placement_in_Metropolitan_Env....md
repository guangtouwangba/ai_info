...
本研究提出了一种基于深度强化学习（DRL）的新方法，用于优化印度德里空气净化亭的布局，以改善空气质量指数（AQI）。采用近端策略优化（PPO）算法，综合考虑人口密度、交通模式、工业影响和绿地限制等多维因素，动态学习最优放置位置。相比随机和基于AQI的贪婪方法，该DRL框架在AQI改善、空间覆盖和公平性等指标上表现更优，实现了净化设施的高效均衡分布。结果表明，AI驱动的空间优化能有效提升智慧城市空气质量管理的精准性和公平性，为数据驱动的城市治理提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T19:01:30Z
- **目录日期**: 2025-05-04
