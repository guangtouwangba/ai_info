...
德里是全球空气污染最严重的城市之一，主要受交通排放、工业活动和建筑扬尘影响。传统静态空气净化装置因位置欠佳和适应性不足效果有限。本研究提出一种深度强化学习（DRL）框架，利用近端策略优化（PPO）算法，基于人口密度、交通模式等动态因素优化净化亭布局。相比随机和贪婪基准方法，DRL方案在AQI改善、空间覆盖和公平性等指标上表现更优，实现了净化效率与覆盖范围的平衡。结果表明，AI驱动的空间优化可有效提升智慧城市空气质量管理的精准性和公平性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T11:01:27Z
- **目录日期**: 2025-05-04
