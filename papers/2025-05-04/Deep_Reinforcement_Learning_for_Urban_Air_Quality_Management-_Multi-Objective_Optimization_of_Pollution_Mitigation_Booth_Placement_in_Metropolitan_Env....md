...
德里是全球空气污染最严重的城市之一，主要受交通排放、工业活动和建筑扬尘影响。传统静态空气净化装置因位置不佳和适应性不足效果有限。本研究提出一种深度强化学习（DRL）框架，利用近端策略优化（PPO）算法，根据人口密度、交通模式、工业影响和绿地限制等因素优化空气净化亭的布局。相比随机和基于AQI的贪婪方法，DRL方法在AQI改善、空间覆盖和公平性等方面表现更优，实现了净化设施的高效均衡分布。结果表明，AI驱动的空间优化能有效提升城市空气质量管理的智能化水平。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T14:01:31Z
- **目录日期**: 2025-05-04
