...
微型交通（如送货机器人、电动代步车）是城市交通的新兴替代方案，但目前依赖人工操作，存在安全和效率问题。本研究提出利用AI代理辅助操作，并开发了可扩展的模拟解决方案URBAN-SIM，包含城市生成、交互动态生成和异步场景采样三大模块，提升机器人学习的多样性、真实性和效率。同时推出URBAN-BENCH基准测试，评估AI代理在自主微型交通中的三大核心能力（移动、导航、穿越），涵盖8项任务。实验对比了轮式和足式等不同机器人在多样化地形和城市结构中的表现，揭示了各自的优势与局限。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T10:01:04Z
- **目录日期**: 2025-05-04
