...
微出行（如送货机器人、电动代步车）是城市交通的有前景替代方案，但目前依赖人工操作存在安全与效率问题。本研究提出通过AI代理辅助操作提升性能，开发了URBAN-SIM仿真平台（含分层城市生成、交互动力学生成、异步场景采样三大模块）用于大规模机器人训练，并建立URBAN-BENCH基准测试套件（包含基于移动/导航/穿越三大核心技能的8项任务）。实验评估了轮式/腿式等异构机器人在不同地形和城市结构中的表现，揭示了各机器人的优劣势。该方案为自主微出行系统的发展提供了可扩展的仿真解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T05:01:11Z
- **目录日期**: 2025-05-04
