...
这篇论文提出了一个可扩展的城市模拟解决方案来推进自主微型交通的发展。研究团队开发了URBAN-SIM平台，包含三个关键模块：分层城市生成管道、交互式动态生成策略和异步场景采样方案，以提高机器人学习的多样性、真实性和效率。同时提出了URBAN-BENCH基准测试套件，包含基于三种核心技能的8项任务，用于评估AI代理在实现自主微型交通方面的能力。实验评估了轮式和腿式机器人等四种不同形态机器人在各种地形和城市结构中的表现，揭示了各自的优势和局限性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T11:00:54Z
- **目录日期**: 2025-05-04
