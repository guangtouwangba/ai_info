...
这篇摘要介绍了一个用于推进自主微型交通的模拟解决方案。研究者开发了URBAN-SIM平台，包含分层城市生成、交互动态生成和异步场景采样三个模块，以提高机器人学习的多样性、真实性和效率。同时提出了URBAN-BENCH基准测试套件，包含基于城市移动、导航和穿越三大核心技能的8项任务，评估了轮式和腿式等不同机器人在各种地形和城市结构中的表现。该研究为提升微型交通工具在复杂城市环境中的安全性和效率提供了AI解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T13:06:23Z
- **目录日期**: 2025-05-04
