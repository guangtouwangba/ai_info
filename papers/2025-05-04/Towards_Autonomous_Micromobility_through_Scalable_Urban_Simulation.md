...
这篇论文提出了一个可扩展的城市模拟解决方案URBAN-SIM，用于推动自主微移动技术的发展。该系统包含三个关键模块：分层城市生成管道、交互式动态生成策略和异步场景采样方案，以提高模拟训练的多样性、真实性和效率。同时，研究者开发了URBAN-BENCH基准测试套件，包含基于城市移动、导航和穿越三大核心技能的8项任务，用于评估AI代理在自主微移动中的能力。实验评估了轮式和腿式等不同形态机器人在多样化地形和城市结构中的表现，揭示了各自的优势与局限。该研究为提升城市环境中微移动设备的安全性和效率提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T06:01:07Z
- **目录日期**: 2025-05-04
