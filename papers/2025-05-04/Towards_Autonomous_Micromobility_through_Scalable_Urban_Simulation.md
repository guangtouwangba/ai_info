...
这篇论文提出了一个用于推进自主微移动技术发展的城市仿真解决方案。研究者开发了URBAN-SIM平台，包含分层城市生成、交互动态生成和异步场景采样三个关键模块，以提高机器人学习的多样性、真实性和效率。同时提出了URBAN-BENCH基准测试套件，包含基于城市移动、导航和穿越三大核心技能的8项任务，用于评估AI代理的多种能力。实验评估了轮式和腿式等不同形态机器人在各种地形和城市结构中的表现，揭示了各自的优势和局限。该研究为提升城市环境中微移动设备的安全性和效率提供了可行方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T18:01:00Z
- **目录日期**: 2025-05-04
