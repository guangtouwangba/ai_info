...
微出行（如配送机器人、电动代步车）是城市交通的新兴替代方案，但依赖人工操作存在安全与效率问题。研究提出通过AI代理辅助操作以提升性能，并开发了可扩展的模拟系统URBAN-SIM，包含分层城市生成、交互动态生成和异步场景采样三大模块，增强机器人学习的多样性、真实性和效率。配套的URBAN-BENCH基准测试包含8项任务，评估轮式/腿式机器人在城市移动、导航和穿越三大核心技能的表现。实验揭示了不同机器人在多样化地形与城市结构中的优劣势，为自主微出行发展提供了系统性研究框架。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T16:00:56Z
- **目录日期**: 2025-05-04
