...
这篇论文提出了一个用于推进自主微型交通的规模化城市模拟解决方案。研究者开发了URBAN-SIM——一个高性能机器人学习平台，包含分层城市生成、交互式动态生成和异步场景采样三大模块，以提高模拟训练的多样性、真实性和效率。同时提出了URBAN-BENCH基准测试套件，包含基于城市移动、导航和穿越三大核心技能的8项任务，评估了轮式和腿式等不同形态机器人在各种地形和城市结构中的表现。该系统为提升AI代理在微型交通设备上的安全性和效率提供了有效的仿真训练环境。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T19:01:02Z
- **目录日期**: 2025-05-04
