...
这篇论文提出了一个可扩展的城市模拟解决方案URBAN-SIM，用于推进自主微移动技术。URBAN-SIM是一个高性能机器人学习平台，包含三个关键模块：分层城市生成、交互动态生成和异步场景采样，以提高机器人学习的多样性、真实性和效率。同时，论文还提出了URBAN-BENCH基准测试套件，包含基于三种核心技能的8项任务，用于评估AI代理在自主微移动中的能力。实验评估了轮式和腿式机器人在不同地形和城市结构中的表现，揭示了各自的优势和局限性。该研究为提升城市环境中微移动的安全性和效率提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T08:00:56Z
- **目录日期**: 2025-05-04
