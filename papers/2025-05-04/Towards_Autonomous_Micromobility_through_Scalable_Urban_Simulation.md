...
这篇论文提出了一个可扩展的城市模拟解决方案来推进自主微型交通的发展。研究团队开发了URBAN-SIM——一个高性能机器人学习平台，包含三个关键模块：分层城市生成管道、交互式动态生成策略和异步场景采样方案，以提高模拟训练的多样性、真实性和效率。同时提出了URBAN-BENCH基准测试套件，包含基于城市移动、导航和穿越三大核心技能的8项任务。实验评估了轮式和腿式等不同形态机器人在各种地形和城市结构中的表现，揭示了各自的优势与局限，为提升微型交通的安全性和效率提供了解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T09:01:05Z
- **目录日期**: 2025-05-04
