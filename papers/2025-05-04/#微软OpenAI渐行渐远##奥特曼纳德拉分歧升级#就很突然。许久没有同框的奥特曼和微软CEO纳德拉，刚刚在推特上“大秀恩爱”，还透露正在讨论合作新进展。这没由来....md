...
微软与OpenAI的合作关系出现微妙变化，主要分歧集中在三方面：1)算力资源分配和模型授权问题；2)对AGI发展方向的判断差异；3)微软开始自研LLM模型形成内部竞争。据《华尔街日报》报道，双方高层联系频率从"每日多条短信"降至"每周例会"，尽管公开场合仍展示合作，但各自战略调整表明联盟正在松动。微软近期收购Inflection团队独立研发对标GPT-4的模型，进一步加剧了这种疏离态势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T11:03:57Z
- **目录日期**: 2025-05-04
