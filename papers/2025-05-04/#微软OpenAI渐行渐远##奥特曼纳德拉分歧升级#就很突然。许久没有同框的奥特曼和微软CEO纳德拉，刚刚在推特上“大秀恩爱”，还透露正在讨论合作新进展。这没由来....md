...
微软与OpenAI的合作关系近期出现裂痕，《华尔街日报》披露双方在算力分配、AGI发展方向和内部竞争三方面存在分歧。微软正减少对OpenAI的依赖，自研AI模型并收购Inflection团队；OpenAI则面临人才流失和微软支持力度下降的问题。尽管双方仍维持表面合作，但联系频率已从每日多条短信降至每周例会，表明合作关系正在弱化。奥特曼与纳德拉最近的公开互动疑似为平息外界猜测。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T03:24:01Z
- **目录日期**: 2025-05-04
