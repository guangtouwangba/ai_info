...
微软与OpenAI的合作关系近期出现明显裂痕，主要体现在三方面：1）算力分配与模型授权存在分歧，微软开始自研AI以减少依赖；2）AGI发展理念不合，OpenAI人事动荡而微软转向Copilot等务实产品；3）微软收购Inflection团队独立研发对标GPT-4的模型，形成内部竞争。双方联系频率从每日多条短信降至每周例会，尽管公开仍维持合作，但各自动作显示联盟正在松动。（98字）  

（注：根据微博话题标签和报道内容提炼核心矛盾，保留算力竞争、技术路线、人事变动等关键要素，严格控制在100字内）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T08:04:06Z
- **目录日期**: 2025-05-04
