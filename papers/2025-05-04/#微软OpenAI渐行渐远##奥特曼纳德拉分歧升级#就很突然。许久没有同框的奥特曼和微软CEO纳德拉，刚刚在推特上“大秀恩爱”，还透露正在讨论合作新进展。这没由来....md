...
微软与OpenAI的合作关系出现微妙变化，主要分歧集中在三个方面：算力资源分配（OpenAI要求更多顶级芯片但微软称已达极限）、AGI发展方向（OpenAI积极而微软态度保守）、以及内部竞争加剧（微软收购Inflection团队自研对标GPT-4的模型）。《华尔街日报》透露，双方高层联系频率从每日多条短信降至每周例会，尽管公开仍展示合作，但各自动作显示联盟渐行渐远。近期奥特曼与纳德拉的互动可能意在回应外界猜测。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T09:04:11Z
- **目录日期**: 2025-05-04
