...
微软与OpenAI的合作关系近期出现微妙变化，双方在算力资源、模型授权和AGI发展方向上存在分歧。微软正减少对OpenAI的依赖，自研AI模型并收购Inflection团队开发对标GPT-4的产品。OpenAI则面临人才流失和微软支持力度下降的问题，双方高层联系频率也从每日多次降至每周例会。尽管公开场合仍维持合作，但各自行动显示联盟正在弱化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T00:03:57Z
- **目录日期**: 2025-05-04
