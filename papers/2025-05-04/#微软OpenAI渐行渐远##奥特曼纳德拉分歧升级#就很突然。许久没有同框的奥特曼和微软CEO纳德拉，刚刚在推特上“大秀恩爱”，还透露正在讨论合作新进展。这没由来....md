...
微软与OpenAI的合作关系近期出现微妙变化。据《华尔街日报》报道，双方在算力资源分配、AGI发展理念和模型授权方面存在分歧。微软正减少对OpenAI的依赖，通过自研AI模型和收购Inflection团队加强自主性。尽管双方仍维持表面合作，但联系频率已从每日多次降至每周例会。OpenAI面临人才流失问题，而微软则主推Copilot并对AGI进展持保守态度。这些迹象表明，两家公司正在从紧密合作转向更具竞争性的关系。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T06:04:08Z
- **目录日期**: 2025-05-04
