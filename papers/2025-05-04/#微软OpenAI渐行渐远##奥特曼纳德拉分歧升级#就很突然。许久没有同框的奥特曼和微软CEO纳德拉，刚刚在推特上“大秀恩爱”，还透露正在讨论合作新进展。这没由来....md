...
微软与OpenAI的合作关系出现裂痕，主要分歧集中在三个方面：1）算力资源分配和模型授权问题，微软称已提供极限资源但OpenAI仍不满足；2）AGI发展方向判断不同，OpenAI保持乐观而微软态度趋于保守；3）内部竞争加剧，微软收购Inflection团队自研大模型。双方联系频率从CEO每日多条短信降至每周例会，虽维持表面合作，但各自动作显示关系正在疏远。近期奥特曼与纳德拉的公开互动被认为是对《华尔街日报》爆料报道的回应。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T02:35:06Z
- **目录日期**: 2025-05-04
