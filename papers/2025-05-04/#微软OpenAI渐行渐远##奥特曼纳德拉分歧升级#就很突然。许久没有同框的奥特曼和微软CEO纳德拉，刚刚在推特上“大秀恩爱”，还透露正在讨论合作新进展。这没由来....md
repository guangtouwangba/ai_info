...
微软与OpenAI的合作关系出现裂痕，主要分歧集中在三方面：1）算力资源分配和模型授权问题，微软称已提供极限资源但OpenAI仍不满足；2）AGI发展理念不合，OpenAI持续投入而微软转向Copilot等实用产品；3）内部竞争加剧，微软收购Inflection团队自研大模型。双方联系频率从CEO每日多次短信降至每周例会，尽管公开仍展示合作，但各自独立研发的动作表明关系正在疏远。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T13:09:34Z
- **目录日期**: 2025-05-04
