...
微软与OpenAI的合作关系近期出现明显裂痕。《华尔街日报》披露双方在算力资源分配、AGI发展理念和内部竞争三方面存在重大分歧：微软限制算力供给并自研AI模型，对AGI进展持保守态度；OpenAI面临人才流失，坚持激进路线。此外，微软收购Inflection团队独立开发对标GPT-4的模型，双方高管沟通频率从每日多条降至每周例会。尽管公开场合仍展示合作，实际已呈现竞争大于协作的态势。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T01:31:22Z
- **目录日期**: 2025-05-04
