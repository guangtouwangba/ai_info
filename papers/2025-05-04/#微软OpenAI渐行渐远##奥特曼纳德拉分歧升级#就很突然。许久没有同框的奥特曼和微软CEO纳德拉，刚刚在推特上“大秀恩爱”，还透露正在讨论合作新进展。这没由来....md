...
微软与OpenAI的合作关系出现裂痕，主要体现在三方面：算力资源分配争议（OpenAI要求更多顶级芯片，微软称已达极限）、AGI发展方向分歧（OpenAI积极布局，微软转向Copilot并持保守态度），以及微软通过收购Inflection团队自研大模型（部分绕过OpenAI）。《华尔街日报》透露双方高管联系频率从"日发多条短信"降至"周例会"，尽管公开仍展示合作，但各自动作显示联盟正逐渐疏离。（99字）  

注：保留核心冲突点（资源/方向/竞争），量化关系变化（联系频率对比），并维持客观表述。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T10:04:10Z
- **目录日期**: 2025-05-04
