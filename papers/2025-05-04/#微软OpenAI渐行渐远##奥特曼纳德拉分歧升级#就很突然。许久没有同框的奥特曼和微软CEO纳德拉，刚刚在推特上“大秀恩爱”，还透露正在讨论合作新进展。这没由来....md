...
微软与OpenAI的合作关系出现裂痕，主要分歧集中在三方面：1)算力资源分配和模型授权问题，微软称已提供极限资源但OpenAI仍不满足；2)AGI发展方向判断不同，OpenAI持续投入而微软转向Copilot等实用产品；3)内部竞争加剧，微软收购Inflection团队自研LLM模型。尽管双方仍维持每周例会，但联系频率从CEO每日多条短信降至每周一次。近期奥特曼与纳德拉的公开互动被解读为对《华尔街日报》爆料的回应，暗示昔日紧密合作关系正在松动。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T07:04:04Z
- **目录日期**: 2025-05-04
