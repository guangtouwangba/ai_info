...
微软与OpenAI的合作关系近期出现裂痕，主要分歧集中在三方面：1）算力资源分配与模型权限问题，微软称已提供极限资源但OpenAI仍不满足；2）AGI发展理念差异，OpenAI积极推动而微软转向Copilot等务实产品；3）内部竞争加剧，微软收购Inflection团队自研对标GPT-4的模型。尽管双方公开互动频繁（如奥特曼与纳德拉推特互动），但日常沟通已从每日多条短信降为周例会。外媒报道显示，这对曾经的AI合作典范正逐渐走向战略分化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T04:05:46Z
- **目录日期**: 2025-05-04
