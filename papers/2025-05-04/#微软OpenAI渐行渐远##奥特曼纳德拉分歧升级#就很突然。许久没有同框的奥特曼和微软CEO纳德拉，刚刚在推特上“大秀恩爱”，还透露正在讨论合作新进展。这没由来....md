...
微软与OpenAI的合作关系近期出现微妙变化。据《华尔街日报》报道，双方在算力资源分配、AGI发展理念和内部竞争三方面存在分歧：OpenAI要求更多计算资源但微软称已达极限；微软对AGI进展持保留态度而OpenAI仍积极推动；微软收购Inflection团队自研LLM模型，部分操作未告知OpenAI。此外，纳德拉与奥特曼的联系频率从每日多条降至每周例会。尽管双方仍公开维持合作，但各自战略调整和人才流动已显示出渐行渐远的迹象。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T05:04:15Z
- **目录日期**: 2025-05-04
