...
当前大语言模型(LLM)的对齐方法主要关注相对偏好，却忽略了响应质量。研究者提出了一种奖励条件化的LLM策略，通过重新标注数据，将偏好对与质量分数关联，构建奖励增强数据集。该方法能识别和学习数据集中所有响应质量，帮助模型推断更优结果。实验表明，该方法显著提升了DPO性能，不仅最大化偏好数据的效用，还缓解了"遗忘"问题。这种效果不仅来自数据扩展，更源于方法本身的优势。研究代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T09:02:12Z
- **目录日期**: 2025-05-04
