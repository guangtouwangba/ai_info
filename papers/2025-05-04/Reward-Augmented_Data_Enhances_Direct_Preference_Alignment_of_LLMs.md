...
当前大语言模型（LLM）偏好对齐方法主要关注相对偏好，却忽略了响应质量，导致模型可能过度拟合或错误学习。本研究提出一种基于奖励条件的LLM策略，通过分析数据集中所有响应的质量谱来优化学习。方法包括对偏好数据重新标记，结合质量评分构建奖励增强数据集。实验表明，该方法显著提升了DPO（直接偏好优化）性能，有效利用偏好数据并减少错误学习问题，其优势不仅来自数据扩展，更源于质量感知机制。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T22:02:16Z
- **目录日期**: 2025-05-04
