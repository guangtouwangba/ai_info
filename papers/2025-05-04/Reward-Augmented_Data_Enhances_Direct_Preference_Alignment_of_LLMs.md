...
该研究提出了一种基于奖励条件的大语言模型（LLM）对齐方法，解决了现有直接偏好对齐算法忽视响应质量的问题。传统方法仅关注相对偏好，可能导致对高质量拒绝响应的遗忘或对低质量选择响应的偏好。新方法通过数据重标注，将偏好对与质量分数结合构建奖励增强数据集，使模型能学习整个响应质量谱系。实验表明，该方法显著提升了DPO（Direct Preference Optimization）性能，有效利用偏好数据并减少遗忘问题，在多种基准测试和模型上表现优异。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T10:02:15Z
- **目录日期**: 2025-05-04
