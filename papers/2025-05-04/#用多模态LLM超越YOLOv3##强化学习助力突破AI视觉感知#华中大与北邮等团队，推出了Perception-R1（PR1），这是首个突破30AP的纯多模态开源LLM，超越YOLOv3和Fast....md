...
华中大与北邮团队联合推出多模态大模型Perception-R1（PR1），首次在纯多模态开源LLM中突破30AP性能，超越YOLOv3、Faster-RCNN等经典模型。PR1创新性地采用基于规则的强化学习优化视觉感知，在COCO2017验证集上展现出卓越的物体检测、OCR和计数能力。实验显示其性能优于专用模型，尤其在visual grounding、OCR和Pixmo-Count任务中表现突出。该研究突破了AI视觉感知的极限，为多模态模型在复杂视觉任务中的应用提供了新范式，具有显著的可扩展性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T20:03:11Z
- **目录日期**: 2025-05-04
