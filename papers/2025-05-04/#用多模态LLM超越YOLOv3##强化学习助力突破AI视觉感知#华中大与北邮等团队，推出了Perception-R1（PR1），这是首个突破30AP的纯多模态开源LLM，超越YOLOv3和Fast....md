...
华中大与北邮团队推出多模态大模型PR1，首次突破30AP，超越YOLOv3等经典模型。通过强化学习优化视觉感知，PR1在物体检测、OCR和计数任务中表现优异，在COCO2017验证集上取得突出成果。实验显示，PR1在视觉定位、OCR等任务中优于专用模型，展现了强大的扩展性。该研究为AI视觉感知发展奠定基础，推动多模态模型理解能力的边界。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T02:33:53Z
- **目录日期**: 2025-05-04
