...
华中大与北邮团队推出多模态大模型Perception-R1（PR1），首次在纯多模态开源LLM中突破30AP，超越YOLOv3、Faster-RCNN等经典模型。PR1通过基于规则的强化学习优化视觉感知能力，在COCO2017验证集上表现优异，尤其在物体检测、OCR和计数任务中显著领先。实验显示，PR1在visual grounding、OCR等任务中超越专用模型，展现强大扩展性。该研究为AI视觉感知发展奠定基础，推动多模态模型理解视觉信息的边界。成果已开源，助力AI视觉领域突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T09:03:01Z
- **目录日期**: 2025-05-04
