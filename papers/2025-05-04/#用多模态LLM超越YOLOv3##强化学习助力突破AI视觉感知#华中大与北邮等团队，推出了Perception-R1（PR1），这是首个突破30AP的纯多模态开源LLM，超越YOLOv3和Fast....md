...
华中大与北邮团队联合推出多模态大模型Perception-R1（PR1），首次突破30AP性能指标，超越YOLOv3、Faster-RCNN等传统视觉模型。该模型通过基于规则的强化学习优化视觉感知能力，在COCO2017验证集上展现出卓越的物体检测、OCR及计数性能。实验表明，PR1在视觉定位、文本识别等任务中优于专用模型，具有强扩展性。这一突破为AI视觉感知领域树立新基准，推动多模态模型理解能力的边界。研究成果已开源，为后续视觉-语言融合研究提供重要基础。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T15:03:31Z
- **目录日期**: 2025-05-04
