...
华中大与北邮团队开发的多模态大语言模型Perception-R1（PR1）在视觉感知任务中取得突破，成为首个AP超过30的开源纯多模态LLM，性能超越YOLOv3和Faster-RCNN等经典模型。PR1采用基于规则的强化学习优化视觉能力，在物体检测、OCR和计数任务中表现优异，尤其在COCO2017验证集上展现了出色的可扩展性。该模型在visual grounding、OCR和Pixmo-Count等任务中超越专用模型，为AI视觉感知的发展奠定了基础，推动了多模态理解的技术边界。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T07:02:54Z
- **目录日期**: 2025-05-04
