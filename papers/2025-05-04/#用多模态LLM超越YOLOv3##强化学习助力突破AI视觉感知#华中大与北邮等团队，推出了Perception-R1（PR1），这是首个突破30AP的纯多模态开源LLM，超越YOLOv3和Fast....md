...
华中大与北邮团队推出多模态大模型PR1，首次突破30AP性能指标，超越YOLOv3等经典视觉模型。该模型通过基于规则的强化学习优化视觉感知能力，在COCO2017等数据集上展现出卓越的物体检测、OCR和计数性能。实验表明PR1在视觉定位等任务中优于专用模型，具有出色的可扩展性。这一突破为AI视觉感知发展奠定基础，推动了多模态模型理解视觉信息的边界。研究成果已开源，标志着多模态LLM在计算机视觉领域取得重要进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T03:22:55Z
- **目录日期**: 2025-05-04
