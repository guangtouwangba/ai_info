...
华中大与北邮团队联合推出多模态大模型PR1，首次突破30AP性能指标，超越YOLOv3、Faster-RCNN等传统视觉模型。该模型通过基于规则的强化学习优化视觉感知能力，在COCO2017验证集上表现出色，尤其在物体检测、OCR和计数任务中表现突出。实验显示PR1在视觉定位、文本识别等任务性能超越专用模型，展现了优秀的扩展性。这一突破为AI视觉感知发展奠定基础，推动了多模态模型理解视觉信息的能力边界。研究成果已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T22:03:13Z
- **目录日期**: 2025-05-04
