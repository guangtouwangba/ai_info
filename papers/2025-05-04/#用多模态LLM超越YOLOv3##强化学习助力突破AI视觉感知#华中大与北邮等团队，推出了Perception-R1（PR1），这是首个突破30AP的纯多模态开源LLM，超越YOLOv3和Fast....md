...
华中大与北邮团队推出首个突破30AP的多模态开源大模型Perception-R1（PR1），在COCO2017数据集上超越YOLOv3等经典模型。该模型通过基于规则的强化学习优化视觉感知能力，在物体检测、OCR和计数任务中表现优异。实验显示，PR1在视觉定位、OCR等任务中优于专用模型，展现出强大的可扩展性。这一突破为AI视觉感知发展奠定基础，推动多模态模型理解视觉信息的边界。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T08:02:54Z
- **目录日期**: 2025-05-04
