...
华中大与北邮团队推出首个纯多模态开源大模型Perception-R1（PR1），在COCO2017验证集上突破30AP，超越YOLOv3和Faster-RCNN等经典模型。通过基于规则的强化学习优化视觉感知能力，PR1在物体检测、OCR和计数任务中表现突出，其感知策略优化框架显著提升了多模态大模型在复杂任务中的精度。实验显示，PR1在视觉定位、OCR和计数等任务中优于专用模型，展现了出色的可扩展性，为AI视觉感知的发展奠定了基础，推动了对视觉信息理解的极限突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T23:03:08Z
- **目录日期**: 2025-05-04
