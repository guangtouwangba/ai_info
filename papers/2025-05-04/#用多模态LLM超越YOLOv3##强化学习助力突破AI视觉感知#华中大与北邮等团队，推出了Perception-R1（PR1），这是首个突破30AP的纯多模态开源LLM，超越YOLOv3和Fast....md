...
华中大与北邮团队开发了多模态大模型Perception-R1（PR1），首次在纯多模态开源LLM中突破30AP，性能超越YOLOv3和Faster-RCNN等传统视觉模型。PR1通过基于规则的强化学习优化视觉感知能力，在COCO2017验证集上表现优异，尤其在物体检测、OCR和计数任务中显著领先。实验显示，PR1在视觉定位、OCR和Pixmo-Count等任务中优于专用模型，展现了强大的可扩展性。该研究为AI视觉感知设定了新基准，推动了多模态模型理解视觉信息的边界。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T13:08:23Z
- **目录日期**: 2025-05-04
