...
华中大与北邮团队联合推出多模态大模型Perception-R1（PR1），成为首个在COCO2017验证集上突破30AP的开源纯多模态LLM，性能超越YOLOv3和Faster-RCNN等经典视觉模型。该模型通过基于规则的强化学习优化视觉感知能力，在物体检测、OCR和计数任务中表现优异。实验显示PR1在visual grounding、OCR和Pixmo-Count等任务中超越专用模型，展现出强大的可扩展性。这一突破为AI视觉感知发展奠定新基础，推动多模态模型理解视觉信息的边界。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T18:02:57Z
- **目录日期**: 2025-05-04
