...
华中大与北邮团队联合推出Perception-R1（PR1），首个AP突破30的纯多模态开源大语言模型（MLLM），在COCO2017验证集上超越YOLOv3、Faster-RCNN等经典模型。该模型通过基于规则的强化学习优化视觉感知能力，在物体检测、OCR和计数任务中表现优异。实验显示，PR1在visual grounding、OCR和Pixmo-Count等任务中超越专用模型，展现出强大的可扩展性。这一突破为AI视觉感知发展奠定新基础，推动了多模态模型理解视觉信息的边界。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T05:03:02Z
- **目录日期**: 2025-05-04
