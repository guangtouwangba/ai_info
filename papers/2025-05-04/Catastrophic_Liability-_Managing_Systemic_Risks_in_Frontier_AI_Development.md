...
随着AI系统能力增强和自主性提高，前沿AI发展可能带来大规模社会风险。当前许多AI实验室在安全措施、测试流程和治理结构方面缺乏透明度，导致难以验证安全声明或确定事故责任。借鉴核能、航空软件和医疗领域的责任框架，本文提出了一套针对前沿AI开发的安全记录与责任机制的综合方案。该方案旨在建立更清晰的问责制度，确保AI发展过程中的安全性与透明度，以应对潜在的系统性风险。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T05:01:59Z
- **目录日期**: 2025-05-04
