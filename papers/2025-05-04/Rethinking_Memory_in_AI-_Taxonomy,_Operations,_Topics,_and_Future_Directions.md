...
这篇综述系统地分析了AI系统中的记忆机制，重点关注基于大语言模型（LLMs）的智能体。作者首先将记忆表征分为参数化、结构化上下文和非结构化上下文三类，并提出了六种基本记忆操作：巩固、更新、索引、遗忘、检索和压缩。通过将这些操作映射到长期记忆、长上下文、参数修改和多源记忆等研究领域，该研究为AI记忆系统提供了一个结构化动态视角，阐明了LLMs中记忆功能的相互作用，同时指出了未来研究方向。相关资源（论文列表、数据集和工具）已在GitHub开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T21:01:23Z
- **目录日期**: 2025-05-04
