...
这篇综述探讨了AI系统中的记忆机制，重点关注基于大语言模型（LLMs）的智能体。作者将记忆表征分为参数化、结构化上下文和非结构化上下文三类，并提出了六种基本记忆操作：巩固、更新、索引、遗忘、检索和压缩。通过从原子操作和表征类型的角度重构记忆系统，该研究为AI记忆相关的研究、基准数据集和工具提供了结构化视角，阐明了LLMs智能体中记忆功能的相互作用，同时指出了未来研究方向。相关资源可在GitHub上获取。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T18:01:16Z
- **目录日期**: 2025-05-04
