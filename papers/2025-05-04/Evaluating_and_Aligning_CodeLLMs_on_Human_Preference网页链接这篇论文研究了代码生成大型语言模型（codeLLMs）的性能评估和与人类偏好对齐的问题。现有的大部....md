...
这篇论文针对代码生成大模型(codeLLMs)与人类偏好对齐的问题，提出了CodeArena基准测试和SynCode-Instruct语料库。CodeArena包含397个高质量样本，覆盖40类编程任务和44种语言，更贴近实际开发需求；SynCode-Instruct则包含近200亿标记的合成指令数据。研究发现：1)传统基于执行的评测与人类偏好存在偏差；2)开源顶尖模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究强调了代码生成模型除正确性外，还需重视与开发者实际需求的匹配度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T20:05:37Z
- **目录日期**: 2025-05-04
