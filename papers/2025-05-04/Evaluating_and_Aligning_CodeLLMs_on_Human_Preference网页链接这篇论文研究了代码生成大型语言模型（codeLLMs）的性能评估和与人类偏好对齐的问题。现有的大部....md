...
这篇论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，关注模型输出与人类偏好的对齐问题。研究收集了397个涵盖40类编程任务和44种语言的高质量样本，并构建包含近200亿标记的SynCode-Instruct合成指令集。实验发现执行基准与人类偏好评估存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，凸显了人类偏好对齐的重要性。研究为评估代码LLMs提供了更全面的框架，强调除功能性外还需考虑用户体验因素。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T00:05:45Z
- **目录日期**: 2025-05-04
