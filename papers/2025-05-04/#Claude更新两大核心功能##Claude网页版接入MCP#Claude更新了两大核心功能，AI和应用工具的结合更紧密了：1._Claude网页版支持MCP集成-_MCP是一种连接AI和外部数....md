...
Claude最新更新两大核心功能：1）网页版支持MCP协议集成，可一键连接GitLab、PayPal等10款应用，实现日程安排、数据调取等操作；2）Research功能升级，可读取MCP接入应用数据，30分钟内分析500+资料并生成带引用来源的详细报告。这些功能已向Max/Team/Enterprise用户开放，Pro用户将陆续获得。此次更新强化了AI与工具的无缝衔接，推动"大模型即服务"发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T18:03:51Z
- **目录日期**: 2025-05-04
