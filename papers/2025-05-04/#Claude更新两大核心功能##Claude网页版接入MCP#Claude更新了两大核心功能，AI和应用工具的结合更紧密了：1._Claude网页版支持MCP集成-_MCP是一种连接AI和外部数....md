...
Claude最新更新两大核心功能：1) 网页版接入MCP协议（AI界的Type-C接口），支持10款应用（如Jira、PayPal）快速集成，实现跨平台数据调用和工作流自动化；2) Research功能升级，可整合MCP应用数据源，30分钟内分析500+资料并生成带引用来源的调研报告。这些功能已向Max/Team/Enterprise用户开放，Pro用户将逐步获得。此次更新强化了AI与工具的协同能力，推动"大模型即服务"发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T09:04:02Z
- **目录日期**: 2025-05-04
