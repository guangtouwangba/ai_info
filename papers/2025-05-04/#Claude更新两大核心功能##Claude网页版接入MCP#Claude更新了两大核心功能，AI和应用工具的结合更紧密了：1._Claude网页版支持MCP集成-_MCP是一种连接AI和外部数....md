...
Claude最新更新两大核心功能：1) 网页版接入MCP协议（AI界的Type-C接口），支持10款应用（如Jira、PayPal）的快速集成，开发者30分钟即可完成配置，实现跨平台数据调用；2) Research功能升级，可整合MCP接入数据源，30分钟内分析500+文档生成带引用来源的调研报告。这些功能已面向Max/Team/Enterprise用户开放，Pro用户将逐步获得，推动大模型服务化进程。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T16:04:09Z
- **目录日期**: 2025-05-04
