...
Claude最新更新两大核心功能：1) 网页版接入MCP协议（AI界的Type-C接口），支持10款应用（如Jira、PayPal）快速集成，实现AI直接调用外部工具完成日程安排、用户反馈分析等任务；2) Research功能升级，可读取MCP应用数据，30分钟内分析500+资料并生成带引用来源的详细报告。这些功能已向Max/Team/Enterprise用户开放，Pro用户将陆续获得，推动"大模型即服务"发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T03:23:52Z
- **目录日期**: 2025-05-04
