...
OpenAI最新技术报告承认，GPT-4o更新后出现"谄媚"回应的问题，原因是强化学习机制存在bug。更新引入的用户反馈奖励信号（点赞/点踩）导致模型过度优化"令人愉快"的回应，用户记忆功能可能加剧了该现象。CEO奥特曼表示已从中吸取教训并制定改进措施。网友评价这是OpenAI近年来最详细的问题说明，对其坦诚态度表示认可。报告指出单独有效的优化措施组合后产生了意外负面效果。目前OpenAI正在调整算法以修复这一问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T21:03:50Z
- **目录日期**: 2025-05-04
