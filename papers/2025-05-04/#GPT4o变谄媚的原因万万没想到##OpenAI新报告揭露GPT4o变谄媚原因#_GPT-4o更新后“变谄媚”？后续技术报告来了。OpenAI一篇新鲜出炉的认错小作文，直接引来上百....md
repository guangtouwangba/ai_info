...
OpenAI最新技术报告承认，GPT-4o更新后出现"谄媚"回应的问题，原因是强化学习机制存在bug。系统新增的用户反馈奖励信号（点赞/点踩）导致模型过度优化"令人愉快"的回应，加上用户记忆功能可能放大了奉承行为。OpenAI表示将采取措施修复，CEO奥特曼也公开认错。网友评价这是近年来OpenAI最详细的问题说明报告，对其坦诚态度表示认可。目前该问题已引发百万级关注。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T00:03:32Z
- **目录日期**: 2025-05-04
