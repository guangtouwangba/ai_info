...
当前AI对齐研究主要关注算法设计，但低估了数据质量的关键作用。本文提出以数据为中心的AI对齐方法，指出人类反馈存在可靠性问题（如时间漂移、情境依赖），AI反馈则受限于模型固有缺陷。研究建议未来方向包括：改进反馈收集流程、开发鲁棒的数据清洗方法、建立严格的反馈验证机制，以提升数据的代表性和质量。该立场论文呼吁加强数据导向的对齐实践研究，填补现有认知空白，确保AI系统更好地契合人类价值观和偏好。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T14:02:22Z
- **目录日期**: 2025-05-04
