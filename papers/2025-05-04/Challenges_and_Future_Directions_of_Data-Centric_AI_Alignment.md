...
随着AI系统日益强大，确保其与人类价值观对齐成为关键研究方向。当前方法多聚焦算法设计，却常忽视数据质量的重要性。本文主张转向以数据为中心的AI对齐，指出人类反馈存在可靠性问题，AI反馈则受限于时间漂移、情境依赖和模型缺陷。研究建议未来应优化反馈收集流程、开发数据清洗方法、完善验证机制，以提升数据代表性和质量。该立场论文呼吁加强数据对齐实践研究，填补现有认知空白，推动AI系统更好地契合人类价值观。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T12:02:35Z
- **目录日期**: 2025-05-04
