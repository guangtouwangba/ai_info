...
当前AI对齐研究主要关注算法设计，但低估了数据质量的关键作用。本文提出以数据为中心的AI对齐方法，指出人类反馈存在不可靠性，AI反馈则受限于时间漂移、情境依赖和模型固有缺陷。研究揭示了数据代表性不足、反馈偏差等核心挑战，建议未来研究方向包括：改进反馈收集方法、开发鲁棒的数据清洗技术、建立严格的反馈验证机制。这些措施将有助于解决数据质量对AI价值观对齐的影响，推动更可靠的AI系统发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T11:02:17Z
- **目录日期**: 2025-05-04
