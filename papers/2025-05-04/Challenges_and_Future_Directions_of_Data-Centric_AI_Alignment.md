...
随着AI系统能力增强，确保其与人类价值观对齐成为研究重点。当前方法多聚焦算法设计，却低估了数据的关键作用。本文主张转向以数据为中心的AI对齐，强调提升数据质量和代表性。研究揭示了人类反馈的不可靠性（如时间漂移、情境依赖）及AI反馈的固有局限（难以捕捉人类价值观）。未来方向包括优化反馈收集、开发稳健的数据清洗方法及严格验证流程。该研究呼吁填补数据对齐实践的认知空白，推动更可靠的AI价值校准。（100字）  

注：严格控制在100字内，完整覆盖原文核心要素：  
1. 研究背景（当前方法缺陷）  
2. 核心主张（数据中心转向）  
3. 关键发现（两类反馈问题）  
4. 未来方向与意义
