...
随着AI系统能力增强，确保其与人类价值观对齐成为研究重点。当前方法过度关注算法设计而忽视数据质量。本文提出以数据为中心的AI对齐框架，指出人类反馈存在可靠性问题，AI反馈则受时间漂移、情境依赖和模型局限影响。研究建议未来方向包括：优化反馈收集流程、开发鲁棒的数据清洗方法、建立严格的验证机制，以提升数据代表性和对齐效果。该立场论文呼吁加强对数据核心问题的研究，填补现有方法论空白。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T02:33:29Z
- **目录日期**: 2025-05-04
