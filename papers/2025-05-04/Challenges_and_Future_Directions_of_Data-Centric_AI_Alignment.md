...
随着AI系统能力增强，确保其与人类价值观对齐成为研究重点。当前方法多聚焦算法设计，却忽视了数据的关键作用。本文主张转向以数据为中心的AI对齐，强调提升数据质量和代表性。研究揭示了人类反馈的不可靠性，以及AI反馈因模型局限导致的价值偏差问题，包括时间漂移和情境依赖等挑战。未来研究方向包括优化反馈收集机制、开发稳健的数据清洗方法及严格的验证流程。该文呼吁填补数据对齐实践中的认知空白，推动相关研究发展。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T16:02:11Z
- **目录日期**: 2025-05-04
