...
本文提出了一种基于有限演示数据学习人类感知与控制模型的通用估计方法。该模型结构包含：1) 智能体对环境动态的内部表征；2) 对可观测结果的偏好。研究采用与认知科学中"主动推理"理论一致的模型框架，认为人类行为旨在最小化"意外"（实际观察与偏好观察的差异）。作者提出基于先验分布结构假设的双层优化估计方法，并以自然驾驶数据中的跟车行为建模为例验证方法有效性。结果表明，这种主动推理模型相比黑箱模型能更好地解释人类驾驶行为，为理解人类感知控制机制提供了新思路。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-04T23:02:27Z
- **目录日期**: 2025-05-04
