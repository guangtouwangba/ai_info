...
该研究介绍了AgentSociety，这是一个基于大语言模型的大规模社会模拟系统，能够模拟1万多个代理的互动行为。通过研究社会极化、信息传播、基本收入政策及自然灾害影响等案例，该系统展现出与传统研究方法相似的结果验证能力，为社会科学研究和政策制定提供了新的计算实验平台。结果表明，AgentSociety能有效捕捉人类行为模式及其内在机制，具有重要的学术和应用价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T18:04:56Z
- **目录日期**: 2025-05-06
