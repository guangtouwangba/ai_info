...
AgentSociety是一种基于大语言模型的大规模社会模拟系统，能模拟1万多个代理及其500万次互动。研究者利用该平台研究了社会极化、信息传播、基本收入政策及自然灾害影响等社会问题。模拟结果与现实数据高度吻合，验证了系统捕捉人类行为机制的能力，展示了其作为社会科学研究和政策制定工具的潜力。该系统整合了生成式AI、真实社会环境和大规模模拟技术，为传统研究方法提供了补充。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T06:04:57Z
- **目录日期**: 2025-05-06
