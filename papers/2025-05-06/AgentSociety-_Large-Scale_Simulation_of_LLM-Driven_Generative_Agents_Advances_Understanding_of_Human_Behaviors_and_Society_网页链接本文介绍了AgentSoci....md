...
AgentSociety是一种基于大语言模型的大规模社会模拟器，可模拟1万个代理及其500万次互动。它通过真实社会环境研究社会问题，如信息传播、政策影响和自然灾害应对。模拟结果与现实数据吻合，验证了其捕捉人类行为机制的能力。该系统可作为计算社会科学实验平台，辅助传统研究方法，为研究者和政策制定者提供新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T11:05:15Z
- **目录日期**: 2025-05-06
