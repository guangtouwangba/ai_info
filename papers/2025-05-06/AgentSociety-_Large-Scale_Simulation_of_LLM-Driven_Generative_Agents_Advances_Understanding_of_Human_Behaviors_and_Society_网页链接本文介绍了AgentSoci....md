...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能模拟1万多个代理的社会互动（500万次交互）。研究者用它研究了社会极化、信息传播、基本收入政策及自然灾害影响等社会问题。模拟结果与现实数据吻合，验证了该系统在分析人类行为机制方面的有效性。该平台可作为传统社会科学研究方法（如调查、实验）的补充工具，帮助研究者探索社会问题的成因和模式，为政策制定提供新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T09:05:23Z
- **目录日期**: 2025-05-06
