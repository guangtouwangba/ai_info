...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟1万多个代理的社会互动（500万次交互）。它被用于研究极化现象、信息传播、基本收入政策及外部冲击等社会问题，结果与现实实验吻合。该系统能有效捕捉人类行为机制，为社会科学研究和政策制定提供新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T08:05:18Z
- **目录日期**: 2025-05-06
