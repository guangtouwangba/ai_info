...
该研究开发了AgentSociety大规模社会模拟器，通过1万多个LLM驱动的代理模拟了500万次社会互动。该系统作为计算社会科学实验平台，研究了社会极化、信息传播、基本收入政策及自然灾害影响等四大社会问题。模拟结果与现实数据高度吻合，证明其能有效捕捉人类行为机制。该工具为社会科学研究和政策制定提供了新方法，可辅助传统调查和干预研究。研究展示了LLM驱动代理在模拟复杂社会现象方面的潜力，为理解人类社会行为提供了创新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T13:14:35Z
- **目录日期**: 2025-05-06
