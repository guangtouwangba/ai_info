...
这篇论文介绍了AgentSociety，这是一个基于大语言模型(LLM)的大规模社会模拟系统，能够模拟超过1万个智能代理的社会互动(500万次交互)。研究者利用该系统研究了四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，证明了该系统在理解人类行为机制和社会问题方面的有效性。AgentSociety为社会科学研究和政策制定提供了新的计算实验平台，能够补充传统研究方法(如调查和访谈)，帮助揭示社会问题的模式和潜在机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T05:05:02Z
- **目录日期**: 2025-05-06
