...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟1万多个代理及其500万次互动。研究者用它研究了社会极化、信息传播、基本收入政策和自然灾害影响等社会问题。模拟结果与现实世界数据吻合，验证了其捕捉人类行为机制的能力。该系统可作为计算社会科学实验平台，为研究者和政策制定者提供新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T17:05:20Z
- **目录日期**: 2025-05-06
