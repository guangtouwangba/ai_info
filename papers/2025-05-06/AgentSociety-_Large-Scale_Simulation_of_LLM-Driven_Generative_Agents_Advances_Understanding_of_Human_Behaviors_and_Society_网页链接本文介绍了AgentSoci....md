...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能模拟1万多个代理的社会生活及500万次互动。研究者用它研究了社会极化、信息传播、基本收入政策及飓风影响等社会问题，结果与现实实验吻合。该系统结合了语言模型代理、真实社会环境和大规模模拟引擎，可作为计算社会科学实验平台，帮助理解人类行为模式和社会机制，为研究者和政策制定者提供新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T04:05:19Z
- **目录日期**: 2025-05-06
