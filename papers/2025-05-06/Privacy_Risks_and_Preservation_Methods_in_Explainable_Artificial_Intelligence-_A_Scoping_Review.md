...
可解释人工智能（XAI）是可信AI的核心，旨在提升复杂模型的透明度，但其解释功能可能引发隐私风险。本文通过文献综述（2019-2024年57篇研究）探讨了三大问题：(1)XAI解释可能泄露敏感数据或模型细节；(2)现有隐私保护方法包括数据脱敏、差分隐私和联邦学习；(3)隐私合规的解释需满足最小披露、可控访问等特性。研究归纳了XAI中的隐私风险类型和保护技术，提出了隐私保护解释的特征框架，并指出平衡隐私与其他系统需求的挑战。该综述揭示了可信AI两大原则——可解释性与隐私之间的复杂关系，为开发合规XAI系统提供指导。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T13:10:09Z
- **目录日期**: 2025-05-06
