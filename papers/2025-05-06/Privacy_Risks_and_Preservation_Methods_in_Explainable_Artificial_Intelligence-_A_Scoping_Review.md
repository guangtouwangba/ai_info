...
这篇综述探讨了可解释人工智能（XAI）与隐私保护之间的冲突。通过分析2019-2024年的57篇文献，研究发现：1）XAI解释可能泄露敏感数据；2）现有隐私保护方法包括差分隐私和模型脱敏；3）隐私保护解释应满足特定特征。研究将隐私风险和保护方法分类，提出了平衡隐私与其他系统需求的建议。作为可信AI的两大支柱，解释性与隐私之间存在复杂关系，该研究为开发合规的隐私保护XAI系统提供了指导。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T09:01:01Z
- **目录日期**: 2025-05-06
