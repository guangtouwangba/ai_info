...
这篇综述探讨了可解释人工智能(XAI)与隐私保护之间的冲突。通过对2019-2024年间1943项研究的筛选分析，研究者提取了57篇相关文献，重点回答了三个问题：(1)AI系统提供解释时存在的隐私风险；(2)当前XAI系统中实现隐私保护的方法；(3)隐私保护解释应具备的特征。研究将XAI中的隐私风险和防护方法进行了分类，并提出了隐私保护解释的特征框架，以帮助开发符合隐私要求的XAI系统。最后指出了在隐私与其他系统需求之间取得平衡的挑战，为构建隐私保护的XAI提供了建议。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T04:01:04Z
- **目录日期**: 2025-05-06
