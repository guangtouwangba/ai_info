...
这篇综述探讨了可解释人工智能(XAI)与隐私保护之间的冲突。通过系统分析2019-2024年间的57篇文献，研究揭示了XAI系统发布解释时面临的隐私风险、现有隐私保护方法，以及隐私保护解释应具备的特征。研究发现，虽然XAI是可信AI的重要支柱，但提供解释信息可能带来隐私泄露风险。文章对隐私风险和防护方法进行了分类，提出了隐私保护解释的关键特性，并指出了在隐私与其他系统需求之间取得平衡的挑战。该研究有助于理解可信AI中隐私与可解释性这两个基本原则的复杂关系。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T17:01:15Z
- **目录日期**: 2025-05-06
