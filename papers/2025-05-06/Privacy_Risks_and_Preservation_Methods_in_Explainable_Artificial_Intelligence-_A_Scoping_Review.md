...
这篇综述探讨了可解释人工智能(XAI)与隐私保护之间的冲突。研究通过系统性文献回顾(2019-2024年57篇文献)分析了三个核心问题：(1)AI系统提供解释时的隐私风险；(2)现有隐私保护方法；(3)隐私保护解释的特征。研究发现XAI在提高透明度的同时可能泄露敏感信息，作者对隐私风险和防护方法进行了分类，并提出了隐私保护解释应具备的特征。最后，文章指出了平衡隐私与其他系统需求的挑战，为构建隐私合规的XAI提供了建议，旨在阐明可信AI中隐私与可解释性这两个基本原则的复杂关系。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T08:01:09Z
- **目录日期**: 2025-05-06
