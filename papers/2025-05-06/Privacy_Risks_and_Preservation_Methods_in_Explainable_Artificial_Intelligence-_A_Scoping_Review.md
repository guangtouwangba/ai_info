...
可解释人工智能（XAI）作为可信AI的核心，旨在提升复杂模型透明度，但其解释信息可能引发隐私风险。本文通过综述2019-2024年57篇文献，探讨了三大问题：1）XAI解释可能泄露敏感数据或模型细节；2）现有隐私保护方法包括差分隐私、联邦学习等；3）隐私保护型解释应具备数据匿名化、模型保密等特性。研究归纳了XAI中的隐私风险类型和保护技术，提出了隐私合规解释的标准，并指出平衡隐私与其他系统需求的挑战。该综述揭示了可信AI中隐私性与可解释性这对核心原则的复杂关系，为隐私保护型XAI的发展提供了方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T03:17:34Z
- **目录日期**: 2025-05-06
