...
可解释人工智能（XAI）作为可信AI的核心，旨在提升复杂模型的透明度，但同时也引发了隐私保护问题。本文通过文献综述（2019-2024年57篇研究）探讨了三个核心问题：1）XAI解释功能带来的隐私风险；2）现有隐私保护方法；3）隐私保护解释的特征。研究归纳了XAI中的隐私风险类型和保护技术，提出了隐私保护解释应具备的特性，并指出平衡隐私与其他系统需求的挑战。该综述揭示了可信AI两大原则——可解释性与隐私保护间的复杂关系，为开发合规的隐私保护XAI系统提供了实践建议。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T11:01:10Z
- **目录日期**: 2025-05-06
