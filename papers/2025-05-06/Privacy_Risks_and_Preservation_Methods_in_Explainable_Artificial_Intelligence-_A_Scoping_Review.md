...
可解释人工智能（XAI）是可信AI的核心，旨在提升复杂模型的透明度，但其解释功能可能引发隐私风险。本文通过文献综述（2019-2024年57篇研究）探讨了三大问题：1）XAI解释可能泄露敏感数据或模型细节；2）现有隐私保护方法包括数据脱敏、差分隐私和联邦学习；3）隐私合规的解释应具备匿名性、最小信息披露和可控访问。研究将隐私风险分为数据泄露和模型暴露两类，并提出平衡隐私与其他系统需求面临技术、法规等挑战。该综述揭示了可信AI中隐私与可解释性这对矛盾的交互关系，为开发隐私友好的XAI系统提供了方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T16:01:21Z
- **目录日期**: 2025-05-06
