...
这篇综述探讨了可解释人工智能(XAI)与隐私保护之间的冲突。通过分析2019-2024年间的57篇文献，研究揭示了XAI系统发布解释时可能带来的隐私风险，总结了现有的隐私保护方法，并提出了隐私保护解释应具备的特征。研究发现，虽然XAI是可信AI的重要支柱，但提供解释信息可能泄露敏感数据。文章对隐私风险和保护方法进行了分类，并提出了平衡隐私与其他系统需求的建议。这项研究有助于理解可信AI中隐私与可解释性这两个基本原则的复杂关系，为开发隐私合规的XAI系统提供指导。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T23:01:08Z
- **目录日期**: 2025-05-06
