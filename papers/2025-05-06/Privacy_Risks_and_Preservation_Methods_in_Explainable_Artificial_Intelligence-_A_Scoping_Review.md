...
这篇综述探讨了可解释人工智能(XAI)与隐私保护之间的冲突。通过分析2019-2024年间的57篇文献，研究回答了三个核心问题：XAI系统发布解释时存在的隐私风险、现有的隐私保护方法，以及隐私保护解释应具备的特征。研究发现，XAI在提供透明性的同时可能泄露敏感信息，因此需要平衡解释性与隐私保护。文章对隐私风险和防护方法进行了分类，并提出了隐私保护解释的标准，以帮助开发符合隐私要求的XAI系统。最后指出了在系统需求间取得平衡的挑战，为构建隐私保护的XAI提供了建议。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T07:01:14Z
- **目录日期**: 2025-05-06
