...
这篇综述探讨了可解释人工智能(XAI)与隐私保护之间的冲突。研究者通过系统分析2019-2024年的57篇文献，回答了三个核心问题：(1)XAI系统提供解释时可能泄露敏感数据；(2)现有隐私保护方法包括数据脱敏、模型加密等；(3)隐私保护解释应具备的特征。研究归纳了XAI中的隐私风险和保护技术，提出了隐私合规解释的标准，并指出平衡隐私与其他系统需求的挑战。该综述揭示了可信AI两大支柱——可解释性与隐私之间的复杂关系，为开发隐私保护的XAI系统提供了指导。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T14:01:09Z
- **目录日期**: 2025-05-06
