...
这篇综述探讨了可解释人工智能(XAI)与隐私保护之间的冲突关系。研究通过系统分析2019-2024年间的57篇文献，回答了三个核心问题：(1)AI系统提供解释时存在的隐私风险；(2)当前XAI系统中的隐私保护方法；(3)隐私保护解释应具备的特征。研究对隐私风险和防护方法进行了分类，提出了隐私保护解释的关键特性，帮助研究者理解符合隐私要求的XAI系统。同时指出了平衡隐私与其他系统需求时的挑战，并给出实现隐私保护XAI的建议。这项研究揭示了可信AI两大基本原则——可解释性与隐私之间的复杂关系。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T18:01:05Z
- **目录日期**: 2025-05-06
