...
可解释人工智能（XAI）作为可信AI的核心，旨在提升复杂模型的透明度。然而，在提供解释信息的同时也引发了隐私风险。本文通过文献综述（2019-2024年57篇研究）探讨了三大问题：(1)XAI解释可能泄露敏感数据；(2)现有隐私保护方法（如差分隐私、模型脱敏）；(3)隐私保护解释的特征（如数据匿名化、最小信息披露）。研究归纳了XAI中的隐私风险类型和保护技术，提出了兼顾隐私与解释性的方案，并指出平衡系统多目标间的挑战。该综述揭示了可信AI中隐私与可解释性这对核心原则的复杂关系，为开发合规XAI系统提供了指导。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T06:01:02Z
- **目录日期**: 2025-05-06
