...
该论文针对代码生成大模型(codeLLMs)提出新评估框架CodeArena，通过397个涵盖40类编程任务的真实样本和44种语言，评估模型与人类偏好的对齐程度。研究发现传统执行基准与人类偏好存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。同时构建20B标记量的合成指令数据集SynCode-Instruct，验证了大规模仿真指令微调的有效性，强调了对齐人类偏好在代码生成领域的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T07:05:53Z
- **目录日期**: 2025-05-06
