...
这篇论文针对代码生成大模型(codeLLMs)提出新评估框架CodeArena，强调人类偏好对齐的重要性。研究者构建了包含397个样本(覆盖40类44种语言)的基准测试，并开发20B标记的合成指令数据集SynCode-Instruct。实验发现：1)传统基于执行的评估与人类偏好存在差距；2)开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著。研究证实大规模指令微调的有效性，凸显了在代码生成任务中考虑人类编程习惯的关键作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T22:05:19Z
- **目录日期**: 2025-05-06
