...
这篇论文针对代码生成大模型(codeLLMs)与人类偏好对齐的问题，提出了CodeArena基准测试(包含397个高质量样本，覆盖40类任务和44种编程语言)和SynCode-Instruct合成指令数据集(近200亿标记)。研究发现：1)传统执行测试与人类偏好存在偏差；2)开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI)在人类偏好匹配上存在显著差距。研究强调了对齐人类偏好的重要性，为评估代码生成模型提供了更全面的框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T17:05:57Z
- **目录日期**: 2025-05-06
