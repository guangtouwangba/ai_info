...
该论文针对代码生成大模型(codeLLMs)提出新评估方法，指出当前基准测试过于关注代码正确性而忽视人类偏好。研究团队构建了CodeArena基准(包含397个高质量样本，覆盖40类任务和44种语言)和SynCode-Instruct合成指令集(近200亿标记)。实验发现：1)传统执行基准与CodeArena存在性能差异；2)开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI)在人类偏好对齐方面差距显著。研究强调代码生成模型需同时兼顾功能正确性和人类可接受性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T01:34:10Z
- **目录日期**: 2025-05-06
