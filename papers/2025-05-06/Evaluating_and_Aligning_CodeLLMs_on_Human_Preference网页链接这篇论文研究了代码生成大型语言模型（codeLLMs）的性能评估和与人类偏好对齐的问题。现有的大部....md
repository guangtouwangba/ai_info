...
这篇论文针对代码生成大模型(codeLLMs)提出新评估框架CodeArena，关注模型输出与人类偏好的对齐问题。研究者构建了包含397个高质量样本的基准测试(覆盖40类任务和44种语言)，并开发20B标记的合成指令数据集SynCode-Instruct。实验发现：1)传统执行正确性评估与人类偏好存在偏差；2)开源顶尖模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究强调了在代码生成任务中，除功能性外还需重视人类可读性、实用性等主观维度的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T23:05:44Z
- **目录日期**: 2025-05-06
