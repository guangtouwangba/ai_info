...
该研究针对代码生成大模型(codeLLMs)提出CodeArena基准测试，关注模型输出与人类偏好的对齐问题。通过397个涵盖40类编程任务、44种语言的真实样本，以及20B标记的合成指令数据集SynCode-Instruct，研究发现：1)传统执行基准与人类偏好存在差异；2)开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究强调在代码生成任务中，除正确性外还需重视人类偏好对齐，为模型评估提供了新维度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T11:05:54Z
- **目录日期**: 2025-05-06
