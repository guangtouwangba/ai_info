...
这篇论文针对代码生成大模型(codeLLMs)提出CodeArena基准，通过397个涵盖40类编程任务和44种语言的样本评估模型与人类偏好的匹配度。研究发现传统基于执行的测试与人类偏好存在差异，并构建了20B标记的SynCode-Instruct合成指令集验证微调效果。实验显示开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)存在显著性能差距，凸显了代码LLMs与人类偏好对齐的重要性。该研究为提升代码生成模型的实用性和用户体验提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T19:05:36Z
- **目录日期**: 2025-05-06
