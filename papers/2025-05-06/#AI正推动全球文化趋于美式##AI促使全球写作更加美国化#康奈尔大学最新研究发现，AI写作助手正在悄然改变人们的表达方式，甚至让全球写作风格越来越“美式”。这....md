...
康奈尔大学研究发现，AI写作助手正在推动全球写作风格"美式化"。实验显示，印度用户更依赖AI建议（接受率25% vs 美国19%），但需更多修改；AI使印度写作在词汇、文化元素（如节日/食物描述）上更接近美国风格，形成单向"文化迁移"。使用AI后，两国作品相似度提高，文化背景更难辨别，甚至影响深层价值观表达。研究警告这可能造成"数字同化"，呼吁开发更具文化包容性的AI系统。论文链接：https://arxiv.org/pdf/2409.11360

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T10:02:58Z
- **目录日期**: 2025-05-06
