...
康奈尔大学研究发现AI写作助手正在推动全球写作风格"美式化"。研究对比了118名美国和印度用户使用AI辅助写作的情况，发现印度用户更依赖AI建议(接受率25% vs 19%)，但需要更多修改。AI使用导致印度用户的写作在词汇、文化元素(如节日/食物描述)和表达方式上都更接近美国风格，形成单向"文化迁移"。更值得注意的是，AI还潜移默化地改变了深层的价值观表达方式。研究警告这可能造成"数字同化"，呼吁开发更具文化包容性的AI系统。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T15:03:55Z
- **目录日期**: 2025-05-06
