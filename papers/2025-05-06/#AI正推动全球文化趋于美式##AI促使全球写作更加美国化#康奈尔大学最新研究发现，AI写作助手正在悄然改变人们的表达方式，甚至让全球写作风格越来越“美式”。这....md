...
康奈尔大学研究发现AI写作助手正推动全球写作风格"美国化"。实验显示，印度用户更依赖AI建议(25% vs 美国19%)，但需更多修改。AI提高了写作效率，却使印度用户的表达更接近美式英语，文化元素(如节日/食物描述)明显西化。使用AI后，印美写作差异缩小，且对美国风格几乎无影响，形成单向"文化迁移"。更值得关注的是，AI还改变了深层的价值观表达方式。研究警告，当前AI模型可能加速"数字同化"，呼吁开发更具文化包容性的AI系统。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T18:03:00Z
- **目录日期**: 2025-05-06
