...
康奈尔大学研究发现，AI写作助手正在推动全球写作风格"美式化"。实验显示，印度用户更依赖AI建议（接受率25% vs 美国19%），但需更多修改。AI提高了写作效率，却使印度用户的表达更接近美式英语，文化元素（如节日、食物）明显西化。更关键的是，AI模糊了文化差异，使美印写作风格趋同，甚至在价值观表达层面引发深层改变。研究警告，当前AI模型可能导致"数字同化"，呼吁开发更具文化包容性的系统，以避免消解文化多样性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T17:03:17Z
- **目录日期**: 2025-05-06
