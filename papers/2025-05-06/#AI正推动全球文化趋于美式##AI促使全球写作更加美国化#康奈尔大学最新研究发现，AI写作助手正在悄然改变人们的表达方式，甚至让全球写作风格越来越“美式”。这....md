...
康奈尔大学研究发现AI写作助手正在推动全球写作风格"美式化"。研究对比了118名美印参与者的写作表现，发现印度用户更依赖AI建议(25% vs 19%)但修改更频繁。AI提高了写作效率，但导致印度用户的表达更接近美式英语，文化特征(如节日/食物描述)被美国元素取代。使用AI后，两国写作风格趋同，且AI对美国写作几乎没有影响，形成单向"文化迁移"。更值得警惕的是，AI还改变了深层的价值观表达方式。研究呼吁开发更具文化包容性的AI模型，防止数字同化加剧文化消解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T21:03:02Z
- **目录日期**: 2025-05-06
