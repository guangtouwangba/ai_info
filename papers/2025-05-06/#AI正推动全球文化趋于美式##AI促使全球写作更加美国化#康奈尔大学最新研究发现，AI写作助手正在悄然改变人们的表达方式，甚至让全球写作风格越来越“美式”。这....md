...
康奈尔大学研究发现AI写作助手正推动全球写作风格"美式化"。研究对比美印118名参与者发现：1)印度用户更依赖AI建议(25% vs 19%)但修改更频繁；2)AI提高写作效率但美国用户获益更大；3)印度写作风格向美式英语靠拢，文化元素更倾向美国特色；4)AI使两国写作差异缩小，形成单向"文化迁移"；5)深层价值观表达也趋同。研究者警告这可能造成"数字同化"，呼吁开发更具文化包容性的AI系统。论文详见：https://arxiv.org/pdf/2409.11360 (100字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T14:03:15Z
- **目录日期**: 2025-05-06
