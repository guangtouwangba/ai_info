...
康奈尔大学研究发现，AI写作助手正推动全球写作风格"美式化"。研究比较了118名美印参与者的写作表现，发现印度用户更依赖AI建议(接受率25% vs 美国19%)，但需更多修改。AI虽提升效率，却使印度写作在词汇、文化元素(如节日/食物描述)上趋近美国风格，形成单向"文化迁移"。更值得警惕的是，AI还潜移默化改变了深层的价值观表达方式。研究者警告，当前AI模型可能导致"数字同化"，呼吁开发更具文化包容性的系统，以避免消解文化多样性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T12:03:18Z
- **目录日期**: 2025-05-06
