...
康奈尔大学研究发现，AI写作助手正导致全球写作风格"美式化"。实验显示，印度用户比美国人更依赖AI建议（25% vs 19%），但需更多修改。AI提高了写作效率，却使印度用户的表达更接近美式英语，推荐美国文化元素（如圣诞节、披萨）多于本土特色。使用AI后，印美写作风格差异减小，形成单向"文化迁移"，甚至影响深层价值观表达。研究者警告，当前AI模型可能加速"数字同化"，呼吁开发更具文化包容性的系统，以避免消解文化多样性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T23:03:01Z
- **目录日期**: 2025-05-06
