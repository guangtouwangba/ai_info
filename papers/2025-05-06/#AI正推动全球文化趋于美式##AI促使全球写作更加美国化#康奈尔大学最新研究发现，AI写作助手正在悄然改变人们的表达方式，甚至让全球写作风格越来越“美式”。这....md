...
康奈尔大学研究发现，AI写作助手正导致全球写作风格"美式化"。实验显示，印度用户更依赖AI建议（接受率25% vs 美国19%），但需更多修改。AI提高了写作效率，却使印度用户的表达更接近美式英语，如偏好推荐圣诞节、披萨等美国文化元素。使用AI后，印美写作风格差异缩小，且AI主要单向影响印度用户。更值得关注的是，AI还改变了深层的价值观表达方式。研究警告，当前AI模型可能加速"数字同化"，呼吁开发更具文化包容性的系统以保护文化多样性。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T16:03:24Z
- **目录日期**: 2025-05-06
