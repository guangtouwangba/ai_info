# #AI看病靠谱吗##AI医生难以与真实患者沟通#身体不舒服？打开手机问问AI可能是什么原因吧！自打AI飞入寻常百姓家，越来越多人开始使用AI给自己“看病”，甚至还有...
...
牛津大学研究发现AI医疗咨询存在显著沟通障碍。研究让1300名志愿者通过AI或网络搜索诊断模拟病例，结果显示：1）患者常无法提供关键症状信息（如头痛发作特点、病史）；2）患者仅能识别34.5%的相关病症和44.2%的处置建议；3）AI虽具备丰富医学知识，但人机交互缺陷导致诊断效率低下。研究者指出，正式应用前需系统测试人机交互表现。该研究揭示了当前AI医疗建议的核心痛点——信息输入不完整与建议采纳困难。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T02:39:18Z
- **目录日期**: 2025-05-06
