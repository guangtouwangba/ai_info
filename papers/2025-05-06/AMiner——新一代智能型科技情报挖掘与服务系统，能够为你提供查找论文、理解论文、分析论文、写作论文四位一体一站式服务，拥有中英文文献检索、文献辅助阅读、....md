...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、AI辅助阅读、翻译、科研情报订阅等功能。平台收录3.5亿论文、0.6亿学者等海量数据，支持用户通过提问快速获取文献摘要和核心内容，并定制最新科研动态推送。其AI工具可自动生成论文概要、解答疑问，还能分析学者画像和学术趋势。基础功能免费开放，适合研究者高效获取和管理学术资源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T17:05:45Z
- **目录日期**: 2025-05-06
