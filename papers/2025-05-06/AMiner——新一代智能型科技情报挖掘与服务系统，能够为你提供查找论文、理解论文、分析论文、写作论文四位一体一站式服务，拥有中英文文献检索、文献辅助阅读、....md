...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、科研情报订阅等一站式服务。它拥有3.5亿论文、0.6亿学者等海量学术资源，支持文献辅助阅读、AI摘要生成和智能问答，帮助用户高效筛选和理解文献。用户可定制订阅最新科研动态，还能使用学者画像、学术会议等特色功能。平台提供免费基础服务，可通过网页或微信小程序访问。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T21:05:33Z
- **目录日期**: 2025-05-06
