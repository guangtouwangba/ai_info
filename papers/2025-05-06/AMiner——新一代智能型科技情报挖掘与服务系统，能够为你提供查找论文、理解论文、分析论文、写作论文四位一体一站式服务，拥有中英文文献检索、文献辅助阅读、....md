...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译、科研动态订阅等一站式服务。它收录3.5亿论文、0.6亿学者等海量数据，支持中英文文献搜索、AI生成摘要、互动问答等功能，帮助用户高效获取和理解学术信息。用户可定制科研情报推送，跟踪特定学者或关键词的最新研究。平台还提供学者画像、学术会议等特色功能，基础服务免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T12:05:54Z
- **目录日期**: 2025-05-06
