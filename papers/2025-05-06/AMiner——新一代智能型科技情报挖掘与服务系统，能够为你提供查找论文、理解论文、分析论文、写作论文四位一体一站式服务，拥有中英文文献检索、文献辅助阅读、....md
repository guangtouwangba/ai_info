...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、翻译、辅助阅读和论文写作支持。它拥有庞大的学术资源库（3.5亿论文、0.6亿学者等），支持AI生成摘要、章节概要和智能问答，帮助用户快速理解文献内容。平台还提供科研动态订阅服务，可根据用户偏好推送最新研究成果。此外，AMiner具备学者画像、学术会议追踪等功能，基础服务免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T04:05:48Z
- **目录日期**: 2025-05-06
