...
这项研究开发了一个基于智能体的模型(ABM)，用于模拟社区对飓风引发基础设施中断的韧性，重点关注电力与交通网络间的相互依赖性。模型包含电网、交通网、风灾/洪水灾害和家庭智能体，并以佛罗里达州迈阿密-戴德县33147邮编区域为案例。研究模拟了三种恢复策略：基于组件、距离和交通信号灯。验证显示模型与飓风"艾尔玛"数据一致。结果表明：优先恢复交通信号灯的策略既能保障信号恢复，又不延误家庭供电；道路通畅和燃料运输顺畅能加快电力恢复。研究强调了交通信号快速修复对减少事故的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T02:38:05Z
- **目录日期**: 2025-05-06
