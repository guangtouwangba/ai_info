...
这项研究开发了一个基于代理的模型(ABM)，模拟社区对飓风引发基础设施中断的恢复能力，重点关注电力与交通网络间的相互依赖性。模型包含电网、交通网、风灾/洪水灾害和家庭代理，并以佛罗里达州迈阿密-戴德县(邮编33147)为案例。研究模拟了三种恢复策略：基于组件、距离和交通信号灯的恢复方式，验证了模型与飓风"Irma"数据的一致性。结果表明，优先恢复交通信号灯的策略既不影响家庭供电恢复，又能提升整体效率；道路可通行性和燃料运输时效性会显著影响电力恢复速度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T17:02:35Z
- **目录日期**: 2025-05-06
