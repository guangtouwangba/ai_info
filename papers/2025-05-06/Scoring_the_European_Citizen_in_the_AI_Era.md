...
欧盟《人工智能法案》禁止了受中国"社会信用体系"启发的社会评分系统，但允许欧洲现有的信用评级、员工监控等高风险AI评分系统。尽管表面看该禁令对欧洲现行实践影响有限，但研究表明禁令条款具有灵活性，可与《通用数据保护条例》第22条形成互补，有效防止AI评分的不当使用。该禁令并非仅是防范威权体制的象征性条款，而是能切实保护个人权利的法律工具。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T22:01:40Z
- **目录日期**: 2025-05-06
