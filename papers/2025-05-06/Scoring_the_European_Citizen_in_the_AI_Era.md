...
欧盟《人工智能法案》禁止了受中国"社会信用体系"启发的社会评分系统，但允许欧洲现有的信用评估、员工监控等高风险AI评分系统在监管下运行。该禁令看似对现有评分实践无实质影响，但研究表明其条款设计灵活，可与《通用数据保护条例》第22条形成互补，有效防止基于AI的评分系统被过度使用。该禁令并非仅是防范极权制度的象征性条款，而是能切实保护个人权利的法律工具。（99字）  

注：严格控制在100字内，保留原文三个核心要素：  
1. 中欧评分系统的差异对比  
2. 禁令表面影响与实际效用的矛盾  
3. 与GDPR协同保护人权的法律价值
