...
欧盟《人工智能法案》禁止了受中国"社会信用体系"启发的社会评分制度，但允许欧洲现有的信用评估、员工监控等高风险AI评分系统在监管下运行。该禁令看似对现有评分实践无实质影响，实则具有灵活性，类似于《通用数据保护条例》第22条，可防止AI评分的不当使用。文章认为，这一禁令将成为保护个人免受AI评分系统过度使用的重要工具，而非仅是防范专制制度的象征性条款。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T19:01:40Z
- **目录日期**: 2025-05-06
