...
欧盟《人工智能法案》禁止了受中国"社会信用体系"启发的社会评分系统，但允许欧洲现有的信用评估、员工监控等高风险AI评分系统在监管下运行。该禁令看似对现有实践无实质影响，实则通过灵活条款成为保护个人的重要工具，类似于《通用数据保护条例》第22条，可防止AI评分的不当使用。文章认为这一禁令并非象征性条款，而是能有效制约基于AI的过度评分行为。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T02:34:46Z
- **目录日期**: 2025-05-06
