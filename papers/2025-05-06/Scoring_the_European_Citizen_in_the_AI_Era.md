...
欧盟《人工智能法案》禁止了受中国"社会信用体系"启发的社会评分系统，但允许欧洲现有的信用评估、员工监控等高风险AI评分系统在监管下运行。该禁令看似对现有评分实践影响有限，实则具有灵活性，可与《通用数据保护条例》第22条形成互补，防止AI评分的不当使用。研究表明，该禁令将成为保护个人免受AI评分过度使用的重要工具，而非仅针对潜在威权制度的预防措施。法案通过区分禁止性社会评分与受监管的高风险评分，在技术创新与个人权利保护间寻求平衡。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T14:01:51Z
- **目录日期**: 2025-05-06
