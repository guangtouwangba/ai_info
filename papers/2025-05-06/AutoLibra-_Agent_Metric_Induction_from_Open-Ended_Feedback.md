...
AutoLibra是一个基于人类开放反馈的智能体评估框架，将模糊反馈（如“按钮禁用时不应重复点击”）转化为细粒度行为指标。它通过关联反馈与行为、聚类正负行为示例，生成可量化指标，并利用LLM作为评估者。该框架提出“覆盖率”和“冗余度”两个元指标优化指标质量。实验显示，AutoLibra生成的指标比传统任务成功率更有效，在文本游戏任务中使智能体性能平均提升20%，并能筛选高质量微调数据。研究表明，AutoLibra是任务无关的智能体评估与改进工具。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T20:01:19Z
- **目录日期**: 2025-05-06
