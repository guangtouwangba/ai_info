# #OpenAI公司结构调整##OpenAI继续由非营利实体控制# OpenAI的公司结构，终于是尘埃落定了。就在刚刚，OpenAI官方重磅宣布：将继续由目前的非营利组织控制。除此...
...
OpenAI宣布公司结构调整最终方案，确认将继续由非营利组织控制。主要调整包括：1）现有营利部门转型为公益公司（PBC）；2）非营利组织将作为PBC的大股东保持控制权；3）双方维持共同使命。该决定是在与政府机构协商后作出。Sam Altman发布全员信说明此次调整。新结构保持了非营利性质，同时通过公益公司形式平衡商业运作需求。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T03:20:03Z
- **目录日期**: 2025-05-06
