...
芝加哥大学研究发现，约60%学生承认使用AI工具，但90%认为他人使用更多。多数学生低估自身AI使用频率，认为同学使用更频繁（每周4-5天），而自称仅0-1天。这种现象被称为"AI羞耻"，源于对AI内容缺乏创意、涉及学术诚信的担忧。STEM专业学生也存在类似心理。研究指出，尽管AI技术快速发展，其应用仍面临负面评价，合理使用边界尚待探索。该现象不仅存在于教育领域，也反映了社会对新技术应用的矛盾态度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T16:02:59Z
- **目录日期**: 2025-05-06
