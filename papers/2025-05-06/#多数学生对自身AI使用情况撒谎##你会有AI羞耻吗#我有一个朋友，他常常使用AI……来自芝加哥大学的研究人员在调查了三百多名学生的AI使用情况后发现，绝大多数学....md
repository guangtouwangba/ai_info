...
芝加哥大学研究发现，约60%学生承认使用AI工具，但认为90%的同学在使用，且多数低估自身使用频率。这种现象被称为"AI羞耻"，源于对AI生成内容缺乏创意和学术诚信的担忧。STEM专业学生也存在类似心理。研究显示，新技术应用本应是优势，但AI使用常引发负面评价。该现象不仅存在于教育领域，也反映出社会对AI合理应用的持续探索。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T20:02:47Z
- **目录日期**: 2025-05-06
