...
芝加哥大学研究发现，约60%学生承认使用AI工具，但估计90%的同学会使用，显示多数人低估自身AI使用频率。学生普遍认为他人使用AI更频繁（每周4-5天），而自评仅为0-1天。这种现象被称为"AI羞耻"，源于对AI生成内容缺乏创意、涉及学术诚信的担忧。研究指出，尽管AI技术快速发展，其合理应用仍存争议，使用AI常招致负面评价，导致用户不愿公开承认。该现象不仅存在于教育领域，也反映社会对新技术应用的矛盾心态。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T13:11:51Z
- **目录日期**: 2025-05-06
