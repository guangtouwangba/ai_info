...
芝加哥大学研究发现，60%学生承认使用AI工具，但90%认为他人使用频率更高。多数学生低估自身AI使用情况，常将个人使用频率描述为"每周0-1天"，却认为同学达"每周4-5天"。这种现象被称为"AI羞耻"，源于对AI生成内容缺乏创意性和学术诚信的担忧。研究显示，即便STEM专业学生也存在这种认知偏差。该现象不仅限于教育领域，反映出社会对AI应用的矛盾态度：虽属新技术优势，却常招致负面评价。AI合理应用的边界仍是待解议题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T22:02:31Z
- **目录日期**: 2025-05-06
