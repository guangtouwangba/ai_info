...
芝加哥大学研究发现，60%学生承认使用AI工具，但认为90%的同学都在使用，且高估他人的使用频率。这种现象被称为"AI羞耻"——学生因担心学术诚信和剽窃问题，不愿承认自己使用AI。即便STEM专业学生也倾向于认为同学比自己更依赖AI。研究指出，社会对AI使用的负面评价导致人们隐藏使用行为，尽管新技术本应被视为优势。该现象不仅存在于教育领域，也反映了社会对AI合理应用的争议。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T15:03:33Z
- **目录日期**: 2025-05-06
