...
华中大与北邮团队推出多模态大模型PR1，首次突破30AP性能指标，超越YOLOv3等经典视觉模型。该模型通过基于规则的强化学习优化视觉感知能力，在COCO2017等基准测试中，物体检测、OCR和计数任务表现突出。实验显示PR1在visual grounding等任务优于专用模型，展现强大扩展性。这一突破为AI视觉感知发展奠定基础，推动多模态理解技术边界。研究成果已开源，相关论文和代码可获取。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T00:03:40Z
- **目录日期**: 2025-05-06
