...
这项研究探讨了如何利用大型语言模型(LLM)增强智能家居自动化并促进家庭可持续实践。研究发现，GPT模型能准确生成自动化程序，理解复杂指令并输出有效的JSON代码，但仍存在语法错误等问题。虽然"环保"提示与普通提示在量化差异不大，但前者确实能产生更可持续的解决方案。一项56人的实证评估显示，与传统基于规则的系统相比，用户更青睐LLM系统。研究凸显了LLM在推动智能家居技术发展中的潜力，建议进一步优化模型以支持可持续生活的实际应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T10:01:48Z
- **目录日期**: 2025-05-06
