...
JetBrains因删除AI Assistant插件的差评引发开发者众怒。该插件下载量超2000万但评分仅2.3分，用户反映差评被无故删除。JetBrains称删评因违反社区政策，但开发者质疑其意图洗白评分。主要投诉包括：仅支持自有云服务、运行卡顿、体验不稳定、自动重装等问题。虽然新AI工具"Junie"评价稍好，但免费额度不足。作为IDE巨头，JetBrains在AI赛道面临VS Code等免费竞品的激烈竞争，目前尚未赢得用户认可。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T18:03:40Z
- **目录日期**: 2025-05-06
