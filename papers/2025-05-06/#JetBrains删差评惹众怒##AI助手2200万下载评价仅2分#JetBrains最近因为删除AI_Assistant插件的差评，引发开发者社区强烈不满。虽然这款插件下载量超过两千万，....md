...
JetBrains因删除AI Assistant插件的差评引发开发者强烈抗议。该插件下载量超2000万但评分仅2.3分，用户投诉内容包括：强制自动安装、运行卡顿、仅支持自家云服务、频繁自动重装等问题。JetBrains称删评是因违反社区政策，但开发者质疑其意图操控评分。虽然新推出的AI工具"Junie"评价稍好，但免费额度仅3天。作为IDE领域的佼佼者，JetBrains在AI助手赛道面临VS Code等免费竞品的激烈竞争，目前尚未获得用户认可。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T23:03:46Z
- **目录日期**: 2025-05-06
