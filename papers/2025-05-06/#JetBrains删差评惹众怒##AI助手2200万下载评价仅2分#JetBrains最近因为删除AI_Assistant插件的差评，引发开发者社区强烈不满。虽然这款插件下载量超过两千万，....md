# #JetBrains删差评惹众怒##AI助手2200万下载评价仅2分#JetBrains最近因为删除AI Assistant插件的差评，引发开发者社区强烈不满。虽然这款插件下载量超过两千万，...
...
JetBrains因删除AI Assistant插件的差评引发众怒。该插件下载量超2200万但评分仅2.3分，用户投诉其自动安装、运行卡顿、强制重装等问题，且差评被以"违反政策"为由删除。开发者批评其仅支持自有云服务、响应延迟、文档缺失。虽然JetBrains新推的AI工具"Junie"评价稍好，但免费额度不足。作为IDE巨头，JetBrains在AI赛道面临VS Code等免费竞品的挑战，目前尚未赢得用户认可。事件反映公司面临产品体验与用户信任危机。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T09:03:00Z
- **目录日期**: 2025-05-06
