...
JetBrains因删除AI Assistant插件的差评引发开发者众怒。该插件虽下载量超2000万，但评分仅2.3分，用户反馈存在自动安装、运行卡顿、强制重装等问题。JetBrains称删评是因违反社区政策，但开发者质疑其刻意操控评分。对比新推出的AI工具"Junie"评价稍好，但免费额度不足。作为IDE巨头，JetBrains在AI赛道面临VS Code等免费竞品的挑战，目前用户认可度较低。事件反映开发者对产品体验与公司透明度的双重不满。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T12:04:06Z
- **目录日期**: 2025-05-06
