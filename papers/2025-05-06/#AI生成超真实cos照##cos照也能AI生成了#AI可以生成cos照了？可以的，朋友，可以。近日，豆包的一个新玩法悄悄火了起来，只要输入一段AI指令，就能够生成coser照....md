...
近日豆包AI推出新功能，用户通过输入特定指令即可生成高度逼真的cosplay照片。该功能能模拟手机随手拍的平庸感，包括运动模糊、曝光不均等细节，生成的Saber、原神可莉、EVA角色等cos照几乎可以假乱真。虽然存在细微瑕疵，但整体效果已难以用肉眼辨别真伪，展现了AI图像生成技术的突破性进展。这一功能引发网友对"真实与虚拟界限"的讨论，相关话题#AI生成超真实cos照#正在微博热传。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T22:02:58Z
- **目录日期**: 2025-05-06
