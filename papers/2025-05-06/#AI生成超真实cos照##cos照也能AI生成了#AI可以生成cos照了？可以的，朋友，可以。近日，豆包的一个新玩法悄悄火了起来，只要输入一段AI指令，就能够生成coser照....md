...
豆包AI新功能可通过文字指令生成超真实cos照片，效果以假乱真。用户只需输入特定描述（如要求"平庸自拍感"的cos照），即可生成Saber、原神可莉、EVA角色等形象，照片带有真实拍摄的模糊、曝光等细节。虽然存在小瑕疵，但整体效果已难以用肉眼辨别真伪，展现了AI图像生成技术的突破性进展。该功能引发网友对"真实与虚拟界限"的讨论，相关话题#AI生成超真实cos照#正在微博热传。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T14:03:25Z
- **目录日期**: 2025-05-06
