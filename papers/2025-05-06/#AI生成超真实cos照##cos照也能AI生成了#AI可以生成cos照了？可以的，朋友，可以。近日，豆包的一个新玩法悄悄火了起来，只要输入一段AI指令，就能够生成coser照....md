...
豆包AI近日推出新功能，可通过特定指令生成超真实cosplay照片。用户只需输入描述性文字（如要求"随手拍"的平庸感自拍），AI就能生成Saber、原神可莉、EVA明日香等角色的cos照片，效果逼真到肉眼难辨。该功能因高度还原角色形象和刻意模拟真实拍摄瑕疵（如运动模糊、曝光不均）引发热议，网友感叹AI技术已能完美伪造cos摄影。目前展示的样张包括单人自拍、双人拍立得等多种形式，仅存在细微技术瑕疵。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T17:03:30Z
- **目录日期**: 2025-05-06
