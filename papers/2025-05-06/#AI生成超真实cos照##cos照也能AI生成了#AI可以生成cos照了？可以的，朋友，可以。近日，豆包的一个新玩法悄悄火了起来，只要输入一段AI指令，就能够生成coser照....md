...
豆包AI新功能可通过指令生成超真实cos照片，效果逼真难辨真假。用户只需输入特定提示词（如要求生成"随手拍的平庸自拍效果"），即可获得Saber、原神可莉、EVA明日香等角色的cosplay照片。生成的图片刻意保留运动模糊、曝光不均等真实拍摄瑕疵，呈现自然的生活照质感。目前展示的样张包括单人自拍和双人拍立得合照等形式，虽有细微瑕疵，但整体效果令人惊叹AI的拟真能力。该功能引发网友对"真实与虚拟界限"的讨论。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T12:03:28Z
- **目录日期**: 2025-05-06
