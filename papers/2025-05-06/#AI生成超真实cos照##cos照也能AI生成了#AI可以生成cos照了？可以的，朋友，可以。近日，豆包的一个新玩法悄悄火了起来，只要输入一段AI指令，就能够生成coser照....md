...
豆包AI新功能可通过文字指令生成高度逼真的cosplay照片，效果接近真实拍摄。用户只需输入特定描述（如"平凡无奇的iPhone自拍"等细节要求），即可生成Saber、原神可莉、EVA角色等动漫游戏人物的cos照片。生成的图像存在少量瑕疵，但整体难以用肉眼辨别真伪，展现了AI图像生成技术的突破性进展。该功能引发网友对"真实与虚拟界限"的讨论，示例图片包括角色挡镜自拍、拍立得合照等多种风格。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T15:04:05Z
- **目录日期**: 2025-05-06
