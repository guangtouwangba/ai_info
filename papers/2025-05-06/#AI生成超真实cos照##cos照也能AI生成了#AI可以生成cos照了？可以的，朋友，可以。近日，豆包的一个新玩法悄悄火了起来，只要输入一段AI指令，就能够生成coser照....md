...
豆包AI新功能可通过文字指令生成超真实cos照片，效果逼真难以肉眼识别。用户只需输入描述性指令（如要求"平庸感自拍"），即可生成Saber、原神可莉、EVA明日香等角色cos照，甚至能还原拍立得质感。该技术展示了AI图像生成的强大能力，引发对真实与虚拟界限的讨论。目前虽存在细微瑕疵，但整体效果已足够以假乱真。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T20:03:19Z
- **目录日期**: 2025-05-06
