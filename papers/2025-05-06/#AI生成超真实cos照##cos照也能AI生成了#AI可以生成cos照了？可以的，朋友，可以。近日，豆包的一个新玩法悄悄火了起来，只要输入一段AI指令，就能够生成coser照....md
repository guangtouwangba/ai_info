...
豆包AI新功能可通过文字指令生成超写实cos照片，效果逼真到肉眼难辨。用户只需输入特定描述（如"平庸的iPhone自拍效果"），即可生成Saber、原神可莉等角色的cosplay照片，甚至能还原经典动漫角色如明日香与绫波丽的拍立得合照。该技术虽存在细微瑕疵，但整体呈现效果已引发"真假难辨"的惊叹，展示了AI图像生成技术的突破性进展。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T10:03:08Z
- **目录日期**: 2025-05-06
