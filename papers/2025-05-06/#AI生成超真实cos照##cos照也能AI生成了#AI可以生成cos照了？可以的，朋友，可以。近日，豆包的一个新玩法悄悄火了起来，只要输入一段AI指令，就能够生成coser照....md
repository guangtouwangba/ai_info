...
近日，豆包AI推出新功能，可根据指令生成超真实的coser照片。用户只需输入描述性文字（如要求"随手拍"的平庸感自拍），AI即可生成Saber、原神可莉、EVA明日香等角色的cos照，效果逼真到肉眼难辨。该功能因高度还原角色和自然的生活化拍摄风格引发热议，网友感叹AI技术已能完美模拟真人cosplay摄影。目前展示的样张包括挡镜自拍、游戏角色和经典动漫人物合照，仅存在少量细节瑕疵。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T16:03:35Z
- **目录日期**: 2025-05-06
