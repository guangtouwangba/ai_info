...
英伟达开源了高效低成本推理模型系列Llama-Nemotron，包含8B/49B/253B三种规格，覆盖轻量到旗舰级需求。该系列采用创新的"Puzzle"架构（非传统Transformer），通过去除注意力机制和压缩FFN模块提升效率。模型基于3300万条高质量数据训练，数学和代码数据占比高，采用五阶段训练流程，并优化多步推理能力。技术亮点包括cudagraph和FP8推理技术，GPU利用率超90%。在GPQA等基准测试中表现优异，现已开源模型、代码和数据集。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T02:40:15Z
- **目录日期**: 2025-05-06
