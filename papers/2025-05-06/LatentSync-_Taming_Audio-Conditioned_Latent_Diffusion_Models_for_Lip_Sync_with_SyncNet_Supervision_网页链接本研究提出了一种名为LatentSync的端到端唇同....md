...
本研究提出LatentSync框架，一种端到端唇同步方法，基于音频条件的潜在扩散模型，无需中间运动表示。为解决时间一致性问题，提出TREPA方法，利用自监督视频模型增强生成帧的时间对齐。同时改进了SyncNet训练框架，提升其收敛性和准确性。实验表明，该方法在HDTF和VoxCeleb2数据集上超越现有技术。创新点包括直接建模音频-视觉关系、增强时间一致性及优化SyncNet训练，可推广至其他唇同步和音频驱动动画任务。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T06:05:15Z
- **目录日期**: 2025-05-06
