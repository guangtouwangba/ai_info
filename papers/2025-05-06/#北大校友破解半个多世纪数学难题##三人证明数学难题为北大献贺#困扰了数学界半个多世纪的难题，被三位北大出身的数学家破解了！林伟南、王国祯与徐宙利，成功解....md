...
三位北大校友数学家林伟南、王国祯和徐宙利合作攻克了高维拓扑学中悬置半个多世纪的"末日假说"难题——证明在126维空间中存在Kervaire不变量为1的奇异流形。这一成果填补了自1960年代以来的理论空白，并作为北大建校126周年的学术贺礼。研究团队通过理论推导和计算验证，历时多年排除了109种可能路径。三位研究者曾是北大同窗及芝加哥大学同门，此次突破也是对已故导师Mahowald的纪念。相关论文已发表于arXiv平台。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T15:04:56Z
- **目录日期**: 2025-05-06
