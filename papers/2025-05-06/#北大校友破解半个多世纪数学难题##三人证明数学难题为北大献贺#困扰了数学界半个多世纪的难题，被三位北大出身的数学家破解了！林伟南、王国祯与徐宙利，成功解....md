...
北大校友林伟南、王国祯与徐宙利合作攻克了高维拓扑学中悬置半个多世纪的"末日假说"——证明了Kervaire不变量在第126维空间的存在性。这一成果填补了自20世纪60年代以来的理论空白，并作为北大126周年校庆献礼。三人通过理论推导与计算验证，最终确认126维存在无法整形成球体的特殊流形结构。这项研究历时65年，跨越了从Milnor到Browder等多代数学家的探索。值得一提的是，三位研究者是北大同门师兄弟，他们的突破也是对已故导师Mahowald的纪念。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T19:03:52Z
- **目录日期**: 2025-05-06
