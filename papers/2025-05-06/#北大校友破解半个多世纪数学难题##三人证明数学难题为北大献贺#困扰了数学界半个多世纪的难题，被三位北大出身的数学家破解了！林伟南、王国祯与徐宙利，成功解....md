...
三位北大校友数学家林伟南、王国祯和徐宙利合作攻克了困扰数学界半个多世纪的Kervaire不变量难题，证明了126维空间中存在无法整形成球体的特殊流形结构。这一成果填补了自20世纪60年代以来高维拓扑学的最后空白，并作为北大建校126周年的学术贺礼。三位研究者通过理论推导和大量计算，历时多年最终验证了这一关键维度的问题。他们曾是北大同窗及芝加哥大学同门，此次突破也是对已故导师Mahowald的纪念。论文已发布于arXiv平台。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T22:03:49Z
- **目录日期**: 2025-05-06
