...
三位北大校友数学家林伟南、王国祯和徐宙利合作攻克了困扰数学界半个多世纪的Kervaire不变量问题，证明了126维空间中存在无法整形成球体的特殊流形结构。这一成果填补了高维拓扑学自20世纪60年代以来的关键空白，并作为北大建校126周年的学术贺礼。三人通过理论推导和计算排除了105种错误路径，最终验证了126维的Kervaire不变量为1。这项研究历时65年，从John Milnor到2009年的阶段性成果，最终由这三位师兄弟完成，也是对已故导师Mahowald的纪念。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T18:04:00Z
- **目录日期**: 2025-05-06
