...
三位北大出身的数学家林伟南、王国祯与徐宙利破解了困扰数学界半个多世纪的Kervaire不变量难题，证明了126维空间中存在无法整形成球体的奇异流形。这一成果填补了高维拓扑学自20世纪60年代以来的关键空白，并作为北大建校126周年的学术贺礼。三人结合理论推导与高强度计算，历时多年攻克这一曾被导师劝退的难题，成果也是对已故恩师的纪念。该研究延续了从Milnor、Browder到2009年相关研究的65年探索历程。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T11:04:16Z
- **目录日期**: 2025-05-06
