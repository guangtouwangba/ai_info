...
北大校友林伟南、王国祯和徐宙利破解了困扰数学界半个多世纪的Kervaire不变量问题，证明了126维空间中存在无法整形成球体的奇异流形。这一高维拓扑学难题自20世纪60年代提出以来，历经65年研究终被攻克。三位研究者通过理论推导和计算排除了105种错误路径，最终验证了126维的特殊结构。他们曾是北大同窗及芝加哥大学同门，此次成果既是献给北大126周年校庆的贺礼，也是对已故导师的纪念。相关论文已发表于arXiv平台。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T09:03:22Z
- **目录日期**: 2025-05-06
