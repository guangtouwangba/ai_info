...
本文探讨了机制可解释性(MI)的核心问题"什么是好的解释"，提出了基于哲学科学的多元解释美德框架(贝叶斯、库恩、德意志、法则学视角)来系统评估和改进MI中的解释。研究发现紧凑证明(Compact Proofs)因涵盖多种解释美德而具有潜力。框架指出的关键研究方向包括：(1)明确定义解释简洁性，(2)聚焦统一性解释，(3)推导神经网络的普适原理。改进的MI方法将增强我们监控、预测和引导AI系统的能力。该研究为建立通用的神经网络解释评估标准提供了理论基础。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T01:28:49Z
- **目录日期**: 2025-05-06
