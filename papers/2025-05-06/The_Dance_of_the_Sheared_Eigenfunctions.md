...
本文研究了非相对论量子力学中的剪切势理论，重点分析了两种典型势场（谐振子势和对称|x|势阱）的剪切族。研究不仅确定了能谱特征，还深入探讨了剪切过程对本征函数的影响——这一常被文献忽略的方面。研究发现，剪切后的本征函数能更深刻地揭示能谱特性。最后，论文探讨了剪切族能谱变化与实现该变化所需外力做功之间的关系。通过本征函数分析，研究为剪切势系统的核心特征提供了新的理论见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T00:02:09Z
- **目录日期**: 2025-05-06
