...
上海交通大学、北京智源研究院和特伦托大学联合推出Video-XL-Pro模型，在超长视频理解领域取得突破。该模型采用“重构式token压缩”技术，仅用3B参数量即超越Meta的7B模型Apollo-7B及其他同尺寸开源模型，实现单卡处理近万帧视频，大海捞针任务准确率超98%。相比现有模型在长视频处理中的性能与效率瓶颈，Video-XL-Pro以较少训练数据实现SOTA表现，相关代码、模型及数据已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T00:03:17Z
- **目录日期**: 2025-05-06
