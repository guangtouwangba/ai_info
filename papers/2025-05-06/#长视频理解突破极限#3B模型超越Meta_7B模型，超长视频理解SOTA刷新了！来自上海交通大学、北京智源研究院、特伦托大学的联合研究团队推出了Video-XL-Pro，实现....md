...
上海交通大学、北京智源研究院和特伦托大学联合推出Video-XL-Pro模型，在超长视频理解领域取得突破。该3B参数模型采用"重构式token压缩"技术，实现单卡处理近万帧视频，在"大海捞针"测试中准确率超98%，性能超越Meta的7B模型Apollo-7B及同类开源模型。研究解决了长视频训练规模受限和处理效率低下的难题，使用较少训练数据即达到SOTA水平。模型代码、训练数据已开源，为视频理解领域提供新基准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T01:31:25Z
- **目录日期**: 2025-05-06
