...
上海交通大学、北京智源研究院和特伦托大学联合推出的Video-XL-Pro模型在长视频理解领域取得突破。该3B参数模型采用"重构式token压缩"技术，实现了单卡处理近万帧视频的能力，在"大海捞针"测试中准确率超过98%。相比Meta的7B模型Apollo-7B及其他同尺寸开源模型，Video-XL-Pro性能更优，训练数据需求更少。该研究解决了现有模型在超长视频训练和应用中的效率与性能瓶颈，相关代码、模型和数据均已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T03:21:13Z
- **目录日期**: 2025-05-06
