...
香港科技大学广州分校团队在CVPR 2025发表的研究MultiGO，实现了仅用单张照片生成高保真3D人体模型的突破。该技术采用分层建模方法，将人体分解为骨架、关节和衣物褶皱三个层级，通过骨架增强、关节扰动和皱纹去噪三大创新技术，显著提升了建模精度。在CustomHuman和THuman3.0测试集中表现优异，细节可达亚毫米级。该技术可应用于虚拟试衣、角色定制和影视特效等领域。研究代码即将开源，为3D建模领域带来重要进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T04:03:45Z
- **目录日期**: 2025-05-06
