...
这项研究探讨了酷儿群体与生成式AI的互动方式，发现主流AI模型（如GPT-4和DALL-E 3）的设计中嵌入了规范性价值观（如过度积极和反性倾向），给酷儿艺术家使用带来困难。通过13位酷儿艺术家的研讨会，研究发现参与者虽需克服模型限制，但仍能从这些高度规范的技术中获取价值。研究基于酷儿女性主义理论，反思了"最先进"AI模型的概念，并探讨FAccT（公平、问责、透明）研究者如何支持酷儿替代方案。研究填补了生成式AI如何支持酷儿群体的空白。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T04:02:24Z
- **目录日期**: 2025-05-06
