...
这项研究探讨了13位酷儿艺术家使用GPT-4和DALL-E 3的经历。研究发现，这些生成式AI模型内置的规范性价值观（如过度积极和反性内容）给酷儿用户带来了使用障碍。尽管如此，参与者仍开发出应对策略并从中获得价值。基于酷儿女性主义理论，研究质疑了"最先进"模型的概念，并建议FAccT（公平、问责和透明度）研究者支持酷儿替代方案。该研究揭示了主流AI技术与酷儿群体需求之间的不匹配，同时展示了酷儿用户克服技术限制的创造力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T18:02:10Z
- **目录日期**: 2025-05-06
