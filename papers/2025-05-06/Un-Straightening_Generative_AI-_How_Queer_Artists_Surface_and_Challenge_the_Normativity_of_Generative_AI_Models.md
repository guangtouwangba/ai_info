...
这项研究探讨了13位酷儿艺术家使用GPT-4和DALL-E 3的经历，发现这些生成式AI模型因内置的规范性价值观（如过度积极和反性倾向）而难以满足酷儿群体的需求。尽管存在限制，参与者仍开发出应对策略并从中获得价值。研究基于酷儿女性主义理论，反思了"最先进"AI模型的概念，并探讨了FAccT（公平、问责和透明度）研究者如何支持酷儿替代方案。研究揭示了主流AI技术与酷儿群体需求间的张力，为更具包容性的AI设计提供了启示。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T10:02:25Z
- **目录日期**: 2025-05-06
