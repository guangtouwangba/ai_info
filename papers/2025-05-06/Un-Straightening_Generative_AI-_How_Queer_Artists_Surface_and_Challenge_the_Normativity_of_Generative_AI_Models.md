...
这项研究探讨了酷儿群体与生成式AI的互动方式。通过13位酷儿艺术家的工作坊实验（使用GPT-4和DALL-E 3），研究发现现有AI模型因内置的规范价值观（如过度积极、反性倾向）限制了酷儿用户的使用。参与者虽开发了应对策略，但仍从这些高度规范化的技术中发现了价值。基于酷儿女性主义理论，研究质疑了"最先进"AI模型的概念，并探讨FAccT（公平性、问责制、透明度）研究者如何支持酷儿替代方案。研究填补了关于AI如何支持酷儿群体的空白，揭示了技术设计中的规范偏见。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-06T09:02:26Z
- **目录日期**: 2025-05-06
