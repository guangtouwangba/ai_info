...
DeepSeek官方发布了新版模型DeepSeek-R1-0528，在数学、编程和逻辑推理等任务上表现接近o3和Gemini 2.5 Pro等领先模型。主要改进包括推理能力提升（尤其在AIME等高难度测试）、支持JSON输出和函数调用、幻觉率降低、文本生成更自然，以及中小模型性能优化（如Qwen3-8B接近Qwen3-235B水平）。此外，代码生成和前端开发体验也有所增强。模型权重已在Hugging Face开源，适用于实际应用场景。用户可访问chat.deepseek.com体验或查看API文档。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T03:21:29Z
- **目录日期**: 2025-05-30
