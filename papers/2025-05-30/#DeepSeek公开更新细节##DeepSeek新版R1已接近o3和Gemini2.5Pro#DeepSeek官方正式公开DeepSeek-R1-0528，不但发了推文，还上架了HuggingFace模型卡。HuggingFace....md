...
DeepSeek 官方发布了新版模型 DeepSeek-R1-0528，性能接近 OpenAI 的 GPT-3 和 Google 的 Gemini 2.5 Pro。该模型在数学、编程和逻辑推理方面表现优异，推理能力显著提升，尤其在 AIME 等高难度测试中进步明显。此外，新版支持 JSON 输出和函数调用，幻觉率降低，文本生成更自然流畅。官方还优化了中小模型性能，如 Qwen3-8B 的表现接近 Qwen3-235B。模型已开源，适用于代码生成、Web 开发等场景。体验入口和 API 文档已开放。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T02:32:10Z
- **目录日期**: 2025-05-30
