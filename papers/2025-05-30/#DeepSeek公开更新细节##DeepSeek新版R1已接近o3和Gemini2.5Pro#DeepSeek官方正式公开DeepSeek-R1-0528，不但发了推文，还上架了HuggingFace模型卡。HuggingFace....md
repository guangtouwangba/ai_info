...
DeepSeek官方发布了新版模型DeepSeek-R1-0528，在数学、编程和逻辑推理等多项基准测试中表现优异，性能接近o3和Gemini 2.5 Pro等领先模型。更新亮点包括：推理能力提升，支持JSON输出和函数调用，幻觉率降低，文本生成更自然，中小模型性能优化，以及前端开发体验改进。模型权重已在Hugging Face开源，方便实际应用部署。用户可通过chat.deepseek.com体验，或查阅API文档获取更多信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T00:03:16Z
- **目录日期**: 2025-05-30
