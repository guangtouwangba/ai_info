...
DeepSeek 官方发布了新版模型 DeepSeek-R1-0528，性能接近 o3 和 Gemini 2.5 Pro，在数学、编程、逻辑推理等任务中表现优异。主要升级包括：推理能力显著提升，支持 JSON 输出和函数调用，幻觉率降低，文本生成更自然，中小模型性能优化（如 Qwen3-8B 接近 Qwen3-235B），并改进了代码生成和前端开发体验。模型已在 Hugging Face 开源，用户可通过官网或 API 体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T06:03:37Z
- **目录日期**: 2025-05-30
