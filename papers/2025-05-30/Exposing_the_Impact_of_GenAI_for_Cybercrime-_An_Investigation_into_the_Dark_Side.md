...
近年来，生成式AI的快速发展和普及引发了对其安全性和伦理风险的广泛讨论，尤其是在网络安全领域。本研究通过心理学中的技术放大理论和可供性理论框架，首次提供了生成式AI与恶意网络活动及网络犯罪关联的实证证据。研究者采用准实验设计和中断时间序列分析，分析了一般性和加密货币相关的数据集。研究结果为AI治理的讨论提供了新依据，强调需要在控制与创新之间取得平衡，并为政策制定者、AI开发者、网络安全专家和公众提供指导，以最大化AI效益同时降低风险。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T12:01:41Z
- **目录日期**: 2025-05-30
