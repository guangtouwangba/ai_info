...
这篇论文通过心理学框架和准实验设计，实证研究了生成式AI与网络犯罪活动的关联。研究分析了两组数据集（普通和加密货币相关），发现生成式AI确实会放大网络安全风险。结果强调了在AI治理中平衡管控与创新的必要性，为政策制定者、AI开发者和网络安全专家提供了决策参考，同时指出需要加强公众教育，以最大限度发挥AI效益并降低其风险。研究为当前关于AI安全、伦理和双重用途的讨论提供了实证依据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T10:01:30Z
- **目录日期**: 2025-05-30
