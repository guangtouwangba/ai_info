...
这篇论文通过心理学框架和技术放大理论，实证研究了生成式AI与恶意网络活动及网络犯罪的关联。研究者采用准实验设计和中断时间序列分析，分析了两组数据集（一组通用，一组聚焦加密货币），评估了生成式AI在网络犯罪中的作用。研究结果有助于平衡AI治理中的控制与创新，为政策制定者、AI开发者、网络安全专家提供策略指导，并强调公众教育的必要性，以最大化AI效益同时降低风险。该研究填补了生成式AI安全风险实证证据的空白，推动了相关讨论。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T18:01:33Z
- **目录日期**: 2025-05-30
