...
这篇论文通过心理学框架和技术放大理论，实证研究了生成式AI与网络犯罪活动的关联。研究者采用准实验设计和中断时间序列分析，分析了两组数据集（一组通用，一组聚焦加密货币），评估了生成式AI在网络犯罪中的作用。研究结果为AI治理的讨论提供了实证依据，强调需要在控制风险与促进创新之间取得平衡，并提出了针对政策制定者、AI开发者、网络安全专家和公众的策略建议，以最大化AI的效益同时降低其风险。该研究填补了生成式AI与网络犯罪关系的实证证据空白。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T21:01:32Z
- **目录日期**: 2025-05-30
