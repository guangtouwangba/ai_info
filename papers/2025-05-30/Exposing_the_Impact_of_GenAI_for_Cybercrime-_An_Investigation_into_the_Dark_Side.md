...
这篇论文通过心理学框架和实证研究，探讨了生成式AI与网络犯罪活动的关联。研究者采用准实验设计和中断时间序列分析，分析了两组数据集（通用型和加密货币相关），发现生成式AI可能放大网络安全风险。研究结果为AI治理提供了实证依据，强调需在控制风险与促进创新间取得平衡，同时为政策制定者、AI开发者、网络安全专家和公众提供指导策略，以最大化AI效益并降低潜在危害。该研究推动了关于AI安全、伦理和双重用途问题的讨论。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T23:01:27Z
- **目录日期**: 2025-05-30
