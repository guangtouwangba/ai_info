...
本文提出了一种基于强化学习(RL)的机器学习代理(ML-Agent)训练框架，通过交互式实验实现自主机器学习。该框架包含三个关键创新：(1)探索增强微调，提升代理行动多样性；(2)分步RL训练，加速经验收集；(3)统一奖励模块，整合多种ML反馈信号。实验表明，仅用7B参数的Qwen-2.5模型在9个任务上训练的ML-Agent，性能超越671B参数的DeepSeek-R1代理，并展现出持续改进能力和出色的跨任务泛化性能。这一学习型代理范式为自主机器学习开辟了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T21:01:42Z
- **目录日期**: 2025-05-30
