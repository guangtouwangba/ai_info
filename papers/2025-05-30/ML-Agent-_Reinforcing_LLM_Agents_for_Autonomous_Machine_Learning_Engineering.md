...
该研究提出了一种基于强化学习(RL)的自主机器学习(ML)代理训练框架ML-Agent。该框架包含三个关键创新：(1)探索增强微调，提升代理行动多样性；(2)分步RL训练，加速经验收集；(3)统一奖励模块，整合多样ML反馈。实验表明，仅用7B参数的Qwen-2.5模型在9个ML任务上训练后，其性能即超越671B参数的DeepSeek-R1代理，并展现出持续改进能力和出色的跨任务泛化性能。这一学习型代理范式突破了传统依赖人工提示工程的局限，为自主ML系统开发提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T16:01:58Z
- **目录日期**: 2025-05-30
