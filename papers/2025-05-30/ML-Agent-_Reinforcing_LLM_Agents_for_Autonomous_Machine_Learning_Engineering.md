...
本文提出了一种基于强化学习(LLM)的自主机器学习(ML)代理训练框架ML-Agent。该框架包含三个关键创新：(1)探索增强微调，提升代理的多样性探索能力；(2)单步强化学习，加速经验收集；(3)统一的ML反馈奖励机制。实验表明，仅用7B参数的Qwen-2.5模型在9个ML任务上训练的ML-Agent，性能超越了671B参数的DeepSeek-R1代理，并展现出持续的改进能力和优秀的跨任务泛化性能。这一成果首次实现了基于学习的ML代理范式，为自主机器学习工程提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T06:01:46Z
- **目录日期**: 2025-05-30
