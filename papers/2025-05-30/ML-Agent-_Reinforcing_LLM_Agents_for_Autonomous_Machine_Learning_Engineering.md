...
本文提出了一种基于强化学习的自主机器学习（ML）代理框架ML-Agent，通过在线交互学习优化ML任务。该框架包含三个核心创新：(1) 探索增强微调，提升动作多样性；(2) 分步强化学习，加速经验收集；(3) 统一的奖励模块，整合ML反馈信号。实验表明，仅用7B参数的Qwen-2.5模型在9个ML任务上训练后，性能即超越671B参数的DeepSeek-R1代理，并展现出持续改进能力和优异的跨任务泛化性。这一学习型代理范式突破了传统依赖人工提示工程的局限，为自主ML系统开辟了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T08:01:53Z
- **目录日期**: 2025-05-30
