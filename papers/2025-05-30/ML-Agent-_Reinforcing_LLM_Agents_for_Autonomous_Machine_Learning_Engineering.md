...
本文提出了一种基于强化学习(LLM)的自主机器学习(ML)代理训练框架ML-Agent。该框架包含三个关键创新：(1)探索增强微调技术，增强代理的多样性探索能力；(2)逐步强化学习，提高训练效率；(3)专用奖励模块，统一不同ML任务的反馈信号。实验表明，仅用7B参数的Qwen-2.5模型在9个ML任务上训练的ML-Agent，性能超越了671B参数的DeepSeek-R1代理，并展现出持续的改进能力和出色的跨任务泛化性能。这一成果开创了基于学习的自主ML代理新范式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T10:01:39Z
- **目录日期**: 2025-05-30
