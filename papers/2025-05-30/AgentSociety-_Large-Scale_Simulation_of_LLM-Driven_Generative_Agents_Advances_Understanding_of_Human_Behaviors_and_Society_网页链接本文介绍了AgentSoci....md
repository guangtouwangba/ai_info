...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理的社会互动（500万次交互）。该系统作为计算社会科学实验平台，研究了四大社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实数据高度吻合，验证了系统对人类行为和社会机制的捕捉能力。研究表明，这种LLM驱动的模拟器能有效辅助传统社会科学研究方法，为研究者和政策制定者提供新的分析工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T09:05:26Z
- **目录日期**: 2025-05-30
