...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个代理的社会互动（500万次交互）。它通过四个社会问题案例（社会极化、信息传播、基本收入政策、自然灾害影响）验证其有效性，结果与现实研究一致。该系统能捕捉人类行为机制，为社会科学研究和政策制定提供新工具，补充传统调查和实验方法。研究表明AgentSociety在理解社会现象成因和潜在机制方面具有重要潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T06:04:52Z
- **目录日期**: 2025-05-30
