...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟器，能够模拟1万多个AI代理及其500万次社会互动。研究者用它作为计算社会科学实验平台，研究了社会极化、信息传播、基本收入政策和自然灾害影响等四个关键社会问题。模拟结果与现实世界数据高度吻合，证明该系统能有效捕捉人类行为机制。该工具为社会科学研究和政策制定提供了新方法，可辅助传统研究方法（如调查和访谈），帮助理解社会问题的模式、原因和潜在机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T07:05:17Z
- **目录日期**: 2025-05-30
