...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能模拟1万多个智能代理的社会互动（500万次交互）。研究团队用它研究了四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，验证了该系统捕捉人类行为机制的能力。该系统可作为计算社会科学的新工具，为研究者和政策制定者提供传统方法（如调查、实验）之外的补充研究手段，有助于深入理解社会问题的成因和潜在解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T17:05:12Z
- **目录日期**: 2025-05-30
