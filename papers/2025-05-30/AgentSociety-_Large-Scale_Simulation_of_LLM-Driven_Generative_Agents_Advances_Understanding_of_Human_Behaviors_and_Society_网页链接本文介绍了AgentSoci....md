...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统模拟了1万多个AI代理的社会生活，产生了500万次互动，用于研究人类行为和社会现象。研究者用它分析了四个关键问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，验证了该系统的有效性。AgentSociety为社会科学研究提供了新工具，能够帮助学者和政策制定者更好地理解社会问题的成因和机制，补充传统研究方法如调查和访谈的不足。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T14:05:26Z
- **目录日期**: 2025-05-30
