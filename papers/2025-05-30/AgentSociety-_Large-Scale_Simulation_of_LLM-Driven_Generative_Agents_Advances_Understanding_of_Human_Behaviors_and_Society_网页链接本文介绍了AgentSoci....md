...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能模拟1万多个AI代理的社会互动（500万次交互）。研究者用它研究了四个关键社会问题：社会极化、信息传播、基本收入政策效果和自然灾害影响。该系统模拟结果与现实世界数据高度吻合，验证了其在捕捉人类行为机制方面的准确性。这表明AgentSociety可作为计算社会科学的有力工具，帮助研究者分析社会问题成因，并为政策制定提供参考依据。该研究发表在AMiner平台，展示了AI模拟在社会研究中的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T03:23:05Z
- **目录日期**: 2025-05-30
