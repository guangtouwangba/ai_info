...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个智能代理及其500万次互动。该系统通过四个社会问题研究（极化现象、信息传播、基本收入政策、自然灾害影响）验证了其有效性，结果与现实数据吻合。研究表明该系统能有效捕捉人类行为机制，为社会科学研究和政策制定提供了新工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T11:05:01Z
- **目录日期**: 2025-05-30
