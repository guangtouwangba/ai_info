...
上海人工智能实验室推出的Avengers框架创新性地将多个7B小模型并联协作，通过四步流程（问题理解、聚类、能力评分、动态路由投票）实现集体智能。在15个测试数据集中，该框架在9项任务上超越GPT-4.1，数学和代码任务分别领先18.21%和7.46%。相比需要训练的混合方法，这种轻量级结构在OOD任务中表现更稳定，平均性能超出主流混合策略17.16%，展现了开源模型协同作战的显著优势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T10:03:47Z
- **目录日期**: 2025-05-30
