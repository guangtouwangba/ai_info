...
上海人工智能实验室联合高校开发的Avengers框架，通过四个关键步骤（Embedding、Clustering、Scoring、Routing & Voting）将多个7B小模型并联组合，无需额外训练即展现出强大性能。在15个公开数据集测试中，该框架在9个任务上超越GPT-4.1，数学和代码任务分别领先18.21%和7.46%。相比需要训练的路由方法和主流混合模型策略，Avengers具有结构轻量、泛化能力强的优势，在OOD任务中表现更稳定，平均性能高出混合模型17.16%，验证了小模型通过集体智慧实现高效能的技术路径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T09:03:24Z
- **目录日期**: 2025-05-30
