...
上海人工智能实验室联合高校开发的Avengers框架创新性地采用10个7B小模型并联策略，通过四步流程（问题理解、聚类、能力评分、动态路由投票）实现集体智能。在15个多领域测试中，该框架在9项任务上超越GPT-4.1，数学和代码任务分别领先18.21%和7.46%。相比需要训练的混合模型方法，这种无需额外训练的结构在泛化性和OOD任务中表现更优，性能平均提升17.16%，展现了轻量化模型集群的显著优势。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T18:03:40Z
- **目录日期**: 2025-05-30
