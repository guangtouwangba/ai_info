...
腾讯ARC Lab与香港城市大学联合推出Video-Holmes基准测试，专攻复杂视频推理能力评估。该测试通过"推理凶手""作案意图分析"等高难度任务，揭示当前多模态大模型的性能瓶颈。测试结果显示，所有参与模型均未达标，突显现有技术在深层视频理解上的不足。该基准已开源，提供GitHub和HuggingFace的"一键测评"工具包，旨在推动视频推理领域发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T02:32:55Z
- **目录日期**: 2025-05-30
