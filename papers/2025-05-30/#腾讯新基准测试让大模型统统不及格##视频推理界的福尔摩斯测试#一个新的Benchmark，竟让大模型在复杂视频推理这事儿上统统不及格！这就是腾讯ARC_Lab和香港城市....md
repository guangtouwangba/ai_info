...
腾讯ARC Lab和香港城市大学联合推出全新视频推理基准测试Video-Holmes，通过"推理杀人凶手"等高难度任务评估多模态大模型的复杂推理能力。该测试规避了现有基准视频源简单、无法区分推理能力的痛点。结果显示，所有参与测试的大模型在各项任务中均未达标。测试工具包已开源至GitHub和HuggingFace，为视频推理研究提供新挑战标准。这一"福尔摩斯式"测试揭示了大模型在复杂视频推理任务中的能力边界。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T00:04:02Z
- **目录日期**: 2025-05-30
