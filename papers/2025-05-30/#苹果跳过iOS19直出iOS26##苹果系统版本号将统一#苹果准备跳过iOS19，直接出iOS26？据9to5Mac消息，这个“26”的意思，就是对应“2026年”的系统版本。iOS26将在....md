# #苹果跳过iOS19直出iOS26##苹果系统版本号将统一#苹果准备跳过iOS19，直接出iOS26？据9to5Mac消息，这个“26”的意思，就是对应“2026年”的系统版本。iOS26将在...
...
苹果计划跳过iOS19，直接推出iOS26（对应2026年），并统一所有设备系统版本号（如macOS/watchOS也将采用"26"命名）。这一调整旨在简化版本识别，同时将visionOS的UI风格推广至全生态，实现界面统一。iPadOS将获得更接近Mac的多任务体验升级。该命名方案预计在2025年秋季发布的系统中启用，但iPhone机型命名是否同步调整（如iPhone17改为iPhone26）仍待WWDC确认。核心变化：版本号与年份对齐+全生态UI大改。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T03:21:19Z
- **目录日期**: 2025-05-30
