...
ZeroGUI是一个创新的在线学习框架，旨在零人工成本下训练纯视觉GUI代理。它通过VLM自动生成多样化任务目标，并利用VLM评估任务完成度，无需人工标注或定制评估函数。该框架采用两阶段在线强化学习，使代理能持续与环境交互学习。实验表明，ZeroGUI显著提升了UI-TARS和Aguvis等GUI代理在OSWorld和AndroidLab环境中的性能。这一方法解决了现有离线学习框架对人工标注的依赖和动态环境适应性问题，为GUI自动化提供了可扩展的解决方案。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T20:01:16Z
- **目录日期**: 2025-05-30
