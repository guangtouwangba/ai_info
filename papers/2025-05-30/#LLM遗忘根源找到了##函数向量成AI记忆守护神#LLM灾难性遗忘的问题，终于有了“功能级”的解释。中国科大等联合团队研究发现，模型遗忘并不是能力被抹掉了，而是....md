...
中国科大等团队研究发现，大语言模型(LLM)的遗忘问题源于新任务激活了"偏离"原有功能的功能向量，而非能力丢失。研究提出"函数向量"分析方法，通过跟踪任务功能向量的变化揭示遗忘机制。实验显示生成任务比分类任务更易遗忘，且早期性能下降可能是暂时的。团队开发了函数向量引导训练法(FVG)，通过控制功能激活偏移来保护记忆，有效减轻遗忘并提升上下文学习能力。该成果已被ICLR 2025接收为口头报告。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T23:03:51Z
- **目录日期**: 2025-05-30
