...
这篇论文研究了一个涉及多个智能体的上下文赌博机问题，其中学习者需在智能体可能虚报信息的情况下选择最优策略。传统方法假设智能体会如实报告，但现实中（如电商平台卖家可能夸大产品质量）往往并非如此。为此，作者提出了COBRA算法，无需金钱激励即可抑制智能体的策略性虚报行为，同时保证激励相容性和次线性遗憾。实验验证了该算法的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T10:01:47Z
- **目录日期**: 2025-05-30
