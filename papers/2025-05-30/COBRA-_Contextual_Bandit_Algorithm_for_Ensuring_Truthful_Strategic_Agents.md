...
本文提出了一种针对多智能体情境赌博问题的算法COBRA，解决了现有研究中假设智能体如实报告行为的局限性。在现实场景（如电商平台）中，智能体可能策略性虚报信息以获取优势。COBRA算法无需货币激励即可抑制这种策略行为，同时保证激励相容性和次线性遗憾界。实验验证了该算法的各项性能表现。该研究为存在策略性智能体的推荐系统等应用提供了新解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T05:01:53Z
- **目录日期**: 2025-05-30
