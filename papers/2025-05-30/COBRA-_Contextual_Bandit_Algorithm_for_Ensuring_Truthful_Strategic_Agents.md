...
这篇论文研究了涉及多个智能体的上下文赌博机问题，提出了一种名为COBRA的算法来解决智能体可能虚报信息的问题。传统方法假设智能体会如实报告，但现实中（如电商平台卖家可能虚报产品质量）这并不成立。COBRA算法无需金钱激励就能抑制智能体的策略性行为，保证激励相容性，并具有次线性遗憾保证。实验验证了该算法的各项性能表现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T20:01:58Z
- **目录日期**: 2025-05-30
