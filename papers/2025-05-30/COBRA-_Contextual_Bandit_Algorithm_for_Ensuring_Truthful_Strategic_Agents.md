...
这篇论文研究了涉及多个智能体的情境赌博问题，提出了一种名为COBRA的算法来解决智能体可能虚报信息的问题。传统情境赌博算法假设智能体会如实报告信息，但现实中（如电商平台卖家可能虚报产品质量）并非如此。COBRA算法无需货币激励就能抑制智能体的策略性行为，同时保证激励相容性和次线性遗憾。实验结果验证了该算法的各项性能表现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T19:01:49Z
- **目录日期**: 2025-05-30
