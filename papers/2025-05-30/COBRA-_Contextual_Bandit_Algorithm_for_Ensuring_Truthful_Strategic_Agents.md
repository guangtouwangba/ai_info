...
这篇论文研究了一个涉及多个智能体的上下文赌博机问题，其中学习者需要处理智能体可能虚报信息的行为（如卖家夸大产品质量）。现有研究假设智能体会如实报告，但现实中常存在策略性欺骗。为此，作者提出了COBRA算法，无需金钱激励即可抑制策略性行为，同时保证激励相容性和次线性遗憾。实验验证了该算法的有效性。该研究对在线平台推荐系统等实际场景具有应用价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T17:01:58Z
- **目录日期**: 2025-05-30
