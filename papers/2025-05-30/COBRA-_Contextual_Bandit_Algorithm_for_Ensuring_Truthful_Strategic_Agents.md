...
这篇论文研究了一个涉及多个智能体的上下文赌博机问题，其中学习者需要处理智能体可能虚报信息的行为。现有研究假设智能体会如实报告，但现实中（如电商平台卖家虚报产品质量）并非如此。为此，作者提出了COBRA算法，无需经济激励即可抑制智能体的策略性虚报行为，同时保证激励相容性和次线性遗憾。实验验证了该算法的性能优势。该研究突破了传统假设，为存在策略性欺骗的场景提供了实用解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T18:01:52Z
- **目录日期**: 2025-05-30
