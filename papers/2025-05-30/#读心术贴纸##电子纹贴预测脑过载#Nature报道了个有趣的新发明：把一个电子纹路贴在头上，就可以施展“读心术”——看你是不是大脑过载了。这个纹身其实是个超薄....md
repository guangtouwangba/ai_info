...
Nature报道了一种新型超薄电子纹身传感器，可贴在头部监测脑负荷状态。该设备结合EEG/EOG技术，通过分析θ/δ波（用脑强度）和α/β波（疲劳程度）的变化，能实时检测并预测大脑过载风险。整套系统成本约220美元，比传统脑电帽更轻便经济。实验显示其能准确识别"最优脑负荷"状态，未来计划扩展至有发区域监测，目标是实现日常化的脑疲劳监测。研究团队还利用机器学习模型实现了脑负荷变化的趋势预测功能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T20:03:19Z
- **目录日期**: 2025-05-30
