...
Nature报道了一种新型超薄电子纹身传感器，可贴在头部监测大脑活动。该设备结合脑电图(EEG)和眼动图(EOG)技术，成本约220美元（含200美元设备和20美元一次性纹身）。通过监测θ/δ波增强（用脑）和α/β波减弱（疲劳），能识别"最优脑负荷"状态，并利用机器学习预测脑力过载趋势。相比传统脑电帽更轻便经济，未来有望实现日常脑疲劳监测，目前正研发适用于有头发区域的版本。实验显示其能有效追踪6名志愿者完成记忆任务时的脑力消耗变化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T14:03:28Z
- **目录日期**: 2025-05-30
