...
Nature报道了一种新型超薄电子纹身贴纸（约20美元），结合200美元的便携设备，可通过EEG/EOG技术实时监测脑负荷状态。该装置通过分析θ/δ波（用脑强度）和α/β波（疲劳程度）的变化，利用机器学习预测认知过载风险，旨在找到"最优脑负荷"状态。相比传统脑电帽更轻便经济，未来计划实现带发区域监测，目标是将脑疲劳监测普及如心率检测。实验显示其能有效追踪6名受试者在记忆任务中的脑力消耗变化。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T17:03:22Z
- **目录日期**: 2025-05-30
