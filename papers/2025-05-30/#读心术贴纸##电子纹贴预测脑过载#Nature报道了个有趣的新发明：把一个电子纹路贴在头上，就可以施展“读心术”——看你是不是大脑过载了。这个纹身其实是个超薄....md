...
Nature报道了一种新型超薄电子纹身贴纸，能通过EEG/EOG技术监测大脑活动。该设备仅需220美元（含20美元一次性贴片），可替代传统脑电帽。通过分析θ/δ波（用脑强度）和α/β波（疲劳程度）的变化，它能实时检测"最优脑负荷"状态，并利用机器学习预测脑力透支风险。目前已在6人实验中验证有效性，未来计划开发适用于有发区域的版本，目标是将脑疲劳监测变得像测心率一样便捷。相关论文发表于Nature期刊。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T11:03:15Z
- **目录日期**: 2025-05-30
