...
Nature报道了一种新型超薄电子纹身贴纸，可实时监测大脑状态。该设备结合脑电图(EEG)和眼动图(EOG)技术，仅需200美元硬件和20美元一次性贴片，比传统脑电帽更经济便捷。通过分析θ/δ波(用脑强度)和α/β波(疲劳程度)的变化，能准确识别"最优脑负荷"状态，并预测脑力过载趋势。研究团队正开发适用于有发区域的版本，目标是将脑疲劳监测变得像测心率一样普及。机器学习模型已能有效预测脑负荷变化，未来有望应用于日常生活场景。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T13:12:04Z
- **目录日期**: 2025-05-30
