...
Nature报道了一种新型超薄电子纹身贴纸，可通过脑电图(EEG)和眼动图(EOG)技术监测大脑活动。这款仅需220美元(含20美元一次性感应器)的设备能检测θ/δ波(用脑强度)和α/β波(疲劳程度)，利用机器学习预测脑力负荷变化趋势，帮助找到"最优脑负荷"状态。相比传统脑电帽更轻便经济，未来有望实现日常脑疲劳监测。研究团队正开发适用于有头发区域的版本，以扩展应用场景。实验显示该设备能提前预警脑力透支，6名志愿者测试验证了其有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T21:03:07Z
- **目录日期**: 2025-05-30
