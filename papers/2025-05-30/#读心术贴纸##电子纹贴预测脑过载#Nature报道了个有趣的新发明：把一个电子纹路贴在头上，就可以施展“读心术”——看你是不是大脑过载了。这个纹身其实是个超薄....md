...
Nature报道了一种新型超薄电子纹身贴纸，可通过EEG和EOG技术监测大脑活动。这款仅需220美元（含20美元一次性传感器）的设备能实时检测θ/δ波（用脑强度）和α/β波（疲劳程度）变化，利用机器学习预测"最优脑负荷"状态，并在脑力过载前发出预警。相比传统脑电帽更便携经济，研究团队正开发适用于有头发区域的版本，目标是让脑疲劳监测像测心率一样普及。实验显示其对6名志愿者记忆任务中的脑负荷变化具有准确预测能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T10:03:14Z
- **目录日期**: 2025-05-30
