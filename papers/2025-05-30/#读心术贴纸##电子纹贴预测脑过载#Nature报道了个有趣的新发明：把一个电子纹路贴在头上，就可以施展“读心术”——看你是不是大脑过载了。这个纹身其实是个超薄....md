...
Nature报道了一种新型超薄电子纹身贴纸，可实时监测大脑状态。该设备结合脑电图(EEG)和眼动图(EOG)技术，通过分析θ/δ波(用脑强度)和α/β波(疲劳程度)来评估脑负荷，预测"最优工作状态"和脑力过载风险。相比传统脑电帽，这套仅220美元的系统更轻便经济。实验显示其机器学习模型能准确预测脑力变化趋势。研究团队正开发适用于有发区域的版本，目标是让脑力监测像测心率一样普及。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T16:03:26Z
- **目录日期**: 2025-05-30
