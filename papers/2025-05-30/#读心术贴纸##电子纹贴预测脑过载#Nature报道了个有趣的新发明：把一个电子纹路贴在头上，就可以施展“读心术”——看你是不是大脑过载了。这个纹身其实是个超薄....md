...
Nature报道了一种新型超薄电子纹身贴纸，可实时监测大脑状态。该设备结合脑电图(EEG)和眼动图(EOG)技术，仅需200美元设备和20美元一次性贴片，比传统脑电帽更经济便捷。通过分析θ/δ波增强(用脑)和α/β波减弱(疲劳)等脑电信号，能确定"最优脑负荷"状态并预测脑力过载。研究团队利用机器学习模型分析实验数据，未来计划开发可贴于头发的版本，目标是使脑疲劳监测像测心率一样普及。这项技术有望帮助人们保持高效认知状态。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T12:03:20Z
- **目录日期**: 2025-05-30
