...
Nature报道了一种新型超薄电子纹身贴纸，可实时监测大脑状态。该设备结合脑电图(EEG)和眼动图(EOG)技术，通过分析θ/δ波(用脑强度)和α/β波(疲劳程度)的变化，预测"最优脑负荷"状态。相比传统脑电帽，这套仅220美元的系统更轻便经济。机器学习模型能提前预警脑力过载。目前正研发可贴于头发区域的版本，目标是让脑疲劳监测像测心率一样普及。实验显示其能有效追踪6名志愿者完成记忆任务时的脑力消耗变化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T19:03:07Z
- **目录日期**: 2025-05-30
