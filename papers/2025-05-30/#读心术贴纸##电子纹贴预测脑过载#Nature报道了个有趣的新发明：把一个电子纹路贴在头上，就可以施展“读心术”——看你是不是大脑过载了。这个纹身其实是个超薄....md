...
Nature报道了一种新型超薄电子纹身贴纸，能通过EEG和EOG技术监测大脑活动。该设备（总价约220美元）可实时检测脑电波变化（θ/δ波增强表示用脑努力，α/β波减弱预示疲劳），并利用机器学习预测脑力过载风险。相比传统脑电帽更轻便经济，未来有望实现日常脑疲劳监测。研究团队正开发适用于有头发区域的版本，以完善脑功能评估。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T22:02:58Z
- **目录日期**: 2025-05-30
