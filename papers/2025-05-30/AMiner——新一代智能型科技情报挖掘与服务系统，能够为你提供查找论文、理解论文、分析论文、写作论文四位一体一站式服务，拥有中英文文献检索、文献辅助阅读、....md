...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、翻译、辅助阅读、论文写作支持等。它拥有庞大的学术资源库，涵盖3.5亿论文、0.6亿学者和1.5亿专利。用户可通过智能问答快速获取文献摘要，并订阅个性化科研动态。平台还支持文档上传、AI生成摘要及章节概要，帮助高效理解论文内容。AMiner的浏览器版本可免费使用，适合科研人员、学生等群体提升学术研究效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T20:05:28Z
- **目录日期**: 2025-05-30
