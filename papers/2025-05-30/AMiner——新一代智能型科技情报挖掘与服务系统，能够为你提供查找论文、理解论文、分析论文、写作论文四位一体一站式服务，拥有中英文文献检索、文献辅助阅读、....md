...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、AI辅助阅读、自动摘要生成、学术翻译及科研动态订阅等功能。其数据库涵盖42个学科3.5亿论文、0.6亿学者及1.5亿专利，支持用户通过关键词/学者/机构订阅最新研究，并通过微信或邮件推送。特色功能包括文献问答对话、PDF智能解析、学者画像分析及学术会议追踪，可显著提升文献调研与论文写作效率。平台基础服务免费开放，网址：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T10:05:32Z
- **目录日期**: 2025-05-30
