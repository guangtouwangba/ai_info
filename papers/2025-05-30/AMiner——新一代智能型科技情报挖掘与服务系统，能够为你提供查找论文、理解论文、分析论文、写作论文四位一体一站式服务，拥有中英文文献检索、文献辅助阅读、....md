...
AMiner是一款智能科技情报挖掘系统，提供一站式学术服务，包括中英文文献检索、翻译、科研情报订阅等。它拥有3.5亿论文、0.6亿学者等海量数据，支持AI辅助阅读、自动摘要生成和互动问答功能。用户可定制订阅最新科研动态，并通过微信或邮件接收。平台还提供学者画像、学术会议等特色功能，基础服务免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T13:14:19Z
- **目录日期**: 2025-05-30
