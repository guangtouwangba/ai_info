...
AMiner是一个智能科技情报挖掘系统，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献搜索、AI辅助阅读和翻译，拥有3.5亿论文、0.6亿学者等海量数据。用户可通过提问快速获取文献摘要，上传PDF后AI能生成章节概要和问题建议。平台还提供科研动态订阅服务，按用户偏好推送最新论文摘要。此外，AMiner包含学者画像、学术会议和论文排行榜等功能，基础服务免费使用。网址：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T22:05:45Z
- **目录日期**: 2025-05-30
