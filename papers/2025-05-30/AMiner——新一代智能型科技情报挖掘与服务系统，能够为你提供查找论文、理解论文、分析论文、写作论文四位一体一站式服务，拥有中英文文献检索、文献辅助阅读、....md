...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务。它支持中英文文献检索、AI辅助阅读、自动摘要生成和翻译功能，覆盖42个学科3.5亿论文。用户可通过互动问答快速理解文献内容，并上传PDF进行智能分析。平台还提供科研动态订阅服务，根据用户偏好推送最新论文摘要。此外，AMiner包含学者画像、学术会议和论文排行榜等功能，基础服务可免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T19:05:18Z
- **目录日期**: 2025-05-30
