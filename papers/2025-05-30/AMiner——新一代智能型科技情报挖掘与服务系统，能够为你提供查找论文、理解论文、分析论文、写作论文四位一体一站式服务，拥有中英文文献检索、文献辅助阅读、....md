...
AMiner是一个智能科技情报挖掘平台，提供四位一体的学术服务：1）支持中英文文献检索，帮助用户快速定位相关论文，并通过问答机制生成摘要；2）具备文献翻译、辅助阅读功能，可上传或选择论文自动生成摘要和章节概要；3）提供科研情报订阅服务，根据用户偏好推送最新学术动态；4）额外功能包括学者画像、学术会议追踪等。平台覆盖42个学科，包含3.5亿论文、0.6亿学者等海量数据，支持浏览器免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T12:05:38Z
- **目录日期**: 2025-05-30
