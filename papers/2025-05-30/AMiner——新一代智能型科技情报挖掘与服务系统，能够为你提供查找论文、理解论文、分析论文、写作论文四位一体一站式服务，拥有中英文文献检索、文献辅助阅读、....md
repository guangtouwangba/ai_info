...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、辅助阅读、翻译和科研情报订阅。它收录了3.5亿论文、0.6亿学者和1.5亿专利，覆盖42个学科。用户可通过互动问答快速获取文献摘要，上传PDF生成章节概要，并订阅个性化科研动态。平台还支持学者画像、学术会议追踪和论文排行榜功能。AMiner的浏览器版本免费开放，旨在提升科研效率。  
