...
多模态大模型(MLLM)在视频OCR任务中表现不佳，为此研究者开发了MME-VideoOCR评估基准。该基准包含1,464个视频片段和2,000条问答对，覆盖10类任务25个子任务，测试模型对视频文字的"看清""理解""推理"能力。评估结果显示，表现最佳的Gemini-2.5 Pro准确率仅73.7%，开源模型更低于60%，主要困难在于时序理解和文字推理。基准特别设置了模糊、遮挡等干扰项，采用字符串匹配、多选题和GPT评分三种评估方式，全面检验模型在复杂场景下的视频文本处理能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T19:03:27Z
- **目录日期**: 2025-05-30
