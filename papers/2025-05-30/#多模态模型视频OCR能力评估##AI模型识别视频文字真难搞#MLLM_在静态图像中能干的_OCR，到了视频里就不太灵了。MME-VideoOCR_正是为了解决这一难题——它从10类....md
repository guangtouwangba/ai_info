...
MME-VideoOCR是一个专门评估多模态模型视频OCR能力的新基准，包含1,464个视频片段和2,000条问答对，覆盖多样场景并设置干扰项。该基准从10类任务、25个子任务全面测试模型对视频文字的"看清""理解""推理"能力，包括时空定位、时序追踪等挑战性任务。评估结果显示，即使最强模型Gemini-2.5 Pro准确率也仅73.7%，开源模型普遍低于60%，主要困难在于时序理解和文字推理。这表明当前AI在视频文字识别方面仍有很大提升空间。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T23:03:19Z
- **目录日期**: 2025-05-30
