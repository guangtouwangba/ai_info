...
MME-VideoOCR是一个评估多模态模型视频OCR能力的基准测试，包含10类任务、25个子任务，覆盖1,464个视频片段和2,000条问答对，涵盖多样场景和干扰项。测试不仅评估基础识别能力，还要求时空定位、时序追踪、逻辑推理等高级功能。结果显示，最强模型Gemini-2.5 Pro准确率仅73.7%，开源模型普遍低于60%，主要难点在于时序理解和文字推理。该基准突显了视频OCR任务的挑战性，为未来模型优化提供了方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T13:12:25Z
- **目录日期**: 2025-05-30
