...
多模态大模型(MLLM)在视频OCR任务中面临显著挑战。研究团队开发了MME-VideoOCR评估框架，包含10类任务25个子任务，测试模型对视频文字的识别、理解和推理能力。该数据集含1,464个视频和2,000个问答，涵盖多样化场景并设置干扰项。评估显示，即使表现最佳的Gemini-2.5 Pro准确率仅73.7%，开源模型普遍低于60%，主要困难在于时序理解和文字推理。结果表明当前AI模型处理视频文字仍存在明显局限。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T14:03:49Z
- **目录日期**: 2025-05-30
