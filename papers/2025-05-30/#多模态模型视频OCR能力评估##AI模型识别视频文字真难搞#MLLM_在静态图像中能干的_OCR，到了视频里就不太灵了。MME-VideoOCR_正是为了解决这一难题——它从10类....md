...
MME-VideoOCR基准测试评估了多模态大模型在视频OCR任务中的表现。该测试包含1,464个视频片段和2,000条问答对，覆盖10类任务25个子任务，特别设置了模糊、遮挡等干扰项。测试不仅考察基础识别能力，还要求时空定位、时序追踪和逻辑推理。结果显示，表现最佳的Gemini-2.5 Pro准确率仅73.7%，开源模型普遍低于60%，主要难点在于时序理解和文字推理。这表明当前AI在视频文字识别方面仍面临重大挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T15:03:42Z
- **目录日期**: 2025-05-30
