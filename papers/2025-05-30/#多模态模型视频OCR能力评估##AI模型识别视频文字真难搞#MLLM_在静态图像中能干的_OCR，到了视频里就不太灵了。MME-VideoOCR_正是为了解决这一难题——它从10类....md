...
MME-VideoOCR是一个专门评估多模态模型视频OCR能力的基准测试，包含1,464个视频片段和2,000条问答对，覆盖多样场景并设置干扰项。测试从10类任务、25个子任务全面考察模型对视频文字的识别、理解和推理能力。结果显示，最强模型Gemini-2.5 Pro准确率仅73.7%，开源模型普遍低于60%，主要困难在于时序理解和文字推理。该研究揭示了当前AI在视频文字处理上的局限性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T22:03:18Z
- **目录日期**: 2025-05-30
