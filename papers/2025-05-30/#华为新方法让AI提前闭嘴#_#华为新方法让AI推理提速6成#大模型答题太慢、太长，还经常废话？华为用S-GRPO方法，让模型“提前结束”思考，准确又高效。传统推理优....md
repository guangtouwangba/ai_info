...
华为提出S-GRPO新方法，解决大模型推理时"想太多"的问题。该方法通过"串行分组+衰减奖励"机制，训练模型在思考过程中适时停止：完整推理后允许中途打断，答对越早奖励越高。实验显示，S-GRPO能节省60%计算量，在数学和科学推理任务中表现优于传统方法，路径更短且准确率更高，尤其适合计算资源受限场景。该方法突破了GRPO必须完整推理的限制，实现了效率与精度的双重提升。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T00:04:10Z
- **目录日期**: 2025-05-30
