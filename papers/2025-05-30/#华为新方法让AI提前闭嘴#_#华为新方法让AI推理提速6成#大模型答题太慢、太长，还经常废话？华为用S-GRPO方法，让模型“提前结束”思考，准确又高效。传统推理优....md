...
华为提出S-GRPO新方法，解决大模型推理时"想太多"的问题。该方法通过"串行分组+衰减奖励"机制，训练模型在推理过程中提前终止思考：若答案正确，越早停止奖励越高；若错误则无奖励。实验显示，S-GRPO在数学和科学推理任务中，可节省60%计算量，同时提高准确率。与传统GRPO相比，该方法生成的答案更短更精准，尤其在长度受限时优势显著，仅需一半计算资源即可达到更好效果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T02:33:04Z
- **目录日期**: 2025-05-30
