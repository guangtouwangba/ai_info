...
这篇论文针对代码生成大模型(codeLLMs)提出新评估方法，指出当前基准测试过于侧重代码正确性而忽视人类偏好。研究者开发了CodeArena基准(包含397个高质量样本，覆盖40类44种语言)来模拟真实编程任务，并构建近200亿标记的SynCode-Instruct合成指令集验证微调效果。实验发现执行基准与CodeArena存在性能差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI)差距显著，凸显了人类偏好对齐的重要性。该研究为提升代码LLMs的实用价值提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T13:14:29Z
- **目录日期**: 2025-05-30
