...
这篇论文提出了CodeArena基准测试和SynCode-Instruct语料库，用于评估代码生成大模型（codeLLMs）与人类偏好的对齐程度。CodeArena包含397个高质量样本，覆盖40个类别和44种编程语言；SynCode-Instruct则包含近200亿标记的合成指令数据。实验发现现有基于执行的基准测试与人类偏好存在差距，且开源模型（如Qwen2.5-Coder）与专有模型（如OpenAI o1）性能差异显著，凸显了人类偏好对齐的重要性。研究强调了代码生成模型需同时关注正确性和用户体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T18:05:32Z
- **目录日期**: 2025-05-30
