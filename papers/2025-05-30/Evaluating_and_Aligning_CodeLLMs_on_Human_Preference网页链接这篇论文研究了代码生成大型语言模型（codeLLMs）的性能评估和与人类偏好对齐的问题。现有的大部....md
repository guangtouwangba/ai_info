...
这篇论文针对代码生成大模型(codeLLMs)提出了CodeArena基准测试，强调评估模型输出与人类偏好的匹配度。研究者收集了397个高质量编程任务样本，覆盖40类任务和44种语言，并构建了20B标记的合成指令数据集SynCode-Instruct。实验发现传统执行测试与人类偏好评估存在差距，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著，凸显了人类偏好对齐的重要性。研究为提升代码生成模型的实际应用价值提供了新评估框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T07:05:57Z
- **目录日期**: 2025-05-30
