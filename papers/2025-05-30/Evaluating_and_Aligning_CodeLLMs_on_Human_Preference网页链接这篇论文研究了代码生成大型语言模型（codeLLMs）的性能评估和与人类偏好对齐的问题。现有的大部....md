...
这篇论文针对代码生成大模型(codeLLMs)提出CodeArena基准，通过397个涵盖40类编程任务和44种语言的高质量样本，评估模型与人类偏好的对齐程度。研究发现现有基于执行的测试与人类偏好存在差距，并构建了20B标记的合成指令数据集SynCode-Instruct验证微调效果。实验显示开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著，强调了人类偏好对齐在代码生成中的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-30T12:05:47Z
- **目录日期**: 2025-05-30
