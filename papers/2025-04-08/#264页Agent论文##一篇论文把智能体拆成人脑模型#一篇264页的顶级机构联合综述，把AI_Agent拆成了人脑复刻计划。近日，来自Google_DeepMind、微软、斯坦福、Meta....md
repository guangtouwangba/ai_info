...
这篇264页的综述论文由Google DeepMind、微软等顶级机构联合发表，提出了基于人脑模型的AI智能体架构。研究将智能体划分为感知、认知、世界模型、情绪、记忆和行动六大仿人模块，指出当前AI在情绪体验、长期记忆和因果推理等方面的不足。论文强调智能体需要自我优化能力，提出了提示词优化、在线学习等进化机制，并探讨了幻觉、越狱攻击等安全问题，引入"超级对齐"等监管概念。作者认为，要实现人类级智能，必须整合各子系统并持续迭代，人脑是最佳设计蓝图。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T01:31:03Z
- **目录日期**: 2025-04-08
