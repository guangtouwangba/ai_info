...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能够模拟10,000+个AI代理的社会互动（500万次交互）。该系统通过四个社会实验（政治极化、信息传播、基本收入政策、自然灾害影响）验证其有效性，结果与现实世界数据高度吻合。研究表明，该平台能有效捕捉人类行为模式和社会机制，可作为计算社会科学研究的新工具，为政策制定提供数据支持。其创新点在于结合LLM智能体、真实社会环境和大规模仿真引擎，突破了传统社会研究的局限性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T02:31:39Z
- **目录日期**: 2025-04-08
