...
AgentSociety是一种基于大语言模型的大规模社会模拟器，可模拟超过1万个代理的互动（500万次）。研究者用它分析了四大社会问题：社会极化、信息传播、基本收入政策及自然灾害影响。结果显示其模拟结果与现实数据吻合，验证了该工具在揭示人类行为机制方面的有效性。该系统有望成为社会科学研究和政策制定的重要辅助工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T18:05:22Z
- **目录日期**: 2025-04-08
