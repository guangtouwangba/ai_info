...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟器，可模拟1万多个代理的社会互动（500万次）。研究者用它研究了四个关键社会问题：社会极化、刺激性信息传播、无条件基本收入政策效果和飓风等外部冲击的影响。模拟结果与现实世界数据吻合，证明了该系统在捕捉人类行为机制方面的有效性。该平台可作为社会科学研究和政策制定的有力工具，为传统研究方法（如调查和干预）提供补充支持。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T15:05:46Z
- **目录日期**: 2025-04-08
