...
这篇论文介绍了AgentSociety，一个基于大语言模型的生成式智能体大规模社会模拟系统。该系统模拟了超过1万个智能体及其500万次互动，用于研究社会现象如极化现象、信息传播、基本收入政策影响和自然灾害应对。研究结果表明，该模拟器能有效捕捉人类行为模式，其输出与现实世界数据高度吻合，展现了作为社会科学研究和政策制定工具的潜力。该系统为理解复杂社会问题提供了新的计算实验平台。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T01:32:28Z
- **目录日期**: 2025-04-08
