...
这篇论文介绍了一个名为AgentSociety的大规模社会模拟器，它利用大型语言模型驱动的智能代理、真实社会环境和大规模模拟引擎，模拟了超过1万个代理的社会生活及其500万次互动。研究者将其作为计算社会科学实验平台，研究了社会极化、信息传播、基本收入政策及自然灾害影响等四个关键社会问题。结果显示，模拟结果与现实世界实验数据高度吻合，验证了该系统捕捉人类行为机制的能力，并展示了其作为社会科学研究和政策制定工具的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T00:04:30Z
- **目录日期**: 2025-04-08
