...
中国人民大学与蚂蚁集团的研究团队提出"个性化对齐大模型"新范式，突破传统AI价值观对齐的局限性。团队构建了包含90维心理特征的130万用户数据集AlignX，开发出ICA（上下文对齐）和PBA（偏好桥接）两项核心技术，使大模型能精准识别用户深层偏好。测试显示该模型平均提升偏好预测准确率17%，在应对新维度、数据稀缺等场景表现优异。研究开源了完整数据和模型框架，为AI个性化发展提供新思路。这项成果有望解决标准化对齐导致的少数群体声音淹没问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T06:04:41Z
- **目录日期**: 2025-04-08
