...
中国人民大学与蚂蚁集团的研究团队提出"个性化对齐大模型"新范式，突破传统AI价值观对齐的局限性。该研究构建了90维心理偏好空间和包含130万用户画像的AlignX数据集，开发了ICA（上下文对齐）和PBA（偏好桥接）两项核心技术。实验显示，新方法在四大基准测试中平均提升偏好预测准确率17%，能有效应对不同文化背景用户的个性化需求。研究团队已开源全部数据和模型，为AI系统实现真正个性化服务提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T07:03:42Z
- **目录日期**: 2025-04-08
