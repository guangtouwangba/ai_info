...
中国人民大学与蚂蚁集团研究团队提出首个个性化对齐大模型AlignXpert，突破传统AI价值观对齐的局限性。该技术通过构建90维心理偏好空间和130万用户画像数据集AlignX，开发出ICA（上下文对齐）和PBA（偏好桥接）两大核心技术，使大模型能精准识别用户深层偏好。实验显示其偏好预测准确率平均提升17%，在应对新偏好、数据稀缺等场景表现优异。研究团队开源了完整数据集和模型框架，推动AI从"普世对齐"迈向"个性化理解"的新阶段，有效解决少数群体被主流声音淹没的问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T08:04:03Z
- **目录日期**: 2025-04-08
