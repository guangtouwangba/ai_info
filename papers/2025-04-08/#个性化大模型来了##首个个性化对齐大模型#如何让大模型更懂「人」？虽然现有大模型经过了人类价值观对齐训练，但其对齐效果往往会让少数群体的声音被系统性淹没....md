...
中国人民大学与蚂蚁集团的研究团队提出"个性化对齐大模型"新范式，突破传统AI价值观对齐的局限性。针对现有大模型在标准化对齐过程中忽视少数群体需求的问题，团队构建了包含90维心理特征的130万用户数据集AlignX，开发出ICA（上下文对齐）和PBA（偏好桥接）两项核心技术。实验显示，该模型在偏好预测准确率上平均提升17%，能有效适应不同文化背景和个性化需求。研究实现了用户画像与偏好方向的双向建模，相关数据和模型已在HuggingFace平台开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T01:30:15Z
- **目录日期**: 2025-04-08
