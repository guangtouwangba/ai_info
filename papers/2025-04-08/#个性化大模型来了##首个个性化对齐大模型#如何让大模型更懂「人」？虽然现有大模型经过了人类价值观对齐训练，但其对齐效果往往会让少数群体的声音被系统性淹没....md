...
中国人民大学与蚂蚁研究团队提出个性化对齐大模型AlignXpert，解决传统大模型因标准化价值观对齐导致的少数群体偏好淹没问题。该研究构建了包含130万用户画像的AlignX数据集，通过90维心理偏好空间分析16亿条社交数据，开发出ICA（上下文对齐）和PBA（偏好桥接）两项核心技术。实验显示模型在四大测试中平均提升偏好预测准确率17%，能有效处理新偏好、数据稀缺等复杂场景。研究开源了完整数据和模型框架，推动AI向更精准的个性化服务发展。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T04:03:41Z
- **目录日期**: 2025-04-08
