...
中国人民大学与蚂蚁集团的研究团队提出个性化对齐大模型AlignXpert，突破传统AI价值观对齐的局限性。该技术通过构建90维心理偏好空间和130万用户画像数据集AlignX，开发出ICA（上下文对齐）和PBA（偏好桥接）两大核心技术，使大模型能精准识别用户深层偏好。实验显示其偏好预测准确率提升17%，在应对新偏好和数据稀缺场景表现优异。研究开源了完整数据和模型框架，推动AI从"普世对齐"迈向"个性化理解"，为解决数字鸿沟问题提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T05:03:25Z
- **目录日期**: 2025-04-08
