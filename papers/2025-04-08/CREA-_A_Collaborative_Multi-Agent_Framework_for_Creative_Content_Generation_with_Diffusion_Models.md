...
本文提出CREA框架，通过多智能体协作模拟人类创作过程，解决AI图像创作的原创性和艺术性挑战。该框架由多个专业AI智能体动态协作，完成构思、生成、评价和优化图像的完整流程。实验表明，CREA在多样性、语义对齐和创意转换方面显著优于现有方法。该研究首次将创意编辑定义为独立任务，通过将创作过程结构化，重新定义了AI与艺术的结合方式，为自主AI艺术探索、生成设计和人机协同创作开辟了新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T20:01:42Z
- **目录日期**: 2025-04-08
