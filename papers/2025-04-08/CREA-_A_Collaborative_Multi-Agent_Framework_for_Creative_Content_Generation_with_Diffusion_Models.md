...
本文提出CREA框架，通过多智能体协作模拟人类创作过程，解决AI图像创作的挑战。不同于传统基于提示的编辑，CREA采用自主迭代方法，平衡原创性、连贯性和艺术性。该框架包含多个专业AI代理，协同完成构思、生成、评估和优化。实验表明，CREA在多样性、语义对齐和创意转化方面显著优于现有方法。作为首个创造性编辑任务的研究，CREA重新定义了AI与艺术的结合，为自主艺术探索、生成设计和人机共创开辟了新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T21:01:52Z
- **目录日期**: 2025-04-08
