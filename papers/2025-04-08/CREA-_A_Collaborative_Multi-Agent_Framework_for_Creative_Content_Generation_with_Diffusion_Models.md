...
本文提出CREA框架，通过多智能体协作模拟人类创作过程，解决AI图像创作的挑战。与基于提示的直接编辑不同，CREA采用自主迭代方法，平衡原创性、连贯性和艺术意图。该系统由多个专业AI代理组成，协同完成构思、生成、评价和增强等环节。实验表明，CREA在多样性、语义对齐和创意转换方面显著优于现有方法。该研究首次定义了创意编辑任务，通过结构化创作流程重新定义AI与艺术的结合，为自主艺术探索、生成设计和人机共创开辟了新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T06:01:11Z
- **目录日期**: 2025-04-08
