...
本文提出CREA框架，通过多智能体协作模拟人类创作过程，解决AI图像创作的原创性与艺术性难题。不同于传统基于提示的编辑方法，CREA采用自主迭代方式，由专业化AI代理协同完成构思、生成、评价与优化。实验表明，该框架在多样性、语义对齐和创意转化方面显著优于现有方法。CREA将创造力构建为动态代理过程，重新定义了AI与艺术的结合，为自主AI艺术探索、生成设计和人机共创开辟了新路径。据作者所知，这是首个针对创意图像编辑任务提出的系统性解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T07:00:55Z
- **目录日期**: 2025-04-08
