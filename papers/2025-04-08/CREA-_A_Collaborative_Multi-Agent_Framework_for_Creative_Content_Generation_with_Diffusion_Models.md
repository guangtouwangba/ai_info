...
CREA是一个创新的多智能体协作框架，旨在解决AI图像创作的挑战。不同于传统的基于提示的直接修改，CREA通过模拟人类创作过程，利用多个专业AI智能体动态协作，进行构思、生成、评估和优化图像。该框架在多样性、语义对齐和创意转换方面显著优于现有方法。CREA将创造力构建为动态的智能体驱动过程，重新定义了AI与艺术的结合，为自主AI艺术探索、生成设计和人机协同创作开辟了新途径。这是首个专注于创意编辑任务的研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T18:01:48Z
- **目录日期**: 2025-04-08
