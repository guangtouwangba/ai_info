...
本文提出CREA框架，通过多智能体协作模拟人类创作过程，解决AI图像生成的创造力难题。不同于传统基于提示的直接编辑，CREA采用自主迭代方法，由多个专业AI代理协同完成构思、生成、评价和优化。实验表明，CREA在多样性、语义对齐和创意转换方面显著优于现有方法。该框架将创造力构建为动态代理过程，重新定义了AI与艺术的交叉领域，为自主AI艺术探索、生成设计和人机共创开辟了新途径。据作者所知，这是首个专注于创意编辑任务的研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T05:01:16Z
- **目录日期**: 2025-04-08
