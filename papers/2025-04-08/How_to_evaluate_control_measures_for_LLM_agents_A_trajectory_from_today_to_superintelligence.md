...
随着AI代理能力增强，自主造成危害的风险上升，开发者需通过"控制评估"测试安全措施的有效性。本文提出系统框架，根据AI能力动态调整红队测试权限，避免过度或不足的评估。作者虚构了5个能力递增的AI模型(M1-M5)，对应5个控制等级(ACL)，每个等级给出评估规则、控制措施和安全案例建议。研究指出，对超智能AI构建可靠安全案例需要突破性研究，未来可能需要新的对齐风险缓解方法。该框架旨在实现更实用、经济的AI控制，使评估与真实风险相匹配。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T14:01:48Z
- **目录日期**: 2025-04-08
