...
随着AI代理能力的提升，自主造成危害的风险增加，开发者需通过控制评估（如红队测试）验证防护措施的有效性。本文提出系统框架，根据AI能力调整红队测试的权限，避免过度依赖人类已知攻击策略，实现更精准、经济的评估。通过5个虚构模型（M1-M5）划分AI控制等级（ACLs），为每个等级提供评估规则、控制措施和安全案例。研究指出，针对超智能LLM代理的安全论证需突破性进展，最终可能需要新的对齐风险缓解方法。  
