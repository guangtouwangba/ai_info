...
随着AI代理自主造成危害的能力增强，开发者需采用更复杂的控制措施。本文提出通过"控制评估"（由红队模拟对抗测试）来验证控制措施的有效性，强调红队的权限设置应与AI能力相匹配。作者建立了系统框架，根据AI能力发展调整评估标准，并定义了5个AI控制等级（ACL），每个等级对应不同的评估规则和控制措施。研究指出，针对超级智能LLM代理的安全论证需要突破性研究，未来可能需要替代方案来解决对齐风险。该框架旨在提供更实用、经济的控制评估方法，避免过度依赖人类已知攻击策略假设。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T17:02:19Z
- **目录日期**: 2025-04-08
