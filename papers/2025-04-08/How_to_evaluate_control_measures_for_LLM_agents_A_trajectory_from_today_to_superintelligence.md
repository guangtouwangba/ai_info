...
随着AI代理能力的提升，其自主造成危害的风险增加，开发者需通过"控制评估"测试安全措施的有效性。本文提出系统性框架，根据AI能力动态调整红队的测试权限，避免过度或不足的评估。通过5个虚构模型（M1-M5）展示5级AI控制等级（ACL），为每个等级提供评估规则、控制措施和安全案例。研究表明，针对超级智能LLM代理构建可靠的安全案例需要突破性研究，最终可能需要替代方案应对错位风险。该框架旨在实现更实用、经济的AI控制，使评估与AI实际能力相匹配。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T13:09:26Z
- **目录日期**: 2025-04-08
