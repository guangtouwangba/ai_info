...
随着AI代理自主造成危害的能力增强，开发者需采用更复杂的控制措施。本文提出通过"控制评估"（红队测试）来验证控制措施的有效性，强调红队的权限设置应与被控AI的能力相匹配。作者构建了一个系统框架，根据AI能力发展调整评估标准，并以五个虚构模型（M1-M5）为例，定义了对应的AI控制等级（ACLs）。每个等级包含评估规则、控制措施和安全论证方案。研究指出，对超智能LLM代理建立可靠的安全论证需要突破性研究，最终可能需要替代方案来解决对齐风险。框架旨在实现更实用、经济的AI控制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T23:01:30Z
- **目录日期**: 2025-04-08
