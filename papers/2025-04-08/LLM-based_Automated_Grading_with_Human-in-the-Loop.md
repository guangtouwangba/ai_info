...
大型语言模型（LLMs）在教育领域的自动简答评分（ASAG）中展现出显著优势，超越传统方法并支持基于评分量表的复杂评估。然而，现有全自动化方法在量表评估中仍难以达到人类水平。本研究提出GradeHITL框架，通过人机协同（HITL）方式，利用LLMs的生成能力向专家提问并动态优化评分标准。这种交互式方法显著提升评分准确性，优于现有技术，使ASAG更接近人类评估水平。研究凸显了LLMs结合人类专业知识的潜力，为教育评估提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T16:02:47Z
- **目录日期**: 2025-04-08
