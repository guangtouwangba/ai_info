...
大型语言模型（LLMs）显著推动了自动短答案评分（ASAG）的发展，尤其在开放文本评估方面。相比传统方法，LLMs不仅能提升评分性能，还能支持基于量规的复杂评估。然而，当前全自动方法在量规评估中仍难以达到人类水平。为此，本研究提出GradeHITL框架，通过人机协同（HITL）方式，利用LLMs的生成能力向专家提问，动态优化评分标准。这种自适应方法显著提高了评分准确性，优于现有技术，使ASAG更接近人类评估水平。（99字）  

核心要点：  
1. LLMs推动ASAG技术进步  
2. 现有全自动方法存在量规评估瓶颈  
3. 人机协同框架GradeHITL通过动态交互优化标准  
4. 实验证明该方法显著提升评分准确性
