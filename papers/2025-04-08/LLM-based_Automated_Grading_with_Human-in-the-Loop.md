...
大型语言模型（LLMs）推动了自动短答案评分（ASAG）的发展，但现有全自动方法在基于量规的评估中仍难以达到人工水平。本研究提出GradeHITL框架，通过人机协同（HITL）方式，利用LLMs的交互能力向专家提问，动态优化评分标准。这种自适应方法显著提升了评分准确性，超越了现有技术，使ASAG更接近人工评估水平。研究突出了LLMs与人类专业知识结合在开放式答案评分中的潜力，为教育评估提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T13:10:33Z
- **目录日期**: 2025-04-08
