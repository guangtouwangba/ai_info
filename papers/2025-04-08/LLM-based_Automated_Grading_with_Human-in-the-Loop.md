...
大型语言模型（LLMs）推动了自动短答案评分（ASAG）的进步，尤其在基于量规的评估中表现优异，但仍难以完全达到人工评分水平。本研究提出GradeHITL框架，通过人机协同（HITL）方式，利用LLMs的生成能力向专家提问并动态优化评分标准，显著提升了评分准确性。该方法超越了现有全自动方案，使ASAG更接近人类评估水平。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T20:02:36Z
- **目录日期**: 2025-04-08
