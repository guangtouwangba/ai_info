...
人工智能（AI）和大语言模型（LLM）的发展推动了自动短答案评分（ASAG）的进步。传统方法依赖标准答案对比，而LLM能实现更复杂的评分，如基于量规的评估。然而，全自动方法在量规评分中仍难以达到人类水平。本研究提出GradeHITL框架，通过人机协同（HITL）方式，利用LLM的交互能力向专家提问，动态优化评分量规。实验表明，该方法显著提升评分准确性，优于现有技术，使ASAG更接近人类评估水平。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T18:02:38Z
- **目录日期**: 2025-04-08
