...
Meta近期因Llama 4模型陷入争议，主要被质疑三点：1）提交榜单的可能是优化版而非公开版本；2）竞技场托管版本与官网下载版输出质量差异大；3）被指训练时使用了测试集数据。Meta生成式AI副总裁Ahmad Al-Dahle回应称，模型刚发布需时间适配各平台，否认使用测试集训练，称表现不稳定是因平台技术实现仍需调优。他强调Llama 4是重要技术突破，承诺将与社区合作优化。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T03:14:35Z
- **目录日期**: 2025-04-08
