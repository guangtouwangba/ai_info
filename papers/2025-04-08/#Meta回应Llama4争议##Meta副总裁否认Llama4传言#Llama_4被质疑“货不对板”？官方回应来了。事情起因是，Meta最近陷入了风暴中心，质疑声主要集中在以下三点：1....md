# #Meta回应Llama4争议##Meta副总裁否认Llama4传言#Llama 4被质疑“货不对板”？官方回应来了。事情起因是，Meta最近陷入了风暴中心，质疑声主要集中在以下三点：1...
...
Meta近期因Llama 4模型陷入争议，被质疑存在三个问题：1）提交榜单的可能是优化版而非公开版本；2）竞技场托管版本与官网下载版输出质量差异大；3）涉嫌使用测试集数据训练。Meta生成式AI副总裁Ahmad Al-Dahle回应称，模型刚发布需时间完成平台适配和bug修复，否认使用测试集训练，称性能波动源于平台技术实现待优化。他强调Llama 4是重要技术突破，承诺与社区合作挖掘其价值。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T07:03:12Z
- **目录日期**: 2025-04-08
