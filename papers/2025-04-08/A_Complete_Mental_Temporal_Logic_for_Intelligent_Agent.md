...
本文提出了一种完整的心理时序逻辑BPICTL，通过引入心理模态扩展了CTL逻辑。研究给出了BPICTL的可靠且完备的推理系统，证明了其有限模型性质，并提出了一种BPICTL的模型检测算法。该工作扩展了传统时序逻辑的表达能力，使其能够处理智能体心理状态相关的推理问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T15:02:54Z
- **目录日期**: 2025-04-08
