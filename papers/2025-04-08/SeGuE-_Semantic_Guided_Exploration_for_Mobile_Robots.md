...
本文提出了一种基于语义探索的机器人自主建图方法，使移动机器人能够同时构建环境的结构和语义特征地图。该方法采用"最佳下一视点"策略，根据潜在视点可见的语义特征进行评分，并探索了两种不同的视点采样方法。实验证明，该框架在仿真和物理环境中均有效。高质量的语义地图能帮助机器人更好地理解和与环境互动，促进具身AI应用的部署。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T02:27:37Z
- **目录日期**: 2025-04-08
