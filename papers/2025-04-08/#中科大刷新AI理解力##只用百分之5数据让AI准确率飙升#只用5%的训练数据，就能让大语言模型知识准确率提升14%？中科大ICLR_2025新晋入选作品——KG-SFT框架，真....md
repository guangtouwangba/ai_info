...
中科大团队在ICLR 2025提出KG-SFT框架，通过知识图谱增强大语言模型的专业知识理解力。该框架包含实体提取、关键推理子图生成和知识冲突检测三大组件，仅用5%训练数据就在医学问答任务中实现14%准确率提升。该方法可兼容现有数据增强方案，在多语言、多领域场景展现强适应性，标志着AI发展从数据规模转向知识深度与推理质量的新阶段。论文一作为中科大2021级博士生陈瀚铸。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T08:03:53Z
- **目录日期**: 2025-04-08
