...
中科大团队在ICLR 2025提出KG-SFT框架，通过知识图谱增强大语言模型的专业知识理解力。该框架包含实体提取、推理子图生成和知识冲突检测三个组件，仅用5%训练数据就在医学问答任务中实现14%准确率提升。KG-SFT能作为插件兼容现有方案，在少数据、多语言场景表现优异，标志着AI发展从数据驱动转向知识深度理解的新阶段。论文一作为中科大陈瀚铸，展示了知识图谱与大模型结合的高效潜力。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T04:03:30Z
- **目录日期**: 2025-04-08
