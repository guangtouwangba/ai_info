...
中科大团队提出KG-SFT框架，通过知识图谱增强大语言模型的专业知识理解力。该框架包含实体提取、关键推理子图生成和知识冲突检测三大组件，仅用5%训练数据就在医学问答任务中实现14%准确率提升。KG-SFT具有多语言、多领域适应性，可兼容现有数据增强方案。研究由王杰教授团队完成，论文入选ICLR 2025，展示了大模型向质量型发展的新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T06:04:30Z
- **目录日期**: 2025-04-08
