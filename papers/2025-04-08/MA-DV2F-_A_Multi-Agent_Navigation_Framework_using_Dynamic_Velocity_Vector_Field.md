...
本文提出MA-DV2F框架，通过为每辆车独立生成动态速度矢量场（DV2F），实现多车辆在复杂环境中的协同控制。该框架提供导航网格中各点的参考速度和方向，并根据车辆间距离和速度实时更新矢量场，有效预防碰撞。实验表明，MA-DV2F在安全性、计算效率和目标到达准确性方面优于现有方法，尤其适用于大规模车辆群控。详见项目页面：https://yininghase.github.io/MA-DV2F/ （98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T20:03:01Z
- **目录日期**: 2025-04-08
