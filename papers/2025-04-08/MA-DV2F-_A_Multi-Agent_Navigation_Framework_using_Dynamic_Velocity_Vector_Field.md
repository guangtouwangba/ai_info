...
本文提出MA-DV2F框架，通过为每辆车独立生成动态速度矢量场（DV2F），实现多车辆在复杂环境中的协同控制。DV2F为车辆提供导航网格中各点的参考方向和速度，并根据自车与其他车辆的接近程度动态更新，有效预防碰撞。实验表明，该方法在大规模车辆场景下，在安全性、计算效率和目标到达精度方面优于现有方法。项目页面详见：https://yininghase.github.io/MA-DV2F/ （100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T15:03:13Z
- **目录日期**: 2025-04-08
