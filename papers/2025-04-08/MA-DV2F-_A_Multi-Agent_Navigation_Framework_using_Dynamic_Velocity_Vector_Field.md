...
本文提出MA-DV2F框架，一种多智能体动态速度矢量场方法，用于在复杂环境中同时控制多辆车辆。该框架为每辆车独立生成动态更新的速度矢量场，提供导航网格中各点的参考方向和速度，确保车辆安全到达目标。通过根据车辆速度和其他智能体的接近程度动态调整矢量场，有效预防潜在碰撞。实验表明，MA-DV2F在安全性、计算效率和目标到达准确性方面优于现有方法，尤其适用于大规模车辆群控。项目页面：https://yininghase.github.io/MA-DV2F/。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T14:02:33Z
- **目录日期**: 2025-04-08
