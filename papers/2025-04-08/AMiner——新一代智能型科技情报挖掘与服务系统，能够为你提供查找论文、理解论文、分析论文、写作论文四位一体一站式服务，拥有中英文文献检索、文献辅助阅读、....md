...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、辅助阅读、翻译、科研情报订阅等功能。平台拥有3.5亿论文、0.6亿学者等海量数据，支持AI生成摘要、章节概要和智能问答，帮助用户高效理解文献内容。用户可定制科研动态推送，关注特定学者或关键词，通过微信或邮件接收最新学术资讯。此外，AMiner还提供学者画像、学术会议等特色功能，免费开放使用。访问链接：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T11:05:32Z
- **目录日期**: 2025-04-08
