...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、辅助阅读及科研订阅等一站式服务。其核心功能包括：1）精准检索3.5亿论文资源；2）AI生成摘要与互动问答辅助理解文献；3）支持PDF文档解析及内容提问；4）定制化推送最新科研动态。平台覆盖42个学科，整合学者、专利及项目数据，并提供免费基础服务。特色功能包含学者画像、会议追踪和论文排行榜，显著提升学术研究效率。访问入口：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T08:05:46Z
- **目录日期**: 2025-04-08
