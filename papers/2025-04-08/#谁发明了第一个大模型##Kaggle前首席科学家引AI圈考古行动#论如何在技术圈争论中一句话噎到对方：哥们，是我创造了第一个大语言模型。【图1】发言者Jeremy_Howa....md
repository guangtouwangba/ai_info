...
这篇微博讨论了AI专家Jeremy Howard声称自己创造了第一个大语言模型(LLM)引发的争议。Howard是ULMFiT(2018)论文的作者，该模型采用无监督预训练-微调范式，被GPT-1作者承认是其灵感来源。考据显示ULMFiT具备现代LLM的核心特征，被认为是所有大模型的"共同祖先"。虽然它未使用Transformer架构，但在概念和技术路径上确实开创了先河。这场争论突显了ULMFiT作为NLP发展关键转折点却常被低估的历史地位。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T11:03:14Z
- **目录日期**: 2025-04-08
