...
Jeremy Howard（昆士兰大学名誉教授、Kaggle前首席科学家）声称自己创造了第一个大语言模型（LLM），引发AI圈热议。证据显示其2018年提出的ULMFiT模型采用无监督预训练-微调范式，被公认为现代大模型的"共同祖先"，GPT-1作者也承认受其启发。分析指出ULMFiT已具备语言模型、自监督训练等LLM核心特征，虽未使用Transformer架构，但在技术路径上具有开创性。这场争议突显了ULMFiT作为NLP领域关键转折点却长期被低估的现状。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T16:04:10Z
- **目录日期**: 2025-04-08
