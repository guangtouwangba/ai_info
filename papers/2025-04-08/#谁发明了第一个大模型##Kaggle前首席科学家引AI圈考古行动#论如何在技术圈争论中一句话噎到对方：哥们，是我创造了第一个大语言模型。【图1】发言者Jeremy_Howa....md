...
澳大利亚AI专家Jeremy Howard声称自己创造了第一个大语言模型，引发AI圈热议。其2018年提出的ULMFiT模型采用预训练-微调范式，被GPT-1团队承认是灵感来源。技术分析显示ULMFiT已具备现代LLM的核心特征，被学者称为"大模型的共同祖先"。虽然未使用Transformer架构，但该研究确实为后续发展奠定基础。这场争论凸显了ULMFiT在NLP发展史中被低估的关键作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T13:13:20Z
- **目录日期**: 2025-04-08
