...
Jeremy Howard（昆士兰大学教授、Kaggle前首席科学家）声称自己发明了第一个大语言模型，引发AI圈热议。经考证，其2018年提出的ULMFiT模型采用"预训练-微调"范式，被公认为现代大语言模型的技术先驱。GPT-1作者曾公开承认受其启发，学者指出ULMFiT具备LLM核心特征（语言建模、自监督、通用性），是当前大模型的"共同祖先"。虽然未使用Transformer架构，但该研究确实奠定了关键技术路径。这场争论凸显了ULMFiT在AI发展史中被低估的关键地位。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T10:03:09Z
- **目录日期**: 2025-04-08
