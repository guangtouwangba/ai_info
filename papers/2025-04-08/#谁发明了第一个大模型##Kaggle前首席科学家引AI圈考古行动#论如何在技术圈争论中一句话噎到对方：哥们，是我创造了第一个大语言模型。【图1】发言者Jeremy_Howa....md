...
这篇微博讨论了AI领域关于"谁发明了第一个大语言模型"的争议。Kaggle前首席科学家Jeremy Howard声称自己2018年发表的ULMFiT模型是首个大语言模型，并得到GPT-1作者的认可。考据显示ULMFiT采用预训练-微调范式，具备现代LLM的关键特征，被认为是所有大模型的"共同祖先"。虽然它未使用Transformer架构，但在概念和技术路径上确实开创了先河。这场争论引发了AI圈的"考古"热潮，突显了ULMFiT作为NLP发展史中被低估的重要转折点。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T18:03:47Z
- **目录日期**: 2025-04-08
