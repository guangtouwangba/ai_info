...
该研究探讨了大型语言模型(LLMs)在医疗应用中的不确定性量化，结合技术创新与哲学思考。研究强调在临床决策中准确传达不确定性对确保AI辅助医疗的可靠性与安全性至关重要。通过整合贝叶斯推理、深度集成和蒙特卡洛丢弃等概率方法，以及预测和语义熵的语言分析，提出了管理认知和随机不确定性的综合框架。该框架采用代理模型处理专有API限制，整合多源数据优化上下文，并通过持续学习和元学习实现动态校准。研究提倡接受可控模糊性而非绝对可预测性，符合负责任AI原则。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T11:01:15Z
- **目录日期**: 2025-04-08
