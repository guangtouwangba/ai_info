...
该研究探讨了大型语言模型(LLMs)在医疗应用中的不确定性量化问题，结合技术创新与哲学思考。随着LLMs参与临床决策，准确传达不确定性对确保AI辅助医疗的可靠性、安全性和伦理性至关重要。研究提出将贝叶斯推理、深度集成等概率方法与预测/语义熵分析相结合的综合框架，处理认知和随机不确定性。方案包含替代建模解决API限制、多源数据整合和动态校准，并通过不确定性图谱增强可解释性。哲学层面主张接受可控模糊性而非绝对确定性，承认医学知识的固有临时性，符合负责任AI原则。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T09:01:12Z
- **目录日期**: 2025-04-08
