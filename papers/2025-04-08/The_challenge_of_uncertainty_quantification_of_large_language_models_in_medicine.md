...
该研究探讨了大语言模型(LLMs)在医疗应用中的不确定性量化问题，结合技术创新与哲学思考。研究强调将不确定性视为知识的重要组成部分，而非障碍，提出通过贝叶斯推理、深度集成和蒙特卡洛丢弃等概率方法，结合预测和语义熵的语言分析，构建综合框架来管理认知和随机不确定性。该框架整合了替代模型、多源数据集成和动态校准技术，并通过不确定性图谱和置信度指标增强可解释性，以支持用户信任和临床决策。研究倡导接受可控的模糊性，而非追求绝对可预测性，符合负责任和反思性AI原则。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T10:01:17Z
- **目录日期**: 2025-04-08
