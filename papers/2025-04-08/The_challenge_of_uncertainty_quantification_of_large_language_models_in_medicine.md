...
本研究探讨了大型语言模型(LLMs)在医疗应用中的不确定性量化问题，结合技术创新与哲学思考。研究提出将贝叶斯推理、深度集成等概率方法与预测/语义熵分析相结合的综合框架，处理认知和随机不确定性。通过代理建模解决API限制、多源数据整合优化上下文理解，并采用持续学习和元学习进行动态校准。框架包含不确定性图谱和置信度指标以增强可解释性。哲学层面主张接受可控模糊性而非绝对确定性，承认医学知识的固有临时性，支持符合负责任AI原则的透明决策。研究强调不确定性应被视为知识的重要组成部分而非障碍。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T13:09:01Z
- **目录日期**: 2025-04-08
