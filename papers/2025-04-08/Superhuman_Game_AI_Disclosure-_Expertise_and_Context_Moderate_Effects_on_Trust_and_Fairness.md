...
研究表明，AI在特定任务中展现超人类能力时，透明度披露具有双刃剑效应。通过《角色卡片》模拟实验发现，披露能缓解怀疑，但也引发新手在合作场景中的挫败感与竞争环境下的过度依赖。资深玩家则因确认对手不可战胜而转向次优目标。研究强调，透明度并非万能，需结合用户特征、领域规范和公平目标进行定制。相关数据集已公开以促进可复现研究。成果表明，有效利用披露提升信任与问责需谨慎权衡，避免负面行为反应。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T11:02:11Z
- **目录日期**: 2025-04-08
