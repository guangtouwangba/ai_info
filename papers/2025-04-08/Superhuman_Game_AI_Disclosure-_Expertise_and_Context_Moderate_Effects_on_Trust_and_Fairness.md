...
该研究探讨了AI在特定任务中超越人类表现时，披露其超能力对用户态度和行为的影响。通过使用"人物卡片"模拟多样化用户反应，研究发现透明度具有双刃剑效应：虽然能减轻怀疑，但会引发新手在合作场景中的挫败感，以及竞争环境下的过度依赖。经验玩家则会将披露视为对手不可战胜的确认，转而追求次优目标。研究表明，透明度并非万能药，要有效利用披露来增强信任和问责，必须根据用户特征、领域规范和具体公平目标进行精心设计。研究发布了"人物卡片数据集"以促进可重复研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T10:02:15Z
- **目录日期**: 2025-04-08
