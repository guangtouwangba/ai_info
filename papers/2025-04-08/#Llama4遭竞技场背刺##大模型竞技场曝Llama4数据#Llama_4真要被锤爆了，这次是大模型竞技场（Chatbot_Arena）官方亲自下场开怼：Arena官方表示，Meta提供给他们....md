...
大模型竞技场(Chatbot Arena)指控Meta提供的Llama-4是经过人类偏好优化的特供版"Llama-4-Maverick-03-26-Experimental"，但未明确标注，影响排名公平性。竞技场公开2000多轮对战数据显示，该版本在代码生成、中文解析等任务中表现突出且更"讨喜"，使其排名跃居榜首，但实际使用中频繁翻车。Meta回应称差异源于部署问题而非测试集训练，但引发"刷榜"质疑。事件暴露当前AI模型评估体系的局限性，有人建议改进评分算法。官方虽保持透明，但争议仍未平息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T11:03:36Z
- **目录日期**: 2025-04-08
