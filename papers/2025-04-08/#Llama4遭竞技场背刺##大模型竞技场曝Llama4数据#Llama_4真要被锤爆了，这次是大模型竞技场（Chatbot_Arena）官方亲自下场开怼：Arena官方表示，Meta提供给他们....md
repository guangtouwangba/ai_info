...
Meta的Llama 4在大模型竞技场（Chatbot Arena）中被曝提交了特供优化版本"Llama-4-Maverick-03-26-Experimental"，该版本经过人类偏好优化但未明确标注，引发公平性质疑。竞技场公布2000多轮对战数据显示，Llama 4在代码生成、中文解析等任务表现优异，用户偏好显著，但实际使用中频繁翻车。虽然Meta否认用测试集训练，称差异源于部署问题，但模型排名与真实体验的差距仍引发"刷榜"质疑。事件暴露出现有AI评价体系的局限性，网友建议改进评分算法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T20:04:07Z
- **目录日期**: 2025-04-08
