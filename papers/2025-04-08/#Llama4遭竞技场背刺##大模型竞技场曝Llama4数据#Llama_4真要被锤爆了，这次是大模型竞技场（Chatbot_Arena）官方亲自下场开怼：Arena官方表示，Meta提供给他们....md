...
Llama4在大模型竞技场(Chatbot Arena)中被曝使用特供优化版本"Llama-4-Maverick-03-26-Experimental"，该版本经过人类偏好优化但未明确标注，导致排名异常跃升至榜首。官方公布2000多轮对战数据显示，该版本在代码生成、中文解析等任务中表现突出，但实际使用频繁翻车，引发"刷榜"质疑。Meta回应称差异源于部署问题，但未能平息争议。事件暴露出现有AI评估体系的局限性，网友建议改进评分算法。官方虽保持透明度，但事件仍存诸多疑点。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T18:04:05Z
- **目录日期**: 2025-04-08
