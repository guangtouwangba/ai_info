...
大模型竞技场(Chatbot Arena)指控Meta提交的Llama-4是经过人类偏好优化的特供版"Llama-4-Maverick-03-26-Experimental"，未明确标注影响排名公平性。公开的2000多轮对战数据显示，该版本在代码生成、中文解析等任务表现优异，用户偏好明显，但被质疑为"刷榜定制"。尽管排名跃居榜首超过DeepSeek-V3，实际使用却频繁翻车。Meta回应称差异源于部署问题，但难以服众。事件引发对现有评分机制（基于人类投票）的质疑，建议改进评价体系。官方虽保持透明，事件仍存诸多疑点。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T15:04:25Z
- **目录日期**: 2025-04-08
