...
大模型竞技场(Chatbot Arena)指控Meta提交的Llama-4是经过人类偏好优化的特供版"Llama-4-Maverick-03-26-Experimental"，未明确标注，影响排名公平性。竞技场公布2000多轮对战数据显示，该版本在代码生成、中文解析等任务表现优异，用户偏好明显，但被质疑为刷榜定制优化。尽管Meta否认使用测试集训练，称差异源于部署问题，但模型竞技场排名与实际体验不符引发争议。有观点认为现行基于人类投票的评分系统已过时，建议改进评估机制。事件暴露大模型评测透明度问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T16:04:29Z
- **目录日期**: 2025-04-08
