...
Llama 4因在Chatbot Arena竞技场中使用特殊优化版本（"Llama-4-Maverick-03-26-Experimental"）引发争议。该版本经人类偏好优化但未明确标注，导致排名异常跃升至榜首，超越DeepSeek-V3等模型。官方公布2000多轮对战数据显示，Llama 4在代码生成、中文解析等任务中表现优于对手，但被质疑"刷榜定制"。尽管Meta否认使用测试集训练，称差异源于部署问题，但用户反馈模型实际体验与评分不符。事件暴露当前AI评估体系的局限性，引发对评分算法和透明度的讨论。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T17:04:08Z
- **目录日期**: 2025-04-08
