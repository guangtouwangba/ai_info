...
Llama4在大模型竞技场(Chatbot Arena)中被曝使用特殊优化版本"Llama-4-Maverick-03-26-Experimental"，该版本经过人类偏好优化但未明确标注，影响排名公平性。竞技场公布2000多轮对战数据显示，Llama4在代码生成、中文解析等任务表现优异，用户偏好明显，但引发"定制优化刷榜"质疑。尽管排名跃居榜首超过DeepSeek-V3，实际使用中却频繁翻车。Meta回应称差异源于部署问题，但难以服众。事件暴露当前AI模型评估体系的局限性，引发对评分机制改革的讨论。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T14:03:45Z
- **目录日期**: 2025-04-08
