...
大模型竞技场(Chatbot Arena)官方指控Meta提交了特供版Llama-4-Maverick-03-26-Experimental参与评测，该版本经过人类偏好优化但未明确标注，影响排名公平性。公开的2000多轮对战数据显示，该版本在代码生成、中文解析等任务中表现优于竞品，但被质疑存在"刷榜"行为——其互动风格明显更讨喜，导致评分虚高（甚至超过DeepSeek-V3），与实际用户体验不符。Meta虽否认使用测试集训练，但未能平息争议。事件引发对现有AI评估方法的质疑，包括人类投票机制的局限性和算法改进需求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T21:04:15Z
- **目录日期**: 2025-04-08
