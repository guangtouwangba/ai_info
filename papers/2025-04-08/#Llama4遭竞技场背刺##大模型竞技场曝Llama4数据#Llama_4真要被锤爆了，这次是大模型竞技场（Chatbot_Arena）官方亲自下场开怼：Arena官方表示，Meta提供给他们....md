...
大模型竞技场(Chatbot Arena)指控Meta提交的Llama 4是经过人类偏好优化的特供版"Llama-4-Maverick-03-26-Experimental"，但未明确标注，影响排名公平性。竞技场公布了2000多轮对战数据，显示该版本在代码生成、中文解析等任务中表现优异且更"讨喜"，直接跃居榜首。但用户反馈实际使用频繁翻车，引发"刷榜"质疑。Meta回应称差异源于部署问题，但难以服众。事件暴露出现有AI评估体系的局限性，引发对评分机制改革的讨论。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T12:03:38Z
- **目录日期**: 2025-04-08
