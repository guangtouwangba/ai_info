...
大模型竞技场(Chatbot Arena)指控Meta提交的Llama 4是经过人类偏好优化的特供版"Llama-4-Maverick-03-26-Experimental"，但未明确标注，影响排名公平性。竞技场公布了2000多轮对战数据，显示该版本在代码生成、中文解析等任务中表现突出且更"讨喜"，但实际使用中频繁翻车，引发"刷榜"质疑。虽然Meta否认使用测试集训练，但模型排名(超过DeepSeek-V3)与真实表现的差距仍引发争议。有观点认为现行基于人类投票的评估方式已过时，需改进评分算法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T19:04:00Z
- **目录日期**: 2025-04-08
