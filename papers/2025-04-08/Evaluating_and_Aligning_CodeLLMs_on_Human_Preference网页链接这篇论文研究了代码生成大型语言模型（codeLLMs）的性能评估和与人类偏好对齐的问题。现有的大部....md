...
这篇论文提出了CodeArena基准测试，用于评估代码生成大模型(codeLLMs)与人类偏好的对齐程度。研究指出当前基准主要关注代码正确性，忽视了人类偏好因素。CodeArena包含397个高质量样本，覆盖40类任务和44种编程语言。同时构建了SynCode-Instruct语料库(近200亿标记)验证合成指令微调效果。实验发现执行基准与CodeArena存在性能差异，开源模型(如Qwen2.5-Coder)与专有模型(如OpenAI o1)差距显著，凸显了人类偏好对齐的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T21:06:03Z
- **目录日期**: 2025-04-08
