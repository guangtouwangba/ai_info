...
这篇论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，解决现有评估忽视人类偏好的问题。该基准包含397个高质量样本，覆盖40类任务和44种编程语言，模拟真实编程场景。研究还构建了20B标记的SynCode-Instruct合成指令集验证微调效果。实验发现执行基准与CodeArena存在性能差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)差距显著，凸显人类偏好对齐的重要性。研究为代码LLM评估提供了更全面的框架，强调除正确性外还需考虑用户体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T15:06:23Z
- **目录日期**: 2025-04-08
