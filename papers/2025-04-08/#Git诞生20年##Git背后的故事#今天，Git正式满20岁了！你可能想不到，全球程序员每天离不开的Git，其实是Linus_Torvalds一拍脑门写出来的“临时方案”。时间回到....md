...
Git诞生20周年，最初由Linus Torvalds在2005年为解决Linux内核团队版本控制工具危机而临时开发。这个去中心化的系统凭借本地完整仓库和透明历史记录迅速超越同类工具。开发者社区逐步完善了git log等常用指令，而商业广告投放等意外需求（如多分支管理素材）推动了SSL支持等关键升级。20年来其SHA-1哈希架构始终未变，现已成为OpenAI、Google等科技公司的开发标配，甚至支撑着现代大模型项目。这个始于"临时方案"的工具，最终重塑了全球协作编程的方式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T04:03:21Z
- **目录日期**: 2025-04-08
