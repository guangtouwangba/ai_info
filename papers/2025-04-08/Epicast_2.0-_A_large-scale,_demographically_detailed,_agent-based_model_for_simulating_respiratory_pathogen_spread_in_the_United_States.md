...
近期流感与新冠病毒等呼吸道病原体流行凸显了改进建模方法的紧迫性。本文介绍了Epicast 2.0——一个基于智能体的全国性传播模拟系统。该模型利用高性能计算技术，通过320多万个代理个体模拟美国全境的日常接触模式（学校、工作、社区活动），支持疫苗接种和多种非药物干预措施的精细化政策调控。研究通过多场景疫情模拟展示了模型在政策推演方面的强大功能，为开展"假设分析"和制定传染病防控策略提供了有力平台。该模型能更精准地捕捉异质性传播动态，提升资源分配和决策效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-08T01:28:57Z
- **目录日期**: 2025-04-08
