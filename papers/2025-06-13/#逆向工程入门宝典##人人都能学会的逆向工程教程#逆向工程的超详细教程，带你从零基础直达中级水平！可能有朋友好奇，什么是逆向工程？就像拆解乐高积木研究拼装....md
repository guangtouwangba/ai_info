...
这是一套面向零基础学习者的逆向工程教程，通过类比拆解乐高积木的方式，讲解如何通过现有系统反向推导设计原理。教程涵盖x86/x64架构和ARM处理器体系，从恶意软件分析基础到汇编语言解析循序渐进。提供PDF/MOBI电子书格式，支持内容持续更新。适合网络安全领域初学者系统学习，也可作为快速查阅的参考资料。教程网址：https://0xinfection.github.io/reversing/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T19:02:56Z
- **目录日期**: 2025-06-13
