...
这是一套面向零基础学习者的逆向工程教程，通过类比拆解乐高积木的方式讲解逆向工程原理。教程涵盖x86/x64架构和ARM处理器体系，从恶意软件分析基础到汇编语言解析循序渐进教学。提供PDF/MOBI电子书格式，支持内容持续更新。适用于网络安全领域入门者，通过模块化章节设计和侧边栏导航功能，既适合系统学习也方便知识点查阅。教程网址：https://0xinfection.github.io/reversing/（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T20:02:49Z
- **目录日期**: 2025-06-13
