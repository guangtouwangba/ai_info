...
这是一套面向零基础的逆向工程入门教程，通过类比拆解乐高积木的方式，讲解如何通过现有系统反向推导设计原理。教程涵盖x86/x64架构和ARM处理器体系，从恶意软件分析基础到汇编语言解析循序渐进。提供PDF/MOBI电子书格式，内容持续更新。特色包括侧边栏快速导航和适合不同学习需求的多媒体资源，旨在让网络安全领域的这项基本功变得简单易学。教程链接已附在文末。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T22:02:46Z
- **目录日期**: 2025-06-13
