...
这是一套面向零基础学习者的逆向工程教程，通过类比拆解乐高积木的方式解释逆向工程概念。教程涵盖x86/x64架构和32/64位ARM处理器体系，从恶意软件分析基础到汇编语言解析循序渐进。提供PDF/MOBI电子书格式，内容持续更新。特色包括侧边栏快速检索和适合不同学习需求的模块化设计，旨在帮助学习者掌握网络安全领域这一基础技能。附有详细图文示例和免费在线资源链接（0xinfection.github.io/reversing/）。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T13:12:00Z
- **目录日期**: 2025-06-13
