...
这是一套面向零基础学习者的逆向工程教程，通过类比拆解乐高积木的方式，讲解如何分析现有系统/产品的设计原理。教程内容涵盖x86/x64架构和ARM处理器体系，从恶意软件分析基础到汇编语言解析逐步深入。提供PDF/MOBI电子书格式，支持章节检索和内容自动更新。该资源被定位为网络安全领域的入门必备教材，适合想系统学习或复习特定概念的学习者。教程网址：https://0xinfection.github.io/reversing/（配图为教程界面和内容示例）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T12:02:48Z
- **目录日期**: 2025-06-13
