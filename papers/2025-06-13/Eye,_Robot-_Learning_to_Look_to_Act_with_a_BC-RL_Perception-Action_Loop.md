...
研究人员开发了EyeRobot系统，通过强化学习训练机械眼球与机械臂协同工作。该系统采用360度摄像头收集演示数据，并在仿真环境中训练眼球注视策略。通过BC-RL联合训练框架，机械臂（行为克隆）从眼球观测中学习动作，而眼球（强化学习）则通过提高机械臂动作准确性获得奖励，从而自然形成手眼协调能力。该系统采用类中央凹的视觉策略架构，在有限计算资源下实现高分辨率观测，表现出稳定的注视能力和抗干扰性。实验表明，EyeRobot能在全景工作空间中高效完成操作任务。项目网站：https://www.eyerobot.net/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T22:01:16Z
- **目录日期**: 2025-06-13
