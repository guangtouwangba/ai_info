...
研究人员开发了EyeRobot系统，通过强化学习训练机械眼球自主转动以完成任务。该系统采用360度摄像头收集演示数据，并在仿真环境中训练手眼协同策略：手部（行为克隆）根据眼球观测执行动作，而眼球（强化学习）通过手部动作准确性获得奖励，从而自然形成协调机制。该系统采用类似人类中央凹的高效视觉架构，能以低计算成本实现高分辨率观察，同时增强注视稳定性和目标追踪能力。实验表明，EyeRobot能在单摄像头支持下，有效完成环绕机械臂的大范围操作任务。项目详情见：https://www.eyerobot.net/（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T20:01:06Z
- **目录日期**: 2025-06-13
