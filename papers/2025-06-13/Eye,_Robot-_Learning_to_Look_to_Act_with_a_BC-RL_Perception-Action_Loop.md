...
研究人员开发了EyeRobot系统，通过机械眼球主动观察环境来完成任务。该系统采用强化学习训练注视策略，结合360°相机采集的遥操作数据，在仿真环境中训练手眼协同：手部（行为克隆）从眼球视角学习动作，而眼球（强化学习）通过手部动作准确性获得奖励。这种机制使眼球自然聚焦于有助于任务完成的区域。系统采用类似中央凹的高分辨率策略架构，实现了稳定注视和抗干扰能力。在5个环绕式操作任务测试中，EyeRobot展示了单摄像头下大范围工作空间的高效手眼协调能力。项目网站：https://www.eyerobot.net/ (98字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T15:01:09Z
- **目录日期**: 2025-06-13
