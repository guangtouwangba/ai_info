...
本文提出SWE-Factory自动化流水线，用于高效构建GitHub问题解决任务的大规模数据集。该流水线包含三个核心组件：SWE-Builder多智能体系统（自动搭建评估环境）、基于退出码的标准化评分方法（无需人工解析）以及自动化的fail2pass验证。实验表明，在4种编程语言的671个问题上，SWE-Builder能以0.024-0.045美元/实例的成本有效构建有效实例，评分准确率达100%，验证精确度0.92、召回率1.00。该方法显著降低了传统基准构建的高昂人力成本，为LLM的软件工程能力评估提供高效解决方案。代码与数据集已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T15:01:19Z
- **目录日期**: 2025-06-13
