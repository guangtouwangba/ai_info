...
随着生成式AI（GenAI）输出的质量提升，区分AI与人类生成内容变得愈发困难。数字水印技术是一种有前景的解决方案，通过在AI生成内容中嵌入隐藏信号实现可靠检测。尽管水印无法解决GenAI的所有风险，但它能通过打击虚假信息增强AI的安全性和可信度。本文全面综述了GenAI水印技术，从历史与监管需求出发，定义了水印方案的标准与理想特性，分析了现有方法的核心目标与威胁模型，并探讨了抗攻击的鲁棒水印开发策略。此外，文章总结了代表性研究、开放挑战及未来方向，为研究者和政策制定者提供指导。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T22:02:10Z
- **目录日期**: 2025-06-13
