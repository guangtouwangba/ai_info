...
随着生成式AI（GenAI）输出质量的提升，区分AI与人类生成内容变得愈发困难。水印技术通过嵌入隐藏信号实现可靠检测，成为解决该问题的有效方法。尽管水印并非应对GenAI所有风险的万能方案，但它在打击错误信息和欺骗行为、增强AI安全性与可信度方面至关重要。本文系统梳理了GenAI水印技术，包括其历史与监管需求、定义与理想特性、核心目标与威胁模型，并探讨了实用评估策略以开发抗攻击的鲁棒水印。同时综述了代表性研究，指出开放挑战与未来方向，为研究者和政策制定者提供指导。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T10:02:32Z
- **目录日期**: 2025-06-13
