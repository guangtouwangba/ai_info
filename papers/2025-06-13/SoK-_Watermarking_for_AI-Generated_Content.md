...
随着生成式AI（GenAI）输出的质量提升，区分AI与人类生成内容变得愈发困难。数字水印技术通过嵌入隐藏信号来可靠检测AI生成内容，成为解决该问题的有效方法。虽然水印不能完全消除GenAI的所有风险，但能通过打击虚假信息增强AI的安全性和可信度。本文系统综述了GenAI水印技术，包括其历史需求、监管背景、定义、特性、目标及威胁模型，并探讨了抗攻击的评估策略。通过分析代表性研究、开放挑战和未来方向，为研究者提供水印方法发展的指导，并辅助政策制定者应对GenAI的广泛影响。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T12:02:10Z
- **目录日期**: 2025-06-13
