...
随着生成式AI（GenAI）输出的质量提升，区分AI与人类生成内容变得愈发困难。数字水印技术通过嵌入隐藏信号来可靠识别AI生成内容，成为解决这一问题的有效方法。虽然水印技术无法完全消除GenAI的所有风险，但能通过打击虚假信息增强AI的安全性和可信度。本文系统梳理了GenAI水印技术，从历史与监管需求出发，明确了水印的定义、特性及现有方案的核心目标与威胁模型，探讨了抗攻击的实用评估策略。同时总结了代表性研究、现存挑战及未来方向，为研究者提供方法指导，并为政策制定者应对GenAI影响提供参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T14:02:19Z
- **目录日期**: 2025-06-13
