...
随着生成式AI（GenAI）输出的质量提升，区分AI与人类生成内容变得愈发困难。数字水印技术通过嵌入隐藏信号实现可靠检测，成为解决该问题的有效方法。尽管水印并非应对GenAI所有风险的万能方案，但它在打击错误信息和欺骗行为、增强AI安全性与可信度方面至关重要。本文系统综述了GenAI水印技术，从历史与监管角度阐述其必要性，定义水印方案的核心特性与目标，分析威胁模型及抗攻击评估策略，并总结最新研究成果。研究旨在为水印技术发展提供指导，并协助政策制定者应对GenAI的广泛影响。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T18:02:20Z
- **目录日期**: 2025-06-13
