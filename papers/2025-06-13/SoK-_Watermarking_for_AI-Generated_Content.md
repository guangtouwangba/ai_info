...
随着生成式AI（GenAI）输出质量提升，区分AI与人类生成内容变得愈发困难。数字水印技术通过嵌入隐藏信号实现可靠检测，成为解决该问题的有效方案。尽管水印不能完全消除GenAI所有风险，但能通过打击虚假信息增强AI安全性和可信度。本文系统梳理了GenAI水印技术，从历史与监管角度阐述需求，规范水印定义与理想特性，分析现有方法的核心目标与威胁模型，探讨抗攻击的鲁棒水印评估策略。综述代表性研究的同时，指出开放挑战与未来方向，为研究者提供方法指导，并为政策制定者应对GenAI影响提供参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T06:02:34Z
- **目录日期**: 2025-06-13
