...
随着生成式AI（GenAI）输出质量的提升，区分AI与人类生成内容变得日益困难。数字水印技术通过嵌入隐藏信号来识别AI生成内容，成为解决这一问题的有效方法。尽管水印并非应对GenAI所有风险的万能方案，但它在增强AI安全性和可信度、打击虚假信息方面发挥关键作用。本文全面综述了GenAI水印技术，从历史和监管角度探讨其必要性，定义水印方案的特性和目标，分析威胁模型及抗攻击策略，并总结代表性研究、现存挑战和未来方向，旨在为研究者和政策制定者提供指导，推动水印技术发展与应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T11:02:03Z
- **目录日期**: 2025-06-13
