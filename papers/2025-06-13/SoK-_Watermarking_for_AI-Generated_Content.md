...
随着生成式AI（GenAI）输出质量的提升，区分AI与人类生成内容变得日益困难。数字水印技术通过嵌入隐藏信号来识别AI生成内容，成为解决这一问题的有效方法。虽然水印并非应对GenAI所有风险的万能方案，但它在打击错误信息和欺骗行为、提升AI安全性和可信度方面至关重要。本文全面综述了GenAI水印技术，从历史和监管角度探讨其必要性，明确了水印的定义、特性、核心目标和威胁模型，并分析了抗攻击的鲁棒水印开发策略。此外，文章总结了最新研究、现存挑战及未来方向，为研究者和政策制定者提供指导。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T07:02:51Z
- **目录日期**: 2025-06-13
