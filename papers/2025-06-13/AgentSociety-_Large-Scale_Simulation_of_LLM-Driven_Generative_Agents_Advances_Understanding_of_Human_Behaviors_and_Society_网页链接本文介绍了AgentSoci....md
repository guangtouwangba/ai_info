...
该研究介绍了AgentSociety，这是一个利用大型语言模型驱动的大规模社会模拟器，包含1万多个代理和500万次互动。研究通过模拟四个关键社会问题（极化现象、信息传播、基本收入政策、飓风影响），验证了其作为计算社会科学工具的有效性。结果显示模拟结果与现实世界实验高度吻合，表明该系统能有效捕捉人类行为机制，为社会科学研究和政策制定提供了新方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T07:06:30Z
- **目录日期**: 2025-06-13
