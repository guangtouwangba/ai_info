...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理的社会互动（500万次）。研究者用它研究了四大社会问题：社会极化、信息传播、基本收入政策效果和自然灾害影响。该系统能有效支持传统社会科学研究方法，其模拟结果与现实世界数据高度吻合，验证了其在捕捉人类行为机制方面的可靠性。这为社会科学研究和政策制定提供了强大的新工具，展现了AI模拟在理解复杂社会现象中的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T10:05:15Z
- **目录日期**: 2025-06-13
