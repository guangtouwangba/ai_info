...
字节跳动发布多主体视频生成工具MAGREF，仅需一张参考图像即可生成主体高度一致的视频，支持多人同框不串脸。该技术通过掩码引导和通道拼接机制，能精准复刻任何时代、风格的主体特征，并根据文本指令渲染多样化动作、环境和光影。MAGREF在不增加模型复杂度的情况下，实现了对单人、多人物互动及复杂场景的统一处理，确保身份稳定、结构一致。其创新性在于突破了传统视频生成的主体限制，使生成内容更具可控性和协调性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T11:03:03Z
- **目录日期**: 2025-06-13
