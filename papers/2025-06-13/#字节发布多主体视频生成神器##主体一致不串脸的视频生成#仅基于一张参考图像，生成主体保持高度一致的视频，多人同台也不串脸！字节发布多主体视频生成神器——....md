...
字节跳动发布多主体视频生成工具MAGREF，仅需一张参考图像即可生成主体高度一致的视频，支持多人同框不串脸。该技术通过掩码引导和通道拼接机制，能精准复刻不同风格主体的身份特征，并根据文本指令渲染多样化动作、环境和光影。MAGREF不增加模型复杂度，即可实现单人、多人物互动及人物与物体/背景的协调生成，保持身份稳定和结构一致。适用于各类主体（包括抽象风格），展现强大的多主体视频生成能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T20:03:21Z
- **目录日期**: 2025-06-13
