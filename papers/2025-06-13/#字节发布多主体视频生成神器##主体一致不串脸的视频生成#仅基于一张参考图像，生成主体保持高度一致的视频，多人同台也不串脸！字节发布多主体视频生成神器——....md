...
字节跳动发布多主体视频生成工具MAGREF，仅需一张参考图像即可生成主体高度一致的视频，支持多人同框且不串脸。该系统能精准复刻不同时代、风格的输入对象特征，并根据文本指令渲染多样化动作、环境和光影效果。通过掩码引导与通道拼接机制，MAGREF在不增加模型复杂度的情况下实现多参考图像统一处理，支持单人、多人物互动及复杂场景生成，确保身份稳定、结构一致。该技术突破了传统视频生成的主体一致性难题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T22:03:16Z
- **目录日期**: 2025-06-13
