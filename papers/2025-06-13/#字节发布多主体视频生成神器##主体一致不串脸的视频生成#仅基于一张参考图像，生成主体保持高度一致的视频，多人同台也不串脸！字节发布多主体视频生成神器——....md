...
字节跳动发布多主体视频生成工具MAGREF，仅需一张参考图像即可生成主体高度一致的视频，支持多人同框且不串脸。该技术通过掩码引导和通道拼接机制，能精准复刻不同风格主体的身份特征，并根据文本指令渲染多样化动作、环境和光影。MAGREF在保持模型简洁的同时，实现了对单人、多人物互动及复杂场景的统一处理，确保视频中身份稳定、结构一致。这一突破使视频生成更具可控性，让每个主体都能成为画面主角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T13:12:33Z
- **目录日期**: 2025-06-13
