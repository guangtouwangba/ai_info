...
字节跳动发布多主体视频生成工具MAGREF，仅需一张参考图像即可生成主体高度一致的视频，支持多人同框且不串脸。该系统能精准复刻不同风格主体的身份特征，并根据文本指令渲染多样化动作、环境和光影效果。通过掩码引导与通道拼接机制，MAGREF在不增加模型复杂度的情况下，实现了对多参考图像的统一处理，支持单人、多人互动及复杂场景生成，确保身份稳定、结构一致。该技术突破了传统视频生成的限制，使每个主体都能保持特征一致性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T16:04:09Z
- **目录日期**: 2025-06-13
