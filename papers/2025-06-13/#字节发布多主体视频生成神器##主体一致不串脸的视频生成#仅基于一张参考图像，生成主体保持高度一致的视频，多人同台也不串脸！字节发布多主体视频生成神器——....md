...
字节跳动发布多主体视频生成工具MAGREF，仅需一张参考图像即可生成主体高度一致的视频，支持多人互动且不会"串脸"。该系统通过掩码引导和通道拼接技术，在不增加模型复杂度的情况下，能精准复刻不同时代、风格的主体特征，并根据文本指令渲染多样化动作、环境和光影。无论是单人、多人物互动，还是人物与物体/背景的组合，MAGREF都能生成身份稳定、结构一致的视频序列，实现了"主体一致不串脸"的视频生成效果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T17:04:18Z
- **目录日期**: 2025-06-13
