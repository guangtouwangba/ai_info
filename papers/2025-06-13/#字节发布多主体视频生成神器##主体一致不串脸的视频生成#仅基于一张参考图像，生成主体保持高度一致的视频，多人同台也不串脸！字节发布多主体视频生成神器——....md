...
字节跳动发布多主体视频生成工具MAGREF，仅需单张参考图像即可生成主体高度一致的视频，支持多人同框不串脸。该技术通过掩码引导和通道拼接机制，能精准复刻不同时代、风格的输入主体特征，并依据文本指令渲染多样化动作、环境及光影效果。MAGREF不增加模型复杂度，即可实现单人、多角色互动及复杂场景的稳定生成，保持身份一致性和语义协调性。其核心突破在于统一处理多样参考图像的能力，使生成视频具备可控的叙事表现力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T15:03:24Z
- **目录日期**: 2025-06-13
