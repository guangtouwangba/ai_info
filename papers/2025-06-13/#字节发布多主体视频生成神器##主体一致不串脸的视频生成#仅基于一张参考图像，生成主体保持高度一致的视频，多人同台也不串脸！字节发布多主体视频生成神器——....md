...
字节跳动发布多主体视频生成工具MAGREF，仅需单张参考图像即可生成主体高度一致的视频，支持多人同框且不会"串脸"。该系统通过掩码引导和通道拼接技术，在不增加模型复杂度的情况下，能精准复现任何时代、风格的人物特征，并依据文本指令生成多样化动作、环境和光影效果。MAGREF不仅支持单人视频生成，还能处理多人物互动及复杂场景，确保身份稳定、结构一致。这项技术突破了当前视频生成的主体一致性难题，实现了更灵活可控的多主体视频创作。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T18:03:50Z
- **目录日期**: 2025-06-13
