...
这篇论文研究了代码生成大模型(codeLLMs)与人类偏好的对齐问题，提出了新基准CodeArena(包含397个高质量样本，覆盖40类任务和44种语言)和合成指令数据集SynCode-Instruct(20B标记)。研究发现：1)传统基于执行的评估与人类偏好存在差异；2)开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究强调了代码生成模型除正确性外，还需重视与开发者实际需求的匹配。通过构建新基准和大规模指令数据，为提升代码LLMs的实用价值提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T00:05:16Z
- **目录日期**: 2025-06-13
