...
大型语言模型（LLM）代理在解决现实数据科学问题中展现出潜力，但现有框架依赖固定流程和编码策略，仅适用于简单任务。为此，研究团队提出**AutoMind**框架，通过三大创新提升性能：(1) 构建专家知识库增强领域认知；(2) 采用知识树搜索算法策略性探索解决方案；(3) 自适应编码策略动态调整代码生成。实验表明，AutoMind在自动化数据科学基准测试中显著优于现有方案，兼具高效性与鲁棒性，为全自动化数据科学提供了有效路径。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T17:01:00Z
- **目录日期**: 2025-06-13
