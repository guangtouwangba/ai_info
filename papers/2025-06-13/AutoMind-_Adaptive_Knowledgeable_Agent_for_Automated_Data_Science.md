...
大型语言模型(LLM)代理在解决现实数据科学问题方面潜力巨大，但现有框架依赖固定流程和编码策略，仅适用于简单问题。本文提出AutoMind框架，通过三大创新克服局限：(1)专家知识库提供领域专业知识；(2)知识树搜索算法战略性地探索解决方案；(3)自适应编码策略根据任务复杂度动态调整代码生成。在两个自动化数据科学基准测试中，AutoMind表现优于现有方法，在效率、效果和解决方案质量方面均展现出优势，为实现全自动化数据科学迈出重要一步。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T03:22:52Z
- **目录日期**: 2025-06-13
