...
大型语言模型（LLM）代理在解决现实数据科学问题中潜力巨大，但现有框架依赖固定流程和编码策略，仅适用于简单任务，难以应对复杂创新场景。为此，研究团队提出了AutoMind框架，通过三大创新突破限制：（1）基于专家知识库增强领域认知；（2）采用智能树搜索算法探索解决方案；（3）自适应编码策略动态调整代码生成。实验表明，该框架在自动化数据科学基准测试中性能优于现有方案，在效率、质量和鲁棒性方面表现突出，推动了全自动化数据科学的发展进程。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T15:01:00Z
- **目录日期**: 2025-06-13
