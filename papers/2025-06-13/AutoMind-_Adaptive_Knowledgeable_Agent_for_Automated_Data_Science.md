...
大型语言模型（LLM）代理在解决现实数据科学问题中潜力巨大，但现有框架依赖僵化的工作流程和编码策略，仅适用于简单任务。为此，研究者提出AutoMind框架，通过三大创新提升性能：（1）基于领域专家知识的专业知识库；（2）智能树搜索算法探索解决方案；（3）自适应编码策略动态调整代码生成。实验表明，AutoMind在自动化数据科学基准测试中表现优于现有方法，兼具高效性和鲁棒性，为全自动化数据科学迈出重要一步。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T19:01:00Z
- **目录日期**: 2025-06-13
