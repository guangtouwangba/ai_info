...
大型语言模型（LLM）代理在解决现实数据科学问题中潜力巨大，但现有框架依赖僵化流程，难以应对复杂任务。本文提出AutoMind框架，通过三个关键创新提升性能：（1）构建专家知识库增强领域认知；（2）采用知识树搜索算法策略性探索解决方案；（3）自适应编码策略动态调整代码生成复杂度。实验表明，AutoMind在自动化数据科学基准测试中优于现有方法，展现出高效性、鲁棒性和优质解决方案生成能力，推动了全自动化数据科学的发展进程。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T12:01:06Z
- **目录日期**: 2025-06-13
