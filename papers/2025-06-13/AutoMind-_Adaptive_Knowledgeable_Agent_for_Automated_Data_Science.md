...
大型语言模型（LLM）代理在解决现实数据科学问题中展现出潜力，但现有框架依赖固定流程和编码策略，仅适用于简单任务。为此，研究团队提出AutoMind框架，通过三大创新突破局限：（1）构建专家知识库以提供领域知识支持；（2）采用智能树搜索算法探索解决方案；（3）开发自适应编码策略动态调整代码生成。实验表明，AutoMind在自动化数据科学基准测试中性能优于现有方法，在效率、效果和解决方案质量上表现优异，为实现全自动化数据科学迈出重要一步。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T08:01:06Z
- **目录日期**: 2025-06-13
