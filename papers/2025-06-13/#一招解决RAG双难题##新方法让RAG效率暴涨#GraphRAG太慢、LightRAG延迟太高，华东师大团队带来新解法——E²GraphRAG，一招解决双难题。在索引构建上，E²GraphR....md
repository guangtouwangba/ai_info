...
华东师大团队提出E²GraphRAG新方法，有效解决GraphRAG速度慢和LightRAG延迟高的问题。该方法通过两步优化：1）用大模型构建文档总结树，提取多粒度信息；2）用SpaCy抽取实体并构图，增强检索精度。相比GraphRAG，索引构建快10倍；查询速度是LightRAG的100倍，同时保持信息处理的细粒度和准确性。E²GraphRAG结合层级信息与实体关系，构建出轻量高效的检索系统，显著提升RAG效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T00:03:50Z
- **目录日期**: 2025-06-13
