...
这篇立场论文主张改变当前网页代理的研究范式，提出应开发专为AI代理优化的新型交互界面——"Agentic Web Interface (AWI)"，而非强迫代理适应人类设计的界面。现有方法因网页输入复杂性（如处理庞大DOM树、依赖增强截图或API交互）面临挑战。AWI基于六大设计原则（安全性、效率、标准化等），旨在克服现有界面的根本限制，为更高效、可靠、透明的网页代理铺路。这需要机器学习社区的广泛协作，平衡各方利益相关者的需求，推动网页自动化任务的发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T02:31:45Z
- **目录日期**: 2025-06-13
