...
这篇立场论文提出，当前基于大语言模型（LLM）的网络代理面临核心挑战：人类设计的界面与AI能力不匹配。作者主张转变研究范式，建议开发专为AI优化的"代理式网络界面"（AWI），而非让AI适应人类界面。AWI设计遵循六大原则，注重安全性、效率和标准化，平衡各方利益。这种新范式旨在克服现有界面的根本局限，推动更高效、可靠、透明的网络代理发展，需要机器学习社区的广泛协作。该方案试图解决当前方法处理DOM树、截图增强或API交互等存在的固有缺陷。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T08:01:43Z
- **目录日期**: 2025-06-13
