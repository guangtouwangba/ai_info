...
这篇立场论文提出，当前基于大语言模型（LLM）的网页代理面临核心挑战：人类设计的界面与AI能力不匹配。现有方法在处理复杂网页输入时存在局限，无论是解析DOM树、依赖增强截图还是通过API交互。作者主张转变研究范式，建议开发专为AI优化的"代理式网页界面"（AWI），而非让AI适应人类界面。AWI设计遵循六大原则，注重安全性、效率和标准化，兼顾各方利益相关者。这种重构旨在突破现有界面限制，推动更高效、可靠、透明的网页代理发展，需要机器学习社区的广泛协作。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T21:01:30Z
- **目录日期**: 2025-06-13
