...
这篇立场论文主张转变网页代理研究范式，提出应开发专为AI代理优化的新型交互界面（AWI），而非让人工智能适应人类设计的网页界面。当前基于大语言模型（LLM）的网页代理面临核心矛盾：现有网页界面与AI能力不匹配，导致处理DOM树、增强截图或API交互等方法均存在局限。作者提出AWI设计的六大原则，强调安全性、效率和标准化，需平衡各方利益。这一重构旨在突破现有界面限制，推动更高效、可靠、透明的网页代理发展，需要机器学习社区的广泛协作。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T04:05:53Z
- **目录日期**: 2025-06-13
