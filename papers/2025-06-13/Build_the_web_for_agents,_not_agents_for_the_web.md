...
这篇立场论文提出，当前基于大语言模型（LLM）的网页代理面临核心挑战：人类界面与AI能力不匹配。针对网页DOM树复杂、截图信息有限等问题，作者主张转变研究范式，建议开发专为AI优化的"代理式网页界面"（AWI）。AWI设计遵循六大原则，强调安全性、效率和标准化，旨在平衡各方利益。这种新交互范式有望突破现有界面限制，推动更高效、可靠、透明的网页代理发展，需要机器学习社区的广泛协作。该方案为解决网页代理与人类界面间的根本性矛盾提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T13:10:38Z
- **目录日期**: 2025-06-13
