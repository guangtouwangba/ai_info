...
这篇立场论文主张改变网页智能体（Web Agent）的研究范式，提出应开发专为AI优化的"代理式网页界面"（AWI），而非让人工智能适应人类设计的界面。当前基于大语言模型（LLM）的网页代理面临核心挑战：网页输入复杂度高，现有方法（如处理DOM树、增强截图或API交互）存在根本性局限。AWI设计遵循六大原则，注重安全性、效率和标准化，兼顾各方利益相关者。这种新范式旨在突破现有界面限制，推动更高效、可靠、透明的网页代理发展，需要机器学习社区的广泛协作。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T11:01:25Z
- **目录日期**: 2025-06-13
