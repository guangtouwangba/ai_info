...
这篇立场论文提出，当前基于大语言模型（LLM）的网页代理面临核心挑战：人类界面设计与AI能力不匹配。现有方法处理DOM树、截图增强或API交互都存在局限。作者主张范式转变，建议开发专为AI优化的"代理式网页界面"（AWI），而非让AI适应人类界面。AWI设计遵循六项原则，注重安全性、效率和标准化，平衡各方利益。这种重构旨在突破现有界面限制，推动更高效、可靠、透明的网页代理发展，需要机器学习社区的广泛协作。新范式将改变网页自动化任务的实现方式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T19:01:28Z
- **目录日期**: 2025-06-13
