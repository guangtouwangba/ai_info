...
上海AI实验室联合复旦、交大等机构推出SurveyForge框架，可自动生成高质量学术综述，被ACL 2025接收。该系统能在10分钟内生成6.4万字的综述，成本不足0.5美元（约4元人民币）。其核心技术包括两阶段流程：先通过融合arXiv论文和综述大纲数据库生成结构化大纲，再借助"学者导航代理"SANA模块提升文献相关性。采用并行生成+协调机制确保内容一致性，同时通过子查询记忆、检索记忆和时间感知重排序兼顾经典与新兴文献。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T02:33:25Z
- **目录日期**: 2025-06-13
