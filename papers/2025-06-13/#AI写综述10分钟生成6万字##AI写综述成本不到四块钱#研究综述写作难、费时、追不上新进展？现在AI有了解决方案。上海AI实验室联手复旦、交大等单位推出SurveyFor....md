...
上海AI实验室联合复旦、交大等推出SurveyForge框架，可10分钟自动生成6万字高质量学术综述，成本仅0.5美元。该系统采用两阶段流程：先融合60万篇论文数据生成结构化大纲，再通过"学者导航代理"SANA模块提升文献相关性，解决检索遗忘问题。采用并行生成+协调机制，在保证生成速度的同时维持内容一致性。该成果已被ACL 2025接收，显著提升综述写作效率并降低成本。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T01:30:51Z
- **目录日期**: 2025-06-13
