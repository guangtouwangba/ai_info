...
该研究探讨了大型语言模型(LLMs)与人类偏好对齐时忽视的"认知摩擦"问题，即面对新信息时更新信念的内在阻力。作者提出"动态认知摩擦"概念，定义为当前信念状态与外部证据支持的新命题之间的错位。基于动态认知逻辑框架，研究发现这种摩擦在交互过程中表现为非平凡的信念修正。通过协作任务分析，该模型能有效预测对话中的信念更新。研究还讨论了如何完善这一模型，以更好地适应现实对话场景的复杂性，将信念对齐视为认知阻力或摩擦的衡量标准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T14:02:01Z
- **目录日期**: 2025-06-13
