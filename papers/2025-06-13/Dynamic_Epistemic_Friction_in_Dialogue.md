...
该研究探讨了大型语言模型(LLMs)与人类偏好对齐中的"认知摩擦"问题，即当遇到新信息时更新信念的内在阻力。作者将动态认知摩擦定义为对外部证据支持的命题与当前信念状态不匹配而产生的认知整合阻力，并在动态认知逻辑框架下进行建模。研究表明，这种认知摩擦模型能有效预测对话中的信念更新。通过协作任务分析，作者提出将信念对齐作为认知阻力的衡量标准，并指出该模型可进一步优化以适应现实对话场景的复杂性。研究强调了在人类-AI协作中考虑认知摩擦的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T17:01:58Z
- **目录日期**: 2025-06-13
