...
该研究探讨了大型语言模型（LLM）与人类偏好对齐中的"认知摩擦"问题，即智能体在面对新证据时更新信念的阻力。作者提出"动态认知摩擦"概念，定义为当前信念与外部证据支持的新命题之间的错位，并将其置于动态认知逻辑框架下分析。研究表明，这种摩擦模型能有效预测对话中的信念更新，并指出通过量化认知阻力（摩擦）来衡量信念对齐的方法，可进一步优化以适应现实对话场景的复杂性。研究强调了在人类-AI协作中考虑认知摩擦对提升模型实用性的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T12:01:54Z
- **目录日期**: 2025-06-13
