...
该研究探讨了大型语言模型(LLMs)与人类协作中的"认知摩擦"问题，即当新信息与现有信念冲突时产生的整合阻力。作者将动态认知摩擦定义为智能体当前信念状态与外部证据支持的新命题之间的错位，并基于动态认知逻辑框架进行分析。研究表明，这种认知摩擦模型能有效预测对话中的信念更新，且可作为衡量认知阻力的指标。该模型为进一步完善现实对话场景中的信念对齐机制提供了理论基础，有助于提升人机协作中LLMs处理矛盾或模糊信息的能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T20:01:49Z
- **目录日期**: 2025-06-13
