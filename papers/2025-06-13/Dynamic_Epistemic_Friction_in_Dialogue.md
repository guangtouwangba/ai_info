...
该研究探讨了大型语言模型（LLM）与人类协作中的"认知摩擦"问题，即模型在面对冲突或模糊信息时更新信念的内在阻力。作者提出"动态认知摩擦"概念，将其定义为智能体当前信念状态与外部证据支持的新命题之间的错位，并基于动态认知逻辑框架进行分析。通过协作任务实验，该模型能有效预测对话中的信念更新。研究指出，将信念对齐视为认知阻力或摩擦的度量，可进一步完善以适应现实对话场景的复杂性。这一发现对提升人机协作中LLM的适应性具有重要意义。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T11:01:48Z
- **目录日期**: 2025-06-13
