...
研究表明，自主学习能力(SRL)对大学生应对学业挑战至关重要。针对59名学生的调研发现，他们在目标设定、时间管理和反思学习方面存在困难。为此，研究者开发了SRLAgent系统，结合大型语言模型(LLM)和游戏化设计，基于Zimmerman的三阶段SRL框架，帮助学生进行目标设定、策略执行和自我反思。实验显示，使用SRLAgent的学生自主学习能力显著提升(p<0.001，效应量d=0.234)，且参与度高于对照组。该研究证实了在游戏化环境中嵌入AI实时支持的可行性，为培养深度学习能力和元认知技能的教育技术提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T00:01:51Z
- **目录日期**: 2025-06-13
