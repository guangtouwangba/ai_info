...
研究表明，大学生缺乏自我调节学习（SRL）能力会导致学习效率低下。针对59名学生的调研发现，他们在目标设定、时间管理和反思学习方面存在困难。为此，研究者开发了SRLAgent系统，结合游戏化设计和大型语言模型（LLM）的实时反馈，基于Zimmerman三阶段SRL框架（目标设定、策略执行和自我反思）提供支持。实验显示，使用SRLAgent的学生SRL技能显著提升（p<0.001，效应量d=0.234），且参与度高于对照组。该研究证实了游戏化环境结合AI支持对培养元认知能力的有效性，为教育技术设计提供了新思路。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T01:29:33Z
- **目录日期**: 2025-06-13
