...
CVPR2025作为计算机视觉顶级会议，共收到13,008篇投稿，录用2,878篇。为帮助研究者快速获取优质论文，网友整理了一份精选清单，涵盖视觉语言模型、视觉智能体、目标跟踪、开放世界检测等热门领域，同时包含深度估计和3D视觉等方向的成果。清单提供论文链接、代码、演示视频和海报等资源，并开放补充建议。精选论文地址和完整录用清单均已公开，便于研究者一站式查阅前沿研究成果。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T00:02:55Z
- **目录日期**: 2025-06-13
