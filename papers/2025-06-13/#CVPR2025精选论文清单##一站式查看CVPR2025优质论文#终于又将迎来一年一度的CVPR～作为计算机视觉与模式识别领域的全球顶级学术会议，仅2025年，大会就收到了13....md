...
CVPR2025作为计算机视觉顶级会议，共收到13,008篇投稿，录用2,878篇。为帮助研究者高效获取优质论文，网友整理了一份精选清单，涵盖视觉语言模型、视觉智能体、目标跟踪、开放世界检测等热点领域，同时包含深度估计和3D视觉等方向。清单提供论文链接、代码、演示视频和海报等资源，支持用户推荐未收录的优秀论文。精选清单和完整录用论文分别可通过GitHub和CVPR官网查看。该整理为研究者提供了高效的一站式论文检索方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T01:30:43Z
- **目录日期**: 2025-06-13
