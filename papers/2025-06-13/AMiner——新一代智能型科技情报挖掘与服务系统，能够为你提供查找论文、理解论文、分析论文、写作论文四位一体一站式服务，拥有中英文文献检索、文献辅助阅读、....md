...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析和写作一站式服务。平台支持中英文文献搜索，能自动生成摘要并解答用户提问，提升研究效率。其AI功能可翻译、解析PDF论文，提供章节概要和互动问答。用户还能订阅个性化科研动态，追踪机构、学者或关键词的最新成果。此外，AMiner包含学者画像、学术会议等模块，收录超3.5亿论文和1.5亿专利，基础功能免费使用。网址：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T12:04:42Z
- **目录日期**: 2025-06-13
