...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析及写作辅助的一站式服务。它支持中英文文献搜索，能自动生成摘要和问答互动，帮助用户快速理解论文内容。平台还提供文献翻译、文档识别、科研动态订阅等功能，覆盖42个学科的3.5亿论文、0.6亿学者等数据。用户可通过微信或邮件获取定制化科研资讯，并免费使用学者画像、学术会议等工具。访问链接：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T07:07:03Z
- **目录日期**: 2025-06-13
