...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析和写作一站式服务。它支持中英文文献搜索，能自动生成摘要并回答用户提问，帮助快速理解论文内容。平台还提供文献翻译、文档识别和辅助阅读功能，用户可上传PDF或从数据库获取论文。此外，AMiner支持科研情报订阅，根据用户偏好推送最新学术动态。其他功能包括学者画像、学术会议和必读论文专题。平台收录3.5亿论文、0.6亿学者等海量数据，浏览器版可免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T05:06:22Z
- **目录日期**: 2025-06-13
