...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析及写作一站式服务。它收录3.5亿论文、0.6亿学者等海量学术资源，支持中英文文献检索、AI辅助阅读（自动生成摘要/章节概要）、互动问答和文档翻译功能。用户可定制科研情报订阅，通过微信/邮件接收最新研究动态。平台还包含学者画像、学术会议等特色功能，基础服务免费开放。核心优势在于通过AI技术显著提升文献筛选、理解和写作效率，网址：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T01:33:10Z
- **目录日期**: 2025-06-13
