...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、辅助阅读、翻译、论文写作支持等。它收录了3.5亿论文、0.6亿学者和1.5亿专利，覆盖42个学科。用户可通过互动问答快速获取文献摘要，并利用AI工具生成章节概要和问题建议。平台还支持科研情报订阅，根据用户偏好推送最新学术动态。此外，AMiner提供学者画像、学术会议和必读论文专题等功能，基础检索服务免费开放。访问链接：https://www.aminer.cn/。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T15:04:47Z
- **目录日期**: 2025-06-13
