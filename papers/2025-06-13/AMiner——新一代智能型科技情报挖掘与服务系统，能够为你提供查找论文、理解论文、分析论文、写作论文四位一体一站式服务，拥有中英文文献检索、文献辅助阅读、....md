...
AMiner是一款智能科技情报挖掘系统，提供一站式学术服务，包括中英文文献检索（覆盖3.5亿论文）、AI辅助阅读（自动生成摘要/问答）、文档翻译及科研情报订阅（按需推送最新成果）。其特色功能涵盖学者画像、学术会议追踪及必读论文推荐，支持用户上传PDF或直接检索文献库进行交互式分析。平台通过微信/邮件推送个性化研究动态，基础功能免费开放，旨在提升科研效率。访问入口：官网（https://www.aminer.cn）及AI交互页（https://www.aminer.cn/chat/g/explain/）。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T10:05:39Z
- **目录日期**: 2025-06-13
