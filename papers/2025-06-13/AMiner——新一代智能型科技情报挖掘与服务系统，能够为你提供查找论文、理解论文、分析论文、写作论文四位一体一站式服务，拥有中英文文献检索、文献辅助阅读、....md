...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和科研订阅等一站式服务。它收录了3.5亿篇论文、0.6亿学者和1.5亿专利，支持中英文文献搜索，并能自动生成摘要和问答互动。用户可上传PDF文档获取AI辅助阅读，包括章节概要和内容解析。此外，AMiner提供个性化科研动态订阅，通过微信或邮件推送最新学术资讯。平台还包含学者画像、学术会议和论文排行榜等功能，基础服务可免费使用。访问入口：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T20:04:48Z
- **目录日期**: 2025-06-13
