...
以色列魏茨曼科学研究所最新研究发现，人类呼吸模式具有类似指纹的独特性，个体识别准确率达96.8%。研究通过可穿戴设备监测发现，呼吸节奏能反映心理状态：焦虑者吸气短、夜间呼吸变化大；抑郁者呼气停顿长；自闭特质者睡眠时呼吸不规律。研究提出"呼吸影响情绪"的新视角，暗示调整呼吸模式可能改善身心健康。该成果发表于Medical Xpress，显示呼吸特征具有长期稳定性，为健康监测提供了新思路。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T14:02:35Z
- **目录日期**: 2025-06-13
