...
以色列魏茨曼科学研究所最新研究发现，人类呼吸模式具有独特性，如同"呼吸指纹"，个体识别准确率达96.8%。研究通过可穿戴设备监测100名志愿者日常活动时的呼吸数据，发现呼吸模式能稳定保持一年以上。研究还揭示呼吸特征与心理状态的关联：焦虑者吸气时间短、夜间呼吸变化大；抑郁倾向者呼气停顿长；自闭特质者睡眠时呼吸不规律。研究者提出"呼吸影响情绪"的新观点，认为调整呼吸模式可能改善身心健康。该研究为通过呼吸监测心理健康提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T18:02:39Z
- **目录日期**: 2025-06-13
