...
以色列魏茨曼科学研究所最新研究发现，人类具有独特的"呼吸指纹"，个体识别准确率高达96.8%。研究人员通过可穿戴设备监测100名志愿者日常活动时的呼吸模式，发现呼吸特征不仅能长期稳定识别个体（类似指纹），还与心理状态相关：焦虑者吸气短、夜间呼吸变化大；抑郁倾向者呼气停顿长；自闭特质者睡眠时呼吸不规律。研究提出"呼吸影响情绪"的新观点，暗示调整呼吸模式可能改善身心健康。该成果为健康监测和心理评估提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T12:02:25Z
- **目录日期**: 2025-06-13
