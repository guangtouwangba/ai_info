...
随着视频生成技术的快速发展，AI生成视频的检测需求日益迫切。本文提出GenWorld数据集，具有三大特点：(1) 真实场景模拟，聚焦高影响力现实场景视频；(2) 高质量伪造，采用多款先进视频生成模型；(3) 跨提示多样性，包含多种生成方式和提示模态。研究发现现有方法难以检测世界模型(如Cosmos)生成的高质量视频。为此，作者提出SpannDetector模型，利用多视角一致性作为检测标准，实验显示其效果显著。该研究为基于物理合理性的可解释AI视频检测提供了新方向。项目页面：https://chen-wl20.github.io/GenWorld

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T11:00:54Z
- **目录日期**: 2025-06-13
