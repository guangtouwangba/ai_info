...
视频生成技术的快速发展威胁了真实信息的可信度，加剧了对AI生成视频检测器的需求。然而，高质量真实世界数据集的缺乏阻碍了可靠检测器的发展。为此，研究者提出了GenWorld——一个大规模、高质量、模拟真实场景的AI生成视频检测数据集，其特点包括：真实场景模拟、多先进模型生成的高质量伪造视频，以及跨提示多样性。研究发现现有方法难以检测世界模型（如Cosmos）生成的高质量视频，因此提出了基于多视角一致性的SpannDetector模型，实验显示其效果显著。该数据集有望推动AI生成视频检测领域的发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T02:31:02Z
- **目录日期**: 2025-06-13
