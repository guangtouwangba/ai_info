...
随着AI视频生成技术的快速发展，其带来的信息可信度问题日益凸显，亟需有效的AI生成视频检测方法。本文提出GenWorld数据集，具有三大特点：(1)真实场景模拟，聚焦高影响力现实场景视频；(2)采用多款先进生成模型，确保高质量伪造视频；(3)涵盖多生成器和多提示模态，增强特征泛化性。研究发现现有方法难以检测世界模型(如Cosmos)生成的视频，因此提出SpannDetector模型，利用多视角一致性作为检测标准。实验表明该方法效果显著，为基于物理合理性的可解释检测提供了新方向。GenWorld有望推动AI生成视频检测领域发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T12:00:58Z
- **目录日期**: 2025-06-13
