...
随着AI生成视频技术的发展，真实信息的可信度面临威胁，对检测技术的需求日益迫切。现有方法因缺乏高质量真实场景数据集而受限。为此，研究者提出GenWorld数据集，具有三大特点：(1) 模拟真实场景的高影响力视频；(2) 采用多款先进生成模型制作高质量伪造视频；(3) 包含多生成器和多模态提示的跨样本多样性。分析发现现有方法难以检测世界模型生成的视频，因此提出SpannDetector模型，利用多视角一致性作为检测标准。实验表明该方法效果显著，为基于物理合理性的可解释检测提供了新方向。项目页见文末链接。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T08:00:56Z
- **目录日期**: 2025-06-13
