...
随着AI视频生成技术的快速发展，其真实性威胁到现实世界信息的可信度，推动了对AI生成视频检测器的需求。然而，高质量真实世界数据集的缺乏阻碍了可靠检测器的发展。为此，研究团队提出GenWorld数据集，具有三大特点：(1)真实场景模拟；(2)采用先进模型生成高质量伪造视频；(3)涵盖多生成器和多提示模态的跨提示多样性。研究发现现有方法难以检测世界模型生成的视频，因此提出SpannDetector模型，利用多视角一致性作为检测标准。实验表明该方法效果显著，为基于物理合理性的可解释AI视频检测提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T03:22:41Z
- **目录日期**: 2025-06-13
