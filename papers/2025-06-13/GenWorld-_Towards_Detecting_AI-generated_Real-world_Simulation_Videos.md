...
本文提出GenWorld，一个用于AI生成视频检测的大规模高质量真实世界模拟数据集。GenWorld具有三大特点：(1)真实场景模拟，聚焦具有现实影响力的视频；(2)采用多种先进视频生成模型，确保伪造视频的高质量；(3)跨提示多样性，包含多种生成器和提示模态。研究发现现有方法难以检测世界模型生成的高质量视频，因此提出SpannDetector模型，利用多视角一致性作为检测标准。实验表明该方法效果显著，为基于物理合理性的可解释AI视频检测提供了新方向。GenWorld将推动AI生成视频检测领域发展。项目页面见文末链接。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-13T10:00:53Z
- **目录日期**: 2025-06-13
