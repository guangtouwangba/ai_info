...
计算创造力领域正在探索如何平衡人类与AI在协同创作中的控制权。协同创作是一种混合智能形式，人类和AI共同主动参与创造过程。研究团队通过系统文献综述提出了MOSAAIC框架，从自主性、主动性和权威性三个维度来分析和优化控制权分配。该框架可应用于评估现有协同创作系统，并为设计更平衡的人机协作关系提供指导。研究分析了6个案例，展示了该框架在优化人机协同创作控制权分配方面的实用价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T21:01:03Z
- **目录日期**: 2025-05-19
