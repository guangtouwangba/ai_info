...
计算创造力领域的关键挑战是如何平衡人类与AI在协同创作中的控制权。协同创作是一种混合智能形式，人类和AI共同主动参与创造过程。研究团队通过系统文献综述172篇论文，提出了MOSAAIC框架，从自主性、主动性和权威性三个维度来分析和优化控制权分配。该框架还提供了控制优化策略，并通过6个案例研究验证了其适用性，为设计更平衡的人机协同创作系统提供了理论指导。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T19:01:12Z
- **目录日期**: 2025-05-19
