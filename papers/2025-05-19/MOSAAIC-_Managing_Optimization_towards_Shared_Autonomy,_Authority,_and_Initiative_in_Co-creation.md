...
这篇论文探讨了人类与AI在协同创作中如何平衡控制权的问题，提出了MOSAAIC框架来管理协同创作中的自主性、主动性和权威性三个关键维度。基于对172篇文献的系统回顾，研究者将控制权定义为决定、发起和指导协同创作过程的能力。该框架提供了优化控制权分配的策略，并通过分析6个案例研究验证了其适用性。MOSAAIC旨在帮助实现人机协同创作的最佳平衡，促进共享创意成果的产生。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T09:01:13Z
- **目录日期**: 2025-05-19
