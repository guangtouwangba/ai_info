...
传统多智能体强化学习（MARL）方法依赖全局状态可观测性，限制了算法的去中心化和可扩展性。近期研究表明，在智能体间影响衰减的假设下，局部邻域观测可替代全局观测。本文聚焦无线通信和雷达网络中的信号衰减特性，以雷达网络目标检测的功率分配问题为例，证明信号衰减可实现MARL去中心化。研究提出两种约束多智能体马尔可夫决策过程模型，推导全局价值函数和梯度估计的局部邻域近似及误差界，并开发去中心化鞍点策略梯度算法。该方法为无线通信和雷达网络的扩展应用提供了模型参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T11:01:50Z
- **目录日期**: 2025-05-19
