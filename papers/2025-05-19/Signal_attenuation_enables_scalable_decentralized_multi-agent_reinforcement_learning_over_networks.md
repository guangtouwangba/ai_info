...
传统多智能体强化学习(MARL)需要全局状态可观测性，限制了算法的去中心化和可扩展性。研究表明，在智能体间影响力衰减的假设下，可用局部邻域观测替代全局观测。本文聚焦无线通信和雷达网络中普遍存在的信号衰减特性，以雷达网络目标检测的功率分配问题为例，提出了两种新的约束多智能体马尔可夫决策过程模型，推导了全局价值函数和梯度估计的局部邻域近似方法并建立误差界，开发了去中心化鞍点策略梯度算法。该方法为无线通信和雷达网络中的其他问题提供了可扩展的解决方案框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T06:01:47Z
- **目录日期**: 2025-05-19
