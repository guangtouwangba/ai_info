...
传统多智能体强化学习（MARL）依赖全局状态可观测性，限制了算法的去中心化和可扩展性。近期研究表明，在智能体间影响衰减的假设下，局部邻域观测可替代全局观测。本文聚焦无线通信和雷达网络中普遍存在的信号衰减特性，以雷达网络功率分配问题为例，证明信号衰减可实现MARL去中心化。作者提出两种约束型多智能体马尔可夫决策模型，推导全局价值函数与梯度的局部邻域近似及误差界，并开发去中心化鞍点策略梯度算法。该方法为无线通信和雷达网络的其他问题提供了可扩展的解决框架。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T13:11:20Z
- **目录日期**: 2025-05-19
