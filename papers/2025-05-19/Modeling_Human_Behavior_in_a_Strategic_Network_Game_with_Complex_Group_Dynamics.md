...
该研究比较了多种从小数据集中学习人类在策略性网络游戏（Junior High Game）中行为模型的方法。最佳方法是hCAB，它通过建模行为分布而非均值，并假设人类具有社区意识而非简单行为匹配。在小型社会（6-11人）中，hCAB模型能准确反映群体动态。用户研究还表明，人类参与者无法区分hCAB智能体和真人，说明该模型能生成可信的个体行为。这些发现有助于理解人类网络对社会不平等等重大问题的影响，为促进有利社会结果提供了新见解。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T01:30:41Z
- **目录日期**: 2025-05-19
