...
DeepMind的通用科学AI系统AlphaEvolve在数学领域取得突破，将4×4复数矩阵乘法的运算量从49次减少到48次，打破了56年来由Strassen算法保持的记录。该系统通过完全自主探索，摆脱了人类算法的对称性限制，在复数领域发现更优解法，并意外适用于实数领域。其核心技术包括异步分布式架构、并行演化和自动化评估，实现了不依赖人类经验的算法创新。虽然更大规模矩阵（5×5、6×6）尚未超越人类最优解，但研究团队认为其性能与底层模型能力正相关，未来潜力显著。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T00:03:41Z
- **目录日期**: 2025-05-19
