...
DeepMind的通用科学AI系统AlphaEvolve取得数学突破，将4×4复数矩阵乘法的运算次数从49次降至48次，打破了1969年Strassen算法保持56年的记录。该系统通过完全自主探索（无人工预设）、分布式并行演化和自动化评估，在复数领域发现更优解法，并意外适用于实数领域。这是AI首次在纯数学基础研究中超越人类最优解，类似AlphaGo的"神之一手"。团队表示其潜力与底层模型能力正相关，未来或挑战更大规模矩阵运算。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T01:31:53Z
- **目录日期**: 2025-05-19
