...
北大校友、前OpenAI华人副总裁翁荔发表万字长文《Why We Think》，探讨如何通过"测试时计算"和"思维链"(CoT)技术提升AI模型性能。文章指出，让模型在输出答案前进行更多思考（如智能解码、思维链推理等方法），能显著突破当前能力瓶颈。该观点引发广泛关注，被认为开辟了AI理解的新维度。文章通过详实分析展示了这些技术对提升模型智能水平的重要作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T04:08:05Z
- **目录日期**: 2025-05-19
