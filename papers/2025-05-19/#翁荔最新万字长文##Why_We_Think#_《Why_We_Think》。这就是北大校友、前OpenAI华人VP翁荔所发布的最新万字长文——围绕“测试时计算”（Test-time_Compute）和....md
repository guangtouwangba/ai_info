...
北大校友、前OpenAI华人副总裁翁荔发表万字长文《Why We Think》，探讨了"测试时计算"和"思维链"(CoT)技术如何显著提升AI模型性能。文章指出，通过让模型在输出答案前进行更长时间的思考(如智能解码、思维链推理等方法)，可以突破当前能力瓶颈，提升智能水平。该研究被认为开辟了理解人工智能的新维度，引发广泛关注和"精彩"评价。文章深入分析了这些技术对AI发展的潜在影响。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T02:34:04Z
- **目录日期**: 2025-05-19
