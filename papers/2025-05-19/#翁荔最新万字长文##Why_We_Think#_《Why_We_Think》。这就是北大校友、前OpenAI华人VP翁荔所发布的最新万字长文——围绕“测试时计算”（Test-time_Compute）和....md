# #翁荔最新万字长文##Why We Think# 《Why We Think》。这就是北大校友、前OpenAI华人VP翁荔所发布的最新万字长文——围绕“测试时计算”（Test-time Compute）和...
...
北大校友、前OpenAI华人副总裁翁荔发表万字长文《Why We Think》，探讨了"测试时计算"（Test-time Compute）和"思维链"（Chain-of-Thought, CoT）技术如何显著提升AI模型性能。文章指出，通过让模型在输出答案前进行更多思考（如智能解码、思维链推理等方法），可以突破当前的能力瓶颈，提高智能水平。该观点引发广泛讨论，被认为打开了理解人工智能的新维度。文章详细分析了这些技术对模型性能的优化作用，展示了AI领域的前沿思考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T03:25:35Z
- **目录日期**: 2025-05-19
