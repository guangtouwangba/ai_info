...
这篇论文针对代码生成大语言模型(codeLLMs)提出创新评估框架，发现现有基准过度关注代码正确性而忽视人类偏好。研究者构建了包含397个样本的CodeArena基准(覆盖40类任务和44种语言)和20B标记的SynCode-Instruct数据集。实验显示执行基准与人类偏好存在显著差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距明显。研究强调了代码生成模型与人类偏好对齐的重要性，为改进代码LLMs提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T16:06:07Z
- **目录日期**: 2025-05-19
