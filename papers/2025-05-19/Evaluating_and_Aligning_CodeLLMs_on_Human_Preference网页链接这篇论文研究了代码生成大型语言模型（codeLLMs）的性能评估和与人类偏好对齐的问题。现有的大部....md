...
这篇论文提出了CodeArena基准测试和SynCode-Instruct语料库，以评估代码生成大模型(CodeLLMs)与人类偏好的对齐程度。研究发现现有基准过于关注代码正确性而忽视人类偏好，CodeArena通过397个涵盖40类编程任务的真实样本填补这一空白。实验显示执行基准与人类偏好评估存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究还验证了大规模合成指令微调的有效性，强调了人类偏好对齐在代码生成中的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T07:06:06Z
- **目录日期**: 2025-05-19
