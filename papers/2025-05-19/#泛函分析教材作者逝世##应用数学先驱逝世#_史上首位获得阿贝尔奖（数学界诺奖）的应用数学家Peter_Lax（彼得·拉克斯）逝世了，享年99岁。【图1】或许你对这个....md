...
著名应用数学家、《泛函分析》教材作者Peter Lax（彼得·拉克斯）于纽约逝世，享年99岁。他是首位获得数学界最高荣誉阿贝尔奖的应用数学家，被誉为"弥合纯粹与应用数学鸿沟"的巨匠。其编写的《微积分及其应用》《线性代数及其应用》等教材以通俗易懂著称。作为计算机数学分析先驱，他重新定义了数学在计算机时代的角色。阿贝尔奖官方曾高度评价其将理论研究与实际应用结合的突出贡献。拉克斯因心脏淀粉样变性离世，其学术遗产持续影响科学与工程领域。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T00:03:23Z
- **目录日期**: 2025-05-19
