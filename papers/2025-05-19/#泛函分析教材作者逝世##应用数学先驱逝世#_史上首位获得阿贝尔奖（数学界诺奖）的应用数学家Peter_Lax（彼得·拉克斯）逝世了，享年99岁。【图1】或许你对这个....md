# #泛函分析教材作者逝世##应用数学先驱逝世# 史上首位获得阿贝尔奖（数学界诺奖）的应用数学家Peter Lax（彼得·拉克斯）逝世了，享年99岁。【图1】或许你对这个...
...
著名应用数学家、《泛函分析》教材作者Peter Lax（彼得·拉克斯）于99岁高龄逝世。他是首位获得数学界最高荣誉阿贝尔奖的应用数学家，其著作《泛函分析》《微积分及其应用》等教材广受推崇。拉克斯在理论数学与应用数学交叉领域贡献卓著，开创了计算机辅助数学分析的先河。阿贝尔奖评价他"弥合了纯数学与应用数学的鸿沟"，其理论至今仍深刻影响科学与工程领域。2023年5月刚度过99岁生日的拉克斯，因心脏淀粉样变性在纽约家中离世，《纽约时报》称其"重新定义了计算机时代的数学角色"。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T02:34:17Z
- **目录日期**: 2025-05-19
