...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、辅助阅读、自动摘要生成、AI翻译及科研情报订阅。平台收录3.5亿论文、0.6亿学者数据，支持用户通过关键词、学者或机构追踪最新研究动态，并通过微信/邮件推送个性化摘要。其特色功能包含互动问答解析论文、文档智能解析（上传PDF可生成章节概要），以及学者画像、学术会议等分析工具。基础功能免费使用，网址：https://www.aminer.cn 。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T15:05:55Z
- **目录日期**: 2025-05-19
