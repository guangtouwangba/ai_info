...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、翻译、辅助阅读和科研情报订阅。它拥有庞大的学术资源库，涵盖3.5亿论文、0.6亿学者和1.5亿专利。用户可通过互动问答快速理解文献，AI还能自动生成摘要和章节概要，提升研究效率。平台支持个性化订阅，推送最新科研动态。此外，AMiner提供学者画像、学术会议和论文排行榜等功能，基础服务免费使用。访问入口：https://www.aminer.cn/。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T20:06:12Z
- **目录日期**: 2025-05-19
