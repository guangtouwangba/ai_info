...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、辅助阅读和科研订阅等一站式服务。其核心功能包括：1）精准定位学术文献，支持互动问答和自动摘要生成；2）AI驱动的文献翻译与解析，可上传PDF或从库中选取论文，快速生成摘要和章节概要；3）个性化科研情报订阅，按用户偏好推送最新学术动态。平台覆盖42个学科，包含3.5亿论文、0.6亿学者等数据，并提供学者画像、学术会议等扩展功能。基础服务免费，支持网页端使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T03:27:31Z
- **目录日期**: 2025-05-19
