...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析和写作一站式服务。它拥有42个学科的3.5亿论文资源，支持中英文文献检索、AI辅助阅读和自动摘要生成。用户可通过互动问答快速理解文献内容，并上传PDF文档获取智能解析。平台还提供科研动态订阅服务，根据用户偏好推送最新学术资讯。此外，AMiner包含学者画像、学术会议和论文排行榜等功能，基础服务免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T21:06:06Z
- **目录日期**: 2025-05-19
