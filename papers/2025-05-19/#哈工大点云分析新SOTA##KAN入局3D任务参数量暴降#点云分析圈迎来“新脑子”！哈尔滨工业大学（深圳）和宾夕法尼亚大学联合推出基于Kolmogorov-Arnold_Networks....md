...
哈尔滨工业大学（深圳）与宾夕法尼亚大学联合提出基于KANs的新型点云分析模型PointKAN，通过可学习函数替代传统MLP的固定激活函数，显著提升3D几何特征学习能力。其核心模块包括几何仿射、局部特征并行处理及全局残差提取，升级版PointKAN-elite进一步采用有理函数和参数共享，实现参数量暴降。实验显示，该模型在分类、分割等任务中全面超越MLP方案，成为新的SOTA。相关成果以“参数量暴降，精度反升”为亮点，推动点云分析领域进步。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T17:03:18Z
- **目录日期**: 2025-05-19
