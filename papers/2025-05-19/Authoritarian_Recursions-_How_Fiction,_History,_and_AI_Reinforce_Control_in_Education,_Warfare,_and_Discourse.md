...
这篇论文提出"威权递归"概念，揭示AI系统如何在教育、军事和数字话语中通过算法中介实施控制。研究表明，AI平台将判断权委托给算法流程，以中立和优化为名，使不透明操作常态化并递归强化行为规范。通过课堂监控、军事目标识别和内容审核等案例，作者指出这些领域在抽象化、监控和分类的递归架构中趋同。这种递归系统不仅自动化任务，更编码认知权威模式，分散责任的同时加剧政治不对称。论文认为威权递归融合了技术抽象与国家市场需求，对民主监督和AI治理框架设计提出挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T19:02:07Z
- **目录日期**: 2025-05-19
