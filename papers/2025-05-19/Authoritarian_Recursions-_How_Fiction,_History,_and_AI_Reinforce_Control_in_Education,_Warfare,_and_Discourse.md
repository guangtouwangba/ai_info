...
这篇论文提出“威权递归”概念，揭示AI系统如何在教育、军事和数字话语中通过算法中介实施控制。研究结合批判话语分析和社会技术理论，指出AI平台将判断权交给算法流程，以中立优化之名掩盖其强化行为规范的本质。案例包括课堂监控的生成式AI、军事AI的自主瞄准系统及平台内容管理逻辑。研究表明这些领域通过抽象化、监控和分类的递归架构实现结构性融合，不仅自动化任务，更编码认知权威模式，加剧政治不对称。文章主张威权递归是技术抽象与政经需求的混合逻辑，呼吁关注算法问责与民主监督。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T03:23:51Z
- **目录日期**: 2025-05-19
