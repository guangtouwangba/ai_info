...
本文提出"威权递归"概念，揭示AI系统如何通过算法中介在教育、军事和数字话语中实施控制。研究指出，AI平台将判断权交给算法流程，以中立优化之名强化行为规范，同时掩盖其不透明性。案例包括课堂监控的生成式AI、军事AI的自主瞄准系统及平台内容管理逻辑。研究表明这些领域通过抽象化、监控和分类的递归架构实现结构性融合，不仅自动化任务，更编码认知权威模式，分散责任并加剧政治不对称。文章认为威权递归融合了技术抽象与政府市场需求，对民主监督和AI治理框架设计提出挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T07:02:18Z
- **目录日期**: 2025-05-19
