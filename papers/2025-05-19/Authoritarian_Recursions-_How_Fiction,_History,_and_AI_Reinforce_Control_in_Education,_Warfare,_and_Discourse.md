...
这篇论文提出"威权递归"概念，揭示AI系统如何通过算法中介在教育、军事和数字话语领域实施控制。研究表明，AI平台将判断权委托给算法流程，以中立和优化为名，使不透明操作常态化并递归强化行为规范。通过课堂监控、军事目标识别和内容审核等案例，作者指出这些领域在抽象化、监控和分类的递归架构中趋于同构。这种递归不仅是技术功能，更成为融合国家与市场需求的社会控制工具，加剧政治不对称性，削弱民主合法性和人类监督。研究为算法问责制讨论提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T09:02:23Z
- **目录日期**: 2025-05-19
