...
这篇论文提出"威权递归"概念，揭示AI系统如何在教育、军事和数字话语中通过算法中介控制。研究表明，AI平台将判断权交给算法流程，以中立优化之名掩盖不透明操作，递归强化行为规范。案例包括课堂监控的生成式AI、军事AI的自主瞄准、平台内容审核机制。研究指出这些领域通过抽象化、监控和分类的递归架构形成结构性融合，不仅自动化任务，更编码认知权威模式，分散责任同时加剧政治不对称。作者认为威权递归是技术抽象与政经需求的混合逻辑，呼吁关注其对民主合法性和AI治理的影响。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T05:02:17Z
- **目录日期**: 2025-05-19
