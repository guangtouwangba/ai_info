...
这篇论文提出“威权递归”概念，揭示人工智能系统如何通过算法中介在教育、军事和数字话语中实施控制。研究结合批判话语分析和社会技术理论，指出AI平台以中立优化为名，将判断权委派给算法流程，使不透明操作常态化，并递归强化行为规范。案例分析涵盖课堂监控的生成式AI、军事AI的自主瞄准系统及平台内容治理逻辑。研究表明这些领域通过抽象化、监控和分类的递归架构实现结构性融合，不仅自动化任务，更编码认知权威模式，分散责任并加剧政治不对称。研究呼吁关注AI治理框架对民主合法性和人类监督的影响。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T16:02:16Z
- **目录日期**: 2025-05-19
