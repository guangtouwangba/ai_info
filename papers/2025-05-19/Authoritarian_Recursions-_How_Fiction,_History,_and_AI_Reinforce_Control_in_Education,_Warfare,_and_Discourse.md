...
这篇论文提出"威权递归"概念，揭示AI系统如何通过算法中介在教育、军事和数字话语领域实施控制。研究指出，AI平台将判断权委托给算法流程，在"中立优化"表象下强化行为规范，同时掩盖系统不透明性。通过课堂监控、军事目标识别和内容审核等案例，作者论证这些领域在抽象化、监控和分类的递归架构中趋于同构。这种递归系统不仅自动化任务，更编码认知权威模式，分散责任的同时加剧政治不对称。文章认为威权递归融合了技术抽象与国家市场需求，对民主监督和AI治理框架设计提出警示。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T02:32:52Z
- **目录日期**: 2025-05-19
