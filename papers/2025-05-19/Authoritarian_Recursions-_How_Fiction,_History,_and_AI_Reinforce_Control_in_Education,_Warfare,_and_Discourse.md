...
这篇论文提出"威权递归"概念，揭示AI系统如何在教育、军事和数字话语中通过算法中介控制。研究表明，AI平台将判断权交给算法流程，以中立优化之名使不透明操作常态化，并递归强化行为规范。案例包括课堂监控的生成式AI、军事AI的自主瞄准系统及平台内容管理逻辑。研究指出这些领域通过抽象化、监控和分类的递归架构实现结构性融合，不仅自动化任务，更编码认知权威模式，分散责任同时加剧政治不对称。论文强调递归不仅是技术功能，更是社会政治控制工具，对民主监督和AI治理提出警示。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T22:02:15Z
- **目录日期**: 2025-05-19
