...
研究人员开发了自动化迭代放疗规划系统(AIRTP)，通过AI技术提升放疗计划的精度和效率。该系统整合了器官轮廓勾画、辅助结构创建、束流设置等关键步骤，能生成高质量治疗计划，质量媲美人工耗时数小时制作的方案。研究团队还提出创新方法，可将3D剂量预测转化为可执行的机器限制方案。为促进AI放疗研究，团队开源了包含头颈癌和肺癌的9组数据集，规模达现有最大公共数据集的10倍以上，将支持2025年美国医学物理学家协会挑战赛。项目代码已发布于GitHub平台。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T07:02:42Z
- **目录日期**: 2025-05-19
