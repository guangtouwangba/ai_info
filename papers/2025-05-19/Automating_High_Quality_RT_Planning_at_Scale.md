...
研究人员开发了自动化迭代放疗规划系统（AIRTP），利用AI技术提升放疗计划的精度和效率。该系统通过自动化关键步骤（如器官勾画、射束设置和优化）生成高质量治疗计划，质量与人工方案相当但耗时更少。研究团队还提出了一种将3D剂量预测转化为可执行治疗方案的新方法。为促进AI放疗研究，团队公开了包含头颈癌和肺癌的9组数据集，规模是现有最大公共数据集的10倍以上，将支持2025年AAPM挑战赛。相关代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T21:02:45Z
- **目录日期**: 2025-05-19
