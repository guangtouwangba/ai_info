...
本文介绍了自动化迭代放疗计划系统(AIRTP)，该系统利用人工智能技术提升放疗计划的精确性和效率。AIRTP通过自动化关键步骤(如器官轮廓勾画、射束设置和优化)生成高质量治疗计划，其质量与人工计划相当但大幅节省时间。研究团队还提出了一种将3D剂量预测转化为可执行治疗计划的新方法。为促进公共研究，团队发布了包含头颈癌和肺癌的9个队列数据集，规模是现有最大公开数据集的10倍以上，将支持2025年AAPM挑战赛。相关代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T13:12:03Z
- **目录日期**: 2025-05-19
