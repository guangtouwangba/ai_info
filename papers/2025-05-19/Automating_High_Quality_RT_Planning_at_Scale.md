...
研究人员开发了自动化迭代放疗规划系统(AIRTP)，通过AI技术解决放疗规划复杂耗时的问题。该系统整合了器官轮廓勾画、辅助结构创建、束流设置等关键步骤，能自动生成高质量治疗计划。研究表明，AIRTP生成的计划质量与人工方案相当，但大幅提高了效率。团队公开了首个数据集，包含头颈癌和肺癌的9个队列计划，规模是现有最大公开数据集的10倍以上，旨在支持2025年AAPM挑战赛。该系统有望推动AI在放疗规划中的应用发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T02:33:15Z
- **目录日期**: 2025-05-19
