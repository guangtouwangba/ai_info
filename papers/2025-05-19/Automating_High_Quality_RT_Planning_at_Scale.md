...
研究人员开发了自动化迭代放疗规划系统(AIRTP)，利用人工智能提升放疗计划的精度和效率。该系统通过自动化关键步骤(如器官轮廓勾画、射束设置和优化)，能快速生成高质量治疗计划，质量与人工方案相当但耗时更少。团队还提出新方法将3D剂量预测转化为可执行计划。为促进研究，他们公开了包含头颈癌和肺癌的9组数据集，规模达现有最大公共数据集的10倍以上，将支持2025年AAPM挑战赛。该系统解决了AI放疗发展中数据不足的关键瓶颈。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T22:02:36Z
- **目录日期**: 2025-05-19
