...
本文介绍了msf-CNN，一种针对微控制器(MCU)优化的新型卷积神经网络融合技术。该方法通过将融合解空间表示为有向无环图，能更高效地寻找最优融合方案，相比现有方法(如MCUNetV2和StreamNet)可识别更多解决方案。实验表明，msf-CNN在ARM Cortex-M、RISC-V和ESP32等MCU上运行时，能减少50%的RAM使用量，同时保持实时推理的低延迟。这项技术为系统设计者提供了更大的灵活性，使AI模型能在内存受限(如128kB RAM)的微型设备上高效运行。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T19:01:02Z
- **目录日期**: 2025-05-19
