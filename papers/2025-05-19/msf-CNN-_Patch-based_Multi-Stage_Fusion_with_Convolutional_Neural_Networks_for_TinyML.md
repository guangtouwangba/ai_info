...
本文介绍了msf-CNN，一种针对微控制器(MCU)优化的卷积神经网络融合技术。该方法通过将融合解空间建模为有向无环图，高效寻找最优融合方案，相比现有方案(如MCUNetV2和StreamNet)可减少50%的RAM占用。msf-CNN支持多种MCU架构(ARM Cortex-M/RISC-V/ESP32)，在保持实时性的同时显著提升内存效率，为系统设计提供了更大灵活性。该技术通过优化跨层数据流，解决了MCU内存受限(如128kB RAM)场景下的AI模型部署难题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T03:22:40Z
- **目录日期**: 2025-05-19
