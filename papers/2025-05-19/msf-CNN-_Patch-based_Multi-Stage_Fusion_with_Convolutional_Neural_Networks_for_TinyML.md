...
本文介绍了msf-CNN，一种针对微控制器(MCU)优化的新型卷积神经网络融合技术。该方法通过将融合解空间表示为有向无环图，有效寻找最优融合方案，相比现有方案(如MCUNetV2和StreamNet)能发现更多可行解。实验表明，msf-CNN在ARM Cortex-M、RISC-V和ESP32等MCU上运行时，可减少50%的RAM使用量，同时保持低延迟以满足实时性要求。该技术为系统设计者提供了更大的灵活性，帮助在MCU有限的内存资源(如128kB RAM)下部署AI模型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T22:01:02Z
- **目录日期**: 2025-05-19
