...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能够模拟1万多个AI代理的社会互动（500万次交互）。研究者利用该平台研究了四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，验证了系统对人类行为和社会机制的捕捉能力。该系统可作为计算社会科学实验平台，为研究社会问题模式、成因及政策影响提供新工具，对社会科学研究和政策制定具有重要价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T19:04:52Z
- **目录日期**: 2025-05-19
