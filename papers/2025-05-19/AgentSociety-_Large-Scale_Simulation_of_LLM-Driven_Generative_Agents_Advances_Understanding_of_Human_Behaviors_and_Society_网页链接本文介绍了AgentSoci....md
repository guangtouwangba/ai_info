...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统通过模拟1万多个AI代理及其500万次互动，研究了极化现象、信息传播、基本收入政策等社会问题。模拟结果与现实数据高度吻合，验证了该系统在捕捉人类行为机制方面的有效性。研究表明，AgentSociety可作为计算社会科学研究的创新工具，为政策制定提供新方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-19T13:15:01Z
- **目录日期**: 2025-05-19
