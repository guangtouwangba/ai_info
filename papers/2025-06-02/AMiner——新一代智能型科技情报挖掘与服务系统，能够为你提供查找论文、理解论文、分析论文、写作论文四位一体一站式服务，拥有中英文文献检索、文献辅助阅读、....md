...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、翻译、辅助阅读和学术分析。它拥有3.5亿论文、0.6亿学者等海量数据，支持AI生成摘要、互动问答和文档解析。用户可订阅个性化科研动态，追踪学者或领域进展。平台还提供学者画像、学术会议推荐等功能，基础服务免费开放。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T01:33:18Z
- **目录日期**: 2025-06-02
