...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、辅助阅读、翻译、学术分析等。平台收录3.5亿论文、0.6亿学者等海量数据，支持AI生成摘要、智能问答和文献翻译功能。用户可定制科研情报订阅，跟踪最新学术动态。此外，AMiner还提供学者画像、学术会议和论文专题等功能，浏览器版免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T00:05:26Z
- **目录日期**: 2025-06-02
