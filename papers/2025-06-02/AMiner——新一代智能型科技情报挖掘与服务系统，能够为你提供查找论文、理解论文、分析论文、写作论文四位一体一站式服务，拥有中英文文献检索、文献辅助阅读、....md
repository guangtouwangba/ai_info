...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、辅助阅读、翻译和科研情报订阅。它拥有庞大的数据库，涵盖3.5亿论文、0.6亿学者和1.5亿专利。用户可通过互动问答快速获取文献内容，AI还能自动生成摘要和章节概要，提升研究效率。平台支持个性化订阅，定期推送最新科研动态。此外，AMiner提供学者画像、学术会议和必读论文专题等功能，浏览器版本可免费使用。访问官网或AI页面即可体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T04:12:02Z
- **目录日期**: 2025-06-02
