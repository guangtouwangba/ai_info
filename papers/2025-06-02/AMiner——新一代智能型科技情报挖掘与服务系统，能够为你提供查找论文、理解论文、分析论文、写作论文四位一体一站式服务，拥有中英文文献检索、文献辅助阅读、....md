...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、翻译、辅助阅读和科研动态订阅。它拥有3.5亿论文、0.6亿学者等海量数据，支持AI生成摘要、智能问答和文献分析。用户可通过关键词、学者或机构订阅最新研究，并通过微信或邮件接收推送。平台还提供学者画像、学术会议和论文排行榜等功能，基础服务免费开放。访问入口：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T17:08:09Z
- **目录日期**: 2025-06-02
