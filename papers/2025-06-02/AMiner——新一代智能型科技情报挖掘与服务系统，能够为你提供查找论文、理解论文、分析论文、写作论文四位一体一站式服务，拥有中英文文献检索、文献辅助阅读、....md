...
AMiner是一个智能科技情报挖掘系统，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献检索，拥有3.5亿论文、0.6亿学者等海量数据，并能通过AI生成摘要和问答互动辅助理解。平台还提供文献翻译、科研动态订阅（按用户偏好推送最新成果）、学者画像等功能。用户可免费使用其浏览器检索，并通过网页或微信小程序获取服务。核心优势在于高效筛选文献、智能摘要生成和个性化科研情报推送，显著提升学术研究效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T08:06:25Z
- **目录日期**: 2025-06-02
