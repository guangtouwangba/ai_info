...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、AI辅助阅读、自动摘要生成、翻译及科研情报订阅。其数据库涵盖42个学科3.5亿论文、0.6亿学者等资源，支持用户通过提问交互快速理解文献，并能定制推送最新研究动态。平台还提供学者画像、学术会议追踪等功能，基础服务免费开放使用。核心优势在于通过AI技术显著提升文献检索、阅读和论文写作效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T21:05:30Z
- **目录日期**: 2025-06-02
