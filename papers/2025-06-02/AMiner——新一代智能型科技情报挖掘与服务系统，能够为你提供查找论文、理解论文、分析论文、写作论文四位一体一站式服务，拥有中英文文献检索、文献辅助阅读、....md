...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、AI辅助阅读、翻译和科研情报订阅。它拥有3.5亿论文、0.6亿学者等海量数据，支持互动问答、自动摘要生成和文献分析。用户可定制订阅最新科研动态，还能使用学者画像、学术会议推荐等功能。平台通过网页或微信小程序免费开放，帮助研究者高效获取和管理学术信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T03:29:36Z
- **目录日期**: 2025-06-02
