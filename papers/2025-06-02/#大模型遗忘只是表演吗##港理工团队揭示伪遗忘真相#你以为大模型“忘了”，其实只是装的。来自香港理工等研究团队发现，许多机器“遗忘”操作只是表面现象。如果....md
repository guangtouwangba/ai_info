...
香港理工大学团队研究发现，大语言模型的"遗忘"存在"伪遗忘"和"真遗忘"之分。他们开发的分析工具表明，仅输出表现变化而内部结构未改变属于可逆的"伪遗忘"；真正的遗忘需要多层网络发生大规模参数扰动，导致表示方向、分布中心等根本性变化且不可恢复。该研究通过PCA、CKA等多维度指标，首次系统区分了这两种遗忘机制，揭示了模型表面遗忘可能只是"表演"的本质。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T18:03:35Z
- **目录日期**: 2025-06-02
