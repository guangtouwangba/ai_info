...
大型语言模型(LLMs)在解决复杂科学问题方面取得进展，但仍难以像人类专家那样进行简洁、基于原理的推理。研究者开发了PhySense基准测试，发现当前LLMs无法像专家那样运用核心物理原理进行高效、可解释的推理。评估显示，即使是最先进的LLMs也难以遵循专家式推理路径。这项研究揭示了LLMs在基于原理的科学推理方面的局限性，为开发更高效、稳健和可解释的AI系统提供了方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T22:01:55Z
- **目录日期**: 2025-06-02
