...
阿里通义实验室开源了预训练框架MaskSearch，通过检索增强型掩码预测(RAMP)技术，使小模型能媲美大模型性能。该框架创新性地让AI在预训练阶段学习结合搜索引擎进行推理，采用多智能体生成思维链和混合奖励系统优化训练。通过课程学习策略逐步提升任务难度，显著增强了模型泛化能力。实验显示，在跨领域问答任务中，采用MaskSearch的小模型表现优于传统方法，甚至达到大模型水平。研究还揭示了掩码策略和奖励函数对模型性能的关键影响。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T03:27:57Z
- **目录日期**: 2025-06-02
