...
南洋理工大学与A*STAR团队提出AI水印新方法MaskMark，通过"掩码机制"精准定位水印区域，分为全图嵌入（MaskMark-D）和局部嵌入（MaskMark-ED）两种版本。该方法在保持高保真度的同时实现接近100%的提取准确率，尤其擅长小区域水印任务，性能全面超越Meta的WAM等现有模型。其训练成本仅为WAM的1/15（单卡A6000训练20小时），支持多水印嵌入和快速微调对抗新攻击。该技术特别适用于人脸、LOGO等局部保护场景，成为AI水印领域的新SOTA。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T03:27:45Z
- **目录日期**: 2025-06-02
