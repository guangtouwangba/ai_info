...
南洋理工大学与A*STAR团队提出新型AI水印方法MaskMark，采用"掩码机制"实现精准水印定位，性能全面超越Meta的WAM模型。该方法分两种版本：全图嵌入局部提取的MaskMark-D和区域定向嵌入的MaskMark-ED，特别适合人脸/LOGO保护。实验显示其在高保真度下保持近100%提取准确率，水印定位能力显著优于现有技术，意外支持多水印嵌入。训练效率惊人——单A6000显卡20小时完成，成本仅为WAM的1/15，且具备快速适应新攻击的能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T04:10:23Z
- **目录日期**: 2025-06-02
