...
本文提出了一种名为"LlamaDuo"的LLMOps流程，旨在将云端大型语言模型(LLMs)的知识和能力迁移到本地可管理的小型模型上。该流程通过使用服务型LLM生成的合成数据对小型模型进行微调，若性能不足则自动进行多轮额外微调，最终使小型模型能在特定下游任务上达到甚至超越原服务型LLM的表现。LlamaDuo解决了对云服务的依赖、隐私问题和网络连接需求，为受限环境中的AI部署提供了实用且可扩展的解决方案。实验证明该方法具有高效性、适应性和经济性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T08:02:49Z
- **目录日期**: 2025-06-02
