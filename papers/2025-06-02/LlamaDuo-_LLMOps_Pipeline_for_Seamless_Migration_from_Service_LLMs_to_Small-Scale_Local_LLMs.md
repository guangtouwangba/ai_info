...
本文提出了一种名为"LlamaDuo"的LLMOps管道，旨在将云端大型语言模型(LLMs)的知识和能力迁移到本地可管理的小型模型上。该方法通过使用服务型LLM生成的合成数据对小模型进行微调，若效果不足则自动追加类似数据进行多轮优化，最终使小模型能在特定下游任务中匹配甚至超越原服务LLM。LlamaDuo解决了对云服务的依赖、隐私问题和离线需求等挑战，为受限环境中的AI部署提供了实用且可扩展的解决方案。实验证明该方法在多种任务中具有高效性、适应性和经济性。项目代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T17:03:56Z
- **目录日期**: 2025-06-02
