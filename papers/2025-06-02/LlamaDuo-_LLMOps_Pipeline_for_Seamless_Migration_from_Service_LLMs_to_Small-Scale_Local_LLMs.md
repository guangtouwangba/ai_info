...
本文提出了一种名为"LlamaDuo"的LLMOps管道，旨在将云端大型语言模型(LLMs)的知识和能力迁移到本地可管理的小型模型中。该方法通过使用服务型LLM生成的合成数据对小型模型进行微调，若性能不足则自动追加相似数据进行多轮优化，最终使小型模型能在特定下游任务中达到或超越原服务型LLM的表现。实验证明该方案在有效性、适应性和经济性方面表现优异，为依赖受限环境(如隐私要求、离线需求或服务中断时)提供了可行的AI部署解决方案。项目代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T12:02:43Z
- **目录日期**: 2025-06-02
