...
本文提出了一种名为"LlamaDuo"的LLMOps流程，旨在将云端大型语言模型(LLMs)的知识和能力迁移到本地可管理的小型模型上。该方法通过使用服务型LLM生成的合成数据集对小模型进行微调，若效果不足则自动生成更多数据进行多轮微调，最终使小模型能在特定下游任务中达到甚至超越原服务型LLM的性能。LlamaDuo解决了对云服务的依赖、隐私问题和离线需求等挑战，实验证明其在多种任务中具有高效性、适应性和经济性。项目代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T10:02:29Z
- **目录日期**: 2025-06-02
