...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统模拟了1万多个AI代理的社会生活，记录它们之间及与环境间的500万次互动。研究者用它研究了四个社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，证明该系统能有效捕捉人类行为模式和社会机制。AgentSociety展现了作为社会科学研究工具和辅助政策制定的潜力，可补充传统研究方法如调查和实验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T02:37:22Z
- **目录日期**: 2025-06-02
