...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可以模拟1万多个AI代理的社会生活及其500万次互动。研究者利用该系统研究了社会极化、信息传播、基本收入政策和自然灾害影响等社会问题，其模拟结果与现实世界数据高度吻合。该系统结合了LLM驱动的智能代理、真实社会环境和强大模拟引擎，能够揭示社会问题的模式和内在机制，为社会科学研究和政策制定提供了新工具。研究表明AgentSociety能有效补充传统研究方法，在理解人类行为和社会机制方面展现出重要潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T23:04:54Z
- **目录日期**: 2025-06-02
