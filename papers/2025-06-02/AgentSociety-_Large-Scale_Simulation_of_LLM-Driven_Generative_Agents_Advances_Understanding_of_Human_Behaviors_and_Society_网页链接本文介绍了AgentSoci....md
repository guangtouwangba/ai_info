...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理的社会互动（500万次交互）。研究者用它研究了四个社会问题：社会极化、信息传播、基本收入政策效果和自然灾害影响。模拟结果与现实数据吻合，验证了该系统在揭示人类行为机制方面的能力。该平台可作为传统社会科学研究方法（如调查、实验）的补充工具，帮助研究者分析社会问题成因并辅助政策制定。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T14:06:25Z
- **目录日期**: 2025-06-02
