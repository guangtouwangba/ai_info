...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个智能代理的社会互动（500万次交互）。该系统被用于研究四大社会问题：社会极化、信息传播、基本收入政策效果和自然灾害影响。模拟结果与现实世界数据高度吻合，验证了系统对人类行为和社会机制的捕捉能力。研究表明，AgentSociety能有效补充传统社会科学研究方法（如调查和实验），为研究者和政策制定者提供强大的分析工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T13:15:24Z
- **目录日期**: 2025-06-02
