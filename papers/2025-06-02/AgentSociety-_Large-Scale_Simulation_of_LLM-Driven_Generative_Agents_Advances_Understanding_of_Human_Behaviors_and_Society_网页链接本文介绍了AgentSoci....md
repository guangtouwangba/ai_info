...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个智能代理及其500万次社会互动。该系统作为计算社会科学实验平台，研究了社会极化、信息传播、基本收入政策及自然灾害影响等社会问题。模拟结果与现实世界研究数据高度吻合，验证了该系统对人类行为和社会机制建模的有效性。研究表明AgentSociety能够有效补充传统社会科学研究方法，为研究者和政策制定者提供强大的分析工具，有助于深入理解复杂社会现象背后的模式和机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T15:06:03Z
- **目录日期**: 2025-06-02
