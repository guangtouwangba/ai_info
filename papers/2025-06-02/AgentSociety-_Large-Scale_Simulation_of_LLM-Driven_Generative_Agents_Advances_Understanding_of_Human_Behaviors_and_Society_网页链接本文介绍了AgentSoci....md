...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统模拟了1万多个AI代理的社会生活，记录了500万次互动，用于研究社会现象。研究者用它分析了四个关键问题：社会极化、信息传播、基本收入政策效果和自然灾害影响。模拟结果与现实数据吻合，验证了该系统捕捉人类行为机制的能力。AgentSociety展现了作为社会科学研究工具和决策辅助平台的潜力，能够补充传统研究方法如调查和实验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T03:29:07Z
- **目录日期**: 2025-06-02
