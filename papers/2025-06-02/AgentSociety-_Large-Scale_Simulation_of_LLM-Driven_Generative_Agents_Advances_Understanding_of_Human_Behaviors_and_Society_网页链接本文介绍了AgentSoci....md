...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统通过1万多个AI代理在虚拟社会环境中的500万次交互，模拟真实人类行为和社会现象。研究团队利用该平台进行了四项社会科学实验，包括社会极化、信息传播、基本收入政策和自然灾害影响等课题。模拟结果与现实世界数据高度吻合，证明了该系统在揭示人类行为机制和社会问题成因方面的有效性。AgentSociety展现了作为社会科学研究和政策制定辅助工具的潜力，能够补充传统研究方法如调查和实地实验的不足。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T01:32:50Z
- **目录日期**: 2025-06-02
