...
Ubiquant团队提出"熵最小化"(EM)方法，无需强化学习(RL)即可高效微调大模型。该方法仅需1条高质量样本，通过10步无监督训练，迫使模型输出高置信度答案，显著提升数学推理能力。相比RL，EM省去了数据标注和奖励模型，训练更快且效果相当。关键创新在于选择模型回答不稳定的问题作为训练样本。实验显示，仅用1道物理题就使Qwen2.5-Math-7B性能大幅提升。该方法突破了传统RL微调对海量数据的依赖，为大模型优化提供了高效新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T21:03:31Z
- **目录日期**: 2025-06-02
