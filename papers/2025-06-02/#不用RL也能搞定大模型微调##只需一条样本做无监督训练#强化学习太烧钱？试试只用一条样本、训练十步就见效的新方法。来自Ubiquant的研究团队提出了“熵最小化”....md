...
Ubiquant团队提出"熵最小化"(EM)方法，无需强化学习(RL)即可高效微调大模型。该方法完全无监督，仅需1条高质量样本和10步训练就能显著提升模型性能。核心原理是通过压低输出分布的熵值，迫使模型选择最自信的答案。实验显示，在数学推理任务上，EM仅用1道物理题就使Qwen2.5-Math-7B模型性能大幅提升，效果媲美传统RL方法。关键创新是选择模型回答不稳定的"纠结"问题作为训练样本，实现快速优化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T04:09:21Z
- **目录日期**: 2025-06-02
