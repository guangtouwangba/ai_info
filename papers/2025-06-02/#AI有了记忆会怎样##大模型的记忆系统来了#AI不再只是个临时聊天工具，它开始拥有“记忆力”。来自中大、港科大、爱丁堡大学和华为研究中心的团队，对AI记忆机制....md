...
中大、港科大等团队发表研究，系统梳理了AI记忆机制。研究指出大语言模型需要更完善的记忆系统来支持长期交互，提出了参数化记忆（内部知识）和上下文记忆（显式信息）两种表示方式，以及6种核心操作：巩固、更新、索引、遗忘、检索和压缩。这些机制使AI能更灵活地处理跨轮对话、多模态输入和个性化需求，推动AI从临时工具向智能体演进。该框架为理解AI记忆系统提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T12:04:29Z
- **目录日期**: 2025-06-02
