# #AI有了记忆会怎样##大模型的记忆系统来了#AI不再只是个临时聊天工具，它开始拥有“记忆力”。来自中大、港科大、爱丁堡大学和华为研究中心的团队，对AI记忆机制...
...
这篇研究综述探讨了大语言模型(LLMs)记忆系统的关键发展。研究团队提出了记忆系统的两个核心维度：记忆表示(参数化记忆和上下文记忆)和记忆操作。参数化记忆指模型内部知识，响应快但难更新；上下文记忆则更灵活，包括非结构化(文本/图像)和结构化(知识图谱)信息。研究定义了6种核心记忆操作：巩固、更新、索引、遗忘、检索和压缩，这些构成了AI的"记忆肌肉"。该框架为构建具有长期交互能力的智能体提供了理论基础，使AI能更好地处理跨轮对话、多模态输入和个性化需求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T20:04:25Z
- **目录日期**: 2025-06-02
