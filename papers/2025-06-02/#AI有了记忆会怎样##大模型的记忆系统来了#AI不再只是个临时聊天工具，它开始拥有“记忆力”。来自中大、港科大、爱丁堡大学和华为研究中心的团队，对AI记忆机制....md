...
这篇研究由中大、港科大、爱丁堡大学和华为团队合作，系统探讨了大语言模型(LLMs)的记忆机制。研究提出记忆系统包含参数化记忆(模型内部知识)和上下文记忆(显式多模态信息)两种表示形式，并定义了6种核心操作：巩固、更新、索引、遗忘、检索和压缩。这些机制使AI能够支持跨轮对话、个性化交互等复杂需求，推动LLMs向长期交互的智能体发展。该框架为构建更接近人类记忆能力的AI系统提供了理论基础。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T06:04:19Z
- **目录日期**: 2025-06-02
