...
中大、港科大等团队发表研究，系统阐述了大语言模型(LLMs)的记忆机制。研究指出，AI需要更完整的记忆系统来支持长期交互，提出了参数化记忆(内部知识)和上下文记忆(显式信息)两种表示方式，以及巩固、更新等6种核心记忆操作。这些机制使AI能够实现跨轮对话、多模态处理和个性化服务，标志着AI从临时工具向具有记忆能力的智能体演进。该研究为理解AI智能提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T21:04:14Z
- **目录日期**: 2025-06-02
