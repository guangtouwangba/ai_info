...
该研究由中大、港科大、爱丁堡大学和华为团队合作，系统综述了AI记忆机制。研究指出大语言模型(LLMs)需要更完善的记忆系统来支持长期交互，提出了记忆的两个核心维度：参数化记忆(内部知识)和上下文记忆(显式信息)。同时定义了6种关键记忆操作：巩固、更新、索引、遗忘、检索和压缩，为AI构建类似人类的记忆能力提供了统一框架。这种记忆系统将使AI能够更好地处理跨轮对话、多模态输入和个性化需求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T10:04:14Z
- **目录日期**: 2025-06-02
