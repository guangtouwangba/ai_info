...
中大、港科大等团队发表研究，系统分析了大语言模型(LLMs)的记忆机制。研究提出记忆系统包含参数化记忆(模型内部知识)和上下文记忆(显式信息)两种表示方式，以及6种核心操作：巩固、更新、索引、遗忘、检索和压缩。这些机制使AI能处理跨轮对话、多模态输入等复杂需求，推动LLMs向长期交互的智能体发展。该框架为理解AI记忆系统提供了新视角，使大模型具备更接近人类的记忆能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T17:06:04Z
- **目录日期**: 2025-06-02
