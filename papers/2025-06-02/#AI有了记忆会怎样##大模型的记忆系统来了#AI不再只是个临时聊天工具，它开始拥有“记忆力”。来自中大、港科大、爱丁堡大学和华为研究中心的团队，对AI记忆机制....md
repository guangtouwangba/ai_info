...
中大、港科大、爱丁堡大学和华为研究团队系统综述了AI记忆机制，提出大语言模型(LLMs)需要更完整的记忆系统来支持长期交互。研究从记忆表示(参数化记忆和上下文记忆)和记忆操作两个维度展开，定义了6种核心操作：巩固、更新、索引、遗忘、检索和压缩。参数化记忆存储内部知识但难更新，上下文记忆则更灵活可更新。该框架为AI实现类人记忆能力提供了理论基础，标志着大模型向更智能的交互形态迈进。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T11:04:27Z
- **目录日期**: 2025-06-02
