...
这篇研究综述探讨了大语言模型(LLMs)如何发展记忆系统以实现长期交互智能。研究团队来自中大、港科大等机构，提出了记忆系统的两个核心维度：参数化记忆(内部知识)和上下文记忆(显式信息)。研究定义了6种关键记忆操作：巩固、更新、索引、遗忘、检索和压缩，这些操作构成了AI记忆系统的基础功能。参数化记忆响应快但难更新，而上下文记忆更灵活且支持多模态内容。该框架为构建具备人类记忆能力的AI系统提供了理论基础。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T07:04:55Z
- **目录日期**: 2025-06-02
