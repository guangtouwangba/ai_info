...
中大、港科大、爱丁堡大学和华为团队发表研究，系统综述了AI记忆机制。研究指出大语言模型(LLMs)需要更完整的记忆系统来支持长期交互、多模态输入和个性化需求。记忆分为两类：参数化记忆(模型内部知识，响应快但难更新)和上下文记忆(显式信息，更灵活)。研究定义了6种核心记忆操作：巩固、更新、索引、遗忘、检索和压缩，为AI构建类似人类的记忆能力提供了统一框架。这项研究为理解智能系统开辟了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T14:05:14Z
- **目录日期**: 2025-06-02
