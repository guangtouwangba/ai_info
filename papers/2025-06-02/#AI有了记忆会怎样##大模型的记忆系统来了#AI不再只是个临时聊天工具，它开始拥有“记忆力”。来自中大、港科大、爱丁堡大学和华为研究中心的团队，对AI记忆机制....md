...
中大、港科大等团队研究提出AI记忆系统框架，将大语言模型的记忆分为参数化记忆（内部知识）和上下文记忆（显式信息）。研究定义了6种核心记忆操作：巩固、更新、索引、遗忘、检索和压缩，使AI能更灵活地处理跨轮对话、多模态输入等复杂需求。该框架为AI实现长期交互和个性化服务提供了理论基础，标志着大模型向更接近人类记忆能力的方向发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T00:03:30Z
- **目录日期**: 2025-06-02
