...
中大、港科大、爱丁堡大学和华为团队发表研究，系统分析了大语言模型(LLMs)的记忆机制。研究指出AI正向长期交互智能体发展，需要支持跨轮对话、多模态输入等复杂记忆功能。记忆系统分为参数化记忆(内部知识)和上下文记忆(显式信息)两种表示形式，并定义了6种核心操作：巩固、更新、索引、遗忘、检索和压缩。这些机制使AI能像人类一样处理记忆，为构建更智能的AI系统提供了理论框架。该研究为理解AI智能开辟了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T08:04:40Z
- **目录日期**: 2025-06-02
