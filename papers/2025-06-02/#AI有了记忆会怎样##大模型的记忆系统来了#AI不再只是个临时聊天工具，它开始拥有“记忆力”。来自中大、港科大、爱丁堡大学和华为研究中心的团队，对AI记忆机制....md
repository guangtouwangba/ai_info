...
这篇研究综述探讨了大语言模型(LLMs)如何发展记忆系统以实现长期智能交互。研究团队提出了记忆的两个核心维度：参数化记忆(内部知识)和上下文记忆(显式信息)，并定义了6种关键记忆操作：巩固、更新、索引、遗忘、检索和压缩。这些机制使AI能够处理跨轮对话、多模态输入和个性化偏好，标志着AI从临时聊天工具向具有"记忆力"的智能体转变。该框架为理解AI智能提供了新视角，使大模型更接近人类记忆能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T23:03:53Z
- **目录日期**: 2025-06-02
