...
这篇论文研究了一种涉及多个智能体的上下文赌博机问题，其中学习者需要观察上下文和智能体报告的选项，并选择能使系统整体奖励最大化的选项。现有研究假设智能体会如实报告选项，但现实中（如电商平台卖家可能虚报产品质量）这并不成立。为解决这一问题，作者提出了COBRA算法，在不使用金钱激励的情况下，通过激励相容性和次线性遗憾保证来抑制智能体的策略性行为。实验结果验证了该算法的各项性能表现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T00:01:54Z
- **目录日期**: 2025-06-02
