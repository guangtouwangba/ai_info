...
该论文研究了一个涉及多个智能体的上下文赌博问题，其中学习者需要观察智能体报告的选项并选择最大化系统整体奖励的选项。现有研究假设智能体会如实报告，但现实中可能存在策略性欺骗行为（如电商平台卖家虚报产品质量）。为此，作者提出了COBRA算法，在不使用金钱激励的情况下抑制智能体的策略性行为，同时保证激励兼容性和次线性遗憾界。实验验证了该算法的各项性能表现。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T02:34:04Z
- **目录日期**: 2025-06-02
