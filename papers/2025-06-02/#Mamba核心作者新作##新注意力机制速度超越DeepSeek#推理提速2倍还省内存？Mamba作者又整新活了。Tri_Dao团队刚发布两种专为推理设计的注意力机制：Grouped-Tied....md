...
Mamba核心作者Tri Dao团队最新发布两种高效注意力机制GTA和GLA，专为优化推理性能设计。实验显示：GTA在中大型模型质量优于GQA；GLA保持精度的同时提升效率，在32K/64K长文本处理中吞吐量显著领先。新技术实现2倍推理加速并降低内存消耗，特别适合长上下文场景，且具备更强并发处理能力。研究成果在困惑度、7个下游任务及延迟/吞吐量等指标上均验证了其优越性，为当前主流注意力机制提供了更高效的替代方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T11:03:57Z
- **目录日期**: 2025-06-02
