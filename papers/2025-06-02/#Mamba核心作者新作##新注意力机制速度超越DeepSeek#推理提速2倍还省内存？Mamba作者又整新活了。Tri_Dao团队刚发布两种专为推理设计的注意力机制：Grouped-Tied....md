...
Mamba核心作者Tri Dao团队最新发布两种高效注意力机制GTA和GLA，专为推理优化。实验显示，这两种机制在保持模型生成质量的同时，显著提升解码速度（最高2倍）并降低内存消耗，特别适合长文本处理。GTA在中大型模型中表现优于GQA，GLA则与MLA精度相当但效率更高。在32K/64K长文本场景下，GLA吞吐量优势明显，并发处理能力更强，能更好应对不均衡负载。该成果有望替代现有注意力机制，为长上下文AI应用提供更优解决方案。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T20:03:55Z
- **目录日期**: 2025-06-02
