...
Tri Dao团队（Mamba核心作者）最新发布两种高效注意力机制GTA和GLA，专为推理优化。实验显示：GTA在中大型模型质量优于GQA；GLA与MLA精度相当但效率更高，在32K/64K长文本处理时吞吐量显著提升。新技术实现2倍推理加速，降低内存消耗，并增强并发处理能力，尤其适合长上下文场景。研究成果在困惑度、7个下游任务及延迟/吞吐量等指标全面验证，为LLM推理效率提供新突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T09:04:43Z
- **目录日期**: 2025-06-02
