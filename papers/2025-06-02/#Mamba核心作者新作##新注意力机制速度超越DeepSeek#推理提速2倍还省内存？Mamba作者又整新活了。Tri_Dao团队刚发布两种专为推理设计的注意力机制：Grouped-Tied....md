...
Mamba核心作者Tri Dao团队最新发布两种高效注意力机制GTA和GLA，专为优化推理性能设计。实验显示：GTA在中大型模型质量优于GQA，GLA在保持精度的同时效率更高，64K长文本吞吐量显著提升，内存利用率更优。新机制在解码速度（2倍提升）、KV缓存和并发处理方面表现突出，尤其适合长上下文场景，且不影响生成质量。该成果有望替代DeepSeek当前使用的注意力方案。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T03:27:05Z
- **目录日期**: 2025-06-02
