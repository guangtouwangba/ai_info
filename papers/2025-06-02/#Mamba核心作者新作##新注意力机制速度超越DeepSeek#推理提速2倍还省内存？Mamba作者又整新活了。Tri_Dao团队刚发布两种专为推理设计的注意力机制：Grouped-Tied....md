...
Mamba核心作者Tri Dao团队发布两种新型注意力机制GTA和GLA，专为提升推理效率设计。实验显示，这两种机制在保持模型生成质量的同时，显著提高解码速度（最高提速2倍）和内存利用率，特别适合长文本处理。GTA在中大型模型中表现优于GQA，GLA则与MLA精度相当但效率更高，在32K/64K长文本吞吐量上优势明显。新机制还增强了并发处理能力，能更好应对不均衡负载。研究成果有望替代现有方案（如DeepSeek采用的机制），推动大模型推理性能突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T10:03:40Z
- **目录日期**: 2025-06-02
