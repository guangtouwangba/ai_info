...
Mamba核心作者Tri Dao团队推出两种新型注意力机制GTA和GLA，专为提升推理效率设计。实验显示，这两种机制在保持模型生成质量的同时，显著提高了解码速度（最高提速2倍）和内存利用率，尤其擅长处理长文本场景。GTA在中大型模型中表现优于GQA，GLA则与MLA精度相当但效率更高。在32K/64K长文本处理时，GLA吞吐量优势明显，并发处理能力更强。该技术有望替代现有方案，为长上下文AI应用提供更高效的推理支持。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T07:04:25Z
- **目录日期**: 2025-06-02
