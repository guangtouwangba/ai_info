...
Mamba核心作者Tri Dao团队发布两种新型注意力机制GTA和GLA，专为提升推理效率设计。实验显示：GTA在中大型模型质量优于GQA；GLA与MLA精度相当但效率更高，在32K/64K长文本处理时吞吐量显著提升，同时降低内存消耗。新机制支持并发处理长文本和不均衡负载，在解码速度上实现2倍提升，且保持模型生成质量。该成果特别适用于长上下文场景，为注意力机制优化提供新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T15:04:09Z
- **目录日期**: 2025-06-02
