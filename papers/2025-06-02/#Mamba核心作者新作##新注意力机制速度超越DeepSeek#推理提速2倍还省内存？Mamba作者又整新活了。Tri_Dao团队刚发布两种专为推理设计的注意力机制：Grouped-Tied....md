...
Mamba核心作者Tri Dao团队最新发布两种高效注意力机制GTA和GLA，专为推理优化。实验显示：GTA在中大型模型质量优于GQA，GLA与MLA精度相当但效率更高，在32K/64K长文本处理时吞吐量显著提升，支持更高并发。新技术在保持生成质量的同时，实现2倍推理加速并降低内存消耗，尤其适合长上下文场景。测试涵盖4种模型规模，从困惑度、下游任务到延迟/缓存等指标均表现优异。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T16:03:46Z
- **目录日期**: 2025-06-02
