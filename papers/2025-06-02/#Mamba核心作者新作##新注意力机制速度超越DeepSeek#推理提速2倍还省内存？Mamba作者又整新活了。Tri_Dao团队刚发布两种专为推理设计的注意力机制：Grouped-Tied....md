...
Tri Dao团队最新发布两种高效注意力机制GTA和GLA，专为优化推理性能设计。实验显示：GTA在中大型模型质量优于GQA，GLA保持MLA精度同时提升效率。在32K/64K长文本处理中，GLA吞吐量显著领先，内存利用率更高，支持并发处理长文本和不均衡负载。新方法使推理速度提升2倍，同时降低内存消耗，特别适合长上下文场景，且不影响生成质量。研究涵盖四种模型规模，测试包括困惑度、7项下游任务及延迟/吞吐量等效率指标。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T13:13:29Z
- **目录日期**: 2025-06-02
