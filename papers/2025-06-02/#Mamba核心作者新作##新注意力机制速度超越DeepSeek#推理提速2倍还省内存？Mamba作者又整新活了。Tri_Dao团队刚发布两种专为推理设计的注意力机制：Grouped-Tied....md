...
Mamba核心作者Tri Dao团队最新发布两种高效注意力机制GTA和GLA，专为提升推理性能设计。实验显示：GTA在中大型模型质量优于GQA，GLA保持精度的同时效率更高，在32K/64K长文本处理中吞吐量显著提升，且具备更强并发能力。新技术在解码速度（提升2倍）、内存利用率方面表现突出，尤其适合长上下文场景，为LLM推理优化提供新方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T19:03:56Z
- **目录日期**: 2025-06-02
