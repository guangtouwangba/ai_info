...
Tri Dao团队最新发布两种高效注意力机制GTA和GLA，专为推理任务优化。在保持模型质量的前提下，新技术实现解码速度提升2倍并降低内存消耗，特别适合长文本处理。测试显示：GTA在中大型模型中优于GQA；GLA与MLA精度相当但效率更高，在32K/64K长文本处理时吞吐量显著领先，并发能力更强。该成果有望替代现有注意力机制，显著提升大模型推理效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T05:03:57Z
- **目录日期**: 2025-06-02
