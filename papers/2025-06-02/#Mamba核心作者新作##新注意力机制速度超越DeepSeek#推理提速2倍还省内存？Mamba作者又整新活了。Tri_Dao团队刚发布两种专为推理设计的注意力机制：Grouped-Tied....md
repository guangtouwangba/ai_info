...
Mamba核心作者Tri Dao团队最新发布两种高效注意力机制GTA和GLA，专为推理优化。实验显示：GTA在中大型模型质量优于GQA，GLA与MLA精度相当但效率更高，在32K/64K长文本处理时吞吐量显著提升，内存占用更低。新方法使解码速度提升2倍，同时保持生成质量，特别适合长上下文场景和并发任务处理。该研究为LLM推理效率提供了突破性解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T18:03:44Z
- **目录日期**: 2025-06-02
