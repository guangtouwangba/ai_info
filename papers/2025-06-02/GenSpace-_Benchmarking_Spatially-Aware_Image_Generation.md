...
GenSpace是一个新的基准测试和评估框架，用于全面评估当前图像生成模型的3D空间感知能力。研究发现，尽管AI模型能生成视觉吸引人的图像并遵循一般指令，但在物体位置、关系和尺寸等3D细节上表现不佳。该研究提出了一种专用评估流程和指标，通过多视觉基础模型重建3D场景几何，提供更准确的空间忠实度度量。研究总结了当前最先进图像生成模型在空间感知上的三大局限：1)物体视角理解，2)自我中心-他中心转换，3)度量测量一致性，为提升图像生成的空间智能指明了改进方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T19:01:20Z
- **目录日期**: 2025-06-02
