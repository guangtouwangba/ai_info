...
本文提出了一种基于强化学习的LLM智能体ML-Agent框架，通过三个创新点实现自主机器学习：(1) 探索增强微调提升动作多样性；(2) 分步强化学习加速训练效率；(3) 专用奖励模块统一反馈信号。实验表明，仅用7B参数的Qwen-2.5模型在9个任务上训练后，性能即超越671B参数的DeepSeek-R1智能体，并展现出持续改进能力和优异的跨任务泛化性能。该研究首次实现了基于学习的智能体ML范式，突破了传统依赖人工提示工程的局限，为自主机器学习开辟了新方向。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T00:01:45Z
- **目录日期**: 2025-06-02
