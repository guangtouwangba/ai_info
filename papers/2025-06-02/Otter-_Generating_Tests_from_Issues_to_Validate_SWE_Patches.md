...
本文介绍了TDD-Bench-Verified基准和基于LLM的解决方案Otter，用于从问题描述生成测试用例。Otter通过规则分析检查和修复输出，并引入自反思动作规划器，支持测试驱动开发（TDD）和验证软件工程代理生成的代码补丁。实验表明，Otter在从问题生成测试方面优于现有系统，并能提升补丁生成系统的性能。该研究旨在帮助开发者更高效解决问题并生成更健壮、经过充分测试的代码。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T20:02:42Z
- **目录日期**: 2025-06-02
