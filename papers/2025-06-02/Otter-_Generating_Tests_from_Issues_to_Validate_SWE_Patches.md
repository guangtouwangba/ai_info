...
本文提出了一种从问题描述生成测试用例的新方法，支持测试驱动开发(TDD)和验证软件工程代理生成的代码补丁。研究团队开发了TDD-Bench-Verified基准测试和基于LLM的Otter系统，该系统通过规则分析和自我反思机制来检查和修复生成的测试用例。实验表明，Otter在从问题生成测试用例方面优于现有技术，并能提升问题补丁生成系统的性能。该研究有助于提高开发效率，促进生成更健壮、经过充分测试的代码。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T15:02:33Z
- **目录日期**: 2025-06-02
