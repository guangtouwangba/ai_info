...
本文提出了一种从问题生成测试的新方法，支持测试驱动开发(TDD)和验证软件工程代理生成的代码补丁。研究团队开发了TDD-Bench-Verified基准测试和基于LLM的解决方案Otter。Otter通过规则分析检查和修复输出，并采用创新的自反式行动规划器。实验表明，Otter在从问题生成测试方面优于现有系统，同时也能提升生成补丁系统的性能。该工具有望提高开发者解决问题的效率，并促进更健壮、经过充分测试的代码产出。研究填补了现有工作中从问题直接生成测试的空白，支持"先测试后编码"的开发模式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T07:03:03Z
- **目录日期**: 2025-06-02
