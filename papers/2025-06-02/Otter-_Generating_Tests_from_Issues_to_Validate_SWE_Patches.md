...
这篇论文提出了TDD-Bench-Verified基准和基于LLM的Otter系统，用于从问题描述生成测试用例。Otter通过规则分析和自我反思机制改进LLM输出，支持测试驱动开发(TDD)和验证软件工程代理生成的代码补丁。实验表明，Otter在从问题生成测试方面优于现有系统，并能提升生成补丁系统的性能。该研究旨在帮助开发者更高效解决问题并产生更健壮的代码。研究填补了从问题直接生成测试（而非现有代码）的空白，特别适用于补丁尚未存在的情况。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T17:03:41Z
- **目录日期**: 2025-06-02
