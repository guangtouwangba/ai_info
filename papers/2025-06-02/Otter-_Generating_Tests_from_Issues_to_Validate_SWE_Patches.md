...
这篇论文提出了TDD-Bench-Verified基准和基于LLM的Otter工具，用于从问题描述生成测试用例，支持测试驱动开发(TDD)和验证软件工程代理生成的代码补丁。Otter通过规则分析和自我反思机制增强LLM输出质量。实验表明，Otter在从问题生成测试方面优于现有技术，并能提升问题补丁生成系统的表现。该研究旨在帮助开发者更高效解决问题并产出经过充分测试的健壮代码，特别适用于补丁尚未存在的开发场景。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T21:02:20Z
- **目录日期**: 2025-06-02
