...
该论文综述了针对非小细胞肺癌(NSCLC)ALK基因的双靶点抑制剂研究进展。ALK基因是NSCLC的重要致癌驱动靶点，现有7种获批ALK抑制剂面临耐药性挑战。相比联合用药，双靶点抑制剂能通过单一分子同时作用于两个靶点，减少副作用和毒性，更有效对抗耐药性。文章总结了基于ALK的双靶点抑制剂在NSCLC治疗中的最新成果，分析了其合理设计和结构-活性关系，为开发新型ALK抑制剂和创新治疗策略提供重要参考，有助于解决当前靶向治疗的耐药性问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T21:04:50Z
- **目录日期**: 2025-06-02
