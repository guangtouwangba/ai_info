...
研究者提出了Agent-X基准测试，用于评估视觉中心智能体在真实多模态环境中的多步深度推理能力。该基准包含828个任务，涵盖图像、视频、多图对比等六类场景，要求智能体结合工具使用进行分步决策。研究还提出了细粒度的分步评估框架，分析每一步推理的逻辑性和工具使用有效性。测试发现，包括GPT、Gemini等在内的顶尖模型在多步视觉任务上成功率不足50%，揭示了当前大模型在视觉推理和工具使用上的关键瓶颈。相关数据和代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T10:01:06Z
- **目录日期**: 2025-06-02
