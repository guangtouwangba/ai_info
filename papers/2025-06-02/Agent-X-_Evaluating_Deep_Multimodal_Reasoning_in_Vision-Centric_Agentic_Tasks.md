...
研究者提出了Agent-X基准测试，用于评估视觉中心智能体在真实多模态环境中的多步深度推理能力。该基准包含828个任务，涵盖图像、视频、文本等多种视觉模态，涉及视觉推理、网页浏览、自动驾驶等6大领域，要求智能体结合工具使用进行显式分步决策。研究还提出了细粒度的分步评估框架，分析每一步推理的正确性和工具使用效果。测试发现，当前最佳模型（如GPT、Gemini等）在多步视觉任务中成功率不足50%，揭示了现有模型在推理和工具使用能力上的关键瓶颈。数据和代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T03:25:04Z
- **目录日期**: 2025-06-02
