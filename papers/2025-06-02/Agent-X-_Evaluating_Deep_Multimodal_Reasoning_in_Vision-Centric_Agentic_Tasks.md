...
研究者提出了Agent-X，这是一个大规模基准测试，用于评估视觉中心智能体在真实多模态环境中的多步深度推理能力。该基准包含828个任务，涵盖图像、视频、多图对比和文本指令，涉及视觉推理、网页浏览、自动驾驶等6大领域。研究采用细粒度分步评估框架，分析每一步推理的逻辑性和工具使用有效性。测试发现，当前最先进的GPT、Gemini等模型在多步视觉任务中的完整链成功率不足50%，揭示了现有模型在推理和工具使用能力上的关键瓶颈。数据和代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T07:01:34Z
- **目录日期**: 2025-06-02
