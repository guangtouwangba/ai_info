...
研究者提出了Agent-X基准测试，用于评估视觉中心智能体在真实多模态环境中的多步深度推理能力。该基准包含828个任务，涵盖图像、视频、文本等多种视觉模态，涉及6大应用场景。测试要求智能体结合工具使用进行显式分步决策，并采用细粒度评估框架分析每一步的逻辑连贯性和工具使用有效性。结果显示，当前最佳模型（如GPT、Gemini等）在多步视觉任务中的成功率不足50%，凸显了现有模型在推理和工具使用能力上的瓶颈。相关数据和代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T15:01:14Z
- **目录日期**: 2025-06-02
