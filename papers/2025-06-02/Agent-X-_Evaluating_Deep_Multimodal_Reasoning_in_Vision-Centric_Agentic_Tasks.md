...
研究者提出了Agent-X基准测试，用于评估视觉中心智能体在真实多模态环境中的多步深度推理能力。该基准包含828个任务，涵盖图像、视频、文本等多种视觉模态，涉及6大应用场景。不同于现有测试，它强调多步推理和工具使用的结合，并提供了细粒度的分步评估框架。测试显示，当前最先进的GPT、Gemini等模型在多步视觉任务中的成功率不足50%，暴露了现有模型在推理和工具使用上的瓶颈。该研究为视觉中心智能体的未来发展指明了方向。数据和代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T12:01:13Z
- **目录日期**: 2025-06-02
