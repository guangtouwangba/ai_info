...
研究者提出了Agent-X基准测试，用于评估视觉中心智能体在真实多模态环境中的多步深度推理能力。该基准包含828个任务，涵盖图像、视频、文本等多种视觉模态，涉及6大领域（如视觉推理、自动驾驶等）。测试要求智能体结合工具使用进行分步决策，并采用细粒度评估框架分析每一步的逻辑性和工具使用有效性。实验显示，当前最先进的GPT、Gemini等模型在多步视觉任务中的成功率不足50%，揭示了现有模型在推理和工具使用方面的瓶颈。数据和代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T22:01:08Z
- **目录日期**: 2025-06-02
