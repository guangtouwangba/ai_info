...
研究人员开发了首个基于网页的CAPTCHA基准测试平台Open CaptchaWorld，用于评估多模态大语言模型（MLLM）代理的视觉推理和交互能力。该平台包含20种现代CAPTCHA类型共225个谜题，并提出了新指标"CAPTCHA推理深度"来衡量解决每个谜题所需的认知和操作步骤。实验显示人类表现接近完美（93.3%），而最先进的MLLM代理成功率最高仅40%，远低于人类水平。该平台为诊断当前多模态代理的局限性提供了重要基准，有助于开发更强大的多模态推理系统。相关代码和数据已公开。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T11:01:06Z
- **目录日期**: 2025-06-02
