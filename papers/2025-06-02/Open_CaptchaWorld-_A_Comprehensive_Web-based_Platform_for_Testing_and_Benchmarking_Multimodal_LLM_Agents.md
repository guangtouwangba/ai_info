...
研究团队推出了首个基于网页的CAPTCHA基准测试平台Open CaptchaWorld，用于评估多模态大语言模型（MLLM）代理的视觉推理和交互能力。该平台包含20类共225个动态验证码，并提出了新的"CAPTCHA推理深度"指标来量化解决每个谜题所需的认知和操作步骤。实验显示，人类准确率高达93.3%，而最先进的MLLM代理最高仅达40.0%，表明当前多模态系统在交互式推理任务上仍远未达到人类水平。该平台为诊断多模态代理的局限性、开发更强大的推理系统提供了重要基准。相关代码和数据已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T15:01:02Z
- **目录日期**: 2025-06-02
