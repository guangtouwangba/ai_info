...
研究者提出了首个基于网页的CAPTCHA基准测试平台Open CaptchaWorld，包含20种类型共225个动态验证码，用于评估多模态大语言模型(MLLM)代理的视觉推理和交互能力。该平台引入新指标"CAPTCHA推理深度"，量化解决每个验证码所需的认知和操作步骤。实验显示，人类准确率高达93.3%，而当前最佳MLLM代理最高仅40.0%，远低于人类水平。该平台能有效诊断多模态代理的局限，推动开发更强大的多模态推理系统。相关代码和数据已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T13:10:19Z
- **目录日期**: 2025-06-02
