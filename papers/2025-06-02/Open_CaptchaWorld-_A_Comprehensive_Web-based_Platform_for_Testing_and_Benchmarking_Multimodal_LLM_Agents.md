...
研究人员推出首个基于网页的CAPTCHA基准测试平台Open CaptchaWorld，包含20类共225个动态验证码，用于评估多模态大语言模型(MLLM)代理的视觉推理和交互能力。该平台提出新指标"CAPTCHA推理深度"来量化解决每个验证码所需的认知和操作步骤。实验显示人类正确率高达93.3%，而当前最优MLLM代理最高仅达40%，远低于人类水平。该平台能有效诊断现有多模态代理的局限，推动开发更强大的多模态推理系统。相关代码和数据已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T20:01:11Z
- **目录日期**: 2025-06-02
