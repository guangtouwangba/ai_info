...
这篇论文针对代码生成大模型(codeLLMs)开发了新基准CodeArena和数据集SynCode-Instruct，以评估模型与人类偏好的对齐程度。CodeArena包含397个涵盖40类编程任务的真实样本，涉及44种语言；SynCode-Instruct则包含近200亿标记的合成指令数据。研究发现现有基于执行的评测与人类偏好存在差距，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著。研究强调了在代码生成任务中考虑人类偏好的重要性，为改进代码LLMs提供了新的评估框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T16:05:57Z
- **目录日期**: 2025-06-02
