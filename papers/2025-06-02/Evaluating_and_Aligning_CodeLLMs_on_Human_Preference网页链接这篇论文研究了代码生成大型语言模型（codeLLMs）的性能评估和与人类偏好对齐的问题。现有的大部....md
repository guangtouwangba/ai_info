...
这篇论文针对代码生成大模型(codeLLMs)提出新评估方法，重点关注人类偏好对齐问题。研究者创建了CodeArena基准测试(包含397个高质量样本，覆盖40类任务和44种语言)和SynCode-Instruct合成指令集(20B标记)，发现传统执行基准与人类偏好存在差异。实验比较40多个模型显示，开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，凸显了人类偏好对齐在代码生成中的重要性。研究证实大规模合成指令微调的有效性，为改进代码LLMs提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T07:06:43Z
- **目录日期**: 2025-06-02
