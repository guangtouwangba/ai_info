...
ZeroGUI提出了一种可扩展的在线学习框架，用于零人工成本的GUI智能体训练。该框架通过视觉语言模型（VLM）自动生成多样化的训练任务，并评估任务完成情况，无需人工标注或定制评估函数。结合两阶段在线强化学习，智能体能够持续与环境交互并自主学习。实验表明，ZeroGUI显著提升了UI-TARS和Aguvis等GUI智能体在OSWorld和AndroidLab环境中的性能，解决了现有离线学习方法依赖人工标注和适应动态环境能力有限的问题。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T01:28:55Z
- **目录日期**: 2025-06-02
