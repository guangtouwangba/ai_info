...
ZeroGUI提出了一种零人工成本的在线学习框架，用于训练纯视觉GUI代理。该框架通过VLM自动生成多样化任务目标，利用VLM进行无人工设计的奖励评估，并采用两阶段在线强化学习持续与环境交互。相比现有依赖人工标注的离线学习方法，ZeroGUI能更好适应动态交互环境。在UI-TARS和Aguvis等GUI代理上的实验表明，该方法在OSWorld和AndroidLab环境中显著提升了性能。该工作解决了现有方法对人工标注的依赖和动态适应性不足两大核心问题，实现了完全自动化的GUI代理训练。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T00:01:09Z
- **目录日期**: 2025-06-02
