...
浙江大学、电子科技大学和香港中文大学联合开发了首个评估视觉语言大模型（VLM）空间定位能力的基准体系ViewSpatial-Bench，包含5700多个问答对和五种任务。测试发现，GPT-4o等主流模型在空间推理任务中表现不佳，尤其在人物注视方向判断上准确率仅25%-36%。模型更擅长第三人称视角，难以从镜头视角进行空间映射，暴露了静态图文学习导致的视角单一和空间推理能力不足的弱点。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T11:02:57Z
- **目录日期**: 2025-06-02
