...
浙江大学等机构研究发现，当前视觉语言大模型（如GPT-4o）的空间感知能力存在明显缺陷。通过新开发的ViewSpatial-Bench基准测试（含5700个多视角问答），发现模型在左右判断、视线方向等空间任务中表现不佳，部分任务准确率仅25%。模型更擅长处理第三人称信息，但难以从相机视角进行准确空间映射。这项研究揭示了AI在空间推理方面的核心短板，为改进多模态模型的空间智能提供了重要评估工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T10:02:39Z
- **目录日期**: 2025-06-02
