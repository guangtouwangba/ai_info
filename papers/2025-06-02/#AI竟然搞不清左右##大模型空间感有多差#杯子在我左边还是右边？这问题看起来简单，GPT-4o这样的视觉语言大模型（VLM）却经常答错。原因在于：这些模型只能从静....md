...
浙江大学等机构研究发现，当前视觉语言大模型（如GPT-4o）的空间感知能力存在明显缺陷。通过新开发的ViewSpatial-Bench基准测试（含5700多个多视角问答对），发现模型在左右判断、视角转换等空间任务中表现不佳，人物注视方向识别准确率仅25%，最优模型也仅达36%。测试还揭示模型更擅长第三人称视角而非相机视角的空间推理，表明其空间映射能力存在根本性局限。该研究首次系统评估了AI的空间智能短板，为改进模型的空间认知能力提供了重要基准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T17:04:08Z
- **目录日期**: 2025-06-02
