...
浙江大学等机构研究发现，当前视觉语言大模型（如GPT-4o）的空间感知能力存在明显缺陷。通过新开发的ViewSpatial-Bench基准测试（含5700个问答对），发现模型在判断左右位置、人物注视方向等空间任务中表现不佳，准确率最低仅25%。测试显示模型更擅长第三人称视角，而难以理解相机视角的空间关系。这表明AI通过静态图文学习空间信息存在局限性，多角度空间推理能力亟待提升。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T08:03:02Z
- **目录日期**: 2025-06-02
