...
浙江大学等机构研究发现，当前视觉语言大模型（如GPT-4o）的空间感知能力存在明显缺陷。通过ViewSpatial-Bench基准测试（含5700个多视角问答对）发现，模型在左右判断、人物注视方向等任务中准确率极低（最低25%），主要因缺乏动态视角训练。测试还揭示模型存在"第三人称优于镜头视角"的反常现象，表明其空间映射能力薄弱。该研究为AI空间智能评估提供了首个系统性基准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T22:02:36Z
- **目录日期**: 2025-06-02
