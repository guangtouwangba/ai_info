...
浙江大学等机构研究发现，当前视觉语言大模型（如GPT-4o）的空间定位能力存在明显缺陷。通过新开发的ViewSpatial-Bench基准测试（含5700个多视角问答对），发现模型在判断左右方位、人物注视方向等任务中准确率极低（最低25%）。测试显示模型更擅长处理第三人称信息，却难以从相机视角进行空间映射，导致多角度判断时频繁出错。这项研究揭示了AI在空间感知方面的关键短板，为改进模型的空间推理能力提供了重要评估工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T05:02:56Z
- **目录日期**: 2025-06-02
