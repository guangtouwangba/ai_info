...
浙江大学等机构研究发现，当前视觉语言大模型（如GPT-4o）的空间定位能力存在明显缺陷。通过新开发的ViewSpatial-Bench基准测试（含5700多个多视角问答对），发现模型在判断物体左右位置、人物注视方向等任务中准确率极低（最低25%）。测试显示模型更擅长第三人称视角，而难以理解相机视角的空间映射。这表明现有AI主要依赖静态图文学习，缺乏多角度空间推理能力，导致处理"左右"等基础空间关系时频繁出错。研究为改进AI空间感知提供了重要评估工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T23:02:32Z
- **目录日期**: 2025-06-02
