...
浙江大学、电子科技大学和香港中文大学联合开发了首个评估视觉语言大模型空间定位能力的基准体系ViewSpatial-Bench。研究发现，GPT-4o等主流模型在判断物体左右位置、人物注视方向等空间任务上表现较差，准确率最低仅25%。模型更擅长处理第三人称信息，但难以从相机视角进行准确的空间映射。该基准包含5700多个问答对，覆盖5种任务类型，揭示了当前大模型在多角度空间推理能力上的显著缺陷。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T15:03:01Z
- **目录日期**: 2025-06-02
