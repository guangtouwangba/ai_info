...
浙江大学等机构研究发现，当前视觉语言大模型（如GPT-4o）的空间定位能力存在明显缺陷。通过新开发的ViewSpatial-Bench基准测试（含5700+问答对），发现模型在判断左右方位、人物注视方向等任务中准确率极低（最低25%）。测试显示模型更擅长第三人称视角，难以处理相机视角的空间映射，表明其空间推理能力主要依赖静态图文学习，缺乏多角度理解能力。这一发现揭示了AI在空间感知方面的核心短板。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T20:03:01Z
- **目录日期**: 2025-06-02
