...
浙江大学等机构研究发现，当前视觉语言大模型（如GPT-4o）的空间感知能力存在明显缺陷。通过新开发的ViewSpatial-Bench基准测试（含5700个多视角问答对）发现，模型在判断左右方位、人物注视方向等任务中表现不佳，最高准确率仅36%。研究显示，这类模型更擅长处理第三人称信息，但难以从第一人称视角进行空间映射，反映出其通过静态数据学习空间关系的局限性。该成果揭示了AI在空间推理方面的关键短板。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T13:12:20Z
- **目录日期**: 2025-06-02
