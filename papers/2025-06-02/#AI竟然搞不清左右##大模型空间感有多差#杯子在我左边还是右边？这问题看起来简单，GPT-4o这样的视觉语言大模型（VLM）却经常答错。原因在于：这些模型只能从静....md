...
浙江大学等机构研究发现，当前视觉语言大模型（如GPT-4o）的空间感知能力存在明显缺陷。通过新推出的ViewSpatial-Bench基准测试（含5700多个多视角问答对），发现模型在左右判断、视角转换等基础空间任务中表现不佳。例如，人物注视方向识别准确率仅25%，GPT-4o最高仅达36%。测试还揭示模型更擅长第三人称视角推理，而难以理解相机视角的空间关系，表明其空间映射能力存在根本性局限。该研究为AI空间智能的评估和改进提供了重要基准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T16:02:45Z
- **目录日期**: 2025-06-02
