...
浙江大学等机构研究发现，当前视觉语言大模型（如GPT-4o）的空间感知能力存在显著缺陷。通过新开发的ViewSpatial-Bench基准测试（含5700多个多视角问答对），发现模型在左右判断、视角转换等空间任务中表现不佳，人物注视方向识别准确率仅25%，GPT-4o最高仅达36%。研究揭示模型更擅长处理第三人称信息，但难以实现镜头视角的空间映射，表明现有AI系统缺乏人类式的空间推理能力。该成果为改进AI空间智能提供了重要评估工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T09:03:14Z
- **目录日期**: 2025-06-02
