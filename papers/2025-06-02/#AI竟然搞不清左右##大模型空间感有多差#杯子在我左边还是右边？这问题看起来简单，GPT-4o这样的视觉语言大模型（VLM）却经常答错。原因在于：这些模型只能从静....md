...
浙江大学等机构研究发现，当前视觉语言大模型（如GPT-4o）的空间感知能力存在明显缺陷。通过新开发的ViewSpatial-Bench基准测试（含5700多个多视角问答对），发现模型在判断物体左右位置、人物注视方向等任务中表现不佳，最低准确率仅25%。测试显示模型更擅长处理第三人称信息，但难以从相机视角进行空间映射。该研究揭示了AI在空间推理方面的核心短板，为提升多模态模型的几何理解能力提供了评估标准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T14:03:21Z
- **目录日期**: 2025-06-02
