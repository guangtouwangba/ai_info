...
西北大学联合谷歌和DeepMind团队提出贝叶斯自适应强化学习（BARL）框架，突破传统强化学习模型在测试期只能"利用"不能"探索"的局限。BARL赋予模型"反思性探索"能力，使其能根据环境变化实时调整策略，在遇到新情况时主动试错修正。该框架摒弃马尔可夫假设，通过综合历史观察更新环境信念，权衡预期回报与信息增益，实现更精准的反思。实验显示，BARL在数学推理任务中不仅准确率更高，还能避免无效反思，显著提升效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T11:03:06Z
- **目录日期**: 2025-06-02
