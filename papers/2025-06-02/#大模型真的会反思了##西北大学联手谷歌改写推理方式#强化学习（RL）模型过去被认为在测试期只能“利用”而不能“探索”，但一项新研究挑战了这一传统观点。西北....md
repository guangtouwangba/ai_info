...
西北大学联合谷歌和DeepMind提出贝叶斯自适应强化学习(BARL)框架，突破传统强化学习在测试期只能"利用"不能"探索"的限制。BARL赋予模型"反思性探索"能力，能根据环境变化实时调整策略，而非死记硬背。其核心是摒弃马尔可夫假设，综合历史观察更新环境认知，权衡回报与信息增益。实验显示，在数学推理任务中BARL不仅准确率更高，还能避免无效反思节省token。研究表明，现有大模型的"反思"常是表面冗余，而BARL实现了精准有效的反思推理。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T10:02:49Z
- **目录日期**: 2025-06-02
