...
西北大学与谷歌、DeepMind合作提出贝叶斯自适应强化学习(BARL)框架，突破传统强化学习在测试期仅能"利用"不能"探索"的限制。BARL赋予模型"反思性探索"能力，能根据环境变化实时调整策略，在新任务中通过试错修正实现适配。其核心是打破马尔可夫假设，综合历史观察更新环境认知，使每个决策同时权衡回报与信息增益。实验显示BARL在数学推理中准确率更高且更省token，能避免无效反思。研究表明现有大模型的"反思"常流于表面冗余，而BARL实现了精准有效的反思推理。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T17:04:26Z
- **目录日期**: 2025-06-02
