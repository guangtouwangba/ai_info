...
西北大学联合谷歌和DeepMind提出贝叶斯自适应强化学习(BARL)框架，突破传统强化学习模型在测试期仅能"利用"不能"探索"的限制。BARL赋予模型"反思性探索"能力，使其能根据环境变化实时调整策略，而非依赖训练时的固定模式。该框架通过综合历史观察更新环境认知，权衡回报与信息增益，实现更精准的反思。实验显示，BARL在数学推理任务中不仅准确率更高，还能减少无效反思，更高效地使用计算资源。研究揭示了当前大模型"反思"中存在的冗余问题，为提升AI推理能力提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T16:02:55Z
- **目录日期**: 2025-06-02
