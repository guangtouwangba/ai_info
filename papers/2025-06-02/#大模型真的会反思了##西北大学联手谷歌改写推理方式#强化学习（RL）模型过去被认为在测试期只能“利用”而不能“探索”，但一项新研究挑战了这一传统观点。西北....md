...
西北大学联合谷歌和DeepMind提出贝叶斯自适应强化学习(BARL)框架，突破传统强化学习在测试期仅能"利用"不能"探索"的限制。BARL赋予模型"反思性探索"能力，能根据环境变化实时调整策略，而非依赖训练时的死记硬背。其核心是通过历史观察更新环境认知，权衡回报与信息增益做出决策。实验显示，在数学推理任务中BARL不仅准确率更高，还能减少无效反思，更高效地使用token。研究指出当前大模型的"反思"常流于表面，而BARL实现了真正有意义的适应性推理。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T15:03:16Z
- **目录日期**: 2025-06-02
