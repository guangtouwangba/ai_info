...
大型语言模型(LLMs)在医疗领域展现出丰富知识，但存在幻觉和错误引用问题。研究者提出新型原子事实核查框架，将LLM生成的回答分解为可独立验证的"原子事实"，对照权威医学指南进行验证。该方法显著提升了医学长问答的准确性和可解释性：整体回答质量提升40%，幻觉检测率达50%，并能追溯每个事实的来源。医学专家评估和自动化测试均证实其有效性。该研究为LLMs在临床应用的可靠性迈出关键一步，通过提供透明解释，解决了医疗AI当前的主要缺陷，增强了AI辅助医疗的可信度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T15:02:03Z
- **目录日期**: 2025-06-02
