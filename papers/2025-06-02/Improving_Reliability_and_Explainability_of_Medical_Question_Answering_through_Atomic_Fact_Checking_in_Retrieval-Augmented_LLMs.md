...
该研究提出了一种新型原子事实核查框架，用于提升大语言模型(LLM)在医学长问答中的可靠性和可解释性。该方法将LLM生成的回答分解为可独立验证的"原子事实"，并对照权威医学指南知识库进行验证，实现精准纠错和文献溯源。经医学专家评估和开放问答基准测试，该框架使答案整体质量提升40%，幻觉检测率达50%，显著提高了事实准确性和可解释性。通过将每个原子事实与知识库中最相关片段关联，提供了细粒度的解释，解决了当前医学AI应用的关键缺陷，为LLM的临床可信应用迈出重要一步。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T14:02:03Z
- **目录日期**: 2025-06-02
