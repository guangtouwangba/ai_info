...
本研究提出了一种新型原子事实核查框架，用于提升医疗长问答中大型语言模型(LLMs)的可靠性和可解释性。该方法将LLM生成的回答分解为可独立验证的"原子事实"，并对照权威医学指南知识库进行验证，实现错误针对性修正和文献溯源。经医学专家评估和开放问答基准测试显示，该方法使答案整体质量提升40%，幻觉检测率达50%，显著提高了事实准确性和可解释性。通过将每个原子事实与数据库中最相关段落关联，提供了细粒度的响应解释，为LLMs在临床医疗中的可信应用迈出了关键一步。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T11:02:02Z
- **目录日期**: 2025-06-02
