...
本研究提出了一种新型原子事实核查框架，用于提升医疗长文本问答中大型语言模型(LLMs)的可靠性和可解释性。该方法将LLM生成的回答分解为可独立验证的原子事实单元，对照权威医学指南知识库进行验证，实现错误精准修正和文献溯源。经医学专家评估和开放问答基准测试，该框架使回答整体质量提升40%，幻觉检测率达50%，并能追溯每个原子事实到数据库中最相关的文献片段，提供细粒度的解释。这一突破性进展为LLMs在临床中的可信应用迈出关键一步，有助于推动AI辅助医疗的发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T12:01:55Z
- **目录日期**: 2025-06-02
