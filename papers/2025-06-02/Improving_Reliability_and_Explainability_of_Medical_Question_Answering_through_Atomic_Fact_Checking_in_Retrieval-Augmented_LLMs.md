...
大型语言模型(LLMs)在医学领域展现出广泛知识，但存在幻觉和错误引用问题。研究者提出新型原子事实核查框架，将LLM生成的回答分解为可独立验证的"原子事实"，对照权威医学指南进行验证。该方法显著提升了医学长问答的准确性和可解释性：整体回答质量提升40%，幻觉检测率达50%，并能追溯每个事实的文献来源。通过医学专家评估和自动问答基准测试，证明该方法有效解决了当前医学AI应用中关键的可信度问题，为LLMs在临床中的可靠应用迈出重要一步。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T23:01:41Z
- **目录日期**: 2025-06-02
