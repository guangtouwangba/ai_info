...
大型语言模型(LLMs)在医学领域展现出广泛知识，但存在幻觉和错误引用问题。研究者提出了一种原子事实核查框架，将LLM生成的回答分解为可独立验证的"原子事实"，并对照权威医学指南进行验证。该方法显著提高了医学长问答的准确性和可解释性：整体回答质量提升40%，幻觉检测率达50%。每个原子事实都能溯源至数据库中最相关的医学文献片段，提供了透明解释。这项研究是推动LLMs在临床应用中更可信可靠的关键一步，有助于增强AI辅助医疗的可信度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T17:03:09Z
- **目录日期**: 2025-06-02
