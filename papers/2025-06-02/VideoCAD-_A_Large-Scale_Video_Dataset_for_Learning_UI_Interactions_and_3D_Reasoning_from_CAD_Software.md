...
本文介绍了VideoCAD，首个面向专业工程工具的大规模合成数据集，包含41K+标注视频记录，捕捉CAD操作的高保真UI交互。相比现有数据集，VideoCAD在复杂度和时间跨度上提升显著（长达20倍），支持真实工程任务的UI交互学习。研究提出VideoCADFormer模型，在视频学习CAD交互中表现优异，并构建了评估多模态大语言模型空间推理能力的VQA基准。该工作揭示了当前视频UI理解的关键挑战：精确动作定位、多模态空间推理和长时依赖关系，为专业3D CAD工具的AI交互学习开辟了新方向。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T15:01:48Z
- **目录日期**: 2025-06-02
