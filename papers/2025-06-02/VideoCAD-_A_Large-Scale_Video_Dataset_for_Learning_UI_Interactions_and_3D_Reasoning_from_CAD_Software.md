...
本文介绍了VideoCAD，首个面向工程UI交互学习的大规模合成数据集，包含41K+标注的CAD操作视频，复杂度远超现有数据集。针对专业3D CAD工具，研究提出了VideoCADFormer模型，在视频学习UI交互方面表现优异，并建立了评估多模态大模型空间推理能力的VQA基准。研究揭示了当前视频UI理解的关键挑战，包括精确动作定位、多模态空间推理和长时依赖处理。该工作填补了AI在专业工程工具应用中的空白，为复杂UI交互学习提供了新基准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T19:01:39Z
- **目录日期**: 2025-06-02
