...
本文介绍了VideoCAD，首个针对专业CAD工具的大规模合成数据集，包含41K+带标注的CAD操作视频，其交互复杂度比现有数据集高一个数量级，时间跨度长达20倍。研究提出了VideoCADFormer模型，在从视频学习CAD交互方面表现优于基线方法，并构建了评估多模态大语言模型空间推理能力的VQA基准。该工作揭示了视频UI理解的关键挑战：需要精确动作定位、多模态空间推理和长时程依赖处理。数据集和模型为工程UI交互学习开辟了新方向，填补了专业工具AI研究的空白。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T08:01:51Z
- **目录日期**: 2025-06-02
