...
研究人员开发了首个针对专业CAD工具的大规模视频数据集VideoCAD，包含41,000多个标注视频，记录CAD操作过程。相比现有数据集，VideoCAD的交互复杂度高出1个数量级，时间跨度长达20倍。团队提出了VideoCADFormer模型，在从视频学习CAD交互方面表现优异。该数据集还支持视觉问答基准测试，用于评估多模态大语言模型的空间推理和视频理解能力。研究揭示了当前视频UI理解面临的关键挑战：需要精确动作定位、多模态空间推理和长时依赖处理。这项工作为工程UI交互学习开辟了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T07:02:17Z
- **目录日期**: 2025-06-02
