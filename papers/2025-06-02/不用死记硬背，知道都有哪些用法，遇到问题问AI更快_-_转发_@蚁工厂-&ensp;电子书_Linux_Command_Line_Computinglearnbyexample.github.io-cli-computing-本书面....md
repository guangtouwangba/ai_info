...
《Linux Command Line Computing》是一本面向初至中级用户的免费在线阅读电子书，重点讲解Linux命令行工具与Shell脚本编程。核心内容涵盖文件管理和文本处理任务，包含大量示例和练习，但不涉及系统管理等高级主题。该书提供收费PDF版本。由@蚁工厂分享，适合想提升命令行技能的学习者使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T04:09:11Z
- **目录日期**: 2025-06-02
