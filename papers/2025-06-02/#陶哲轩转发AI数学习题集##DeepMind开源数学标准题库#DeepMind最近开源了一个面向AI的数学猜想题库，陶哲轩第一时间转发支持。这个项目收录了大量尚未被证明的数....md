...
DeepMind开源了一个用Lean语言形式化的数学猜想题库，旨在为AI训练、数学家协作和自动定理证明提供基础设施。该题库包含未证明的猜想，可帮助AI理解数学问题并辅助研究。陶哲轩支持这一项目，认为这是AI协助解决数学难题的重要一步。DeepMind鼓励社区贡献新猜想，并计划结合其AI证明系统AlphaProof，实现AI自主"找题+解题"。项目地址：github.com/google-deepmind/formal-conjectures。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T00:03:58Z
- **目录日期**: 2025-06-02
