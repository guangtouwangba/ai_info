...
DeepMind开源了一个用Lean语言形式化的数学猜想题库，旨在为AI提供训练数据、为数学家搭建协作平台。该项目收录了未证明的数学猜想，通过形式化处理使问题可编程验证。陶哲轩转发支持，并指出这是AI辅助数学研究的重要一步。未来DeepMind计划结合其AI证明系统AlphaProof，实现"找题+解题"的自动化流程。该项目鼓励社区贡献新猜想，目前已在GitHub开放协作。这一基础设施有望推动AI参与数学定理发现，开启人机协作的数学研究新模式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T02:36:18Z
- **目录日期**: 2025-06-02
