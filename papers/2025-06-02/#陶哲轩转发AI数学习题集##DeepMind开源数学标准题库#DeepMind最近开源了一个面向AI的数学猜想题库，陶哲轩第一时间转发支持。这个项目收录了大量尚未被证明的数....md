...
DeepMind开源了一个AI数学猜想题库，收录了未证明的数学猜想并用Lean语言形式化处理。著名数学家陶哲轩转发支持，指出这是AI辅助数学研究的重要一步。该题库具有三重价值：1)作为AI训练的标准数据集；2)成为数学家协作平台；3)构建未来AI数学研究的基础设施。项目采用开源模式，鼓励社区贡献新猜想。DeepMind计划结合其AlphaProof系统，实现AI自主"找题+解题"的闭环。这标志着AI从验证数学证明向发现新定理迈出了关键一步。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-06-02T01:31:47Z
- **目录日期**: 2025-06-02
