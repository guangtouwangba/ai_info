...
本文提出了一种加权广义共形测试鞅(WCTM)方法，用于AI/ML系统部署后的持续监控。该方法扩展了现有非参数变化点检测技术的应用范围，能够在线监控数据分布中的任何异常变化点，同时控制误报率。针对实际应用，研究者开发了特定WCTM算法，可适应轻微的协变量偏移，并对严重的概念漂移或极端协变量偏移发出警报。实验表明，该方法在真实数据集上的性能优于现有最优基线。这一研究为高风险场景下AI系统的可靠监控提供了理论基础和实用工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T02:30:06Z
- **目录日期**: 2025-05-09
