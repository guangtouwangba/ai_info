...
本文提出了一种加权广义共形测试鞅(WCTM)方法，用于高风险AI/ML系统的持续监控。该方法突破了现有非参数变点检测技术的限制，能够在线监测数据分布的任何异常变化并控制误报率。针对实际应用，研究者开发了特定算法，可适应轻度协变量偏移，同时对严重偏移(如概念漂移或极端协变量偏移)发出警报。实验表明，相比现有最优方法，WCTM在真实数据集上表现更优，为AI系统部署后的安全监控提供了更强大的理论框架和实用工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T00:01:27Z
- **目录日期**: 2025-05-09
