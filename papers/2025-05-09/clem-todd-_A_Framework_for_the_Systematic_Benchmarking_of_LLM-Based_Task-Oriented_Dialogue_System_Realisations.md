...
本文提出了clem todd框架，用于在统一条件下系统评估任务型对话系统。该框架支持灵活集成不同用户模拟器和对话系统（包括现有或新开发模型），确保使用一致的数据集、评估指标和计算约束。通过重新评估现有系统并整合三个新系统，研究揭示了架构、模型规模和提示策略对对话性能的影响，为构建高效对话AI提供了实用指导。clem todd解决了现有研究中评估孤立、结论泛化性不足的问题，实现了多组合场景下的标准化基准测试。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T08:01:42Z
- **目录日期**: 2025-05-09
