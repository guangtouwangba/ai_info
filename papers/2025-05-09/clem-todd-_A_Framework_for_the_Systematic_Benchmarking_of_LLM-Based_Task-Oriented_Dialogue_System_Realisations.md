...
本文介绍了clem todd框架，旨在统一评估任务导向对话系统中的用户模拟器和对话代理。现有研究常孤立评估单一组件，限制了跨架构和配置的通用性。clem todd支持灵活集成现有或新开发的模型，确保数据集、评估指标和计算条件一致。通过该框架，作者重新评估了现有系统并整合了三个新系统，分析了架构、规模和提示策略对对话性能的影响，为构建高效对话AI提供了实用指导。该框架促进了对话系统组件的系统性比较研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T22:01:31Z
- **目录日期**: 2025-05-09
