...
开源文本生成图像(TTI)技术因个性化适配器的发展而普及，但也助长了非自愿深度伪造和性别歧视内容等滥用行为。本研究分析了最大开源TTI平台CivitAI的4000万用户生成图像和23万模型数据，发现平台存在大量不适合工作场所(NSFW)内容和模仿真实人物的模型，且互联网亚文化深刻影响着模型个性化实践。研究从女权主义和建构主义视角探讨了剥削性视觉内容的成因，指出平台设计和社区动态的影响。最后提出改进内容审核、工具设计和平台政策等干预措施，以促进责任意识和知情同意。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T04:02:09Z
- **目录日期**: 2025-05-09
