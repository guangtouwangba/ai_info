...
本文提出了一种改进人机协作机器人部署的方法，通过扩散策略主动在必要时寻求人类协助，减少对持续人工监控的依赖。该方法利用扩散策略的生成过程计算基于不确定性的指标，使自主代理能在部署时决定何时请求操作员协助，且训练阶段无需人工交互。同时，该方法还能高效收集数据以微调扩散策略，提升自主性能。模拟和真实环境实验表明，该方法能有效提高各种场景下的策略性能。研究解决了大规模机器人部署时人工监控劳动强度高的问题，为半自主系统提供了实用解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T15:02:28Z
- **目录日期**: 2025-05-09
