...
本文提出了一种基于扩散策略的人机协同机器人部署方法，通过计算不确定性指标让机器人仅在必要时主动寻求人类协助，减少持续人工监控的需求。该方法利用扩散策略的生成过程，在部署时（而非训练时）决定何时请求操作员干预，同时也可用于高效收集数据以微调策略。实验表明，该方法能有效提升各类场景下的策略性能，平衡自主运行与人工干预，适用于大规模机器人部署。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T14:02:25Z
- **目录日期**: 2025-05-09
