...
本文提出了一种基于扩散策略的人机协同机器人部署方法，通过计算不确定性指标让机器人仅在必要时主动寻求人工协助，减少持续人工监控的需求。该方法利用扩散策略的生成过程，在部署时动态判断是否需要人工干预，且无需训练阶段的人工参与。同时，该方法还能用于高效收集数据以优化扩散策略的自主性能。仿真和真实环境实验表明，该方法能有效提升多种场景下的策略性能，实现更高效的半自主机器人部署。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T12:02:32Z
- **目录日期**: 2025-05-09
