...
本文提出了一种基于扩散策略的人机协作方法，旨在减少机器人部署时对人类持续监控的依赖。该方法利用扩散策略的生成过程计算不确定性指标，仅在必要时主动寻求人类协助，无需训练阶段的人工干预。同时，该方法还能高效收集数据以优化扩散策略，提升自主性能。模拟和真实环境实验表明，该方法能有效提高多种场景下的策略表现，平衡自主性与人工干预需求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T09:02:32Z
- **目录日期**: 2025-05-09
