...
本文提出了一种基于扩散策略（diffusion policies）的人机协作方法，通过计算不确定性指标让机器人仅在必要时主动寻求人类协助，减少对持续人工监控的依赖。该方法无需训练阶段的人工干预，并可用于高效收集数据以优化策略。实验表明，该方法能有效提升机器人在模拟和真实场景中的部署表现，同时降低人工干预频率，适用于大规模机器人部署。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T20:02:29Z
- **目录日期**: 2025-05-09
