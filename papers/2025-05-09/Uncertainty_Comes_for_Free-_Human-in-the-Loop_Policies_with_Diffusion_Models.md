...
本文提出了一种基于扩散策略（diffusion policies）的人机协作方法，通过计算不确定性指标让机器人仅在必要时主动寻求人类协助，从而减少对持续人工监控的依赖。该方法无需训练阶段的人工干预，且能用于高效收集数据以微调策略，提升自主性能。实验表明，该方法在模拟和真实场景中均能有效提高策略表现，适用于大规模机器人部署。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T08:02:37Z
- **目录日期**: 2025-05-09
