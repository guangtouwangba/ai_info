...
Figma推出新功能"Sites"，实现一站式网站搭建，让设计师无需前端知识即可独立完成建站。主要特点包括：设计稿直接转为响应式网页；提供预设模块快速构建页面；一键添加交互动效；未来将支持AI代码优化。该功能配合Auto Layout和文本组件，大幅简化建站流程，并提供多种模板支持活动页、作品集等场景。目前已在官网开放体验，显著降低了设计师独立建站的门槛。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T00:03:59Z
- **目录日期**: 2025-05-09
