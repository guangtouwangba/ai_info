# #全球最大AI计算机投入使用##马斯克超级计算机全面投用#全球最大的AI超级计算机集群——马斯克的超超超级计算机Colossus，历经122天建设，现已投入使用！据Tom's...
...
马斯克的xAI公司建成全球最大AI超级计算机Colossus，目前已投入20万颗GPU（计划扩展至100万颗）。该设施首期耗电150兆瓦（最终或达300兆瓦），使用35台天然气发电机（422兆瓦）和特斯拉储能电池供电，引发环保争议——年排放2000吨氮氧化物，遭居民投诉污染空气。xAI计划在孟菲斯建第二数据中心（需1.1吉瓦电力），面临电网承载力、水资源消耗等挑战。环保组织批评其利用监管漏洞危害公共健康。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T02:31:41Z
- **目录日期**: 2025-05-09
