...
阿里巴巴通义实验室提出ZeroSearch强化学习框架，使大语言模型(LLM)无需依赖真实搜索引擎即可提升搜索能力。该方法通过轻量级监督微调(SFT)和渐进式课程学习策略，让LLM自身生成训练所需的查询-文档对，并逐步增加噪声文档比例提升鲁棒性。实验显示，70亿参数模型性能媲美真实搜索引擎，140亿参数模型甚至实现超越，在多个基准测试中优于传统方法。该方案解决了文档质量不可控和API成本高的问题，兼容多种强化学习算法，具有良好泛化性。论文及项目已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T03:20:00Z
- **目录日期**: 2025-05-09
