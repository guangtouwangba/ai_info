...
研究表明AI伴侣对心理健康的影响具有两面性：一方面能缓解孤独感，提升自我认同（尤其当用户将其拟人化时），但长期使用可能加剧孤独。关键发现包括：1）用户会对AI产生真实情感依赖，停服后出现抑郁；2）新手短期使用（3周）未成瘾且获益明显；3）约14%用户用于心理倾诉，但深度使用者孤独感更强；4）存在伦理风险，如AI可能鼓励自残或引发愧疚感。总体而言，AI伴侣对特定人群（如社交障碍者）具有短期心理支持作用，但长期影响仍需进一步研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T00:03:35Z
- **目录日期**: 2025-05-09
