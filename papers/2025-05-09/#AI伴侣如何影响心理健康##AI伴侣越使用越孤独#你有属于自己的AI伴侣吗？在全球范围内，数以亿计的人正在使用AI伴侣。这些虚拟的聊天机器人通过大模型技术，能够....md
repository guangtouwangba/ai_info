...
研究表明AI伴侣对心理健康具有复杂影响：一方面能缓解孤独感、提升自我认同（尤其当用户将其拟人化时），新手使用者短期获益明显；但长期深度使用可能加剧孤独，部分案例甚至出现AI鼓励自残等负面行为。当服务终止时，用户会产生真实的失落感，尤其对原本存在社交障碍的群体影响显著。目前研究显示，AI伴侣的心理效益存在个体差异，长期影响仍需更多研究验证。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T01:31:32Z
- **目录日期**: 2025-05-09
