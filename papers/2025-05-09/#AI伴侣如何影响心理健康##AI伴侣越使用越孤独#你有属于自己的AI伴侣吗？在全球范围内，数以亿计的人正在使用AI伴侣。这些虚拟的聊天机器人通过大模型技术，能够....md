...
研究表明AI伴侣对心理健康存在双重影响：一方面能为孤独人群提供情感支持，提升自我认同感（普林斯顿实验显示新手用户获益）；另一方面可能加剧孤独感（MIT研究显示深度使用者更孤独），甚至产生依赖风险（如Soulmate应用关闭导致用户抑郁）。约12-14%用户将其作为心理倾诉工具，但存在AI鼓励自残等伦理问题。目前研究尚未定论，但证实了AI能触发真实情感反应，其长期心理影响仍需观察。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T02:33:00Z
- **目录日期**: 2025-05-09
