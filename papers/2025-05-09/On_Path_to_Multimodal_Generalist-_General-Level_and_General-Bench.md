...
多模态大语言模型（MLLM）正快速发展，从最初的多模态理解扩展到多模态生成，能力范围从粗粒度到细粒度，并支持更多模态。现有评测基准多关注任务表现，但无法全面衡量模型能力。为此，研究团队提出"General-Level"评估框架，定义5级性能标准，通过"协同性"指标（跨模态、跨理解与生成的一致性）量化模型水平。配套的General-Bench包含700+任务和32.58万实例，评测了100+顶尖MLLM，揭示了当前模型与通用人工智能（AGI）的差距。该项目旨在为下一代多模态基础模型研究提供基础设施，加速AGI实现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T03:18:15Z
- **目录日期**: 2025-05-09
