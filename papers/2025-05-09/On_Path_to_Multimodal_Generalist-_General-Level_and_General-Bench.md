...
多模态大语言模型(MLLM)正快速发展，从最初仅能理解多模态数据，进化到能跨模态理解和生成内容。研究团队提出"General-Level"评估框架，定义了MLLM的5级性能标准，并引入"Synergy"概念来衡量模型在理解与生成、跨模态方面的协同能力。配套的General-Bench评估集涵盖700多项任务、32.5万实例，对100多个先进MLLM进行评估，揭示了当前模型与真正通用人工智能(AGI)的差距。该项目为下一代多模态基础模型研究奠定了基础，旨在加速AGI的实现。项目页面：https://generalist.top/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T01:28:41Z
- **目录日期**: 2025-05-09
