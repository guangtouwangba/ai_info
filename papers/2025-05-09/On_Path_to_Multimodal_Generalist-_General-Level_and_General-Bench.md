...
多模态大语言模型（MLLM）正快速发展，从最初仅理解多模态数据，逐步演变为能跨模态生成内容的通用模型。然而，现有评估方法难以衡量其是否接近人类水平AI。为此，研究团队提出"General-Level"评估框架，定义了5级性能标准，并引入"协同性"概念，检验模型在理解、生成及跨模态任务中的一致性。配套的General-Bench包含700多项任务和32.5万实例，评估了100多个先进MLLM，揭示了当前模型与真正AI的差距。该项目为下一代多模态基础模型研究提供了基础设施，推动AGI实现。项目页面：https://generalist.top/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T02:29:55Z
- **目录日期**: 2025-05-09
