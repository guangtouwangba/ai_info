...
研究表明，AI生成的多模态反馈（结合文本和幻灯片）能有效提升学习效果，但不同反馈方式（人工/AI、有无幻灯片）的学习增益差异不显著。91名参与者的实验显示，学生认为幻灯片辅助反馈有帮助但理解存在困难，AI文本反馈虽具个性化和相关性，但其可信度低于人工反馈。该研究验证了多媒体学习原则，表明多模态反馈能降低认知负荷，但需优化AI反馈的可理解性与可信度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T04:02:27Z
- **目录日期**: 2025-05-09
