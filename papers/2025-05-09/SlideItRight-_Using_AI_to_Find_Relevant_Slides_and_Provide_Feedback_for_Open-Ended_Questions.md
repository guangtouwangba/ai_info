...
研究表明，人工智能（AI）结合多模态反馈（如文本+幻灯片）能支持学生学习。通过91人的实验对比人工反馈与AI反馈（含/不含相关幻灯片），发现所有组别均有显著学习提升，但组间差异不显著。学生认为幻灯片辅助有助于学习，但理解存在困难；AI生成的文本反馈被认为个性化和相关，但信任度低于人工反馈。该研究验证了多模态反馈的潜力，但揭示了AI反馈在可信度和信息呈现清晰度上的改进空间。研究采用大语言模型（LLMs）生成文本反馈，并辅以相关幻灯片作为补充指导。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T03:18:58Z
- **目录日期**: 2025-05-09
