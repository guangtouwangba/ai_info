...
研究表明，AI辅助的多模态反馈（结合文本和幻灯片）能提升学习效果，但不同反馈方式（AI vs. 人工，有无幻灯片）的学习增益差异不显著。91名参与者的实验显示，学生认为幻灯片反馈有帮助但理解存在困难，AI生成的文本反馈虽具个性化和相关性，但信任度低于人工反馈。该研究验证了大型语言模型在多模态反馈中的潜力，同时指出需优化幻灯片呈现方式并提高AI反馈的可信度。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T01:29:24Z
- **目录日期**: 2025-05-09
