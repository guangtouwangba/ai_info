...
这篇摘要警告AI发展可能带来灾难性风险，包括失控、恶意滥用、大国冲突和威权垄断。作者提出四项应对方案：1)建立国际管控机制（首选方案）；2)美国主导的单边开发；3)维持现状；4)通过破坏延缓发展。除国际管控方案外，其他路径都可能造成不可接受的风险。研究呼吁美国国安部门和AI治理体系紧急行动，解答关键问题，建立叫停危险AI的能力，并为国际协议做准备。核心观点是必须通过技术、法律和制度手段限制危险AI的发展部署，否则人类可能面临灭绝威胁。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T00:01:44Z
- **目录日期**: 2025-05-09
