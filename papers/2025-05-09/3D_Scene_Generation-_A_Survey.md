...
3D场景生成技术旨在创建结构化、语义丰富且逼真的虚拟环境，应用于沉浸式媒体、机器人、自动驾驶和具身AI等领域。早期基于规则的方法可扩展但多样性有限，而当前深度生成模型（如GAN、扩散模型）和3D表示（如NeRF、3D高斯）显著提升了真实性、多样性和视角一致性。该综述将方法分为四类：程序化生成、神经3D生成、图像生成和视频生成，分析其技术基础、优缺点及评估标准，并指出未来方向包括更高保真度、物理交互和感知-生成统一模型。项目动态详见GitHub页面。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T16:01:05Z
- **目录日期**: 2025-05-09
