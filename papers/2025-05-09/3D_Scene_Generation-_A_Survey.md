...
3D场景生成技术通过合成空间结构化、语义丰富且逼真的环境，广泛应用于沉浸式媒体、机器人等领域。早期基于规则的方法可扩展但多样性不足。近年来，基于深度生成模型（如GAN、扩散模型）和3D表示（如NeRF、3D高斯）的方法显著提升了真实感、多样性和视角一致性。最新研究将扩散模型引入3D合成，通过图像或视频生成框架实现突破。本文系统梳理了四大技术范式（程序化生成、神经3D生成、图像/视频生成），分析其优劣、数据集及评估方法，并展望了高保真、物理交互等未来方向。项目页面持续更新进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T05:01:08Z
- **目录日期**: 2025-05-09
