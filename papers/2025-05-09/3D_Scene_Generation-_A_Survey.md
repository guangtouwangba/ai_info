...
3D场景生成技术旨在创建空间结构化、语义丰富且逼真的环境，应用于沉浸式媒体、机器人、自动驾驶和具身AI等领域。早期基于规则的方法可扩展但多样性有限。近年来，深度生成模型（如GAN、扩散模型）和3D表示（如NeRF、3D高斯）通过学习真实场景分布，提升了保真度、多样性和视角一致性。扩散模型通过图像或视频合成方式进一步推动了3D场景生成与真实感的结合。本文综述了四大范式：程序化生成、神经3D生成、图像生成和视频生成，分析了技术基础、优缺点及挑战，并展望了高保真、物理感知和统一感知生成等方向。项目页面持续更新进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T23:00:51Z
- **目录日期**: 2025-05-09
