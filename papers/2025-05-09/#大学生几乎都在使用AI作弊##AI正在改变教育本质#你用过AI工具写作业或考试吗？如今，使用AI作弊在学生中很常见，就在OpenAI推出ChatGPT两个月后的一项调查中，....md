...
当前大学生使用AI作弊现象普遍，约90%学生用ChatGPT完成作业。常见方式包括AI生成论文/代码、参与在线讨论等。教师采取蓝皮书考试、AI检测工具等应对措施，但效果有限。这反映出教育体系面临根本挑战：AI作弊不仅破坏学术诚信，更暴露了教育功利化、学习交易化等问题。专家指出，单纯惩罚难以解决问题，需系统性教育改革以适应AI时代。该现象正在重塑教育本质，其长期影响仍需观察。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T01:30:39Z
- **目录日期**: 2025-05-09
