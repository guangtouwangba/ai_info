...
该报道指出，AI作弊在大学生中已成普遍现象，近90%学生使用ChatGPT等工具完成作业、论文甚至编程任务。教师通过调整考试形式、使用检测工具等方式应对，但效果有限。AI作弊不仅破坏学术诚信，更反映出教育体系的结构性问题——功利化学习削弱了学生的基础能力，传统教育模式面临根本性质疑。专家认为，单纯惩罚难以解决问题，教育系统需全面改革以适应AI时代的学习需求。这一现象正在深刻改变教育的本质。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T04:04:24Z
- **目录日期**: 2025-05-09
