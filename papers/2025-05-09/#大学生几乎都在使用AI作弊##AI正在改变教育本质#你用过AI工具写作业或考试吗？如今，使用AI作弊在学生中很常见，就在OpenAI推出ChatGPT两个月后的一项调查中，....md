# #大学生几乎都在使用AI作弊##AI正在改变教育本质#你用过AI工具写作业或考试吗？如今，使用AI作弊在学生中很常见，就在OpenAI推出ChatGPT两个月后的一项调查中，...
...
当前大学生使用AI作弊现象普遍，约90%学生用ChatGPT等工具完成作业、论文甚至编程任务。教师采取蓝皮书考试、AI检测工具等应对措施，但效果有限。AI作弊不仅破坏学术诚信，更暴露教育体系问题：高成本、功利化倾向导致学习交易化。教育工作者担忧过度依赖AI会削弱学生基础能力。专家指出，单纯惩罚治标不治本，需系统性教育改革，重新思考评估方式与学习本质。这一现象反映出传统教育模式与数字时代的深刻冲突。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T03:21:07Z
- **目录日期**: 2025-05-09
