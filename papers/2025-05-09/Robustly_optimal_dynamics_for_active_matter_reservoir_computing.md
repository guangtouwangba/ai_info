...
该研究探讨了活性物质在储层计算（RC）范式中的信息处理能力，通过模拟系统预测混沌信号的未来状态。研究发现了一个此前被忽视的优越动力学区域，该区域在不同物理参数和推断任务中均表现出稳健的最优性能。系统信息处理能力主要取决于其内在弛豫特性，最佳计算状态位于临界阻尼阈值下方，涉及多阶段的微观动力学弛豫。最优系统在混沌外部驱动下具有适应性，表现为准稳态与高度非线性动态间的快速切换。相关动力学特征可标识最优性能区域，为多体非平衡物理提供了新的计算视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T07:02:14Z
- **目录日期**: 2025-05-09
