...
该研究探讨了活性物质在储层计算（RC）范式中的信息处理能力，通过模拟受外部驱动的模型预测混沌信号。研究发现了一种此前被忽视的优越动力学机制，该机制在不同物理参数和推断任务中均表现稳健，揭示了物理系统计算与推断的深层原理。系统信息处理效率主要由其本征弛豫能力决定，最优计算状态位于临界阻尼阈值之下，表现为多阶段微观弛豫。在混沌驱动下，系统通过准静态与高度非线性状态的快速切换实现适应。相关动力学特征可标识最优性能区间，为多体非平衡系统的非传统计算提供了物理解释框架。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T22:01:57Z
- **目录日期**: 2025-05-09
