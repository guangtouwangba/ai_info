...
本研究探讨了活性物质在储层计算（RC）范式中的信息处理能力，通过模拟外部驱动的混沌信号预测模型，发现了一个此前被忽视的优异动力学机制。该机制在多种物理参数和推断任务中均表现出鲁棒的最优性，其信息处理效能主要由系统的本征弛豫能力决定。最优计算状态位于临界阻尼阈值之下，呈现多阶段微观弛豫特性，并因准静态与高度非线性动态的快速切换而具备混沌驱动适应性。相干与非相干动力学在不同时空尺度共同作用，而粒子动态相关性可标识最优性能区间。该模型为多体非平衡系统的非传统计算提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T10:02:20Z
- **目录日期**: 2025-05-09
