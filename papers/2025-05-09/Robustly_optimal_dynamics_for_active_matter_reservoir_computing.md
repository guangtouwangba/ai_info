...
这项研究探讨了活性物质在储层计算（RC）范式中的信息处理能力，通过模拟外部驱动的混沌信号预测模型，发现了一个此前被忽视的卓越动力学机制。该机制在多种物理参数和推断任务中均表现出稳健的最优性，揭示了物理系统计算与推断的核心特征：信息处理效能主要由系统内在弛豫能力决定。最优计算状态位于临界阻尼阈值之下，表现为多阶段微观弛豫动力学，其适应性源于准静态与高度非线性态间的快速切换。相关动力学特征可标识最优性能区间，为理解非平衡多体物理中的非传统计算提供了新视角。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T23:01:53Z
- **目录日期**: 2025-05-09
