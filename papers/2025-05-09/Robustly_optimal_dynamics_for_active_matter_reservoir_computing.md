...
该研究探讨了活性物质在储层计算（RC）范式中的信息处理能力，通过模拟外部驱动的混沌信号预测模型，发现了一个此前被忽视的优异动力学机制。这一机制在多种物理参数和推断任务中均表现出鲁棒性优势，其计算效能主要取决于系统的本征弛豫能力。最优计算状态位于临界阻尼阈值以下，呈现多阶段微观弛豫特性，并通过准静态与高度非线性动态的快速切换适应混沌驱动。相干与非相干动力学共同作用，且不同时空尺度的动力学相关性可标识最优性能区间。该模型为多体非平衡系统的非传统计算提供了物理解释框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T15:02:08Z
- **目录日期**: 2025-05-09
