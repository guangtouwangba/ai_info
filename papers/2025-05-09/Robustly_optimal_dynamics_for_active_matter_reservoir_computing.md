...
该研究探讨了活性物质在储层计算（RC）范式中的信息处理能力，通过外部驱动模型预测混沌信号的未来状态。研究发现了一种此前被忽视的优越动力学机制，该机制在不同物理参数和推断任务中均表现出稳健的最优性。最优计算状态位于临界阻尼阈值以下，涉及多阶段的微观动力学弛豫过程，并展现出准静态与高度非线性动态之间的快速切换。系统的内在弛豫能力是信息处理的关键，其性能可通过粒子动态相关性表征。这一物理可解释的模型为多体非平衡系统中的非常规计算提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T13:09:47Z
- **目录日期**: 2025-05-09
