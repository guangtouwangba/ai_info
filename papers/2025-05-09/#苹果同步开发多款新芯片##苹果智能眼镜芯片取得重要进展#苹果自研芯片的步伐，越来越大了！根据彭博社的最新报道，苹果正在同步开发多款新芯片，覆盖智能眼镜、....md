...
苹果正同步开发多款自研芯片，覆盖智能眼镜、Mac和AI服务器三大领域。智能眼镜专用处理器基于Apple Watch芯片优化，能效突出，计划2026年底量产。同时研发代号"Nevis"和"Glennie"的穿戴设备芯片，将为AirPods/Apple Watch加入摄像头和AI功能。Mac产品线开发M6/M7系列芯片，AI服务器芯片"Baltra"核心数或达M3 Ultra的8倍。调制解调器方面，继iPhone 16e的C1芯片后，将推出C2/C3升级版本。这些进展显示苹果正加速芯片自主化布局。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T21:03:38Z
- **目录日期**: 2025-05-09
