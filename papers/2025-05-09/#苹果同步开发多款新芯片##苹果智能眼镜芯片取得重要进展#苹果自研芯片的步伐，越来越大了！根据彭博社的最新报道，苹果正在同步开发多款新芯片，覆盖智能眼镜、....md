...
苹果正在同步开发多款自研芯片，覆盖智能眼镜、Mac及AI服务器等领域。其中，基于Apple Watch芯片优化的智能眼镜处理器已取得重要进展，预计2026年底量产，配套眼镜或2028年面世。此外，苹果计划为AirPods和Apple Watch研发带摄像头的AI芯片（代号Nevis/Glennie），开发M6/M7系列Mac芯片，并与博通合作AI服务器芯片（Baltra）。调制解调器方面，继iPhone 16e的C1芯片后，将推出C2/C3升级版本。这些进展显示苹果正加速芯片自主化布局。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T17:03:39Z
- **目录日期**: 2025-05-09
