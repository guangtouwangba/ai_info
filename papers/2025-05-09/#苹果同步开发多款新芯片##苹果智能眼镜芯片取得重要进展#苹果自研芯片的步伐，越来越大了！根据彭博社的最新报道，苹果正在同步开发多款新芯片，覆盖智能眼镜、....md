...
苹果正同步开发多款自研芯片，覆盖智能眼镜、Mac和AI服务器三大领域。其中智能眼镜芯片基于Apple Watch芯片优化，能效突出，预计2026年底量产。此外，苹果还研发代号"Nevis"和"Glennie"的穿戴设备芯片，计划为AirPods和Apple Watch加入摄像头功能；开发M6、M7等新一代Mac芯片；与博通合作AI服务器芯片；并推进自研调制解调器芯片迭代。这些进展显示苹果正加速芯片自主化布局，强化产品创新力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T15:03:57Z
- **目录日期**: 2025-05-09
