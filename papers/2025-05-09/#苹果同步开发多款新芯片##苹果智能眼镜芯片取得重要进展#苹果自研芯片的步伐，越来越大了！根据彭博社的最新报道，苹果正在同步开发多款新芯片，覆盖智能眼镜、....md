...
苹果正同步开发多款自研芯片，覆盖智能眼镜、Mac和AI服务器三大领域。其智能眼镜专用芯片基于Apple Watch设计，优化了功耗和摄像头性能，预计2026年底量产。同时，苹果研发代号"Nevis"和"Glennie"的芯片将为AirPods和Apple Watch添加摄像头功能；Mac产品线将推出M6/M7芯片；AI服务器芯片"Baltra"可能配备M3 Ultra处理器8倍核心；调制解调器芯片C1将用于iPhone 16e，后续还有C2/C3版本。这些进展显示苹果正加速芯片自主化布局。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T20:03:55Z
- **目录日期**: 2025-05-09
