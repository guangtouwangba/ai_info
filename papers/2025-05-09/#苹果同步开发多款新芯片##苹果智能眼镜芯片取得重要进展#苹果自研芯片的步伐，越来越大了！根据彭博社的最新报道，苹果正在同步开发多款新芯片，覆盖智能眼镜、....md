...
苹果正同步开发多款自研芯片，覆盖智能眼镜、Mac和AI服务器三大领域。其中智能眼镜专用处理器基于Apple Watch芯片优化，能效突出，计划2026年底量产。同时研发代号"Nevis"和"Glennie"的穿戴设备芯片，将为AirPods和Apple Watch加入摄像头功能；Mac产品线开发M6/M7系列芯片；与博通合作开发AI服务器芯片"Baltra"；并推进自研调制解调器C系列迭代。这些进展显示苹果正加速芯片自主化布局，预计2025-2027年陆续推出新产品。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T19:03:27Z
- **目录日期**: 2025-05-09
