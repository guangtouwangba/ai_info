...
最新研究发现，要求AI"简要回答"会显著增加其产生幻觉的概率。Giskard和DeepMind测试显示，简洁指令会使主流AI模型的错误率上升10%-20%。这种压缩回答空间的做法迫使AI跳过关键推理步骤，默认问题前提正确，导致误导性结论。尤其在医疗、技术等专业领域，简答会遗漏重要限制条件。测试中，GPT-4o、Claude等模型在简答模式下准确率均下降，轻量级模型受影响更严重。研究建议开发者应优先保证回答准确性，而非单纯追求回答简洁性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T07:03:05Z
- **目录日期**: 2025-05-09
