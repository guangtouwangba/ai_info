...
AI正在冲击传统搜索市场格局。谷歌4月Safari搜索量首次下降，部分用户转向ChatGPT等AI工具。谷歌广告点击增速降至2%的历史新低，分析师认为AI精准答案可能减少了付费点击需求。目前AI搜索量已占传统引擎的15%。分析师观点分歧：郭明錤认为AI终将威胁谷歌广告，而Jefferies认为谷歌能通过AI功能获利。随着AI直接提供答案，传统搜索的广告模式面临挑战，市场格局正在重塑。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T17:02:43Z
- **目录日期**: 2025-05-09
