...
谷歌搜索业务正面临AI工具的冲击。4月Safari搜索量首次下降，用户转向ChatGPT等AI工具，导致谷歌广告点击增速降至2%的历史新低。分析师对威胁程度看法不一：郭明錤认为AI终将影响广告业务，而Jefferies认为谷歌能通过AI功能获利。目前AI搜索量已占传统引擎的15%，市场格局正在重塑。谷歌回应称总体搜索量仍在增长，但AI直接提供答案的模式正在改变用户习惯，对传统搜索广告模式构成挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T20:02:50Z
- **目录日期**: 2025-05-09
