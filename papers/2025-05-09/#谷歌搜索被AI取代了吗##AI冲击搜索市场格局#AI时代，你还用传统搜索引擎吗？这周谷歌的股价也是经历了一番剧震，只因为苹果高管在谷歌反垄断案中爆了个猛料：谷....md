...
AI工具如ChatGPT正冲击传统搜索引擎市场。谷歌4月Safari搜索量首次下降，广告点击增速创历史新低（仅2%），分析师认为AI精准答案可能减少了付费点击需求。虽然谷歌称整体搜索量仍在增长，但Bernstein估计AI搜索已占传统引擎15%份额。分析师观点分化：郭明錤警告AI将威胁谷歌广告业务，而Jefferies则认为谷歌最终能通过AI功能盈利。市场格局正在重塑，用户可能更倾向直接获取AI答案而非浏览广告页面。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T21:02:39Z
- **目录日期**: 2025-05-09
