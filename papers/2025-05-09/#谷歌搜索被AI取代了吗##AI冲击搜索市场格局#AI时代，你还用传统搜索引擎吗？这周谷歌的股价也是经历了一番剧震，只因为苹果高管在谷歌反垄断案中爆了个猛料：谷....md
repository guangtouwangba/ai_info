...
AI工具正在冲击传统搜索引擎市场。谷歌4月通过Safari的搜索量首次下降，广告点击增速创历史新低（仅2%），分析师认为这与ChatGPT等AI工具兴起有关。虽然谷歌称整体搜索量仍在增长，但数据显示AI搜索已占传统搜索量的15%。分析师观点分歧：郭明錤认为AI终将影响谷歌广告业务，而Jefferies认为谷歌能通过AI功能盈利。核心矛盾在于：当AI能直接给出精准答案，用户可能不再需要点击广告链接的搜索结果页。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T11:02:49Z
- **目录日期**: 2025-05-09
