...
AI正在冲击传统搜索引擎市场。谷歌4月通过Safari的搜索量首次下降，广告点击增速降至2%的历史低点，分析师认为这与ChatGPT等AI工具兴起有关（已占15%搜索量）。尽管谷歌称总体搜索量仍在增长，但市场担忧其主导地位。观点分两派：郭明錤认为AI终将威胁谷歌广告业务；Jefferies则认为谷歌能通过AI功能盈利。核心矛盾在于：当AI能直接给出答案，用户可能减少点击广告链接的意愿，这将重塑搜索市场格局。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T12:02:56Z
- **目录日期**: 2025-05-09
