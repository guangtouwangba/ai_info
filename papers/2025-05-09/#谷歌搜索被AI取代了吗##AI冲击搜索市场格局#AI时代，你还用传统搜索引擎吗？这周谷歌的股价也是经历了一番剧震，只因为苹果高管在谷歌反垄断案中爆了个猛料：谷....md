...
AI正在冲击传统搜索引擎市场。谷歌4月Safari搜索量首次下降，部分用户转向ChatGPT等AI工具。谷歌广告点击增速降至历史新低2%，分析师认为AI精准答案可能减少了付费点击需求。尽管谷歌强调整体搜索量仍在增长，但Bernstein估算AI工具已占搜索市场15%份额。分析师观点分歧：郭明錤认为AI终将影响谷歌广告，而Jefferies相信谷歌能通过AI功能盈利。市场格局正在重塑，AI直接提供答案的能力可能改变用户搜索习惯。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T15:02:50Z
- **目录日期**: 2025-05-09
