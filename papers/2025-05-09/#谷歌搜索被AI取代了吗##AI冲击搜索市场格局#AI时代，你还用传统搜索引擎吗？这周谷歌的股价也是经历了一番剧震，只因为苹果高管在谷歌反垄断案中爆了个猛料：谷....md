...
AI正在冲击传统搜索市场格局。谷歌4月通过Safari的搜索量首次下降，广告点击增速创历史新低（仅2%），分析师认为这与ChatGPT等AI工具兴起有关。目前AI搜索量已占传统搜索的15%。虽然谷歌表示总体搜索量仍在增长，但市场担忧其主导地位受威胁。分析师观点分化：部分认为AI将颠覆搜索广告模式，另一些则相信谷歌能通过AI功能获利。核心矛盾在于：当AI能直接给出精准答案时，用户可能不再需要点击广告链接。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T16:03:00Z
- **目录日期**: 2025-05-09
