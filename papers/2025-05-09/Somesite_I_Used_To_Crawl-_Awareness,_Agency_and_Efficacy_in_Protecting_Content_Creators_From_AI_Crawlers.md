...
这项研究探讨了当前网络工具（如robots.txt和反向代理）在保护内容创作者免受AI爬取方面的效果。通过大规模测量和对203名专业艺术家的调查，研究发现艺术家们强烈需求这类工具，但受限于技术认知不足、部署能力有限以及工具对不响应爬虫的防护效果不佳。虽然反向代理提供的网络级拦截能更有效阻挡AI爬虫，但目前部署较少且存在局限性。研究揭示了在版权、隐私和伦理问题日益突出的背景下，现有防护工具的不足与改进需求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T03:19:40Z
- **目录日期**: 2025-05-09
