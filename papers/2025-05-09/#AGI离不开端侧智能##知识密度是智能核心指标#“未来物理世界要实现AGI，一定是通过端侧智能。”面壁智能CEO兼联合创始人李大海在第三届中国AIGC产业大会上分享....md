...
面壁智能CEO李大海在第三届中国AIGC产业峰会上提出，未来实现通用人工智能（AGI）必须依赖端侧智能，即将智能模型直接部署在终端设备上。他强调"知识密度"是衡量模型智能的核心指标，类比芯片制程的晶体管密度，知识密度越高则智能越强。面壁智能已推出端侧模型MiniCPM，并应用于手机、机器人等设备。李大海认为，只有将"大脑"部署在终端，才能实现灵敏感知和实时决策，最终推动物理世界的AGI发展。该峰会吸引了超千名线下观众和320万线上观众。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T23:03:32Z
- **目录日期**: 2025-05-09
