...
面壁智能CEO李大海在第三届中国AIGC产业峰会上提出，实现物理世界AGI必须依赖端侧智能。他指出大模型的"知识密度"是智能核心指标，类比芯片制程，知识密度越高智能越强。面壁智能已推出端侧模型MiniCPM，应用于手机、机器人等设备，目标是让所有终端具备智能。他强调端侧部署能实现灵敏感知和实时决策，是AGI落地的关键。团队认为高密度的团队组织与资源投入是技术突破的基础。该峰会吸引超千名线下观众及320万线上观看量。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T10:03:52Z
- **目录日期**: 2025-05-09
