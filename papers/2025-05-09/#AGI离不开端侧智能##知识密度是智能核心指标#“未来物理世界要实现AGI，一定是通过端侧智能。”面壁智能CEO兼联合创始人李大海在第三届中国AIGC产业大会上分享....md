...
面壁智能CEO李大海在第三届中国AIGC产业峰会上提出，实现物理世界的AGI必须依赖端侧智能。他认为大模型的"知识密度"是智能的核心指标，类比芯片制程，知识密度越高智能越强。面壁智能已推出端侧模型MiniCPM，并布局手机、机器人、PC等终端设备，目标是让所有设备具备智能。李大海强调，只有将AI部署在终端设备上，才能实现灵敏感知、及时决策和完美应对。其方法论基于团队密度、组织密度和高资源密度的极致优化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T15:04:08Z
- **目录日期**: 2025-05-09
