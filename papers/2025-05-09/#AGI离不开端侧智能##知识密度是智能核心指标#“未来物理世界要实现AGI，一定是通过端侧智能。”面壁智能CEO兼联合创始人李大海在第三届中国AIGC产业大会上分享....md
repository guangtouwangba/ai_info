...
面壁智能CEO李大海在第三届中国AIGC产业大会上提出，实现物理世界AGI必须依靠端侧智能。他认为大模型的"知识密度"是智能核心指标，类比芯片制程密度决定计算能力。面壁智能已推出端侧模型MiniCPM，应用于手机、机器人等设备，目标是让所有终端具备智能。李大海强调，只有将"大脑"部署在终端设备上，才能实现灵敏感知、及时决策和完美应对。团队认为成功关键在于三个"密度"：团队、组织和资源的高度集中。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T17:03:48Z
- **目录日期**: 2025-05-09
