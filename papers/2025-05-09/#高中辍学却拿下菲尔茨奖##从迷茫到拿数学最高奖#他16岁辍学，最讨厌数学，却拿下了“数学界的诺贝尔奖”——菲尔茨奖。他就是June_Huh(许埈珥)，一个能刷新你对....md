...
许埈珥(June Huh)16岁辍学、曾厌恶数学，却因被菲尔茨奖得主广中平祐的非传统授课方式吸引而爱上数学。他通过独特视角用几何工具解决了40年未解的图论猜想，被密歇根大学破格录取。其研究重塑了组合与几何的关系，提出独立于几何空间的新方法，最终获得2022年菲尔茨奖。生活中他极度专注研究（曾用布缝毯御寒），成为父亲后改为每天仅工作3小时，强调"慢思考"的价值。他认为重要发现常源于放松状态，并坦言："我不是特别聪明，但愿意慢慢走别人未走的路。"

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T15:04:19Z
- **目录日期**: 2025-05-09
