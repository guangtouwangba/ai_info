...
该研究提出了MultiMind框架，首次将多模态信息整合到社交推理游戏（如"狼人杀"）的LLM智能体中。该框架通过分析面部表情、语音语调等非语言线索，结合心理理论模型追踪玩家间的相互怀疑程度，并利用蒙特卡洛树搜索优化沟通策略。实验表明，MultiMind在AI对战和人类对战中均表现出色，实现了跨模态的人类级社交推理能力，突破了现有纯文本智能体的局限。这项工作为开发具备多模态社交推理能力的LLM智能体提供了重要进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T14:02:17Z
- **目录日期**: 2025-05-09
