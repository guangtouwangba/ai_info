...
该研究提出了首个整合多模态信息的社交推理游戏框架MultiMind，用于解决现有基于文本的AI代理在《一夜终极狼人杀》等游戏中忽视面部表情和语调等关键社交线索的局限。该框架通过融合视觉、听觉和语言信息，结合心理理论模型追踪玩家间的相互怀疑程度，并利用蒙特卡洛树搜索优化沟通策略。实验表明，MultiMind在人机对抗和人类玩家测试中均表现出色，标志着大语言模型在多模态社交推理领域向类人化方向迈出了重要一步。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T10:02:30Z
- **目录日期**: 2025-05-09
