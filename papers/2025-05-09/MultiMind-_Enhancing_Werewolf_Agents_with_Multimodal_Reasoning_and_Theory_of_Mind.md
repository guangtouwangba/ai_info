...
该研究提出了首个多模态社交推理框架MultiMind，用于提升大型语言模型(LLM)在"一夜终极狼人杀"等社交推理游戏中的表现。该框架创新性地整合了面部表情、语音语调等多模态信息，并采用心理理论(ToM)模型追踪玩家间的相互怀疑程度。结合蒙特卡洛树搜索(MCTS)，智能体能制定最小化自身嫌疑的沟通策略。实验表明，MultiMind在AI对战和人类玩家测试中均表现出色。这项研究突破了传统纯文本分析的局限，使AI具备更接近人类的多模态社交推理能力，为发展类人社交智能体提供了重要进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T17:02:15Z
- **目录日期**: 2025-05-09
