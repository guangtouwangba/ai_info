...
本文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统，能够模拟1万多个AI代理的社会互动（500万次交互）。该系统被用于研究四大社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。研究发现模拟结果与现实世界数据高度吻合，证明了该系统在揭示人类行为机制方面的有效性。AgentSociety为社会科学研究和政策制定提供了新工具，能够补充传统研究方法（如调查和访谈），帮助理解复杂社会现象的内在规律。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T13:12:52Z
- **目录日期**: 2025-05-09
