...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个代理及其500万次互动。它通过真实社会环境和大规模模拟引擎，研究了社会极化、信息传播、基本收入政策和自然灾害影响等社会问题。模拟结果与现实实验数据吻合，验证了该系统捕捉人类行为机制的能力，展示了其作为社会科学研究和政策制定工具的潜力。该系统能够补充传统研究方法（如调查和访谈），帮助分析社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T06:05:11Z
- **目录日期**: 2025-05-09
