...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统，能够模拟超过1万个智能代理及其500万次社会互动。研究者用它作为计算社会科学实验平台，研究了四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，证明了该系统在捕捉人类行为机制方面的有效性。该平台为社会科学研究和政策制定提供了新工具，能有效补充传统研究方法如调查和访谈。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T02:34:00Z
- **目录日期**: 2025-05-09
