...
本文提出HA²框架，通过分层强化学习模拟人类协作中的结构化方法，解决自主智能体在新队友间零样本协调的适应性不足问题。研究指出，缺乏共享任务抽象是主要限制因素，而人类依赖此机制实现隐式协作。在Overcooked环境中的实验表明，HA²与未见过的智能体和人类配对时表现显著优于现有基线，对环境变化具有更强适应力，且在所有最先进方法中性能最优。该成果为提升多智能体协作的快速适应能力提供了有效解决方案。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T00:02:02Z
- **目录日期**: 2025-05-09
