...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作一站式服务。它支持中英文文献搜索，能自动生成摘要和问答互动，帮助用户快速理解内容。平台还具备文档翻译、科研动态订阅功能，用户可定制关注学者或关键词，通过微信或邮件接收最新研究。AMiner收录了3.5亿论文、0.6亿学者等海量数据，并提供免费基础服务。网址：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T12:05:45Z
- **目录日期**: 2025-05-09
