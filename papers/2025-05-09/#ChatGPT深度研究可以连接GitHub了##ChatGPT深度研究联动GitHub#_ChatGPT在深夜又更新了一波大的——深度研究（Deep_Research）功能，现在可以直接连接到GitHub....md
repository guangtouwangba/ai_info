# #ChatGPT深度研究可以连接GitHub了##ChatGPT深度研究联动GitHub# ChatGPT在深夜又更新了一波大的——深度研究（Deep Research）功能，现在可以直接连接到GitHub...
...
ChatGPT推出深度研究（Deep Research）功能，现已可直接连接GitHub。用户可通过该功能查询GitHub代码库，获取项目架构、技术栈、关键模块等信息，并生成改进建议。目前该功能处于测试阶段，面向Team用户开放，后续将逐步扩展至Plus和Pro用户。这一更新被视为开发者工具的重要升级，实现了类似RAG（检索增强生成）的效果，能直接访问并分析GitHub上的18个相关代码库。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T04:04:04Z
- **目录日期**: 2025-05-09
