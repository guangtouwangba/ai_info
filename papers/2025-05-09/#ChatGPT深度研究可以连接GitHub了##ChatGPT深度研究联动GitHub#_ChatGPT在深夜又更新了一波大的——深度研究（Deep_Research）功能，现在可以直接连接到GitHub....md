...
ChatGPT推出"深度研究"新功能，可直接连接GitHub进行代码分析。用户可通过该功能获取项目架构、技术栈等关键信息，并提出代码改进建议。目前该测试功能面向Team用户开放，后续将逐步覆盖Plus/Pro用户。该功能采用RAG技术，能自动搜索相关代码库并生成分析报告，被开发者视为重大效率提升工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T02:31:50Z
- **目录日期**: 2025-05-09
