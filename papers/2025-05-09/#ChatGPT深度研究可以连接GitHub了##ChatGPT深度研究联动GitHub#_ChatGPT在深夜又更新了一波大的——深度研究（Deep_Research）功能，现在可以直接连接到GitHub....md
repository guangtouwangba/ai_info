...
ChatGPT最新推出深度研究功能，现已支持直接连接GitHub。用户可通过该功能获取代码库分析报告，包括项目架构、技术栈、关键模块及改进建议等。测试阶段目前面向Team用户开放，后续将逐步覆盖Plus/Pro用户。该功能采用RAG技术，能自动检索相关代码仓库并生成分析，被开发者视为重大效率提升工具。操作时只需输入需求并选择GitHub选项，系统即可关联18个相关代码库进行智能解析。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T03:20:48Z
- **目录日期**: 2025-05-09
