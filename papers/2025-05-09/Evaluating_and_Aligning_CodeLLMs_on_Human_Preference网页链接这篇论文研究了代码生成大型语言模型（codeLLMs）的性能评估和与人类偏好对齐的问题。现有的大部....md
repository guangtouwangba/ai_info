...
这篇论文提出了CodeArena基准测试和SynCode-Instruct语料库，用于评估代码生成大语言模型(codeLLMs)与人类偏好的对齐程度。CodeArena包含397个高质量编程任务样本，覆盖40个类别和44种语言，比传统仅关注代码正确性的测试更能反映实际需求。研究还构建了近200亿标记的合成指令数据集用于微调验证。实验发现执行基准与人类偏好存在差异，且开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI)性能差距显著，凸显了人类偏好对齐的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T22:05:06Z
- **目录日期**: 2025-05-09
