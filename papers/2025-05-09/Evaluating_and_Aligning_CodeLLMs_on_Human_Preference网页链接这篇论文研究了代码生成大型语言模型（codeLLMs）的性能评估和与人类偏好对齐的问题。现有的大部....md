...
该论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，聚焦人类偏好对齐问题。研究选取397个高质量样本覆盖40类编程任务和44种语言，并构建20B标记的SynCode-Instruct合成指令集。实验发现执行基准与人类偏好存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，凸显对齐人类偏好的重要性。研究通过真实编程场景验证了合成指令微调的有效性，为提升代码LLMs的实用价值提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-09T07:06:00Z
- **目录日期**: 2025-05-09
