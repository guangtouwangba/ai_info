...
元戎启行CEO周光在英伟达GTC 2025上提出了一种名为RoadAGI的新路径，旨在通过自动驾驶技术实现垂直领域的通用人工智能（AGI）。与传统的Robotaxi不同，RoadAGI专注于道路场景下的AGI应用，能够更快地实现大规模商用自动驾驶。元戎启行推出的AI Spark平台不依赖高精地图，能够赋能智能车、机器人等多种移动设备，使其具备自主移动能力。这一创新为自动驾驶和AGI的结合开辟了新的可能性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-22T16:04:18Z
- **目录日期**: 2025-03-22
