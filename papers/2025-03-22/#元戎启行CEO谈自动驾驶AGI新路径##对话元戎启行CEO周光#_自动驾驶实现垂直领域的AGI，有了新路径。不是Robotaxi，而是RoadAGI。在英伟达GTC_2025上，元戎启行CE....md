...
元戎启行CEO周光在英伟达GTC 2025上提出了一种新的自动驾驶AGI（通用人工智能）实现路径——RoadAGI。与传统的Robotaxi不同，RoadAGI旨在通过一个平台赋能智能车、机器人等所有可移动体，实现垂直道路场景下的AGI。该平台名为AI Spark，无需依赖高精地图，能够大规模商用自动驾驶。这一创新路径为自动驾驶领域开辟了新的可能性，展示了通过自动驾驶实现AGI的另一种途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-22T08:03:18Z
- **目录日期**: 2025-03-22
