...
元戎启行CEO周光在英伟达GTC 2025上提出了一种新的自动驾驶技术路径——RoadAGI，旨在通过不依赖高精地图的方式，实现垂直道路场景下的通用人工智能（AGI）。该技术的实施平台AI Spark能够赋能各种移动设备，包括智能车、机器人等，使它们具备自主移动的能力。这一创新路径为自动驾驶的大规模商用提供了新的可能性，并展示了AI和自动驾驶技术的另一种发展方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-22T20:03:16Z
- **目录日期**: 2025-03-22
