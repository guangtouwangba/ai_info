...
元戎启行CEO周光在英伟达GTC 2025上提出了一种新的自动驾驶技术路径——RoadAGI，旨在实现垂直道路场景下的通用人工智能（AGI）。与传统的Robotaxi不同，RoadAGI通过不依赖高精地图的AI Spark平台，赋能智能车、机器人等移动体，使其具备自主移动能力。这一创新路径有望加速自动驾驶的大规模商用，并为AI和自动驾驶领域开辟新的可能性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-22T11:03:41Z
- **目录日期**: 2025-03-22
