...
元戎启行CEO周光在英伟达GTC 2025上提出了通过RoadAGI实现自动驾驶垂直领域AGI的新路径。RoadAGI不依赖高精地图，通过AI Spark平台赋能智能车、机器人等移动体，使其具备自主移动能力。这一方法旨在加速自动驾驶的大规模商用，特别是在特定道路场景下的应用。元戎启行及其CEO周光通过这一创新，为自动驾驶和AI公司开辟了新的可能性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-22T23:03:24Z
- **目录日期**: 2025-03-22
