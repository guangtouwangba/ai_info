...
元戎启行CEO周光在英伟达GTC 2025上提出了一种新的自动驾驶技术路径——RoadAGI，旨在通过不依赖高精地图的AI Spark平台，实现垂直道路场景下的通用人工智能（AGI）。该平台能够赋能智能车、机器人等多种移动体，使其具备自主移动能力，从而加速自动驾驶的大规模商用。这一创新路径为自动驾驶领域开辟了新的可能性，展示了通过自动驾驶实现AGI的新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-22T02:27:23Z
- **目录日期**: 2025-03-22
