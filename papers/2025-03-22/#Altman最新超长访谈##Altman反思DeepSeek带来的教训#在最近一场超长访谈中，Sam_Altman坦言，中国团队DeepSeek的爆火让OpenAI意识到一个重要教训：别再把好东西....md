...
在最近的一次访谈中，Sam Altman反思了OpenAI的保守策略，认为中国团队DeepSeek的成功在于其开放性和透明度，如免费提供最强模型和展示思维链。Altman承认OpenAI错失了类似机会，并透露GPT-5将增加新功能。他还分享了OpenAI从实验室到消费科技公司的转变，以及ChatGPT意外爆红后的挑战。Altman强调，AI正成为普通人生活的一部分，而年轻用户对此接受度更高。OpenAI正加速转型，以抓住这一波技术变革的机遇。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-22T07:04:35Z
- **目录日期**: 2025-03-22
