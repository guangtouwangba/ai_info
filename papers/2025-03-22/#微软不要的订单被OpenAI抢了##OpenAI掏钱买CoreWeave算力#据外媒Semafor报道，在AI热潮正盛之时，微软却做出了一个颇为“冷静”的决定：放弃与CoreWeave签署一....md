...
在AI热潮中，微软决定放弃与CoreWeave签署的价值120亿美元的数据中心扩容订单。CoreWeave随即与OpenAI签约，而OpenAI的主要投资者正是微软。这一事件反映了AI行业的封闭循环，核心玩家如英伟达、微软和OpenAI之间相互依赖。CoreWeave，一家专注于AI基础设施的公司，正筹备IPO，目标融资27亿美元。Sam Altman支持CoreWeave的上市，强调OpenAI的未来模型将依赖其算力。这种深度合作预示着AI竞赛的激烈未来。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-22T07:04:58Z
- **目录日期**: 2025-03-22
