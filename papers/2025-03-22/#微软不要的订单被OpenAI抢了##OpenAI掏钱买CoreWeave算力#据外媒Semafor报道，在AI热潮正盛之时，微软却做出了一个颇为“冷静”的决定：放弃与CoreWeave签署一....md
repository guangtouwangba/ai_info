...
微软放弃了与CoreWeave签署的价值120亿美元的数据中心扩容订单，随后OpenAI接手了这笔交易。尽管微软是OpenAI的主要投资者，这一举动仍引发了关于AI行业内部资金流动的讨论。CoreWeave，一家专注于AI基础设施并得到英伟达支持的公司，正计划进行首次公开募股（IPO），目标融资27亿美元。OpenAI的Sam Altman在CoreWeave的路演中强调了其对公司未来模型开发的重要性，显示了行业内公司间的紧密合作。这一系列事件反映了AI行业的封闭循环和主要玩家之间的深度绑定。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-22T06:04:24Z
- **目录日期**: 2025-03-22
