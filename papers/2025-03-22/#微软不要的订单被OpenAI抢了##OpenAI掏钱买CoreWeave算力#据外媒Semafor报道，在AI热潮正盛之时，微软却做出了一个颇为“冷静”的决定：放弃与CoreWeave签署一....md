...
微软放弃了与CoreWeave签署的价值120亿美元的数据中心扩容订单，OpenAI迅速接手了这一订单。尽管OpenAI的主要投资者是微软，这一交易仍引发了关于AI行业内部资金流动的讨论。CoreWeave，一家专注于AI基础设施的公司，正筹备首次公开募股（IPO），融资目标高达27亿美元。OpenAI的Sam Altman支持CoreWeave的IPO，强调其算力对OpenAI未来模型的重要性。这一系列事件展示了AI行业内主要玩家之间的紧密联系和相互依赖，预示着AI竞赛的激烈未来。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-22T05:04:18Z
- **目录日期**: 2025-03-22
