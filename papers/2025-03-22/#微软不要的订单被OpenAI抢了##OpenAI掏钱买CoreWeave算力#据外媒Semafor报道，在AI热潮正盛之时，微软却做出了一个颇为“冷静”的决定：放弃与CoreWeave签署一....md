...
微软放弃了与CoreWeave签署的价值120亿美元的数据中心扩容订单，OpenAI随即接手。OpenAI是微软的主要投资者，因此这笔交易实际上仍由微软出资。CoreWeave是一家专注于AI基础设施的公司，正筹备IPO，融资目标27亿美元。OpenAI的Sam Altman支持CoreWeave，强调其算力对OpenAI未来模型的重要性。这一交易反映了AI行业核心玩家之间的紧密合作和相互依赖，凸显了AI经济的封闭循环特性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-22T00:04:23Z
- **目录日期**: 2025-03-22
