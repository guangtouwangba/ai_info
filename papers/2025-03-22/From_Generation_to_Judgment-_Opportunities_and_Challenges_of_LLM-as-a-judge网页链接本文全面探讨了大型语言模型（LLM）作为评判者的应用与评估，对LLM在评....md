...
本文深入探讨了大型语言模型（LLM）作为评判者的应用与评估，涵盖了评分、排名和选择等任务。文章从输入和输出角度定义了LLM评判者，并从评判内容、方式和领域构建了分类体系。最后，总结了评估LLM评判者的基准，并指出了关键挑战和未来研究方向，旨在为该领域提供见解并推动进一步研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-22T01:32:50Z
- **目录日期**: 2025-03-22
