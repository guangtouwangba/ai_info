...
林达尔均衡是一种用于在多个可分公共物品之间分配固定预算的解决方案概念，始终位于核心，满足稳定性和比例公平性。本文提出了一种新的凸规划公式，用于计算无上限和上限设置下的林达尔均衡，证明了其与纳什社会福利最大化的对偶关系，并通过镜像下降法提供了比例响应动态的收敛性证明。在无上限设置中，林达尔均衡等同于最大化纳什社会福利；在上限设置中，证明了凸规划公式仍适用，解决了长期存在的算法效率问题，表明林达尔均衡可高效计算，且近似核心稳定分配也可高效计算。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-22T01:28:25Z
- **目录日期**: 2025-03-22
