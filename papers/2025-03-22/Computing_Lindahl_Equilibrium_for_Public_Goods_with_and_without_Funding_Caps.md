...
Lindahl均衡是一种在多个可分公共物品间分配固定预算的解决方案，具有稳定性和比例公平性。本文研究了在无上限和有上限预算设置下的Lindahl均衡计算问题。在无上限情况下，Lindahl均衡等价于最大化Nash社会福利，可通过比例响应动态计算。本文提出了一种新的凸规划公式，并证明其与Nash福利最大化相关，且比例响应动态等价于在该公式上运行镜像下降法。在有上限情况下，本文证明了该凸规划公式仍适用，且其最优解为Lindahl均衡，从而解决了长期存在的算法计算问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-22T07:01:33Z
- **目录日期**: 2025-03-22
