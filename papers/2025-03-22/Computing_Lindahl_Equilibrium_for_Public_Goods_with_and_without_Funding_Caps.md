...
Lindahl均衡是一种用于在多个可分公共物品之间分配固定预算的解决方案，具有稳定性和比例公平性。本文提出了一种新的凸规划公式，用于计算无上限设置下的Lindahl均衡，并证明其与Nash社会福利最大化相关。通过镜像下降法，比例响应动态的收敛性得到了新的证明。在有上限设置下，本文证明了该凸规划公式仍适用，且其最优解为Lindahl均衡，从而解决了长期存在的算法效率问题。此外，该结果还表明，对于可分分段线性凹效用函数，近似核心稳定分配可以高效计算。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-22T13:05:02Z
- **目录日期**: 2025-03-22
