...
林达尔均衡是一种用于在多个可分公共物品之间分配固定预算的解决方案概念，始终位于核心，满足稳定性和比例公平性。本文提出了一种新的凸规划公式，用于计算无上限设置下的林达尔均衡，并证明其与纳什社会福利最大化相关。此外，比例响应动态等同于在新公式上运行镜像下降，从而提供了新的收敛保证。在有上限设置下，本文证明了新凸规划公式仍然有效，其最优解为林达尔均衡，解决了长期存在的算法效率问题，并表明可有效计算近似核心稳定分配。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-22T00:01:41Z
- **目录日期**: 2025-03-22
