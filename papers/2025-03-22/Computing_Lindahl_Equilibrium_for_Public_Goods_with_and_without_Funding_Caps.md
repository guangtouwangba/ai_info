...
林达尔均衡是一种用于在多个可分公共物品之间分配固定预算的解决方案概念，始终位于核心，满足稳定性和比例公平性。本文提出了一种新的凸规划公式，用于计算无上限设置下的林达尔均衡，并证明其与纳什社会福利最大化相关。通过镜像下降法，比例响应动态的收敛性得到了新的证明。在有上限设置中，每个公共物品有资金上限，林达尔均衡的存在性通过固定点论证已知，但高效算法一直未解决。本文证明新凸规划在有上限设置中仍有效，其最优解为林达尔均衡，从而解决了这一长期开放问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-22T02:25:52Z
- **目录日期**: 2025-03-22
