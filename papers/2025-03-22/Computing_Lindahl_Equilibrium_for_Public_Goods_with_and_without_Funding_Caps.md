...
Lindahl均衡是一种用于在多个可分公共物品间分配固定预算的解决方案，具有稳定性和比例公平性。本文研究了在无上限和有上限预算约束下，Lindahl均衡的计算方法。在无上限情况下，Lindahl均衡等价于最大化Nash社会福利，并提出了一种新的凸规划公式，证明其与比例响应动态的等价性。在有上限情况下，首次证明了Lindahl均衡可以通过凸规划高效计算，解决了长期存在的开放问题。这一结果还表明，对于可分分段线性凹效用函数，近似核心稳定分配也可以高效计算。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-22T04:01:24Z
- **目录日期**: 2025-03-22
