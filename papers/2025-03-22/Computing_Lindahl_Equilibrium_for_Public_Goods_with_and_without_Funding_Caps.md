...
Lindahl均衡是一种用于在多个可分公共物品之间分配固定预算的解决方案，具有稳定性和比例公平性。本文研究了在无上限和上限设置下的Lindahl均衡计算。在无上限情况下，Lindahl均衡等价于最大化Nash社会福利，并提出了一种新的凸规划公式，通过对偶和重构与Nash福利最大化相关联。比例响应动态等价于在新公式上运行镜像下降，提供了收敛保证的新证明。在上限情况下，证明了新凸规划公式仍适用，其最优解为Lindahl均衡，从而解决了长期存在的计算问题，并表明可高效计算近似核心稳定分配。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-22T11:01:23Z
- **目录日期**: 2025-03-22
