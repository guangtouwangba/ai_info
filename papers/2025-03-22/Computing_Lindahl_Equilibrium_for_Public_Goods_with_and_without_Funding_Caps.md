...
林达尔均衡是一种用于在多个可分公共物品之间分配固定预算的解决方案概念，始终位于核心内，满足稳定性和比例公平性。本文研究了代理人对公共物品具有可分离线性效用函数的模型，并提出了新的凸规划公式来计算该均衡。在无上限设置中，林达尔均衡等同于最大化纳什社会福利，且可通过比例响应动态计算。本文还证明了比例响应动态等同于在新公式上运行镜像下降法，从而提供了收敛保证的新证明。在上限设置中，本文证明了新凸规划公式仍适用，且其最优解为林达尔均衡，从而解决了长期存在的算法效率问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-22T18:01:19Z
- **目录日期**: 2025-03-22
