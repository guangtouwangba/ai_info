...
林达尔均衡是一种用于在多个可分割公共物品之间分配固定预算的解决方案概念，始终位于核心，满足稳定性和比例公平性。本文研究了代理人对公共物品具有可分离线性效用函数的模型，并引入了一种新的凸规划公式来计算该均衡，证明其与纳什社会福利最大化相关。通过镜像下降法，比例响应动态的收敛性得到新证明。在有限制条件下，每个公共物品有资金上限，本文证明了新凸规划仍适用，且其最优解为林达尔均衡，从而解决了长期存在的算法计算问题，并表明可有效计算近似核心稳定分配。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-22T20:01:18Z
- **目录日期**: 2025-03-22
