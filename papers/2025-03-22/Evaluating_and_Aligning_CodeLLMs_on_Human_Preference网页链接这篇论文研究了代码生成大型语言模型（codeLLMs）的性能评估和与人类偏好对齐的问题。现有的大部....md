...
这篇论文探讨了代码生成大型语言模型（codeLLMs）的性能评估及其与人类偏好的对齐问题。研究提出了CodeArena基准，包含397个高质量样本，涵盖40个类别和44种编程语言，以模拟现实编程任务的复杂性。此外，构建了SynCode-Instruct语料库（近20B标记）来验证大规模合成指令微调的效果。实验显示，基于执行的基准与CodeArena存在性能差异，且开源与专有代码LLM（如Qwen2.5-Coder与OpenAI o1）之间存在显著差距，强调了与人类偏好对齐的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-22T14:06:45Z
- **目录日期**: 2025-03-22
