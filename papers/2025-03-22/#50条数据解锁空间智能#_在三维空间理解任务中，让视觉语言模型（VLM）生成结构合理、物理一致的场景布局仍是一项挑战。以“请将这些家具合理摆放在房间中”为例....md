...
西北大学的研究人员潘震宇和刘晗提出了一种名为MetaSpatial的新框架，旨在通过规则驱动的强化学习策略提升视觉语言模型（VLM）在三维空间布局任务中的推理能力。该框架利用可程序化评估的奖励函数，通过多轮布局优化机制，显著提高了模型的空间推理和布局生成质量。实验表明，MetaSpatial在多个空间生成指标上优于传统的监督微调方法，展示了强化学习在三维空间智能建模中的有效性和通用性。这一方法仅需约50条无标注数据，即可显著提升模型性能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-22T15:03:31Z
- **目录日期**: 2025-03-22
