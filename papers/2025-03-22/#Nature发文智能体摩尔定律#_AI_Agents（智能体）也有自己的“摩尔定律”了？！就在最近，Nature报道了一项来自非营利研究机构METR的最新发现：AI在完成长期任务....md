...
《自然》杂志报道了非营利研究机构METR的最新发现，指出AI在完成长期任务方面的进步速度惊人，其时间跨度大约每七个月翻一番。研究人员提出了“50%-任务完成时间跨度”指标来衡量AI自动完成任务的能力变化。以50%任务成功率为基准，2019年AI达到这一目标所需时间对应人类需要的时间为10分钟，7个月后则变为20分钟。2024年增长速度更快，一些最新模型大约每三个月翻一番。预计五年后，AI能自动完成许多人类现在要花一个月才能完成的任务。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-22T01:31:20Z
- **目录日期**: 2025-03-22
