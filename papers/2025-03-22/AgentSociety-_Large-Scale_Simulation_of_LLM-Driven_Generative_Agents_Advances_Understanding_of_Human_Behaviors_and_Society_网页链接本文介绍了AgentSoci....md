...
本文介绍了AgentSociety，一个大规模社会模拟器，结合了大型语言模型驱动的代理、真实社会环境和强大的模拟引擎。通过模拟超过1万个代理及其500万次互动，研究者探讨了极化现象、信息传播、无条件基本收入政策及外部冲击等社会问题。AgentSociety的结果与现实世界实验吻合，展示了其在捕捉人类行为和社会机制方面的能力，并证明了其作为社会科学研究和政策制定工具的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-22T17:05:09Z
- **目录日期**: 2025-03-22
