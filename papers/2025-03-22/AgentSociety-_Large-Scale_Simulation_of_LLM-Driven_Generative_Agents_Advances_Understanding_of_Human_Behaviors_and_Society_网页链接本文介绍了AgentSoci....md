...
本文介绍了AgentSociety，一种大规模社会模拟器，结合了大型语言模型驱动的代理、真实社会环境和强大的模拟引擎。通过模拟超过1万个代理及其500万次互动，研究者探讨了极化现象、信息传播、无条件基本收入政策及外部冲击等社会问题。AgentSociety的结果与现实世界实验吻合，证明了其在捕捉人类行为及内在机制方面的能力，展示了其作为社会科学研究和政策制定工具的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-22T16:06:13Z
- **目录日期**: 2025-03-22
