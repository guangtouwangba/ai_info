...
本文提出了一种针对多智能体具身系统的组合约束概念，以解决智能体协作中的挑战。通过设计多种接口以适应不同类型的约束，实现了与物理世界的无缝交互。基于组合约束和定制接口，开发了自动化数据收集框架，并引入了首个多智能体具身操作基准RoboFactory。利用该基准，评估了模仿学习方法在不同难度任务中的表现，并探索了多智能体模仿学习的架构和训练策略，旨在构建安全高效的具身多智能体系统。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-22T08:01:39Z
- **目录日期**: 2025-03-22
