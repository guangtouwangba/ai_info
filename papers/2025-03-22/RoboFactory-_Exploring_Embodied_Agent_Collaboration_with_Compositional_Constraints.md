...
设计有效的多智能体系统对于解决跨领域的复杂现实任务至关重要。针对现有方法无法自动生成安全高效训练数据的挑战，本文提出了一种基于组合约束的多智能体系统概念，并设计了多种接口以适应不同类型的约束，实现与物理世界的无缝交互。利用这些约束和接口，开发了一个自动数据收集框架，并引入了首个多智能体操作基准RoboFactory。基于该基准，本文评估了模仿学习方法在不同难度任务中的表现，并探索了多智能体模仿学习的架构和训练策略，旨在构建安全高效的多智能体系统。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-22T17:01:31Z
- **目录日期**: 2025-03-22
