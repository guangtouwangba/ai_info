...
设计有效的多智能体系统对于解决跨领域的复杂现实任务至关重要。针对现有方法难以自动生成安全高效训练数据的问题，本文提出“组合约束”概念，解决多智能体协作中的挑战，并设计多种接口以实现与物理世界的无缝交互。基于此，开发了自动化数据收集框架，并推出首个多智能体操作基准RoboFactory。通过RoboFactory，本文评估了模仿学习方法在不同难度任务中的表现，并探索了多智能体模仿学习的架构和训练策略，旨在构建安全高效的多智能体系统。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-22T02:26:02Z
- **目录日期**: 2025-03-22
