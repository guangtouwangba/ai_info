...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理的社会互动（500万次交互）。研究者利用该系统研究了四大社会问题：社会极化、信息传播、基本收入政策效果和自然灾害影响。模拟结果与现实世界数据高度吻合，验证了该系统在揭示人类行为机制方面的有效性。该平台可作为传统社会科学研究方法（如调查、访谈）的有力补充，为研究者和政策制定者提供新的分析工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T08:03:54Z
- **目录日期**: 2025-04-25
