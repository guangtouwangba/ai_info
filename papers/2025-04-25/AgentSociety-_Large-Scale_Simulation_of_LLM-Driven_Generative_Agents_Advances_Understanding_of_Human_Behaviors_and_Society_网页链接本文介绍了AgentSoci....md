...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能模拟10,000+个AI代理的社会互动（500万次交互）。研究者用它研究了四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。结果显示其模拟结果与现实世界数据高度吻合，验证了该系统在揭示人类行为机制方面的可靠性。该系统可作为传统社会科学研究方法（如调查、实验）的有力补充，为研究者和政策制定者提供新的分析工具。研究突显了大语言模型在社会系统建模中的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T12:05:11Z
- **目录日期**: 2025-04-25
