...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能模拟1万多个AI代理的社会互动（500万次交互）。研究者用它分析四大社会问题：群体极化、争议信息传播、基本收入政策效果和自然灾害影响。该系统模拟结果与现实数据高度吻合，证明其能有效捕捉人类行为机制，为社会科学研究和政策制定提供了新型实验平台。该技术突破传统研究方法（如问卷调查）的限制，展现了AI模拟在理解复杂社会现象方面的巨大潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T05:04:59Z
- **目录日期**: 2025-04-25
