...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理的社会互动。研究者用它研究了社会极化、信息传播、基本收入政策和自然灾害影响等社会问题。该系统模拟了500万次代理与环境的互动，结果与现实世界数据吻合，验证了其模拟人类行为和社会机制的能力。该平台为社会科学研究和政策制定提供了新工具，能有效补充传统研究方法如调查和干预实验。研究表明，AgentSociety在揭示社会问题模式和内在机制方面具有重要潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T10:05:10Z
- **目录日期**: 2025-04-25
