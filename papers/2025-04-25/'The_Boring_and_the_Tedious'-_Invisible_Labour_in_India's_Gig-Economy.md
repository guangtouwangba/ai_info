...
印度外卖平台（如Swiggy和Zomato）为边缘群体提供重要收入，但也通过隐形劳动束缚劳动者。基于14次半结构化访谈，研究发现等待时间和重复性UI操作是造成"数字不适"的主要负担。工人虽采取策略应对算法管理，但仍受平台"游戏化"和系统不透明性限制。研究建议通过以工人为中心的GUI自动化来减少摩擦并保持自主权。该立场文件主张在"全球南方"的HCI研究中，应优先考虑工人自主性而非效率驱动的设计优化。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T17:01:40Z
- **目录日期**: 2025-04-25
