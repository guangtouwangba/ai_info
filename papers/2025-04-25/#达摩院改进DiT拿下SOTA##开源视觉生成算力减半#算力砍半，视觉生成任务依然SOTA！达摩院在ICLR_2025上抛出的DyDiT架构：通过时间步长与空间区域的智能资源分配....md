...
阿里巴巴达摩院联合多所高校在ICLR 2025提出动态架构DyDiT，通过时间步长和空间区域的智能资源分配，将DiT模型的推理算力减少51%，生成速度提升1.73倍，同时保持FID指标几乎无损。该方法仅需3%微调成本，能自适应调整计算资源分配，优先处理关键区域，显著降低视觉生成任务的算力消耗。相关代码已开源，并适配到文生图模型FLUX。实验显示DyDiT在多个数据集上表现稳定，实现了效率与质量的最佳平衡。达摩院今年共有13篇论文被ICLR录用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T03:17:37Z
- **目录日期**: 2025-04-25
