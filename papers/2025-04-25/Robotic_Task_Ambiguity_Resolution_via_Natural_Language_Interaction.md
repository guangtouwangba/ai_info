...
研究人员提出了一种名为AmbResVLM的新方法，用于解决机器人语言策略中的任务描述模糊性问题。该方法通过将语言目标与观察场景关联，并显式推理任务歧义，显著提升了任务模糊性的检测和解决能力。实验表明，在模拟和真实环境中，AmbResVLM均优于现有最优基线方法，成功将下游机器人策略的平均成功率从69.6%提升至97.1%。相关数据、代码和训练模型已开源。该研究解决了语言条件策略中因任务描述模糊导致的策略失败问题，为机器人自然语言交互提供了更可靠的解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T11:01:10Z
- **目录日期**: 2025-04-25
