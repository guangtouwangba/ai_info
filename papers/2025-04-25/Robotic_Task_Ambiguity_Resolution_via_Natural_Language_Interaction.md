...
AmbResVLM是一种新型方法，用于解决机器人语言条件策略中的任务描述模糊性问题。该方法通过将语言目标与观察场景关联，并显式推理任务模糊性，显著提升了任务歧义检测和解决能力。在仿真和真实环境中的测试表明，其性能优于现有先进基线方法。实际机器人实验显示，该方法将下游策略的平均成功率从69.6%提升至97.1%。相关数据、代码和训练模型已公开。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T20:01:00Z
- **目录日期**: 2025-04-25
