...
研究人员提出了一种名为AmbResVLM的新方法，用于解决机器人任务描述中的歧义问题。该方法通过将语言目标与场景信息结合，并显式推理任务歧义，显著提高了下游策略的准确性。实验表明，AmbResVLM在模拟和真实环境中均优于现有方法，成功将机器人任务完成率从69.6%提升至97.1%。相关数据、代码和训练模型已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T16:01:08Z
- **目录日期**: 2025-04-25
