...
AmbResVLM是一种新型方法，用于解决语言条件策略中的任务描述模糊性问题。该方法通过将语言目标与观察场景关联，并显式推理任务模糊性，显著提高了任务模糊性的检测和解决能力。实验表明，AmbResVLM在模拟和真实场景中均优于现有方法，成功将下游机器人策略的平均成功率从69.6%提升至97.1%。相关数据、代码和训练模型已公开。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T22:01:04Z
- **目录日期**: 2025-04-25
