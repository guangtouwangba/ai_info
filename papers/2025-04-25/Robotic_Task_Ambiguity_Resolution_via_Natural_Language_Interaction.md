...
AmbResVLM是一种新型方法，旨在解决机器人执行语言指令时的任务歧义问题。该方法通过将语言目标与场景关联并显式推理任务歧义，显著提高了任务检测和解决能力。实验表明，在模拟和真实环境中，AmbResVLM的表现优于现有技术，成功将下游机器人策略的平均成功率从69.6%提升至97.1%。相关数据、代码和训练模型已公开。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T12:01:04Z
- **目录日期**: 2025-04-25
