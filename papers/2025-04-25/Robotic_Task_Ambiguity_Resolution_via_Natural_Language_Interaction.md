...
本文提出AmbResVLM方法，用于解决语言条件策略中任务描述模糊导致的机器人执行失败问题。该方法通过将语言目标与场景关联并显式推理任务模糊性，在模拟和真实环境中均表现出优于现有方法的模糊性检测与解决能力。实验表明，该方法能将下游机器人策略的平均成功率从69.6%提升至97.1%。相关数据、代码和训练模型已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T19:00:59Z
- **目录日期**: 2025-04-25
