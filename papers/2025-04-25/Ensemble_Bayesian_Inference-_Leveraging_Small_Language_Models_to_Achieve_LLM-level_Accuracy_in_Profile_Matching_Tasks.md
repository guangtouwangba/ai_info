...
本研究提出了一种新型集成贝叶斯推理(EBI)方法，通过贝叶斯估计整合多个小型语言模型(SLM)的预测结果，使其性能超越单个模型限制。实验表明，EBI在多种任务(包括日英双语能力评估和用户画像分析)中表现优异，甚至整合负提升值模型也能改善整体性能。该方法为在有限计算资源下构建高性能AI系统提供了新思路，并能有效利用个体性能较低的模型。研究基于现有的大模型评估、集成方法和开源模型应用成果，拓展了资源受限环境下实现接近专有大模型性能的可能性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T16:01:47Z
- **目录日期**: 2025-04-25
