...
本研究提出了一种名为"集成贝叶斯推理(EBI)"的新方法，通过贝叶斯估计整合多个小型语言模型(SLM)的判断，使其性能超越单个模型的限制。实验表明，即使在日语和英语的多种任务(能力评估和消费者画像分析)中，包含负提升值模型的集成也能提升整体表现。该方法为在有限计算资源下构建高性能AI系统提供了新思路，并能有效利用性能较低的个体模型。研究基于现有的大模型性能评估、集成方法和开源模型应用成果，展示了该方法的新颖性和重要意义。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T23:01:37Z
- **目录日期**: 2025-04-25
