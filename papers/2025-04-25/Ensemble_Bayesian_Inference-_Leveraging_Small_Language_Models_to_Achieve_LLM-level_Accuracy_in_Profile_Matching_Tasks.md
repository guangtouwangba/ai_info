...
本研究提出了一种名为"集成贝叶斯推理(EBI)"的新方法，通过贝叶斯估计整合多个小型语言模型(SLM)的判断，使其性能超越单个模型。实验表明，即使在日英双语能力测试和消费者画像分析等多样化任务中，包含负提升值模型的集成也能提升整体表现。该方法突破了计算资源限制，为利用性能较低模型构建高性能AI系统提供了新思路。研究基于现有的大模型评估、集成方法和开源模型应用成果，展示了在有限资源下实现接近专有大模型准确性的可能性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T09:01:55Z
- **目录日期**: 2025-04-25
