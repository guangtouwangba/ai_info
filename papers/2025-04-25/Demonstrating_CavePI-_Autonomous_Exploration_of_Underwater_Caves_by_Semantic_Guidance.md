...
本文介绍了用于水下洞穴自主探索的视觉伺服系统CavePI，该系统整合了轻量级深度视觉感知模块和鲁棒控制机制，可在GPS失效、特征匮乏和低能见度的复杂环境中实现语义引导导航。研究团队通过实地水下洞穴测试和ROS数字孪生仿真验证了该系统的可靠性。该技术在水资源管理、水文地质、考古和海洋机器人等领域具有重要应用价值，能够实现自主水下机器人的安全高效探索与建图。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T13:09:30Z
- **目录日期**: 2025-04-25
