...
本文介绍了用于水下洞穴自主探索的视觉伺服系统CavePI，该系统结合轻量级深度视觉感知模块和鲁棒控制机制，能在GPS失效、特征匮乏的低能见度环境中实现语义引导导航。研究展示了该系统的硬件设计、边缘AI集成及数字孪生验证，并通过实地水下洞穴测试和仿真实验验证了其可靠性。该系统在水资源管理、水文地质学、考古学和海洋机器人等领域具有重要应用价值，为复杂水下环境中的自主探索提供了新解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T09:02:34Z
- **目录日期**: 2025-04-25
