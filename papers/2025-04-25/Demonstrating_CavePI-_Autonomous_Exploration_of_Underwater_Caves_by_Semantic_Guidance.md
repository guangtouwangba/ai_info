...
本文介绍了CavePI自主水下机器人(AUV)的视觉伺服系统，用于水下洞穴探索。该系统采用轻量级深度视觉感知模块实现环境语义理解，并通过鲁棒控制机制引导机器人在复杂洞穴结构中导航。研究通过实地水下洞穴测试和ROS数字孪生仿真验证了系统性能。该设计在缺乏特征、无GPS信号和低能见度的水下环境中实现了可靠导航，可应用于水资源管理、水文地质学、考古学等领域。系统整合了硬件设计与边缘AI算法，展示了语义引导的自主水下探索能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T14:02:27Z
- **目录日期**: 2025-04-25
