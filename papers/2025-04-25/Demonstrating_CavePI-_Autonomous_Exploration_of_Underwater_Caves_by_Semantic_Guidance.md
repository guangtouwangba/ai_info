...
本文介绍了专为水下洞穴探索设计的自主水下航行器CavePI及其视觉伺服框架。该系统采用轻量级深度视觉感知模块实现环境语义理解，并通过鲁棒控制机制在复杂洞穴结构中导航。研究通过实地水下洞穴测试和ROS数字孪生仿真验证了系统在无GPS、低能见度等恶劣条件下的可靠性。该技术对水资源管理、考古学和海洋机器人等领域具有重要意义。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T10:02:25Z
- **目录日期**: 2025-04-25
