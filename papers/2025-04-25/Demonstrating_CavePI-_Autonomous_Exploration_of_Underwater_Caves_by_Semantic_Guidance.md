...
本文介绍了用于水下洞穴自主探索的视觉伺服系统CavePI，其集成了轻量化深度视觉感知模块和鲁棒控制机制，可在无GPS、低能见度的复杂环境中实现语义引导导航。该系统通过硬件和边缘AI设计优化，支持水下资源管理、考古等应用。研究通过真实水下洞穴实验和ROS数字孪生仿真验证了其可靠性，展示了在特征缺失环境中的稳定导航能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T11:02:32Z
- **目录日期**: 2025-04-25
