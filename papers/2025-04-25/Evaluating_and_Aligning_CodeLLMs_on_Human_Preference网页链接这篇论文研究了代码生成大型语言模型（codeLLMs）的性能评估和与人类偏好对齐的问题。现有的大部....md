...
这篇论文针对代码生成大模型(codeLLMs)提出新评估方法，重点关注与人类偏好的对齐。研究者构建了CodeArena基准测试(397个样本，40类/44种语言)模拟真实编程任务，并开发了20B标记的SynCode-Instruct合成指令集。实验发现传统执行基准与人类偏好评估存在差距，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著。研究强调仅关注代码正确性不足，需重视人类偏好对齐，为提升代码LLMs实用性提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T00:05:39Z
- **目录日期**: 2025-04-25
