...
这篇论文探讨了代码生成大模型(codeLLMs)与人类偏好的对齐问题。研究者创建了CodeArena基准测试(含397个样本，覆盖40类任务和44种编程语言)，发现现有基准过于关注代码正确性而忽视人类偏好。同时构建了20B标记的合成指令数据集SynCode-Instruct验证微调效果。实验显示：1)执行基准与CodeArena存在性能差异；2)开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)差距显著。研究凸显了代码生成模型与人类偏好对齐的重要性，为改进模型评估提供了新方向。(98字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T15:05:41Z
- **目录日期**: 2025-04-25
