...
这篇论文针对代码生成大模型(codeLLMs)与人类偏好对齐的问题，提出了CodeArena基准测试(包含397个高质量样本，覆盖40类任务和44种编程语言)和大规模合成指令数据集SynCode-Instruct(近200亿标记)。研究发现现有基于执行的评估与人类偏好存在差异，实验显示开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，突出了对齐人类偏好的重要性。该研究为提升代码生成模型的实际应用价值提供了新的评估框架和数据支持。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T04:05:45Z
- **目录日期**: 2025-04-25
