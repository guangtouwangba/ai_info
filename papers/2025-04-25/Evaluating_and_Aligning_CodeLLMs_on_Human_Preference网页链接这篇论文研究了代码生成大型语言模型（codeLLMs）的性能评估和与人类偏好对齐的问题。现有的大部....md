...
这篇论文针对代码生成大型语言模型（codeLLMs）提出新评估方法，关注人类偏好对齐问题。研究者创建了CodeArena基准测试，包含397个高质量编程任务样本，覆盖40个类别和44种语言，模拟真实编程场景。同时构建了20B标记的合成指令数据集SynCode-Instruct验证微调效果。实验发现执行基准与人类偏好评估存在差异，开源模型（如Qwen2.5-Coder）与专有模型（如OpenAI o1）性能差距显著，突显对齐人类偏好的重要性。研究强调了现有评估方法的局限性，为改进codeLLMs提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T16:05:57Z
- **目录日期**: 2025-04-25
