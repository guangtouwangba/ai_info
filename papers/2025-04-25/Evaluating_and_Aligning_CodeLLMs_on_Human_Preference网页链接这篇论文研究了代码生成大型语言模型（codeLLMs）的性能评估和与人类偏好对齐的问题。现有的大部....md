...
这篇论文提出CodeArena基准测试和SynCode-Instruct语料库，用于评估代码生成大模型(CodeLLMs)与人类偏好的对齐程度。研究发现现有基准过于侧重代码正确性而忽略实际偏好，CodeArena通过397个多语言样本模拟真实编程场景。实验显示执行基准与人类偏好存在差异，且开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI)性能差距显著。研究强调对齐人类偏好的重要性，并通过20B标记的合成指令验证了大规规模微调的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T23:05:12Z
- **目录日期**: 2025-04-25
