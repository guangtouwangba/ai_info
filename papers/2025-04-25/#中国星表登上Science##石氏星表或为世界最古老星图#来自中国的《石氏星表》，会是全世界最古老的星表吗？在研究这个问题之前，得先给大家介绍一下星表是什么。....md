...
中国《石氏星表》可能是世界最古老星表，引发学界争议。国家天文台何勃亮团队通过霍夫变换分析，发现部分恒星坐标可追溯至公元前355年（石申时期），但另一半为公元125年更新数据。中科大杨伯顺等学者则认为数据反映的是公元前103年后汉代天文体系整合的结果，指出观测仪器存在1°偏差可能导致年代误判。尽管确切年代尚无定论，该星表无疑是中国天文学重要遗产，其球面坐标体系展现了古代中国在天文领域的卓越成就。相关研究发表于《Science》。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T21:03:02Z
- **目录日期**: 2025-04-25
