...
《石氏星表》可能是世界最古老的星表之一，相传由公元前4世纪石申编纂，但原著失传，现存残卷。中科院团队利用广义霍夫变换分析，发现部分数据可追溯至公元前355年，但另一半为公元125年更新。争议在于：有学者认为数据可能因汉代仪器偏差（偏离天极1°）导致年代误判，实际成书于公元前103年后，与汉代浑天仪发明时间吻合。尽管年代尚无定论，《石氏星表》仍是中国天文学的重要遗产，展现了早期球面坐标系的雏形。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T15:03:06Z
- **目录日期**: 2025-04-25
