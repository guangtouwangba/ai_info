...
中国《石氏星表》可能是世界最古老的星表，但对其年代存在争议。国家天文台何勃亮团队通过霍夫变换算法分析，发现部分数据可追溯至公元前355年（石申时期），部分为公元125年更新。但中科大杨伯顺等学者认为，若考虑汉代仪器1°的测量偏差，数据更可能形成于公元前103年后，与汉代天文体系发展时间吻合。尽管具体年代尚无定论，《石氏星表》作为中国天文学珍贵遗产，展现了早期球面坐标应用，对全球天文史具有重要意义。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T19:02:45Z
- **目录日期**: 2025-04-25
