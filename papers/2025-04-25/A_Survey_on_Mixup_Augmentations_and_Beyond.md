...
这篇综述全面回顾了Mixup及其相关数据混合增强方法的研究进展与应用。Mixup通过凸组合样本和标签生成虚拟数据，作为一种正则化技术，在缺乏大规模标注数据时表现出色且易于迁移到不同领域。文章首先提出了一个统一的Mixup训练框架，系统梳理了各类方法；随后探讨了Mixup在视觉下游任务、多模态数据中的应用及相关理论分析；最后总结了当前研究的局限性与未来方向。该综述为研究者提供了Mixup领域的最新进展和指导，相关资源已开源在GitHub项目Awesome-Mixup中。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T02:40:22Z
- **目录日期**: 2025-04-25
