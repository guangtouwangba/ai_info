...
本文通过理论模型研究了拍卖中预筛选策略的经济合理性。在竞标者具有独立同分布私人估值的设定下，拍卖设计者通过观察含噪的估值预测指标来决定准入竞标者数量。研究发现：预筛选拍卖等价于估值相关的标准拍卖，但不符合常见的关联性假设。研究确定了全支付、第一价格和第二价格拍卖中存在对称严格单调均衡策略的条件。关键结论显示：全支付拍卖中预筛选能显著提高收益（完美预测时仅准入2位竞标者最优），而第一和第二价格拍卖中准入所有竞标者仍是最优策略。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T22:02:06Z
- **目录日期**: 2025-04-25
