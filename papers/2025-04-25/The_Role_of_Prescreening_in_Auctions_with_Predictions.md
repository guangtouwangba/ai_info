...
本文通过理论模型分析了拍卖中"预筛选"策略的经济合理性。研究发现，基于噪声预测的预筛选拍卖等价于竞标者估值相关的标准拍卖，但传统关联性假设在此不成立。研究确定了三种经典拍卖形式（全支付、第一价格、第二价格）中存在对称严格单调均衡策略的条件。结果显示：在全支付拍卖中，预筛选能显著提升收益（完美预测时仅需2名竞标者）；而在第一价格和第二价格拍卖中，允许所有竞标者参与仍是最佳策略。这为拍卖设计者选择筛选策略提供了理论依据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T19:02:02Z
- **目录日期**: 2025-04-25
