...
本文通过理论模型研究了拍卖中预筛选策略的经济合理性。拍卖设计者利用噪声预测器评估竞标者估值，决定准入人数。研究发现，预筛选拍卖等同于竞标者估值相关的标准拍卖，但传统关联性假设不成立。模型分析了全支付、第一价格和第二价格拍卖的均衡策略条件。结果显示，全支付拍卖中预筛选能显著提高收益（完美预测时仅准入2人最优），而第一和第二价格拍卖中允许所有人参与仍是收益最大化的。这表明拍卖形式决定预筛选策略的有效性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T06:02:13Z
- **目录日期**: 2025-04-25
