...
拍卖行常采用封闭拍卖制造稀缺性和提升声望，以刺激高价值竞标者间的竞争。本文通过理论模型分析，探讨基于机器学习预筛竞标者的经济合理性。研究表明：预筛拍卖等同于标准拍卖中竞标者估值相关的情形，但传统关联性假设不成立。在三种经典拍卖形式中，预筛能显著提升全支付拍卖收益（完美预测时仅需两名竞标者即可最优），但在第一价格和第二价格拍卖中，允许所有竞标者参与仍是最优策略。该发现为差异化拍卖设计提供了理论依据。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T15:02:12Z
- **目录日期**: 2025-04-25
