...
拍卖行常采用封闭拍卖制造稀缺性与声望，以激发高价值竞标者的竞争。本研究通过理论模型分析，探讨基于机器学习预筛选手的经济合理性。模型假设竞标者估值独立同分布，拍卖方通过含噪预测器筛选参与者。研究表明：预筛选拍卖等同于标准关联估值拍卖，但传统关联性假设不成立。在三种拍卖形式中，全支付拍卖通过预筛选能显著提升收益（完美预测时仅需2名竞标者），而第一价格和第二价格拍卖则仍应允许全员参与以实现收益最大化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T05:02:12Z
- **目录日期**: 2025-04-25
