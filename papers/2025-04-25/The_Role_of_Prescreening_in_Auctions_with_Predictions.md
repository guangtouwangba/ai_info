...
本文通过理论模型分析了拍卖中预筛选策略的经济合理性。研究发现，基于噪声预测器的预筛选拍卖等同于标准拍卖中竞标者估值相关的情况，但传统关联性假设不成立。研究确定了全支付、首价和次价拍卖中对称严格单调均衡策略的存在条件。结果显示，预筛选能显著提升全支付拍卖的收益（完美预测时仅需两名竞标者），但在首价和次价拍卖中，允许所有竞标者参与仍是最优策略。这表明AI驱动的预筛选策略需根据拍卖形式差异化实施。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T13:09:20Z
- **目录日期**: 2025-04-25
