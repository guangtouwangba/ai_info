...
拍卖行常采用封闭拍卖制造稀缺性和声望，以刺激高地位竞标者间的竞争。本文通过理论模型分析，在竞标者估值独立同分布且拍卖方掌握带噪声的估值预测信号时，预筛选竞标人数能否提升经济效益。研究表明：预筛选拍卖等价于标准拍卖中引入估值相关性，但传统关联性假设不成立。在三种经典拍卖形式中，全支付拍卖通过预筛选能显著提高收益（完美预测时仅需两名竞标者），而一价和二价拍卖仍以允许全员参与为最优。机器学习使精准预筛选成为可能，但收益效果因拍卖机制而异。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T18:02:08Z
- **目录日期**: 2025-04-25
