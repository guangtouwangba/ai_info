...
字节推出多模态模型Vidi，专注于视频理解与编辑，能快速定位长视频中的目标内容。其创新点包括：1)采用分解注意力架构降低计算复杂度；2)两阶段训练提升时序检索能力；3)推出VUE-TR基准测试优化5个关键维度。在VUE-TR测试中，Vidi表现优于Gemini和GPT-4，尤其在长视频处理上优势明显。目前发布技术报告和评估基准，即将推出7B模型demo。未来计划拓展视频理解任务和交互式编辑功能，填补大模型与视频应用的差距。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T22:03:02Z
- **目录日期**: 2025-04-25
