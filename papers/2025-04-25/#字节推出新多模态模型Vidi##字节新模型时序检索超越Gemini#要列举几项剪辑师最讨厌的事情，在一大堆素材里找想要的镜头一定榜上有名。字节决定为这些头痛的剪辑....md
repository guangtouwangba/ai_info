...
字节跳动推出全新多模态模型Vidi，专注于视频理解与编辑，能快速定位长视频中的特定内容。Vidi在VUE-TR基准测试中表现优异，尤其在长视频处理上超越Gemini和GPT-4。其创新分解注意力架构将计算复杂度从O(N²)降至O(N)，并采用两阶段训练优化跨模态对齐和任务处理能力。团队还推出VUE-TR基准，涵盖视频时长、音频支持等五个维度。Vidi未来将支持更多视频任务和交互式编辑功能，7B模型demo和权重文件即将发布。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T13:10:26Z
- **目录日期**: 2025-04-25
