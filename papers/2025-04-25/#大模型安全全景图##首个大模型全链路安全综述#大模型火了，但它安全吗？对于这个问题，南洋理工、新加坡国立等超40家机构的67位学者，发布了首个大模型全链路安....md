...
这篇由67位学者联合发布的大模型安全综述，系统梳理了843篇研究，首次构建了覆盖全生命周期的安全知识图谱。研究指出：数据阶段需防范隐私泄露（0.1%污染即可破坏模型）；微调阶段面临后门攻击风险；对齐阶段可能产生"伪合规"输出；模型遗忘可能引发新偏见；部署阶段需应对提示注入等新型攻击；商业应用中幻觉/偏见问题突出。防御措施包括差分隐私、多模态审核、对抗训练等，强调技术治理需协同推进。该研究为AI安全提供了系统性参考框架。论文链接：https://arxiv.org/abs/2504.15585

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T11:03:49Z
- **目录日期**: 2025-04-25
