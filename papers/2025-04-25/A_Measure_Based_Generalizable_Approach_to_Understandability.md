...
本文探讨了智能体与人类有效合作的关键在于确保智能体生成的信息易于人类理解，并且人类能轻松引导智能体达成目标。当前包括大语言模型在内的先进智能体仅依赖训练数据中的平均人类认知，缺乏细粒度的可理解性评估，导致引导性受限（如依赖复杂提示工程）。作者主张开发通用、领域无关的可理解性度量标准作为智能体的指导原则，而非仅依赖数据。通过综述跨领域相关研究，本文为未来更系统、领域无关的可理解性研究奠定了认知科学基础。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T04:02:06Z
- **目录日期**: 2025-04-25
