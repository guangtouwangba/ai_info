...
本文探讨了实现高效人机协作的关键在于提升AI生成信息的可理解性及人类对AI的引导能力。现有AI（包括大语言模型）仅依赖训练数据中的平均人类认知水平，缺乏细粒度可理解性评估，导致引导性有限（如依赖复杂提示工程）。作者主张开发通用、领域无关的可理解性度量标准作为AI指令，而非仅依赖数据。通过梳理分散在各领域的研究成果，本文以认知科学为基础，为未来更系统、跨领域的可理解性研究奠定基础，旨在增强AI对人类意图的响应能力。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T01:29:39Z
- **目录日期**: 2025-04-25
