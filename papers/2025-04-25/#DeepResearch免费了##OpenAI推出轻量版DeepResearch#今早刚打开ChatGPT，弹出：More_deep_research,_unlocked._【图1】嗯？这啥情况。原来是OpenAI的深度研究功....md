# #DeepResearch免费了##OpenAI推出轻量版DeepResearch#今早刚打开ChatGPT，弹出：More deep research, unlocked. 【图1】嗯？这啥情况。原来是OpenAI的深度研究功...
...
OpenAI宣布向所有用户免费开放轻量版DeepResearch功能，包括Plus/Team/Pro及免费用户。该版本由o4-mini驱动，响应速度更快、内容更简洁，准确率45.6%（标准版51.1%）。付费用户优先使用标准版，额度耗尽后自动切换轻量版。企业/教育用户将于下周获得访问权限。此举降低了深度研究功能的准入门槛。（98字）  

注：图片数据提及但未展示，核心信息已完整覆盖版本差异、用户范围、性能指标和切换机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T07:02:37Z
- **目录日期**: 2025-04-25
