...
本文对Google的Agent2Agent（A2A）协议进行了全面的安全分析，研究其核心组件和运行机制，并置于智能体通信发展框架中。通过MAESTRO风险评估框架，采用主动威胁建模方法，重点评估A2A在Agent Card管理、任务执行完整性和身份验证等方面的潜在安全问题。研究提出了安全开发方法和架构最佳实践，以构建健壮的A2A系统，并探讨A2A与模型上下文协议（MCP）的协同作用如何提升安全互操作性。为开发者提供了构建安全可靠的下一代智能体应用所需的知识和实践指导。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T01:28:57Z
- **目录日期**: 2025-04-25
