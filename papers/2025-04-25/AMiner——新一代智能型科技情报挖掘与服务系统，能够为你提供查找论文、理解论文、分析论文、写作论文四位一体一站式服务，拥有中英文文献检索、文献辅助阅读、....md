...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和科研订阅等一站式服务。它拥有3.5亿论文、0.6亿学者等海量学术资源，支持中英文文献检索、AI生成摘要和互动问答，帮助用户快速理解内容。用户可上传PDF或从平台获取论文，系统自动生成摘要和章节概要。此外，AMiner提供个性化科研动态订阅，按用户偏好推送最新论文和资讯。平台还包含学者画像、学术会议等特色功能，支持免费使用，旨在提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T18:05:10Z
- **目录日期**: 2025-04-25
