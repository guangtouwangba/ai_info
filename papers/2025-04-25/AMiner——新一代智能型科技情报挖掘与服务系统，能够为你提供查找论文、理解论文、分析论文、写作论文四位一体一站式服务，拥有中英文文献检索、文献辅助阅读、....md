...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、翻译、辅助阅读和科研情报订阅。它覆盖42个学科，拥有3.5亿论文、0.6亿学者等海量数据。用户可通过互动问答快速获取文献摘要，支持PDF上传和AI生成章节概要。平台还提供个性化订阅服务，推送最新科研动态。此外，AMiner具备学者画像、学术会议推荐等功能，浏览器版本可免费使用。访问入口：https://www.aminer.cn/。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T08:04:25Z
- **目录日期**: 2025-04-25
