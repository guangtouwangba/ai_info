...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索（覆盖3.5亿论文）、AI辅助阅读（自动生成摘要、章节概要和问答）、文档翻译及科研情报订阅（按需推送最新成果）。支持用户上传或检索文献，通过对话交互深入理解内容，并具备学者画像、学术会议追踪等功能。平台免费开放基础服务，可通过网页或微信小程序使用，显著提升文献调研和论文写作效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T03:20:16Z
- **目录日期**: 2025-04-25
