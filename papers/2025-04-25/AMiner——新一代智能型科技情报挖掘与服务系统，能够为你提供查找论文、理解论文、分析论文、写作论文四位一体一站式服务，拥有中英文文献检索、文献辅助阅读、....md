...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作的一站式服务，涵盖42个学科的3.5亿论文、0.6亿学者等资源。主要功能包括：1）中英文文献检索，支持互动问答和自动摘要生成；2）英文文献翻译，可上传PDF并获取摘要、章节概要和内容问答；3）科研情报订阅，按用户偏好推送最新学术动态。此外，还提供学者画像、学术会议和论文排行榜等功能。平台支持浏览器免费使用，旨在提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T16:05:46Z
- **目录日期**: 2025-04-25
