...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、阅读分析和科研动态订阅等一站式服务。它拥有3.5亿论文、0.6亿学者和1.5亿专利数据，支持中英文文献搜索、AI辅助阅读（自动生成摘要和问答）、文档翻译及个性化科研情报推送。用户可通过关键词、学者或机构订阅最新研究，并通过微信或邮件接收。平台还提供学者画像、学术会议和论文排行榜等功能，基础服务免费使用，网址：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T05:05:30Z
- **目录日期**: 2025-04-25
