...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读辅助、翻译及科研情报订阅等一站式服务。其核心功能包括：1）中英文文献检索，支持互动问答和自动摘要生成；2）英文文献翻译与AI辅助阅读，可解析PDF并生成章节概要；3）个性化科研动态推送，按用户偏好筛选最新论文。平台覆盖42个学科，包含3.5亿论文、0.6亿学者等海量数据，同时提供学者画像、学术会议等特色功能。基础服务免费开放，可通过网页或微信小程序使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T20:05:22Z
- **目录日期**: 2025-04-25
