...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、辅助阅读、翻译、论文写作支持等。平台收录3.5亿论文、0.6亿学者数据，支持AI生成摘要、章节概要和智能问答。用户可订阅个性化科研动态，跟踪机构、学者及关键词，通过微信或邮件接收最新资讯。此外，AMiner还提供学者画像、学术会议和论文专题功能。浏览器版可免费使用，网址：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T09:05:46Z
- **目录日期**: 2025-04-25
