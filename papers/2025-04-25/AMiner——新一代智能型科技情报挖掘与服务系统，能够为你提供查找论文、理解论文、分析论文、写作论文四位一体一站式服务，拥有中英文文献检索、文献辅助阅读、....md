...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译、科研订阅等一站式服务。它收录了3.5亿论文、0.6亿学者等海量学术资源，支持中英文文献搜索、AI生成摘要、互动问答等功能。用户可上传或搜索论文，快速获取概要，并通过定制订阅跟踪最新研究动态。平台还提供学者画像、学术会议等特色功能，基础服务免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T07:04:07Z
- **目录日期**: 2025-04-25
