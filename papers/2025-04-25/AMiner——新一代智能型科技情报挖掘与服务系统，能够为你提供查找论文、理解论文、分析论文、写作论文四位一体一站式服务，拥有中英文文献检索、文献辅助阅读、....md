...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、辅助阅读、翻译和科研情报订阅。它拥有3.5亿论文、0.6亿学者和1.5亿专利数据，支持AI生成摘要、问答互动和个性化订阅推送。用户可通过关键词、学者或机构订阅最新研究动态，还能上传PDF进行智能解析。平台还提供学者画像、学术会议和论文排行榜等功能，浏览器版可免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T17:05:09Z
- **目录日期**: 2025-04-25
