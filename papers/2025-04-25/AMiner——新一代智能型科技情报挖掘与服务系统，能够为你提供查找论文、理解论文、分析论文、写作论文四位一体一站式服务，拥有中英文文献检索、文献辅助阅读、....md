...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译和科研订阅等一站式服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持中英文文献搜索，并能通过AI生成摘要、章节概要和智能问答，帮助用户高效理解文献内容。此外，用户可定制科研动态推送，跟踪关注的学者、机构或关键词。平台还提供学者画像、学术会议和论文排行榜等功能，基础服务免费开放使用。访问地址：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T15:05:30Z
- **目录日期**: 2025-04-25
