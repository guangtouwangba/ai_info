...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析和写作一站式服务。它支持中英文文献搜索，能自动生成摘要并解答用户提问，提升科研效率。平台还具备文档识别、辅助阅读功能，允许上传PDF并获取章节概要。用户可定制科研情报订阅，跟踪最新学术动态。此外，AMiner提供学者画像、会议信息等资源，免费开放使用。访问地址：https://www.aminer.cn/。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T12:05:42Z
- **目录日期**: 2025-04-25
