...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译和科研订阅等一站式服务。它涵盖42个学科，拥有3.5亿论文、0.6亿学者等海量数据。主要功能包括：1）中英文文献检索，支持智能问答和自动摘要生成；2）英文文献翻译和辅助阅读，可上传PDF并获取章节概要；3）科研情报订阅，按用户偏好推送最新学术动态。此外，还提供学者画像、学术会议等特色功能。平台可通过浏览器免费使用，旨在提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-25T02:43:43Z
- **目录日期**: 2025-04-25
