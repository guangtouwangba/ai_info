...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析及写作辅助的一站式服务。它支持中英文文献搜索，拥有3.5亿论文、0.6亿学者等海量数据，并能通过AI生成摘要、章节概要和智能问答。用户可订阅个性化科研动态，跟踪机构、学者或关键词的最新研究。平台还提供学者画像、学术会议和论文排行榜等功能，基础服务免费使用，旨在提升科研效率。访问链接：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T02:34:01Z
- **目录日期**: 2025-04-24
