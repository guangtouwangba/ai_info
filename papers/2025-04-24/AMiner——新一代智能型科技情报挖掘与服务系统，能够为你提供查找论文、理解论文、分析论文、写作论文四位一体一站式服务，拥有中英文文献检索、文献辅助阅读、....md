...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读辅助、翻译及科研订阅等一站式服务。其核心功能包括：1）中英文文献精准检索，支持互动问答和自动摘要生成；2）AI驱动的文献翻译与解析，可上传PDF或从数据库选取论文，生成摘要和章节概要；3）个性化科研情报订阅，按用户偏好推送最新学术动态。平台覆盖42个学科，包含3.5亿论文和1.5亿专利数据，支持免费使用，助力高效学术研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T15:05:46Z
- **目录日期**: 2025-04-24
