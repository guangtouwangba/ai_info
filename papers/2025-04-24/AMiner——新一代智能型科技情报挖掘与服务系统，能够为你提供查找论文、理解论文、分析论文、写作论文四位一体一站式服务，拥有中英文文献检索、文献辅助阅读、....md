...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、科研情报订阅等一站式服务。其核心功能包括：1）精准检索3.5亿论文资源，支持智能问答和自动摘要生成；2）AI辅助阅读，可解析PDF文档并生成章节概要；3）个性化订阅服务，按用户需求推送最新科研成果。平台还包含学者画像、学术会议等特色功能，支持浏览器免费使用。通过AI技术显著提升文献查阅、理解和写作效率，适用于科研工作者快速获取前沿学术信息。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T10:05:28Z
- **目录日期**: 2025-04-24
