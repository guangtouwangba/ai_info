...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析和写作一站式服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持中英文文献检索、AI辅助阅读、自动摘要生成和智能问答。用户可上传PDF或从平台获取论文，快速理解内容。AMiner还提供科研动态订阅服务，根据用户偏好推送最新学术资讯。平台免费开放使用，具备学者画像、学术会议等特色功能，帮助研究者高效获取和管理学术信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T23:05:08Z
- **目录日期**: 2025-04-24
