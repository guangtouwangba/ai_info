...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作一站式服务。支持中英文文献搜索、AI辅助阅读、自动摘要生成和翻译功能，覆盖42个学科3.5亿论文。用户可通过互动问答快速理解文献，上传PDF获取智能解析。平台还提供科研动态订阅服务，按用户偏好推送最新成果。额外功能包括学者画像、学术会议追踪和论文排行榜。基础检索服务免费开放，网址：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T00:05:54Z
- **目录日期**: 2025-04-24
