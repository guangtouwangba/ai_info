...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译和科研订阅等一站式服务。它支持中英文文献搜索，能自动生成摘要和问答互动，帮助用户快速理解论文内容。平台还提供文献翻译、文档识别和个性化科研动态推送功能。收录了3.5亿论文、0.6亿学者等海量学术资源，用户可通过浏览器免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T22:05:31Z
- **目录日期**: 2025-04-24
