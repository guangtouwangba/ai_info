...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译及科研订阅等一站式服务。它覆盖42个学科的3.5亿论文、0.6亿学者和1.5亿专利，支持中英文文献检索、AI生成摘要、互动问答及文档翻译功能。用户可订阅个性化科研动态，跟踪机构、学者或关键词，通过微信或邮件接收最新资讯。平台还提供学者画像、学术会议和论文排行榜等功能，基础服务免费使用。访问入口：https://www.aminer.cn/。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T18:05:23Z
- **目录日期**: 2025-04-24
