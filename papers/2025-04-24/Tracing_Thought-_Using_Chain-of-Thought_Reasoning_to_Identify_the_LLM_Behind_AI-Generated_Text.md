...
本文提出了一种名为COT Fine-tuned的新框架，用于检测AI生成的文本并识别其背后的特定语言模型。该框架采用双任务方法：任务A区分AI生成与人类撰写文本，任务B识别生成文本的具体大语言模型。其创新点在于引入思维链推理机制，使模型能为其预测生成解释，从而提升透明度和可解释性。实验表明，该方法在两项任务中均表现出高准确率，尤其在模型识别和人机分类方面效果显著。研究证实思维链推理过程对提升模型效能和可解释性具有重要作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T09:01:16Z
- **目录日期**: 2025-04-24
