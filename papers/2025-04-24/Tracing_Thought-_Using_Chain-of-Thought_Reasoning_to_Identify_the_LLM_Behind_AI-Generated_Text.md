...
本文提出了一种名为COT Fine-tuned的新型AI文本检测框架，通过双任务设计实现AI生成文本检测和特定语言模型识别。任务A区分AI生成与人类撰写文本，任务B识别生成文本的具体大语言模型。该方法的创新点在于采用思维链推理机制，使模型能为其预测生成解释，提高了透明度和可解释性。实验表明，该框架在两项任务中均取得高准确率，尤其在模型识别和AI/人类文本分类方面表现突出，证实思维链推理对提升模型效果和可解释性具有重要作用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T20:01:21Z
- **目录日期**: 2025-04-24
