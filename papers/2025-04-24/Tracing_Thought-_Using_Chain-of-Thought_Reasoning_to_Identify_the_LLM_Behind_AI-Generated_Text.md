...
本文提出了一种名为COT Fine-tuned的新型框架，用于检测AI生成文本并识别其来源语言模型。该方法采用双任务设计：任务A区分AI生成与人类撰写文本，任务B识别具体的大型语言模型(LLM)。关键创新在于引入思维链(Chain-of-Thought)推理机制，使模型能为其预测提供解释，增强了透明度和可解释性。实验表明，该框架在两项任务中均表现优异，尤其在LLM识别和人机文本分类方面准确率高。研究证实，思维链推理过程显著提升了模型效能和结果可解释性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T10:01:22Z
- **目录日期**: 2025-04-24
