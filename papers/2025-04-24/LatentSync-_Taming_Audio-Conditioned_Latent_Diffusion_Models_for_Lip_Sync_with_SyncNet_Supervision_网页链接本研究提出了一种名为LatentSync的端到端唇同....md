...
本研究提出LatentSync，一种端到端唇同步框架，基于音频条件的潜在扩散模型，无需中间运动表示。该框架利用Stable Diffusion直接建模音频-视觉相关性，解决了传统方法的时间一致性问题。研究创新性地提出TREPA方法，通过自监督视频模型增强生成帧的时间一致性。此外，针对SyncNet收敛问题进行了实证研究，改进了其训练框架，提升了准确性。实验表明，该方法在HDTF和VoxCeleb2数据集上超越了现有技术。这些改进可推广至其他唇同步和音频驱动的人像动画应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T12:05:36Z
- **目录日期**: 2025-04-24
