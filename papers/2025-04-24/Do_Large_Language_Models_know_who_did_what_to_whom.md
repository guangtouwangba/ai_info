...
这篇论文研究了大型语言模型(LLMs)是否能够理解句子中的"谁对谁做了什么"(主题角色)。通过两个实验分析4个LLM的句子表征发现：与人类判断不同，LLM的句子相似性主要反映句法相似性而非主题角色分配；模型隐藏单元中几乎没有主题角色信息，但某些注意力头确实能独立于句法捕获主题角色信息。研究表明，虽然LLM能够提取主题角色信息，但与人类相比，这些信息对其表征的影响较弱。这表明LLM的核心训练目标(词语预测)与主题角色理解的联系有限。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T17:01:44Z
- **目录日期**: 2025-04-24
