...
研究表明，大型语言模型（LLMs）的核心训练目标（词语预测）并未使其句子表征像人类那样有效捕捉主题角色（如施事与受事关系）。实验发现，LLMs的句子相似性判断主要依赖句法而非语义角色分配，且主题角色信息在隐藏单元中表现微弱。不过，部分注意力头能独立于句法结构识别主题角色。这说明LLMs虽具备提取主题角色的能力，但该信息对其表征的影响远弱于人类。研究揭示了LLMs语言理解与人类认知的关键差异。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T14:01:58Z
- **目录日期**: 2025-04-24
