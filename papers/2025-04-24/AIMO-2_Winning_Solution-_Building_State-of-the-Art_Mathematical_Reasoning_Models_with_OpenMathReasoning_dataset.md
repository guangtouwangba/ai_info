...
这篇论文介绍了在AI数学奥林匹克竞赛AIMO-2中获胜的解决方案。其核心方法基于三点：1)构建了包含54万道高质量数学题(含奥赛题)和320万条详细解答的大规模数据集；2)开发了通过迭代训练、生成和质量筛选将代码执行与长推理模型结合的新方法，产生了170万条工具集成推理解答；3)建立了从多个候选解中选择最优解的模型训练流程(GenSelect)，显著优于多数投票基准。结合这些创新，训练出的模型在数学推理基准测试中达到最先进水平。作者开源了代码、模型和完整数据集以促进后续研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T04:01:45Z
- **目录日期**: 2025-04-24
