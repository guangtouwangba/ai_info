...
这篇论文介绍了在AI数学奥林匹克竞赛AIMO-2中获胜的方案。该方案基于三个关键创新：1) 构建了包含54万道高质量数学题（包括奥赛级题目）及其320万条详细解答的大规模数据集；2) 开发了通过迭代训练、生成和筛选将代码执行与长推理模型结合的新方法，产生了170万条高质量工具集成推理解答；3) 设计了从多个候选解中选择最优解的生成式选择管道(GenSelect)，显著优于多数投票基准。结合这些方法训练出的模型在数学推理基准测试中达到最先进水平，相关数据和代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T13:09:36Z
- **目录日期**: 2025-04-24
