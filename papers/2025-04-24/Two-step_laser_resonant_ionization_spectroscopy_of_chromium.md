...
在TRIUMF的离线激光离子源测试平台上，研究人员对铬(Cr)进行了分步共振激光电离光谱研究，以寻找适合钛蓝宝石(Ti:Sa)激光系统的有效电离方案。通过使用357.971 nm、359.451 nm和360.636 nm三种不同的一阶激发跃迁，采用倍频光栅调谐Ti:Sa激光器进行自动连续激光频率扫描，观测到了里德堡系列和自电离态(AI)。由此测得Cr的电离势(IP)为54575.49(2)_stat(2)_sys cm^-1，精度比NIST数据库记录值提高了一个数量级。该方案随后被用于放射性Cr同位素束的在线输送，成功测量了^50-59Cr的在线产额。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T01:29:02Z
- **目录日期**: 2025-04-24
