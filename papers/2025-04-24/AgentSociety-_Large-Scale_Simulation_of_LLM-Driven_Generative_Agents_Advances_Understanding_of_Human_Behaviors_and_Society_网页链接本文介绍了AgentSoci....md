...
这篇论文介绍了AgentSociety——一个基于大语言模型的大规模社会模拟系统，能模拟1万多个AI代理的社会互动（500万次）。研究者用它研究了四个社会问题：群体极化、信息传播、基本收入政策效果和自然灾害影响。结果显示其模拟结果与现实研究高度吻合，证明该系统能有效捕捉人类行为机制。该平台为社会科学研究和政策制定提供了新工具，可辅助传统研究方法（如调查和实验），帮助理解复杂社会现象背后的模式和机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T16:05:39Z
- **目录日期**: 2025-04-24
