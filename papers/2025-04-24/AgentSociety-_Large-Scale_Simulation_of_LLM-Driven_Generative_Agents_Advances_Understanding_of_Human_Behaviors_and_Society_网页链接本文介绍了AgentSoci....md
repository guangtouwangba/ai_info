...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理的社会互动（500万次交互）。研究者用它研究了四大社会问题：群体极化、信息传播、基本收入政策影响和自然灾害冲击。模拟结果与现实数据高度吻合，验证了该系统捕捉人类行为机制的能力。该系统可作为社会科学研究和政策制定的创新工具，弥补传统方法（如调查）的局限性，帮助深入理解社会问题的成因和模式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T03:21:22Z
- **目录日期**: 2025-04-24
