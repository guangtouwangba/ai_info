...
该研究提出了AgentSociety——一个结合大语言模型代理、真实社会环境和大规模模拟引擎的社会模拟平台。通过模拟1万多个代理的500万次社会互动，研究者针对社会极化、信息传播、基本收入政策和自然灾害影响四个关键问题进行了实验。结果显示模拟结果与现实世界数据高度吻合，验证了该平台在揭示人类行为机制方面的有效性。这一工具为社会科学研究和政策制定提供了新的实验手段，能够辅助传统研究方法，深入理解复杂社会问题的成因和潜在解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T17:04:56Z
- **目录日期**: 2025-04-24
