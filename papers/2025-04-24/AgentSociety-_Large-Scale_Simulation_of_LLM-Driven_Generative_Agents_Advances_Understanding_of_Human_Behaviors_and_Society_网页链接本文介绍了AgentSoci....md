...
该研究介绍了AgentSociety——一个融合大语言模型代理、真实社会环境和大规模模拟引擎的社会模拟系统。通过模拟1万多个代理及其500万次互动，研究者考察了四大社会问题：群体极化、信息传播、基本收入政策效果和自然灾害影响。模拟结果与现实数据高度吻合，证明该系统能有效捕捉人类行为机制，为社会科学研究和政策制定提供了新工具。该平台可辅助传统研究方法，帮助理解社会问题的成因与潜在机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T05:05:35Z
- **目录日期**: 2025-04-24
