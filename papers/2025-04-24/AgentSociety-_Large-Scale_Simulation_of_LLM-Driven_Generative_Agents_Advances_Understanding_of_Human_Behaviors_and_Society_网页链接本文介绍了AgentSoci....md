...
AgentSociety是一个基于大语言模型的大规模社会模拟平台，模拟了1万多个AI代理及其500万次互动。研究者用它分析四个关键社会问题：社会极化、信息传播、基本收入政策效果和自然灾害影响。模拟结果与现实数据高度吻合，验证了该平台捕捉人类行为机制的能力。该系统可作为计算社会科学的新型研究工具，为学者和政策制定者提供传统方法（如调查）之外的补充研究手段，帮助理解复杂社会现象的成因和模式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T01:33:18Z
- **目录日期**: 2025-04-24
