...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能模拟1万多个AI代理的社会互动（500万次交互）。该系统被用于研究四大社会问题：群体极化、信息传播、基本收入政策效果和自然灾害影响。研究发现模拟结果与现实社会实验高度吻合，证明其能有效捕捉人类行为机制。该系统为社会科学研究和政策制定提供了新型实验平台，可辅助传统研究方法（如调查、访谈），帮助深入理解社会问题的成因与规律。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T13:13:13Z
- **目录日期**: 2025-04-24
