...
IBM 2024年Q1财报显示，营收145.4亿美元（同比+0.6%），超预期144亿；净利润10.6亿（同比降34%），调整后每股收益1.6美元（预期1.4）。软件业务（含Red Hat）营收63.4亿（+7%），混合云增长12%；咨询业务50.7亿（-2%），基础设施28.9亿（-6%）。生成式AI签约额突破60亿（单季增10亿）。公司维持全年增长预期，预计Q2营收164-167.5亿（中值超预期），2025年自由现金流目标135亿，营收至少增长5%（汇率利好150基点）。CEO强调软件业务强劲，对AI需求持续乐观。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T16:03:54Z
- **目录日期**: 2025-04-24
