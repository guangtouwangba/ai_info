...
该研究指出，基于文本提示的生成式AI交互方式常给小型企业主（SBOs）等新手用户带来障碍，尤其是在广告创意等专业领域。通过英国6位SBO的调研，发现三大挑战：难以通过提示表达品牌直觉、缺乏细粒度调整机会、生成内容缺乏品牌特色。为此，研究者开发了多模态AI工具ACAI，采用结构化三面板输入系统（品牌、受众与目标、灵感板），帮助用户传递品牌背景与视觉偏好。研究表明，结构化界面能突出用户定义的情境，改善内容匹配，增强新手创作流程中的协同控制能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T00:02:09Z
- **目录日期**: 2025-04-24
