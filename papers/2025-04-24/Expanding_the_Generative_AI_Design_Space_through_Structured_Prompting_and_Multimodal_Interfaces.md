...
该研究针对小型企业主（SBOs）在使用文本提示生成AI时面临的三大挑战：难以通过提示表达品牌直觉、缺乏细粒度调整机会、生成内容缺乏品牌特异性。为此，研究者开发了多模态AI工具ACAI，通过结构化输入界面（品牌、受众与目标、灵感看板）替代传统文本提示，帮助非专业用户更好地传达品牌相关背景和视觉偏好。研究表明，结构化界面能突出用户定义的上下文，改善生成内容与需求的匹配度，并增强新手创意工作流程中的协同控制能力。该成果为人机交互领域的生成系统设计提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T01:29:34Z
- **目录日期**: 2025-04-24
