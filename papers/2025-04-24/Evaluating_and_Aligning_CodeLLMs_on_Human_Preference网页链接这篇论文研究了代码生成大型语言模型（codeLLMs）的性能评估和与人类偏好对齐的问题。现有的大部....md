...
这篇论文提出了CodeArena基准测试和SynCode-Instruct语料库，以评估代码生成大型语言模型（codeLLMs）与人类偏好的对齐程度。CodeArena包含397个高质量样本，覆盖40个类别和44种编程语言，模拟真实编程任务。研究发现现有基准测试过于关注代码正确性而忽略人类偏好，且开源模型（如Qwen2.5-Coder）与专有模型（如OpenAI o1）存在显著差距。SynCode-Instruct（20B标记）验证了合成指令微调的有效性，强调了模型对齐人类偏好的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T23:05:17Z
- **目录日期**: 2025-04-24
