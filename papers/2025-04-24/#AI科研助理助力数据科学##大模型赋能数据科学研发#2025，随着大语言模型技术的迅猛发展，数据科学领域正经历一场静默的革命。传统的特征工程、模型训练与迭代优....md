...
微软亚洲研究院刘炜清团队研发的RD-Agent系统，通过大语言模型技术重塑数据科学研发流程。该系统采用双Agent协作框架：Research Agent生成研究想法，Development Agent实现验证，形成闭环迭代。其演进分为自动化、增强和重塑三阶段，在特征生成等任务中达到80-90%可用性。通过记录实验数据突破模仿瓶颈，既提升团队效率，也助力金融领域论文复现。该系统代表AI从执行工具向研究伙伴的转变，探索了"AI驱动数据驱动AI"的新型科研范式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T20:02:55Z
- **目录日期**: 2025-04-24
