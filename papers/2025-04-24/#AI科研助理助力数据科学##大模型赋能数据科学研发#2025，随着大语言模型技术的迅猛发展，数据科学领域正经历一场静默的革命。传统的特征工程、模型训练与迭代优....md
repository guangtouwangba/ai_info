...
微软亚洲研究院刘炜清团队研发的RD-Agent系统通过大模型技术革新数据科学工作流程，实现从自动化到增强再到领域重塑的三阶段演进。该系统采用双Agent协作框架（Research Agent生成创意 + Development Agent实现验证），通过数据驱动突破创新瓶颈，在特征生成等任务中达到80-90%可用性，已应用于金融论文复现等场景。该技术不仅提升科研效率，更重新定义了"AI驱动数据科学"的研究范式。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T18:02:53Z
- **目录日期**: 2025-04-24
