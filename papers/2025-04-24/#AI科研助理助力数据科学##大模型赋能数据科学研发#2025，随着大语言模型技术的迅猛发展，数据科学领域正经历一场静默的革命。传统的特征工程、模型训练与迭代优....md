...
微软亚洲研究院刘炜清团队开发了RD-Agent智能系统，通过三阶段演进（自动化→增强→重塑）重构数据科研流程。该系统采用双Agent架构：Research Agent生成研究创意，Development Agent实现验证，形成闭环迭代。其核心突破在于通过历史数据学习突破专家经验限制，在特征生成等任务中实现80-90%可用性，已应用于金融论文复现等场景。该技术将重复性工作智能化，使研究者聚焦创新，代表了大模型时代"AI驱动数据科学"的新型研究范式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T15:03:11Z
- **目录日期**: 2025-04-24
