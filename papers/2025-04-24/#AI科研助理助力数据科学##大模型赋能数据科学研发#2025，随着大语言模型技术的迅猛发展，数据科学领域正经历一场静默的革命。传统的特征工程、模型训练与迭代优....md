...
微软亚洲研究院刘炜清团队开发了RD-Agent智能系统，通过三阶段演进（自动化→增强→重塑）变革数据科学研发流程。该系统采用双Agent协作框架：Research Agent生成研究创意，Development Agent实现验证，形成闭环迭代。关键突破在于利用历史实验数据驱动创新，在特征生成等任务中实现80-90%可用率，已应用于金融论文自动复现等场景。该系统将大模型技术转化为"AI科研助理"，通过承担重复性工作提升研究效率，展现了"AI驱动数据科学，数据科学反哺AI"的新型研发范式。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T14:03:16Z
- **目录日期**: 2025-04-24
