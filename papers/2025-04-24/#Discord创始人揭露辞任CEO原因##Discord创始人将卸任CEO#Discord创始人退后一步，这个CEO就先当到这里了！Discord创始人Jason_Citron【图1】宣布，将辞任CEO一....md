...
Discord创始人Jason Citron宣布辞任CEO，由资深游戏行业高管Humam Sakhnini接任。Citron将继续担任董事会成员并过渡为顾问角色。Discord在疫情期间业务扩张后重新聚焦游戏领域，已连续五个季度实现收入增长和调整后盈利。新任CEO Sakhnini拥有15年游戏行业经验，曾参与《使命召唤》等知名游戏管理。Citron表示CEO角色需随公司发展阶段调整，此次人事变动是为公司下一阶段发展布局，但目前尚无具体上市计划。双方对游戏行业前景保持乐观，认为AI等新技术将催生新型娱乐形式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T13:12:13Z
- **目录日期**: 2025-04-24
