...
Discord创始人Jason Citron宣布卸任CEO，由游戏行业资深人士Humam Sakhnini接任。Citron将继续担任董事会成员和顾问。Discord作为游戏玩家实时通讯平台，疫情期间业务扩张后重新聚焦游戏领域，已连续五个季度实现收入增长和调整后盈利。新CEO表示将利用Discord的社区生态优势，支持各类游戏开发者。关于上市计划，双方表示目前尚无具体安排，但承认是未来方向。Citron特别提到AI技术可能催生新型娱乐形式，重燃玩家热情，推动行业增长。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T15:04:22Z
- **目录日期**: 2025-04-24
