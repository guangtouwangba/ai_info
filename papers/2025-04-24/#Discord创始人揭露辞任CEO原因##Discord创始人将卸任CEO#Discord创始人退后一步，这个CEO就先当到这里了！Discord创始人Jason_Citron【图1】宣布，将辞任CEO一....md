...
Discord创始人Jason Citron宣布辞任CEO，由游戏行业资深人士Humam Sakhnini接任。Citron将继续担任董事会成员并过渡为顾问角色。Discord在疫情期间业务扩张后重新聚焦游戏领域，已连续五个季度实现收入增长和调整后盈利。新任CEO Sakhnini拥有15年游戏行业经验，曾任职于动视暴雪等公司。Citron表示卸任是出于公司发展阶段考量，虽暂无具体上市计划，但认为这是未来方向。双方对游戏行业前景持乐观态度，认为AI将催生新型娱乐形式，而Discord将继续为各类开发者提供社区支持平台。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T18:03:58Z
- **目录日期**: 2025-04-24
