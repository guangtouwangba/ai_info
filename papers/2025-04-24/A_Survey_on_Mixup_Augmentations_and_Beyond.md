...
这篇综述全面回顾了深度神经网络中Mixup数据增强方法及其应用。Mixup通过凸组合样本和标签生成虚拟数据，作为有效的正则化技术受到广泛关注。文章首先提出了一个统一的Mixup训练框架，系统梳理了各类Mixup方法；随后探讨了Mixup在视觉下游任务、多模态数据中的应用及相关理论分析；最后总结了当前研究的局限性和未来发展方向。该综述为研究人员提供了Mixup领域的最新进展和指导，相关资源可在GitHub项目Awesome-Mixup获取。Mixup方法因其高效性和跨领域适应性，已成为数据增强领域的重要研究方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T23:02:17Z
- **目录日期**: 2025-04-24
