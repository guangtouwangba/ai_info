...
这篇综述系统回顾了Mixup及其相关数据混合方法的研究进展与应用。Mixup作为一种通过凸组合样本和标签的数据增强技术，因其高效生成虚拟数据且易于迁移到不同领域而广受关注。文章首先提出了一个统一的Mixup训练框架，并探讨了其在视觉下游任务、多模态数据中的应用及相关理论分析。同时总结了当前研究的局限性和未来发展方向，为研究者提供了Mixup领域的最新进展和实用指导。相关资源可在GitHub项目Awesome-Mixup中获取。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T04:02:39Z
- **目录日期**: 2025-04-24
