...
这篇综述系统回顾了Mixup及其相关数据混合方法的研究进展与应用。Mixup通过凸组合样本和标签生成虚拟数据，作为一种有效的正则化技术，在缺乏大规模标注数据时展现出优异性能。文章首先提出了一个统一的Mixup训练框架，并详细探讨了其在视觉下游任务、多模态数据中的应用及相关理论分析。同时总结了当前研究的局限性和未来方向，为研究者提供了Mixup领域的最新进展和指导。相关资源已开源在GitHub项目Awesome-Mixup中。该综述对推动高效Mixup方法的发展具有重要参考价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T10:02:29Z
- **目录日期**: 2025-04-24
