...
这篇综述全面回顾了Mixup及其相关数据混合方法的研究进展与应用。Mixup作为一种通过凸组合样本和标签来生成虚拟数据的正则化技术，因其高效性和跨领域适应性而受到广泛关注。文章首先提出了一个统一的Mixup训练框架，系统梳理了各类Mixup方法在视觉下游任务、多模态数据中的应用，并分析了相关理论。同时指出了当前研究的局限性和未来发展方向，为研究者提供了Mixup领域的最新进展和指导。相关资源可在GitHub项目Awesome-Mixup获取。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T20:02:23Z
- **目录日期**: 2025-04-24
