...
这篇综述全面回顾了Mixup及其相关数据混合方法在深度神经网络中的应用。Mixup通过凸组合样本和标签生成虚拟数据，作为一种正则化技术，在缺乏大规模标注数据时展现出优异性能。文章提出统一框架梳理Mixup的训练流程，系统探讨了其在视觉下游任务、多模态数据中的应用，以及相关理论分析。同时指出了当前研究的局限性和未来发展方向，为研究者提供Mixup领域的最新进展和指导。相关资源已开源在GitHub项目Awesome-Mixup中。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T16:02:53Z
- **目录日期**: 2025-04-24
