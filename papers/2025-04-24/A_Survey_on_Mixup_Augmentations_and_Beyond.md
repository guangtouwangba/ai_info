...
这篇综述系统回顾了Mixup及其相关数据混合方法的研究进展与应用。Mixup作为一种通过凸组合样本及标签生成虚拟数据的数据增强技术，因其高效性和跨领域适应性而受到广泛关注。文章首先提出了一个统一的Mixup训练框架，系统梳理了其在视觉下游任务、多模态数据中的应用，并分析了相关理论证明。最后总结了当前研究的局限，展望了未来提升Mixup效果与效率的研究方向。该综述为研究者提供了Mixup领域的最新进展，并附有开源项目资源（https://github.com/Westlake-AI/Awesome-Mixup）。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T11:02:35Z
- **目录日期**: 2025-04-24
