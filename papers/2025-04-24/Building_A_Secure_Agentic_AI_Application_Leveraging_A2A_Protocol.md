...
本文对谷歌的Agent2Agent(A2A)协议进行了全面的安全分析，重点研究了其在多智能体协作中的安全实现问题。研究采用MAESTRO框架进行主动威胁建模，评估了A2A部署中可能存在的安全问题，包括智能体卡管理、任务执行完整性和认证方法等关键环节。基于分析结果，论文提出了安全开发方法和架构最佳实践建议，以构建更可靠的A2A系统。研究还探讨了A2A与模型上下文协议(MCP)的协同作用，认为这种结合可以进一步增强安全互操作性。该研究为开发者提供了构建安全智能体应用的实用指导。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-24T21:01:23Z
- **目录日期**: 2025-04-24
