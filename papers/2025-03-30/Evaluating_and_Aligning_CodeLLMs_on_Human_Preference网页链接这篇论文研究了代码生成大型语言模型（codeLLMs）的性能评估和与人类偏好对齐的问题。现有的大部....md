...
这篇论文提出了CodeArena基准测试，用于评估代码生成大模型(CodeLLMs)与人类偏好的对齐程度。研究指出当前基准过于关注代码正确性而忽视人类偏好，为此构建了包含397个样本(覆盖40类/44种语言)的高质量测试集。同时创建了20B标记的SynCode-Instruct合成指令集验证微调效果。实验发现执行基准与CodeArena存在性能差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)差距显著，凸显对齐人类偏好的重要性。研究为提升代码LLMs的实际应用价值提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T15:05:36Z
- **目录日期**: 2025-03-30
