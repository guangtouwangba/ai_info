...
该论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，聚焦人类偏好对齐问题。研究选取397个高质量样本覆盖40类编程任务和44种语言，并构建20B标记的SynCode-Instruct数据集验证合成指令微调效果。实验发现：1)传统执行基准与人类偏好存在差距；2)开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著。研究强调代码生成模型需同时关注功能正确性和人类偏好匹配，为模型评估提供了新维度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T02:34:00Z
- **目录日期**: 2025-03-30
