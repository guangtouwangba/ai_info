...
该论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，通过397个高质量样本(覆盖40类/44种语言)评估模型与人类偏好的对齐程度。研究发现传统基于执行的测试与人类偏好存在差距，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI)性能差异显著。同时构建20B标记的SynCode-Instruct语料库验证合成指令微调效果，强调模型优化需兼顾功能正确性和人类编程习惯。研究突显了代码生成模型在实际应用中与开发者偏好匹配的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T14:08:22Z
- **目录日期**: 2025-03-30
