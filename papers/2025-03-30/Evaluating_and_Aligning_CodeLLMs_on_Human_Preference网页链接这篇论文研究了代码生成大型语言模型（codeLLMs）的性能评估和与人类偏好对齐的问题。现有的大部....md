...
这篇论文提出了CodeArena基准测试，用于评估代码生成大型语言模型(codeLLMs)与人类偏好的对齐程度。研究指出现有基准过于关注代码正确性而忽视人类偏好，因此构建了包含397个高质量样本、覆盖40类编程任务和44种语言的测试集。同时开发了SynCode-Instruct语料库(近200亿标记)验证合成指令微调效果。实验发现执行基准与CodeArena存在性能差异，开源模型(如Qwen2.5-Coder)与专有模型(如OpenAI o1)差距显著，凸显了人类偏好对齐的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T07:05:40Z
- **目录日期**: 2025-03-30
