...
大型语言模型（LLM）的对齐对安全可信部署至关重要。传统强化学习人类反馈（RLHF）方法计算成本高，而单代理解码方法难以适应多样化任务。为此，本文提出一种基于多代理协作的解码策略Collab，通过动态选择最优模型进行令牌级决策，实现推理时对齐。理论分析证明其最优性，实验显示Collab在开源对齐模型上表现优异：平均奖励提升1.56倍，GPT-4评估胜率提升71.89%，显著优于当前最佳单代理基线。该方法无需重新训练，通过模型池协作有效提升了任务适应性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T12:01:40Z
- **目录日期**: 2025-03-30
