...
大型语言模型（LLM）的对齐对安全可信的应用部署至关重要。传统强化学习人类反馈（RLHF）方法计算成本高，而控制解码可在推理时对齐模型但适应性不足。为此，研究者提出了一种基于多智能体协作的解码方法Collab，通过动态选择最优模型进行令牌级决策，利用现成对齐策略提升任务表现。理论分析证明其能针对目标奖励实现最优性能。实验显示，Collab在开源模型上超越单智能体基线，平均奖励提升1.56倍，GPT-4评估胜率提高71.89%，成为当前最佳解码策略。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T14:02:43Z
- **目录日期**: 2025-03-30
