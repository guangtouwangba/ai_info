...
浙江大学与上海AI Lab等机构研究人员提出了一种名为"邻近自回归建模"(NAR)的视觉生成新范式。该技术突破传统"下一个token预测"方法的效率瓶颈，采用"下一个邻域预测"机制，将图像/视频生成视为逐步"外绘"过程。实验显示，这种新方法能显著提升高分辨率图像生成速度，最高可达传统方法的13.8倍，为视觉生成领域带来了重大效率突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T22:03:07Z
- **目录日期**: 2025-03-30
