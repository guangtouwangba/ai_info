...
浙江大学与上海AI Lab等机构的研究人员提出了一种名为"邻近自回归建模"(NAR)的视觉生成新范式。该方法突破传统"下一个token预测"的低效模式，采用"下一个邻域预测"机制，将图像/视频生成视为逐步"外绘"过程。实验表明，这种新范式能显著提升高分辨率图像的生成效率，速度提升达到近14倍(13.8倍)，为解决当前视觉生成任务中的效率瓶颈提供了创新性解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T18:02:58Z
- **目录日期**: 2025-03-30
