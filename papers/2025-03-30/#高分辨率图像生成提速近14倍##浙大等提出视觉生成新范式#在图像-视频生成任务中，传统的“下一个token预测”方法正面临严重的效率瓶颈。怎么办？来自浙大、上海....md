...
浙江大学与上海AI Lab等机构的研究人员提出了一种名为"邻近自回归建模"(NAR)的新视觉生成范式。该技术突破了传统"下一个token预测"方法的效率瓶颈，采用"下一个邻域预测"机制，将图像/视频生成视为逐步"外绘"的过程。实验显示，这种新方法在高分辨率图像生成任务中实现了13.8倍的加速效果，显著提升了生成效率。这一创新为视觉内容生成领域提供了更高效的新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T14:05:20Z
- **目录日期**: 2025-03-30
