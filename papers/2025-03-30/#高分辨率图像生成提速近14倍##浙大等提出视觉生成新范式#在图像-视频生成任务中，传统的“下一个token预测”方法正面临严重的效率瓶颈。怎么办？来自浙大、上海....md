...
浙江大学与上海AI Lab等机构提出了一种名为"邻近自回归建模"(NAR)的视觉生成新范式。该方法突破传统"下一个token预测"的局限，采用"下一个邻域预测"机制，将图像生成视为逐步"外绘"的过程。实验显示，这种新方法能显著提升高分辨率图像的生成速度，最高可达传统方法的13.8倍，为解决当前视觉生成任务的效率瓶颈提供了创新解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T20:02:57Z
- **目录日期**: 2025-03-30
