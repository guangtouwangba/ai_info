# #高分辨率图像生成提速近14倍##浙大等提出视觉生成新范式#在图像/视频生成任务中，传统的“下一个token预测”方法正面临严重的效率瓶颈。怎么办？来自浙大、上海...
...
浙江大学与上海AI Lab等机构的研究团队提出了一种名为"邻近自回归建模"(NAR)的视觉生成新范式。该技术突破传统"下一个token预测"方法的效率瓶颈，采用"下一个邻域预测"机制，将图像/视频生成过程视为逐步扩展的"外绘"过程。实验表明，这种新方法能够将高分辨率图像生成速度提升近14倍(13.8倍)，显著提高了视觉内容生成的效率。这一创新为高质量视觉内容生成提供了更快速、更高效的解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T06:03:01Z
- **目录日期**: 2025-03-30
