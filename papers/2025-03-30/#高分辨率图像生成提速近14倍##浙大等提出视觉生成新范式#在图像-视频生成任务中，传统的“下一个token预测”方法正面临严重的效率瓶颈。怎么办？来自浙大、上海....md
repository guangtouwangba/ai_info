...
浙江大学与上海AI Lab等机构的研究人员提出了一种名为"邻近自回归建模"(NAR)的视觉生成新范式，突破了传统"下一个token预测"方法的效率瓶颈。NAR采用"下一个邻域预测"机制，将图像/视频生成视为逐步扩展的"外绘"过程。实验表明，这种新方法使高分辨率图像生成速度提升近14倍(13.8倍)，显著提高了生成效率。该研究为视觉内容生成领域提供了更高效的新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T19:03:00Z
- **目录日期**: 2025-03-30
