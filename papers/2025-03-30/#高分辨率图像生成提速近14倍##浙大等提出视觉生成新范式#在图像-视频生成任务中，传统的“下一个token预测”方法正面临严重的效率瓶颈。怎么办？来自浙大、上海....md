...
浙江大学与上海AI Lab等机构的研究团队提出了一种名为"邻近自回归建模"(NAR)的视觉生成新范式。该方法突破了传统"下一个token预测"的效率瓶颈，采用"下一个邻域预测"机制，将图像/视频生成视为逐步"外绘"的过程。实验表明，这种新方法能显著提升高分辨率图像的生成速度，最高可达传统方法的13.8倍。该技术为视觉生成领域提供了更高效的新思路，有望推动相关应用的进一步发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T07:03:11Z
- **目录日期**: 2025-03-30
