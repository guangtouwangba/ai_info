...
浙江大学与上海AI Lab等机构的研究团队提出了一种名为"邻近自回归建模"(NAR)的全新视觉生成范式，突破了传统"下一个token预测"方法的效率瓶颈。该技术采用"下一个邻域预测"机制，将图像/视频生成过程视为逐步"外绘"的扩展过程。实验表明，这种新方法能显著提升高分辨率图像的生成速度，最高可达传统方法的13.8倍，为视觉生成领域带来了突破性进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T10:03:07Z
- **目录日期**: 2025-03-30
