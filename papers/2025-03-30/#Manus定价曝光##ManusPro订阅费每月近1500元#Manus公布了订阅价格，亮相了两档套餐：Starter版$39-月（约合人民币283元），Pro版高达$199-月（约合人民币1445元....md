...
Manus公布了两档AI订阅套餐价格：Starter版39美元/月（约283元），支持2个任务；Pro版199美元/月（约1445元），支持5个任务并提供高级功能。Pro版价格显著高于ChatGPT Plus，但提供更多积分、优先资源和高投入模式。Manus定位"通用AI助手"，旨在提供多样化智能体服务。目前仍处测试阶段，已与阿里Qwen团队合作。其高价策略显示出差异化竞争路线，但能否被市场接受尚待观察。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T00:03:55Z
- **目录日期**: 2025-03-30
