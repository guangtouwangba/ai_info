...
Manus公布了两档AI订阅套餐：Starter版39美元/月（约283元），支持2个任务；Pro版199美元/月（约1445元），支持5个任务并提供更长上下文、高投入模式等高级功能。定位为"通用AI助手"，旨在提供各类智能体服务。目前处于测试阶段，已与阿里Qwen团队合作。其高价策略在国内AI市场竞争中寻求差异化发展，Pro版价格远超ChatGPT Plus的20美元/月。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T01:31:06Z
- **目录日期**: 2025-03-30
