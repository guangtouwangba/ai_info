...
OpenAI近期高层动荡的核心推手是首席科学家Ilya Sutskever。他在Sam Altman被解雇前一个月就准备了举报材料，指控Altman在GPT-4 Turbo审批流程上撒谎。董事会解雇Altman时未提前通知微软，后被前CTO Murati提醒。随后员工集体抗议，Ilya反悔签名，导致Altman48小时内复职。但多数高层已离职创业，仅剩Brockman留下。这场权力斗争展现了OpenAI内部复杂的治理矛盾。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T13:06:54Z
- **目录日期**: 2025-03-30
