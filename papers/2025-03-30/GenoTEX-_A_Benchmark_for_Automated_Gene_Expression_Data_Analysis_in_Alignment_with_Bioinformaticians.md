...
GenoTEX是一个用于自动化基因表达数据分析的基准数据集，包含注释代码和标准化流程，涵盖数据选择、预处理和统计分析。该数据集由生物信息学专家标注，确保准确性。研究者还开发了GenoAgent——基于大语言模型（LLM）的多智能体系统，采用自校正编程流程协作分析基因数据。实验表明LLM方法在基因组数据分析中具有潜力，但也揭示了改进空间。GenoTEX为评估和开发自动化基因分析方法提供了资源，其基准数据可在GitHub获取。该研究推动了机器学习在疾病相关基因识别中的应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T21:02:21Z
- **目录日期**: 2025-03-30
