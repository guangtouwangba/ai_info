...
近期机器学习在基因表达数据疾病相关基因识别方面取得显著进展，但传统方法依赖专家经验且难以扩展。为此，研究者开发了GenoTEX基准数据集，包含标准化处理流程和专家标注，用于评估自动化基因分析方法。同时提出基于大语言模型的多智能体系统GenoAgent，通过自修正编程流程协作分析基因数据。实验验证了大语言模型在基因组学中的应用潜力，也揭示了改进方向。该基准数据集（GitHub开源）为基因表达分析的自动化方法提供了评估标准和开发资源，有望推动该领域的技术发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T15:02:23Z
- **目录日期**: 2025-03-30
