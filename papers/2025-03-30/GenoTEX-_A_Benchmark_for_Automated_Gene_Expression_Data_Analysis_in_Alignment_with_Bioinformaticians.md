...
GenoTEX是一个用于自动化基因表达数据分析的基准数据集，包含注释代码和结果，涵盖数据选择、预处理和统计分析等流程，遵循计算基因组学标准。该数据集由生物信息学专家标注，确保准确性。研究者还开发了GenoAgent——基于大语言模型（LLM）的多智能体系统，采用多步骤编程工作流和自我修正机制来协作分析基因数据。实验表明LLM方法在基因组数据分析中具有潜力，但也揭示了改进空间。GenoTEX为评估和提升基因表达数据自动化分析方法提供了资源，相关基准可在GitHub获取。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T07:02:32Z
- **目录日期**: 2025-03-30
