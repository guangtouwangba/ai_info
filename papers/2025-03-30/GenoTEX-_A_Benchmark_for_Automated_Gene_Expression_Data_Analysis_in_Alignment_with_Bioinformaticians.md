...
近期机器学习在基因表达数据疾病相关基因识别方面取得显著进展，但传统方法依赖专家经验且难以扩展。为此，研究者开发了GenoTEX基准数据集，包含标准化的基因组学分析流程（数据选择、预处理和统计分析）及专家标注结果，用于评估自动化分析方法。同时提出GenoAgent系统——采用多步骤编程工作流和自校正机制的LLM智能体团队，为基因表达数据分析提供基线方案。实验验证了LLM在基因组学分析中的潜力，也揭示了改进方向。该基准数据集（GitHub开源）有望推动基因表达分析自动化方法的发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T22:02:31Z
- **目录日期**: 2025-03-30
