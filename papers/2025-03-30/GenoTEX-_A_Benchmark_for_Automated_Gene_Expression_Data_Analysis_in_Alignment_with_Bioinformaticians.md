...
近期机器学习在基因表达数据疾病相关基因识别方面取得显著进展，但传统方法依赖专业知识和人工操作，可扩展性受限。为此研究者开发了GenoTEX基准数据集，包含符合计算基因组学标准的全流程注释代码和专家校验结果，用于评估自动化分析方法。同时提出基于大语言模型的多智能体系统GenoAgent，通过多步骤编程和自校正机制协作分析基因数据。实验验证了大语言模型在基因组数据分析中的潜力，同时也揭示了当前局限和改进方向。该基准数据集为基因表达分析的自动化方法提供了评估和优化资源，已在GitHub开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T01:29:47Z
- **目录日期**: 2025-03-30
