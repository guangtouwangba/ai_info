...
近期机器学习在基因表达数据分析方面取得显著进展，但现有方法依赖专家知识且难以扩展。为此，研究者开发了GenoTEX基准数据集，包含标准化的基因识别流程（数据选择、预处理和统计分析）及专家标注结果。同时提出GenoAgent系统，采用具备自我修正能力的多智能体协作框架来自动化分析流程。实验验证了大语言模型在基因组数据分析中的潜力，也揭示了现存挑战。该基准数据集（GitHub开源）为自动化基因表达分析方法的评估与改进提供了重要资源，有助于推动该领域发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T14:04:35Z
- **目录日期**: 2025-03-30
