...
GenoTEX是一个用于自动化基因表达数据分析的基准数据集，包含注释代码和结果，覆盖基因识别问题的全流程（数据选择、预处理和统计分析），遵循计算基因组学标准。该数据集由生物信息学专家标注以确保准确性。研究团队还开发了GenoAgent，一个基于大语言模型（LLM）的多智能体系统，采用多步骤编程和自校正机制协作分析基因数据。实验表明LLM方法在基因组数据分析中具有潜力，但也存在挑战。GenoTEX可作为评估和提升基因表达分析自动化方法的资源，项目地址：https://github.com/Liu-Hy/GenoTex。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T03:17:31Z
- **目录日期**: 2025-03-30
