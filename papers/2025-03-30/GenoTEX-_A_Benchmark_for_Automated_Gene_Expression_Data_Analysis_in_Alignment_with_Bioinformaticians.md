...
近期机器学习在基因表达数据疾病相关基因识别方面取得显著进展，但传统方法依赖专家知识且难以扩展。为此研究者开发了GenoTEX基准数据集，提供标准化的基因分析流程标注（包括数据选择、预处理和统计分析），并包含生物信息学专家验证结果。同时提出基于大语言模型的GenoAgent系统，采用多智能体协作编程与自我修正机制来自动完成分析任务。实验证明该方法具有潜力，但也揭示了现有挑战。该基准数据集（GitHub开源）为基因表达分析的自动化方法评估与改进提供了重要资源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T17:02:30Z
- **目录日期**: 2025-03-30
