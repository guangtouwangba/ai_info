...
GenoTEX是一个用于自动化基因表达数据分析的基准数据集，包含注释代码和标准化流程，涵盖数据选择、预处理和统计分析等任务。该数据集由生物信息学专家标注，确保准确性和可靠性。研究者还开发了GenoAgent，一种基于大语言模型（LLM）的多智能体系统，采用自校正编程工作流协作分析基因数据。实验表明LLM方法在基因组数据分析中具有潜力，但也存在挑战。GenoTEX为评估和改进自动化基因分析方法提供了资源，可在GitHub获取。该研究推动了机器学习在疾病相关基因识别中的应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T11:02:38Z
- **目录日期**: 2025-03-30
