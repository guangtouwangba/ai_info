...
近期机器学习在基因表达数据疾病相关基因识别方面取得显著进展，但现有方法依赖专业知识且难以扩展。为此，研究者开发了GenoTEX基准数据集，包含符合计算基因组学标准的完整分析流程（数据选择、预处理、统计分析）及专家标注。同时提出GenoAgent——采用多步骤编程工作流和自我修正机制的LLM智能体系统，为自动化基因分析提供基线方法。实验表明LLM在基因组数据分析中具有潜力，同时揭示了改进方向。该基准数据集（https://github.com/Liu-Hy/GenoTex）有望推动基因表达分析自动化方法的发展与评估。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T02:30:59Z
- **目录日期**: 2025-03-30
