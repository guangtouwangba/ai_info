...
近期机器学习在基因表达数据疾病相关基因识别方面取得显著进展，但传统方法依赖专业知识和人工操作，可扩展性有限。为此，研究者开发了GenoTEX基准数据集，包含标准化的基因组学分析流程（数据选择、预处理、统计分析）和专家标注，用于评估自动化分析方法。同时提出GenoAgent——基于大语言模型的多智能体系统，采用自校正编程流程协作分析基因数据。实验验证了大语言模型在基因组学分析中的潜力，也揭示了改进方向。该数据集为基因表达分析的自动化方法提供了评估基准，开源地址：https://github.com/Liu-Hy/GenoTex。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T16:02:37Z
- **目录日期**: 2025-03-30
