...
近期机器学习在基因表达数据疾病相关基因识别方面取得显著进展，但传统方法依赖专家经验且难以扩展。为此，研究者开发了GenoTEX基准数据集，包含标准化处理流程和专家标注，用于评估自动化分析方法。同时提出GenoAgent系统——采用多智能体协作框架的LLM解决方案，通过自校正编程流程实现基因数据分析。实验验证了LLM在基因组学中的应用潜力，也揭示了改进方向。该资源为基因表达分析的自动化方法提供了标准化评测平台，数据集已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T10:02:28Z
- **目录日期**: 2025-03-30
