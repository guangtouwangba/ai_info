...
近期机器学习在基因表达数据疾病相关基因识别方面取得显著进展，但传统方法依赖专家经验且难以扩展。为此，研究者开发了GenoTEX基准数据集，包含标准化的基因分析流程（数据选择、预处理、统计分析）和专家标注，用于评估自动化分析方法。同时提出GenoAgent系统——采用多步骤编程工作流和自我修正机制的LLM智能体团队，为自动化基因分析提供基线方案。实验验证了LLM在基因组数据分析中的潜力，也揭示了改进方向。该数据集（https://github.com/Liu-Hy/GenoTex）可作为基因表达自动化分析的重要评测资源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T06:02:33Z
- **目录日期**: 2025-03-30
