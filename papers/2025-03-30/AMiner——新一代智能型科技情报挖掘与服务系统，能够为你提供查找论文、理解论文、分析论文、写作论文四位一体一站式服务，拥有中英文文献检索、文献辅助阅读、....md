...
AMiner是一个智能科技情报挖掘系统，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献检索、翻译和辅助阅读，拥有3.5亿论文、0.6亿学者等海量数据。用户可通过互动问答快速理解文献，AI还能自动生成摘要和章节概要。平台提供科研情报订阅服务，根据用户偏好推送最新学术动态。此外，AMiner还包含学者画像、学术会议等功能，浏览器检索免费使用。访问入口：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T08:05:43Z
- **目录日期**: 2025-03-30
