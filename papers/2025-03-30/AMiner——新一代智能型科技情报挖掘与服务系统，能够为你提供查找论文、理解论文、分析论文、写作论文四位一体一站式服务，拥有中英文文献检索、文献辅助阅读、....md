...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析及写作等一站式服务。它支持中英文文献搜索，拥有3.5亿论文、0.6亿学者等海量数据。用户可通过互动问答快速获取文献摘要，提升研究效率。平台还支持英文文献翻译、文档识别及辅助阅读，并能根据用户偏好推送最新科研动态。此外，AMiner提供学者画像、学术会议等特色功能，基础服务免费开放。访问链接：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T16:05:37Z
- **目录日期**: 2025-03-30
