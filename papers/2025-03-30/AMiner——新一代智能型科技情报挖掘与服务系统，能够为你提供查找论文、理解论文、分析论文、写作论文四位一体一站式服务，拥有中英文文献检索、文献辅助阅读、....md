...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译和科研情报订阅等一站式服务。它收录了3.5亿篇论文、0.6亿学者和1.5亿专利，支持中英文文献检索，并能通过AI生成摘要和回答用户提问。用户可上传PDF文档获取摘要和章节概要，还能定制科研动态推送。平台还提供学者画像、学术会议和必读论文专题等功能，支持浏览器免费使用。网址：https://www.aminer.cn/。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T14:08:11Z
- **目录日期**: 2025-03-30
