...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献搜索、AI辅助阅读、自动摘要生成和翻译功能，涵盖3.5亿论文、0.6亿学者等海量学术资源。用户可通过互动问答快速理解文献，或订阅个性化科研动态推送。平台还提供学者画像、学术会议等特色功能，支持PDF上传和智能对话解析。基础功能免费开放，适合科研人员高效获取学术信息。  

（注：图片内容未纳入摘要，因文字描述已覆盖核心功能）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T21:05:13Z
- **目录日期**: 2025-03-30
