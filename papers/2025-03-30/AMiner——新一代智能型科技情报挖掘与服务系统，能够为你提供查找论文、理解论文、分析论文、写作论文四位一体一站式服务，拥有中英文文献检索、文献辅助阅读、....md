...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、翻译、科研情报订阅等功能。它拥有庞大的数据库，涵盖3.5亿论文、0.6亿学者和1.5亿专利。用户可通过互动问答快速获取文献摘要，并利用AI辅助阅读和翻译功能。平台还支持个性化订阅，推送最新科研动态。此外，AMiner提供学者画像、学术会议和论文排行榜等工具，帮助用户高效进行学术研究。访问AMiner网站或AI页面即可免费体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T06:05:27Z
- **目录日期**: 2025-03-30
