...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、AI辅助阅读、自动摘要生成、论文翻译及科研情报订阅。平台收录3.5亿论文、0.6亿学者等海量数据，支持用户通过提问快速理解文献内容，并能定制推送最新研究动态。其特色功能包含学者画像、学术会议追踪及文献排行榜，基础服务免费开放。访问入口：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T09:05:59Z
- **目录日期**: 2025-03-30
