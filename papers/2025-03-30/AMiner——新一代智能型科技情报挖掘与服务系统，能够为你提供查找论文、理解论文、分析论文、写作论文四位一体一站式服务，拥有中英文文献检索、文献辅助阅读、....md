...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析与写作一站式服务。支持中英文文献搜索、AI辅助阅读、自动摘要生成及翻译功能，覆盖42个学科3.5亿论文。用户可通过互动问答快速理解文献，上传PDF获取章节概要，还能定制科研动态推送（如学者/机构追踪）。平台包含学者画像、学术会议等模块，基础功能免费使用。网址：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T02:33:50Z
- **目录日期**: 2025-03-30
