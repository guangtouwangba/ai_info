...
AMiner是一个智能科技情报挖掘系统，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献搜索，能自动生成摘要和回答用户提问，提升研究效率。平台还提供英文文献翻译、文档识别和辅助阅读功能，用户可上传PDF获取AI生成的摘要和章节概要。此外，AMiner提供科研情报订阅服务，根据用户偏好推送最新学术动态。平台收录大量论文、学者、专利和科研项目数据，并免费开放使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T03:20:22Z
- **目录日期**: 2025-03-30
