...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献搜索，拥有3.5亿论文、0.6亿学者等海量数据。平台具备AI辅助阅读功能，可自动生成摘要、翻译文献，并通过问答帮助用户理解内容。此外，AMiner提供科研动态订阅服务，根据用户偏好推送最新论文摘要。其他功能包括学者画像、学术会议追踪和论文排行榜。用户可通过浏览器免费使用，网址为https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T23:05:42Z
- **目录日期**: 2025-03-30
