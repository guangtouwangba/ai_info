...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟1万多个代理及其500万次互动。它通过真实社会环境和大规模模拟引擎，研究社会极化、信息传播、基本收入政策及外部冲击（如飓风）等社会问题。模拟结果与现实实验吻合，验证了其捕捉人类行为和社会机制的能力。该工具可作为社会科学研究和政策制定的补充方法，帮助分析社会问题的模式、原因和潜在机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T03:19:57Z
- **目录日期**: 2025-03-30
