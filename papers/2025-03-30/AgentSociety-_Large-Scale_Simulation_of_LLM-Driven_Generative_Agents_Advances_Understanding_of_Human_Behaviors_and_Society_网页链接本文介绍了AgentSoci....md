...
AgentSociety是一个基于大型语言模型的大规模社会模拟器，能模拟超过1万个代理及其500万次互动。研究者用它分析了极化现象、信息传播、基本收入政策及飓风影响等社会问题，结果与现实世界实验吻合。该系统展示了捕捉人类行为机制的能力，可作为社会科学研究和政策制定的有力工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T22:05:01Z
- **目录日期**: 2025-03-30
