...
AgentSociety是一个基于大型语言模型的大规模社会模拟器，可模拟超过1万个代理的互动行为。研究者通过该平台研究了社会极化、信息传播、基本收入政策和自然灾害影响等社会问题。模拟结果与现实世界数据高度吻合，验证了其在捕捉人类行为机制方面的有效性。该系统为社会科学研究和政策制定提供了新型实验工具，能够辅助传统研究方法（如调查和干预）分析社会问题的成因和潜在机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T04:04:40Z
- **目录日期**: 2025-03-30
