...
AgentSociety是一个基于大型语言模型的大规模社会模拟器，能模拟超过1万个代理的社会互动（500万次）。研究者用它分析社会极化、信息传播、基本收入政策及飓风等外部冲击的影响。模拟结果与现实数据吻合，验证了其捕捉人类行为机制的能力。该系统可作为计算社会科学工具，辅助传统研究方法（如调查、干预），帮助研究社会问题的成因与模式，为政策制定提供新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T05:04:45Z
- **目录日期**: 2025-03-30
