...
本文介绍AgentSociety——一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理及其500万次社会互动。该系统通过四个关键社会议题（政治极化、信息传播、基本收入政策、自然灾害影响）的仿真实验，结果与现实世界数据高度吻合，验证了其模拟人类行为和社会机制的有效性。研究表明，这种LLM驱动的模拟器能作为计算社会科学研究的新工具，为学者和政策制定者提供传统调查方法之外的补充研究手段，有助于深入理解复杂社会问题的成因与解决路径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T10:05:08Z
- **目录日期**: 2025-03-30
