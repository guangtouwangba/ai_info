...
OVO-Bench是一个新型视频基准测试，旨在评估在线视频大语言模型（Video-LLMs）的时间感知能力。该能力使模型能根据提问时间戳动态响应视频流，区分离线（静态分析）和在线（实时处理）模型。OVO-Bench包含12项任务、644个视频和约2800条人工标注，测试模型在三种场景下的表现：回溯过去事件、实时理解当前画面、延迟响应以获取未来信息。评估显示，现有模型在在线视频理解上显著落后于人类。该基准希望推动视频LLMs的发展，代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T02:30:40Z
- **目录日期**: 2025-03-30
