...
OVO-Bench是一个专注于评估视频大语言模型（LLMs）时间感知能力的新型基准测试。它强调在线视频理解中时间戳的关键作用，通过三种场景测试模型能力：回溯过去事件、实时响应当前事件以及延迟回答以获取未来信息。该基准包含12项任务、644个独特视频和约2800个人工标注的精细元数据。研究评估了9种视频LLMs，发现它们在在线视频理解方面仍显著落后于人类表现。OVO-Bench旨在推动视频LLMs的发展，促进在线视频推理研究。数据和代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T03:17:12Z
- **目录日期**: 2025-03-30
