...
OVO-Bench是一个专注于评估视频大语言模型(LLM)时间感知能力的新型基准测试。该基准强调时间戳在在线视频理解中的关键作用，通过三个场景评估模型能力：(1)回溯过去事件(2)实时理解当前事件(3)等待未来信息做出响应。包含12项任务、644个视频和约2800个人工标注的精细元数据。研究测试了9个视频LLM，发现尽管在传统基准上有进步，现有模型在在线视频理解方面仍远落后于人类。该基准旨在推动视频LLM发展，促进在线视频推理研究。数据集和代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T00:02:16Z
- **目录日期**: 2025-03-30
