...
本文提出了一种新的形式化框架，用于分析和理解直接偏好对齐(DPA)算法的语义。通过将现有DPA损失函数转化为符号程序，研究者系统性地揭示了不同DPA变体之间的差异和联系。该框架不仅能够严格描述近期各种损失函数提案之间的关系，还能从基本原理出发系统地探索损失函数空间并推导新函数。这项研究为理解人类偏好学习提供了新的理论视角，有助于指导人工智能与人类价值观对齐的研究工作。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T20:02:11Z
- **目录日期**: 2025-03-30
