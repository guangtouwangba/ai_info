...
近期直接偏好对齐算法(DPA)如DPO在语言模型对齐人类偏好方面展现出潜力，但缺乏统一的理论框架来分析其语义差异。本研究提出一种基于离散推理问题的形式化方法，将现有DPA损失函数转化为符号程序来系统表征其语义。研究建立了单模型和参考模型偏好损失的形式化体系，识别了常见DPA变体的符号形式，揭示了损失函数空间的规模和结构特征。该框架不仅能严格分析现有算法关系，还能从第一性原理推导新损失函数，为人类-AI对齐研究提供理论指导。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T11:02:27Z
- **目录日期**: 2025-03-30
