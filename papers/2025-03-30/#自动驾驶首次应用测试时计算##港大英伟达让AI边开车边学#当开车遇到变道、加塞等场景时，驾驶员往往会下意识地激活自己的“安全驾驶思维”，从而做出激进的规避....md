...
香港大学、英伟达和图宾根大学联合团队提出Centaur方法，通过测试时计算（test-time training）让自动驾驶系统在行驶过程中动态优化驾驶策略。该方法利用不确定性评估和聚类熵，使AI能像人类驾驶员一样实时学习应对变道、加塞等复杂场景，减少过度保守行为（如无故急刹）带来的安全隐患。相比依赖预设规则的自动驾驶系统，新技术显著提升了AI在不确定性环境中的适应性和安全性，实现了"边开车边学习"的突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T02:31:20Z
- **目录日期**: 2025-03-30
