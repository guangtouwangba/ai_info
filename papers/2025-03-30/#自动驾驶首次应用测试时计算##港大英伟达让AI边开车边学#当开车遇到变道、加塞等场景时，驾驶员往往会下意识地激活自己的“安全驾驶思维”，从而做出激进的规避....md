...
香港大学、英伟达和图宾根大学联合团队提出Centaur方法，解决自动驾驶在变道、加塞等场景中过度保守的问题。传统自动驾驶依赖预设规则，导致"新手司机"式的过度避让行为，反而增加安全隐患。Centaur通过测试时在线学习（test-time training），利用不确定性评估动态优化驾驶策略，实现AI"边开边学"，减少无故急刹并提升应对不确定场景的能力。该技术首次将测试时计算应用于自动驾驶领域，显著提高了系统的适应性和安全性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T01:30:10Z
- **目录日期**: 2025-03-30
