...
香港大学、英伟达和图宾根大学联合团队提出Centaur方法，通过测试时在线学习技术，让自动驾驶系统在行驶过程中动态优化驾驶策略。该方法利用不确定性评估和集群熵，突破传统依赖预设规则的局限，使AI能像人类驾驶员一样实时适应变道、加塞等复杂场景，避免过度保守行为（如无故急刹）导致的安全隐患。这项技术显著提升了自动驾驶在不确定环境中的适应性和安全性，标志着"边驾驶边学习"的突破性进展。相关论文已入选ICLR 2024会议。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T19:03:25Z
- **目录日期**: 2025-03-30
