...
香港大学、英伟达与图宾根大学联合团队提出Centaur方法，解决自动驾驶在变道、加塞等场景中过度保守的问题。传统自动驾驶依赖预设规则，导致无故急刹或避让，反而增加安全隐患。Centaur通过测试时在线学习（test-time training），动态优化驾驶策略，减少对固定规则的依赖，提升AI在不确定场景下的适应性和安全性。该技术首次实现自动驾驶系统"边开边学"，使车辆能像人类驾驶员一样灵活应对复杂路况。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T12:03:56Z
- **目录日期**: 2025-03-30
