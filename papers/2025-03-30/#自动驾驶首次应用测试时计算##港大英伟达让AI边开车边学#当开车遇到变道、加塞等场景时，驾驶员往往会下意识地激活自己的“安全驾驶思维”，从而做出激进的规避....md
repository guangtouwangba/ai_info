...
香港大学、英伟达与图宾根大学联合团队提出Centaur方法，通过测试时计算技术让自动驾驶系统实现"边开边学"。该方法利用集群熵和不确定性评估，动态优化驾驶策略，突破传统预设规则的局限。在变道、加塞等复杂场景中，系统能像人类驾驶员一样实时调整决策，避免过度保守行为（如无故急刹）带来的安全隐患。这项技术显著提升了自动驾驶在不确定性环境中的适应性和安全性，标志着AI驾驶系统从静态规则向动态学习的重要演进。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T09:03:54Z
- **目录日期**: 2025-03-30
