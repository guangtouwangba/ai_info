...
香港大学、英伟达和图宾根大学联合团队提出Centaur方法，通过测试时计算让自动驾驶系统边驾驶边学习。该方法利用不确定性评估动态优化驾驶策略，减少对预设规则的依赖，解决了传统自动驾驶在变道、加塞等场景中过度保守（如无故急刹）的问题。这种数据驱动的在线学习方式显著提升了AI在不确定环境中的适应性和安全性，使自动驾驶表现更接近人类驾驶员的安全决策模式。相关技术论文已发表于CVPR 2024。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T05:03:15Z
- **目录日期**: 2025-03-30
