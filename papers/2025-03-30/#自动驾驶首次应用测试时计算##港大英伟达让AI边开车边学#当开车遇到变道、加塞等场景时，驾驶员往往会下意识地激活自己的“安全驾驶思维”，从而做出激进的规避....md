...
香港大学、英伟达和图宾根大学联合团队开发了Centaur方法，通过测试时计算让自动驾驶系统能边驾驶边学习。该方法利用不确定性评估和在线数据驱动，动态优化驾驶策略，减少对预设规则的依赖。相比传统自动驾驶系统在变道、加塞等场景中过度保守的表现，Centaur提升了系统在不确定性环境中的适应性和安全性，避免了无故急刹或过度避让带来的安全隐患。这项技术标志着自动驾驶首次实现测试时的实时学习能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T16:03:43Z
- **目录日期**: 2025-03-30
