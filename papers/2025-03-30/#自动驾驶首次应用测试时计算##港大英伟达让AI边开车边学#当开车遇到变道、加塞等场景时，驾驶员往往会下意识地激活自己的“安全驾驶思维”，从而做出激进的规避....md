...
香港大学、英伟达与图宾根大学联合团队提出Centaur方法，通过测试时计算技术让自动驾驶系统实现"边开边学"。该方法利用在线数据驱动替代传统预设规则，能动态优化驾驶策略，解决现有自动驾驶在变道、加塞等场景中因过度谨慎导致的急刹、避让问题。Centaur通过不确定性评估和集群熵技术，显著提升了AI在复杂交通环境中的适应性和安全性，使自动驾驶车辆能像人类驾驶员一样灵活应对突发状况。这项突破标志着自动驾驶系统首次实现实时学习能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T10:03:38Z
- **目录日期**: 2025-03-30
