...
香港大学、英伟达与德国图宾根大学联合团队提出Centaur方法，通过测试时计算技术让自动驾驶系统能动态优化驾驶策略。该方法利用在线数据驱动学习，突破传统预设规则的局限，使AI能在行驶过程中实时学习应对变道、加塞等复杂场景，显著提升系统在不确定性环境中的适应性和安全性，避免因过度保守（如无故急刹）引发新隐患。这项突破标志着自动驾驶首次实现"边开边学"的能力，解决了现有模型机械遵循固定规则导致的"新手司机"式驾驶问题。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T03:17:54Z
- **目录日期**: 2025-03-30
