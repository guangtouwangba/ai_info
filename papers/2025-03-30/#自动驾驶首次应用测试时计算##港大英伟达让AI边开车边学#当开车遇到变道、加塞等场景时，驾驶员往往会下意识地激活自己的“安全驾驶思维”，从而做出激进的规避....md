...
香港大学、英伟达和图宾根大学联合团队提出Centaur方法，通过测试时计算技术让自动驾驶系统能动态优化驾驶策略。该方法利用在线数据驱动学习，减少对预设规则的依赖，解决了传统自动驾驶在变道、加塞等场景中过度谨慎的问题（如无故急刹）。Centaur通过实时评估不确定性并调整决策，显著提升了自动驾驶在复杂路况下的适应性和安全性，使AI能像人类驾驶员一样"边开边学"。这项技术有望减少因过度避让引发的安全隐患，推动自动驾驶技术发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T08:03:40Z
- **目录日期**: 2025-03-30
