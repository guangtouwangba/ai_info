...
香港大学、英伟达和图宾根大学联合团队提出Centaur方法，解决自动驾驶在变道、加塞等场景中过于保守的问题。该方法通过测试时在线学习（test-time training），动态优化驾驶策略，减少对预设规则的依赖，提升AI在不确定性路况下的适应性和安全性。相比传统自动驾驶模型"过度避让"的缺陷，新技术让车辆能像人类驾驶员一样实时调整决策，实现更自然的驾驶行为。这项突破首次将在线计算应用于自动驾驶测试阶段，标志着AI"边开边学"能力的重要进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T21:03:23Z
- **目录日期**: 2025-03-30
