...
香港大学、英伟达与图宾根大学联合团队提出Centaur方法，通过测试时在线学习优化自动驾驶决策。该方法突破传统依赖预设规则的局限，利用不确定性评估动态调整驾驶策略，使AI能像人类驾驶员一样在变道、加塞等复杂场景中灵活应对。相比保守型自动驾驶易产生的无故急刹问题，Centaur显著提升了系统在不确定性环境中的适应性和安全性，实现"边开边学"的类人化驾驶模式。相关技术论文首次将测试时计算应用于自动驾驶领域，标志着AI驾驶能力的重要突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-30T13:07:52Z
- **目录日期**: 2025-03-30
