...
信息技术深刻改变了人类获取信息的方式，但海量在线内容增加了获取相关信息的难度。近20年来，推荐系统和搜索引擎（统称信息检索系统）不断发展以应对这些挑战。大语言模型（LLMs）的最新进展在语言相关任务中展现出超越人类的能力，并具备理解、推理和决策等通用智能。本文探讨了LLM代理在增强推荐和搜索系统中的变革潜力，提出了分类框架梳理现有研究，并指出LLM代理解决当前挑战的巨大潜力。这是首个系统综述LLM代理在信息检索领域应用的论文，为未来研究提供了新视角。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T19:02:06Z
- **目录日期**: 2025-04-14
