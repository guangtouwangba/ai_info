...
这篇论文探讨了大语言模型（LLM）代理在推荐和搜索系统中的变革潜力。随着信息技术发展，海量在线内容使获取相关信息变得困难。近20年来，推荐系统和搜索引擎（统称信息检索系统）已显著进化。最新LLM在语言任务中展现出超越人类的能力，具备理解、推理和决策功能。研究系统梳理了LLM代理在这两个领域的研究现状，建立了分类框架，并指出其解决当前挑战的巨大潜力。这是首篇对LLM代理在推荐和搜索领域研究进行系统综述的论文，为利用这一先进AI技术提供了新视角。相关论文列表见文末GitHub链接。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T22:02:09Z
- **目录日期**: 2025-04-14
