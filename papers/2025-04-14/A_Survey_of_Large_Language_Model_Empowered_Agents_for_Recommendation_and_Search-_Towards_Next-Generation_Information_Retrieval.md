...
信息技术的快速发展改变了人类获取信息的方式，但海量在线内容也带来了信息过载问题。近二十年来，推荐系统和搜索引擎（统称信息检索系统）不断演进以应对这一挑战。最新的大型语言模型(LLM)在语言任务上展现出超越人类的能力，并具备理解、推理和决策等通用智能。本文系统探讨了LLM代理在改进推荐和搜索系统方面的潜力，提出了分类框架并梳理了相关研究，为未来研究方向提供了洞见。这是首个对LLM代理在信息检索领域应用进行系统综述的研究，相关论文列表可在GitHub链接中查阅。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T18:02:14Z
- **目录日期**: 2025-04-14
