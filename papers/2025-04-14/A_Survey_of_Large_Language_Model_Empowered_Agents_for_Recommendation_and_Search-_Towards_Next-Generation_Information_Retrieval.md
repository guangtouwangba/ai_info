...
信息技术深刻改变了人类获取信息的方式，但海量在线内容增加了获取相关信息的难度。近20年，推荐系统和搜索引擎（统称信息检索系统）不断发展以应对这一挑战。大语言模型（LLMs）的突破性进展在语言任务中展现出超越人类的表现，并具备理解、推理和决策能力。本文探讨LLM代理如何革新推荐与搜索系统，分析其动机、作用，建立分类框架梳理现有研究，指出LLM代理解决当前挑战的巨大潜力，为未来研究提供方向。这是首篇系统综述LLM代理在该领域应用的论文，相关研究列表见文末GitHub链接。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T13:09:55Z
- **目录日期**: 2025-04-14
