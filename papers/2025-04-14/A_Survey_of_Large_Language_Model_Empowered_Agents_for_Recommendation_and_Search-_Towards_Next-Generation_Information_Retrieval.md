...
这篇论文探讨了大语言模型（LLM）代理在推荐和搜索系统中的变革潜力。随着信息技术发展，海量在线内容使获取相关信息变得困难。近20年来，推荐系统和搜索引擎不断进化以应对挑战。LLM在语言任务中展现出超越人类的能力，具备理解、推理和决策等通用智能。研究系统梳理了LLM代理在这两个领域的研究现状，建立了分类框架，并指出其在解决当前信息检索挑战中的巨大潜力。这是首个对LLM代理在推荐和搜索领域研究进行系统综述和分类的工作，为利用这一先进AI技术提供了新视角。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T10:02:23Z
- **目录日期**: 2025-04-14
