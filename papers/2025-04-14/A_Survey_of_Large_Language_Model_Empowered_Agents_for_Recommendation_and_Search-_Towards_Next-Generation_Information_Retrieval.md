...
信息技术深刻改变了人类获取信息的方式，但海量在线内容也带来了信息过载问题。近20年来，推荐系统和搜索引擎不断发展以应对这一挑战。最新的大型语言模型(LLM)展现出超越人类的多项能力，包括理解、推理和决策。本文系统探讨了LLM智能体如何革新推荐和搜索系统，提出了分类框架并梳理现有研究，指出LLM在解决当前信息检索难题上的巨大潜力。这是首篇对该领域进行系统综述的论文，为利用这一先进AI技术提供了新视角。相关研究论文列表见文末GitHub链接。(99字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T23:02:08Z
- **目录日期**: 2025-04-14
