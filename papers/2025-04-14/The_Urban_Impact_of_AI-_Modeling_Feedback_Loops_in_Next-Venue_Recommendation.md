...
下一代场所推荐系统正日益融入基于位置的服务中，影响城市环境中的个人出行决策。本研究通过模拟框架探讨了推荐算法与人类行为之间的反馈循环，发现虽然推荐系统能增加个人访问场所的多样性，但也可能加剧集体不平等——使访问集中在少数热门地点。这种影响还体现在社交共现网络结构上，揭示了算法对城市可达性和空间隔离的潜在影响。该框架为评估AI辅助出行的社会影响提供了新视角，可作为预测风险、评估监管措施和设计伦理算法的工具。研究基于真实移动数据，系统比较了不同推荐策略的影响。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T00:01:24Z
- **目录日期**: 2025-04-14
