# #ICLR高分论文因未引用AI生成论文险被拒#有在离谱。高分论文因为没有引用先前的研究而被ICLR拒稿了？！【图1】于是作者提起上诉，审稿主席们推翻之前的决定，最...
...
ICLR一篇高分论文因未引用某篇"先前研究"险遭拒稿，经上诉后被接收为Spotlight。作者举报该被引论文存在实验结果矛盾、抄袭嫌疑，且疑似用Claude生成内容（但该文已被COLM 2024接收）。争议核心在于被要求引用的论文涉嫌学术不端，作者因此拒绝引用。事件引发学界对AI生成论文审查及学术伦理的讨论，双方后续披露更多细节，暴露当前学术评审体系存在的漏洞。（98字）  

关键点：  
1. 拒稿反转事件暴露评审机制问题  
2. 被引论文涉嫌AI生成与抄袭  
3. 学术诚信与AI伦理争议  
4. 两大顶会（ICLR/COLM）卷入风波

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T22:03:26Z
- **目录日期**: 2025-04-14
