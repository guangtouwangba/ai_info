...
ICLR高分论文因未引用某篇论文险遭拒稿，作者上诉后最终被接收。但争议升级：作者举报被要求引用的论文存在实验矛盾、抄袭其成果，且涉嫌用Claude生成内容（该论文已被COLM 2024接收）。作者因此拒绝引用。事件经网友曝光后引发双方新一轮争论，揭露更多细节。核心矛盾围绕学术诚信与AI生成内容的合规性展开。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T11:03:23Z
- **目录日期**: 2025-04-14
