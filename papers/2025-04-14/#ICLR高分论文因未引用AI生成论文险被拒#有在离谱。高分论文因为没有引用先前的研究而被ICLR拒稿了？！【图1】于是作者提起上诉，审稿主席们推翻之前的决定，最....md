...
ICLR一篇高分论文因未引用某篇"先前研究"险被拒稿，上诉后最终被接收。作者举报称该被引论文存在实验结果矛盾、抄袭嫌疑，且是用Claude生成的AI论文，但该文却被COLM 2024接收。双方作者展开争论，揭露更多细节，包括拒绝引用该论文是因质疑其学术诚信。事件引发对AI生成论文和学术规范的讨论。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T15:03:44Z
- **目录日期**: 2025-04-14
