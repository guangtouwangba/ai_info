...
ICLR高分论文因未引用某篇论文险遭拒稿，后经上诉被接收为Spotlight。作者举报该被引论文存在实验结果矛盾、抄袭嫌疑，且疑似用Claude生成内容，但该问题论文却被COLM 2024接收。争议双方披露更多细节，揭露学术不端争议。事件凸显AI生成论文与学术规范的冲突，引发对论文引用伦理及会议审稿机制的讨论。（99字）  
