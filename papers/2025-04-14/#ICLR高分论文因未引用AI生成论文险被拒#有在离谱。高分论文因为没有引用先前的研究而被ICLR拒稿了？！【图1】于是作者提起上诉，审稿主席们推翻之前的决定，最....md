...
ICLR高分论文因拒绝引用一篇涉嫌用Claude生成的争议论文险遭拒稿，经上诉后最终被接收。作者举报该"先前研究"存在实验结果矛盾、抄袭其成果等问题，但该论文仍被COLM 2024接收。事件引发双方公开争论，揭露涉事论文可能使用大模型生成等学术不端行为。这反映出当前AI生成内容对学术诚信审查带来的新挑战。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T10:03:17Z
- **目录日期**: 2025-04-14
