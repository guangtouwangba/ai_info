...
ICLR一篇高分论文因未引用某篇"先前研究"险遭拒稿，上诉后最终被接收。作者举报该被引论文存在实验矛盾、抄袭嫌疑，且疑似用Claude生成内容，但该论文仍被COLM 2024接收。争议双方在社交媒体持续交锋，揭露更多细节。事件暴露了AI生成论文的学术诚信问题及审稿流程的潜在漏洞。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T21:03:21Z
- **目录日期**: 2025-04-14
