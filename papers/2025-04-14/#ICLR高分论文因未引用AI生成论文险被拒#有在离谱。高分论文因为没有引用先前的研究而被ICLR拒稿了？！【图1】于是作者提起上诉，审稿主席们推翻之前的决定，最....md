...
ICLR高分论文因未引用某篇研究险遭拒稿，后经上诉被接收。作者举报该被引论文存在实验结果矛盾、抄袭嫌疑，且疑似用Claude生成内容，但该文仍被COLM 2024接收。争议双方披露更多细节，涉及学术诚信与AI生成论文的规范问题。事件凸显当前学术界对AI辅助研究的审查漏洞。（99字）  

（注：根据微博内容提炼核心争议点，包括：1.拒稿与上诉反转 2.被引论文的学术不端指控 3.AI生成内容争议 4.会议审查机制问题）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T20:03:32Z
- **目录日期**: 2025-04-14
