...
ICLR高分论文因未引用某篇AI生成论文险遭拒稿，后经上诉被接收为Spotlight。作者举报该"先前研究"存在实验结果矛盾、抄袭嫌疑，并指控其使用Claude生成论文内容。争议论文却被COLM 2024接收。双方在社交媒体持续争论，揭露更多细节，包括拒绝引用的正当理由和涉嫌学术不端行为。事件引发对AI生成论文审查标准和学术诚信的关注。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T12:03:40Z
- **目录日期**: 2025-04-14
