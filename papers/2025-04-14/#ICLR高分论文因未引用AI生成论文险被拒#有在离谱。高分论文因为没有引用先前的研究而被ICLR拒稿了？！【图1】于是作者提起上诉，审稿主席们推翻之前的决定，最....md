...
ICLR高分论文因拒绝引用一篇涉嫌造假的AI生成论文（被指用Claude生成且实验结果矛盾）而险遭拒稿。作者上诉后论文最终被接收为Spotlight，但事件引发更大争议：被举报论文不仅涉嫌抄袭原作者成果，还被COLM 2024会议接收。双方在后续争论中披露更多细节，凸显当前学术审查中AI生成内容引发的伦理问题。事件反映出学术界对AI辅助研究规范化的迫切需求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T14:03:35Z
- **目录日期**: 2025-04-14
