...
DocAgent是一种新型多智能体协作系统，通过拓扑代码处理和增量上下文构建自动生成高质量代码文档。该系统包含Reader、Searcher等专门化智能体协同工作，并采用评估框架从完整性、实用性和准确性三个维度衡量文档质量。实验表明，DocAgent显著优于基线方法，消融研究证实了拓扑处理顺序的关键作用。该方案为复杂和专有代码库提供了可靠的文档自动生成方法，解决了现有大语言模型生成文档不完整、不实用或错误的问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T17:01:13Z
- **目录日期**: 2025-04-14
