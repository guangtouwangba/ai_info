...
DocAgent是一种新型多智能体协作系统，通过拓扑代码处理和增量上下文构建来自动生成高质量代码文档。该系统包含阅读器、搜索器、编写器、验证器和协调器等专门化智能体，协同工作解决现有大语言模型在文档生成中存在的不完整、无用或事实错误等问题。研究者还提出了评估框架，从完整性、实用性和真实性三个维度进行评测。实验表明DocAgent显著优于基线方法，消融研究证实了拓扑处理顺序的关键作用。该系统为复杂专有代码库提供了可靠的文档自动生成解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T16:01:15Z
- **目录日期**: 2025-04-14
