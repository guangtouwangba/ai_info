...
加州理工学院在《Neuron》期刊发表研究指出，人脑信息处理速度约为每秒10bit，远低于感官接收能力（双眼可达3.2Gbps）。通过实验测算，人类思考和输出行为普遍受限于这一速率，导致大脑长期处于"信息过载"状态。研究认为进化形成的串行处理模式限制了多任务能力，并指出马斯克脑机接口难以突破这一生理瓶颈（10bit/s≈人类语言速度）。不过研究者强调，脑机接口的价值在于信息解码而非带宽提升。按此速率推算，人类一生所学信息量仅约4GB。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T00:03:00Z
- **目录日期**: 2025-04-14
