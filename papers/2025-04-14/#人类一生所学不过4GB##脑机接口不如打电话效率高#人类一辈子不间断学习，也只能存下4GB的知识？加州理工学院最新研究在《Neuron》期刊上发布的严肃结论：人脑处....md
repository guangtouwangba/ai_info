...
加州理工学院《Neuron》期刊最新研究显示，人脑信息处理速度仅为10bit/秒，远低于感官接收数据的3.2Gbps/秒。这意味着人类一生所学知识总量不超过4GB。研究发现大脑采用"串行处理"模式，限制了多任务能力。该结论对脑机接口技术提出挑战，指出其无法突破人脑固有的信息处理瓶颈，但仍有助信息解码功能。研究调侃称，打电话的语音传输效率已接近人脑处理极限。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T08:04:02Z
- **目录日期**: 2025-04-14
