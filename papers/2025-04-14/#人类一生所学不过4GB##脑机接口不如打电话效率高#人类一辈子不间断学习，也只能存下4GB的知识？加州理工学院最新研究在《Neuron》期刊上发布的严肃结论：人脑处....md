...
加州理工学院《Neuron》期刊最新研究表明，人脑信息处理速度存在约10bit/s的瓶颈。研究发现，无论是打字（高级打字员约10bit/s）还是感官输入（双眼3.2Gbps），大脑始终受限于串行处理模式。这意味着人类一生积累的知识量约4GB，且脑机接口难以突破这一生理极限。研究者指出，虽然Neuralink等脑机接口无法提高信息传输速率，但能帮助优化信息解码。该研究揭示了大脑进化形成的"单任务优先"机制，解释了人类在多任务处理上的天然局限性。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T07:03:41Z
- **目录日期**: 2025-04-14
