...
加州理工学院《Neuron》期刊研究揭示：人脑信息处理速度存在10bit/s的生理瓶颈，远低于感官接收的Gbps级数据量。通过打字、演讲等行为验证，人类持续学习70年仅能积累约4GB知识。这种进化形成的串行处理模式虽保障生存，却限制了多任务能力。研究质疑脑机接口突破带宽的可能性，指出其核心价值在于信息解码而非速率提升。该发现引发对认知极限与技术边界的讨论，暗示神经增强技术需另辟蹊径。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T04:03:31Z
- **目录日期**: 2025-04-14
