...
加州理工学院《Neuron》期刊研究显示，人脑信息处理速度仅约10bit/s，而感官接收达10亿bit/s，形成巨大"信息堵车"。通过打字、演讲等实验证实，人类认知输出普遍受限于这一速率。按此计算，终身学习积累约4GB数据。研究指出大脑进化形成的串行处理机制虽实用但限制多任务能力，并质疑脑机接口突破带宽的可能性，认为其核心价值在于信息解码而非速率提升。该发现引发对脑机接口技术本质的重新思考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T05:03:24Z
- **目录日期**: 2025-04-14
