...
加州理工学院《Neuron》期刊最新研究显示，人脑信息处理速度存在"10bit/s"的生理极限，相当于人类一生所学知识不超过4GB。研究发现，尽管感官每秒接收10亿比特数据（如双眼3.2Gbps），但大脑采用串行处理模式，导致高级认知活动（如打字、演讲）均受限于此速率。该研究质疑脑机接口突破带宽的可能性，指出其核心价值在于信息解码而非速率提升。研究者比喻称，当前人脑处理效率甚至低于电话通信，反映了进化形成的保守神经架构特性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T03:18:29Z
- **目录日期**: 2025-04-14
