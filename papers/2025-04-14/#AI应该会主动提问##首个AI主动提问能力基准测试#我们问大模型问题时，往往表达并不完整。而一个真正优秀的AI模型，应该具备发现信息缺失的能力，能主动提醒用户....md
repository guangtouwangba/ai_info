...
谷歌DeepMind提出首个AI主动提问能力基准测试QuestBench，通过四类任务评估模型识别信息缺失的能力。研究发现，GPT-4o和Claude 3.5在数学题表现优异（准确率80%-98%），但在逻辑和规划任务中较差（40%-50%）。模型常不敢承认不确定，反而胡乱猜测。结果表明提问能力与解题能力不同，实用AI系统需具备主动发现信息缺漏、引导用户澄清的能力。该研究填补了AI评估体系中提问能力测试的空白。论文地址：arxiv.org/abs/2503.22674

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T09:03:51Z
- **目录日期**: 2025-04-14
