...
谷歌DeepMind提出首个AI主动提问能力基准测试QuestBench，通过四类任务（逻辑、规划、数学题、数学等式）评估模型识别信息缺失的能力。研究发现：1）GPT-4等模型在数学题表现优异（80-98%准确率），但逻辑和规划类仅40-50%；2）模型常回避"不确定"选项（规划任务42%应选该选项）；3）解题能力不等于提问能力。该研究揭示了智能系统需兼具解答与主动提问能力，才能有效补全用户信息缺口。论文详见arxiv.org/abs/2503.22674。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T03:18:07Z
- **目录日期**: 2025-04-14
