...
本研究利用包含2000张高清图像的"南瓜叶病数据集"，测试了多种深度学习模型对5类叶片状态(霜霉病、白粉病、花叶病、细菌性叶斑病及健康叶片)的识别效果。结果表明，ResNet50模型表现最佳，准确率达90.5%，其他评估指标(精确率、召回率、F1分数)同样优异。研究还采用Grad-CAM等可解释AI技术，增强了模型决策过程的可理解性。该成果展示了ResNet50在实现南瓜叶病自动化精准诊断方面的潜力，有助于早期防治，提升农业生产效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T00:02:45Z
- **目录日期**: 2025-04-14
