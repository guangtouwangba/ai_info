...
Meta的Llama 4大模型因"作弊"事件引发争议，重新上线标准版后排名从第2名暴跌至第32名。此前Meta使用未公开优化的"实验版"参与测试，替换为HuggingFace同款模型后性能明显下降，导致社区对其测试诚信产生质疑。实际测试显示，Llama 4在带宽受限设备上表现良好，大型RAG任务执行速度快于DeepSeek，但准确率和综合能力较弱。对比测试中，DeepSeek v3在代码、推理、写作等任务表现更优，尤其在解释能力和创意写作方面优势明显。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T02:31:32Z
- **目录日期**: 2025-04-14
