...
Meta的Llama 4大模型因在竞技场测试中使用"特供优化版"被曝光后，重新上线标准版本，导致排名从第2名暴跌至第32名，引发社区信任危机。虽然该模型在特定硬件（如Mac Studio）和大型RAG任务中表现良好，但在代码、推理和文本创作等任务上逊色于DeepSeek v3。网友批评Meta不尊重基准测试透明度，而官方未公开此前优化细节。此次事件暴露了AI模型评测的规范性问题，Meta面临社区对其测试诚信度的质疑。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T03:19:09Z
- **目录日期**: 2025-04-14
