...
Meta的Llama 4大模型因"作弊"争议被重新测试，排名从第2名暴跌至第32名。此前Meta使用了专为人类偏好优化的"实验版"，但未公开具体优化方式，引发社区不满和信任危机。替换为HuggingFace同款模型后，性能表现明显下滑。虽然Llama 4在带宽受限设备上运行效果较好，但在代码、推理、写作等任务中表现不如DeepSeek v3。开发者指出其在大规模RAG任务中速度快但准确率较低，而DeepSeek在解释能力和创意写作方面更优。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T01:30:41Z
- **目录日期**: 2025-04-14
