...
Meta的Llama 4大模型因被曝在竞技场测试中使用"特供优化版"而引发争议。重新上线标准版后，其排名从第2名暴跌至第32名，导致社区对Meta产生信任危机。虽然Llama 4在内存充足但带宽受限的设备上表现良好，且在大型RAG任务中执行速度快，但在准确性、代码题和文本创作等方面仍逊色于DeepSeek v3等竞品。开发者指出，DeepSeek在解释能力和创意写作等任务上表现更优。这一事件凸显了AI基准测试的透明性问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T05:04:07Z
- **目录日期**: 2025-04-14
