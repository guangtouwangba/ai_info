# #Llama4重测竞技场排名大跳水##Meta遭竞技场信任危机#Llama 4在大模型竞技场“作弊”事件被曝光后，Meta重新上线了非特供版模型，但它的排名却从原本的第2名，直...
...
Meta的Llama 4大模型因被曝"作弊"后重新上线标准版，排名从第2暴跌至第32，引发社区信任危机。此前Meta使用未公开优化的"实验版"参与测试，替换为HuggingFace同款模型后性能显著下滑。实测显示，Llama 4在带宽受限设备（如Mac Studio）表现良好，大型RAG任务速度快于DeepSeek，但准确率较低。在代码、推理、写作等任务中，DeepSeek v3整体更优，尤其在解释能力和创意写作方面。开发者认为Llama 4仍有特定场景优势，但基准测试争议损害了Meta的公信力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T00:03:40Z
- **目录日期**: 2025-04-14
