...
Meta的Llama 4模型因被曝在竞技场测试中使用"特供优化版"而引发争议。重新上线标准版后，其排名从第2名暴跌至第32名，导致社区对Meta的信任危机。虽然Llama 4在带宽受限设备（如Mac Studio）和大型RAG任务中表现良好（速度快于DeepSeek），但在准确率、代码题、常识推理和文本创作（如故事结尾设计）等方面仍逊色于DeepSeek v3。开发者指出该模型并非糟糕，但Meta未公开"实验版"具体优化方式的行为遭到强烈质疑。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T06:02:51Z
- **目录日期**: 2025-04-14
