...
一款名为Optimus Alpha的神秘AI模型在OpenRouter平台上线仅三天就引发热潮，日均处理超200亿Token，最高达340亿。该模型在多领域表现优异：图像生成碾压同类产品，编程能力超越GPT-4.5，SQL查询排名第一，创意写作位列前四。其真实身份引发猜测，模型自称基于GPT-4（知识截止2024年6月），研究人员发现其与ChatGPT-4o和已下线的Quasar Alpha高度相似，Tokenizer漏洞特征指向可能出自OpenAI。目前其技术来源仍是个谜，网友推测可能与马斯克团队或OpenAI有关。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T04:03:42Z
- **目录日期**: 2025-04-14
