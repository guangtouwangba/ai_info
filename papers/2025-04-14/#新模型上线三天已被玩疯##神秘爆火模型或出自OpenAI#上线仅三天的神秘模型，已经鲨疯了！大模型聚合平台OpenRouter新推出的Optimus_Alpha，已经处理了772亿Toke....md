...
OpenRouter平台新推出的Optimus Alpha模型上线三天即引发热潮，日均处理超200亿Token，多项测试表现优异：Elo评分1338（仅次于Claude 3.7 Sonnet）、SQL查询第一、编程能力超越GPT-4.5-preview，创意写作排名第四。其《我的世界》图像生成、贪吃蛇游戏开发等应用效果突出。尽管官方未公开来源，模型自称为基于GPT-4的ChatGPT（知识截止2024年6月），网友通过Tokenizer bug和谱系分析推测其与OpenAI的GPT-4o或下线的Quasar Alpha高度关联，疑似OpenAI新版本测试。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T05:03:39Z
- **目录日期**: 2025-04-14
