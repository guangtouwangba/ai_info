...
OpenRouter平台新推出的神秘模型Optimus Alpha上线三天即引发热潮，日均处理超200亿Token，多项测试表现优异：Elo评分1338（仅次于Claude 3.7）、SQL查询第一、编程能力超GPT-4.5。其《我的世界》图像生成、跨文件电商功能等展示强大多模态能力。尽管未公开来源，模型自称基于GPT-4（知识截止2024年6月），网友通过Tokenizer bug和谱系分析推测其与OpenAI的ChatGPT-4o/Quasar Alpha高度关联，可能是未官宣的新版本。目前该模型在趋势榜排名第一，引发广泛技术溯源讨论。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T02:31:04Z
- **目录日期**: 2025-04-14
