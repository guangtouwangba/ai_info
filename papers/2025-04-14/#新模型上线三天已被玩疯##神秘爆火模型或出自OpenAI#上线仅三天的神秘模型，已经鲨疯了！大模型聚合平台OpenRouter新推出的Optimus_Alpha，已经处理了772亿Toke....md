...
OpenRouter平台新推出的神秘模型Optimus Alpha上线三天即引发热潮，日均处理超200亿Token，多项测试表现优异：Elo分数1338（仅次于Claude 3.7）、SQL查询第一、编程能力超GPT-4.5-preview，并能高效完成《我的世界》图像生成、贪吃蛇游戏开发等复杂任务。其自称基于GPT-4（知识截止2024年6月），研究者发现其与OpenAI模型存在Tokenizer bug等相似特征，推测可能是GPT-4.1或ChatGPT-4o的更新版本。真实开发者身份尚未公开，引发网友对马斯克或Sam Altman参与的猜测。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T08:04:13Z
- **目录日期**: 2025-04-14
