...
近日，一款名为Optimus Alpha的神秘AI模型在OpenRouter平台上线仅三天就引发热潮，日均处理Token超200亿，多项测试表现优异：Elo评分1338（仅次于Claude 3.7）、SQL查询第一、编程能力超越GPT-4.5，还能生成《我的世界》风格图像和构建电商网站。其身份引发猜测，模型自称基于GPT-4（知识截止2024年6月），研究者发现其与OpenAI的ChatGPT-4o及已下线的Quasar Alpha高度相似，存在特有Tokenizer漏洞。网友推测可能是OpenAI未官宣的新版本，目前相关分析仍在持续。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T06:02:22Z
- **目录日期**: 2025-04-14
