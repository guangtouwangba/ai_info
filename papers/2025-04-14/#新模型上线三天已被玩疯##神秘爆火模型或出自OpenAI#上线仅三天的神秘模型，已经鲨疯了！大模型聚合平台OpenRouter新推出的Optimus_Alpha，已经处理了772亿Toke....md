...
近日，OpenRouter平台推出的神秘AI模型Optimus Alpha上线三天即引发热潮，日均处理超200亿Token，多项测试表现亮眼：在图像生成、编程（超越GPT-4.5）、SQL查询（排名第一）及创意写作（第四名）等领域表现优异，甚至能完成跨文件电商任务。其自称基于GPT-4（知识截止2024年6月），技术特征与OpenAI模型高度相似（如Tokenizer bug），研究者推测可能是GPT-4o的更新版本或与已下线的Quasar Alpha为"兄弟模型"。目前其真实来源仍成谜，网友猜测涉及马斯克或OpenAI高层。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T03:18:42Z
- **目录日期**: 2025-04-14
