...
OpenRouter平台新上线的神秘AI模型Optimus Alpha表现惊人：上线3天处理772亿Token，日处理量超340亿，多项测试成绩优异（Elo 1338分、SQL第一、编程超GPT-4.5）。其能力覆盖图像生成（《我的世界》风格）、游戏开发、OCR识别等复杂任务，UI交互流畅。尽管未公开开发者，但模型自称为GPT-4基座（知识截止2024年6月），且被发现与OpenAI模型存在Tokenizer相同bug。研究员分析其行为类似ChatGPT-4o更新版，疑似OpenAI未官宣的新版本，引发社区热议。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T07:03:52Z
- **目录日期**: 2025-04-14
