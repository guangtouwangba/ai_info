# #131cm机器人图纸代码全部公开##傅里叶开源机器人#上海傅利叶推出首款开源人形机器人——Fourier N1，全身23个自由度、身高131cm、体重38kg。实测奔跑速度达3.5m...
...
上海傅利叶推出开源人形机器人Fourier N1，身高131cm，重38kg，具备23个自由度，运动能力出色（3.5m/s奔跑、上下楼梯等）。采用自研FSA 2.0执行器和控制系统，续航超2小时。首批开源包含完整图纸、物料清单、装配指南及控制代码，支持"乐高式"搭建。公司还推出Fourier Nexus平台推动行业生态共建，承诺持续更新算法框架。此举旨在降低人形机器人开发门槛，促进技术共享。（98字）  

注：保留核心参数（尺寸/自由度）、关键技术亮点（执行器/续航）、开源内容细节及生态建设目标，剔除冗余修饰词和具体动作示例，确保信息密度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T02:32:14Z
- **目录日期**: 2025-04-14
