...
上海傅利叶推出首款开源人形机器人Fourier N1，高131cm、重38kg，具备23个自由度，运动能力出色（3.5m/s奔跑速度）。采用自研FSA 2.0执行器和控制系统，结构紧凑且续航达2小时。首批开源包含完整图纸、物料清单、装配指南和基础代码，支持"乐高式搭建"。公司还搭建了Fourier Nexus平台推动行业生态共建，承诺持续更新算法框架。该开源项目显著降低了人形机器人开发门槛。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T01:31:18Z
- **目录日期**: 2025-04-14
