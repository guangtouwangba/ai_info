...
OpenAI前首席科学家Ilya Sutskever创立的AI公司Safe Superintelligence（SSI）近日完成20亿美元融资，估值达320亿美元，投资方包括Alphabet和英伟达。这家成立于2024年6月的初创公司专注研发"安全的超级智能"，采取独特策略——不推出中间产品，直接瞄准终极目标。目前团队仅20人，运作低调，招聘严格，并与谷歌云合作使用TPU芯片。尽管尚无产品和用户，但其纯粹愿景、顶尖团队和强大资本支持已引发行业高度关注。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T19:03:50Z
- **目录日期**: 2025-04-14
