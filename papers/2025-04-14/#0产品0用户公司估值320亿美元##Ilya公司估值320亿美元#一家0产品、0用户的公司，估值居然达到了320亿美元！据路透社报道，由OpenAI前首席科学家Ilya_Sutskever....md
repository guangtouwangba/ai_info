...
OpenAI前首席科学家Ilya Sutskever创立的AI公司Safe Superintelligence（SSI）完成20亿美元融资，估值达320亿美元。该公司成立于2024年6月，团队约20人，专注研发"安全的超级智能"，不推出中间产品。投资方包括Alphabet和英伟达。SSI采用高度保密策略，与谷歌云合作使用TPU芯片。尽管尚无产品和用户，其纯粹的技术愿景和顶尖团队吸引了资本青睐。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T23:03:46Z
- **目录日期**: 2025-04-14
