...
本文介绍AgentSociety，一个基于大语言模型的大规模社会模拟器，可模拟1万多个代理和500万次互动。研究者用它分析四个社会问题：社会极化、刺激性信息传播、基本收入政策效果和飓风等外部冲击的影响。模拟结果与现实数据吻合，验证了该工具在揭示人类行为机制方面的有效性。AgentSociety可作为计算社会科学的新实验平台，辅助传统研究方法，帮助学者和决策者理解社会问题的成因与模式。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T08:05:20Z
- **目录日期**: 2025-04-14
