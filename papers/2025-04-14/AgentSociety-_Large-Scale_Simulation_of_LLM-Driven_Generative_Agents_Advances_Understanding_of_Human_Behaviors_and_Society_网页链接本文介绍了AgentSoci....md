...
本文介绍了一种名为AgentSociety的大规模社会模拟器，它结合了大型语言模型驱动的代理、真实社会环境和强大的模拟引擎，模拟了1万多个代理及其500万次互动。研究者利用该平台研究了极化现象、刺激性信息传播、无条件基本收入政策及飓风等外部冲击的影响。模拟结果与现实世界实验数据吻合，验证了其在捕捉人类行为和社会机制方面的能力，展现了其作为社会科学研究和政策制定工具的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T05:05:09Z
- **目录日期**: 2025-04-14
