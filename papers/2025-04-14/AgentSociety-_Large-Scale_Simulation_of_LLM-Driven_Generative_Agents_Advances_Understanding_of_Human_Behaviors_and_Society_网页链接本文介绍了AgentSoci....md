...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟1万多个代理的社会互动（500万次交互）。它被用于研究极化现象、信息传播、基本收入政策及自然灾害影响等社会问题，结果与现实数据吻合。该系统展示了作为计算社会科学工具的强大潜力，能辅助传统研究方法（如调查、干预），帮助理解人类行为机制，并为政策制定提供支持。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T12:05:27Z
- **目录日期**: 2025-04-14
