...
该研究介绍了AgentSociety，这是一个利用大型语言模型驱动的大规模社会模拟器，包含超过1万个代理和500万次互动。该系统被用于研究四个关键社会问题：社会极化、信息传播、基本收入政策影响和外部冲击（如飓风）。模拟结果与现实世界数据吻合，验证了该平台在捕捉人类行为机制方面的有效性。研究表明AgentSociety可作为社会科学研究和政策制定的有力工具，为理解复杂社会现象提供新方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T04:05:04Z
- **目录日期**: 2025-04-14
