...
这篇论文介绍了AgentSociety，一个利用大语言模型驱动的大规模社会模拟器。该系统模拟了1万多个代理的社会生活及500万次互动，用于研究极化现象、信息传播、基本收入政策及自然灾害影响等社会问题。模拟结果与现实数据吻合，验证了该工具在揭示人类行为机制方面的有效性，展示了其作为社会科学研究和政策制定辅助工具的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T10:05:15Z
- **目录日期**: 2025-04-14
