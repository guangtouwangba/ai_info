...
AgentSociety是一个基于大语言模型的大规模社会模拟器，通过模拟1万多个代理和500万次互动，研究人类行为和社会现象。该系统作为计算社会科学实验平台，成功研究了社会极化、信息传播、基本收入政策及自然灾害影响等关键问题。其模拟结果与现实世界数据高度吻合，验证了该工具在揭示人类行为机制方面的有效性，展现了作为社会科学研究和政策制定辅助工具的潜力。该研究推动了LLM在社会系统建模中的应用，为传统研究方法提供了有力补充。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T00:05:35Z
- **目录日期**: 2025-04-14
