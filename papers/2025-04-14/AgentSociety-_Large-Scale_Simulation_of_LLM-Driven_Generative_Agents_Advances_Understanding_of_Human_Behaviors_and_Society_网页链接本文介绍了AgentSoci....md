...
本文介绍了一个名为AgentSociety的大规模社会模拟器，它结合了LLM驱动的智能代理、真实社会环境和强大的模拟引擎，模拟了超过1万个代理的500万次社会互动。研究者利用该平台进行了四个关键社会问题的实验：社会极化、刺激性信息传播、无条件基本收入政策影响以及飓风等外部冲击。模拟结果与现实世界数据吻合，验证了该工具在捕捉人类行为机制方面的能力，展示了其作为社会科学研究和政策制定辅助工具的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T17:05:09Z
- **目录日期**: 2025-04-14
