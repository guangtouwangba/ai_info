...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟1万多个AI代理的社会互动（500万次交互）。该系统作为计算社会科学实验平台，研究了四大社会问题：社会极化、刺激性信息传播、基本收入政策影响和自然灾害（如飓风）效应。其模拟结果与现实世界数据高度吻合，验证了系统对人类行为机制建模的有效性。该技术为社会科学研究和政策制定提供了新工具，能补充传统研究方法（如调查、访谈），帮助深入理解社会问题的成因与机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T07:05:11Z
- **目录日期**: 2025-04-14
