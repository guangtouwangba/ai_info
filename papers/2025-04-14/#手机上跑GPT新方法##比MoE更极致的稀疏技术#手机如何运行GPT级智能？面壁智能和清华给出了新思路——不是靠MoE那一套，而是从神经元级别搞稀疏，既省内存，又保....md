...
面壁智能与清华团队提出CFM技术（Configurable Foundation Models），通过神经元级稀疏激活实现在手机等端侧设备运行GPT级模型。相比MoE技术需限制激活专家数量，CFM利用模型天然稀疏性，根据任务难度动态激活神经元，既节省内存又保持性能。该技术尤其适合FFN层，支持模块化组合，可灵活适配不同终端设备（手机/笔记本/智能家居）。CFM摆脱了MoE的负载平衡限制，允许全参数参与运算，在保证效果的同时显著提升计算效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T00:03:50Z
- **目录日期**: 2025-04-14
