...
清华大学与面壁智能提出CFM（可配置基础模型）技术，通过神经元级稀疏化实现在手机等终端设备运行GPT级模型。相比MoE（专家混合）技术需固定激活专家数量，CFM根据任务难度动态激活神经元，既节省内存又保持性能。该技术特别适合前馈神经网络层，支持模块化组合，为手机、笔记本等端侧设备提供高效AI解决方案，无需负载平衡处理，实现全参数参与的高效运算。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T01:30:51Z
- **目录日期**: 2025-04-14
