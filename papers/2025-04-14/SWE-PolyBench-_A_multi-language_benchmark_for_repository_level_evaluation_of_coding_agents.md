...
研究人员开发了SWE-PolyBench，一个多语言基准测试，用于评估基于大语言模型的编码代理在真实场景中的表现。该基准包含2110个任务，涵盖Java、JavaScript、TypeScript和Python，涉及错误修复、功能添加和代码重构。研究还提供了500个任务的子集(SWE-PolyBench500)和自动化评估工具，并引入基于语法树分析的新指标。实验显示当前编码代理在不同语言和任务复杂度上表现不均，擅长简单任务但难以处理复杂问题。该基准旨在推动开发更通用、稳健的AI编程助手。数据集和代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T13:08:51Z
- **目录日期**: 2025-04-14
