...
研究人员开发了名为SWE-PolyBench的多语言基准测试平台，包含2110个任务实例（Java/JavaScript/TypeScript/Python），涵盖错误修复、功能添加和代码重构等场景。该平台提供自动化评估工具和基于语法树分析的新指标，用于全面评估AI编程助手。测试发现当前开源编码代理在不同语言和任务复杂度上表现不均，处理复杂问题能力有限。SWE-PolyBench旨在推动开发更强大、通用的AI编程助手，相关数据集和代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T21:01:11Z
- **目录日期**: 2025-04-14
