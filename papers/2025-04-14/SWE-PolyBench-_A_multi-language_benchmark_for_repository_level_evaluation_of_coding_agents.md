...
研究人员开发了SWE-PolyBench，一个多语言基准测试工具，用于评估基于大语言模型的编程助手性能。该工具包含2110个任务实例，涵盖Java、JavaScript、TypeScript和Python四种语言，涉及错误修复、功能添加和代码重构等任务。研究还提出了一套基于语法树分析的新评估指标，并测试了主流开源编程助手，发现它们在处理复杂问题时表现参差不齐，且在不同语言间性能差异明显。SWE-PolyBench旨在推动开发更强大、通用的AI编程助手，相关数据和代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T16:01:25Z
- **目录日期**: 2025-04-14
