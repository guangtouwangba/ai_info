...
研究人员开发了名为SWE-PolyBench的多语言基准测试工具，用于评估基于大语言模型的编程AI在真实场景中的表现。该工具包含2110个测试实例，覆盖Java、JavaScript、TypeScript和Python四种语言，涉及错误修复、功能添加和代码重构等任务。研究还提出了基于语法树分析的新评估指标，测试发现当前AI在不同语言和任务复杂度上表现不均衡，处理复杂问题时仍有困难。SWE-PolyBench旨在推动开发更强大、通用的AI编程助手。相关数据和代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T20:01:14Z
- **目录日期**: 2025-04-14
