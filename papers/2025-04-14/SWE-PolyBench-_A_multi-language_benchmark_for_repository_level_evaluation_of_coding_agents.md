...
研究人员开发了名为SWE-PolyBench的多语言基准测试工具，包含2110个来自21个代码库的任务实例，涵盖Java、JavaScript、TypeScript和Python四种语言，涉及错误修复、功能添加和代码重构等任务。该工具提供自动化评估框架和基于语法树分析的新指标，用于全面评估AI编程助手的性能。测试显示当前主流开源编程代理在不同语言和任务复杂度上表现不均，擅长简单任务但处理复杂问题时存在困难。该基准旨在推动开发更强大、通用的AI编程助手，相关数据和代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T07:01:17Z
- **目录日期**: 2025-04-14
