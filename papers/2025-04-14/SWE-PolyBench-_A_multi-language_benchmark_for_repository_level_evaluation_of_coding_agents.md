...
研究人员开发了名为SWE-PolyBench的多语言基准测试平台，包含2110个任务实例，涵盖Java、JavaScript、TypeScript和Python四种语言，涉及错误修复、功能添加和代码重构等任务。该平台提供自动化评估工具和基于语法树分析的新型指标，用于全面评估AI编程助手在不同语言和任务类型中的表现。测试发现当前AI编程助手在不同语言间表现不均，处理复杂任务时存在困难，但在简单任务上表现较好。该平台旨在推动开发更强大、通用的AI编程助手。相关数据和代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T15:01:17Z
- **目录日期**: 2025-04-14
