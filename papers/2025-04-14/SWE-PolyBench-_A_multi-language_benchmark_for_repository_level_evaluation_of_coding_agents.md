...
研究人员开发了名为SWE-PolyBench的多语言基准测试平台，用于评估基于大语言模型的编程AI代理性能。该平台包含2110个任务实例，覆盖Java、JavaScript、TypeScript和Python四种语言，涉及错误修复、功能添加和代码重构等任务。研究还提出了基于语法树分析的新评估指标，并测试了主流开源编程AI的表现。结果显示当前AI在不同语言和任务复杂度上表现不均，处理复杂问题仍存在困难。该基准测试旨在推动开发更强大、通用的AI编程助手。相关数据和代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T05:01:16Z
- **目录日期**: 2025-04-14
