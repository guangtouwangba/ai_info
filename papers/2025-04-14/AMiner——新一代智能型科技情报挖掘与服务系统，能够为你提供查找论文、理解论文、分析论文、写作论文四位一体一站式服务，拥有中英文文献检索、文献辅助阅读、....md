...
AMiner是一个智能科技情报挖掘系统，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献搜索、AI辅助阅读和翻译，涵盖42个学科的3.5亿论文、0.6亿学者等数据。功能包括：1）精准文献检索与智能问答；2）自动生成摘要和翻译英文文献；3）定制科研情报订阅，推送最新动态。此外，还提供学者画像、学术会议等工具。用户可通过网页免费使用，提升科研效率。网址：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T19:05:05Z
- **目录日期**: 2025-04-14
