...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献搜索、AI辅助阅读、自动摘要生成、翻译及互动问答功能，覆盖42个学科3.5亿论文。用户可订阅个性化科研动态，追踪学者或机构的最新成果。平台还包含学者画像、学术会议和论文排行榜等工具，支持PDF上传和文档解析，帮助高效获取和理解学术信息。免费使用，可通过网页或微信小程序访问。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T10:05:44Z
- **目录日期**: 2025-04-14
