...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、辅助阅读、翻译、摘要生成及科研动态订阅。它覆盖42个学科，拥有3.5亿论文、0.6亿学者等海量数据，支持用户通过提问快速理解文献内容，并定制个性化学术资讯推送。平台还提供学者画像、学术会议推荐等功能，浏览器即可免费使用，帮助研究者高效获取和分析学术信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T14:05:36Z
- **目录日期**: 2025-04-14
