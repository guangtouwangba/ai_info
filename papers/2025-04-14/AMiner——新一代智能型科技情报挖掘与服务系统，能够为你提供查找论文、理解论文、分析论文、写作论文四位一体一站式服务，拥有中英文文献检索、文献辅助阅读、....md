...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作一站式服务。其核心功能包括：1）中英文文献检索，支持互动问答和自动摘要生成；2）英文文献翻译与辅助阅读，可上传PDF并获取AI生成的摘要和章节概要；3）科研情报订阅，根据用户偏好推送最新学术动态。平台收录3.5亿论文、0.6亿学者等海量数据，覆盖42个学科，并提供学者画像、学术会议等增值服务。用户可通过网页免费使用基础功能，实现高效学术研究。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T07:05:41Z
- **目录日期**: 2025-04-14
