...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译及科研分析等一站式服务。它收录了3.5亿论文、0.6亿学者等海量学术资源，支持中英文文献检索、AI生成摘要、互动问答及文档翻译功能。用户可订阅个性化科研动态，追踪学者或机构的最新成果。平台还提供学者画像、学术会议信息等特色功能，浏览器端可免费使用，旨在提升科研效率。访问入口：https://www.aminer.cn/ 。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T12:05:59Z
- **目录日期**: 2025-04-14
