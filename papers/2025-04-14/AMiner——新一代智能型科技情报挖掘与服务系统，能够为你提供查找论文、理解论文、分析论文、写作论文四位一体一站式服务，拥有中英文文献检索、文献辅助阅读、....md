...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献搜索，能自动生成摘要和问答互动，帮助用户快速理解论文内容。平台还具备文档翻译、科研情报订阅功能，可根据用户偏好推送最新学术动态。AMiner收录了3.5亿论文、0.6亿学者等海量数据，并提供学者画像、学术会议等辅助功能。用户可通过网页免费使用基础服务，提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T09:05:43Z
- **目录日期**: 2025-04-14
