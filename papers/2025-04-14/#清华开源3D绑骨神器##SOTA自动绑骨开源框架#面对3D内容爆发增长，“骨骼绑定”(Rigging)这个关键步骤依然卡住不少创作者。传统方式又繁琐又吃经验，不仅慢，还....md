...
清华大学与VAST联合开源3D自动骨骼绑定框架UniRig，突破传统繁琐的手动绑骨流程。该框架采用自回归模型逐关节预测骨架结构，创新性引入骨骼树Tokenization技术，使处理效率提升30%，支持人形、动物、幻想生物及机械等多种模型。通过Rig-XL数据集（含1.4万+模型）训练，UniRig能同步预测蒙皮权重和骨骼物理属性（如刚体/重力影响），显著提升动画真实感。作为当前SOTA开源方案，其通用性为3D内容创作提供高效自动化支持。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T00:04:12Z
- **目录日期**: 2025-04-14
