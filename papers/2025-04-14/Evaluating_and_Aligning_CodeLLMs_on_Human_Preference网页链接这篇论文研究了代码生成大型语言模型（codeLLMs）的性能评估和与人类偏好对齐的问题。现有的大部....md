...
这篇论文探讨了代码生成大模型(codeLLMs)如何更好地匹配人类偏好。研究者创建了CodeArena基准测试(包含397个高质量样本，覆盖40类任务和44种语言)来评估模型在真实编程场景中的表现，并开发了包含近200亿标记的SynCode-Instruct合成指令集。实验发现传统基于执行的测试与人类偏好存在差异，且开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，凸显了模型对齐人类偏好的重要性。研究强调了在代码生成领域超越单纯正确性、关注用户体验的必要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T16:05:51Z
- **目录日期**: 2025-04-14
