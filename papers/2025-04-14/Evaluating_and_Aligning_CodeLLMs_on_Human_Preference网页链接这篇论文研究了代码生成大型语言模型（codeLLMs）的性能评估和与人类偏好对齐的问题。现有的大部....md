...
该论文针对代码生成大模型（codeLLMs）提出新评估方法，指出当前基准测试过于关注代码正确性而忽视人类偏好。研究团队开发了CodeArena基准（含397个高质量样本，覆盖40类任务和44种编程语言）和20B标记的合成指令数据集SynCode-Instruct。实验发现执行基准与人类偏好评估存在差异，开源模型（如Qwen2.5-Coder）与商业模型（如OpenAI o1）性能差距显著，凸显对齐人类偏好的重要性。成果发表于人工智能顶会，为代码LLM评估提供新维度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T08:05:59Z
- **目录日期**: 2025-04-14
