...
该论文提出CodeArena基准测试，聚焦代码生成大模型（codeLLMs）与人类偏好的对齐问题。通过397个涵盖40类编程任务的样本和44种语言，弥补现有基准忽视人类偏好的缺陷。研究还构建20B标记的SynCode-Instruct合成指令集验证微调效果。实验显示，执行基准与CodeArena存在差异，开源模型（如Qwen2.5-Coder）与专有模型（如OpenAI o1）性能差距显著，凸显对齐人类偏好的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T18:05:29Z
- **目录日期**: 2025-04-14
