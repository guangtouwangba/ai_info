...
这篇论文针对代码生成大模型（codeLLMs）与人类偏好对齐的问题，提出了CodeArena基准测试和SynCode-Instruct合成指令数据集。CodeArena包含397个高质量样本，覆盖40类编程任务和44种语言，更贴近实际开发需求。研究发现在传统执行测试与人类偏好评估间存在性能差异，开源模型（如Qwen2.5-Coder）与商业模型（如OpenAI o1）表现差距显著。通过20B标记的指令微调实验，验证了大规模合成数据对提升模型对齐效果的有效性，凸显了代码生成模型优化中人类偏好校准的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T14:05:48Z
- **目录日期**: 2025-04-14
