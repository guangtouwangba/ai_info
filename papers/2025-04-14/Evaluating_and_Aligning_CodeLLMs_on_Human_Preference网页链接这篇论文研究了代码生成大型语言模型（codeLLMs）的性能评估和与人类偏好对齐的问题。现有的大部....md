...
这篇论文探讨了代码生成大模型（codeLLMs）与人类偏好的对齐问题。研究发现现有基准主要评估代码正确性，忽视了人类偏好匹配。为此，作者构建了CodeArena基准（含397个高质量样本，覆盖40类44种语言）和SynCode-Instruct合成指令集（20B标记）。实验显示执行基准与CodeArena存在性能差异，开源模型（如Qwen2.5-Coder）与专有模型（如OpenAI o1）差距显著，凸显了人类偏好对齐的重要性。研究为代码LLM评估提供了更全面的框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T00:06:18Z
- **目录日期**: 2025-04-14
