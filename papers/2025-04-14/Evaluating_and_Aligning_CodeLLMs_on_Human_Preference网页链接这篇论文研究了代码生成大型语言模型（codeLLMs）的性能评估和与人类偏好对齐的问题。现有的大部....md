...
这篇论文探讨了代码生成大模型(codeLLMs)与人类偏好的对齐问题。研究者创建了CodeArena基准测试(含397个样本，覆盖40类编程任务和44种语言)，发现传统基于执行的评估与人类偏好存在差异。同时构建了20B标记的合成指令数据集SynCode-Instruct验证微调效果。实验比较40多个模型显示，开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)存在显著差距，凸显了模型与人类偏好对齐的重要性。研究强调了在代码生成评估中考虑人类偏好的必要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T15:05:58Z
- **目录日期**: 2025-04-14
