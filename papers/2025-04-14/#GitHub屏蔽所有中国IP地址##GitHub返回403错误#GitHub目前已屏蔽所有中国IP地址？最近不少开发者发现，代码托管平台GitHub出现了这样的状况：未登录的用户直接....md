...
近日开发者发现GitHub对中国IP实施访问限制：未登录用户访问主站会返回403错误，已登录用户仍可正常使用。测试显示该限制主要针对中国大陆IP，导致未登录状态下多数页面无法访问。此前GitHub在中国长期处于不稳定访问状态，用户常需通过加速器等技术手段访问。此次限制进一步提高了访问门槛，但GitHub官方尚未就此作出说明。这一变化引发开发者社区对平台"主动屏蔽"中国IP的猜测。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T07:03:11Z
- **目录日期**: 2025-04-14
