...
GitHub近期疑似对中国IP实施访问限制，未登录用户访问时会返回HTTP 403错误，已登录用户仍可正常使用。经测试，中国大陆IP在未登录状态下多数页面无法访问，开发者推测可能是平台主动采取的屏蔽措施。此前GitHub在中国处于不稳定访问状态，常需通过加速器或修改hosts访问。目前官方未对此事作出回应，访问门槛显著提高。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T05:02:52Z
- **目录日期**: 2025-04-14
