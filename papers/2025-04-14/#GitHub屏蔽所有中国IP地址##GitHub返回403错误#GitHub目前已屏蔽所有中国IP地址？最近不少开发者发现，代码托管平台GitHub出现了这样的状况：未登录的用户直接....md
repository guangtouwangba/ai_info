...
近日开发者发现GitHub对中国IP实施访问限制：未登录用户访问时会返回HTTP 403错误，已登录用户仍可正常使用。测试显示中国大陆IP在未登录状态下多数页面无法访问，推测可能是平台主动采取的屏蔽措施。此前GitHub在中国一直处于不稳定访问状态，常需通过加速器等技术手段访问。目前官方未对此事作出回应，该限制显著提高了中国开发者的使用门槛。这一变化引发广泛关注，但具体原因尚不明确。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T09:03:41Z
- **目录日期**: 2025-04-14
