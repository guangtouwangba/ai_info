...
GitHub官方回应中国IP访问问题，称是由于系统配置更改导致未登录用户出现403错误，并非针对特定地区的限制。登录用户不受影响，目前配置已回滚，访问恢复正常。但网友实测部分IP仍无法连接。此前GitHub在中国处于"灰色访问"状态，资源加载常需借助加速器。此次事件引发开发者关注，官方承诺今后避免类似情况。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T05:02:36Z
- **目录日期**: 2025-04-14
