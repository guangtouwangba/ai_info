...
本文提出了TP-RAG基准测试，专注于提升大语言模型(LLMs)在旅游规划中的时空合理性。该数据集包含2,348个真实旅游查询、85,575个细粒度POI标注和18,784条高质量旅游轨迹，支持动态规划。研究表明，参考轨迹能显著提升空间效率和POI合理性，但仍面临通用性和鲁棒性挑战。为此，作者提出EvoRAG进化框架，将检索轨迹与LLM推理能力结合，在时空合规性和常识性错误减少方面优于现有方法。这项工作展示了网络知识与LLM优化结合的潜力，为更可靠的旅游规划代理铺平了道路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T14:01:37Z
- **目录日期**: 2025-04-14
