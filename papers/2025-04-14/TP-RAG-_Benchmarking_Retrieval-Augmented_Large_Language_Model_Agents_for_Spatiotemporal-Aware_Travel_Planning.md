...
本文提出TP-RAG，首个面向时空感知旅游规划的检索增强基准，包含2348个真实查询、85,575个细粒度POI和18,784条高质量参考轨迹。研究发现参考轨迹能显著提升空间效率和POI合理性，但普遍性和鲁棒性仍受冲突数据和噪声影响。为此，作者提出EvoRAG进化框架，通过协同多源轨迹与LLM推理能力，在时空合规性和常识规避方面优于基线方法。该工作展示了网络知识与LLM优化结合的潜力，为开发更可靠、自适应的旅游规划智能体提供了新思路。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T11:01:43Z
- **目录日期**: 2025-04-14
