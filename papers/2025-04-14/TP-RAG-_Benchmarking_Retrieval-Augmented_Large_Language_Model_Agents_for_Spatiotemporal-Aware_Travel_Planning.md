...
本文提出TP-RAG基准测试，针对检索增强的时空感知旅行规划，包含2348个真实查询、85,575个细粒度POI和18,784条高质量轨迹数据。研究发现，结合参考轨迹能显著提升旅行计划的空间效率和POI合理性，但在通用性和鲁棒性方面仍存在挑战。为解决这些问题，作者提出EvoRAG进化框架，有效融合多源轨迹与LLM推理能力，在时空合规性和常识性错误减少方面表现优异。该工作展示了网络知识与LLM优化结合的潜力，为开发更可靠、自适应的旅行规划代理奠定了基础。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T09:01:39Z
- **目录日期**: 2025-04-14
