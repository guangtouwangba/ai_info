...
该研究提出了TP-RAG基准测试，专注于提升大语言模型（LLM）在旅行规划中的时空合理性。TP-RAG包含2,348个真实旅行查询、85,575个细粒度标注的兴趣点（POI）和18,784条高质量参考轨迹，旨在优化路线效率、POI吸引力和实时适应性。实验表明，参考轨迹能显著提升空间效率和POI合理性，但仍面临通用性和鲁棒性挑战。为此，研究者提出EvoRAG框架，结合检索轨迹与LLM推理能力，在时空合规性和常识性错误减少方面表现优异，为可靠、自适应的旅行规划代理提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T22:01:31Z
- **目录日期**: 2025-04-14
