...
该研究提出了TP-RAG基准测试，针对检索增强的时空感知旅行规划，包含2,348个真实旅行查询、85,575个细粒度POI和18,784条高质量旅行轨迹。实验表明，参考轨迹能提升规划的空间效率和POI合理性，但普遍性和鲁棒性仍受冲突参考和噪声数据影响。为此，研究者开发了EvoRAG进化框架，有效结合检索轨迹与LLM推理能力，在时空合规性和常识违反率上优于基线方法。该工作展示了网络知识与LLM优化结合的潜力，为开发更可靠、自适应的旅行规划智能体奠定了基础。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T05:01:37Z
- **目录日期**: 2025-04-14
