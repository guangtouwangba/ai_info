...
本文提出TP-RAG基准测试，针对检索增强的时空感知旅行规划，包含2348个真实查询、85,575个细粒度POI和18,784条高质量参考轨迹。研究发现参考轨迹能提升规划的空间效率和POI合理性，但仍存在通用性和鲁棒性挑战。为此，作者提出EvoRAG进化框架，融合多源轨迹与LLM推理，在时空合规性和常识错误方面优于现有方法。该工作展示了网络知识与LLM优化结合的潜力，为开发更可靠、自适应的旅行规划系统铺平了道路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T17:01:43Z
- **目录日期**: 2025-04-14
