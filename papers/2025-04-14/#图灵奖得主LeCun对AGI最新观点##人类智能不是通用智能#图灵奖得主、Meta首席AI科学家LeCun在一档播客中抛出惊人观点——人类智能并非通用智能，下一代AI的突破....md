...
图灵奖得主LeCun提出，人类智能并非通用智能（AGI），而是专注于生存相关问题的专业智能。他认为当前生成式AI（如大语言模型）缺乏物理世界理解和推理能力，连猫的空间认知都不具备。未来AI突破可能来自非生成式架构（如Meta的JEPA），需建立"世界模型"以实现推理、规划和记忆。他预测十年内或有重大进展，并强调Meta的开源策略将推动生态发展。智能眼镜被视为AI落地的关键场景。最终目标不是提升对话能力，而是让AI像动物一样理解并交互物理世界。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T14:03:26Z
- **目录日期**: 2025-04-14
