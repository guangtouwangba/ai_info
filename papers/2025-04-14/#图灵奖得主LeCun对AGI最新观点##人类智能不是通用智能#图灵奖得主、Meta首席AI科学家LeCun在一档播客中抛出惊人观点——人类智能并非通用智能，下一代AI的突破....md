...
图灵奖得主LeCun在播客中提出：1）人类智能本质是"专用智能"，仅擅长生存相关任务，并非真正的通用智能（AGI）；2）当前生成式AI（如大模型）缺乏物理世界理解和推理能力，甚至不及猫的认知水平；3）下一代AI突破可能来自"非生成式"架构（如Meta的JEPA），需具备世界模型、规划能力和长期记忆；4）AGI短期内难以实现，但十年内或有重大进展；5）Meta坚持开源路线推动生态发展，并看好智能眼镜作为AI落地场景。他强调AI未来应像动物一样理解并交互物理世界。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T17:03:32Z
- **目录日期**: 2025-04-14
