...
图灵奖得主LeCun提出，人类智能并非真正的通用智能（AGI），而是专注于生存相关问题的专业智能。他认为当前生成式AI（如大语言模型）缺乏物理世界理解和推理能力，不如猫的认知水平。未来AI突破可能来自非生成式架构（如Meta的JEPA），需具备世界模型、规划能力和长期记忆。LeCun反对AGI短期可实现的观点，但预计十年内或有重大进展。Meta坚持开源策略推动生态发展，并看好智能眼镜作为AI落地场景。他强调下一代AI应像动物一样理解世界并具备行动能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T11:03:15Z
- **目录日期**: 2025-04-14
