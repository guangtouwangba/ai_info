...
图灵奖得主LeCun提出颠覆性观点：人类智能本质是"专用智能"而非通用智能（AGI），当前生成式AI（如大语言模型）缺乏物理世界理解与推理能力，甚至不如猫的空间认知水平。他认为下一代AI突破需构建"世界模型"，Meta的JEPA架构通过抽象推理实现非生成式进步。LeCun预测十年内或有重大进展，强调AI应像动物般具备行动规划能力，并持续推动开源生态。智能眼镜被视为AI落地的关键场景，而Meta将通过产品而非模型直接变现。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T22:03:16Z
- **目录日期**: 2025-04-14
