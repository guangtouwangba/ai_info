...
图灵奖得主LeCun在播客中提出：人类智能并非真正的通用智能（AGI），而只是擅长解决与生存相关的特定问题。他认为当前生成式AI（如大语言模型）缺乏物理世界理解和推理能力，远不如猫的认知水平。未来AI突破可能来自非生成式架构（如Meta的JEPA），需具备世界模型、长期记忆和规划能力。他预测十年内或有重大进展，并强调Meta坚持开源策略以推动生态发展。智能眼镜被视为AI落地的关键场景，而AI的下一步应是像动物一样理解并互动于物理世界。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T10:03:09Z
- **目录日期**: 2025-04-14
