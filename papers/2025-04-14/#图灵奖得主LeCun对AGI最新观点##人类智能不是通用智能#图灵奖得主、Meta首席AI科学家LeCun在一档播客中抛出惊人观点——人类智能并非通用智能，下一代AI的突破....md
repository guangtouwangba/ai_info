...
图灵奖得主LeCun提出颠覆性观点：人类智能本质是"专用智能"而非通用智能（AGI），当前生成式AI（如大语言模型）缺乏物理世界理解和推理能力，甚至不如猫的空间认知水平。他认为下一代AI突破方向应是构建具备"世界模型"的非生成式架构（如Meta的JEPA），实现物理规律理解、长期记忆和行动规划。LeCun预测十年内或有重大进展，并强调Meta开源策略的价值。智能眼镜被视为AI落地的关键载体，未来AI发展核心是赋予机器动物般的环境理解与行动能力，而非单纯优化对话能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T13:11:12Z
- **目录日期**: 2025-04-14
