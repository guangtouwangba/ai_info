...
图灵奖得主LeCun在播客中提出：1）人类智能本质是"专用智能"，仅擅长生存相关任务，AGI概念被过度神化；2）当前生成式AI（如大模型）缺乏物理世界理解与推理能力，不如猫的认知水平；3）下一代AI突破方向应是构建"世界模型"，发展非生成式架构（如Meta的JEPA），实现物理推理、规划与长期记忆；4）AGI短期难实现，但十年内或有重大进展；5）Meta坚持开源推动生态，智能眼镜是AI落地关键场景。AI未来需向动物级环境理解与行动能力进化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T15:03:35Z
- **目录日期**: 2025-04-14
