# #图灵奖得主LeCun对AGI最新观点##人类智能不是通用智能#图灵奖得主、Meta首席AI科学家LeCun在一档播客中抛出惊人观点——人类智能并非通用智能，下一代AI的突破...
...
图灵奖得主LeCun在播客中提出，人类智能并非真正的通用智能（AGI），而是高度专业化且局限于生存相关领域。他认为当前生成式AI（如大语言模型）缺乏物理世界理解、推理和规划能力，甚至不如猫的认知水平。未来AI突破可能来自非生成式架构（如Meta的JEPA），需构建"世界模型"以实现物理规律理解和长期规划。LeCun预测十年内或有重大进展，并强调Meta坚持开源策略推动生态发展。智能眼镜被视为AI落地的关键场景，下一代AI应侧重环境感知与行动能力，而非仅优化对话能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T12:03:30Z
- **目录日期**: 2025-04-14
