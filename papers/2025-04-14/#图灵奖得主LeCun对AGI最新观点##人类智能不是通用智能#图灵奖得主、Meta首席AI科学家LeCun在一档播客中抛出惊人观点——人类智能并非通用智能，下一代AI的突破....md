...
图灵奖得主LeCun在播客中提出：1）人类智能并非真正的通用智能（AGI），仅擅长生存相关领域；2）当前生成式AI（如大模型）缺乏物理世界理解和推理能力，不如猫的认知水平；3）未来AI突破方向应是构建"世界模型"，具备物理理解、规划、记忆等能力，可能通过非生成式架构（如Meta的JEPA）实现；4）AGI短期难实现，但10年内或有重大进展；5）Meta坚持开源策略推动生态发展，看好智能眼镜作为AI落地场景。他强调AI需向动物级认知进化，而非仅提升对话能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-14T21:03:14Z
- **目录日期**: 2025-04-14
