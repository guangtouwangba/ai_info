...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和科研订阅等一站式服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持中英文文献检索，并能通过AI生成摘要和问答互动帮助用户快速理解内容。平台还提供文献翻译、文档识别、学术动态订阅（通过微信或邮件推送）以及学者画像等功能。用户可免费使用其浏览器检索服务，实现高效科研信息获取与分析。访问官网或AI交互页面即可体验。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T00:05:34Z
- **目录日期**: 2025-04-07
