...
AMiner是一款智能科技情报挖掘系统，提供论文检索、阅读、分析和写作一站式服务。支持中英文文献搜索，可自动生成摘要和问答互动，提升研究效率。具备文档翻译、辅助阅读功能，用户可上传或选择论文获取AI生成的概要。提供科研动态订阅服务，按用户偏好推送最新学术资讯。平台涵盖3.5亿论文、0.6亿学者等海量数据，免费开放使用。网址：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T19:05:06Z
- **目录日期**: 2025-04-07
