...
AMiner是一个智能科技情报挖掘平台，提供论文检索、辅助阅读、翻译和科研订阅等一站式服务。它收录了3.5亿论文、0.6亿学者和1.5亿专利，支持中英文文献检索，并能自动生成摘要和问答互动。用户可上传PDF或从库中选取文献，获取AI生成的摘要和章节概要。平台还提供定制化科研动态推送，根据用户关注的学者、机构或关键词筛选最新论文。此外，AMiner具备学者画像、学术会议和论文排行榜等功能，基础检索服务免费开放。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T02:33:31Z
- **目录日期**: 2025-04-07
