...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和科研情报订阅等一站式服务。它收录了3.5亿篇论文、6000万学者和1.5亿专利，支持中英文文献检索、AI生成摘要、互动问答和文档翻译功能。用户可定制订阅最新科研动态，通过微信或邮件接收个性化推荐。平台还提供学者画像、学术会议和论文排行榜等工具，免费使用，帮助研究者高效获取和分析学术信息。访问链接：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T13:12:49Z
- **目录日期**: 2025-04-07
