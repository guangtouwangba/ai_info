...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献搜索，拥有3.5亿论文、0.6亿学者等海量数据，并提供AI辅助阅读、自动摘要生成和互动问答功能。用户可上传PDF或从平台获取论文，快速生成摘要和章节概要。此外，AMiner支持科研动态订阅，按用户偏好推送最新学术资讯。平台还包含学者画像、学术会议等特色功能，可通过浏览器免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T21:04:52Z
- **目录日期**: 2025-04-07
