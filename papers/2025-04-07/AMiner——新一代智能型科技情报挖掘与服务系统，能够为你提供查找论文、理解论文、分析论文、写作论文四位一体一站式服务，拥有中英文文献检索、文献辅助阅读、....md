...
AMiner是一个智能科技情报挖掘平台，提供一站式科研服务，包括中英文文献检索、辅助阅读、翻译和论文写作支持。它拥有庞大的学术资源库，涵盖42个学科的3.5亿论文、0.6亿学者和1.5亿专利。主要功能包括：1）高效文献检索与智能问答；2）自动生成摘要和翻译；3）科研动态订阅服务，通过微信或邮件推送最新研究。此外，还提供学者画像、学术会议和论文排行榜等功能。用户可免费使用其浏览器检索服务，网址为https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T18:05:17Z
- **目录日期**: 2025-04-07
