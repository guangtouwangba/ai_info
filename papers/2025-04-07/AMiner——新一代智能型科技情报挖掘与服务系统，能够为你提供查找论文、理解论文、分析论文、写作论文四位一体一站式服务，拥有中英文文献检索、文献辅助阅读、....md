...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读、分析和写作的一站式服务。它支持中英文文献搜索、自动摘要生成、互动问答和文档翻译，涵盖42个学科3.5亿论文。用户可上传PDF或从平台获取文献，AI会生成摘要和章节概要，并支持内容提问。此外，AMiner提供科研动态订阅服务，按用户偏好推送最新论文摘要。平台还包括学者画像、学术会议和论文排行榜等功能，基础检索免费使用。网址：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T05:04:57Z
- **目录日期**: 2025-04-07
