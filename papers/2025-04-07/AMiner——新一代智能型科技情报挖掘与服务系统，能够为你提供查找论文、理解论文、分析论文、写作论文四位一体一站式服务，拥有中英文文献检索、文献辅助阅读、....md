...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析及写作一站式服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持中英文文献检索、AI辅助阅读、自动摘要生成及互动问答功能。用户可订阅个性化科研动态，通过微信或邮件获取最新学术资讯。平台还提供学者画像、学术会议等扩展功能，支持免费使用，网址为https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T15:05:21Z
- **目录日期**: 2025-04-07
