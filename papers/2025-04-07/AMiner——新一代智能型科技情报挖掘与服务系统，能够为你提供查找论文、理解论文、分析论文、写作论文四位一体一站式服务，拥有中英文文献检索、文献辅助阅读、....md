...
AMiner是一个智能科技情报挖掘平台，提供论文检索、阅读辅助、翻译和科研订阅等一站式服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持中英文文献检索，并能通过AI生成摘要和问答互动。用户可上传PDF或从平台获取论文，系统会快速解析内容并提供章节概要和问题建议。此外，AMiner支持个性化科研动态订阅，按用户关注的学者、机构或关键词推送最新论文摘要。平台还包含学者画像、学术会议等特色功能，可免费使用。网址：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T16:05:27Z
- **目录日期**: 2025-04-07
