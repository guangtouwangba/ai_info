...
这篇264页的联合综述由Google DeepMind、微软等顶级机构合作完成，提出了"基础智能体"(Foundation Agents)的类人架构。研究将AI Agent划分为感知、认知、世界模型、情绪、记忆和行动六大仿人模块，指出当前AI在情绪体验、长期记忆和因果推理等方面仍存在明显短板。论文强调Agent需要自我优化能力，并提出提示词优化、在线学习等进化机制，同时探讨了幻觉、越狱攻击等安全问题。作者认为，要实现人类级智能，必须整合多个子系统并持续迭代，而人脑结构为此提供了最佳蓝图。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T10:02:23Z
- **目录日期**: 2025-04-07
