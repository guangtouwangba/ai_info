...
这篇264页的综述论文由Google DeepMind、微软等顶级机构联合发表，提出了"基础智能体"(Foundation Agents)的类人架构。研究者将AI Agent拆解为仿人模块：感知、认知、世界模型、情绪、记忆和行动系统，指出当前AI在情绪体验、长期记忆和因果推理等方面仍存在短板。论文强调AI需要自我优化能力，提出了提示词优化、在线学习等进化机制，并讨论了幻觉、越狱攻击等安全问题。作者认为，要实现人类级别智能，必须整合多个子系统并持续迭代，而人脑是最佳参考模型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T20:03:07Z
- **目录日期**: 2025-04-07
