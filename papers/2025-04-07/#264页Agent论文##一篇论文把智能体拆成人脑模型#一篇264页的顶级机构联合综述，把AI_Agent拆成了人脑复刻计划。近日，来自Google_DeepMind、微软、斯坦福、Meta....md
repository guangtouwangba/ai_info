...
这篇264页的联合综述由Google DeepMind、微软等顶级机构共同完成，提出了"基础智能体"(Foundation Agents)的类人架构。研究将AI Agent划分为感知、认知、世界模型、情绪、记忆和行动六大仿人模块，指出当前AI在情绪体验、长期记忆和因果推理等方面仍存在明显短板。论文强调需要整合多个子系统并引入自优化机制（如提示词优化、工具学习），同时提出"超级对齐"等安全概念应对AI风险。研究认为人脑是构建人类级别智能的最佳蓝图，大语言模型仅是发展Agent的"引擎"。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T09:02:06Z
- **目录日期**: 2025-04-07
