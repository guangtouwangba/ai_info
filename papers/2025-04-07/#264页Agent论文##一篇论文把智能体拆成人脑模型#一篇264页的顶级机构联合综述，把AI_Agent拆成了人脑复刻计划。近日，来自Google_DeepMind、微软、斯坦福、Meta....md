...
这篇264页的综述论文由Google DeepMind、微软等顶级机构联合发表，提出以人脑为蓝图的"基础智能体"架构。研究将AI Agent拆解为感知、认知、世界模型、情绪、记忆和行动六大仿人模块，指出当前AI在情绪体验、长期记忆和因果推理等方面仍存在明显短板。论文强调Agent需要自我优化能力（如提示词优化、工具学习），并探讨了幻觉、越狱攻击等安全问题，提出"超级对齐"等监管方案。作者认为，要实现人类级智能，必须整合多子系统并持续进化，人脑结构为此提供了最佳参考框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T14:03:42Z
- **目录日期**: 2025-04-07
