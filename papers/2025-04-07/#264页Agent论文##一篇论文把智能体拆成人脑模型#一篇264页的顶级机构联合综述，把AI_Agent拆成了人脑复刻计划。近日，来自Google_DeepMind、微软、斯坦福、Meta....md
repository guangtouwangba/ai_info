...
这篇264页的综述论文由Google DeepMind、微软等顶级机构联合发表，提出将AI智能体(Agent)构建为仿人脑的"基础智能体"框架。该框架包含感知、认知、世界模型、情绪、记忆和行动六大类人模块，并指出当前AI在情绪体验、长期记忆和因果推理等方面仍存在明显短板。论文强调AI需具备自我优化能力，提出提示词优化、在线学习和工具学习等进化机制，同时探讨了幻觉、越狱攻击等安全问题，引入"超级对齐"等监管概念。研究者认为，要实现人类级智能，必须整合多子系统并持续迭代，而人脑是最佳参考模型。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T22:03:15Z
- **目录日期**: 2025-04-07
