...
这篇264页的联合综述论文由Google DeepMind、微软等顶级机构合作完成，提出了"基础智能体"(Foundation Agents)的类人架构。研究将AI Agent拆解为仿人模块：感知、认知、世界模型、情绪、记忆和行动系统，旨在模拟人类思维过程。论文指出当前AI存在情绪缺失、记忆不稳定、世界模型简陋等短板，并提出了自优化机制和安全监管方案。作者强调，要实现人类级别智能，需要整合多个子系统并持续进化，人脑是最佳参考模型。该研究为AI发展提供了系统性框架和安全考量。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T13:10:46Z
- **目录日期**: 2025-04-07
