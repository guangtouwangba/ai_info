...
中科大团队提出KG-SFT框架，通过知识图谱增强大语言模型的专业知识理解力。该框架包含实体提取、推理子图生成和知识冲突检测三个组件，在仅使用5%训练数据的情况下，使医学问答准确率提升14%。KG-SFT可兼容现有数据增强方案，在多语言、多领域任务中表现优异，显著提升模型在低资源场景下的知识推理能力。这项ICLR 2025入选研究展示了大模型向"质量优于数据量"的发展趋势，由王杰教授团队陈瀚铸博士主导完成。论文详见OpenReview链接。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T16:02:42Z
- **目录日期**: 2025-04-07
