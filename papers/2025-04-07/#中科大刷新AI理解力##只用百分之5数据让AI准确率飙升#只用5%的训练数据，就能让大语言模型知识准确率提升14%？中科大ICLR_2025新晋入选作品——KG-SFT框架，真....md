...
中科大团队在ICLR 2025提出KG-SFT框架，通过知识图谱增强大模型的专业知识理解力。该框架包含实体提取、关键推理子图生成和知识冲突检测三大组件，仅用5%训练数据就在医学问答任务中实现14%准确率提升。KG-SFT具备多语言多领域适应性，可兼容现有数据增强方案，显著提升大模型在低数据场景下的知识推理能力。这一突破表明未来AI发展将更注重知识深度而非数据规模，由王杰教授团队陈瀚铸等研发。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T12:02:54Z
- **目录日期**: 2025-04-07
