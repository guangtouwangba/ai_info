...
中科大团队在ICLR 2025提出KG-SFT框架，通过知识图谱增强大语言模型的专业知识理解力。该框架包含实体提取、关键推理子图生成和知识冲突检测三大组件，仅用5%训练数据就在医学问答任务中实现14%准确率提升。KG-SFT具有多领域适应性和插件化特点，可配合现有数据增强方案，显著提升模型在低数据场景下的知识推理能力。研究展示了大模型从"数据驱动"转向"知识深度理解"的新方向，为资源受限场景下的AI应用提供了高效解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T18:02:36Z
- **目录日期**: 2025-04-07
