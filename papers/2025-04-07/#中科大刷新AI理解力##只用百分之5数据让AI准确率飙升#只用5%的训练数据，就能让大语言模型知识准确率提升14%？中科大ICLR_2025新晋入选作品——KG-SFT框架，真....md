...
中科大团队提出KG-SFT框架，通过知识图谱增强大语言模型的专业知识理解力。该框架包含实体提取、关键推理子图生成和知识冲突检测三大组件，在仅使用5%训练数据的情况下，将医学问答准确率提升14%。KG-SFT具有多语言、多领域适应性，可作为插件与现有方案结合。研究由王杰教授团队完成，论文入选ICLR 2025，展示了大模型向知识深度理解发展的新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T10:01:24Z
- **目录日期**: 2025-04-07
