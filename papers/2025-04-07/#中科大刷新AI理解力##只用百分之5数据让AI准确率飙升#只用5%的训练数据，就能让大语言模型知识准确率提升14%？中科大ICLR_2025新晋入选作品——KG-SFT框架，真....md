...
中科大团队提出KG-SFT框架，通过知识图谱提升大模型的专业知识理解力。该框架包含实体提取、推理子图生成和知识冲突检测三大组件，在仅使用5%训练数据的情况下，使医学问答准确率提升14%。KG-SFT能适配多语言、多领域场景，并可与其他数据增强方案结合。这一成果表明，未来AI性能提升可能更依赖知识深度而非数据量。论文入选ICLR 2025，由王杰教授团队开发，一作为陈瀚铸。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T11:01:11Z
- **目录日期**: 2025-04-07
