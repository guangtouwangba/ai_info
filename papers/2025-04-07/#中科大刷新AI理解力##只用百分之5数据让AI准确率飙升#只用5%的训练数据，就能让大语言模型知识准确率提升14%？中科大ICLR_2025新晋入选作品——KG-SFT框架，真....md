...
中科大团队提出的KG-SFT框架在ICLR 2025入选研究中取得突破，通过知识图谱增强大语言模型的专业知识理解力。该框架仅需5%训练数据即可在医学问答任务中提升14%准确率，包含实体提取、关键信息生成和冲突检测三大组件。其创新性在于将知识图谱作为"插件"辅助模型推理，有效解决少数据场景下专业领域理解不足的问题。这一成果展示了大模型发展正从数据规模竞争转向知识深度与逻辑质量提升的新阶段，具有多语言、多领域的应用潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T14:02:45Z
- **目录日期**: 2025-04-07
