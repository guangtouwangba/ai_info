...
这篇论文介绍了AgentSociety，一个基于大型语言模型(LLM)的大规模社会模拟系统。该系统模拟了超过1万个AI代理的社会生活，记录了500万次交互。研究者用它研究了四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害冲击。模拟结果与现实世界数据高度吻合，证明了该系统在理解人类行为机制方面的有效性。AgentSociety展示了作为社会科学研究工具和政策测试平台的潜力，能够补充传统研究方法如调查和访谈。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T12:05:22Z
- **目录日期**: 2025-04-07
