...
AgentSociety是一个基于大型语言模型的大规模社会模拟器，通过1万多个AI代理模拟真实社会环境，记录了500万次交互。研究者用它分析了四大社会问题：社会极化、信息传播、基本收入政策影响和自然灾害冲击。模拟结果与现实世界数据高度吻合，验证了该系统在揭示人类行为机制方面的可靠性。该平台可作为计算社会科学的新工具，辅助传统研究方法，为政策制定和社会问题研究提供数据支持。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T04:03:03Z
- **目录日期**: 2025-04-07
