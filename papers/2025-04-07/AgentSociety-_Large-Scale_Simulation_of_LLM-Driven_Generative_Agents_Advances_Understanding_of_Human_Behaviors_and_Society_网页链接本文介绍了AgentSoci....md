...
AgentSociety是一个基于大型语言模型的大规模社会模拟系统，能够模拟10,000多个AI代理的社会互动（500万次交互）。该系统被用于研究四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，验证了该系统在揭示人类行为机制方面的有效性。研究表明，AgentSociety可作为计算社会科学的有力工具，为研究者和政策制定者提供传统方法（如调查、实验）之外的补充研究手段，有助于深入理解复杂社会现象的内在机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T18:04:52Z
- **目录日期**: 2025-04-07
