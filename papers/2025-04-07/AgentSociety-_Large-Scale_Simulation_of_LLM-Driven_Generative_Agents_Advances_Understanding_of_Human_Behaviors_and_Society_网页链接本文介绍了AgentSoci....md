...
这篇论文介绍了AgentSociety，这是一个利用大型语言模型驱动的大规模社会模拟系统，能够模拟超过1万个代理及其500万次互动。研究者用它作为计算社会科学实验平台，研究了社会极化、信息传播、基本收入政策和自然灾害影响等四个关键问题。模拟结果与现实世界数据高度吻合，验证了该系统在捕捉人类行为机制方面的有效性。该工具为社会科学研究和政策制定提供了新的实验手段，能够辅助传统研究方法，帮助理解社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T14:05:03Z
- **目录日期**: 2025-04-07
