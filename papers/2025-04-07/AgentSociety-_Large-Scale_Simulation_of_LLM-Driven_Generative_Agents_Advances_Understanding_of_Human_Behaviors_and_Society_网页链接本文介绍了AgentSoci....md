# AgentSociety: Large-Scale Simulation of LLM-Driven Generative Agents Advances Understanding of Human Behaviors and Society 网页链接本文介绍了AgentSoci...
...
AgentSociety是一个基于大型语言模型的大规模社会模拟系统，通过10,000多个AI代理和500万次交互，模拟真实社会环境。该系统被用于研究四个关键社会问题：社会极化、刺激性信息传播、基本收入政策影响和自然灾害（如飓风）的社会效应。模拟结果与现实世界数据高度吻合，验证了该系统捕捉人类行为机制的能力。研究表明AgentSociety可作为计算社会科学的有效工具，为研究者和政策制定者提供传统方法（如调查、访谈）之外的补充研究手段，有助于深入理解社会问题的成因和潜在解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T13:12:20Z
- **目录日期**: 2025-04-07
