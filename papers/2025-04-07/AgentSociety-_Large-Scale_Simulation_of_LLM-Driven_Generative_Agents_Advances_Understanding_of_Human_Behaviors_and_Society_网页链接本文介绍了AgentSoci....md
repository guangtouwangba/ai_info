...
《AgentSociety》是一项利用大语言模型驱动的大规模社会模拟研究。该系统模拟了10,000多个AI代理的社会生活，记录了500万次互动，用于研究社会极化、信息传播、基本收入政策及自然灾害影响等问题。结果显示，模拟结果与现实世界数据高度吻合，验证了该系统捕捉人类行为机制的能力。该平台可作为社会科学研究和政策制定的有效工具，补充传统研究方法如调查和访谈。研究表明，AgentSociety在理解社会问题模式和机制方面具有重要潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T07:05:08Z
- **目录日期**: 2025-04-07
