...
AgentSociety是一个基于大型语言模型的大规模社会模拟器，通过1万个AI代理和500万次互动模拟真实社会环境。研究者用它分析了四个关键社会问题：社会极化、信息传播、基本收入政策影响及自然灾害（如飓风）的冲击。模拟结果与现实世界数据高度吻合，验证了该工具在揭示人类行为机制和社会动态方面的可靠性。该系统可作为计算社会科学的新平台，辅助传统研究方法（如调查、实验），为研究者和政策制定者提供高效、低成本的社会问题分析工具。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T06:04:39Z
- **目录日期**: 2025-04-07
