...
AgentSociety是一个基于大型语言模型的大规模社会模拟器，能够模拟超过1万个代理及其500万次互动。研究者利用该系统研究了社会极化、信息传播、基本收入政策和飓风影响等社会问题，结果与现实世界数据吻合。该系统可作为计算社会科学实验平台，帮助理解人类行为机制，并为政策制定提供参考。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T00:05:07Z
- **目录日期**: 2025-04-07
