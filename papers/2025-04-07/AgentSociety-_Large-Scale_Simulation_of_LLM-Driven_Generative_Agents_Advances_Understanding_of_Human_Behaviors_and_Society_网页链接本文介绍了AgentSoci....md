...
这篇论文介绍了AgentSociety——一个基于大语言模型的大规模社会模拟系统，能够模拟10,000多个AI代理的社会互动（500万次交互）。该系统作为计算社会科学实验平台，研究了四大社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，验证了该系统在揭示人类行为机制方面的有效性，展示了其作为社会科学研究和政策制定工具的潜力。该研究突破了传统调查方法的局限，为理解复杂社会现象提供了新途径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T10:03:58Z
- **目录日期**: 2025-04-07
