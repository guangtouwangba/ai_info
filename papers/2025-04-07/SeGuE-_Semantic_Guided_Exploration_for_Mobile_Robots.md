...
本文提出了一种基于语义探索的机器人自主建图方法，使移动机器人能够同时构建环境的结构和语义特征地图。该方法采用"最佳下一视角"策略，根据潜在视角下可见的语义特征对位姿进行评分，并探索了两种不同的视角采样方法。实验验证了该框架在仿真和实际场景中的有效性。这种高质量语义地图的自动创建有助于机器人更好地理解和与环境互动，并为未来具身AI应用的部署提供便利。研究聚焦于结合几何与语义信息的地图构建，以支持复杂任务的执行。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T05:01:08Z
- **目录日期**: 2025-04-07
