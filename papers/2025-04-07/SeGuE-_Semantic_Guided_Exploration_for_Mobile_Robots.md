...
本文提出了一种新颖的语义探索方法，使移动机器人能自主探索环境，构建包含几何和语义信息的完整地图。该方法基于"最佳下一视点"策略，通过评估潜在视点可见的语义特征来评分。研究探索了两种视点采样方法，并在仿真和实体实验中验证了框架的有效性。高质量的语义地图能帮助机器人更好地理解和与环境互动，促进具身AI应用的部署。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T21:01:09Z
- **目录日期**: 2025-04-07
