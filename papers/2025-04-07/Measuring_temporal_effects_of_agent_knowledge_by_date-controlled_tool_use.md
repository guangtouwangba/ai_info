...
这篇论文研究了大型语言模型(LLM)代理在知识更新中的时间动态性。通过使用日期控制工具(DCTs)测试发现，基于网络搜索的代理性能会随时间变化，这种时间依赖性会影响其作为写作助手完成科学摘要的质量。研究表明，基础模型的选择和显式推理指令(如思维链提示)可以缓解这种时间依赖性。作者建议代理设计和评估应考虑外部资源的动态影响，采取相应措施以确保可靠性。研究强调了在知识更新过程中考虑时间因素的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T03:16:10Z
- **目录日期**: 2025-04-07
