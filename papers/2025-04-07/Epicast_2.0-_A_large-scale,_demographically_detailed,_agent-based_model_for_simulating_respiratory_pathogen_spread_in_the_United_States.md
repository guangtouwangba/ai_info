...
这篇论文介绍了Epicast 2.0，这是一个基于代理的模型，用于模拟呼吸道病原体在美国全国的传播。该模型利用高度详细的合成人口和高性能计算技术，模拟超过3.2亿代理人的日常接触模式（如学校、工作和社区活动）。Epicast 2.0支持疫苗接种和各种非药物干预措施，用户可通过细粒度政策调整干预强度。通过多种疫情场景的模拟，模型展示了其动态多样性和政策探索能力，为"假设分析"提供了强大平台，有助于优化资源分配和决策制定，以减轻传染病的影响。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T07:01:32Z
- **目录日期**: 2025-04-07
