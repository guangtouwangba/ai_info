...
该论文针对代码生成大模型（CodeLLMs）提出新评估方法，指出当前基准测试过于关注代码正确性而忽略人类偏好。研究者构建了CodeArena基准（含397个多语言样本）和SynCode-Instruct合成指令集（20B标记），发现执行基准与人类偏好存在差异。实验显示开源模型（如Qwen2.5-Coder）与商业模型（如OpenAI o1）性能差距显著，强调了对齐人类偏好的必要性。研究通过模拟真实编程场景，揭示了代码生成质量评估的新维度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T16:05:37Z
- **目录日期**: 2025-04-07
