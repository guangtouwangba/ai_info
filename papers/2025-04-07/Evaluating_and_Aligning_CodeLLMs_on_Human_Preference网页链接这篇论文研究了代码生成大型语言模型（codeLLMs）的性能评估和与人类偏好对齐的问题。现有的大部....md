...
这篇论文针对代码生成大模型（codeLLMs）与人类偏好对齐的问题，提出了新基准CodeArena和合成指令数据集SynCode-Instruct。CodeArena包含397个高质量编程任务样本，覆盖40类44种语言，模拟真实编程场景；SynCode-Instruct含近200亿标记的合成指令数据。实验发现：1）传统基于执行的评估与人类偏好存在差距；2）开源顶级模型（如Qwen2.5-Coder）与商业模型（如OpenAI o1）性能差异显著。研究强调了代码生成模型除功能性外，还需重视与开发者实际需求的匹配度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T15:05:31Z
- **目录日期**: 2025-04-07
