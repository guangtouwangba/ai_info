...
这篇论文针对代码生成大模型(codeLLMs)提出了CodeArena基准测试，聚焦模型输出与人类偏好的对齐问题。研究团队从真实查询中精选397个样本，覆盖40类任务和44种语言，构建了更贴近实际编程场景的评估体系。同时开发了包含近200亿标记的合成指令数据集SynCode-Instruct，验证了大规规模指令微调的效果。实验发现传统执行基准与人类偏好评估存在差异，并显示开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI)在人类偏好对齐方面仍有显著差距，强调了优化方向的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T02:33:43Z
- **目录日期**: 2025-04-07
