...
这篇论文研究了代码生成大模型（CodeLLMs）与人类偏好的对齐问题。作者提出了CodeArena基准测试，包含397个高质量样本，覆盖40个类别和44种编程语言，模拟真实编程任务的复杂性。同时构建了20B标记的合成指令数据集SynCode-Instruct验证大规模微调效果。实验发现现有执行基准与人类偏好存在差异，开源顶级模型（如Qwen2.5-Coder）与专有模型（如OpenAI o1）性能差距显著，凸显了人类偏好对齐的重要性。研究强调了在代码生成评估中考虑实际应用需求的关键性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T10:04:36Z
- **目录日期**: 2025-04-07
