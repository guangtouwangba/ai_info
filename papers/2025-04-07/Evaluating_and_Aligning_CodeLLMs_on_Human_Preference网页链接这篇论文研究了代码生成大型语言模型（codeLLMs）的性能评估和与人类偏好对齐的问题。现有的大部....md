...
这篇论文针对代码生成大型语言模型(codeLLMs)提出新评估方法，重点关注与人类偏好的对齐。研究者创建了CodeArena基准测试(含397个高质量样本，覆盖40类任务和44种语言)来模拟真实编程场景，并构建了20B标记的SynCode-Instruct合成指令集。实验发现现有基于执行的评估与人类偏好存在差距，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著。研究强调了在代码生成任务中考虑人类偏好的重要性，为改进代码LLM提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T01:33:28Z
- **目录日期**: 2025-04-07
