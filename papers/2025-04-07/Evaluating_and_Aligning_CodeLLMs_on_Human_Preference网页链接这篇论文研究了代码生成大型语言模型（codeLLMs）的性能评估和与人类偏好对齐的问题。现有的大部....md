...
该论文针对代码生成大模型(codeLLMs)提出创新评估框架CodeArena，包含397个涵盖40类编程任务的人类偏好样本，弥补了传统基准忽视人机对齐的缺陷。研究同时构建20B标记的合成指令集SynCode-Instruct验证微调效果，实验发现：1)执行正确性与人类偏好存在显著差异；2)开源顶尖模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距明显。研究强调代码LLMs需同时满足功能正确和人类偏好，为模型优化提供了新维度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T06:05:19Z
- **目录日期**: 2025-04-07
