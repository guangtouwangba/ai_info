...
Meta新发布的Llama 4大模型陷入争议。华人社区爆料称其实际表现与宣传差距大，有员工因无法接受"刷榜"要求而辞职。TechCrunch指出Meta用于榜单测试的是"特别优化版"，与开发者可下载版本不同。博主对比发现榜单模型回答更冗长且爱用emoji。Meta官网承认使用"实验性聊天版"打榜。Llama 4系列含三个版本，其中2万亿参数的Behemoth号称超越GPT-4.5等模型。目前其真实性能仍待验证。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T16:03:54Z
- **目录日期**: 2025-04-07
