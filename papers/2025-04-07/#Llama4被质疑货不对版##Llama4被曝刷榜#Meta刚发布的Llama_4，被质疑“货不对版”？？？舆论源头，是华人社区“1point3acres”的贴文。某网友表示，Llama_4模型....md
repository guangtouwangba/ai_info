...
Meta新发布的Llama 4大模型陷入争议。华人社区爆料称其实际表现与宣传差距大，有员工因不满"刷榜"行为辞职。TechCrunch指出Meta用于榜单测试的是"实验性聊天版"，与开发者可下载版本不同。官网承认榜单模型为优化版本，但用户实测发现两者在回答风格（如表情使用）上差异明显。Llama 4系列号称在多任务上超越GPT-4o，其2万亿参数的Behemoth版本宣称优于GPT-4.5，但实际性能仍待验证。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T08:02:42Z
- **目录日期**: 2025-04-07
