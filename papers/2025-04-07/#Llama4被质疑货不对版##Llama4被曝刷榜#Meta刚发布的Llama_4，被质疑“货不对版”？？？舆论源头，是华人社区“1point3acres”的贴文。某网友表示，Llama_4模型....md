...
Meta新发布的Llama 4大模型陷入争议。社区爆料称其实际表现与宣传差距大，有员工因拒绝"优化数据"离职。TechCrunch指出Meta用于刷榜的是"实验性聊天特供版"，与开发者可下载版本存在明显差异（如大量使用emoji和冗长回答）。官方宣称其Maverick版本超越GPT-4o，而2万亿参数的Behemoth版本号称超过GPT-4.5。但榜单模型与发布版本的不一致性引发"货不对版"质疑，真实性能尚待验证。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T23:03:25Z
- **目录日期**: 2025-04-07
