...
Meta新发布的Llama 4模型陷入争议：1）华人社区爆料称其表现未达SOTA水平，有员工因不满"优化数据"要求辞职；2）TechCrunch披露Meta用于刷榜的是"实验性聊天特供版"，与开发者可下载版本存在差异（如使用更多emoji和冗长回复）；3）官方宣称其Maverick版本在编程等多任务超越GPT-4o，而2万亿参数的Behemoth版本号称超过GPT-4.5。Meta官网已注明榜单成绩来自实验版本，但模型实际能力仍待验证。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T15:03:49Z
- **目录日期**: 2025-04-07
