# #Llama4被质疑货不对版##Llama4被曝刷榜#Meta刚发布的Llama 4，被质疑“货不对版”？？？舆论源头，是华人社区“1point3acres”的贴文。某网友表示，Llama 4模型...
...
Meta新发布的Llama 4大模型陷入争议。社区爆料称其实际表现与宣传的SOTA水平差距较大，有员工因不满"刷榜"要求而离职。TechCrunch指出Meta用于榜单测试的是"特别优化版"，与开发者可下载的正式版不同。官网确认上榜的是"实验性聊天版"，该版本回答风格（频繁使用emoji/冗长）与发布版存在明显差异。Llama 4系列包含三个版本，其中2万亿参数的Behemoth号称超越GPT-4.5等模型，但实际性能仍需验证。目前争议焦点在于榜单模型与发布版本是否存在性能偏差。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T20:03:21Z
- **目录日期**: 2025-04-07
