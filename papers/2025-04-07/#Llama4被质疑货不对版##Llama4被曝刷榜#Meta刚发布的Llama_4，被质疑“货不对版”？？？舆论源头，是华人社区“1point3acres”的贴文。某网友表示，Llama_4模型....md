...
Meta最新发布的Llama 4大模型陷入争议。社区爆料称其实际表现与SOTA差距大，员工因不满"刷榜"要求辞职。TechCrunch指出Meta用于榜单测试的是"实验性聊天版"，与开发者可下载版本存在差异（如大量使用emoji和冗长回答）。官方宣称其Maverick版本在编程等多任务超越GPT-4o，2万亿参数的Behemoth版本更声称超越GPT-4.5。但官网已注明榜单成绩来自实验版本，引发对模型真实能力的质疑。目前实际表现仍需验证。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T17:03:37Z
- **目录日期**: 2025-04-07
