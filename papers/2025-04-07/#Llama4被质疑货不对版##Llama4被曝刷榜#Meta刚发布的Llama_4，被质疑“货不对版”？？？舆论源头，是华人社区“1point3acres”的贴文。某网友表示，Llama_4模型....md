...
Meta最新发布的Llama 4大模型陷入争议。开发者社区爆料称其实际表现与宣传的SOTA水平差距较大，有员工因不满"刷榜"要求而离职。TechCrunch指出Meta用于榜单测试的是经过特殊优化的"实验性聊天版"，而非公开下载版本。对比显示榜单模型回答更冗长且频繁使用emoji。官方宣称Llama 4系列（含2万亿参数的Behemoth）在多任务中超越GPT-4o等竞品，但模型真实性引发质疑。Meta官网已注明榜单使用实验版本，实际性能仍需验证。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T22:03:30Z
- **目录日期**: 2025-04-07
