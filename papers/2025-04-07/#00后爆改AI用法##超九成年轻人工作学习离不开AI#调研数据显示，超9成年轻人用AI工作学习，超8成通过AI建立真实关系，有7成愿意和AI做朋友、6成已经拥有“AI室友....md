...
调研显示，90%以上年轻人依赖AI辅助工作学习，80%通过AI建立真实社交关系。约70%愿与AI交友，60%拥有"AI室友"，同时40%存在"AI焦虑"。值得注意的是，近20%的年轻人已通过AI获利，更多人选择边用边学。AI已从工具演变为00后的"情感伙伴"和"创收助手"，人均拥有1.8个AI朋友，展现出深度融入日常生活的趋势。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T07:03:58Z
- **目录日期**: 2025-04-07
