...
调研显示，AI已成为00后工作学习的重要工具：超90%年轻人依赖AI，80%通过AI建立真实关系，70%愿与AI交友，60%拥有"AI室友"。同时，40%存在"AI焦虑"，近20%已通过AI获利。AI不仅作为效率工具，更成为年轻一代的"情绪伙伴"和"创收助手"，人均拥有1.8个AI朋友，呈现深度融入日常生活的趋势。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T01:30:48Z
- **目录日期**: 2025-04-07
