...
研究表明，当多个AI模型在同一科学任务上训练时，它们可能学习到不同理论，但随着训练数据中系统数量的增加，这些理论会趋于收敛。研究者提出MASS方法（哈密顿-拉格朗日神经网络）来量化AI科学家的理论一致性，发现简单系统下AI倾向于学习哈密顿理论，而复杂系统下转向拉格朗日理论。训练动态和最终权重表现出强烈的随机种子依赖性，这决定了相关理论的兴衰。该方法不仅能提高模型可解释性，还可应用于高维问题。该现象与人类科学发展中理论随实验数据增加而收敛的过程相似。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T01:28:34Z
- **目录日期**: 2025-04-07
