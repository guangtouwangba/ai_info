...
研究表明，当两个AI模型在相同科学任务上训练时，它们可能学习到不同理论，这与科学史上多种理论并存的现象类似。随着训练数据的增加，AI模型的理论会趋于收敛，但有时仍会形成不同理论群。研究者提出MASS框架（哈密顿-拉格朗日神经网络）来量化AI科学家的理论一致性，发现简单系统中AI倾向于学习哈密顿理论，复杂系统则转向拉格朗日表述。训练动态和最终权重表现出强烈的随机种子依赖性，这决定了相关理论的兴衰。该方法不仅增强可解释性，还能应用于高维问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T00:01:17Z
- **目录日期**: 2025-04-07
