...
Meta最新发布了三款AI模型：Scout（中杯）、Maverick（大杯）和Behemoth（特大杯）。其中Behemoth仍在训练中，但参数高达2万亿，引发关注。已发布的两款模型性能突出，尤其是LIama 4在参数减少一半的情况下，仍保持与DeepSeek相当的代码能力，并支持单卡运行（SOTA级别）。新模型显著降低了AI使用成本，展现了Meta在开源AI领域的领先地位。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T05:03:40Z
- **目录日期**: 2025-04-07
