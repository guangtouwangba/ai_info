...
Meta最新发布了三款AI模型：Scout（中杯）、Maverick（大杯）和Behemoth（特大杯）。前两款已开放下载，Behemoth仍在训练中，但凭借2万亿参数的惊人规模引发关注。其中，LIama 4表现尤为突出，在保持与DeepSeek相当代码能力的同时，参数量减少一半，仅需单张H100显卡即可运行，并达到SOTA（当前最优）性能。这一系列模型显著降低了AI使用门槛，被形容为"价格打骨折"的技术突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T06:03:46Z
- **目录日期**: 2025-04-07
