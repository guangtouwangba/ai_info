...
Meta最新发布了三款AI模型：Scout（中杯）、Maverick（大杯）和Behemoth（特大杯）。其中Behemoth仍在训练中，但参数规模高达2万亿，引发关注。已发布的LIama 4模型在性能上达到SOTA（当前最优水平），代码能力与DeepSeek相当，但参数量减少一半，且支持单卡（如H100）运行，显著降低了AI使用成本。此次发布被形容为"价格打骨折"，展示了Meta在开源AI领域的领先地位和技术突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T03:18:07Z
- **目录日期**: 2025-04-07
