...
Meta最新发布三款AI模型：Scout（中杯）、Maverick（大杯）和Behemoth（特大杯）。其中Behemoth仍在训练中，参数高达2万亿，引发关注。已发布的Llama 4表现突出，在同等代码能力下参数比DeepSeek减少一半，单张H100显卡即可运行并达到SOTA（最先进水平），显著降低了AI使用成本。这一系列模型的开源特性及高效能设计，使Meta重新夺回开源AI领域的领先地位。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T00:03:26Z
- **目录日期**: 2025-04-07
