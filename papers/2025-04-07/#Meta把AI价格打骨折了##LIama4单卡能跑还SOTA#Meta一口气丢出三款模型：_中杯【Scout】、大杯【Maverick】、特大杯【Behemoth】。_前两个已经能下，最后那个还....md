...
Meta最新发布了三款AI模型：Scout（中杯）、Maverick（大杯）和Behemoth（特大杯）。其中Behemoth仍在训练中，但参数规模高达2万亿，引发广泛关注。已发布的两款模型表现亮眼，特别是LIama 4在参数减半的情况下仍达到SOTA（最先进）水平，且仅需单张H100显卡即可运行，展现出极高的效率。新模型在代码能力上与DeepSeek相当，但成本大幅降低，Meta此举可能重塑AI行业的价格体系。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T01:30:58Z
- **目录日期**: 2025-04-07
