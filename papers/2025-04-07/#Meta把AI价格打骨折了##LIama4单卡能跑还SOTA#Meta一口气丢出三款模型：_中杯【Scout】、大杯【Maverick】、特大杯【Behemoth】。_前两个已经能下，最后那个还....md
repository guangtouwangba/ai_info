...
Meta发布三款AI模型：Scout（中杯）、Maverick（大杯）和Behemoth（特大杯，2万亿参数）。前两款已开放下载，Behemoth仍在训练但参数规模惊人。重点发布的LIama 4以单卡（H100）即可运行，性能达到SOTA水平，代码能力与DeepSeek相当但参数量减半，显著降低使用门槛。新模型通过技术优化实现高效推理，重新夺回开源模型领先地位。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T04:02:01Z
- **目录日期**: 2025-04-07
