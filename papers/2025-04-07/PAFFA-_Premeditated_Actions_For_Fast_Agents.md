...
研究人员提出PAFFA方法，通过构建可复用的"动作库"来提升AI助手在网页任务中的效率和准确性。该方法采用两种策略：跨任务通用的"Dist-Map"识别关键网页元素，以及首次探索新网站时状态化的"Unravel"技术。实验显示PAFFA能减少87%的推理时间token消耗，同时保持较高任务准确率（0.57 vs 基线0.50）。Unravel还能通过探索更新动作库，适应未见过的网站。研究表明，大语言模型的推理序列可以跨提示泛化，为互联网规模数据提供了次线性token增长的推理方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T12:02:27Z
- **目录日期**: 2025-04-07
