...
多模态人工智能（AI）通过机器学习整合多种数据类型，以提升医疗、科学和工程等领域的理解、预测和决策能力。当前研究主要集中于视觉和语言数据模型，但可部署性仍是关键挑战。本文提出以部署为中心的工作流程，早期纳入部署约束以避免不可行方案，并强调跨多模态层级和多学科协作，以拓展研究范围。通过分析疫情响应、自动驾驶设计和气候变化应对三个案例，探讨跨学科共性挑战。倡导多学科对话和开放研究实践，推动部署导向的开发，实现广泛社会影响。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T20:01:36Z
- **目录日期**: 2025-04-07
