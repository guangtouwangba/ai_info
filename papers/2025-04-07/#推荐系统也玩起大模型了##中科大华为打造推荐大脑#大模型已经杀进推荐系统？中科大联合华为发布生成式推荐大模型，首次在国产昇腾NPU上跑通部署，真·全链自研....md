...
中科大与华为合作推出生成式推荐大模型，首次在国产昇腾NPU上实现全链自研部署。该模型复现了Meta的HSTU架构，并创新性地引入相对注意力偏移（RAB）和残差连接技术，显著提升模型扩展性。研究还使经典SASRec模型具备可扩展能力，支持多域推荐和冷启动处理。在排序任务中表现媲美传统DIN模型，标志着大模型技术在推荐系统领域的重大突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T05:03:26Z
- **目录日期**: 2025-04-07
