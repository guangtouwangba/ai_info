...
中国人民大学与蚂蚁集团的研究团队提出首个个性化对齐大模型AlignXpert，突破传统AI对齐的标准化局限。该研究通过构建90维心理偏好空间和130万用户数据集AlignX，开发了ICA（上下文对齐）和PBA（偏好桥接）两项核心技术，使大模型能精准识别用户深层偏好。实验显示其偏好预测准确率提升17%，在应对新维度、数据稀缺等场景表现优异。这项开源研究实现了"用户画像-偏好方向"双向建模，为解决AI服务中的数字鸿沟问题提供了新范式。相关数据和模型已在HuggingFace平台公开。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T15:02:47Z
- **目录日期**: 2025-04-07
