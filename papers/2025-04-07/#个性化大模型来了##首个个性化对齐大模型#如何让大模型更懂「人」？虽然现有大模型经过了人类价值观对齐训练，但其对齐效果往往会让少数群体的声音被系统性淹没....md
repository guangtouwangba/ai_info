...
中国人民大学与蚂蚁集团的研究团队提出首个个性化对齐大模型AlignXpert，突破传统AI价值观对齐的局限性。传统方法基于普世原则，导致少数群体需求被忽视。该研究构建90维心理偏好空间，利用16亿条社交数据创建130万用户画像数据集AlignX，开发ICA（上下文对齐）和PBA（偏好桥接）两项核心技术，使模型能精准识别用户深层偏好。测试显示偏好预测准确率提升17%，尤其在处理新偏好和数据稀缺场景表现突出。研究开源全部数据和模型框架，推动AI向个性化服务迈进。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T10:01:36Z
- **目录日期**: 2025-04-07
