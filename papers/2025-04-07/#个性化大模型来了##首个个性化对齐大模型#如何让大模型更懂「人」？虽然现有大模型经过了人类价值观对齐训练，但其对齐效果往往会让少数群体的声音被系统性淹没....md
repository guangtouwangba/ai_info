...
中国人民大学与蚂蚁集团的研究团队提出"个性化对齐大模型"新范式，突破传统AI价值观对齐的局限性。该研究构建了包含90维心理特征的130万用户数据集AlignX，开发出ICA（上下文对齐）和PBA（偏好桥接）两项核心技术，使大模型能精准识别用户深层偏好。实验显示，新方法在四大基准测试中平均提升偏好预测准确率17%，有效解决了主流模型对少数群体需求响应不足的问题。相关数据和模型已在HuggingFace平台开源，推动AI向更包容的个性化服务方向发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T20:02:29Z
- **目录日期**: 2025-04-07
