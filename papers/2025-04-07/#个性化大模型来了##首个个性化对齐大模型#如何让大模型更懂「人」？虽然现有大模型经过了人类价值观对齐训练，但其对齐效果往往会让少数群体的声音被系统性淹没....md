...
中国人民大学与蚂蚁集团的研究团队提出"个性化对齐大模型"新范式，突破传统AI价值观对齐的局限性。该研究构建了90维心理偏好空间和包含130万用户画像的AlignX数据集，开发了ICA（上下文对齐）和PBA（偏好桥接）两项核心技术，使大模型能精准识别用户深层偏好。测试显示，新方法平均提升偏好预测准确率17%，有效解决了主流模型忽视少数群体需求的问题。相关数据和模型已全面开源，为AI个性化发展提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T12:03:04Z
- **目录日期**: 2025-04-07
