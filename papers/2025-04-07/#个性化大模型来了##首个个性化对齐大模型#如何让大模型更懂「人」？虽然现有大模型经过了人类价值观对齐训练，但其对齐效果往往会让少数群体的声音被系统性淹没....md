...
中国人民大学与蚂蚁研究团队提出个性化对齐大模型AlignXpert，突破传统AI对齐的单一价值观局限。该研究构建90维心理偏好空间和130万用户数据集AlignX，开发ICA（上下文对齐）和PBA（偏好桥接）技术，使大模型能精准识别用户深层偏好。实验显示模型在四大测试中偏好预测准确率提升17%，有效解决数据稀缺、偏好反转等挑战。该框架实现"用户画像-偏好方向"双向建模，相关数据和模型已开源，推动AI向个性化服务发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T13:10:01Z
- **目录日期**: 2025-04-07
