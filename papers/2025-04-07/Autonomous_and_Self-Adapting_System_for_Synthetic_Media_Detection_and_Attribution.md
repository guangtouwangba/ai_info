...
这篇论文提出了一种自主自适应合成媒体识别系统，能够检测合成图像并识别其来源，还能自动发现并整合新型生成器而无需人工干预。该系统采用开放集识别策略和可演化的嵌入空间，通过无监督聚类方法将未知来源样本聚集成高置信度簇，并持续优化决策边界。实验表明，该方法显著优于现有技术，在生成模型快速发展的背景下，为构建通用、适应性强的取证系统迈出了关键一步。该系统解决了现有静态识别系统面对新型生成器时性能骤降的问题，增强了检测和溯源能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T07:01:23Z
- **目录日期**: 2025-04-07
