...
这篇论文提出了一种自主自适应的合成媒体识别系统，能够检测合成图像并识别其来源，还能自动发现并整合新型生成器而无需人工干预。该系统采用开放集识别策略，利用可演化的嵌入空间区分已知和未知来源，并通过无监督聚类将未知样本聚集成高置信度簇，持续优化决策边界。实验表明，该方法显著优于现有技术，为应对快速发展的生成模型提供了更通用的适应性取证方案。这一创新解决了现有静态系统面对新型生成器时性能下降的问题，具有重要的实际应用价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T19:01:18Z
- **目录日期**: 2025-04-07
