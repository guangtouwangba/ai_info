...
这篇论文提出了一种自主自适应的合成图像识别系统，能够检测并归因已知来源的合成图像，同时自动识别和整合新型生成器而无需人工干预。该系统采用开放集识别策略和可演化的嵌入空间，通过无监督聚类方法将未知样本聚集成高置信度簇，并持续优化决策边界。实验表明，该方法显著优于现有技术，在生成模型快速发展的背景下，为构建通用、适应性强的取证系统迈出了关键一步，有效应对合成图像带来的虚假信息和恶意应用风险。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T14:01:23Z
- **目录日期**: 2025-04-07
