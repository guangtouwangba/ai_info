...
这篇论文提出了一种自主自适应的合成图像识别系统，能够检测并归因已知来源的合成图像，同时自主识别和整合新型生成器，无需人工干预。该系统采用开放集识别策略和可进化的嵌入空间，区分已知和未知来源，并通过无监督聚类方法将未知样本聚集成高置信度簇，持续优化决策边界。实验表明，该方法显著优于现有技术，为应对快速发展的生成模型提供了通用且适应性强的取证系统，有效缓解因新型生成器出现导致的性能下降问题，提升对虚假信息、欺诈等恶意应用的防御能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T23:01:17Z
- **目录日期**: 2025-04-07
