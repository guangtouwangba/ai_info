...
这篇论文提出了一种自主自适应的合成图像识别系统，能够检测合成图像并识别其来源，同时无需人工干预即可自动整合新型生成模型。该系统采用开放集识别策略和可演化的嵌入空间，通过无监督聚类方法将未知来源样本聚集成高置信度簇，并持续优化决策边界。实验表明，该方法显著优于现有技术，为应对快速发展的生成模型提供了更通用、适应性更强的取证系统解决方案，有效解决了现有静态系统面对新型生成器时性能下降的问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T08:01:17Z
- **目录日期**: 2025-04-07
