...
研究人员开发了首个多模态X射线行李安检数据集STCray，包含46,642张图像-文本配对扫描，涵盖21种威胁类别。该数据集通过专业协议生成领域感知的连贯描述，用于训练视觉AI助手STING-BEE。STING-BEE支持多种视觉语言任务，如场景理解、威胁定位和视觉问答，在跨领域场景中表现出优异的泛化能力。相关代码、数据和模型已开源。这一进展为X射线行李安检中的多模态学习设定了新基准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-04-07T02:28:49Z
- **目录日期**: 2025-04-07
