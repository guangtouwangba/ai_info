...
交互式生成视频（IGV）是一种结合生成能力与交互功能的技术，能根据用户控制信号生成高质量多样化视频内容。其应用涵盖三大领域：1）游戏，支持无限虚拟世界探索；2）具身AI，作为物理感知环境合成器训练智能体；3）自动驾驶，提供闭环仿真测试。研究提出理想IGV系统的五模块框架：生成、控制、记忆、动态和智能，并分析各模块的技术挑战，如实时生成、开放域控制、长期一致性、物理模拟和因果推理。该分析旨在推动IGV技术向更成熟实用的方向发展。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T01:28:21Z
- **目录日期**: 2025-05-02
