...
这篇论文提出了一个用于推进自主微移动技术的城市模拟解决方案。研究者开发了URBAN-SIM平台，包含分层城市生成、交互动态生成和异步场景采样三大模块，以提高机器人学习的多样性、真实性和效率。同时提出了URBAN-BENCH基准测试套件，包含基于城市移动、导航和穿越三大核心技能的8项任务，评估了轮式和足式等不同机器人在各种地形和城市结构中的表现。该研究为AI代理辅助人类操作微移动设备（如送货机器人、代步车）提供了安全高效的训练和评估方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T12:01:01Z
- **目录日期**: 2025-05-02
