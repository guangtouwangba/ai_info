...
本文提出了一种可扩展的城市模拟解决方案URBAN-SIM，用于推进自主微移动技术。该平台包含分层城市生成、交互动态生成和异步场景采样三个关键模块，以提高机器人学习的多样性、真实性和效率。同时，作者设计了URBAN-BENCH基准测试套件，包含基于城市移动、导航和穿越三大核心技能的8项任务，评估了轮式和腿式机器人在不同地形和城市结构中的表现。该研究为提升AI代理在繁忙城市环境中操作微移动设备的安全性和效率提供了新方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T23:00:57Z
- **目录日期**: 2025-05-02
