...
这篇论文提出了一个可扩展的城市模拟解决方案URBAN-SIM，用于推进自主微移动技术。该系统包含三个关键模块：分层城市生成、交互动力学生成和异步场景采样，以提高机器人学习的多样性、真实性和效率。同时，作者提出了URBAN-BENCH基准测试套件，包含基于三种核心技能的8项任务，用于评估AI代理在实现自主微移动方面的能力。研究评估了轮式和腿式等不同形态机器人在各种地形和城市结构中的表现，揭示了各自的优势和局限性。该方案为提升城市环境中微移动设备的安全性和效率提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T10:00:56Z
- **目录日期**: 2025-05-02
