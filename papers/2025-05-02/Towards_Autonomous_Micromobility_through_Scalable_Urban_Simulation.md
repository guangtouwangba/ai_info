...
这篇论文提出了一种可扩展的城市模拟解决方案URBAN-SIM，用于推进自主微出行技术。该系统包含三个关键模块：分层城市生成、交互式动态生成和异步场景采样，以提高机器人学习的多样性、真实性和效率。同时，研究团队设计了URBAN-BENCH基准测试套件，包含基于城市移动、导航和穿越三大核心技能的8项任务，用于评估AI代理在实现自主微出行方面的能力。实验评估了轮式和腿式等不同形态机器人在各种地形和城市结构中的表现，揭示了各自的优势和局限性。该研究为提升城市环境中微出行的安全性和效率提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T13:07:50Z
- **目录日期**: 2025-05-02
