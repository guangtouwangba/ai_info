...
这篇论文提出了一个用于推进自主微移动技术的城市模拟解决方案。研究团队开发了URBAN-SIM——一个高性能机器人学习平台，包含三个关键模块：分层城市生成、交互动态生成和异步场景采样，以提高模拟训练的多样性、真实性和效率。同时提出了URBAN-BENCH基准测试套件，包含基于三种核心技能（城市移动、导航和穿越）的8项任务，用于评估AI代理在自主微移动中的能力。实验评估了轮式和腿式等不同形态机器人在各种地形和城市结构中的表现，揭示了各自的优势和局限性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T19:00:59Z
- **目录日期**: 2025-05-02
