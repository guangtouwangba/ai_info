...
微型交通（如配送机器人、电动代步车）是城市交通的有前景替代方案，但目前依赖人工操作存在安全和效率隐患。本研究提出AI辅助的解决方案，开发了可扩展的URBAN-SIM仿真平台，通过分层城市生成、交互动态生成和异步场景采样三大模块提升训练多样性、真实性和效率。同时推出URBAN-BENCH评测基准，包含基于移动、导航和穿越三大核心技能的8项任务，评估轮式和足式等不同机器人在多样化城市场景中的表现。实验揭示了各机器人在不同地形和城市结构中的优劣势，为自主微型交通发展提供支持。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T09:00:57Z
- **目录日期**: 2025-05-02
