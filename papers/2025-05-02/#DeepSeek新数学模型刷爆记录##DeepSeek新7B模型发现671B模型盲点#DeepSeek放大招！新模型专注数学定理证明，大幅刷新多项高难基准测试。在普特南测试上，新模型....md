...
DeepSeek发布新数学模型DeepSeek-Prover-V2，在普特南测试中以49道题刷新纪录，远超当前最佳模型（10道）。特别值得注意的是，7B参数的小模型通过强化学习发现了671B大模型的盲点，在非CoT模式下解决了13个大模型无法处理的问题。研究发现7B模型在处理有限基数问题时采用了独特方法（如Cardinal.toNat），而671B模型完全未使用这些技巧。这表明小模型通过强化学习获得了大模型不具备的新能力。该成果展现了模型规模并非决定性能的唯一因素，强化学习可激发意外的新技能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T05:02:42Z
- **目录日期**: 2025-05-02
