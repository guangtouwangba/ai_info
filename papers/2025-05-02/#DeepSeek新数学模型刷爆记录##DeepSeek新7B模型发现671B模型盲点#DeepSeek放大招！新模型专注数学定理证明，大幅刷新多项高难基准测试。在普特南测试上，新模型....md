...
DeepSeek发布新数学模型DeepSeek-Prover-V2，在普特南测试中以49道题的成绩刷新记录，远超之前Kimi-Prover的10道题。值得注意的是，7B参数的小模型通过强化学习发现了671B大模型未掌握的数学推理技能，成功解决了13个大模型无法处理的问题，尤其在有限基数问题上表现出独特推理模式。该模型基于前代优化，通过大模型数据微调和强化学习训练，展现了"小模型发现新能力"的突破性现象，为AI数学推理领域带来重要进展。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T18:03:17Z
- **目录日期**: 2025-05-02
