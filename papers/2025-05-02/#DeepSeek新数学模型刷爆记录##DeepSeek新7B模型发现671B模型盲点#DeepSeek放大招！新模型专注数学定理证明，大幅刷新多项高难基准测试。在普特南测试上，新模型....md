...
DeepSeek推出新数学模型DeepSeek-Prover-V2，在普特南测试中以49道题的解答刷新记录，远超当前第一名Kimi-Prover的10道题。值得注意的是，7B参数的小模型通过强化学习发现了671B大模型未掌握的数学推理技能，解决了13个大模型无法处理的问题。研究发现，7B模型在处理有限基数问题时采用了独特的推理方法，而671B模型未使用这些方法。该成果展示了小模型通过特定训练可能超越大模型的潜力。论文还提到模型通过强化学习获得了意外的新能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T14:03:28Z
- **目录日期**: 2025-05-02
