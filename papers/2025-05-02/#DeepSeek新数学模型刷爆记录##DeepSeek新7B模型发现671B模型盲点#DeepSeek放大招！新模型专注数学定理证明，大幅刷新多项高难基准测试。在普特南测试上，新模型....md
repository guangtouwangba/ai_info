...
DeepSeek发布新数学证明模型DeepSeek-Prover-V2，在普特南测试中以49道题的解答刷新纪录（原纪录为10道）。值得注意的是，7B参数的小模型通过强化学习发现了671B大模型未掌握的解题方法，在有限基数问题中运用独特推理模式解决了13个大模型无法处理的问题。该现象显示小模型能通过训练获得超越大模型的新技能。团队透露该模型基于V1.5-Base微调后经强化学习训练而成，其突破性表现引发对未发布R2模型的期待。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T23:03:00Z
- **目录日期**: 2025-05-02
