...
DeepSeek推出新数学模型DeepSeek-Prover-V2，在普特南测试中取得49道题的突破性成绩，远超当前第一名（10道）。值得注意的是，7B小模型通过强化学习发现了671B大模型未掌握的数学推理技能，成功解决了13个大模型无法处理的问题，尤其是在有限基数问题中采用了独特方法。该模型基于V1.5-Base微调并强化训练，展现了"小模型超越大模型"的现象。团队称这一发现为"新技能涌现"，进一步提升了AI数学推理的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T00:02:54Z
- **目录日期**: 2025-05-02
