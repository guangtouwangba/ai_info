...
DeepSeek发布新数学模型DeepSeek-Prover-V2，在普特南测试中创下49道题的新纪录，远超当前冠军模型（10道）。值得注意的是，7B参数的小模型通过强化学习发现了671B大模型未掌握的数学推理技能，成功解决了13个大模型无法处理的问题，尤其在有限基数问题上表现出独特推理模式。该模型基于DeepSeek-Prover-V1.5微调后通过强化学习训练而成，展现了"小模型发现新能力"的突破。这一成果突显了模型优化和训练方法的重要性，为AI数学推理开辟了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T10:03:16Z
- **目录日期**: 2025-05-02
