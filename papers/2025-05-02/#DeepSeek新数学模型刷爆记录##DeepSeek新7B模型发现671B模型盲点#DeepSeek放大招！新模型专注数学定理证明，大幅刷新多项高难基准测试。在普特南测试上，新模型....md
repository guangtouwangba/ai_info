...
DeepSeek发布新数学模型DeepSeek-Prover-V2，在普特南测试中以49道题刷新记录，远超当前第一名的10道题成绩。研究发现，7B参数的小模型通过强化学习获得了671B大模型不具备的新技能，成功解决了13个大模型未能攻克的数学问题，特别是在处理有限基数问题时展现出独特推理模式。该模型基于V1.5-Base微调后，通过强化学习自主发展出新能力，体现了"小模型发现大模型盲点"的创新突破。团队表示这一发现类似R1模型的"啊哈时刻"，为AI数学推理带来新启示。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T22:03:11Z
- **目录日期**: 2025-05-02
