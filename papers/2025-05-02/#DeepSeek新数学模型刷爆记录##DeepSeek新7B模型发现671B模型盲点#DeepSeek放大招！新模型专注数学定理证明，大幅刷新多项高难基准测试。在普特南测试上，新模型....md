...
DeepSeek发布新数学模型DeepSeek-Prover-V2，在普特南测试中取得49道题的突破性成绩，远超当前第一名（10道题）。特别值得注意的是，7B参数的小模型通过强化学习发现了671B大模型未掌握的数学推理技能，成功解决了13个大模型未能处理的问题。研究发现7B模型在处理有限基数问题时采用了独特方法（如Cardinal.toNat等），而671B模型未使用这些技术。该模型基于强化学习微调数据训练，展现了小模型自主发展新能力的现象。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T06:03:23Z
- **目录日期**: 2025-05-02
