...
DeepSeek发布的新数学模型DeepSeek-Prover-V2在数学定理证明领域取得突破，刷新多项基准测试记录。在普特南测试中，该模型解答了49道题，远超当前最优模型（10道）。值得注意的是，7B参数的小模型通过强化学习发现了671B大模型未掌握的解题方法，成功解决了13个大模型未能攻克的难题，尤其在有限基数问题上展现了独特推理模式。这一现象表明小模型能通过训练自主发展出大模型不具备的新技能。该突破为AI数学推理领域带来了新的研究方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T01:29:49Z
- **目录日期**: 2025-05-02
