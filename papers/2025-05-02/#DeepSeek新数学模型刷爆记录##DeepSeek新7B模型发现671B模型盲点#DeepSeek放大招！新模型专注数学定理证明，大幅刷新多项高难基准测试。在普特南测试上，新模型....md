...
DeepSeek发布新数学模型DeepSeek-Prover-V2，在普特南测试中以49道题的解答刷新记录，远超当前第一名的10道题表现。值得注意的是，7B参数的小模型通过强化学习发现了671B大模型未掌握的数学推理技能，成功解决了13个大模型无法处理的问题，尤其在有限基数问题上展现了独特推理模式。该模型基于前代模型微调后通过强化学习获得新能力，展示了小模型自主发展超越大模型的可能性。这一突破为AI数学推理领域带来新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T19:03:07Z
- **目录日期**: 2025-05-02
