...
DeepSeek发布新数学模型DeepSeek-Prover-V2，在普特南数学测试中取得49道题的惊人成绩，远超当前冠军（10道）。特别值得注意的是，7B参数的小模型通过强化学习发现了671B大模型未掌握的解题方法，成功解决13个大模型无法处理的问题，展现出独特的有限基数问题处理能力。该模型基于前代改进，先通过大模型数据微调，再经强化学习训练，最终实现超越大模型的新技能突破。这一成果展示了小模型通过适当训练也能发展出超越超大模型的特定能力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T11:03:21Z
- **目录日期**: 2025-05-02
