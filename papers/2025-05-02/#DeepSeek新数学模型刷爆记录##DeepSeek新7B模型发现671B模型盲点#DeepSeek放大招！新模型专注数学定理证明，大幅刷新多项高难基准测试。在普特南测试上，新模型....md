...
DeepSeek发布新数学模型DeepSeek-Prover-V2，在普特南数学测试中取得49道题的好成绩，远超当前Kimi-Prover保持的10道题记录。特别值得注意的是，7B参数的小模型通过强化学习发现了671B大模型未能掌握的解题方法，在有限基数问题上展现了独特推理模式。该模型基于V1.5-Base改进，先使用大模型数据进行微调，再通过强化学习获得新能力。这一突破表明小模型也可能超越大模型发现新技能，为AI数学推理领域带来新启示。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T16:03:33Z
- **目录日期**: 2025-05-02
