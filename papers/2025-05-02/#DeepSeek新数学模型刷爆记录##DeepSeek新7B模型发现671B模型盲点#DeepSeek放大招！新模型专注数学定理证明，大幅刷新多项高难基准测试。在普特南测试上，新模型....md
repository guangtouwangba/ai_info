...
DeepSeek推出新数学模型DeepSeek-Prover-V2，在普特南测试中取得49道题的突破性成绩，远超当前最佳模型（仅10道）。值得注意的是，7B参数的小模型通过强化学习发现了671B大模型的盲点，成功解决了13个大模型未能处理的问题，尤其在有限基数问题上展现出独特推理模式。该模型基于V1.5-Base微调并强化训练，意外习得大模型不具备的新技能。研究团队强调这一"新技能涌现"现象，展现了小模型在特定领域的潜力。论文还透露了模型优化细节，进一步结果令人期待。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T04:02:26Z
- **目录日期**: 2025-05-02
