...
DeepSeek推出新数学模型DeepSeek-Prover-V2，在数学定理证明领域表现突出，刷新多项基准测试记录。在普特南测试中，该模型解决了49道题，远超当前第一名（10道）。值得注意的是，7B参数的小模型通过强化学习发现了671B大模型未掌握的技能，成功解决了13个大模型未能处理的问题，尤其在有限基数问题上表现出独特推理模式。这一突破表明，小模型通过优化训练方法可以超越大模型的能力。团队还透露，未发布的R2版本更值得期待。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T03:18:30Z
- **目录日期**: 2025-05-02
