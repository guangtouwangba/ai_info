...
DeepSeek发布新数学模型DeepSeek-Prover-V2，在普特南测试中取得49道题的好成绩，远超当前第一名（10道）。值得注意的是，7B小模型通过强化学习发现了671B大模型的盲点，用独特方法解决了13个大模型未能处理的问题，涉及有限基数时采用了Cardinal.toNat等技术。该模型基于V1.5-Base，先用大模型数据微调再进行强化学习，最终获得了大模型不具备的新技能。这一突破展示了小模型通过特定训练可能超越大模型的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T12:03:28Z
- **目录日期**: 2025-05-02
