...
DeepSeek发布新数学模型DeepSeek-Prover-V2，在普特南测试中取得49道题的好成绩，远超当前第一名（10道题）。值得注意的是，7B参数的小模型通过强化学习发现了671B大模型未掌握的数学推理技能，成功解决了13个大模型无法处理的问题，尤其在有限基数问题上展现出独特推理模式。该模型基于V1.5-Base微调并强化学习训练而成，展现了小模型自主发现新能力的特点，突破了模型规模限制。这一成果为AI数学推理领域带来新突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T09:03:08Z
- **目录日期**: 2025-05-02
