...
DeepSeek发布新数学模型DeepSeek-Prover-V2，在普特南测试中取得49道题的好成绩，远超当前第一名的10道。值得注意的是，7B小模型通过强化学习发现了671B大模型的盲点，成功解决了13个大模型未能解决的问题，尤其在处理有限基数问题时展现出独特推理模式。该模型基于DeepSeek-Prover-V1.5-Base微调并强化学习而成，展现了超越大模型的新技能。这一突破性成果引发关注，未发布的R2版本更令人期待。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T02:30:48Z
- **目录日期**: 2025-05-02
