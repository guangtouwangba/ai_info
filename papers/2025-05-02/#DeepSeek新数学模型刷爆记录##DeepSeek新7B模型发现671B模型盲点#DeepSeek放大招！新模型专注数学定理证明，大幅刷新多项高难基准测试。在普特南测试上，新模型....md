...
DeepSeek发布新数学证明模型DeepSeek-Prover-V2，在普特南测试中以49道题的解答刷新纪录，远超当前第一名的10道题表现。研究发现，7B参数的小模型通过强化学习发现了671B大模型未掌握的解题技能，在有限基数问题上采用独特推理方法，解决了13个大模型未能攻克的题目。该模型基于V1.5-Base微调后通过强化学习训练，展现出超越参数规模的学习能力，体现了小模型自主发现新技能的可能性。这一突破为AI数学推理领域带来新进展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T21:03:21Z
- **目录日期**: 2025-05-02
