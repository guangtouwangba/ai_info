...
DeepSeek发布新数学模型DeepSeek-Prover-V2，在普特南测试中取得49道题的突破性成绩，远超当前冠军模型（10道）。值得注意的是，7B参数的小模型通过强化学习发现了671B大模型未掌握的数学推理技能，成功解决了13个大模型无法处理的问题，尤其在有限基数问题上展现出独特推理模式。该模型基于V1.5-Base微调后经强化学习训练，实现了"小模型超越大模型"的罕见现象。团队称这一发现为"新技能涌现"，相关技术细节已通过论文披露。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T07:02:48Z
- **目录日期**: 2025-05-02
