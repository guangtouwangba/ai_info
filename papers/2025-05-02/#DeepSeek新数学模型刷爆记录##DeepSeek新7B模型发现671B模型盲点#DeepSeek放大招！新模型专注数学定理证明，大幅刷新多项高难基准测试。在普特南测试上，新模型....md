...
DeepSeek推出新数学模型DeepSeek-Prover-V2，在普特南数学测试中创下49道题的新纪录，远超现有最佳模型（10道）。值得注意的是，7B参数的小模型通过强化学习发现了671B大模型的盲点，解决了13道后者无法处理的问题，尤其在有限基数问题上展现了独特推理模式。该模型基于V1.5-Base微调并强化训练，意外获得了大模型不具备的新技能。这一突破展示了小模型通过优化方法实现超越规模限制的可能性，为AI数学推理领域带来新进展。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T17:03:22Z
- **目录日期**: 2025-05-02
