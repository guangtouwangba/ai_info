...
这篇综述系统性地探讨了AI系统中的记忆机制，特别是基于大语言模型(LLM)的智能体。研究首先将记忆表征分为参数化、结构化上下文和非结构化上下文三类，并提出了六种基础记忆操作：巩固、更新、索引、遗忘、检索和压缩。通过将这些操作映射到长期记忆、长上下文、参数修改和多源记忆等研究领域，该研究为AI记忆系统提供了一个结构化动态视角，阐明了LLM智能体中记忆功能的相互作用，同时指出了未来研究方向。相关资源可在GitHub仓库获取。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T03:17:17Z
- **目录日期**: 2025-05-02
