...
这篇论文提出了一个AI智能体的四维分析框架：自主性、效能、目标复杂性和通用性。每个维度都有不同的等级划分，并引发关于AI系统设计、运营和治理的独特问题。基于此框架，作者构建了不同AI智能体的"代理特征图谱"，从单一任务助手到高度自主的通用系统，揭示了各类AI智能体带来的跨领域技术与非技术治理挑战。该框架通过梳理关键变量和连续性，为开发者、政策制定者和公众提供了开发更符合社会集体目标的治理方法的机会。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T01:28:46Z
- **目录日期**: 2025-05-02
