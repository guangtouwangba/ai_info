...
2025年上海车展见证了中国汽车工业的历史性转折：上汽大众与国内智能驾驶公司Momenta达成合作，标志着从"技术输血"到"智能造血"的转变。作为中国首家合资车企（1984年成立）的上汽大众，41年后在AI智能化浪潮中完成核心技术供应切换。值得注意的是，德日美等传统汽车巨头也在此次车展上不约而同选择引入Momenta的智能驾驶技术。这一现象被解读为汽车工业"西为中用"到"中为西用"的变革开端，或将成为终结中国汽车"技术逆差"时代的标志性事件。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T17:03:55Z
- **目录日期**: 2025-05-02
