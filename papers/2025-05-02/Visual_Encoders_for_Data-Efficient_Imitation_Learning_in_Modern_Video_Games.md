...
该研究比较了在《我的世界》《CS:GO》等现代游戏中，使用预训练视觉编码器（如DINOv2）与端到端训练方法对模仿学习决策的影响。结果表明，端到端训练在低分辨率图像和少量演示下仍有效，但预训练编码器能显著提升性能，具体效果因游戏而异。预训练编码器不仅提高了决策效率，还通过大幅降低训练成本，使视频游戏决策研究更易普及。这为资源有限的研究者提供了可行的替代方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T01:29:38Z
- **目录日期**: 2025-05-02
