...
AgentSociety是一个基于大语言模型的大规模社会模拟器，可模拟1万多个代理的社会生活及500万次互动。研究者用它分析了四个关键社会问题：社会极化、刺激性信息传播、基本收入政策影响和飓风等外部冲击。模拟结果与现实世界数据吻合，验证了该工具在揭示人类行为机制方面的有效性。该系统为社会科学研究和政策制定提供了新方法，能补充传统调查和实验的不足。研究表明AgentSociety具有捕捉复杂社会动态的潜力，可作为理解社会问题成因和机制的重要计算实验平台。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T20:04:59Z
- **目录日期**: 2025-05-02
