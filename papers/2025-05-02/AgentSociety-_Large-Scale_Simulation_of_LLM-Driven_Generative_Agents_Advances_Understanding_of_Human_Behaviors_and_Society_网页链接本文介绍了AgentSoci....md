...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟10,000多个智能代理及其500万次社会互动。该系统通过四个关键社会问题（社会极化、信息传播、基本收入政策、自然灾害影响）的模拟实验，验证了其模拟结果与现实世界数据的高度一致性。研究表明，这种LLM驱动的社会模拟能有效捕捉人类行为机制，可作为计算社会科学研究的新工具，为政策制定提供参考。该成果展示了人工智能在社会科学研究中的潜力，能够辅助传统研究方法并揭示社会问题的深层机制。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T00:05:16Z
- **目录日期**: 2025-05-02
