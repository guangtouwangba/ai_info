...
这篇论文介绍了一个名为AgentSociety的大规模社会模拟器，它结合了大型语言模型驱动的代理、真实社会环境和强大的模拟引擎。研究者模拟了超过1万个代理的社会生活及500万次互动，并针对极化现象、信息传播、基本收入政策和外部冲击等四个社会问题进行了实验。模拟结果与现实世界数据吻合，验证了该系统捕捉人类行为机制的能力，展示了其作为社会科学研究和政策制定工具的潜力。该平台能够辅助传统研究方法，帮助深入理解社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T05:04:48Z
- **目录日期**: 2025-05-02
