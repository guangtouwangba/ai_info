...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。它模拟了1万多个AI代理的社会生活，记录500万次互动，用于研究社会现象。该系统被用于四个关键问题的实验：社会极化、信息传播、基本收入政策效果和自然灾害影响。实验结果与现实数据吻合，验证了该系统在模拟人类行为和社会机制方面的可靠性。研究表明，AgentSociety可以作为社会科学研究和政策制定的有力工具，为理解复杂社会问题提供新方法。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T23:04:36Z
- **目录日期**: 2025-05-02
