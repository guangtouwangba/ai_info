...
随着AI系统能力增强，确保其与人类价值观对齐成为研究重点。当前方法多聚焦算法设计，却低估了数据的关键作用。本文主张转向以数据为中心的AI对齐，强调提升训练数据的质量和代表性。研究揭示了人类反馈的不可靠性，以及AI反馈因时间漂移、情境依赖和模型局限导致的价值偏差问题。建议未来研究方向包括：优化反馈收集机制、开发鲁棒的数据清洗方法、建立严格的验证流程。呼吁学界填补数据对齐实践的认知空白，推动该领域发展。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T18:02:18Z
- **目录日期**: 2025-05-02
