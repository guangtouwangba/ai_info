...
随着AI系统日益强大和普及，确保其与人类价值观、偏好和目标的一致性成为关键研究方向。当前对齐方法主要关注算法和损失函数设计，却常忽视数据的关键作用。本文主张转向以数据为中心的AI对齐，强调提升训练数据的质量和代表性。研究揭示了人类反馈的不可靠性，以及AI反馈存在的时间漂移、情境依赖和固有模型局限等问题。未来研究方向包括改进反馈收集方法、开发鲁棒的数据清洗技术，以及建立严格的反馈验证流程，以填补数据为中心的对齐实践中的认知空白。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T19:02:09Z
- **目录日期**: 2025-05-02
