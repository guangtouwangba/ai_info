...
当前AI对齐研究主要关注算法设计，但忽视了数据的关键作用。本文提出以数据为中心的AI对齐方法，强调提升数据质量和代表性。研究指出人类反馈存在不可靠性，AI反馈则受时间漂移、情境依赖和模型局限影响，难以准确反映人类价值观。未来研究方向包括改进反馈收集、开发鲁棒的数据清洗方法及严格的验证流程，以解决数据对齐中的关键问题。该论文呼吁加强数据导向的对齐实践研究，填补现有认知空白。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T23:02:04Z
- **目录日期**: 2025-05-02
