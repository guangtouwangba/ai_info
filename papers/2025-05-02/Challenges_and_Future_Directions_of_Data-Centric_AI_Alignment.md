...
当前AI对齐研究主要关注算法设计，但低估了数据质量的关键作用。本文提出以数据为中心的AI对齐方法，指出人类反馈存在可靠性问题（如时间漂移、情境依赖），AI反馈则因模型局限难以准确捕捉人类价值观。研究建议未来方向包括：改进反馈收集流程、开发鲁棒的数据清洗方法、建立严格的反馈验证机制，以提升训练数据的代表性和质量。该框架旨在解决数据对齐实践中存在的关键缺口，推动AI系统与人类价值观的更有效匹配。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T13:09:10Z
- **目录日期**: 2025-05-02
