...
当前AI对齐研究主要关注算法设计，但低估了数据的关键作用。本文主张转向以数据为中心的AI对齐方法，强调提升数据质量和代表性。研究指出人类反馈存在不可靠性，以及AI反馈存在时间漂移、情境依赖和模型局限等问题。未来研究方向包括改进反馈收集、开发鲁棒的数据清洗方法及严格的验证流程，以解决数据为中心的对齐实践中存在的不足。该研究呼吁加强这些关键领域的研究，确保AI系统更好地与人类价值观保持一致。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T20:02:14Z
- **目录日期**: 2025-05-02
