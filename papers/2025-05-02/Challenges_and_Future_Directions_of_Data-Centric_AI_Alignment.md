...
本文主张以数据为中心的人工智能对齐方法，强调提升训练数据的质量和代表性对AI系统价值对齐的重要性。研究指出当前基于人类反馈和AI反馈的数据都存在关键挑战：人类反馈存在可靠性问题，AI反馈则受限于时间漂移、情境依赖及模型固有缺陷。作者建议未来研究方向包括优化反馈收集流程、开发鲁棒的数据清洗方法以及严格的反馈验证机制，以填补数据对齐实践中的认知空白。这一立场论文呼吁学界关注数据质量在AI对齐中的核心作用，推动相关研究弥补现有不足。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T04:02:07Z
- **目录日期**: 2025-05-02
