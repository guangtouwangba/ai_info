...
随着AI系统能力增强，确保其与人类价值观对齐成为研究重点。当前方法过于关注算法设计而忽视数据质量。本文提出以数据为中心的AI对齐框架，指出人类反馈存在可靠性问题，AI反馈则受限于时间漂移、情境依赖和模型缺陷。研究建议改进反馈收集方法、开发鲁棒的数据清洗技术，并建立严格的验证流程。这些方向将弥补现有数据对齐实践的不足，推动AI系统更好地体现人类价值。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T03:18:11Z
- **目录日期**: 2025-05-02
