...
浙江大学与vivo合作研发的LearnAct框架实现重大突破，仅需一次示范就能教会AI完成复杂操作。该研究同步发布了LearnGUI基准，首次构建了移动端示范学习的评估体系，为AI智能体的实际应用提供关键技术支持。项目由浙大硕士生刘广义、赵鹏翔（共同一作）和vivo算法专家刘亮主导，通信作者为浙大孟文超研究员。该技术使手机AI能像人类一样快速学习，显著提升智能终端的操作效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T12:03:46Z
- **目录日期**: 2025-05-02
