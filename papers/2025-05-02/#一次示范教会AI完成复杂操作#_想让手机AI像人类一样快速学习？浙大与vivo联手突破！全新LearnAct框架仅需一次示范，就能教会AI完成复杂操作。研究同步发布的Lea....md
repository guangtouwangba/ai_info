...
浙江大学与vivo合作开发了LearnAct框架，通过单次示范即可教会AI完成复杂操作。该研究同时发布了LearnGUI基准，为移动端示范学习建立了首个评估体系。项目由浙大硕士生刘广义、赵鹏翔（共同一作）和vivo AI专家刘亮主导，浙大孟文超研究员担任通讯作者。这项技术突破使手机AI能快速学习人类操作，为AI智能体的实际应用提供了关键支持。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T22:03:30Z
- **目录日期**: 2025-05-02
