...
浙江大学与vivo合作开发了LearnAct框架，该技术突破使手机AI仅需一次示范就能学会复杂操作。研究团队同步发布了LearnGUI基准测试，首次构建了移动端示范学习的评估体系，为AI智能体实用化提供关键技术支撑。项目由浙大硕士生刘广义、赵鹏翔（共同一作）和vivo算法专家刘亮主导，浙大孟文超研究员担任通讯作者。该成果标志着大语言模型驱动的GUI智能体技术取得重要进展，使AI能像人类一样快速学习手机操作。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T16:03:49Z
- **目录日期**: 2025-05-02
