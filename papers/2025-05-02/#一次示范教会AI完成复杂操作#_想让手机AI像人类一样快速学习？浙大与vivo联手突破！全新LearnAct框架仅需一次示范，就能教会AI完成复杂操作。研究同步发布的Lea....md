...
浙江大学与vivo合作开发了LearnAct框架，仅需一次示范即可教会AI完成复杂操作。该研究同时发布了LearnGUI基准，首次构建了移动端示范学习的评估体系，为AI智能体的实用化部署提供了关键技术。研究团队由浙大硕士生刘广义、赵鹏翔（共同一作）和vivo AI专家刘亮领导，通信作者为浙大孟文超研究员。该技术实现了大语言模型驱动的GUI智能体快速学习能力，标志着手机AI向人类化学习迈出重要一步。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T20:03:34Z
- **目录日期**: 2025-05-02
