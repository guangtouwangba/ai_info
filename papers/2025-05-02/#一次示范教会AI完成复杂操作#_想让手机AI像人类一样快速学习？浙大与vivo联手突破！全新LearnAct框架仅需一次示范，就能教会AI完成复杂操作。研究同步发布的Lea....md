...
浙江大学与vivo合作开发了LearnAct框架，该技术仅需一次示范就能教会AI完成复杂操作。研究团队同时发布了LearnGUI基准测试，首次建立了移动端示范学习的评估体系。该技术由浙大硕士生刘广义、赵鹏翔（共同一作）和vivo AI专家刘亮主导，浙大孟文超研究员担任通讯作者。这项突破为AI智能体在移动端的实用化部署提供了关键技术支持，使手机AI能像人类一样快速学习复杂任务。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T08:03:02Z
- **目录日期**: 2025-05-02
