...
浙江大学与vivo合作开发了LearnAct框架，仅需一次示范即可教会AI完成复杂操作。该研究同时发布了LearnGUI基准，首次构建了移动端示范学习的评估体系，为AI智能体的实用化部署提供关键技术。论文第一作者为浙大硕士生刘广义和赵鹏翔，项目负责人为vivo AI专家刘亮，通讯作者为浙大孟文超研究员。该技术突破使手机AI能像人类一样快速学习复杂任务。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T10:03:36Z
- **目录日期**: 2025-05-02
