...
浙江大学与vivo合作开发了LearnAct框架，仅需一次示范即可教会AI完成复杂操作。该研究同步发布了LearnGUI基准，首次构建了移动端示范学习的评估体系，为AI智能体的实用化部署提供关键技术。研究团队由浙江大学硕士生刘广义、赵鹏翔（共同一作），vivo AI lab专家刘亮（项目负责人）和浙大孟文超研究员（通讯作者）组成，专注于大语言模型驱动的GUI智能体技术。这项突破使手机AI能像人类一样快速学习复杂任务。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T15:03:47Z
- **目录日期**: 2025-05-02
