...
浙江大学与vivo合作开发的LearnAct框架实现了AI智能体的突破性进展：仅需一次人类示范就能学会复杂操作。该研究同步发布了LearnGUI基准测试体系，首次为移动端示范学习建立了标准化评估方法。项目由浙大硕士生刘广义、赵鹏翔（共同一作）和vivo算法专家刘亮主导，浙大孟文超研究员担任通讯作者。这项技术使手机AI能像人类一样快速学习操作，为AI智能体的实际应用提供了关键技术支持。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T11:03:40Z
- **目录日期**: 2025-05-02
