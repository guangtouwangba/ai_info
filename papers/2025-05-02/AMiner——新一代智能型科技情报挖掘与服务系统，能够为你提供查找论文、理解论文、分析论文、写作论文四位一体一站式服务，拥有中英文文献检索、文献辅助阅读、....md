...
AMiner是一款智能科技情报挖掘系统，提供论文检索、辅助阅读、翻译及科研分析等一站式服务。其核心功能包括：1）中英文文献检索，支持互动问答和自动摘要生成；2）英文文献翻译与AI辅助阅读，可上传PDF并获取章节概要；3）个性化科研情报订阅，通过微信/邮件推送最新学术动态。平台覆盖42个学科，包含3.5亿论文、0.6亿学者等海量数据，同时提供学者画像、学术会议等特色功能。基础服务免费开放，网址：https://www.aminer.cn。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T02:33:37Z
- **目录日期**: 2025-05-02
