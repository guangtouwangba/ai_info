...
AMiner是一个智能科技情报挖掘平台，提供四位一体的学术服务：文献检索（中英文）、辅助阅读、翻译和写作支持。它拥有3.5亿论文、0.6亿学者等海量数据，支持AI生成摘要、章节概要和互动问答，帮助用户高效理解文献。平台还提供科研动态订阅服务，可按用户偏好推送最新论文摘要。其他功能包括学者画像、学术会议和论文排行榜。用户可通过网页免费使用基础功能，适合科研人员和学生快速获取学术信息。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T06:06:09Z
- **目录日期**: 2025-05-02
