...
AMiner是一款智能科技情报挖掘系统，提供论文查找、理解、分析和写作的一站式服务。它支持中英文文献检索、辅助阅读、翻译等功能，涵盖42个学科的3.5亿论文、0.6亿学者和1.5亿专利。AMiner通过智能问答和自动摘要提升文献筛选效率，支持PDF上传和AI辅助阅读，还能定制科研情报订阅服务，推送最新学术动态。此外，它还提供学者画像、学术会议和论文排行榜等功能，可免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T12:05:39Z
- **目录日期**: 2025-05-02
