...
这篇论文针对代码生成大模型(codeLLMs)提出新评估框架CodeArena，关注模型输出与人类偏好的对齐。研究者构建了包含397个样本(涵盖40类任务和44种语言)的人工标注基准，并开发20B标记的合成指令数据集SynCode-Instruct。实验发现传统基于执行的评估与人类偏好存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。研究强调了代码生成质量需兼顾功能正确性和人类可接受性，为改进代码LLMs提供了重要方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T03:21:36Z
- **目录日期**: 2025-05-02
