...
这篇论文针对代码生成大模型(codeLLMs)提出了CodeArena基准测试，重点关注模型输出与人类偏好的对齐问题。研究团队收集了397个高质量编程任务样本，覆盖40个类别和44种语言，并构建了包含近200亿标记的合成指令数据集SynCode-Instruct。实验发现，传统基于执行的评估与人类偏好存在差距，且开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著。研究强调了代码生成模型除正确性外，还需重视与开发者实际需求的匹配度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T17:05:33Z
- **目录日期**: 2025-05-02
