...
这篇论文提出了CodeArena基准测试和SynCode-Instruct语料库，用于评估代码生成大模型(CodeLLMs)与人类偏好的对齐程度。研究发现传统基于执行的基准测试无法充分反映人类偏好，通过分析40多个模型发现开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)存在显著差距。CodeArena包含397个涵盖40类编程任务的样本，支持44种语言；SynCode-Instruct则包含近200亿标记的合成指令数据。研究强调了在代码生成任务中考虑人类偏好的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T10:05:42Z
- **目录日期**: 2025-05-02
