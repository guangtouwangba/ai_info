...
该研究针对代码生成大模型(codeLLMs)提出CodeArena基准测试，通过397个涵盖40类编程任务和44种语言的真实样本，评估模型与人类偏好的匹配程度。研究发现传统基于执行的测试与人类偏好存在差异，并构建了20B标记的合成指令数据集SynCode-Instruct验证微调效果。实验比较40多个模型显示，开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)存在显著差距，凸显对齐人类偏好的重要性。研究为提升代码生成模型的实际可用性提供了新评估框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T12:05:51Z
- **目录日期**: 2025-05-02
