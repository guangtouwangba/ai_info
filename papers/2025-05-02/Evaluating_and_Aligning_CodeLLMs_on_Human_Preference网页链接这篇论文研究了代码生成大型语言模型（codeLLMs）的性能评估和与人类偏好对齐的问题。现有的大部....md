...
该论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，通过397个涵盖40类编程任务和44种语言的人类精选样本，评估模型与人类偏好的对齐程度。研究发现传统执行基准与人类偏好存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著。同时构建包含近200亿标记的SynCode-Instruct合成指令集，验证了大规模指令微调的有效性，强调代码LLMs需同时关注功能正确性和人类偏好对齐。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T06:06:20Z
- **目录日期**: 2025-05-02
