...
这篇论文提出了CodeArena基准测试和SynCode-Instruct数据集，用于评估代码生成大模型(CodeLLMs)与人类偏好的对齐程度。研究发现现有基准过于侧重代码正确性而忽略实际编程需求，为此构建了包含397个样本(覆盖40类任务和44种语言)的人类评估基准。实验显示执行基准与人类偏好存在差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI)性能差距显著。研究还验证了200亿token合成指令数据的微调效果，强调了代码模型与人类偏好对齐的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T18:05:32Z
- **目录日期**: 2025-05-02
