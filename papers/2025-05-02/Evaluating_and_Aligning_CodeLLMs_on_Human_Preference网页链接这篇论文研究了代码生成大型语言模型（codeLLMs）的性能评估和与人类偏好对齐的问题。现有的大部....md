...
这篇论文探讨了代码生成大模型(codeLLMs)与人类偏好的对齐问题，指出当前基准测试过于关注代码正确性而忽视用户体验。研究者创建了CodeArena基准(含397个样本/44种语言)模拟真实编程场景，并开发了20B标记的SynCode-Instruct合成指令集。实验发现：1)传统执行基准与CodeArena存在性能差异；2)开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)差距显著。研究强调了代码LLMs在符合人类偏好方面的重要性，为模型优化提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T14:05:56Z
- **目录日期**: 2025-05-02
