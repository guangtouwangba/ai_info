...
随着前沿AI系统能力增强和自主性提高，其发展可能带来影响全社会的系统性风险。当前许多AI实验室在安全措施、测试流程和治理结构方面缺乏足够透明度，导致难以验证安全声明或确定事故责任。借鉴核能、航空软件和医疗领域的责任框架，研究者提出了一套全面的安全文档和问责机制方案，以加强前沿AI开发的安全监管。该研究强调需要建立更透明的安全实践标准，确保AI发展过程中的可追溯性和责任归属。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T07:01:47Z
- **目录日期**: 2025-05-02
