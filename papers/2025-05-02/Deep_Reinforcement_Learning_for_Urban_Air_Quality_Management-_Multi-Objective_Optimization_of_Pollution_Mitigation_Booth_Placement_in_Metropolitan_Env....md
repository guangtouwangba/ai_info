...
德里是全球空气污染最严重的城市之一，主要受交通排放、工业活动和建筑扬尘影响。传统静态空气净化装置因位置不佳和适应性不足效果有限。本研究提出一种深度强化学习（DRL）框架，利用近端策略优化（PPO）算法，根据人口密度、交通模式、工业影响和绿地限制等因素，优化空气净化亭的布局。与随机和基于AQI的贪婪方法相比，DRL方法在AQI改善、空间覆盖和公平性方面表现更优，实现了净化设施的高效均衡分布。结果表明，AI驱动的空间优化能有效提升城市空气质量，推动智慧城市发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T04:01:23Z
- **目录日期**: 2025-05-02
