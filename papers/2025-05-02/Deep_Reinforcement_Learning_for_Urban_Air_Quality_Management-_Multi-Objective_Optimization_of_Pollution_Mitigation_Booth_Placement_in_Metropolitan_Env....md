...
德里是全球空气污染最严重的城市之一，主要受交通尾气、工业活动和建筑扬尘影响。传统静态空气净化装置因布局不合理和适应性差而效果有限。本研究提出一种深度强化学习（DRL）框架，采用近端策略优化（PPO）算法，根据人口密度、交通模式、工业分布和绿地约束等空间环境因素，优化空气净化亭的布局。相比随机和贪婪AQI基准方法，DRL方法在AQI改善、空间覆盖、人口交通影响和空间熵等多维指标上表现更优，实现了净化设施的高效均衡分布，为智慧城市和数据驱动的空气质量治理提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T22:01:30Z
- **目录日期**: 2025-05-02
