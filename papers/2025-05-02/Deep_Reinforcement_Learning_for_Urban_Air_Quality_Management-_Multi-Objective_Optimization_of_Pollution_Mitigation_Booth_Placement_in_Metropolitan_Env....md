...
印度德里是全球污染最严重的城市之一，主要污染源包括交通排放、工业活动和建筑扬尘。传统静态空气净化装置因位置欠佳和适应性不足，效果有限。本研究提出一种基于深度强化学习（DRL）的新框架，利用近端策略优化（PPO）算法，综合考虑人口密度、交通模式、工业影响和绿地分布等因素，优化空气净化亭的布局。相比随机和基于AQI的贪婪方法，DRL方法在AQI改善、空间覆盖和公平性等指标上表现更优，实现了净化效果与覆盖范围的平衡。该研究展示了人工智能在智慧城市和空气质量管理的应用潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T11:01:27Z
- **目录日期**: 2025-05-02
