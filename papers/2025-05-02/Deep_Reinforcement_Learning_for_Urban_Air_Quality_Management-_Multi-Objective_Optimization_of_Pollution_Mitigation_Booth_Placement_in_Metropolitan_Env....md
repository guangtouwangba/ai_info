...
德里是全球空气污染最严重的城市之一，主要受交通排放、工业活动和建筑扬尘影响。传统静态空气净化装置因位置不佳和适应性差而效果有限。本研究提出了一种新型深度强化学习（DRL）框架，利用近端策略优化（PPO）算法，根据人口密度、交通模式、工业影响和绿地限制等多重因素，优化空气净化亭的布局。相比随机和基于AQI的贪婪方法，DRL方法在AQI改善、空间覆盖、人口交通影响和空间熵等多维指标上表现更优，实现了净化设施的高效均衡分布，为智慧城市和数据驱动的空气质量治理提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T10:01:25Z
- **目录日期**: 2025-05-02
