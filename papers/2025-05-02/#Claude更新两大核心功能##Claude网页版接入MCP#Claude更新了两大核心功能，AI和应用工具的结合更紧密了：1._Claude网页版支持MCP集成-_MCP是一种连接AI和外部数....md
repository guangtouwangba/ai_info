...
Claude最新更新两大核心功能：1) 网页版接入MCP协议（AI界的Type-C接口），支持直接调用Jira、Intercom等10款应用数据，实现工作日程安排、用户反馈调取等功能；2) Research功能升级，可整合MCP接入应用数据，30分钟内分析500多份资料生成带来源引用的详细报告。这些功能已向Max/Team/Enterprise用户开放，Pro用户将陆续获得，推动AI向"大模型即服务"方向发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T15:03:01Z
- **目录日期**: 2025-05-02
