...
Claude最新更新两大核心功能：1) 网页版接入MCP协议（AI界的Type-C接口），支持连接GitLab、PayPal等10款应用，实现一键调用外部服务（如Jira任务管理、Intercom用户反馈）；2) Research功能升级，可整合MCP接入应用数据，30分钟内分析500+资料生成带引用来源的调研报告。这些功能已向Max/Team/Enterprise用户开放，Pro用户将陆续获得。更新强化了AI与工具集成能力，推动"大模型即服务"发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T14:02:59Z
- **目录日期**: 2025-05-02
