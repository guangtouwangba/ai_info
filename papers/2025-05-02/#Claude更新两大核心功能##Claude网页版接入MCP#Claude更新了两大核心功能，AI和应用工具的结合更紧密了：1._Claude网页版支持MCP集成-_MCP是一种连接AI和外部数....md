...
Claude近期更新两大核心功能：1）网页版接入MCP协议（AI界Type-C接口），支持10款应用（如Jira、PayPal）一键集成，开发者30分钟可完成对接，实现AI直接调用外部工具数据；2）Research功能升级，新增MCP应用数据源，能30分钟内分析500+资料并生成带溯源链接的详细报告。这些功能已向Max/Team/Enterprise用户开放，Pro用户将逐步获得。更新推动AI与工具深度整合，向"大模型即服务"迈进。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T20:02:47Z
- **目录日期**: 2025-05-02
