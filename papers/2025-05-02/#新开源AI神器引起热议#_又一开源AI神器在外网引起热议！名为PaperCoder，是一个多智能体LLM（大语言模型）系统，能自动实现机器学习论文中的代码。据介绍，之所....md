...
韩国科学技术院研究人员开发了一款名为PaperCoder的开源AI工具，能够自动将机器学习论文转化为可运行代码。该工具采用多智能体系统，分别在规划、分析和代码生成三个阶段处理任务，旨在解决顶会论文代码开源率低（2024年仅21%）导致的复现困难问题。测试显示，其生成的代码质量优于部分现有基准，并获得了77%原论文作者的认可。这一创新工具有望加速机器学习研究成果的复现和应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T01:30:16Z
- **目录日期**: 2025-05-02
