...
韩国科学技术院研究人员开发了一款名为PaperCoder的开源AI工具，能够将机器学习论文自动转换为可运行代码。该系统采用多智能体架构，通过规划、分析和代码生成三个阶段处理任务，旨在解决顶会论文代码开源率低（2024年仅21%）导致的复现困难问题。测试显示其生成代码质量优于部分基准，并获得了77%原论文作者的认可。该工具有望加速科研成果的复现和应用进程。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T23:03:23Z
- **目录日期**: 2025-05-02
