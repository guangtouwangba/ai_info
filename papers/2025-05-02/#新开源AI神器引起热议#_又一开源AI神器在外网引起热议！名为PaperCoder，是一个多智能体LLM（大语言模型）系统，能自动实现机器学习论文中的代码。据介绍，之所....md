...
韩国科学技术院团队开发的开源AI工具PaperCoder引发关注。该系统采用多智能体架构，能自动将机器学习论文转化为可运行代码，解决了顶会论文仅21%开源代码导致的复现难题。其三大智能体分工处理规划、分析和代码生成，最终产出代码质量超越基准测试，并获77%原论文作者认可。该工具显著提升了科研代码的复现效率，推动AI研究可复现性发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T08:03:10Z
- **目录日期**: 2025-05-02
