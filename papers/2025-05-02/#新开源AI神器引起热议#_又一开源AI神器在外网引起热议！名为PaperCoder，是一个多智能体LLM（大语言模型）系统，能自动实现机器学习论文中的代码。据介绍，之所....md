...
韩国科学技术院团队开发的开源AI工具PaperCoder引发关注。该系统通过多智能体协作（规划、分析、代码生成三阶段），能将机器学习论文自动转化为可运行代码。研究显示，2024年顶会论文仅21%公开代码，导致复现困难。PaperCoder生成的代码质量超越部分基准测试，获得77%原论文作者认可，显著提升研究复现效率。该工具针对NeurIPS等顶会论文设计，有效解决了学术代码共享不足的问题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T03:18:57Z
- **目录日期**: 2025-05-02
