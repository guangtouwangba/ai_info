...
韩国科学技术院团队开发的PaperCoder是一个多智能体开源AI系统，能自动将机器学习论文转化为可运行代码。该系统针对2024年顶会论文仅21%开源代码的问题，通过规划、分析、代码生成三阶段智能体协作，显著提升研究复现效率。测试显示其生成代码质量超越部分基准，并获得77%原论文作者认可。该工具旨在解决学术领域代码共享率低导致的复现困难问题，目前已在海外引发广泛讨论。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T10:03:44Z
- **目录日期**: 2025-05-02
