...
韩国科学技术院研究人员开发了名为PaperCoder的开源AI工具，能自动将机器学习论文转化为可运行代码。该系统采用多智能体架构，分规划、分析和代码生成三个阶段处理任务。开发背景是2024年顶会论文仅21%公开代码，导致复现困难。测试显示其生成代码质量优于部分基准，并获77%原论文作者认可。该工具旨在加速科研成果复现和应用落地。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T13:10:43Z
- **目录日期**: 2025-05-02
