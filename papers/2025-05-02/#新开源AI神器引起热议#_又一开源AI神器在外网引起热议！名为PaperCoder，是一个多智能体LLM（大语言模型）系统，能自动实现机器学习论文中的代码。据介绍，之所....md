...
韩国科学技术院团队开发的开源AI工具PaperCoder引发热议。该系统采用多智能体架构，能自动将机器学习论文转换为可运行代码，解决学术论文代码开源率低（2024年顶会仅21%论文公开代码）导致的复现困难问题。其工作流程分为规划、分析和代码生成三阶段，由专用智能体协作完成。测试显示，生成代码质量超越现有基准，并获得77%原论文作者的认可。该工具显著提升了科研成果的复现效率，推动AI研究发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T00:03:21Z
- **目录日期**: 2025-05-02
