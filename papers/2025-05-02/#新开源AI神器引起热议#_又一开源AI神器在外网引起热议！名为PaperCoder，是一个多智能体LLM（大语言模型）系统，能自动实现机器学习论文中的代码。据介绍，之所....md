...
韩国科学技术院团队开发的开源AI工具PaperCoder引发热议。该系统通过多智能体分工（规划、分析、代码生成），能将机器学习论文自动转化为可运行代码。研究显示2024年顶会论文仅21%公开代码，导致复现困难。PaperCoder生成的代码质量超越部分基准测试，并获得77%原论文作者认可。该工具旨在加速科研成果的复现和应用开发。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T14:03:54Z
- **目录日期**: 2025-05-02
