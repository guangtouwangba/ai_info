...
韩国科学技术院团队开发的开源AI工具PaperCoder引发热议。该系统通过多智能体架构（规划、分析、代码生成三阶段）自动将机器学习论文转化为可运行代码，解决了顶会论文仅21%公开代码导致的复现难题。测试显示其生成代码质量超越部分基准，并获得77%原论文作者认可。该工具显著提升了科研代码的复现效率，推动学术成果的快速落地应用。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T17:03:46Z
- **目录日期**: 2025-05-02
