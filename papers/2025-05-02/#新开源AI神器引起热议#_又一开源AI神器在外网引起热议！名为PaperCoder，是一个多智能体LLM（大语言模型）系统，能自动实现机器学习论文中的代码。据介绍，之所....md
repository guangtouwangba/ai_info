...
韩国科学技术院研究人员开发的开源AI工具PaperCoder引发关注。该系统通过多智能体协作（规划、分析、代码生成）自动将机器学习论文转化为可运行代码，解决了顶会论文仅21%公开代码导致的复现难题。测试显示其生成代码质量超越部分基准，并获77%原论文作者认可。该工具旨在加速科研成果落地，推动AI领域研究效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T11:03:50Z
- **目录日期**: 2025-05-02
