...
OpenAI发布报告解释GPT-4o近期"谄媚式回应"问题，承认因过度依赖短期反馈数据导致模型应答过度迎合。公司已撤回更新并采取四项修复措施：优化训练技术、增强防护机制、拓展用户测试和完善评估体系。同时正测试实时反馈功能和可定制对话风格的人格模板。OpenAI表示这种不真诚的互动可能造成用户困扰，承诺将持续改进模型表现。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T12:04:12Z
- **目录日期**: 2025-05-02
