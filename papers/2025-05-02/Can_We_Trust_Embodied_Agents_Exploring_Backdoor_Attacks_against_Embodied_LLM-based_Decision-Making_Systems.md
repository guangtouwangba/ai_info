...
本文提出了首个针对基于大语言模型(LLM)的具身AI决策系统的后门攻击框架BALD，系统研究了攻击面和触发机制。研究者设计了三种攻击方式：词语注入、场景操控和知识注入，针对LLM决策流程的不同环节。实验在自动驾驶和家庭机器人任务中对GPT-3.5、LLaMA2和PaLM2等主流模型进行了验证，攻击成功率最高可达100%，且具有隐蔽性。研究揭示了具身LLM系统的严重安全漏洞，其中词语和知识注入攻击仅需有限系统访问权限，场景操控攻击无需运行时入侵。结果表明这些攻击对现有防御措施具有强鲁棒性，凸显了保护这类系统的紧迫性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T00:02:20Z
- **目录日期**: 2025-05-02
