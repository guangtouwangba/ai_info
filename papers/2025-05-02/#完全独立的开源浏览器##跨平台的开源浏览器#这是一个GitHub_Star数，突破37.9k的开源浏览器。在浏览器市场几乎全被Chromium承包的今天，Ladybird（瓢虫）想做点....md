...
Ladybird是一款完全独立开发的开源浏览器，不依赖Chromium、Firefox或WebKit，所有底层引擎和JS引擎均从零开始用C++编写。该项目由非营利组织Ladybird Browser Initiative运营，完全依靠赞助和捐款，承诺永不商业化。目前已有7名全职工程师，支持者包括GitHub联合创始人等。尽管尚未完全成熟，但已能处理日常任务，在Web Platform Tests中JS引擎合规性排名第二。代码量近50万行，贡献者超1000人，目标是打造符合现代标准的跨平台浏览器。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T04:03:39Z
- **目录日期**: 2025-05-02
