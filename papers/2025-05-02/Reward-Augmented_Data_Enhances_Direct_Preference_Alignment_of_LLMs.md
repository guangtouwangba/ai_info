...
该研究提出了一种基于奖励条件的大语言模型（LLM）对齐方法，通过利用偏好数据中的奖励分数来优化模型性能。现有方法通常忽略响应质量，仅关注相对偏好，导致过拟合或错误学习。新方法通过数据重标注，将偏好对与质量分数结合构建增强数据集，使模型能学习响应质量的整体分布，从而推广到更优区域。实验表明，该方法显著提升了DPO（Direct Preference Optimization）性能，有效利用偏好数据并减少错误学习问题。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T10:02:04Z
- **目录日期**: 2025-05-02
