...
大型语言模型（LLMs）的偏好对齐虽能提升指令遵循能力，但现有方法过度关注相对偏好而忽略响应质量，导致对低质量选择的盲目偏好或高质量拒绝响应的遗忘。本研究提出基于奖励条件的LLM策略，通过分析数据集中的完整质量谱来优化学习。方法包括对偏好数据重新标注，构建奖励增强数据集。实验表明，该方法显著提升DPO性能，有效利用偏好数据并缓解遗忘问题，其优势不仅源于数据扩展。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T18:02:09Z
- **目录日期**: 2025-05-02
