...
大型语言模型（LLMs）的偏好对齐虽能提升对人类指令的遵从性，但现有方法过度关注相对偏好而忽略响应质量，导致对次优拒绝响应的过度拟合或盲目偏好低质量选择响应。本研究提出基于奖励条件的LLM策略，通过分析数据集中全部响应质量来泛化至更优解，并设计了一种简单有效的数据重标注方法，将偏好对与质量分数结合构建奖励增强数据集。实验表明，该方法显著提升了DPO性能，不仅最大化偏好数据效用，还缓解了“遗忘”问题，其效果超越单纯的数据扩展。代码已开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T20:02:07Z
- **目录日期**: 2025-05-02
