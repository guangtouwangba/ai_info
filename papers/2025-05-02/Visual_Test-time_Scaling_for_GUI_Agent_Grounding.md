...
研究人员提出了RegionFocus，一种视觉测试时缩放方法，用于提升视觉语言模型代理处理网页的能力。该方法通过动态放大相关区域减少背景干扰，并引入图像地图机制可视化关键地标，从而提升定位准确性和操作透明度。实验显示，该方法在Screenspot-pro和WebVoyager基准测试中分别取得28%和24%的性能提升，配合Qwen2.5-VL-72B模型时，ScreenSpot-Pro基准测试准确率达到61.6%的新纪录。代码已开源。该方法有效解决了网页视觉复杂性和界面元素过多导致的交互难题。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T13:08:03Z
- **目录日期**: 2025-05-02
