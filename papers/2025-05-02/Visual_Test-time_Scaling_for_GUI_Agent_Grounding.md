...
本文介绍了RegionFocus，一种针对视觉语言模型代理的视觉测试时缩放方法。该方法通过动态放大网页相关区域，减少背景干扰，提高定位准确性。同时提出图像地图机制，可视化关键地标，提供透明操作记录，帮助代理有效选择候选动作。实验表明，该方法在UI-TARS和Qwen2.5-VL两种先进模型上，将Screenspot-pro和WebVoyager基准测试性能分别提升28%和24%。在Qwen2.5-VL-72B模型上，ScreenSpot-Pro基准测试达到61.6%的最新定位性能。代码将在GitHub开源。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T17:01:18Z
- **目录日期**: 2025-05-02
