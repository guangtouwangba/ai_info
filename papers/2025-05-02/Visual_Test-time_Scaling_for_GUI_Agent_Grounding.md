...
RegionFocus是一种视觉测试时缩放方法，用于提升视觉语言模型代理在复杂网页界面中的表现。该方法通过动态放大相关区域，减少背景干扰，提高动作选择的准确性。结合图像地图机制，可视化关键地标，提供透明操作记录，帮助代理有效筛选候选动作。实验表明，该方法在UI-TARS和Qwen2.5-VL等先进模型上显著提升性能，在Screenspot-pro和WebVoyager基准测试中分别获得28%和24%的增益。使用Qwen2.5-VL-72B模型时，在ScreenSpot-Pro基准上达到61.6%的最新最优性能。代码将公开在GitHub。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T16:01:18Z
- **目录日期**: 2025-05-02
