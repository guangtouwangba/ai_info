...
RegionFocus是一种视觉测试时缩放方法，用于提升视觉语言模型代理在网页理解任务中的表现。该方法通过动态聚焦相关区域来减少背景干扰，提高定位准确性，并采用图像-地图机制可视化关键地标，增强动作选择的透明度。实验显示，该方法在Screenspot-pro和WebVoyager基准测试中分别提升28%和24%的性能，结合Qwen2.5-VL-72B模型后，在ScreenSpot-Pro上达到61.6%的最新最优定位准确率。代码将公开于GitHub。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T15:01:09Z
- **目录日期**: 2025-05-02
