...
这篇论文探讨了实现"人工科学家"愿景所需的关键概念，从AlphaGo到ChatGPT展开实证研究。研究始于类似AlphaGo Zero的Olivaw智能体，它虽能独立发现奥赛罗棋知识但无法表达，从而催生了"解释性学习"(EL)框架。通过EL成功破解模拟科研过程的Zendo棋盘游戏，发现人工科学家必须自主构建解释语言而非依赖现有解释器。研究进一步提出构建CLIP类模型的新方法，将解释与感知显式分离。最后指出ChatGPT等模型在成为人工科学家方面的不足，并引入Big-Bench符号解释任务作为基准测试，显示大语言模型表现仅随机水平而人类能完全解决。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T09:02:00Z
- **目录日期**: 2025-05-02
