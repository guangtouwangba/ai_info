...
这篇论文探讨了实现"人工科学家"愿景所需的关键概念，从AlphaGo到ChatGPT展开实证研究。研究始于类似AlphaGo Zero的Olivaw智能体，它虽能发现奥赛罗棋知识但无法表达，由此发展出"解释性学习"(EL)框架，成功破解模拟科研过程的Zendo棋盘游戏。核心洞见是：人工科学家必须自主构建解释语言的理解机制，而非依赖固定解释器。研究进一步提出构建解耦感知与解释的CLIP类模型的新方法，并指出当前ChatGPT等模型在成为人工科学家方面的不足，通过Big-Bench符号解释任务验证了人类与LLM的显著差距。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T12:02:05Z
- **目录日期**: 2025-05-02
