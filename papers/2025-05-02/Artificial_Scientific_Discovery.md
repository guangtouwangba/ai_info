...
这篇论文探讨了实现"人工科学家"愿景所需的核心概念，从AlphaGo到ChatGPT展开实证研究。研究首先开发了类似AlphaGo Zero的Olivaw智能体，但发现其无法交流知识，于是提出"解释性学习"(EL)框架来解决科学解释问题。通过破解Zendo棋盘游戏获得关键洞见：人工科学家必须自主发展解释语言的理解能力，而非依赖固定解释器。研究还提出构建解耦感知与解释的CLIP类模型的新方法。最后指出当前大语言模型(如ChatGPT)与人工科学家的差距，并引入Big-Bench符号解释任务作为基准测试。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T16:02:10Z
- **目录日期**: 2025-05-02
