...
这篇论文探讨了实现"人工科学家"愿景所需的核心概念，从AlphaGo到ChatGPT展开实证研究。研究始于类似AlphaGo Zero的Olivaw智能体，它虽能发现新知识但无法表达，由此发展出"解释性学习"(EL)框架。通过破解科学模拟游戏Zendo，研究发现人工科学家必须自主构建解释语言而非依赖固定解释器。论文进一步提出构建CLIP类模型的新方法，将解释与感知显式分离。最后指出当前大语言模型(如ChatGPT)与人工科学家的差距，并引入Big-Bench符号解释任务作为基准测试，显示人类表现远超随机水平的LLMs。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T22:02:00Z
- **目录日期**: 2025-05-02
