...
这篇论文探讨了实现"人工科学家"愿景所需的基础概念，从AlphaGo到ChatGPT展开实证研究。研究首先开发了类似AlphaGo Zero的Olivaw智能体，随后提出"解释性学习"(EL)框架来解决科学解释问题，并成功应用于Zendo棋盘游戏。关键发现是：人工科学家需要自主发展解释语言的理解能力，而非依赖固定解释器。作者进一步研究了多模态模型，提出一种经济高效的CLIP类模型构建方法，将解释与感知明确分离。最后指出ChatGPT等模型与人工科学家的差距，并引入Big-Bench符号解释任务作为基准测试。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T05:01:55Z
- **目录日期**: 2025-05-02
