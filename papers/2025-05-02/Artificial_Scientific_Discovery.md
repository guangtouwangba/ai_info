...
这篇论文探讨了如何实现"人工科学家"的愿景——能够自主进行原创研究并扩展人类知识的AI系统。研究从AlphaGo风格的Othello智能体Olivaw出发，发现其无法解释知识，进而提出"解释学习"(EL)框架来模拟科学家解释新现象的过程。通过破解科学模拟游戏Zendo，研究发现人工科学家需要自主发展解释语言的理解能力。论文还提出了一种高效的多模态模型构建方法，将单模态模型解耦结合。最后指出ChatGPT等大模型在解释Zendo类任务上表现仅随机水平，与人类存在显著差距，仍需突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T23:01:48Z
- **目录日期**: 2025-05-02
