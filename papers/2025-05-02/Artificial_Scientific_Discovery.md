...
这篇论文探讨了实现"人工科学家"愿景所需的核心概念，从AlphaGo到ChatGPT展开实证研究。研究首先开发了类似AlphaGo Zero的Olivaw智能体，发现其无法传达知识，进而提出"解释学习"(EL)框架来模拟科学家解释新现象的过程。通过EL成功破解了模拟科研过程的Zendo棋盘游戏，关键发现是人工科学家需要自主发展解释语言的能力。研究还提出了一种高效构建CLIP类模型的新方法，并分析了当前大语言模型(如ChatGPT)与真正人工科学家的差距，为此设计了Big-Bench符号解释任务作为评估基准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T13:08:51Z
- **目录日期**: 2025-05-02
