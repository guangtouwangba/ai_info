...
这篇论文探讨了实现"人工科学家"愿景所需的关键概念，从AlphaGo到ChatGPT展开实证研究。研究首先开发了类似AlphaGo Zero的Olivaw智能体，发现其无法传达知识，进而提出"解释性学习"(EL)框架来模拟科学家解释新现象的过程。通过破解科学模拟游戏Zendo，研究揭示人工科学家需要自主发展解释语言的能力。论文还提出了一种经济高效的多模态模型构建方法，将单模态模型解耦结合。最后指出当前大语言模型(如ChatGPT)在解释Zendo类任务上表现仅达随机水平，与人类存在显著差距。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T04:01:48Z
- **目录日期**: 2025-05-02
