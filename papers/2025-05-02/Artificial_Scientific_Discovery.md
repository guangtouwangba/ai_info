...
这篇论文探讨了实现"人工科学家"愿景所需的关键概念，从AlphaGo到ChatGPT展开实证研究。研究首先开发了类似AlphaGo Zero的Olivaw智能体，发现其无法传达知识，进而提出"解释学习"(EL)框架来模拟科学家解释新现象的过程。通过破解科学模拟游戏Zendo，研究发现人工科学家需要自主发展解释语言的理解能力，而非依赖固定解释器。作者还提出了一种经济高效的多模态模型构建方法，将单模态模型解耦结合。最后指出当前大语言模型(如ChatGPT)在解释Zendo类任务上表现仅随机水平，与人类存在显著差距。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T07:01:58Z
- **目录日期**: 2025-05-02
