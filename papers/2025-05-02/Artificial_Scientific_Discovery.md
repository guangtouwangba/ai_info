...
这篇论文探讨了实现"人工科学家"愿景所需的核心概念，从AlphaGo到ChatGPT展开实证研究。研究始于类似AlphaGo Zero的Olivaw智能体，它虽能自主发现知识但无法表达，由此发展出"解释性学习"(EL)框架，成功破解模拟科研过程的Zendo棋盘游戏。关键发现是人工科学家必须自主构建解释语言的理解机制，而非依赖固定解释器。作者进一步提出解耦感知与解释的CLIP类模型构建方法，并指出ChatGPT等模型在成为人工科学家方面的不足，同时引入评估解释理解能力的Big-Bench符号解释任务基准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T18:01:59Z
- **目录日期**: 2025-05-02
