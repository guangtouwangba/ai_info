...
这篇论文探讨了实现"人工科学家"愿景所需的基础概念，从AlphaGo到ChatGPT展开实证研究。研究始于类似AlphaGo Zero的Olivaw智能体，发现其无法传达知识，进而开发了"解释性学习"(EL)框架来模拟科学家解释新现象的过程。通过EL成功破解了模拟科研过程的Zendo游戏，得出关键见解：人工科学家必须自主发展解释语言的理解能力。研究还提出构建CLIP类模型的新方法，将解释与感知明确分离。最后指出ChatGPT等模型在成为人工科学家方面的不足，并引入Big-Bench符号解释任务作为评估基准。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T10:01:52Z
- **目录日期**: 2025-05-02
