...
这篇论文探讨了实现"人工科学家"愿景所需的核心概念，从AlphaGo到ChatGPT展开实证研究。研究始于类似AlphaGo Zero的Olivaw智能体，它虽能自主发现知识但无法表达，由此发展出"解释性学习"(EL)框架。通过破解模拟科研过程的Zendo游戏，发现人工科学家必须自主构建解释语言而非依赖固定解释器。研究进一步提出构建解耦感知与解释的多模态模型新方法，仅需少量数据即可耦合单模态模型。最后指出当前大语言模型(如ChatGPT)在解释能力上仍不及人类，并引入Big-Bench符号解释任务作为基准测试。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T14:02:01Z
- **目录日期**: 2025-05-02
