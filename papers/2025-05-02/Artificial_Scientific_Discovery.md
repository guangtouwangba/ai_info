...
这篇论文探讨了实现"人工科学家"愿景所需的关键概念，从AlphaGo到ChatGPT展开实证研究。研究首先开发了类似AlphaGo Zero的Olivaw智能体，发现其无法传达知识，进而提出"解释性学习"(EL)框架来解决科学解释问题。通过破解Zendo棋盘游戏，研究得出关键洞见：人工科学家必须自主发展解释语言的理解能力，而非依赖固定解释器。作者还提出了一种高效构建CLIP类模型的新方法，并指出当前ChatGPT等模型在成为人工科学家方面的不足，通过Big-Bench符号解释任务验证了人类与LLM的差距。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T20:01:56Z
- **目录日期**: 2025-05-02
