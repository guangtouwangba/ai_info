...
这篇论文探讨了实现“人工科学家”愿景所需的关键概念，从AlphaGo到ChatGPT展开实证研究。研究首先开发了类似AlphaGo Zero的代理Olivaw，发现了其无法传达知识的局限，进而提出“解释性学习”（EL）框架来解决科学解释问题。通过EL成功破解了模拟科学探索的Zendo游戏，揭示了人工科学家必须自主构建解释语言而非依赖固定解释器。研究还提出了一种高效的多模态模型构建方法，并指出当前ChatGPT等模型在成为人工科学家方面的不足，最后通过Big-Bench符号解释任务验证了人类与LLM在解释能力上的显著差距。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T19:01:53Z
- **目录日期**: 2025-05-02
