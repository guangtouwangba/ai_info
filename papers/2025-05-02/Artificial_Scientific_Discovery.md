...
这篇论文探讨了如何实现"人工科学家"的愿景——能自主进行原创研究并扩展人类知识的AI系统。研究从AlphaGo类智能体Olivaw出发，发现其无法解释发现的奥赛罗棋知识，从而提出"解释性学习"(EL)框架来模拟科学家解释新现象的过程。通过破解科学模拟游戏Zendo，研究者发现AI必须自主构建解释语言而非依赖预设解释器。研究进一步探索了现代多模态模型，提出解耦感知与解释的CLIP类模型构建方法。最后指出ChatGPT等模型在解释Zendo类任务上表现仅随机水平，与人类存在显著差距。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T21:02:01Z
- **目录日期**: 2025-05-02
