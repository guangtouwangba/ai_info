...
微软与OpenAI的合作关系近期出现明显裂痕。《华尔街日报》披露双方在算力分配、模型授权和AGI发展路径上存在重大分歧：微软开始自研AI模型并收购竞品团队，减少对OpenAI依赖；OpenAI则面临人才流失和微软对其AGI野心的质疑。尽管双方仍保持每周例会，但CEO间的日常联系已从每天多条短信锐减。这些动作表明，这对曾经的AI黄金搭档正在走向战略分岔路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T21:03:03Z
- **目录日期**: 2025-05-02
