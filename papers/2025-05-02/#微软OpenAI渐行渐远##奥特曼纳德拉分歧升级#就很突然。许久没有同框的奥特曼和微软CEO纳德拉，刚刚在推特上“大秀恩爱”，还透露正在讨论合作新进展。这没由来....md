...
微软与OpenAI的合作关系出现微妙变化，双方在算力资源、模型授权和AGI发展方向上存在分歧。微软正减少对OpenAI的依赖，自研AI模型并收购Inflection团队开发对标GPT-4的产品。尽管双方仍维持合作，但联系频率从每日多条短信降至每周例会，OpenAI近期还面临人才流失问题。这些迹象表明，这对曾经的科技圈黄金搭档可能正在渐行渐远。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T15:03:10Z
- **目录日期**: 2025-05-02
