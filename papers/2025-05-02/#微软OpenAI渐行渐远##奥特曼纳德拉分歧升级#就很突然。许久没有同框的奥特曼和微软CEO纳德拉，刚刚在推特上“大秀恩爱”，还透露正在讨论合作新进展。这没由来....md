...
微软与OpenAI的合作关系近期出现微妙变化。据《华尔街日报》报道，双方在算力分配、模型授权和AGI发展方向上存在分歧：OpenAI要求更多资源但微软称已达极限，同时微软正自研AI模型减少依赖；OpenAI人事动荡而微软主推Copilot并对AGI持保留态度。此外微软收购Inflection团队独立研发对标GPT-4的模型。纳德拉与奥特曼的日常联系从每日多条短信降至每周例会。尽管双方公开互动频繁，但实际合作已显现渐行渐远趋势。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T14:03:09Z
- **目录日期**: 2025-05-02
