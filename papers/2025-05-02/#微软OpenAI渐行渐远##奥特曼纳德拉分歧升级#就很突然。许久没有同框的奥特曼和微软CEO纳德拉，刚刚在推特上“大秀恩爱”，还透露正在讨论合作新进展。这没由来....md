...
微软与OpenAI的合作关系出现微妙变化，主要分歧集中在三方面：1)算力资源分配与模型权限问题；2)对AGI发展方向的判断差异；3)微软开始自研大模型形成内部竞争。据《华尔街日报》报道，双方高层联系频率从每日多条短信降至每周例会，尽管公开场合仍展示合作，但微软正通过收购团队、自主研发等方式减少对OpenAI的依赖。近期奥特曼与纳德拉的公开互动被解读为对关系传闻的回应。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T20:02:57Z
- **目录日期**: 2025-05-02
