...
微软与OpenAI的合作关系出现微妙变化。据《华尔街日报》报道，双方在算力资源分配、AGI发展方向和模型授权方面存在分歧。微软正减少对OpenAI的依赖，自研AI模型并收购Inflection团队开发对标GPT-4的产品。尽管双方仍保持每周例会，但联系频率已从CEO间每日多条短信降至例行沟通。OpenAI面临人才流失问题，而微软更聚焦Copilot等实际应用，对AGI进展持保留态度。这些迹象表明，曾经的紧密合作伙伴正在战略上逐渐分道扬镳。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T16:03:13Z
- **目录日期**: 2025-05-02
