...
微软与OpenAI的合作关系近期出现微妙变化，主要体现在三方面：1）算力资源分配和模型授权存在分歧，微软正自研AI减少依赖；2）对AGI发展态度不同，OpenAI人事动荡而微软主推Copilot；3）微软收购Inflection团队独立研发LLM，形成内部竞争。尽管双方仍维持合作，但高管互动频率明显下降，从每日多条短信降至每周例会。这一变化引发外界对两家公司未来合作走向的猜测。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T13:09:56Z
- **目录日期**: 2025-05-02
