...
微软与OpenAI的合作关系出现裂痕，主要体现在三方面：1)算力分配与模型授权分歧，微软限制资源供给并加速自研AI；2)AGI发展理念不合，OpenAI坚持激进路线而微软转向Copilot等务实产品；3)内部竞争加剧，微软挖角Inflection团队开发对标GPT-4的竞品。双方联系频率从CEO每日短信降至每周例会，虽公开维持合作，但资源争夺与战略分歧日益明显。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T19:02:50Z
- **目录日期**: 2025-05-02
