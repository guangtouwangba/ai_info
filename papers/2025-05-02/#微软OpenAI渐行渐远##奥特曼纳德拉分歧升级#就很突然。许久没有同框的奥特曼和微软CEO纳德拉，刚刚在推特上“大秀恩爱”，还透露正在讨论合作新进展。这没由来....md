...
微软与OpenAI的合作关系近期出现微妙变化，主要存在三方面分歧：1）算力资源分配与模型授权问题，微软称已提供极限资源但OpenAI仍要求更多；2）AGI发展方向判断不同，OpenAI持续投入但微软转向Copilot等实用产品；3）内部竞争加剧，微软收购Inflection团队自研LLM模型。双方联系频率从高管每日短信降至每周例会，尽管公开仍展示合作，但各自独立研发动作表明联盟正在弱化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T18:02:56Z
- **目录日期**: 2025-05-02
