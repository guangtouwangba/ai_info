...
微软与OpenAI的合作关系出现微妙变化，主要分歧集中在三方面：1）算力资源分配和模型授权问题，微软称已提供极限但OpenAI希望更多；2）AGI发展方向判断不同，OpenAI持续投入而微软转向Copilot等实用产品；3）内部竞争加剧，微软收购Inflection团队自研大模型。虽然双方仍维持合作，但高管互动频率明显降低，从每日多条短信变为每周例会。近期奥特曼与纳德拉的公开互动被外界视为对合作裂痕的公关回应。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T23:02:44Z
- **目录日期**: 2025-05-02
