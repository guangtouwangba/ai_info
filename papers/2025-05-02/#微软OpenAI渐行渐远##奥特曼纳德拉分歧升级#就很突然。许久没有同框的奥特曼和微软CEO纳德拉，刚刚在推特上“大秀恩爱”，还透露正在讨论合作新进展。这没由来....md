...
微软与OpenAI的合作关系近期出现明显裂痕。据《华尔街日报》报道，双方主要在三个领域产生分歧：算力资源分配（OpenAI要求更多顶级芯片）、AGI发展理念（微软对进展持保留态度）以及内部竞争加剧（微软自研对标GPT-4的模型）。曾经密切的日常联系（纳德拉每天发5-6条短信给奥特曼）现已降至每周例会。尽管双方公开场合仍展示合作，但微软通过收购Inflection团队等动作显示出降低OpenAI依赖的意图，合作典范关系正面临实质性考验。（98字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-02T09:02:51Z
- **目录日期**: 2025-05-02
