...
本文提出了首个城市空中视觉目标搜索（AVOS）基准数据集CityAVOS，包含6类2420个不同难度的任务，用于评估无人机自主搜索能力。针对现有方法在复杂城市环境中的不足，作者开发了基于多模态大语言模型的PRPSearcher方法，模拟人类三层认知：通过动态语义地图增强空间感知，基于语义吸引力的3D认知地图进行目标推理，以及3D不确定性地图平衡探索-开发。实验表明PRPSearcher在成功率(+37.69%)和搜索效率(+28.96% SPL)上显著优于基线，但与人类表现仍有差距，凸显了语义推理和空间探索能力提升的需求。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T16:01:06Z
- **目录日期**: 2025-05-14
