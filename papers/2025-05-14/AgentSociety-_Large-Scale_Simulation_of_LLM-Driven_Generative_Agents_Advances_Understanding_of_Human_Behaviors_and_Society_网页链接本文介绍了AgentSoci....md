...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，可模拟10,000+个智能代理及其500万次社会互动。该系统通过四个社会问题研究（社会极化、信息传播、基本收入政策、自然灾害影响）验证其有效性，模拟结果与现实数据高度吻合。研究表明，该系统能有效捕捉人类行为机制，可作为计算社会科学研究和政策制定的创新工具，为传统研究方法（如调查、实验）提供补充。这一成果展示了LLM驱动模拟器在理解复杂社会现象方面的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T00:05:23Z
- **目录日期**: 2025-05-14
