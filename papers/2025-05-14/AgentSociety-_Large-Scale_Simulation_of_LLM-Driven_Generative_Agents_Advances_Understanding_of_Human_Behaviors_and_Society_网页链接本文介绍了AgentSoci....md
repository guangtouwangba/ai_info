...
AgentSociety是一个基于大语言模型(LLM)的大规模社会模拟系统，可模拟10,000+个AI代理及其500万次社会互动。该系统通过四个关键社会问题研究(社会极化、信息传播、基本收入政策、自然灾害影响)，验证了其模拟结果与现实世界数据的高度一致性。研究证明该系统能有效捕捉人类行为模式和社会机制，为社会科学研究和政策制定提供了新工具。AgentSociety结合了LLM代理、真实社会环境和大规模模拟引擎，展示了计算社会科学实验的创新潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T17:05:45Z
- **目录日期**: 2025-05-14
