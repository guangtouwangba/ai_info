...
AgentSociety是一个基于大型语言模型的大规模社会模拟系统，可模拟1万多个代理及其500万次互动。研究者利用该平台研究了社会极化、信息传播、基本收入政策和自然灾害影响四个关键问题。模拟结果与现实世界数据高度吻合，验证了系统对人类行为和社会机制建模的有效性。该系统可作为计算社会科学研究的创新工具，为研究者和政策制定者提供新的实验平台，补充传统研究方法如调查和访谈。研究展示了AI模拟在理解复杂社会现象方面的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T21:05:05Z
- **目录日期**: 2025-05-14
