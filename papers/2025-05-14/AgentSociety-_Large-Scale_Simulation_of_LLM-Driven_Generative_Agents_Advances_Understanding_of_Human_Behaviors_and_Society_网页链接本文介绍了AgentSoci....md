...
这篇论文介绍了AgentSociety，一个基于大语言模型的大规模社会模拟系统。该系统模拟了1万多个AI代理的社会生活，记录了500万次互动，用于研究社会现象。研究者测试了四个关键问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。模拟结果与现实世界数据高度吻合，验证了该系统在理解人类行为机制方面的有效性。AgentSociety展现了作为社会科学研究和政策制定工具的潜力，能够补充传统研究方法（如调查和访谈），帮助深入分析社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T01:32:59Z
- **目录日期**: 2025-05-14
