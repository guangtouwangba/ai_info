...
AgentSociety是一个基于大语言模型的大规模社会模拟系统，能够模拟1万多个AI代理及其500万次社会互动。该系统通过真实社会环境和大规模模拟引擎，研究了四个关键社会问题：社会极化、信息传播、基本收入政策影响和自然灾害应对。研究结果与现实世界数据高度吻合，验证了该系统在模拟人类行为和社会机制方面的有效性。AgentSociety可作为计算社会科学的重要工具，为传统研究方法提供补充，帮助研究者分析社会问题的模式和成因，并为政策制定提供参考依据。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T18:05:40Z
- **目录日期**: 2025-05-14
