...
AgentSociety是一个基于大语言模型的大规模社会模拟器，能够模拟1万多个代理的社会互动（500万次交互）。研究者用它作为计算社会科学平台，研究了社会极化、信息传播、基本收入政策及自然灾害影响四个关键问题。模拟结果与现实数据吻合，验证了该系统捕捉人类行为机制的能力，展示了其作为社会科学研究和政策制定工具的潜力。该系统可辅助传统研究方法（如调查、访谈），帮助理解社会问题的模式和成因。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T20:05:15Z
- **目录日期**: 2025-05-14
