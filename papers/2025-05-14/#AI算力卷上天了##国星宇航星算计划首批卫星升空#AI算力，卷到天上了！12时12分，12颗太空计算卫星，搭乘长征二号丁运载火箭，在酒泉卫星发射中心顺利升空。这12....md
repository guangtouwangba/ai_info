...
中国商业航天企业国星宇航成功发射全球首个太空计算星座"星算计划"首批12颗卫星。这些卫星具备太空计算和互联能力，将构建由2800颗卫星组成的太空计算网络，开启"太空计算时代"。该计划旨在将算力设施部署到太空，突破地面数据中心限制，提升计算效率和覆盖范围。此次发射标志着中国在太空计算领域取得重要突破。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T20:03:22Z
- **目录日期**: 2025-05-14
