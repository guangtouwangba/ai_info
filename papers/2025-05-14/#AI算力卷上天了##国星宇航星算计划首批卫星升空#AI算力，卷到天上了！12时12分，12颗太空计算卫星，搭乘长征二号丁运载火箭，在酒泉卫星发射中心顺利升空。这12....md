...
中国商业航天企业国星宇航成功发射12颗具备太空计算和互联能力的卫星，组成全球首个太空计算星座，标志着"星算计划"正式启动。该计划旨在构建由2800颗卫星组成的太空计算网络，将AI算力部署到太空，开启"太空计算时代"新篇章。此次发射任务由长征二号丁运载火箭在酒泉卫星发射中心完成，未来将实现数据中心从地球向太空的转移。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T21:03:14Z
- **目录日期**: 2025-05-14
