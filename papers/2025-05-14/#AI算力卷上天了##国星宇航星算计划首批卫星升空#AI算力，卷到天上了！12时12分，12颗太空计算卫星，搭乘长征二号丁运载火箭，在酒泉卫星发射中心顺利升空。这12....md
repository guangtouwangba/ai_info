...
中国商业航天企业国星宇航成功发射12颗太空计算卫星，组成全球首个太空计算星座，开启"太空计算时代"。这些卫星具备太空计算和互联能力，是"星算"计划的首批成果。未来计划扩展至2800颗卫星组成的太空计算网络，将算力基础设施部署到太空。该计划由长征二号丁火箭在酒泉卫星发射中心执行，标志着AI算力发展进入新阶段。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T13:12:28Z
- **目录日期**: 2025-05-14
