...
荷兰科学家团队最新研究发现宇宙衰亡速度远超预期：通过修正霍金辐射理论，他们证明所有引力天体（包括中子星和黑洞）都会蒸发。关键突破在于发现天体蒸发时间仅取决于密度，导致黑洞（10⁶⁷年）与中子星衰变时间相同，因黑洞会重吸收部分辐射。据此推算，纯靠辐射的宇宙终结时间从原10¹¹⁰⁰年大幅缩短至10⁷⁸年。研究还计算出月球/人类完全蒸发需10⁹⁰年（但实际会通过其他方式更早消亡）。论文发表于《宇宙学与天体粒子物理学杂志》。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T02:33:08Z
- **目录日期**: 2025-05-14
