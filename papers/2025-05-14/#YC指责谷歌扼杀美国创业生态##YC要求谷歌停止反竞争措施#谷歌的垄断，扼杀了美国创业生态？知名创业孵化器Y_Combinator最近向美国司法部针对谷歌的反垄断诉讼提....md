...
知名创业孵化器YC向美国司法部提交意见书，指控谷歌通过垄断搜索和AI市场形成"扼杀区"，阻碍初创企业融资竞争。YC提出五项补救措施：开放搜索数据训练AI模型、禁止付费预装协议、防止AI搜索垄断、禁止预设AI答案、禁止报复合作伙伴。值得注意的是，YC与谷歌存在合作历史（如提供GPU资源），但与OpenAI关系更密切（OpenAI CEO曾任YC总裁）。此次指控凸显科技巨头垄断对创新生态的压制，尤其在新兴AI领域可能影响行业竞争格局。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T15:04:19Z
- **目录日期**: 2025-05-14
