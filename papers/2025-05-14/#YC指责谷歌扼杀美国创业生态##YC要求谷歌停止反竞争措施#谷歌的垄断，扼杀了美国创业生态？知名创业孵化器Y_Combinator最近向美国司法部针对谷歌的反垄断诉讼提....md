...
知名创业孵化器YC向美国司法部提交文件，指控谷歌通过垄断搜索和AI市场扼杀创业生态。YC指出谷歌的"扼杀区"策略阻碍风投投资潜在竞争者，要求其停止反竞争行为，包括开放搜索数据、禁止默认预装协议、防止AI市场垄断等。值得注意的是，YC与谷歌既有合作（如提供云服务），又与谷歌竞争对手OpenAI关系密切（OpenAI CEO曾任YC总裁）。YC希望通过监管干预而非拆分谷歌，为AI时代的创新保留竞争空间。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T16:04:02Z
- **目录日期**: 2025-05-14
