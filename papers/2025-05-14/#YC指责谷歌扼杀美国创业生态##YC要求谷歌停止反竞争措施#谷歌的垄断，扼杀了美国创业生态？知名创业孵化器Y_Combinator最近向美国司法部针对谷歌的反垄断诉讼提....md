...
知名创业孵化器YC向美国司法部提交意见书，指控谷歌通过垄断搜索和AI市场扼杀创业生态。YC指出谷歌制造"Kill Zone"阻碍初创企业发展，要求其停止反竞争行为，包括开放搜索数据、禁止默认搜索引擎协议、防止AI市场垄断等。值得注意的是，YC与谷歌存在合作，但与OpenAI关系更密切（OpenAI CEO曾任YC总裁）。YC未要求拆分谷歌，而是希望通过补救措施促进创新竞争。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T13:13:15Z
- **目录日期**: 2025-05-14
