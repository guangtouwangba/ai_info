...
知名创业孵化器YC向美国司法部提交意见书，指控谷歌通过垄断搜索和AI市场形成"扼杀区"，抑制初创企业创新。YC提出五项补救措施：开放搜索数据训练竞品模型、禁止付费预装协议、防止AI搜索垄断、禁止预设AI答案、禁止报复合作方。值得注意的是，YC与谷歌既有合作（如提供GPU资源），又与谷歌竞争对手OpenAI关系密切（OpenAI CEO曾任YC总裁）。YC未要求拆分谷歌，但强调需限制其反竞争行为以保护创业生态。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T23:03:49Z
- **目录日期**: 2025-05-14
