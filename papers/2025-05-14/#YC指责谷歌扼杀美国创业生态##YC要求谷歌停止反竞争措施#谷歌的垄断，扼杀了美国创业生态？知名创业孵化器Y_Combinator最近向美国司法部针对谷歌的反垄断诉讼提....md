...
知名创业孵化器YC向美国司法部提交意见书，指控谷歌通过垄断搜索和AI市场制造"Kill Zone"，扼杀初创企业创新。YC提出五项补救措施：开放搜索数据训练LLM、禁止付费默认搜索引擎协议、防止AI搜索垄断、禁止预设AI答案、禁止报复合作伙伴。值得注意的是，YC与OpenAI关系密切（OpenAI CEO曾任YC总裁），而OpenAI正是谷歌主要竞争对手。尽管谷歌云去年曾支持YC初创企业，YC仍坚持要求其停止反竞争行为，以保护创业生态健康发展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T11:04:14Z
- **目录日期**: 2025-05-14
