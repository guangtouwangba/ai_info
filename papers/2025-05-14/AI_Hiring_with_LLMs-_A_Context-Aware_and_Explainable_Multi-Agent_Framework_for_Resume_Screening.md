...
本文提出了一种基于大语言模型（LLM）的多智能体框架，用于自动化简历筛选。该框架包含简历提取器、评估器、摘要器和分数格式化器四个核心模块，并采用检索增强生成（RAG）技术整合行业专业知识等外部数据源，以提高评估的针对性和准确性。通过将AI评分与人力资源专家评分进行对比实验，验证了该框架在提升招聘效率和扩展性方面的潜力，为AI自动化与人才招聘的融合提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T07:01:40Z
- **目录日期**: 2025-05-14
