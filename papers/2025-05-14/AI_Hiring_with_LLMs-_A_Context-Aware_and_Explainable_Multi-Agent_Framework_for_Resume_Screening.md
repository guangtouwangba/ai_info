...
简历筛选是招聘中的关键但耗时的环节。本研究提出一个基于大语言模型(LLM)的多智能体框架来自动化这一流程，包含简历提取器、评估器、总结器和分数格式化器四个核心模块。通过整合检索增强生成(RAG)技术，评估器能结合行业专业知识、认证标准等外部信息进行个性化评估。实验通过比较AI评分与HR专家评分验证了该框架的有效性。结果表明，这种多智能体RAG-LLM系统能提高招聘效率，实现更客观、可扩展的自动化筛选流程，为人才招聘带来新机遇。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T22:01:33Z
- **目录日期**: 2025-05-14
