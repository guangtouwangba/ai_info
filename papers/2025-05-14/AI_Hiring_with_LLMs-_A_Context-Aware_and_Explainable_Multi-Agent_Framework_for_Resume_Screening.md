...
本文提出了一种基于大语言模型（LLM）的多智能体框架，用于自动化简历筛选。该框架包含四个核心模块：简历提取器、评估器、摘要生成器和分数格式化器。通过整合检索增强生成（RAG）技术，评估器可结合行业专业知识、职业认证等外部信息进行个性化评估。研究通过对比AI评分与HR人工评分的匿名简历数据集，验证了该方法的有效性。结果表明，这种多智能体RAG-LLM系统能有效提升招聘效率，实现更客观、可扩展的自动化筛选流程，为人才招聘工作流程带来革新。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T12:01:50Z
- **目录日期**: 2025-05-14
