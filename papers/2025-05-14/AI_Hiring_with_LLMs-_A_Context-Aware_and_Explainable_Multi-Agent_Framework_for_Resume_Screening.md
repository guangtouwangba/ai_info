...
本文提出了一种基于大语言模型(LLM)的多智能体框架，用于自动化简历筛选。该框架包含四个核心模块：简历提取器、评估器、摘要生成器和分数格式化器。通过集成检索增强生成(RAG)技术，评估器可以结合行业专业知识、职业认证等外部知识，实现个性化招聘。研究通过对比AI评分与HR专业评分的实验表明，这种多智能体RAG-LLM系统能有效提升简历筛选效率，在保持客观公正的同时，为规模化招聘流程提供了自动化解决方案。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T17:02:13Z
- **目录日期**: 2025-05-14
