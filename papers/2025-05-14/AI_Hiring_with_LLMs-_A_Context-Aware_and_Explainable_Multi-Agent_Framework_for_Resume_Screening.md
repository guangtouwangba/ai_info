...
本文提出了一种基于大语言模型（LLM）的多智能体框架，用于自动化简历筛选流程。该框架包含简历提取器、评估器、总结器和评分格式化器四个核心模块，并整合了检索增强生成（RAG）技术，可融入行业专业知识、职业认证等外部数据源，实现个性化招聘评估。通过对比HR专家对匿名简历的评分，验证了该AI系统在提升招聘效率和客观性方面的潜力。研究表明，多智能体RAG-LLM系统能有效弥合AI自动化与人才招聘之间的鸿沟，为规模化招聘流程提供技术支持。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T04:02:20Z
- **目录日期**: 2025-05-14
