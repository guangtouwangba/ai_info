...
本文提出了一种基于大语言模型(LLM)的多智能体简历筛选框架，通过四个核心模块(提取器、评估器、总结器和评分器)实现简历自动化处理。该框架创新性地结合检索增强生成(RAG)技术，整合行业知识、专业认证等外部信息，提升评估的个性化与准确性。实验通过对比AI评分与HR专家评分，验证了该系统的有效性。研究表明，这种多智能体RAG-LLM系统能显著提高招聘效率，在保持客观公正的同时实现规模化人才筛选，为AI自动化招聘提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T13:10:33Z
- **目录日期**: 2025-05-14
