...
本研究提出了一种基于大语言模型(LLM)的多智能体框架，用于自动化简历筛选流程。该框架包含四个核心模块：简历提取器、评估器、摘要生成器和分数格式化器。通过整合检索增强生成(RAG)技术，系统能结合行业专业知识、职业认证等外部信息进行个性化评估。实验通过比较AI评分与HR专家评分验证了该方法的有效性。研究表明，这种多智能体RAG-LLM系统能显著提高招聘效率，实现更客观、可扩展的简历筛选流程，为人才招聘自动化提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T10:01:49Z
- **目录日期**: 2025-05-14
