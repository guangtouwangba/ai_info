...
本文提出了一种基于大语言模型（LLM）的多智能体框架，用于自动化简历筛选。该框架包含简历提取器、评估器、摘要生成器和分数格式化器四个核心模块，并引入检索增强生成（RAG）技术整合行业知识、专业认证等外部信息以提升评估准确性。通过将AI评分与人力资源专家的评分进行对比验证，结果表明该系统能有效提升招聘效率，实现个性化、可扩展的自动化筛选流程，弥合人工智能与人才招聘之间的鸿沟。研究突显了多智能体RAG-LLM系统在优化招聘流程方面的潜力。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T18:02:11Z
- **目录日期**: 2025-05-14
