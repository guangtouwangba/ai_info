...
苹果开源了FastVLM视觉AI模型，可在iPhone和Mac本地运行，无需联网。该模型支持手势识别（如检测手指数量）、图像文字识别（791毫秒内完成）和图像描述生成（800毫秒内响应）。技术亮点包括：视觉token压缩至1/16、推理速度比LLaVA-OneVision快85倍、模型体积缩小3.4倍，并针对Apple Silicon芯片优化。采用卷积与Transformer混合架构，在GQA等基准测试中超越多款主流模型。提供0.5B/1.5B/7B三种规格，已发布iOS演示应用和开源代码。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T22:03:30Z
- **目录日期**: 2025-05-14
