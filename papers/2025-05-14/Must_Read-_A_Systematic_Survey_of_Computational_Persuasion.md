...
这篇摘要探讨了人工智能在说服领域的三重角色：说服者、被说服者和评判者。AI作为说服者能生成有影响力的内容，但也存在操纵风险；作为被说服者易受攻击和偏见影响；作为评判者则需评估说服策略的伦理性。研究提出了计算说服的分类框架，并指出关键挑战：评估说服效果、防止操纵性说服、开发负责任的AI说服系统。随着语言模型能力提升，未来研究需关注AI说服的安全性、公平性和有效性，平衡其应用潜力与伦理风险。该领域仍受限于说服效果的主观性和情境依赖性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T00:01:57Z
- **目录日期**: 2025-05-14
