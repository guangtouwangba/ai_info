...
这篇论文提出了一种受黑格尔辩证法启发的哲学方法，用于增强大语言模型(LLMs)的自我反思能力。通过自辩证过程模拟内部批判并综合对立观点来产生新想法。研究探讨了温度参数的影响，提出动态退火方法（早期促进创造性，后期关注细节）和固定温度策略。评估显示该方法能有效生成新想法并提升问题解决能力。此外，作者采用多智能体多数投票(MAMV)策略来评估生成想法的有效性和新颖性，这在缺乏领域专家时特别有用。实验结果表明该方法在创意生成和问题解决方面效果显著。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T12:02:02Z
- **目录日期**: 2025-05-14
