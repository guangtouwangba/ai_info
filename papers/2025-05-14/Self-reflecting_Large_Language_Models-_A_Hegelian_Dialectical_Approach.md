...
这篇论文提出了一种受黑格尔辩证法启发的哲学方法，用于提升大语言模型(LLM)的自我反思能力。通过自辩证方法模拟内部批判，并综合对立观点产生新想法。研究还探索了温度参数对生成效果的影响，采用动态退火策略（早期促进创造性，后期注重细节）和固定温度策略。通过多智能体多数投票(MAMV)方法评估生成想法的有效性和新颖性，在缺乏领域专家时特别有用。实验表明，该方法在创意生成和问题解决能力提升方面取得了良好效果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T15:01:55Z
- **目录日期**: 2025-05-14
