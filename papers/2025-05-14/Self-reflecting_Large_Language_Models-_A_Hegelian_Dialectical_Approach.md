...
这篇论文提出了一种受黑格尔辩证法启发的哲学方法，用于增强大语言模型(LLM)的自我反思能力。通过自我辩证的方式，模型能进行内部批判并综合对立观点以产生新想法。研究还探讨了温度参数对生成效果的影响，提出动态退火方法（早期促进创造性，后期注重细节）和固定温度策略。实验评估了该方法在创新生成和问题解决推理能力上的效果，并采用多智能体多数投票(MAMV)策略来评估生成想法的有效性和新颖性。结果表明，该方法在创意生成和问题解决方面取得了良好效果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T14:01:56Z
- **目录日期**: 2025-05-14
