...
这篇论文提出了一种受黑格尔辩证法启发的哲学方法，用于增强大语言模型(LLMs)的自我反思能力。通过自辩证方法模拟内部批判并综合对立观点生成新想法。研究探索了动态退火策略（早期促进创造性，后期注重细节）和固定温度策略对生成效果的影响，评估了该方法在创新生成和问题解决推理能力提升方面的有效性。此外，论文采用多智能体多数投票(MAMV)策略来评估生成想法的有效性和新颖性，这在缺乏领域专家时尤为有用。实验结果表明该方法在创意生成和问题解决性能提升方面具有良好效果。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T18:02:22Z
- **目录日期**: 2025-05-14
