...
这篇指南总结了Google DeepMind专家Neel Nanda的机器学习论文写作建议。核心在于构建清晰的技术叙事：提炼1-3个新颖主张，用严谨实验支撑，并阐明研究价值。关键要素包括：突出创新性（明确与前人工作差异）、提供可靠证据（多基线/消融实验）、把握写作时机（先验证关键结果）。论文结构需注意：摘要激发兴趣，引言列贡献，正文详述方法结果，讨论局限性与影响。作者强调，优秀论文应让读者快速理解"研究什么、如何验证、为何重要"。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T06:04:14Z
- **目录日期**: 2025-05-14
