...
DeepMind研究员Neel Nanda发布机器学习论文写作指南，强调优秀论文应围绕1-3个新颖主张构建技术叙事，需包含严谨实验证据并阐明研究价值。关键要素包括：提炼核心创新点、把握写作时机、突出差异化贡献、提供可靠实验数据（含消融研究和详细基线）。论文结构建议：摘要激发兴趣，引言明确贡献，正文详述方法结果，讨论局限性与影响，相关工作说明差异。特别指出摘要需浓缩核心主张、证据链和研究意义，并以具体论文为例解析摘要写法。指南适用于NeurIPS等顶会投稿。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T02:32:11Z
- **目录日期**: 2025-05-14
