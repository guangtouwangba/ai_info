...
本文介绍了一种名为ARC-NCA的新型方法，利用神经细胞自动机（NCA）及其增强版本（EngramNCA）来解决ARC-AGI基准测试中的抽象与推理问题。ARC-AGI对AI系统极具挑战性，但对人类相对简单。NCA因其模拟复杂动态和涌现模式的能力而被采用，类似生物系统的发育过程。ARC-NCA展示了将发育原理融入计算模型如何促进自适应推理和抽象能力。初步结果表明，其性能可能媲美甚至超越ChatGPT 4.5，而成本显著降低。这一发育性方法为增强AI问题解决能力提供了新思路。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T20:00:57Z
- **目录日期**: 2025-05-14
