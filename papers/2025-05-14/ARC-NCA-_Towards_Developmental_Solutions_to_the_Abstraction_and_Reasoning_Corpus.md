...
这篇论文介绍了ARC-NCA，一种基于神经细胞自动机（NCA）和带隐藏记忆的增强型NCA（EngramNCA）的发展性方法，用于解决ARC-AGI基准测试。ARC-AGI对人工智能系统极具挑战性，但对人类相对简单。NCA因其模拟复杂动态和涌现模式的能力而被采用，可模仿生物系统的发展过程。该研究表明，ARC-NCA的概念验证结果可能媲美甚至超越ChatGPT 4.5，且成本显著更低。通过将发展性原则融入计算模型，该方法有望增强AI的抽象推理能力，超越单纯的数据外推。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T11:00:56Z
- **目录日期**: 2025-05-14
