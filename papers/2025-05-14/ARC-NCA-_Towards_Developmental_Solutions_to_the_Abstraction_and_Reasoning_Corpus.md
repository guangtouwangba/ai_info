...
本文介绍了ARC-NCA，一种基于神经细胞自动机（NCA）及其增强版（EngramNCA）的发展性方法，用于解决ARC-AGI基准测试的挑战。ARC-AGI要求AI在仅提供少量示例的情况下展现强大的抽象和推理能力，这对AI系统极具挑战性，但对人类却相对简单。NCA因其模拟复杂动态和涌现模式的能力，被用来模仿生物系统的发展过程。ARC-NCA展示了将发展性原则融入计算模型如何促进自适应推理和抽象能力，其概念验证结果在某些情况下可与ChatGPT 4.5相媲美甚至超越，且成本显著降低。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T09:01:00Z
- **目录日期**: 2025-05-14
