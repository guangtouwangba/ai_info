...
任天堂在Switch 2用户协议中新增条款，声明拥有远程封锁破解设备的权限。若用户进行主机破解、运行自制软件或提取ROM等违规操作，任天堂可远程使设备永久失效（欧洲地区受法律限制，仅能封锁盗版内容访问权）。协议明确禁止修改软件、使用未授权硬件/软件绕过保护措施，违规将导致账号或设备被封。此举引发"设备所有权"争议——用户购买硬件但软件仅为授权使用。网友批评此举过度限制用户权利，可能影响玩家对Switch 2的购买意愿。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T05:04:16Z
- **目录日期**: 2025-05-14
