...
任天堂更新Switch 2用户协议，声明拥有远程封锁主机的技术。若用户破解设备、运行自制软件或提取游戏ROM，任天堂可永久禁用设备，导致主机"变砖"。协议禁止修改软件、使用未授权硬件/软件绕过保护措施，违规将面临账号或设备封禁。欧洲法律限制此类操作，仅允许封锁盗版内容访问权。此举引发"设备所有权"争议，用户质疑购买硬件却无法完全掌控。网友批评协议过于严苛，可能影响用户对Switch 2的购买意愿。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T01:31:01Z
- **目录日期**: 2025-05-14
