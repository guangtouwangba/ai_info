...
O-RAN联盟通过引入RAN智能控制器(RIC)和AI应用(rApps/xApps)实现蜂窝网络的智能自主控制，但不同应用的目标冲突(如最大化吞吐vs.最小化能耗)会导致性能下降。研究提出PACIFISTA框架，通过沙盒测试和分层图统计模型来检测和缓解冲突。实验显示，即使目标相似的xApp也会造成16%吞吐损失，冲突目标更会导致30%性能下降。PACIFISTA能帮助运营商在部署前识别冲突应用，维持网络性能。该方案在Colosseum和OpenRAN Gym平台上验证有效。(99字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T18:02:49Z
- **目录日期**: 2025-05-14
