...
O-RAN联盟通过引入RAN智能控制器(RIC)和AI驱动的rApps/xApps实现智能蜂窝网络，但不同应用间的目标冲突可能导致资源分配矛盾。为此，研究者提出PACIFISTA框架，通过沙盒测试和分层图统计模型来检测和缓解冲突。实验表明，即使目标相似的xApp也会造成16%吞吐量损失，而目标冲突的应用可能导致30%性能下降。PACIFISTA能在部署前预测冲突，帮助运营商维持网络性能。该方案在Colosseum和OpenRAN Gym平台上验证有效。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T23:02:13Z
- **目录日期**: 2025-05-14
