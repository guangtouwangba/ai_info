...
AMiner是一个智能科技情报挖掘平台，提供论文检索、翻译、分析和写作一站式服务。它收录了3.5亿论文、0.6亿学者和1.5亿专利，支持中英文文献检索、AI辅助阅读和自动摘要生成。用户可通过提问快速理解文献内容，还能订阅个性化科研动态。平台还提供学者画像、学术会议和论文排行榜等功能，基础服务免费使用。网址：https://www.aminer.cn

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T17:06:11Z
- **目录日期**: 2025-05-14
