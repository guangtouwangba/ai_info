...
AMiner是一个智能科技情报挖掘平台，提供中英文文献检索、翻译、科研订阅等一站式服务。它拥有3.5亿论文、0.6亿学者等海量数据，支持文献搜索、智能摘要生成、互动问答等功能，帮助用户快速理解和分析论文。此外，AMiner还能根据用户偏好推送最新科研动态，并提供学者画像、学术会议等辅助功能。平台支持免费使用，旨在提升科研效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T06:05:48Z
- **目录日期**: 2025-05-14
