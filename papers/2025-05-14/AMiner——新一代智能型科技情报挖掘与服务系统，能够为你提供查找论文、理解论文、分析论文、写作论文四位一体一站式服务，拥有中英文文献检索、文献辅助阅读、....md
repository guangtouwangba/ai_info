...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、辅助阅读、翻译和科研情报订阅。它拥有3.5亿论文、0.6亿学者和1.5亿专利数据，支持AI生成摘要、章节概要和智能问答，帮助用户高效理解文献内容。用户可定制订阅最新科研动态，并通过微信或邮件接收。平台还提供学者画像、学术会议和论文排行榜等功能，基础功能免费使用。访问链接：https://www.aminer.cn/

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T05:05:48Z
- **目录日期**: 2025-05-14
