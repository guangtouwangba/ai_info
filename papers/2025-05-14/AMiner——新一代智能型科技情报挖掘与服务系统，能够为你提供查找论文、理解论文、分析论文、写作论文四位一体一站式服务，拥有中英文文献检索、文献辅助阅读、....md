...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、辅助阅读、翻译和科研情报订阅。其核心功能包括：1）精准检索3.5亿论文资源，支持智能问答和自动摘要生成；2）AI驱动的文献解析，可上传PDF获取章节概要和内容问答；3）个性化订阅服务，通过微信/邮件推送最新研究动态。平台覆盖42个学科，整合论文、学者、专利等数据，并提供学者画像、学术会议等增值功能。基础检索服务免费开放，旨在提升科研效率。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T11:05:54Z
- **目录日期**: 2025-05-14
