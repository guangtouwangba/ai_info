...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、辅助阅读、翻译和科研情报订阅。它拥有海量学术资源（3.5亿论文、0.6亿学者等），支持AI生成摘要、智能问答和文档解析。用户可定制订阅最新科研动态，并获取学者画像、学术会议等专题信息。平台通过浏览器免费使用，旨在提升文献查找、理解和写作效率。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T13:14:55Z
- **目录日期**: 2025-05-14
