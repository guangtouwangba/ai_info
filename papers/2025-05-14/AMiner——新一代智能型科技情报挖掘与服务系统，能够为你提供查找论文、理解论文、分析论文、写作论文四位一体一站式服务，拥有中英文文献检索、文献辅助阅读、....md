...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、翻译、科研情报订阅等功能。它拥有42个学科的3.5亿论文、0.6亿学者等海量数据，支持文献辅助阅读、智能问答和自动摘要生成。用户可通过关键词、学者或机构订阅最新科研动态，并通过微信或邮件接收。平台还提供学者画像、学术会议和必读论文推荐。AMiner的浏览器版本可免费使用，旨在提升科研效率。访问链接：https://www.aminer.cn/。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T09:06:01Z
- **目录日期**: 2025-05-14
