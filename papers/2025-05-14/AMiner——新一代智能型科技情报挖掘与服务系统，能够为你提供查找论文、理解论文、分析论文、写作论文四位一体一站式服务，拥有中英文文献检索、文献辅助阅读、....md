...
AMiner是一个智能科技情报挖掘平台，提供一站式学术服务，包括中英文文献检索、翻译、科研情报订阅等功能。其数据库涵盖42个学科的3.5亿论文、0.6亿学者和1.5亿专利。用户可通过互动问答快速获取文献摘要，支持PDF上传和AI辅助阅读，还能定制最新科研动态推送。平台还提供学者画像、学术会议和论文排行榜等工具，基础功能可免费使用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T08:06:03Z
- **目录日期**: 2025-05-14
