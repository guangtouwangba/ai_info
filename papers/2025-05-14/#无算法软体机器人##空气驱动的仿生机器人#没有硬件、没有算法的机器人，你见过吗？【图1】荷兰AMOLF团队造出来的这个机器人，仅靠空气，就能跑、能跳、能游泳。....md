...
荷兰AMOLF团队研发了一款无需算法和硬件的软体机器人，仅通过空气驱动就能实现跑、跳、游泳等动作。其灵感源于充气人偶，利用3D打印外壳和软管腿，通过气压产生自维持振动，形成类似生物运动的节律。机器人通过共享气源实现多腿协调运动，无线版能耗低至0.06瓦/腿，并配备光传感器导航。目前虽无法精准控制（如遇障碍随机转向），但未来有望应用于人工心脏等场景，依靠流体动力自适应工作。研究发表于《Science》。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T09:03:24Z
- **目录日期**: 2025-05-14
