...
荷兰AMOLF团队研发了一款无需算法和硬件的软体机器人，仅通过空气驱动就能实现跑、跳、游泳等动作。其灵感来源于充气人偶，利用3D打印外壳和软管腿，通过气压产生自维持震动模式，类似生物节律运动。多条腿连接同一气源时可自动同步动作，无线版本能耗低至0.06瓦/腿，并能用光传感器导航。目前虽无法精准控制行为（如遇墙随机转向），但团队计划优化环境交互功能，未来或应用于人工心脏等无需布线的场景。论文发表于《Science》。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T18:04:40Z
- **目录日期**: 2025-05-14
