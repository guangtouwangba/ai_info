...
荷兰AMOLF团队研发了一款无需算法和硬件的仿生软体机器人，仅通过空气驱动即可实现跑、跳、游泳等动作。其灵感来源于充气人偶，利用3D打印外壳和软管腿，通过气压产生自维持的类生物节律运动。所有腿通过共享气源自动同步动作，无线版能耗仅0.06瓦/腿，并配备光传感器导航。目前虽无法精准控制（如遇墙随机转向），但未来有望应用于无需布线场景（如人工心脏）。研究聚焦于通过结构与环境互动实现功能行为，成果发表于《Science》。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T13:13:26Z
- **目录日期**: 2025-05-14
