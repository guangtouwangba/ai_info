...
荷兰AMOLF团队研发出一款无需算法和硬件的软体机器人，仅通过空气驱动就能实现跑、跳、游泳等动作。该机器人采用3D打印外壳和弯曲软管作为腿部结构，当连接气泵时，各腿部能自动同步形成协调的节律运动，类似于自然界中的生物运动。团队还开发了无线版本，能耗极低（每条腿仅0.06瓦），并配备光传感器实现简单导航。目前机器人尚无法精准控制行为，未来计划优化其环境适应性，有望应用于人工心脏等无需布线的场景。研究灵感源自充气人偶的随机运动特性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T21:04:09Z
- **目录日期**: 2025-05-14
