...
荷兰AMOLF团队研发出一款无需算法和硬件的软体机器人，仅通过空气驱动就能实现跑、跳、游泳等动作。其灵感来源于充气人偶，利用3D打印外壳和软管腿，通过气压产生自维持的周期性运动。机器人腿部通过共享气源自动同步动作，能耗极低（0.06瓦/腿），并配备光传感器实现简单导航。目前虽无法精准控制行为（如遇障碍随机转向），但未来有望应用于无需布线场景（如人工心脏）。研究发表于《Science》，目标是通过结构设计实现环境自适应功能。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T15:04:29Z
- **目录日期**: 2025-05-14
