...
荷兰AMOLF团队研发出一款无需算法和硬件的软体机器人，仅靠空气驱动即可运动。该机器人采用3D打印外壳和弯曲软管作为腿，通过气压产生自维持震动模式，实现类似生物运动的节律性动作。所有腿连接同一气源时能自动同步，形成协调运动。最新无线版本能耗降至每条腿0.06瓦，可搭载小电池和光传感器自主行动。虽然目前行为控制尚不精准，但团队计划进一步优化，未来或可用于人工心脏等医疗领域。这项研究展示了无算法机械系统实现复杂运动的可能性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T11:04:24Z
- **目录日期**: 2025-05-14
