...
荷兰AMOLF团队研发了一种无算法、无硬件的软体机器人，仅通过空气驱动就能实现跑、跳、游泳等动作。灵感源自充气人偶，利用3D打印外壳和软管设计，当连接气泵时，各腿部通过气压自发同步运动，形成类似生物的自然节律。最新无线版本能耗降至每条腿0.06瓦，可搭载电池和光传感器自主行动。目前虽无法精准控制（如遇障碍随机转向），但未来有望应用于无需布线场景（如人工心脏）。研究目标是通过结构优化实现环境自适应功能。论文发表于《Science》。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T14:04:34Z
- **目录日期**: 2025-05-14
