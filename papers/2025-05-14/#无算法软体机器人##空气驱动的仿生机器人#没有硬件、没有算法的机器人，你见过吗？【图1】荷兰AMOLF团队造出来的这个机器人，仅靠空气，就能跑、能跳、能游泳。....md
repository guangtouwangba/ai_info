...
荷兰AMOLF团队研发了一款无算法、无硬件的仿生软体机器人，仅通过空气驱动即可实现跑、跳、游泳等动作。其灵感源自充气人偶，利用3D打印外壳和软管腿，通过气压产生自维持震动模式，模拟生物节律运动。多腿通过共享气源自动同步动作，能耗极低（单腿0.06瓦）。目前虽无法精准控制（遇墙随机转向），但未来有望应用于无需布线场景（如人工心脏）。研究聚焦于通过机械结构而非算法实现自适应运动，相关成果发表于《Science》。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T17:04:47Z
- **目录日期**: 2025-05-14
