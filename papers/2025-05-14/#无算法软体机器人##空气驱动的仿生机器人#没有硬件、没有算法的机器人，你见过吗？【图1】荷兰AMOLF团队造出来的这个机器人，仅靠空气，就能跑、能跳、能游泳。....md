...
荷兰AMOLF团队研发出一款无需算法和硬件的软体机器人，仅通过空气驱动就能实现跑、跳、游泳等动作。其灵感来源于充气人偶，利用3D打印外壳和软管腿，在气压作用下产生类似生物运动的节律性动作。所有腿通过共享气源自动同步，能耗极低（单腿0.06瓦）。目前机器人虽能自主运动（如遇墙转向、遇水倒退），但控制精度有限。未来目标包括环境适应性改进，并有望应用于无需维护的医疗设备（如人工心脏）。研究展示了纯机械结构实现智能行为的可能性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T20:04:13Z
- **目录日期**: 2025-05-14
