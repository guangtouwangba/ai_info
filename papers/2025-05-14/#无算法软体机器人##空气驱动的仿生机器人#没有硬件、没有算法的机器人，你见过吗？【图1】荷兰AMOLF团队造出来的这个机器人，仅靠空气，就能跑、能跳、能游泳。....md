...
荷兰AMOLF团队研发了一款无需算法和硬件的软体机器人，仅通过空气驱动即可实现跑、跳、游泳等动作。其灵感源自充气人偶，利用3D打印外壳和软管腿，通过气压产生自维持震动模式，模拟生物节律运动。多腿连接同一气源时可自动同步动作，能耗极低（单腿0.06瓦），并支持无线光感操控。目前虽无法精准控制（遇墙随机转向），但未来有望应用于人工心脏等场景，通过流体动力自适应环境。研究发表于《Science》。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T16:04:14Z
- **目录日期**: 2025-05-14
