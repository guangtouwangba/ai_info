...
AI搜索引擎公司Perplexity估值飙升至140亿美元（约1008亿人民币），正进行5亿美元新一轮融资，资金将用于开发AI浏览器Comet挑战谷歌Chrome。其估值半年内从30亿涨至140亿，年度收入达1.2亿美元。Perplexity以"替代传统搜索引擎"为口号，持续与谷歌竞争，并计划通过精准搜索体验突围。但面临谷歌、OpenAI等巨头的AI搜索升级压力，行业竞争激烈。本轮融资将加强其技术研发和市场拓展。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T02:33:17Z
- **目录日期**: 2025-05-14
