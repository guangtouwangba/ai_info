...
该研究提出了两种去中心化多智能体轨迹规划器PARM和PARM*，通过感知信息实现不确定环境中的避障与轨迹协调。PARM*相比PARM计算量更大但解更优。为克服高计算成本问题，研究者进一步开发了基于模仿学习的神经网络规划器PRIMER，以PARM*为专家示范进行训练。PRIMER在部署时计算速度比优化方法快达5500倍，同时保持优异性能。这些方法解决了定位误差导致的轨迹冲突问题，实现了高效的多智能体导航。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T19:02:03Z
- **目录日期**: 2025-05-14
