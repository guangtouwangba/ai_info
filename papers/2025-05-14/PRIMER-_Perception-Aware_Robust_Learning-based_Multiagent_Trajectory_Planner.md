...
该研究提出了两种感知感知的分布式异步多智能体轨迹规划器PARM和PARM*，用于在定位不确定环境下实现避障和轨迹解冲突。PARM*相比PARM计算量更大但解更优。为克服优化方法计算成本高的问题，作者进一步提出基于模仿学习的神经网络规划器PRIMER，以PARM*为专家示范进行训练。PRIMER在部署时计算效率显著提升，速度比优化方法快达5500倍，同时保持优异性能。该工作通过结合优化方法与学习技术，实现了高效可靠的分布式多智能体轨迹规划。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T07:02:14Z
- **目录日期**: 2025-05-14
