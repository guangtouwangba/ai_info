...
本文提出了两种去中心化多智能体轨迹规划方法PARM和PARM*，通过感知信息实现不确定环境下的避障与轨迹解冲突，其中PARM*计算量更大但解更优。为降低计算成本，作者进一步提出基于模仿学习的神经网络规划器PRIMER，以PARM*为专家示范进行训练。PRIMER在部署时计算速度比优化方法快5500倍，同时保持优异性能。这些方法解决了定位误差导致的轨迹冲突问题，并通过学习范式实现了实时高性能的轨迹规划。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T15:02:17Z
- **目录日期**: 2025-05-14
