...
这篇论文探讨了人工智能（AI）系统开发中普遍存在的观点分歧被压制的问题，提出了“视角同质化”的概念，即AI开发过程中不公正地压制分歧和多样性视角的风险。作者认为这种同质化既是伦理风险，也是认知风险，并提出了一个规范性框架来指导AI生命周期中的分歧管理。该框架强调分歧的认知价值、多元视角的纳入、任务设计与权衡，以及分歧的记录与沟通。研究挑战了AI实践中的常见假设，为参与式和多元化方法提供了理论基础，并指出了未来AI设计与治理的可操作路径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T03:19:16Z
- **目录日期**: 2025-05-14
