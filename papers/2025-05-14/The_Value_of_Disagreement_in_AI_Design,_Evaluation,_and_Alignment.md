...
这篇论文探讨了人工智能（AI）开发中忽视或压制不同观点的风险，提出了“视角同质化”的概念，即AI系统开发过程中不合理地压制多样性和争议，可能对边缘群体造成伦理和认知上的危害。作者提出了一个规范性框架，强调分歧在AI生命周期中的认知价值，并指导如何纳入多元视角、权衡利弊以及记录分歧。该框架挑战了AI实践中的常见假设，支持参与式和多元化方法，为未来的AI设计与治理提供了可操作的路径。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T00:02:16Z
- **目录日期**: 2025-05-14
