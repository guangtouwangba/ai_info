...
这篇论文针对代码生成大模型(codeLLMs)提出CodeArena基准测试，强调现有评估忽略人类偏好匹配的问题。通过397个高质量样本(覆盖40类任务和44种编程语言)模拟真实编程场景，并构建20B标记的SynCode-Instruct语料库验证合成指令微调效果。实验发现执行基准与人类偏好评估存在差异，开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距显著，凸显人类偏好对齐的重要性。研究为提升代码LLMs的实际应用价值提供了新评估维度。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T05:05:59Z
- **目录日期**: 2025-05-14
