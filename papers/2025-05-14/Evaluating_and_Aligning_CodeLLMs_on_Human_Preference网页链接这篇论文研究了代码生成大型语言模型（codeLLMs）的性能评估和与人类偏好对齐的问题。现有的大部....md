...
这篇论文提出了CodeArena基准测试和SynCode-Instruct语料库，以评估代码生成大语言模型(codeLLMs)与人类偏好的对齐程度。CodeArena包含397个高质量编程任务样本，覆盖40类任务和44种语言，模拟真实编程场景。研究显示现有基于执行的基准与人类偏好存在差距，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差异显著。通过近200亿标记的合成指令微调实验，验证了大规模指令数据对提升模型对齐效果的有效性，强调了代码LLM开发中考虑人类偏好的重要性。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T23:05:30Z
- **目录日期**: 2025-05-14
