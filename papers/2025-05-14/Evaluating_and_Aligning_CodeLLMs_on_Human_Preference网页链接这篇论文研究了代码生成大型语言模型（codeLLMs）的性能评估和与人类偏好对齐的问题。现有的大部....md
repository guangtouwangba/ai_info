...
该论文针对代码生成大语言模型(codeLLMs)提出创新评估框架，重点解决现有基准忽略人类偏好的问题。研究者构建了CodeArena基准(397个高质量样本，覆盖40类任务和44种语言)和SynCode-Instruct语料库(20B标记)，通过实验发现：1)传统执行基准与人类偏好评估存在显著差异；2)开源顶级模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)性能差距明显。研究强调了代码生成模型与人类偏好对齐的重要性，为提升模型实用价值提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T12:06:19Z
- **目录日期**: 2025-05-14
