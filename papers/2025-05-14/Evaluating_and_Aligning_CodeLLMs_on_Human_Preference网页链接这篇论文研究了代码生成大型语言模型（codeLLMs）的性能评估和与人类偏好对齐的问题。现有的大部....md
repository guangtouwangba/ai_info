...
这篇论文针对代码生成大语言模型(codeLLMs)提出新评估方法，强调与人类偏好对齐的重要性。研究者创建了CodeArena基准测试(包含397个高质量样本，覆盖40类任务和44种语言)来模拟真实编程场景，同时构建了20B标记的SynCode-Instruct合成指令集。实验发现传统执行基准与CodeArena存在性能差异，开源模型(如Qwen2.5-Coder)与商业模型(如OpenAI o1)差距显著，凸显人类偏好对齐在代码生成中的关键作用。研究为提升代码LLMs的实际应用价值提供了新方向。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T06:05:59Z
- **目录日期**: 2025-05-14
