...
MLE-Dojo是一个Gym风格的强化学习框架，用于系统化训练、评估和改进基于大语言模型(LLM)的自主AI代理。与依赖静态数据的传统基准不同，它提供交互式环境，支持代理通过反馈循环迭代优化解决方案。该框架基于200多个真实Kaggle挑战，涵盖数据处理、架构搜索等典型机器学习工程任务，支持监督微调和强化学习训练。评估显示当前LLM在长程问题解决和复杂错误修正方面仍有局限。MLE-Dojo具有可扩展架构，能整合多种数据源和工具，其开源设计旨在推动下一代机器学习工程代理的发展。(100字)

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T00:01:37Z
- **目录日期**: 2025-05-14
