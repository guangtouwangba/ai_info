...
美国自20世纪40年代开始使用人工降雨技术，但缺乏结构化数据。为此，研究人员利用OpenAI的o4-mini大语言模型处理了836份NOAA历史报告，构建了2000-2025年美国人工降雨活动的结构化数据集，包含年份、季节、州、催化剂、投放装置和目的等信息。该数据集经人工验证准确率达94.72%，并已在Zenodo公开。这项研究不仅填补了人工降雨数据空白，还展示了LLM从历史文档提取结构化环境数据的潜力，为科学领域解锁扫描文档中的历史数据提供了可扩展框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T08:01:23Z
- **目录日期**: 2025-05-14
