...
美国自1940年代起使用人工降雨技术（云催化）增加降水，但缺乏结构化数据。为填补这一空白，研究者利用OpenAI的o4-mini大语言模型（LLM），结合多阶段PDF文本转换和解析代码，处理了美国国家海洋和大气管理局（NOAA）的836份历史报告，构建了2000-2025年人工降雨活动的结构化数据集，包含年份、季节、州、催化剂、投放装置及目的等信息。该数据集在Zenodo公开，整体准确率达94.72%。研究不仅填补了人工降雨数据空白，还展示了LLM从历史文档提取结构化环境数据的潜力，为科学领域解锁扫描文档数据提供了可扩展框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T13:10:12Z
- **目录日期**: 2025-05-14
