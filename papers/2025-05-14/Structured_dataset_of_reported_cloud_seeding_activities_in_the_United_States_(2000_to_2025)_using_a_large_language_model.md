...
美国自1940年代起使用人工降雨技术（云催化）增加降水，但缺乏结构化数据。为此，研究者构建了2000-2025年美国人工降雨活动的结构化数据集，包含年份、季节、州、催化剂、投放装置及目的等信息。通过OpenAI的o4-mini大语言模型（LLM）结合多阶段PDF文本转换和解析代码，处理了836份NOAA历史报告，最终数据集经人工验证准确率达94.72%，并公开于Zenodo平台。该研究填补了人工降雨数据空白，展示了LLM从历史文档提取结构化环境数据的潜力，为跨学科历史文档数据挖掘提供了可扩展框架。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T10:01:28Z
- **目录日期**: 2025-05-14
