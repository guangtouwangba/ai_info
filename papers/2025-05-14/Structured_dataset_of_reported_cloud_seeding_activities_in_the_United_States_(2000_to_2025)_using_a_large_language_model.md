...
美国自1940年代起使用人工降雨技术（云催化），但缺乏结构化数据。为填补这一空白，研究者利用OpenAI的o4-mini大语言模型处理了836份NOAA历史报告，提取2000-2025年人工降雨活动的年份、季节、州、催化剂、设备及目的等数据。经人工验证，数据集准确率达94.72%，并公开于Zenodo平台。该研究不仅填补了人工降雨数据的空白，还展示了LLM从历史文档提取结构化环境数据的潜力，为跨学科历史文档数据挖掘提供了可扩展的框架。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T05:01:18Z
- **目录日期**: 2025-05-14
