...
美国自1940年代起使用人工降雨技术，但缺乏结构化数据。为此，研究者构建了2000-2025年美国人工降雨活动的结构化数据集，包含时间、地点、催化剂、设备等信息。通过OpenAI的o4-mini大语言模型处理836份NOAA历史报告，结合多阶段PDF转换和解析代码，最终数据集准确率达94.72%，已在Zenodo公开。该研究填补了人工降雨数据空白，展示了LLM从历史文档提取结构化环境数据的潜力，并为跨学科历史文档数据挖掘提供了可扩展框架。（99字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T15:01:22Z
- **目录日期**: 2025-05-14
