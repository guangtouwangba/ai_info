...
本研究提出LatentSync框架，利用音频条件潜在扩散模型实现端到端唇同步，无需中间运动表示。该方法通过时间表示对齐(TREPA)技术增强生成视频的时间一致性，并改进SyncNet训练框架以解决收敛问题。实验表明，该方案在HDTF和VoxCeleb2数据集上超越现有方法，为音频驱动人像动画提供了新思路。研究发现的SyncNet优化经验也可推广至其他相关应用。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T17:06:03Z
- **目录日期**: 2025-05-14
