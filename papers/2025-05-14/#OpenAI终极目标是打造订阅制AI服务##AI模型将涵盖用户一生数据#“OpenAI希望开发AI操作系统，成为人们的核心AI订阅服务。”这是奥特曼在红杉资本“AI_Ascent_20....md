...
OpenAI CEO Sam Altman在红杉资本活动上透露，公司的终极目标是打造订阅制AI操作系统，成为用户一生的核心AI服务。未来的AI模型将能存储用户一生的数据，实现高度个性化推理。目前该计划尚处构想阶段，公司90%精力仍集中在优化通用模型。Altman预测2025年AI代理将成为主流，编码是关键能力，AI将更多进入物理世界创造经济价值。OpenAI同时探索语音交互，但尚未突破语音+图形界面技术。他建议初创公司若想竞争，应提供更好的核心AI订阅服务。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T19:02:54Z
- **目录日期**: 2025-05-14
