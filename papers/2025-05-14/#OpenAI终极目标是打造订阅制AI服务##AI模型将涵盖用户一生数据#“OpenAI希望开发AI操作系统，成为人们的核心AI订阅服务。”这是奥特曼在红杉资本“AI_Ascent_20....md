...
OpenAI CEO Sam Altman在红杉资本活动上透露，公司的终极目标是打造订阅制AI操作系统，该模型将存储用户一生的数据，实现高度个性化推理。目前计划尚处构想阶段，但已开展相关研究。Altman预测2025年AI代理将成为主流，编码是核心能力，并可能推动重大科学发现。OpenAI同时探索语音交互技术，但承认"语音+图形界面"尚未突破。他强调公司将聚焦优化通用模型（投入90%资源），同时通过API/SDK构建开放生态，最终成为用户的核心AI订阅服务。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T17:03:35Z
- **目录日期**: 2025-05-14
