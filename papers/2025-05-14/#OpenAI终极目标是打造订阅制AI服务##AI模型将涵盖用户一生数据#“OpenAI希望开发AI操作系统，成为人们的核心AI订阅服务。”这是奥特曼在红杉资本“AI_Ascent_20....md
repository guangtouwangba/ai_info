...
OpenAI的终极目标是打造订阅制AI操作系统，成为用户的核心AI服务。CEO奥特曼在访谈中表示，未来AI模型将涵盖用户一生的数据，实现高度个性化推理，改变人机交互方式。目前该计划仍处构想阶段，公司90%精力仍聚焦通用模型优化。奥特曼预测2025年AI代理将成为主流，编码是关键驱动，并透露语音交互和机器人领域将有突破。他鼓励竞争，表示OpenAI将专注于提供优质核心AI订阅服务。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T14:03:15Z
- **目录日期**: 2025-05-14
