...
OpenAI CEO Sam Altman在红杉资本活动上透露，公司的终极目标是打造订阅制AI操作系统，成为用户的核心AI服务。他设想未来AI将涵盖用户一生的数据，实现高度个性化推理。目前该计划仍处概念阶段，但OpenAI已在相关学术研究上布局。Altman还预测2025年AI代理将主导工作流程，编码成为关键能力，并可能带来重大科学突破。他强调OpenAI将专注于提升模型质量，同时保持策略灵活性。尽管面临基础设施等挑战，公司仍将90%精力投入通用模型优化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T20:03:05Z
- **目录日期**: 2025-05-14
