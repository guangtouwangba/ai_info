...
OpenAI CEO Sam Altman在红杉资本活动上透露，公司终极目标是打造订阅制AI操作系统，成为用户"核心AI服务"。他设想未来AI将涵盖用户一生数据，实现高度个性化推理，改变人机交互方式。目前计划尚处概念阶段，但已开展相关研究。Altman预测2025年AI代理将主导工作流程，编码成为关键能力，并可能推动重大科学发现。OpenAI正探索语音交互等方向，但承认技术尚未成熟。他强调公司90%精力仍聚焦优化通用模型，同时保持战略灵活性以适应行业变化。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T21:02:57Z
- **目录日期**: 2025-05-14
