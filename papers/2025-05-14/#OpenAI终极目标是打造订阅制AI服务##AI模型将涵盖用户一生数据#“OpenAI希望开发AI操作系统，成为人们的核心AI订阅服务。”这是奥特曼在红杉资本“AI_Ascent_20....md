...
OpenAI CEO Sam Altman在红杉资本活动上透露，公司的终极目标是打造订阅制AI操作系统，成为用户终身个性化服务的核心平台。该AI将能存储用户一生的数据，实现高度个性化推理。目前计划仍处构想阶段，OpenAI正专注于改进通用模型。Altman预测2025年AI代理将主导工作流程，编码成为关键能力，并可能推动重大科学发现。他认为未来AI将从纯智力领域转向物理世界应用，创造实际经济价值。OpenAI希望成为基础AI订阅服务提供商，同时鼓励竞争。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T16:03:02Z
- **目录日期**: 2025-05-14
