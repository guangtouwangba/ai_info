...
OpenAI CEO Sam Altman在红杉资本活动上透露，公司的终极目标是打造订阅制AI操作系统，成为用户的核心AI服务。他设想未来AI模型能存储用户一生的数据，实现高度个性化推理。目前该计划尚处概念阶段，但OpenAI已在相关研究领域布局。Altman预测2025年AI代理将主导工作流程，编码成为关键能力，AI可能实现重大科学突破。他同时强调，OpenAI将专注于提升模型质量，90%资源仍用于优化现有通用模型。对于竞争，Altman表示欢迎提供更优质核心AI服务的挑战者。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T18:03:31Z
- **目录日期**: 2025-05-14
