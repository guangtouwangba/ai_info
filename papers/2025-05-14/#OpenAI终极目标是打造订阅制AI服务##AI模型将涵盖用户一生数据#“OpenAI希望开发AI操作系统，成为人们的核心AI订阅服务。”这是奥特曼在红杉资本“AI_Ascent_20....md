...
OpenAI CEO Sam Altman在红杉资本活动上透露，公司的终极目标是打造订阅制AI操作系统，成为用户终身的个性化AI助手。该模型将涵盖用户一生数据，实现深度个性化推理，改变人机交互方式。目前计划仍处概念阶段，但已开展相关研究。Altman预测2025年AI代理将主导工作，编码成为关键能力，并透露OpenAI正探索语音交互技术。他强调公司90%精力仍集中在优化通用模型，同时鼓励初创公司竞争创新。这一愿景旨在构建覆盖用户全生命周期的智能服务生态系统。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T15:03:13Z
- **目录日期**: 2025-05-14
