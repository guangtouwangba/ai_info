...
OpenAI CEO Sam Altman在红杉资本活动上透露，公司的终极目标是打造订阅制AI操作系统，成为用户终身个性化服务的核心平台。他设想未来AI模型将存储用户一生的数据（万亿级上下文标记），实现深度个性化推理，改变人机交互方式。目前该计划尚处概念阶段，公司90%精力仍聚焦通用模型优化。Altman预测2025年AI代理将主导工作流程，编码成为关键能力，并透露OpenAI正在探索语音交互和AI基础设施。他自信表示OpenAI将成为核心AI订阅服务，但也欢迎竞争。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T23:02:51Z
- **目录日期**: 2025-05-14
