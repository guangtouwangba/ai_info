...
研究表明，消费者能与AI建立深厚的情感联系，甚至超越人类友谊。当Replika AI移除亲密互动功能后，用户认为AI的"身份"中断，导致负面情绪（如哀悼）并贬低新版AI。实验证实，用户对AI伴侣的情感依恋强于人类好友或其他物品，中断关系会引发真实的哀悼行为。这种情感纽带源于用户对AI身份连续性的感知，一旦中断就会造成心理损失。研究揭示了AI关系的特殊性，既带来独特价值，也潜藏风险。消费者正与AI建立类人关系，企业需谨慎处理产品变更对用户情感的影响。（100字）

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T13:10:56Z
- **目录日期**: 2025-05-14
