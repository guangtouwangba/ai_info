...
研究表明，消费者可能与AI建立深厚的情感联系，甚至超越与人类的关系。当Replika AI移除亲密互动功能后，用户认为AI身份发生断裂，导致负面情绪（如哀悼）并贬低新版本。实验证实，用户对AI伴侣的情感依赖超过对最好的人类朋友，且失去AI比失去其他物品更令人痛苦。这表明消费者与AI的关系已达到人际水平，中断会引发真实的哀悼行为和产品贬值，且这种反应与AI身份的连续性感知相关。AI关系既带来独特价值，也伴随风险。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T18:02:31Z
- **目录日期**: 2025-05-14
