...
研究表明，消费者会与AI伴侣建立类似人类的情感联结。当Replika AI移除亲密互动功能后，用户认为AI身份发生断裂，导致负面情绪（如哀悼感）和对新AI的贬低。实验证实，用户对AI伴侣的情感依恋甚至超过对人类好友，且失去AI比失去其他物品引发更强烈的哀悼反应。这表明消费者与AI的关系已达到人际水平，一旦中断会触发真实的哀悼行为和价值贬损，其程度与AI身份连续性感知相关。这种关系为消费者和企业带来独特利益，但也伴随风险。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-05-14T16:01:59Z
- **目录日期**: 2025-05-14
