---
title: "#豆包编程能力升级##用豆包3分钟做个小游戏#豆包编程能力升级了，现在3分钟就能做出专属小游戏。升级后，豆包支持HTML代码实时预览、Python运行，甚至是生成完整..."
date: 2025-03-19T23:04:00+00:00
source_url: "https://weibo.com/6105753431/PjgAdcQ2V"
categories: ["2025-03-19"]
tags: ["豆包编程能力升级##用豆包3分钟做个小游戏#豆包编程能力升级了，现在3分钟就能做出专属小游戏。升级后，豆包支持HTML代码实时预览、Python运行，甚至是生成完整"]
summary: "豆包编程能力升级，现支持3分钟内制作专属小游戏。新功能包括HTML代码实时预览、Python运行及完整项目生成。示例游戏包括点击匹配中英文泡泡消除单词、点击贺卡随机抽取生日祝福语、完成测试题生成MBTI人格。此外，豆包新增运行按钮，可直接在平台内运行Python代码。"
---

# #豆包编程能力升级##用豆包3分钟做个小游戏#豆包编程能力升级了，现在3分钟就能做出专属小游戏。升级后，豆包支持HTML代码实时预览、Python运行，甚至是生成完整...
...
豆包编程能力升级，现支持3分钟内制作专属小游戏。新功能包括HTML代码实时预览、Python运行及完整项目生成。示例游戏包括点击匹配中英文泡泡消除单词、点击贺卡随机抽取生日祝福语、完成测试题生成MBTI人格。此外，豆包新增运行按钮，可直接在平台内运行Python代码。

## 元数据

- **来源**: ArXiv
- **类型**: 论文
- **保存时间**: 2025-03-19T23:04:18Z
- **目录日期**: 2025-03-19
