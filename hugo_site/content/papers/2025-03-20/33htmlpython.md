...
date: 2025-03-20T03:14:00+00:00
...
summary: "豆包编程能力升级，现支持3分钟内制作专属小游戏。新功能包括HTML代码实时预览、Python运行及完整项目生成。用户可通过点击操作消除单词、抽取生日祝福语及生成MBTI人格测试结果。豆包还新增运行按钮，可直接在平台内运行Python代码。"
---
